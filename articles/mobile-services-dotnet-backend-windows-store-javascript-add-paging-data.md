<properties 
	pageTitle="데이터에 페이징 추가(JavaScript) - Azure 모바일 서비스" 
	description="페이징을 사용하여 데이터 양을 관리하는 방법에 알아봅니다.ata returned to your Windows Store JavaScript app from Mobile Services." 
