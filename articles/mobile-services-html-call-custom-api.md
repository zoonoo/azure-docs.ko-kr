<properties urlDisplayName="Call a custom API from the client" pageTitle="HTML 클라이언트에서 사용자 지정 API 호출 | 모바일 서비스" metaKeywords="" description="Learn how to define a custom API and then call it from an HTML app that uses Microsoft Azure Mobile Services." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Call a custom API from the client" authors="glenga"  solutions="" writer="jparrel" manager="dwrede" editor=""  />
