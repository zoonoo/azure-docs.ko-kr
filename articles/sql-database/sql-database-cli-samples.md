...
| [Managed Instance 만들기 및 관리](https://medium.com/azure-sqldb-managed-instance/working-with-sql-managed-instance-using-azure-cli-611795fe0b44) | 이러한 CLI 스크립트는 Azure CLI를 사용하여 Managed Instance를 만들고 관리해야 한다는 것을 보여줍니다. |
|||
