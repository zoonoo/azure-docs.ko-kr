...
[SQL Server용 TinyTDS Ruby 드라이버를 사용하기 위한 필수 구성 요소](https://docs.microsoft.com/sql/connect/ruby/step-1-configure-development-environment-for-ruby-development/)
...
[Ruby를 사용하여 SQL에 연결하는 개념 증명](https://docs.microsoft.com/sql/connect/ruby/step-3-proof-of-concept-connecting-to-sql-using-ruby/)

## <a name="next-steps"></a>다음 단계
* [SQL 데이터베이스 개발 개요](sql-database-develop-overview.md)
* [SQL Server용 Microsoft Ruby Driver](https://docs.microsoft.com/sql/connect/ruby/ruby-driver-for-sql-server/)
