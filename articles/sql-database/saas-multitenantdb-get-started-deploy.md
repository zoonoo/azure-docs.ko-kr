...
스크립트는에 있습니다 *. Wingtipticketssaas-dbpertenant-master-wingtipticketssaas-multitenantdb-master\\Learning Modules\\ \\*
...
1. 웹 브라우저에서 **이벤트 허브**를 엽니다.
   - http://events.wingtip-mt.&lt; user&gt;. trafficmanager.net &nbsp; *(사용자 &lt;&gt; 를 배포의 사용자 값으로 바꿉니다.)*
...
이제 [프로 비전 및 카탈로그 자습서](sql-database-saas-tutorial-provision-and-catalog.md)를 사용해 보세요.
