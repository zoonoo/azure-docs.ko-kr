...
이 항목에서는 Python을 사용하여 Azure SQL 데이터베이스를 연결 및 쿼리하는 방법을 보여 줍니다. Windows, Ubuntu Linux 또는 Mac 플랫폼에서 이 샘플을 실행할 수 있습니다.


## 1단계: 개발 환경 구성

[SQL Server용 pymssql Python 드라이버를 사용하기 위한 필수 구성 요소](https://msdn.microsoft.com/library/mt694094.aspx)
...
[Python을 사용하여 SQL에 연결하는 개념 증명](http://msdn.microsoft.com/library/mt715796.aspx)

## 다음 단계

* [SQL 데이터베이스 개발 개요](sql-database-develop-overview.md)를 검토합니다.
* [SQL Server용 Microsoft Python Driver](https://msdn.microsoft.com/library/mt652092.aspx)에 대한 추가 정보
