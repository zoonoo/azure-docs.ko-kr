...
- R 버전은 3.4.4입니다.
- `external scripts enabled`를 통해 `sp_configure`를 구성할 필요가 없습니다. [등록](sql-database-machine-learning-services-overview.md#signup)하면 SQL 데이터베이스에 대한 기계 학습을 사용할 수 있습니다.
