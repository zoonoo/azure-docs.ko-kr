---
title: "Azure SQL Database 개요 | Microsoft Docs"
description: "이 페이지에서는 Azure SQL Database의 개요를 제공합니다."
...
- [고유한 리소스 집합](sql-database-what-is-a-dtu.md#what-are-database-transaction-units-dtus)(DTU)이 있는 독립 실행형 데이터베이스
...
- 보안 관련 지침은 [Azure SQL Database 보안 지침 및 제한 사항](sql-database-security-guidelines.md)을 참조하세요.
