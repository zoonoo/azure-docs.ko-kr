---
title: SQL Database에 대한 자세한 정보 | Microsoft Docs
...
> [!NOTE]
> 로컬 백업과 지역 중복 백업 모두 자동으로 수행됩니다. 사용자는 어떤 작업도 수행할 필요가 없으며 추가 비용도 없습니다. 
> 
> 
...
> [!NOTE]
> SQL Database는 자동으로 로컬 데이터베이스 백업과 지역 중복 백업을 모두 만듭니다. 사용자는 아무 작업도 할 필요가 없습니다. 추가 비용도 없습니다.
> 
> 
