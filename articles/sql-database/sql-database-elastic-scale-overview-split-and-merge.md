...
테이블의 'region' 및 'nation'은 참조 테이블로 정의되며 분할/병합/이동 작업을 통해 복사됩니다. 그런 다음 'customer' 및 'orders'는 분할된 테이블로 정의됩니다. C_CUSTKEY 및 O_CUSTKEY는 분할 키 역할을 합니다. 
