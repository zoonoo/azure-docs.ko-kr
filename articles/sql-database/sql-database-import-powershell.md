<properties 
    pageTitle="PowerShell을 사용하여 Azure SQL 데이터베이스로 BACPAC 가져오기" 
    description="PowerShell을 사용하여 Azure SQL 데이터베이스로 BACPAC 가져오기" 
...
이 문서에서는 PowerShell로 BACPAC을 가져와 SQL 데이터베이스를 만드는 방법을 보여 줍니다.
