...
description: Azure Portal에서 Azure SQL Database 서버 및 데이터베이스를 만들고 쿼리합니다.
...
Azure SQL Database에는 [컴퓨팅 및 스토리지 리소스](sql-database-service-tiers-dtu.md)의 정의된 세트가 있습니다. [Azure 리소스 그룹](../azure-resource-manager/resource-group-overview.md) 내의 [SQL Database 서버](sql-database-features.md)에서 데이터베이스를 만듭니다.
