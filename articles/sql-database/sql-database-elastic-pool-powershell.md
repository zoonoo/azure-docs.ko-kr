...
리소스 그룹, 서버, 방화벽 규칙을 구성했으므로 이제 서버에 액세스할 수 있습니다. 다음 명령은 탄력적 풀을 만듭니다. 이 명령은 총 400 DTU를 공유하는 풀을 만듭니다. 풀에 있는 각 데이터베이스는 항상 10 DTU(DatabaseDtuMin)를 사용할 수 있도록 보장 받습니다. 풀에 있는 개별 데이터베이스는 최대 100 DTU(DatabaseDtuMax)를 사용할 수 있습니다. 매개 변수 설명에 대한 자세한 내용은 [Azure SQL 데이터베이스 탄력적 풀](sql-database-elastic-pool.md)을 참조하세요.
