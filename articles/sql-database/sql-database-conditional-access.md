...
Azure [SQL Database](sql-database-technical-overview.md), [관리되는 인스턴스](sql-database-managed-instance.md) 및 [SQL Data Warehouse](../sql-data-warehouse/sql-data-warehouse-overview-what-is.md)는 Microsoft 조건부 액세스를 지원합니다. 
...
1. 선택 포털에 로그인 **Azure Active Directory**를 선택한 후 **조건부 액세스**합니다. 자세한 내용은 [Azure Active Directory 조건부 액세스 기술 참조](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-technical-reference)를 참조하세요.  
...
3. 아래 **할당**를 선택 **사용자 및 그룹**, 확인 **사용자 및 그룹 선택**를 선택한 다음 조건부 액세스에 대 한 사용자 또는 그룹. **선택**을 클릭한 다음 **완료**를 클릭하여 선택 사항을 적용합니다.  
   ![사용자 및 그룹 선택](./media/sql-database-conditional-access/select-users-and-groups.png)  

4. **클라우드 앱**을 선택하고 **앱 선택**을 클릭합니다. 조건부 액세스에 대 한 사용 가능한 모든 앱이 표시 합니다. **Azure SQL Database**를 선택하고 아래쪽에서 **선택**을 클릭한 다음, **완료**를 클릭합니다.  
   ![SQL Database 선택](./media/sql-database-conditional-access/select-sql-database.png)  
   세 번째 스크린샷에서 나열된 **Azure SQL Database**를 찾을 수 없으면, 다음 단계를 완료합니다.   
