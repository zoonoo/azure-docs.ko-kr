...
Azure [SQL Database](sql-database-technical-overview.md), [Managed Instance](sql-database-managed-instance.md)및 [Azure Synapse](../synapse-analytics/sql-data-warehouse/sql-data-warehouse-overview-what-is.md) 는 Microsoft 조건부 액세스를 지원 합니다. 
...
Multi-factor authentication에 대 한 Azure SQL Database 및 Azure Synapse에 대 한 질문은 MFAforSQLDB@microsoft.com를 문의 하세요.  
