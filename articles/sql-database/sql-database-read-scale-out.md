...
[AzSqlDatabase](/powershell/module/az.sql/set-azsqldatabase) cmdlet을 호출 하 고 `Enabled` `Disabled` `-ReadScale` 매개 변수에 대해 원하는 값 (또는--)을 전달 하 여 Azure PowerShell에서 읽기 확장을 사용 하지 않도록 설정 하거나 다시 사용 하도록 설정할 수 있습니다.
