...
SQL DB용 탄력적 데이터베이스 트랜잭션은 여러 개의 다른 SQL 데이터베이스에 저장된 데이터에 대한 응용 프로그램의 원자성 변경을 가능하게 합니다. 미리 보기는 C# 및 .NET의 클라이언트 쪽 개발 환경에 중점을 둡니다. T-SQL을 사용한 서버 쪽 환경은 차후에 계획되어 있습니다.  
