...
이 항목에서는 Yosemite를 실행 중인 Mac 컴퓨터에서 실행하여 Azure SQL 데이터베이스에 연결하는 Ruby 코드 샘플을 보여줍니다.

## 1단계: 개발 환경 구성

[SQL Server용 TinyTDS Ruby 드라이버를 사용하기 위한 필수 구성 요소](https://msdn.microsoft.com/library/mt711041.aspx#Mac)
