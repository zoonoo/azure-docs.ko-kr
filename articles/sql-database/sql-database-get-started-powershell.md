...
# <a name="sql-database-tutorial-get-started-with-azure-sql-database-servers-databases-and-firewall-rules-using-powershell"></a>SQL Database 자습서: PowerShell을 사용하여 Azure SQL Database 서버, 데이터베이스 및 방화벽 규칙 시작
