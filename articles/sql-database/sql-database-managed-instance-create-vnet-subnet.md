---
title: Azure SQL Database Managed Instance VNet 만들기 | Microsoft Docs
description: 이 항목에서는 Azure SQL Database Managed Instance를 배포할 수 있는 VNet(가상 네트워크)을 만드는 방법을 설명합니다.
