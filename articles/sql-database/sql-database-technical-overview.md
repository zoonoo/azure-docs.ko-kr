...
바로 사용해 볼 준비가 되어 있고 깊이 알기를 원하는 경우 30분짜리 비디오를 보세요.


> [AZURE.VIDEO azurecon-2015-get-started-with-azure-sql-database]


현재 문서에서는 세부 정보를 찾는 링크를 통해 성능, 확장성 및 관리 효율성과 관련된 SQL 데이터베이스의 핵심 개념과 기능을 소개합니다. 이동할 준비가 된 경우 바로 [먼저 SQL 데이터베이스를 만들거나](sql-database-get-started.md) [탄력적 데이터베이스 풀을 만들 수](sql-database-elastic-pool-portal.md) 있습니다.
