...
description: "Azure SQL Database를 사용하는 샘플 다중 테넌트 응용 프로그램인 Wingtip SaaS 예제를 설치 및 실행하기 위한 단계와 지침을 제공합니다."
...
![개체 탐색기](media/saas-dbpertenant-wingtip-app-guidance-tips/object-explorer.png)
