---
title: Azure SQL Database 메트릭 및 진단 로깅
...
1. 인스턴스 진단 원격 분석: **ResourceUsageStats**에 대 한 확인란을 선택 합니다.
   관리 되는 인스턴스의 진단을 구성 ![](./media/sql-database-metrics-diag-logging/diagnostics-settings-container-mi-selection.png)
1. **저장**을 선택합니다.
