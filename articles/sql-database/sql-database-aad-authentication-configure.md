...
2. 에 **사용자 이름** 상자에 Azure Active Directory 사용자 이름 형식으로 입력 **username\@domain.com**합니다. 사용자 이름은 Azure Active Directory의 계정이거나, Azure Active Directory와 페더레이션된 도메인의 계정이어야 합니다.
