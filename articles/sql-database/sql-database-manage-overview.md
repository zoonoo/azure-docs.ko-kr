...
> [!IMPORTANT]
> 최신 버전의 SQL Server Management Studio 및 Visual Studio용 SQL Server Data Tools를 사용하여 Microsoft Azure 및 SQL 데이터베이스에 대한 업데이트와 동기화 상태를 유지해야 합니다. 이러한 도구의 이전 버전은 SQL 데이터베이스에서 제대로 작동하지 않습니다.
> 
> 
