...
- 탄력적 데이터베이스 풀 만들기 및 관리는 [Azure 포털](https://portal.azure.com), [PowerShell](sql-database-elastic-pool-create-powershell.md) 및 .NET 클라이언트 라이브러리(Azure Resource Manager만)를 사용하여 지원합니다. [클래식 포털](https://manage.windowsazure.com/) 및 서비스 관리 명령은 지원되지 않습니다.
...
| [Azure 포털에서 SQL 데이터베이스에 확장성 있는 탄력적 데이터베이스 풀 만들기](sql-database-elastic-pool-create-portal.md) | Azure 포털을 사용하여 탄력적 데이터베이스 풀을 만들고 관리하는 방법 |
...
PowerShell 및 C#을 사용하여 풀로 작업하는 방법을 보여주는 자세한 내용 및 코드 예제:

- [PowerShell을 사용한 탄력적 풀 만들기](sql-database-elastic-pool-create-powershell.md)
- [C#로 탄력적 풀 만들기](sql-database-elastic-pool-create-csharp.md)
- [PowerShell을 사용한 탄력적 풀 관리](sql-database-elastic-pool-manage-powershell.md)
- [C#로 탄력적 풀 관리](sql-database-elastic-pool-manage-csharp.md)

탄력적 풀과 관련된 cmdlet 및 해당하는 REST API 작업의 빠른 참조는 다음과 같습니다.
...
| [Get-AzureRmSqlDatabaseActivity]() | [풀 내부 및 외부에서 데이터베이스의 이동 상태 가져오기](https://msdn.microsoft.com/library/mt603687.aspx) |
...
| 기존 데이터베이스를 풀 내부 및 외부로 이동 | [ALTER DATABASE (Transact-SQL)](https://msdn.microsoft.com/library/mt574871.aspx) |
