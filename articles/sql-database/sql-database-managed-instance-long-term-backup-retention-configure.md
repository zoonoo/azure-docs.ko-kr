---
title: '관리 되는 인스턴스: 장기 백업 보존 (PowerShell)'
description: PowerShell을 사용 하 여 Azure SQL Database 관리 되는 인스턴스에 대해 별도의 Azure Blob storage 컨테이너에 자동화 된 백업을 저장 하 고 복원 하는 방법에 대해 알아봅니다.
