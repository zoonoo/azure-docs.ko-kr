<properties
    pageTitle="Azure SQL 데이터베이스를 사용하여 규모 확장 | Microsoft Azure"
...
도구를 사용하도록 기존 데이터베이스를 변환하려면 [규모를 확장하기 위해 기존 데이터베이스 마이그레이션](sql-database-elastic-convert-to-use-elastic-tools.md)을 참조하세요.
