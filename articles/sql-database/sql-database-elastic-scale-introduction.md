...
탄력적 풀의 세부 사항을 보려면 [탄력적 풀의 가격 및 성능 고려 사항](sql-database-elastic-pool-guidance.md)을 참조하거나 [자습서](sql-database-elastic-pool-create-portal.md)를 사용하여 새로운 풀을 만드세요.  
