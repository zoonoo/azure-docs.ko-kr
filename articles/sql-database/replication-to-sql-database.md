...
- 스냅샷 및 단방향 트랜잭션 복제만 지원됩니다. 피어 투 피어 트랜잭션 복제 및 병합 복제는 지원되지 않습니다.
- Azure SQL Database Managed Instance에서 공개 미리 보기로 복제 기능을 사용할 수 있습니다. Managed Instance는 게시자, 배포자 및 구독자 데이터베이스를 호스트할 수 있습니다. 자세한 내용은 [SQL Database Managed Instance를 사용하여 복제](replication-with-sql-database-managed-instance.md)를 참조하세요.
