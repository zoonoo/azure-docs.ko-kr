...
1. **POWERSHELL ISE** *에서 ... 학습 모듈\\스키마 관리\\demo-schemamanagement.ps1. p s \\*1.
...
6. SSMS *에서 파일을 엽니다. 학습 모듈\\Schema Management\\ \\.sql*.
...
2. SSMS *에서 열기 ... 학습 모듈\\Schema Management\\ \\*
...
* **sp\_add\_job** 은 *온라인 인덱스 재 인덱싱 PK\_\_\_\_VenueTyp 265E44FD7FD4C885*라는 새 작업을 만듭니다.

* **sp\_add\_jobstep** 은 인덱스를 업데이트 하기 위한 t-sql 명령 텍스트가 포함 된 작업 단계를 만듭니다.
