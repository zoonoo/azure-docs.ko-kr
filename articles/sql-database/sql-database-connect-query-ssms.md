---
title: SQL 데이터베이스 연결 - SQL Server Management Studio | Microsoft Docs
...
[!INCLUDE [SSMS 설치](../../includes/sql-server-management-studio-install.md)]

[!INCLUDE [SSMS 연결](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]
