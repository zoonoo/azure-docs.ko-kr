---
title: Azure Active Directory 인증을 사용하여 SQL 데이터베이스 또는 SQL 데이터 웨어하우스에 연결 | Microsoft Docs
...
> [!NOTE]
> Azure AD 사용자는 데이터베이스 메타데이터에서 E 형식(EXTERNAL\_USER) 및 그룹의 경우 X 형식(EXTERNAL\_GROUPS)으로 표시됩니다. 자세한 내용은 [sys.database\_principals](https://msdn.microsoft.com/library/ms187328.aspx)를 참조하세요.
> 
> 
