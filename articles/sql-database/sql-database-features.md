---
title: Azure SQL Database 기능 비교
...
| [인증서 및 비대칭 키](https://docs.microsoft.com/sql/relational-databases/security/sql-server-certificates-and-asymmetric-keys) | 예, `BACKUP` 및 `CREATE` 작업에 대 한 파일 시스템에 액세스 하지 않습니다. | 예, `BACKUP` 및 `CREATE` 작업용 파일 시스템에 대 한 액세스 권한이 없는 경우 [인증서 차이점](sql-database-managed-instance-transact-sql-information.md#certificates)을 참조 하세요. | 
...
| [데이터베이스 미러링](https://docs.microsoft.com/sql/database-engine/database-mirroring/database-mirroring-sql-server) | 아니요 | [아니요](sql-database-managed-instance-transact-sql-information.md#database-mirroring) |
...
| [FileStream](https://docs.microsoft.com/sql/relational-databases/blob/filestream-sql-server) | 아니요 | [아니요](sql-database-managed-instance-transact-sql-information.md#filestream-and-filetable) |
