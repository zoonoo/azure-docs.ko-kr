...
| [SSIS(SQL Server Integration Services)](https://docs.microsoft.com/sql/integration-services/sql-server-integration-services) | [Azure Data Factory](https://azure.microsoft.com/services/data-factory/) 참조 |
