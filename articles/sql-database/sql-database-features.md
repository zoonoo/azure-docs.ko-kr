...
| [변경 데이터 캡처-CDC](https://docs.microsoft.com/sql/relational-databases/track-changes/about-change-data-capture-sql-server) | 아니오 | 예 |
...
| [CLR (공용 언어 런타임)](https://docs.microsoft.com/sql/relational-databases/clr-integration/common-language-runtime-clr-integration-programming-concepts) | 아니오 | 예, 하지만 `CREATE ASSEMBLY` 문에서 파일 시스템에 액세스 하지 않습니다. [CLR 차이점](sql-database-managed-instance-transact-sql-information.md#clr) 을 참조 하세요. |
...
| [데이터베이스 간 트랜잭션](https://docs.microsoft.com/sql/relational-databases/linked-servers/linked-servers-database-engine) | 아니오 | 예, 인스턴스 내에 있습니다. 인스턴스 간 쿼리에 대 한 [연결 된 서버 차이점](sql-database-managed-instance-transact-sql-information.md#linked-servers) 을 참조 하세요. |
| [데이터베이스 메일-DbMail](https://docs.microsoft.com/sql/relational-databases/database-mail/database-mail) | 아니오 | 예 |
| [데이터베이스 미러링](https://docs.microsoft.com/sql/database-engine/database-mirroring/database-mirroring-sql-server) | 아니오 | [아니요](sql-database-managed-instance-transact-sql-information.md#database-mirroring) |
| [데이터베이스 스냅샷](https://docs.microsoft.com/sql/relational-databases/databases/database-snapshots-sql-server) | 아니오 | 아니오 |
...
| [이벤트 알림](https://docs.microsoft.com/sql/relational-databases/service-broker/event-notifications) | 아니요 - [경고](sql-database-insights-alerts-portal.md) 참조 | 아니오 |
...
| [FileStream](https://docs.microsoft.com/sql/relational-databases/blob/filestream-sql-server) | 아니오 | [아니요](sql-database-managed-instance-transact-sql-information.md#filestream-and-filetable) |
...
| [OLE 자동화](https://docs.microsoft.com/sql/database-engine/configure-windows/ole-automation-procedures-server-configuration-option) | 아니오 | 아니오 |
| [OPENDATASOURCE](https://docs.microsoft.com/sql/t-sql/functions/opendatasource-transact-sql)|아니오|예, 다른 Azure SQL Database 및 SQL Server에만 해당 합니다. [T-sql 차이점을](sql-database-managed-instance-transact-sql-information.md) 참조 하세요.|
| [OPENQUERY](https://docs.microsoft.com/sql/t-sql/functions/openquery-transact-sql)|아니오|예, 다른 Azure SQL Database 및 SQL Server에만 해당 합니다. [T-sql 차이점을](sql-database-managed-instance-transact-sql-information.md) 참조 하세요.|
...
| [PolyBase](https://docs.microsoft.com/sql/relational-databases/polybase/polybase-guide) | 아니요. `OPENROWSET` 함수를 사용 하 여 Azure Blob Storage에 배치 된 파일의 데이터를 쿼리할 수 있습니다. | 아니요. `OPENROWSET` 함수를 사용 하 여 Azure Blob Storage에 배치 된 파일의 데이터를 쿼리할 수 있습니다. |
| [쿼리 알림](https://docs.microsoft.com/sql/relational-databases/native-client/features/working-with-query-notifications) | 아니오 | 예 |
| [R 서비스](https://docs.microsoft.com/sql/advanced-analytics/r-services/sql-server-r-services) | 예, [공개 미리 보기 상태](https://docs.microsoft.com/sql/advanced-analytics/what-s-new-in-sql-server-machine-learning-services)  | 아니오 |
...
| [RESTORE 문](https://docs.microsoft.com/sql/t-sql/statements/restore-statements-for-restoring-recovering-and-managing-backups-transact-sql) | 아니오 | 예, Azure Blob Storage에 배치 된 백업 파일에 대 한 필수 `FROM URL` 옵션을 사용 합니다. [복원 차이점](sql-database-managed-instance-transact-sql-information.md#restore-statement) 을 참조 하세요. |
...
| [Service Broker](https://docs.microsoft.com/sql/database-engine/configure-windows/sql-server-service-broker) | 아니오 | 예. 단, 인스턴스 내 에서만 가능 합니다. 원격 Service Broker 경로를 사용 하는 경우 마이그레이션 중에 여러 배포 된 SQL Server 인스턴스의 데이터베이스를 하나의 관리 되는 인스턴스로 통합 하 여 로컬 경로만 사용 하십시오. [Service Broker 차이점](sql-database-managed-instance-transact-sql-information.md#service-broker) 을 참조 하세요. |
...
| 표준 시간대 선택 | 아니오 | [예](sql-database-managed-instance-timezone.md), Managed Instance 만들어질 때 구성 해야 합니다. |
| [추적 플래그](https://docs.microsoft.com/sql/t-sql/database-console-commands/dbcc-traceon-trace-flags-transact-sql) | 아니오 | 예. 단, 제한 된 전역 추적 플래그 집합만 지원 됩니다. [DBCC 차이점](sql-database-managed-instance-transact-sql-information.md#dbcc) 을 참조 하세요. |
...
| [가용성 영역](/azure/availability-zones/az-overview) | 예 | 아니오 |
| [Azure Resource Health](/azure/service-health/resource-health-overview) | 예 | 아니오 |
...
| [하이퍼 확장 아키텍처](sql-database-service-tier-hyperscale.md) | 예 | 아니오 |
...
| 일시 중지/다시 시작 | 예, [서버 리스 모델](sql-database-serverless.md) 에서 | 아니오 | 
...
| VNet 서비스 끝점 | [예](sql-database-vnet-service-endpoint-rule-overview.md) | 아니오 |
