...
---
# <a name="archive-an-azure-sql-database-to-a-bacpac-file-using-the-azure-portal"></a>Azure 포털을 사용하여 Azure SQL 데이터베이스를 BACPAC 파일에 보관
> [!div class="op_single_selector"]
> * [쉬운 테이블](sql-database-export.md)
...
* Azure SQL 데이터베이스에 BACPAC를 가져오는 방법에 대해 자세히 알아보려면 [Azure SQL 데이터베이스에 BACPCAC 가져오기](sql-database-import.md)
