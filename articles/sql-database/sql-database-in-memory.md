---
title: SQL 메모리 내, 시작 | Microsoft Docs
...
> [!NOTE]
> 미리 보기 기능은 표준 또는 기본 서비스 계층의 데이터베이스에는 제공되지 않고, [*프리미엄*](sql-database-service-tiers.md) Azure SQL 데이터베이스에만 제공됩니다.
> 
> 
...
* 탄력적 풀의 데이터베이스로 메모리 내 OLTP 기능 사용은 미리 보기 중에 지원되지 않습니다.
  ...
  * 1. 데이터베이스의 서비스 계층을 표준으로 변경합니다.
  * 1. 데이터베이스를 탄력적 풀 내로 이동합니다.
