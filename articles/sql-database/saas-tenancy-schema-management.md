...
1. **파워 쉘 ISE에서,** 열기 ... \\학습 모듈\\스키마\\관리*데모-SchemaManagement.ps1*.
...
1. 파일을 엽니 다 _... 학습 모듈\\스키마\\관리 OnlineReindex.sql \\_
...
* **sp\_\_추가 작업은** "온라인 재인덱싱\_\_PK\_\_장소Typ 265E44FD7FD4C885"라는 새로운 작업을 만듭니다
...
다음으로 임시 [보고 자습서를](saas-tenancy-cross-tenant-reporting.md) 시도하여 테넌트 데이터베이스 간에 분산 쿼리를 실행하는 방법을 살펴봅습니다.


## <a name="additional-resources"></a>추가 리소스

* [테넌트별 배포당 Wingtip Tickets SaaS 데이터베이스를 기반으로 하는 추가 자습서](saas-dbpertenant-wingtip-app-overview.md#sql-database-wingtip-saas-tutorials)
