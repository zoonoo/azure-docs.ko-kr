...
1. **POWERSHELL ISE에서**... \\학습 모듈\\스키마 관리\\*demo-schemamanagement.ps1*. p s 1.
...
1. _파일 열기 ... 학습 모듈\\Schema Management\\ \\_
...
* **sp\_add\_job** 은 "온라인 인덱스 인덱스 PK\_\_VenueTyp\_\_265E44FD7FD4C885" 라는 새 작업을 만듭니다.
...
* [정문 티켓 SaaS 테 넌 트 별 데이터베이스 응용 프로그램 배포를 기반으로 하는 추가 자습서](saas-dbpertenant-wingtip-app-overview.md#sql-database-wingtip-saas-tutorials)
