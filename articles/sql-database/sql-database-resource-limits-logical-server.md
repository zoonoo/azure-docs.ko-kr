...
description: 이 문서에서는 탄력적 풀을 사용하는 단일 데이터베이스 및 풀링된 데이터베이스에 대한 Azure SQL Database 논리 서버 리소스 한도를 간략하게 설명합니다. 또한 이러한 리소스 한도에 도달하거나 초과할 때 발생하는 사항에 대한 정보도 제공합니다.
...
ms.locfileid: "51620901"
---
# <a name="sql-database-resource-limits-for-single-and-pooled-databases"></a>단일 데이터베이스 및 풀링된 데이터베이스에 대한 SQL Database 리소스 한도
...
| 서버당 최대 풀 | DTU 또는 vCore의 수로 제한됩니다. 예를 들어, 각 풀에 DTU가 1000개인 경우 단일 서버는 54개 풀을 지원할 수 있습니다.|
||||
