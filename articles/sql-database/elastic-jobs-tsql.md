...
[ **@target_group_id =** ] target_group_id OUTPUT이 성공적으로 만들어지면 작업에 할당되는 대상 그룹 ID 번호입니다. target_group_id는 uniqueidentifier 형식의 출력 변수이며, 기본값은 NULL입니다.
