...
> [!NOTE]
> 이 문서는 Azure SQL Database 및 Azure SQL Data Warehouse에 연결합니다. 간단히 하기 위해 SQL Database는 SQL Database와 SQL Data Warehouse를 참조할 때 사용됩니다. SQL Server (온-프레미스)에 대한 부분은 [SQL 데이터 검색 및 분류](https://go.microsoft.com/fwlink/?linkid=866999)를 확인합니다.
...
6. 분류 엔진은 잠재적으로 중요한 데이터를 포함하는 열에 대해 데이터베이스를 스캔하여 **권장되는 열 분류** 목록을 제공합니다. 분류 권장 사항 보고 적용하려면:
...
[Azure 리소스에 대 한 RBAC](https://docs.microsoft.com/azure/role-based-access-control/overview)에 대해 확인합니다.
