...
- *단일 테 넌 트:* &nbsp; 각 데이터베이스는 한 테 넌 트의 데이터만 저장 합니다.
...
- **사용자 지정 가능성:** &nbsp; 테 넌 트 특정 또는 테 넌 트 클래스 관련 스키마 사용자 지정을 쉽게 지원 합니다.
...
| :---------- | :------------- | :------------------ | :------------------- |
| 확장 | 보통<br />1-100s | 매우 높음<br />1-100,000s | 제한 없음<br />1-1,000,000s |
