...
![정확히 하나의 단일 테 넌 트 데이터베이스가 있는 독립 실행형 앱 디자인 합니다.][image-standalone-app-st-db-111a]
...
![데이터베이스 당 테 넌 트를 사용 하 여 다중 테 넌 트 앱 디자인 합니다.][image-mt-app-db-per-tenant-132d]
...
![데이터베이스 당 테 넌 트, 탄력적 풀을 사용 하 여를 사용 하 여 다중 테 넌 트 앱 디자인 합니다.][image-mt-app-db-per-tenant-pool-153p]
...
![분할 된 다중 테 넌 트 데이터베이스가 있는 다중 테 넌 트 앱 디자인 합니다.][image-mt-app-sharded-mt-db-174s]
