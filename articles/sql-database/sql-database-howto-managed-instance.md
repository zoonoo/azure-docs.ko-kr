...
- [관리 엔드포인트 IP 주소 찾기](sql-database-managed-instance-find-management-endpoint-ip-address.md) - 관리되는 인스턴스는 관리 용도로 공용 엔드포인트를 사용합니다. 여기에 설명된 스크립트를 사용하여 관리 엔드포인트의 IP 주소를 확인할 수 있습니다.
...
- [경고를 만들면](sql-database-managed-instance-alerts.md) 관리되는 인스턴스에 대한 CPU 사용률, 스토리지 공간 사용량, IOPS 등 모니터링되는 메트릭에 대한 경고를 설정할 수 있습니다. 이 가이드에서는 관리되는 인스턴스의 경고를 사용하도록 설정하고 구성하는 방법을 설명합니다.
