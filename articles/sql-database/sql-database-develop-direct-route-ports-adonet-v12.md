<properties 
	pageTitle="SQL 데이터베이스에 대한 1433 이외의 포트 | Microsoft Azure"
...
Azure 클라이언트 컴퓨터에 있는 11000-11999 및 14000-14999 범위의 포트가 ADO.NET 4.5와 SQL 데이터베이스 V12 사이의 클라이언트 상호 작용에 사용 가능한지 확인합니다.
...
*참고:* TRANSACT-SQL 문 `SELECT @@version;`은 '11.' 또는 '12.'와 같은 숫자로 시작하는 값과 SQL 데이터베이스에 대한 V11 및 V12의 버전 이름과 일치하는 값을 반환합니다.
