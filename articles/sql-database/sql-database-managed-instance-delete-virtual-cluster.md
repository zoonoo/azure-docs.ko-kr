...
> - 가상 클러스터를 삭제 하는 작업은 약 1.5 시간 동안 지속 되는 장기 실행 작업입니다 (최신 가상 클러스터 삭제 시간에 대 한 [관리 되는 인스턴스 관리 작업](https://docs.microsoft.com/azure/sql-database/sql-database-managed-instance#managed-instance-management-operations) 참조) .이 프로세스가 완료 될 때까지 포털에서 가상 클러스터를 계속 볼 수 있습니다.
