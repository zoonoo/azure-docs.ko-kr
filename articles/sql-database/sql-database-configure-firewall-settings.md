...
# 방법: Azure 클래식 포털을 사용하여 SQL 데이터베이스에 방화벽 설정 구성
...
### 새 Azure 클래식 포털을 통해 서버 수준 방화벽 규칙 관리


[AZURE.INCLUDE [sql-database-include-ip-address-22-v12portal](../../includes/sql-database-include-ip-address-22-v12portal.md)]


## 클래식 포털을 통해 서버 수준 방화벽 규칙 관리 

1. 클래식 포털에서 **SQL 데이터베이스**를 클릭합니다. 모든 데이터베이스 및 해당 하는 서버가 여기에 나열 됩니다.
