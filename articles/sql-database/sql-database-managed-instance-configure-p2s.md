...
- 기존 SQL Server 데이터베이스를 온-프레미스에서 Managed Instance 복원 하려면 [마이그레이션에는 DMS (Azure Database Migration Service)](../dms/tutorial-sql-server-to-managed-instance.md) 를 사용 하거나 [t-sql restore 명령을](sql-database-managed-instance-get-started-restore.md) 사용 하 여 데이터베이스 백업 파일에서 복원할 수 있습니다.
