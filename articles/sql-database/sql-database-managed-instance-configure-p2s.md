...
ms.locfileid: "47163004"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>온-프레미스 컴퓨터에서 Azure SQL Database Managed Instance에 연결하는 지점 및 사이트 간 연결 구성
...
6. **Windows가 PC 보호** 메시지가 표시되면 **자세한 정보**를 클릭한 다음, **실행**을 클릭합니다.
...
## <a name="connect-to-the-vpn-connection"></a>VPN 연결에 연결합니다.
