---
title: Azure SQL Database vCores에 대 한 비용 절감
...
[Azure Portal](https://portal.azure.com)에서 Azure SQL Database 예약된 용량을 구매할 수 있습니다. 예약 요금은 [사전 결제 또는 월별 결제](../billing/billing-monthly-payments-reservations.md)로 처리할 수 있습니다. SQL Database 예약된 용량을 구입하려면 다음을 수행합니다.
