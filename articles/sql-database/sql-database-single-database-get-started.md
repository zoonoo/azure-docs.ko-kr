...
- Azure Powershell을 사용하여 서버리스 컴퓨팅 계층에서 단일 데이터베이스를 만들려면 [PowerShell을 사용하여 서버리스 데이터베이스 만들기](sql-database-serverless.md#create-new-database-using-powershell)를 참조하세요.
