...
Key Vault에 대 한 자세한 내용은 [cli 2.0을 사용 하 여 Key Vault 관리](../key-vault/general/manage-with-cli2.md) 및 [cli에서 일시 삭제 Key Vault 사용 하는 방법](../key-vault/general/soft-delete-cli.md)을 참조 하세요.
