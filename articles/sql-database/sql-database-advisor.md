...
| **스키마 문제 해결 권장 사항 (미리 보기)** -SQL DATABASE 서비스가 SQL Database에서 발생 하는 스키마 관련 sql 오류 수의 비정상 상태를 볼 때 스키마 수정에 대 한 권장 사항이 표시 됩니다. Microsoft는 현재 “스키마 문제 해결” 권장 사항을 사용하지 않습니다. | 예 | 예 |
