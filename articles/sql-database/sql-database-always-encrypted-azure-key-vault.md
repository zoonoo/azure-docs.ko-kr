...
12. **표시**를 **Microsoft 앱**으로 설정된 상태로 두고 **Microsoft Azure 서비스 관리**를 찾아서 선택한 후 확인 표시를 클릭하여 계속합니다.
13. **Microsoft Azure 서비스 관리** 줄에서 **위임된 권한** 드롭다운을 클릭하고 **Azure 서비스 관리 액세스**를 선택합니다.
14. 아래쪽에서 **저장**을 클릭합니다.
