...
### <a name="enable-subscription-access-to-a-region"></a><a id="other"></a>지역에 대 한 구독 액세스 사용
...
## <a name="managed-instance-quota-type"></a><a id="sqlmiquota"></a>관리 되는 인스턴스 할당량 유형
...
마지막 단계는 SQL Database 할당량 요청에 대 한 나머지 세부 정보를 입력 하는 것입니다. 그런 후 다음을 선택 합니다 **. 검토 + 만들기>>**, 요청 정보를 검토 한 후 **만들기** 를 클릭 하 여 요청을 제출 합니다.
