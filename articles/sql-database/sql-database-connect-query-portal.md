...
ms.locfileid: "50913158"
---
# <a name="quickstart-azure-portal-use-the-sql-query-editor-to-connect-and-query-data"></a>빠른 시작: Azure Portal: SQL 쿼리 편집기를 사용하여 데이터 연결 및 쿼리
