...
---
# <a name="use-azure-portal-to-create-alerts-for-azure-sql-database"></a>Azure Portal을 사용하여 Azure SQL Database에 대한 경고 만들기

## <a name="overview"></a>개요
이 문서에서는 Azure Portal을 사용하여 Azure SQL Database를 설정하는 방법을 보여 줍니다. 이 문서는 또한 값과 임계값에 대한 유용한 정보를 제공합니다.    
...
| 탄력적 풀 | dtu_consumption_percent | DTU 비율 | 평균 | 5분 |
| 탄력적 풀 | storage_percent | 저장소 비율 | 평균 | 5분 |
| 탄력적 풀 | workers_percent | 작업자 백분율 | 평균 | 5분 |
| 탄력적 풀 | eDTU_limit | eDTU 제한 | 평균 | 5분 |
| 탄력적 풀 | storage_limit | 저장소 제한 | 평균 | 5분 |
| 탄력적 풀 | eDTU_used | eDTU 사용 | 평균 | 5분 |
| 탄력적 풀 | storage_used | 저장소 사용됨 | 평균 | 5분 |
||||||
