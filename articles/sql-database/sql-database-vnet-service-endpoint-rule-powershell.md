---
title: 'Azure SQL의 단일 및 풀링된 데이터베이스에 대 한 VNet 끝점 및 규칙에 대 한 PowerShell '
...
규칙을 만드는 데 대 한 동기는 [Azure SQL Database에 대 한 가상 서비스 끝점][sql-db-vnet-service-endpoint-rule-overview-735r]에 설명 되어 있습니다.
