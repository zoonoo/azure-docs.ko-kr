<properties 
	pageTitle="SQL 데이터베이스를 사용하는 방법(.NET) | Microsoft Azure" 
...
다음으로, 데이터베이스 및 서버를 만들고 구성합니다. Azure 클래식 포털에서 수정된 워크플로를 통해 데이터베이스를 처음 만든 후에 서버를 프로비전합니다.
...
13. SQL 데이터베이스 클래식 포털, 저장소 서비스 및 Azure의 기타 서비스를 사용하여 이 데이터베이스에 연결할 수 있도록 **Azure 서비스가 서버에 액세스할 수 있도록 허용합니다.** 옵션이 선택된 상태로 유지해야 합니다.
...
자세한 내용은 [Entity Framework용 EntityClient 공급자](http://msdn.microsoft.com/library/bb738561.aspx)(영문)를 참조하세요.
