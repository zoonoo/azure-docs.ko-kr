...
2. 다음 표의 정보를 사용하여 양식을 작성합니다.
   ...
   | **Virtual Network 이름**|Managed Instance를 만든 가상 네트워크입니다.|
...
- 지점 및 사이트 간 연결을 사용 하 여 온-프레미스 클라이언트 컴퓨터에서 연결 하는 방법을 보여 주는 빠른 시작은 [지점 및 사이트 간 연결 구성](sql-database-managed-instance-configure-p2s.md)을 참조 하세요.
