...
트랜잭션 사용을 통해 성능을 향상시킬 수 있지만 계속해서 [트랜잭션 및 연결에 대한 모범 사례](https://msdn.microsoft.com/library/ms187484.aspx)를 살펴보겠습니다. 트랜잭션을 최대한 짧게 유지하고 작업이 완료된 후에는 데이터베이스 연결을 닫습니다. 이전 예제의 using 문은 후속 코드 블록이 완료되면 연결이 닫히도록 합니다.
