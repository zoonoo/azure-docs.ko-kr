...
<tr>
   ...
   <td valign="middle"><ul>
      ...
      <li type=round><a href="http://msdn.microsoft.com/library/jj919148.aspx">Azure 저장소의 백업</a> 또는 <a href="http://msdn.microsoft.com/library/azure/jj870962.aspx">Azure VM의 AlwaysOn 복제본</a>을 사용한 온-프레미스 SQL Server 응용 프로그램에 대한 재해 복구를 지원합니다.
      </ul></td>
