...
## <a name="troubleshooting-sync"></a>동기화 문제 해결
...
## <a name="troubleshooting-the-client-agent"></a>클라이언트 에이전트 문제 해결
...
-   동기화 그룹과 동일한 데이터 센터에 새 에이전트를 만듭니다. 그런 다음 데이터베이스를 해당 에이전트에 등록합니다.
...
## <a name="troubleshooting-setup-and-maintenance"></a>설정 및 유지 관리 문제 해결
