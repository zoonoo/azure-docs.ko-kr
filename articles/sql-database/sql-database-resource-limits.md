...
| 최대 | 논리 서버 | Managed Instance |
| :--- | :--- | :--- |
| 서버/인스턴스당 데이터베이스 | 5,000 | 100 |
| 모든 지역에서 구독당 서버의 기본 수 | 20 | 해당 없음 |
| 모든 지역에서 구독당 서버의 최대 수 | 200 | 해당 없음 | 
| 서버당 DTU/eDTU 할당량 | 54,000 | 해당 없음 |  
| 서버/인스턴스당 vCore 할당량 | 540 | 80 |
| 서버당 최대 풀 | DTU 또는 vCore 수로 제한 | 해당 없음 |
||||
...
- 데이터베이스 또는 탄력적 풀의 성능 수준을 높여 데이터베이스에 더 많은 계산 리소스를 제공합니다. 
  [단일 데이터베이스 리소스 확장](sql-database-single-database-scale.md) 및 [탄력적 풀 리소스 확장](sql-database-elastic-pool-scale.md)을 참조하세요.
...
- 데이터베이스 또는 탄력적 풀의 최대 크기를 늘리거나 더 많은 저장소를 추가합니다. 
  [단일 데이터베이스 리소스 확장](sql-database-single-database-scale.md) 및 [탄력적 풀 리소스 확장](sql-database-elastic-pool-scale.md)을 참조하세요.
...
- 데이터베이스 또는 탄력적 풀의 서비스 계층 또는 성능 수준을 늘립니다. 
  [단일 데이터베이스 리소스 확장](sql-database-single-database-scale.md) 및 [탄력적 풀 리소스 확장](sql-database-elastic-pool-scale.md)을 참조하세요.
