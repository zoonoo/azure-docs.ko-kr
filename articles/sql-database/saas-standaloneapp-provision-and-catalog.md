...
## <a name="application-per-tenant-pattern"></a>테넌트별 응용 프로그램 패턴
...
1. PowerShell ISE에서 *...\Learning Modules\UserConfig.psm*을 열고 **\<user\>** 값을 세 가지 응용 프로그램 예제를 배포할 때 사용한 값으로 업데이트합니다.  **파일을 저장합니다**.  
