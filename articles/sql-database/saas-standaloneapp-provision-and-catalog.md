...
* 세 가지 샘플 테넌트 앱이 배포되어 있습니다. 앱을 5분 내에 배포하려면 [Wingtip Tickets SaaS 독립 실행형 애플리케이션 배포 및 탐색](https://docs.microsoft.com/azure/sql-database/saas-standaloneapp-get-started-deploy)을 참조하세요.
