...
**지정 시간 복원**은 데이터베이스를 이전 시점으로 복원하는 기능입니다. 돌아갈 수 있는 일 수는 서비스 계층에 따라 결정됩니다. 자세한 내용은 [지정 시간 복원](sql-database-recovery-using-backups.md#point-in-time-restore)을 참조하세요.
