...
## <a name="service-tiers-and-database-options"></a>서비스 계층 및 데이터베이스 옵션
...
## <a name="standalone-database-service-tiers-and-performance-levels"></a>독립 실행형 데이터베이스 서비스 계층 및 성능 수준
...
### <a name="choosing-a-service-tier-for-a-standalone-database"></a>독립 실행형 데이터베이스에 대한 서비스 계층 선택
