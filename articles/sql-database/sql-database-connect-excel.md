---
title: SQL 데이터베이스에 Excel 연결 | Microsoft Docs
...
> [!TIP]
> 다른 Excel 통합 문서 및 워크시트를 데이터베이스에 연결하려면 **데이터**, **연결**, **추가**를 차례로 클릭하고 목록에서 만든 연결을 선택한 후 **열기**를 클릭합니다. ![다른 통합 문서에서 연결 열기](./media/sql-database-connect-excel/open-from-another-workbook.png)
> 
> 
