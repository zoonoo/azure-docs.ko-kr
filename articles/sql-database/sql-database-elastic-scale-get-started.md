...
**Azure SQL와 Elastic DB - 시작** 샘플 응용 프로그램은 Elastic Database 도구를 사용하는 분할된 응용 프로그램용 개발 환경의 가장 중요한 측면을 설명합니다. [분할 맵 관리](sql-database-elastic-scale-shard-map-management.md), [데이터 종속 라우팅](sql-database-elastic-scale-data-dependent-routing.md) 및 [다중 분할 쿼리](sql-database-elastic-scale-multishard-querying.md)의 주요 사용 사례를 중점적으로 소개합니다. 샘플을 다운로드하고 실행하려면 다음 단계를 수행합니다. 
