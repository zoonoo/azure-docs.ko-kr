...
Azure Portal를 사용 하 여 Azure SQL Database 탄력적 풀 및 테스트 장애 조치 (failover) 그룹을 구성 합니다.  이 자습서에서는 다음 방법을 알아봅니다.
...
이 자습서에서는 장애 조치 (failover) 그룹에 Azure SQL Database 탄력적 풀을 추가 하 고 장애 조치 (failover)를 테스트 했습니다. 다음 방법에 대해 알아보았습니다.
