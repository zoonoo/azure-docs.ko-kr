...
SQL Database에서 지원되는 기능 및 지원되지 않는 기능 목록은 [Azure SQL Database 기능 비교](sql-database-features.md)를 참조하세요. 이 페이지의 목록은 해당 지침 및 기능 항목을 보완하고 Transact-SQL 문을 중점적으로 다룹니다.
