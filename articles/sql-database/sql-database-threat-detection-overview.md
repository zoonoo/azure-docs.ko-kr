...
ms.locfileid: "73820710"
---
# <a name="advanced-threat-protection-for-azure-sql-database"></a>Azure SQL Database의 Advanced Threat Protection

[Azure SQL Database](sql-database-technical-overview.md) 및 [SQL Data Warehouse](../sql-data-warehouse/sql-data-warehouse-overview-what-is.md) 에 대 한 Advanced Threat Protection은 비정상적인 활동을 감지 하 여 데이터베이스에 액세스 하거나 악용 하려는 비정상적인 시도를 감지 합니다.
...
**Advanced Threat Protection 경고** 를 클릭 하 여 Azure Security Center 경고 페이지를 시작 하 고 데이터베이스 또는 데이터 웨어하우스에서 검색 된 활성 SQL 위협에 대 한 개요를 확인 합니다.
