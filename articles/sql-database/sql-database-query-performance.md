...
5. **Intelligent performance** > **performance 권장 사항을** 열고 성능 권장 사항을 사용할 수 있는지 확인 합니다. 기본 제공 성능 권장 사항에 대한 자세한 내용은 [SQL Database Advisor](sql-database-advisor.md)를 참조하세요.
