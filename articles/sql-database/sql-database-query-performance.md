...
- [SQL 데이터베이스 관리자](sql-database-index-advisor.md)를 열고 권장 사항을 사용할 수 있는지 확인합니다.
- 자세한 내용을 알아보세요.
...
SQL 데이터베이스의 성능 향상을 위한 추가 권장 사항은 **쿼리 성능 Insight** 블레이드의 [SQL 데이터베이스 관리자](sql-database-index-advisor.md)를 클릭하여 확인합니다.
