...
- [인덱스 관리자](sql-database-index-advisor.md)를 열고 권장 사항을 사용할 수 있는지 확인합니다.
...
쿼리 성능 Insight를 통해 쿼리 작업의 영향 및 데이터베이스 리소스 사용의 관계를 이해할 수 있습니다. 이 기능을 사용하여 최상위 사용 쿼리를 확인하고 문제가 되기 전에 해결할 쿼리를 쉽게 식별할 수 있습니다. 데이터베이스의 **쿼리 성능 Insight**를 클릭하여 최상위 리소스(CPU) 소비 쿼리를 확인합니다.
...
SQL 데이터베이스의 성능 향상을 위한 추가 권장 사항은 **Query Performance Insight** 블레이드의 [인덱스 관리자](sql-database-index-advisor.md)를 클릭하여 확인합니다.

![인덱스 관리자](./media/sql-database-query-performance/ia.png)
