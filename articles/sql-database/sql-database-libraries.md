...
| 자바 | Windows, Linux, macOS | [SQL Server용 Microsoft JDBC 드라이버](http://msdn.microsoft.com/library/mt484311.aspx) | [다운로드](https://go.microsoft.com/fwlink/?linkid=852460) |  [시작](https://www.microsoft.com/en-us/sql-server/developer-get-started/java/ubuntu)
