...
| 자바 | Windows, Linux, macOS |[Hibernate ORM](https://hibernate.org/orm)|
...
- 클라이언트 애플리케이션에서 연결하는 데 사용되는 [SQL Server 드라이버](https://msdn.microsoft.com/library/mt654049.aspx)
- SQL Database에 연결:
