<properties
	pageTitle="규모가 확장된 클라우드 데이터베이스 관리 | Microsoft Azure" 
...
규모가 확장된 분할된 데이터베이스를 관리하기 위해 **탄력적 데이터베이스 작업** 기능(미리 보기)을 사용하면 Transact-SQL(T-SQL) 스크립트를 안정적으로 실행하거나 다음을 포함한 데이터베이스 그룹에 대해 DACPAC([데이터 계층 응용 프로그램](https://msdn.microsoft.com/library/ee210546.aspx))를 적용할 수 있습니다.
