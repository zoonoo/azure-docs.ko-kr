---
title: "SQL Database 자습서: SQL Database 만들기 | Microsoft Docs"
...
---
# <a name="sql-database-tutorial-create-a-sql-database-in-minutes-by-using-the-azure-portal"></a>SQL Database 자습서: Azure Portal을 사용하여 빠르게 SQL Database 만들기
...
## <a name="create-your-first-azure-sql-database"></a>첫 Azure SQL 데이터베이스 만들기
...
* Azure SQL Database 보안에 대해 알아보기 시작하려면 [보안 시작](sql-database-get-started-security.md)
