...
|읽기 확장|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|Columnstore 지원 여부|예|예|예|예|예|예|
|메모리 내 OLTP 스토리지(GB)|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|N/A|
...
|스토리지 형식|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)
|최대 데이터 IOPS (64 KB)|3500|4000|4500|5,000|7000|7000|
...
|메모리 내 OLTP 스토리지(GB)|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|스토리지 형식|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|
...
|읽기 확장|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|N/A|
...
|Columnstore 지원 여부|예|예|예|예|예|예|예|
|메모리 내 OLTP 스토리지(GB)|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|N/A|
...
|스토리지 형식|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|원격 SSD|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|최대 데이터 IOPS (64 KB)|7000|7000|7000|7000|7000|7000|7000|
|최대 로그 전송률 (MBps)|30|30|30|30|30|30|30|
|최대 동시 작업자(요청)|1600|1800|2000|2400|3200|4000|8000|
|최대 동시 세션|30000|30000|30000|30000|30000|30000|30000|
|복제본 수|1|1|1|1|1|1|1|
|다중 AZ|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
|읽기 확장|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
|포함되는 백업 스토리지|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
...
|복제본 수|1|1|1|1|1|
|다중 AZ|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
|읽기 확장|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|복제본 수|1|1|1|1|
|다중 AZ|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
|읽기 확장|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|TempDB 최대 데이터 크기 (GB)|224|256|288|320|384|384|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|최대 데이터 IOPS (64 KB)|35000|40000|45000|50000|80,000|120000|
...
|최대 데이터 IOPS (64 KB)|8000|16000|24000|32000|40000|48000|56000|
...
|스토리지 형식|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|최대 데이터 IOPS (64 KB)|64000|72000|80,000|96000|128000|160000|320000|
...
|메모리 내 OLTP 스토리지(GB)|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|최대 데이터 IOPS (64 KB)| [참고 1](#note-1) |[참고 1](#note-1)|[참고 1](#note-1) |[참고 1](#note-1) |[참고 1](#note-1) |[참고 1](#note-1) |[참고 1](#note-1) | [참고 1](#note-1) |
