...
|[RBPEX](sql-database-service-tier-hyperscale.md#compute) 크기가|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|
...
|최대 로그 전송률 (MBps)|105 |105 |105 |105 |105 |105 |
...
|[RBPEX](sql-database-service-tier-hyperscale.md#compute) 크기가|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|3 x 메모리|
...
|최대 로그 전송률 (MBps)|105 |105 |105 |105 |105 |105 |105 |
