...
\*8kb에서 64 KB 사이의 최대 IO 크기 값입니다. 실제 IOPS는 워크 로드에 따라 달라 집니다. 자세한 내용은 [데이터 IO 관리](sql-database-resource-limits-database-server.md#resource-governance)를 참조 하세요.
