...
### <a name="error-26-error-locating-serverinstance-specified"></a>오류 26: 지정 된 서버/인스턴스를 찾는 동안 오류가 발생 했습니다.
...
* [Azure SQL 연결 아키텍처](https://docs.microsoft.com/azure/sql-database/sql-database-connectivity-architecture)<br>
