...
[Azure 관리 포털][Management Portal]을 사용하여 Azure SQL 데이터베이스 및 서버를 만들고, 모니터링하고, 관리할 수 있습니다. 이 문서에서는 관리 포털을 사용하여 수행할 수 있는 데이터베이스 작업에 대해 설명합니다.
...
커밋된 트랜잭션을 보조 데이터베이스에 비동기적으로 복제하도록 Azure SQL 데이터베이스를 구성할 수 있습니다. 관리 포털의 지역에서 복제 파트를 사용하여 보조 데이터베이스가 상주할 Azure 지역을 선택할 수 있습니다.
