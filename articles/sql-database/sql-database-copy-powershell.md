---
title: "PowerShell을 사용하여 Azure SQL Database 복사 | Microsoft Docs"
...
> [!NOTE]
> 데이터베이스 크기에 따라 복사 작업을 완료하는 데 다소 시간이 걸릴 수 있습니다.
> 
> 
...
* [Azure SQL Database PowerShell Cmdlet 참조](https://msdn.microsoft.com/library/mt574084\(v=azure.300\).aspx)
