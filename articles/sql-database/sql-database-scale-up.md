---
title: Azure SQL 데이터베이스의 서비스 계층 및 성능 수준 변경
...
4. 변경할 데이터베이스를 클릭합니다.
5. SQL 데이터베이스 블레이드에서 **모든 설정**을 클릭한 다음 **가격 책정 계층(배율 DTU)**을 클릭합니다.
   
   ![가격 책정 계층][1]
6. 새 계층을 선택하고 **선택**을 클릭합니다.
...
3. 업데이트된 데이터베이스를 클릭합니다.
4. **가격 책정 계층**을 선택하고 올바른 계층으로 설정되었는지 확인합니다.
