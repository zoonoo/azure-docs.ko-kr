---
title: PowerShell 예제 - Azure SQL Database Managed Instance 만들기 | Microsoft Docs
description: Azure SQL Database Managd Instance를 만드는 Azure PowerShell 예제 스크립트
...
ms.locfileid: "53336474"
---
# <a name="use-powershell-with-azure-resource-manager-template-to-create-an-azure-sql-database-managed-instance"></a>Azure Resource Manager 템플릿과 함께 PowerShell을 사용하여 Azure SQL Database Managed Instance 만들기
...
이 샘플에서는 Managed Instance에 대한 [유효한 네트워크 환경을 만들](../sql-database-managed-instance-create-vnet-subnet.md)거나 [기존 VNet을 수정](../sql-database-managed-instance-configure-vnet-subnet.md)했다고 가정합니다. 샘플에서는 commandlet [New-AzureRmResourceGroupDeployment](https://docs.microsoft.com/powershell/module/azurerm.resources/new-azurermresourcegroupdeployment) 및 [Get-AzureRmVirtualNetwork](https://docs.microsoft.com/powershell/module/azurerm.network/get-azurermvirtualnetwork)를 사용하므로 다음 PowerShell 모듈을 설치해야 합니다.
...
```
Azure VNet에 적절히 구성된 서브넷이 이미 있다고 가정합니다. 그렇지 않은 경우 독립적으로 실행하거나 이 템플릿에 포함될 수 있는 별도의 [Azure Resource Managed 템플릿](https://github.com/Azure/azure-quickstart-templates/tree/master/101-sql-managed-instance-azure-environment)을 사용하여 네트워크 환경을 준비합니다.
