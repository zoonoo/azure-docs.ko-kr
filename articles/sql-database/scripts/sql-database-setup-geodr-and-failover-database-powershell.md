---
title: PowerShell 예제-활성 지역 복제-독립 실행형 Azure SQL Database | Microsoft Docs
...
이 PowerShell 스크립트 예제는 단일 데이터베이스에 대해 활성 지역 복제를 구성하고 데이터베이스의 보조 복제본으로 장애 조치(failover)를 수행합니다.
