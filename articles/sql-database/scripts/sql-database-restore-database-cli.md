---
title: CLI 예제 백업 복원 - Azure SQL Database
description: 자동 백업에서 이전 시점으로 Azure SQL 단일 데이터베이스를 복원하는 Azure CLI 예제 스크립트
...
ms.locfileid: "80067371"
---
# <a name="use-cli-to-restore-an-azure-sql-single-database-to-an-earlier-point-in-time"></a>CLI를 사용하여 Azure SQL 단일 데이터베이스를 이전 시점으로 복원

이 Azure CLI 스크립트 예제는 Azure SQL 데이터베이스를 특정 시점으로 복원합니다.  
...
| | |
|---|---|
| [az sql db restore](/cli/azure/sql/db#az-sql-db-restore) | 데이터베이스 복원 명령입니다. |
