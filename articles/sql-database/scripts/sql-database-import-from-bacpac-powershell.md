...
| [New-AzureRmSqlServerFirewallRule](/powershell/module/azurerm.sql/new-azurermsqlserverfirewallrule) | 입력한 IP 주소 범위의 SQL Database 서버에 있는 모든 단일 데이터베이스와 풀링된 데이터베이스에 액세스가 가능하도록 SQL Database 서버 방화벽 규칙을 만듭니다. |
