...
Azure Preview 포털에서 동적 데이터 마스킹 정책을 설정한 다음 데이터베이스에 액세스하는 응용 프로그램이나 다른 클라이언트에서 사용하는 보안 사용 연결 문자열을 통해 설정을 완료합니다.
...
3. **동적 데이터 마스킹** 타일을 클릭하여 **동적 데이터 마스킹** 구성 블레이드를 시작합니다.
	...
	* 아래쪽의 작업 **섹션**으로 스크롤한 다음 **동적 데이터 마스킹**을 클릭해도 됩니다.
...
13. **보안 지원 액세스** 아래에서 **옵션** 또는 **필수**를 클릭합니다. 자세한 내용은 [보안 지원 연결 문자열](#Anchor1)을 참조하세요.
