...
---
# <a name="get-started-with-sql-database-dynamic-data-masking-azure-portal"></a>SQL 데이터베이스 동적 데이터 마스킹 시작(Azure 포털)
...
## <a name="sql-database-dynamic-data-masking-basics"></a>SQL 데이터베이스 동적 데이터 마스킹 관련 기본 사항
