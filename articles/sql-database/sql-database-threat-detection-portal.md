---
title: "Azure Portal: 위협 감지 구성 - SQL Database | Microsoft 문서"
description: "Azure Portal에서 위협 감지 구성 및 관리"
...
---
# <a name="configure-and-manage-azure-sql-database-threat-detection-in-the-azure-portal"></a>Azure Portal에서 Azure SQL Database 위협 감지 구성 및 관리

이 항목에서는 위협 감지를 설정하고 비정상적인 데이터베이스 활동을 탐색하는 방법을 보여 줍니다. Azure SQL Database 위협 감지의 개요는 [위협 감지 개요](sql-database-threat-detection.md)를 참조하세요.
...
* SQL Database 위협 감지의 개요는 [위협 감지](sql-database-threat-detection.md)를 참조하세요.
