...
## <a name="azure-portal-create-a-managed-instance"></a>Azure 포털: 관리되는 인스턴스 만들기

Azure SQL Database 관리형 인스턴스를 만드는 방법을 보여 주려면 [빠른 시작: Azure SQL 데이터베이스 관리 인스턴스 만들기](sql-database-managed-instance-get-started.md)를 참조하십시오.

## <a name="powershell-create-and-manage-managed-instances"></a>PowerShell: 관리되는 인스턴스 생성 및 관리
...
> [!TIP]
> PowerShell 예제 스크립트의 경우 [빠른 시작 스크립트: PowerShell 라이브러리를 사용하여 Azure SQL 관리형 인스턴스 만들기를](https://blogs.msdn.microsoft.com/sqlserverstorageengine/20../../quick-start-script-create-azure-sql-managed-instance-using-powershell/)참조하십시오.
...
|[제거-아즈Sql인스턴스](https://docs.microsoft.com/powershell/module/az.sql/remove-azsqlinstance)|Azure SQL Database Managed Instance를 제거합니다.|
|[뉴 아즈Sql인스턴스데이터베이스](https://docs.microsoft.com/powershell/module/az.sql/new-azsqlinstancedatabase)|Azure SQL Database Managed Instance 데이터베이스 만들기|
|[받기-아즈Sql인스턴스데이터베이스](https://docs.microsoft.com/powershell/module/az.sql/get-azsqlinstancedatabase)|Azure SQL Managed Instance 데이터베이스에 대한 정보를 반환합니다.|
|[제거-아즈Sql인스턴스데이터베이스](https://docs.microsoft.com/powershell/module/az.sql/remove-azsqlinstancedatabase)|Azure SQL Database Managed Instance 데이터베이스를 제거합니다.|
...
## <a name="azure-cli-create-and-manage-managed-instances"></a>Azure CLI: 관리되는 인스턴스 만들기 및 관리
...
## <a name="transact-sql-create-and-manage-instance-databases"></a>SQL 거래: 인스턴스 데이터베이스 생성 및 관리
...
> [!TIP]
> Microsoft Windows에서 SQL Server 관리 스튜디오를 사용하여 관리되는 인스턴스를 구성하고 연결해야 한다는 것을 보여주는 빠른 시작의 경우 [빠른 시작: Azure VM 구성을 참조하여 Azure SQL Database 관리 인스턴스및](sql-database-managed-instance-configure-vm.md) [빠른 시작에 연결합니다.](sql-database-managed-instance-configure-p2s.md)
> [!IMPORTANT]
> Transact-SQL을 사용하여 Managed Instance를 만들거나 삭제할 수 없습니다.

| 명령 | 설명 |
| --- | --- |
|[데이터베이스 만들기](https://docs.microsoft.com/sql/t-sql/statements/create-database-transact-sql?view=azuresqldb-mi-current)|새 Managed Instance 데이터베이스를 만듭니다. 새 데이터베이스를 만들려면 master 데이터베이스에 연결해야 합니다.|
| [데이터베이스 변경](https://docs.microsoft.com/sql/t-sql/statements/alter-database-transact-sql?view=azuresqldb-mi-current) |Azure SQL Managed Instance 데이터베이스를 수정합니다.|

## <a name="rest-api-create-and-manage-managed-instances"></a>REST API: 관리되는 인스턴스 생성 및 관리
