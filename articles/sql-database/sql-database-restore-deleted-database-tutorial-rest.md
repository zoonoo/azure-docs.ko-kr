...
> [AZURE.SELECTOR]
- [삭제된 데이터베이스 복원 - 포털](http://azure.microsoft.com/documentation/articles/sql-database-restore-deleted-database-tutorial-management-portal/)
...
이 가이드에서는 REST API를 사용하여 삭제된 Azure SQL 데이터베이스를 복원하는 방법을 보여줍니다. 보다 자세한 작업의 링크도 제공됩니다.
...
[Azure 포털에서 삭제된 Azure SQL 데이터베이스 복원](http://azure.microsoft.com/documentation/articles/sql-database-restore-deleted-database-tutorial-management-portal/)을 참조하세요.
...
2.	[복원 가능한 삭제된 데이터베이스 가져오기](http://msdn.microsoft.com/library/azure/dn509574.aspx) 작업을 사용하여 복원하려는 삭제된 데이터베이스에 대한 자세한 내용을 알아보세요.

3.	[데이터베이스 복원 만들기 요청](http://msdn.microsoft.com/library/azure/dn509571.aspx) 작업을 사용하여 복원을 시작하세요.
