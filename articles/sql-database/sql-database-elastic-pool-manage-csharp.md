---
title: C#으로 탄력적 데이터베이스 풀 모니터링 및 관리 | Microsoft Docs
...
---
# <a name="monitor-and-manage-an-elastic-database-pool-with-c&#x23;"></a>C&#x23;으로 탄력적 데이터베이스 풀 모니터링 및 관리
...
C&#x23;을 사용하여 [Elastic Database 풀](sql-database-elastic-pool.md)을 관리하는 방법을 알아봅니다. 
...
* 탄력적 풀(관리하려는 풀). 풀을 만들려면 [C#으로 Elastic Database 풀 만들기](sql-database-elastic-pool-create-csharp.md)를 참조하세요.
