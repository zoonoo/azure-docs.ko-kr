...
|성능 수준|GP_Gen4_1|GP_Gen4_2|GP_Gen4_4|GP_Gen4_8|GP_Gen4_16|
|:--- | --: |--: |--: |--: |--: |
|하드웨어 세대|4|4|4|4|4|
|vCore 수|1|2|4|8|16|
|메모리(GB)|7|14|28|56|112|
|Columnstore 지원 여부|예|예|예|예|예|
|메모리 내 OLTP 저장소(GB)|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|저장소 유형|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|
...
|최대 로그 크기|307|307|461|922|1,229|
|TempDB 크기(DB)|32|64|128|256|384|
|대상 IOPS|320|640|1280|2560|5120|
|IO 대기 시간(근사치)|5-7ms(쓰기)
|최대 동시 작업자(요청)|200|400|800|1600|3200|
|최대 동시 로그인|200|400|800|1600|3200|
|허용되는 최대 세션 수|3000|3000|3000|3000|3000|
|복제본 수|1|1|1|1|1|
|다중 AZ|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|읽기 확장|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|포함되는 백업 저장소|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
|||
...
|메모리(GB)|7|14|28|56|112|
|Columnstore 지원 여부|예|예|예|예|예|
|메모리 내 OLTP 저장소(GB)|1|2|4|8|20|
|저장소 유형|연결형 SSD|연결형 SSD|연결형 SSD|연결형 SSD|연결형 SSD|
|최대 데이터 크기(GB)|1024|1024|1024|1024|1024|
|최대 로그 크기|307|307|307|307|307|
|TempDB 크기(DB)|32|64|128|256|384|
|대상 IOPS|5,000|10000|20000|40,000|80,000|
...
|메모리 내 OLTP 저장소(GB)|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|저장소 유형|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|
|최대 데이터 크기(GB)|512|756|1536|2048|3584|
|최대 로그 크기|154|227|461|614|1,075|
|TempDB 크기(DB)|32|64|128|256|384|
|대상 IOPS|320|640|1280|2560|5120|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|최대 동시 작업자(요청)|210|420|840|1,680|3,360|
|최대 동시 로그인|210|420|840|1,680|3,360|
|허용되는 최대 세션 수|3000|3000|3000|3000|3000|
|최대 풀 밀도|100|200|500|500|500|
|최소/최대 탄력적 풀 클릭 중지 수|0, 0.25, 0.5, 1|0, 0.25, 0.5, 1, 2|0, 0.25, 0.5, 1, 2, 4|0, 0.25, 0.5, 1, 2, 4, 8|0, 0.25, 0.5, 1, 2, 4, 8, 16|
|복제본 수|1|1|1|1|1|
|다중 AZ|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|읽기 확장|해당 없음|해당 없음|해당 없음|해당 없음|해당 없음|
|포함되는 백업 저장소|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
