<properties 
   pageTitle="REST API를 통해 지정 시간 복원 기능을 사용하여 Azure SQL 데이터베이스 복원" 
   description="지정 시간 복원, Microsoft Azure SQL 데이터베이스, 데이터베이스 복원, 데이터베이스 복구, REST API" 
...
# REST API를 통해 지정 시간 복원 기능을 사용하여 Azure SQL 데이터베이스 복원
...
- [지정 시간 복원 - PowerShell](http://azure.microsoft.com/documentation/articles/sql-database-point-in-time-restore-tutorial-powershell/) 

## 개요

이 가이드에서는 REST API를 통해 지정 시간 복원 기능을 사용하여 Azure SQL 데이터베이스를 복원하는 방법을 설명합니다. 보다 자세한 작업의 링크도 제공됩니다.
