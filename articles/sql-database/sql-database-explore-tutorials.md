---
title: Azure SQL 데이터베이스 자습서 탐색 | Microsoft Docs
...
| [PowerShell을 사용하여 Azure SQL 데이터베이스 복사](sql-database-copy-powershell.md#copy-your-sql-database) |이 자습서에서는 PowerShell을 사용하여 Azure SQL 데이터베이스를 복사하는 방법을 알아봅니다. |
