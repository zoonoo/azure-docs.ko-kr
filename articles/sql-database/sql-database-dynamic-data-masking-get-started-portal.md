---
title: SQL 데이터베이스 동적 데이터 마스킹 시작(Azure 클래식 포털)
...
> [!NOTE]
> Azure 포털에서 동적 데이터 마스킹을 설정하려면 [SQL 데이터베이스 동적 데이터 마스킹(Azure 포털)](sql-database-dynamic-data-masking-get-started.md)을 참조하세요.
> 
> 
