...
이 문서에서는 [SSMS(SSMS)에서](https://msdn.microsoft.com/library/hh213248.aspx) [항상 암호화된 마법사를](https://msdn.microsoft.com/library/mt459280.aspx) 사용하여 데이터베이스 암호화를 사용하여 SQL 데이터베이스에서 중요한 데이터를 보호하는 방법을 보여 주었습니다. 그뿐 아니라 Windows 인증서 저장소에 암호화 키를 저장하는 방법을 보여 줍니다.
...
* SSMS에서 항상 암호화된 마법사를 사용하여 [항상 암호화된 키를](https://msdn.microsoft.com/library/mt163865.aspx#Anchor_3)만듭니다.
  * [CMK(열 마스터 키)](https://msdn.microsoft.com/library/mt146393.aspx)만들기.
  * [CEK(열 암호화 키)](https://msdn.microsoft.com/library/mt146372.aspx)만들기.
...
* [비주얼 스튜디오](https://www.visualstudio.com/downloads/download-visual-studio-vs.aspx).

## <a name="create-a-blank-sql-database"></a>빈 SQL 데이터베이스 만들기

1. [Azure 포털에](https://portal.azure.com/)로그인합니다.
2. 리소스 > **데이터 만들기 + 저장소** > **SQL 데이터베이스** **만들기를**클릭합니다.
...
1. **SQL 데이터베이스를** > 클릭**클리닉** > **데이터베이스 연결 문자열 표시**.
...
1. SSMS를 엽니다. (데이터베이스**엔진** **연결을** > 클릭하여 열려 있지 않은 경우 **서버 연결** 창을 엽니다.)
...
**클리닉** > **보안** > **항상 암호화 된 키로**이동하여 SSMS에서 키의 생성을 확인할 수 있습니다. 이제 마법사에서 생성한 새 키를 볼 수 있습니다.
...
2. **데이터베이스 엔진** **연결을** > 클릭하여 서버 에 **연결** 창을 연 다음 **옵션을**클릭합니다.
...
* [SQL 서버 암호화](https://msdn.microsoft.com/library/bb510663.aspx)
* [항상 암호화된 마법사](https://msdn.microsoft.com/library/mt459280.aspx)
* [항상 암호화된 블로그](https://blogs.msdn.com/b/sqlsecurity/archive/tags/always-encrypted/)