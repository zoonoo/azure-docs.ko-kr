...
> [AZURE.NOTE] 탄력적 풀은 현재 미리 보기 상태인 인도 서부를 제외한 모든 Azure 지역에서 일반 공급(GA) 상태입니다.  이 영역에서 탄력적 풀의 GA는 가능한 한 빨리 수행될 예정입니다.
...
### <a name="limits-for-elastic-databases"></a>탄력적 데이터베이스에 대한 제한
