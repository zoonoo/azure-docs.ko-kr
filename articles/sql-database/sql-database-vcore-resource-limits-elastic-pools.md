...
|메모리 내 OLTP 저장소(GB)|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|로그 전송률 제한 (MBps)|4.6875|9.375|14.0625|18.75|23.4375|28.125|
...
|최대 로그 크기(GB)|461|614|614|614|1,075|1229|
|TempDB 크기(GB)|224|256|288|320|384|384|
|스토리지 형식|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|대상 IOPS(64KB)|3500|4000|4500|5,000|7000|7000|
|로그 전송률 제한 (MBps)|32.8125|37.5|37.5|37.5|37.5|37.5|
...
|메모리 내 OLTP 저장소(GB)|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
|최대 데이터 크기(GB)|512|756|756|1536|1536|1536|
...
|로그 전송률 제한 (MBps)|4.6875|9.375|14.0625|18.75|23.4375|28.125|32.8125|
...
|최대 로그 크기(GB)|614|614|922|922|1229|1229|1229|
|TempDB 크기(GB)|384|384|384|384|384|384|384|
|스토리지 형식|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|프리미엄(원격) 저장소|
|IO 대기 시간(근사치)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|5-7ms(쓰기)<br>5-10ms(읽기)|
|대상 IOPS(64KB)|7000|7000|7000|7000|7000|7000|7000|
|로그 전송률 제한 (MBps)|37.5|37.5|37.5|37.5|37.5|37.5|37.5|
|풀당 최대 동시 작업자(요청)*|1,680|1890|2100|2520|33600|4200|8400|
|풀 당 최대 동시 로그인 수 (요청) *|1,680|1890|2100|2520|33600|4200|8400|
...
|로그 전송률 제한 (MBps)|10|20|30|40|50|60|
|풀당 최대 동시 작업자(요청)*|210|420|630|840|1050|1260|
|풀 당 최대 동시 로그인 수 (요청) *|210|420|630|840|1050|1260|
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|
|데이터베이스별로 최소/최대 탄력적 풀 vcore 선택|해당 사항 없음|0, 0.25, 0.5, 1, 2|0, 0.25, 0.5, 1...3|0, 0.25, 0.5, 1...4|0, 0.25, 0.5, 1...5|0, 0.25, 0.5, 1...6|
|복제본 수|4|4|4|4|4|4|
|다중 AZ|예|예|예|예|예|예|
|읽기 확장|예|예|예|예|예|예|
|포함되는 백업 저장소|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
...
|Columnstore 지원 여부|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|
...
|로그 전송률 제한 (MBps)|70|80|80|80|80|80|
|풀당 최대 동시 작업자(요청)*|1470|1,680|1890|2100|3,360|5040|
|풀 당 최대 동시 로그인 수 (요청) *|1470|1,680|1890|2100|3,360|5040|
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|
|데이터베이스별로 최소/최대 탄력적 풀 vcore 선택|0, 0.25, 0.5, 1...7|0, 0.25, 0.5, 1...8|0, 0.25, 0.5, 1...9|0, 0.25, 0.5, 1...10|0, 0.25, 0.5, 1...10, 16|0, 0.25, 0.5, 1...10, 16, 24|
|복제본 수|4|4|4|4|4|4|
|다중 AZ|예|예|예|예|예|예|
...
|로그 전송률 제한 (MBps)|15|30|45|60|75|90|105|
|풀당 최대 동시 작업자(요청)*|210|420|630|840|1050|1260|1470|
|풀 당 최대 동시 로그인 수 (요청) *|210|420|630|840|1050|1260|1470|
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|30000|
...
|스토리지 형식|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|대상 IOPS(64KB)|40000|45000|50000|60000|80,000|100000|200000|
|로그 전송률 제한 (MBps)|120|120|120|120|120|120|120|
|풀당 최대 동시 작업자(요청)*|1,680|1890|2100|2520|3,360|4200|8400|
|풀 당 최대 동시 로그인 수 (요청) *|1,680|1890|2100|2520|3,360|4200|8400|
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|30000|
