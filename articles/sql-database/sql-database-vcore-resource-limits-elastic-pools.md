...
|메모리 내 OLTP 스토리지(GB)|N/A|해당 사항 없음|해당 사항 없음|해당 사항 없음|해당 사항 없음|N/A|
|최대 데이터 크기(GB)|512|756|756|1536|1536|1536|
|최대 로그 크기|154|227|227|461|461|461|
|TempDB 크기(GB)|32|64|96|128|160|192|
|스토리지 형식|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|
...
|스토리지 형식|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|프리미엄(원격) 스토리지|
