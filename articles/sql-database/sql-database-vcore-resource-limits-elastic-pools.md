---
title: Azure SQL Database vCore 리소스 제한-탄력적 풀 | Microsoft Docs
...
|풀당 최대 동시 작업자(요청)*|1,680|1890|2,100개의|2520|3,360|4200|8400|
...
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|
|데이터베이스별로 최소/최대 탄력적 풀 vcore 선택|해당 없음|0, 0.25, 0.5, 1, 2|0, 0.25, 0.5, 1...3|0, 0.25, 0.5, 1...4|0, 0.25, 0.5, 1...5|0, 0.25, 0.5, 1...6|
|복제본 수|4|4|4|4|4|4|
|다중 AZ|예|예|예|예|예|예|
|읽기 확장|예|예|예|예|예|예|
|포함되는 백업 스토리지|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
...
|풀 당 최대 동시 로그인 수 (요청) *|210|420|630|840|1050|1260|1470|
|허용되는 최대 세션 수|30000|30000|30000|30000|30000|30000|30000|
|데이터베이스별로 최소/최대 탄력적 풀 vcore 선택|해당 없음|0, 0.25, 0.5, 1...4|0, 0.25, 0.5, 1...6|0, 0.25, 0.5, 1...8|0, 0.25, 0.5, 1...10|0, 0.25, 0.5, 1...12|0, 0.25, 0.5, 1...14|
|복제본 수|4|4|4|4|4|4|4|
|다중 AZ|예|예|예|예|예|예|
|읽기 확장|예|예|예|예|예|예|예|
|포함되는 백업 스토리지|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|DB 크기의 1배|
