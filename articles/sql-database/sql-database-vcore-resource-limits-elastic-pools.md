...
|최대 로그 크기(GB)|614|614|614|614|1,075|1,229|
...
|TempDB 크기(GB)|64|96|128|160|192|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|대상 IOPS(64KB)|10000|15000|20000|25000|30000|
|로그 전송률 제한 (MBps)|20|30|40|50|60|
|풀당 최대 동시 작업자(요청)*|420|630|840|1050|1260|
...
|메모리(GB)|20.4|30.6|40.8|51|61.2|71.4|
|풀당 최대 DB|100|100|100|100|100|100|
|Columnstore 지원 여부|yes|yes|yes|yes|yes|yes|
|메모리 내 OLTP 스토리지(GB)|3.142|4.713|6.284|8.655|11.026|13.397|
|최대 데이터 크기(GB)|1024|1536|1536|1536|3072|3072|
|최대 로그 크기(GB)|307|307|461|461|922|922|
|TempDB 크기(GB)|128|192|256|320|384|384|
|스토리지 유형|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|로컬 SSD|
|IO 대기 시간(근사치)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|1-2ms(쓰기)<br>1-2ms(읽기)|
|대상 IOPS(64KB)|10000|15000|20000|25000|30000|35000|
|로그 전송률 제한 (MBps)|30|45|60|75|90|105|
|풀당 최대 동시 작업자(요청)*|420|630|840|1050|1260|1470|
