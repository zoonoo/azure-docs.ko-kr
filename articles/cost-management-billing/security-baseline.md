...
- 다단계 인증 - Azure AD MFA를 사용하도록 설정하고 MFA 설정의 몇 가지 모범 사례에 대한 Azure Security Center ID 및 액세스 관리 추천 사항을 따릅니다. MFA는 로그인 조건 및 위험 요소에 따라 모든 사용자나 일부 사용자에게 또는 사용자별 수준에서 적용할 수 있습니다.
