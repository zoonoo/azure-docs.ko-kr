...
_ **예제 1** : 8 vCore에 대해 Azure Database for MySQL 예약된 용량을 구입합니다. 예약의 나머지 특성과 일치하는 16 vCore Azure Database for MySQL 서버를 실행하는 경우 MySQL 서버 컴퓨팅 사용량의 8 vCore에 대한 종량제 가격이 청구되고 1시간의 8 vCore MySQL 서버 컴퓨팅 사용량에 대해 예약 할인이 적용됩니다.</br>
