...
MCA(Microsoft 고객 계약) 또는 MPA(Microsoft 파트너 계약)가 있는 경우 타사 서비스에는 나머지 Azure 서비스가 청구됩니다. [청구 계정 유형을 확인](#check-billing-account-type)하여 MCA 또는 MPA에 액세스할 수 있는지 확인합니다. 이 경우에는 [Azure Portal에서 청구서 보기 및 다운로드](download-azure-invoice.md)를 참조하여 타사 요금을 확인합니다.
