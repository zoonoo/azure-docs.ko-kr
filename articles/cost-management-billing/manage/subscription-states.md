...
| **경고함** | Azure 구독은 경고 상태에 있으며 정상적으로 사용할 수 있지만 경고 이유가 해결되지 않으면 곧 비활성화됩니다. 구독 기간이 지났거나, 사용자가 취소했거나, 구독이 만료된 경우 구독이 경고 상태일 수 있습니다.<br><br>모든 작업이 가능합니다. |
