...
- 고객 테넌트 내에서 [Azure VNet(Virtual Network)](../../virtual-network/index.yml) 및 가상 네트워크 및 vNIC(가상 네트워크 인터페이스 카드)를 배포하고 관리합니다.
...
- [정책을 통해 관리 ID를 사용하여](https://github.com/Azure/Azure-Lighthouse-samples/tree/master/templates/create-keyvault-secret) 디스크 암호화에 대한 암호, 비밀 또는 암호화 키의 Azure KeyVault와 통합하여 비밀을 고객 테넌트의 Key Vault에 저장하도록 합니다.
