...
**내 고객** 페이지에는 구독 또는 리소스 그룹을 위임한 고객에 대한 정보만 표시됩니다. [클라우드 솔루션 공급자 프로그램](https://docs.microsoft.com/partner-center/csp-overview) 등을 통해 다른 고객과 작업하는 경우 위임된 리소스 관리를 위해 리소스를 온보딩하지 않으면 여기에서 해당 고객에 대한 정보를 볼 수 없습니다.
