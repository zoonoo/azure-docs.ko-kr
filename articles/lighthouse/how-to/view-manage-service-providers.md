...
ms.locfileid: "97617207"
---
# <a name="view-and-manage-service-providers"></a>서비스 공급자 보기 및 관리

[Azure Portal](https://portal.azure.com) 의 **서비스 공급자** 페이지를 통해 고객은 [Azure Lighthouse](../overview.md)를 사용 하는 서비스 공급자를 제어 하 고 표시 유형을 확인할 수 있습니다. 고객은 서비스 공급자에 대 한 세부 정보를 보고, 특정 리소스를 위임 하 고, 새 서비스 공급자 제품을 구입 하 고, 서비스 공급자 액세스를 제거할 수 있습니다.
...
> [!TIP]
> 서비스 공급자는 Azure Portal **내 고객** 으로 이동 하 여 고객에 대 한 정보를 볼 수 있습니다. 자세한 내용은 [고객과 위임된 리소스 보기 및 관리](view-manage-customers.md)를 참조하세요.

## <a name="view-service-provider-details"></a>서비스 공급자 세부 정보 보기

서비스 공급자에 대 한 세부 정보를 보려면 **고객이 서비스 공급자 페이지의** 왼쪽에서 **서비스 공급자 제공** 을 선택할 수 있습니다.
...
고객이 서비스 공급자 제품을 제거 하려는 경우 해당 제품에 대 한 행에서 휴지통 아이콘을 선택 하 여 언제 든 지이를 수행할 수 있습니다. 삭제를 확인한 후에는 해당 서비스 공급자가 이전에 해당 제품에 대해 위임된 고객 리소스에 더 이상 액세스할 수 없습니다.
