...
ms.locfileid: "67672394"
---
# <a name="common-power-bi-workspace-collection-scenarios"></a>일반적인 Power BI 작업 영역 컬렉션 시나리오

Power BI 작업 영역 컬렉션은 주로 대부분의 기존 Power BI API 기능을 애플리케이션을 개발하는 데 사용할 수 있는 Azure 서비스의 일부로 노출합니다.  또한 필요한 리소스 및 Power BI 콘텐츠를 프로그래밍 방식으로 프로비전, 개발 및 배포할 수 있습니다. 자세히 알아보려면 [Microsoft Power BI 작업 영역 컬렉션 시작](get-started.md)을 참조하세요.
...
다음은 애플리케이션에서 **Power BI 작업 영역 컬렉션**을 사용하는 몇 가지 시나리오입니다.

* Power BI Desktop에서 작성된 완전한 대화형 보고서를 새 애플리케이션 토큰 인증 모델을 사용하여 사용자 고유의 애플리케이션 내에 포함할 수 있습니다.
