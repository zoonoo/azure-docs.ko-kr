<properties 
	pageTitle="릴리스 정보: Microsoft HDInsight Emulator for Azure | Azure" 
...
* 로컬 클러스터에 ASV를 구성합니다. 
	...
	3. 전체 URI를 사용하여 해당 계정의 파일에 액세스합니다. asv://{container}@{account}/{path}(또는 데이터에 액세스하기 위해 HTTPS를 사용하려는 경우 asvs://). 예를 들면 다음과 같습니다.
