---
title: "Azure Resource Health - 자습서 | Microsoft Docs"
description: "Azure Service Health는 영향을 주는 Azure 서비스에 문제가 있을 때 개인 설정된 지침 및 지원을 제공하고 예정된 계획된 유지 관리에 대해 준비하도록 도움을 줍니다. Azure Service Health는 대상 및 유연한 알림을 통해 사용자 및 팀에 경고합니다."
...
Azure Service Health는 영향을 주는 Azure 서비스에 문제가 있을 때 개인 설정된 지침 및 지원을 제공하고 예정된 계획된 유지 관리에 대해 준비하도록 도움을 줍니다. Azure Service Health는 대상 및 유연한 알림을 통해 사용자 및 팀에 경고합니다.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Service Health에 대해 알아보기</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Resource Health의 리소스 종류와 상태 검사에 대해 알아보기</h3>
                    </div>
                </div>
            </div>
        </div>
