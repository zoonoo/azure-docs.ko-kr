...
-   [Jenkins 개요][Jenkins 개요]
-   [Blob 서비스를 사용할 경우의 이점][Blob 서비스를 사용할 경우의 이점]
-   [필수 조건][필수 조건]
-   [Blob 서비스를 Jenkins CI와 함께 사용하는 방법][Blob 서비스를 Jenkins CI와 함께 사용하는 방법]
...
## <a name="overview"></a><span class="short header">개요</span>Jenkins 개요
...
Jenkins에 대한 자세한 내용은 [Meet Jenkins][Meet Jenkins]에서 찾을 수 있습니다.

## <a name="benefits"></a><span class="short header">이점</span>Blob 서비스를 사용할 경우의 이점
...
## <a name="prerequisites"></a><span class="short header">필수 조건</span>필수 조건
...
## <a name="howtouse"></a><span class="short header">Blob 서비스를 사용하는 방법</span>Blob 서비스를 Jenkins CI와 함께 사용하는 방법
...
## <a name="howtoinstall"></a><span class="short header">설치하는 방법</span>Azure 저장소 플러그 인을 설치하는 방법
...
## <a name="howtoconfigure"></a><span class="short header">구성하는 방법</span>저장소 계정을 사용하도록 Azure 저장소 플러그 인을 구성하는 방법
...
## <a name="howtocreatepostbuild"></a><span class="short header">빌드 후 작업을 만드는 방법</span>빌드 아티팩트를 저장소 계정에 업로드하는 빌드 후 작업을 만드는 방법
...
## <a name="components"></a><span class="short header">Blob 서비스 구성 요소</span>Blob 서비스에 사용되는 구성 요소
