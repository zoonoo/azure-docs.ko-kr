...
>[WACOM.NOTE]이 항목에서는 Azure 관리 포털을 사용하여 새 모바일 서비스 프로젝트 및 범용 Windows 앱을 만드는 방법을 보여 줍니다. Visual Studio 2013을 사용하면 기존 Visual Studio 솔루션에 새 모바일 서비스 프로젝트를 추가할 수도 있습니다. 자세한 내용은 [빠른 시작: 모바일 서비스 추가(JavaScript 백 엔드)](http://msdn.microsoft.com/ko-kr/library/windows/apps/xaml/dn263180.aspx)를 참조하세요.
