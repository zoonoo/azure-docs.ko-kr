---
title: Azure Maps에서 mobility 검사 | Microsoft Docs
description: Azure Maps에서 Mobility 검사에 대해 알아봅니다
author: walsehgal
ms.author: v-musehg
ms.date: 06/05/2019
ms.topic: conceptual
...
Azure Maps [Mobility service](https://aka.ms/AzureMapsMobilityService) 공용 전송, 자전거 공유 및 multimodal를 사용 하 여 라우팅 스쿠터 공유 여정 계획 옵션에 대 한 기능을 허용 합니다. 공용 전송에 대 한 서비스 제공 주변 스테이션에 대 한 검색을 중지 및 선 및 예약 검사 및 실시간 공용 같은 정보를 제공 도착, 중지 및 경로 가이드 뿐 아니라 상세 하 고 조직의 다중 모달 방식 단계별 여정 목록을 전송 하 고 서비스 알림을 생성 합니다. 모바일 서비스도 실시간으로 반환 하 고 차량 및 공유 bikes scooters 정적 가용성 정보 자동차를 공유 합니다.

Azure Maps는 동일한 수준의 정보 및 모든 도시 및 국가/지역에 대 한 정확도 없습니다. 전송 중 데이터를 호출 하는 기능은 도시에 따라 다르며 데이터에는 모든 공용 전송 옵션 및 도시를 제공 하는 기관 포함 되지 않을 수 있습니다.

다음 표에서 Azure Maps 모바일 서비스에 대 한 검사 정보를 제공합니다.


| 기호 | 의미 |
|--------|---------|
| *      |국가/지역에 대 한 거의 전체 검사 합니다.|

## <a name="americas"></a>아메리카

| 국가/지역 |  도시 (Metro 영역) |
|----------------|---------|
| 아르헨티나       | <p>Bahía Blanca, 부에노스아이레스, Caleta Olivia, Chivilcoy, Comodoro Rivadavia, 코르도바, Corrientes, 일반 Pico, La Rioja, Mar del Plata, 멘도사, Miramar, Neuquén, Oberá, Olavarría, Paraná, Posadas, Rio Tercero, 로사리오, Salta, San Carlos de Bariloche, San Luis San Pedro 산타 Fe, Tandil, Ushuaia, 빅토리아, 그것 María</p>|
| 바베이도스       |  바베이도스 * |
| 브라질         | <p>Angra dos Reis Anápolis, Apucarana, Aracaju, Araraquara, Araxa, Araçatuba, Bage, Barretos, Bauru, 벨렘, 아래에서 선택한 Horizonte, Blumenau, 비스타, 브라질리아, Caldas Novas, Campina 그란데, 캄피 나 스, Campo 아래에서 선택한, 캄 푸 그란데, Caraguatatuba, Cascavel, Cataguases, Leopoldina e Região, Catalão, Caxias 수행 Sul Chapecó, Cianorte, Conselheiro Lafaiete, Corumbá, Criciúma 않으면 레알 Sul Cuiabá, Curitiba, Curitibanos, Curvelo, Diamantina, Divinópolis, Dourados, Estrela, 페르난도 드 노로냐, Florianópolis, 포르탈레자, Foz 수행 Iguaçu 대표, Garanhuns, Goiania, Governador Valadares, Guarapuava, Imperatriz, Ipatinga, Irati, Itabira, Itabuna, Itajaí, Ituiutaba 않으면 Jaraguá Sul Joao Pessoa, Joinville, Juazeiro 수행 Norte, Juiz de Fora, Jundiaí, Lages, Londrina, Macapa, Macaé, Maceió, Rio Negro Mafra e, 마나우스, Manhuacu, Maringá, Marília, 몬테카를로 Carmelo, Montes Claros, Mossoró, Natal, Osorio, Ourinhos, Ouro Preto, Palmas, Paracatu, Parnaíba, Passo Fundo, Passos, Patos de Minas Patrocínio, Pelotas, Piracicaba, Poco de Caldas, Ponta Grossa 포르토 Alegre, 포르토 Ferreira, 포르토 Seguro, 포르토 벨 호, Praia 그란데, 레시페, Ribeirão Preto, Rio, 리오 브 랑 코, Rondonópolis, Salinas, 엘살바도르, 강남구 Sul, 산타 Maria 수행 하면서도 비용은 줄일 Rita Sapucaí, Santarem, Santos 수행, 상파울루 Gabriel Oeste, 상파울루 Joao del Rei 수행 Tiradentes e Regiao, 상파울루 Jose 수행 Rio Preto, 상파울루 Mateus, 상 파울로, Sorocaba, Carlos 초, 초 Francisco Sul, 초 José dos Campos, 초 Lourenço, 초 Luís, Taubaté, Telemaco Borba, Teofilo Otoni, Teresina, 톨레도, Três Lagoas, Tucurui, Ubatuba, Uberaba, 수행 Uberlândia Ubá, Uruguaiana, Varginha, Vicosa, Videira & Fraiburgo, Vitória, Vitória da Conquista, Volta Redonda, Votuporanga </p>|
| 캐나다 | 밴프 (AB), Brandon (MB), Calgary (AB), Comox Valley (BC), Cowichan Valley (BC), 에드먼턴 (AB), 요새 St. John, Fredericton (NB), (ON) 큰 Sudbury, 큰 밴쿠버, (BC), 핼리팩스 (NS), 캠룹스 (BC), Kelowna (BC), (ON) Kingston, (ON) 런던 멍크턴 (NB) 몬트리올, (QC), Nanaimo (BC), (ON) 오타와, Prince George (BC), Québec 도시 (QC), Red 사슴 (AB), 리자이나 (SK), Rimouski (QC), 새스커툰 (SK), Sherbrooke (QC), Squamish (BC), 세인트 존스 (NL), 햇빛과 Coast, (ON) 프랑크푸르트, 토론토 (ON) (BC) 빅토리아, 휘슬러 BC ( ), (ON) Windsor, Woodstock 위니펙 (MB)</p>|
| 칠레  | <p>Antofagasta, Arica, Aysén, Chillán, Concepción, Constitución, Copiapó, Curicó, Iquique, La Serena y Coquimbo, Linares, Los Angeles (칠레), Los 라고스, 푼 타 아레나스, Rancagua, 산티아고, Talca, Temuco, Valdivia, 발 파라이 소, Viña del 3 월</p>|
| 콜롬비아 | <p>Barranquilla, Bogotá, Bucaramanga, Cali, Cartagena, Ibagué, Medellín, Pasto, Popayán, Santa Marta, Sincelejo, Valledupar</p>|  
| 코스타리카 | San José|
| 에콰도르 | Cuenca, Guayaquil, Manta|
| 멕시코 | Aguascalientes, Mexico City, Guadalajara, Lion, Merida, Monterrey, Puebla, Querétaro, San Luis Potosi|
| 니카라과 | 마나과 | 
| Panamá | Panamá*| 
| 페루 | Cusco, Lima |
| 푸에르토리코 | 산후안 |
...
| 국가/지역 |  도시 (Metro 영역) |
|--------|---------|
| 오스트레일리아      | <p>애들레이드, Alice 스프링, bowen 임, 브리즈번, Bundaberg QLD, Burnie, Cairns, 캔버라, 다윈, Gladstone, 호바트, Innisfail, Launceston,으로, 자기 섬, Maryborough Hervey 베이, 멜버른, New South Wales, 퍼스, RockHampton, 남부 동부 퀸즐랜드, 시드니, Toowoomba, Townsville, 빅토리아, Warwick, Yeppoon</p> |
| 중국 | <p> Changchun, Changsha, 리우데자네이루, 충칭, 대련, Datong, Dongguan, Hangzhou, Jiangyin, Jinan, Nanjing, Nantong, Ningbo, Pingdingshan, Qingdao, Shenyang, Suzhou, Tangshan, Tianjin, Weifang, Wuhan, Wuxi, Yantai, Yixing, Zhuhai, 상하이, 베이징, 광저우, Shenzhen, Zhengzhou</P>| 
| 홍콩 특별 행정구 | 홍콩 특별 행정구 *|
| 마카오 | Macau*|
| 인도 | Ahmedabad Bengaluru, Delhi, 뭄바이, Mysuru|
| 인도네시아 | Bandung, Banyuwangi, Batam, Denpasar, Jakarta, Kediri, Malang, Palembang, Semarang, Surabaya, Surakarta, Yogyakarta |
| 일본 | Shizuoka 시/도, 도쿄, Wakkanai, Yamanashi 시/도 |
| 말레이시아 | 이 포, Johar Bahru, 콸라룸푸르, Penang |
| 뉴질랜드 | 오클랜드, Christchurch, Dunedin, Queenstown, Timaru, 웰링턴|
| 필리핀 | 마닐라 |
| 싱가포르 | 싱가포르 * |
| 대한민국 | 부산, 서울 |
| 대만 | County Changhua 타이베이 | 
| 태국 | 방콕, Chiang Mai | 
| 베트남 | 하노이, 호치민 시 | 
...
| 벨기에        | 벨기에 * |
| 볼리비아        | 라파스, 강남구 de la Sierra | 
| 보스니아 헤르체고비나 | 사라예보 | 
| 불가리아       | <p>Balchik, Blagoevgrad, Burgas, Dobrich, Gabrovo, Haskovo, Kardzhali, Lovech, Nessebar, Pazardzhik, Pleven, Plovdiv, 루즈, Shumen, Sliven, Stara Zagora, Vratsa, Yambol, Varna, Veliko, 소피아</P> |
| 크로아티아 | Crikvenica Dubrovnik, Rijeka, Slovanski Brod, 자그레브 | 
| 키프로스 | Larnaca, Limassol, 니코시아 | 
| 체코 | 로스엔젤레스, 캘리포니아주, Jablonec Karlovy 달라질 Liberec, Ostrava, 프라하 | 
| 덴마크   | 덴마크 * |
| 에스토니아   | Estonia* |   
