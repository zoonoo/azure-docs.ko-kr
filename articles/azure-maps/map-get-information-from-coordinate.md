...
커서의 변경 내용, popup 개체 및 클릭 이벤트는 모두 지도의 [로드 이벤트 수신기](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest#events) 에 생성 되므로 지도 정보를 검색 하기 전에 지도를 완전히 로드할 수 있습니다.
...
커서의 변경 내용, popup 개체 및 클릭 이벤트는 모두 지도의 [로드 이벤트 수신기](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest#events) 에 생성 되므로 좌표 정보를 검색 하기 전에 맵 로드가 완전히 발생 합니다.
