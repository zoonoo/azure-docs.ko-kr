...
이 문서에서는 모든 XML 태그 및 잘 알려진 텍스트 기 하 도형 형식에 대 한 읽기 및 쓰기 지원에 대 한 세부 정보를 제공 합니다. 또한 공간 IO 모듈에서 구분 된 공간 데이터를 구문 분석 하는 방법에 대해 자세히 설명 합니다.
...
| `atom:link`          | 예     | 예     |                                                                                                                            |
| `atom:name`          | 예     | 예     |                                                                                                                            |
| `BalloonStyle`       | 부분 | 부분 | `displayMode`는 지원되지 않습니다. `PopupTemplate`로 변환 됩니다. 쓰려면 작성 하려는 기능의 속성으로 `popupTemplate` 속성을 추가 합니다. |
| `begin`              | 예     | 예     |                                                                                                                            |
| `color`              | 예     | 예     | `#AABBGGRR` 및 `#BBGGRR`를 포함 합니다. CSS 색 문자열로 구문 분석 됨                                                           |
| `colorMode`          | 예     | 아니요      |                                                                                                                            |
| `coordinates`        | 예     | 예     |                                                                                                                            |
| `Data`               | 예     | 예     |                                                                                                                            |
| `description`        | 예     | 예     |                                                                                                                            |
...
| `east`               | 예     | 예     |                                                                                                                            |
| `end`                | 예     | 예     |                                                                                                                            |
| `ExtendedData`       | 예     | 예     | 형식화 되지 않은 `Data``SimpleData` 또는 `Schema`를 지원 하 고 폼 `$[dataName]`엔터티를 대체 합니다.                      |
...
| `heading`            | 부분 | 아니요      | 구문 분석 되었지만 `SimpleDataLayer`에 의해 렌더링 되지 않습니다. 셰이프의 속성에 데이터를 저장 하는 경우에만 씁니다.                 |
| `hotSpot`            | 예     | 부분 | 셰이프의 속성에 데이터를 저장 하는 경우에만 씁니다. 단위는 "픽셀"로만 출력 됩니다.                         |
| `href`               | 예     | 예     |                                                                                                                            |
| `Icon`               | 부분 | 부분 | 구문 분석 되었지만 `SimpleDataLayer`에 의해 렌더링 되지 않습니다. 는 URI 데이터를 포함 하는 경우에만 셰이프의 icon 속성을 씁니다. `href`만 지원됩니다. |
| `IconStyle`          | 부분 | 부분 | `icon`, `heading`, `colorMode`및 `hotspots` 값은 구문 분석 되지만 해당 값은 구문 분석 되지 않습니다 `SimpleDataLayer`         |
| `innerBoundaryIs`    | 예     | 예     |                                                                                                                            |
| `kml`                | 예     | 예     |                                                                                                                            |
| `LabelStyle`         | 아니요      | 아니요      |                                                                                                                            |
| `LatLonBox`          | 예     | 예     |                                                                                                                            |
...
| `Link`               | 예     | 아니요      | 네트워크 링크에는 `href` 속성만 지원 됩니다.                                                                   |
...
| `outline`            | 예     | 예     |                                                                                                                            |
| `overlayXY`          | 아니요      | 아니요      |                                                                                                                            |
| `Pair`               | 부분 | 아니요      | `StyleMap` `normal` 스타일만 지원 됩니다. `highlight`는 지원되지 않습니다.                                   |
| `phoneNumber`        | 예     | 예     |                                                                                                                            |
...
| `Polygon`            | 예     | 예     |                                                                                                                            |
| `PolyStyle`          | 예     | 예     |                                                                                                                            |
| `Region`             | 부분 | 부분 | 문서 수준에서 `LatLongBox` 지원 됩니다.                                                                      |
| `rotation`           | 아니요      | 아니요      |                                                                                                                            |
| `rotationXY`         | 아니요      | 아니요      |                                                                                                                            |
| `scale`              | 아니요      | 아니요      |                                                                                                                            |
| `Schema`             | 예     | 예     |                                                                                                                            |
...
| `SimpleField`        | 예     | 예     |                                                                                                                            |
| `size`               | 아니요      | 아니요      |                                                                                                                            |
| `Snippet`            | 부분 | 부분 | `maxLines` 특성은 무시 됩니다.                                                                                  |
| `south`              | 예     | 예     |                                                                                                                            |
| `Style`              | 예     | 예     |                                                                                                                            |
| `StyleMap`           | 부분 | 아니요      | `StyleMap`의 표준 스타일만 지원 됩니다.                                                                        |
| `styleUrl`           | 부분 | 예     | 외부 스타일 Url은 지원 되지 않습니다.                                                                         |
| `text`               | 예     | 예     | `$[geDirections]` 대체는 지원 되지 않습니다.                                                                          |
| `textColor`          | 예     | 예     |                                                                                                                            |
| `TimeSpan`           | 예     | 예     |                                                                                                                            |
| `TimeStamp`          | 예     | 예     |                                                                                                                            |
| `value`              | 예     | 예     |                                                                                                                            |
| `viewRefreshMode`    | 부분 | 아니요      |  WMS 서비스를 가리키는 경우에는 `onStop`만 접지 오버레이에 대해 지원 됩니다. 는 맵을 이동할 때 URL에 `BBOX=[bboxWest],[bboxSouth],[bboxEast],[bboxNorth]`을 추가 하 고 업데이트 합니다.  |
| `visibility`         | 예     | 예     |                                                                                                                            |
| `west`               | 예     | 예     |                                                                                                                            |
| `when`               | 예     | 예     |                                                                                                                            |
| `width`              | 예     | 예     |                                                                                                                            |
...
| `atom:updated`           | 예     | 예   |                                                                                                |
| `atom:uri`               | 예     | 예   |                                                                                                |
| `geo:lat`                | 예     | 아니요    | `georss:point`로 작성 되었습니다.                                                                   |
| `geo:lon`                | 예     | 아니요    | `georss:point`로 작성 되었습니다.                                                                   |
| `geo:long`               | 예     | 아니요    | `georss:point`로 작성 되었습니다.                                                                   |
| `georss:box`             | 예     | 아니요    | "Rectangle"의 `subType` 속성을 지정 하 여 polygon로 읽습니다.                                |
| `georss:circle`          | 예     | 예   |                                                                                                |
| `georss:elev`            | 예     | 예   |                                                                                                |
...
| `georss:where`           | 예     | 예   |                                                                                                |
| `geourl:latitude`        | 예     | 아니요    | `georss:point`로 작성 되었습니다.                                                                   |
| `geourl:longitude`       | 예     | 아니요    | `georss:point`로 작성 되었습니다.                                                                   |
| `position`               | 예     | 아니요    | 일부 XML 피드는 georss: where 태그를 사용 하 여 래핑하는 대신 위치 태그를 사용 하 여 GML을 래핑합니다. 은이 태그를 읽었지만 georss: where 태그를 사용 하 여 작성 합니다. |
| `rss`                    | 예     | 아니요    | GeoRSS는 ATOM 형식으로 작성 되었습니다.                                                                 |
| `rss:author`             | 예     | 부분 | `atom:author`로 작성 되었습니다.                                                                 |
| `rss:category`           | 예     | 부분 | `atom:category`로 작성 되었습니다.                                                               |
| `rss:channel`            | 예     | 아니요    |                                                                                                |
| `rss:cloud`              | 예     | 아니요    |                                                                                                |
| `rss:comments`           | 예     | 아니요    |                                                                                                |
| `rss:copyright`          | 예     | 부분 | Shape에 `rights` `properties` 속성이 없는 경우 `atom:rights`으로 작성 됩니다.       |
| `rss:description`        | 예     | 부분 | Shape에 `content` `properties` 속성이 없는 경우 `atom:content`으로 작성 됩니다.      |
| `rss:docs`               | 예     | 아니요    |                                                                                                |
| `rss:enclosure`          | 예     | 아니요    |                                                                                                |
| `rss:generator`          | 예     | 아니요    |                                                                                                |
| `rss:guid`               | 예     | 부분 | Shape에 `id` `properties` 속성이 없는 경우 `atom:id`으로 작성 됩니다.         |
| `rss:image`              | 예     | 부분 | Shape에 `logo` `properties` 속성이 없는 경우 `atom:logo`으로 작성 됩니다.      |
| `rss:item`               | 예     | 부분 | `atom:entry`로 작성 되었습니다.                                                                  |
| `rss:language`           | 예     | 아니요    |                                                                                                |
| `rss:lastBuildDate`      | 예     | 부분 | Shape에 `updated` `properties` 속성이 없는 경우 `atom:updated`으로 작성 됩니다.     |
| `rss:link`               | 예     | 부분 | `atom:link`로 작성 되었습니다.                                                                   |
| `rss:managingEditor`     | 예     | 부분 | `atom:contributor`로 작성 되었습니다.                                                            |
| `rss:pubDate`            | 예     | 부분 | Shape에 `published` `properties` 속성이 없는 경우 `atom:published`으로 작성 됩니다.  |
| `rss:rating`             | 예     | 아니요    |                                                                                                |
| `rss:skipDays`           | 예     | 아니요    |                                                                                                |
| `rss:skipHours`          | 예     | 아니요    |                                                                                                |
| `rss:source`             | 예     | 부분 | `atom:link`를 포함 하는 `atom:source`으로 작성 됩니다.                                       |
| `rss:textInput`          | 예     | 아니요    |                                                                                                |
| `rss:title`              | 예     | 부분 | `atom:title`로 작성 되었습니다.                                                                  |
| `rss:ttl`                | 예     | 아니요    |                                                                                                |
| `rss:webMaster`          | 예     | 아니요    |                                                                                                |
...
| 요소 이름            | 읽기 | 쓰기 | 메모                                                                                  |
|-------------------------|------|-------|----------------------------------------------------------------------------------------|
| `gml:coordinates`       | 예  | 아니요    | `gml:posList`로 작성 되었습니다.                                                              |
| `gml:curveMember`       | 예  | 아니요    |                                                                                        |
| `gml:curveMembers`      | 예  | 아니요    |                                                                                        |
| `gml:Box`               | 예  | 아니요    | `gml:Envelope`로 작성 되었습니다.                                                             |
| `gml:description`       | 예  | 예   |                                                                                        |
| `gml:Envelope`          | 예  | 예   |                                                                                        |
| `gml:exterior`          | 예  | 예   |                                                                                        |
...
| `gml:identifier`        | 예  | 예   |                                                                                        |
| `gml:innerBoundaryIs`   | 예  | 아니요    | `gml.interior`를 사용 하 여 작성 됩니다.                                                          |
| `gml:interior`          | 예  | 예   |                                                                                        |
| `gml:LinearRing`        | 예  | 예   |                                                                                        |
| `gml:LineString`        | 예  | 예   |                                                                                        |
| `gml:lineStringMember`  | 예  | 예   |                                                                                        |
| `gml:lineStringMembers` | 예  | 아니요    |                                                                                        |
| `gml:MultiCurve`        | 예  | 아니요    | `gml:LineString` 멤버만 읽습니다. `gml.MultiLineString`으로 작성 됨                  |
| `gml:MultiGeometry`     | 부분  | 부분   | FeatureCollection 으로만 읽습니다.                                              |
| `gml:MultiLineString`   | 예  | 예   |                                                                                        |
| `gml:MultiPoint`        | 예  | 예   |                                                                                        |
| `gml:MultiPolygon`      | 예  | 예   |                                                                                        |
| `gml:MultiSurface`      | 예  | 아니요    | `gml:Polygon` 멤버만 읽습니다. `gml.MultiPolygon`으로 작성 됨                        |
| `gml:name`              | 예  | 예   |                                                                                        |
| `gml:outerBoundaryIs`   | 예  | 아니요    | `gml.exterior`를 사용 하 여 작성 됩니다.                                                          |
| `gml:Point`             | 예  | 예   |                                                                                        |
| `gml:pointMember`       | 예  | 예   |                                                                                        |
...
| `gpx:wpt`                | 예     | 예     |                                                                                             |
| `gpx_style:color`        | 예     | 예     |                                                                                             |
| `gpx_style:line`         | 부분 | 부분 | `color`, `opacity`, `width``lineCap` 지원 됩니다.                                           |
| `gpx_style:opacity`      | 예     | 예     |                                                                                             |
| `gpx_style:width`        | 예     | 예     |                                                                                             |
| `gpxx:DisplayColor`      | 예     | 아니요      | 모양의 색을 지정 하는 데 사용 됩니다. 쓰는 경우 `gpx_style:line` 색이 대신 사용 됩니다.  |
| `gpxx:RouteExtension`    | 부분 | 아니요      | 모든 속성은 `properties`로 읽혀집니다. `DisplayColor`만 사용 됩니다.                     |
| `gpxx:TrackExtension`    | 부분 | 아니요      | 모든 속성은 `properties`로 읽혀집니다. `DisplayColor`만 사용 됩니다.                     |
| `gpxx:WaypointExtension` | 부분 | 아니요      | 모든 속성은 `properties`로 읽혀집니다. `DisplayColor`만 사용 됩니다.                     |
| `gpx:keywords`           | 예     | 예     |                                                                                             |
| `gpx:fix`                | 예     | 예     |                                                                                             |
...
쉼표로 구분 된 값 파일 (CSV)과 같은 구분 된 공간 데이터에는 종종 공간 데이터를 포함 하는 열이 있습니다. 예를 들어 위도 및 경도 정보를 포함 하는 열이 있을 수 있습니다. 잘 알려진 텍스트 형식에는 공간 기 하 도형 데이터를 포함 하는 열이 있을 수 있습니다.
...
데이터의 첫 행은 잘 알려진 텍스트 형식으로 된 문자열을 검색 합니다. 
