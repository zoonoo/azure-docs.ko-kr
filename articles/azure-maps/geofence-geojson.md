...
* `MultiPoint`, `MultiLineString`, `MultiPolygon` 또는 `GeometryCollection`을 포함하는 각 기능의 경우 속성이 모든 요소에 적용됩니다. 예를 들어의 `MultiPoint` 모든 지점은 동일한 반경을 사용 하 여 여러 원 지 오를 형성 합니다.
