...
Read 함수의 결과는 `SpatialDataSet` 개체입니다. 이 개체는 GeoJSON FeatureCollection 클래스를 확장 합니다. 이를 `DataSource` 그대로에 쉽게 전달 하 여 지도에 기능을 렌더링할 수 있습니다. 는 `SpatialDataSet` 기능 정보를 포함할 뿐만 아니라 다음 표에 설명 된 대로 KML 그라운드 오버레이, 처리 메트릭 및 기타 세부 정보를 포함할 수도 있습니다.
...
다음 코드에서는 공간 데이터 집합을 읽고 `SimpleDataLayer` 클래스를 사용 하 여 map에서 렌더링 하는 방법을 보여 줍니다. 이 코드는 URL에서 가리키는 .GPX) 파일을 사용 합니다.

<br/>

<iframe height='500' scrolling='no' title='공간 데이터를 간단 하 게 로드' src='//codepen.io/azuremaps/embed/yLNXrZx/?height=500&theme-id=0&default-tab=js,result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>에서 펜으로 <a href='https://codepen.io/azuremaps/pen/yLNXrZx/'>공간 데이터를 간단</a> 하 게<a href='https://codepen.io/azuremaps'>@azuremaps</a>로드 Azure Maps ()를 참조 하세요.
</iframe>
...
<iframe height='500' scrolling='no' title='구분 된 파일 추가' src='//codepen.io/azuremaps/embed/ExjXBEb/?height=500&theme-id=0&default-tab=js,result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>에서 펜으로 <a href='https://codepen.io/azuremaps/pen/ExjXBEb/'>구분 된 파일 추가</a> Azure Maps (<a href='https://codepen.io/azuremaps'>@azuremaps</a>)를 참조 하세요.
</iframe>
...
<iframe height='700' scrolling='no' title='공간 데이터 쓰기 옵션' src='//codepen.io/azuremaps/embed/YzXxXPG/?height=700&theme-id=0&default-tab=result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>의 Azure Maps (<a href='https://codepen.io/azuremaps'>@azuremaps</a>)로 펜 <a href='https://codepen.io/azuremaps/pen/YzXxXPG/'>공간 데이터 쓰기 옵션</a> 을 확인 하세요.
</iframe>
...
<iframe height='700' scrolling='no' title='공간 파일을 맵으로 끌어서 놓기' src='//codepen.io/azuremaps/embed/zYGdGoO/?height=700&theme-id=0&default-tab=result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>에서 펜으로 <a href='https://codepen.io/azuremaps/pen/zYGdGoO/'>공간 파일 끌어서 놓기</a> Azure Maps (<a href='https://codepen.io/azuremaps'>@azuremaps</a>)를 참조 하세요.
</iframe>
...
다음 코드는 잘 알려진 텍스트 문자열 `POINT(-122.34009 47.60995)` 을 읽고 거품형 계층을 사용 하 여 지도에서 렌더링 하는 방법을 보여 줍니다.

<br/>

<iframe height='500' scrolling='no' title='잘 알려진 텍스트 읽기' src='//codepen.io/azuremaps/embed/XWbabLd/?height=500&theme-id=0&default-tab=result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>의 Azure Maps (<a href='https://codepen.io/azuremaps'>@azuremaps</a>)에서 펜으로 <a href='https://codepen.io/azuremaps/pen/XWbabLd/'>잘 알려진 텍스트 읽기</a> 를 참조 하세요.
</iframe>
...
<iframe height='700' scrolling='no' title='잘 알려진 텍스트 읽기 및 쓰기' src='//codepen.io/azuremaps/embed/JjdyYav/?height=700&theme-id=0&default-tab=result&embed-version=2&editable=true' frameborder='no' allowtransparency='true' allowfullscreen='true' style='width: 100%;'><a href='https://codepen.io'>CodePen</a>의 Azure Maps (<a href='https://codepen.io/azuremaps'>@azuremaps</a>)로 펜 <a href='https://codepen.io/azuremaps/pen/JjdyYav/'>읽기 및 쓰기 잘 알려진 텍스트</a> 를 참조 하세요.
</iframe>

## <a name="read-and-write-gml"></a>읽기 및 쓰기 GML

GML은 다른 XML 사양에 대 한 확장으로 자주 사용 되는 공간 XML 파일 사양입니다. 함수를 `atlas.io.core.GmlWriter.write` 사용 하 여 GeoJSON 데이터를 GML 태그로 XML로 작성할 수 있습니다. GML을 포함 하는 XML은 함수를 `atlas.io.core.GmlReader.read` 사용 하 여 읽을 수 있습니다. Read 함수에는 두 가지 옵션이 있습니다.
...
함수 `atlas.io.read` 는 입력 데이터가 XML 임을 `atlas.io.core.GmlReader.read` 검색 했지만 데이터가 다른 지원 공간 XML 형식 중 하나가 아닌 경우 함수를 기본적으로 제공 합니다.
