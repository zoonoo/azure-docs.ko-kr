---
title: 교통 범위 | 마이크로소프트 Azure 지도
description: 이 문서에서는 Microsoft Azure 지도에서 트래픽 범위에 대해 알아봅니다.
author: philmea
ms.author: philmea
ms.date: 09/22/2018
ms.topic: conceptual
...
그러나 지도에는 모든 국가 또는 지역에 대해 동일한 수준의 정보와 정확도가 있는 것은 아닙니다. 다음 표에서는 각 국가 또는 지역에서 요청할 수 있는 교통 정보의 종류에 대한 정보를 제공합니다. 
