...
description: Azure Maps에서 지원되는 검색 범주에 대해 알아봅니다. 지원되는 모든 범주 코드와 각 항목이 나타내는 관심 지점 유형을 확인합니다.
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
ms.locfileid: "92896908"
---
# <a name="azure-maps-supported-categories"></a>Azure Maps에서 지원되는 범주

관심 지점에 대해 [범주 검색](/rest/api/maps/search/getsearchpoicategory)을 수행하는 경우 지원되는 범주는 백 가지가 넘습니다. 아래는 지원되는 범주 이름에 대한 카테고리 코드 목록입니다. 범주 코드는 최상위 수준 범주에 대해 생성됩니다. 모든 하위 범주는 동일한 범주 코드를 공유합니다. 이 범주 목록은 새로운 데이터가 릴리스에 따라 변경될 수 있습니다.
...
| ADMINISTRATIVE\_DIVISION | 시/도, 제4 행정 구역, 제1 행정 구역, 역사적인 제3 행정 구역, 제4 행적 구역의 소재지, 제2 행적 구역의 소재지, 종속 정치 단체, 인구가 많은 장소, 제3 행정 구역의 소재지, 인구가 많은 장소, 제2 행정 구역, 제1 행정 구역의 소재지, 행정 구역, 인구가 많은 지역, 역사적인 지역, 역사적인 장소, 역사적인 인구 밀집 지역, 이스라엘 정착촌, 역사적인 제4 행정 구역, 제5 행정 구역, 역사적인 제1 행정 구역, 제3 행정 구역, 역사적 정치 단체, 역사적인 행정 구역, 정치 단체 정부의 소재지, 역사적인 제2 행정 구역, 정치 단체의 수도/주요 도시 |
