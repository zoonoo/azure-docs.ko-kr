...
1. Postman에서 **새 요청**  |  **가져오기 요청** 을 클릭 하 고 이름으로 **주소 검색**을 클릭 합니다.
...
1. Postman에서 **새 요청**  |  **GET 요청** 을 클릭 하 고 **역 주소 검색**으로 이름을 바꿉니다.
...
1. Postman에서 **새 요청**  |  **가져오기 요청** 을 클릭 하 고 **역 주소 간 검색**으로 이름을 바꿉니다.
...
- [Azure Maps Search Service REST API 설명서](https://docs.microsoft.com/rest/api/maps/search)를 탐색 합니다.
- [Azure Maps Search Service 모범 사례](https://docs.microsoft.com/azure/azure-maps/how-to-use-best-practices-for-search) 와 쿼리를 최적화 하는 방법에 대해 알아봅니다.
