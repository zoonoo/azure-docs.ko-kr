...
description: Azure Portal를 사용 하 여 Azure Maps 계정을 관리 하는 방법을 알아봅니다. 새 계정을 만드는 방법 및 기존 계정을 삭제 하는 방법을 참조 하세요.
author: anastasia-ms
ms.author: v-stharr
ms.date: 01/27/2020
ms.topic: conceptual
...
[![Azure Portal에 Azure Maps 계정 정보를 입력 하십시오.](./media/how-to-manage-account-keys/new-account-portal.png)](./media/how-to-manage-account-keys/new-account-portal.png#lightbox)
