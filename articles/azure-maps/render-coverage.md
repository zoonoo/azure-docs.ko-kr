---
title: 렌더 커버리지 | 마이크로소프트 Azure 지도
description: 이 문서에서는 Microsoft Azure Maps가 있는 지역에 대해 렌더링된 세부 정보 수준과 함께 적용 범위를 렌더링합니다.
...
Azure Maps는 래스터 타일 및 벡터 타일을 모두 사용하여 맵을 만듭니다. 가장 낮은 해상도에서는 전 세계가 단일 타일에 맞습니다. 가장 높은 해상도에서 단일 타일은 38 평방 미터를 나타냅니다. 맵을 확대할 때 대륙, 지역, 도시 및 개별 거리에 대한 자세한 내용을 볼 수 있습니다. 타일에 대한 자세한 내용은 [확대/축소 수준 및 타일 그리드를](zoom-levels-and-tile-grid.md)참조하십시오.

그러나 지도에는 모든 지역에 대해 동일한 수준의 정보와 정확도가 있는 것은 아닙니다. 다음 표에서는 각 지역에 대해 렌더링할 수 있는 정보 의 수준을 자세히 설명합니다.
