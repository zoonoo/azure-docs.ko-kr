...
시작 하려면 [주변 전송 API 가져오기](/rest/api/maps/mobility/getnearbytransitpreview)를 사용 하 여 가까운 전송 중지를 요청할 수 있습니다.
...
시작 하려면 [전송 라인 API 가져오기 API](/rest/api/maps/mobility/gettransitlineinfopreview)를 사용 하 여 줄 그룹을 요청할 수 있습니다.
