...
세 번째 코드 블록은 경로에 대 한 시작 및 대상 위치를 만듭니다. 그런 다음 데이터 소스에 추가 합니다. [addPins](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-iot-typescript-latest) 사용 방법에 대한 지침은 [지도에 핀 추가](map-add-pin.md)를 참조하세요.
...
> [!div class="nextstepaction"]
> [지도 마우스 이벤트와 상호 작용](./map-events.md)
