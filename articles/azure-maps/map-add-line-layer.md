...
다음 코드는 선을 만드는 방법을 보여 줍니다. 데이터 원본에 줄을 추가한 다음, [LineLayer](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.layer.linelayer?view=azure-iot-typescript-latest) 클래스를 사용하여 선 계층으로 렌더링합니다.
...
선 계층은 [LineLayerOptions](/javascript/api/azure-maps-control/atlas.linelayeroptions?view=azure-iot-typescript-latest) 및 [데이터 기반 스타일 식 사용](data-driven-style-expressions-web-sdk.md)을 사용하여 스타일을 지정할 수 있습니다.
