...
- 사용자 지정 컨트롤을 만드는 경우 기본 제공 컨트롤이 고대비 스타일을 사용 하는지 여부를 확인 하는 것이 유용 합니다. 개발자는 맵 컨테이너 div에 css 클래스를 추가 하 여 확인할 수 있습니다. 추가 되는 css 클래스는 `high-contrast-dark` 및 `high-contrast-light`됩니다. JavaScript를 사용 하 여 확인 하려면 다음을 사용 합니다.
