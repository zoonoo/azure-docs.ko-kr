...
- 색 대비를 통해 색이 혼합되어 서로 구분하기 어려워지지 않도록 해야 합니다. 
...
- 고대비 유형에는 밝은 유형과 어두운 유형, 두 가지가 있습니다. 맵 컨트롤에서 고대비 유형을 검색할 수 있는 경우에는 맵의 동작이 적절하게 조정됩니다. 밝은 유형인 경우 grayscale_light 맵 스타일이 로드됩니다. 유형이 감지될 수 없거나 어두운 유형인 경우 high_contrast_dark 스타일이 로드됩니다.
...
<sup>*</sup> 이러한 바로 가기 키는 일반적으로 키보드에서 동일한 키를 공유합니다. 이러한 바로 가기는 사용자 환경을 향상시키기 위해 추가되었습니다. 또한 사용자가 이러한 바로 가기 키에 Shift 키를 사용하는지 여부는 중요하지 않습니다.
