...
---
# <a name="how-to-view-the-azure-maps-api-usage"></a>Azure Maps API 사용량을 보는 방법
...
4. **메트릭** 창에서 다음 중 하나를 선택합니다.
    ...
    1. 일정 기간 동안의 API 가용성에 대한 *평균*을 보여 주는 **가용성** 또는 
    2. 계정에 대한 사용량(*개수*)을 보여 주는 **사용량** 

    ![Azure Maps 메트릭 창](media/how-to-view-api-usage/portal-metrics.png)

5. 메트릭이 선택되면 기본값인 **지난 12시간(자동)** 을 선택하여 *시간 범위*를 선택할 수 있습니다. 또한 *시간 단위*를 선택하고, 동일한 드롭다운에서 시간을 *로컬* 또는 *GMT*로 표시하도록 선택할 수도 있습니다. **적용**을 클릭합니다.
...
7. 선택한 메트릭 속성에 따라 메트릭에 대한 **분할**을 적용할 수도 있습니다. 이렇게 하면 그래프가 해당 속성의 각 값에 대해 하나씩 여러 그래프로 분할될 수 있습니다. 예를 들어 다음 그림에서 각 그래프의 색은 그래프 아래쪽에 표시된 속성 값에 해당합니다.
...
Azure Maps 사용량을 추적하는 방법을 알아보았으며, 다음 항목을 통해 현재 사용 중인 API에 대해 자세히 알아볼 수 있습니다.
