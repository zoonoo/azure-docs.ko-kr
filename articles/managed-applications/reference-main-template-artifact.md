---
title: Azure 관리 되는 응용 프로그램 템플릿 아티팩트 참조
...
ms.locfileid: "72528946"
---
# <a name="reference-deployment-template-artifact"></a>참조: 배포 템플릿 아티팩트

이 문서는 Azure Managed Applications *maintemplate.json* 아티팩트에 대 한 참조입니다. 배포 템플릿 작성에 대 한 자세한 내용은 [Azure Resource Manager 템플릿](../azure-resource-manager/resource-group-authoring-templates.md)을 참조 하세요.
