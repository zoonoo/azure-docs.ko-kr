---
title: 정책을 사용 하 여 Azure 사용자 지정 공급자에 대 한 연결 배포
...
ms.locfileid: "74932646"
---
# <a name="deploy-associations-for-a-custom-provider-using-azure-policy"></a>Azure 정책을 사용 하 여 사용자 지정 공급자에 대 한 연결 배포
...
연결에 대 한 자세한 내용은 [Azure 사용자 지정 공급자 리소스 온 보 딩](./concepts-custom-providers-resourceonboarding.md) 을 참조 하세요.
...
![기본 제공 정책 할당](media/builtin-policy/assign-builtin-policy-customprovider.png)
...
- [개념: Azure 사용자 지정 공급자 리소스 온 보 딩](./concepts-custom-providers-resourceonboarding.md)
- [자습서: 사용자 지정 공급자를 사용 하 여 리소스 온 보 딩](./tutorial-custom-providers-resource-onboarding.md)
