---
title: Azure Portal을 사용하여 관리되는 응용 프로그램 모니터링 | Microsoft Docs
description: Azure Portal을 사용하여 관리되는 응용 프로그램의 가용성과 경고를 모니터링하는 방법을 설명합니다.
...
관리되는 응용 프로그램을 Azure 구독에 배포한 후에는 응용 프로그램의 상태를 확인할 수 있습니다. 이 문서에서는 상태 확인을 위한 Azure Portal의 옵션에 대해 설명합니다. 관리되는 응용 프로그램에서 리소스의 가용성을 모니터링할 수 있으며, 경고를 설정하고 확인할 수도 있습니다.

## <a name="view-resource-health"></a>리소스 상태 보기

1. 관리되는 응용 프로그램 인스턴스를 선택합니다.

   ![관리되는 응용 프로그램 선택](./media/monitor-managed-application-portal/select-managed-application.png)

1. **Resource Health**를 선택합니다.

   ![Resource Health 선택](./media/monitor-managed-application-portal/select-resource-health.png)

1. 관리되는 응용 프로그램에서 리소스의 가용성을 확인합니다.
