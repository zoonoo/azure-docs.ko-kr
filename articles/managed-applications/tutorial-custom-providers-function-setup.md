---
title: Azure 사용자 지정 공급자를 위한 Azure Functions 설정
...
![테이블 바인딩을 보여주는 사용자 지정 공급자 개요](./media/create-custom-providers/azure-functions-table-bindings.png)
...
![HTTP 메서드를 보여주는 사용자 지정 공급자 개요](./media/create-custom-providers/azure-functions-http-methods.png)
