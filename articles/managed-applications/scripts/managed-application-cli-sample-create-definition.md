...
| 명령 | 메모 |
|---|---|
| [az managedapp definition create](https://docs.microsoft.com/cli/azure/managedapp/definition#az-managedapp-definition-create) | 관리되는 응용 프로그램 정의를 만듭니다. 필요한 파일이 포함된 패키지를 제공합니다. |
