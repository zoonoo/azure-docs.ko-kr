---
title: '빠른 시작: Node.js 웹앱 만들기 - Windows'
description: 몇 분 안에 Windows 플랫폼용 첫 번째 Node.js Hello World를 Azure App Service에 배포합니다.
...
1. **새 웹앱 만들기... 고급** 을 선택하여 Windows의 App Service에 배포합니다.
...
1. 마우스 오른쪽 단추로 앱 서비스의 노드를 한 번 더 클릭하고, **웹앱에 배포** 를 선택합니다.
