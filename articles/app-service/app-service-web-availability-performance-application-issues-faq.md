---
title: "Azure Web Apps에 대한 응용 프로그램 성능 FAQ | Microsoft Docs"
...
느린 앱 성능의 원인에는 여러 요인이 관련될 수 있습니다. 자세한 문제 해결 단계는 [느린 웹앱 성능 문제 해결](app-service-web-troubleshoot-performance-degradation.md)을 참조하세요.
...
자세한 내용은 [Azure 앱 서비스에서 웹 앱 구성](web-sites-configure.md)을 참조하세요.
...
초기 [Kestrel 버전](https://github.com/aspnet/KestrelHttpServer/issues/1182)에서 알려진 문제로 인해 App Service에서 호스트되는 ASP.NET Core 1.0 앱이 간헐적으로 응답을 중지할 수 있습니다. “지정한 CGI 응용 프로그램에서 오류가 발생하여 서버에서 프로세스가 종료되었습니다.”라는 메시지가 표시될 수도 있습니다.
...
웹앱의 아웃바운드 연결에 대한 자세한 내용은 [Azure Websites에 대한 아웃바운드 연결](http://www.freekpaans.nl/2015/08/starving-outgoing-connections-on-windows-azure-web-sites/)에 관한 블로그 게시물을 참조하세요.
