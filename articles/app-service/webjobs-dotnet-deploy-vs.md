...
이 항목에서는 Visual Studio를 사용하여 콘솔 애플리케이션 프로젝트를 [App Service](overview.md)의 웹앱에 [Azure WebJob](https://go.microsoft.com/fwlink/?LinkId=390226)으로 배포하는 방법을 설명합니다. [Azure Portal](https://portal.azure.com)을 사용하여 WebJobs를 배포하는 방법에 대한 내용은 [WebJobs로 백그라운드 작업 실행](webjobs-create.md)을 참조하세요.

Visual Studio는 WebJob 지원 콘솔 애플리케이션 프로젝트를 배포할 때 다음 두 가지 작업을 수행합니다.
