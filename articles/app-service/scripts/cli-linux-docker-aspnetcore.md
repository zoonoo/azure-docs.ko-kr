...
| [`az webapp config container set`](/cli/azure/webapp/config/container?view=azure-cli-latest#az-webapp-config-container-set) | App Service 앱에 대한 Docker 컨테이너를 설정합니다. |
