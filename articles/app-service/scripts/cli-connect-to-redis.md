...
| [`az redis create`](/cli/azure/redis#az-redis-create) | 새 Azure Cache for Redis 인스턴스를 만듭니다. |
| [`az redis list-keys`](/cli/azure/redis#az-redis-list-keys) | Azure Cache for Redis 인스턴스에 대한 액세스 키를 나열합니다. |
