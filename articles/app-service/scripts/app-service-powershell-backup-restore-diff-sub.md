---
title: Azure PowerShell 스크립트 샘플 - 다른 구독에 있는 백업에서 웹앱 복원 | Microsoft Docs
...
ms.locfileid: "52291613"
---
# <a name="restore-a-web-app-from-a-backup-in-another-subscription"></a>다른 구독에 있는 백업에서 웹앱 복원
