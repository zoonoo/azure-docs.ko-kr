...
| [az sql server create](https://docs.microsoft.com/cli/azure/sql/server#az_sql_server_create) | SQL Database 서버를 만듭니다.  |
| [az sql db create](https://docs.microsoft.com/cli/azure/sql/db#az_sql_db_create) | SQL Database 서버를 사용하여 새 데이터베이스를 만듭니다. |
