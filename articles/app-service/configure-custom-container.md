...
이 가이드에서는 App Service의 Linux 앱 컨테이너 화에 대 한 주요 개념 및 지침을 제공 합니다. Azure App Service 사용한 적이 없는 경우 먼저 [사용자 지정 컨테이너 빠른](quickstart-custom-container.md?pivots=container-linux) 시작 및 [자습서](tutorial-custom-container.md?pivots=container-linux) 를 따르세요. [다중 컨테이너 앱 빠른](quickstart-multi-container.md) 시작 및 [자습서](tutorial-multi-container-app.md)도 있습니다.
...
> [!NOTE]
> 사용자 [고유의 영구 저장소를 구성할](configure-connect-to-azure-storage.md?pivots=platform-linux)수도 있습니다.
