...
3. **새 프로젝트 구성** 에서 애플리케이션 이름을 _myFirstAzureWebApp_ 으로 지정한 다음, **만들기** 를 선택합니다.
...
1. **Azure App Service(Windows)** 를 선택하고 **다음** 을 클릭합니다.
...
1. **App Service 인스턴스** 오른쪽에서 **+** 를 클릭합니다.
   ...
   ![새 App Service 앱](./media/quickstart-dotnet-framework/publish-new-app-service.png)
...
1. **호스팅 계획** 대화 상자에서 다음 표의 값을 입력한 다음, **확인** 을 선택합니다.
