...
4. 이제 분기의 워크플로 파일에서: `.github/workflows/workflow.yml` Azure 웹 앱 배포 작업의 입력 `publish-profile` 에 대 한 암호를 바꿉니다.
...
App Service 앱에 코드를 배포 하려면 `azure/webapps-deploy@v2` 작업을 사용 합니다. 이 작업에는 다음과 같은 4 개의 매개 변수가 있습니다.
