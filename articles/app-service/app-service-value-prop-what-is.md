...
[앱 서비스 계획](azure-web-sites-web-hosting-plans-in-depth-overview.md) 은 앱에서 실행되는 계산 리소스의 종류를 지정합니다. 트래픽 부하가 가벼운 경우 공유 VM(**무료** 및 **공유** 가격 책정 계층)을 사용할 수 있습니다. 대량 로드의 경우 전용 VM을 여러 가지 크기 중에서 선택할 수 있습니다(**기본**, **표준** 및 **프리미엄** 계층). 여러 App Service 앱은 동일한 계획을 공유할 수 있고 이러한 계획을 사용하여 가격 책정 계층의 규모를 확장하고 축소합니다.
...
## <a name="testdrive-app-service"></a>App Service 시험 사용
