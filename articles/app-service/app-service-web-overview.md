...
또한 웹앱은 [API Apps](app-service-web-tutorial-rest-api.md)(예: CORS 지원) 및 [Mobile Apps](../app-service-mobile/app-service-mobile-value-prop.md)(예: 푸시 알림)에서 제공하는 기능을 활용할 수 있습니다. 
