...
이 문서에서는 [App Service](app-service-web-overview.md)의 OS 또는 소프트웨어에 대한 특정 버전 정보를 가져오는 방법을 보여 줍니다. 

App Service는 Platform-as-a-Service입니다. 이것은 OS 및 응용 프로그램 스택이 Azure에 의해 관리된다는 것을 의미합니다. 따라서 사용자는 응용 프로그램과 해당 데이터만 관리하면 됩니다. OS 및 응용 프로그램 스택에 대한 추가 제어 기능은 [Azure Virtual Machines](https://docs.microsoft.com/azure/virtual-machines/)에서 사용할 수 있습니다. 이 사실에 유의한다고 해도, 다음과 같은 추가 정보를 알면 App Service를 사용할 때 도움이 될 수 있습니다.
