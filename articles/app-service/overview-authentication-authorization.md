...
기본 모바일 응용 프로그램과 관련된 자세한 내용은 [Azure App Service를 사용하여 모바일 응용 프로그램에 대한 사용자 인증 및 권한 부여](/previous-versions/azure/app-service-mobile/app-service-mobile-auth)를 참조하세요.
