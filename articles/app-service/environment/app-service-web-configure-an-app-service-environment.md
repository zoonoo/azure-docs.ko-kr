...
특정 리소스 풀에서 수동 또는 자동 크기 조정 기능을 사용 하려면 적절 한 **설정**  >  **프런트 엔드 풀**  /  **작업자 풀** 로 이동 합니다. 그런 다음 변경하려는 풀을 엽니다. **설정**  >  **Scale Out** 또는 **설정** 강화로 이동  >  합니다. **규모 확장** 블레이드를 사용하면 인스턴스 수량을 제어할 수 있습니다. **강화** 를 사용하면 리소스 크기를 제어할 수 있습니다.  
