...
|-|-|-|
| AppServiceConsoleLogs | TBA | yes | 표준 출력 및 표준 오류 |
| AppServiceHTTPLogs | yes | yes | 웹 서버 로그 |
| Appservice환경 Platformlogs | yes | yes | App Service Environment: 크기 조정, 구성 변경 및 상태 로그|
| AppServiceAuditLogs | yes | yes | FTP 및 Kudu를 통한 로그인 활동 |
| AppServiceFileAuditLogs | TBA | yes | FTP 및 Kudu를 통해 파일 변경 |
