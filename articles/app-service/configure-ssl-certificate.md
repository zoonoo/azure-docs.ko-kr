---
title: SSL 인증서 추가 및 관리 - Azure App Service | Microsoft Docs
...
| Subscription | 웹앱이 호스팅된 데이터 센터입니다. |
| Resource group | 인증서를 포함하는 리소스 그룹입니다. 예를 들어, 새로운 리소스 그룹을 사용하거나 App Service 앱과 동일한 리소스 그룹을 선택할 수 있습니다. |
