...
2. [**앱 등록**](https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade)로 이동 하 고 요청 된 경우 Microsoft 계정를 사용 하 여 로그인 합니다.
...
3. **Microsoft 계정**을 클릭합니다. 이전에 가져온 애플리케이션 ID 및 암호 값을 붙여넣고 필요에 따라 애플리케이션에 필요한 범위를 설정합니다. 그런 다음 **확인**을 클릭합니다.
