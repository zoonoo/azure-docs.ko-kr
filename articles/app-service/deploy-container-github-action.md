...
ms.locfileid: "98761770"
---
# <a name="deploy-a-custom-container-to-app-service-using-github-actions"></a>GitHub Actions를 사용하여 App Service에 사용자 지정 컨테이너 배포

[GitHub 작업](https://docs.github.com/en/actions) 을 통해 자동화 된 소프트웨어 개발 워크플로를 유연 하 게 빌드할 수 있습니다. [Azure 웹 배포 작업](https://github.com/Azure/webapps-deploy)을 사용 하면 GitHub 작업을 사용 하 여 사용자 지정 컨테이너를 [App Service](overview.md) 에 배포 하는 워크플로를 자동화할 수 있습니다.
