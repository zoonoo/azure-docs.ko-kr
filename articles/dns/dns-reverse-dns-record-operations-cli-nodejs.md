---
title: "Azure CLI 1.0을 사용하여 Azure 서비스에 대한 역방향 DNS 레코드 관리 | Microsoft Docs"
description: "Resource Manager에서 Azure CLI 1.0을 사용하여 Azure 서비스에 대한 역방향 DNS 레코드 또는 PTR 레코드를 관리하는 방법"
services: DNS
...
---
# <a name="how-to-manage-reverse-dns-records-for-your-azure-services-using-the-azure-cli-10"></a>Azure CLI 1.0을 사용하여 Azure 서비스에 대한 역방향 DNS 레코드를 관리하는 방법
