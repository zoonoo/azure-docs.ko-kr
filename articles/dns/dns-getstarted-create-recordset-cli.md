---
title: "CLI를 사용하여 DNS 영역에 대한 레코드 집합 및 레코드 만들기 | Microsoft Docs"
...
---
# <a name="create-dns-record-sets-and-records-by-using-cli"></a>CLI를 사용하여 DNS 레코드 집합 및 레코드 만들기
...
### <a name="1-create-a-record-set"></a>1. 레코드 집합 만들기
...
### <a name="2-add-records"></a>2. 레코드 추가
