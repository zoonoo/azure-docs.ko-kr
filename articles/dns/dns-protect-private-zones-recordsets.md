...
* `Microsoft.Network/privateDNSZones/read`는 DNS 전용 영역을 읽을 수 있는 권한을 부여 하 고 수정 하지는 않지만 CNAME이 생성 되는 영역을 볼 수 있도록 합니다.
...
Azure Resource Manager는 리소스를 잠글 수 있는 다른 유형의 보안 제어를 지원 합니다. 리소스 잠금은 리소스에 적용 되 고 모든 사용자 및 역할에서 적용 됩니다. 자세한 내용은 [Azure 리소스 관리자를 사용하여 리소스 잠그기](../azure-resource-manager/management/lock-resources.md)를 참조하세요.
