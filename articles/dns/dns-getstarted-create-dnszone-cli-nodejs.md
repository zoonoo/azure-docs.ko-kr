---
title: "Azure CLI 1.0을 사용하여 DNS 영역 만들기| Microsoft Docs"
description: "Azure DNS에 DNS 영역을 만드는 방법을 알아봅니다. Azure CLI 1.0을 사용하여 첫 번째 DNS 영역을 만들고 관리하는 단계별 가이드입니다."
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>Azure CLI 1.0을 사용하여 Azure DNS 영역 만들기
