...
## 역방향 DNS 레코드를 사용하여 새 공용 IP 주소 만들기
...
## 기존 공용 IP 주소에 대한 역방향 DNS 레코드 보기
...
- "ReverseFqdn" 정방향이 지정되어 있는 공용 IP 주소의 이름 또는 IP 주소로 확인되거나, 동일한 구독 내의 공용 IP 주소 "Fqdn" 또는 IP로 확인됩니다. 예를 들어 "ReverseFqdn"이 "contosoapp1.northus.cloudapp.azure.com."에 대한 CName 별칭인 "app1.contoso.com."입니다. 유효성 검사는 공용 IP 주소의 역방향 DNS 속성이 설정되거나 수정되는 경우에만 수행됩니다. 유효성 재검사는 정기적으로 수행되지 않습니다.
