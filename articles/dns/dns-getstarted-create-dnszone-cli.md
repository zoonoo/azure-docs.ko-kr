<properties
   pageTitle="CLI를 사용하여 DNS 영역 만들기 | Microsoft Azure"
...
이러한 레코드를 보려면 `azure network dns-record-set show`를 사용합니다.<BR> *사용법: network dns record-set show <resource-group> <dns-zone-name> <name> <type>*
