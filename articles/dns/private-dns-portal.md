---
title: Azure Portal을 사용하여 Azure DNS 프라이빗 영역 만들기
description: 이 자습서에서는 Azure DNS에 프라이빗 DNS 영역 및 레코드를 만들고 테스트합니다. Azure Portal을 사용하여 첫 번째 프라이빗 DNS 영역 및 레코드를 만들고 관리하는 단계별 가이드입니다.
services: dns
author: vhorne
ms.service: dns
ms.topic: tutorial
...
ms.locfileid: "67147810"
---
# <a name="tutorial-create-an-azure-dns-private-zone-using-the-azure-portal"></a>자습서: Azure Portal을 사용하여 Azure DNS 프라이빗 영역 만들기

이 자습서에서는 Azure Portal을 사용하여 첫 번째 프라이빗 DNS 영역 및 레코드를 만드는 단계를 설명합니다.
...
원하는 경우 [Azure PowerShell](private-dns-getstarted-powershell.md) 또는 [Azure CLI](private-dns-getstarted-cli.md)를 사용하여 이 자습서를 완료해도 됩니다.
