...
프레임워크는 수많은 워크로드에 사용할 수 있지만 이 문서에서는 Marathon으로 컨테이너 배포를 만들고 확장할 수 있는 방법을 설명합니다. 
...
![새 응용 프로그램 UI--상태 검사](./media/dcos/dcos_healthcheck.png)
...
컨테이너의 인스턴스 수를 확장하는 데 Marathon UI를 사용할 수 있습니다. 이렇게 하려면 **Marathon** 페이지로 이동하여 확장하려는 컨테이너를 선택하고 **응용 프로그램 확장**을 클릭합니다. **응용 프로그램 확장** 대화 상자에서 원하는 컨테이너 인스턴스 수를 입력하고 **응용 프로그램 확장**을 클릭합니다.
