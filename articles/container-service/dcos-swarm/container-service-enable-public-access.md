...
5. 프로브 양식을 입력하고 **확인**을 클릭합니다.
   ...
   | 필드 | Description |
   | --- | --- |
   | Name |프로브에 대한 설명이 포함된 이름입니다. |
   | 포트 |테스트할 컨테이너의 포트입니다. |
   | 경로 |(HTTP 모드에 있는 경우) 프로브에 대한 상대 웹 사이트 경로입니다. HTTPS는 지원되지 않습니다. |
   | 간격 |프로브 시도 간격(초)입니다. |
...
7. 부하 분산 장치 양식을 입력하고 **확인**을 클릭합니다.
   ...
   | 필드 | Description |
   | --- | --- |
   | Name |부하 분산 장치에 대한 설명이 포함된 이름입니다. |
   | 포트 |공용 수신 포트입니다. |
