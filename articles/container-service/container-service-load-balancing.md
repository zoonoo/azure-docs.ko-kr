...
![부하 분산된 응용 프로그램의 이미지](media/container-service-load-balanging/lb-app.png)
...
다른 포트를 사용하는 경우 부하 분산 장치에서 사용한 포트에 대해 라운드 로빈 규칙 및 프로브를 추가해야 합니다. 이는 [Azure CLI](../xplat-cli-azure-resource-manager.md)에서 `azure network lb rule create` 및 `azure network lb probe create` 명령으로 수행할 수 있습니다.
