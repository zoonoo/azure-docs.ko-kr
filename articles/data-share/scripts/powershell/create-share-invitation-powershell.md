---
title: 'PowerShell 스크립트: Azure 데이터 공유 초대 만들기| 마이크로 소프트 문서'
...
| 명령 | 메모 |
|---|---|
| [뉴 아즈데이터쉐어초대장](/powershell/module/az.datashare/new-azdatashareinvitation?view=azps-2.6.0) | 데이터 공유 초대를 만듭니다. |
|||
