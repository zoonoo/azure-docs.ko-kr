...
1. [리소스 그룹](../../azure-resource-manager/management/manage-resource-groups-portal.md)의 경우 네임스페이스를 배치할 기존 리소스 그룹을 선택하거나 새 리소스 그룹을 만듭니다.  
...
1. **정책: RootManageSharedAccessKey** 아래에서 **기본 연결 문자열** 옆에 있는 **복사** 단추를 선택합니다. 이 작업은 나중에 사용할 연결 문자열을 클립보드에 복사합니다. 메모장이나 기타 다른 위치에 임시로 이 값을 붙여 넣습니다.
