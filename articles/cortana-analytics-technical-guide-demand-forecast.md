...
가져오는 데이터 집합은 이 솔루션 템플릿에 사용되는 데이터 집합과 일치하지 않을 수 있습니다. 데이터 및 요구 사항을 이해하는 것은 사용자 고유 데이터로 작업하기 위해 이 템플릿을 수정하는 방법에서 중요합니다. Azure Machine Learning 서비스를 처음 접하는 경우 [첫 번째 실험을 만드는 방법](machine-learning/machine-learning-create-experiment.md)의 예제를 사용하여 소개를 확인할 수 있습니다.
