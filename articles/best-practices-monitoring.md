...
#### <a name="_pulling-and-pushing-instrumentation-data_"></a>_계측 데이터 끌어오기 밀어넣기_
...
#### <a name="_consolidating-instrumentation-data_"></a>_계측 데이터 통합_
...
#### <a name="_log-rotation-and-data-retention_"></a>_로그 회전 및 데이터 보존_
...
#### <a name="_down-sampling_"></a>_저해상도로 처리_
