...
+ [모바일 서비스 앱에 푸시 알림 추가](/ko-kr/documentation/articles/mobile-services-javascript-backend-android-get-started-push/)<br/>Azure 알림 허브를 사용하여 TodoList 샘플 앱 사용자에게 알림을 보내도록 TodoList 모바일 서비스를 업데이트합니다.
+ [인증된 사용자에게 푸시 알림 보내기](/ko-kr/documentation/articles/mobile-services-javascript-backend-android-push-notifications-app-users/)<br/>로그인한 사용자만 알림에 등록하도록 이전 자습서 내용을 확장합니다.
