<properties urlDisplayName="index" pageTitle="미디어 서비스 계정에서 원본을 관리하는 방법" metaKeywords="" description="" metaCanonical="" services="" documentationCenter="" title="미디어 서비스 계정에서 스트리밍 끝점을 관리하는 방법" authors="juliako"  solutions="" writer="juliako" manager="dwrede" editor=""  />

<tags ms.service="media-services" ms.workload="media" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="01/01/1900" ms.author="juliako" />

# <span id="managemediaservicesorigins"></span></a>미디어 서비스 계정에서 스트리밍 끝점을 관리하는 방법
...
3.  Akamai 서명 헤더 인증에 대한 구성을 지정합니다.
    ...
    이 페이지의 구성은 하나 이상의 예약 단위가 있는 스트리밍 끝점에만 적용됩니다. 주문형 스트리밍 예약 단위를 예약하려면 SCALE 탭으로 이동합니다. 예약 단위에 대한 자세한 내용은 [미디어 서비스 크기 조정][미디어 서비스 크기 조정](영문)을 참조하세요.
  ...
  [미디어 서비스 크기 조정]: ../media-services-how-to-scale/
