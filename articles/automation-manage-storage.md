...
[Azure 자동화 runbook 갤러리](http://azure.microsoft.com/blog/2014/10/07/introducing-the-azure-automation-runbook-gallery/)는 다양한 Azure 저장소, 다른 Azure 서비스 및 타사 시스템의 관리 자동화를 시작하도록 제품 팀 및 커뮤니티 runbook을 포함합니다. Runbook 갤러리에는 다음이 포함됩니다.

 * [X 일 보다 오래 된 Azure 저장소 blob 제거](https://gallery.technet.microsoft.com/scriptcenter/Remove-Storage-Blobs-that-aae4b761)
 * [Azure 저장소에서 Azure 자동화에 blob 다운로드](https://gallery.technet.microsoft.com/scriptcenter/a-Blob-from-Azure-Storage-6bc13745)
 * [Azure 클라우드 서비스에서 Azure VM 데이터 디스크의 복사본 만들기](https://gallery.technet.microsoft.com/scriptcenter/Make-copies-of-Azure-VM-065a6394)
