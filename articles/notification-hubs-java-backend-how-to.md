...
또한 원하는 경우 [Java REST 래퍼 샘플]의 코드를 사용하고 바로 [자습서 완료](#complete-tutorial) 섹션으로 이동할 수 있습니다.

전체 REST 래퍼를 구현하는 방법에 대한 자세한 내용은 [MSDN](http://msdn.microsoft.com/ko-kr/library/dn530746.aspx)을 참조하세요. 이 섹션에서는 알림 허브 REST 끝점에 액세스하는 데 필요한 기본 단계의 Java 구현에 대해 설명합니다.
