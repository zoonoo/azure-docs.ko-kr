...
-   선택한 모바일 플랫폼에 대한 [시작 자습서][시작 자습서]에 따라 Java에서 백 엔드 부분을 구현합니다.
...
[Java REST 래퍼 샘플][Java REST 래퍼 샘플]에서 사용할 수 있는 모든 코드를 찾을 수 있습니다.
...
또한 [Java REST 래퍼 샘플][Java REST 래퍼 샘플]의 코드를 사용하려면 [자습서 완료][자습서 완료] 섹션으로 바로 이동하세요.

전체 REST 래퍼를 구현하는 방법에 대한 자세한 내용은 [MSDN][MSDN]을 참조하세요. 이 섹션에서는 알림 허브 REST 끝점에 액세스하는 데 필요한 기본 단계의 Java 구현에 대해 설명합니다.
...
-   위의 모든 코드와 등록 관리가 포함된 전체 [Java REST 래퍼 샘플][Java REST 래퍼 샘플]을 다운로드합니다.
