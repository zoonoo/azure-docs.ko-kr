...
ms.locfileid: "92370681"
---
# <a name="save-costs-with-azure-vmware-solution"></a>Azure VMware 솔루션을 사용 하 여 비용 절감

[Azure VMware 솔루션](introduction.md)의 예약 된 인스턴스로 커밋하면 비용을 절감할 수 있습니다. 예약 할인은 예약 범위 및 특성과 일치 하는 실행 중인 Azure VMware 솔루션 호스트에 자동으로 적용 됩니다. 할인을 얻기 위해 전용 호스트에 예약을 할당할 필요가 없습니다. 예약 인스턴스 구매는 사용량의 계산 부분만 다루며 소프트웨어 라이선스 비용이 포함 됩니다. 
...
4. 필수 필드를 입력 합니다. 특성과 일치 하는 Azure VMware 솔루션 호스트를 실행 하는 경우 [한정]을 선택 하 여 예약 할인을 받으세요. 선택한 범위와 수량에 따라 할인을 받는 Azure VMware 솔루션 호스트의 실제 수입니다.
   ...
   | Azure 지역       | 예약 범위에 해당하는 Azure 지역입니다.   |
   | 호스트 크기    | AV36    |
   | 용어         | 1년 또는 3년입니다.  |
