...
:::image type="content" source="media/hub-spoke/create-route-table-to-direct-traffic.png" alt-text="Azure VMware 솔루션 허브 및 스포크 통합 배포" lightbox="media/hub-spoke/create-route-table-to-direct-traffic.png":::
...
:::image type="content" source="media/hub-spoke/specify-gateway-subnet-for-route-table.png" alt-text="Azure VMware 솔루션 허브 및 스포크 통합 배포" lightbox="media/hub-spoke/specify-gateway-subnet-for-route-table.png":::
