...
- Azure Security Center은 다음을 비롯 한 다양 한 기능을 제공 합니다.
    - 파일 무결성 모니터링
    - Fileless 공격 감지
    - 운영 체제 패치 평가 
    - 잘못된 보안 구성 평가
...
6. **인시던트 설정** 탭에서 **이 분석 규칙에 의해 트리거되는 경고에서 인시던트 만들기** 를 사용 하도록 설정 하 고 **다음: 자동화 된 응답 >** 을 선택 합니다.
    ...
    :::image type="content" source="media/azure-security-integration/create-new-analytic-rule-wizard.png" alt-text="Azure 센티널에서 새 규칙을 만들기 위한 분석 규칙 마법사의 스크린샷 이 규칙에 따라 설정 된 경고에서 인시던트 만들기를 표시 합니다.":::
