...
Azure 계획을 구성 하 고 필요한 RBAC 권한이 CSP로 설정 된 후에 Azure 계획 구독에 대 한 할당량을 사용 하도록 설정 하는 Microsoft에 참여 합니다. (Aobo) 프로시저를 대신 하 여 관리자를 사용 하 여 파트너 센터에서 Azure Portal **에** 액세스 합니다.
