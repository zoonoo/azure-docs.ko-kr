...
Azure 계획을 구성 하 고 필요한 RBAC 권한이 CSP로 설정 된 후에는 유사한 절차를 사용 하 여 Azure 계획 구독에 대 한 할당량을 사용 하도록 설정 하는 Microsoft에 참여 하 게 됩니다. Azure 계획에 추가 되 면 고객 또는 파트너 관리자는 Azure Portal를 통해 Azure VMware 솔루션 사설 클라우드를 배포할 수 있습니다. 
