...
### <a name="error-if-azurerm-module-is-updated-from-powershellgallery"></a>AzureRM 모듈이 PowerShellGallery에서 업데이트되는 경우 오류
AzureRM 모듈을 최신 버전(4.4.0)으로 업데이트하는 경우 Cloudshell을 시작할 때 다음 오류가 표시될 수 있습니다.
``` powershell
