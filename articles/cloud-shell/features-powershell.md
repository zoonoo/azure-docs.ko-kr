...
|**범주**    |**Name**                                 |
|----------------|-----------------------------------------|
|Azure 도구     |[Azure PowerShell(6.1.0)](https://docs.microsoft.com/powershell/azure/overview)<br> [Azure CLI(2.0.33)](https://docs.microsoft.com/cli/azure)|
|텍스트 편집기    |vim<br> nano                             |
