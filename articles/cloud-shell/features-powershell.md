...
|**범주**    |**Name**                                 |
|----------------|-----------------------------------------|
|Azure 도구     |[Azure PowerShell(5.1.1)](https://docs.microsoft.com/powershell/azure/overview?view=azurermps-5.1.1)<br> [Azure CLI(2.0.25)](https://docs.microsoft.com/cli/azure/overview)|
|텍스트 편집기    |vim<br> nano                             |
