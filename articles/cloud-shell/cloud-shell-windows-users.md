...
PowerShell Core 6의 새로운 기능에 대한 자세한 내용은 [PowerShell 문서](/powershell/scripting/whats-new/what-s-new-in-powershell-70) 및 [PowerShell Core 시작](https://blogs.msdn.microsoft.com/powershell/2017/06/09/getting-started-with-powershell-core-on-windows-mac-and-linux/) 블로그 게시물을 참조하세요.