...
**참고**: Azure Cloud Shell Azure Portal에 액세스 하는 데 사용 되는 것과 동일한 권한 부여를 사용 하는 브라우저 기반 명령줄 환경입니다 .이 경우에는 Azure Portal에 연결 하는 데 필요한 다단계 인증이 Cloud Shell에도 필요 합니다.
