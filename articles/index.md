...
<div id="main" class="v2">
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">Azure에 대한 클라우드 채택 프레임워크</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <h1 class="visually-hidden">Microsoft Azure 설명서</h1>
        <ul class="pivots">
            <li>
                        ...
                        <ul id="get-started1" class="cardsL">
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <h4>관계형 데이터베이스</h4>
                                                <ul class="noBullet">
                                                    <li><a class="barLink" href="/azure/sql-database/">SQL DBaaS(Database as a service)</a></li>
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">에지용 SQL Database</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">Azure VM의 SQL Server</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics(이전의 SQL DW)</a></li>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">모든 Azure 서비스 보기<svg viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics(이전의 SQL DW)</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="/azure/virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview?toc=%2Fazure%2Fvirtual-machines%2Fwindows%2Ftoc.json">
                                                <img src="media/index/VirtualMachine.svg" alt="" />
                                                <p>Virtual Machines의 SQL Server</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics(이전의 SQL DW)</h3>
                                                    <p>인사이트에 대한 시간이 일치하지 않는 무제한 분석 서비스</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>애플리케이션 및 디바이스에서 빠르게 이동하는 데이터 스트림에 대한 실시간 분석</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight용 Apache Spark</h3>
                                                    <p>중요 업무용 배포를 위한 클라우드의 Apache Spark</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight용 Apache Storm</h3>
                                                    <p>빅 데이터에 대한 실시간 스트림 처리 용이</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure HDInsight용 R Server</h3>
                                                    <p>빅 데이터를 위한 예측 분석, 기계 학습 및 통계 모델링</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Blockchain 서비스</h3>
                                                    <p>컨소시엄 블록체인 네트워크 빌드, 관리 및 확장</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Virtual Machines의 SQL Server</h3>
                                                    <p>클라우드에서 엔터프라이즈 SQL Server 앱 호스트</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Cognitive Services</h3>
                                                    <p>Docker, Kubernetes, AKS 및 Container Instances에서 Azure Cognitive Services 컨테이너 사용</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Dev 공간</h3>
                                                    <p>컨테이너 및 마이크로 서비스를 통한 신속한 Kubernetes 개발</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>IoT 및 에지 배포에 최적화된 관계형 데이터베이스 엔진입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Visual Studio</h3>
                                                    <p>Android, iOS, Windows, 웹 및 클라우드에 대해 완전한 기능을 갖춘 통합 개발 환경(IDE)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Visual Studio 코드는 데스크톱에서 실행되며 Windows, macOS 및 Linux에 사용할 수 있는 간단하지만 강력한 소스 코드 편집기입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SDK</h3>
                                                    <p>이미 알고있는 프로그래밍 언어로 클라우드 앱 빌드</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>클래스룸, 개발 및 테스트 및 기타 시나리오를 위해 클라우드에 랩 만들기(이전의 DevTest Labs)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>중요한 정보를 제어하기 위한 조직 정책 빌드 및 배포</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>보안 정보</h3>
                                                    <p>모범 사례 및 지침을 통해 Azure에서 클라우드 솔루션을 보호하는 방법 알아보기</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>클라우드에서 디지털 농업 솔루션을 신속하게 빌드합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>금융 서비스</h3>
                                                    <p>금융 서비스 산업을 위한 솔루션 및 사용 사례입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>의료 및 생명 과학</h3>
                                                    <p>의료 및 생명 과학을 위한 솔루션 및 사용 사례입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT 플러그 앤 플레이</h3>
                                                    <p>디바이스 코드를 작성하지 않고 IoT 솔루션에 디바이스 연결</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>보안 &amp; 규정 준수</h3>
                                                    <p>고급 클라우드 보안을 통해 위협 탐지 및 예방 지원</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure portal</h3>
                                                    <p>모든 Azure 제품을 단일의 통합 콘솔에서 빌드하고, 관리하고 모니터링</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Migrate</h3>
                                                    <p>간단히 온-프레미스 VM을 검색, 평가, 크기 조정 및 Azure로 마이그레이션</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>AES, PlayReady, Widevine 및 Fairplay를 사용하여 안전하게 콘텐츠 전송</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>미디어 분석</h3>
                                                    <p>음성 및 비전 서비스를 통해 비디오 파일에서 정보 파악</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>웹 애플리케이션 방화벽</h3>
                                                    <p>일반적인 악용과 취약성으로부터 중앙 집중식으로 웹 애플리케이션 보호</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Microsoft 네트워크에 액세스하기 위한 최적의 인터넷 연결 가져오기</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>네트워킹 인프라 변경이 고객의 성능에 주는 영향 평가</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Microsoft 네트워크 내에서 데이터를 유지하면서 Azure 플랫폼에서 호스팅되는 서비스에 비공개로 액세스</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>클라우드 및 온-프레미스에서의 위협으로부터 엔터프라이즈 보호</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp Files</h3>
                                                    <p>NetApp에서 제공하는 엔터프라이즈급 네트워크 파일 서비스</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows Virtual Desktop</h3>
                                                    <p>클라우드 규모의 모든 디바이스에 가상 데스크톱 환경 제공</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
Python 개발자용 Azure </h3>
                                                <p>
                                                    <a href="/azure/python">시작</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">API 참조</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure portal</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">시작</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure 모바일 앱</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">시작</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>
Service Fabric SDK 및 Tools </h3>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started">Windows용 다운로드</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/service-fabric/service-fabric-get-started-linux">Linux용 다운로드</a>
                                                </p>
                                                <p>
...
Azure Dev 공간 </h3>
                                                ...
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-netcore-visualstudio">.NET Core 및 Visual Studio용 다운로드</a>
                                                </p>
                                                <p>
                                                    <a href="https://docs.microsoft.com/azure/dev-spaces/quickstart-nodejs">Node.js용 다운로드</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
