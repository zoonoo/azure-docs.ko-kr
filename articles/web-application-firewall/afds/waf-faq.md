...
description: 이 문서에서는 Azure Front 도어 서비스의 웹 응용 프로그램 방화벽에 대 한 질문과 대답을 제공 합니다.
...
## <a name="what-is-waf-on-azure-front-door-service"></a>Azure Front 도어 서비스의 WAF 란? 
