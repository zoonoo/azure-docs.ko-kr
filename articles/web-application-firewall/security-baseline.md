...
- [Microsoft 웹 응용 프로그램 방화벽의 데이터를 Azure 센티널에 연결](../sentinel/connect-azure-waf.md)
...
Azure Policy를 사용 하 여 구독에 만들 수 있는 리소스 유형에 대 한 제한을 설정할 수 있습니다. Azure Resource Graph를 사용하여 구독 내에서 리소스를 쿼리하고 검색합니다. 환경에 있는 모든 Azure 리소스가 승인 되었는지 확인 합니다.
