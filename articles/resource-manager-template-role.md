<properties
   ...
   description="배포 중에 역할 할당을 만들기 위한 리소스 관리자 스키마를 보여 줍니다."
...
| name | string | 예 | 전역 고유 식별자 | 새 역할 할당에 대한 식별자입니다. |
...
| principalId | string | 예 | 전역 고유 식별자 | 기존 서비스 주체의 식별자입니다. 이 식별자는 디렉터리 내의 ID에 매핑되며 사용자, 서비스 주체 또는 보안 그룹을 가리킬 수 있습니다. |
