...
<ol start="5">
<li><p><code>\services\mobileServices\settings</code> 프로젝트 폴더로 이동하여 생성된 <<em>your_service_name</em>>.js 스크립트 파일을 공유 <code>\js</code> 프로젝트 폴더에 복사한 다음 개별 Windows 및 WindowsPhone 앱 프로젝트에서 모두 이 파일을 삭제합니다. 또한 각 앱 프로젝트의 <code>\services\mobileServices\scripts</code> 폴더에서도 이 파일(있는 경우)을 삭제합니다.</p></li> 
<li><p>공유되는 <code>\js</code> 프로젝트 폴더에서 이 스크립트 파일을 열고 Azure에서 실행되는 모바일 서비스에 액세스하는 데 사용되는 <a href="http://msdn.microsoft.com/ko-kr/library/azure/jj554219.aspx">MobileServiceClient 개체</a>를 정의하는 기존 코드를 주석 처리합니다.</p></li>
...
* [Azure 모바일 서비스용 HTML/JavaScript 클라이언트를 사용하는 방법]
  <br/>모바일 서비스를 HTML 및 JavaScript 앱과 함께 사용하는 방법을 알아봅니다.
...
<!-- URLs. -->
[앱 페이지 제출]: http://go.microsoft.com/fwlink/p/?LinkID=266582
...
[데이터 작업 시작]: /ko-kr/documentation/articles/mobile-services-dotnet-backend-windows-universal-javascript-get-started-data
...
[알림 허브란?]: /ko-kr/documentation/articles/notification-hubs-overview/

[Azure 모바일 서비스에 TML/JavaScript 클라이언트를 사용하는 방법]: /ko-kr/documentation/articles/mobile-services-html-how-to-use-client-library
