<properties
   pageTitle="Service Fabric 및 컨테이너 개요 | Microsoft Azure"
...
4.  컨테이너가 호스트에 소비할 수 있는 실제 리소스를 제한하도록 **리소스 관리를 제공**합니다.
...
다음 그림은 OS에서 사용할 수 있는 다양한 유형의 가상화 및 격리 수준을 보여줍니다. ![서비스 패브릭 플랫폼][Image1]
