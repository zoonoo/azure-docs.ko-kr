...
1. Azure 포털에 로그인하고 리소스 그룹에 새 Windows Server 2012 R2 Datacenter VM을 만듭니다. 자세한 내용은 [Azure Portal에서 Windows VM 만들기](../virtual-machines/virtual-machines-windows-hero-tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) 문서를 참조하세요.
2. 동일한 리소스 그룹에 두 개의 Windows Server 2012 R2 Datacenter VM을 더 추가합니다. 각 VM은 만들어질 때 동일한 관리자 사용자 이름 및 암호를 갖습니다. 만들어지면 동일한 가상 네트워크에&3;개의 모든 VM이 표시됩니다.
