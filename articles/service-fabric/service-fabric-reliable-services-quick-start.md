...
신뢰할 수 있는 컬렉션에는 LINQ를 비롯하여 `System.Collections.Generic` 및 `System.Collections.Concurrent` 해당 항목과 동일한 작업이 많이 있습니다. 하지만 신뢰할 수 있는 컬렉션의 작업은 비동기적입니다. 이것은 신뢰할 수 있는 컬렉션의 쓰기 작업이 *복제되기* 때문에 즉, 고가용성을 위해 작업이 여러 노드의 다른 서비스 복제본에 전송되기 때문입니다.
