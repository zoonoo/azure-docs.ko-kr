---
title: Azure Service Fabric 서비스 모델 XML 스키마 요소 그룹
...
ms.locfileid: "79282082"
---
<!-- This article was generated by the Python script found in the service-fabric-service-model-schema.md file -->

# <a name="service-fabric-service-model-xml-schema-elements"></a>Service Fabric 서비스 모델 XML 스키마 요소
