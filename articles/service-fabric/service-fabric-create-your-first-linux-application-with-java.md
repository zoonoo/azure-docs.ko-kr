...
---
# <a name="create-your-first-service-fabric-java-application-on-linux"></a>Linux에서 첫 번째 Service Fabric Java 응용 프로그램 만들기
...
3. 브라우저를 열고 http://localhost:19080/Explorer에서 [Service Fabric Explorer](service-fabric-visualizing-your-cluster.md)로 이동합니다(Mac OS X에서 Vagrant를 사용하는 경우 localhost를 VM의 개인 IP로 바꿈).
...
## <a name="add-another-service-to-the-application"></a>응용 프로그램에 다른 서비스 추가
