...
Service Fabric용 Eclipse 플러그 인을 사용하여 만든 기존 응용 프로그램에 서비스를 추가하려면 [여기](service-fabric-get-started-eclipse.md#add-a-service-fabric-service-to-your-service-fabric-application) 설명서를 참조하세요.
