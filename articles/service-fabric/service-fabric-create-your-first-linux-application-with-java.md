...
응용 프로그램의 이름을 "HelloWorldActorApplication"으로 지정하고 작업자의 이름을 "HelloWorldActor"라고 지정하면 다음과 같은 스캐폴딩이 만들어집니다.
...
응용 프로그램에 대한 Service Fabric Reliable Services 지원입니다.
