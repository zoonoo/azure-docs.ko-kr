<properties
   pageTitle="Reliable Services 고급 사용법 | Microsoft Azure"
...
## 상태 비저장 서비스 인스턴스 수명 주기

상태 비저장 서비스의 수명 주기는 매우 간단합니다. 상태 비저장 서비스는 열리거나, 닫히거나, 중단될 수만 있습니다. 상태 비저장 서비스의 `RunAsync`는 서비스 인스턴스가 열리면 실행되고 서비스 인스턴스가 닫히거나 중단되면 취소됩니다.
