...
Reliable Actors 런타임에서는 [EventSource](/dotnet/api/system.diagnostics.tracing.eventsource) 이벤트 및 [성능 카운터](/dotnet/api/system.diagnostics.performancecounter)를 내보냅니다. 이러한 정보는 런타임이 어떻게 작동하고 있는지 파악하여 문제를 해결하고 성능을 모니터링하는 데 도움이 됩니다.
