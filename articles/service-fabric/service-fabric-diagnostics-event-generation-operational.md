...
| EventId | 이름 | 범주 | Description |원본(태스크) | 수준 | 
| --- | --- | --- | --- | --- | --- | 
...
| 16834 | PrimaryReplicationQueueFull | 보건 | 주 복제본의 복제 큐가 꽉 찼습니다. | 복제 | 경고 |
| 16835 | PrimaryReplicationQueueWarning | 보건 | 주 복제본의 복제 큐가 거의 꽉 찼습니다. | 복제 | 경고 |
| 16836 | PrimaryReplicationQueueWarningMitigated | 보건 | 주 복제본의 복제 큐가 양호 합니다. | 복제 | 정보 제공 |
| 16837 | SecondaryReplicationQueueFull | 보건 | 보조 복제본의 복제 큐가 꽉 찼습니다. | 복제 | 경고 |
| 16838 | SecondaryReplicationQueueWarning | 보건 | 보조 복제본의 복제 큐가 거의 꽉 찼습니다. | 복제 | 경고 |
| 16839 | SecondaryReplicationQueueWarningMitigated | 보건 | 보조 복제본의 복제 큐가 양호 합니다. | 복제 | 정보 제공 |
| 16840 | PrimaryFaultedSlowSecondary | 보건 | 주 복제본에서 저속 보조 복제본에 오류가 발생 했습니다. | 복제 | 경고 |
| 16841 | ReplicatorFaulted | 보건 | 복제본에 오류가 발생 했습니다. | 복제 | 경고 |

## <a name="container-events"></a>컨테이너 이벤트

**컨테이너 수명 주기 이벤트** 

| EventId | 이름 | Description |원본(태스크) | 수준 | 버전 |
| --- | --- | ---| --- | --- | --- |
