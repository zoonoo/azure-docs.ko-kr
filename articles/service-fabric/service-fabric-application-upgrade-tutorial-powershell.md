...
이제 애플리케이션이 빌드되고 업그레이드 준비되었습니다. 관리자로 PowerShell 창을 열고 [Get-ServiceFabricApplication](/powershell/module/servicefabric/get-servicefabricapplication?view=azureservicefabricps)을 입력하면 **VisualObjects**의 응용 프로그램 형식 1.0.0.0이 배포되었음을 알려줍니다.  
