...
다음과 같이 응용 프로그램 프로젝트 **VisualObjectsApplication**을 마우스 오른쪽 단추로 클릭하고 서비스 패브릭 메뉴 항목에서 **게시** 명령을 선택하여 응용 프로그램을 구축 및 게시합니다. 자세한 내용은 [서비스 패브릭 응용 프로그램 업그레이드 자습서](service-fabric-application-upgrade-tutorial.md)를 참조하세요. 또는 PowerShell을 사용하여 응용 프로그램을 배포할 수 있습니다.
...
이제 **VisualObjects.ActorService** 프로젝트의 2.0 버전을 사용하기 위해 *ApplicationManifest.xml* 파일(**VisualObjects** 솔루션 내 **VisualObjects** 프로젝트 내에서 찾을 수 있음)을 업데이트하고, 응용 프로그램의 버전도 1.0.0.0에서 2.0.0.0으로 업데이트해야 합니다. 이제 *ApplicationManifest.xml*의 해당 줄은 다음과 같습니다.
