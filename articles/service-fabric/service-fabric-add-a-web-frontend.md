---
title: "ASP.NET Core를 사용하여 응용 프로그램에 대한 프런트 엔드 만들기 | Microsoft Docs"
...
> [!NOTE]
> 이 자습서를 완료하려면 [.NET 코어 1.0을 설치][dotnetcore-install]해야 합니다.
> 
> 
...
> [!TIP]
> ASP.NET Core 서비스를 구축하는 방법에 대한 자세한 내용 [ASP.NET Core 설명서](https://docs.asp.net)를 참조하세요.
> 
> 
...
> [!WARNING]
> 템플릿 Kestrel에 제공된 ASP.NET Core 웹 서버는 [현재 직접 인터넷 트래픽을 처리를 지원하지 않습니다](https://docs.asp.net/en/latest/fundamentals/servers.html#kestrel). 프로덕션 시나리오의 경우 [API Management][api-management-landing-page] 또는 다른 인터넷 게이트웨이 뒤에 ASP.NET Core 끝점을 호스트하는 것이 좋습니다. 서비스 패브릭은 IIS 내에서 배포하도록 지원되지 않습니다.
> 
> 

## <a name="what-about-actors"></a>행위자의 경우는 어떨까요?
