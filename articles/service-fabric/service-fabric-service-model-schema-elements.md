...
## <a name="parameter-element-defined-in-parameters"></a>매개 변수에서 정의 된 매개 변수 요소
...
## <a name="parameter-element-defined-in-section"></a>섹션에 정의 된 매개 변수 요소
재정의할 설정입니다.
...
암호화 된 상태로 설정 된 경우 응용 프로그램 개발자는 인증서를 만들고 Invoke-ServiceFabricEncryptSecret cmdlet을 사용 하 여 중요 한 정보를 암호화할 책임이 있습니다.
...
## <a name="serviceplacementpolicy-element-defined-in-serviceplacementpolicies"></a>ServicePlacementPolicy에 정의 된 ServicePlacementPolicy 요소
특정 클러스터 장애 도메인에서 서비스를 실행해야 하는지 여부를 지정하는 서비스 배치 정책을 정의합니다.  클러스터가 지리적 거리 및/또는 지정학적 지역에 걸쳐 있는 경우에 유용합니다.
