...
## <a name="addremoveincrementalnamedpartitionscalingmechanism-element"></a>AddRemoveIncrementalNamedPartitionScalingMechanism 요소
...
Microsoft Azure Fabric ServiceGroup 구성원에 대한 사용자 정의 유형 식별자입니다(예: Actor).
|특성|값|
|---|---|
|이름|ServiceTypeName|
|use|필수|
