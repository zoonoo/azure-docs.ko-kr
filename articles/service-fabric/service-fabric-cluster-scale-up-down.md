...
## <a name="choose-the-node-typevm-scale-set-to-scale"></a>크기를 조정할 노드 형식/VM 크기 집합 선택
...
## <a name="set-auto-scale-rules-for-the-node-typevm-scale-set"></a>노드 형식/VM 크기 집합에 대한 자동 크기 조정 규칙 설정
...
## <a name="manually-add-vms-to-a-node-typevm-scale-set"></a>노드 형식/VM 크기 집합에 수동으로 VM 추가
...
## <a name="manually-remove-vms-from-the-primary-node-typevm-scale-set"></a>주 노드 형식/VM 크기 집합에서 수동으로 VM 제거
> [!NOTE]
...
## <a name="manually-remove-vms-from-the-non-primary-node-typevm-scale-set"></a>주가 아닌 노드 형식/VM 크기 집합에서 수동으로 VM 제거
> [!NOTE]
