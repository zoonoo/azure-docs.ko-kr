---
title: Linux Azure Diagnostics를 사용한 이벤트 집계
...
로그를 업로드 및 수집하는 방법 중 하나는 LAD(Linux Azure Diagnostics) 확장을 사용하여 Azure Storage에 로그를 업로드하고 Azure Application Insights 또는 Event Hubs에 로그를 보낼 수 있는 옵션을 제공하는 것입니다. 또한 외부 프로세스를 사용하여 스토리지에서 이벤트를 읽고 [Azure Monitor 로그](./service-fabric-diagnostics-oms-setup.md) 또는 기타 로그 구문 분석 솔루션과 같은 분석 플랫폼 제품에 배치할 수 있습니다.
...
1. 문제를 해결하는 동안 살펴봐야 하는 이벤트에 대해 자세히 알아보려면 [LTTng 설명서](https://lttng.org/docs) 및 [LAD 사용](../virtual-machines/extensions/diagnostics-linux.md)을 참조하세요.
