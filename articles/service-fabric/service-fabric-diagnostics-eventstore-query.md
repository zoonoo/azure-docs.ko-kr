---
title: EventStore API를 사용하는 클러스터 이벤트 쿼리
...
[Service Fabric 클라이언트 라이브러리](/dotnet/api/overview/azure/service-fabric#client-library)를 통해 EventStore를 프로그래밍 방식으로 쿼리할 수도 있습니다.
