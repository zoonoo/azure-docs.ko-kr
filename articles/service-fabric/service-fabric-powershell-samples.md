...
| **클러스터, 노드 및 인프라 관리** ||
| [응용 프로그램 인증서 추가](./scripts/service-fabric-powershell-add-application-certificate.md) .| 클러스터의 모든 노드에 애플리케이션 X.509 인증서를 추가합니다. |
...
| **응용 프로그램 관리** ||
| [응용 프로그램 배포](./scripts/service-fabric-powershell-deploy-application.md)| 클러스터에 애플리케이션을 배포합니다.|
| [응용 프로그램 업그레이드](./scripts/service-fabric-powershell-upgrade-application.md)| 애플리케이션을 업그레이드합니다.|
| [응용 프로그램 제거](./scripts/service-fabric-powershell-remove-application.md)| 클러스터에서 애플리케이션을 제거합니다.|
