---
title: Azure Service Fabric에서 Java를 사용하여 서비스 원격 호출
...
기본 재시도 매개 변수는 [OperationRetrySettings](/java/api/microsoft.servicefabric.services.communication.client.operationretrysettings)에서 제공됩니다.
