...
기본 재시도 매개 변수는 [는 operationretrysettings](https://docs.microsoft.com/java/api/microsoft.servicefabric.services.communication.client.operationretrysettings)에 의해 프로 비전 됩니다.
