-- title: Service Fabric에 대한 .NET 응용 프로그램 만들기 | Microsoft Docs description: 이 자습서에서는 ASP.NET Core 프런트 엔드 및 신뢰할 수 있는 서비스 상태 저장 백 엔드로 응용 프로그램을 만들고 클러스터에 배포하는 방법을 알아봅니다.
...
이 자습서에서는 [ASP.NET Core Web API](service-fabric-reliable-services-communication-aspnetcore.md)를 사용합니다.
