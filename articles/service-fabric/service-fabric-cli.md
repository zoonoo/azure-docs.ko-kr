...
CLI는 Python 버전 2.7 및 3.6+을 지원하며, Python 3.x가 권장됩니다.
...
1. 공식 [Python 다운로드 페이지](https://www.python.org/downloads/)로 이동하여 Python 3.x의 최신 릴리스를 다운로드합니다.

2. 설치 관리자를 시작합니다.

3. 프롬프트의 아래쪽에 있는 **PATH에 Python 3.x 추가** 를 선택합니다.
...
그런 다음, 터미널에서 다음 명령을 실행하여 최신 Python 3.x, pip 및 Service Fabric CLI를 설치합니다.
