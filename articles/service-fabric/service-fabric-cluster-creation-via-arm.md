...
인증서 키를 포함하는 Key Vault 참조하여 Cluster Resource Manager 템플릿에 Azure AD 구성을 추가합니다. Resource Manager 템플릿 매개 변수 파일(azuredeploy.parameters.json)에 해당 Azure AD 매개 변수 및 값을 추가합니다.
