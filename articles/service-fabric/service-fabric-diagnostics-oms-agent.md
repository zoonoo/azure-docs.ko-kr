...
2. 포털에서 OMS 작업 영역이 있는 리소스 그룹으로 이동합니다. Log Analytics 리소스(Log Analytics가 될 리소스 종류)를 클릭하고 오른쪽 탐색 모음에서 아래로 스크롤하여 **속성**을 클릭합니다.

    ![OMS 속성 페이지](media/service-fabric-diagnostics-oms-agent/oms-properties.png)
...
OMS Log Analytics 작업 영역을 배포하고 각 노드에 에이전트를 추가하는 샘플 Resource Manager 템플릿은 [Windows](https://github.com/ChackDan/Service-Fabric/tree/master/ARM%20Templates/SF%20OMS%20Samples/Windows) 또는 [Linux](https://github.com/ChackDan/Service-Fabric/tree/master/ARM%20Templates/SF%20OMS%20Samples/Linux)에서 사용할 수 있습니다.

이 템플릿을 다운로드하고 수정하여 필요에 가장 적합한 클러스터를 배포할 수 있습니다.

## <a name="next-steps"></a>다음 단계

* 관련 [성능 카운터](service-fabric-diagnostics-event-generation-perf.md)를 수집합니다. 특정 성능 카운터를 선택하도록 OMS 에이전트를 구성하려면 OMS Log Analytics 리소스의 맨 위에 링크된 OMS 포털을 방문하십시오. 그런 다음 **[홈] > [설정] > [데이터] > [Windows 성능 카운터]** 또는 **Linux 성능 카운터**를 클릭하고 수집하려는 카운터를 선택합니다.
