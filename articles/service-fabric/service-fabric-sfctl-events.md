...
EventStore 시스템 서비스는 >= 6.4를 실행 하는 모든 SFRP 클러스터에 구성 업그레이드를 통해 추가할 수 있습니다. 다음 url \: https \: //docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-eventstore를 확인 하세요.
...
|인수|설명|
| --- | --- |
| --최종 시간-utc [필수] | ISO UTC yyyy-MM-Yyyy-mm-ddthh MM ssz에서 조회 쿼리의 종료 시간 \: \: 입니다. |
| --시작 시간-utc [필수] | ISO UTC yyyy-MM-Yyyy-mm-ddthh MM ssz에서 조회 쿼리의 시작 시간 \: \: 입니다. |
