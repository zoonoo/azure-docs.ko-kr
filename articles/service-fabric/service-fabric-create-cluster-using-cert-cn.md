...
3. **Microsoft.Compute/virtualMachineScaleSets** 리소스에서 지문 대신 인증서 설정의 일반 이름을 사용하도록 가상 머신 확장을 업데이트합니다.  **Virtualmachineprofile**->**extensionprofile**->**확장**->**속성**->**settings**설정->**인증서**에서를 추가 합니다. 
    ```json
       "commonNames": [
