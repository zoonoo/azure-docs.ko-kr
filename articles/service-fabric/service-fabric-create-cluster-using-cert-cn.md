---
title: 인증서 공통 이름을 사용하여 클러스터 만들기
...
3. **Microsoft.Compute/virtualMachineScaleSets** 리소스에서 지문 대신 인증서 설정의 일반 이름을 사용하도록 가상 머신 확장을 업데이트합니다.  **가상머신프로파일**->**확장에서 프로필**->**확장**->**속성**->**설정**->**인증서,** 추가 
    ```json
       "commonNames": [
