...
> [!NOTE]
> 배포 로그는 CreateServiceFabricCluster PowerShell을 실행하는 VM/컴퓨터에서 로컬로 사용할 수 있습니다. 이러한 로그는 PowerShell 명령을 실행한 폴더의 DeploymentTraces라는 하위 폴더에 있습니다. 컴퓨터에 Service Fabric이 올바르게 배포되었는지 여부를 확인하려면 C:\ProgramData 디렉터리에서 설치된 파일을 찾을 수 있으며 작업 관리자에서 실행 중인 FabricHost.exe 및 Fabric.exe 프로세스를 볼 수 있습니다.
> 
> 
