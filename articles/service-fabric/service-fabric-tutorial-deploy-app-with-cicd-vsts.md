---
title: Azure에서 연속 통합으로 Service Fabric 앱 배포(Team Services) | Microsoft Docs
description: 이 자습서에서는 Visual Studio Team Services를 사용하여 Service Fabric 응용 프로그램에 대한 지속적인 통합 및 배포를 설정하는 방법을 알아봅니다.
