<properties
   pageTitle="CLI를 사용하여 Service Fabric 클러스터와 상호 작용 | Microsoft Azure"
...
# Azure CLI를 사용하여 Service Fabric 클러스터와 상호 작용
...
## Azure CLI를 사용하여 Service Fabric 클러스터에 연결
...
문제가 지속되면 다음 명령으로 **sshd\_config** 파일을 변경하여 ssh에 대해 PAM을 사용하지 않도록 해보세요.
