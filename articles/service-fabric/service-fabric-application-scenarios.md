...
* **세션 기반 대화형 응용 프로그램**: 온라인 게임 또는 인스턴트 메시징 같은 응용 프로그램의 읽기 및 쓰기 대기 시간이 짧아야 하는 경우 서비스 패브릭이 유용합니다. 서비스 패브릭을 사용하면 상태 비저장 앱에 필요한 것처럼 별도의 저장소 또는 캐시를 만들 필요 없이 이러한 대화형 상태 저장 응용 프로그램을 빌드할 수 있습니다. (대기 시간이 증가하고 잠재적으로 일관성 문제가 시작됩니다.)
* **분산 그래프 처리**: 소셜 네트워크의 성장으로 대형 그래프를 병렬로 분석할 필요성이 크게 늘어났습니다. 빠른 크기 조정 및 병렬 부하 처리가 가능한 서비스 패브릭은 대형 그래프를 처리하기 위한 타고난 플랫폼입니다. 서비스 패브릭을 사용하면 소셜 네트워킹, 비즈니스 인텔리전스, 과학적 연구 등 그룹을 위한 확장성이 뛰어난 서비스를 빌드할 수 있습니다.
