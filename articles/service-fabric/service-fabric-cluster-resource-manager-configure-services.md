---
title: "Service Fabric 클러스터 리소스 관리자를 사용하여 서비스 구성 | Microsoft Docs"
...
---
# <a name="configuring-cluster-resource-manager-settings-for-service-fabric-services"></a>서비스 패브릭 서비스에 대한 클러스터 리소스 관리자 설정 구성
