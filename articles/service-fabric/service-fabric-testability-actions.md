---
title: Azure 마이크로 서비스에서 시뮬레이션 실패
...
| MoveInstance | 상태 비저장 서비스의 현재 인스턴스를 다른 클러스터 노드로 이동합니다. | MoveInstanceAsync | Move-ServiceFabricInstance | 정상 |
...
![PowerShell에서 Restart-ServiceFabricNode 명령을 실행하는 스크린샷.](media/service-fabric-testability-actions/Restart-ServiceFabricNode.png)
