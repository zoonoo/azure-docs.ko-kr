...
2. **F5** 키를 누르거나 **디버그** > **디버깅 시작** 을 클릭합니다.
    ...
    ![디버그 메뉴를 보여주는 스크린샷][startdebugging]
...
1. **클라우드 탐색기** 에 있는 클러스터로 이동합니다. 마우스 오른쪽 단추를 클릭하고 **디버깅 사용** 을 선택합니다
...
1. **클라우드 탐색기** 에 있는 클러스터로 이동합니다. 마우스 오른쪽 단추를 클릭하고 **스트리밍 추적 사용** 을 선택합니다
