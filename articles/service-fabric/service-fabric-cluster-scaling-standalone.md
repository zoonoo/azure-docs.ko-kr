...
> [!WARNING]
> 클러스터에 대한 [안정성 계층의 클러스터 크기](service-fabric-cluster-capacity.md#reliability-characteristics-of-the-cluster) 아래로 노드 개수를 낮추지 않는 것이 좋습니다. 이렇게 낮추면 Service Fabric 시스템 서비스가 클러스터 전체에 복제되는 기능을 방해하여 클러스터가 불안정해지거나 손상될 가능성이 있습니다.
>
