...
- 단점: 애플리케이션을 [확장 가능하게 디자인](service-fabric-concepts-scalability.md)해야 합니다.  애플리케이션 데이터베이스 및 지속성도 확장하려면 추가적인 아키텍처 작업이 필요할 수 있습니다.  그렇지만 Service Fabric 상태 저장 서비스의 [신뢰할 수 있는 컬렉션](service-fabric-reliable-services-reliable-collections.md)을 사용하면 응용 프로그램 데이터를 훨씬 더 쉽게 확장할 수 있습니다.
...
- 이점: 소프트웨어 및 애플리케이션 아키텍처가 동일하게 유지됩니다.
