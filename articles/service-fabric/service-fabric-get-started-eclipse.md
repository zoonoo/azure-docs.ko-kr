...
1.  Eclipse Neon 이상 및 최신 버전의 Buildship(1.0.17 이상 버전)을 설치되어 있는지 확인합니다.
    -   설치된 구성 요소의 버전을 확인하려면 Eclipse에서 **도움말** > **설치 세부 정보**로 이동합니다.
...
2.  Service Fabric 플러그 인을 설치하려면 Eclipse에서 **도움말** > **새 소프트웨어 설치**로 이동합니다.
