...
* 사람들이 서비스를 작은 집합의 컴퓨터로 제한하고 서비스 컬렉션의 부하를 집계하려는 것과 같은 선호도를 사용하려는 많은 이유는 응용 프로그램 그룹을 통해 더 잘 지원되기 때문입니다.  [응용 프로그램 그룹](service-fabric-cluster-resource-manager-application-groups.md)
