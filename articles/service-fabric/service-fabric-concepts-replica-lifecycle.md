...
- I -> N: 유휴 보조 복제본 삭제
- I -> P: 활성 보조 복제본을 주 복제본으로 승격. 이것은 주 복제본의 장애 조치나, 클러스터 리소스 관리자가 주 복제본 이동을 시작했을 때 발생할 수 있습니다. 예를 들어 애플리케이션 업그레이드 또는 부하 분산의 결과로 발생할 수 있습니다.
- S -> N: 활성 보조 복제본 삭제
