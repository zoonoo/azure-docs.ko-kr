---
title: Azure Service Fabric 애플리케이션 비밀 관리
...
애플리케이션 매니페스트에서 인증서를 지정하여 Service Fabric 애플리케이션에도 암호를 포함해야 합니다. **ApplicationManifest.xml** 에 **SecretsCertificate** 요소를 추가하고 원하는 인증서의 지문을 포함합니다.
...
* Service Fabric [비밀 저장소](service-fabric-application-secret-store.md) 
