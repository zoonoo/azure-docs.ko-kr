...
| EnforceLinuxMinTlsVersion | bool, 기본값: FALSE | 동적 | True로 설정 하면입니다. TLS 버전 1.2 이상만 지원 됩니다.  False 이면입니다. 이전 TLS 버전을 지원 합니다. Linux에만 적용 됩니다. |
...
| **매개 변수** | **허용되는 값** | **업그레이드 정책** | **지침 또는 간단한 설명** |
| --- | --- | --- | --- |
|수준 |int, 기본값: 4 | 동적 |ETW 추적 수준은 1, 2, 3, 4 값을 가질 수 있습니다. 지원 받으려면 추적 수준을 4에서 유지해야 합니다. |
