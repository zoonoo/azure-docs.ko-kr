---
title: "Service Fabric 역방향 프록시 | Microsoft Docs"
...
---
# <a name="service-fabric-reverse-proxy"></a>서비스 패브릭 역방향 프록시
...
이 토픽에 대한 자세한 내용은 [서비스와 통신](service-fabric-connect-and-communicate-with-services.md)을 참조하세요.

### <a name="communicating-via-sf-reverse-proxy"></a>SF 역방향 프록시를 통해 통신
...
### <a name="reaching-microservices-via-the-sf-reverse-proxy-from-outside-the-cluster"></a>클러스터 외부에서 SF 역방향 프록시를 통해 마이크로 서비스에 연결
