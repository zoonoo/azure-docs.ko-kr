...
description: 상태 충실 서비스 복제본에 대한 구성과 변경 중에 일관성과 가용성을 유지하기 위해 서비스 패브릭이 사용하는 재구성 프로세스에 대해 알아봅니다.
author: appi101
ms.topic: conceptual
ms.date: 01/10/2018
ms.author: aprameyr
...
- 주 복제본이 변경 중인 재구성
    - **장애 조치:** 장애 조치(Failover)는 실행 중인 기본 의 실패에 대한 응답으로 재구성됩니다.
...
- **단계2**: 이 단계에서 Service Fabric은 현재 구성의 대부분의 복제본에서 모든 데이터를 사용할 수 있도록 합니다.
...
- **복제본 아래로:** 일부 재구성 단계는 구성에서 복제본의 대부분을 가동해야 합니다.
