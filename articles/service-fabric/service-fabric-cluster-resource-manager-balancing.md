---
title: Azure Service Fabric 클러스터 균형 유지
...
![서비스의 균형을 유지하는 방법을 보여 주는 다이어그램][Image4]
</center>
...
![클러스터 리소스 관리자가 관련된 서비스를 결정하는 과정을 보여 주는 다이어그램][Image5]
</center>
...
* 클러스터 리소스 관리자는 하위 클러스터링(때때로 배치 제약 조건과 분산을 사용하는 경우에 발생하는 상황)을 인식하고 처리할 수 있습니다. 하위 클러스터링이 분산에 미치는 영향과 처리 방법에 대한 자세한 내용은 [여기](cluster-resource-manager-subclustering.md)를 참조하세요.
