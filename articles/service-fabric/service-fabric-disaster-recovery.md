...
고가용성 클라우드 응용 프로그램을 제공하는 중요한 부분은 통제 범위를 완전히 벗어난 오류를 비롯하여 모든 유형의 오류를 극복할 수 있는 것입니다. 이 문서는 잠재적 재해의 맥락에서 Azure 서비스 패브릭 클러스터의 물리적 레이아웃을 설명하고 가동 중지 시간 또는 데이터 손실의 위험을 제한하거나 제거하기 위해 이러한 재해를 처리하는 방법에 대한 지침을 제공합니다.
