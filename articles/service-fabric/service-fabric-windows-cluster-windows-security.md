...
GMSA [버전 >](https://go.microsoft.com/fwlink/?LinkId=730690) 를 사용 하 여\<다운로드 한 샘플 *clusterconfig* 구성 파일은 [GMSA (그룹 관리 서비스 계정)](https://technet.microsoft.com/library/hh831782.aspx)를 사용 하 여 Windows 보안을 구성 하기 위한 템플릿을 포함 합니다.  
...
> [!NOTE]
> ClustergMSAIdentity 값이 "mysfgmsa@mydomain" 형식입니다.
...
이 모델은 더 이상 사용되지 않습니다. 위에서 설명한 대로 gMSA를 사용하는 것이 좋습니다. [\<ServiceFabric 버전 >](https://go.microsoft.com/fwlink/?LinkId=730690) 를 사용 하 여 다운로드 한 샘플 *clusterconfig* 구성 파일은 windows 보안을 구성 하기 위한 템플릿을 포함 하 고 있습니다.  **Properties** 섹션에서 다음과 같이 Windows 보안을 구성합니다. 
