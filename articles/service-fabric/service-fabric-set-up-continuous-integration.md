---
title: "Service Fabric에 대한 연속 통합 | Microsoft Docs"
...
---
# <a name="set-up-continuous-integration-for-a-service-fabric-application-by-using-visual-studio-team-services"></a>Visual Studio Team Services를 사용한 서비스 패브릭 응용 프로그램에 대한 연속 통합 설정
