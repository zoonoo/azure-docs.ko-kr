---
title: Azure 서비스 패브릭 Reliable Services 구성의 개요 | Microsoft Docs
...
> [!NOTE]
> 코드를 통해 서비스를 구성할 예정이 아니면 Visual Studio 솔루션에서 생성된 "Settings.xml" 파일에서 다음 구성의 섹션 이름을 삭제하지 **않도록** 합니다. ReliableStateManager를 구성할 때 구성 패키지 또는 섹션의 이름을 바꾸려면 코드를 변경해야 합니다.
> 
> 
