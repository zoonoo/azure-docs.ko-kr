<properties
   pageTitle="이벤트 추적으로 문제 해결 | Microsoft Azure"
...
# Azure 서비스 패브릭에서 서비스 배포 시 일반적인 문제 해결
...
모든 노드에 대해 응용 프로그램 이벤트 로그를 자동으로 업로드하도록 [Azure 진단](service-fabric-diagnostics-how-to-setup-wad.md)을 구성할 수 있습니다.
