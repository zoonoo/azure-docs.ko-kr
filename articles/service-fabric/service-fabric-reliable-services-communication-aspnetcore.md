...
`HttpSysCommunicationListener` 현재 적합 하지 않습니다 기본 복잡성으로 인해 상태 저장 서비스에서 사용 하 여 *http.sys* 포트 공유 기능입니다. 자세한 내용은 HttpSys를 통한 동적 포트 할당에 대한 다음 섹션을 참조하세요. 상태 저장 서비스의 경우 Kestrel이 권장되는 웹 서버입니다.
