...
**연결 엔드포인트** 에서 배포할 Service Fabric 클러스터를 선택합니다. 없는 경우 **&lt; 새 클러스터 &gt; 만들기** ...를 선택 하 여 Azure Portal에 대 한 웹 브라우저 창을 엽니다. 자세한 내용은 [포털에서 클러스터 만들기](service-fabric-cluster-creation-via-portal.md#create-cluster-in-the-azure-portal)를 참조하세요. 
...
응답이 표시 되는이 주소로 이동 `HELLO WORLD` 합니다.
