<properties
   pageTitle="서비스 패브릭 백업 및 복원 | Microsoft Azure"
...
>[AZURE.NOTE] 백업의 샘플 구현을 찾고 Github의 웹 참조 앱에서 기능을 복원할 수 있습니다. 자세한 내용은 Inventory.Service 서비스를 확인하세요.
