---
title: Azure 보안 벤치 마크에 대 한 Service Fabric 보안 기준
...
ms.locfileid: "86531705"
---
# <a name="service-fabric-security-baseline-for-azure-security-benchmark"></a>Azure 보안 벤치 마크에 대 한 Service Fabric 보안 기준
...
* [템플릿을 사용하여 Azure Firewall 배포](https://docs.microsoft.com/azure/firewall/deploy-template)

* [Azure NSGs (네트워크 보안 그룹)를 사용 하 여 경계 네트워크 만들기](https://docs.microsoft.com/azure/security/fundamentals/service-fabric-best-practices#use-network-isolation-and-security-with-azure-service-fabric)

* [Azure Service Fabric 클러스터를 기존 가상 네트워크와 통합 하는 방법](https://docs.microsoft.com/azure/service-fabric/service-fabric-patterns-networking)
...
* [Azure 트래픽 분석을 사용 하도록 설정 하 고 사용 하는 방법](https://docs.microsoft.com/azure/network-watcher/traffic-analytics)
...
* [Service Fabric 및 API Management 개요](https://docs.microsoft.com/azure/service-fabric/service-fabric-api-management-overview)

* [내부 VNET의 API Management를 Application Gateway와 통합](https://docs.microsoft.com/azure/api-management/api-management-howto-integrate-internal-vnet-appgateway)
...
* [트래픽 분석을 사용 하 여 NSG 흐름 로그 시각화](https://docs.microsoft.com/azure/network-watcher/traffic-analytics)
...
* [Service Fabric 네트워킹 모범 사례](https://docs.microsoft.com/azure/service-fabric/service-fabric-best-practices-networking)
...
* [Service Fabric와 Azure Monitor 로그 통합 구성](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-oms-setup)

* [Azure Service Fabric의 모니터링 컨테이너에 대 한 Azure Monitor 로그 설정](https://docs.microsoft.com/azure/service-fabric/service-fabric-tutorial-monitoring-wincontainers)

* [일반적인 Service Fabric 시나리오 진단](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-common-scenarios)
...
* [노드에 Log Analytics 에이전트를 배포 하는 방법](https://docs.microsoft.com/azure/service-fabric/service-fabric-diagnostics-oms-agent)

* [로그 검색 Log Analytics](https://docs.microsoft.com/azure/log-analytics/log-analytics-log-searches)
...
* [Log Analytics 작업 영역 보존 기간을 구성 하는 방법](https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage)
...
* [자세한 내용은 windows Server 2016의 Windows Defender 바이러스 백신을 참조 하십시오.](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-antivirus/windows-defender-antivirus-on-windows-server-2016)
...
* [Azure Security Center를 사용 하 여 id 및 액세스를 모니터링 하는 방법](https://docs.microsoft.com/azure/security-center/security-center-identity-access)
...
* [Azure Portal에서 만들기](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-creation-via-portal)
...
* [Azure Active Directory 클라이언트 인증 설정](https://docs.microsoft.com/azure/service-fabric/service-fabric-tutorial-create-vnet-and-windows-cluster#set-up-azure-active-directory-client-authentication)
...
* [Service Fabric 클라이언트 인증에 대 한 설치 Azure Active Directory](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-creation-setup-aad)
...
* [서비스 패브릭 클러스터 보안 시나리오](https://docs.microsoft.com/azure/service-fabric/service-fabric-cluster-security)
...
* [고객이 관리 하는 암호화 키를 구성 하는 방법](https://docs.microsoft.com/azure/storage/common/storage-encryption-keys-portal)

* [Windows에서 Azure Service Fabric 클러스터 노드에 대해 디스크 암호화 사용](https://docs.microsoft.com/azure/service-fabric/service-fabric-enable-azure-disk-encryption-windows)

* [Linux에서 Azure Service Fabric 클러스터 노드에 대해 디스크 암호화 사용](https://docs.microsoft.com/azure/service-fabric/service-fabric-enable-azure-disk-encryption-linux)
...
* [Service Fabric 오류 분석 서비스 소개](https://docs.microsoft.com/azure/service-fabric/service-fabric-testability-overview)

* [Service Fabric 클러스터에서 제어 되는 비정상 상황 유도](https://docs.microsoft.com/azure/service-fabric/service-fabric-controlled-chaos)
...
* [Service Fabric 클러스터 노드에 대 한 패치 관리](https://docs.microsoft.com/azure/service-fabric/service-fabric-best-practices-infrastructure-as-code#azure-virtual-machine-operating-system-automatic-upgrade-configuration)

* [Azure 가상 머신 확장 집합을 사용 하 여 자동 OS 이미지 업그레이드](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-automatic-upgrade)
...
* [Service Fabric 클러스터에 대 한 OS 패치 일정을 구성 하는 방법](https://docs.microsoft.com/azure/service-fabric/service-fabric-patch-orchestration-application)
...
* [Service Fabric에서 Azure에 관리 id 사용](https://docs.microsoft.com/azure/service-fabric/concepts-managed-identity)

* [새 Service Fabric 클러스터에 대 한 관리 id 지원 구성](https://docs.microsoft.com/azure/service-fabric/configure-new-azure-service-fabric-enable-managed-identity)

* [Service Fabric 응용 프로그램에서 관리 id 사용](https://docs.microsoft.com/azure/service-fabric/how-to-managed-identity-service-fabric-app-code)

* [Service Fabric 응용 프로그램에 대 한 KeyVaultReference 지원](https://docs.microsoft.com/azure/service-fabric/service-fabric-keyvault-references)
...
* [Service Fabric 클러스터의 인증서 관리](https://docs.microsoft.com/azure/service-fabric/cluster-security-certificate-management#certificate-rotation)
...
* [Windows Server 2016에 대 한 Windows Defender 바이러스 백신 이해](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-antivirus/windows-defender-antivirus-on-windows-server-2016)
...
* [Azure Service Fabric 클러스터에서 정기 백업 및 복원](https://docs.microsoft.com/azure/service-fabric/service-fabric-backuprestoreservice-quickstart-azurecluster)
...
* [Azure Service Fabric의 정기 백업 구성 이해](https://docs.microsoft.com/azure/service-fabric/service-fabric-backuprestoreservice-configure-periodic-backup)
...
* [Azure Service Fabric에서 백업 복원](https://docs.microsoft.com/azure/service-fabric/service-fabric-backup-restore-service-trigger-restore)
