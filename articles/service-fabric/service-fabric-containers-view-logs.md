...
**Runinteractive** 설정은 Docker의 `--interactive` 및 `tty` [플래그](https://docs.docker.com/engine/reference/commandline/run/#options)에 해당 합니다. 매니페스트 파일에서 이 설정을 true로 지정하면 이러한 플래그가 컨테이너를 시작하는 데 사용됩니다.  
