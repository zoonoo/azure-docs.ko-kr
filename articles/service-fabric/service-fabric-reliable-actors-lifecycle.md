---
title: 신뢰할 수 있는 행위자 수명 주기 | Microsoft Docs
...
> [!TIP]
> 패브릭 행위자 런타임에서는 일부 [행위자 활성화 및 비활성화 관련 이벤트](service-fabric-reliable-actors-diagnostics.md#actor-activation-and-deactivation-events)를 내보냅니다. 진단 및 성능 모니터링에 유용합니다.
> 
> 
