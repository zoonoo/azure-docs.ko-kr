...
> [!NOTE]
> Windows Server 2016 Datacenter는 호스트에서 SMB 마운트를 지원하지 않습니다([Windows Server 버전 1709에서만 지원됨](https://docs.microsoft.com/en-us/virtualization/windowscontainers/manage-containers/container-storage)). 따라서 Azure 파일 볼륨 드라이버와 같은 특정 볼륨 드라이버를 사용할 수 없습니다. 대신 **net use**를 사용하여 컨테이너 내에서 직접 공유를 마운트할 수 있습니다. 
>   
