---
title: Azure 서비스 패브릭 CLI- sfctl rpm
description: Azure 서비스 패브릭 명령줄 인터페이스인 sfctl에 대해 알아봅니다. 복구 관리자 서비스에 대한 명령 목록을 포함합니다.
author: jeffj6123
ms.topic: reference
ms.date: 1/16/2020
ms.author: jejarry
...
| --state-filter | 결과 목록에 포함되어야 하는 작업 상태를 지정하는 다음 값의 비트 OR입니다. <ul><li>1 - 생성됨</li><li>2 - 청구됨</li><li>4 - 준비 중</li><li>8 - 승인됨</li><li>16 - 실행 중</li><li>32 - 복원</li><li>64 - 완료됨</li></ul>
