...
ms.locfileid: "80385047"
---
# <a name="supported-service-fabric-versions"></a>지원되는 Service Fabric 버전

클러스터가 항상 지원되는 Azure 서비스 패브릭 버전을 실행하고 있는지 확인합니다. 새 버전의 서비스 패브릭 릴리스를 발표한 후 최소 60일이 지나면 이전 버전에 대한 지원이 종료됩니다. [서비스 패브릭 팀 블로그에서](https://azure.microsoft.com/updates/?product=service-fabric)새로운 릴리스에 대한 공지를 확인할 수 있습니다.

지원되는 서비스 패브릭 버전을 실행하려면 다음 문서를 참조하십시오.

- [Azure Service Fabric 클러스터 업그레이드](service-fabric-cluster-upgrade.md)
- [독립 실행형 Windows 서버 클러스터에서 실행되는 서비스 패브릭 버전 업그레이드](service-fabric-cluster-upgrade-windows-server.md)

## <a name="supported-versions"></a>지원되는 버전

다음 표에는 서비스 패브릭 버전과 해당 지원 종료 날짜가 나열되어 있습니다.
...
| 6.3.* | 6.1.480.* |버전 3.2보다 작거나 같음 |2019년 3월 31일  |
| 6.4.* | 6.2.301.* |버전 3.3보다 작거나 같음 |2019년 9월 15일 |
| 6.5.* | 6.4.617.* |버전 3.4보다 작거나 같음 |2020년 8월 1일 |
| 7.0.466.* | 6.4.664.* |버전 4.0보다 작거나 같음|현재 버전이므로 종료 날짜가 없습니다. |
| 7.0.466.* | 6.5.* |버전 4.0보다 작거나 같음|현재 버전이므로 종료 날짜가 없습니다. |
| 7.0.470.* | 7.0.466.* |버전 4.0보다 작거나 같음 |현재 버전이므로 종료 날짜가 없습니다. |
...
## <a name="supported-version-names"></a>지원되는 버전 이름

다음 표에는 서비스 패브릭의 버전 이름과 해당 버전 번호가 나열되어 있습니다.

| 버전 이름 | Windows 버전 번호 | 리눅스 버전 번호 |
| --- | --- | --- |
