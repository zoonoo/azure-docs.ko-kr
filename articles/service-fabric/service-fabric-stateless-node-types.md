...
* 확장 집합의 **Upgradepolicy** **모드** 를 **롤링** 으로 설정 해야 합니다.
...
>[!NOTE]
> 상태 비저장 노드 유형이 여러 영역에 걸쳐 있는 가상 머신 확장 집합에 의해 지원 되는 경우 플랫폼 장애 도메인 수가 5로 업데이트 되어야 합니다. 자세한 내용은이 [템플릿을](https://github.com/Azure-Samples/service-fabric-cluster-templates/tree/master/15-VM-2-NodeTypes-Windows-Stateless-CrossAZ-Secure) 참조 하세요.
> 
