...
Azure Mobile Engagement [SDK]를[Link 5] 응용 프로그램에 통합하고 기본적인 Azure Mobile Engagement [개념]을 파악한 후에는[Link 6]두 가지 방법을 통해 앱용 Azure Mobile Engagement와 상호 작용할 수 있습니다. 표준 사용자는 [사용자 인터페이스]를 사용할 수 있으며,[Link 1] 개발자 사용자는 HTTP REST 기반 [API]를 사용할 수 있습니다[Link 4]. 일반적인 작업의 연습은 [방법 가이드]를 참조하세요[Link 3]. 문제가 발생하면 Azure Mobile Engagement [문제 해결 가이드]를 참조하세요[Link 2].
