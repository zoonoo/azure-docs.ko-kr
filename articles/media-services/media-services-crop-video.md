<properties
	pageTitle="비디오를 자르는 방법 | Microsoft Azure"
...
1. 입력 프레임의 가운데에 있는 1440x1080의 출력으로 잘라야 합니다.
1. 즉, X 오프셋은 (1920 – 1440)/2 = 240이고 Y 오프셋은 0입니다.
1. 자르기 사각형의 너비 및 높이는 각각 1440 및 1080입니다.
1. 인코딩 단계에서 해상도가 각각 1440x1080, 960x720 및 480x360인 세 계층을 생성할지를 묻습니다.
...
1. 위에서 설명했듯이 인코딩 설정의 너비 및 높이는 자른 비디오와 일치해야 합니다.
1. 자르기는 가로 모드에서 캡처된 비디오에 적용됩니다(즉, 세로로 또는 인물 모드로 스마트폰을 잡고 기록한 비디오에는 적용되지 않음).
1. 정사각형 픽셀로 캡처된 프로그레시브 비디오에서 가장 잘 작동합니다.
