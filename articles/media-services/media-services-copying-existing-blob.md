...
Blob은 미디어 서비스 계정에 연결된 저장소 계정 또는 미디어 서비스 계정에 연결되지 않은 저장소 계정에 존재할 수 있습니다. 이 항목에서는 저장소 계정에서 미디어 서비스 자산으로 Blob을 복사하는 방법을 보여줍니다. 데이터 센터 간에 복사할 수도 있습니다. 하지만 이 경우 요금이 발생할 수 있습니다. 가격 책정에 대한 자세한 내용은 [데이터 전송](http://azure.microsoft.com/pricing/#header-11)을 참조하세요.
