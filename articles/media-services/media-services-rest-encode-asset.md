...
---
# <a name="how-to-encode-an-asset-using-media-encoder-standard"></a>미디어 인코더 표준을 사용하여 자산을 인코드하는 방법
...
## <a name="create-a-job-using-a-jobtemplate"></a>JobTemplate을 사용하여 작업 만들기
...
자산을 인코드하는 작업을 만드는 방법을 알아보았습니다. 이제 [Media Services 작업 진행 상태를 확인하는 방법](media-services-rest-check-job-progress.md) 항목으로 이동하세요.
