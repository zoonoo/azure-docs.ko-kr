...
![외부 추론 모듈을 기반으로 하는 라이브 비디오 분석](./media/analyze-live-video/external-inferencing-module.png)
...
![외부 추론 모듈을 통해 검색 된 이동 프레임을 기반으로 하는 라이브 비디오 분석](./media/analyze-live-video/motion-detected-frames.png)
