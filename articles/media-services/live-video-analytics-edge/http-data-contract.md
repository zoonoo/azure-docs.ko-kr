---
title: HTTP 확장 데이터 계약 - Azure
description: 이 문서에서는 HTTP 프로토콜을 사용하여 Live Video Analytics 모듈과 AI 또는 CV 모듈 간에 메시지를 보내는 방법에 대해 알아봅니다.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88701959"
---
# <a name="http-extension-data-contract"></a>HTTP 확장 데이터 계약

이 문서에서는 HTTP 프로토콜을 사용하여 Live Video Analytics 모듈과 AI 또는 CV 모듈 간에 메시지를 보내는 방법에 대해 알아봅니다.
...
![클래스 계층 구조](./media/http-data-contract/class-hierarchy.png)
