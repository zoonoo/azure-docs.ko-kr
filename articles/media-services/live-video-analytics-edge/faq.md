---
title: IoT Edge의 Live Video Analytics FAQ - Azure
description: 이 문서는 IoT Edge의 Live Video Analytics에 대한 일반적인 질문과 대답입니다.
ms.topic: conceptual
ms.date: 12/01/2020
...
ms.locfileid: "106275960"
---
# <a name="live-video-analytics-on-iot-edge-faq"></a>IoT Edge의 Live Video Analytics FAQ
...
아니요, Live Video Analytics는 IP 카메라에서 비디오를 캡처하는 데 RTSP만 지원합니다. TCP/HTTP를 통한 RTSP 스트리밍을 지원하는 모든 카메라가 작동합니다. 
...
솔루션은 Live Video Analytics와 통신하기 위해 추론 서버에서 사용하는 통신 프로토콜에 따라 달라집니다. 다음 섹션에서는 각 프로토콜의 작동 방식에 대해 설명합니다.
