---
title: gRPC 확장 데이터 계약 - Azure
description: 이 문서에서는 gRPC 프로토콜을 사용하여 Live Video Analytics 모듈과 AI 또는 CV 사용자 지정 확장 간에 메시지를 보내는 방법에 대해 알아봅니다.
ms.topic: overview
ms.date: 09/14/2020
...
ms.locfileid: "88687231"
---
# <a name="grpc-extension-data-contract"></a>gRPC 확장 데이터 계약

이 문서에서는 gRPC 프로토콜을 사용하여 Live Video Analytics 모듈과 AI 또는 CV 사용자 지정 확장 간에 메시지를 보내는 방법에 대해 알아봅니다.
...
단일 세션에서: 클라이언트는 gRPC 스트림 세션을 통해 미디어 스트림 설명자, 다음으로 비디오 프레임을 [protobuf](https://developers.google.com/protocol-buffers) 메시지로 서버에 보냅니다. 서버는 스트림 설명자의 유효성을 검사하고, 비디오 프레임을 분석하고, 유추 결과를 protobuf 메시지로 반환합니다.

![gRPC 확장 계약](./media/data-contracts/grpc.png)
...
![프로토콜 메시지](./media/data-contracts/grpc2.png)
