<properties 
	...
	description="이 토픽에서는 .NET을 사용하여 Media Services에 연결하는 방법을 보여 줍니다." 
...
다음 App.config 파일에는 필수 연결 값이 포함됩니다. <appSettings> 요소의 값은 Media Services 계정 설정 과정에서 가져온 필수 값입니다.
