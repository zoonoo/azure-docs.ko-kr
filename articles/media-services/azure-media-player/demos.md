...
| AES HLS 프록시 시뮬레이션 | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_aes_token_withHLSProxy.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_aes_token_withHLSProxy.html) | 토큰을 포함 하는 AES 콘텐츠를 재생 하 여 iOS 장치에서 토큰을 사용할 수 있도록 HLS에 대 한 프록시를 표시 합니다. |
| AES 토큰 force 플래시 | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_aes_token_forceFlash.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_aes_token_forceFlash.html) | 토큰을 사용 하 여 AES 콘텐츠를 재생 하 여 Flashss 기술은 tech 강제 적용. |
| DRM |
| PlayReady, Widevine 및를 사용 하는 다중 DRM | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_multiDRM_PlayReadyWidevineFairPlay_notoken.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_multiDRM_PlayReadyWidevineFairPlay_notoken.html) | PlayReady, Widevine 및 헤더를 포함 하 여 토큰이 없는 DRM 콘텐츠 재생 |
| PlayReady 토큰 없음 | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_playready_notoken.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_playready_notoken.html) | 토큰 없이 PlayReady 콘텐츠를 재생 합니다. |
| PlayReady no token force Silverlight | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_playready_notoken_forceSilverlight.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_playready_notoken_forceSilverlight.html) | 토큰 없이 PlayReady 콘텐츠를 재생 하 여 강제로 silverlightSS 기술을 적용 합니다. |
| PlayReady 토큰 | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_playready_token.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_playready_token.html) | 토큰을 사용 하 여 PlayReady 콘텐츠 재생 |
| PlayReady 토큰 강제 Silverlight | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_playready_token_forceSilverlight.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_playready_token_forceSilverlight.html) | 토큰을 사용 하 여 PlayReady 콘텐츠를 재생 하 고 강제로 silverlightSS tech 합니다. |
| 프로토콜 및 기술 |
...
| UrlRewriter의 경우에만 MPEG 대시 적용 | [동적](https://amp.azure.net/libs/amp/latest/samples/dynamic_forceDash.html) | [정적](https://amp.azure.net/libs/amp/latest/samples/videotag_forceDash.html) | 대시 프로토콜을 사용 하는 경우에만 보호 되지 않는 콘텐츠 재생 |
