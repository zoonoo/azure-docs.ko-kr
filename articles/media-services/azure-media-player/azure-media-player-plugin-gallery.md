...
|  스프라이트 팁                         | [데모](https://www.smwcentral.net/?p=section&a=details&id=10301)                        | [GitHub](https://github.com/RickShahid/SpriteTip)                    | AMS(Azure Media Services) MES(Media Encoder Standard)에서 생성된 비디오 썸네일 이미지 스프라이트의 타임라인 렌더링을 위한 AMP(Azure Media Player) 플러그 인입니다. |
