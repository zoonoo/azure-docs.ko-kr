...
5.  비디오 코덱이 [여기에 나열된 Apple ProRes 버전](https://docs.microsoft.com/azure/media-services/media-services-media-encoder-standard-formats) 중 하나이고 오디오가 AAC 또는 PCM 중 하나이면 프리미엄 인코더는 입력으로 QuickTime/MOV 파일 형식을 지원합니다.
