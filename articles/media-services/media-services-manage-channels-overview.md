---
title: "Azure Media Services를 사용하는 라이브 스트리밍 개요 | Microsoft 문서"
...
---
# <a name="overview-of-live-steaming-using-azure-media-services"></a>Azure 미디어 서비스를 사용하는 라이브 스트리밍 개요
...
| 가격 |[가격 책정 페이지](/pricing/details/media-services/) 를 참조하고 "라이브 비디오" 탭 클릭 | [가격 책정 페이지](/pricing/details/media-services/) |
| 최대 실행 시간 |연중 무휴 |8시간 |
| 슬레이트 삽입 지원 |아니요 |예 |
| 광고 신호 지원 |아니요 |예 |
