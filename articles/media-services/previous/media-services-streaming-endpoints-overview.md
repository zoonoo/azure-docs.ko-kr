...
Azure Media Services 스트리밍 끝점 엔터티에 **Cdnprovider**, **cdnprovider**, **streamingendpointversion** 속성이 추가 되었습니다. 이러한 속성의 자세한 개요는 [여기](/rest/api/media/operations/streamingendpoint)를 참조하세요. 
