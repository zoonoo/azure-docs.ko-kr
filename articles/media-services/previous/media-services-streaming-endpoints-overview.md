...
Azure Media Services는 Streaming Endpoint 엔터티에 다음과 같은 속성을 추가했습니다. **Cdnprovider**, **cdnprovider**, **streamingendpointversion** 이러한 속성의 자세한 개요는 [여기](https://docs.microsoft.com/rest/api/media/operations/streamingendpoint)를 참조하세요. 
...
Media Services의 2017년 1월 릴리스부터 다음 두 가지 스트리밍 유형을 사용할 수 있습니다. **표준** (미리 보기) 및 **프리미엄**. 이러한 유형은 스트리밍 엔드포인트 버전 "2.0"의 일부입니다.
...
|형식|StreamingEndpointVersion|ScaleUnits|CDN|대금 청구|
|--------------|----------|-----------------|-----------------|-----------------|
|클래식|1.0|0|NA|Free|
...
동적 암호화|예|예
동적 패키징|예|예
소수 자릿수|대상 처리량까지 자동으로 확장합니다.|추가 스트리밍 단위입니다.
