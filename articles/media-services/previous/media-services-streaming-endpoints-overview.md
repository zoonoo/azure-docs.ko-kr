...
description: 이 문서에서는 Azure Media 서비스 스트리밍 끝점에 대한 개요를 제공합니다.
...
Azure Media 서비스는 스트리밍 엔드포인트 엔터티에 다음 속성을 추가했습니다: **CdnProvider,** **CdnProfile,** **StreamingEndpointVersion**. 이러한 속성의 자세한 개요는 [여기](https://docs.microsoft.com/rest/api/media/operations/streamingendpoint)를 참조하세요. 
...
미디어 서비스의 2017년 1월 릴리스부터 **표준(미리** 보기) 및 **프리미엄의**두 가지 스트리밍 유형이 있습니다. 이러한 유형은 스트리밍 엔드포인트 버전 "2.0"의 일부입니다.


|Type|Description|
|--------|--------|  
|**Standard**|기본 스트리밍 끝점은 **표준** 유형이며 스트리밍 단위를 조정하여 프리미엄 유형으로 변경할 수 있습니다.|
|**Premium** |이 옵션은 큰 규모나 세밀한 컨트롤을 필요로 하는 전문 시나리오에 적합합니다. 스트리밍 단위를 조정하여 **프리미엄** 유형으로 이동합니다.<br/>전용 스트리밍 엔드포인트는 격리된 환경에 거주하며 리소스를 위해 경쟁하지 않습니다.|
...
|Type|StreamingEndpointVersion|ScaleUnits|CDN|결제|
|--------------|----------|-----------------|-----------------|-----------------|
|클래식|1.0|0|해당 없음|무료|
|표준 스트리밍 끝점(미리 보기)|2.0|0|yes|유료|
|프리미엄 스트리밍 단위|1.0|>0|yes|유료|
|프리미엄 스트리밍 단위|2.0|>0|yes|유료|
