...
|기능|미디어 인코더 표준|Media Encoder Premium Workflow|
|---|---|---|
...
|[Dolby® Professional Loudness Correction](https://www.dolby.com/us/en/technologies/dolby-professional-loudness-solutions.pdf)<br/> Dialogue Intelligence™ 사용|아니요|예|
...
|다중 오디오 언어 트랙|제한|[예](media-services-media-encoder-premium-workflow-multiplefilesinput.md#example-2--multiple-audio-language-encoding)|

## <a id="billing"></a>각 인코더에서 사용되는 요금 청구 기준
| 미디어 프로세서 이름 | 적용 가능한 가격 | 참고 |
| --- | --- | --- |
| **미디어 인코더 표준** |인코더 |인코딩 작업은 출력으로 생성 된 모든 미디어 파일의 전체 재생 시간 (분)을 [여기][1]에 지정 된 속도 (인코더 열 아래)에 따라 요금이 청구 됩니다. |
| **미디어 인코더 Premium 워크플로** |프리미엄 인코더 |인코딩 작업은 [여기][1]에 지정 된 속도에서 프리미엄 인코더 열 아래에 출력으로 생성 된 모든 미디어 파일의 전체 재생 시간 (분)을 기준으로 요금이 청구 됩니다. |

## <a name="input-containerfile-formats"></a>입력 컨테이너/파일 형식
| 입력 컨테이너/파일 형식 | 미디어 인코더 표준 | Media Encoder Premium Workflow |
| --- | --- | --- |
| Adobe® Flash® F4V |예 |예 |
| MXF/SMPTE 377M |예 |예 |
| GXF |예 |예 |
...
| 입력 비디오 코덱 | 미디어 인코더 표준 | Media Encoder Premium Workflow |
| --- | --- | --- |
...
| 입력 오디오 코덱 | 미디어 인코더 표준 | Media Encoder Premium Workflow |
| --- | --- | --- |
...
| 출력 컨테이너/파일 형식 | 미디어 인코더 표준 | Media Encoder Premium Workflow |
| --- | --- | --- |
...
| 출력 오디오 코덱 | 미디어 인코더 표준 | Media Encoder Premium Workflow |
| --- | --- | --- |
| AES(SMPTE 331M 및 302M, AES3-2003) |아니요 |예 |
| Dolby® Digital(AC3) |아니요 |예 |
