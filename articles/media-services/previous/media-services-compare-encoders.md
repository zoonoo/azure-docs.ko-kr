...
|---|---|---|
|인코딩 중에 조건부 논리 적용<br/>(예를 들어, 입력이 HD인 경우 인코드 5.1 오디오)|예|yes|
|선택 자막|예|[예](media-services-premium-workflow-encoder-formats.md#closed_captioning)|
|[Dolby® Professional Loudness Correction](https://www.dolby.com/us/en/technologies/dolby-professional-loudness-solutions.pdf)<br/> Dialogue Intelligence™ 사용|예|yes|
|디-인터레이스, 역텔레시네|Basic|브로드캐스트 품질|
|검은색 테두리 감지 및 제거 <br/>(필러박스, 레터박스)|예|yes|
...
| 3GPP/3GPP2 |yes |예 |
| 부드러운 스트리밍 파일 형식(PIFF 1.3) |yes |예 |
| [DVR-MS(Microsoft Digital Video Recording)](https://msdn.microsoft.com/library/windows/desktop/dd692984) |yes |예 |
| Matroska/WebM |yes |예 |
| QuickTime(.mov) |yes |예 |
...
| Canopus HQ/HQX |예 |예 |
| Mpeg-4 2부 |yes |예 |
| [Theora](https://en.wikipedia.org/wiki/Theora) |yes |예 |
| Apple ProRes 422 |yes |예 |
| Apple ProRes 422 LT |yes |예 |
| Apple ProRes 422 HQ |yes |예 |
| Apple ProRes Proxy |yes |예 |
| Apple ProRes 4444 |yes |예 |
| Apple ProRes 4444 XQ |yes |예 |
| HEVC/H.265|기본 프로필|기본 및 기본 10 프로필|

## <a name="input-audio-codecs"></a>입력 오디오 코덱
| 입력 오디오 코덱 | 미디어 인코더 표준 | 미디어 인코더 Premium 워크플로 |
| --- | --- | --- |
| AES(SMPTE 331M 및 302M, AES3-2003) |예 |yes |
| Dolby® E |예 |yes |
| Dolby® Digital(AC3) |예 |yes |
| Dolby® Digital Plus(E-AC3) |예 |yes |
| AAC(AAC-LC, AAC-HE 및 AAC-HEv2, 최대 5.1) |yes |yes |
| MPEG Layer 2 |yes |yes |
| MP3(MPEG-1 Audio Layer 3) |yes |yes |
| Windows Media 오디오 |yes |yes |
| WAV/PCM |yes |yes |
| [Flac](https://en.wikipedia.org/wiki/FLAC)</a> |yes |예 |
| [오푸스](https://en.wikipedia.org/wiki/Opus_\(audio_format\)) |yes |예 |
| [Vorbis](https://en.wikipedia.org/wiki/Vorbis)</a> |yes |예 |

## <a name="output-containerfile-formats"></a>출력 컨테이너/파일 형식
| 출력 컨테이너/파일 형식 | 미디어 인코더 표준 | 미디어 인코더 Premium 워크플로 |
| --- | --- | --- |
| Adobe® Flash® F4V |예 |yes |
| MXF(OP1a, XDCAM 및 AS02) |예 |yes |
| DPP(AS11 포함) |예 |yes |
| GXF |예 |yes |
| MPEG-4/MP4 |yes |yes |
| MPEG-TS |yes |yes |
| Windows Media/ASF |예 |yes |
| AVI(압축되지 않은 8비트/10비트) |예 |yes |
| 부드러운 스트리밍 파일 형식(PIFF 1.3) |예 |yes |
...
| HEVC(H.265; 8비트 및 10비트;)  |예 |yes |
| Avid DNxHD(MXF) |예 |yes |
| MPEG-2(최대 422 프로필 및 높은 수준, XDCAM, XDCAM HD, XDCAM IMX, CableLabs® 및 D10과 같은 변형 포함) |예 |yes |
| MPEG-1 |예 |yes |
| Windows Media 비디오/VC-1 |예 |yes |
...
| AES(SMPTE 331M 및 302M, AES3-2003) |예 |yes |
| Dolby® Digital(AC3) |예 |yes |
| Dolby® Digital Plus(E-AC3) 최대 7.1 |예 |yes |
| AAC(AAC-LC, AAC-HE 및 AAC-HEv2, 최대 5.1) |yes |yes |
| MPEG Layer 2 |예 |yes |
| MP3(MPEG-1 Audio Layer 3) |예 |yes |
| Windows Media 오디오 |예 |yes |
