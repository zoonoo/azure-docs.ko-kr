...
ms.locfileid: "86056211"
---
# <a name="input-metadata"></a>입력 메타데이터 

인코딩 작업은 일부 인코딩 태스크를 수행할 입력 자산(또는 자산)과 연결됩니다.  태스크가 완료되는 즉시 출력 자산이 생성됩니다.  출력 자산에는 비디오, 오디오, 미리 보기, 매니페스트 등이 포함 됩니다. 출력 자산에는 입력 자산에 대 한 메타 데이터가 있는 파일도 포함 됩니다. 메타데이터 XML 파일의 이름 형식은 &lt;asset_id&gt;_metadata.xml입니다(예: 41114ad3-eb5e-4c57-8d92-5354e2b7d4a4_metadata.xml). 여기서 &lt;asset_id&gt;는 입력 자산의 AssetId 값입니다.  
...
## <a name="assetfiles-element-root-element"></a><a name="AssetFiles"></a> AssetFiles 요소(루트 요소)
...
| --- | --- | --- |
| **이름**<br /><br /> 필요한 공간 |**xs:string** |자산 파일의 이름입니다. |
| **크기**<br /><br /> 필요한 공간 |**xs:long** |자산 파일의 크기(바이트)입니다. |
| **Duration**<br /><br /> 필요한 공간 |**xs:duration** |콘텐츠 재생 시간입니다. 예제: Duration="PT25M37.757S" |
| **NumberOfStreams**<br /><br /> 필요한 공간 |**xs:int** |자산 파일의 스트림 수입니다. |
| **FormatNames**<br /><br /> 필요한 공간 |**xs: string** |형식 이름입니다. |
| **FormatVerboseNames**<br /><br /> 필요한 공간 |**xs: string** |자세한 형식 이름입니다. |
...
| Name | Type | 설명 |
| --- | --- | --- |
| **프로그램**<br /><br /> minOccurs="0" | |자산 파일의 형식이 MPEG-TS인 경우 모든 [Programs 요소](media-services-input-metadata-schema.md#Programs)의 컬렉션입니다. |
...
| **메타데이터**<br /><br /> minOccurs="0" maxOccurs="unbounded" |[MetadataType](media-services-input-metadata-schema.md#MetadataType) |key/value 문자열로 표시되는 자산 파일의 메타데이터입니다. 예를 들어:<br /><br /> **&lt;Metadata key = "language" value = "eng"/&gt;** |
...
| Name | Type | 설명 |
| --- | --- | --- |
| **ID**<br /><br /> 필요한 공간 |**xs:int** |이 오디오 또는 비디오 트랙의 0 기준 인덱스입니다.<br /><br /> 반드시 MP4 파일에 사용되는 TrackID일 필요는 없습니다. |
| **Codec** |**xs:string** |비디오 트랙 코덱 문자열입니다. |
| **CodecLongName** |**xs: string** |오디오 또는 비디오 트랙 코덱의 긴 이름입니다. |
| **TimeBase**<br /><br /> 필요한 공간 |**xs:string** |시간 기준입니다. 예제: TimeBase="1/48000" |
...
| **Channels**<br /><br /> 필요한 공간 |**xs:int** |오디오 채널 수입니다(0개 이상). |
| **SamplingRate**<br /><br /> 필요한 공간 |**xs:int** |오디오 샘플링 속도(샘플/초 또는 Hz)입니다. |
...
| **Width**<br /><br /> 필요한 공간 |**xs:int** |인코딩된 비디오 너비(픽셀)입니다. |
| **높이**<br /><br /> 필요한 공간 |**xs:int** |인코딩된 비디오 높이(픽셀)입니다. |
| **DisplayAspectRatioNumerator**<br /><br /> 필요한 공간 |**xs: double** |비디오 디스플레이 가로 세로 비율의 분자입니다. |
| **DisplayAspectRatioDenominator**<br /><br /> 필요한 공간 |**xs:double** |비디오 디스플레이 가로 세로 비율의 분모입니다. |
| **DisplayAspectRatioDenominator**<br /><br /> 필요한 공간 |**xs: double** |비디오 샘플 가로 세로 비율의 분자입니다. |
| **SampleAspectRatioNumerator** |**xs: double** |비디오 샘플 가로 세로 비율의 분자입니다. |
| **SampleAspectRatioNumerator** |**xs:double** |비디오 샘플 가로 세로 비율의 분모입니다. |
| **속도**<br /><br /> 필요한 공간 |**xs:decimal** |.3f 형식으로 측정된 비디오 프레임 속도입니다. |
...
| 이름 | Type | 설명 |
| --- | --- | --- |
| **key**<br /><br /> 필요한 공간 |**xs:string** |key/value 쌍의 키입니다. |
| **value**<br /><br /> 필요한 공간 |**xs:string** |key/value 쌍의 값입니다. |
...
| 이름 | Type | 설명 |
| --- | --- | --- |
| **ProgramId**<br /><br /> 필요한 공간 |**xs:int** |Program ID입니다. |
| **NumberOfPrograms**<br /><br /> 필요한 공간 |**xs:int** |프로그램 수입니다. |
| **PmtPid**<br /><br /> 필요한 공간 |**xs:int** |PMT(프로그램 맵 테이블)에는 프로그램에 대한 정보가 포함됩니다.  자세한 내용은 [PMT](https://en.wikipedia.org/wiki/MPEG_transport_stream#PMT)를 참조하세요. |
| **PcrPid**<br /><br /> 필요한 공간 |**xs: int** |디코더에서 사용됩니다. 자세한 내용은 [PCR](https://en.wikipedia.org/wiki/MPEG_transport_stream#PCR)을 참조하세요. |
...
| 이름 | Type | Description |
| --- | --- | --- |
| **기본값**<br /><br /> 필요한 공간 |**xs: int** |기본 프레젠테이션임을 나타내려면 이 속성을 1로 설정합니다. |
| **Dub**<br /><br /> 필요한 공간 |**xs:int** |더빙된 프레젠테이션임을 나타내려면 이 속성을 1로 설정합니다. |
| **원래 이름**<br /><br /> 필요한 공간 |**xs: int** |원본 프레젠테이션임을 나타내려면 이 속성을 1로 설정합니다. |
| **설명**<br /><br /> 필요한 공간 |**xs:int** |이 트랙에 해설이 있음을 나타내려면 이 속성을 1로 설정합니다. |
| **Lyrics**<br /><br /> 필요한 공간 |**xs:int** |이 트랙에 가사가 있음을 나타내려면 이 속성을 1로 설정합니다. |
| **Karaoke**<br /><br /> 필요한 공간 |**xs:int** |가라오케 트랙(배경 음악, 보컬 없음)임을 나타내려면 이 성을 1로 설정합니다. |
| **정해**<br /><br /> 필요한 공간 |**xs:int** |강제 프레젠테이션임을 나타내려면 이 속성을 1로 설정합니다. |
| **HearingImpaired**<br /><br /> 필요한 공간 |**xs:int** |이 트랙은 청각을 어려운 사용자를 위해이 트랙 임을 나타내려면이 특성을 1로 설정 합니다. |
| **VisualImpaired**<br /><br /> 필요한 공간 |**xs:int** |시각 장애자용 트랙임을 나타내려면 이 속성을 1로 설정합니다. |
| **CleanEffects**<br /><br /> 필요한 공간 |**xs: int** |이 트랙에 새 효과가 있음을 나타내려면 이 속성을 1로 설정합니다. |
| **AttachedPic**<br /><br /> 필요한 공간 |**xs: int** |이 트랙에 그림이 있음을 나타내려면 이 속성을 1로 설정합니다. |

## <a name="programs-element"></a><a name="Programs"></a> Programs 요소
...
## <a name="schema-code"></a><a name="code"></a>스키마 코드
```xml
