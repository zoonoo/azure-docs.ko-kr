...
description: 이 문서에서는 Media Encoder Standard 기본 설정의 기반이 되는 XML 스키마의 일부 요소와 유형을 설명 합니다.
author: Juliako
manager: femila
editor: ''
...
| name | Type | 설명 |
| --- | --- | --- |
| **FileName** |**xs:string** |출력 파일 이름입니다.<br/><br/> 다음 표에 설명된 매크로를 사용하여 출력 파일 이름을 작성할 수 있습니다. 다음은 그 예입니다.<br/><br/> **"Outputs": [      {       "FileName": "{Basename} *{Resolution}* {Bitrate}.mp4",       "Format": {         "Type": "MP4Format"       }     }   ]** |
