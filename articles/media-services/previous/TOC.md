...
### [Windows 10용 오프라인 PlayReady](offline-playready-streaming-windows-10.md)
...
### 기타 재생 옵션
#### [부드러운 스트리밍 Windows 스토어 애플리케이션](media-services-build-smooth-streaming-apps.md)
#### [DASH.js 사용 HTML5 애플리케이션](media-services-embed-mpeg-dash-in-html5.md)
