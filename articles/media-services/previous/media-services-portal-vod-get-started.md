...
## <a name="start-the-streaming-endpoint"></a>스트리밍 끝점 시작
...
> [!NOTE]
> Media Services 계정이 만들어질 때 기본 스트리밍 끝점은 **중지됨** 상태에서 계정에 추가됩니다. 콘텐츠 스트리밍을 시작하고 동적 패키징 및 동적 암호화를 활용하려면 콘텐츠를 스트리밍하려는 스트리밍 끝점은 **실행** 상태에 있어야 합니다. 

스트리밍 끝점을 시작하려면

1. [Azure 포털](https://portal.azure.com/)에 로그인합니다.
2. **설정** > **스트리밍 끝점**을 선택합니다. 
3. 기본 스트리밍 끝점을 선택합니다. **기본 스트리밍 끝점 세부 정보** 창이 나타납니다.
4. **시작** 아이콘을 선택합니다.
5. **저장** 단추를 선택합니다.
...
* 스트리밍을 시작하려면 기본 스트리밍 끝점 실행을 시작하세요.
* 비디오가 게시된 것을 확인합니다.
