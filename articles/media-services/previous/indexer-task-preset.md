...
|SaaS 앱 개발<br/><br/>버전 1.2에 추가되었습니다. 현재 지원되는 유일한 기능은 음성 인식("ASR")입니다.|false|음성 인식 기능에는 다음 설정 키가 포함됩니다.<br/><br/>언어:<br/>- 멀티미디어 파일에서 인식할 자연어<br/>- English, Spanish<br/><br/>CaptionFormats:<br/>- 원하는 출력 캡션 형식의 세미콜론으로 구분된 목록(있는 경우)<br/>- ttml;webvtt<br/><br/><br/>GenerateKeywords:<br/>- 키워드 XML 파일이 필요한지를 지정하는 부울 플래그<br/>- True, False|
