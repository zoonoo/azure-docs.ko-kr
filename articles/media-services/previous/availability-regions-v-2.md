...
> [!NOTE]
> Media Services v2에는 새로운 특징 또는 기능이 추가되지 않습니다. [Media Services v3](../latest/media-services-overview.md)의 최신 버전을 확인하세요. 또한 [v2에서 v3로의 마이그레이션 지침](../latest/migrate-v-2-v-3-migration-introduction.md)을 참조하세요.
