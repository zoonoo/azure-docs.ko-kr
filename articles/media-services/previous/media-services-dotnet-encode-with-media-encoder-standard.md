...
출력 자산이 암호화된 스토리지인 경우 자산 배달 정책을 구성해야 합니다. 자세한 내용은 [자산 배달 정책 구성](media-services-dotnet-configure-asset-delivery-policy.md)을 참조 하세요.
...
* [적응 스트리밍](media-services-autogen-bitrate-ladder-with-mes.md) 사전 설정을 사용 하도록 지정 합니다. 
* 작업에 단일 인코딩을 추가합니다. 
* 인코딩할 입력 자산을 지정합니다.
