...
description: Azure Media Redactor는 클라우드에서 확장 가능한 얼굴 수정을 제공하는 Azure 미디어 분석 미디어 프로세서입니다. 이 문서에서는 Azure 미디어 분석을 사용하여 얼굴을 수정하는 방법을 보여 줍니다.
