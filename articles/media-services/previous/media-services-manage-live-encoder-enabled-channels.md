...
TLS 연결을 통해 조각화 된 MP4 부드러운 스트리밍 (수집) 라이브 스트림을 선택할 수 있습니다. TLS를 통해 수집하려면 수집 URL을 HTTPS로 업데이트해야 합니다. 현재 AMS는 사용자 지정 도메인에서 TLS를 지원 하지 않습니다.  
...
* **삭제**합니다. 채널이 삭제 중입니다. 이 상태에서는 업데이트 또는 스트리밍이 허용되지 않습니다.
