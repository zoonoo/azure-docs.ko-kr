...
description: 이 문서에서는 콘텐츠 키에 대한 인증 정책을 구성하는 방법에 대해 설명합니다.
...
토큰 제한 정책에는 STS(보안 토큰 서비스)에서 발급한 토큰이 수반되어야 합니다. Media Services는 [SWT(단순 웹 토큰)](/previous-versions/azure/azure-services/gg185950(v=azure.100)#BKMK_2) 형식 및 JWT(JSON Web Token) 형식의 토큰을 지원합니다. 자세한 내용은 [JWT 인증](http://www.gtrifonov.com/2015/01/03/jwt-token-authentication-in-azure-media-services-and-dynamic-encryption/)을 참조하세요.
