...
description: 이 문서에서는 Azure Media Services v2를 통해 콘텐츠 보호에 대한 개요를 제공합니다.
...
Media Services를 사용하여 AES 암호화되지 않은 키 또는 PlayReady, Widevine 또는 FairPlay 등과 같은 DRM 암호화로 동적 암호화된 콘텐츠를 제공할 수 있습니다. 콘텐츠가 AES 지우기 키로 암호화되고 HTTPS를 통해 전송되는 경우 클라이언트에 도달할 때까지 명확하지 않습니다. 
...
## <a name="aes-128-clear-key-vs-drm"></a>AES-128 클리어 키 vs. DRM
...
* [플레이레디 및/또는 와이드바인으로 보호](media-services-protect-with-playready-widevine.md)
