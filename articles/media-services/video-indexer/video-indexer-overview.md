...
- **감정 감지**: 음성 (감정을) 및 음성 tonality (설명)를 기반으로 하는를 식별 합니다.  감정은 joy(기쁨), sadness(슬픔), anger(분노) 또는 fear(두려움)일 수 있습니다.
...
- 콘텐츠 만들기 – 비디오에서 추출 된 정보를 효율적으로 만드는 데 도움이 됩니다. 예를 들어, 조직 보관의 기존 콘텐츠에서 트레일러, 소셜 미디어 콘텐츠, 뉴스 클립 등의 콘텐츠를 효율적으로 만들 수 있습니다. 
