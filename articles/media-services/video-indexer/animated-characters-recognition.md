...
|Number of animation models|1|Up to 100 models per account (Custom Vision limitation).|
...
1. Tag and train the model.
    ...
    1. 새 이름을 입력한 후 새 이름 옆에 있는 확인 아이콘을 클릭합니다. This saves the new name in the model in Video Indexer.
