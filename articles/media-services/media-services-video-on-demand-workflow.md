...
**Azure 관리 포털**을 이용하여 [Azure Media Services 계정](media-services-create-account.md)을 만듭니다. 
...
개요는 [Azure 미디어 서비스 작업 사용](media-services-jobs.md)을 참조하세요.
...
**개요**: [Azure 미디어 서비스로 주문형 콘텐츠 인코딩](media-services-encode-asset.md).
...
**개요**: [콘텐츠 개요 제공](media-services-deliver-content-overview.md)
