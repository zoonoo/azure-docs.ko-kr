...
DRM/CENC 하위 시스템 설계 및 구현에 대한 자세한 내용은 [다중 DRM 및 액세스 제어 기능을 갖춘 CENC](media-services-cenc-with-multidrm-access-control.md) 문서를 참조하세요.
...
자산 배달 정책 구성을 통해 AMS 동적 포장기에서 사용하는 다음 특성과 AMS 스트리밍 끝점의 동적 암호화를 제어할 수 있습니다.
