---
title: 동적 패키징 개요 | Microsoft Docs
...
1. [미리 인코드된 파일의 유효성을 검사합니다](media-services-static-packaging.md#validating-adaptive-bitrate-mp4s-encoded-with-external-encoders).
2. [콘텐츠를 스트리밍합니다](media-services-deliver-content-overview.md).
