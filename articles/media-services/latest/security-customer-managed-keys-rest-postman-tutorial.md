---
title: 고객 관리형 키 또는 BYOK REST API 사용
...
2020-05-01 API를 사용하면 시스템 관리 ID가 있는 Azure Media Services 계정에서 고객 관리형 RSA 키를 사용할 수 있습니다. 이 자습서에는 Azure 서비스에 REST 요청을 전송하는 Postman 컬렉션 및 환경이 포함되어 있습니다. 사용되는 서비스는 다음과 같습니다.
