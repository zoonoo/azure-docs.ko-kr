...
리소스 그룹을 이동한 다음 Media Services 계정이나 연결된 Azure Storage 계정이 “연결 끊김” 상태이면 스토리지 계정 키를 순환해 봅니다. 스토리지 계정 키를 순환해도 Media Services 계정의 “연결 끊김” 상태가 해결되지 않으면 Media Services 계정의 “지원 + 문제 해결” 메뉴에서 새 지원 요청을 제출합니다.  
