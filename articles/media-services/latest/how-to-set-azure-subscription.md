...
1. Azure 서비스 제목에서 구독을 선택 합니다. (구독이 나열 되지 않은 경우 Azure AD 테 넌 트를 전환 해야 할 수도 있습니다.) 구독 Id는 두 번째 열에 나열 됩니다.
1. 구독 ID를 복사 하 여 나중에 사용 하기 위해 선택한 텍스트 문서에 붙여 넣습니다.
...
### <a name="list-your-azure-subscriptions-with-cli"></a>CLI를 사용 하 여 Azure 구독 나열
