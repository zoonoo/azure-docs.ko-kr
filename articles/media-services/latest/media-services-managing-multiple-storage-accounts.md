---
title: 여러 저장소 계정에서 Media Services v3 자산 관리 | Microsoft Docs
description: 이 문서에서는 여러 저장소 계정에서 Media Services v3 자산을 관리 하는 방법에 대 한 지침을 제공 합니다.
...
ms.locfileid: "105572547"
---
# <a name="managing-media-services-v3-assets-across-multiple-storage-accounts"></a>여러 저장소 계정에서 Media Services v3 자산 관리  
