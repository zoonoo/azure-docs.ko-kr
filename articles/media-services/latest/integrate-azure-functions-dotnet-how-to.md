...
description: 이 항목에서는 Azure Portal을 사용하여 Media Services v3를 통해 Azure Functions 개발을 시작하는 방법을 보여줍니다.
...
>[!NOTE]
> 지정한 스토리지 계정은 앱과 동일한 지역에 있어야 합니다.
