...
사용자 지정 사전 설정 샘플은 [.NET을 사용하는 사용자 지정 사전 설정으로 인코딩](https://github.com/Azure-Samples/media-services-v3-dotnet/tree/main/VideoEncoding/EncodingWithMESCustomPreset_H264) 폴더에 있습니다.
