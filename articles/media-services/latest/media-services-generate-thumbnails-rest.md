...
description: 이 문서에서는 REST를 Media Encoder Standard와 함께 사용하여 동시에 자산을 인코딩하고 썸네일을 생성하는 방법을 보여줍니다.
...
[사용자 지정 변환을 사용하여 인코딩하는 방법 - REST](encode-custom-preset-rest-how-to.md)를 읽어 사용자 지정 변환에 익숙해지기를 권장합니다.
...
[.NET을 사용하여 썸네일 생성](media-services-generate-thumbnails-dotnet.md)