...
description: 이 항목에서는 Apple FairPlay 라이선스 요구 사항 및 구성에 관한 개요를 제공합니다.
...
다음 예제에서는 [Media Services .NET SDK](/dotnet/api/microsoft.azure.management.media.models)를 사용하여 라이선스를 구성합니다.
