...
* Azure Event Grid를 `JobStateChange` 통해 각 계정에서 메시지를 구독 합니다.
    * Azure Portal 또는 CLI를 통해 [이벤트를 등록](https://review.docs.microsoft.com/azure/media-services/latest/reacting-to-media-services-events) 합니다 (Eventgrid Management SDK를 사용 하 여 수행할 수도 있음).
