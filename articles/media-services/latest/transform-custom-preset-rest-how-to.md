...
- [Azure Media Services REST API 호출에 대해 Postman 구성](setup-postman-rest-how-to.md)<br/>[Azure AD 토큰 가져오기](setup-postman-rest-how-to.md#get-azure-ad-token) 항목의 마지막 단계를 수행해야 합니다. 
