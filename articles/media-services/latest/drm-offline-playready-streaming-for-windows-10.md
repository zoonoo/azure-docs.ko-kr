...
description: 이 문서에서는 Windows 10용 오프라인 PlayReady 스트리밍에 대한 Azure Media Services v3 계정을 구성하는 방법을 보여 줍니다.
...
- [iOS용 오프라인 FairPlay 스트리밍](drm-offline-fairplay-for-ios-concept.md)
- [Android용 오프라인 Widevine 스트리밍](drm-offline-widevine-for-android.md)

> [!NOTE]
> 오프라인 DRM은 콘텐츠를 다운로드할 때 단일 라이선스 요청에 대해서만 청구됩니다. 모든 오류에 대해 청구되지는 않습니다.

## <a name="background-on-offline-mode-playback"></a>오프라인 모드 재생에 관한 배경
