...
> [!NOTE]
> [StandardEncoderPreset](/rest/api/media/transforms/createorupdate#standardencoderpreset)에 대한 사용자 지정 표준 인코더 사전 설정 JSON 파일의 경로만 지정할 수 있습니다. [사용자 지정 변환으로 인코딩](transform-custom-preset-cli-how-to.md) 예제를 참조하세요.
>
