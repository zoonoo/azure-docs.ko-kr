...
> [!NOTE]
> 현재 Azure Media Player의 LowLatency HeuristicProfile은 CSF 또는 CMAF 형식 (예: `format=mdp-time-csf` 또는 `format=mdp-time-cmaf`)을 사용 하 여 mpeg-2 프로토콜의 스트림을 재생 하기 위한 것입니다. 
