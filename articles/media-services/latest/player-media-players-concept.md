...
[Azure Media Services에서 Shaka 플레이어를 사용하는 방법](player-shaka-player-how-to.md)을 참조하세요.
...
[Azure Media Services에서 Video.js 플레이어를 사용하는 방법](player-how-to-video-js-player.md)을 참조하세요.
