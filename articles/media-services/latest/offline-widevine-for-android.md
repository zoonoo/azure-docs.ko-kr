---
title: Azure 미디어 서비스 v3와 스트림 와이드 바인 안드로이드 오프라인
...
ms.locfileid: "80295431"
---
# <a name="offline-widevine-streaming-for-android-with-media-services-v3"></a>미디어 서비스 v3와 안드로이드에 대한 오프라인 와이드 바인 스트리밍
...
와이드바인 보안 레벨의 경우 Google의 "와이드바인 DRM 아키텍처 개요" 문서는 세 가지 보안 수준을 정의합니다. 그러나 [Widevine 라이선스 템플릿에 대한 Azure Media Services 설명서](widevine-license-template-overview.md)에는 5개의 보안 수준이 설명되어 있습니다. 두 가지 다른 보안 수준 집합 간에는 어떤 관계 또는 매핑이 있나요?
