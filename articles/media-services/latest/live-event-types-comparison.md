...
| 기능 | 통과 LiveEvent | 표준(기본) LiveEvent |
| --- | --- | --- |
...
| 변수 프레임 속도 입력에 대한 지원|yes|아니요 - 입력은 고정된 프레임 속도여야 함. 예를 들어 움직임이 많은 장면 중에는 사소한 차이가 허용됩니다. 그러나 기여 피드는 프레임 속도를 15프레임/초 등으로 늦출 수 없습니다.|
