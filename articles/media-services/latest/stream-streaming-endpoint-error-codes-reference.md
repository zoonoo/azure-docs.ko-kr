...
|MPE_FORMAT_NOT_SUPPORTED|0x80890205|미디어 형식이나 유형이 지원되지 않습니다. 예를 들어 Media Services는 64개를 초과하는 품질 수준 수를 지원하지 않습니다. FLV 비디오 태그에서 Media Services는 여러 SPS 및 여러 PPS가 있는 비디오 프레임을 지원하지 않습니다.|
...
|MPE_ENCRYPTION_NOT_SUPPORTED|0x80890208|지원되지 않는 암호화 형식이 발견되었습니다.|
...
|MPE_FILTER_TYPE_INVALID|0x80890238|잘못된 필터 유형입니다.|
