---
title: Media Services v3 iOS용 오프라인 FairPlay 스트리밍
description: 이 토픽에서는 오프라인 모드에서 Azure Media Services v3를 사용하여 Apple FairPlay에서 HLS(HTTP 라이브 스트리밍) 콘텐츠를 동적으로 암호화하는 방법과 개요를 설명합니다.
