...
ms.locfileid: "105960183"
---
# <a name="get-a-signing-key-from-the-existing-policy"></a>기존 정책에서 서명 키 가져오기

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

v3 API의 핵심 디자인 원칙 중 하나는 API를 더 안전하게 만드는 것입니다. v3 API는 **가져오기** 또는 **나열** 작업에서 비밀 또는 자격 증명을 반환하지 않습니다. 자세한 설명은 다음을 참조하세요. 자세한 내용은 [Azure RBAC 및 Media Services 계정](rbac-overview.md)을 참조하세요.
