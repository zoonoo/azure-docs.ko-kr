---
title: Media Services v3로 오프 라인 PlayReady 스트리밍-Azure
...
* 일부 국가/지역에서는 인터넷 가용성 및/또는 대역폭이 여전히 제한 됩니다. 사용자는 만족 스러운 보기 환경을 위해 충분히 높은 해상도로 콘텐츠를 볼 수 있도록 먼저를 다운로드 하도록 선택할 수 있습니다. 이 경우 대개 문제는 네트워크 가용성이 아니라 제한된 네트워크 대역폭입니다. OTT/OVP 공급자가 오프라인 모드 지원을 요청하고 있습니다.
