...
description: Java를 사용 하 여 Media Services v3 API에 연결 하는 방법을 알아봅니다.
...
명령을 `pom.xml`실행 하면, `App.java`및 기타 파일이 생성 됩니다. 
...
1. `App.java` 에서`src\main\java\com\azure\ams` 파일을 열고 패키지가 맨 위에 포함 되는지 확인 합니다.
