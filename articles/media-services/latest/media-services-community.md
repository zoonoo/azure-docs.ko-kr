...
[@MSFTAzureMedia](https://twitter.com/MSFTAzureMedia) twitter 핸들을 사용 하 여 microsoft에 문의 하거나 twitter의 업데이트를 팔 로우 할 수 있습니다. Twitter에서 지원을 요청 하려면 [@AzureSupport](https://twitter.com/azuresupport) twitter 핸들을 사용 합니다.  
