...
| state | 문자열 | 이 이벤트에서 알리는 직업의 새로운 상태입니다. 예를 들어, “예약됨: 작업을 실행할 준비가 됨” 또는 “완료됨: 작업이 완료됨”입니다.|
...
| 제목 | 문자열 | Media Services 계정에 속한 Media Services 채널에 대한 리소스 경로입니다. topic과 subject를 연결하면 작업에 대한 리소스 ID가 제공됩니다. |
