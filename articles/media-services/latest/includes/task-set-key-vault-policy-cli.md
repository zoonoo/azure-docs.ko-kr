...
ms.locfileid: "110103263"
---
<!-- ### Set the the Key Vault policy -->

이 명령을 사용하려면 Media Services `principalId`를 `object-id`로 포함해야 합니다. 아직 수행하지 않은 경우 `az ams account show --name <your-media-services-account-name> --resource-group <your-resource-group>`을 사용하여 이 ID를 가져옵니다.
