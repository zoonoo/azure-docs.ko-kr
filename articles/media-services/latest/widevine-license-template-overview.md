---
title: 와이드 바인 라이센스 템플릿 개요와 Azure 미디어 서비스 v3
...
ms.locfileid: "76705635"
---
# <a name="media-services-v3-with-widevine-license-template-overview"></a>와이드 바인 라이센스 템플릿 개요와 미디어 서비스 v3
