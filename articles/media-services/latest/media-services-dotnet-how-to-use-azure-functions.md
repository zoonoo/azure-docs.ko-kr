...
description: 이 토픽에서는 Azure Portal을 사용하여 Media Services v3를 통해 Azure Functions 개발을 시작하는 방법을 보여줍니다.
...
ms.locfileid: "105961679"
---
# <a name="develop-azure-functions-with-media-services-v3"></a>Media Services v3를 통해 Azure Functions 개발

[!INCLUDE [media services api v3 logo](./includes/v3-hr.md)]

이 문서에서는 Media Services를 사용하여 Azure Functions 만들기를 시작하는 방법을 보여 줍니다. 이 문서에 정의된 Azure 함수는 새 MP4 파일에 대한 스토리지 계정 컨테이너 **input** 을 모니터링합니다. 파일이 스토리지 컨테이너에 포함되면 blob 트리거가 함수를 실행합니다. Azure Functions를 검토하려면 **Azure Functions** 섹션의 [개요](../../azure-functions/functions-overview.md) 및 기타 토픽을 참조하세요.
...
>[!NOTE]
> 지정한 스토리지 계정은 앱과 같은 지역에 있어야 합니다.
...
Azure Media Services에서 Azure Functions 및 Logic Apps를 사용하여 사용자 지정 콘텐츠 생성 워크플로를 만드는 방법에 대한 자세한 내용 및 전체 샘플/솔루션은 [Media Services Azure Functions](https://github.com/Azure-Samples/media-services-v3-dotnet-core-functions-integration)를 참조하세요.
