---
title: Azure Portal을 사용하여 Azure AD 인증 시작
...
ms.locfileid: "79082747"
---
# <a name="use-the-azure-portal-to-get-credentials-to-access-media-services-api"></a>Azure Portal를 사용 하 여 Media Services API에 액세스할 수 있는 자격 증명을 가져옵니다.  
...
이 문서에서는 Azure Portal를 사용 하 여 Media Services API에 액세스 하기 위한 자격 증명을 가져오는 방법을 보여 줍니다.

## <a name="prerequisites"></a>사전 요구 사항

- Azure 계정. 계정이 없는 경우 [Azure 평가판](https://azure.microsoft.com/pricing/free-trial/)으로 시작하세요. 
- Media Services 계정. 자세한 내용은 [Azure Portal을 사용하여 Azure Media Services 계정 만들기](create-account-portal.md)를 참조하세요.
