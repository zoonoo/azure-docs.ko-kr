...
서비스: media services documentationcenter: ' ' author: IngridAtMicrosoft manager: femila ms.date editor: ' ' ms. 서비스: media services ms. 작업: ms. 항목: 개념 ms. 날짜: 01/29/2021. 작성자: inhenkel
---
...
저장소 계정에 대해 선택할 수 있는 다양 한 Sku가 있습니다. 스토리지 계정을 실험하려면 `--sku Standard_LRS`를 사용합니다. 그러나 프로덕션을 위해 SKU를 선택할 때 `--sku Standard_RAGRS` 비즈니스 연속성을 위한 지리적 복제를 제공 하는을 고려해 야 합니다.
