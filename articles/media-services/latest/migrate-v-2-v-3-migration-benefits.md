...
| 관리 ID | 관리 되는 id를 통해 개발자는 Azure AD의 Azure 리소스에 대 한 id를 제공 하 여 자격 증명을 관리할 필요가 없습니다. [여기](../../active-directory/managed-identities-azure-resources/overview.md)에서 관리 되는 id에 대 한 세부 정보를 참조 하세요. |
