...
**Azure 미디어 인덱서 2 미리 보기** MP(미디어 프로세서)를 사용하여 미디어 파일과 콘텐츠를 검색 가능하도록 설정할 수 있으며 선택 캡션 트랙을 생성할 수 있습니다. **Azure 미디어 인덱서 2 미리 보기**는 이전 버전의 [Azure 미디어 인덱서](media-services-index-content.md)에 비해 보다 빠른 인덱싱을 수행하고 더 광범위한 언어 지원을 제공합니다. 지원되는 언어는 영어, 스페인어, 프랑스어, 독일어, 이탈리아어, 중국어, 포르투갈어, 아랍어 등입니다.
...
>
>미리 보기는 처리 시간이 10분 이내로 제한되지만 모든 고객에게 무료로 제공됩니다.
>
...
1. 다음 json 기본 설정을 포함하는 구성 파일을 기반으로 인덱싱 작업이 포함된 작업을 만듭니다.
