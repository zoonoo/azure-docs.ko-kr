...
1. 완료되면 **다음: 사용자 지정**을 선택합니다.
    ...
    ![Azure IoT Central RuuviTag 센서 디바이스 템플릿](./media/tutorial-in-store-analytics-create-app/ruuvitag-device-template.png)
...
1. **저장**을 선택하여 변경 내용을 저장합니다.
    ...
    ![Azure IoT Central RuuviTag 디바이스 템플릿 사용자 지정](./media/tutorial-in-store-analytics-create-app/ruuvitag-device-template-customize.png)
