...
![이벤트 허브](./media/tutorial-in-store-analytics-visualize-insights/event-hub.png)
...
![연속 데이터 내보내기 구성](./media/tutorial-in-store-analytics-visualize-insights/export-configuration.png)
...
![영역 데이터 세트](./media/tutorial-in-store-analytics-visualize-insights/dataset-1.png)
...
![선점 데이터 세트](./media/tutorial-in-store-analytics-visualize-insights/dataset-2.png)
...
1. **디바이스 ID**를 적어 둡니다. 다음 스크린샷에서 ID는 **f5dcf4ac32e8** 및 **e29ffc8d5326**입니다.
    ...
    ![디바이스 ID](./media/tutorial-in-store-analytics-visualize-insights/device-ids.png)
...
1. **저장**을 선택한 다음, **디자이너**를 선택하여 추가한 논리의 시각적 버전을 확인합니다.
    ...
    ![논리 앱 디자인](./media/tutorial-in-store-analytics-visualize-insights/logic-app.png)
...
1. 로그인 프로세스가 완료되면 **데이터 세트에 행 추가** 작업에서 다음을 수행합니다.
    ...
    * **저장**을 선택하여 변경 내용을 저장합니다. **영역 1 환경** 작업은 다음 스크린샷과 같습니다. ![영역 1 환경](./media/tutorial-in-store-analytics-visualize-insights/zone-1-action.png)
...
1. **데이터 세트에 행 추가 2** 작업에서 다음을 수행합니다.
    ...
    * **습도** 필드를 선택한 다음, **원격 분석 구문 분석** 옆에 있는 **자세히 보기**를 선택합니다. 그런 다음, **humidity**를 선택합니다.
    * **온도** 필드를 선택한 다음, **원격 분석 구문 분석** 옆에 있는 **자세히 보기**를 선택합니다. 그런 다음, **temperature**를 선택합니다.
    **저장**을 선택하여 변경 내용을 저장합니다.  **영역 2 환경** 작업은 다음 스크린샷과 같습니다. ![영역 2 환경](./media/tutorial-in-store-analytics-visualize-insights/zone-2-action.png)
...
1. **데이터 세트에 행 추가** 작업에서 다음을 수행합니다.
    ...
    * **저장**을 선택하여 변경 내용을 저장합니다. **사람 수 인터페이스** 작업은 다음 스크린샷과 같습니다. ![선점 작업](./media/tutorial-in-store-analytics-visualize-insights/occupancy-action-2.png)
...
![꺾은선형 차트 설정](./media/tutorial-in-store-analytics-visualize-insights/line-chart.png)
...
![카드 설정](./media/tutorial-in-store-analytics-visualize-insights/card-settings.png)
...
![Power BI 대시보드](./media/tutorial-in-store-analytics-visualize-insights/pbi-dashboard-graphics.png)
