...
Azure IoT Central 애플리케이션에서 다음 측정값 및 장치 속성이 정의된 장치 템플릿이 필요합니다.
...
테이블에 표시된 필드 이름을 디바이스 템플릿에 똑같이 입력합니다. 필드 이름이 해당 장치 코드의 속성 이름과 일치하지 않는 경우 애플리케이션은 장치 속성 값을 표시할 수 없습니다.
