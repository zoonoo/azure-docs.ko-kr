...
ms.locfileid: "69879644"
---
# <a name="view-your-bill-in-an-iot-central-application"></a>IoT Central 응용 프로그램에서 청구서 보기
...
- **평가판** 응용 프로그램은 만료 되기 7 일 전에 무료로 제공 됩니다. 만료되기 전에 언제든지 종량제로 변환할 수 있습니다.
...
1. **관리** 섹션의 **청구** 페이지로 이동합니다.
    ...
    ![평가판 상태](media/howto-view-bill-pnp/freetrialbilling.png)

1. **종 량 제로 변환을**선택 합니다.

    ![평가판 변환](media/howto-view-bill-pnp/convert.png)
...
Azure IoT Central 응용 프로그램에서 청구서를 보는 방법에 대해 알아보았습니다. 다음 단계에서는 Azure IoT Central에서 [응용 프로그램 UI를 사용자 지정](howto-customize-ui-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 하는 방법에 대해 알아봅니다.