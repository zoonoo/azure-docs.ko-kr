...
description: 솔루션 개발자는 장치에서 원격 분석 전송을 중지할 때 전자 메일 알림을 보내도록 IoT Central 응용 프로그램을 구성 합니다. 이 솔루션은 Azure Stream Analytics 및 Azure Functions를 사용 합니다.
author: dominicbetts
ms.author: dobett
ms.date: 08/23/2019
ms.topic: conceptual
...
| 응용 프로그램 이름 | 기본값을 그대로 적용 하거나 고유한 이름을 선택 합니다. |
...
1. 이전에 만든 이벤트 허브를 사용 하 여 입력을 구성 하려면 다음 표의 정보를 사용 하 고 **저장**을 선택 합니다.
    ...
    | 구독 | 구독 |
    | Event Hubs 네임스페이스 | 이벤트 허브 네임 스페이스 |
    | Event Hubs 이름 | 기존- **centralexport** 사용 |
