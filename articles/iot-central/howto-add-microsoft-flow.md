...
1. 선택한 템플릿의 커넥터에 로그인 하 라는 메시지가 표시 됩니다. 
    ...
    > [!NOTE]
    > Azure IoT Central 커넥터를 사용 하려면 Azure Active Directory 계정 (회사 또는 학교 계정)을 사용 하 여 로그인 해야 합니다. abc@outlook.com 또는abc@live.com 와 같은 개인 계정은 Azure IoT Central 커넥터에서 지원 되지 않습니다.
