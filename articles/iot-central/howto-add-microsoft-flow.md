...
1. (선택 사항) 새 장치를 만드는 데 적합한 대로 다른 필드를 채웁니다.
...
1. 디바이스 이름을 업데이트할 수 있습니다. 장치의 속성 및 설정 중 하나를 업데이트하려면 **장치 템플릿** 드롭다운에서 업데이트하려는 장치의 장치 템플릿을 선택해야 합니다. 작업 타일은 업데이트할 수 있는 모든 속성 및 설정을 표시하도록 확장됩니다.
