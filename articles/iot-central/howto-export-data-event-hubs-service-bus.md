...
이제 데이터를 내보낼 Event Hubs/Service Bus 대상이 있으므로 다음 단계에 따라 연속 데이터 내보내기를 설정 합니다. 
