...
**디바이스 집합**을 선택하고, **필터**(선택 사항)를 추가하고, 시작할 **기간**을 선택해야 합니다. 완료되면 *결과 표시*를 클릭하여 데이터 시각화를 시작합니다.


* **디바이스 세트:** [디바이스 세트](howto-use-device-sets-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)는 사용자 정의 디바이스 그룹입니다. 예를 들어 오클랜드의 모든 냉장고 또는 모든 rev 2.0 풍력 발전용 터빈이 있습니다.
...
* **기간:** 기본적으로 지난 10분 동안의 데이터를 검색합니다. 이 값을 미리 정의된 시간 범위 중 하나로 변경하거나 사용자 지정 기간을 선택할 수 있습니다. 
 ...
 ![분석 쿼리](media/howto-create-analytics-experimental/analytics-query.png)
...
* **집계:**. 데이터는 기본적으로 평균으로 집계하지만, 데이터 집계를 요구 사항에 맞게 다른 항목으로 변경하도록 선택할 수 있습니다. 
   ...
   ![분석 시각화 분할 기준](media/howto-create-analytics-experimental/analytics-splitby.png)
...
* **그리드 표시:** 각 데이터 요소에 대한 특정 값을 볼 수 있도록 결과가 표 형식으로 제공됩니다. 이 보기는 내게 필요한 옵션 표준을 충족합니다. 
* **차트 표시:** 상향/하향 추세 및 이상 현상을 쉽게 파악할 수 있도록 결과를 선 형식으로 표시합니다. 

 ![분석에 대한 그리드 보기 표시](media/howto-create-analytics-experimental/analytics-showgrid.png)

확대/축소를 사용하면 데이터를 효과적으로 활용할 수 있습니다. 결과 집합 내에서 집중하려는 기간을 찾는 경우 커서를 사용하여 확대할 영역을 잡고, 사용 가능한 컨트롤을 통해 다음 작업 중 하나를 수행합니다.
...
* **확대/축소 다시 설정:** 다양한 확대/축소 수준을 수행한 경우 확대/축소 다시 설정 컨트롤을 사용하여 원래 결과 집합으로 돌아갈 수 있습니다. 
 ...
 ![데이터 확대/축소 수행](media/howto-create-analytics-experimental/analytics-zoom.png)
...
* **분산형:** 모든 점이 차트에 선으로 연결되지 않은 채 그려집니다. 
 ...
 ![분석에서 사용할 수 있는 다양한 선 유형](media/howto-create-analytics-experimental/analytics-linetypes.png)
...
* **Y축 공유:** 모든 그래프가 동일한 Y축을 공유하고 축 값이 변하지 않습니다. Y축 공유 그래프는 단일 측정값을 살펴보고 데이터를 기준에 따라 조각화하려는 경우에 유용합니다.
 ...
 ![다양한 시각화 모드를 사용하여 y-축을 따라 데이터 정렬](media/howto-create-analytics-experimental/analytics-yaxis.png)
...
> [Node.js 애플리케이션 준비 및 연결](howto-connect-nodejs-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)