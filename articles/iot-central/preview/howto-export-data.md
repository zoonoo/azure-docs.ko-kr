...
스냅숏의 각 메시지 또는 레코드는 마지막으로 내보낸 메시지 이후 장치 및 해당 속성에 대 한 변경 내용을 하나 이상 나타냅니다. 다음 내용이 포함됩니다.

- IoT Central의 디바이스 `@id`
- 디바이스의 `name`
- `deviceId`Device Provisioning Service[의 ](../core/howto-connect-nodejs.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json)
- 디바이스 템플릿 정보
- 속성 값
