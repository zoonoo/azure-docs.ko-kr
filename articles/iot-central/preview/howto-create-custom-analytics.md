...
이제 사용자 지정 분석을 만드는 방법을 배웠으므로 제안 된 다음 단계는 [Power BI 대시보드에서 Azure IoT Central 데이터를 시각화 하 고 분석](../core/howto-connect-powerbi.md?toc=/azure/iot-central/preview/toc.json&bc=/azure/iot-central/preview/breadcrumb/toc.json)하는 방법을 배우는 것입니다.
