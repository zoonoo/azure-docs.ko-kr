...
규모에 맞게 작동 하도록 설계 된 모든 IoT 솔루션을 사용 하 여 장치 관리에 대 한 잘 구성 된 접근 방식을 고려해 야 합니다. 장치를 클라우드에 "연결" 하는 것 만으로는 충분 하지 않습니다. 솔루션이 진화 하 고 성장 함에 따라 장치를 연결 하 고 정상 상태로 유지 하는 방법이 필요 합니다. Azure IoT Central는 응용 프로그램 수명 주기 동안 IoT 솔루션의 장치가 잘 확인 개체만 수 있도록 하는 데 필요한 기능을 제공 합니다.
