...
1. 왼쪽 탐색 메뉴에서 **장치** 를 선택 합니다. 여기에서 장치 템플릿 및 모든 장치 목록이 표시 됩니다.
...
1. **마이그레이션**을 선택 합니다.
    ...
    ![디바이스 연결](./media/howto-manage-devices-pnp/unassociateddevices2a.png)
