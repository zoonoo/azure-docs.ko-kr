...
이제 Azure IoT Central에서 사용자 및 역할을 관리 하는 방법을 배웠으므로 제안 된 다음 단계는 Azure IoT Central에서 [청구서 보기](howto-view-bill-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 에 대해 알아보는 것입니다.
