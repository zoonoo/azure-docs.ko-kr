...
2. 왼쪽 메뉴에서 **데이터 내보내기**를 선택 합니다.
    ...
    ![새 cde 이벤트 허브 만들기](media/howto-export-data-pnp/export-menu1.png)
...
3. 오른쪽 위에 있는 **+ 새로 만들기** 단추를 선택 합니다. 내보내기의 대상으로 **Azure Blob Storage** 를 선택 합니다. 
    ...
    ![새 연속 데이터 내보내기 만들기](media/howto-export-data-pnp/export-new1.png)
...
4. 드롭다운 목록 상자에서 **저장소 계정 네임 스페이스**를 선택 합니다. **연결 문자열 입력**인 목록의 마지막 옵션을 선택할 수도 있습니다. 
    ...
    ![새 cde 이벤트 허브 만들기](media/howto-export-data-pnp/export-create-blob.png)
...
6. 연속 데이터 내보내기를 켜려면 **데이터 내보내기**가 **켬**인지 확인합니다. **저장**을 선택합니다.
   ...
   ![연속 데이터 내보내기 구성](media/howto-export-data-pnp/export-list-blob.png)
...
> [Power BI에서 데이터 시각화하는 방법](howto-connect-powerbi-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
