...
* [새 디바이스 유형 정의](tutorial-define-device-type.md)
...
1. **설정**을 선택합니다. **온도 설정**을 75로 변경합니다. **업데이트**를 선택하여 새 대상 온도를 디바이스로 전송합니다. 디바이스가 설정 변경을 인식하는 경우 설정 값의 상태가 **동기화됨**으로 변경됩니다.
