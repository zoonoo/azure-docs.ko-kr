---
title: IoT Central을 사용하여 태양광 패널 모니터링 앱 만들기 | Microsoft Docs
description: Azure IoT Central 애플리케이션 템플릿을 사용하여 태양광 패널 애플리케이션을 만드는 방법에 대해 알아봅니다.
author: op-ravi
ms.author: omravi
ms.date: 10/23/2019
ms.topic: tutorial
