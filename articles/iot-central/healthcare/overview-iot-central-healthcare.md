...
1. **원격 환자 모니터링**: 의료 착용식 장치 및 환자 보고된 결과(PRO)를 사용하여 병원 밖의 환자를 모니터링함으로써 재입원의 위험을 크게 낮출 수 있습니다. 만성 질환 환자 및 재입원 환자의 데이터를 수집하여 환자가 의료 계획을 준수할 수 있도록 할 수 있으며 환자의 악화 징후의 경고를 더 위험해지기 전에 의료 팀에게 전달할 수 있습니다.

이 애플리케이션 템플릿은 지속적인 환자 모니터링의 두 범주에 대한 솔루션을 빌드하는 데 사용할 수 있습니다. 이점은 다음과 같습니다.

* 다양한 의료 착용식 장치를 IoT Central 인스턴스에 원활하게 연결합니다.
...
* 집계된 인사이트를 기존 또는 새 비즈니스 애플리케이션으로 내보내 의료 팀의 역량을 강화합니다.
