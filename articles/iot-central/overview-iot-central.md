...
새로운 Azure IoT Central 응용 프로그램을 빠르게 배포한 다음, 브라우저에서 특정 요구 사항에 맞게 사용자 지정할 수 있습니다. Azure IoT Central 개발자는 웹 기반 도구를 사용하여 응용 프로그램에 연결하는 장치에 대한 _장치 템플릿_을 만들 수 있습니다. 디바이스 템플릿은 디바이스 모델의 청사진입니다. 동일한 디바이스 템플릿에서 만들어진 모든 디바이스는 템플릿을 공유합니다. 장치 템플릿은 다음과 같은 장치 유형의 특성 및 동작을 정의합니다.
