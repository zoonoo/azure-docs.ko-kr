...
[Blob Storage로 내보내는 방법](howto-export-data-blob-storage.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)을 자세히 알아봅니다.
...
[Event Hubs 및 Service Bus로 내보내는 방법](howto-export-data-event-hubs-service-bus.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)을 자세히 알아봅니다.
...
2. 왼쪽 메뉴에서 **연속 데이터 내보내기**를 클릭합니다.
    ...
    ![새 cde 이벤트 허브 만들기](media/howto-export-data-experimental/export_menu.png)
...
3. 오른쪽 위에서 **+ 새로 만들기** 단추를 클릭합니다. **Azure Blob Storage**, **Azure Event Hubs** 또는 **Azure Service Bus** 중 하나를 내보내기 대상으로 선택합니다. 
    ...
    ![새 연속 데이터 내보내기 만들기](media/howto-export-data-experimental/export_new.png)
...
4. 드롭다운 목록 상자에서 **스토리지 계정/Event Hubs 네임스페이스/Service Bus 네임스페이스**를 선택합니다. **연결 문자열 입력**인 목록의 마지막 옵션을 선택할 수도 있습니다. 
    ...
    ![새 cde 이벤트 허브 만들기](media/howto-export-data-experimental/export_create.png)
...
6. 연속 데이터 내보내기를 켜려면 **데이터 내보내기**가 **켬**인지 확인합니다. **저장**을 선택합니다.
  ...
  ![연속 데이터 내보내기 구성](media/howto-export-data-experimental/export_list.png)
...
> [Azure Blob Storage로 데이터 내보내기](howto-export-data-blob-storage.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

> [!div class="nextstepaction"]
> [Azure Event Hubs 및 Azure Service Bus로 데이터 내보내기](howto-export-data-event-hubs-service-bus.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)

> [!div class="nextstepaction"]
> [Power BI에서 데이터 시각화하는 방법](howto-connect-powerbi.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
