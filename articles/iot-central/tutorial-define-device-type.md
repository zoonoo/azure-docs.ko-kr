...
이 자습서에서는 **연결된 공조 장치** 템플릿을 만듭니다. 연결된 공조 디바이스:
...
* 디바이스와 연결되는 메타데이터를 정의하기 위해 _속성_을 사용합니다. 속성에는 다음 두 카테고리가 있습니다.
    ...
    * 속성 값을 응용 프로그램에 보내도록 장치를 설정하려면 _장치 속성_을 사용할 수 있습니다. 이러한 속성은 디바이스에서만 변경할 수 있습니다. 연산자의 경우 장치 속성은 읽기 전용입니다. 이 연결된 공조 디바이스 시나리오에서 펌웨어 버전과 디바이스 일련 번호는 디바이스가 보고하는 디바이스 속성입니다. 
...
1. **연결된 공조 장치** 템플릿에 대한 **속성** 페이지로 이동합니다.
    ...
    숫자 또는 텍스트 등 다른 형식의 장치 속성을 만들 수 있습니다. 디바이스 템플릿에 위치 속성을 추가하려면 **위치**를 선택합니다.
