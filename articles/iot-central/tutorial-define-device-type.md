...
*속성*을 사용하여 응용 프로그램에서 장치에 대한 정보를 저장합니다. 이 섹션에서는 **연결된 공조 장치** 템플릿에 속성을 추가하여 장치 일련 번호 및 각 장치의 펌웨어 버전을 저장합니다.
...
3. 장치 템플릿에 펌웨어 버전 속성을 추가하려면 **텍스트** 선택

4. 펌웨어 버전 속성을 구성하려면 다음 표의 정보를 사용합니다.
