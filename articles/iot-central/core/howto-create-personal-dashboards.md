...
ms.locfileid: "72950666"
---
# <a name="create-and-manage-multiple-dashboards"></a>여러 대시보드 만들기 및 관리

**대시보드** 는 응용 프로그램을 처음 탐색할 때 로드 되는 페이지입니다. 응용 프로그램의 **작성기** 는 모든 사용자에 대 한 기본 응용 프로그램 대시보드를 정의 합니다. 이 기본 대시보드를 개인 설정 된 응용 프로그램 대시보드로 바꿀 수 있습니다. 여러 대시보드를 만들어 서로 다른 데이터를 표시 하 고 서로 전환할 수 있습니다. 
...
> [!div class="mx-imgBorder"]
> 온도](media/howto-create-personal-dashboards/device-details.png)에 대 한 세부 정보가 포함 된 장치 세부 정보 구성 ![
...
> [!div class="mx-imgBorder"]
> ![대시보드 "탭에서 온도 타일에 대 한 세부 정보가 포함 된](media/howto-create-personal-dashboards/temperature-tile-edit.png)

이제 개인 대시보드를 볼 때 장치의 **온도** 설정이 포함 된 새 타일이 표시 됩니다.

> [!div class="mx-imgBorder"]
> ![대시보드 "탭에서 온도 타일에 대 한 세부 정보가 포함 된](media/howto-create-personal-dashboards/temperature-tile-complete.png)
...
> [!div class="mx-imgBorder"]
> 대시보드를 삭제 ![](media/howto-create-personal-dashboards/delete-dashboards.png)
