...
1. [원격 분석 규칙](tutorial-create-telemetry-rules-pnp.md)을 만듭니다. 규칙을 저장하고 새 작업을 추가합니다.

    ![Webhook 만들기 화면](media/howto-create-webhooks-pnp/webhookcreate.png)
...
웹 후크를 설정 하 고 사용 하는 방법을 배웠으므로 이제 제안 된 다음 단계는 [Azure Monitor 작업 그룹 구성을](howto-use-action-groups-pnp.md)살펴보는 것입니다.
