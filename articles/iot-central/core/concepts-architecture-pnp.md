...
Azure IoT Central 응용 프로그램에서 데이터를 Azure Event Hubs 및 Azure Service Bus 인스턴스로 [지속적으로 내보낼](howto-export-data-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 수 있습니다. Azure Blob storage 계정에 주기적으로 데이터를 내보낼 수도 있습니다. IoT Central은 측정, 장치 및 장치 템플릿을 내보낼 수 있습니다.
