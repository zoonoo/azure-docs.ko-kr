---
title: '자습서: Azure IoT Central 애플리케이션에 실제 디바이스 추가'
description: '자습서: Azure IoT Central 애플리케이션에서 실제 디바이스를 추가하고 구성하는 방법을 알아봅니다. 실제 디바이스에 있는 코드에 대해서도 알아볼 수 있습니다.'
author: sandeeppujar
ms.author: sandeepu
ms.date: 11/13/2019
ms.topic: tutorial
...
1. 운영자로서 새 디바이스를 추가하려면 왼쪽 창에서 **디바이스**를 선택합니다.
