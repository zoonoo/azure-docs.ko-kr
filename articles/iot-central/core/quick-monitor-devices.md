...
description: 빠른 시작 - Azure IoT Central 애플리케이션을 사용하여 디바이스를 모니터링하는 방법을 알아봅니다.
author: dominicbetts
ms.author: dobett
ms.date: 11/16/2020
ms.topic: quickstart
