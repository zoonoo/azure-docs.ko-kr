...
1. 왼쪽 창에서 ***장치 템플릿*** 탭으로 이동 하 고 **+ 새로**만들기를 선택 하 ![새 장치 템플릿 만들기를 선택 합니다. 페이지](./media/howto-connect-ruuvi/devicetemplate-new.png) ***사용자 지정 템플릿을 만들거나*** ***미리 구성 된 장치 템플릿을 사용할*** 수 있는 옵션을 제공 합니다.
1. 아래와 같이 미리 구성 된 장치 템플릿 목록에서 RuuviTag 장치 템플릿을 선택 합니다. ![RuuviTag 장치 템플릿을 선택](./media/howto-connect-ruuvi/devicetemplate-preconfigured.png)
...
RuuviTag를 Azure IoT Central 응용 프로그램에 연결 하는 방법을 배웠으므로 이제 제안 된 다음 단계는 종단 간 솔루션을 빌드하기 위해 [IoT Central 응용 프로그램을 사용자 지정](../retail/tutorial-in-store-analytics-customize-dashboard-pnp.md) 하는 방법을 배우는 것입니다.
