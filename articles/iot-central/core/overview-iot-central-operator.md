...
ms.locfileid: "104609568"
---
# <a name="iot-central-operator-guide"></a>IoT Central 연산자 가이드

이 문서에서는 IoT Central 운영자 역할의 개요를 제공 합니다. 운영자는 애플리케이션에 연결된 디바이스를 관리합니다.

_운영자_ 는 애플리케이션에 연결된 디바이스를 관리합니다.

운영자로서 다음과 같은 일을 할 수 있습니다.
...
:::image type="content" source="media/overview-iot-central-tour/iot-central-homepage.png" alt-text="IoT Central 홈페이지의 스크린샷":::
...
1. **장치 페이지의** 오른쪽 창에 해당 장치 템플릿에서 만든 장치 목록이 표시 됩니다. 개별 디바이스를 선택하면 해당 디바이스의 디바이스 세부 정보 페이지를 볼 수 있습니다.
    ...
    ![장치 세부 정보 페이지의 스크린샷](./media/overview-iot-central-operator/device-list.png)
...
1. **가져오기** 를 선택합니다.
    ...
    ![가져오기 작업 스크린샷](./media/overview-iot-central-operator/bulk-import-1-a.png)
...
1. 가져오기가 완료 되 면 장치 작업 패널에 성공 메시지가 표시 됩니다.
    ...
    ![가져오기 성공의 스크린샷](./media/overview-iot-central-operator/bulk-import-3-a.png)
...
1. 왼쪽 패널에서 **모든 장치** 를 선택 합니다.
    ...
    ![연결 되지 않은 장치의 스크린샷](./media/overview-iot-central-operator/unassociated-devices-2-a.png)
...
1. **마이그레이션** 을 선택 합니다.
    ...
    ![장치 연결의 스크린샷](./media/overview-iot-central-operator/unassociated-devices-1-a.png)
...
1. 내보내려는 장치를 선택 하 고 **내보내기** 작업을 선택 합니다.
    ...
    ![내보내기 스크린샷](./media/overview-iot-central-operator/export-1-a.png)
...
1. 파일 **다운로드** 링크를 선택 하 여 디스크의 로컬 폴더에 파일을 다운로드 합니다.
    ...
    ![내보내기 성공 스크린샷](./media/overview-iot-central-operator/export-2-a.png)
...
연결 문자열 및 실제 장치를 IoT Central 응용 프로그램에 연결 하는 방법에 대 한 자세한 내용은 [Azure IoT Central에서 장치 연결](concepts-get-connected.md)을 참조 하세요.
...
1. **삭제** 를 선택 합니다. 장치 작업 패널에서이 삭제의 상태를 추적할 수 있습니다.
