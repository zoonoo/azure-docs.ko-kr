...
1. IoT Central 응용 프로그램에서 장치 인증서를 생성 하는 데 사용 하 _는 중간 또는 루트 x.509 인증서를 추가 하 고 확인 합니다_ .
    ...
    - **관리 > 장치 연결 > 인증서 (x.509)** 로 이동 하 여 리프 장치 인증서를 생성 하는 데 사용 하는 x.509 루트 또는 중간 인증서를 추가 합니다.
      ...
      ![연결 설정](media/overview-iot-central-get-connected-pnp/connection-settings.png)
    ...
    - 인증서 소유권을 확인 하면 인증서의 업 로더는 인증서의 개인 키를 갖습니다. 인증서를 확인 하려면:
        ...
        - 서명 된 확인 인증서를 업로드 하 고 **확인**을 선택 합니다.
          ...
          ![연결 설정](media/overview-iot-central-get-connected-pnp/verify-cert.png)
...
![연결 설정](media/overview-iot-central-get-connected-pnp/device-connection-flow1.png)
...
1. 연결 설정 구성:
    ...
    ![연결 설정 SAS](media/overview-iot-central-get-connected-pnp/connection-settings-sas.png)
...
장치 Sdk를 사용 하는 방법에 대 한 자세한 내용은 [Azure IoT Central 응용 프로그램에 DevDiv 키트 장치 연결](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 예제 코드를 참조 하세요.
...
- [DevKit 디바이스 준비 및 연결](howto-connect-devkit-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
