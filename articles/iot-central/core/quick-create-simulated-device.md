...
![디바이스 템플릿 페이지](./media/quick-create-simulated-device/device-definitions.png)
...
1. **저장** 을 선택하여 변경 내용을 저장합니다.
    ...
    ![클라우드 속성](media/quick-create-simulated-device/cloud-properties.png)
...
1. **고객 이름** 및 **마지막 서비스 날짜** 클라우드 속성과 **팬 속도** 속성을 선택합니다. 그런 다음, **섹션 추가** 를 선택합니다.
    ...
    ![새 양식 만들기](media/quick-create-simulated-device/new-form.png)
...
1. **게시** 를 선택합니다.
    ...
    ![게시된 모델](media/quick-create-simulated-device/published-model.png)
...
1. 시뮬레이션된 DevKit 디바이스를 추가하려면 **+** 기호를 선택합니다. 제안된 **디바이스 ID** 를 사용하거나 직접 입력합니다. 디바이스 ID는 문자, 숫자 및 `-` 문자를 포함할 수 있습니다. 새 디바이스의 이름을 입력할 수도 있습니다. **시뮬레이션됨** 토글을 **켜기** 로 전환한 다음, **만들기** 를 선택합니다.

    ![시뮬레이션된 디바이스](./media/quick-create-simulated-device/simulated-device.png)
...
1. 목록에서 시뮬레이션된 디바이스를 선택합니다. 그런 다음, **적용** 을 선택합니다. 이제 디바이스 템플릿 보기 빌드 환경에 동일한 시뮬레이션된 디바이스가 표시됩니다. 이 보기는 차트 및 기타 시각화에 유용합니다.
    ...
    ![미리 보기 디바이스 구성](./media/quick-create-simulated-device/configure-preview.png)
