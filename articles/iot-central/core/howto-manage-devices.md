...
1. 왼쪽 창에서 **Device Explorer** 을 선택 합니다. 여기서 [디바이스 템플릿](howto-set-up-template.md) 목록을 볼 수 있습니다.
...
1. 왼쪽 창에서 **Device Explorer** 을 선택 합니다.
...
1. **설정** 탭을 선택 합니다. 여기에는 장치에 있는 모든 설정 및 현재 값이 표시 됩니다. 각 설정에 대해 디바이스가 여전히 동기화 중인지 확인할 수 있습니다.
