...
Microsoft Azure IoT Central에서는 작업을 사용하여 연결된 디바이스를 대규모로 관리할 수 있습니다. 작업을 사용 하면 장치 속성 및 명령에 대 한 대량 업데이트를 수행할 수 있습니다. 이 문서에서는 응용 프로그램에서 작업을 사용 하 여 시작 하는 방법을 안내 합니다.
...
4. 작업을 적용 하려는 장치 그룹을 선택 합니다. 요약 섹션에서 작업 구성이 적용 되는 장치 수를 확인할 수 있습니다. 

5. 다음으로 정의할 작업 유형 (속성 또는 명령)을 선택 합니다. 속성을 선택 하 고 새 값을 설정 하 여 작업 구성을 설정 하거나 명령을 선택 합니다. 한 번에 여러 속성을 추가할 수 있습니다.
...
실행 중인 작업을 중지 하려면 해당 작업을 선택 하 고 **중지**를 선택 합니다. 작업이 중지 됨을 반영 하도록 작업 상태가 변경 됩니다.
...
만든 기존 작업을 복사 하려면 생성 된 작업을 열고 **복사**를 선택 합니다. 편집할 수 있도록 작업 구성의 새 복사본이 열립니다. 새 작업을 저장 하거나 실행할 수 있습니다. 
