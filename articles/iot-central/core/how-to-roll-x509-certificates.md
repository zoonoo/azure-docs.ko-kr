...
2. **등록 그룹**을 클릭하고 목록에서 그룹 이름을 클릭합니다.

    ![디바이스 연결](./media/how-to-roll-x509-certificates/device-connection.png)


3. 인증서 업데이트의 경우 **기본 관리** 또는 **보조 관리**를 클릭 합니다.

    ![인증서 관리](./media/how-to-roll-x509-certificates/certificates.png)
...
3. 인증서 업데이트의 경우 **기본 관리**를 클릭 합니다.

    ![디바이스 연결](./media/how-to-roll-x509-certificates/manage-certs.png)
...
1. **장치**를 클릭 하 고 장치를 선택 합니다. 

2. **연결**을 클릭 하 고 **개별 등록** 으로 방법 연결을 선택 합니다.

3. 메커니즘으로 **인증서 (x.509)** 를 선택 합니다.

    ![개별 등록 관리](./media/how-to-roll-x509-certificates/certificate-update.png)

4. 인증서 업데이트의 경우 폴더 아이콘을 클릭 하 여 등록 항목에 대해 업로드할 새 인증서를 선택 합니다. **Save**을 클릭합니다.
...
4. 보조 인증서 업데이트의 경우 폴더 아이콘을 클릭 하 여 등록 항목에 대해 업로드할 새 인증서를 선택 합니다. **Save**을 클릭합니다.
