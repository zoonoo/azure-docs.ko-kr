...
2. 구독을 선택합니다. 
    ...
    > [!Note] 
    > 이제 표준 IoT Central 응용 프로그램에 대 한 것과 다른 구독으로 데이터를 내보낼 수 있습니다. 이 경우 연결 문자열을 사용하여 연결합니다.
...
2. 왼쪽 창에서 **연속 데이터 내보내기**를 선택 합니다.

    > [!Note]
    > 왼쪽 창에 연속 데이터 내보내기가 표시 되지 않는 경우 앱의 관리자가 아닙니다. 관리자에게 데이터 내보내기를 설정하도록 요청합니다.
