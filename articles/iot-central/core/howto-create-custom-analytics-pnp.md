...
이 방법 가이드에서는 [기본 제공 분석 도구](./howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)를 사용 하 여 이미 수행할 수 있는 작업 이상의 IoT Central 확장 하는 방법을 보여 줍니다.
...
이제 사용자 지정 분석을 만드는 방법을 배웠으므로 제안 된 다음 단계는 [Power BI 대시보드에서 Azure IoT Central 데이터를 시각화 하 고 분석](./howto-connect-powerbi.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)하는 방법을 배우는 것입니다.
