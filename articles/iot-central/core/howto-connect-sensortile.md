...
* Android 장치에 설치 된 ST의 센서 앱은 [여기에서 다운로드할](https://play.google.com/store/apps/details?id=com.st.bluems)수 있습니다. 자세한 내용은 다음을 참조 하세요. [센서 센서](https://www.st.com/stblesensor)
...
Azure IoT Central 응용 프로그램에서 **SensorTile** 장치 템플릿의 실제 장치를 추가 하 고 장치 연결 정보: **범위 ID**, **장치 ID**및 **기본 키**를 적어둡니다.
...
1. 왼쪽 창을 사용 하 여 **클라우드 로깅** 단추를 선택 합니다.
...
| gyroscopeX     | 않으면   | -3276   | 3276    | 1              |
| gyroscopeY     | 않으면   | -3276   | 3276    | 1              |
| gyroscopeZ     | 않으면   | -3276   | 3276    | 1              |
| FFT_X     |    |    |     |               |
| FFT_Y     |    |    |     |               |
| FFT_Z     |    |    |     |               |
