...
시작 하기 전에 [Azure IoT Central 응용 프로그램 만들기](./quick-deploy-iot-central-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 를 완료 하 고 시뮬레이션 된 [장치를 IoT Central 응용 프로그램 빠른 시작에 추가](./quick-create-pnp-device-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) 하 여 작업할 **환경 센서** 장치 템플릿을 만들어야 합니다.

## <a name="create-simulated-devices"></a>시뮬레이션 된 장치 만들기

장치 그룹을 만들기 전에이 자습서에서 사용할 수 있도록 **환경 센서** 장치 템플릿에서 시뮬레이션 된 장치를 5 개 이상 추가 합니다.

![시뮬레이션 된 5 개의 환경 센서 장치](./media/tutorial-use-device-groups-pnp/simulated-devices.png)

네 가지 환경 센서 장치에 대해 **환경 센서 속성** 보기를 사용 하 여 고객 이름을 **Contoso**로 설정 합니다.

![고객 이름을 Contoso로 설정](./media/tutorial-use-device-groups-pnp/customer-name.png)
...
1. **+ 새로 만들기**를 선택 합니다.
    ...
    ![새 장치 그룹](media/tutorial-use-device-groups-pnp/image1.png)
...
1. **Customer Name** 속성, **Equals** 비교 연산자 및 **contoso** 를 값으로 선택 하 여 장치 그룹에 대 한 **contoso** 에 속한 장치를 식별 하는 쿼리를 만듭니다. **모든** 조건을 충족 하는 여러 쿼리 및 장치를 장치 그룹에 추가할 수 있습니다. 만든 장치 그룹은 응용 프로그램에 액세스할 수 있는 모든 사용자가 액세스할 수 있으므로 누구나 장치 그룹을 보거나 수정 하거나 삭제할 수 있습니다.
    ...
    ![장치 그룹 쿼리](media/tutorial-use-device-groups-pnp/image2.png)
...
1. 만든 **Contoso 장치** 장치 그룹을 선택 합니다. 그런 다음 **온도** 및 **습도** 원격 분석 유형을 추가 합니다.
    ...
    ![분석 만들기](./media/tutorial-use-device-groups-pnp/create-analysis.png)
...
1. **분석** 을 선택 하 여 평균 원격 분석 값을 확인 합니다.
    ...
    ![분석 보기](./media/tutorial-use-device-groups-pnp/view-analysis.png)
...
> [원격 분석 규칙을 만드는 방법](tutorial-create-telemetry-rules-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)
