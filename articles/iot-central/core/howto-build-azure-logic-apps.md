...
언제든지 Azure Portal의 Logic Apps에서 IoT Central 커넥터를 사용하여 워크플로 작성을 시작할 수 있습니다. 그런 다음 앱과 연결할 규칙을 IoT Central 선택할 수 있으며 동일한 방식으로 작동 합니다. 매번 IoT Central 규칙 페이지에서 시작할 필요가 없습니다.
