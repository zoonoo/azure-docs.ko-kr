...
description: 이 문서에서는 Azure PowerShell에서 IoT Central 응용 프로그램을 만들고 관리하는 방법을 설명합니다.
...
ms.locfileid: "80365536"
---
# <a name="manage-iot-central-from-azure-powershell"></a>Azure PowerShell에서 IoT Central 관리

[!INCLUDE [iot-central-selector-manage](../../../includes/iot-central-selector-manage.md)]

Azure IoT Central 응용 프로그램 [관리자](https://aka.ms/iotcentral) 웹 사이트에서 IoT Central 응용 프로그램을 만들고 관리하는 대신 [Azure PowerShell을](https://docs.microsoft.com/powershell/azure/overview) 사용하여 응용 프로그램을 관리할 수 있습니다.
...
> [!TIP]
> 다른 Azure 구독에서 PowerShell 명령을 실행해야 하는 경우 [활성 구독 변경을](/powershell/azure/manage-subscriptions-azureps?view=azps-3.4.0#change-the-active-subscription)참조하십시오.
