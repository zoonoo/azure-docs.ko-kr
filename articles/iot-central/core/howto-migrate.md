...
> [!Note]
> 응용 프로그램을 삭제 하려면 응용 프로그램을 만들 때 선택한 Azure 구독에서 리소스를 삭제할 수 있는 권한이 있어야 합니다. 자세한 내용은 [역할 기반 액세스 제어를 사용하여 Azure 구독 리소스에 대한 액세스 관리](../../active-directory/role-based-access-control-configure.md)를 참조하세요.
