...
| Create | 보기 <br/> 기타 종속성: 장치 템플릿 및 장치 그룹 보기  |
...
| Create | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿 및 장치 인스턴스 보기   |
...
| Create | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 |
...
| Create | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿 보기 |
