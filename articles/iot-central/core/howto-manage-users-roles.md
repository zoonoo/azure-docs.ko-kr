...
| Name | 종속성 |
| ---- | -------- |
| View | None <br/> 기타 종속성: 장치 템플릿 및 장치 그룹 보기 |
| 업데이트 | View <br/> 기타 종속성: 장치 템플릿 및 장치 그룹 보기  |
| 생성 | 보기 <br/> 기타 종속성: 장치 템플릿 및 장치 그룹 보기  |
| 삭제 | View <br/> 기타 종속성: 장치 템플릿 및 장치 그룹 보기  |
...
| Name | 종속성 |
| ---- | -------- |
| View | None <br/> 기타 종속성: 장치 템플릿 및 장치 인스턴스 보기 |
| 업데이트 | View <br/> 기타 종속성: 장치 템플릿 및 장치 인스턴스 보기   |
| 만들기 | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿 및 장치 인스턴스 보기   |
| 삭제 | View <br/> 기타 종속성: 장치 템플릿 및 장치 인스턴스 보기   |
...
| Name | 종속성 |
| ---- | -------- |
| View | None <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 |
| 업데이트 | View <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 |
| 만들기 | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 |
| 삭제 | View <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 |
| Execute | View <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스 및 장치 그룹 보기 장치 인스턴스 업데이트 장치 인스턴스에서 명령 실행 |
...
| Name | 종속성 |
| ---- | -------- |
| View | None <br/> 기타 종속성: 장치 템플릿 보기 |
| 업데이트 | View <br/> 기타 종속성: 장치 템플릿 보기 |
| 만들기 | 보기, 업데이트 <br/> 기타 종속성: 장치 템플릿 보기 |
| 삭제 | View <br/> 기타 종속성: 장치 템플릿 보기 |
...
| View | None     |
| 업데이트 | View   |
| 복사 | View <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스, 장치 그룹, 대시보드, 데이터 내보내기, 브랜딩, 도움말 링크, 사용자 지정 역할, 규칙 보기 |
| 삭제 | View   |
...
| ---- | -------- |
| View | None     |
| 내보내기 | View <br/> 기타 종속성: 장치 템플릿, 장치 인스턴스, 장치 그룹, 대시보드, 데이터 내보내기, 브랜딩, 도움말 링크, 사용자 지정 역할, 규칙 보기 |
...
| Name | 종속성 |
| ---- | -------- |
| View | None <br/> 기타 종속성: 사용자 지정 역할 보기 |
| 추가 | View <br/> 기타 종속성: 사용자 지정 역할 보기 |
| 삭제 | View <br/> 기타 종속성: 사용자 지정 역할 보기 |
