...
예를 들어 **설정 및 속성** 타일을 추가하여 현재 설정 및 속성 값의 선택 항목을 표시할 수 있습니다. 이렇게 하려면 먼저 **장치 템플릿**을 선택한 다음, **장치 인스턴스**를 선택합니다. 타일에 제목을 지정한 후, 표시할 **설정** 또는 **속성**을 선택합니다. 이 경우에는 **온도 설정**을 선택했습니다. **완료**를 클릭하면 이 타일이 홈페이지에 표시됩니다.
