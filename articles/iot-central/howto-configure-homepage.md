...
예를 들어 다음은 “샘플 Contoso” 템플릿을 기반으로 하는 애플리케이션에 대한 홈 페이지입니다. 응용 프로그램에 대한 홈페이지를 사용자 지정하려면 먼저 오른쪽 위에 있는 **편집**을 선택합니다. 

![“샘플 Contoso” 템플릿을 기반으로 하는 애플리케이션에 대한 홈 페이지](media/howto-configure-homepage/image1.png)
