...
1. Azure IoT Central 애플리케이션. 자세한 내용은 참조는 [애플리케이션 빠른 시작 만들기](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)를 참조하세요.
...
* **애플리케이션 관리자** 페이지
    ...
    ![애플리케이션 관리자 페이지의 이미지](media/howto-prepare-images-experimental/applicationmanager.png)

* 홈페이지

    ![홈페이지의 이미지](media/howto-prepare-images-experimental/homepage.png)

* 디바이스 템플릿

    ![디바이스 템플릿의 이미지](media/howto-prepare-images-experimental/devicetemplate.png)

* 디바이스 대시보드의 타일

    ![디바이스 타일의 이미지](media/howto-prepare-images-experimental/devicetile.png)

* 디바이스 집합 대시보드의 타일

    ![디바이스 집합 타일의 이미지](media/howto-prepare-images-experimental/devicesettile.png)
...
![애플리케이션 이미지 업로드](media/howto-prepare-images-experimental/uploadapplicationmanager.png)
...
![홈페이지 이미지 업로드](media/howto-prepare-images-experimental/uploadhomepage.png)
...
![디바이스 템플릿 이미지 업로드](media/howto-prepare-images-experimental/uploaddevicetemplate.png)
...
![디바이스 대시보드 이미지 업로드](media/howto-prepare-images-experimental/uploaddevicedashboard.png)
...
![디바이스 집합 대시보드 이미지 업로드](media/howto-prepare-images-experimental/uploaddevicesetdashboard.png)
...
> [Azure IoT Central 애플리케이션에서 장치 관리](howto-manage-devices-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)