...
**완료**를 선택하면 측정값 목록에 **온도** 측정값이 나타납니다. 작업자는 장치가 수집하는 온도 데이터의 시각화를 볼 수 있습니다.
...
예를 들어 **템플릿 편집**을 선택하고 새 설정을 입력하면 새 팬 속도 설정을 추가할 수 있습니다.
...
타일을 만든 후에는 새 설정을 사용해 볼 수 있습니다. 먼저 화면의 오른쪽 윗부분에서 **완료**를 선택합니다.
...
예를 들어 **템플릿 편집**을 선택하고 새 속성을 입력하면 장치 위치를 새 속성으로 추가할 수 있습니다.
...
타일을 만든 후에는 속성 값을 변경할 수 있습니다. 먼저 화면의 오른쪽 윗부분에서 **완료**를 선택합니다.
...
**저장**, **완료**를 차례로 선택하면 **에코** 명령이 타일로 표시되며 장치를 에코하는 데 사용하도록 준비됩니다.
...
3. 제목을 지정하고 이전에 장치 속성의 일부로 구성한 위치 속성을 선택합니다.
