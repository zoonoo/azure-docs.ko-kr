...
운영자는 이 디바이스 템플릿에서 **fan-1**, **fan-2** 등의 이름을 가진 실제 팬 디바이스를 만들고 연결할 수 있습니다. 이 모든 팬에는 측정값, 설정, 속성 및 규칙과, 응용 프로그램 사용자가 모니터링하고 관리할 수 있는 대시보드가 있습니다.
...
IoT Central 응용 프로그램에서 Azure Maps를 사용하여 응용 프로그램 속성으로 위치 속성을 만들 수 있습니다. 예를 들어 디바이스 설치 주소를 추가할 수 있습니다. 
