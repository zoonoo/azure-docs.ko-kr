...
[Azure 포털](https://portal.azure.com)에서 다른 구성 요소의 컨테이너인 일련의  *blades*를 통해 웹 앱을 관리합니다. (Azure 포털의 개요는 [포털](http://go.microsoft.com/fwlink/?LinkId=529715) 변경 내용 가이드를 참조하세요.) 

웹 앱에 대한 블레이드를 보려면 **홈** 다음에 앱 이름을 클릭하거나 **찾아보기**를 클릭하여 모든 Azure 리소스를 봅니다.
...
- **크기 조정**에서는 인스턴스 수의 크기를 조정하고 자동 크기 조정을 설정할 수 있습니다. [Azure 앱 서비스에서 웹 앱 크기 조정](how-to-scale-websites.md)을 참조하세요.  
...
- **콘솔**. 포털 내에서 실행되는 명령줄을 열려면 클릭합니다.  `mkdir` 및  `dir` 같은 명령을 실행하는 데 사용할 수 있습니다.  
