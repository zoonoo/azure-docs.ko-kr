...
**Linux** VM에서 로그 파일을 찾는 방법에 대 한 지침은 다음 문서를 참조 하세요. [Linux virtual machines에서 Azure 사용자 지정 스크립트 확장 버전 2 사용](../virtual-machines/extensions/custom-script-linux.md#troubleshooting)
