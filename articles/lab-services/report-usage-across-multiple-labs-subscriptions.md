...
* PowerShell Az. Resource 모듈은 [Invoke-AzResourceAction](https://docs.microsoft.com/powershell/module/az.resources/invoke-azresourceaction?view=azps-2.5.0&viewFallbackFrom=azps-2.3.2) 의 `exportResourceUsage`작업, 랩 리소스 ID 및 필요한 매개 변수를 사용 하 여 AzResourceAction를 호출 합니다. 
