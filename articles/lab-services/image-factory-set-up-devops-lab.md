...
시작 하려면 Azure DevOps에서 무료 계정을 만듭니다. 을 https://www.visualstudio.com/ 방문 하 여 **Azure devops** (이전의 VSTS)에서 **무료로 시작** 을 선택 합니다. 고유한 계정 이름을 선택 하 고 Git를 사용 하 여 코드를 관리 하도록 선택 해야 합니다. 이를 만든 후에는 팀 프로젝트에 URL을 저장 합니다. 샘플 URL은 다음과 같습니다 `https://<accountname>.visualstudio.com/MyFirstProject`.
...
1. 이전 단계에서 만든 Azure devops 프로젝트를 방문 합니다 (URL은 **https:\//\<accountname> visualstudio.com/MyFirstProject**).
