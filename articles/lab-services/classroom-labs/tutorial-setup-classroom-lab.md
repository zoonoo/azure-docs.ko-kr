...
4. **가상 머신 사양 선택** 페이지에서 다음 단계를 수행합니다.
    1. 랩에서 만드는 VM(가상 머신)의 **크기**를 선택합니다. 현재, **소형**, **중형**, **중형(가상화)** , **대형** 및 **GPU** 크기를 사용할 수 있습니다.
...
할당량 설정을 **0시간(일정에만 해당)** 으로 구성한 경우 랩에 대한 일정을 설정해야 합니다. 이 자습서에서는 일정을 되풀이 주별 일정으로 설정합니다.
