...
동일한 속성을 사용할 수 있습니다는 **Labs 구성** 탭의 **랩 계정을** 랩 계정 생성 시 피어 네트워크를 설정 하지 않은 경우 페이지입니다. 이 설정에 변경 내용을 변경 된 후 만들어진 랩에만 적용 됩니다. 이미지에 보이는 것 처럼이 활성화 하거나 비활성화할 수 있습니다 **피어 가상 네트워크** 실습 랩 계정에 대 한 합니다. 
