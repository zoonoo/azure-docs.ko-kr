...
> [!IMPORTANT] 
> **원격 데스크톱 연결** 을 사용 하도록 설정 하면 Linux 컴퓨터 에서만 **RDP** 포트가 열립니다. 선생님은 처음으로 SSH를 사용 하 여 Linux 컴퓨터에 연결 하 고 rdp 및 GUI 패키지를 설치 하 여 나중에 RDP를 사용 하 여 Linux 컴퓨터에 연결할 수 있습니다. 그런 다음 학생이 학생 Linux Vm에 RDP 할 수 있도록 이미지를 **게시** 합니다. 
