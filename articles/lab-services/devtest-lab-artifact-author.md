...
비밀을 보안 문자열로 선언 합니다. 다음은 `parameters` **artifactfile. json** 파일의 섹션 내에서 보안 문자열 매개 변수를 선언 하는 구문입니다.
...
전체 예제 artifactfile. json 및 아티팩트와 (PowerShell 스크립트) [GitHub에서이 샘플](https://github.com/Azure/azure-devtestlab/tree/master/Artifacts/windows-test-paramtypes)을 참조 하세요.
