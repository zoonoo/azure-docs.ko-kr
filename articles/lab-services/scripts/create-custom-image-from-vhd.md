---
title: PowerShell - Azure Lab 서비스에서 VHD 파일에서 사용자 지정 이미지 만들기
...
| [새 아즈리소스 그룹 배포](/powershell/module/az.resources/new-azresourcegroupdeployment) | 리소스 그룹에 Azure 배포를 추가합니다. |
