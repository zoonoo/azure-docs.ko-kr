...
중앙 IT 부서는 필요한 사항만 소유하고 프로젝트 및 응용 프로그램 팀이 필요한 수준의 제어 권한을 갖도록 하는 것이 좋습니다. 이에 따라 일반적으로 중앙 IT 부서는 구독을 소유하고 네트워킹 구성과 같은 핵심 IT 기능을 처리합니다. 구독의 **소유자** 집합은 소규모인 것이 좋습니다. 이러한 소유자는 필요할 때 추가 소유자를 지정하거나, 구독자 수준 정책(예: “공용 IP 없음”)을 적용할 수 있습니다.
...
자세한 내용은 [Azure 엔터프라이즈 스캐폴드: 규범적 구독 거버넌스](/architecture/cloud-adoption/appendix/azure-scaffold) 설명서를 참조하세요.
