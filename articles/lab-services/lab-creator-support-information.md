...
description: 이 문서에서는 랩 작성자가 도움을 얻기 위해 사용할 수 있는 지원 정보를 보는 방법을 설명 합니다.
ms.date: 06/26/2020
ms.topic: how-to
...
이 문서에서는 랩 작성자로 서 다음 지원 정보를 확인할 수 있는 방법에 대해 설명 합니다.
...
이 정보를 사용 하 여 랩 계정에서 랩을 만들 때 기술 문제가 발생할 때 도움을 받을 수 있습니다.
