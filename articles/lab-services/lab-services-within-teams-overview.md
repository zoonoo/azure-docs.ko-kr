---
title: Microsoft 팀 내 Azure Lab Services
...
Azure Lab Services Microsoft 팀과 통합 하 여 교육자는 교실 환경을 설정 하 고 팀 (클래스) 내에서 가상 랩 환경을 제공할 수 있습니다. 

* 교육자는 팀을 종료 하 고 [Azure Lab Services 웹 사이트로](https://labs.azure.com)이동 하지 않고도 학생 들이 팀 내에서 vm에 액세스할 수 있도록 랩을 설정할 수 있습니다.
* 팀에서 Azure Lab Services에 대 한 SSO (Single Sign-on)
* 팀 및 랩 소유자는 서로 다른 두 시스템의 클래스 rosters를 유지 관리할 필요가 없습니다. 랩 사용자 목록은 팀 멤버 자격에서 채워집니다 되며 24 시간 마다 동기화가 자동으로 수행 됩니다. 
* 템플릿 VM의 초기 게시 후 랩 용량 (즉, 랩의 Vm 수)은 팀 멤버 자격의 사용자 추가/삭제에 따라 자동으로 조정 됩니다. 
* 팀 및 랩 소유자는 팀과 관련 된 랩을 볼 수 있으며, 학생은 특정 팀에 대해 프로 비전 된 Vm만 볼 수 있습니다. 
* 사용자가 랩에 자동으로 등록 되 고 랩이 게시 된 후 첫 번째 로그인 시 Vm이 자동으로 할당 됩니다. 교육자는 초대를 보낼 필요가 없으며 학생 들이 개별적으로 랩을 등록할 필요가 없습니다.  
