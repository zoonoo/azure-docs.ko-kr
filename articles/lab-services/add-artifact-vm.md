...
다음 스크립트를 지정된 된 VM에 지정 된 아티팩트를 적용합니다. 합니다 [Invoke-azurermresourceaction](/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-6.13.0) 명령 작업을 수행 하는 것입니다.  
