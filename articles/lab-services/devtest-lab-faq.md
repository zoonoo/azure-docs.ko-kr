...
DevTest Labs 리소스는 프로젝트/응용 프로그램 팀에 가까운 소유자가 소유하는 것이 좋습니다. 컴퓨터 및 필수 소프트웨어에 대 한 요구 사항을 이해 하 고 있기 때문입니다. 대부분의 조직에서 이 DevTest Labs 리소스의 소유자는 일반적으로 프로젝트/개발 책임자입니다. 이 소유자는 랩 환경 내에서 사용자 및 정책을 관리하고 DevTest Labs 환경에서 모든 VM을 관리할 수 있습니다.
