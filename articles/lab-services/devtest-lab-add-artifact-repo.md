...
* Git 리포지토리가 있는 Azure DevOps 서비스 프로젝트를 만드는 방법에 대해 알아보려면 [Azure DevOps 서비스에 연결 을](https://www.visualstudio.com/get-started/setup/connect-to-visual-studio-online)참조하십시오.
