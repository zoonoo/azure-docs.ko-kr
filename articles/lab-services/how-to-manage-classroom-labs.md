...
---
# <a name="manage-classroom-labs-in-azure-lab-services-formerly-azure-devtest-labs"></a>Azure Lab Services(이전 Azure DevTest Labs)에서 클래스룸 랩 관리
...
1. 랩의 **홈페이지**가 표시됩니다. 
    ...
    ![클래스룸 랩 홈페이지](./media/how-to-manage-classroom-labs/classroom-lab-home-page.png)
...
랩의 템플릿은 모든 사용자의 가상 머신이 만들어지는 곳입니다. 랩 사용자에게 제공하려는 구성과 정확히 일치하도록 템플릿 가상 머신을 설정합니다. 랩 사용자에게 표시될 템플릿의 이름과 설명을 입력하고 템플릿 VM 인스턴스를 랩 사용자가 사용할 수 있도록 표시 유형을 “공용”으로 설정합니다.  
...
템플릿의 표시 유형을 **공용**으로 설정하면 Azure Lab Services에서 템플릿을 사용하여 랩에 VM이 만들어집니다. 이 과정에서 만들어지는 VM 수는 랩에 허용되는 최대 사용자 수와 같으며, 이 값은 랩의 사용 정책에서 설정할 수 있습니다. 모든 가상 머신은 템플릿과 구성이 동일합니다.  
...
3. **저장**을 선택합니다.
    ...
    ![가용성](./media/how-to-manage-classroom-labs/public-access.png)
...
2. **사용자 등록** 대화 상자에서 **복사** 단추를 선택합니다. 링크가 클립보드에 복사됩니다. 이메일 편집기에 붙여넣고 학생에게 이메일을 보냅니다. 
    ...
    ![학생 등록 ​링크](./media/how-to-manage-classroom-labs/registration-link.png)
