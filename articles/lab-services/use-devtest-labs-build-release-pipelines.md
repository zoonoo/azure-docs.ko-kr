...
- 빌드 파이프라인에 대 한 [구성 리포지토리에](devtest-lab-create-environment-from-arm.md) 대 한 연결을 사용 하 여 랩을 설정 해야 합니다. DevTest Labs가 템플릿을 인식 하 고 배포할 수 있도록 하려면를 사용 하 여 구성 리포지토리를 azuredeploy로 체크 인 해야 합니다. 리소스 관리자
