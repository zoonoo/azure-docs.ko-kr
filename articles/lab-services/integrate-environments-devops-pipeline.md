...
3. 이 예에서는 기존 Azure 빠른 시작 템플릿을 [https://azure.microsoft.com/resources/templates/201-web-app-redis-cache-sql-database/](https://azure.microsoft.com/resources/templates/201-web-app-redis-cache-sql-database/)사용 합니다.
