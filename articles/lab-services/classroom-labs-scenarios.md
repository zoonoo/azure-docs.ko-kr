---
title: 학습에 대 한 labs 사용 Azure Lab Services
...
---
# <a name="use-labs-for-trainings"></a>학습에 대 한 labs 사용
...
랩은 가상 환경에서 학습을 수행 하는 데 필요한 다음과 같은 요구 사항을 충족 합니다. 
...
랩 계정에서 랩 작성자 역할의 멤버인 교육자는 랩 계정에서 랩을 하나 이상 만들 수 있습니다. 과정에서 연습을 수행하는 데 필요한 모든 소프트웨어를 사용하여 템플릿 VM을 만들고 구성합니다. 클래스룸 랩을 만들기 위해 사용 가능한 이미지에서 미리 만든 이미지를 선택한 다음, 랩에 필요한 소프트웨어를 설치하여 사용자 지정합니다. 자세한 내용은 [랩 만들기 및 관리](how-to-manage-classroom-labs.md)를 참조 하세요.
...
일정을 사용하면 랩의 VM이 지정된 시간에 자동으로 시작 및 종료되도록 Classroom(강의실) 랩을 구성할 수 있습니다. 일회성 일정이나 되풀이 일정을 정의할 수 있습니다. 자세한 내용은 [랩에 대 한 일정 만들기 및 관리](how-to-create-schedules.md)를 참조 하세요.
