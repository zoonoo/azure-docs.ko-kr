...
| 문제 | 해결 방법 |
| :----------------------------------| :---------------------------------------------- |
| Msg 40847: 서버가 허용되는 데이터베이스 트랜잭션 단위 할당량인 45000을 초과하므로 작업을 수행할 수 없습니다. | 만들려는 데이터베이스의 [DWU][]를 줄이거나 또는 [할당량 증가를 요청][]합니다.|
...
[sqlcmd]: https://azure.microsoft.com/ko-KR/documentation/articles/sql-data-warehouse-get-started-connect-sqlcmd/
