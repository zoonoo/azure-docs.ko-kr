<properties
   pageTitle="Azure SQL 데이터 웨어하우스에서 데이터베이스 복원(REST API) | Microsoft Azure"
...
# Azure SQL 데이터 웨어하우스에서 데이터베이스 복원(REST API)
...
Azure SQL 데이터 웨어하우스의 라이브 데이터베이스, 삭제된 데이터베이스, 액세스할 수 없는 데이터베이스를 복원하기 위한 REST API 작업입니다.
