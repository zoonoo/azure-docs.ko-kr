...
ms.locfileid: "56246335"
---
# <a name="upgrade-your-data-warehouse-to-gen2"></a>데이터 웨어하우스를 Gen2로 업그레이드
Microsoft는 Azure SQL Data Warehouse에 하위 컴퓨팅 계층을 추가함으로써 까다로운 쿼리를 처리 가능한 데이터 웨어하우스를 실행하는 데 드는 초기 비용을 줄여줍니다. [Gen2에 대한 하위 컴퓨팅 계층 지원](https://azure.microsoft.com/blog/azure-sql-data-warehouse-gen2-now-supports-lower-compute-tiers/)에 대한 전체 공지를 읽어보세요. 새 제품은 아래 표에 나와 있는 지역에서 이미 사용할 수 있습니다. 지원되는 지역의 경우 다음을 통해 기존 Gen1 데이터 웨어하우스를 Gen2로 업그레이드할 수 있습니다.
- **자동 업그레이드 프로세스:** 지역에서 서비스를 사용할 수 있게 되는 즉시, 자동 업그레이드가 시작되는 것은 아닙니다.  특정 지역에서 자동 업그레이드가 시작되면 선택한 유지 관리 일정 동안 개별 DW 업그레이드가 수행됩니다. 
- **Gen2로 자체 업그레이드:** 업그레이드 일정을 제어하려는 경우 Gen2로의 자동 업그레이드를 수행할 수 있습니다. 해당 지역이 아직 지원되지 않는 경우, DW를 지원되는 지역으로 마이그레이션한 후 Gen 2로의 자동 업그레이드를 수행할 수 있습니다.
...
|:--- |:--- |:--- |
| 오스트레일리아 중부 1 |2019년 3월 1일 |2019년 6월 15일 |
| 오스트레일리아 중부 2 |2019년 3월 1일 |2019년 6월 15일 |
| 오스트레일리아 동부 |사용 가능 |2019년 5월 1일 |
| 오스트레일리아 남동부 |2019년 3월 1일 |2019년 6월 15일 |
| 브라질 남부 |\* |\* |
| 캐나다 중부 |사용 가능 |2019년 5월 1일 |
| 캐나다 동부 |\* |\* |
| 미국 중부 |사용 가능 |2019년 5월 1일 |
| 중국 동부 |\* |\* |
| 중국 북부 1 |\* |\* |
| 동아시아 |사용 가능 |2019년 5월 1일 |
| 미국 동부 1 |사용 가능 |2019년 3월 16일 |
| 미국 동부 2 |사용 가능 |2019년 3월 16일 |
| 프랑스 중부 |2019년 3월 1일 |2019년 5월 1일 |
| 독일 중부 |\* |\* |
| 인도 중부 |사용 가능 |2019년 5월 1일 |
| 인도 남부 1 |2019년 3월 1일 |2019년 6월 15일 |
| 일본 동부 |사용 가능 |2019년 5월 1일 |
| 일본 서부 |사용 가능 |2019년 6월 15일 |
| 한국 중부 |2019년 3월 1일 |2019년 5월 1일 |
| 한국 남부 1 |2019년 3월 1일 |2019년 6월 15일 |
| 미국 중북부 |2019년 3월 1일 |2019년 6월 15일 |
| 북유럽 |사용 가능 |2019년 3월 16일 |
| 미국 중남부 |사용 가능 |2019년 5월 1일 |
| 동남아시아 |사용 가능 |2019년 3월 16일 |
| 영국 남부 |2019년 3월 1일 |2019년 5월 1일 |
| 영국 서부 1 |2019년 3월 1일 |2019년 6월 15일 |
| 미국 중서부 |\* |\* |
| 서유럽 |사용 가능 |2019년 3월 16일 |
| 미국 서부 1 |2019년 3월 1일 |2019년 6월 15일 |
| 미국 서부 2 |사용 가능 |2019년 3월 16일 |

## <a name="automatic-upgrade-process"></a>자동 업그레이드 프로세스

2019년 3월 16일부터 Gen1 인스턴스의 자동 업그레이드 예약을 시작합니다. 데이터 웨어하우스의 가용성이 예기치 않게 중단되는 것을 방지하기 위해 자동 업그레이드가 유지 관리 일정 중에 예약됩니다. 일정에 대한 자세한 내용은 [유지 관리 일정 보기](viewing-maintenance-schedule.md)를 참조하세요.

데이터 웨어하우스를 다시 시작하면 업그레이드 프로세스 때 연결이 잠시 끊어집니다(약 5분).  데이터 웨어하우스를 다시 시작한 후에는 완전하게 사용할 수 있게 되지만, 백그라운드에서 데이터 파일이 업그레이드되는 동안에는 성능이 저하될 수 있습니다. 총 성능 저하 시간은 데이터 파일의 크기에 따라 달라집니다.
...
만약 지금 업그레이드하려면 기존 Gen1 데이터 웨어하우스에 다음 단계를 수행하여 자체 업그레이드를 진행하도록 선택할 수 있습니다. 이 옵션을 선택하면 해당 지역에서 자동 업그레이드 프로세스를 시작하기 전에 자체 업그레이드를 완료해야 합니다. 이렇게 해야 자동 업그레이드로 인해 충돌이 발생하는 위험을 방지할 수 있습니다.

자체 업그레이드를 수행할 때는 두 가지 옵션을 사용할 수 있습니다.  현재 위치에서 데이터 웨어하우스를 업그레이드하거나 Gen1 데이터 웨어하우스를 Gen2 인스턴스로 복원할 수 있습니다.

- [현재 위치 업그레이드](upgrade-to-latest-generation.md) - 이 옵션은 기존 Gen1 데이터 웨어하우스를 Gen2로 업그레이드합니다. 데이터 웨어하우스를 다시 시작하면 업그레이드 프로세스 때 연결이 잠시 끊어집니다(약 5분).  데이터 웨어하우스를 다시 시작하면 완전히 사용할 수 있게 됩니다. 어떤 이유로든 Gen2 인스턴스에서 Gen1으로 다시 복원해야 할 경우 [지원 요청](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-get-started-create-support-ticket)을 엽니다.
