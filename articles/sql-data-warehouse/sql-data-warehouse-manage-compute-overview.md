...
계산 성능을 탄력적으로 증가 또는 감소하려면 데이터베이스의 [DWU(데이터 웨어하우스 단위)][]를 변경하기만 하면 됩니다. 더 많은 DWU를 추가하면 성능이 연속해서 증가합니다. 높은 DWU 수준에서 성능이 크게 향상되었음을 감지하려면 DWU를 100개 이상 추가해야 합니다. 의미 있는 DWU 증가분을 선택할 때에는 최고의 결과를 제공하는 DWU 수준을 참조할 수 있습니다.
