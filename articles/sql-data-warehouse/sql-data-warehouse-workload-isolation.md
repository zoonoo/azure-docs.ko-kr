...
> [!NOTE] 
> Min_percentage_resource에 대 한 특정 서비스 수준 실행 가능한 최소 값이 있습니다.  자세한 내용은 [유효한 값](https://review.docs.microsoft.com/sql/t-sql/statements/create-workload-group-transact-sql?view=azure-sqldw-latest#effective-values) 을 참조 하세요.
