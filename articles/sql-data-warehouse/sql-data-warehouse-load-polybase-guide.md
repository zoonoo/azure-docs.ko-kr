<properties
   pageTitle="SQL 데이터 웨어하우스의 PolyBase 사용을 위한 가이드 | Microsoft Azure"
...
시작하려면 [PolyBase를 사용하여 데이터 로드][] 자습서를 참조하세요.
...
## 다음 단계
SQL 데이터 웨어하우스에 데이터를 이동하는 방법에 대한 자세한 내용은 [데이터 마이그레이션 개요][]를 참조하세요.
