...
- [dbo.server\_quotas(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn308512.aspx)
...
| sys.dm\_pdw\_nodes\_tran\_commit\_table | Transact-SQL 문서는 사용할 수 없습니다. |
...
다음은 SQL Server PDW에서 사용할 수 있는 SQL Server 정보 스키마 보기에 연결하는 링크입니다. SQL Server에서 볼 수 있는 모든 INFORMATION\_SCHEMA 보기는 SQL Server PDW에서 사용할 수 있습니다.
