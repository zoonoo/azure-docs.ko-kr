...
유지 관리 일정 기능은 Service Health 계획 된 유지 관리 알림, Resource Health 확인 모니터 및 Azure SQL Data Warehouse 유지 관리 예약 서비스를 통합 합니다.
...
예를 들어 토요일 22:00의 주 창을 일요일 01:00로 예약한 다음 수요일 19:00의 보조 창을 22:00로 예약할 수 있습니다. SQL Data Warehouse가 기본 유지 관리 기간 중에 유지 관리를 수행할 수 없는 경우 보조 유지 관리 기간 중에 유지 관리를 다시 시도합니다. 서비스 유지 관리는 기본 및 보조 창에서 발생 하는 경우에 발생할 수 있습니다. 모든 유지 관리 작업을 신속 하 게 완료 하기 위해 지정 된 유지 관리 기간을 벗어나 DW400c 및 낮은 데이터 웨어하우스 계층의 유지 관리를 완료할 수 있습니다.
