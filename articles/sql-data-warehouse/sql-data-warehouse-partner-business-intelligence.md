...
| ![Microstrategy][14] |**MicroStrategy**<br>MicroStrategy 플랫폼을 조직에서 비즈니스 데이터에서 가치를 창출할 수 있도록 하는 비즈니스 인텔리전스 및 분석 기능의 전체 집합을 제공 합니다. 모든 팀 및 비즈니스 함수에서 분석에 대 한 액세스를 확장 하는 데 필요한 모든 했는지 MicroStrategy의 강력한 분석 엔진, 포괄적인 도구 집합, 데이터 커넥터와 확장 가능 하 고 열기 아키텍처의 다양 한 확인 |[제품 페이지][microstrategy_website]<br> [Azure Marketplace][microstrategy_marketplace]<br> |
...
| ![Targit][11] |**Targit (Decision Suite)**<br>Targit Decision Suite는 실시간 대시보드, 셀프 서비스 분석, 사용자에게 친숙한 보고, 멋진 모바일 기능 및 단일 통합 솔루션으로 제공하는 간단한 데이터 검색 기술을 제공하는 BI 및 분석 플랫폼을 제공합니다. Targit는 회사들이 행동을 취하도록 용기를 줍니다. |[제품 페이지][targit_website]<br> [Azure Marketplace][targit_marketplace]<br> |
| ![Yellowfin][12] |**Yellowfin**<br>Yellowfin은 BARC에서 임시 보고 및 대시보드용 클라우드 BI 공급 업체를 평가 하는 top BI 설문 조사 합니다. Azure SQL Data Warehouse에 연결한 다음 만들고 수상한 공동 작업 BI 및 위치 인텔리전스 기능을 포함한 아름다운 보고서와 대시보드를 만들고 공유합니다. |[제품 페이지][yellowfin_website]<br> [Azure Marketplace][yellowfin_marketplace] |
