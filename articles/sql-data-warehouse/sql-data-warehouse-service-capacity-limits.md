...
| 데이터베이스 연결 |최대 동시 세션을 열고 |1024<br/><br/>열린 동시 세션 수는 선택한 DWU에 따라 달라 집니다. DWU600c 위에 지 원하는 최대 1,024 개의 세션을 엽니다. DWU500c 512의 최대 동시 열린 세션 제한을 지원 합니다. 동시에 실행할 수 있는 쿼리 수에 제한이 있습니다. 동시성 제한을 초과하는 경우 요청이 처리될 때까지 대기하는 내부 큐로 이동합니다. |
