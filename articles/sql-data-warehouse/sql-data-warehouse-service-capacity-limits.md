...
| Category | 설명 | 최대 |
| :---------------- | :------------------------------------------- | :----------------- |
| 쿼리 | 사용자 테이블에서 동시 쿼리입니다. | 32<br/><br/>동시에 실행할 수 있는 최대 쿼리 수입니다. 주어진 순간의 실제 수는 데이터베이스의 서비스 수준 목표 및 쿼리의 리소스 클래스에 따라 다릅니다. 리소스를 사용할 수 없는 경우 쿼리는 내부 큐에서 대기합니다. 자세한 내용은 [동시성 및 워크로드 관리][]를 참조하세요.|
