...
4.  필요한 연결 정보를 입력합니다. 아래의 매개 변수 찾기 섹션에서는 이 데이터를 찾을 수 있는 위치를 보여 줍니다.
...
## 매개 변수 값 찾기
정규화된 서버 이름과 데이터베이스 이름을 Azure 클래식 포털에서 찾을 수 있습니다. 이 때 SQL 데이터 웨어하우스만이 Azure 포털에서 있음에 유의합니다.
