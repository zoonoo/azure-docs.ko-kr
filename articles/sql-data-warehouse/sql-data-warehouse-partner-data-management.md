...
| 파트너 | 설명 | 링크 | 동영상 |
| --- | --- | --- | --- |
| ![Coffing Data Warehousing][1] |**Coffing Data Warehousing**<br>Coffing Data Warehousing은 10년 동안 쿼리 시스템을 전용으로 디자인한 도구인 Nexus Chameleon을 제공합니다. Nexus는 SQL Data Warehouse에 대한 쿼리 도구로 사용 가능합니다. Nexus를 사용하여 사내 및 클라우드 컴퓨터에서 쿼리하여 다른 플랫폼에서 데이터를 조인합니다. 마우스로 클릭하여 보고합니다! |[웹 사이트][coffing_website]<br>[보도 자료][coffing_press]<br>[Twitter][coffing_twitter]<br>[YouTube][coffing_youtube] |[![coffing 비디오](./media/sql-data-warehouse-partner-data-management/coffing_video.jpg)](https://www.youtube.com/watch?v=N5GSxBEySFc) |
...
| ![Sentry One][5] |**DW Sentry**<br>지능형 데이터 이동 대시보드 및 이벤트 달력을 사용하면 워크로드에 영향을 주는 작업을 항상 정확히 알 수 있습니다. 데이터를 로드, 백업 또는 복원하기 위해 실행 중인 쿼리 및 작업에 대한 가시성을 제공하도록 설계되었기 때문에 Azure 리소스의 대부분을 사용하는 것에 대해 걱정할 필요가 없습니다. |[Marketplace][sql_sentry_marketplace]<br>[웹 사이트][sql_sentry_website]<br>[보도 자료][sql_sentry_press]<br>[Twitter][sql_sentry_twitter]<br>[YouTube][sql_sentry_youtube] | |
