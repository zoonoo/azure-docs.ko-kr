<properties
   pageTitle="Azure SQL 데이터 웨어하우스의 계산 능력 관리(개요) | Microsoft Azure"
...
- DWU(데이터 웨어하우스 단위)를 조정하여 계산 능력 조정
...
- [Azure 포털을 사용하여 계산 능력 조정][]
- [PowerShell을 사용하여 계산 능력 조정][]
- [REST API를 사용하여 계산 능력 조정][]
- [TSQL을 사용하여 계산 능력 조정][]
