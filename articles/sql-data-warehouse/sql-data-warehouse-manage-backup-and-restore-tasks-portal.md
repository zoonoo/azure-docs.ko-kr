<properties
   pageTitle="Azure SQL 데이터 웨어하우스에서 백업 및 복원(포털) | Microsoft Azure"
...
# Azure SQL 데이터 웨어하우스에서 데이터베이스 백업 및 복원(포털)
...
Azure 포털을 사용하여 SQL 데이터 웨어하우스에서 데이터베이스를 백업 및 복원하는 방법
