<properties
   pageTitle="Azure SQL 데이터 웨어하우스의 장기 실행 사용자 쿼리 찾기 | Microsoft Azure"
   description="Azure SQL 데이터 웨어하우스에서 DMV(동적 관리 뷰)를 사용하여 워크로드를 모니터링하고 장기 실행 쿼리를 찾는 방법에 대해 알아봅니다."
