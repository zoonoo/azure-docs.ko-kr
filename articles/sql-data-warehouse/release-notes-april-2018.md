...
### <a name="dbcc-commands-do-not-consume-concurrency-slots"></a>DBCC 명령은 동시성 슬롯을 사용하지 않음
...
### <a name="updated-error-message-for-excessive-literals"></a>과도한 리터럴에 대한 업데이트된 오류 메시지
...
### <a name="removed-the-syspdwdatabasemappings-view"></a>제거된 SYS.PDW_DATABASE_MAPPINGS 보기
