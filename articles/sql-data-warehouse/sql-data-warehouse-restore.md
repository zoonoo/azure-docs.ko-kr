...
## <a name="copy-your-data-warehouse-with-user-defined-restore-points"></a>사용자 정의 복원 지점을 사용하여 데이터 웨어하우스 복사
...
5. 지정된 RestorePointLabel을 사용하여 가장 최근의 복원 지점을 검색합니다.
6. 데이터베이스의 리소스 ID를 가져와서 복원을 시작합니다.
6. 데이터베이스를 원하는 복원 지점으로 복원합니다.
7. 복원된 데이터베이스가 온라인 상태인지 확인합니다.
...
## <a name="create-a-user-defined-restore-point"></a>사용자 정의 복원 지점 만들기
