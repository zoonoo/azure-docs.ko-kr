...
SQL Data warehouse에서 Azure PowerShell을 사용 하려면 Azure PowerShell을 설치 해야 합니다.  **Get-module-ListAvailable-Name Az**를 실행하여 버전을 확인할 수 있습니다. 최신 버전 설치에 대한 자세한 내용은 [Azure PowerShell 설치 및 구성 방법][How to install and configure Azure PowerShell]을 참조하세요.
...
데이터베이스를 복구 하려면 [ Restore-AzSqlDatabase] cmdlet을 사용합니다.
