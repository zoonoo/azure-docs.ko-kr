---
title: "SQL Data Warehouse 개발을 위한 디자인 결정 및 코딩 기술 | Microsoft Docs"
...
개발 문서들을 살펴본 후에는 [Transact-SQL 참조][Transact-SQL 참조] 페이지에서 SQL Data Warehouse에 대해 지원되는 구문에 대한 자세한 내용을 보세요.
