...
커서를 대체하기 전에 먼저 Set 기반 작업을 사용하도록 이 커서를 재작성할 수 있는지를 확인해야 합니다. 대부분의 경우 다시 작성할 수 있으며 종종 가장 좋은 방법이기도 합니다. Set 기반 작업은 흔히 행별 반복 접근 방식보다 더 빠르게 수행됩니다.
...
첫째, 개별 문을 식별하는데 사용되는 고유한 행 번호를 포함하는 임시 테이블을 만듭니다.
