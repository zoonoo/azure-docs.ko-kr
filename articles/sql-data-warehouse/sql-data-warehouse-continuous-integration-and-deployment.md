...
- [Azure SQL Data Warehouse 아키텍처](massively-parallel-processing-mpp-architecture.md) 살펴보기
- 빠르게 [SQL Data Warehouse 만들기](create-data-warehouse-portal.md)
