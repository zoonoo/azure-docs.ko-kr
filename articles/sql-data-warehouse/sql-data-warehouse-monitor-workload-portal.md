---
title: 워크 로드 모니터링-Azure Portal | Microsoft Docs
...
SQL Data Warehouse에서 로그를 내보내도록 진단 설정을 구성 합니다. 로그는 SQL Data Warehouse에 대한 가장 일반적으로 사용되는 성능 문제 해결 DMV에 해당 하는 데이터 웨어하우스의 원격 분석 뷰로 구성됩니다. 현재 다음과 같은 뷰가 지원됩니다.
