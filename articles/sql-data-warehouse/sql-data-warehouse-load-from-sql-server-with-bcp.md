---
title: SQL Server에서 Azure SQL 데이터 웨어하우스로 데이터 로드(bcp) | Microsoft Docs
...
## 다음 단계
로드 개요는 [SQL 데이터 웨어하우스로 데이터 로드][SQL 데이터 웨어하우스로 데이터 로드]를 참조하세요. 더 많은 개발 팁은 [SQL 데이터 웨어하우스 개발 개요][SQL 데이터 웨어하우스 개발 개요]를 참조하세요. SQL 데이터 웨어하우스에 테이블을 만드는 방법에 대한 내용은 [테이블 개요][테이블 개요] 또는 [CREATE TABLE 구문][CREATE TABLE 구문]을 참조하세요.
