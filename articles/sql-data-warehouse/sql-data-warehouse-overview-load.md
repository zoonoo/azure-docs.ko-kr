---
title: Azure SQL 데이터 웨어하우스에 데이터 로드 | Microsoft Docs
...
자습서의 경우 [Azure Blob 저장소에서 SQL 데이터 웨어하우스로 데이터 로드(PolyBase)][Azure Blob 저장소에서 SQL 데이터 웨어하우스로 데이터 로드(PolyBase)]를 참조하세요.
...
자습서의 경우 [Azure Blob 저장소에서 SQL 데이터 웨어하우스로 데이터 로드(Azure Data Factory)][Azure Blob 저장소에서 SQL 데이터 웨어하우스로 데이터 로드(Azure Data Factory)]를 참조하세요.
...
SQL Server에서 SQL 데이터 웨어하우스로 전체 데이터 마이그레이션을 계획하려면 [마이그레이션 개요][마이그레이션 개요]를 참조하세요.
...
자습서의 경우 [SQL Server에서 Azure SQL 데이터 웨어하우스로 데이터 로드(SSIS)][SQL Server에서 Azure SQL 데이터 웨어하우스로 데이터 로드(SSIS)]를 참조하세요.
...
자습서의 경우 [SQL Server에서 Azure SQL 데이터 웨어하우스로 데이터 로드(bcp)][SQL Server에서 Azure SQL 데이터 웨어하우스로 데이터 로드(bcp)]를 참조하세요.
