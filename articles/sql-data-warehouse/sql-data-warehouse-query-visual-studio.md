---
title: Azure SQL 데이터 웨어하우스 쿼리(Visual Studio) | Microsoft Docs
...
* 정규화된 SQL 서버 이름. 이를 찾으려면 [SQL 데이터 웨어하우스에 연결][SQL 데이터 웨어하우스에 연결]을 참조하세요.
...
Azure Active Directory 인증을 위한 환경을 구성하려면 [SQL 데이터 웨어하우스에 대한 인증][SQL 데이터 웨어하우스에 대한 인증]을 참조하세요.
