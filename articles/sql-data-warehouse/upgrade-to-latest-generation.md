...
이제 Azure Portal에서 계산에 최적화된 성능 계층으로 원활하게 업그레이드할 수 있습니다. Optimized for Elasticity 데이터 웨어하우스가 있는 경우 업그레이드하는 것이 좋습니다. 업그레이드하여 최신 버전의 Azure 하드웨어 및 향상된 저장소 아키텍처를 사용할 수 있습니다. 더 빠른 성능, 더 높은 확장성 및 제한 없는 열 형식의 저장소를 활용할 수 있습니다. 
