...
| ![Informatica][4] |**Informatica PowerCenter**<br>Informatica는 세계에서 가장 인식할만한 데이터 통합 소프트웨어의 독립적인 공급자 중 하나입니다. PowerCenter는 모든 데이터 통합 이니셔티브의 토대를 형성합니다. 분석, 데이터 웨어하우징, 응용 프로그램 마이그레이션, 통합 또는 데이터 관리를 위해 PowerCenter를 사용합니다. |[Marketplace][informatica_PowerCenter_byol]<br>[웹 사이트][informatica_PowerCenter_website]<br>[데이터 시트][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
