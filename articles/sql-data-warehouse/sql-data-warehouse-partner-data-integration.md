...
종단간 데이터 웨어하우스 솔루션을 만들려면 다양한 업계 최고의 도구에서 선택합니다. 다음은 SQL 데이터 웨어하우스에 대한 데이터 통합 솔루션을 가진 여러 파트너 회사의 목록입니다.
...
| ![Attunity][2] | **Attunity**<br>Attunity CloudBeam은 SQL 데이터 웨어하우스에 데이터를 로드하기 위한 자동화되고 최적화된 솔루션을 제공합니다. "클릭하여 로드" 디자인으로 SQL Server, Oracle, DB2, Sybase 및 mySQL을 포함하여 여러 다른 유형의 데이터베이스에서 증분 복제뿐 아니라 일괄 처리 로드 모두를 단순화하여 가속화합니다. | [마켓플레이스][attunity_marketplace]<br>[웹 사이트][attunity_cloudbeam_website]<br>[데이터시트][attunity_cloudbeam_datasheet]<br>[Twitter][attunity_cloudbeam_twitter]<br>[YouTube][attunity_cloudbeam_youtube] | [![Attunity 비디오](./media/sql-data-warehouse-partner-data-integration/attunity_video.jpg)](https://www.youtube.com/watch?v=w14zuSjMlok)로 바꿉니다. |
...
| ![Informatica][4] | **Informatica Cloud**<br>Informatica Cloud Integration 포트폴리오를 사용하면 다양한 클라우드, 온-프레미스, 모바일 및 소셜 데이터 소스에 쉽게 연결하여 관련성 있고 신뢰할 수 있는 비즈니스 정보를 효율적으로 공유할 수 있습니다. 또한 일괄 처리 및 실시간 패턴, 클라우드 테스트 데이터 관리, 클라우드 데이터 품질 및 클라우드 마스터 데이터 관리 응용 프로그램을 위한 가장 완전한 클라우드 통합 제품군을 제공합니다. | [마켓플레이스][informatica_Cloud_Services_marketplace]<br>[웹 사이트][informatica_Cloud_Services_website]<br>[데이터시트][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
| ![Informatica][4] | **Informatica PowerCenter**<br>Informatica는 세계에서 가장 인식할만한 데이터 통합 소프트웨어의 독립적인 공급자 중 하나입니다. PowerCenter는 분석 및 데이터 웨어하우징, 응용 프로그램 마이그레이션 또는 통합 및 데이터 거버넌스를 비롯한 모든 데이터 통합 이니셔티브에 대한 기반을 형성합니다. | [마켓플레이스(표준)][informatica_PowerCenter_std_marketplace]<br>[마켓플레이스(고급)][informatica_PowerCenter_adv_marketplace]<br>[웹 사이트][informatica_PowerCenter_website]<br>[데이터시트][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
| ![Redgate][5] | **Redgate Data Platform Studio(Preview)**<br>Redgate의 Data Platform Studio는 온-프레미스 SQL 데이터베이스를 Azure SQL 데이터 웨어하우스에 마이그레이션하는 간단하고 신뢰할 수 있는 방법을 제공합니다. 이 제품은 완전히 자동화된 마이그레이션 위한 스마트 결정을 내릴 수 있도록 설계되어 있고 일회성 마이그레이션을 위해 무료로 사용할 수 있습니다. | [웹 사이트][redgate_website]<br>[Twitter][redgate_twitter]<br>[YouTube][redgate_youtube] | |
| ![SnapLogic][6] | **SnapLogic**<br>서비스(iPaaS)로서의 SnapLogic 통합 플랫폼을 사용하여 고객은 Microsoft Azure SQL 데이터 웨어하우스 내부 및 외부로 데이터를 신속하게 전송할 수 있습니다. SnapLogic은 수백 개의 응용 프로그램, 서비스 및 클라우드에서 온-프레미스 또는 IoT를 신속하고 효과적인 통찰력 전달을 위한 혼합 모드로 통합하는 기능을 제공합니다. | [마켓플레이스][snaplogic_marketplace]<br>[웹 사이트][snaplogic_website]<br>[데이터시트][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] | [![Snaplogic 비디오](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y)로 바꿉니다. |
