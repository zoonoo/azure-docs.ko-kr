---
title: SQL 데이터 웨어하우스용 Visual Studio 및 SSDT 설치 | Microsoft Docs
...
1. [Visual Studio 2015 다운로드][Visual Studio 2015 다운로드].
2. MSDN의 [Visual Studio 설치][Visual Studio 설치] 지침을 따르고 기본 구성을 선택합니다.
...
업데이트가 없는 경우 최신 버전을 설치했어야 합니다. SSDT가 설치되었는지 확인하려면 **도움말** / **Microsoft Visual Studio 정보**를 클릭하여 목록에서 SQL Server 데이터 도구를 찾아봅니다. 최신 버전의 SSDT는 14.0.60525.0입니다. 설치 옵션을 Visual Studio에서 사용할 수 없는 경우 [SSDT 다운로드][SSDT 다운로드] 페이지를 방문하여 SSDT를 수동으로 다운로드하고 설치할 수 있습니다.

## 다음 단계
이제 최신 버전의 SSDT가 설치되었으므로 SQL 데이터 웨어하우스에 [연결][연결]할 수 있습니다.
