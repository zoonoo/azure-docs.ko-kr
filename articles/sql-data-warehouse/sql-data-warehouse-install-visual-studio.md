...
description: SQL Analytics 용 Visual Studio 및 SSDT (SQL Server 개발 도구) 설치
...
SQL Analytics 용 기능 릴리스에 SSDT에 대 한 지원이 포함 되지 않는 경우가 있습니다. 현재 지원 되지 않는 기능은 다음과 같습니다.
...
최신 버전의 SSDT를 만들었으므로 SQL 풀에 [연결할][connect] 준비가 되었습니다.
