...
이 예제에서는 [CREATE TABLE AS SELECT](https://docs.microsoft.com/en-us/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse?view=aps-pdw-2016-au7)를 사용하여 다른 해시 배포 열로 테이블을 다시 만듭니다.
