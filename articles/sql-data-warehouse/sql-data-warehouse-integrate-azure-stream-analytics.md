...
데이터베이스에 대 한 연결이 성공 하면 포털에 알림이 표시 됩니다. 테스트를 클릭 하 여 데이터베이스에 대 한 연결을 테스트할 수 있습니다.
