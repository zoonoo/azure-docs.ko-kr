...
* 용량 계획은 혼합 쿼리 워크로드에 대해 복잡한 작업이 될 수도 있습니다. 특히 데이터 웨어하우스에 용량을 추가하는 데 긴 지연 시간이 필요한 경우가 그렇습니다. 언제든지 컴퓨팅 용량을 증가 및 축소시킬 수 있으며 저장 및 컴퓨팅 용량이 독립적으로 지정되므로 SQL Data Warehouse는 용량 계획의 긴급성을 제거해줍니다.
