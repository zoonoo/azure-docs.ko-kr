...
참고: SQL Server의 파티션에 대한 자세한 내용은 [분할된 테이블 및 인덱스](https://msdn.microsoft.com/library/ms190787.aspx)를 참조하세요.
