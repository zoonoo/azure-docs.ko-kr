...
## <a name="4-load-the-data-into-sql-data-warehouse-staging-tables-using-polybase"></a>4. PolyBase를 사용 하 여 SQL Data Warehouse 준비 테이블에 데이터를 로드 합니다.
