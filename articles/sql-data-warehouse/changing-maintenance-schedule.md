...
유지 관리 일정을 사용하려면 7일 동안 두 유지 관리 기간을 선택해야 합니다. 각 유지 관리 기간은 3 ~ 8시간이 될 수 있습니다. 유지 관리는 유지 관리 기간 내에서 언제든지 발생할 수 있지만 사전 알림 없이 시간 범위 외에는 발생하지 않습니다. 서비스가 데이터 웨어하우스에 새 코드를 배포할 때는 연결이 잠깐 동안 끊깁니다. 
