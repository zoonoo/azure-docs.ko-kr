...
Azure Stack Edge Pro R 디바이스에는 컴퓨팅 및 메모리에 대한 다음과 같은 사양이 있습니다.

| 사양       | 값                  |
|---------------------|------------------------|
| CPU    | Intel Xeon Silver 4114 CPU 2개<br>20개의 물리적 코어(CPU당 10개)<br>40개 논리 코어(vCPU)(CPU당 20개)  |
| 메모리              | 256GB RAM(2666MT/s)     |
