...
9. 업데이트를 사용할 수 있다는 알림이 다시 표시 됩니다. Kubernetes 업데이트입니다. 알림을 선택 하거나 맨 위 명령 모음에서 **장치 업데이트** 를 선택 합니다.
    ...
    ![업데이트 15 이후의 소프트웨어 버전](./media/azure-stack-edge-gpu-install-update/portal-update-16.png)

10. Kubernetes 업데이트를 다운로드 합니다. 이전 업데이트 패키지와 비교할 때 패키지 크기가 다른 것을 볼 수 있습니다.

    ![업데이트 16 이후 소프트웨어 버전](./media/azure-stack-edge-gpu-install-update/portal-update-17.png)

    설치 프로세스는 장치 업데이트의 프로세스와 동일 합니다. 먼저 업데이트가 다운로드 됩니다.

    ![업데이트 17 이후 소프트웨어 버전](./media/azure-stack-edge-gpu-install-update/portal-update-18.png)    
    
11. 업데이트가 다운로드 되 면 업데이트를 설치할 수 있습니다. 

    ![업데이트 18 이후의 소프트웨어 버전](./media/azure-stack-edge-gpu-install-update/portal-update-19.png)
    ...
    ![업데이트 19 이후의 소프트웨어 버전](./media/azure-stack-edge-gpu-install-update/portal-update-20.png)
