---
title: Azure Stack Edge Pro 2011 릴리스 정보
description: 2011 릴리스를 실행 하는 Azure Stack Edge Pro에 대 한 중요 한 미해결 문제 및 해결 방법을 설명 합니다.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "96467232"
---
# <a name="azure-stack-edge-2011-release-notes"></a>Azure Stack Edge 2011 릴리스 정보

다음 릴리스 정보는 Azure Stack Edge 장치의 2011 릴리스에 대 한 중요 한 미해결 문제 및 해결 된 문제를 식별 합니다. 이러한 릴리스 정보는 Azure Stack Edge Pro GPU, Azure Stack Edge Pro R 및 Azure Stack Edge 미니 R 장치에 적용 됩니다. 특정 모델에 해당 하는 기능 및 문제는 해당 하는 경우에 호출 됩니다.

릴리스 정보는 계속 업데이트되며, 해결 방법이 필요한 중대한 문제가 발견되면 해당 내용이 추가됩니다. 장치를 배포 하기 전에 릴리스 정보에 포함 된 정보를 주의 깊게 검토 하세요.

이 문서는 **Azure Stack Edge 2011** 릴리스에 적용 됩니다.<!--which maps to software version number **2.1.XXXX.XXXX**-->.

## <a name="whats-new"></a>새로운 기능

Azure Stack Edge 2011 릴리스에서는 다음과 같은 새로운 기능을 사용할 수 있습니다. 
...
## <a name="known-issues-in-2011-release"></a>2011 릴리스의 알려진 문제

다음 표에서는 2011 릴리스의 알려진 문제에 대 한 요약을 제공 합니다.
...
|**5.**|Kubernetes |Kubernetes는 .NET 응용 프로그램에서 사용 하는 환경 변수 이름에서 ":"을 지원 하지 않습니다. 이는 Event grid IoT Edge 모듈이 Azure Stack Edge 장치 및 기타 응용 프로그램에서 작동 하는 데도 필요 합니다. 자세한 내용은 [ASP.NET core 설명서](/aspnet/core/fundamentals/configuration/?tabs=basicconfiguration&view=aspnetcore-3.1#environment-variables)를 참조 하세요.|":"을 이중 밑줄로 바꿉니다. 자세한 내용은 [Kubernetes issue](https://github.com/kubernetes/kubernetes/issues/53201) 항목을 참조 하세요.|
