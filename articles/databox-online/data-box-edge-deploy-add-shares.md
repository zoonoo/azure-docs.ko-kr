...
ms.locfileid: "49165361"
---
# <a name="tutorial-transfer-data-with-azure-data-box-edge-preview"></a>자습서: Azure Data Box Edge를 사용하여 데이터 전송(미리 보기)

이 자습서에서는 Data Box Edge에 공유를 추가하고 연결하는 방법에 대해 설명합니다. 공유가 추가되면 Data Box Edge 디바이스에서 데이터를 Azure로 전송할 수 있습니다.
...
* [Data Box Edge 설치](data-box-edge-deploy-install.md)에서 설명한 대로 물리적 장치를 설치했습니다. 
    ...
    물리적 디바이스가 [Azure Data Box Edge 연결 및 활성화](data-box-edge-deploy-connect-setup-activate.md)에서 설명한 대로 활성화됩니다. 디바이스에서 공유를 만들고 데이터를 전송할 준비가 되었습니다.
...
2. 필터링된 리소스 목록에서 Data Box Edge 리소스를 선택한 다음, **개요**로 이동합니다. 디바이스 명령 모음에서 **+ 공유 추가**를 클릭합니다.
...
2. NFS 클라이언트가 설치되면 다음 명령을 사용하여 Data Box Edge 디바이스에서 만든 NFS 공유를 탑재합니다.
