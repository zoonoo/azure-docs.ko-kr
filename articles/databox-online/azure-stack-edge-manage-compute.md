---
title: Azure Stack Edge 계산 관리 | Microsoft Docs
description: Azure Stack Edge에서 Azure Portal를 통해 트리거, 모듈, 계산 구성 보기, 구성 제거와 같은에 지 계산 설정을 관리 하는 방법을 설명 합니다.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
ms.locfileid: "82569070"
---
# <a name="manage-compute-on-your-azure-stack-edge"></a>Azure Stack Edge에서 계산 관리
