...
1. 트리거 목록에서 삭제하려는 트리거를 선택합니다.
    ...
    ![트리거 선택](media/azure-stack-edge-manage-compute/add-trigger-1.png)

2. 마우스 오른쪽 단추를 클릭한 다음, **삭제**를 선택합니다.

    ![삭제 선택](media/azure-stack-edge-manage-compute/add-trigger-1.png)

3. 확인 메시지가 표시되면 **예**를 클릭합니다.

    ![삭제 확인](media/azure-stack-edge-manage-compute/add-trigger-1.png)
