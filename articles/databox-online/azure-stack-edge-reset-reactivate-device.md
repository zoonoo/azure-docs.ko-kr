...
1. [새 리소스 만들기](azure-stack-edge-gpu-deploy-prep.md?tabs=azure-portal#create-a-new-resource)의 단계에 따라 기존 장치에 대 한 새 주문을 만듭니다. **배송 주소** 탭에서 **이미 장치가** 있습니다 .를 선택 합니다.

   ![배송 주소에 새 장치를 지정 하지 않음](./media/azure-stack-edge-reset-reactivate-device/create-resource-with-no-new-device.png)

1. [활성화 키를 가져옵니다](azure-stack-edge-gpu-deploy-prep.md?tabs=azure-portal#get-the-activation-key).
...
1. [장치를 활성화](azure-stack-edge-gpu-deploy-activate.md)합니다.
