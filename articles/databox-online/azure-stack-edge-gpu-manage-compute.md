---
title: Azure Stack Edge Pro GPU 계산 관리 | Microsoft Docs
description: Azure Stack Edge Pro GPU에서 Azure Portal를 통해 트리거, 모듈, 계산 구성 보기, 구성 제거와 같은에 지 계산 설정을 관리 하는 방법을 설명 합니다.
services: databox
author: alkohli
ms.service: databox
ms.subservice: edge
...
2. IoT Edge 서비스를 제거 하면 작업이 되돌릴 수 없으며 실행 취소할 수 없습니다. 만든 모듈과 트리거도 삭제 됩니다. IoT Edge를 다시 사용 해야 하는 경우 장치를 다시 구성 해야 합니다. 확인 메시지가 표시 되 면 **확인** 을 선택 합니다.
    ...
    ![계산 제거 2 선택](media/azure-stack-edge-gpu-manage-compute/remove-compute-2.png)
...
- [Edge Pro Azure Stack 문제를 해결](azure-stack-edge-gpu-troubleshoot.md)하는 방법을 알아봅니다.
