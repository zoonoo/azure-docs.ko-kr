...
[Azure Stack Edge Pro에서 인증서 사용](azure-stack-edge-j-series-manage-certificates.md)

[Azure Stack 허브 준비 검사 도구를 사용 하 여 Azure Stack Edge Pro에 대 한 인증서 만들기](azure-stack-edge-j-series-create-certificates-tool.md)
