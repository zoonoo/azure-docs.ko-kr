...
이 문서에서는 Data Box Gateway에서 공유를 추가하고 연결하는 방법에 대해 설명합니다. 공유가 추가되면 Data Box Gateway 디바이스에서 데이터를 Azure로 전송할 수 있습니다.
...
2. 필터링된 리소스 목록에서 Data Box Gateway 리소스를 선택한 다음, **개요**로 이동합니다. 디바이스 명령 모음에서 **+ 공유 추가**를 클릭합니다.
