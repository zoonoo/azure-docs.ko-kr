...
> [AZURE.SELECTOR]
> - [시작하기](/documentation/articles/vs-storage-aspnet5-getting-started-tables/)
...
**참고:** 이 가이드의 모든 코드에서는 빌드되는 응용 프로그램이 Azure 클라우드 서비스 프로젝트이며 Azure 응용 프로그램의 서비스 구성에 저장된 저장소 연결 문자열을 사용한다고 가정합니다. 또한 다음 섹션의 코드 앞에서 이 코드를 모두 사용합니다.
...
#####엔터티 삭제
엔터티를 찾은 후 삭제할 수 있습니다. 다음 코드에서는 "Ben Smith"라는 고객 엔터티를 찾아보고 찾으면 삭제합니다.
