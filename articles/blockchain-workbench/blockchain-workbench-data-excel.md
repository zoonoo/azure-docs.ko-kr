...
3. **Azure에서**를 선택하고 **Azure SQL Database에서**를 선택합니다.
   ...
   ![Azure SQL 데이터베이스에 연결](media/blockchain-workbench-data-excel/connect-sql-db.png)
...
4. **SQL Server 데이터베이스** 대화 상자에서:
   ...
   ![데이터베이스 서버 및 데이터베이스 입력](media/blockchain-workbench-data-excel/provide-server-db.png)
...
5. **SQL Server 데이터베이스** 대화 상자 탐색 모음에서 **데이터베이스**를 선택합니다. **사용자 이름** 및 **암호**를 입력한 다음, **연결**을 선택합니다.
   ...
   ![자격 증명을 입력하여 데이터베이스에 액세스](media/blockchain-workbench-data-excel/provide-credentials.png)
...
데이터베이스에 연결하면 Excel 탐색기 대화 상자가 열립니다. 탐색기를 사용하여 데이터베이스의 테이블 및 보기를 살펴볼 수 있습니다. 보기는 보고용으로 설계되었으며 보기의 이름에 **vw**라는 접두사가 붙습니다.
   ...
   ![보기의 Excel 탐색기 미리 보기](media/blockchain-workbench-data-excel/excel-navigator.png)
...
2. **로드**를 선택하여 보기의 모든 데이터를 검색하고 Excel 통합 문서에 배치합니다.
   ...
   ![보기에서 로드된 데이터](media/blockchain-workbench-data-excel/view-data.png)
