...
![Blockchain Workbench 리소스 나열](media/blockchain-workbench-database-firewall/list-database-resources.png)
...
2. 메뉴 모음에서 **서버 방화벽 설정**을 선택합니다.
   ...
   ![서버 방화벽 설정](media/blockchain-workbench-database-firewall/configure-server-firewall.png)
...
3. 조직의 규칙을 만들려면:
   ...
   * 주소 범위의 **끝 IP**에 대한 IP 주소를 입력합니다.
   ...
   ![방화벽 규칙 만들기](media/blockchain-workbench-database-firewall/create-firewall-rule.png)
