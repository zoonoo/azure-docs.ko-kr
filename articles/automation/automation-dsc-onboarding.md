...
## <a name="onboarding-physicalvirtual-windows-machines"></a>물리적/가상 Windows 컴퓨터 온보딩

온-프레미스 또는 다른 클라우드 환경(AWS EC2 인스턴스 포함)에서 실행되는 Windows 서버를 Azure 자동화 상태 구성에 온보덕일 수 있습니다. 서버는 Azure 에 [대한 아웃바운드 액세스 권한이](automation-dsc-overview.md#network-planning)있어야 합니다.
...
## <a name="onboarding-physicalvirtual-linux-machines"></a>물리적/가상 Linux 컴퓨터 온보딩
