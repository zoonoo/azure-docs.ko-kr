...
ms.locfileid: "92222728"
---
# <a name="enable-update-management-from-an-automation-account"></a>Automation 계정에서 업데이트 관리 사용

이 문서에서는 Automation 계정을 사용 하 여 [Azure Arc 사용 서버](../../azure-arc/servers/overview.md) (미리 보기)에 등록 된 컴퓨터 또는 서버를 포함 하 여 사용자 환경에서 vm에 대 한 [업데이트 관리](overview.md) 기능을 사용 하도록 설정 하는 방법을 설명 합니다. 대규모로 Azure Vm을 사용 하도록 설정 하려면 업데이트 관리를 사용 하 여 기존 Azure VM을 사용 하도록 설정 해야 합니다.
