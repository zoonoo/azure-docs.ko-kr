...
5. Log Analytics 작업 영역 및 Automation 계정을 선택하고 **사용**을 클릭하여 업데이트 관리를 사용하도록 설정합니다. 업데이트 관리를 사용 하도록 설정한 후 VM에서 업데이트 평가를 보려면 약 15 분이 걸릴 수 있습니다.

    ![업데이트 관리 사용](media/update-mgmt-enable-vm/manageupdates-update-enable.png)
