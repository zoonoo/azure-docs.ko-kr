...
1.  Azure에서 “Automation Hybrid Worker”를 사용하도록 설정합니다. 이렇게 하려면 다음 방법 중 하나를 사용합니다.
   ...
   1. [작업 영역에 Log Analytics 관리 솔루션 추가](https://docs.microsoft.com/azure/log-analytics/log-analytics-add-solutions)의 프로시저를 사용하여 구독에 **Automation Hybrid Worker** 솔루션을 추가합니다.
   2. 다음 cmdlet을 실행합니다.
