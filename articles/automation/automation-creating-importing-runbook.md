---
title: "Azure 자동화에서 Runbook 만들기 또는 가져오기"
...
---
# <a name="creating-or-importing-a-runbook-in-azure-automation"></a>Azure 자동화에서 Runbook 만들기 또는 가져오기
...
### <a name="to-create-a-new-azure-automation-runbook-with-the-azure-classic-portal"></a>Azure 클래식 포털에서 새 Azure 자동화 Runbook을 만들려면
...
### <a name="to-create-a-new-azure-automation-runbook-with-the-azure-portal"></a>Azure 포털에서 새 Azure 자동화  Runbook을 만들려면
...
### <a name="to-create-a-new-azure-automation-runbook-with-windows-powershell"></a>Windows PowerShell에서 새 Azure 자동화 Runbook을 만들려면
...
## <a name="importing-a-runbook-from-a-file-into-azure-automation"></a>파일의 Runbook을 Azure 자동화로 가져오기
...
### <a name="to-import-a-runbook-from-a-file-with-the-azure-portal"></a>Azure 포털을 사용하여 파일에서 Runbook을 가져오려면
...
7. 새 Runbook이 자동화 계정의Runbook 목록에 표시됩니다.
...
## <a name="to-publish-a-runbook-using-the-azure-classic-portal"></a>Azure 클래식 포털을 사용하여 Runbook을 게시하려면
1. Azure 클래식 포털에서 Runbook을 엽니다.
2. 화면 맨 위에서 **작성자**를 클릭합니다.
3. 화면 아래쪽에서 **게시**를 클릭한 다음 확인 메시지에서 **예**를 클릭합니다.

## <a name="to-publish-a-runbook-using-the-azure-portal"></a>Azure 포털을 사용하여 Runbook을 게시하려면
...
* Runbook 및 PowerShell 모듈 갤러리를 활용하는 방법을 알아보려면 [Azure 자동화에 대한 Runbook 및 모듈 갤러리](automation-runbook-gallery.md)
...
* 그래픽 Runbook 작성에 대한 자세한 내용은 [Azure 자동화에서 그래픽 제작](automation-graphical-authoring-intro.md)
