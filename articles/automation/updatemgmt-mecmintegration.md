...
* 현재 Configuration Manager 환경에서 관리중인 Windows 서버는 업데이트 관리 솔루션이 활성화되어 있는 Log Analytics 작업 영역에 보고해야 합니다.
* 이 기능은 Configuration Manager 현재 분기 버전 1606 이상에서 사용할 수 있습니다. Configuration Manager 중앙 관리 사이트 또는 독립 실행형 기본 사이트를 Azure Monitor 로그 및 가져오기 컬렉션과 통합하려면 [구성 관리자를 Azure Monitor 로그에 연결합니다.](../azure-monitor/platform/collect-sccm.md)  
