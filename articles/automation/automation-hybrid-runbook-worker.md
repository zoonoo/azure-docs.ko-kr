...
|OS  |배포 형식  |
|---------|---------|
|Windows     | [PowerShell](automation-windows-hrw-install.md#automated-deployment)<br>[설명서](automation-windows-hrw-install.md#manual-deployment)        |
