---
title: Azure 자동화 Hybrid Runbook Worker | Microsoft Docs
...
> [!NOTE]
> 하이브리드 Runbook Worker는 현재 [DSC 구성](automation-dsc-overview.md)을 지원하지 않습니다.
> 
> 
...
> [!NOTE]
> 현재 Hybrid Runbook Worker 버전 7.2.11136.0은 PowerShell 스크립트를 사용하여 프록시 서버를 통해서만 통신을 지원합니다.  PowerShell 워크플로 스크립트에 대한 지원은 향후 릴리스에서 사용할 수 있습니다.  
> 
> 
