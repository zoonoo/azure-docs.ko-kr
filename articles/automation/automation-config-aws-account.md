...
AWS 보안 키를 만들어서 복사한 후에는 보안 키를 안전하게 보관하고 Runbook에서 참조할 수 있도록 Azure Automation 계정으로 자격 증명 자산을 만들어야 합니다. 섹션의 단계를 **따르십시오:** Azure 자동화 문서의 [자격 증명 자산에](shared-resources/credentials.md#to-create-a-new-credential-asset-with-the-azure-portal) 새 자격 증명을 만들고 다음 정보를 입력하려면 다음 정보를 입력합니다.
