...
|Automation 작업 연산자|Automation 작업 Operator 역할을 사용하면 Automation Runbook을 사용하여 작업을 만들고 관리할 수 있습니다.|
|Automation Runbook 연산자|Automation Runbook 연산자 역할을 사용하면 Runbook 속성을 읽을 수 있습니다. Runbook의 작업을 만들 수도 있습니다.|
...
Automation 작업 연산자는 Automation 계정 범위에서 부여됩니다. 그러면 연산자 권한이 해당 계정에서 작업을 관리할 수 있습니다.
...
Automation Runbook 운영자 역할은 Runbook 범위에서 부여됩니다. Automation Runbook 운영자는 Runbook 이름을 확인할 수 있습니다. Automation 계정 범위에서 'Automation 작업 연산자'를 포함하는 이 사용 권한을 통해 연산자가 특정 Runbook에 대한 Automation 연산자 작업을 수행할 수 있습니다. 다음 표에서는 역할에 부여된 사용 권한을 보여줍니다.
...
Automation 연산자는 작업을 시작, 중지, 일시 중단 및 다시 시작할 수 있습니다. 다음 표에서는 역할에 부여된 사용 권한을 보여줍니다.
