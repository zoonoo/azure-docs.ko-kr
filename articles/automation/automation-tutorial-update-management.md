...
업데이트 관리를 사용하도록 설정한 후에는 **업데이트 관리** 창이 열립니다. 업데이트가 누락된 것으로 식별된 경우 **누락 업데이트** 탭에 누락된 업데이트 목록이 표시됩니다.
...
Automation 계정이 이미 리소스로 선택되어 있습니다. 변경하려면 **선택**을 클릭합니다. **리소스 선택** 페이지의 **리소스 종류별로 필터링** 드롭다운에서 **Automation 계정**을 선택합니다. Automation 계정을 선택한 다음, **완료**를 클릭합니다.
