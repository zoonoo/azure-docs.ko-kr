...
Azure Monitor 경고에 익숙하지 않은 경우 시작 하기 전에 [Microsoft Azure의 경고 개요](../../azure-monitor/alerts/alerts-overview.md) 를 참조 하세요. 로그 쿼리를 사용 하는 경고에 대해 자세히 알아보려면 [Azure Monitor의 로그 경고](../../azure-monitor/alerts/alerts-unified-log.md)를 참조 하세요.
