...
- **평가되지 않음**: 예상 기간 내에 컴퓨터의 업데이트 평가 데이터를 받지 못했습니다. Linux 컴퓨터의 경우 기간이 지난 1 시간입니다. Windows 컴퓨터의 경우, 예상 시간 범위는 지난 12시간입니다.
...
- **업데이트 분류**: 업데이트 배포에 포함할 소프트웨어 종류를 선택합니다. 분류 형식에 대한 설명은 [업데이트 분류](automation-view-update-assessments.md#update-classifications)를 참조하세요. 분류 형식은 다음과 같습니다.
  - 중요 업데이트
  - 보안 업데이트
  - 업데이트 롤업
  - 기능 팩
...
> [!NOTE]
> 업데이트 배포에 포함 되도록 대체 된 업데이트를 지정할 수 없습니다.
>
