...
* Powershell 워크플로를 포함 하는 `.ps1` 파일은powershell스크립트엔진에서인식할수없으므로 [powershellrunbook](automation-runbook-types.md#powershell-runbooks)으로 가져올 수 없습니다.
