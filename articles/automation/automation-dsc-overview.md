...
구성 키워드에 대한 자세한 내용은 [필요한 상태 구성의 구성 키워드 이해](http://blogs.msdn.com/b/powershell/archive/2013/11/05/understanding-configuration-keyword-in-desired-state-configuration.aspx "필요한 상태 구성의 구성 키워드 이해")
