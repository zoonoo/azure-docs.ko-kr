...
다음 활동인 Connect-AzureRmAccount는 Runbook에서 사용하기 위해 인증된 실행 계정을 추가합니다.<br>
![Connect-AzureRmAccount 매개 변수 집합](media/automation-graphical-authoring-intro/authenticate-conn-to-azure-parameter-set.png)<br>
