...
* Runbook에서 [using module 문을 사용](https://docs.microsoft.com/powershell/module/microsoft.powershell.core/about/about_using?view=powershell-7.1#module-syntax) 하 여 모듈을 명시적으로 가져오는 경우 Using 문은 Windows PowerShell 5.0부터 지원 되며 클래스 및 열거형 형식 가져오기를 지원 합니다.
