...
1. `External_Stop_ResourceGroupNames` 대상 VM을 지정하도록 및 `External_ExcludeVMNames` 변수를 구성합니다.
...
### <a name="to-target-the-autostop-action-to-a-list-of-vms"></a>자동 정지 작업을 VM 목록으로 타겟팅하려면
