...
이 가져오기 프로세스는 [PowerShell 갤러리](https://www.powershellgallery.com)를 통해 수행할 수 있습니다.

1. [Watch-NewFile.ps1](https://gallery.technet.microsoft.com/scriptcenter/Watcher-runbook-that-looks-36fc82cd)의 갤러리 페이지로 이동합니다.
2. **Azure Automation** 탭 아래의 **Azure Automation 배포**를 클릭합니다.

다음 단계를 수행하여 포털에서 이 Runbook을 Automation 계정으로 가져올 수도 있습니다.
...
작업 Runbook은 감시자 Runbook에서 전달된 데이터에 대한 작업을 수행하기 위해 감시자 태스크에서 사용됩니다. [PowerShell 갤러리](https://www.powershellgallery.com)에서 **Process-NewFile**이라는 미리 정의된 작업 Runbook을 가져와야 합니다. 

작업 Runbook을 만들려면 다음을 수행합니다.

1. [Process-NewFile.ps1](https://gallery.technet.microsoft.com/scriptcenter/Watcher-action-that-b4ff7cdf)의 갤러리 페이지로 이동합니다.
2. **Azure Automation** 탭 아래의 **Azure Automation 배포**를 클릭합니다.
...
> [PowerShell Runbook 만들기](learn/automation-tutorial-runbook-textual-powershell.md)