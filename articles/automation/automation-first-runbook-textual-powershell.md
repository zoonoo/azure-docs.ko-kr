...
1.	Runbook은 현재 비어 있습니다. *Write-Output "Hello World"*를 입력합니다. ![Hello World](media/automation-first-runbook-textual-powershell/automation-helloworld.png)  
...
4.	Runbook을 시작해야 하므로 Runbook 시작 블레이드가 열리면 **시작**을 클릭한 다음 **확인**을 클릭합니다. ![시작 단추](media/automation-first-runbook-textual-powershell/automation-start-button.png)  
