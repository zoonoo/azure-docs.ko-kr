...
Python Runbook은 Python 스크립트 언어를 기반으로 하는 텍스트 Runbook입니다. Azure Automation에서는 Python 2 및 Python 3 Runbook을 모두 지원합니다.
Python에 대한 자세한 내용은 [https://www.python.org/](https://www.python.org/)를 참조하세요.
Python Runbook의 예제를 보려면 [Azure Automation의 내 첫 번째 Python Runbook](automation-first-runbook-textual-python2.md)을 참조하세요.

## <a name="bash-runbooks"></a>Bash Runbook

Bash Runbook은 GNU Bash 셸을 기반으로 하는 텍스트 Runbook입니다. Bash에 대한 자세한 내용은 [https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/)를 참조하세요.
