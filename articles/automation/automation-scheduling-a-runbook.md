...
1. Azure 포털의 자동화 계정에서 **자산** 타일을 클릭하여 **자산** 블레이드를 엽니다.
2. **일정** 타일을 클릭하여 **일정** 블레이드를 엽니다.
2. 일정 이름을 클릭하여 해당 세부 정보 블레이드를 엽니다.
3. **사용**을 **아니오**로 변경합니다.

### Windows PowerShell을 사용하여 일정을 해제하려면

[Set-AzureAutomationSchedule](http://msdn.microsoft.com/library/azure/dn690270.aspx) cmdlet을 사용하여 기존 runbook에 대한 기존 일정의 속성을을 변경하거나 [Set-AzureRmAutomationSchedule](https://msdn.microsoft.com/library/mt603566.aspx) cmdlet을 Azure 포털에서 runbook에 사용할 수 있습니다. 일정을 해제하려면 **IsEnabled** 매개 변수에 대해 **false**를 지정합니다.
