...
>[AZURE.NOTE] Runbook과 일정을 연결하는 경우 자동화는 계정에 모듈의 현재 버전을 저장하고 해당 일정에 연결합니다. 즉, 일정을 만들고 모듈을 버전 2.0으로 업데이트할 때 계정에 버전 1.0을 사용하는 모듈이 있는 경우 일정은 계속 1.0을 사용합니다. 업데이트된 모듈 버전을 사용하려면 새 일정을 만들어야 합니다.
