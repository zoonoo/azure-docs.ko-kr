...
3.  관리 포털의 왼쪽 위에 있는 창에서 **서비스 버스** 노드를 클릭한 후
    **새로 만들기** 단추를 클릭합니다.
    ![서비스 버스 노드 스크린샷][서비스 버스 노드 스크린샷]
4.  **Create a new Service Namespace** 대화 상자에서
    **네임스페이스**를 입력한 후, 네임스페이스가 중복되지 않는지 확인하기 위해
    **중복 확인** 단추를 클릭합니다.
    ![새 네임스페이스 만들기 스크린샷][새 네임스페이스 만들기 스크린샷]
5.  네임스페이스 이름이 사용 가능한지 확인한 후 해당 네임스페이스를
...
3.  오른쪽 **속성** 창에 새 네임스페이스의 속성이
    나열됩니다.
    ![속성 창 스크린샷][속성 창 스크린샷]
4.  **기본 키**가 숨겨져 있습니다. **보기** 단추를 클릭하여 보안 자격
    증명을 표시합니다.
    ![기본 키 스크린샷][기본 키 스크린샷]
5.  **기본 발급자** 및 **기본 키**를 기록해 둡니다. 이 정보는 아래에서
     네임스페이스 관련 작업을 수행하는 데 사용됩니다.

## 계산 집약적인 작업을 수행하는 Java 응용 프로그램을 만드는 방법

1.  개발 컴퓨터(직접 생성한 가상 컴퓨터일 필요는 없음)에서 [Java용 Azure SDK][Java용 Azure SDK]를 다운로드합니다.
...
해 찾기 및 클라이언트 응용 프로그램을 정상적인 완료 이전에 종료하고 싶으면 **Ctrl+C**를 누르면 됩니다.
  ...
  [순회 외판원 문제 해 찾기]: ./media/virtual-machines-java-run-compute-intensive-task/WA_JavaTSPSolver.png
  [순회 외판원 문제 클라이언트]: ./media/virtual-machines-java-run-compute-intensive-task/WA_JavaTSPClient.png
  [Azure 관리 포털]: https://manage.windowsazure.com
  [Java CA 인증서 저장소에 인증서 추가]: ../java-add-certificate-ca-store
  [서비스 버스 노드 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_02_SvcBusNode.jpg
  [새 네임스페이스 만들기 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_03_CreateNewSvcNamespace.jpg
  [사용 가능한 네임스페이스 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_04_SvcBusNode_AvailNamespaces.jpg
  [네임스페이스 목록 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_05_NamespaceList.jpg
  [속성 창 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_06_PropertiesPane.jpg
  [기본 키 스크린샷]: ./media/virtual-machines-java-run-compute-intensive-task/SvcBusQueues_07_DefaultKey.jpg
