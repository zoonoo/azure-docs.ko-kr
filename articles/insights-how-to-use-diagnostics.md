<properties title="How to use diagnostics" pageTitle="진단을 사용하는 방법" description="Learn how to set up diagnostics for your resources in Azure." authors="stepsic" manager="kamrani" />
