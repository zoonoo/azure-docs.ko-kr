<properties urlDisplayName="Validate and Modify Data" pageTitle=".Net 백 엔드를 사용하여 데이터 유효성 검사 및 수정(Windows Phone 8) | 모바일 개발자 센터" metaKeywords="" description="Learn how to validate, modify, and augment data for your Windows Phone app with .Net backend Microsoft Azure Mobile Services." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using the .Net backend" authors="wesmc" solutions="" manager="dwrede" editor="" />
