...
1.  Xamarin Studio 또는 Visual Studio에서 [인증 시작][인증 시작](영문) 자습서를 완료할 때 수정한 프로젝트를 엽니다.

2.  **Run(실행)**을 클릭하여 앱을 시작하고 선택한 ID 공급자로 로그인합니다.
...
<!-- Anchors. --> <!-- Images. --> <!-- URLs. -->
  ...
  [Windows Phone]: /ko-kr/develop/mobile/tutorials/authorize-users-in-scripts-wp8 "Windows Phone"
  [iOS]: /ko-kr/develop/mobile/tutorials/authorize-users-in-scripts-ios "iOS"
  [Android]: /ko-kr/develop/mobile/tutorials/authorize-users-in-scripts-android "Android"
  [HTML]: /ko-kr/develop/mobile/tutorials/authorize-users-in-scripts-html "HTML"
  [iOS C#]: /ko-kr/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-ios "Xamarin.iOS"
