...
| Microsoft. Storage/storageAccounts/List서비스로 서/작업, </br> Microsoft. Storage/storageAccounts/listAccountSas/Action, <br> Microsoft.Storage/storageAccounts/listKeys/Action| [저장소 계정에 대 한 보안 액세스](../storage/common/storage-sas-overview.md) 를 설정 하 고 저장소 계정에 쓸 수 있는 SAS (공유 액세스 서명)를 인출 하는 데 사용 됩니다. |
