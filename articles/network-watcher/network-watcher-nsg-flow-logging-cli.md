...
이 문서의 단계를 수행하려면 [Mac, Linux 및 Windows용 Azure 명령줄 인터페이스를 설치(CLI)](/cli/azure/install-azure-cli)해야 합니다. 모든 흐름 로그 명령의 자세한 사양은 [여기](/cli/azure/network/watcher/flow-log)에서 확인할 수 있습니다.
