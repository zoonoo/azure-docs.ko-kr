...
* 메트릭 경고는 연결 모니터 메트릭 경고로 마이그레이션됩니다. 메트릭은 다르지만 변경 됩니다. 자세한 내용은 [연결 모니터를 사용 하 여 네트워크 연결 모니터링](./connection-monitor-overview.md#metrics-in-azure-monitor)을 참조 하세요.
