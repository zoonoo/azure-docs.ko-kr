...
Network Watcher로 이동하고 **연결 확인(미리 보기)**을 클릭합니다. 가상 컴퓨터를 선택하여 연결을 확인합니다. **대상** 섹션에서 **가상 컴퓨터 선택**을 선택하고 테스트할 가상 컴퓨터와 포트를 정확히 선택합니다.

**확인**을 클릭하면 지정한 포트의 가상 컴퓨터 간 연결이 확인됩니다. 이 예에서는 대상 VM이 연결될 수 없으며 홉 목록이 표시됩니다.
