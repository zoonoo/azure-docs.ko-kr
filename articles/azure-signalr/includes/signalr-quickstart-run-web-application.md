...
1. 편의를 위해 GitHub에서 호스트된 샘플 단일 페이지 웹 애플리케이션이 있습니다. 브라우저에서 [https://azure-samples.github.io/signalr-service-quickstart-serverless-chat/demo/chat/](https://azure-samples.github.io/signalr-service-quickstart-serverless-chat/demo/chat/)을(를) 엽니다.
