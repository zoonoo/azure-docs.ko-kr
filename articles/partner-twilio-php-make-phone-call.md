...
* [PHP-MySQL Azure 웹 사이트 만들기 및 Git를 사용하여 배포][website-git](영문)
* [PHP-MySQL Azure 웹 사이트 만들기 및 FTP를 사용하여 배포][website-ftp](영문)
* [WebMatrix를 사용하여 PHP-MySQL Azure 웹 사이트 만들기 및 배포][website-webmatrix](영문)
