<properties 
	...
	description="A WordPress 블로그에 대한 새 Azure 웹 앱을 만든 다음 Azure 포털을 통해 배포하는 방법에 대해 설명하는 자습서입니다." 
...
- [PHP-MySQL Azure 웹 앱 만들기 및 Git를 사용하여 배포](/ko-kr/develop/php/tutorials/website-w-mysql-and-git/) -- PHP 웹 앱을 처음부터 만들고 Git를 사용하여 Azure 앱 서비스에 배포합니다.
