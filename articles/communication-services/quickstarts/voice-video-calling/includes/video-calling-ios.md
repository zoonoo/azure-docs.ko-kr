...
`<USER ACCESS TOKEN>`을 리소스에 대한 유효한 사용자 액세스 토큰으로 바꿉니다. 사용할 수 있는 토큰이 아직 없는 경우 [사용자 액세스 토큰](https://docs.microsoft.com/azure/communication-services/quickstarts/access-tokens?pivots=programming-language-csharp) 설명서를 참조하세요.
