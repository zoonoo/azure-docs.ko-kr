...
다양한 도구와 기법을 사용하여 클라우드 서비스의 성능을 테스트할 수 있습니다. 클라우드 서비스를 Azure에 게시할 때 [Azure 응용 프로그램 프로파일링](http://msdn.microsoft.com/ko-kr/library/windowsazure/hh369930.aspx)에 설명된 대로 Visual Studio에서 프로파일링 데이터를 수집하고 로컬에서 분석하게 할 수 있습니다. [Azure에서 성능 카운터 사용](http://www.windowsazure.com/ko-kr/develop/net/common-tasks/performance-profiling)에 설명된 대로 진단을 사용하여 다양한 성능 카운터를 추적할 수도 있습니다. 또한 클라우드에 배포하기 전에 계산 에뮬레이터에서 로컬로 응용 프로그램을 프로파일링할 수 있습니다.
