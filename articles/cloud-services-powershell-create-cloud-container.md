...
1. Microsoft Azure PowerShell cmdlet을 [Azure PowerShell 다운로드](http://go.microsoft.com/?linkid=9811175&clcid=0x409)에서 설치합니다. Azure PowerShell cmdlet 설치 및 Azure 구독에 연결에 대한 추가 지침은 [Azure PowerShell 설치 및 구성하는 방법](install-configure-powershell.md)을 참조하세요.
