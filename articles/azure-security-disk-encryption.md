...
#Windows 및 Linux IaaS VM용 Azure 디스크 암호화 미리 보기

> [AZURE.NOTE]이 문서의 정보는 Azure 디스크 암호화의 미리 보기 버전에 적용됩니다.
...
- Azure 디스크 암호화 사용에 대해 Azure 키 자격 증명을 설정하고 구성하려면 이 문서의 부록에서 **Azure 디스크 암호화 사용에 대한 Azure 키 자격 증명 설정 및 구성** 섹션을 참조하세요.

- Azure Active directory에서 Azure 디스크 암호화 사용에 Azure AD 응용 프로그램을 설정하고 구성하려면 이 문서의 부록에서 **Azure Active Directory에서 Azure AD 응용 프로그램 설치** 섹션을 참조하세요.

- Azure AD 응용 프로그램에 대한 키 자격 증명 모음 액세스 정책을 설정하고 구성하려면 이 문서의 부록에서 **Azure AD 응용 프로그램에 대 한 설정 키 자격 증명 모음 액세스 정책** 섹션을 참조하세요.
...
**참고:** 주요 자격 증명 모음은 VM과 동일한 하위 지역에 있어야 합니다.
