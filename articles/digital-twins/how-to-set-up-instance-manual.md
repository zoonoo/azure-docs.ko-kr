...
>[!TIP]
> 구독 소유자는 모든 새 Azure Digital Twins 인스턴스에 대해 새 앱 등록을 설정 *하거나* , 한 번만 수행 하 고 구독의 모든 Azure Digital twins 인스턴스 간에 공유 되는 단일 앱 등록을 설정할 수 있습니다.
