---
title: 개인 링크를 사용 하 여 개인 액세스 사용 (미리 보기)
titleSuffix: Azure Digital Twins
description: 개인 링크를 사용 하 여 Azure Digital Twins 솔루션에 대 한 개인 액세스를 사용 하도록 설정 하는 방법 참조
author: baanders
ms.author: baanders
ms.date: 1/25/2021
ms.topic: how-to
...
ms.locfileid: "98948817"
---
# <a name="enable-private-access-with-private-link-preview"></a>개인 링크를 사용 하 여 개인 액세스 사용 (미리 보기)
...
인스턴스의 초기 설정 중에 Azure Digital Twins 인스턴스의 개인 끝점을 사용 하 여 개인 링크를 설정 하거나, 이미 있는 인스턴스에서는 나중에 사용 하도록 설정할 수 있습니다. 

이러한 생성 방법 중 하나는 인스턴스에 대해 동일한 구성 옵션과 동일한 최종 결과를 제공 합니다. 이 섹션에서는 [Azure Portal](https://portal.azure.com)에서 각 작업을 수행 하는 방법을 설명 합니다.
...
이 섹션에서는 현재 만들고 있는 Azure Digital Twins 인스턴스에서 개인 끝점으로 개인 링크를 사용 하도록 설정 하는 [Azure Portal](https://portal.azure.com) 을 사용 합니다. 이 섹션에서는 만들기 프로세스의 네트워킹 단계를 중점적으로 설명 합니다. 새 Azure Digital Twins 인스턴스를 만드는 전체 연습은 [*방법: 인스턴스 및 인증 설정*](how-to-set-up-instance-portal.md)을 참조 하세요.
...
이 섹션에서는 [Azure Portal](https://portal.azure.com) 를 사용 하 여 이미 존재 하는 Azure Digital twins 인스턴스의 개인 끝점으로 개인 링크를 사용 하도록 설정 합니다.
...
[Azure Portal](https://portal.azure.com), [Azure CLI](/cli/azure/)또는 [ARMClient 명령 도구](https://github.com/projectkudu/ARMClient)를 사용 하 여 네트워크 플래그의 값을 업데이트할 수 있습니다.

### <a name="option-1-using-the-azure-portal"></a>옵션 1: Azure Portal 사용
...
### <a name="option-2-using-the-azure-cli"></a>옵션 2: Azure CLI 사용

Azure CLI에서이 작업은 `az resource update` 아래와 같이 명령을 사용 하 여 수행 됩니다. Azure Digital Twins 인스턴스의 publicNetworkAccess 속성은 또는로 설정할 수 있습니다 `disabled` `enabled` .

플래그를 사용 하지 않도록 설정 하려면 다음 명령을 사용 하 여 자리 표시자를 인스턴스 값으로 바꿉니다.
...
:::image type="content" source="media/how-to-enable-private-link/network-flag-cli.png" alt-text="위의 Azure CLI 명령을 실행 하는 터미널 창의 스크린샷 출력에는 값이 Disabled 인 publicNetworkAccess 라는 속성을 포함 하 여 인스턴스의 세부 정보가 포함 됩니다." lightbox="media/how-to-enable-private-link/network-flag-cli.png":::

플래그를 사용 하도록 설정 하려면 다음과 유사한 명령을 사용 합니다.
...
### <a name="option-3-usingarmclient"></a>옵션 3: ARMClient 사용  
