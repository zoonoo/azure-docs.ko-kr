...
- [서비스 주체에 대한 개체 ID를 가져오는](https://docs.microsoft.com/powershell/module/azurerm.resources/get-azurermadserviceprincipal?view=azurermps-6.8.1) 방법.
