...
Azure Digital Twins 보안을 사용하면 IoT 그래프에서 특정 리소스 및 작업에 대한 액세스 권한을 세밀하게 지정할 수 있습니다. 이는 [역할 기반 액세스 제어](./security-role-based-access-control.md)라는 세부적인 역할 및 권한 관리를 통해 수행 됩니다.
