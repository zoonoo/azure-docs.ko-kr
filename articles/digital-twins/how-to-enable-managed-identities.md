---
title: 라우팅 이벤트에 대해 관리 id 사용 (미리 보기)
titleSuffix: Azure Digital Twins
description: Azure Digital Twins에 대해 시스템 할당 id를 사용 하도록 설정 하 고 이벤트를 전달 하는 데 사용 하는 방법을 참조 하세요.
author: baanders
ms.author: baanders
ms.date: 1/21/2021
ms.topic: how-to
...
ms.locfileid: "98948877"
---
# <a name="enable-a-managed-identity-for-routing-azure-digital-twins-events-preview"></a>Azure 디지털 쌍 이벤트 라우팅 (미리 보기)에 대 한 관리 id 사용
...
이 섹션에서는 [Azure Portal](https://portal.azure.com) 사용 하 여 이미 존재 하는 Azure Digital twins 인스턴스에 시스템 관리 id를 추가 합니다.
