...
클라이언트 앱에서 서비스로 쿼리를 제출 하려면 Azure Digital Twins **쿼리 API**를 사용 합니다. 이를 통해 개발자는 쿼리를 작성 하 고 필터를 적용 하 여 쌍 그래프에서 디지털 쌍 집합을 찾을 수 있으며, Azure digital 쌍 시나리오에 대 한 기타 정보를 찾을 수 있습니다.
