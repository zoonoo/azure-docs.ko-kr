...
이 작업을 수행 하는 데 도움이 되도록 NuGet: [**DigitalTwins**](https://nuget.org/packages/Microsoft.Azure.DigitalTwins.Parser/)에 .net 클라이언트 쪽 dtdl 구문 분석 라이브러리가 제공 됩니다. 파서 라이브러리를 c # 코드에서 직접 사용 하거나, 파서 라이브러리: [**Dtdl Validator 샘플**](https://docs.microsoft.com/samples/azure-samples/dtdl-validator/dtdl-validator)에서 빌드된 언어 독립적인 코드 샘플 프로젝트를 사용할 수 있습니다.
