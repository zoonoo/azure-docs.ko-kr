...
장치에서 원격 분석 데이터를 Azure Digital Twins로 전송 하 고 나면 개발자는 *유효성 검사*, *일치*, *계산*및 *디스패치*의 네 단계로 데이터를 처리할 수 있습니다.
...
Azure Digital twins의 데이터 처리는 *선택기*, *사용자 정의 함수*및 *역할 할당*의 세 가지 개체를 정의 하는 것으로 구성 됩니다.
