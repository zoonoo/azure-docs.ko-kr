...
* **Java** SDK를 사용할 수 있습니다. Java SDK를 사용 하려면 ...
   ...
   - [SDK 참조 설명서](https://docs.microsoft.com/java/api/overview/azure/digitaltwins/client?view=azure-java-preview&preserve-view=true) 를 볼 수 있습니다.
