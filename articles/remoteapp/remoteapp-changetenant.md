...
<properties
    pageTitle="Azure RemoteApp에서 Azure Active Directory 테넌트 변경 | Microsoft Azure"
...
4. **새로 만들기 > 앱 서비스 > Active Directory > 디렉터리 > 사용자 지정 만들기**를 클릭합니다.
...
5. 다시 로그인하여 **설정 -> 구독**으로 다시 이동합니다. 구독을 선택한 다음 **디렉터리 편집**을 클릭합니다. 사용하려는 Azure AD 테넌트를 선택합니다.
