...
Azure RemoteApp은 Windows Server 2012 R2 이미지를 사용하여 사용자와 공유할 모든 프로그램을 호스트합니다. 사용자 지정 RemoteApp 이미지를 만들려면, 기존 이미지로 시작하거나 [새 이미지](remoteapp-create-custom-image.md)를 만듭니다. Azure RemoteApp과 사용하기 위해 업로드할 수 있는 이미지의 요구 사항은 다음과 같습니다.
...
- 원격 데스크톱 연결 브로커 역할은 설치되지  *않아야* 합니다.
