...
* **Azure RemoteApp이란?** RemoteApp은 다양한 사용자 장치에서 응용 프로그램에 안전하게 원격으로 액세스할 수 있는 Azure 서비스입니다. [Azure RemoteApp](remoteapp-whatis.md)에 대해 더 알아봅니다.
...
* **사용자 의견을 제출하려면 어떻게 해야 하나요?** [피드백 포럼](https://feedback.azure.com/forums/247748-azure-remoteapp/)에 대해 더 알아봅니다.
