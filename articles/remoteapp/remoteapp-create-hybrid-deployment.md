...
3. 컬렉션을 만듭니다.
4. 컬렉션을 로컬 도메인에 연결합니다.
5. 템플릿 이미지를 컬렉션에 추가합니다.
6. 디렉터리 동기화를 구성합니다. RemoteApp은 1) 암호 동기화 옵션을 포함하여 Azure Active Directory 동기화를 구성하거나 2) 암호 동기화 옵션을 포함하지 않지만 AD FS로 페더레이션되는 도메인을 사용하여 Azure Active Directory 동기화를 구성하는 방식으로 Azure Active Directory와 통합해야 합니다. [RemoteApp과 함께 Active Directory에 대한 구성 정보](remoteapp-ad.md)를 확인합니다.
...
### <a name="create-an-azure-vnet-and-join-it-to-your-active-directory-deployment"></a>Azure VNET을 만들고 Active Directory 배포에 조인
...
뭔가 잘못된 경우 [하이브리드 컬렉션 문제 해결 정보](remoteapp-hybridtrouble.md)를 확인하세요.

## <a name="step-3-link-your-collection-to-the-local-domain"></a>3단계: 로컬 도메인에 컬렉션 가입
...
## <a name="step-4-link-to-an-azure-remoteapp-image"></a>4단계: Azure RemoteApp 이미지에 연결
