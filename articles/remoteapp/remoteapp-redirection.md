...
장치 리디렉션을 사용하면 사용자가 로컬 컴퓨터, 휴대폰 또는 태블릿에 연결된 장치를 통해 원격 앱을 조작할 수 있습니다. 예를 들어 RemoteApp을 통해 Skype를 제공한 경우 사용자가 Skype를 사용하려면 PC에 카메라가 설치되어 있어야 합니다. 프린터, 스피커, 모니터 및 USB로 연결된 다양한 주변 장치의 경우도 마찬가지입니다.
