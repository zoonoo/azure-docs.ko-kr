---
title: Azure RemoteApp용 사용자 지정 템플릿 이미지를 만드는 방법 | Microsoft Docs
...
6. 응용 프로그램을 설치하고 구성합니다. 공유 앱을 만들려면 공유하려는 앱 또는 프로그램을 이미지의 **시작** 메뉴(**%systemdrive%\\ProgramData\\Microsoft\\Windows\\Start Menu\\Programs)에 추가합니다.
