...
<properties 
    pageTitle="사용자 지정 이미지 업로드"
    description="RemoteApp에 대한 사용자 지정 이미지를 업로드하는 방법을 알아봅니다." 
    services="remoteapp" 
...
1.      사용자 지정 이미지가 [이미지 요구사항](..\remoteapp-imagereqs) 및 [응용 프로그램 요구사항](..\remoteapp-appreqs).을 충족하는지 확인합니다.
2.      [Azure PowerShell 모듈](../install-configure-powershell.md)을 설치합니다.
...
**경고:**  업로드 스크립트를 수정하지 마십시오. 이미지가 이미지 요구 사항 및 응용 프로그램 요구사항을 충족하는지 확인하도록 특정 검사가 구현됩니다.
