---
title: "Azure RemoteApp을 사용하여 모든 장치에서 Windows 앱 실행 | Microsoft Docs"
...
## <a name="configure-access-to-access"></a>Access에 대한 액세스 구성
...
3. 이제 RemoteApp에서 파일 탐색기 앱을 시작합니다. 공유 앱에서 사용할 Access 파일을 파일 공유에 복사합니다.
   ![Azure 공유에 Access 파일 넣기](./media/remoteapp-anyapp/ra-anyappuseraccess.png)
4. 마지막으로 Access를 열고 방금 공유한 데이터베이스를 엽니다. 클라우드에서 실행 중인 Access의 데이터가 표시됩니다.
