...
1. 먼저 <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">Twitter 개발자</a> 웹 사이트로 이동하고 Twitter 계정 자격 증명으로 로그인하고 **Create a new application**을 클릭합니다.
