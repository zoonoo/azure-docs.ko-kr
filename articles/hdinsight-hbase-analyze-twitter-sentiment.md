<properties urlDisplayName="Analyze realt-time Twitter sentiment with Hbase in HDInsight" pageTitle="HDInsight에서 HBase를 사용하여 Twitter 데이터 실시간 분석 | Azure" metaKeywords="" description="HDInsight(Hadoop) 클러스터에서 HBase를 사용하여 빅 데이터를 실시간으로 데이터 분석하는 방법에 대해 알아봅니다." metaCanonical="" services="hdinsight" documentationCenter="" title="HDInsight에서 HBase를 사용하여 Twitter 데이터 실시간 분석" authors="jgao" solutions="big-data" manager="paulettm" editor="cgronlun" />
...
전체 Visual Studio 솔루션 샘플은 <https://github.com/maxluk/tweet-sentiment>에서 확인할 수 있습니다.
...
-   **HDInsight의 HBase 클러스터**. 클러스터 프로비전 지침은 [HDInsight에서 Hadoop을 통해 HBase 사용 시작][HDInsight에서 Hadoop을 통해 HBase 사용 시작]을 참조하세요. 자습서를 완료하려면 다음 데이터가 필요합니다.
    ...
    | 클러스터 속성        | 설명                                                                                                |
    |----------------------|-----------------------------------------------------------------------------------------------------|
    | HBase 클러스터 이름  | HDInsight HBase 클러스터 이름입니다. 예를 들면 다음과 같습니다. https://myhbase.azurehdinsight.net/ |
...
3.  **Name**, **Description**, **Website**를 입력합니다. 웹 사이트 필드는 실제로 사용되지는 않으므로 유효한 URL을 입력하지 않아도 됩니다. 다음 표는 사용할 샘플 값을 보여 줍니다.
    ...
    | 필드      | 값                                 |
    |-----------|------------------------------------|
    | 이름      | MyHDInsightHBaseApp                |
    | 설명      | MyHDInsightHBaseApp                |
    | 웹 사이트 | http://www.myhdinsighthbaseapp.com |
...
**Visual Studio 솔루션을 만들려면 다음 단계를 수행합니다.**
...
2.  다음 명령을 사용하여 Twitter API에 액세스하는 데 사용되는 [Tweetinvi][Tweetinvi] 패키지와 개체를 직렬화/역직렬화하는 데 사용되는 [Protobuf-net][Protobuf-net] 패키지를 설치합니다.
    ...
    > [WACOM.NOTE] Microsoft Hbase SDK Nuget 패키지는 2014년 8월 26일 현재 제공되지 않습니다. 이 패키지의 Github 리포지토리는 <https://github.com/hdinsight/hbase-sdk-for-net>입니다. SDK가 제공될 때까지는 dll을 직접 작성해야 합니다. 해당 지침은 [HDInsight에서 Hadoop을 통해 HBase 사용 시작][HDInsight에서 Hadoop을 통해 HBase 사용 시작]을 참조하세요.
...
1.  <https://github.com/maxluk/tweet-sentiment>로 이동합니다.
2.  **ZIP 다운로드**를 클릭합니다.
3.  로컬에서 파일의 압축을 풉니다.
...
## <span id="web"></span></a> Twitter 데이터 시각화를 위한 Azure 웹 사이트 만들기
...
6.  **Windows Azure**에서 **구독 관리**를 클릭합니다.
7.  **Windows Azure 구독 관리**에서 **로그인**을 클릭합니다.
8.  Azure 자격 증명을 입력합니다. 그러면 계정 탭에 Azure 구독 정보가 표시됩니다.
9.  **닫기**를 클릭하여 Windows Azure 구독 관리 창을 닫습니다.
10. **새 ASP.NET 프로젝트 - TweetSentimentWeb**에서 **확인**을 클릭합니다.
11. **Windows Azure 사이트 설정 구성**에서 현재 위치와 가장 인접한 **지역**을 선택합니다. 데이터베이스 서버는 지정하지 않아도 됩니다.
12. **확인**을 클릭합니다.
...
2.  다음 명령을 사용하여 개체를 직렬화/역직렬화하는 데 사용되는 [Protobuf-net][Protobuf-net] 패키지를 설치합니다.
    ...
    > [WACOM.NOTE] Microsoft Hbase SDK Nuget 패키지는 2014년 8월 20일 현재 제공되지 않습니다. 이 패키지의 Github 리포지토리는 <https://github.com/hdinsight/hbase-sdk-for-net>입니다. SDK가 제공될 때까지는 dll을 직접 작성해야 합니다. 해당 지침은 [HDInsight에서 Hadoop을 통해 HBase 사용 시작][HDInsight에서 Hadoop을 통해 HBase 사용 시작]을 참조하세요.
...
4.  다음 코드를 복사하여 파일에 붙여 넣습니다. 이 코드는 Alastair Aitchison이 작성한 것입니다. 자세한 내용은 <http://alastaira.wordpress.com/2011/04/15/bing-maps-ajax-v7-heatmap-library/>를 참조하세요.
