...
* RDS 참가자는 모든 항목을 관리할 수 있지만 리소스에는 액세스할 수 없습니다.
...
Windows 가상 데스크톱 환경을 설정 하는 방법에 대 한 지침은 [Windows 가상 데스크톱 환경](environment-setup-2019.md)을 참조 하세요.
