---
title: 서비스 연결 문제 해결 Windows Virtual Desktop(클래식) - Azure
description: Windows Virtual Desktop(클래식) 테넌트 환경에서 클라이언트 연결을 설정할 때 발생하는 문제를 해결하는 방법입니다.
author: Heidilohr
...
ms.locfileid: "106444193"
---
# <a name="windows-virtual-desktop-classic-service-connections"></a>Windows Virtual Desktop(클래식) 서비스 연결
