...
1. Azure 리소스로 이동 하 여 템플릿에서 제공한 이름 (예: Apr3UX)으로 Azure 앱 Services 리소스를 선택 하 고 연결 된 URL로 이동 합니다. 예를 <https://rdmimgmtweb-210520190304.azurewebsites.net>들면입니다.
