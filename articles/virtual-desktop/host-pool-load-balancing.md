...
>[!IMPORTANT]
>깊이 우선 부하 분산 알고리즘은 세션 호스트에 최대 세션 호스트 제한에 따라 세션을 배포 합니다. 이 매개 변수는 깊이 우선 부하 분산 알고리즘을 사용 하는 경우에 필요 합니다. 가능한 최상의 사용자 환경을 위해 사용자 환경에 가장 적합 한 숫자로 최대 세션 호스트 제한 매개 변수를 변경 해야 합니다.