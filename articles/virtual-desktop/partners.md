...
Citrix는 Azure에서 가상 앱 및 데스크톱 워크 로드의 중앙 집중식 하이브리드 관리를 온-프레미스 배포와 나란히 제공 하는 승인 된 공급자입니다. 가상 앱 및 데스크톱 서비스를 사용 하는 Citrix 작업 영역을 통해 사용자는 모든 장치에서 앱 및 데스크톱에 액세스할 수 있으므로 고급 Citrix HDX 프로토콜을 활용 하 여 어디에서 든 높은 정의 환경을 제공할 수 있습니다.

Citrix는 사용자 밀도와 성능을 향상 시키고, 주문형 워크 로드를 프로 비전 하 고, 이미지 및 응용 프로그램 관리를 간소화 하기 위해 강력한 엔터프라이즈 도구를 사용 하 여 Windows 가상 데스크톱의 가치를 확장 합니다. 지능형 크기 조정 도구를 사용 하 여 비용을 최적화할 수 있으며, 산업 전반에 걸친 응용 프로그램에 대해 필드 테스트를 거친 뛰어난 최종 사용자 환경을 제공 합니다.
