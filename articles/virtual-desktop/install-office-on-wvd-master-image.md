...
- 월간 채널에서 Office를 설치 하 고 실행 되는 월간 채널에서 업데이트를 제공 합니다.
- X64 아키텍처를 사용 합니다.
- 자동 업데이트를 사용 하지 않습니다.
...
2. 다음 링크를 사용 하 여 OneDriveSetup를 스테이징 위치로 다운로드 합니다. <https://aka.ms/OneDriveWVD-Installer>
