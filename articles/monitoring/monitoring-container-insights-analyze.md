...
컨테이너용 Azure Monitor를 사용하도록 설정하는 방법은 [컨테이너용 Azure Monitor 등록](monitoring-container-insights-onboard.md)을 참조하세요.
...
![Azure Monitor 다중 클러스터 대시보드 예제](./media/monitoring-container-insights-analyze/azmon-containers-multiview.png)
...
![클러스터 탭의 예제 성능 차트](./media/monitoring-container-insights-analyze/containers-cluster-perfview.png)
...
![Kubernetes 큐브 뷰 속성 창 예제](./media/monitoring-container-insights-analyze/perspectives-preview-pane-01.png)
...
![필터를 사용하여 결과를 좁히는 예제](./media/monitoring-container-insights-analyze/add-filter-option-01.png)
...
![데이터 필터링에 대한 백분위 선택 영역](./media/monitoring-container-insights-analyze/containers-metric-percentile-filter.png)

다음 예제에서는 *aks-nodepool1-* 노드의 **컨테이너** 값이 14이며, 이것은 배포된 전체 컨테이너 수를 롤업한 값입니다.

![노드당 컨테이너 롤업 예제](./media/monitoring-container-insights-analyze/containers-nodes-containerstotal.png)
...
![컨트롤러 보기 선택](./media/monitoring-container-insights-analyze/containers-controllers-tab.png)
...
| 아이콘 | 상태 | 
|--------|-------------|
| ![실행이 준비됨 상태 아이콘](./media/monitoring-container-insights-analyze/containers-ready-icon.png) | 실행 중(준비됨)|
| ![대기 중 또는 일시 중지됨 상태 아이콘](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | 대기 중 또는 일시 중지됨|
| ![마지막으로 보고된 실행 중 상태 아이콘](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | 하지만 마지막으로 보고된 실행 중 상태는 30분 넘게 응답되지 않았습니다.|
| ![성공 상태 아이콘](./media/monitoring-container-insights-analyze/containers-green-icon.png) | 성공적으로 중지됨 또는 중지하지 못함|
...
![컨테이너 보기 선택](./media/monitoring-container-insights-analyze/containers-containers-tab.png)
...
| ![대기 중 또는 일시 중지됨 상태 아이콘](./media/monitoring-container-insights-analyze/containers-waiting-icon.png) | 대기 중 또는 일시 중지됨|  
| ![마지막으로 보고된 실행 중 상태 아이콘](./media/monitoring-container-insights-analyze/containers-grey-icon.png) | 하지만 마지막으로 보고된 실행 중 상태는 30분 넘게 응답되지 않았습니다.|  
| ![종료됨 상태 아이콘](./media/monitoring-container-insights-analyze/containers-terminated-icon.png) | 성공적으로 중지됨 또는 중지하지 못함|  
| ![실패 상태 아이콘](./media/monitoring-container-insights-analyze/containers-failed-icon.png) | 실패 상태 |  
...
![Log Analytics에서 데이터 분석](./media/monitoring-container-insights-analyze/container-health-log-search-example.png)   
