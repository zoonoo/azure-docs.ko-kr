...
![OMSIngestionAPI 모듈](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![Runbook 편집](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![Runbook 테스트](media/monitoring-runbook-datacollect/test-runbook.png)
...
4. Log Analytics에 대한 POST 명령 출력에 오류가 표시되지 않는지 확인합니다.  다음과 유사한 메시지가 표시됩니다.
    ...
    ![POST 출력](media/monitoring-runbook-datacollect/post-output.png)
...
![로그 출력](media/monitoring-runbook-datacollect/log-output.png)
...
![Runbook 게시](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![로깅 및 추적](media/monitoring-runbook-datacollect/logging.png)
...
![Runbook 예약](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
![교육](media/monitoring-runbook-datacollect/jobs.png)
...
5. 아래 이미지와 유사한 항목을 찾을 때까지 아래쪽으로 스크롤합니다.<br>![자세한 정보 표시](media/monitoring-runbook-datacollect/verbose.png)
...
- Runbook을 [관리 솔루션](monitoring-solutions-creating.md)으로 패키지하여 고객에게 배포합니다.
