...
![컨테이너용 Azure Monitor에 액세스하는 방법에 대한 개요](./media/monitoring-container-insights-overview/azmon-containers-views.png)
...
AKS 클러스터 모니터링을 시작하려면 [컨테이너용 Azure Monitor를 등록하는 방법](monitoring-container-insights-onboard.md)을 검토하여 모니터링 사용을 위한 요구 사항과 사용 가능한 방법을 파악하세요.  