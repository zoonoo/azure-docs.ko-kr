...
- [서비스 버스 소개](http://azure.microsoft.com/services/service-bus/)
 
## 빌드

- [메시징 엔터티 분할](service-bus-partitioning.md)
- [서비스 버스 항목](service-bus-dotnet-how-to-use-topics-subscriptions.md)
- [Linux 및 Windows에서 Azure 서비스 버스와 Apache Qpid Proton C 사용](http://msdn.microsoft.com/library/dn235560.aspx) 
