<properties 
	pageTitle="클라우드에 수많은 항목 연결 | Microsoft Azure" 
...
현대의 기술 생태계에서 스마트하고 연결된 "항목"이 점점 더 증가하고 있습니다. 자동차, 집, 인프라 및 어플라이언스의 센서가 제품 품질 향상, 서비스 확장, 새로운 고객 참여 모델을 제공할 수 있는 새로운 기회를 창출하고 있습니다. Microsoft Azure 서비스 버스 및 이벤트 허브는 이렇게 새롭게 등장한 "사물 인터넷"을 연결하는 데 도움을 줄 수 있습니다.
...
- [서비스 버스 항목](service-bus-dotnet-how-to-use-topics-subscriptions.md)
- [Linux 및 Windows에서 Azure 서비스 버스와 Apache Qpid Proton C 설치](service-bus-amqp-apache.md) 
...
- [사물 인터넷(Microsoft 블로그 게시물 알림)](http://blogs.microsoft.com/iot/2015/03/16/microsoft-announces-azure-iot-suite)
