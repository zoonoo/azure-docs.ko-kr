...
이전 예제를 사용하여 저장소1에서 오는 메시지를 필터하려면 대시보드 구독을 다음과 같이 만듭니다.
...
- [서비스 버스 조정된 메시징 .NET 자습서](https://msdn.microsoft.com/library/azure/hh367512.aspx)
- [이벤트 허브 개발자 가이드](../event-hubs-programming-guide.md)
