...
이 샘플을 빌드하기 전에 [Azure SDK for Java][]를 설치했는지 확인하십시오. Eclipse를 사용하는 경우 Azure SDK for Java를 포함하고 있는 [Eclipse용 Azure Toolkit][]를 설치할 수 있습니다. 그런 다음 **Java용 Microsoft Azure 라이브러리**를 프로젝트에 추가할 수 있습니다.![](media/service-bus-java-how-to-use-queues/eclipselibs.png)
