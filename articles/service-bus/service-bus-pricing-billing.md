---
title: 서비스 버스 가격 및 대금 청구 | Microsoft Docs
...
> [!NOTE]
> 최신 서비스 버스 가격 책정에 대한 자세한 내용은 [Azure 서비스 버스 가격 책정 페이지](https://azure.microsoft.com/pricing/details/service-bus/) 및 [서비스 버스 FAQ](../service-bus-messaging/service-bus-faq.md#service-bus-pricing)를 참조하세요.
> 
> 
...
> [!NOTE]
> 프리미엄 계층은 현재 미리 보기 상태이며 다음 가격은 50% 미리 보기 할인을 반영합니다.
> 
> 
...
> [!NOTE]
> 1,000개의 조정된 연결이 표준 메시징 계층에 포함되며(기본 요금) 관련 Azure 구독 내의 모든 큐, 토픽/구독과 Event Hubs 전체에서 공유할 수 있습니다.
> 
> [!NOTE]
