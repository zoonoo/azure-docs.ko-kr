...
이로 인해 예측 가능성 및 가용성도 높아질 뿐 아니라 속도도 더 빨라집니다. Azure 서비스 버스 프리미엄 메시징은 [Azure 이벤트 허브](https://azure.microsoft.com/services/event-hubs/)에 도입된 저장소 엔진 위에 구축됩니다. 프리미엄 메시징을 사용할 경우 표준 계층보다 최고 성능이 훨씬 더 빠릅니다.
