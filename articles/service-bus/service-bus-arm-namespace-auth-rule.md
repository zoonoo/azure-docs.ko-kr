<properties
    pageTitle="ARM 템플릿을 사용하여 서비스 버스 권한 부여 규칙 만들기 | Microsoft Azure"
    description="ARM 템플릿을 사용하여 네임스페이스 및 큐에 대한 서비스 버스 권한 부여 규칙 만들기"
...
# ARM 템플릿을 사용하여 네임스페이스 및 큐에 대한 서비스 버스 권한 부여 규칙 만들기

이 문서에서는 서비스 버스 네임스페이스 및 큐에 대한 권한 부여 규칙을 만드는 ARM(Azure Resource Manager) 템플릿을 사용하는 방법을 보여 줍니다. 어떤 리소스를 배포할지 정의하는 방법 및 배포를 실행할 때 매개 변수를 지정하는 방법을 알게 됩니다. 배포를 위해 이 템플릿을 사용하거나 요구 사항에 맞게 사용자 지정을 할 수 있습니다.
...
>-    [토픽 및 구독이 있는 서비스 버스 네임스페이스 만들기](service-bus-arm-namespace-topic.md)
...
[![Azure에 배포](./media/service-bus-arm-namespace-auth-rule/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F301-servicebus-create-authrule-namespace-and-queue%2Fazuredeploy.json)로 바꿉니다.
