...
**안내**: Azure Data Explorer는 가상 네트워크의 서브넷에 클러스터 배포를 지원합니다. 이 기능을 사용하면 Azure Data Explorer 클러스터 트래픽에 NSG(네트워크 보안 그룹) 규칙을 적용하고, 온-프레미스 네트워크를 Azure Data Explorer 클러스터의 서브넷에 연결하고, 데이터 연결 소스(이벤트 허브 및 이벤트 그리드)를 보호할 수 있습니다. 서비스 끝점.
...
Kusto 쿼리를 사용하여 Azure 데이터 탐색기의 보안 역할 관리:https://docs.microsoft.com/azure/kusto/management/security-roles
...
사용자 인증(대화형 로그온): 사용자 보안 주체를 인증하는 데 사용됩니다.

응용 프로그램 인증(비대화형 로그온): 사용자가 없는 경우 실행/인증해야 하는 서비스 및 응용 프로그램을 인증하는 데 사용됩니다.

Azure 데이터 탐색기 액세스 제어 개요:https://docs.microsoft.com/azure/kusto/management/access-control

Azure Active 디렉터리로 인증:https://docs.microsoft.com/azure/kusto/management/access-control/aad
...
Azure 데이터 탐색기 액세스에 대한 Azure AD로 인증하는 방법:https://docs.microsoft.com/azure/kusto/management/access-control/how-to-authenticate-with-aad
...
스토리지로 데이터 내보내기:https://docs.microsoft.com/azure/kusto/management/data-export/export-data-to-storage
