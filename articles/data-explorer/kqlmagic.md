...
> [!TIP]
> 모든 사용 가능한 구성 사용에 대 한 정보를 받을 `%config KQLmagic`합니다. 문제를 해결 하 고 Kusto 오류, 연결 문제 등 잘못 된 쿼리 캡처를 사용 하 여 `%config Kqlmagic.short_errors=False`
