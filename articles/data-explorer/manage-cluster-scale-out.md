...
클러스터로 이동 합니다. 아래 **설정을**를 선택 **확장할**합니다. **구성** 아래에서 **자동 크기 조정 사용**을 선택합니다.

![자동 크기 조정 사용](media/manage-cluster-scaling/enable-autoscale.png)

다음은 다음 몇 단계의 흐름을 보여 주는 그래픽입니다. 자세한 내용은 그래픽 다음과 같습니다.

![크기 조정 규칙](media/manage-cluster-scaling/scale-rule.png)

1. 에 **자동 크기 조정 설정 이름** 상자에 같은 이름을 제공 *스케일 아웃: 캐시 사용률*합니다.

1. 에 대 한 **크기 조정 모드**를 선택 **메트릭에 따라 크기 조정**합니다. 이 모드는 동적 확장을 제공 합니다. 선택할 수도 있습니다 **특정 인스턴스 수로 크기 조정**합니다.
