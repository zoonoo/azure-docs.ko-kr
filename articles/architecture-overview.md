...
##3D 청사진 Visio 템플릿
[Microsoft 아키텍처 청사진](http://aka.ms/azblueprints) 3D 버전은 타사 도구에서 최초로 개발되었지만 2015년 8월 5일부터 [EDX.ORG에 배포된 Microsoft 아키텍처 인증 과정](#microsoft-architecture-certification-course)의 일부로 새로운 Visio 2013 템플릿이 제공되었습니다.
