...
> [!IMPORTANT]  
> 리소스 공급자 설치 관리자를 실행 하기 전에의 지침을 따랐는지 확인 [시작 하기 전에](azure-stack-app-service-before-you-get-started.md) 읽었다고 합니다 [릴리스](azure-stack-app-service-release-notes-update-five.md) 1.5와 함께 제공 되는 릴리스 알아봅니다 새 기능, 수정 및 배포에 영향을 줄 수 있는 알려진된 문제가 있습니다.
