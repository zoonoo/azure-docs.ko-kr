...
<!-- 2332636 - IS -->  
- AD FS를 사용 하 여 Azure Stack의이 버전으로 업데이트 확인 하 고 Azure Stack id 시스템에 대 한 기본 제공 기본 공급자 구독의 기본 소유자 재설정 됩니다 **CloudAdmin** 사용자입니다.  
...
<!-- 2096388 IS --> 
- 네트워크 보안 그룹 규칙을 업데이트 하는 관리 포털을 사용할 수 없습니다.
...
<!-- IS, ASDK --> 
- 공간 및 마침표를 포함 하 여 특수 문자를 사용할 수 없습니다는 **제품군** 또는 **계층** SQL 및 MySQL 리소스 공급자에 대 한 SKU를 만들 때 이름을 지정 합니다.

<!-- TBD - IS --> 
> [!NOTE]  
> Azure Stack 1805를 업데이트 한 후에 이전에 배포한 SQL 및 MySQL 리소스 공급자를 사용 하도록 계속 수 있습니다.  새 릴리스를 사용할 수 있을 때 SQL 및 MySQL를 업데이트 하는 것이 좋습니다. 예: Azure Stack에 SQL 및 MySQL 리소스 공급자 업데이트를 순차적으로 적용 됩니다. 예를 들어, 버전 1803에서 사용 하는 경우 먼저 버전 1804에서를 적용 하 고 1805로 업데이트 합니다.      
>   
