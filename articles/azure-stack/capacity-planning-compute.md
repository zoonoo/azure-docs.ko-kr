...
Azure에서 여러 오류 도메인 간에 분산 하기 위해 가용성 집합에 다중 VM 프로덕션 시스템의 고가용성을 달성 하기 위해 Vm 배치 됩니다. Azure Stack에서 가용성 집합의 장애 도메인은 배율 단위에서 단일 노드도 정의 됩니다.
