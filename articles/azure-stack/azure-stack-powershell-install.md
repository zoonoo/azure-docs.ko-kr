...
이 문서에 Azure 스택에 대 한 PowerShell을 설치 하는 지침을 설명 합니다. 그러나 신속 하 게 설치 하 고 PowerShell을 구성 하려는 경우 스크립트에서 제공 되는 사용할 수는 [PowerShell과 함께 시작 하 고 실행할](azure-stack-powershell-configure-quickstart.md) 항목입니다. 
