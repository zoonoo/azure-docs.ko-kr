...
사용자가 Microsoft Azure 스택에 대 한 클라우드 연산자 (공급자) 및 테 넌 트 (소비자) 형식 이라는 두 가지 있습니다.

* A **클라우드 연산자** Azure 스택 구성 및 제공, 계획, 서비스, 할당량 및 가격 해당 테 넌 트에 대 한 리소스를 제공 하기를 관리할 수 있습니다.  클라우드 운영자는 또한 용량 관리 하 고 경고에 응답 합니다.  
