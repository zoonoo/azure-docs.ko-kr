...
- 인증서 pfx 암호는 복잡 한 암호를 사용 해야 합니다. 다음 암호 복잡성 요구 사항을 충족 하는 암호를 만듭니다. 8 개 문자의 최소 길이입니다. 암호를 포함 하는 다음의 세 가지 이상을: 대문자 문자, 소문자, 숫자 0-9, 특수 문자를 대문자 또는 소문자 알파벳 문자입니다. 이 암호를 기록해 둡니다. 배포 매개 변수로 사용 됩니다.
