...
| ![Alfresco Community](media/azure-stack-marketplace-azure-items/alfrescocommunity.png) | [Alfresco Community](https://azuremarketplace.microsoft.com/marketplace/apps/bitnami.alfrescocommunity) | 문서를 손쉽게 관리를 위한 ECM 시스템입니다. | Bitnami |
...
| ![Chef 자동화](media/azure-stack-marketplace-azure-items/chefautomate.png) | [Chef 자동화](https://azuremarketplace.microsoft.com/marketplace/apps/chef-software.chef-automate) | 빌드, 배포 및 사용 하 여 Chef 자동화 연속 자동화 플랫폼 관리 합니다. <b>Chef 마켓플레이스 항목을 모두 다운로드</b> | Chef Software, Inc |
