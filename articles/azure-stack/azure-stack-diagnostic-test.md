...
테스트-azurestack의 경우 cmdlet은 공통 매개 변수를 지원 합니다: Verbose, Debug, ErrorAction, ErrorVariable, WarningAction, WarningVariable, OutBuffer, PipelineVariable, 및 OutVariable 합니다. 자세한 내용은 [에 대 한 일반 매개 변수](https://go.microsoft.com/fwlink/?LinkID=113216)합니다. 
