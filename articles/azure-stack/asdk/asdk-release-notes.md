...
<!--3463840 - IS, ASDK --> 
- 공용 VIP 네트워크에서 액세스할 수 없는 파일 서버 인해 실패 하는 인프라 백업 사용 하 여 문제를 해결 했습니다. 이 문제가 해결 공개 인프라 네트워크에 인프라 백업 서비스를 다시 이동합니다. 이 문제를 해결 하는 1809 용 최신 Azure Stack 핫픽스를 적용 한 경우 1811 업데이트 추가 수정은 수 없습니다. 
