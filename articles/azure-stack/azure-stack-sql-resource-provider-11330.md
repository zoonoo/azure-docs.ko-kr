...
- **SQL 리소스 공급자에 대 한 포털 확장 잘못 된 구독을 선택할 수 있습니다**합니다. SQL 리소스 공급자는 다르게를 사용 하려면 첫 번째 서비스 관리자 구독을 확인 하려면 Azure Resource Manager 호출을 사용 합니다 *기본 공급자 구독*합니다. 이런 경우, SQL 리소스 공급자를 정상적으로 작동 하지 않습니다. 

- **SQL 호스팅 서버 호스팅된 데이터베이스를 나열 하지 않습니다.** SQL 호스팅 서버에 대 한 테 넌 트 리소스를 볼 때 사용자가 만든 데이터베이스를 나열 될 수 있습니다.
