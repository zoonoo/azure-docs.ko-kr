...
- **서명 알고리즘**합니다. 서명 알고리즘 s h a 1이 아닌지 확인 
...
- CertChecker (PartnerToolKit \utils\certchecker 아래)에
- SSL 인증서 내보낸 다음는 [준비 지침은](prepare-pki-certs.md)
- DeploymentData.json
