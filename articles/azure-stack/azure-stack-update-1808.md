...
- Azure Stack 1808 업데이트를 적용 하기 전에 Azure Stack 1807 업데이트를 설치 합니다. 

- 사용 가능한 최신 업데이트로 또는 1807 버전에 대 한 핫픽스를 설치 합니다.  
  > [!TIP]  
...
- Azure Stack에서 System Center Operations Manager (SCOM)을 관리 되는 경우에 1808 적용 하기 전에 10.0.3.11 버전으로 Microsoft Azure Stack 용 관리 팩을 업데이트 해야 합니다.
...
- [KB 4481066 – Azure Stack 핫픽스 Azure Stack 핫픽스 1.1808.9.117](https://support.microsoft.com/help/4481066/)
...
- 반복적으로 나타나고 나타났다가 사라집니다 Azure Stack 시스템에 다음 경고가 표시 될 수 있습니다.
  ...
  최신에서이 문제를 해결할 [1808 핫픽스 릴리스](https://support.microsoft.com/help/4481066/), 문제가 발생 하면이 핫픽스를 설치 해야 합니다.
...
<!-- 3099544 – IS, ASDK --> 
- Azure Stack 포털을 사용 하 여 새 VM을 만들고 VM 크기를 선택 하는 경우 u s D/월 열이 함께 표시 됩니다는 **사용할 수 없습니다** 메시지입니다. 이 열이 나타나지 않아야 합니다. 표시 된 VM 가격 책정 열에서에서 지원 되지 않습니다 Azure Stack.
