...
- <!-- 3060156 - IS ASDK --> 포털 설정을 클릭 하 고 선택 하면 관리자와 사용자 포털 **모든 설정 및 개인 대시보드 삭제** 예상 대로 작동 하지 않습니다. 오류 알림이 표시 됩니다. 

- <!-- 2930799 - IS ASDK --> 관리자와 사용자 포털에서 아래 **모든 서비스**, 자산 **DDoS 보호 계획** 올바르게 나열 됩니다. Azure Stack에서 실제로 사용할 수 없는 합니다. 만들 하려고 하면 포털 마켓플레이스 항목을 만들 수 있는지를 나타내는 오류가 표시 됩니다. 

- <!-- 2930820 - IS ASDK --> 관리자와 사용자 포털에서 "Docker"를 검색 하는 경우 항목을 올바르게 반환 됩니다. Azure Stack에서 실제로 사용할 수 없는 합니다. 만들 하려고 하면 오류가 표시 된 블레이드가 표시 됩니다. 
