...
ms.locfileid: "42889923"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>Azure Stack에 대 한 확장 호스트 준비

확장 호스트 필요한 TCP/IP 포트의 수를 줄여 Azure Stack 보안 하는 데 사용할 수 있습니다. 이 문서에서는 Azure Stack 1808 업데이트 후 Azure Stack 업데이트 패키지를 통해 자동으로 사용할 수 있는 확장 호스트에 대 한 준비 살펴봅니다.
...
> [!Note]  
> 이 단계 요청에 따라 SSL 인증서를 건너뛸 수 있습니다.
...
3. 끝점을 호스트 하는 것에 대 한 인증서를 가져옵니다. 환경에 맞게 스크립트를 조정 합니다.
