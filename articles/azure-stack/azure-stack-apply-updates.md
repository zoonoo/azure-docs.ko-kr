...
Azure Stack 운영자를 Microsoft에 적용할 수 있습니다 또는 관리자 포털에서 업데이트를 사용 하 여 Azure Stack에 대 한 OEM 업데이트 패키지 타일입니다. 업데이트 패키지를 다운로드 하 고, Azure Stack에 패키지 파일을 가져올 하 고, 다음 업데이트 패키지를 설치 해야 합니다. 
...
2. 필터 상자에 입력 **업데이트**를 선택 합니다 **updateadminaccount** 저장소 계정입니다.
    ...
    ![Updateadminaccount 검색 하는 방법을 보여 줍니다.](media/azure-stack-apply-updates/ApplyUpdates2.png)
...
4. 아래 **Blob service**를 선택 **+ 컨테이너** 컨테이너를 만들려고 합니다. 이름을 입력 (예를 들어 *업데이트 1709*)를 선택한 후 **확인**합니다.
...
- [Azure Stack 개요에 대 한 업데이트 관리](azure-stack-updates.md)
