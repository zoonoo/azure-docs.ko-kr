...
만 청구 됩니다 노드에서 클러스터를 지 원하는 데 필요한 계산 사용 합니다. 자세한 내용은 [사용 및 Azure Stack에서 청구](https://docs.microsoft.com/azure/azure-stack/azure-stack-billing-and-chargeback)합니다.
