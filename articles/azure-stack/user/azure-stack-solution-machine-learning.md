...
1.  양식 필드에 정보를 채우고 **만들기** 단추를 선택하여 Workbench에 새 프로젝트를 만듭니다.
    ...
    | Visualstudio.com GIT 리포지토리 URL | 비워 둡니다. | 선택적 필드입니다. 소스 제어 및 공동 작업에 대 한 Azure 리포지토리에 Git 리포지토리와 프로젝트를 연결 합니다. |
...
### <a name="configure-azure-devops-to-deploy-automatically"></a>Azure DevOps 자동으로 배포를 구성 합니다.
...
1.  아티팩트 이름 지정 **iris_deployment** 되도록 게시 위치를 선택 하 고 **Azure 파이프라인**합니다.
