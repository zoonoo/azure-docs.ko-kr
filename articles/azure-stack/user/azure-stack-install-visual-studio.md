...
Visual Studio를 사용 하 여 작성 하 고 Azure Resource Manager 배포 [템플릿](azure-stack-arm-templates.md) Azure Stack에 있습니다. 이 문서의 단계를 안내에 Visual Studio를 설치 합니다 [Azure Stack](azure-stack-connect-azure-stack.md#connect-to-azure-stack-with-remote-desktop), 또는 Azure Stack을 통해 하려는 경우 외부 컴퓨터는 [VPN](azure-stack-connect-azure-stack.md#connect-to-azure-stack-with-vpn)합니다.
...
4. 선택 **추가**, 사용자 Azure 리소스 관리자 끝점을 입력 합니다.  
  Azure Stack 개발 키트에 대 한 URL은: `https://management.local.azurestack/external`합니다.  
  Azure Stack 통합 시스템 URL은: `https://management.[Region}.[External FQDN]`합니다.
...
7. 선택 **계정 추가** ADFS 자격 증명으로 로그인 합니다.  
    ...
    클라우드 탐색기 사용 가능한 구독을 쿼리합니다. 하나 관리를 사용할 수 있는 구독을 선택할 수 있습니다.

    ![X](./media/azure-stack-install-visual-studio/image8.png)

8. 기존 리소스, 리소스 그룹을 통해 검색 또는 템플릿을 배포 합니다.

## <a name="next-steps"></a>다음 단계

 - 에 대해 자세히 알아보세요 [공존](https://msdn.microsoft.com/library/ms246609.aspx) 다른 Visual Studio 버전을 사용 하 여 합니다.
