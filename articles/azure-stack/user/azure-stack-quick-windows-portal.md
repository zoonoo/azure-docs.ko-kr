...
1. 클릭 **새** > **계산** > **Windows Server 2016 Datacenter 평가판** > **만들기**합니다. 표시 되지 않는 경우 **Windows Server 2016 Datacenter 평가판** 항목이 귀하가 Azure Stack 운영자에 게 문의 합니다. 추가 하는 것을 marketplace에 설명 된 대로 요청을 [Windows Server 2016 VM 이미지를 Azure Stack 마켓플레이스에 추가할](../azure-stack-add-default-image.md) 문서.
...
4. 아래 **설정을**, 기본값을 사용 하 고 클릭 **확인**합니다.
