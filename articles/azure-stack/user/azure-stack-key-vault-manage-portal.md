...
2. 대시보드에서 선택 **+ 리소스 만들기**, 한 다음 **보안 + Id**, 한 다음 **Key Vault**.
    ...
    ![Key Vault 화면](media/azure-stack-key-vault-manage-portal/image1.png)
...
![키 URI](media/azure-stack-key-vault-manage-portal/image4.png)
...
![URI 암호](media/azure-stack-key-vault-manage-portal/image5.png)

## <a name="next-steps"></a>다음 단계

* [Key Vault에 저장 된 암호를 검색 하 여 VM 배포](azure-stack-key-vault-deploy-vm-with-secret.md)
* [Key Vault에 저장 된 인증서를 사용 하 여 VM 배포](azure-stack-key-vault-push-secret-into-vm.md)
