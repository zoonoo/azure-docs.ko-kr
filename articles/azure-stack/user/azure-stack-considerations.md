...
서비스를 사용 하거나 Azure Stack에 대 한 앱을 작성 하기 전에 Azure Stack 및 Azure 간의 차이점을 이해 하는 것이 반드시 합니다. 이 문서에서는 하이브리드 클라우드 개발 환경으로 Azure Stack을 사용 하는 경우 주요 고려 사항을 식별 합니다.

## <a name="overview"></a>개요

Azure Stack은 회사 또는 서비스 공급자 데이터 센터에서 Azure 서비스를 사용할 수 있는 하이브리드 클라우드 플랫폼입니다. Azure Stack에서 앱을 빌드할 수 있으며 그런 다음 Azure Stack, Azure 또는 Azure 하이브리드 클라우드 배포.
...
| Azure Resource Manager 끝점 * | https://management.azure.com | Azure Stack 통합 시스템, 귀하가 Azure Stack 운영자를 제공 하는 끝점을 사용 합니다.<br><br>개발 키트를 사용 하 여: https://management.local.azurestack.external합니다.
| 포털 URL * | [https://portal.azure.com](https://portal.azure.com) | Azure Stack 통합 시스템을 귀하가 Azure Stack 운영자를 제공 하는 URL을 사용 합니다.<br><br>개발 키트를 사용 하 여: https://portal.local.azurestack.external합니다.
