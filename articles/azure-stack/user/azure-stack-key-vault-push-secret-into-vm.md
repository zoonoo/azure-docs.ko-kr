...
![템플릿 배포 결과](media/azure-stack-key-vault-push-secret-into-vm/deployment-output.png)
...
* [응용 프로그램이 Key Vault에 액세스 하도록 허용](azure-stack-key-vault-sample-app.md)
