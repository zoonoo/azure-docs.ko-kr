...
2. Azure Stack 테 넌 트 포털에서 선택 **+ 리소스 만들기 > 템플릿 배포** 사용자 지정 템플릿에서 배포 합니다.
...
Ethereum 및 Azure에 대 한 자세한 내용은 참조 하세요 [블록 체인 기술 및 응용 프로그램](https://azure.microsoft.com/solutions/blockchain/)합니다.
