...
ms.locfileid: "42139398"
---
# <a name="deploy-a-template-to-azure-stack-using-powershell"></a>PowerShell을 사용 하 여 Azure Stack에 템플릿 배포

*적용 대상: Azure Stack 통합 시스템 및 Azure Stack 개발 키트*

Azure Stack에 Azure Resource Manager 템플릿을 배포 하려면 PowerShell을 사용할 수 있습니다. 이 문서에서는 PowerShell를 사용 하 여 템플릿을 배포 하는 방법을 보여 줍니다.
...
1. 로 이동 <http://aka.ms/AzureStackGitHub> 찾고 합니다 **101-간단한-windows-vm** 템플릿. 이 위치에 템플릿을 저장할: c:\\템플릿\\azuredeploy-101-간단한-windows-vm.json 합니다.
...
3. 대체 *사용자 이름* 및 *암호* 다음 스크립트와 사용자 이름 및 암호를 한 다음 스크립트를 실행 합니다.
   ...
   >[!IMPORTANT]
   >이 스크립트를 실행할 때마다 배포를 덮어쓰지 않도록 "$myNum" 매개 변수의 값이 증가 합니다.
