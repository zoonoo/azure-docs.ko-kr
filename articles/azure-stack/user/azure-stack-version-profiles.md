...
예를 들어 사용 하 여 계정 저장소를 만들려면 PowerShell을 사용 합니다 **Microsoft.Storage** api-version 2016-03-30 및 api 버전 2015-12-01을 사용 하 여 Microsoft.Compute 리소스 공급자를 사용 하는 VM을 지 원하는 리소스 공급자 를 조회 하는 PowerShell 모듈 지원 2016-03-30 저장용 해야 하 고는 모듈은 계산 2015-02-01을 지원 하 고 설치 합니다. 대신 프로필을 사용할 수 있습니다. Cmdlet을 사용 하 여 * * 설치 프로필 * profilename * 및 PowerShell 모듈의 올바른 버전을 로드 합니다.
