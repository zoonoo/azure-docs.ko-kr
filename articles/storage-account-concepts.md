<properties umbracoNaviHide="0" pageTitle="저장소 계정 개념 | Azure" metaKeywords="Azure 저장소, 저장소 서비스, 서비스, 저장소 계정, 계정, 저장소 계정 만들기, 계정 만들기" description="Learn about storage account concepts." urlDisplayName="How to: storage accounts" headerExpose="" footerExpose="" disqusComments="1" title="Storage Account Concepts" services="storage" authors="tamram" manager="adinah" editor="cgronlun" />
