<properties 
	pageTitle="저장소 계정 개념 | Azure" 
	description="저장소 계정의 개념에 대해 알아봅니다." 
	headerExpose="" 
	footerExpose="" 
	services="storage" 
	authors="tamram" 
...
사용자 지정 도메인 이름을 구성하여 저장소 계정에서 사용할 수도 있습니다. 자세한 내용은 [저장소 계정에서 Blob 데이터의 사용자 지정 도메인 이름 구성](http://azure.microsoft.com/documentation/articles/storage-custom-domain-name/)을 참조하세요.
