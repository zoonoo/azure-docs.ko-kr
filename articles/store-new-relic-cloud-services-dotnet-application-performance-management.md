...
New Relic Standard는 Azure 사용자에게 무료입니다. New Relic Pro는 Azure Cloud Services의 인스턴스 크기에 따라 제공됩니다. 가격 책정 정보에 대 한 참조는 [New Relic 페이지](https://azure.microsoft.com/marketplace/partners/newrelic/newrelic/) Azure 마켓플레이스 또는 연락처 New Relic에서 (sales@newrelic.com) 엔터프라이즈 수준의 가격에 대 한 합니다.
