...
Event Hubs 처리량 단위는 주어진 시간 동안 선택된 단위의 최대 수에 따라 시간당 청구됩니다. 사용량 증가에 따라 [자동 확장을 사용하여 자동으로 처리량 단위 수를 증가](event-hubs-auto-inflate.md)시킬 수 있습니다.
