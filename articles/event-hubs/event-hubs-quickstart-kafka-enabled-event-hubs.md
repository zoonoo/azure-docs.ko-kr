---
title: Kafka 프로토콜을 사용하여 Azure Event Hubs로 데이터 스트리밍 | Microsoft Docs
...
ms.locfileid: "65203914"
---
# <a name="data-streaming-with-event-hubs-using-the-kafka-protocol"></a>Kafka 프로토콜을 사용하여 Event Hubs로 데이터 스트리밍
