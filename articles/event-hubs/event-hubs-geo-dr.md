...
1. 기본 네임 스페이스를 만듭니다.
1. 보조 네임 스페이스를 만듭니다. 이 단계는 선택 사항입니다. 다음 단계에서 페어링을 만드는 동안 보조 네임 스페이스를 만들 수 있습니다. 
...
1. **페어링 시작** 페이지에서 기존 보조 네임 스페이스를 선택 하거나 만든 후 **만들기** 를 선택 합니다. 다음 예에서는 기존 보조 네임 스페이스를 선택 합니다. 
