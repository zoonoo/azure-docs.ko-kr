...
마지막으로 또한 다음 예와 같이 [MessagingFactory](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.messagingfactory.aspx) 인스턴스에서 [EventHubClient](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventhubclient.aspx) 개체를 만들 수 있습니다.
...
[EventData](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventdata.aspx) 인스턴스를 만들고 [보내기](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventhubclient.send.aspx) 메서드를 통해 보내어 이벤트 허브를 이벤트로 보냅니다. 이 메서드는 단일[EventData](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventdata.aspx) 인스턴스 매개 변수를 취하고 동기적으로 이벤트 허브에 보냅니다.
...
[CreatePartitionedSender](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventhubclient.createpartitionedsender.aspx)는 특정 이벤트 허브 파티션에 이벤트를 게시하는데 사용할 수 있는 [EventHubSender](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventhubsender.aspx)개체를 반환합니다.

## 이벤트 소비자

이벤트 허브에는 이벤트 사용에 대한 두 기본 모델이 있습니다. 직접 수신기 및 [EventProcessorHost](https://msdn.microsoft.com/library/azure/microsoft.servicebus.messaging.eventprocessorhost.aspx)와 같은 상위 수준의 추상화입니다. 직접 수신기는 소비자 그룹 내의 파티션에 액세스를 자체 조정을 담당합니다.
