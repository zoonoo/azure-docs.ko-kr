---
title: .NET-Azure Event Hubs에 대 한 메시징 예외 Microsoft Docs
...
ms.locfileid: "71309835"
---
# <a name="event-hubs-messaging-exceptions---net"></a>Event Hubs 메시징 예외-.NET

이 문서에는 .NET Framework Event Hubs Api를 포함 하는 Azure Service Bus messaging .NET API 라이브러리에 의해 생성 된 .NET 예외 중 일부가 나열 되어 있습니다. 이 참조는 변경될 수 있으므로 나중에 다시 업데이트를 확인하세요.
