...
Event Hubs의 규모는 구입한 처리량 단위 수에 따라 제어되며, 각 처리량 단위는 초당 1MB 또는 수신 시 초당 이벤트 1,000개 및 송신 시 이벤트 2,000개에 해당합니다. Event Hubs는 [자동 확장](event-hubs-auto-inflate.md) 기능을 사용하는 경우 처리량 제한에 도달하면 처리량 단위를 자동으로 스케일 업할 수 있습니다. 이 기능은 Apache Kafka 프로토콜 지원에서도 작동합니다.  
