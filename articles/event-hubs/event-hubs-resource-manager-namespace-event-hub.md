---
title: Azure Resource Manager 템플릿을 사용하여 이벤트 허브 및 소비자 그룹이 있는 이벤트 허브 네임스페이스 만들기 | Microsoft Docs
...
전체 템플릿은 GitHub에서 [이벤트 허브 및 소비자 그룹 템플릿][이벤트 허브 및 소비자 그룹 템플릿] 을 참조하세요.
