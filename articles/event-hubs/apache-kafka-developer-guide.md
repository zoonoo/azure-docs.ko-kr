...
| [Go](https://github.com/Azure/azure-event-hubs-for-kafka/tree/master/quickstart/go) | <p>이 빠른 시작은 Go에 기록된 예제 생산자 및 소비자를 사용하여 이벤트 허브 Kafka 끝점을 만들고 연결하는 방법을 보여 줄 것입니다.</p><p>이 샘플은 [Confluent의 아파치 카프카 골랑 클라이언트를](https://github.com/confluentinc/confluent-kafka-go)기반으로 하며, 카프카의 이벤트 허브와 함께 사용하도록 수정되었습니다.</p>| 
