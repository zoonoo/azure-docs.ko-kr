...
* 사용 하 여 [MirrorMaker](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=27846330) 에 [온-프레미스에서 Kafka에서 kafka 스트림 이벤트 클라우드에서 Event Hubs를 사용 하도록 설정 합니다.](event-hubs-kafka-mirror-maker-tutorial.md)
