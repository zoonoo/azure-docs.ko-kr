...
이벤트 허브 처리량 단위는 사용자에 의해 Azure 클래식 포털 또는 이벤트 허브 Resource Manager 템플릿을 통해 명시적으로 선택됩니다. 처리량 단위는 서비스 버스 네임스페이스의 모든 이벤트 허브에 적용하고 각 처리량 단위로 네임 스페이스가 다음 기능을 수행합니다.
