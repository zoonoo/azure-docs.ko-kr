...
## <a name="can-i-use-a-single-amqp-connection-to-send-and-receive-from-event-hubs-and-service-bus-queues/topics?"></a>이벤트 허브 및 서비스 버스 큐/항목에서 보내고 받는 단일 AMQP 연결을 사용할 수 있습니까?
