...
Notebook에서 다음 코드를 사용하여 Event Hub에서 이벤트를 스트리밍합니다.
...
이 아티클에서는 실시간 내결함성 스트리밍 솔루션을 구축하기 위해 Event Hubs 커넥터가 작동하는 방법을 보여주었습니다. 다음과 같은 링크에 따라 구조적 스트리밍 및 Event Hubs 통합 커넥터에 대해 자세히 알아보세요.
