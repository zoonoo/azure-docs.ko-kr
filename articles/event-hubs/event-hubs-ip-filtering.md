...
이 섹션에서는 Azure Portal을 사용하여 이벤트 허브 네임스페이스에 대한 IP 방화벽 규칙을 만드는 방법을 보여 주십니다. 
...
1. 특정 네트워크 및 IP 주소에 대한 액세스를 제한하려면 **선택한 네트워크** 옵션을 선택합니다. **방화벽** 섹션에서 다음 단계를 따르십시오.
    ...
    3. **신뢰할 수 있는 Microsoft 서비스가 이 방화벽을 우회하도록 허용할지**여부를 지정합니다. 
        ...
        ![방화벽 - 선택한 모든 네트워크 옵션](./media/event-hubs-firewall/firewall-selected-networks-trusted-access-disabled.png)
