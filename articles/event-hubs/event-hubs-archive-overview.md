...
## 보관 탐색 및 Avro 작업
Event Hubs 보관이 구성되면 구성된 기간에 제공한 Azure Storage 계정 및 컨테이너에 파일을 만듭니다. [Azure Storage 탐색기][Azure Storage 탐색기]와 같은 도구에서 이러한 파일을 볼 수 있습니다. 파일을 로컬로 다운로드하여 작업할 수 있습니다.
