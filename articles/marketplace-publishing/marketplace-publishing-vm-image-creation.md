...
* SQL Server 2014([엔터프라이즈][link-sql-2014-ent], [표준][link-sql-2014-std], [웹][link-sql-2014-web])
* SQL Server 2012 SP2([엔터프라이즈][link-sql-2012-ent], [표준][link-sql-2012-std], [웹][link-sql-2012-web])
...
* [PowerShell을 설정하는 방법](../powershell-install-configure.md)
...
공유 액세스 서명 URI를 만들려면 [공유 액세스 서명, 1부: SAS 모델 이해][link-azure-1] 및 [공유 액세스 서명, 2부: Azure Blob service를 통해 SAS 만들기 및 사용][link-azure-2]에 제공된 지침을 따를 수 있습니다.

코드를 사용하여 공유 선택키를 생성하는 대신, [Azure Storage 탐색기][link-azure-codeplex]와 같은 저장소 도구를 사용할 수 있습니다.

**Azure 저장소 탐색기를 사용하여 공유 액세스 키 생성**

1. CodePlex에서 [Azure Storage 탐색기][link-azure-codeplex] 6 이상을 다운로드합니다.
