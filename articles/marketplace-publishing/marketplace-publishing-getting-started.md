...
|| [VM 기술 필수 구성 요소][link-single-vm-prereq] | 개발자 서비스 기술 필수 구성 요소 | [데이터 서비스 기술 필수 구성 요소](marketplace-publishing-data-service-creation-prerequisites.md) | [솔루션 템플릿 기술 필수 구성 요소](marketplace-publishing-solution-template-creation-prerequisites.md) |
...
| **3단계. 스테이징에 제품 푸시** | [스테이징에서 VM 제품 테스트](marketplace-publishing-vm-image-test-in-staging.md) | 스테이징에서 개발자 서비스 제품 테스트 | [스테이징에서 데이터 서비스 제품 테스트](marketplace-publishing-data-service-test-in-staging.md) | [스테이징에서 솔루션 템플릿 테스트](marketplace-publishing-solution-template-test-in-staging.md) |
