<properties
   pageTitle="클라우드 솔루션 공급자의 대리점 인센티브를 확인하고 변경하는 방법 | Microsoft Azure"
...
# Azure 마켓플레이스에서 클라우드 솔루션 공급자 "대리점 인센티브"를 확인 및 변경
...
1.	[Microsoft Azure 게시 계정](https://publish.windowsazure.com/workspace)에 로그인합니다.
