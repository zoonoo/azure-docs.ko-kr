---
title: Azure 마켓플레이스에 제품 배포를 위한 준비 및 테스트 | Microsoft Docs
...
### 샘플 이미지(선택 사항)
> [!NOTE]
> 샘플 이미지를 포함하는 것은 선택적인 단계입니다. 게시 포털에 여러 샘플 이미지를 업로드할 수 있지만 Azure 포털에는 하나의 이미지(시스템에서 임의로 선택)만 표시됩니다. 따라서 샘플 이미지는 하나만 업로드하는 것이 좋습니다.
> 
> 
