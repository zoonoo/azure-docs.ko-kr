...
Microsoft는 매우 다양한 제품 및 서비스를 지원하므로 쿼리를 통해 적절한 지원 팀을 찾도록 하는 것은 적합하고 시기 적절한 응답을 보장하는 데 중요합니다. 쿼리를 적절한 팀에 전달하는 데 도움이 되는 다음 시나리오를 살펴보세요.

- 마켓플레이스에서 게시자이고 VM을 개발하고 있는 경우 Microsoft 등록 또는 계산 팀과 함께 작업해야 합니다.

- 마켓플레이스에서 게시자이고 고객에게 질문을 받은 경우 https://ms.portal.azure.com/의 지원 링크를 통해 지원을 요청하도록 고객에게 알려줍니다.
...
가능한 한 자세하게 문제를 설명하고 문제 해결에 도움이 될 수 있는 파일(예: 스크린샷, 네트워크 추적 등)을 모두 제공합니다.
