<properties
   pageTitle="Azure 마켓플레이스용 제품을 만들기 위한 기술 이외의 필수 조건 | Microsoft Azure"
...
# Azure 마켓플레이스용 제품을 만들기 위한 일반 필수 조건
제품 만들기 배포 프로세스를 진행하는 데 필요한 일반적인 비즈니스 프로세스 중심 필수 조건을 이해합니다.
...
- **게시 계정의 소유자가 아닌** 경우에는 해당 Microsoft 계정을 계정 소유자가 [게시 포털](https://publish.windowsazure.com) -> **게시자** 탭-> **관리자** 링크에 공동 관리자로 추가하도록 할 수 있습니다.
...
> [AZURE.IMPORTANT]**무료 제품만 게시하거나 본인의 라이선스를 가져오려는 경우에는 회사 세금 및 은행 정보를 작성하지 않아도 됩니다.**

> 판매자로 활동하려면 회사 등록을 완료해야 합니다. 그러나 회사에서 판매자 대시보드 계정의 세금 및 은행 정보를 작성하는 동안 개발자는 [게시 포털](https://publish.windowsazure.com)에서 가상 컴퓨터 이미지를 만들어 Azure 스테이징 환경에서 인증받고 테스트할 수 있습니다. 제품을 마켓플레이스에 게시하는 마지막 단계에 대해서만 판매자 계정 승인을 완료해야 합니다.

> 판매자 등록 완료에 문제가 있으면 아래와 같이 지원 티켓을 기록하세요. 1. [지원](http://go.microsoft.com/fwlink?LinkId=272975)에 문의 2. **판매자 대시보드 등록 및 계정** 선택 3. **개발자 계정 등록** 선택 4. 연락 **방법** 선택
...
|-----|-----|-----|-----|
| [VM 기술 필수 조건](marketplace-publishing-vm-image-creation-prerequisites.md) | 개발자 서비스 기술 필수 조건 | 데이터 서비스 기술 필수 조건 | [솔루션 템플릿 기술 필수 조건](marketplace-publishing-solution-template-creation-prerequisites.md) |
