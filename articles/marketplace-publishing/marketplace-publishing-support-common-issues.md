...
다음과 같은 문제는 [http://go.microsoft.com/fwlink/?LinkId=272975](http://go.microsoft.com/fwlink/?LinkId=272975)에서 지원 요청을 작성하세요.

- 웹 서비스를 관리하는 데 문제가 있습니다.
- 내 판매자 계정과 연결된 Microsoft 계정을 변경하려면 어떻게 해야 하나요?
