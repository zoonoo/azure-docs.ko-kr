...
1. 회사의 도메인 내에서 DL(배포 목록) 또는 SG(보안 그룹)를 만듭니다. DL을 사용하면 여러 사람이 지급 정보 보고에 중요한 메일 알림을 받을 수 있습니다. Microsoft 계정 소유권은 양도될 수 있으며 단일 사용자에게 한정되지도 않습니다.
   아래 제공된 지침을 따르세요.
   
   1. DL에 온보딩 팀을 추가합니다.
   2. 결제, 세금 정보 및 보고가 이 계정을 통해 전송되므로 DL/SG가 활성 전자 메일 주소이며 전자 메일을 받을 수 있는지 확인합니다.
   3. DL/SG에 대한 전자 메일 주소로 marketplace@partnercompany.com 과 같은 주소를 사용하는 것이 좋습니다.
...
## <a name="2-create-your-microsoft-developer-center-account"></a>2. Microsoft 개발자 센터 계정 만들기
...
1. 지원 링크 [https://developer.microsoft.com/windows/support](https://developer.microsoft.com/windows/support)
