...
ms.locfileid: "69877215"
---
# <a name="security-recommendations-for-azure-internet-of-things-iot-deployment"></a>IoT (Azure 사물 인터넷) 배포에 대 한 보안 권장 사항

이 문서에는 Azure IoT 서비스에 대 한 보안 권장 사항이 포함 되어 있습니다. 이러한 권장 사항을 구현 하면 Azure IoT의 고객으로 서 보안 의무를 충족 하 고 IoT 솔루션에 대 한 전반적인 보안을 개선 하는 데 도움이 됩니다. Azure IoT에서 제공 하는 내장 보안 기능에 대 한 자세한 내용은 [처음부터 iot 보안](iot-security-ground-up.md)을 읽어 보세요.
