<properties 
	pageTitle="DASH.js를 사용하여 HTML5 응용 프로그램에 MPEG-DASH 적응 스트리밍 비디오 포함" 
	description="이 항목에서는 DASH.js를 사용하여 HTML5 응용 프로그램에 MPEG-DASH 적응 스트리밍 비디오를 포함시키는 방법을 보여줍니다." 
	authors="Juliako" 
	manager="dwrede" 
	editor="" 
...
#DASH.js를 사용하여 HTML5 응용 프로그램에 MPEG-DASH 적응 스트리밍 비디오 포함
...
Dash.js는 JavaScript로 작성된 오픈 소스 MPEG-DASH 비디오 플레이어입니다. 목표는 비디오 재생이 필요한 응용 프로그램에서 자유롭게 다시 사용할 수 있는 강력한 플랫폼 간 플레이어를 제공하는 것입니다. W3C 미디어 원본 확장(MSE)을 지원하는 모든 브라우저에서 MPEG-DASH 재생을 제공합니다. 현재는 Chrome 및 IE11에서 지원되며 다른 브라우저는 MSE를 지원하지 않는 것으로 보입니다. DASH.js에 대한 자세한 내용은 GitHub dash.js 리포지토리를 참조하세요.


##브라우저 기반 스트리밍 비디오 플레이어 만들기
