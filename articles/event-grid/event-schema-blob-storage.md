---
title: "Azure Event Grid Blob 저장소 이벤트 스키마"
description: "Azure Event Grid를 사용하여 Blob 저장소 이벤트에 제공되는 속성을 설명합니다."
services: event-grid
author: tfitzmac
manager: timlt
...
---
# <a name="azure-event-grid-event-schema-for-blob-storage"></a>Azure Event Grid Blob 저장소에 대한 이벤트 스키마

이 문서에서는 Blob 저장소 이벤트에 대한 속성 및 스키마를 제공합니다. 이벤트 스키마에 대한 소개는 [Azure Event Grid 이벤트 스키마](event-schema.md)를 참조하세요.

## <a name="available-event-types"></a>사용할 수 있는 이벤트 유형

Blob 저장소는 다음과 같은 이벤트 유형을 내보냅니다.
...
| metadataVersion | string | 이벤트 메타데이터의 스키마 버전입니다. Azure Event Grid는 최상위 속성의 스키마를 정의합니다. Event Grid가 이 값을 제공합니다. |
...
* Blob 저장소 이벤트를 사용하는 방법에 대한 소개는 [Blob 저장소 이벤트 라우팅 - Azure CLI](../storage/blobs/storage-blob-event-quickstart.md?toc=%2fazure%2fevent-grid%2ftoc.json)를 참조하세요. 
