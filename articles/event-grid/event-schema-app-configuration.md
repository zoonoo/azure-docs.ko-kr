...
description: 이 문서에서는 Event Grid 이벤트 원본으로 Azure 앱 구성을 사용 하는 방법을 설명 합니다. 스키마와 자습서 및 방법 문서에 대 한 링크를 제공 합니다.
services: event-grid
author: banisadr
...
| etag | string | 새 `KeyValueModified` 키 값의 etag에 대 한입니다. 삭제 `KeyValueDeleted` 된 키-값의 etag에 대 한입니다. |
