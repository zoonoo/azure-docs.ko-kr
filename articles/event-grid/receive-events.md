...
프로그래밍 방식으로 유효성 검사 코드를 에코하려면 다음 코드를 사용합니다(https://github.com/Azure-Samples/event-grid-dotnet-publish-consume-events/tree/master/EventGridConsumer):에서 관련 샘플을 확인할 수 있음).
