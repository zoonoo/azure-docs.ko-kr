...
| 데이터 | 개체(object) | IoT Hub 이벤트 데이터입니다.  |
...
| 자산 | Type | 설명 |
| -------- | ---- | ----------- |
| 쌍 | 개체(object) | 응용 프로그램 장치 메타 데이터의 클라우드 표현인 장치 쌍에 대 한 정보를 제공 합니다. | 
...
| 원하는 | 개체(object) | 애플리케이션 백 엔드에서만 작성할 수 있고 장치에서 읽을 수 있는 속성의 일부입니다. | 
| 보고된 | 개체(object) | 장치에서만 작성할 수 있고 애플리케이션 백 엔드에서 읽을 수 있는 속성의 일부입니다. |
