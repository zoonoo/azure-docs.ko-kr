...
4. **경고 규칙 만들기** 페이지로 돌아가 **작업 그룹 선택** 을 클릭 합니다.
    ...
    :::image type="content" source="./media/monitor-event-delivery/select-action-group-button.png" alt-text="작업 그룹 선택 단추":::
...
> [!NOTE]
> 이 문서에서는 경고를 생성 하는 데 사용할 수 있는 다양 한 단계 및 조합을 다루지 않습니다. 경고에 대 한 개요는 [경고 개요](../azure-monitor/alerts/alerts-metric.md)를 참조 하세요.
