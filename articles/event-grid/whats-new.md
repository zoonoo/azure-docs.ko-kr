...
- 다음과 같은 새로운 기능을 지원합니다.
    ...
    * 리소스 목록 작업에 대한 페이지 매김 및 검색 필터입니다. 예제는 [토픽 - 구독 별로 나열](/rest/api/eventgrid/version2021-06-01-preview/partner-namespaces/list-by-subscription)을 참조하세요.
