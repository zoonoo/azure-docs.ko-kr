...
[.NET 백 엔드](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-validate-modify-data/ ".NET 백 엔드") | [JavaScript 백 엔드](/en-us/documentation/articles/mobile-services-windows-store-javascript-validate-modify-data-server-scripts/ "JavaScript 백 엔드")
...
3.  [길이 유효성 검사 테스트](#test-length-validation)
4.  [CompleteDate에 대한 타임스탬프 필드 추가](#add-timestamp)
5.  [CompleteDate를 표시하도록 클라이언트 업데이트](#update-client-timestamp)

이 자습서는 이전 자습서인 [시작](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started/) 또는 [데이터 시작](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-data/)의 단계 및 샘플 앱을 기반으로 합니다. 이 자습서를 시작하기 전에 먼저 [시작](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started/) 또는 [데이터 시작](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-data/) 자습서를 완료해야 합니다.

모바일 서비스에 유효성 검사 코드 추가
-------------------------------------
...
CompleteDate에 대한 타임스탬프 필드 추가
----------------------------------------

[WACOM.INCLUDE [mobile-services-dotnet-backend-add-completedate](../includes/mobile-services-dotnet-backend-add-completedate.md)]

completeDate를 표시하도록 클라이언트 업데이트
---------------------------------------------
...
-   [사용자의 서비스 쪽 권한 부여](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-authorize-users-in-scripts/)
    인증된 사용자의 ID를 기준으로 데이터를 필터링하는 방법을 알아봅니다.

-   [푸시 알림 시작](en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-push/)
