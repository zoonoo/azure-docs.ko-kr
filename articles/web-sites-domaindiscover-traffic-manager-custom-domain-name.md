<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with DomainDiscover - TierraNet" pageTitle="트래픽 관리자를 사용하여 Azure에 대한 DomainDiscover 도메인 이름 구성" metaKeywords="Microsoft Azure, Microsoft Azure 웹 사이트, DomainDiscover, TierraNet, 트래픽 관리자" description="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with DomainDiscover - TierraNet" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
