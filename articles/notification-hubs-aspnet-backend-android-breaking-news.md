...
5. 그런 다음 **onCreate** 메서드에서 **hub** 필드 및 **registerWithNotificationHubs** 메서드의 초기화를 제거합니다. **Notifications** 클래스 인스턴스를 초기화하는 다음 줄을 추가합니다. 메서드에는 다음 줄이 포함되어야 합니다.
...
3. 그런 다음 **MainActivity**에 다음 메서드를 추가합니다.
