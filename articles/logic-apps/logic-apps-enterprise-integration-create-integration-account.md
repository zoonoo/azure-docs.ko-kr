...
> [!IMPORTANT]
> 선택한 통합 계정 유형에 따라 통합 계정을 만들면 비용이 발생 합니다. 자세한 내용은 [가격 책정 및 청구 모델 Logic Apps](logic-apps-pricing.md#integration-accounts) 및 [Logic Apps 가격 책정](https://azure.microsoft.com/pricing/details/logic-apps/)을 참조 하세요.
