---
title: B2B 통합 계정 만들기 또는 관리-Azure Logic Apps
...
이 작업의 경우이 섹션의 단계, [Azure PowerShell](https://docs.microsoft.com//powershell/module/azurerm.logicapp/New-AzureRmIntegrationAccount)또는 [Azure CLI](https://docs.microsoft.com/cli/azure/resource?view=azure-cli-latest#az-resource-create)따라 Azure Portal를 사용할 수 있습니다.
...
이 작업의 경우이 섹션의 단계, [Azure CLI](https://docs.microsoft.com/cli/azure/resource?view=azure-cli-latest#az-resource-delete)또는 [Azure PowerShell](https://docs.microsoft.com/powershell/module/azurerm.logicapp/Remove-AzureRmIntegrationAccount)따라 Azure Portal를 사용할 수 있습니다.
