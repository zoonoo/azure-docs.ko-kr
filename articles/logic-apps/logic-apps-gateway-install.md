...
* 게이트웨이 구성하려면 해당 **이름** 및 **복구 키**를 입력한 후 **구성**을 클릭하거나 누릅니다.
    ...
    최소&8;자를 포함하는 복구 키를 지정하고 안전한 장소에 보관합니다. 해당 게이트웨이를 마이그레이션, 복원 또는 인계받으려는 경우 이 키가 필요합니다.
...
사용자는 회사 또는 학교 계정을 사용하여 로그인합니다. 이것은 조직 계정입니다. Office 365 서비스에 등록하고 실제 회사 전자 메일을 제공하지 않은 경우 jeff@contoso.onmicrosoft.com과 같을 수 있습니다. 클라우드 서비스 내에서 계정은 AAD(Azure Active Directory)의 테넌트 내에 저장됩니다. 대부분의 경우에서 AAD 계정의 UPN은 전자 메일 주소와 일치합니다.
...
* [논리 앱으로의 온-프레미스 연결 만들기](../logic-apps/logic-apps-gateway-connection.md)
