...
B2B 통신에서는 실행되는 두 비즈니스 프로세스 또는 응용 프로그램 간에 메시지 교환이 진행됩니다. 이러한 관계는 비즈니스 프로세스 간 계약을 정의합니다. 통신이 연결된 후 메시지 모니터링을 설정하여 통신이 예상대로 작동하는지 확인할 수 있습니다.
다양한 세부 정보는 디버깅을 위해 통합 계정에 대한 진단을 설정할 수 있습니다.
