...
| `runtimeConfiguration` | 예 | Object | `operationOptions`런타임에 논리 앱이 작동 하는 방식을 제어 하는 속성을 지정 하는 데 사용할 수 있습니다. 예를 들어 [높은 처리량 모드](../logic-apps/logic-apps-limits-and-config.md#run-high-throughput-mode)에서 논리 앱을 실행할 수 있습니다. |
|||||
