...
* Azure 구독에 이미 정의되고 연결된 [통합 계정입니다.](logic-apps-enterprise-integration-create-integration-account.md) EDIFACT 메시지 인코딩 커넥터를 사용하는 통합 계정이 있어야 합니다. 
...
3.  검색 상자에서 필터로 "EDIFACT"를 입력합니다. 계약 **이름으로 EDIFACT 메시지를 인코딩하거나** **ID로 EDIFACT 메시지에 인코딩합니다.**
