...
1. **ROSETTANET PIP**에서 **추가**를 선택 합니다. PIP 세부 정보를 제공 합니다.
   ...
   |----------|----------|-------------|
   | **이름** | 예 | PIP 이름 |
   | **PIP 코드** | 예 | PIP 3 자리 코드입니다. 자세한 내용은 [RosettaNet pip](https://docs.microsoft.com/biztalk/adapters-and-accelerators/accelerator-rosettanet/rosettanet-pips)를 참조 하세요. |
