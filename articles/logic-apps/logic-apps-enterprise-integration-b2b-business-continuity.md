---
title: 통합 계정에 대한 재해 복구
description: Azure Logic Apps에서 지역 간 재해 복구를 통해 통합 계정 및 B2B 아티팩트 설정
services: logic-apps
...
---
# <a name="set-up-cross-region-disaster-recovery-for-integration-accounts-in-azure-logic-apps"></a>Azure 논리 앱에서 통합 계정에 대한 지역 간 재해 복구 설정
...
7. 작업을 보조 지역 통합 계정에 연결하려면 **연결** > 변경을 선택사용 가능한 통합 계정 목록에 대한**새 연결** 추가를 선택합니다. 연결 이름을 입력하고 목록에서 *보조 지역 통합 계정*을 선택한 후 **만들기**를 선택합니다. 
...
8. 작업을 보조 지역 통합 계정에 연결하려면 **연결** > 변경을 선택사용 가능한 통합 계정 목록에 대한**새 연결** 추가를 선택합니다. 연결 이름을 입력하고 목록에서 *보조 지역 통합 계정*을 선택한 후 **만들기**를 선택합니다.
...
7. 작업을 보조 통합 계정에 연결하려면 **연결** > 변경을 선택사용 가능한 통합 계정 목록에 대한**새 연결** 추가를 선택합니다. 연결 이름을 입력하고 목록에서 *보조 지역 통합 계정*을 선택한 후 **만들기**를 선택합니다.
