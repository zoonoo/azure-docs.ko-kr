...
프로덕션 시나리오가 아니라 예비 시나리오에만 체험 계층을 사용합니다. 이 계층에서는 처리량과 사용량을 제한하며 SLA(서비스 수준 계약)가 없습니다.
...
| 서유럽 | 13.95.155.53, 52.174.49.6, 52.174.49.6, 52.174.54.218 |
