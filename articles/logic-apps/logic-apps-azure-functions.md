...
함수 내에서 논리 앱을 트리거할 수도 있습니다.  이렇게 하려면 수동 트리거를 사용하여 논리 앱을 만들면 됩니다. 자세한 내용은 [호출 가능 끝점인 논리 앱](logic-apps-http-endpoint.md)을 참조하세요.  그러면 함수 내에서 논리 앱으로 보낼 페이로드를 사용하여 수동 트리거 URL로의 HTTP POST를 생성합니다.
