...
BizTalk Services의 전용 포털에서 문제를 모니터링하고 해결할 수 있는 추적 기능을 제공했습니다. Logic Apps는 [Azure Portal](../logic-apps/logic-apps-monitor-your-logic-apps.md) 및 [Operations Management Suite B2B 솔루션](../logic-apps/logic-apps-monitor-b2b-message.md)을 통해 더 풍부한 추적 및 모니터링 기능을 제공하며, 이동 중인 경우에는 사물을 주시하는 모바일 앱을 포함합니다.
