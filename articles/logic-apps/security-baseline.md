...
* [Logic Apps 커넥터 이해](https://docs.microsoft.com/azure/connectors/apis-list)

* [Azure의 서비스 태그 이해](https://docs.microsoft.com/azure/virtual-network/service-tags-overview)

* [ISEs (integration service environment)를 사용 하 여 Azure Logic Apps에서 Azure Virtual Network 리소스에 대 한 액세스 이해](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [ISE 끝점 액세스 이해](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview#ise-endpoint-access)
...
* [ISE에 대 한 액세스를 사용 하도록 설정 하는 방법](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment#enable-access-for-ise)
...
* [Logic Apps에 대 한 인바운드 호출을 보호 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)

* [인바운드 IP 주소를 제한 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [WAF 액세스 로그를 이해 하는 방법](https://docs.microsoft.com/azure/web-application-firewall/ag/web-application-firewall-logs#access-log)
...
* [내부 VNET의 API Management를 Application Gateway와 통합하는 방법](https://docs.microsoft.com/azure/api-management/api-management-howto-integrate-internal-vnet-appgateway)
...
* [Logic Apps에 대 한 Azure Policy 정의 목록](https://docs.microsoft.com/azure/logic-apps/policy-samples)
...
* [Azure Monitor 로그를 설정 하 고 Azure Logic Apps에 대 한 진단 데이터를 수집 하는 방법](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps-log-analytics)
...
* [실행 상태를 모니터링 하 고, 트리거 기록을 검토 하 고, Azure Logic Apps에 대 한 경고를 설정 하는 방법](https://docs.microsoft.com/azure/logic-apps/monitor-logic-apps)
...
* [Azure Monitor의 Log Analytics에서 Azure 활동 로그를 수집 하 고 분석 하는 방법](https://docs.microsoft.com/azure/azure-monitor/platform/activity-log-collect)
...
* [Azure Logic Apps에서 관리 ID를 사용하여 Azure 리소스에 대한 액세스 인증](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [SAS를 사용 하 여 Azure Logic Apps에서 액세스 및 데이터를 보호 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-request-based-triggers)
...
* [Logic Apps에서 데이터를 보호 하 고 액세스 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Azure Key Vault에서 비밀을 설정 하 고 검색 하는 방법](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-portal)
...
* [워크플로 트리거 API 정보](https://docs.microsoft.com/rest/api/logic/workflowtriggers)

* [커넥터 구성 이해](https://docs.microsoft.com/azure/connectors/apis-list])
...
* [Logic Apps에서 인바운드 IP 주소를 제한 하는 방법 이해](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#restrict-inbound-ip-addresses)
...
* [ISE(통합 서비스 환경)를 사용하여 Azure Logic Apps에서 Azure Virtual Network 리소스에 액세스](https://docs.microsoft.com/azure/logic-apps/connect-virtual-network-vnet-isolated-environment-overview)
...
* [Azure Logic Apps에서 액세스 및 데이터 보안](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app)

* [Azure Logic Apps에서 인바운드 HTTPS 요청 수신 및 응답](https://docs.microsoft.com/azure/connectors/connectors-native-reqres#tls-support)

* [Azure Logic Apps에서 HTTP 또는 HTTPS를 통해 서비스 엔드포인트 호출](https://docs.microsoft.com/azure/connectors/connectors-native-http#tls-support)
...
* [Azure를 사용 하 여 미사용 데이터 암호화 이해](https://docs.microsoft.com/azure/security/fundamentals/encryption-atrest)

* [고객 관리 키를 설정 하 여 ISEs (integration service environment)에 대 한 미사용 데이터를 암호화 Azure Logic Apps](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [실행 기록 데이터에 대 한 액세스 보호](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-run-history-data)
...
* [Azure Logic Apps 작업에 대 한 보안 액세스](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Azure Logic Apps의 통합 서비스 환경에 대 한 미사용 데이터 암호화](https://docs.microsoft.com/azure/logic-apps/customer-managed-keys-integration-service-environment)
...
* [모든 Logic Apps 커넥터 목록](https://docs.microsoft.com/connectors/connector-reference/connector-reference-logicapps-connectors)

* [Gmail 커넥터에 대 한 문제 및 제한 사항 이해](https://docs.microsoft.com/connectors/gmail/#known-issues-and-limitations)

* [Google의 개인 정보 취급 방침에 대 한 자세한 정보](https://docs.microsoft.com/azure/connectors/connectors-google-data-security-privacy-policy)
...
* [RBAC를 통해 Logic Apps에 대 한 액세스를 보호 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-logic-app-operations)
...
* [Azure Logic Apps 커넥터에서 만든 연결 차단](https://docs.microsoft.com/azure/logic-apps/block-connections-connectors)
...
* [Azure Logic Apps 용 Azure Resource Manager 템플릿을 배포 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-deploy-azure-resource-manager-templates)
...
* [실행 기록 입력 및 출력에 대 한 액세스 보호](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [매개 변수 입력에 안전 하 게 액세스](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#secure-action-parameters)
...
* [Azure Logic Apps에서 실행 기록의 입력 및 출력 보안](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#obfuscate)

* [매개 변수에 대한 보안 권장 사항](https://docs.microsoft.com/azure/azure-resource-manager/templates/template-best-practices#security-recommendations-for-parameters)

* [Azure Logic Apps에서 매개 변수 입력에 안전 하 게 액세스](https://docs.microsoft.com/azure/logic-apps/logic-apps-securing-a-logic-app#access-to-parameter-inputs)

* [Azure Key Vault를 사용 하 여 배포 중에 보안 매개 변수 값 전달](https://docs.microsoft.com/azure/azure-resource-manager/templates/key-vault-parameter)
...
* [Azure Logic Apps에서 관리 되는 id를 사용 하 여 Azure 리소스에 대 한 액세스를 인증 하는 방법](https://docs.microsoft.com/azure/logic-apps/create-managed-service-identity)
...
* [Azure Logic Apps에 대 한 비즈니스 연속성 및 재해 복구에 대해 자세히 알아보세요.](https://docs.microsoft.com/azure/logic-apps/business-continuity-disaster-recovery-guidance)

* [Azure Resource Manager 템플릿을 사용 하 여 Azure Logic Apps에 대 한 배포를 자동화 하는 방법](https://docs.microsoft.com/azure/logic-apps/logic-apps-azure-resource-manager-templates-overview)
