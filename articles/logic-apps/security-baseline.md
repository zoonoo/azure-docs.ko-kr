...
description: Logic Apps 보안 기준은 Azure 보안 벤치 마크에 지정 된 보안 권장 사항을 구현 하기 위한 절차 지침과 리소스를 제공 합니다.
author: msmbaldwin
...
- [Logic Apps에 대 한 인바운드 호출을 보호 하는 방법](logic-apps-securing-a-logic-app.md#secure-inbound-requests)
...
- [Logic Apps에 대 한 Azure Policy 정의 목록](/azure/logic-apps/policy-samples)
...
- [Azure Monitor의 Log Analytics에서 Azure 활동 로그를 수집 하 고 분석 하는 방법](/azure/azure-monitor/platform/activity-log-collect)
...
- [SAS를 사용 하 여 Azure Logic Apps에서 액세스 및 데이터를 보호 하는 방법](logic-apps-securing-a-logic-app.md#sas)
...
- [Azure AD에 클라이언트 응용 프로그램을 등록 하는 방법](/rest/api/azure/#register-your-client-application-with-azure-ad)
...
- [Azure Logic Apps의 보안 액세스 및 데이터를 요청 기반 트리거에 대 한 인바운드 호출](logic-apps-securing-a-logic-app.md#secure-inbound-requests)

- [Azure Logic Apps-다른 서비스와 시스템에 대 한 아웃 바운드 호출에서 액세스 및 데이터 보호](logic-apps-securing-a-logic-app.md#secure-outbound-requests)
...
- [Azure Resource Manager 템플릿을 사용 하 여 Azure Logic Apps에 대 한 배포 자동화](logic-apps-azure-resource-manager-templates-overview.md)

- [SAS를 사용 하 여 Azure Logic Apps에서 액세스 및 데이터 보호](logic-apps-securing-a-logic-app.md#sas)
