---
title: B2B 메시지에 대 한 추적 쿼리 만들기-Azure Logic Apps
...
ms.locfileid: "72680087"
---
# <a name="create-tracking-queries-for-b2b-messages-in-azure-monitor-logs-for-azure-logic-apps"></a>Azure Logic Apps에 대 한 Azure Monitor 로그에서 B2B 메시지에 대 한 추적 쿼리 만들기

[Azure Monitor 로그](../log-analytics/log-analytics-overview.md)를 사용 하 여 추적 중인 AS2, X12 또는 EDIFACT 메시지를 찾기 위해 특정 조건에 따라 작업을 필터링 하는 쿼리를 만들 수 있습니다. 예를 들어 특정 교환 컨트롤 번호에 따라 메시지를 찾을 수 있습니다.
...
* 아직 설치 하지 않은 경우 [Azure Monitor 로그에 진단 데이터를 게시](../logic-apps/logic-apps-track-b2b-messages-omsportal.md) 하 고 [Azure Monitor 로그에서 메시지 추적을 설정](../logic-apps/logic-apps-track-b2b-messages-omsportal.md)합니다.
...
1. 쿼리 편집 상자에 찾으려는 필드 이름을 입력합니다. 입력을 시작하면 쿼리 편집기에 사용할 수 있는 가능한 일치 및 작업이 표시됩니다. 쿼리를 만든 후에 **실행**을 선택하거나 Enter 키를 누릅니다.
   ...
   [Azure Monitor 로그에서 데이터를 찾는 방법](../log-analytics/log-analytics-log-searches.md)에 대해 자세히 알아보세요.
