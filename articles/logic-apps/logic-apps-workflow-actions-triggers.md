...
|-----------------|----------------|------------|  
|200|\(없음\)|워크플로를 실행하여 정의된 되풀이 이후에 콘텐츠가 더 있는지를 다시 확인합니다.|  
|200|10|워크플로를 실행하고 10초 후 더 많은 내용에 대해 다시 확인합니다.|  
|202|60|워크플로를 트리거하지 않습니다. 정의된 되풀이 간격에 따라 1분 후에 다음 시도를 합니다. 정의된 되풀이 간격이 1분 이내이면 retry-after 헤더가 우선적으로 적용됩니다. 그렇지 않으면 정의된 되풀이 간격을 따릅니다.|  
|400|\(없음\)|잘못된 요청이며 워크플로를 실행하지 않습니다. **다시 시도 정책**이 정의되지 않으면 기본 정책이 사용됩니다. 다시 시도 횟수에 도달하면 트리거는 정의된 되풀이 이후에 콘텐츠가 더 있는지 다시 확인합니다.|  
|500|\(없음\)|서버 오류이며 워크플로를 실행하지 않습니다.  **다시 시도 정책**이 정의되지 않으면 기본 정책이 사용됩니다. 다시 시도 횟수에 도달하면 트리거는 정의된 되풀이 이후에 콘텐츠가 더 있는지 다시 확인합니다.|  
