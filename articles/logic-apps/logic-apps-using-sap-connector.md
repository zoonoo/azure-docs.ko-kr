...
* [.NET Framework 4.0-Windows 64 비트 (x64)를 사용 하 여 컴파일된 Microsoft .NET 3.0.22.0에 대 한 최신 버전인 SAP Connector (NCo 3.0)](https://support.sap.com/en/product/connectors/msnet.html)를 설치 해야 합니다. 이전 버전에서는 호환성 문제가 발생할 수 있습니다. 자세한 내용은 [SAP 클라이언트 라이브러리 버전](#sap-library-versions)을 참조 하세요.
