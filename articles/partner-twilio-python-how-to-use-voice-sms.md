...
> [!IMPORTANT]
> 전화 번호는 '+' 및 국가 코드로 포맷해야 합니다. 예를 들어 +16175551212(E.164 형식)가 있습니다. Twilio는 서식이 지정되지 않은 미국 번호도 허용합니다. 예를 들어 (415) 555-1212 또는 415-555-1212가 있습니다.
