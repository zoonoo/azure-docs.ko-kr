...
* 되풀이 앱 작업을 실행 합니다. 예를 들어, Twitter에서 피드로 데이터를 주기적으로 수집 합니다.

* 매일 로그 잘라내기, 백업 수행 및 기타 유지 관리 태스크와 같은 일상적인 유지 관리를 수행 합니다.
...
* [Azure Scheduler에 대 한 계획 및 청구](scheduler-plans-billing.md)
* [Azure Scheduler를 사용 하 여 복잡 한 일정 및 고급 되풀이 빌드](scheduler-advanced-complexity.md)
