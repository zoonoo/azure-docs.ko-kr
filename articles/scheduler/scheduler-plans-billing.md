...
* 작업 컬렉션의 작업에 [HTTP 아웃바운드 권한 부여 개체](scheduler-outbound-authentication.md)
...
Standard 작업 컬렉션이 하나이고 Premium 작업 컬렉션이 하나라면 Standard 청구 단위 1개 *와* Premium 청구 단위 1개가 청구됩니다. 스케줄러 서비스는 Standard 또는 Premium 버전으로 설정된 활성 작업 컬렉션의 수에 따라 청구되며 이에 대해서는 다음 두 섹션에서 상세히 설명하겠습니다.
