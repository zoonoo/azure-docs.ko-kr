...
|**Premium**|작업 컬렉션당 50개 작업|1분당 1회. 1분에 한 번 이상 작업을 실행할 수 없습니다.|구독에서 Premium 작업 컬렉션 수에 제한이 없습니다.|스케줄러의 모든 기능 액세스|
...
단일 작업에서 작업 컬렉션 안의 모든 작업을 비활성화할 수 있으나 작업 컬렉션의 청구 상태가 바뀌지는 않으며 작업 컬렉션은 _여전히_ 청구됩니다. 마찬가지로 빈 작업 컬렉션도 활성 상태로 간주되어 청구됩니다.

## 가격

가격 세부 정보는 [스케줄러 가격 책정](http://azure.microsoft.com/pricing/details/scheduler/)을 참조하십시오.
