...
# Azure 클래식 포털에서 Azure 스케줄러 사용 시작

## 시작

Azure 스케줄러에서 쉽게 작업 및 작업 컬렉션을 만들 수 있습니다. 이 자습서에서는 작업 저장하는 데 사용할 작업 컬렉션 만들기, 작업 컬렉션에 작업 만들기, 사용 가능한 작업 모니터링 및 관리 작업 개요를 단계별로 안내합니다. 이전에 Azure를 사용한 경험이 있어야 이 자습서를 사용할 수 있습니다.

Azure 클래식 포털을 처음으로 열면 **모든 항목** 탭이 자동으로 표시됩니다. **모든 항목** 탭의 열은 정렬할 수 있습니다. 스케줄러 작업 및 작업 컬렉션을 보려면**스케줄러** 탭을 클릭합니다.
...
5.  화살표 키를 클릭하여 작업 컬렉션을 만들고 다음 단계로 이동하여 작업을 만듭니다.
