...
| *tenant* |필수입니다. Azure AD 테넌트의 테넌트 식별자입니다. |
| *audience* |필수입니다. 이 값은 https://management.core.windows.net/. |
...
| *tenant* |Azure AD 테넌트의 테넌트 식별자입니다. |
| *audience* |이 값은 https://management.core.windows.net/. |
