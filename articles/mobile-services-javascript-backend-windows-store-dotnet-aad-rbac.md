...
>[AZURE.NOTE] 이 자습서에서는 권한 부여 방식을 포함하여 인증에 대한 다양한 지식 정보를 제공합니다. 이 자습서 이전에 Azure Active Directory 인증 공급자를 사용하여 [인증 시작] 자습서를 완료해야 합니다. 이 자습서에서는 [인증 시작] 자습서에서 사용된 TodoItem 응용 프로그램을 계속 업데이트합니다.
...
1. 모바일 서비스에 대한 로컬 저장소의 ./service/shared/ 디렉토리에  *rbac.js*라는 새 스크립트 파일을 만듭니다.
