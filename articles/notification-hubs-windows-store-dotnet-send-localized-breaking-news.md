...
3.  [Windows 스토어 클라이언트 앱 빌드][Windows 스토어 클라이언트 앱 빌드]
...
템플릿은 [알림 허브 지침][알림 허브 지침] 문서에서 자세한 내용을 알아볼 수 있는 매우 강력한 기능입니다. 템플릿 표현 언어에 대한 참조는 [Windows 스토어용 알림 허브 방법][Windows 스토어용 알림 허브 방법]을 참조하십시오.
