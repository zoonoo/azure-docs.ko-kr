...
이 자습서에서는 Windows Phone 8.0 및 Windows Phone 8.1Silverlight 앱이 지원됩니다. Windows Phone 8.1 스토어 앱의 경우 [이 항목의 Windows 스토어 버전](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md)을 참조하세요.
...
[푸시 알림 시작]: mobile-services-javascript-backend-windows-phone-get-started-push.md
