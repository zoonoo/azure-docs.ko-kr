...
이 자습서에서는 Windows Phone 8.0 및 Windows Phone 8.1("Silverlight") 앱이 지원됩니다. Windows Phone 8.1 스토어 앱의 경우 [이 항목의 Windows 스토어 버전](mobile-services-javascript-backend-windows-store-dotnet-push-notifications-app-users.md)을 참조하세요.
