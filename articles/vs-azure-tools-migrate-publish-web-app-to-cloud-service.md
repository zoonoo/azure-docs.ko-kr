...
> [!NOTE]
> 이 토픽은 웹 사이트가 아닌 클라우드 서비스에 배포에 대한 것입니다. 웹 사이트에 배포에 대한 자세한 내용은 [Azure 앱 서비스에서 웹앱 배포](app-service-web/web-sites-deploy.md)를 참조하세요.
> 
> 
