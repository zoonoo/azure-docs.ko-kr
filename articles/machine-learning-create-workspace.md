...
Microsoft Azure Machine Learning 작업 영역(ML 작업 영역)에는 실험을 관리하고 게시하는 데 필요한 도구가 있습니다. 기계 학습 작업 영역에 대한 자세한 내용은 링크를 참조하세요.
...
3.  ML 작업 영역이 만들어진 후에는 **기계 학습** 페이지에 나열됩니다.
