...
Microsoft Azure 기계 학습 작업 영역에는 실험을 관리하고 게시하는 데 필요한 도구가 있습니다. 기계 학습 작업 영역에 대한 자세한 내용은 링크를 참조하세요.
## 작업 영역 만들기 ##
...
2. **빠른 생성** 페이지에서 다음을 수행합니다.
	1. 작업 영역 정보를 입력합니다.    
	> [AZURE.NOTE] **작업 영역 소유자**는 Microsoft 계정 이름(name@outlook.com) 또는 조직 계정 이름입니다.
