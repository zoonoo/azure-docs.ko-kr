...
이 자습서에서는 PTVS 샘플 템플릿 중 하나를 사용하여 간단한 설문 조사 응용 프로그램을 만들어 보겠습니다. 이 자습서는 [비디오](https://www.youtube.com/watch?v=qUtZWtPwbTk)로도 제공됩니다.
...
1.  PTVS 샘플 VSIX의 프로젝트 테플릿은 **Python**, **샘플**에서 사용할 수 있습니다.  **Polls Flask Web Project**를 선택하고 확인을 클릭하여 프로젝트를 만듭니다.
