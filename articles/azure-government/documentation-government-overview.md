...
### <a name="<a-name="overview"></a>encryption-at-rest"></a><a name="Overview"></a>휴지 상태의 암호화
미사용 데이터 암호화는 디스크 저장소에 보관된 고객 콘텐츠 보호에 적용됩니다. 이는 여러 가지 방법으로 발생할 수 있습니다.

### <a name="<a-name="overview"></a>storage-service-encryption"></a><a name="Overview"></a>저장소 서비스 암호화
...
### <a name="<a-name="overview"></a>client-side-encryption"></a><a name="Overview"></a>클라이언트 쪽 암호화
...
### <a name="<a-name="overview"></a>encryption-in-transit"></a><a name="Overview"></a>전송 중 암호화
...
### <a name="<a-name="overview"></a>best-practices-for-encryption"></a><a name="Overview"></a>암호화에 대한 모범 사례
...
### <a name="<a-name="overview"></a>best-practices-for-managing-secrets"></a><a name="Overview"></a>암호 관리 모범 사례
...
### <a name="<a-name="overview"></a>environment-isolation"></a><a name="Overview"></a>환경 격리
...
#### <a name="<a-name="overview"></a>per-customer-isolation"></a><a name="Overview"></a>고객별 격리
