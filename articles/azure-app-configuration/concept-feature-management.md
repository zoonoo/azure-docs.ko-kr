...
* **프로덕션에서 테스트**: 기능 플래그를 사용 하 여 프로덕션의 새 기능에 대 한 초기 액세스 권한을 부여할 수 있습니다. 예를 들어 이 액세스 권한은 팀 구성원 또는 내부 베타 테스터로만 제한할 수 있습니다. 이러한 사용자는 테스트 환경에서 시뮬레이션된 환경 또는 부분 환경이 아닌 완전한 프로덕션 환경을 사용하게 됩니다.
