...
2. 새 `Settings` 클래스를 정의하고 구현하는 Controllers 디렉터리에 *Settings.cs* 파일을 추가합니다. 네임스페이스를 프로젝트의 이름으로 바꿉니다. 
...
1. 새 구성 설정을 확인하려면 브라우저 페이지를 새로 고칩니다. 변경 내용을 반영하려면 두 번 이상 새로 고치거나 자동 새로 고침 빈도를 5분 미만으로 변경해야 할 수 있습니다. 
