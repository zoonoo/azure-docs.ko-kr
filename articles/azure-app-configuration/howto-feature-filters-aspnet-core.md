...
1. **편집** 화면에서 **기능 플래그 사용** 단추가 선택 되어 있지 않으면 선택 합니다. 그런 다음 **기능 필터 사용** 단추를 클릭 하 고 **사용자 지정** 을 선택 합니다. 
...
1. 기능 필터 키 옆에 있는 상황에 맞는 메뉴를 클릭 합니다. **필터 매개 변수 편집** 을 클릭 합니다.
...
> [대상 그룹에 대 한 기능의 스테이징 된 롤아웃 사용](./howto-targetingfilter-aspnet-core.md)
