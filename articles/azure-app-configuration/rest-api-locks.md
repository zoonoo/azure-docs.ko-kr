...
ms.locfileid: "93424310"
---
# <a name="locks"></a>잠금

api-version: 1.0

이 API는 키-값 리소스에 대 한 잠금/잠금 해제 의미 체계를 제공 합니다. 다음 작업을 지원 합니다.
...
## <a name="lock-key-value"></a>잠금 Key-Value
...
## <a name="unlock-key-value"></a>Key-Value 잠금 해제
...
## <a name="conditional-lockunlock"></a>조건부 잠금/잠금 해제

경합 상태를 방지 하려면 `If-Match` 또는 `If-None-Match` 요청 헤더를 사용 합니다. `etag`인수는 키 표현의 일부입니다. `If-Match`또는 `If-None-Match` 이 생략 된 경우에는 작업이 무조건 수행 됩니다.
