...
이 빠른 시작에서는 기능 플래그를 만들고, [App Configuration 공급자](/dotnet/api/Microsoft.Extensions.Configuration.AzureAppConfiguration)를 통해 Azure Functions 앱에서 사용했습니다.
