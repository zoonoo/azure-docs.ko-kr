...
권한 부여 단계를 수행 하려면 하나 이상의 RBAC 역할을 보안 주체에 할당 해야 합니다. Azure 앱 구성은 앱 구성 리소스에 대 한 권한 집합을 포함 하는 RBAC 역할을 제공 합니다. 보안 주체에 할당 된 역할에 따라 보안 주체에 제공 되는 사용 권한이 결정 됩니다. RBAC 역할에 대 한 자세한 내용은 [Azure 앱 구성에 대 한 Azure 기본 제공 역할](#azure-built-in-roles-for-azure-app-configuration)을 참조 하세요. 
