---
title: Azure 관리 ID와 통합 자습서 | Microsoft Docs
description: 이 자습서에서는 Azure 관리 ID를 사용하여 Azure App Configuration을 인증하고 액세스 권한을 얻는 방법을 알아봅니다.
