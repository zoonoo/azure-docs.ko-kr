...
로컬로 빌드하는 경우 [Azure CLI](/cli/azure/install-azure-cli)가 아직 없으면 Azure CLI를 다운로드하여 설치합니다.

클라우드 빌드를 수행하려면(예: Azure DevOps) 빌드 시스템에 [Azure CLI](/cli/azure/install-azure-cli)가 설치되어 있어야 합니다.
