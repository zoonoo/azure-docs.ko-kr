...
| Node.js | - [API 참조](/javascript/api/@azure/keyvault-secrets/?view=azure-node-latest)<br>- [npm 패키지](https://www.npmjs.com/package/@azure/keyvault-secrets)<br>- [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/keyvault/keyvault-secrets)<br>- [빠른 시작](../secrets/quick-create-node.md) |- [API 참조](/javascript/api/@azure/keyvault-keys/?view=azure-node-latest)<br>- [npm 패키지](https://www.npmjs.com/package/@azure/keyvault-keys)<br>- [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/keyvault/keyvault-keys)<br>- [빠른 시작](../keys/quick-create-node.md)| - [API 참조](/javascript/api/@azure/keyvault-certificates/?view=azure-node-latest)<br>- [npm 패키지](https://www.npmjs.com/package/@azure/keyvault-certificates)<br>- [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/keyvault/keyvault-certificates)<br>- [빠른 시작](../certificates/quick-create-node.md) |  - [API 참조](/javascript/api/@azure/arm-keyvault/?view=azure-node-latest)<br>- [npm 패키지](https://www.npmjs.com/package/@azure/arm-keyvault)<br>- [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/keyvault/arm-keyvault)
