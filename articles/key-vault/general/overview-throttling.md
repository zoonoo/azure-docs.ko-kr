...
키 볼트는 원래 [Azure 키 볼트 서비스 제한에](service-limits.md)지정된 제한으로 만들어졌습니다.  키 볼트의 풋레이를 최대화하려면 처리량을 최대화하기 위한 몇 가지 권장 지침/모범 사례를 소개합니다.
