...
Azure Portal를 통해 Azure Active Directory에서 그룹을 만드는 방법에 대 한 자세한 내용은 [기본 그룹 만들기 및 멤버 추가](/azure/active-directory/fundamentals/active-directory-groups-create-azure-portal) 를 참조 하세요.
