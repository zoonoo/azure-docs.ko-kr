...
|Azure SQL Database|[Azure SQL Database 및 Azure Synapse 분석에 대 한 Bring Your Own Key 지원으로 투명한 데이터 암호화](../../azure-sql/database/transparent-data-encryption-byok-overview.md?view=sql-server-2017&viewFallbackFrom=azuresqldb-current)합니다.|
