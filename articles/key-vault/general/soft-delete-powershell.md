...
> [!IMPORTANT]
> 키 자격 증명 모음에 대해 '일시 삭제'를 사용하도록 설정하는 것은 복구 불가능한 작업입니다. 일시 삭제된 속성을 "true"로 설정한 후에는 해당 속성을 변경하거나 제거할 수 없습니다.  
...
- 삭제된 상태의 인증서를 제거합니다. 
  ...
  > [!IMPORTANT]
  > 인증서를 제거하면 인증서가 영구적으로 삭제되며 복구할 수 없습니다!
