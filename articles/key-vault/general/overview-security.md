...
Azure Key Vault 네트워크 주소에 대 한 자세한 내용은 [Azure Key Vault에 대 한 Virtual network 서비스 끝점](overview-vnet-service-endpoints.md)검토)
...
- [Azure Key Vault에 대 한 가상 네트워크 서비스 끝점](overview-vnet-service-endpoints.md))
