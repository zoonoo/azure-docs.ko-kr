...
보안 응용 프로그램의 경우 Azure에 배포 된 응용 프로그램에 관리 되는 id를 사용 하는 것이 좋습니다. 관리 id를 지원 하지 않는 Azure 서비스 또는 온-프레미스에 배포 된 응용 프로그램의 경우 인증서를 사용 하는 [서비스 주체](https://docs.microsoft.com/azure/active-directory/develop/howto-create-service-principal-portal) 를 사용할 수 있습니다. 인증서를 Key Vault 저장 하 고 자주 회전 해야 합니다. 

보안을 사용 하는 서비스 주체는 개발 및 테스트 환경에 사용할 수 있으며 로컬 또는 Cloud Shell 사용자 보안 주체가 권장 됩니다.

응용 프로그램 개발의 경우 코드를 변경 하지 않고도 다양 한 환경 및 플랫폼에서 Azure Id SDK를 사용할 수 있습니다. Azure Id는 Azure CLI, Visual Studio, Visual Studio Code 및 다른 사용자와 통합 됩니다. 
