...
![현재 블레이드를 사용하여 프라이빗 엔드포인트를 추가하는 방법을 보여 주는 스크린샷](../media/private-link-service-3.png)
!['프라이빗 엔드포인트 만들기(미리 보기)' 페이지의 예를 보여 주는 스크린샷](../media/private-link-service-4.png)
