...
- 명령줄 인터페이스 버전 0.9.1 이상. 최신 버전을 설치하고 Azure 구독에 연결하려면 [Azure 플랫폼 간 명령줄 인터페이스 설치 및 구성](xplat-cli.md)을 참조하세요.
...
- [Azure 플랫폼 간 명령줄 인터페이스를 설치 및 구성하는 방법](xplat-cli.md)
...
Azure 플랫폼 간 명령줄 인터페이스 구성에 대한 자세한 내용은 [Azure 플랫폼 간 명령줄 인터페이스를 설치 및 구성하는 방법](xplat-cli.md)을 참조하세요.
