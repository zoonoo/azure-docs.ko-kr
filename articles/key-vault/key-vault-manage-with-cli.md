---
title: CLI를 사용하여 주요 자격 증명 모음 관리 | Microsoft Docs
...
* 명령줄 인터페이스 버전 0.9.1 이상. 최신 버전을 설치하고 Azure 구독에 연결하려면 [Azure 플랫폼 간 명령줄 인터페이스 설치 및 구성](../xplat-cli-install.md)을 참조하세요.
...
* [Azure 플랫폼 간 명령줄 인터페이스를 설치 및 구성하는 방법](../xplat-cli-install.md)
...
Azure 플랫폼 간 명령줄 인터페이스 구성에 대한 자세한 내용은 [Azure 플랫폼 간 명령줄 인터페이스를 설치 및 구성하는 방법](../xplat-cli-install.md)을 참조하세요.
...
> [!NOTE]
> Windows 명령 프롬프트에서 실행하는 경우 작은따옴표를 큰따옴표로 바꾸고 내부 큰따옴표를 이스케이프해야 합니다(예: "["decrypt","sign"]").
> 
> 
