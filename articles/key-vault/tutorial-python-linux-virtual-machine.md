...
ms.locfileid: "53720575"
---
# <a name="tutorial-how-to-use-azure-key-vault-with-azure-linux-virtual-machine-in-python"></a>자습서: Python의 Azure Linux Virtual Machine에서 Azure Key Vault 사용하는 방법
...
다음은 이름이 "Sample.py"인 예제 파일에 불과합니다. 이 예제는 [requests](https://pypi.org/project/requests/2.7.0/) 라이브러리를 사용하여 HTTP GET 호출을 수행합니다.
