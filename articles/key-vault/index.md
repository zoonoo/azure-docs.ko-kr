        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>웹 응용 프로그램에서 Key Vault 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>종단 간 키 회전 및 감사를 사용하여 Azure Key Vault 설정</h3>
                    </div>
                </div>
            </div>
        </div>
...
[Azure CLI를 사용하는 Key Vault](/cli/azure/keyvault)
