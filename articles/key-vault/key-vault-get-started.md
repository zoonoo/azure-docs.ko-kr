...
>[AZURE.NOTE]  새로운 주요 자격 증명 모음을 만들려고 할 때 **구독 'Microsoft.KeyVault' 네임스페이스를 사용하기 위한 구독이 등록되지 않았습니다**라는 오류가 나타나는 경우 `Register-AzureRmResourceProvider -ProviderNamespace "Microsoft.KeyVault"`을(를) 실행한 다음, [New-AzureRmKeyVault] 명령을 다시 실행합니다. 자세한 내용은 [Register-AzureRmResourceProvider](https://msdn.microsoft.com/library/azure/mt759831\(v=azure.300\).aspx)를 참조하세요.
>
