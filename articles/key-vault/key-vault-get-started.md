...
- Microsoft Azure 구독. 계정이 없는 경우 [무료 계정](https://azure.microsoft.com/pricing/free-trial/)을 등록할 수 있습니다.
...
[New-AzureRmKeyVault](https://msdn.microsoft.com/library/azure/mt603736.aspx) cmdlet을 사용하여 키 자격 증명 모음를 만듭니다. 이 cmdlet은 3개의 필수 매개 변수, **리소스 그룹 이름**, **키 자격 증명 모음 이름** 및 **지리적 위치**가 있습니다.
...
>[AZURE.NOTE]  새로운 키 자격 증명 모음을 만들려고 할 때 **구독 'Microsoft.KeyVault' 네임스페이스를 사용하기 위한 구독이 등록되지 않았습니다**라는 오류가 나타나는 경우 `Register-AzureRmResourceProvider -ProviderNamespace "Microsoft.KeyVault"`을(를) 실행한 다음, New-AzureRmKeyVault 명령을 다시 실행합니다. 자세한 내용은 [Register-AzureRmProvider](https://msdn.microsoft.com/library/mt679020.aspx)를 참조하세요.
>
...
응용 프로그램이 자격 증명 모음의 키 또는 암호에 대한 액세스를 인증하려면 [Set-AzureRmKeyVaultAccessPolicy](https://msdn.microsoft.com/library/azure/mt603625.aspx) cmdlet을 사용합니다.
...
주요 자격 증명 모음 및 이를 포함하는 키나 암호가 더 이상 필요하지 않은 경우 [Remove-AzureRmKeyVault](https://msdn.microsoft.com/library/azure/mt619485.aspx) cmdlet을 사용하여 주요 자격 증명 모음을 삭제할 수 있습니다.
...
Azure 주요 자격 증명 모음에 대한 최신 Azure PowerShell cmdlet의 목록은 [Azure 주요 자격 증명 모음 Cmdlet](https://msdn.microsoft.com/library/azure/dn868052.aspx)을 참조하세요.
