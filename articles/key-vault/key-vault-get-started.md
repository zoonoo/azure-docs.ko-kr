...
- **Key Vault를 사용하도록 구성할 수 있는 응용 프로그램**. 샘플 응용 프로그램은 [Microsoft 다운로드 센터](https://www.microsoft.com/download/details.aspx?id=45343)에서 사용할 수 있습니다. 자세한 내용은 해당 **추가 정보** 파일을 참조하세요.
