...
3. **리소스** > 만들기 엔터프라이즈 통합ServiceBus > 를 선택 하 고 필요한 세부 정보를 입력 합니다.
...
**조건 추가**를 선택합니다. 조건에서 고급 편집기로 전환 하 고 다음 코드를 입력 합니다. *APP_ID* 을 웹 앱의 실제 앱 ID로 바꿉니다.
