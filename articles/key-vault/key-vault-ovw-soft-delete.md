...
소프트 삭제 기능은 [처음에 REST,](/rest/api/keyvault/) [CLI,](key-vault-soft-delete-cli.md) [PowerShell](key-vault-soft-delete-powershell.md) 및 [.NET/C#](/dotnet/api/microsoft.azure.keyvault?view=azure-dotnet) 인터페이스를 통해 사용할 수 있습니다.
...
새 키 자격 증명 모음을 만들 때 기본적으로 소프트 삭제가 설정됩니다. [Azure CLI](key-vault-soft-delete-cli.md) 또는 [Azure Powershell을](key-vault-soft-delete-powershell.md)통해 소프트 삭제 없이 키 자격 증명 모음을 만들 수 있습니다. 키 자격 증명 모음에서 소프트 삭제를 사용하도록 설정하면 비활성화할 수 없습니다.
...
지우기 보호는 키 높이 뛰기(Key Vault)라는 선택적 동작이며 **기본적으로 활성화되지 않습니다.** [CLI](key-vault-soft-delete-cli.md#enabling-purge-protection) 또는 [Powershell을](key-vault-soft-delete-powershell.md#enabling-purge-protection)통해 켜질 수 있습니다.
