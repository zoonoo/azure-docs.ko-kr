...
마지막 코드 변경은 Application\_Start 메서드입니다. 먼저 GetCert() 메서드를 호출하여 ClientAssertionCertificate를 로드해야 합니다. 그런 다음 새 KeyVaultClient를 만들 때 제공한 콜백 메서드를 변경합니다. 이 코드는 위의 코드를 대체합니다.
