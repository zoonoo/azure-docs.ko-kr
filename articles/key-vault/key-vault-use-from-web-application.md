...
이제 주요 자격 증명 모음 API를 호출하고 암호를 검색하는 코드가 필요합니다. 다음 코드는 사용하기 전에 호출되기만 하면 아무 곳에나 배치할 수 있습니다. 이 경우 시작 시 한 번 실행되어 응용 프로그램에서 암호를 사용할 수 있도록 Global.asax의 응용 프로그램 시작 이벤트에 이 코드를 배치했습니다.
...
이러한 명령을 실행하면 Azure AD에서 응용 프로그램을 볼 수 있습니다. 앱 등록을 검색할 때 검색 대화 상자에서 "모든 앱" 대신 **내 앱**을 선택해야 합니다. 
...
더 이상 필요하지 않은 경우 자습서에 사용된 앱 서비스, 키 자격 증명 모음 및 Azure AD 응용 프로그램을 삭제합니다.  
