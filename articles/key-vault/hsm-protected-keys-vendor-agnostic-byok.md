...
자세한 내용 및 키 볼트(HSM 로 보호된 키에 대한 키 자격 증명 모음을 만드는 방법 포함)를 사용하여 시작하는 자습서에 대한 자세한 [내용은 Azure 키 자격 증명 모음이란 무엇입니까?](key-vault-overview.md)
...
| 요구 사항 | 자세한 정보 |
| --- | --- |
| Azure 구독 |Azure 키 자격 증명 모음에서 키 자격 증명 모음을 만들려면 Azure 구독이 필요합니다. [무료 평가판에 등록하십시오.](https://azure.microsoft.com/pricing/free-trial/) |
