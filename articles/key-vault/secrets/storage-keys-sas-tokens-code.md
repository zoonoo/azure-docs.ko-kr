...
- [키 자격 증명 모음 및 Azure CLI](overview-storage-keys.md) 또는 Azure [PowerShell을](overview-storage-keys-powershell.md)사용하여 저장소 계정 키를 관리하는 방법에 대해 알아봅니다.
