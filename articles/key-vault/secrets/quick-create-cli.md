...
이제 해당 URI를 사용하여 Azure Key Vault에 추가한 이 암호를 참조할 수 있습니다. **'https://Contoso-Vault2.vault.azure.net/secrets/ExamplePassword '** 를 사용하여 현재 버전을 가져옵니다. 
