...
비밀에 대한 자세한 내용은 [비밀 정보](about-secrets.md)를 참조하세요.
...
Azure CLI 및 PowerShell을 사용하여 Key Vault를 만들 수도 있습니다.
- [PowerShell을 사용하여 Key Vault 만들기](../general/quick-create-powershell.md)
