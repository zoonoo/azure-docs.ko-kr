...
nCipher Security는 금융 서비스, 첨단 기술, 제조, 정부 및 기술 부문에 대 한 데이터 암호화 및 사이버 보안 솔루션의 선두 글로벌 공급자입니다. 회사 및 정부 정보를 보호 하는 40 년 추적 레코드를 사용 하 여 nCipher 보안 암호화 솔루션은 최대 5 개의 에너지 및 항공 회사에서 사용 됩니다. 또한 해당 솔루션은 22 개 NATO 국가/지역에서 사용 되며 전 세계의 지불 트랜잭션 80 이상으로 보호 됩니다.
