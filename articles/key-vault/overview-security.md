...
Azure 키 볼트 네트워크 주소에 대한 자세한 내용은 [Azure 키 볼트에 대한 가상 네트워크 서비스 끝점을](key-vault-overview-vnet-service-endpoints.md) 검토합니다.
...
- [Azure Key Vault의 가상 네트워크 서비스 엔드포인트](key-vault-overview-vnet-service-endpoints.md)
- [RBAC: 기본 제공 역할](../role-based-access-control/built-in-roles.md)
- [Azure 키 볼트에 대한 가상 네트워크 서비스 끝점](key-vault-overview-vnet-service-endpoints.md)
