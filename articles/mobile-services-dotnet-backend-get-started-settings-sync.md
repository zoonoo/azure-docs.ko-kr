...
# 모바일 서비스에서 플랫폼 간 설정 동기화 시작


>[WACOM.NOTE] 이 콘텐츠는 아직 준비되지 않았지만 알려드리고 싶었습니다. 이 항목에 특히 관심이 있을 경우 [@AzureMobile]로 트윗하거나 [포럼] 또는 [UserVoice]에 게시하여 알려주세요.
