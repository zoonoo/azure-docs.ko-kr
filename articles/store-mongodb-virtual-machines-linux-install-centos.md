...
[MongoDB](http://www.mongodb.org/)는 대중적인 오픈 소스의 고성능 NoSQL 데이터베이스입니다. Azure 관리 포털을 사용하면 CentOS Linux를 실행하는 가상 컴퓨터를 이미지 갤러리에서 만들 수 있습니다. 그런 다음, MongoDB 데이터베이스를 가상 컴퓨터에 설치하고 구성할 수 있습니다.
