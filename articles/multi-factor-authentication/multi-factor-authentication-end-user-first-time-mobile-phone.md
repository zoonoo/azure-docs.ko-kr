---
title: Azure MFA와 함께 연락 방법으로 휴대폰 사용
...
<li>다음을 클릭합니다.</li>
<li>지금 확인 단추를 클릭합니다. 이렇게 하면 휴대폰으로 전화를 걸거나 문자를 발송합니다. 사용자가 직접 작업해야 합니다. 선택한 모드(문자 또는 전화)에 따라 응답이 달라질 수 있습니다. <ul><li>문자 모드를 선택한 경우 6자리 코드가 문자로 전송됩니다. 브라우저에 표시되는 상자에 이 코드를 입력합니다.</li> <li>전화 모드를 선택한 경우 전화를 받습니다. 휴대폰에서 # 기호를 사용하여 전화에 응답합니다.</li></ul>
<li>다음을 클릭합니다.</li>
