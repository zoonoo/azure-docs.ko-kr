...
기본 연락 방법으로 휴대폰을 사용하려는 경우 이 문서를 사용할 수 있습니다. 이 문서에서는 기본 연락 방법으로 휴대폰 전화 또는 문자를 사용하도록 다단계 인증을 설정하는 과정을 안내합니다.

## 휴대폰을 연락 방법으로 사용하려면
<ol>
<li>드롭다운 메뉴에서 인증 전화를 선택합니다.</li>
...
<li>다음을 클릭합니다.</li>
<li>지금 확인 단추를 클릭합니다. 이렇게 하면 휴대폰으로 전화를 걸거나 문자를 발송합니다. 사용자가 직접 작업해야 합니다. 선택한 모드(문자 또는 전화)에 따라 응답이 달라질 수 있습니다. <ul><li>문자 모드를 선택한 경우 6자리 코드가 문자로 전송됩니다. 브라우저에 표시되는 상자에 이 코드를 입력합니다.</li> <li>전화 모드를 선택한 경우 전화를 받습니다. 휴대폰에서 # 기호를 사용하여 전화에 응답합니다.</li></ul> <li>다음을 클릭합니다.</li> <li>이제 연락 방법을 설정했으므로 비브라우저 앱(예: Outlook 2010 또는 이전 버전)의 앱 암호를 설정해야 합니다. 이러한 앱을 사용하지 않는 경우 **완료**를 클릭합니다. 그렇지 않은 경우 다음 단계를 계속 진행합니다. <li>이러한 앱을 사용하는 경우 제공된 앱 암호를 복사합니다.</li>
