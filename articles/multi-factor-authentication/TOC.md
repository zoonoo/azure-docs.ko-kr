...
## [클라우드의 MFA](../active-directory/authentication/howto-mfa-getstarted.md)
## [온-프레미스에서 MFA](../active-directory/authentication/howto-mfaserver-deploy.md)
...
## [보안 모범 사례](../active-directory/authentication/multi-factor-authentication-security-best-practices.md)

# 방법
## 배포 및 사용
### [설정 구성](../active-directory/authentication/howto-mfa-mfasettings.md)
### [MFA 보고서](../active-directory/authentication/howto-mfa-reporting.md)
