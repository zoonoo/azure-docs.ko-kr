...
---
# <a name="configure-azure-multi-factor-authentication-server-to-work-with-with-ad-fs-in-windows-server-2012-r2"></a>Windows Server 2012 R2에서 AD FS와 작동하도록 Azure Multi-Factor Authentication 서버 구성
