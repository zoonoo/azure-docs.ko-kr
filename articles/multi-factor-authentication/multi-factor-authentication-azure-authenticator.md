...
![클라우드](./media/multi-factor-authentication-azure-authenticator/addaccount.png)
...
기존 앱에서 개별 계정을 제거하는 방법을 모르시나요? 계정을 탭합니다. "삭제" 옵션이 표시됩니다.

![클라우드](./media/multi-factor-authentication-azure-authenticator/remove.png)
