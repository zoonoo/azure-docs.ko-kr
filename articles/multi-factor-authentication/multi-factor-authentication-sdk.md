---
title: Azure Active Directory와 온-프레미스 ID 통합
...
> [!NOTE]
> Multi-Factor Authentication을 구현 하는 경우 기본 인증 방법을 보완하기 위해 보조 또는 3차 확인으로 추가 요소를 사용합니다. 이 메서드는 기본 인증 방법으로 사용할 수 없습니다.
> 
> 
