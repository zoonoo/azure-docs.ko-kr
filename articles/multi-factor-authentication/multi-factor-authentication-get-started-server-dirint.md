...
| ... (특성 선택) 단추 |각 특성 필드 옆에는 특성 선택 대화 상자를 표시할 수 있는 "..." 단추가 있으며 이를 통해 목록에서 특성을 선택할 수 있습니다. <br><br>특성 대화 상자를 선택합니다.<br><br>참고: 특성은 수동으로 입력할 수 있으며 특성 목록의 특성과 일치할 필요는 없습니다. |
...
> [!TIP]
> 동기화 항목을 제거한 후에는 전체 동기화를 실행해야 합니다.  동기화 항목의 순서를 지정한 후에는 전체 동기화를 실행해야 합니다.  전체 동기화를 실행하려면 지금 동기화 단추를 클릭합니다.
> 
> 

## <a name="multifactor-auth-servers"></a>Multi-Factor Auth 서버
