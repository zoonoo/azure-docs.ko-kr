...
## <a name="methods-available-for-multi-factor-authentication"></a>다단계 인증에 사용할 수 있는 방법
...
가격 책정에 대한 자세한 내용은 [Azure MFA 가격 책정](https://azure.microsoft.com/pricing/details/multi-factor-authentication/)

조직에 가장 적합한 사용자 단위 또는 소비 기반 모델을 선택합니다.   그런 다음 시작하려면 [시작](multi-factor-authentication-get-started.md)
