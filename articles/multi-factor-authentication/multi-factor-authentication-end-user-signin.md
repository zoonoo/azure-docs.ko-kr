---
title: Azure Multi-Factor Authentication을 사용할 경우 Azure MFA 로그인 환경
...
> [!NOTE]
> 이 페이지에 제공된 다음의 문서는 일반적인 로그인 환경을 보여줍니다. 로그인 관련 지원은 [Azure Multi-Factor Authentication에 문제가 있는 경우](multi-factor-authentication-end-user-manage-settings.md)를 참조하세요.
> 
> 
