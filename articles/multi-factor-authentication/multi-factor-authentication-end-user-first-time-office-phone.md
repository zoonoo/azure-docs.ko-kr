...
<li>다음을 클릭합니다.</li>
<li>지금 확인 단추를 클릭합니다. 이렇게 하면 사무실 전화로 전화를 겁니다. 가까운 곳에 있어야 합니다. <li>다음을 클릭합니다.</li> <li>이제 연락 방법을 설정했으므로 비브라우저 앱(예: Outlook 2010 또는 이전 버전)의 앱 암호를 설정해야 합니다. 이러한 앱을 사용하지 않는 경우 **완료**를 클릭합니다. 그렇지 않은 경우 다음 단계를 계속 진행합니다. <li>이러한 앱을 사용하는 경우 제공된 앱 암호를 복사합니다.</li>
