---
title: Azure Multi-Factor Authentication 및 Active Directory Federation Services 시작
...
|:--- |:--- |:--- |
| Azure Multi-Factor Authentication을 사용하여 Azure AD 리소스 보안 유지 |<li>인증의 첫 단계는 AD FS를 사용하여 온-프레미스에서 수행됩니다.</li> <li>두 번째 단계는 클라우드 인증을 사용하여 수행되는 휴대폰 기반 방법입니다.</li> |
| Active Directory Federation Services를 사용하여 Azure AD 리소스 보안 유지 |<li>인증의 첫 단계는 AD FS를 사용하여 온-프레미스에서 수행됩니다.</li><li>두 번째 단계는 클레임을 적용하여 온-프레미스에서 수행됩니다.</li> |
