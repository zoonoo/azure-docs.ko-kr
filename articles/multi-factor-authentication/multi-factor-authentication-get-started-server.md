---
title: "Azure Multi-Factor Authentication 서버로 시작하기"
...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication 서버로 시작하기
<center>![클라우드](./media/multi-factor-authentication-get-started-server/server2.png)</center>
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication 서버 다운로드
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Azure 포털에서 Azure Multi-Factor Authentication 서버를 다운로드하려면
- - -
1. 관리자 권한으로 Azure 포털에 로그인합니다.
2. 왼쪽에서 Active Directory를 선택합니다.
3. Active Directory 페이지의 위쪽에서 **Multi-Factor Auth 공급자**
4. 아래쪽에서 **관리**
5. 그러면 새 페이지가 열립니다.  **다운로드**
   ![다운로드](./media/multi-factor-authentication-sdk/download.png)를 클릭합니다.
6. **정품 인증 자격 증명 생성** 위의 **다운로드**
   ![다운로드](./media/multi-factor-authentication-get-started-server/download4.png)를 클릭합니다.
7. 다운로드 파일을 저장합니다.

### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>서비스 설정을 통해 Azure Multi-Factor Authentication 서버를 다운로드하려면
1. 관리자 권한으로 Azure 포털에 로그인합니다.
2. 왼쪽에서 Active Directory를 선택합니다.
3. Azure AD 인스턴스를 두 번 클릭합니다.
4. 위쪽에서 **구성**
   ![다운로드](./media/multi-factor-authentication-sdk/download2.png)를 클릭합니다.
...
7. 그러면 새 페이지가 열립니다.  **다운로드**
8. **정품 인증 자격 증명 생성** 위의 **다운로드**를 클릭합니다.
9. 다운로드 파일을 저장합니다.

## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication 서버 설치 및 구성
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Azure Multi-Factor Authentication 방화벽 요구 사항
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication 서버를 설치 및 구성하려면
- - -
...
### <a name="to-import-users-from-active-directory"></a>Active Directory에서 사용자를 가져오려면
- - -
...
### <a name="configuring-email-and-email-templates"></a>전자 메일 및 전자 메일 템플릿 구성
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Azure Multi-Factor Authentication 서버에서 사용자 데이터를 처리하는 방법
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>고급 Azure Multi-Factor Authentication 서버 구성
