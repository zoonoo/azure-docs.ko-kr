<properties
    pageTitle="Azure MFA 개요 | Microsoft Azure"
...
>[AZURE.NOTE] 다음 비교 표는 각 구독에 포함된 기능을 설명합니다. Azure AD Premium 또는 Enterprise Mobility Suite가 있는 경우 [클라우드 또는 온-프레미스에서 MFA를 사용하는지](multi-factor-authentication-get-started.md)에 따라 일부 기능을 사용할 수 없을 수 있습니다.
