<properties
	pageTitle="IntelliJ용 Azure 도구 키트 설치 | Microsoft Azure"
...
## 설정 대화 상자에서 IntelliJ용 Azure 도구 키트를 설치하려면
...
1. **Browse repositories** 대화 상자에서 검색 상자에 "Azure"를 입력합니다. **Azure Toolkit for IntelliJ**를 강조 표시하고 **설치**를 클릭합니다.
...
1. IntelliJ IDEA를 다시 시작할지 또는 연기할지 묻는 메시지가 나타나면 **Restart**를 클릭합니다.
    ...
    ![IntelliJ IDEA 다시 시작][07]

## 시작 화면에서 IntelliJ용 Azure 도구 키트를 설치하려면
