...
[Azure 기계 학습을 사용한 예측 솔루션 개발][Azure 기계 학습을 사용한 예측 솔루션 개발] 자습서의 5번째 단계입니다.
...
2.  연결된 **모델 학습** 및 **모델 점수 매기기** 모듈을 삭제합니다.
...
![라이브 환경으로 서비스 수준 올리기][라이브 환경으로 서비스 수준 올리기]

------------------------------------------------------------------------

**다음: [웹 서비스 액세스][웹 서비스 액세스]**
  ...
  [실험 목록]: ./media/machine-learning-walkthrough-5-publish-web-service/publish1.png
  [학습된 모델 점수 매기기]: ./media/machine-learning-walkthrough-5-publish-web-service/publish2.png
  [라이브 환경으로 서비스 수준 올리기]: ./media/machine-learning-walkthrough-5-publish-web-service/publish3.png
