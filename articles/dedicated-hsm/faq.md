...
No. Azure Dedicated HSM은 가상 네트워크 내에서만 액세스할 수 있습니다.
...
No. Dedicated HSM은 고객의 개인 IP 주소 공간에 직접 프로비전되어 다른 Azure 또는 Microsoft 서비스에서 액세스할 수 없습니다.
...
No. Microsoft에는 고객에게 할당된 Dedicated HSM에 저장된 키에 대한 액세스 권한이 없습니다.
