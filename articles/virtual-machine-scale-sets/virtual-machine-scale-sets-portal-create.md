<properties
	pageTitle="크기 집합 CLI 포털 만들기 | Microsoft Azure"
...
포털에서 CentOS, CoreOS, Debian, Open Suse, Red Hat Enterprise Linux, SUSE Linux Enterprise Server 또는 Ubuntu Server 이미지를 사용하여 크기 집합을 쉽게 배포할 수 있습니다.
...
* 원하는 리소스 그룹 이름 및 위치를 입력한 다음 `OK`을 클릭합니다.
...
* `Summary` 블레이드에서 유효성 검사 작업이 완료되면 `OK`을 클릭합니다.
