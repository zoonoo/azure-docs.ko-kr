...
- 많은 VM을 배포하려는 경우 Compute 코어 할당량 제한을 늘려야 할 수 있습니다.
...
[Azure CLI](https://github.com/Azure/azure-cli) _az vmss create_ 명령을 사용하여 대규모 VM 확장 집합을 만들 수 있습니다. 이 명령은 _instance-count_ 인수를 기반으로 한 서브넷 크기와 같은 지능형 기본값을 설정합니다.
