...
## <a name="add-an-alert-to-your-vm-scale-set"></a>VM 규모 집합에 경고 추가
다음은 VM 규모 집합에 경고를 추가하는 방법을 보여 주는 PowerShell 스크립트입니다. [Azure Monitor 자동 크기 조정 공용 메트릭](../monitoring-and-diagnostics/insights-autoscale-common-metrics.md)문서를 참조하여 경고를 시작할 메트릭의 이름을 가져옵니다.
