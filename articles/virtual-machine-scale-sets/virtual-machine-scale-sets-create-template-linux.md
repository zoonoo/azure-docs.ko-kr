---
title: Azure 템플릿을 사용하여 Linux 가상 머신 확장 집합 만들기 | Microsoft Docs
...
이 시작 문서에서는 Azure 템플릿을 사용하여 Linux 확장 집합을 만들고, 사용자 지정 스크립트 확장을 사용하여 VM 인스턴스에서 기본 Python 웹 서버를 설치했습니다. 확장성 및 자동화를 향상시키려면 다음 방법 문서를 사용하여 확장 집합을 확장합니다.
