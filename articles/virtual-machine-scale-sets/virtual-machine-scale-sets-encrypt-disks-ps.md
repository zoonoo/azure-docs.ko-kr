...
암호화 명령을 포함하는 최신 버전의 [Azure Powershell](https://github.com/Azure/azure-powershell/releases)을 설치합니다.
...
다음 명령을 사용하여 실행 중인 가상 머신 확장 집합에서 암호화를 사용하지 않도록 설정합니다. 실행 중인 [Windows 확장 집합](https://github.com/Azure/azure-quickstart-templates/tree/master/201-decrypt-vmss-windows) 또는 [Linux 확장 집합](https://github.com/Azure/azure-quickstart-templates/tree/master/201-decrypt-vmss-linux)에서 템플릿을 사용하여 암호화를 사용하지 않도록 설정할 수도 있습니다.
