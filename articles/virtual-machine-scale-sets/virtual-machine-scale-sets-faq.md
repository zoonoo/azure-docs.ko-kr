...
Azure Portal의 가상 컴퓨터 확장 집합에서 VM 수를 변경하려면 VM 확장 집합 속성 섹션에서 "크기 조정" 블레이드를 설정하고 슬라이더 막대를 사용합니다. 다른 방법으로 인스턴스 수를 변경하려면 [가상 컴퓨터 확장 집합의 인스턴스 수 변경](https://msftstack.wordpress.com/2016/05/13/change-the-instance-count-of-an-azure-vm-scale-set/)을 참조하세요.
