...
Azure의 역할 기반 액세스 제어를 사용하여 웹 앱 배포에 대한 액세스를 관리하는 방법은 [RBAC 및 Azure 웹 사이트 게시](http://azure.microsoft.com/blog/2015/01/05/rbac-and-azure-websites-publishing)를 참조하세요.
