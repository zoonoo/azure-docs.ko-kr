---
title: Azure API에서 FHIR® 진단 로깅 사용
...
이 문서에서는 Azure API for FHIR®에 대해 감사 로그를 사용 하도록 설정 하는 방법을 알아보았습니다. 다음으로, FHIR 용 Azure API에서 구성할 수 있는 다른 추가 설정에 대해 알아봅니다.
