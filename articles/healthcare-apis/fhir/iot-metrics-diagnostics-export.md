...
이 문서에서는 신속한 의료 상호 운용성 리소스 (FHIR&#174;) * 메트릭 로그를 위해 Azure IoT 커넥터를 내보내는 방법에 대해 알아봅니다. 메트릭 로깅을 사용 하도록 설정 하는 기능은 Azure Portal의 [**진단 설정**](../../azure-monitor/essentials/diagnostic-settings.md) 입니다. 
