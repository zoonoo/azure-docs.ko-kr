...
클라이언트 응용 프로그램은 [REST API](https://www.hl7.org/fhir/http.html)를 통해 FHIR 용 Azure API에 액세스할 수 있습니다. 요청을 보내고, 응답을 확인 하 고, 응용 프로그램을 빌드하는 동안 디버그 하려면 선택한 API 테스트 도구를 사용 합니다. 이 자습서에서는 [Postman](https://www.getpostman.com/)을 사용 하 여 FHIR 서버에 액세스 하는 단계를 안내 합니다. 
