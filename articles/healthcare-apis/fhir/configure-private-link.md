...
>
>Azure API for FHIR에 대해 감사 로그 및 메트릭 내보내기가 사용 하도록 설정 된 경우 포털에서 **진단 설정을** 통해 내보내기 설정을 업데이트 합니다.
...
FHIR 리소스에 대 한 개인 끝점을 만들면 해당 리소스에 대 한 공용 트래픽이 자동으로 비활성화 되지 않습니다. 이렇게 하려면 FHIR 리소스를 업데이트 하 여 새 "공용 액세스" 속성을 "Enabled"에서 "Disabled"로 설정 해야 합니다. 올바르게 구성 된 개인 끝점에서 제공 하지 않는 FHIR 서비스에 대 한 모든 요청이 거부 되므로 공용 네트워크 액세스를 사용 하지 않도록 설정할 때 주의 해야 합니다. 개인 끝점의 트래픽만 허용 됩니다.

:::image type="content" source="media/private-link/private-link-disable.png" alt-text="공용 네트워크 액세스를 사용 하지 않도록 설정 합니다.":::
