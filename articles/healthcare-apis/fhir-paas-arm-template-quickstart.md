...
description: 이 빠른 시작에서는 Azure Resource Manager 템플릿을 사용하여 Azure API for FHIR®(Fast Healthcare Interoperability Resources)을 배포하는 방법을 알아봅니다.
author: mgblythe
...
4. 새 **서비스 이름**을 입력하고, Azure API for FHIR의 **위치**를 선택합니다. 위치는 리소스 그룹의 지역과 같거나 다를 수 있습니다.
    ...
    :::image type="content" source="./media/fhir-paas-arm-template-quickstart/deploy-azure-api-fhir.png" alt-text="Azure Portal에서 ARM 템플릿을 사용하여 Azure API for FHIR 서비스를 Azure에 배포합니다.":::
