...
- [Azure 구독에 대한 Azure Cosmos DB 리소스 공급자 등록](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#register-resource-provider) 
- [AKV 인스턴스 구성](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#configure-your-azure-key-vault-instance)
-  [AKV 인스턴스에 액세스 정책 추가](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#add-an-access-policy-to-your-azure-key-vault-instance)
- [AKV에서 키 생성](https://docs.microsoft.com/azure/cosmos-db/how-to-setup-cmk#generate-a-key-in-azure-key-vault)
...
:::image type="content" source="media/bring-your-own-key/bring-your-own-key-keypicker.png" alt-text="Azure API for FHIR 만들기" 블레이드에서 아래와 같은 키 암호화 선택 항목(서비스 또는 고객 관리형 키)이 표시됩니다. 구성 옵션을 선택한 후에는 수정할 수 없습니다. 그러나 키는 수정하고 업데이트할 수 있습니다.

:::image type="content" source="media/bring-your-own-key/bring-your-own-key-database.png" alt-text="Azure API for FHIR 만들기":::
