...
## <a name="enable-metric-logging-for-the-azure-iot-connector-for-fhir-preview"></a>FHIR (미리 보기)에 대 한 Azure IoT 커넥터에 메트릭 로깅 사용
...
6. FHIR 용 Azure IoT 커넥터 및 FHIR 용 Azure API에 대해 캡처할 추가 메트릭 범주에 대 한 **오류, 트래픽 및 대기 시간** 을 선택 합니다.
