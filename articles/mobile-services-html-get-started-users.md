<properties pageTitle="인증 시작(HTML 5) | 모바일 개발자 센터" description="모바일 서비스를 사용하여 Google, Facebook, Twitter, Microsoft 등의 다양한 ID 공급자를 통해 HTML 앱 사용자를 인증하는 방법에 대해 알아봅니다." services="mobile-services" documentationCenter="" authors="ggailey777" manager="dwrede" editor=""/>
...
3. (선택 사항) 사용하는 웹 브라우저용 스크립트 디버거를 열고 페이지를 다시 로드합니다. 액세스 거부 오류가 발생하는지 확인합니다. 
