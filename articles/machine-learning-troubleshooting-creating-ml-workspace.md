...
새 Azure ML 작업 영역을 만들 때 작업 영역 소유자 필드에 입력한 ID는 유효한 Microsoft 계정(이전의 Windows Live ID)이어야 합니다. 예: <john-contoso@live.com> 또는 <john-contoso@hotmail.com> 회사 전자 메일 계정과 같은 타사 계정을 사용할 수 없습니다. 무료 Microsoft 계정을 만들려면 [www.live.com][]으로 이동합니다.
...
Microsoft는 Azure ML 환경을 가능한 한 매끄럽게 만들기 위해 노력하고 있습니다. 의견이나 문제가 있을 경우 더 나은 서비스를 제공할 수 있도록 아래 또는 [Azure ML 포럼][]에 게시해 주세요.
  ...
  [Azure ML 포럼]: http://social.msdn.microsoft.com/Forums/windowsazure/en-US/home?forum=MachineLearning
