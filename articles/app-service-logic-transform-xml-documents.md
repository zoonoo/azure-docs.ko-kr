...
## 새로운 BizTalk 변환 API 앱 만들기

1.	Azure 포털에 로그인한 다음 시작 보드(홈페이지)로 이동합니다.

2.	**새로 만들기** > **웹 + 모바일** > **Azure 마켓플레이스** > **API 앱**을 선택합니다.

	   ![][1]
 
	또는 시작 보드에서 **마켓플레이스**를 선택한 다음 사용 가능한 목록에서 **API 앱**을 선택할 수 있습니다.

	   ![][2]
 
3.	**변환**을 입력하고 **BizTalk 변환 서비스**를 선택하여 BizTalk 변환을 찾습니다.

	   ![][4] 
 
4.	**BizTalk 변환 서비스** 블레이드에서 **만들기**를 선택합니다.

       ![][5]
 
5.	**새 API 앱** 블레이드에 다음 정보를 입력하고 **만들기**를 선택합니다.

	- 이름 - 변환 API 앱의 이름을 지정합니다. 
	- 앱 서비스 계획 - 앱 서비스 계획을 선택하거나 새로 만듭니다. 
	- 가격 책정 계층 - 이 앱이 상주할 가격 책정 계층을 선택합니다. 
	- 리소스 그룹 - 앱이 상주할 리소스 그룹을 선택하거나 만듭니다. 
	- 위치 - 앱을 배포할 지리적 위치를 선택합니다.
	
	   ![][6]

6.	**만들기**를 선택합니다. 몇 분 내에 BizTalk 변환 API 앱이 만들어집니다. 
...
맵이 작성 및 테스트되고 나면 사용할 준비가 완료되었습니다. 사용자가 새 논리 앱을 만들 수 있습니다(**새로 만들기** > **논리 앱**).

1. 논리 앱 내의 오른쪽 갤러리에서 BizTalk 변환을 사용할 수 있습니다. 갤러리에서 **BizTalk 변환 서비스**를 선택합니다. 변환이 흐름에 추가됩니다.

	![][11]

2. **변환** 작업을 선택합니다. 입력 매개 변수가 표시됩니다.

	![][12]

3. 다음 매개 변수를 입력하여 **변환** 작업 구성을 완료합니다.
