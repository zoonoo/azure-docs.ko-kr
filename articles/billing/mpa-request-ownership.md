...
[Azure RBAC(역할 기반 액세스 제어)](../role-based-access-control/overview.md)를 사용하여 할당된 기존 사용자, 그룹 또는 서비스 사용자에 대한 액세스는 이전 중에 영향을 받지 않습니다. 파트너는 구독에 대한 새 RBAC 액세스를 얻지 않습니다.  
