---
title: "Microsoft Azure 리소스 사용에 대한 통찰력 얻기 | Microsoft Docs"
...
---
# <a name="gain-insights-into-your-microsoft-azure-resource-consumption"></a>Microsoft Azure 리소스 소비에 대한 통찰력 얻기
...
## <a name="introducing-the-azure-resource-usage-and-ratecard-apis"></a>Azure 리소스 사용량 및 RateCard API 소개
...
* **사전 소비 비용 분석** – 고객은 RateCard API 사용하여 원하는 사용 수치를 제공함으로써 워크로드를 Azure에 이동하면 얼마가 청구되는지 예측할 수 있습니다. 고객이 다른 클라우드 또는 사설 클라우드에 기존 워크로드를 가진 경우 Azure 속도로 사용을 매핑하여 예상된 Azure 소비를 더 잘 예측할 수 있습니다. 청구 파트너가 제품을 피벗하고 약정 금액 및 금액 크레딧을 포함하여 종량제뿐만 아니라 다른 제품 유형 간에 비교/대조하는 기능을 제공하는 한편 이것은 [Azure 가격 책정 계산기](https://azure.microsoft.com/pricing/calculator/)를 통해 확인할 정보 보기를 향상시킵니다. 또한 API는 지역별로 비용 측정 변경을 수행하는 기능을 제공합니다. 이는 전세계에 서로 다른 도시에서 리소스를 배포하면 총비용에 직접적인 영향을 줄 수 있으므로 배포를 결정하는 데 필요한 가상 분석 유형을 사용합니다.
* **가상 분석** -
...
* Azure Resource Manager에서 제공하는 API 집합인 두 API에 대한 자세한 내용은 [Azure 청구 REST API 참조](https://msdn.microsoft.com/library/azure/1ea5b323-54bb-423d-916f-190de96c6a3c)를 확인하세요.
