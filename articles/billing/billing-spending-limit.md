...
예를 들어 구독에 포함된 모든 크레딧을 소비하는 경우 배포한 Cloud Services가 프로덕션에서 제거되고 Azure 가상 컴퓨터가 중지되고 할당이 취소됩니다. 저장소 계정 및 데이터베이스의 데이터는 읽기 전용으로 사용할 수 있습니다.
...
1. 구독을 선택합니다.
1. 지출 한도에 도달하여 구독이 비활성화된 경우 "구독이 지출 한도에 도달하여 요금이 부과되지 않도록 비활성화되었습니다."라는 알림을 클릭합니다. 그렇지 않으면 **구독 상태** 영역에서 **지출 한도 제거**를 클릭합니다.
1. 적절한 옵션을 선택합니다.
...
일부 [Microsoft 서비스 및 타사 브랜드 서비스](billing-understand-your-azure-marketplace-charges.md)의 경우 지출 한도가 설정되어 있어도 결제 방법에 따라 요금이 발생할 수 있습니다. Visual Studio 라이선스, Azure Active Directory Premium, 지원 플랜 및 [Azure Marketplace](https://azure.microsoft.com/marketplace/)에서 판매되는 대부분의 타사 브랜드 서비스를 예로 들 수 있습니다.
