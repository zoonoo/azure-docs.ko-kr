...
## <a name="incorrect-overage-invoice"></a>잘못된 초과분 청구서

잘못된 초과분 청구서가 있다고 생각되는 경우 Azure 사용 요금을 조정하는 방법에 대한 [Azure 기업계약 요금의 이해](billing-understand-your-bill-ea.md)를 참조하세요. Microsoft에서 부과한 초과분 청구서가 잘못되었다고 생각되는 경우 고객 지원팀에 문의하세요.

## <a name="change-a-po-number-for-an-overage-invoice"></a>초과분 청구서의 PO 번호 변경

EA 관리자가 청구서 날짜 전에 PO(구매 주문) 번호를 설정하지 않으면 Azure EA Portal에서 자동으로 기본 PO 번호를 생성합니다. EA 관리자는 Azure EA Portal에 로그인하고 **보고서**로 이동하여 PO 번호를 업데이트할 수 있습니다. EA 관리자는 PO 번호를 업데이트할 수 있습니다. PO 번호를 보여주는 오른쪽 위 섹션에서 연필 기호를 클릭하고 정보를 업데이트하면 됩니다.

EA 관리자는 청구서가 만들어지기 전까지 현재 청구 분기 중에 PO 번호를 업데이트할 수 있습니다. 또한 자동화된 청구서 알림 이메일을 받은 후 최대 7일 이내에 PO 번호를 업데이트할 수 있습니다.

EA 관리자가 PO 번호를 업데이트하지 않았고 새 PO 번호가 필요한 경우에 선택할 수 있는 유일한 방법은 크레딧 및 재청구를 완료하는 것입니다. 고객이 PO 번호를 업데이트해야 하는 경우 파트너에게 도움을 요청하세요.
...
청구서 및 요금을 이해하는 방법에 대한 자세한 내용은 [Azure 기업계약 요금의 이해](billing-understand-your-bill-ea.md)를 참조하세요.
...
![가격표 정보를 보여주는 예제](./media/billing-ea-portal-enrollment-invoices/ea-create-view-price-sheet-information.png)
...
![이전 가격표를 다운로드하는 위치를 보여주는 예제](./media/billing-ea-portal-enrollment-invoices/create-ea-view-price-sheet-download-historical-price-list.png)
...
_별도 청구 요금_ 및 _Azure Marketplace 서비스_는 Azure Marketplace 플랫폼을 통해 배포되는 타사 서비스입니다. 두 서비스의 주요 차이점은 타사 게시자를 통해 설정된 계약 체계에 따른 청구 방법입니다.

타사 사용량은 **별도 청구 요금** 아래의 청구서에 표시됩니다. 사용량만큼 Azure 현금 약정 금액의 잔액이 감소합니다. 타사 서비스 목록을 보려면 [Azure Marketplace 타사 재판매인 서비스에서 이제 Azure 현금 약정 금액을 사용함](https://azure.microsoft.com/updates/azure-marketplace-third-party-reseller-services-now-use-azure-monetary-commitment/)을 참조하세요.

**Azure Marketplace** 아래에 표시되는 청구서의 사용량에 대한 요금은 별도로 청구되며 현금 약정 금액을 사용하지 않습니다. 그러나 마켓플레이스, 초과분 및 별도 청구 요금을 비롯한 모든 요금은 단일 청구서에 통합됩니다.

Azure 자사 초과분 및 Azure 타사 마켓플레이스 구매에 대한 단일 청구서가 발송됩니다.

현금 약정 금액이 모두 소진되면 사용량에 대한 월별 또는 분기별 요금이 청구됩니다. 2018년 5월 전에 시작된 등록의 경우 150% 현금 약정 금액 임계값 규칙이 적용되고 초과분 요금은 분기별로 청구됩니다. 2018년 5월 이후에 시작된 등록의 경우 모든 초과분 요금이 월별로 청구됩니다.
