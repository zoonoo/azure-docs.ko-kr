...
### <a name="step-3-add-your-office-365-organizational-accounts-as-admins-to-the-azure-subscription"></a>3단계: 관리자로 Office 365 조직 계정을 Azure 구독에 추가
   
Azure 구독에 관리자를 추가하려면 [구독 또는 서비스를 관리하는 Azure 관리자 역할 추가 또는 변경](billing-add-change-azure-subscription-administrator.md)을 참조하세요.
