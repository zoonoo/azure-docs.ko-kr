---
title: Azure App Service 격리 스탬프에 예약 할인이 적용되는 방법
...
- 비용 절감을 위해 사전 구매 App Service 격리 스탬프 예약 용량에 대해 자세히 알아보려면 [예약된 용량으로 Azure App Service 격리 인지세를 선불로 결제](billing-prepay-app-service-isolated-stamp.md)를 참조하세요.
