---
title: Azure 예약 용량으로 SQL Data Warehouse 요금에 대한 비용 절감
...
[Azure Portal](https://portal.azure.com/#blade/Microsoft_Azure_Reservations/ReservationsBrowseBlade)에서 Azure SQL Data Warehouse 예약 용량을 구매할 수 있습니다. 예약 요금은 [사전 결제 또는 월별 결제](billing-monthly-payments-reservations.md)로 처리할 수 있습니다. 예약 용량을 구입할 수 있는 조건은 다음과 같습니다.
...
예약 구매에 대해 엔터프라이즈 고객 및 종량제 고객에게 요금이 청구되는 방법에 대한 자세한 내용은 [엔터프라이즈 등록에서 Azure 예약 사용량 이해](billing-understand-reserved-instance-usage-ea.md) 및 [종량제 구독의 Azure 예약 사용량 이해](billing-understand-reserved-instance-usage.md)를 참조하세요.
...
- Azure SQL Data Warehouse에 예약 할인이 적용되는 방법에 대해 자세히 알아보려면 [Azure SQL Data Warehouse에 예약 할인이 적용되는 방법](billing-prepay-sql-data-warehouse-charges-with-reserved-capacity.md)을 참조하세요.
