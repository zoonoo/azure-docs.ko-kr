...
| Managed Disk <sup>1</sup>  | 표준 관리 디스크/스냅숏(GB) - 로컬 중복 | 표준 관리 디스크/스냅숏(GB) - 무료 | ad94c237-52a5-4804-ae65-38c5bf85ef42
...
<sup>2</sup> 공유 미터는 여러 서비스를 통해 사용할 수 있습니다. 예를 들어 가상 머신과 저장소는 모두 데이터 송신(GB) 미터에 대해 사용량을 내보냅니다.
