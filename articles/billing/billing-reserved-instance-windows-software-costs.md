---
title: Azure Reservation Windows 소프트웨어 비용 | Microsoft Docs
...
ms.locfileid: "39630114"
---
# <a name="windows-software-costs-not-included-with-azure-reservations"></a>Azure Reservations에 포함되지 않는 Windows 소프트웨어 비용
