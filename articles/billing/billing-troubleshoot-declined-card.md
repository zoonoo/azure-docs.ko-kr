...
ms.locfileid: "69657061"
---
# <a name="troubleshoot-a-declined-card-at-azure-sign-up"></a>Azure 등록 시 거부된 카드 문제 해결

이 문서는 Azure Portal 또는 Azure 계정 센터에서 Azure 등록 시 신용 카드가 거부된 문제를 해결하는 데 도움이 됩니다. 문제 해결을 시작하기 전에 다음 사항을 확인합니다.

- Azure 계정 프로필에 제공한 정보(예: 연락처 이메일, 주소, 전화 번호)가 정확한지 확인합니다.
...
다음에는 Azure 등록 시 신용 카드가 거부될 수 있는 일반적인 문제가 나열되어 있습니다.
