...
Microsoft 고객 계약의 [청구 프로필](billing-mca-overview.md#billing-profiles)마다 청구서가 생성됩니다. 청구 프로필 소유자, 기여자, 독자 또는 청구서 관리자여야 Azure Portal에서 청구서를 다운로드할 수 있습니다.
