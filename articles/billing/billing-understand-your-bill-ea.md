...
## <a name="invoices-for-most-customers"></a>대부분의 고객의 청구서

이 섹션에서는 Azure 고객에 게 오스트레일리아, 일본 또는 싱가포르에 적용 되지 않습니다. 있는 경우 해당 국가/지역 중 하나를 참조 하세요 [다른 고객의 청구서](#invoices-for-other-customers)합니다.

다음 중 하나가 청구 기간 동안 발생 하는 경우 Azure 청구서를 나타납니다.
...
- **Marketplace 요금**: Azure Marketplace 구매 및 사용 현황 조직의 크레딧에서 다루지 않습니다. 따라서 있습니다 송장이 발급 되는 Marketplace 요금에 대 한 신용 잔액에 관계 없이 합니다. Enterprise Portal에 엔터프라이즈 관리자를 사용 하도록 설정 하 고 Marketplace 구매를 사용 하지 않도록 설정할 수 있습니다.

## <a name="review-charges-for-most-customers"></a>대부분의 고객에 대 한 검토 요금
이 섹션에서는 Azure 고객에 게 오스트레일리아, 일본 또는 싱가포르에 적용 되지 않습니다. 있는 경우 해당 국가 중 하나를 참조 하세요 [다른 고객에 대 한 요금을 검토](#review-charges-for-other-customers)합니다.
...
청구서에는 모든 Azure 사용량 요금이 Marketplace 뒤에 표시 됩니다. 크레딧 잔액을 있다면 Azure 사용에 적용 됩니다.
...
1. 사용자 요금에 대 한 자세한 내용은로 이동 **사용량 다운로드**합니다.  
    ![사용량 다운로드 탭을 보여 주는 스크린샷](./media/billing-understand-your-bill-ea/ea-portal-download-usage.png)

## <a name="invoices-for-other-customers"></a>다른 고객의 청구서

이 섹션에서는 Azure 고객에 게 오스트레일리아, 일본 또는 싱가포르에만 적용 됩니다.

다음과 같은 경우에 하나 이상의 Azure 청구서를 받습니다.
...
- **별도 청구 요금**: 조직에서 사용한 서비스가 크레딧에 적용되지 않습니다. 다음 서비스에 대해서는 크레딧 잔액과 관계없이 청구서를 받게 됩니다.
    ...
    - Visual Studio Professional(월간)
    - Visual Studio Professional(연간)
- **Marketplace 요금**: Azure Marketplace의 구매 및 사용이 조직의 크레딧에 적용되지 않으며 요금이 별도로 청구됩니다. Enterprise Portal에 엔터프라이즈 관리자를 사용 하도록 설정 하 고 Marketplace 구매를 사용 하지 않도록 설정할 수 있습니다.

로 인해 청구 금액이 있는 경우 하나의 송장 요금 청구 기간 동안 개별적으로 청구 되는 서비스 초과분에 대 한 표시 합니다. 두 가지 유형의 요금이 포함 됩니다. Marketplaces 요금은 항상 별도로 청구됩니다.

## <a name="review-charges-for-other-customers"></a>다른 고객에 대 한 검토 요금

이 섹션에서는 오스트레일리아, 일본 또는 싱가포르 있는 경우에 적용 됩니다.
...
1. 요금에 대한 자세한 내용을 보려면 **사용량 다운로드** > **고급 보고서 다운로드**로 이동합니다. 보고서는 세금 또는 예약에 대 한 요금이 marketplace 요금에 포함 되지 않습니다.  
      ![다운로드 사용량 탭에서 고급 보고서를 보여 주는 스크린샷 다운로드 합니다.](./media/billing-understand-your-bill-ea/ea-portal-download-usage-advanced.png)
...
1. 사용량 기반 요금에 대한 자세한 내용을 보려면 **사용량 다운로드**로 이동합니다. **마켓플레이스 요금** 아래에서 **다운로드**를 선택합니다. 이 보고서는 세금을 포함하지 않거나 일회성 구매를 보여 줍니다.  
     ![보여 주는 스크린샷 Marketplace 요금에서 옵션을 다운로드 합니다.](./media/billing-understand-your-bill-ea/ea-portal-download-usage-marketplace.png)
...
- [Azure 사용량 및 요금에 보기 및 다운로드](billing-download-azure-daily-usage.md)
