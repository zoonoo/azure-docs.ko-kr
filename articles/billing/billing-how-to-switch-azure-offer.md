...
description: Azure 구독을 변경 하 고 Azure 계정 센터를 사용 하 여 다른 제품으로 전환 하는 방법에 알아봅니다.
author: bandersmsft
manager: amberb
...
---
# <a name="change-your-azure-subscription-to-a-different-offer"></a>Azure 구독을 다른 제품으로 변경

사용 하 여 고객에 게는 [종 량 제 요금으로 개별 구독](https://azure.microsoft.com/offers/ms-azr-0003p/), Azure 구독에서 다른 제품으로 전환할 수 있습니다 합니다 [계정 센터](https://account.windowsazure.com/Subscriptions). 예를 들어 이 기능을 사용하여 [Visual Studio 구독자를 위한 월간 크레딧](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)을 활용할 수 있습니다.

**평가판에서 업그레이드를 원하세요?** 참조 [구독을 업그레이드](billing-upgrade-azure-subscription.md)합니다.

## <a name="whats-supported"></a>지원되는 내용:

개별 구독을 종 량 제 요금으로 전환할 수 있습니다.
...
1. 종 량 제 요금으로 개별 구독을 선택 합니다.
1. **다른 제품으로 전환**을 클릭합니다. 옵션은 종 량 제 요금으로 개별 구독을 보유 하 고 최초 청구 기간이 완료 하는 경우에 사용할 수 있습니다.
...
표시 되지 않을 수는 **다른 제품으로 전환** 옵션을 선택 합니다.

* 없는 [종 량 제 요금으로 구독](https://azure.microsoft.com/offers/ms-azr-0003p/)합니다. 종 량 제 요금을 사용 하 여 현재 구독을 다른 제품으로 변환할 수 있습니다.
  * 있는 경우는 [무료 평가판](https://azure.microsoft.com/free/), 알아봅니다 하는 방법 [종 량 제로 업그레이드](billing-upgrade-azure-subscription.md)합니다.
  * 다른 구독에서 제안을 전환하려면 [지원에 문의](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)하세요.
* 최초 청구 기간이;에서 계속 최초 청구 기간이 끝날 때 제품을 전환할 수까지 기다려야 합니다.
