...
**평가판에서 업그레이드를 원하세요?** [구독 업그레이드](billing-upgrade-azure-subscription.md)를 참조하세요.
...
* [종량제 요금을 사용하는 개별 구독](https://azure.microsoft.com/offers/ms-azr-0003p/)이 없습니다. 현재 종량제 요금을 사용하는 구독만 다른 상품으로 전환할 수 있습니다.
  * [평가판](https://azure.microsoft.com/free/)이 있는 경우 [종량제로 업그레이드](billing-upgrade-azure-subscription.md)하는 방법을 알아보세요.
