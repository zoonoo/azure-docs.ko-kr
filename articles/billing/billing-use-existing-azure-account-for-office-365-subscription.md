...
2. **사용자**를 확장한 다음 **활성 사용자**를 클릭합니다.
    ...
    ![Microsoft 365 관리 센터 사용자의 스크린샷](./media/billing-use-existing-azure-account-office-365-subscription/16-microsoft-365-admin-center-users.png)
