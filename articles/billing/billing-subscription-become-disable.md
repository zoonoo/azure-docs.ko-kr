...
전체 금액에서 미지불된 금액을 결제하면 됩니다. [Azure 구독에 미지불액이 있다는 알림을 받는지 궁금하신가요?](billing-azure-subscription-past-due-balance.md#what-can-you-do-to-resolve-the-issue) 문서를 참조하세요.
