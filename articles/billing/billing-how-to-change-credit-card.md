...
## <a name="add-a-new-credit-or-debit-card-to-an-azure-subscription"></a>Azure 구독에 새 신용 카드나 직불 카드 추가
...
1. 클릭 **활성 설정**합니다.
    ![선택 하 고 활성 설정 하는 신용 카드 또는 직불 카드를 보여 주는 스크린샷.](./media/billing-how-to-change-credit-card/sub-change-active-x.png)
