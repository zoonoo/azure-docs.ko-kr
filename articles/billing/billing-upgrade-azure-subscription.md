...
Azure 체험 계정을 업그레이드할 때 가입할 때부터 30일 동안 남은 크레딧을 유지합니다. 예:  11월 1일에 가입하고 11월 5일에 업그레이드하는 경우 사용되지 않은 크레딧을 11월 30일까지 사용할 수 있습니다. 업그레이드 후 12개월 동안 무료 서비스에도 액세스할 수 있습니다.

1. [Azure 포털](https://portal.azure.com)
1. **구독**을 검색합니다.

    ![검색을 보여주는 스크린샷](./media/billing-upgrade-azure-subscription/search-subscriptions-ibiza.png)
...
계정을 업그레이드했으므로 [Azure 청구 및 비용 관리를 사용하여 예기치 않은 비용 방지](billing-getting-started.md)를 참조하세요.
