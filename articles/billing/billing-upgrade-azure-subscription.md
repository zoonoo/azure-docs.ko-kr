...
1. [Azure 계정 포털](https://account.windowsazure.com/subscriptions)에 로그인합니다.
1. 구독 상태 섹션에서 **지금 업그레이드** 배너를 선택합니다.
...
업그레이드 자체만으로는 비용이 들지 않으며 사용하는 서비스에 대해서만 비용이 청구됩니다. 업그레이드를 확인한 후 평가판 기간이 끝날 때까지 여전히 평가판 크레딧을 유지할 수 있습니다.
