...
- 있는 경우는 [Microsoft 고객 계약](#check-access), 타사 서비스는 Azure 서비스의 rest를 사용 하 여 요금이 청구 됩니다.
...
## <a name="view-and-download-invoices"></a>보기 및 송장을 다운로드합니다

있는 경우는 [Microsoft 고객 계약](#check-access)는 동일한 Azure 요금이 청구서에 타사 요금은 부과 됩니다. 에 대해 알아봅니다 하는 방법 [살펴보고 Azure 청구서를 다운로드할](billing-download-azure-invoice.md) 제 요금의 보려면 Azure portal에서 합니다.
...
## <a name="external-spending-for-ea-customers"></a>EA 고객에 대 한 지출 한도 외부
...
## <a name="manage-payment-for-external-services"></a>외부 서비스에 대 한 결제를 관리 합니다.
