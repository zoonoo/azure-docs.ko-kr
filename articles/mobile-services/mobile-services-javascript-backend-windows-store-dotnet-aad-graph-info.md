...
1. [Azure 관리 포털]에서 모바일 서비스에 대한 새로운 GetUserInfo 사용자 지정 API를 만들고 **Only Authenticated Users**에 대한 get 메서드의 권한을 설정합니다.
...
[사용자 지정 API 자습서]: mobile-services-windows-store-dotnet-call-custom-api.md
[사용자 지정 API 자습서l]: mobile-services-windows-store-dotnet-call-custom-api.md
