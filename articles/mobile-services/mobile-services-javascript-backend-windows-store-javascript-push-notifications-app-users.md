...
<p>이 삽입 스크립트는 사용자 ID 태그를 사용하여 삽입된 항목의 텍스트가 포함된 푸시 알림을 로그인된 사용자가 만든 모든 Windows 스토어 앱 등록으로 전송합니다.</p></li></ol>
...
<!-- URLs. -->
[앱에 인증 추가]: mobile-services-windows-store-javascript-get-started-users.md
[앱에 푸시 알림 추가]: mobile-services-javascript-backend-windows-store-javascript-get-started-push.md
