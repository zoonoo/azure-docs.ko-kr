...
2. **개발자 분석**까지 아래로 스크롤하고 New Relic 구독을 구입한 방법에 따라 다음 중 하나를 수행합니다.
	...
	+ New Relic에서 직접 구입:
		...
		**사용자 지정**을 클릭하고 **공급자**에서 New Relic을 선택하고 키를 입력한 다음 **저장**을 클릭합니다.
...
2. 잠시 기다렸다가 데이터가 처리된 다음 New Relic 대시보드로 이동합니다.
	...
	New Relic 구독을 추가 기능으로 구입했으면 [관리 포털][Azure Management Portal]에서 그 구독을 선택하고 **관리**를 클릭합니다.
...
+ 가격 책정 정보는 [Azure 스토어의 New Relic 페이지](영문)를 참조하십시오.
+ New Relic을 사용하는 방법에 대한 자세한 내용은 New Relic 설명서의 [응용 프로그램 개요]를 참조하십시오. 
...
[소스 제어의 스토어 서버 스크립트]: /develop/mobile/tutorials/store-scripts-in-source-control/
[newrelic]: https://npmjs.org/package/newrelic
[Azure 스토어의 New Relic 페이지]: /gallery/store/new-relic/new-relic/
