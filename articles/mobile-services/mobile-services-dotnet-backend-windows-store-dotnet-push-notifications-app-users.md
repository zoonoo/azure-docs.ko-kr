---
title: 인증된 사용자에게 푸시 알림 보내기(유니버설 Windows 8.1) | Microsoft Docs
...
> 이 항목에 해당하는 모바일 앱 버전은 [방법: 인증된 사용자에게 푸시 알림 보내기](../app-service-mobile/app-service-mobile-dotnet-backend-how-to-use-server-sdk.md#push-user)를 참조하세요.
> 
> 
