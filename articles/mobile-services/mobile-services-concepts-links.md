<properties
	pageTitle="모바일 서비스 개념"
	description="Azure 포털에서 도움말 서랍에 있는 모바일 서비스 개념 항목에 연결됩니다."
...
아래에 링크 항목은 Microsoft Azure 모바일 서비스의 특정 동작에 관한 정보를 제공합니다. 이러한 동일한 항목은 Microsoft Azure 관리 포털의 도움말로 사용할 수 있습니다.

[AZURE.INCLUDE [mobile-services-concepts](../../includes/mobile-services-concepts.md)]

[개요 항목](https://msdn.microsoft.com/library/azure/jj193167.aspx)은 모바일 서비스를 사용할 때의 이점과 관리 포털에서 수행할 수 있는 작업에 대해 설명합니다. 모바일 서비스에 관한 일반 정보와 앱에서 모바일 서비스를 사용하는 방법의 대한 자세한 내용은 [모바일 서비스 자습서 및 리소스](https://azure.microsoft.com/documentation/services/mobile-services/)를 참조하세요.
