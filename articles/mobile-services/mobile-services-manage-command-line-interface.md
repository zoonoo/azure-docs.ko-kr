---
title: 명령줄에서 모바일 서비스 관리 | Microsoft Docs
...
> [!NOTE]
> "목록" 및 "스크립트"와 관련된 CLI의 명령은 JavaScript 백 엔드에서만 작동합니다.
> 
> 
...
> [!NOTE]
> <code>-a</code> 또는 <code>-d</code>와 함께 <code>-q</code> 매개 변수를 지정하지 않을 경우 실행이 일시 중지되고 SQL 데이터베이스에 대한 삭제 옵션을 선택하라는 메시지가 표시됩니다. 데이터베이스나 서버를 사용하는 다른 서비스가 없는 경우 <code>-a</code> 매개 변수만 사용합니다. 그렇지 않으면 <code>-d</code> 매개 변수를 사용하여 삭제되는 모바일 서비스에 속하는 데이터만 삭제합니다.
> 
> 
...
스크립트 등록에 대한 자세한 내용은 [모바일 서비스 서버 스크립트 참조](영문.md)를 참조하십시오.
