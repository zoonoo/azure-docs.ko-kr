---
title: 모바일 서비스에서 오프라인 데이터 사용(Xamarin iOS) | Microsoft Docs
...
> 이 항목에 해당하는 모바일 앱 버전은 [Xamarin.iOS 모바일 앱에 대해 오프라인 동기화 사용](../app-service-mobile/app-service-mobile-xamarin-ios-get-started-offline-data.md)을 참조하세요.
> 
> 
