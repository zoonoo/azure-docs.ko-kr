...
>[AZURE.NOTE] Windows Phone 8.1 스토어 앱으로 푸시 알림을 보내려면 이 자습서의 [Windows 스토어 앱](mobile-services-javascript-backend-windows-universal-dotnet-get-started-push.md) 버전을 참조하세요.
