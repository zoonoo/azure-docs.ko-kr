---
title: 유니버설 Windows 8.1 앱에 푸시 알림 보내기 | Microsoft Docs
...
> 이 항목에 해당하는 모바일 앱 버전은 [Windows 앱에 푸시 알림 추가](../app-service-mobile/app-service-mobile-windows-store-dotnet-get-started-push.md)를 참조하세요.
> 
> 
...
* [구독자에게 브로드캐스트 알림 보내기](../notification-hubs/notification-hubs-windows-notification-dotnet-push-xplat-segmented-wns.md) <br/>관심이 있는 범주에 대해 푸시 알림을 등록하고 받아보는 방법에 대해 알아봅니다.
