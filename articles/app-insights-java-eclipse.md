...
![이름별 요청 수](./media/app-insights-java-track-http-requests/6-barchart.png)
...
![이 요청에 대한 모든 추적](./media/app-insights-java-track-http-requests/7-instance.png)
...
![세션, 사용자 및 페이지 보기](./media/appinsights/appinsights-47usage-2.png)
...
![웹 테스트의 예](./media/appinsights/appinsights-10webtestresult.png)
