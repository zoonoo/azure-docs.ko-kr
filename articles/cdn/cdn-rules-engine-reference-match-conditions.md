...
---
### <a name="country"></a>국가
해당 국가 코드를 통해 국가/지역을 지정할 수 있습니다. 
...
- 국가 일치: 국가 일치 조건을 원하는 국가 집합에 설정 합니다.
   - 허용: 국가 일치 조건을 **맞지** URL 경로 와일드 카드 일치 조건에 정의 된 위치에 저장 된 콘텐츠에 지정 된 국가/지역 액세스만 허용 하도록 합니다.
   - 차단: 국가 일치 조건을 **일치** URL 경로 와일드 카드 일치 조건에 정의 된 위치에 저장 된 콘텐츠에 액세스 하지 못하도록 지정 된 국가/지역 차단 합니다.
