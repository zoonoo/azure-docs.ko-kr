...
PowerShell 스크립트를 연속 배달 구성으로 통합하는 예제는 [Azure 클라우드 서비스에 대한 연속 배달](../cloud-services/cloud-services-dotnet-continuous-delivery.md)을 참조하세요. 
