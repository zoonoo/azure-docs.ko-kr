<properties
	pageTitle="Azure CDN의 실시간 통계 | Microsoft Azure"
...
> [AZURE.TIP]  각 HTTP 상태 코드 옵션에 대한 설명은 [Azure CDN HTTP 상태 코드](https://msdn.microsoft.com/library/mt759238.aspx)를 참조하세요.
...
> [AZURE.TIP]  각 캐시 상태 코드 옵션에 대한 설명은 [Azure CDN 캐시 상태 코드](https://msdn.microsoft.com/library/mt759237.aspx)를 참조하세요.
