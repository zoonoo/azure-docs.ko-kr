...
1. Azure Portal 메뉴에서 **모든 리소스** >> 선택 **하 여-CDN 프로필 >\<** 합니다.
...
Microsoft 서비스의 Azure CDN 현재 원시 로그 (일괄 처리 시간)를 제공 합니다. 원시 로그는 각 항목이 다음 스키마를 갖는 개별 API 요청을 제공 합니다. 
