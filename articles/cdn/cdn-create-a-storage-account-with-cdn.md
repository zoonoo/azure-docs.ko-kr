<properties
	pageTitle="저장소 계정과 CDN 통합 | Microsoft Azure"
...
4. **이름** 필드에 하위 도메인 이름을 입력합니다. 이 입력에는 3-24자의 소문자와 숫자를 사용할 수 있습니다.
...
5. **배포 모델**, **계정 종류**, **성능** 및 **복제**에 대한 기본값을 그대로 둡니다.

6. 저장소 계정을 사용할 **구독**을 선택합니다.

7. **리소스 그룹**을 선택하거나 만듭니다. 리소스 그룹에 대한 자세한 내용은 [Azure 리소스 관리자 개요](resource-group-overview.md#resource-groups)를 참조하세요.
