---
title: "Azure CDN 사용 | Microsoft 문서"
...
---
# <a name="using-azure-cdn"></a>Azure CDN 사용
이 항목에서는 새로운 CDN 프로필 및 끝점을 만들어서 Azure CDN을 활성화하는 단계를 살펴봅니다.

> [!IMPORTANT]
> CDN 작동 방법 및 기능 목록에 대한 소개는 [CDN 개요](cdn-overview.md)를 참조하세요.
> 
> 
...
> [!NOTE]
> 기본적으로 단일 Azure 구독은 CDN 프로필이 8개로 제한됩니다. 각 CDN 프로필은 CDN 끝점이 열 개로 제한됩니다.
> 
