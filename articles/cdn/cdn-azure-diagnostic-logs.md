...
>[!NOTE] 
>이러한 단계를 완료 하려면 log analytics 작업 영역이 필요 합니다. 자세한 내용은 **[Azure Portal에서 Log Analytics 작업 영역 만들기](../azure-monitor/logs/quick-create-workspace.md)** 를 참조 하세요.
