...
| EgressCacheUncacheable | 자산의 Cache 컨트롤 및 또는 Expires 헤더에 의해 캐시 되지 못하도록 방지 된 자산에 대 한 아웃 바운드 데이터 전송. POP 또는 HTTP 클라이언트에 의해 캐시 되지 않아야 함을 나타냅니다. | 예 | 예 | 예 |
