...
[통합 문서](../vm/vminsights-workbooks.md) 는 텍스트, [로그 쿼리](/azure/data-explorer/kusto/query/), 메트릭 및 매개 변수를 풍부한 대화형 보고서로 결합 합니다. Azure 리소스에 대 한 동일한 액세스 권한이 있는 팀 구성원도 통합 문서를 편집할 수 있습니다.
