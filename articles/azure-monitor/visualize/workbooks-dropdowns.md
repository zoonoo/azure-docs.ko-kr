...
8. 환경 매개 변수는 세 개의 값이 있는 드롭다운입니다.
    ...
    ![정적 drown의 생성을 보여 주는 이미지](./media/workbooks-dropdowns/dropdown-create.png)
...
![그룹화 된 드롭다운의 예제를 보여 주는 이미지](./media/workbooks-dropdowns/grouped-dropDown.png)
...
3. RequestName 매개 변수는 앱의 모든 요청 이름이 드롭다운 됩니다.
    ...
    ![동적 드롭다운 생성을 보여 주는 이미지](./media/workbooks-dropdowns/dropdown-dynamic.png)
...
4. 쿼리를 실행 하 여 결과를 확인 합니다. 필요에 따라 차트를 렌더링 합니다.
    ...
    ![KQL에서 참조 되는 드롭다운을 보여 주는 이미지](./media/workbooks-dropdowns/dropdown-reference.png)
...
![값, 레이블, 선택 및 그룹 옵션을 사용 하 여 드롭다운 매개 변수를 보여 주는 이미지](./media/workbooks-dropdowns/dropdown-more-options.png)
