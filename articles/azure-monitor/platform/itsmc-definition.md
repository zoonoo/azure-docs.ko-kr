...
9. 작업 ITSM 그룹 정의의 마지막 섹션에서 각 경고에 생성 되는 경고의 수를 정의할 수 있습니다. 이 섹션에서는 로그 검색 경고와 관련 된 내용만 설명 합니다.

    * 작업 항목 드롭다운에서 "인시던트" 또는 "경고"를 선택 하는 경우:
        * **각 구성 항목에 대해 개별 작업 항목 만들기** 확인란을 선택 하면 모든 경고의 모든 구성 항목에서 새 작업 항목이 생성 됩니다. ITSM 시스템의 구성 항목 마다 작업 항목이 둘 이상 있을 수 있습니다.

            예를 들면 다음과 같습니다.
            1) 3 개 구성 항목을 포함 하는 경고 1: A, B, C-는 3 개의 작업 항목을 만듭니다.
            2) 1 개 구성 항목을 포함 하는 경고 2: D-작업 항목 1 개를 만듭니다.
    ...
    * 작업 항목 드롭다운에서 "Event"를 선택 하는 경우:
        * 라디오 단추 선택에서 **각 로그 항목에 대해 개별 작업 항목 만들기** 를 선택 하면 로그 검색 경고 쿼리의 검색 결과에 각 행 마다 경고가 생성 됩니다. 경고의 페이로드에 설명 속성은 검색 결과의 행을 포함 합니다.
        * 라디오 단추 선택에서 **각 구성 항목에 대해 개별 작업 항목 만들기** 를 선택 하는 경우 모든 경고의 모든 구성 항목이 새 작업 항목을 만듭니다. ITSM 시스템의 구성 항목 마다 작업 항목이 둘 이상 있을 수 있습니다. 이는 인시던트/경고 섹션의 확인란을 선택 하는 것과 같습니다.
