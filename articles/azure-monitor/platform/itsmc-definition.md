...
9. 작업 ITSM 그룹 정의의 마지막 섹션에서 각 경고에 대해 만들 작업 항목 수를 정의할 수 있습니다.
    ...
    * 작업 항목 드롭다운에서 "Event"를 선택 하는 경우:
        * **"각 로그 항목에 대 한 개별 작업 항목 만들기 (구성 항목 필드는 채워지지 않음)를 선택 합니다. 많은 수의 작업 항목이 생성 될 수 있습니다. "** 라디오 단추 선택에서 로그 검색 경고 쿼리의 검색 결과에 각 행 마다 경고가 생성 됩니다. 경고의 페이로드에 설명 속성은 검색 결과의 행을 포함 합니다.
