...
9. 작업 ITSM 그룹 정의의 마지막 섹션에서 각 경고에 대해 만들 작업 항목 수를 정의할 수 있습니다.
    ...
    * "작업 항목" 드롭다운 "이벤트"에서 선택 하면 ![ ITSM 이벤트 창이 표시 됩니다.](media/itsmc-overview/itsm-action-configuration-event.png)
        ...
        * **"각 로그 항목에 대 한 개별 작업 항목 만들기 (구성 항목 필드는 채워지지 않음)를 선택 합니다. 많은 수의 작업 항목이 생성 될 수 있습니다. "** 라디오 단추 선택에서 로그 검색 경고 쿼리의 검색 결과에 각 행 마다 작업 항목이 생성 됩니다. 작업 항목 페이로드의 설명 속성에는 검색 결과의 행이 포함 됩니다.
