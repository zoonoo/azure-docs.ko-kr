---
title: Azure Monitor 통합 문서를 사용 하 여 대화형 보고서 만들기 | 시간 매개 변수 | Microsoft 문서
...
2. 대부분의 통합 문서 컨트롤은 _시간 범위_ 범위 선택을 지원 합니다. _시간 범위_ 드롭다운을 열고 아래쪽의 time 결심 매개 변수 그룹에서 `{TimeRange}`를 선택 합니다.
