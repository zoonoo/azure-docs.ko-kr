...
![경고로직 로고](./media/partners/alertlogic.png)
...
![앱다이내믹스 로고](./media/partners/appdynamics.png)
...
![아틀라시안 로고](./media/partners/atlassian.png)
...
[자세한 정보][botmetric-doc].

## <a name="circonus"></a>Circonus

![서코누스 로고](./media/partners/circonus.png)

Circonus는 기계 데이터 인텔리전스 전문가로, 전례 없는 비즈니스 통찰력과 가치를 창출하기 위해 수십억 개의 메트릭 스트림을 실시간으로 처리할 수 있는 유일한 기계 데이터 인텔리전스 플랫폼을 제공합니다. Circonus를 사용하여 Microsoft Azure 설정과 관련된 주요 메트릭을 수집, 추적 및 시각화합니다. Azure의 리소스 사용률, 응용 프로그램 성능 및 운영 상태를 시스템 전반에 대한 가시성을 확보합니다.

[설명서로 이동합니다.][circonus-doc]

## <a name="cloudhealth"></a>CloudHealth

![클라우드헬스 로고](./media/partners/cloudhealth.png)


시간과 비용을 절감하도록 빌드된 플랫폼을 사용하여 클라우드를 통합하고 자동화합니다. CloudHealth는 클라우드 관리를 위한 탁월한 가시성, 직관적인 최적화 및 견고한 관리 사례를 제공합니다. 클라우드헬스 플랫폼을 통해 기업과 MSP는 클라우드 투자 수익을 극대화할 수 있습니다. 비용, 사용량, 성능, 보안에 대해 자신 있게 결정할 수 있습니다.

[자세히 알아보기][cloudhealth-doc]

## <a name="cloudmonix"></a>CloudMonix

![클라우드모닉스 로고](./media/partners/cloudmonix.png)
...
![탄성 로고](./media/partners/elastic.png)
...
[설명서로 이동합니다.][elastic-doc]

## <a name="grafana"></a>Grafana

![그라파나 로고](./media/partners/grafana.png)
...
![인리유입데이터 로고](./media/partners/Influxdata.png)

InfluxDB의 작성자인 InfluxData는 DevOps 및 IoT 애플리케이션에 대한 메트릭 및 이벤트(시계열 데이터)를 분석하기 위해 새롭게 빌드된 최신 오픈 소스 플랫폼을 제공합니다. 데이터가 사용자, 센서 또는 컴퓨터에서 제공되는지에 관계없이, InfluxData는 개발자가 차세대 모니터링, 분석 및 IoT 애플리케이션을 더 빠르고 쉽게 빌드하고 규모 확장을 통해 실제 비즈니스 가치를 빠르게 제공할 수 있도록 지원합니다. 샌프란시스코에 본사를 둔 InfluxData의 420개 이상의 고객은 시스코, 이베이, IBM 및 지멘스를 포함합니다.
...
![로직 모니터 로고](./media/partners/logicmonitor.png)

LogicMonitor는&reg; 복잡한 IT 인프라를 위한 선도적인 SaaS 기반 성능 모니터링 플랫폼입니다. 수천 개의 기술에 대한 보급으로 LogicMonitor는 인프라 및 애플리케이션 성능에 대한 세부적인 가시성을 제공합니다. LM Cloud의 포괄적인 Azure 모니터링을 통해 사용자는 단일 플랫폼에서 Azure 클라우드, 온-프레미스 및 하이브리드 클라우드 리소스의 성능을 상호 연관시킬 수 있습니다. 자동화된 리소스 검색, 기본 제공 모니터링 템플릿, 미리 구성된 경고 임계값 및 사용자 지정 가능한 대시보드는 성공에 필요한 속도, 유연성 및 가시성을 IT에 제공하기 위해 결합됩니다.

[설명서로 이동합니다.][logicmonitor-doc]

## <a name="logrhythm"></a>로그 리듬

![로그리듬 로고](./media/partners/logrhythm.png)

NextGen SIEM의 선두 주자인 LogRhythm은 6개 대륙의 조직이 사이버 위협을 신속하게 탐지, 대응 및 중화하여 위험을 측정가능하게 줄일 수 있도록 지원합니다. LogRhythm의 위협 수명 주기 관리(TLM) 워크플로우는 보안 운영 센터의 토대가 되어 고객이 IT 및 OT 환경을 위한 클라우드, 물리적 및 가상 인프라를 보호할 수 있도록 지원합니다. LogRhythm 고객이 Azure 여정을 시작할 준비가 된 경우 LogRhythm 오픈 컬렉터 및 EventHub 통합을 설치하고 구성해야 합니다. Azure 모니터 구성 및 열기 수집기 구성에 대한 설명서를 포함하여 자세한 내용은 [여기에서](https://logrhythm.com/six-tips-for-securing-your-azure-cloud-environment/)확인할 수 있습니다. 



## <a name="microfocus"></a>미소 초점

![마이크로포커스 로고](./media/partners/microfocus.png)     

마이크로포커스 **ArcSight에는** Azure Monitor 이벤트 허브용 스마트 커넥터가 있습니다.
...
마이크로포커스 **Operations Bridge는** 모든 장치, 운영 체제, 데이터베이스, 응용 프로그램 또는 서비스 등 모든 하이브리드 IT 리소스를 자동으로 모니터링하고 AIOps를 이벤트, 메트릭, 로그 및 종속성 등 모든 데이터 유형에 적용합니다. 심층적인 응용 프로그램 상태 분석과 결합된 서비스 품질 모니터링의 고유한 조합을 제공하며 Microsoft Azure 서비스의 포괄적인 성능 및 가용성 모니터링을 포함합니다. Operations Bridge를 사용하면 고객이 비즈니스 및 IT 이해 관계자가 이해할 수 있는 방식으로 브라우저를 사용하여 모든 장치에서 사용할 수 있는 단일 창을 제공할 수 있습니다.

자세한 정보
- [OB 스위트 개요](https://www.microfocus.com/products/operations-bridge-suite/overview)
- [다운로드](https://marketplace.microfocus.com/itom/content/obm-management-pack-for-microsoft-azure)
- [SiteScope](https://docs.microfocus.com/itom/SiteScope:2019.05/MSAzureMonitor) - 사이트스코프는 운영 브리지 제품군의 구성 요소입니다.
...
![뉴렐릭 로고](./media/partners/newrelic.png)

[자세한 정보][newrelic-doc].

## <a name="opsgenie"></a>OpsGenie

![옵스제니 로고](./media/partners/opsgenie.png)
...
![호출기 듀티 로고](./media/partners/pagerduty.png)
...
![사이언스로직 로고](./media/partners/sciencelogic.png)

ScienceLogic은 어디서든지 모든 기술을 관리하는 차세대 IT 서비스 보증 플랫폼을 제공합니다. ScienceLogic은 IT 리소스, 서비스 및 애플리케이션을 관리하는 작업의 간소화에 필요한 규모, 보안, 자동화 및 복원력을 제공합니다. ScienceLogic 플랫폼은 Azure API를 사용하여 Microsoft Azure와 상호 작용합니다. ScienceLogic은 Azure 서비스 및 리소스에 대한 실시간 가시성을 제공합니다. 그래서 당신은 뭔가가 작동하지 않을 때 알고 당신은 빨리 해결할 수 있습니다. 또한 다른 클라우드 및 데이터 센터 시스템과 서비스와 함께 Azure를 관리할 수 있습니다.

[자세한 정보][sciencelogic-doc].

## <a name="serverless360"></a>Serverless360

![서버리스360 로고](./media/partners/serverless360.png)

Serverless360은 Azure 서버리스 구성 요소를 운영, 관리 및 모니터링하는 하나의 플랫폼 도구입니다. 관리 용이성은 서버없는 구현의 주요 과제 중 하나입니다. 수백 개의 작고 개별적인 서버리스 서비스가 여러 곳에 흩어져 있으며, 이러한 솔루션을 관리하고 운영하는 것은 복잡합니다. Serverless360은 다양한 정교한 도구 세트로 이러한 문제를 해결합니다. Azure Functions, 논리 앱, 이벤트 그리드, 서비스 버스 큐, 토픽, 릴레이, 이벤트 허브, 저장소 큐, 파일, Blob 및 테이블과 같은 서버없는 서비스를 모니터링할 수 있습니다. 서버리스360은 Azure 마켓플레이스에서 사용할 수 있습니다. 이러한 기능은 SaaS 및 개인 호스팅(사용자 사용자 환경에서 호스팅됨)에서 모두 사용할 수 있습니다.  

[자세한 정보][serverless360-doc].

## <a name="servicenow"></a>ServiceNow

![서비스나우 로고](./media/partners/servicenow.png)

NOW AIOps 플랫폼을 통해 인시던트 및 MTTR을 줄여 노이즈를 제거하고, 우선 순위를 지정하고, ML을 사용하여 근본 원인 탐지를 식별하고, ITX 워크플로우를 사용하여 수정합니다.  Azure에서 Iaas/PaaS/FaaS 서비스의 현재 상태를 이해하고 태그에서 서비스 맵을 빌드하여 비즈니스 영향 분석을 위한 응용 프로그램 서비스 컨텍스트를 빌드합니다.    

[자세한 정보](https://www.servicenow.com/solutions/aiops.html).

## <a name="signalfx"></a>SignalFx

![시그널FX 로고](./media/partners/signalfx.png)

SignalFx는 데이터 기반 DevOps에 대한 실시간 운영 인텔리전스의 선두입니다. 서비스는 클라우드의 모든 구성 요소에서 메트릭을 발견하고 수집합니다. 기존의 포인트 툴을 대체하고 오늘날의 동적 환경에 대한 실시간 가시성을 제공합니다. 확장성이 매우 뛰어난 SignalFx 플랫폼을 활용하여 SaaS 플랫폼은 아키텍처를 기반으로 하는 컨테이너 및 마이크로 서비스에 최적화되며 강력한 시각화, 자동 관리 경고 및 모든 크기의 조직에 대한 공동 작업 심사 기능을 제공합니다. SignalFx는 Azure Monitor와 직접 통합뿐만 아니라 *Telegraf,* *statsD와*같은 오픈 소스 커넥터를 통해 *통합되며* Azure에 대한 클래스 대시보드, 분석 및 경고에서 최상의 기능을 제공하기 위해 수집됩니다.
...
[자세한 정보][solarwinds-doc].

## <a name="splunk"></a>Splunk

![스플렁크 로고](./media/partners/splunk.png)

Splunk용 Azure Monitor 추가 기능은 [Splunkbase에서 사용 가능](https://splunkbase.splunk.com/app/3534/)합니다.

[설명서로 이동합니다.][splunk-doc]

## <a name="squaredup"></a>스퀘어업 

![스퀘어드업 로고](./media/partners/squaredup.png)

Azure용 SquaredUp을 사용하면 Azure 응용 프로그램을 매우 간단하게 시각화할 수 있습니다. 그것은 당신에게 실시간, 대화 형 대시 보드를 제공합니다. 구독, 리소스 그룹, 태그 및 개별 리소스로 드릴다운하여 CPU, 대부분의 인바운드 연결, Application Insights 응답 시간, 총 비용 및 요약 상태와 같은 메트릭을 확인하고 다음과 같은 관련 데이터를 볼 수 있습니다. 경고, 로그 분석 이벤트, 더 자세한 메트릭, 또는 당신이 사용하는 다른 도구에서 관련 데이터를 볼 수 있습니다 – 예를 들어 ServiceNow, 다이너 트 레이스, PagerDuty 또는 핑돔.  사용자 고유의 대시보드를 사용자 지정하고, 게시하고, 개인 또는 인트라넷 페이지에서 공유할 수 있습니다. 

[자세한 정보](https://squaredup.com/).

## <a name="sumo-logic"></a>Sumo Logic

![스모 로직 로고](./media/partners/SumoLogic.png)
...
[자세한 정보][sumologic-doc].

## <a name="turbonomic"></a>Turbonomic

![터보노믹 로고](./media/partners/Turbonomic.png)
...
- [리소스 로그를 Microsoft 이외의 서비스로 스트리밍](../../azure-monitor/platform/resource-logs-stream-event-hubs.md)
...
[influxdata-doc]: ./../../azure-monitor/platform/collect-custom-metrics-linux-telegraf.md "Azure 모니터 유입 데이터 텔레그라프 통합."
...
[serverless360-doc]: https://docs.serverless360.com/docs/ "서버리스360 설명서."
