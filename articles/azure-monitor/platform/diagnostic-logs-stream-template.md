...
description: Resource Manager 템플릿을 사용하여 Event Hubs로 진단 로그 스트림을 활성화하거나 로그를 스토리지 계정에 저장하는 진단 설정을 만드는 방법을 알아봅니다.
author: johnkemnetz
...
다음은 Logic App을 만들고 Event Hubs로 스트리밍 및 스토리지 계정에 저장을 설정하는 전체 예제입니다.
...
2. 매개 변수로 스토리지 계정 및/또는 이벤트 허브를 지정합니다.
