...
> [!NOTE]
> 이 문서에서는 기존 클래식 메트릭 경고를 만드는 방법을 설명합니다. Azure Monitor는 이제 [최신 실시간 메트릭 경고 및 새 경고 환경을](../../azure-monitor/platform/alerts-overview.md)지원합니다. 클래식 경고는 아직 새 경고를 지원하지 않는 리소스에 대해 여전히 제한적으로 사용되지만 [사용 중지됩니다.](https://docs.microsoft.com/azure/azure-monitor/platform/monitoring-classic-retirement) 
>
...
Azure Monitor를 통해 사용할 수 있는 리소스 로그 데이터의 경우 데이터를 로그 분석으로 라우팅하고 로그 쿼리 경고를 사용합니다. 이제 로그 분석에서 [새로운 경고 방법을 사용합니다.](../../azure-monitor/platform/alerts-overview.md) 
...
* **작업** - 알림 수신자에게 전송된 특정 통화(예: 주소 이메일 또는 웹후크 URL로 게시). 알림은 보통 여러 작업을 트리거할 수 있습니다.
...
* [측정항목에](data-platform.md) 대해 자세히 알아보기
...
* [활동 로그에](platform-logs-overview.md) 대해 자세히 알아보기
...
* [작업 그룹에](action-groups.md) 대해 자세히 알아보기
