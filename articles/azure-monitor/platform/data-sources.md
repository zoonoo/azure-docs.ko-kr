...
| Azure Kubernetes Service | 거의 실시간 환경을 위해 컨테이너에 대 한 Azure Monitor는 Azure Portal의 Azure Kubernetes 서비스에서 직접 데이터를 제공 합니다. | [Azure Monitor에서 컨테이너 로그를 실시간으로 보는 방법(미리 보기)](../insights/container-insights-live-logs.md) |
