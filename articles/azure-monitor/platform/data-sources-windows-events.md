...
[Log Analytics 설정의 데이터 메뉴](agent-data-sources.md#configuring-data-sources)에서 Windows 이벤트 로그를 구성합니다.
...
* [사용자 지정 필드](../../log-analytics/log-analytics-custom-fields.md)를 사용하여 이벤트 레코드를 개별 필드로 구문 분석합니다.
