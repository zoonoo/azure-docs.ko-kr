...
> [!NOTE]
> Windows 이벤트 로그에서 중요한 이벤트에는 Azure 모니터 로그에서 "오류"의 심각도가 있습니다.
...
| ManagementGroupName |System Center Operations Manager 에이전트의 관리 그룹 이름입니다.  다른 에이전트의 경우 이 값은`AOI-<workspace ID>` |
