...
현재 Log Analytics에 저장된 검색을 사용해서만 경고를 만들 수 있습니다.  자세한 내용은 [로그 검색 REST API](../../log-analytics/log-analytics-queries.md) 를 참조하세요.
...
* Log Analytics에서 [REST API를 사용하여 로그 검색을 수행](../../log-analytics/log-analytics-queries.md) 합니다.
