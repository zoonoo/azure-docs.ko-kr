...
* 관리 그룹에 적용된 최신 업데이트 롤업. Operations Manager 2012의 경우 원본 폴더 `%ProgramFiles%\Microsoft System Center 2012\Operations Manager\Server\Management Packs for Update Rollups` 는 이며 2012 r 2의 경우에 `System Center 2012 R2\Operations Manager\Server\Management Packs for Update Rollups`있습니다.
