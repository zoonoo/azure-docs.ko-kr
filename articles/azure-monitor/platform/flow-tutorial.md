...
예를 들어 Microsoft Flow를 사용 하 여 Office 365의 전자 메일 알림에서 Azure Monitor 로그 데이터를 사용 하거나, Azure DevOps에서 버그를 만들거나, 여유 시간 메시지를 게시할 수 있습니다.  메일이나 트윗이 수신될 때와 같이 연결된 서비스의 일부 작업 또는 단순 일정에서 워크플로를 트리거할 수 있습니다.  
