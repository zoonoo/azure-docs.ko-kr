...
| 단계 | 속성 또는 함수 | 주석 |
|:---|:---|:---|
| 데이터 원본에 생성 되는 레코드 | [TimeGenerated](log-standard-properties.md#timegenerated-and-timestamp) <br>데이터 원본에서이 값을 설정 하지 않으면 _TimeReceived와 동일한 시간으로 설정 됩니다. |
