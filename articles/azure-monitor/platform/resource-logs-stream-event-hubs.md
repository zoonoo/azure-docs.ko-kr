---
title: Azure platform logs를 이벤트 허브로 스트림
...
* **Power BI으로 데이터를 스트리밍하는 서비스 상태 보기** – Event Hubs, Stream Analytics 및 Power BI를 사용 하 여 Azure 서비스에서 진단 데이터를 거의 실시간으로 변환 합니다. [Stream Analytics 및 Power BI를 참조 하세요. 이 솔루션에 대 한 자세한 내용은 스트리밍 데이터에 대 한 실시간 분석 대시보드](../../stream-analytics/stream-analytics-power-bi-dashboard.md).
