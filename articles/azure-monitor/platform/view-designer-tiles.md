...
| [두 숫자](#two-numbers-tile) |두 개의 서로 다른 쿼리의 레코드 수입니다. |
| [도넛형](#donut-tile) | 중앙에 요약 값이 있는 쿼리 기반 차트입니다. |
| 꺾은선형 차트 및 설명선 | 쿼리 기반 꺾은선형 차트 및 요약 값이 있는 설명선입니다. |
| [꺾은선형 차트](#line-chart-tile) |쿼리 기반 꺾은선형 차트입니다. |
| [두 타임라인](#two-timelines-tile) | 각각 별도의 쿼리에 기반하는 두 계열이 있는 세로 막대형 차트입니다. |
