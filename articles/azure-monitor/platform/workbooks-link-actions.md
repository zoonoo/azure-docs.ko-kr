...
ms.locfileid: "98122284"
---
# <a name="link-actions"></a>링크 작업

링크 작업은 통합 문서 링크 단계 또는 [그리드](workbooks-grid-visualizations.md), [제목](workbooks-tile-visualizations.md)또는 [그래프](workbooks-graph-visualizations.md)의 열 설정을 통해 액세스할 수 있습니다.
