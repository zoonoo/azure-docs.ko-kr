...
1. Azure Portal에서 **작업 영역** > 작업 영역 > **고급 설정**을 선택합니다.
2. **데이터**를 선택합니다.
3. 구성할 데이터 원본을 클릭합니다.
