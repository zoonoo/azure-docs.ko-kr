---
title: Azure Monitor를 사용 하 여 메트릭 경고 만들기, 보기 및 관리
description: Azure Portal 또는 CLI를 사용 하 여 메트릭 경고 규칙을 만들고, 보고, 관리 하는 방법에 대해 알아봅니다.
author: harelbr
ms.author: harelbr
ms.topic: conceptual
ms.date: 03/13/2020
...
1. [Azure Portal](https://portal.azure.com)에서 **모니터**를 클릭 합니다. [모니터] 블레이드는 모든 모니터링 설정 및 데이터를 하나의 뷰에 통합합니다.
...
13. 경고 **규칙 이름**, **설명**및 **심각도**와 같은 **경고 세부 정보** 를 입력 합니다.
...
3. **규칙 관리** 블레이드에서 구독의 모든 경고 규칙을 볼 수 있습니다. **리소스 그룹**, **리소스 종류**및 **리소스**를 사용 하 여 규칙을 추가로 필터링 할 수 있습니다. 메트릭 경고만 보려면 **신호 유형**을 메트릭으로 선택합니다.
