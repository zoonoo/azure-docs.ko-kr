...
1. **Nagios** 및 **Zabbix** 경고의 경우 Log Analytics에 경고를 [보내도록](https://docs.microsoft.com/azure/azure-monitor/platform/data-sources-alerts-nagios-zabbix?toc=%2Fazure%2Fazure-monitor%2Ftoc.json) [해당 서버를 구성](https://docs.microsoft.com/azure/log-analytics/log-analytics-linux-agents) 합니다.
