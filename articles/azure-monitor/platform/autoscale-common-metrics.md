...
- [Resource Manager 기반 Windows 및 Linux VM용 호스트 메트릭](./metrics-supported.md#microsoftcomputevirtualmachines)
- [Resource Manager 기반 Windows 및 Linux VM Scale Sets용 호스트 메트릭](./metrics-supported.md#microsoftcomputevirtualmachinescalesets)
