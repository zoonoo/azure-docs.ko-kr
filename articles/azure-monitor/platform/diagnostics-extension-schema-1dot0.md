...
|특성|형식|설명|  
|---------------|----------|-----------------|  
|**path**|string|필수 요소. 모니터링할 디렉터리의 절대 경로입니다.|  
|**expandEnvironment**|boolean|필수 요소. **true**로 설정하면 경로의 환경 변수가 확장됩니다.|  
...
|특성|형식|설명|  
|---------------|----------|-----------------|  
|**name**|string|필수 요소. 모니터링할 디렉터리를 포함하는 로컬 리소스의 이름입니다.|  
|**relativePath**|string|필수 요소. 모니터링할 로컬 리소스의 상대 경로입니다.|  
...
|특성|형식|설명|  
|---------------|----------|-----------------|  
|**counterSpecifier**|string|필수 요소. 수집할 성능 카운터의 경로입니다.|  
|**sampleRate**|duration|필수 요소. 성능 카운터를 수집할 속도입니다.|  
...
|특성|형식|설명|  
|---------------|----------|-----------------|  
|**name**|string|필수 요소. 수집할 로그를 지정하는 XPath 식입니다.|  
