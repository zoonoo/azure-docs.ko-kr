...
| Azure 진단 인프라 로그 |Azure Diagnostics 자체에 대한 정보 |
...
## <a name="costs"></a>비용
위의 각 옵션에는 비용이 발생할 수 있습니다. 예기치 않은 요금을 방지 하려면 연구 해야 합니다.  Application Insights, 이벤트 허브 및 Azure Storage 수집 및 저장 된 시간과 관련 된 별도의 비용이 있습니다. 특히, Azure Storage는 모든 데이터를 영구적으로 보유 하므로 특정 기간 후에는 오래 된 데이터를 제거 하 여 비용을 줄일 수 있습니다.    

## <a name="versioning-and-configuration-schema"></a>버전 관리 및 구성 스키마
[Azure Diagnostics 버전 기록 및 스키마](diagnostics-extension-schema.md)를 참조하세요.
...
* [Cloud Services용 Application Insights에서 Azure Diagnostics 사용](../../azure-monitor/app/cloudservices.md)
...
* [Azure Virtual Machine에서 Azure Diagnostics 설정](/azure/virtual-machines/extensions/diagnostics-windows)
