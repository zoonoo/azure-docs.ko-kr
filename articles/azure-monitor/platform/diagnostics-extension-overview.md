...
- [Linux 진단 확장을 사용 하 여 메트릭 및 로그 모니터링](../../virtual-machines/extensions/diagnostics-linux.md)
...
- [Azure Cloud Services에서 Azure 진단 사용](../../cloud-services/cloud-services-dotnet-diagnostics.md)
