...
* **작업 유형**: 수행 된 작업입니다. 음성 통화, SMS, 이메일 보내기나, 여러 자동화된 작업 유형 트리거를 예로 들 수 있습니다. 이 문서 뒷부분에 나오는 유형을 참조하세요.
...
1. [Azure Portal](https://portal.azure.com)에서 **모니터**를 선택합니다. **모니터** 창은 모든 모니터링 설정 및 데이터를 하나의 보기로 통합 합니다.
