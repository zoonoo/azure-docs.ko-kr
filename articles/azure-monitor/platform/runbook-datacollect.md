...
![OMSIngestionAPI 모듈](media/runbook-datacollect/OMSIngestionAPI.png)
...
![Runbook 편집](media/runbook-datacollect/edit-runbook.png)
...
![Runbook 게시](media/runbook-datacollect/publish-runbook.png)
...
![로깅 및 추적](media/runbook-datacollect/logging.png)
...
![Runbook 예약](media/runbook-datacollect/schedule-runbook.png)
...
![교육](media/runbook-datacollect/jobs.png)
...
5. 아래 이미지와 유사한 항목을 찾을 때까지 아래쪽으로 스크롤합니다.<br>![자세한 정보 표시](media/runbook-datacollect/verbose.png)
6. Log Analytics로 전송된 자세한 JSON 데이터를 보려면 이 항목을 클릭합니다.

## <a name="next-steps"></a>다음 단계
- [뷰 디자이너](../../azure-monitor/platform/view-designer.md)를 사용하여 Log Analytics 리포지토리로 수집한 데이터를 표시하는 보기를 만듭니다.
