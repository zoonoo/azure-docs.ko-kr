...
| 속성 |이벤트에 대한 세부 정보를 포함하는 `<Key, Value>` 쌍의 집합(즉, `Dictionary<String, String>`)입니다. |
...
| 수준(level) |해당 값은 Critical, Error, Warning 및 Informational 중 하나입니다. |
