...
|---------|---------|-----|----------|
|Microsoft.ApiManagement/service | yes| 예 | [API 관리](../../azure-monitor/platform/metrics-supported.md#microsoftapimanagementservice)|
|마이크로소프트.앱플랫폼/봄 |예| yes|
|Microsoft.Automation/automationAccounts | yes| 예 | [자동화 계정](../../azure-monitor/platform/metrics-supported.md#microsoftautomationautomationaccounts)|
|Microsoft.Batch/batchAccounts | 해당 없음| 예 | [일괄 처리 계정](../../azure-monitor/platform/metrics-supported.md#microsoftbatchbatchaccounts)|
|Microsoft.Cache/Redis|yes| 예 |[Redis용 Azure 캐시](../../azure-monitor/platform/metrics-supported.md#microsoftcacheredis)|
|마이크로소프트.클래식스토리지/스토리지계정/mmxclassic|예|yes|
|마이크로 소프트.클래식 스토리지 / 스토리지계정 / mmxclassic / blob서비스|예|yes|
|마이크로 소프트.클래식 스토리지 / 스토리지계정 / mmxclassic / 파일 서비스|예|yes|
|마이크로소프트.클래식스토리지/스토리지계정/mmxclassic/큐서비스|예|yes|
|마이크로 소프트.클래식 스토리지 / 스토리지계정 / mmxclassic / 테이블서비스|예|yes| |
|Microsoft.CognitiveServices/accounts| 해당 없음 | 예 | [코그너티브 서비스](../../azure-monitor/platform/metrics-supported.md#microsoftcognitiveservicesaccounts)|
...
|Microsoft.Compute/virtualMachineScaleSets |해당 없음 | yes |[가상 머신 스케일 세트](../../azure-monitor/platform/metrics-supported.md#microsoftcomputevirtualmachinescalesets)|
...
|마이크로소프트.데이터박스에지/데이터박스에지디바이스 | yes | yes | |
...
|Microsoft.Devices/IotHubs | 해당 없음 | 예 |[IoT 허브 메트릭](../../azure-monitor/platform/metrics-supported.md#microsoftdevicesiothubs)|
...
|마이크로소프트.이벤트 그리드/도메인|예|yes| |
|Microsoft.EventGrid/topics |yes | 예 |[이벤트 그리드 토픽](../../azure-monitor/platform/metrics-supported.md#microsofteventgridtopics)|
|Microsoft.EventHub/clusters |yes| 예 |[이벤트 허브 클러스터](../../azure-monitor/platform/metrics-supported.md#microsofteventhubclusters)|
...
|Microsoft.Logic/workflows |해당 없음 | 예 |[논리 앱](../../azure-monitor/platform/metrics-supported.md#microsoftlogicworkflows) |
|Microsoft.MachineLearningServices/workspaces|yes| 예 | [기계 학습](../../azure-monitor/platform/metrics-supported.md#microsoftmachinelearningservicesworkspaces) |
...
|마이크로소프트.넷앱/넷앱계정/용량풀/볼륨 |yes| 예 | [Azure 넷앱 볼륨](../../azure-monitor/platform/metrics-supported.md#microsoftnetappnetappaccountscapacitypoolsvolumes) |
...
|Microsoft.Network/loadBalancers (표준 SKU 전용)| yes| 예 | [로드 밸러저](../../azure-monitor/platform/metrics-supported.md#microsoftnetworkloadbalancers) |
|마이크로소프트.네트워크/낫게이트웨이|예|yes|
|마이크로소프트.네트워크/프라이빗엔드포인트|예|yes|
|마이크로소프트.네트워크/개인링크서비스|예|yes|
...
|Microsoft.Network/trafficManagerProfiles | yes | 예 | [트래픽 관리자 프로필](../../azure-monitor/platform/metrics-supported.md#microsoftnetworktrafficmanagerprofiles) |
...
|Microsoft.Relay/namespaces | yes | 예 | [릴레이](../../azure-monitor/platform/metrics-supported.md#microsoftrelaynamespaces)|
|마이크로소프트.피어링/피어링서비스|예|yes|
|Microsoft.PowerBIDedicated/capacities | 해당 없음 | 예 | [용량](../../azure-monitor/platform/metrics-supported.md#microsoftpowerbidedicatedcapacities)|
...
|Microsoft.Storage/storageAccounts |yes | 예 | [저장소 계정](../../azure-monitor/platform/metrics-supported.md#microsoftstoragestorageaccounts)|
...
|마이크로소프트.마이크로소프트.VM웨어클라우드심플/가상머신 |yes|예 |[CloudSimple Virtual Machines](../../azure-monitor/platform/metrics-supported.md#microsoftvmwarecloudsimplevirtualmachines)|
|Microsoft.Web/hostingEnvironments/multiRolePools | yes | 예 | [앱 서비스 환경 다중 역할 풀](../../azure-monitor/platform/metrics-supported.md#microsoftwebhostingenvironmentsmultirolepools)|
|Microsoft.Web/hostingEnvironments/workerPools | yes | 예 | [앱 서비스 환경 작업자 풀](../../azure-monitor/platform/metrics-supported.md#microsoftwebhostingenvironmentsworkerpools)|
