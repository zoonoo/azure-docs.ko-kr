...
|Microsoft.Compute/virtualMachines | yes | 예 | [Virtual Machines](./metrics-supported.md#microsoftcomputevirtualmachines) |
...
|Microsoft.ContainerRegistry/registries | 아니요 | 예 | [컨테이너 레지스트리](./metrics-supported.md#microsoftcontainerregistryregistries) |
|Microsoft.ContainerService/managedClusters | 예 | 예 | [관리되는 클러스터](./metrics-supported.md#microsoftcontainerservicemanagedclusters) |
|Microsoft.DataBoxEdge/dataBoxEdgeDevices | yes | 예 | [Data Box](./metrics-supported.md#microsoftdataboxedgedataboxedgedevices) |
...
|Microsoft.KeyVault/vaults | 예 |예 |[볼트](./metrics-supported.md#microsoftkeyvaultvaults)|
