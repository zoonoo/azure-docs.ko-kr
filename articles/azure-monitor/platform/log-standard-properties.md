...
**Timegenerated** 및 **timestamp** 는 시간에 따라 필터링 하거나 요약 하는 데 사용할 공용 속성을 제공 합니다. Azure Portal에서 뷰나 대시보드의 시간 범위를 선택 하면 TimeGenerated 또는 timestamp를 사용 하 여 결과를 필터링 합니다. 
...
**\_ItemId** 속성에는 레코드에 대 한 고유 식별자가 포함 되어 있습니다.
