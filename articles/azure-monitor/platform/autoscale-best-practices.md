...
* 모든 자동 크기 조정 실패는 활동 로그에 기록됩니다. 그러므로 자동 크기 조정 오류가 있을 때마다 메일, SMS 또는 웹후크를 통해 알림을 받을 수 있도록 [활동 로그 경고](./activity-log-alerts.md)를 구성할 수 있습니다.
