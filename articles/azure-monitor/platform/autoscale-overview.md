...
구성 가능한 필드 및 설명의 전체 목록은 [자동 크기 조정 REST API](/rest/api/monitor/autoscalesettings)에서 사용할 수 있습니다.
