...
`dailyQuotaGb`여기에 설명 된 대로 매개 변수를 설정 하 여 ARM을 통해 일일 캡을 구성할 수 있습니다 `WorkspaceCapping` . [here](https://docs.microsoft.com/rest/api/loganalytics/workspaces/createorupdate#workspacecapping) 
