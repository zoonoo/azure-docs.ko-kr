...
- [Log Analytics 작업 영역을 만듭니다.](../insights/vminsights-configure-workspace.md#create-log-analytics-workspace)
- [VMInsights 솔루션을 작업 영역에 추가 합니다.](../insights/vminsights-configure-workspace.md#add-vminsights-solution-to-workspace)
- [모니터링할 가상 컴퓨터 및 가상 컴퓨터 확장 집합에 에이전트를 설치 합니다.](../insights/vminsights-enable-overview.md)



## <a name="next-steps"></a>다음 단계

- 가상 컴퓨터에 대 한 모니터링을 사용 하도록 설정 하는 요구 사항 및 방법에 대 한 [VM용 Azure Monitor 배포](../insights/vminsights-enable-overview.md) 를 참조 하세요.
