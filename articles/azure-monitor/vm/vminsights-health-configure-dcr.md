...
| 사용 가능한 메모리 | 참 | 거짓 | 없음 | \< 100 M B | 60초 | 240 초 | 최대 | 2 | 3 |
| 파일 시스템      | 참 | 거짓 | 없음 | \< 100 M B | 60초 | 120 초 | 최대 | 1 | 1 |
...
재정의는 [데이터 수집 규칙 (DCR)](../agents/data-collection-rule-overview.md)에 정의 되어 있습니다. 서로 다른 재정의 집합을 사용 하 여 여러 개의 가상 컴퓨터를 만들고 여러 가상 컴퓨터에 적용할 수 있습니다. [Azure Monitor 에이전트에 대 한 데이터 수집 구성 (미리 보기)](../agents/data-collection-rule-azure-monitor-agent.md#data-collection-rule-associations)에 설명 된 대로 연결을 만들어 가상 머신에 DCR을 적용 합니다.
...
- 자세한 내용은 [데이터 수집 규칙](../agents/data-collection-rule-overview.md)을 참조 하세요.