---
title: Azure Monitor 리브랜딩 | Microsoft Docs
description: Azure 관리 서비스에 대한 최신 브랜딩 및 이름 변경 사항을 설명합니다.
author: bwren
manager: carmonm
editor: tysonn
...
## <a name="consolidation-of-monitoring-services-into-azure-monitor"></a>Azure Monitor로 모니터링 서비스 통합
