...
- [웹 페이지용 Application Insights](app/javascript.md) - 새 문서
- [Application Insights JavaScript SDK에 대한 Click Analytics 자동 수집 플러그 인](app/javascript-click-analytics-plugin.md) - 새 문서
- [코드 변경 없이 앱 모니터링 - Azure Monitor Application Insights에 대한 자동 계측](app/codeless-overview.md) - Python 열이 추가되었습니다.
- [Application Insights JavaScript SDK에 대한 플러그 인 응답](app/javascript-react-plugin.md) - 새 문서입니다.
- [원격 분석 프로세서(미리 보기) - Java용 Azure Monitor Application Insights](app/java-standalone-telemetry-processors.md) - 다시 작성되었습니다.
- [Azure Application Insights로 사용량 분석](app/usage-overview.md) - 새 문서
- [Azure Monitor에서 애플리케이션 변경 분석을 사용하여 웹앱 문제 찾기](app/change-analysis.md) - 오류 메시지가 추가되었습니다.
...
- [Azure 모니터링 에이전트 개요](agents/agents-overview.md) - Oracle 8에 대한 지원이 추가되었습니다.

### <a name="alerts"></a>경고
- [Azure 메트릭 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 동적 임계값에 대한 문제 해결이 추가되었습니다.
- [Log Analytics의 IT 서비스 관리 커넥터](alerts/itsmc-definition.md) - 새 문서입니다.
- [IT 서비스 관리 커넥터 개요](alerts/itsmc-overview.md) - 문제 해결 정보가 재구성되었습니다.
- [Cherwell을 Azure의 IT 서비스 관리 커넥터에 연결](alerts/itsmc-connections-cherwell.md) - 새 문서입니다.
- [Provance를 Azure의 IT 서비스 관리 커넥터에 연결](alerts/itsmc-connections-provance.md) - 새 문서입니다.
- [SCSM을 Azure의 IT 서비스 관리 커넥터에 연결](alerts/itsmc-connections-scsm.md) - 새 문서입니다.
- [ServiceNow를 Azure의 IT 서비스 관리 커넥터에 연결](alerts/itsmc-connections-servicenow.md) - 새 문서입니다.
- [ServiceNow 동기화 문제를 수동으로 해결하는 방법](alerts/itsmc-resync-servicenow.md) - 문제 해결 정보가 재구성되었습니다.
...
- [Azure Monitor와 Azure Data Explorer 간의 교차 서비스 쿼리(미리 보기)](logs/azure-data-explorer-monitor-cross-service-query.md) - 새 문서입니다.
- [Azure Monitor에서 Log Analytics 작업 영역 데이터 내보내기(미리 보기)](logs/logs-data-export.md) - ARM 템플릿이 추가되었습니다.

### <a name="metrics"></a>메트릭
- [Azure 메트릭 탐색기의 고급 기능](essentials/metrics-charts.md) - 리소스 범위 선택기에 대한 정보가 추가되었습니다.
- [메트릭 탐색기에서 여러 리소스 보기](essentials/metrics-dynamic-scope.md) - 새 문서입니다.
...
- [하이브리드 환경에서 Azure Monitor 사용](vm/vminsights-enable-hybrid.md) - 새로운 종속성 에이전트 버전입니다.


### <a name="visualizations"></a>시각화
- [Azure Monitor 통합 문서 맵 시각화](visualize/workbooks-map-visualizations.md) - 새 문서입니다.
- [자체 스토리지를 제공하는 Azure Monitor 통합 문서](visualize/workbooks-bring-your-own-storage.md) - 새 문서입니다.
...
### <a name="agents"></a>에이전트
- [Azure 모니터링 에이전트 개요](agents/agents-overview.md) - Azure Arc 지원을 위해 업데이트되었습니다.
- [Azure Monitor 에이전트 설치](agents/azure-monitor-agent-install.md) - 새 문서.
- [Azure Monitor 에이전트 개요](agents/azure-monitor-agent-overview.md) - Azure Arc 지원을 위해 업데이트되었습니다.
- [에이전트용 Resource Manager 템플릿 샘플](agents/resource-manager-agent.md) - Azure Arc 지원을 위해 업데이트되었습니다.

### <a name="alerts"></a>경고
- [Azure Portal에서 작업 그룹 만들기 및 관리](alerts/action-groups.md) - 웹후크에 대한 원본 IP 주소를 추가했습니다.
...
- [Azure Monitor 에이전트를 위한 데이터 컬렉션 구성(미리 보기)](agents/data-collection-rule-azure-monitor-agent.md) - Azure Arc 지원을 위해 업데이트되었습니다.
- [Azure Monitor의 데이터 컬렉션 규칙(미리 보기)](agents/data-collection-rule-overview.md) - Azure Arc 지원을 위해 업데이트되었습니다.
- [데이터 수집 규칙에 대한 Resource Manager 템플릿 샘플](agents/resource-manager-data-collection-rules.md) - 새 문서.

### <a name="insights-and-solutions"></a>인사이트 및 솔루션
- [보안 내보내기를 사용하여 Azure를 ITSM 도구에 연결](alerts/it-service-management-connector-secure-webhook-connections.md) - ServiceNow에 연결하는 섹션을 추가했습니다.

### <a name="logs"></a>로그
- [Log Analytics와 Excel 통합](logs/log-excel.md) - 새 문서.
- [Log Analytics 데이터 보안](logs/data-security.md) - 추가 보안 기능에 대한 섹션이 추가되었습니다.
- [Power BI와 Log Analytics 통합](logs/log-powerbi.md) - 새 문서.
- [Azure Monitor 로그 레코드의 표준 열](logs/log-standard-columns.md) - _SubscriptionId 열이 추가되었습니다.

로그 쿼리 콘텐츠의 재구성에서 새롭게 업데이트된 문서.

- [Log Analytics 자습서](logs/log-analytics-tutorial.md)
- [Azure Monitor의 로그 쿼리](logs/log-query-overview.md)
- [Azure Monitor의 Log Analytics 개요](logs/log-analytics-overview.md)
...
### <a name="general"></a>일반
- [Azure Monitor API 사용 중지](logs/operationalinsights-api-retirement.md) -새 문서.

### <a name="agents"></a>에이전트
- [Azure Monitor에서 모니터링하는 항목](monitor-reference.md) - 에이전트에 대한 섹션을 추가했습니다.

### <a name="alerts"></a>경고
- [Azure Portal에서 작업 그룹 만들기 및 관리](alerts/action-groups.md) - 서비스 태그에 대한 섹션을 추가했습니다.
- [메트릭 경고에 대한 Resource Manager 템플릿 샘플](alerts/resource-manager-alerts-metric.md) - 콘텐츠 일치 매개 변수 및 테스트 위치를 추가했습니다.
- [Azure 메트릭 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 규칙 구성에 대한 모범 사례를 추가했습니다.
...
### <a name="logs"></a>로그
- [Logic App을 사용하여 Log Analytics 작업 영역에서 Azure storage로 데이터 보관](logs/logs-export-logic-app.md) - 새 문서.
- [Azure Monitor(미리 보기)에서 Log Analytics 작업 영역 데이터 내보내기](logs/logs-data-export.md) - 이벤트 허브용 REST 요청에 대한 샘플 본문을 추가했습니다.
- [Azure Monitor 로그의 사용량 및 비용 관리](logs/manage-cost-storage.md) - Azure Monitor 로그와 Azure Security Center 청구 간의 관계에 대한 정보를 추가했습니다. 노드당 가격 책정 계층을 사용하는 경우 노드 수에 대한 쿼리를 추가했습니다. 
- [Azure Monitor에서 Log Analytics 작업 영역의 상태 모니터링](logs/monitor-workspace.md) - 새 문서.
- [Azure Data Explorer를 사용하여 Azure Monitor에서 데이터 쿼리(미리 보기)](logs/azure-data-explorer-monitor-proxy.md) - 새 문서.
- [Azure Data Explorer를 사용하여 Azure Monitor에서 내보낸 데이터 쿼리(미리 보기)](logs/azure-data-explorer-query-storage.md) - 새 문서.

### <a name="networks"></a>네트워크
- [네트워크 미리용 Azure Monitor 미리 보기](insights/network-insights-overview.md) - 문제 해결 섹션을 추가했습니다. 연결에 대한 섹션을 추가했습니다.

### <a name="platform-logs"></a>플랫폼 로그
- [Azure 활동 로그 이벤트 스키마](essentials/activity-log-schema.md) - 심각도 수준에 대한 설명이 추가되었습니다.
...
### <a name="agents"></a>에이전트
- [Azure Monitor 에이전트 개요](agents/azure-monitor-agent-overview.md) - 새 에이전트로 전환하도록 결정하기 위한 요인이 추가되었습니다.
- [Azure 모니터링 에이전트 개요](agents/agents-overview.md) - Windows 10에 대한 지원이 추가되었습니다.

### <a name="alerts"></a>경고
- [Resource Manager 템플릿을 사용하여 로그 경고 만들기](alerts/alerts-log-create-templates.md) - 새 문서
- [Azure 메트릭 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 메트릭 경고 규칙의 ARM 템플릿 내보내기에 대한 섹션이 추가되었습니다.
...
- [Azure Monitor의 IT 서비스 관리 커넥터 - 보안 내보내기](alerts/it-service-management-connector-secure-webhook-connections.md) - 새 문서
- [Azure Monitor의 IT 서비스 관리 커넥터](alerts/itsmc-connections.md) - Cherwell 및 Provance ITSM 통합에 대한 참고 사항입니다.
- [Key Vault용 Azure Monitor를 사용하여 Key Vault 모니터링](insights/key-vault-insights-overview.md) - 미리 보기 지정이 제거되었습니다.

### <a name="logs"></a>로그
- [Azure Monitor 로그 쿼리의 쿼리 감사](logs/query-audit.md) - 새 문서
- [Azure Monitor 고객 관리형 키](logs/customer-managed-keys.md) - 고객 Lockbox가 추가되었습니다.
- [Azure Monitor 로그 전용 클러스터](logs/logs-dedicated-clusters.md) - 새 문서
- [Azure Monitor 로그 배포 디자인](logs/design-logs-deployment.md) - 크기 조정 및 수집 볼륨 비율 제한 섹션이 업데이트되었습니다.
- [Azure Monitor Log Analytics의 로그 쿼리 범위](logs/scope.md) - 작업 영역 기반 애플리케이션을 포함하도록 업데이트되었습니다.
- [Azure Monitor의 로그](logs/data-platform-logs.md) - 작업 영역 기반 애플리케이션을 포함하도록 업데이트되었습니다.
- [Azure Monitor 로그 레코드의 표준 열](logs/log-standard-columns.md) - 작업 영역 기반 애플리케이션을 포함하도록 업데이트되었습니다.
- [Azure Monitor 서비스 제한](service-limits.md) - 사용자 쿼리 제한이 업데이트되었습니다.
- [Azure Monitor Log Analytics에서 고객 관리형 스토리지 계정 사용](logs/private-storage.md) - 재작성된 문서
- [Azure Log Analytics에서 데이터 보기 및 분석](./logs/data-platform-logs.md) - 작업 영역 기반 애플리케이션을 포함하도록 업데이트되었습니다.


### <a name="platform-logs"></a>플랫폼 로그
- [Azure 활동 로그 이벤트 스키마 - Azure Monitor](essentials/activity-log-schema.md) - 심각도 수준이 추가되었습니다.
- [진단 설정에 대한 Resource Manager 템플릿 샘플](essentials/resource-manager-diagnostic-settings.md) - Azure 스토리지 계정에 대한 샘플이 추가되었습니다.

### <a name="visualizations"></a>시각화
- [Azure Monitor 통합 문서 차트 시각화](visualize/workbooks-chart-visualizations.md) - 새 문서
- [Azure Monitor 통합 문서 복합 막대 렌더러](visualize/workbooks-composite-bar.md) - 새 문서
- [Azure Monitor 통합 문서 그래프 렌더러](visualize/workbooks-graph-visualizations.md) - 새 문서
- [Azure Monitor 통합 문서 그리드 시각화](visualize/workbooks-grid-visualizations.md) - 새 문서
- [Azure Monitor 통합 문서 벌집 시각화](visualize/workbooks-honey-comb.md) - 새 문서
- [Azure Monitor 통합 문서 텍스트 시각화](visualize/workbooks-text-visualizations.md) - 새 문서
- [Azure Monitor 통합 문서 타일 시각화](visualize/workbooks-tile-visualizations.md) - 새 문서
- [Azure Monitor 통합 문서 트리 시각화](visualize/workbooks-tree-visualizations.md) - 새 문서
...
### <a name="agents"></a>에이전트
- [Azure Monitor 에이전트 개요](agents/azure-monitor-agent-overview.md) - 새 문서.
- [하이브리드 환경에서 Azure Monitor 사용](vm/vminsights-enable-hybrid.md) - 종속성 에이전트 버전이 업데이트되었습니다.
- [Azure 모니터링 에이전트 개요](agents/agents-overview.md) - Azure Monitor 에이전트가 추가되고 OS 지원 테이블이 통합되었습니다.
...
- [Application Insights JavaScript SDK에 대한 플러그 인 응답](app/javascript-react-plugin.md) - 새 문서입니다.
- [Application Insights 모니터링을 사용하여 Azure 함수 앱을 만들기 위한 Resource Manager 템플릿 샘플](app/resource-manager-function-app.md) - 새 문서입니다.
- [Application Insights 모니터링을 사용하여 Azure App Services 웹앱을 만들기 위한 Resource Manager 템플릿 샘플](app/resource-manager-web-app.md) - 새 문서입니다.
- [Azure Application Insights로 사용량 분석](app/usage-overview.md) - 동영상이 추가되었습니다.

### <a name="autoscale"></a>자동 크기 조정
- [Azure에서 자동 크기 조정 시작](autoscale/autoscale-get-started.md) - App Service의 정상 인스턴스로 라우팅하는 섹션이 추가되었습니다.

### <a name="data-collection"></a>데이터 수집
- [Azure Monitor 에이전트를 위한 데이터 컬렉션 구성(미리 보기)](agents/data-collection-rule-azure-monitor-agent.md) - 새 문서입니다.
- [Azure Monitor의 데이터 컬렉션 규칙(미리 보기)](agents/data-collection-rule-overview.md) - 새 문서입니다.
...
- [Azure Monitor FAQ](faq.md) - 작업 영역에서 데이터를 삭제하는 항목이 추가되었습니다. 502 및 503 응답에 항목이 추가되었습니다.
  - [Azure Monitor 로그 배포 디자인](logs/design-logs-deployment.md) - 수집 볼륨 요금 제한 섹션으로 업데이트합니다.
- [Azure Monitor 로그의 사용량 및 비용 관리](logs/manage-cost-storage.md) - 더 효율적인 쿼리 형식을 위한 사용량 쿼리가 업데이트되었습니다.
- [Azure Monitor의 로그 쿼리 최적화](logs/query-optimization.md) - 성능 표시기에 대한 특정 값이 추가되었습니다.
- [진단 설정에 대한 Resource Manager 템플릿 샘플](essentials/resource-manager-diagnostic-settings.md) - 로그 쿼리 감사 로그에 대한 샘플이 추가되었습니다.


### <a name="platform-logs"></a>플랫폼 로그
- [플랫폼 로그 및 메트릭을 다른 대상으로 전송하는 진단 설정 만들기](essentials/diagnostic-settings.md) - 진단 설정을 위한 지역 요구 사항이 추가되었습니다.

### <a name="visualizations"></a>시각화
- [Azure Monitor 통합 문서 개요](visualize/workbooks-overview.md) - 동영상이 추가되었습니다.
- [Azure 통합 문서 템플릿을 다른 지역으로 이동](visualize/workbook-templates-move-region.md) - 새 문서입니다.
- [Azure 통합 문서를 다른 지역으로 이동](visualize/workbooks-move-region.md) - 새 문서입니다.
...
### <a name="alerts"></a>경고
- [Azure Monitor 경고에 대한 작업 규칙](alerts/alerts-action-rules.md) - CLI 프로세스가 추가됨
- [Azure Portal에서 작업 그룹 만들기 및 관리](alerts/action-groups.md) - UI의 변경 내용을 반영하도록 업데이트됨
- [Azure Monitor Log Analytics의 예제 쿼리](logs/example-queries.md) - 새 문서.
- [Azure Monitor의 로그 경고 문제 해결](alerts/alerts-troubleshoot-log.md) - 경고 규칙 할당량에 섹션이 추가됨
- [Azure 메트릭 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 아직 내보내지 않은 사용자 지정 메트릭의 경고 규칙에 대한 섹션이 추가됨
- [Azure Monitor 메트릭 경고의 작동 방식 이해](alerts/alerts-metric-overview.md) - 집계 세분성 선택을 위한 권장 사항이 추가됨

### <a name="application-insights"></a>Application Insights
- [Azure 웹앱 확장에 대한 릴리스 정보 - Application Insights](app/web-app-extension-release-notes.md) - 새 문서
- [Application Insights 리소스에 대한 Resource Manager 템플릿 샘플](app/resource-manager-app-resource.md) - 새 문서
...
- [Azure Monitor HTTP 데이터 수집기 API](logs/data-collector-api.md) - Python 3 샘플이 추가됨
- [Azure Monitor에서 로그 쿼리 최적화](logs/query-optimization.md) - 하위 쿼리를 사용할 때 여러 데이터 검색 방지에 대한 섹션이 추가됨
- [자습서: Log Analytics 쿼리 시작](./logs/log-analytics-tutorial.md) - 비디오가 추가됨

### <a name="platform-logs"></a>플랫폼 로그
- [플랫폼 로그 및 메트릭을 다른 대상으로 전송하는 진단 설정 만들기](essentials/diagnostic-settings.md) - 비디오가 추가됨
- [Azure Monitor에 대한 Resource Manager 템플릿 샘플](/resource-manager-samples.md) - 로그 대상 유형을 사용하는 ARM 샘플이 추가됨 
...
### <a name="visualizations"></a>시각화
- [Log Analytics 대시보드 시각화 업그레이드](logs/dashboard-upgrade.md) - 새로 고침 빈도가 업데이트됨
...
- [Azure Monitor 고객 관리형 키](logs/customer-managed-keys.md) - 업데이트된 billingtype 속성. PowerShell 명령이 추가되었습니다.

### <a name="agents"></a>에이전트
- [Log Analytics 에이전트 개요](agents/log-analytics-agent.md) - Python 2 요구 사항이 추가되었습니다.

### <a name="alerts"></a>경고
- [대상 리소스가 다른 Azure 지역으로 이동할 때 경고 규칙 또는 작업 규칙을 업데이트하는 방법](alerts/alerts-resource-move.md) - 새 문서.
- [Azure 메트릭 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 새 문서.
- [Azure Monitor에서 로그 경고 문제 해결](alerts/alerts-troubleshoot-metric.md) - 새 문서.
...
### <a name="logs"></a>로그
- [Azure Log Analytics 작업 영역 삭제 및 복구](logs/delete-workspace.md) - PowerShell 명령이 추가되었습니다. 문제 해결이 업데이트되었습니다.
- [Azure Monitor에서 Log Analytics 작업 영역 관리](logs/manage-access.md) - Azure RBAC 섹션에 허용되지 않는 테이블에 대한 예제가 추가되었습니다.
- [Azure Monitor 로그의 사용량 및 비용 관리](logs/manage-cost-storage.md) - 데이터 크기 계산에 대한 추가 세부 정보. 데이터 볼륨 경고 구성을 업데이트했습니다. Azure Sentinel에서 수집한 보안 데이터에 대한 세부 정보. 데이터 캡에 대한 설명.
- [Azure Logic Apps와 Power Automate로 Azure Monitor 로그 사용](logs/logicapp-flow-connector.md) - 커넥터 제한이 추가되었습니다.

### <a name="metrics"></a>메트릭
- [리소스 종류별 Azure Monitor 지원 메트릭](essentials/metrics-supported.md) - SQL Server 메트릭이 업데이트되었습니다.


### <a name="platform-logs"></a>플랫폼 로그

- [진단 설정에 대한 Resource Manager 템플릿 샘플](essentials/resource-manager-diagnostic-settings.md) - 활동 로그 진단 설정 수정.
- [Azure Portal을 사용하여 Log Analytics 작업 영역에 Azure 활동 로그 보내기](essentials/quick-collect-activity-log-portal.md) - 새 문서.
- [Azure Resource Manager 템플릿을 사용하여 Log Analytics 작업 영역에 Azure 활동 로그 보내기](essentials/quick-collect-activity-log-arm.md) - 새 문서.

플랫폼 로그 콘텐츠 재구성 및 통합의 새로운 문서 및 업데이트된 문서

- [스토리지 계정에 Azure 리소스 로그 보관](./essentials/resource-logs.md#send-to-azure-storage)
- [Azure 활동 로그 이벤트 스키마](essentials/activity-log-schema.md)
- [Azure 활동 로그](essentials/activity-log.md)
- [Azure Monitor CLI 샘플](/cli-samples.md)
- [Azure Monitor PowerShell 샘플](/powershell-samples.md)
- [Azure Monitoring REST API 연습](essentials/rest-api-walkthrough.md)
- [Azure 리소스 로그 지원 서비스 및 스키마](./essentials/resource-logs-schema.md)
- [Azure 리소스 로그](essentials/resource-logs.md)
- [Azure Monitor에서 Azure 활동 로그 수집 및 분석](./essentials/activity-log.md)
- [Log Analytics 작업 영역에서 Azure 리소스 로그 수집](./essentials/resource-logs.md#send-to-log-analytics-workspace)
- [플랫폼 로그 및 메트릭을 다른 대상으로 전송하는 진단 설정 만들기](essentials/diagnostic-settings.md)
- [Azure 활동 로그 내보내기](./essentials/activity-log.md#legacy-collection-methods)
- [Azure 플랫폼 로그 개요](essentials/platform-logs-overview.md)
- [이벤트 허브로 Azure 플랫폼 로그 스트림](./essentials/resource-logs.md#send-to-azure-event-hubs)
...
### <a name="visualizations"></a>시각화
- [Azure Monitor 통합 문서 데이터 원본](visualize/workbooks-data-sources.md) - 경고 및 사용자 지정 엔드포인트 섹션이 추가되었습니다.
- [Azure Monitor 통합 문서 기반 인사이트 문제 해결](insights/troubleshoot-workbooks.md) - 새 문서.
- [Log Analytics 대시보드 시각화 업그레이드](logs/dashboard-upgrade.md) - 새 문서.
...
- [Azure Monitor 고객 관리형 키](logs/customer-managed-keys.md) - 일반 공급을 위한 다양한 변경 내용.
- [Azure Monitor에 대한 기본 제공 정책 정의](./policy-reference.md) - 새 문서
- [로그 수집을 위한 고객 소유 스토리지 계정](logs/private-storage.md) - 새 문서
- [Azure Monitor 로그 사용량 및 비용 관리](logs/manage-cost-storage.md) - 클러스터에 대한 비례 요금 청구가 추가됨.
- [Azure Private Link를 사용하여 네트워크를 Azure Monitor에 안전하게 연결](logs/private-link-security.md) - 새 문서
...
- [로그 쿼리 경고 규칙에 대한 Resource Manager 템플릿 샘플](alerts/resource-manager-alerts-log.md)
- [메트릭 경고 규칙에 대한 Resource Manager 템플릿 샘플](alerts/resource-manager-alerts-metric.md)
- [통합 문서에 대한 Resource Manager 템플릿 샘플](visualize/resource-manager-workbooks.md)

### <a name="agents"></a>에이전트
- [WAD (Windows Azure 진단 확장) 설치 및 구성](agents/diagnostics-extension-windows-install.md) - 진단 구성에 대한 세부 정보가 추가됨.
- [Log Analytics 에이전트 개요](agents/log-analytics-agent.md) - 지원되는 Linux 버전이 추가됨.
...
- [Azure Monitor 로그 쿼리의 앱() 식](logs/app-expression.md)
- [Azure Monitor Log Analytics의 로그 쿼리 범위](logs/scope.md)
- [Azure Monitor로 리소스 쿼리](logs/cross-workspace-query.md)
- [Azure Monitor 로그 레코드의 표준 속성](./logs/log-standard-columns.md)
- [Azure Monitor 로그의 구조](./logs/data-platform-logs.md)
...
### <a name="logs"></a>로그
- [PowerShell을 사용하여 Log Analytics 설정 & 구성](logs/powershell-workspace-configuration.md) - 문제 해결 섹션을 추가
- [Azure Portal에서 Log Analytics 작업 영역 생성](logs/quick-create-workspace.md) - 문제 해결 섹션을 추가
- [Azure CLI를 사용하여 Log Analytics 작업 영역을 생성](logs/quick-create-workspace-cli.md) - 문제 해결 섹션을 추가
- [Azure Log Analytics 작업 영역 삭제 및 복구](logs/delete-workspace.md) - 삭제된 작업 영역 복구에 대한 정보가 업데이트
- [Azure Monitor 로그 쿼리 함수](logs/functions.md) - 다른 함수를 포함하지 않는 함수에 대한 메모를 제거
- [Azure Monitor 로그의 구조](./logs/data-platform-logs.md)-Application Insights 테이블에 대한 속성 설명이 명시됨
- [Azure Logic Apps와 Power Automate로 Azure Monitor 로그를 사용](logs/logicapp-flow-connector.md) - 한도 섹션을 추가함
- [PowerShell을 사용하여 Log Analytics 작업 영역 생성 및 구성](logs/powershell-workspace-configuration.md) - 문제 해결 섹션을 추가함


### <a name="metrics"></a>메트릭
- [리소스 유형별로 Azure Monitor 지원 메트릭](essentials/metrics-supported.md) - 게스트 메트릭 및 메트릭 라우팅을 설명함. 
...
- [Azure Monitor 고객 관리형 키](logs/customer-managed-keys.md) - 비동기 작업에 대한 섹션이 추가됨.
- [Azure Monitor에서 Log Analytics 작업 영역 관리](logs/manage-access.md) - 사용자 지정 로그 섹션이 업데이트됨.

### <a name="alerts"></a>경고

- [Azure Monitor 경고에 대한 작업 규칙](alerts/alerts-action-rules.md) - 비디오가 추가됨.
- [Azure의 경고 및 알림 모니터링 개요](alerts/alerts-overview.md) - 비디오가 추가됨.
...
- [하이브리드 Kubernetes 클러스터 모니터링을 중지하는 방법](containers/container-insights-optout-hybrid.md) - 새 문서
...
- [Azure Monitor 로그 사용량 및 비용 관리](logs/manage-cost-storage.md) - 로그 클러스터에 대한 요금 청구가 추가됨. 레거시 노드당 가격 책정 계층을 사용하는 고객이 GB당 또는 용량 예약 계층으로 이동할지 여부를 결정할 수 있도록 Kusto 쿼리가 추가되었습니다.

### <a name="metrics"></a>메트릭

- [Azure 메트릭 탐색기의 고급 기능](essentials/metrics-charts.md) - 집계 섹션이 추가됨.

### <a name="workbooks"></a>통합 문서

- [Azure Monitor 통합 문서 및 Azure Resource Manager 템플릿](visualize/workbooks-automate.md) - 통합 문서 템플릿을 배포하기 위한 Resource Manager 템플릿이 추가됩니다.
...
- [Azure Monitor 고객 관리형 키 구성](logs/customer-managed-keys.md) - 일반 업데이트입니다.
- [Azure Monitor 데이터 참조](/azure/azure-monitor/reference/) - 새 사이트입니다.

### <a name="alerts"></a>경고

- [Azure Monitor에서 활동 로그 경고 만들기, 보기 및 관리](alerts/alerts-activity-log.md) - Resource Manager 템플릿에 대한 추가 설명입니다.
- [Azure Monitor 메트릭 경고의 작동 방식 이해](alerts/alerts-metric-overview.md) - 정부 지원을 위해 업데이트되었습니다.
- [Azure Monitor 경고 및 알림 문제 해결](alerts/alerts-troubleshoot.md) - 새 문서
...
- [Azure Monitor에서 로그 쿼리 최적화](logs/query-optimization.md) - XML 및 JSON 구문 분석을 위해 추가된 CPU 조건입니다.
- [Azure Log Analytics 작업 영역 삭제 및 복구](logs/delete-workspace.md) - 추가된 문제 해결 방법입니다.
- [Azure Logic Apps 및 Power Automate와 함께 Azure Monitor 로그 사용](logs/logicapp-flow-connector.md) - 새 Azure Monitor 커넥터에 대한 내용이 업데이트되었습니다.

### <a name="metrics"></a>메트릭

- [Azure Portal에서 디스크 메트릭 사용 중단](essentials/portal-disk-metrics-deprecation.md)- 새 문서입니다.
- [자습서 - Azure Monitor에서 메트릭 차트 만들기](essentials/tutorial-metrics-explorer.md) - 추가된 비디오입니다.

### <a name="platform-logs"></a>플랫폼 로그

- [Azure Monitor에서 Azure 활동 로그 수집 및 분석](./essentials/activity-log.md) - 진단 설정을 사용하여 활동 로그를 수집하는 방법을 보다 정확하게 설명하기 위해 다시 작성 되었습니다.
...
- [Azure 모니터링 에이전트 개요](agents/agents-overview.md) - 각 에이전트의 고유한 기능을 보다 명확하게 설명하기 위해 재구성된 테이블
- [Azure Diagnostics 확장 개요](agents/diagnostics-extension-overview.md) - 다시 작성을 완료합니다.
- [Azure Monitor에서 IIS에 대해 Blob 스토리지 및 이벤트에 대해 테이블 스토리지 사용](essentials/diagnostics-extension-logs.md) - 업데이트 및 명확성을 위한 일반 재작성
- [Windows Azure 진단 확장(WAD) 설치 및 구성](agents/diagnostics-extension-windows-install.md) - 새 문서 
- [Windows 진단 확장 스키마](agents/diagnostics-extension-schema-windows.md) - 재구성됨
- [Microsoft Azure 진단 확장에서 Azure Event Hubs로 데이터 전송](agents/diagnostics-extension-stream-event-hubs.md) - 완전히 다시 작성되고 업데이트됨
...
- [Azure Monitor에서 로그 쿼리 최적화](logs/query-optimization.md) - 새 문서
- [Azure Monitor 로그에 대한 사용량 및 비용 관리](logs/manage-cost-storage.md) - 사용량을 이해하는 데 도움이 되는 향상된 샘플 쿼리

### <a name="metrics"></a>메트릭

- [진단 설정을 통해 내보낼 수 있는 Azure Monitor 플랫폼 메트릭](essentials/metrics-supported-export-diagnostic-settings.md) - Null 및 0 값에 대한 동작 변경 내용에 추가된 섹션

### <a name="visualizations"></a>시각화

뷰 디자이너에서 통합 문서로 전환 가이드에 대한 여러 가지 새 문서

- [Azure Monitor 뷰 디자이너에서 통합 문서로 전환 가이드](visualize/view-designer-conversion-overview.md) - 새 문서
- [Azure Monitor 뷰 디자이너에서 통합 문서로 전환 옵션](visualize/view-designer-conversion-options.md) - 새 문서
- [Azure Monitor 뷰 디자이너에서 통합 문서로 타일 전환](visualize/view-designer-conversion-tiles.md) - 새 문서
- [Azure Monitor 뷰 디자이너에서 통합 문서로 전환 요약 및 액세스](visualize/view-designer-conversion-access.md) - 새 문서
- [Azure Monitor 뷰 디자이너에서 통합 문서로 전환 일반 작업](visualize/view-designer-conversion-tasks.md) - 새 문서
- [Azure Monitor 뷰 디자이너에서 통합 문서로 전환 예제](visualize/view-designer-conversion-examples.md) - 새 문서
...
- [Azure Log Analytics 에이전트를 사용하여 로그 데이터 수집](agents/log-analytics-agent.md) - 네트워크 방화벽 요구 사항 표가 업데이트되었습니다.

### <a name="alerts"></a>경고

- [Azure Portal에서 작업 그룹 만들기 및 관리](alerts/action-groups.md) - 더 이상 필요하지 않은 v2 기능에 대한 설정이 제거되었습니다.
- [Resource Manager 템플릿을 사용하여 메트릭 경고 만들기](alerts/alerts-metric-create-templates.md) - *ignoreDataBefore* 매개 변수에 대한 예제가 추가되었습니다.  다중 조건 규칙에 대한 제약 조건이 추가되었습니다.
- [Log Analytics 경고 REST API 사용](alerts/api-alerts.md) - JSON 예제가 수정되었습니다.
...
- [Azure Monitor 고객 관리형 키 구성](logs/customer-managed-keys.md) - 새 문서
...
- [Azure Monitor에서 Log Analytics 작업 영역 관리](logs/manage-access.md) - '작업 없음'으로 업데이트되었습니다.
- [Azure Monitor 로그의 사용량 및 비용 관리](logs/manage-cost-storage.md) - 가격 책정 모델 섹션에서 데이터 볼륨 계산에 대한 설명이 추가되었습니다.
- [Azure Resource Manager 템플릿을 사용하여 Log Analytics 작업 영역 만들기 및 구성](./logs/resource-manager-workspace.md) - 템플릿에서 새 가격 책정 계층을 사용하도록 업데이트되었습니다.

### <a name="platform-logs"></a>플랫폼 로그

- [진단 설정을 사용하여 Azure 활동 로그 수집 - Azure Monitor](./essentials/activity-log.md) - 변경된 속성에 대한 정보가 추가되었습니다.
- [Azure 활동 로그 내보내기](./essentials/activity-log.md#legacy-collection-methods) - 변경된 UI에 맞도록 업데이트되었습니다. 

## <a name="december-2019"></a>2019년 12월

### <a name="agents"></a>에이전트

- [Azure Monitor에 Linux 컴퓨터 연결](agents/agent-linux.md) - 새 문서

### <a name="alerts"></a>경고

- [Resource Manager 템플릿을 사용하여 메트릭 경고 만들기](alerts/alerts-metric-create-templates.md) - 사용자 지정 메트릭에 대한 예제가 추가되었습니다.
- [Azure Monitor에서 동적 임계값을 사용하는 경고 만들기](alerts/alerts-dynamic-thresholds.md) - 동적 임계값 차트를 해석하는 방법에 대한 섹션이 추가되었습니다.
- [Azure의 경고 및 알림 모니터링 개요](alerts/alerts-overview.md) - 리소스 그래프 쿼리가 업데이트되었습니다.
- [Azure Monitor에서 메트릭 경고에 지원되는 리소스](alerts/alerts-metric-near-real-time.md) - 지원되는 메트릭 및 차원이 업데이트되었습니다.
- [레거시 Log Analytics 경고 API에서 새 Azure 경고 API로 전환](alerts/alerts-log-api-switch.md) - 수정된 경고 이름에 대한 참고 사항이 추가되었습니다.
- [Azure Monitor 메트릭 경고의 작동 방식 이해](alerts/alerts-metric-overview.md) - 규모에 맞게 모니터링에 지원되는 리소스 종류가 추가되었습니다.
...
- [Azure Log Analytics의 IT Service Management Connector에 지원되는 연결](alerts/itsmc-connections.md) - 필수 구성 요소 클라이언트 ID 및 클라이언트 암호에 New York이 추가되었습니다.

### <a name="logs"></a>로그

- [Azure Log Analytics 작업 영역 삭제 및 복구](logs/delete-workspace.md) - PowerShell 메서드가 추가되었습니다.
- [Azure Monitor 로그 배포 디자인](logs/design-logs-deployment.md) - 작업 영역에 대한 수집 비율이 증가되었습니다.

### <a name="metrics"></a>메트릭

- [진단 설정을 통해 내보낼 수 있는 Azure Monitor 플랫폼 메트릭](essentials/metrics-supported-export-diagnostic-settings.md) - 새 문서
...
- [Log Analytics 작업 영역에서 Azure 활동 로그 수집 및 분석](./essentials/activity-log.md)
- [진단 설정을 사용하여 Azure 활동 로그 수집(미리 보기) - Azure Monitor](./essentials/activity-log.md)
- [Azure 테넌트 전체에서 Log Analytics 작업 영역으로 Azure 활동 로그 수집](./essentials/activity-log.md)
- [Log Analytics 작업 영역에서 Azure 리소스 로그 수집](./essentials/resource-logs.md#send-to-log-analytics-workspace)
- [Resource Manager 템플릿을 사용하여 Azure에서 진단 설정 만들기](./essentials/resource-manager-diagnostic-settings.md)
- [Azure에서 로그 및 메트릭을 수집하는 진단 설정 만들기](essentials/diagnostic-settings.md)
- [Azure 활동 로그 내보내기](./essentials/activity-log.md#legacy-collection-methods)
- [Azure 플랫폼 로그 개요](essentials/platform-logs-overview.md)
- [이벤트 허브로 Azure 모니터링 데이터 스트림](essentials/stream-monitoring-data-event-hubs.md)
- [이벤트 허브로 Azure 플랫폼 로그 스트림](./essentials/resource-logs.md#send-to-azure-event-hubs)

### <a name="quickstarts-and-tutorials"></a>빠른 시작 및 자습서

- [Azure Monitor에서 메트릭 차트 만들기](essentials/tutorial-metrics-explorer.md) - 새 문서
- [Azure 리소스에서 리소스 로그를 수집하고 Azure Monitor를 사용하여 분석](essentials/tutorial-resource-logs.md) - 새 문서
- [Azure Monitor를 사용하여 Azure 리소스 모니터링](essentials/quick-monitor-azure-resource.md) - 새 문서
