...
|메트릭|진단 설정을 통해 내보내기 가능?|메트릭 표시 이름|단위|집계 형식|설명|차원|
|---|---|---|---|---|---|---|
|활성-타이머-개수|예|System.Runtime|활성-타이머-개수|개수|평균|현재 활성 상태인 타이머의 수입니다.|배포, AppName, Pod|
|할당 율|예|System.Runtime|할당 율|바이트|평균|관리 되는 힙에서 할당 된 바이트 수|배포, AppName, Pod|
|AppCpuUsage|예|앱 CPU 사용량 (미리 보기)|백분율|평균|앱에 대 한 최근 CPU 사용량|배포, AppName, Pod|
|어셈블리 수|예|System.Runtime|어셈블리 수|개수|평균|로드 된 어셈블리 수|배포, AppName, Pod|
|cpu 사용량|예|System.Runtime|cpu 사용량|백분율|평균|프로세스에서 CPU를 사용한 시간 (%)|배포, AppName, Pod|
|현재 요청|예|Microsoft.AspNetCore.Hosting|현재 요청|개수|평균|프로세스의 수명 동안 처리 중인 총 요청 수입니다.|배포, AppName, Pod|
|예외-개수|예|System.Runtime|예외-개수|개수|합계|예외 수|배포, AppName, Pod|
|실패-요청|예|Microsoft.AspNetCore.Hosting|실패-요청|개수|평균|프로세스의 수명 동안 실패 한 총 요청 수입니다.|배포, AppName, Pod|
|gc-힙 크기|예|System.Runtime|gc-힙 크기|개수|평균|GC에서 보고 한 총 힙 크기 (MB)|배포, AppName, Pod|
|gen-0-gc-개수|예|System.Runtime|gen-0-gc-개수|개수|평균|0 세대 Gc 수|배포, AppName, Pod|
|gen-0-크기|예|System.Runtime|gen-0-크기|바이트|평균|Gen 0 힙 크기|배포, AppName, Pod|
|gen-1-gc-개수|예|System.Runtime|gen-1-gc-개수|개수|평균|System.Runtime|Gen 1 Gc 수|배포, AppName, Pod|
|gen-1-크기|예|System.Runtime|gen-1-크기|바이트|평균|Gen 1 힙 크기|배포, AppName, Pod|
|gen-2-gc-개수|예|System.Runtime|gen-2-gc-개수|개수|평균|Gen 2 Gc 수|배포, AppName, Pod|
|gen-2-크기|예|System.Runtime|gen-2-크기|바이트|평균|Gen 2 힙 크기|배포, AppName, Pod|
...
|loh-크기|예|System.Runtime|loh-크기|바이트|평균|LOH 힙 크기|배포, AppName, Pod|
|모니터-잠금-경합 수|예|System.Runtime|모니터-잠금-경합 수|개수|평균|모니터 잠금을 사용 하려고 할 때 경합이 있었던 횟수|배포, AppName, Pod|
|프로세스. cpu 사용량|예|프로세스. cpu 사용량|백분율|평균|JVM 프로세스에 대 한 최근 CPU 사용량|배포, AppName, Pod|
|초당 요청 수|예|Microsoft.AspNetCore.Hosting|요청-요율|개수|평균|요청 속도|배포, AppName, Pod|
|시스템 cpu 사용량|예|시스템 cpu 사용량|백분율|평균|전체 시스템의 최근 CPU 사용량|배포, AppName, Pod|
|threadpool-완료-항목 수|예|System.Runtime|threadpool-완료-항목 수|개수|평균|ThreadPool 완료 된 작업 항목 수|배포, AppName, Pod|
|threadpool-큐 길이|예|System.Runtime|threadpool-큐 길이|개수|평균|ThreadPool 작업 항목 큐 길이|배포, AppName, Pod|
|threadpool-스레드 수|예|System.Runtime|threadpool-스레드 수|개수|평균|ThreadPool 스레드 수|배포, AppName, Pod|
|gc 시간|예|System.Runtime|gc 시간|백분율|평균|마지막 GC 이후 GC의 시간 (%)|배포, AppName, Pod|
...
|total-requests|예|Microsoft.AspNetCore.Hosting|total-requests|개수|평균|프로세스 수명의 총 요청 수입니다.|배포, AppName, Pod|
|작업 집합|예|System.Runtime|작업 집합|개수|평균|프로세스에서 사용 하는 작업 집합의 양 (MB)|배포, AppName, Pod|
