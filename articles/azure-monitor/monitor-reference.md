...
| [VM용 Azure Monitor](insights/container-insights-overview.md) | Azure VM (가상 머신) 및 가상 머신 확장 집합을 대규모로 모니터링 합니다. 또한 Windows 및 Linux VM의 성능과 상태를 분석하고, 프로세스와 다른 리소스 및 외부 프로세스에 대한 종속성을 모니터링합니다. |
...
|Active Directory 도메인 서비스 | 예 | 예 | 아니요 |  |
|활동 로그 | 예 | 예 | 아니요 | |
|고급 위협 보호 | 아니요 | 아니요 | 아니요 |  |
|Advisor | 아니요 | 아니요 | 아니요 |  |
|AI 작성기 | 아니요 | 아니요 | 아니요 |  |
|Analysis Services | 예 | 예 | 아니요 |  |
|API for FHIR | 아니요 | 아니요 | 아니요 |  |
...
|Data Explorer | 예 | 예 | 아니요 |  |
|Data Factory | 예 | 예 | 아니요 |  |
|Data Factory v2 | 예 | 예 | 아니요 |  |
|Data Share | 아니요 | 아니요 | 아니요 |  |
|Database for MariaDB | 예 | 예 | 아니요 |  |
|Database for MySQL | 예 | 예 | 아니요 |  |
|Database for PostgreSQL | 예 | 예 | 아니요 |  |
...
|Microsoft Managed Desktop | 아니요 | 아니요 | 아니요 |  |
|Microsoft PowerApps | 아니요 | 아니요 | 아니요 |  |
|Microsoft Social Engagement | 아니요 | 아니요 | 아니요 |  |
|Microsoft Stream | 예 | 예 | 아니요 |  |
|마이그레이션 | 아니요 | 아니요 | 아니요 |  |
|Multi-Factor Authentication | 예 | 예 | 아니요 |  |
|Network Watcher | 예 | 예 | 아니요 |  |
|Notification Hubs | 예 | 아니요 | 아니요 |  |
...
|검색 | 예 | 예 | 아니요 |  |
|서비스 버스 | 예 | 예 | 아니요 |  |
|Service Fabric | 예 | 예 | 아니요 | 에이전트가 게스트 운영 체제 및 워크플로를 모니터링 하는 데 필요 합니다.  |
|등록 포털 | 아니요 | 아니요 | 아니요 |  |
|Site Recovery | 예 | 예 | 아니요 |  |
|스프링 클라우드 서비스 | 아니요 | 아니요 | 아니요 |  |
|SQL Data Warehouse | 예 | 예 | 아니요 |  |
|SQL Database | 예 | 예 | 아니요 |  |
...
|유니버설 인쇄 | 아니요 | 아니요 | 아니요 |  |
|Virtual Machine Scale Sets | 예 | 예 | [예](insights/vminsights-overview.md) | 에이전트가 게스트 운영 체제 및 워크플로를 모니터링 하는 데 필요 합니다. |
|Virtual Machines | 예 | 예 | [예](insights/vminsights-overview.md) | 에이전트가 게스트 운영 체제 및 워크플로를 모니터링 하는 데 필요 합니다. |
|Virtual Network | 예 | 예 | [예](insights/network-insights-overview.md) |  |
|Virtual Network-NSG 흐름 로그 | 예 | 예 | 아니요 |  |
|VPN Gateway | 예 | 예 | 아니요 |  |
...
| [활동 로그 분석](platform/activity-log-view.md#azure-portal) | 활동 로그 항목을 봅니다. |
