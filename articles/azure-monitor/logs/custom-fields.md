...
> [!IMPORTANT]
> 사용자 지정 필드는 Log Analytics 작업 영역에 수집 되는 데이터의 양을 늘려 비용을 증가 시킬 수 있습니다. 자세한 내용은 [Azure Monitor 로그를 사용하여 사용량 및 비용 관리](../platform/manage-cost-storage.md#pricing-model)를 참조하세요.
