...
| 단계 | 속성 또는 함수 | 주석 |
|:---|:---|:---|
| 데이터 원본에 생성 되는 레코드 | [TimeGenerated](../platform/log-standard-columns.md#timegenerated-and-timestamp) <br>데이터 원본에서이 값을 설정 하지 않으면 _TimeReceived와 같은 시간으로 설정 됩니다. |
| Azure Monitor 수집 끝점에서 받은 레코드 | [_TimeReceived](../platform/log-standard-columns.md#_timereceived) | |
