...
* **경고 컨텍스트 (페이로드)**  
이 규칙은 경고 컨텍스트 필드에 하나 이상의 특정 값이 포함 된 경고에만 적용 됩니다.  
...
1. [Azure CLI 설치](/cli/azure/install-azure-cli)
   ...
   원한다 면 Azure Cloud Shell를 사용 하 여이 문서의 단계를 완료할 수도 있습니다.  Azure Cloud Shell은 브라우저를 통해 사용할 수 있는 대화형 셸 환경입니다.  다음 방법 중 하나를 사용하여 Cloud Shell을 시작합니다.
