...
1. **새 규칙으로 마이그레이션** 을 선택 하 여 마이그레이션 방문 페이지로 이동 합니다. 이 페이지에는 모든 구독의 목록과 마이그레이션 상태가 표시 됩니다.
    ...
    ![경고 규칙 마이그레이션 페이지를 보여 주는 스크린샷](media/alerts-using-migration-tool/migration-landing.png "마이그레이션 규칙")
...
1. 하나 이상의 구독을 선택한 다음, **마이그레이션 미리 보기** 를 선택 합니다.
    ...
    ![이 구독에 대 한 마이그레이션 세부 정보를 다운로드 하는 링크가 있는 경고 규칙 마이그레이션 페이지와 마이그레이션 알림에 대 한 전자 메일을 지정할 수 있는 스크린샷](media/alerts-using-migration-tool/migration-preview.png "마이그레이션 미리 보기")
...
1. **마이그레이션 시작** 을 선택 합니다. 확인 대화 상자에 표시 된 정보를 읽고 마이그레이션 프로세스를 시작할 준비가 되었는지 확인 합니다.
    ...
    ![진행 하기 전에 자세한 내용을 볼 수 있는 링크와 함께 중요 한 정보를 포함 하 여 마이그레이션에 대 한 확인 메시지가 스크린샷에 표시 됩니다.](media/alerts-using-migration-tool/migration-confirm.png "마이그레이션 시작 확인")
