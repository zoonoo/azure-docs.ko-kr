...
클래식 경고는 Azure Portal의 클래식 경고 사용자 화면 에서만 볼 수 있습니다. 경고 화면의 **클래식 경고 보기** 단추를 누르면 이 화면을 표시할 수 있습니다. 
...
* [활동 로그](../essentials/platform-logs-overview.md) 에 대 한 자세한 정보
