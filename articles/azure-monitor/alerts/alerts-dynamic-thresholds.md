...
전자 메일 또는 문자 메시지의 링크를 클릭 하 여 경고 보기에서 트리거된 경고 인스턴스를 탐색 하거나 브라우저를 클릭 하 여 Azure Portal에서 경고 보기를 볼 수 있습니다. [경고 보기에 대해 자세히 알아보세요](../platform/alerts-overview.md#alerts-experience).
