...
ms.locfileid: "111966935"
---
# <a name="resource-manager-template-samples-for-container-insights"></a>컨테이너 인사이트를 위한 Resource Manager 템플릿 샘플
이 문서에는 Azure Monitor에서 가상 머신에 대한 Log Analytics 에이전트를 배포하고 구성하기 위한 [Azure Resource Manager 템플릿](../../azure-resource-manager/templates/syntax.md) 샘플이 포함되어 있습니다. 각 샘플에는 템플릿 파일과 템플릿에 제공할 샘플 값이 포함된 매개 변수 파일이 포함되어 있습니다.
