...
컨테이너 정보를 사용 하 여 Windows Server 클러스터를 Linux 클러스터와 비교해 서 모니터링 하는 주요 차이점은 개요 문서 [에 설명 되어](container-insights-overview.md#what-does-container-insights-provide) 있습니다.
...
메트릭을 [분할](../essentials/metrics-charts.md#apply-splitting) 하 여 차원 별로 표시 하 고 서로 다른 세그먼트의 서로 비교 하는 방법을 시각화할 수 있습니다. 노드의 경우 *호스트* 차원에 따라 차트를 분할할 수 있습니다. Pod에서 다음 차원으로 분할할 수 있습니다.
