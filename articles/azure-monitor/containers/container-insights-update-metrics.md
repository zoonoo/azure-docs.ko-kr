...
* 사용자 지정 메트릭은 Azure 지역의 하위 집합 에서만 사용할 수 있습니다. 지원 되는 지역 목록은 [여기](../essentials/metrics-custom-overview.md#supported-regions)에 설명 되어 있습니다.
...
앞서 설명한 방법 중 하나를 사용 하 여 업데이트를 시작한 후 Azure Monitor 메트릭 탐색기를 사용 하 여 **정보** 를 확인할 수 있는 **메트릭 네임 스페이스** 에서 확인할 수 있습니다. 이 경우 계속 진행 하 여 [메트릭 경고](../alerts/alerts-metric.md) 를 설정 하거나 [대시보드에](../../azure-portal/azure-portal-dashboards.md)차트를 고정할 수 있습니다.  
