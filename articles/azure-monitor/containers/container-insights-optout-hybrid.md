...
description: 이 문서에서는 컨테이너 insights를 사용 하 여 hybrid Kubernetes 클러스터의 모니터링을 중지 하는 방법을 설명 합니다.
ms.topic: conceptual
ms.date: 06/16/2020
...
Kubernetes 클러스터의 모니터링을 사용 하도록 설정한 후에는 더 이상 모니터링 하지 않으려는 경우 컨테이너 정보를 사용 하 여 클러스터 모니터링을 중지할 수 있습니다. 이 문서에서는 다음 환경에 대해이 작업을 수행 하는 방법을 보여 줍니다.
