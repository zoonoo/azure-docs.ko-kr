...
이 문서에는 Azure Monitor에서 로그 쿼리 경로를 만들고 구성하기 위한 [Azure Resource Manager 템플릿](../../azure-resource-manager/templates/template-syntax.md) 샘플이 포함되어 있습니다. 각 샘플에는 템플릿 파일과 템플릿에 제공할 샘플 값이 포함된 매개 변수 파일이 포함되어 있습니다.

[!INCLUDE [azure-monitor-samples](../../../includes/azure-monitor-resource-manager-samples.md)]

## <a name="number-of-results-template-up-to-version-2018-04-16"></a>결과 템플릿 수(버전 2018-04-16까지)
다음 샘플에서는 [결과 수 경고 규칙](../platform/alerts-unified-log.md#count-of-the-results-table-rows)을 만듭니다.

### <a name="notes"></a>메모

- 이 샘플에는 [웹후크 페이로드](../platform/alerts-log-webhook.md)가 포함되어 있습니다. 경고 규칙에서 웹후크를 트리거하지 않아야 하는 경우 **customWebhookPayload** 요소를 제거합니다.
...
다음 샘플에서는 [메트릭 측정 경고 규칙](../platform/alerts-unified-log.md#calculation-of-measure-based-on-a-numeric-column-such-as-cpu-counter-value)을 만듭니다.
...
* [경고 규칙에 대해 자세히 알아보세요](../platform/alerts-overview.md).
