...
## <a name="number-of-results-alert-rule"></a>결과 수 경고 규칙
다음 샘플에서는 [결과 수 경고 규칙](../platform/alerts-unified-log.md#metric-measurement-alert-rules)을 만듭니다.
...
## <a name="metric-measurement-alert"></a>메트릭 측정 경고
다음 샘플에서는 [메트릭 측정 경고 규칙](../platform/alerts-unified-log.md#metric-measurement-alert-rules)을 만듭니다.
