...
1. **조사** 메뉴 아래에서 **가용성**을 선택한 다음 **테스트 추가**를 클릭합니다.
    ...
    ![가용성 테스트 추가](media/tutorial-alert/add-test.png)
