...
다음 예제에서는 [시각화 데이터 자습서](tutorial-logs-dashboards.md)에 저장된 *Azure VM - 프로세서 사용률* 쿼리에 기반을 둔 메트릭 측정 경고 규칙을 만듭니다.  90%의 임계값을 초과하는 각 가상 머신에 대한 경고가 생성됩니다.  
