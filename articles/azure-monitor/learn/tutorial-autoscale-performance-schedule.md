---
title: 데이터 또는 일정에 따라 Azure 리소스 자동 크기 조정
...
몇 분 내에 리소스를 프로비전해야 합니다. 이 자습서의 나머지 부분에서는 웹앱 및 해당 App Service 계획을 사용합니다.
   ...
   ![포털에서 새 앱 서비스 만들기](./media/tutorial-autoscale-performance-schedule/Web-App-Create.png)
...
이 규칙을 통해 Web App 이 5분 이내에 10개 이상의 요청을 수신하는 경우 하나의 추가 인스턴스가 App Service 계획에 추가되어 부하를 관리하게 됩니다.
   ...
   ![확장 규칙 만들기](./media/tutorial-autoscale-performance-schedule/Scale-Out-Rule.png)
...
7. **추가** 단추를 클릭합니다.
    ...
    ![축소 규칙 만들기](./media/tutorial-autoscale-performance-schedule/Scale-In-Rule.png)
...
8. 차트에는 이 자동 크기 조정 설정에서 수행한 각 크기 조정 작업에 해당하는 활동 로그 항목 집합이 표시됩니다.
    ...
    ![축소 작업 보기](./media/tutorial-autoscale-performance-schedule/Scale-In-Chart.png)
...
자동 크기 조정 설정에 대한 자세한 내용을 보려면 [자동 크기 조정 개요](../platform/autoscale-overview.md)를 계속 진행합니다.
