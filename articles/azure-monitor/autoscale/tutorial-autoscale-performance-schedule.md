...
자동 크기 조정 설정에 대한 자세한 내용을 보려면 [자동 크기 조정 개요](../autoscale/autoscale-overview.md)를 계속 진행합니다.

> [!div class="nextstepaction"]
> [모니터링 데이터 보관](../essentials/platform-logs-overview.md)
