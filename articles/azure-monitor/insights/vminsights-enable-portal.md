...
Azure Portal에서 **가상 머신**, **가상 머신 확장 집합**또는 **컴퓨터-Azure Arc** 를 선택 하 고 목록에서 리소스를 선택 합니다. 메뉴의 **모니터링** 섹션에서 **Insights** 를 선택 하 고 **사용**을 선택 합니다. 다음 예제에서는 azure 가상 컴퓨터를 보여 주지만 azure virtual machine scale set 또는 Azure Arc의 메뉴는 유사 합니다.
