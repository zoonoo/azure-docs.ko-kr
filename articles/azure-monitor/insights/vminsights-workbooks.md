...
* 알 수 없는 경우 관심 메트릭을 사전에 가상 컴퓨터의 사용 현황 탐색: CPU 사용률, 디스크 공간, 메모리, 네트워크 종속성, 등입니다. 다른 사용량 현황 분석 도구와는 달리 통합 문서를 통해 이러한 종류의 자유 형식 탐색에 매우 유용하도록 여러 종류의 시각화 및 분석을 결합할 수 있습니다.
