...
관리 팩의 이름은 *microsoft.intelligencepacks.updateassessment. ApplicationDependencyMonitor*입니다. 이는%Programfiles%\Microsoft Monitoring \server\health Service state\\stst\stststst\ager\ager\ager\ 관리 팩에 사용된 데이터 원본은 %Program files%\Microsoft Monitoring Agent\Agent\Health Service State\Resources\<AutoGeneratedID>\Microsoft.EnterpriseManagement.Advisor.ApplicationDependencyMonitorDataSource.dll입니다.
