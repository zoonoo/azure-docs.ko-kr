...
[컨테이너용 Azure Monitor 개요](../insights/container-insights-overview.md)를 참조하세요.
...
[Azure Monitor(미리 보기)를 사용하여 리소스 그룹 모니터링](../insights/resource-group-insights.md)을 참조하세요.
