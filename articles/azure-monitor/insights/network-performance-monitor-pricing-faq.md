...
**두 개의 서브넷 (A 및 B) 있고 각 서브넷에 여러 에이전트를 사용 했습니다. 2. 서브넷의 모든 에이전트는 서브넷에 있는 모든 에이전트 까지의 연결을 모니터링 하는 성능 모니터 요금이 청구 서브넷 간 연결의 수를 기준으로?**
...
**서비스 엔드포인트 모니터의 사용에 대 한 요금은 얼마 인가요?**
