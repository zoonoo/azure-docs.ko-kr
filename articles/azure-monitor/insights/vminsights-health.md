...
![상태 롤업 예제](./media/vminsights-health/health-diagnostics-windows-svc-rollup.png)
...
![상태 조건 구성 예제](./media/vminsights-health/health-diagnostics-linuxvm-example-03.png)
...
![단위 모니터의 상태 조건 구성 예제](./media/vminsights-health/health-diagnostics-linuxvm-example-04.png)
...
![모니터링되는 인스턴스 선택 및 결과 예제](./media/vminsights-health/health-diagnostics-linuxvm-example-02.png)
...
병목 상태 및 VM 성능에 대한 전반적인 사용률을 확인하려면 [Azure VM 성능 보기](vminsights-performance.md)를 참조하세요. 검색된 응용 프로그램 종속성을 보려면 [VM용 Azure Monitor 맵 보기](vminsights-maps.md)를 참조하세요. 
