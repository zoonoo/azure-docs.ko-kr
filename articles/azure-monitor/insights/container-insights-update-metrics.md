...
시작 하기 전에의 구성원 인지 확인 합니다 **[소유자](https://docs.microsoft.com/en-us/azure/role-based-access-control/built-in-role.mds#owner)** 노드의 컬렉션을 사용 하도록 설정 하 고 사용자 지정 성능 메트릭을 pod를 AKS 클러스터 리소스에 대 한 역할입니다. 
