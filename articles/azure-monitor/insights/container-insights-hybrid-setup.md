...
먼저 **containerSolutionParams** 파일의 `workspaceResourceId` 매개 변수 값에 필요한 Log Analytics 작업 영역의 전체 리소스 ID를 식별 하려면 다음 단계를 수행한 후 PowerShell cmdlet 또는 Azure CLI 명령을 실행 하 여 해결할.
