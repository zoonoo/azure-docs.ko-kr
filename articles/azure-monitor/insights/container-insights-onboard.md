...
컨테이너용 Azure Monitor는 다음 지원되는 방법을 사용하여 AKS의 새 배포에 사용할 수 있습니다.

* Azure Portal 또는 Azure CLI를 사용하여 관리되는 Kubernetes 클러스터 배포
* [Terraform 및 AKS](../../terraform/terraform-create-k8s-cluster-with-tf-and-aks.md)를 사용하여 Kubernetes 클러스터 만들기

또는 Azure Portal 또는 Azure CLI에서 하나 이상의 기존 AKS 클러스터에 대해 모니터링을 사용하도록 설정할 수도 있습니다. 
...
- 컨테이너 모니터링을 사용하도록 설정하기 위한 Log Analytics 참가자 역할의 멤버입니다. Log Analytics 작업 영역에 대한 액세스를 제어하는 방법에 대한 자세한 내용은 [작업 영역 관리](../../log-analytics/log-analytics-manage-access.md)를 참조하세요.

[!INCLUDE [log-analytics-agent-note](../../../includes/log-analytics-agent-note.md)]

## <a name="components"></a>구성 요소 

성능을 모니터링하는 기능은 컨테이너화된 Linux용 Log Analytics 에이전트에 의존합니다. 이를 통해 클러스터의 모든 노드에서 성능 및 이벤트 데이터를 수집합니다. 이 에이전트는 컨테이너용 Azure Monitor를 사용하도록 설정한 후에 지정된 Log Analytics 작업 영역에 자동으로 배포되고 등록됩니다. 배포된 버전은 microsoft / oms:ciprod04202018 이상이며, *mmddyyyy* 형식의 날짜로 표시됩니다. 
...
[Terraform을 사용하여 AKS 클러스터를 배포](../../terraform/terraform-create-k8s-cluster-with-tf-and-aks.md)하는 경우 인수 [**addon_profile**](https://www.terraform.io/docs/providers/azurerm/r/kubernetes_cluster.html#addon_profile)을 포함하고 **oms_agent**를 지정하여 컨테이너용 Azure Monitor를 사용하도록 설정할 수도 있습니다.  
