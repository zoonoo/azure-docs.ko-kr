...
이 솔루션을 배포하기 전에 [Windows 에이전트](../platform/agent-windows.md)가 Log Analytic 작업 영역 또는 작업 영역에 통합된 [Operations Manager 관리 그룹](../../azure-monitor/platform/om-agents.md)에 보고하도록 지원하는지 확인합니다.
