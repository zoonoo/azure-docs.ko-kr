...
다음 명령을 실행 하 여 Azure Red Hat OpenShift 이외의 Kubernetes 클러스터에 변경 내용을 적용 `kubectl apply -f  <path to yaml file>`합니다. ConfigMap을 편집 하 고 Azure Red Hat OpenShift 클러스터에이 변경 내용을 적용 하려면 명령을 실행 합니다.
