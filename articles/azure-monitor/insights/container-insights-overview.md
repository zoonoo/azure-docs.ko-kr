...
- Windows에는 메모리 RSS 메트릭이 없으므로 Windows 노드와 컨테이너에 사용할 수 없습니다. [작업 집합](https://docs.microsoft.com/windows/win32/memory/working-set) 메트릭을 사용할 수 있습니다.
