...
> [!NOTE]
> Azure 애플리케이션 Insights 커넥터는 API 키를 요구 하는 대신 Azure Active Directory와 통합 된 [Azure Monitor 커넥터로](../logs/logicapp-flow-connector.md) 대체 되었으며 Log Analytics 작업 영역에서 데이터를 검색할 수도 있습니다.
