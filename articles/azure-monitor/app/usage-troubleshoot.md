...
페이지 보기 및 사용자 지정 이벤트 이름은 사용자 동작 분석 도구 전체에서 사용됩니다. 이벤트 이름을 잘 지정하는 것은 이러한 도구에서 값을 가져오는 데 매우 중요합니다. 목표는 너무 적은, 과도 하 게 일반적인 이름 ("단추를 클릭) 하 고, 너무 많은 과도 하 게 구체적인 이름 (" http에서 편집 단추 클릭:\//www.contoso.com/index ").
