...
* [로그 기반 및 미리 집계 된 메트릭에](https://docs.microsoft.com/azure/azure-monitor/app/pre-aggregated-metrics-log-metrics)대해 알아봅니다.
* [로그 기반 메트릭 쿼리 및 정의](https://docs.microsoft.com/azure/azure-monitor/platform/app-insights-metrics).