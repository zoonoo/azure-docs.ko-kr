...
5. Power BI가 Azure에 액세스할 수 있도록 자격 증명을 제공해야 할 수 있습니다. **조직 계정을** 사용 하 여 Microsoft 계정 로그인 합니다.
   
    ![Power BI 쿼리 설정 대화 상자 스크린샷](./media/export-power-bi/power-bi-import-sign-in.png)

    자격 증명을 확인 해야 하는 경우 쿼리 편집기에서 **데이터 원본 설정** 메뉴 명령을 사용 합니다. Azure에 사용할 자격 증명은 Power BI용 자격 증명과 다를 수 있습니다.
