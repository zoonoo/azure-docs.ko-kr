...
*벌써 질문이 있나요?* [리소스 만들기에 대해 자세히 알아보세요](../../application-insights/app-insights-create-new-resource.md)를 구독해야 합니다.
...
* SharePoint 사이트의 경우 제어판에서 [사이트 설정/마스터 페이지](../../application-insights/app-insights-sharepoint.md)를 엽니다.
...
아직 아무 데이터도 없나요? 페이지 위쪽에서 **새로 고침을 클릭합니다. 여전히 아무 데이터도 없나요? [문제 해결](../../application-insights/app-insights-troubleshoot-faq.md)을 참조하세요.
...
* [사용자 동작 분석 도구에 대해 알아보기](../../application-insights/app-insights-usage-overview.md)
...
## <a name="next"></a> 다음 단계
* [사용 현황 추적](../../application-insights/app-insights-usage-overview.md)
* [사용자 지정 이벤트 및 메트릭](../../azure-monitor/app/api-custom-events-metrics.md)
* [빌드 - 측정 - 학습](../../application-insights/app-insights-usage-overview.md)
