---
title: Azure 모니터 응용 프로그램 인사이트 NuGet 패키지
description: Azure 모니터 응용 프로그램 인사이트 NuGet ASP.NET, ASP.NET 코어, 파이썬에 대한 패키지 목록
ms.topic: reference
ms.date: 10/16/2018
...
## <a name="common-packages-for-python-using-opencensus"></a>OpenCensus를 사용하여 파이썬에 대한 일반적인 패키지
| 패키지 이름 | 안정적 버전 | 설명 | 다운로드 |
|-------------------------------|-----------------------|------------|----|
| 오픈 인구 조사 - 내선 azure | 1.0.0 | OpenCensus를 통해 Azure 모니터에서 파이썬 응용 프로그램에 대한 응용 프로그램 인사이트. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-azure/) |
| 오픈 인구 조사 - 내선 - 장고 | 0.7.2 | 이 패키지는 파이썬 [장고](https://pypi.org/project/django/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-django/) |
| 오픈 인구 조사 - 내선 플라스크 | 0.7.3 | 이 패키지는 파이썬 [플라스크](https://pypi.org/project/flask/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-flask/) |
| 오픈 인구 조사 - 내선 - httplib | 0.7.2 | 이 패키지는 파이썬3용 파이썬 [http.client](https://docs.python.org/3/library/http.client.html) 라이브러리와 파이썬2용 [httplib를](https://docs.python.org/2/library/httplib.html) 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-httplib/) |
| 오픈 인구 조사 - 내선 로깅 | 0.1.0 | 이 패키지는 추적 데이터로 로그 레코드를 보강합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-logging/) |
| 오픈 인구 조사 - 내선 - mysql | 0.1.2 | 이 패키지는 파이썬 [mysql 커넥터](https://pypi.org/project/mysql-connector/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-mysql/) |
| 오픈 인구 조사 - 내선 포스트 그레sql | 0.1.2 | 이 패키지는 파이썬 [psycopg2](https://pypi.org/project/psycopg2/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-postgresql/) |
| 오픈 인구 조사 - 내선 피몽고 | 0.7.1 | 이 패키지는 파이썬 [피몬고](https://pypi.org/project/pymongo/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-pymongo/) |
| 오픈 인구 조사 - 내선 피미 SQL | 0.1.2 | 이 패키지는 파이썬 [파이마이SQL](https://pypi.org/project/PyMySQL/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-pymysql/) |
| 오픈 인구 조사 - 내선 피라미드 | 0.7.1 | 이 패키지는 파이썬 [피라미드](https://pypi.org/project/pyramid/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-pyramid/) |
| 오픈 인구 조사 - 내선 요청 | 0.7.2 | 이 패키지는 파이썬 [요청](https://pypi.org/project/requests/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-requests/) |
| 오픈 인구 조사 - 내선 - sqlalchemy | 0.1.2 | 이 패키지는 파이썬 [SQLAlchemy](https://pypi.org/project/SQLAlchemy/) 라이브러리와의 통합을 제공합니다. | [패키지 다운로드](https://pypi.org/project/opencensus-ext-sqlalchemy/) |
