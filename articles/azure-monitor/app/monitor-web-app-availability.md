...
#### <a name="us-sec"></a>US 초

| 표시 이름 | 채우기 이름 |
|--------------|-----------------|
| USSec 서 부   | ussec-서-ms-azr-0017p  |
| USSec 동부   | ussec-동-ms-azr-0017p  |

#### <a name="us-nat"></a>US Nat

| 표시 이름 | 채우기 이름 |
|--------------|-----------------|
| USNat 동부   | usnat-동-ms-azr-0017p  |
| USNat 서 부   | usnat-서-ms-azr-0017p  |
...
[여기에서](./transaction-diagnostics.md) 종단 간 트랜잭션 진단 환경에 대해 자세히 알아봅니다.
