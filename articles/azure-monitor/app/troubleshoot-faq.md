...
* [.NET 앱](../../azure-monitor/app/asp-net-troubleshoot-no-data.md)
* [이미 실행 중인 앱 모니터링](../../azure-monitor/app/monitor-performance-live-website-now.md#troubleshoot)
* [Azure 진단](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [Java 웹앱](../../azure-monitor/app/java-troubleshoot.md)

*내 서버에서 데이터를 가져오지 않습니다.*

* [방화벽 예외 설정](../../azure-monitor/app/ip-addresses.md)
* [ASP.NET 서버 설정](../../azure-monitor/app/monitor-performance-live-website-now.md)
* [Java 서버 설정](../../azure-monitor/app/java-agent.md)

## <a name="can-i-use-application-insights-with-"></a>Application Insights와 같이 사용할 수 있나요...?

* [IIS 서버의 웹앱 - 온-프레미스 또는 VM](../../azure-monitor/app/asp-net.md)
* [Java 웹앱](../../azure-monitor/app/java-get-started.md)
* [Node.js 앱](../../azure-monitor/app/nodejs.md)
* [Azure의 Web Apps](../../azure-monitor/app/azure-web-apps.md)
* [Azure의 Cloud Services](../../azure-monitor/app/cloudservices.md)
* [Docker에서 실행되는 앱 서버](../../azure-monitor/app/docker.md)
* [단일 페이지 웹앱](../../azure-monitor/app/javascript.md)
* [SharePoint](sharepoint.md)
* [Windows 데스크톱 앱](../../azure-monitor/app/windows-desktop.md)
...
더 큰 볼륨의 원격 분석은 GB 단위로 청구됩니다. [요금 제한](../../azure-monitor/app/pricing.md) 방법에 대한 몇 가지 팁을 제공합니다.
...
사용자의 애플리케이션 유형에 적합한 SDK는 [릴리스 정보](../../azure-monitor/app/release-notes.md)를 참조하세요.
...
[자세히 알아보기](../../azure-monitor/app/monitor-performance-live-website-now.md#questions).
...
* HTTP 요청
* [종속성](../../azure-monitor/app/asp-net-dependencies.md). 호출: SQL Database, 외부 서비스(Azure Cosmos DB, 테이블, Blob Storage 및 큐)에 대한 HTTP 호출. 
* [예외](../../azure-monitor/app/asp-net-exceptions.md) 및 스택 추적.
* [성능 카운터](../../azure-monitor/app/performance-counters.md) - [상태 모니터](../../azure-monitor/app/monitor-performance-live-website-now.md), [Azure 모니터링](../../azure-monitor/app/azure-web-apps.md) 또는 [Application Insights 수집 기록기](../../azure-monitor/app/java-collectd.md)를 사용하는 경우입니다.
* 코딩하는 [사용자 지정 이벤트 및 메트릭](../../azure-monitor/app/api-custom-events-metrics.md).
* 적절한 수집기를 구성한 경우 [추적 로그](../../azure-monitor/app/asp-net-trace-logs.md).

[클라이언트 웹 페이지](../../azure-monitor/app/javascript.md):

* [페이지 보기 수](usage-overview.md)
* 실행되는 스크립트의 [AJAX 호출](../../azure-monitor/app/asp-net-dependencies.md) 요청.
* 페이지 보기 로드 데이터
* 사용자 및 세션 수
* [인증된 사용자 ID](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users)

다른 원본(구성한 경우):

* [Azure 진단](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [Analytics로 가져오기](https://docs.microsoft.com/azure/log-analytics/log-analytics-data-collector-api)
...
[ASP.NET](../../azure-monitor/app/api-filtering-sampling.md) 또는 [Java](../../azure-monitor/app/java-filter-telemetry.md)에 대해 자세히 알아보세요.
...
[Power BI를 사용](../../azure-monitor/app/export-power-bi.md )하여 요청 원격 분석을 지도에 표시할 수 있습니다.
...
코드에서 이러한 데이터를 전송하는 경우 가능합니다. 스택 추적의 변수에 개인 데이터가 포함된 경우에도 전송될 수 있습니다. 개발 팀은 개인 데이터가 제대로 처리되도록 위험 평가를 수행해야 합니다. [데이터 보존 및 개인 정보](../../azure-monitor/app/data-retention-privacy.md)에 대해 자세히 알아보세요.
...
* [예 - 작업자 및 웹 역할이 포함된 클라우드 서비스](../../azure-monitor/app/cloudservices.md)
...
* 여러 컴퓨터 및 브라우저에서 로그인한 사용자를 식별하려면 [setAuthenticatedUserContext()](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users)에 대한 호출을 추가합니다.

## <a name="q17"></a> Application Insights의 모든 기능을 사용하도록 어떻게 설정하나요?
| 표시 내용 | 시작 방법 | 원하는 이유 |
| --- | --- | --- |
| 가용성 차트 |[웹 테스트](../../azure-monitor/app/monitor-web-app-availability.md) |웹 앱이 작동 중인지 확인 |
| 서버 앱 성능: 응답시간. ... |[프로젝트에 Application Insights 추가](../../azure-monitor/app/asp-net.md) 또는 [서버에 AI 상태 모니터 설치](../../azure-monitor/app/monitor-performance-live-website-now.md)(또는 [종속성 추적](../../azure-monitor/app/api-custom-events-metrics.md#trackdependency)을 위한 자체 코드 작성) |성능 문제 검색 |
| 종속성 원격 분석 |[서버에 AI 상태 모니터 설치](../../azure-monitor/app/monitor-performance-live-website-now.md) |데이터베이스 또는 다른 외부 구성 요소의 문제 진단 |
| 예외에서 스택 추적 가져오기 |[TrackException 호출을 코드에 삽입](../../azure-monitor/app/asp-net-exceptions.md)(하지만 일부는 자동으로 보고됨) |예외 감지 및 진단 |
| 로그 추적 검색 |[로깅 어댑터 추가](../../azure-monitor/app/asp-net-trace-logs.md) |예외, 성능 문제 진단 |
| 클라이언트 사용 기본 사항: 페이지 보기, 세션,... |[웹 페이지의 JavaScript 이니셜라이저](../../azure-monitor/app/javascript.md) |사용 현황 분석 |
| 클라이언트 사용자 지정 메트릭 |[웹 페이지에서 추적 호출](../../azure-monitor/app/api-custom-events-metrics.md) |사용자 환경 향상 |
| 서버 사용자 지정 메트릭 |[서버에서 호출 추적](../../azure-monitor/app/api-custom-events-metrics.md) |비즈니스 인텔리전스 |

## <a name="why-are-the-counts-in-search-and-metrics-charts-unequal"></a>검색 및 메트릭 차트의 수가 다른 이유는 무엇인가요?

[샘플링](../../azure-monitor/app/sampling.md)을 하면 실제로 앱에서 포털로 전송되는 원격 분석 항목(요청, 사용자 지정 이벤트 등)의 수가 줄어듭니다. 검색에는 실제로 받은 항목 수가 표시됩니다. 이벤트 수를 표시하는 메트릭 차트에는 발생된 원래 이벤트 수가 표시됩니다. 
...
Azure Resource Monitor를 통해 [PowerShell 스크립트를 작성](../../azure-monitor/app/powershell.md)하여 다음을 수행할 수 있습니다.
...
[REST API](https://dev.applicationinsights.io/)를 사용하여 [분석](../../azure-monitor/app/analytics.md) 쿼리를 실행합니다.
...
저희가 제공하는 SDK 및 [SDK API](../../azure-monitor/app/api-custom-events-metrics.md)를 사용하는 것이 좋습니다. 다양한 [플랫폼](../../azure-monitor/app/platforms.md)에 따라 여러 SDK 변형이 있습니다. 이러한 SDK는 버퍼링, 압축, 제한, 다시 시도 등을 처리합니다. 그러나 [수집 스키마](https://github.com/Microsoft/ApplicationInsights-dotnet/tree/develop/Schema/PublicSchema) 및 [엔드포인트 프로토콜](https://github.com/Microsoft/ApplicationInsights-Home/blob/master/EndpointSpecs/ENDPOINT-PROTOCOL.md)은 공용입니다.
...
[웹 테스트](../../azure-monitor/app/monitor-web-app-availability.md)는 전 세계에 배포된 클라이언트 로그인 지점에서 실행됩니다. 두 가지 해결 방법이 있습니다.

* 방화벽 문 - [길고 변경 가능한 웹 테스트 에이전트 목록](../../azure-monitor/app/ip-addresses.md)에서 서버에 대한 요청을 허용합니다.
