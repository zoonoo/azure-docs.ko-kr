...
고객 환경을 이해하는 것이 비즈니스에 가장 중요합니다. 애플리케이션이 여러 단계와 관련된 경우, 고객 대부분이 전체 프로세스를 거치는지 아니면 특정 시점에서 프로세스를 종료하는지를 알아야 합니다. 웹 응용 프로그램의 일련의 단계를 통한 진행을 *깔때기라고*합니다. Azure Application Insights Funnels를 사용하여 사용자에 대한 정보를 얻고 단계별 전환율을 모니터링할 수 있습니다. 
...
1. **시간 범위** 드롭다운 메뉴에서 **지난 90일**을 선택합니다. 내 **유입경로** 또는 공유 유입경로 중 하나를 **선택합니다.**
