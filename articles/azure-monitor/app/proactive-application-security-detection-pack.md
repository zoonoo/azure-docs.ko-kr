---
title: Azure 응용 프로그램 인사이트가 있는 보안 검색 팩
description: Azure 응용 프로그램 인사이트 및 스마트 검색을 통해 잠재적인 보안 문제를 모니터링합니다.
ms.topic: conceptual
ms.date: 12/12/2017
...
3. 의심스러운 사용자 활동: 응용 프로그램은 거의 동시에 동일한 사용자가 여러 국가/지역에서 액세스하고 있습니다. 예를 들어 같은 사용자가 같은 시간 내에 스페인과 미국에서 애플리케이션에 액세스했습니다. 이 검색은 악의적일 가능성이 있는 애플리케이션 액세스 시도를 나타냅니다.
...
2. **범위.** 의심스러운 요청이 발생한 국가/지역은 어느 국가/지역에서 발생했습니까? 가장 의심스러운 사용자는 누구였나요? 이 정보는 알림에서 얻을 수 있습니다.
3. **진단.** 검색은 의심스러운 사용자 목록과 각 사용자에 대한 국가/지역 목록을 제공하여 문제를 추가로 진단하는 데 도움이 됩니다.
