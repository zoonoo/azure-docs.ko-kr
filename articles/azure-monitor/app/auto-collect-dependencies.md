...
> [!NOTE]
> *반응형 프로그래밍 지원을 제외합니다.
> <br>†[JVM 에이전트](java-2x-agent.md#install-the-application-insights-agent-for-java)를 설치해야 합니다.
...
- [Java](java-2x-agent.md)에 대한 사용자 지정 종속성 추적을 설정합니다.
