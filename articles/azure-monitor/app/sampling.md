...
1. [Applicationinsights-agent-3.0.0-PREVIEW. 3 jar](https://github.com/microsoft/ApplicationInsights-Java/releases/download/3.0.0-PREVIEW.3/applicationinsights-agent-3.0.0-PREVIEW.3.jar) 다운로드
