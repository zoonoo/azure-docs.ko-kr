...
의미상 이벤트는 요청과 상호 관련되거나 그렇지 않을 수 있습니다. 하지만 제대로 사용될 경우 이벤트 원격 분석은 요청이나 추적보다 더 중요합니다. 이벤트는 비즈니스 원격 분석을 나타내며 별도의 덜 공격적인 [샘플링의](../../azure-monitor/app/api-filtering-sampling.md)대상이 되어야 합니다.
