...
> [!IMPORTANT]
> 이전 버전의 Application Insights에서는 _Azure App Service에 대 한 Application Insights 확장_ 이라는 개인 사이트 확장을 사용 했습니다. 현재 Application Insights 환경은 미리 설치 된 사이트 확장을 밝게 하기 위해 앱 설정을 설정 하 여 사용할 수 있습니다.
