...
인스턴스를 직접 `TelemetryConfiguration` 만든 경우로 `true`설정 `DisableTelemetry` 합니다.

ASP.NET Core 응용 프로그램의 경우 `TelemetryConfiguration` [ASP.NET Core 종속성 주입](/aspnet/core/fundamentals/dependency-injection/)을 사용 하 여 인스턴스에 액세스할 수 있습니다. [ASP.NET Core 응용 프로그램에 대 한 Applicationinsights](../../azure-monitor/app/asp-net-core.md) 문서에서 자세한 내용을 확인 하세요.
...
* **Unix 서버** - [설치 collectd](../../azure-monitor/app/java-collectd.md)
