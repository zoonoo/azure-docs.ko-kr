---
title: 웹 앱 성능 모니터링 - Azure 응용 프로그램 인사이트
...
* [IIS 서버](../../azure-monitor/app/monitor-performance-live-website-now.md)및 [Azure 앱 서비스에](../../azure-monitor/app/app-insights-overview.md)대한 .
