...
![클릭하여 추가 데이터를 표시한 다음 시간 범위 선택](./media/web-monitor-performance/appinsights-48metrics.png)

차트를 클릭하여 표시되는 메트릭을 선택하거나 새 차트를 추가하고 해당 메트릭을 선택합니다.

![그래프를 클릭하여 메트릭 선택](./media/web-monitor-performance/appinsights-61perfchoices.png)
...
![모든 메트릭의 선택을 취소하여 전체 집합 표시](./media/web-monitor-performance/appinsights-62allchoices.png)
...
![고객/세부 정보 가져오기 세 가지 기간 스파이크(기간: 7일 범위)](./media/web-monitor-performance/SlowDependencies95thTrend.png)
