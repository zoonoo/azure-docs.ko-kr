...
ms.locfileid: "87024353"
---
# <a name="performance-testing"></a>성능 테스트

> [!NOTE]
> 클라우드 기반 부하 테스트 서비스는 더 이상 사용 되지 않습니다. 사용 중단, 서비스 가용성 및 대체 서비스에 대 한 자세한 내용은 [여기](/azure/devops/test/load-test/overview?view=azure-devops)에서 찾을 수 있습니다.
