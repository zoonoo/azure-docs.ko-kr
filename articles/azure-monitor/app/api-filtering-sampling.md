...
* [샘플링](../../application-insights/app-insights-sampling.md) 통계를 왜곡하지 않고 원격 분석의 양을 줄입니다. 관련 데이터 요소를 함께 유지하여 문제를 진단할 때 데이터 요소 간을 탐색할 수 있습니다. 포털에서는 샘플링을 보완하기 위해 총 개수를 곱합니다.
...
>
> 대신 [샘플링](../../application-insights/app-insights-sampling.md)사용을 고려하세요.
>
>
...
[Java SDK 설명서](https://docs.microsoft.com/java/api/com.microsoft.applicationinsights.extensibility._telemetry_initializer?view=azure-java-stable)
...
* [샘플링](../../application-insights/app-insights-sampling.md)
