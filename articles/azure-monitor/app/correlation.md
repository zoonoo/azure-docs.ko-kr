...
- **들어오는 구성**
  ...
  - J2EE 앱의 경우 ApplicationInsights.xml 내의 `<TelemetryModules>` 태그에 다음을 추가합니다.
...
- 다른 SDK의 [cloud_RoleName 설정](../../azure-monitor/app/app-map.md#set-cloudrolename)에 대해 자세히 알아봅니다.
