...
적절 한 상관 관계를 위해 한 구성 요소에서 다른 구성 요소로 추적 정보를 전달할 수도 있습니다. 예를 들어 두 개의 구성 요소와가 있는 시나리오를 살펴보겠습니다 `module1` `module2` . Module1은 Module2의 함수를 호출 하 고 및 모두에서 로그를 가져오기 위해 `module1` `module2` 다음 접근 방식을 사용할 수 있습니다.
