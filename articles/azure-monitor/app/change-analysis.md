...
1. 선택 **응용 프로그램 변경**합니다. Not 기능에서 사용할 수 있는 이기도 **응용 프로그램이 크래시 되**합니다.

   !["응용 프로그램이 크래시 되" 단추 스크린샷](./media/change-analysis/application-changes.png)

1. 변경 분석을 사용 하려면 **지금 사용**합니다.

   !["응용 프로그램이 크래시 되" 옵션의 스크린샷](./media/change-analysis/enable-changeanalysis.png)

1. 켜기 **변경 Analysis** 선택한 **저장**합니다.
