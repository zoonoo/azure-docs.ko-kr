...
IP 구성 규칙, TLS 설정 및 확장 버전 등의 설정은 ARG에서 아직 사용할 수 없으므로 분석 쿼리를 변경 하 고 이러한 변경 내용을 안전 하 게 계산 하 여 앱에서 변경 된 내용에 대 한 자세한 정보를 제공 합니다. 이 정보는 Azure 리소스 그래프에서 아직 사용할 수 없지만 곧 제공 될 예정입니다.
...
1.  > 변경 분석에 액세스 하려면 **진단 및 문제 해결 및****성능** > **응용 프로그램 충돌**을 선택 합니다. 시간에 따른 변경 내용 유형과 해당 변경 내용에 대 한 세부 정보를 요약 하는 그래프가 표시 됩니다. 기본적으로 지난 24 시간 동안의 변경 내용은 즉각적인 문제를 해결 하기 위해 표시 됩니다.
