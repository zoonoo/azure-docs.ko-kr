...
3. **참여한 사용자 – 사용한 일 기준**을 선택합니다.
    ...
    * **UsedLeastLeastCustom**- 사용자가 참여한 것으로 계산하기 위해 기간 내에 무언가를 사용해야 하는 횟수입니다.

4. **사용 변경최소사용자 정의** 를 **5일 이상으로**변경하고 **기간을** 28일 기본값으로 둡니다.
...
이러한 필터는 쿼리 작성기로 표현할 수 없는 더 복잡한 질문을 지원합니다. 예를 들어 _지난 28일 동안 종사한 사람들이 있습니다. 지난 60일 동안 그 사람들은 어떻게 행동했는가?_
...
2. 템플릿 **갤러리** 탭을 선택합니다. 다양한 코호트에 대한 템플릿 컬렉션을 볼 수 있습니다.
...
3. **쿼리 실행**을 선택합니다. 테이블에 사용자 아이디가 표시되지 않으면 응용 프로그램에 사용자가 있는 국가/지역으로 변경합니다.

4. 코호트를 저장하고 이름을 지정합니다.

## <a name="frequently-asked-questions"></a>질문과 대답

_특정 국가/지역의 사용자 집단을 정의했습니다. 사용자 도구에서 이 코호트를 해당 국가/지역에 필터를 설정하는 것과 비교하면 다른 결과가 표시됩니다. 왜?_
