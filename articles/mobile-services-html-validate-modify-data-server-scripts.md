<properties urlDisplayName="Validate Data - HTML5" pageTitle="서버 스크립트를 사용하여 데이터 유효성 검사 및 수정(HTML 5) | 모바일 개발자 센터" metaKeywords="" description="Learn how to validate and modify data sent using server scripts from your HTML app." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using server scripts" authors="glenga" solutions="" manager="dwrede" editor="" />
...
1. 	app.js 파일을 연 다음 **$('#add-item').submit()** 이벤트 처리기를 다음 코드로 바꿉니다.
...
2. 웹 브라우저에서 <a href="http://localhost:8000/" target="_blank">http://localhost:8000/</a>으로 이동한 다음 **새 작업 추가**에 텍스트를 입력한 다음 **추가**를 클릭합니다.
...
7. 다시 **refreshTodoItems** 함수에서 쿼리를 정의하는 코드 줄을 다음과 같이 바꿉니다.
...
자세한 내용은 [서버 스크립트 작업] 및 [모바일 서비스 HTML/JavaScript 방법 개념 참조]를 참조하세요.
...
<!-- URLs. -->
[서버 스크립트 작업]: /ko-kr/develop/mobile/how-to-guides/work-with-server-scripts
[모바일 서비스 시작]: /ko-kr/develop/mobile/tutorials/get-started-html
[스크립트를 통해 사용자 권한 부여]: /ko-kr/develop/mobile/tutorials/authorize-users-html
