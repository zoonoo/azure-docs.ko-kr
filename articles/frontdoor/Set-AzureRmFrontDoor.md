...
ms.locfileid: "47047209"
---
# Set-AzureRmFrontDoor
Front Door 부하 분산 장치를 업데이트
...
## 설명
**Set-AzureRmFrontDoor** cmdlet은 Front Door 부하 분산 장치를 업데이트합니다. 입력 매개 변수를 제공하지 않으면 기존 Front Door의 이전 매개 변수가 사용됩니다.

## 예제

### 예제 1: FrontDoorName 및 ResourceGroupName을 사용하여 기존 Front Door 업데이트.
```powershell
...
### 예제 2: PSFrontDoor 개체를 사용하여 기존 Front Door 업데이트.
```powershell
...
### 예제 3: ResourceId를 사용하여 기존 Front Door 업데이트.
```powershell
...
### -EnabledState
Front Door 부하 분산 장치의 선택적 상태입니다.
