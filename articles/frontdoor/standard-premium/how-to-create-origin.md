...
1. **추가** 를 선택 하 여 새 원본을 만듭니다. 만든 원본이 그룹을 사용 하 여 원본 목록에 표시 됩니다.
  
    :::image type="content" source="../media/how-to-create-origin/origin-list-view.png" alt-text="목록 뷰의 원본 스크린샷":::
...
:::image type="content" source="../media/how-to-create-origin/delete-origin-group.png" alt-text="원본 그룹을 삭제 하는 방법의 스크린샷":::
