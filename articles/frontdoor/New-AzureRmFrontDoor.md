...
ms.locfileid: "47047027"
---
# New-AzureRmFrontDoor

Azure Front Door 부하 분산 장치 만들기
...
## 설명
**New-AzureRmFrontDoor** cmdlet은 현재 구독에서 지정된 리소스 그룹에 새 Azure Front Door 부하 분산 장치를 만듭니다.

## 예제

### 예제 1: 주어진 매개 변수를 기반으로 Front Door 만들기.
```powershell
...
주어진 매개 변수를 기반으로 Front Door 만들기.

## 매개 변수

### -BackendPool
회람 규칙에 사용할 수 있는 Backendpool입니다.
...
### -EnabledState
Front Door 부하 분산 장치의 EnabledState입니다.
기본값은 [사용]입니다.
...
### -FrontendEndpoint
회람 규칙에 사용할 수 있는 프런트 엔드 엔드포인트입니다.
