...
## <a name="step-1-create-an-azure-front-door-afd-resource"></a>1단계: AFD(Azure Front Door) 리소스 만들기
...
## <a name="step-2-create-an-azure-waf-profile-to-use-with-azure-front-door-resources"></a>2단계: Azure Front Door 리소스에 사용할 Azure WAF 프로필 만들기
...
## <a name="step-3-add-managed-rulesets-to-this-waf-policy"></a>3단계: 관리형 규칙 집합을 WAF 정책에 추가
...
## <a name="step-4-associate-the-waf-policy-with-the-afd-resource"></a>4단계: WAF 정책을 AFD 리소스와 연결
...
## <a name="step-5-configure-custom-domain-for-your-web-application"></a>5단계: 웹 애플리케이션에 대한 사용자 지정 도메인 구성
...
## <a name="step-6-lock-down-your-web-application"></a>6단계: 웹 애플리케이션 잠금
