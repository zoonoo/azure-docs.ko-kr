...
전면 도어는에 지에서 동적으로 콘텐츠를 압축 하 여 클라이언트에 대 한 응답 시간을 더 작게 하 고 더 빠르게 수행할 수 있습니다. 파일이 압축에 적합 하도록 하려면 캐싱을 사용 하도록 설정 하 고 파일을 압축에 적합 한 MIME 형식 이어야 합니다. 현재 앞 도어에서는이 목록을 변경할 수 없습니다. 현재 목록:
- "application/eot"
- "application/font"
