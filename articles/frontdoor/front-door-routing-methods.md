...
* **세션 선호도:** 사용자 세션이 여전히 활성 상태이고 백 엔드 인스턴스가 상태 프로브를 기반으로 정상 보고서를 보고하는 한 사용자의 후속 요청이 동일한 백 엔드로 전송되도록 하려는 경우 프런트 엔드 호스트 또는 도메인에 대한 세션 선호도를 구성할 수 있습니다. 
