...
ms.locfileid: "47046606"
---
# New-AzureRmFrontDoorFrontendEndpointObject

Front Door 생성을 위한 PSFrontendEndpoint 개체 만들기
...
### -CertificateType
frontendEndpoint에 대한 보안 연결에 사용되는 인증서 유형
...
해당하는 경우 세션 선호도에 사용할 TTL(초 단위)입니다. 기본값은 0입니다.
...
### -WebApplicationFirewallPolicyLink
각 호스트(해당하는 경우)에 대한 웹 응용 프로그램 방화벽 정책의 리소스 ID
