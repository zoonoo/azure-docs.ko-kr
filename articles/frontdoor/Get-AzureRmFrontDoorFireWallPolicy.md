...
## 설명
**Get-AzureRmFrontDoorFireWallPolicy** cmdletGet은 현재 구독의 리소스 그룹에서 WAF 정책을 가져옵니다.

## 예제

### 예제 1: $resourceGroup에서 $Name이라는 WAF 정책 가져오기
```powershell
...
$resourceGroup에서 $Name이라는 WAF 정책 가져오기

### 예제 2: $resourceGroup에서 WAF 정책 가져오기
```powershell
