...
ms.locfileid: "47046539"
---
# New-AzureRmFrontDoorMatchConditionObject
WAF 정책 생성용 MatchCondition 개체 만들기
...
### -MatchVariable
일치 변수입니다.
가능한 값으로는 'RemoteAddr', 'RequestMethod', 'QueryString', 'PostArgs','RequestUri', 'RequestHeader', 'RequestBody'가 있습니다.
...
### -NegateCondition
무효화 조건인지, 아니면 기본값이 false가 아닌지 설명합니다.
...
### -OperatorProperty
매칭할 연산자를 설명합니다.
가능한 값으로는 'Any', 'IPMatch', 'GeoMatch', 'Equal', 'Contains', 'LessThan', 'GreaterThan', 'LessThanOrEqual', 'GreaterThanOrEqual', 'BeginsWith', 'EndsWith''가 있습니다.
...
### -Selector
매칭할 RequestHeader 또는 RequestBody의 선택기 이름
