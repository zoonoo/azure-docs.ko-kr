<properties 
	pageTitle="Express를 사용하여 웹 앱 빌드(Node.js) - Azure 자습서" 
	description="클라우드 서비스 자습서를 기반으로 웹 앱을 빌드하고 Express 모듈 사용 방법을 보여 주는 자습서입니다." 
...
개발자가 Node.js 응용 프로그램을 개발할 때 추가 기능을 제공하기 위해
타사 모듈을 사용하기도 합니다. 자습서 내용
Node.js 웹 응용 프로그램을 만들기 위한 MVC 프레임워크를 제공하는 [Express][] 모듈을 사용하여 새 응용 프로그램을 만들어 봅니다.
...
5.  package.json 파일에 정의된 추가 종속성을 설치하려면
    다음 명령을 입력합니다.
...
8.  다음 명령을 사용하여 Windows Azure 에뮬레이터에서
    응용 프로그램을 실행합니다.
...
1.  다음 명령을 입력하여 index.jade 파일을 엽니다.
    ...
    Jade는 Express 응용 프로그램에서 사용하는 기본 뷰 엔진입니다. Azure Redis Cache 사용에 대한
    Jade 뷰 엔진에 대한 자세한 내용은 [http://jade-lang.com][] (영문)을 참조하세요.
