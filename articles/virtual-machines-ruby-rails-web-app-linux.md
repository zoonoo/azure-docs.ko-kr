...
1.  명령줄 또는 터미널 세션에서 다음 명령으로 SSH를 사용하여 가상 컴퓨터에 연결합니다.
    ...
    **참고**
    Windows를 개발 환경으로 사용하는 경우 SSH용 **PuTTY** 기능과 같은 유틸리티를 사용할 수 있습니다. PuTTY는 [PuTTY 다운로드 페이지][PuTTY 다운로드 페이지](영문)에서 다운로드할 수 있습니다.
...
**참고**
Windows를 개발 환경으로 사용하는 경우 scp용 **pscp** 기능과 같은 유틸리티를 사용할 수 있습니다. Pscp는 [PuTTY 다운로드 페이지][PuTTY 다운로드 페이지](영문)에서 다운로드할 수 있습니다.
