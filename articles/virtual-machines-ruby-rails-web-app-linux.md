<properties pageTitle="Azure에서 Linux VM을 사용하여 Ruby on Rails 웹 앱 호스트" description="Azure에서 Linux 가상 컴퓨터를 사용하여 Ruby on Rails 기반 웹 사이트를 호스트하는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="ruby" authors="blackmist" manager="wpickett" editor=""/>
