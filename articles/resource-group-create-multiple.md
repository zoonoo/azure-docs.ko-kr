...
배포 템플릿의 관련 섹션은 아래에 나와 있습니다. 많은 수의 데이터 디스크를 동적으로 만드는 작업과 관련된 섹션을 중점적으로 제공하기 위해 많은 템플릿을 제거했습니다. **numDataDisks** 매개 변수는 만들려는 디스크 수를 제공하는 데 사용합니다.
