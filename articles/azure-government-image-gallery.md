...
---|---|---|---|---
Barracuda Networks, Inc.|Barracuda NextGen Firewall F-Series 6.2.1-057|: 참고: 이 어플라이언스는 클라이언트 응용 프로그램을 통해 관리되며, 이를 위해 TCP/807을 전달해야 합니다. 배포 추가 정보를 참조하세요. https://techlib.barracuda.com/NG61/DeployAzure...|Linux|80 GB
