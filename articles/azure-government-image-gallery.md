...
게시자|이미지 이름|설명|디스크 크기
---|---|---|---
Barracuda Networks, Inc.|Barracuda Web Application Firewall (WAF) 7.8 PatchLevel 4|참고: 이 어플라이언스는 웹 UI를 통해 관리되며, 이를 위해 TCP/8000을 전달해야 합니다. detai...에 대한 배포 추가 정보 https://cloudvm.cudasvc.com/azure/deployment-readme-waf.html|Linux|50GB
Barracuda Networks, Inc.|Barracuda NG Firewall 5.4.3-182 PatchLevel 4|참고: 이 어플라이언스는 클라이언트 응용 프로그램을 통해 관리되며, 이를 위해 TCP/807을 전달해야 합니다. 배포 추가 정보 https://cloudvm.cudasvc.com/azure/deployment-readme-ng.html...|Linux|80GB
...
Microsoft SQL Server 그룹|SQL Server 2014 RTM Enterprise on Windows Server 2012 R2|이 이미지에는 정식 버전의 SQL Server가 포함되어 있습니다. A3 이상의 가상 컴퓨터를 사용하는 것이 좋습니다. 이 이미지는 CEIP whic을 포함하여 Azure용으로 미리 구성되었으며...|Windows|127GB
...
Microsoft SQL Server 그룹|SQL Server 2014 RTM Enterprise on Windows Server 2012 R2|이 이미지에는 정식 버전의 SQL Server가 포함되어 있습니다. A3 이상의 가상 컴퓨터를 사용하는 것이 좋습니다. 이 이미지는 CEIP whic을 포함하여 Azure용으로 미리 구성되었으며...|Windows|127GB
Microsoft SQL Server 그룹|SQL Server 2014 RTM Standard on Windows Server 2012 R2|이 이미지에는 정식 버전의 SQL Server가 포함되어 있습니다. A2 이상의 가상 컴퓨터를 사용하는 것이 좋습니다. 이 이미지는 CEIP whic을 포함하여 Azure용으로 미리 구성되었으며...|Windows|127GB
Microsoft SQL Server 그룹|SQL Server 2012 SP2 Standard on Windows Server 2012|일부 SQL Server 구성 요소는 사용하기 전에 추가 설치 및 구성이 필요합니다. A2 이상의 가상 컴퓨터를 사용하는 것이 좋습니다. 이 이미지는 Azure용으로 미리 구성되었으며...|Windows|127GB
Microsoft SQL Server 그룹|SQL Server 2014 RTM Standard on Windows Server 2012 R2|이 이미지에는 정식 버전의 SQL Server가 포함되어 있습니다. A2 이상의 가상 컴퓨터를 사용하는 것이 좋습니다. 이 이미지는 CEIP whic을 포함하여 Azure용으로 미리 구성되었으며...|Windows|127GB
Microsoft Windows Server 그룹|Windows Server 2012 R2 Datacenter, June 2014|Microsoft 클라우드 OS 비전의 핵심인 Windows Server 2012 R2는 고객의 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 경험을 선사합니다. 엔터프라이즈급 성능을 제공하며...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 Datacenter, June 2014|Windows Server 2012는 공용 클라우드 구축 및 운영에 대한 Microsoft의 경험을 바탕으로 항상 사용 가능한 동적 서버 플랫폼을 제공합니다. 확장 가능한 동적 다중 테넌트...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2008 R2 SP1, June 2014|Windows Server 2008 R2는 서버 또는 사설 클라우드 인프라의 안정성 및 유연성을 개선하여 시간을 절약하고 비용을 절감할 수 있도록 도와주는 다용도 서버입니다. 이 서버는...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2008 R2 SP1, September 2014|Windows Server 2008 R2는 서버 또는 사설 클라우드 인프라의 안정성 및 유연성을 개선하여 시간을 절약하고 비용을 절감할 수 있도록 도와주는 다용도 서버입니다. 이 서버는...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2008 R2 SP1, October 2014|Windows Server 2008 R2는 서버 또는 사설 클라우드 인프라의 안정성 및 유연성을 개선하여 시간을 절약하고 비용을 절감할 수 있도록 도와주는 다용도 서버입니다. 이 서버는...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2008 R2 SP1, November 2014|Windows Server 2008 R2는 서버 또는 사설 클라우드 인프라의 안정성 및 유연성을 개선하여 시간을 절약하고 비용을 절감할 수 있도록 도와주는 다용도 서버입니다. 이 서버는...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2008 R2 SP1, April 2015|Windows Server 2008 R2는 서버 또는 사설 클라우드 인프라의 안정성 및 유연성을 개선하여 시간을 절약하고 비용을 절감할 수 있도록 도와주는 다용도 서버입니다. 이 서버는...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 Datacenter, September 2014|Windows Server 2012는 공용 클라우드 구축 및 운영에 대한 Microsoft의 경험을 바탕으로 항상 사용 가능한 동적 서버 플랫폼을 제공합니다. 확장 가능한 동적 다중 테넌트...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 Datacenter, November 2014|Windows Server 2012는 공용 클라우드 구축 및 운영에 대한 Microsoft의 경험을 바탕으로 항상 사용 가능한 동적 서버 플랫폼을 제공합니다. 확장 가능한 동적 다중 테넌트...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 Datacenter, October 2014|Windows Server 2012는 공용 클라우드 구축 및 운영에 대한 Microsoft의 경험을 바탕으로 항상 사용 가능한 동적 서버 플랫폼을 제공합니다. 확장 가능한 동적 다중 테넌트...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 R2 Datacenter, September 2014|Microsoft 클라우드 OS 비전의 핵심인 Windows Server 2012 R2는 고객의 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 경험을 선사합니다. 엔터프라이즈급 성능을 제공하며...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 R2 Datacenter, October 2014|Microsoft 클라우드 OS 비전의 핵심인 Windows Server 2012 R2는 고객의 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 경험을 선사합니다. 엔터프라이즈급 성능을 제공하며...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 R2 Datacenter, November 2014|Microsoft 클라우드 OS 비전의 핵심인 Windows Server 2012 R2는 고객의 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 경험을 선사합니다. 엔터프라이즈급 성능을 제공하며...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 R2 Datacenter, April 2015|Microsoft 클라우드 OS 비전의 핵심인 Windows Server 2012 R2는 고객의 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 경험을 선사합니다. 엔터프라이즈급 성능을 제공하며...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server Technical Preview|Microsoft 클라우드 플랫폼의 핵심인 Windows Server는 고객의 데이터 센터 인프라에 세계적인 규모의 클라우드 서비스 제공에 대한 Microsoft의 수준 높고 풍부한 경험을 선사합니다. Windows S...|Windows|128GB
Microsoft Windows Server 그룹|Windows Server 2012 Datacenter, April 2015|Windows Server 2012는 공용 클라우드 구축 및 운영에 대한 Microsoft의 경험을 바탕으로 항상 사용 가능한 동적 서버 플랫폼을 제공합니다. 확장 가능한 동적 다중 테넌트...|Windows|128GB
...
SUSE|SUSE Linux Enterprise Server 11 SP3|Microsoft Azure의 SUSE Linux Enterprise Server에서 프로덕션 작업 부하를 안심하고 실행하세요. 서비스 수준이 보장되며 SUSE 및 Microsoft 엔지니어의 도움을...|Linux|30GB
SUSE|SUSE Linux Enterprise Server 11 SP3(Premium 이미지)|Microsoft Azure의 SUSE Linux Enterprise Server에서 프로덕션 작업 부하를 안심하고 실행하세요. 서비스 수준이 보장되며 SUSE 및 Microsoft 엔지니어의 도움을...|Linux|30GB
...
- [Linux 가상 컴퓨터 배포](./virtual-machines/virtual-machines-linux-create-cli-complete.md)

- [가상 컴퓨터 FAQ](./virtual-machines/virtual-machines-linux-classic-faq.md)

- [사용자 고유의 VHD 만들기 및 업로드](./virtual-machines/virtual-machines-linux-about-disks-vhds.md/)
