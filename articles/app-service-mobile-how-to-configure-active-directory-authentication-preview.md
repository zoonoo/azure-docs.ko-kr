...
8. 응용 프로그램이 추가되면 **구성** 탭을 클릭합니다. **Single Sign-On** 아래의 **회신 URL**을 앞에 _/signin-aad_ 경로가 추가된 게이트웨이 URL로 편집합니다. 예를 들면 `https://contosogateway.azurewebsites.net/signin-aad`입니다. HTTPS 체계를 사용 중인지 확인합니다.
