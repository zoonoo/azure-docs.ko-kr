<properties pageTitle="Azure Linux VM에서 MySQL 성능 최적화" description="Linux를 실행하는 Azure VM(가상 컴퓨터)에서 실행 중인 MySQL을 최적화하는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
...
[http://azure.microsoft.com/ko-kr/documentation/articles/virtual-machines-linux-configure-RAID/](http://azure.microsoft.com/ko-kr/documentation/articles/virtual-machines-linux-configure-RAID/) 문서를 따르세요.
