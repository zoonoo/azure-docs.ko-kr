<properties pageTitle="Google Cloud Messaging 설정 방법" description="Azure 모바일 서비스를 사용하여 새 서비스를 만들려면 이 자습서를 따라 작업을 진행합니다." services="mobile-services, notification-hubs" documentationCenter="android" authors="ggailey777" manager="dwrede" editor=""/>
