...
이 자습서에서는 PTVS 샘플 템플릿 중 하나를 사용하여 간단한 설문 조사 응용 프로그램을 만들기 위해 [Python Tools for Visual Studio][]를 사용해 보겠습니다. 이 자습서는 [비디오](https://www.youtube.com/watch?v=GJXDGaEPy94)로도 제공됩니다.
...
1.  탐색 창 맨 아래에 있는 **새로 만들기**를 클릭합니다.
  	...
  	![새 단추](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonAzurePlusNew.png)
...
1.  **액세스 키 관리**를 클릭합니다.
  	...
  	![액세스 키 관리 대화 상자](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonAzureTableStorageManageKeys.png)
...
1.  **서버 탐색기**를 엽니다.  **Azure**, **저장소**, 저장소 계정 및 **테이블**을 차례로 확장합니다.
  	...
  	![서버 탐색기](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonServerExplorer.png)
...
1.  **사이트 이름** 및 **지역**을 선택하고 **만들기**를 클릭합니다.
  	...
  	![Microsoft Azure에서 사이트 만들기 대화 상자](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonCreateWebSite.png)
...
1.  위쪽 메뉴에서 **구성**을 클릭합니다.
  	...
  	![최상위 메뉴](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonWebSiteTopMenu.png)
...
1. 아래쪽 메뉴에서 **저장**을 클릭하고 **다시 시작**을 클릭한 후 **찾아보기**를 클릭합니다.
  	...
  	![하위 메뉴](./media/web-sites-python-ptvs-bottle-table-storage/PollsCommonWebSiteConfigureBottomMenu.png)
