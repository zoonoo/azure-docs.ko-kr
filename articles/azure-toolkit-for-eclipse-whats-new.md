...
<!-- Legacy MSDN URL = https://msdn.microsoft.com/ko-KR/library/azure/hh694270.aspx -->
...
* **인스턴스 끝점:** 부하 분산된 역할 인스턴스와의 통신을 위한 직접 포트 끝점 액세스를 허용합니다. [끝점 속성][] 페이지를 통해 사용 가능한 끝점 UI를 통해 인스턴스 끝점을 추가할 수 있습니다. 이렇게 하면 다중 인스턴스 배포로 시나리오의 클라우드에서 실행 중인 특정 계산 인스턴스에 대한 원격 디버깅 및 JMX 진단을 사용할 수 있습니다. (인스턴스 끝점이 다음에 나열됩니다. 
