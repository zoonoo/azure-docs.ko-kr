...
- Azure SDK 2.5에서 만든 **클라우드 배포 프로젝트** 유형의 프로젝트를 2.6에서 사용할 수 있지만 Visual Studio에서 템플릿을 배포하지는 못합니다. 그러나 PowerShell 스크립트를 사용한 배포는 이전과 마찬가지로 여전히 작동합니다. 2.6에서 **클라우드 배포 프로젝트**를 사용하는 방법에 대한 자세한 내용은 이 [게시물](http://go.microsoft.com/fwlink/?LinkID=534086)을 참조하세요.
