---
title: 'PowerShell: Azure SQL Database의 여러 데이터베이스 간 동기화'
description: Azure SQL Database의 여러 데이터베이스 간에 동기화를 수행하는 Azure PowerShell 예제 스크립트를 사용합니다.
...
이 Azure PowerShell 예제는 Azure SQL Database의 여러 데이터베이스 간에 데이터 동기화를 수행하도록 SQL 데이터 동기화를 구성합니다.
