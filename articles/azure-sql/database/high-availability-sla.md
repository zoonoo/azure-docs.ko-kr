...
> [!NOTE]
> 크기가 80 vcore 인 범용 데이터베이스는 영역 중복 구성으로 인해 성능이 저하 될 수 있습니다. 백업, 복원, 데이터베이스 복사 및 지리적 DR 관계 설정과 같은 작업을 수행 하면 1TB 보다 큰 단일 데이터베이스의 성능이 저하 될 수 있습니다. 
