...
* 이 자습서 시리즈의 2부에서는 [**1부**](predictive-model-prepare-data-tutorial.md) 및 해당 전제 작업을 완료했다고 가정합니다.
...
![두 모델 비교](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [자습서: Azure SQL Database Machine Learning Services(미리 보기)를 사용하여 R에서 예측 모델 배포](predictive-model-deploy-tutorial.md)
