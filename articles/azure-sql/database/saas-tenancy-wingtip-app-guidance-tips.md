...
- [Wingtip 티켓 SaaS 독립형 애플리케이션 배포](../../sql-database/saas-standaloneapp-get-started-deploy.md)
- [Wingtip Tickets SaaS 테넌트당 데이터베이스 애플리케이션 배포](../../sql-database/saas-dbpertenant-get-started-deploy.md)
- [Wingtip Tickets SaaS 다중 테넌트 데이터베이스 애플리케이션 배포](../../sql-database/saas-multitenantdb-get-started-deploy.md)
