...
- [Azure SQL Database를 사용한 다중 테넌트 SaaS 애플리케이션 디자인 패턴](../../sql-database/saas-tenancy-app-design-patterns.md)
