...
- [서버 수준 방화벽 규칙](single-database-create-quickstart.md)이 있는 [Azure SQL Database의 데이터베이스](firewall-create-server-level-portal-quickstart.md)
...
![추가 출력이 있는 학습된 모델](./media/r-train-score-model-create-quickstart/r-train-model-with-additional-output.png)
...
2. 이러한 새 속도 값에서 정지 거리를 예측합니다.
   ...
   **결과**
   ...
   ![장지 거리를 예측하는 결과 집합](./media/r-train-score-model-create-quickstart/r-predict-stopping-distance-resultset.png)
