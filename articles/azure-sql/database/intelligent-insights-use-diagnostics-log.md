...
범주(category) 속성은 검색 가능한 성능 패턴의 범주를 설명합니다. 검색 가능한 성능 패턴의 모든 가능한 범주에 대해서는 다음 표를 참조하세요. 자세한 내용은 [인텔리전스 Insights를 사용하여 데이터베이스 성능 문제 해결](intelligent-insights-troubleshoot-performance.md)을 참조하세요.
...
Intelligent Insights 성능 로그를 사용자 지정 DevOps 경고 및 보고 기능을 위해 [Azure Monitor 로그](/azure/log-analytics/log-analytics-azure-sql) 또는 타사 솔루션과 함께 사용할 수 있습니다.
