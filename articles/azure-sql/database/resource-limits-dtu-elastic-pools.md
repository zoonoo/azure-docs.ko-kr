...
| 풀당 최대 스토리지(GB) 옵션 | 5 | 10 | 20 | 29 | 39 | 78 | 117 | 156 |
...
|:---|---:|---:|---:| ---: | ---: | ---: |
| 풀당 포함된 스토리지(GB) | 50 | 100 | 200 | 300 | 400 | 800 |
| 풀당 최대 스토리지(GB) 옵션 | 50, 250, 500 | 100, 250, 500, 750 | 200, 250, 500, 750, 1024 | 300, 500, 750, 1024, 1280 | 400, 500, 750, 1024, 1280, 1536 | 800, 1024, 1280, 1536, 1792, 2048 |
| 풀당 최대 메모리 내 OLTP 스토리지(GB) | 해당 없음 | 해당 없음 | 해당 없음 | 해당 없음 | 해당 없음 | 해당 없음 |
| 풀 당 최대 Db 수 <sup>1</sup> | 100 | 200 | 500 | 500 | 500 | 500 |
| 풀 당 최대 동시 작업자 (요청) <sup>2</sup> | 100 | 200 | 400 | 600 | 800 | 1600 |
| 풀 당 최대 동시 세션 수 <sup>2</sup> | 30000 | 30000 | 30000 | 30000 | 30000 | 30000 |
...
|:---|---:|---:|---:| ---: | ---: |
| 풀당 포함된 스토리지(GB) | 1200 | 1600 | 2000 | 2500 | 3000 |
| 풀당 최대 스토리지(GB) 옵션 | 1200, 1280, 1536, 1792, 2048, 2304, 2560 | 1600, 1792, 2048, 2304, 2560, 2816, 3072 | 2000, 2048, 2304, 2560, 2816, 3072, 3328, 3584 | 2500, 2560, 2816, 3072, 3328, 3584, 3840, 4096 | 3000, 3072, 3328, 3584, 3840, 4096 |
| 풀당 최대 메모리 내 OLTP 스토리지(GB) | 해당 없음 | 해당 없음 | 해당 없음 | 해당 없음 | 해당 없음 |
| 풀 당 최대 Db 수 <sup>1</sup> | 500 | 500 | 500 | 500 | 500 |
| 풀 당 최대 동시 작업자 (요청) <sup>2</sup> | 2400 | 3200 | 4000 | 5,000 | 6000 |
| 풀 당 최대 동시 세션 수 <sup>2</sup> | 30000 | 30000 | 30000 | 30000 | 30000 |
...
| 데이터베이스당 최대 스토리지(GB) 옵션 | 1024 | 1024 | 1024 | 1024 | 1024 |
|||||||
...
|:---|---:|---:|---:| ---: | ---: |
| 풀당 포함된 스토리지(GB) | 250 | 500 | 750 | 1024 | 1536 |
| 풀당 최대 스토리지(GB) 옵션 | 250, 500, 750, 1024 | 500, 750, 1024 | 750, 1024 | 1024 | 1536 |
| 풀당 최대 메모리 내 OLTP 스토리지(GB) | 1 | 2 | 4 | 10 | 12 |
| 풀 당 최대 Db 수 <sup>1</sup> | 50 | 100 | 100 | 100 | 100 |
| 풀 당 최대 동시 작업자 수 (요청) <sup>2</sup> | 200 | 400 | 800 | 1600 | 2400 |
| 풀 당 최대 동시 세션 수 <sup>2</sup> | 30000 | 30000 | 30000 | 30000 | 30000 |
...
|:---|---:|---:|---:| ---: | ---: |
| 풀당 포함된 스토리지(GB) | 2048 | 2560 | 3072 | 3548 | 4096 |
| 풀당 최대 스토리지(GB) 옵션 | 2048 | 2560 | 3072 | 3548 | 4096|
| 풀당 최대 메모리 내 OLTP 스토리지(GB) | 16 | 20 | 24 | 28 | 32 |
| 풀 당 최대 Db 수 <sup>1</sup> | 100 | 100 | 100 | 100 | 100 |
| 풀 당 최대 동시 작업자 (요청) <sup>2</sup> | 3200 | 4000 | 4800 | 5600 | 6400 |
| 풀 당 최대 동시 세션 수 <sup>2</sup> | 30000 | 30000 | 30000 | 30000 | 30000 |
