...
<External_Data_Source>:: = CREATE EXTERNAL DATA SOURCE <data_source_name> (TYPE = RDBMS, LOCATION = ' <fully_qualified_server_name> ', DATABASE_NAME = ' <remote_database_name> ',  
...
외부 테이블 만들기 [database_name. [ schema_name ] . | schema_name. ] table_name  
