...
|[sys.dm_resource_governor_workload_groups](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-resource-governor-workload-groups-transact-sql)|작업 그룹의 누적 작업 그룹 통계 및 현재 구성을 반환 합니다. 이 뷰를 열에서 dm_resource_governor_resource_pools와 조인 `pool_id` 하 여 리소스 풀 정보를 가져올 수 있습니다.|
