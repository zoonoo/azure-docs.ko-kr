...
[탄력적 데이터베이스 클라이언트 라이브러리를 사용하여 애플리케이션에 분할된 데이터베이스 추가](elastic-scale-add-a-shard.md)를 참조하세요.
...
[SQL Database에 대한 Microsoft Q&A 질문 페이지](https://docs.microsoft.com/answers/topics/azure-sql-database.html)에서 문의하세요.
