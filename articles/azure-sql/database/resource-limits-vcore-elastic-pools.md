...
|풀 당 최대 데이터 IOPS <sup>2</sup>|16,000|
|풀 당 최대 로그 전송률 (MBps)|37.5|
|풀 당 최대 동시 작업자 수 (요청) <sup>3</sup>|3780|
|풀 당 최대 동시 로그인 수 (요청) <sup>3</sup>|3780|
|최대 동시 세션|30,000|
...
|계산 크기 (서비스 목표)|BC_Gen4_2|BC_Gen4_3|BC_Gen4_4|BC_Gen4_5|BC_Gen4_6|
|:--- | --: |--: |--: |--: |--: |--: |
...
|계산 크기 (서비스 목표)|BC_Gen5_4|BC_Gen5_6|BC_Gen5_8|BC_Gen5_10|BC_Gen5_12|BC_Gen5_14|
|:--- | --: |--: |--: |--: |---: | --: |--: |
...
|풀 당 최대 데이터 IOPS <sup>2</sup>|200,000|
|풀 당 최대 로그 전송률 (MBps)|333|
|풀 당 최대 동시 작업자 수 (요청) <sup>3</sup>|13440|
|풀 당 최대 동시 로그인 수 (요청) <sup>3</sup>|13440|
|최대 동시 세션|30,000|
