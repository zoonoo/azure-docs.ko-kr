...
다음 단계에서는 Azure SQL Database, SQL Managed Instance 또는 Azure Synapse를 구성 하 여 조건부 액세스 정책을 적용 하는 방법을 보여 줍니다.  
...
1. Azure Portal에 로그인 하 고 **Azure Active Directory** 을 선택한 다음 **조건부 액세스** 를 선택 합니다. 자세한 내용은 [Azure Active Directory 조건부 액세스 기술 참조](../../active-directory/conditional-access/concept-conditional-access-conditions.md)를 참조하세요.  
