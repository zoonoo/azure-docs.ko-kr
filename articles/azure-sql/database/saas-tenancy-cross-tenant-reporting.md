...
1. **$DemoScenario = 2**, _임시 보고 데이터베이스 배포_를 설정합니다.
...
* [Tickets SaaS Database Per Tenant 애플리케이션을 기반으로 빌드되는 추가 자습서](../../sql-database/saas-dbpertenant-wingtip-app-overview.md#sql-database-wingtip-saas-tutorials)
