...
***이 자습서를 계속 진행하지 않으려면*** 서버에서 tpcxbb_1gb 데이터베이스를 삭제합니다.
...
> [자습서: Azure SQL Database Machine Learning Services(미리 보기)를 사용하여 R에서 예측 모델 만들기](clustering-model-build-tutorial.md)
