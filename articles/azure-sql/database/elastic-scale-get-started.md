...
2. 프로젝트를 만들려면 *탄력적-도구-마스터* 디렉터리에서 *ElasticDatabaseTools* 솔루션을 엽니다. 

3. *Elasticscalestarterkit.sln* 프로젝트를 시작 프로젝트로 설정 합니다.

4. *Elasticscalestarterkit.sln* 프로젝트에서 *App.config* 파일을 엽니다. 그런 다음 파일의 지침에 따라 서버 이름 및 로그인 정보 (사용자 이름 및 암호)를 추가 합니다.
