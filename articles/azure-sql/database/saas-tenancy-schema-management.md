...
* Wingtip Tickets SaaS Database Per Tenant 앱이 배포됩니다. 5분 안에 배포를 마치려면 [테넌트 애플리케이션별로 Wingtip Tickets SaaS 데이터베이스 배포 및 살펴보기](../../sql-database/saas-dbpertenant-get-started-deploy.md)를 참조하세요.
