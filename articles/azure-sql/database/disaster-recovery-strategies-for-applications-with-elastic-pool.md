...
이 전략의 주요 장점 은 데이터 계층 중복성을 위해 지속적으로 발생하는 비용이 낮은 것입니다. Azure SQL Database는 추가 비용 없이 응용 프로그램 재작성 없이 데이터베이스를 자동으로 백업 합니다. 탄력적 데이터베이스를 복원한 경우에만 비용이 발생합니다. 

### <a name="trade-off"></a>절충
