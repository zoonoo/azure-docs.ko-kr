...
ms.locfileid: "84028004"
---
# <a name="set-up-and-use-azure-monitor-logs-with-a-multitenant-azure-sql-database-saas-app"></a>다중 테 넌 트 Azure SQL Database SaaS 앱을 사용 하 여 Azure Monitor 로그 설정 및 사용
...
* Wingtip Tickets SaaS 테넌트별 데이터베이스 앱이 배포되어 있습니다. 5분 안에 배포를 마치려면 [Wingtip Tickets SaaS 테넌트별 데이터베이스 애플리케이션 배포 및 살펴보기](../../sql-database/saas-dbpertenant-get-started-deploy.md)를 참조하세요.
...
1. PowerShell ISE에서 .를 엽니다 *. \\ Wingtipticketssaas-dbpertenant-master-Wingtipticketssaas-multitenantdb-master \\ Learning 모듈 \\ 성능 모니터링 및 관리 \\Demo-PerformanceMonitoringAndManagement.ps1*. 이 자습서에서 몇 가지 부하 생성 시나리오를 실행할 수도 있으므로 이 스크립트를 계속 열어 둡니다.
...
1. PowerShell ISE에서 .를 엽니다 *. \\ Wingtipticketssaas-dbpertenant-master-Wingtipticketssaas-multitenantdb-master \\ \\ \\ Log Analytics \\Demo-LogAnalytics.ps1학습 모듈 성능 모니터링 및 관리 *.
