...
Azure Monitor 로그를 사용하여 쿼리를 실행하고 경고를 설정하는 방법에 대한 자세한 내용은 [Azure Monitor 로그에서 경고 규칙 작업](../../azure-monitor/platform/alerts-metric.md)을 참조하세요.
