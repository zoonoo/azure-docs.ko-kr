...
대량 마이그레이션의 경우 [Azure Site Recovery](/azure/site-recovery/site-recovery-overview) 서비스를 사용하는 것이 좋습니다. Azure Site Recovery를 통해 고객은 온-프레미스에서 Azure VM으로 SQL Server를 포함하여 전체 VM을 복제할 수 있습니다.
...
- **SQL Server 백업:** Azure Backup을 사용하여 15분 RPO 및 지정 시간 복구로 인해 랜섬웨어, 실수로 인한 삭제 및 손상으로부터 EOS SQL Server 2008 및 2008 R2를 보호할 수 있습니다. 자세한 내용은 [이 문서](https://docs.microsoft.com/azure/backup/sql-support-matrix#scenario-support)를 참조하세요.
