...
ms.locfileid: "84197120"
---
# <a name="prerequisites-for-creating-always-on-availability-groups-on-sql-server-on-azure-virtual-machines"></a>Azure 가상 머신의 SQL Server에서 Always On 가용성 그룹을 만들기 위한 필수 구성 요소
[!INCLUDE[appliesto-sqlvm](../../includes/appliesto-sqlvm.md)]

이 자습서에서는 [Azure VM(Virtual Machines)에 SQL Server Always On 가용성 그룹](availability-group-manually-configure-tutorial.md)을 만들기 위해 필수 구성 요소를 완료하는 방법을 보여 줍니다. 필수 구성 요소를 완료하면 단일 리소스 그룹에 도메인 컨트롤러, 두 개의 SQL Server VM 및 감시 서버가 포함됩니다.
...
> [!NOTE]
> 여기에서 제안하는 컴퓨터 크기는 Azure VM에서 가용성 그룹 테스트를 위해 계획된 것입니다. 프로덕션 작업에서 최상의 성능을 얻으려면 [Azure 가상 머신의 SQL Server에 대한 성능 모범 사례](performance-guidelines-best-practices.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)에서 SQL Server 가상 머신 크기 및 구성에 대한 권장 사항을 참조하세요.
>
>
