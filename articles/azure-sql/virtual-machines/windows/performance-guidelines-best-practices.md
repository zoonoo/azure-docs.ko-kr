...
저장소 및 성능에 대 한 자세한 내용은 [Azure의 SQL Server에 대 한 저장소 구성 지침 Virtual Machines](/archive/blogs/sqlserverstorageengine/storage-configuration-guidelines-for-sql-server-on-azure-vm) 을 참조 하세요.
