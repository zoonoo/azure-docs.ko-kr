...
4. Azure의 가상 머신 디스크에 온-프레미스 데이터를 백업하는 예약 작업 및 알림을 설정합니다. 자세한 내용은 azure [Blob storage 서비스를 사용 하 여 백업 및 복원 SQL Server](https://msdn.microsoft.com/library/jj919148.aspx) [azure Virtual Machines에서 SQL Server에 대 한 백업 및 복원](../../../azure-sql/virtual-machines/windows/backup-restore.md)을 참조 하세요.
