...
ms.locfileid: "84030034"
---
# <a name="configure-an-availability-group-on-azure-sql-server-virtual-machines-in-different-regions"></a>여러 지역의 Azure SQL Server 가상 머신에 가용성 그룹 구성
