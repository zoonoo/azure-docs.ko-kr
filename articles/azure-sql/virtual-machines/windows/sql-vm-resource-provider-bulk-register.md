...
- 가상 머신을 등록하는 데 사용되는 클라이언트 자격 증명은 다음 RBAC 역할 중 하나에 존재합니다. **가상 머신 기여자**, **기여자** 또는 **소유자**. 
...
## <a name="resister-all-vms-in-a-resource-group"></a>리소스 그룹의 모든 VM 등록
...
## <a name="register-specific-vms-in-single-resource-group"></a>단일 리소스 그룹의 특정 VM 등록
