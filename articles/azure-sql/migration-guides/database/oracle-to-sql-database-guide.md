...
ms.locfileid: "111961957"
---
# <a name="migration-guide-oracle-to-azure-sql-database"></a>마이그레이션 가이드: Oracle에서 Azure SQL Database로 마이그레이션

[!INCLUDE[appliesto-sqldb-sqlmi](../../includes/appliesto-sqldb.md)]

이 가이드에서는 Oracle용 SSMA(Oracle용 [SQL Server Migration](https://azure.microsoft.com/en-us/migration/sql-server/) Assistant)를 사용하여 Oracle 스키마를 Azure SQL Database로 [마이그레이션하는 방법](https://azure.microsoft.com/migration/migration-journey)을 알아봅니다.
