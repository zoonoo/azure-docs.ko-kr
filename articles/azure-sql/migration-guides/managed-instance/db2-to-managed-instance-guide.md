---
title: 'Db2에서 Azure로 SQL Managed Instance: 마이그레이션 가이드'
...
ms.locfileid: "105025053"
---
# <a name="migration-guide-db2-to-azure-sql-managed-instance"></a>마이그레이션 가이드: Db2에서 Azure SQL Managed Instance로
...
1. D b 2 용 SSMA (SQL Server Migration Assistant)를 엽니다. 
