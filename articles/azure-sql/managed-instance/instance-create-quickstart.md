...
> [!IMPORTANT]
> - SQL Managed Instance 만들기는 상황에 따라 한 번에 몇 시간이 걸릴 수 있는 장기 실행 작업입니다. 일반적인 생성 시간은 [관리 작업 기간](management-operations-overview.md#duration)을 참조하세요.
