...
Azure CLI 명령 [az resource invoke-작업](/cli/azure/resource#az_resource_invoke_action) 을 사용 하 여 서브넷에 있는 모든 가상 클러스터에 대 한 DNS 서버 구성을 동기화 합니다.
