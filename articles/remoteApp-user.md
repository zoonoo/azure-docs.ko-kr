<properties 
    pageTitle="RemoteApp에서 사용자 추가" 
    description="RemoteApp에 사용자를 추가하는 방법" 
    services="remoteapp" 
    solutions="" 
	documentationCenter="" 
    authors="lizap" 
...
Azure RemoteApp에는 두 배포 메서드, 클라우드 및 하이브리드가 있습니다. 각각은 사용자의 응용 프로그램 액세스에 다른 사용자 ID 사용을 지원합니다.
...
RemoteApp의 클라우드 컬렉션의 경우, Azure Active Directory 지원 ID가 있는 사용자에게는 Microsoft 계정을 비롯하여 RemoteApp에 대한 사용자 액세스 권한이 부여됩니다. 아래 표를 참조합니다.
...
|AD FS 포함 ADsync |예 |예 |
|타사 Azure 지원 ID 공급자(예: Ping) |예 |아니요|	
