...
### 가상 네트워크 ###
새 VNET을 자동으로 만드는 빨리 만들기 기능이 있지만 이 기능은 기존 VNET의 선택 및 수동으로 VNET 만들기도 지원합니다. 앱 서비스 환경 배포를 지원할 정도의 규모인 경우 기존 VNET(지금은 클래식 "v1" 가상 네트워크만 지원됨)을 선택할 수 있습니다. VNET에는 적어도 8개 이상의 주소가 있어야 합니다.
