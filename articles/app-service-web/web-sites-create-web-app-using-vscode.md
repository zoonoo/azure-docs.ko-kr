...
2. DNVM 설치를 완료하려면 **Windows를 다시 시작**합니다.
...
1. VS Code의 **명령 팔레트**에서 다음을 입력하여 사용 가능한 명령 실행 옵션을 표시합니다.
   ...
   > [!NOTE]
   > **명령 팔레트**에서 명령을 실행하려면 명령줄의 시작 부분에 **>** 문자가 있어야 합니다. 또한 *project.json* 파일에서 **web** 명령과 관련된 세부 정보를 볼 수 있습니다. 명령이 나타나지 않거나 사용할 수 없는 경우 C# 확장을 설치해야 할 수 있습니다. `>Extensions: Install Extension` 및 `ext install c#`을 실행하여 C# 확장을 설치합니다.
   > 
   > 
