...
1. [Azure 포털](http://go.microsoft.com/fwlink/?LinkId=529715)에서 웹앱을 찾아 **설정** 단추를 클릭합니다.
...
2. 런타임에 맞게 `php.ini` 파일을 수정합니다. 참고로, 시스템 수준 전용 지시문인 구성 설정은 웹 앱에서 무시됩니다. 시스템 수준 전용 지시문에 대한 자세한 내용은 [php.ini 지시문 목록](영문)을 참조하십시오.
