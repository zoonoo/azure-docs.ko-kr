...
---
# <a name="how-to-use-azure-blob-storage-with-the-webjobs-sdk"></a>WebJob SDK를 사용하여 Azure Blob 저장소로 작업하는 방법
...
## <a name="getting-the-blob-path-for-the-triggering-blob"></a>Blob 트리거를 위한 Blob 경로 가져오기
함수를 트리거한 Blob의 컨테이너 이름 및 Blob 이름을 가져오려면 함수 시그니처에 `blobTrigger` 문자열 매개 변수를 포함합니다.
