<properties
	pageTitle="Azure 자동화를 사용하여 Azure 웹 앱 관리"
	description="Azure 자동화 서비스를 사용하여 Azure 웹 앱을 관리하는 방법에 대해 알아봅니다."
