...
[Azure App Service에서 Java 웹 앱 만들기](web-sites-java-get-started.md)에 설명된 대로 [Azure 앱 서비스][Azure 앱 서비스]에서 Java 웹 앱을 초기화하면, **webapps** 폴더에 WAR을 배치하여 응용 프로그램을 업로드할 수 있습니다.
