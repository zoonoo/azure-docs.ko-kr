...
1. 아래 코드를 사용하여 동적 연락처 목록을 반영하도록 `Contact` 뷰를 업데이트합니다. <pre>// 뷰 파일의 맨 위에 @model IList&lt;MyContactsList.Web.Models.Contact&gt;를 추가합니다.
	
	// 기본 메일 주소를 다음 코드로 바꿉니다. &lt;h3&gt;Public Contacts&lt;/h3&gt; &lt;ul&gt; @foreach (var contact in Model) { &lt;li&gt;&lt;a href=&quot;mailto:@contact.EmailAddress&quot;&gt;@contact.Name &amp;lt;@contact.EmailAddress&amp;gt;&lt;/a&gt;&lt;/li&gt; } &lt;/ul&gt; </pre>
