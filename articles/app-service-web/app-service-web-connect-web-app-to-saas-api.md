...
이 자습서에서는 [앱 서비스](https://azure.microsoft.com/services/app-service/)에 호스트된 ASP.NET 웹앱에서 API 앱을 사용하는 방법을 보여 줍니다.
...
1. 솔루션 탐색기에서 새로 만든 웹 응용 프로그램 프로젝트를 마우스 오른쪽 단추로 클릭하고 **추가** > **REST API 클라이언트...**를 선택합니다.

	![Azure API 앱 참조 추가...](./media/app-service-web-connect-web-app-to-saas-api/3-Add-Azure-API-App-SDK.png)

1. **REST API 클라이언트 추가**에서 Microsoft Azure API 앱에서 다운로드를 선택하고 찾아보기를 선택합니다. 연결하려는 API 앱을 클릭합니다.
