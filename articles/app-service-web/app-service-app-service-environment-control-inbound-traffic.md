...
**참고**: 네트워크 보안 그룹은 아래 설명된 Powershell cmdlet을 사용해서만 구성될 수 있습니다. Azure 포털은 "v2" 가상 네트워크와 연결된 NSG의 그래픽 방식 구성만 허용하기 때문에 네트워크 보안 그룹은 [Azure 포털](https://portal.azure.com)을 사용하여 그래픽 방식으로 구성할 수 없습니다. 하지만 현재 작동하는 앱 서비스 환경은 클래식 "v1" 가상 네트워크에서만 지원됩니다. 따라서 “v1” 가상 네트워크에 연결된 네트워크 보안 그룹은 Powershell cmdlet을 사용해서만 구성할 수 있습니다.
