...
- 454: Azure 인프라에서 앱 서비스 환경을 관리 및 유지 보수하는 데 사용되는 **필수 포트**입니다. 이 포트를 차단하지 마세요. 이 포트는 항상 ASE의 공용 VIP에 바인딩됩니다.
- 455: Azure 인프라에서 앱 서비스 환경을 관리 및 유지 보수하는 데 사용되는 **필수 포트**입니다. 이 포트를 차단하지 마세요. 이 포트는 항상 ASE의 공용 VIP에 바인딩됩니다.
