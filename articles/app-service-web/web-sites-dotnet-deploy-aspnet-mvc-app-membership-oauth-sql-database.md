...
- [로그인, 메일 확인 및 암호 재설정이 포함된 보안 ASP.NET MVC 5 웹앱 만들기](http://www.asp.net/mvc/overview/getting-started/create-an-aspnet-mvc-5-web-app-with-email-confirmation-and-password-reset)(영문)
- [SMS 및 메일 2단계 인증을 사용하는 ASP.NET MVC 5 앱](http://www.asp.net/mvc/overview/getting-started/aspnet-mvc-5-app-with-sms-and-email-two-factor-authentication)(영문)
- [암호 및 기타 중요한 데이터를 ASP.NET 및 Azure에 배포하기 위한 모범 사례](http://www.asp.net/identity/overview/features-api/best-practices-for-deploying-passwords-and-other-sensitive-data-to-aspnet-and-azure)(영문) 
