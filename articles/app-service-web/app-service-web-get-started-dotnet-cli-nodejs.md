---
title: "5분 내 Azure에 첫 번째 ASP.NET 웹앱 배포 | Microsoft Docs"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>5분 내 Azure에 첫 번째 ASP.NET 웹앱 배포
...
- [Azure CLI 2.0](app-service-web-get-started-dotnet.md) - 리소스 관리 배포 모델용 차세대 CLI
...
4. 작업 디렉터리(`CD`)를 변경하고 샘플 ASP.NET 앱을 복제합니다.
