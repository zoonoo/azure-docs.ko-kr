...
## <a name="web-app-creation-on-the-azure-portal"></a>Azure 포털에서 웹앱 만들기
...
3. 검색 결과에서 선택 **Bottle**을 선택하고 **만들기**를 클릭합니다.
4. 새 Bottle 앱을 구성(예: 새 앱 서비스 계획 만들기)하고 해당 앱의 새 리소스 그룹을 구성합니다. 그런 다음에 **만들기**를 클릭합니다.
