---
title: Azure 앱 서비스에서 .NET WebJob 만들기 | Microsoft Docs
...
1. **서버 탐색기**의 **Azure > 앱 서비스 > {리소스 그룹}**에서 웹앱을 마우스 오른쪽 단추로 클릭한 다음 **설정 보기**를 클릭합니다.
...
WebJob SDK 특성을 사용하는 함수를 작성하는 방법에 대한 자세한 내용은 다음 리소스를 참조하세요.
