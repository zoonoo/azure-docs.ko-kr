<properties 
	...
	description="Python Tools for Visual Studio를 사용하여 MongoDB 데이터베이스 인스턴스에 데이터를 저장하고 Azure 앱 서비스 웹앱에 배포할 수 있는 Flask 웹앱을 만드는 방법에 대해 알아봅니다." 
...
Azure에서 호스트된 MongoDB 서비스 중 하나를 사용하는 방법, MongoDB를 사용하도록 웹앱을 구성하는 방법 및 [Azure 앱 서비스 웹앱](http://go.microsoft.com/fwlink/?LinkId=529714)에 웹앱을 게시하는 방법을 알아봅니다.
...
1.  데이터베이스 서비스를 찾을 영역을 선택합니다. Azure 응용 프로그램에서 데이터베이스를 사용하는 경우 응용 프로그램을 배포할 영역과 동일한 영역을 선택합니다.
...
1.  `F5` 키를 눌러 응용 프로그램을 실행합니다. **Create Sample Polls**를 사용하여 만든 설문 조사와 투표를 통해 제출된 데이터는 MongoDB에서 직렬화됩니다.
...
PTVS를 통해 Azure 앱 서비스에 웹앱을 쉽게 배포할 수 있습니다.
