...
## <a name="buy-a-new-custom-domain-in-azure-portal"></a>Azure 포털에서 새 사용자 지정 도메인 구입
...
## <a name="map-a-custom-domain-you-purchased-externally"></a>외부에서 구입한 사용자 지정 도메인 매핑
