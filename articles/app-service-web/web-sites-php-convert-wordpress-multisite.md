...
## <a name="enable-domain-mapping-to-the-web-app"></a>웹 앱에 대한 도메인 매핑 사용
...
## <a name="add-the-domain-to-the-web-app"></a>웹 앱에 도메인 추가
...
## <a name="setup-the-domain-a-record"></a>도메인 A 레코드 설정
