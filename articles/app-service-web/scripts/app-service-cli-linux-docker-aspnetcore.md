...
이 시나리오에서는 리소스 그룹, Linux App Service 계획 및 웹앱을 만들고 Docker 컨테이너를 사용하여 ASP.NET Core 응용 프로그램을 배포하는 방법을 알아봅니다.
...
[!code-azurecli-interactive[기본](../../../cli_scripts/app-service/deploy-linux-docker/deploy-linux-docker.sh?highlight=6 "Linux Docker")]
