...
1.  [Python Tools 2.2 for Visual Studio Samples VSIX]의 프로젝트 템플릿은 **Python**, **샘플**에서 사용할 수 있습니다. **Polls Flask Web Project**를 선택하고 확인을 클릭하여 프로젝트를 만듭니다.
...
5. 저장소 계정 블레이드에서 **액세스 키** 부분을 클릭합니다. 계정 이름 및 key1을 기록해 둡니다.
