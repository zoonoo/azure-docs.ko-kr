...
>[AZURE.NOTE] Azure 계정 없이 [App Service를 체험](http://go.microsoft.com/fwlink/?LinkId=523751)할 수 있습니다. 시작 앱을 만들고 최대 한 시간 동안 해당 앱을 사용하여 재생합니다. -- 신용 카드는 필요하지 않으며 약정도 필요하지 않습니다.
...
2. 왼쪽 메뉴에서 **새로 만들기** > **웹 + 모바일** > **Web App**을 클릭합니다.
...
## <a name="deploy-code-to-your-web-app"></a>사용자의 웹앱에 코드 배포
