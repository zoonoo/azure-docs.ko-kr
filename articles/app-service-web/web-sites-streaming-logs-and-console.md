...
Microsoft Azure 포털은 통합 스트리밍 로그 뷰어를 제공하며, 이 뷰어에서 Azure 앱 서비스 웹 앱의 추적 이벤트를 실시간으로 볼 수 있습니다.
...
![][BrowseSitesScreenshot] 진단은 웹 앱별로 사용하도록 설정됩니다. [포털](https://portal.azure.com) 안의 왼쪽 메뉴 표시줄에서 **찾아보기 (1)** 단추를 클릭한 다음 **웹앱 (2)**을 클릭하여 모든 웹 앱 **목록 (3)**을 표시합니다.

구성할 웹앱의 이름을 클릭하여 해당 항목으로 이동합니다.
  
![][DiagnosticsLogs] 그런 다음 **설정 (1)** > **진단 로그 (2)**를 클릭하고 **응용 프로그램 로깅(파일 시스템)(3)**을 **실행**합니다. **수준** 옵션을 통해 캡처할 추적의 심각도 수준을 변경할 수 있습니다. **세부 정보 표시**는 모든 추적 스트리밍을 로깅하므로, 이 기능에 익숙해지고 싶으면 이 설정을 지정해야 합니다.
...
![][StreamingLogsScreenshot]포털 내에서 스트리밍 로그를 보려면 **도구 (1)**>**로그 스트림(2)**을 클릭합니다. 앱에서 추적 문을 활발하게 쓰는 경우 결과 창에서 거의 실시간으로 볼 수 있습니다.
...
![][ConsoleScreenshot] 콘솔에 액세스하려면 위의 섹션에 설명된 대로 웹 앱으로 이동합니다. **도구**>**콘솔** 타일을 클릭하면 콘솔이 열립니다.
