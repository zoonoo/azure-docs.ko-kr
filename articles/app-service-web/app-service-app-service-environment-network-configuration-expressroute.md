...
-  앱 서비스 환경처럼 동일한 지역에 위치한 Sql DB 끝점에 대한 아웃바운드 네트워크 연결. Sql DB 끝점은 다음 도메인에서 해결합니다. *database.windows.net* 이를 위해서는 포트 1433, 11000-11999 및 14000-14999에 대한 열기 액세스가 필요합니다. 자세한 내용은 [이 문서에서 Sql 데이터베이스 V12 포트 사용](../sql-database/sql-database-develop-direct-route-ports-adonet-v12.md)을 참조하세요.
