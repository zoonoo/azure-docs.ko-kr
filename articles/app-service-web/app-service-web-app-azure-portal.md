...
---
# <a name="reference-for-navigating-the-azure-portal"></a>Azure 포털 탐색을 위한 참조
...
## <a name="the-future-of-the-azure-classic-portal"></a>Azure 클래식 포털의 미래
...
## <a name="layout-differences-between-the-azure-classic-portal-and-azure-portal"></a>Azure 클래식 포털과 Azure 포털 간의 레이아웃 차이점
...
또한 포털에서는 다른 일반적인 설정을 정의할 수 있습니다. 예를 들어 [리소스 그룹](../azure-resource-manager/resource-group-overview.md)을 사용하면 관련된 Azure 리소스를 간단하게 확인하고 관리할 수 있습니다. 
