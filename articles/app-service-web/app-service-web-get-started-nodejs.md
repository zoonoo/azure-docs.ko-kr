---
title: "5분 내 Azure에 Node.js 웹앱 배포(CLI 2.0 미리 보기) | Microsoft Docs"
...
---
# <a name="deploy-your-first-nodejs-web-app-to-azure-in-five-minutes-cli-20-preview"></a>5분 내에 Azure에 첫 번째 Node.js 웹앱 배포(CLI 2.0 미리 보기)
...
4. 다음으로 배포하려는 샘플 Node.js 코드를 가져옵니다. 작업 디렉터리(`CD`)를 변경하고 샘플 앱을 다음과 같이 복제합니다.
