...
9. **키** 섹션까지 아래로 스크롤하고 기간을 선택하여 키를 추가합니다. 그런 다음 **위임된 사용 권한**을 클릭하고 **디렉터리 데이터 읽기**를 선택합니다. **Save**를 클릭합니다.
...
13. subscriptions > **&lt;*subscriptionname*>** > **resourceGroups** > **&lt;*resourcegroupname*>** > **providers** > **Microsoft.Web** > **사이트** > **&lt;*appname*>** > **config** > **authsettings**에 있는 앱의 인증 설정을 찾습니다.
14. **편집**을 클릭합니다.
...
13. ~\\App\_Start\\BundleConfig.cs를 열고 다음 강조 표시된 사항을 변경합니다.
...
14. 마지막으로 ~\\Global.asax의 `Application_Start()` 메서드에 코드의 다음 줄을 추가합니다. 이를 수정하기 위해 각 명명 확인 오류에 대한 `Ctrl`+`.`.
