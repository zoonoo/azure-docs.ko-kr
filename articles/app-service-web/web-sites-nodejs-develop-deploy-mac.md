---
title: Azure 앱 서비스에서 Node.js 웹앱 만들기 | Microsoft Docs
...
7. **앱 서비스 계획/위치**을 선택하거나 새로 만듭니다.
    ...
    앱 서비스 계획에 대한 자세한 내용은 [Azure 앱 서비스 계획 개요](../app-service/azure-web-sites-web-hosting-plans-in-depth-overview.md)를 참조하세요.
8. **만들기**를 클릭합니다.
...
4. 명령줄을 열고 다음 명령을 사용하여 웹앱을 로컬에서 시작합니다.
        ...
        node server.js
5. 웹 브라우저를 열고 http://localhost:1337으로 이동합니다.
