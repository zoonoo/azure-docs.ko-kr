...
7. 상태가 **실행 중**으로 변경되면 포털에서 웹앱에 대한 블레이드를 자동으로 엽니다. **찾아보기**를 클릭하여 블레이드를 찾을 수도 있습니다.
...
9. **원본 선택**을 클릭하고 **로컬 Git 리포지토리**를 클릭한 다음 **확인**을 클릭합니다.
...
11. 게시하려면 Git 원격 리포지토리에 푸시합니다. 리포지토리의 URL을 찾고 **모든 설정**, **속성**을 차례로 클릭합니다. URL이 **GIT URL** 아래에 나열됩니다.
...
4. 웹 브라우저를 열고 http://localhost:1337으로 이동합니다. 아래 스크린샷처럼 "Hello World"라는 웹 페이지가 나타납니다.
...
5. 앱을 보려면 Azure 포털 내 **웹앱** 부분에서 **찾아보기** 단추를 클릭합니다.
