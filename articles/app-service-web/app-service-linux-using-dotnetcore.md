...
최신 Azure 플랫폼 간 CLI를 사용하면 **azure webapp config set** 명령을 사용하여 응용 프로그램 스택을 변경할 수 있습니다. 예제는 다음과 같습니다.
...
그러면 .Net Core 이미지가 로드되고 웹앱이 시작됩니다. **azure webapp config show**를 사용하여 설정이 올바르게 지정되었는지 확인할 수 있습니다. 예제는 다음과 같습니다.
