...
>[AZURE.NOTE] "잠깐만요! FTP로 배포하려는 경우 어떻게 하나요?" 요구에 맞는 [FTP 자습서](web-sites-php-mysql-deploy-use-ftp.md)가 있습니다. 
