...
> [!NOTE]
> **무료** 계층에서 앱 서비스 계획을 전환하기 전에 먼저 Azure 구독에 대한 [지출 한도](/pricing/spending-limits/)를 제거해야 합니다. Microsoft Azure 앱 서비스 구독 옵션을 보거나 변경하려면 [Microsoft Azure 구독][azuresubscriptions]을 참조하세요.
> 
> 
...
> [!NOTE]
> Azure 계정을 등록하기 전에 Azure 앱 서비스를 시작하려면 [앱 서비스 평가](http://go.microsoft.com/fwlink/?LinkId=523751)로 이동합니다. 앱 서비스에서 단기 스타터 웹앱을 즉시 만들 수 있습니다. 신용 카드는 필요하지 않으며 약정은 없습니다.
> 
> 
