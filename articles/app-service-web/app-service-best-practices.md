...
## <a name="a-namecolocationacolocation"></a><a name="colocation"></a>공동 배치
...
## <a name="a-namememoryresourcesawhen-apps-consume-more-memory-than-expected"></a><a name="memoryresources"></a>앱에서 예상보다 더 많은 메모리를 사용하는 경우
...
## <a name="a-namecpuresourcesawhen-apps-consume-more-cpu-than-expected"></a><a name="CPUresources"></a>앱에서 예상보다 더 많은 CPU를 사용하는 경우
...
## <a name="a-namesocketresourcesawhen-socket-resources-are-exhausted"></a><a name="socketresources"></a>소켓 리소스를 모두 사용한 경우
...
## <a name="a-nameappbackupawhen-your-app-backup-starts-failing"></a><a name="appbackup"></a>앱 백업이 실패하는 경우
