...
2. **http://[web 앱 이름].azurewebsites.net/createtable.php**로 이동하여 응용 프로그램에 대한 SQL 데이터베이스를 만듭니다.
3. **http://[web 앱 이름].azurewebsites.net/index.php**로 이동하여 응용 프로그램 사용을 시작합니다.
...
3. **http://[web 앱 이름].azurewebsites.net/index.php**로 이동하여 변경 내용을 확인합니다.
