---
title: Azure 앱 서비스에서 Java 웹앱 만들기 | Microsoft Docs
...
이 자습서는 [Azure 포털]을 사용하여 Java [Azure 앱 서비스에서 웹앱]을 만드는 방법을 보여 줍니다. Azure 포털은 Azure 리소스를 관리하는 데 사용할 수 있는 웹 인터페이스입니다.
...
[Azure 앱 서비스에서 웹앱]: http://go.microsoft.com/fwlink/?LinkId=529714
