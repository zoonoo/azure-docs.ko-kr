...
6. 검색 텍스트 상자에 **Apache Tomcat**, **Jetty**와 같은 Java 응용 프로그램 서버의 이름을 입력한 다음 Enter를 누릅니다.

4. 검색 결과에서 Java 응용 프로그램 서버를 클릭합니다.

	![](./media/web-sites-java-get-started/webmobilejetty.png)

5. 첫 번째 **Apache Tomcat** 또는 **Jetty** 블레이드에서 **만들기**를 클릭합니다.

	![](./media/web-sites-java-get-started/jettyblade.png)

4. 다음 **Apache Tomcat** 또는 **Jetty** 블레이드에서 **웹앱** 상자에 웹앱의 이름을 입력합니다.
...
11. 웹앱을 만들었으면 **웹앱 > {사용자의 웹앱}**을 클릭합니다.
 
13. **웹앱** 블레이드에서 **설정**을 클릭합니다.

12. **응용 프로그램 설정**을 클릭합니다.

13. 원하는 **Java 버전**을 클릭합니다.

14. 원하는 **웹 컨테이너**를 선택합니다.
