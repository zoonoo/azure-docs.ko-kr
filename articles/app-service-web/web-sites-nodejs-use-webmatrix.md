---
title: "WebMatrix를 사용하여 Node.js 웹앱 빌드 및 Azure에 배포"
...
---
# <a name="build-and-deploy-a-nodejs-web-app-to-azure-using-webmatrix"></a>WebMatrix를 사용하여 Node.js 웹앱 빌드 및 Azure에 배포
...
## <a name="create-a-site-using-a-built-in-template-for-azure"></a>Azure용 기본 제공 템플릿을 사용하여 사이트 만들기
...
## <a name="modify-and-republish-your-application"></a>응용 프로그램 수정 및 다시 게시
...
3. 변경 내용을 저장한 후 게시 아이콘을 클릭합니다. 마지막으로 **계속** in the **게시 미리 보기** 을 클릭하고 업데이트가 게시될 때까지 기다립니다.
