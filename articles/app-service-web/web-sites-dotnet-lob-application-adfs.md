...
- 온-프레미스 AD FS 배포(이 문서에 사용된 테스트 랩의 전체 연습은 [테스트 랩: AD FS가 Azure VM에 포함된 독립 실행형 STS(테스트 전용)](https://blogs.msdn.microsoft.com/cephalin/2014/12/21/test-lab-standalone-sts-with-ad-fs-in-azure-vm-for-test-only/) 참조)
