---
title: "5분 내 Azure에 첫 번째 HTML 웹앱 배포(CLI 2.0 미리 보기) | Microsoft Docs"
...
---
# <a name="deploy-your-first-html-web-app-to-azure-in-five-minutes-cli-20-preview"></a>5분 내 Azure에 첫 번째 HTML 웹앱 배포(CLI 2.0 미리 보기)
...
4. 다음으로 배포하려는 샘플 HTML 사이트를 가져옵니다. 작업 디렉터리(`CD`)를 변경하고 샘플 앱을 다음과 같이 복제합니다.
