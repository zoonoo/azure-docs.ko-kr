...
### <a id="qtattributetypes"></a> QueueTrigger 특성이 작동하는 유형
...
### <a id="ibinder"></a>함수 본문에 WebJobs SDK 특성 사용
...
함수가 실패하게 만드는 내용이 포함된 메시지를  *poison messages*라고 합니다. 함수가 실패할 경우 큐 메시지가 삭제되지 않고 결국 다시 선택되어 주기가 반복됩니다. SDK에서 제한된 반복 횟수 후에 자동으로 주기를 중단하거나 수동으로 중단할 수 있습니다.
