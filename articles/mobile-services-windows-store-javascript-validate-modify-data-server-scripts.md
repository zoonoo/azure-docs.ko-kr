<properties pageTitle="서버 스크립트를 사용하여 데이터 유효성 검사 및 수정(JavaScript) | 모바일 개발자 센터" description="Windows 스토어 JavaScript 앱에서 서버 스크립트를 사용하여 전송된 데이터의 유효성을 검사하고 데이터를 수정하는 방법에 대해 알아봅니다." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
