...
description: Azure에서 실행 중인 가상 시스템에 대한 유지 관리 알림을 보고 포털을 사용하여 셀프 서비스 유지 관리를 시작합니다.
author: shants123
...
계획된 [유지 관리](maintenance-notifications.md) 웨이브가 예약되면 영향을 받는 가상 컴퓨터 목록을 확인할 수 있습니다. 

Azure Portal을 사용하여 유지 관리하도록 예약된 VM을 찾아볼 수 있습니다.

1. [Azure 포털에](https://portal.azure.com)로그인합니다.

2. 왼쪽 탐색에서 **가상 컴퓨터를 클릭합니다.**

3. 가상 시스템 창에서 **열 편집 단추를** 선택하여 사용 가능한 열 목록을 엽니다.

4. 다음 열을 선택하여 추가합니다.

   **유지 관리 상태**: VM의 유지 관리 상태를 표시합니다. 가능한 값은 다음과 같습니다.
...
**이벤트 형식을** 계획된 유지 **관리**및 **서비스를** **가상 컴퓨터 크기 집합** 및/또는 가상 **컴퓨터로**설정해야 합니다.
...
[Azure CLI](maintenance-notifications-cli.md) 또는 [PowerShell을](maintenance-notifications-powershell.md)사용하여 계획된 유지 관리를 처리할 수도 있습니다.