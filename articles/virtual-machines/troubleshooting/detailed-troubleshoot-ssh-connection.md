...
* **대상 VM의 SSH 트래픽에 대한 엔드포인트 구성.** 엔드포인트의 프라이빗 TCP 포트는 VM에서 SSH 서비스가 수신 대기 중인 TCP 포트와 일치해야 합니다. 기본 포트는 22입니다. **가상 컴퓨터** > *VM 이름* > **설정** > **끝점을**선택하여 Azure 포털에서 SSH TCP 포트 번호를 확인합니다.
