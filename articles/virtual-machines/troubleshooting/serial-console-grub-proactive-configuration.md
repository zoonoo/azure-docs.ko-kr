...
SysRq 기능은 Azure 직렬 콘솔에서 직접 충돌 하거나 중단 된 VM을 다시 부팅 하는 데 유용 합니다. 또한 GRUB 메뉴에 액세스 하거나 다른 포털 창에서 VM을 다시 시작 하거나 ssh 세션에서 현재 콘솔 연결을 삭제할 수 있습니다. 따라서 GRUB 메뉴를 표시 하는 데 사용 되는 GRUB 시간 제한이 만료 됩니다.
...
여기에 표시 된 대로 sysrq2를 사용 하도록 설정 ![](./media/virtual-machines-serial-console/enabling-sysrq-2.png)
...
수정할 파일은/boot/grub/grub.conf.입니다. `timeout` 값은에 대해 GRUB가 표시 되는 기간을 결정 합니다.
