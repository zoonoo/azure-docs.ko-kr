...
2. **slmgr.vbs /dlv**가 소매 채널을 표시하는 경우 다음 명령을 실행하여 사용된 Windows Server의 버전에 [KMS 클라이언트 설정 키](/windows-server/get-started/kmsclientkeys)를 설정하고 활성화를 다시 시도합니다. 
