...
>* DIP 또는 HostName을 사용 하 여 \<컴퓨터 >를 바꿀 수 있습니다.
...
스토리지 계정에 스크립트를 업로드하고 자체 컨테이너를 생성해야 합니다. 그런 다음, VM에 연결된 컴퓨터의 Azure PowerShell에서 다음 스크립트를 실행합니다.
