...
4. 만든 복구 VM에서 필요한 완화 단계를 수행한 후 5단계로 진행합니다.
...
* VM에 연결하는 데 문제가 있는 경우 [Azure 가상 머신에 RDP 연결 문제 해결](https://docs.microsoft.com/azure/virtual-machines/troubleshooting/troubleshoot-rdp-connection)을 참조하세요.
