...
실제 디스크 관점(디스크 맵)에서 테이블은 디스크에서 실행 중인 모든 논리 볼륨을 표시합니다. 다음 예제에서 **예에서** 는 여러 파티션에 생성 된 두 개의 논리 볼륨을 실행 합니다 (J 및 H).
...
검색 **결과** 탭에는 권장 사항과 함께 발견 된 모든 SQL 관련 성능 문제의 목록이 포함 되어 있습니다.
