...
## <a name="issue-error-when-starting-a-stopped-vm"></a>문제: 중지 된 VM을 시작 하는 동안 오류 발생
...
## <a name="issue-error-when-resizing-an-existing-vm"></a>문제: 기존 VM의 크기를 조정 하는 동안 오류 발생
