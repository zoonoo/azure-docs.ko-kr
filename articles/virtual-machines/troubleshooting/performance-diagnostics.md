...
* 로그 파일을 포함 하는 Linux에서 Windows의 출력 압축 파일 (.zip) (이름이 지정 된 **PerformanceDiagnostics_yyyy-MM-dd_hh-mm-ss-fff.zip** ) 및 tar 구슬 파일 ( **PerformanceDiagnostics_yyyy-MM-dd_hh-mm-release.tar.gz** )
* HTML 보고서
