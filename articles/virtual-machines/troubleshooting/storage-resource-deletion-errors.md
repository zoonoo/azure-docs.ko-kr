...
> **' StorageAccountName ' 저장소 계정을 삭제 하지 못했습니다. 오류: 아티팩트를 사용 중 이므로 저장소 계정을 삭제할 수 없습니다.**
> 
...
1. [Azure Portal](https://portal.azure.com)에 로그인합니다.
2. 허브 메뉴에서 **모든 리소스** 를 선택합니다. 저장소 계정으로 이동 하 여 **Blob Service** 에서 **컨테이너** 를 선택 하 고 삭제할 컨테이너를 찾습니다.
