...
Windows 기반 Vm 용 드라이버를 설치 하는 지침은 [여기](../sizes-gpu.md#supported-operating-systems-and-drivers)에 있습니다.
...
- [적격 개발/테스트 제품](../windows/client-images.md) 내에서 Azure 갤러리의 특정 Windows 10 이미지를 사용할 수 있습니다. 
