...
[설명]: <> (TODO 이전 블로그)
[설명]: <> (Azure에서 AlwaysOn 구성 설치에 대한 자세한 단계 및 필요성은 [여기][virtual-machines-sql-server-alwayson-availability-groups-powershell]에서 사용할 수 있는 자습서를 살펴보는 것이 좋습니다.)
...
[설명]: <> (가용성 그룹 수신기 생성은 [이][virtual-machines-sql-server-configure-ilb-alwayson-availability-group-listener] 자습서에 잘 설명되어 있습니다.)
...
#### 고가용성
[설명]: <> (ASM 참조 링크)
높은 가용성 및 재해 복구를 위해 Oracle Data Guard가 지원됩니다. 자세한 내용은 [이][virtual-machines-configuring-oracle-data-guard] 설명서에서 찾을 수 있습니다.
