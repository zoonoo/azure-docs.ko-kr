...
이 단계를 시작하기 전에 [Active Directory 서비스 주체](../azure-resource-manager/resource-group-authenticate-service-principal.md)에 액세스할 수 있는지 확인합니다. 서비스 주체에서 Azure Resource Manager에서 요청을 인증받기 위한 토큰을 얻을 수 있습니다.
...
이 콘솔 응용 프로그램을 처음부터 끝까지 완전히 실행하려면 약&5;분이 필요합니다. 
