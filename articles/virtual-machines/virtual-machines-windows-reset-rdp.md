...
암호를 잊었거나 원격 데스크톱 서비스 구성의 문제로 Windows 가상 컴퓨터에 연결할 수 없는 경우 로컬 관리자 암호를 다시 설정하거나 원격 데스크톱 서비스 구성을 다시 설정할 수 있습니다.
...
Azure 포털은 현재 Azure Resource Manager를 사용하여 만든 가상 컴퓨터에 대한 원격 액세스 또는 로그인 자격 증명을 다시 설정하도록 지원하지 않습니다.
