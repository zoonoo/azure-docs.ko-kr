...
---
# <a name="using-load-balanced-sets-to-clusterize-mysql-on-linux"></a>부하 분산 집합을 사용하여 Linux에서 MySQL 클러스터화
[!INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]

MySQL 클러스터를 배포하는 Resource Manager 템플릿은 [여기](https://azure.microsoft.com/documentation/templates/mysql-replication/)를 참조하세요.
...
## <a name="setting-up-the-cluster"></a>클러스터 설치
...
### <a name="setting-up-drbd"></a>DRBD 설치
...
### <a name="mounting-the-drbd-resource"></a>DRBD 리소스 탑재
...
## <a name="setting-up-mysql"></a>MySQL 설치
...
### <a name="creating-the-mysql-load-balanced-set"></a>MySQL 부하 분산 집합 만들기
...
### <a name="testing-the-load-balanced-set"></a>부하 분산된 집합 테스트
...
## <a name="setting-up-corosync"></a>Corosync 설치
...
## <a name="setting-up-pacemaker"></a>Pacemaker 설치
