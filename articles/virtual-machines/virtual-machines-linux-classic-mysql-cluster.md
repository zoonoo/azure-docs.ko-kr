...
여기서는 DRBD, Corosync 및 Pacemaker에 기반한 비공유&2;개 노드 단일 마스터 MySQL 고가용성 솔루션을 개괄적으로 설명합니다. 한 번에 하나의 노드만 MySQL을 실행합니다. DRBD 리소스를 쓰고 이 리소스에서 읽는 작업도 한 번에 하나의 노드로 제한됩니다.
