...
<sup>1</sup> 1 GPU = 1-절반 M60 카드.

<sup>2</sup> 이 시점에서 가속화 된 네트워킹은이 VM 제품군에서 지원 되지 않으므로 실제 네트워크 성능은 여기에서 캡처한 최대 이론적 수 보다 낮을 수 있습니다.
