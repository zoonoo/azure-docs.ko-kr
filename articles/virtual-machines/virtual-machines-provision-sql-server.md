...
* [Azure 포털에 연결 및 갤러리에서 가상 컴퓨터 프로비전](#Provision)
...
1. 사용자 계정을 사용하여 [Azure 포털](http://manage.windowsazure.com)에 로그인합니다. Azure 계정이 없는 경우 [Azure 무료 평가판](http://azure.microsoft.com/pricing/free-trial/)을 방문하십시오.

2. Azure 포털 웹 페이지의 왼쪽 아래에서 **+새로 만들기**, **계산**, **가상 컴퓨터**, **갤러리에서**를 차례로 클릭합니다.
