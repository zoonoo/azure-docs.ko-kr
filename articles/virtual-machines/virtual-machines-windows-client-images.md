---
title: 테스트/개발 시나리오용으로 Windows 클라이언트 이미지 사용 | Microsoft Docs
...
---
# <a name="using-windows-client-in-azure-for-dev/test-scenarios"></a>개발/테스트 시나리오용으로 Azure에서 Windows 클라이언트 사용
