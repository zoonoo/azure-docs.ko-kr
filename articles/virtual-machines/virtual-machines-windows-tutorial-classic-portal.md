...
> [AZURE.NOTE]또한 보다 다양하며 사용자 지정 가능한 Azure Preview 포털에서 가상 컴퓨터를 만들고, 향상된 모니터링 및 진단과 프리미엄 저장소 등을 사용해 볼 수 있습니다. 두 포털에서의 가상 컴퓨터 구성에 사용 가능한 옵션은 상당 부분 중복되지만 동일하지는 않습니다. 예를 들어, Azure Preview 포털을 사용하여 프리미엄 저장소를 적용한 가상 컴퓨터를 구성합니다.
