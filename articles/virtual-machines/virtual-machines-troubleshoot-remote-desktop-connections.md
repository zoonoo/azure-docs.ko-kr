<properties
	pageTitle="RDP를 통해 Azure 가상 컴퓨터에 연결할 수 없습니다. | Microsoft Azure"
...
> [AZURE.NOTE]이 문서는 Windows를 실행하는 Azure 가상 컴퓨터에만 적용됩니다. Linux를 실행하는 Azure 가상 컴퓨터에 대한 연결 문제 해결에 대해서는 [이 문서](virtual-machines-troubleshoot-ssh-connections.md)를 참조하세요.
...
- [Azure 포털](https://portal.azure.com)에서 원격 데스크톱 서비스를 초기화합니다. **모두 찾아보기** > **가상 컴퓨터(클래식)** > **Windows 가상 컴퓨터** > 원격 액세스 재설정을 클릭합니다.
...
- [가상 컴퓨터 크기를 조정](https://msdn.microsoft.com/library/dn168976.aspx)합니다.
...
1.	[진단 지원 페이지](https://home.diagnostics.support.microsoft.com/SelfHelp?knowledgebaseArticleFilter=2976864)에서 **Microsoft Azure IaaS(Windows) 진단 패키지**를 클릭합니다. 새 진단 세션에 대한 **만들기**를 클릭합니다. 이 세션을 다른 대상 컴퓨터와 **공유**하거나 로컬 컴퓨터에 **다운로드**할 수 있습니다.
2.	세션을 **실행**하고 Microsoft 사용권 계약에 **동의**하고 진단 도구를 **시작**합니다.
...
이러한 오류가 발생하지 않았는데도 여전히 원격 데스크톱을 통해 가상 컴퓨터에 연결할 수 없는 경우 [이 문서](virtual-machines-rdp-detailed-troubleshoot.md)를 읽고 다른 원인을 찾아보십시오.
