...
3. 다음 단계를 위해 VM 3개의 내부 IP 주소를 각각 가져와야 합니다.
	...
	![IP 주소 가져오기](./media/virtual-machines-mariadb-cluster/IP.png)
...
![끝점 편집](./media/virtual-machines-mariadb-cluster/Endpoint.PNG)

부하 분산 집합 다시 구성을 클릭하고 다음으로 이동합니다.

![부하 분산된 집합 다시 구성](./media/virtual-machines-mariadb-cluster/Endpoint2.PNG)

검색 간격을 5초로 변경하고 저장합니다.

![검색 간격 변경](./media/virtual-machines-mariadb-cluster/Endpoint3.PNG)
