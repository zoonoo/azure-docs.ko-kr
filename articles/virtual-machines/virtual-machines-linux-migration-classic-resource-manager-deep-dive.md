...
## <a name="detailed-guidance-on-migration-at-a-resource-and-feature-level"></a>리소스 및 기능 수준 마이그레이션에 대한 자세한 지침
...
![준비 후 클래식 표현을 보여주는 스크린샷](./media/virtual-machines-windows-migration-classic-resource-manager/classic-migration-prepare-portal.png)
![준비 후 Resource Manager 표현을 보여주는 스크린샷](./media/virtual-machines-windows-migration-classic-resource-manager/resourcemanager-migration-prepare-portal.png)
