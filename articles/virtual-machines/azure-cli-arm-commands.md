...
## <a name="active-directory-objects"></a>Active Directory 개체
...
## <a name="account-features"></a>계정 기능
...
## <a name="resource-provider-registrations"></a>리소스 공급자 등록
...
## <a name="storage-objects"></a>스토리지 개체
**Storage 계정을 관리하는 명령**
