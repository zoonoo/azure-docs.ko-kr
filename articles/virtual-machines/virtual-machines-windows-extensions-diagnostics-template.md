...
> [!NOTE]
> Visual Studio에서 Windows 가상 컴퓨터 템플릿을 만들면, 기본 저장소 계정은 가상 컴퓨터 VHD가 업로드되는 위치와 동일한 저장소 계정을 사용하도록 설정됩니다. 이것은 VM 초기 설정을 간소화하기 위한 것입니다. 매개 변수로 전달될 수 있는 다른 저장소 계정을 사용하려면 템플릿을 리팩터링해야 합니다. 
> 
> 
