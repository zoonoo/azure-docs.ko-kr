<properties
	...
	description="CoreOS, Azure에서 CoreOS 가상 컴퓨터 클러스터를 만드는 방법 및 기본적인 사용 방법에 대해 설명합니다."
...
>[AZURE.NOTE]이 문서에서는 Azure 명령줄 인터페이스와 서비스 관리 명령을 사용하여 CoreOS VM을 만드는 방법을 보여줍니다. Azure 리소스 관리자에서 CoreOS를 시작하려면 이 [빠른 시작 템플릿](https://azure.microsoft.com/documentation/templates/coreos-with-fleet-multivm/)을 사용해 보세요.
