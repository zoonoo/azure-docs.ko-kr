...
- [리소스 그룹 개요](../resource-group-overview)
- [Azure CLI을 사용하여 템플릿 배포](virtual-machines-deploy-rmtemplates-azure-cli)
- [Azure PowerShell을 사용하여 템플릿 배포](virtual-machines-deploy-rmtemplates-powershell)
