...
CLI에서 Azure 명령줄 인터페이스를 사용합니다. npm, Docker 컨테이너 또는 설치 스크립트를 통해 [Azure CLI를 설치하는 방법](../xplat-cli-install.md)에 대해 자세히 참고할 수 있습니다. 다음 자습서에서는 Azure CLI를 사용하는 방법에 대한 예제를 제공합니다.
