...
링크:[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] [Resource Manager model](virtual-machines-extensions-customscript.md).
...
Azure 리소스 관리자 템플릿으로 사용자 지정 스크립트 확장을 사용하는 방법에 대한 자세한 내용은 설명서 [여기](virtual-machines-extensions-customscript.md)를 참조하세요.
