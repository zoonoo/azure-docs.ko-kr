...
- [Azure CLI 2.0(미리 보기)](virtual-machines-linux-creation-choices.md) - 리소스 관리 배포 모델용 차세대 CLI
...
* [Azure 템플릿을 사용하여 안전한 Linux VM 만들기](virtual-machines-linux-create-ssh-secured-vm-from-template.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
  ...
  * 다음 예제에서는 GitHub에 저장된 템플릿을 사용하여 VM을 만듭니다.
    ...
    ```
* [Azure CLI를 사용하여 완전한 Linux 환경 만들기](virtual-machines-linux-create-cli-complete-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
...
* [사용자 지정 디스크 이미지에서 Linux VM 업로드 및 만들기](virtual-machines-linux-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
