---
title: 가용성 집합 개요
description: Azure의 가용성 집합에 대 한 자세한 정보
author: mimckitt
ms.author: mimckitt
...
## <a name="how-do-availability-sets-work"></a>가용성 집합은 어떻게 작동 하나요?
...
장애 도메인은 공통 전원과 네트워크 스위치를 공유하는 가상 머신 그룹을 정의합니다. 기본적으로 가용성 집합 내에서 구성 된 가상 머신은 리소스 관리자 배포에 대 한 최대 3 개의 장애 도메인에 걸쳐 분리 되어 있습니다. 가상 머신을 가용성 집합에 배치한다고 해서 애플리케이션이 운영 체제 또는 애플리케이션 고유의 오류로부터 보호되는 것은 아닙니다. 잠재적인 물리적 하드웨어 오류, 네트워크 중단, 전력 차단의 영향이 제한될 뿐입니다.
