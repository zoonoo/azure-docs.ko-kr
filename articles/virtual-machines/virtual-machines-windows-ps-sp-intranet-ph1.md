...
Azure 인프라 서비스의 SQL Server AlwaysOn 가용성 그룹을 사용하여 인트라넷 전용 SharePoint 2013 팜을 배포하는 이 단계에서는 Azure 서비스 관리에서 Azure 네트워킹 및 저장소 인프라를 구축합니다. [2단계](virtual-machines-windows-ps-sp-intranet-ph2.md)로 진행하기 전에 이 단계를 완료해야 합니다. 전체 단계를 보려면 [Azure에서 SQL Server AlwaysOn 가용성 그룹을 사용하여 SharePoint 배포](virtual-machines-windows-sp-intranet-overview.md)를 참조하세요.
...
- [2단계](virtual-machines-windows-ps-sp-intranet-ph2.md)를 사용하여 이 워크로드의 구성을 계속합니다.
