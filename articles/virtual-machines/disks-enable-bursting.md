...
주문형 버스트 cmdlet은 2.19.0 이상 버전의 [Azure CLI 모듈](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latest)에서 사용할 수 있습니다. 또는 [Azure Cloud Shell](https://shell.azure.com/)를 사용할 수 있습니다.
