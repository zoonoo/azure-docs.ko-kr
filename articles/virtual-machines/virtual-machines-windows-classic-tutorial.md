...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] [리소스 관리자 배포 모델을 사용하여 이러한 단계를 수행](virtual-machines-windows-hero-tutorial.md)하는 방법을 알아봅니다.
