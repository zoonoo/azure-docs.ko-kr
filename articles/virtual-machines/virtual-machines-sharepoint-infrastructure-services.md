...
리소스 관리자 배포 모델로 유사한 구성을 만들려면 템플릿을 사용합니다. [3개의 서버 SharePoint 팜 배포](virtual-machines-workload-template-sharepoint.md#deploy-a-three-server-sharepoint-farm)를 참조하세요.
...
리소스 관리자 가상 컴퓨터로 유사한 구성을 만들려면 템플릿을 사용합니다. [9개의 서버 SharePoint 팜 배포](virtual-machines-workload-template-sharepoint.md#deploy-a-nine-server-sharepoint-farm)를 참조하세요.
