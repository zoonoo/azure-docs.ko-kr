<properties 
	...
	description="Azure 인프라 서비스에서 개발/테스트 또는 프로덕션 SharePoint 2013 팜을 설정하는 방법을 설명하는 주요 항목을 알아봅니다." 
	documentationCenter="" 
...
## 항상 사용 가능한 인트라넷 SharePoint 프로덕션 팜

[Azure에서 SQL Server AlwaysOn 가용성 그룹이 있는 SharePoint 2013 배포](https://msdn.microsoft.com/library/dn275959.aspx)를 통해 Azure에서 프로덕션을 지원하는 항상 사용 가능한 인트라넷 SharePoint Server 2013 팜을 구축할 수 있습니다.
