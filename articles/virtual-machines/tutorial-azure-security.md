---
title: 자습서 - Azure에서 VM용 Azure Security Center 사용
description: 이 자습서에서는 Azure에서 가상 머신을 보호하고 안전하게 하는 데 유용한 Azure Security Center 기능에 대해 알아봅니다.
author: cynthn
manager: gwallace
...
ms.locfileid: "94594827"
---
# <a name="tutorial-use-azure-security-center-to-monitor-virtual-machines"></a>자습서: Azure Security Center를 사용하여 가상 머신 모니터링
...
> [Jenkins, GitHub 및 Docker를 사용하여 CI/CD 인프라 만들기](/azure/developer/jenkins/pipeline-with-github-and-docker)