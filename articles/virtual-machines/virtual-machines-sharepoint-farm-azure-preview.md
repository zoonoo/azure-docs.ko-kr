...
1. [Microsoft Azure 미리 보기 포털](https://portal.azure.com/)에서 **새로 만들기** > **컴퓨터** > **SharePoint 서버 팜**을 클릭합니다. **SharePoint 서버 팜의**이 보이지 않으면 **새로 만들기** > **계산** > **Azure 마켓플레이스**를 클릭하고 **SharePoint**를 **모든 항목 검색**에 입력한 다음 **SharePoint 서버 팜**을 클릭합니다. 
...
SharePoint 서버 팜은 Azure 리소스 관리자 및 스크립트를 사용하여 SharePoint 팜의 인프라 및 서버 구성을 자동으로 만듭니다. 자세한 내용은 [리소스 관리자에서 Windows PowerShell 사용](../powershell-azure-resource-manager.md)을 참조하세요.
