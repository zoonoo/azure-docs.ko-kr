...
- 근접 배치 그룹 공동 배치 상태는 포털, CLI 및 PowerShell을 사용 하 여 볼 수 있습니다.
    ...
    -   CLI를 사용 하는 경우 `az ppg show` 선택적 매개 변수 '--include-i n e t-상태 '를 포함 하 여를 사용 하 여 공동 배치 상태를 가져올 수 있습니다.
...
- 대기 시간이 가장 짧은 경우 근접 배치 그룹을 가속 네트워킹과 함께 사용 합니다. 자세한 내용은 [가속화 된 네트워킹을 사용 하 여 Linux 가상 머신 만들기](../virtual-network/create-vm-accelerated-networking-cli.md) 또는 [가속화 된 네트워킹을 사용 하 여 Windows 가상 머신](../virtual-network/create-vm-accelerated-networking-powershell.md)만들기를 참조 하세요.
...
[Azure CLI](./linux/proximity-placement-groups.md) 또는 [PowerShell](./windows/proximity-placement-groups.md) 을 사용 하 여 근접 배치 그룹에 VM 배포
...
[SAP 응용 프로그램에서 근접 배치 그룹을 사용](./workloads/sap/sap-proximity-placement-scenarios.md)하는 방법에 대해 알아봅니다.