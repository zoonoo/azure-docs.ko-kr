...
이 문서에서는 Azure CLI 2.0 및 Azure Resource Manager 배포 모델을 사용하여 Linux를 실행하는 Azure VM(Virtual Machine)의 복사본을 만드는 방법에 대해 설명합니다. [Azure CLI 1.0](virtual-machines-linux-copy-vm-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)에서 이러한 단계를 수행할 수도 있습니다.

[VHD에서 VM을 업로드하고 만들](virtual-machines-linux-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)수도 있습니다.
