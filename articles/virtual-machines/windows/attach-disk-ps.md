...
가용성 영역에서 디스크를 만들려면 [ 매개 변수와 함께 ](https://docs.microsoft.com/powershell/module/az.compute/new-azdiskconfig)New-AzDiskConfig`-Zone`를 사용합니다. 다음 예제에서는 영역 *1*에서 디스크를 만듭니다.
