...
이 문서에서는 최신 버전으로 지속적으로 업데이트 되는 [Azure Cloud Shell](https://docs.microsoft.com/azure/cloud-shell/overview)내에서 PowerShell을 사용 합니다. Cloud Shell 열려면 코드 블록의 맨 위에서 **시도** 를 선택 합니다.
