...
> [!IMPORTANT]
> Azure에 VHD를 업로드하기 전에 Sysprep을 처음으로 실행하는 경우 Sysprep을 실행하기 전에 [VM을 준비](prepare-for-upload-vhd-image.md)해야 합니다. 
> 
> 
...
* VM이 온-프레미스에 있는 경우 이제 [Azure에 VHD를 업로드](upload-image.md)할 수 있습니다.
* VM이 Azure에 이미 있는 경우 이제 [일반화된 VM에서 이미지를 만들](capture-image.md) 수 있습니다.
