...
[Azure VM(Virtual Machine)](overview.md)에 몇 가지 지원 Azure 리소스가 필요합니다. 이 문서에서는 Python을 사용하여 VM 리소스 만들기, 관리 및 삭제에 대해 설명합니다. 다음 방법을 알아봅니다.
...
가상 머신에도 VHD로 저장되는 [데이터 디스크](../managed-disks-overview.md)가 하나 이상 있을 수 있습니다.
