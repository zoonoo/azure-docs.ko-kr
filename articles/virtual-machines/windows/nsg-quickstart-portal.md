...
고가용성 웹 응용 프로그램의 경우 VM을 Azure 부하 분산 장치 뒤에 배치하는 것이 좋습니다. 부하 분산 장치는 트래픽 필터링을 제공하는 네트워크 보안 그룹으로 트래픽을 VM에 분산합니다. 자세한 내용은 [Azure에서 Windows 가상 머신의 부하를 분산하여 고가용성 응용 프로그램 만들기](tutorial-load-balancer.md)를 참조하세요.
