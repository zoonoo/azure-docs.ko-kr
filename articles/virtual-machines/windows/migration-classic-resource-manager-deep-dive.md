...
* [Resource Manager 마이그레이션에 대한 VPN Gateway 클래식](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-classic-resource-manager-migration)
