...
- (CLI/PowerShell에만 해당) 서버 쪽 암호화 및 고객이 관리 하는 키를 사용 하 여 암호화 된 스냅숏을 만듭니다.
- 서버 쪽 암호화 및 고객이 관리 하는 키를 사용 하 여 암호화 된 가상 머신 확장 집합을 만듭니다.
- 크기 2080의 ["Soft" 및 "hard" RSA 키](../../key-vault/about-keys-secrets-and-certificates.md#keys-and-key-types) 가 지원 됩니다.
