...
Chef Server는 관리 지점이며, 호스트 솔루션과 온-프레미스 솔루션의 두 가지 옵션이 있습니다. 이 자습서에서는 호스트되는 솔루션을 사용합니다.
...
이제 ChefDK(Chef Development Kit)를 [다운로드 및 설치](http://downloads.getchef.com/chef-dk/windows)하여 Chef Workstation을 설정합니다.
