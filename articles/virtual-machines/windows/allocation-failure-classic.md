---
title: 클래식 배포 모델의 Azure Windows VM 할당 오류 문제 해결 | Microsoft Docs
description: Azure에서 클래식 Windows VM을 만들거나 다시 시작하거나 크기를 조정할 때의 할당 오류 문제 해결입니다.
