# 개요
## [가상 머신 정보](../../virtual-machines-windows-about.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)
## [FAQ](faq-classic.md)

# 시작하기
## [Azure Portal을 사용하여 VM 만들기](tutorial-classic.md)
## [VM에 로그온](connect-logon-classic.md)
...
### [VM을 VNet 또는 클라우드 서비스와 연결](connect-vms-classic.md)

## 배포
### [사용자 지정 VM 만들기](createportal-classic.md)
### [Windows VM 캡처](capture-image-classic.md)
...
### [가용성 집합 구성](configure-availability-classic.md)
### [클래식 배포 모델에서 만든 Windows VM 크기 조정](resize-vm-classic.md)
...
#### [Marketplace 이미지를 사용하여 헤드 노드 만들기](../../virtual-machines-windows-hpcpack-cluster-headnode.md)
