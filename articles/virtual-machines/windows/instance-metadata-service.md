...
버전 2019-11-01은 현재 배포 되어 있으며 일부 지역에서 사용 하지 못할 수 있습니다.
...
인스턴스 | [인스턴스 API](#instance-api) 참조 | 2017-04-02
...
서명에 사용 되는 인증서와 관련 하 여 알려진 문제가 있습니다. 인증서는 공용 클라우드와 정확히 일치 `metadata.azure.com` 하지 않을 수 있습니다. 따라서 인증 유효성 검사는 하위 `.metadata.azure.com` 도메인의 일반 이름을 허용 해야 합니다.
...
- [Scheduled Events](scheduled-events.md) 에 대 한 자세한 정보
