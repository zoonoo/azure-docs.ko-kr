...
[Portal](spot-portal.md), [CLI](../linux/spot-cli.md), [ARM 템플릿](../linux/spot-template.md)또는 [PowerShell](spot-powershell.md) 을 사용 하 여 스폿 vm을 배포 합니다.
