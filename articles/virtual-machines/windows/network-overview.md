...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-multinic-arm-ps.md) | **-PublicIpAddressId** 매개 변수와 함께 [New-AzureRmNetworkInterface](/powershell/module/azurerm.network/new-azurermnetworkinterface)를 사용하여 이전에 만든 공용 IP 주소의 식별자를 제공합니다. |
...
| [Azure PowerShell](../../virtual-network/virtual-network-deploy-static-pip-arm-ps.md) | Dynamic 또는 Static인 **-AllocationMethod** 매개 변수와 함께 [New-AzureRmPublicIpAddress](/powershell/module/azurerm.network/new-azurermpublicipaddress)를 사용합니다. |
...
| [Azure PowerShell](../virtual-machines-windows-ps-create.md) | [Add-AzureRmVMNetworkInterface](/powershell/module/azurerm.compute/add-azurermvmnetworkinterface)를 사용하여 이전에 만든 NIC를 VM 구성에 추가합니다. |
