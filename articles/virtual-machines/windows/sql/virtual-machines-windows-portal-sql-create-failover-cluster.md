...
1. [장애 조치(Failover) 클러스터링 기능을 각 가상 컴퓨터에 추가합니다](virtual-machines-windows-portal-sql-availability-group-prereq.md#add-failover-cluster-features-to-both-sql-servers).
