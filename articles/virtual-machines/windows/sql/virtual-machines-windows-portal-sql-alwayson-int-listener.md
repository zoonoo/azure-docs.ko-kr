...
> [!NOTE]
> 지정한 포트가 두 SQL Server 인스턴스의 방화벽에서 열려 있는지 확인합니다. 두 인스턴스 모두 사용하는 TCP 포트에 대한 인바운드 규칙이 필요합니다. 자세한 내용은 [방화벽 규칙 추가 또는 편집](http://technet.microsoft.com/library/cc753558.aspx)을 참조하세요. 
> 
> 
