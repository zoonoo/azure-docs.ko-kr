---
title: "SQL Server 가상 컴퓨터의 자동화된 백업(리소스 관리자) | Microsoft Docs"
...
---
# <a name="automated-backup-for-sql-server-in-azure-virtual-machines-resource-manager"></a>Azure 가상 컴퓨터에서 SQL Server의 자동화된 백업(리소스 관리자)
