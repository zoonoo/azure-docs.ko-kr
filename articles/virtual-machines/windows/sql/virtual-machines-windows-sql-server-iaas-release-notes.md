...
| 변경 | 세부 정보 |
| --- | --- |
| **지원 Azure Government** | 이제 [Azure Government](https://azure.microsoft.com/global-infrastructure/government/) 클라우드에서 호스트 되는 가상 컴퓨터에 대 한 SQL VM 리소스 공급자를 사용 하 여 SQL Server 가상 컴퓨터를 등록할 수 있습니다. | 
| &nbsp; | &nbsp; |
