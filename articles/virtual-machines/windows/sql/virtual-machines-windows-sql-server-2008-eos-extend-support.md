...
- **SQL Server 백업**: Azure Backup를 사용 하 여, 15 분 RPO 및 지정 시간 복구를 통해 RPO SQL Server 2008 및 2008 r 2를 랜 섬 웨어, 실수로 삭제 및 손상 으로부터 보호 합니다. 자세한 내용은 [이 문서](https://docs.microsoft.com/azure/backup/sql-support-matrix#scenario-support)를 참조 하세요.
...
* [확장 된](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & [보안 업데이트](/sql/sql-server/end-of-support/sql-server-extended-security-updates) 지원 종료