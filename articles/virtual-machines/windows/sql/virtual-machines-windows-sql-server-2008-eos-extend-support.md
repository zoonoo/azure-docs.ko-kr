...
- **SQL Server 백업을**: 랜 섬 웨어, 실수로 삭제 되거나 손상 되지 않도록 EOS SQL Server를 보호 하기 위해 Azure Backup을 사용 합니다. 솔루션은 현재 EOS SQL Server에 대 한 미리 보기 및 SQL Server 2008 및 2008 R2 지원 Windows 2008 R2 SP1을 실행 합니다. 자세한 내용은이 참조 [문서](https://docs.microsoft.com/azure/backup/backup-azure-sql-database#support-for-sql-server-2008-and-sql-server-2008-r2)
