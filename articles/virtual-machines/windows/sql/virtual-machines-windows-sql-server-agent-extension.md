---
title: "SQL Server VM에 대한 SQL Server 에이전트 확장(리소스 관리자) | Microsoft Docs"
...
---
# <a name="sql-server-agent-extension-for-sql-server-vms-resource-manager"></a>SQL Server VM에 대한 SQL Server 에이전트 확장(리소스 관리자)
