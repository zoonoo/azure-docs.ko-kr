...
1. **테스트 선택**에서 **저장소** 및 **스토리지 공간 다이렉트**제외한 모든 테스트를 포함 합니다. 다음 그림을 참조하세요.
   ...
   :::image type="content" source="media/virtual-machines-windows-portal-sql-create-failover-cluster-premium-file-share/cluster-validation.png" alt-text="클러스터 유효성 검사 테스트":::
