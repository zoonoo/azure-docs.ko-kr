...
이 문서는 2019년 2월 21일에 [Az PowerShell 모듈](https://docs.microsoft.com/powershell/azure/install-az-ps) 버전 1.3.0 및 [Packer](https://www.packer.io/docs/install/index.html) 버전 1.3.4를 사용하여 마지막으로 테스트되었습니다.
