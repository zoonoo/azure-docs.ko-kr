---
title: 팩을 사용 하 여 Windows VM 이미지를 만드는 방법
...
| *client_secret*                     | 다음을 사용 하 여 자동 생성 된 암호 보기`$plainPassword` |
