---
title: Azure Windows VM 크기-계산에 최적화 됨
description: Azure의 Windows 가상 머신에 사용할 수 있는 다양한 컴퓨팅 최적화 크기를 나열합니다. 이 시리즈의 크기에 대한 스토리지 처리량 및 네트워크 대역폭뿐만 아니라 vCPU, 데이터 디스크 및 NIC의 수에 대한 정보를 제공합니다.
