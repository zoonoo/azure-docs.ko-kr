---
title: Windows VM에 배포된 Azure Resource Manager에서 저장소 리소스 삭제 오류 문제 해결 | Microsoft Docs
...
Azure VM에 사용되는 VHD는 Azure의 표준 또는 프리미엄 저장소 계정에 페이지 Blob으로 저장되는 .vhd 파일입니다. Azure 디스크에 대한 자세한 내용은 [Microsoft Azure Windows VM을 위한 비관리 및 관리 디스크 저장소](about-disks-and-vhds.md)를 참조하세요. 
