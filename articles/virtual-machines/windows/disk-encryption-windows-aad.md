...
- **Resource Manager 템플릿으로 암호화를 사용하지 않도록 설정:** 
    ...
    1. **실행중인 Windows VM에서 디스크 암호화 사용 안 함** 템플릿에서 [Azure에 배포](https://github.com/Azure/azure-quickstart-templates/tree/master/201-decrypt-running-windows-vm)를 클릭합니다.
