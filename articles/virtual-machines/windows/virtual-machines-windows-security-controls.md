...
| 보안 제어 | 예/아니요 | 메모|
|---|---|--|
| Azure 모니터링 지원(로그 분석, 앱 인사이트 등)| yes | [Azure 에서 Windows 가상 컴퓨터를 모니터링하고 업데이트합니다.](tutorial-monitoring.md) |
...
| 보안 제어 | 예/아니요 | 메모 |
|---|---|--|
| 미사용 서버 측 암호화: Microsoft에서 관리하는 키 | yes | [Windows VM의 가상 디스크 암호화를](/azure/virtual-machines/windows/encrypt-disks)참조하십시오. |
