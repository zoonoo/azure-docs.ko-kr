...
Azure DevOps Services를 사용하면 온-프레미스 코드 관리 솔루션을 유지 관리하지 않고도 손쉽게 협업하고 개발할 수 있습니다. Azure DevOps Services는 클라우드 코드 테스트, 빌드 및 애플리케이션 정보를 제공합니다. 코드 개발에 가장 적합한 버전 제어 리포지토리 및 IDE를 선택할 수 있습니다. 이 자습서에서는 체험 조직을 사용하여 기본 ASP.NET 웹앱 및 CI/CD 파이프라인을 만들 수 있습니다. Azure DevOps Services 조직이 아직 없으면 [조직을 만듭니다](http://go.microsoft.com/fwlink/?LinkId=307137).
