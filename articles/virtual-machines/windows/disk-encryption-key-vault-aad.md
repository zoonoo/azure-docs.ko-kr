...
### <a name="create-a-key-vault-with-powershell"></a>PowerShell을 사용 하 여 주요 자격 증명 모음 만들기
...
### <a name="create-a-key-vault-with-azure-cli"></a>Azure CLI를 사용 하 여 주요 자격 증명 모음 만들기
...
### <a name="create-a-key-vault-with-a-resource-manager-template"></a>리소스 관리자 템플릿을 사용 하 여 주요 자격 증명 모음 만들기
...
## <a name="set-up-an-azure-ad-app-and-service-principal"></a>Azure AD 앱 및 서비스 주체 설정 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-powershell"></a>Azure PowerShell를 사용 하 여 Azure AD 앱 및 서비스 주체 설정 
...
### <a name="set-up-an-azure-ad-app-and-service-principal-with-azure-cli"></a>Azure CLI를 사용 하 여 Azure AD 앱 및 서비스 주체 설정
...
### <a name="set-up-an-azure-ad-app-and-service-principal-though-the-azure-portal"></a>Azure Portal를 통해 Azure AD 앱 및 서비스 주체를 설정 합니다.
...
## <a name="set-the-key-vault-access-policy-for-the-azure-ad-app"></a>Azure AD 앱에 대 한 키 자격 증명 모음 액세스 정책 설정
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-powershell"></a>Azure PowerShell를 사용 하 여 Azure AD 앱에 대 한 키 자격 증명 모음 액세스 정책 설정
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-azure-cli"></a>Azure CLI를 사용 하 여 Azure AD 앱에 대 한 키 자격 증명 모음 액세스 정책 설정
...
### <a name="set-the-key-vault-access-policy-for-the-azure-ad-app-with-the-portal"></a>포털을 사용 하 여 Azure AD 앱에 대 한 키 자격 증명 모음 액세스 정책 설정
...
### <a name="set-key-vault-advanced-access-policies-with-azure-powershell"></a>Azure PowerShell를 사용 하 여 key vault 고급 액세스 정책 설정
...
### <a name="set-key-vault-advanced-access-policies-using-the-azure-cli"></a>Azure CLI를 사용 하 여 key vault 고급 액세스 정책 설정
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a>Azure Portal를 통해 주요 자격 증명 모음 고급 액세스 정책 설정
...
### <a name="set-up-a-key-encryption-key-with-azure-powershell"></a>Azure PowerShell를 사용 하 여 키 암호화 키 설정 
