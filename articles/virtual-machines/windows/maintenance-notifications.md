...
- 유지 관리를 다시 부팅해야 하는 경우 유지 관리가 계획된 시기에 대해 알림을 받을 수 있습니다. 이러한 경우에는 사용자에 게 유지 관리를 직접 시작할 수 있는 30 일의 기간을 제공 합니다.
...
- 알림과 동시에 *셀프 서비스 기간*이 제공됩니다. 일반적으로 30 일 동안이 작업을 수행 하는 동안이 웨이브에 포함 된 가상 컴퓨터를 확인 하 고 예약 요구 사항에 따라 사전에 유지 관리를 시작할 수 있습니다.
