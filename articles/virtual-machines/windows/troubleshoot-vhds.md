---
title: Azure Windows 가상 머신에서 연결된 VHD 문제 해결 | Microsoft Docs
description: Windows VM이 예기치 않게 다시 부팅되거나 연결된 VHD가 포함된 저장소 계정을 삭제하는 등의 문제를 해결하는 방법입니다.
...
ms.locfileid: "30289932"
---
# <a name="troubleshoot-attached-vhds-on-azure-windows-virtual-machines"></a>Azure Windows 가상 머신에서 연결된 VHD 문제 해결
