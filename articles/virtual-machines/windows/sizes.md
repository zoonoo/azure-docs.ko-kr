...
| [Storage에 최적화](../virtual-machines-windows-sizes-storage.md)        | Lsv2, Ls                | 빅 데이터, SQL, NoSQL 데이터베이스, 데이터 웨어하우징, 대형 트랜잭션 데이터베이스에 이상적인 높은 디스크 처리량과 IO.  |
