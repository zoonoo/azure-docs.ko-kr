...
<sup>1</sup> Mv2 시리즈는 1 세대 VM 이미지를 지원 하지 않으며 2 세대 이미지의 하위 집합만 지원 합니다. 자세한 내용은 [Mv2 시리즈 설명서](https://docs.microsoft.com/azure/virtual-machines/mv2-series) 를 참조 하세요.
...
> [!NOTE]
> Mv2 시리즈와 같은 특정 가상 머신 크기는 이러한 이미지의 하위 집합만 지원할 수 있습니다. 자세한 내용은 관련 가상 머신 크기 설명서를 참조 하세요.
