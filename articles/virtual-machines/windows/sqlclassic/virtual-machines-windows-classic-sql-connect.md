...
예를 들어 이름이 **mysqlvm**, DNS 이름이 **mysqlvm7777.cloudapp.net**이고 VM 끝점이 **57500**인 클래식 가상 머신을 고려해보세요. 올바르게 구성된 연결이라고 가정할 경우 다음 연결 문자열을 사용하여 인터넷의 어디에서든지 가상 머신에 액세스할 수 있습니다.
...
* [가상 머신에 대한 TCP 끝점 만들기](#create-a-tcp-endpoint-for-the-virtual-machine)
