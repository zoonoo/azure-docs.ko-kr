---
title: "Azure에서 Windows VM에 대한 계획된 유지 관리 | Microsoft Docs"
...
---
# <a name="planned-maintenance-for-windows-virtual-machines"></a>Windows 가상 컴퓨터에 대한 계획된 유지 관리 
...
이 페이지에서는 Microsoft Azure에서 계획된 유지 관리를 수행하는 방법을 설명합니다. 계획되지 않은 이벤트(중단)에 대한 자세한 내용은 [가상 컴퓨터의 가용성 관리](manage-availability.md)를 참조하세요.
