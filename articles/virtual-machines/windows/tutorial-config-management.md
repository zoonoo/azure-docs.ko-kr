---
title: 자습서 - Azure에서 Windows 가상 머신 구성 관리 | Microsoft Docs
...
Azure [변경 추적](../../automation/change-tracking.md)을 사용하면 변경 내용을 쉽게 식별할 수 있으며 [업데이트 관리](../../automation/automation-update-management.md)를 사용하면 Azure Windows VM의 운영 체제 업데이트를 관리할 수 있습니다.
