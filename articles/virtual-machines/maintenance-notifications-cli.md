...
CLI를 사용하여 [유지 관리](maintenance-notifications.md)를 위해 VM이 예약되는 시기를 확인할 수 있습니다. 계획된 유지 관리 정보는 [az vm get-instance-view](/cli/azure/vm#az-vm-get-instance-view)에서 제공됩니다.
