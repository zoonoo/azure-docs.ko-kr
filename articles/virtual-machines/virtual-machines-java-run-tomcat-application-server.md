...
4. **다음**을 클릭합니다.
5. <strong>가상 컴퓨터 구성</strong> 대화 상자에서 다음을 수행합니다.
    1. 가상 컴퓨터의 이름을 지정합니다.
...
7. <strong>새 끝점 세부 정보</strong> 대화 상자에서 다음을 수행합니다.
...
6. **규칙 유형**의 경우 **포트**를 선택한 후 **다음**을 클릭합니다.

 ![새 인바운드 규칙 포트][NewRulePort]

7. **프로토콜 및 포트** 화면에서 **TCP**를 선택하고 **특정 로컬 포트**를 **8080**으로 지정한 후 **다음**을 클릭합니다.

 ![새 인바운드 규칙][NewRuleProtocol]

8. **작업** 화면에서 **연결 허용**을 선택한 후 **다음**을 클릭합니다.

 ![새 인바운드 규칙 동작][NewRuleAction]

9. **프로필** 화면에서 **도메인**, **개인** 및 **공용**이 선택되어 있는지 확인한 후 **다음**을 클릭합니다.

 ![새 인바운드 규칙 프로필][NewRuleProfile]

10. **이름** 화면에서 규칙의 이름(예: **HttpIn**)(규칙 이름이 끝점 이름과 일치할 필요는 없음)을 지정한 후 **마침**을 클릭합니다.  
