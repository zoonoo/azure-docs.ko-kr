...
---
# <a name="provision-a-sql-server-virtual-machine-in-the-azure-portal"></a>Azure 포털에서 SQL Server 가상 컴퓨터 프로비전
...
> [!NOTE]
> 네트워크 통신에 대한 추가 제한을 SQL Server VM에 추가할 수 있습니다. 이 작업은 VM이 만들어진 후에 네트워크 보안 그룹을 편집하여 수행할 수 있습니다. 자세한 내용은 [NSG(네트워크 보안 그룹)란?](../virtual-network/virtual-networks-nsg.md)
> 
> 
...
**포트** 기본값은 1433입니다. 다른 포트 번호를 지정할 수 있습니다.
자세한 내용은 [SQL Server Virtual Machine에 연결(Resource Manager) | Microsoft Azure](virtual-machines-windows-sql-connect.md)를 참조하세요.
...
6. **사용자 이름**에 **\<user name>**을 입력합니다. 여기서 <user name>은(는) VM을 구성할 때 지정한 사용자 이름입니다. 이름 앞에 초기 백슬래시를 추가해야 합니다.
7. 이전에 구성한 이 VM의 **암호**를 입력한 다음 **확인**을 클릭하여 연결합니다.
8. 다른 **원격 데스크톱 연결** 대화 상자가 연결 여부를 물어보면 **예**를 클릭합니다.
