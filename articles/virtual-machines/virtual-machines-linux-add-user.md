...
---
# <a name="add-a-user-to-an-azure-vm"></a>Azure VM에 사용자 추가
...
필수 구성 요소는 [Azure 계정](https://azure.microsoft.com/pricing/free-trial/), [SSH 공개 및 개인 키](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json), Azure 리소스 그룹, 설치되고 `azure config mode arm`을 사용하여 Azure Resource Manager 모드로 전환된 Azure CLI입니다.
...
### <a name="adding-a-single-sudo-user-to-an-azure-vm"></a>Azure VM에 단일 sudo 사용자 추가
...
### <a name="add-your-ssh-public-key-to-the-new-user-account"></a>새 사용자 계정에 SSH 공개 키 추가
...
### <a name="using-visudo-to-allow-sudo-usage-without-a-password"></a>visudo를 사용하여 암호 없이 sudo를 사용하도록 허용
...
### <a name="verify-the-user-ssh-keys-and-sudo"></a>사용자, ssh 키 및 sudo 확인
```bash
# Verify the SSH keys & User account
