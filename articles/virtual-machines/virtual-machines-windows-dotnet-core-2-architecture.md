...
![가상 컴퓨터](./media/virtual-machines-windows-dotnet-core/vm-win.png)
...
![저장소 계정](./media/virtual-machines-windows-dotnet-core/storacct-win.png)

Storage 계정 blob 컨테이너를 클릭하면 템플릿을 통해 배포된 각 가상 컴퓨터의 가상 하드 드라이버 파일을 볼 수 있습니다.

![가상 하드 드라이브](./media/virtual-machines-windows-dotnet-core/vhd-win.png)
...
![가상 네트워크](./media/virtual-machines-windows-dotnet-core/vnet-win.png)
...
![네트워크 인터페이스](./media/virtual-machines-windows-dotnet-core/nic-win.png)
