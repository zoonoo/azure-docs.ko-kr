...
시작하기 전에 Premium Storage를 처음 사용하는 경우 먼저 [IaaS VM에 대한 Azure 디스크 유형 선택](./linux/disks-types.md) 및 [프리미엄 페이지 Blob 스토리지 계정의 확장성 목표](~/articles/storage/blobs/scalability-targets-premium-page-blobs.md)를 읽어보세요.
