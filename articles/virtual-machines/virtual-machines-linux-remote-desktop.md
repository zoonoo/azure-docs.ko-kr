<properties
	pageTitle="원격 데스크톱을 사용하여 Microsoft Azure Linux VM 연결"
...
#원격 데스크톱을 사용하여 Microsoft Azure Linux VM 연결

##개요

RDP(원격 데스크톱 프로토콜)는 Windows에 사용되는 독점 프로토콜인데, 어떻게 RDP를 사용하여 Linux VM(가상 컴퓨터)을 원격으로 연결할 수 있을까요?
