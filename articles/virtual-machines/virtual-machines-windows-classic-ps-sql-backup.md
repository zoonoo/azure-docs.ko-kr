...
![Azure 포털에서 SQL 자동 백업 구성](./media/virtual-machines-windows-classic-ps-sql-backup/IC778483.jpg)
...
![Azure 포털에서 자동화된 백업 구성](./media/virtual-machines-windows-classic-ps-sql-backup/IC792133.jpg)
...
Azure VM의 SQL Server에 대한 추가적인 백업 및 복원 지침은 [Azure 가상 컴퓨터의 SQL Server 백업 및 복원](virtual-machines-windows-classic-sql-br.md) 항목을 참조하세요.

Azure에서 SQL Server VM 관련 기능은 [Azure 가상 컴퓨터의 SQL Server에 대한 자동화된 패치](virtual-machines-windows-classic-ps-sql-patch.md)입니다.

그 밖에 [Azure 가상 컴퓨터에서 SQL Server 실행과 관련된 리소스](virtual-machines-windows-classic-sql-overview.md)를 검토합니다.
