...
2.	오른쪽 위에 있는 **도구** 단추(톱니바퀴 아이콘)를 선택하고 **인터넷 옵션**을 클릭합니다. **보안** 탭을 클릭하고, **신뢰할 수 있는 사이트** 아이콘, **사이트** 단추를 차례로 클릭합니다. 신뢰할 수 있는 사이트 목록에 **http://*.mysql.com**를 추가합니다. **닫기**를 클릭한 후 **확인**을 클릭합니다. 
3.	Internet Explorer의 주소 표시줄에 **http://dev.mysql.com/downloads/mysql/**를 입력합니다. 
