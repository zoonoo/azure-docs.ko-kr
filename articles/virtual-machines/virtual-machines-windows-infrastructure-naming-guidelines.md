...
이 문서에서는 작업 환경에서 논리적이고 쉽게 식별할 수 있는 리소스 집합을 구축하기 위해 다양한 Azure 리소스 전체의 명명 규칙을 중점적으로 살펴봅니다.
...
- 리소스에서 일관된 방식으로 사용할 수 있게 접사를 정의합니다.
...
앞서 명명 규칙 집합에 동의해야 합니다. 규칙 집합에 영향을 미치는 명명 규칙과 관련한 고려 사항이 있습니다.
...
Azure VM 이름을 기본 운영 체제 컴퓨터 이름과 동일하게 하는 것이 좋습니다.
