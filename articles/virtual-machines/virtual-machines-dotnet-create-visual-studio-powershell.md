...
1. Visual Studio에서 **파일**, **새 프로젝트**, **웹** 및 **ASP.NET 웹 응용 프로그램**을 차례로 선택합니다(**Visual C#** 또는 **Visual Basic** 노드 아래).
...
3. Microsoft Azure의 드롭다운 목록 상자에서 **가상 컴퓨터**를 선택한 다음 **확인** 단추를 선택합니다.
...
6. **이미지** 목록에서 가상 컴퓨터에 기반하는 VM 이미지를 선택합니다. 표준 Azure VM 이미지 중 하나를 선택하거나 Azure에 업로드한 자체 이미지를 선택할 수 있습니다.
