...
<table>
<thead>
    <tr><th>유형</th><th>Description</th><th>다음과 같은 경우에 사용합니다.</th></tr>
</thead>
<tbody>
<tr><td>Azure Files
</td>
...
| 유형         | 크기           | IOPS                  |
|--------------|----------------|-----------------------|
| Ultra SSD    | 4gb ~ 64 TB  | 1200 ~ 16만 IOPS |
...
- [Azure Blob, Azure Files 또는 Azure 디스크를 사용할 시기 결정](https://docs.microsoft.com/azure/storage/common/storage-decide-blobs-files-disks)
