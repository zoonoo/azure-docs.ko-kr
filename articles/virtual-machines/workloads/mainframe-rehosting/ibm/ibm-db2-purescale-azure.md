...
![저장소 및 네트워킹을 보여 주는 Azure virtual machines의 DB2 pureScale](media/pureScaleArchitecture.png "저장소 및 네트워킹을 보여 주는 Azure virtual machines의 DB2 pureScale")
