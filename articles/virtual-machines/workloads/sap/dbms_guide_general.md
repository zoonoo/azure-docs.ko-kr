...
내부 부하 분산 장치를 구성 하는 방법의 예는 [자습서: Azure Virtual Machines에서 수동으로 SQL Server 가용성 그룹 구성](../../../azure-sql/virtual-machines/windows/availability-group-manually-configure-tutorial.md#create-an-azure-load-balancer) 문서에서 찾을 수 있습니다.
