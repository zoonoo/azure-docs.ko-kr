...
- **스토리지 구성 요소**: 스토리지 볼륨이 할당된 스토리지 가상 머신을 통해 격리됩니다. 저장소 볼륨은 하나의 스토리지 가상 머신에만 할당될 수 있습니다. 저장소 가상 머신은 인프라 스택에서 하나의 단일 테 넌 트에 독점적으로 할당 됩니다. 따라서 스토리지 가상 머신에 할당된 스토리지 볼륨은 관련된 특정 단일 테넌트에서만 액세스할 수 있으며, 배포된 다른 테넌트에서는 표시되지 않습니다.
