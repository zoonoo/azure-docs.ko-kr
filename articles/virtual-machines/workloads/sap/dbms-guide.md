...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>Azure Virtual Machines에서 SAP NetWeaver - DBMS 배포 가이드
...
* 타사 도구 - Azure의 백업 및 SAP에 대한 자세한 내용은 [SAP 백업 가이드](sap-hana-backup-guide.md)를 참조하세요.
...
또는 이 문서의 [소프트웨어 RAID][dbms-guide-2.2] 챕터에서 설명한 대로 LVM(논리 볼륨 관리자) 또는 MDADM을 사용하여 탑재된 여러 VHD 디스크에 하나의 큰 논리적 장치를 만들 수 있습니다.
