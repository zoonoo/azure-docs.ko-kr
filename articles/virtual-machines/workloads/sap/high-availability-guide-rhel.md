...
그리고 예제 구성, 설치 명령 등을 소개합니다. 00 ASCS 인스턴스 번호, 02 ERS 인스턴스 번호 및 NW1 SAP 시스템 ID를 사용합니다. 예제에서 리소스의 이름 (예: 가상 머신, 가상 네트워크)은 리소스 접두사 N W 1을 사용 하 여 [Ascs/SCS 템플릿을][template-multisid-xscs] 사용 하 여 리소스를 만들었다고 가정 합니다.
