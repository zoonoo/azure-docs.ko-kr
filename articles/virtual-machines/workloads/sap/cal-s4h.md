...
> [!NOTE]
계속하기 전에 Azure H 시리즈 VM에 대한 Azure 코어 할당량이 확인합니다. 현재 SAP CAL은 Azure의 H 시리즈 VM을 사용하여 일부 SAP HANA 기반 솔루션을 배포합니다. Azure 구독은 H 시리즈에 대한 H 시리즈 코어 할당량이 없을 수 있습니다. 이 경우 16 H 시리즈 코어의 할당량을 가져오도록 Azure 지원에 문의해야 합니다.
...
3. **개인 키** 대화 상자에서 **저장**을 클릭하여 SAP CAL에 개인 키를 저장합니다. 개인 키에 대해 암호 보호를 사용하려면 **다운로드**를 클릭합니다. 
...
5. 하나의 리소스 그룹에서 다른 연결된 리소스를 사용하여 수집된 가상 컴퓨터를 찾으려면 Azure Portal로 이동합니다. 
