...
이 문서 앞부분의 일반 정보에서 설명했듯이 Azure 디스크에 대한 IOPS 처리량에 할당량이 존재합니다. 정확한 할당량은 사용되는 VM 유형에 따라 달라집니다. VM 유형 [(Linux)][virtual-machines-sizes-linux] 및 [여기 (Windows)][virtual-machines-sizes-windows]는 여기에서 찾을 수 있습니다.
