...
- 05/11/2020: SLES의 [Azure vm에](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability) 대 한 고가용성의 변경으로 SAP HANA 인해 netcat 리소스에 대 한 리소스를 0으로 설정 하 여 보다 간소화 된 장애 조치 (failover)가 발생 합니다. 
...
- 04/22/2020: 클러스터를 유지 관리 모드에서 제거 하는 것과 충돌 하므로 [SLES의 Azure vm에서 SAP HANA의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability) 을 변경 하 여 `is-managed` 해당 지침에서 meta 특성을 제거 합니다.
