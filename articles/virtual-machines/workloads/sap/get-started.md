...
- 2020년 03/26: [SAP 응용 프로그램에 대한 SLES용 SLES의 Azure VM에서 SAP NetWeaver의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)변경, SAP 응용 프로그램에 [대한 Azure NetApp 파일이 있는 SLES의 Azure NetWeaver에 대한 고가용성,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files) [NFS용 고가용성 SLES의 Azure VM에서](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs) [SLES의 Azure VM, SLES 다중 SID 가이드의 Azure VM에 대한 고가용성,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-multi-sid) [SAP 응용 프로그램에 대한 RHEL의 Azure VM에서 SAP NetWeaver에 대한 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-rhel) 및 Azure를 사용 하 여 [RHEL에서 Azure VM에 대 한 SAP NetWeaver에 대 한 높은 가용성 다이어그램을](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-rhel-netapp-files) 업데이트하고 Azure 로드 밸러서 백 엔드 풀 생성에 대한 지침을 명확히 하는 SAP 응용 프로그램에 대한 NetApp 파일
...
- 03/09/2020: [SAP 응용 프로그램에 대 한 SUSE 리눅스 엔터프라이즈 서버에서 Azure VM에 Azure NetWeaver에 대](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)한 고가용성 변경, [Azure NetApp 파일이 있는 SUSE Linux 엔터프라이즈 서버에서 Azure VM에 SAP NetWeaver에 대 한 고가용성 SAP 응용 프로그램,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files) [SUSE Linux 엔터프라이즈 서버의 Azure VM에서 NFS에 대한 고가용성,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs) [Azure의 SUSE Linux 엔터프라이즈 서버에서 페이스 메이커 설정,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-pacemaker) [페이스 메이커가있는 SUSE Linux 엔터프라이즈 서버의 Azure VM에서 IBM Db2 LUW의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms-guide-ha-ibm) [SUSE Linux 엔터프라이즈 서버의 Azure VM에서 SAP HANA의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability) 및 [SLES 다중 SID 가이드에서 Azure VM의 SAP NetWeaver에 대한 고가용성으로](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-multi-sid) 리소스 에이전트 Azure-lb로 클러스터 리소스를 업데이트합니다. 
...
- 11/08/2019: [SUSE Linux 엔터프라이즈 서버의 Azure VM에서 SAP HANA의 고가용성](sap-hana-high-availability.md)변경, [Azure 가상 머신(VM)에서 SAP HANA 시스템 복제 설정,](sap-hana-high-availability-rhel.md) [Azure 가상 머신에 대한 고가용성 SAP 응용 프로그램에 대 한 SUSE 리눅스 엔터프라이즈 서버에 SAP NetWeaver,](high-availability-guide-suse.md) [Azure 가상 머신 에 SAP 넷위버 에 SAP 넷위버 용 SUSE 리눅스 엔터프라이즈 서버 Azure NetApp 파일,](high-availability-guide-suse-netapp-files.md) [Azure 가상 머신 높은 가용성 SAP 넷위버에 대 한 SAP 넷 위버 에 레드 햇 엔터프라이즈 리눅스 ](high-availability-guide-rhel.md), [Azure 가상 머신 SAP NetWeaver에 대 한 높은 가용성 레드 햇 엔터프라이즈 리눅스에 레드 햇 엔터프라이즈 리눅스에](high-availability-guide-rhel-netapp-files.md) [NFS에 대 한 고가용성, SUSE 리눅스 엔터프라이즈 서버에서 Azure VM에 NFS에 대 한 고가용성,](high-availability-guide-suse-nfs.md) [SAP NetWeaver에 대 한 Azure VM에 GlusterFS Azure 표준](high-availability-guide-rhel-glusterfs.md) 로드 밸러블러를 추천 합니다.  
...
- 10/22/2019: SAP 응용 프로그램에 대 한 [SUSE 리눅스 엔터프라이즈 서버에서 Azure VM에 Azure NetWeaver에 대](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse)한 고가용성 변경, Azure [NetApp 파일이 있는 SUSE Linux 엔터프라이즈 서버에서 Azure VM에 SAP NetWeaver에 대 한 고가용성 SAP 응용 프로그램,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-netapp-files) [SUSE Linux 엔터프라이즈 서버의 Azure VM에서 NFS에 대한 고가용성,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-nfs) [Azure의 SUSE Linux 엔터프라이즈 서버에서 페이스 메이커 설정,](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/high-availability-guide-suse-pacemaker) [페이스 메이커가있는 SUSE Linux 엔터프라이즈 서버의 Azure VM에서 IBM Db2 LUW의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/dbms-guide-ha-ibm) Azure 로드 밸러서 감지 강화를 위한 [SUSE Linux 엔터프라이즈 서버의 Azure VM에서 SAP HANA의 고가용성](https://docs.microsoft.com/azure/virtual-machines/workloads/sap/sap-hana-high-availability)
