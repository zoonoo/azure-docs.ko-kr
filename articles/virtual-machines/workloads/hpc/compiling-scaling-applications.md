...
FLANG 컴파일러는 AOCC 제품군 (4 월 2018 추가)에 대 한 최근 추가 기능으로, 현재 개발자가 다운로드 하 고 테스트할 수 있도록 시험판에 있습니다. 포트란 2008을 기반으로 하는 AMD는 GitHub 버전의 FLANGhttps://github.com/flangcompiler/flang)()를 확장 합니다. FLANG 컴파일러는 모든 Clang 컴파일러 옵션 및 추가 개수의 FLANG 관련 컴파일러 옵션을 지원 합니다.
