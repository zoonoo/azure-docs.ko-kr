...
|             |rhel-lvm76-gen2| LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 7.6 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm77| LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 7.7 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm77-gen2| LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 7.7 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm78| LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 7.8 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm78-gen2| LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 7.8 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm8 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.0 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm8-gen2 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.0 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm81 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.1 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm81-gen2 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.1 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm82 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
|             |rhel-lvm82-gen2 | LVM    | Linux 에이전트 | 업데이트 원본에 연결 되지 않은 RHEL 8.2 세대 2 BYOS 이미지는 RHEL premium을 청구 하지 않습니다.
