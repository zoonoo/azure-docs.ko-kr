...
Azure에서 가상 컴퓨터를 만드는 데 사용할 수 있도록 .vhd 파일을 업로드하려면 Azure에 저장소 계정이 있어야 합니다. Azure 관리 포털을 사용하여 저장소 계정을 만들 수 있습니다.
...
2. 이전 단계를 완료한 후 Azure 관리 포털에서 **이미지** 탭을 선택하면 새 이미지가 나열됩니다.
