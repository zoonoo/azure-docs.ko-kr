...
[Azure 필요한 상태 구성(DSC)](virtual-machines-windows-extensions-dsc-overview.md) 확장 처리기에 [가상 컴퓨터 크기 집합(VMSS)](virtual-machines-windows-vmss-powershell-creating.md)을 사용할 수 있습니다. VMSS은 부하 요구에 맞게 가상 컴퓨터의 배포를 구성하는 데 사용합니다. DSC는 VM이 온라인으로 전환되어 프로덕션 소프트웨어를 실행하도록 VM을 구성하는 데 사용합니다.
