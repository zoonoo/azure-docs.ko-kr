<properties
	pageTitle="Azure 서비스 관리에서 Azure Resource Manager로의 마이그레이션을 위한 커뮤니티 도구"
...
# Azure 서비스 관리에서 Azure Resource Manager로의 마이그레이션을 위한 커뮤니티 도구

이 문서에는 Azure 서비스 관리에서 Azure Resource Manager 스택으로의 IaaS 리소스 마이그레이션을 지원하기 위해 커뮤니티에서 제공한 도구의 카탈로그가 포함되어 있습니다.

>[AZURE.NOTE]이러한 도구는 Microsoft 지원을 통해 공식적으로 지원되지는 않습니다. 따라서 Github에 오픈 소스로 제공되며 수정 또는 추가적인 시나리오를 위한 PR을 기꺼이 받아들입니다. 문제를 보고하려면 Github의 문제 기능을 사용합니다.
>
