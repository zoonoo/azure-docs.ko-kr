...
리소스 관리자 템플릿과 Azure Preview 포털을 사용하여 이 워크로드를 배포하려면 [여기](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fsharepoint-three-vm%2Fazuredeploy.json)를 클릭하십시오.
...
**New- AzureResourceGroupDeployment** 명령을 실행하면 일련의 매개변수 값을 제공하라는 메시지가 표시됩니다. 모든 매개변수 값을 지정하면 **New-AzureResourceGroupDeployment**는 가상 컴퓨터를 만들고 구성합니다.
...
리소스 관리자 템플릿과 Azure Preview 포털을 사용하여 이 워크로드를 배포하려면 [여기](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fsharepoint-server-farm-ha%2Fazuredeploy.json)를 클릭하십시오.
