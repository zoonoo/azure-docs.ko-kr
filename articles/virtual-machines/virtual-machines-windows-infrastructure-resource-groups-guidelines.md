...
리소스 그룹의 주요 기능은 템플릿을 사용하여 사용자 환경을 구축하는 기능입니다. 템플릿은 관련된 사용자 지정 스크립트나 적용할 구성과 함께 저장소, 네트워킹 및 계산 리소스를 선언하는 JSON 파일입니다. 이러한 템플릿을 사용하여 응용 프로그램에 대해 일관되고 재현 가능한 배포를 만들 수 있습니다. 그뿐 아니라 개발 환경을 쉽게 구축한 다음 동일한 템플릿을 사용하여 프로덕션 배포를 만들 수도 있고 그 반대도 가능합니다. 템플릿 사용 방식을 더욱 잘 이해하기 위해 템플릿 작성의 각 단계를 안내하는 [템플릿 연습](../resource-manager-template-walkthrough.md)을 읽어보세요.
