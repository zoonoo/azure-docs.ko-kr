...
이 문서에서는 Azure의 필요한 상태 구성 확장을 다룹니다. DSC 확장 처리기의 개요는 [Azure 필요한 상태 구성 확장 처리기 소개](virtual-machines-windows-extensions-dsc-overview.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)에 나와 있습니다. 
