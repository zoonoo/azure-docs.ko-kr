...
- Microsoft Monitoring Agent VM 확장을 사용하여 가상 컴퓨터의 모니터링을 구성합니다. 자세한 내용은 [VM 모니터링 사용 또는 사용 안 함](virtual-machines-linux-vm-monitoring.md)을 참조하세요.
...
지원되는 운영 체제 및 설치 지침에 대한 자세한 내용은 [Azure Virtual Machines 에이전트](virtual-machines-linux-classic-agents-and-extensions.md)를 참조하세요.
...
자세한 내용은 [Linux VM 확장을 사용하여 Azure Resource Manager 템플릿 작성](virtual-machines-linux-extensions-authoring-templates.md)을 참조하세요.
...
각 VM 확장에는 확장 관련 문제 해결 단계가 있을 수 있습니다. 예를 들어 사용자 지정 스크립트 확장을 사용하는 경우 확장이 실행된 가상 컴퓨터에서 로컬로 스크립트 실행 세부 정보를 확인할 수 있습니다. 확장별 문제 해결 단계는 확장 관련 설명서에 자세히 나와 있습니다.
...
| 확장 이름 | 설명 | 자세한 정보 |
| --- | --- | --- |
| Linux용 사용자 지정 스크립트 확장 |Azure Virtual Machine에 대해 스크립트 실행 |[Linux용 사용자 지정 스크립트 확장](virtual-machines-linux-extensions-customscript.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) |
