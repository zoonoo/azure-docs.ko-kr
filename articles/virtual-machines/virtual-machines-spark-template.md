...
Spark 버전 3.0.0이 기본 버전이며, Spark 리포지토리에서 사용할 수 있는 미리 작성된 이진 파일로 변경할 수 있습니다. 스크립트에는 원본에서 빌드의 주석 처리를 제거하는 프로비전도 있습니다. 각 Spark 마스터 노드에는 고정 IP 주소 10.0.0.10이 할당됩니다. 고정 IP 주소는 템플릿 내에서 동적으로 IP 주소 목록을 작성할 수 없는 현재 제한을 해결하기 위해 각 Spark 슬레이브 노드에 할당됩니다. 기본적으로 첫 번째 노드에는 개인 IP 주소 10.0.0.30이 할당되고, 두 번째 노드에는 10.0.0.31이 할당됩니다. 배포 오류를 확인하려면 새 Azure 포털로 이동하고 **리소스 그룹** > **마지막 배포** > **작업 세부 정보 확인**을 살펴보세요.
