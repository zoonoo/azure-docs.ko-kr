<properties 
   pageTitle="온-프레미스 AlwaysOn 가용성 그룹을 Azure에 확장"
   description="이 자습서에서는 SSMS(SQL Server Management Studio)에서 복제본 추가 마법사를 사용하여 Azure에 AlwaysOn 가용성 그룹 복제본을 추가하는 방법을 설명합니다."
