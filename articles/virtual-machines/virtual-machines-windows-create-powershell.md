<properties
	pageTitle="Powershell로 VM 만들기 | Microsoft Azure"
...
자세한 내용은 [Azure PowerShell 1.0](https://azure.microsoft.com/ko-KR/blog/azps-1-0/)을 참조하세요.

## 2단계: 구독 설정

먼저, PowerShell 프롬프트를 시작합니다.
...
[리소스 관리자 템플릿 및 PowerShell을 사용하여 Azure 가상 컴퓨터 배포 및 관리](virtual-machines-windows-ps-manage.md)

[리소스 관리자 템플릿 및 PowerShell을 사용하여 Windows 가상 컴퓨터 만들기](virtual-machines-windows-ps-template.md)
