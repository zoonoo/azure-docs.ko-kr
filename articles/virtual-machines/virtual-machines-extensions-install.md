...
>[AZURE.IMPORTANT]지원하는 기능별 전체 확장 목록은 [Azure VM 확장 및 기능](virtual-machines-extensions-features.md)을 참조하세요. 각 VM 확장은 특정 기능을 지원하므로 확장에서 정확히 지원하는 기능과 지원하지 않는 기능은 확장마다 다릅니다. 따라서 VM을 수정하기 전에 사용하려는 VM 확장에 대한 설명서를 읽어야 합니다. 어떤 VM 확장은 제거가 지원되지 않으며 어떤 확장에서는 VM 동작을 근본적으로 변경하는 속성을 설정할 수 있습니다.
...
Azure VM 확장(지원하는 기능별 전체 확장 목록은 [Azure VM 확장 및 기능](virtual-machines-extensions-features.md) 참조) 다음을 통해 확장 및 확대 정보를 찾을 수 있습니다.
...
-   가상 컴퓨터 인스턴스의 경우 [리소스 확장 나열](https://msdn.microsoft.com/library/dn495441.aspx) 작업을 사용할 수 있습니다. 사용 가능한 확장의 버전을 나열하려면 [리소스 확장 버전 나열](https://msdn.microsoft.com/library/dn495440.aspx)을 사용할 수 있습니다.
...
-   가상 컴퓨터의 경우 **Get-AzureVMAvailableExtension** cmdlet을 사용할 수 있습니다.
