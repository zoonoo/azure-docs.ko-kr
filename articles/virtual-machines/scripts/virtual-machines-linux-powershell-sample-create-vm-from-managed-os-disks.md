---
title: 관리 디스크를 OS 디스크로 연결하여 VM 만들기(Linux) - PowerShell
...
ms.locfileid: "89077525"
---
# <a name="create-a-virtual-machine-using-an-existing-managed-os-disk-with-powershell-linux"></a>PowerShell과 기존 관리 OS 디스크를 사용하여 가상 머신 만들기(Linux)
