...
# <a name="create-a-fully-configured-virtual-machine"></a>완벽히 구성된 가상 컴퓨터 만들기
...
[!code-azurecli-interactive[기본](../../../cli_scripts/virtual-machine/create-vm-detailed/create-vm-detailed.sh "VM 빠른 생성")]
