---
title: "Azure에서 DSC 및 New-AzVM을 사용하여 IIS가 있는 VM 만들기 | Microsoft Docs"
description: "Azure PowerShell 스크립트 샘플 - DSC 및 New-AzVM을 사용하여 IIS VM을 만듭니다."
...
---
# <a name="create-an-iis-vm-with-powershell-using-new-azvm-preview"></a>New-AzVM을 사용하여 PowerShell에서 IIS VM 만들기(미리 보기)

이 스크립트는 New-AzVM을 사용하여 Windows Server 2016을 실행하는 Azure Virtual Machine을 만들고 Azure Virtual Machine DSC 확장을 사용하여 IIS를 설치합니다. 스크립트를 실행하면 가상 컴퓨터의 공용 IP 주소에서 기본 IIS 웹 사이트에 액세스할 수 있습니다.
