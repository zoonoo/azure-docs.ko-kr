...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension) | 가상 머신에 대한 VM 확장을 실행합니다. 이 경우에 Log Analytics 에이전트 확장은 Log Analytics 에이전트를 설치하고 Log Analytics 작업 영역에서 VM을 등록하는 데 사용됩니다. |
