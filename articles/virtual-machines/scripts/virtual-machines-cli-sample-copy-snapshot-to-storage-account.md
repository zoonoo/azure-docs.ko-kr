---
title: CLI를 사용하여 다른 지역의 스토리지 계정에 스냅샷 복사
...
[VHD에서 관리 디스크 만들기](virtual-machines-cli-sample-create-managed-disk-from-vhd.md?toc=%2fcli%2fmodule%2ftoc.json)
