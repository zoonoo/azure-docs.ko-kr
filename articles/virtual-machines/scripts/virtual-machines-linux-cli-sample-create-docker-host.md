...
| [azure vm extension set](https://docs.microsoft.com/cli/azure/vm/extension#az_vm_extension_set) | VM에 가상 컴퓨터 확장을 추가하고 실행합니다. 이 샘플에서는 Docker VM 확장을 사용하여 Docker 호스트를 구성합니다.|
