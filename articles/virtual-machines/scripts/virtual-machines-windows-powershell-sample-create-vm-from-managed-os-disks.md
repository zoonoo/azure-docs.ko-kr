...
Marketplace 이미지에는 [Set-AzureRmVMPlan](https://docs.microsoft.com/en-us/powershell/module/azurerm.compute/set-azurermvmplan?view=azurermps-6.7.0)을 사용하여 계획 정보를 설정합니다.
```powershell
