---
title: 스냅샷에서 관리 디스크 만들기(Windows) - PowerShell 샘플
...
ms.locfileid: "86500993"
---
# <a name="create-a-managed-disk-from-a-snapshot-with-powershell-windows"></a>PowerShell을 사용하여 스냅샷에서 관리 디스크 만들기(Windows)
