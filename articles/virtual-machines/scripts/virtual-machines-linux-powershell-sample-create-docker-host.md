...
| [Set-AzureRmVMExtension](/powershell/module/azurerm.compute/set-azurermvmextension) | 가상 머신에 VM 확장을 추가합니다. 이 샘플에서는 Docker를 구성하고 NGINX Docker 컨테이너를 실행하기 위해 Docker 확장을 사용합니다. |
