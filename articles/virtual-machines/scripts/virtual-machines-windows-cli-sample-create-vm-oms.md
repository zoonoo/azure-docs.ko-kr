...
## <a name="create-vm-sample-with-operations-management-suite"></a>Operations Management Suite를 사용하여 VM 샘플 만들기

[!code-azurecli[기본](../../../cli_scripts/virtual-machine/create-vm-monitor-oms/create-windows-vm-monitor-oms.sh "VM 빠른 생성")]
