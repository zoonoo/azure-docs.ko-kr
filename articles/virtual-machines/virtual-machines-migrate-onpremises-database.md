...
- AlwaysOn 배포 온-프레미스가 있는 경우에는 [Azure Replica Wizard 추가](virtual-machines-sql-server-extend-on-premises-alwayson-availability-groups.md)를 사용하여 Azure에 복제본을 만들고 장애 조치하며 이는 Azure 데이터베이스 인스턴스에 사용자를 가리킵니다.
...
| [Azure Replica Wizard 추가 사용](virtual-machines-sql-server-extend-on-premises-alwayson-availability-groups.md) | SQL Server 2012 이상 | SQL Server 2012 이상 | [Azure VM 저장소 제한](https://azure.microsoft.com/documentation/articles/azure-subscription-service-limits/) | 가동 중지 시간을 최소화하고 AlwaysOn 온-프레미스 배포가 있을 경우 사용 |
