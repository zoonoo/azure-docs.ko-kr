---
title: Ev3 시리즈 및 Esv3 시리즈 - Azure 가상 컴퓨터
description: Ev3 및 Esv3 시리즈 VM용 사양입니다.
...
Ev3 및 Esv3 시리즈는 인텔® 제온® 8171M 2.1 GHz (스카이 레이크) 또는 인텔® 제온® E5-2673 v4 2.3 GHz (Broadwell) 프로세서를 하이퍼 스레드 구성으로 갖추고 있어 대부분의 범용 워크로드에 더 나은 가치 제안을 제공하고 Ev3를 제공합니다. 대부분의 다른 클라우드의 범용 VM과 정렬됩니다.  하이퍼 스레딩으로 이동하기 위해 디스크 및 네트워크 제한이 코어 단위로 조정되는 동안 메모리가 확장되었습니다(7GiB/vCPU에서 8GiB/vCPU로). Ev3는 D/Dv2 제품군의 상위 메모리 VM 크기에 대한 후속 시리즈입니다.

## <a name="ev3-series"></a>Ev3 시리즈

Ev3 시리즈 인스턴스는 인텔® 제온® 8171M 2.1 GHz (스카이 레이크) 또는 인텔® 제온® E5-2673 v4 2.3 GHz (브로드 웰) 프로세서와 인텔 터보 부스트 기술 2.0 기능을 기반으로합니다. Ev3 시리즈 인스턴스는 메모리 집약적 엔터프라이즈 애플리케이션에 적합합니다.

데이터 디스크 스토리지는 가상 머신과 별도로 비용이 청구됩니다. Premium Storage 디스크를 사용하려면 ESv3 크기를 사용합니다. ESv3 크기의 가격 및 요금 청구 기준은 Ev3 시리즈와 동일합니다.

Ev3 시리즈 VM의 기능 인텔® 하이퍼 스레딩 기술.
...
<sup>1</sup> 제한된 코어 크기를 사용할 수 있습니다.

<sup>2</sup> 인스턴스는 단일 고객 전용의 하드웨어에 격리되어 있습니다.

## <a name="esv3-series"></a>Esv3 시리즈

Esv3 시리즈 인스턴스는 인텔® 제온® 8171M 2.1 GHz (스카이 레이크) 또는 인텔® 제온® E5-2673 v4 2.3 GHz (브로드 웰) 프로세서, 인텔 터보 부스트 기술 2.0, 프리미엄 스토리지를 사용합니다. Esv3 계열 인스턴스는 메모리집약적인 엔터프라이즈 애플리케이션에 이상적입니다.

Esv3 시리즈 VM의 기능 인텔® 하이퍼 스레딩 기술.
