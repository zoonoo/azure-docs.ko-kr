---
title: Azure 지역
description: Azure에서 가상 머신을 실행 하기 위한 지역에 대해 알아봅니다.
author: cynthn
ms.author: cynthn
...
[여기에서 Azure Storage 복제 옵션](../storage/common/storage-redundancy.md)에 대해 자세히 알아볼 수 있습니다. 관리 디스크에 대한 자세한 내용은 [Azure Managed Disks 개요](./windows/managed-disks-overview.md)를 참조하세요.
