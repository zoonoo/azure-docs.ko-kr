...
ms.locfileid: "82796760"
---
# <a name="create-a-vm-using-a-specialized-image"></a>특수 이미지를 사용 하 여 VM 만들기 

공유 이미지 갤러리에 저장 된 특수 이미지 버전에서 VM을 만듭니다. 일반화 된 이미지 버전을 사용 하 여 VM을 만들려면 [특수 이미지 버전에서 Vm 만들기](vm-generalized-image-version-powershell.md)를 참조 하세요.

전문 이미지 버전이 있으면 하나 이상의 새 Vm을 만들 수 있습니다. [New-azvm](https://docs.microsoft.com/powershell/module/az.compute/new-azvm) cmdlet 사용 
