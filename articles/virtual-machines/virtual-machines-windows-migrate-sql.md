<properties
    pageTitle="VM에서 SQL Server로 SQL Server 데이터베이스 마이그레이션 | Microsoft Azure"
...
> [AZURE.NOTE] 전체 응용 프로그램을 마이그레이션하려면 [Azure Site Recovery](../site-recovery/site-recovery-overview.md)사용을 고려합니다.
