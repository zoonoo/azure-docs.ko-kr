...
---
# <a name="create-a-linux-vm-using-an-azure-template"></a>Azure 템플릿을 사용하여 Linux VM 만들기
...
[Azure 포털](virtual-machines-linux-quick-create-portal.md)을 사용하여 Linux VM을 신속히 배포할 수도 있습니다.
