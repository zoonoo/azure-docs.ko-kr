...
VM이 프로비전되고 실행되면 데이터 디스크를 연결하고 탑재할 수 있습니다. [여기](virtual-machines-linux-tutorial.md#attach-and-mount-a-disk)의 지침을 참조하세요.

다른 사용자 지정을 수행하려면 원하는 SSH 클라이언트를 사용하여 VM에 연결해야 합니다. 자세한 내용은 [ssh를 사용하여 Azure Linux VM에 연결](virtual-machines-linux-tutorial-portal-rm.md#connect-to-your-azure-linux-vm-using-strongsshstrong)을 참조하세요.
