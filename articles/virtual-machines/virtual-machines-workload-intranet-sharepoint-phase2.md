...
1.	Azure 클래식 포털의 왼쪽 창에서, **가상 컴퓨터**를 클릭합니다.
2.	VM에 연결하려면 VM 이름 옆의 **상태** 열에서 **실행**을 클릭합니다.
3.	페이지 아래쪽의 명령 모음에서 **연결**을 클릭합니다.
4.	Azure 클래식 포털에 .rdp 파일을 검색 중이라고 표시됩니다. **확인**을 클릭합니다.
...
1.	Azure 클래식 포털의 왼쪽 창에서 **네트워크**를 클릭한 후 가상 컴퓨터의 이름을 클릭합니다(표 v-항목 1-값 열).
2.	**Configure**를 클릭합니다.
...
6.	Azure 클래식 포털의 왼쪽 창에서 **가상 컴퓨터**를 클릭한 후, 첫번째 도메인 컨트롤러 이름 옆의 **상태** 열을 클릭합니다.
