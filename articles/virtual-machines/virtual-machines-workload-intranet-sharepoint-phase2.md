...
표 V, S, ST, A는 [1단계: Azure 구성](virtual-machines-workload-intranet-sharepoint-phase1.md)에서 정의했습니다.
...
- [3단계](virtual-machines-workload-intranet-sharepoint-phase3.md)를 사용하여 이 워크로드의 구성을 계속합니다.
