...
# Azure에서 Linux 클래식 가상 컴퓨터에 끝점을 설정하는 방법
...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] **리소스 관리자** 배포 모델에서는 **NSG(네트워크 보안 그룹)**를 사용하여 끝점을 구성합니다. 자세한 내용은 [포트 및 끝점 열기](virtual-machines-linux-nsg-quickstart.md)를 참조하세요.
