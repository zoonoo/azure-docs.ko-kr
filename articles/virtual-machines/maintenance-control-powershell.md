...
성공 하면이 명령은 `PSApplyUpdate` 개체를 반환 합니다. `Get-AzApplyUpdate` 명령의 Name 특성을 사용 하 여 업데이트 상태를 확인할 수 있습니다. [업데이트 상태 확인](#check-update-status)을 참조 하세요.
