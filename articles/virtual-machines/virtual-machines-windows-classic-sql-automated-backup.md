<properties
	...
	description="클래식 배포 모드를 사용하여 Azure 가상 컴퓨터에서 실행 중인 SQL Server에 대한 자동화된 백업 기능에 대해 설명합니다."
...
Azure에서 SQL Server VM 관련 기능은 [Azure 가상 컴퓨터의 SQL Server에 대한 자동화된 패치](virtual-machines-windows-classic-sql-automated-patching.md)입니다.
