...
저장소 계층에서 고가용성을 위해 응용 프로그램을 디자인합니다. 모범 사례는 가용성 집합의 각 VM마다 별도의 저장소 계정을 사용하는 것입니다. 동일한 저장소 계정에서 VM과 모든 디스크(OS 및 데이터) 연결을 유지합니다. 저장소 계정에 더 많은 VHD를 추가하는 경우 저장소 계정 [제한](../storage/storage-scalability-targets.md)을 고려하십시오.
