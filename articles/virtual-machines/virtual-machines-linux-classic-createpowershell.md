...
Windows 기반 가상 컴퓨터에 대한 관련 문서는 [Azure PowerShell을 사용하여 Windows 기반 가상 컴퓨터 만들기](virtual-machines-windows-classic-create-powershell.md)를 참조하세요.
...
자세한 내용은 [Azure에서 Linux와 함께 SSH를 사용하는 방법](virtual-machines-linux-ssh-from-linux.md)을 참조하세요.
...
가상 컴퓨터를 만든 후 [Linux를 실행하는 가상 컴퓨터에 로그온하는 방법](virtual-machines-linux-classic-log-on.md)을 참조하세요.
