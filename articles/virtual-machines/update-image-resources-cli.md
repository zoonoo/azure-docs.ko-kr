---
title: Azure CLI를 사용 하 여 이미지 리소스 나열, 업데이트 및 삭제
description: Azure CLI를 사용 하 여 공유 이미지 갤러리에서 이미지 리소스를 나열, 업데이트 및 삭제 합니다.
author: cynthn
...
ms.locfileid: "82797098"
---
# <a name="list-update-and-delete-image-resources"></a>이미지 리소스 나열, 업데이트 및 삭제 

Azure CLI를 사용 하 여 공유 이미지 갤러리 리소스를 관리할 수 있습니다.
