...
특정 리소스를 만들 때 Azure는 이러한 리소스에 연결된 리소스 관리를 간소화하기 위해 일부 기본값을 사용합니다. 예를 들어, 새 클라우드 서비스에 대한 첫 번째 가상 컴퓨터를 만들 때 Azure 포털은 가상 컴퓨터에 대한 새 클라우드 서비스 이름에 가상 컴퓨터의 이름을 사용하려고 합니다.
...
- 명명 규칙을 사용하여 저장소 계정 집합을 만듭니다. Azure 미리 보기 포털, Azure 포털 또는 **New-AzureStorageAccount** PowerShell cmdlet을 사용할 수 있습니다.
...
- 명명 규칙을 사용하여 클라우드 서비스 집합을 만듭니다. Azure 포털 또는 **New-AzureService** PowerShell cmdlet을 사용할 수 있습니다.
...
- 명명 규칙을 사용하여 가상 네트워크를 만듭니다. Azure 미리 보기 포털 또는 Azure 포털을 사용할 수 있습니다.
...
- Azure 미리 보기 포털, Azure 포털, **New-AzureVM** PowerShell cmdlet, Azure CLI 또는 리소스 관리자 템플릿을 사용하여 가상 컴퓨터를 만듭니다.
