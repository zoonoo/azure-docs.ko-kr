...
| Azure CLI 2.0(미리 보기) | **--public-ip-address** 매개 변수와 함께 [az network nic create](https://docs.microsoft.com/cli/azure/network/nic#create)를 사용하여 이전에 만든 공용 IP 주소의 식별자를 제공합니다. |
...
| Azure CLI 2.0(미리 보기) | Dynamic 또는 Static인 **--allocation-method** 매개 변수와 함께 [az network public-ip create](https://docs.microsoft.com/cli/azure/network/public-ip#create)를 사용합니다. |
...
| Azure CLI 2.0(미리 보기) | 서브넷과 VNet은 동시에 만들어집니다. [az network vnet create](https://docs.microsoft.com/cli/azure/network/vnet#create)에 서브넷 이름으로 **--subnet-name** 매개 변수를 제공합니다. |
