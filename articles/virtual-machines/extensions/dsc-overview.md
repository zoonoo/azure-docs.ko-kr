...
Azure DSC(Desired State Configuration) 확장의 주요 사용 사례는 VM을 [Azure Automation DSC 서비스](../../automation/automation-dsc-overview.md)로 부트스트랩하는 것입니다. VM 부트스트랩은 VM 구성의 지속적인 관리, Azure Monitor 등과 같은 기타 운영 도구와의 통합 등, 다양한 [혜택](/powershell/dsc/metaconfig#pull-service)을 제공합니다.
