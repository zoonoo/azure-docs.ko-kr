...
ms.locfileid: "74892637"
---
# <a name="use-powershell-to-enable-azure-diagnostics-in-a-virtual-machine-running-windows"></a>PowerShell을 사용하여 Windows를 실행 중인 가상 머신에서 Azure Diagnostics를 사용하도록 설정
