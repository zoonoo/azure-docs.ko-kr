...
### <a name="debian-7-jesse-debian-7-stretch"></a>데비안 7 "제시"/ 데비안 7 "스트레치"
...
## <a name="oracle-linux-6-and-oracle-linux-7"></a>오라클 리눅스 6 오라클 리눅스 7
...
### <a name="3-restart-the-waagent-service"></a>3. 와에이전트 서비스 다시 시작
대부분의 Linux 배포판:
