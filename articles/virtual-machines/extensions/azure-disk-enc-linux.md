...
Azure Disk Encryption은 현재 배포판 및 버전 선택에서 지원됩니다.  Azure Disk Encryption 지원 [되는 운영 체제를 참조 하세요. Linux](../../security/azure-security-disk-encryption-prerequisites.md#linux) 는 지원 되는 linux 배포판의 목록입니다.
