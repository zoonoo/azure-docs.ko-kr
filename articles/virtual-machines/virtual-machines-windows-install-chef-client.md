<properties
	...
	description="Azure의 VM에서 Chef를 설치 및 구성하는 방법에 대해 설명합니다."
...
- Windows Server 2012 또는 Windows Server 2012 R2가 실행되는 가상 컴퓨터를 만들 때 Azure 포털을 사용하여 Chef 클라이언트를 설치합니다. 지침은 [Azure 포털](https://docs.chef.io/azure_portal.html)(영문)을 참조하세요.
