...
---
# Azure의 기존 Windows 가상 컴퓨터 재시작 또는 크기 조정 관련 클래식 배포 문제 해결
> [!div class="op_single_selector"]
> * [클래식](virtual-machines-windows-classic-restart-resize-error-troubleshooting.md)
> * [리소스 관리자](virtual-machines-windows-restart-resize-error-troubleshooting.md)
> 
> 
...
## 다음 단계
Azure에서 새 Windows VM을 만들 때 문제가 발생하면 [Azure에서 새 Windows 가상 컴퓨터 생성 관련 배포 문제 해결](virtual-machines-windows-troubleshoot-deployment-new-vm.md)을 참조하세요.
