...
포털의 그래픽 사용자 인터페이스는 특히 Azure로 시작한 경우 쉽게 가상 컴퓨터를 사용해 볼 수 있는 방법입니다. [Azure 클래식 포털](http://manage.windowsazure.com) 또는 [Azure 포털](http://portal.azure.com)을 사용하여 VM을 만듭니다. 일반적인 지침은 [사용자 지정 가상 컴퓨터 만들기][]를 참조하고 **갤러리**에서 Linux 이미지를 선택합니다. [Azure 클래식 포털](http://manage.windowsazure.com)에서는 클래식 배포 모델만 사용하여 가상 컴퓨터를 만듭니다.
