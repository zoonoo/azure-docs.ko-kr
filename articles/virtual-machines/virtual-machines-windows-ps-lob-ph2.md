...
[3단계](virtual-machines-windows-ps-lob-ph3.md)로 진행하기 전에 이 단계를 완료해야 합니다. 모든 단계는 [Azure에서 고가용성 LOB(기간 업무) 응용 프로그램 배포](virtual-machines-windows-lob-overview.md)를 참조하세요.
...
표 V, S, ST, A는 [1단계: Azure 구성](virtual-machines-windows-ps-lob-ph1.md)에서 정의했습니다.
