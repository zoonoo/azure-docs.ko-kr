...
[Resource Manager 모델을 사용하여 이러한 단계를 수행](https://github.com/Azure/azure-linux-extensions/tree/master/VMAccess)하는 방법을 알아봅니다.
...
> [!NOTE]
> 재설정된 SSH 구성 파일은 /etc/ssh/sshd\_config에 있습니다.
> 
> 
