...
9.	리소스 그룹을 선택하거나 만듭니다. 자세한 내용은 [Azure Preview 포털을 사용하여 Azure 리소스 관리](resource-group-portal.md)를 참조하세요.
...
[Oracle 가상 컴퓨터 이미지 목록](virtual-machines-oracle-list-oracle-virtual-machine-images.md)
