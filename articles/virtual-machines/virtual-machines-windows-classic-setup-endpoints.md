...
[Resource Manager 모델을 사용하여 이러한 단계를 수행](virtual-machines-windows-nsg-quickstart-portal.md)하는 방법을 알아봅니다. **Resource Manager** 배포 모델에서는 **NSG(네트워크 보안 그룹)**를 사용하여 끝점을 구성합니다. 자세한 내용은 [Azure 포털을 사용하여 VM에 대한 외부 액세스 허용](virtual-machines-windows-nsg-quickstart-portal.md)을 참조하세요.
