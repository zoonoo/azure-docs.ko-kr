...
![Azure 포털에서 SQL 자동 패치](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
![Azure 포털에서 자동화된 패치 구성](./media/virtual-machines-windows-classic-ps-sql-patch/IC792132.jpg)
...
Azure에서 SQL Server VM 관련 기능은 [Azure 가상 컴퓨터의 SQL Server에 대한 자동화된 백업](virtual-machines-windows-classic-ps-sql-backup.md)입니다.
