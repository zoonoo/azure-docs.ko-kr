...
---
# <a name="what-are-virtual-machine-scale-sets"></a>가상 컴퓨터 크기 집합이란?
가상 컴퓨터 크기 집합을 사용하여 여러 VM을 집합으로 관리할 수 있습니다. 개략적으로 크기 집합의 장점과 단점은 다음과 같습니다.

장점:

1. 고가용성. 각 크기 집합은 가용성을 보장하기 위해 5개의 FD(장애 도메인)와 5개의 UD(업데이트 도메인)가 있는 가용성 집합에 VM을 배치합니다(FD와 UD에 대한 자세한 내용은 [VM 가용성](virtual-machines-linux-manage-availability.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) 참조). 
...
## <a name="quick-create-using-azure-cli"></a>Azure CLI를 사용한 빠른 생성
