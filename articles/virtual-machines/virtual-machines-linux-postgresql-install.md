...
> [!NOTE]
> 이 자습서를 완료하려면 Linux를 실행하는 Azure 가상 컴퓨터가 이미 있어야 합니다. 계속하기 전에 Linux VM을 생성하고 설정하려면 [Azure Linux VM 자습서](virtual-machines-linux-quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)를 참조하세요.
> 
> 

이 경우 PostgreSQL 포트로 포트 1999를 사용하세요.  

PuTTY를 통해 생성한 Linux VM에 연결합니다. Azure Linux VM을 처음 사용하는 경우 [Azure에서 Linux와 함께 SSH를 사용하는 방법](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)을 참조하여 Linux VM에 연결하기 위해 PuTTY를 사용하는 방법을 배웁니다.
...
![이미지](./media/virtual-machines-linux-postgresql-install/no1.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no2.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no3.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no4.png)

다음 명령을 사용하여 테이블 구조를 확인할 수 있습니다.

![이미지](./media/virtual-machines-linux-postgresql-install/no5.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no6.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no7.png)
...
![이미지](./media/virtual-machines-linux-postgresql-install/no8.png)
