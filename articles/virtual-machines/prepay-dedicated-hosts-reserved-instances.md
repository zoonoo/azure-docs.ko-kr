...
먼저 [Windows 가상 머신](./windows/sizes.md) 또는 [Linux](./linux/sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) 에 대해 지원 되는 크기를 이동 하 여 VM 시리즈를 식별 합니다.
