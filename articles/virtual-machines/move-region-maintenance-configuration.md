...
1. 각 구독에서 모든 유지 관리 구성을 검색 합니다. CLI [az maintenance configuration list](https://docs.microsoft.com/cli/azure/ext/maintenance/maintenance/configuration?view=azure-cli-latest#ext-maintenance-az-maintenance-configuration-list) 명령을 실행 하 여이 작업을 수행 하 고 $subId를 구독 ID로 바꿉니다.
