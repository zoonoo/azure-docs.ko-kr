...
Azure Disk Encryption [2 세대 vm](generation-2.md#generation-1-vs-generation-2-capabilities)) 및 [Lsv2 시리즈 vm](../lsv2-series.md)에서 사용할 수 없습니다. 자세한 예외는 [Azure Disk Encryption: 지원 되지 않는 시나리오](disk-encryption-linux.md#unsupported-scenarios)를 참조 하세요.
