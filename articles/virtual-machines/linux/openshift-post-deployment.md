...
- 각 OpenShift 노드에서 Log Analytics VM 확장을 사용하도록 설정
- OpenShift 디먼 집합으로 Log Analytics 에이전트 설치

전체 지침은 https://docs.microsoft.com/en-us/azure/log-analytics/log-analytics-containers#configure-a-log-analytics-agent-for-red-hat-openshift에 나와 있습니다.
