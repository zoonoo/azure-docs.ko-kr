...
|---|---|---|---|---|---|---|
| RHEL | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![아니요](./media/sql-server-linux-virtual-machines-overview/no.png) |
| SLES | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![예](./media/sql-server-linux-virtual-machines-overview/yes.png) | ![아니요](./media/sql-server-linux-virtual-machines-overview/no.png) | ![아니요](./media/sql-server-linux-virtual-machines-overview/no.png) |
...
* [리눅스 문서에 SQL 서버](https://docs.microsoft.com/sql/linux)
