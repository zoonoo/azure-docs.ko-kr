...
적용 되는 모든 네트워크 보안 그룹 설정은 여전히 끝점이 디스크 암호화에 대해 문서화 된 네트워크 구성 필수 조건을 충족 하도록 허용 해야 합니다.  [Azure Disk Encryption: 네트워킹 요구 사항](disk-encryption-overview.md#networking-requirements) 을 참조 하세요.
