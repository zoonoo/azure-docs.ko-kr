...
| 리소스 그룹     |  배포된 리소스가 실행되는 리소스 그룹입니다. 자세한 내용은 [Azure 리소스 관리자 개요를 참조하세요.](https://docs.microsoft.com/azure/virtual-machines/linux/vm-usage)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |    "MyRG"                                                                                                                                                                                                                                                                                                                                                        |
...
### <a name="how-are-basic-vs-standard-vm-types-differentiated-in-the-usage-csv"></a>기본 VM 유형과 표준 VM 유형은 사용 CSV에서 어떻게 차별화되나요?
