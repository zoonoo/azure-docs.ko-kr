...
| 측정기 이름         | Azure의 각 서비스마다 특정합니다. Compute의 경우 항상 “컴퓨팅 시간”입니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | “컴퓨팅 시간”                                                                                                                                                                                                                                                                                                                                                  |
...
| 태그               | 리소스에 할당하는 태그입니다. 태그를 사용하여 청구 레코드를 그룹화합니다. [Virtual Machines에 태그를 지정하는 방법](tag.md)을 알아봅니다. Resource Manager VM에만 사용할 수 있습니다.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | "{"myDepartment":"RD","myUser":"myName"}"                                                                                                                                                                                                                                                                                                                        |
...
### <a name="how-are-basic-vs-standard-vm-types-differentiated-in-the-usage-csv"></a>기본 및 표준 VM 유형은 사용 CSV에서 어떻게 구분 되나요?
