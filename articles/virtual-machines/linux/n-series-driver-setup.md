...
N 시리즈 Linux VM은 Azure Marketplace의 다음 배포판 및 나열된 NVIDIA 드라이버를 지원합니다.


| VM 시리즈 | 지원되는 배포판 | 지원되는 드라이버 |
| --- | --- | --- |
| **NC**(Tesla K80 카드) | Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> CentOS 기반 7.3 | NVIDIA CUDA 8.0, 드라이버 분기 R375<br/>[설치 단계](#install-cuda-drivers-for-nc-vms) |
| **NV**(Tesla M60 카드)| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>CentOS 기반 7.3 | NVIDIA GRID 4.2, 드라이버 분기 R367<br/>[설치 단계](#install-grid-drivers-for-nv-vms) |
