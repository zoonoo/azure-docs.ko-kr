---
title: Azure CLI를 사용 하 여 근접 배치 그룹 만들기
...
또한 근접 배치 그룹에 확장 집합을 만들 수 있습니다. `--ppg` [Az vmss create](/cli/azure/vmss#az_vmss_create) 와 동일한 매개 변수를 사용 하 여 확장 집합을 만들고 모든 인스턴스는 동일한 근접 배치 그룹에 생성 됩니다.
