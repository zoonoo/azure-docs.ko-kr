---
title: Azure CLI를 사용하여 Linux VM 복사
...
-   Azure [CLI를](/cli/azure/install-az-cli2)설치합니다.
...
[공유 이미지 갤러리를](shared-images.md) 사용하여 VM 이미지를 관리하는 방법을 알아봅니다.
