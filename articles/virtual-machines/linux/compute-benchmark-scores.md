---
title: Azure Linux VM에 대한 벤치마크 점수 계산
...
(2019년 3월 15일 오전 12:06:55 pbi 3897709)
...
참고: Av2 시리즈 VM은 위와 같이 다양한 하드웨어 유형 및 프로세서에 배포할 수 있습니다. Av2 시리즈 VM에는 CPU 성능과 메모리 구성이 개발 및 테스트와 같은 엔트리 레벨 워크로드에 가장 적합합니다. 크기는 배포된 하드웨어에 관계없이 실행 중인 인스턴스에 대해 비교적 일관된 프로세서 성능을 제공하도록 제한됩니다. 그러나 특정 최신 프로세서 최적화를 활용하는 소프트웨어는 프로세서 유형 간에 더 큰 차이를 보일 수 있습니다.

## <a name="b---burstable"></a>B - 버스트 가능
(2019년 3월 15일 오전 12:27:08 pbi 3897709)
...
참고: B 시리즈 VM은 버스트 가능한 성능 요구 사항이 있는 워크로드를 위한 것입니다. VM 인스턴스는 기준보다 적게 사용할 때 크레딧을 누적합니다. VM에 크레딧이 누적되면 VM은 짧은 CPU 버스트 요구 사항을 충족하기 위해 최대 100%를 사용하여 기준선 이상으로 버스트할 수 있습니다. 버스트 시간은 VM 크기 및 시간의 함수인 사용 가능한 크레딧에 따라 다릅니다.  

CoreMark는 일반적으로 사용 가능한 버스트 크레딧 내에서 완료되는 짧은 실행 테스트입니다.  따라서 위의 숫자는 일반적으로 짧은 버스트, 워크로드(일반적으로 B-시리즈에서) 성능이 표시되는 것을 반영하여 VM의 버스트 성능을 나타냅니다.

## <a name="dsv3---general-compute--premium-storage"></a>DSv3 - 일반 컴퓨팅 + Premium Storage
(2019년 3월 12일 오후 6:52:03 pbi 3897709)
...
(2019년 3월 12일 오후 6:54:27 pbi 3897709)
...
(2019년 3월 15일 오전 12:53:13 pbi 3897709)
...
(2019년 3월 12일 오후 6:53:48 pbi 3897709)
...
(2019년 3월 12일 오후 7:17:33 pbi 3897709)
...
## <a name="eisv3---memory-opt--premium-storage-isolated"></a>Eisv3 - 메모리 옵트 + 프리미엄 스토리지(절연)
(2019년 4월 11일 오후 10:07:29 pbi 3897709)
...
(2019년 3월 12일 오후 6:52:13 pbi 3897709)
...
(2019년 3월 12일 오후 6:57:51 pbi 3897709)
...
(2019년 3월 12일 오후 6:51:35 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_F2s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 2 | 1 | 3.9 | 28,219 | 1,843 | 6.53% | 700 |
| Standard_F4s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 4 | 1 | 7.8 | 53,911 | 1,002 | 1.86% | 707 |
| Standard_F8s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 8 | 1 | 15.7 | 106,467 | 1,101 | 1.03% | 707 |
| Standard_F16s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 16 | 1 | 31.4 | 211,311 | 1,724 | 0.82% | 707 |
| Standard_F32s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 32 | 1 | 62.9 | 423,175 | 4,346 | 1.03% | 707 |
| Standard_F64s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 64 | 2 | 125.9 | 829,537 | 21,574 | 2.60% | 707 |
| Standard_F72s_v2 | Intel(R) Xeon(R) 플래티넘 8168 CPU @ 2.70GHz | 72 | 2 | 141.7 | 933,800 | 26,783 | 2.87% | 707 |

## <a name="fs---compute-and-storage-optimized"></a>Fs - 컴퓨팅 및 스토리지 최적화
(2019년 3월 15일 오전 12:51 pbi 3897709)
...
(2019년 3월 12일 오후 6:53:59 pbi 3897709)
...
(2019년 3월 12일 오후 10:22:33 pbi 3897709)
...
(2019년 3월 12일 오후 10:23:51 pbi 3897709)
...
(2019년 3월 12일 오후 10:50:51 pbi 3897709)
...
## <a name="lv2---storage-optimized"></a>Lv2 - 스토리지 최적화
(2019년 3월 14일 오후 5:49:04 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_L8s_v2 | AMD EPYC 7551 32 코어 프로세서 | 8 | 1 | 62.9 | 80,528 | 404 | 0.50% | 119 |
| Standard_L16s_v2 | AMD EPYC 7551 32 코어 프로세서 | 16 | 2 | 125.9 | 154,829 | 3,708 | 2.40% | 119 |
| Standard_L32s_v2 | AMD EPYC 7551 32 코어 프로세서 | 32 | 4 | 251.9 | 310,811 | 7,751 | 2.49% | 119 |
| Standard_L64s_v2 | AMD EPYC 7551 32 코어 프로세서 | 64 | 8 | 503.9 | 595,140 | 14,572 | 2.45% | 112 |
| Standard_L80s_v2 | AMD EPYC 7551 32 코어 프로세서 | 80 | 10 | 629.9 | 773,171 | 19,559 | 2.53% | 119 |

## <a name="ls---storage-optimized"></a>Ls - 스토리지 최적화
(2019년 3월 12일 오후 10:22:29 pbi 3897709)
...
(2019년 4월 11일 오후 7:30:39 pbi 3897709)
...
## <a name="ncsv3---gpu-enabled"></a>NCSv3 - GPU 지원
(3/21/2019 5:48:37 오후 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v3 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 106,929 | 353 | 0.33% | 49 |
| Standard_NC12s_v3 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 213,585 | 875 | 0.41% | 42 |
| Standard_NC24rs_v3 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 403,554 | 6,705 | 1.66% | 42 |
| Standard_NC24s_v3 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 403,874 | 7,603 | 1.88% | 42 |

## <a name="ncsv2---gpu-enabled"></a>NCSv2 - GPU 지원
(2019년 3월 12일 오후 11:19:19 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6s_v2 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 107,115 | 321 | 0.30% | 63 |
| Standard_NC12s_v2 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 213,814 | 656 | 0.31% | 63 |
| Standard_NC24rs_v2 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 401,728 | 6,995 | 1.74% | 63 |
| Standard_NC24s_v2 | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 402,808 | 7,923 | 1.97% | 63 |

## <a name="nc---gpu-enabled"></a>NC - GPU 사용 가능
(2019년 3월 12일 오후 11:08:03 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NC6 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 6 | 1 | 55.0 | 102,211 | 658 | 0.64% | 259 |
| Standard_NC12 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 12 | 1 | 110.2 | 203,523 | 2,293 | 1.13% | 259 |
| Standard_NC24 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 382,897 | 8,712 | 2.28% | 259 |
| Standard_NC24r | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 383,171 | 9,166 | 2.39% | 259 |

## <a name="nds--gpu-enabled"></a>NDS- GPU 지원
(2019년 3월 12일 오후 11:19:10 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_ND6s | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 6 | 1 | 110.2 | 107,095 | 353 | 0.33% | 63 |
| Standard_ND12s | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 12 | 1 | 220.4 | 212,298 | 3,457 | 1.63% | 63 |
| Standard_ND24rs | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 402,749 | 7,838 | 1.95% | 56 |
| Standard_ND24s | 인텔(R) 제온(R) CPU E5-2690 v4 @ 2.60GHz | 24 | 2 | 440.9 | 401,822 | 7,776 | 1.94% | 63 |

## <a name="nv---gpu-enabled"></a>NV - GPU 사용 가능
(2019년 3월 12일 오후 11:08:13 pbi 3897709)

| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | StdDev | StdDev% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_NV6 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 6 | 1 | 55.0 | 101,728 | 2,094 | 2.06% | 259 |
| Standard_NV12 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 12 | 1 | 110.2 | 203,903 | 1,724 | 0.85% | 252 |
| Standard_NV24 | 인텔(R) 제온(R) CPU E5-2690 v3 @ 2.60GHz | 24 | 2 | 220.4 | 379,879 | 8,737 | 2.30% | 259 |
