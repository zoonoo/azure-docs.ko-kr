...
|VM 크기| CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | 표준 편차 | 표준 편차% | #실행 |
|---| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
|Standard_D2as_v4| AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 7.8 | 29,726 | 693 | 2.33% | 42 |
|Standard_D4as_v4| AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 15.7 | 59,224 | 1,595 | 2.69% | 42 |
|Standard_D8as_v4| AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 31.4 | 116,412 | 3,613 | 3.10% | 42 |
|Standard_D16as_v4| AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 62.9 | 229,489 | 7,209 | 3.14% | 35 |
|Standard_D32as_v4| AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 125.9 | 461,916 | 6,746 | 1.46% | 35 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | 표준 편차 | 표준 편차% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_D2a_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 7.8 | 30,023 | 333 | 1.11% | 35 |
| Standard_D4a_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 15.7 | 59,685 | 1,141 | 1.91% | 77 |
| Standard_D8a_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 31.4 | 118,346 | 1,130 | 0.95% | 42 |
| Standard_D16a_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 62.9 | 231,131 | 3,830 | 1.66% | 35 |
| Standard_D32a_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 125.9 | 457,266 | 10,208 | 2.23% | 35 |
| Standard_D48a_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 188.9 | 664,078 | 17,241 | 2.60% | 35 |
| Standard_D64a_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 251.9 | 863,911 | 24,818 | 2.87% | 35 |
| Standard_D96a_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 377.9 | 1,290,455 | 13,640 | 1.06% | 35 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | 표준 편차 | 표준 편차% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2as_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 15.7 | 29,217 | 654 | 2.24% | 42 |
| Standard_E4as_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 31.4 | 58,356 | 480 | 0.82% | 42 |
| Standard_E8as_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 62.9 | 115,943 | 3,526 | 3.04% | 35 |
| Standard_E16as_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 125.9 | 227,383 | 5,619 | 2.47% | 35 |
| Standard_E32as_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 251.9 | 454,609 | 12,746 | 2.80% | 35 |
| Standard_E48as_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 377.9 | 682,769 | 9,257 | 1.36% | 35 |
| Standard_E64as_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 503.9 | 881,311 | 28,357 | 3.22% | 35 |
| Standard_E96as_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 661.4 | 1,299,233 | 14,997 | 1.15% | 70 |
...
| VM 크기 | CPU | vCPU | NUMA 노드 | 메모리(GiB) | Avg 점수 | 표준 편차 | 표준 편차% | #실행 |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Standard_E2a_v4 | AMD EPYC 7452 32-코어 프로세서 | 2 | 1 | 15.7 | 29,561 | 422 | 1.43% | 42 |
| Standard_E4a_v4 | AMD EPYC 7452 32-코어 프로세서 | 4 | 1 | 31.4 | 58,303 | 1,280 | 2.20% | 42 |
| Standard_E8a_v4 | AMD EPYC 7452 32-코어 프로세서 | 8 | 1 | 62.9 | 114,650 | 2,726 | 2.38% | 42 |
| Standard_E16a_v4 | AMD EPYC 7452 32-코어 프로세서 | 16 | 2 | 125.9 | 226,947 | 4,661 | 2.05% | 35 |
| Standard_E32a_v4 | AMD EPYC 7452 32-코어 프로세서 | 32 | 4 | 251.9 | 453,666 | 10,058 | 2.22% | 42 |
| Standard_E48a_v4 | AMD EPYC 7452 32-코어 프로세서 | 48 | 6 | 377.9 | 665,200 | 18,714 | 2.81% | 35 |
| Standard_E64a_v4 | AMD EPYC 7452 32-코어 프로세서 | 64 | 8 | 503.9 | 894,718 | 25,214 | 2.82% | 35 |
| Standard_E96a_v4 | AMD EPYC 7452 32-코어 프로세서 | 96 | 12 | 661.4 | 1,298,074 | 15,948 | 1.23% | 35 |
...
> [!NOTE]
> Av2 시리즈 VM은 다양한 하드웨어 유형 및 프로세서에 배포할 수 있습니다(위 참조). Av2 시리즈 VM은 개발과 테스트 등 항목별 작업에 가장 적합한 CPU 성능 및 메모리 구성을 갖추고 있습니다. 배포된 하드웨어에 관계없이 실행 중인 인스턴스에 대해 비교적 일관된 프로세서 성능을 제공하기 위해 크기가 조절됩니다. 그러나 특정 최신 프로세서 최적화를 활용하는 소프트웨어는 프로세서 유형에 따라 더 큰 차이를 볼 수 있습니다.

## <a name="b---burstable"></a>B-버스트 가능
(3/15/2019 12:27:08 AM pbi 3897709) (6/14/2019 7:09:29 AM pbi 4777081 업데이트됨)
...
> [!NOTE]
> B 시리즈 VM은 버스트 가능 성능 요구 사항이 있는 워크로드를 위한 것입니다. VM 인스턴스는 기준선보다 적은 값을 사용하는 경우 크레딧을 누적합니다. VM에 크레딧이 누적되면 VM은 짧은 CPU 버스트 요구 사항을 충족하기 위해 최대 100%를 사용하여 기준선 이상으로 버스트할 수 있습니다. 버스트 시간은 VM 크기 및 시간 함수에 해당하는 사용 가능한 크레딧에 따라 달라집니다.  
>
> CoreMark는 일반적으로 사용 가능한 버스트 크레딧 내에서 완료되는 짧은 실행 테스트입니다.  따라서 위의 수치는 일반적으로 VM의 버스트 성능을 나타내며, 짧고 버스트가 있는 워크로드(B 시리즈에서 일반적) 성능에 일반적으로 표시하는 항목을 반영합니다.
...
## <a name="nds--gpu-enabled"></a>ND - GPU 사용
