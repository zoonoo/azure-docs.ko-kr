...
모니터링 메트릭 구성 및 샘플에 대한 자세한 내용은 **[Linux 진단 확장을 사용하여 Linux VM의 성능 및 진단 데이터 모니터링](classic/diagnostic-extension.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json) 문서를 참조하세요.
