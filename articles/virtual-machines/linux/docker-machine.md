...
![ngnix 컨테이너 실행](./media/docker-machine/nginxsuccess.png)

## <a name="next-steps"></a>다음 단계
관심이 있을 경우 Azure [Docker VM 확장](dockerextension.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)에서 Azure CLI 또는 Azure Resource Manager 템플릿을 사용하여 동일한 작업을 시도해 볼 수 있습니다. 
