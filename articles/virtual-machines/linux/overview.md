...
새 Azure 계정에 사용하여 웹 기반 관리 패널인 Azure 포털에서 즉시 시작할 수 있습니다.  명령줄을 통해 Azure 클라우드를 관리하려면 `azure-cli`를 설치합니다.  Mac 또는 Linux 워크스테이션에 [Azure CLI 2.0](/cli/azure/install)을 설치합니다.
