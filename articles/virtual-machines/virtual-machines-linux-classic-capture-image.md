...
[Resource Manager 모델을 사용하여 이러한 단계를 수행](virtual-machines-linux-capture-image.md)하는 방법을 알아봅니다.
...
## 다음 단계
이제 이미지를 사용하여 가상 컴퓨터를 만들 수 있습니다. Azure CLI 명령 `azure vm create`을 사용하고 만든 이미지 이름을 제공할 수 있습니다. 이 명령에 대한 자세한 내용은 [클래식 배포 모델에서 Azure CLI 사용](../virtual-machines-command-line-tools.md)을 참조하세요. 또는 [Azure 클래식 포털][Azure 클래식 포털]에서 **갤러리에서** 방법을 사용한 후 만든 이미지를 선택하여 사용자 지정 가상 컴퓨터를 만듭니다. 자세한 내용은 [사용자 지정 가상 컴퓨터를 만드는 방법][사용자 지정 가상 컴퓨터를 만드는 방법]을 참조하세요.
