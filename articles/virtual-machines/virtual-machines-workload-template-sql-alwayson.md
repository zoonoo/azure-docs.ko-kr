...
리소스 관리자 템플릿과 Azure Preview 포털을 사용하여 이 워크로드를 배포하려면 [여기](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2Fsql-server-2014-alwayson-dsc%2Fazuredeploy.json)를 클릭하십시오.
...
템플릿에 따라 Azure의 워크로드 빌드에 다소 시간이 걸릴 수 있습니다. 템플릿 실행이 완료되면, 기존 또는 새로운 리소스 그룹에 새로운 5-서버 SQL Server AlwaysOn을 갖게 됩니다.
