...
[Azure에서 Linux 환경의 SSH를 사용하는 방법](virtual-machines-linux-ssh-from-linux.md)의 지침에 따라 SSH용 공용 키 및 개인 키를 만듭니다. 기본 단계는 아래 지침에 나와 있습니다. 이러한 키를 사용하여 클러스터의 VM에 연결해 VM이 작동하며 서로 통신할 수 있는지를 확인합니다.
...
[YAML]: http://yaml.org/
[Azure의 CoreOS에서 Fleet 시작]: virtual-machines-linux-classic-coreos-fleet-get-started.md
