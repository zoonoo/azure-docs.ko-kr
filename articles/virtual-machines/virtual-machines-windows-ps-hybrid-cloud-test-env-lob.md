<properties 
	pageTitle="LOB 응용 프로그램 테스트 환경 | Microsoft Azure" 
...
Azure 포털을 사용하여 로컬 관리자 계정으로 SQL1에 연결합니다.
...
다음으로, Window Power Shell 프롬프트에서 이러한 명령을 사용하여 SQL1을 CORP Active Directory 도메인에 가입합니다.
...
다음으로, Azure 포털을 사용하여 로컬 관리자 계정의 자격 증명으로 LOB1에 연결합니다.
...
- 이 환경에서 다른 [작업](virtual-machines-windows-ps-hybrid-cloud-test-envs.md)을 배포합니다.
