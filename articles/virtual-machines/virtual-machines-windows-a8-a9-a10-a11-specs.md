<properties
 pageTitle="Windows의 계산 집약적 VM 정보 | Microsoft Azure"
...
>[AZURE.NOTE]RDMA 지원 계산 집약적 VM에서는 RDMA 연결에 필요한 Windows 네트워크 장치 드라이버를 설치하는 HpcVmDrivers 확장을 VM에 추가해야 합니다. 대부분의 배포에서는 HpcVmDrivers 확장이 자동으로 추가됩니다. 확장을 직접 추가하려면 [VM 확장 관리](virtual-machines-windows-classic-manage-extensions.md)를 참조하세요.
