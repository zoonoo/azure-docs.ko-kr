<properties
	pageTitle="SQL Server VM에 대한 저장소 구성 | Microsoft Azure"
...
- [SQL Server 갤러리 이미지](virtual-machines-windows-sql-server-iaas-overview.md#option-1-deploy-a-sql-vm-per-minute-licensing)로 프로비전합니다.
- [Resource Manager 배포 모델](../resource-manager-deployment-model.md)을 사용합니다.
...
- [AKV 통합을 사용하여 VM 만들기](https://github.com\Azure\azure-quickstart-templates\tree\master\201-vm-sql-full-keyvault)
...
가격 책정 정보는 **디스크 저장소** 탭의 [저장소 가격 책정](https://azure.microsoft.com/pricing/details/storage) 페이지를 참조하세요.
...
>[AZURE.NOTE] SQL 가상 컴퓨터를 프로비전할 때 저장소 구성 단계에서 워크로드 유형을 선택하여 지정할 수 있습니다.
