<properties
   pageTitle="Azure Resource Manager 템플릿을 사용하여 계산 리소스 배포 | Microsoft Azure"
...
# Azure Resource Manager 템플릿을 사용하는 응용 프로그램 아키텍처
...
![가상 컴퓨터](./media/virtual-machines-linux-dotnet-core/vm.png)
...
![저장소 계정](./media/virtual-machines-linux-dotnet-core/storacct.png)

저장소 계정 blob 컨테이너를 클릭하면 템플릿을 통해 배포된 각 가상 컴퓨터의 가상 하드 드라이버 파일을 볼 수 있습니다.

![가상 하드 드라이브](./media/virtual-machines-linux-dotnet-core/vhd.png)
...
![가상 네트워크](./media/virtual-machines-linux-dotnet-core/vnet.png)
...
![네트워크 인터페이스](./media/virtual-machines-linux-dotnet-core/nic.png)
