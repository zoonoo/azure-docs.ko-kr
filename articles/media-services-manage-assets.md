...
-   [Media Services SDK for .NET을 사용하여 자산 관리(영문)][Media Services SDK for .NET을 사용하여 자산 관리(영문)]
-   [Media Services REST API를 사용하여 자산 관리(영문)][Media Services REST API를 사용하여 자산 관리(영문)]

</p>
## 다음 단계

자산 관리 방법을 알아보았습니다. [다운로드를 통해 자산을 제공하는 방법][다운로드를 통해 자산을 제공하는 방법](영문) 항목을 이동하세요.

  [방법: 자산 보호]: ../media-services-protect-asset/
  ...
  [다운로드를 통해 자산을 제공하는 방법]: ../media-services-deliver-asset-download/
