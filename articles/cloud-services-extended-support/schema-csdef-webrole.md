---
title: Azure Cloud Services(추가 지원) Def. WebRole 스키마 | Microsoft Docs
description: Cloud Services(추가 지원)에 대한 웹 역할과 관련된 정보
ms.topic: article
...
---
# <a name="azure-cloud-services-extended-support-definition-webrole-schema"></a>Azure Cloud Services(추가 지원) 정의 WebRole 스키마
...
| attribute | Type | Description |  
| --------- | ---- | ----------- |  
|moduleName|문자열|필수 요소. 가져올 모듈의 이름입니다. 유효한 가져오기 모듈은 다음과 같습니다.<br /><br /> -   RemoteAccess<br />-   RemoteForwarder<br />-   Diagnostics<br /><br /> RemoteAccess 및 RemoteForwarder 모듈을 사용하면 원격 데스크톱 연결에 대한 역할 인스턴스를 구성할 수 있습니다. 자세한 내용은 [추가](extensions.md)를 참조하세요.<br /><br /> 진단 모듈을 사용하면 역할 인스턴스에 대한 진단 데이터를 수집할 수 있습니다.|  
...
|physicalDirectory|문자열|사이트 루트에 대한 콘텐츠 디렉터리의 위치입니다. 위치는 절대 경로로 지정되거나 .csdef 위치에 대해 상대적일 수 있습니다.|  
