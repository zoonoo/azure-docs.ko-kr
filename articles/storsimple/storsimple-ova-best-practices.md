...
> [!NOTE]
> 또한 로컬 디스크는 씬 프로비전이 좋습니다. 복원 공간은&5;일을 초과한 데이터를 복원하려는 경우에만 필요하기 때문에 좋습니다. 항목 수준 복구를 사용하면 복원에 필요한 추가 공간 없이 최근&5;일의 데이터를 복원할 수 있습니다.
> 
> 
...
* 가상 배열이 배포되는 네트워크에 항상 5Mbps 이상 인터넷 대역폭을 사용할 수 있는 용량이 있는지 확인합니다. 
  ...
  * 처리 가능한 데이터 변경은 인터넷 대역폭에 정비례합니다. 예를 들어 백업을 수행할 때 5Mbps 대역폭은 8시간에 약 18GB의 데이터를 변경할 수 있습니다. 대역폭이&4;배 증가하면(20Mbps)&4;배 더 많은 데이터 변경(72GB)을 처리할 수 있습니다. 
...
* StorSimple 가상 배열은 바로 복원을 지원하지 않습니다. 하지만 언제든지 가상 배열에 공간을 확보한 후 다른 볼륨/공유에 복원하는&2;단계 프로세스를 통해 복원을 수행할 수 있습니다.
