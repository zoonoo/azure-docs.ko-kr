---
title: 다른 StorSimple 8000 디바이스로 장애 조치(failover), 재해 복구
...
9. 장애 조치를 완료한 후 **디바이스** 블레이드로 이동합니다.
   ...
   1. 장애 조치 프로세스에 대한 대상 디바이스로 사용된 디바이스를 선택합니다.
       ...
       ![디바이스 2 선택](./media/storsimple-8000-device-failover-disaster-recovery/failover-phy-dev14.png)
