<properties 
   ...
   description="볼륨에 대한 백업 세트를 관리하는 StorSimple Manager 서비스를 사용하는 방법에 대해 설명합니다."
   services="storsimple"
...
3. 백업 세트를 선택하고 확장합니다. **복원 및 삭제** 옵션이 페이지의 맨 아래에 표시 됩니다. 선택한 백업 세트에 이러한 동작 중 하나를 수행할 수 있습니다.
...
1. StorSimple 관리자 서비스 페이지에서 **백업 카탈로그 탭**을 클릭합니다.
...
3. 백업 세트를 선택하고 확장합니다. **복원 및 삭제** 옵션이 페이지의 맨 아래에 표시 됩니다. **삭제**를 클릭합니다. 백업 삭제
