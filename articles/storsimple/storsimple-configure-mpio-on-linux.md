...
2. 볼륨은 StorSimple 장치에서 CentOS 서버에 노출됩니다. 자세한 내용은 StorSimple 장치에서 Azure 클래식 포털을 통한 [6단계: 볼륨 만들기](storsimple-deployment-walkthrough.md#step-6-create-a-volume) 를 참조하세요.
