...
5. 확인 아이콘 ![확인 아이콘](./media/storsimple-ova-manage-acrs/check-icon.png)로 이동합니다. 테이블 형식 목록이 이 추가 사항을 반영하도록 업데이트됩니다.
...
5. 확인 아이콘 ![확인 아이콘](./media/storsimple-ova-manage-acrs/check-icon.png)로 이동합니다. 테이블 형식 목록이 이 변경 내용을 반영하도록 업데이트됩니다.
...
4. 확인 아이콘 ![확인 아이콘](./media/storsimple-ova-manage-acrs/check-icon.png)로 이동합니다. 테이블 형식 목록이 삭제를 반영하도록 업데이트됩니다.
