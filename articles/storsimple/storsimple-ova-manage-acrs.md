<properties 
   pageTitle="StorSimple 가상 배열에 대한 액세스 제어 레코드 관리 | Microsoft Azure"
...
> [AZURE.NOTE] 현재 사용하지 않고 있는 ACR만 수정해야 합니다. 현재 사용 중인 볼륨과 연관된 ACR을 편집하려면 먼저 볼륨을 오프라인으로 전환해야 합니다.
...
5. 확인 아이콘![확인 아이콘](./media/storsimple-ova-manage-acrs/check-icon.png)을 클릭합니다. 테이블 형식 목록이 삭제를 반영하도록 업데이트됩니다.
