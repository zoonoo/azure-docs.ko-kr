...
## 저장소 사양
StorSimple 장치에는 8100 및 8600에 대한 하드 디스크 드라이브 및 반도체 드라이브가 혼합되어 있습니다. 8100 및 8600에 대한 총 사용 가능한 용량은 각각 약 15TB 및 40TB입니다. 다음 표에서는 SSD, HDD 및 StorSimple 솔루션 용량의 컨텍스트에서 클라우드 용량에 대한 세부 정보를 설명합니다.
