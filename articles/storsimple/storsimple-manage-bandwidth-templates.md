...
대역폭 템플릿을 사용하면 데이터를 StorSimple 장치에서 클라우드로 티어하도록 여러 시간의 일정을 구성할 수 있습니다. 이 일정을 만들고, 수정하고, 삭제하고 템플릿으로 저장할 수도 있습니다. 볼륨 컨테이너에 이 대역폭 템플릿을 적용하여 클라우드를 포함하는 작업을 수행할 때 StorSimple 장치가 차지하는 대역폭을 제어할 수 있습니다. 대역폭 사용 패턴에 따라 기본 템플릿의 목록에서 선택할 수도 있습니다.
...
이 기능은 가상 장치가 아닌 StorSimple 물리적 장치에 대해서만 사용할 수 있습니다. 서비스에 대한 모든 대역폭 템플릿은 테이블 형식으로 표시되며 다음 정보를 포함합니다.
...
Azure 클래식 포털의 StorSimple Manager 서비스 **구성** 페이지를 사용하여 대역폭 템플릿을 관리합니다. 이 페이지에서 수행할 수 있는 대역폭 템플릿과 관련된 가장 일반적인 작업은 다음과 같습니다.
...
> [AZURE.NOTE]편집한 일정이 수정하려는 대역폭 템플릿의 기존 일정와 겹치는 경우, 변경 내용을 저장할 수 없습니다.
