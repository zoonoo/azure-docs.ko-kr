...
> [!IMPORTANT]
> - 업데이트는 작업 중단 업데이트이며 장치를 다시 시작합니다. I/O가 진행 중인 경우 장치에 가동 중지 시간이 발생합니다. 업데이트를 적용하는 방법에 대한 자세한 내용은 [업데이트 1.1 설치](storsimple-virtual-array-install-update-11.md)를 참조하세요.
>
> - 업데이트 1.1은 장치에서 업데이트 1.0을 실행하는 경우에만 Azure Portal을 통해 사용할 수 있습니다.
...
| 2 |로깅| 이 릴리스는 장치가 자세한 정보 표시 모드의 지원 세션에 있는 동안의 로깅 변경 내용을 포함하고 있습니다.|
