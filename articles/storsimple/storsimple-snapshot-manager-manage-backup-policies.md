...
백업 정책은 로컬로 또는 클라우드에 볼륨 데이터를 백업하기 위한 일정을 만듭니다. 백업 정책을 만들 때 보존 정책을 지정할 수도 있습니다. 최대 64개의 스냅숏을 유지할 수 있습니다. 백업 정책에 대한 자세한 내용은 [StorSimple 8000 시리즈의](storsimple-overview.md) [백업 유형:](storsimple-what-is-snapshot-manager.md#backup-types-and-backup-policies) 하이브리드 클라우드 솔루션을 참조하십시오.
