...
| 경고 텍스트 | 이벤트 | 자세한 내용 / 권장 작업 |
|:--- |:--- |:--- |
| <*장치 이름* \> 에 대 한 암호는 <*수* \> 일 후에 만료 됩니다. |암호 경고. |암호는 <*수* \> 일 후에 만료 됩니다. 암호를 변경하는 것이 좋습니다. 자세한 내용은 [StorSimple Virtual Array 디바이스 관리자 암호를 변경](storsimple-virtual-array-change-device-admin-password.md)으로 이동합니다. |
