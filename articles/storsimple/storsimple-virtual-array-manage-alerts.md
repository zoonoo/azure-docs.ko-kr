...
3. **일반 설정** 블레이드에서 **경고 설정** 섹션으로 이동하고 다음 항목을 설정합니다.
   ...
   3. **추가 메일 받는 사람** 필드에 경고 알림을 받을 다른 모든 받는 사람의 메일 주소를 입력합니다. *someone@somewhere.com* 형식으로 이름을 입력합니다. 세미콜론을 사용하여 메일 주소를 구분합니다. 가상 디바이스당 최대 20개의 메일 주소를 구성할 수 있습니다.
