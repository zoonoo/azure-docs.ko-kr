...
| --- | --- | --- | --- |
| 설치된 드라이브 없음 |OFF |OFF |None |
| 드라이브 설치됨 및 작동 |활동 시 깜박임 켜기/끄기 |X |None |
| SES(SCSI 인클로저 서비스) 디바이스 ID 집합 |켜기 |깜박임 1초 켜기/1초 끄기 |None |
...
| SBB 인터페이스 모듈 제거됨 |Warning |None |모듈 결함 |
| 드라이브 전원 컨트롤 결함 |경고 - 드라이브 전원 손실 없음 |S1 |모듈 결함 |
| 드라이브 전원 컨트롤 결함 |결함 - 중요, 드라이브 전원 손실 |S1 |모듈 결함 |
| 드라이브 제거됨 |Warning |None |모듈 결함 |
| 전원 부족 |Warning |none |모듈 결함 |

## <a name="next-steps"></a>다음 단계
[StorSimple 하드웨어 구성 요소 및 상태에](storsimple-8000-monitor-hardware-status.md)대해 자세히 알아보십시오.
