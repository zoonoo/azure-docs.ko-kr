...
이 자습서에서는 **작업** 노드를 사용하여 예약된 백업 작업, 최근 백업 작업 및 현재 실행 중인 백업 작업에 대한 정보를 표시하는 방법을 설명합니다. 작업 목록과 해당 정보가 **결과** 창에 나타납니다. 또한 나열된 작업을 마우스 오른쪽 단추로 클릭하고 사용 가능한 작업을 나열하는 상황에 맞는 메뉴를 볼 수 있습니다.
