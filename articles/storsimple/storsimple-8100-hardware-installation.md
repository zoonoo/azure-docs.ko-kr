...
Microsoft Azure StorSimple 8100은 단일 인클로저의 랙 탑재 장치입니다.

이 자습서는 StorSimple 소프트웨어를 구성하기 전에 StorSimple 8100 장치 하드웨어를 개봉하고 랙에 탑재하고 케이블로 연결하는 방법을 설명합니다.
...
>[AZURE.WARNING]![무거움 아이콘](./media/storsimple-8100-hardware-installation/HCS_HeavyWeight_Icon.png)
>
...
다음 단계를 따라 전면/후면 포스트가 있는 표준 19인치 랙에 StorSimple 8100 저장소 장치를 설치하십시오. StorSimple 8100 장치에는 단일 기본 인클로저가 있습니다.
...
3. 높은 가용성을 위해 다음을 연결해야 합니다.
    1. 각 컨트롤러 상의 동일한 인터페이스와 관련 네트워크를 연결하여 컨트롤러 장애 발생 시 가용성 보장
...
이제 장치가 케이블로 전원, 네트워크 액세스 및 직렬 장치에 연결되었습니다. 다음 단계는 장치에 소프트웨어를 구성하는 것입니다.
