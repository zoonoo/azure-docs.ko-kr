...
* Azure 관리자는 정기적으로 Azure Portal의 [저장소] 섹션을 사용해 직접 저장소 계정에 액세스하여 기본 또는 보조 키를 변경하거나 다시 생성해야 합니다.
