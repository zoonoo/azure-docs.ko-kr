...
# StorSimple 가상 배열 장치 관리자 암호 변경(미리 보기)

## 개요

Windows PowerShell 인터페이스를 사용하여 StorSimple 가상 장치에 액세스할 때 장치 관리자 암호를 입력해야 합니다. StorSimple 장치를 처음으로 프로비저닝하고 시작할 때 기본 암호는 Password1입니다. 데이터 보안을 위해 처음 로그인하면 기본 암호가 만료되며, 암호를 변경해야 합니다.
