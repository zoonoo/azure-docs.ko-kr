...
StorSimple 장치 관리자 서비스 요약 블레이드에서는 심각도 수준에 따라 정렬되어 있는, 장치의 경고 수를 한 눈에 볼 수 있습니다.
