---
title: "StorSimple 가상 배열에 대한 StorSimple Manager 서비스 배포| Microsoft Docs"
...
---
# <a name="deploy-the-storsimple-manager-service-for-storsimple-virtual-array"></a>StorSimple 가상 배열을 위한 StorSimple Manager 서비스 배포
...
> [!NOTE]
> StorSimple 8000 시리즈 장치와 StorSimple 가상 배열을 관리하려면 별도의 StorSimple Manager 서비스 인스턴스가 필요합니다.
> 
> 
...
6. 확인 아이콘 ![확인 아이콘](./media/storsimple-ova-manage-service/image7.png) 을 클릭하고 이 대화 상자를 닫습니다.
