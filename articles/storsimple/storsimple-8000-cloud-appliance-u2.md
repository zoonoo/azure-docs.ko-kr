...
| **저장소 유형** |로컬 디스크에 Azure Standard Storage 사용<br></br> [Standard Storage 계정을 만드는](../storage/common/storage-account-create.md) |로컬 디스크용 Azure Premium Storage 사용<sup>2</sup> <br></br> |
