...
| 선택됨 |**선택** 열은 볼륨 그룹에 포함된 볼륨의 수를 표시합니다. 0이면 볼륨 그룹의 볼륨에 연결된 애플리케이션이 없음을 나타냅니다. |
...
3. **Backup 수행** 대화 상자에서 **로컬 스냅샷** 또는 **클라우드 스냅샷**를 선택한 다음, **만들기**를 클릭합니다.
...
3. 볼륨 그룹 만들기 대화 상자가 나타납니다. **이름**, **애플리케이션** 및 **볼륨** 항목을 변경할 수 있습니다.
...
3. **볼륨 그룹 삭제** 대화 상자가 나타납니다. 텍스트 상자에 **확인**을 입력한 다음 **확인**을 클릭합니다.
