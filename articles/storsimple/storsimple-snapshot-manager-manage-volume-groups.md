...
3. **볼륨 그룹 삭제** 대화 상자가 나타납니다. 텍스트 상자에 **Confirm**을 입력한 다음 **확인**을 클릭합니다.
    ...
    삭제된 볼륨 그룹이 **결과** 창의 목록에서 사라지고 해당 볼륨 그룹에 연결된 모든 백업은 백업 카탈로그에서 삭제됩니다.
