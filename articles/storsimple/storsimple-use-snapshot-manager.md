...
| 메뉴 항목 | 설명 |
|:--- |:--- |
| 새로 만들기 |**새로 만들기** 를 클릭하면 StorSimple 스냅샷 관리자를 기반으로 새 콘솔을 만듭니다. |
...
| 스냅인 추가/제거 |**스냅인 추가/제거**를 클릭하면 스냅인을 추가하거나 제거하고 **범위** 창에서 노드를 구성할 수 있습니다. 자세한 내용은 [MMC 3.0에서의 스냅인 추가, 제거 및 구성](https://technet.microsoft.com/library/cc722035.aspx)에서 제공합니다. |
...
| 끝내기 |**종료**를 클릭하면 **파일** 메뉴를 닫을 수 있습니다. |
...
**작업** 창(콘솔의 오른쪽에 있음)에는 **작업** 메뉴와 동일한 작업 목록이 있습니다. 또한 **작업** 창에는 **뷰** 메뉴 옵션이 있으며, 이 메뉴 옵션을 통해 **결과** 창의 사용자 지정 뷰를 만들 수 있습니다.
...
* **작업** 열에는 노드 및 결과에 대해 수행할 수 있는 작업이 나열되어 있습니다. 
* **탐색** 열에는 작업을 선택할 수 있도록 적절한 **작업** 메뉴를 표시하는 방법이 설명되어 있습니다. 일부 작업은 여러 **작업** 메뉴에 표시됩니다. 이러한 작업의 경우 글머리 기호 목록에서 **탐색** 옵션을 하나 선택합니다. 
* **설명** 열에서는 **작업** 메뉴의 각 작업 또는 작업 창 사용 방법과 그 기능에 대해 설명합니다.

> [!NOTE]
> **작업** 창 및 **작업** 메뉴에는 **뷰**, **여기에서 창 새로 만들기**, **새로 고침**, **목록 내보내기**, **도움말** 등의 추가 옵션이 포함되어 있습니다. 이러한 옵션은 MMC의 일부로 제공되며 StorSimple 스냅샷 관리자 특정 메뉴가 아닙니다. 표에서는 이 옵션에 대해 설명합니다.
> 
> 
...
| 디바이스 구성 |**장치** 노드를 마우스 오른쪽 단추로 클릭합니다. |**디바이스 구성** 을 클릭하여 Windows 호스트에 연결할 단일 디바이스 또는 여러 디바이스를 구성합니다. |
...
| DELETE |노드 또는 결과(여러 **작업** 메뉴 및 **작업** 창에 표시되는 항목)를 클릭합니다. |**삭제**를 클릭하면 선택한 노드 또는 결과를 삭제할 수 있습니다. 확인 대화 상자가 나타나면 삭제를 확인하거나 취소합니다. |
...
| 여기에서 창 새로 만들기 |아무 노드 또는 결과를 클릭합니다(이 항목은 모든 **작업** 메뉴 및 **작업** 창에 표시됨). |**여기에서 창 새로 만들기** 를 클릭하여 새 StorSimple 스냅샷 관리자 창을 엽니다. |
| 새로 고침 |아무 노드 또는 결과를 클릭합니다(이 항목은 모든 **작업** 메뉴 및 **작업** 창에 표시됨). |**새로 고침** 을 클릭하여 현재 표시된 StorSimple 스냅샷 관리자 창을 업데이트합니다. |
...
| 디바이스 새로 고침 |**장치** 노드를 마우스 오른쪽 단추로 클릭합니다. |**디바이스 새로 고침**을 클릭하여 연결 디바이스 목록을 StorSimple Snapshot Manager와 동기화합니다. |
| 볼륨 다시 검사 |**볼륨** 노드를 마우스 오른쪽 단추로 클릭합니다. |**볼륨 다시 검사**를 클릭하면 **결과** 창에 표시되는 볼륨 목록을 업데이트할 수 있습니다. |
| 복원 |**백업 카탈로그**, 볼륨 그룹 및 **로컬 스냅숏** 또는 **클라우드 스냅숏**을 차례로 확장한 후 백업을 마우스 오른쪽 단추로 클릭합니다. |**복원**을 클릭하면 현재 볼륨 그룹 데이터를 선택한 백업의 데이터로 바꿀 수 있습니다. |
| Backup 수행 |다음 중 하나를 수행합니다.<ul><li>**볼륨 그룹**을 확장한 후 볼륨 그룹을 마우스 오른쪽 단추로 클릭합니다.</li><li>**백업 카탈로그**를 확장한 후 볼륨 그룹을 마우스 오른쪽 단추로 클릭합니다.</li></ul> |**백업 수행**을 클릭하면 백업 작업을 즉시 시작할 수 있습니다. |
...
| Enter |Enter 키를 누르면 특정 동작을 완료 한 후 다음 단계를 진행합니다. 예를 들어 Enter 키를 눌러 **다음**, **확인** 또는 **만들기**를 선택하고 마법사의 다음 단계로 이동할 수 있습니다. |
