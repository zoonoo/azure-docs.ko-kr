...
> [!IMPORTANT]
> 방화벽이 StorSimple 디바이스 및 Azure 사이의 모든 TLS 트래픽을 수정하거나 암호를 해독하지 않도록 해야 합니다.
