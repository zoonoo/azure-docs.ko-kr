...
> [AZURE.NOTE] Microsoft Azure 웹 사이트에 게시된 StorSimple 배포 정보는 StorSimple 8000 시리즈 장치에만 적용됩니다. 7000 시리즈 장치에 대한 정보는 다음으로 이동합니다. [StorSimple 도움말](http://onlinehelp.storsimple.com/).

## StorSimple 장치

Microsoft Azure StorSimple 장치는 기본 저장소 및 다른 곳에 저장된 데이터에 대한 iSCSI 액세스를 제공하는 온-프레미스 하이브리드 저장소 배열입니다. 클라우드 저장소와의 통신을 관리하고 보안 및 Microsoft Azure StorSimple 솔루션에 저장된 모든 데이터의 기밀성을 보장하는데 도움이 됩니다.
...
자세한 내용은 [StorSimple Manager 서비스](https://msdn.microsoft.com/library/azure/dn772396.aspx)를 참조하세요.
