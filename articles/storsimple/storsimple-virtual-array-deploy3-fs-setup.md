...
설정 및 구성 프로세스를 완료하는 데 10분 정도가 소요됩니다. 이 문서의 정보는 StorSimple 가상 배열의 배포에만 적용됩니다. StorSimple 8000 시리즈 디바이스를 배포하는 경우 [업데이트 2를 실행하는 StorSimple 8000 시리즈 디바이스 배포](./storsimple-8000-deployment-walkthrough-u2.md)를 참조하세요.
