...
3. 장치가 준비되기까지 5-10분 정도 걸릴 수 있습니다. 콘솔에 진행률을 나타내는 상태 메시지가 표시됩니다. 장치가 준비되면 **작업**으로 이동합니다. `Ctrl + Alt + Delete` 키를 눌러서 가상 장치에 로그인합니다. 기본 사용자는 *StorSimpleAdmin*이고 기본 암호는 *Password1*입니다.
...
5. 암호 변경이 완료되면 가상 장치가 다시 시작됩니다. 장치가 시작할 때까지 기다립니다.
