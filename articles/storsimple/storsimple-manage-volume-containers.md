...
* **Storage 계정** – 클라우드 Storage 서비스 공급자에 연결된 Storage 계정입니다. 볼륨 컨테이너에 있는 모든 볼륨은 이 저장소 계정을 공유합니다. 기존 목록에서 저장소 계정을 선택하거나 볼륨 컨테이너를 만들고 해당 계정에 대한 액세스 자격 증명을 지정하는 경우 새 계정을 만들 수 있습니다.
