...
1. 로 [https://ms.portal.azure.com](https://ms.portal.azure.com)이동합니다.
...
| 공유 및 볼륨 백업</br>수동 백업 수행</br>백업 일정 변경</br>기존 백업 보기 |[StorSimple 가상 배열 백업](storsimple-virtual-array-backup.md) |
| 백업 세트에서 공유 복제</br>백업 세트에서 볼륨 복제</br>항목 수준 복구(파일 서버에만 해당) |[StorSimple 가상 배열의 백업에서 복제](storsimple-virtual-array-clone.md) |
| Storage 계정 정보</br>스토리지 계정 추가</br>스토리지 계정 편집</br>스토리지 계정 삭제 |[StorSimple 가상 배열에 대한 스토리지 계정 관리](storsimple-virtual-array-manage-storage-accounts.md) |
...
| 디바이스 관리자 암호 수정 |[StorSimple Virtual Array 디바이스 관리자 암호 변경](storsimple-virtual-array-change-device-admin-password.md) |
