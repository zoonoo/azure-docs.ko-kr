...
> [!IMPORTANT]
> 디스크 드라이브를 꺼내고 교체하기 전에 [StorSimple 하드웨어 구성 요소 교체](storsimple-hardware-component-replacement.md)에서 안전 정보를 검토하세요.
> 
> 
...
> * Azure 클래식 포털에서 슬롯에는 0 – 11 사이의 번호가 매겨져 있습니다. 따라서 포털에 슬롯 2의 디스크에서 오류가 발생했다고 표시되면 장치 왼쪽 위에서 세 번째 슬롯에서 오류가 발생한 디스크를 찾습니다.
> 
> 
