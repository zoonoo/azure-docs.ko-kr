...
1. 상자와 포장 발포 폼에 찌그러짐, 자르기, 물에 의한 손상 또는 기타 손상이 없는지 검사합니다. 상자나 포장이 심각하게 손상된 경우에는 상자를 열지 마세요. 장치가 올바르게 작동하는지 여부를 평가하려면 Microsoft 지원에 문의 하세요.
...
3. 두 상자를 개봉한 후 다음이 있는지 확인합니다.
  ...
  - 시작 설명서
    ...
    위에 나열된 항목 중에 수신하지 않은 것이 있다면 Microsoft 지원에 문의하세요.
