---
title: 마이크로 소프트 Azure Stor간단한 8600 장치를 설치
...
> [!NOTE]
> **라이트 아웃 관리:** 장치가 원격 데이터 센터 또는 액세스가 제한된 컴퓨터실에 설치된 경우 두 컨트롤러에 대한 직렬 연결이 항상 직렬 콘솔 스위치 또는 유사한 장비에 연결되어 있는지 확인합니다. 이렇게 하면 네트워크 중단 또는 예기치 않은 장애 발생 시 대역 외 원격 제어 및 지원 작업이 허용됩니다.
> 
> 
