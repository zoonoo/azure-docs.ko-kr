...
> [AZURE.IMPORTANT]
>
>- 이 업데이트는 Windows Update를 통해 사용할 수 없으며 다른 업데이트와 같이 설치할 수 없습니다. 장치 Azure 포털을 사용하여 업데이트를 적용한 경우에도 이 업데이트가 수신되지 않습니다. 이 업데이트는 2015년 1월 20일 이후에 만들어진 가상 장치에만 적용됩니다. 
> 
