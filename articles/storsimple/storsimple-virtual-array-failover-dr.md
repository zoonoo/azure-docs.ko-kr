...
이 문서는 StorSimple 가상 배열에만 적용할 수 있습니다. 8000 시리즈 디바이스에 장애 조치를 하려면 [StorSimple 디바이스에 대한 디바이스 장애 조치 및 재해 복구](./storsimple-8000-device-failover-disaster-recovery.md)로 이동합니다.
...
14. 연결하려는 모든 애플리케이션이 새 디바이스에 리디렉션되도록 [DNS 별칭을 만들](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/cc772053(v=ws.11)?redirectedfrom=MSDN)어야 합니다.
