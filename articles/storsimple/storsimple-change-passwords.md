...
Azure 클래식 포털 **구성** 페이지에는 StorSimple 관리자 서비스로 관리되는 StorSimple 장치에서 다시 구성할 수 있는 모든 장치 매개 변수가 포함되어 있습니다. 이 자습서에서는 **구성** 페이지에서 StorSimple 스냅숏 관리자 또는 장치 관리자 암호를 변경하는 방법에 대해 설명합니다.
