...
## <a name="change-the-storsimple-snapshot-manager-password"></a>StorSimple 스냅숏 관리자 암호 변경
...
#### <a name="to-change-the-storsimple-snapshot-manager-password"></a>StorSimple 스냅숏 관리자 암호 변경 방법
1. 클래식 포털에서 사용자의 장치에 대해 **장치** > **구성**을 클릭합니다.
