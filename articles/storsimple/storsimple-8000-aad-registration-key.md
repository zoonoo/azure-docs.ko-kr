---
title: Azure에서 StorSimple 8000 Device Manager 서비스에 대 한 새 인증 사용
...
| 업데이트 5 이상을 실행 중이고 디바이스가 온라인 상태입니다.| 아무런 작업도 필요하지 않습니다.                                       |
...
1. **StorSimple Device Manager**에서 **관리 &gt;** **키**로 이동 합니다. 검색 창을 사용하여 _키_를 검색할 수도 있습니다.
