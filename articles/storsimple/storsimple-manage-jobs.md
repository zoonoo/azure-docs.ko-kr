...
1. **작업** 페이지에서 적절한 필터를 사용하여 쿼리를 실행하여 관심 있는 작업을 표시합니다. 완료되거나, 실행 중이거나, 취소된 작업을 검색할 수 있습니다.
...
1. **작업** 페이지에서 적절한 필터를 사용하여 쿼리를 실행하여 취소하려는 실행 중인 작업을 표시합니다.

1. 작업을 선택합니다.

1. 페이지 맨 아래에 있는 **취소**를 클릭합니다.
...
[StorSimple 백업 정책 관리 방법에 대해 알아봅니다](storsimple-manage-backup-policies.md).
