...
| SAS 확장기 |입력/출력 |물리적 |Controller |아닙니다. |직렬 연결된 SCSI(SAS) 확장기의 상태를 표시하며, 통합된 저장소를 컨트롤러에 연결하는 데 사용됩니다. |
| SAS 커넥터 [0-1] |입력/출력 |물리적 |Controller |아닙니다. |SAS 확장기에 통합된 저장소를 연결하는데 사용되는 각 SAS 커넥터의 상태를 나타냅니다. |
...
| SAS 확장기 |입력/출력 |물리적 |Controller |아닙니다. |SAS 확장기의 상태를 표시하며, 통합된 저장소를 컨트롤러에 연결하는 데 사용됩니다. |
| SAS 커넥터 [0-2] |입력/출력 |물리적 |Controller |아닙니다. |SAS 확장기에 통합된 저장소를 연결하는데 사용되는 각 SAS 커넥터의 상태를 나타냅니다. |
| SBB 중간 평면 상호 연결 |입력/출력 |물리적 |Controller |아닙니다. |각 컨트롤러에서 중간 평면에 연결하는데 사용되는 중간 평면 커넥터의 상태를 나타냅니다. |
| 인클로저 전자 기기 전원 |입력/출력 |물리적 |Controller |아닙니다. |인클로저에에서 사용된 전원 시스템의 상태를 나타냅니다. |
| 인클로저 전자 기기 진단 |입력/출력 |물리적 |Controller |아닙니다. |컨트롤러에서 제공된 진단 하위 시스템의 상태를 나타냅니다. |
