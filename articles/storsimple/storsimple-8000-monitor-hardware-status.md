...
| 구성 요소 | 모듈 | Type | 위치 | FRU(Field replaceable unit)? | Description |
| --- | --- | --- | --- | --- | --- |
| 슬롯 [0-11]의 드라이브 |디스크 드라이브 |물리적 |공유됨 |yes |기본 인클로저의 SSD 또는 HDD 드라이브의 각각에 대해 한 줄이 표시됩니다. |
...
| 인클로저 |인클로저 |물리적 |공유됨 |yes |섀시의 존재를 표시합니다. |
...
| 전원 공급 장치 [0-1] |PCM |물리적 |공유됨 |yes |각 디바이스 뒷면에 두 PCM의 전원 공급 디바이스에 대한 한 줄이 표시됩니다. |
| 냉각 장치 [0-1] |PCM |물리적 |공유됨 |yes |두 PCM에 있는 4개의 냉각팬 각각에 대해 한 줄이 표시됩니다. |
| 배터리 [0-1] |PCM |물리적 |공유됨 |yes |PCM에 장착된 백업 배터리 모듈 각각에 대한 한 줄이 표시됩니다. |
...
| 구성 요소 | 모듈 | Type | 위치 | FRU? | Description |
| --- | --- | --- | --- | --- | --- |
| 슬롯 [0-11]의 드라이브 |디스크 드라이브 |물리적 |공유됨 |yes |EBOD 인클로저 전면의 HDD 드라이브의 각각에 대해 한 줄이 표시됩니다. |
| 주변 온도 센서 |인클로저 |물리적 |공유됨 |예 |섀시 내에서 온도를 측정합니다. |
| 중간 평면 온도 센서 |인클로저 |물리적 |공유됨 |예 |중간 평면 온도를 측정합니다. |
| 청각적 경고 |인클로저 |물리적 |공유됨 |예 |섀시 내 청각적 경고 하위 시스템의 작동 여부를 나타냅니다. |
| 인클로저 |인클로저 |물리적 |공유됨 |yes |섀시의 존재를 표시합니다. |
