---
title: "StorSimple 가상 배열 백업 자습서 | Microsoft Docs"
...
---
# <a name="back-up-your-storsimple-virtual-array"></a>StorSimple 가상 배열 백업
...
## <a name="back-up-shares-and-volumes"></a>백업 공유 및 볼륨
...
## <a name="change-the-backup-schedule"></a>백업 일정 변경
...
#### <a name="to-create-a-manual-on-demand-backup"></a>수동(주문형) 백업을 만들려면
...
5. 적절한 장치, 백업 정책 및 시간 범위로 필터 선택을 설정한 후 확인 아이콘  ![확인 아이콘](./media/storsimple-ova-backup/image3.png))으로 백업할 수 있습니다.
...
![video_icon](./media/storsimple-ova-backup/video_icon.png) **동영상 사용 가능**
