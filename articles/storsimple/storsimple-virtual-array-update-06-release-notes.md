...
| **13.** |iSCSI 서버 |iSCSI 볼륨에 대해 표시되는 '사용된 스토리지'가 StorSimple 디바이스 관리자 서비스와 iSCSI 호스트에서 다를 수 있습니다. |iSCSI 호스트에는 파일 시스템 보기가 있습니다.<br></br>볼륨이 최대 크기일 때 디바이스에서는 블록이 할당된 것을 봅니다. |
