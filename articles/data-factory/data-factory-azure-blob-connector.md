<properties 
	...
	description="Azure 데이터 팩터리를 사용하여 Azure Blob 저장소 간 데이터를 이동하는 방법에 대해 알아봅니다."
...
# Azure 데이터 팩터리를 사용하여 Azure Blob 간 데이터 이동
...
| encodingName | 인코딩 이름을 지정합니다. 올바른 인코딩 이름 목록은 [Encoding.EncodingName 속성](https://msdn.microsoft.com/library/system.text.encoding.aspx)을 참조하세요. 예: windows-1250 또는 shift\_jis 기본값은 UTF-8입니다. | 아니요 | 
