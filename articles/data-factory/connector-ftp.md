...
FTP 커넥터는 passive 모드에서 실행 되는 FTP 서버를 지원 합니다. 활성 모드는 지원 되지 않습니다.
...
| 속성   | Description                                                  | 필수 |
| ---------- | ------------------------------------------------------------ | -------- |
| type       | 데이터 집합의 **`location`에 있는**type 속성은이 (가)로 설정 되어야 합니다. | yes      |
...
| 속성                 | Description                                                  | 필수                                      |
| ------------------------ | ------------------------------------------------------------ | --------------------------------------------- |
| type                     | `storeSettings` 아래의 type 속성은 **Ftpreadsettings**로 설정 되어야 합니다. | yes                                           |
