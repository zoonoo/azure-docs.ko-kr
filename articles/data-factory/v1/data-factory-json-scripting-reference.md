...
| userName 이름 |사용자 계정의 사용자 이름을 지정합니다. |예. authenticationType은 Basic으로 설정됩니다. |
...
| userName 이름 |FTP 서버에 액세스하는 사용자 |아니요 |&nbsp; |
...
| 속성 | 설명 | 필수 |
| --- | --- | --- |
| userName 이름 | HTTP 엔드포인트 액세스를 위한 사용자 이름입니다. | 예 |
| password | 사용자(사용자 이름) 암호. | 예 |
