...
| 입력 | 선택 사항입니다. 입력 데이터 집합을 지정 하는 경우 저장 프로시저 작업을 실행 하는 데 ' 준비 ' 상태를 사용할 수 있어야 합니다. 저장 프로시저에서 입력 데이터 세트를 매개 변수로 사용할 수 없습니다. 저장 프로시저 작업을 시작하기 전에 종속성을 확인하는 데만 사용됩니다. |아니요 |
...
| storedProcedureName |출력 테이블에서 사용 하는 연결 된 서비스로 표시 되는 Azure SQL Database, Azure Synapse Analytics 또는 SQL Server의 저장 프로시저 이름을 지정 합니다. |예 |
