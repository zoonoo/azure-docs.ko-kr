...
출력 데이터 세트 JSON에서 **type**을 **SqlServerTable**로 설정합니다. Azure SQL Database에 사용하기 위해 이 항목을 **AzureSqlTable**로 설정합니다. **tableName** 속성 값은 저장 프로시저의 첫 번째 매개 변수 이름과 일치해야 합니다.  
