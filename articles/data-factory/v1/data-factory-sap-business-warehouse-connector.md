...
이 데이터 세트는 SAP Business Warehouse 데이터 세트를 정의합니다. Data Factory 데이터 집합의 type은 **RelationalTable**로 설정합니다. 현재 SAP BW 데이터 세트에 대한 type별 속성은 지정하지 않습니다. 활동 복사 정의의 쿼리는 SAP BW 인스턴스에서 읽을 데이터를 지정합니다. 
