...
| 자산 | 설명 | 필수 |
| --- | --- | --- |
| 형식 |형식 속성은 **OnPremisesTeradata** |yes |
...
**typeProperties** 섹션은 데이터 집합의 각 형식에 따라 다르며 데이터 저장소에 있는 데이터의 위치에 대한 정보를 제공합니다. 현재 Teradata 데이터 세트에 대해 지원되는 형식 속성은 없습니다.
