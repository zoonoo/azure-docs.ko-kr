...
| 자산 | 설명 | 필수 |
| --- | --- | --- |
| 형식 | **type** 속성은 **Http**로 설정해야 합니다. | yes |
...
| 자산 | 설명 | 필수 |
| --- | --- | --- |
| 사용자 이름 | HTTP 엔드포인트에 액세스하는 데 사용할 사용자 이름입니다. | yes |
| 암호 | 사용자(**username**)의 암호입니다. | yes |
...
| 압축 | 데이터에 대한 압축 유형 및 수준을 지정합니다. 지원되는 형식: **GZip**, **Deflate**, **BZip2** 및 **ZipDeflate**. 지원되는 수준: **Optimal** 및 **Fastest**. 자세한 내용은 [Azure Data Factory의 파일 및 압축 형식](data-factory-supported-file-and-compression-formats.md#compression-support)을 참조하세요. |아니요 |
...
*   [Http](#dataset-properties) 형식의 입력 [데이터 집합](data-factory-create-datasets.md)입니다.
