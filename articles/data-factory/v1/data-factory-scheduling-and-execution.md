...
다음 파이프라인 정의에서 **scheduler** 속성은 활동에 대한 일정을 지정하는 데 사용됩니다. 이 속성은 선택적입니다. 현재 활동에 대한 일정은 출력 데이터 세트에 지정된 일정과 일치해야 합니다.
...
| anchorDateTime |스케줄러에서 사용하는 시간에 절대 위치를 정의하여 데이터 세트 조각 경계를 컴퓨팅합니다. <br/><br/><b>참고</b>: AnchorDateTime에 빈도보다 더 세분화된 날짜 부분이 있는 경우 더 세분화된 부분을 무시합니다. <br/><br/>예를 들어 <b>간격</b>이 <b>매시간</b>으로 설정됩니다(frequency: hour and interval: 1)이고 <b>AnchorDateTime</b>에서 <b>분 및 초</b>를 포함하는 경우 AnchorDateTime의 <b>분 및 초</b> 부분은 무시됩니다. |아닙니다. |01/01/0001 |
