...
Azure SQL Database에서 입력 또는 출력 데이터를 표시할 데이터 세트를 지정하려면 데이터 세트의 형식 속성을 다음으로 설정합니다. **AzureSqlTable**. 데이터 세트의 **linkedServiceName** 속성을 Azure SQL 연결된 서비스의 이름으로 설정합니다.
