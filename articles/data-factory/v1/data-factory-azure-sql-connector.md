...
> [!NOTE]
> 이 문서는 Data Factory 버전 1에 적용됩니다. 현재 버전의 Data Factory 서비스를 사용 중인 경우, [V2의 Azure SQL Database 커넥터](../connector-azure-sql-database.md)를 참조하세요.
