...
* Azure Blob Storage: 이 실험에서는 Azure Blob Storage(GRS)를 사용하여 TPC-H 테스트 데이터 집합을 저장합니다.  Azure Storage 계정이 없을 경우 [저장소 계정을 만드는 방법](../../storage/common/storage-quickstart-create-account.md)을 참조하세요.
