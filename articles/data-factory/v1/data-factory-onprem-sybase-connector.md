...
| 속성 | 설명 | 필수 |
| --- | --- | --- |
| type |type 속성을 다음으로 설정해야 합니다. **OnPremisesSybase** |예 |
...
다음 예에서는 사용 하 여 파이프라인을 만드는 데 사용할 수 있는 샘플 JSON 정의 [Visual Studio](data-factory-copy-activity-tutorial-using-visual-studio.md) 하거나 [Azure PowerShell](data-factory-copy-activity-tutorial-using-powershell.md)합니다. 이 샘플은 Sybase 데이터베이스에서 Azure Blob Storage로 데이터를 복사하는 방법을 보여 줍니다. 그러나 Azure Data Factory의 복사 작업을 사용하여 [여기](data-factory-data-movement-activities.md#supported-data-stores-and-formats) 에 설명한 싱크로 데이터를 복사할 수 있습니다.   
