...
3. **새 데이터 팩터리** 창에서 다음을 수행합니다.  
    ...
    6. **만들기**를 클릭합니다.
3. 만들기가 완료 되 면 다음 이미지와 같이 **Data Factory** 블레이드가 표시 됩니다. ![Data Factory 홈 페이지](./media/data-factory-azure-blob-connector/data-factory-home-page.png)
