...
| linkedServiceName |작업에서 사용하는 연결된 서비스의 이름입니다. <br/><br/>작업은 필요한 계산 환경에 연결하는 연결된 서비스를 지정해야 할 수 있습니다. |HDInsight 작업 및 Azure 기계 학습 Batch 평가 작업의 경우 예  <br/><br/>다른 모든 사용자의 경우 아니요 |
