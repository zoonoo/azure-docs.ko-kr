...
이 파이프라인을 만드는 전체 연습은 [자습서: Blob Storage에서 SQL 데이터베이스로 데이터 복사](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)를 참조하세요. 
