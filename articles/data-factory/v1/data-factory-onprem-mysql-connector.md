...
> [!NOTE]
> 이 문서는 Data Factory 버전 1에 적용됩니다. 현재 버전의 Data Factory 서비스를 사용 중인 경우, [V2의 MySQL 커넥터](../connector-mysql.md)를 참조하세요.
...
| database |MySQL 데이터베이스의 이름입니다. |yes |
