---
title: 복사 작업 성능 및 조정 가이드 | Microsoft Docs
...
> [!NOTE]
> 더 높은 처리량을 위해 더 많은 클라우드 DMU가 필요하면 [Azure 지원](https://azure.microsoft.com/support/)에 문의하시기 바랍니다. 현재는 파일 크기가 각각 16MB 이상인, Blob 저장소에서 Blob 저장소, Data Lake Store 또는 Azure SQL Database로 여러 파일을 복사하는 경우에만 8 이상으로 설정할 수 있습니다.
> 
> 
