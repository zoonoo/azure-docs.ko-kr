...
데이터 팩터리를 사용해서 두 가지 방법으로 VSTS Git 리포지토리를 구성할 수 있습니다.

#### <a name="method1"></a> 구성 방법 1(VSTS Git 리포지토리): 시작하기 페이지
...
| **공동 작업 분기** | 게시에 사용되는 VSTS 공동 작업 분기입니다. 기본값은 `master`입니다. 다른 분기에서 리소스를 게시하려는 경우 이 설정을 변경합니다. | <your collaboration branch name> |
...
#### <a name="configuration-method-2--vsts-git-repo-ux-authoring-canvas"></a>구성 방법 2(VSTS Git 리포지토리): UX 제작 캔버스
...
다른 Azure Active Directory 테넌트에서 VSTS Git 리포지토리를 만들 수 있습니다. 다른 Azure AD 테넌트를 지정하려면 사용하고 있는 Azure 구독에 대한 관리자 권한이 있어야 합니다.
...
기능 분기에서 기능을 개발할 준비가 되면 **끌어오기 요청 만들기**를 클릭할 수 있습니다. 이 작업을 통해 끌어오기 요청을 수행하고, 코드 검토를 수행하고, 공동 작업 분기에 변경 내용을 병합할 수 있는 VSTS Git로 이동합니다. (기본값은 `master`입니다.) 공동 작업 분기에서 Data Factory 서비스에 게시할 수만 있습니다. 
...
| **설정**                                              | **설명**                                                                                                                                                                                                                                                                                                                                                                                                                   | **값**          |
|----------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------|
| **리포지토리 유형**                                      | VSTS 코드 리포지토리의 유형입니다.                                                                                                                                                                                                                                                                                                                                                                                             | GitHub             |
