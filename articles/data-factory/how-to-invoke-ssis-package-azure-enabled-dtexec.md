...
AzureDTExec을 호출한 후 SSIS 패키지 실행 활동이 있는 고유한 파이프라인이 생성되고 실행된 후 데이터 팩터리 포털에서 모니터링할 수 있습니다. 자세한 내용은 [SSIS 패키지 실행을 데이터 팩터리 활동으로](https://docs.microsoft.com/azure/data-factory/how-to-invoke-ssis-package-ssis-activity)참조하십시오.
