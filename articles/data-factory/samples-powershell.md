...
|[SQL Server에서 Azure Blob Storage로 데이터 복사](scripts/hybrid-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 이 PowerShell 스크립트는 SQL Server 데이터베이스에서 Azure Blob Storage로 데이터를 복사합니다. |
|[대량 복사](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 이 샘플 PowerShell 스크립트는 Azure SQL Database의 데이터베이스에 있는 여러 테이블의 데이터를 Azure Synapse Analytics로 복사합니다. |
