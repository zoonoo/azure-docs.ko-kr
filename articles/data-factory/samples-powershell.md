---
title: Azure Data Factory에 대한 Azure PowerShell 샘플 | Microsoft Docs
...
> [!NOTE]
> 이 문서는 현재 미리 보기 상태인 Data Factory 버전 2에 적용됩니다. GA(일반 공급) 상태인 Data Factory 버전 1 서비스를 사용 중인 경우 [Data Factory 버전 1의 샘플](v1/data-factory-samples.md)을 참조하세요.
...
|[대량 복사](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 이 샘플 PowerShell 스크립트는 Azure SQL Data Warehouse에 Azure SQL Database에 있는 여러 테이블의 데이터를 복사합니다. |
