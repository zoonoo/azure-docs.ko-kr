...
|[대량 복사](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 이 샘플 PowerShell 스크립트는 Azure SQL Database 데이터베이스의 여러 테이블에서 Azure SQL data warehouse로 데이터를 복사 합니다. |
