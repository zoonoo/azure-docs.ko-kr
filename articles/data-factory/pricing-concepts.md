...
1. AWS S3에서 복사될 데이터에 대한 입력 데이터 집합이 있는 복사 작업

2. Azure Storage의 데이터에 대한 출력 데이터 집합
...
| 데이터 집합 만들기 | 4개의 읽기/쓰기 엔터티(데이터 집합 만들기에 대해 2개, 연결된 서비스 참조에 대해 2개) |
| 파이프라인 만들기 | 3개의 읽기/쓰기 엔터티(파이프라인 만들기에 대해 1개, 데이터 집합 참조에 대해 2개) |
...
1. AWS S3에서 복사될 데이터에 대한 입력 데이터 집합 및 Azure 저장소의 데이터에 대한 출력 데이터 집합이 있는 하나의 복사 작업
