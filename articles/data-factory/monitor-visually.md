...
## <a name="monitoring-features"></a>모니터링 기능
...
Data Factory의 지원되는 메트릭에 대해 경고를 발생시킬 수 있습니다. 시작하려면 Data Factory 모니터링 페이지에서 모니터링 -> 경고 및 메트릭을 선택합니다.
