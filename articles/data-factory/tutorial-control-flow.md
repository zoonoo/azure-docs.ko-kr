...
이 자습서에서는 .NET SDK를 사용합니다. 다른 메커니즘을 사용하여 Azure Data Factory와 상호 작용할 수 있습니다. Data Factory 빠른 시작에 대해서는 [5분 빠른 시작](https://docs.microsoft.com/azure/data-factory/#5-minute-quickstarts)을 참조하세요.
