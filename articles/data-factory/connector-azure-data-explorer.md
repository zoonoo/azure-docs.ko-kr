...
2. Azure 데이터 탐색기에서 서비스 주체에 게 적절 한 권한을 부여 합니다. 역할 및 권한에 대 한 자세한 정보와 사용 권한 관리 연습은 [Azure 데이터 탐색기 데이터베이스 사용 권한 관리](../data-explorer/manage-database-permissions.md) 를 참조 하세요. 일반적으로 다음을 수행 해야 합니다.
...
| noTruncation | 반환 된 결과 집합을 잘라낼 지 여부를 나타냅니다. 기본적으로 결과는 50만 레코드 또는 64MB 후에 잘립니다. 작업의 적절 한 동작을 수행 하는 데는 잘림이 좋습니다. |아니요 |
