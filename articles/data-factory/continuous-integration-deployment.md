...
7.  Azure Resource Manager 배포 작업을 추가합니다.
    ...
    d.  **템플릿** 필드에서 **…** 를 선택합니다. 포털에서 게시 작업으로 만들어진 Resource Manager 템플릿(*ARMTemplateForFactory.json*)을 찾아봅니다. `adf_publish` 분기의 `<FactoryName>` 폴더에서 이 파일을 찾습니다.
