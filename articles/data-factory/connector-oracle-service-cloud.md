...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 형식 속성을 다음으로 설정해야 합니다. **OracleServiceCloud** | yes |
...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 데이터 세트의 형식 속성을 다음으로 설정해야 합니다. **OracleServiceCloudObject** | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 복사 작업 원본의 형식 속성을 다음으로 설정해야 합니다. **OracleServiceCloudSource** | yes |
