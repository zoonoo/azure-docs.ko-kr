...
## <a name="compliance-and-security-considerations"></a>규정 준수 및 보안 고려 사항

Azure Data Factory은 _SOC 1, 2, 3_, _HIPAA Baa_ 및 _HITRUST_ 를 비롯 한 다양 한 규정 준수 인증에 대해 인증 됩니다. 전체 및 증가 된 인증 목록은 [여기](data-movement-security-considerations.md)에서 찾을 수 있습니다. 감사 보고서 및 규정 준수 인증을 위한 디지털 복사본은 [서비스 보안 센터](https://servicetrust.microsoft.com/) 에서 찾을 수 있습니다.
