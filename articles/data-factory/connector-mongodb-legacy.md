...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| type |type 속성을 다음으로 설정해야 합니다. **MongoDb** |예 |
| server |MongoDB 서버의 IP 주소 또는 호스트 이름입니다. |예 |
| port |MongoDB 서버가 클라이언트 연결을 수신하는 데 사용하는 TCP 포트입니다. |아니요(기본값: 27017) |
...
| 2222 |XYZ |[{invoice_id:"135", item:"fridge", price: "12543", 할인: "0.0"}] |금 |[1,2] |
