---
title: Azure Data Factory를 사용하여 Azure Data Lake Storage Gen1에서 Gen2(미리 보기)로 데이터 복사
description: Azure Data Factory를 사용하여 Azure Data Lake Storage Gen1에서 Gen2(미리 보기)로 데이터 복사
...
1. 왼쪽 메뉴에서 **새로 만들기** > **데이터 + 분석** > **Data Factory**를 차례로 선택합니다.
   ...
   ![새 데이터 팩터리 만들기](./media/load-azure-data-lake-storage-gen2-from-gen1/new-azure-data-factory-menu.png)
...
9. **출력 파일 또는 폴더 선택** 페이지에서 출력 폴더 이름으로 **copyfromadlsgen1**을 입력하고, **다음**을 선택합니다. 
