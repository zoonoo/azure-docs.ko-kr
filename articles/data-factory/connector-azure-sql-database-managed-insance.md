...
>[!NOTE]
>저장 프로시저를 호출하여 **Money/Smallmoney** 데이터 형식에 쓰는 경우에는 값이 반올림될 수 있습니다. 테이블 반환 매개 변수의 해당 데이터 형식을 **Money/Smallmoney** 대신 **Decimal**로 지정하면 이 문제를 완화할 수 있습니다. 
