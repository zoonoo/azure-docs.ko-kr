---
title: Azure Data Factory를 사용하여 Concur에서 데이터 복사 | Microsoft Docs
...
---
# <a name="copy-data-from-concur-using-azure-data-factory"></a>Azure Data Factory를 사용하여 Concur에서 데이터 복사
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | type 속성은 **Concur**로 설정해야 합니다. | 예 |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 복사 작업 원본의 type 속성은 **ConcurSource**로 설정해야 합니다. | 예 |
