...
> * [버전 1 - GA](v1/data-factory-map-reduce.md)
> * [버전 2 - 미리 보기](transform-data-using-hadoop-map-reduce.md)
...
> [!NOTE]
> 이 문서는 현재 미리 보기 상태인 Data Factory 버전 2에 적용됩니다. GA(일반 공급) 상태인 Data Factory 버전 1 서비스를 사용 중인 경우 [V1의 MapReduce 작업](v1/data-factory-map-reduce.md)을 참조하세요.
...
| linkedServiceName | Data Factory에서 연결된 서비스로 등록된 HDInsight 클러스터에 대한 참조입니다. 이 연결된 서비스에 대한 자세한 내용은 [연결된 서비스 계산](compute-linked-services.md) 문서를 참조하세요. | 예      |
...
| jarlibs           | jarLinkedService에서 참조하는 Azure Storage에 저장된 작업에서 참조하는 Jar 라이브러리 파일의 경로를 제공합니다. 파일 이름은 대/소문자를 구분합니다. | 아니요       |
