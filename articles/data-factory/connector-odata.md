...
- OData 버전 3.0 및 4.0
- 인증 방법인 **익명**, **기본**, **Windows**, **AAD 서비스 주체** 및 **관리 서비스 ID** 중 하나를 사용한 데이터 복사
...
| tenant | 응용 프로그램이 있는 테넌트 정보(도메인 이름 또는 테넌트 ID)를 지정합니다. Azure Portal의 오른쪽 위 모서리를 마우스로 가리켜 검색합니다. | 아니요 |
