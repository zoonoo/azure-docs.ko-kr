...
- OData 버전 3.0 및 4.0
- 다음 인증 중 하나를 사용 하 여 데이터를 복사 합니다. **익명**, **기본**, **Windows**, **AAD 서비스 사용자**및 **Azure 리소스에 대 한 관리 되는 id**입니다.
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | **형식** 속성은 **OData**로 설정해야 합니다. |yes |
| URL | OData 서비스의 루트 URL입니다. |yes |
| authenticationType | OData 원본에 연결하는 데 사용되는 인증 형식입니다. 허용되는 값은 **Anonymous**, **Basic**, **Windows**, **AadServicePrincipal** 및 **ManagedServiceIdentity**입니다. 사용자 기반 OAuth는 지원되지 않습니다. | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 세트의 **type** 속성을 **ODataResource**로 설정해야 합니다. | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 복사 작업 원본의 **type** 속성을 **odatasource**로 설정 해야 합니다. | yes |
