...
아직 수행 하지 않은 경우 Azure-SSIS IR 설정 된 동일한 데이터 팩터리에 Azure Blob 저장소 연결 된 서비스를 만듭니다. 이렇게 하려면 [Azure data factory 연결 된 서비스 만들기](./quickstart-create-data-factory-portal.md#create-a-linked-service)를 참조 하세요. 다음을 수행 해야 합니다.
