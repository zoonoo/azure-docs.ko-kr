...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | type 속성을 다음으로 설정해야 합니다. **Eloqua** | 예. |
| 엔드포인트 | Eloqua 서버의 엔드포인트입니다. Eloqua는 엔드포인트를 확인하고 자격 증명을 사용하여 https://login.eloqua.com에 로그인한 다음, `xxx.xxx.eloqua.com` 패턴의 리디렉션된 URL에서 **기준 URL** 부분을 복사하기 위해 여러 데이터 센터를 지원합니다. | 예. |
...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 세트의 type 속성을 다음으로 설정해야 합니다. **EloquaObject** | 예. |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 복사 작업 원본의 type 속성을 다음으로 설정해야 합니다. **EloquaSource** | 예. |
