...
[메타데이터 작업 가져오기](control-flow-get-metadata-activity.md) | GetMetadata 작업은 Azure Data Factory에 있는 모든 데이터의 메타데이터를 검색하는 데 사용할 수 있습니다.
...
retryIntervalInSeconds | 다시 시도 사이의 지연(초) | Integer | 아니요. 기본값은 30초입니다.
