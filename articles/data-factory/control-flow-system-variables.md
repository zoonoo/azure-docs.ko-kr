...
| @trigger().startTime |트리거가 파이프라인 실행을 **실제로** 실행한 시간입니다. 예를 들어 5분마다 발생하는 트리거의 경우 이 변수는 각각 `2017-06-01T22:20:00.4061448Z`, `2017-06-01T22:25:00.7958577Z`, `2017-06-01T22:29:00.9935483Z`를 반환할 수 있습니다. (참고: 타임 스탬프는 기본적으로 ISO 8601 형식으로)|

## <a name="tumbling-window-trigger-scope"></a>연속 창 트리거 범위
이 시스템 변수는 트리거가 "TumblingWindowTrigger" 유형인 경우, 트리거 JSON의 어디에서나 참조할 수 있습니다.
(참고: 타임 스탬프는 기본적으로 ISO 8601 형식으로)
