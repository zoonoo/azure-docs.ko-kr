...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | type 속성을 다음으로 설정해야 합니다. **HBase** | yes |
...
| authenticationType | HBase 서버에 연결하는 데 사용할 인증 메커니즘입니다. <br/>허용되는 값은 다음과 같습니다. **익명**, **기본** | yes |
...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 데이터 세트의 type 속성을 다음으로 설정해야 합니다. **HBaseObject** | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 복사 작업 원본의 type 속성을 다음으로 설정해야 합니다. **HBaseSource** | yes |
