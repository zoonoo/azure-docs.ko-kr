...
### <a name="error-message-connection-timeout-expired-or-the-service-has-encountered-an-error-processing-your-request-please-try-again"></a>오류 메시지: "연결 제한 시간이 만료 되었습니다." 또는 "서비스에서 요청을 처리 하는 동안 오류가 발생 했습니다. 다시 시도 하세요. "
...
[일반] 탭의 [일반 **] 탭에서** 속성 ![설정 하 고](media/how-to-invoke-ssis-package-ssis-activity/ssis-activity-general.png)에 시간 제한을 설정 하는 것이 좋습니다.
