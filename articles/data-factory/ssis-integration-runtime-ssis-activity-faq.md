...
### <a name="error-message-there-is-not-enough-space-on-the-disk"></a>오류 메시지: "디스크 공간이 부족 합니다."
...
### <a name="error-message-failed-to-retrieve-resource-from-master-microsoftsqlserverintegrationservicesscalescaleoutcontractcommonmasterresponsefailedexception-code300004-descriptionload-file--failed"></a>오류 메시지: "Master에서 리소스를 검색 하지 못했습니다. Microsoft.SqlServer.IntegrationServices.Scale.ScaleoutContract.Common.MasterResponseFailedException: 코드: 300004. 설명: 로드 파일 "* * *"이 (가) 실패 했습니다. "
...
### <a name="error-message-the-database-ssisdb-has-reached-its-size-quota"></a>오류 메시지: "데이터베이스 ' SSISDB '의 크기 할당량에 도달 했습니다."
...
### <a name="error-message-your-integration-runtime-cannot-be-upgraded-and-will-eventually-stop-working-since-we-cannot-access-the-azure-blob-container-you-provided-for-custom-setup"></a>오류 메시지: "사용자 지정 설치를 위해 제공한 Azure Blob 컨테이너에 액세스할 수 없으므로 통합 런타임을 업그레이드할 수 없으며 결국 작동 하지 않습니다."
...
또한 **일반** 탭에서 제한 시간을 설정 하는 것이 좋습니다. ![일반 탭](media/how-to-invoke-ssis-package-ssis-activity/ssis-activity-general.png)에서 속성을 설정 합니다.
