...
ms.locfileid: "56212590"
---
# <a name="azure-data-factory-mapping-data-flow-reference-node"></a>Azure Data Factory 데이터 흐름 매핑 참조 노드
...
예:  둘 이상의 데이터 스트림의 조인 또는 공용 구조체를 수행하는 경우 데이터 흐름 캔버스가 기본이 아닌 들어오는 스트림의 이름 및 설정을 반영하는 참조 노드를 추가할 수도 있습니다.
