---
title: PowerShell을 사용하여 클라우드에서 데이터 복사
...
* **Azure 저장소 계정**. Blob Storage를 **원본** 및 **싱크** 데이터 스토리지 모두로 사용합니다. Azure Storage 계정이 없는 경우 [스토리지 계정 만들기](../../storage/common/storage-account-create.md)를 참조하여 하나 만듭니다. 
