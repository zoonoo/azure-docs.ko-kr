...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 형식 속성은 **CosmosDb**로 설정해야 합니다. | 예 |
...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 집합의 type 속성을 **DocumentDbCollection**으로 설정해야 합니다. |예 |
