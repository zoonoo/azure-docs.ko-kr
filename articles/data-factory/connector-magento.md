...
이 Magento 커넥터는 다음과 같은 작업에 대해 지원 됩니다.
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | type 속성은 **Magento**로 설정해야 합니다. | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 집합의 type 속성은 **MagentoObject** 로 설정 해야 합니다. | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 복사 작업 원본의 type 속성은 **MagentoSource**로 설정해야 합니다. | yes |
