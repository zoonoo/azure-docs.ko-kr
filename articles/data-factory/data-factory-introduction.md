...
![다이어그램: Data Factory 개요, 데이터 통합 서비스](./media/data-factory-introduction/what-is-azure-data-factory.png)
**그림1.**  다양한 데이터 원본으로부터 데이터를 수집하고 해당 데이터를 준비하고 변환하고 분석한 다음 소비를 위해 바로 사용할 수 있는 데이터를 게시합니다.
