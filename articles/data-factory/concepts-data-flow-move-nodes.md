...
ms.locfileid: "56212534"
---
#<a name="data-factory-data-flow-move-nodes"></a>Data Factory 데이터 흐름 이동 노드
...
따라서 끌어서 놓기 패러다임을 사용하지 않고 변환 노드를 “이동”하는 방법은 들어오는 스트림을 변경하기 위한 것입니다. 대신 “들어오는 스트림”변경하여 변환을 이동하게 됩니다.
