---
title: Azure Data Factory(베타)를 사용하여 Oracle Responsys에서 데이터 복사 | Microsoft Docs
...
ms.locfileid: "33206468"
---
# <a name="copy-data-from-oracle-responsys-using-azure-data-factory-beta"></a>Azure Data Factory(베타)를 사용하여 Oracle Responsys에서 데이터 복사
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 형식 속성은 **Responsys**로 설정해야 합니다. | 예 |
| endpoint | Responsys 서버의 끝점입니다.  | 예 |
| clientId | Responsys 응용 프로그램과 연결된 클라이언트 ID입니다.  | 예 |
| clientSecret | Responsys 응용 프로그램과 연결된 클라이언트 암호입니다. 이 필드를 SecureString으로 표시하거나, ADF에 안전하게 저장하거나, Azure Key Vault에 암호를 저장하도록 선택하고 데이터 복사를 수행하는 경우 여기에서 ADF 복사 작업을 끌어올 수 있습니다. [Key Vault에서 자격 증명 저장](store-credentials-in-key-vault.md)에서 자세히 알아봅니다. | 예 |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 복사 작업 원본의 형식 속성을 **ResponsysSource**로 설정해야 합니다. | 예 |
