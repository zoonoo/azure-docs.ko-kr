...
- **PolyBase를 통해 다양 한 데이터 저장소의 데이터를 Azure Synapse Analytics로 수집 하거나, 데이터를 눈송이로 복사 하거나, Amazon Redshift/HDFS performantly에서 데이터를 수집 하려고 합니다.** 다음에서 자세한 정보를 알아보세요.
