...
1. PowerShell을 사용 하 여 Azure-SSIS IR를 프로 비전 하거나 다시 구성 하는 경우 Azure-SSIS IR를 시작 하기 전에 `Set-AzDataFactoryV2IntegrationRuntime` cmdlet을 실행 하 여 사용자 지정 프로그램을 추가/제거할 수 있습니다.
