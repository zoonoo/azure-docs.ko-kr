<properties 
	pageTitle="파일 시스템 간 데이터 이동 | Azure 데이터 팩터리"
	description="Azure 데이터 팩터리를 사용하여 온-프레미스 파일 시스템 간 데이터를 이동하는 방법에 대해 알아봅니다."
...
# Azure 데이터 팩터리를 사용하여 온-프레미스 파일 시스템 간 데이터 이동
...
서식이 **TextFormat**으로 설정된 경우 **typeProperties** 섹션 내의 **Format** 섹션에서 다음의 **선택적** 속성을 지정할 수 있습니다.
...
후속 Hive 테이블에서 Avro 형식을 사용하려면 [Apache Hive의 자습서](https://cwiki.apache.org/confluence/display/Hive/AvroSerDe)를 참조하세요.

## 파일 공유 복사 활동 형식 속성

**FileSystemSource**및**FileSystemSink**는 이번에 속성을 지원하지 않습니다.
