...
코어가 많은 통합 런타임은 Spark 컴퓨팅 환경의 노드 수를 늘리고 데이터를 읽고 쓰고 변환하는 데 더 많은 처리 능력을 제공합니다.
...
## <a name="optimizing-for-azure-sql-database-and-azure-sql-data-warehouse"></a>Azure SQL 데이터베이스 및 Azure SQL 데이터 웨어하우스에 대한 최적화
