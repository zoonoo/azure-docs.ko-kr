...
![스크린샷 다중 입/출력 메뉴에 있는 새 분기 옵션을 보여 줍니다.](media/data-flow/new-branch2.png "새 분기 추가")
...
![스크린샷을 원본에서 두 개의 분기를 포함 하는 데이터 흐름을 보여 줍니다.](media/data-flow/new-branch.png "새 분기 추가")
