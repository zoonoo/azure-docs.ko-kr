...
## Azure 포털의 샘플
Azure 포털의 **샘플 파이프라인** 블레이드를 사용하여 Azure 데이터 팩터리 샘플을 신속하게 배포, 검토 및 테스트할 수 있습니다.

1. 새 데이터 팩터리를 만들거나 기존 데이터 팩터리를 엽니다. 데이터 팩터리를 만드는 단계는 [Azure 데이터 팩터리 시작][data-factory-get-started]을 참조하십시오.
