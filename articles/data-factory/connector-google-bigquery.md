...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 집합의 type 속성은 **GoogleBigQueryObject** 로 설정 해야 합니다. | yes |
...
Google BigQuery에서 데이터를 복사하려면 복사 작업의 원본 형식을 **GoogleBigQuerySource**로 설정합니다. 복사 활동 **source** 섹션에서 지원되는 속성은 다음과 같습니다.
