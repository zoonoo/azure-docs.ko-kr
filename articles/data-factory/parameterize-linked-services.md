...
모든 유형의 연결된 서비스를 매개 변수화할 수 있습니다.
UI에서 연결된 서비스를 작성할 때 Data Factory는 다음 유형의 연결된 서비스에 대해 기본 제공 매개 변수화 환경을 제공합니다. 연결된 서비스 생성/편집 블레이드에서 새 매개 변수에 대한 옵션을 찾고 동적 콘텐츠를 추가할 수 있습니다.
...
위 목록에 없는 다른 연결된 서비스 유형의 경우 UI에서 JSON을 편집하여 연결된 서비스를 매개 변수화할 수 있습니다.
