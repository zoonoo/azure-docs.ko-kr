...
| **dependsOn: 형식** | TumblingWindowTriggerReference의 형식입니다. 종속성이 설정 된 경우 필수 사항입니다. | 문자열 |  "TumblingWindowTriggerDependencyReference", "SelfDependencyTumblingWindowTriggerReference" | 예 |
