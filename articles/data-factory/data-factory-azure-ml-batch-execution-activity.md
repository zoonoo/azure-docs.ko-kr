...
1. 점수 매기기 웹 서비스에 기본값이 아닌 끝점을 추가합니다. 웹 서비스의 기본 끝점은 업데이트할 수 없으므로 Azure 포털을 사용하여 기본이 아닌 새 끝점을 만들어야 합니다. 개념 정보와 절차적 단계는 모두 [끝점 만들기](../machine-learning/machine-learning-create-endpoint.md)를 참조하세요.
