---
title: Azure Data Factory(미리 보기)를 사용하여 Shopify에서 데이터 복사
...
| 쿼리 | 사용자 지정 SQL 쿼리를 사용하여 데이터를 읽습니다. 예제: `"SELECT * FROM "Products" WHERE Product_Id = '123'"`. | 아니요(데이터 세트의 "tableName"이 지정된 경우) |
