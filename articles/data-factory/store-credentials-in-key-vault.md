...
현재, 모든 유형의 커넥터가 있는 복사 작업이 이 기능을 지원합니다. 자세한 내용은 [각 커넥터 항목](copy-activity-overview.md#supported-data-stores-and-formats)의 “링크된 서비스 속성” 섹션을 확인하세요. 기타 활동 유형 및 계산 연결 서비스에 대한 지원은 나중에 제공됩니다.
