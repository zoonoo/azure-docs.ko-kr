...
| Decimal |Decimal |
| Double |Double |
| 그래픽 |지원되지 않습니다. 원본 쿼리에서 명시적 캐스트를 적용 합니다. |
| 정수 |Int32 |
