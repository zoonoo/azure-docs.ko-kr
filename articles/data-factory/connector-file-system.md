...
description: "파일 시스템에서 지원되는 싱크 데이터 저장소로 (또는) 지원되는 싱크 데이터 저장소에서 파일 시스템으로 Azure Data Factory를 사용하여 데이터를 복사하는 방법에 대해 알아봅니다."
...
| 암호 | 사용자(userid)의 암호를 지정합니다. 이 필드를 SecureString으로 표시합니다. | 예 |
