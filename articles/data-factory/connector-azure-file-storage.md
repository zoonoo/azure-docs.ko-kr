...
| host | Azure File Storage 엔드포인트를 `"host": "\\\\<storage name>.file.core.windows.net\\<file service name>"`로 지정합니다. | 예 |
...
| folderPath | 파일의 경로입니다. 와일드카드 필터는 지원되지 않습니다. |예 |
