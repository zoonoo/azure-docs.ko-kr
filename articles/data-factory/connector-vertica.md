---
title: Azure Data Factory를 사용하여 Vertica에서 데이터 복사(베타) | Microsoft Docs
...
ms.locfileid: "34617854"
---
# <a name="copy-data-from-vertica-using-azure-data-factory-beta"></a>Azure Data Factory를 사용하여 Vertica에서 데이터 복사(베타)
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 형식 속성은 **Vertica**로 설정되어야 합니다. | 예 |
| connectionString | Vertica에 연결할 ODBC 연결 문자열입니다. 이 필드를 SecureString으로 표시하여 Data Factory에 안전하게 저장하거나 [Azure Key Vault에 저장되는 비밀을 참조](store-credentials-in-key-vault.md)합니다. | 예 |
...
데이터 집합 정의에 사용할 수 있는 섹션 및 속성의 전체 목록은 [데이터 집합](concepts-datasets-linked-services.md) 문서를 참조하세요. 이 섹션에서는 Vertica 데이터 집합에서 지원하는 속성의 목록을 제공합니다.

Vertica에서 데이터를 복사하려면 데이터 집합의 형식 속성을 **VerticaTable**로 설정합니다. 이 형식의 데이터 집합에는 추가적인 형식별 속성이 없습니다.
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 복사 작업 원본의 형식 속성을 **VerticaSource**로 설정해야 합니다. | 예 |
