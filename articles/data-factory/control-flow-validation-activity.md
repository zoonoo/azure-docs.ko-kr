...
자산 | 설명 | 허용되는 값 | 필수
-------- | ----------- | -------------- | --------
이름 | '유효성 검사' 작업의 이름 | 문자열 | 예 |
형식 | 로 설정 되어야 합니다 **유효성 검사**합니다. | 문자열 | 예 |
...
시간 제한 | 작업 실행에 대한 시간 제한을 지정합니다. 없는 값을 지정 하는 경우 기본값은 7 일 ("7.00:00:00")입니다. 형식은 d.hh:mm:ss | 문자열 | 아닙니다. |
