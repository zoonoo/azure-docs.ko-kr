...
sleep | 유효성 검사 시도 간격 (초) 지연 합니다. 없는 값을 지정 하는 경우 기본값은 10 초입니다. | Integer | 아닙니다. |
...
minimumSize | 바이트에 있는 파일의 최소 크기입니다. 기본값은 0 바이트 없는 값을 지정 하는 경우 | Integer | 아닙니다. |
