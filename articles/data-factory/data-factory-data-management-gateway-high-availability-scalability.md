...
고가용성 및 확장성 기능을 사용하도록 기존 게이트웨이를 업그레이드할 수 있습니다. 이 기능은 2.9.xxxx 버전 이상의 데이터 관리 게이트웨이가 있는 노드에서만 작동합니다. 데이터 관리 게이트웨이 구성 관리자의 **도움말** 탭에서 컴퓨터에 설치된 데이터 관리 게이트웨이의 버전을 확인할 수 있습니다. 
