...
매핑 데이터 흐름에서 데이터를 변환할 때 JSON, Avro, 분리된 텍스트 또는 Parquet 형식으로 Azure Data Lake Storage Gen1에서 파일을 읽고 쓸 수 있습니다. 자세한 내용은 매핑 데이터 흐름 기능에서 [원본 변환](data-flow-source.md) 및 [싱크 변환](data-flow-sink.md)을 참조하세요.
