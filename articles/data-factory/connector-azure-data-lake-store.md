...
| 속성 | 설명 | 필수 |
|:--- |:--- |:--- |
| 형식 | 데이터 세트의 type 속성을 **AzureDataLakeStoreFile**로 설정해야 합니다. |yes |
| folderPath | Data Lake Store의 폴더 경로입니다. 와일드카드 필터는 지원되지 않습니다. 지정하지 않으면 루트를 가리킵니다. 예: rootfolder/subfolder/ |아니요 |
