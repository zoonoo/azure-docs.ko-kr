...
>[!TIP]
>이 Amazon S3 커넥터를 사용하여 [Google 클라우드 Storage](connector-google-cloud-storage.md)와 같은 ‘S3 호환 스토리지 공급자’의 데이터를 복사할 수 있습니다. 연결된 서비스 구성에서 해당 서비스 URL을 지정합니다.
...
>[!NOTE]
>다음 모델은 이전 버전과의 호환성을 위해 그대로 계속 지원됩니다. 앞서 설명한 새 모델을 사용하는 것이 좋습니다. Data Factory 제작 UI가 새 모델을 생성으로 전환되었습니다.
