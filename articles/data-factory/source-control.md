...
| **GitHub Enterprise URL** | GitHub Enterprise 루트 URL입니다. 예를 들어 https://github.mydomain.com을 참조하십시오. **GitHub Enterprise 사용** 을 선택한 경우에만 필요 | `<your GitHub enterprise url>` |                                                           
