...
> [!NOTE]
> 이 OData 커넥터는 클라우드 OData 소스와 온-프레미스 OData 소스의 데이터 복사를 지원합니다. 후자의 경우 데이터 관리 게이트웨이를 설치해야 합니다. 데이터 관리 게이트웨이에 대한 자세한 내용은 [온-프레미스 및 클라우드 간 데이터 이동](data-factory-move-data-between-onprem-and-cloud.md)을 참조하세요.
> 
> 
