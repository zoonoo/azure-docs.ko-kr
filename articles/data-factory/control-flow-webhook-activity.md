...
자산 | 설명 | 허용되는 값 | 필수
-------- | ----------- | -------------- | --------
이름 | 웹 후크 작업의 이름 | 문자열 | 예 |
형식 | 로 설정 되어야 합니다 **웹 후크**합니다. | 문자열 | 예 |
...
시간 제한 | 작업은 대기 시간를 &#39;callbackuri&#39; 를 호출 합니다. 기간 활동 호출할 'callbackuri' 대기 합니다. 기본값은 10mins ("00: 10:00"). 즉, d.hh:mm:ss Timespan 형식은 | 문자열 | 아닙니다. |
