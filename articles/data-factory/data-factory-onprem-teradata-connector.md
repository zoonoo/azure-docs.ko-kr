---
title: "Teradata에서 데이터 이동 | Microsoft Docs"
...
Teradata 데이터베이스에 연결할 데이터 관리 게이트웨이의 경우 데이터 관리 게이트웨이와 동일한 시스템에 [.NET Data Provider for Teradata](http://go.microsoft.com/fwlink/?LinkId=278886) 버전 14 이상을 설치해야 합니다. Teradata 버전 12 이상이 지원됩니다.
...
### <a name="sample-copy-data-from-teradata-to-azure-blob"></a>샘플: Teradata에서 Azure Blob로 데이터 복사
이 샘플은 Teradata 데이터베이스에서 Azure Blob 저장소로 데이터를 복사하는 방법을 보여 줍니다. 그러나 Azure Data Factory의 복사 작업을 사용하여 **여기** 에 설명한 싱크로 [직접](data-factory-data-movement-activities.md#supported-data-stores-and-formats) 데이터를 복사할 수 있습니다.  
...
5. [RelationalSource](data-factory-onprem-teradata-connector.md#teradata-copy-activity-type-properties) 및 [BlobSink](data-factory-azure-blob-connector.md#azure-blob-copy-activity-type-properties)를 사용하는 복사 작업의 [파이프라인](data-factory-create-pipelines.md)
...
온-프레미스 Teradata 데이터 원본의 자격 증명을 설정하는 방법에 대한 자세한 내용은 [데이터 관리 게이트웨이를 사용하여 온-프레미스 원본과 클라우드 간 데이터 이동](data-factory-move-data-between-onprem-and-cloud.md)을 참조하세요.

## <a name="teradata-dataset-type-properties"></a>Teradata 데이터 집합 형식 속성
...
## <a name="teradata-copy-activity-type-properties"></a>Teradata 복사 작업 형식 속성
