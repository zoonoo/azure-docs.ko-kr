...
| writeBatchTimeout |WriteBatchSize 또는 writeBatchTimeout에 도달하면 Azure 테이블에 데이터를 삽입합니다.<br/>허용되는 값은 timespan입니다. 예: "00:20:00"(20분) |아니요(기본값: 90초 - 저장소 클라이언트의 기본 시간 제한) |
