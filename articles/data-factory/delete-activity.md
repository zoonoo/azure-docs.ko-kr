...
-   Delete 활동에서 파일 특성 필터를 사용 하는 경우: modifiedDatetimeStart 및 modifiedDatetimeEnd에서 삭제할 파일을 선택 하려면 delete 활동에 "wildcardFileName": "*"를 설정 해야 합니다.
