...
## <a name="delta-data-loading-using-a-watermark"></a>워터마크를 사용하여 델타 데이터 로드
...
## <a name="delta-data-loading-using-the-change-tracking-technology"></a>변경 내용 추적 기술을 사용한 델타 데이터 로드
변경 내용 추적 기술은 응용 프로그램에 효율적인 변경 내용 추적 메커니즘을 제공하는 SQL Server 및 Azure SQL 데이터베이스의 간단한 솔루션입니다. 이를 통해 삽입되거나 업데이트되거나 삭제된 데이터를 응용 프로그램에서 쉽게 식별할 수 있습니다. 
