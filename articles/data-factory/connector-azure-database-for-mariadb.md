...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 형식 속성은 **Azuremariadb** 로 설정 되어야 합니다. | yes |
...
| connectVia | 데이터 저장소에 연결하는 데 사용할 [Integration Runtime](concepts-integration-runtime.md)입니다. 지정하지 않으면 기본 Azure Integration Runtime을 사용합니다. |아닙니다. |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 데이터 집합의 type 속성은 **Azuremariadbtable** 로 설정 해야 합니다. | yes |
...
| 자산 | 설명 | 필수 |
|:--- |:--- |:--- |
| type | 복사 작업 원본의 type 속성은 **Azuremariadbsource** 로 설정 해야 합니다. | yes |
