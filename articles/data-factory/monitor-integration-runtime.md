...
| CatalogServerEndpoint | SSISDB를 호스트 하는 기존 SQL Database/SQL Managed Instance의 끝점입니다. |
| CatalogAdminUserName | 기존 SQL Database/SQL Managed Instance의 관리자 사용자 이름입니다. Data Factory 서비스는 이 정보를 사용하여 사용자 대신 SSISDB를 준비하고 관리합니다. |
| CatalogAdminPassword | 기존 SQL Database/SQL Managed Instance의 관리자 암호입니다. |
| CatalogPricingTier | SQL Database에서 호스트 하는 SSISDB에 대 한 가격 책정 계층입니다.  SSISDB를 호스팅하는 SQL Managed Instance에는 적용 되지 않습니다. |
