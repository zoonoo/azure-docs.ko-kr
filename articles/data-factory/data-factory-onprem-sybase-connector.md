<properties 
	pageTitle="Sybase 커넥터 - Sybase에서 데이터 이동" 
	description="Sybase 데이터베이스에서 데이터를 이동시킬 수 있는 데이터 팩터리 서비스용 Sybase 커넥터에 대해 알아봅니다" 
...
1.	OnPremisesSybase 형식의 연결된 서비스입니다.
