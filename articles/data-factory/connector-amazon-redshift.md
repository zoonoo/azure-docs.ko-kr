---
title: Azure Data Factory를 사용하여 Amazon Redshift에서 데이터 복사
...
| password |사용자 계정의 password입니다. 이 필드를 SecureString으로 표시하여 Data Factory에 안전하게 저장하거나 [Azure Key Vault에 저장되는 암호를 참조](store-credentials-in-key-vault.md)합니다. |예 |
