...
API 관리(미리 보기)를 사용하여 조직들은 외부, 파트너 및 내부의 개발자에게 API를 게시하여 데이터 및 서비스의 잠재성을 활용할 수 있습니다. 모든 곳의 비즈니스는 디지털 플랫폼으로 운영을 확장함으로써 새로운 채널을 생성하고, 새로운 고객을 찾고, 기존 고객과 더 깊은 관계를 구축하고자 합니다. API 관리는 개발자 참여, 비즈니스 통찰력, 분석, 보안과 보호 등을 통해 성공적인 API 프로그램을 보장하는 핵심적인 역량을 제공합니다.
...
자세한 내용은 [API를 관리하는 방법][API를 관리하는 방법](영문) 및 [API에 작업을 추가하는 방법][API에 작업을 추가하는 방법](영문)을 참조하세요.
...
자세한 내용은 [제품을 만들고 게시하는 방법][제품을 만들고 게시하는 방법](영문)을 참조하세요.
...
-   **개발자** - 개발자는 API를 사용하여 응용 프로그램을 구축하는 고객입니다. 개발자는 [개발자 포털][개발자 포털]에 액세스할 수 있는 권한을 받으며 API의 작업을 호출하는 응용 프로그램을 빌드합니다.
...
자세한 내용은 [그룹을 만들고 사용하는 방법][그룹을 만들고 사용하는 방법](영문)을 참조하세요.

## <a name="developers"> </a>개발자

개발자는 API 관리 서비스 인스턴스의 사용자 계정을 나타냅니다. 개발자는 개발자(administrator)가 만들거나 참여하도록 초대할 수 있으며 [개발자 포털][개발자 포털]에서 등록할 수도 있습니다. 각 개발자는 하나 이상의 그룹의 구성원이며 해당 그룹에 대한 가시성을 부여하는 제품을 구독할 수 있습니다.

개발자가 제품을 구독하면 제품의 기본 키 및 보조 키를 부여받습니다. 이 키는 제품의 API를 호출할 때 사용됩니다.

자세한 내용은 [개발자를 만들거나 초대하는 방법][개발자를 만들거나 초대하는 방법](영문) 및 [그룹을 개발자와 연결하는 방법][그룹을 개발자와 연결하는 방법](영문)을 참조하세요.
...
API 관리 정책의 전체 목록을 보려면 [정책 참조][정책 참조](영문)를 참조하세요. 정책 사용 및 구성에 대한 자세한 내용은 [API 관리 정책][API 관리 정책](영문)을 참조하세요. 속도 제한 및 할당량 정책을 사용하여 제품을 만드는 방법에 대한 자습서는 [고급 제품 설정을 만들고 구성하는 방법][고급 제품 설정을 만들고 구성하는 방법]을 참조하세요.
...
사용자 지정 콘텐츠를 추가하고, 스타일을 사용자 지정하고, 브랜딩을 추가하여 개발자 포털의 모양을 사용자 지정할 수 있습니다.
  ...
  [API를 관리하는 방법]: ../api-management-howto-create-apis
