...
##런타임 지원
[DocumentDB JavaScript 서버 쪽 SDK](http://dl.windowsazure.com/documentDB/jsserverdocs/)는 [ECMA-262]에서 표준화된 일반 JavaScript 언어 기능을 대부분 지원합니다(../documentdb-interactions-with-resources.md).
...
다음 예제에서는 UDF(사용자 정의 함수)를 만들고 [DocumentDB SQL 쿼리]에 사용하는 방법을 보여 줍니다(../documentdb-sql-query.md).
