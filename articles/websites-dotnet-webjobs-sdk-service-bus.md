<properties 
	pageTitle="WebJob SDK를 사용하여 Azure 서비스 버스로 작업하는 방법" 
...
샘플 프로젝트의 경우 [서비스 버스 예시](https://github.com/Azure/azure-webjobs-sdk-samples/tree/master/BasicSamples/ServiceBus)를 참조하세요. 자세한 내용은 [WebJobs SDK 시작](websites-dotnet-webjobs-sdk-get-started.md)을 참조하세요.
