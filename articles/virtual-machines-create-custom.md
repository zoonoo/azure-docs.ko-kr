<properties pageTitle="Azure에서 사용자 지정 가상 컴퓨터 만들기" description="Azure에서 사용자 지정 가상 컴퓨터를 만드는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
