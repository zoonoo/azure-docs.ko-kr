...
## 개요 ##
앱 서비스 환경은 Azure 앱 서비스의 [프리미엄][PremiumTier] 서비스 계획 옵션으로, 모든 앱의 안전한 실행을 위해 완전히 격리된 전용 환경을 제공합니다. 여기에는 확장된 크기 조정 옵션과 함께 [웹앱][WebApps], [모바일 앱][MobileApps], [Api 앱][APIApps] 및 [논리 앱][LogicApps]이 포함됩니다.
