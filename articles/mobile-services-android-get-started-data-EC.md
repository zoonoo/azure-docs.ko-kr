...
> [AZURE.NOTE] 이 자습서는 Android 앱에서 모바일 서비스를 통해 Azure를 사용하여 데이터를 저장하고 검색할 수 있는 방법을 더욱 잘 이해할 수 있도록 돕기 위한 것입니다. 이 항목에서는 모바일 서비스 퀵 스타트에서 완료한 여러 단계를 순서대로 안내합니다. 모바일 서비스를 처음 사용하는 경우 먼저 [모바일 서비스 시작](/ko-kr/develop/mobile/tutorials/get-started-android-EC) 자습서를 완료하는 것이 좋습니다.
> 
...
이 자습서를 완료하려면 [모바일 서비스 Android SDK](영문)가 필요합니다. 이 <a href="https://go.microsoft.com/fwLink/p/?LinkID=280125" target="_blank">Android SDK</a>(영문)에는 Eclipse IDE(통합 개발 환경), ADT(Android 개발자 도구) 플러그 인 및 Android 4.2 이상 버전이 포함되어 있습니다. 
