<properties
	pageTitle="Azure 구독이 취소될 경우 어떻게 해야 하나요? | Microsoft Azure"
...
취소된 구독을 다시 사용하도록 설정하려면 지원 티켓을 만들어야 합니다. [Azure 포털](https://portal.azure.com/)에 로그인하여 **도움말 + 지원**>**새 지원 요청**을 선택합니다.
