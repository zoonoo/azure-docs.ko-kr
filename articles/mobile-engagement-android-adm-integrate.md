...
절차는 다음에 자세히 설명되어 있습니다. [<https://developer.amazon.com/sdk/adm/credentials.html>]
...
-   Amazon 태그를 추가한 후 프로젝트 빌드 대상이 Android 2.1 이하인 경우 빌드 오류가 발생할 수 있습니다. **Android 2.1 이상의** 빌드 대상을 사용해야 합니다(여전히  `minSdkVersion`을 4로 설정할 수 있음).
...
[통합 ADM]:https://developer.amazon.com/sdk/adm/integrating-app.html
