...
|검사 목록 범주| 설명|
| ------------ | -------- |
| [<br>보안 역할 및 Access Control](https://docs.microsoft.com/azure/security-center/security-center-planning-and-operations-guide)|<ul><li>[RBAC(역할 기반 액세스 제어)](https://docs.microsoft.com/azure/role-based-access-control/role-assignments-portal)를 사용하여 특정 범위의 사용자, 그룹 및 응용 프로그램에 권한을 사용자별로 할당할 수 있습니다.</li></ul> |
