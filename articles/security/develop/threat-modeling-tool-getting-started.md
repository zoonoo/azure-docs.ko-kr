...
description: Threat Modeling Tool를 사용 하 여 시작 하는 방법을 알아봅니다. 다이어그램을 만들고, 위협을 식별 하 고, 위협을 완화 하 고, 각 완화의 유효성을 검사 합니다.
services: security
...
![제목, 범주, 설명, 상호 작용 및 우선 순위를 포함 하는 위협 속성 창를 보여 주는 스크린샷](./media/threat-modeling-tool-getting-started/interactioninfo.png)
...
![대표적인 위협 모델링 보고서를 보여 주는 스크린샷](./media/threat-modeling-tool-feature-overview/report.png)
