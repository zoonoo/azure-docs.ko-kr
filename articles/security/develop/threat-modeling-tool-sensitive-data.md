...
| **적용 가능한 기술** | 일반 |
| **특성**              | 해당 없음  |
| **참조**              | [Azure 디스크 암호화를 사용하여 가상 머신에 사용되는 디스크 암호화](https://azure.microsoft.com/documentation/articles/storage-security-guide/#_using-azure-disk-encryption-to-encrypt-disks-used-by-your-virtual-machines) |
...
| **특성**              | 해당 없음  |
| **참조**              | [Microsoft Intune 정책을 사용하여 디바이스에서 설정 및 기능 관리](https://docs.microsoft.com/mem/intune/configuration/), [키 집합 Valet](https://components.xamarin.com/view/square.valet) |
