---
title: 마이크로소프트 위협 모델링 도구 릴리스 11/1/2018
titleSuffix: Azure
...
ms.locfileid: "78269760"
---
# <a name="threat-modeling-tool-update-release-71510231---1112018"></a>Threat Modeling Tool 업데이트 릴리스 7.1.51023.1 - 2018/11/1

[GA 릴리스 정보](threat-modeling-tool-releases-71509112.md)에 원래 언급된 대로, Preview 버전(7.1.50911.2 이전 버전의 미리 보기 클라이언트)의 사용자가 지원되는 GA 릴리스로 업그레이드하도록 요구하는 Microsoft Threat Modeling Tool 업데이트(7.1.51023.1)가 릴리스되었습니다. 이 릴리스에는 새로운 기능이나 수정 사항이 포함되어 있지 않습니다.
