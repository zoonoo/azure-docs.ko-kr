...
description: Threat Modeling Tool에서 감사 및 로깅 완화에 대해 알아봅니다. 완화 정보를 참조하고 코드 예제를 확인하세요.
services: security
...
## <a name="ensure-that-auditing-and-logging-is-enforced-on-the-application"></a><a id="auditing"></a>애플리케이션에 감사 및 로깅 적용
...
## <a name="ensure-that-log-rotation-and-separation-are-in-place"></a><a id="log-rotation"></a>로그 회전 및 분리가 작동하는지 확인
...
## <a name="ensure-that-the-application-does-not-log-sensitive-user-data"></a><a id="log-sensitive-data"></a>애플리케이션이 민감한 사용자 데이터를 기록하지 않도록 확인
...
| **특성**              | 해당 없음  |
| **참조**              | 해당 없음  |
| **단계**                   | <p>사용자가 사이트에 제출하는 민감한 데이터를 기록하지 않도록 확인합니다. 의도적 로깅과 설계 문제로 인한 부작용을 확인합니다. 중요한 데이터의 예는 다음과 같습니다.</p><ul><li>사용자 자격 증명</li><li>사회 보장 번호 또는 기타 식별 정보</li><li>신용 카드 번호 또는 기타 금융 정보</li><li>의료 정보</li><li>프라이빗 키 또는 암호화된 정보를 해독하는 데 사용할 수 있는 기타 데이터</li><li>애플리케이션을 보다 효과적으로 공격하는 데 용할 수 있는 시스템 또는 애플리케이션 정보</li></ul>|

## <a name="ensure-that-audit-and-log-files-have-restricted-access"></a><a id="log-restricted-access"></a>감사 및 로그 파일의 액세스 제한
...
## <a name="ensure-that-user-management-events-are-logged"></a><a id="user-management"></a>사용자 관리 이벤트 기록
...
## <a name="ensure-that-the-system-has-inbuilt-defenses-against-misuse"></a><a id="inbuilt-defenses"></a>시스템에 악용 방지 수단을 기본적으로 제공
...
## <a name="ensure-that-login-auditing-is-enabled-on-sql-server"></a><a id="identify-sensitive-entities"></a>SQL Server에서 로그인 감사를 사용하도록 설정
...
| **적용 가능한 기술** | SQL Azure |
| **특성**              | SQL 버전 - V12 |
| **참조**              | [SQL Database 위협 감지 시작](../../azure-sql/database/threat-detection-configure.md)|
...
## <a name="implement-sufficient-audit-failure-handling"></a><a id="audit-failure-handling"></a>충분한 감사 실패 처리 구현
...
## <a name="ensure-that-auditing-and-logging-is-enforced-on-web-api"></a><a id="logging-web-api"></a>웹 API에 감사 및 로깅 적용
...
## <a name="ensure-that-appropriate-auditing-and-logging-is-enforced-on-field-gateway"></a><a id="logging-field-gateway"></a>필드 게이트웨이에 적절한 감사 및 로깅 적용
...
## <a name="ensure-that-appropriate-auditing-and-logging-is-enforced-on-cloud-gateway"></a><a id="logging-cloud-gateway"></a>클라우드 게이트웨이에 적절한 감사 및 로깅 적용
