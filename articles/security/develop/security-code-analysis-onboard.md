...
> - 매개 변수로 지정할 수 있는 Azure DevOps 팀 빌드에서 미리 정의 된 변수 목록은 [Azure Devops 빌드 변수](/azure/devops/pipelines/build/variables?tabs=batch&view=vsts)를 참조 하세요.
