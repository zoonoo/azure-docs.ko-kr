...
**세부 정보**: [NSG](../virtual-network/virtual-networks-nsg.md)(네트워크 보안 그룹)을 만듭니다. NSG는 간단한 상태 저장 패킷 검사 디바이스로 5개 튜플(원본 IP, 원본 포트, 대상 IP, 대상 포트 및 계층 4 프로토콜) 접근 방식을 사용하여 네트워크 트래픽에 대한 허용/거부 규칙을 만듭니다. 단일 IP 주소 간의 트래픽, 여러 IP 주소 간의 트래픽 또는 전체 서브넷 간의 트래픽을 허용하거나 거부할 수 있습니다.
