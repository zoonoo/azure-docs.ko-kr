...
description: 이 아티클에서는 Microsoft에서 Azure 데이터 센터의 보안을 보장하는 방법을 설명합니다.
services: security
...
이 아티클 시리즈에서는 Microsoft에서 Azure 인프라를 보호하는 내용에 대한 정보를 제공합니다. 아티클을 다음을 확인합니다.
...
사용자와 Microsoft 간의 책임 분담을 이해해야 합니다. 온-프레미스에서는 전체 스택을 가지고 있지만 클라우드로 이동할 때 일부 책임이 Microsoft로 이전됩니다. 다음 책임 매트릭스에서는 사용자와 Microsoft가 책임을 지는 SaaS(software as a service), PaaS(platform as a service) 및 IaaS(infrastructure as a service) 배포의 스택 영역을 보여줍니다.
...
SaaS, PaaS 및 IaaS 배포에서 사용자와 Microsoft 간의 책임 분배를 이해해야 합니다. 자세한 세부 정보는 [클라우드 컴퓨팅에 대한 공유 책임](https://gallery.technet.microsoft.com/Shared-Responsibilities-81d0ff91/file/153019/1/Shared%20responsibilities%20for%20cloud%20computing.pdf)을 참조하세요.
