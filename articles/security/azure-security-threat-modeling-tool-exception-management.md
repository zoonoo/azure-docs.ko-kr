...
## <a name="a-idservicedebugawcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug">WCF - 구성 파일에 serviceDebug 노드를 포함하지 않음</a>
...
## <a name="a-idservicemetadataawcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata">WCF - 구성 파일에 serviceMetadata 노드를 포함하지 않음</a>
...
## <a name="a-idexceptionaensure-that-proper-exception-handling-is-done-in-aspnet-web-api"></a><a id="exception">ASP.NET Web API에서 적절한 예외 처리가 수행되었는지 확인</a>
...
## <a name="a-idmessagesado-not-expose-security-details-in-error-messages"></a><a id="messages"></a>오류 메시지에 보안 정보를 노출하지 않음
...
## <a name="a-iddefaultaimplement-default-error-handling-page"></a><a id="default"></a>기본 오류 처리 페이지 구현
...
## <a name="a-iddeploymentaset-deployment-method-to-retail-in-iis"></a><a id="deployment"></a>IIS에서 배포 방법을 일반 정품으로 설정
...
## <a name="a-idfailaexceptions-should-fail-safely"></a><a id="fail"></a>안전한 예외 실패
