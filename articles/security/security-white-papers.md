...
|[Azure 보안 기술 기능](azure-security-technical-capabilities.md)|Azure Storage, Azure SQL Database, Azure 가상 머신 모델 및 이 모두를 관리하는 도구와 인프라를 지원하는 보안 기능 및 특성에 대해 중점적으로 설명합니다.|
