...
해당 하는 기본 제공 Azure Policy를 보려면 [Azure 보안 벤치 마크 규정 준수 기본 제공 이니셔티브: 권한 있는 액세스의 세부 정보](../../governance/policy/samples/azure-security-benchmark.md#privileged-access) 를 참조 하세요.
