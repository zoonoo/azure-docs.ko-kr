...
ms.locfileid: "82606843"
---
# <a name="security-baselines-for-azure"></a>Azure 보안 기준

Azure에 대 한 보안 기준은 향상 된 도구, 추적 및 보안 기능을 통해 보안을 강화 하는 데 도움이 됩니다. 또한 환경을 보호할 때 일관 된 환경을 제공 합니다.

Azure에 대 한 보안 기준은 클라우드 중심 제어 영역에 중점을 둡니다. 이러한 컨트롤은 CI (Internet Security)의 중앙에서 설명 하는 것과 같은 잘 알려진 보안 벤치 마크와 일치 합니다. Microsoft 기준은 [Azure 보안 벤치 마크](overview.md)에 나열 된 제어 영역에 대 한 지침을 제공 합니다.

각 권장 사항에는 다음 정보가 포함 됩니다.

- **AZURE ID**: 권장 사항에 해당 하는 Azure 보안 벤치 마크 ID입니다.
- **권장 사항**: Azure ID 바로 뒤에 나오는 권장 사항에 따라 컨트롤에 대 한 개략적인 설명이 제공 됩니다.
- **지침**: 권장 사항 및 구현 방법에 대 한 지침을 제공 하는 링크를 제공 합니다. Azure Security Center에서 권장 사항을 지원 하면 해당 정보도 나열 됩니다.
