...
Microsoft Defender for Endpoint는 엔터프라이즈 끝점 보안 플랫폼의 일부로 EDR 기능을 제공 하 여 고급 위협을 방지 하 고, 감지 하 고, 조사 하 고, 대응 합니다.

- [Microsoft Defender for Endpoint 개요](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)

- [Windows server 용 Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/configure-server-endpoints)

- [비 Windows 서버용 Microsoft Defender for Endpoint](/windows/security/threat-protection/microsoft-defender-atp/configure-endpoints-non-windows)
...
모든 끝점이 최신 서명으로 최신 상태를 유지 하도록 하려면 Azure Security Center "계산 & 앱"의 권장 사항을 따릅니다. Microsoft 맬웨어 방지 프로그램은 기본적으로 최신 서명 및 엔진 업데이트를 자동으로 설치 합니다. Linux의 경우 타사 맬웨어 방지 솔루션에서 서명이 업데이트 되었는지 확인 합니다.
