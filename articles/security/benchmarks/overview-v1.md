---
title: Azure Security 벤치 마크 V1 개요
description: Azure Security 벤치 마크 V1 개요
author: msmbaldwin
manager: rkarlin
ms.service: security
ms.topic: conceptual
...
> [!NOTE]
> 최신 Azure 보안 벤치 마크는 [여기](overview.md)에서 제공 됩니다.
...
Azure 보안 벤치 마크 활동에 대 한 자세한 피드백 및 활성 참여를 환영 합니다. Azure 보안 벤치 마크 팀 다이렉트 입력을 제공 하려는 경우 양식을 작성 하세요 [https://aka.ms/AzSecBenchmark](https://aka.ms/AzSecBenchmark) .
