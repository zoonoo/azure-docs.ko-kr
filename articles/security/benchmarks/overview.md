...
Azure 보안 벤치 마크를 [스프레드시트 형식](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Security%20Benchmark)으로 다운로드할 수도 있습니다.
...
- **고객 보안 관련자**: 고객 조직의 보안 기능으로, 해당 컨트롤에 대해 책임을 지지 하거나 담당 하거나이를 검색할 수 있습니다. 회사의 보안 조직 구조와 Azure 보안과 관련 하 여 설정 하는 역할 및 책임에 따라 조직 마다 다를 수 있습니다.
...
- [Azure Security 벤치 마크 v2 excel 스프레드시트](https://github.com/MicrosoftDocs/SecurityBenchmarks/tree/master/Azure%20Security%20Benchmark) 다운로드