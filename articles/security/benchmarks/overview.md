...
- [ID 및 Access Control](security-control-identity-access-control.md)
...
Azure 보안 벤치 마크 활동에 대 한 자세한 피드백 및 활성 참여를 환영 합니다. 벤치 마크 팀 다이렉트 입력을 제공 하려는 경우 양식을 작성 하세요 [https://aka.ms/AzSecBenchmark](https://aka.ms/AzSecBenchmark).
