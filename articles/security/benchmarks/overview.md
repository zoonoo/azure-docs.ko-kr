...
- **CIS ID**:이 권장 사항에 해당 하는 cis 벤치 마크 권장 사항 #입니다.  
...
- **세부 정보**: 권장 사항에 대 한 근거 및 권장 사항을 구현 하는 방법에 대 한 지침을 제공 합니다. Azure Security Center에서 권장 사항을 지원 하면 해당 정보가 여기에 나열 됩니다.  
