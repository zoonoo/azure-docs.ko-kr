...
**세부 정보**: 모든 트랜잭션은 HTTPS를 통해 발생합니다. 사용할 수도 있습니다 [Storage REST API](https://msdn.microsoft.com/library/azure/dd179355.aspx) 와 상호 작용 하는 HTTPS를 통한 [Azure Storage](https://azure.microsoft.com/services/storage/)합니다.
