...
## <a name="20-azure-active-directory-identity-protection"></a>2.0 Azure Active Directory ID 보호
...
### <a name="21-identity-protections-capabilities"></a>2.1 ID 보호 기능
...
### <a name="22-azure-ad-privileged-identity-management-pim"></a>2.2 Azure AD PIM(Privileged Identity Management)
...
## <a name="30-microsoft-operations-management-suite-oms"></a>3.0 Microsoft OMS(Operations Management Suite)
...
### <a name="31-holistic-security-and-compliance-posture"></a>3.1 전체적인 보안 및 규정 준수 상태
...
### <a name="32-insight-and-analytics"></a>3.2 Insight and Analytics
...
### <a name="33-automation--control-alert-on-security-configuration-drifts"></a>3.3 자동화 및 제어: 보안 구성 표류에 대한 경고
...
### <a name="41-threat-intelligence"></a>4.1 위협 인텔리전스
...
### <a name="42-behavioral-analytics"></a>4.2 동작 분석
...
### <a name="43-anomaly-detection"></a>4.3 변칙 검색
...
### <a name="44-continuous-threat-intelligence-monitoring"></a>4.4 연속 위협 인텔리전스 모니터링
...
## <a name="50-advanced-threat-detection-features---other-azure-services"></a>5.0 고급 위협 검색 기능 - 다른 Azure 서비스

### <a name="51-virtual-machine-microsoft-antimalware"></a>5.1 Virtual Machine: Microsoft 맬웨어 방지 프로그램
...
#### <a name="511-microsoft-antimalware-core-features"></a>5.1.1 Microsoft 맬웨어 방지 프로그램 핵심 기능
...
### <a name="52-azure-sql-database-threat-detection"></a>5.2 Azure SQL Database 위협 검색
...
### <a name="53-application-gateway-web-application-firewall"></a>5.3 Application Gateway 웹 응용 프로그램 방화벽
...
### <a name="54-anomaly-detection--an-api-built-with-azure-machine-learning"></a>5.4 변칙 검색 – Azure Machine Learning으로 작성된 API
...
## <a name="60-third-party-atd-capabilities-through-azure-marketplace"></a>6.0 Azure Marketplace를 통한 타사 ATD 기능
