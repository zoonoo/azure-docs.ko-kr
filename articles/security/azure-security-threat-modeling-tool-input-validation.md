...
| **특성**              | 해당 없음  |
| **참조**              | [유효성 검사 추가](http://www.asp.net/mvc/overview/getting-started/introduction/adding-validation), [MVC 애플리케이션에서 모델 데이터 유효성 검사](https://msdn.microsoft.com/library/dd410404(v=vs.90).aspx)(영문), [ASP.NET MVC 애플리케이션을 위한 기본 원칙](https://msdn.microsoft.com/magazine/dd942822.aspx)(영문) |
