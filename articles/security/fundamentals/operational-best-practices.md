...
**세부 정보**: [Azure AD ID 보호](/azure/active-directory/identity-protection/overview) 은 다음 작업을 수행할 수 있는 Azure AD Premium P2 버전의 기능입니다.
...
**세부 정보**: [Azure 센티널](/azure/sentinel/overview) 의 특징과 기능을 조사 하 여 현재 온-프레미스에서 사용 하 고 있는 기능의 기능과 비교 합니다. 조직의 SIEM 요구 사항을 충족 하는 경우 Azure 센티널을 채택 하는 것이 좋습니다.
...
**세부 정보**: azure [정책 설명](../../governance/policy/concepts/definition-structure.md#display-name-and-description) 또는 azure 정책 [이니셔티브](../../governance/policy/concepts/definition-structure.md#initiatives) 설명에서 조직 정책에 대 한 참조를 추가 하 여 조직의 설명서 또는 azure 정책 자체에서 문서를 매핑합니다.
