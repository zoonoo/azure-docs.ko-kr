...
| 배포                                                   | Azure 지원 팀은 필요한 경우 파트너에게 직렬 콘솔 출력을 제공하고 클라우드 스토리지에서 OS 디스크 마운트에 적절한 제한 시간을 제공할 수 있어야 합니다. 이미지는 다음 매개 변수를 커널 부팅 줄에 추가했을 것입니다. `console=ttyS0 earlyprintk=ttyS0 rootdelay=300` |
