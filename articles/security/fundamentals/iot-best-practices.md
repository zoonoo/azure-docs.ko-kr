...
이 문서는 [사물 인터넷 보안 모범 사례](/azure/iot-fundamentals/iot-security-best-practices)를 요약합니다. 자세한 정보는 그 문서를 참조하세요.
...
* **보안 하드웨어를 중심으로 구축**: [COGS](https://en.wikipedia.org/wiki/Cost_of_goods_sold) 가 허용된다면 안전하게 암호화되는 스토리지 및 TPM(신뢰할 수 있는 플랫폼 모듈) 기반 부팅 기능 같은 보안 기능을 구축합니다.
