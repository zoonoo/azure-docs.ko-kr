---
title: Azure 데이터 센터의 물리적 보안-Microsoft Azure | Microsoft Docs
description: 이 문서에서는 Microsoft가 실제 인프라, 보안 및 규정 준수 제품을 비롯 하 여 Azure 데이터 센터를 보호 하기 위해 수행 하는 작업을 설명 합니다.
services: security
...
이 인프라는 전 세계 사용자에게 애플리케이션을 더 가까이 제공하는 데 필요한 확장성을 제공하고, 데이터 상주를 유지하고, 고객에게 포괄적인 준수 및 복원력 옵션을 제공하도록 디자인되어 있습니다. Azure에는 전 세계 52 지역이 있으며 140 국가/지역에서 사용할 수 있습니다.
...
![데이터 상주 경계를 보여주는 다이어그램](./media/physical-security/data-residency-boundary.png)
