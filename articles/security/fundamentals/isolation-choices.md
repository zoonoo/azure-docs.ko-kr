...
-   [실시간 암호화](../../storage/common/storage-security-guide.md)(예: Azure 파일 공유에 대한 SMB 3.0 암호화)
...
애플리케이션 관점에서 SQL Azure는 다음과 같은 계층 구조를 제공하며, 각 수준 아래에는 1 대 다 시스템 수준이 포함됩니다.
