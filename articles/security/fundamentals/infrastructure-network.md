...
[Azure DDoS Protection 표준](../../virtual-network/ddos-protection-overview.md)은 DDoS 공격으로부터 보호합니다. 자세히 알아보려면 [Azure DDoS Protection: 모범 사례 및 참조 아키텍처](ddos-best-practices.md) 를 참조 하세요.
