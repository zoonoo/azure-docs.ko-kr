...
description: Azure 도메인의 참조 목록(포괄적이지 않음)
services: security
author: memildin
manager: rkarlin
ms.assetid: ''
...
---
# <a name="reference-list-of-azure-domains-not-comprehensive"></a>Azure 도메인의 참조 목록(포괄적이지 않음)

이 페이지는 사용 중인 Azure 도메인의 일부 목록입니다. 그 중 일부는 REST API 엔드포인트입니다.


|서비스  |하위 도메인  |
|---------|---------|
|[Azure Access Control Service](https://azure.microsoft.com/blog/one-month-retirement-notice-access-control-service/)(사용 중지)|*.accesscontrol.windows.net|
...
|[Azure BizTalk Services](https://azure.microsoft.com/pricing/details/biztalk-services/)(사용 중지)|*.biztalk.windows.net|
...
|ACS(Azure Container Service)(사용되지 않음)|*.azurecontainer.io|
|[Azure CDN(Content Delivery Network)](https://azure.microsoft.com/services/cdn/)|*.vo.msecnd.net|
