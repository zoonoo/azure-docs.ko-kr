...
| Event Hubs                       | yes                | 예, 모든 RSA 길이입니다. | -                  |
| Functions                        | yes                | 예, 모든 RSA 길이입니다. | -                  |
...
| MySQL에 대 한 Azure SQL Database     | yes                | yes                | -                  |
| PostgreSQL에 대 한 Azure SQL Database | yes               | yes                | -                  |
| Azure Synapse Analytics          | yes                | 예, RSA 2048비트  | yes                |
