...
- [Azure DDoS protection에서 사용 권한 이해](../../virtual-network/manage-ddos-protection.md#permissions)
...
**지침**: MFA (azure Multi-Factor Authentication)를 사용 하는 안전한 azure 관리 워크스테이션을 사용 하 여 azure 고객 Lockbox 요청에 로그인 하 고 구성 합니다.
