...
Azure 가상 네트워크에 대해 자세히 알아 보려면 [Azure 가상 네트워크 개요](../virtual-network/virtual-networks-overview.md) 문서를 읽어 보세요.
...
**네트워크 보안 그룹**에 대한 자세한 내용은 [네트워크 보안 그룹](../virtual-network/virtual-networks-nsg.md) 문서를 읽어 보세요.
...
**사용자 정의 경로**에 대해 자세히 알아 보려면 [사용자 정의된 경로 및 IP 전달이란](../virtual-network/virtual-networks-udr-overview.md) 문서를 참조하시기 바랍니다.
...
**지점 및 사이트 간 VPN** 연결에 대해 자세히 알아 보려면 [PowerShell을 사용하여 가상 네트워크에 지점 및 사이트 간 연결 구성](../vpn-gateway/vpn-gateway-howto-point-to-site-rm-ps.md) 문서를 참조하세요.
...
**Azure에 대한 사이트 간 VPN**에 대해 자세히 알아 보려면 [Azure 포털을 사용하여 사이트 간 VPN 연결로 Resource Manager VNet 만들기](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md) 문서를 참조하세요.

**VPN 기반 크로스-프로미스 연결**에 준비하는 방법에 대해 자세히 알아 보려면 [VPN 게이트웨이 계획 및 설계](../vpn-gateway/vpn-gateway-plan-design.md)를 참조하세요.
...
온-프레미스 위치와 Azure 가상 네트워크 간 **전용 WAN 링크**에 대해 자세히 알아 보려면 [Express 경로 기술 개요](../expressroute/expressroute-introduction.md) 문서를 읽어 보세요.
...
Azure 가상 네트워크-Azure 가상 네트워크의 사이트 간 VPN에 대한 자세한 내용은 [Azure Resource Manager 및 PowerShell을 사용하여 VNet 간 연결 구성](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md) 문서를 읽어 보세요.
...
Azure 응용 프로그램 게이트웨이에 대한 자세한 내용은 [응용 프로그램 게이트웨이 개요](../application-gateway/application-gateway-introduction.md) 문서를 읽어 보세요.
...
외부 Azure Load Balancer에 대한 자세한 내용은 [여러 가상 컴퓨터 또는 서비스 간의 인터넷 연결 부하 분산 장치](../load-balancer/load-balancer-internet-overview.md) 문서를 읽어 보세요.

내부 Azure Load Balancer에 대해 자세히 알아 보려면 [내부 부하 분산 장치 개요](../load-balancer/load-balancer-internal-overview.md) 문서를 읽어 보세요.
...
Azure 트래픽 관리자를 사용한 글로벌 부하 분산에 대한 자세한 내용은 [트래픽 관리자란?](../traffic-manager/traffic-manager-overview.md) 문서를 읽어 보세요.
...
네트워크 보안 그룹 로깅에 대한 자세한 내용은 [NSG(네트워크 보안 그룹)에 대한 Log Analytics](../virtual-network/virtual-network-nsg-manage-log.md) 문서를 읽어 보세요.
...
**Azure 가상 네트워크 DNS 서버**에 대한 자세한 내용은 [가상 네트워크 개요](../virtual-network/virtual-networks-overview.md)를 참조하세요.

Azure 가상 네트워크에서 **자체 DNS 서버** 사용에 대한 자세한 내용은 [가상 네트워크(VNet)에서 사용하는 DNS 서버 관리](../virtual-network/virtual-networks-manage-dns-in-vnet.md) 문서를 참조하세요.
...
Azure DNS에 대한 자세한 내용은 [Azure DNS 개요](../dns/dns-overview.md)를 읽어 보세요.
...
Azure에서 DMZ 디자인 배포에 대한 자세한 내용은 [Microsoft 클라우드 서비스 및 네트워크 보안](../best-practices-network-security.md) 문서를 읽어 주세요.
...
Azure 보안 센터에 대한 자세한 내용은 [Azure 보안 센터 소개](../security-center/security-center-intro.md) 문서를 참조하세요.
