...
[OMS(Operations Management Suite)](/azure/operations-management-suite/)는 Contoso Webstore에 재무 데이터 로깅을 포함하여 모든 시스템 및 사용자 활동에 대한 광범위한 로깅을 제공할 수 있습니다. 변경을 검토하고 정확도를 확인할 수 있습니다. 
