...
Azure SQL Data Warehouse는 열 형식 저장소를 사용하여 관계형 테이블에 데이터를 저장합니다. 이 형식으로 인해 데이터 저장소 비용이 상당히 감소하고 쿼리 성능이 향상됩니다. 컴퓨팅 리소스가 필요한 활성 프로세스가 없으면 사용량 요구 사항에 따라 SQL Data Warehouse 컴퓨팅 리소스를 강화/규모 축소하거나 완전히 종료할 수 있습니다.
