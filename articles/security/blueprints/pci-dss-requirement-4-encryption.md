...
|---|---|
| **공급자<br />(Microsoft&nbsp;Azure)** | 사용할 수 없습니다. |
| **고객<br />(PCI&#8209;DSS&nbsp;Blueprint)** | Contoso Webstore에는 보호되지 않은 PAN(기본 계정 번호) 데이터를 보낼 수 있게 구현된 메시징 솔루션이 없습니다.|
...
|---|---|
| **공급자<br />(Microsoft&nbsp;Azure)** | 사용할 수 없습니다. |
| **고객<br />(PCI&#8209;DSS&nbsp;Blueprint)** | 고객은 카드 소유자 데이터가 포함된 전송을 문서화 및 암호화할 책임이 있습니다.|
