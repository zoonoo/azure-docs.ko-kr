...
**CP-4 (1)** 조직은 관련 계획을 담당하는 조직 요소를 사용하여 대체 계획 테스트를 조정합니다.
...
**CP-6 (3)** 조직은 지역 전체에 중단 또는 재해가 발생할 경우 대체 저장소 사이트의 잠재적인 접근성 문제를 식별하고 명시적인 완화 조치를 설명합니다.
