...
ms.locfileid: "45580738"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-ffiec-financial-services"></a>Azure 보안 및 규정 준수 청사진 - FFIEC Financial Services용 데이터 웨어하우스
...
**SQL Data Warehouse**: [SQL Data Warehouse](https://docs.microsoft.com/azure/sql-data-warehouse/sql-data-warehouse-overview-what-is)는 MPP(Massively Parallel Processing)를 활용하여 페타바이트 단위의 데이터에서 복잡한 쿼리를 빠르게 실행하여 사용자가 재무 데이터를 효율적으로 식별할 수 있게 하는 EDW(Enterprise Data Warehouse)입니다. 사용자는 간단한 PolyBase T-SQL 쿼리를 사용하여 빅 데이터를 SQL Data Warehouse로 가져오고 MPP 기능을 활용하여 고성능 분석을 실행할 수 있습니다.
