...
|   |   |
|---|---|
| **보안 네트워크 및 시스템<br/>빌드 및 유지 관리** | 1. [카드 소유자 데이터를 보호하는 방화벽 구성 설치 및 유지 관리](pci-dss-requirement-1-firewall.md)<br/><br/> 2. [시스템 암호 및 기타 보안 매개 변수에 공급 업체에서 제공하는 기본값을 사용하지 마십시오.](pci-dss-requirement-2-password.md) |  
...
| **취약점 관리<br/>프로그램 유지 관리** | 5. [맬웨어에 대해 모든 시스템 보호 및 바이러스 백신 소프트웨어 또는 프로그램 정기적으로 업데이트](pci-dss-requirement-5-malware.md)<br/><br/> 6. [보안 시스템 및 응용 프로그램 개발 및 유지 관리](pci-dss-requirement-6-secure-system.md) |
