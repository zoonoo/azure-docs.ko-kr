...
ms.locfileid: "37906239"
---
# <a name="azure-security-and-compliance-blueprint-data-warehouse-for-pci-dss"></a>Azure 보안 및 규정 준수 청사진: PCI DSS용 데이터 웨어하우스
...
![PCI DSS용 데이터 웨어하우스 참조 아키텍처 다이어그램](images/pcidss-dw-threat-model.png "PCI DSS용 PaaS 웹 응용 프로그램 위협 모델")
