...
이 Azure 보안 및 규정 준수 청사진은 FFIEC(Federal Financial Institution Examination Council)에서 규제하는 재무 데이터의 수집, 저장 및 검색에 적합한 데이터 분석 아키텍처를 Azure에 배포하기 위한 지침을 제공합니다.
