---
title: Azure 보안 및 규정 준수 청사진 - FFIEC용 데이터 분석
description: Azure 보안 및 규정 준수 청사진 - FFIEC용 데이터 분석
services: security
author: meladie
...
이 Azure 보안 및 규정 준수 청사진은 FFIEC(Federal Financial Institution Examination Council)에서 규제하는 재무 데이터의 수집, 스토리지 및 검색에 적합한 데이터 분석 아키텍처를 Azure에 배포하기 위한 지침을 제공합니다.
...
[Azure 보안 및 규정 준수 청사진 – FFIEC 데이터 분석 구현 매트릭스](https://aka.ms/ffiec-analytics-cim)는 구현이 각 대상 목표의 요구 사항을 충족하는 방법에 대한 자세한 설명을 포함하여 데이터 분석 아키텍처에서 처리하는 FFIEC 목표에 대한 정보를 제공합니다.
