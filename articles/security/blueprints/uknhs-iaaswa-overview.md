---
title: Azure 보안 및 규정 준수 청사진 - UK NHS에 대한 IaaS 웹 응용 프로그램
description: Azure 보안 및 규정 준수 청사진 - UK NHS에 대한 IaaS 웹 응용 프로그램
services: security
author: jomolesk
...
![UK NHS용 IaaS 웹 응용 프로그램 참조 아키텍처 다이어그램](images/uknhs-iaaswa-architecture.png?raw=true "UK NHS용 IaaS 웹 응용 프로그램 참조 아키텍처 다이어그램")
...
**클라우드 감시**: [클라우드 감시](https://docs.microsoft.com/windows-server/failover-clustering/whats-new-in-failover-clustering#BKMK_CloudWitness)는 Azure를 중재 지점으로 활용하는 Windows Server 2016의 장애 조치 클러스터 쿼럼 감시의 한 유형입니다. 다른 모든 쿼럼 감시와 마찬가지로 클라우드 감시는 투표를 받고 쿼럼 계산에 참여할 수 있지만 공개적으로 사용 가능한 표준 Azure Blob Storage를 사용합니다. 따라서 공용 클라우드에서 호스팅되는 가상 머신에 대한 추가적인 유지 관리 오버헤드가 필요하지 않습니다.
...
![UK NHS용 IaaS 웹 응용 프로그램 위협 모델](images/uknhs-iaaswa-threat-model.png?raw=true "UK NHS용 IaaS 웹 응용 프로그램 위협 모델")
...
[Azure 보안 및 규정 준수 청사진 - UK NHS IaaS 웹 응용 프로그램 구현 매트릭스](https://aka.ms/uknhs-iaaswa-cim)는 구현이 각 대상 문서의 요구 사항을 충족시키는 방법에 대한 자세한 설명을 포함하여 IaaS 웹 응용 프로그램 아키텍처에서 UK NHS 요구 사항에 대처하는 정보를 제공합니다.
