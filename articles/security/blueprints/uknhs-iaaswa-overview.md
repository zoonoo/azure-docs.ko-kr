...
![UK NHS용 IaaS 웹 애플리케이션 참조 아키텍처 다이어그램](images/uknhs-iaaswa-architecture.png?raw=true "UK NHS용 IaaS 웹 애플리케이션 참조 아키텍처 다이어그램")
...
![UK NHS용 IaaS 웹 애플리케이션 위협 모델](images/uknhs-iaaswa-threat-model.png?raw=true "UK NHS용 IaaS 웹 애플리케이션 위협 모델")
