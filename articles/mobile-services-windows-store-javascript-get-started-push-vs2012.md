...
<div class="dev-center-tutorial-selector sublanding"> 
    <a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-dotnet-vs2012" title="Windows 스토어 C#">Windows 스토어 C#</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-js-vs2012" title="Windows 스토어 JavaScript" class="current">Windows 스토어 JavaScript</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-wp8" title="Windows Phone" class="current">Windows Phone</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-ios" title="iOS" class="current">iOS</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-android" title="Android" class="current">Android</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-xamarin-ios" title="Xamarin.iOS" class="current">Xamarin.iOS</a><a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-xamarin-android" title="Xamarin.Android">Xamarin.Android</a> 
</div>

이 항목에서는 Azure 모바일 서비스를 사용하여 Windows 스토어 앱에 푸시 알림을 보내는 방법을 보여 줍니다.
이 자습서에서는 빠른 시작 프로젝트에 대한 WPNS(Windows 푸시 알림 서비스)를 사용하여 푸시 알림을 추가합니다. 이 작업을 완료하면 레코드가 삽입될 때마다 모바일 서비스에서 푸시 알림을 전송합니다.

<div class="dev-callout"><b>참고</b>
    <p>이 자습서에서는 Visual Studio 2012에서 만든 Windows 스토어 앱에 푸시 알림을 추가합니다. Visual Studio 2013에는 모바일 서비스를 사용하여 Windows 스토어 앱에서 푸시 알림을 쉽게 설정할 수 있는 새로운 기능이 포함되어 있습니다. Visual Studio 2013 버전에 대한 자세한 내용은 <a href="/ko-kr/develop/mobile/tutorials/get-started-with-push-js">푸시 알림 시작</a>을 참조하십시오.</p>
</div>

이 자습서에서는 푸시 알림을 사용하도록 설정하는 다음 기본 단계를 단계별로 안내합니다.

1.  [푸시 알림을 위한 앱 등록 및 모바일 서비스 구성][푸시 알림을 위한 앱 등록 및 모바일 서비스 구성]
2.  [Registrations 테이블 만들기][Registrations 테이블 만들기]
...
이 자습서는 [데이터 시작][데이터 시작] 자습서를 기반으로 합니다. 이 자습서를 시작하기 전에 먼저 [이 자습서][데이터 시작]를 완료해야 합니다.

## <a name="register"></a><span class="short-header">앱 등록</span>Windows 스토어에 앱 등록
...
1.  default.js 파일을 열고 다음 코드 조각을 **app.OnActivated** 메서드 오버로드의 **args.setPromise** 메서드 바로 뒤에 삽입합니다.
    ...
    이 코드는 응용 프로그램이 시작될 때마다 푸시 알림 채널을 가져와 저장합니다.

2.  **MobileServiceClient** 인스턴스를 만드는 코드 뒤에 다음 코드를 삽입합니다.
...
-   [모바일 서비스 HTML/JavaScript 방법 개념 참조][모바일 서비스 HTML/JavaScript 방법 개념 참조]
  ...
  [인증 시작하기]: /ko-kr/develop/mobile/tutorials/get-started-with-users-js
