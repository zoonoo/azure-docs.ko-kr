<properties pageTitle="서비스 쪽 권한 부여(Android) | 모바일 개발자 센터" metaKeywords="" description="Azure 모바일 서비스의 .NET 백 엔드에서 사용자에게 권한을 부여하는 방법에 대해 알아봅니다." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="모바일 서비스 사용자의 서비스 쪽 권한 부여" authors="glenga" solutions="" manager="dwrede" editor="" />
...
2.  **Run** 메뉴에서 **Run**을 클릭하여 Android 에뮬레이터에서 프로젝트를 시작합니다.
...
-   [모바일 서비스 Android 방법 개념 참조][모바일 서비스 Android 방법 개념 참조]
    Android와 함께 모바일 서비스를 사용하는 방법에 대해 자세히 알아보세요.
