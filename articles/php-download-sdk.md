...
Mac 및 Linux용 Azure 명령줄 도구 사용 방법에 대한 내용은 [Mac 및 Linux용 명령줄 도구 사용 방법][Mac 및 Linux용 명령줄 도구 사용 방법]을 참조하십시오.
  ...
  [테이블 서비스 사용 방법]: http://go.microsoft.com/fwlink/?LinkId=252715
  [큐 서비스 사용 방법]: http://go.microsoft.com/fwlink/?LinkId=252716
  [Git를 설치]: http://git-scm.com/book/en/Getting-Started-Installing-Git
  [composer.phar]: http://getcomposer.org/composer.phar
  [PEAR를 설치]: http://pear.php.net/manual/en/installation.getting.php
  ...
  [PEAR 패키지 관리자]: http://pear.php.net/manual/en/installation.php
  [Microsoft 웹 플랫폼 설치 관리자]: http://go.microsoft.com/fwlink/?LinkId=253447
  [Azure PowerShell 사용 방법]: http://go.microsoft.com/fwlink/?LinkId=252718
  ...
  [Mac 및 Linux용 명령줄 도구 사용 방법]: http://go.microsoft.com/fwlink/?LinkId=252717
