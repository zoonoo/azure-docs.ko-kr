...
이 항목의 지침은 [PHP](http://www.php.net/manual/en/install.php)가 설치되어 있다고 가정합니다.
...
Azure용 PHP 클라이언트 라이브러리를 사용하는 방법에 대한 내용은 [Blob 서비스 사용 방법](http://go.microsoft.com/fwlink/?LinkId=252714), [테이블 서비스 사용 방법](http://go.microsoft.com/fwlink/?LinkId=252715) 및 [큐 서비스 사용 방법](http://go.microsoft.com/fwlink/?LinkId=252716)을 참조하십시오.

### 작성기를 통해 설치

1.  [Git를 설치](http://git-scm.com/book/en/Getting-Started-Installing-Git)합니다.
...
1.  [PEAR를 설치](http://pear.php.net/manual/en/installation.getting.php)합니다.
...
Azure PowerShell 및 Azure 에뮬레이터는 [Microsoft 웹 플랫폼 설치 관리자](http://go.microsoft.com/fwlink/?LinkId=253447)를 사용하여 설치하는 것이 좋습니다. PHP, SQL Server, PHP용 Microsoft Drivers for SQL Server, WebMatrix와 같은 다른 개발 구성 요소를 설치하도록 선택할 수도 있습니다.

Azure PowerShell 사용 방법에 대한 내용은 [Azure PowerShell 사용 방법](http://go.microsoft.com/fwlink/?LinkId=252718)을 참조하십시오.
...
-   **Mac**: Azure SDK 설치 관리자를 <http://go.microsoft.com/fwlink/?LinkId=252249>에서 다운로드합니다. 다운로드한 .pkg 파일을 열고 메시지가 표시되면 설치 단계를 완료합니다.

-   **Linux**: 최신 버전의 [Node.js](http://nodejs.org/)를 설치한 후([패키지 관리자를 통해 Node.js 설치](https://github.com/joyent/node/wiki/Installing-Node.js-via-package-manager)(영문) 참조) 다음 명령을 실행합니다.
...
Mac 및 Linux용 Azure 명령줄 도구 사용 방법에 대한 내용은 [Mac 및 Linux용 명령줄 도구 사용 방법](http://go.microsoft.com/fwlink/?LinkId=252717)을 참조하십시오.
