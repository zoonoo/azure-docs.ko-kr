...
ms.locfileid: "71037464"
---
# <a name="microsoft-azure-storage-explorer-release-notes"></a>Microsoft Azure Storage Explorer 릴리스 정보

이 문서에는 Azure Storage 탐색기 1.10.0 릴리스에 대 한 릴리스 정보와 이전 버전에 대 한 릴리스 정보가 포함 되어 있습니다.
...
### <a name="download-azure-storage-explorer-1100"></a>다운로드 Azure Storage 탐색기 1.10.0
- [Windows 용 Azure Storage 탐색기 1.10.0](https://go.microsoft.com/fwlink/?LinkId=708343)
- [Mac 용 Azure Storage 탐색기 1.10.0](https://go.microsoft.com/fwlink/?LinkId=708342)
- [Snap 저장소에 1.10.0 Azure Storage 탐색기](https://snapcraft.io/storage-explorer)
- [Linux 용 Azure Storage 탐색기 1.10.0](https://go.microsoft.com/fwlink/?LinkId=722418)
