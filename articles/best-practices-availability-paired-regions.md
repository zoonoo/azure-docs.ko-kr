...
4. 기본적으로 **Azure Resource Manager** 리소스 관리자는 지역 간에 구성 요소의 논리적 격리를 제공 합니다. 따라서 하나의 지역에서 발생한 논리적 오류가 다른 지역에 영향을 줄 가능성이 거의 없습니다.
