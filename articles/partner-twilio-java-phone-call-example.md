...
또한 Eclipse를 사용하지 않는 경우 [Eclipse용 Azure 플러그 인(Java 포함)(Microsoft Open Technologies 제공)을 사용하여 Hello World 응용 프로그램 만들기][azure_java_eclipse_hello_world](영문)의 내용 또는 Azure에서 Java 응용 프로그램을 호스트하기 위한 기타 기술에 대해 알아보는 것이 좋습니다.
