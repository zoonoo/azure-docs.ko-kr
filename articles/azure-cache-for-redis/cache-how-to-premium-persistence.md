...
> [!NOTE]
> 
> 데이터는 지속 될 때 자동으로 암호화 Azure Storage 합니다. 암호화에 고유한 키를 사용할 수 있습니다. 자세한 내용은 [Azure Key Vault를 사용 하 여 고객 관리 키](../storage/common/storage-service-encryption.md)를 참조 하세요.
> 
> 

## <a name="set-up-data-persistence"></a>데이터 지 속성 설정
...
8. RDB 지 속성을 사용 하도록 설정 하려면 **rdb** 를 클릭 하 고 설정을 구성 합니다. 
   ...
   > [!NOTE]
   > RDB 파일은 저장소에 백업 될 때 페이지 blob 형식으로 저장 됩니다.
...
* [데이터 지 속성에 사용 되는 저장소에 대 한 요금이 청구 됩니까?](#will-i-be-charged-for-the-storage-being-used-in-data-persistence)
...
### <a name="will-i-be-charged-for-the-storage-being-used-in-data-persistence"></a>데이터 지 속성에 사용 되는 저장소에 대 한 요금이 청구 됩니까?

예, 사용 중인 저장소 계정에 대 한 가격 책정 모델에 따라 사용 되는 저장소에 대 한 요금이 청구 됩니다.
