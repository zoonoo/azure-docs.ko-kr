---
title: .NET 앱에서 Azure Cache for Redis를 사용하는 방법에 대한 빠른 시작
...
- [.NET Framework 4 이상](https://www.microsoft.com/net/download/dotnet-framework-runtime) - StackExchange.Redis 클라이언트를 사용하려면 필요합니다.
