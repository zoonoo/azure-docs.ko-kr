...
애플리케이션의 데이터에 대한 많은 처리량을 짧은 대기 시간 동안 처리할 수 있도록 하는 보안 데이터 캐시 및 메시징 broker인 Azure Cache for Redis를 사용하는 방법에 대해 알아봅니다. 자습서, API 참조 및 기타 설명서에서는 Azure에 있는 애플리케이션의 Azure Cache for Redis를 사용하는 방법을 보여 줍니다.
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis 프리미엄 계층에 대해 알아보기</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis 라이브러리</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>.NET을 사용하여 Azure Cache for Redis 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>ASP.NET MVC를 사용하여 Azure Cache for Redis 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Node.js를 사용하여 Azure Cache for Redis 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Java를 사용하여 Azure Cache for Redis 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Python을 사용하여 Azure Cache for Redis 시작</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Azure Cache for Redis에서 변경 가능한 부분 데이터로 작업</h3>
                    </div>
                </div>
            </div>
        </div>
...
**[더 많은 대화형 학습 보기...](/learn/browse?products=azure-redis-cache)**
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/cli/azure/redis">Azure CLI 2.0(미리 보기)</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST (영문)</h3>
                        <p><a href="https://docs.microsoft.com/rest/api/redis/">REST API 참조</a></p>
                    </div>
                </div>
            </div>
        </div>
