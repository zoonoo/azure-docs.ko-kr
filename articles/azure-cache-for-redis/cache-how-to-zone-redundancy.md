...
1. **새 Redis Cache** 페이지에서 새 캐시의 설정을 구성합니다.
    ...
    | **가용성 영역** | 드롭다운 및 사용할 영역을 선택 합니다. | 캐시에 대 한 Vm은 선택 된 영역에 최대한 균등 하 게 분산 됩니다. 예를 들어 캐시에 세 개의 복제본이 있고 두 개의 영역을 사용 하는 경우 각 영역에 두 개의 Vm이 있습니다. |
...
1. **만들기**를 클릭합니다. 
    ...
    :::image type="content" source="media/cache-how-to-zone-redundancy/create-zones.png" alt-text="Redis에 대 한 Azure 캐시를 만듭니다.":::
