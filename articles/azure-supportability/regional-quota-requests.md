...
## <a name="request-total-regional-vcpus-quota-increase-at-subscription-level-using-the-help--support-blade"></a>**도움말 + 지원** 블레이드를 사용 하 여 구독 수준에서 총 지역 vcpus 할당량 증가 요청
