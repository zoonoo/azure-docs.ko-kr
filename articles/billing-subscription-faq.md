<properties
	pageTitle="Azure 청구 및 구독 FAQ | Microsoft Azure"
...
>[AZURE.NOTE] 관리자 권한으로 로그인했는지 확인하세요. 계정 관리자는 [계정 센터](https://account.windowsazure.com/)에만 액세스할 수 있는 반면 SA(서비스 관리자) 및 CA(공동 관리자)는 [Azure 포털](https://portal.azure.com/) 또는 [Azure 클래식 포털](https://manage.windowsazure.com/)에 대한 액세스 권한이 있습니다.
...
>[AZURE.NOTE] DreamSpark 구독은 할당량을 증가할 수 없습니다.
