...
<properties 
    pageTitle="3분 이내로 장치에서 RemoteApp 시도"
    description="서비스를 설치하지 않고 RemoteApp 기능을 시험 사용합니다." 
    services="remoteapp" 
...
# 3분 이내로 장치에서 RemoteApp 시도

장치에서 RemoteApp를 볼까요? Microsoft 계정으로 액세스되어 있는 한 10분 동안 데모 배포에 액세스할 수 있습니다. Office 및 몇몇 다른 응용 프로그램을 사용할 수 있습니다. 3분 이내에 사용자가 RemoteApp을 시험 사용할 수 있는 가장 좋은 방법입니다.
...
이제 RemoteApp에서 실시간으로 실행 중인 응용 프로그램에 액세스할 수 있습니다. 
