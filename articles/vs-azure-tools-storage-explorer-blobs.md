...
[SAS (공유 액세스 서명)](storage/common/storage-dotnet-shared-access-signature-part-1.md) 는 저장소 계정의 리소스에 대 한 위임 된 액세스를 제공 합니다.
...
7. 수행하려는 작업에 따라서 다음 단계를 수행하세요.
   ...
   * **Blob 컨테이너에 파일 업로드**
     ...
     1. 기본 창의 도구 모음에서 **업로드**를 선택 하 고 드롭다운 메뉴에서 **파일 업로드** 를 선택 합니다.
