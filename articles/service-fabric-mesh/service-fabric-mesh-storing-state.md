---
title: Azure Service Fabric Mesh의 상태 스토리지 옵션
...
![다이어그램은 볼륨으로 이동하는 서비스를 보여주는데, 볼륨은 복제된 로컬 디스크의 Service Fabric 안정적 볼륨으로 이동하고 네트워크 스토리지의 Azure Files 볼륨으로 이동합니다.][image3]
