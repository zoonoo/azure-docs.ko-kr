---
title: Azure 서비스 패브릭 메시 샘플 찾기
description: 사용 가능한 서비스 패브릭 메시 샘플 응용 프로그램의 인덱스는 다음과 같습니다. 이 예제의 소스 코드에서는 Service Fabric 리소스 모델을 사용하여 특정 시나리오를 수행하는 방법을 보여줍니다.
ms.date: 12/03/2018
ms.topic: conceptual
...
Azure에 직접 템플릿을 배포하는 것에 대한 자세한 내용은 [샘플 템플릿 GitHub 페이지를 참조하십시오.](https://github.com/Azure-Samples/service-fabric-mesh/blob/master/templates/README.md)
...
| [투표 앱](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/templates/voting) | DNS 기반 해결을 사용하는 프런트 엔드 및 백 엔드 서비스를 사용하여 애플리케이션을 만듭니다. | [소스 코드](https://github.com/Azure-Samples/service-fabric-mesh/tree/master/src/votingapp) | 윈도우 버전에 대한 비주얼 스튜디오 메쉬 툴링, VS 코드 / 도트넷 CLI는 리눅스 버전에 사용할 수 있습니다 |
