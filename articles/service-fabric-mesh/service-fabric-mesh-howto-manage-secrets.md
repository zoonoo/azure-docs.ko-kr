---
title: Azure Service Fabric Mesh 애플리케이션 비밀 관리
...
inlinedValue 종류 정의를 사용하여 Azure 리소스 모델 JSON 또는 YAML 파일에서 Mesh 비밀 리소스가 선언됩니다. Mesh 비밀 리소스는 보안 스토리지 서비스 제공 비밀을 지원합니다. 
>
