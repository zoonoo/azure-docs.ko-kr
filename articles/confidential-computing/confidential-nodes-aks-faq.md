...
<a name="1"></a>
### <a name="are-the-confidential-computing-nodes-on-aks-in-ga"></a>GA의 AKS에 대 한 기밀 컴퓨팅 노드가 있나요? ###
예
...
아니요. AKS의 기밀 컴퓨팅 노드를 구성을 하는 DCSv2 가상 머신에서 가속화 된 네트워킹을 지원 하지 않습니다. 
...
<a name="5"></a>
### <a name="what-version-of-intel-sgx-driver-version-is-on-the-aks-image-for-confidential-nodes"></a>기밀 노드에 대 한 AKS 이미지에 있는 Intel SGX Driver 버전의 버전은 무엇입니까? ### 
...
아니요. [AKS 엔진 기반 기밀 컴퓨팅 노드](https://github.com/Azure/aks-engine/blob/master/docs/topics/sgx.md) 는 사용자 지정 설치를 허용 하 고 Kubernetes 제어 평면에 대 한 모든 권한을 보유 하는 기밀 컴퓨팅 노드를 지원 합니다.
<a name="7"></a>
...
지금은 없습니다. Windows 노드나 컨테이너에 필요한 경우에는에서 제품 팀에 문의 하세요 *acconaks@microsoft.com* . 
...
<a name="13"></a>
### <a name="do-you-automatically-install-any-additional-daemonset-to-expose-the-sgx-drivers"></a>모든 추가 daemonset를 자동으로 설치 하 여 SGX 드라이버를 표시 하나요? ###

예. Daemonset의 이름은 sgx-장치 플러그 인입니다. [여기](confidential-nodes-aks-overview.md)에서 해당 목적에 대해 자세히 알아보세요.  
...
<a name="20"></a>
### <a name="what-are-the-known-current-limitations-of-the-product"></a>제품의 알려진 현재 제한은 무엇 인가요? ###
...
<a name="21"></a>
### <a name="will-only-signed-and-trusted-images-be-loaded-in-the-enclave-for-confidential-computing"></a>기밀 컴퓨팅을 위해 서명 되 고 신뢰할 수 있는 이미지만 enclave에 로드 되나요? ###
Enclave 초기화 중에는 기본적으로 지원 되지 않지만 예를 들어 증명 프로세스 서명의 유효성을 검사할 수 있습니다. 참조 [하세요](../attestation/basic-concepts.md#benefits-of-policy-signing). 
