...
기밀 컨테이너를 사용 하 여 기밀 의료 데모를 봅니다. 샘플은 [여기](https://docs.microsoft.com/azure/architecture/example-scenario/confidential/healthcare-inference)에서 사용할 수 있습니다. 
