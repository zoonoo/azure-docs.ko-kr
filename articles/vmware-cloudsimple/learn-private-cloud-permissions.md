...
| **전역적** | 작업 취소 <br> 용량 계획 <br> 진단 <br> 메서드 사용 안 함 <br> 메서드 사용 <br> 전역 태그 <br> 상태 <br> 라이선스 <br> 로그 이벤트 <br> 사용자 지정 특성 관리 <br> 프록시 <br> 스크립트 동작 <br> 서비스 관리자 <br> 사용자 지정 특성 설정 <br> 시스템 태그 |
