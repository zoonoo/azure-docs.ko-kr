...
| 백업 서버 <br> *Required for deploying Veeam Backup & Replication components* | Backup Proxy  | TCP/UDP  | 135, 137 to 139 and 445 |
    | 백업 서버   | DNS  | UDP  | 53  | 
    | 백업 서버   | Veeam Update Notification Server  | TCP  | 80  | 
    | 백업 서버   | Veeam License Update Server  | TCP  | 443  | 
