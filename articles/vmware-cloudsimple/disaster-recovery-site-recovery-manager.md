...
2. 사설 클라우드에서 vSphere 복제 및 SRM 설치를 위한 사용자를 만듭니다. VCenter UI에서 [아래에 설명 되어 있습니다. VRA & SRM 설치용](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)사설 클라우드에서 사용자를 만듭니다.
...
5. VRA에 대 한 방화벽 규칙을 구성 합니다. Cloudsimple 포털 [에서 아래에 설명 되어 있습니다. VRA](#cloudsimple-portal-configure-firewall-rules-for-vra)에 대 한 방화벽 규칙을 구성 합니다.
...
Srm-고-관리자 자격 증명을 사용 하 여 vCenter에 로그인 한 후 VMware 설명서에 따라이 Vmware에 설명 된 대로 배포 모델의 두 사이트 토폴로지 (플랫폼 서비스 컨트롤러 당 하나의 vCenter 인스턴스 포함)에서 SRM 서버 설치를 수행 합니다. [ 문서](https://docs.vmware.com/en/Site-Recovery-Manager/6.5/com.vmware.srm.install_config.doc/GUID-F474543A-88C5-4030-BB86-F7CC51DADE22.html). SRM 6.5에 대 한 설치 지침은 [Site Recovery Manager를 설치](https://docs.vmware.com/en/Site-Recovery-Manager/6.5/com.vmware.srm.install_config.doc/GUID-437E1B65-A17B-4B4B-BA5B-C667C90FA418.html)하는 VMware 문서에서 사용할 수 있습니다.
...
#### <a name="cloudsimple-portal-de-escalate-privileges"></a>CloudSimple 포털: 권한 상승
