---
title: Azure VMware CloudSimple-CloudSimple 작업 관리 솔루션
description: VMware 솔루션 CloudSimple 하 여 작업 개념을 설명합니다.
author: sharaths-cs
ms.author: dikamath
ms.date: 04/30/2019
ms.topic: article
...
감사를 수행 하는 추적 작업을 기록 합니다.  로그 작업에 대 한 사용자가 제공한 매개 변수를 포함 합니다.  모든 사용자에 대 한 사용자 활동을 모니터링 하려면 감사 로그를 사용할 수 있습니다.

## <a name="next-steps"></a>다음 단계

* [요약 계정 보기](https://docs.azure.cloudsimple.com/account/)
* [사용 현황 로그를 보려면](https://docs.azure.cloudsimple.com/usage/)