...
4. NSX-T Manager에 로그인 하 고 **네트워킹** > **라우팅** > **라우터** > **공급자-LR** > **라우팅** > **BGP**1**이웃**을 선택 합니다. 첫 번째 인접 항목을 선택 합니다.  > **주소 패밀리** **편집** 을 클릭 합니다. IPv4 패밀리의 경우 **아웃 필터** 열을 편집 하 고 만든 IP 접두사 목록을 선택 합니다. 페이지 맨 아래에 있는 **저장**을 참조하세요. 두 번째 인접 항목에 대해이 단계를 반복 합니다.
