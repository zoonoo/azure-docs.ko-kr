...
#### <a name="cloudsimple-portal-configure-firewall-rules-to-secure-horizon-management-plane"></a>CloudSimple 포털: 방화벽 규칙을 구성 하 여 수평 관리 평면 보호
