---
title: CloudSimple 빠른 시작에의 한 azure VMware 솔루션-Azure에서 VMware Vm 사용
description: CloudSimple에서 Azure VMware 솔루션을 사용 하 여 Azure Portal에서 VMware Vm을 구성 하 고 사용 하는 방법을 알아봅니다.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/14/2019
ms.topic: article
...
ms.locfileid: "69574498"
---
# <a name="quickstart---consume-vmware-vms-on-azure"></a>빠른 시작-Azure에서 VMware Vm 사용

Azure Portal에서 가상 컴퓨터를 만들려면 CloudSimple 관리자가 구독에 대해 사용 하도록 설정한 가상 컴퓨터 템플릿을 사용 합니다. VM 템플릿은 VMware 인프라에 있습니다.

## <a name="cloudsimple-vm-creation-on-azure-requires-a-vm-template"></a>Azure에서 CloudSimple VM을 만들려면 VM 템플릿이 필요 합니다.

VCenter UI에서 사설 클라우드에 가상 컴퓨터를 만듭니다. 템플릿을 만들려면 [vSphere 웹 클라이언트에서 템플릿에 가상 머신 복제](https://docs.vmware.com/en/VMware-vSphere/6.7/com.vmware.vsphere.vm_admin.doc/GUID-FE6DE4DF-FAD0-4BB0-A1FD-AFE9A40F4BFE.html)의 지침을 따릅니다. 사설 클라우드 vCenter에 VM 템플릿을 저장 합니다.
...
4. 기본 정보를 입력 하 고 **다음: 크기**를 클릭 합니다.
    ...
    | 사용자 계정 | Windows 템플릿에만 사용할 VM 관리자의 사용자 이름입니다.|
