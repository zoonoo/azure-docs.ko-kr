---
title: CloudSimple service에서 Azure VMware 솔루션 만들기
...
ms.locfileid: "68812434"
---
# <a name="create-azure-vmware-solution-by-cloudsimple---service"></a>CloudSimple Service에서 Azure VMware 솔루션 만들기
...
8. 서비스 게이트웨이의 CIDR을 입력 합니다. 기존 서브넷과 겹치지 않는/28 서브넷을 지정 합니다.  여기에는 온-프레미스 서브넷, Azure 서브넷 또는 예정 된 CloudSimple 서브넷이 포함 됩니다. 서비스를 만든 후에는 CIDR을 변경할 수 없습니다.
