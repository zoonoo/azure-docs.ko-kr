...
2. **Cloudsimple 서비스**를 검색 합니다.
    ![검색 CloudSimple Service](media/create-cloudsimple-service-search.png)
3. **Cloudsimple 서비스**를 선택 합니다.
4. **추가** 를 클릭 하 여 새 서비스를 만듭니다.
    CloudSimple Service](media/create-cloudsimple-service-add.png) 추가 ![
