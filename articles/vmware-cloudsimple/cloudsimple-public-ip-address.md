---
title: Azure VMware 솔루션 (AVS)-공용 IP 주소
description: 공용 IP 주소 및 Azure VMware 솔루션 (AVS)의 이점에 대해 알아봅니다.
author: sharaths-cs
ms.author: dikamath
ms.date: 08/20/2019
ms.topic: article
...
---
# <a name="avs-public-ip-address-overview"></a>AVS 공용 IP 주소 개요

공용 IP 주소를 사용 하면 인터넷 리소스가 개인 IP 주소에서 AVS 사설 클라우드 리소스에 대 한 인바운드를 통신할 수 있습니다. 개인 IP 주소는 사용자의 AVS 사설 클라우드 vCenter에 있는 가상 머신 또는 소프트웨어 부하 분산 장치입니다. 공용 IP 주소를 사용 하 여 AVS 사설 클라우드에서 실행 되는 서비스를 인터넷에 노출할 수 있습니다.
