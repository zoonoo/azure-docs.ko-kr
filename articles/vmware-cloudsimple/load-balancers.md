...
널리 사용 되는 공급 업체는 http://nginx.org/en/docs/http/load_balancing.html 다음과 같습니다. NginX: F5- https://www.f5.com/products/big-ip-services/virtual-editions 이상 ip-Traffic Manager: Citrix ADC:https://www.citrix.com/products/citrix-adc/
