...
# C를 사용한 SQL 데이터베이스 연결 및 쿼리# 

이 항목에서는 ADO.NET을 사용하여 기존 AdventureWorks SQL 데이터베이스에 연결하는 방법을 보여주는 C# 코드 샘플을 소개합니다. 이 샘플은 콘솔 응용 프로그램으로 컴파일되어 데이터베이스를 쿼리하고 결과를 표시합니다.
...
1. 아래에서 코드 샘플을 복사하여 콘솔 응용 프로그램에 붙여넣습니다.
...
1. [Azure 포털](http://portal.azure.com/)을 엽니다.
...
데이터베이스 연결 문자열 블레이드에서 ADO.NET, ODBC, PHP 및 JDBC에 대한 적절한 연결 문자열을 확인합니다.
