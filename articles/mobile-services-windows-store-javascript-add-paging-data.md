<properties pageTitle="데이터에 페이징 추가(JavaScript) - Azure 모바일 서비스" description="페이징을 사용하여 모바일 서비스에서 Windows 스토어 JavaScript 앱에 반환되는 데이터의 양을 관리하는 방법에 대해 알아봅니다." services="mobile-services" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
