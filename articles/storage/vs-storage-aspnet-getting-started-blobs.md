---
title: Blob 저장소 및 Visual Studio 연결된 서비스 시작(ASP.NET) | Microsoft Docs
...
> [!NOTE]
> ASP.NET 5에서 Azure 저장소에 대한 호출을 수행하는 일부 API는 비동기식입니다. 자세한 내용은 [Async 및 Await를 사용한 비동기 프로그래밍](http://msdn.microsoft.com/library/hh191443.aspx)을 참조하세요.
> 
> 
