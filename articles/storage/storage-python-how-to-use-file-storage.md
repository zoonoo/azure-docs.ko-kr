---
title: "Python에서 Azure File Storage를 사용하는 방법 | Microsoft Docs"
...
**create\_file\_from\_path**는 지정된 경로에서 파일의 내용을 업로드하고, **create\_file\_from\_stream**은 이미 열려 있는 파일/스트림에서 내용을 업로드합니다. **create\_file\_from\_bytes**는 바이트 배열을 업로드하고, **create\_file\_from\_text**는 지정된 인코딩(기본값: UTF-8)을 사용하여 지정된 텍스트 값을 업로드합니다.
