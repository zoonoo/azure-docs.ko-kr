---
title: Python에서 Azure 파일 저장소를 사용하는 방법 | Microsoft Docs
...
[!INCLUDE [저장소-선택기-파일-포함](../../includes/storage-selector-file-include.md)]
...
[!INCLUDE [저장소-파일-개념-포함](../../includes/storage-file-concepts-include.md)]
