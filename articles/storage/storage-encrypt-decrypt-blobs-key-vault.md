...
다음은 키 자격 증명에 저장된 키와 함께 클라이언트 쪽 암호화를 사용하여 암호화한 Blob에 대한 현재 [Azure 클래식 포털](manage.windowsazure.com)의 스크린샷입니다. **KeyId** 속성은 키 KEK 역할을 하는 키 자격 증명 모음의 키에 대한 URI입니다. **EncryptedKey** 속성은 CEK의 암호화된 버전을 포함하고 있습니다.
