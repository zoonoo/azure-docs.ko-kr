<properties 
	...
	description="Visual Studio의 Azure WebJob 프로젝트에서 Azure Blob 저장소를 사용하는 방법" 
	services="storage" 
	documentationCenter="" 
	authors="patshea123" 
	manager="douge" 
...
이 문서에서는 Azure Blob을 만들거나 업데이트할 때 프로세스를 트리거하는 방법을 보여 주는 Azure Blob C# 코드 샘플을 제공합니다. 코드 샘플에서는 [WebJobs SDK](websites-dotnet-webjobs-sdk.md) 버전 1.x를 사용합니다.

## Blob가 만들어지거나 업데이트될 때 함수를 트리거하는 방법
