<properties
	pageTitle="Blob 저장소 및 Visual Studio 연결된 서비스 시작(WebJob 프로젝트) | Microsoft Azure"
...
## Blob이 만들어지거나 업데이트될 때 함수를 트리거하는 방법
...
* **CloudBlockBlob**
* **CloudPageBlob**
* [ICloudBlobStreamBinder](#getting-serialized-blob-content-by-using-icloudblobstreambinder)에 의해 deserialize된 다른 유형

Azure 저장소 계정으로 직접 작업하려는 경우 메서드 서명에 **CloudStorageAccount** 매개 변수를 추가할 수도 있습니다.

## 문자열에 바인딩하여 텍스트 Blob 콘텐츠 가져오기
...
## ICloudBlobStreamBinder를 사용하여 serialize된 Blob 콘텐츠 가져오기
