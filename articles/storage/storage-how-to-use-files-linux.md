...
* **cifs-utils 패키지를 설치할 수 있는 Linux 배포판을 선택합니다**. Azure 이미지 갤러리에서 권장되는 Linux 배포판은 다음과 같습니다.
    ...
    * SUSE Linux Enterprise Server 12   
    ...
    > [!Note]  
    > 최신 버전의 cifs-utils 패키지를 다운로드하여 설치하거나 컴파일하는 모든 Linux 배포판은 Azure File Storage와 함께 사용할 수 있습니다.
...
* [Azure Storage에서 Azure CLI 사용](storage-azure-cli.md#create-and-manage-file-shares)
