---
title: "Linux에서 Azure Files 사용 방법 | Microsoft Docs"
...
---
# <a name="how-to-use-azure-file-storage-with-linux"></a>Linux에서 Azure 파일 저장소 사용 방법
...
## <a name="video-using-azure-file-storage-with-linux"></a>비디오: Linux에서 Azure 파일 저장소 사용
...
## <a name="choose-a-linux-distribution-to-use"></a>사용할 Linux 배포판
...
## <a name="mount-the-file-share"></a>파일 공유 탑재
...
RHEL 7.3을 사용하는 경우 다음과 같이 파일을 탑재할 수 있습니다.
...
## <a name="manage-the-file-share"></a>파일 공유 관리
...
## <a name="feedback-and-more-information"></a>피드백 및 추가 정보
...
* [파일 공유 만들기 및 관리](storage-azure-cli.md#create-and-manage-file-shares) 

### <a name="reference"></a>참조
* [파일 서비스 REST API 참조](http://msdn.microsoft.com/library/azure/dn167006.aspx)
* [Azure 파일 문제 해결 문서](storage-troubleshoot-file-connection-problems.md)
