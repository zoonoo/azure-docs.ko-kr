...
* [.NET에서 Azure 테이블 저장소 시작](https://azure.microsoft.com/documentation/samples/storage-table-dotnet-getting-started/)에 있는 더 많은 테이블 저장소 샘플을 참조하세요.
