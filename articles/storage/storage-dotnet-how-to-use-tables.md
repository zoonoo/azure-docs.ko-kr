...
이 자습서에서는 몇 가지 일반적인 Azure Table Storage 시나리오에서 [.NET용 Azure Storage 클라이언트 라이브러리](https://www.nuget.org/packages/WindowsAzure.Storage/)를 사용하는 방법을 보여 줍니다. 테이블 만들기 및 삭제, 테이블 데이터 삽입, 업데이트, 삭제 및 쿼리 등 C# 예제를 사용하는 다음과 같은 시나리오가 제시됩니다.
