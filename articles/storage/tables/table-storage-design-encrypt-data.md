...
description: Azure Storage에서 테이블 데이터 암호화에 대해 알아봅니다. .NET Azure Storage 클라이언트 라이브러리를 사용하면 삽입 및 바꾸기 작업을 위해 문자열 엔터티를 암호화할 수 있습니다.
services: storage
author: tamram
ms.author: tamram
ms.service: storage
