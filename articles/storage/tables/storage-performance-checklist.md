...
| &nbsp; |확장성 목표 |[초당 엔터티의 확장 목표에 도달하고 있습니까?](#table-specific-scalability-targets) |
...
Table service의 확장성 목표에 대한 자세한 내용은 [스토리지 계정에 대한 Azure Storage 확장성 및 성능 목표](/azure/storage/common/storage-scalability-targets?toc=%2fazure%2fstorage%2ftables%2ftoc.json#azure-table-storage-scale-targets)를 참조하세요.
...
## <a name="table-specific-scalability-targets"></a>테이블 관련 확장성 목표
