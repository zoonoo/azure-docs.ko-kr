---
title: Java에서 파일 저장소를 사용하는 방법| Microsoft Docs
...
[!INCLUDE [저장소-만들기-계정-포함](../../includes/storage-create-account-include.md)]
...
> [!NOTE]
> your\_storage\_account\_name과 your\_storage\_account\_key를 자신의 저장소 계정에 대한 실제 값으로 바꿉니다.
> 
> 
