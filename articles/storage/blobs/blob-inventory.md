...
| includeSnapshots    | 부울                         | 인벤토리에 스냅숏을 포함할지 여부를 지정 합니다. 기본값은 **false** 입니다. | 아니요 |
| includeBlobVersions | 부울                         | 인벤토리에 blob 버전을 포함할지 여부를 지정 합니다. 기본값은 **false** 입니다. | 아니요 |
...
- [컨테이너 당 blob의 개수 및 총 크기를 계산 합니다.](calculate-blob-count-size.md)
