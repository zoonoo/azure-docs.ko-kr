...
> [!IMPORTANT]
> 이 자습서를 완료하려면 Blob 저장소 이벤트 미리 보기에 등록해야 합니다.  미리 보기 프로그램에 대한 자세한 내용은 [여기](storage-blob-event-overview.md#join-the-preview)를 참조하세요.
...
> [!NOTE]
> 미리 보기 릴리스의 경우 Blob 저장소 이벤트는 **westcentralus** 위치의 저장소 계정에서만 사용할 수 있습니다.
