...
| [Hadoop](https://hadoop.apache.org/) | 2.7 이상 | [Apache Hadoop 릴리스 보관 파일](https://hadoop.apache.org/release.html) |
...
| [Azure Databricks](https://azure.microsoft.com/services/databricks/) | 4.2 이상 | [Databricks Runtime 버전](https://docs.databricks.com/release-notes/runtime/databricks-runtime-ver.html) |
|[Hortonworks](https://hortonworks.com/)| 2.6 이상 | [Hortonworks 설명서](https://docs.hortonworks.com/) |
...
-   [Data Lake Storage Gen2를 사용하여 HDInsight 클러스터 만들기](data-lake-storage-quickstart-create-connect-hdi-cluster.md)
