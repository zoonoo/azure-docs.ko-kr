...
예를 들어 **$web** 컨테이너의 공용 액세스 수준을 **개인 (익명 액세스 없음)** 에서 **blob (blob에 대 한 익명 읽기 액세스**)로 변경 하는 경우 주 정적 웹 사이트 끝점 `https://contosoblobaccount.z22.web.core.windows.net/index.html` 에 대 한 공용 액세스 수준이 변경 되지 않습니다.
