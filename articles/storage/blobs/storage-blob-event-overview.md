...
> |자산|Type|설명|
> |-------------------|------------------------|-----------------------------------------------------------------------|
> |topic|문자열|이벤트를 내보내는 저장소 계정의 전체 Azure Resource Manager ID입니다.|
> |subject|문자열|이벤트 주체인 개체에 대한 상대 리소스 경로로, Azure RBAC용 저장소 계정, 서비스 및 컨테이너를 설명하는 데 사용하는 것과 동일한 확장 Azure Resource Manager 형식을 사용합니다.  이 형식은 대소문자가 구분되는 Blob 이름을 포함합니다.|
