---
title: "Azure Blob Storage 이벤트에 대응(미리 보기) | Microsoft Docs"
...
> * blobType 필드를 사용하여 Blob에 허용되는 작업 형식을 파악하고 Blob에 액세스하는 데 사용해야 하는 클라이언트 라이브러리 형식을 확인합니다.
