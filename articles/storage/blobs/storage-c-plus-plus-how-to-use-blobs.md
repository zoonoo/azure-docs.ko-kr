...
로컬 Windows 컴퓨터에서 응용 프로그램을 테스트 하기 위해 [Azurite 저장소 에뮬레이터](../common/storage-use-azurite.md)를 사용할 수 있습니다. Azurite는 로컬 개발 컴퓨터의 Azure에서 사용할 수 있는 Blob 및 큐 서비스를 시뮬레이트하는 유틸리티입니다. 다음 예제에서는 로컬 스토리지 에뮬레이터에 연결 문자열을 포함할 수 있도록 정적 필드를 선언하는 방법을 보여줍니다.
