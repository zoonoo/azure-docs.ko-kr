...
로컬 Windows 컴퓨터에서 애플리케이션을 테스트하려면 [Azurite 스토리지 에뮬레이터](../common/storage-use-azurite.md)를 사용하면 됩니다. Azurite는 로컬 개발 머신의 Azure에서 사용할 수 있는 Blob 및 큐 서비스를 시뮬레이션하는 유틸리티입니다. 다음 예제에서는 로컬 스토리지 에뮬레이터에 연결 문자열을 포함할 수 있도록 정적 필드를 선언하는 방법을 보여줍니다.
