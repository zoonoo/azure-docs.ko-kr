...
이 문서의 예제에서는 [Blob 저장소에 대 한 Azure Storage 클라이언트 라이브러리](https://www.nuget.org/packages/Azure.Storage.Blobs)의 최신 미리 보기 버전을 사용 합니다. 미리 보기 패키지를 설치 하려면 NuGet 패키지 관리자 콘솔에서 다음 명령을 실행 합니다.
