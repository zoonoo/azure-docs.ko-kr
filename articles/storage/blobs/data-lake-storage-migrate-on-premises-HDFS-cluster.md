...
Data Box 장치를 사용 하 여 Hadoop 클러스터의 온-프레미스 HDFS 저장소에서 Azure Storage (blob Storage 또는 Data Lake Storage Gen2)로 데이터를 마이그레이션할 수 있습니다. 80-TB Data Box 또는 770 TB Data Box Heavy Data Box Disk에서 선택할 수 있습니다.

이 문서는 다음 작업을 완료 하는 데 도움이 됩니다.

> [!div class="checklist"]
> * 데이터 마이그레이션을 준비 합니다.
> * 데이터를 Data Box Disk Data Box 또는 Data Box Heavy 장치로 복사 합니다.
