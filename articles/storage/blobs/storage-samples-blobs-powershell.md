...
| [Windows에서 AzCopy를 사용해 여러 저장소 계정으로 Blob 마이그레이션](../scripts/storage-common-transfer-between-storage-accounts.md?toc=%2fpowershell%2fmodule%2ftoc.json)| Windows에서 AzCopy를 사용해 여러 Azure 저장소 계정으로 Blob을 마이그레이션하는 방법을 설명합니다. |
|**Blob storage**||
