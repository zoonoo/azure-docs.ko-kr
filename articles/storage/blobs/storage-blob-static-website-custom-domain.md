---
title: '자습서: Azure의 정적 웹 사이트에 대한 사용자 지정 도메인 및 SSL 사용'
...
ms.locfileid: "74327507"
---
# <a name="tutorial-enable-custom-domain--ssl-for-a-static-website-in-azure"></a>자습서: Azure의 정적 웹 사이트에 대한 사용자 지정 도메인 및 SSL 사용
