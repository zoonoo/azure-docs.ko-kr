---
title: Gen1에서 Gen2로 Azure Data Lake Storage 업그레이드
description: Gen1에서 Gen2로 Azure Data Lake Storage을 업그레이드 합니다.
author: normesta
ms.topic: conceptual
ms.author: normesta
ms.date: 11/19/2019
...
ms.locfileid: "74894235"
---
# <a name="upgrade-azure-data-lake-storage-from-gen1-to-gen2"></a>Gen1에서 Gen2로 Azure Data Lake Storage 업그레이드
...
: heavy_check_mark: 업그레이드 준비를 평가 합니다.

: heavy_check_mark: 업그레이드 계획

: heavy_check_mark: 업그레이드를 수행 합니다.
...
: heavy_check_mark: Azure 에코 시스템

: heavy_check_mark: 파트너 에코 시스템
...
| 서버 쪽 API| [WebHDFS 호환 REST API](https://msdn.microsoft.com/library/azure/mt693424.aspx) | Azure Blob Service REST API, [Data Lake Storage Gen2 REST API](https://docs.microsoft.com/rest/api/storageservices/data-lake-storage-gen2) | Data Lake Storage Gen2 REST API – *지금 사용 가능* <br><br> Azure Blob Service REST API – *지금 사용 가능*       |
...
| 데이터 작업 – 로그  | yes | yes | *지금 사용 가능* (미리 보기). [알려진 문제](data-lake-storage-known-issues.md)를 참조하세요.<br><br> Azure Monitoring 통합 – *아직 사용할 수 없음* |
...
| 개발자 SDK | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| Blob SDK- *이제 사용할 수*있습니다. [AZURE DATA LAKE STORAGE GEN2 SDK](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *지금 사용 가능-.net, Java, Python (공개 미리 보기)*  |
...
| 데이터 관리                             | 파일 만료 기간                                                                                                                                        | 수명 주기 정책                                                                                                                                                                                                                                                                                                                                                                                                          | 이제 수명 주기 정책 (미리 보기)을 *사용할 수* 있습니다. [알려진 문제](data-lake-storage-known-issues.md)를 참조하세요.                                                                                                                     |

### <a name="programming-interfaces"></a>프로그래밍 인터페이스

다음 표에서는 사용자 지정 애플리케이션에 사용할 수 있는 API 세트에 대해 설명합니다. ACL 및 디렉터리 수준 작업에 대 한 SDK 지원은 아직 지원 되지 않습니다.

|  API 세트                           |  Data Lake Storage Gen1                                                                                                                                                                                                                                                                                                   | Data Lake Storage Gen2 가용성 - 공유 키 인증 사용 | Data Lake Storage Gen2 가용성 - OAuth 인증 사용                                                                                                  |
|----------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
| .NET SDK                  | [링크](https://docs.microsoft.com/dotnet/api/overview/azure/datalakestore/management?view=azure-dotnet) | *지금 사용 가능* | *지금 사용 가능* |
| Java SDK                | [링크](https://docs.microsoft.com/java/api/overview/azure/datalakestore/management)                                                                                                                                                                                                                                     | *지금 사용 가능*                                                      | *지금 사용 가능*                                     |
| Node.js                | [링크](https://www.npmjs.com/package/azure-arm-datalake-store)                                                                                                                                                                                                                                                                | *지금 사용 가능*                                                     | *지금 사용 가능*                                                                                           |
| Python SDK                   | [링크](https://docs.microsoft.com/python/api/overview/azure/datalakestore/management?view=azure-python)                                                                                                                                                                                                                 | *지금 사용 가능*                                                      | *지금 사용 가능*                                        |
| REST API                 | [링크](https://docs.microsoft.com/rest/api/datalakestore/accounts)                                                                                                                                                                                                                                                      | *지금 사용 가능*                                                      | *지금 사용 가능*                                                                                                                                               |
| PowerShell | [링크](https://docs.microsoft.com/powershell/module/az.datalakestore)                                                                                                                                                                                                                        | *지금 사용 가능* |
| CLI                 | [링크](https://docs.microsoft.com/cli/azure/dls/account?view=azure-cli-latest)                                                                                                                                                                                                                                          | *지금 사용 가능*                                                      | *지금 사용 가능*                                                               |
| Azure Resource Manager 템플릿 - 관리             | [Template1](https://azure.microsoft.com/resources/templates/101-data-lake-store-no-encryption/),   [Template2](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-adls/),   [Template3](https://azure.microsoft.com/resources/templates/101-data-lake-store-encryption-key-vault/)  | *지금 사용 가능*                                                      | *지금 사용 가능*                                          |
...
| 데이터 통합     | [데이터 팩터리](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-store)                                                                                | [버전 2](https://docs.microsoft.com/azure/data-factory/connector-azure-data-lake-storage) – ‘지금 사용 가능’, 버전 1 – ‘지원되지 않음’                               | [버전 2](https://docs.microsoft.com/azure/data-factory/connector-azure-data-lake-storage) – *지금 사용 가능* <br><br> 버전 1 – *지원되지 않음*  |
|                      | [AdlCopy](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-copy-data-azure-storage-blob)                                                                 | *지원되지 않음*                                                                                                                                                              | *지원되지 않음*                                                                                                                                 |
|                      | [SQL Server Integration Services](https://docs.microsoft.com/sql/integration-services/connection-manager/azure-data-lake-store-connection-manager?view=sql-server-2017) | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
|                      | [Data Catalog](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-with-data-catalog)                                                                       | *아직 사용할 수 없음*                                                                                                                                                          | *아직 사용할 수 없음*                                                                                                                             |
|                      | [Logic Apps](https://docs.microsoft.com/connectors/azuredatalake/)                                                                                                      | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
| IoT                  | [Event Hubs – 캡처](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-archive-eventhub-capture)                                                       | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
|                      | [Stream Analytics](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-stream-analytics)                                                                   | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
| 소비          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
...
| 생산성         | [Azure 포털](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-get-started-portal)                                                                      | *지원되지 않음*                                                                                                                                                              | 계정 관리 *– 지금 사용 가능* <br><br>데이터 작업 *–*  *아직 사용할 수 없음*                                                                   |
...
|                      | [Azure Storage Explorer](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-in-storage-explorer)                                                          | *지금 사용 가능*                                                                                                                                                              | *지금 사용 가능*                                                                                                                                 |
...
| 영역            | Partner  | 제품/서비스  | Data Lake Storage Gen1 가용성                                                                                                                                               | Data Lake Storage Gen2 가용성 - 공유 키 인증 사용                                                   | Data Lake Storage Gen2 가용성 - OAuth 사용                                                             |
|---------------------|--------------|----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------|
...
|                     | Qubole       |                      | [링크](https://www.qubole.com/blog/big-data-analytics-microsoft-azure-data-lake-store-qubole/)                                                                                            | [링크](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4c-configure-azure-data-lake-gen-2-storage-with-keys)                                                                                                  | [링크](https://docs.qubole.com/en/latest/quick-start-guide/Azure-quick-start-guide/QuboleConnect/detailed-azure-qubole-steps/azure-Azure-setup.html#step-4d-configure-azure-data-lake-gen-2-storage-with-tokens)                                                                                                 |
...
| 진단 로그                                                                                        | [링크](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *지금 사용 가능* (미리 보기). [알려진 문제](data-lake-storage-known-issues.md)를 참조하세요. <br>Azure 모니터링 통합- *아직 사용할 수 없음* |
...
이 표에는 데이터베이스, Hadoop 클러스터 등을 마이그레이션하는 데 사용 된 잘 알려진 몇 가지 전략이 나와 있습니다. 지침에서 비슷한 전략을 채택 하 고이를 컨텍스트에 맞게 조정 합니다.
...
| 전략                       | 도구                                                                                                             | 장점                                                                                                                             | 고려 사항                                                                                                                                                                                                                                                                                                                |
|------------------------------------|-----------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **리프트 앤 시프트**                 | [Azure Data Factory](https://docs.microsoft.com/azure/data-factory/load-azure-data-lake-storage-gen2-from-gen1) | 관리형 클라우드 서비스                                                                                                                | 데이터와 Acl은 현재를 통해 복사할 수 있습니다.                                                                                                                                                                                                                                                                      |
...
| **한 번 복사 및 증분 복사** | Azure Data Factory                                                                                                    | 관리형 클라우드 서비스                                                                                                                | 데이터와 Acl은 현재를 통해 복사할 수 있습니다. ADF에서 증분 복사를 지원하려면 데이터를 시계열 방식으로 구성해야 합니다. 증분 복사 간의 가장 짧은 간격은 [15분](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger)입니다. |
...
위의 데이터/메타 데이터 복사 도구 (예: [Cloudera](https://blog.cloudera.com/blog/2017/08/use-amazon-s3-with-cloudera-bdr/))를 포함 하지 않고 업그레이드를 Data Lake Storage Gen2 하는 Data Lake Storage Gen1를 처리할 수 있는 타사가 있습니다. 데이터 마이그레이션뿐만 아니라 워크로드 마이그레이션도 수행하는 "원스톱 쇼핑(one-stop shop)" 환경을 제공합니다. 에코시스템 외부에 있는 도구에 대해서는 대역 외 업그레이드를 수행해야 합니다.
...
여기서 주요 작업은 `adl://` 접두사가 있는 URI를 `abfss://` 접두사가 있는 URI로 변환 하는 것입니다.
...
Data Lake Storage Gen2 파일에 액세스 하기 위한 URI 체계에 대 한 자세한 내용은 [여기](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) 에 자세히 설명 되어 있지만, `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.windows.net/<PATH>`됩니다.
...
그런 다음 위에서 호출 된 요소 (예: URI 및 자격 증명)를 변경 해야 합니다. Data Lake Storage Gen1에서 작동하는 기존 인스턴스를 수정하거나 Data Lake Storage Gen2에서 작동하는 새 인스턴스를 만들 수 있습니다.
...
전환 작업이 완료되면 마지막 단계로 철저히 확인해야 합니다. 여기에는 데이터가 안정적으로 복사 되었는지 확인 하 고, Acl이 올바르게 설정 되었는지 확인 하 고, 종단 간 파이프라인이 올바르게 작동 하는지 확인 하는 작업이 포함 되지만이에 제한 되지 않습니다. 확인이 완료 되 면 이제 이전 파이프라인을 끄고, 원본 Data Lake Storage Gen1 계정을 삭제 하 고, Data Lake Storage Gen2 기반 솔루션에서 전체 속도를 높일 수 있습니다.
