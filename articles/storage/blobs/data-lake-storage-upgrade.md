...
Data Lake Storage Gen2 파일에 액세스 하기 위한 URI 체계에 대 한 자세한 설명은 [여기](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md) 에 자세히 `abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.widows.net/<PATH>`설명 되어 있습니다.
