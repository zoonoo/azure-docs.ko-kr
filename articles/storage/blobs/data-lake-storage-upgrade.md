...
| 개발자 SDK | .NET, Java, Python, Node.js  | .NET, Java, Python, Node.js, C++, Ruby, PHP, Go, Android, iOS| Blob SDK- *이제 사용할 수*있습니다. Azure Data Lake Storage Gen2 SDK- *아직 사용할 수 없음*  |
...
| 데이터 관리                             | 파일 만료 기간                                                                                                                                        | 수명 주기 정책                                                                                                                                                                                                                                                                                                                                                                                                          | 이제 수명 주기 정책 (미리 보기)을 *사용할 수* 있습니다. [알려진 문제](data-lake-storage-known-issues.md)를 참조 하세요.                                                                                                                     |
...
| Consumption          | [Power BI Desktop](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-power-bi)                                                                           | *지금 사용 가능*                                                                                                                                                          | *지금 사용 가능*                                                                                                                             |
...
| 진단 로그                                                                                        | [링크](https://docs.microsoft.com/azure/data-lake-store/data-lake-store-diagnostic-logs#request-logs) | *지금 사용 가능* (미리 보기). [알려진 문제](data-lake-storage-known-issues.md)를 참조 하세요. <br>Azure 모니터링 통합- *아직 사용할 수 없음* |
| metrics                                                                                                | *지원되지 않음*                                                                                               | *지금 사용 가능 -* [링크](https://docs.microsoft.com/azure/storage/common/storage-metrics-in-azure-monitor)                          |
...
| **한 번 복사 및 증분 복사** | Power BI                                                                                                    | 관리형 클라우드 서비스                                                                                                                | 데이터와 Acl은 현재를 통해 복사할 수 있습니다. ADF에서 증분 복사를 지원하려면 데이터를 시계열 방식으로 구성해야 합니다. 증분 복사 간의 가장 짧은 간격은 [15분](https://docs.microsoft.com/azure/data-factory/how-to-create-tumbling-window-trigger)입니다. |
