...
![Microsoft Azure Storage Explorer - 연결 창을 보여주는 스크린샷.](media/storage-quickstart-blobs-storage-explorer/connect.png)
...
![Microsoft Azure Storage Explorer에서 컨테이너를 선택하는 위치를 보여주는 스크린샷.](media/storage-quickstart-blobs-storage-explorer/listblobs.png)
