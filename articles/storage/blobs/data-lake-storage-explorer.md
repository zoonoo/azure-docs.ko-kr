...
![Microsoft Azure Storage 탐색기 - 디렉터리의 Blob 나열](media/storage-quickstart-blobs-storage-explorer/listblobs.png)
...
이 빠른 시작에서는 **Azure Storage 탐색기**를 사용하여 로컬 디스크와 Azure Blob Storage 간에 파일을 전송하는 방법을 학습했습니다. 파일 및 디렉터리에 ACL을 설정하는 방법을 알아보려면 주제에 대한 방법을 계속 따르세요.
