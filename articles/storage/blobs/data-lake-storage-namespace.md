...
- **친숙한 인터페이스 스타일:** 파일 시스템이 개발자와 사용자 모두에게 쉽게 이해됩니다. Data Lake Storage Gen2를 통해 노출되는 파일 시스템 인터페이스는 크고 작은 컴퓨터에서 사용되는 동일한 패러다임이므로 클라우드로 이동할 때 새 저장소 패러다임을 배울 필요가 없습니다.
