...
### <a name="cool-and-archive-early-deletion-effective-february-1-2018"></a>쿨 및 보관 초기 삭제(2018년 2월 1일까지 유효함)
...
각각 30일 및 180일이 지나기 전에 쿨(GPv2 계정에만 해당) 또는 보관 계층에서 삭제되거나 이동된 모든 Blob은 초기 삭제 요금으로 요금이 청구됩니다(2018년 2월 1일까지 유효함). 마지막 계층 변경의 스탬프를 제공하는 **액세스 계층 변경 시간** Blob 속성을 확인하여 Blob을 쿨 또는 보관 계층에서 유지한 시간을 확인할 수 있습니다. 자세한 내용은 [쿨 및 보관 초기 삭제](#cool-and-archive-early-deletion) 섹션을 참조하세요.
