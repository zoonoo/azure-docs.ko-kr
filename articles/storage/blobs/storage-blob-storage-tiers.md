...
- 보관 스토리지는 데이터를 오프라인으로 저장하며 스토리지 비용이 가장 적지만 데이터 리하이드레이션 및 액세스 비용이 가장 많이 듭니다.
...
- 활발히 사용 중이거나 자주 액세스(읽기 및 쓰기)해야 하는 데이터.
...
**핫, 쿨 및 보관 액세스 계층에 대해 지원 되는 중복성 옵션은 무엇 인가요?**

핫 및 쿨 계층은 모든 중복성 옵션을 지원 합니다. 보관 계층은 LRS, GRS 및 RA-GRS만 지원 합니다. ZRS, GZRS 및 RA-GZRS는 보관 계층에 대해 지원 되지 않습니다.
