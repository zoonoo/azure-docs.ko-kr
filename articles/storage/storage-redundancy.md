---
title: "Azure Storage 복제 | Microsoft Docs"
...
RA-GRS(읽기 액세스 지역 중복 저장소)는 새 저장소 계정을 만드는 경우 기본 옵션입니다.
...
* 일부 응용 프로그램은 데이터 관리 요구 사항으로 인해 단일 국가 내에서만 데이터를 복제하도록 제한됩니다. 쌍을 이루는 지역이 다른 국가에 있을 수 있습니다. 지역 쌍에 대한 정보는 [Azure 지역](https://azure.microsoft.com/regions/)을 참조하세요.
...
GRS를 사용하면 주 및 보조 지역은 LRS로 설명한 것처럼 모두 별도 오류 도메인에 걸쳐 복제를 관리하고 저장소 배율 단위 내에서 도메인을 업그레이드합니다.
