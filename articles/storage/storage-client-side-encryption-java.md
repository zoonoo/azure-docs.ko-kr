---
title: Microsoft Azure 저장소용 Java를 사용하는 클라이언트 쪽 암호화 | Microsoft Docs
...
3. 암호화 정책을 생성하는 동안 캐싱 확인자를 입력으로 사용합니다. 주요 자격 증명 모음 사용법에 대한 자세한 내용은 암호화 코드 샘플에서 찾을 있습니다. <fix URL>
