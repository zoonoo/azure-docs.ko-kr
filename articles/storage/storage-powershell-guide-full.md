---
title: Azure 저장소와 함께 Azure PowerShell 사용 ㅣ Microsoft Azure
...
> [!IMPORTANT]
> 저장소 계정의 이름은 Azure 내에서 고유하며 소문자여야 합니다. 명명 규칙 및 제한에 대해서는 [Azure 저장소 계정 정보](storage-create-storage-account.md), [컨테이너와 Blob, 메타데이터의 이름 지정 및 참조](http://msdn.microsoft.com/library/azure/dd135715.aspx)를 참조하세요.
> 
> 
