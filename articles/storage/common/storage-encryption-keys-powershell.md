...
PowerShell을 사용 하 여 기존 주요 자격 증명 모음에서 **일시** 삭제를 사용 하도록 설정 하 고 **제거 하지 않도록** 설정 하는 방법에 대 한 자세한 내용은 powershell에서 일시 [삭제를 사용 하는 방법](../../key-vault/key-vault-soft-delete-powershell.md)에서 **일시 삭제** 및 **제거 방지** 사용 설정 섹션을 참조 하세요.
