...
|    **데이터 형식**                    |    Azure Blobs                  |    Azure Blobs<br>Azure Files                    |    Azure Blobs<br>Azure Files            |    Azure Blobs<br>Azure Files          |
...
|    **데이터 사전 처리**          |    아니요                                        |    예                                        |    예(Edge 컴퓨팅 사용)                               |    예                                                                |
