...
> [!IMPORTANT]
> 이 기능은 현재 미리 보기로 제공됩니다. If you decide to remove data from your S3 buckets after a copy operation, make sure to verify that the data was properly copied to your storage account before you remove the data.
