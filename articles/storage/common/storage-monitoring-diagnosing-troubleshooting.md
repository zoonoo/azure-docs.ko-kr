...
#### <a name="feature-X-is-not-working"></a>&quot;X&quot; 기능이 스토리지 에뮬레이터에서 작동하지 않음
...
#### <a name="error-HTTP-header-not-correct-format"></a>스토리지 에뮬레이터를 사용할 때 &quot;HTTP 헤더 중 하나의 값이 올바른 형식이 아닙니다.&quot; 오류가 발생함
