---
title: 아즈카피 로그아웃 | 마이크로 소프트 문서
description: 이 문서에서는 azcopy 로그아웃 명령에 대한 참조 정보를 제공합니다.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 10/16/2019
...
사용자를 로그아웃하고 Azure 저장소 리소스에 대한 액세스를 종료합니다.

## <a name="synopsis"></a>개요

이 명령은 현재 사용자의 모든 캐시된 로그인 정보를 제거합니다.
...
|옵션|설명|
|--|--|
|-h, --help|로그아웃 명령에 대한 도움말 콘텐츠를 표시합니다.|
