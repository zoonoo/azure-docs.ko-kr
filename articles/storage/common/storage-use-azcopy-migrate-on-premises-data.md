...
이 자습서를 완료하려면 [Linux](https://docs.microsoft.com/azure/storage/common/storage-use-azcopy-linux#download-and-install-azcopy) 또는 [Windows](https://aka.ms/downloadazcopy)에 최신 버전의 AzCopy를 다운로드합니다.
...
AzCopy에 대한 자세한 내용을 보려면 사용하는 운영 체제에 맞는 문서를 선택하세요.
