...
| 데이터 형식                                   | Azure Blob, Azure Files   | Azure Blob, Azure Files | [데이터 저장소 및 형식을 위해 70개 이상의 데이터 커넥터 지원](/azure/data-factory/copy-activity-overview#supported-data-stores-and-formats)|
...
- 다음 작업을 수행하는 방법을 이해합니다.
    - [Data Box Gateway를 통해 데이터 전송](/azure/databox-online/data-box-gateway-deploy-add-shares).
    - [Azure로 보내기 전에 Data Box Edge를 사용하여 데이터 변환](/azure/databox-online/data-box-edge-deploy-configure-compute)
- [Azure Data Factory를 사용하여 데이터를 전송하는 방법 알아보기](/azure/data-factory/tutorial-bulk-copy-portal)
