---
title: Azure portal을 사용 하 여 컨테이너 및 RBAC-Azure Storage를 사용 하 여 큐에 Azure AD 액세스 권한을 관리 하려면 | Microsoft Docs
...
ms.locfileid: "58368241"
---
# <a name="grant-access-to-azure-containers-and-queues-with-rbac-in-the-azure-portal"></a>Azure 컨테이너 및 Azure portal에서 RBAC 사용 하 여 큐 액세스 권한 부여
...
1. 컨테이너 또는 큐에 대 한 액세스 권한을 부여 하려면 적절 한 Azure Storage RBAC 역할을 할당 합니다. 읽기 액세스용으로 할당 합니다 **Blob 데이터 판독기** 하거나 **큐 데이터 판독기** 역할입니다. 읽기, 쓰기 및 삭제 액세스를 할당 합니다 **Blob 데이터 기여자** 하거나 **큐 데이터 기여자** 역할입니다. 또한 사용자 지정 역할을 할당할 수 있습니다.
