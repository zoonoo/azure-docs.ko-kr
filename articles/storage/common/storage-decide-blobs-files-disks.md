...
데이터 디스크에 대한 자세한 내용 [디스크 및 이미지 관리](../../virtual-machines/windows/about-disks-and-vhds.md) 및 [Windows 가상 컴퓨터에 데이터 디스크를 연결하는 방법](../../virtual-machines/windows/classic/attach-disk.md)을 참조하세요.
