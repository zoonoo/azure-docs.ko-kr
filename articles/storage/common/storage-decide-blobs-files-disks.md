...
Azure Blob에 대 한 자세한 내용은 [Azure blob storage 란?](../blobs/storage-blobs-overview.md)문서를 참조 하세요.

디스크 저장소에 대 한 자세한 내용은 [managed Disks 소개](../../virtual-machines/windows/managed-disks-overview.md)를 참조 하세요.

Azure Files에 대 한 자세한 내용은 [Azure Files 배포에 대 한 계획](../files/storage-files-planning.md)문서를 참조 하세요.