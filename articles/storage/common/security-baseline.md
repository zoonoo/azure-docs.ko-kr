...
- [Azure Storage 방화벽을 구성 하는 방법](./storage-network-security.md#change-the-default-network-access-rule)
...
- [Azure Storage에 대 한 개인 끝점 이해](./storage-private-endpoints.md#known-issues)
...
- [Advanced Threat Protection을 사용 하도록 설정 하는 방법](./azure-defender-storage-configure.md?tabs=azure-portal)
...
- [저장소에 대 한 Azure Policy 샘플](../../governance/policy/samples/built-in-policies.md#storage)

- [네트워크에 대 한 Azure Policy 샘플](../../governance/policy/samples/built-in-policies.md#network)
...
- [Azure Storage에 대 한 advanced threat protection 구성](./azure-defender-storage-configure.md?tabs=azure-portal)
...
- [Privileged Identity Management 개요](../../active-directory/privileged-identity-management/index.yml)
...
- [Azure Storage 계정에 대 한 Advanced Threat Protection을 설정 하는 방법](./azure-defender-storage-configure.md)
...
- [Virtual Network 서비스 끝점](../../virtual-network/virtual-network-service-endpoints-overview.md)
...
- [Azure Storage 계정에 대 한 Azure 역할을 할당 하는 방법](./storage-auth-aad-rbac-portal.md#assign-azure-roles-using-the-azure-portal)
...
- [ARM에 대 한 액세스를 차단 하도록 조건부 액세스를 구성 하는 방법](../../role-based-access-control/conditional-access-azure-management.md)
...
- [Blob Storage에 대한 불변성 정책 설정 및 관리](../blobs/storage-blob-immutability-policies-manage.md?tabs=azure-portal)
...
- [Azure Storage Blob에 대한 일시 삭제](../blobs/soft-delete-blob-overview.md?tabs=azure-portal)
