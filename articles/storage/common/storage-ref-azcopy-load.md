...
description: 이 문서에서는 azcopy load 명령에 대 한 참조 정보를 제공 합니다.
author: normesta
ms.service: storage
ms.topic: reference
ms.date: 07/24/2020
...
Microsoft의 CLFS (Avere Cloud FileSystem) 형식과 같은 특정 형식으로 데이터를 전송 하는 것과 관련 된 하위 명령입니다.
...
|옵션|Description|
|--|--|
|-h, --help|로드 명령에 대 한 도움말 콘텐츠를 표시 합니다.|
