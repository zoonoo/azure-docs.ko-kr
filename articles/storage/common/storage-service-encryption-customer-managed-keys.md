...
description: 데이터를 저장할 때 서비스 쪽에서 Azure Storage 서비스 암호화 기능을 사용하여 Azure Blob Storage, Azure Files, Azure Queue Storage 및 Azure Table Storage를 암호화하고 데이터를 검색할 때 고객 관리 키를 사용하여 암호를 해독합니다.
services: storage
author: lakasa
manager: jeconnoc
ms.service: storage
