...
## <a name="about-storage-analytics-logging"></a>스토리지 분석 로깅 정보
...
* **ContainerCount**: 스토리지 계정 Blob Service의 컨테이너 수입니다.
...
* [스토리지 분석 로깅](https://msdn.microsoft.com/library/hh343262.aspx)
* [스토리지 분석 메트릭](https://msdn.microsoft.com/library/hh343258.aspx)
