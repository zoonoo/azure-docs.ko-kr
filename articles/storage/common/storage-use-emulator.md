...
> [!TIP]
> [Microsoft Azure Storage Explorer](https://storageexplorer.com)를 사용하여 로컬 스토리지 에뮬레이터 리소스를 사용할 수 있습니다. 저장소 에뮬레이터를 설치 하 고 시작한 후에 Storage 탐색기 리소스 트리의 "로컬 & 연결 됨"에서 "(에뮬레이터-기본 포트) (키)"를 찾습니다.
>
