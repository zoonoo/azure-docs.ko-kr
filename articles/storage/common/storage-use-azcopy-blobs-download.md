...
#### <a name="download-blobs-that-were-modified-before-or-after-a-date-and-time"></a>날짜 및 시간 이전 또는 이후 수정 된 blob 다운로드 
...
다음 예에서는 지정한 날짜 또는 그 이후에 수정 된 파일을 다운로드 합니다.
