...
3.  **방화벽 및 가상 네트워크** 탭의 **네트워크 라우팅** 에서 **라우팅 기본** 설정 설정을 **인터넷 라우팅** 으로 변경 합니다.
...
3.  **방화벽 및 가상 네트워크** 탭의 **경로 관련 끝점 게시** 에서 경로 관련 끝점의 라우팅 기본 설정을 선택 하 고 **저장** 을 클릭 합니다. 이 기본 설정은 경로 특정 끝점에만 영향을 줍니다. 이 기본 설정에는 기본 라우팅 기본 설정에 영향을 주지 않습니다.  
