...
> [!NOTE]
> 핫 또는 쿨 스토리지 액세스 계층 사용 시의 비용을 계산하는 자세한 예제는 *Azure Storage 가격 책정 페이지*에서 에서 [핫 및 쿨 액세스 계층이란 무엇이며 무슨 계층을 사용할지 어떻게 결정하나요?](https://azure.microsoft.com/pricing/details/storage/)에 로그인합니다.
