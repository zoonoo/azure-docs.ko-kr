...
|    BlockBlobStorage<sup>1</sup>    | 동남아시아<br /> 서유럽<br /> 미국 동부    |    블록 Blob만 해당    |
|    FileStorage    | 동남아시아<br /> 서유럽<br /> 미국 동부    |    Azure Files만 해당    |
...
| 전체 데이터 센터(영역 또는 비영역)를 사용할 수 없게 됨                                           | 아니요                              | 예                              | 예<sup>1</sup>                                  | 예                                  |
| 지역 전체 중단이 기본 지역에서 발생함                                                                                     | 아니요                              | 아니요                               | 예<sup>1</sup>                                  | 예<sup>1</sup>                                  |
