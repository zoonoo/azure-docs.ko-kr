...
<sup>2</sup> 관리 되는 디스크와 관리 되지 않는 디스크를 포함 하 여 가상 컴퓨터에 대 한 Azure 디스크는 LRS만 지원 합니다. ZRS 또는 GZRS를 지원 하지 않습니다. 관리 디스크에 대 한 자세한 내용은 [Azure managed Disks 가격 책정](/pricing/details/managed-disks/)을 참조 하세요.
