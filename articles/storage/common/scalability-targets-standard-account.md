---
title: 표준 스토리지 계정의 확장성 및 성능 목표
titleSuffix: Azure Storage
description: Standard storage 계정에 대 한 확장성 및 성능 목표에 대해 알아봅니다.
services: storage
author: tamram
ms.service: storage
ms.topic: conceptual
...
## <a name="scale-targets-for-standard-storage-accounts"></a>Standard storage 계정에 대 한 크기 조정 대상
