...
A: 저장소 서비스 암호화는 모든 저장소 계정(클래식 및 Resource Manager)에 대해 사용하도록 설정됩니다.
...
A: 저장소 서비스 암호화는 모든 저장소 계정(클래식 및 Resource Manager)에 대해 사용하도록 설정되고, 암호화가 활성화되기 전에 만들어진 저장소 계정의 모든 기존 파일이 백그라운드 암호화 프로세스를 통해 소급하여 암호화됩니다.
...
A: 예, 저장소 서비스 암호화는 모든 저장소 계정 및 모든 Azure Storage 서비스에 대해 사용하도록 설정됩니다.
...
**Q: 저장소 서비스 암호화는 FIPS 140-2를 준수하나요?**

A: 예, 저장소 서비스 암호화는 FIPS 140-2를 준수합니다.
