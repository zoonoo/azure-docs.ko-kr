...
|`ContainerSas`|문자열|`StorageAccountKey`이 지정되지 않은 경우 가져오기 작업에 필요합니다. 작업과 연결된 Blob에 액세스하기 위한 컨테이너 SAS입니다. 해당 형식은 [작업 배치](/rest/api/storageimportexport/jobs#Jobs_CreateOrUpdate)를 참조하세요. 이 요소는 내보내기 작업에 대한 매니페스트에서 생략됩니다.|  
