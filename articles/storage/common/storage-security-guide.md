...
이 기능은 Resource Manager 배포 모델을 사용하여 Standard 및 Premium Storage 계정에 사용할 수 있습니다. SSE는 블록 Blob, 페이지 Blob, 추가 Blob, 테이블, 큐 및 파일 등 모든 종류의 데이터에 적용됩니다.
...
새 가상 머신을 만들기 위한 기준으로 사용하는 VHD 파일의 보관 또는 라이브러리가 있는 경우 새 저장소 계정을 만들고, SSE를 사용하도록 설정한 다음 해당 계정에 VHD 파일을 업로드할 수 있습니다. 이러한 VHD 파일은 Azure Storage에 의해 암호화됩니다.
