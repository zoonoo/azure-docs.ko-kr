...
ms.locfileid: "107503544"
---
# <a name="azcopy-doc"></a>azcopy doc

Markdown 형식으로 도구에 대한 문서를 생성합니다.

## <a name="synopsis"></a>개요

도구에 대한 문서를 Markdown 형식으로 생성하고 지정된 위치에 저장합니다.

기본적으로 파일은 현재 디렉터리 내의 'doc' 폴더에 저장됩니다.
...
|옵션|설명|
|--|--|
|-h, --help|doc 명령에 대한 도움말 콘텐츠를 표시합니다.|
