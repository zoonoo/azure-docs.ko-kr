...
| 이전 메트릭 | 새 메트릭 |
| ------------------- | ----------------- |
| **AnonymousAuthorizationError** | **ResponseType** 차원이 **AuthorizationError**와 동일한 트랜잭션 |
| **AnonymousClientOtherError** | **ResponseType** 차원이 **ClientOtherError**와 동일한 트랜잭션 |
| **AnonymousClientTimeoutError** | **ResponseType** 차원이 **ClientTimeoutError**와 동일한 트랜잭션 |
| **AnonymousNetworkError** | **ResponseType** 차원이 **NetworkError**와 동일한 트랜잭션 |
| **AnonymousServerOtherError** | **ResponseType** 차원이 **ServerOtherError**와 동일한 트랜잭션 |
| **AnonymousServerTimeoutError** | **ResponseType** 차원이 **ServerTimeoutError**와 동일한 트랜잭션 |
| **AnonymousSuccess** | **ResponseType** 차원이 **Success**와 동일한 트랜잭션 |
| **AnonymousThrottlingError** | **ResponseType** 차원이 **ClientThrottlingError** 또는 **ServerBusyError**와 동일한 트랜잭션 |
...
| **SASAuthorizationError** | **ResponseType** 차원이 **AuthorizationError**와 동일한 트랜잭션 |
| **SASClientOtherError** | **ResponseType** 차원이 **ClientOtherError**와 동일한 트랜잭션 |
| **SASClientTimeoutError** | **ResponseType** 차원이 **ClientTimeoutError**와 동일한 트랜잭션 |
| **SASNetworkError** | **ResponseType** 차원이 **NetworkError**와 동일한 트랜잭션 |
| **SASServerOtherError** | **ResponseType** 차원이 **ServerOtherError**와 동일한 트랜잭션 |
| **SASServerTimeoutError** | **ResponseType** 차원이 **ServerTimeoutError**와 동일한 트랜잭션 |
| **SASSuccess** | **ResponseType** 차원이 **Success**와 동일한 트랜잭션 |
| **SASThrottlingError** | **ResponseType** 차원이 **ClientThrottlingError** 또는 **ServerBusyError**와 동일한 트랜잭션 |
