...
title: "가져오기 작업을 위한 하드 드라이브 준비 | Microsoft Docs"
description: "Microsoft Azure Import/Export 서비스의 가져오기 작업을 위해 하드 드라이브를 하나 이상 준비하는 방법에 대해 알아봅니다."
author: muralikk
manager: syadav
editor: tysonn
services: storage
...
##  <a name="a-nameprepareharddrivesidentifythedatatobeimporteda-identify-the-data-to-be-imported"></a><a name="PrepareHardDrives_IdentifytheDatatoBeImported"></a> 가져올 데이터 식별
...
##  <a name="a-nameprepareharddrivesidentifythedestinationlocationsintheblobservicea-identify-the-destination-locations-in-the-blob-service"></a><a name="PrepareHardDrives_IdentifytheDestinationLocationsintheBlobService"></a> Blob Service에서 대상 위치 식별
...
##  <a name="a-nameprepareharddrivesdeterminehowmanydrivesareneededa-determine-how-many-drives-are-needed"></a><a name="PrepareHardDrives_DetermineHowManyDrivesAreNeeded"></a> 필요한 드라이브 수 결정
 여기서는 다음을 결정해야 합니다.
...
##  <a name="a-nameprepareharddrivescopydatatoasingleharddrivea-copy-data-to-your-hard-drive"></a><a name="PrepareHardDrives_CopyDatatoaSingleHardDrive"></a> 하드 드라이브에 데이터 복사
...
|**/PropertyFile:**<PropertyFile\>|`Optional.` 대상 Blob에 대한 속성 파일의 경로입니다. 자세한 내용은 [Import/Export 서비스의 메타데이터 및 속성 파일 형식](storage-import-export-file-format-metadata-and-properties.md)(영문)을 참조하세요.|
|**/MetadataFile:**<MetadataFile\>|`Optional.` 대상 Blob에 대한 메타데이터 파일의 경로입니다. 자세한 내용은 [Import/Export 서비스의 메타데이터 및 속성 파일 형식](storage-import-export-file-format-metadata-and-properties.md)(영문)을 참조하세요.|
...
## <a name="see-also"></a>참고 항목
 [Azure Import/Export 도구 설치](storage-import-export-tool-setup-v1.md)
 ...
 [복사 로그 파일로 작업 상태 검토](storage-import-export-tool-reviewing-job-status-v1.md)
