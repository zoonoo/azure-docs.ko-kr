...
> [!NOTE]
> 핫 또는 쿨 저장소 계층을 사용하는 비용 계산에 대한 자세한 예제는 [Azure 저장소 가격 책정 페이지](https://azure.microsoft.com/pricing/details/storage/)에서 *핫 및 쿨 액세스 계층이란 무엇이며 무슨 계층을 사용할지 어떻게 결정하나요?*라는 제목의 FAQ를 살펴보세요.
> 
> 
