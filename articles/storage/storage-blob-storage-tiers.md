...
7. 액세스 계층을 **쿨** 또는 **핫**으로 선택합니다. 기본값은 **핫**입니다.
...
#### Azure 포털을 사용하여 Blob 저장소 계정에서 액세스 계층을 변경합니다.
...
기존 저장소 계정을 모니터링하고 이 데이터를 수집하려면 [Azure 저장소 메트릭 사용 및 메트릭 데이터 보기](storage-enable-and-view-metrics.md)를 참조하세요. 이제 이 데이터를 사용하여 [Azure 저장소 가격 책정 계산기](https://azure.microsoft.com/pricing/calculator/?scenario=data-management)로 비용을 예측할 수 있습니다.
