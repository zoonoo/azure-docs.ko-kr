...
클라우드에서 스토리지 계정을 대상으로 하는 경우 Azure Portal에서 스토리지 계정에 대한 기본 선택키를 복사합니다. 자세한 내용은 [저장소 계정 액세스 키 관리](../common/storage-account-keys-manage.md)를 참조 하세요.
