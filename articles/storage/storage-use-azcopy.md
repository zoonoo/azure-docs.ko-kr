...
저장소 액세스 키를 사용한 작업에 대한 자세한 내용은 [저장소 액세스 키 보기, 복사 및 다시 생성](../storage-create-storage-account/#regeneratestoragekeys)을 참조하세요.
...
- [가져오기/내보내기 서비스를 사용하여 Blob 저장소로 데이터 전송](storage-import-export-service.md)
