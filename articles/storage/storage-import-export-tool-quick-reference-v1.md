...
description: "가져오기 작업에 자주 사용되는 Azure Import/Export 도구 명령에 대한 명령 참조 이는 Import/Export 도구의 v1을 나타냅니다."
author: muralikk
manager: syadav
editor: tysonn
services: storage
...
---
# <a name="quick-reference-for-frequently-used-commands-for-import-jobs"></a>가져오기 작업에 자주 사용되는 명령에 대한 빠른 참조
