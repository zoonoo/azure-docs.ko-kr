---
title: "Blob 저장소 및 Visual Studio 연결된 서비스 시작(ASP.NET 5) | Microsoft Docs"
...
---
# <a name="get-started-with-azure-blob-storage-and-visual-studio-connected-services-aspnet-5"></a>Azure Blob 저장소 및 Visual Studio 연결된 서비스 시작(ASP.NET 5)
