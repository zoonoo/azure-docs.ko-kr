...
| 0x80070005 | -2147024891 | E_ACCESSDENIED | 파일에 삭제 보류 중 상태가 있습니다. | 열려 있는 모든 파일 핸들이 닫히면 파일이 삭제 됩니다. |
| 0x80070020 | -2147024864 | ERROR_SHARING_VIOLATION | 파일이 사용 중이므로 동기화할 수 없습니다. 파일이 더 이상 사용되지 않을 때 동기화됩니다. | 필요한 조치가 없습니다. |
