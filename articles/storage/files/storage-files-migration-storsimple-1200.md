...
가동 중지 시간이 허용 되는 것으로 간주 되 고 StorSimple 위치를 오프 라인 상태로 전환할 준비가 되 면 이제는이 작업을 수행 합니다. 예를 들어 사용자가 폴더에 액세스 하거나 콘텐츠를 변경 하지 못하도록 하는 다른 적절 한 단계를 수행할 수 없도록 SMB 공유를 제거 합니다. StorSimple의 폴더입니다.
