...
| V 11.1 릴리스- [KB4539951](https://support.microsoft.com/en-us/help/4539951)| 11.1.0.0 | 2020 년 11 월 4 일 | 지원됨 |
...
- 항목 별로 오류가 발생 하 여 동기화 세션이 취소 되는 경우에는 Azure 파일 동기화 서비스가 항목당 오류를 수정 하는 데 사용자 지정 동기화 세션이 필요한 경우 새 세션이 시작 되 면 동기화가 조정을 통해 조정 될 수 있습니다.
