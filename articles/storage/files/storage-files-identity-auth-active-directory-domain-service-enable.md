...
1.  **Azure AD 테넌트를 선택하거나 만듭니다.**
    ...
    새 Azure AD 테넌트를 만들려는 경우 [Azure AD 테넌트 및 Azure AD 구독을 추가](/windows/client-management/mdm/add-an-azure-ad-tenant-and-azure-ad-subscription)하면 됩니다. 기존 Azure AD 테 넌 트가 있지만 Azure 파일 공유에 사용할 새 테 넌 트를 만들려는 경우 [Azure Active Directory 테 넌 트 만들기](/rest/api/datacatalog/create-an-azure-active-directory-tenant)를 참조 하세요.
...
Azure AD DS를 사용 하 여 Azure Files 인증은 [모든 Azure Public, .gov 및 중국 지역](https://azure.microsoft.com/global-infrastructure/locations/)에서 사용할 수 있습니다.
