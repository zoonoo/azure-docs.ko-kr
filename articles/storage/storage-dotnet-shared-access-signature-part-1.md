...
시작 시간|st=2015-04-29T22%3A18%3A26Z|ISO 8601 형식으로 지정됩니다. SAS를 즉시 유효화하려면 시작 시간을 생략하십시오.
만료 시간|se=2015-04-30T02%3A23%3A26Z|ISO 8601 형식으로 지정됩니다.
...
[sas-storage-fe-proxy-service]: ./media/storage-dotnet-shared-access-signature-part-1/sas-storage-fe-proxy-service.png [sas-storage-provider-service]: ./media/storage-dotnet-shared-access-signature-part-1/sas-storage-provider-service.png
