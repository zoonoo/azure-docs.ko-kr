...
명시적 끝점을 지정하고자 할 수 있는 하나의 시나리오로서 Blob Storage 끝점을 [사용자 지정 도메인](storage-custom-domain-name.md)에 매핑한 경우가 있습니다. 이 경우 연결 문자열에 있는 Blob Storage에 대해 사용자 지정 끝점을 지정할 수 있습니다. 응용 프로그램에서 다른 서비스에 대한 기본 끝점을 사용하는 경우 선택적으로 지정할 수 있습니다.
