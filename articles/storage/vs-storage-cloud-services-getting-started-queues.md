---
title: 큐 저장소 및 Visual Studio 연결 서비스 시작(클라우드 서비스) | Microsoft Docs
...
* 코드에서 큐를 조작하는 방법에 대한 자세한 내용은 [.NET을 사용하여 Azure 큐 저장소 시작](storage-dotnet-how-to-use-queues.md)을 참조하세요.
