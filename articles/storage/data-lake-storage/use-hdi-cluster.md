...
이 문서에서는 Data Lake Storage Gen2가 HDInsight 클러스터에서 작동하는 방식에 대해 알아봅니다. HDInsight 클러스터를 만드는 방법에 대한 자세한 내용은 [Hadoop, Spark, Kafka 등으로 Azure Data Lake Storage를 사용하여 HDInsight 클러스터 설정](quickstart-create-connect-hdi-cluster.md)을 참조하세요.
...
* [Azure Data Lake Storage Gen2 소개](introduction.md)
* [Azure Data Lake Storage Gen2를 사용하여 Hadoop, Spark, Kafka 등이 포함된 HDInsight 클러스터 설정](quickstart-create-connect-hdi-cluster.md)
* [distcp를 사용하여 Azure Data Lake Storage Gen2에 데이터 수집](use-distcp.md)
