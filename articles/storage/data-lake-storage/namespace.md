...
ms.locfileid: "39528700"
---
# <a name="azure-data-lake-storage-gen2-preview-hierarchical-namespace"></a>Azure Data Lake Storage Gen2 미리 보기 계층 구조 네임스페이스

Azure Data Lake Storage Gen2 미리 보기를 사용하여 개체 저장소 규모 및 가격에 파일 시스템 성능을 제공할 수 있는 주요 메커니즘은 **계층 구조 네임스페이스**를 추가한 것입니다. 이렇게 하면 계정 내의 개체/파일 컬렉션이 컴퓨터의 파일 시스템이 구성되는 것과 동일한 방식으로 디렉터리 및 중첩된 하위 디렉터리의 계층 구조로 구성될 수 있습니다. 계층 구조 네임스페이스를 사용할 수 있는 경우, Data Lake Storage Gen2는 분석 엔진 및 프레임워크에 친숙한 파일 시스템 의미 체계를 통해 개체 저장소의 확장성 및 비용 효과를 제공합니다.
