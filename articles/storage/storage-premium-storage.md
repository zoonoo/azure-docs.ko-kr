...
<tr>
    <td>7.0-7.1</td>
    <td> </td>
    <td>UEK4 또는 RHCK(<a href="http://go.microsoft.com/fwlink/?LinkID=403033&clcid=0x409">LIS 4.1 이상 포함)</a></td>
</tr>
<tr>
    <td>6.4-6.7</td>
    <td></td>
...
## <a name="create-and-use-a-premium-storage-account-for-a-virtual-machine-data-disk"></a>가상 컴퓨터 데이터 디스크에 대한 프리미엄 저장소 계정 만들기 및 사용
...
#### <a name="i-create-a-premium-storage-account-in-azure-portal"></a>I. Azure 포털에서 프리미엄 저장소 계정 만들기
...
#### <a name="ii-create-an-azure-virtual-machine-via-azure-portal"></a>II. Azure 포털을 통해 Azure 가상 컴퓨터 만들기
...
#### <a name="iii-attach-a-premium-storage-data-disk-via-azure-portal"></a>III. Azure 포털을 통해 프리미엄 저장소 데이터 디스크 연결
...
#### <a name="iv-change-disk-caching-policy-via-azure-portal"></a>IV. Azure 포털을 통해 디스크 캐싱 정책 변경
1. Azure 포털에서 새로운 또는 기존 DS, DSv2, GS 또는 Fs VM을 찾습니다.
...
#### <a name="i-create-a-premium-storage-account-in-azure-powershell"></a>I. Azure PowerShell에서 프리미엄 저장소 계정 만들기
...
2. PowerShell 콘솔을 시작하고, 구독에 연결한 후 콘솔 창에서 다음 PowerShell cmdlet을 실행합니다. 이 PowerShell 문에 표시된 대로 Premium Storage 계정을 만드는 경우 **Type** 매개 변수를 **Premium_LRS**로 지정해야 합니다.
   
        New-AzureStorageAccount -StorageAccountName "yourpremiumaccount" -Location "West US" -Type "Premium_LRS"

#### <a name="ii-create-an-azure-virtual-machine-via-azure-powershell"></a>II. Azure PowerShell을 통해 Azure 가상 컴퓨터 만들기
...
#### <a name="iii-attach-a-premium-storage-data-disk-via-azure-powershell"></a>III. Azure PowerShell을 통해 프리미엄 저장소 데이터 디스크 연결
...
#### <a name="iv-change-disk-caching-policy-via-azure-powershell"></a>IV. Azure PowerShell을 통해 디스크 캐싱 정책 변경
...
#### <a name="i-create-a-premium-storage-account-via-azure-cli"></a>I. Azure CLI를 통해 프리미엄 저장소 계정 만들기
````
azure storage account create "premiumtestaccount" -l "west us" --type PLRS
````

#### <a name="ii-create-a-ds-series-virtual-machine-via-azure-cli"></a>II. Azure CLI를 통해 DS 시리즈 가상 컴퓨터 만들기
...
#### <a name="iii-attach-a-new-premium-data-disk-via-azure-cli"></a>III. Azure CLI를 통해 새 프리미엄 데이터 디스크 연결
...
#### <a name="iv-change-disk-caching-policy"></a>IV. 디스크 캐싱 정책 변경
