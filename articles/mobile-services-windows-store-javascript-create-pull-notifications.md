...
[모바일 서비스 시작](영문) 또는 [기존 앱에 모바일 서비스 추가](영문) 자습서를 완료할 때 만든 앱에 이 기능을 추가합니다. 그러려면 다음 단계를 완료합니다.
...
[기존 앱에 모바일 서비스 추가]: /ko-kr/documentation/articles/mobile-services-windows-store-javascript-get-started
