<properties 
	...
	description="Azure에서 지원하는 두 가지 부하 분산 유형인 클라우드 서비스용 부하 분산 장치와 클라이언트 트래픽용 Azure 트래픽 관리자에 대해 설명합니다." 
...
자세한 내용은 [트래픽 관리자 부하 분산 방법 정보](http://msdn.microsoft.com/library/azure/dn339010.aspx)를 참조하세요.
...
자세한 내용은 [트래픽 관리자](http://msdn.microsoft.com/library/azure/hh745750.aspx)를 참조하세요.
...
자세한 내용은 [Azure 부하 분산 장치](http://msdn.microsoft.com/library/azure/dn655058.aspx)를 참조하세요. 부하 분산 집합을 만드는 과정은 [부하 분산 집합 구성](http://msdn.microsoft.com/library/azure/dn655055.aspx)(영문)을 참조하세요.
...
자세한 내용은 [내부 부하 분산](http://msdn.microsoft.com/library/azure/dn690121.aspx)을 참조하세요. 부하 분산 집합을 만드는 과정은 [내부 부하 분산 집합 구성](http://msdn.microsoft.com/library/azure/dn690125.aspx)(영문)을 참조하세요.
