...
수동 QoS 유형 기능은 현재 미리 보기 상태입니다. 이 기능을 처음 사용하는 경우 먼저 기능을 등록해야 합니다.
...
> 변환 시에는 수동 QoS 형식의 볼륨에 대 한 처리량 제한을 따르기 위해 처리량 수준이 줄어들 수 있습니다. [Azure NetApp Files에 대 한 리소스 제한을](azure-netapp-files-resource-limits.md#resource-limits)참조 하세요.
