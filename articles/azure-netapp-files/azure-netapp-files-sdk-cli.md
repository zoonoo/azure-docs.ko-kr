---
title: Azure NetApp Sdk 파일 | Microsoft Docs
description: NetApp Azure Files에서 지원 되는 Sdk를 나열 합니다.
...
ms.locfileid: "65957882"
---
# <a name="azure-netapp-files-sdks"></a>Azure NetApp Files SDK

이 문서에서는 Azure NetApp Files에서 지원 되는 Sdk를 나열 합니다.

## <a name="supported-sdks"></a>지원되는 SDK 

다음 표에서 지원 되는 Sdk를 나열합니다.  GitHub에서 게시 된 위치에 지원 되는 Sdk에 대 한 정보를 찾을 수 있습니다.  
