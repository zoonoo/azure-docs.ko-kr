...
기본 계층의 경우 백업은 7일간 사용할 수 있습니다. 표준 계층의 경우 백업은 35일간 사용할 수 있습니다. 자세한 내용은 [Azure Database for MySQL 가격 책정 계층](concepts-pricing-tiers.md)을 참조하세요.
...
| 이름 | myserver-restored | 복원 명령에 의해 만들어진 새 서버의 이름입니다. |
