...
7. **조건**(예: "보다 큼"), **임계값**(예: 85%), **시간 집계**, 경고를 트리거하기 전에 메트릭 규칙을 만족해야 하는 **기간**(예: "지난 30분") 및 **빈도** 를 포함하는 경고 논리를 구성합니다.
   ...
   :::image type="content" source="./media/howto-alert-on-metric/7-set-threshold-time.png" alt-text="메트릭 2 선택":::
...
11. 경고 규칙 이름, 설명 및 심각도를 지정합니다.
    ...
    :::image type="content" source="./media/howto-alert-on-metric/11-name-description-severity.png" alt-text="작업 그룹 2"::: 
