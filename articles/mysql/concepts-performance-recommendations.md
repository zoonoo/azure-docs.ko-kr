...
쿼리 권장 사항은 작업에서 쿼리에 대 한 최적화 및 재작성을 제안 합니다. MySQL 쿼리 패턴을 식별 하 고 구문적으로 수정 하 여 시간이 많이 걸리는 쿼리의 성능을 향상 시킬 수 있습니다. 이 권장 사항 유형을 사용하려면 쿼리 저장소를 사용하도록 설정해야 합니다. 쿼리 저장소는 쿼리 정보를 수집하고 분석에서 권장 사항을 적용하는 데 사용하는 자세한 쿼리 런타임 및 빈도 통계를 제공합니다.
