---
title: 방화벽 규칙 관리 - Azure 포털 - MySQL용 Azure 데이터베이스
...
서버 수준 방화벽 규칙을 사용하여 지정된 IP 주소 또는 다양한 IP 주소에서 MySQL Server용 Azure 데이터베이스에 대한 액세스를 관리할 수 있습니다. 
