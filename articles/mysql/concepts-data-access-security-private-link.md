---
title: Azure Database for MySQL에 대 한 개인 링크 (미리 보기)
...
ms.locfileid: "75897508"
---
# <a name="private-link-for-azure-database-for-mysql-preview"></a>Azure Database for MySQL에 대 한 개인 링크 (미리 보기)
...
네트워크 관리자가 PE (개인 끝점)를 만든 후에는 MySQL 관리자가 PEC (개인 끝점 연결)를 관리 하 여 Azure Database for MySQL 수 있습니다.

> [!NOTE]
> 현재 Azure Database for MySQL에서는 개인 끝점에 대 한 자동 승인만 지원 합니다.
