...
5. 자동 증가가 성공적으로 설정 되었음을 알리는 알림이 나타납니다.
    ...
    :::image type="content" source="./media/howto-auto-grow-storage-portal/5-auto-grow-success.png" alt-text="Azure Database for MySQL-Settings_Pricing_tier-자동 증가":::
