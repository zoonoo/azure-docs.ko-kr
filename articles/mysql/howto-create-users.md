...
Azure Database for MySQL 서버를 만든 후에는 첫 번째 서버 관리자 계정을 사용 하 여 더 많은 사용자를 만들고 관리 액세스 권한을 부여할 수 있습니다. 또한 서버 관리자 계정을 사용 하 여 개별 데이터베이스 스키마에 대 한 액세스 권한이 있는 사용자가 적은 권한으로 사용자를 만들 수 있습니다.
...
## <a name="to-create-more-admin-users-in-azure-database-for-mysql"></a>Azure Database for MySQL에서 더 많은 관리 사용자를 만들려면
