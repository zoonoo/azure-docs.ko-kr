...
| 이동 | https://github.com/go-sql-driver/mysql/releases | 1.3, 1.4 | 1.2 이하 | 버전 1.3에 대한 연결 문자열에서는 `allowNativePasswords=true`를 사용합니다. 버전 1.4는 수정 사항을 포함하고 `allowNativePasswords=true`가 필요하지 않습니다. |
