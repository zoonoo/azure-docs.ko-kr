...
- **Microsoft .sql** 서비스 태그를 사용 하 여 가상 네트워크 서비스 끝점을 Azure Database for MySQL로 설정 하면 모든 azure 데이터베이스 서비스에 대 한 끝점 (Azure Database for MySQL, Azure Database for PostgreSQL, Azure SQL Database 및 Azure Synapse Analytics (이전의 SQL Data Warehouse)도 사용할 수 있습니다.
