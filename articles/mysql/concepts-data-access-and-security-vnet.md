...
> [!NOTE]
> Azure Database for MySQL의 경우 이 기능은 Azure Database for MySQL이 배포된 모든 지역의 Azure 공용 클라우드에서 공개 미리 보기 상태로 사용할 수 있습니다.
...
그러나 2018년 5월 현재, Azure Database for MySQL 서버는 아직 서브넷에 할당될 수 있는 서비스가 아닙니다.
...
- 공개 미리 보기 상태에서 VNet 이동 작업에 대한 지원은 없습니다. 가상 네트워크 규칙을 이동하려면 삭제하고 다시 만듭니다.
