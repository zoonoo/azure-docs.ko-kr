...
이러한 백업 파일은 내보낼 수 없습니다. 백업은 Azure Database for MySQL의 복원 작업에만 사용할 수 있습니다. [Mysqldump](concepts-migrate-dump-restore.md) 를 사용 하 여 데이터베이스를 복사할 수 있습니다.
