---
title: VNet 끝점 관리 - Azure CLI - MySQL용 Azure 데이터베이스
...
- [MySQL 서버 및 데이터베이스에 대 한 Azure 데이터베이스](quickstart-create-mysql-server-database-using-azure-cli.md).
