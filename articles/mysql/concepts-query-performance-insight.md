---
title: Azure Database for MySQL에서에서 query Performance Insight
description: 이 문서에서는 MySQL 용 Azure Database에서 Query Performance Insight 기능 설명
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
