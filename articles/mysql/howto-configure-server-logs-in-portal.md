---
title: Azure Portal에서 Azure Database for MySQL에 대 한 느리게 쿼리 로그 구성 및 액세스
...
ms.locfileid: "71703432"
---
# <a name="configure-and-access-slow-query-logs-in-the-azure-portal"></a>Azure Portal에서 느리게 쿼리 로그 구성 및 액세스
