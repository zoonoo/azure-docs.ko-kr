---
title: VNet 끝점 관리 - Azure 포털 - MySQL용 Azure 데이터베이스
...
> [!Important]
> 컨트롤을 ON으로 설정하면 Azure MySQL Database 서버는 모든 서브넷의 통신을 허용합니다. 제어 집합을 ON으로 유지하면 보안 관점에서 과도하게 액세스할 수도 있습니다. MySQL용 Azure 데이터베이스의 가상 네트워크 규칙 기능과 함께 Microsoft Azure 가상 네트워크 서비스 끝점 기능을 사용하면 보안 영역을 줄일 수 있습니다.
