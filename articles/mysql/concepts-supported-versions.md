...
MySQL용 Azure 데이터베이스는 InnoDB 엔진을 사용하여 MySQL Community Edition [MySQL Community Edition](https://www.mysql.com/products/community/)에서 개발되었습니다.  Azure Database for MySQL은 현재 다음 버전을 지원합니다.
