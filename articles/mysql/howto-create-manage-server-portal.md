...
5. **만들기**를 클릭하여 서버를 프로비전합니다. 프로비전하는 데 몇 분이 걸립니다.
    ...
    > [!NOTE]
    > 공개 미리 보기를 위해 기본 계층에서 최대 1000GB 및 표준 계층에서 10000GB 저장소가 지원되며 최대 저장소는 일시적으로 여전히 1000GB로 제한됩니다.</Include>
...
2. 새 암호를 입력하고 아래와 같이 창에서 암호를 확인합니다.
...
3. **삭제** 단추를 다시 클릭하여 삭제 작업을 확인하고 알림 표시줄에 “삭제 성공” 메시지가 표시되기를 기다립니다.
...
서버 블레이드의 **설정**에서 **속성**을 클릭하여 **속성** 블레이드를 연 다음 서버에 대한 자세한 정보를 모두 확인합니다.
