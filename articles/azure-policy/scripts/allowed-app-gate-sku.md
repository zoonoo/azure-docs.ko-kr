---
title: "Azure Policy json 샘플 - 허용되는 응용 프로그램 게이트웨이 SKU | Microsoft Docs"
description: "이 json 샘플 정책을 적용하려면 응용 프로그램 게이트웨이에서 승인된 SKU를 사용해야 합니다."
...
이 정책을 적용하려면 응용 프로그램 게이트웨이에서 승인된 SKU를 사용해야 합니다. 승인된 SKU 배열을 지정하세요.
