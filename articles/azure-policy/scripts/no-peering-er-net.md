---
title: Azure Policy json 샘플 ‑ ER 네트워크에 피어링하는 네트워크 없음 | Microsoft Docs
description: 이 json 샘플 정책에서는 네트워크 피어링이 지정된 리소스 그룹의 한 네트워크에 연결되는 것을 금지합니다.
