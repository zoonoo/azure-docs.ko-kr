---
title: Azure Policy json 샘플 ‑ 허용되는 Load Balancer SKU | Microsoft Docs
description: 이 json 샘플 정책에서는 Load Balancer가 승인된 SKU를 사용해야 합니다.
...
ms.locfileid: "34600965"
---
# <a name="allowed-load-balancer-skus"></a>허용되는 Load Balancer SKU

이 정책에서는 Load Balancer가 승인된 SKU를 사용해야 합니다. 허용되는 SKU 배열을 지정합니다.
