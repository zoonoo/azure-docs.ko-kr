---
title: Azure Policy json 샘플 ‑ Microsoft SQL DB 수준 감사 설정 감사 | Microsoft Docs
description: 이 json 샘플 정책에는 해당 설정이 지정한 설정과 일치하지 않는 경우 Microsoft Azure SQL Database 감사 설정을 감사합니다.
