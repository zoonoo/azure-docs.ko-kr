---
title: Azure Policy json 샘플 - 허용되는 Express Route SKU | Microsoft Docs
description: 이 json 샘플 정책에서는 Express Routes가 승인된 SKU를 사용해야 합니다.
...
ms.locfileid: "34604763"
---
# <a name="allowed-express-route-skus"></a>허용되는 Express Route SKU

이 정책에서는 Express Routes가 승인된 SKU를 사용해야 합니다. 허용되는 SKU 배열을 지정합니다.
