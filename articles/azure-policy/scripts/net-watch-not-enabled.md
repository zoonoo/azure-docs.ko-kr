---
title: Azure Policy json 샘플 ‑ Network Watcher를 지역에 대해 사용하도록 설정되지 않은 경우 감사 | Microsoft Docs
description: 이 json 샘플 정책은 Network Watcher를 특정 지역에 대해 사용하도록 설정되지 않은 경우 감사합니다.
