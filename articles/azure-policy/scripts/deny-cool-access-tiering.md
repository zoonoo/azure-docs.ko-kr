---
title: Azure Policy json 샘플 - 저장소 계정에 대한 쿨 액세스 계층 거부 | Microsoft Docs
description: 이 json 샘플 정책은 BLOB 저장소 계정에 쿨 액세스 계층을 사용하는 것을 금지합니다.
...
이 정책은 BLOB 저장소 계정에 쿨 액세스 계층을 사용하는 것을 금지합니다.
