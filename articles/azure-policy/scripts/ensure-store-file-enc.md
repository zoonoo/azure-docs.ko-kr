---
title: Azure Policy json 샘플 ‑ 저장소 파일 암호화 확인 | Microsoft Docs
description: 이 json 샘플 정책에서는 저장소 계정에 대해 파일 암호화를 사용할 수 있도록 해야 합니다.
...
---
# <a name="ensure-storage-file-encryption"></a>저장소 파일 암호화 확인
