---
title: Azure Policy json 샘플 ‑ 저장소 계정에 대해서만 https 트래픽 확인 | Microsoft Docs
description: 이 json 샘플 정책에서는 저장소 계정이 HTTPS 트래픽을 사용해야 합니다.
