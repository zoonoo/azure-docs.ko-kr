---
title: "Azure Policy json 샘플 ‑ 관리 디스크를 사용하지 않는 VM 감사 | Microsoft Docs"
description: "이 json 샘플은 관리 디스크를 사용하지 않는 가상 컴퓨터를 만들 때 감사합니다."
...
관리 디스크를 사용하지 않는 가상 컴퓨터를 만들 때 감사합니다.
