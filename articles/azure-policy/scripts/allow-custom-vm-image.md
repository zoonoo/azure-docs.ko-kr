---
title: Azure Policy json 샘플 - 리소스 그룹으로부터 사용자 지정 VM 이미지 허용 | Microsoft Docs
description: 이 json 샘플 정책에서는 사용자 지정 이미지가 승인된 리소스 그룹으로부터 와야 합니다.
...
이 json 샘플 정책에서는 사용자 지정 이미지가 승인된 리소스 그룹으로부터 와야 합니다. 승인된 리소스 그룹의 이름을 지정합니다.
...
추가적인 Azure 정책 템플릿 샘플을 Azure Policy 설명서에서 찾을 수 있습니다.
