---
title: Azure Policy json 샘플 ‑ Microsoft SQL Server 버전 12.0 필수 | Microsoft Docs
description: 이 json 샘플 정책에서는 Microsoft SQL Server 버전 12.0을 사용해야 합니다.
