---
title: Azure Policy json 샘플 ‑ VM 네트워크 인터페이스에 승인된 서브넷 사용 | Microsoft Docs
description: 이 json 샘플 정책에서는 네트워크 인터페이스가 승인된 서브넷을 사용해야 합니다.
...
ms.locfileid: "34602468"
---
# <a name="use-approved-subnet-for-vm-network-interfaces"></a>VM 네트워크 인터페이스에 승인된 서브넷을 사용합니다.

이 정책에서는 네트워크 인터페이스가 승인된 서브넷을 사용해야 합니다. 승인된 서브넷의 ID를 지정합니다.
