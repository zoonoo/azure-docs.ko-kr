---
title: Azure Policy json 샘플 ‑ VM 네트워크 인터페이스에 승인된 VNet 사용 | Microsoft Docs
description: 이 json 샘플 정책에서는 네트워크 인터페이스가 승인된 가상 네트워크를 사용해야 합니다.
