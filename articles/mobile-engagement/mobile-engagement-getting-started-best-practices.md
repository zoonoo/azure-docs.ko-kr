...
예제와 지침을 위해 [미디어 플레이 북 템플릿][미디어 플레이 북 템플릿]에 **KPI 작성기** 워크시트를 사용할 수 있습니다.
...
예제와 지침을 위해 [미디어 플레이 북 템플릿][미디어 플레이 북 템플릿]에 **고객 관리 프로그램** 워크시트를 사용합니다.
...
태그 계획은 응용 프로그램의 모든 내용에 태그를 지정하지 않아야 합니다. 모바일 고객 관리 전략의 일부인 태그 데이터만 포함해야 합니다. 이는 응용 프로그램 간에 따라 달라질 수 있습니다. Azure 모바일 계약 관리에서 제공하는 [미디어 플레이 북 템플릿][미디어 플레이 북 템플릿]은 지정한 방법을 사용하여 태그 계획을 만드는 데 도움이 됩니다. **태그 계획** 워크시트를 태그 계획을 만드는 지침으로 사용합니다.
