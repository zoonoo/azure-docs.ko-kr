<properties 
   pageTitle="Azure Mobile Engagement 사용자 인터페이스 - 도달률 기준" 
...
# 대상 지정 기준을 사용하여 선택한 사용자 하위 집합에 푸시 캠페인을 보내는 방법
...
- **기술 정보: ** 분석 및 모니터 섹션에서 확인할 수 있는 것과 같은 기술 정보를 기준으로 대상을 지정할 수 있습니다. **참고 항목:** [UI 설명서 - 분석][Link 15], [UI 설명서 - 모니터][Link 16] - **위치:** 지역 펜싱과 함께 "실시간 위치 보고"를 사용하는 응용 프로그램은 지리적 위치를 기준으로 사용하여 GPS 위치에서 대상 그룹을 지정할 수 있습니다. "지연 영역 위치 보고" 호출을 사용하여 휴대폰 위치에서 대상 그룹을 지정할 수도 있습니다(SDK에서 "실시간으로 위치 보고" 및 "지연 영역 위치 보고"를 활성화해야 함). **참고 항목:** [SDK 설명서 - iOS - 통합][Link 5], [SDK 설명서 - Android - 통합][Link 5]
