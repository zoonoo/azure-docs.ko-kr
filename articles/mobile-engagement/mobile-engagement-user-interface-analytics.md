...
- 버전: 응용 프로그램의 각 버전에 대해 각기 다른 분석 정보를 표시하거나 모든 버전에 대한 정보를 표시할 수 있습니다. 참고로 UI에서 분석 데이터를 필터링하면 앱 버전에 관계없이 해당 형식의 모든 예제가 표시됩니다. 즉, "작동 중지"를 이름으로 필터링하면 앱 버전 1과 2의 예제가 모두 표시됩니다.
