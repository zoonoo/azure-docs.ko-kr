...
1) 문제가 시스템 전체의 문제인지 테스트하려는 경우 다음의 개별 항목에서 같은 기능을 테스트할 수 있습니다.
...
6) 최종 사용자 장치의 OS 업그레이드 관련 문제인지를 테스트하려면(문제를 해결하려면 SDK를 업그레이드해야 함)
