...
1. 다음 매개 변수를 사용하여 API를 호출하고 TENANT\_ID, CLIENT\_ID 및 CLIENT\_SECRET을 대체해야 합니다.
	...
	> [AZURE.NOTE] 테스트를 위해 [Fiddler](http://www.telerik.com/fiddler) 또는 [Chrome Postman 확장](https://chrome.google.com/webstore/detail/postman/fhbjgbiflinjbdggehcddcbncdddomop)과 같은 HTTP 클라이언트 도구를 사용할 수 있습니다.
