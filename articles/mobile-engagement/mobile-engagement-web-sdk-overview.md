...
-   Internet Explorer 8 및 Internet Explorer 9에서 Mobile Engagement 웹 SDK가 사용하지 않도록 설정되었습니다.
...
>[AZURE.IMPORTANT] Capptain과 Azure Mobile Engagement는 같은 서비스가 아니며, 다음 절차에서는 클라이언트 앱을 마이그레이션하는 방법만 중점적으로 설명합니다. 앱의 Mobile Engagement 웹 SDK를 마이그레이션해도 데이터가 Capptain 서버에서 Mobile Engagement 서버로 마이그레이션되지는 않습니다.
