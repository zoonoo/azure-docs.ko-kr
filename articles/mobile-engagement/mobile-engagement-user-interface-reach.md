...
### 참고 항목
-  [API 설명서 - 도달률 API][Link 4], [API 설명서 - 푸시 API][Link 4], [문제해결 가이드 - 푸시/도달률][Link 23]
-  [도달률 - 캠페인][Link 27], [도달률 - 기준][Link 28], [도달률 - 콘텐츠][Link 29], [도달률- 방법][Link 3]
...
### 참고 항목
-  [개념 - 용어집][Link 6], [API 설명서 - 도달률 - 통계][Link 4]
...
### 참고 항목 
-  [UI 설명서 - 도달률 - 새 푸시 캠페인][27], [API 설명서 - 도달률 API - 통계][Link 4]
