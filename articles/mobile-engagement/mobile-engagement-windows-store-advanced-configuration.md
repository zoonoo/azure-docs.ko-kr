<properties
	pageTitle="Windows 유니버설 앱 Engagement SDK에 대한 고급 구성"
...
# Windows 유니버설 앱 Engagement SDK에 대한 고급 구성
...
> [AZURE.WARNING] 이 기능을 사용하지 않도록 설정하면 앱에서 처리되지 않은 작동 중단이 발생해도 Engagement에서 작동 중단을 전송하지 않으며 **또한** 세션 및 작업도 닫지 않습니다.
