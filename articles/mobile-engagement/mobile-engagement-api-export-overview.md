<properties
	pageTitle="Mobile Engagement 내보내기 API 개요"
...
>[AZURE.NOTE] Azure 저장소와 상호 작용하기 위한 손쉬운 UI 사용을 제공하므로 개발 단계 중 유용한 [Microsoft Azure 저장소 탐색기](http://storageexplorer.com/)를 권장합니다.
