...
이 자습서에서는 데이터를 수집하고 푸시 알림을 보내는 데 필요한 최소 집합인 "기본 통합" 방법을 설명합니다. 전체 통합 설명서는 [Mobile Engagement Windows Phone SDK 통합](../mobile-engagement-windows-phone-sdk-overview/)에서 확인할 수 있습니다.
