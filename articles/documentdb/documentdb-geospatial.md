<properties 
    pageTitle="Azure DocumentDB에서 지리 공간 데이터 작업 | Microsoft Azure" 
...
코드 샘플은 이 [Github 프로젝트](https://github.com/Azure/azure-documentdb-net/tree/master/samples/code-samples/Queries.Spatial)를 참조하세요.
...
다음 JSON 조각은 공간 인덱싱이 사용되는 인덱싱 정책을 보여 줍니다. 즉, 공간 쿼리를 위해 문서 내에 있는 모든 GeoJSON 점을 인덱싱합니다. Azure Preview 포털을 사용하여 인덱싱 정책을 수정하는 경우 인덱싱 정책에 대해 다음과 같은 JSON을 지정하여 컬렉션에서 공간 인덱싱을 사용하도록 설정할 수 있습니다.
