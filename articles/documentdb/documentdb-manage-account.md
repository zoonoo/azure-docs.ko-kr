...
키 및 일관성 수준으로 작업하는 방법에 대해 알아봅니다. 또한 Azure 포털에서 계정을 삭제하는 방법에 대해 알아봅니다.
...
2.      계정 블레이드에서 **설정** 블레이드가 아직 열려 있지 않은 경우 맨 위 명령 모음에서 **설정** 아이콘을 클릭합니다.

3.      **모든 설정** 블레이드의 **기능**에서 **기본 일관성** 항목을 클릭합니다.

![기본 일관성 세션](./media/documentdb-manage-account/chooseandsaveconsistency.png)
