...
1. [Azure 포털](https://portal.azure.com)에 로그인하고 새로 만들기를 클릭하고 "템플릿 배포"를 검색합니다.
    ![템플릿 배포 UI의 스크린샷](./media/documentdb-create-documentdb-website/TemplateDeployment1.png)

2. 템플릿 배포 항목을 선택하고 **만들기**
    ![템플릿 배포 UI의 스크린샷](./media/documentdb-create-documentdb-website/TemplateDeployment2.png)을 클릭합니다.

3.  **템플릿 편집**을 클릭하고 DocDBWebsiteTodo.json 템플릿 파일의 내용을 붙여 넣고 **저장**을 클릭합니다.
    ![템플릿 배포 UI의 스크린샷](./media/documentdb-create-documentdb-website/TemplateDeployment3.png)
...
>[AZURE.NOTE] Azure 계정을 등록하기 전에 Azure 앱 서비스를 시작하려면 [App Service 체험](http://go.microsoft.com/fwlink/?LinkId=523751)으로 이동합니다. 앱 서비스에서 단기 스타터 웹앱을 즉시 만들 수 있습니다. 신용 카드는 필요하지 않으며 약정도 필요하지 않습니다.
