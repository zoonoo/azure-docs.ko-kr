...
|/dbs/{_rid-db} |값 {_rid-db}와 일치하는 id가 있는 데이터베이스 
|/dbs/{_rid-db}/colls/ |단일 데이터베이스 아래의 컬렉션 피드 
|/dbs/{_rid-db}/colls/{_rid-coll} |값 {_rid-coll}과 일치하는 id가 있는 컬렉션 
...
|/dbs/{_rid-db}/users/{_rid-user} |값 {_rid-user}와 일치하는 id가 있는 사용자 
|/dbs/{_rid-db}/users/{_rid-user}/permissions |사용자 아래의 사용 권한 피드 
|/dbs/{_rid-db}/users/{_rid-user}/permissions/{_rid-permission} |값 {_rid-permission}과 일치하는 id가 있는 사용 권한
