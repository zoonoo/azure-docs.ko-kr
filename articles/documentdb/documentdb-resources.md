...
Azure 클래식 포털([http://portal.azure.com/](http://portal.azure.com/))을 통해 [DocumentDB 데이터베이스 계정을 만들고 관리](documentdb-create-account.md)할 수 있습니다. 데이터베이스 계정을 만들고 관리하려면 관리 액세스 권한이 필요하며 Azure 구독으로만 수행할 수 있습니다.
