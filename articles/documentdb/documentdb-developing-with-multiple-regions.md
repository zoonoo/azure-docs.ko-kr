<properties
   pageTitle="DocumentDB에서 여러 지역을 사용하여 개발 | Microsoft Azure"
...
> [AZURE.NOTE] 끝점의 URL은 수명이 긴 상수로 간주하지 말아야 합니다. 서비스는 언제든지 이 URL을 업데이트할 수 있습니다. SDK가 이런 변경 내용을 자동으로 처리합니다.
...
## NodeJS, JavaScript 및 Python SDK
SDK는 코드 변경 없이 사용할 수 있습니다. 이 경우 SDK는 읽기와 쓰기를 현재 쓰기 지역에 자동으로 가져옵니다.
