...
---
# <a name="distribute-data-globally-with-documentdb"></a>DocumentDB로 데이터를 글로벌 배포
...
Karthik Raman이 Azure DocumentDB로 지역 배포를 설명하는 다음 동영상을 보면서 시작하는 것이 좋습니다.

> [!VIDEO https://channel9.msdn.com/Shows/Azure-Friday/Planet-Scale-NoSQL-with-DocumentDB/player]
> 
> 

## <a name="configuring-multi-region-accounts"></a>다중 지역 계정 구성
...
## <a name="enabling-global-distribution"></a>글로벌 배포 활성화
