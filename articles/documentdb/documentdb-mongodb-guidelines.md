---
title: MongoDB에 대한 프로토콜 지원을 사용하는 DocumentDB에 대한 개발 지침 미리 보기 | Microsoft Docs
...
## 컬렉션
> [!IMPORTANT]
> DocumentDB는 컬렉션 수준에서 예약된 처리량을 사용하여 보장되고 예측 가능한 성능을 제공합니다. 따라서 DocumentDB의 컬렉션은 청구 가능한 엔터티입니다.
> 
> 
