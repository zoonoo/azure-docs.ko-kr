---
title: DocumentDB .NET API 및 SDK | Microsoft Docs
...
## 릴리스 정보
> [!IMPORTANT]
> 분할된 컬렉션을 쿼리할 때 System.NotSupportedException이 나타날 수 있습니다. 이 오류를 방지하려면 프로젝트 속성 창의 빌드 탭에서 "32비트 기본 사용" 옵션을 선택 취소합니다.
> 
> 
