---
title: "MongoDB API를 사용하여 DocumentDB 앱 빌드 | Microsoft 문서"
description: "DocumentDB MongoDB API를 사용하여 온라인 데이터베이스를 만드는 NoSQL 자습서입니다."
keywords: "MongoDB 예제"
services: documentdb
author: AndrewHoh
manager: jhubbard
...
---
# <a name="build-a-documentdb-api-for-mongodb-app-using-nodejs"></a>Node.js를 사용하여 DocumentDB: MongoDB API 앱 빌드
...
이 예제에서는 Node.js를 사용하여 DocumentDB: MongoDB API 콘솔 앱을 빌드하는 방법을 보여 줍니다.
