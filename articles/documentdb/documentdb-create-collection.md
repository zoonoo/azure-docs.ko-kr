...
1.  [Azure 포털](https://portal.azure.com/)의 Jumpbar에서 **DocumentDB 계정**을 클릭한 다음 **DocumentDB 계정** 블레이드에서 컬렉션을 추가할 계정을 선택합니다.
    ...
    Jumpbar에 **DocumentDB 계정**이 표시되지 않는 경우 **서비스 더 보기**를 클릭한 다음 **DocumentDB 계정**을 클릭합니다. 나열된 계정이 없는 경우 [DocumentDB 계정을 만들](documentdb-create-account.md)어야 합니다.
