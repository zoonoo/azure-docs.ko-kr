...
6. 단일 파티션으로 컬렉션을 만드는 경우 화살표를 클릭하여 가격 책정 계층을 선택하고 모두 보기를 클릭한 다음 컬렉션에 대한 성능 수준을 선택합니다. 사용 가능한 성능 수준에 대한 자세한 내용은 [DocumentDB의 성능 수준](documentdb-performance-levels.md)을 참조하세요. 만드는 각 컬렉션은 청구 가능 엔터티입니다.
...
9. 분할된 컬렉션을 만드는 경우 컬렉션에 대한 **파티션 키**를 선택합니다. 올바른 파티션 키를 선택하는 것은 성능이 뛰어난 컬렉션을 만드는 데 중요합니다. 파티션 키의 선택에 대한 자세한 내용은 [DocumentDB에서 데이터 분할](documentdb-partition-data.md)을 참조하세요.

10. 화면 맨 아래의 **확인**을 클릭하여 새 컬렉션을 만듭니다.

11. 이제 **데이터베이스** 블레이드의 **컬렉션** 렌즈에 새 컬렉션이 표시됩니다.
