...
<tbody>
<tr>
<td valign="top" ><p><b>컬렉션 성능 수준</b></p></td>
<td valign="top" ><p><b>예약된 처리량</b></p></td>
</tr>

<tr>
<td valign="top" ><p>S1</p></td>
<td valign="top" ><p>250 RU/초</p></td>
</tr>

<tr>
<td valign="top" ><p>S2</p></td>
<td valign="top" ><p>1000 RU/초</p></td>
</tr>

<tr>
<td valign="top" ><p>S3</p></td>
<td valign="top" ><p>2500 RU/초</p></td>
</tr>
...
##성능 수준 작업
DocumentDB 컬렉션을 사용하면 응용 프로그램의 쿼리 패턴 및 성능 요구를 기준으로 데이터를 분할할 수 있습니다. DocumentDB를 사용한 데이터 분할에 대한 자세한 내용은 [데이터 분할 설명서](documentdb-partition-data.md)를 참조하십시오. DocumentDB의 자동 인덱싱 및 쿼리 지원을 통해 동일한 컬렉션 내에서 이기종 문서를 수집하는 것이 상당히 일반적입니다. 개별 컬렉션을 사용해야 할지 여부를 결정할 때는 다음과 같은 주요 사항을 고려합니다.
...
6. 새로 연 **데이터베이스** 블레이드에서 **컬렉션** 렌즈 아래로 스크롤하고 원하는 컬렉션을 선택합니다.
7. 마지막으로 **컬렉션** 블레이드 내의 **사용량** 렌즈에서 **가격 책정 계층** 타일을 찾고 클릭합니다.
8. **가격 책정 계층 선택** 블레이드에서 원하는 성능 수준을 클릭한 다음 블레이드의 아래에서 **선택**을 클릭합니다. 
...
컬렉션의 성능 수준 변경에 대한 다른 옵션은 SDK를 통하는 것입니다. 이 섹션은 [.NET SDK](https://msdn.microsoft.com/library/azure/dn948556.aspx)을 사용하는 컬렉션의 성능 수준을 변경하지만 프로세스는 다른 [SDK](https://msdn.microsoft.com/library/azure/dn781482.aspx)와 유사합니다. .NET SDK을 처음 접하는 경우 [자습서 시작](documentdb-get-started.md)을 방문하십시오.
...
제품 방법에 대한 자세한 정보 및 추가 예제를 보려면 [MSDN](https://msdn.microsoft.com/library/azure/microsoft.azure.documents.client.documentclient.aspx)를 방문하십시오.
...
DocumentDB에 대해 자세히 알아보려면 Azure DocumentDB [설명서](http://azure.microsoft.com/documentation/services/documentdb/)를 참조하십시오.
