...
각 성능 수준에는 연관된 RU(요청 단위) 비율 한도가 있습니다. 이러한 한도는 성능 수준에 따라 컬렉션에 대해 예약되는 처리량이며, 해당 컬렉션에서만 배타적으로 사용할 수 있습니다. 컬렉션은 [Azure 클래식 포털](https://portal.azure.com) 또는 [DocumentDB SDK](https://msdn.microsoft.com/library/azure/dn781482.aspx)를 통해 만들 수 있습니다. DocumentDB API를 사용하면 컬렉션의 성능 수준을 지정할 수 있습니다.
