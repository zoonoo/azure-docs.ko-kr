...
# 저장된 프로시저, 트리거 및 DocumentDB 스크립트 탐색기를 사용한 사용자 정의 함수 보기
...
## 저장된 프로시저, 트리거 및 스크립트 탐색기를 사용한 사용자 정의 함수 보기

스크립트 탐색기를 사용하면 쉽게 DocumentDB 서버 쪽 프로그래밍 아티팩트를 볼 수 있습니다.

- 관심있는 내용이 있는 스크립트를 누르기만 하면 됩니다.
