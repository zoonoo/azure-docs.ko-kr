<properties 
	pageTitle="DocumentDB에서 데이터에 대한 액세스를 보호하는 방법 | Azure" 
...
- 리소스 토큰: 리소스 토큰은 DocumentDB 권한 리소스와 연관되며, 데이터베이스 사용자와 해당 사용자가 특정 Document 응용 프로그램 리소스(예: 컬렉션, 문서)에 대해 갖고 있는 권한 및 데이터베이스 사용자 사이의 관계를 캡처합니다.
