---
title: "Azure Cosmos DB SQL 참고 자료 PDF | Microsoft Docs"
description: "Azure Cosmos DB의 SQL 구문을 사용하여 해당 데이터베이스에서 JSON 문서를 쿼리하는 데 도움이 되는 인쇄 가능한 SQL 참고 자료 PDF - SQL 빠른 참조"
...
## <a name="download-the-cosmos-db-sql-query-cheat-sheet-pdf"></a>Cosmos DB SQL 쿼리 참고 자료 PDF 다운로드
...
**SQL 참고 자료 다운로드: [Microsoft Azure Cosmos DB SQL 참고 자료](http://go.microsoft.com/fwlink/?LinkId=623215)**.

![Azure Cosmos DB SQL 쿼리 참고 자료: Azure Cosmos DB에서 지원하는 SQL 구문에 대한 빠른 참조 PDF - SQL 참고 자료, SQL 참고 자료 PDF, SQL 빠른 참조][cheat-sheet]
