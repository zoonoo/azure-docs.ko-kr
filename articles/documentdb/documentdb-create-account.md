...
컬렉션에 문서가 포함된 후 [DocumentDB SQL](documentdb-sql-query.md)을 사용하여 문서에 대한 [쿼리를 실행](documentdb-sql-query.md#executing-sql-queries)할 수 있습니다. 포털의 [Query Explorer](documentdb-query-collections-query-explorer.md), [REST API](https://msdn.microsoft.com/library/azure/dn781481.aspx) 또는 [SDK](documentdb-sdk-dotnet.md) 중 하나를 사용하여 쿼리를 실행할 수 있습니다.
