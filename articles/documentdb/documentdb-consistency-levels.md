...
- 강력한 일관성이 적용된 읽기 작업(사용한 요청 단위 기준)의 비용은 세션 및 최종 일관성보다 높지만, 강력한 일관성과 동일합니다.
...
3. 계정 블레이드에서 **모든 설정** 블레이드가 아직 열려 있지 않은 경우 맨 위 명령 모음에서 **설정** 아이콘을 클릭합니다.
