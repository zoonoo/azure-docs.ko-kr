...
응용 프로그램의 저장소 및 처리량 크기 조정 요구 사항을 충족하기 위해 컬렉션을 개수에 제한 없이 만들 수 있습니다. [Azure 포털](https://portal.azure.com/)을 통해 또는 [DocumentDB SDK](https://msdn.microsoft.com/library/azure/dn781482.aspx) 중 하나를 통해 컬렉션을 만들 수 있습니다.
