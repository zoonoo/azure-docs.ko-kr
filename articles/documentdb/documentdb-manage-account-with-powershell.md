...
## <a id="create-documentdb-account-powershell"></a> DocumentDB 데이터베이스 계정 만들기
...
## <a id="update-tags-powershell"></a> DocumentDB 데이터베이스 계정의 태그 업데이트
...
## <a id="modify-failover-priority-powershell"></a> DocumentDB 데이터베이스 계정의 장애 조치 우선 순위 수정
