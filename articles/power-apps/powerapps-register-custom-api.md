...
>[AZURE.IMPORTANT] 이 항목은 [사용자 지정 API란](https://powerapps.microsoft.com/tutorials/register-custom-api/)의 powerapps.microsoft.com으로 이동되었습니다. 최신 버전에 대한 PowerApps로 이동하세요. 이 Azure 링크가 보관됩니다.
