...
- 회사 내의 사용자를 추가하고 [역할 기반 액세스 제어](../active-directory/role-based-access-control-configure.md)를 사용하여 이 사용자에게 PowerApps 엔터프라이즈 포털에 액세스하기 위한 PowerApps 관리자 역할을 지정합니다.
...
일반적인 Azure 앱 서비스 환경에 다른 기능이 있습니다. 자세한 내용은 [앱 서비스 환경 소개](../app-service-web/app-service-app-service-environment-intro.md)를 참조하세요.
