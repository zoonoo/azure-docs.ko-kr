...
7. **원본**에서 **사용 가능한 API**를 선택하여 이미 만들어진 API를 선택한 다음 **Office 365 사용자**를 선택합니다. ![Office 365 사용자 API 선택][3]

8. **설정 - 필수 설정 구성**을 선택합니다. ![Office 365 사용자 API 설정 구성][4]
...
8. _OAuth 2_ 섹션의 **회신 URL**을 이 항목의 Azure 포털에서 새 Office 365 사용자 API를 추가했을 때 받은 리디렉션 URL로 설정합니다. **응용 프로그램 추가**를 선택합니다. ![Contoso AAD 앱 구성][11]
