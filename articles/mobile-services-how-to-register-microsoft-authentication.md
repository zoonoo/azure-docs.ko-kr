...
>[AZURE.NOTE]공용 Windows 앱에 대한 Microsoft 계정 인증을 구성하거나 Windows 스토어 앱의 Single Sign-On 환경을 제공하려면 [Microsoft 인증을 위해 Windows 스토어 앱 패키지 등록]을 참조하세요(mobile-services-how-to-register-store-app-package-microsoft-authentication.md).
...
3. **API 설정**을 클릭하고 **리디렉션 URL**에 `https://<mobile_service>.azure-mobile.net/login/microsoftaccount` 값을 제공한 다음 **저장**을 클릭합니다.
