...
* SSDT의 **테이블 형식 모델 프로젝트** 또는 Analysis Services 인스턴스에 대한 1200 이상 호환성 수준의 기존 테이블 형식 모델 - 만들어 본 적이 없나요? [Adventure Works 자습서](https://msdn.microsoft.com/library/hh231691.aspx)를 사용해 봅니다.
