...
|MemoryLimitHigh|메모리: 메모리 제한 상한|바이트|평균|구성 파일의 상한 메모리 제한입니다.|
|MemoryLimitLow|메모리: 메모리 제한 하한|바이트|평균|구성 파일의 하한 메모리 제한입니다.|
...
|LongParsingBusyThreads|스레드: 긴 구문 분석 사용 중인 스레드|개수|평균|긴 구문 분석 스레드 풀의 사용 중인 스레드 수입니다.|
|LongParsingIdleThreads|스레드: 긴 구문 분석 유휴 상태 스레드|개수|평균|긴 구문 분석 스레드 풀의 유휴 상태 스레드 수입니다.|
