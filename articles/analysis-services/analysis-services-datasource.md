...
|Azure Synapse Analytics(SQL Data Warehouse)      |   예      |   예       |<sup>[2](#azprovider)</sup>|
|Azure Blob Storage      |   예       |    아니요      | <sup>[1](#tab1400a)</sup> |
|Azure Table Storage     |   예       |    아니요      | <sup>[1](#tab1400a)</sup>|
|Azure Cosmos DB     |  예        |  아니요        |<sup>[1](#tab1400a)</sup> |
|Azure Data Lake Store Gen1      |   예       |    아니요      |<sup>[1](#tab1400a)</sup> |
|Azure Data Lake Store Gen2       |   예       |    아니요      |<sup>[1](#tab1400a)</sup>, <sup> [5](#gen2)</sup>|
|Azure HDInsight HDFS    |     예     |   아니요       |<sup>[1](#tab1400a)</sup> |
|Azure HDInsight Spark     |   예       |   아니요       |<sup>[1](#tab1400a)</sup>, <sup> [4](#databricks)</sup>|
||||
...
|  --- | --- | --- | --- |
|Access 데이터베이스     |  예 | 아니요 |  |
|Active Directory     |  예 | 아니요 | <sup>[6](#tab1400b)</sup>  |
|Analysis Services     |  예 | 아니요 |  |
|분석 플랫폼 시스템     |  예 | 아니요 |  |
|CSV 파일  |예 | 아니요 |  |
|Dynamics 365     |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|Excel 통합 문서     |  예 | 아니요 |  |
|Exchange      |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|폴더      |예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|IBM Informix  |예 | 아니요 |  |
|JSON 문서      |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|이진의 줄      | 예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|MySQL 데이터베이스     | 예 | 아니요 |  |
|OData 피드      |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|ODBC 쿼리     | 예 | 아니요 |  |
|OLE DB     |   예 | 아니요 |  |
|Oracle  | 예  |예  | <sup>[9](#oracle)</sup> |
|PostgreSQL 데이터베이스   | 예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|Salesforce 개체|  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|Salesforce 보고서 |예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|SAP HANA     |  예 | 아니요 |  |
|SAP Business Warehouse    |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
|SharePoint 목록      |   예 | 아니요 | <sup>[6](#tab1400b)</sup>, <sup> [11](#filesSP)</sup> |
...
|TXT 파일  |예 | 아니요 |  |
|XML 테이블    |  예 | 아니요 | <sup>[6](#tab1400b)</sup> |
| | | |
...
레거시 데이터 원본을 사용 하는 경우 **테이블 형식 모델 탐색기**에서 데이터 > **원본 데이터 원본에서 가져오기 (레거시)** 를 마우스 오른쪽 **단추로 클릭 합니다**.
