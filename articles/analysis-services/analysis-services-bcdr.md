...
* 기본 서버에서 데이터베이스를 백업하고 중복 서버에서 복원합니다. 예를 들어 야간에 Azure Storage에 백업하는 작업을 자동화하고 다른 지역의 다른 중복 서버로 복원할 수 있습니다. 
...
조직에서 서비스 중단을 처리하는 방법을 결정할 때 데이터를 최신 상태로 안전하게 유지하도록 보장하는 방법을 고려하세요. 
