...
최신 호환성 수준은 1400입니다(미리 보기). 이 수준은 SQL Server 2017 Analysis Services와 일치합니다. 1400 호환성 수준에서 주요 기능은 다음과 같습니다.
...
> [!IMPORTANT]
> 1400 호환성 수준은 여전히 미리 보기 상태입니다. 일부 기능은 완전하게 작동하지 않을 수 있습니다. 프로덕션 환경에서 테이블 형식 1400 모델을 사용하지 않는 것이 좋습니다. 
