...
종속성 작업은 상위 태스크에 대한 종료 조건을 기반으로 합니다. 다음과 같은 종료 조건에 대한 종속성 작업을 지정할 수 있습니다. .NET에 대한 세부 정보는 [ExitConditions][net_exitconditions] 클래스를 참조하세요.
