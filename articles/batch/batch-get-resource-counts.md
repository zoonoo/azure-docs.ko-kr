...
* [작업 수 가져오기][rest_get_task_counts] 는 작업의 활성, 실행 중 및 완료 된 작업과 성공 또는 실패 한 태스크의 집계 수를 가져옵니다. 
...
* [목록 풀 노드][rest_get_node_counts] 수는 다양 한 상태 (만들기, 유휴, 오프 라인, 선점, 다시 부팅, 이미지로 다시 설치, 시작 및 기타)의 각 풀에서 우선 순위가 낮은 전용 계산 노드의 수를 가져옵니다. 
