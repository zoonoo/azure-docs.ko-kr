...
이 엔드포인트 구성은 하나 이상의 프런트 엔드 포트 [NAT(Network Address Translation) 풀](/rest/api/batchservice/pool/add#inboundnatpool)로 이루어집니다. NAT 풀을 계산 노드의 일괄 처리 풀과 혼동하지 마십시오. 각 NAT 풀을 설정하여 풀의 계산 노드에서 기본 연결 설정을 재정의합니다. 
