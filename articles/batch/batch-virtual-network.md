...
> [!WARNING]
> 일괄 처리 서비스 IP 주소는 시간이 지남에 따라 변경될 수 있습니다. IP 주소 변경으로 인한 중단을 방지하려면 Batch 서비스 IP 주소를 자동으로 새로 고치고 경로 테이블에 최신 상태로 유지하는 정기적인 프로세스를 설정하는 것이 좋습니다.
