...
Azure CLI를 사용하여 작업을 관리하려면 [az batch job-schedule](https://docs.microsoft.com/cli/azure/batch/job-schedule?view=azure-cli-latest)을 참조하세요.
