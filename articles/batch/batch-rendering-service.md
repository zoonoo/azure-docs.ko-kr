...
Maya 및 3ds Max를 통해 [Batch Explorer](https://github.com/Azure/BatchExplorer) 데스크톱 응용 프로그램 또는 [Batch 템플릿 CLI](batch-cli-templates.md)를 사용하여 작업을 실행할 수 있습니다. Azure Batch CLI를 사용하면 코드를 작성하지 않고 Batch 작업을 실행할 수 있습니다. 대신, 템플릿 파일을 사용하여 Batch 풀, 작업, 및 태스크를 만들 수 있습니다. 자세한 내용은 [Azure Batch CLI 템플릿 및 파일 전송 사용](batch-cli-templates.md)을 참조하세요.
...
- **Batch Explorer**(선택 사항). [Batch Explorer](https://azure.github.io/BatchExplorer)(이전 이름은 BatchLabs)는 Azure Batch 응용 프로그램을 만들고, 디버그하고, 모니터링할 수 있도록 하는 무료의 풍부한 기능을 가진 독립 실행형 클라이언트 도구입니다. Rendering 서비스를 사용할 필요 없이 Batch 솔루션을 개발하고 디버그하는 유용한 옵션입니다.
...
응용 프로그램 로그를 다운로드하고 RDP 또는 SSH를 사용하여 개별 VM에 원격으로 연결하면 [Azure Portal](https://ms.portal.azure.com/)을 사용하여 작업을 모니터링하고 실패한 작업을 진단할 수 있습니다. 또한 [Batch Explorer 도구](https://azure.github.io/BatchExplorer)를 사용하여 관리, 모니터링 및 디버그할 수 있습니다.
...
Azure는 사전 설치되어 사용이 가능한 Maya, 3DS Max, Arnold 및 V-Ray의 각 버전과 함께 Windows 및 Linux 이미지를 제공합니다. 풀을 만들 때 [Azure Portal](https://portal.azure.com), Maya 플러그 인 또는 [Batch Explorer](https://azure.github.io/BatchExplorer)에서 이러한 이미지를 선택할 수 있습니다.

Azure Portal 및 Batch Explorer에서 사전 설치된 응용 프로그램으로 VM 이미지 중 하나를 설치할 수 있습니다. 배치 계정의 풀 섹션에서 **새로 만들기**를 선택한 다음, **풀 추가**의 **이미지 형식** 드롭다운 목록에서 **그래픽 및 렌더링(Linux/Windows)** 을 선택하면 됩니다.
...
- [Batch Explorer](https://azure.github.io/BatchExplorer) 데스크톱 응용 프로그램
...
- [Batch Explorer](https://azure.github.io/BatchExplorer) 데스크톱 응용 프로그램(3ds Max 템플릿 사용에 대한 지침은 [BatchExplorer 데이터](https://github.com/Azure/BatchExplorer-data/tree/master/ncj/3dsmax) 참조)
- [Batch 템플릿 CLI](batch-cli-templates.md)

3ds Max Batch Labs 템플릿을 사용하면 Batch Rendering을 통해 VRay와 Arnold 장면을 렌더링할 수 있습니다. VRay 및 Arnold를 위한 템플릿에는 두 가지 변형이 있습니다. 하나는 표준 장면을 위한 것이고, 다른 하나는 자산과 텍스처에 대한 3DS Max 경로 파일(.mxp 파일)이 필요한 더 복잡한 장면을 위한 것입니다. 3ds Max 템플릿에 대한 자세한 내용은 GitHub의 [BatchExplorer 데이터](https://github.com/Azure/BatchExplorer-data/tree/master/ncj/3dsmax) 리포지토리를 참조하세요.
