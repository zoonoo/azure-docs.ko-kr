...
### <a name="task-dependencies"></a>작업 의존 관계
...
이러한 엔터티에 대한 *환경 설정* 속성을 채워서 태스크 또는 작업 수준에서 사용자 지정 환경 변수를 설정할 수 있습니다. 예를 들어 Batch .NET.에서 [작업 추가][rest_add_task] (일괄 처리 REST API) 또는 [CloudTask.EnvironmentSettings][net_cloudtask_env] 및  [CloudJob.CommonEnvironmentSettings][net_job_env] 속성을 참조하세요.
