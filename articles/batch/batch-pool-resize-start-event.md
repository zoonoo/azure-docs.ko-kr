---
title: Azure 일괄 처리 풀 크기 조정 시작 이벤트
description: Batch 풀 크기 조정 시작 이벤트에 대한 참조입니다. 예제에서는 수동 크기 조정을 사용하여 풀 크기 조정에 대한 풀 크기 조정 시작 이벤트의 본문을 0개에서 2개 노드로 조정합니다.
services: batch
author: LauraBrenner
manager: evansma
ms.assetid: ''
