...
> [!NOTE]
> [JobPreparationTask]JobPreparationTask는 각 작업을 시작할 때 실행되지만 StartTask는 먼저 계산 노드를 풀과 조인하거나 다시 시작할 때만 실행된다는 점에서 [net\_job\_prep\_cloudjob]은 [CloudPool.StartTask][pool_starttask]와 다릅니다.
> 
> 
