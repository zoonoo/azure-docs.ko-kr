...
다음 단계를 사용하여 Azure 포털에서 할당량 증가를 요청합니다([Azure 클래식 포털](https://azure.microsoft.com/blog/2014/06/04/azure-limits-quotas-increase-requests/)에서도 증가 요청 가능).

1. 포털의 대시보드에서 **도움말+지원**을 클릭합니다.

2. **새 지원 요청 > 기본**을 클릭합니다.
