...
자동 사용자 계정 및 명명 된 사용자 계정은 모두 태스크의 작업 디렉터리, 공유 디렉터리 및 다중 인스턴스 작업 디렉터리에 대 한 읽기/쓰기 액세스 권한을 가집니다. 두 가지 유형의 계정 모두 시작 및 작업 준비 디렉터리에 대해 읽기 권한을 갖습니다.
