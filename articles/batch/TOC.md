...
### [계산 노드에 대한 VM 크기 선택](batch-pool-vm-sizes.md)
...
### [계산 집약적 VM 사용](batch-pool-compute-intensive-sizes.md)
### [Linux 계산 노드 사용](batch-linux-nodes.md)
### [우선 순위가 낮은 VM 사용](batch-low-pri-vms.md)
