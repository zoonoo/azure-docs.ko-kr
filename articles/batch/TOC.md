...
# 시작
## 
            [Batch 계정 만들기](batch-account-create-portal.md)
## 
            [Batch .NET 자습서](batch-dotnet-get-started.md)
## 
            [Batch Python 자습서](batch-python-tutorial.md)
## 
            [Batch Node.js 자습서](batch-nodejs-get-started.md)
## 
...
### 
            [MPI 작업 Batch 실행](batch-mpi.md)
### [작업 종속성](batch-task-dependencies.md)
### [작업 실행을 위한 사용자 계정](batch-user-accounts.md)
### 
            [Batch용 Visual Studio 프로젝트 템플릿](batch-visual-studio-templates.md)
## 관리
### 
...
#### 
            [Batch 계정 만들기](./scripts/batch-cli-sample-create-account.md)
...
## 
            [Batch 진단 로그](batch-diagnostics.md)
## 
...
## 
            [Azure 클라우드의 Batch 및 HPC 솔루션](batch-hpc-solutions.md)
