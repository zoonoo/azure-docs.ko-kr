...
> [!IMPORTANT]
> Azure Batch 공용 IP 주소가 없는 풀에 대 한 지원은 현재 미국 서 부, 미국 동부, 미국 동부, 미국 서 부 2, US Gov 버지니아 및 US Gov 애리조나 지역에 대 한 공개 미리 보기로 제공 됩니다.
...
![NoPublicIPAddresses가 선택 된 풀 추가 화면](./media/batch-pool-no-public-ip-address/create-pool-without-public-ip-address.png)
