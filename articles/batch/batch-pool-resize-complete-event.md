...
|`resultMessage`|문자열| 결과에 대 한 자세한 메시지입니다.<br /><br /> 크기 조정이 성공적으로 완료되면 작업에 성공했다고 표시됩니다.|
