---
title: 클라우드의 배치 및 HPC 솔루션 | Microsoft Docs
...
> [!NOTE]
> Azure는 정기적으로 시나리오에 유용할 수 있는 새로운 서비스를 도입합니다. 질문이 있는 경우 [Azure 파트너](https://pinpoint.microsoft.com/ko-KR/search?keyword=azure) 또는 전자 메일 *bigcompute@microsoft.com*에 문의하세요.
> 
> 
