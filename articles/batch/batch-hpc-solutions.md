...
> [!NOTE]
> Azure [H 시리즈와 같은 계산 집약적인 인스턴스](../virtual-machines/windows/sizes-hpc.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)를 활용하여 HPC 워크로드의 성능 및 확장성을 개선합니다. 또한 이러한 인스턴스는 대기 시간이 짧고 처리량이 많은 응용 프로그램 네트워크를 필요로 하는 병렬 MPI 응용 프로그램을 지원합니다. 또한 NVIDIA GPU를 포함한 [N 시리즈](../virtual-machines/windows/sizes-gpu.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) VM을 사용하여 Azure에서 컴퓨팅 및 시각화 시나리오의 범위를 확장할 수 있습니다.  
> 
> 
