...
Security Center 아래 나열 된 환경의 영역에서 위협을 발견 하면 경고를 생성 합니다. 이러한 경고는 영향을 받는 리소스, 제안 된 수정 단계에 대 한 세부 정보를 설명 하 고, 경우에 따라 논리 앱을 트리거하는 옵션을 설명 합니다.

경고가 Security Center에 의해 생성 되거나 다른 보안 제품의 Security Center에서 수신 되는지 여부를 내보낼 수 있습니다. Azure 센티널 (또는 타사 SIEM) 또는 다른 외부 위치로 경고를 내보내려면 [경고 및 권장 사항 내보내기](continuous-export.md)의 지침을 따르세요. 




## Windows 컴퓨터에 대 한 위협 방지<a name="windows-machines"></a>
...
## Linux 컴퓨터에 대 한 위협 방지<a name="linux-machines"></a>
...
## Azure App Service에 대 한 위협 방지<a name="app-services"></a>
...
## Azure 컨테이너에 대 한 위협 방지<a name="azure-containers"></a>
...
## Azure 네트워크 계층에 대 한 위협 방지<a name="network-layer"></a>
...
## Azure Key Vault에 대 한 위협 방지 (미리 보기)<a name="azure-keyvault"></a>
...
## SQL Database 및 SQL Data Warehouse에 대 한 위협 방지<a name="data-sql"></a>
...
## Azure Storage에 대 한 위협 방지<a name="azure-storage"></a>
...
## Azure Cosmos DB에 대 한 위협 방지<a name="cosmos-db"></a>
...
## Azure 관리 계층 (Azure Resource Manager)에 대 한 위협 방지 (미리 보기)<a name ="management-layer"></a>
...
## 다른 Microsoft 서비스의 보안 경고<a name="alerts-other"></a>

### Azure WAF에 대 한 위협 방지<a name="azure-waf"></a>
...
### Azure DDoS Protection에 대 한 위협 방지<a name="azure-ddos"></a>
