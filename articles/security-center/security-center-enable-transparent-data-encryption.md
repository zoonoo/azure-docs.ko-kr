...
1. **권장 사항** 블레이드에서 **투명한 데이터 암호화 사용**을 선택합니다. ![][1]

2. 이렇게 하면 **SQL 데이터베이스에서 투명한 데이터 암호화 사용** 블레이드가 열립니다. TDE를 사용하도록 설정할 SQL 데이터베이스를 선택합니다. ![][2]
3. **투명한 데이터 암호화** 블레이드의 데이터 암호화에서 **켜기**를 선택하고 블레이드의 위쪽 리본에서 **저장**을 선택합니다. ![][3]
