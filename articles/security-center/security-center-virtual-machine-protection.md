...
Compute 및 App Services 권장 사항의 전체 목록은 [권장 사항](security-center-virtual-machine-protection.md#compute-and-app-recs)을 참조하세요.
...
- **컨테이너**: 해당 구성의 컨테이너 및 보안 평가의 목록입니다.
...
- **이름**: 누락된 업데이트의 이름입니다.
- **아니요. Vm & 컴퓨터**:이 업데이트가 누락 된 vm 및 컴퓨터의 총 수입니다.
- **업데이트 심각도**: 특정 권장 사항의 심각도를 설명합니다.

    - **심각**: 중요한 리소스(애플리케이션, 가상 머신 또는 네트워크 보안 그룹)에 취약성이 있으며 주의가 필요합니다.
