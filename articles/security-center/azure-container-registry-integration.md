...
- 지원 되는 레지스트리:
    ...
    - ✘ ' Private ' 레지스트리 Security Center를 사용 하려면 공용 인터넷에서 레지스트리를 액세스할 수 있어야 합니다. 방화벽이 나 서비스 끝점을 사용 하거나 개인 끝점 (예: Azure 개인 링크) Security Center을 사용 하 여 레지스트리에 대 한 액세스를 제한 한 경우 현재 사용자의 레지스트리에 연결 하거나 검색할 수 없습니다.
...
## <a name="acr-with-security-center-faq"></a>Security Center FAQ로 ACR
