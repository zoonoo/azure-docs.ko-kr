...
* **Azure 활동**: 모든 보안 경고, 승인된 보안 센터 [적시](https://docs.microsoft.com/azure/security-center/security-center-just-in-time) 요청 및 [적응형 응용 프로그램 컨트롤에](https://docs.microsoft.com/azure/security-center/security-center-adaptive-application)의해 생성된 모든 경고입니다.
* **Azure 모니터 로그**: 모든 보안 경고입니다.
