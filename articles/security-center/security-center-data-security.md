...
* **Azure 활동**: 모든 보안 경고, 승인된 Security Center [Just-In-Time](security-center-just-in-time.md) 요청 및 [적응형 애플리케이션 제어](security-center-adaptive-application.md)에서 생성된 모든 경고
