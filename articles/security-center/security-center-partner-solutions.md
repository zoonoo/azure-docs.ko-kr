...
---
# <a name="monitoring-partner-solutions-with-azure-security-center"></a>Azure Security Center를 사용하여 파트너 솔루션 모니터링
이 문서에서는 Azure Security Center에서 파트너 솔루션의 상태를 모니터링하는 방법을 알아봅니다.
...
이 문서에서는 보안 센터의 **파트너 솔루션** 타일을 소개했습니다. Security Center에 대한 자세한 내용은 다음 문서를 참조하세요.
