...
* **보안 권장 사항** SECURITY CENTER-AKS 리소스를 식별 하 고 클러스터에서 개별 가상 머신으로 분류 합니다. 그런 다음 리소스 별로 보안 권장 사항을 볼 수 있습니다. 자세한 내용은 [권장 사항 목록](recommendations-reference.md#recs-computeapp)에서 컨테이너 권장 사항을 참조 하세요. 

    > [!NOTE]
    > Security Center 권장 사항의 이름이 "(Preview)" 태그로 끝나는 경우에는 기능이 아니라 권장 사항의 미리 보기 특성을 참조 합니다.
