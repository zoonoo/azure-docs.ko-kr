...
## [온보딩](security-center-onboarding.md)
## [이벤트](security-center-events-dashboard.md)
## [이를 통해 검색](security-center-search.md)

## 예방
### [보안 상태 모니터링](security-center-monitoring.md)
### [권장 사항 관리](security-center-recommendations.md)
### [파트너 솔루션 통합](security-center-partner-integration.md)
### [파트너 솔루션 모니터링](security-center-partner-solutions.md)

### [계산](security-center-virtual-machine-recommendations.md)
...
### [네트워킹](security-center-network-recommendations.md)
...
### [저장소 및 데이터](security-center-sql-service-recommendations.md)
...
### [응용 프로그램](security-center-application-recommendations.md)
...
### [위협 인텔리전스 맵](security-center-threat-intel.md)
