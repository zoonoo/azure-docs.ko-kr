...
사고 대응 팀도 [Security Center Power BI](security-center-powerbi.md) 기능을 활용하여 서로 다른 종류의 보고서를 볼 수 있습니다. 이러한 보고서는 권장 사항과 보안 경고를 시각화, 분석 및 필터링하는 추가 조사에서 유용합니다. SIEM(보안 정보 및 이벤트 관리) 솔루션을 사용하는 회사의 경우 조사 과정에서 [SIEM 솔루션과 Security Center를 통합](security-center-integrating-alerts-with-log-integration.md)할 수도 있습니다. Azure 감사 로그와 VM 보안 이벤트는 [Azure 로그 통합 도구](https://blogs.msdn.microsoft.com/azuresecurity/2016/07/21/microsoft-azure-log-integration-preview/)를 통해 통합할 수도 있습니다. 이 정보는 Security Center에서 제공하는 정보와 함께 공격을 조사하는 데 사용할 수 있습니다.
