...
5. 작업 영역을 선택합니다.  
   Azure Monitor 로그 검색 쿼리를 필터링 된 보안 구성 불일치가 있는 작업 영역을 엽니다.
...
* Azure 구독 및 리소스 그룹에 대해 보안 정책을 구성하는 방법을 알아보려면 [Azure Security Center에서 보안 정책 설정](tutorial-security-policy.md)을 참조하세요.
