...
적응형 애플리케이션 제어는 구성된 VM 그룹에서 실행되도록 허용된 애플리케이션의 집합을 정의할 수 있습니다. 이 기능은 Windows 컴퓨터(모든 버전, 클래식 또는 Azure Resource Manager)에서만 사용할 수 있습니다. 다음 단계를 사용하여 Security Center에서 응용 프로그램 허용 목록을 구성할 수 있습니다.
...
Security Center는 안정적인 애플리케이션의 집합을 실행하는 가상 머신을 위해 애플리케이션 허용 목록 정책만 권장합니다. 관련된 VM의 응용 프로그램이 계속 변경되는 경우 권장 사항이 생성되지 않습니다.
