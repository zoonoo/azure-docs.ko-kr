...
- **자동 온 보 딩**. Security Center은 Security Center에서 모니터링 하는 모든 Windows server에 대해 Microsoft Defender for Endpoint 센서를 자동으로 사용 하도록 설정 합니다.
...
1. **Microsoft Defender For Endpoint에서 내 데이터에 액세스 하도록 허용** 을 선택 하 고 **저장** 을 선택 합니다.
    ...
    :::image type="content" source="./media/security-center-wdatp/enable-integration-with-edr.png" alt-text="Azure Security Center와 Microsoft의 EDR 솔루션, Microsoft Defender for Endpoint 간의 통합 사용":::
...
1. 다음 명령을 복사하여 프롬프트에서 실행합니다. 명령 프롬프트 창이 자동으로 닫힙니다.
    ...
    ```
    :::image type="content" source="./media/security-center-wdatp/generate-edr-alert.png" alt-text="테스트 경고를 생성 하는 명령을 포함 하는 명령 프롬프트 창":::
