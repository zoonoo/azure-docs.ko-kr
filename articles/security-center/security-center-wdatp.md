...
- **자동 온보딩**: Azure 보안 센터에 온보딩된 Windows 서버에 대해 Microsoft Defender ATP 센서가 자동으로 활성화됩니다.
...
3. 명령이 성공하면 Azure 보안 센터 대시보드 및 Microsoft Defender ATP 포털에 새 경고가 표시됩니다. 이 경고가 표시되려면 몇 분 정도 걸릴 수 있습니다.

4. 보안 센터에서 경고를 검토하려면 **보안 경고** > **의심스러운 PowerShell CommandLine로**이동합니다.

5. 조사 창에서 링크를 선택하여 Microsoft Defender ATP 포털로 이동합니다.
