---
title: Azure Security Center에서 Azure storage 계정에 대 한 암호화 | Microsoft Docs
...
미사용 데이터에 대 한 azure Storage 암호화는 모든 Azure storage 계정에 대해 기본적으로 사용 됩니다. Azure Storage는 Azure Storage에 기록 되 고 검색 전 해독 하는 경우 데이터를 암호화 합니다. 자세한 내용은 [미사용 데이터에 대 한 Azure Storage 암호화](../storage/common/storage-service-encryption.md)합니다.
