...
Endpoint Protection은 Security Center에서 권장 사항으로 표시됩니다.  환경이 맬웨어 방지 위협에 취약한 경우 **권장 사항**과 **컴퓨팅** 아래에 이 권장 사항이 표시됩니다. **Endpoint Protection 문제 대시보드**를 보려면 계산 워크플로를 따라야 합니다.
