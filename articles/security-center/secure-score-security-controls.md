...
|----------------|:-------------------:|---------------|
|**MFA 사용**|10|-구독에 대 한 소유자 권한이 있는 계정에서 MFA를 사용 하도록 설정 해야 합니다.<br>-MFA에 구독에 대 한 쓰기 권한이 있는 계정을 사용 하도록 설정 해야 합니다.|
