...
ms.locfileid: "76158157"
---
# <a name="the-enhanced-secure-score-preview"></a>향상 된 보안 점수 (미리 보기) 

이 문서에서는 향상 된 보안 점수 (현재 미리 보기 상태), 함께 제공 되는 보안 컨트롤 및 가져오는 이점을 소개 합니다.
...
위의 스크린샷에서 "시스템 업데이트 적용" 보안 제어의 값은 "2% (1 포인트)"를 표시 합니다. 즉,이 컨트롤의 모든 권장 사항을 재구성 하면 점수가 2% (이 경우 1 포인트) 씩 증가 합니다. 편의상 권장 구성 목록의 "잠재적 증가" 열 값은 정수로 반올림 됩니다. 도구 설명에 정확한 값이 표시 됩니다.
