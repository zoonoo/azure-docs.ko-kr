...
이 연습을 사용하여 Azure 보안 센터 기능으로 보안 경고를 관리하고 대응하는 방법에 대해 알아봅니다.

> [AZURE.NOTE]이 문서의 정보는 Azure 보안 센터의 미리 보기 버전에 적용됩니다.

## Azure 보안 센터가 보안 경고를 관리하는 방법
...
- **끝점 데이터에 대한 무작위 공격 감지**: 이 감지는 시스템 로그의 Azure 보안 센터를 기반으로 하며, 이 감지를 사용하여 실패한 시도와 성공적인 시도를 구별할 수 있습니다. 
