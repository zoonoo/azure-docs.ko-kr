...
1. **리소스 유형별 가격 책정 계층 선택** 그룹에서 **키 자격 증명 모음** 행을 찾고 **사용** 또는 **사용 안 함**을 선택 합니다.
    ...
    [![Azure Security Center에서 Key Vault에 대 한 advanced threat protection 사용 또는 사용 안 함](media/advanced-threat-protection-key-vault/atp-for-akv-enable-atp-for-akv.png)](media/advanced-threat-protection-key-vault/atp-for-akv-enable-atp-for-akv.png#lightbox)
