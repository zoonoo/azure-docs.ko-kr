...
- [Azure 활동 로그 이벤트를 확인 하 고 검색 하는 방법](/azure/azure-monitor/platform/activity-log-view) 
...
- [Azure Resource Manager 템플릿을 사용 하 여 Log Analytics 작업 영역 관리](../azure-monitor/platform/template-workspace-configuration.md)
