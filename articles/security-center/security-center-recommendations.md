---
title: Azure Security Center |의 보안 권장 사항 Microsoft Docs
...
- 권장 사항을 구현 하기 위해 수행할 수정 단계입니다. <!-- In some cases, one-click remediation is available. -->
- 권장 조치를 수행 하는 데 필요한 리소스
- **보안 점수에 영향을 줍니다**.이는이 권장 사항을 구현 하는 경우 보안 점수가 적용 되는 금액입니다.

## 권장 사항 모니터링<a name="monitor-recommendations"></a>
...
1. **개요**에서 **권장 사항 타일** 을 선택 합니다. **권장 사항** 목록이 열립니다.
   ...
   * **상태 표시줄**:  특정 권장 사항의 심각도를 설명합니다.
       ...
       * **보통 (주황)** : 취약점이 있으며 중요하지 않은 또는 추가 단계가 프로세스를 완료하거나 취약점을 제거하는 데 필요합니다.
