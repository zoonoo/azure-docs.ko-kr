...
호스트 및 AKS 클러스터 수준에서 위협을 검색 합니다. 자세한 내용은 [Azure container service](https://docs.microsoft.com/azure/security-center/security-center-alerts-compute#azure-container-service-)를 참조 하세요.
