...
Security Center는 Microsoft Monitoring Agent를 사용 하 여 데이터를 수집 하 고 저장 합니다. 자세한 내용은 [Azure Security Center에서 데이터 수집](security-center-enable-data-collection.md)을 참조 하세요.
