...
|리소스 유형|보안 점수|권장 사항|설명|
|----|----|----|----|
|컴퓨터|40|가상 머신에서 네트워크 보안 그룹 사용|가상 머신의 네트워크 액세스를 제어하기 위해 네트워크 보안 그룹을 활성화합니다.|
...
|컴퓨터|20|인터넷 연결 엔드포인트를 통해 액세스 제한|기존 허용 규칙의 액세스를 제한하여 인터넷 연결 VM의 네트워크 보안 그룹을 강화합니다.|
