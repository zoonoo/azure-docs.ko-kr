...
> [!NOTE]
> 이 옵션은 테 넌 트 수준의 사용 권한이 있는 사용자에 대해서만 표시 됩니다. [자신에 게 테 넌 트 전체 사용 권한을 부여](https://docs.microsoft.com/azure/security-center/security-center-management-groups#grant-tenant-wide-permissions-to-yourself)합니다.
