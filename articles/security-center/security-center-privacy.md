...
Azure Portal에서 사용자는 Security Center의 just-in-time VM 액세스 기능을 사용 하 여 허용 된 IP 구성을 볼 수 있습니다. 자세한 내용은 [just-in-time을 사용 하 여 가상 머신 액세스 관리](security-center-just-in-time.md) 를 참조 하세요.
...
Security Center의 [just-in-time](security-center-just-in-time.md) 기능에 의해 저장 되는 IP 주소 및 포트 번호는 분류할 필요가 없습니다.
...
보안 연락처, just-in-time 및 경고 업데이트의 감사 로그는 [Azure 활동 로그](../azure-monitor/platform/activity-logs-overview.md)에서 유지 관리 됩니다.
