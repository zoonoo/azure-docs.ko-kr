...
보안 센터 위협 보호는 Azure 리소스, 네트워크 및 연결된 파트너 솔루션의 보안 정보를 모니터링하여 작동합니다. 위협을 식별하도록 종종 여러 소스의 정보를 상호 연결하는 이 정보를 분석합니다. 자세한 내용은 [Azure Security Center가 위협을 감지하고 대응하는 방법을 참조하세요.](security-center-alerts-overview.md#detect-threats)
...
3. 이 경우 **실행된 의심스러운 프로세스** 블레이드는 아래 그림과 같이 경고에 대한 세부 정보를 표시합니다.
