...
4. 왼쪽 창에서 **알림**을 클릭하고 다음 이미지와 같이 모든 Syslog 알림을 사용하도록 설정합니다(권장).
    ...
    ![알림](./media/security-center-ata-integration/security-center-ata-integration-fig2.png)
...
설치를 완료하면 통합이 완료되며 ATA에서 Security Center로 전송된 새 경고를 **보안 경고** 및 **검색**에서 볼 수 있습니다. 해당 솔루션은 **보안 솔루션** 페이지의 **연결된 솔루션**에 표시됩니다. 
