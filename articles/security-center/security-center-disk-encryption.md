...
> [!NOTE]
> Azure Active Directory 응용 프로그램을 만들어야 하는 이유에 대해 관심이 있다면 [Azure 키 자격 증명 모음 시작](../key-vault/key-vault-get-started.md) 문서에서 *Azure Active Directory로 응용 프로그램 등록* 섹션을 참조하세요.
> 
> 
