...
---
# <a name="update-to-dynamic-compliance-packages-in-your-regulatory-compliance-dashboard"></a>규정 준수 대시보드에서 동적 규정 준수 패키지로 업데이트
...
1. 업계 & 규제 표준 섹션에서 Azure CIS 1.1.0을 새 콘텐츠에 대해 업데이트할 수 있습니다. **지금 업데이트를**클릭합니다. 
