...
[Azure PowerShell을 사용하여 Windows IaaS VM 암호화](../security/fundamentals/quick-encrypt-vm-powershell.md)에서는 이러한 단계를 설명합니다. 이 항목에서는 디스크 암호화를 구성할 Windows 클라이언트 머신을 사용하고 있다고 가정합니다.
