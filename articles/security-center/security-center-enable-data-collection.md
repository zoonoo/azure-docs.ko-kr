...
**작업 영역: DefaultWorkspace-[subscription-ID]-[geo]<br> 리소스 그룹: DefaultResouceGroup-[geo]**
...
5.  기존 VM에 확장을 배포하려면 [Azure Virtual Machines에 대한 데이터 수집](../log-analytics/log-analytics-quick-collect-azurevm.md)의 지침을 따릅니다.
