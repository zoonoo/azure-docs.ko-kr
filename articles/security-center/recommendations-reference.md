...
|**인터넷 연결 Vm을 사용 하는 허용 되는 네트워크 보안 그룹에 대 한 액세스를 제한 해야 합니다.**|기존 허용 규칙의 액세스를 제한 하 여 인터넷 연결 Vm의 네트워크 보안 그룹을 강화 합니다.<br>(관련 정책: 인터넷 연결 가상 컴퓨터에 대 한 네트워크 보안 그룹 규칙을 강화 해야 함)|높음|N|가상 머신|
