...
자세한 내용은 [Azure Security Center의 보안 경고](security-center-alerts-overview.md) 및 [의 보안 경고 관리 및 대응](security-center-managing-and-responding-alerts.md) 을 참조 하세요 Azure Security Center
...
## Windows VM에 대 한 경고 유효성 검사<a name="validate-windows"></a>
...
> [!NOTE]
> Windows에 대 한이 테스트 경고를 검토할 때 필드 **인수 감사를 사용 하도록 설정** 했는지 확인 **합니다.** **False**인 경우에는 명령줄 인수 감사를 사용 하도록 설정 해야 합니다. 사용 하도록 설정 하려면 다음 명령줄을 사용 합니다.
>
