---
title: "Eclipse용 Azure 탐색기를 사용하여 저장소 계정 관리 | Microsoft Docs"
...
# <a name="managing-storage-accounts-using-the-azure-explorer-for-eclipse"></a>Eclipse용 Azure 탐색기를 사용하여 저장소 계정 관리

Eclipse용 Azure 도구 키트의 일부인 Azure 탐색기는 Eclipse IDE 내에서 Azure 계정의 저장소 계정을 관리하기 위한 사용하기 쉬운 솔루션을 Java 개발자에게 제공합니다.

[!INCLUDE [azure-toolkit-for-eclipse-prerequisites](../includes/azure-toolkit-for-eclipse-prerequisites.md)]

[!INCLUDE [azure-toolkit-for-eclipse-show-azure-explorer](../includes/azure-toolkit-for-eclipse-show-azure-explorer.md)]

## <a name="creating-a-storage-account-in-eclipse"></a>Eclipse에서 저장소 계정 만들기

다음 단계에서는 Azure 탐색기를 사용하여 저장소 계정을 만드는 단계를 안내합니다.

1. [Eclipse용 Azure 도구 키트에 대한 로그인 지침] 문서의 단계를 사용하여 Azure 계정에 로그인합니다.

1. **Azure 탐색기** 보기에서 **Azure** 노드를 확장하고 **저장소 계정**을 마우스 오른쪽 단추로 클릭한 후 **저장소 계정 만들기**를 클릭합니다.
   ![저장소 계정 만들기 메뉴][CS01]

1. **저장소 계정 만들기** 대화 상자가 나타나면 ![새 저장소 계정 만들기 대화 상자][CS02]에서 다음 옵션을 지정합니다.

   a. **이름**: 새 저장소 계정의 이름을 지정합니다.

   b. **구독**: 새 저장소 계정에 사용할 Azure 구독을 지정합니다.

   c. **리소스 그룹**: 가상 컴퓨터에 대한 리소스 그룹을 지정합니다. 다음 옵션 중 하나를 선택해야 합니다.
      * **새로 만들기**: 새 리소스 그룹을 만들 것임을 지정합니다.
      * **기존 그룹 사용**: Azure 계정에 연결된 목록 리소스 그룹에서 선택할 것임을 지정합니다.

   ㄹ. **지역**: 저장소 계정을 만들 위치(예: "미국 서부")를 지정합니다.

   e. **계정 종류**: 만들려는 저장소 계정의 유형(예: "Blob Storage")을 지정합니다. (자세한 내용은 [Azure Storage 계정 정보]를 참조하세요.)

   f. **성능**: 선택한 게시자에서 사용할 제품을 제공하는 저장소 계정(예: "Premium")을 지정합니다. (자세한 내용은 [Azure Storage 확장성 및 성능 목표]를 참조하세요.)

   g. **복제**: 저장소 계정에 대한 복제(예: "영역 중복")를 지정합니다. (자세한 내용은 [Azure 저장소 복제]를 참조하세요.)

1. 위의 옵션을 모두 지정한 경우 **만들기**를 클릭합니다.

## <a name="creating-a-storage-container-in-eclipse"></a>Eclipse에서 저장소 컨테이너 만들기
...
## <a name="deleting-a-storage-container-in-eclipse"></a>Eclipse에서 저장소 컨테이너 삭제
...
1. 저장소 컨테이너를 삭제할지 묻는 메시지가 표시되면 **확인**을 클릭합니다.
   ![저장소 컨테이너 삭제 대화 상자][DC02]

## <a name="deleting-a-storage-account-in-eclipse"></a>Eclipse에서 저장소 계정 삭제

Azure 탐색기를 사용하여 저장소 계정을 삭제하려면 다음 단계를 사용합니다.

1. **Azure 탐색기** 보기에서 저장소 계정을 마우스 오른쪽 단추로 클릭하고 **삭제**를 선택합니다.
   ![저장소 계정 삭제 메뉴][DS01]

1. 저장소 계정을 삭제할지 묻는 메시지가 표시되면 **확인**을 클릭합니다.
...
[Azure 저장소 복제]: /azure/storage/storage-redundancy
