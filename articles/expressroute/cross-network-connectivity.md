...
[7]: ./media/cross-network-connectivity/contosovm-routes-peering.png "VNet 피어 링 후 Contoso VM 경로"
[8]: ./media/cross-network-connectivity/fabrikamvm-routes-peering.png "VNet 피어 링 후 Fabrikam VM 경로" 8 개
[9]: ./media/cross-network-connectivity/exr-x-connect.png "연결할 expressroutes 교차 연결 후의 아키텍처" 9
...
[12]: ./media/cross-network-connectivity/contosovm-routes-xconnect.png "Exr 및 vnet를 교차 연결한 후의 12 개 Contoso VM 경로"
[13]: ./media/cross-network-connectivity/fabrikamvm-routes-xconnect.png "Exr 및 vnet를 교차 연결한 후 Fabrikam VM 경로" 13 개
[14]: ./media/cross-network-connectivity/globalreach.png "Global Reach 구성한 후의 아키텍처" 14
