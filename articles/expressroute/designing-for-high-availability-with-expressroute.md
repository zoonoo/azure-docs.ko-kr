---
title: Azure Express 경로를 사용 하 여 고가용성을 위한 설계 | Microsoft Docs
...
> [!NOTE]
> 기본 및 보조 Express 경로 연결에 대 한 NAT 옵션 1 (독립 NAT 풀)을 사용 하 고 NAT 풀 중 하나에서 온-프레미스 서버로 IP 주소의 포트를 매핑하는 경우 해당 하는 연결에 실패 합니다.
> 
