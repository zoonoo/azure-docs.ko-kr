<properties
   pageTitle="Express 경로에 대한 QoS 요구 사항 | Microsoft Azure"
...
>[AZURE.NOTE] QoS 요구 사항은 Microsoft 피어링에만 적용합니다. Azure 공용 피어링 및 Azure 개인 피어링에서 수신하는 네트워크 트래픽의 DSCP 값은 0으로 다시 설정됩니다. 
