...
| **Airtel** | 곧 출시됩니다 | 곧 출시됩니다 | 첸나이, 뭄바이 |
...
| **LG CNS** |지원됨 |지원됨 |부산 |
| **[Megaport](https://www.megaport.com/services/microsoft-expressroute/)** |지원됨 |지원됨 |시카고, 댈러스, 홍콩 특별행정구, 라스베이거스, 로스앤젤레스, 멜버른, 마이애미, 뉴욕, 퀘벡 시티, 시애틀, 싱가포르, 시드니, 토론토, 워싱턴 DC |
| **MTN** |지원됨 |지원됨 |런던 |
...
## <a name="c1partners"></a>다른 서비스 공급자를 통한 연결
