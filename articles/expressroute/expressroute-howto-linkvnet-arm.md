...
회로 소유자는 Express 경로 회로 리소스의 인증된 고급 사용자입니다. 회로 소유자는 회로 사용자가 사용할 수 있는 권한 부여를 만들 수 있습니다. 회로 사용자는 Express 경로 회로와 동일한 구독 내에 있지 않은 가상 네트워크 게이트웨이의 소유자입니다. 회로 사용자는 가상 네트워크당 하나의 권한 부여를 사용할 수 있습니다.
