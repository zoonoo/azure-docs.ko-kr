...
- 활성화된 Express 경로 회로가 있어야 합니다. 
    ...
    - 가상 네트워크 및 가상 네트워크 게이트웨이를 만들어서 완전히 프로비전해야 합니다. [VPN Gateway](../articles/vpn-gateway/vpn-gateway-create-site-to-site-rm-powershell.md)를 만들려면 지침을 따르고 `-GatewayType ExpressRoute`를 사용해야 합니다.
...
#### <a name="adding-authorizations"></a>권한 부여 추가
