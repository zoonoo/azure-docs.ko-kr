...
ms.locfileid: "51281476"
---
# <a name="expressroute-circuits-and-routing-domains"></a>ExpressRoute 회로 및 라우팅 도메인
 ExpressRoute 회로를 사용하면 연결 공급자를 통해 온-프레미스 인프라를 Microsoft에 연결할 수 있습니다. 다음 그림은 WAN 및 Microsoft 간 연결의 논리적 표현을 보여 줍니다.
