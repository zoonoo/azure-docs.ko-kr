...
|**AS 번호 요구 사항**|개인 및 공용 AS 번호. 자신의 공용 AS 번호를 소유해야 합니다. | 개인 및 공용 AS 번호. 그러나 공용 IP 주소의 소유권을 확인하려면 공용 AS 번호를 제공해야 합니다.| 개인 및 공용 AS 번호. 그러나 공용 IP 주소의 소유권을 확인하려면 공용 AS 번호를 제공해야 합니다.|
