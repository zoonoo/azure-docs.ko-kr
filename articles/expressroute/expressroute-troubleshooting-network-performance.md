...
이전 다이어그램에서 맨 왼쪽에 있는 것이 여러분의 회사 네트워크입니다. 회사 크기에 따라 이 라우팅 도메인은 여러분과 WAN 사이에 있는 몇 대의 네트워크 장치이거나 캠퍼스/엔터프라이즈 네트워크의 장치 레이어일 수 있습니다.
...
회사 네트워크 문제인 경우 내부 IT 부서 또는 네트워크를 지원하는 서비스 공급자(하드웨어 제조업체일 수도 있음)가 장치 구성 또는 하드웨어 복구를 도와줄 수 있습니다.
