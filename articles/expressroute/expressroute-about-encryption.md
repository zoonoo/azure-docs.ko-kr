...
아니요. MACsec를 구성 하 고 키가 일치 하지 않으면 Microsoft에 대 한 연결이 끊어집니다. 즉, 데이터를 노출 하는 암호화 되지 않은 연결로 대체 되지 않습니다. 
...
아니요. Azure 가상 네트워크에 타사 VPN gateway를 배포 하 고이를 온-프레미스 VPN gateway 간에 IPsec 터널을 설정 해야 합니다.
