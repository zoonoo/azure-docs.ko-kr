---
title: 'Azure ExpressRoute: 클래식 회로를 Resource Manager로 이동'
...
* 컴퓨터에 클래식 및 Az Azure PowerShell 모듈을 둘 다 로컬로 설치했는지 확인합니다. 자세한 내용은 [Azure PowerShell을 설치 및 구성하는 방법](/powershell/azure/)을 참조하세요.
