---
title: '클래식에서 리소스 관리자로 회로 이동: PowerShell: Azure | Microsoft Docs'
...
* 클래식 및 Az Azure PowerShell 모듈을 모두 컴퓨터에 로컬로 설치 했는지 확인 합니다. 자세한 내용은 [Azure PowerShell 설치 및 구성하는 방법](/powershell/azure/overview)을 참조하세요.
