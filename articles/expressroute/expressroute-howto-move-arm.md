...
## <a name="enable-an-expressroute-circuit-for-both-deployment-models"></a>두 배포 모델에 대한 Express 경로 회로 사용
...
## <a name="disable-the-expressroute-circuit-to-the-classic-deployment-model"></a>클래식 배포 모델에 대해 Express 경로 회로 사용 안 함
