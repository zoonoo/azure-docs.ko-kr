...
5. 이제 클래식 VNet에 대한 클래식 배포 모델 명령 및 Resource Manager VNet에 대한 Resource Manager 명령을 사용하여 ExpressRoute 회로에 대한 링크를 관리할 수 있습니다. 다음 문서에서는 Express 경로 회로에 대한 링크를 관리하는 방법을 안내합니다.
