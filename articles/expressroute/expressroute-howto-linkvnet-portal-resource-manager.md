...
description: "이 문서는 가상 네트워크(VNets)를 ExpressRoute 회로에 연결하는 방법에 대한 개요를 제공합니다."
...
2. 이제 연결 프로비전을 시작하여 가상 네트워크 게이트웨이를 ExpressRoute 회로에 연결할 수 있습니다. **연결** > **추가**를 클릭하여 **연결 추가** 블레이드를 연 다음 값을 구성합니다.
