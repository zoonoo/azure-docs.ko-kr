...
| **Microsoft Azure 지역** | **국가별 BGP 커뮤니티** | **저장소 BGP 커뮤니티** | **SQL BGP 커뮤니티** | **Cosmos DB BGP 커뮤니티** |
| --- | --- | --- | --- | --- |
| **북아메리카** | |
...
### <a name="service-to-bgp-community-value"></a>BGP 커뮤니티 값에는 서비스
