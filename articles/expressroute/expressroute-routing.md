...
> [!IMPORTANT]
> 공용 인터넷 및 ExpressRoute를 통해 동일한 공용 IP 경로를 보급하지 않습니다. ExpressRoute를 통해 더 특정한 경로 및 [NAT](expressroute-nat.md)에 대한 인터넷에 보다 일반적인 경로를 보급 것이 좋습니다. NAT에 대한 공용 경로 외에 ExpressRoute를 통해 Microsoft 내에서 Office 365 엔드포인트와 통신하는 온-프레미스 네트워크의 사용자가 사용하는 공용 IP 주소를 보급할 수도 있습니다. 
> 
> 
