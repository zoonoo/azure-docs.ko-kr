...
-   **Microsoft 계정**(개인 용도로 직접 생성함) - 모든 소비자 지향 Microsoft 제품 및 클라우드 서비스(예: Outlook(Hotmail), Messenger, SkyDrive, MSN, Xbox LIVE 또는 Office Live)에 액세스할 수 있습니다. Outlook에 등록하면 @Outlook.com 주소로 지정된 Microsoft 계정이 자동으로 만들어집니다. 이 Microsoft 계정을 사용하여 소비자 관련 Microsoft 클라우드 서비스 및/또는 Azure에 액세스할 수 있습니다. [자세한 정보][]
...
-   [Azure AD란?][]
-   [TechNet의 Azure AD 라이브러리][]
-   [MSDN의 Azure AD 라이브러리][]
  ...
  [**지금 등록하십시오.**]: http://go.microsoft.com/fwlink/?LinkId=269967
  [Azure AD란?]: /ko-KR/manage/services/identity/what-is-windows-azure-active-directory/
  [TechNet의 Azure AD 라이브러리]: http://technet.microsoft.com/ko-KR/library/hh967619.aspx
