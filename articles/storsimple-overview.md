...
Microsoft Azure StorSimple은 다양한 문제 및 엔터프라이즈 저장소 및 데이터 보호와 관련된 비용을 제거하는 효과적이고, 비용면에서 효율적인 관리 솔루션입니다. 클라우드 저장소를 포함하여 모든 엔터프라이즈 저장소의 원활한 뷰를 제공하는 주변 장치(Microsoft Azure StorSimple 장치) 및 통합된 관리 도구를 사용합니다.
