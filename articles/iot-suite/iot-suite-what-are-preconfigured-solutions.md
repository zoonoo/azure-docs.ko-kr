<properties
 pageTitle="미리 구성된 Azure IoT 솔루션은 무엇입니까? | Microsoft Azure"
...
Azure 구독을 사용하여 Microsoft Azure에 일반적인 IoT(사물 인터넷) 시나리오를 구현하는 미리 구성된 솔루션을 배포할 수 있습니다. 고유의 IoT 솔루션에 대한 시작 지점으로 이러한 미리 구성된 솔루션을 사용할 수 있습니다. IoT 솔루션 디자인 및 개발에서 가장 일반적인 패턴에 대해 알아봅니다.
...
사용할 수 있는 미리 구성된 솔루션은:- 원격 모니터링 - 예측 유지 관리(출시 예정)입니다.
...
### 솔루션 포털
솔루션 포털은 다음을 가능하게 하는 웹 기반 UI입니다. 원격 분석 및 대시 보드의 알람 기록 보기, 새 장치 프로비전, 장치 관리 및 모니터, 명령을 특정 장치에 전송, 규칙 및 작업 관리

참고: 솔루션 포털의 장치 보기는 DocumentDB 데이터베이스의 다양한 장치 상태 정보의 저장소와 동기화된 IoT Hub 장치 ID 레지스트리를 유지합니다.


## 다음 단계
미리 구성된 Azure IoT 솔루션 사용을 시작하려면 [미리 구성된 Azure IoT 솔루션 개요](iot-suite-overview.md) - [미리 구성된 IoT 솔루션 시작](iot-suite-getstarted-preconfigured-solutions.md)을 참조하세요.
