...
GitHub, Visual Studio 또는 다른 Git 클라이언트에서 **ZIP 다운로드** 단추를 사용하여 [GitHub MyDriving 리포지토리](https://github.com/Azure-Samples/MyDriving)의 로컬 복사본을 가져옵니다.
...
빌드 앱을 [업로드하여 시작](http://support.hockeyapp.net/kb/app-management-2/how-to-create-a-new-app)합니다. 그런 다음 개발 컴퓨터에서 [HockeyApp](https://rink.hockeyapp.net)에 로그인합니다. 개발자 대시보드에서 **새 앱**을 클릭한 다음 작성한 파일을 창으로 끕니다. (나중에 이 작업을 수행하도록 빌드 서비스를 자동화할 수 있습니다.)
...
-   PowerShell 사용:
 ...
 -   *location*은 `North Europe` 또는 `West US`와(과) 같은 [Azure 위치](https://azure.microsoft.com/regions/)입니다. `Get-AzureLocation`을(를) 사용하여 사용할 수 있는 위치의 목록을 찾을 수 있습니다.
...
## 빌드를 설정하고 Visual Studio Team Services에서 정의를 테스트합니다.
...
## Application Insights를 사용하여 원격 분석 탐색
...
>[AZURE.NOTE] Azure를 처음 접하는 경우 [무료 계정](https://azure.microsoft.com/free/)이 있습니다.
...
| [기계 학습](https://azure.microsoft.com/documentation/services/machine-learning/)<br/> 적응 응답 | $10/사용자/월. <br/> + 3h 실험 * $1 / 실험 시간. <br/> + 3.5h API CPU * $2 /프로덕션 CPU 시간. <br/> API CPU 시간은 5분/일 재학습을 가정. 단, 입력 데이터가 많아지면 증가할 수 있음. <br/> + 400주행/일을 처리하는 데 2분/일 점수. | $20 |
| [앱 서비스](https://azure.microsoft.com/pricing/details/app-service/) <br/> 모바일 백 엔드에 대한 호스트 | B1 계층--프로덕션 웹앱 | $56 |
...
| Azure 앱 서비스를 위한 [SQL 데이터베이스](https://azure.microsoft.com/pricing/details/sql-database/)| 기본 계층, 단일 데이터베이스 모델. | $5 |
| [서비스 패브릭](../service-fabric/services/service-fabric.md)(선택 사항) | 로컬 클러스터를 실행합니다. | $0 |
| [Power BI](https://powerbi.microsoft.com/pricing/)<br/> 스트리밍 및 정적 데이터에 대한 다양한 표시 및 조사| 무료 계층: 1GB, 10,000 행/시간, 매일 새로 고침 <br/> [제한 확대](https://powerbi.microsoft.com/documentation/powerbi-power-bi-pro-content-what-is-it/), 추가 연결 옵션, 공동 작업을 위해 $10/사용자/월 | $0 |
...
| [HDInsight](https://azure.microsoft.com/pricing/details/hdinsight/)(주문형 클러스터) <br/> 일일 재학습 | 매일 1시간 동안 $0.32/시간으로 3개 A3 노드 * 31일. | $30 |
