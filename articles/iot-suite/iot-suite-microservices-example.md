...
>[!div class="checklist"]
> * [로컬로 미리 구성된 원격 모니터링 솔루션 배포](../iot-accelerators/iot-accelerators-remote-monitoring-deploy-local.md)
...
![성공적인 Docker 이미지](media/iot-suite-microservices-example/successful-docker-image.png)
...
![도커 허브에 있는 도커 이미지](media/iot-suite-microservices-example/docker-image-in-docker-hub.png)
...
![New Edits Made Here postman 메시지](media/iot-suite-microservices-example/new-postman-message.png)
...
다음으로 시도할 것은 [Remote Monitoring 솔루션에서 장치 시뮬레이터 마이크로 서비스를 사용자 지정](iot-suite-remote-monitoring-test.md)하는 것입니다.
