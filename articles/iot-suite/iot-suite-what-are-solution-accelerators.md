...
원격 모니터링 솔루션 가속기의 새 버전에서는 마이크로 서비스 아키텍처를 사용합니다. 이 솔루션 가속기는 *IoT Hub 관리자* 및 *Storage 관리자*와 같은 여러 마이크로 서비스로 구성됩니다. Java 및 .NET 버전 모두의 각 마이크로 서비스는 관련된 개발자 설명서와 함께 다운로드할 수 있습니다. 마이크로 서비스에 대한 자세한 내용은 [원격 모니터링 아키텍처](iot-suite-remote-monitoring-sample-walkthrough.md)를 참조하세요.
...
* [원격 모니터링 솔루션 탐색](iot-suite-remote-monitoring-explore.md).
* [예측 유지 관리 솔루션 가속기 개요](iot-suite-predictive-overview.md).
* [연결된 팩터리 가속화 솔루션 시작](iot-suite-connected-factory-overview.md).
