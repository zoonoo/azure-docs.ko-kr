...
* [IoT 도구 모음 - 원격 모니터링 - 라이브 및 시뮬레이션된 장치 추가](https://social.technet.microsoft.com/wiki/contents/articles/32975.iot-suite-remote-monitoring-adding-live-and-simulated-devices.aspx)
