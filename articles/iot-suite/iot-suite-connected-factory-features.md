...
![연결된 팩터리 솔루션 대시보드](media/iot-suite-connected-factory-features/dashboard.png)
...
[경고의 임계값 기반 규칙을 구성합니다](iot-suite-connected-factory-configure.md).
...
- 특정 비즈니스 요구 사항을 충족하도록 솔루션을 [사용자 지정](iot-suite-v1-guidance-on-customizing-preconfigured-solutions.md)할 수 있습니다.
...
* [연결된 팩터리 미리 구성된 솔루션 연습](iot-suite-connected-factory-sample-walkthrough.md)
