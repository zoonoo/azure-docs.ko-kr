...
## <a name="finding-the-source-code"></a>소스 코드 찾기
...
## <a name="adding-your-own-rules"></a>사용자 고유 규칙 추가
...
### <a name="building-and-using-your-own-physical-device"></a>고유한 (물리적) 장치 빌드 및 사용
[Azure IoT SDK](https://github.com/Azure/azure-iot-sdks) 는 IoT 솔루션으로 다양한 장치 유형(언어 및 운영 체제)를 연결하기 위한 라이브러리를 제공합니다.

## <a name="modifying-dashboard-limits"></a>대시보드 제한 수정
