...
1. Azure Portal에서 **Cloud Shell** 단추를 클릭합니다.
    ...
    ![포털 시작 아이콘](media/iot-suite-integrate-data-lake/portal-launch-icon.png)
...
1. 개요 탭에서 **시작**을 클릭합니다.
    ...
    ![Stream Analytics 작업을 시작합니다.](media/iot-suite-integrate-data-lake/stream-analytics-start.png)
