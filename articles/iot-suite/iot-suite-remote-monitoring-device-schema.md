...
* [장치 모델 동작 구현](iot-suite-remote-monitoring-device-behavior.md)에서는 시뮬레이션된 장치의 동작을 구현하는 데 사용하는 JavaScript 파일에 대해 설명합니다.
* [새 시뮬레이션된 장치 만들기](iot-suite-remote-monitoring-test.md)에서는 장치를 만들고 새 시뮬레이션된 장치 유형을 솔루션에 배포하는 방법을 보여 줍니다.
...
장치 상태 개체를 업데이트하는 JavaScript 파일에 대한 자세한 내용은 [장치 모델 동작 이해](iot-suite-remote-monitoring-device-behavior.md)를 참조하세요.
...
장치의 동작을 구현하는 JavaScript 파일에 대한 자세한 내용은 [장치 모델 동작 이해](iot-suite-remote-monitoring-device-behavior.md)를 참조하세요.
...
이제 JSON 스키마에 대해 학습했으므로 다음 단계에서는 [시뮬레이션된 장치의 동작을 구현](iot-suite-remote-monitoring-device-behavior.md)하는 방법을 알아보는 것이 좋습니다.
