...
Microsoft는 위에서 설명한 프레임워크를 사용하여 Azure IoT에 대한 위협 모델링을 수행합니다. 아래 섹션에서는 Azure IoT 참조 아키텍처의 구체적인 예를 통해 IoT에 대한 위협 모델링을 수행하고 확인된 위협을 해결하는 방법을 보여 드리겠습니다. 이 예에서는 다음 네 가지 주요 포커스 영역이 확인되었습니다.
