...
description: "이 자습서는 azureiotsuite.com에서 미리 구성된 원격 모니터링 솔루션을 프로비전하는 방법을 보여 줍니다."
services: 
suite: iot-suite
author: dominicbetts
manager: timlt
...
이 자습서는 미리 구성된 원격 모니터링 솔루션을 프로비전하는 방법을 보여 줍니다. azureiotsuite.com에서 솔루션을 배포합니다. CLI를 사용하여 솔루션을 배포할 수도 있습니다. 이 옵션에 대해 자세히 알아보려면 [명령줄에서 미리 구성된 솔루션 배포](https://github.com/Azure/azure-iot-pcs-remote-monitoring-dotnet/wiki/Developer-Reference-Guide#deploy-a-pcs-from-the-command-line)를 참조하세요.
...
프로비전 프로세스가 완료되면 미리 구성된 원격 모니터링 솔루션에 로그인할 수 있습니다.
