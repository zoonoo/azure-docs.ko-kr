...
개인 네트워크에 있는 온-프레미스 리소스의 호스트 이름 또는 IP 주소를 지정하여 1. [하이브리드 연결을 만듭니다](#CreateHybridConnection).

하이브리드 연결에 2.	[Azure 웹 사이트 또는 Azure 모바일 서비스를 연결합니다](#LinkWebSite).

온-프레미스 리소스에 3. [하이브리드 연결 관리자를 설치](#InstallHCM)하고 특정 하이브리드 연결에 연결합니다. Azure 포털은 한 번 클릭으로 설치하고 연결할 수 있도록 합니다.

4. [하이브리드 연결을 관리](#ManageHybridConnection)하고 연결 키를 관리합니다.
...
**웹 사이트를 사용하여 하이브리드 연결을 만들려면** [Azure 웹 사이트를 온-프레미스 리소스에 연결](http://go.microsoft.com/fwlink/p/?LinkId=397538)을 참조하세요.
...
<br/>기존 BizTalk 서비스가 없는 경우 [BizTalk 서비스](http://go.microsoft.com/fwlink/p/?LinkID=329870)를 만들 수 있습니다.
3. 하이브리드 연결 탭을 선택합니다.
<br/>
...
- 하이브리드 연결을 여러 개 만들 수 있습니다. 허용되는 연결 수는 [BizTalk 서비스: Editions 차트](http://go.microsoft.com/fwlink/p/?LinkID=302279)를 참조하세요. 
...
<br/>
<br/>
**다시 생성을 선택하면** 연결 문자열에 사용된 공유 액세스 키가 변경됩니다. 다음을 수행합니다.
...
- [BizTalk 서비스: Editions 차트](http://go.microsoft.com/fwlink/p/?LinkID=302279)<br/>
- [Azure 관리 포털을 사용하여 BizTalk 서비스 만들기](http://go.microsoft.com/fwlink/p/?LinkID=302280)<br/>
