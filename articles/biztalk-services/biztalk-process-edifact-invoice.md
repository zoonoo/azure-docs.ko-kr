...
5.  자습서 클라이언트를 실행 상태로 둡니다. 열고 **서비스 버스** > **_서비스 버스 네임스페이스_** > **큐**를 클릭하고 세 개의 큐가 생성되었는지 확인합니다.
...
8.  구성 세부 정보를 포함하도록 EDIBridge.config 파일 업데이트
    ...
    *   _<behaviors>_ 아래에서 BizTalk 서비스 구독에 연결된 ACS 네임스페이스 및 키를 제공합니다.

    *   _<client>_ 아래에서 EDI 송신 규약이 배포되는 끝점을 제공합니다.
