...
Azure HDInsight에서 Microsoft R Server는 R 기반 분석을 위한 최신 기능을 제공합니다.  [Azure Blob](../storage/storage-introduction.md "Azure Blob 저장소") 저장소 계정 또는 로컬 Linux 파일 시스템에 있는 컨테이너의 HDFS에 저장된 데이터를 사용합니다. R Server가 오픈 소스 R을 기반으로 하기 때문에 빌드한 R 기반 응용 프로그램은 8000개 이상의 오픈 소스 R 패키지를 활용할 수 있습니다. R 서버와 함께 포함된 Microsoft의 빅 데이터 분석 패키지인 [ScaleR](http://www.revolutionanalytics.com/revolution-r-enterprise-scaler "Revolution Analytics ScaleR")에서 루틴을 활용할 수도 있습니다.  
