...
ASM(Azure 서비스 관리)를 사용하여 HDInsight와 함께 사용하도록 Azure CLI에서 제공한 기본 명령은 ARM을 사용하는 경우와 동일합니다. 그러나 일부 매개 변수 및 스위치는 이름이 다를 수 있고 ARM을 사용하는 경우 많은 새 매개 변수를 사용할 수 있습니다. 예를 들어 이제 `azure hdinsight cluster create`을 사용하여 클러스터를 만들어야 할 Azure Virtual Network 또는 Hive 및 Oozie 메타저장소 정보를 지정할 수 있습니다.
...
## <a name="migrating-to-the-arm-based-hdinsight-net-sdk"></a>ARM 기반 HDInsight .NET SDK로 마이그레이션
