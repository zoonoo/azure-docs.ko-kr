---
title: Azure HDInsight 사용 중지 된 버전
...
## <a name="retired-version-list"></a>사용 중지 된 버전 목록

다음 표에는 사용 중지 된 HDInsight 버전이 나와 있습니다.
...
- [HDInsight에서 지원 되는 Apache 구성 요소 및 버전](./hdinsight-component-versioning.md)
