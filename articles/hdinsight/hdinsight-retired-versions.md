---
title: Azure HDInsight 사용 중지된 버전
...
이 문서에서는 HDInsight의 사용 중지된 버전에 대해 알아봅니다.

## <a name="retired-version-list"></a>사용 중지된 버전 목록

다음 표에는 HDInsight의 사용 중지된 버전이 열거됩니다.
...
- [HDInsight의 지원되는 Apache 구성 요소 및 버전](./hdinsight-component-versioning.md)
