---
title: Linux, Unix 또는 OS X에서 Linux 기반 HDInsight의 SSH 키 사용 | Microsoft Docs
...
**SSH 공개 키**를 선택하는 경우 확장명이 **.pub**인 파일에 포함된 공개 키를 **SSH 공개 키** 필드에 붙여 넣거나 __파일 선택__을 선택하여 공개 키 파일을 찾아 선택할 수 있습니다.
