...
> [!Note]
> ACID/트랜잭션 지원은 외부 테이블이 아닌 관리 되는 테이블에 대해서만 작동 합니다. Hive 외부 테이블은 외부 당사자가 기본 데이터를 변경 하지 않고 테이블 데이터를 읽고 쓸 수 있도록 설계 되었습니다. ACID 테이블의 경우 Hive는 compactions 및 트랜잭션으로 기본 데이터를 변경할 수 있습니다.
...
* Azure Data Lake Storage Gen2 Spark 클러스터에 Jupyter 노트북을 저장할 수 없습니다.
