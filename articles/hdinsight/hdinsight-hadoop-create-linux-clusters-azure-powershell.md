...
[Azure 파워쉘](/powershell/azure/install-Az-ps) Az 모듈.
...
cmdlet을 사용하여 [`New-AzHDInsightClusterConfig`](https://docs.microsoft.com/powershell/module/az.hdinsight/new-azhdinsightclusterconfig) HDInsight 구성 개체를 만들 수도 있습니다. 그런 다음 이 구성 개체를 수정하여 클러스터에 대한 추가 구성 옵션을 사용하도록 설정합니다. 마지막으로 cmdlet의 `-Config` [`New-AzHDInsightCluster`](https://docs.microsoft.com/powershell/module/az.hdinsight/new-azhdinsightcluster) 매개 변수를 사용하여 구성을 사용합니다.
...
HDInsight 클러스터를 성공적으로 만들었으니 다음 리소스를 사용하여 클러스터 를 사용하는 방법을 알아봅니다.
