...
[HBase 복제는](https://hbase.apache.org/book.html#_cluster_replication) 원본 클러스터에서 최소한의 오버헤드로 비동기 메커니즘을 사용하여 원본 클러스터에서 대상 클러스터로 트랜잭션을 자동으로 푸시합니다. HDInsight에서 다음과 같은 클러스터 간에 복제를 설정할 수 있습니다.
