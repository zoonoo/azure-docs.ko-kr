...
covered 인덱스는 인덱싱된 값 외에도 행의 데이터를 포함하는 인덱스입니다. 원하는 인덱스 항목을 찾은 후에는 기본 테이블에 액세스할 필요가 없습니다.
...
`19805`에 대 한 항공편 id를 사용 하 여 항공편을 선택 하려면 다음을 수행 합니다. 여기서 항공편 lineid는 기본 키 또는 인덱스에 없는 필드입니다.
