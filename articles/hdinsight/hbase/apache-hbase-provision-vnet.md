...
[Azure Virtual Network](https://azure.microsoft.com/services/virtual-network/)에서 Azure HDInsight Apache HBase 클러스터를 만드는 방법에 대해 알아봅니다.
...
>
> `CLUSTERNAME`은 템플릿을 사용할 때 사용자가 제공 하는 클러스터 이름으로 바뀝니다.
...
1. 165 줄에서 값 `Standard_A3` `Standard_A4_V2`로 변경 합니다. 그런 다음 **저장**을 선택합니다.
...
### <a name="obtain-fully-qualified-domain-name"></a>정규화 된 도메인 이름 가져오기
...
이 문서에서는 Apache HBase 클러스터를 만드는 방법을 알아보았습니다. 자세한 내용은 다음을 참조하세요.
