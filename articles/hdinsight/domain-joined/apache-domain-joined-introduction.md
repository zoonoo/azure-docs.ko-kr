...
> [!NOTE]
> 이 아티클에서 설명하는 새 기능은 Hadoop, Spark 및 대화형 쿼리와 같은 클러스터 형식에서만 미리 보기로 사용할 수 있습니다.
...
* [도메인에 가입된 HDInsight 클러스터 계획](apache-domain-joined-architecture.md)
