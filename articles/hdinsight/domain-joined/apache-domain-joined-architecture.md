...
![도메인에 가입된 HDInsight 클러스터 토폴로지](./media/apache-domain-joined-architecture/hdinsight-domain-joined-architecture_2.png)
...
![도메인에 가입된 HDInsight 클러스터 토폴로지](./media/apache-domain-joined-architecture/hdinsight-domain-joined-architecture_1.png)
