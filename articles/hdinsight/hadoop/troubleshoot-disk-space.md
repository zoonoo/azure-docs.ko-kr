...
1. **Hive** > **Configs**Configs > **Advanced**고급 > **고급 hive-log4j**로 이동 합니다. 다음 설정을 검토 합니다.
...
* Apache Ambari
    ...
    1. **Hive** > **Configs**Configs > **Advanced**고급 > **리소스 관리자**로 이동 합니다. **로그 집계 사용** 이 선택 되어 있는지 확인 합니다. 사용 하지 않도록 설정 된 경우 이름 노드는 로컬에서 로그를 유지 하 고 응용 프로그램 완료 또는 종료 시 원격 저장소에서 집계 하지 않습니다.
