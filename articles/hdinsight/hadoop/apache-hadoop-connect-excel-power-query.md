...
* **HDInsight 클러스터**. 하나를 구성 하려면 [Azure HDInsight 시작](./apache-hadoop-linux-tutorial-get-started.md)을 참조 하세요.
* **워크스테이션** .
...
4. **Windows에서 Azure File Storage 시작** 이 계정은 기본 저장소 계정 또는 연결 된 저장소 계정일 수 있습니다.  형식은 *https://&lt;StorageAccountName>.blob.core.windows.net/* 입니다.
