...
3. **새 프로젝트 만들기** 창에서로 스크롤하고 **콘솔 앱 (.NET Framework)** 템플릿 ( C# 버전)을 선택 합니다. 그런 후 **다음**을 선택합니다.
...
5. **제출** 을 선택 하 여 HDInsight 클러스터에 작업을 제출 합니다. **Hive 작업 요약** 창이 열립니다.
