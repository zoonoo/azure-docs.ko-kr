...
ODBC 드라이버를 사용할 응용 프로그램 버전과 일치 하는 [Microsoft Hive ODBC Driver](https://go.microsoft.com/fwlink/?LinkID=286698) 버전을 다운로드 하 여 설치 합니다.  이 문서에서는 Office Excel 용 드라이버를 사용 합니다.
