---
title: PowerShell 및 Azure HDInsight를 사용하여 Sqoop 작업 실행
...
Azure PowerShell을 통해 Azure HDInsight에서 Sqoop 작업을 실행하여 HDInsight 클러스터와 Azure SQL 데이터베이스 또는 SQL Server 데이터베이스 간에 가져오기 및 내보내기를 수행하는 방법에 대해 알아봅니다.
