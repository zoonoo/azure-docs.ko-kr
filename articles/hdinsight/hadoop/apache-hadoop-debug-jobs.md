...
* **설명**: Azure Storage 위치인 *dataRegionName* 이(가) 올바른 위치가 아닙니다. 지역이 올바른지 확인하고 요청을 다시 시도하세요.
...
* **설명**: 외부 스토리지 계정 blob 컨테이너 이름 *yourContainerName* 이(가) 잘못되었습니다. 이름이 문자로 시작되며 이름에 소문자, 숫자 및 대시만 포함되어 있는지 확인하세요.  
