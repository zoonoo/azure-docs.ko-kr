...
파워 쿼리는 [www.microsoft.com/en-us/download/details.aspx?id=39379](http://www.microsoft.com/en-us/download/details.aspx?id=39379)에서 설치될 수 있습니다. 시스템 요구 사항은 다운로드 페이지를 참조하세요.
...
4. **저장소 계정은**, 클러스터에 대한 기본 저장소 계정, **테이블**을 차례로 확장합니다.
...
## <a name="logs-written-to-azure-blob-storage"></a>Azure Blob 저장소에 기록된 로그
