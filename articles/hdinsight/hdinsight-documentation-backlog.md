<properties
   pageTitle="Azure HDInsight 설명서 백로그 | Microsoft Azure"
   description="게시하려는 HDInsight 도움말 문서 보기 및 등급 지정"
...
# Azure HDInsight 설명서 백로그

이 페이지에는 Azure HDInsight에 대해 게시 예정인 문서 또는 문서 업데이트가 나와 있습니다. 이 문서에 의견을 추가하거나 이 문서를 업데이트하여(GitHub 끌어오기 요청 사용) 문서에 할당된 우선 순위를 변경할 경우 알려주시기 바랍니다.

## 설명서 백로그

영역 |항목 | 우선 순위 | 상태 | 할당 대상 | 요청자 
------------- | ------------- | -------------- | -------------- | --------------- | --------------
관리 | .NET SDK를 사용하는 관리자 HDInsight 클러스터 | 1 | [완료됨](hdinsight-administer-use-dotnet-sdk.md) | [@mumian](https://github.com/mumian) | - | 
...
개발 | Sqoop를 사용하는 Curl 및 Rest API 샘플 | 2 | [완료됨](hdinsight-hadoop-use-sqoop-curl.md) | [@mumian](https://github.com/mumian) | Jon Kennerly | 
개발 | [HDInsight .NET 응용 프로그램으로 비대화형 인증](hdinsight-create-non-interactive-authentication-dotnet-applications.md) |2| [완료됨](hdinsight-create-non-interactive-authentication-dotnet-applications.md) | [@mumian](https://github.com/mumian) | [@matt1883](https://github.com/matt1883)
