...
3. 규칙을 만들면 다음을 사용하여 서브넷에 대한 새 네트워크 보안 그룹에 적용합니다. **RESOURCEGROUPNAME** 을 Azure 가상 네트워크를 포함하는 리소스 그룹 이름으로 바꿉니다. **VNETNAME** 및 **SUBNETNAME**을 Azure Virtual Network의 이름 및 HDInsight를 설치할 때 사용할 서브넷의 이름으로 바꿉니다.
