...
1. **저장소 계정 만들기** 화면에서 다음을 수행 합니다.
    ...
    1. Data Lake Storage Gen2 계정의 이름을 입력 합니다.
    1. **고급** 탭을 클릭 합니다.
