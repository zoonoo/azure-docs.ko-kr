---
title: Hadoop 샌드박스를 사용하여 Hadoop에 대해 자세히 알아보기 | Microsoft Docs
...
## 가상 컴퓨터 다운로드 및 설치
1. [http://hortonworks.com/downloads/#sandbox](http://hortonworks.com/downloads/#sandbox)의 Hortonworks Sandbox에서 HDP 2.4에 대한 **VIRTUALBOX 다운로드** 항목을 선택합니다. 다운로드가 시작되기 전에 Hortonworks를 등록하라는 메시지가 표시됩니다.
...
## 가상 컴퓨터 시작합
1. VirtualBox를 시작하고 Hortonworks Sandbox를 선택한 다음 **시작**, __일반 시작__을 차례로 선택합니다.
...
## 암호 설정
1. Hortonworks Sandbox 페이지의 **시작** 단계에서 __보기 고급 옵션__을 선택합니다. SSH를 사용하여 샌드박스에 로그인하는 이 페이지에 대한 정보를 사용합니다. 제공된 이름 및 암호를 사용합니다.
   
   > [!NOTE]
   > 대신 SSH 클라이언트를 설치하지 않은 경우 \_\_http://localhost:4200/__의 가상 컴퓨터에 제공된 웹 기반 SSH을 사용할 수 있습니다.
   > 
   > 
