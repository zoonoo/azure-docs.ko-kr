---
title: HDFS 호환 가능 Blob 저장소에서 데이터 쿼리 | Microsoft Docs
...
> [!NOTE]
> HDInsight 3.0 이전 버전에서 `wasb://` 대신에 `asv://`을 사용합니다.`asv://`을 HDInsight 클러스터 3.0 이상과 함께 사용하면 오류가 발생하므로 함께 사용하지 않습니다.
> 
> 
