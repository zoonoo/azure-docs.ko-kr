...
---
# <a name="use-azure-data-lake-store-with-apache-storm-with-hdinsight"></a>HDInsight에서 Apache Storm으로 Azure 데이터 레이크 저장소 사용
...
* **ADLStoreBolt**: [HdfsBolt](http://storm.apache.org/javadoc/apidocs/org/apache/storm/hdfs/bolt/HdfsBolt.html) 구성 요소를 사용하여 Azure Data Lake 저장소에 데이터를 작성합니다.
...
* **[Azure Portal](https://portal.azure.com)**에서: 포털에서 HDInsight와 함께 사용하는 Azure Data Lake 저장소를 선택합니다.
