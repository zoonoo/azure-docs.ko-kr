...
HDInsight 클러스터는 Azure 저장소 계정에서 Azure 리소스 그룹 및 Blob 컨테이너가 필요합니다.
...
3. 새 리소스 그룹 만들기:
	...
	New-AzureResourceGroup -name <AzureResourceGroupName> -Location <AzureDataCente> # 예를 들어 "West US"
