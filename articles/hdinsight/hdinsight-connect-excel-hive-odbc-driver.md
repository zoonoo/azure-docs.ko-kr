---
title: "Hive ODBC 드라이버로 Hadoop에 Excel 연결 | Microsoft 문서"
...
---
# <a name="connect-excel-to-hadoop-with-the-microsoft-hive-odbc-driver"></a>Microsoft Hive ODBC 드라이버로 Hadoop에 Excel 연결
