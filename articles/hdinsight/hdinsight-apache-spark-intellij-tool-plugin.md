...
1. HDInsight Spark 클러스터에서 응용 프로그램 실행
   ...
   2. Azure 구독 자격 증명을 입력하라는 메시지가 표시됩니다. **Spark 제출** 대화 상자에 다음 값을 제공합니다.
      ...
      * **주 클래스 이름** 텍스트 상자에서 줄임표(![ellipsis](./media/hdinsight-apache-spark-intellij-tool-plugin/ellipsis.png))를 클릭하고 응용 프로그램 소스 코드에서 주 클래스를 선택한 다음 **확인**을 클릭합니다.
...
### <a name="access-the-job-view-directly-from-the-hdinsight-tools"></a>HDInsight 도구에서 직접 작업 보기에 액세스
...
3. 선택한 응용 프로그램을 기준으로 **오류 메시지**, **작업 출력**, **Livy 작업 로그** 및 **Spark 드라이버 로그** 상자가 채워집니다.
