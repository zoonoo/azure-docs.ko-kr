...
![작업 영역 로그 블레이드 ' 사용할 수 없는 컴퓨터 ' 샘플 Log Analytics](media/hdinsight-cluster-availability/portal-unavailable-computers.png)
...
![경고 규칙 새 작업 그룹 만들기](media/hdinsight-cluster-availability/portal-create-new-action-group.png)
...
![경고 규칙 만들기 추가 작업 그룹](media/hdinsight-cluster-availability/portal-add-action-group.png)
...
![포털 경고 규칙 만들기 완료](media/hdinsight-cluster-availability/portal-create-alert-rule-finish.png)
