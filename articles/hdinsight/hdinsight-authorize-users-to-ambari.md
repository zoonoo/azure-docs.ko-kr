...
1. 관리 페이지에서, 왼쪽에 있는 **Views** 메뉴 머리글 아래에서 **보기** 연결을 선택합니다.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/apache-ambari-views-link.png" alt-text="Apache Ambari 뷰 링크 보기":::
...
1. 사용자를 추가하려면 **사용자 추가** 단추를 선택합니다.
   ...
   * 변경 내용을 저장하려면 **파란색 확인란** 을 선택합니다.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/user-entered-permissions.png" alt-text="Apache Ambari grant 사용자 권한":::
...
1. 그룹을 추가하려면 **그룹 추가** 단추를 선택합니다.
   ...
   * 변경 내용을 저장하려면 **파란색 확인란** 을 선택합니다.
     ...
     :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-group-entered.png" alt-text="Apache Ambari grant 권한":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-roles-block-view.png" alt-text="Apache Ambari roles 블록 보기":::
...
* 목록 보기의 사용자 범주에는 모든 사용자 목록이 표시되므로 드롭다운 목록에서 각 사용자의 역할을 선택할 수 있습니다.
    ...
    :::image type="content" source="./media/hdinsight-authorize-users-to-ambari/roles-list-view-users.png" alt-text="Apache Ambari 역할 목록 뷰-사용자":::
...
:::image type="content" source="./media/hdinsight-authorize-users-to-ambari/ambari-user-views-only.png" alt-text="뷰만 있는 Apache Ambari 사용자":::
