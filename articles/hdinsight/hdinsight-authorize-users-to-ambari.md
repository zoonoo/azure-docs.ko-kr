...
사용자 Active Directory 도메인 자격 증명을 사용 하 여 클러스터 노드에 로그인 할 수 있습니다. 또한 해당 도메인 자격 증명을 사용 하 여 [색상](https://gethue.com/), Ambari 보기, ODBC, JDBC, POWERSHELL 및 REST api와 같은 다른 승인 된 끝점과 클러스터 상호 작용을 인증할 수 있습니다.
