...
### 1단계: 만든 SSH 사용자를 사용하여 에지 노드에 로그인
...
### 3단계: 만든 사용자를 통해 RStudio Community 버전 사용
...
## HDInsight 작업자 노드에서 Microsoft R Server 조작화 계산 노드를 확장하는 방법
...
### 서비스 해제된 작업자 노드 각각에 Compute 노드 구성
