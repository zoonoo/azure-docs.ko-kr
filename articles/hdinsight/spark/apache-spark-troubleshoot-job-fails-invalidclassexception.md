...
이 오류는 `spark.yarn.jars` 구성에 추가 jar을 추가 하 여 발생할 수 있습니다. 특히, 다른 버전의 `commons-lang3` 패키지를 포함 하는 음영이 있는 jar를 추가 하 고 클래스 불일치를 소개 합니다. 기본적으로 Spark 2.1/2/3은 버전 3.5를 사용 `commons-lang3`합니다.
