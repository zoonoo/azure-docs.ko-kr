...
대신 Spark-HBase 커넥터를 사용해야 합니다. 자세한 내용은 [Spark-HBase 커넥터 사용 방법](/archive/blogs/azuredatalake/hdinsight-how-to-use-spark-hbase-connector)을 참조하세요.
