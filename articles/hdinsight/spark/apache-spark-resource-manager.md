...
Apache Ambari를 사용하여 클러스터를 모니터링하고 구성을 변경할 수 있습니다. 자세한 내용은 [Azure Portal을 사용하여 HDInsight의 Hadoop 클러스터 관리](../hdinsight-administer-use-portal-linux.md#open-the-ambari-web-ui)를 참조하세요.
