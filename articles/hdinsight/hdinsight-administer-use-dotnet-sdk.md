...
* Apache Storm
  ...
  * 명령줄 인터페이스(CLI) 도구
    ...
    :::image type="content" source="./media/hdinsight-administer-use-powershell/hdinsight-portal-scale-cluster-storm-rebalance.png" alt-text="HDInsight 스톰 규모 균형 재조정":::
