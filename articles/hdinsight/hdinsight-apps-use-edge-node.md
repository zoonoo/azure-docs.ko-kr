...
빈 에지 노드를 기존 HDInsight 클러스터에 추가할 수 있습니다(클러스터를 만들 때는 새 클러스터에 추가). 빈 에지 노드는 Azure 리소스 관리자 템플릿을 사용하여 추가합니다.  다음 예제는 템플릿을 사용하여 추가하는 방법을 보여 줍니다.
...
이 섹션에서는 리소스 관리자 템플릿을 사용하여 기존 HDInsight 클러스터에 에지 노드를 추가합니다.  리소스 관리자 템플릿은 [GitHub](https://azure.microsoft.com/en-us/resources/templates/101-hdinsight-linux-add-edge-node/)에서 찾을 수 있습니다. 리소스 관리자 템플릿은 https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/101-hdinsight-linux-add-edge-node/scripts/EmptyNodeSetup.sh에 있는 스크립트 동작을 호출합니다. 스크립트는 어떤 작업도 수행하지 않습니다.  리소스 관리자 템플릿에서 스크립트 호출 작업을 보여 주기 위한 것입니다.
...
2. Azure에 로그인하여 Azure Portal에서 Azure 리소스 관리자 템플릿을 열려면 다음 이미지를 클릭합니다. 
...
이 섹션에서는 리소스 관리자 템플릿을 사용하여 에지 노드로 HDInsight 클러스터를 만듭니다.  리소스 관리자 템플릿은 [Azure 빠른 시작 템플릿 갤러리](https://azure.microsoft.com/documentation/templates/101-hdinsight-linux-with-edge-node/)에서 찾을 수 있습니다. 리소스 관리자 템플릿은 https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/101-hdinsight-linux-with-edge-node/scripts/EmptyNodeSetup.sh에있는 스크립트 동작을 호출합니다. 스크립트는 어떤 작업도 수행하지 않습니다.  리소스 관리자 템플릿에서 스크립트 호출 작업을 보여 주기 위한 것입니다.
...
* [리소스 관리자 템플릿을 사용하여 HDInsight의 Linux 기반 Hadoop 클러스터 만들기](hdinsight-hadoop-create-linux-clusters-arm-templates.md): 리소스 관리자 템플릿을 호출하여 HDInsight 클러스터를 만드는 방법을 알아봅니다.
