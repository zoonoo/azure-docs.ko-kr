...
3. 다음 스크립트를 복사하여 스크립트 창에 붙여 넣습니다.  
   ...
   > [!NOTE]
   > 스크립트는 REST(representational state transfer) 서비스 http://bot.whatismyipaddress.com을 사용하여 외부 IP 주소를 검색합니다. IP 주소는 SQL 데이터베이스 서버용 방화벽 규칙을 만드는 데 사용됩니다.
