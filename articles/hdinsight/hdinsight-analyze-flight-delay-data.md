---
title: HDInsight의 Hadoop을 사용하여 비행 지연 데이터 분석 | Microsoft Docs
...
1. SQL 데이터베이스에 연결하고 AvgDelays 테이블에서 도시별 평균 비행 지연을 확인합니다.
...
3. 다음 스크립트를 복사하여 스크립트 창에 붙여 넣습니다.
   ...
   > [!NOTE]
   > 스크립트는 REST(Representational State Transfer) 서비스(http://bot.whatismyipaddress.com)를 사용하여 외부 IP 주소를 검색합니다. IP 주소는 SQL 데이터베이스 서버용 방화벽 규칙을 만드는 데 사용됩니다.
   > 
   > 
