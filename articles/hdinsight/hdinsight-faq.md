...
지원 되는 구성 요소 목록은 [HDInsight에서 사용할 수 있는 Apache Hadoop 구성 요소 및 버전](./hdinsight-component-versioning.md) 을 참조 하세요.
...
Blob storage 계정을 감사 하려면 [Azure Portal에서 저장소 계정 모니터링의](../storage/common/manage-storage-analytics-logs.md)절차를 사용 하 여 모니터링을 구성 합니다. HDFS 감사 로그는 로컬 HDFS 파일 시스템에 대해서만 감사 정보를 제공 합니다 (hdfs://mycluster).  원격 저장소에서 수행 되는 작업은 포함 되지 않습니다.
