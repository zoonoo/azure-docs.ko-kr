...
* Power BI 사용
    ...
    [Azure HDInsight에서 Power BI를 사용하여 빅 데이터 시각화](./hdinsight-connect-hive-power-bi.md)를 참조하세요.
...
* Visual Studio 사용
    ...
    [Data Lake Tools for Visual Studio를 사용하여 Azure HDInsight에 연결 및 Hive 쿼리 실행](hdinsight-hadoop-visual-studio-tools-get-started.md#run-a-hive-query)을 참조하세요.
...
* Ambari Hive 보기를 사용하여 Hive 실행
    ...
    [Azure HDInsight에서 Hadoop과 Hive 보기 사용](hdinsight-hadoop-use-hive-ambari-view.md)을 참조하세요.
* Beeline을 사용하여 Hive 실행
  
    [Beeline를 사용하여 HDInsight에서 Hadoop과 Hive 사용](hdinsight-hadoop-use-hive-beeline.md)을 참조하세요.
...
* Hive ODBC를 사용하여 Hive 실행
    ...
    [Microsoft Hive ODBC Driver로 Hadoop에 Excel 연결](hdinsight-connect-excel-hive-odbc-driver.md)을 참조하세요.
