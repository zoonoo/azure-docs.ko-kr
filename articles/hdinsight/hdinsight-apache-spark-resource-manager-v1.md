...
2. Spark 클러스터 블레이드에서 **대시보드**를 클릭합니다. 메시지가 표시되면 Spark 클러스터에 대한 관리자 자격 증명을 입력합니다.
	...
	![리소스 관리자 시작](./media/hdinsight-apache-spark-resource-manager-v1/hdispark.cluster.launch.dashboard.png "리소스 관리자 시작")
...
1. **Spark 대시보드**에서 **Spark UI** 탭을 클릭하여 응용 프로그램에 할당할 수 있는 최대 코어 수 및 최대 RAM을 확인합니다.
	...
	![리소스 할당](./media/hdinsight-apache-spark-resource-manager-v1/hdispark.ui.resource.png "Spark 클러스터에 할당된 리소스 찾기")
	...
	![응용 프로그램 실행](./media/hdinsight-apache-spark-resource-manager-v1/hdispark.ui.running.apps.png "클러스터에서 실행 중인 응용 프로그램")

	
2. HDInsight Spark 대시보드에서 **리소스 관리자** 탭을 클릭하고 **기본 응용 프로그램 코어 수** 및 **작업자 노드당 기본 실행자 메모리**에 대한 값을 지정합니다. 다른 속성을 0으로 설정합니다.

	![리소스 할당](./media/hdinsight-apache-spark-resource-manager-v1/hdispark.ui.allocate.resources.png "응용 프로그램에 리소스 할당")
...
![리소스 할당](./media/hdinsight-apache-spark-resource-manager-v1/hdispark.ui.no.thrift.png "Thrift 서버에 리소스 없음")
