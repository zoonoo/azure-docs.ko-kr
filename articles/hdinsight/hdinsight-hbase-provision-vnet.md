...
기본적으로 가상 네트워크에서는 Azure에서 제공하는 내부 DNS(Domain Name System) 서버를 사용합니다. 사용자 지정 DNS 서버가 포함된 고급 네트워킹 구성도 지원됩니다. 자세한 지침이 필요하면 [이름 확인(DNS)](http://msdn.microsoft.com/library/azure/jj156088.aspx)을 참조하세요.
