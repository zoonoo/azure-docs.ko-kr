---
title: "Microsoft Avro Library로 데이터 직렬화 | Microsoft 문서"
...
### <a name="a-namescenario1asample-1-serialization-with-reflection"></a><a name="Scenario1"></a>샘플 1: 리플렉션을 사용한 직렬화
