...
> [!Note]
> Powershell 및 기타 스크립트에서 사용할 SKU 식별자를 가져오려면 아래 표에 있는 모든 `Standard_` VM sku의 시작 부분에를 추가 합니다. 예를 들어 `D12_v2` ,가 `Standard_D12_v2`가 됩니다.
...
\*= Spark Enterprise Security Package (ESP) 클러스터의 VM 크기
