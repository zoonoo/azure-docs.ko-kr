...
ms.openlocfilehash: 109c0fefef3b30b5c23163ada99bb66f6f82b097
...
* __Spark__: Apache Spark는 Hive로 작업하기 위한 기본 제공 기능입니다. 자세한 내용은 [HDInsight의 Spark로 시작](hdinsight-apache-spark-jupyter-spark-sql.md) 문서를 참조하세요.

* __HBase__: HiveQL은 HBase에 저장된 데이터를 쿼리하는 데 사용할 수 있습니다. 자세한 내용은 [HDInsight의 HBase로 시작](hdinsight-hbase-tutorial-get-started-linux.md) 문서를 참조하세요.
...
HiveQL 언어 참조는 [언어 설명서(https://cwiki.apache.org/confluence/display/Hive/LanguageManual)](https://cwiki.apache.org/confluence/display/Hive/LanguageManual)에서 확인할 수 있습니다.
