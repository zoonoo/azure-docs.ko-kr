...
1. Log Analytics 작업 영역을 만듭니다. 자세한 내용은 [Log Analytics 작업 영역 시작](../log-analytics/log-analytics-get-started.md) 문서를 참조하세요.

2. HDInsight 클러스터에서 Kafka를 만듭니다. 자세한 내용은 [HDInsight에서 Apache Kafka 시작](hdinsight-apache-kafka-get-started.md) 문서를 참조하세요.
 ...
 * [HDInsight 클러스터 간 Kafka 미러링](hdinsight-apache-kafka-mirroring.md)
 * [HDInsight의 Kafka 확장성 개선](hdinsight-apache-kafka-scalability.md)
