...
이러한 경우 클러스터를 만든 후에 스크립트 작업을 통해 추가 패키지를 설치할 수 있습니다. 자세한 내용은 [R 서버를 사용하여 HDInsight 클러스터 만들기](hdinsight-hadoop-r-server-get-started.md)를 참조하세요.   
