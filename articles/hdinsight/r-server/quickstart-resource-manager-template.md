...
이 빠른 시작에서 사용되는 템플릿은 [Azure 빠른 시작 템플릿](https://azure.microsoft.com/resources/templates/101-hdinsight-rserver/)에서 나온 것입니다.
...
1. 다음 값을 입력하거나 선택합니다.
    ...
    ![Resource Manager 템플릿 HBase 배포](./media/quickstart-resource-manager-template/resource-manager-template-rserver.png)
