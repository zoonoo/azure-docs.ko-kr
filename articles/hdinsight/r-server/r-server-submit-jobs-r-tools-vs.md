...
1. HDInsight의 ML 서비스에 지 노드 주소는 `CLUSTERNAME-ed-ssh.azurehdinsight.net` 됩니다. 여기서 `CLUSTERNAME`은 ML 서비스 클러스터의 이름입니다.
...
1. R 대화형 창에서 다음 명령을 실행합니다.
    ...
    ![성공한 rx 명령 실행을](./media/r-server-submit-jobs-r-tools-vs/successful-rx-commands.png)
