...
3. 제출 `newconfig.json`.  
   다음 명령을 사용하여 업데이트된 구성을 Ambari에 제출합니다.
    ...
    이러한 명령은 **newconfig** 파일의 내용을 새 구성으로 클러스터에 제출 합니다. 이 요청은 JSON 문서를 반환합니다. 이 문서의 **versionTag** 요소는 제출한 버전과 일치해야 하며, **configs** 개체에는 요청한 구성 변경 내용이 포함됩니다.
