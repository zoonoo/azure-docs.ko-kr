---
title: HDInsight용 Visual Studio Hadoop 도구를 사용하는 방법 알아보기 | Microsoft Docs
...
* 다음 소프트웨어가 설치된 워크스테이션
  ...
  * Visual Studio(다음 버전 중 하나)
    ...
    * Visual Studio 2015(Community/Enterprise)
    ...
    > [!NOTE]
    > 현재 Visual Studio용 HDInsight 도구는 영어 버전으로만 제공됩니다.
    > 
    > 
...
3. **Azure**를 확장한 다음 **HDInsight**를 확장합니다.
   ...
   > [!NOTE]
   > **HDInsight 작업 목록** 창이 열립니다. 이 창이 표시되지 않는 경우 **보기** 메뉴에서 **다른 창**을 클릭한 후 **HDInsight 작업 목록 창**를 클릭합니다.
   > 
   > 
