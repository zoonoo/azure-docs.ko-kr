...
HDInsight 클러스터 및 종속 Azure 저장소 계정을 만들기 위한 ARM 템플릿은 [부록 A]()에서 찾을 수 있습니다. 텍스트 편집기를 사용하여 워크스테이션의 파일에 템플릿을 저장합니다. 다양한 도구를 사용하여 템플릿을 호출하는 방법을 알아봅니다.
