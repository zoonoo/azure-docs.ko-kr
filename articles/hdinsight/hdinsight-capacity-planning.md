...
* [Hadoop, Spark, Kafka 등으로 HDInsight에서 클러스터를 설정](hdinsight-hadoop-provision-linux-clusters.md): Hadoop, Spark, Kafka, Interactive Hive, HBase, R Server 또는 Storm을 사용하여 HDInsight에서 클러스터를 설정 및 구성하는 방법을 알아보세요.
