...
**Actions** 메뉴에서 경고 알림을 생성할 수도 있습니다. 이렇게 하면 특정 경고/심각도 조합이 발생할 때 **EMAIL** 또는 **SNMP**를 통해 알림을 보내는 트리거를 만들 수 있습니다. 예를 들어 **YARN Default** 그룹에 **위험**으로 설정된 경고가 있으면 이 경고를 보낼 수 있습니다.
