...
또한 __경고 알림 관리__를 선택하여 **작업** 메뉴에서 경고 방법을 관리하고 경고 알림을 만들 수도 있습니다. 그러면 현재 알림이 표시되고 새 알림을 만들 수 있습니다. 특정 경고/심각도 조합이 발생하면 **전자 메일** 또는 **SNMP**를 통해 알림을 보낼 수 있습니다. 예를 들어 **YARN Default** 그룹에 **위험**으로 설정된 경고가 있으면 이 경고를 보낼 수 있습니다.

![경고 만들기 대화 상자](./media/hdinsight-hadoop-manage-ambari/create-alert-notification.png)

마지막으로, __작업__ 메뉴에서 __경고 설정 관리__를 선택하면 알림을 보내기 전에 경고가 발생해야 하는 횟수를 지정할 수 있습니다. 이를 통해 하나의 헤드 노드에서 서비스가 실패하고, 다른 헤드 노드에서 다시 시작하는 것과 같이 일시적인 오류에 대한 알림을 방지하는 데 사용할 수 있습니다.
