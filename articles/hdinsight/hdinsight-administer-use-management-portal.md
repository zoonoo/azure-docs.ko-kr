<properties
	pageTitle="Azure 미리 보기 포털을 사용하여 HDInsight의 Hadoop 클러스터 관리 | Microsoft Azure"
...
[Azure 미리 보기 포털][azure-portal]에서 Azure HDInsight의 Hadoop 클러스터를 프로비전하고, Hadoop 사용자 암호를 변경하고, RDP(원격 데스크톱 프로토콜)를 사용하도록 설정하여 클러스터의 Hadoop 명령 콘솔에 액세스할 수 있습니다.

[AZURE.INCLUDE [hdinsight-azure-preview-portal](../../includes/hdinsight-azure-preview-portal.md)]

* [Azure 포털을 사용하여 HDInsight의 Hadoop 클러스터 관리](hdinsight-administer-use-management-portal-v1.md)

> [AZURE.NOTE]이 문서의 단계는 Windows 기반 Hadoop 클러스터를 사용한 작업을 대상으로 합니다. Linux 기반 클러스터를 사용한 작업에 대한 자세한 내용은 [Azure 미리 보기 포털을 사용하여 HDInsight의 Hadoop 클러스터 관리](hdinsight-administer-use-portal-linux.md)를 참조하세요.



> [AZURE.NOTE]미리 보기 포털뿐 아니라 HDInsight 관리에 사용할 수 있는 기타 도구도 있습니다.
>
...
미리 보기 포털을 사용한 프로비전 지침은 [HDInsight 클러스터 프로비전](hdinsight-provision-clusters.md#portal)을 참조하세요.

##HDInsight 클러스터 프로비전 사용자 지정
...
## 클러스터 포털 인터페이스에 대해 알아보기

**클러스터에 액세스하려면**

1. [미리 보기 포털][azure-portal]에 로그인합니다.
2. 왼쪽 메뉴에서 **모두 찾아보기**를 클릭하여 **찾아보기** 블레이드를 엽니다.
3. **HDInsight 클러스터**를 클릭하여 **HDInsight 클러스터** 블레이드를 엽니다.
4. 목록의 클러스터 중 하나를 클릭하여 클러스터 블레이드를 엽니다.

	![HDInsight 포털](./media/hdinsight-administer-use-management-portal/hdinsight.portal.cluster.blade.png)

5. **설정을** 클릭하여 구성 세부 정보를 참조하고 클러스터를 구성합니다.

	![HDInsight 포털 클러스터 설정](./media/hdinsight-administer-use-management-portal/hdinsight.portal.cluster.settings.png)

	|설정|설명|
	|-----|-----|
	|속성| 클러스터 속성을 표시합니다.|
	|Azure 저장소 키| 기본 Azure 저장소 계정 정보를 표시합니다. |
	|클러스터 로그인| HTTP 웹 서비스 액세스를 권한을 부여/해지하고 클러스터 로그인 정보를 구성합니다. |
	|외부 Metastore| Hive/Oozie Metastore 정보를 표시합니다.|
	|클러스터 크기 조정| 클러스터의 작업자 노드 수를 증가/감소시킵니다.|
	|원격 데스크톱| 원격 데스크톱 연결을 설정/해제하고 원격 데스크톱을 통해 클러스터에 연결합니다.|
...
1. [미리 보기 포털][azure-portal]에 로그인합니다.
2. 왼쪽의 메뉴에서 **모두 찾아보기**를 클릭하고 **HDInsight 클러스터**를 클릭하고 클러스터 이름을 클릭합니다.
3. 상단 메뉴에서 **설정**을 클릭한 다음 **클러스터 로그인**을 클릭합니다.
5. **클러스터 로그인 액세스**의 **ON** 또는 **OFF**를 클릭합니다.  
6. **클러스터 로그인 사용자 이름** 및 **클러스터 로그인 암호**에 대해 클러스터의 새 사용자 이름 및 암호를 각각 입력합니다.
7. **저장**을 클릭합니다.
...
생성 시 제공한 클러스터의 자격 증명은 원격 데스크톱을 통해 클러스터 자체가 아니라 클러스터의 서비스에 대한 액세스를 제공합니다. 클러스터를 프로비전할 때 또는 클러스터가 프로비전된 후 원격 데스크톱 액세스를 켤 수 있습니다. 프로비전 시 원격 데스크톱을 사용하는 방법에 대한 지침은 [HDInsight 클러스터 프로비전](hdinsight-provision-clusters.md)을 참조하세요.
...
##다음 단계
이 문서에서는 미리 보기 포털을 사용하여 HDInsight 클러스터를 만드는 방법 및 Hadoop 명령줄 도구를 여는 방법을 배웠습니다. 자세한 내용은 다음 문서를 참조하세요.
