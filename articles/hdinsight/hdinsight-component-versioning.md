...
| HDInsight 3.6 |HDP 2.6 |Ubuntu 16.0.4 LTS |2017년 4월 4일 | 2020 년 6 월 30 일 |2020 년 12 월 31 일 |예 |예 |
...
* HDInsight 클러스터 버전 3.1은 [Hortonworks Data Platform 2.1.7][hdp-2-1-7]. HDInsight 3.1 clusters created before November, 7, 2014, are based on [Hortonworks Data Platform 2.1.1][hdp-2-1-1]를 기반으로 하는 Hadoop 배포를 사용 합니다.
...
|||A8 v2||A4 v2|||D3 v2|
|||A2m v2||A8 v2|||E8 v3|
|ML 서비스: 기본 VM 크기||||||D4 v2||
|ML 서비스: 권장 되는 VM 크기||||||D4 v2||
|||||||D12 v2||
|||||||D13 v2||
|||||||D14 v2||
|||||||E16 v3||
...
* 브라질 남부 및 일본 서부만 해당(v2 크기 제외):
  ...
  | ML 서비스: 기본 VM 크기 | | | | | |D4 |
  | ML 서비스: 권장 되는 VM 크기 | | | | | |D4,<br/> D12,<br/> D13,<br/> D14 |
