...
HDInsight Windows PowerShell cmdlet 또는 HDInsight .NET SDK를 통해 클러스터를 만들 경우 Azure 포털에서 **선택적 구성** 블레이드의 **HDInsight 버전** 드롭다운을 사용하여 HDInsight Hadoop 클러스터에 대한 버전을 선택할 수 있습니다.
