...
# HDInsight의 Hive를 사용한 JSON 문서 처리 및 분석
...
2. [Maven 3.3.1](http://mirror.olnevhost.net/pub/apache/maven/maven-3/3.3.1/binaries/apache-maven-3.3.1-bin.zip)을 설치합니다.
...
- [DocumentDB 및 HDInsight를 사용해서 Hadoop 실행](documentdb-run-hadoop-with-hdinsight.md)
