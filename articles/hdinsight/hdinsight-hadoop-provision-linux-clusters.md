---
title: Linux 기반 HDInsight에서 Hadoop, HBase, Storm 또는 Spark 클러스터 만들기 | Microsoft Docs
...
> [!IMPORTANT]
> HDInsight Metastore는 이전 버전과 호환되지 않습니다. 예를 들어 HDInsight 3.4 클러스터의 Metastore를 사용하여 HDInsight 3.3 클러스터를 만들 수 없습니다.
> 
> 
