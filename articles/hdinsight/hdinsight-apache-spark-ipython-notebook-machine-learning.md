...
1. [Jupyter](https://jupyter.org) 노트북을 시작합니다. Azure 포털에서 Spark 클러스터를 선택하고 맨 아래 포털 작업 표시줄에서 **Jupyter 노트북**을 클릭합니다. 메시지가 표시되면 Spark 클러스터에 대한 관리자 자격 증명을 입력합니다.
...
11. 이제 커널을 다시 시작하여 노트북을 끝낼 수 있습니다. 상단 메뉴 모음에서 **커널**을 클릭하고 **다시 시작**을 클릭한 후 프롬프트에서 **다시 시작**을 한 번 더 클릭합니다.
