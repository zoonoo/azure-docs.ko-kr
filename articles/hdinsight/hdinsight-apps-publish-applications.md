...
* [HDInsight 응용 프로그램을 설치합니다.](hdinsight-apps-install-applications.md) 클러스터에 HDInsight 애플리케이션을 설치하는 방법을 알아봅니다.
* [사용자 정의 HDInsight 응용 프로그램을 설치합니다.](hdinsight-apps-install-custom-applications.md) 사용자 지정 HDInsight 애플리케이션을 설치하고 테스트하는 방법을 알아봅니다.
...
6. 토폴로지 이름을 입력한 **+** 다음 을 선택합니다.
7. 새 버전을 입력한 다음 **+** 을 선택합니다.
