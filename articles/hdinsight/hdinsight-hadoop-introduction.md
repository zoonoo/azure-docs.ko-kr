...
* Hadoop 호환 저장소 옵션인 Azure Storage 또는 Azure Data Lake Store를 통한 효율적이고 경제적인 데이터 저장. 자세한 내용은 [HDInsight에서 Hadoop와 함께 Azure Storage 사용](hdinsight-hadoop-use-blob-storage.md) 또는 [HDInsight 클러스터와 함께 Data Lake Store 사용](https://docs.microsoft.com/en-us/azure/data-lake-store/data-lake-store-hdinsight-hadoop-use-portal)을 참조하세요.
