---
title: 클라우드에서 Hadoop이란? HDInsight 소개 | Microsoft Docs
...
* 저렴한 초기 비용. [무료 평가판](https://azure.microsoft.com/free/)으로 시작하거나 [HDInsight 가격 정보](https://azure.microsoft.com/pricing/details/hdinsight/)를 확인해 보세요.
