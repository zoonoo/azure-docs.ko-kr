...
## Azure 자동화 정의
[Azure 자동화](http://azure.microsoft.com/services/automation/)는 프로세스 자동화를 통해 클라우드 및 데이터 센터 관리를 간소화하기 위한 Azure 서비스입니다. Azure 자동화, 수동, 빈번하게 반복되는, 장기 실행 및 오류가 발생하기 쉬운 작업을 사용하면 조직의 안정성, 효율성 및 가치 창출 시간을 개선하도록 자동화할 수 있습니다.
...
Azure HDInsight cmdlet을 사용하면 Linux 또는 Windows에서 HDInsight 클러스터 프로비전, 클러스터 크기 조정, 클러스터 관리, MapReduce 작업 제출 등의 작업을 자동화할 수 있습니다. 이는 Azure 자동화에서 PowerShell을 사용하여 자동화할 수 있는 많은 작업의 일부에 불과합니다.
