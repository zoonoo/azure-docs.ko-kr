---
title: Azure HDInsight에서 쿼리 결과를 인출 하는 동안 Apache Hive 보기 시간 초과
...
ms.locfileid: "71091249"
---
# <a name="scenario-apache-hive-view-times-out-when-fetching-a-query-result-in-azure-hdinsight"></a>시나리오: Azure HDInsight에서 쿼리 결과를 인출 하는 동안 Apache Hive 보기 시간 초과
...
에서 `/etc/ambari-server/conf/ambari.properties`다음 속성을 설정 하 여 Apache Ambari Hive 뷰 시간 제한을 늘립니다.
...
값 `HIVE_VIEW_INSTANCE_NAME` 은 Hive 뷰 URL의 끝에 있습니다.
