...
* Visual Studio Code 사용
    ...
    참조 [Apache Hive, LLAP 또는 pySpark 용 Visual Studio Code를 사용 하 여](../hdinsight-for-vscode.md)입니다.
...
1. 다음 URL을 사용 하 여 Apache Ambari에 로그인: `https://<cluster name>.AzureHDInsight.net`합니다.
