...
* [HDInsight의 Apache Beeline](https://docs.microsoft.com/azure/hdinsight/hadoop/apache-hadoop-use-hive-beeline)
* [HDInsight 게이트웨이 시간 제한 문제 해결 단계](https://docs.microsoft.com/azure/hdinsight/interactive-query/troubleshoot-gateway-timeout)
* [HDInsight 용 가상 네트워크](https://docs.microsoft.com/azure/hdinsight/hdinsight-plan-virtual-network-deployment)
* [Express 경로를 사용 하는 HDInsight](https://docs.microsoft.com/azure/hdinsight/connect-on-premises-network)