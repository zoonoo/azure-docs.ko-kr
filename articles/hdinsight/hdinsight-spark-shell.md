...
3. SSH(Secure Shell)를 선택합니다.
    ...
    ![Azure Portal의 HDInsight 창](./media/hdinsight-spark-shell/hdinsight-spark-blade.png)

4. 표시되는 SSH 명령을 복사하고 터미널에서 실행합니다.

    ![Azure Portal의 HDInsight SSH 창](./media/hdinsight-spark-shell/hdinsight-spark-ssh-blade.png)
