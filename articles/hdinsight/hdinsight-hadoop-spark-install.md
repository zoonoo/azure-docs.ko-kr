---
title: 스크립트 작업을 사용하여 Hadoop 클러스터에 Spark 설치 | Microsoft Docs
...
1. **SimpleScalaApp** 폴더 아래에 디렉터리 구조 **\\src\\main\\scala**를 만들고 앞에서 \\src\\main\\scala 폴더에 만든 Scala 프로그램(**SimpleApp.scala**)을 붙여 넣습니다.
