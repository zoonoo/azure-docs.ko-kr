...
2. 다음 값을 입력하거나 선택합니다.
    ...
    ![HDInsight Linux 시작 - 포털의 Resource Manager 템플릿](./media/hdinsight-hadoop-linux-tutorial-get-started/hdinsight-linux-get-started-arm-template-on-portal.png "Azure Portal과 리소스 그룹 관리자 템플릿을 사용하여 HDInsigut에 Hadoop 클러스터 배포")
