...
2. **매개 변수** 블레이드에서 다음을 입력합니다.
    ...
    ![HDInsight Linux 포털에서 Resource Manager 템플릿 시작](./media/hdinsight-hadoop-linux-tutorial-get-started/hdinsight-linux-get-started-arm-template-on-portal.png).
...
4. 페이지의 **쿼리 편집기** 섹션에서 다음 HiveQL 문을 워크시트에 붙여넣습니다.
   ...
   > 
   > 
5. **실행__을 클릭합니다. 쿼리 편집기 아래에 __쿼리 프로세스 결과** 섹션이 나타나고 작업에 대한 정보가 표시될 것입니다.
...
> [!NOTE]
> [Azure 데이터 팩터리](hdinsight-hadoop-create-linux-clusters-adf.md)를 사용하여 주문형 HDInsight 클러스터를 만들고, 클러스터를 자동으로 삭제하도록 TimeToLive 설정을 구성할 수 있습니다.
> 
> 
