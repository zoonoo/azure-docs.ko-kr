...
* Visual Studio에서 Hive 쿼리를 수행 하는 방법을 비롯 하 여 HDInsight에서 [Apache Hive](https://hive.apache.org/) 를 사용 하는 방법에 대 한 자세한 내용은 [Hdinsight에서 Apache Hive 사용][hdinsight-use-hive]을 참조 하세요.
* 데이터 변환에 사용 되는 언어인 [Apache Pig](https://pig.apache.org/)에 대 한 자세한 내용은 [HDInsight에서 apache Pig 사용][hdinsight-use-pig]을 참조 하세요.
* Hadoop에서 데이터를 처리 하는 프로그램을 작성 하는 방법에 대 [Apache Hadoop](https://hadoop.apache.org/docs/current/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html)한 자세한 내용은 HDInsight를 사용 하 여 [Apache Hadoop mapreduce 사용][hdinsight-use-mapreduce]을 참조 하세요.
