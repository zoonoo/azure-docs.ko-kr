...
최소 4 코어 VM은 HDInsight 클러스터의 고가용성 및 안정성을 보장 하기 위해 헤드 노드에 필요 합니다. 4 월 6 일 2020부터 고객은 새 HDInsight 클러스터에 대 한 헤드 노드로 4 코어 이상 VM만 선택할 수 있습니다. 기존 클러스터는 정상적으로 계속 실행 됩니다. 
