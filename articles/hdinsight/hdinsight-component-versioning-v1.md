---
title: HDInsight의 Hadoop 클러스터 버전 내 새로운 기능 | Microsoft Docs
...
> [!NOTE]
> HDInsight 2.1 및 3.0 클러스터는 모두 64비트 버전의 Windows Server 2012 R2를 사용하고 .NET Framework 4.0, 4.5 및 4.5.1을 지원하는 Azure 게스트 OS [제품군 4](../cloud-services/cloud-services-guestos-update-matrix.md)에서 실행됩니다.
> 
> 
