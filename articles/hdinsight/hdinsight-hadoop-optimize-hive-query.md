<properties
   pageTitle="HDInsight에서 빠른 실행을 위해 Hive 쿼리 최적화 | Microsoft Azure"
   description="HDInsight에서 Hive 쿼리를 최적화하는 방법에 대해 알아봅니다."
   services="hdinsight"
   documentationCenter=""
   authors="rashimg"
   manager="mwinkle"
...
# HDInsight에서 Hadoop에 대한 Hive 쿼리 최적화
...
이러한 개념에 대한 자세한 내용은 [여기](http://hortonworks.com/hadoop/tez/)를 클릭합니다.
