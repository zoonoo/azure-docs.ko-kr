---
title: 프로그래밍 방식으로 Hadoop YARN 응용 프로그램 로그에 액세스 | Microsoft Docs
...
> [!NOTE]
> 이 문서의 정보는 Windows 기반 HDInsight 클러스터에만 적용됩니다. Linux 기반 HDInsight 클러스터에서 YARN 로그 액세스에 대한 정보는 [HDInsight의 Linux 기반 Hadoop에 대한 YARN 응용 프로그램 로그 액세스](hdinsight-hadoop-access-yarn-app-logs-linux.md)를 참조하세요.
> 
> 
