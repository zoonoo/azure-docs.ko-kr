...
:::image type="content" source="./media/hdinsight-log-management/ambari-stack-versions.png" alt-text="Apache Ambari admin Stack 및 버전":::
...
:::image type="content" source="./media/hdinsight-log-management/download-client-configs.png" alt-text="Apache Ambari 다운로드 호스트 클라이언트 configs":::
