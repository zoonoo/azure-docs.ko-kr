...
HDInsight는 BLOB 컨테이너의 저장소 계정에 데이터를 저장합니다. [New-AzStorageContainer](/powershell/module/Azure.Storage/New-AzStorageContainer)를 사용하여 새 컨테이너를 만듭니다.
