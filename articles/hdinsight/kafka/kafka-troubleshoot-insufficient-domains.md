...
---
# <a name="scenario-cluster-creation-failed-due-to-not-sufficient-fault-domains-in-region-in-azure-hdinsight"></a>시나리오: Azure HDInsight에서로 인해 `not sufficient fault domains in region` 클러스터를 만들지 못했습니다.

이 문서에서는 Azure HDInsight 클러스터와 상호 작용할 때 문제에 대 한 문제 해결 단계 및 가능한 해결 방법을 설명 합니다.

## <a name="issue"></a>문제

Apache Kafka 클러스터를 만들려고 할 `not sufficient fault domains in region` 때와 유사한 오류 메시지가 표시 됩니다.
