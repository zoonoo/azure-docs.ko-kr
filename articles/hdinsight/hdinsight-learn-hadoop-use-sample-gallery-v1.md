---
title: 샘플 갤러리를 사용하여 HDInsight에서 Hadoop에 대해 알아보기 | Microsoft Docs
...
* [HDInsight 시작 갤러리를 사용하여 Hadoop에 대해 알아보기](hdinsight-learn-hadoop-use-sample-gallery.md)

![샘플 데이터가 포함된 HDInsight Hadoop, Storm 및 HBase 시작 갤러리 솔루션][hdinsight.sample.gallery]

다음 비디오 클립에서는 Twitter 추세 분석 샘플을 실행하는 방법을 보여 줍니다.
