...
> [!NOTE]
> 이 문서의 단계는 Linux 기반 HDInsight 클러스터를 만듭니다. HDInsight 클러스터에서 Linux 기반 Storm을 만드는 단계에 대해서는 [Apache Storm 자습서: HDInsight에서 빅 데이터 분석을 사용하여 Storm Starter 샘플 시작](hdinsight-apache-storm-tutorial-get-started.md)을 참조하세요.
> 
> 
...
2. 다음 명령을 사용하여 예제 토폴로지를 시작합니다.
   ...
   > [!NOTE]
   > HDInsight가 새 버전의 Storm으로 업데이트되면 파일 이름의 `0.10.0.2.4.2.4-5` 부분이 변경될 수 있습니다.
   > 
   > 
