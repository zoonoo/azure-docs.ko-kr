...
---
# <a name="use-azure-toolkit-for-intellij-to-debug-applications-remotely-on-hdinsight-spark"></a>IntelliJ용 Azure 도구 키트를 사용하여 HDInsight Spark에서 원격으로 응용 프로그램 디버그
