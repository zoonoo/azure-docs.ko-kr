<properties
	pageTitle=".NET 백 엔드를 통한 Azure 알림 허브의 Android 사용자 알림"
...
#.NET 백 엔드를 통한 Azure 알림 허브의 Android 사용자 알림
...
7. `MainActivity` 클래스에서 전체 `registerWithNotificationHubs` 메서드를 삭제하거나 주석 처리합니다. 이는 이 자습서에서는 사용되지 않습니다.

8. 다음 `import` 문을 **MainActivity.java** 파일에 추가합니다.
