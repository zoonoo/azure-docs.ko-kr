...
1. **application:didRegisterForRemoteNotificationsWithDeviceToken** 에 대한 다음 구현에서 대체하여 스토리보드 UI 변경 내용을 고려합니다.
...
3. 다음 메서드를 사용하여 **AppDelegate.m** 에서 이미지 뷰 컨트롤러를 열어 위의 로컬 알림을 처리합니다.
