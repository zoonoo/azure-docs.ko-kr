...
Notification Hubs는 모바일 앱을 실행하는 디바이스에 알림을 보냅니다. 전자 메일 또는 문자 메시지 기능은 제공하지 않습니다. 또한 Notification Hubs는 브라우저 내 푸시 알림 배달 서비스를 기본적으로 제공하지 않습니다. 고객은 지원되는 서버 쪽 플랫폼의 맨 위에서 SignalR을 사용하여 이를 구현할 수 있습니다. 
