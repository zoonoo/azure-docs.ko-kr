...
2. **Description**에 앱 이름을 입력하고 **Bundle Identifier** 값을 입력한 후 "App Services" 섹션에서 "Push Notifications" 옵션을 선택하고 **Continue**를 클릭합니다.
	...
	앱 ID가 생성되고 정보를 제출하도록 요청됩니다. 제출을 클릭합니다.
...
6. 포털에서 인증서가 생성되면 **Download**를 클릭한 후 **Done**을 클릭합니다.
   ...
   서명 인증서가 다운로드되어 컴퓨터의 **Downloads** 폴더에 저장됩니다.
    ...
    > [AZURE.NOTE] 기본적으로 다운로드된 개발 증명서 파일은 이름이 aps_development.cer로 지정됩니다.
...
7. 다운로드한 푸시 인증서 **aps_development.cer**을 두 번 클릭합니다.
	...
	> [AZURE.NOTE] 인증서의 이름은 다를 수 있지만 Apple Development iOS Push Notification Services:가 앞에 옵니다.
