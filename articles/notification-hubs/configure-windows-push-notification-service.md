...
Azure Notification Hubs 및 WNS (Windows 푸시 알림 서비스)를 사용 하 여 유니버설 Windows 플랫폼 응용 프로그램에 알림을 푸시하는 방법에 대 한 단계별 지침이 포함 된 자습서는 [azure Notification Hubs를 사용 하 여 UWP 앱에 알림 보내기](notification-hubs-windows-store-dotnet-get-started-wns-push-notification.md)를 참조 하세요.
