...
다음 절차에서는 알림 허브에 대 한 Google Firebase Cloud Messaging (FCM) 설정을 구성 하는 단계를 제공 합니다. 
...
Azure Notification Hubs 및 Google Firebase 클라우드 메시징을 사용 하 여 Android 장치에 알림을 푸시하는 방법에 대 한 단계별 지침이 포함 된 자습서는 [Notification Hubs 및 GOOGLE FCM를 사용 하 여 android 장치에 알림 푸시](notification-hubs-android-push-notification-google-fcm-get-started.md)를 참조 하세요.
