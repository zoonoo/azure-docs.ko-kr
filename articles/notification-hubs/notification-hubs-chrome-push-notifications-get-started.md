...
6. **알림 설정** 범주에서 **Google(GCM)** 을 선택하고 GCM 프로젝트에 대한 **API 키**를 입력한 후 **저장**을 클릭합니다.
