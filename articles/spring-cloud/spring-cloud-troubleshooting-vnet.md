...
[Azure CLI](https://docs.microsoft.com/cli/azure/get-started-with-azure-cli)를 사용 하 여 Azure 스프링 클라우드 서비스 인스턴스를 설정 하려면 다음을 확인 합니다.
...
리소스 관리자 템플릿을 사용 하 여 Azure 스프링 클라우드 서비스 인스턴스를 설정 하려면 [Azure Resource Manager 템플릿의 구조 및 구문 이해](https://docs.microsoft.com/azure/azure-resource-manager/resource-group-authoring-templates)를 참조 하세요.
...
[일반적인 Azure 스프링 클라우드 문제를 해결](https://docs.microsoft.com/azure/spring-cloud/spring-cloud-troubleshoot)합니다.