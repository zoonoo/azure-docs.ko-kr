...
1. 왼쪽 메뉴에서 **설정** 제목 아래의 **크기 조정** 탭으로 이동합니다. 다음 섹션에 표시된 크기 조정 특성에 대한 옵션이 표시되어야 합니다.
...
크기 조정 설정을 적용하려면 **저장** 단추를 클릭해야 합니다.

![Azure Portal에서 서비스 크기 조정](media/spring-cloud-tutorial-scale-manual/scale-up-out.png)
