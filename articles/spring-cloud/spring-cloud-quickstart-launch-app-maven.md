...
1. 부모 POM을 포함하는 PiggyMetrics의 루트 폴더에서 다음 명령을 실행하여 구성을 생성합니다.
    ...
    c. 제공된 프로젝트 목록에서 `gateway`에 해당하는 숫자를 입력하여 공용 액세스 권한을 부여합니다.
...
> [Azure용 Maven 플러그 인에 대해 자세히 알아보기](https://github.com/microsoft/azure-maven-plugins)
