...
ms.locfileid: "89269610"
---
# <a name="quickstart-launch-a-java-spring-application-using-the-azure-cli"></a>빠른 시작: Azure CLI를 사용하여 Java Spring 애플리케이션 시작

Azure Spring Cloud를 사용하면 Azure에서 Spring Boot 기반 마이크로서비스 애플리케이션을 쉽게 실행할 수 있습니다.  이 예를 실행하기 전에 [기본 빠른 시작](spring-cloud-quickstart.md)을 시도해 볼 수 있습니다.
...
3. 이전 명령에서 제공하는 URL로 이동하여 PiggyMetrics 애플리케이션을 실행합니다.
    ![PiggyMetrics 실행 중](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. **게이트웨이** 선택
    ...
    ![PiggyMetrics 탐색](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. **게이트웨이 개요** 페이지 ![PiggyMetrics 탐색 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)에서 URL 찾기
