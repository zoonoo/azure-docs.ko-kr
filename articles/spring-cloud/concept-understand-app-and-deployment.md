---
title: Azure 스프링 클라우드의 앱 및 배포
description: 이 항목에서는 Azure 스프링 클라우드의 응용 프로그램과 배포의 차이점에 대해 설명 합니다.
author: MikeDodaro
ms.author: brendm
...
ms.locfileid: "104878592"
---
# <a name="app-and-deployment-in-azure-spring-cloud"></a>Azure 스프링 클라우드의 앱 및 배포
