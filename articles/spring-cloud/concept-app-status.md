...
---
# <a name="app-status-in-azure-spring-cloud"></a>Azure 스프링 클라우드의 앱 상태
...
* [Azure 스프링 클라우드에서 배포용 스프링 또는 Steeltoe 응용 프로그램 준비](how-to-prepare-app-deployment.md)