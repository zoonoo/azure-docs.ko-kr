...
이 문서에서는 Azure Spring Cloud 애플리케이션을 Azure Cache for Redis에 바인딩하는 방법을 알아보았습니다. 서비스를 애플리케이션에 바인딩하는 방법에 대한 자세한 내용은 [Azure Database for MySQL 인스턴스에 바인딩](spring-cloud-howto-bind-mysql.md)을 참조하세요.
