---
title: Azure Portal을 사용하여 Azure Spring Cloud 애플리케이션 시작
...
이 빠른 시작에서는 Azure에 기존 Spring Cloud 애플리케이션을 배포하는 방법을 보여줍니다. 이 자습서에 사용된 샘플 애플리케이션 코드에 대한 [링크는 여기에](https://github.com/Azure-Samples/PiggyMetrics) 있습니다. 자습서를 마치면, 제공된 샘플 애플리케이션에 온라인으로 액세스할 수 있고 Azure Portal을 통해 관리할 준비가 됩니다.
...
1. 명령 창을 열고 다음 명령을 실행하여 로컬 머신에 샘플 앱 리포지토리를 복제합니다.

    ```cli
    git clone https://github.com/Azure-Samples/piggymetrics
    ```

1. 아래 명령을 실행하여 프로젝트를 빌드합니다.
