...
![오른쪽 아래에 있는 탑재 주소 목록 주위에 강조 표시 상자가 있는 Azure HPC 캐시 인스턴스의 개요 페이지 스크린샷](media/mount-addresses.png)
...
가상 네임 스페이스 경로는 **저장소 대상** 페이지에 표시 됩니다. 
![테이블의 경로 열에 있는 항목 주위에 강조 표시 상자가 있는 캐시의 저장소 대상 패널 스크린샷](media/storage-target-path.png)
