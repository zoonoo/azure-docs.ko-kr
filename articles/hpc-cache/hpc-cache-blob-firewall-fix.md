...
"선택한 네트워크" 에서만 액세스할 수 있도록 하는 방화벽 설정으로 인해 캐시에서 Blob 저장소 대상을 만들거나 수정 하지 못할 수 있습니다. 이 구성은 저장소 계정의 **방화벽 및 가상 네트워크** 설정 페이지에 있습니다.
...
또한 방화벽은 Blob 저장소 대상 네임 스페이스 경로에 대 한 변경 내용을 차단할 수 있습니다.
...
1. 저장소 대상의 네임 스페이스 경로를 만듭니다.
1. 저장소 대상과 경로를 성공적으로 만든 후에는 계정의 방화벽 설정을 **선택한 네트워크** 로 다시 변경 합니다.
