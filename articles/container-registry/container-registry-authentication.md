...
| [AD 서비스 사용자](#service-principal)                  | `docker login`<br/><br/>Azure CLI `az acr login`<br/><br/> Api 또는 도구의 레지스트리 로그인 설정<br/><br/> [Kubernetes pull 비밀](container-registry-auth-kubernetes.md)                                           | CI/CD 파이프라인에서 무인 푸시<br/><br/> Azure 또는 외부 서비스에 무인 풀  | yes                              | SP 암호 기본 만료는 1 년입니다.       |                                                           
