...
빈번 하 게 익명 끌어오기 요청을 만드는 경우 `ERROR: toomanyrequests: Too Many Requests.` `You have reached your pull rate limit.` 이러한 오류를 방지 하기 위해 docker 허브와 유사한 docker 오류가 표시 될 수 있습니다.
