...
[ACR 작업](container-registry-tasks-overview.md)은 Azure에서 간편하고 효율적인 Docker 컨테이너 이미지 빌드를 제공하는 Azure Container Registry 내의 기능 모음입니다. 이 문서에서는 ACR 작업의 *빠른 작업* 기능을 사용하는 방법에 대해 알아봅니다.
...
:::image type="content" source="media/container-registry-tutorial-quick-build/quick-build-02-browser.png" alt-text="브라우저에서 실행 중인 샘플 애플리케이션":::
