<properties title="Learn how to configure an Azure website to use a domain name registered with eNom" pageTitle="Azure 웹 사이트에 대한 eNom 도메인 이름 구성" metaKeywords="Microsoft Azure, Microsoft Azure 웹 사이트 도메인 이름" description="" services="web-sites" documentationCenter="" authors="larryfr, jroth" manager="wpickett" />
...
4. Host Records 편집기에서 **Record Type** 필드를 사용하여 특정 레코드 유형을 선택할 수 있습니다. Azure 웹 사이트의 경우 **CNAME (Alias)** 또는 **A (Address)** 선택 항목만 사용해야 합니다.
