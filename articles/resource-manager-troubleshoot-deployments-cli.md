<properties
   pageTitle="Azure CLI를 사용하여 배포 문제 해결 | Microsoft Azure"
   description="Azure CLI를 사용하여 리소스 관리자 배포의 문제를 감지하고 해결하는 방법에 대해 설명합니다."
...
# Azure CLI를 사용하여 리소스 그룹 배포 문제 해결
...
Azure로 리소스를 배포할 때 오류가 발생하면 문제를 해결해야 합니다. Azure CLI는 오류를 찾고 잠재적 해결 방법을 확인할 수 있도록 하는 명령을 제공합니다.
