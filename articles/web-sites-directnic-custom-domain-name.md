...
[웹 사이트](/ko-kr/documentation/articles/web-sites-directnic-custom-domain-name/ "웹 사이트") | [트래픽 관리자를 사용하는 웹 사이트](/ko-kr/documentation/articles/web-sites-directnic-traffic-manager-custom-domain-name/ "트래픽 관리자를 사용하는 웹 사이트")
