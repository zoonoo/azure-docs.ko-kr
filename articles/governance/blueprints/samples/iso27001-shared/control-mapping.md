...
Azure의 [SQL Vulnerability Assessment 서비스](https://docs.microsoft.com/azure/sql-database/sql-vulnerability-assessment)는 데이터베이스에 저장된 중요한 데이터를 검색하는 데 도움이 되며 해당 데이터를 분류하기 위한 권장 사항을 포함합니다. 이 청사진은 [Azure Policy](../../../policy/overview.md) 정의를 할당하여 SQL Vulnerability Assessment 검사 중에 식별된 취약성이 해결되었는지 감사합니다.
...
- \[미리 보기\]: 암호 없는 Linux VM 계정을 감사하는 VM 확장 배포
- \[미리 보기\]: Linux VM이 암호가 없는 계정에서 원격 연결을 허용하는지 감사하는 VM 확장 배포
- \[미리 보기\]: 암호 없는 Linux VM 계정 감사
- \[미리 보기\]: Linux VM이 암호가 없는 계정에서 원격 연결을 허용하는지 감사
- 클래식 스토리지 계정의 사용 감사
- 클래식 가상 머신의 사용 감사
...
- \[미리 보기\]: 구독에서 MFA가 사용하도록 설정되지 않은 쓰기 권한이 있는 계정 감사
- \[미리 보기\]: Linux VM passwd 파일 권한을 감사하는 VM 확장 배포
...
- \[미리 보기\]: Windows VM이 암호 복잡성 요구 사항을 적용하는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM 최대 암호 사용 기간이 70일인지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM 최소 암호 사용 기간이 1일인지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM 암호가 14자 이상이어야 하는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM에서 이전 24개 암호를 허용하지 않아야 하는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM이 암호 복잡성 요구 사항을 적용하는지 감사
- \[미리 보기\]: Windows VM 최대 암호 사용 기간 70일 감사
- \[미리 보기\]: Windows VM 최소 암호 사용 기간 1일 감사
- \[미리 보기\]: Windows VM 암호가 14자 이상이어야 하는지 감사
- \[미리 보기\]: Windows VM에서 이전 24개 암호를 허용하지 않아야 하는지 감사
...
- \[미리 보기\]: 함수 앱에 대한 HTTPS 전용 액세스 감사
- \[미리 보기\]: 웹 애플리케이션에 대한 HTTPS 전용 액세스 감사
- \[미리 보기\]: API 앱에 대한 HTTPS 전용 액세스 감사
...
- \[미리 보기\]: Azure Security Center에서 가능한 앱 허용 목록 모니터링
