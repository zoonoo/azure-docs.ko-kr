---
title: Azure Security Benchmark 청사진 샘플 배포
description: 청사진 아티팩트 매개 변수 세부 정보를 포함하여 Azure Security Benchmark 청사진 샘플에 대한 단계를 배포합니다.
ms.date: 05/01/2020
ms.topic: sample
...
ms.locfileid: "82702674"
---
# <a name="deploy-the-azure-security-benchmark-blueprint-sample"></a>Azure Security Benchmark 청사진 샘플 배포
...
|-|-|-|-|
|Azure Security Benchmark 권장 사항 감사 및 지원하는 특정 VM 확장 배포|정책 할당|
Windows VM 관리자 그룹에서 제외된 사용자 목록|관리자 로컬 그룹에서 제외해야 하는 구성원의 세미콜론으로 구분된 목록입니다. 예: Administrator; myUser1; myUser2|
...
지금까지 Azure Security Benchmark 청사진 샘플을 배포하는 단계를 살펴보았으므로 이제 다음 문서를 참조하여 청사진 및 컨트롤 매핑에 대해 알아보세요.

> [!div class="nextstepaction"]
> [Azure Security Benchmark 청사진 - 개요](./index.md)
> [Azure Security Benchmark 청사진 - 컨트롤 매핑](./control-mapping.md)
