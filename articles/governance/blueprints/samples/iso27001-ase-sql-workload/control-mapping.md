---
title: 샘플-ISO 27001 ASE/SQL 작업 blueprint-컨트롤 매핑
description: Azure 정책 및 RBAC를 ISO 27001 앱 서비스 환경/SQL Database 워크 로드 blueprint 샘플의 컨트롤 매핑.
services: blueprints
author: DCtheGeek
ms.author: dacoulte
ms.date: 03/14/2019
...
---
# <a name="control-mapping-of-the-iso-27001-asesql-workload-blueprint-sample"></a>ISO 27001 ASE/SQL 작업 blueprint 샘플의 컨트롤 매핑

다음 문서는 Azure 청사진 ISO 27001 ASE/SQL 작업 blueprint 샘플 ISO 27001 컨트롤에 매핑되는 방법을 자세히 설명 합니다. 컨트롤에 대 한 자세한 내용은 참조 하세요. [ISO 27001](https://www.iso.org/isoiec-27001-information-security.html)합니다.
...
ISO 27001 앱 서비스 환경/SQL Database 워크 로드 blueprint 샘플의 컨트롤 매핑, 보신 했으므로 아키텍처 및이 샘플을 배포 하는 방법에 대해 알아보려면 다음 문서를 방문 합니다.
