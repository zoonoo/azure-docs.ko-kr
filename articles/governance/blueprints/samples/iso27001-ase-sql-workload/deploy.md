---
title: -ISO 27001 앱 서비스 환경/SQL Database 워크 로드 blueprint-샘플 배포 단계
...
ms.locfileid: "58201911"
---
# <a name="deploy-the-azure-blueprints-iso-27001-app-service-environmentsql-database-workload-blueprint-sample"></a>Azure 청사진 ISO 27001 앱 서비스 환경/SQL Database 워크 로드 blueprint 샘플 배포
...
1. 입력 된 _기본 사항_ blueprint 샘플:
   ...
   - **Blueprint 이름**: ISO 27001 ASE/SQL 작업 blueprint 샘플에 대 한 이름을 제공 합니다.
...
|-|-|-|-|
|Log Analytics 리소스 그룹|리소스 그룹|이름|**잠긴** -연결 된 **조직 이름** 사용 하 여 `-workload-log-rg` 리소스 그룹을 고유 하 게 합니다.|
...
|네트워크 리소스 그룹|리소스 그룹|이름|**잠긴** -연결 된 **조직 이름** 사용 하 여 `-workload-net-rg` 리소스 그룹을 고유 하 게 합니다.|
...
|주요 자격 증명 모음 리소스 그룹|리소스 그룹|이름|**잠긴** -연결 된 **조직 이름** 사용 하 여 `-workload-kv-rg` 리소스 그룹을 고유 하 게 합니다.|
...
|Azure SQL Database 리소스 그룹|리소스 그룹|이름|**잠긴** -연결 된 **조직 이름** 사용 하 여 `-workload-azsql-rg` 리소스 그룹을 고유 하 게 합니다.|
...
|앱 서비스 환경 리소스 그룹|리소스 그룹|이름|**잠긴** -연결 된 **조직 이름** 사용 하 여 `-workload-ase-rg` 리소스 그룹을 고유 하 게 합니다.|
