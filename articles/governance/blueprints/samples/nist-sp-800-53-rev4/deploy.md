---
title: 샘플 - NIST SP 800-53 R4 청사진 - 배포 단계
description: NIST SP 800-53 R4 청사진 샘플의 배포 단계
author: DCtheGeek
ms.author: dacoulte
ms.date: 06/24/2019
ms.topic: sample
...
지금까지 NIST SP 800-53 R4 청사진 샘플을 배포하는 단계를 살펴보았으므로 이제 다음 문서를 참조하여 청사진 및 컨트롤 매핑에 대해 알아보세요.
