...
- \[미리 보기\]: 구독에서 사용되지 않는 계정 감사
- \[미리 보기\]: 구독에서 소유자 권한이 있는 사용되지 않는 계정 감사
- \[미리 보기\]: 구독에서 소유자 권한이 있는 외부 계정 감사
- \[미리 보기\]: 구독에서 읽기 권한이 있는 외부 계정 감사
- \[미리 보기\]: 구독에서 쓰기 권한이 있는 외부 계정 감사
...
- \[미리 보기\]: 웹 애플리케이션에 대한 CORS 리소스 액세스 제한 감사
...
- \[미리 보기\]: 구독에 대한 최대 소유자 수 감사
- \[미리 보기\]: 구독에 대한 최소 소유자 수 감사
...
- \[미리 보기\]: 함수 앱에 대한 원격 디버깅 상태 감사
- \[미리 보기\]: 웹 애플리케이션에 대한 원격 디버깅 상태 감사
- \[미리 보기\]: API 앱에 대한 원격 디버깅 상태 감사
- \[미리 보기\]: Linux VM이 암호 없는 계정의 원격 연결을 허용하지 않는지 감사
- \[미리 보기\]: Linux VM이 암호 없는 계정의 원격 연결을 허용하지 않는지 감사하는 VM 확장 배포
...
- \[미리 보기\]: Azure Security Center에서 감사되지 않은 SQL Sever 모니터링
- 진단 설정 감사
...
- \[미리 보기\]: Azure Security Center에서 사용 가능한 앱 허용 목록 모니터링
...
- \[미리 보기\]: 구독에서 MFA가 사용하도록 설정되지 않은 소유자 권한이 있는 계정 감사
- \[미리 보기\]: 구독에서 MFA가 사용하도록 설정되지 않은 쓰기 권한이 있는 계정 감사
...
- \[미리 보기\]: 구독에서 MFA가 사용하도록 설정되지 않은 읽기 권한이 있는 계정 감사
...
- \[미리 보기\]: Linux VM에 암호 없는 계정이 없는지 감사
- \[미리 보기\]: Linux VM에 암호 없는 계정이 없는지 감사하는 VM 확장 배포
- \[미리 보기\]: Linux VM에서 passwd 파일 권한이 0644로 설정되어 있는지 감사
- \[미리 보기\]: Windows VM이 해독 가능한 암호화를 사용하여 암호를 저장하는지 감사
- \[미리 보기\]: Linux VM에서 passwd 파일 권한이 0644로 설정되어 있는지 감사하는 VM 확장 배포
...
- \[미리 보기\]: Windows VM에서 이전 24개 암호를 다시 사용할 수 없는지 감사
- \[미리 보기\]: Windows VM에 최대 암호 사용 기간이 70일로 설정되어 있는지 감사
- \[미리 보기\]: Windows VM에 최소 암호 사용 기간이 1일로 설정되어 있는지 감사
- \[미리 보기\]: Windows VM에서 암호 복잡성 설정이 사용되는지 감사
- \[미리 보기\]: Windows VM에서 최소 암호 길이가 14자로 제한되어 있는지 감사
- \[미리 보기\]: Windows VM이 해독 가능한 암호화를 사용하여 암호를 저장하는지 감사
- \[미리 보기\]: Windows VM에서 이전 24개 암호를 다시 사용할 수 없는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM에 최대 암호 사용 기간이 70일로 설정되어 있는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM에 최소 암호 사용 기간이 1일로 설정되어 있는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM에서 암호 복잡성 설정이 사용되는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM에서 최소 암호 길이가 14자로 제한되어 있는지 감사하는 VM 확장 배포
- \[미리 보기\]: Windows VM이 해독 가능한 암호화를 사용하여 암호를 저장하는지 감사하는 VM 확장 배포
...
- Advanced Data Security 없이 SQL 서버 감사
- SQL 서버에 Advanced Data Security 배포
- \[미리 보기\]: Azure Security Center에서 가상 머신 확장 집합의 OS 취약성 감사
- \[미리 보기\]: Azure Security Center에서 OS 취약성 모니터링
- \[미리 보기\]: Azure Security Center에서 SQL 취약성 평가 결과 모니터링
- \[미리 보기\]: Azure Security Center에서 VM 취약성 모니터링
...
- \[미리 보기\]: 가상 네트워크에 DDoS 보호 표준 계층을 사용하도록 설정했는지 감사
...
- \[미리 보기\]: 인터넷 연결 가상 머신에서 네트워크 보안 그룹 트래픽 강화 권장 사항 모니터링
- \[미리 보기\]: Azure Security Center에서 관대한 네트워크 액세스 모니터링
- \[미리 보기\]: Azure Security Center에서 보호되지 않은 네트워크 엔드포인트 모니터링
- \[미리 보기\]: Azure Security Center에서 보호되지 않은 웹 애플리케이션 모니터링
- 스토리지 계정에 대한 무제한 네트워크 액세스 감사
...
- \[미리 보기\]: Azure Security Center에서 가상 머신 확장 집합의 누락된 시스템 업데이트 감사
- \[미리 보기\]: Azure Security Center에서 가상 머신 확장 집합의 OS 취약성 감사
- \[미리 보기\]: Azure Security Center에서 누락된 시스템 업데이트 모니터링
- \[미리 보기\]: Azure Security Center에서 OS 취약성 모니터링
- \[미리 보기\]: Azure Security Center에서 SQL 취약성 평가 결과 모니터링
- \[미리 보기\]: Azure Security Center에서 VM 취약성 모니터링
...
- \[미리 보기\]: Azure Security Center에서 가상 머신 확장 집합의 엔드포인트 보호 솔루션 감사
- \[미리 보기\]: Azure Security Center에서 누락된 Endpoint Protection 모니터링
...
지금까지 NIST SP 800-53 R4 청사진의 컨트롤 매핑을 살펴보았으므로 이제 다음 문서를 참조하여 청사진 및 이 샘플을 배포하는 방법에 대해 알아보세요.

> [!div class="nextstepaction"]
> [NIST SP 800-53 R4 청사진 - 개요](./index.md)
> [NIST SP 800-53 R4 청사진 - 배포 단계](./deploy.md)
