...
컨트롤 매핑 섹션에서는 이 청사진에 포함된 정책과 이러한 정책이 DoD 영향 수준 4의 다양한 컨트롤을 처리하는 방법에 대해 자세히 설명합니다. 아키텍처에 할당된 리소스는 할당된 정책을 준수하지 않는지 Azure 정책에서 평가됩니다. 자세한 내용은 [Azure Policy](../../../policy/overview.md)를 참조하세요.

## <a name="next-steps"></a>다음 단계

DoD 영향 수준 4 청사진 샘플의 개요를 살펴봤습니다. 이제 다음 문서를 참조하여 컨트롤 매핑 및 이 샘플을 배포하는 방법에 대해 알아보세요.

> [!div class="nextstepaction"]
> [DoD 영향 수준 4 청사진 - 제어 매핑](./control-mapping.md)
