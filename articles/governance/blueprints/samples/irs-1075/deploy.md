...
ms.locfileid: "106386537"
---
# <a name="deploy-the-irs-1075-blueprint-sample"></a>IRS 1075 청사진 샘플 배포

Azure Blueprints IRS 1075(Rev.11-2016) 청사진 샘플을 배포하려면 다음 단계를 수행해야 합니다.
...
1. **IRS 1075(Rev.11-2016)** 청사진 샘플을 _다른 샘플_ 아래에서 찾아 **이 샘플 사용** 을 선택합니다.

1. 청사진 샘플의 _기본 사항_ 을 입력합니다.

   - **청사진 이름**: IRS 1075(Rev.11-2016) 청사진 샘플 사본의 이름을 지정합니다.
...
지금까지 IRS 1075(Rev.11-2016) 청사진 샘플을 배포하는 단계를 살펴보았으므로 이제 다음 문서를 참조하여 청사진 및 컨트롤 매핑에 대해 알아보세요.
