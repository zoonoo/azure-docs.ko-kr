...
description: IRS 1075 청사진 샘플의 컨트롤 매핑. 각 컨트롤은 평가를 지원하는 하나 이상의 Azure Policy 정의에 매핑됩니다.
ms.date: 04/02/2021
ms.topic: sample
...
ms.locfileid: "106386570"
---
# <a name="control-mapping-of-the-irs-1075-blueprint-sample"></a>IRS 1075 청사진 샘플의 컨트롤 매핑

다음 문서에서는 Azure Blueprints IRS 1075 청사진 샘플을 IRS 1075 컨트롤에 매핑하는 방법을 자세히 설명합니다. 컨트롤에 대한 자세한 내용은 [IRS 1075](https://www.irs.gov/pub/irs-pdf/p1075.pdf)를 참조하세요.

다음은 **IRS 1075** 컨트롤에 대한 매핑입니다. 특정 컨트롤 매핑으로 바로 점프하려면 오른쪽의 탐색 기능을 사용합니다. 많은 매핑된 컨트롤은 [Azure Policy](../../../policy/overview.md) 이니셔티브를 사용하여 구현됩니다. 전체 이니셔티브를 검토하려면 Azure Portal에서 **정책** 을 열고 **정의** 페이지를 선택합니다. 그런 다음, **\[미리 보기\]: IRS 1075 컨트롤 감사 및 감사 요구 사항을 지원하기 위한 특정 VM 확장 배포** 기본 제공 정책 이니셔티브를 찾아서 선택합니다.

> [!IMPORTANT]
> 아래의 각 컨트롤은 하나 이상의 [Azure Policy](../../../policy/overview.md) 정의와 연결되어 있습니다. 이러한 정책은 컨트롤을 사용한 [규정 준수 평가](../../../policy/how-to/get-compliance-data.md)에 도움이 될 수 있지만, 컨트롤과 하나 이상의 정책 간에 일대일 또는 완벽한 일치 관계가 없는 경우도 많습니다. 따라서 Azure Policy의 **규정 준수** 는 정책 자체만 가리킬 뿐, 컨트롤의 모든 요구 사항을 완벽하게 준수한다는 것은 아닙니다. 또한 규정 준수 표준에는 현재 Azure Policy 정의에서 처리되지 않은 컨트롤이 포함되어 있습니다. 따라서 Azure Policy의 규정 준수는 전반적인 규정 준수 상태를 부분적으로 표시할 뿐입니다. 이 규정 준수 청사진 샘플에 대한 컨트롤과 Azure Policy 정의 간의 연결은 시간이 지남에 따라 변경될 수 있습니다. 변경 기록을 보려면 [GitHub 커밋 기록](https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/governance/blueprints/samples/irs-1075/control-mapping.md)을 참조하세요.

## <a name="9321-ac-2-account-management"></a>9.3.2.1 AC-2 계정 관리
...
## <a name="9321-ac-2-7-account-management--role-based-schemes"></a>9.3.2.1 AC-2 (7) 계정 관리 | 역할 기반 체계
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) 계정 관리 | 계정 모니터링/비정상적 사용
...
## <a name="9314-ac-4-information-flow-enforcement"></a>9.3.1.4 AC-4 정보 흐름 적용
...
## <a name="9315-ac-5-separation-of-duties"></a>9.3.1.5 AC-5 의무 분리
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) 최소 권한 | 사용자 권한 검토
...
## <a name="9313-au-3-2-content-of-audit-records--centralized-management-of-planned-audit-record-content"></a>9.3.1.3 AU-3 (2) 감사 레코드의 콘텐츠 | 계획된 감사 레코드 콘텐츠의 중앙 집중식 관리
...
## <a name="9335-au-5-response-to-audit-processing-failures"></a>9.3.3.5 AU-5 감사 처리 실패에 대한 응답
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) 감사 검토, 분석 및 보고 | 중앙 검토 및 분석
...
## <a name="93311-au-12-audit-generation"></a>9.3.3.11 AU-12 감사 생성
...
## <a name="9357-cm-7-2-least-functionality--prevent-program-execution"></a>9.3.5.7 CM-7 (2) 최소한의 기능 | 프로그램 실행 금지
...
## <a name="9357-cm-7-5-least-functionality--authorized-software--whitelisting"></a>9.3.5.7 CM-7 (5) 최소한의 기능 | 권한이 부여된 소프트웨어/허용 목록
...
## <a name="93511-cm-11-user-installed-software"></a>9.3.5.11 CM-11 사용자가 설치한 소프트웨어
...
## <a name="9366-cp-7-alternate-processing-site"></a>9.3.6.6 CP-7 대체 처리 사이트
...
## <a name="9372-ia-2-1-identification-and-authentication-organizational-users--network-access-to-privileged-accounts"></a>9.3.7.2 IA-2 (1) 식별 및 인증(조직 사용자) | 네트워크를 통해 권한 있는 계정에 액세스
...
## <a name="9372-ia-2-2-identification-and-authentication-organizational-users--network-access-to-non-privileged-accounts"></a>9.3.7.2 IA-2 (2) 식별 및 인증(조직 사용자) | 권한 없는 계정에 대한 네트워크 액세스
...
## <a name="9375-ia-5-authenticator-management"></a>9.3.7.5 IA-5 인증자 관리
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) 인증자 관리 | 암호 기반 인증
...
## <a name="93143-ra-5-vulnerability-scanning"></a>9.3.14.3 RA-5 취약성 검색
...
## <a name="93164-sc-5-denial-of-service-protection"></a>9.3.16.4 SC-5 서비스 거부 방지
...
## <a name="93165-sc-7-boundary-protection"></a>9.3.16.5 SC-7 경계 보호
...
## <a name="93165-sc-7-3-boundary-protection--access-points"></a>9.3.16.5 SC-7 (3) 경계 보호 | 액세스 지점
...
## <a name="93165-sc-7-4-boundary-protection--external-telecommunications-services"></a>9.3.16.5 SC-7 (4) 경계 보호 | 외부 원격 통신 서비스
...
## <a name="96163-sc-8-1-transmission-confidentiality-and-integrity--cryptographic-or-alternate-physical-protection"></a>9.6.16.3 SC-8 (1) 전송 기밀성 및 무결성 | 암호화 또는 대체 물리적 보호
...
## <a name="93166-sc-28-1-protection-of-information-at-rest--cryptographic-protection"></a>9.3.16.6 SC-28 (1) 저장 정보 보호 | 암호화 보호
...
## <a name="93172-si-2-flaw-remediation"></a>9.3.17.2 SI-2 결함 수정
...
## <a name="93173-si-3-malicious-code-protection"></a>9.3.17.3 SI-3 악성 코드 방지
...
## <a name="93173-si-3-1-malicious-code-protection--central-management"></a>9.3.17.3 SI-3 (1) 악성 코드 방지 | 중앙 관리
...
## <a name="93174-si-4-information-system-monitoring"></a>9.3.17.4 SI-4 정보 시스템 모니터링
...
## <a name="93174-si-4-18-information-system-monitoring--analyze-traffic--covert-exfiltration"></a>9.3.17.4 SI-4 (18) 정보 시스템 모니터링 | 트래픽 분석 / 비밀 반출
...
지금까지 IRS 1075 청사진의 컨트롤 매핑을 살펴보았으므로 이제 다음 문서를 참조하여 청사진 및 이 샘플을 배포하는 방법에 대해 알아보세요.

> [!div class="nextstepaction"]
> [IRS 1075 청사진 - 개요](./index.md)
