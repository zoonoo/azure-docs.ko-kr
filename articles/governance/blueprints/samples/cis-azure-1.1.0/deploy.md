...
CIS Microsoft Azure Foundations Benchmark 청사진 샘플을 배포하는 단계를 살펴보았으므로, 이제 다음 문서를 참조하여 청사진 및 컨트롤 매핑에 대해 알아보세요.

> [!div class="nextstepaction"]
> [CIS Microsoft Azure Foundations Benchmark 청사진- 개요](./index.md)
> [CIS Microsoft Azure Foundations Benchmark 청사진 - 컨트롤 매핑](./control-mapping.md)
