...
추천 매핑 섹션에는 이 청사진에 포함된 정책 및 이러한 정책이 CIS Microsoft Azure Foundations Benchmark v1.1.0의 다양한 추천을 처리하는 방법에 대한 세부 정보가 제공됩니다. 아키텍처에 할당된 리소스는 할당된 정책을 준수하지 않는지 Azure 정책에서 평가됩니다. 자세한 내용은 [Azure Policy](../../../policy/overview.md)를 참조하세요.
...
> [CIS Microsoft Azure Foundations Benchmark 청사진- 추천 매핑](./control-mapping.md)
