...
다음 매핑은 **영국 공식** 및 **영국 nhs** 컨트롤에 대 한 것입니다. 특정 컨트롤 매핑으로 바로 점프하려면 오른쪽의 탐색 기능을 사용합니다. 많은 매핑된 컨트롤은 [Azure Policy](../../../policy/overview.md) 이니셔티브를 사용하여 구현됩니다. 전체 이니셔티브를 검토하려면 Azure Portal에서 **정책**을 열고 **정의** 페이지를 선택합니다. 그런 다음 **\[\] PREVIEW 영국 공식 및 영국 NHS 컨트롤을 찾아 선택 하 고 감사 요구 사항 기본 제공 정책 이니셔티브를 지원 하도록 특정 VM 확장을 배포** 합니다.
...
- \[Preview\]: 감사 Linux VM/etc/passwd file 권한이 0644로 설정 되어 있습니다.
...
- \[미리 보기\]: 암호 복잡성 설정이 사용 하도록 설정 되지 않은 Windows Vm을 감사 하는 요구 사항을 배포 합니다.
- \[Preview\]: 70 일의 최대 암호 사용 기간을 포함 하지 않는 Windows Vm을 감사 하는 요구 사항을 배포 합니다.
- \[Preview\]: 최소 암호 사용 기간이 1 일인 Windows Vm을 감사 하는 요구 사항 배포
...
- \[Preview\]: 최소 암호 사용 기간이 1 일인 Windows Vm 감사
...
- \[미리 보기\]: 암호 없이 계정에서 원격 연결을 허용 하는 Linux Vm을 감사 하는 요구 사항 배포
