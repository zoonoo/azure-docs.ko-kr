...
- 게이트웨이 서브넷은 네트워크 보안 그룹을 사용하여 구성해서는 안 됨
- 스토리지 계정은 가상 네트워크 서비스 엔드포인트를 사용해야 함
- \[미리 보기\]: Container Registry는 가상 네트워크 서비스 엔드포인트를 사용해야 함
- 내부 가상 머신에 적응형 네트워크 강화 권장 사항을 적용해야 합니다.
...
- \[미리 보기\]: Windows 가상 머신에 네트워크 트래픽 데이터 수집 에이전트를 설치해야 합니다.
- \[미리 보기\]: Linux 가상 머신에 네트워크 트래픽 데이터 수집 에이전트를 설치해야 합니다. Network Watcher를 활성화해야 합니다.
...
- \[미리 보기\]: 안전하지 않은 암호 보안 설정이 있는 VM 감사
...
- \[미리 보기\]: 필수 조건을 배포하여 Log Analytics 에이전트가 예상대로 연결되지 않은 Windows VM 감사
- \[미리 보기\]: Log Analytics 에이전트가 예상대로 연결되지 않은 Windows VM의 감사 결과 표시
...
- \[미리 보기\]: '사용자 권한 할당'에서 Windows VM 구성의 감사 결과 표시
- \[미리 보기\]: 필수 조건을 배포하여 '보안 옵션 - 사용자 계정 컨트롤'에서 Windows VM 구성 감사
- \[미리 보기\]: '보안 옵션 - 사용자 계정 컨트롤'에서 Windows VM 구성의 감사 결과 표시
...
- \[미리 보기\]: 필수 조건을 배포하여 '보안 옵션 - 복구 콘솔'에서 Windows VM 구성 감사
