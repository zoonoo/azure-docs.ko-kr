...
청사진은 기존의 CRUD(만들기/읽기/업데이트/삭제) 수명 주기 작업을 지원하지만 코드(IaC(Infrastructure as Code)라는 DevOps의 핵심 요소)를 통해 해당 인프라를 관리하여 사용하기 위한 일반적인 CI/CD(지속적인 통합/지속적인 배포) 파이프라인을 지원하는 추가 수준의 상태를 제공하도록 빌드합니다.
...
청사진을 만들 때 아티팩트를 추가하고, 관리 그룹에 저장하고, 고유 이름과 고유 버전을 제공합니다. 이 시점에서 청사진은 **초안** 모드에 있으며 아직 할당될 수 없습니다. 그러나 **초안** 모드에 있는 동안 계속해서 업데이트 및 변경될 수 있습니다.

게시되지 않은 **초안** 모드의 청사진은 **게시된** 것과 다른 아이콘을 **청사진 정의** 페이지에 표시합니다. **최신 버전**도 이러한 게시되지 않은 청사진에 대해 **초안**으로 표시됩니다.
...
**초안** 모드의 청사진에 원하는 모든 변경 내용이 적용되면 **게시**되고 할당에 사용될 수 있습니다. 청사진의 **게시된** 버전은 변경될 수 없습니다.
...
**게시된** 버전의 청사진을 변경할 수 없지만 새 버전의 청사진을 기존 청사진에 추가하고 필요에 따라 수정할 수 있습니다. 기존 청사진을 변경하여 이루어집니다. 청사진이 이미 **게시된** 경우 이러한 변경 내용이 저장되면 청사진 정의 목록에 **게시되지 않은 변경 내용**으로 표시됩니다. 변경 내용을 저장하면 청사진의 **초안** 버전도 저장됩니다.
...
청사진의 첫 번째 버전이 **게시된** 것처럼 할당하려면 해당 동일한 청사진의 각 후속 버전은 할당되기 전에 **게시**되어야 합니다. **게시되지 않은 변경 내용**이 청사진에 적용되었지만 아직 **게시**되지 않은 경우 **청사진 게시** 단추를 청사진 편집 페이지에서 사용할 수 있습니다. 단추가 보이지 않는 경우 청사진은 이미 **게시**되었지만 **게시되지 않은 변경 내용**이 없는 것입니다.

> [!NOTE]
> 하나의 청사진에는 각각 구독에 할당될 수 있는 여러 개의 **게시된** 버전이 있을 수 있습니다.

기존 청사진의 새 버전으로 **게시되지 않은 변경 내용**을 사용하여 청사진을 게시하는 단계는 새 청사진을 게시하는 단계와 동일합니다.

## <a name="deleting-a-specific-version-of-the-blueprint"></a>특전 버전의 청사진 삭제

청사진의 각 버전은 고유한 개체이며 개별적으로 **게시**될 수 있습니다. 즉, 청사진의 각 버전을 삭제할 수 있습니다. 청사진의 버전을 삭제하는 것은 해당 청사진의 다른 버전에 영향을 주지 않습니다.

> [!NOTE]
> 활성 할당이 있는 청사진을 삭제하는 것은 불가능합니다. 먼저 할당을 삭제한 다음, 제거하려는 버전을 삭제합니다.

1. **모든 서비스**를 클릭하고 왼쪽 창에서 **정책**을 검색하고 선택하여 Azure Portal에서 Azure Blueprint 서비스를 시작합니다. **정책** 페이지에서 **청사진**을 클릭합니다.
...
코어 청사진을 삭제할 수도 있습니다. 코어 청사진을 삭제하면 **초안** 또는 **게시됨** 상태와 관계없이 해당 청사진의 모든 청사진 버전도 삭제됩니다. 청사진의 버전을 삭제하는 것과 마찬가지로 코어 청사진을 삭제해도 청사진 버전의 기존 할당이 제거되지 않습니다.
...
청사진을 구독에 할당할 수 있는 수명 주기 동안 몇 가지 사항이 있습니다.
청사진의 버전 모드가 **게시**되었을 때마다 해당 버전을 구독에 할당할 수 있습니다. 청사진의 **초안** 버전이 있는 경우에도 **게시됨** 모드에 하나 이상의 청사진 버전이 있으면 해당 **게시됨** 버전을 할당할 수 있습니다. 이를 통해 새 버전이 개발되는 동안 청사진의 버전을 사용하고 적극적으로 할당할 수 있습니다.
...
- [청사진 리소스 잠금](resource-locking.md)을 활용하는 방법 확인
