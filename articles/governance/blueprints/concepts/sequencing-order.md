...
큰 청사진 정의를 작성할 때 리소스를 특정 순서로 만들어야 할 수 있습니다. 이 시나리오에서 가장 일반적인 사용 패턴은 Blueprint 정의에 여러 Azure 리소스 관리자 템플릿이 포함되어 있는 경우입니다. Blueprints는 시퀀싱 순서를 정의할 수 있도록 허용하여 이 패턴을 처리합니다.
