...
## <a name="a-nameapiversion-show-resource-types-and-api-versions"></a><a name="apiversion" />리소스 유형 및 API 버전 표시
...
- Azure China Portal: <a href="https://portal.azure.cn/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20distinct%20type%2C%20apiVersion%20%7C%20where%20isnotnull(apiVersion)%20%7C%20order%20by%20type%20asc" target="_blank">portal.azure.cn</a> ![새 창에서 링크 열기 아이콘](../../media/new-window.png)

---

## <a name="a-namevmss-capacity-get-virtual-machine-scale-set-capacity-and-size"></a><a name="vmss-capacity" />가상 머신 확장 집합 용량 및 크기 가져오기
...
## <a name="a-nameremove-column-remove-columns-from-results"></a><a name="remove-column" />결과에서 열 제거
...
## <a name="a-namelist-all-tags-list-all-tag-names"></a><a name="list-all-tags" />모든 태그 이름 나열
...
- Azure Government Portal: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20project%20tags%20%7C%20summarize%20buildschema(tags)" target="_blank">portal.azure.us</a> ![새 창에서 링크 열기 아이콘](../../media/new-window.png)
- Azure China Portal: <a href="https://portal.azure.cn/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20project%20tags%20%7C%20summarize%20buildschema(tags)" target="_blank">portal.azure.cn</a> ![새 창에서 링크 열기 아이콘](../../media/new-window.png)

---

## <a name="a-namevm-regex-virtual-machines-matched-by-regex"></a><a name="vm-regex" />정규식과 일치하는 가상 머신
...
## <a name="a-namemvexpand-cosmosdb-list-cosmos-db-with-specific-write-locations"></a><a name="mvexpand-cosmosdb" />특정 쓰기 위치를 사용하여 Cosmos DB 나열
...
## <a name="a-namejoin-key-vault-with-subscription-name"></a><a name="join" />구독 이름이 있는 Key Vault
...
- Azure Government Portal: <a href="https://portal.azure.us/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20join%20(ResourceContainers%20%7C%20where%20type%3D%3D'microsoft.resources%2Fsubscriptions'%20%7C%20project%20SubName%3Dname%2C%20subscriptionId)%20on%20subscriptionId%20%7C%20where%20type%20%3D%3D%20'microsoft.keyvault%2Fvaults'%20%7C%20project%20type%2C%20name%2C%20SubName%7C%20limit%201" target="_blank">portal.azure.us</a> ![새 창에서 링크 열기 아이콘](../../media/new-window.png)
- Azure China Portal: <a href="https://portal.azure.cn/?feature.customportal=false#blade/HubsExtension/ArgQueryBlade/query/Resources%20%7C%20join%20(ResourceContainers%20%7C%20where%20type%3D%3D'microsoft.resources%2Fsubscriptions'%20%7C%20project%20SubName%3Dname%2C%20subscriptionId)%20on%20subscriptionId%20%7C%20where%20type%20%3D%3D%20'microsoft.keyvault%2Fvaults'%20%7C%20project%20type%2C%20name%2C%20SubName%7C%20limit%201" target="_blank">portal.azure.cn</a> ![새 창에서 링크 열기 아이콘](../../media/new-window.png)

---

## <a name="a-namejoin-sql-list-sql-databases-and-their-elastic-pools"></a><a name="join-sql" />SQL Database 및 탄력적 풀 나열
...
## <a name="a-namejoin-vmpip-list-virtual-machines-with-their-network-interface-and-public-ip"></a><a name="join-vmpip" />네트워크 인터페이스 및 공용 IP를 사용하여 가상 머신 나열
...
## <a name="a-namejoin-findstoragetag-find-storage-accounts-with-a-specific-tag-on-the-resource-group"></a><a name="join-findstoragetag" />리소스 그룹에서 특정 태그를 사용하여 스토리지 계정 찾기

다음 쿼리는 **inner** `join`를 사용하여 스토리지 계정을 지정된 대/소문자 구분 태그 이름 및 태그 값을 가진 리소스 그룹에 연결합니다.
...
대/소문자를 구분하지 않는 태그 이름 및 태그 값을 검색해야 하는 경우에는 **bagexpansion** 매개 변수와 함께 `mvexpand`를 사용합니다. 이 쿼리는 이전 쿼리보다 많은 할당량을 사용하므로 필요한 경우에만 `mvexpand`를 사용합니다.
...
## <a name="a-nameunionresults-combine-results-from-two-queries-into-a-single-result"></a><a name="unionresults" />두 쿼리의 결과를 단일 결과로 결합
...
## <a name="a-namedisplaynames-include-the-tenant-and-subscription-names-with-displaynames"></a><a name="displaynames" />DisplayNames를 사용한 테넌트 및 구독 이름 포함
