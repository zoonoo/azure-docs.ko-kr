...
> [!NOTE]
> **First**를 사용 하는 경우 `asc` 또는 `desc` 인 하나 이상의 열을 기준으로 결과를 정렬 하는 것이 좋습니다. 정렬 하지 않으면 반환 된 결과가 무작위로 반환 되 고 반복 되지 않습니다.
...
> [!NOTE]
> **Skip**을 사용 하는 경우 `asc` 또는 `desc` 인 하나 이상의 열을 기준으로 결과를 정렬 하는 것이 좋습니다. 정렬 하지 않으면 반환 된 결과가 무작위로 반환 되 고 반복 되지 않습니다.
