...
ms.locfileid: "77170041"
---
# <a name="azure-policy-built-in-policy-definitions"></a>Azure Policy 기본 제공 정책 정의

이 페이지는 Azure Policy 기본 제공 정책 정의의 인덱스입니다.

각 기본 제공 기능의 이름은 [Azure Policy GitHub 리포지토리](https://github.com/Azure/azure-policy)의 정책 정의 원본에 연결됩니다. 기본 제공 기능은 **메타데이터**의 **범주** 속성을 기준으로 그룹화됩니다. 특정 **범주**로 이동하려면 페이지 오른쪽에 있는 메뉴를 사용합니다. 그렇지 않으면 <kbd>Ctrl</kbd>-<kbd>F</kbd>를 사용하여 브라우저의 검색 기능을 사용합니다.
