...
description: 이 샘플 정책 정의에서는 사용자 지정 이미지가 매개 변수에 정의된 승인된 리소스 그룹의 이미지여야 합니다.
ms.date: 01/23/2019
ms.topic: sample
