...
다음 문서에서는 Azure Policy 규정 준수 기본 제공 이니셔티브 정의가 CIS Microsoft Azure Foundations 벤치마크에 대한 **규정 준수 도메인** 및 **컨트롤**에 매핑되는 방법을 자세히 설명합니다.
...
### <a name="ensure-that-email-service-and-co-administrators-is-enabled"></a>'이메일 서비스 및 공동 관리자'가 '사용'으로 설정되어 있는지 확인

**ID**: CIS Azure 4.7 **소유권**: Customer

|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[SQL 관리형 인스턴스 Advanced Data Security 설정에는 관리자 및 구독 소유자에게 이메일 알림을 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Faeb23562-188d-47cb-80b8-551f16ef9fff) |SQL 관리형 인스턴스 고급 위협 탐지 설정에 ‘관리자 및 구독 소유자에 대한 이메일 알림’이 사용하도록 설정되었는지 감사합니다. 이렇게 하면 SQL 관리형 인스턴스에서 검색된 모든 비정상적 활동이 관리자에게 가능한 한 빨리 보고됩니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurityEmailAdmins_Audit.json) |
|[SQL 서버 Advanced Data Security 설정에는 관리자 및 구독 소유자에게 이메일 알림을 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc8343d2f-fdc9-4a97-b76f-fc71d1163bfc) |SQL 서버의 고급 위협 탐지 설정에 '관리자 및 구독 소유자에 대한 이메일 알림'이 사용하도록 설정되었는지 감사합니다. 이렇게 하면 SQL 서버에서 검색된 모든 비정상적 활동이 관리자에게 가능한 한 빨리 보고됩니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlServer_AdvancedDataSecurityEmailAdmins_Audit.json) |

### <a name="ensure-that-send-alerts-to-is-set"></a>'경고 전송 대상'이 설정되어 있는지 확인

**ID**: CIS Azure 4.6 **소유권**: Customer

|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[SQL 관리형 인스턴스에 대한 Advanced Data Security 설정에는 보안 경고를 받을 이메일 주소가 포함되어야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F3965c43d-b5f4-482e-b74a-d89ee0e0b3a8) |Advanced Data Security 서버 설정에서 '경고 전송 대상' 필드에 이메일 주소가 지정되었는지 확인합니다. 이 이메일 주소는 SQL 관리형 인스턴스에서 비정상적인 활동이 감지될 때 경고 알림을 받습니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurityEmails_Audit.json) |
|[SQL 서버에 대한 Advanced Data Security 설정에는 보안 경고를 받을 이메일 주소가 포함되어야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F9677b740-f641-4f3c-b9c5-466005c85278) |Advanced Data Security 서버 설정에서 '경고 전송 대상' 필드에 이메일 주소가 지정되었는지 확인합니다. 이 이메일 주소는 SQL 서버에서 비정상적인 활동이 감지될 때 경고 알림을 받습니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlServer_AdvancedDataSecurityEmails_Audit.json) |

### <a name="ensure-that-threat-detection-types-is-set-to-all"></a>'위협 탐지 유형'이 '모두'로 설정되어 있는지 확인

**ID**: CIS Azure 4.5 **소유권**: Customer

|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[SQL 관리형 인스턴스의 Advanced Data Security 설정에서 Advanced Threat Protection 유형을 '모두'로 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fbda18df3-5e41-4709-add9-2554ce68c966) |SQL 서버에서 모든 Advanced Threat Protection 유형을 사용하도록 설정하는 것이 좋습니다. 모든 유형을 사용하도록 설정하면 SQL 삽입, 데이터베이스 취약성 및 기타 비정상적인 활동을 방지할 수 있습니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_EnsureThreatDetectionTypes_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[사용자 지정 구독 소유자 역할이 없어야 함](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F10ee2ea2-fb4d-45b8-a7e9-a2e770044cd9) |이 정책은 사용자 지정 구독 소유자 역할이 없도록 합니다. |감사, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/General/CustomSubscription_OwnerRole_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[인터넷 연결 가상 머신은 네트워크 보안 그룹과 함께 보호되어야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff6de0be7-9a8a-4b8a-b349-43cf02d22f7c) |NSG(네트워크 보안 그룹)를 통해 VM에 대한 액세스를 제한하여 잠재적인 위협으로부터 VM을 보호합니다. NSG를 사용하여 트래픽을 제어하는 방법에 대해 자세히 알아보려면 [https://aka.ms/nsg-doc](https://aka.ms/nsg-doc)를 참조하세요. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_NetworkSecurityGroupsOnVirtualMachines_Audit.json) |
...
- [이니셔티브 정의 구조](../concepts/initiative-definition-structure.md)를 참조하세요.
- [Azure Policy 샘플](./index.md)에서 다른 예제를 검토합니다.
