...
### <a name="maintain-secure-azure-resource-configurations"></a>보안 Azure 리소스 구성 유지 관리

**ID**: Azure Security Benchmark 7.3 **소유권**: Customer
...
### <a name="implement-automated-configuration-monitoring-for-azure-services"></a>Azure 서비스에 대한 자동화된 구성 모니터링 구현

**ID**: Azure Security Benchmark 7.9 **소유권**: Customer
