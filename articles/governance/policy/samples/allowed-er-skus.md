---
title: Azure Policy 샘플 - 허용되는 ExpressRoute SKU
description: 이 샘플 정책에서는 ExpressRoute가 승인된 SKU를 사용해야 합니다.
...
ms.locfileid: "50248054"
---
# <a name="allowed-expressroute-skus"></a>허용되는 ExpressRoute SKU

이 정책에서는 ExpressRoute가 승인된 SKU를 사용해야 합니다. 허용되는 SKU 배열을 지정합니다.
