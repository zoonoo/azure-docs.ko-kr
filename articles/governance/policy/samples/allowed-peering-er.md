---
title: Azure Policy 샘플 - 허용되는 Express Route 피어링 위치
description: 이 정책에서는 Express Routes가 지정된 피어링 위치를 사용해야 합니다.
...
ms.locfileid: "46946921"
---
# <a name="allowed-peering-location-for-express-route"></a>허용되는 Express Route 피어링 위치

이 정책에서는 Express Routes가 지정된 피어링 위치를 사용해야 합니다. 허용되는 피어링 위치 배열을 지정합니다.
...
- [Azure Policy 샘플](index.md)에서 추가 샘플 검토