...
다음 문서에서는 Azure Policy 규정 준수 기본 제공 이니셔티브 정의가 NIST SP 800-53 R4에 대한 **규정 준수 도메인** 및 **컨트롤**에 매핑되는 방법을 자세히 설명합니다.
...
그런 다음, **[미리 보기]: NIST SP 800-53 R4 컨트롤 감사 및 감사 요구 사항을 지원하기 위한 특정 VM 확장 배포** 규정 준수 기본 제공 이니셔티브 정의를 찾아서 선택합니다.
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[SQL 관리형 인스턴스에서 Advanced Data Security를 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb7388-5bf4-4ad7-ba99-2cd2f41cebb9) |Advanced Data Security 없이 SQL 관리형 인스턴스 감사 |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurity_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[\[미리 보기\]: Log Analytics 에이전트 배포 감사 - 목록에 없는 VM 이미지(OS)](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F32133ab0-ee4b-4b44-98d6-042180979d50) |VM 이미지(OS)가 정의된 목록에 없고 에이전트가 설치되어 있지 않은 경우 VM을 비준수로 보고합니다. OS 이미지 목록은 향후 지원이 업데이트되면 업데이트됩니다. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Monitoring/LogAnalytics_OSImage_Audit.json) |
|[SQL 관리형 인스턴스에서 Advanced Data Security를 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb7388-5bf4-4ad7-ba99-2cd2f41cebb9) |Advanced Data Security 없이 SQL 관리형 인스턴스 감사 |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlManagedInstance_AdvancedDataSecurity_Audit.json) |
|[SQL 서버에서 Advanced Data Security를 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fabfb4388-5bf4-4ad7-ba82-2cd2f41ceae9) |Advanced Data Security 없이 SQL 서버 감사 |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/SQL/SqlServer_AdvancedDataSecurity_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[가상 머신에서 적응형 애플리케이션 제어를 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F47a6b606-51aa-4496-8bb7-64b11cf66adc) |가능한 애플리케이션 허용 목록 구성은 Azure Security Center에서 모니터링됩니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_AppWhitelistMonitoring_Audit.json) |
...
|[암호 파일 권한이 0644로 설정되지 않은 Linux VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fb18175dd-c599-4c64-83ba-bb018a06d35b) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 파일 권한이 0644로 설정되지 않은 Linux 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword121_Audit.json) |
|[암호 없는 계정이 있는 Linux VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fc40c9087-1981-4e73-9f53-39743eda9d05) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 없는 계정이 있는 Linux 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.1.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_LinuxPassword232_Audit.json) |
|[해독 가능한 암호화를 사용하여 암호를 저장하지 않는 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 해독 가능한 암호화를 사용하여 암호를 저장하지 않는 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|[이전 24개 암호의 재사용을 허용하는 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fcdbf72d9-ac9c-4026-8a3a-491a5ac59293) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 이전 24개 암호의 재사용을 허용하는 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEnforce_Audit.json) |
|[암호 최대 사용 기간이 70일로 설정되지 않은 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F24dde96d-f0b1-425e-884f-4a1421e2dcdc) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 최대 사용 기간이 70일로 설정되지 않은 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMaximumPassword_Audit.json) |
|[암호 최소 사용 기간이 1일로 설정되지 않은 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aa11bbc-5c76-4302-80e5-aba46a4282e7) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 최소 사용 기간이 1일로 설정되지 않은 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsMinimumPassword_Audit.json) |
|[암호 복잡성 설정이 사용되지 않는 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Ff48b2913-1dc5-4834-8c72-ccc1dfd819bb) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 복잡성 설정이 사용되지 않는 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordComplexity_Audit.json) |
|[암호 최소 길이가 14자로 제한되지 않는 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F5aebc8d1-020d-4037-89a0-02043a7524ec) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 암호 최소 길이가 14자로 제한되지 않는 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordLength_Audit.json) |
|[해독 가능한 암호화를 사용하여 암호를 저장하지 않는 Windows VM의 감사 결과 표시](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F2d60d3b7-aa10-454c-88a8-de39d99d17c6) |이 정책은 이니셔티브에서 해당 배포 정책과 함께 사용해야 합니다. 이 정의를 사용하면 Azure Policy에서 해독 가능한 암호화를 사용하여 암호를 저장하지 않는 Windows 가상 머신에 대한 감사 결과를 처리할 수 있습니다. 게스트 구성 정책에 대한 자세한 내용은 [https://aka.ms/gcpol](https://aka.ms/gcpol)을 방문하세요. |auditIfNotExists |[1.0.0-preview](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Guest%20Configuration/GuestConfiguration_WindowsPasswordEncryption_Audit.json) |
...
|Name<br /><sub>(Azure Portal)</sup> |Description |효과 |버전<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[DDoS Protection 표준을 사용하도록 설정해야 합니다.](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2Fa7aca53f-2ed4-4466-a25e-0b45ade68efd) |공용 IP를 사용하는 애플리케이션 게이트웨이의 일부인 서브넷이 포함된 모든 가상 네트워크에 DDoS 보호 표준을 사용하도록 설정해야 합니다. |AuditIfNotExists, 사용 안 함 |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/Security%20Center/ASC_EnableDDoSProtection_Audit.json) |
...
Azure Policy에 대한 추가 문서를 읽어보세요.

- [규정 준수](../concepts/regulatory-compliance.md) 개요
- [이니셔티브 정의 구조](../concepts/initiative-definition-structure.md)
- [Azure Policy 샘플](./index.md)의 다른 예제
- [정책 효과 이해](../concepts/effects.md)
- [규정 비준수 리소스 수정](../how-to/remediate-resources.md) 방법
