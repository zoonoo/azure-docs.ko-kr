...
description: 이 샘플 정책 정의에서는 SQL Server에 할당된 Azure Active Directory 관리자가 없을 때 감사를 수행합니다.
author: DCtheGeek
manager: carmonm
...
ms.locfileid: "59274215"
---
# <a name="sample---audit-no-azure-active-directory-administrator"></a>샘플 - Azure Active Directory 관리자가 없을 경우 감사
