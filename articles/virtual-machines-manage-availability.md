...
>[WACOM.NOTE] 관련 지침은 [가상 컴퓨터의 가용성 집합을 구성하는 방법][]을 참조하세요.
...
### 부하 분산 장치를 가용성 집합과 결합
Azure 부하 분산 장치를 가용성 집합과 결합하여 응용 프로그램 복원력을 극대화하세요. Azure 부하 분산 장치는 트래픽을 여러 가상 컴퓨터에 분산시킵니다. 표준 계층 가상 컴퓨터의 경우 Azure 부하 분산 장치가 포함되어 있습니다. 모든 가상 컴퓨터에 Azure 부하 분산 장치가 포함되어 있는 것은 아닙니다. 가상 컴퓨터 부하 분산에 대한 자세한 내용은 [가상 컴퓨터 부하 분산](../load-balance-virtual-machines/)을 읽어보세요. 
