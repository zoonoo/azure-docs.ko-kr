---
title: 공용 표준 부하 분산 장치 만들기 - Azure CLI | Microsoft Docs
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>Azure CLI 2.0을 사용하여 VM 부하를 분산하는 표준 부하 분산 장치 만들기
