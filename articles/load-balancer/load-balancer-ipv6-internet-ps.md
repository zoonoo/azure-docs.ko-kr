...
## <a name="create-virtual-machines-and-assign-the-newly-created-nics"></a>가상 컴퓨터를 만들고 새로 만든 NIC를 할당합니다.

VM 만들기에 대한 자세한 내용은 [리소스 관리자 및 Azure PowerShell을 사용하여 Windows 가상 컴퓨터 만들기 및 미리 구성](..\virtual-machines\virtual-machines-windows-ps-create.md)
