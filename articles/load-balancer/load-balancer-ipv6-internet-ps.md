...
자세한 내용은 [Azure Load Balancer 구성 요소](./components.md)를 참조 하세요.
...
2. 프런트 엔드 IP 주소 풀에 대한 Azure Public IP address (PIP) 리소스를 만듭니다. `-DomainNameLabel`다음 명령을 실행 하기 전에 값을 변경 해야 합니다. 값은 Azure 지역 내에서 고유 해야 합니다.
