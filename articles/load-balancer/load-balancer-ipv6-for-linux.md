...
2. 다음 구성을 사용하여 eth0 인터페이스에 대한 네트워크 구성을 편집합니다.
    ...
    * **Ubuntu 12.04 및 14.04**에서, 파일 `/etc/network/interfaces.d/eth0.cfg`를 편집합니다.
    * **Ubuntu 16.04**에서, 파일 `/etc/network/interfaces.d/50-cloud-init.cfg`를 편집합니다.
...
1. 파일 `/etc/systemd/network/10_dhcp.network`을 엽니다.
