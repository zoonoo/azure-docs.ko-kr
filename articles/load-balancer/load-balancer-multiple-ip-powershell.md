...
- 관리 및 부하 분산 장치에서 문제를 해결 하려면 Azure에서 다양 한 유형의 로그를 사용 하는 방법을 알아봅니다 [Azure Monitor는 Azure Load Balancer에 대 한 로그](../load-balancer/load-balancer-monitor-log.md)합니다.
