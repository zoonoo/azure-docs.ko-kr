...
사용할 수 있는 부하 분산 서비스 및 권장 사용에 대 한 [부하 분산 장치 기술 가이드](/azure/architecture/guide/technology-choices/load-balancing-overview)  를 참조 하세요.

## <a name="where-can-i-find-load-balancer-arm-templates"></a>Load Balancer ARM 템플릿은 어디에서 찾을 수 있나요?
일반적인 배포의 ARM 템플릿에 대 한 [Azure Load Balancer 빠른 시작 템플릿 목록을](/azure/templates/microsoft.network/loadbalancers#quickstart-templates) 참조 하세요.
