...
| SNAT 포트 릴리스 동작 | TCP | 서버/클라이언트 중 하나가 FINACK를 보내면 240초 후에 SNAT 포트가 해제됩니다. RST 표시 되 면 15 초 후에 SNAT 포트가 해제 됩니다. 유휴 시간 제한에 도달하면 포트가 해제됩니다.|
...
## <a name="outbound-rules"></a><a name="outboundrules"></a>아웃바운드 규칙
