...
>[!Note]
> 지정 된 가상 네트워크에서 단일 Ip 집합을 사용 해야 하는 많은 수의 아웃 바운드 연결 또는 기업 고객을 요구 하는 응용 프로그램의 경우에는 [NAT를 Virtual Network](../virtual-network/nat-overview.md) 하는 것이 좋습니다. 동적 할당은 간단한 구성을 허용 하 고 각 IP 주소에서 SNAT 포트를 가장 효율적으로 사용 하는 > 합니다. 또한 부하 분산 장치 > 공유 하지 않아도 가상 네트워크의 모든 리소스가 IP 주소 집합을 공유할 수 있습니다.
