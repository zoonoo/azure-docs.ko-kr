<properties
    pageTitle="Azure CLI를 사용하여 Azure Resource Manager에서 IPv6으로 인터넷 연결 부하 분산 장치 만들기 | Microsoft Azure"
...
1. PowerShell 변수를 설정합니다.
    ...
    >[AZURE.WARNING] 이 예제에서는 일반 텍스트로 VM에 대한 사용자 이름 및 비밀번호를 사용합니다. 일반 텍스트로 자격 증명을 사용하는 경우 적절한 주의를 기울여야 합니다. PowerShell에서 자격 증명을 처리하는 보다 안전한 방법은 [Get-Credential](https://technet.microsoft.com/library/hh849815.aspx) cmdlet를 참조하세요.
