...
1. 응용 프로그램에서 첫 번째 프로브가 도착하기 직전에 시간 시간 표시 프로브 응답을 생성하기 시작하면 이러한 이벤트를 감지하는 데 10초(2 x 5초 간격)와 첫 번째 프로브가 시간 시간을 알리기 시작하는 응용 프로그램의 지속 시간이 소요됩니다. 프로브가 도착합니다.  이 검색은 10초 가 약간 넘게 걸릴 것으로 가정할 수 있습니다.
