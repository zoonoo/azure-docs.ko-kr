...
1. 첫 번째 프로브가 도착 하기 바로 전에 응용 프로그램에서 시간 제한 프로브 응답을 생성 하기 시작 하는 경우 이러한 이벤트의 검색에는 10 초 (2 x 5 초 간격)와 응용 프로그램이 첫 번째 프로브 도착 시점에 대 한 제한 시간을 알리기 시작 하는 기간이 소요 됩니다.  이 검색은 10 초 이상 소요 된다고 가정할 수 있습니다.
