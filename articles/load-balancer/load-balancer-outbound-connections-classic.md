...
부하 분산된 VM에서 아웃바운드 흐름을 만드는 경우 Azure에서 아웃바운드 흐름의 프라이빗 원본 IP 주소를 부하 분산된 공용 엔드포인트의 공용 IP 주소로 변환합니다. Azure는 SNAT을 사용하여 이 기능을 수행합니다. 또한 Azure는 [PAT](#pat)를 사용하여 공용 IP 주소 뒤에서 여러 개인 IP 주소를 가장합니다. 
