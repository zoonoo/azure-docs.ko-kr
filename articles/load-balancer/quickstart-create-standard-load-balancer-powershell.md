...
[New-AzureRmLoadBalancer](/powershell/module/azurerm.network/new-azurermloadbalancer)를 사용하여 표준 Load Balancer를 만듭니다. 다음 예제는 이전 단계에서 만든 프런트 엔드 IP 구성, 백 엔드 풀, 상태 프로브, 부하 분산 규칙 및 NAT 규칙을 사용하여 myLoadBalancer라는 공용 기본 Load Balancer를 만듭니다.
