---
title: "Azure CLI를 사용하여 Resource Manager에서 인터넷 연결 부하 분산 장치 만들기 | Microsoft Docs"
...
---
# <a name="creating-an-internal-load-balancer-using-the-azure-cli"></a>Azure CLI를 사용하여 내부 부하 분산 장치 만들기
