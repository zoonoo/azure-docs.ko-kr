...
12. 또한 선택 하는 경우 파일 **의template.js** 에 있는 다른 매개 변수를 변경할 수 있으며 요구 사항에 따라 선택 사항입니다.
    ...
    * **서브넷** -파일 **에 있는template.js** 의 **서브넷** 섹션을 수정 하 여 서브넷 이름 및 서브넷 주소 공간을 변경 하거나에 추가할 수 있습니다. **이름** 속성을 변경 하 여 서브넷의 이름을 변경할 수 있습니다. 파일 **의template.js** 에서 **addressPrefix** 속성을 변경 하 여 서브넷 주소 공간을 변경할 수 있습니다.
...
7. **템플릿**  >  **템플릿 편집** 을 클릭 하 여 온라인 편집기에서 파일 **에template.js** 를 엽니다.
8. 내부 부하 분산 장치 구성을 이동할 대상 지역을 편집 하려면 파일 **의template.js** 에 있는 **리소스** 에서 **위치** 속성을 변경 합니다.
...
10. 또한 선택하는 경우 템플릿의 다른 매개 변수를 변경할 수 있으며 요구 사항에 따라 선택적입니다.
    ...
    * **인바운드 nat 규칙** -파일 **에template.js** 의 **loadbalancer.inboundnatrules** 섹션에 항목을 추가 하거나 제거 하 여 부하 분산 장치에 대 한 인바운드 nat 규칙을 추가 하거나 제거할 수 있습니다.
        ...
        ```
        인바운드 NAT 규칙의 추가 또는 제거를 완료 하려면 다음 파일 **에서template.js** 끝에 **유형** 속성으로 해당 규칙을 제거 해야 합니다.
