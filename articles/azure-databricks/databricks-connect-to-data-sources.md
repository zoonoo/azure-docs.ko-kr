...
다음 목록은 Azure Databricks에 사용할 수 있는 Azure의 데이터 원본을 보여 줍니다. Azure Databricks에 사용할 수 있는 데이터 원본의 전체 목록은 [Azure Databricks의 데이터 원본](/azure/databricks/data/data-sources/index.html)을 참조하세요.

- [Azure SQL 데이터베이스](/azure/databricks/data/data-sources/sql-databases.html)
...
Azure Databricks로 데이터를 가져올 수 있는 원본에 대해 알아보려면 [Azure Databricks의 데이터 원본](/azure/databricks/data/data-sources/index.html#)을 참조하세요.
