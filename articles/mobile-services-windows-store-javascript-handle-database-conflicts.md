...
1.  Visual Studio에서 [모바일 서비스 시작](/en-us/develop/mobile/tutorials/get-started) 자습서에서 다운로드한 TodoList 프로젝트의 JavaScript 언어 버전을 엽니다.
...
6.  **디버그**-\>**디버깅 시작**을 클릭하여 Visual Studio에서 앱의 인스턴스 1을 실행합니다. 두 번째 컴퓨터의 시작 화면에서 아래쪽 화살표를 클릭하여 "이름별 앱"을 표시합니다. 그런 다음 **todolist** 앱을 클릭하여 앱의 인스턴스 2를 실행합니다.
    ...
    앱 인스턴스 1 ![](./media/mobile-services-windows-store-javascript-handle-database-conflicts/Mobile-oc-store-app1.png)

    앱 인스턴스 2 ![](./media/mobile-services-windows-store-javascript-handle-database-conflicts/Mobile-oc-store-app1.png)
