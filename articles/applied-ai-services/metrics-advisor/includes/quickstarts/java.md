...
ms.locfileid: "114713697"
---
[참조 설명서](https://westus2.dev.cognitive.microsoft.com/docs/services/MetricsAdvisor/) | [라이브러리 소스 코드](https://github.com/Azure/azure-sdk-for-java/tree/main/sdk/metricsadvisor/azure-ai-metricsadvisor/src) | [아티팩트(Maven)](https://search.maven.org/artifact/com.azure/azure-ai-metricsadvisor) | [샘플](https://github.com/Azure/azure-sdk-for-java/tree/main/sdk/metricsadvisor/azure-ai-metricsadvisor/src/samples)
...
> [!TIP]
> * [GitHub](https://github.com/Azure/azure-sdk-for-java/tree/main/sdk/metricsadvisor/azure-ai-metricsadvisor/src/samples)에서 Java Metrics Advisor 샘플을 찾을 수 있습니다.
...
|이름|설명|
|---|---|
| [MetricsAdvisorClient](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-ai-metricsadvisor/1.0.0/com/azure/ai/metricsadvisor/MetricsAdvisorClient.html) | **용도**: <br> - 변칙 인시던트 나열 <br> - 인시던트의 근본 원인 나열 <br> - 서비스에 의해 보강된 원래 시계열 데이터와 시계열 데이터를 검색합니다. <br> - 경고 나열 <br> - 모델 조정을 위한 피드백 추가 |
| [MetricsAdvisorAdministrationClient](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-ai-metricsadvisor/1.0.0/com/azure/ai/metricsadvisor/administration/MetricsAdvisorAdministrationClient.html)| **다음을 수행할 수 있습니다.** <br> - 데이터 피드 관리 <br> - 변칙 검색 구성 <br> - 변칙 경고 구성 <br> - 후크 관리  |
| [DataFeed](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-ai-metricsadvisor/1.0.0/com/azure/ai/metricsadvisor/administration/models/DataFeed.html) | **Metrics Advisor가 데이터 원본에서 수집하는 항목. `DataFeed`에는**  행이 포함됩니다. <br> - 타임스탬프 <br> - 0개 이상의 차원 <br> - 하나 이상의 측정값  |
| [DataFeedMetric](https://azuresdkdocs.blob.core.windows.net/$web/java/azure-ai-metricsadvisor/1.0.0/com/azure/ai/metricsadvisor/administration/models/DataFeedMetric.html) | `DataFeedMetric`은 특정 비즈니스 프로세스의 상태를 모니터링하고 평가하는 데 사용되는 정량 측정값입니다. 차원으로 나눈 여러 개의 시계열 값의 조합일 수 있습니다. 예를 들어 웹 상태 메트릭은 사용자 수 및 en-us 시장의 차원을 포함할 수 있습니다. |
...
`sql_server_connection_string`을 사용자 고유의 SQL 서버 연결 문자열로 바꾸고 `query`를 단일 타임스탬프에서 데이터를 반환하는 쿼리로 바꿉니다. 사용자 지정 데이터를 기반으로 `DataFeedMetric` 및 `DataFeedDimension` 값도 조정해야 합니다.
