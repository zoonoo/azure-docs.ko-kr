...
> [!IMPORTANT]
> 클라이언트 장치에서 렌더링 세션에 연결 하려면 ARR 런타임 SDK가 필요 합니다. 이러한 Sdk는 [.net](/dotnet/api/microsoft.azure.remoterendering?view=remoterendering) 및 [c + +](/cpp/api/remote-rendering/)에서 사용할 수 있습니다. 서비스에 연결 하는 것 외에도 이러한 Sdk를 사용 하 여 세션을 시작 하 고 중지할 수 있습니다.
