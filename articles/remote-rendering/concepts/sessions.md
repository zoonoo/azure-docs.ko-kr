...
* [C # Azuresession 클래스](/dotnet/api/microsoft.azure.remoterendering.azuresession)
...
* [C + + AzureSession 클래스](/cpp/api/remote-rendering/azuresession)
