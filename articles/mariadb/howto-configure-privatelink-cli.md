---
title: Azure Database for MariaDB (미리 보기) CLI 설치 방법에 대 한 개인 링크
...
2.  `nslookup mydemoserver.mariadb.privatelink.database.azure.com`를 입력합니다. 
