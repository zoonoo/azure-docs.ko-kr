...
Azure Database for MariaDB에 연결 하기 위해 SSL/TLS를 사용 하 고 루트 인증서를 확인 하는 모든 응용 프로그램은 루트 인증서를 업데이트 해야 합니다. 현재 SSL/TLS를 사용 하지 않는 경우 응용 프로그램 가용성에 영향을 주지 않습니다. 클라이언트 응용 프로그램에서 미리 정의 된 신뢰할 수 있는 [CA (인증](concepts-ssl-connection-security.md#default-settings)기관)와 함께 SSL 모드를 사용 하려고 하는지 확인할 수 있습니다.
