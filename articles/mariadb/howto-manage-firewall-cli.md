...
Virtual Network (VNet) 규칙은 대한 액세스를 보호 하는데도 사용할 수 있습니다. [Azure CLI를 사용하여 VNet 서비스 엔드포인트 만들기 및 관리](howto-manage-vnet-cli.md)에 대해 자세히 알아보세요.
...
- [Azure CLI를 사용하여 VNet 서비스 엔드포인트 만들기 및 관리](howto-manage-vnet-cli.md)를 통해 서버에 대한 액세스 보안을 강화합니다.
