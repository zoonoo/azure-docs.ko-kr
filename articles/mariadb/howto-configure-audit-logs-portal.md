---
title: 액세스 감사 로그 - Azure 포털 - MariaDB용 Azure 데이터베이스
description: 이 문서에서는 Azure 포털에서 MariaDB에 대한 Azure 데이터베이스의 감사 로그를 구성하고 액세스하는 방법을 설명합니다.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
Azure 포털에서 [MariaDB 감사 로그](concepts-audit-logs.md) 및 진단 설정에 대한 Azure 데이터베이스를 구성할 수 있습니다.
