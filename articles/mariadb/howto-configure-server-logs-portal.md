---
title: Azure portal에서 MariaDB에 대 한 Azure Database에 대 한 서버 로그 액세스 및 구성
description: 이 문서에서는 Azure portal에서 Azure Database에서 서버 로그에 MariaDB에 대 한 액세스 및 구성 하는 방법을 설명 합니다.
author: rachel-msft
ms.author: raagyema
ms.service: mariadb
ms.topic: conceptual
...
ms.locfileid: "67065632"
---
# <a name="configure-and-access-server-logs-in-the-azure-portal"></a>Azure Portal에서 서버 로그 구성 및 액세스

구성, 나열 및 다운로드 합니다 [Azure Database for MariaDB 느린 쿼리 로그](concepts-server-logs.md) Azure portal에서 합니다.
...
- 에 대해 자세히 알아보세요 [느린 쿼리 로그](concepts-server-logs.md) Azure Database for MariaDB에서에서.
