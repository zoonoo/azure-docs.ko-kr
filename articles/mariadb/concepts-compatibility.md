...
이동 | https://github.com/go-sql-driver/mysql/releases | 1.3, 1.4 | 1.2 이하 | 1\.3 버전에 대 한 연결 문자열에 `allowNativePasswords=true`를 사용 합니다. 버전 1.4에는 수정 `allowNativePasswords=true` 프로그램이 포함 되어 있으므로 더 이상 필요 하지 않습니다.
