...
**계획 된 유지 관리** 이벤트 유형을 사용 하 여 Azure Database for MariaDB에 대 한 예약 된 유지 관리 이벤트를 볼 수 있습니다. **서비스 상태 경고**를 만드는 방법을 알아보려면 [서비스 알림에서 활동 로그 경고 만들기](../service-health/alerts-activity-log-service-notifications.md) 문서를 참조 하세요.
