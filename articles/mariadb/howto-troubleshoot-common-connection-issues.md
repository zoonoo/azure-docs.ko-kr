...
description: 재시도가 필요한 일시적인 오류, 방화벽 문제 및 중단을 포함하여 Azure Database for MariaDB에 대한 연결 문제를 해결하는 방법을 알아봅니다.
author: savjani
ms.author: pariks
ms.service: mariadb
...
* 사용자 오류: 예를 들어 연결 문자열의 서버 이름을 잘못 입력하였거나 사용자 이름에 *\@servername* 접미사와 같은 연결 매개 변수가 누락되었을 수 있습니다.
