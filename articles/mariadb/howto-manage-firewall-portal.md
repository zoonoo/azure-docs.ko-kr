...
서버 수준 방화벽 규칙은 지정된 IP 주소 또는 IP 주소에서 Azure Database for MariaDB에 대한 액세스 관리하는데 사용할 수 있습니다.

Virtual Network (VNet) 규칙은 서버에 대한 액세스를 보호 하는데도 사용할 수 있습니다. [Azure Portal을 사용하여 Azure Database for MariaDB VNet 서비스 엔드포인트와 VNet 규칙 만들기 및 관리](howto-manage-vnet-portal.md)에 대해 자세히 알아보세요.
...
## <a name="next-steps"></a>다음 단계
 - 마찬가지로, [Azure CLI를 사용하여 Azure Database for MariaDB 방화벽 규칙 만들기 및 관리](howto-manage-firewall-cli.md)를 확인 할 수 있습니다.
 - [Azure Portal을 사용하여 Azure Database for MariaDB VNet 서비스 엔드포인트와 VNet 규칙 만들기 및 관리](howto-manage-vnet-portal.md)를 통해 서버에 대한 액세스 보안을 강화합니다.
