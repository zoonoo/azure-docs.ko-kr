---
title: Azure Database for MariaDB (미리 보기) 포털 설치 방법에 대 한 개인 링크
...
1. Azure Portal 화면 왼쪽 상단에서 **리소스 만들기** > **데이터베이스** > **Azure Database for MariaDB**를 선택 합니다.
