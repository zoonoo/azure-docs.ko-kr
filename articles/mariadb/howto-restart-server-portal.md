---
title: 서버 다시 시작 - Azure 포털 - MariaDB용 Azure 데이터베이스
...
[빠른 시작: Azure 포털을 사용하여 MariaDB 서버에 대한 Azure 데이터베이스 만들기](./quickstart-create-mariadb-server-database-using-azure-portal.md)