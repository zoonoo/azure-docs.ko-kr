...
저장소에서 사용 하는 것이 좋습니다 자동 증가 또는 서버 저장소 임계값에 도달할 때이 알리도록 경고 설정에 따라서 방지할 수 있습니다 읽기 전용 상태로 시작 합니다. 자세한 내용은 [경고 설정 방법](howto-alert-metric.md)에 관한 설명서를 참조하세요.
