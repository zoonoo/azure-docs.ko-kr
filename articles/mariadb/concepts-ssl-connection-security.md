---
title: SSL 연결-Azure Database for MariaDB
...
## <a name="tls-connectivity-in-azure-database-for-mariadb"></a>Azure Database for MariaDB의 TLS 연결
...
Azure Database for MariaDB은 클라이언트 연결에 TLS 버전을 적용할 수 있는 기능을 제공 합니다. TLS 옵션을 사용 하려면 **최소 tls 버전** 옵션 설정을 사용 합니다. 이 옵션 설정에 허용 되는 값은 다음과 같습니다.
...
> [!Note] 
> Azure Database for MariaDB 기본값은 모든 새 서버에서 TLS를 사용 하지 않도록 설정 됩니다.
>
> 현재 byAzure Database for MariaDB에서 지원 되는 TLS 버전은 TLS 1.0, 1.1 및 1.2입니다.
...
- [TLS를 구성](howto-tls-configurations.md)하는 방법에 대해 알아봅니다.