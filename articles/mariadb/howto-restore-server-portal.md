---
title: Azure Database for MariaDB에서 서버를 복원하는 방법
...
Azure Database for MariaDB를 사용하면 특정 시점의 서버를 서버의 새 복사본으로 다시 복원할 수 있습니다. 이 새 서버를 사용하여 데이터를 복구하거나 클라이언트 응용 프로그램에서 이 새 서버를 가리키도록 할 수 있습니다.
...
1. 포털의 왼쪽 상단 모서리에서 **리소스 만들기** 단추(+)를 선택합니다. 검색 상자에 **Azure Database for MariaDB**를 입력하여 서비스를 찾습니다.
