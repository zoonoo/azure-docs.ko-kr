---
title: 백업 및 복원 - MariaDB용 Azure 데이터베이스
...
이러한 백업 파일은 사용자가 노출하지 않으며 내보낼 수 없습니다. 이러한 백업은 MariaDB용 Azure 데이터베이스의 복원 작업에만 사용할 수 있습니다. [mysqldump을](howto-migrate-dump-restore.md) 사용하여 데이터베이스를 복사할 수 있습니다.
...
MariaDB용 Azure 데이터베이스에서 복원을 수행하면 원래 서버의 백업에서 새 서버가 생성되고 서버에 포함된 모든 데이터베이스가 복원됩니다.
