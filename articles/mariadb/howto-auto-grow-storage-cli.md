---
title: 자동 증가 저장소 - Azure CLI - MariaDB용 Azure 데이터베이스
description: 이 문서에서는 MariaDB용 Azure 데이터베이스의 Azure CLI를 사용하여 저장소를 자동으로 늘리는 방법을 설명합니다.
author: ambhatna
ms.author: ambhatna
ms.service: mariadb
ms.topic: conceptual
...
## <a name="enable-mariadb-server-storage-auto-grow"></a>MariaDB 서버 스토리지 자동 증가 지원
