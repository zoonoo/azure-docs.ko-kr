---
title: 서버 관리 - Azure 포털 - MariaDB용 Azure 데이터베이스
description: Azure 포털에서 MariaDB 서버에 대한 Azure 데이터베이스를 관리하는 방법에 대해 알아봅니다.
author: ajlam
ms.author: andrela
ms.service: mariadb
ms.topic: conceptual
...
---
# <a name="manage-an-azure-database-for-mariadb-server-using-the-azure-portal"></a>Azure 포털을 사용하여 MariaDB 서버에 대한 Azure 데이터베이스 관리
이 문서에서는 MariaDB 서버에 대한 Azure 데이터베이스를 관리하는 방법을 보여 줍니다. 관리 작업에는 계산 및 저장소 확장, 관리자 암호 재설정 및 서버 세부 정보 보기가 포함됩니다.

## <a name="sign-in"></a>로그인
[Azure 포털에](https://portal.azure.com)로그인합니다.

## <a name="create-a-server"></a>서버 만들기
빠른 [시작을](quickstart-create-mariadb-server-database-using-azure-portal.md) 방문하여 MariaDB 서버용 Azure 데이터베이스를 만들고 시작하는 방법을 알아봅니다.
...
- [MariaDB용 Azure 데이터베이스에서 튜닝 및 모니터링 옵션에 대해](concepts-monitoring.md) 알아보기
