---
title: 로컬 Docker 컨테이너에서 앱 개발 | Microsoft Docs
...
## 2\. Docker 지원 추가
[!INCLUDE [docker 지원 추가](../includes/vs-azure-tools-docker-add-docker-support.md)]
...
4. 파일의 끝에 다음 HTML 콘텐츠를 추가하고 변경 내용을 저장합니다.
    ...
    ```
5. 출력창을 보는 가운데 .NET 빌드가 완료되고 이러한 줄이 표시될 때 브라우저로 전환하고 정보 페이지를 새로 고칩니다.
