<properties
   pageTitle="HDInsight의 Linux 기반 Hadoop에 대해 알아야 할 정보 | Azure"
...
클러스터에 연결할 때 사용하려는 FQDN(정규화된 도메인 이름)은 **&lt;clustername>.azurehdinsight.net** 또는 **&lt;clustername>.aurehdinsight.net**(SSH인 경우만)입니다.
...
예제 데이터 및 jar는 '/example' 또는 'wasb:///example'의 HDFS(WASB)에서 찾을 수 있습니다.
...
HDInsight은 클러스터와 여러 개의 Blob 저장소 계정을 연결할 수도 있습니다. 기본이 아닌 Blob 저장소 계정 데이터에 액세스하려면 **WASB://&lt;컨테이너 이름>@&lt;계정 이름 >.blob.core.windows.net/** 형식을 사용할 수 있습니다. 예를 들어 다음은 특정 컨테이너 및 저장소 계정에 대한 **/예제/데이터** 디렉터리 콘텐츠를 나열합니다.
...
1. <a href="https://manage.windowsazure.com/" target="_blank">Azure 관리 포털</a>에서 HDInsight 클러스터를 선택합니다.
...
* <a href="http://azure.microsoft.com/documentation/articles/xplat-cli/" target="_blank">Azure 플랫폼 간 명령줄 인터페이스</a> - 설치 후 저장소 사용에 대한 도움말은 `azure storage`를 참조하고 Blob 관련 명령은 `azure blob`을 참조하세요.
...
* <a href="https://msdn.microsoft.com/library/azure/dd135733.aspx" target="_blank">저장소 REST API</a>
