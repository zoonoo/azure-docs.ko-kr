...
description: Azure에서 Twilio API 서비스를 사용하여 전화를 거는 방법에 대해 알아봅니다. 코드 샘플은 .NET으로 작성되었습니다.
services: ''
...
1. [Twilio 콘솔][twilio_console]에서 Twilio 계정 및 인증 토큰을 가져옵니다. Twilio를 시작하려면 [https://www.twilio.com/try-twilio][try_twilio]에서 등록하세요. 사용자는 [https://www.twilio.com/pricing][twilio_pricing]에서 가격을 볼 수 있습니다. Twilio에서 제공하는 API에 대한 내용은 [https://www.twilio.com/voice/api][twilio_api]를 참조하세요.
...
TwiML에 대한 자세한 내용은 [https://www.twilio.com/docs/api/twiml][twiml]에서 확인할 수 있습니다. &lt;Say&gt; 및 기타 Twilio 동사에 대한 자세한 내용은 [https://www.twilio.com/docs/api/twiml/say][twilio_say]에서 찾을 수 있습니다.
