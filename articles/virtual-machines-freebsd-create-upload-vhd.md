...
이 문서에서는 FreeBSD 운영 체제가 포함된 VHD(가상 하드 디스크)를 생성 및 업로드하고 이를 Azure에서 가상 컴퓨터를 만들기 위한 고유한 이미지로 사용하는 방법을 소개합니다. 
...
2. **SSH 사용**
    ...
    SSH는 디스크에서 설치한 후에 기본적으로 사용하도록 설정됩니다. 그렇지 않거나 FreeBSD VHD를 직접 사용하는 경우에는 다음을 입력합니다.
