<properties pageTitle="서비스 쪽 권한 부여(iOS) | 모바일 개발자 센터" description="Azure 모바일 서비스의 .NET 백 엔드에서 사용자에게 권한을 부여하는 방법에 대해 알아봅니다." services="mobile-services" documentationCenter="ios" authors="krisragh" manager="dwrede" editor=""/>
...
1. Xcode에서 [인증 시작] 자습서를 완료할 때 수정한 프로젝트를 엽니다.
