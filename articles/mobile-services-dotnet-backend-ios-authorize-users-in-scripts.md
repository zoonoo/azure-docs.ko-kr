...
<!-- URLs. -->
  ...
  [.NET 백 엔드]: /ko-kr/documentation/articles/mobile-services-dotnet-backend-ios-authorize-users-in-scripts/ ".NET 백 엔드"
  [JavaScript 백 엔드]: /ko-kr/documentation/articles/mobile-services-ios-authorize-users-in-scripts/ "JavaScript 백 엔드"
