...
Arc 지원 서버에서 VM 확장을 사용하려면 [az connectedmachine extension create](/cli/azure/ext/connectedmachine/connectedmachine/extension#ext_connectedmachine_az_connectedmachine_extension_create)을 `--machine-name``--extension-name``--location``--type``settings` 및 `--publisher` 매개 변수와 함께 사용합니다.
...
Arc 지원 서버의 VM 확장 목록을 가져오려면 [az connectedmachine extension list](/cli/azure/ext/connectedmachine/connectedmachine/extension#ext_connectedmachine_az_connectedmachine_extension_list)을 `--machine-name`및 `--resource-group` 매개 변수와 함께 사용합니다.
...
Arc 지원 서버에서 설치된 VM 확장을 제거하려면 [az connectedmachine extension delete](/cli/azure/ext/connectedmachine/connectedmachine/extension#ext_connectedmachine_az_connectedmachine_extension_delete)를 `--extension-name`, `--machine-name` 및 `--resource-group` 매개 변수와 함께 사용합니다.
...
- 명령에 대한 자세한 내용은 Azure CLI VM 확장 [개요](/cli/azure/ext/connectedmachine/connectedmachine/extension) 문서를 참조하세요.
