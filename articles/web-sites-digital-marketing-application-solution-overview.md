...
웹 사이트에서 이 템플릿을 사용하는 방법에 대한 빠른 안내를 보려면 [ASP.NET MVC Facebook 템플릿을 사용하여 Facebook 앱을 만들고 무료로 Azure 웹 사이트에 호스트][fbtutorial]를 참조하세요. 좀 더 자세한 자습서 및 예제 응용 프로그램은 [ASP.NET MVC Facebook 생일 앱][fbbirthdayapp](영문) 및 [ASP.NET MVC용 새로운 Facebook 응용 프로그램 템플릿 및 라이브러리][fbvstemplate](영문)를 참조하세요.
...
- [서비스 관리 API][servicemanagementapi] 또는 [PowerShell 스크립팅][powershell]을 통해 프로그래밍 방식으로 크기를 조정합니다.
...
웹 사이트 크기 조정에 대한 자세한 내용은 [웹 사이트 크기를 조정하는 방법][scalewebsite]을 참조하세요. 이 주제는 모니터링과 밀접하게 관련되어 있습니다. 자세한 내용은 이 가이드의 [캠페인 모니터링](#monitor) 섹션을 참조하세요.

<div class="dev-callout">
<strong>참고</strong>
<p>클라우드 서비스와 웹 역할을 사용하도록 선택한 웹 응용 프로그램의 경우 큐에 있는 항목의 길이를 기반으로 크기를 조정할 수 있는 추가 옵션이 있습니다. 클라우드 서비스에서는 백 엔드 큐를 처리하는 역할이 일반적인 아키텍처 패턴입니다. 클라우드 서비스 크기 조정에 대한 자세한 내용은 <a href="http://www.windowsazure.com/ko-kr/manage/services/cloud-services/how-to-scale-a-cloud-service/">클라우드 서비스의 크기를 조정하는 방법</a>(영문)을 참조하세요.</p>
</div>
...
마지막으로, 표준 모드 웹 사이트에서는 끝점 모니터링 및 경고를 사용할 수 있습니다. 끝점 모니터링은 규칙적으로 웹 사이트 도달을 시도하여 응답 시간을 보고합니다. 경고는 응답 시간이 지정된 임계값을 초과하는 경우 메일 알림을 제공합니다. 자세한 내용은 [글로벌 웹 서비스][scenarioglobalweb] 시나리오의 모니터링 섹션 및 [방법: Azure에서 경고 알림 받기 및 경고 규칙 관리][receivealerts](영문) 항목을 참조하세요.
...
<tr>
   ...
   <td valign="top">- <a href="http://msdn.microsoft.com/ko-kr/library/windowsazure/dn223282.aspx">Azure 미디어 서비스 개념 및 시나리오 소개</a></td>(영문)
</tr>
<tr>
   <td valign="middle"><strong>모니터</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/ko-kr/manage/services/web-sites/how-to-monitor-websites/">웹 사이트를 모니터링하는 방법</a><br/>- <a href="http://msdn.microsoft.com/library/windowsazure/dn306638.aspx">방법: Azure에서 경고 알림 받기 및 경고 규칙 관리</a></td>(영문)
</tr>
</table>
