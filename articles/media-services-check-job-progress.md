<properties 
	pageTitle="미디어 서비스에서 작업 진행률을 확인하는 방법 - Azure" 
...
이 문서는 Azure 미디어 서비스 프로그래밍을 소개하는 시리즈 중 하나입니다. 이전 항목은 [방법: 자산 인코드](http://go.microsoft.com/fwlink/?LinkID=301753&clcid=0x409)입니다.
