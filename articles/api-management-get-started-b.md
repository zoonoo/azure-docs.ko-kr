<properties pageTitle="Azure API 관리 시작" metaKeywords="" description="API와 작업을 만들고 API 관리를 시작하는 방법에 대해 알아봅니다." metaCanonical="" services="api-management" documentationCenter="API Management" title="Azure API 관리 시작" authors="sdanie" solutions="" manager="dwrede" editor="" />
