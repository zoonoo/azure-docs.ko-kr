...
커뮤니티와의 작업을 통해 좀더 인증된 배포를 제공하며, 갤러리의 배포 이미지는 다음 파트너를 통해 제공됩니다. 그러는 동안 이 페이지의 지침에 따라 자신만의 Linux를 언제든지 가져올 수 있습니다.
...
Oracle™의 전략은 공용 및 사설 클라우드에 대한 솔루션의 다양한 포트폴리오를 제공하며, 다른 클라우드뿐만 아니라 Oracle 클라우드에서 Oracle 소프트웨어를 배포하는 방법에 있어서 고객에게 선택권과 유연성을 제공하는 것입니다. Oracle™과 Microsoft의 파트너 관계를 통해 고객은 Oracle의 확실한 인증 및 지원으로 Microsoft 공용 및 사설 클라우드에서 Oracle 소프트웨어를 배포할 수 있습니다. Oracle 공용 및 사설 클라우드 솔루션에 대한 Oracle™의 이행 및 투자는 변하지 않습니다.
...
<table border="1" width="600">
  <tr bgcolor="#E9E7E7">
	...
	<tr>
		...
		<td> Ubuntu 12.04.1, 12.10, 13.04</td>
		<td>커널에 있음</td>
		...
		<td>패키지: walinuxagent의 패키지 리포지토리에 있음 <br />
			소스: <A HREF="http://go.microsoft.com/fwlink/p/?LinkID=250998">GITHUB</A></td>
			</tr>
	<tr>
		<th> CENTOS by Open Logic </th>
		<td> CentOS 6.3 이상</td>
	    <td>CentOS 6.3: <a href="http://go.microsoft.com/fwlink/p/?LinkID=254263">LIS 드라이버</a>; CentOS 6.4 이상 드라이버: 커널에 있음</td>
	...
	<tr>
        ...
        <td>커널에 있음</td>
		<td>해당 없음</td>
		<td>패키지: 리포지토리에 있음. 이름: WALinuxAgent
<br />
			소스: <A HREF="http://go.microsoft.com/fwlink/p/?LinkID=250998">GITHUB</A></td>
