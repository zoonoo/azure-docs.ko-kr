...
<table border="1" cellpadding="0" cellspacing="0">
    <tbody>
        ...
        <tr>
            ...
            <td valign="top" width="213">
                <p>
                    Blob에 대한 액세스 권한을 인증하는 데 사용합니다. 이 서명은 SHA256 알고리즘을 사용하여 서명할 문자열과 키를 통해 계산된 다음 Base64 인코딩을 사용하여 인코드되는 HMAC입니다.
                </p>
            </td>
        </tr>
    </tbody>
...
10.	**저장소 분석을 사용하여 응용 프로그램을 모니터링합니다.** 로깅 및 메트릭을 사용하여 SAS 공급자 서비스의 가동 중단이나 저장된 액세스 정책의 잘못된 제거로 인한 인증 오류의 급격한 증가를 관찰할 수 있습니다. 추가 정보는 [Azure 저장소 팀 블로그](http://blogs.msdn.com/b/windowsazurestorage/archive/2011/08/03/windows-azure-storage-logging-using-logs-to-track-storage-requests.aspx) (영문)를 참조하세요.
