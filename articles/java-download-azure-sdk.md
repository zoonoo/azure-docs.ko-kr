...
> [AZURE.NOTE] 다음 샘플의 각 `<version>` 요소 내에서 이 예제의 "n.n.n" 자리 표시자를 유효한 버전 번호로 바꿉니다. 버전 번호는 [Maven의 Azure 라이브러리 리포지토리]에서 얻을 수 있습니다.
...
1. 사이트 위치 <http://dl.microsoft.com/eclipse>를 입력하고 **Enter** 키를 누릅니다.
