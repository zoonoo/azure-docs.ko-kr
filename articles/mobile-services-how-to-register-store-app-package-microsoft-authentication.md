...
클라이언트 관리 인증을 사용하면 Live Connect를 사용하여 Windows 장치에서 Single Sign-On 환경을 제공할 수 있습니다. Live Connect API를 사용하는 경우에는 이 항목의 단계를 완료할 필요가 없습니다. 자세한 내용은 [Live Connect Single Sign-On을 사용하여 Windows 스토어 앱 인증]을 참조하십시오.
