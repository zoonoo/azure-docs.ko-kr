...
클라이언트 기반 인증을 사용하면 Live Connect를 사용하여 Windows 장치에서 Single Sign-On 환경을 제공할 수 있습니다. Live Connect API를 사용하는 경우에는 이 항목의 단계를 완료할 필요가 없습니다. 자세한 내용은 [Live Connect Single Sign-On을 사용하여 Windows 스토어 앱 인증](/en-us/develop/mobile/tutorials/single-sign-on-windows-8-dotnet)을 참조하십시오.

앱을 등록하면 앱에 푸시 알림을 보낼 수도 있습니다. 앱에 대한 [푸시 알림 시작](/en-us/develop/mobile/tutorials/get-started-with-push-dotnet/) 자습서를 이미 완료한 경우 이 항목의 단계를 이미 완료한 것입니다.

**참고**

*Visual Studio 2013 Preview*에는 모바일 서비스를 통해 Windows 스토어 앱 패키지를 쉽게 등록할 수 있도록 해주는 새로운 기능이 포함되어 있습니다. 자세한 내용은 Windows 개발자 센터에서 [빠른 시작: 모바일 서비스에 대한 푸시 알림 추가](http://go.microsoft.com/fwlink/p/?LinkId=309101)(영문)를 참조하십시오.

[WACOM.INCLUDE [mobile-services-register-windows-store-app](../includes/mobile-services-register-windows-store-app.md)]

앱 패키지를 등록한 후 [LoginAsync](http://go.microsoft.com/fwlink/p/?LinkId=311594) 메서드를 호출할 때 *useSingleSignOn*에 대해 **true** 값을 제공해야 합니다. 그러면 사용자가 Microsoft 계정을 사용할 때 향상된 로그인 환경이 제공됩니다.
