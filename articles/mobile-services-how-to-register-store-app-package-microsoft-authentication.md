...
>[AZURE.NOTE]Visual Studio 2013을 사용하면 Windows 스토어 앱 패키지를 모바일 서비스에 손쉽게 등록할 수 있습니다. 자세한 내용은 Windows 개발자 센터에서 <a href="http://go.microsoft.com/fwlink/p/?LinkId=309101">퀵 스타트: 모바일 서비스에 대한 푸시 알림 추가</a> 를 참조하세요.
...
[Live Connect Single Sign-On을 사용하여 Windows 스토어 앱 인증]: /develop/mobile/tutorials/single-sign-on-windows-8-dotnet
[Live Connect Single Sign-On으로 Windows 스토어 앱 인증]: /develop/mobile/tutorials/single-sign-on-windows-8-dotnet
[사용자 C# 시작]: /develop/mobile/tutorials/get-started-with-users-dotnet/
[사용자 JavaScript 시작]: /develop/mobile/tutorials/get-started-with-users-js/
