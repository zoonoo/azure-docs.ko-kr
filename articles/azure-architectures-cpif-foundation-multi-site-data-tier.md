...
SQL Server 2012와 함께 도입 AlwaysOn 가용성 그룹은 Azure 인프라 서비스에서 완벽하게 지원되는 고가용성 및 재해 복구 기능입니다. Microsoft Azure 인프라 서비스에서 AlwaysOn 가용성 그룹에 대한 세부 정보 및 공식 지원 발표는 AlwaysOn 가용성 그룹 문서에 있습니다.
