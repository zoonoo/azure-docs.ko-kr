...
:::image type="content" source="./media/graph-visualization/ci-demo-2.gif" alt-text="애니메이션은 다양 한 세부 수준에서 KeyLines 시각화 예를 보여 줍니다." border="false":::
...
:::image type="content" source="./media/graph-visualization/ci-demo-1.gif" alt-text="애니메이션은 다양 한 세부 수준에서 Re-Graph 시각화 예제를 보여 줍니다." border="false":::
