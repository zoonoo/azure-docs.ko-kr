...
ms.locfileid: "87082888"
---
# <a name="regional-presence-with-azure-cosmos-db"></a>Azure Cosmos DB의 지역 현재 상태

Azure Cosmos DB는 Azure의 기본 서비스 이며 기본적으로 [azure를 사용할 수 있는 모든 지역](https://azure.microsoft.com/global-infrastructure/services/?products=cosmos-db&regions=all)에서 항상 사용할 수 있습니다.

:::image type="content" source="./media/regional-presence/regional-presence.png" alt-text="Azure Cosmos DB를 사용할 수 있는 지역" lightbox="./media/regional-presence/regional-presence.png" border="false":::
...
글로벌 복제 지원은 Azure 클라우드 환경 내에서 범위가 지정 됩니다. 예를 들어 *azure public* 의 Azure Cosmos DB 계정은 *azure Public* 내의 모든 azure 지역에 복제할 수 있지만 *azure 중국 21vianet*의 azure 지역으로 복제할 수는 없습니다.
