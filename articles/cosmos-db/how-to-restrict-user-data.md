...
각 인증 방법에서는 여러 작업 집합에 대 한 액세스를 제공 하며, 이러한 작업에는 인증 유형별 작업 분할 ![있습니다](./media/how-to-restrict-user-data/operations.png)
...
1. 먼저 다음과 같은 내용이 포함 된 `AzureCosmosKeyOnlyAccess.json` JSON 문서를 만듭니다.
