...
|**API 설명서**|[Python API 참조 설명서](/python/api/overview/azure/cosmosdb)|
...
|**현재 지원되는 플랫폼**|[Python 2.7](https://www.python.org/downloads/) 또는 [python 3.6 이상](https://www.python.org/downloads/)|
