...
|[Azure AD id, 역할 정의 및 역할 할당을 사용 하 여 Azure Cosmos 계정 만들기](manage-with-templates.md#create-rbac) | 이 템플릿은 Azure AD id, 역할 정의 및 서비스 사용자에 대 한 역할 할당을 사용 하 여 코어 (SQL) API 계정을 만듭니다. |
