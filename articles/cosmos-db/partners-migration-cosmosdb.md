...
|---------|---------|---------|
|[Striim](https://www.striim.com/)    |  지속적인 실시간 데이터 이동, 데이터 마이그레이션|   USA   |
| [10thMagnitude](https://www.10thmagnitude.com/) | IoT, 소매점 (인벤토리), 운영 분석 (Spark), 서버를 사용 하지 않는 아키텍처, 앱 개발 | USA |
|[Altoros Development LLC](https://www.altoros.com/)  |  IoT, 개인 설정 일반 정품 (인벤토리), 서버 리스 아키텍처 NoSQL 마이그레이션, 앱 개발|   USA |
...
|[Bluemetal](https://www.bluemetal.com/)     |  IoT, 개인 설정 일반 정품 (재고), 엔터프라이즈 & SMC에 대 한 운영 분석, AI 이미지 주석, 자산 컨트롤, NoSQL 마이그레이션, 앱 개발     |    북아메리카, 아시아 태평양     |
|[Capax Global LLC](https://www.capaxglobal.com/) | IoT, 개인 설정, 소매 (인벤토리), 운영 분석 (Spark), 서버 리스 아키텍처, 앱 개발|    USA     |  
...
|[Infosys](https://www.infosys.com/)     | 앱 개발      |    USA    |  
| [Lagash 시스템](https://www.lagash.com/) | IoT, 서버를 사용 하지 않는 아키텍처, 앱 개발 | 아르헨티나, 칠레, 콜롬비아, 멕시코|
| [Lambda3 Informatics](https://www.lambda3.com.br/) | 실시간 개인 설정, 소매 재고, 앱 개발 | 브라질|
|[Neal Analytics](https://www.nealanalytics.com/)    |     개인 설정, 소매점 (인벤토리), 운영 분석 (Spark), 앱 개발  |    USA     |  
|[Pragmatic Works Software Inc](https://www.pragmaticworks.com/)    |   NoSQL 마이그레이션      |   USA      |
| [Ricoh Digital Services](https://www.ricoh.com/) | IoT, 실시간 개인 설정, 소매 재고, NoSQL 마이그레이션 | 영국  |
|[SNP Technologies](https://www.snp.com/) | NoSQL 마이그레이션| USA |
| [Solidsoft Reply](https://www.reply.com/solidsoft-reply/) | NoSQL 마이그레이션 | 크로아티아, 스웨덴, 덴마크, 아일랜드, 불가리아, 슬로베니아, 키프로스, 몰타, 리투아니아, 체코어 공화국, 아이슬란드, 스위스 및 리히텐슈타인|
| [Spanish Point Technologies](https://www.spanishpoint.ie/) | NoSQL 마이그레이션| 아일랜드|
| [Syone](https://www.syone.com/) | NoSQL 마이그레이션| 포르투갈|
|[Tallan](https://www.tallan.com/)    |  앱 개발      |    USA     |
| [TCS](https://www.tcs.com/) | 앱 개발 | 미국, 영국, 프랑스, 말레이시아, 덴마크, 노르웨이, 스웨덴|
|[VTeamLabs](https://www.vteamlabs.com/)    | 개인 설정, 소매 (인벤토리), IoT, 게임, Spark (운영 분석), 서버 리스 아키텍처, NoSQL 마이그레이션, 앱 개발       |  USA      |  
| [흰색 오리 GmbH](https://whiteducksoftware.com/) |새 앱 개발, 앱 백 엔드, 문서 기반 데이터를 위한 저장소| 독일 |
| [Xpand IT](https://www.xpand-it.com/) | 새로운 앱 개발 | 포르투갈, 영국|
| [Hanu](https://hanu.com/) | IoT, 앱 개발 | USA|
| [Incycle 소프트웨어](https://www.incyclesoftware.com/) | NoSQL 마이그레이션, 서버를 사용 하지 않는 아키텍처, 앱 개발| USA|
| [Orion](https://www.orioninc.com/) | 개인 설정, 소매점 (인벤토리), 운영 분석 (Spark), IoT, 앱 개발| 미국, 캐나다|
