...
| **작업** | **Azure CLI**|**SQL API** | **Cassandra API** | **MongoDB API** | **Gremlin API** | **Table API** |
| --- | --- | --- | --- | --- | --- | --- |
...
| **시스템 정의 속성** | **시스템 생성 또는 사용자 설정 가능** | **목적** | **SQL API** | **Cassandra API** | **MongoDB API** | **Gremlin API** | **Table API** |
| --- | --- | --- | --- | --- | --- | --- | --- |
|__rid | 시스템 생성 | 컨테이너의 고유 식별자 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__etag | 시스템 생성 | 낙관적 동시성 제어에 사용되는 엔터티 태그 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__ts | 시스템 생성 | 컨테이너의 마지막 업데이트 타임스탬프 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__self | 시스템 생성 | 컨테이너의 주소 지정 가능 URI | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|id | 사용자 구성 가능 | 컨테이너의 사용자 정의 고유 이름 | yes | 예 | 예 | 예 | yes |
|indexingPolicy | 사용자 구성 가능 | 인덱스 경로, 정밀도 및 일관성 모델을 변경하는 기능을 제공합니다. | yes | 아니요 | 아니요 | 아니요 | yes |
|TimeToLive | 사용자 구성 가능 | 일정 기간이 지난 후 컨테이너에서 항목을 자동으로 삭제하는 기능을 제공합니다. 자세한 내용은 [Time To Live](time-to-live.md) 문서를 참조하세요. | yes | 아니요 | 아니요 | 아니요 | yes |
|changeFeedPolicy | 사용자 구성 가능 | 컨테이너의 항목에 대한 변경 내용을 읽는 데 사용됩니다. 자세한 내용은 [변경 피드](change-feed.md) 문서를 참조하세요. | yes | 아니요 | 아니요 | 아니요 | yes |
|uniqueKeyPolicy | 사용자 구성 가능 | 고유 키를 사용하면 논리 파티션 내에서 하나 이상의 값의 고유성을 보장할 수 있습니다. 자세한 내용은 [고유 키](unique-keys.md) 문서를 참조하세요. | yes | 아니요 | 아니요 | 아니요 | yes |
...
| **작업** | **Azure CLI** | **SQL API** | **Cassandra API** | **MongoDB API** | **Gremlin API** | **Table API** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 데이터베이스에 컨테이너 열거 | 예* | yes | 예 | yes | 해당 없음 | 해당 없음 |
| 컨테이너 읽기 | yes | 예 | 예 | yes | 해당 없음 | 해당 없음 |
| 새 컨테이너 만들기 | yes | 예 | 예 | yes | 해당 없음 | 해당 없음 |
| 컨테이너 업데이트 | yes | 예 | 예 | yes | 해당 없음 | 해당 없음 |
| 컨테이너 삭제 | yes | 예 | 예 | yes | 해당 없음 | 해당 없음 |
...
|**시스템 정의 속성** | **시스템 생성 또는 사용자 설정 가능**| **목적** | **SQL API** | **Cassandra API** | **MongoDB API** | **Gremlin API** | **Table API** |
| --- | --- | --- | --- | --- | --- | --- | --- |
|__id | 시스템 생성 | 항목의 고유 식별자 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__etag | 시스템 생성 | 낙관적 동시성 제어에 사용되는 엔터티 태그 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__ts | 시스템 생성 | 항목의 마지막 업데이트 타임스탬프 | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|__self | 시스템 생성 | 항목의 주소 지정 가능 URI | yes | 아니요 | 아니요 | 아니요 | 아니요 |
|id | 여기서는 | 논리 파티션 내의 사용자 정의 고유 이름. 사용자가 id를 지정하지 않으면 시스템이 자동으로 생성합니다. | yes | 예 | 예 | 예 | yes |
|임의의 사용자 정의 속성 | 사용자 정의 | API 네이티브 표현에 표시되는 사용자 정의 속성(JSON, BSON, CQL 등) | yes | 예 | 예 | 예 | yes |
...
| **작업** | **Azure CLI** | **SQL API** | **Cassandra API** | **MongoDB API** | **Gremlin API** | **Table API** |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 삽입, 바꾸기, 삭제, Upsert, 읽기 | 아니요 | 예 | 예 | 예 | 예 | yes |
