...
### <a name="high-network-latency"></a>높은 네트워크 대기 시간
...
[시간 초과가](#request-timeouts) 없고 진단에 단일 요청이 표시 되는 경우 (예:이 예에서는 300 밀리초 >) `ResponseTime`와 `RequestStartTime`간의 차이에 대 한 높은 대기 시간이 분명 하 게 표시 됩니다.
...
### <a name="request-rate-too-large"></a>요청 비율이 너무 큼
