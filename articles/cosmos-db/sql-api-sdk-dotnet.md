---
title: 'Azure 코스모스 DB: SQL .NET API, SDK & 리소스'
...
|**API 문서**|[.NET API 참조 문서](/dotnet/api/overview/azure/cosmosdb?view=azure-dotnet)|
...
> [!NOTE]
> .NET 프레임워크를 사용하는 경우 .NET 표준을 대상으로 하는 [.NET SDK의](sql-api-sdk-dotnet-standard.md)최신 버전 3.x를 참조하십시오. 
