...
| 보안 특성 | 예/아니요 | 메모 |
|---|---|--|
| 미사용 암호화 (서버 쪽 암호화, 고객이 관리 하는 키를 사용 하는 서버 쪽 암호화 및 기타 암호화 기능) | 예 | 모든 Cosmos 데이터베이스 및 백업은 기본적으로 암호화 됩니다. [Azure Cosmos DB의 데이터 암호화를](database-encryption-at-rest.md)참조 하세요. 고객 관리 키를 사용 하는 서버 쪽 암호화는 지원 되지 않습니다. |
