...
이 문서에는 MongoDB용 Azure Cosmos DB API의 예제만 있으며, 다른 API 형식 계정의 예제를 찾으려면 [Cassandra](templates-samples-cassandra.md), [Gremlin](templates-samples-gremlin.md), [SQL](templates-samples-sql.md), [Table](templates-samples-table.md)의 Azure Cosmos DB API에서 Azure Resource Manager 템플릿 사용 문서를 참조하세요.
