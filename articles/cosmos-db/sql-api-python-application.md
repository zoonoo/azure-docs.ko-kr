...
2. config.py에 다음 코드를 추가하고 다음 단계에서 **COSMOSDB\_HOST** 및 **COSMOSDB\_KEY**의 값을 변경해야 합니다.
...
4. 다시 Azure Portal의 **키** 페이지에서 **기본 키** 또는 **보조 키** 값을 복사하고 **config.py** 파일에 **COSMOSDB\_KEY** 속성에 대한 값으로 붙여넣습니다.
