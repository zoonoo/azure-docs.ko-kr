...
|[201-300]  |D1:50K <br/>D2:70K <br/>C1:20K |미국 서부의 컨테이너에 대한 처리량 청구(모든 지역에 쓰기 가능)  |`D1: 50 K RU/sec/100 * $0.016 * 100 hours = $800` <br/>`D2: 70 K RU/sec/100 * $0.016 * 100 hours = $1,120` <br/>`C1: 20K RU/초/100 *$0.016 * 100시간 = $320 |$2,240`  |
