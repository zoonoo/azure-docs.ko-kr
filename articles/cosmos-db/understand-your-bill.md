...
*또한 가정를 송신 하 여 100GB의 데이터가 매월 미국 동부, 북유럽 및 동아시아로 데이터를 복제 하는 미국 서부의 컨테이너에서 합니다. 송신 데이터 전송 요금에 따라 요금이 청구 됩니다.*
...
*가격 책정은 지역에 따라 달라질 수 있습니다. 최신 가격 책정에 대 한 참조를 [가격 책정 페이지](https://azure.microsoft.com/pricing/details/cosmos-db/)합니다.*
...
|**지역**| **100 RU/s 당 시간당 가격**|**단위(RU/초)**|**청구된 금액(시간당)**| **청구된 금액(월별)**|
|----|----|----|----|----|
