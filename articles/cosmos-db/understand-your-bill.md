...
>! 두고 요금 청구는 60 분이 아닌 벽 시계 시간의 일부에 대 한 것입니다.
...
* 요금은 1,200 x $0.008 = $9.60/시간으로 청구됩니다. 
...
|**Region**| **100RU/초당 시간 기준 가격**|**단위(RU/초)**|**청구된 금액(시간당)**| **청구된 금액(월별)**|
|----|----|----|----|----|
|East US|$0.008 |50K|$4|$2,880 |
