...
| (논리적) 파티션 키 당 모든 항목에 대 한 최대 저장소| 20GB |
...
## <a name="autopilot-mode-limits"></a>Autopilot 모드 제한

Autopilot 모드의 처리량 및 저장소 제한에 대해서는 [Autopilot](provision-throughput-autopilot.md#autopilot-limits) 문서를 참조 하세요.
