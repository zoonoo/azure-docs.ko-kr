...
|---------------------|-------|--------------|-----------|
| ExceededTimeLimit   | 50 | 요청이 실행의 60 초 제한을 초과 했습니다. | 이 오류의 원인은 여러 가지가 있을 수 있습니다. 원인 중 하나는 현재 할당 된 요청 단위 용량이 부족 하 여 요청을 완료할 수 없는 경우입니다. 이는 해당 컬렉션 또는 데이터베이스의 요청 단위를 늘려서 해결할 수 있습니다. 다른 경우에는 대규모 요청을 더 작은 요청으로 분할 하 여이 오류를 해결할 수 있습니다. |
