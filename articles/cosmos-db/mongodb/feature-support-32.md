...
또한 Azure Cosmos DB의 API for MongoDB는 적격 계정에 대한 원활한 업그레이드 환경을 제공합니다. 자세한 내용은 [MongoDB 버전 업그레이드 가이드](upgrade-mongodb-version.md)를 참조하세요.
