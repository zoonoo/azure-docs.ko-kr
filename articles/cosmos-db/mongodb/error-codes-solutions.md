...
>[!Note]
> Azure Cosmos DB는 MongoDB 엔진을 호스트하지 않습니다. MongoDB [유선 프로토콜 버전 4.0](feature-support-40.md)과 [3.6](feature-support-36.md) 및 [유선 프로토콜 버전 3.2](feature-support-32.md)의 레거시 지원을 구현합니다. 따라서 일부 오류는 MongoDB용 Azure Cosmos DB의 API에서만 발생합니다.
