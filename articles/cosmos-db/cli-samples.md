...
| [Gremlin API 계정 만들기](scripts/create-graph-database-account-cli.md?toc=%2fcli%2fazure%2ftoc.json) | 단일 Azure Cosmos DB Gremlin API 계정, 데이터베이스 및 컬렉션을 만듭니다. |
|**Azure Cosmos DB 확장**||
