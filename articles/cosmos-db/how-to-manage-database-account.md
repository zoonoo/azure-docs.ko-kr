...
> [!NOTE]
> 쓰기 지역이 여러 개인 계정은 수동으로 장애 조치 (failover) 할 수 없습니다. Azure Cosmos SDK를 사용 하는 응용 프로그램의 경우 SDK는 지역을 사용할 수 없게 되는 경우를 감지 하 고 다음으로 가장 가까운 지역으로 자동으로 리디렉션합니다.
