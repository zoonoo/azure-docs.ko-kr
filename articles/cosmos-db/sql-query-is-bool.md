---
title: Azure 코스모스 DB 쿼리 언어로 IS_BOOL
description: Azure Cosmos DB에서 IS_BOOL SQL 시스템 기능에 대해 알아봅니다.
author: ginamr
...
---
# <a name="is_bool-azure-cosmos-db"></a>IS_BOOL (Azure 코스모스 DB)
...
## <a name="examples"></a>예
  ...
  다음 예제에서는 함수를 사용하여 JSON Boolean, 숫자, 문자열, null, 개체, 배열 및 정의되지 않은 형식의 개체를 `IS_BOOL` 검사합니다.  
