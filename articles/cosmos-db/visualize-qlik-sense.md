---
title: Qlik Sense를 Azure Cosmos DB에 연결하고 데이터 시각화 | Microsoft Docs
...
> [!NOTE]
> Azure Cosmos DB를 Qlik Sense에 연결하는 기능은 현재 Azure Cosmos DB SQL API 계정에서만 지원됩니다.
