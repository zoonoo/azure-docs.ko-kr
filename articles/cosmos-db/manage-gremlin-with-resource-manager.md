...
---
# <a name="create-azure-cosmos-db-gremlin-api-resources-from-a-resource-manager-template"></a>Resource Manager 템플릿에서 Azure Cosmos DB Gremlin API 리소스 만들기

Azure Resource Manager 템플릿을 사용 하는 Azure Cosmos DB Gremlin API 리소스를 만드는 방법에 알아봅니다. 다음 예제에서는에서 Azure Cosmos DB Gremlin API를 [Azure 빠른 시작 템플릿](https://aka.ms/gremlin-arm-qs)합니다. 이 템플릿은 데이터베이스 수준에서 400 RU/s 처리량을 공유 하는 두 개의 그래프를 사용 하 여 Gremlin API에 대 한 Azure Cosmos 계정이 만들어집니다.
