...
- [MongoDB에 대 한 Azure Cosmos DB API에 대 한 전역 배포 구성](#globally-distribute-your-data)
...
## <a name="globally-distribute-your-data"></a>데이터를 전역적으로 배포

Azure Cosmos DB는 전 세계의 모든 [Azure 지역](https://azure.microsoft.com/regions/#services)에서 사용할 수 있습니다. Azure Cosmos DB 계정에 대 한 기본 일관성 수준을 선택한 후에는 글로벌 배포 요구 사항에 따라 하나 이상의 Azure 지역에 연결할 수 있습니다. 고가용성 및 비즈니스 연속성을 위해 항상 두 개 이상의 지역에서를 실행 하는 것이 좋습니다. [Azure Cosmos DB에서 다중 지역 배포의 비용을 최적화](optimize-cost-regions.md)하기 위한 팁을 검토할 수 있습니다.
