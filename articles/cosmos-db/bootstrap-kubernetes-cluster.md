...
1. Azure Cosmos DB의 etcd API는 현재 미리 보기로 제공됩니다. https://aka.ms/cosmosetcdapi-signup에서 미리 보기 버전을 사용하도록 가입합니다. 양식을 제출하면 구독은 Azure Cosmos etcd API를 사용하기 위한 허용 목록에 추가됩니다. 
