...
서비스를 사용할 수 없는 예외는 시간 초과를 유발 하는 일시적인 연결 문제가 있는 경우에 발생할 수 있습니다. 일반적으로이 시나리오와 관련 된 스택 추적에는 `ServiceUnavailableException` 진단 정보에 대 한 오류가 포함 됩니다. 예를 들면 다음과 같습니다.
