...
이 템플릿은 분석 TTL이 설정된 컨테이너와 수동 또는 자동 크기 조정 처리량에 대한 옵션을 사용하여 한 지역에 Azure Cosmos 계정을 만듭니다.
...
## <a name="azure-cosmos-account-with-standard-manual-throughput"></a>표준(수동) 처리량을 사용하는 Azure Cosmos 계정
