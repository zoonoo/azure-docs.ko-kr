...
[Cortana Intelligence Suite](https://social.technet.microsoft.com/wiki/contents/articles/36688.introduction-to-cortana-intelligence-suite.aspx)의 일부인 [Azure Machine Learning](https://azure.microsoft.com/services/machine-learning/)는 완전히 관리 되는 클라우드 서비스로, 간단한 끌어서 놓기 인터페이스의 알고리즘을 사용 하 여 워크플로를 만들거나, [R](https://en.wikipedia.org/wiki/R_\(programming_language\))에서 사용자 고유의 알고리즘을 코딩 하거나, 이미 빌드되고 준비 된 api를 사용할 수 있는 [Text Analytics](https://gallery.cortanaanalytics.com/MachineLearningAPI/Text-Analytics-2), Content Moderator 또는 [권장 사항](https://gallery.azure.ai/Solution/Recommendations-Solution)중 일부를 사용할 수 있습니다.
