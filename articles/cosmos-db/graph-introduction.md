...
* 이 방법은 각 Store 꼭짓점을 검색하는 비용을 한 번에 3개 그래프 개체(District, District->Store, Store)를 획득하는 것에서 단일 Store 꼭짓점으로 줄인다는 이점이 있습니다. 이 경우 쿼리 성능이 향상될 뿐 아니라 쿼리당 비용도 절감될 수 있습니다.
