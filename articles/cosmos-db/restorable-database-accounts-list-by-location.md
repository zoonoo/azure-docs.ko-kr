---
title: Azure Cosmos DB REST API를 사용 하 여 위치 별로 복원 가능한 데이터베이스 계정 나열
description: 구독 및 지역에서 사용할 수 있는 복원 가능한 Azure Cosmos DB 데이터베이스 계정을 모두 나열 합니다.
author: kanshiG
...
| restorableLocations |[RestorableLocationResource](#restorablelocationresource)[]| 데이터베이스 계정의를 복원할 수 있는 영역 목록입니다. |
...
복원 가능한 데이터베이스 계정 및 해당 속성을 포함 하는 List 작업 응답입니다.
...
* REST API를 사용 하 여 Azure Cosmos DB API for MongoDB에 [복원 가능한 컬렉션을 나열](restorable-database-accounts-list-by-location.md) 합니다.
