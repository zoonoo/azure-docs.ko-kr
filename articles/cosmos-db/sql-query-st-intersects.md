---
title: Azure 코스모스 DB 쿼리 언어로 ST_INTERSECTS
description: Azure Cosmos DB에서 ST_INTERSECTS SQL 시스템 기능에 대해 알아봅니다.
author: ginamr
...
---
# <a name="st_intersects-azure-cosmos-db"></a>ST_INTERSECTS (Azure 코스모스 DB)
