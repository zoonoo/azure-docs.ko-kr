...
description: Azure PowerShell 샘플을 가져와 Azure Cosmos DB Gremlin API 계정에서 다양한 일반 작업 수행
author: markjbrown
...
|[삭제에서 리소스 잠그기](scripts/powershell/gremlin/powershell-gremlin-lock.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 리소스 잠금을 사용하여 리소스를 삭제하지 않습니다. |
|||
