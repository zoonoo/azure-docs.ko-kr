---
title: Azure Cosmos DB용 Table API 테이블에 대한 RU/s 업데이트
description: Azure Cosmos DB용 Table API 테이블에 대한 RU/s 업데이트
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "87431546"
---
# <a name="update-rus-for-a-table-api-table-for-azure-cosmos-db-azure-cli"></a>Azure Cosmos DB Azure CLI용 Table API 테이블에 대한 RU/s 업데이트
...
이 스크립트는 Table API 테이블을 만든 다음, 테이블의 처리량을 업데이트합니다.
...
| [az cosmosdb table 처리량 업데이트](/cli/azure/cosmosdb/table/throughput#az-cosmosdb-table-throughput-update) | Azure Cosmos Table API 테이블에 대한 RU/s를 업데이트합니다. |
