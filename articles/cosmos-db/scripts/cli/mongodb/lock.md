---
title: Azure Cosmos DB용 MongoDB API의 데이터베이스 및 컬렉션에 대한 리소스 잠금 만들기
description: Azure Cosmos DB용 MongoDB API의 데이터베이스 및 컬렉션에 대한 리소스 잠금 만들기
author: markjbrown
ms.author: mjbrown
