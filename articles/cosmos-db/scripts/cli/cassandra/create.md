---
title: Azure Cosmos DB에 대한 Cassandra 키스페이스 및 테이블 만들기
description: Azure Cosmos DB에 대한 Cassandra 키스페이스 및 테이블 만들기
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "107786852"
---
# <a name="create-an-azure-cosmos-cassandra-api-account-keyspace-and-table-using-azure-cli"></a>Azure CLI를 사용하여 Azure Cosmos Cassandra API 계정, 키스페이스 및 테이블 만들기
