---
title: Azure Cosmos DB용 Gremlin 데이터베이스 및 그래프에 대한 RU/s 업데이트
description: Azure Cosmos DB용 Gremlin 데이터베이스 및 그래프에 대한 RU/s 업데이트
author: markjbrown
ms.author: mjbrown
...
ms.locfileid: "71275070"
---
# <a name="update-rus-for-a-gremlin-database-and-graph-for-azure-cosmos-db-using-azure-cli"></a>Azure CLI를 사용하여 Azure Cosmos DB용 Gremlin 데이터베이스 및 그래프에 대한 RU/s 업데이트
...
이 스크립트는 공유 처리량이 있는 Gremlin 데이터베이스와 전용 처리량이 있는 Gremlin 그래프를 만든 다음, 데이터베이스와 그래프 모두에 대한 처리량을 업데이트합니다.
