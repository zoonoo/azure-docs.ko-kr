---
title: Azure PowerShell 스크립트 - Azure Cosmos DB MongoDB API 계정 만들기
...
---
# <a name="azure-cosmos-db-create-a-mongodb-api-account-using-powershell"></a>Azure Cosmos DB는 PowerShell을 사용하여 MongoDB API 계정 만들기
