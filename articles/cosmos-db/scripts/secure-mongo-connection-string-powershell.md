...
[!code-powershell[주](../../../powershell_scripts/cosmosdb/get-mongodb-connection-string/get-mongodb-connection-string.ps1?highlight=37-41 "Azure Cosmos DB 계정에서 MongoDB 연결 문자열 가져오기")]
