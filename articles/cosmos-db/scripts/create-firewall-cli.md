---
title: Azure CLI 스크립트 - Azure Cosmos DB에 대한 방화벽 만들기
...
ms.locfileid: "52955369"
---
# <a name="azure-cosmos-db-create-a-firewall-using-azure-cli"></a>Azure Cosmos DB는 Azure CLI를 사용하여 방화벽 만들기
