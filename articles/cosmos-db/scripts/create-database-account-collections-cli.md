...
[!code-azurecli[main](../../../cli_scripts/cosmosdb/create-cosmosdb-account-database/create-cosmosdb-account-database.sh?highlight=15-35 "Azure Cosmos DB DocumentDB API 계정, 데이터베이스 및 컬렉션 만들기")]
