---
title: Azure PowerShell 스크립트 - Azure Cosmos DB SQL API 계정 만들기
...
ms.locfileid: "52955567"
---
# <a name="azure-cosmos-db-create-a-sql-api-account-using-powershell"></a>Azure Cosmos DB는 PowerShell을 사용하여 SQL API 계정 만들기
