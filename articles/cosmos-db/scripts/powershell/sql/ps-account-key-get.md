---
title: Azure PowerShell 스크립트-Azure Cosmos 계정의 키 가져오기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정의 키 가져오기
author: markjbrown
...
ms.locfileid: "65078402"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정의 키를 가져옵니다.
