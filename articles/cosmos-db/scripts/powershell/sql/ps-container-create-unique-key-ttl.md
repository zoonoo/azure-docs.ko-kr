---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에서 고유 키 정책 및 TTL을 사용 하 여 컨테이너 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에서 고유 키 정책 및 TTL을 사용 하 여 컨테이너 만들기
author: markjbrown
...
ms.locfileid: "65078252"
---
# <a name="create-a-container-with-unique-key-policy-and-ttl-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 고유 키 정책 및 TTL을 사용 하 여 컨테이너를 만들기
