---
title: Azure PowerShell 스크립트-Azure Cosmos 계정 삭제
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정 삭제
author: markjbrown
...
ms.locfileid: "65078417"
---
# <a name="delete-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정 삭제
...
|---|---|
|**Azure 리소스**| |
| [Remove-AzResource](https://docs.microsoft.com/powershell/module/az.resources/remove-azresource) | 리소스를 삭제합니다. |
|**Azure 리소스 그룹**| |
