---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 대 한 코어 (SQL) API 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 대 한 코어 (SQL) API 만들기
author: markjbrown
...
ms.locfileid: "65078432"
---
# <a name="create-an-azure-cosmos-account-for-core-sql-api-account-using-powershell"></a>PowerShell을 사용 하 여 (코어) SQL API 계정에 대 한 Azure Cosmos 계정 만들기
