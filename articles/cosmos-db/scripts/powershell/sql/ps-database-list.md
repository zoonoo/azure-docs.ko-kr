---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 모든 데이터베이스 목록
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 모든 데이터베이스 목록
author: markjbrown
...
ms.locfileid: "65077682"
---
# <a name="list-all-databases-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 있는 모든 데이터베이스 나열
