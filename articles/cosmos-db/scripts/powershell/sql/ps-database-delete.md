---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 데이터베이스 삭제
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 데이터베이스 삭제
author: markjbrown
...
ms.locfileid: "65077727"
---
# <a name="delete-a-database-in-an-azure-cosmos-account-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에서 Azure Cosmos 계정에 데이터베이스를 삭제 합니다.
