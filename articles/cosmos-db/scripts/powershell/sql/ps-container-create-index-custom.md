---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 사용자 지정 인덱스 정책을 사용 하 여 컨테이너 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 사용자 지정 인덱스 정책을 사용 하 여 컨테이너 만들기
author: markjbrown
...
---
# <a name="create-a-container-with-custom-index-policy-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 사용자 지정 인덱스 정책을 사용 하 여 컨테이너를 만듭니다.
