---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 컨테이너 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 컨테이너 만들기
author: markjbrown
...
ms.locfileid: "65078237"
---
# <a name="create-a-container-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에서 컨테이너 만들기
