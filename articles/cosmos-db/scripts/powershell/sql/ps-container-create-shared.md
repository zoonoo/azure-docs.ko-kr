---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 공유 처리량을 사용 하 여 컨테이너 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 공유 처리량을 사용 하 여 컨테이너 만들기
author: markjbrown
...
ms.locfileid: "65078267"
---
# <a name="create-a-container-with-shared-throughput-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 공유 처리량을 사용 하 여 컨테이너 만들기
