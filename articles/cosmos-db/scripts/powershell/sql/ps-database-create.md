---
title: Azure PowerShell 스크립트-Azure Cosmos 데이터베이스 만들기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 데이터베이스 만들기
author: markjbrown
...
---
# <a name="create-an-azure-cosmos-database-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 데이터베이스 만들기
