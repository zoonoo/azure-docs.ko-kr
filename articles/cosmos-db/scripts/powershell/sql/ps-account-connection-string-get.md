---
title: Azure PowerShell 스크립트-Azure Cosmos 계정의 연결 문자열 가져오기
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정의 연결 문자열 가져오기
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정의 연결 문자열 가져오기
