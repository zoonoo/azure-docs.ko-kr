---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에서 컨테이너 삭제
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에서 컨테이너 삭제
author: markjbrown
...
---
# <a name="delete-a-container-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에서 컨테이너 삭제
