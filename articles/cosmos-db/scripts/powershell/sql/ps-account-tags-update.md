---
title: Azure PowerShell 스크립트-Azure Cosmos 계정의 업데이트 태그
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정의 업데이트 태그
author: markjbrown
...
ms.locfileid: "65078342"
---
# <a name="update-tags-for-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정의 태그 업데이트
