---
title: Azure PowerShell 스크립트-Azure Cosmos 데이터베이스를 공유 하는 처리량을 사용 하 여 만들기
description: Azure PowerShell 스크립트 샘플-공유 처리량을 사용 하 여 Azure Cosmos 데이터베이스 만들기
author: markjbrown
...
ms.locfileid: "65077712"
---
# <a name="create-an-azure-cosmos-database-with-shared-throughput-using-powershell"></a>PowerShell을 사용 하 여 공유 처리량을 사용 하 여 Azure Cosmos 데이터베이스 만들기
