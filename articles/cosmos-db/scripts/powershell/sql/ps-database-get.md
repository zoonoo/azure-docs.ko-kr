---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 데이터베이스의 속성을 가져옵니다.
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 데이터베이스의 속성을 가져옵니다.
author: markjbrown
...
ms.locfileid: "65077667"
---
# <a name="get-the-properties-of-a-database-in-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 데이터베이스의 속성을 가져옵니다.
