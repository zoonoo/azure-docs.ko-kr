---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 대 한 IP 방화벽 구성
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 대 한 IP 방화벽 구성
author: markjbrown
...
ms.locfileid: "65078372"
---
# <a name="configure-ip-firewall-for-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정에 대 한 IP 방화벽을 구성 합니다.
