---
title: Azure PowerShell 스크립트-Azure Cosmos 계정에 대 한 키 다시 생성
description: Azure PowerShell 스크립트 샘플-Azure Cosmos 계정에 대 한 키 다시 생성
author: markjbrown
...
ms.locfileid: "65078357"
---
# <a name="regenerate-keys-for-an-azure-cosmos-account-using-powershell"></a>PowerShell을 사용 하 여 Azure Cosmos 계정의 키를 다시 생성
