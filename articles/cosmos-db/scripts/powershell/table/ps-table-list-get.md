...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | 계정의 Cosmos DB Table API 테이블을 나열하거나 계정에 지정된 Cosmos DB Table API 테이블을 가져옵니다. |
|**Azure 리소스 그룹**| |
