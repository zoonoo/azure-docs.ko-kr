---
title: Azure Cosmos DB Table API에서 테이블을 만드는 PowerShell 스크립트
...
| [New-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/new-azcosmosdbtable) | Table API 테이블을 만듭니다. |
|**Azure 리소스 그룹**| |
