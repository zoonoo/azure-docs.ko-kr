...
|---|---|
|**Azure Cosmos DB**| |
| [Get-AzCosmosDBMongoDBDatabaseThroughput](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbmongodbdatabasethroughput) | 지정된 MongoDB API Database의 처리량 값을 가져옵니다. |
| [Get-AzCosmosDBMongoDBCollectionThroughput](hhttps://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbmongodbcollectionthroughput) | 지정된 MongoDB API 컬렉션의 처리량 값을 가져옵니다. |
|**Azure 리소스 그룹**| |
