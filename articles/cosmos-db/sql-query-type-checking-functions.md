---
title: Azure Cosmos DB 쿼리 언어에서 함수를 검사하는 형식
description: Azure Cosmos DB에서 SQL 시스템 함수를 확인하는 유형에 대해 알아봅니다.
author: ginamr
...
---
# <a name="type-checking-functions-azure-cosmos-db"></a>형식 검사 기능(Azure 코스모스 DB)

형식 검사 함수를 사용하면 SQL 쿼리 내에서 식의 형식을 확인할 수 있습니다. 형식 검사 함수를 사용하여 가변적이거나 알 수 없는 경우 즉석에서 항목 내의 속성 유형을 결정할 수 있습니다. 

## <a name="functions"></a>함수

다음은 지원되는 기본 제공 형식 검사 함수 테이블입니다.
