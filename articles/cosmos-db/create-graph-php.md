...
이 빠른 시작은 GitHub에서 예제를 복제하여 콘솔 앱을 빌드하기 위해 PHP와 Azure Cosmos DB [Graph API](graph-introduction.md)를 사용하는 방법을 보여 줍니다. 이 빠른 시작에서는 또한 웹 기반 Azure Portal을 사용하여 Azure Cosmos DB 계정을 만드는 과정을 안내합니다.   
