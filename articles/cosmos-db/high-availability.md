...
- **단일 쓰기 지역이 있는 다중 지역 계정 (쓰기 영역 중단):**
  ...
  - 또한 고객은 **수동 장애 조치 (failover)** 를 사용 하도록 선택 하 고 자체적으로 작성 된 에이전트를 사용 하 여 Cosmos 쓰기 끝점 URL을 모니터링할 수 있습니다. 복잡 하 고 정교한 상태 모니터링 요구 사항을 충족 하는 고객의 경우 쓰기 지역에서 오류가 발생 하는 경우 감소 하는 RTO를 제공할 수 있습니다.
