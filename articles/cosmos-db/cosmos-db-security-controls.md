...
description: Azure Cosmos DB 평가를 위한 보안 컨트롤의 검사 목록
services: cosmos-db
documentationcenter: ''
author: msmbaldwin
manager: rkarlin
...
| 보안 제어 | 예/아니요 | 참고 |
|---|---|--|
| 미사용 서버 쪽 암호화: Microsoft에서 관리 하는 키 | 예 | 모든 Cosmos 데이터베이스 및 백업은 기본적으로 암호화 됩니다. [Azure Cosmos DB의 데이터 암호화를](database-encryption-at-rest.md)참조 하세요. 고객 관리 키를 사용 하는 서버 쪽 암호화는 지원 되지 않습니다. |
