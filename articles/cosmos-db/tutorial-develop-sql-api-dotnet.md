...
---
# <a name="azure-cosmosdb-develop-with-the-sql-api-in-net"></a>Azure Cosmos DB: .NET의 SQL API를 사용하여 개발
...
![C# 콘솔 응용 프로그램을 만들기 위해 NoSQL 자습서에서 사용하는 Azure Portal의 스크린샷 Azure Cosmos DB 계정 블레이드에서 강조 표시된 키 및 키 블레이드에서 강조 표시된 URI와 키 값이 있는 Azure Cosmos DB 계정을 보여 줍니다.](./media/tutorial-develop-sql-api-dotnet/nosql-tutorial-keys.png)
