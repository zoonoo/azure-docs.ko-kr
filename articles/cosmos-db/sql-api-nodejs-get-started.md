...
ms.locfileid: "46969062"
---
# <a name="nodejs-tutorial-create-a-nodejs-console-application-with-javascript-sdk-to-manage-azure-cosmos-db-sql-api-data"></a>Node.js 자습서: JavaScript SDK에서 Azure Cosmos DB SQL API 데이터를 관리하기 위한 Node.js 콘솔 응용 프로그램 만들기
