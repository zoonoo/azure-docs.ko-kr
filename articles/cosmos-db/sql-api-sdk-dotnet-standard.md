---
title: 'Azure 코스모스 DB: SQL .NET 표준 API, SDK & 리소스'
description: Azure Cosmos DB .NET SDK의 각 버전 간에 릴리스 날짜, 사용 중지 날짜 및 변경 사항을 포함하여 SQL API 및 .NET SDK에 대해 자세히 알아봅니다.
author: deborahc
...
---
# <a name="azure-cosmos-db-net-standard-sdk-for-sql-api-download-and-release-notes"></a>AZURE 코스모스 DB .NET 표준 SDK SQL API: 다운로드 및 릴리스 노트
