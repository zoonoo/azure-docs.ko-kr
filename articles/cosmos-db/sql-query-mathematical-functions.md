...
|[COS](sql-query-cos.md)|[COT](sql-query-cot.md)|[각도](sql-query-degrees.md)|  
|[EXP](sql-query-exp.md)|[FLOOR](sql-query-floor.md)|[로그](sql-query-log.md)|  
|[LOG10](sql-query-log10.md)|[PI](sql-query-pi.md)|[전원](sql-query-power.md)|  
|[라디안](sql-query-radians.md)|[RAND](sql-query-rand.md)|[반올림](sql-query-round.md)|
