...
이 빠른 시작에서는 Mongo DB 및 Java SDK용 Azure Cosmos DB API를 사용하여 콘솔 웹앱을 만듭니다. Azure Cosmos DB를 사용하면 문서, 키/값 및 그래프 데이터베이스를 빠르게 만들고 쿼리할 수 있으며, 이 모든 기능은 Cosmos DB의 핵심에 있는 글로벌 배포 및 수평 확장 기능을 활용할 수 있습니다.
