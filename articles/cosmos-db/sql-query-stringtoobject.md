...
## <a name="examples"></a>예
  ...
  다음 예제에서는 `StringToObject`이 서로 다른 형식에서 동작 하는 방식을 보여 줍니다. 
...
쿼리 내에서 유효 하더라도 유효한 개체로 구문 분석 되지 않습니다. 개체의 문자열에 있는 문자열은 "{\\" a @ no__t-1 ": \\" str @ no__t-3 "}" 이거나, 닫는 따옴표는 단일 ' {"a": "str"} ' 여야 합니다.
