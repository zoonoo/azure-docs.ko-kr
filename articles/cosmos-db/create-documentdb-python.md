...
이 빠른 시작에서는 Azure Portal을 사용하여 Azure Cosmos DB 계정, 문서 데이터베이스 및 컬렉션을 만드는 방법을 보여 줍니다. 그런 다음, [DocumentDB Python API](documentdb-sdk-python.md)에서 작성한 콘솔 앱을 빌드 및 실행합니다.
