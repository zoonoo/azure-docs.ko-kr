...
EndsWith의 속성 크기가 일부 문서에 대해 1KB보다 큰 경우 쿼리 엔진은 해당 문서를 로드해야 합니다. 이 경우 쿼리 엔진은 인덱스로 EndsWith를 완전히 평가할 수 없습니다. EndsWith에 대한 RU 요금은 속성 크기가 1KB를 초과하는 문서가 많은 경우 높습니다.
