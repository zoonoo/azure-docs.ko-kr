...
ms.locfileid: "46957349"
---
# <a name="_Toc395783175"></a>JavaScript SDK를 사용하여 Node.js 웹앱을 빌드하여 Azure Cosmos DB SQL API 데이터 관리
...
이 자습서에서는 Azure Portal을 사용하여 Azure Cosmos DB SQL API 계정을 만드는 방법을 보여줍니다. 그 후에는 Node.js SDK 기반의 웹앱을 빌드하고 실행하여 데이터베이스 및 컨테이너를 만들고 컨테이너에 항목을 추가합니다. 이 자습서에서는 JavaScript SDK의 버전 2.0을 사용합니다.
