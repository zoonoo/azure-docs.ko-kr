...
|**빠른 시작**|[Azure Cosmos DB: .NET 및 Table API를 사용하여 앱 빌드](https://aka.ms/acdbtnetqs)|
...
Azure Cosmos DB Table API에 대한 자세한 내용은 [Azure Cosmos DB 소개: Table API](table-introduction.md)를 참조하세요. 