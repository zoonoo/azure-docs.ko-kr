...
프로젝트의 수준을 올려보겠습니다. 차세대 DocumentDB 스택인 Azure Cosmos DB로 작업 중인 멋진 프로젝트를 보여주고 사용자의 재능을 다른 사람과 공유할 수 있도록 합니다. 프로젝트를 제출하려면 [askcosmosdb@microsoft.com](mailto:askcosmosdb@microsoft.com)으로 메일을 보내세요.

### <a name="documentdb-lumenize"></a>documentdb-lumenize
*Larry Maccherone 작성*

Azure Cosmos DB DocumentDB API의 저장 프로시저인 집계(Group-by, 피벗 테이블 및 N 차원 큐브) 및 시계열 변환입니다.
...
Azure Cosmos DB DocumentDB API 서비스용 클라이언트 관리 뷰어/탐색기입니다.
...
DoQmentDB는 Azure Cosmos DB 위에 MongoDB와 비슷한 계층을 제공하는 Node.js 프라미스 기반 클라이언트입니다.
...
API 앱으로 쉽게 배포할 수 있는 DocumentDB API에 대한 Azure Cosmos DB REST API Swagger 파일입니다.
...
fluent-plugin-documentdb는 Azure Cosmos DB DocumentDB API로 출력하기 위한 Fluentd 플러그 인입니다.
...
*[GitHub](https://github.com/search?p=4&q=documentdb&type=Repositories)에서 더 많은 오픈 소스 Azure Cosmos DB 프로젝트를 찾아볼 수 있습니다.*

## <a name="news-blogs-and-articles"></a>뉴스, 블로그 및 문서
[블로그](https://azure.microsoft.com/blog/tag/documentdb/)를 팔로우하여 최신 Azure Cosmos DB 소식과 기능에 대한 최신 동향을 파악하세요.
...
* [**Node.js + Azure DocumentDB 솔루션의 Infrastructure as Code 및 연속 배포(영문)**](http://www.talmeida.net/blog/2015/10/26/infrastructure-as-code-and-continuous-deployment-of-a-nodejs-azure-documentdb-solution) - *Thiago Almedia 작성*
...
*공유하려는 블로그 게시물, 코드 샘플 또는 사례 연구가 있나요? [알려주세요](mailto:askcosmosdb@microsoft.com)!*
...
| 학습 파트너 | 설명 |
| --- | --- |
| [![Microsoft Virtual Academy](./media/community/mva.png)](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) |[**Microsoft Virtual Academy**](https://mva.microsoft.com/en-US/training-courses/azure-documentdb-planetscale-nosql-16847) 는 Azure DocumentDB 구축에 참여한 전문가의 교육 과정을 제공합니다. |
| [![Pluralsight](./media/community/pluralsight.png)](http://www.pluralsight.com/courses/azure-documentdb-introduction) |[**Pluralsight**](http://www.pluralsight.com/courses/azure-documentdb-introduction) 는 Azure 교육을 제공하는 핵심 Microsoft 파트너입니다. MSDN 구독자의 경우 구독 혜택을 사용하여 Microsoft Azure 교육을 이용할 수 있습니다. |
| [![OpsGility](./media/community/opsgility.png)](https://www.opsgility.com/courses/player/introduction_to_azure_documentdb) |[**OpsGility**](https://www.opsgility.com/courses/player/introduction_to_azure_documentdb) 는 Microsoft Azure에 대한 세부 기술 교육을 제공합니다. 현장에서 이뤄지는 강사 주도형 교육 또는 업계에서 인정받고 있는 전문 강사로 구성된 원격 강의를 받아 보세요. |
...
| 포럼 공급자 | 설명 |
| --- | --- |
| [![StackOverflow](./media/community/stack-overflow.png)](http://stackoverflow.com/questions/tagged/azure-documentdb) |프로그래머를 위해 공동으로 언어 독립적이게 편집된 질문 및 답변 사이트입니다. [azure documentdb](http://stackoverflow.com/questions/tagged/azure-documentdb) |

## <a name="contact-the-team"></a>팀에 문의
![팀](./media/community/team.png)

기술 지원이 필요합니까? 질문이 있으십니까? NoSQL이 적합한지 궁금하십니까? [전자 메일](mailto:askcosmosdb@microsoft.com)을 보내거나 [@DocumentDB](https://twitter.com/DocumentDB)에서 트윗하여 DocumentDB 엔지니어링 팀과 직접 1:1 채팅을 예약할 수 있습니다.
...
| 데이터 마이그레이션 도구 |[azure-documentdb-datamigrationtool](https://github.com/Azure/azure-documentdb-datamigrationtool) |[Microsoft 다운로드 센터](http://www.microsoft.com/download/details.aspx?id=46436) |

## <a name="azure-cosmos-db-wizards"></a>Azure Cosmos DB 마법사
Azure Cosmos DB 마법사는 다른 사용자가 차세대 Azure DocumentDB인 Azure Cosmos DB에서 경험을 최대한 활용할 수 있도록 돕기 위해 모범을 보여왔던 커뮤니티 리더입니다. 놀라운 열정, 실제 지식 및 기술적 전문성을 커뮤니티 및 Azure Cosmos DB 팀과 공유합니다.
...
Azure Cosmos DB 마법사가 되고 싶으세요? 마법사가 되기 위한 벤치마크는 없지만 몇 가지 평가 기준에는 StackOverflow 및 MSDN과 같은 온라인 포럼, wiki 및 온라인 콘텐츠, 회의 및 사용자 그룹, 팟캐스트, 웹 사이트, 블로그 및 소셜 미디어, 기사 및 저서와 관련된 후보자의 영향력이 포함됩니다. [메일을 보내](mailto:askcosmosdb@microsoft.com)자신이나 다른 사용자를 후보로 지명할 수 있습니다.
