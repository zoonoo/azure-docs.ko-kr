...
**전역적으로 읽기 및 쓰기 처리량 조정** 전 세계의 모든 리전을 작성 가능하고 탄력적으로 확장할 수 있습니다. 응용 프로그램이 Azure Cosmos 데이터베이스 또는 컨테이너에서 구성하는 처리량은 Azure Cosmos 계정과 연결된 모든 리전에서 제공되도록 보장됩니다. 프로비저닝된 처리량은 [재정적으로 지원되는 SLA에](https://aka.ms/acdbsla)의해 보장됩니다.
