...
[리소스 관리자 템플릿을 사용 하 여 MONGODB API에 대 한 Azure Cosmos DB 컬렉션을 만듭니다](manage-sql-with-resource-manager.md#azure-cosmos-account-with-standard-provisioned-throughput).
