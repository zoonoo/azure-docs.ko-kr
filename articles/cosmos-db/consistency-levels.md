...
- **세션**:  단일 클라이언트 세션 내에서 일관 된 접두사 (단일 "writer" 세션 가정), 단조 읽기, 단조 쓰기, 읽기-사용자-쓰기 및 읽기 뒤 쓰기 보장을 적용할 읽기가 보증 됩니다. 쓰기를 수행 하는 세션 외부 클라이언트에는 최종 일관성을 표시 됩니다.
