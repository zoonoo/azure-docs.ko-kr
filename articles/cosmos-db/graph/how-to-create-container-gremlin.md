...
이 문서에서는 Azure Cosmos DB Gremlin API에서 컨테이너를 만드는 다양한 방법을 설명합니다. 다른 API를 사용하는 경우 [MongoDB용 API](../mongodb/how-to-create-container-mongodb.md), [Cassandra API](../cassandra/how-to-create-container-cassandra.md), [Table API](../table/how-to-create-container.md) 및 [SQL API](../how-to-create-container.md) 문서를 참조하여 컨테이너를 만듭니다.
