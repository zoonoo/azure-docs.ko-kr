...
두 개의 스프링 데이터 Azure Cosmos DB 버전 3 Maven 아티팩트를 사용할 수 있습니다.

- 스프링 데이터 프레임 워크 버전 2.2에 종속 된 아티팩트:
  ```xml
  <dependency>
...
- 스프링 데이터 프레임 워크 버전 2.3에 종속 된 아티팩트:
  ```xml
  <dependency>
      <groupId>com.azure</groupId>
...
| 리소스 | 스프링 데이터 프레임 워크 2.2 | 스프링 데이터 프레임 워크 2.3 |
|---|---|
...
|**SDK에 기여** | [GitHub의 스프링 데이터 Azure Cosmos DB 리포지토리](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/cosmos/azure-spring-data-2-2-cosmos) | [GitHub의 스프링 데이터 Azure Cosmos DB 리포지토리](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/cosmos/azure-spring-data-2-3-cosmos) | 
...
### <a name="300-beta2-unreleased"></a>3.0.0-beta. 2 (릴리스되지 않음)
