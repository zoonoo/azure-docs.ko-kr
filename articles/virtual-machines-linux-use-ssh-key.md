<properties pageTitle="SSH를 사용하여 Azure의 Linux 가상 컴퓨터에 연결" description="SSH 키를 생성하여 Azure에서 Linux 가상 컴퓨터에 사용하는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor=""/>
