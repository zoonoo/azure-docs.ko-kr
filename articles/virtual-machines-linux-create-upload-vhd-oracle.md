<properties urlDisplayName="Upload an Oracle Linux VHD" pageTitle="Azure에서 Oracle Linux VHD 만들기 및 업로드" metaKeywords="Azure VHD, uploading Linux VHD, Oracle Linux" description="Oracle Linux 운영 체제가 포함된 Azure VHD(가상 하드 디스크)를 만들고 업로드하는 방법에 대해 알아봅니다." metaCanonical="" services="virtual-machines" documentationCenter="" title="Oracle Linux 운영 체제가 포함된 가상 하드 디스크 만들기 및 업로드" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Azure용 Oracle Linux 6.4 이상 가상 컴퓨터 준비][Azure용 Oracle Linux 6.4 이상 가상 컴퓨터 준비]
-   [Azure용 Oracle Linux 7.0 이상 가상 컴퓨터 준비][Azure용 Oracle Linux 7.0 이상 가상 컴퓨터 준비]

## 필수 조건

이 문서에서는 가상 하드 디스크에 Oracle Linux 운영 체제를 이미 설치했다고 가정합니다. Hyper-V와 같은 가상화 솔루션 등의 다양한 도구를 사용하여 .vhd 파일을 만들 수 있습니다. 관련 지침은 [Hyper-V 역할 설치 및 가상 컴퓨터 구성][Hyper-V 역할 설치 및 가상 컴퓨터 구성]을 참조하세요.
...
## <span id="oracle6"></span> </a> Oracle Linux 6.4 이상
...
## <span id="oracle7"></span> </a> Oracle Linux 7.0 이상
