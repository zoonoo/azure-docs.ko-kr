...
### <a name="bundle-command-line-arguments"></a>번들 명령줄 인수
```
Options:
...
작업 영역 ID는 선택적 매개 변수입니다. 이 ID를 지정한 경우 작업 영역별 디먼에서만 작동합니다.  그렇지 않으면 모든 디먼에서 작동합니다.
...
### <a name="centos-oracle-linux-rhel-and-sles"></a>CentOS, Oracle Linux, RHEL 및 SLES
```
