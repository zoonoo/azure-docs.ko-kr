...
솔루션 갤러리에서 볼 수 있는 ITSMC 타일은 다음과 같습니다.
...
> 기본적으로 ITSMC는 24시간 마다 한 번씩 연결의 데이터를 새로 고칩니다. 적용한 편집 내용 또는 템플릿 업데이트에 대해 연결 데이터를 즉시 새로 고치려면 연결 옆에 표시된 “새로 고침” 단추를 클릭합니다.
...
커넥터를 구성하면, 연결된 ITSM 제품/서비스에서 데이터를 수집하기 시작합니다. ITSM 제품/서비스의 인시던트 수 및 변경 요청에 따라 몇 분 안에 초기 동기화를 완료해야 합니다.

> [!NOTE]
> - ITSMC 솔루션에서 ITSM 제품으로부터 가져온 데이터는 Log Analytics에서 **ServiceDesk_CL** 유형의 로그 레코드로 표시됩니다.
...
인시던트 및 변경 요청은 ITSM 제품에서 Log Analytics 작업 영역으로 동기화됩니다.
...
## <a name="itsmc-integration-with-other-oms-solutions"></a>다른 OMS 솔루션과의 ITSMC 통합

ITSMC는 현재 서비스 맵 솔루션과의 통합을 지원합니다.
...
ITSM 솔루션을 사용하면 연결된 ITSM 도구에서 작업 항목 만들기를 트리거하는 OMS 경고를 구성할 수 있습니다. 이렇게 하려면 다음 절차를 수행합니다.
...
로그 레코드에서 직접 연결된 ITSM 원본의 작업 항목을 만들 수도 있습니다. 이렇게 하려면 다음 절차를 수행합니다.
