<properties
    pageTitle="서비스 공급자에 대한 Log Analytics 기능 | Microsoft Azure"
...
>[AZURE.NOTE] Log Analytics에 대한 Backup 및 Site Recovery 솔루션을 Recovery Services 자격 증명 모음에 연결할 수 없으며 CSP 구독에서 구성할 수 없습니다.
