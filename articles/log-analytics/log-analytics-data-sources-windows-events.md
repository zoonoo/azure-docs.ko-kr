<properties 
   pageTitle="Log Analytics의 Windows 이벤트 로그 | Microsoft Azure"
...
# Log Analytics의 Windows 이벤트 로그 데이터 원본
...
Log Analytics에서는 설정에 지정된 Windows 이벤트 로그에서만 이벤트를 수집합니다. 로그 이름을 입력하고 **+**를 클릭하여 새 로그를 추가할 수 있습니다. 각 로그에 대해 선택한 심각도의 이벤트만 수집됩니다. 수집하려는 특정 로그에 대한 심각도를 확인합니다. 이벤트를 필터링할 추가 조건을 제공할 수 없습니다.
