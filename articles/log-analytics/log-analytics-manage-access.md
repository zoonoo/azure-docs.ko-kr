...
2. Log Analytics 구독 창에서 **추가**를 클릭합니다.  
    ...
    ![작업 영역 목록](./media/log-analytics-manage-access/workspace-link-existing-01.png)
...
3. **가격 책정 계층**에서 가격 책정 계층을 선택하고 **선택**을 클릭합니다.  
    ![선택된 가격 책정 계획](./media/log-analytics-manage-access/workspace-pricing-tier-info.png)
