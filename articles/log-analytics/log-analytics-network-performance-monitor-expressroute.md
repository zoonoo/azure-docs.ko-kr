...
6. **저장**을 선택하여 구성을 저장합니다. 
   ...
   ![ExpressRoute 모니터링 구성](media/log-analytics-network-performance-monitor/expressroute-configure-discovery.png)
...
![네트워크 성능 모니터 대시보드](media/log-analytics-network-performance-monitor/npm-dashboard-expressroute.png) 
...
![ExpressRoute 가상 네트워크 연결](media/log-analytics-network-performance-monitor/expressroute-vnet.png)
...
![ExpressRoute 회로 중단](media/log-analytics-network-performance-monitor/expressroute-circuit-down.png)
...
![ExpressRoute 대역폭 사용률](media/log-analytics-network-performance-monitor/expressroute-peak-utilization.png)
