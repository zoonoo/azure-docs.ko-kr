...
![ExpressRoute 모니터](media/log-analytics-network-performance-monitor-expressroute/expressroute-intro.png)
...
2. **지금 검색** 단추를 선택하여 이 Azure Log Analytics 작업 영역에 연결된 Azure 구독의 가상 네트워크에 연결되어 있는 모든 ExpressRoute 개인 피어링을 검색합니다.
    ...
    ![ExpressRoute 모니터 구성](media/log-analytics-network-performance-monitor-expressroute/expressroute-configure.png)
...
6. **저장**을 선택하여 구성을 저장합니다. 
   ...
   ![ExpressRoute 모니터링 구성](media/log-analytics-network-performance-monitor-expressroute/expressroute-configure-discovery.png)
...
![네트워크 성능 모니터 대시보드](media/log-analytics-network-performance-monitor-expressroute/npm-dashboard-expressroute.png) 
...
![ExpressRoute 회로 목록](media/log-analytics-network-performance-monitor-expressroute/expressroute-circuits.png) 
...
![ExpressRoute 대기 시간](media/log-analytics-network-performance-monitor-expressroute/expressroute-latency.png) 
...
![ExpressRoute 피어링](media/log-analytics-network-performance-monitor-expressroute/expressroute-peerings.png) 
...
![ExpressRoute 토폴로지](media/log-analytics-network-performance-monitor-expressroute/expressroute-topology.png)

### <a name="detailed-topology-view-of-a-circuit"></a>회로의 자세한 토폴로지 보기 

이 보기에서는 가상 네트워크 연결을 표시합니다. 

![ExpressRoute 가상 네트워크 연결](media/log-analytics-network-performance-monitor-expressroute/expressroute-vnet.png)
...
![ExpressRoute 회로 중단](media/log-analytics-network-performance-monitor-expressroute/expressroute-circuit-down.png)
...
![ExpressRoute 트래픽 흐름](media/log-analytics-network-performance-monitor-expressroute/expressroute-traffic-flow.png)
...
![ExpressRoute 대역폭 사용률](media/log-analytics-network-performance-monitor-expressroute/expressroute-peak-utilization.png)
