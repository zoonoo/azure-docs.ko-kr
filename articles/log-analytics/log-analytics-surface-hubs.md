...
다음으로, 기존 Log Analytics 작업 영역을 추가하거나 새로 만듭니다. 두 방법 중 하나를 사용하는 방법에 대한 자세한 내용은 [Azure Portal에서 Log Analytics 작업 영역 만들기](log-analytics-quick-create-workspace.md)를 참조하세요. Log Analytics 작업 영역이 구성되면 다음 두 가지 방법으로 Surface Hub 장치를 등록할 수 있습니다.
