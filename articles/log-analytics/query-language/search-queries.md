---
title: Log Analytics의 검색 쿼리 | Microsoft Docs
description: 이 문서에서는 Log Analytics에서 검색 쿼리 작성을 시작하기 위한 자습서를 제공합니다.
...
- [Log Analytics 쿼리 언어 사이트](http://http://docs.loganalytics.io)에서 자세한 자습서 참조