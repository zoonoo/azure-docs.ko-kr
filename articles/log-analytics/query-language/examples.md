...
ms.locfileid: "49071066"
---
# <a name="log-analytics-query-examples"></a>Log Analytics 쿼리 예제
이 문서에는 [Kusto 언어](https://docs.microsoft.com/azure/kusto/query/)를 사용하여 Log Analytics에서 여러 형식의 데이터를 검색하는 [쿼리](../log-analytics-queries.md)의 다양한 예제가 포함되어 있습니다. 여기서 소개하는 예제에서는 여러 가지 방법으로 데이터를 통합하고 분석하므로, 이러한 샘플을 활용하면 고유한 요구 사항을 충족하는 데 사용할 수 있는 여러 전략을 파악할 수 있습니다.  
