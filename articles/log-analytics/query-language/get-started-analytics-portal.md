...
![스키마](media/get-started-analytics-portal/schema.png)
...
![쿼리에 필터 추가](media/get-started-analytics-portal/add-filter.png)
...
![열 선택](media/get-started-analytics-portal/select-columns.png)
...
![가로 막대형 차트](media/get-started-analytics-portal/bar-chart.png)

결과가 누적 가로 막대형 차트로 표시됩니다. 결과의 다른 보기를 표시하려면 _누적 세로 막대형_을 클릭하고 _원형_을 선택합니다.

![원형 차트](media/get-started-analytics-portal/pie-chart.png)
...
![스마트 진단](media/get-started-analytics-portal/smart-diagnostics.png)

## <a name="pin-to-dashboard"></a>대시보드에 고정
다이어그램 또는 테이블을 공유 Azure 대시보드 중 하나에 고정하려면 핀 아이콘을 클릭합니다.

![대시보드에 고정](media/get-started-analytics-portal/pin-dashboard.png)
...
![함수 저장](media/get-started-analytics-portal/save-function.png)
...
- [Log Analytics 쿼리 작성](get-started-queries.md)에 대해 자세히 알아봅니다.
