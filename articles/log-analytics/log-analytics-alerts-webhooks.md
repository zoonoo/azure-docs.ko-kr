...
# Log Analytics 경고의 웹후크

[Log Analytics 경고](log-analytics-alerts.md)에 응답하여 실행할 수 있는 작업 중 하나는 단일 HTTP 요청을 통해 외부 프로세스를 호출할 수 있는 *웹후크*입니다. [Log Analytics의 경고](log-analytics-alerts.md)에서 경고 및 웹후크의 세부 정보에 관하여 읽을 수 있습니다.
...
## 2 단계 - Log Analytics에서 경고 규칙 만들기
1.	다음 설정을 사용하여 [경고 규칙을 만듭니다](log-analytics-alerts.md).
...
- 웹후크에서 호출할 수 있는 [Azure 자동화의 Runbook을 만들](../automation/automation-webhooks.md) 수 있습니다.
