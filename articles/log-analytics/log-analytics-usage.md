...
2. Azure Portal의 왼쪽 아래 모서리에 있는 **추가 서비스**를 클릭합니다. 리소스 목록에서 **Log Analytics**를 입력합니다. 입력을 시작하면 입력한 내용을 바탕으로 목록이 필터링됩니다. **Log Analytics**를 선택합니다.<br><br> ![Azure 포털](media/log-analytics-quick-collect-azurevm/azure-portal-01.png)<br><br>  
3. Log Analytics 작업 영역 목록에서 작업 영역을 선택합니다.
4. 왼쪽 창의 목록에서 **Log Analytics 사용량**을 선택합니다.
5. **Log Analytics 사용량** 대시보드에서 **시간: 최근 24시간**을 클릭하여 시간 간격을 변경합니다.<br><br> ![시간 간격](./media/log-analytics-usage/time.png)<br><br>
6. 관심이 있는 영역을 표시하는 사용량 범주 블레이드를 확인합니다. [로그 검색](log-analytics-log-searches.md)에서 블레이드를 선택하고 더 자세히 보려는 항목을 클릭합니다.<br><br> ![예제 데이터 사용량 블레이드](./media/log-analytics-usage/blade.png)<br><br>
7. 로그 검색 대시보드에서 검색에서 반환되는 결과를 검토합니다.<br><br> ![예제 사용량 로그 검색](./media/log-analytics-usage/usage-log-search.png)
