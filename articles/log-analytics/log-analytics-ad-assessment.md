<properties
	pageTitle="Log Analytics에서 Active Directory 평가 솔루션을 사용하여 사용자 환경 최적화 | Microsoft Azure"
...
# Log Analytics에서 Active Directory 평가 솔루션을 사용하여 사용자 환경 최적화
...
**성능 및 확장성** - 이 주요 영역은 조직의 IT 인프라를 확장하고, IT 환경이 현재 성능 요구 사항을 충족하며, 변화하는 인프라 요구 사항의 대응할 수 있도록 하는 데 도움이 되는 권장 사항을 보여 줍니다.
...
3. 주요 영역 페이지에서 사용자 환경에 대해 우선순위가 지정된 권장 사항을 볼 수 있습니다. 권장하는 이유에 대한 세부 정보를 보려면 **영향을 받는 개체** 아래에서 해당 권장 사항을 클릭합니다. ![평가 권장 사항의 이미지](./media/log-analytics-ad-assessment/ad-focus.png)
...
1.	작업 영역에 로그인하고 로그 검색을 엽니다. 다음 쿼리를 사용하여 사용자 환경의 컴퓨터에 대해 실패한 권장 사항을 나열합니다.
    ...
    로그 검색 쿼리를 보여 주는 스크린 샷은 다음과 같습니다. ![실패한 권장 사항](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
