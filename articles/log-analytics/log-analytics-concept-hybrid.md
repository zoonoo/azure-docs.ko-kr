---
title: Azure Log Analytics 에이전트를 사용하여 하이브리드 환경에서 데이터 수집 | Microsoft Docs
...
사용자 환경에 호스트된 컴퓨터는 Log Analytics에 직접 연결할 수 있고, System Center Operations Manager 2012 R2 이상에서 해당 컴퓨터를 이미 모니터링하고 있는 경우에는 Operations Management 관리 그룹을 Log Analytics와 통합하고 IT 서비스 작업 프로세스를 계속 유지 관리할 수 있습니다.  
