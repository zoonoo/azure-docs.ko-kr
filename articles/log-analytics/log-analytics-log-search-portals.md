...
Log Analytics 메뉴의 **로그**에서 Log Analytics 페이지를 엽니다. 로그 데이터를 사용하고 쿼리를 만들 수 있는 새로운 환경입니다. [Azure Portal에서 Log Analytics 페이지 시작](query-language/get-started-analytics-portal.md)에서 이 포털에 대한 소개를 보고 기능을 살펴볼 수 있습니다.
