...
### <a name="step-1-enable-custom-logs-preview"></a>1단계. 사용자 지정 로그 사용 미리 보기
1. Azure Portal에서 **모든 서비스**를 클릭합니다. 리소스 목록에서 **Log Analytics**를 입력합니다. 입력을 시작하면 입력한 내용을 바탕으로 목록이 필터링됩니다. **Log Analytics**를 선택합니다.
2. Log Analytics 구독 창에서 작업 영역을 선택한 다음 **OMS 포털** 타일을 선택합니다.<br><br> ![로그 검색 단추](media/log-analytics-data-sources-custom-logs/azure-portal-01.png)<br><br> 
3. OMS 포털로 리디렉션된 후에는 페이지의 오른쪽 위에 있는 설정 타일을 클릭합니다.<br><br> ![OMS 포털 설정 옵션](media/log-analytics-data-sources-custom-logs/oms-portal-settings-option.png)<br><br> 
4. **설정** 페이지에서 **미리 보기 기능**을 선택하고 해당 페이지에서 사용자 지정 로그에 대해 **사용**을 선택합니다.    

### <a name="step-2-open-the-custom-log-wizard"></a>2단계. Custom Log Wizard(사용자 지정 로그 마법사) 열기
...
### <a name="step-3-upload-and-parse-a-sample-log"></a>3단계. 샘플 로그 업로드 및 구문 분석
...
### <a name="step-4-add-log-collection-paths"></a>4단계. 로그 수집 경로 추가
...
### <a name="step-5-provide-a-name-and-description-for-the-log"></a>5단계. 로그의 이름과 설명을 제공합니다.
...
### <a name="step-6-validate-that-the-custom-logs-are-being-collected"></a>6단계. 사용자 지정 로그를 수집 중인지 확인
...
### <a name="step-7-parse-the-custom-log-entries"></a>7단계. 사용자 지정 로그 항목 구문 분석
