---
title: "Log Analytics의 컨테이너 솔루션 | Microsoft Docs"
...
### <a name="for-all-container-hosts-except-coreos"></a>CoreOS를 제외한 모든 컨테이너 호스트의 경우
...
### <a name="for-all-container-hosts-including-coreos"></a>CoreOS를 포함한 모든 컨테이너 호스트의 경우
