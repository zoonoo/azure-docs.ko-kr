...
| 에이전트 상태                                                                              | <ul><li>정보&nbsp;및&nbsp;분석</li><li>Log Analytics</li></ul>   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)   | 체험 계층 요금에 적용되지 않는 데이터<br> Azure Portal/Marketplace에서 추가할 수 없습니다. |
...
| 백업                                                                                    | <ul><li>Insight and Analytics</li></ul>                                   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)                                                                       | 기존 백업 자격 증명 모음이 필요합니다.<br> Azure Portal/Marketplace에서 추가할 수 없습니다. |
...
| [IT Service Management Connector](log-analytics-itsmc-overview.md)<br>(미리 보기)                                               | <ul><li>정보&nbsp;및&nbsp;분석</li><li>Log Analytics</li></ul>   | 무료<br> &nbsp;노드당&nbsp;(OMS)     | |
...
| Logic Apps B2B                    | <ul><li>정보&nbsp;및&nbsp;분석</li><li>Log Analytics</li></ul>   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)   | Azure Portal/Marketplace에서 추가할 수 없습니다. |
...
| [서비스 맵](../operations-management-suite/operations-management-suite-service-map.md) <br>(미리 보기)| <ul><li>Insight and Analytics</li></ul>                       | 무료<br> &nbsp;노드당&nbsp;(OMS)                                                                         | 미국 동부, 유럽 서부 및 미국 중서부에서 사용 가능    |
| 사이트 복구                                                                             | <ul><li>Insight and Analytics</li></ul>                                   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)                                                                       | 기존 Site Recovery 자격 증명 모음이 필요합니다.<br> Azure Portal/Marketplace에서 추가할 수 없습니다. |
...
| [업데이트 규정 준수](https://technet.microsoft.com/en-us/itpro/windows/manage/update-compliance-get-started) <br>(미리 보기)                                                             | <ul><li>정보&nbsp;및&nbsp;분석</li><li>Log Analytics</li></ul>   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)   | 데이터 또는 노드 무료 사용<br>체험 계층 요금에 적용되지 않는 데이터입니다.<br> Azure Portal/Marketplace에서 추가할 수 없습니다. |
| [업그레이드 준비](https://technet.microsoft.com/itpro/windows/deploy/manage-windows-upgrades-with-upgrade-readiness)                                                            | <ul><li>정보&nbsp;및&nbsp;분석</li><li>Log Analytics</li></ul>   | 무료<br> Standard<br> Premium&nbsp;(OMS)<br> &nbsp;GB당&nbsp;(독립 실행형)<br> &nbsp;노드당&nbsp;(OMS)   | 데이터 또는 노드 무료 사용<br>체험 계층 요금에 적용되지 않는 데이터입니다.<br> Azure Portal/Marketplace에서 추가할 수 없습니다. |
...
| 실시간 데이터 2.0<br>(미리 보기)                                                                | <ul><li>Insight and Analytics</li></ul>                                   | 무료<br> &nbsp;노드당&nbsp;(OMS)                                                                         | 미국 동부, 유럽 서부 및 미국 중서부에서 사용 가능 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Azure 활동 로그 |Windows |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |알림 시 |
| Azure 진단 로그 |Windows |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |알림 시 |
| Azure 진단 메트릭 |Windows |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |알림 시 |
...
| Windows 이벤트 로그 |Windows |![예](./media/log-analytics-add-solutions/oms-bullet-green.png) |![예](./media/log-analytics-add-solutions/oms-bullet-green.png) |![예](./media/log-analytics-add-solutions/oms-bullet-green.png) |![아니요](./media/log-analytics-add-solutions/oms-bullet-red.png) |![예](./media/log-analytics-add-solutions/oms-bullet-green.png) |Azure 저장소: 10분, 에이전트: 도착 시 |
