...
- [내 대시보드](log-analytics-dashboards.md)는 더 이상 사용되지 않으며 대신 [뷰 디자이너](log-analytics-view-designer.md) 및 [Azure 대시보드](https://docs.microsoft.com/en-us/azure/azure-portal/azure-portal-dashboards.md)가 사용됩니다.  내 대시보드에 추가된 타일은 계속 사용할 수 있지만 읽기 전용으로 제공됩니다.
...
업그레이드가 완료되면 작업 영역에 대한 설정에서 **업그레이드 요약** 섹션이 나타납니다.  업그레이드에 대한 자세한 내용을 보려면 이 섹션을 참조하세요.
