---
title: Log Analytics의 구성 평가 솔루션 | Microsoft Docs
...
> [!NOTE]
> 구성 평가 경고는 Log Analytics의 다른 경고와 다릅니다. 경고를 보려면 브라우저에 대 한 Silverlight 플러그 인이 필요합니다.
> 
> 
...
> [!TIP]
> 기본적으로 표시되는 경고의 최대 개수는 2,000개입니다. 더 많은 경고를 보려면 경고 목록 위의 알림 표시줄을 클릭합니다.
> 
> 
