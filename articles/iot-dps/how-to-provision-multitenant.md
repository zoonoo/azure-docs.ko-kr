...
1. SDK의 [최신 릴리스에](https://github.com/Azure/azure-iot-sdk-c/releases/latest) 대 한 태그 이름을 찾습니다.

1. 두 VM에서 [Azure IoT C SDK](https://github.com/Azure/azure-iot-sdk-c)를 복제합니다.  이전 단계에서 찾은 태그를 `-b` 매개 변수의 값으로 사용 합니다.
