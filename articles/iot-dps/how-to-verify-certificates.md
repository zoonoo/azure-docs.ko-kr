...
설명서 및 SDK에서 제공된 PowerShell 및 Bash 스크립트는 [OpenSSL](https://www.openssl.org/)을 사용합니다. 소유 증명을 수행할 수 있도록 OpenSSL 또는 기타 타사 도구를 사용할 수도 있습니다. Sdk와 함께 제공 되는 도구를 사용 하는 예제는 [x.509 인증서 체인 만들기](tutorial-custom-hsm-enrollment-group-x509.md#create-an-x509-certificate-chain)를 참조 하세요. 
