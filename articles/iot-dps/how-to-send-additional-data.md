...
장치에서 DPS에 [장치 등록 호출](https://docs.microsoft.com/rest/api/iot-dps/runtimeregistration/registerdevice) 을 보내는 경우 등록 호출은 본문의 다른 필드를 사용할 수 있도록 향상 시킬 수 있습니다. 본문은 다음과 같습니다. 
   ```
   { 
