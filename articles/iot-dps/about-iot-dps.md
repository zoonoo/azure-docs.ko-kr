...
* **다중 허브 지원**을 통해 Device Provisioning Service가 런타임 시 디바이스를 IoT 허브에 늦게 바인딩할 수 있습니다. Device Provisioning Service는 여러 Azure 구독에서 허브와 통신할 수 있습니다.
* **지역 간 지원** Device Provisioning Service가 디바이스를 다른 지역의 IoT Hub에 할당할 수 있게 해줍니다.
