...
description: 이 빠른 시작에서는 그룹 등록을 사용합니다. 이 빠른 시작에서는 Python을 사용하여 Azure IoT Hub Device Provisioning Service에 X.509 장치를 등록합니다.
author: wesmc7777
ms.author: wesmc
ms.date: 01/25/2018
ms.topic: quickstart
...
4. Azure Portal에서 프로비전 서비스로 이동합니다. **등록 관리**를 클릭합니다. 앞에서 만든 이름(`registrationid`)이 있는 X.509 장치 그룹이 **등록 그룹** 탭 아래에 표시됩니다. 
