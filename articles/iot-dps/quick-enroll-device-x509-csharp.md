---
title: 빠른 시작 - C#을 사용하여 Azure Device Provisioning Service에 X.509 디바이스 등록
...
이 섹션에서는 등록 그룹을 프로비저닝 서비스에 추가하는 .NET Core 콘솔 앱을 만드는 방법을 보여줍니다. 일부를 수정하여 등록 그룹을 추가할 [Windows IoT Core](https://developer.microsoft.com/en-us/windows/iot) 콘솔 앱을 만들기 위해 다음과 같은 단계를 수행할 수 있습니다. IoT Core를 사용하여 개발하는 방법에 대해 자세히 알아보려면 [Windows IoT Core 개발자 설명서](/windows/iot-core/)를 참조하세요.
