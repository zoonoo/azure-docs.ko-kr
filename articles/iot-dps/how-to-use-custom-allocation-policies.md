...
3. Azure Cloud Shell을 사용하여 **az iot hub create** 명령으로 [Contoso Toasters Division](/cli/azure/iot/hub#az-iot-hub-create) IoT Hub를 만듭니다. IoT Hub는 *contoso-us-resource-group*에 추가됩니다.
...
4. Azure Cloud Shell을 사용하여 **az iot hub create** 명령으로 [Contoso Heat Pumps Division](/cli/azure/iot/hub#az-iot-hub-create) IoT Hub를 만듭니다. 이 IoT Hub도 *contoso-us-resource-group*에 추가됩니다.
...
4. **요약** 페이지에서 **만들기** 를 선택 하 여 함수 앱을 만듭니다. 배포에는 몇 분 정도 걸릴 수 있습니다. 완료 되 면 **리소스로 이동**을 선택 합니다.
