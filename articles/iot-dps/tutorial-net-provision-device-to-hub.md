...
장치가 부팅되면 다음 작업이 이루어져야 합니다. 자세한 내용은 [장치 클라이언트 샘플 프로비전](https://github.com/Azure-Samples/azure-iot-samples-csharp/tree/master/provisioning/Samples/device)을 참조하세요. 
