---
title: Azure Portal에서 디바이스 프로비저닝 설정 | Microsoft Docs
...
ms.locfileid: "56818122"
---
# <a name="set-up-the-iot-hub-device-provisioning-service-with-the-azure-portal"></a>Azure Portal에서 IoT Hub Device Provisioning Service 설정
...
3. **IoT Hub에 링크 추가** 페이지에서 다음 정보를 입력하여 IoT Hub에 새 Device Provisioning Service 인스턴스를 연결합니다. 그런 다음, **저장**을 클릭합니다. 
    ...
    * **IoT 허브:** 새 Device Provisioning Service 인스턴스에 연결할 IoT Hub를 선택합니다.
...
이 빠른 시작에서는 IoT Hub 및 Device Provisioning Service 인스턴스를 배포하고, 두 리소스를 연결했습니다. 시뮬레이션된 디바이스를 프로비전하도록 설정하는 방법에 대해 알아보려면 시뮬레이션된 디바이스 만들기를 위한 빠른 시작을 진행하세요.
