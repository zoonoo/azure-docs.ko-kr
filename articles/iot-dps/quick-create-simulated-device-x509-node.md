...
3. 사용자 고유의 _인증서 이름_ 을 사용하는 스크립트를 실행하여 _리프_ X.509 인증서를 만듭니다. 리프 인증서의 일반 이름은 [등록 ID](./concepts-service.md#registration-id)가 되므로 소문자 영숫자와 하이픈만 사용해야 합니다.
