...
가용성 영역 [Azure Cognitive Search Service Level Agreement(서비스 수준 약정)](https://azure.microsoft.com/support/legal/sla/search/v1_0/)에 영향을 주지 않습니다. 쿼리 고가용성을 위해 3 개 이상의 복제본이 필요 합니다.
