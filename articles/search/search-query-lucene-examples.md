...
## <a name="viewing-the-examples-in-this-article"></a>이 문서의 예제 살펴보기
...
쿼리는 nycjobs라고 하는 사전 구성된 Azure 검색을 사용합니다. **searchFields** 매개 변수는 검색을 직위 필드로만 제한합니다. **queryType**이 **full**로 설정되어,이 쿼리에 Lucene 쿼리 파서를 사용하도록 Azure Search에 지시합니다.
...
## <a name="fuzzy-search"></a>유사 항목 검색
...
## <a name="proximity-search"></a>근접 검색
...
## <a name="wildcard-search"></a>와일드카드 검색
