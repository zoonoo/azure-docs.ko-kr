---
title: Azure 관리 액세스에 대한 RBAC 역할 설정
titleSuffix: Azure Cognitive Search
description: Azure 인지 검색 관리를 위한 관리 작업을 제어하고 위임하기 위한 Azure 포털의 RBAC(역할 기반 관리 제어)입니다.
manager: nitinme
author: HeidiSteen
ms.author: heidist
...
---
# <a name="set-rbac-roles-for-administrative-access-to-azure-cognitive-search"></a>Azure 인지 검색에 대한 관리 액세스를 위한 RBAC 역할 설정

Azure에서는 포털 또는 Resource Manager API를 통해 관리되는 모든 서비스에 대해 [전역 역할 기반 권한 부여 모델](../role-based-access-control/role-assignments-portal.md) 을 제공합니다. 소유자, 기여자 및 판독기 역할은 각 역할에 할당된 Active Directory 사용자, 그룹 및 보안 보안 주체에 대한 *서비스 관리* 수준을 결정합니다. 
...
Azure Cognitive Search의 경우 역할은 다음 관리 작업을 지원하는 권한 수준과 연결됩니다.
...
+ [Azure 인지 검색의 성능 및 최적화](search-performance-optimization.md)
+ [Azure 포털에서 역할 기반 액세스 제어를 시작합니다.](../role-based-access-control/overview.md)