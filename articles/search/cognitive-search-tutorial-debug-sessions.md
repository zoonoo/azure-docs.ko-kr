...
> :::image type="content" source="media/cognitive-search-debug/postman-create-data-source.png" alt-text="Postman을 사용하여 데이터 원본 만들기":::
...
> :::image type="content" source="media/cognitive-search-debug/debug-execution-complete1.png" alt-text="시작된 새 디버그 세션":::
