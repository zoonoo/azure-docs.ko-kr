...
ms.locfileid: "74113315"
---
# <a name="c-tutorial-import-azure-sql-database-using-azure-cognitive-search-indexers"></a>C# 자습서: Azure Cognitive Search 인덱서를 사용하여 Azure SQL 데이터베이스 가져오기
...
> * Azure SQL 데이터베이스에서 외부 데이터 세트 준비 
