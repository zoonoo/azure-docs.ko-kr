...
Azure Search에서는 검색 및 운영 요구 사항을 충족할 수 있도록 광범위한 기능을 제공합니다.
...
다른 검색 솔루션과 비교할 때, Azure Search는 콘텐츠 탐색 작업을 주로 검색 기능에 의존하는 앱에 필요한 추가적인 기능 계층을 갖추며, Azure의 콘텐츠 저장소 및 데이터베이스에 대한 전체 텍스트 검색 워크로드에 가장 강력합니다. 
...
### <a name="a-namefeature-drilldownafeature-drilldown"></a><a name="feature-drilldown"></a>기능 드릴다운
