...
description: Azure Cognitive Search의 AI 보강 파이프라인의 텍스트에서 사람, 위치 및 조직에 대한 명명된 엔터티를 추출합니다.
manager: nitinme
author: luiscabrer
ms.author: luisca
...
> [!IMPORTANT]
> 명명된 엔터티 인식 기술은 이제 [Microsoft.Skills.Text.Entity인식 기술로](cognitive-search-skill-entity-recognition.md)대체됩니다. 지원은 2019년 2월 15일에 중단되었으며 API는 2019년 5월 2일에 제품에서 제거되었습니다. 사용되지 않는 [인지 검색 기술의](cognitive-search-skill-deprecated.md) 권장 사항을 따라 지원되는 기술로 마이그레이션합니다.
