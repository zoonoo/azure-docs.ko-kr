---
title: '예제: 인식 검색 파이프라인에 사용자 지정 기술 만들기(Azure Search) | Microsoft Docs'
...
**F5** 키를 눌러 프로그램을 실행하고 함수 동작을 테스트합니다. Postman 또는 Fiddler를 사용하여 아래와 같은 호출을 실행합니다.
