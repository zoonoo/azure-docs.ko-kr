...
Azure 검색에 대해 자세히 알아보려면 [http://azure.microsoft.com](https://azure.microsoft.com/)에서 [설명서 페이지](https://azure.microsoft.com/documentation/services/search/)를 참조하거나 전체 Azure 검색 기능을 살펴보는 다양한 [샘플 및 비디오](search-video-demo-tutorial-list.md)를 확인하세요.
...
- 검색 가능한 데이터가 Azure 검색에서 관리하는 인덱스에 저장됩니다.
