...
## <a name="creating-a-suggester"></a>제안기 만들기

**제안기**는 언제든지 만들 수 있지만 인덱스에 미치는 영향은 필드에 따라 달라집니다.

+ 동일한 업데이트의 일환으로 제안기에 추가된 새 필드는 인덱스를 다시 작성할 필요가 없다는 점에서 영향력이 가장 작습니다.
+ 그러나 제안기에 기존 필드를 추가하면 필드 정의가 변경되므로 인덱스를 완전히 다시 작성해야 합니다.
...
[인덱스 업데이트 &#40;Azure Search 서비스 REST API&#41;](https://docs.microsoft.com/rest/api/searchservice/update-index)  
[제안 &#40;Azure Search 서비스 REST API&#41;](https://docs.microsoft.com/rest/api/searchservice/suggestions)  
[인덱스 작업 &#40;Azure Search 서비스 REST API&#41;](https://docs.microsoft.com/rest/api/searchservice/index-operations)  
