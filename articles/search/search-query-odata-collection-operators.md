...
description: Azure Search 쿼리의 OData 컬렉션 연산자, any 및 all 및 람다 식.
ms.date: 06/13/2019
services: search
ms.service: search
ms.topic: conceptual
...
ms.locfileid: "69647646"
---
# <a name="odata-collection-operators-in-azure-search---any-and-all"></a>Azure Search- `any` 및의 OData 컬렉션 연산자`all`

Azure Search와 함께 사용할 [OData 필터 식을](query-odata-filter-orderby-syntax.md) 작성할 때는 컬렉션 필드에 대해 필터링 하는 것이 유용한 경우가 많습니다. `any` 및`all` 연산자를 사용 하 여이를 달성할 수 있습니다.
...
이러한 제한 사항 및 예제에 대 한 자세한 내용은 [Azure Search의 컬렉션 필터 문제 해결](search-query-troubleshoot-collection-filters.md)을 참조 하세요. 이러한 제한 사항이 있는 이유에 대 한 자세한 내용은 [Azure Search의 컬렉션 필터 이해](search-query-understand-collection-filters.md)를 참조 하세요.
