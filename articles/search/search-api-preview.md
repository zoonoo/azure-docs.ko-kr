...
+ 검색 작업의 경우 [**`2019-05-06-Preview`**](https://docs.microsoft.com/rest/api/searchservice/index-2019-05-06-preview) 는 현재 미리 보기 버전입니다.
...
| IP 액세스 제한 | 관리 [`api-version=2019-10-01-Preview`](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) REST API를 사용 하 여 액세스를 허용 하는 IP 주소에 대 한 제한이 있는 서비스를 만들 수 있습니다. |
