---
title: Azure 검색에 대한 SKU 또는 가격 책정 계층 선택 | Microsoft Docs
...
> [!NOTE]
> 용량을 과소 평가하는 경우 더 높은 계층에서 새 서비스를 프로비전한 다음 인덱스를 다시 로드해야 합니다. 하나의 SKU에서 다른 SKU로 동일한 서비스의 전체 업그레이드가 없습니다.
> 
> 
