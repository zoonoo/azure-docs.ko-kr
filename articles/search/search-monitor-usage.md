...
[Azure 클래식 포털](https://portal.azure.com)에서는 리소스 사용량, 횟수 및 통계의 모니터링을 쉽게 확인할 수 있지만, 사용자 지정 서비스 관리 도구를 빌드하는 경우에는 정보 프로그래밍 방식으로 확인할 수도 있습니다. 이 문서는 두 기술 모두에 대한 단계를 설명합니다.
