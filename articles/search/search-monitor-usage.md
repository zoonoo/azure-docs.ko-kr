...
시간이 걸리며 Blob storage에 컨테이너가 표시 됩니다. 컨테이너 마다 시간당 하나의 blob이 있습니다. **
...
| 속성 |object |다음 테이블 참조 |데이터별 작업을 포함하는 개체 |
...
| 최소 |int |37 |메트릭 시간 간격에 원시 샘플의 최소 값 |
| 최대 |int |78 |메트릭 시간 간격에 원시 샘플의 최대 값 |
