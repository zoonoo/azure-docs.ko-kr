...
모든 Azure search 인덱스는 기본적으로 Microsoft 관리 키를 사용 하 여 암호화 되지만 Key Vault에서 **고객 관리 키** 를 사용 하 여 암호화 되도록 인덱스를 구성할 수 있습니다. 자세히 알아보려면 [Azure Search에서 암호화 키 관리](search-security-manage-encryption-keys.md)를 참조 하세요.
