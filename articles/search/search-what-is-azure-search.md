...
description: Azure Search는 완벽하게 관리되는 호스트된 클라우드 Search 서비스입니다. 기능 설명, 개발 워크플로, Azure Search 및 다른 검색 제품 비교, 시작하는 방법을 검토합니다.
manager: cgronlun
author: HeidiSteen
services: search
ms.service: search
