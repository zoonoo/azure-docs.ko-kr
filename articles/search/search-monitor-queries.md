...
더 심층적으로 탐색 하려면 데이터를 계층화 하 고 확대 하 고 시각화 하 여 추세 또는 비정상을 탐색할 수 있도록 **모니터링** 메뉴에서 메트릭 탐색기를 엽니다. 메트릭 [차트 만들기에 대](../azure-monitor/learn/tutorial-metrics-explorer.md)한이 자습서를 완료 하 여 메트릭 탐색기에 대해 자세히 알아보세요.
