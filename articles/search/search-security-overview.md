...
표준 준수의 부분 목록에는 일반 공급 기능에 대한 SOC 2 Type 2 및 HIPAA가 포함됩니다. 미리 보기 기능은 일반 공급의 일부로 인증되며 특정 표준 요구 사항이 있는 솔루션에는 사용하면 안 됩니다. 규정 준수 인증은 [Microsoft Azure 규정 준수 개요](https://gallery.technet.microsoft.com/Overview-of-Azure-c1be3942) 및 [보안 센터](https://www.microsoft.com/en-us/trustcenter)에 설명되어 있습니다. 

다음 표준에 대한 인증이 [2018년 6월에 발표](https://azure.microsoft.com/blog/azure-search-is-now-certified-for-several-levels-of-compliance/)되었습니다.
