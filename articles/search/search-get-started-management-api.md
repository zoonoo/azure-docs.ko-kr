...
[Azure Search 개발 워크플로]: search-workflow.md
[첫 Azure Search 솔루션 만들기]: search-create-first-solution.md
[Azure Search를 사용하여 지리 공간 검색 앱 만들기]: search-create-geospatial.md
