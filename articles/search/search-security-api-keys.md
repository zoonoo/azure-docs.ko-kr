...
> [!Note]
> 쿼리 키 사용을 보여 주는 코드 예제는 [의 C#쿼리 Azure Search 인덱스 ](search-query-dotnet.md)에서 찾을 수 있습니다.
