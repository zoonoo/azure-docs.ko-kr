...
| [Microsoft.Skills.Text.PIIDetectionSkill](cognitive-search-skill-pii-detection.md)  | 이 기술은 미리 학습 된 모델을 사용 하 여 지정 된 텍스트에서 개인 식별이 가능한 정보를 추출 합니다. 또한이 기술은 검색 된 PII 엔터티를 텍스트에서 마스킹 하는 다양 한 옵션을 제공 합니다.  |
...
| [Microsoft.Skills.Util.ConditionalSkill](cognitive-search-skill-conditional.md) | 조건을 기준으로 필터링, 기본값 할당 및 데이터 병합을 허용 합니다.|
| [Microsoft.Skills.Util.DocumentExtractionSkill](cognitive-search-skill-document-extraction.md) | 보강 파이프라인 내에서 파일의 콘텐츠를 추출 합니다. |
