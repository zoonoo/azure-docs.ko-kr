...
[.NET에서 Azure 검색 시작](search-get-started-dotnet.md)|관리 코드에서 Azure 검색을 사용하는 방법을 학습하기 위한 자습서입니다.
[NodeJS에서 Azure 검색 시작](search-get-started-nodejs.md)|NodeJS에서 Azure 검색을 사용하는 방법을 학습하기 위한 자습서입니다.
...
[.NET에서 Azure 검색을 사용하는 방법](search-howto-dotnet-sdk.md)|Azure 검색과 통합되는 샘플 Visual Studio 웹 응용 프로그램을 구성 및 실행하는 방법입니다.
...
[Azure 검색 관리 REST API 자습서](search-get-started-management-api.md)|관리 REST API를 사용하여 서비스를 프로비전하고 구성하는 방법입니다.
...
- GitHub의 [**JavaIndexerDemo**](https://github.com/AzureSearch/AzureSearchJavaIndexerDemo).
- GitHub의 [**NodeJSIndexerDemo**](https://github.com/AzureSearch/AzureSearchNodeJSIndexerDemo).
- GitHub의 [**.NET-2015-02-28-Sample**](https://github.com/AzureSearch/.NET-2015-02-28-Sample).
- GitHub의 [**AzureSearch-Microsoft Virtual Academy 교육 자료**](https://github.com/MicrosoftLearning/AzureSearch-MVA).

CodePlex에서 공개 미리 보기 중에 현재 버전과 여전히 관련이 있는 여러 샘플을 찾을 수 있습니다.

- CodePlex의 [**관리 REST API 데모**](https://azuresearchmgmtapi.codeplex.com/).
- CodePlex의 [**AdventureWorks 데모**](https://azuresearchadventureworksdemo.codeplex.com/).
- CodePlex의 [**제안 데모**](https://azsearchsuggestions.codeplex.com/SourceControl/latest).
- CodePlex의 [**지리적 검색 샘플**](https://azuresearchgeospatial.codeplex.com/).
- CodePlex의 [**SQL Server에서 Azure 검색으로의 동기화 샘플**](http://sqlserver2azuresearch.codeplex.com/).
- CodePlex의 [**프로필 데모 점수 매기기**](https://azuresearchscoringprofiles.codeplex.com/).
