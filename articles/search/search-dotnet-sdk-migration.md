---
title: Azure 검색 .NET SDK 버전 1.1 | Microsoft Docs
...
> [!NOTE]
> 0.13-preview 또는 이전 버전을 사용하는 경우 먼저 버전 1.1로 업그레이드한 후 2.0-preview로 업그레이드해야 합니다. 지침은 [부록: 1.1 버전으로 업그레이드하는 단계](#UpgradeStepsV1)를 참조하세요.
> 
> 
...
> [!NOTE]
> 이 섹션은 Azure 검색 .NET SDK 버전 0.13-preview 이상의 사용자에게만 적용됩니다.
> 
> 
