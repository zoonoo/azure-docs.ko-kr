...
Azure Portal를 사용 하 여 인덱서를 만드는 경우 Azure Cognitive Search 포털 논리는 만든 시간 동안 SQL Azure VM에 대 한 액세스 권한도 필요 합니다. `stamp2.search.ext.azure.com`ping을 통해 Azure Cognitive Search 포털 IP 주소를 찾을 수 있습니다.
