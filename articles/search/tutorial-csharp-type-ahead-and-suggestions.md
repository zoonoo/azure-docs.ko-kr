...
2. 이 명령문의 닫는 **&lt;/div&gt;** 뒤에 다음 스크립트를 입력합니다. 이 스크립트는 오픈 소스 jQuery UI 라이브러리의 [자동 완성 위젯](https://api.jqueryui.com/autocomplete/)을 활용하여 제안된 결과의 드롭다운 목록을 제공합니다. 
