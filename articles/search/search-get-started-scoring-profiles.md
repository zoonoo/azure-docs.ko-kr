---
title: "Azure Search에서 점수 매기기 프로필을 사용하는 방법 | Microsoft Docs"
...
---
# <a name="how-to-use-scoring-profiles-in-azure-search"></a>Azure 검색에서 점수 매기기 프로필을 사용하는 방법
...
2. 솔루션 탐색기에서 **app.config**를 두 번 클릭합니다. 이 파일은 서비스 끝점 및 요청을 인증하는 데 사용되는 `api-key` 를 지정합니다. 클래식 포털에서 이러한 값을 가져올 수 있습니다.
3. [Azure 포털](https://portal.azure.com)에 로그인합니다.
4. Azure 검색에 대한 서비스 대시보드로 이동합니다.
5. **속성** 타일을 클릭하여 서비스 URL을 복사합니다.
6. **키** 타일을 클릭하여 `api-key`를 복사합니다.
