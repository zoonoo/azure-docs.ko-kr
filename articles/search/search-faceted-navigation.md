...
## <a name="what-it-looks-like"></a>모양
 ![][1]
...
## <a name="how-to-build-it"></a>작성 방법
...
## <a name="check-for-data-quality"></a>데이터 품질 확인
...
## <a name="best-practices-for-faceted-navigation"></a>패싯 탐색을 위한 모범 사례
...
## <a name="tips-on-how-to-control-faceted-navigation"></a>패싯 탐색을 제어하는 방법에 대한 팁
...
## <a name="facet-navigation-based-on-a-range-values"></a>범위 값을 기반으로 하는 패싯 탐색
...
### <a name="build-a-filter-for-facet-ranges"></a>패싯 범위에 대한 필터 작성
...
## <a name="filtered-navigation-based-on-geopoints"></a>GeoPoint를 기반으로 하는 필터링된 탐색
