...
<sup>1</sup> 2017 년 12 월 전에 생성 된 기본 서비스 인덱스에 대 한 낮은 한도 (15 대신 5). 기본 계층은 인덱스당 100개 필드 제한보다 더 낮은 SKU입니다.
...
<sup>2</sup> 2017 년 12 월 전에 생성 된 기본 서비스에 낮습니다 (15 대신 5) 인덱서, 데이터 원본 및 기술 집합입니다.
...
저장소 액세스에 최적화 된 계층에 대 한 낮은 쿼리 처리량 및 표준 계층 보다 더 높은 대기 시간을 예상 해야 합니다.  알림과 쿼리 성능을 추정 하는 방법을 표준 계층으로 동일 합니다.
