...
| -------- | ----------------- | ----------------- | --- | --- | --- | --- |
| 최대 인덱서 |3 |5 또는 15|50 |200 |200 |N/A |
| 최대 데이터 원본 |3 |5 또는 15 |50 |200 |200 |N/A |
| 최대 기술 집합 <sup>4</sup> |3 |5 또는 15 |50 |200 |200 |N/A |
| 호출당 최대 인덱싱 로드 |10,000개 문서 |최대 문서에 의해서만 제한됨 |최대 문서에 의해서만 제한됨 |최대 문서에 의해서만 제한됨 |최대 문서에 의해서만 제한됨 |N/A |
| 최대 실행 시간 <sup>5</sup> | 1-3분 |24시간 |24시간 |24시간 |24시간 |N/A  |
| 인식 검색 기능이나 이미지 분석을 통한 Blob 인덱싱의 최대 실행 시간 <sup>5</sup> | 3~10분 |2시간 |2시간 |2시간 |2시간 |N/A  |
| Blob 인덱서: 최대 Blob 크기(MB) |16 |16 |128 |256 |256 |N/A  |
| Blob 인덱서: Blob에서 추출된 콘텐츠의 최대 문자 |32,000 |64,000 |400만 |400만 |400만 |N/A |
