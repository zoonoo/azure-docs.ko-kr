...
| [서비스 REST API](https://msdn.microsoft.com/library/azure/dn798935.aspx) |2016-09-01 |일반 공급 |
...
## <a name="sdk-version-roadmap"></a>SDK 버전 로드맵
...
| 3.x |2016-09-01 |2.0-preview와 동일, CSV 및 JSON 파일에 대한 마이너스 Blob 인덱서 지원 |2016년 11월 |
