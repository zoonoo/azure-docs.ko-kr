...
인지 검색에는 [OCR (광학 문자 인식)](cognitive-search-skill-ocr.md) 과 같은 이미지 처리 기술과 각 이미지에 있는 시각적 콘텐츠를 인덱싱할 수 있도록 하는 [시각적 기능](cognitive-search-skill-image-analysis.md) id가 포함 됩니다.
