<properties 
	pageTitle="Azure 포털에서 Azure Search에 대한 서비스 관리" 
...
# Azure 포털에서 Azure Search에 대한 서비스 관리
> [AZURE.SELECTOR]
- [포털](search-manage.md)
- [PowerShell](search-manage-powershell.md)
- [REST API](search-get-started-management-api.md)

Azure Search는 사용자 지정 앱에 풍부한 검색 환경을 구축하기 위해 사용되는 완전히 관리되는 클라우드 기반 검색 서비스입니다. 이 문서에서는 이미 프로비전된 검색 서비스를 위한 [Azure 포털](https://portal.azure.com)에서 수행할 수 있는 *서비스 관리* 작업에 대해 설명합니다. *서비스 관리*는 의도적으로 간단하게 작성되었으며 다음 작업으로 제한됩니다.
...
<a id="rbac"></a>
## Azure Search의 관리자 액세스 권한에 대한 RBAC 역할 설정
...
역할|작업
---|---
소유자|api-key, 인덱스, 인덱서, 인덱서 데이터 원본 및 인덱서 일정을 비롯하여 서비스 또는 서비스의 모든 개체를 만들거나 삭제합니다. <p>개수 및 저장소 크기를 비롯한 서비스 상태를 봅니다.<p>역할 멤버 자격을 추가 또는 삭제합니다(소유자만 역할 멤버 자격을 관리할 수 있음).<p>구독 관리자 및 서비스 소유자는 소유자 역할의 자동 멤버 자격을 갖습니다.
...
1. 서비스 대시보드에서 액세스 아이콘을 클릭하여 사용자 블레이드를 엽니다. ![][7]
