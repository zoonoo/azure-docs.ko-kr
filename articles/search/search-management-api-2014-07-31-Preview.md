...
이 문서에서는 **2014-07-31-Preview** 버전의 Azure 검색 관리 REST API를 설명합니다. 일반적으로 사용 가능한 버전인 MSDN의 [Azure 검색 관리 REST-API 2015-02-28](https://msdn.microsoft.com/library/dn832684.aspx)으로 대체되었습니다.________________________________________
