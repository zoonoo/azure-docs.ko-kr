...
> [!IMPORTANT]
> JSON Blob 인덱싱은 일반적으로 사용할 수 있지만, JsonArray 구문 분석은 공개 미리 보기이며 프로덕션 환경에서 사용하지 않아야 합니다. 자세한 내용은 [REST api-version=2017-11-11-Preview](search-api-2017-11-11-preview.md)를 참조하세요. 
