...
SQL 데이터베이스에서 [SQL 통합 변경 내용 추적](http://technet.microsoft.com/library/cc280462(v=SQL.105).aspx)을 지원하는 경우 SQL 통합 변경 내용 추적 정책을 사용하는 것이 좋습니다. 이 정책을 사용하면 변경 내용을 가장 효율적으로 추적할 수 있으며, 스키마에서 "soft delete" 열을 명시적으로 지정하지 않아도 Azure 검색에서 삭제된 행을 식별할 수 있습니다.
