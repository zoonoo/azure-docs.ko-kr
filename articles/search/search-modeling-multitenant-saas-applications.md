...
표준 [가격 책정 계층](https://azure.microsoft.com/pricing/details/search/) 의 모든 Azure Search 서비스는 스토리지 및 가용성의 2가지 차원으로 확장할 수 있습니다.
...
Azure Search를 사용하면 개별 인덱스와 총 인덱스 수가 모두 커져도 됩니다. 적절한 가격 계층을 선택한 경우 서비스 내의 개별 인덱스가 스토리지 또는 트래픽 측면에서 너무 커질 때 전체 검색 서비스에 파티션 및 복제본을 추가할 수 있습니다.
