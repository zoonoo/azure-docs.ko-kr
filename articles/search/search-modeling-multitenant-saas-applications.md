...
2. ‘테넌트당 서비스’: 각 테넌트에 자체 전용 Azure Cognitive Search 서비스가 있으며 가장 높은 수준의 데이터 및 워크로드 분리를 제공합니다.
...
Azure Cognitive Search 및 다중 테넌트 시나리오에 대한 질문은 azuresearch_contact@microsoft.com으로 보내 주세요.