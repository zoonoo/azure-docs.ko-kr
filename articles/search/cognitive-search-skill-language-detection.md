...
description: 구조화되지 않은 텍스트를 평가하고 각 레코드에 대해 Azure Cognitive Search의 AI 보강 파이프라인에서 분석의 강도를 나타내는 점수가 있는 언어 식별자를 반환합니다.
manager: nitinme
author: luiscabrer
ms.author: luisca
...
ms.locfileid: "76045025"
---
#   <a name="language-detection-cognitive-skill"></a>언어 감지 인식 기술

**언어 검색** 기술은 입력 텍스트의 언어를 감지하고 요청에 제출된 모든 문서에 대해 단일 언어 코드를 보고합니다. 언어 코드는 분석의 강도를 나타내는 점수와 쌍을 이룹니다. 이 기술은 Cognitive Services의 [Text Analytics](https://docs.microsoft.com/azure/cognitive-services/text-analytics/overview)에서 제공하는 기계 학습 모델을 사용합니다.
...
언어 검색은 Bing의 자연어 처리 라이브러리를 활용하여 텍스트 분석에 나열된 지원되는 언어 및 지역 수를 [초과합니다.](https://docs.microsoft.com/azure/cognitive-services/text-analytics/language-support) 정확한 언어 목록은 게시되지 않지만 널리 사용되는 모든 언어와 변형, 방언 및 일부 지역 및 문화 언어를 포함합니다. 자주 사용되지 않는 언어로 표현된 콘텐츠가 있는 경우 [언어 검색 API를 사용하여](https://westus.dev.cognitive.microsoft.com/docs/services/TextAnalytics.V2.0/operations/56f30ceeeda5650db055a3c7) 코드를 반환하는지 확인할 수 있습니다. 감지할 수 없는 언어에 대한 응답은 `unknown`입니다.
...
레코드의 최대 크기는 에 의해 [`String.Length`](https://docs.microsoft.com/dotnet/api/system.string.length)측정된 대로 50,000자여야 합니다. 언어 검색 기술로 보내기 전에 데이터를 분할해야 하는 경우 텍스트 [분할 기술을](cognitive-search-skill-textsplit.md)사용할 수 있습니다.
