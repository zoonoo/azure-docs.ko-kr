...
**요약:** 웹 및 모바일 응용 프로그램에서 풍부한 검색 환경을 구현하는 데 사용할 수 있으며 Azure의 완전히 관리 및 호스팅되는 클라우드 서비스인 Azure 검색에 대해 알아봅니다. 검색은 웹에서 데이터와 상호 작용하는 기본 스타일로서, 모든 응용 프로그램 상황에서 필요성이 증가하고 있습니다.
