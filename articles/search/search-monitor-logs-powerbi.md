...
1. **키** 를 인증 방법으로 선택 하 고 저장소 계정 키를 제공 합니다. 개인 정보 수준으로 **개인** 을 선택 합니다. 로그인을 클릭 하 여 로드 프로세스를 시작 합니다.
...
[Power BI 서비스 디자이너에 대 한 기본 개념](https://docs.microsoft.com/power-bi/service-basic-concepts)