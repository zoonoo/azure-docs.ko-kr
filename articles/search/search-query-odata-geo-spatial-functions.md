...
다음 EBNF ([확장 Backus-Naur 폼](https://en.wikipedia.org/wiki/Extended_Backus–Naur_form))에서는 `geo.distance` 및 함수 및 해당 `geo.intersects` 함수가 작동 하는 지역 공간 값의 문법을 정의 합니다.
