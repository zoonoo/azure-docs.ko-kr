...
> [!NOTE]
> 새로 발표된 기능은 Azure Blob 저장소에 대한 인덱서 지원이지만 해당 기능은 미리 보기 상태이며 아직 포털 옵션은 아닙니다. 해당 인덱서를 시도하려면 코드를 작성해야 합니다. 자세한 내용은 [Azure 검색에서 Azure Blob 저장소 인덱싱](search-howto-indexing-azure-blob-storage.md)을 참조하세요. <a id="apdx-sampledata"></a>
> 
> 
