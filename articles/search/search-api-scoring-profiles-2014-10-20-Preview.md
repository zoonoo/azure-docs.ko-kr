<properties 
	pageTitle="점수 매기기 프로필(Azure 검색 REST API 버전 2014-10-20-Preview)" 
	description="점수 매기기 프로필(Azure 검색 REST API 버전 2014-10-20-Preview)" 
	services="search" 
	documentationCenter="" 
	authors="HeidiSteen" 
	manager="mblythe" 
...
> [AZURE.NOTE]이 문서에서는 2014-10-20-Preview 버전의 REST API에서 제공되는 점수 매기기 프로필을 설명합니다. 이 API의 릴리스 버전은 MSDN의 [검색 인덱스에 점수 매기기 프로필 추가](http://msdn.microsoft.com/library/azure/dn798928.aspx)에서 확인할 수 있습니다. 2014-10-20-Preview 버전에 대한 자세한 내용은 [Azure 검색 서비스 REST API: 2014-10-20-Preview](search-api-2014-10-20-preview.md)를 참조하세요.
...
<td>distance | referencePointParameter</td>	<td>참조 위치로 사용하도록 쿼리에 전달할 매개 변수입니다. scoringParameter는 쿼리 매개 변수입니다. 쿼리 매개 변수의 설명은 [문서 검색(Azure 검색 REST API)](search-api-2014-10-20-preview.md#SearchDocs)을 참조하세요.</td>
</tr><tr>
...
<td>tag | tagsParameter</td>	<td>특정 요청에 대한 태그를 지정하도록 쿼리에 전달할 매개 변수입니다. scoringParameter는 쿼리 매개 변수입니다. 쿼리 매개 변수의 설명은 [문서 검색(Azure 검색 REST API)]을 참조하세요.</td>
</tr><tr>
