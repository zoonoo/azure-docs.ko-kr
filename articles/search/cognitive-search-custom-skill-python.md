...
이제 새 사용자 지정 기술이 있으므로 기능에 추가할 수 있습니다. 아래 예제에서는 문서의 제목과 작성자를 merged_title_author 호출 하는 단일 필드에 연결 하는 기술을 호출 하는 방법을 보여 줍니다. `[your-function-url-here]`를 새 Azure 함수의 URL로 바꿉니다.
