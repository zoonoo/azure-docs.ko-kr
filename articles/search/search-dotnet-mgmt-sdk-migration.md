---
title: Azure 검색 .NET 관리 SDK 버전 2로 업그레이드
...
---
# <a name="upgrading-versions-of-the-azure-search-net-management-sdk"></a>Azure 검색 .NET 관리 SDK의 업그레이드 버전

> [!Important]
> 이 콘텐츠는 아직 진행 중입니다. Azure 검색 관리 .NET SDK의 버전 3.0은 NuGet에서 사용할 수 있습니다. 새 버전으로 업그레이드하는 방법을 설명하기 위해 이 마이그레이션 가이드를 업데이트하려고 합니다. 
>
...
SDK에 대한 귀하의 피드백을 환영합니다! 문제가 발생하면 [스택 오버플로에](https://stackoverflow.com/questions/tagged/azure-cognitive-search?tab=Newest)질문을 게시하십시오. 버그를 발견하는 경우 [Azure .NET SDK GitHub 리포지토리](https://github.com/Azure/azure-sdk-for-net/issues)에 문제를 제출할 수 있습니다. 문제 제목에 '검색]으로 레이블을 지정해야 합니다.
