<properties pageTitle="Active Directory를 사용하여 리소스에 로그인 및 액세스(Android) | 모바일 개발자 센터" description="Active Directory를 사용하여 앱에 대한 인증을 추가하는 방법에 대해 알아봅니다." documentationCenter="android" authors="mattchenderson" manager="dwrede" editor="" services=""/>
