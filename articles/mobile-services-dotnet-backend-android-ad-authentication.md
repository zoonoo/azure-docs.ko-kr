<properties linkid="develop-mobile-tutorials-sso-android" urlDisplayName="Active Directory SSO Authentication with ADAL" pageTitle="Active Directory를 사용하여 리소스에 로그인 및 액세스(Android) | 모바일 개발자 센터" metaKeywords="" description="Active Directory를 사용하여 앱에 대한 인증을 추가하는 방법에 대해 알아봅니다." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Active Directory를 사용하여 앱 인증" authors="wesmc,mahender" />
