...
IoT 서비스 Azure Security Center에서 경고 사용자 지정이 작동 하는 방식에 대 한 자세한 내용은 [사용자 지정 가능한 경고](concept-customizable-security-alerts.md)를 참조 하세요. Azure RTOS의 보안 모듈을 사용할 때 사용자 지정에 사용할 수 있는 특정 경고 및 권장 사항은 다음 표에 자세히 설명 되어 있습니다. 
...
### <a name="all-azure-security-center-for-iot-alerts-and-recommendations"></a>IoT 경고 및 권장 사항에 대 한 모든 Azure Security Center

IoT 서비스 관련 경고 및 권장 사항에 대 한 모든 Azure Security Center의 전체 목록은 IoT [보안 경고](concept-security-alerts.md), iot 보안 [권장 사항](concept-recommendations.md)을 참조 하세요.
