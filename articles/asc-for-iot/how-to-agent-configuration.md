---
title: 보안 에이전트 구성
description: Iot 보안 서비스용 Azure Security Center에서 사용할 IoT 보안 에이전트에 대 한 Azure Security Center를 구성 하는 방법에 대해 알아봅니다.
...
|수신 대기 포트|eventPriorityListeningPorts |높은 |True |장치에서 열려 있는 모든 수신 포트의 스냅숏입니다.|
...
|로컬 사용자| eventPriorityLocalUsers |높은 |True|시스템 내에서 등록 된 로컬 사용자의 스냅숏입니다. |
|로그인|  eventPriorityLogin |높은|False|로그인 이벤트를 장치 (로컬 및 원격 로그인)로 감사 합니다.|
