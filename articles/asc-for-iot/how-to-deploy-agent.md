---
title: IoT 에이전트용 Azure 보안 센터 선택 및 배포 | 마이크로 소프트 문서
...
| IoT 허브에 대한 [인증](concept-security-agent-authentication-methods.md) | yes | yes |
| 보안 데이터 [수집](how-to-agent-configuration.md#supported-security-events) | yes | yes |
| 이벤트 집계 | yes | yes |
| [보안 모듈 트윈을](concept-security-module.md) 통한 원격 구성 | yes | yes |
|
