---
title: IoT 필수 구성 조건을 위한 Azure 보안 센터 | 마이크로 소프트 문서
...
이 문서에서는 IoT 서비스에 대한 Azure 보안 센터의 다양한 구성 요소, 시작해야 하는 사항에 대한 설명과 서비스를 이해하는 데 도움이 되는 기본 개념에 대해 설명합니다. 
...
1. IoT Hub를 엽니다. 
2. **개요**를 클릭합니다. 
3. 나열된 위치가 [지원되는 서비스 지역](#supported-service-regions)중 하나와 일치하는지 확인합니다. 
