...
-   하드 드라이브만 배송하고 전원 공급 장치 케이블이나 USB 케이블과 같은 품목은 포함하지 마세요.
  ...
  [Azure 가져오기/내보내기 서비스 REST API 참조]: http://go.microsoft.com/fwlink/?LinkID=329099
  [저장소 계정을 만드는 방법]: ../storage-create-storage-account/
  [Microsoft Azure 가져오기/내보내기 도구 참조]: http://go.microsoft.com/fwlink/?LinkId=329032
  [Microsoft Azure 가져오기/내보내기 도구]: http://go.microsoft.com/fwlink/?LinkID=301900&clcid=0x409
