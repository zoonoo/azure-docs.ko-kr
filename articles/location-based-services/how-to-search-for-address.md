...
5. 쿼리 문자열에 다음 값을 추가하고 **보내기**를 클릭합니다.
    ```
        ,countrySet=US
    ```
    >[!NOTE] 
    >쿼리 문자열의 추가 URI 매개 변수를 쉼표로 구분해야 합니다.
...
4. 쿼리 문자열에 다음 값을 추가하고 **보내기**를 클릭합니다.
    ```
        ,number
    ```
...
6. 쿼리 문자열에 다음 값을 추가하고 **보내기**를 클릭합니다.
    ```
        ,returnSpeedLimit
    ```
...
7. 쿼리 문자열에 다음 값을 추가하고 **보내기**를 클릭합니다.
    ```
        ,returnRoadUse
    ```
...
8. 쿼리 문자열에 다음 값을 추가하고 **보내기**를 클릭합니다.
    ```
        ,roadUse
    ```
