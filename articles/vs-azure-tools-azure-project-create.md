...
4. **템플릿** 창에서 **Azure 클라우드 서비스**를 선택합니다.
...
8. 로젝트에 추가한 역할의 이름을 바꾸려면 **새 Azure 프로젝트** 대화 상자의 역할에 마우스 포인터를 가리키고 역할의 오른쪽에 있는 **이름바꾸기** 아이콘을 선택합니다. 또한 추가 된 후 솔루션 내에서 역할의 이름을 바꿀 수 있습니다.
