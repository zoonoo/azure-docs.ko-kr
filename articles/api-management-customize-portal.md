...
-   [페이지 머리글의 텍스트/로고 변경][페이지 머리글의 텍스트/로고 변경]
-   [머리글의 스타일 변경][머리글의 스타일 변경]
-   [페이지 콘텐츠 편집][페이지 콘텐츠 편집]
-   [다음 단계][다음 단계]
...
개발자 포털은 CMS(콘텐츠 관리 시스템)에 기반합니다. 모든 페이지에 나타나는 머리글은 위젯이라고 하는 특수 형식의 콘텐츠입니다. 이 위젯의 콘텐츠를 편집하려면 왼쪽의 **개발자 포털** 메뉴에서 **위젯**을 클릭한 다음 목록에서 **머리글** 위젯을 선택합니다.
...
-   [고급 API 구성 시작][고급 API 구성 시작] 자습서에서 다른 항목을 확인하세요.
  ...
  [다음 단계]: #next-steps
  [관리 콘솔]: ./media/api-management-customize-portal/api-management-management-console.png
  [위젯 머리글]: ./media/api-management-customize-portal/api-management-widgets-header.png
  [사용자 지정 도구 모음]: ./media/api-management-customize-portal/api-management-customization-toolbar.png
  [부트스트랩]: http://getbootstrap.com/
  [LESS 변수]: http://getbootstrap.com/css/
  [색 선택]: ./media/api-management-customize-portal/api-management-customization-toolbar-color-picker.png
  [게시 메뉴]: ./media/api-management-customize-portal/api-management-customization-toolbar-publish-form.png
  [콘텐츠 관리]: ./media/api-management-customize-portal/api-management-customization-manage-content.png
