---
title: Palo Alto Networks 데이터 Azure Sentinel 미리 보기에 연결 | Microsoft Docs
description: Palo Alto Networks 데이터 Azure Sentinel를 연결 하는 방법에 알아봅니다.
services: sentinel
