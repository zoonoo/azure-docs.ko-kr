...
- **Fusion** 기반 fusion 기술 기반 Azure 센티널의 advanced 다단계 공격 감지는 확장 가능한 기계 학습 알고리즘을 사용 하 여 여러 제품에서 발생 하는 여러 가지 낮은 충실도 경고 및 이벤트의 상관 관계를 높은 충실도 및 실행 가능으로 지정할 수 있습니다. 사고. Fusion은 기본적으로 사용 하도록 설정 되어 있습니다. 논리는 숨겨져 있으므로이를 템플릿으로 사용 하 여 둘 이상의 규칙을 만들 수 없습니다.
