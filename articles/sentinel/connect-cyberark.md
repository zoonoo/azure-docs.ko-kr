...
1. [CyberArk EPV 지침](https://docs.cyberark.com/Product-Doc/OnlineHelp/PAS/Latest/en/Content/PASIMP/DV-Integrating-with-SIEM-Applications.htm) 에 따라 로그 전달 서버에 syslog 데이터 보내기를 구성 합니다.
