---
title: Azure Sentinel 미리 보기에서 Azure Security Center 데이터 수집 | Microsoft Docs
description: Azure Sentinel에 Azure Security Center 데이터를 수집 하는 방법에 알아봅니다.
services: sentinel
...
ms.locfileid: "57242277"
---
# <a name="collect-data-from-azure-security-center"></a>Azure Security Center에서 데이터를 수집 합니다.
...
Azure Sentinel을 사용 하면 경고를 수집할 수 있습니다 [Azure Security Center](../security-center/security-center-intro.md) Azure Sentinel에 스트리밍하 고 합니다. 
...
1. Azure Sentinel 선택 **데이터 컬렉션** 클릭 하 고는 **Azure Security Center** 바둑판식으로 배열 합니다.
...
이 문서에서는 Azure Sentinel에 Azure Security Center를 연결 하는 방법을 알아보았습니다. Azure에서 감시 하는 방법에 대 한 자세한 내용은 다음 문서를 참조 합니다.
