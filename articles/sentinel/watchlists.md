...
1. 정보를 검토 하 고 올바른지 확인 한 다음 **만들기** 를 선택 합니다.
    ...
    :::image type="content" source="./media/watchlists/sentinel-watchlist-complete.png" alt-text="관심 목록 성공적으로 생성 알림" lightbox="./media/watchlists/sentinel-watchlist-complete.png":::
...
1. Azure Portal에서 **Azure 센티널**  >  **Configuration**  >  **관심 목록** 로 이동 하 고 사용 하려는 관심 목록을 선택한 다음 **Log Analytics에서 보기** 를 선택 합니다.
    ...
    :::image type="content" source="./media/watchlists/sentinel-watchlist-queries-list.png" alt-text="쿼리에서 watchlists 사용" lightbox="./media/watchlists/sentinel-watchlist-queries-list.png":::
