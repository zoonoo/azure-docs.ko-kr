...
- [Azure DDoS Standard 보호 계획](../ddos-protection/manage-ddos-protection.md#create-a-ddos-protection-plan)을 구성 해야 합니다.

- [Azure DDoS Standard를 사용 하도록 설정 된 가상 네트워크가](../ddos-protection/manage-ddos-protection.md#enable-ddos-protection-for-a-new-virtual-network)구성 되어 있어야 합니다.
...
1. 연결 하려는 로그의 모든 공용 IP 주소에서 **진단 로그** 를 사용 하도록 설정 합니다.
