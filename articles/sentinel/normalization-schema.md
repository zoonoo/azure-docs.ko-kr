...
Azure 센티널 스키마에서 사용 되는 용어는 다음과 같습니다.
...
| EventResult | 다중값: Success, Partial, Failure, [Empty] (String) | Success | 작업에 대해 보고 된 결과입니다. 해당 하지 않는 경우 빈 값입니다. | 이벤트 |
...
| EventUid | Guid (문자열) | 516a64e3-8360-4f1e-a67c-d96b3d52df54 | Azure 센티널에서 행을 표시 하는 데 사용 하는 고유 식별자입니다. | 이벤트 |
