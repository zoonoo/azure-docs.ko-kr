...
- 기본 제공 쿼리: 시작 하기 위해 시작 페이지는 미리 로드 된 쿼리 예제를 시작 하 여 테이블 및 쿼리 언어를 친숙 하 게 만들 수 있도록 설계 되었습니다. 이러한 기본 제공 검색 쿼리는 지속적으로 Microsoft 보안 연구원에 의해 개발 되 고, 새 쿼리를 추가 하 고, 기존 쿼리를 미세 조정 하 여 새 검색을 찾고, 검색을 시작할 위치를 파악 하는 진입점을 제공 합니다. 새 공격의 처음입니다. 
...
Azure 센티널의 구하기는 Kusto 쿼리 언어를 기반으로 합니다. 쿼리 언어 및 지원 되는 연산자에 대 한 자세한 내용은 [쿼리 언어 참조](https://docs.loganalytics.io/docs/Language-Reference/)를 참조 하세요.
