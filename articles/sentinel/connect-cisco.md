...
description: Cisco GLOBAL.ASA 어플라이언스를 Azure 센티널에 연결 하 여 대시보드를 보고, 사용자 지정 경고를 만들고, 조사를 개선 하는 방법을 알아봅니다.
services: sentinel
...
1. Cisco 이벤트의 Log Analytics에서 관련 스키마를 사용 하려면를 검색 `CommonSecurityLog` 합니다.
