...
## <a name="view-available-notebooks-from-azure-sentinel"></a>Azure 센티널에서 사용 가능한 노트북 보기
...
2. 개별 노트북을 선택 하 여 설명, 필수 데이터 형식 및 데이터 원본을 읽습니다. 예:
    ...
    > [!div class="mx-imgBorder"]
    > 노트북](./media/notebooks/sentinel-azure-notebooks-nolaunch.png) 시작 ![

3. **노트북 시작** 을 선택 하 여 [Azure 센티널 커뮤니티 GitHub 리포지토리에서](https://github.com/Azure/Azure-Sentinel)노트북을 찾아봅니다.

현재는 Azure 센티널에서 직접 노트북을 시작할 수 없습니다. 대신, GitHub에서 노트북을 Azure Notebooks 프로젝트로 복제 하는 단계를 수행 하는 다음 절차를 사용 하세요.
