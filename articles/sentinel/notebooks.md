...
2. Select individual notebooks to read their descriptions, required data types, and data sources. 다음은 그 예입니다.
...
4. Open the project you just created, and then open the **Notebooks** folder to see the notebooks. 다음은 그 예입니다.
...
In this article, you learned how to get started using Jupyter notebooks in Azure Sentinel. Azure Sentinel에 대한 자세한 내용은 다음 문서를 참조하세요.
