...
3.	Appcelerator Titanium Studio에서 [모바일 서비스 시작] 자습서를 완료했을 때 만든 프로젝트를 엽니다.
...
1.	프로젝트 파일 index.js를 열고 테이블 이벤트 Lister 메서드에서 `case 2:`을(를) 찾습니다.
...
>[AZURE.NOTE]Google 이외의 ID 공급자를 사용하는 경우, 위의 **authorizeClient**에 전달된 값을 다음 중 하나로 변경합니다. *microsoftaccount*, *facebook*, *twitter* 또는 *windowsazureactivedirectory*.
