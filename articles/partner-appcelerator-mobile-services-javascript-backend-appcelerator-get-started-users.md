...
3.	Appcelerator Titanium Studio에서 [모바일 서비스 시작] 자습서를 완료할 때 만든 프로젝트를 엽니다.
...
>[AZURE.NOTE] Google 이외의 ID 공급자를 사용하는 경우 **authorizeClient**에 전달된 값을  *microsoftaccount*,  *facebook*,  *twitter*,  *windowsazureactivedirectory* 중 하나로 변경합니다.
