...
| 백업 | VM이 더 이상 존재하지 않아 작업을 수행할 수 없습니다. | 백업용으로 구성된 VM이 삭제되었기 때문에 백업을 수행할 수 없습니다. 보호된 항목 보기로 이동하여 향후 백업을 중지하고 보호된 항목을 선택하고 보호 중지를 클릭합니다. 백업 데이터 보존 옵션을 선택하여 데이터를 보존할 수 있습니다. 나중에 등록된 항목 보기에서 보호 구성을 클릭하여 이 가상 컴퓨터에 대한 보호를 다시 시작할 수 있습니다.|
