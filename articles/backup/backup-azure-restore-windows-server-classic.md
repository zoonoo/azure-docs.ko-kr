...
> [!IMPORTANT]
> 이제 Backup 자격 증명 모음을 Recovery Services 자격 증명 모음으로 업그레이드할 수 있습니다. 자세한 내용은 [Recovery Services 자격 증명 모음으로 Backup 자격 증명 모음 업그레이드](backup-azure-upgrade-backup-to-recovery-services.md) 문서를 참조하세요. Backup 자격 증명 모음을 Recovery Services 자격 증명 모음으로 업그레이드하는 것이 좋습니다.<br/> **2017년 11월 30일** 이후에는 PowerShell을 사용하여 Backup 자격 증명 모음을 만들 수 없습니다. <br/> **2017년 11월 30일부터**:
...
1. **Microsoft Azure Backup** 스냅인을 엽니다.
...
* *샘플 자격 증명 모음* – *원본 컴퓨터* 및 *대상 컴퓨터*가 등록된 Backup 자격 증명 모음입니다. <br/>
...
* [Azure Backup 포럼](http://go.microsoft.com/fwlink/p/?LinkId=290933)을 방문하세요.

## <a name="learn-more"></a>자세한 정보
* [Azure Backup 개요](http://go.microsoft.com/fwlink/p/?LinkId=222425)
* [Azure 가상 컴퓨터 Backup](backup-azure-vms-introduction.md)
