...
이제 [ cmdlet의 출력에서 선택한 ](https://docs.microsoft.com/powershell/module/msonlinebackup/start-obrecovery?view=winserver2012-ps)에 대해 `$Item`Start-OBRecovery`Get-OBRecoverableItem` 명령을 사용하여 복원 프로세스를 트리거합니다.
