...
1. **일별 보존 정책**: 매일 수행 되는 백업은 7 일 동안 저장 됩니다.
2. **주간 보존 정책**: 자정 및 오후 6 시 토요일에 매일 수행 되는 백업은 4 주 동안 보존 됩니다.
3. **월별 보존 정책**: 매월 마지막 토요일 자정 및 오후 6 시에 수행 된 백업은 12 개월 동안 유지 됩니다.
