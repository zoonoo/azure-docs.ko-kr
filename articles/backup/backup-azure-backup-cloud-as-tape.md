---
title: 테이프 인프라를 교체하는 방법
description: Azure Backup에서 데이터를 백업하고 복원할 수 있는 테이프와 같은 의미 체계를 제공하는 방법에 대해 알아봅니다.
ms.topic: conceptual
ms.date: 04/30/2017
...
2. **주간 보존 정책**: 자정과 토요일 오후 6시에 수행된 백업은 4주 동안 보존됩니다.
3. **월별 보존 정책**: 매월 마지막 토요일 자정과 오후 6시에 수행된 백업은 12개월 동안 보존됩니다.
4. **연간 보존 정책**: 매년 3월 마지막 토요일 자정에 수행한 백업은 10년 동안 보존됩니다.
...
> [!NOTE]
> Azure 백업을 사용하면 보호된 인스턴스당 최대 9999개의 복구 지점을 만들 수 있습니다. 보호된 인스턴스는 Azure로 백업하는 컴퓨터, 서버(실제 또는 가상) 또는 워크로드입니다.
>
