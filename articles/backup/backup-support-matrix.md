...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure VM               | 관리되는 디스크와 관리되지 않는 디스크를 모두 사용하는 Azure VM에서 지원됩니다. 클래식 VM에는 지원되지 않습니다. | 프랑스 중부, 오스트레일리아 중부, 남아프리카 공화국 북부, 아랍에미리트 북부, 스위스 북부, 독일 중서부, 노르웨이 동부를 제외한 모든 Azure 공용 지역 및 주권 지역에서 사용할 수 있습니다. <br>이러한 지역에서 사용하는 방법에 대한 내용은 [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com)에 문의하세요. |
| SQL/SAP HANA | 미리 보기                                                      | 프랑스 중부, 오스트레일리아 중부, 남아프리카 공화국 북부, 아랍에미리트 북부, 스위스 북부, 독일 중서부, 노르웨이 동부를 제외한 모든 Azure 공용 지역 및 주권 지역에서 사용할 수 있습니다. <br>이러한 지역에서 사용하는 방법에 대한 내용은 [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com)에 문의하세요. |
