...
**자격 증명 모음 간의 데이터 이동** | 자격 증명 모음 간에 백업 데이터를 이동 하는 것은 지원 되지 않습니다.
...
--- | ---
**Linux를 실행 하는 온-프레미스 컴퓨터의 직접 백업** | 지원 안 됨 MARS 에이전트는 Windows 컴퓨터에만 설치할 수 있습니다.
...
**MABS 또는 DPM을 사용 하 여 Linux Azure Vm 백업** | 지원 안 됨
...
**컴퓨터** | **MABS/DPM에 압축(TCP)** | **자격 증명 모음으로 압축 (HTTPS)**
--- | --- | ---
...
**DPM/MABS 디스크의 복구 지점 수** | 파일 서버의 경우 64 448 앱 서버 <br/><br/>온-프레미스 DPM의 무제한 테이프 복구 시점
...
| ---------------------- | ------------------------------------------------------------ | ----------------- |
| Azure VM               | 예.   1TB 미만의 디스크를 사용 하는 암호화 된 Vm 및 Vm에 지원 됨 | 모든 Azure 공용 지역입니다.  |
| MARS 에이전트/온-프레미스 | 아니요                                                           | 해당 없음               |
| SQL/SAP HANA          | 아니요                                                           | 해당 없음               |
| AFS                    | 아니요                                                           | 해당 없음               |
