...
Azure 파일 공유를 위한 백업은 미리 보기에 있습니다. 범용 v1 및 범용 v2 스토리지 계정 둘 다에서 Azure 파일 공유가 지원됩니다. Azure 파일 공유 백업에 대 한 제한 사항은 다음과 같습니다.
...
1. 포털 알림을 모니터링 하 여 백업 작업 실행 완료에 대 한 추적을 유지 합니다. 자격 증명 모음 대시보드에서 작업 진행률을 모니터링할 수 있습니다. **진행**중인 **백업 작업** > 선택 합니다.
