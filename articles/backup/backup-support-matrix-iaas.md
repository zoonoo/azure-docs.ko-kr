...
Write Accelerator가 설정된 디스크 | 2020 년 11 월 23 일부 터 미국 중부 (KRC) 및 남부 아프리카 북부 (SAN) 지역에서 지원 됩니다.<br/><br/> Azure Backup은 백업 하는 동안 WA (Write Accelarted)가 설정 된 디스크가 있는 가상 컴퓨터를 백업 합니다.  
