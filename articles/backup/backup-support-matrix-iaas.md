...
[확장 집합](../virtual-machine-scale-sets/overview.md)에 배포된 VM 백업 |지원됩니다. 장애 도메인에 대해 [오케스트레이션 모드](../virtual-machine-scale-sets/orchestration-modes.md) 를 2로 설정 해야 합니다. 가용성 집합은 지원 되지 않습니다.
