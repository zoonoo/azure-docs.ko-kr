...
현재는 가상 IP에 대해서만 솔루션을 설정 하는 기능이 없습니다. 솔루션을 실행 하려면 가상 머신이 필요 합니다.

### <a name="i-have-a-sap-hana-system-replication-hsr-how-should-i-configure-backup-for-this-setup"></a>HSR (SAP HANA System Replication)이 있습니다 .이 설정에 대 한 백업을 구성 하려면 어떻게 해야 하나요?

HSR의 기본 및 보조 노드는 서로 관련 없는 두 개의 Vm으로 취급 됩니다. 주 노드에서 백업을 구성 해야 하 고 장애 조치 (failover)가 발생 하는 경우 보조 노드 (이제 주 노드가 됨)에 백업을 구성 해야 합니다. 다른 노드에 대 한 백업에 대 한 자동 ' 장애 조치 (failover) '가 없습니다.
