...
## [백업 관리를 위해 역할 기반 액세스 제어 사용](backup-rbac-rs-vault.md)
## [하이브리드 백업에 대한 보안 기능을 사용하도록 설정](backup-azure-security-feature.md)
