...
| 등록 | Microsoft Azure 백업에서 내부 오류가 발생했습니다. 몇 분간 기다린 후 작업을 다시 시도하세요. 문제가 지속되면 Microsoft 지원에 문의하세요. | 이 오류는 지원되지 않는 다음 구성 중 하나로 인해 발생할 수 있습니다. <ol><li>프리미엄 LRS <li>다중 NIC <li>부하 분산 장치(내부 및 인터넷 연결)</ol> |
...
| 백업 | 부하 분산 장치 구성으로 가상 컴퓨터의 백업은 지원되지 않습니다. | 없음 <br><br>내부 부하 분산 장치 및 인터넷 연결 부하 분산 장치에 적용됩니다.|
