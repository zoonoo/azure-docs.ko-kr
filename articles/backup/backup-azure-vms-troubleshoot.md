...
* [기존 VM에 고정 내부 IP를 추가하는 방법](/previous-versions/azure/virtual-network/virtual-networks-reserved-private-ip.md#how-to-add-a-static-internal-ip-to-an-existing-vm)
