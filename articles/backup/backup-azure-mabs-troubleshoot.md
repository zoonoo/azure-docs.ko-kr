...
| Backup | 파일/공유 폴더에 액세스하는 동안 오류가 발생했습니다. | [DPM 서버에서 바이러스 백신 소프트웨어 실행](https://docs.microsoft.com/previous-versions/system-center/system-center-2012-R2/hh757911(v=sc.12))문서에 제안 된 대로 바이러스 백신 설정을 수정 하십시오.|
