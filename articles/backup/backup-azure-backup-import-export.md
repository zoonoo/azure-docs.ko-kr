...
* 지원되는 드라이브를 사용하고 있는지 확인합니다. 2.5인치 SSD나 2.5 또는 3.5인치 SATA II/III 내부 하드 드라이브만 Import/Export 서비스에서 사용하도록 지원됩니다. 최대 10TB의 하드 드라이브를 사용할 수 있습니다. [Azure 가져오기/내보내기 서비스 설명서](../storage/storage-import-export-service.md#hard-disk-drives)에서 서비스가 지원하는 최신 드라이브를 집합을 확인하세요.
