...
---
title: Azure 포털을 사용하여 백업에서 가상 컴퓨터 복원 | Microsoft Docs
...
> [!NOTE]
> 포털은 복원된 VM에 대해 빨리 만들기 옵션을 제공합니다. 복원될 VM의 VM 구성을 사용자 지정하려면, PowerShell을 사용하여 백업된 디스크를 복원하고 선택한 VM 구성에 연결합니다. [특수 네트워크 구성을 가진 VM 복원](#restoring-vms-with-special-network-configurations)을 참조하세요.
> 
> 
