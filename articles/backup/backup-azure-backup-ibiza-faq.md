...
이 문서에서는 복구 서비스 자격 증명 모음에 지정된 정보를 제공하고 [Azure 백업 FAQ](backup-azure-backup-faq)를 보완합니다. Azure 백업 FAQ는 Azure 백업 서비스에 대한 질문 및 답변의 전체 집합을 제공합니다.
...
## 복구 서비스 자격 증명 모음은 Resource Manager 기반이며 백업 자격 증명 모음(기본 모드)을 계속 지원하나요? <br/>
