---
title: Azure Backup를 사용 하 여 SQL Server 데이터베이스 백업 문제 해결 Microsoft Docs
...
* 다음 오류 코드 중 하나를 사용 하 여 VM에서 모든 작업 (예: 백업, 복원 및 구성 백업)이 실패 합니다. **WorkloadExtensionNotReachable**, **UserErrorWorkloadExtensionNotInstalled**, **WorkloadExtensionNotPresent**, **WorkloadExtensionDidntDequeueMsg**.
...
위의 시나리오에서 VM에 대 한 다시 등록 작업을 트리거하는 것이 좋습니다. 지금은이 옵션은 PowerShell을 통해서만 사용할 수 있습니다.
