...
| ------------------ | ----------------------------- |
| Azure 파일 공유에 대한 백업을 구성할 스토리지 계정을 찾을 수 없습니다. | <ul><li>검색이 완료될 때까지 기다립니다. <li>스토리지 계정의 파일 공유가 이미 다른 Recovery Services 자격 증명 모음으로 보호되고 있는지 확인합니다. **참고**: 스토리지 계정의 모든 파일 공유를 Recovery Services 자격 증명 모음 하나로 보호할 수 있습니다. <li>지원되지 않는 스토리지 계정에 파일 공유가 있지 않도록 주의해야 합니다.|
