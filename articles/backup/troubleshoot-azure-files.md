...
description: "이 문서에서는 Azure에서 Azure Files(파일 공유)를 보호할 때 발생하는 문제 해결에 대한 내용을 다룹니다."
services: backup
ms.service: backup
...
Azure Files 백업은 미리 보기입니다. 다음 백업 시나리오는 Azure 파일 백업에 지원되지 않습니다.
