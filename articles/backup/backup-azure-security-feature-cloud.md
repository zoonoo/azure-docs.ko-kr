...
아닙니다. 일시 삭제 된 항목은 강제로 삭제할 수 없습니다. 14 일 후 자동으로 삭제 됩니다. 이 보안 기능은 백업 된 데이터를 실수로 또는 악의적으로 삭제 하지 않도록 보호 하기 위해 사용 됩니다.  항목에 대해 다른 작업을 수행 하기 전에 14 일 동안 기다려야 합니다.  일시 삭제 된 항목에는 요금이 부과 되지 않습니다.  새 자격 증명 모음의 14 일 이내에 일시 삭제로 표시 된 항목을 다시 보호 해야 하는 경우 Microsoft 지원에 문의 하세요.
