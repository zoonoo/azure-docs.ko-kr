...
Azure vm의 SQL server에 대 한 [azure virtual machines](soft-delete-virtual-machines.md) 및 일시 삭제에 대 한 소프트 삭제 및 azure vm [워크 로드의 SAP HANA에](soft-delete-sql-saphana-in-azure-vm.md) 대 한 일시 삭제는 모든 사용자에 게 제공 됩니다.
