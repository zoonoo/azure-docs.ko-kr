...
> [!NOTE]
> Azure Backup은 명명 형식 **AzureBackupRG_geography_number**를 통해 별도 리소스 그룹(VM 리소스 그룹 이외)을 만들어 복원 지점을 저장합니다(예: AzureBackupRG_northeurope_1). 이 리소스 그룹은 잠그면 안 됩니다.
