...
| 액세스 관리 - 권한 부여| 예 | 고객이 생성하고 기본 제공된 RBAC 역할이 사용됩니다. 참조 [Azure Backup 복구 지점 관리에 관한 Access Control](/azure/backup/backup-rbac-rs-vault) 자세한 내용은 합니다. |
