...
[AZURE.INCLUDE [백업-만들기-자격 증명 모음](../../includes/backup-create-vault.md)]

[AZURE.INCLUDE [백업-다운로드-자격 증명](../../includes/backup-download-credentials.md)]

[AZURE.INCLUDE [백업-설치-에이전트](../../includes/backup-install-agent.md)]
