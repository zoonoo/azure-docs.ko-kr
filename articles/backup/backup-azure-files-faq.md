...
description: "이 문서에서는 Azure에서 Azure Files을 보호하는 자세한 방법을 설명합니다. 이 추상은 검색 결과에 표시됩니다."
services: backup
...
### <a name="how-many-file-shares-can-i-protect-in-a-vaultbr"></a>자격 증명 모음 하나로 보호할 수 있는 파일 공유 수는 몇 개입니까?<br/>
미리 보기 기간에는 자격 증명 모음당 최대 25개의 저장소 계정에서 파일 공유를 보호할 수 있습니다. 또한 자격 증명 모음 하나당 최대 200개의 파일 공유를 보호할 수 있습니다. 
...
### <a name="what-happens-when-i-change-the-backup-policy-for-a-file-share-br"></a>파일 공유에 대한 백업 정책을 변경하면 어떻게 되나요? <br/>
