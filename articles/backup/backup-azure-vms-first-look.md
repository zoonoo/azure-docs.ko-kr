---
title: "소개: 백업 자격 증명으로 Azure VM 보호 | Microsoft 문서"
...
![1단계](./media/backup-azure-vms-first-look/step-one.png) 백업 자격 증명 모음을 만들거나 기존 백업 자격 증명 모음을 식별합니다. <br/>
![2단계](./media/backup-azure-vms-first-look/step-two.png) Azure 클래식 포털을 사용하여 가상 컴퓨터를 검색하고 등록합니다. <br/>
![3단계](./media/backup-azure-vms-first-look/step-three.png) VM 에이전트를 설치합니다. <br/>
![4단계](./media/backup-azure-vms-first-look/step-four.png) 가상 컴퓨터를 보호하는 정책을 만듭니다. <br/>
![5단계](./media/backup-azure-vms-first-look/step-five.png) 백업을 실행합니다.
...
2. Azure 포털의 왼쪽 아래 모서리에서 **새로 만들기**

    ![새로 만들기 메뉴를 클릭합니다.](./media/backup-azure-vms-first-look/new-button.png)
3. 빠른 생성 마법사에서 **Data Services** > **Recovery Services** > **백업 자격 증명 모음** > **빠른 생성**을 클릭합니다.
...
7. **자격 증명 모음 만들기**를 클릭합니다. 백업 자격 증명 모음을 만드는 데 시간이 걸릴 수 있습니다. 포털의 맨 아래에서 상태 알림을 모니터링합니다.
    ...
    자격 증명 모음이 성공적으로 만들어졌다는 메시지가 표시됩니다. **Recovery Services** 페이지에서 **활성**으로 표시됩니다.

    ![자격 증명 모음 알림 메시지 만들기](./media/backup-azure-vms-first-look/create-vault-demo-success.png)
8. **Recovery Services** 페이지의 자격 증명 모음 목록에서 만든 자격 증명 모음을 선택하여 **빠른 시작** 페이지를 시작합니다.

    ![백업 자격 증명 모음 목록](./media/backup-azure-vms-first-look/active-vault-demo.png)
9. **빠른 시작** 페이지에서 **구성**을 클릭하여 저장소 복제 옵션을 엽니다.
    ![백업 자격 증명 모음 목록](./media/backup-azure-vms-first-look/configure-storage.png)
