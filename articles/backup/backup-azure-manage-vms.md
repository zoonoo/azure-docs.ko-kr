...
* 추가 비용을 방지 하기 위해 주 데이터 원본이 더 이상 존재 하지 않는 백업 항목을 삭제 하는 것이 좋습니다. 가장 최근 복구 지점이 영구적으로 유지 되 고 해당 사용자에 게 적용 되는 백업 가격에 따라 요금이 청구 되는 경우 삭제 리소스에 대 한 백업 항목/데이터가 더 이상 필요 하지 않은 경우
