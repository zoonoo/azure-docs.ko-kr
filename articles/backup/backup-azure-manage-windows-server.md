...
4. Vault 목록에서 열려는 Recovery Services Vault의 이름을 선택합니다. Recovery Services 자격 증명 모음 대시보드 블레이드가 열립니다.
...
1. Microsoft Azure Backup 에이전트에서 **백업 예약**을 클릭합니다.
...
1. **Microsoft Azure Backup 에이전트**를 엽니다(*Microsoft Azure Backup*에 대한 컴퓨터를 검색하여 찾을 수 있음).
    ...
    ![Windows Server Backup 예약](./media/backup-azure-manage-windows-server/snap-in-search.png)
2. Microsoft Azure Backup 에이전트에서 **백업 예약**을 클릭합니다.
...
A1. 백업 작업 상태가 Azure 백업 에이전트와 Azure Portal에 반영될 때까지 최대 15분이 지연됩니다.
...
* Azure Backup에 대한 자세한 내용은 [ 개요](backup-introduction-to-azure-backup.md)
