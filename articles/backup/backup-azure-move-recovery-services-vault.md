...
## <a name="register-the-subscription-to-move-your-recovery-services-vault"></a>구독을 등록하여 Recovery Services 자격 증명 모음 이동

구독을 등록하여 Recovery Services 자격 증명 모음을 **이동**하려면 PowerShell 터미널에서 다음 cmdlet을 실행합니다.
