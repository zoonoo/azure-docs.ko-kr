<properties
	pageTitle="Windows Server 또는 Windows 클라이언트 백업을 위한 환경 준비 | Microsoft Azure"
...
이 문서에서는 Windows 서버나 Windows 클라이언트를 Azure에 백업하기 위한 준비를 안내합니다. 이를 위해 Azure 계정이 필요합니다. 계정이 없는 경우 몇 분 만에 무료 평가판 계정을 만들 수 있습니다. 자세한 내용은 [Azure 무료 체험](https://azure.microsoft.com/pricing/free-trial/)을 참조하세요.

이미 수행한 경우 [Windows 컴퓨터 백업](backup-azure-backup-windows-server.md)을 시작할 수 있습니다. 그렇지 않은 경우 아래 단계를 계속 진행하여 사용자 환경이 준비되었는지 확인합니다.
