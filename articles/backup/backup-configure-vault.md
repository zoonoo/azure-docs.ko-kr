...
## <a name="step-1-create-a-recovery-services-vault"></a>1단계: 복구 서비스 자격 증명 모음 만들기
...
## <a name="step-2-download-files"></a>2단계: 파일 다운로드
> [!NOTE]
...
1. **인프라 준비** 블레이드에서 **Windows Server 또는 Windows 클라이언트의 에이전트 다운로드**를 클릭합니다.
    ...
    ![Windows Server 또는 Windows 클라이언트의 에이전트 다운로드](./media/backup-configure-vault/prepare-infrastructure-short.png)
...
1. [인프라 준비] 블레이드에서 **다운로드 > 저장**을 클릭합니다.
    ...
    ![Windows Server 또는 Windows 클라이언트의 에이전트 다운로드](./media/backup-configure-vault/prepare-infrastructure-download.png)

## <a name="step-3-install-and-register-the-agent"></a>3단계: 에이전트 설치 및 등록
...
### <a name="confirm-the-installation"></a>설치 확인
