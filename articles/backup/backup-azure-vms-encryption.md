...
5. **Backup 정책** > **백업 정책 선택**, 자격 증명 모음을 사용 하 여 연결 하려는 정책을 선택 합니다. 그런 다음 **확인**을 클릭합니다.
...
4. **지금 백업**을 클릭합니다.
5. **지금 Backup**, 달력 컨트롤을 사용 하 여 복구 지점을 유지 되어야 하는 마지막 날을 선택 합니다. 그런 다음 **확인**을 클릭합니다.
