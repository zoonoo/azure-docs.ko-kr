...
- [일반적인 오류](backup-azure-vms-troubleshoot.md#troubleshoot-backup-of-encrypted-vms) 경우 백업 및 복원 하는 Azure Vm 암호화 합니다.
- [일반](backup-azure-vms-troubleshoot.md) Azure VM을 발급 합니다.
