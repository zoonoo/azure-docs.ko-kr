...
6. **보호 항목** 마법사의 세 번째 화면에서 수행된 백업과 연결될 보존 범위를 선택합니다. 이 화면에서는 보존 체계에 기반한 업계 표준 GFS(Grandfather-Father-Son)을 지원합니다. [장기 보존](backup-azure-vms-introduction.md#장기 보존 정책)에 대해 자세히 읽어봅니다.
...
4. **월 단위 보존 정책**: 매년 1월 첫 주 일요일에 수행된 백업이 99년 동안 유지됩니다.
