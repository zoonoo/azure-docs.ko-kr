---
title: "Azure Backup Server를 사용하여 워크로드를 백업하도록 환경 준비 | Microsoft Docs"
description: "Azure Backup Server를 사용하여 작업 부하를 보호하거나 백업하기 위한 환경을 준비합니다."
services: backup
documentationcenter: 
author: PVRK
manager: shivamg
...
Azure의 VM과 같은 서버(IaaS) 작업으로 정보를 보호할 수 있습니다.
...
5. Getting Started(시작)가 열리면, Backup Goals(백업 목표) 화면이 자동으로 선택됩니다.
    ![Backup-goals-default-opened](./media/backup-azure-microsoft-azure-backup/getting-started.png)
   
    **백업 목표** 섹션에서 *워크로드가 실행되는 위치*에 대해 *온-프레미스*를 선택합니다.
...
6. *what workloads you want to protect* (보호할 워크로드)에서 Azure 백업 서버를 사용하여 보호할 워크로드를 선택하고 **확인**을 클릭합니다.
   ...
   > [!NOTE]
   > 파일과 폴더만 보호하려면 Azure 백업 에이전트를 사용하는 것이 좋습니다. 파일과 폴더 이상으로 더 많은 워크로드를 보호할 예정이거나, 나중에 보호 요구를 확장할 계획이면, 해당 워크로드를 모두 살펴봅니다.
   > 
   > 
...
7. 열린 **인프라 준비** 블레이드에서 [Azure Backup Server 설치] 및 [자격 증명 모음 자격 증명 다운로드]의 **다운로드** 링크를 클릭합니다. 복구 서비스 자격 증명 모음에 Azure 백업 서버를 등록하는 동안 자격 증명 모음 자격 증명을 사용합니다. 소프트웨어 패키지를 다운로드할 수 있는 다운로드 센터로 연결됩니다.
