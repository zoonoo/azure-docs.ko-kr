...
VM 에이전트 구성 파일 옵션의 전체 목록을 보려면을 참조 하십시오 <https://github.com/Azure/WALinuxAgent#configuration-file-options>
...
Linux VM의 경우 VMSnapshot 확장이 Azure Portal에 표시 되지 않으면 [Azure Linux 에이전트를 업데이트](../virtual-machines/linux/update-agent.md)한 후 백업을 실행 합니다.
...
#### <a name="clean-up-restore-point-collection-by-running-on-demand-backup"></a>주문형 백업을 실행 하 여 복원 지점 수집 정리
