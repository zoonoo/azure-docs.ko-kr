...
- PowerShell을 사용 하 여 관리 디스크를 사용 하는 Vm을 복원 하려면 추가 매개 변수 ***TargetResourceGroupName*** 을 제공 하 여 관리 되는 디스크를 복원할 리소스 그룹을 지정 합니다. [여기에서 자세히 알아보세요](./backup-azure-vms-automation.md#restore-managed-disks).
