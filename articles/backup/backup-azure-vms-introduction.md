...
**고려 사항** | **세부 정보**
--- | ---
**디스크로** | VM 디스크의 백업이 동시에 진행 됩니다. 예를 들어 VM에 4 개의 디스크가 있는 경우 Backup 서비스는 4 개의 디스크를 모두 병렬로 백업 하려고 시도 합니다. 백업은 증분 방식입니다(변경된 데이터만 백업).
