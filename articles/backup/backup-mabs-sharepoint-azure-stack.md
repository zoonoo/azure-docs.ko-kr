...
10. **온라인 Backup 일정 지정** 페이지에서 선호하는 일정을 선택하고 **다음**을 클릭합니다.
    ...
    > [!NOTE]
    > MABS는 사용 가능한 최신 디스크 백업 지점에서 Azure에 최대 두 번의 일일 백업을 제공합니다. Azure 백업은 [Azure Backup 네트워크 제한](backup-windows-with-mars-agent.md#enable-network-throttling)을 사용하여 사용량이 최고인 시간과 적은 시간의 백업에 사용될 수 있는 WAN 대역폭 양을 제어할 수도 있습니다.
    >
    >
