...
추가 필수 구성 요소 및 제한 사항은 [DPM을 사용 하 여 SharePoint 백업](/system-center/dpm/back-up-sharepoint#prerequisites-and-limitations) 문서를 참조 하세요.

## <a name="configure-backup"></a>백업 구성

SharePoint 팜을 백업하려면 ConfigureSharePoint.exe를 사용하여 SharePoint 보호를 구성한 다음 DPM에서 보호 그룹을 만듭니다. 지침은 DPM 설명서의 [백업 구성](/system-center/dpm/back-up-sharepoint#configure-backup) 을 참조 하세요.

## <a name="monitoring"></a>모니터링

백업 작업을 모니터링 하려면 [DPM 백업 모니터링](/system-center/dpm/back-up-sharepoint#monitoring) 의 지침을 따르세요.

## <a name="restore-sharepoint-data"></a>SharePoint 데이터 복원

DPM을 사용 하 여 디스크에서 SharePoint 항목을 복원 하는 방법에 대 한 자세한 내용은 [sharepoint 데이터 복원](/system-center/dpm/back-up-sharepoint#restore-sharepoint-data)을 참조 하세요.
...
프런트 엔드 웹 서버가 두 대 이상인 경우 DPM에서 팜을 보호 하는 데 사용 하는 서버를 전환 하려면 [Front-End 웹 서버 전환](/system-center/dpm/back-up-sharepoint#switching-the-front-end-web-server)의 지침을 따르세요.
