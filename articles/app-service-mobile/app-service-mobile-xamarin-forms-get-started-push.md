...
11. **OnRegistered** 이벤트 처리기를 재정의하고 **Register** 메서드를 구현하는 다음 코드를 **GcmService** 클래스에 추가합니다.
...
4. **실행** 단추를 눌러 프로젝트를 빌드하고 Android 장치 또는 에뮬레이터에서 앱을 시작합니다.
...
3. **AppDelegate**에서 **DidReceivedRemoteNotification** 이벤트 처리기에 대한 다음 재정의도 추가합니다.
