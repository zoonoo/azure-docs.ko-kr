...
![완성된 앱의 스크린샷](./media/app-service-mobile-dotnet-backend-html-get-started-preview/mobile-quickstart-completed-html.png)
...
5. 앱에서 _Enter new task_에 **자습서 완료**와 같은 의미 있는 텍스트를 입력하고 **추가**를 클릭합니다.
   	...
   	![앱 실행](./media/app-service-mobile-dotnet-backend-html-get-started-preview/mobile-quickstart-startup-html.png)
