...
description: Azure App Service Mobile Apps를 사용 하 여 다음을 비롯 한 다양 한 id 공급자를 사용 하 여 UWP (유니버설 Windows 플랫폼) 앱의 사용자를 인증 하는 방법을 알아봅니다. AAD, Google, Facebook, Twitter 및 Microsoft.
