...
1. **TodoActivity** 클래스에 다음 코드를 추가합니다.
   ...
   > [!NOTE]
   > Facebook 이외의 id 공급자를 사용 하는 경우 위의 **LoginAsync** 에 전달 된 값을 다음 중 하나로 변경 합니다. *MicrosoftAccount*, *Twitter*, *Google* 또는 *WindowsAzureActiveDirectory* 중 하나로 변경합니다.
   > 
   > 
