...
4. 새 모바일 앱을 사용하는 새 버전의 클라이언트 응용 프로그램을 릴리스합니다.
...
## <a name="scaffold-app"></a> 새 Azure 모바일 앱 백 엔드 스캐폴드
...
- **+ 추가**를 클릭합니다.
- 드롭다운 목록에서 **SQL 데이터베이스**를 선택합니다.
- **SQL 데이터베이스** 아래에서 기존 데이터베이스를 선택한 다음 **선택**을 클릭합니다.
...
Azure 모바일 앱을 사용하면 서비스 내에서 Azure Active Directory, Facebook, Google, Microsoft 및 Twitter 인증을 구성할 수 있습니다. 사용자 지정 인증을 개별적으로 개발해야 합니다. 자세한 정보는 [인증 개념] 설명서 및 [인증 빠른 시작] 설명서를 참조하세요.
