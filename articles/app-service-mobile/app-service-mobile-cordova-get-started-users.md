---
title: 아파치 코르도바에 인증 추가
description: Azure 앱 서비스에서 모바일 앱을 사용하여 Google, Facebook, Twitter 및 Microsoft와 같은 ID 공급자를 사용하여 아파치 코르도바 앱 사용자를 인증하는 방법을 알아봅니다.
