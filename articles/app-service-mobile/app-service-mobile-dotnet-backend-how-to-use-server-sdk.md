...
> [!TIP]
> [Azure Mobile App용 .NET 서버 SDK][2]는 GitHub의 오픈 소스입니다. 리포지토리는 전체 서버 SDK 단위 테스트 도구 모음 및 일부 샘플 프로젝트를 포함하는 모든 소스 코드를 포함합니다.
> 
> 

## <a name="reference-documentation"></a>참조 설명서
서버 SDK에 대한 참조 설명서는 [Azure Mobile App .NET 참조][1]를 참조하세요.

## <a name="a-namecreate-appahow-to-create-a-net-mobile-app-backend"></a><a name="create-app"></a>방법: .NET 모바일 앱 백 엔드 만들기
...
App Service 모바일 백 엔드를 만들려면 [빠른 시작 자습서][3]를 따르거나 이 단계를 따릅니다.
...
Visual Studio에서 Azure Mobile App 프로젝트를 만들려면 [Azure SDK for .NET][4](버전 2.9.0 이상)을 설치합니다. SDK를 설치한 후 다음 단계를 사용하여 ASP.NET 응용 프로그램을 만듭니다.
...
## <a name="a-nameinstall-sdkahow-to-download-and-initialize-the-sdk"></a><a name="install-sdk"></a>방법: SDK 다운로드 및 설치
...
### <a name="a-nameserver-project-setupa-initialize-the-server-project"></a><a name="server-project-setup"></a> 서버 프로젝트 초기화
...
* [Microsoft.Azure.Mobile.Server.Home](http://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.Home/)
   웹 사이트 루트에 대해 기본 *이 모바일 앱이 실행 중인 페이지*를 구현합니다.   **AddMobileAppHomeController** 확장 메서드를 호출하여 구성에 추가합니다.
...
* [Microsoft.Azure.Mobile.Server.CrossDomain](http://www.nuget.org/packages/Microsoft.Azure.Mobile.Server.CrossDomain/)
   모바일 앱에서 레거시 웹 브라우저에 데이터를 제공하는 컨트롤러를 만듭니다.   **MapLegacyCrossDomainController** 확장 메서드를 호출하여 구성에 추가합니다.
* [Microsoft.Azure.Mobile.Server.Login] 은 사용자 지정 인증 시나리오 동안 사용되는 정적 메서드인 AppServiceLoginHandler.CreateToken() 메서드를 제공합니다.   

## <a name="a-namepublish-server-projectahow-to-publish-the-server-project"></a><a name="publish-server-project"></a>방법: 서버 프로젝트 게시
...
## <a name="a-namedefine-table-controllera-how-to-define-a-table-controller"></a><a name="define-table-controller"></a> 방법: 테이블 컨트롤러 정의
...
### <a name="a-nameadd-authahow-to-add-authentication-to-a-server-project"></a><a name="add-auth"></a>방법: 서버 프로젝트에 인증 추가
...
### <a name="a-namecustom-authahow-to-use-custom-authentication-for-your-application"></a><a name="custom-auth"></a>방법: 응용 프로그램에 사용자 지정 인증 사용
...
### <a name="a-nameuser-infoahow-to-retrieve-authenticated-user-information"></a><a name="user-info"></a>방법: 인증된 사용자 정보 검색
...
### <a name="a-nameauthorizeahow-to-restrict-data-access-for-authorized-users"></a><a name="authorize"></a>방법: 인증된 사용자에 대한 데이터 액세스 제한
...
## <a name="a-nametagsahow-to-enable-targeted-push-using-tags"></a><a name="tags"></a>방법: 태그를 사용하여 대상 지정 푸시 활성화
...
예제는 빠른 시작 샘플에서 완료된 App Service Mobile Apps에서 [클라이언트 추가 푸시 알림 태그][5]를 참조하세요.

## <a name="a-namepush-userahow-to-send-push-notifications-to-an-authenticated-user"></a><a name="push-user"></a>방법: 인증된 사용자에게 푸시 알림 보내기
...
인증된 클라이언트의 푸시 알림을 등록할 때 등록을 시도하기 전에 인증이 완료되었는지 확인합니다. 자세한 내용은 .NET 백 엔드에 대한 App Service Mobile Apps가 완료된 빠른 시작 샘플에서 [사용자에게 푸시 알림 보내기][6]를 참조하세요.
...
### <a name="a-namelocal-debugalocal-debugging-with-authentication"></a><a name="local-debug"></a>인증을 사용하여 로컬 디버깅
