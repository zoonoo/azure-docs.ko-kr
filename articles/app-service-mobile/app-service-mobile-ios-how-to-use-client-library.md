...
## <a name="a-namecreate-clientahow-to-create-client"></a><a name="create-client"></a>방법: 클라이언트 만들기
...
## <a name="a-nametable-referenceahow-to-create-table-reference"></a><a name="table-reference"></a>방법: 테이블 참조 만들기
...
## <a name="a-namequeryingahow-to-query-data"></a><a name="querying"></a>방법: 데이터 쿼리
...
## <a name="a-namequery-objectahow-to-use-msquery"></a><a name="query-object"></a>방법: MSQuery 사용
...
## <a name="a-namesortingahow-to-sort-data-with-msquery"></a><a name="sorting"></a>방법: MSQuery를 사용하여 데이터 정렬
...
## <a name="a-nameselectingaa-nameparametersahow-to-limit-fields-and-expand-query-string-parameters-with-msquery"></a><a name="selecting"></a><a name="parameters"></a>방법: MSQuery를 사용하여 필드 제한 및 쿼리 문자열 매개 변수 확장
...
## <a name="a-namepagingahow-to-configure-page-size"></a><a name="paging"></a>방법: 페이지 크기 구성
...
## <a name="a-nametemplatesahow-to-register-push-templates-to-send-cross-platform-notifications"></a><a name="templates"></a>방법: 플랫폼 간 알림을 보내기 위해 푸시 템플릿 등록
...
## <a name="a-nametwitter-fabricahow-to-authenticate-users-with-twitter-fabric-for-ios"></a><a name="twitter-fabric"></a>방법: iOS용 Twitter Fabric을 사용하여 사용자 인증
...
## <a name="a-namegoogle-sdkahow-to-authenticate-users-with-the-google-sign-in-sdk-for-ios"></a><a name="google-sdk"></a>방법: iOS용 Google 로그인 SDK를 사용하여 사용자 인증
