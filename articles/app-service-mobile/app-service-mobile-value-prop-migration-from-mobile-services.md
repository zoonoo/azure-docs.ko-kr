...
##SaaS API에 *모바일 앱* 연결
*Azure 앱 서비스*를 사용하면 Office 365, Dynamics, Salesforce, SAP 등을 비롯한 SaaS API에 모바일 앱을 쉽게 연결할 수 있습니다. *Azure 앱 서비스*는 사용자 대신 턴키 인증을 제공하며 개별 SaaS API에 대한 토큰을 기본 ID와 연결하여 사용하는 모든 SaaS API에서 진정한 Single Sign On을 수행할 수 있게 해줍니다.
