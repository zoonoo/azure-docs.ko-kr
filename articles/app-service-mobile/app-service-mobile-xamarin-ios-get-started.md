---
title: Xamarin.iOS 앱용 Azure 앱 서비스 모바일 앱 시작 | Microsoft Docs
...
> [!NOTE]
> Azure 계정을 등록하기 전에 Azure 앱 서비스를 시작하려는 경우 [앱 서비스 평가](https://tryappservice.azure.com/?appServiceName=mobile)로 이동하세요. 여기서 신용 카드와 약정 없이 앱 서비스에서 수명이 짧은 스타터 모바일 앱을 즉시 만들 수 있습니다.
> 
> 
