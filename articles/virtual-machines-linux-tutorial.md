...
- [Azure의 Linux 소개](http://azure.microsoft.com/documentation/articles/introduction-linux/)

- [Mac 및 Linux에서 Azure 명령줄 도구를 사용하는 방법](http://azure.microsoft.com/documentation/articles/xplat-cli/)
