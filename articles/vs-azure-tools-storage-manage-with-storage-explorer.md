...
1. 기본 엔드포인트에서 수신 대기하도록 선택한 에뮬레이터를 구성합니다.
...
3. Storage 탐색기의 왼쪽 창에서 **(로컬 및 연결된)** > **Storage 계정** > **(개발)** 노드를 확장합니다.
...
> [!NOTE]
> Storage 탐색기는 기본 엔드포인트를 사용하여 로컬 에뮬레이터에 대한 연결만 지원합니다. 에뮬레이터를 시작하는 경우 기본 엔드포인트만 구성하는지 확인합니다.
