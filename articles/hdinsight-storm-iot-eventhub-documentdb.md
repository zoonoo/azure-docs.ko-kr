<properties
 pageTitle="Azure 이벤트 허브 및 HDInsight의 Apache Storm을 사용하여 차량 센서 데이터 처리"
 description="HDInsight의 Apache Storm을 사용하여 Azure 이벤트 허브에서 차량 센서 데이터를 처리하는 방법에 대해 알아봅니다. 처리하는 동안 DocumentDB에서 차량 모델 정보를 조회하여 데이터가 보강됩니다. 데이터는 최종적으로 Azure 저장소에 기록됩니다."
 services="hdinsight"
 documentationCenter=""
 authors="Blackmist"
 manager="paulettm"
...
# HDInsight의 Apache Storm을 사용하여 Azure 이벤트 허브에서 센서 데이터 처리
...
![아키텍처 다이어그램](./media/hdinsight-storm-iot-eventhub-documentdb/iot.png)
