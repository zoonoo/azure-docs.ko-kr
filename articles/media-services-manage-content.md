...
4.  Azure 미디어 인코더 대화 사자에서 일반 또는 고급 인코딩 기본 설정 중 하나를 선택합니다.
    ...
    **고급 기본 설정**
    ...
    -   [Azure 미디어 인코더에 대한 작업 기본 설정 문자열](http://go.microsoft.com/fwlink/?LinkId=270865) 항목에서는 고급 기본 설정 목록에 포함된 각 기본 설정의 의미를 설명합니다.

    ![EncoderDialog](./media/media-services-manage-content/EncoderDialog2.png)

    현재 포털에서는 미디어 인코더가 지원하는 일부 인코딩 형식을 지원하지 않습니다. 또한 미디어 자산 암호화/암호 해독을 지원하지 않습니다. 이러한 작업은 프로그래밍 방식으로 수행할 수 있습니다. 자세한 내용은 [Media Services SDK for .NET을 사용하여 응용 프로그램 빌드](http://go.microsoft.com/fwlink/?LinkId=270866) 및 [Azure 미디어 인코더에 대한 작업 기본 설정 문자열](http://go.microsoft.com/fwlink/?LinkId=270865)을 참조하십시오.
