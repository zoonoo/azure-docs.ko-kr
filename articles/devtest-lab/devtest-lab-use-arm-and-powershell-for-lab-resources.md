...
* 사용자 지정한 템플릿 또는 스크립트를 저장할 수 있는 [개인 Git 리포지토리](devtest-lab-add-repo.md)를 만드는 방법에 대해 배웁니다.
