---
title: Azure DevTest Labs에서 랩에 Git 아티팩트 리포지토리 추가 | Microsoft Docs
...
5. 왼쪽의 **개인 설정** 메뉴에서 **개인 액세스 토큰**을 탭합니다.
6. **Generate new token**(새 토큰 생성)을 탭합니다.
7. **New personal access token**(새 개인 액세스 토큰) 페이지에서 **토큰 설명**을 입력하고 **범위 선택**에서 기본 항목을 수락한 다음 **Generate Token**(토큰 생성)을 선택합니다.
...
3. 복제 URL을 보려면 프로젝트 **코드** 페이지에서 **복제**를 탭합니다.
