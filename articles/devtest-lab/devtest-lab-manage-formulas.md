---
title: Azure DevTest Labs에서 VM을 만드는 수식 관리 | Microsoft Docs
...
> [!NOTE]
> [사용자 지정 이미지](devtest-lab-create-template.md)와 마찬가지로 수식을 사용하면 VHD 파일에서 기본 이미지를 만들 수 있습니다. 그런 다음 기본 이미지를 사용하여 새 VM을 프로비전할 수 있습니다. 사용자의 환경에 적합한 것을 결정하는 데 도움이 필요하면, [DevTest Lab에서 사용자 지정 이미지와 수식 비교](devtest-lab-comparing-vm-base-image-types.md) 문서를 참조하세요.
> 
> 
...
5. **Lab formulas**(랩 수식) 블레이드에서 **+ 추가**를 탭합니다.
...
6. **Update formula**(수식 업데이트) 블레이드에서 원하는 내용을 편집하고 **업데이트**를 탭합니다.
