---
title: 아티팩트를 사용하여 Azure DevTest Labs의 랩에 VM 추가 | Microsoft Docs
...
4. 랩의 **개요** 블레이드에서 **+ 가상 컴퓨터**를 선택합니다. ![VM 단추 추가](./media/devtest-lab-add-vm-with-artifacts/devtestlab-home-blade-add-vm.png)
...
13. **아티팩트**를 선택하고 아티팩트 목록에서 기본 이미지에 추가하려는 아티팩트를 선택하고 구성합니다. **참고:** DevTest Lab을 처음 접하거나 아티팩트를 구성 중인 경우 [VM에 기존 아티팩트 추가](#add-an-existing-artifact-to-a-vm) 섹션으로 건너뛴 다음 완료되면 여기로 돌아옵니다.
14. Azure Resource Manager 템플릿을 보거나 복사하려면 [Azure Resource Manager 템플릿 저장](#save-arm-template) 섹션으로 건너뛰어 원하는 작업을 마친 후에 여기로 다시 돌아옵니다.
