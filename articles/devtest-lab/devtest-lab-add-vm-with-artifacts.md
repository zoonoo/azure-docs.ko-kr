...
1. 랩의 블레이드에서 다음 그림에 나와 있는 대로 **+ 랩 VM**을 탭합니다. ![랩 VM 추가 단추](./media/devtest-lab-add-vm-with-artifacts/devtestlab-home-blade-add-vm.png)
...
1. **Azure Resource Manager 템플릿 블레이드 보기**에서 템플릿 텍스트를 모두 선택합니다.
