---
title: Azure DevTest Labs에서 가상 네트워크 구성 | Microsoft Docs
...
8. **가상 네트워크** 블레이드에서 **[가상 네트워크 선택]**을 탭합니다.
...
15. **저장**을 선택합니다.
16. 이제 가상 네트워크를 구성했으므로 VM을 만들 때 선택할 수 있습니다. VM을 만들고 가상 네트워크를 지정하는 방법을 확인하려면 [아티팩트를 사용하여 랩에 VM 추가](devtest-lab-add-vm-with-artifacts.md) 문서를 참조하세요.
