...
랩을 만들면 가상 네트워크의 서브넷에 상주합니다.  기본적으로 이 서브넷은 **Enable shared public IP**(공유 공용 IP 사용)을 *예*로 설정하면 생성됩니다.  이 구성은 전체 서브넷에 하나의 공용 IP 주소를 만듭니다.  [이 문서의 단계에 따라](devtest-lab-configure-vnet.md) 랩을 생성된 후 해제할 수 있습니다.
