...
1. 랩의 **설정** 블레이드의 **VM 정책** 아래에서 **Allowed VM Sizes(허용된 VM 크기)**를 탭합니다.
...
1. 랩의 **설정** 블레이드의 **VM 정책** 아래에서 **Maximum VMs per user(사용자당 최대 VM 수)**를 탭합니다.
...
1. 랩의 **설정** 블레이드의 **VM 정책** 아래에서 **Total VMs allowed(허용된 총 VM 수)**를 탭합니다.
...
1. 랩의 **설정** 블레이드의 **VM 정책** 아래에서 **Auto Shutdown(자동 종료)**을 탭합니다.
...
1. 랩의 **설정** 블레이드의 **VM 정책** 아래에서 **자동 시작**을 탭합니다.
