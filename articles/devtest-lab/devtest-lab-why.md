<properties
	pageTitle="DevTest Lab을 선택해야 하는 이유 | Microsoft Azure"
...
> [AZURE.NOTE]
이 문서는 세 파트로 구성된 시리즈의 파트 2입니다.
> 
> 1. [DevTest Lab이란?](devtest-lab-overview.md)
> 1. **[DevTest Lab을 선택해야 하는 이유](devtest-lab-why.md)**
> 1. [DevTest Lab 개념](devtest-lab-concepts.md)
