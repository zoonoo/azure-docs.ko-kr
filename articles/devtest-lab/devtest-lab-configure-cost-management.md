<properties
	pageTitle="Azure DevTest Labs에서 월간 예상 랩 비용 추세 보기 | Microsoft Azure"
...
# Azure DevTest Labs에서 월간 예상 랩 비용 추세 보기
...
1. 랩의 블레이드에서 **비용 설정**을 선택합니다.

1. 랩의 **비용 설정** 블레이드에서 **랩 비용 추세**를 선택합니다.
...
- [마켓플레이스 이미지 구성](./devtest-lab-configure-marketplace-images.md) - DevTest Labs에서는 Azure Marketplace 이미지를 기준으로 VM을 만들 수 있습니다. 이 문서에서는 랩에서 VM을 만들 때 사용할 수 있는 Azure 마켓플레이스 이미지(있는 경우)를 지정하는 방법을 보여 줍니다.
