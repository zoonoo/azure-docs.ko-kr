---
title: DevTest Lab VM에 대한 사용자 지정 아티팩트 만들기 | Microsoft Docs
...
2. 샘플 artifactfile.json 가져오기 - 다양한 아티팩트 라이브러리를 만들어 놓은 [GitHub 리포지토리](https://github.com/Azure/azure-devtestlab)에서 Azure DevTest Lab 팀이 만든 아티팩트를 확인합니다. 이러한 아티팩트는 사용자 고유 아티팩트를 만드는 데 도움이 됩니다. 아티팩트 정의 파일을 다운로드하고 변경하여 사용자 고유 아티팩트를 만들 수 있습니다.
...
5. 랩에 아티팩트 리포지토리 추가 - [랩에 Git 아티팩트 리포지토리 추가](devtest-lab-add-artifact-repo.md) 문서를 참조하세요.
