...
description: "Azure DevTest Labs에서 사용자 지정 아티팩트 원본 또는 Azure Resource Manager 템플릿용 GitHub 또는 Visual Studio Team Services Git 리포지토리 추가"
...
---
# <a name="add-a-git-repository-to-store-custom-artifacts-and-azure-resource-manager-templates-for-use-in-azure-devtest-labs"></a>Azure DevTest Labs에서 사용하기 위한 사용자 지정 아티팩트 및 Azure Resource Manager 템플릿을 저장할 Git 리포지토리 추가
...
5. 랩의 **구성 및 정책** 블레이드에서 **리포지토리**를 선택합니다.
6. **리포지토리** 블레이드에서 **+ 추가**를 선택합니다.

    ![리포지토리 추가 버튼](./media/devtest-lab-add-repo/devtestlab-add-repo.png)
7. 두 번째 **리포지토리** 블레이드에서 다음을 지정합니다.
   ...
   * **폴더 경로** - 아티팩트 또는 Azure Resource Manager 템플릿 정의가 포함된 복제 URL에 상대적인 폴더 경로를 하나 이상 입력합니다. 하위 디렉터리를 지정하는 경우 폴더 경로에 슬래시를 포함해야 합니다.
     ...
     ![리포지토리 블레이드](./media/devtest-lab-add-repo/devtestlab-repo-blade.png)
8. **저장**을 선택합니다.
