<properties urlDisplayName="Azure Cross-Platform Command-Line Interface" pageTitle="Azure 플랫폼 간 명령줄 인터페이스" title="Azure 플랫폼 간 명령줄 인터페이스" metaKeywords="Azure 플랫폼 간 명령줄 인터페이스, Azure 명령줄, azure 명령줄, azure cli" description="Install and configure the Azure Cross-Platform Command-Line Interface to manage Azure Services" metaCanonical="http://www.windowsazure.com/ko-kr/script/xplat-cli-intro" umbracoNaviHide="0" disqusComments="1" editor="mollybos" manager="need to identify contact" documentationCenter="" solutions="" authors="carolz" services="" />
