<properties 
	pageTitle="Azure 웹 사이트의 엔터프라이즈급 WordPress" 
	description="Azure 웹 사이트에서 엔터프라이즈급 WordPress 사이트를 호스트하는 방법에 대해 알아봅니다." 
	services="web-sites" 
	documentationCenter="" 
	authors="tfitzmac" 
	manager="wpickett" 
...
**캐시 리소스** | [Redis 캐시][rediscache], [Memcache 클라우드](http://azure.microsoft.com/ko-kr/gallery/store/garantiadata/memcached/), [MemCachier](http://azure.microsoft.com/ko-kr/gallery/store/memcachier/memcachier/) 또는 [Azure 스토어](http://azure.microsoft.com/ko-kr/gallery/store/)에 제공되는 기타 캐싱 서비스 중 하나
...
* **수동 마이그레이션** - [사이트][wordpressbackup] 및 [데이터베이스][wordpressdbbackup]를 백업한 다음 Azure 웹 사이트 및 관련 MySQL 데이터베이스에 수동으로 복원하여 고가용성 사이트를 마이그레이션하고, 플러그 인, 테마 및 사용자 지정 내용을 수동으로 설치하는 번거로움을 피할 수 있습니다.
...
4. 새 웹 사이트를 만들고 WordPress 백업을 게시합니다.
	...
	1. **새로 만들기** -> **웹 사이트** -> **사용자 지정 만들기**를 사용하여 데이터베이스로 [Azure 관리 포털][mgmtportal]에서 새 웹 사이트를 만듭니다. 이렇게 하면 빈 사이트가 만들어집니다.
...
* [WordPress 사이트를 멀티 사이트로 변환](http://azure.microsoft.com/ko-kr/documentation/articles/web-sites-php-convert-wordpress-multisite/)

* [Azure용 ClearDB 업그레이드 마법사](http://www.cleardb.com/store/azure/upgrade)

* [Azure 웹 사이트의 하위 폴더에 WordPress 호스트](http://blogs.msdn.com/b/webapps/archive/2013/02/13/hosting-wordpress-in-a-subfolder-of-your-windows-azure-web-site.aspx)
...
* [WordPress에서 멋진 permalinks 사용](http://www.iis.net/learn/extensions/url-rewrite-module/enabling-pretty-permalinks-in-wordpress)

* [Azure 웹 사이트에서 WordPress 블로그를 마이그레이션 및 실행하는 방법](http://www.kefalidis.me/2012/06/how-to-migrate-and-run-your-wordpress-blog-on-windows-azure-websites/)

* [Azure 웹 사이트에서 무료로 WordPress를 실행하는 방법](http://architects.dzone.com/articles/how-run-wordpress-azure)
...
* [Azure 계정에서 WordPress 웹 사이트를 설정하는 방법](http://www.itexperience.net/2014/01/20/how-to-set-up-a-wordpress-website-in-your-windows-azure-account/)
