...
## <a name="memory-size"></a>메모리 크기
현재 함수 앱에서 함수에 대해 할당할 메모리 양을 구성할 수 있습니다. 

메모리를 구성하려면 원하는 메모리 양으로 슬라이더를 밉니다. 최대 128MB입니다.

![함수 앱 메모리 크기 구성](./media/functions-how-to-use-azure-function-app-settings/configure-function-app-memory-size.png)
...
3. 사용할 수 있는 배포 소스인 Visual Studio Team Services, OneDrive, 로컬 Git 리포지토리, GitHub, Bitbucket, DropBox 또는 외부 리포지토리 중 하나를 클릭하여 선택합니다. 
    ...
    ![앱 함수의 CI 구성](./media/functions-how-to-use-azure-function-app-settings/configure-function-ci.png)
...
![앱 함수의 CI 구성](./media/functions-how-to-use-azure-function-app-settings/configure-function-app-authentication.png)
...
![앱 함수의 CORS 구성](./media/functions-how-to-use-azure-function-app-settings/configure-function-app-cors.png)
...
![앱 함수의 API 구성](./media/functions-how-to-use-azure-function-app-settings/configure-function-app-apidef.png)
...
## <a name="in-portal-console"></a>포털 내 콘솔
