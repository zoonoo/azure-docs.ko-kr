...
>__How to use it:__ Create a Linux function app in the Premium or Dedicated plan and specify which container image to run from. 다음 두 가지 방법으로 수행할 수 있습니다.
>
...
>__How to use it:__ Use Deployment Center in the Functions area of the portal to set up publishing from source control. 자세한 내용은 [Azure Functions에 대한 연속 배포](functions-continuous-deployment.md)를 참조하세요.
