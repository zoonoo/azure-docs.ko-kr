...
### <a name="enabling-functions-20"></a>함수 2.0 사용

바인딩 확장은 Azure Functions 2.0 에서만 사용할 수 있습니다. 

함수 런타임의 2.0 버전을 사용 하도록 함수 앱을 설정 하는 방법에 대 한 자세한 내용은 [Azure Functions 런타임 버전을 대상으로 하는 방법](set-runtime-version.md)을 참조 하세요.
