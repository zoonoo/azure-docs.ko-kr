---
title: "Azure Storage에 대한 Azure Functions 트리거 및 바인딩 | Microsoft Docs"
...
---
# <a name="azure-functions-triggers-and-bindings-for-azure-storage"></a>Azure 저장소에 대한 Azure Functions 트리거 및 바인딩
...
## <a name="a-idstoragequeuetriggera-azure-storage-queue-trigger"></a><a id="storagequeuetrigger"></a> Azure 저장소 큐 트리거
#### <a name="functionjson-for-storage-queue-trigger"></a>저장소 큐 트리거에 대한 function.json
...
#### <a name="queue-trigger-supported-types"></a>큐 트리거를 지원하는 형식
...
## <a name="a-idstoragequeueoutputa-azure-storage-queue-output-binding"></a><a id="storagequeueoutput"></a> Azure 저장소 큐 출력 바인딩
#### <a name="functionjson-for-storage-queue-output-binding"></a>저장소 큐 출력 바인딩에 대한 function.json 예제
*function.json* 파일은 다음 속성을 지정합니다.
...
#### <a name="queue-output-binding-supported-types"></a>큐 출력 바인딩을 지원하는 형식
...
#### <a name="queue-output-binding-code-examples"></a>큐 출력 바인딩 코드 예제
...
이 C# 코드 예제는 `ICollector<T>`을 사용하여 여러 메시지를 작성합니다(비동기 함수의 `IAsyncCollector<T>`을 사용).
...
## <a name="a-idstorageblobtriggera-azure-storage-blob-trigger"></a><a id="storageblobtrigger"></a> Azure 저장소 Blob 트리거
#### <a name="functionjson-for-storage-blob-trigger"></a>저장소 Blob 트리거에 대한 function.json
*function.json* 파일은 다음 속성을 지정합니다.
...
#### <a name="blob-trigger-supported-types"></a>Blob 트리거를 지원하는 형식
...
#### <a name="blob-trigger-c-code-example"></a>Blob 트리거 C# 코드 예제
...
#### <a name="blob-trigger-name-patterns"></a>Blob 트리거 이름 패턴
...
파일 확장명에 대한 고정된 값으로 패턴을 지정하여 함수를 트리거하는 Blob의 종류를 제한할 수 있습니다. `path`를 *samples/{name}.png*로 설정하는 경우 *samples* 컨테이너의 *.png* Blob만 함수를 트리거합니다.
...
* FunctionId(형식 *{함수 앱 이름}*.Functions.*{함수 이름}*)
...
## <a name="a-idstorageblobbindingsa-azure-storage-blob-input-and-output-bindings"></a><a id="storageblobbindings"></a> Azure 저장소 Blob 입력 및 출력 바인딩
#### <a name="functionjson-for-a-storage-blob-input-or-output-binding"></a>저장소 Blob 입력 또는 출력 바인딩에 대한 function.json 예제
*function.json* 파일은 다음 속성을 지정합니다.
...
#### <a name="blob-input-and-output-supported-types"></a>Blob 입력 및 출력을 지원하는 형식
...
#### <a name="blob-output-c-code-example"></a>Blob 출력 C# 코드 예제
...
## <a name="a-idstoragetablesbindingsa-azure-storage-tables-input-and-output-bindings"></a><a id="storagetablesbindings"></a> Azure 저장소 테이블 입력 및 출력 바인딩
#### <a name="functionjson-for-storage-tables"></a>저장소 테이블에 대한 function.json
...
#### <a name="storage-tables-input-and-output-supported-types"></a>저장소 테이블 입력 및 출력 지원 형식
...
#### <a name="storage-tables-binding-scenarios"></a>저장소 테이블 바인딩 시나리오
...
#### <a name="storage-tables-example-read-a-single-table-entity-in-c-or-node"></a>Storage 테이블 예제: C# 또는 노드에서 단일 테이블 엔터티 읽기
...
#### <a name="storage-tables-example-read-multiple-table-entities-in-c"></a>Storage 테이블 예제: C에서 여러 테이블 엔터티 읽기
...
#### <a name="storage-tables-example-create-table-entities-in-c"></a>Storage 테이블 예제: C로 테이블 엔터티 만들기
...
#### <a name="storage-tables-example-create-table-entities-in-f"></a>Storage 테이블 예제: F에서 테이블 엔터티 만들기
...
#### <a name="storage-tables-example-create-a-table-entity-in-node"></a>Storage 테이블 예제: Node에서 테이블 엔터티 만들기
