...
이 문서에서는 Maven 명령줄 도구를 사용하여 Java 함수를 만들고 Azure Functions에 게시하는 방법을 설명합니다. 완료되면 함수 코드가 Azure의 [사용 플랜](functions-scale.md#consumption-plan)에서 실행되고 HTTP 요청을 사용하여 트리거될 수 있습니다.
