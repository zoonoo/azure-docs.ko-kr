...
이 퀵 스타트에서는 Maven을 사용하여 서버 없는 함수 프로젠트를 만들어 로컬로 테스트하고 Azure Functions에 배포하는 과정을 안내합니다. 마친 후에는 Azure에서 HTTP 트리거 함수 앱이 실행됩니다.
...
-  [Java Developer Kit](https://www.azul.com/downloads/zulu/) 버전 1.8
