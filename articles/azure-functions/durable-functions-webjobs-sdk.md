...
2. .NET Core 구성 프레임워크를 사용하여 *appsettings.json* 파일에서 저장소 연결 문자열 및 Application Insights 계측 키를 가져오도록 `Main` 메서드 코드를 변경합니다.  예를 들면 다음과 같습니다.
