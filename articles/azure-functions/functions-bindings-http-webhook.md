...
HTTP 요청을 통해 Azure Functions를 호출하여 서버리스 API를 빌드하고 [웹후크](https://en.wikipedia.org/wiki/Webhook)에 응답할 수 있습니다.
...
이 문서의 코드는 Functions 버전 2.x 이상에서 사용되는 .NET Core 구문을 기본값으로 사용합니다. 1.x 구문에 대한 자세한 내용은 [1.x 기능 템플릿](https://github.com/Azure/azure-functions-templates/tree/v1.x/Functions.Templates/Templates)을 참조하세요.
