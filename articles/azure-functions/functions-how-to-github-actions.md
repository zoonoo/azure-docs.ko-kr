...
| 섹션 | 작업 |
| ------- | ----- |
| **인증** | <ol><li>Define a service principal.</li><li>Download publishing profile.</li><li>Create a GitHub secret.</li></ol>|
| **빌드** | <ol><li>Set up the environment.</li><li>함수 앱을 빌드합니다.</li></ol> |
| **배포** | <ol><li>Deploy the function app.</li></ol>|
