---
title: Azure Functions에서 Python ModuleNotFoundError 문제 해결
description: Python 함수에서 Azure Functions 모듈을 찾을 수 없음 오류 문제를 해결하는 방법에 대해 알아봅니다.
author: Hazhzeng
ms.topic: article
ms.date: 05/12/2020
ms.author: hazeng
...
ms.locfileid: "84554749"
---
# <a name="troubleshoot-python-module-errors-in-azure-functions"></a>Azure Functions에서 Python 모듈 오류 문제 해결

이 문서는 Python 함수 앱에서 모듈 관련 오류 문제를 해결하는 데 도움이 됩니다. 이러한 오류는 일반적으로 다음과 같은 Azure Functions 오류 메시지를 생성합니다.
...
모듈 관련 문제를 해결할 수 없는 경우 함수 팀에 보고해주세요.
