...
|Event Grid은 Blob Storage에서 이미지를 읽고 Cosmos DB의 문서에서 전자 메일을 보내는 데 사용 됩니다. | 이벤트 표 | Blob Storage 및 Cosmos DB | SendGrid |
...
|-------------|--------------------------------------------|
| C#클래스 라이브러리 | &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;특성을 사용 하 여 C# 메서드 및 매개 변수 장식 |
