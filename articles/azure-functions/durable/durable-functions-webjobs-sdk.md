...
연결 Durable Functions 샘플은 WebJobs SDK 2.x 버전에서 사용할 수 있습니다. [Durable Functions 리포지토리](https://github.com/azure/azure-functions-durable-extension/)를 다운로드 하거나 복제 하 고 *샘플\\webjobssdk\\* 연결 폴더로 이동 합니다.
...
1. 프로젝트를 로컬로 실행할 때 Application Insights의 로그를 보려면 다음을 수행 합니다.
    ...
    가. Application Insights 리소스를 만들고 해당 리소스에 대 한 **일반** 앱 유형을 사용 합니다.
