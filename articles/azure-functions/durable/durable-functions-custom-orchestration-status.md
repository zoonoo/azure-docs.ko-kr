...
ms.locfileid: "76261656"
---
# <a name="custom-orchestration-status-in-durable-functions-azure-functions"></a>지속성 함수의 사용자 지정 오케스트레이션 상태(Azure Functions)

사용자 지정 오케스트레이션 상태를 사용하면 오케스트레이터 함수의 사용자 지정 상태 값을 설정할 수 있습니다. 이 상태는 오케스트레이션 클라이언트에서 [HTTP GETSTATUS api](durable-functions-http-api.md#get-instance-status) 또는 [`GetStatusAsync` api](durable-functions-instance-management.md#query-instances) 를 통해 제공 됩니다.
