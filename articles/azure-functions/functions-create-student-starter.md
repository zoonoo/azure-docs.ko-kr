...
이 자습서에서는 학생용 Azure 스타터 구독에서 "hello 세계" HTTP 함수를 만듭니다. 또한 이 구독 형식의 Azure Functions에서 사용할 수 있는 기능도 알아봅니다.
...
## <a name="create-a-function"></a>함수 만들기
 ...
 이 문서에서는 Azure Functions를 사용 하 여 Azure Portal에서 "hello 세계" HTTP 트리거 함수를 만드는 방법에 대해 알아봅니다.
...
학생용 Azure 스타터에서 다음과 같은 몇 가지 주요 제한 사항을 사용 하 여 Azure Functions 런타임의 대부분 기능에 액세스할 수 있습니다.
...
* 확장은 매일 최대 60분 동안 실행되는 [하나의 무료 계층 인스턴스](https://azure.microsoft.com/pricing/details/app-service/windows/)로 제한됩니다. HTTP 트래픽이 수신 될 때 0 개에서 1 개의 인스턴스로 자동으로 크기를 serverlessly 수 있습니다.
* Functions 런타임의 [버전 2.x 이상](functions-versions.md)만 지원됩니다.
* 모든 개발자 도구는 함수 편집 및 게시를 지원합니다. 여기에는 VS Code, Visual Studio, Azure CLI 및 Azure Portal이 포함됩니다. 포털 이외의 항목을 사용 하려면 먼저 포털에서 앱을 만든 다음 원하는 도구에서 해당 앱을 배포 대상으로 선택 해야 합니다.

## <a name="next-steps"></a>다음 단계

이제 간단한 HTTP 트리거 함수로 함수 앱을 만들었습니다. 다음으로, 로컬 도구, 추가 언어, 모니터링 및 통합을 탐색할 수 있습니다.

 * [Visual Studio를 사용하여 첫 번째 함수 만들기](./functions-create-your-first-function-visual-studio.md)
 * [Visual Studio Code를 사용 하 여 첫 번째 함수 만들기](./functions-create-first-function-vs-code.md)
