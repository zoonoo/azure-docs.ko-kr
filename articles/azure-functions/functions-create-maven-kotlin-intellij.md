---
title: Kotlin 및 IntelliJ를 사용하여 Azure 함수 만들기
description: Kotlin 및 IntelliJ로 Azure에서 간단한 HTTP 트리거 서버리스 앱을 만들고 게시하는 방법을 알아봅니다.
author: dglover
...
이 문서에서는 IntelliJ IDEA 및 Apache Maven을 사용하여 [서버리스](https://azure.microsoft.com/overview/serverless-computing/) 함수 프로젝트를 만드는 방법을 보여줍니다. 또한 IDE(통합 개발 환경)에서 함수 코드를 로컬로 디버깅한 다음, 함수 프로젝트를 Azure에 배포하는 방법을 보여줍니다.

[!INCLUDE [quickstarts-free-trial-note](../../includes/quickstarts-free-trial-note.md)]

## <a name="set-up-your-development-environment"></a>개발 환경 설정

Kotlin 및 IntelliJ를 사용하여 함수를 개발하려면 다음 소프트웨어를 설치합니다.
...
1. 설정이 끝나면 **디버그 < 원격 구성 이름 >** 를 선택하거나 키보드에서 Shift+F9를 눌러 디버깅을 시작합니다.
   ...
   ![IntelliJ에서 함수 디버깅](media/functions-create-first-kotlin-intellij/debug-configuration-intellij.PNG)
...
이제 첫 번째 Kotlin 함수를 Azure에 배포했으므로 Java 함수 및 Kotlin 함수 개발에 대한 자세한 내용은 [Java Functions 개발자 가이드](functions-reference-java.md)를 검토하세요.
