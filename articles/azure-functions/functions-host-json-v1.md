...
모든 함수에 대한 시간 제한 기간을 나타냅니다. 서버리스 사용 계획에서 유효한 범위는 1초에서 10분 사이이고 기본값은 5분입니다. In an App Service plan, there is no overall limit and the default is _null_, which indicates no timeout.
