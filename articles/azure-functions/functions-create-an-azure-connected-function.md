<properties
   pageTitle="Azure 서비스를 바인딩하는 Azure Function 만들기 | Microsoft Azure"
...
# Azure 서비스를 바인딩하는 Azure Function 만들기
   
[AZURE.INCLUDE [시작 메모](../../includes/functions-getting-started.md)]
