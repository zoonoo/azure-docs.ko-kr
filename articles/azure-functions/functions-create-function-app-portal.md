...
Azure Functions에는 다음과 같은 세 가지 서비스 계획이 있습니다. 소비 계획, 프리미엄 계획 및 전용 (App Service) 계획을 사용 합니다. 함수 앱을 만들 때 서비스 계획을 선택 해야 하며 이후에는 변경할 수 없습니다. 자세한 내용은 [Azure Functions 호스팅 계획 선택](functions-scale.md)을 참조하세요.
