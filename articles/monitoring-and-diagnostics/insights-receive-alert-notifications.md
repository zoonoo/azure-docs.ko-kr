---
title: "Azure 서비스에 대한 경고 알림 받기 | Microsoft 문서"
...
---
# <a name="receive-alert-notifications"></a>경고 알림 받기
...
## <a name="managing-your-alert-rules"></a>경고 규칙 관리
...
* [알림에서 Webhook](insights-webhooks-alerts.md) 구성
