...
메트릭 및 메트릭 경고에 대한 자세한 내용은 [Azure Monitor 메트릭 개요](../monitoring/monitoring-data-collection.md) 및 [Azure Monitor 경고 개요](./monitoring-overview-alerts.md)를 참조하세요. 
