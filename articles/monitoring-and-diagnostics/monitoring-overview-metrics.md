...
> [!NOTE]
> 추가적인 진단 설정 없이 VM(Azure Resource Manager 기반) 및 VM 규모 설정에서 호스트 설정 메트릭에 액세스할 수 있습니다. 이러한 호스트 수준 메트릭은 Windows 및 Linux 인스턴스에서 사용할 수 있습니다. 이러한 메트릭을 VM 또는 VMSS에서 Azure Diagnostics를 사용할 때 액세스할 수 있는 게스트 OS 수준 메트릭과 혼동해서는 안 됩니다. Azure Diagnostics 구성에 대한 자세한 내용은 [Microsoft Azure Diagnostics이란?](../azure-diagnostics.md)을 참조하세요.
> 
> 
