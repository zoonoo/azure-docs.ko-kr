<properties
    pageTitle="PowerShell을 사용하여 Azure 서비스에 경고 만들기| Microsoft Azure"
...
7. 활동 로그의 특정 조건에 대해 트리거되는 경고를 만들려면 다음 형태의 명령을 사용합니다.
...
8. 개별 규칙을 살펴서 경고가 제대로 만들어졌는지 확인합니다.
...
9. 경고를 삭제합니다. 이 명령은 이 문서의 앞에서 만든 규칙을 삭제합니다.
