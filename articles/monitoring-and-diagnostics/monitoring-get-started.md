...
2. **모니터** 옵션을 클릭하여 **모니터** 페이지를 엽니다. 이 페이지에 모든 모니터링 설정과 데이터가 하나의 보기로 통합됩니다. 먼저 **개요** 섹션을 엽니다. 개요에서는 구독에 있는 리소스에 관련된 모든 모니터링 경고, 오류 및 서비스 상태 권고의 롤업을 보여줍니다.  
