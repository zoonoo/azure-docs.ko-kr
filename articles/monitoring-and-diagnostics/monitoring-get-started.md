<properties
    pageTitle="Azure Monitor 시작 | Microsoft Azure"
...
2. **모니터** 옵션을 클릭하여 **모니터** 블레이드를 엽니다. 이 블레이드에서는 모든 모니터링 설정과 데이터를 하나의 통합 보기로 모읍니다. 처음에는 **활동 로그** 섹션이 열립니다.
    ...
    > [AZURE.WARNING] 표시되는 **서비스 알림** 및 **알림 그룹** 옵션은 비공개 미리 보기이며 비공개 미리 보기에 가입한 사용자에게만 표시됩니다.
...
8. 사용자가 리소스를 선택하면 모든 사용 가능한 메트릭이 블레이드의 왼쪽에 표시됩니다. 메트릭을 선택하고 그래프 형식 및 시간 범위를 수정하면 여러 메트릭을 한 번에 차트로 표시할 수 있습니다. 이 리소스에 대해 설정한 모든 메트릭 경로도 확인할 수 있습니다.
    ...
    > [AZURE.NOTE] 일부 메트릭은 리소스에 대해 [Application Insights](../application-insights/app-insights-overview.md) 를 활성화한 경우에만 사용할 수 있습니다.
