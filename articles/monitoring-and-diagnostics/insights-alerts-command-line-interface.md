---
title: "CLI(플랫폼 간 명령줄 인터페이스)를 사용하여 Azure 서비스에 대한 경고 만들기 | Microsoft 문서"
...
---
# <a name="use-the-cross-platform-command-line-interface-cli-to-create-alerts-for-azure-services"></a>플랫폼 간 명령줄 인터페이스(CLI)를 사용하여 Azure 서비스에 대한 경고 만들기
