...
* [Resource Manager 템플릿을 사용하여 활동 로그 경고를 만들](alert-activity-log.md) 수 있습니다.
...
* [Resource Manager 템플릿을 사용하여 경고를 만드는 방법](alert-activity-log.md)을 알아봅니다.
