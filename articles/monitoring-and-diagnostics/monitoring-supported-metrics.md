<properties
    pageTitle="Azure Monitor 메트릭 - 리소스 유형별 지원 메트릭 | Microsoft Azure"
...
> [AZURE.NOTE] 레거시 API를 통해서 또는 포털에서 다른 메트릭을 제공할 수 있습니다. 이 목록에는 통합 Azure Monitor 메트릭 파이프라인의 공개 미리 보기를 통해 사용할 수 있는 공개 미리보기 메트릭만 포함됩니다.
