...
## <a name="overview"></a>개요
 ...
 - **활동 로그 경고에 대한 통합된 작성 환경** - 이제 **모니터** > **경고(미리 보기)**에서 활동 로그 경고를 직접 만들 수 있습니다. 이전에는 **모니터** > **활동 로그**를 통해서만 만들 수 있었습니다.
...
- **신호** - 신호는 대상 리소스에 의해 발생되며 여러 유형일 수 있습니다. 이 미리 보기는 신호 형식으로 **메트릭**, **활동 로그**, **Application Insights** 및 **로그**를 지원합니다.
...
| 로그  | 활동 로그 | 이 범주는 선택한 대상(리소스/리소스 그룹/구독)을 통해 수행된 모든 Create, Update 및 Delete 작업의 레코드를 포함합니다. |
| 로그  | Service Health 로그 | 경고(미리 보기) 환경에서 지원되지 않습니다.   |
