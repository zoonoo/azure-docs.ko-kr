...
description: 이 문서에서는 Azure 포털을 사용하여 릴레이 네임스페이스를 만드는 방법을 보여 주는 연습문을 제공합니다.
...
1. Azure Portal(이 문서).
2. [Azure 리소스 관리자](../azure-resource-manager/management/overview.md) 템플릿입니다.
