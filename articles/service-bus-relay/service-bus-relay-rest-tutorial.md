...
4. `<services>` 요소 다음으로 다음과 같은 콘텐츠로 `<behaviors>` 요소를 만들고, "SAS\_KEY"를 [Azure 포털][]로부터 이전에 확보한 *공유 액세스 서명*(SAS) 키로 대체합니다.
...
- [Azure 서비스 버스 아키텍처 개요](../service-bus/service-bus-fundamentals-hybrid-solutions.md#relays)
