...
이 자습서에서는 [Azure Relay Hybrid Connections](relay-what-is-it.md#hybrid-connections)를 소개하고 .NET을 사용하여 메시지를 해당 수신기 응용 프로그램으로 보내는 클라이언트 응용 프로그램을 만드는 방법을 보여 줍니다. 
...
2. Azure Portal을 사용하여 해당 네임스페이스에서 하이브리드 연결을 만듭니다.
