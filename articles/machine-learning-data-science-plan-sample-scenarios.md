<properties
	pageTitle="클라우드 데이터 과학 프로세스 연습 | Azure" 
	description="클라우드 데이터 과학 프로세스 연습" 
	metaKeywords="" 
...
# Azure 기계 학습에서 클라우드 데이터 과학 프로세스

이 문서는 클라우드 데이터 과학 프로세스 맵 및 일부 샘플 데이터 원본 및 대상 시나리오를 안내합니다. Azure에서 데이터 특징, 소스 위치 및 대상 저장소를 기반으로 옵션 선택 및 처리 시퀀스의 일부 방법을 보여줍니다. 마지막 섹션에서는 샘플 시나리오에 대 한 클라우드 데이터 과학 프로세스 흐름이 요약됩니다.

[AZURE.INCLUDE [machine-learning-free-trial](../includes/machine-learning-free-trial.md)]

**모든 시나리오에 대해 다음을 수행해야합니다.**
...
3. 복사된 파일을 대상 SQL Server 인스턴스에 첨부합니다. 자세한 내용은 [데이터베이스 첨부](https://technet.microsoft.com/library/ms190209(v=sql.110).aspx)를 참조하세요. 
...
다음 다이어그램은 위에서 설명한 시나리오 및 각 시나리오에서 만든 클라우드 데이터 과학 프로세스 선택 내용을 간략하게 설명합니다. 데이터 처리, 탐색, 기능 엔지니어링 및 샘플링은 소스, 중간 및/또는 대상 환경에서 하나 이상의 메서드/환경에서 발생할 수 있으며, 필요에 따라 반복적으로 진행할 수 있습니다. 다이어그램은 가능한 흐름 중 일부를 그림으로 제공합니다.
