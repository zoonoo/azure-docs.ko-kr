---
title: 자습서 - RBAC 및 Azure PowerShell을 사용하여 사용자에게 액세스 권한 부여 | Microsoft Docs
description: RBAC(역할 기반 액세스 제어)를 사용하여 사용자에게 Azure PowerShell을 사용하여 구독의 모든 항목을 살펴보고 리소스 그룹의 모든 항목을 관리할 수 있는 액세스 권한을 부여할 수 있습니다.
...
[RBAC(역할 기반 액세스 제어)](overview.md)는 Azure에서 리소스에 대한 액세스를 관리하는 방법입니다. 이 자습서에서는 Azure PowerShell을 사용하여 사용자에게 구독의 모든 항목을 살펴보고 리소스 그룹의 모든 항목을 관리할 수 있는 액세스 권한을 부여합니다.
