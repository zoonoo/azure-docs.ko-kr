...
> | [Key Vault Crypto Service 암호화 사용자 (미리 보기)](#key-vault-crypto-service-encryption-user-preview) | 키의 메타 데이터를 읽고 래핑/래핑 해제 작업을 수행 합니다. ' Azure 역할 기반 액세스 제어 ' 권한 모델을 사용 하는 키 자격 증명 모음에만 적용 됩니다. | e147488a-f6f5-4113-8e2d-b22465e65bf6 |
...
### <a name="key-vault-crypto-service-encryption-user-preview"></a>Key Vault Crypto Service 암호화 사용자 (미리 보기)
