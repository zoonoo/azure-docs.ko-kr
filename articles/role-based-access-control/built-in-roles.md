...
| [AcrQuarantineReader](#acrquarantinereader) | acr 격리 데이터 읽기 권한자 |
...
| [Azure API Management 읽기 권한자 역할](#api-management-service-reader-role) | 서비스 및 API에 읽기 전용 액세스 |
| [Application Insights 구성 요소 기여자](#application-insights-component-contributor) | Application Insights 구성 요소를 관리할 수 있습니다. |
...
| [Automation 운영자](#automation-operator) | Automation 운영자는 작업을 시작, 중지, 일시 중단 및 다시 시작할 수 있습니다. |
...
| [Classic Virtual Machine 기여자](#classic-virtual-machine-contributor) | 클래식 가상 머신을 관리할 수 있지만 가상 머신이나 연결된 가상 네트워크 또는 스토리지 계정에 액세스할 수는 없습니다. |
...
| [지능형 시스템 계정 기여자](#intelligent-systems-account-contributor) | 지능형 시스템 계정을 관리할 수 있지만 액세스할 수는 없습니다. |
| [키 자격 증명 모음 기여자](#key-vault-contributor) | Key Vault를 관리할 수 있지만 액세스할 수는 없습니다. |
...
| [보안 판독기](#security-reader) | Security Center에서만 권장 사항 및 경고 보기, 보안 정책 보기, 보안 상태 보기가 가능하며 변경할 수는 없습니다. |
...
| [공간 앵커 계정 기여자](#spatial-anchors-account-contributor) | 계정의 공간 앵커를 관리할 수 있지만 삭제할 수는 없습니다. |
| [공간 앵커 계정 소유자](#spatial-anchors-account-owner) | 삭제를 포함 하 여 계정의 공간 앵커를 관리할 수 있습니다. |
| [공간 앵커 계정 판독기](#spatial-anchors-account-reader) | 계정의 공간 앵커 속성을 찾고 읽을 수 있습니다. |
...
| [저장소 Blob 위임자](#storage-blob-delegator) | Azure AD 자격 증명으로 서명 된 컨테이너 또는 blob에 대 한 공유 액세스 서명을 만드는 데 사용할 수 있는 사용자 위임 키를 가져옵니다. 자세한 내용은 [사용자 위임 SAS 만들기](https://docs.microsoft.com/rest/api/storageservices/create-user-delegation-sas)를 참조 하세요. |
...
| [Virtual Machine 기여자](#virtual-machine-contributor) | 가상 머신을 관리할 수 있지만 가상머신이나 연결된 가상 네트워크 또는 스토리지 계정에 액세스할 수는 없습니다. |
...
## <a name="storage-blob-data-contributor"></a>저장소 Blob 데이터 기여자
> [!div class="mx-tableFixed"]
> | | |
> | --- | --- |
