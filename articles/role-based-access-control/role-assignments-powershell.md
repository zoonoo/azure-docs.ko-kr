...
description: Learn how to manage access to Azure resources for users, groups, and applications using role-based access control (RBAC) and Azure PowerShell. 여기에는 액세스 권한을 나열, 부여 및 제거하는 방법이 포함됩니다.
