...
그룹을 만들 수 있는 권한이 없으면 [자습서: RBAC 및 Azure PowerShell을 사용하여 사용자에게 액세스 권한 부여](tutorial-role-assignments-user-powershell.md)를 대신 시도해 볼 수 있습니다.
