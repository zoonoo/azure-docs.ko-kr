---
title: 빠른 시작 - 사용자가 Azure 리소스에 대해 갖는 액세스 권한 보기
description: 이 빠른 시작에서는 RBAC(역할 기반 액세스 제어) 및 Azure Portal을 사용하여 사용자 또는 다른 보안 주체가 Azure 리소스에 대해 갖는 액세스 권한을 보는 방법을 알아봅니다.
