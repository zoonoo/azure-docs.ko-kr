...
Azure에서 거부 할당을 만들고 관리 하 여 리소스를 보호 합니다. Azure 청사진 및 Azure 관리 되는 앱은 거부 할당을 사용 하 여 시스템 관리 리소스를 보호 합니다. Azure 청사진 및 Azure 관리 되는 앱은 거부 할당을 만들 수 있는 유일한 방법입니다. 사용자 고유의 거부 할당을 직접 만들 수는 없습니다. 청사진에서 리소스를 잠그기 위해 거부 할당을 사용 하는 방법에 대 한 자세한 내용은 [Azure 청사진의 리소스 잠금 이해](../governance/blueprints/concepts/resource-locking.md)를 참조 하세요.
...
모든 보안 주체를와 결합 `ExcludePrincipals` 하 여 일부 사용자를 제외한 모든 보안 주체를 거부할 수 있습니다. 모든 보안 주체에는 다음과 같은 제약 조건이 있습니다.
