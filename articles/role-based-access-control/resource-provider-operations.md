...
> | Action | Microsoft.AAD/domainServices/replicaSets/delete | 클러스터 사이트 삭제 |
...
> | Action | Microsoft.ADHybridHealthService/services/reports/blobUris/read | 지난 7 일 동안 위험한 모든 IP 보고서 Uri를 가져옵니다. |
...
> | Action | Microsoft.ADHybridHealthService/services/servicemembers/metrics/read | 지정 된 서비스 및 서비스 멤버의 커넥터 및 실행 프로필 이름 목록을 가져옵니다. |
...
> | Action | Microsoft.AlertsManagement/actionRules/read | 입력 필터에 대한 모든 작업 규칙을 가져옵니다. |
...
> | Action | Microsoft.AlertsManagement/alertsSummary/read | 경고의 요약 정보를 가져옵니다. |
...
> | Action | Microsoft.AlertsManagement/register/action | Microsoft 경고 관리에 대한 구독을 등록합니다. |
> | Action | Microsoft.AlertsManagement/smartDetectorAlertRules/delete | 지정 된 구독의 스마트 탐지기 경고 규칙 삭제 |
> | 작업 | Microsoft.AlertsManagement/smartDetectorAlertRules/read | 입력 필터에 대 한 모든 스마트 탐지기 경고 규칙을 가져옵니다. |
> | Action | Microsoft.AlertsManagement/smartDetectorAlertRules/write | 지정 된 구독에서 스마트 탐지기 경고 규칙을 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/diagnostics/delete | API에서 지정 된 진단을 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/issues/attachments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/issues/comments/write | API의 문제에 대 한 새 주석을 만들거나 기존 주석을 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/releases/delete | Api의 모든 릴리스를 제거 하거나 API에서 지정 된 릴리스를 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/apis/releases/read | API의 모든 릴리스를 나열 합니다.<br>Api 릴리스는 현재 API 수정을 만들 때 생성 됩니다.<br>릴리스는 이전 수정 버전으로 롤백하는 데도 사용 됩니다.<br>결과는 페이징할 수 있으며 $top 및 $skip 매개 변수에 의해 제한 될 수 있습니다.<br>또는 API 릴리스의 세부 정보를 반환 합니다. |
> | Action | Microsoft.ApiManagement/service/apis/releases/write | API에 대 한 새 릴리스를 만듭니다. 또는는 해당 식별자로 지정 된 API 릴리스의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/schemas/read | API 수준에서 스키마 구성을 가져옵니다. 또는 API 수준에서 스키마 구성을 가져옵니다. |
> | Action | Microsoft.ApiManagement/service/apis/schemas/write | API에 대 한 스키마 구성을 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apiVersionSets/versions/read | 버전 엔터티 목록을 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/applynetworkconfigurationupdates/action | Virtual Network에서 실행되는 Microsoft.ApiManagement 리소스를 업데이트하여 업데이트된 네트워크 설정을 선택합니다. |
...
> | Action | Microsoft.ApiManagement/service/backends/reconnect/action | 지정 된 시간 제한 후에 백 엔드에 대 한 새 연결을 만들도록 APIM 프록시에 알립니다. 제한 시간을 지정 하지 않으면 2 분의 제한 시간이 사용 됩니다. |
...
> | Action | Microsoft.ApiManagement/service/diagnostics/write | 새 진단을 만들거나 기존 진단을 업데이트 합니다. 또는는 해당 식별자로 지정 된 진단 정보를 업데이트 합니다. |
...
> | Action | Microsoft.apimanagement/서비스/게이트웨이/키/작업 | 게이트웨이 키를 검색 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/읽기 | 서비스 인스턴스에 등록 된 게이트웨이의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 가져옵니다. |
> | Action | Microsoft.apimanagement/서비스/게이트웨이/regeneratePrimaryKey/작업 | 기본 게이트웨이 키를 생성 하 여 만든 모든 토큰을 invalidationg 합니다. |
...
> | Action | Microsoft.apimanagement/서비스/게이트웨이/쓰기 | Api Management 인스턴스에서 사용할 게이트웨이를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/openidConnectProviders/write | Openid connect Connect 공급자를 만들거나 업데이트 합니다. 또는 특정 Openid connect Connect 공급자를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/policy/delete | 테 넌 트 수준에서 정책 구성을 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/policySnippets/read | 모든 정책 코드 조각을 나열 합니다. |
> | Action | Microsoft.ApiManagement/service/portalsettings/read | 포털에 대 한 로그인 설정을 가져오거나 포털에 대 한 등록 설정을 가져오거나 포털에 대 한 위임 설정을 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/products/apis/delete | 지정 된 제품에서 지정 된 API를 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/products/groups/read | 지정 된 제품과 연결 된 개발자 그룹의 컬렉션을 나열 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/groups/write | 지정 된 제품을 사용 하 여 지정 된 개발자 그룹 간의 연결을 추가 합니다. |
> | Action | Microsoft.ApiManagement/service/products/policies/delete | 제품에서 정책 구성을 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/products/policies/read | 제품 수준에서 정책 구성을 가져옵니다. 또는 제품 수준에서 정책 구성을 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/reports/read | 기간별로 집계된 보고서를 가져오거나 지역별로 집계된 보고서를 가져오거나 개발자별로 집계된 보고서를 가져옵니다.<br>또는 제품별로 집계된 보고서를 가져옵니다.<br>또는 API별로 집계된 보고서를 가져오거나 작업별로 집계된 보고서를 가져오거나 구독별로 집계된 보고서를 가져옵니다.<br>또는 데이터 보고 요청을 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/tags/delete | API Management 서비스 인스턴스의 특정 태그를 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/tags/read | 서비스 인스턴스 내에 정의 된 태그의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 태그의 세부 정보를 가져옵니다. |
> | Action | Microsoft.ApiManagement/service/tags/write | 태그를 만듭니다. 또는는 해당 식별자로 지정 된 태그의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/users/subscriptions/read | 지정 된 사용자의 구독 컬렉션을 나열 합니다. |
...
> | Action | Microsoft.Automation/automationAccounts/python2Packages/write | Azure Automation Python 2 패키지를 만들거나 업데이트 |
> | Action | Microsoft.Automation/automationAccounts/python3Packages/delete | Azure Automation Python 3 패키지를 삭제 |
> | Action | Microsoft.Automation/automationAccounts/python3Packages/read | Azure Automation Python 3 패키지를 가져오기 |
...
> | Action | Microsoft.Automation/automationAccounts/updateDeploymentMachineRuns/read | Azure Automation 업데이트 배포 머신을 가져옵니다. |
...
> | Action | Microsoft.Batch/batchAccounts/read | Batch 계정을 나열하거나 Batch 계정의 속성을 가져옵니다. |
...
> | 작업 | Microsoft.Billing/billingAccounts/enrollmentAccounts/read | 청구 계정 범위에 포함된 모든 등록 계정을 나열합니다. |
...
> | Action | Microsoft.Billing/departments/read | 사용자가 액세스할 수 있는 모든 부서를 나열합니다. |
...
> | --- | --- | --- |
> | Action | Microsoft.Blockchain/blockchainMembers/delete | 기존 Blockchain 멤버를 삭제 합니다. |
...
> | 동작 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.Blueprint/blueprintAssignments/assignmentOperations/read | 모든 청사진 아티팩트 읽기 |
...
> | Action | Microsoft.Blueprint/blueprints/versions/delete | 청사진 삭제 |
...
> | Action | Microsoft.Capacity/calculateprice/action | 예약 가격을 계산합니다. |
...
> | Action | Microsoft.Capacity/register/action | 용량 리소스 공급자를 등록하고 용량 리소스 만들기를 사용하도록 설정합니다. |
...
> | Action | Microsoft.Capacity/reservationorders/return/action | 예약을 반환합니다. |
...
> | Action | Microsoft.Capacity/tenants/register/action | 테넌트를 등록합니다. |
...
> | Action | Microsoft.ClassicCompute/domainNames/deploymentslots/state/read | 배포 슬롯 상태를 가져옵니다. |
...
> | Action | Microsoft.CognitiveServices/accounts/listKeys/action | 키를 나열합니다. |
...
> | Action | Microsoft.CognitiveServices/accounts/usages/read | 기존 리소스에 대한 할당량 사용량을 가져옵니다. |
...
> | Action | Microsoft.Compute/hosts/delete | 호스트를 삭제 합니다. |
...
> | Action | Microsoft.Compute/proximityPlacementGroups/read | 근접 배치 그룹의 속성을 가져옵니다. |
> | 작업 | Microsoft.Compute/proximityPlacementGroups/write | 새 근접 배치 그룹을 만들거나 기존 항목을 업데이트 합니다. |
> | Action | Microsoft.Compute/register/action | Microsoft.Compute 리소스 공급자에 구독을 등록합니다. |
...
> | Action | Microsoft.Compute/unregister/action | Microsoft. Compute 리소스 공급자를 사용 하 여 구독 등록을 취소 합니다. |
...
> | Action | Microsoft.Compute/virtualMachines/read | 가상 머신의 속성을 가져옵니다. |
...
> | Action | Microsoft.Consumption/credits/read | 크레딧을 나열합니다. |
...
> | 작업 | Microsoft.ContainerInstance/containerGroups/stop/action | 특정 컨테이너 그룹을 중지합니다. 계산 리소스 할당이 취소되고 청구가 중지됩니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/write | 특정 컨테이너 그룹을 만들거나 업데이트합니다. |
> | Action | Microsoft.ContainerInstance/locations/cachedImages/read | Azure 지역의 구독에 대해 캐시된 이미지를 가져옵니다. |
...
> | Action | Microsoft.ContainerRegistry/registries/operationStatuses/read | 레지스트리 비동기 작업 상태를 가져옵니다. |
...
> | Action | Microsoft.ContainerRegistry/registries/runs/listLogSasUrl/action | 실행을 위한 로그 SAS URL을 가져옵니다. |
...
> | Action | Microsoft.ContainerService/openShiftClusters/write | 새 Open Shift 클러스터를 만들거나 기존 Open Shift 클러스터를 업데이트합니다. |
...
> | Action | Microsoft.ContainerService/openShiftManagedClusters/write | 새 Open Shift 관리형 클러스터를 만들거나 기존 Open Shift 관리 클러스터를 업데이트합니다. |
...
> | 동작 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.CostManagement/cloudConnectors/delete | 지정 된 cloudConnector를 삭제 합니다. |
> | Action | Microsoft.CostManagement/cloudConnectors/read | 인증 된 사용자에 대 한 cloudConnectors를 나열 합니다. |
...
> | Action | Microsoft.DataBox/register/action | 공급자 Microsoft.Databox를 등록합니다. |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/downloadUpdates/action | 디바이스에서 업데이트를 다운로드 |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/networkSettings/read | 디바이스 네트워크 설정을 나열하거나 가져오기 |
...
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/read | 저장소 계정 자격 증명을 나열하거나 가져오기 |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/write | 저장소 계정 자격 증명을 만들거나 업데이트 |
...
> | Action | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
...
> | Action | Microsoft.DataFactory/datafactories/read | Data Factory를 읽습니다. |
...
> | Action | Microsoft.DataFactory/factories/createdataflowdebugsession/action | 데이터 흐름 디버그 세션을 만듭니다. |
...
> | Action | Microsoft.DataFactory/factories/dataflows/write | 데이터 흐름 만들기 또는 업데이트 |
...
> | Action | Microsoft.DataFactory/factories/querypipelineruns/action | 파이프라인 실행을 쿼리합니다. |
...
> | Action | Microsoft.DataFactory/operations/read | Microsoft Data Factory 공급자의 모든 작업을 읽습니다. |
...
> | Action | Microsoft.DataLakeStore/accounts/write | DataLakeStore 계정을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.DataMigration/services/addWorker/action | 서비스의 availiable 작업자에 DMS 작업자를 추가 합니다. |
> | Action | Microsoft.DataMigration/services/checkStatus/action | 서비스가 배포되어 실행되고 있는지 확인합니다. |
> | Action | Microsoft.DataMigration/services/configureWorker/action | 서비스의 availiable 작업자에 대해 DMS 작업자를 구성 합니다. |
...
> | Action | Microsoft.DataMigration/services/serviceTasks/delete | 리소스와 해당 하위 항목을 모두 삭제합니다. |
...
> | Action | Microsoft.DBforMariaDB/servers/advisors/recommendedActions/read | 권장된 작업 목록을 반환 |
...
> | Action | Microsoft.DBforMariaDB/servers/read | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforMariaDB/servers/waitStatistics/read | 대기 통계 반환 |
...
> | Action | Microsoft.DBforMySQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
...
> | Action | Microsoft.DBforMySQL/servers/configurations/read | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforMySQL/servers/logFiles/read | PostgreSQL LogFiles의 목록을 반환 합니다. |
...
> | Action | Microsoft.DBforMySQL/servers/securityAlertPolicies/read | 지정된 서버에 구성된 서버 위협 검색 정책의 세부 정보를 검색합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/servers/logFiles/read | PostgreSQL LogFiles의 목록을 반환 합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/servers/securityAlertPolicies/read | 지정된 서버에 구성된 서버 위협 검색 정책의 세부 정보를 검색합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/serversv2/configurations/read | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforPostgreSQL/serversv2/firewallRules/read | 서버에 대한 방화벽 규칙 목록을 반환하거나 지정된 방화벽 규칙에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforPostgreSQL/serversv2/providers/Microsoft.Insights/diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> | Action | Microsoft.DBforPostgreSQL/serversv2/providers/Microsoft.Insights/logDefinitions/read | Postgres 서버에 사용 가능한 로그를 가져옵니다. |
...
> | 작업 | Microsoft.DevTestLab/labs/idleShutdowns/read | 유휴 종료를 읽습니다. |
> | 작업 | Microsoft.DevTestLab/labs/idleShutdowns/write | 유휴 종료를 추가 하거나 수정 합니다. |
> | Action | Microsoft.DevTestLab/labs/ImportVirtualMachine/action | 가상 머신을 다른 랩으로 가져옵니다. |
...
> | Action | Microsoft.DevTestLab/labs/sharedGalleries/delete | 공유 갤러리를 삭제 합니다. |
> | Action | Microsoft.DevTestLab/labs/sharedGalleries/read | 공유 갤러리를 읽습니다. |
...
> | Action | Microsoft.DevTestLab/labs/virtualMachines/UnClaim/action | 기존 가상 머신의 소유권을 해제합니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/read | 컬렉션 처리량을 읽습니다. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ' API 유형에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/read | 컨테이너를 읽거나 모든 컨테이너를 나열 합니다. ' Sql ' API 유형에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/delete | 데이터베이스를 삭제 합니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/write | 그래프 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/write | 그래프를 만들거나 업데이트 합니다. API 형식에만 적용 됩니다. ' gremlin'. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/tables/delete | 테이블을 삭제 합니다. ' Table ' API 유형에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Table ' API 유형에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/tables/write | 테이블을 만들거나 업데이트 합니다. ' Table ' API 유형에만 적용 됩니다. |
...
> | Action | Microsoft.EventGrid/domains/listKeys/action | 도메인에 대한 키를 나열합니다. |
...
> | Action | Microsoft.EventGrid/domains/regenerateKey/action | 도메인에 대한 키를 다시 생성합니다. |
> | 작업 | Microsoft.EventGrid/domains/topics/read | 도메인 토픽을 읽습니다. |
> | Action | Microsoft.EventGrid/domains/write | 도메인을 만들거나 업데이트합니다. |
> | Action | Microsoft.EventGrid/eventSubscriptions/delete | EventSubscription 삭제 |
...
> | Action | Microsoft.EventGrid/locations/topictypes/eventSubscriptions/read | 항목 유형별로 지역 이벤트 구독을 나열합니다. |
> | Action | Microsoft.EventGrid/operationResults/read | 작업의 결과를 읽습니다. |
...
> | Action | Microsoft.EventGrid/topictypes/eventSubscriptions/read | 항목 유형별로 글로벌 이벤트 구독을 나열합니다. |
...
> | Action | Microsoft.EventHub/checkNameAvailability/action | 지정된 구독에서 네임스페이스의 가용성을 확인합니다. |
...
> | Action | Microsoft.EventHub/namespaces/ipFilterRules/read | IP 필터 리소스 가져오기 |
...
> | Action | Microsoft.HDInsight/clusters/updateGatewaySettings/action | HDInsight 클러스터에 대 한 게이트웨이 설정 업데이트 |
...
> | Action | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/diagnosticSettings/Read | 리소스 진단 설정을 읽습니다. |
...
> | Action | Microsoft.Insights/CalculateBaseline/Read | 메트릭 값의 기준선 계산 (미리 보기) |
...
> | Action | Microsoft.Insights/Logs/DeviceAppCrash/Read | DeviceAppCrash 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.Insights/MetricBaselines/Read | 메트릭 기준 읽기 |
...
> | Action | Microsoft.Insights/Metricnamespaces/Read | 메트릭 네임 스페이스 읽기 |
> | Action | Microsoft.Insights/Metrics/Action | 메트릭 작업 |
> | 작업 | Microsoft.Insights/Metrics/Microsoft.Insights/Read | 메트릭 읽기 |
> | Action | Microsoft.Insights/Metrics/providers/Metrics/Read | 메트릭 읽기 |
...
> | 동작 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.Intune/diagnosticsettings/delete | 진단 설정을 삭제합니다. |
...
> | Action | Microsoft.IoTCentral/IoTApps/read | 단일 IoT Central 애플리케이션 가져오기 |
> | Action | Microsoft.IoTCentral/IoTApps/write | IoT Central 애플리케이션을 만들거나 업데이트 |
...
> | Action | Microsoft.KeyVault/vaults/eventGridFilters/write | Key Vault에 대 한 새 EventGrid 구독을 만들고 있음을 Microsoft. KeyVault에 알립니다. |
...
> | Action | Microsoft.Kusto/Clusters/Databases/AddPrincipals/action | 데이터베이스 보안 주체를 추가 합니다. |
> | Action | Microsoft.Kusto/Clusters/Databases/CheckNameAvailability/action | 지정 된 형식에 대 한 이름 가용성을 확인 합니다. |
...
> | Action | Microsoft.Kusto/Clusters/Databases/delete | 데이터베이스 리소스를 삭제합니다. |
...
> | Action | Microsoft.Kusto/Clusters/Databases/read | 데이터베이스 리소스를 읽습니다. |
...
> | Action | Microsoft.Kusto/Clusters/read | 클러스터 리소스를 읽습니다. |
...
> | Action | Microsoft.Kusto/SKUs/read | SKU 리소스를 읽습니다. |
...
> | 작업 | Microsoft. 서비스/랩 계정/idleShutdowns/쓰기 | Idleshutdowns를 추가 하거나 수정 합니다. |
...
> | Action | Microsoft.LabServices/labAccounts/labs/environmentSettings/ResetPassword/action | 템플릿 가상 컴퓨터에서 암호를 다시 설정 합니다. |
...
> | Action | Microsoft.LabServices/labAccounts/labs/environmentSettings/schedules/write | 일정을 추가하거나 수정합니다. |
...
> | Action | Microsoft.LabServices/users/ListAllEnvironments/action | 사용자에 대 한 모든 환경 나열 |
...
> | Action | Microsoft.LabServices/users/StartEnvironment/action | 환경 내의 모든 리소스를 시작하여 환경을 시작합니다. |
...
> | Action | Microsoft.MachineLearningServices/register/action | Machine Learning Services 리소스 공급자에 대한 구독을 등록합니다. |
...
> | 작업 | Microsoft.MachineLearningServices/workspaces/computes/read | Machine Learning Services 작업 영역에서 계산 리소스를 가져옵니다. |
...
> | Action | Microsoft ManagedServices/register/action | 관리 서비스에 등록 합니다. |
> | 작업 | Microsoft ManagedServices/registrationAssignments/delete | 관리 되는 서비스 등록 할당을 제거 합니다. |
> | Action | Microsoft ManagedServices/registrationAssignments/read | 관리 되는 서비스 등록 할당 목록을 검색 합니다. |
> | Action | Microsoft ManagedServices/registrationAssignments/write | 관리 서비스 등록 할당을 추가 하거나 수정 합니다. |
...
> | Action | Microsoft ManagedServices/registrationDefinitions/쓰기 | 관리 서비스 등록 정의를 추가 하거나 수정 합니다. |
...
> | Action | Microsoft.Maps/accounts/eventGridFilters/delete | Event Grid 필터를 삭제합니다. |
> | Action | Microsoft.Maps/accounts/eventGridFilters/read | Event Grid 필터를 가져옵니다. |
> | Action | Microsoft.Maps/accounts/eventGridFilters/write | Event Grid 필터를 만들거나 업데이트합니다. |
...
> | Action | Microsoft.MarketplaceOrdering/operations/read | API에서 가능한 모든 작업 나열 |
...
> | Action | Microsoft.Media/mediaservices/accountfilters/delete | 계정 필터를 삭제합니다. |
> | Action | Microsoft.Media/mediaservices/accountfilters/read | 계정 필터를 읽습니다. |
> | 작업 | Microsoft.Media/mediaservices/accountfilters/write | 계정 필터를 만들거나 업데이트합니다. |
> | Action | Microsoft.Media/mediaservices/assets/assetfilters/delete | 자산 필터를 삭제합니다. |
...
> | Action | Microsoft.Migrate/assessmentprojects/groups/assessments/assessedmachines/read | 평가된 머신의 속성을 가져옵니다. |
...
> | Action | Microsoft.Migrate/assessmentprojects/groups/updateMachines/action | 컴퓨터를 추가 또는 제거 하 여 그룹 업데이트 |
...
> | Action | Microsoft.Migrate/assessmentprojects/hypervcollectors/read | HyperV 수집기의 속성을 가져옵니다. |
> | Action | Microsoft.Migrate/assessmentprojects/hypervcollectors/write | 새 HyperV 수집기를 만들거나 기존 HyperV 수집기를 업데이트 합니다. |
...
> | Action | Microsoft.Migrate/assessmentprojects/vmwarecollectors/read | VMware 수집기의 속성을 가져옵니다. |
...
> | Action | Microsoft.Migrate/locations/assessmentOptions/read | 지정된 위치에서 사용할 수 있는 평가 옵션을 가져옵니다. |
...
> | Action | Microsoft.Migrate/migrateprojects/delete | 마이그레이션 프로젝트를 삭제 합니다. |
...
> | Action | Microsoft.Migrate/migrateprojects/read | 마이그레이션 프로젝트의 속성을 가져옵니다. |
...
> | Action | Microsoft.Migrate/migrateprojects/solutions/read | 프로젝트 솔루션 마이그레이션 속성을 가져옵니다. |
> | 작업 | Microsoft.Migrate/migrateprojects/solutions/write | 새 프로젝트 마이그레이션 솔루션을 만들거나 기존 마이그레이션 프로젝트 솔루션을 업데이트 합니다. |
> | Action | Microsoft.Migrate/migrateprojects/write | 새 마이그레이션 프로젝트를 만들거나 기존 마이그레이션 프로젝트를 업데이트 합니다. |
...
> | Action | Microsoft.Network/bastionHosts/delete | 요새 호스트 삭제 |
> | Action | Microsoft.Network/bastionHosts/read | 요새 호스트 가져오기 |
...
> | Action | Microsoft.Network/connections/read | VirtualNetworkGatewayConnection을 가져옵니다. |
...
> | Action | Microsoft.Network/expressRouteCircuits/peerings/arpTables/action | ExpressRouteCircuit Peering ArpTable을 가져옵니다. |
...
> | Action | Microsoft.Network/expressRouteCircuits/read | ExpressRouteCircuit을 가져옵니다. |
...
> | Action | Microsoft.Network/expressRoutePorts/links/read | ExpressRouteLink를 가져옵니다. |
...
> | Action | Microsoft. Network/firewallPolicies/ruleGroups/read | 방화벽 정책 규칙 그룹을 가져옵니다. |
...
> | Action | Microsoft.Network/frontDoors/backendPools/delete | 백 엔드 풀 삭제 |
...
> | Action | Microsoft.Network/frontDoors/frontendEndpoints/disableHttps/action | 프런트 엔드 엔드포인트에서 HTTPS를 사용하지 않도록 설정 |
...
> | Action | Microsoft.Network/frontDoors/healthProbeSettings/delete | 상태 프로브 설정 삭제 |
...
> | Action | Microsoft.Network/frontDoors/loadBalancingSettings/delete | 부하 분산 설정을 만들거나 업데이트 |
...
> | Action | Microsoft.Network/privateDnsZones/CNAME/write | 사설 DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.Network/privateDnsZones/PTR/read | JSON 형식의 사설 DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
...
> | Action | Microsoft.Network/privateDnsZones/recordsets/read | 형식 간에 사설 DNS 레코드 집합을 가져옵니다. |
> | Action | Microsoft.Network/privateDnsZones/SOA/read | JSON 형식의 사설 DNS 영역 내에서 ' SOA ' 형식의 레코드 집합을 가져옵니다. |
...
> | Action | Microsoft.Network/privateDnsZones/SRV/write | 사설 DNS 영역 내에서 ' SRV ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
...
> | Action | Microsoft.Network/privateDnsZones/virtualNetworkLinks/read | JSON 형식의 가상 네트워크 속성에 대 한 사설 DNS 영역 링크를 가져옵니다. |
...
> | Action | Microsoft.Network/privateLinkServices/delete | 프라이빗 링크 서비스 자원을 삭제합니다. |
> | Action | Microsoft.Network/privateLinkServices/privateEndpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
...
> | Action | Microsoft.Network/publicIPAddresses/read | 공용 IP 주소 정의를 가져옵니다. |
...
> | Action | Microsoft.Network/virtualNetworks/checkIpAddressAvailability/read | IP 주소를 지정된 가상 네트워크에서 사용할 수 있는지 확인합니다. |
...
> | Action | Microsoft.Network/virtualNetworks/subnets/read | 가상 네트워크 서브넷 정의를 가져옵니다. |
...
> | Action | Microsoft.Network/virtualNetworkTaps/read | 가상 네트워크 탭을 가져옵니다. |
...
> | Action | Microsoft.network/virtualWans/p2sVpnServerConfigurations/write | 가장 Wan P2SVpnServerConfiguration을 만들거나 기존 가상 Wan P2SVpnServerConfiguration을 업데이트합니다. |
...
> | Action | Microsoft.NotificationHubs/unregister/action | NotificationHubs 리소스 공급자에 대한 구독을 등록 취소하고 네임스페이스와 NotificationHubs 만들기를 사용하도록 설정합니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesLogonLogoff/read | AADDomainServicesLogonLogoff 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/ADReplicationResult/read | ADReplicationResult 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/AutoscaleScaleActionsLog/read | AutoscaleScaleActionsLog 테이블에서 데이터를 읽습니다. |
> | Action | Microsoft.OperationalInsights/workspaces/query/AWSCloudTrail/read | AWSCloudTrail 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/DatabricksTables/read | DatabricksTables 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/LinuxAuditLog/read | LinuxAuditLog 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppInstanceHealth/read | MAOfficeAppInstanceHealth 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MAWindowsSysReqInstanceReadiness/read | MAWindowsSysReqInstanceReadiness 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/SecurityIoTRawEvent/read | SecurityIoTRawEvent 테이블에서 데이터를 읽습니다. |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/SecurityRecommendation/read | SecurityRecommendation 테이블에서 데이터를 읽습니다. |
> | Action | Microsoft.OperationalInsights/workspaces/query/ServiceFabricOperationalEvent/read | ServiceFabricOperationalEvent 테이블에서 데이터를 읽습니다. |
...
> | Action | microsoft.operationalinsights/workspaces/savedsearches/schedules/actions/write | 예약된 검색 작업을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.OperationsManagement/managementConfigurations/read | 기존 관리 구성을 가져옵니다. |
...
> | Action | Microsoft.PolicyInsights/remediations/write | Microsoft Policy 재구성를 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.Portal/consoles/write | Cloud Shell 인스턴스를 만들거나 업데이트 합니다. |
...
> | Action | microsoft.recoveryservices/Locations/backupProtectedItems/read | 모든 보호 항목 목록을 반환합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupconfig/read | Recovery Services 자격 증명 모음에 구성을 반환합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/backupProtectionIntent/delete | 백업 보호 의도를 삭제합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/protectedItems/backup/action | 보호 항목 백업을 수행합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupPolicies/operationResults/read | 정책 작업 결과를 가져옵니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupPolicies/write | 보호 정책을 만듭니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupstorageconfig/read | Recovery Services 자격 증명 모음에 대한 저장소 구성을 반환합니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationVaultSettings/write | 만들기 또는 업데이트  |
...
> | Action | Microsoft.RecoveryServices/Vaults/vaultTokens/read | 자격 증명 모음 토큰 작업을 사용하여 자격 증명 모음 수준의 백 엔드 작업에 대한 자격 증명 모음 토큰을 가져올 수 있습니다. |
...
> | Action | Microsoft.Resources/deployments/whatIf/action | 템플릿 배포 변경 사항을 예측 합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.Security/adaptiveNetworkHardenings/enforce/action | 지정 된 네트워크 보안 그룹에서 일치 하는 보안 규칙을 만들어 지정 된 트래픽 강화 규칙을 적용 합니다. |
> | Action | Microsoft.Security/adaptiveNetworkHardenings/read | Azure로 보호 되는 리소스의 적응 네트워크 강화 권장 사항을 가져옵니다. |
> | Action | Microsoft.Security/advancedThreatProtectionSettings/read | 리소스에 대한 Advanced Threat Protection 설정을 가져옵니다. |
...
> | Action | Microsoft.Security/settings/write | 범위에 대한 설정을 업데이트합니다. |
> | Action | Microsoft.Security/tasks/read | 모든 사용 가능한 보안 권장 사항을 가져옵니다. |
...
> | Action | Microsoft.ServiceBus/locations/deleteVirtualNetworkOrSubnets/action | 지정된 VNet에 대한 ServiceBus 리소스 공급자의 VNet 규칙을 삭제합니다. |
...
> | Action | Microsoft.ServiceBus/namespaces/networkrulesets/delete | VNET 규칙 리소스 삭제 |
...
> | Action | Microsoft.SignalRService/operationresults/read | 비동기 작업의 상태 쿼리 |
...
> | Action | Microsoft.SignalRService/SignalR/restart/action | 관리 포털 또는 API를 통해 Azure SignalR 서비스를 다시 시작합니다. 가동 중지 시간이 있을 것입니다. |
> | Action | Microsoft.SignalRService/SignalR/write | 관리 포털 또는 API를 통해 SignalR의 설정과 구성을 수정합니다. |
...
> | Action | Microsoft.Solutions/applications/applicationArtifacts/read | 응용 프로그램 아티팩트를 나열 합니다. |
...
> | Action | Microsoft.Sql/instancePools/usages/read | 인스턴스 풀의 사용 정보를 가져옵니다. |
> | Action | Microsoft.Sql/instancePools/write | 인스턴스 풀을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.Sql/locations/encryptionProtectorAzureAsyncOperation/read | 투명 한 데이터 암호화 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/instancePoolAzureAsyncOperation/read | 인스턴스 풀 작업의 상태를 가져옵니다. |
> | Action | Microsoft.Sql/locations/instancePoolOperationResults/read | 인스턴스 풀 작업의 결과를 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/managedInstanceEncryptionProtectorAzureAsyncOperation/read | 투명 한 데이터 암호화 관리 되는 인스턴스 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/privateEndpointConnectionOperationResults/read | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/read | 지정된 구독에 사용 가능한 위치를 가져옵니다. |
...
> | Action | Microsoft.Sql/managedInstances/databases/sensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
...
> | Action | Microsoft.Sql/servers/databases/failover/action | 고객이 데이터베이스 장애 조치를 시작 했습니다. |
...
> | Action | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
...
> | Action | Microsoft.Sql/servers/databases/vulnerabilityAssessments/rules/baselines/delete | 지정된 데이터베이스에 대한 취약성 평가 규칙 기준을 제거합니다. |
...
> | Action | Microsoft.Sql/servers/jobAgents/delete | Azure SQL DB 작업 에이전트를 삭제합니다. |
> | Action | Microsoft.Sql/servers/jobAgents/read | Azure SQL DB 작업 에이전트를 가져옵니다. |
> | 작업 | Microsoft.Sql/servers/jobAgents/write | Azure SQL DB 작업 에이전트를 만들거나 업데이트합니다. |
> | Action | Microsoft.Sql/servers/keys/delete | 기존 서버 키를 삭제합니다. |
...
> | Action | Microsoft.Sql/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
...
> | Action | Microsoft.Sql/servers/providers/Microsoft.Insights/metricDefinitions/read | 서버에 사용할 수 있는 메트릭 형식을 반환합니다. |
...
> | Action | Microsoft.Sql/servers/recoverableDatabases/read | 이 작업은 라이브 데이터베이스의 재해 복구 기능이 데이터베이스를 마지막 정상 지점으로 복원하는 데 사용합니다. 마지막 정상 백업에 대한 정보가 반환되지만 실제로 데이터베이스는 복원되지 않습니다. |
...
> | Action | Microsoft.Sql/servers/vulnerabilityAssessments/write | 주어진 서버에 대한 취약성 평가를 변경합니다. |
...
> | Action | Microsoft.Storage/locations/checknameavailability/read | 해당 계정 이름이 올바른지와 사용되고 있지 않은지 확인합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/blobServices/containers/read | 컨테이너를 반환합니다. |
> | 작업 | Microsoft.Storage/storageAccounts/blobServices/containers/read | 컨테이너 목록을 반환합니다. |
> | Action | Microsoft.Storage/storageAccounts/blobServices/containers/setLegalHold/action | Blob 컨테이너 법적 보존을 설정합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/listAccountSas/Action | 지정된 저장소 계정에 대한 계정 SAS 토큰을 반환합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시를 추가 합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/restoreBlobRanges/action | 지정 된 시간 상태로 blob 범위 복원 |
...
> | Action | Microsoft.Storage/storageAccounts/write | 지정된 매개 변수를 사용하여 저장소 계정을 만들거나, 속성 또는 태그를 업데이트하거나, 지정된 저장소 계정의 사용자 지정 도메인을 추가합니다. |
...
> | Action | Microsoft.StorSimple/managers/storageAccountCredentials/read | Storage 계정 자격 증명을 나열하거나 가져옵니다. |
...
> | Action | Microsoft. 구독/이름 바꾸기/작업 | 구독 이름 바꾸기 |
...
> | Action | Microsoft.TimeSeriesInsights/environments/eventsources/read | 이벤트 원본 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.TimeSeriesInsights/environments/eventsources/write | 환경에 대한 새 이벤트 원본을 만들거나 기존 이벤트 원본을 업데이트합니다. |
> | Action | Microsoft.TimeSeriesInsights/environments/read | 환경 속성을 가져옵니다. |
...
> | Action | microsoft.web/sites/processes/read | Web Apps 프로세스를 가져옵니다. |
> | Action | microsoft.web/sites/processes/threads/read | 스레드를 가져오기 Web Apps를 처리 합니다. |
...
> | Action | microsoft.web/sites/slots/containerlogs/download/action | Web Apps 슬롯 컨테이너 로그를 다운로드합니다. |
