...
> | 액션(Action) | Microsoft.AAD/domainServices/oucontainer/delete | Ou 컨테이너 삭제 |
> | 액션(Action) | Microsoft.AAD/domainServices/oucontainer/read | Ou 컨테이너 읽기 |
> | 액션(Action) | Microsoft.AAD/domainServices/oucontainer/write | Ou 컨테이너 쓰기 |
> | 액션(Action) | Microsoft.AAD/domainServices/read | 도메인 서비스를 읽습니다. |
...
> | 액션(Action) | Microsoft. AAD/domainServices/replicaSets/write | 클러스터 사이트 쓰기 |
...
> | 액션(Action) | Microsoft.AAD/unregister/action | 도메인 서비스를 등록 취소합니다. |
...
> | 액션(Action) | Microsoft.ADHybridHealthService/reports/tenantassigneddeployment/read | 테넌트 ID가 지정되면 테넌트 스토리지 위치를 가져옵니다. |
...
> | 액션(Action) | ADHybridHealthService/services/reports/blobUris/read | 지난 7 일 동안 위험한 모든 IP 보고서 Uri를 가져옵니다. |
> | 액션(Action) | Microsoft.ADHybridHealthService/services/reports/details/read | 지난 7일간 잘못된 암호 오류가 있는 상위 50명의 사용자에 대한 보고서를 가져옵니다. |
> | 액션(Action) | ADHybridHealthService/services/reports/generateBlobUri/action | 위험한 IP 보고서를 생성 하 고이를 가리키는 URI를 반환 합니다. |
...
> | 액션(Action) | ADHybridHealthService/services/servicemembers/메트릭/읽기 | 지정 된 서비스 및 서비스 멤버의 커넥터 및 실행 프로필 이름 목록을 가져옵니다. |
> | 액션(Action) | Microsoft.ADHybridHealthService/services/servicemembers/read | 서비스의 서버 인스턴스를 읽습니다. |
...
> | 액션(Action) | Microsoft Advisor/metadata/read | 메타데이터 가져오기 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.AlertsManagement/actionRules/delete | 지정된 구독에서 작업 규칙을 삭제합니다. |
> | 액션(Action) | Microsoft.AlertsManagement/actionRules/read | 입력 필터에 대한 모든 작업 규칙을 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/actionRules/write | 지정된 구독에서 작업 규칙을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alerts/changestate/action | 경고 상태를 변경합니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alerts/diagnostics/read | 경고에 대한 모든 진단을 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alerts/history/read | 경고 기록을 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alerts/read | 입력 필터에 대한 모든 경고를 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alertsList/read | 전체 구독에서 입력 필터에 대한 모든 경고를 가져옵니다. |
> | 액션(Action) | AlertsManagement/alertsMetaData/읽기 | 입력 매개 변수에 대 한 경고 메타 데이터를 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alertsSummary/read | 경고의 요약 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/alertsSummaryList/read | 구독 전체의 경고에 대한 요약을 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/Operations/read | 제공된 작업을 읽습니다. |
> | 액션(Action) | Microsoft.AlertsManagement/register/action | Microsoft 경고 관리에 대한 구독을 등록합니다. |
> | 액션(Action) | AlertsManagement/smartDetectorAlertRules/delete | 지정 된 구독의 스마트 탐지기 경고 규칙 삭제 |
> | 액션(Action) | AlertsManagement/smartDetectorAlertRules/읽기 | 입력 필터에 대 한 모든 스마트 탐지기 경고 규칙을 가져옵니다. |
> | 액션(Action) | AlertsManagement/smartDetectorAlertRules/write | 지정 된 구독에서 스마트 탐지기 경고 규칙을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.AlertsManagement/smartGroups/changestate/action | 스마트 그룹의 상태를 변경합니다. |
> | 액션(Action) | Microsoft.AlertsManagement/smartGroups/history/read | 스마트 그룹 기록을 가져옵니다. |
> | 액션(Action) | Microsoft.AlertsManagement/smartGroups/read | 입력 필터에 대한 모든 스마트 그룹을 가져옵니다. |
...
> | 액션(Action) | Microsoft.AnalysisServices/servers/read | 지정된 Analysis Server의 정보를 검색합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/apis/delete | API Management 서비스 인스턴스의 지정 된 API를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/diagnostics/delete | API에서 지정 된 진단을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/diagnostics/read | API의 모든 진단을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 진단 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/diagnostics/write | API에 대 한 새 진단을 만들거나 기존 API를 업데이트 합니다. 또는는 해당 식별자로 지정 된 API에 대 한 진단 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/attachments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/attachments/read | 지정 된 API와 관련 된 문제에 대 한 모든 첨부 파일을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 문제 첨부 파일의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/attachments/write | API의 문제에 대 한 새 첨부 파일을 만들거나 기존 문제를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/comments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/comments/read | 지정 된 API와 관련 된 문제에 대 한 모든 설명을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 문제 설명의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/comments/write | API의 문제에 대 한 새 주석을 만들거나 기존 주석을 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/delete | API에서 지정 된 문제를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/read | 지정 된 API와 관련 된 모든 문제를 나열 합니다. 또는 해당 식별자로 지정 된 API의 문제에 대 한 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/issues/write | API에 대 한 새 문제를 만들거나 기존 문제를 업데이트 합니다. 또는는 API에 대 한 기존 문제를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/delete | API에서 지정 된 작업을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/policies/delete | Api 작업에서 정책 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/policies/read | API 작업 수준에서 정책 구성 목록을 가져옵니다. 또는 API 작업 수준에서 정책 구성을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/policies/write | API 작업 수준에 대 한 정책 구성을 만들거나 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/policy/write | 작업 수준에서 정책 구성 만들기 |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/read | 지정 된 API에 대 한 작업의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 API 작업에 대 한 세부 정보를 가져옵니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operations/write | API에서 새 작업을 만들거나 기존 작업을 업데이트 합니다. 또는는 해당 식별자로 지정 된 API의 작업 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/operationsByTags/read | 태그와 연결 된 작업의 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/policies/delete | Api에서 정책 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/policies/read | API 수준에서 정책 구성을 가져옵니다. 또는 API 수준에서 정책 구성을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/policies/write | API에 대 한 정책 구성을 만들거나 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/apis/policy/write | API 수준에서 정책 구성 만들기 |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/products/read | API의 일부인 모든 제품을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/read | API Management 서비스 인스턴스의 모든 Api를 나열 합니다. 또는 해당 식별자로 지정 된 API의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/releases/delete | Api의 모든 릴리스를 제거 하거나 API에서 지정 된 릴리스를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/releases/read | API의 모든 릴리스를 나열 합니다.<br>Api 릴리스는 현재 API 수정을 만들 때 생성 됩니다.<br>릴리스는 이전 수정 버전으로 롤백하는 데도 사용 됩니다.<br>결과는 페이징할 수 있으며 $top 및 $skip 매개 변수에 의해 제한 될 수 있습니다.<br>또는 API 릴리스의 세부 정보를 반환 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/releases/write | API에 대 한 새 릴리스를 만듭니다. 또는는 해당 식별자로 지정 된 API 릴리스의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/revisions/delete | API의 모든 수정 버전을 제거합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/revisions/read | API의 모든 수정 버전을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/schemas/delete | Api에서 스키마 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/schemas/read | API 수준에서 스키마 구성을 가져옵니다. 또는 API 수준에서 스키마 구성을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/schemas/write | API에 대 한 스키마 구성을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tagDescriptions/delete | Api에 대 한 태그 설명을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tagDescriptions/read | API의 범위에서 모든 태그 설명을 나열 합니다. Swagger-tagDescription와 유사한 모델은 API 수준에서 정의 되지만 태그는 작업에 할당 되거나 API 범위에서 태그 설명을 가져올 수 있습니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tagDescriptions/write | Api의 범위에서 태그 설명을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tags/delete | Api에서 태그를 분리 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tags/read | API와 연결 된 모든 태그를 나열 합니다. 또는 API와 연결 된 태그를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/tags/write | 태그를 Api에 할당 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apis/write | API Management 서비스 인스턴스의 지정 된 기존 API를 새로 만들거나 업데이트 합니다. 또는 API Management 서비스 인스턴스의 지정 된 API를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apisByTags/read | 태그와 연결 된 api 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apiVersionSets/delete | 특정 Api 버전 집합을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apiVersionSets/read | 지정 된 서비스 인스턴스의 API 버전 집합 컬렉션을 나열 합니다. 또는 식별자로 지정 된 Api 버전 집합의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apiVersionSets/versions/read | 버전 엔터티 목록을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/apiVersionSets/write | Api 버전 집합을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 Api VersionSet의 세부 정보를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/authorizationServers/delete | 특정 권한 부여 서버 인스턴스를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/authorizationServers/read | 서비스 인스턴스 내에 정의 된 권한 부여 서버 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 권한 부여 서버에 대 한 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/authorizationServers/write | 새 권한 부여 서버를 만들거나 기존 권한 부여 서버를 업데이트 합니다. 또는는 해당 식별자로 지정 된 권한 부여 서버의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/backends/delete | 지정 된 백 엔드를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/backends/read | 지정 된 서비스 인스턴스의 백 엔드 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 백 엔드의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/backends/reconnect/action | 지정 된 시간 제한 후에 백 엔드에 대 한 새 연결을 만들도록 APIM 프록시에 알립니다. 제한 시간을 지정 하지 않으면 2 분의 제한 시간이 사용 됩니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/backends/write | 백 엔드를 만들거나 업데이트 합니다. 또는 기존 백 엔드를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/backup/action | 사용자가 제공한 스토리지 계정의 지정된 컨테이너로 API Management 서비스를 백업합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/캐시/삭제 | 특정 캐시를 삭제 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/캐시/읽기 | 지정 된 서비스 인스턴스에 있는 모든 외부 캐시의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 캐시의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/캐시/쓰기 | Api Management 인스턴스에 사용할 외부 캐시를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 캐시의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/certificates/delete | 특정 인증서를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/certificates/read | 지정 된 서비스 인스턴스에 있는 모든 인증서의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 인증서의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/certificates/write | 백 엔드와의 인증에 사용 되는 인증서를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/contentTypes/contentItems/delete | 지정된 콘텐츠 항목을 제거합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/contentTypes/contentItems/read | 콘텐츠 항목 목록을 반환하거나 콘텐츠 항목 세부 정보를 반환합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/contentTypes/contentItems/write | 새 콘텐츠 항목을 만들거나 지정된 콘텐츠 항목을 업데이트합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/contentTypes/read | 콘텐츠 형식을 반환합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/delete | API Management 서비스 인스턴스를 삭제합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/diagnostics/delete | 지정 된 진단을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/diagnostics/read | API Management 서비스 인스턴스에 대 한 모든 진단을 나열 합니다. 또는 해당 식별자로 지정 된 진단 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/diagnostics/write | 새 진단을 만들거나 기존 진단을 업데이트 합니다. 또는는 해당 식별자로 지정 된 진단 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/작업 | 게이트웨이 구성을 검색 합니다. 또는 게이트웨이 하트 비트를 업데이트 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/삭제 | 특정 게이트웨이를 삭제 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/키/작업 | 게이트웨이 키를 검색 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/읽기 | 서비스 인스턴스에 등록 된 게이트웨이의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/regeneratePrimaryKey/작업 | 기본 게이트웨이 키를 생성 하 여 만든 모든 토큰을 invalidationg 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/regenerateSecondaryKey/작업 | Invalidationg 보조 게이트웨이 키를 사용 하 여 만든 모든 토큰을 다시 생성 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/토큰/작업 | 게이트웨이에 대 한 공유 액세스 권한 부여 토큰을 가져옵니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/게이트웨이/쓰기 | Api Management 인스턴스에서 사용할 게이트웨이를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/groups/delete | API Management 서비스 인스턴스의 특정 그룹을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/groups/read | 서비스 인스턴스 내에 정의 된 그룹의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 그룹의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/groups/users/delete | 기존 그룹에서 기존 사용자를 제거 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/groups/users/read | 그룹에 연결 된 사용자 엔터티의 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/groups/users/write | 기존 그룹에 기존 사용자를 추가합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/groups/write | 그룹을 만들거나 업데이트 합니다. 또는 해당 식별자로 지정 된 그룹의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/identityProviders/delete | 지정 된 id 공급자 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/identityProviders/read | 지정 된 서비스 인스턴스에 구성 된 Id 공급자의 컬렉션을 나열 합니다. 또는 지정 된 서비스 인스턴스에 구성 된 id 공급자의 구성 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/identityProviders/write | IdentityProvider 구성을 만들거나 업데이트 합니다. 또는 기존 IdentityProvider 구성을 업데이트 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/문제/읽기 | 지정 된 서비스 인스턴스의 문제 컬렉션을 나열 합니다. 또는 API Management 문제 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/locations/networkstatus/read | 해당 위치에는 서비스가 종속되는 리소스의 네트워크 액세스 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/loggers/delete | 지정 된로 거를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/loggers/read | 지정 된 서비스 인스턴스에 대 한로 거 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된로 거에 대 한 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/loggers/write | 로 거를 만들거나 업데이트 합니다. 또는는 기존로 거를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/read | 서비스 인스턴스 내에 정의 된 속성의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 알림의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientEmails/delete | 알림 목록에서 전자 메일을 제거 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientEmails/read | 알림을 구독 하는 알림 받는 사람 전자 메일의 목록을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientEmails/write | 알림에 대 한 받는 사람 목록에 전자 메일 주소를 추가 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | 알림 목록에서 API Management 사용자를 제거 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientUsers/read | 알림을 구독 하는 알림 받는 사람 목록을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/recipientUsers/write | 알림에 대 한 받는 사람 목록에 API Management 사용자를 추가 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/notifications/write | API Management 게시자 알림을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/openidConnectProviders/delete | API Management 서비스 인스턴스의 특정 Openid connect Connect 공급자를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/openidConnectProviders/read | 모든 Openid connect Connect 공급자 목록입니다. 또는 특정 Openid connect Connect 공급자를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/openidConnectProviders/write | Openid connect Connect 공급자를 만들거나 업데이트 합니다. 또는 특정 Openid connect Connect 공급자를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/operationresults/read | 장기 실행 작업의 현재 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/policies/delete | Api Management 서비스의 전역 정책 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/policies/read | Api Management 서비스의 모든 전역 정책 정의를 나열 합니다. 또는 Api Management 서비스의 전역 정책 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/policies/write | Api Management 서비스의 전역 정책 구성을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/정책/삭제 | 테 넌 트 수준에서 정책 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/정책/읽기 | 테 넌 트 수준에서 정책 구성 가져오기 |
> | 액션(Action) | Microsoft.apimanagement/서비스/정책/쓰기 | 테 넌 트 수준에서 정책 구성 만들기 |
> | 액션(Action) | Microsoft.apimanagement/서비스/정책 설명/읽기 | 모든 정책 설명을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/policySnippets/read | 모든 정책 코드 조각을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/portalsettings/read | 포털에 대 한 로그인 설정을 가져오거나 포털에 대 한 등록 설정을 가져오거나 포털에 대 한 위임 설정을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/portalsettings/write | 로그인 설정을 업데이트 합니다. 또는 로그인 설정을 만들거나 업데이트 합니다. 또는 등록 설정을 업데이트 하거나 등록 설정을 업데이트 하거나 위임 설정을 업데이트 합니다. 또는 위임 설정을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/apis/delete | 지정 된 제품에서 지정 된 API를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/apis/read | 제품과 연결 된 Api 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/apis/write | 지정 된 제품에 API를 추가 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/delete | 제품을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/groups/delete | 지정 된 그룹과 제품 간의 연결을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/groups/read | 지정 된 제품과 연결 된 개발자 그룹의 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/groups/write | 지정 된 제품을 사용 하 여 지정 된 개발자 그룹 간의 연결을 추가 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/policies/delete | 제품에서 정책 구성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/policies/read | 제품 수준에서 정책 구성을 가져옵니다. 또는 제품 수준에서 정책 구성을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/policies/write | 제품에 대 한 정책 구성을 만들거나 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/products/policy/write | 제품 수준에서 정책 구성 만들기 |
> | 액션(Action) | Microsoft.ApiManagement/service/products/read | 지정 된 서비스 인스턴스의 제품 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 제품의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/subscriptions/read | 지정 된 제품에 대 한 구독 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/tags/delete | 제품에서 태그를 분리 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/tags/read | 제품과 연결 된 모든 태그를 나열 합니다. 또는 제품과 연결 된 태그를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/tags/write | 제품에 태그를 할당 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/products/write | 제품을 만들거나 업데이트 합니다. 또는 기존 제품 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/productsByTags/read | 태그와 연결 된 제품의 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/properties/delete | API Management 서비스 인스턴스에서 특정 속성을 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/properties/read | 서비스 인스턴스 내에 정의 된 속성의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 속성의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/properties/write | 속성을 만들거나 업데이트 합니다. 또는 특정 속성을 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.apimanagement/서비스/지역/읽기 | 서비스가 존재 하는 모든 azure 지역을 나열 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/subscriptions/read | API Management 서비스 인스턴스에 대 한 모든 구독을 나열 합니다. 또는 지정 된 구독 엔터티를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/subscriptions/regeneratePrimaryKey/action | API Management 서비스 인스턴스에 대 한 기존 구독의 기본 키를 다시 생성 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | API Management 서비스 인스턴스에 대 한 기존 구독의 보조 키를 다시 생성 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/subscriptions/write | 지정한 제품에 대해 지정한 사용자의 구독을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 구독의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/tagResources/read | 태그와 연결 된 리소스의 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/tags/delete | API Management 서비스 인스턴스의 특정 태그를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/tags/read | 서비스 인스턴스 내에 정의 된 태그의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 태그의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/tags/write | 태그를 만듭니다. 또는는 해당 식별자로 지정 된 태그의 세부 정보를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.ApiManagement/service/tenant/read | Api Management 서비스의 전역 정책 정의를 가져옵니다. 또는 테 넌 트 액세스 정보 정보 가져오기 |
...
> | 액션(Action) | Microsoft.ApiManagement/service/users/delete | 특정 사용자를 삭제 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/generateSsoUrl/action | 지정 된 사용자를 개발자 포털에 서명 하기 위한 인증 토큰이 포함 된 리디렉션 URL을 검색 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/groups/read | 모든 사용자 그룹을 나열 합니다. |
> | 액션(Action) | Microsoft.apimanagement/서비스/사용자/id/읽기 | 모든 사용자 id의 목록입니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/keys/read | 사용자와 연결 된 키 가져오기 |
> | 액션(Action) | Microsoft.ApiManagement/service/users/read | 지정 된 서비스 인스턴스에 등록 된 사용자의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 사용자의 세부 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/subscriptions/read | 지정 된 사용자의 구독 컬렉션을 나열 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/token/action | 사용자에 대 한 공유 액세스 권한 부여 토큰을 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/users/write | 사용자를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 사용자의 세부 정보를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/write | API Management 서비스의 새 인스턴스를 만듭니다. |
...
> | 액션(Action) | Microsoft. 권한 부여/정책/감사/작업 | ' 감사 ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
> | 액션(Action) | Microsoft. 권한 부여/정책/auditIfNotExists/작업 | ' AuditIfNotExists ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
> | 액션(Action) | Microsoft. 권한 부여/정책/거부/작업 | ' 거부 ' 효과가 있는 Azure Policy의 평가 결과로 수행 된 작업 |
> | 액션(Action) | Microsoft. 권한 부여/정책/deployIfNotExists/작업 | ' DeployIfNotExists ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
...
> | 액션(Action) | Microsoft.Automation/automationAccounts/hybridRunbookWorkerGroups/delete | Hybrid Runbook Worker 리소스를 삭제합니다. |
...
> | 액션(Action) | Microsoft.Automation/automationAccounts/linkedWorkspace/read | 자동화 계정에 연결된 작업 영역 가져오기 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/listKeys/action | 자동화 계정에 대한 키를 읽습니다. |
> | 액션(Action) | Microsoft.Automation/automationAccounts/modules/activities/read | Azure Automation 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Automation/automationAccounts/python2Packages/delete | Azure Automation Python 2 패키지를 삭제 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/python2Packages/read | Azure Automation Python 2 패키지를 가져오기 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/python2Packages/write | Azure Automation Python 2 패키지를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/python3Packages/delete | Azure Automation Python 3 패키지를 삭제 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/python3Packages/read | Azure Automation Python 3 패키지를 가져오기 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/python3Packages/write | Azure Automation Python 3 패키지를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Automation/automationAccounts/read | Azure Automation 계정을 가져옵니다. |
...
> | 액션(Action) | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationMachineRuns/read | 소프트웨어 업데이트 구성 컴퓨터 실행 Azure Automation를 가져옵니다. |
> | 액션(Action) | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationRuns/read | Azure Automation 소프트웨어 업데이트 구성 실행을 가져옵니다. |
...
> | 액션(Action) | AzureActiveDirectory/b2ctenants/읽기 | 사용자가 멤버인 모든 B2C 테 넌 트를 나열 합니다. |
...
> | 액션(Action) | Microsoft AzureStack/등록/제품/uploadProductLog/작업 | Azure Stack Marketplace 제품 작업 상태 및 타임 스탬프를 기록 합니다. |
...
> | 액션(Action) | Microsoft.Batch/batchAccounts/pools/write | 배치 계정에 새 풀을 만들거나 기존 풀을 업데이트합니다. |
> | 액션(Action) | Microsoft.Batch/batchAccounts/read | Batch 계정을 나열하거나 Batch 계정의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.Batch/batchAccounts/regeneratekeys/action | Batch 계정에 대한 액세스 키를 다시 생성합니다. |
> | 액션(Action) | Microsoft.Batch/batchAccounts/syncAutoStorageKeys/action | Batch 계정에 대해 구성된 자동 스토리지 계정의 액세스 키를 동기화합니다. |
> | 액션(Action) | Microsoft.Batch/batchAccounts/write | 새 Batch 계정을 만들거나 기존 Batch 계정을 업데이트합니다. |
> | 액션(Action) | Microsoft.Batch/locations/accountOperationResults/read | 장기 실행 배치 계정 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Batch/locations/checkNameAvailability/action | 계정 이름이 올바르고 사용되고 있지 않은지 확인합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. 청구/billingAccounts/계약/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingPermissions/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/billingPermissions/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/고객/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/청구서/가격표/다운로드/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingPermissions/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/이동/동작 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/전송/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/validateMoveEligibility/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/products/move/action |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/제품/전송/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/products/validateMoveEligibility/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/write |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/가격표/다운로드/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/쓰기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingProfiles/쓰기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/billingSubscriptions/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/고객/billingPermissions/읽기 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/고객/읽기 |  |
> | 액션(Action) | Microsoft.Billing/billingAccounts/departments/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/enrollmentAccounts/billingPermissions/read |  |
> | 액션(Action) | Microsoft.Billing/billingAccounts/enrollmentAccounts/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/enrollmentDepartments/billingPermissions/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/listInvoiceSectionsWithCreateSubscriptionPermission/작업 |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/제품/읽기 |  |
> | 액션(Action) | Microsoft.Billing/billingAccounts/read |  |
> | 액션(Action) | Microsoft. 청구/billingAccounts/쓰기 |  |
> | 액션(Action) | Microsoft.Billing/departments/read |  |
> | 액션(Action) | Microsoft.Billing/register/action |  |
> | 액션(Action) | Microsoft. 요금 청구/s i d/작업 |  |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/delete | 기존 Blockchain 멤버를 삭제 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/listApiKeys/작업 | 기존 Blockchain 구성원 Api 키를 가져오거나 나열 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/read | 기존 Blockchain 멤버를 가져오거나 나열 합니다. |
> | DataAction | Microsoft Blockchain/blockchainMembers/transactionNodes/connect/action | Blockchain 구성원 트랜잭션 노드에 연결 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/transactionNodes/delete | 기존 Blockchain 구성원 트랜잭션 노드를 삭제 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/transactionNodes/listApiKeys/작업 | 기존 Blockchain 구성원 트랜잭션 노드 Api 키를 가져오거나 나열 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/transactionNodes/read | 기존 Blockchain 구성원 트랜잭션 노드를 가져오거나 나열 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/transactionNodes/write | Blockchain 구성원 트랜잭션 노드를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft Blockchain/blockchainMembers/write | Blockchain 멤버를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft Blockchain/위치/blockchainMemberOperationResults/읽기 | Blockchain 멤버의 작업 결과를 가져옵니다. |
> | 액션(Action) | Microsoft Blockchain/위치/checkNameAvailability/action | 리소스 이름이 유효 하며 사용 되 고 있지 않은지 확인 합니다. |
> | 액션(Action) | Microsoft Blockchain/작업/읽기 | Microsoft Blockchain 리소스 공급자의 모든 작업을 나열 합니다. |
> | 액션(Action) | Microsoft Blockchain/register/action | Blockchain 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Blueprint/blueprintAssignments/assignmentOperations/read | 모든 청사진 아티팩트 읽기 |
> | 액션(Action) | Microsoft.Blueprint/blueprintAssignments/delete | 청사진 아티팩트 삭제 |
> | 액션(Action) | Microsoft.Blueprint/blueprintAssignments/read | 모든 청사진 아티팩트 읽기 |
> | 액션(Action) | Microsoft. 청사진/blueprintAssignments/whoisblueprint/작업 | Azure 청사진 서비스 사용자 개체 Id를 가져옵니다. |
> | 액션(Action) | Microsoft.Blueprint/blueprintAssignments/write | 청사진 아티팩트 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/artifacts/delete | 청사진 아티팩트 삭제 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/artifacts/read | 모든 청사진 아티팩트 읽기 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/artifacts/write | 청사진 아티팩트 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/delete | 청사진 삭제 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/read | 청사진 읽기 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/versions/artifacts/read | 모든 청사진 아티팩트 읽기 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/versions/delete | 청사진 삭제 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/versions/read | 청사진 읽기 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/versions/write | 청사진 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Blueprint/blueprints/write | 청사진 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Blueprint/register/action | Azure 청사진 리소스 공급자 등록 |
...
> | 액션(Action) | Microsoft.Cache/redis/export/action | Redis 데이터를 지정된 형식의 접두사 지정 스토리지 blob으로 내보냅니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Capacity/appliedreservations/read | 모든 예약을 읽습니다. |
> | 액션(Action) | Microsoft Capacity/calculateexchange/action | 새 구매의 교환 금액 및 가격을 계산 하 고 정책 오류를 반환 합니다. |
> | 액션(Action) | Microsoft.Capacity/calculateprice/action | 예약 가격을 계산합니다. |
> | 액션(Action) | Microsoft.Capacity/catalogs/read | 예약 카탈로그를 읽습니다. |
> | 액션(Action) | Microsoft.Capacity/checkoffers/action | 구독 제안을 확인합니다. |
> | 액션(Action) | Microsoft.Capacity/checkscopes/action | 구독을 확인합니다. |
> | 액션(Action) | Microsoft.Capacity/commercialreservationorders/read | 테넌트에서 작성된 예약 주문을 가져옵니다. |
> | 액션(Action) | Microsoft. 용량/교환/작업 | 모든 예약 교환 |
> | 액션(Action) | Microsoft.Capacity/operations/read | 작업을 읽습니다. |
> | 액션(Action) | Microsoft.Capacity/register/action | 용량 리소스 공급자를 등록하고 용량 리소스 만들기를 사용하도록 설정합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/action | 예약을 업데이트합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/availablescopes/action | 사용 가능한 범위를 찾습니다. |
> | 액션(Action) | Microsoft Capacity/reservationorders/calculaterefund/작업 | 새 구매의 환불 금액 및 가격을 계산 하 고 정책 오류를 반환 합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/delete | 예약을 삭제합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/merge/action | 예약을 병합합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/read | 모든 예약을 읽습니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/reservations/action | 예약을 업데이트합니다. |
> | 액션(Action) | Microsoft Capacity/reservationorders/예약은/availablescopes/action | 사용 가능한 범위를 찾습니다. |
...
> | 액션(Action) | Microsoft.Capacity/reservationorders/return/action | 예약을 반환합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/split/action | 예약을 분할합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/swap/action | 예약을 교환합니다. |
> | 액션(Action) | Microsoft.Capacity/reservationorders/write | 예약을 만듭니다. |
> | 액션(Action) | Microsoft.Capacity/tenants/register/action | 테넌트를 등록합니다. |
> | 액션(Action) | Microsoft.Capacity/unregister/action | 테넌트를 등록 취소합니다. |
> | 액션(Action) | Microsoft.Capacity/validatereservationorder/action | 예약의 유효성을 검사합니다. |
...
> | 액션(Action) | Microsoft.Cdn/profiles/endpoints/Purge/action |  |
...
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/roles/read | 도메인 이름의 배포 슬롯의 역할 가져오기 |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/roles/roleinstances/read | 도메인 이름의 배포 슬롯의 역할에 대한 역할 인스턴스 가져오기 |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/state/read | 배포 슬롯 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/state/write | 배포 슬롯 상태를 추가합니다. |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/upgradedomain/read | 도메인 이름의 배포 슬롯에 대한 업그레이드 도메인 가져오기 |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/upgradedomain/write | 도메인 이름의 배포 슬롯에 대한 업그레이드 도메인 업데이트 |
> | 액션(Action) | Microsoft.ClassicCompute/domainNames/deploymentslots/write | 배포를 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft.ClassicNetwork/virtualNetworks/gateways/stopDiagnostics/action | 가상 네트워크 게이트웨이에 대한 진단을 중지합니다. |
> | 액션(Action) | Microsoft.ClassicNetwork/virtualNetworks/gateways/write | 가상 네트워크 게이트웨이를 추가합니다. |
...
> | 액션(Action) | Microsoft.ClassicStorage/checkStorageAccountAvailability/action | 스토리지 계정의 가용성을 확인합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/checkStorageAccountAvailability/read | 스토리지 계정의 가용성을 가져옵니다. |
> | 액션(Action) | Microsoft.ClassicStorage/disks/read | 스토리지 계정 디스크를 반환합니다. |
...
> | 액션(Action) | Microsoft.ClassicStorage/operations/read | 클래식 스토리지 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.ClassicStorage/register/action | 클래식 스토리지에 등록합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/abortMigration/action | 스토리지 계정의 마이그레이션을 중단합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/blobServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/blobServices/providers/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/blobServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/commitMigration/action | 스토리지 계정의 마이그레이션을 커밋합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/delete | 스토리지 계정을 삭제합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/disks/delete | 지정된 스토리지 계정 디스크를 삭제합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/disks/operationStatuses/read | 리소스의 작업 상태를 읽습니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/disks/read | 스토리지 계정 디스크를 반환합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/disks/write | 스토리지 계정 디스크를 추가합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/fileServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/fileServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/fileServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/images/operationstatuses/read | 스토리지 계정 이미지 작업 상태를 반환합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/images/read | 스토리지 계정 이미지를 반환합니다. (사용되지 않음, 대신 ‘Microsoft.ClassicStorage/storageAccounts/vmImages’ 사용) |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/listKeys/action | 스토리지 계정의 액세스 키를 나열합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/operationStatuses/read | 리소스의 작업 상태를 읽습니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/osImages/delete | 지정된 스토리지 계정 운영 체제 이미지를 삭제합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/osImages/read | 스토리지 계정 운영 체제 이미지를 반환합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/osImages/write | 지정된 스토리지 계정 운영 체제 이미지를 추가합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/prepareMigration/action | 스토리지 계정의 마이그레이션을 준비합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/providers/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/queueServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/queueServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/queueServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/read | 지정된 계정의 스토리지 계정을 반환합니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/regenerateKey/action | 스토리지 계정에 대한 기존 액세스 키를 다시 생성합니다. |
...
> | 액션(Action) | ClassicStorage/storageAccounts/tableServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/tableServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | ClassicStorage/storageAccounts/tableServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/validateMigration/action | 스토리지 계정의 마이그레이션 유효성을 검사합니다. |
...
> | 액션(Action) | Microsoft.ClassicStorage/storageAccounts/write | 새 스토리지 계정을 추가합니다. |
...
> | DataAction | Cognitiveservices account/accounts/ComputerVision/generatethumbnail 그림/작업 | 이 작업을 수행 하면 사용자 지정 너비와 높이가 포함 된 미리 보기 이미지가 생성 됩니다.<br> 기본적으로이 서비스는 이미지를 분석 하 고, ROI (관심 영역)를 식별 하며, ROI에 따라 스마트 자르기 좌표를 생성 합니다.<br> 스마트 자르기는 입력 이미지의 가로 세로 비율을 지정 하는 경우에 유용 합니다. |
...
> | 액션(Action) | Microsoft.CognitiveServices/accounts/listKeys/action | 키를 나열합니다. |
...
> | DataAction | Cognitiveservices account/계정/텍스트 분석/엔터티/작업 | API는 지정 된 문서에서 알려진 엔터티와 일반적인 명명 된 엔터티 (\"Person\", \"Location\", \"조직\" 등) 목록을 반환 합니다. |
> | DataAction | Cognitiveservices account/accounts/TextAnalytics/keyphrases/action | 이 API는 입력 텍스트의 핵심 요지를 나타내는 문자열 목록을 반환합니다. |
> | DataAction | Cognitiveservices account/계정/텍스트 분석/언어/작업 | 이 API는 검색된 언어 및 0~1 사이의 숫자 점수를 추출합니다. 점수가 1에 가까울수록 식별된 언어가 true라는 100% 확실성을 나타냅니다. 총 120개의 언어가 지원됩니다. |
...
> | 액션(Action) | Cognitiveservices account/checkDomainAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> | 액션(Action) | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> | 액션(Action) | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> | 액션(Action) | Cognitiveservices account/위치/deleteVirtualNetworkOrSubnets/작업 | VirtualNetworks 또는 서브넷을 삭제 하는 Microsoft 네트워크의 알림입니다. |
...
> | 액션(Action) | Microsoft. Compute/Disk를 설정/삭제 | 디스크 암호화 집합 삭제 |
> | 액션(Action) | Microsoft. Compute/Disk를 설정/읽기 | 디스크 암호화 집합의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. Compute/Disk/Set/write | 새 디스크 암호화 집합 만들기 또는 기존 항목 업데이트 |
...
> | 액션(Action) | Microsoft. Compute/hostGroups/delete | 호스트 그룹을 삭제 합니다. |
> | 액션(Action) | Microsoft. Compute/hostGroups/hosts/delete | 호스트를 삭제 합니다. |
> | 액션(Action) | Microsoft. Compute/hostGroups/hosts/read | 호스트의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. Compute/hostGroups/hosts/write | 새 호스트를 만들거나 기존 호스트를 업데이트 합니다. |
> | 액션(Action) | Microsoft. Compute/hostGroups/read | 호스트 그룹의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. Compute/hostGroups/write | 새 호스트 그룹을 만들거나 기존 호스트 그룹을 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.Compute/locations/logAnalytics/getRequestRateByInterval/action | 제한 진단을 지원하기 위해 시간 간격별로 총 요청을 표시할 로그를 만듭니다. |
> | 액션(Action) | Microsoft.Compute/locations/logAnalytics/getThrottledRequests/action | ResourceName, OperationName 또는 적용된 제한 정책에서 그룹화한 제한된 요청의 집계를 표시할 로그를 만듭니다. |
> | 액션(Action) | Microsoft.Compute/locations/operations/read | 비동기 작업의 상태를 가져옵니다. |
...
> | 액션(Action) | Microsoft. Compute/proximityPlacementGroups/delete | 근접 배치 그룹을 삭제 합니다. |
> | 액션(Action) | Microsoft. Compute/proximityPlacementGroups/read | 근접 배치 그룹의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. Compute/proximityPlacementGroups/write | 새 근접 배치 그룹을 만들거나 기존 항목을 업데이트 합니다. |
...
> | 액션(Action) | Microsoft. Compute/등록 취소/작업 | Microsoft. Compute 리소스 공급자를 사용 하 여 구독 등록을 취소 합니다. |
> | 액션(Action) | Microsoft.Compute/virtualMachines/capture/action | 가상 하드 디스크를 복사하여 가상 머신을 캡처하고 유사한 가상 머신을 만드는 데 사용할 수 있는 템플릿을 생성합니다. |
...
> | 액션(Action) | Microsoft.Compute/virtualMachines/read | 가상 머신의 속성을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Compute/virtualMachineScaleSets/virtualMachines/read | VM 확장 집합에서 Virtual Machine의 속성을 가져옵니다. |
...
> | 액션(Action) | Microsoft. Compute/virtualMachineScaleSets/vmSizes/읽기 | 가상 머신 확장 집합에서 가상 머신을 만들거나 업데이트 하는 데 사용할 수 있는 크기를 나열 합니다. |
...
> | 액션(Action) | Microsoft.Consumption/budgets/delete | 구독 또는 관리 그룹별로 예산을 삭제합니다. |
> | 액션(Action) | Microsoft.Consumption/budgets/read | 구독 또는 관리 그룹별로 예산을 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/budgets/write | 구독 또는 관리 그룹별로 예산을 만들고 업데이트합니다. |
> | 액션(Action) | Microsoft.Consumption/charges/read | 요금을 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/credits/read | 크레딧을 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/events/read | 이벤트를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/forecasts/read | 예측을 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/lots/read | lots를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/marketplaces/read | EA 및 WebDirect 구독의 범위에 대한 마켓플레이스 리소스 사용 정보를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/operations/read | 작업 결과를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/operations/read | Microsoft.Consumption 리소스 공급자가 지원하는 모든 작업을 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/operationstatus/read | 작업 상태를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/pricesheets/read | 구독 또는 관리 그룹의 가격표 데이터를 나열합니다. |
> | 액션(Action) | Microsoft.Consumption/register/action | 소비 RP에 등록합니다. |
> | 액션(Action) | Microsoft.Consumption/reservationDetails/read | 예약된 인스턴스의 사용률 세부 정보를 예약 순서 또는 관리 그룹별로 나열합니다. 세부 정보 데이터는 일별 인스턴스 수준입니다. |
...
> | 액션(Action) | Microsoft.Consumption/tags/read | EA 및 구독에 대한 태그를 나열합니다. |
> | 액션(Action) | Microsoft 사용/테 넌 트/읽기 | 테 넌 트 나열 |
> | 액션(Action) | Microsoft.Consumption/tenants/register/action | 테넌트에 의한 Microsoft.Consumption 범위에 대한 작업을 등록합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/containers/exec/action | 특정 컨테이너에 실행합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/containers/logs/read | 특정 컨테이너에 대한 로그를 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/delete | 특정 컨테이너 그룹을 삭제합니다. |
> | 액션(Action) | ContainerInstance/containerGroups/operationResults/read | 비동기 작업 결과 가져오기 |
...
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/restart/action | 특정 컨테이너 그룹을 다시 시작합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/start/action | 특정 컨테이너 그룹을 시작합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/stop/action | 특정 컨테이너 그룹을 중지합니다. 컴퓨팅 리소스 할당이 취소되고 청구가 중지됩니다. |
> | 액션(Action) | Microsoft.ContainerInstance/containerGroups/write | 특정 컨테이너 그룹을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/locations/cachedImages/read | Azure 지역의 구독에 대해 캐시된 이미지를 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerInstance/locations/capabilities/read | Azure 지역에 대한 기능을 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerInstance/locations/deleteVirtualNetworkOrSubnets/action | 가상 네트워크 또는 서브넷이 삭제됨을 Microsoft.ContainerInstance에 알립니다. |
> | 액션(Action) | ContainerInstance/위치/작업/읽기 | Azure Container Instance 서비스에 대 한 작업을 나열 합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/locations/usages/read | 특정 Azure 지역의 사용량을 가져옵니다. |
> | 액션(Action) | ContainerInstance/작업/읽기 | Azure Container Instance 서비스에 대 한 작업을 나열 합니다. |
> | 액션(Action) | Microsoft.ContainerInstance/register/action | 컨테이너 인스턴스 리소스 공급자에 대한 구독을 등록하고 컨테이너 그룹을 만들 수 있도록 합니다. |
> | 액션(Action) | ContainerInstance/serviceassociationlinks/delete | 서브넷에서 azure container instance 리소스 공급자에 의해 만들어진 서비스 연결 링크를 삭제 합니다. |
...
> | 액션(Action) | Microsoft.containerregistry/레지스트리/아티팩트/삭제 | 컨테이너 레지스트리에서 아티팩트를 삭제 합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/builds/cancel/action | 기존 빌드를 취소합니다. |
...
> | 액션(Action) | Microsoft.ContainerRegistry/registries/listBuildSourceUploadUrl/action | 컨테이너 레지스트리에 대한 원본 업로드 URL 위치를 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/listCredentials/action | 지정된 컨테이너 레지스트리에 대한 로그인 자격 증명을 나열합니다. |
...
> | 액션(Action) | Microsoft.containerregistry/registry/metadata/read | 컨테이너 레지스트리에 대 한 특정 리포지토리의 메타 데이터를 가져옵니다. |
> | 액션(Action) | Microsoft.containerregistry/registry/metadata/write | 컨테이너 레지스트리에 대 한 리포지토리의 메타 데이터를 업데이트 합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/operationStatuses/read | 레지스트리 비동기 작업 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/pull/read | 컨테이너 레지스트리에서 이미지를 끌어오거나 가져옵니다. |
...
> | 액션(Action) | Microsoft.ContainerRegistry/registries/runs/cancel/action | 기존 실행을 취소합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/runs/listLogSasUrl/action | 실행을 위한 로그 SAS URL을 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/runs/read | 컨테이너 레지스트리 또는 목록 실행에 대한 실행 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/runs/write | 실행을 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/scheduleRun/action | 컨테이너 레지스트리에 대한 실행을 예약합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/sign/write | 컨테이너 레지스트리에 대한 콘텐츠 신뢰 메타데이터를 푸시/풀합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/tasks/delete | 컨테이너 레지스트리에 대한 작업을 삭제합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/tasks/listDetails/action | 컨테이너 레지스트리에 대한 작업의 모든 세부 정보를 나열합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/tasks/read | 컨테이너 레지스트리에 대한 작업을 가져오거나 모든 작업을 나열합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/tasks/write | 컨테이너 레지스트리에 대한 작업을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerRegistry/registries/updatePolicies/write | 지정된 컨테이너 레지스트리에 대한 정책을 업데이트합니다. |
...
> | 액션(Action) | ContainerService/managedClusters/agentPools/delete | 에이전트 풀을 삭제 합니다. |
> | 액션(Action) | ContainerService/managedClusters/agentPools/read | 에이전트 풀을 가져옵니다. |
> | 액션(Action) | ContainerService/managedClusters/agentPools/upgradeProfiles/read | 에이전트 풀의 업그레이드 프로필을 가져옵니다. |
> | 액션(Action) | ContainerService/managedClusters/agentPools/write | 새 에이전트 풀을 만들거나 기존 에이전트 풀을 업데이트 합니다. |
> | 액션(Action) | Microsoft.ContainerService/managedClusters/delete | 관리되는 클러스터를 삭제합니다. |
> | 액션(Action) | ContainerService/managedClusters/감지기/read | 관리 되는 클러스터 탐지기 가져오기 |
> | 액션(Action) | ContainerService/managedClusters/diagnosticsState/read | 클러스터의 진단 상태를 가져옵니다. |
...
> | 액션(Action) | ContainerService/managedClusters/privateEndpointConnectionsApproval/작업 | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
> | 액션(Action) | Microsoft.ContainerService/managedClusters/read | 관리되는 클러스터를 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerService/managedClusters/resetAADProfile/action | 관리형 클러스터의 AAD 프로필을 다시 설정합니다. |
> | 액션(Action) | Microsoft.ContainerService/managedClusters/resetServicePrincipalProfile/action | 관리형 클러스터의 서비스 주체 프로필을 다시 설정합니다. |
> | 액션(Action) | ContainerService/managedClusters/upgradeProfiles/read | 클러스터의 업그레이드 프로필을 가져옵니다. |
> | 액션(Action) | Microsoft.ContainerService/managedClusters/write | 새 관리되는 클러스터를 만들거나 기존 관리되는 클러스터를 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerService/openShiftClusters/delete | 열린 Shift 클러스터 삭제 |
> | 액션(Action) | Microsoft.ContainerService/openShiftClusters/read | 열린 Shift 클러스터 가져오기 |
> | 액션(Action) | Microsoft.ContainerService/openShiftClusters/write | 새 Open Shift 클러스터를 만들거나 기존 Open Shift 클러스터를 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerService/openShiftManagedClusters/delete | 열린 Shift 관리 클러스터 삭제 |
> | 액션(Action) | Microsoft.ContainerService/openShiftManagedClusters/read | Open Shift 관리 되는 클러스터 가져오기 |
> | 액션(Action) | Microsoft.ContainerService/openShiftManagedClusters/write | 새 Open Shift 관리형 클러스터를 만들거나 기존 Open Shift 관리 클러스터를 업데이트합니다. |
> | 액션(Action) | Microsoft.ContainerService/operations/read | Microsoft.ContainerService 리소스 공급자에서 사용 가능한 작업을 나열합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | CostManagement/cloudConnectors/delete | 지정 된 cloudConnector를 삭제 합니다. |
> | 액션(Action) | CostManagement/cloudConnectors/read | 인증 된 사용자에 대 한 cloudConnectors를 나열 합니다. |
> | 액션(Action) | CostManagement/cloudConnectors/write | 지정 된 cloudConnector를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.CostManagement/dimensions/read | 범위별 지원되는 모든 차원을 나열합니다. |
> | 액션(Action) | Microsoft.CostManagement/exports/action | 지정된 내보내기를 실행합니다. |
> | 액션(Action) | Microsoft.CostManagement/exports/delete | 지정된 내보내기를 삭제합니다. |
> | 액션(Action) | Microsoft.CostManagement/exports/read | 범위에 따라 내보내기를 나열합니다. |
> | 액션(Action) | CostManagement/내보내기/실행/작업 | 내보내기를 실행 합니다. |
> | 액션(Action) | Microsoft.CostManagement/exports/write | 지정된 내보내기를 만들거나 업데이트합니다. |
> | 액션(Action) | CostManagement/externalBillingAccounts/externalSubscriptions/read | 인증 된 사용자에 대 한 externalBillingAccount 내에 externalSubscriptions을 나열 합니다. |
> | 액션(Action) | CostManagement/externalBillingAccounts/읽기 | 인증 된 사용자에 대 한 externalBillingAccounts를 나열 합니다. |
> | 액션(Action) | CostManagement/externalSubscriptions/read | 인증 된 사용자에 대 한 externalSubscriptions을 나열 합니다. |
> | 액션(Action) | CostManagement/externalSubscriptions/write | ExternalSubscription의 연결 된 관리 그룹 업데이트 |
> | 액션(Action) | Microsoft.CostManagement/query/action | 범위별 사용량 현황 데이터를 쿼리합니다. |
> | 액션(Action) | Microsoft.CostManagement/query/read | 범위별 사용량 현황 데이터를 쿼리합니다. |
> | 액션(Action) | CostManagement/register/action | 구독에의 한 CostManagement 범위에 대 한 작업을 등록 합니다. |
> | 액션(Action) | Microsoft.CostManagement/reports/action | 범위별 사용량 현황 데이터에 관한 보고서를 예약합니다. |
> | 액션(Action) | Microsoft.CostManagement/reports/read | 범위별 사용량 현황 데이터에 관한 보고서를 예약합니다. |
> | 액션(Action) | CostManagement/테 넌 트/등록/작업 | CostManagement의 범위에 대 한 작업을 테 넌 트에 등록 합니다. |
...
> | 액션(Action) | Microsoft.DataBox/jobs/delete | 주문을 삭제합니다. |
> | 액션(Action) | Microsoft.DataBox/jobs/listCredentials/action | 주문과 관련된 암호화되지 않은 자격 증명을 나열합니다. |
> | 액션(Action) | Microsoft.DataBox/jobs/read | 주문을 나열하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBox/jobs/write | 주문을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.DataBox/locations/availableSkus/action | 이 메서드는 사용할 수 있는 SKU 목록을 반환합니다. |
> | 액션(Action) | DataBox/위치/availableSkus/읽기 | 사용 가능한 Sku 나열 또는 가져오기 |
> | 액션(Action) | Microsoft.DataBox/locations/operationResults/read | 작업 결과를 나열하거나 가져옵니다. |
> | 액션(Action) | DataBox/위치/지역 구성/작업 | 이 메서드는 영역에 대 한 구성을 반환 합니다. |
> | 액션(Action) | Microsoft.DataBox/locations/validateAddress/action | 배송 주소의 유효성을 검사하고, 있는 경우, 대체 주소를 제공합니다. |
> | 액션(Action) | DataBox/위치/validateInputs/작업 | 이 메서드는 모든 유형의 유효성 검사를 수행 합니다. |
> | 액션(Action) | DataBox/작업/읽기 | 작업 나열 또는 가져오기 |
> | 액션(Action) | Microsoft.DataBox/register/action | 공급자 Microsoft.Databox를 등록합니다. |
> | 액션(Action) | DataBox/subscription/resourceGroups/moveResources/action | 이 메서드는 리소스 이동을 수행 합니다. |
> | 액션(Action) | DataBox/subscription/resourceGroups/validateMoveResources/action | 이 메서드는 리소스 이동이 허용 되는지 여부를 확인 합니다. |
> | 액션(Action) | DataBox/등록 취소/작업 | 공급자 등록 취소 Databox |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/alerts/read | 경고를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/alerts/read | 경고를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/delete | 대역폭 일정을 삭제 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/read | 대역폭 일정을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/read | 대역폭 일정을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/write | 대역폭 일정을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/delete | Data Box Edge 디바이스를 삭제 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/downloadUpdates/action | 디바이스에서 업데이트를 다운로드 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | 리소스 확장 정보를 검색 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/installUpdates/action | 디바이스에 업데이트를 설치 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/jobs/read | 작업을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/networkSettings/read | 디바이스 네트워크 설정을 나열하거나 가져오기 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/노드/읽기 | 노드를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/operationsStatus/read | 작업 상태를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/주문/삭제 | 주문을 삭제 합니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/orders/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/주문/읽기 | 주문을 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/주문/읽기 | 주문을 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/주문/쓰기 | 주문을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/read | Data Box Edge 디바이스를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/read | Data Box Edge 디바이스를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/read | Data Box Edge 디바이스를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/delete | 역할을 삭제 합니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/역할/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/write | 역할을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/scanForUpdates/action | 업데이트를 검색 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/securitySettings/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/securitySettings/update/action | 보안 설정을 업데이트 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/delete | 공유를 삭제 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/공유/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/read | 공유를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/read | 공유를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/refresh/action | 클라우드의 데이터로 공유 메타 데이터를 새로 고칩니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/write | 공유를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/delete | 스토리지 계정 자격 증명을 삭제 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/read | 스토리지 계정 자격 증명을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/read | 스토리지 계정 자격 증명을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/write | 스토리지 계정 자격 증명을 만들거나 업데이트 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/triggers/delete | 트리거를 삭제 합니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/triggers/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/트리거/읽기 | 트리거를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/트리거/읽기 | 트리거를 나열 하거나 가져옵니다. |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/triggers/write | 트리거를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/updateSummary/read | 업데이트 요약을 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/uploadCertificate/action | 디바이스 등록에 대한 인증서를 업로드 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/delete | 공유 사용자를 삭제 |
> | 액션(Action) | DataBoxEdge/dataBoxEdgeDevices/사용자/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/read | 공유 사용자를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/read | 공유 사용자를 나열하거나 가져오기 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/write | 공유 사용자를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Data Box Edge 디바이스를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Data Box Edge 디바이스를 만들거나 업데이트 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Databricks/위치/a p Network정책/작업 | NRP에서 사용 하는 위치에 따라 서브넷에 대 한 네트워크 의도 정책 가져오기 |
> | 액션(Action) | Microsoft.Databricks/register/action | Databricks에 등록합니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/delete | Databricks 작업 영역을 제거합니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/diagnosticSettings/read | Databricks 작업 영역에 사용할 수 있는 진단 설정을 구성합니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/logDefinitions/read | Databricks 작업 영역에 사용할 수 있는 로그 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/read | Databricks 작업 영역의 목록을 검색합니다. |
> | 액션(Action) | Microsoft.Databricks/workspaces/write | Databricks 작업 영역을 만듭니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.DataCatalog/catalogs/delete | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 삭제 합니다. |
> | 액션(Action) | Microsoft.DataCatalog/catalogs/read | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.DataCatalog/catalogs/write | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 작성 합니다. |
> | 액션(Action) | Microsoft.datacatalog/checkNameAvailability/read | Data Catalog 리소스 공급자에 대 한 카탈로그 이름 가용성을 확인 합니다. |
> | 액션(Action) | Microsoft.datacatalog/datacatalogs/delete | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 삭제 합니다. |
> | 액션(Action) | Microsoft.datacatalog/datacatalogs/읽기 | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.datacatalog/datacatalogs/write | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 씁니다. |
> | 액션(Action) | Microsoft.DataCatalog/operations/read | Data Catalog 리소스 공급자에서 사용 가능한 모든 작업을 읽습니다. |
> | 액션(Action) | Microsoft.DataCatalog/register/action | Data Catalog 리소스 공급자에 대 한 구독 등록 |
> | 액션(Action) | Microsoft.DataCatalog/unregister/action | Data Catalog 리소스 공급자에 대 한 구독 등록 취소 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.DataFactory/checkazuredatafactorynameavailability/read | Data Factory 이름을 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft.DataFactory/datafactories/activitywindows/read | 지정된 매개 변수를 사용하여 Data Factory의 활동 창을 읽습니다. |
...
> | 액션(Action) | Microsoft.DataFactory/datafactories/read | Data Factory를 읽습니다. |
...
> | 액션(Action) | DataFactory/공장/cancelSandboxPipelineRun/작업 | 파이프라인에 대 한 디버그 실행을 취소 합니다. |
> | 액션(Action) | DataFactory/공장/createdataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 만듭니다. |
> | 액션(Action) | DataFactory/factory/데이터 흐름/delete | 데이터 흐름을 삭제 합니다. |
> | 액션(Action) | DataFactory/factory/데이터 흐름/read | 데이터 흐름을 읽습니다. |
> | 액션(Action) | DataFactory/factory/데이터 흐름/write | 데이터 흐름 만들기 또는 업데이트 |
...
> | 액션(Action) | DataFactory/공장/debugpipelineruns/취소/작업 | 파이프라인에 대 한 디버그 실행을 취소 합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/delete | 데이터 팩터리를 삭제합니다. |
> | 액션(Action) | DataFactory/공장/deletedataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 삭제 합니다. |
> | 액션(Action) | DataFactory/팩터리/Getdata계획 Eaccess/action | ADF 데이터 평면 서비스에 대한 액세스를 가져옵니다. |
> | 액션(Action) | DataFactory/factory/Getdata계획 Eaccess/read | ADF 데이터 평면 서비스에 대한 액세스를 읽습니다. |
> | 액션(Action) | DataFactory/factory/getFeatureValue/action | 특정 위치에 대한 노출 제어 기능 값을 가져옵니다. |
> | 액션(Action) | DataFactory/factory/getFeatureValue/read | 특정 위치에 대한 노출 제어 기능 값을 읽습니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/getGitHubAccessToken/action | GitHub 액세스를 토큰을 가져옵니다. |
...
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/getObjectMetadata/action | 지정된 Integration Runtime에 대한 SSIS Integration Runtime 메타데이터를 가져옵니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/getstatus/read | Integration Runtime 상태를 읽습니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/linkedIntegrationRuntime/action | 지정된 공유 Integration Runtime에 연결된 Integration Runtime 참조를 만듭니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/listauthkeys/read | 모든 Integration Runtime에 대한 인증 키를 나열합니다. |
...
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/nodes/read | 지정된 Integration Runtime에 대한 노드를 읽습니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/nodes/write | 자체 호스팅 Integration Runtime 노드를 업데이트합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/read | 모든 Integration Runtime을 읽습니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/refreshObjectMetadata/action | 지정된 Integration Runtime에 대한 SSIS Integration Runtime 메타데이터를 새로 고칩니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/regenerateauthkey/action | 지정된 Integration Runtime에 대한 인증 키를 다시 생성합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/removelinks/action | 지정된 Integration Runtime에서 연결된 Integration Runtime 참조를 제거합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/integrationruntimes/start/action | 모든 Integration Runtime을 시작합니다. |
...
> | 액션(Action) | DataFactory/공장/파이프라인/sandbox/작업 | 파이프라인에 대 한 디버그 실행 환경을 만듭니다. |
> | 액션(Action) | DataFactory/공장/파이프라인/sandbox/만들기/작업 | 파이프라인에 대 한 디버그 실행 환경을 만듭니다. |
> | 액션(Action) | DataFactory/공장/파이프라인/sandbox/실행/작업 | 파이프라인에 대 한 디버그 실행을 만듭니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/pipelines/write | 파이프라인을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/querydebugpipelineruns/action | 디버그 파이프라인 실행을 쿼리합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/querypipelineruns/action | 파이프라인 실행을 쿼리합니다. |
...
> | 액션(Action) | DataFactory/factory/sandboxpipelineruns/sandboxActivityRuns/read | 활동에 대 한 디버그 실행 정보를 가져옵니다. |
> | 액션(Action) | DataFactory/공장/startdataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 시작 합니다. |
> | 액션(Action) | DataFactory/공장/submitDataFlowForPreview/작업 | 디버그 세션을 사용 하 여 데이터 미리 보기를 가져오기 위해 데이터 흐름을 제출 합니다. |
> | 액션(Action) | Microsoft.DataFactory/factories/triggerruns/read | 트리거 실행을 읽습니다. |
...
> | 액션(Action) | Microsoft.DataFactory/locations/getFeatureValue/action | 특정 위치에 대한 노출 제어 기능 값을 가져옵니다. |
> | 액션(Action) | Microsoft.DataFactory/locations/getFeatureValue/read | 특정 위치에 대한 노출 제어 기능 값을 읽습니다. |
> | 액션(Action) | Microsoft.DataFactory/operations/read | Microsoft Data Factory 공급자의 모든 작업을 읽습니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/computePolicies/Delete | 컴퓨팅 정책을 삭제합니다. |
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/computePolicies/read | 컴퓨팅 정책에 대한 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/computePolicies/Write | 컴퓨팅 정책을 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/read | 기존 DataLakeAnalytics 계정에 대한 정보를 가져옵니다. |
...
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/transferAnalyticsUnits/action | DataLakeAnalytics 계정 간에 SystemMaxAnalyticsUnits를 전송합니다. |
> | 액션(Action) | DataLakeAnalytics/accounts/virtualNetworkRules/delete | 가상 네트워크 규칙을 삭제 합니다. |
> | 액션(Action) | DataLakeAnalytics/계정/virtualNetworkRules/읽기 | 가상 네트워크 규칙에 대 한 정보를 가져옵니다. |
> | 액션(Action) | DataLakeAnalytics/accounts/virtualNetworkRules/write | 가상 네트워크 규칙을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DataLakeAnalytics/accounts/Write | DataLakeAnalytics 계정을 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft.DataLakeAnalytics/locations/usages/read | DataLakeAnalytics 사용과 관련된 구독의 할당량 사용량 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.DataLakeAnalytics/operations/read | DataLakeAnalytics에서 사용 가능한 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.DataLakeStore/accounts/read | 기존 DataLakeStore 계정에 대한 정보를 가져옵니다. |
> | 액션(Action) | DataLakeStore/계정/공유/삭제 | 공유를 삭제 합니다. |
> | 액션(Action) | DataLakeStore/계정/공유/읽기 | 공유에 대 한 정보를 가져옵니다. |
> | 액션(Action) | DataLakeStore/계정/공유/쓰기 | 공유를 만들거나 업데이트 합니다. |
...
> | 액션(Action) | DataLakeStore/accounts/virtualNetworkRules/delete | 가상 네트워크 규칙을 삭제 합니다. |
> | 액션(Action) | DataLakeStore/계정/virtualNetworkRules/읽기 | 가상 네트워크 규칙에 대 한 정보를 가져옵니다. |
> | 액션(Action) | DataLakeStore/accounts/virtualNetworkRules/write | 가상 네트워크 규칙을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DataLakeStore/accounts/write | DataLakeStore 계정을 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft.DataLakeStore/locations/usages/read | DataLakeStore 사용과 관련된 구독의 할당량 사용량 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.DataLakeStore/operations/read | DataLakeStore에서 사용 가능한 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.datamigration/서비스/addWorker/작업 | 서비스의 availiable 작업자에 DMS 작업자를 추가 합니다. |
> | 액션(Action) | Microsoft.DataMigration/services/checkStatus/action | 서비스가 배포되어 실행되고 있는지 확인합니다. |
> | 액션(Action) | Microsoft.datamigration/서비스/configureWorker/작업 | 서비스의 availiable 작업자에 대해 DMS 작업자를 구성 합니다. |
> | 액션(Action) | Microsoft.DataMigration/services/delete | 리소스와 해당 하위 항목을 모두 삭제합니다. |
...
> | 액션(Action) | Microsoft.datamigration/services/removeWorker/action | 서비스의 availiable 작업자에 대해 DMS 작업자를 제거 합니다. |
> | 액션(Action) | Microsoft.datamigration/services/serviceTasks/취소/작업 | 작업이 현재 실행 중인 경우 취소합니다. |
...
> | 액션(Action) | Microsoft.datamigration/services/updateAgentConfig/action | 제공 된 값을 사용 하 여 DMS 에이전트 구성을 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | DBforMariaDB/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> | 액션(Action) | DBforMariaDB/위치/azureAsyncOperation/읽기 | 서버 작업 결과 반환 (& u) |
> | 액션(Action) | DBforMariaDB/위치/operationResults/read | ResourceGroup 기반 MariaDB 서버 작업 결과 반환 |
> | 액션(Action) | DBforMariaDB/위치/operationResults/read | 서버 작업 결과 반환 (& u) |
> | 액션(Action) | Microsoft.DBforMariaDB/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | 액션(Action) | DBforMariaDB/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | DBforMariaDB/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | DBforMariaDB/작업/읽기 | 작업 목록 반환. |
> | 액션(Action) | Microsoft.DBforMariaDB/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | 액션(Action) | DBforMariaDB/register/action | MariaDB 리소스 공급자 등록 |
> | 액션(Action) | DBforMariaDB/servers/administrators/delete | 기존 관리자의 기존 관리자를 삭제 합니다. |
> | 액션(Action) | DBforMariaDB/servers/administrators/read | MariaDB 서버 관리자의 목록을 가져옵니다. |
> | 액션(Action) | DBforMariaDB/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 MariaDB 서버 관리자를 만들거나 업데이트 합니다. |
> | 액션(Action) | DBforMariaDB/servers/advisor/createRecommendedActionSession/작업 | 새 권장 구성 작업 세션을 만듭니다. |
> | 액션(Action) | DBforMariaDB/servers/advisor/read | 관리자 목록을 반환합니다. |
> | 액션(Action) | DBforMariaDB/servers/advisor/read | Advisor 반환 |
> | 액션(Action) | DBforMariaDB/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 액션(Action) | DBforMariaDB/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 액션(Action) | DBforMariaDB/servers/advisor/recommendedActions/read | 권장 작업 반환 |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/configurations/read | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/configurations/write | 지정된 구성의 값을 업데이트합니다. |
> | 액션(Action) | DBforMariaDB/서버/데이터베이스/삭제 | 기존에 있는 데이터베이스를 삭제 합니다. |
> | 액션(Action) | DBforMariaDB/서버/데이터베이스/읽기 | 반환 된 데이터베이스에 대 한 속성을 가져오거나 반환 합니다. |
> | 액션(Action) | DBforMariaDB/servers/databases/write | 지정 된 매개 변수를 사용 하 여, 지정 된 데이터베이스에 대 한 속성을 업데이트 하는에 대 한 속성을 업데이트 합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/delete | 기존 서버를 삭제합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/firewallRules/delete | 기존 방화벽 규칙을 삭제합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/firewallRules/read | 서버에 대한 방화벽 규칙 목록을 반환하거나 지정된 방화벽 규칙에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/firewallRules/write | 지정된 매개 변수를 사용하여 방화벽 규칙을 만들거나 기존 규칙을 업데이트합니다. |
> | 액션(Action) | DBforMariaDB/servers/logFiles/read | Aadb LogFiles의 목록을 반환 합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/providers/Microsoft.Insights/diagnosticSettings/read | 리소스에 대한 진단 설정을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/providers/Microsoft.Insights/diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/providers/Microsoft.Insights/logDefinitions/read | MariaDB 서버에 사용 가능한 로그를 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/providers/Microsoft.Insights/metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> | 액션(Action) | DBforMariaDB/servers/queryTexts/작업 | 쿼리 목록의 텍스트 반환 |
> | 액션(Action) | DBforMariaDB/servers/queryTexts/작업 | 쿼리 텍스트를 반환합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/read | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/recoverableServers/read | 복구 가능한 MariaDB 서버 정보를 반환 |
> | 액션(Action) | DBforMariaDB/servers/복제본/읽기 | MariaDB 서버의 읽기 복제본 가져오기 |
> | 액션(Action) | DBforMariaDB/서버/다시 시작/작업 | 특정 서버를 다시 시작 합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/securityAlertPolicies/read | 지정된 서버에 구성된 서버 위협 검색 정책의 세부 정보를 검색합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/securityAlertPolicies/write | 지정된 서버에 대한 서버 위협 검색 정책을 변경합니다. |
> | 액션(Action) | DBforMariaDB/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
> | 액션(Action) | DBforMariaDB/servers/topQueryStatistics/read | 쿼리 통계 반환 |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/virtualNetworkRules/delete | 기존 가상 네트워크 규칙을 삭제합니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/virtualNetworkRules/read | 가상 네트워크 규칙 목록을 반환하거나 지정된 가상 네트워크 규칙에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMariaDB/servers/virtualNetworkRules/write | 지정된 매개 변수를 사용하여 가상 네트워크 규칙을 만들거나 지정된 가상 네트워크 규칙에 대한 속성 또는 태그를 업데이트합니다. |
> | 액션(Action) | DBforMariaDB/servers/waitStatistics/read | 인스턴스에 대한 대기 통계를 반환합니다. |
> | 액션(Action) | DBforMariaDB/servers/waitStatistics/read | 대기 통계 반환 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft DBforMySQL/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft DBforMySQL/위치/azureAsyncOperation/읽기 | MySQL 서버 작업 결과 반환 |
> | 액션(Action) | Microsoft DBforMySQL/위치/operationResults/read | ResourceGroup 기반 MySQL 서버 작업 결과 반환 |
> | 액션(Action) | Microsoft DBforMySQL/위치/operationResults/read | MySQL 서버 작업 결과 반환 |
> | 액션(Action) | Microsoft.DBforMySQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | 액션(Action) | Microsoft DBforMySQL/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | Microsoft DBforMySQL/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | Microsoft DBforMySQL/작업/읽기 | MySQL 작업 목록을 반환 합니다. |
...
> | 액션(Action) | Microsoft DBforMySQL/servers/administrators/delete | MySQL 서버의 기존 관리자를 삭제 합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/administrators/read | MySQL server 관리자 목록을 가져옵니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 MySQL 서버 관리자를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/createRecommendedActionSession/action | 새 권장 구성 작업 세션을 만듭니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/read | 관리자 목록을 반환합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/read | Advisor 반환 |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 액션(Action) | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장 작업 반환 |
...
> | 액션(Action) | Microsoft DBforMySQL/servers/databases/delete | 기존 MySQL 데이터베이스를 삭제 합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/databases/read | MySQL 데이터베이스 목록을 반환 하거나 지정 된 데이터베이스에 대 한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/databases/write | 지정 된 매개 변수를 사용 하 여 MySQL 데이터베이스를 만들거나 지정 된 데이터베이스에 대 한 속성을 업데이트 합니다. |
...
> | 액션(Action) | Microsoft DBforMySQL/servers/logFiles/read | PostgreSQL LogFiles의 목록을 반환 합니다. |
...
> | 액션(Action) | Microsoft.DBforMySQL/servers/providers/Microsoft.Insights/logDefinitions/read | MySQL 서버에 사용 가능한 로그를 가져오기 |
> | 액션(Action) | Microsoft.DBforMySQL/servers/providers/Microsoft.Insights/metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/queryTexts/동작 | 쿼리 목록의 텍스트 반환 |
> | 액션(Action) | Microsoft DBforMySQL/servers/queryTexts/동작 | 쿼리 텍스트를 반환합니다. |
> | 액션(Action) | Microsoft.DBforMySQL/servers/read | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforMySQL/servers/recoverableServers/read | 복구 가능한 MySQL 서버 정보를 반환합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/복제본/읽기 | MySQL 서버의 읽기 복제본 가져오기 |
> | 액션(Action) | Microsoft DBforMySQL/servers/restart/action | 특정 서버를 다시 시작 합니다. |
...
> | 액션(Action) | Microsoft DBforMySQL/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
> | 액션(Action) | Microsoft DBforMySQL/servers/topQueryStatistics/read | 쿼리 통계 반환 |
> | 액션(Action) | Microsoft.DBforMySQL/servers/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
...
> | 액션(Action) | Microsoft DBforMySQL/servers/waitStatistics/read | 대기 통계 반환 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | DBforPostgreSQL/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> | 액션(Action) | DBforPostgreSQL/위치/azureAsyncOperation/읽기 | PostgreSQL 서버 작업 결과 반환 |
> | 액션(Action) | DBforPostgreSQL/위치/operationResults/read | ResourceGroup 기반 PostgreSQL 서버 작업 결과 반환 |
> | 액션(Action) | DBforPostgreSQL/위치/operationResults/read | PostgreSQL 서버 작업 결과 반환 |
> | 액션(Action) | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | 액션(Action) | DBforPostgreSQL/위치/privateEndpointConnectionAzureAsyncOperation/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | DBforPostgreSQL/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | 액션(Action) | DBforPostgreSQL/작업/읽기 | PostgreSQL 작업의 목록을 반환 합니다. |
> | 액션(Action) | Microsoft.DBforPostgreSQL/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | 액션(Action) | DBforPostgreSQL/register/action | PostgreSQL 리소스 공급자 등록 |
> | 액션(Action) | DBforPostgreSQL/servers/administrators/delete | PostgreSQL 서버의 기존 관리자를 삭제 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/administrators/read | PostgreSQL 서버 관리자의 목록을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 PostgreSQL 서버 관리자를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/advisors/read | 관리자 목록을 반환합니다. |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/advisors/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/advisors/recommendedActionSessions/action | 권장 사항 수행 |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/configurations/read | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/configurations/write | 지정된 구성의 값을 업데이트합니다. |
> | 액션(Action) | DBforPostgreSQL/서버/데이터베이스/삭제 | 기존 PostgreSQL 데이터베이스를 삭제 합니다. |
> | 액션(Action) | DBforPostgreSQL/서버/데이터베이스/읽기 | PostgreSQL 데이터베이스의 목록을 반환 하거나 지정 된 데이터베이스에 대 한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/servers/databases/write | 지정 된 매개 변수를 사용 하 여 PostgreSQL 데이터베이스를 만들거나 지정 된 데이터베이스에 대 한 속성을 업데이트 합니다. |
...
> | 액션(Action) | DBforPostgreSQL/servers/logFiles/read | PostgreSQL LogFiles의 목록을 반환 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/privateLinkResources/read | 해당 PostgreSQL 서버에 대 한 개인 링크 리소스를 가져옵니다. |
...
> | 액션(Action) | DBforPostgreSQL/servers/queryTexts/읽기 | 쿼리 목록의 텍스트 반환 |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/read | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.DBforPostgreSQL/servers/recoverableServers/read | 복구 가능한 PostgreSQL 서버 정보를 반환합니다. |
> | 액션(Action) | DBforPostgreSQL/servers/복제본/읽기 | PostgreSQL 서버의 읽기 복제본 가져오기 |
> | 액션(Action) | DBforPostgreSQL/서버/다시 시작/작업 | 특정 서버를 다시 시작 합니다. |
...
> | 액션(Action) | DBforPostgreSQL/serversv2/구성/읽기 | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/구성/쓰기 | 지정된 구성의 값을 업데이트합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/delete | 기존 서버를 삭제합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/firewallRules/delete | 기존 방화벽 규칙을 삭제합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/firewallRules/read | 서버에 대한 방화벽 규칙 목록을 반환하거나 지정된 방화벽 규칙에 대한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/firewallRules/write | 지정된 매개 변수를 사용하여 방화벽 규칙을 만들거나 기존 규칙을 업데이트합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/providers//diagnosticSettings/read | 리소스에 대한 진단 설정을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/providers//diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/providers/Microsoft. Insights/logDefinitions/읽기 | Postgres 서버에 사용 가능한 로그를 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/providers//metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/읽기 | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> | 액션(Action) | DBforPostgreSQL/serversv2/write | 지정된 매개 변수를 사용하여 서버를 만들거나 지정된 서버에 대한 속성 또는 태그를 업데이트합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. 장치/계정/diagnosticSettings/읽기 | 리소스에 대한 진단 설정을 가져옵니다. |
> | 액션(Action) | Microsoft. 장치/계정/diagnosticSettings/쓰기 | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft. 장치/계정/s i d 정의/읽기 | IotHub 서비스에 사용 가능한 로그 정의를 가져옵니다. |
> | 액션(Action) | Microsoft. 장치/계정/metricDefinitions/읽기 | IotHub 서비스에 대해 사용 가능한 메트릭을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | 프로비전 서비스 이름을 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft. Devices/digitalTwins/Delete | 기존 디지털 쌍 계정과 모든 자식을 삭제 합니다. |
> | 액션(Action) | Microsoft. Devices/digitalTwins/operationresults/Read | 디지털 쌍 계정에 대해 작업 상태 가져오기 |
> | 액션(Action) | Microsoft. 장치/digitalTwins/읽기 | 구독과 연결 된 디지털 Twins 계정의 목록을 가져옵니다. |
> | 액션(Action) | Microsoft. Devices/digitalTwins/sku/읽기 | 디지털 쌍 계정에 대 한 유효한 Sku 목록 가져오기 |
> | 액션(Action) | Microsoft. Devices/digitalTwins/Write | 새 Digitial Twins 계정 만들기 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.DevSpaces/controllers/delete | Azure Dev Spaces 컨트롤러 및 데이터 평면 서비스 삭제 |
> | 액션(Action) | Microsoft.DevSpaces/controllers/listConnectionDetails/action | Azure Dev Spaces 컨트롤러의 인프라에 대한 연결 세부 정보 나열 |
> | 액션(Action) | Microsoft.DevSpaces/controllers/read | Azure Dev Spaces 컨트롤러 속성 읽기 |
> | 액션(Action) | Microsoft.DevSpaces/controllers/write | Azure Dev Spaces 컨트롤러 속성 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft DevSpaces/위치/checkContainerHostMapping/작업 | 컨테이너 호스트에 대 한 기존 컨트롤러 매핑 확인 |
> | 액션(Action) | Microsoft. DevSpaces/위치/operationresults/read | 비동기 작업의 상태를 읽습니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | 지정된 아티팩트에 대한 ARM 템플릿을 생성하고, 필요한 파일을 스토리지 계정에 업로드하고, 생성된 아티팩트의 유효성을 검사합니다. |
...
> | 액션(Action) | Microsoft DevTestLab/labs/EnsureCurrentUserProfile/action | 현재 사용자가 랩에서 유효한 프로필을 갖고 있는지 확인 합니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/ExportResourceUsage/action | 랩 리소스 사용량을 스토리지 계정으로 내보냅니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/notificationChannels/delete | 알림 채널을 삭제 합니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/notificationChannels/Notify/action | 제공된 채널에 알림을 보냅니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/notificationChannels/read | 알림 채널을 읽습니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/notificationChannels/write | 알림 채널을 추가 하거나 수정 합니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/policySets/read | 정책 집합을 읽습니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/read | 랩을 읽습니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/sharedGalleries/read | 공유 갤러리를 읽습니다. |
...
> | 액션(Action) | Microsoft. DevTestLab/labs/sharedGalleries/sharedImages/write | 공유 이미지를 추가 하거나 수정 합니다. |
> | 액션(Action) | Microsoft. DevTestLab/labs/sharedGalleries/write | 공유 갤러리를 추가 하거나 수정 합니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/users/serviceFabrics/read | 서비스 패브릭을 읽습니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/virtualMachines/read | 가상 머신을 읽습니다. |
...
> | 액션(Action) | Microsoft.DevTestLab/labs/virtualMachines/UnClaim/action | 기존 가상 머신의 소유권을 해제합니다. |
> | 액션(Action) | Microsoft.DevTestLab/labs/virtualMachines/write | 가상 머신을 추가 또는 수정합니다. |
> | 액션(Action) | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/delete | Bastionhosts를 삭제 합니다. |
> | 액션(Action) | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/read | Bastionhosts을 읽습니다. |
> | 액션(Action) | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/write | Bastionhosts를 추가 하거나 수정 합니다. |
...
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/delete | 컬렉션을 삭제 합니다. API 형식에만 적용 됩니다. ' mongodb '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' mongodb '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/read | 컬렉션을 읽거나 모든 컬렉션을 나열 합니다. API 형식에만 적용 됩니다. ' mongodb '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/read | 컬렉션 처리량을 읽습니다. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/write | 컬렉션 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/collections/write | 컬렉션을 만들거나 업데이트 합니다. API 형식에만 적용 됩니다. ' mongodb '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/삭제 | 컨테이너를 삭제 합니다. ' Sql ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/읽기 | 컨테이너를 읽거나 모든 컨테이너를 나열 합니다. ' Sql ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/읽기 | 컨테이너 처리량을 읽습니다. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/쓰기 | 컨테이너 처리량을 업데이트 합니다. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/쓰기 | 컨테이너를 만들거나 업데이트 합니다. ' Sql ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/delete | 데이터베이스를 삭제 합니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/삭제 | 그래프를 삭제 합니다. API 형식에만 적용 됩니다. ' gremlin'. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' gremlin'. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/읽기 | 그래프를 읽거나 모든 그래프를 나열 합니다. API 형식에만 적용 됩니다. ' gremlin'. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/읽기 | 그래프 처리량을 읽습니다. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/쓰기 | 그래프 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/쓰기 | 그래프를 만들거나 업데이트 합니다. API 형식에만 적용 됩니다. ' gremlin'. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/read | 데이터베이스를 읽거나 모든 데이터베이스를 나열 합니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/settings/read | 데이터베이스 처리량을 읽습니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/settings/write | 데이터베이스 처리량을 업데이트 합니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/databases/write | 데이터베이스 만들기 ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/delete | Keyspace를 삭제 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/read | Keyspace을 읽거나 모든 keyspaces를 나열 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/read | Keyspace 처리량을 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/write | Keyspace 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/delete | 테이블을 삭제 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/read | 테이블을 읽거나 모든 테이블을 나열 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/read | 테이블 처리량을 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/write | 테이블 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/write | 테이블을 만들거나 업데이트 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/keyspaces/write | Keyspace를 만듭니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/delete | 테이블을 삭제 합니다. ' Table ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Table ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/read | 테이블을 읽거나 모든 테이블을 나열 합니다. ' Table ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/settings/read | 테이블 처리량을 읽습니다. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/settings/write | 테이블 처리량을 업데이트 합니다. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/api/tables/write | 테이블을 만들거나 업데이트 합니다. ' Table ' API 유형에만 적용 됩니다. |
> | 액션(Action) | Microsoft.DocumentDB/databaseAccounts/backup/action | 백업 구성하는 요청 제출 |
> | 액션(Action) | Microsoft.DocumentDB/databaseAccounts/changeResourceGroup/action | 데이터베이스 계정의 리소스 그룹을 변경합니다. |
...
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/getBackupPolicy/action | 데이터베이스 계정의 백업 정책 가져오기 |
...
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/delete | 데이터베이스 계정의 개인 끝점 연결 프록시를 삭제 합니다. |
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/read | 데이터베이스 계정의 개인 끝점 연결 프록시 읽기 |
...
> | 액션(Action) | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/write | 데이터베이스 계정의 개인 끝점 연결 프록시를 만들거나 업데이트 합니다. |
...
> | 액션(Action) | Microsoft.DocumentDB/databaseAccounts/restore/action | 복원 요청 제출 |
> | 액션(Action) | Microsoft.DocumentDB/databaseAccounts/usages/read | 데이터베이스 계정 사용 현황을 읽습니다. |
...
> | 액션(Action) | Microsoft DocumentDB/위치/operationsStatus/읽기 | 비동기 작업의 상태를 읽습니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.EventGrid/domains/delete | 도메인을 삭제합니다. |
> | 액션(Action) | Microsoft.EventGrid/domains/listKeys/action | 도메인에 대한 키를 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/domains/providers/Microsoft.Insights/metricDefinitions/read | 도메인에 사용 가능한 메트릭을 가져옵니다. |
> | 액션(Action) | Microsoft.EventGrid/domains/read | 도메인을 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/domains/regenerateKey/action | 도메인에 대한 키를 다시 생성합니다. |
> | 액션(Action) | Microsoft EventGrid/도메인/항목/삭제 | 도메인 항목 삭제 |
> | 액션(Action) | Microsoft.EventGrid/domains/topics/read | 도메인 토픽을 읽습니다. |
> | 액션(Action) | Microsoft EventGrid/도메인/토픽/쓰기 | 도메인 항목 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.EventGrid/domains/write | 도메인을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.EventGrid/eventSubscriptions/delete | EventSubscription 삭제 |
> | 액션(Action) | Microsoft.EventGrid/eventSubscriptions/getFullUrl/action | 이벤트 구독의 전체 url을 가져옵니다. |
...
> | 액션(Action) | Microsoft.EventGrid/eventSubscriptions/read | EventSubscription 읽기 |
> | 액션(Action) | Microsoft.EventGrid/eventSubscriptions/write | EventSubscription 만들기 또는 업데이트 |
...
> | 액션(Action) | Microsoft.EventGrid/extensionTopics/read | extensionTopic을 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/locations/eventSubscriptions/read | 지역 이벤트 구독을 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/locations/operationResults/read | 국가별 작업의 결과를 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/locations/operationsStatus/read | 국가별 작업의 상태를 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/locations/topictypes/eventSubscriptions/read | 항목 유형별로 지역 이벤트 구독을 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/operationResults/read | 작업의 결과를 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/operations/read | EventGrid 작업을 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/operationsStatus/read | 작업의 상태를 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/register/action | EventGrid 리소스 공급자에 대한 구독을 등록합니다. |
> | 액션(Action) | Microsoft.EventGrid/topics/delete | 항목 삭제 |
> | 액션(Action) | Microsoft.EventGrid/topics/listKeys/action | 토픽에 대한 키를 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/topics/providers/Microsoft.Insights/diagnosticSettings/read | 토픽에 대한 진단 설정을 가져옵니다. |
...
> | 액션(Action) | Microsoft.EventGrid/topics/write | 토픽을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.EventGrid/topictypes/eventSubscriptions/read | 항목 유형별로 글로벌 이벤트 구독을 나열합니다. |
> | 액션(Action) | Microsoft.EventGrid/topictypes/eventtypes/read | topictype에서 지원하는 eventtype을 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/topictypes/read | 토픽을 읽습니다. |
> | 액션(Action) | Microsoft.EventGrid/unregister/action | EventGrid 리소스 공급자에 대한 구독을 등록 취소합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft EventHub/availableClusterRegions/read | Azure 지역에서 사용 가능한 미리 프로 비전 된 클러스터를 나열 하는 읽기 작업입니다. |
...
> | 액션(Action) | Microsoft EventHub/클러스터/삭제 | 기존 클러스터 리소스를 삭제 합니다. |
> | 액션(Action) | Microsoft. EventHub/클러스터/네임 스페이스/읽기 | 클러스터 내의 네임 스페이스에 대 한 네임 스페이스 ARM Id를 나열 합니다. |
> | 액션(Action) | Microsoft EventHub/클러스터/operationresults/read | 비동기 클러스터 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.EventHub/clusters/providers/Microsoft.Insights/metricDefinitions/read | 클러스터 메트릭 리소스 설명의 목록을 가져옵니다. |
> | 액션(Action) | Microsoft.EventHub/clusters/read | 클러스터 리소스 설명을 가져옵니다. |
> | 액션(Action) | Microsoft.EventHub/clusters/write | 기존 클러스터 리소스를 만들거나 수정 합니다. |
...
> | 액션(Action) | Microsoft.EventHub/namespaces/authorizationRules/action | 네임스페이스 권한 부여 규칙을 업데이트합니다. 이 API는 더 이상 사용되지 않습니다. 그 대신 PUT 호출을 사용하여 네임스페이스 권한 부여 규칙을 업데이트하세요. 이 작업은 API 버전 2017-04-01에서 지원되지 않습니다. |
...
> | 액션(Action) | Microsoft.EventHub/namespaces/ipFilterRules/delete | IP 필터 리소스 삭제 |
> | 액션(Action) | Microsoft.EventHub/namespaces/ipFilterRules/read | IP 필터 리소스 가져오기 |
> | 액션(Action) | Microsoft.EventHub/namespaces/ipFilterRules/write | IP 필터 리소스 만들기 |
...
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/networkruleset 집합/삭제 | VNET 규칙 리소스 삭제 |
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/networkruleset 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/networkruleset 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
...
> | 액션(Action) | Microsoft.EventHub/namespaces/virtualNetworkRules/delete | VNET 규칙 리소스 삭제 |
> | 액션(Action) | Microsoft.EventHub/namespaces/virtualNetworkRules/read | VNET 규칙 리소스 가져오기 |
> | 액션(Action) | Microsoft.EventHub/namespaces/virtualNetworkRules/write | VNET 규칙 리소스 만들기 |
> | 액션(Action) | Microsoft.EventHub/namespaces/write | 네임스페이스 리소스를 만들고 해당 속성을 업데이트합니다. 네임스페이스의 태그 및 용량은 업데이트할 수 있는 속성입니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | GuestConfiguration/guestConfigurationAssignments/delete | 게스트 구성 할당을 삭제 합니다. |
> | 액션(Action) | Microsoft.GuestConfiguration/guestConfigurationAssignments/read | 게스트 구성 할당을 가져옵니다. |
> | 액션(Action) | Microsoft.GuestConfiguration/guestConfigurationAssignments/reports/read | 게스트 구성 할당 보고서를 가져옵니다. |
> | 액션(Action) | Microsoft.GuestConfiguration/guestConfigurationAssignments/write | 새 게스트 구성 할당을 만듭니다. |
> | 액션(Action) | GuestConfiguration/작업/읽기 | GuestConfiguration 리소스 공급자에 대 한 작업을 가져옵니다. |
> | 액션(Action) | GuestConfiguration/register/action | GuestConfiguration 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | 액션(Action) | Microsoft.HDInsight/clusters/configurations/action | HDInsight 클러스터 구성을 가져옵니다. |
...
> | 액션(Action) | Microsoft HDInsight/클러스터/확장/삭제 | HDInsight 클러스터에 대 한 클러스터 확장 삭제 |
> | 액션(Action) | Microsoft HDInsight/클러스터/확장/읽기 | HDInsight 클러스터에 대 한 클러스터 확장 가져오기 |
> | 액션(Action) | Microsoft HDInsight/클러스터/확장/쓰기 | HDInsight 클러스터에 대 한 클러스터 확장 만들기 |
> | 액션(Action) | Microsoft HDInsight/클러스터/getGatewaySettings/작업 | HDInsight 클러스터에 대 한 게이트웨이 설정 가져오기 |
> | 액션(Action) | Microsoft.HDInsight/clusters/providers/Microsoft.Insights/diagnosticSettings/read | 리소스 HDInsight 클러스터에 대한 진단 설정을 가져옵니다. |
...
> | 액션(Action) | Microsoft HDInsight/클러스터/updateGatewaySettings/action | HDInsight 클러스터에 대 한 게이트웨이 설정 업데이트 |
> | 액션(Action) | Microsoft.HDInsight/clusters/write | HDInsight 클러스터를 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft HDInsight/register/action | 구독에 대 한 HDInsight 리소스 공급자 등록 |
> | 액션(Action) | Microsoft HDInsight/등록 취소/작업 | 구독에 대 한 HDInsight 리소스 공급자 등록 취소 |
...
> | 액션(Action) | Microsoft. ImportExport/작업/읽기 | 리소스 공급자가 지 원하는 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/diagnosticSettings/Read | 리소스 진단 설정을 읽습니다. |
> | 액션(Action) | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/diagnosticSettings/Write | 리소스 진단 설정을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/logDefinitions/Read | 로그 정의 읽기 |
> | 액션(Action) | Microsoft.Insights/AutoscaleSettings/providers/Microsoft.Insights/MetricDefinitions/Read | 메트릭 정의 읽기 |
...
> | 액션(Action) | Microsoft. 인 사이트/기준/읽기 | 메트릭 기준선 읽기 (미리 보기) |
> | 액션(Action) | Microsoft Insights/CalculateBaseline/Read | 메트릭 값의 기준선 계산 (미리 보기) |
...
> | 액션(Action) | Microsoft Insights/Components/DailyCapReached/Action | Application Insights 구성 요소의 일일 상한에 도달 했습니다. |
> | 액션(Action) | Microsoft Insights/Components/DailyCapWarningThresholdReached/Action | Application Insights 구성 요소에 대 한 일일 상한 경고 임계값에 도달 했습니다. |
...
> | 액션(Action) | Microsoft.Insights/Logs/DeviceAppCrash/Read | DeviceAppCrash 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft Insights/Logs/Tables. 사용자 지정/읽기 | 사용자 지정 로그에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft Insights/MetricBaselines/Read | 메트릭 기준 읽기 |
...
> | 액션(Action) | Microsoft Insights/Metricnamespaces/Read | 메트릭 네임 스페이스 읽기 |
> | 액션(Action) | Microsoft.Insights/Metrics/Action | 메트릭 작업 |
> | 액션(Action) | Microsoft의 통찰력/메트릭/Microsoft. 통찰력/읽기 | 메트릭 읽기 |
> | 액션(Action) | Microsoft.Insights/Metrics/providers/Metrics/Read | 메트릭 읽기 |
...
> | 액션(Action) | Microsoft Insights/통합 문서/삭제 | 통합 문서 삭제 |
> | 액션(Action) | Microsoft Insights/통합 문서/읽기 | 통합 문서 읽기 |
> | 액션(Action) | Microsoft Insights/통합 문서/쓰기 | 통합 문서 만들기 또는 업데이트 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Intune/diagnosticsettings/delete | 진단 설정을 삭제합니다. |
> | 액션(Action) | Microsoft.Intune/diagnosticsettings/read | 진단 설정을 읽습니다. |
> | 액션(Action) | Microsoft.Intune/diagnosticsettings/write | 진단 설정을 작성합니다. |
> | 액션(Action) | Microsoft.Intune/diagnosticsettingscategories/read | 진단 설정 범주를 읽습니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. IoTCentral/appTemplates/action | Azure IoT Central에서 사용 가능한 모든 응용 프로그램 템플릿을 가져옵니다. |
> | 액션(Action) | Microsoft.IoTCentral/checkNameAvailability/action | IoT Central 애플리케이션 이름이 사용 가능한지 확인합니다. |
> | 액션(Action) | Microsoft.IoTCentral/checkSubdomainAvailability/action | IoT Central 애플리케이션 하위 도메인이 사용 가능한지 확인합니다. |
> | 액션(Action) | Microsoft.IoTCentral/IoTApps/delete | IoT Central 애플리케이션 삭제 |
> | 액션(Action) | Microsoft.IoTCentral/IoTApps/read | 단일 IoT Central 애플리케이션 가져오기 |
> | 액션(Action) | Microsoft.IoTCentral/IoTApps/write | IoT Central 애플리케이션을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.IoTCentral/operations/read | IoT Central 애플리케이션에 사용 가능한 모든 작업 가져오기 |
> | 액션(Action) | Microsoft.IoTCentral/register/action | Azure IoT Central 리소스 공급자에 대한 구독 등록 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.IoTSpaces/Graph/delete | Microsoft.IoTSpaces Graph 리소스를 삭제 |
> | 액션(Action) | Microsoft.IoTSpaces/Graph/read | Microsoft.IoTSpaces Graph 리소스를 가져오기 |
> | 액션(Action) | Microsoft.IoTSpaces/Graph/write | Microsoft.IoTSpaces Graph 리소스를 만들기 |
> | 액션(Action) | Microsoft.IoTSpaces/register/action | 리소스를 만들 수 있게 설정하려면 Microsoft.IoTSpaces Graph 리소스 공급자에 대한 구독을 등록하세요. |
...
> | 액션(Action) | Microsoft. KeyVault/자격 증명 모음/eventGridFilters/delete | Key Vault에 대 한 EventGrid 구독이 삭제 됨을 Microsoft KeyVault에 알립니다. |
> | 액션(Action) | Microsoft. KeyVault/자격 증명 모음/eventGridFilters | Key Vault에 대 한 EventGrid 구독을 표시 하 고 있음을 Microsoft. KeyVault에 알립니다. |
> | 액션(Action) | Microsoft. KeyVault/Vault/eventGridFilters/write | Key Vault에 대 한 새 EventGrid 구독을 만들고 있음을 Microsoft. KeyVault에 알립니다. |
> | 액션(Action) | Microsoft.KeyVault/vaults/read | Key Vault의 속성을 봅니다. |
> | 액션(Action) | Microsoft.KeyVault/vaults/secrets/read | 암호의 속성은 볼 수 있지만 해당 값은 볼 수 없습니다. |
> | 액션(Action) | Microsoft.KeyVault/vaults/secrets/write | 새 비밀을 만들거나 기존 비밀의 값을 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. Kusto/클러스터/활성화/작업 | 클러스터를 시작 합니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/AttachedDatabaseConfigurations/delete | 연결 된 데이터베이스 구성 resourceCopy을 삭제 합니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/AttachedDatabaseConfigurations/읽기 | 연결 된 데이터베이스 구성 resourceCopy을 읽습니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/AttachedDatabaseConfigurations/write | 연결 된 데이터베이스 구성 resourceCopy을 작성 합니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/CheckNameAvailability/action | 클러스터 이름 가용성을 확인 합니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/데이터베이스/AddPrincipals/action | 데이터베이스 보안 주체를 추가 합니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/데이터베이스/CheckNameAvailability/action | 지정 된 형식에 대 한 이름 가용성을 확인 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/DataConnections/delete | ResourceCopy 데이터 연결을 삭제 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/DataConnections/read | ResourceCopy 데이터 연결을 읽습니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/DataConnections/write | ResourceCopy 데이터 연결을 작성 합니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/데이터베이스/DataConnectionValidation/작업 | 데이터베이스 데이터 연결의 유효성을 검사 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/delete | ResourceCopy 데이터베이스를 삭제 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/EventHubConnections/delete | ResourceCopy 이벤트 허브 연결을 삭제 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/EventHubConnections/read | ResourceCopy 이벤트 허브 연결을 읽습니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | ResourceCopy 이벤트 허브 연결을 작성 합니다. |
> | 액션(Action) | Microsoft .Kusto/클러스터/데이터베이스/EventHubConnectionValidation/작업 | 데이터베이스 이벤트 허브 연결의 유효성을 검사 합니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/데이터베이스/ListPrincipals/action | 데이터베이스 보안 주체를 나열 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/read | ResourceCopy 데이터베이스를 읽습니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/데이터베이스/RemovePrincipals/action | 데이터베이스 보안 주체를 제거 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/Databases/write | ResourceCopy 데이터베이스를 작성 합니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/비활성화/작업 | 클러스터를 중지 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/delete | 클러스터 resourceCopy를 삭제 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/read | 클러스터 resourceCopy을 읽습니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/Sku/읽기 | 클러스터 SKU resourceCopy을 읽습니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/시작/작업 | 클러스터를 시작 합니다. |
> | 액션(Action) | Microsoft. Kusto/클러스터/중지/작업 | 클러스터를 중지 합니다. |
> | 액션(Action) | Microsoft.Kusto/Clusters/write | 클러스터 resourceCopy를 작성 합니다. |
> | 액션(Action) | DetachFollowerDatabases/작업 | 종동체 데이터베이스를 분리 합니다. |
> | 액션(Action) | Microsoft .Kusto/ListFollowerDatabases/action | 종동체의 데이터베이스를 나열 합니다. |
> | 액션(Action) | Microsoft .Kusto/위치/CheckNameAvailability/action | ResourceCopy 이름 가용성을 확인 합니다. |
> | 액션(Action) | Microsoft.Kusto/locations/operationresults/read | 읽기 작업 resourceCopys |
> | 액션(Action) | Microsoft.Kusto/Operations/read | 읽기 작업 resourceCopys |
> | 액션(Action) | Microsoft. Kusto/등록/동작 | 구독 등록 작업 |
> | 액션(Action) | Microsoft. Kusto/등록/동작 | 구독을 Kusto 리소스 공급자에 등록 합니다. |
> | 액션(Action) | Microsoft. Kusto/Sku/읽기 | SKU resourceCopy을 읽습니다. |
> | 액션(Action) | Microsoft. Kusto/등록 취소/작업 | Kusto 리소스 공급자에 대 한 구독을 등록 취소 합니다. |
...
> | 액션(Action) | Microsoft.LabServices/labAccounts/GetRegionalAvailability/action | 랩 계정에서 구성된 각 크기 범주에 대한 지역별 가용성 정보 가져오기 |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/AddUsers/action | 랩에 사용자 추가 |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/delete | 랩을 삭제합니다. |
...
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/environments/ResetPassword/action | 환경의 사용자 암호 다시 설정 |
...
> | 액션(Action) | Microsoft. 서비스/랩 계정/실습/environmentSettings/ResetPassword/action | 템플릿 가상 컴퓨터에서 암호를 다시 설정 합니다. |
> | 액션(Action) | Microsoft. 서비스/랩 계정/실습/environmentSettings/SaveImage/action | 랩 계정의 공유 갤러리에 현재 템플릿 이미지를 저장 합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/schedules/delete | 일정을 삭제합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/schedules/read | 일정을 읽습니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/schedules/write | 일정을 추가하거나 수정합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/Start/action | 템플릿 내의 모든 리소스를 시작하여 템플릿을 시작합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/Stop/action | 템플릿 내의 모든 리소스를 중지하여 템플릿을 중지합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/environmentSettings/write | 환경 설정을 추가하거나 수정합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/read | 랩을 읽습니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/SendEmail/action | 등록 링크가 포함된 이메일을 랩으로 보냅니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/labs/users/delete | 사용자를 삭제합니다. |
...
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedGalleries/delete | sharedgalleries를 삭제합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedGalleries/read | sharedgalleries를 읽습니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedGalleries/write | sharedgalleries를 추가 또는 수정합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedImages/delete | sharedimages를 삭제합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedImages/read | sharedimages를 읽습니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/sharedImages/write | sharedimages를 추가 또는 수정합니다. |
> | 액션(Action) | Microsoft.LabServices/labAccounts/write | 랩 계정을 추가 또는 수정합니다. |
...
> | 액션(Action) | Microsoft.LabServices/users/GetPersonalPreferences/action | 사용자의 개인 기본 설정 가져오기 |
> | 액션(Action) | Microsoft. 서비스/사용자/ListAllEnvironments/작업 | 사용자에 대 한 모든 환경 나열 |
> | 액션(Action) | Microsoft.LabServices/users/Register/action | 사용자를 관리되는 랩에 등록합니다. |
> | 액션(Action) | Microsoft.LabServices/users/ResetPassword/action | 환경의 사용자 암호 다시 설정 |
> | 액션(Action) | Microsoft.LabServices/users/StartEnvironment/action | 환경 내의 모든 리소스를 시작하여 환경을 시작합니다. |
...
> | 액션(Action) | Microsoft.Logic/integrationAccounts/partners/write | 통합 계정에서 파트너를 만들거나 업데이트합니다. |
...
> | 액션(Action) | Microsoft.Logic/integrationServiceEnvironments/operationStatuses/read | 통합 서비스 환경 작업 상태를 읽습니다. |
> | 액션(Action) | Microsoft.Logic/integrationServiceEnvironments/providers/Microsoft.Insights/metricDefinitions/read | 통합 서비스 환경 메트릭 정의를 읽습니다. |
> | 액션(Action) | Microsoft.Logic/integrationServiceEnvironments/read | 통합 서비스 환경을 읽습니다. |
> | 액션(Action) | Microsoft.Logic/integrationServiceEnvironments/write | 통합 서비스 환경을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Logic/locations/workflows/recommendOperationGroups/action | 워크플로 권장 작업 그룹을 가져옵니다. |
> | 액션(Action) | Microsoft.Logic/locations/workflows/validate/action | 워크플로의 유효성을 검사합니다. |
...
> | 액션(Action) | Microsoft. 논리/워크플로/실행/삭제 | 워크플로 실행을 삭제 합니다. |
> | 액션(Action) | Microsoft.Logic/workflows/runs/operations/read | 워크플로 실행 작업 상태를 읽습니다. |
...
> | 액션(Action) | Microsoft.MachineLearning/Workspaces/resyncstoragekeys/action | Machine Learning 작업 영역에 대해 구성된 스토리지 계정의 키를 다시 동기화합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | MachineLearningServices/위치/computeoperationsstatus/읽기 | 특정 컴퓨팅 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/locations/usages/read | 구독의 aml 컴퓨팅 리소스에 대한 사용량 보고서입니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/locations/vmsizes/read | 지원되는 vm 크기를 가져옵니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/locations/workspaceOperationsStatus/read | 특정 작업 영역 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/register/action | Machine Learning Services 리소스 공급자에 대한 구독을 등록합니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/workspaces/computes/delete | Machine Learning Services 작업 영역에서 컴퓨팅 리소스를 삭제합니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/workspaces/computes/listKeys/action | Machine Learning Services 작업 영역에서 컴퓨팅 리소스에 대한 비밀을 나열합니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/workspaces/computes/listNodes/action | Machine Learning Services 작업 영역의 컴퓨팅 리소스에 대한 노드를 나열합니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/workspaces/computes/read | Machine Learning Services 작업 영역에서 컴퓨팅 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft.MachineLearningServices/workspaces/computes/write | Machine Learning Services 작업 영역에서 컴퓨팅 리소스를 만들거나 업데이트합니다. |
...
> | DataAction | MachineLearningServices/작업 영역/실험/쓰기 | Machine Learning Services 작업 영역에서 실험을 만들거나 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.managedidentity/id/읽기 | 기존 시스템 할당 id를 가져옵니다. |
> | 액션(Action) | Microsoft.ManagedIdentity/register/action | 관리 ID 리소스 공급자에 대한 구독을 등록합니다. |
> | 액션(Action) | Microsoft.ManagedIdentity/userAssignedIdentities/assign/action | 기존 사용자 할당 ID를 리소스에 할당하기 위한 RBAC 작업입니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft ManagedServices/marketplaceRegistrationDefinitions/read | 관리 서비스 등록 정의의 목록을 검색 합니다. |
> | 액션(Action) | Microsoft ManagedServices/작업/읽기 | 관리 서비스 작업 목록을 검색 합니다. |
> | 액션(Action) | Microsoft ManagedServices/operationStatuses/읽기 | 리소스의 작업 상태를 읽습니다. |
> | 액션(Action) | Microsoft ManagedServices/register/action | 관리 서비스에 등록 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationAssignments/delete | 관리 되는 서비스 등록 할당을 제거 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationAssignments/read | 관리 되는 서비스 등록 할당 목록을 검색 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationAssignments/write | 관리 서비스 등록 할당을 추가 하거나 수정 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationDefinitions/삭제 | 관리 서비스 등록 정의를 제거 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationDefinitions/읽기 | 관리 서비스 등록 정의의 목록을 검색 합니다. |
> | 액션(Action) | Microsoft ManagedServices/registrationDefinitions/쓰기 | 관리 서비스 등록 정의를 추가 하거나 수정 합니다. |
> | 액션(Action) | Microsoft ManagedServices/등록 취소/작업 | 관리 서비스에서 등록을 취소 합니다. |
...
> | 액션(Action) | Microsoft.Maps/accounts/eventGridFilters/delete | Event Grid 필터를 삭제합니다. |
> | 액션(Action) | Microsoft.Maps/accounts/eventGridFilters/read | Event Grid 필터를 가져옵니다. |
> | 액션(Action) | Microsoft.Maps/accounts/eventGridFilters/write | Event Grid 필터를 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Maps/accounts/listKeys/action | Maps 계정 키를 나열합니다. |
> | 액션(Action) | Microsoft.Maps/accounts/read | Maps 계정을 가져옵니다. |
...
> | 액션(Action) | Microsoft Maps/작업/읽기 | 공급자 작업 읽기 |
> | 액션(Action) | Microsoft.Maps/register/action | 공급자를 등록합니다. |
...
> | 액션(Action) | Microsoft.Marketplace/register/action | 구독에서 Microsoft.Marketplace 리소스 공급자를 등록합니다. |
...
> | 액션(Action) | MarketplaceOrdering/작업/읽기 | API에서 가능한 모든 작업 나열 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Media/checknameavailability/action | Media Services 계정 이름을 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft.Media/locations/checkNameAvailability/action | Media Services 계정 이름을 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/accountfilters/delete | 계정 필터를 삭제합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/accountfilters/read | 계정 필터를 읽습니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/accountfilters/write | 계정 필터를 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/assets/assetfilters/delete | 자산 필터를 삭제합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/assets/assetfilters/read | 자산 필터를 읽습니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/assets/assetfilters/write | 자산 필터를 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/assets/delete | 모든 자산을 삭제합니다. |
...
> | 액션(Action) | Microsoft.Media/mediaservices/assets/listStreamingLocators/action | 자산에 대한 스트리밍 로케이터를 나열합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/assets/read | 모든 자산을 읽습니다. |
...
> | 액션(Action) | Microsoft.Media/mediaservices/eventGridFilters/delete | 모든 Event Grid 필터를 삭제합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/eventGridFilters/read | 모든 Event Grid 필터를 읽습니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/eventGridFilters/write | 모든 Event Grid 필터를 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Media/mediaservices/liveEventOperations/read | 모든 라이브 이벤트 작업을 읽습니다. |
...
> | 액션(Action) | Microsoft.Media/mediaservices/streamingEndpoints/read | 모든 스트리밍 엔드포인트를 읽습니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/assessmentOptions/읽기 | 지정된 위치에서 사용할 수 있는 평가 옵션을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/평가/읽기 | 프로젝트 내의 평가를 나열합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/삭제 | 평가 프로젝트를 삭제 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/assessedmachines/읽기 | 평가된 머신의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/삭제 | 평가를 삭제합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/다운로드 url/작업 | 평가 보고서의 URL을 다운로드합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/읽기 | 평가의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/쓰기 | 새 평가를 만들거나 기존 평가를 업데이트합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/삭제 | 그룹을 삭제합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/읽기 | 그룹의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/updateMachines/작업 | 컴퓨터를 추가 또는 제거 하 여 그룹 업데이트 |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/그룹/쓰기 | 새 그룹을 만들거나 기존 그룹을 업데이트합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/delete | HyperV 수집기를 삭제 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/읽기 | HyperV 수집기의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/write | 새 HyperV 수집기를 만들거나 기존 HyperV 수집기를 업데이트 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/컴퓨터/읽기 | 머신의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/읽기 | 평가 프로젝트의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/삭제 | VMware 수집기를 삭제 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/읽기 | VMware 수집기의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/쓰기 | 새 VMware 수집기를 만들거나 기존 VMware 수집기를 업데이트 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/assessmentprojects/쓰기 | 새 평가 프로젝트를 만들거나 기존 평가 프로젝트를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/DatabaseInstances/read | 데이터베이스 인스턴스의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/데이터베이스/읽기 | 데이터베이스의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/삭제 | 마이그레이션 프로젝트를 삭제 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/컴퓨터/읽기 | 머신의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/MigrateEvents/삭제 | 마이그레이션 이벤트를 삭제 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/MigrateEvents/읽기 | 마이그레이션 이벤트의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.Migrate/migrateprojects/read | 마이그레이션 프로젝트의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/RefreshSummary/작업 | 프로젝트 마이그레이션 요약을 새로 고칩니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/registerTool/action | 마이그레이션 프로젝트에 도구 등록 |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/솔루션/cleanupData/action | 프로젝트 솔루션 데이터 마이그레이션 정리 |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/솔루션/삭제 | 프로젝트 마이그레이션 솔루션을 삭제 합니다. |
> | 액션(Action) | Microsoft.Migrate/migrateprojects/solutions/getconfig/action | 마이그레이션 프로젝트 솔루션 구성을 가져옵니다. |
> | 액션(Action) | Microsoft.Migrate/migrateprojects/solutions/read | 프로젝트 솔루션 마이그레이션 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/솔루션/쓰기 | 새 프로젝트 마이그레이션 솔루션을 만들거나 기존 마이그레이션 프로젝트 솔루션을 업데이트 합니다. |
> | 액션(Action) | Microsoft. 마이그레이션/migrateprojects/쓰기 | 새 마이그레이션 프로젝트를 만들거나 기존 마이그레이션 프로젝트를 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | MixedReality/register/action | Mixed Reality 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | 액션(Action) | MixedReality/spatialAnchorsAccounts/providers//diagnosticSettings/read | MixedReality/spatialAnchorsAccounts에 대 한 진단 설정을 가져옵니다. |
> | 액션(Action) | MixedReality/spatialAnchorsAccounts/providers//diagnosticSettings/write | MixedReality/spatialAnchorsAccounts에 대 한 진단 설정을 만들거나 업데이트 합니다. |
> | 액션(Action) | MixedReality/spatialAnchorsAccounts/providers//metricDefinitions/read | MixedReality/spatialAnchorsAccounts에 대해 사용 가능한 메트릭을 가져옵니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft NetApp/위치/checkfilepathavailability/작업 | 파일 경로를 사용할 수 있는지 확인 |
> | 액션(Action) | Microsoft NetApp/위치/checknameavailability/action | 리소스 이름을 사용할 수 있는지 확인 |
...
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | 볼륨 리소스를 삭제합니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/mountTargets/read | 마운트 대상 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/read | 볼륨 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots/delete | 스냅샷 리소스를 삭제합니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots/read | 스냅샷 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots/write | 스냅샷 리소스를 씁니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/write | 볼륨 리소스를 씁니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/capacityPools/write | 풀 리소스를 씁니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/delete | 계정 리소스를 삭제 합니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/read | 계정 리소스를 읽습니다. |
> | 액션(Action) | Microsoft.NetApp/netAppAccounts/write | 계정 리소스를 씁니다. |
> | 액션(Action) | Microsoft.NetApp/Operations/read | 작업 리소스를 읽습니다. |
> | 액션(Action) | Microsoft NetApp/register/action | Microsoft NetApp 리소스 공급자에 구독을 등록 합니다. |
> | 액션(Action) | Microsoft NetApp/등록 취소/작업 | Microsoft .Net 앱 리소스 공급자를 사용 하 여 구독 등록 취소 |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Network/applicationGatewayAvailableRequestHeaders/read | Application Gateway 사용 가능한 요청 헤더를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/applicationGatewayAvailableResponseHeaders/read | Application Gateway 사용 가능한 응답 헤더를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/applicationGatewayAvailableServerVariables/read | Application Gateway 사용 가능한 서버 변수를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/applicationGateways/backendAddressPools/join/action | 응용 프로그램 게이트웨이 백 엔드 주소 풀을 조인 합니다. 했어야 하지 않습니다. |
...
> | 액션(Action) | Microsoft. Network/applicationGateways/getBackendHealthOnDemand/action | 지정 된 http 설정 및 백 엔드 풀에 대 한 요청 시 응용 프로그램 게이트웨이 백 엔드 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/applicationGateways/read | 애플리케이션 게이트웨이를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/applicationGateways/start/action | Application Gateway를 시작합니다. |
> | 액션(Action) | Microsoft.Network/applicationGateways/stop/action | Application Gateway를 중지합니다. |
> | 액션(Action) | Microsoft.Network/applicationGateways/write | 애플리케이션 게이트웨이를 만들거나 애플리케이션 게이트웨이를 업데이트합니다. |
> | 액션(Action) | Microsoft. Network/ApplicationGatewayWebApplicationFirewallPolicies/delete | Application Gateway WAF 정책을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/ApplicationGatewayWebApplicationFirewallPolicies/read | Application Gateway WAF 정책을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/ApplicationGatewayWebApplicationFirewallPolicies/write | Application Gateway WAF 정책을 만들거나 Application Gateway WAF 정책을 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/applicationSecurityGroups/delete | 애플리케이션 보안 그룹을 삭제합니다. |
> | 액션(Action) | Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action | IP 구성을 애플리케이션 보안 그룹에 조인합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/applicationSecurityGroups/joinNetworkSecurityRule/action | 보안 규칙을 애플리케이션 보안 그룹에 조인합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/applicationSecurityGroups/listIpConfigurations/action | ApplicationSecurityGroup의 IP 구성을 나열합니다. |
...
> | 액션(Action) | Microsoft.Network/azurefirewalls/read | Azure Firewall을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/azurefirewalls/write | Azure Firewall을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Network/bastionHosts/delete | 요새 호스트 삭제 |
> | 액션(Action) | Microsoft.Network/bastionHosts/read | 요새 호스트 가져오기 |
> | 액션(Action) | Microsoft.Network/bastionHosts/write | 요새 호스트 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Network/bgpServiceCommunities/read | BGP 서비스 커뮤니티를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/checkFrontDoorNameAvailability/action | Front Door 이름이 사용 가능한지 여부 확인 |
> | 액션(Action) | Microsoft.Network/checkTrafficManagerNameAvailability/action | Traffic Manager 상대 DNS 이름의 가용성을 확인합니다. |
> | 액션(Action) | Microsoft.Network/connections/delete | VirtualNetworkGatewayConnection을 삭제합니다. |
> | 액션(Action) | Microsoft.Network/connections/read | VirtualNetworkGatewayConnection을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/connections/revoke/action | 기본 경로 연결 상태를 해지됨으로 표시합니다. |
...
> | 액션(Action) | Microsoft.Network/ddosCustomPolicies/delete | DDoS 사용자 지정 정책 삭제 |
> | 액션(Action) | Microsoft.Network/ddosCustomPolicies/read | DDoS 사용자 지정 정책 정의 가져오기 |
> | 액션(Action) | Microsoft.Network/ddosCustomPolicies/write | DDoS 사용자 지정 정책을 만들거나 기존 DDoS 사용자 지정 정책 업데이트 |
> | 액션(Action) | Microsoft.Network/ddosProtectionPlans/delete | DDoS 보호 계획을 삭제합니다. |
> | 액션(Action) | Microsoft.Network/ddosProtectionPlans/join/action | DDoS Protection 계획에 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/ddosProtectionPlans/read | DDoS 보호 계획을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/dnszones/PTR/delete | DNS 영역에서 지정된 이름의 레코드 집합 및 'PTR' 형식을 제거합니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteCircuits/join/action | Express 경로 회로를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft. Network/expressRouteCircuits/피어 링/arpTables/읽기 | ExpressRouteCircuit Peering ArpTable을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteCircuits/peerings/peerConnections/read | 피어링 기본 경로 회로 연결을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/expressRouteCircuits/peerings/read | ExpressRouteCircuit Peering을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/expressRouteCircuits/피어 링/routeTables/읽기 | ExpressRouteCircuit Peering RouteTable을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/expressRouteCircuits/피어 링/routeTablesSummary/읽기 | ExpressRouteCircuit Peering RouteTable Summary를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteCircuits/read | ExpressRouteCircuit을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteCrossConnections/join/action | Express 경로 교차 연결을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft. Network/expressRouteCrossConnections/피어 링/arpTables/읽기 | Express Route 교차 연결 피어링 Arp 테이블을 가져옵니다. |
...
> | 액션(Action) | Microsoft. Network/expressRouteCrossConnections/피어 링/routeTables/읽기 | Express Route 교차 연결 피어링 경로 테이블을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/expressRouteCrossConnections/피어 링/routeTableSummary/읽기 | Express Route 교차 연결 피어링 경로 테이블 요약 정보를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteGateways/expressRouteConnections/delete | Express Route 연결을 삭제합니다. |
...
> | 액션(Action) | Microsoft.Network/expressRouteGateways/join/action | Express 경로 게이트웨이를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/expressRouteGateways/read | Express Route 게이트웨이를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/expressRoutePorts/delete | ExpressRoutePorts를 삭제합니다. |
> | 액션(Action) | Microsoft.Network/expressRoutePorts/join/action | Express 경로 포트를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/expressRoutePorts/links/read | ExpressRouteLink를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/expressRoutePorts/read | ExpressRoutePorts를 가져옵니다. |
...
> | 액션(Action) | Microsoft. Network/firewallPolicies/delete | 방화벽 정책을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/join/action | 방화벽 정책을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/read | 방화벽 정책을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/ruleGroups/delete | 방화벽 정책 규칙 그룹을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/ruleGroups/read | 방화벽 정책 규칙 그룹을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/ruleGroups/write | 방화벽 정책 규칙 그룹을 만들거나 기존 방화벽 정책 규칙 그룹을 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/firewallPolicies/write | 방화벽 정책을 만들거나 기존 방화벽 정책을 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/frontDoors/backendPools/delete | 백 엔드 풀 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoors/backendPools/read | 백 엔드 풀 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/backendPools/write | 백 엔드 풀 만들기 또는 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/delete | Front Door 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoors/frontendEndpoints/delete | 프런트 엔드 엔드포인트 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoors/frontendEndpoints/disableHttps/action | 프런트 엔드 엔드포인트에서 HTTPS를 사용하지 않도록 설정 |
> | 액션(Action) | Microsoft.Network/frontDoors/frontendEndpoints/enableHttps/action | 프런트 엔드 엔드포인트에서 HTTPS를 사용하도록 설정 |
> | 액션(Action) | Microsoft.Network/frontDoors/frontendEndpoints/read | 프런트 엔드 엔드포인트 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/frontendEndpoints/write | 프런트 엔드 엔드포인트를 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/healthProbeSettings/delete | 상태 프로브 설정 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoors/healthProbeSettings/read | 상태 프로브 설정 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/healthProbeSettings/write | 상태 프로브 설정을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/loadBalancingSettings/delete | 부하 분산 설정을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/loadBalancingSettings/read | 부하 분산 설정 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/loadBalancingSettings/write | 부하 분산 설정을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/purge/action | Front Door에서 캐시된 콘텐츠 제거 |
> | 액션(Action) | Microsoft.Network/frontDoors/read | Front Door 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/routingRules/delete | 라우팅 규칙 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoors/routingRules/read | 라우팅 규칙 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoors/routingRules/write | 라우팅 규칙을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/frontDoors/validateCustomDomain/action | Front Door에 대한 프런트 엔드 엔드포인트 유효성 검사 |
> | 액션(Action) | Microsoft.Network/frontDoors/write | Front Door를 만들거나 업데이트 |
> | 액션(Action) | Microsoft. Network/frontDoorWebApplicationFirewallManagedRuleSets/read | 웹 응용 프로그램 방화벽 관리 되는 규칙 집합을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/delete | 웹 애플리케이션 방화벽 정책 삭제 |
> | 액션(Action) | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/read | 웹 애플리케이션 방화벽 정책 가져오기 |
> | 액션(Action) | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/write | 웹 애플리케이션 방화벽 정책을 만들거나 업데이트 |
> | 액션(Action) | Microsoft.Network/loadBalancers/backendAddressPools/join/action | 부하 분산 장치 백 엔드 주소 풀을 조인 합니다. 했어야 하지 않습니다. |
...
> | 액션(Action) | Microsoft.Network/loadBalancers/frontendIPConfigurations/join/action | 부하 분산 장치 프런트 엔드 IP 구성을 조인합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/loadBalancers/frontendIPConfigurations/read | 부하 분산 장치 프런트 엔드 IP 구성 정의를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/loadBalancers/inboundNatPools/join/action | 부하 분산 장치 인바운드 NAT 풀을 조인 합니다. 했어야 하지 않습니다. |
...
> | 액션(Action) | Microsoft.Network/loadBalancers/inboundNatRules/join/action | 부하 분산 장치 인바운드 nat 규칙을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/loadBalancers/inboundNatRules/read | 부하 분산 장치 인바운드 NAT 규칙 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/loadBalancers/probes/join/action | 부하 분산 장치 프로브 사용을 허용합니다. 예를 들어 이 권한이 있으면 VM 확장 집합의 healthProbe 속성이 프로브를 참조할 수 있습니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/loadBalancers/probes/read | 부하 분산 장치 프로브를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/loadBalancers/read | 부하 분산 장치 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft. 네트워크/위치/autoApprovedPrivateLinkServices/읽기 | 자동 승인 된 개인 링크 서비스를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/locations/availableDelegations/read | 사용 가능한 위임을 가져옵니다. |
> | 액션(Action) | Microsoft. 네트워크/위치/availablePrivateEndpointTypes/읽기 | 사용 가능한 개인 끝점 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft. 네트워크/위치/availableServiceAliases/읽기 | 사용 가능한 서비스 별칭을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/locations/bareMetalTenants/action | 운영 체제 미 설치 컴퓨터 테넌트를 할당하거나 유효성을 검사합니다. |
...
> | 액션(Action) | Microsoft. Network/위치/checkPrivateLinkServiceVisibility/작업 | 개인 링크 서비스 표시 여부를 확인 합니다. |
> | 액션(Action) | Microsoft.Network/locations/operationResults/read | 비동기 POST 또는 DELETE 작업의 작업 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/locations/operations/read | 비동기 작업의 상태를 나타내는 작업 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft. 네트워크/위치/serviceTags/읽기 | 서비스 태그 가져오기 |
...
> | 액션(Action) | Microsoft.Network/locations/virtualNetworkAvailableEndpointServices/read | 사용 가능한 가상 네트워크 엔드포인트 서비스 목록을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/networkInterfaces/effectiveNetworkSecurityGroups/action | VM의 네트워크 인터페이스에 구성된 네트워크 보안 그룹을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/networkInterfaces/effectiveRouteTable/action | VM의 네트워크 인터페이스에 구성된 경로 테이블을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/networkInterfaces/ipconfigurations/join/action | 네트워크 인터페이스 IP 구성을 조인합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/networkInterfaces/ipconfigurations/read | 네트워크 인터페이스의 IP 구성 정의를 가져옵니다.  |
> | 액션(Action) | Microsoft.Network/networkInterfaces/join/action | 가상 컴퓨터를 네트워크 인터페이스에 조인 합니다. 했어야 하지 않습니다. |
...
> | 액션(Action) | Microsoft.Network/networkSecurityGroups/join/action | 네트워크 보안 그룹을 조인 합니다. 했어야 하지 않습니다. |
...
> | 액션(Action) | Microsoft.Network/networkWatchers/connectionMonitors/query/action | 지정된 엔드포인트 간의 연결 모니터링을 쿼리합니다. |
...
> | 액션(Action) | Microsoft.Network/p2sVpnGateways/getp2svpnconnectionhealth/action | P2SVpnGateway에 대한 P2S Vpn 연결 상태를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/p2sVpnGateways/getp2svpnconnectionhealthdetailed/action | P2SVpnGateway에 대 한 자세한 P2S Vpn 연결 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/p2sVpnGateways/read | P2SVpnGateway를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/p2sVpnGateways/write | P2SVpnGateway를 씁니다. |
> | 액션(Action) | Microsoft. Network/privateDnsOperationResults/read | 사설 DNS 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsOperationStatuses/read | 사설 DNS 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/A/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' A ' 형식을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/A/read | JSON 형식의 사설 DNS 영역 내에서 ' A ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/A/write | 사설 DNS 영역 내에서 ' A ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/AAAA/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' AAAA ' 형식을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/AAAA/read | JSON 형식의 사설 DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/AAAA/write | 사설 DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/ALL/read | 형식 간에 사설 DNS 레코드 집합을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/CNAME/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' CNAME ' 형식을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/CNAME/read | JSON 형식의 사설 DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/CNAME/write | 사설 DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/delete | 사설 DNS 영역을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/MX/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' MX ' 유형을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/MX/read | JSON 형식의 사설 DNS 영역 내에서 ' MX ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/MX/write | 사설 DNS 영역 내에서 ' MX ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/PTR/delete | 사설 DNS 영역에서 지정 된 이름 및 ' PTR ' 형식의 레코드 집합을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/PTR/read | JSON 형식의 사설 DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/PTR/write | 사설 DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/read | JSON 형식의 사설 DNS 영역 속성을 가져옵니다. 이 명령은 사설 DNS 영역이 연결 된 가상 네트워크 또는 영역 내에 포함 된 레코드 집합을 검색 하지 않습니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/레코드 집합/읽기 | 형식 간에 사설 DNS 레코드 집합을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/SOA/read | JSON 형식의 사설 DNS 영역 내에서 ' SOA ' 형식의 레코드 집합을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/SOA/write | 사설 DNS 영역 내에서 ' SOA ' 형식의 레코드 집합을 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/SRV/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합과 ' SRV ' 형식을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/SRV/read | JSON 형식의 사설 DNS 영역 내에서 ' SRV ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/SRV/write | 사설 DNS 영역 내에서 ' SRV ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/TXT/delete | 사설 DNS 영역에서 지정 된 이름 및 ' TXT ' 형식의 레코드 집합을 제거 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/TXT/read | JSON 형식의 사설 DNS 영역 내에서 ' TXT ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/TXT/write | 사설 DNS 영역 내에서 ' TXT ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/virtualNetworkLinks/delete | 가상 네트워크에 대 한 사설 DNS 영역 링크를 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/virtualNetworkLinks/read | JSON 형식의 가상 네트워크 속성에 대 한 사설 DNS 영역 링크를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/virtualNetworkLinks/write | 가상 네트워크에 대 한 사설 DNS 영역 링크를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/privateDnsZones/write | 리소스 그룹 내의 사설 DNS 영역을 만들거나 업데이트 합니다. 이 명령은 영역 내에서 가상 네트워크 링크 또는 레코드 집합을 만들거나 업데이트 하는 데 사용할 수 없습니다. |
> | 액션(Action) | Microsoft. Network/privateEndpointRedirectMaps/read | 개인 끝점 RedirectMap을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateEndpointRedirectMaps/write | 개인 끝점 RedirectMap을 만들거나 기존 개인 끝점 RedirectMap을 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/privateEndpoints/delete | 개인 끝점 리소스를 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/privateEndpoints/read | 개인 끝점 리소스를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateEndpoints/write | 새 개인 끝점을 만들거나 기존 개인 끝점을 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/privateLinkServices/delete | 프라이빗 링크 서비스 자원을 삭제합니다. |
> | 액션(Action) | Microsoft. Network/privateLinkServices/privateEndpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/privateLinkServices/privateEndpointConnections/read | 개인 끝점 연결 정의를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/privateLinkServices/privateEndpointConnections/write | 새 개인 끝점 연결을 만들거나 기존 개인 끝점 연결을 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/privateLinkServices/read | 프라이빗 링크 서비스 리소스를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/publicIPAddresses/join/action | 공용 ip 주소를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/publicIPAddresses/read | 공용 IP 주소 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/publicIPPrefixes/join/action | PublicIPPrefix을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/publicIPPrefixes/read | 공용 IP 접두사 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/routeFilters/join/action | 경로 필터를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/routeFilters/read | 경로 필터 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/routeTables/delete | 경로 테이블 정의를 삭제합니다. |
> | 액션(Action) | Microsoft.Network/routeTables/join/action | 경로 테이블을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/routeTables/read | 경로 테이블 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/securegateways/delete | 보안 게이트웨이를 삭제합니다. |
> | 액션(Action) | Microsoft.Network/securegateways/read | 보안 게이트웨이를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/serviceEndpointPolicies/join/action | 서비스 끝점 정책을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/serviceEndpointPolicies/joinSubnet/action | 서브넷을 서비스 끝점 정책에 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/serviceEndpointPolicies/read | 서비스 엔드포인트 정책 설명을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/serviceEndpointPolicies/serviceEndpointPolicyDefinitions/write | 서비스 엔드포인트 정책 정의를 만들거나 기존 서비스 엔드포인트 정책 정의를 업데이트합니다. |
...
> | 액션(Action) | Microsoft. Network/virtualHubs/routeTables/delete | VirtualHubRouteTableV2 삭제 |
> | 액션(Action) | Microsoft. Network/virtualHubs/routeTables/read | VirtualHubRouteTableV2 가져오기 |
> | 액션(Action) | Microsoft. Network/virtualHubs/routeTables/write | VirtualHubRouteTableV2 만들기 또는 업데이트 |
...
> | 액션(Action) | Microsoft.Network/virtualNetworks/BastionHosts/action | Virtual Network의 요새 호스트 참조를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/bastionHosts/default/action | Virtual Network의 요새 호스트 참조를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/checkIpAddressAvailability/read | IP 주소를 지정된 가상 네트워크에서 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/delete | 가상 네트워크를 삭제합니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/join/action | 가상 네트워크를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/peer/action | 가상 네트워크를 다른 가상 네트워크와 피어링합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/read | 가상 네트워크 정의를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/delete | 컨텍스트 서비스 끝점 정책을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/read | 상황별 서비스 끝점 정책을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/write | 컨텍스트 서비스 끝점 정책을 만들거나 기존 컨텍스트 서비스 끝점 정책을 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/delete | 가상 네트워크 서브넷을 삭제합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/join/action | 가상 네트워크를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | 스토리지 계정 또는 SQL 데이터베이스 같은 리소스를 서브넷에 조인합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/prepareNetworkPolicies/action | 필요한 네트워크 정책을 적용하여 서브넷을 준비합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/read | 가상 네트워크 서브넷 정의를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualNetworks/서브넷/unprepareNetworkPolicies/action | 적용 된 네트워크 정책을 제거 하 여 서브넷을 Unprepare 합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/virtualMachines/read | 가상 네트워크 서브넷의 모든 가상 머신에 대한 참조를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/subnets/write | 가상 네트워크 서브넷을 만들거나 기존 가상 네트워크 서브넷을 업데이트합니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworks/usages/read | 가상 네트워크의 각 서브넷에 대한 IP 사용량을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Network/virtualNetworkTaps/join/action | 가상 네트워크 탭을 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworkTaps/read | 가상 네트워크 탭을 가져옵니다. |
> | 액션(Action) | Microsoft.Network/virtualNetworkTaps/write | 가상 네트워크 탭을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/delete | VirtualRouter를 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/조인/작업 | VirtualRouter를 조인 합니다. 했어야 하지 않습니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/읽기 | VirtualRouter를 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/s s t/삭제 | VirtualRouterPeering 링을 삭제 합니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/s s t e r/s t r/읽기 | VirtualRouterPeering 링을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/s s t r o p s/쓰기 | VirtualRouterPeering 링을 만들거나 기존 VirtualRouterPeering 링을 업데이트 합니다. |
> | 액션(Action) | Microsoft. Network/virtualRouters/write | VirtualRouter를 만들거나 기존 VirtualRouter를 업데이트 합니다. |
> | 액션(Action) | Microsoft.Network/virtualWans/delete | 가상 Wan을 삭제합니다. |
> | 액션(Action) | Microsoft. Network/virtualwans/generateVpnProfile/action | VirtualWanVpnServerConfiguration VpnProfile 생성 |
...
> | 액션(Action) | Microsoft.Network/virtualWans/virtualHubs/read | 가상 WAN을 참조하는 모든 가상 허브를 가져옵니다. |
> | 액션(Action) | Microsoft.Network/virtualwans/vpnconfiguration/action | VPN 구성을 가져옵니다. |
> | 액션(Action) | Microsoft. Network/virtualwans/vpnServerConfigurations/action | VirtualWanVpnServerConfigurations 가져오기 |
> | 액션(Action) | Microsoft.Network/virtualWans/vpnSites/read | 가상 WAN을 참조하는 모든 VPN 사이트를 가져옵니다. |
...
> | 액션(Action) | microsoft. network/vpnGateways/vpnConnections/vpnLinkConnections/read | Vpn 링크 연결을 가져옵니다. |
...
> | 액션(Action) | Microsoft. Network/vpnServerConfigurations/delete | VpnServerConfiguration 삭제 |
> | 액션(Action) | Microsoft. Network/vpnServerConfigurations/read | VpnServerConfiguration 가져오기 |
> | 액션(Action) | Microsoft. Network/vpnServerConfigurations/write | VpnServerConfiguration 만들기 또는 업데이트 |
...
> | 액션(Action) | microsoft. network/vpnSites/vpnSiteLinks/read | Vpn 사이트 링크를 가져옵니다. |
...
> | 액션(Action) | Microsoft.NotificationHubs/unregister/action | NotificationHubs 리소스 공급자에 대한 구독을 등록 취소하고 네임스페이스와 NotificationHubs 만들기를 사용하도록 설정합니다. |
...
> | 액션(Action) | Microsoft. OffAzure/HyperVSites/healthsummary/read | Hyper-v 리소스에 대 한 상태 요약을 가져옵니다. |
...
> | 액션(Action) | Microsoft.OffAzure/register/action | Microsoft.OffAzure 리소스 공급자에 구독을 등록합니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/job/read | 서버 작업의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/machines/read | 서버 컴퓨터의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/machines/write | 서버 컴퓨터의 속성 쓰기 |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/operationsstatus/read | 서버 작업 상태의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/read | 서버 사이트의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/refresh/action | 서버 사이트 내의 개체를 새로 고칩니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/runasaccounts/read | 서버 실행 계정의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/usage/read | 서버 사이트의 용도를 가져옵니다. |
> | 액션(Action) | Microsoft. OffAzure/ServerSites/write | 서버 사이트를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.OffAzure/VMwareSites/delete | VMware 사이트를 삭제합니다. |
> | 액션(Action) | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
...
> | 액션(Action) | Microsoft.OffAzure/VMwareSites/machines/start/action | VMware 머신을 시작합니다. |
> | 액션(Action) | Microsoft.OffAzure/VMwareSites/machines/stop/action | VMware 머신을 중지합니다. |
...
> | 액션(Action) | microsoft.operationalinsights/operations/read | 사용 가능한 모든 OperationalInsights Rest API 작업을 나열합니다. |
> | 액션(Action) | operationalinsights/register/action | 구독을 Rergisters 합니다. |
> | 액션(Action) | Microsoft.OperationalInsights/register/action | 리소스 공급자에 구독을 등록합니다. |
> | 액션(Action) | operationalinsights/등록 취소/작업 | 구독의 등록을 취소 합니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/gateways/delete | 작업 영역에 대해 구성된 게이트웨이를 제거합니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/generateregistrationcertificate/action | 작업 영역에 대한 등록 인증서를 생성합니다. 이 인증서는 Microsoft System Center Operation Manager를 작업 영역에 연결하는 데 사용됩니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/linkedServices/delete | 지정된 작업 영역에서 연결된 서비스를 삭제합니다. |
...
> | 액션(Action) | operationalinsights/작업 영역/작업/읽기 | OperationalInsights 작업 영역 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/purge/action | 작업 영역에서 지정된 데이터를 삭제합니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesAccountLogon/읽기 | AADDomainServicesAccountLogon 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesAccountManagement/읽기 | AADDomainServicesAccountManagement 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesDirectoryServiceAccess/읽기 | AADDomainServicesDirectoryServiceAccess 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesLogonLogoff/읽기 | AADDomainServicesLogonLogoff 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesPolicyChange/읽기 | AADDomainServicesPolicyChange 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesPrivilegeUse/읽기 | AADDomainServicesPrivilegeUse 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AADDomainServicesSystemSecurity/읽기 | AADDomainServicesSystemSecurity 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AddonAzureBackupAlerts/읽기 | AddonAzureBackupAlerts 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AddonAzureBackupJobs/읽기 | AddonAzureBackupJobs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AddonAzureBackupPolicy/읽기 | AddonAzureBackupPolicy 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AddonAzureBackupProtectedInstance/읽기 | AddonAzureBackupProtectedInstance 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AddonAzureBackupStorage/읽기 | AddonAzureBackupStorage 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ADFActivityRun/read | ADFActivityRun 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ADFPipelineRun/읽기 | ADFPipelineRun 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ADFTriggerRun/읽기 | ADFTriggerRun 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AmlComputeClusterEvent/읽기 | AmlComputeClusterEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AmlComputeClusterNodeEvent/읽기 | AmlComputeClusterNodeEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/workspaces/query/AmlComputeJobEvent/read | AmlComputeJobEvent 테이블에서 데이터 읽기 |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ApiManagementGatewayLogs/읽기 | ApiManagementGatewayLogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/AppCenterError/read | AppCenterError 테이블의 데이터 읽기 |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/ApplicationInsights/read | ApplicationInsights 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AppPlatformLogsforSpring/읽기 | AppPlatformLogsforSpring 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/Appservice환경 Platformlogs/read | Appservice환경 Platformlogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/AuditLogs/read | AuditLogs 테이블에서 데이터 읽기 |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AutoscaleEvaluationsLog/읽기 | AutoscaleEvaluationsLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AutoscaleScaleActionsLog/읽기 | AutoscaleScaleActionsLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AWSCloudTrail/read | AWSCloudTrail 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/AzureActivity/read | AzureActivity 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/AzureAssessmentRecommendation/읽기 | AzureAssessmentRecommendation 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/AzureMetrics/read | AzureMetrics 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/BaiClusterEvent/읽기 | BaiClusterEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/BaiClusterNodeEvent/읽기 | BaiClusterNodeEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/BaiJobEvent/읽기 | BaiJobEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/BlockchainApplicationLog/읽기 | BlockchainApplicationLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/BlockchainProxyLog/읽기 | BlockchainProxyLog 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ContainerNodeInventory/읽기 | ContainerNodeInventory 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ContainerRegistryLoginEvents/읽기 | ContainerRegistryLoginEvents 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ContainerRegistryRepositoryEvents/읽기 | ContainerRegistryRepositoryEvents 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/ContainerServiceLog/read | ContainerServiceLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/CoreAzureBackup/읽기 | CoreAzureBackup 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksAccounts/읽기 | DatabricksAccounts 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksClusters/읽기 | DatabricksClusters 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksDBFS/읽기 | DatabricksDBFS 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksInstancePools/읽기 | DatabricksInstancePools 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksJobs/읽기 | DatabricksJobs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksNotebook/읽기 | DatabricksNotebook 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksSecrets/읽기 | DatabricksSecrets 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksSQLPermissions/읽기 | DatabricksSQLPermissions 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksSSH/읽기 | DatabricksSSH 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksTables/읽기 | DatabricksTables 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/DatabricksWorkspace/읽기 | DatabricksWorkspace 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/FailedIngestion/읽기 | FailedIngestion 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/Heartbeat/read | Heartbeat 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/HuntingBookmark/읽기 | HuntingBookmark 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/InsightsMetrics/읽기 | InsightsMetrics 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/IntuneAuditLogs/read | IntuneAuditLogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/IntuneOperationalLogs/read | IntuneOperationalLogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/KubeEvents/read | KubeEvents 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/KubeHealth/읽기 | KubeHealth 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/KubeNodeInventory/read | KubeNodeInventory 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/KubePodInventory/read | KubePodInventory 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/KubeServices/read | KubeServices 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/LinuxAuditLog/read | LinuxAuditLog 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MADeviceNotEnrolled/read | MADeviceNotEnrolled 테이블의 데이터 읽기 |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MADeviceNRT/read | MADeviceNRT 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/Ma Addinentityhealth/read | Ma의 Addinentityhealth 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeAddinHealth/read | MAOfficeAddinHealth 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeAddinHealthEventNRT/읽기 | MAOfficeAddinHealthEventNRT 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeAddinHealthIssues/read | MAOfficeAddinHealthIssues 테이블에서 데이터 읽기 |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeAppCrashesNRT/읽기 | MAOfficeAppCrashesNRT 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppHealth/read | MAOfficeAppHealth 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppInstance/read | MAOfficeAppInstance 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeAppInstanceHealth/read | MAOfficeAppInstanceHealth 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppReadiness/read | MAOfficeAppReadiness 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeAppSessionsNRT/read | MAOfficeAppSessionsNRT 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/MAOfficeBuildInfo/read | MAOfficeBuildInfo 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/workspaces/query/MAOfficeDeploymentStatusNRT/read | MAOfficeDeploymentStatusNRT 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeMacroErrorNRT/읽기 | MAOfficeMacroErrorNRT 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAOfficeMacroGlobalHealth/읽기 | MAOfficeMacroGlobalHealth 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MAWindowsDeploymentStatusNRT/read | MAWindowsDeploymentStatusNRT 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/McasShadowItReporting/읽기 | McasShadowItReporting 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftDataShareShareLog/읽기 | MicrosoftDataShareShareLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftHealthcareApisAuditLogs/읽기 | MicrosoftHealthcareApisAuditLogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftInsightsAzureActivityLog/읽기 | MicrosoftInsightsAzureActivityLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftWebApplicationLog/읽기 | MicrosoftWebApplicationLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftWebFunctionExecutionLogs/읽기 | MicrosoftWebFunctionExecutionLogs 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftWebStdOutStdErrLog/읽기 | MicrosoftWebStdOutStdErrLog 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/MicrosoftWebW3CLog/읽기 | MicrosoftWebW3CLog 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/read | 작업 영역의 데이터에서 쿼리를 실행 |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/ReservedAzureCommonFields/read | ReservedAzureCommonFields 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/SecurityIoTRawEvent/읽기 | SecurityIoTRawEvent 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/보안 권장 사항/읽기 | SecurityRecommendation 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/ServiceFabricOperationalEvent/read | ServiceFabricOperationalEvent 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/SigninLogs/read | SigninLogs 테이블에서 데이터 읽기 |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/SPAssessmentRecommendation/read | SPAssessmentRecommendation 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/SqlThreatProtectionLoginAudits/읽기 | SqlThreatProtectionLoginAudits 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/SqlVulnerabilityAssessmentResult/읽기 | SqlVulnerabilityAssessmentResult 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/SucceededIngestion/읽기 | SucceededIngestion 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/Syslog/read | Syslog 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | OperationalInsights/작업 영역/쿼리/ThreatIntelligenceIndicator/읽기 | ThreatIntelligenceIndicator 테이블에서 데이터를 읽습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/UAApp/read | UAApp 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/WindowsEvent/read | WindowsEvent 테이블에서 데이터 읽기 |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/query/WindowsFirewall/read | WindowsFirewall 테이블에서 데이터를 읽습니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/regeneratesharedkey/action | 지정된 작업 영역 공유 키를 다시 생성합니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/rules/read | 모든 경고 규칙을 가져옵니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/savedSearches/delete | 저장된 검색 쿼리를 삭제합니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/savedSearches/read | 저장된 검색 쿼리를 가져옵니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/results/read | 저장된 검색 결과를 가져옵니다. 사용되지 않음 |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/actions/delete | 예약된 검색 작업을 삭제합니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/actions/read | 예약된 검색 작업을 가져옵니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/actions/write | 예약된 검색 작업을 만들거나 업데이트합니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/delete | 예약된 검색을 삭제합니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/read | 예약된 검색을 가져옵니다. |
> | 액션(Action) | microsoft.operationalinsights/workspaces/savedsearches/schedules/write | 예약된 검색을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/savedSearches/write | 저장된 검색 쿼리를 만듭니다. |
...
> | 액션(Action) | microsoft.operationalinsights/workspaces/search/read | 검색 결과를 가져옵니다. 사용되지 않습니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/sharedKeys/action | 작업 영역에 대한 공유 키를 검색합니다. 이러한 키는 Microsoft Operational Insights 에이전트를 작업 영역에 연결하는 데 사용됩니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/storageinsightconfigs/delete | 스토리지 구성을 삭제합니다. 이렇게 하면 Microsoft Operational Insights에서 스토리지 계정의 데이터 읽기를 중지합니다. |
...
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/upgradetranslationfailures/read | 작업 영역에 대한 검색 업그레이드 변환 오류 로그를 가져옵니다. |
> | 액션(Action) | Microsoft.OperationalInsights/workspaces/usages/read | 작업 영역에서 읽는 데이터 양을 포함하여 작업 영역에 대한 사용량 현황 데이터를 가져옵니다. |
...
> | 액션(Action) | Microsoft.OperationsManagement/managementConfigurations/read | 기존 관리 구성을 가져옵니다. |
...
> | 액션(Action) | Microsoft. PolicyInsights/작업/읽기 | Microsoft PolicyInsights 네임 스페이스에 대해 지원 되는 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft.PolicyInsights/register/action | Microsoft Policy Insights 리소스 공급자를 등록 하 고 작업을 사용 하도록 설정 합니다. |
> | 액션(Action) | Microsoft.PolicyInsights/remediations/cancel/action | 진행 중인 Microsoft Policy 재구성를 취소 합니다. |
...
> | 액션(Action) | Microsoft.PolicyInsights/remediations/write | Microsoft Policy 재구성를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft. PolicyInsights/등록 취소/작업 | Microsoft Policy Insights 리소스 공급자를 등록 취소 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.Portal/consoles/delete | Cloud Shell 인스턴스를 제거 합니다. |
> | 액션(Action) | Microsoft. 포털/콘솔/읽기 | Cloud Shell 인스턴스를 읽습니다. |
> | 액션(Action) | Microsoft.Portal/consoles/write | Cloud Shell 인스턴스를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.Portal/dashboards/delete | 구독에서 대시보드를 제거합니다. |
...
> | 액션(Action) | Microsoft.Portal/register/action | 포털에 등록합니다. |
> | 액션(Action) | Microsoft.Portal/usersettings/delete | Cloud Shell 사용자 설정을 제거 합니다. |
> | 액션(Action) | Microsoft.Portal/usersettings/read | Cloud Shell 사용자 설정을 읽습니다. |
> | 액션(Action) | Microsoft.Portal/usersettings/write | 사용자 설정 Cloud Shell 만들거나 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.PowerBIDedicated/capacities/delete | Power BI 전용 용량을 삭제합니다. |
> | 액션(Action) | Microsoft.PowerBIDedicated/capacities/read | 지정된 Power BI 전용 용량에 대한 정보를 검색합니다. |
...
> | 액션(Action) | Microsoft. PowerBIDedicated/위치/checkNameAvailability/action | 지정된 Power BI 전용 용량 이름이 올바르고 사용 중이 아닌지 확인합니다. |
> | 액션(Action) | Microsoft.PowerBIDedicated/locations/operationresults/read | 지정된 작업 결과에 대한 정보를 검색합니다. |
...
> | 액션(Action) | Microsoft.RecoveryServices/Locations/backupPreValidateProtection/action |  |
> | 액션(Action) | Microsoft RecoveryServices/위치/backupProtectedItem/쓰기 | 백업 보호 항목을 만듭니다. |
> | 액션(Action) | Microsoft RecoveryServices/위치/backupProtectedItems/읽기 | 모든 보호 항목 목록을 반환합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/Locations/backupStatus/action | Recovery Services 자격 증명 모음의 백업 상태를 반환합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/Locations/backupValidateFeatures/action | 기능의 유효성을 검사합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/locations/checkNameAvailability/action | Check Resource Name Availability는 리소스 이름을 사용할 수 있는지 확인하는 API입니다. |
> | 액션(Action) | Microsoft.RecoveryServices/locations/operationStatus/read | 지정된 작업의 작업 상태를 가져옵니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/operationsStatus/읽기 | 작업의 상태를 반환합니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/protectionContainers/operationsStatus/read | 보호 컨테이너에 대해 수행 된 작업의 상태를 가져옵니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/backupJobs/operationsStatus/read | 작업의 상태를 반환 합니다. |
...
> | 액션(Action) | Microsoft.RecoveryServices/Vaults/backupOperationResults/read | Recovery Services 자격 증명 모음의 Backup 작업 결과를 반환합니다. |
...
> | 액션(Action) | Microsoft.RecoveryServices/Vaults/backupstorageconfig/read | Recovery Services 자격 증명 모음에 대한 스토리지 구성을 반환합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/Vaults/backupstorageconfig/write | Recovery Services 자격 증명 모음에 대한 스토리지 구성을 업데이트합니다. |
...
> | 액션(Action) | Microsoft.RecoveryServices/Vaults/read | 자격 증명 모음 가져오기 작업에서는 '자격 증명 모음' 형식의 Azure 리소스를 나타내는 개체를 가져옵니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/operationresults/read | 리소스 패브릭에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/operationresults/read | 리소스 보호 컨테이너에서 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/delete | 마이그레이션 항목을 삭제합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/migrate/action | 마이그레이션 항목 |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/migrationRecoveryPoints/read | 마이그레이션 복제 복구 지점을 읽습니다. |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/operationresults/read | 리소스 마이그레이션 항목에 대 한 비동기 작업의 결과 추적 |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/read | 마이그레이션 항목을 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/testMigrate/action | 테스트 마이그레이션 |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/testMigrateCleanup/action | 테스트 마이그레이션 정리 |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/write | 마이그레이션 항목을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectableItems/read | 보호 가능한 항목을 읽습니다. |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/addDisks/작업 | 디스크 추가 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/operationresults/read | 리소스 보호 항목에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/removeDisks/작업 | 디스크 제거 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/ResolveHealthErrors/action |  |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/operationresults/read | 리소스 보호 컨테이너 매핑에서 비동기 작업의 결과를 추적 합니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationRecoveryServicesProviders/operationresults/read | 리소스 Recovery Services 공급자에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/read | 스토리지 분류를 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/delete | 스토리지 분류 매핑을 삭제합니다. |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/operationresults/read | 리소스 저장소 분류 매핑에서 비동기 작업의 결과 추적 |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/read | 스토리지 분류 매핑을 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/write | 스토리지 분류 매핑을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationvCenters/delete | vCenter를 삭제합니다. |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationvCenters/operationresults/read | 리소스 \ 리소스에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationJobs/operationresults/read | 리소스 작업에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationMigrationItems/read | 마이그레이션 항목을 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationNetworkMappings/read | 네트워크 매핑을 읽습니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationPolicies/operationresults/read | 리소스 정책에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationRecoveryPlans/operationresults/read | 리소스 복구 계획에 대 한 비동기 작업의 결과 추적 |
...
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationStorageClassificationMappings/read | 스토리지 분류 매핑을 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationStorageClassifications/read | 스토리지 분류를 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationSupportedOperatingSystems/read | 모든 항목을 읽습니다.  |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationUsages/read | 자격 증명 모음 복제 사용 현황을 읽습니다. |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationVaultHealth/operationresults/read | 리소스 자격 증명 모음 복제 상태에 대 한 비동기 작업의 결과를 추적 합니다. |
...
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationVaultSettings/읽기 | 모든 항목을 읽습니다.  |
> | 액션(Action) | Microsoft RecoveryServices/자격 증명 모음/replicationVaultSettings/쓰기 | 만들기 또는 업데이트  |
> | 액션(Action) | Microsoft.RecoveryServices/vaults/replicationvCenters/read | vCenter를 읽습니다. |
> | 액션(Action) | Microsoft.RecoveryServices/Vaults/usages/read | 자격 증명 모음 사용 현황을 읽습니다. |
...
> | 액션(Action) | Microsoft.Relay/namespaces/authorizationRules/action | 네임스페이스 권한 부여 규칙을 업데이트합니다. 이 API는 더 이상 사용되지 않습니다. 그 대신 PUT 호출을 사용하여 네임스페이스 권한 부여 규칙을 업데이트하세요. 이 작업은 API 버전 2017-04-01에서 지원되지 않습니다. |
...
> | 액션(Action) | Microsoft. Relay/네임 스페이스/공급자/Microsoft/diagnosticSettings/read | 네임스페이스 진단 설정 리소스 설명의 목록을 가져옵니다. |
> | 액션(Action) | Microsoft. Relay/네임 스페이스/공급자/Microsoft/diagnosticSettings/write | 네임스페이스 진단 설정 리소스 설명의 목록을 가져옵니다. |
> | 액션(Action) | Microsoft. Relay/네임 스페이스/공급자/Microsoft의 Insights/logDefinitions/읽기 | 네임스페이스 로그 리소스 설명의 목록을 가져옵니다. |
...
> | 액션(Action) | Microsoft ResourceHealth/metadata/read | 메타 데이터를 가져옵니다. |
> | 액션(Action) | Microsoft.ResourceHealth/Operations/read | Microsoft ResourceHealth에 사용 가능한 작업을 가져옵니다. |
> | 액션(Action) | Microsoft.ResourceHealth/register/action | Microsoft ResourceHealth에 대한 구독을 등록합니다. |
> | 액션(Action) | Microsoft.ResourceHealth/unregister/action | Microsoft ResourceHealth에 대한 구독을 등록 취소합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | CalculateTemplateHash/작업 | 제공 된 템플릿의 해시를 계산 합니다. |
...
> | 액션(Action) | Microsoft .Resources/배포/내보내기 템플릿/작업 | 배포용 템플릿 내보내기 |
> | 액션(Action) | Microsoft.Resources/deployments/operations/read | 배포 작업을 가져오거나 나열합니다. |
> | 액션(Action) | Microsoft .Resources/배포/operationstatuses/읽기 | 배포 작업 상태를 가져오거나 나열합니다. |
...
> | 액션(Action) | Microsoft .Resources/배포/p i/작업 | 템플릿 배포 변경 사항을 예측 합니다. |
...
> | 액션(Action) | Microsoft .Resources/tags/delete | 리소스의 모든 태그를 제거 합니다. |
> | 액션(Action) | Microsoft .Resources/tags/read | 리소스의 모든 태그를 가져옵니다. |
> | 액션(Action) | Microsoft .Resources/tags/write | 기존 태그를 새 태그 집합으로 대체 하거나 병합 하거나 기존 태그를 제거 하 여 리소스에 대 한 태그를 업데이트 합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft. Security/adaptiveNetworkHardenings/적용/작업 | 지정 된 네트워크 보안 그룹에서 일치 하는 보안 규칙을 만들어 지정 된 트래픽 강화 규칙을 적용 합니다. |
> | 액션(Action) | Microsoft. Security/adaptiveNetworkHardenings/read | Azure로 보호 되는 리소스의 적응 네트워크 강화 권장 사항을 가져옵니다. |
...
> | 액션(Action) | Microsoft. Security/assessmentMetadata/read | 구독에서 사용 가능한 보안 평가 메타 데이터 가져오기 |
> | 액션(Action) | Microsoft. Security/assessmentMetadata/write | 보안 평가 메타 데이터를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft. 보안/평가/읽기 | 구독에 대 한 보안 평가 가져오기 |
> | 액션(Action) | Microsoft. 보안/평가/작성 | 구독에서 보안 평가를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.Security/complianceResults/read | 리소스에 대한 준수 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Security/informationProtectionPolicies/read | 리소스에 대한 정보 보호 정책을 가져옵니다. |
> | 액션(Action) | Microsoft.Security/informationProtectionPolicies/write | 리소스에 대한 정보 보호 정책을 업데이트합니다. |
> | 액션(Action) | Microsoft.Security/locations/alerts/activate/action | 보안 경고를 활성화합니다. |
...
> | 액션(Action) | Microsoft.Security/settings/read | 범위에 대한 설정을 가져옵니다. |
> | 액션(Action) | Microsoft.Security/settings/write | 범위에 대한 설정을 업데이트합니다. |
> | 액션(Action) | Microsoft.Security/tasks/read | 모든 사용 가능한 보안 권장 사항을 가져옵니다. |
> | 액션(Action) | Microsoft.Security/unregister/action | Azure Security Center에서 구독을 등록 취소합니다. |
> | 액션(Action) | Microsoft.Security/webApplicationFirewalls/delete | 웹 애플리케이션 방화벽을 삭제합니다. |
...
> | 액션(Action) | Microsoft.ServiceBus/locations/deleteVirtualNetworkOrSubnets/action | 지정된 VNet에 대한 ServiceBus 리소스 공급자의 VNet 규칙을 삭제합니다. |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/authorizationRules/action | 네임스페이스 권한 부여 규칙을 업데이트합니다. 이 API는 더 이상 사용되지 않습니다. 그 대신 PUT 호출을 사용하여 네임스페이스 권한 부여 규칙을 업데이트하세요. 이 작업은 API 버전 2017-04-01에서 지원되지 않습니다. |
...
> | 액션(Action) | Microsoft.ServiceBus/namespaces/ipFilterRules/delete | IP 필터 리소스 삭제 |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/ipFilterRules/read | IP 필터 리소스 가져오기 |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/ipFilterRules/write | IP 필터 리소스 만들기 |
...
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 액션(Action) | ServiceBus/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
...
> | 액션(Action) | Microsoft.ServiceBus/namespaces/virtualNetworkRules/delete | VNET 규칙 리소스 삭제 |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/virtualNetworkRules/read | VNET 규칙 리소스 가져오기 |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/virtualNetworkRules/write | VNET 규칙 리소스 만들기 |
> | 액션(Action) | Microsoft.ServiceBus/namespaces/write | 네임스페이스 리소스를 만들고 해당 속성을 업데이트합니다. 네임스페이스의 태그 및 용량은 업데이트할 수 있는 속성입니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft.SignalRService/locations/checknameavailability/action | 새 SignalR 서비스에서 이름을 사용할 수 있는지 확인합니다. |
> | 액션(Action) | Microsoft.SignalRService/locations/operationresults/signalr/read | 비동기 작업의 상태 쿼리 |
> | 액션(Action) | SignalRService/위치/operationStatuses/operationId/읽기 | 비동기 작업의 상태 쿼리 |
> | 액션(Action) | Microsoft.SignalRService/locations/usages/read | Azure SignalR 서비스에 대한 할당량 사용량을 가져옵니다. |
> | 액션(Action) | Microsoft.SignalRService/operationresults/read | 비동기 작업의 상태 쿼리 |
> | 액션(Action) | SignalRService/작업/읽기 | Azure SignalR service에 대 한 작업을 나열 합니다. |
> | 액션(Action) | SignalRService/operationstatus/read | 비동기 작업의 상태 쿼리 |
> | 액션(Action) | Microsoft.SignalRService/register/action | ‘Microsoft.SignalRService’ 리소스 공급자를 구독에 등록합니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/delete | 전체 SignalR 서비스를 삭제합니다. |
> | 액션(Action) | SignalRService/SignalR/eventGridFilters/delete | SignalR에서 event grid 필터를 삭제 합니다. |
> | 액션(Action) | SignalRService/SignalR/eventGridFilters/read | 지정 된 event grid 필터의 속성을 가져오거나 지정 된 SignalR에 대 한 모든 event grid 필터를 나열 합니다. |
> | 액션(Action) | SignalRService/SignalR/eventGridFilters/write | 지정 된 매개 변수를 사용 하 여 SignalR에 대 한 event grid 필터를 만들거나 업데이트 합니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/listkeys/action | 관리 포털에서 또는 API를 통해 SignalR 액세스 키 값을 봅니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/read | 관리 포털 또는 API를 통해 SignalR의 설정과 구성을 확인합니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/regeneratekey/action | 관리 포털에서 또는 API를 통해 SignalR 액세스 키 값을 변경합니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/restart/action | 관리 포털 또는 API를 통해 Azure SignalR 서비스를 다시 시작합니다. 가동 중지 시간이 있을 것입니다. |
> | 액션(Action) | Microsoft.SignalRService/SignalR/write | 관리 포털 또는 API를 통해 SignalR의 설정과 구성을 수정합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft Solutions/applicationDefinitions/Applicationdefinitions/읽기 | 응용 프로그램 정의의 응용 프로그램 아티팩트를 나열 합니다. |
...
> | 액션(Action) | Microsoft. 솔루션/응용 프로그램/a p i 아티팩트/읽기 | 응용 프로그램 아티팩트를 나열 합니다. |
...
> | 액션(Action) | Microsoft 솔루션/응용 프로그램/refreshPermissions/작업 | 응용 프로그램 사용 권한을 새로 고칩니다. |
> | 액션(Action) | Microsoft. Solutions/applications/updateAccess/action | 응용 프로그램 액세스를 업데이트 합니다. |
...
> | 액션(Action) | Microsoft. 솔루션/등록 취소/작업 | 솔루션에서 등록을 취소 합니다. |
...
> | 액션(Action) | Microsoft.Sql/instancePools/delete | 인스턴스 풀을 삭제합니다. |
> | 액션(Action) | Microsoft.Sql/instancePools/read | 인스턴스 풀을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/instancePools/사용량/읽기 | 인스턴스 풀의 사용 정보를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/instancePools/write | 인스턴스 풀을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Sql/locations/auditingSettingsAzureAsyncOperation/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
...
> | 액션(Action) | Microsoft.Sql/locations/elasticPoolAzureAsyncOperation/read | 탄력적 풀 비동기 작업에 대한 azure 비동기 작업을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/elasticPoolOperationResults/read | 탄력적 풀 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/encryptionProtectorAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/encryptionProtectorOperationResults/읽기 | 투명 한 데이터 암호화 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/extendedAuditingSettingsAzureAsyncOperation/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
> | 액션(Action) | Microsoft.Sql/locations/extendedAuditingSettingsOperationResults/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
> | 액션(Action) | Microsoft.Sql/locations/firewallRulesAzureAsyncOperation/read | 방화벽 규칙 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/firewallRulesOperationResults/read | 방화벽 규칙 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/instanceFailoverGroups/delete | 기존 인스턴스 장애 조치(failover) 그룹을 삭제합니다. |
...
> | 액션(Action) | Microsoft.Sql/locations/instanceFailoverGroups/write | 지정한 매개 변수를 사용 하 여 인스턴스 장애 조치 (failover) 그룹을 만들거나 지정 된 인스턴스 장애 조치 (failover) 그룹의 속성 또는 태그를 업데이트 합니다 |
> | 액션(Action) | Microsoft.Sql/locations/instancePoolAzureAsyncOperation/read | 인스턴스 풀 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/instancePoolOperationResults/read | 인스턴스 풀 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/interfaceEndpointProfileAzureAsyncOperation/read | 특정 인터페이스 엔드포인트 Azure 비동기 작업의 세부 정보를 반환합니다. |
> | 액션(Action) | Microsoft.Sql/locations/interfaceEndpointProfileOperationResults/read | 지정된 인터페이스 엔드포인트 프로필 작업의 세부 정보를 반환합니다. |
> | 액션(Action) | Microsoft.Sql/locations/jobAgentAzureAsyncOperation/read | 작업 에이전트 작업의 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/jobAgentOperationResults/read | 작업 에이전트 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/longTermRetentionBackups/read | 위치에 있는 모든 서버의 모든 데이터베이스에 대한 장기 보존 백업을 나열합니다. |
...
> | 액션(Action) | Microsoft .Sql/위치/managedInstanceEncryptionProtectorAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/managedInstanceEncryptionProtectorOperationResults/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/managedInstanceKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 키에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/managedInstanceKeyOperationResults/read | 투명 한 데이터 암호화 관리 되는 인스턴스 키에서 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/managedTransparentDataEncryptionAzureAsyncOperation/read | 관리되는 데이터베이스 투명한 데이터 암호화에 대해 진행 중인 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft .Sql/위치/privateEndpointConnectionAzureAsyncOperation/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/read | 지정된 구독에 사용 가능한 위치를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/serverKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/위치/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/locations/syncAgentOperationResults/read | 동기화 에이전트 리소스 작업의 결과를 검색합니다. |
...
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/backupShortTermRetentionPolicies/read | 관리되는 데이터베이스에 대한 단기 보존 정책을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/backupShortTermRetentionPolicies/write | 관리되는 데이터베이스에 대한 단기 보존 정책을 업데이트합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/데이터베이스/열/읽기 | 관리 되는 데이터베이스에 대 한 열 목록 반환 |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/currentSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/currentSensitivityLabels/write | 일괄 업데이트 민감도 레이블 |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/delete | 기존 관리되는 데이터베이스를 삭제합니다. |
...
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/recommendedSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/recommendedSensitivityLabels/write | Batch 업데이트 권장 민감도 레이블 |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/restoreDetails/read | 복원이 진행 되는 동안 관리 되는 데이터베이스 복원 세부 정보를 반환 합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/스키마/읽기 | 관리 되는 데이터베이스 스키마를 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/읽기 | 관리 되는 데이터베이스 열 가져오기 |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/delete | 지정된 열의 민감도 레이블을 삭제합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/sensitivityLabels/사용 안 함/작업 | 지정 된 열에서 민감도 권장 사항을 사용 하지 않도록 설정 |
> | 액션(Action) | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/read | 지정된 열의 민감도 레이블을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/write | 지정된 열의 민감도 레이블을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft .Sql/managedInstances/데이터베이스/스키마/테이블/읽기 | 관리 되는 데이터베이스 테이블 가져오기 |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 관리 되는 데이터베이스 위협 검색 정책의 목록을 검색 합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/write | 지정된 관리되는 데이터베이스에 대한 데이터베이스 위협 검색 정책을 변경합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/securityEvents/read | 관리되는 데이터베이스 보안 이벤트를 검색합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/sensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/transparentDataEncryption/read | 지정된 관리되는 데이터베이스에서 데이터베이스 투명한 데이터 암호화의 세부 정보를 검색합니다. |
...
> | 액션(Action) | Microsoft.Sql/managedInstances/databases/vulnerabilityAssessments/rules/baselines/delete | 지정된 데이터베이스에 대한 취약성 평가 규칙 기준을 제거합니다. |
...
> | 액션(Action) | Microsoft .Sql/managedInstances/Cr프로텍터/유효성 재검사/작업 | 지정된 서버 암호화 보호기에 대한 속성을 업데이트합니다. |
...
> | 액션(Action) | Microsoft.Sql/managedInstances/recoverableDatabases/read | 복구 가능한 관리되는 데이터베이스 목록을 반환합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/restorableDroppedDatabases/backupShortTermRetentionPolicies/read | 삭제된 관리되는 데이터베이스에 대한 단기 보존 정책을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/restorableDroppedDatabases/backupShortTermRetentionPolicies/write | 삭제된 관리되는 데이터베이스에 대한 단기 보존 정책을 업데이트합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/restorableDroppedDatabases/read | 복원 가능한 삭제된 관리되는 데이터베이스 목록을 반환합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 관리 되는 서버 위협 검색 정책 목록을 검색 합니다. |
> | 액션(Action) | Microsoft.Sql/managedInstances/securityAlertPolicies/write | 지정된 관리되는 서버에 대한 관리되는 서버 위협 검색 정책을 변경합니다. |
...
> | 액션(Action) | Microsoft.Sql/managedInstances/vulnerabilityAssessments/write | 주어진 관리되는 인스턴스에 대한 취약성 평가를 변경합니다. |
...
> | 액션(Action) | Microsoft .Sql/privateEndpointConnectionsApproval/action | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
> | 액션(Action) | Microsoft.Sql/register/action | Microsoft SQL Database 리소스 공급자에 대한 구독을 등록하고 Microsoft SQL Databases를 만들도록 설정합니다. |
> | 액션(Action) | Microsoft.Sql/servers/administrators/delete | 특정 Azure Active Directory 관리자 개체를 삭제 합니다. |
> | 액션(Action) | Microsoft.Sql/servers/administrators/read | 특정 Azure Active Directory 관리자 개체를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/servers/administrators/write | 특정 Azure Active Directory 관리자 개체를 추가 하거나 업데이트 합니다. |
...
> | 액션(Action) | Microsoft .Sql/servers/databases/backupShortTermRetentionPolicies/read | 데이터베이스에 대 한 단기 보존 정책을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/servers/databases/backupShortTermRetentionPolicies/write | 데이터베이스에 대 한 단기 보존 정책을 업데이트 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/databases/columns/read | 데이터베이스에 대 한 열 목록 반환 |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/currentSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 액션(Action) | Microsoft .Sql/servers/databases/currentSensitivityLabels/write | 일괄 업데이트 민감도 레이블 |
> | 액션(Action) | Microsoft.Sql/servers/databases/dataMaskingPolicies/read | 데이터베이스 데이터 마스킹 정책 목록을 반환합니다. |
...
> | 액션(Action) | Microsoft .Sql/servers/데이터베이스/장애 조치/동작 | 고객이 데이터베이스 장애 조치를 시작 했습니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/operationResults/read | 데이터베이스 작업의 상태를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/recommendedSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 액션(Action) | Microsoft .Sql/servers/databases/recommendedSensitivityLabels/write | Batch 업데이트 권장 민감도 레이블 |
> | 액션(Action) | Microsoft.Sql/servers/databases/replicationLinks/delete | 잠재적 데이터 손실이 발생하는 상태로 강제로 복제 관계를 종료합니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/schemas/tables/columns/read | 데이터베이스 열을 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/delete | 지정된 열의 민감도 레이블을 삭제합니다. |
> | 액션(Action) | Microsoft .Sql/servers/데이터베이스/스키마/테이블/열/sensitivityLabels/사용 안 함/작업 | 지정 된 열에서 민감도 권장 사항을 사용 하지 않도록 설정 |
> | 액션(Action) | Microsoft .Sql/servers/databases/스키마/테이블/열/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
> | 액션(Action) | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/read | 지정된 열의 민감도 레이블을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/schemas/tables/recommendedIndexes/read | 데이터베이스에 대한 인덱스 권장 사항 목록을 검색합니다. |
> | 액션(Action) | Microsoft.Sql/servers/databases/schemas/tables/recommendedIndexes/write | 인덱스 권장 사항을 적용합니다. |
> | 액션(Action) | Microsoft.Sql/servers/databases/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 데이터베이스 위협 검색 정책 목록을 검색 합니다. |
> | 액션(Action) | Microsoft.Sql/servers/databases/securityAlertPolicies/write | 지정된 데이터베이스에 대한 데이터베이스 위협 탐지 정책을 변경합니다. |
> | 액션(Action) | Microsoft.Sql/servers/databases/securityMetrics/read | 데이터베이스 보안 메트릭 컬렉션을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/databases/vulnerabilityAssessments/rules/baselines/delete | 지정된 데이터베이스에 대한 취약성 평가 규칙 기준을 제거합니다. |
...
> | 액션(Action) | Microsoft .Sql/servers/elasticPools/failover/작업 | 고객이 탄력적 풀 장애 조치 (failover)를 시작 했습니다. |
...
> | 액션(Action) | Microsoft .Sql/servers///또는 유효성 재검사/작업 | 지정된 서버 암호화 보호기에 대한 속성을 업데이트합니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/jobAgents/read | Azure SQL DB 작업 에이전트를 가져옵니다. |
> | 액션(Action) | Microsoft.Sql/servers/jobAgents/write | Azure SQL DB 작업 에이전트를 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.Sql/servers/keys/delete | 기존 서버 키를 삭제합니다. |
...
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateEndpointConnectionsApproval/action | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
> | 액션(Action) | Microsoft .Sql/servers/privateLinkResources/read | 해당 sql server에 대 한 개인 링크 리소스 가져오기 |
...
> | 액션(Action) | Microsoft.Sql/servers/recoverableDatabases/read | 이 작업은 라이브 데이터베이스의 재해 복구 기능이 데이터베이스를 마지막 정상 지점으로 복원하는 데 사용합니다. 마지막 정상 백업에 대한 정보가 반환되지만 실제로 데이터베이스는 복원되지 않습니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 서버 위협 검색 정책 목록을 검색 합니다. |
> | 액션(Action) | Microsoft.Sql/servers/securityAlertPolicies/write | 지정된 서버에 대한 서버 위협 검색 정책을 변경합니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/syncAgents/linkedDatabases/read | 동기화 에이전트 연결 데이터베이스 목록을 반환합니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/usages/read | 서버 내의 모든 데이터베이스에서 서버 DTU 할당량 및 현재 DTU 사용을 반환 합니다. |
...
> | 액션(Action) | Microsoft.Sql/servers/vulnerabilityAssessments/write | 주어진 서버에 대한 취약성 평가를 변경합니다. |
...
> | 액션(Action) | Microsoft .Sql/virtualClusters/삭제 | 기존 가상 클러스터를 삭제 합니다. |
> | 액션(Action) | Microsoft.Sql/virtualClusters/read | 가상 클러스터 목록을 반환하거나 지정된 가상 클러스터에 대한 속성을 가져옵니다. |
...
> | 액션(Action) | Microsoft. 저장소/위치/checknameavailability/read | 해당 계정 이름이 올바른지와 사용되고 있지 않은지 확인합니다. |
...
> | 액션(Action) | Microsoft.Storage/register/action | 스토리지 리소스 공급자에 대한 구독을 등록하고 스토리지 계정을 만들도록 설정합니다. |
...
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/lease/action | Blob 컨테이너 임대 결과를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/read | 컨테이너를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/read | 컨테이너 목록을 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/setLegalHold/action | Blob 컨테이너 법적 보존을 설정합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/write | Blob 컨테이너 패치 결과를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/containers/write | Blob 컨테이너 넣기의 결과를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/generateUserDelegationKey/action | Blob Service에 대한 사용자 위임 키를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/read |  |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/read | Blob service 속성 또는 통계를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/blobServices/write | Blob service 속성 넣기의 결과를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/delete | 기존 스토리지 계정을 삭제합니다. |
> | 액션(Action) | Microsoft. Storage/storageAccounts/. 범위/읽기 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/대 범위/쓰기 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/failover/action | 가용성 문제가 발생 하는 경우 고객은 장애 조치 (failover)를 제어할 수 있습니다. |
...
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/read |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/read | 파일 서비스 속성 가져오기 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/공유/삭제 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/공유/읽기 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/공유/읽기 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/공유/쓰기 |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/fileServices/write |  |
> | 액션(Action) | Microsoft.Storage/storageAccounts/listAccountSas/Action | 지정된 스토리지 계정에 대한 계정 SAS 토큰을 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/listkeys/action | 지정된 스토리지 계정에 대한 액세스 키를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/listServiceSas/Action | 지정된 스토리지 계정에 대한 서비스 SAS 토큰을 반환합니다. |
> | 액션(Action) | Microsoft. Storage/storageAccounts/managementPolicies/삭제 | 저장소 계정 관리 정책 삭제 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/managementPolicies/읽기 | 저장소 관리 계정 정책 가져오기 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/managementPolicies/쓰기 | 저장소 계정 관리 정책 배치 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/objectReplicationPolicies/delete |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/objectReplicationPolicies/read |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/objectReplicationPolicies/write |  |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시 삭제 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시를 추가 합니다. |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnections/delete | 개인 끝점 연결 삭제 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnections/read | 개인 끝점 연결 가져오기 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateEndpointConnections/write | 개인 끝점 연결 배치 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/PrivateEndpointConnectionsApproval/action | 개인 끝점 연결 승인 |
> | 액션(Action) | Microsoft. Storage/storageAccounts/privateLinkResources/read | StorageAccount groupids 가져오기 |
> | 액션(Action) | Microsoft.Storage/storageAccounts/queueServices/queues/delete | 큐 삭제 결과를 반환합니다. |
...
> | 액션(Action) | Microsoft.Storage/storageAccounts/queueServices/read | 큐 서비스 속성 또는 통계를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/queueServices/write | 큐 서비스 속성 설정 결과를 반환합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/read | 스토리지 계정의 목록을 반환하거나 지정된 스토리지 계정의 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/regeneratekey/action | 지정된 스토리지 계정에 대한 액세스 키를 다시 생성합니다. |
> | 액션(Action) | Microsoft. Storage/storageAccounts/restoreBlobRanges/action | 지정 된 시간 상태로 blob 범위 복원 |
> | 액션(Action) | Microsoft.Storage/storageAccounts/revokeUserDelegationKeys/action | 지정된 스토리지 계정에 대한 모든 사용자 위임 키를 취소합니다. |
> | 액션(Action) | Microsoft.Storage/storageAccounts/services/diagnosticSettings/write | 스토리지 계정 진단 설정을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft. Storage/storageAccounts/tableServices/read | Table service 속성 가져오기 |
> | 액션(Action) | Microsoft.Storage/storageAccounts/write | 지정된 매개 변수를 사용하여 스토리지 계정을 만들거나, 속성 또는 태그를 업데이트하거나, 지정된 스토리지 계정의 사용자 지정 도메인을 추가합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | microsoft.storagesync/locations/checkNameAvailability/action | 해당 스토리지 동기화 서비스 이름이 유효하며 사용되지 않는지 확인합니다. |
> | 액션(Action) | microsoft.storagesync/locations/workflows/operations/read | 비동기 작업의 상태를 가져옵니다. |
> | 액션(Action) | microsoft.storagesync/작업/읽기 | 지원 되는 작업 목록을 가져옵니다. |
> | 액션(Action) | microsoft.storagesync/register/action | 저장소 동기화 공급자에 대 한 구독을 등록 합니다. |
> | 액션(Action) | microsoft.storagesync/storageSyncServices/delete | Storage Sync Services를 삭제합니다. |
...
> | 액션(Action) | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/postbackup/action | 백업 후 이 작업을 호출합니다. |
...
> | 액션(Action) | microsoft.storagesync/storageSyncServices/workflows/operationresults/read | 비동기 작업의 상태를 가져옵니다. |
> | 액션(Action) | microsoft.storagesync/storageSyncServices/workflows/operations/read | 비동기 작업의 상태를 가져옵니다. |
> | 액션(Action) | microsoft.storagesync/storageSyncServices/workflows/read | 워크플로 읽기 |
> | 액션(Action) | microsoft.storagesync/storageSyncServices/write | Storage Sync Services를 만들거나 업데이트합니다. |
> | 액션(Action) | microsoft.storagesync/등록 취소/작업 | 저장소 동기화 공급자에 대 한 구독의 등록을 취소 합니다. |
...
> | 액션(Action) | Microsoft.StorSimple/managers/regenerateActivationKey/action | 기존 StorSimple 디바이스 관리자의 활성화 키를 다시 생성합니다. |
...
> | 액션(Action) | Microsoft.StorSimple/managers/storageDomains/delete | 스토리지 도메인을 삭제합니다. |
> | 액션(Action) | Microsoft.StorSimple/managers/storageDomains/operationResults/read | 작업 결과를 나열하거나 가져옵니다. |
> | 액션(Action) | Microsoft.StorSimple/managers/storageDomains/read | 스토리지 도메인을 나열하거나 가져옵니다. |
> | 액션(Action) | Microsoft.StorSimple/managers/storageDomains/write | 스토리지 도메인을 만들거나 업데이트합니다. |
...
> | 액션 유형 | 작업 | 설명 |
> | --- | --- | --- |
> | 액션(Action) | Microsoft 구독/취소/작업 | 구독을 취소 합니다. |
> | 액션(Action) | Microsoft.Subscription/CreateSubscription/action | Azure 구독을 만듭니다. |
> | 액션(Action) | Microsoft.Subscription/register/action | Microsoft.Subscription 리소스 공급자에 구독을 등록합니다. |
> | 액션(Action) | Microsoft. 구독/이름 바꾸기/작업 | 구독 이름 바꾸기 |
> | 액션(Action) | Microsoft.Subscription/SubscriptionDefinitions/read | 관리 그룹의 Azure 구독 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.TimeSeriesInsights/environments/eventsources/read | 이벤트 원본 속성을 가져옵니다. |
> | 액션(Action) | Microsoft.TimeSeriesInsights/environments/eventsources/write | 환경에 대한 새 이벤트 원본을 만들거나 기존 이벤트 원본을 업데이트합니다. |
> | 액션(Action) | Microsoft.TimeSeriesInsights/environments/read | 환경 속성을 가져옵니다. |
...
> | 액션(Action) | Microsoft.Web/certificates/Delete | 기존 인증서를 삭제합니다. |
...
> | 액션(Action) | Microsoft 웹/hostingEnvironments/조인/작업 | App Service Environment를 조인 합니다. |
> | 액션(Action) | microsoft.web/hostingenvironments/metricdefinitions/read | 호스팅 환경 메트릭 정의를 가져옵니다. |
...
> | 액션(Action) | Microsoft.Web/hostingEnvironments/multiRolePools/Read | App Service 환경의 FrontEnd 풀 속성을 가져옵니다. |
...
> | 액션(Action) | Microsoft 웹/hostingEnvironments/PrivateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
...
> | 액션(Action) | Microsoft.Web/hostingEnvironments/workerPools/Read | App Service 환경의 작업자 풀 속성을 가져옵니다. |
...
> | 액션(Action) | microsoft.web/locations/deleteVirtualNetworkOrSubnets/action | 위치에 대한 Vnet 또는 서브넷 삭제 알림입니다. |
> | 액션(Action) | microsoft.web/locations/extractapidefinitionfromwsdl/action | 위치에 대한 WSDL에서 Api 정의를 추출합니다. |
...
> | 액션(Action) | microsoft. 웹/위치/operationResults/read | 작업을 가져옵니다. |
> | 액션(Action) | microsoft. 웹/위치/작업/읽기 | 작업을 가져옵니다. |
...
> | 액션(Action) | Microsoft 웹/serverfarms/eventGridFilters/delete | 서버 팜에서 Event Grid 필터를 삭제 합니다. |
> | 액션(Action) | Microsoft 웹/serverfarms/eventGridFilters/read | 서버 팜에서 Event Grid 필터를 가져옵니다. |
> | 액션(Action) | Microsoft 웹/serverfarms/eventGridFilters/write | 서버 팜에 Event Grid 필터를 추가 합니다. |
...
> | 액션(Action) | Microsoft.Web/serverfarms/Read | App Service 계획의 속성을 가져옵니다. |
...
> | 액션(Action) | microsoft.web/sites/backups/action | Azure Storage의 Blob에서 복원할 수 있는 기존 앱 백업을 검색합니다. |
...
> | 액션(Action) | microsoft.web/sites/containerlogs/download/action | Web Apps 컨테이너 로그를 다운로드합니다. |
...
> | 액션(Action) | Microsoft. 웹/사이트/i s d i d 필터/삭제 | 웹 앱에서 Event Grid 필터를 삭제 합니다. |
> | 액션(Action) | Microsoft. 웹/사이트/i s d e r/r e d 필터/읽기 | 웹 앱에서 Event Grid 필터를 가져옵니다. |
> | 액션(Action) | Microsoft. 웹/사이트/i s d i d 필터/쓰기 | 웹 앱에 Event Grid 필터를 추가 합니다. |
> | 액션(Action) | microsoft 웹/사이트/확장/삭제 | Web Apps 사이트 확장을 삭제합니다. |
> | 액션(Action) | microsoft 웹/사이트/확장/읽기 | Web Apps 사이트 확장을 가져옵니다. |
> | 액션(Action) | microsoft 웹/사이트/확장/쓰기 | Web Apps 사이트 확장을 업데이트합니다. |
> | 액션(Action) | microsoft.web/sites/functions/action | 합수 Web Apps입니다. |
> | 액션(Action) | microsoft.web/sites/functions/delete | Web Apps 함수를 삭제합니다. |
> | 액션(Action) | microsoft 웹/사이트/함수/키/삭제 | 함수 키를 삭제 합니다. |
> | 액션(Action) | microsoft 웹/사이트/함수/키/쓰기 | 기능 키를 업데이트 합니다. |
> | 액션(Action) | microsoft 웹/사이트/함수/listkeys/동작 | 함수 키를 나열 합니다. |
> | 액션(Action) | microsoft.web/sites/functions/listsecrets/action | 함수 암호를 나열 합니다. |
> | 액션(Action) | microsoft.web/sites/functions/masterkey/read | Web Apps 함수 Masterkey를 가져옵니다. |
> | 액션(Action) | microsoft 웹/사이트/함수/속성/읽기 | Web Apps 함수 속성을 읽습니다. |
> | 액션(Action) | microsoft 웹/사이트/함수/속성/쓰기 | Web Apps 함수 속성을 업데이트 합니다. |
...
> | 액션(Action) | microsoft 웹/사이트/호스트/functionkeys/delete | 함수 호스트 함수 키를 삭제 합니다. |
> | 액션(Action) | microsoft. 웹/사이트/호스트/functionkeys/write | 업데이트 함수는 함수 키를 호스트 합니다. |
> | 액션(Action) | microsoft 웹/사이트/호스트/listkeys/작업 | 함수 호스트 키를 나열 합니다. |
> | 액션(Action) | microsoft. 웹/사이트/호스트/listsyncstatus/작업 | 동기화 함수 트리거 상태를 나열 합니다. |
> | 액션(Action) | microsoft 웹/사이트/호스트/속성/읽기 | Web Apps 함수 호스트 속성을 읽습니다. |
> | 액션(Action) | microsoft 웹/사이트/호스트/동기화/작업 | 함수 트리거를 동기화 합니다. |
> | 액션(Action) | microsoft. 웹/사이트/호스트/m p r/systemkeys/delete | 함수 호스트 시스템 키를 삭제 합니다. |
> | 액션(Action) | microsoft. 웹/사이트/호스트/m p r/시스템 키/쓰기 | 업데이트 함수는 시스템 키를 호스트 합니다. |
...
> | 액션(Action) | microsoft.web/sites/hostruntime/functions/keys/read | Web Apps Hostruntime 함수 키를 가져옵니다. |
> | 액션(Action) | Microsoft.Web/sites/hostruntime/host/_master/read | 관리 작업에 대한 함수 앱의 마스터 키를 가져옵니다. |
> | 액션(Action) | Microsoft.Web/sites/hostruntime/host/action | 트리거 동기화, 함수 추가, 함수 호출, 함수 삭제 등과 같은 함수 앱 런타임 작업을 수행합니다. |
> | 액션(Action) | microsoft.web/sites/hostruntime/host/read | Web Apps Hostruntime 호스트를 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/hybridconnection/delete | Web Apps 하이브리드 연결을 삭제합니다. |
...
> | 액션(Action) | microsoft.web/sites/instances/extensions/processes/read | Web Apps 인스턴스 확장 프로세스를 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/instances/extensions/read | Web Apps 인스턴스 확장을 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/instances/processes/delete | Web Apps 인스턴스 프로세스를 삭제합니다. |
> | 액션(Action) | microsoft.web/sites/instances/processes/modules/read | Web Apps 인스턴스 프로세스 모듈을 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/instances/processes/read | Web Apps 인스턴스 프로세스를 가져옵니다. |
...
> | 액션(Action) | microsoft.web/sites/listsyncfunctiontriggerstatus/action | 동기화 함수 트리거 상태를 나열 합니다. |
...
> | 액션(Action) | microsoft. 웹/사이트/e s t e r/operationresults/read | Web Apps 네트워크 추적 작업 결과를 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/newpassword/action | Newpassword Web Apps입니다. |
...
> | 액션(Action) | Microsoft 웹/사이트/PrivateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
> | 액션(Action) | microsoft 웹/사이트/프로세스/모듈/읽기 | Web Apps 프로세스 모듈을 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/processes/read | Web Apps 프로세스를 가져옵니다. |
> | 액션(Action) | microsoft 웹/사이트/프로세스/스레드/읽기 | 스레드를 가져오기 Web Apps를 처리 합니다. |
> | 액션(Action) | microsoft.web/sites/publiccertificates/delete | Web Apps 공용 인증서를 삭제합니다. |
...
> | 액션(Action) | microsoft 웹/사이트/restorefromdeletedapp/작업 | 삭제된 앱에서 Web Apps를 복원합니다. |
...
> | 액션(Action) | microsoft.web/sites/slots/containerlogs/download/action | Web Apps 슬롯 컨테이너 로그를 다운로드합니다. |
> | 액션(Action) | microsoft.web/sites/slots/continuouswebjobs/delete | Web Apps 슬롯 연속 웹 작업을 삭제합니다. |
...
> | 액션(Action) | microsoft.web/sites/slots/functions/listsecrets/action | 비밀 Web Apps 슬롯 함수를 나열합니다. |
> | 액션(Action) | microsoft.web/sites/slots/functions/read | Web Apps 슬롯 함수를 가져옵니다. |
...
> | 액션(Action) | microsoft. 웹/사이트/슬롯/네트워크 추적/operationresults/read | Web Apps 슬롯 네트워크 추적 작업 결과를 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/slots/newpassword/action | Newpassword Web Apps 슬롯입니다. |
...
> | 액션(Action) | microsoft.web/sites/slots/processes/read | Web Apps 슬롯 프로세스를 가져옵니다. |
> | 액션(Action) | microsoft.web/sites/slots/publiccertificates/delete | Web Apps 슬롯 공용 인증서를 삭제합니다. |
...
> | 액션(Action) | microsoft 웹/사이트/슬롯/restorefromdeletedapp/작업 | 삭제된 앱에서 웹앱 슬롯을 복원합니다. |
...
> | 액션(Action) | microsoft.web/sites/syncfunctiontriggers/action | 함수 트리거를 동기화 합니다. |
