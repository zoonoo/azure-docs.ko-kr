...
> | Microsoft.DataFactory/factories/integrationruntimes/getconnectioninfo/read | Integration Runtime 연결 정보를 읽습니다. |
> | Microsoft.DataFactory/factories/integrationruntimes/getstatus/read | Integration Runtime 상태를 읽습니다. |
> | Microsoft.DataFactory/factories/integrationruntimes/listauthkeys/read | 모든 Integration Runtime에 대한 인증 키를 나열합니다. |
...
Azure 서비스: [Azure SQL Database](../azure-sql/database/index.yml), [azure SQL Managed Instance](../azure-sql/managed-instance/index.yml), [SQL Data Warehouse](../sql-data-warehouse/index.yml)
...
> | Microsoft .Sql/managedInstances/exportOperationResults/read | 진행 중인 내보내기 작업을 가져옵니다. |
...
> | Microsoft .Sql/servers/enableAzureADOnlyAuthentication/action | 논리 서버 에서만 Azure Active Directory 인증 사용 |
> | Microsoft .Sql/servers/disableAzureADOnlyAuthentication/action | 논리 서버 에서만 Azure Active Directory 인증 사용 안 함 |
...
> | Microsoft.Sql/servers/import/action | 서버에서 새 데이터베이스를 만들고 DacPac 패키지의 스키마 및 데이터를 배포합니다. |
...
> | Microsoft.Sql/servers/auditingPolicies/read | 지정된 서버에 구성된 기본 서버 테이블 감사 정책의 세부 정보를 검색합니다. |
> | Microsoft.Sql/servers/auditingPolicies/write | 지정된 서버에 대한 기본 서버 테이블 감사를 변경합니다. |
...
> | Microsoft.Sql/servers/databases/auditingPolicies/read | 지정된 데이터베이스에 구성된 테이블 감사 정책의 세부 정보를 검색합니다. |
> | Microsoft.Sql/servers/databases/auditingPolicies/write | 지정된 데이터베이스에 대한 테이블 감사 정책을 변경합니다. |
...
> | Microsoft.Sql/servers/databases/connectionPolicies/read | 지정된 데이터베이스에 구성된 연결 정책의 세부 정보를 검색합니다. |
> | Microsoft.Sql/servers/databases/connectionPolicies/write | 지정된 데이터베이스에 대한 연결 정책을 변경합니다. |
...
> | Cognitiveservices account/계정/폼 인식기/사용자 지정/모델/읽기 | 모델에 대 한 정보를 가져옵니다. 학습 된 모든 사용자 지정 모델에 대 한 정보 가져오기 * |
...
> | Cognitiveservices account/계정/폼 인식기/미리 작성/수신/작업/작업 | 상태를 쿼리하고 수신 분석 작업의 결과를 검색 합니다. 이 인터페이스의 URL은 분석 수신 응답의 ' 작업-위치 ' 헤더에서 가져올 수 있습니다. |
...
> | MachineLearningServices/위치/Updatas/작업 | 작업 영역에서 각 VM 제품군에 대 한 할당량을 업데이트 합니다. |
...
> | Microsoft.ApiManagement/service/portalsettings/read | 포털 설정의 컬렉션을 나열 합니다. 또는 포털에 대 한 로그인 설정을 가져오거나 포털에 대 한 등록 설정을 가져오거나 포털에 대 한 위임 설정을 가져옵니다. |
...
> | Microsoft.apimanagement/service/portalsettings/listSecrets/작업 | 포털 위임 설정의 유효성 검사 키를 가져옵니다. |
...
> | DataBoxEdge/작업/읽기 | 작업을 나열 하거나 가져옵니다. |
...
> | 작업 | Description |
> | --- | --- |
> | Microsoft.DataCatalog/register/action | Data Catalog 리소스 공급자에 대 한 구독 등록 |
> | Microsoft.DataCatalog/unregister/action | Data Catalog 리소스 공급자에 대 한 구독 등록 취소 |
> | Microsoft.DataCatalog/catalogs/read | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 읽습니다. |
> | Microsoft.DataCatalog/catalogs/write | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 작성 합니다. |
> | Microsoft.DataCatalog/catalogs/delete | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 삭제 합니다. |
> | Microsoft.datacatalog/checkNameAvailability/read | Data Catalog 리소스 공급자에 대 한 카탈로그 이름 가용성을 확인 합니다. |
> | Microsoft.datacatalog/datacatalogs/읽기 | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 읽습니다. |
> | Microsoft.datacatalog/datacatalogs/write | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 씁니다. |
> | Microsoft.datacatalog/datacatalogs/delete | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 삭제 합니다. |
> | Microsoft.DataCatalog/operations/read | Data Catalog 리소스 공급자에서 사용 가능한 모든 작업을 읽습니다. |
...
> | aadiam/privateLinkForAzureAD/privateEndpointConnectionProxies/write | 개인 링크 프록시 만들기 및 업데이트 |
...
> | Microsoft.OperationalInsights/workspaces/query/ReservedCommonFields/read | ReservedCommonFields 테이블에서 데이터를 읽습니다. |
...
> | Microsoft.Subscription/SubscriptionDefinitions/read | 관리 그룹의 Azure 구독 정의를 가져옵니다. |
> | Microsoft.Subscription/SubscriptionDefinitions/write | Azure 구독 정의를 만듭니다. |
