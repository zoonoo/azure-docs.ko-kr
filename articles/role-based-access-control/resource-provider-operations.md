...
> |  | **supportProviders/Supportproviders 유형** |  |
...
> |  | **addsservices/기능/userpreference 설정** |  |
...
> |  | **addsservices/connectingtosource** |  |
...
> |  | **addsservices/servicemembers/자격 증명** |  |
...
> |  | **보고서/badpassworduseridipfrequency** |  |
...
> | 작업 | Microsoft.ADHybridHealthService/services/alerts/read | 서비스에 대한 경고를 읽습니다. |
> |  | **서비스/checkservicefeatureavailibility** |  |
...
> |  | **서비스/보고서** |  |
> | 작업 | ADHybridHealthService/services/reports/generateBlobUri/action | 위험한 IP 보고서를 생성 하 고이를 가리키는 URI를 반환 합니다. |
> |  | **서비스/보고서/blobUris** |  |
> | 작업 | ADHybridHealthService/services/reports/blobUris/read | 지난 7 일 동안 위험한 모든 IP 보고서 Uri를 가져옵니다. |
> |  | **서비스/보고서/세부 정보** |  |
...
> |  | **서비스/servicemembers/메트릭** |  |
> | 작업 | ADHybridHealthService/services/servicemembers/메트릭/읽기 | 지정 된 서비스 및 서비스 멤버의 커넥터 및 실행 프로필 이름 목록을 가져옵니다. |
> |  | **services/servicemembers/메트릭/그룹** |  |
...
> |  | **메타** |  |
> | 작업 | Microsoft Advisor/metadata/read | 메타데이터 가져오기 |
> |  | **작업도** |  |
...
> | 작업 | Microsoft.Advisor/recommendations/available/action | Microsoft Advisor에서 새로운 권장 사항을 사용할 수 있습니다. |
> |  | **권장 사항/비 표시** |  |
...
> |  | **alertsMetaData** |  |
> | 작업 | AlertsManagement/alertsMetaData/읽기 | 입력 매개 변수에 대 한 경고 메타 데이터를 가져옵니다. |
> |  | **alertsSummary** |  |
...
> | 작업 | AlertsManagement/smartDetectorAlertRules/write | 지정 된 구독에서 스마트 탐지기 경고 규칙을 만들거나 업데이트 합니다. |
> | 작업 | AlertsManagement/smartDetectorAlertRules/읽기 | 입력 필터에 대 한 모든 스마트 탐지기 경고 규칙을 가져옵니다. |
> | 작업 | AlertsManagement/smartDetectorAlertRules/delete | 지정 된 구독의 스마트 탐지기 경고 규칙 삭제 |
> |  | **smartGroups** |  |
...
> |  | **출력소** |  |
> | 작업 | Microsoft.ApiManagement/service/write | API Management 서비스 인스턴스 만들기 또는 업데이트 |
...
> | 작업 | Microsoft.ApiManagement/service/updatecertificate/action | API Management 서비스에 대 한 TLS/SSL 인증서 업로드 |
...
> |  | **서비스/a p i** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/read | API Management 서비스 인스턴스의 모든 Api를 나열 합니다. 또는 해당 식별자로 지정 된 API의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/write | API Management 서비스 인스턴스의 지정 된 기존 API를 새로 만들거나 업데이트 합니다. 또는 API Management 서비스 인스턴스의 지정 된 API를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/delete | API Management 서비스 인스턴스의 지정 된 API를 삭제 합니다. |
> |  | **서비스/a p i/진단** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/diagnostics/read | API의 모든 진단을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 진단 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/diagnostics/write | API에 대 한 새 진단을 만들거나 기존 API를 업데이트 합니다. 또는는 해당 식별자로 지정 된 API에 대 한 진단 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/diagnostics/delete | API에서 지정 된 진단을 삭제 합니다. |
> |  | **서비스/a p i/문제** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/read | 지정 된 API와 관련 된 모든 문제를 나열 합니다. 또는 해당 식별자로 지정 된 API의 문제에 대 한 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/write | API에 대 한 새 문제를 만들거나 기존 문제를 업데이트 합니다. 또는는 API에 대 한 기존 문제를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/delete | API에서 지정 된 문제를 삭제 합니다. |
> |  | **서비스/a p i/문제/첨부 파일** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/attachments/read | 지정 된 API와 관련 된 문제에 대 한 모든 첨부 파일을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 문제 첨부 파일의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/attachments/write | API의 문제에 대 한 새 첨부 파일을 만들거나 기존 문제를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/attachments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
> |  | **서비스/a p i/문제/설명** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/comments/read | 지정 된 API와 관련 된 문제에 대 한 모든 설명을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 문제 설명의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/comments/write | API의 문제에 대 한 새 주석을 만들거나 기존 주석을 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/comments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
> |  | **서비스/a p i/작업** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/read | 지정 된 API에 대 한 작업의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 API 작업에 대 한 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/write | API에서 새 작업을 만들거나 기존 작업을 업데이트 합니다. 또는는 해당 식별자로 지정 된 API의 작업 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/delete | API에서 지정 된 작업을 삭제 합니다. |
> |  | **서비스/a p i/작업/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policies/read | API 작업 수준에서 정책 구성 목록을 가져옵니다. 또는 API 작업 수준에서 정책 구성을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policies/write | API 작업 수준에 대 한 정책 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policies/delete | Api 작업에서 정책 구성을 삭제 합니다. |
> |  | **서비스/a p i/작업/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policy/read | 작업 수준에서 정책 구성 가져오기 |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policy/write | 작업 수준에서 정책 구성 만들기 |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/policy/delete | 작업 수준에서 정책 구성을 삭제 합니다. |
> |  | **서비스/a p i/작업/태그** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/tags/read | 작업과 연결 된 모든 태그를 나열 합니다. 또는 작업과 연결 된 태그를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/tags/write | 작업에 태그를 할당 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/operations/tags/delete | 작업에서 태그를 분리 합니다. |
> |  | **서비스/a p i/operationsByTags** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/operationsByTags/read | 태그와 연결 된 작업의 컬렉션을 나열 합니다. |
> |  | **서비스/a p i/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/policies/read | API 수준에서 정책 구성을 가져옵니다. 또는 API 수준에서 정책 구성을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/policies/write | API에 대 한 정책 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/policies/delete | Api에서 정책 구성을 삭제 합니다. |
> |  | **서비스/a p i/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/policy/read | API 수준에서 정책 구성 가져오기 |
> | 작업 | Microsoft.ApiManagement/service/apis/policy/write | API 수준에서 정책 구성 만들기 |
> | 작업 | Microsoft.ApiManagement/service/apis/policy/delete | API 수준에서 정책 구성을 삭제 합니다. |
> |  | **서비스/a p i/제품** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/products/read | API의 일부인 모든 제품을 나열 합니다. |
> |  | **서비스/a p i/릴리스** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/releases/read | API의 모든 릴리스를 나열 합니다.<br>Api 릴리스는 현재 API 수정을 만들 때 생성 됩니다.<br>릴리스는 이전 수정 버전으로 롤백하는 데도 사용 됩니다.<br>결과는 페이징할 수 있으며 $top 및 $skip 매개 변수에 의해 제한 될 수 있습니다.<br>또는 API 릴리스의 세부 정보를 반환 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/releases/delete | Api의 모든 릴리스를 제거 하거나 API에서 지정 된 릴리스를 삭제 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/releases/write | API에 대 한 새 릴리스를 만듭니다. 또는는 해당 식별자로 지정 된 API 릴리스의 세부 정보를 업데이트 합니다. |
> |  | **서비스/a p i/수정 버전** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/revisions/read | API의 모든 수정 버전을 나열 합니다. |
...
> | 작업 | Microsoft.ApiManagement/service/apis/schemas/write | API에 대 한 스키마 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/schemas/delete | Api에서 스키마 구성을 삭제 합니다. |
> |  | **서비스/a p i/tagDescriptions** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/tagDescriptions/read | API의 범위에서 모든 태그 설명을 나열 합니다. Swagger-tagDescription와 유사한 모델은 API 수준에서 정의 되지만 태그는 작업에 할당 되거나 API 범위에서 태그 설명을 가져올 수 있습니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/tagDescriptions/write | Api의 범위에서 태그 설명을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/tagDescriptions/delete | Api에 대 한 태그 설명을 삭제 합니다. |
> |  | **서비스/a p i/태그** |  |
> | 작업 | Microsoft.ApiManagement/service/apis/tags/read | API와 연결 된 모든 태그를 나열 합니다. 또는 API와 연결 된 태그를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/tags/write | 태그를 Api에 할당 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/tags/delete | Api에서 태그를 분리 합니다. |
> |  | **service/apisByTags** |  |
> | 작업 | Microsoft.ApiManagement/service/apisByTags/read | 태그와 연결 된 api 컬렉션을 나열 합니다. |
> |  | **service/apiVersionSets** |  |
> | 작업 | Microsoft.ApiManagement/service/apiVersionSets/read | 지정 된 서비스 인스턴스의 API 버전 집합 컬렉션을 나열 합니다. 또는 식별자로 지정 된 Api 버전 집합의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/apiVersionSets/write | Api 버전 집합을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 Api VersionSet의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apiVersionSets/delete | 특정 Api 버전 집합을 삭제 합니다. |
> |  | **service/apiVersionSets/버전** |  |
> | 작업 | Microsoft.ApiManagement/service/apiVersionSets/versions/read | 버전 엔터티 목록을 가져옵니다. |
> |  | **service/authorizationServers** |  |
> | 작업 | Microsoft.ApiManagement/service/authorizationServers/read | 서비스 인스턴스 내에 정의 된 권한 부여 서버 컬렉션을 나열 합니다. 또는 암호 없이 권한 부여 서버의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/authorizationServers/write | 새 권한 부여 서버를 만들거나 기존 권한 부여 서버를 업데이트 합니다. 또는는 해당 식별자로 지정 된 권한 부여 서버의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/authorizationServers/delete | 특정 권한 부여 서버 인스턴스를 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/service/authorizationServers/listSecrets/작업 | 권한 부여 서버에 대 한 암호를 가져옵니다. |
> |  | **서비스/백 엔드** |  |
> | 작업 | Microsoft.ApiManagement/service/backends/read | 지정 된 서비스 인스턴스의 백 엔드 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 백 엔드의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/backends/write | 백 엔드를 만들거나 업데이트 합니다. 또는 기존 백 엔드를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/backends/delete | 지정 된 백 엔드를 삭제 합니다. |
> | 작업 | Microsoft.ApiManagement/service/backends/reconnect/action | 지정 된 시간 제한 후에 백 엔드에 대 한 새 연결을 만들도록 APIM 프록시에 알립니다. 제한 시간을 지정 하지 않으면 2 분의 제한 시간이 사용 됩니다. |
> |  | **서비스/캐시** |  |
> | 작업 | Microsoft.apimanagement/서비스/캐시/읽기 | 지정 된 서비스 인스턴스에 있는 모든 외부 캐시의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 캐시의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.apimanagement/서비스/캐시/쓰기 | Api Management 인스턴스에 사용할 외부 캐시를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 캐시의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/캐시/삭제 | 특정 캐시를 삭제 합니다. |
> |  | **서비스/인증서** |  |
> | 작업 | Microsoft.ApiManagement/service/certificates/read | 지정 된 서비스 인스턴스에 있는 모든 인증서의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 인증서의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/certificates/write | 백 엔드와의 인증에 사용 되는 인증서를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/certificates/delete | 특정 인증서를 삭제 합니다. |
> |  | **서비스/contentTypes** |  |
> | 작업 | Microsoft.ApiManagement/service/contentTypes/read | 콘텐츠 형식을 반환합니다. |
> |  | **서비스/contentTypes/Contenttypes** |  |
...
> |  | **서비스/진단** |  |
> | 작업 | Microsoft.ApiManagement/service/diagnostics/read | API Management 서비스 인스턴스에 대 한 모든 진단을 나열 합니다. 또는 해당 식별자로 지정 된 진단 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/diagnostics/write | 새 진단을 만들거나 기존 진단을 업데이트 합니다. 또는는 해당 식별자로 지정 된 진단 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/diagnostics/delete | 지정 된 진단을 삭제 합니다. |
> |  | **서비스/게이트웨이** |  |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/읽기 | 서비스 인스턴스에 등록 된 게이트웨이의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/쓰기 | Api Management 인스턴스에서 사용할 게이트웨이를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 게이트웨이의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/삭제 | 특정 게이트웨이를 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/listKeys/작업 | 게이트웨이 키를 검색 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/regenerateKey/작업 | 지정 된 게이트웨이 키로 생성 된 모든 토큰을 다시 생성 invalidationg. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/generateToken/작업 | 게이트웨이에 대 한 공유 액세스 권한 부여 토큰을 가져옵니다. |
> |  | **서비스/게이트웨이/api** |  |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/a p i/읽기 | 게이트웨이와 연결 된 Api의 컬렉션을 나열 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/a p i/쓰기 | 지정 된 게이트웨이에 API를 추가 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/a p i/삭제 | 지정 된 게이트웨이에서 지정 된 API를 삭제 합니다. |
> |  | **서비스/게이트웨이/hostnameConfigurations** |  |
> | 작업 | Microsoft.apimanagement/서비스/게이트웨이/hostnameConfigurations/읽기 | 지정 된 게이트웨이의 호스트 이름 구성 컬렉션을 나열 합니다. |
> |  | **서비스/그룹** |  |
> | 작업 | Microsoft.ApiManagement/service/groups/read | 서비스 인스턴스 내에 정의 된 그룹의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 그룹의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/groups/write | 그룹을 만들거나 업데이트 합니다. 또는 해당 식별자로 지정 된 그룹의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/groups/delete | API Management 서비스 인스턴스의 특정 그룹을 삭제 합니다. |
> |  | **서비스/그룹/사용자** |  |
> | 작업 | Microsoft.ApiManagement/service/groups/users/read | 그룹에 연결 된 사용자 엔터티의 컬렉션을 나열 합니다. |
> | 작업 | Microsoft.ApiManagement/service/groups/users/write | 기존 그룹에 기존 사용자를 추가합니다. |
> | 작업 | Microsoft.ApiManagement/service/groups/users/delete | 기존 그룹에서 기존 사용자를 제거 합니다. |
> |  | **서비스/identityProviders** |  |
> | 작업 | Microsoft.ApiManagement/service/identityProviders/read | 지정 된 서비스 인스턴스에 구성 된 Id 공급자의 컬렉션을 나열 합니다. 또는 암호 없이 id 공급자의 구성 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/identityProviders/write | IdentityProvider 구성을 만들거나 업데이트 합니다. 또는 기존 IdentityProvider 구성을 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/identityProviders/delete | 지정 된 id 공급자 구성을 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/service/identityProviders/listSecrets/작업 | Id 공급자 암호를 가져옵니다. |
> |  | **서비스/문제** |  |
> | 작업 | Microsoft.apimanagement/서비스/문제/읽기 | 지정 된 서비스 인스턴스의 문제 컬렉션을 나열 합니다. 또는 API Management 문제 세부 정보를 가져옵니다. |
> |  | **서비스/위치/네트워크 상태** |  |
> | 작업 | Microsoft.ApiManagement/service/locations/networkstatus/read | 해당 위치에는 서비스가 종속되는 리소스의 네트워크 액세스 상태를 가져옵니다. |
> |  | **서비스/로 거** |  |
> | 작업 | Microsoft.ApiManagement/service/loggers/read | 지정 된 서비스 인스턴스에 대 한로 거 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된로 거에 대 한 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/loggers/write | 로 거를 만들거나 업데이트 합니다. 또는는 기존로 거를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/loggers/delete | 지정 된로 거를 삭제 합니다. |
> |  | **서비스/namedValues** |  |
> | 작업 | Microsoft.apimanagement/service/namedValues/read | 서비스 인스턴스 내에 정의 된 명명 된 값의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 명명 된 값의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.apimanagement/서비스/namedValues/write | 명명 된 값을 만들거나 업데이트 합니다. 또는 특정 명명 된 값을 업데이트 합니다. |
> | 작업 | Microsoft.apimanagement/service/namedValues/delete | API Management 서비스 인스턴스에서 명명 된 특정 값을 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/service/namedValues/listValue/action | 해당 식별자로 지정 된 명명 된 값의 암호를 가져옵니다. |
> |  | **서비스/네트워크 상태** |  |
> | 작업 | Microsoft.ApiManagement/service/networkstatus/read | 서비스가 종속되는 리소스의 네트워크 액세스 상태를 가져옵니다. |
> |  | **서비스/알림** |  |
> | 작업 | Microsoft.ApiManagement/service/notifications/read | 서비스 인스턴스 내에 정의 된 속성의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 알림의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/write | API Management 게시자 알림을 만들거나 업데이트 합니다. |
> |  | **서비스/알림/recipientEmails** |  |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientEmails/read | 알림을 구독 하는 알림 받는 사람 전자 메일의 목록을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientEmails/write | 알림에 대 한 받는 사람 목록에 전자 메일 주소를 추가 합니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientEmails/delete | 알림 목록에서 전자 메일을 제거 합니다. |
> |  | **서비스/알림/recipientUsers** |  |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientUsers/read | 알림을 구독 하는 알림 받는 사람 목록을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientUsers/write | 알림에 대 한 받는 사람 목록에 API Management 사용자를 추가 합니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | 알림 목록에서 API Management 사용자를 제거 합니다. |
> |  | **service/openidConnectProviders** |  |
> | 작업 | Microsoft.ApiManagement/service/openidConnectProviders/read | 모든 Openid connect Connect 공급자 목록입니다. 또는는 비밀 없이 특정 Openid connect 연결 공급자를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/openidConnectProviders/write | Openid connect Connect 공급자를 만들거나 업데이트 합니다. 또는 특정 Openid connect Connect 공급자를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/openidConnectProviders/delete | API Management 서비스 인스턴스의 특정 Openid connect Connect 공급자를 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/service/openidConnectProviders/listSecrets/작업 | 특정 Openid connect Connect 공급자 암호를 가져옵니다. |
> |  | **서비스/operationresults** |  |
> | 작업 | Microsoft.ApiManagement/service/operationresults/read | 장기 실행 작업의 현재 상태를 가져옵니다. |
> |  | **서비스/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/policies/read | Api Management 서비스의 모든 전역 정책 정의를 나열 합니다. 또는 Api Management 서비스의 전역 정책 정의를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/policies/write | Api Management 서비스의 전역 정책 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/policies/delete | Api Management 서비스의 전역 정책 구성을 삭제 합니다. |
> |  | **서비스/정책** |  |
> | 작업 | Microsoft.apimanagement/서비스/정책/읽기 | 테 넌 트 수준에서 정책 구성 가져오기 |
> | 작업 | Microsoft.apimanagement/서비스/정책/쓰기 | 테 넌 트 수준에서 정책 구성 만들기 |
> | 작업 | Microsoft.apimanagement/서비스/정책/삭제 | 테 넌 트 수준에서 정책 구성을 삭제 합니다. |
> |  | **서비스/policyDescriptions** |  |
> | 작업 | Microsoft.apimanagement/서비스/정책 설명/읽기 | 모든 정책 설명을 나열 합니다. |
> |  | **서비스/policySnippets** |  |
> | 작업 | Microsoft.ApiManagement/service/policySnippets/read | 모든 정책 코드 조각을 나열 합니다. |
> |  | **서비스/portalsettings** |  |
> | 작업 | Microsoft.ApiManagement/service/portalsettings/read | 포털 설정의 컬렉션을 나열 합니다. 또는 포털에 대 한 로그인 설정을 가져오거나 포털에 대 한 등록 설정을 가져오거나 포털에 대 한 위임 설정을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/portalsettings/write | 로그인 설정을 업데이트 합니다. 또는 로그인 설정을 만들거나 업데이트 합니다. 또는 등록 설정을 업데이트 하거나 등록 설정을 업데이트 하거나 위임 설정을 업데이트 합니다. 또는 위임 설정을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.apimanagement/service/portalsettings/listSecrets/작업 | 포털 위임 설정의 유효성 검사 키를 가져옵니다. |
> |  | **서비스/제품** |  |
> | 작업 | Microsoft.ApiManagement/service/products/read | 지정 된 서비스 인스턴스의 제품 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 제품의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/products/write | 제품을 만들거나 업데이트 합니다. 또는 기존 제품 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/delete | 제품을 삭제 합니다. |
> |  | **서비스/제품/a p i** |  |
> | 작업 | Microsoft.ApiManagement/service/products/apis/read | 제품과 연결 된 Api 컬렉션을 나열 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/apis/write | 지정 된 제품에 API를 추가 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/apis/delete | 지정 된 제품에서 지정 된 API를 삭제 합니다. |
> |  | **서비스/제품/그룹** |  |
> | 작업 | Microsoft.ApiManagement/service/products/groups/read | 지정 된 제품과 연결 된 개발자 그룹의 컬렉션을 나열 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/groups/write | 지정 된 제품을 사용 하 여 지정 된 개발자 그룹 간의 연결을 추가 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/groups/delete | 지정 된 그룹과 제품 간의 연결을 삭제 합니다. |
> |  | **서비스/제품/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/products/policies/read | 제품 수준에서 정책 구성을 가져옵니다. 또는 제품 수준에서 정책 구성을 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/products/policies/write | 제품에 대 한 정책 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/policies/delete | 제품에서 정책 구성을 삭제 합니다. |
> |  | **서비스/제품/정책** |  |
> | 작업 | Microsoft.ApiManagement/service/products/policy/read | 제품 수준에서 정책 구성 가져오기 |
> | 작업 | Microsoft.ApiManagement/service/products/policy/write | 제품 수준에서 정책 구성 만들기 |
> | 작업 | Microsoft.ApiManagement/service/products/policy/delete | 제품 수준에서 정책 구성을 삭제 합니다. |
> |  | **서비스/제품/구독** |  |
> | 작업 | Microsoft.ApiManagement/service/products/subscriptions/read | 지정 된 제품에 대 한 구독 컬렉션을 나열 합니다. |
> |  | **서비스/제품/태그** |  |
> | 작업 | Microsoft.ApiManagement/service/products/tags/read | 제품과 연결 된 모든 태그를 나열 합니다. 또는 제품과 연결 된 태그를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/products/tags/write | 제품에 태그를 할당 합니다. |
> | 작업 | Microsoft.ApiManagement/service/products/tags/delete | 제품에서 태그를 분리 합니다. |
> |  | **서비스/productsByTags** |  |
> | 작업 | Microsoft.ApiManagement/service/productsByTags/read | 태그와 연결 된 제품의 컬렉션을 나열 합니다. |
> |  | **서비스/속성** |  |
> | 작업 | Microsoft.ApiManagement/service/properties/read | 서비스 인스턴스 내에 정의 된 속성의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 속성의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/properties/write | 속성을 만들거나 업데이트 합니다. 또는 특정 속성을 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/properties/delete | API Management 서비스 인스턴스에서 특정 속성을 삭제 합니다. |
> | 작업 | Microsoft.apimanagement/서비스/속성/listSecrets/작업 | 해당 식별자로 지정 된 속성의 암호를 가져옵니다. |
> |  | **서비스/할당량** |  |
...
> |  | **서비스/지역** |  |
> | 작업 | Microsoft.apimanagement/서비스/지역/읽기 | 서비스가 존재 하는 모든 azure 지역을 나열 합니다. |
> |  | **서비스/보고서** |  |
...
> |  | **서비스/구독** |  |
> | 작업 | Microsoft.ApiManagement/service/subscriptions/read | API Management 서비스 인스턴스에 대 한 모든 구독을 나열 합니다. 또는 지정 된 구독 엔터티를 가져옵니다 (키 포함 안 함). |
> | 작업 | Microsoft.ApiManagement/service/subscriptions/write | 지정한 제품에 대해 지정한 사용자의 구독을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 구독의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/subscriptions/delete | 지정 된 구독을 삭제 합니다. |
...
> | 작업 | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | API Management 서비스 인스턴스에 대 한 기존 구독의 보조 키를 다시 생성 합니다. |
> | 작업 | Microsoft.apimanagement/service/subscription/listSecrets/작업 | 지정 된 구독 키를 가져옵니다. |
> |  | **서비스/tagResources** |  |
> | 작업 | Microsoft.ApiManagement/service/tagResources/read | 태그와 연결 된 리소스의 컬렉션을 나열 합니다. |
> |  | **서비스/태그** |  |
> | 작업 | Microsoft.ApiManagement/service/tags/read | 서비스 인스턴스 내에 정의 된 태그의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 태그의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/tags/write | 태그를 만듭니다. 또는는 해당 식별자로 지정 된 태그의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/tags/delete | API Management 서비스 인스턴스의 특정 태그를 삭제 합니다. |
> |  | **서비스/템플릿** |  |
...
> |  | **서비스/테 넌 트** |  |
> | 작업 | Microsoft.ApiManagement/service/tenant/read | Api Management 서비스의 전역 정책 정의를 가져옵니다. 또는 테 넌 트 액세스 정보 정보 가져오기 |
...
> | 작업 | Microsoft.apimanagement/서비스/테 넌 트/listSecrets/작업 | 테넌트 액세스 세부 정보를 가져옵니다. |
...
> |  | **서비스/사용자** |  |
> | 작업 | Microsoft.ApiManagement/service/users/read | 지정 된 서비스 인스턴스에 등록 된 사용자의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 사용자의 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/users/write | 사용자를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 사용자의 세부 정보를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/users/delete | 특정 사용자를 삭제 합니다. |
> | 작업 | Microsoft.ApiManagement/service/users/generateSsoUrl/action | 지정 된 사용자를 개발자 포털에 서명 하기 위한 인증 토큰이 포함 된 리디렉션 URL을 검색 합니다. |
> | 작업 | Microsoft.ApiManagement/service/users/token/action | 사용자에 대 한 공유 액세스 권한 부여 토큰을 가져옵니다. |
> |  | **서비스/사용자/확인** |  |
> | 작업 | Microsoft.ApiManagement/service/users/confirmations/send/action | 확인을 보냅니다. |
> |  | **서비스/사용자/그룹** |  |
> | 작업 | Microsoft.ApiManagement/service/users/groups/read | 모든 사용자 그룹을 나열 합니다. |
> |  | **서비스/사용자/id** |  |
> | 작업 | Microsoft.apimanagement/서비스/사용자/id/읽기 | 모든 사용자 id의 목록입니다. |
> |  | **서비스/사용자/키** |  |
> | 작업 | Microsoft.ApiManagement/service/users/keys/read | 사용자와 연결 된 키 가져오기 |
> |  | **서비스/사용자/구독** |  |
> | 작업 | Microsoft.ApiManagement/service/users/subscriptions/read | 지정 된 사용자의 구독 컬렉션을 나열 합니다. |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft AppConfiguration/register/action | Microsoft 앱 구성을 사용 하는 구독을 등록 합니다. |
> |  | **checkNameAvailability** |  |
> | 작업 | Microsoft AppConfiguration/checkNameAvailability/read | 리소스 이름을 사용할 수 있는지 여부를 확인 합니다. |
> |  | **configurationStores** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/read | 지정 된 구성 저장소의 속성을 가져오거나 지정 된 리소스 그룹 또는 구독 아래의 모든 구성 저장소를 나열 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/write | 지정 된 매개 변수를 사용 하 여 구성 저장소를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/delete | 구성 저장소를 삭제 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/ListKeys/action | 지정 된 구성 저장소에 대 한 API 키를 나열 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/RegenerateKey/action | 지정 된 구성 저장소에 대 한 API 키를 다시 생성 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/ListKeyValue/action | 지정 된 구성 저장소에 대 한 키 값을 나열 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/PrivateEndpointConnectionsApproval/action | 지정 된 구성 저장소에서 개인 끝점 연결을 자동으로 승인 합니다. |
> |  | **configurationStores/eventGridFilters** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/eventGridFilters/read | 지정 된 구성 저장소 event grid 필터의 속성을 가져오거나 지정 된 구성 저장소에 있는 모든 구성 저장소 event grid 필터를 나열 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/eventGridFilters/write | 지정 된 매개 변수를 사용 하 여 구성 저장소 event grid 필터를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/eventGridFilters/delete | 구성 저장소 event grid 필터를 삭제 합니다. |
> |  | **configurationStores/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnectionProxies/validate/action | 지정 된 구성 저장소에서 개인 끝점 연결 프록시의 유효성을 검사 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnectionProxies/read | 지정 된 구성 저장소에서 개인 끝점 연결 프록시를 가져옵니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnectionProxies/write | 지정 된 구성 저장소에서 개인 끝점 연결 프록시를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnectionProxies/delete | 지정 된 구성 저장소에서 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **configurationStores/privateEndpointConnections** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnections/read | 지정 된 구성 저장소에서 개인 끝점 연결을 가져오거나 개인 끝점 연결을 나열 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnections/write | 지정 된 구성 저장소에서 개인 끝점 연결을 승인 하거나 거부 합니다. |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateEndpointConnections/delete | 지정 된 구성 저장소에서 개인 끝점 연결을 삭제 합니다. |
> |  | **configurationStores/privateLinkResources** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/privateLinkResources/read | 지정 된 구성 저장소에 있는 모든 개인 링크 리소스를 나열 합니다. |
> |  | **configurationStores/providers/Microsoft. Insights/diagnosticSettings** |  |
> | 작업 | Microsoft AppConfiguration/configurationStores/providers/diagnosticSettings/read | 구성 저장소에 대 한 모든 진단 설정 값을 읽습니다. |
...
> |  | **작업도** |  |
> | 작업 | Microsoft AppConfiguration/작업/읽기 | Microsoft 앱 구성에서 지원 되는 모든 작업을 나열 합니다. |
...
> |  | **방침** |  |
> | 작업 | Microsoft. 권한 부여/정책/감사/작업 | ' 감사 ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
> | 작업 | Microsoft. 권한 부여/정책/auditIfNotExists/작업 | ' AuditIfNotExists ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
> | 작업 | Microsoft. 권한 부여/정책/거부/작업 | ' 거부 ' 효과가 있는 Azure Policy의 평가 결과로 수행 된 작업 |
> | 작업 | Microsoft. 권한 부여/정책/deployIfNotExists/작업 | ' DeployIfNotExists ' 효과를 사용 하 여 Azure Policy 평가 결과로 수행 된 작업 |
> |  | **policyAssignments** |  |
...
> |  | **automationAccounts/certificate** |  |
...
> |  | **automationAccounts/jobs/stream** |  |
...
> |  | **automationAccounts/objectDataTypes 형식/필드** |  |
...
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/read | Azure Automation 개인 끝점 연결 프록시를 읽습니다. |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/write | Azure Automation 개인 끝점 연결 프록시를 만듭니다. |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 요청 유효성 검사 (groupId 유효성 검사) |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/delete | Azure Automation 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **automationAccounts/privateEndpointConnectionProxies/operationResults** |  |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnectionProxies/operationResults/read | Azure Automation 개인 끝점 프록시 작업 결과를 가져옵니다. |
> |  | **automationAccounts/privateEndpointConnections** |  |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnections/read | Azure Automation 개인 끝점 연결 상태 가져오기 |
> | 작업 | Microsoft. Automation/automationAccounts/privateEndpointConnections/write | Azure Automation 개인 끝점 연결 승인 또는 거부 |
> |  | **automationAccounts/privateLinkResources** |  |
> | 작업 | Microsoft. Automation/automationAccounts/privateLinkResources/read | 전용 끝점에 대 한 그룹 정보를 읽습니다. |
...
> |  | **automationAccounts/runbook/draft/content** |  |
...
> | 작업 | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationMachineRuns/read | 소프트웨어 업데이트 구성 컴퓨터 실행 Azure Automation를 가져옵니다. |
> |  | **automationAccounts/softwareUpdateConfigurationRuns** |  |
> | 작업 | Microsoft. Automation/automationAccounts/softwareUpdateConfigurationRuns/read | Azure Automation 소프트웨어 업데이트 구성 실행을 가져옵니다. |
...
> |  | **b2ctenants** |  |
> | 작업 | AzureActiveDirectory/b2ctenants/읽기 | 사용자가 멤버인 모든 B2C 테 넌 트를 나열 합니다. |
> |  | **작업도** |  |
...
> |  | **cloudManifestFiles** |  |
> | 작업 | Microsoft AzureStack/cloudManifestFiles/read | 클라우드 매니페스트 파일을 가져옵니다. |
> |  | **작업** |  |
...
> | 작업 | Microsoft AzureStack/등록/제품/t s p 제품/작업 | Azure Stack Marketplace 제품의 목록을 검색 합니다. |
> | 작업 | Microsoft AzureStack/등록/제품/t s p s/작업 | Azure Stack Marketplace 제품을 검색 합니다. |
> | 작업 | Microsoft AzureStack/등록/제품/uploadProductLog/작업 | Azure Stack Marketplace 제품 작업 상태 및 타임 스탬프를 기록 합니다. |
...
> | 작업 | Microsoft. Batch/batchAccounts/privateEndpointConnectionResults/read | 장기 실행 Batch 계정 개인 끝점 연결 작업의 결과를 가져옵니다. |
> |  | **batchAccounts/privateEndpointConnections** |  |
> | 작업 | Microsoft. Batch/batchAccounts/privateEndpointConnections/write | Batch 계정에서 기존 개인 끝점 연결 업데이트 |
> | 작업 | Microsoft. Batch/batchAccounts/privateEndpointConnections/read | 개인 끝점 연결을 가져오거나 배치 계정의 개인 끝점 연결을 나열 합니다. |
> |  | **batchAccounts/privateLinkResources** |  |
> | 작업 | Microsoft. Batch/batchAccounts/privateLinkResources/read | 개인 링크 리소스의 속성을 가져오거나 배치 계정에 개인 링크 리소스를 나열 합니다. |
> |  | **위치도** |  |
> | 작업 | Microsoft.Batch/locations/checkNameAvailability/action | 계정 이름이 올바르고 사용되고 있지 않은지 확인합니다. |
> |  | **위치/accountOperationResults** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft. 요금 청구/s i d/작업 |  |
> | 작업 | Microsoft.Billing/register/action |  |
> |  | **billingAccounts** |  |
> | 작업 | Microsoft.Billing/billingAccounts/read |  |
> | 작업 | Microsoft. 청구/billingAccounts/listInvoiceSectionsWithCreateSubscriptionPermission/작업 |  |
> | 작업 | Microsoft. 청구/billingAccounts/쓰기 |  |
> |  | **billingAccounts/규약** |  |
> | 작업 | Microsoft. 청구/billingAccounts/계약/읽기 |  |
> |  | **billingAccounts/billingPermissions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingPermissions/읽기 |  |
> |  | **billingAccounts/billingProfiles** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/쓰기 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/읽기 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/쓰기 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/쓰기 |  |
> |  | **billingAccounts/billingProfiles/billingPermissions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/billingPermissions/read |  |
> |  | **billingAccounts/billingProfiles/고객** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/고객/읽기 |  |
> |  | **billingAccounts/billingProfiles/invoices/pricesheet** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/청구서/가격표/다운로드/작업 |  |
> |  | **billingAccounts/billingProfiles/invoiceSections** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/write |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/read |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/write |  |
> |  | **billingAccounts/billingProfiles/invoiceSections/billingPermissions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingPermissions/read |  |
> |  | **billingAccounts/billingProfiles/invoiceSections/billingSubscriptions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/전송/작업 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/이동/동작 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/billingSubscriptions/validateMoveEligibility/작업 |  |
> |  | **billingAccounts/billingProfiles/invoiceSections/products** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/제품/전송/작업 |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/products/move/action |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/products/validateMoveEligibility/작업 |  |
> |  | **billingAccounts/billingProfiles/pricesheet** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingProfiles/가격표/다운로드/작업 |  |
> |  | **billingAccounts/billingSubscriptions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/billingSubscriptions/읽기 |  |
> |  | **billingAccounts/고객** |  |
> | 작업 | Microsoft. 청구/billingAccounts/고객/읽기 |  |
> |  | **billingAccounts/customers/billingPermissions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/고객/billingPermissions/읽기 |  |
...
> | 작업 | Microsoft. 청구/billingAccounts/enrollmentAccounts/billingPermissions/read |  |
> |  | **billingAccounts/enrollmentDepartments/billingPermissions** |  |
> | 작업 | Microsoft. 청구/billingAccounts/enrollmentDepartments/billingPermissions/read |  |
> |  | **billingAccounts/products** |  |
> | 작업 | Microsoft. 청구/billingAccounts/제품/읽기 |  |
> |  | **부서가** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | BingMaps/updateCommunicationPreference/작업 | Microsoft. BingMaps의 소유자에 대 한 통신 기본 설정을 업데이트 합니다. |
> | 작업 | BingMaps/listCommunicationPreference/작업 | Microsoft. BingMaps의 소유자에 대 한 통신 기본 설정을 가져옵니다. |
> |  | **mapApis** |  |
> | 작업 | Microsoft.BingMaps/mapApis/Read | Microsoft. BingMaps/mapApis에 대 한 리소스를 가져옵니다. |
> | 작업 | Microsoft.BingMaps/mapApis/Write | Microsoft. BingMaps/mapApis에 대 한 리소스를 업데이트 합니다. |
> | 작업 | Microsoft.BingMaps/mapApis/Delete | Microsoft. BingMaps/mapApis에 대 한 리소스를 삭제 합니다. |
> | 작업 | Microsoft.BingMaps/mapApis/regenerateKey/action | Microsoft. BingMaps/mapApis에 대 한 키를 다시 생성 합니다. |
> | 작업 | Microsoft.BingMaps/mapApis/listSecrets/action | Microsoft. BingMaps/mapApis에 대 한 암호를 나열 합니다. |
> | 작업 | Microsoft. BingMaps/mapApis/listUsageMetrics/action | Microsoft. BingMaps/mapApis에 대 한 메트릭을 나열 합니다. |
> |  | **작업** |  |
> | 작업 | Microsoft.BingMaps/Operations/read | Microsoft. BingMaps에 대 한 작업 나열 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft Blockchain/register/action | Blockchain 리소스 공급자에 대 한 구독을 등록 합니다. |
> |  | **blockchainMembers** |  |
> | 작업 | Microsoft Blockchain/blockchainMembers/read | 기존 Blockchain 멤버를 가져오거나 나열 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/write | Blockchain 멤버를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/delete | 기존 Blockchain 멤버를 삭제 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/listApiKeys/작업 | 기존 Blockchain 구성원 API 키를 가져오거나 나열 합니다. |
> |  | **blockchainMembers/transactionNodes** |  |
> | 작업 | Microsoft Blockchain/blockchainMembers/transactionNodes/read | 기존 Blockchain 구성원 트랜잭션 노드를 가져오거나 나열 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/transactionNodes/write | Blockchain 구성원 트랜잭션 노드를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/transactionNodes/delete | 기존 Blockchain 구성원 트랜잭션 노드를 삭제 합니다. |
> | 작업 | Microsoft Blockchain/blockchainMembers/transactionNodes/listApiKeys/작업 | 기존 Blockchain 구성원 트랜잭션 노드 API 키를 가져오거나 나열 합니다. |
> |  | **cordaMembers** |  |
> | 작업 | Microsoft Blockchain/cordaMembers/read | 기존 Blockchain Corda 멤버를 가져오거나 나열 합니다. |
> | 작업 | Microsoft Blockchain/cordaMembers/write | Blockchain Corda 멤버를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft Blockchain/cordaMembers/delete | 기존 Blockchain Corda 멤버를 삭제 합니다. |
> |  | **위치도** |  |
> | 작업 | Microsoft Blockchain/위치/checkNameAvailability/action | 리소스 이름이 유효 하며 사용 되 고 있지 않은지 확인 합니다. |
> |  | **위치/blockchainMemberOperationResults** |  |
> | 작업 | Microsoft Blockchain/위치/blockchainMemberOperationResults/읽기 | Blockchain 멤버의 작업 결과를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft Blockchain/작업/읽기 | Microsoft Blockchain 리소스 공급자의 모든 작업을 나열 합니다. |
> |  | **blockchainMembers/transactionNodes** |  |
...
> | 작업 | Microsoft. 청사진/blueprintAssignments/whoisblueprint/작업 | Azure 청사진 서비스 사용자 개체 Id를 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | BotService/checknameavailability/action | 봇의 이름 사용 가능 여부 확인 |
> | 작업 | BotService/listauthserviceproviders/action | 인증 서비스 공급자 나열 |
> |  | **botServices** |  |
...
> | 작업 | Microsoft.BotService/botServices/channels/read | Bot Service 채널 읽기 |
> | 작업 | Microsoft.BotService/botServices/channels/write | Bot Service 채널 작성 |
> | 작업 | Microsoft.BotService/botServices/channels/delete | Bot Service 채널 삭제 |
> | 작업 | BotService/botServices/채널/listchannelwithkeys/작업 | 암호를 사용 하 여 Botservice 채널 나열 |
> |  | **botServices/connections** |  |
> | 작업 | Microsoft.BotService/botServices/connections/read | Bot Service 연결 읽기 |
> | 작업 | Microsoft.BotService/botServices/connections/write | Bot Service 연결 작성 |
> | 작업 | Microsoft.BotService/botServices/connections/delete | Bot Service 연결 삭제 |
> |  | **botServices/connections/listwithsecrets** |  |
> | 작업 | BotService/botServices/connections/listwithsecrets/write | Bot Service 연결 목록 작성  |
> |  | **위치/operationresults** |  |
...
> | 작업 | Microsoft Capacity/calculateexchange/action | 새 구매의 교환 금액 및 가격을 계산 하 고 정책 오류를 반환 합니다. |
> | 작업 | Microsoft. 용량/교환/작업 | 모든 예약 교환 |
> |  | **appliedreservations** |  |
...
> | 작업 | Microsoft Capacity/reservationorders/calculaterefund/작업 | 새 구매의 환불 금액 및 가격을 계산 하 고 정책 오류를 반환 합니다. |
> |  | **reservationorders/mergeoperationresults** |  |
> | 작업 | Microsoft Capacity/reservationorders/mergeoperationresults/read | 모든 병합 작업 폴링 |
> |  | **reservationorders/예약** |  |
> | 작업 | Microsoft Capacity/reservationorders/예약은/availablescopes/action | 사용 가능한 범위를 찾습니다. |
...
> | 작업 | Microsoft Cdn/operationresults/profileresults/endpointresults/origingroupresults/read |  |
> | 작업 | Microsoft Cdn/operationresults/profileresults/endpointresults/origingroupresults/write |  |
> | 작업 | Microsoft Cdn/operationresults/profileresults/endpointresults/origingroupresults/delete |  |
...
> |  | **프로필/끝점/origingroups** |  |
> | 작업 | Microsoft. Cdn/profiles/endpoints/origingroups/read |  |
> | 작업 | Microsoft. Cdn/profiles/endpoints/origingroups/write |  |
> | 작업 | Microsoft. Cdn/profiles/endpoints/origingroups/delete |  |
...
> |  | **domainNames/deploymentslots/역할** |  |
...
> |  | **domainNames/deploymentslots/상태** |  |
...
> |  | **domainNames/internalLoadBalancers 조정기/operationStatuses** |  |
...
> |  | **domainNames/슬롯/operationStatuses** |  |
...
> |  | **domainNames/슬롯/역할/extensionReferences** |  |
...
> |  | **domainNames/슬롯/역할/extensionReferences/operationStatuses** |  |
...
> |  | **domainNames/슬롯/역할/roleInstances/operationStatuses** |  |
...
> |  | **expressroutecrossconnections/피어 링** |  |
...
> |  | **expressroutecrossconnections/피어 링/operationstatuses** |  |
...
> |  | **virtualNetworks/게이트웨이/clientRevokedCertificates** |  |
...
> |  | **virtualNetworks/게이트웨이/clientRootCertificates** |  |
...
> |  | **virtualNetworks/서브넷/associatedNetworkSecurityGroups** |  |
...
> |  | **virtualNetworks/서브넷/associatedNetworkSecurityGroups/operationStatuses** |  |
...
> | 작업 | ClassicStorage/storageAccounts/blobServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 작업 | ClassicStorage/storageAccounts/blobServices/providers/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> |  | **storageAccounts/blobServices/providers/Microsoft. Insights/metricDefinitions** |  |
> | 작업 | ClassicStorage/storageAccounts/blobServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
...
> | 작업 | ClassicStorage/storageAccounts/fileServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 작업 | ClassicStorage/storageAccounts/fileServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> |  | **storageAccounts/fileServices/providers/metricDefinitions** |  |
> | 작업 | ClassicStorage/storageAccounts/fileServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
...
> |  | **storageAccounts/providers/diagnosticSettings/Microsoft** |  |
> | 작업 | ClassicStorage/storageAccounts/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 작업 | ClassicStorage/storageAccounts/providers/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> |  | **storageAccounts/providers/metricDefinitions/Microsoft** |  |
> | 작업 | ClassicStorage/storageAccounts/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
> |  | **storageAccounts/queueServices/providers/diagnosticSettings** |  |
> | 작업 | ClassicStorage/storageAccounts/queueServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 작업 | ClassicStorage/storageAccounts/queueServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> |  | **storageAccounts/queueServices/providers/metricDefinitions** |  |
> | 작업 | ClassicStorage/storageAccounts/queueServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
...
> | 작업 | ClassicStorage/storageAccounts/tableServices/providers/diagnosticSettings/read | 진단 설정을 가져옵니다. |
> | 작업 | ClassicStorage/storageAccounts/tableServices/providers/Microsoft. Insights/diagnosticSettings/write | 진단 설정을 추가하거나 수정합니다. |
> |  | **storageAccounts/tableServices/providers/metricDefinitions** |  |
> | 작업 | ClassicStorage/storageAccounts/tableServices/providers/metricDefinitions/read | 메트릭 정의를 가져옵니다. |
...
> | 작업 | Cognitiveservices account/checkDomainAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> | 작업 | Microsoft.CognitiveServices/register/action | Cognitive Services에 대한 구독을 등록합니다. |
> |  | **계좌** |  |
...
> |  | **위치도** |  |
> | 작업 | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> | 작업 | Cognitiveservices account/위치/deleteVirtualNetworkOrSubnets/작업 | VirtualNetworks 또는 서브넷을 삭제 하는 Microsoft 네트워크의 알림입니다. |
> | 작업 | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 구독에 대해 사용 가능한 Sku를 읽습니다. |
> |  | **위치/operationresults** |  |
> | 작업 | Cognitiveservices account/위치/operationresults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **작업** |  |
> | 작업 | Microsoft.CognitiveServices/Operations/read | 사용 가능한 모든 작업을 나열합니다. |
> |  | **accounts/AnomalyDetector/시계열/전체** |  |
...
> |  | **accounts/AnomalyDetector/시계열/last** |  |
...
> |  | **계정/컴퓨터 비전** |  |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/분석/작업 | 이 작업은 이미지 콘텐츠를 기반으로 다양 한 시각적 기능 집합을 추출 합니다.  |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/설명/작업 | 이 작업을 수행 하면 전체 문장이 있는 사람이 읽을 수 있는 언어로 이미지에 대 한 설명이 생성 됩니다.<br> 설명은 작업에 의해 반환 되는 콘텐츠 태그의 컬렉션을 기반으로 합니다.<br>각 이미지에 대해 둘 이상의 설명을 생성할 수 있습니다.<br> 설명은 신뢰성 점수를 기준으로 정렬 됩니다.<br>모든 설명은 영어로 되어 있습니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/generatethumbnail 그림/작업 | 이 작업을 수행 하면 사용자 지정 너비와 높이가 포함 된 미리 보기 이미지가 생성 됩니다.<br> 기본적으로 서비스는 이미지를 분석하고 ROI(관심 영역)를 식별하며 ROI를 기반으로 스마트 자르기 좌표를 생성합니다.<br> 스마트 자르기는 입력 이미지의 가로 세로 비율을 지정 하는 경우에 유용 합니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/a d/작업 | OCR (광학 문자 인식)은 이미지의 텍스트를 검색 하 고 인식 된 문자를 컴퓨터에서 사용 가능한 문자 스트림으로 추출 합니다.    |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/recognizetext/작업 | 이 인터페이스를 사용 하 여 텍스트 인식 작업의 결과를 가져옵니다. 텍스트 인식 인터페이스를 사용 하는 경우 응답에는 "작업-위치" 라는 필드가 포함 됩니다. "작업 위치" 필드에는 가져오기 텍스트 인식 작업 결과 작업에 사용 해야 하는 URL이 포함 되어 있습니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/태그/작업 | 이 작업을 수행 하면 제공 된 이미지의 내용과 관련 된 단어 또는 태그 목록이 생성 됩니다.<br>Computer Vision API는 이미지에 있는 개체, 거실 생물, 장면 또는 작업을 기반으로 태그를 반환할 수 있습니다.<br>범주와 달리 태그는 계층적 분류 시스템에 따라 구성 되지 않지만 이미지 내용에 해당 합니다.<br>태그는 모호성을 방지 하거나 컨텍스트를 제공 하는 힌트를 포함할 수 있습니다. 예를 들어 "cello" 태그는 "음악 계측" 힌트와 함께 사용 될 수 있습니다.<br>모든 태그는 영어로 되어 있습니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/areaofinterest/작업 | 이 작업은 이미지의 가장 중요 한 영역 주위에 경계 상자를 반환 합니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/감지/작업 | 이 작업은 지정 된 이미지에서 개체 검색을 수행 합니다.  |
> |  | **계정/컴퓨터 비전/모델** |  |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/모델/읽기 | 이 작업은 Computer Vision API에서 지 원하는 도메인별 모델 목록을 반환 합니다.  현재이 API는 다음과 같은 도메인별 모델 (유명인 인식기, 랜드마크 인식기)을 지원 합니다. |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/모델/분석/작업 | 이 작업은 도메인별 모델을 적용 하 여 이미지 내에서 콘텐츠를 인식 합니다.<br> /모델 GET 요청을 사용 하 여 Computer Vision API에서 지 원하는 도메인별 모델 목록을 검색할 수 있습니다.<br> 현재이 API는 다음과 같은 도메인별 모델을 제공 합니다. 유명인, 랜드마크. |
> |  | **계정/컴퓨터 비전/읽기** |  |
...
> |  | **계정/컴퓨터 비전/textoperations** |  |
> | DataAction | Cognitiveservices account/accounts/ComputerVision/textoperations/읽기 | 이 인터페이스는 인식 텍스트 작업 결과를 가져오는 데 사용 됩니다. 이 인터페이스의 URL은 텍스트 인식 인터페이스에서 반환 된 <b>"작업 위치"</b> 필드에서 검색 해야 합니다. |
> |  | **계정/ContentModerator** |  |
...
> |  | **계정/ContentModerator/imagelists** |  |
...
> |  | **계정/ContentModerator/imagelists/images** |  |
...
> |  | **계정/ContentModerator/processimage** |  |
...
> | DataAction | Cognitiveservices account/accounts/ContentModerator/processimage/match/action | Fuzzily 사용자 지정 이미지 목록 중 하나에 대해 이미지를 일치 시킵니다. 이 API를 사용 하 여 사용자 지정 이미지 목록을 만들고 관리할 수 있습니다.  |
...
> |  | **계정/ContentModerator/processtext** |  |
> | DataAction | Cognitiveservices account/accounts/ContentModerator/processtext/detectlanguage/action | 이 작업을 수행 하면 지정 된 입력 콘텐츠의 언어가 검색 됩니다. 전송 된 텍스트를 구성 하는 언어에 대 한 ISO 639-3 코드를 반환 합니다. 110 이상의 언어가 지원 됩니다. |
> | DataAction | Cognitiveservices account/accounts/ContentModerator/processtext/화면/작업 | 작업은 100 개 이상의 언어에서 비속어를 검색 하 고 사용자 지정 및 공유 블랙 리스트에 대해 일치 시킵니다. |
> |  | **계정/ContentModerator/팀** |  |
...
> |  | **계정/ContentModerator/팀/워크플로** |  |
> | DataAction | Cognitiveservices account/accounts/ContentModerator 사람/팀/워크플로/쓰기 | 새 워크플로를 만들거나 기존 워크플로를 업데이트 합니다. |
> | DataAction | Cognitiveservices account/accounts/ContentModerator 사람/팀/워크플로/읽기 | 팀에서 사용 가능한 모든 워크플로를 가져오는 팀의 특정 워크플로에 대 한 세부 정보 가져오기 * |
> |  | **계정/ContentModerator/termlists** |  |
...
> |  | **계정/ContentModerator/termlists/사용 약관** |  |
...
> | DataAction | Cognitiveservices account/accounts/CustomVision. 예측/프로젝트/가져오기/동작 | 프로젝트를 가져옵니다. |
> |  | **계정/CustomVision. 예측/프로젝트/내보내기** |  |
> | DataAction | Cognitiveservices account/accounts/CustomVision. 예측/프로젝트/내보내기/읽기 | 프로젝트를 내보냅니다. |
> |  | **계정/CustomVision. 예측/프로젝트/이미지** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/이미지/i d** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/이미지/지역** |  |
> | DataAction | Cognitiveservices account/accounts/CustomVision. 예측/프로젝트/이미지/지역/삭제 | 이미지 영역 집합을 삭제 합니다. |
> |  | **계정/CustomVision. 예측/프로젝트/이미지/제안** |  |
> | DataAction | Cognitiveservices account/accounts/CustomVision. 예측/프로젝트/이미지/제안/개수/작업 | 이 API는 지정 된 임계값에 대해 제안 된 태그 당 태그 없는 이미지 수를 가져오기 위해 tagIds을 사용 합니다. |
> |  | **계정/CustomVision. 예측/프로젝트/이미지/태그가 지정 된** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/이미지/태그가 지정 된/개수** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/이미지/태그 없음/개수** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/반복/성능/이미지/개수** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/quicktest** |  |
...
> |  | **계정/CustomVision. 예측/프로젝트/tagsandregions** |  |
...
> |  | **계정/얼굴** |  |
> | DataAction | Cognitiveservices account/계정/얼굴/감지/작업 | 이미지에서 인간 얼굴을 감지 하 고, 얼굴 사각형을 반환 하 고, 선택적으로 faceIds, 랜드마크 및 특성을 사용 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/findsimilars/작업 | 쿼리 표면의 faceId를 지정 하 여 faceId 배열, 얼굴 목록 또는 커다란 얼굴 목록에서 비슷한 모양의 얼굴을 검색 합니다. faceId |
> | DataAction | Cognitiveservices account/계정/얼굴/그룹/작업 | 얼굴 유사성을 기준으로 후보 얼굴을 그룹으로 나눕니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/식별/작업 | 일대다 그룹 또는 대기업에서 특정 쿼리 사용자에 게 가장 가까운 일치 항목을 찾는 데 대 한 일대다 id입니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/확인/작업 | 두 얼굴이 동일한 사람에 게 속하는지 또는 한 얼굴이 사람에 게 속하는지 여부를 확인 합니다. |
> |  | **계정/얼굴/facelists** |  |
> | DataAction | Cognitiveservices account/accounts/Face/facelists/write | 사용자 지정 faceListId, 이름 및 userData (선택 사항)를 사용 하 여 빈 얼굴 목록을 만듭니다. 이름 및 userData를 비롯 한 얼굴 목록의 업데이트 정보는 최대 64 얼굴 목록에 허용 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/facelists/delete | 지정 된 얼굴 목록을 삭제 합니다. 얼굴 목록에서 관련 된 얼굴 이미지도 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/facelists/read | 얼굴 목록에서 얼굴 목록 faceListId, 이름, userData 및 얼굴을 검색 합니다. 목록에서 ' faceListId, name, userData '를 나열 합니다. |
> |  | **계정/얼굴/facelists/persistedfaces** |  |
> | DataAction | Cognitiveservices account/accounts/Face/facelists/persistedfaces/쓰기 | 지정 된 얼굴 목록에 얼굴을 최대 1000 면까지 추가 합니다. |
> | DataAction | Cognitiveservices account/accounts/Face/facelists/persistedfaces/삭제 | FaceListId 및 persisitedFaceId를 지정 하 여 얼굴 목록에서 얼굴을 삭제 합니다. 관련 된 얼굴 이미지도 삭제 됩니다. |
> |  | **계정/얼굴/largefacelists** |  |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/write | 사용자 지정 largeFaceListId, 이름 및 userData (선택 사항)를 사용 하 여 빈 긴 얼굴 목록을 만듭니다. 이름 및 userData를 포함 하 여 많은 얼굴 목록의 정보를 업데이트 합니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/delete | 지정 된 많은 얼굴 목록을 삭제 합니다. 또한 많은 면 목록에 있는 관련 된 얼굴 이미지가 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/read | 많은 얼굴 목록의 largeFaceListId, name, userData를 검색 합니다. LargeFaceListId, 이름 및 userData의 정보를 나열 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/largefacelists/학습/작업 | 커다란 얼굴 목록 교육 작업을 제출 합니다. 교육은 학습 된 많은 얼굴 목록 에서만 사용할 수 있는 중요 한 단계입니다. |
> |  | **계정/얼굴/largefacelists/persistedfaces** |  |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/persistedfaces/쓰기 | 지정 된 많은 얼굴 목록에 얼굴을 최대 100만 면까지 추가 합니다. 많은 얼굴 목록에서 지정 된 얼굴의 userData 필드를 persistedFaceId로 업데이트 합니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/persistedfaces/삭제 | LargeFaceListId 및 persisitedFaceId를 지정 하 여 많은 얼굴 목록에서 얼굴을 삭제 합니다. 관련 된 얼굴 이미지도 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largefacelists/persistedfaces/읽기 | LargeFaceListId 및 persistedFaceId로 많은 얼굴 목록에서 지속형 얼굴을 검색 합니다. 지정 된 많은 얼굴 목록에서 ' persistedFaceId 및 userData '를 나열 합니다. |
> |  | **계정/얼굴/largefacelists/교육** |  |
> | DataAction | Cognitiveservices account/계정/얼굴/largefacelists/교육/읽기 | 커다란 얼굴 목록 학습 상태를 완료 또는 계속 진행 중으로 확인 합니다. LargeFaceList 교육은 비동기 작업입니다. |
> |  | **계정/얼굴/largepersongroups** |  |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/write | 사용자가 지정한 largePersonGroupId, 이름 및 선택적 userData를 사용 하 여 새 large person 그룹을 만듭니다. 기존 large person 그룹의 이름 및 userData를 업데이트 합니다. 요청 본문에 없는 속성은 변경 되지 않은 상태로 유지 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/delete | 지정 된 personGroupId를 사용 하 여 기존 large person 그룹을 삭제 합니다. 이 많은 사용자 그룹의 지속형 데이터가 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/read | 이름 및 userData를 포함 하 여 large person 그룹의 정보를 검색 합니다. 이 API는 기존의 많은 개인 그룹의 largePesonGroupId, 이름 및 userData를 모두 반환 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/largepersongroups/학습/작업 | 대량 사용자 그룹 학습 작업을 제출 합니다. 교육은 학습 된 많은 사용자 그룹에서 사용할 수 있는 중요 한 단계입니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/largepersongroups/사람/작업 | 지정 된 large person 그룹에 새 사용자를 만듭니다. 이 사용자에 게 얼굴을 추가 하려면 다음을 호출 하세요. |
> |  | **계정/얼굴/largepersongroups/사람** |  |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/사람/삭제 | 대량 사용자 그룹에서 기존 사용자를 삭제 합니다. 사용자 항목의 저장 된 모든 사용자 데이터와 얼굴 이미지가 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/사람/읽기 | 사용자의 이름과 userData를 검색 하 고, 등록 된 사용자 얼굴 이미지를 나타내는 지속형 faceIds을 검색 합니다. PersonId, name, userData 및 persistedFaceIds를 포함 하 여 지정 된 large person 그룹의 모든 사람 정보를 나열 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/largepersongroups/사람/쓰기 | 개인의 이름 또는 userData를 업데이트 합니다. |
> |  | **계정/얼굴/largepersongroups/사람/persistedfaces** |  |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/persons/persistedfaces/쓰기 | 얼굴 식별 또는 확인을 위해 개인에 게 얼굴 이미지를 추가 합니다. 사용자가 저장 한 면의 userData 필드를 업데이트 하는 이미지를 처리 합니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/persons/persistedfaces/삭제 | 대기업의 사용자에서 얼굴을 삭제 합니다. 이 얼굴 항목과 관련 된 얼굴 데이터 및 이미지도 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/largepersongroups/persons/persistedfaces/읽기 | 사용자 얼굴 정보를 검색 합니다. 지속형 사용자 face는 해당 largePersonGroupId, personId 및 persistedFaceId에 의해 지정 됩니다. |
> |  | **계정/얼굴/largepersongroups/교육** |  |
> | DataAction | Cognitiveservices account/계정/얼굴/largepersongroups/교육/읽기 | 대량 사용자 그룹의 학습 상태를 완료 또는 계속 진행 중으로 확인 합니다. LargePersonGroup 교육은 비동기 작업입니다. |
> |  | **계정/얼굴/persongroups** |  |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/write | 지정 된 personGroupId, 이름 및 사용자가 제공한 userData를 사용 하 여 새 person 그룹을 만듭니다. 기존 사용자 그룹의 이름 및 userData를 업데이트 합니다. 요청 본문에 없는 속성은 변경 되지 않은 상태로 유지 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/delete | 지정 된 personGroupId를 사용 하 여 기존 사용자 그룹을 삭제 합니다. 이 사용자 그룹의 지속형 데이터가 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/read | 사용자 그룹 이름 및 userData를 검색 합니다. 이 personGroup에 대 한 사용자 정보를 가져오려면 사용자 그룹의 pesonGroupId, 이름 및 userData를 사용 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/persongroups/학습/작업 | 개인 그룹 학습 작업을 제출 합니다. 학습은 학습 된 사용자 그룹에만 사용할 수 있는 중요 한 단계입니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/persongroups/사람/작업 | 지정 된 사용자 그룹에 새 사용자를 만듭니다. 이 사용자에 게 얼굴을 추가 하려면 다음을 호출 하세요. |
> |  | **계정/얼굴/persongroups/사람** |  |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/사람/삭제 | 사용자 그룹에서 기존 사용자를 삭제 합니다. 사용자 항목의 저장 된 모든 사용자 데이터와 얼굴 이미지가 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/사람/읽기 | 사용자의 이름과 userData를 검색 하 고, 등록 된 사용자 얼굴 이미지를 나타내는 지속형 faceIds을 검색 합니다. PersonId, name, userData 및 persistedFaceIds를 포함 하 여 지정 된 사용자 그룹의 모든 사람 정보를 나열 합니다. |
> | DataAction | Cognitiveservices account/계정/얼굴/persongroups/사람/쓰기 | 개인의 이름 또는 userData를 업데이트 합니다. |
> |  | **계정/얼굴/persongroups/사람/persistedfaces** |  |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/persons/persistedfaces/쓰기 | 얼굴 식별 또는 확인을 위해 개인 그룹에 얼굴 이미지를 추가 합니다. 여러 업데이트의 이미지를 처리 하려면 개인 저장 된 면의 userData 필드를 사용 합니다. |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/persons/persistedfaces/삭제 | 개인 그룹의 사람에서 얼굴을 삭제 합니다. 이 얼굴 항목과 관련 된 얼굴 데이터 및 이미지도 삭제 됩니다. |
> | DataAction | Cognitiveservices account/accounts/Face/persongroups/persons/persistedfaces/읽기 | 사용자 얼굴 정보를 검색 합니다. 지속형 사용자 face는 해당 personGroupId, personId 및 persistedFaceId에 의해 지정 됩니다. |
> |  | **계정/얼굴/persongroups/교육** |  |
> | DataAction | Cognitiveservices account/계정/얼굴/persongroups/교육/읽기 | 사용자 그룹 학습 상태를 완료 또는 계속 진행 중으로 확인 합니다. PersonGroup 교육은 트리거된 비동기 작업입니다. |
> |  | **계정/얼굴/스냅숏** |  |
...
> |  | **계정/LUIS** |  |
> | DataAction | Cognitiveservices account/accounts/LUIS/predict/action | 지정 된 쿼리에 대 한 게시 된 끝점 예측을 가져옵니다. |
> |  | **계정/NewsSearch** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft. 상거래용/register/action | Microsoft Commerce UsageAggregate에 대 한 구독 등록 |
> | 작업 | Microsoft. 상거래/등록 취소/작업 | Microsoft Commerce UsageAggregate에 대 한 구독 등록 취소 |
> |  | **RateCard** |  |
> | 작업 | Microsoft.Commerce/RateCard/read | 지정된 구독에 대한 제안 데이터, 리소스/미터 메타데이터 및 요율을 제공합니다. |
> |  | **UsageAggregates** |  |
> | 작업 | Microsoft.Commerce/UsageAggregates/read | 구독에서 Microsoft Azure의 사용을 검색 합니다. 결과에는 특정 시간 범위의 집계 사용량 현황 데이터, 구독 및 리소스 관련 정보가 포함됩니다. |
...
> | 작업 | Microsoft. Compute/등록 취소/작업 | Microsoft. Compute 리소스 공급자를 사용 하 여 구독 등록을 취소 합니다. |
> |  | **availabilitySets** |  |
...
> | 작업 | Microsoft. Compute/Disk를 설정/삭제 | 디스크 암호화 집합 삭제 |
> |  | **디스크만** |  |
...
> |  | **갤러리/응용 프로그램** |  |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/읽기 | 갤러리 응용 프로그램의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/쓰기 | 새 갤러리 응용 프로그램을 만들거나 기존 갤러리 응용 프로그램을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/삭제 | 갤러리 응용 프로그램을 삭제 합니다. |
> |  | **갤러리/응용 프로그램/버전** |  |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/버전/읽기 | 갤러리 응용 프로그램 버전의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/버전/쓰기 | 새 갤러리 응용 프로그램 버전을 만들거나 기존 갤러리 응용 프로그램 버전을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/갤러리/응용 프로그램/버전/삭제 | 갤러리 응용 프로그램 버전을 삭제 합니다. |
> |  | **galleries/images** |  |
...
> |  | **호스트 그룹** |  |
> | 작업 | Microsoft. Compute/hostGroups/read | 호스트 그룹의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/hostGroups/write | 새 호스트 그룹을 만들거나 기존 호스트 그룹을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/hostGroups/delete | 호스트 그룹을 삭제 합니다. |
> |  | **호스트 그룹/호스트** |  |
> | 작업 | Microsoft. Compute/hostGroups/hosts/read | 호스트의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/hostGroups/hosts/write | 새 호스트를 만들거나 기존 호스트를 업데이트 합니다. |
> | 작업 | Microsoft. Compute/hostGroups/hosts/delete | 호스트를 삭제 합니다. |
> |  | **images** |  |
...
> |  | **위치/privateEndpointConnectionProxyAzureAsyncOperation** |  |
> | 작업 | Microsoft. Compute/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 비동기 개인 끝점 연결 프록시 작업의 상태를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyOperationResults** |  |
> | 작업 | Microsoft. Compute/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/게시자** |  |
> | 작업 | Microsoft.Compute/locations/publishers/read | 게시자의 속성을 가져옵니다. |
> |  | **위치/게시자/artifacttypes/제안** |  |
> | 작업 | Microsoft.Compute/locations/publishers/artifacttypes/offers/read | 플랫폼 이미지 제품의 속성을 가져옵니다. |
> |  | **위치/게시자/artifacttypes/제품/sku** |  |
> | 작업 | Microsoft.Compute/locations/publishers/artifacttypes/offers/skus/read | 플랫폼 이미지 Sku의 속성을 가져옵니다. |
> |  | **위치/게시자/artifacttypes/제품/a s/버전** |  |
> | 작업 | Microsoft.Compute/locations/publishers/artifacttypes/offers/skus/versions/read | 플랫폼 이미지 버전의 속성을 가져옵니다. |
> |  | **위치/게시자/artifacttypes/types** |  |
> | 작업 | Microsoft.Compute/locations/publishers/artifacttypes/types/read | VMExtension 형식의 속성을 가져옵니다. |
> |  | **위치/게시자/artifacttypes/types/versions** |  |
...
> |  | **위치/vsmOperations** |  |
> | 작업 | Microsoft. Compute/위치/vsmOperations/읽기 | 가상 머신 런타임 서비스 확장을 사용 하 여 가상 머신 확장 집합에 대 한 비동기 작업의 상태를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft.Compute/operations/read | Microsoft.Compute 리소스 공급자에서 사용 가능한 작업을 나열합니다. |
> |  | **proximityPlacementGroups** |  |
> | 작업 | Microsoft. Compute/proximityPlacementGroups/read | 근접 배치 그룹의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/proximityPlacementGroups/write | 새 근접 배치 그룹을 만들거나 기존 항목을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/proximityPlacementGroups/delete | 근접 배치 그룹을 삭제 합니다. |
...
> |  | **sharedVMExtensions** |  |
> | 작업 | Microsoft. Compute/sharedVMExtensions/read | 공유 VM 확장의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/sharedVMExtensions/write | 새 공유 VM 확장을 만들거나 기존 확장을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/sharedVMExtensions/delete | 공유 VM 확장을 삭제 합니다. |
> |  | **sharedVMExtensions/버전** |  |
> | 작업 | Microsoft. Compute/sharedVMExtensions/버전/읽기 | 공유 VM 확장 버전의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/sharedVMExtensions/버전/쓰기 | 새 공유 VM 확장 버전을 만들거나 기존 항목을 업데이트 합니다. |
> | 작업 | Microsoft. Compute/sharedVMExtensions/버전/삭제 | 공유 VM 확장 버전을 삭제 합니다. |
> |  | **sharedVMImages** |  |
...
> |  | **sshPublicKeys** |  |
> | 작업 | Microsoft. Compute/sshPublicKeys/read | SSH 공개 키의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/sshPublicKeys/write | 새 SSH 공개 키를 만들거나 기존 SSH 공개 키를 업데이트 합니다. |
> | 작업 | Microsoft. Compute/sshPublicKeys/delete | SSH 공개 키를 삭제 합니다. |
> |  | **virtualMachines** |  |
...
> | 작업 | Microsoft.Compute/virtualMachines/start/action | 가상 머신 시작 |
...
> | 작업 | Microsoft. Compute/virtualMachines/installPatches/작업 | 사용자가 제공한 매개 변수를 기반으로 가상 컴퓨터에 사용 가능한 OS 업데이트 패치를 설치 합니다. 사용 가능한 패치 목록을 포함 하는 평가 결과도이의 일부로 새로 고쳐집니다. |
> | 작업 | Microsoft. Compute/virtualMachines/assessPatches/action | 가상 컴퓨터를 평가 하 고 해당 가상 컴퓨터에 대 한 사용 가능한 OS 업데이트 패치의 목록을 찾습니다. |
> | 작업 | Microsoft. Compute/virtualMachines/cancelPatchInstallation/action | 가상 컴퓨터에서 진행 중인 OS 업데이트 패치 설치 작업을 취소 합니다. |
> |  | **virtualMachines/확장** |  |
...
> | 작업 | Microsoft. Compute/virtualMachineScaleSets/rollingUpgrades/action | 가상 머신 확장 집합의 롤링 업그레이드를 취소합니다. |
...
> |  | **virtualMachineScaleSets/확장/역할** |  |
> | 작업 | Microsoft. Compute/virtualMachineScaleSets/확장/역할/읽기 | 가상 컴퓨터 확장 집합에서 가상 컴퓨터 런타임 서비스 확장을 사용 하 여 역할의 속성을 가져옵니다. |
> | 작업 | Microsoft. Compute/virtualMachineScaleSets/extensions/roles/write | Virtual machine Runtime 서비스 확장을 사용 하 여 가상 머신 확장 집합에 있는 기존 역할의 속성을 업데이트 합니다. |
...
> |  | **aggregatedcost** |  |
> | 작업 | Microsoft 사용/aggregatedcost/읽기 | 관리 그룹에 대 한 AggregatedCost를 나열 합니다. |
> |  | **잔고** |  |
...
> |  | **externalBillingAccounts/태그** |  |
> | 작업 | Microsoft. 사용/externalBillingAccounts/태그/읽기 | EA 및 구독에 대한 태그를 나열합니다. |
> |  | **externalSubscriptions/태그** |  |
> | 작업 | Microsoft. 사용/s i d 구독/태그/읽기 | EA 및 구독에 대한 태그를 나열합니다. |
> |  | **예측** |  |
...
> | 작업 | Microsoft 사용/테 넌 트/읽기 | 테 넌 트 나열 |
> |  | **표현을** |  |
...
> |  | **작업도** |  |
> | 작업 | ContainerInstance/작업/읽기 | Azure Container Instance 서비스에 대 한 작업을 나열 합니다. |
> |  | **serviceassociationlinks** |  |
> | 작업 | ContainerInstance/serviceassociationlinks/delete | 서브넷에서 azure container instance 리소스 공급자에 의해 만들어진 서비스 연결 링크를 삭제 합니다. |
...
> | 작업 | Microsoft.containerregistry/레지스트리/generateCredentials/작업 | 지정 된 컨테이너 레지스트리의 토큰에 대 한 키를 생성 합니다. |
...
> |  | **레지스트리/agentpools** |  |
> | 작업 | Microsoft.containerregistry/registry/agentpools/listQueueStatus/작업 | 컨테이너 레지스트리에 대 한 agentpool의 모든 큐 상태를 나열 합니다. |
> |  | **레지스트리/아티팩트** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/아티팩트/삭제 | 컨테이너 레지스트리에서 아티팩트를 삭제 합니다. |
> |  | **registries/builds** |  |
...
> |  | **레지스트리/메타 데이터** |  |
> | 작업 | Microsoft.containerregistry/registry/metadata/read | 컨테이너 레지스트리에 대 한 특정 리포지토리의 메타 데이터를 가져옵니다. |
> | 작업 | Microsoft.containerregistry/registry/metadata/write | 컨테이너 레지스트리에 대 한 리포지토리의 메타 데이터를 업데이트 합니다. |
> |  | **레지스트리/operationStatuses** |  |
> | 작업 | Microsoft.ContainerRegistry/registries/operationStatuses/read | 레지스트리 비동기 작업 상태를 가져옵니다. |
> |  | **레지스트리/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/privateEndpointConnectionProxies/유효성 검사/작업 | 개인 끝점 연결 프록시 (NRP에만 해당)의 유효성을 검사 합니다. |
> | 작업 | Microsoft.containerregistry/registry/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 (NRP에만 해당) |
> | 작업 | Microsoft.containerregistry/registry/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 (NRP에만 해당) |
> | 작업 | Microsoft.containerregistry/registry/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다 (NRP에만 해당). |
> |  | **레지스트리/privateEndpointConnectionProxies/operationStatuses** |  |
> | 작업 | Microsoft.containerregistry/registry/privateEndpointConnectionProxies/operationStatuses/읽기 | 개인 끝점 연결 프록시 비동기 작업 상태 가져오기 |
> |  | **레지스트리/풀** |  |
...
> |  | **레지스트리/격리** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/격리/읽기 | 컨테이너 레지스트리에서 격리된 이미지를 끌어오거나 가져옵니다. |
> | 작업 | Microsoft.containerregistry/레지스트리/격리/쓰기 | 격리된 이미지의 격리 상태를 작성/수정합니다. |
...
> |  | **레지스트리/scopeMaps** |  |
> | 작업 | Microsoft.containerregistry/registry/scopeMaps/read | 지정 된 범위 맵의 속성을 가져오거나 지정 된 컨테이너 레지스트리에 대 한 모든 범위 맵을 나열 합니다. |
> | 작업 | Microsoft.containerregistry/registry/scopeMaps/write | 지정 된 매개 변수를 사용 하 여 컨테이너 레지스트리에 대 한 범위 맵을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.containerregistry/registry/scopeMaps/delete | 컨테이너 레지스트리에서 범위 맵을 삭제 합니다. |
> |  | **레지스트리/scopeMaps/operationStatuses** |  |
> | 작업 | Microsoft.containerregistry/registry/scopeMaps/operationStatuses/읽기 | 범위 매핑 비동기 작업 상태를 가져옵니다. |
> |  | **레지스트리/서명** |  |
> | 작업 | Microsoft.ContainerRegistry/registries/sign/write | 컨테이너 레지스트리에 대한 콘텐츠 신뢰 메타데이터를 푸시/풀합니다. |
> |  | **레지스트리/taskruns** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/작업 실행/listDetails/작업 | 컨테이너 레지스트리에 대 한 taskrun의 모든 세부 정보를 나열 합니다. |
> |  | **registries/tasks** |  |
...
> |  | **레지스트리/토큰** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/토큰/읽기 | 지정 된 토큰의 속성을 가져오거나 지정 된 컨테이너 레지스트리에 대 한 모든 토큰을 나열 합니다. |
> | 작업 | Microsoft.containerregistry/레지스트리/토큰/쓰기 | 지정 된 매개 변수를 사용 하 여 컨테이너 레지스트리에 대 한 토큰을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.containerregistry/레지스트리/토큰/삭제 | 컨테이너 레지스트리에서 토큰을 삭제 합니다. |
> |  | **레지스트리/토큰/operationStatuses** |  |
> | 작업 | Microsoft.containerregistry/레지스트리/토큰/operationStatuses/읽기 | 토큰 비동기 작업 상태를 가져옵니다. |
...
> |  | **registry/webhooks/operationStatuses** |  |
...
> | 작업 | ContainerService/managedClusters/listClusterMonitoringUserCredential/작업 | 관리 되는 클러스터의 clusterMonitoringUser 자격 증명 나열 |
...
> | 작업 | ContainerService/managedClusters/rotateClusterCertificates/작업 | 관리 되는 클러스터의 인증서 회전 |
> | 작업 | ContainerService/managedClusters/privateEndpointConnectionsApproval/작업 | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
...
> | 작업 | ContainerService/managedClusters/agentPools/read | 에이전트 풀을 가져옵니다. |
> | 작업 | ContainerService/managedClusters/agentPools/write | 새 에이전트 풀을 만들거나 기존 에이전트 풀을 업데이트 합니다. |
> | 작업 | ContainerService/managedClusters/agentPools/delete | 에이전트 풀을 삭제 합니다. |
> |  | **managedClusters/agentPools/upgradeProfiles** |  |
> | 작업 | ContainerService/managedClusters/agentPools/upgradeProfiles/read | 에이전트 풀의 업그레이드 프로필을 가져옵니다. |
> |  | **managedClusters/해당 하는 Agentpoolversions** |  |
> | 작업 | ContainerService/managedClusters/해당 하는 Agentpoolversions/읽기 | 클러스터의 사용 가능한 에이전트 풀 버전을 가져옵니다. |
> |  | **managedClusters/감지기** |  |
> | 작업 | ContainerService/managedClusters/감지기/read | 관리 되는 클러스터 탐지기 가져오기 |
> |  | **managedClusters/diagnosticsState** |  |
> | 작업 | ContainerService/managedClusters/diagnosticsState/read | 클러스터의 진단 상태를 가져옵니다. |
> |  | **managedClusters/upgradeProfiles** |  |
> | 작업 | ContainerService/managedClusters/upgradeProfiles/read | 클러스터의 업그레이드 프로필을 가져옵니다. |
> |  | **openShiftClusters** |  |
> | 작업 | Microsoft.ContainerService/openShiftClusters/read | 열린 Shift 클러스터 가져오기 |
> | 작업 | Microsoft.ContainerService/openShiftClusters/write | 새 Open Shift 클러스터를 만들거나 기존 Open Shift 클러스터를 업데이트합니다. |
> | 작업 | Microsoft.ContainerService/openShiftClusters/delete | 열린 Shift 클러스터 삭제 |
> |  | **openShiftManagedClusters** |  |
> | 작업 | Microsoft.ContainerService/openShiftManagedClusters/read | Open Shift 관리 되는 클러스터 가져오기 |
> | 작업 | Microsoft.ContainerService/openShiftManagedClusters/write | 새 Open Shift 관리형 클러스터를 만들거나 기존 Open Shift 관리 클러스터를 업데이트합니다. |
> | 작업 | Microsoft.ContainerService/openShiftManagedClusters/delete | 열린 Shift 관리 클러스터 삭제 |
> |  | **작업도** |  |
...
> | 작업 | CostManagement/register/action | 구독에의 한 CostManagement 범위에 대 한 작업을 등록 합니다. |
> | 작업 | CostManagement/뷰/작업 | 뷰를 만듭니다. |
> | 작업 | CostManagement/예측/작업 | 범위에서 사용 데이터를 예측 합니다. |
> |  | **경고** |  |
> | 작업 | CostManagement/경고/쓰기 | 경고를 업데이트합니다. |
> |  | **cloudConnectors** |  |
> | 작업 | CostManagement/cloudConnectors/read | 인증 된 사용자에 대 한 cloudConnectors를 나열 합니다. |
> | 작업 | CostManagement/cloudConnectors/write | 지정 된 cloudConnector를 만들거나 업데이트 합니다. |
> | 작업 | CostManagement/cloudConnectors/delete | 지정 된 cloudConnector를 삭제 합니다. |
> |  | **차원만** |  |
...
> | 작업 | CostManagement/내보내기/실행/작업 | 내보내기를 실행 합니다. |
> |  | **externalBillingAccounts** |  |
> | 작업 | CostManagement/externalBillingAccounts/읽기 | 인증 된 사용자에 대 한 externalBillingAccounts를 나열 합니다. |
> | 작업 | CostManagement/externalBillingAccounts/쿼리/동작 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 쿼리 합니다. |
> | 작업 | CostManagement/externalBillingAccounts/예측/작업 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 예측 합니다. |
> |  | **externalBillingAccounts/차원** |  |
> | 작업 | CostManagement/externalBillingAccounts/차원/읽기 | 외부 BillingAccounts 지원 되는 모든 차원을 나열 합니다. |
> |  | **externalBillingAccounts/externalSubscriptions** |  |
> | 작업 | CostManagement/externalBillingAccounts/externalSubscriptions/read | 인증 된 사용자에 대 한 externalBillingAccount 내에 externalSubscriptions을 나열 합니다. |
> |  | **externalBillingAccounts/예측** |  |
> | 작업 | CostManagement/externalBillingAccounts/예측/읽기 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 예측 합니다. |
> |  | **externalBillingAccounts/쿼리** |  |
> | 작업 | CostManagement/externalBillingAccounts/쿼리/읽기 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 쿼리 합니다. |
> |  | **externalSubscriptions** |  |
> | 작업 | CostManagement/externalSubscriptions/read | 인증 된 사용자에 대 한 externalSubscriptions을 나열 합니다. |
> | 작업 | CostManagement/externalSubscriptions/write | ExternalSubscription의 연결 된 관리 그룹 업데이트 |
> | 작업 | CostManagement/externalSubscriptions/query/action | 외부 구독에 대 한 사용 현황 데이터를 쿼리 합니다. |
> | 작업 | CostManagement/externalSubscriptions/예측/작업 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 예측 합니다. |
> |  | **externalSubscriptions/차원** |  |
> | 작업 | CostManagement/externalSubscriptions/차원/읽기 | 외부 구독에 대해 지원 되는 모든 차원을 나열 합니다. |
> |  | **externalSubscriptions/예측** |  |
> | 작업 | CostManagement/externalSubscriptions/예측/읽기 | 외부 BillingAccounts에 대 한 사용 현황 데이터를 예측 합니다. |
> |  | **externalSubscriptions/query** |  |
> | 작업 | CostManagement/externalSubscriptions/query/read | 외부 구독에 대 한 사용 현황 데이터를 쿼리 합니다. |
> |  | **예측할** |  |
> | 작업 | CostManagement/예측/읽기 | 범위에서 사용 데이터를 예측 합니다. |
> |  | **작업도** |  |
> | 작업 | CostManagement/작업/읽기 | CostManagement 리소스 공급자에 의해 지원 되는 모든 작업을 나열 합니다. |
> |  | **쿼리** |  |
...
> |  | **테 넌 트** |  |
> | 작업 | CostManagement/테 넌 트/등록/작업 | CostManagement의 범위에 대 한 작업을 테 넌 트에 등록 합니다. |
> |  | **뷰** |  |
> | 작업 | CostManagement/뷰/읽기 | 저장 된 모든 뷰를 나열 합니다. |
> | 작업 | CostManagement/views/delete | 저장 된 보기를 삭제 합니다. |
> | 작업 | CostManagement/views/write | 업데이트 뷰입니다. |

## <a name="microsoftdatabox"></a>Microsoft.DataBox

Azure 서비스: [Azure Data Box](../databox-family/index.md)

> [!div class="mx-tdCol2BreakAll"]
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft.DataBox/register/action | 공급자 Microsoft.Databox를 등록합니다. |
> | 작업 | DataBox/등록 취소/작업 | 공급자 등록 취소 Databox |
> |  | **직업** |  |
...
> |  | **위치도** |  |
> | 작업 | DataBox/위치/validateInputs/작업 | 이 메서드는 모든 유형의 유효성 검사를 수행 합니다. |
...
> | 작업 | DataBox/위치/지역 구성/작업 | 이 메서드는 영역에 대 한 구성을 반환 합니다. |
> |  | **위치/availableSkus** |  |
> | 작업 | DataBox/위치/availableSkus/읽기 | 사용 가능한 Sku 나열 또는 가져오기 |
> |  | **위치/operationResults** |  |
> | 작업 | Microsoft.DataBox/locations/operationResults/read | 작업 결과를 나열하거나 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | DataBox/작업/읽기 | 작업 나열 또는 가져오기 |
> |  | **subscriptions/resourceGroups** |  |
> | 작업 | DataBox/subscription/resourceGroups/moveResources/action | 이 메서드는 리소스 이동을 수행 합니다. |
> | 작업 | DataBox/subscription/resourceGroups/validateMoveResources/action | 이 메서드는 리소스 이동이 허용 되는지 여부를 확인 합니다. |
...
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/read | Data Box Edge 디바이스를 나열하거나 가져오기 |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Data Box Edge 디바이스를 만들거나 업데이트 |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | 리소스 확장 정보를 검색 |
...
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/bandwidthSchedules/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/작업** |  |
...
> |  | **dataBoxEdgeDevices/노드** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/노드/읽기 | 노드를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/operationsStatus** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/operationsStatus/read | 작업 상태를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/주문** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/주문/읽기 | 주문을 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/주문/읽기 | 주문을 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/주문/쓰기 | 주문을 만들거나 업데이트 합니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/주문/삭제 | 주문을 삭제 합니다. |
> |  | **dataBoxEdgeDevices/orders/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/orders/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/역할** |  |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/write | 역할을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/delete | 역할을 삭제 합니다. |
> |  | **dataBoxEdgeDevices/roles/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/역할/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
...
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/securitySettings/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/공유** |  |
...
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/refresh/action | 클라우드의 데이터로 공유 메타 데이터를 새로 고칩니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/delete | 공유를 삭제 |
> |  | **dataBoxEdgeDevices/공유/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/공유/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
...
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/storageAccounts** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/read | 저장소 계정을 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/read | 저장소 계정을 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/write | 저장소 계정을 만들거나 업데이트 합니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/delete | 저장소 계정을 삭제 합니다. |
> |  | **dataBoxEdgeDevices/storageAccounts/컨테이너** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/읽기 | 컨테이너를 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/읽기 | 컨테이너를 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/쓰기 | 컨테이너를 만들거나 업데이트 합니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/삭제 | 컨테이너를 삭제 합니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/새로 고침/작업 | 클라우드의 데이터로 컨테이너 메타 데이터를 새로 고칩니다. |
> |  | **dataBoxEdgeDevices/storageAccounts/컨테이너/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/컨테이너/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/storageAccounts/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/storageAccounts/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/트리거** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/트리거/읽기 | 트리거를 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/트리거/읽기 | 트리거를 나열 하거나 가져옵니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/triggers/write | 트리거를 만들거나 업데이트 합니다. |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/triggers/delete | 트리거를 삭제 합니다. |
> |  | **dataBoxEdgeDevices/triggers/operationResults** |  |
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/triggers/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **dataBoxEdgeDevices/updateSummary** |  |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/updateSummary/read | 업데이트 요약을 나열하거나 가져오기 |
> |  | **dataBoxEdgeDevices/사용자** |  |
...
> | 작업 | DataBoxEdge/dataBoxEdgeDevices/사용자/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> |  | **sku** |  |
> | 작업 | DataBoxEdge/sku/읽기 | Sku를 나열 하거나 가져옵니다. |

## <a name="microsoftdatabricks"></a>Microsoft.Databricks

Azure 서비스: [Azure Databricks](../azure-databricks/index.yml)
...
> |  | **위치도** |  |
> | 작업 | Databricks/위치/a p Network정책/작업 | NRP에서 사용 하는 위치에 따라 서브넷에 대 한 네트워크 의도 정책 가져오기 |
> |  | **위치/operationstatuses** |  |
...
> | 작업 | Databricks/작업 영역/refreshPermissions/작업 | 작업 영역에 대 한 새로 고침 권한 |
> | 작업 | Databricks/작업 영역/updateDenyAssignment/작업 | 작업 영역의 관리 되는 리소스 그룹에 대 한 작업 거부 할당 업데이트 |
> | 작업 | Databricks/작업 영역/refreshWorkspaces/작업 | URL과 같은 새 세부 정보를 사용 하 여 작업 영역 새로 고침 |
> |  | **workspace/dbWorkspaces** |  |
> | 작업 | Databricks/workspace/dbWorkspaces/write | Databricks 작업 영역을 초기화 합니다 (내부 전용). |
> |  | **작업 영역/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **작업 영역/공급자/Microsoft Insights/logDefinitions** |  |
...
> |  | **작업 영역/storageEncryption** |  |
> | 작업 | Databricks/작업 영역/storageEncryption/write | Databricks 작업 영역의 관리 되는 저장소 계정에서 고객이 관리 하는 키 암호화를 사용 하도록 설정 합니다. |
> | 작업 | Databricks/작업 영역/storageEncryption/delete | Databricks 작업 영역의 관리 되는 저장소 계정에서 고객 관리 키 암호화를 사용 하지 않도록 설정 합니다. |
> |  | **workspaces/virtualNetworkPeerings** |  |
> | 작업 | Databricks/작업 영역/virtualNetworkPeerings/읽기 | 가상 네트워크 피어링을 가져옵니다. |
> | 작업 | Databricks/작업 영역/virtualNetworkPeerings/쓰기 | 가상 네트워크 피어 링 추가 또는 수정 |
> | 작업 | Databricks/작업 영역/virtualNetworkPeerings/삭제 | 가상 네트워크 피어링을 삭제합니다. |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft.DataCatalog/register/action | Data Catalog 리소스 공급자에 대 한 구독 등록 |
> | 작업 | Microsoft.DataCatalog/unregister/action | Data Catalog 리소스 공급자에 대 한 구독 등록 취소 |
> |  | **catalogs** |  |
> | 작업 | Microsoft.DataCatalog/catalogs/read | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 읽습니다. |
> | 작업 | Microsoft.DataCatalog/catalogs/write | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 작성 합니다. |
> | 작업 | Microsoft.DataCatalog/catalogs/delete | Data Catalog 리소스 공급자에 대 한 카탈로그 리소스를 삭제 합니다. |
> |  | **checkNameAvailability** |  |
> | 작업 | Microsoft.datacatalog/checkNameAvailability/read | Data Catalog 리소스 공급자에 대 한 카탈로그 이름 가용성을 확인 합니다. |
> |  | **datacatalogs** |  |
> | 작업 | Microsoft.datacatalog/datacatalogs/읽기 | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 읽습니다. |
> | 작업 | Microsoft.datacatalog/datacatalogs/write | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 씁니다. |
> | 작업 | Microsoft.datacatalog/datacatalogs/delete | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 삭제 합니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft.DataCatalog/operations/read | Data Catalog 리소스 공급자에서 사용 가능한 모든 작업을 읽습니다. |
...
> |  | **datafactories/datapipelines/활동/activitywindows** |  |
...
> |  | **datafactories/Linkedservices.json 및 datasets.json** |  |
...
> | 작업 | DataFactory/공장/createdataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 만듭니다. |
> | 작업 | DataFactory/공장/startdataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 시작 합니다. |
> | 작업 | DataFactory/공장/addDataFlowToDebugSession/작업 | 미리 보기에 대 한 디버그 세션에 데이터 흐름을 추가 합니다. |
> | 작업 | DataFactory/공장/executeDataFlowDebugCommand/작업 | 데이터 흐름 실행 디버그 명령입니다. |
> | 작업 | DataFactory/공장/deletedataflowdebugsession/작업 | 데이터 흐름 디버그 세션을 삭제 합니다. |
> | 작업 | DataFactory/공장/querydataflowdebugsessions/작업 | 데이터 흐름 디버그 세션을 쿼리 합니다. |
> | 작업 | Microsoft.DataFactory/factories/cancelpipelinerun/action | 실행 ID로 지정된 파이프라인 실행을 취소합니다. |
> | 작업 | DataFactory/공장/cancelSandboxPipelineRun/작업 | 파이프라인에 대 한 디버그 실행을 취소 합니다. |
> | 작업 | DataFactory/공장/sandboxpipelineruns/작업 | 디버그 파이프라인 실행을 쿼리합니다. |
> | 작업 | DataFactory/공장/querytriggers/작업 | 트리거를 쿼리 합니다. |
> | 작업 | DataFactory/factory/getFeatureValue/action | 특정 위치에 대한 노출 제어 기능 값을 가져옵니다. |
> | 작업 | DataFactory/팩터리/Getdata계획 Eaccess/action | ADF 데이터 평면 서비스에 대한 액세스를 가져옵니다. |
...
> |  | **팩터리/데이터 흐름** |  |
> | 작업 | DataFactory/factory/데이터 흐름/read | 데이터 흐름을 읽습니다. |
> | 작업 | DataFactory/factory/데이터 흐름/delete | 데이터 흐름을 삭제 합니다. |
> | 작업 | DataFactory/factory/데이터 흐름/write | 데이터 흐름 만들기 또는 업데이트 |
> |  | **팩터리/데이터 집합** |  |
...
> |  | **팩터리/debugpipelineruns** |  |
> | 작업 | DataFactory/공장/debugpipelineruns/취소/작업 | 파이프라인에 대 한 디버그 실행을 취소 합니다. |
> |  | **팩터리/Getdata계획 Eaccess** |  |
> | 작업 | DataFactory/factory/Getdata계획 Eaccess/read | ADF 데이터 평면 서비스에 대한 액세스를 읽습니다. |
> |  | **팩터리/getFeatureValue** |  |
> | 작업 | DataFactory/factory/getFeatureValue/read | 특정 위치에 대한 노출 제어 기능 값을 읽습니다. |
> |  | **팩터리/integrationruntimes** |  |
...
> |  | **팩터리/Linkedservices.json 및 datasets.json** |  |
...
> |  | **팩터리/operationResults** |  |
> | 작업 | DataFactory/factory/operationResults/read | 작업 결과를 가져옵니다. |
> |  | **팩터리/pipelineruns** |  |
...
> | 작업 | DataFactory/공장/파이프라인/sandbox/작업 | 파이프라인에 대 한 디버그 실행 환경을 만듭니다. |
> |  | **공장/파이프라인/pipelineruns** |  |
> | 작업 | Microsoft.DataFactory/factories/pipelines/pipelineruns/read | 파이프라인 실행을 읽습니다. |
> |  | **팩터리/파이프라인/pipelineruns/activityruns/진행률** |  |
> | 작업 | Microsoft.DataFactory/factories/pipelines/pipelineruns/activityruns/progress/read | 활동 실행의 진행률을 가져옵니다. |
> |  | **팩터리/파이프라인/샌드박스** |  |
> | 작업 | DataFactory/공장/파이프라인/sandbox/만들기/작업 | 파이프라인에 대 한 디버그 실행 환경을 만듭니다. |
> | 작업 | DataFactory/공장/파이프라인/sandbox/실행/작업 | 파이프라인에 대 한 디버그 실행을 만듭니다. |
> |  | **팩터리/querypipelineruns** |  |
> | 작업 | Microsoft.DataFactory/factories/querypipelineruns/read | 쿼리 파이프라인 실행의 결과를 읽습니다. |
> |  | **팩터리/querytriggerruns** |  |
> | 작업 | Microsoft.DataFactory/factories/querytriggerruns/read | 트리거 실행의 결과를 읽습니다. |
> |  | **팩터리/sandboxpipelineruns** |  |
> | 작업 | DataFactory/factory/sandboxpipelineruns/read | 파이프라인에 대 한 디버그 실행 정보를 가져옵니다. |
> |  | **팩터리/sandboxpipelineruns/sandboxActivityRuns** |  |
> | 작업 | DataFactory/factory/sandboxpipelineruns/sandboxActivityRuns/read | 활동에 대 한 디버그 실행 정보를 가져옵니다. |
> |  | **팩터리/triggerruns** |  |
...
> | 작업 | DataFactory/factory/triggers/subscribetoevents/action | 이벤트를 구독 합니다. |
> | 작업 | DataFactory/factory/triggers/geteventsubscriptionstatus/action | 이벤트 구독 상태입니다. |
> | 작업 | DataFactory/factory/triggers/unsubscribefromevents/action | 이벤트 구독을 취소 합니다. |
...
> |  | **계정/virtualNetworkRules** |  |
> | 작업 | DataLakeAnalytics/계정/virtualNetworkRules/읽기 | 가상 네트워크 규칙에 대 한 정보를 가져옵니다. |
> | 작업 | DataLakeAnalytics/accounts/virtualNetworkRules/write | 가상 네트워크 규칙을 만들거나 업데이트 합니다. |
> | 작업 | DataLakeAnalytics/accounts/virtualNetworkRules/delete | 가상 네트워크 규칙을 삭제 합니다. |
> |  | **위치도** |  |
...
> |  | **계정/공유** |  |
> | 작업 | DataLakeStore/계정/공유/읽기 | 공유에 대 한 정보를 가져옵니다. |
> | 작업 | DataLakeStore/계정/공유/쓰기 | 공유를 만들거나 업데이트 합니다. |
> | 작업 | DataLakeStore/계정/공유/삭제 | 공유를 삭제 합니다. |
> |  | **계정/trustedIdProviders** |  |
...
> |  | **계정/virtualNetworkRules** |  |
> | 작업 | DataLakeStore/계정/virtualNetworkRules/읽기 | 가상 네트워크 규칙에 대 한 정보를 가져옵니다. |
> | 작업 | DataLakeStore/accounts/virtualNetworkRules/write | 가상 네트워크 규칙을 만들거나 업데이트 합니다. |
> | 작업 | DataLakeStore/accounts/virtualNetworkRules/delete | 가상 네트워크 규칙을 삭제 합니다. |
> |  | **위치도** |  |
...
> | 작업 | Microsoft.datamigration/서비스/configureWorker/작업 | 서비스의 availiable 작업자에 대해 DMS 작업자를 구성 합니다. |
> | 작업 | Microsoft.datamigration/서비스/addWorker/작업 | 서비스의 availiable 작업자에 DMS 작업자를 추가 합니다. |
> | 작업 | Microsoft.datamigration/services/removeWorker/action | 서비스의 availiable 작업자에 대해 DMS 작업자를 제거 합니다. |
> | 작업 | Microsoft.datamigration/services/updateAgentConfig/action | 제공 된 값을 사용 하 여 DMS 에이전트 구성을 업데이트 합니다. |
> | 작업 | Microsoft.datamigration/서비스/getHybridDownloadLink/작업 | RP Blob Storage에서 DMS 작업자 패키지 다운로드 링크를 가져옵니다. |
> |  | **services/projects** |  |
...
> |  | **서비스/serviceTasks** |  |
> | 작업 | Microsoft.datamigration/services/serviceTasks/read | 리소스에 대한 정보를 읽습니다. |
> | 작업 | Microsoft.datamigration/services/serviceTasks/write | Azure Database Migration Service 작업을 실행합니다. |
> | 작업 | Microsoft.datamigration/services/serviceTasks/delete | 리소스와 해당 하위 항목을 모두 삭제합니다. |
> | 작업 | Microsoft.datamigration/services/serviceTasks/취소/작업 | 작업이 현재 실행 중인 경우 취소합니다. |
> |  | **서비스/슬롯** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | DBforMariaDB/register/action | MariaDB 리소스 공급자 등록 |
> | 작업 | DBforMariaDB/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> |  | **위치/azureAsyncOperation** |  |
> | 작업 | DBforMariaDB/위치/azureAsyncOperation/읽기 | 서버 작업 결과 반환 (& u) |
> |  | **위치/operationResults** |  |
> | 작업 | DBforMariaDB/위치/operationResults/read | ResourceGroup 기반 MariaDB 서버 작업 결과 반환 |
> | 작업 | DBforMariaDB/위치/operationResults/read | 서버 작업 결과 반환 (& u) |
> |  | **위치/performanceTiers** |  |
...
> | 작업 | DBforMariaDB/위치/privateEndpointConnectionAzureAsyncOperation/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionOperationResults** |  |
> | 작업 | DBforMariaDB/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyAzureAsyncOperation** |  |
> | 작업 | DBforMariaDB/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyOperationResults** |  |
> | 작업 | DBforMariaDB/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/securityAlertPoliciesAzureAsyncOperation** |  |
> | 작업 | DBforMariaDB/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/securityAlertPoliciesOperationResults** |  |
> | 작업 | DBforMariaDB/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/serverKeyAzureAsyncOperation** |  |
> | 작업 | DBforMariaDB/위치/serverKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **위치/serverKeyOperationResults** |  |
> | 작업 | DBforMariaDB/위치/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | DBforMariaDB/작업/읽기 | 작업 목록 반환. |
> |  | **performanceTiers** |  |
> | 작업 | Microsoft.DBforMariaDB/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> |  | **서버용** |  |
> | 작업 | DBforMariaDB/servers/queryTexts/작업 | 쿼리 목록의 텍스트 반환 |
> | 작업 | DBforMariaDB/servers/queryTexts/작업 | 쿼리 텍스트를 반환합니다. |
...
> | 작업 | DBforMariaDB/서버/다시 시작/작업 | 특정 서버를 다시 시작 합니다. |
> | 작업 | Microsoft.DBforMariaDB/servers/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> |  | **servers/administrators** |  |
> | 작업 | DBforMariaDB/servers/administrators/read | MariaDB 서버 관리자의 목록을 가져옵니다. |
> | 작업 | DBforMariaDB/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 MariaDB 서버 관리자를 만들거나 업데이트 합니다. |
> | 작업 | DBforMariaDB/servers/administrators/delete | 기존 관리자의 기존 관리자를 삭제 합니다. |
> |  | **servers/advisors** |  |
> | 작업 | DBforMariaDB/servers/advisor/read | 관리자 목록을 반환합니다. |
> | 작업 | DBforMariaDB/servers/advisor/read | Advisor 반환 |
> | 작업 | DBforMariaDB/servers/advisor/createRecommendedActionSession/작업 | 새 권장 구성 작업 세션을 만듭니다. |
> |  | **servers/advisor/recommendedActions** |  |
> | 작업 | DBforMariaDB/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 작업 | DBforMariaDB/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 작업 | DBforMariaDB/servers/advisor/recommendedActions/read | 권장 작업 반환 |
...
> |  | **servers/databases** |  |
> | 작업 | DBforMariaDB/서버/데이터베이스/읽기 | 반환 된 데이터베이스에 대 한 속성을 가져오거나 반환 합니다. |
> | 작업 | DBforMariaDB/servers/databases/write | 지정 된 매개 변수를 사용 하 여, 지정 된 데이터베이스에 대 한 속성을 업데이트 하는에 대 한 속성을 업데이트 합니다. |
> | 작업 | DBforMariaDB/서버/데이터베이스/삭제 | 기존에 있는 데이터베이스를 삭제 합니다. |
...
> |  | **servers/keys** |  |
> | 작업 | DBforMariaDB/서버/키/읽기 | 서버 키 목록을 가져오거나 지정된 서버 키에 대한 속성을 가져옵니다. |
> | 작업 | DBforMariaDB/servers/keys/write | 지정된 매개 변수를 사용하여 키를 만들거나 지정된 서버 키에 대한 속성 또는 태그를 업데이트합니다. |
> | 작업 | DBforMariaDB/servers/keys/delete | 기존 서버 키를 삭제합니다. |
> |  | **서버/logFiles** |  |
> | 작업 | DBforMariaDB/servers/logFiles/read | Aadb LogFiles의 목록을 반환 합니다. |
> |  | **servers/privateEndpointConnectionProxies** |  |
> | 작업 | DBforMariaDB/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 작업 | DBforMariaDB/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | DBforMariaDB/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 작업 | DBforMariaDB/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **servers/privateEndpointConnections** |  |
> | 작업 | DBforMariaDB/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 작업 | DBforMariaDB/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 작업 | DBforMariaDB/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> |  | **servers/privateLinkResources** |  |
> | 작업 | DBforMariaDB/servers/privateLinkResources/read | 해당 하는 Aadb 서버에 대 한 개인 링크 리소스를 가져옵니다. |
> |  | **서버/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **서버/복제본** |  |
> | 작업 | DBforMariaDB/servers/복제본/읽기 | MariaDB 서버의 읽기 복제본 가져오기 |
...
> | 작업 | DBforMariaDB/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
> | 작업 | DBforMariaDB/servers/topQueryStatistics/read | 쿼리 통계 반환 |
...
> | 작업 | DBforMariaDB/servers/waitStatistics/read | 인스턴스에 대한 대기 통계를 반환합니다. |
> | 작업 | DBforMariaDB/servers/waitStatistics/read | 대기 통계 반환 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft DBforMySQL/register/action | MySQL 리소스 공급자 등록 |
> | 작업 | Microsoft DBforMySQL/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> |  | **위치/azureAsyncOperation** |  |
> | 작업 | Microsoft DBforMySQL/위치/azureAsyncOperation/읽기 | MySQL 서버 작업 결과 반환 |
> |  | **위치/operationResults** |  |
> | 작업 | Microsoft DBforMySQL/위치/operationResults/read | ResourceGroup 기반 MySQL 서버 작업 결과 반환 |
> | 작업 | Microsoft DBforMySQL/위치/operationResults/read | MySQL 서버 작업 결과 반환 |
> |  | **위치/performanceTiers** |  |
> | 작업 | Microsoft.DBforMySQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> |  | **위치/privateEndpointConnectionAzureAsyncOperation** |  |
> | 작업 | Microsoft DBforMySQL/위치/privateEndpointConnectionAzureAsyncOperation/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionOperationResults** |  |
> | 작업 | Microsoft DBforMySQL/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyAzureAsyncOperation** |  |
> | 작업 | Microsoft DBforMySQL/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyOperationResults** |  |
> | 작업 | Microsoft DBforMySQL/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/securityAlertPoliciesAzureAsyncOperation** |  |
> | 작업 | Microsoft DBforMySQL/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/securityAlertPoliciesOperationResults** |  |
> | 작업 | Microsoft DBforMySQL/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/serverKeyAzureAsyncOperation** |  |
> | 작업 | Microsoft DBforMySQL/위치/serverKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **위치/serverKeyOperationResults** |  |
> | 작업 | Microsoft DBforMySQL/위치/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft DBforMySQL/작업/읽기 | MySQL 작업 목록을 반환 합니다. |
> |  | **performanceTiers** |  |
> | 작업 | Microsoft.DBforMySQL/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> |  | **서버용** |  |
> | 작업 | Microsoft DBforMySQL/servers/queryTexts/동작 | 쿼리 목록의 텍스트 반환 |
> | 작업 | Microsoft DBforMySQL/servers/queryTexts/동작 | 쿼리 텍스트를 반환합니다. |
...
> | 작업 | Microsoft DBforMySQL/servers/restart/action | 특정 서버를 다시 시작 합니다. |
> | 작업 | Microsoft.DBforMySQL/servers/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> |  | **servers/administrators** |  |
> | 작업 | Microsoft DBforMySQL/servers/administrators/read | MySQL server 관리자 목록을 가져옵니다. |
> | 작업 | Microsoft DBforMySQL/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 MySQL 서버 관리자를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DBforMySQL/servers/administrators/delete | MySQL 서버의 기존 관리자를 삭제 합니다. |
> |  | **servers/advisors** |  |
> | 작업 | Microsoft DBforMySQL/servers/advisor/read | 관리자 목록을 반환합니다. |
> | 작업 | Microsoft DBforMySQL/servers/advisor/read | Advisor 반환 |
> | 작업 | Microsoft DBforMySQL/servers/advisor/createRecommendedActionSession/action | 새 권장 구성 작업 세션을 만듭니다. |
> |  | **servers/advisor/recommendedActions** |  |
> | 작업 | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 작업 | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장된 작업 목록을 반환 |
> | 작업 | Microsoft DBforMySQL/servers/advisor/recommendedActions/read | 권장 작업 반환 |
> |  | **servers/configurations** |  |
...
> |  | **servers/databases** |  |
> | 작업 | Microsoft DBforMySQL/servers/databases/read | MySQL 데이터베이스 목록을 반환 하거나 지정 된 데이터베이스에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft DBforMySQL/servers/databases/write | 지정 된 매개 변수를 사용 하 여 MySQL 데이터베이스를 만들거나 지정 된 데이터베이스에 대 한 속성을 업데이트 합니다. |
> | 작업 | Microsoft DBforMySQL/servers/databases/delete | 기존 MySQL 데이터베이스를 삭제 합니다. |
> |  | **servers/firewallRules** |  |
...
> |  | **servers/keys** |  |
> | 작업 | Microsoft DBforMySQL/servers/keys/read | 서버 키 목록을 가져오거나 지정된 서버 키에 대한 속성을 가져옵니다. |
> | 작업 | Microsoft DBforMySQL/servers/keys/write | 지정된 매개 변수를 사용하여 키를 만들거나 지정된 서버 키에 대한 속성 또는 태그를 업데이트합니다. |
> | 작업 | Microsoft DBforMySQL/servers/keys/delete | 기존 서버 키를 삭제합니다. |
> |  | **서버/logFiles** |  |
> | 작업 | Microsoft DBforMySQL/servers/logFiles/read | MySQL 로그의 목록을 반환 합니다. |
> |  | **servers/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **servers/privateEndpointConnections** |  |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 작업 | Microsoft DBforMySQL/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> |  | **servers/privateLinkResources** |  |
> | 작업 | Microsoft DBforMySQL/servers/privateLinkResources/read | 해당 MySQL Server에 대 한 개인 링크 리소스 가져오기 |
> |  | **서버/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **서버/복제본** |  |
> | 작업 | Microsoft DBforMySQL/servers/복제본/읽기 | MySQL 서버의 읽기 복제본 가져오기 |
> |  | **servers/securityAlertPolicies** |  |
...
> |  | **servers/topQueryStatistics** |  |
> | 작업 | Microsoft DBforMySQL/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
> | 작업 | Microsoft DBforMySQL/servers/topQueryStatistics/read | 쿼리 통계 반환 |
> |  | **servers/virtualNetworkRules** |  |
...
> |  | **servers/waitStatistics** |  |
> | 작업 | Microsoft DBforMySQL/servers/waitStatistics/read | 인스턴스에 대한 대기 통계를 반환합니다. |
> | 작업 | Microsoft DBforMySQL/servers/waitStatistics/read | 대기 통계 반환 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | DBforPostgreSQL/register/action | PostgreSQL 리소스 공급자 등록 |
> | 작업 | DBforPostgreSQL/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> |  | **위치/azureAsyncOperation** |  |
> | 작업 | DBforPostgreSQL/위치/azureAsyncOperation/읽기 | PostgreSQL 서버 작업 결과 반환 |
> |  | **위치/operationResults** |  |
> | 작업 | DBforPostgreSQL/위치/operationResults/read | ResourceGroup 기반 PostgreSQL 서버 작업 결과 반환 |
> | 작업 | DBforPostgreSQL/위치/operationResults/read | PostgreSQL 서버 작업 결과 반환 |
> |  | **위치/performanceTiers** |  |
> | 작업 | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> |  | **위치/privateEndpointConnectionAzureAsyncOperation** |  |
> | 작업 | DBforPostgreSQL/위치/privateEndpointConnectionAzureAsyncOperation/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionOperationResults** |  |
> | 작업 | DBforPostgreSQL/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyAzureAsyncOperation** |  |
> | 작업 | DBforPostgreSQL/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyOperationResults** |  |
> | 작업 | DBforPostgreSQL/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/securityAlertPoliciesAzureAsyncOperation** |  |
> | 작업 | DBforPostgreSQL/위치/securityAlertPoliciesAzureAsyncOperation/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/securityAlertPoliciesOperationResults** |  |
> | 작업 | DBforPostgreSQL/위치/securityAlertPoliciesOperationResults/읽기 | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> |  | **위치/serverKeyAzureAsyncOperation** |  |
> | 작업 | DBforPostgreSQL/위치/serverKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **위치/serverKeyOperationResults** |  |
> | 작업 | DBforPostgreSQL/위치/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | DBforPostgreSQL/작업/읽기 | PostgreSQL 작업의 목록을 반환 합니다. |
> |  | **performanceTiers** |  |
...
> | 작업 | DBforPostgreSQL/서버/다시 시작/작업 | 특정 서버를 다시 시작 합니다. |
> | 작업 | Microsoft.DBforPostgreSQL/servers/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> |  | **servers/administrators** |  |
> | 작업 | DBforPostgreSQL/servers/administrators/read | PostgreSQL 서버 관리자의 목록을 가져옵니다. |
> | 작업 | DBforPostgreSQL/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 PostgreSQL 서버 관리자를 만들거나 업데이트 합니다. |
> | 작업 | DBforPostgreSQL/servers/administrators/delete | PostgreSQL 서버의 기존 관리자를 삭제 합니다. |
> |  | **servers/advisors** |  |
...
> |  | **servers/databases** |  |
> | 작업 | DBforPostgreSQL/서버/데이터베이스/읽기 | PostgreSQL 데이터베이스의 목록을 반환 하거나 지정 된 데이터베이스에 대 한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/servers/databases/write | 지정 된 매개 변수를 사용 하 여 PostgreSQL 데이터베이스를 만들거나 지정 된 데이터베이스에 대 한 속성을 업데이트 합니다. |
> | 작업 | DBforPostgreSQL/서버/데이터베이스/삭제 | 기존 PostgreSQL 데이터베이스를 삭제 합니다. |
> |  | **servers/firewallRules** |  |
...
> |  | **servers/keys** |  |
> | 작업 | DBforPostgreSQL/서버/키/읽기 | 서버 키 목록을 가져오거나 지정된 서버 키에 대한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/servers/keys/write | 지정된 매개 변수를 사용하여 키를 만들거나 지정된 서버 키에 대한 속성 또는 태그를 업데이트합니다. |
> | 작업 | DBforPostgreSQL/servers/keys/delete | 기존 서버 키를 삭제합니다. |
> |  | **서버/logFiles** |  |
> | 작업 | DBforPostgreSQL/servers/logFiles/read | PostgreSQL LogFiles의 목록을 반환 합니다. |
> |  | **servers/privateEndpointConnectionProxies** |  |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **servers/privateEndpointConnections** |  |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 작업 | DBforPostgreSQL/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> |  | **servers/privateLinkResources** |  |
> | 작업 | DBforPostgreSQL/servers/privateLinkResources/read | 해당 PostgreSQL 서버에 대 한 개인 링크 리소스를 가져옵니다. |
> |  | **서버/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **서버/공급자/s a t e r/logDefinitions** |  |
> | 작업 | Microsoft.DBforPostgreSQL/servers/providers/Microsoft.Insights/logDefinitions/read | PostgreSQL 서버에 대해 사용 가능한 로그를 가져옵니다. |
> |  | **서버/공급자/Microsoft metricDefinitions/** |  |
> | 작업 | Microsoft.DBforPostgreSQL/servers/providers/Microsoft.Insights/metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> |  | **servers/queryTexts** |  |
> | 작업 | DBforPostgreSQL/servers/queryTexts/읽기 | 쿼리 목록의 텍스트 반환 |
> |  | **servers/recoverableServers** |  |
> | 작업 | Microsoft.DBforPostgreSQL/servers/recoverableServers/read | 복구 가능한 PostgreSQL 서버 정보를 반환합니다. |
> |  | **서버/복제본** |  |
> | 작업 | DBforPostgreSQL/servers/복제본/읽기 | PostgreSQL 서버의 읽기 복제본 가져오기 |
> |  | **servers/securityAlertPolicies** |  |
...
> |  | **serversv2** |  |
> | 작업 | DBforPostgreSQL/serversv2/읽기 | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/serversv2/write | 지정된 매개 변수를 사용하여 서버를 만들거나 지정된 서버에 대한 속성 또는 태그를 업데이트합니다. |
> | 작업 | DBforPostgreSQL/serversv2/delete | 기존 서버를 삭제합니다. |
> | 작업 | DBforPostgreSQL/serversv2/updateConfigurations/action | 지정된 서버의 구성을 업데이트합니다. |
> |  | **serversv2/구성** |  |
> | 작업 | DBforPostgreSQL/serversv2/구성/읽기 | 서버에 대한 구성 목록을 반환하거나 지정된 구성에 대한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/serversv2/구성/쓰기 | 지정된 구성의 값을 업데이트합니다. |
> |  | **serversv2/firewallRules** |  |
> | 작업 | DBforPostgreSQL/serversv2/firewallRules/read | 서버에 대한 방화벽 규칙 목록을 반환하거나 지정된 방화벽 규칙에 대한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/serversv2/firewallRules/write | 지정된 매개 변수를 사용하여 방화벽 규칙을 만들거나 기존 규칙을 업데이트합니다. |
> | 작업 | DBforPostgreSQL/serversv2/firewallRules/delete | 기존 방화벽 규칙을 삭제합니다. |
> |  | **serversv2/providers/diagnosticSettings** |  |
> | 작업 | DBforPostgreSQL/serversv2/providers//diagnosticSettings/read | 리소스에 대한 진단 설정을 가져옵니다. |
> | 작업 | DBforPostgreSQL/serversv2/providers//diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> |  | **serversv2/providers/Microsoft. Insights/logDefinitions** |  |
> | 작업 | DBforPostgreSQL/serversv2/providers/Microsoft. Insights/logDefinitions/읽기 | PostgreSQL 서버에 대해 사용 가능한 로그를 가져옵니다. |
> |  | **serversv2/providers/metricDefinitions** |  |
> | 작업 | DBforPostgreSQL/serversv2/providers//metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> |  | **singleservers** |  |
> | 작업 | DBforPostgreSQL/singleservers/읽기 | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
> | 작업 | DBforPostgreSQL/singleservers/write | 지정된 매개 변수를 사용하여 서버를 만들거나 지정된 서버에 대한 속성 또는 태그를 업데이트합니다. |
> | 작업 | DBforPostgreSQL/singleservers/delete | 기존 서버를 삭제합니다. |
> |  | **singleservers/providers/diagnosticSettings** |  |
> | 작업 | DBforPostgreSQL/singleservers/providers//diagnosticSettings/read | 리소스에 대한 진단 설정을 가져옵니다. |
> | 작업 | DBforPostgreSQL/singleservers/providers//diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> |  | **singleservers/providers/Microsoft. Insights/logDefinitions** |  |
> | 작업 | DBforPostgreSQL/singleservers/providers/Microsoft. Insights/logDefinitions/읽기 | PostgreSQL 서버에 대해 사용 가능한 로그를 가져옵니다. |
> |  | **singleservers/providers/metricDefinitions** |  |
> | 작업 | DBforPostgreSQL/singleservers/providers//metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
...
> | 작업 | Microsoft.Devices/checkProvisioningServiceNameAvailability/Action | 프로비전 서비스 이름을 사용할 수 있는지 확인합니다. |
> | 작업 | Microsoft.Devices/register/action | IotHub 리소스 공급자에 대한 구독을 등록하고 IotHub 리소스를 만들도록 설정합니다. |
> |  | **계정/diagnosticSettings** |  |
> | 작업 | Microsoft. 장치/계정/diagnosticSettings/읽기 | 리소스에 대한 진단 설정을 가져옵니다. |
> | 작업 | Microsoft. 장치/계정/diagnosticSettings/쓰기 | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
> |  | **계정/로그 정의** |  |
> | 작업 | Microsoft. 장치/계정/s i d 정의/읽기 | IotHub 서비스에 사용 가능한 로그 정의를 가져옵니다. |
> |  | **계정/metricDefinitions** |  |
> | 작업 | Microsoft. 장치/계정/metricDefinitions/읽기 | IotHub 서비스에 대해 사용 가능한 메트릭을 가져옵니다. |
> |  | **digitalTwins** |  |
> | 작업 | Microsoft. 장치/digitalTwins/읽기 | 구독과 연결 된 디지털 Twins 계정의 목록을 가져옵니다. |
> | 작업 | Microsoft. Devices/digitalTwins/Write | 새 Digitial Twins 계정 만들기 |
> | 작업 | Microsoft. Devices/digitalTwins/Delete | 기존 디지털 쌍 계정과 모든 자식을 삭제 합니다. |
> |  | **digitalTwins/operationresults** |  |
> | 작업 | Microsoft. Devices/digitalTwins/operationresults/Read | 디지털 쌍 계정에 대해 작업 상태 가져오기 |
> |  | **digitalTwins/sku** |  |
> | 작업 | Microsoft. Devices/digitalTwins/sku/읽기 | 디지털 쌍 계정에 대 한 유효한 Sku 목록 가져오기 |
...
> | 작업 | Microsoft. Devices/elasticPools/eventGridFilters/Write | 새로 만들거나 기존 Elastic Pool Event Grid 필터를 업데이트 합니다. |
> | 작업 | Microsoft. Devices/elasticPools/eventGridFilters/Read | Elastic Pool Event Grid 필터를 가져옵니다. |
> | 작업 | Microsoft. Devices/elasticPools/eventGridFilters/Delete | Elastic Pool Event Grid 필터를 삭제 합니다. |
...
> |  | **elasticPools/iotHubTenants/certificate** |  |
...
> |  | **elasticPools/iotHubTenants/라우팅/경로** |  |
...
> | 작업 | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/Write | Iot 테 넌 트 허브에서 Azure Security Center 설정 업데이트 |
> | 작업 | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/Read | Iot 테 넌 트 허브에서 Azure Security Center 설정 가져오기 |
> |  | **elasticPools/iotHubTenants/securitySettings/operationResults** |  |
> | 작업 | Microsoft. Devices/elasticPools/iotHubTenants/securitySettings/operationResults/Read | Iot 테 넌 트 허브 보안 설정에 대 한 비동기 Put 작업의 결과를 가져옵니다. |
...
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnectionsApproval/Action | 개인 끝점 연결 승인 또는 거부 |
> |  | **iotHubs/인증서** |  |
...
> | 작업 | Microsoft. Devices/iotHubs/digitalTwinsLinks/Write |  |
> | 작업 | Microsoft. Devices/iotHubs/digitalTwinsLinks/Read |  |
> | 작업 | Microsoft. Devices/iotHubs/digitalTwinsLinks/Delete |  |
...
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/validate/Action | 만드는 동안 개인 끝점 연결 프록시 입력의 유효성을 검사 합니다. |
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Read | 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Write | 개인 끝점 연결 프록시를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnectionProxies/Delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
...
> | 작업 | Microsoft. Devices/iotHubs/privateEndpointConnections/operationResults/Read | 개인 끝점 연결에 대 한 비동기 작업의 결과를 가져옵니다. |
> |  | **iotHubs/privateLinkResources** |  |
> | 작업 | Microsoft. Devices/iotHubs/privateLinkResources/Read | IotHub에 대 한 개인 링크 리소스를 가져옵니다. |
...
> | 작업 | Microsoft. Devices/iotHubs/securitySettings/Write | Iot Hub에서 Azure Security Center 설정 업데이트 |
> | 작업 | Microsoft. Devices/iotHubs/securitySettings/Read | Iot Hub에서 Azure Security Center 설정 가져오기 |
> |  | **iotHubs/securitySettings/operationResults** |  |
> | 작업 | Microsoft. Devices/iotHubs/securitySettings/operationResults/Read | Iot Hub SecuritySettings에 대 한 비동기 Put 작업의 결과를 가져옵니다. |
> |  | **iotHubs/sku** |  |
...
> |  | **위치도** |  |
> | 작업 | Microsoft DevSpaces/위치/checkContainerHostMapping/작업 | 컨테이너 호스트에 대 한 기존 컨트롤러 매핑 확인 |
> |  | **위치/checkContainerHostMapping** |  |
> | 작업 | Microsoft DevSpaces/위치/checkContainerHostMapping/읽기 | 컨테이너 호스트에 대 한 기존 컨트롤러 매핑 확인 |
> |  | **위치/operationresults** |  |
> | 작업 | Microsoft. DevSpaces/위치/operationresults/read | 비동기 작업의 상태를 읽습니다. |
...
> | 작업 | Microsoft DevTestLab/labs/EnsureCurrentUserProfile/action | 현재 사용자가 랩에서 유효한 프로필을 갖고 있는지 확인 합니다. |
> |  | **랩/artifactSources** |  |
...
> |  | **랩/artifactSources/armTemplates** |  |
> | 작업 | Microsoft.DevTestLab/labs/artifactSources/armTemplates/read | Azure Resource Manager 템플릿을 읽습니다. |
> |  | **랩/artifactSources/아티팩트** |  |
> | 작업 | Microsoft.DevTestLab/labs/artifactSources/artifacts/read | 아티팩트를 읽습니다. |
> | 작업 | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | 지정 된 아티팩트에 대 한 Azure Resource Manager 템플릿을 생성 하 고, 필요한 파일을 저장소 계정에 업로드 하 고, 생성 된 아티팩트의 유효성을 검사 합니다. |
> |  | **labs/costs** |  |
...
> |  | **랩/notificationChannels** |  |
> | 작업 | Microsoft.DevTestLab/labs/notificationChannels/delete | 알림 채널을 삭제 합니다. |
> | 작업 | Microsoft.DevTestLab/labs/notificationChannels/read | 알림 채널을 읽습니다. |
> | 작업 | Microsoft.DevTestLab/labs/notificationChannels/write | 알림 채널을 추가 하거나 수정 합니다. |
...
> |  | **랩/sharedGalleries** |  |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/delete | 공유 갤러리를 삭제 합니다. |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/읽기 | 공유 갤러리를 읽습니다. |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/write | 공유 갤러리를 추가 하거나 수정 합니다. |
> |  | **labs/sharedGalleries/Shareages Ages** |  |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/sharedImages/delete | 공유 이미지를 삭제 합니다. |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/sharedImages/read | 공유 이미지를 읽습니다. |
> | 작업 | Microsoft. DevTestLab/labs/sharedGalleries/sharedImages/write | 공유 이미지를 추가 하거나 수정 합니다. |
> |  | **labs/users** |  |
...
> | 작업 | Microsoft DevTestLab/labs/virtualMachines/ClearArtifactResults/작업 | 가상 컴퓨터의 아티팩트 결과를 지웁니다. |
...
> | 작업 | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/delete | Bastionhosts를 삭제 합니다. |
> | 작업 | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/read | Bastionhosts을 읽습니다. |
> | 작업 | Microsoft. DevTestLab/labs/virtualNetworks/bastionHosts/write | Bastionhosts를 추가 하거나 수정 합니다. |
> |  | **labs/vmPools** |  |
...
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 데이터베이스를 만드세요. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 데이터베이스를 읽거나 모든 데이터베이스를 나열 하십시오. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/delete | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 데이터베이스를 삭제 하세요. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/databases/collections** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컬렉션을 만들거나 업데이트 하세요. API 형식에만 적용 됩니다. ' mongodb '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컬렉션을 읽거나 모든 컬렉션을 나열 하세요. API 형식에만 적용 됩니다. ' mongodb '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/delete | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컬렉션을 삭제 하세요. API 형식에만 적용 됩니다. ' mongodb '. |
> |  | **databaseAccounts/api/databases/collections/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' mongodb '. |
> |  | **databaseAccounts/api/데이터베이스/컬렉션/설정** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컬렉션 처리량을 업데이트 하십시오. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컬렉션 처리량을 읽어 보세요. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/databases/collections/settings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/collections/settings/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' mongodb '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/컨테이너** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/쓰기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컨테이너를 만들거나 업데이트 하세요. ' Sql ' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/읽기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컨테이너를 읽거나 모든 컨테이너를 나열 하세요. ' Sql ' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/삭제 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컨테이너를 삭제 하세요. ' Sql ' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/databases/컨테이너/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Sql ' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/컨테이너/설정** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/쓰기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컨테이너 처리량을 업데이트 하십시오. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/읽기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 컨테이너 처리량을 읽어 보세요. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/컨테이너/설정/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/컨테이너/설정/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/그래프** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/쓰기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 그래프를 만들거나 업데이트 하세요. API 형식에만 적용 됩니다. ' gremlin'. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/읽기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 그래프를 읽거나 모든 그래프를 나열 하세요. API 형식에만 적용 됩니다. ' gremlin'. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/삭제 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 그래프를 삭제 하세요. API 형식에만 적용 됩니다. ' gremlin'. |
> |  | **databaseAccounts/api/데이터베이스/그래프/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' gremlin'. |
> |  | **databaseAccounts/api/데이터베이스/그래프/설정** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/쓰기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 그래프 처리량을 업데이트 하세요. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/읽기 | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 그래프 처리량을 읽어 보세요. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/그래프/설정/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/데이터베이스/그래프/설정/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' gremlin'. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/databases/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/데이터베이스/설정** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/settings/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 데이터베이스 처리량을 업데이트 하십시오. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/settings/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 데이터베이스 처리량을 읽어 보세요. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/databases/settings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/databases/settings/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/keyspaces** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 keyspace를 만드세요. API 형식에만 적용 됩니다. ' cassandra '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 keyspace을 읽거나 모든 keyspaces를 나열 하세요. API 형식에만 적용 됩니다. ' cassandra '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/delete | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 keyspace를 삭제 하세요. API 형식에만 적용 됩니다. ' cassandra '. |
> |  | **databaseAccounts/api/keyspaces/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' cassandra '. |
> |  | **databaseAccounts/api/keyspaces/settings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 keyspace 처리량을 업데이트 하세요. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 keyspace 처리량을 읽어 보세요. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/keyspaces/settings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/settings/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/keyspaces/tables** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 만들거나 업데이트 하세요. API 형식에만 적용 됩니다. ' cassandra '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 읽거나 모든 테이블을 나열 하십시오. API 형식에만 적용 됩니다. ' cassandra '. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/delete | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 삭제 하십시오. API 형식에만 적용 됩니다. ' cassandra '. |
> |  | **databaseAccounts/api/keyspaces/tables/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' cassandra '. |
> |  | **databaseAccounts/api/keyspaces/tables/settings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블 처리량을 업데이트 하십시오. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블 처리량을 읽어 보세요. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/keyspaces/tables/settings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/keyspaces/tables/settings/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/테이블** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 만들거나 업데이트 하세요. ' Table ' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 읽거나 모든 테이블을 나열 하십시오. ' Table ' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/delete | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블을 삭제 하십시오. ' Table ' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/tables/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Table ' API 유형에만 적용 됩니다. |
> |  | **databaseAccounts/api/테이블/설정** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/settings/write | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블 처리량을 업데이트 하십시오. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/settings/read | (사용되지 않음, '/Apis/' 세그먼트 없이 리소스 경로를 사용 하 여 테이블 처리량을 읽어 보세요. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/api/tables/settings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/api/tables/settings/operationResults/read | (사용되지 않음, 비동기 작업의 읽기 상태는 '/apis/' 세그먼트 없이 리소스 경로를 사용 하세요. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> |  | **databaseAccounts/cassandraKeyspaces** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/write | Cassandra keyspace를 만듭니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/read | Cassandra keyspace을 읽거나 모든 Cassandra keyspaces를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/delete | Cassandra keyspace를 삭제 합니다. |
> |  | **databaseAccounts/cassandraKeyspaces/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/cassandraKeyspaces/tables** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/write | Cassandra 테이블을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/read | Cassandra 테이블을 읽거나 모든 Cassandra 테이블을 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/delete | Cassandra 테이블을 삭제 합니다. |
> |  | **databaseAccounts/cassandraKeyspaces/tables/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/cassandraKeyspaces/tables/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/write | Cassandra 테이블 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/read | Cassandra 테이블 처리량을 읽습니다. |
> |  | **databaseAccounts/cassandraKeyspaces/tables/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/tables/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/cassandraKeyspaces/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/write | Cassandra keyspace 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/read | Cassandra keyspace 처리량을 읽습니다. |
> |  | **databaseAccounts/cassandraKeyspaces/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/cassandraKeyspaces/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
...
> |  | **databaseAccounts/databases/collections/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/databases/collections/metrics/read | 컬렉션 메트릭을 읽습니다. |
> |  | **databaseAccounts/databases/collections/partitionKeyRangeId/메트릭** |  |
...
> |  | **databaseAccounts/데이터베이스/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/databases/metrics/read | 데이터베이스 메트릭을 읽습니다. |
> |  | **databaseAccounts/databases/사용법** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/databases/usages/read | 데이터베이스 사용 현황을 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/write | Gremlin 데이터베이스를 만듭니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/read | Gremlin 데이터베이스를 읽거나 모든 Gremlin 데이터베이스를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/delete | Gremlin 데이터베이스를 삭제 합니다. |
> |  | **databaseAccounts/gremlinDatabases/graph** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/write | Gremlin graph를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/read | Gremlin 그래프를 읽거나 모든 Gremlin 그래프를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/delete | Gremlin 그래프를 삭제 합니다. |
> |  | **databaseAccounts/gremlinDatabases/graph/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases/graph/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/throughputSettings/write | Gremlin graph 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/throughputSettings/read | Gremlin graph 처리량을 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases/graph/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/graph/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/write | Gremlin 데이터베이스 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/read | Gremlin 데이터베이스 처리량을 읽습니다. |
> |  | **databaseAccounts/gremlinDatabases/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/gremlinDatabases/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/metricDefinitions** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/metricDefinitions/read | 데이터베이스 계정 메트릭 정의를 읽습니다. |
> |  | **databaseAccounts/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/metrics/read | 데이터베이스 계정 메트릭을 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/write | MongoDB 데이터베이스를 만듭니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/read | MongoDB 데이터베이스를 읽거나 모든 MongoDB 데이터베이스를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/delete | MongoDB 데이터베이스를 삭제 합니다. |
> |  | **databaseAccounts/mongodbDatabases/collections** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/write | MongoDB 컬렉션을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/read | MongoDB 컬렉션을 읽거나 모든 MongoDB 컬렉션을 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/delete | MongoDB 컬렉션을 삭제 합니다. |
> |  | **databaseAccounts/mongodbDatabases/collections/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases/collections/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/write | MongoDB 컬렉션 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/read | MongoDB 컬렉션 처리량을 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases/collections/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/collections/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/write | MongoDB 데이터베이스 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/read | MongoDB 데이터베이스 처리량을 읽습니다. |
> |  | **databaseAccounts/mongodbDatabases/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/notebookWorkspaces** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/notebookWorkspaces/write | 노트북 작업 영역 만들기 또는 업데이트 |
> | 작업 | Microsoft DocumentDB/databaseAccounts/notebookWorkspaces/read | 노트북 작업 영역 읽기 |
> | 작업 | Microsoft DocumentDB/databaseAccounts/notebookWorkspaces/delete | 노트북 작업 영역 삭제 |
> | 작업 | Microsoft DocumentDB/databaseAccounts/notebookWorkspaces/listConnectionInfo/action | 노트북 작업 영역에 대 한 연결 정보 나열 |
> |  | **databaseAccounts/notebookWorkspaces/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/notebookWorkspaces/operationResults/read | 노트북 작업 영역에 대 한 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/operationResults** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/operationResults/read | 비동기 작업 상태를 읽습니다. |
> |  | **databaseAccounts/백분위 수** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/percentile/read | 복제 대기 시간의 백분위 수를 읽습니다. |
> |  | **databaseAccounts/백분위 수/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/percentile/metrics/read | 대기 시간 메트릭을 읽습니다. |
> |  | **databaseAccounts/백분위 수/sourceRegion/targetRegion/메트릭** |  |
...
> |  | **databaseAccounts/백분위 수/targetRegion/메트릭** |  |
...
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/read | 데이터베이스 계정의 개인 끝점 연결 프록시 읽기 |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/write | 데이터베이스 계정의 개인 끝점 연결 프록시를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/delete | 데이터베이스 계정의 개인 끝점 연결 프록시를 삭제 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/validate/action | 데이터베이스 계정의 개인 끝점 연결 프록시 유효성 검사 |
> |  | **databaseAccounts/privateEndpointConnectionProxies/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnectionProxies/operationResults/read | 개인 끝점 연결 프록시 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/privateEndpointConnections** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnections/read | 개인 끝점 연결을 읽거나 데이터베이스 계정의 모든 개인 끝점 연결을 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnections/write | 데이터베이스 계정의 개인 끝점 연결을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnections/delete | 데이터베이스 계정의 개인 끝점 연결 삭제 |
> |  | **databaseAccounts/privateEndpointConnections/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateEndpointConnections/operationResults/read | PrivateEndpointConnenctions 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/privateLinkResources** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/privateLinkResources/read | 개인 링크 리소스를 읽거나 데이터베이스 계정의 모든 개인 링크 리소스를 나열 합니다. |
> |  | **databaseAccounts/readonlykeys** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/readonlykeys/read | 데이터베이스 계정 읽기 전용 키를 읽습니다. |
> |  | **databaseAccounts/지역/데이터베이스/컬렉션/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/region/databases/collections/metrics/read | 지역 컬렉션 메트릭을 읽습니다. |
> |  | **databaseAccounts/region/databases/collections/partitionKeyRangeId/메트릭** |  |
...
> |  | **databaseAccounts/region/메트릭** |  |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/region/metrics/read | 지역 및 데이터베이스 계정 메트릭을 읽습니다. |
> |  | **databaseAccounts/sqlDatabases** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/write | SQL 데이터베이스를 만듭니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/read | SQL 데이터베이스를 읽거나 모든 SQL 데이터베이스를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/delete | SQL 데이터베이스를 삭제 합니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/쓰기 | SQL 컨테이너를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/읽기 | SQL 컨테이너를 읽거나 모든 SQL 컨테이너를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/삭제 | SQL 컨테이너를 삭제 합니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/storedProcedures** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/storedProcedures/write | SQL 저장 프로시저를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/storedProcedures/read | SQL 저장 프로시저를 읽거나 모든 SQL 저장 프로시저를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/storedProcedures/delete | SQL 저장 프로시저를 삭제 합니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/storedProcedures/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/storedProcedures/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/throughputSettings/write | SQL 컨테이너 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/throughputSettings/read | SQL 컨테이너 처리량을 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/트리거** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/트리거/쓰기 | SQL 트리거를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/트리거/읽기 | SQL 트리거를 읽거나 모든 SQL 트리거를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/트리거/삭제 | SQL 트리거를 삭제 합니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/트리거/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/트리거/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions/write | SQL 사용자 정의 함수를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions/read | SQL 사용자 정의 함수를 읽거나 모든 SQL 사용자 정의 함수를 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions/delete | SQL 사용자 정의 함수를 삭제 합니다. |
> |  | **databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/컨테이너/userDefinedFunctions/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/write | SQL database 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/read | SQL database 처리량을 읽습니다. |
> |  | **databaseAccounts/sqlDatabases/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/sqlDatabases/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/tables** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/write | 테이블을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/read | 테이블을 읽거나 모든 테이블을 나열 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/delete | 테이블을 삭제 합니다. |
> |  | **databaseAccounts/tables/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/tables/throughputSettings** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/throughputSettings/write | 테이블 처리량을 업데이트 합니다. |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/throughputSettings/read | 테이블 처리량을 읽습니다. |
> |  | **databaseAccounts/tables/throughputSettings/operationResults** |  |
> | 작업 | Microsoft DocumentDB/databaseAccounts/tables/throughputSettings/operationResults/read | 비동기 작업의 상태를 읽습니다. |
> |  | **databaseAccounts/사용법** |  |
...
> |  | **위치/deleteVirtualNetworkOrSubnets/operationResults** |  |
...
> |  | **위치/operationsStatus** |  |
> | 작업 | Microsoft DocumentDB/위치/operationsStatus/읽기 | 비동기 작업의 상태를 읽습니다. |
> |  | **operationResults** |  |
...
> |  | **도메인/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnectionProxies/validate/action | 도메인에 대 한 PrivateEndpointConnectionProxies 유효성 검사 |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnectionProxies/read | 도메인에 대 한 PrivateEndpointConnectionProxies 읽기 |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnectionProxies/write | 도메인에 대 한 PrivateEndpointConnectionProxies 쓰기 |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnectionProxies/delete | 도메인에 대 한 PrivateEndpointConnectionProxies 삭제 |
> |  | **도메인/privateEndpointConnections** |  |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnections/read | 도메인에 대 한 PrivateEndpointConnections 읽기 |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnections/write | 도메인에 대 한 PrivateEndpointConnections 쓰기 |
> | 작업 | Microsoft EventGrid/domains/privateEndpointConnections/delete | 도메인에 대 한 PrivateEndpointConnections 삭제 |
...
> | 작업 | Microsoft EventGrid/도메인/토픽/쓰기 | 도메인 항목 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/도메인/항목/삭제 | 도메인 항목 삭제 |
> |  | **eventSubscriptions** |  |
> | 작업 | Microsoft.EventGrid/eventSubscriptions/write | EventSubscription 만들기 또는 업데이트 |
> | 작업 | Microsoft.EventGrid/eventSubscriptions/read | EventSubscription 읽기 |
> | 작업 | Microsoft.EventGrid/eventSubscriptions/delete | EventSubscription 삭제 |
> | 작업 | Microsoft.EventGrid/eventSubscriptions/getFullUrl/action | 이벤트 구독의 전체 url을 가져옵니다. |
> |  | **eventSubscriptions/providers/diagnosticSettings/Microsoft** |  |
...
> |  | **eventSubscriptions/providers/metricDefinitions/Microsoft** |  |
...
> |  | **extensionTopics/공급자/Microsoft Insights/diagnosticSettings** |  |
...
> |  | **extensionTopics/공급자/Microsoft Insights/metricDefinitions** |  |
...
> |  | **위치/topictypes/eventSubscriptions** |  |
...
> |  | **네임 스페이스** |  |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/쓰기 | 파트너 네임 스페이스 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/추가 네임 스페이스/읽기 | 파트너 네임 스페이스 읽기 |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/삭제 | 파트너 네임 스페이스 삭제 |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/listKeys/action | 파트너 네임 스페이스의 키를 나열 합니다. |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/regenerateKey/작업 | 파트너 네임 스페이스에 대 한 키 다시 생성 |
> |  | **네임 스페이스/a s p 채널** |  |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/read | 이벤트 채널 읽기 |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/write | 이벤트 채널 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/delete | 이벤트 채널 삭제 |
> |  | **파트너 등록** |  |
> | 작업 | Microsoft EventGrid/함께 등록/쓰기 | 파트너 등록 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/함께 등록/읽기 | 파트너 등록 읽기 |
> | 작업 | Microsoft EventGrid/함께 등록/삭제 | 파트너 등록 삭제 |
> |  | **항목 항목** |  |
> | 작업 | Microsoft EventGrid/관련 항목/읽기 | 파트너 항목 읽기 |
> | 작업 | Microsoft EventGrid/관련 항목/쓰기 | 파트너 항목 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/관련 항목/삭제 | 파트너 항목 삭제 |
> | 작업 | Microsoft EventGrid/제품 토픽/활성화/작업 | 파트너 활성화 항목 |
> | 작업 | Microsoft EventGrid/항목 토픽/비활성화/작업 | 파트너 비활성화 항목 |
> |  | **sku** |  |
> | 작업 | Microsoft EventGrid/sku/읽기 | Event grid 리소스에 대해 사용 가능한 Sku 정의 읽기 |
> |  | **systemTopics** |  |
> | 작업 | Microsoft EventGrid/systemTopics/읽기 | 시스템 항목 읽기 |
> | 작업 | Microsoft EventGrid/systemTopics/쓰기 | 시스템 항목 만들기 또는 업데이트 |
> | 작업 | Microsoft EventGrid/systemTopics/delete | 시스템 항목 삭제 |
> |  | **systemTopics/공급자/Microsoft Insights/diagnosticSettings** |  |
...
> |  | **토픽/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnectionProxies/validate/action | PrivateEndpointConnectionProxies 유효성 검사 항목 |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnectionProxies/read | 항목에 대 한 PrivateEndpointConnectionProxies 읽기 |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnectionProxies/write | 항목에 대 한 PrivateEndpointConnectionProxies 쓰기 |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnectionProxies/delete | 항목에 대 한 PrivateEndpointConnectionProxies 삭제 |
> |  | **토픽/privateEndpointConnections** |  |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnections/read | 항목에 대 한 PrivateEndpointConnections 읽기 |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnections/write | 항목에 대 한 PrivateEndpointConnections 쓰기 |
> | 작업 | Microsoft EventGrid/토픽/privateEndpointConnections/delete | 항목에 대 한 PrivateEndpointConnections 삭제 |
> |  | **토픽/privateLinkResources** |  |
> | 작업 | Microsoft EventGrid/토픽/privateLinkResources/read | 항목에 대 한 PrivateLinkResources 읽기 |
> |  | **토픽/공급자/Microsoft diagnosticSettings/** |  |
...
> | 작업 | Microsoft EventHub/availableClusterRegions/read | Azure 지역에서 사용 가능한 미리 프로 비전 된 클러스터를 나열 하는 읽기 작업입니다. |
> |  | **클러스터** |  |
> | 작업 | Microsoft.EventHub/clusters/read | 클러스터 리소스 설명을 가져옵니다. |
> | 작업 | Microsoft.EventHub/clusters/write | 기존 클러스터 리소스를 만들거나 수정 합니다. |
> | 작업 | Microsoft EventHub/클러스터/삭제 | 기존 클러스터 리소스를 삭제 합니다. |
> |  | **클러스터/네임 스페이스** |  |
> | 작업 | Microsoft. EventHub/클러스터/네임 스페이스/읽기 | 클러스터 내의 네임 스페이스에 대 한 네임 스페이스 Azure Resource Manager Id를 나열 합니다. |
> |  | **클러스터/operationresults** |  |
> | 작업 | Microsoft EventHub/클러스터/operationresults/read | 비동기 클러스터 작업의 상태를 가져옵니다. |
> |  | **클러스터/공급자/Microsoft metricDefinitions/** |  |
...
> |  | **네임 스페이스/disasterrecoveryconfigs** |  |
...
> |  | **네임 스페이스/disasterRecoveryConfigs/authorizationRules** |  |
...
> |  | **네임 스페이스/eventHubs/consumergroups** |  |
...
> |  | **네임 스페이스/네트워크 규칙 집합** |  |
> | 작업 | Microsoft. EventHub/네임 스페이스/networkruleset 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 작업 | Microsoft. EventHub/네임 스페이스/networkruleset 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 작업 | Microsoft. EventHub/네임 스페이스/networkruleset 집합/삭제 | VNET 규칙 리소스 삭제 |
> |  | **네임 스페이스/네트워크 규칙 집합** |  |
> | 작업 | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 작업 | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 작업 | Microsoft. EventHub/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
> |  | **네임 스페이스/operationresults** |  |
> | 작업 | Microsoft.EventHub/namespaces/operationresults/read | 네임스페이스 작업의 상태를 가져옵니다. |
> |  | **네임 스페이스/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft EventHub/네임 스페이스/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 프록시 유효성 검사 |
> | 작업 | Microsoft. EventHub/네임 스페이스/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | 작업 | Microsoft. EventHub/네임 스페이스/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 |
> | 작업 | Microsoft. EventHub/네임 스페이스/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시 삭제 |
> |  | **네임 스페이스/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **네임 스페이스/메시지** |  |
> | DataAction | Microsoft. EventHub/네임 스페이스/메시지/송신/동작 | 메시지 보내기 |
> | DataAction | Microsoft. EventHub/네임 스페이스/메시지/수신/동작 | 메시지 받기 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | GuestConfiguration/register/action | GuestConfiguration 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | 작업 | GuestConfiguration/guestConfigurationAssignments/delete | 게스트 구성 할당을 삭제 합니다. |
> |  | **guestConfigurationAssignments/보고서** |  |
> | 작업 | Microsoft.GuestConfiguration/guestConfigurationAssignments/reports/read | 게스트 구성 할당 보고서를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | GuestConfiguration/작업/읽기 | GuestConfiguration 리소스 공급자에 대 한 작업을 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft HDInsight/register/action | 구독에 대 한 HDInsight 리소스 공급자 등록 |
> | 작업 | Microsoft HDInsight/등록 취소/작업 | 구독에 대 한 HDInsight 리소스 공급자 등록 취소 |
> |  | **클러스터** |  |
...
> | 작업 | Microsoft HDInsight/클러스터/getGatewaySettings/작업 | HDInsight 클러스터에 대 한 게이트웨이 설정 가져오기 |
> | 작업 | Microsoft HDInsight/클러스터/updateGatewaySettings/action | HDInsight 클러스터에 대 한 게이트웨이 설정 업데이트 |
...
> |  | **클러스터/확장** |  |
> | 작업 | Microsoft HDInsight/클러스터/확장/쓰기 | HDInsight 클러스터에 대 한 클러스터 확장 만들기 |
> | 작업 | Microsoft HDInsight/클러스터/확장/읽기 | HDInsight 클러스터에 대 한 클러스터 확장 가져오기 |
> | 작업 | Microsoft HDInsight/클러스터/확장/삭제 | HDInsight 클러스터에 대 한 클러스터 확장 삭제 |
> |  | **클러스터/공급자/Microsoft diagnosticSettings/** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | HybridCompute/register/action | HybridCompute 리소스 공급자에 대 한 구독을 등록 합니다. |
> | 작업 | HybridCompute/등록 취소/작업 | HybridCompute 리소스 공급자에 대 한 구독의 등록을 취소 합니다. |
> |  | **위치/operationresults** |  |
> | 작업 | HybridCompute/위치/operationresults/read | HybridCompute 리소스 공급자에 대 한 작업 상태를 읽습니다. |
> |  | **머신의** |  |
> | 작업 | HybridCompute/컴퓨터/읽기 | 모든 Azure Arc 컴퓨터를 읽습니다. |
> | 작업 | HybridCompute/컴퓨터/쓰기 | Azure Arc 컴퓨터를 작성 합니다. |
> | 작업 | HybridCompute/컴퓨터/삭제 | Azure Arc 컴퓨터를 삭제 합니다. |
> | 작업 | HybridCompute/컴퓨터/다시 연결/작업 | Azure Arc 컴퓨터 다시 연결 |
> |  | **컴퓨터/확장** |  |
> | 작업 | HybridCompute/컴퓨터/확장/읽기 | 모든 Azure Arc 확장을 읽습니다. |
> | 작업 | HybridCompute/컴퓨터/확장/쓰기 | Azure Arc 확장을 설치 또는 업데이트 합니다. |
> | 작업 | HybridCompute/컴퓨터/확장/삭제 | Azure Arc 확장을 삭제 합니다. |
> |  | **작업도** |  |
> | 작업 | HybridCompute/작업/읽기 | 서버에 대 한 Azure Arc의 모든 작업 읽기 |
...
> |  | **작업도** |  |
> | 작업 | Microsoft. ImportExport/작업/읽기 | 리소스 공급자가 지 원하는 작업을 가져옵니다. |
...
> | 작업 | Microsoft Insights/Components/DailyCapReached/Action | Application Insights 구성 요소의 일일 상한에 도달 했습니다. |
> | 작업 | Microsoft Insights/Components/DailyCapWarningThresholdReached/Action | Application Insights 구성 요소에 대 한 일일 상한 경고 임계값에 도달 했습니다. |
...
> |  | **구성 요소/ProactiveDetectionConfigs** |  |
...
> |  | **구성 요소/공급자/Microsoft. Insights/diagnosticSettings** |  |
> | 작업 | Microsoft Insights/Components/providers/diagnosticSettings/Read | 리소스 진단 설정을 읽습니다. |
> | 작업 | Microsoft 인 사이트/구성 요소/공급자/Microsoft의 통찰력/diagnosticSettings/Write | 리소스 진단 설정을 만들거나 업데이트합니다. |
> |  | **구성 요소/공급자/Microsoft Insights/logDefinitions** |  |
> | 작업 | Microsoft Insights/Components/providers/Microsoft. Insights/logDefinitions/읽기 | 로그 정의 읽기 |
> |  | **구성 요소/공급자/Microsoft. Insights/MetricDefinitions** |  |
...
> |  | **구성 요소/SyntheticMonitorLocations** |  |
...
> | 작업 | Microsoft Insights/DataCollectionRuleAssociations/Read | 데이터 수집 규칙과 리소스의 연결 읽기 |
> | 작업 | Microsoft DataCollectionRuleAssociations/Write/Write | 데이터 수집 규칙을 사용 하 여 리소스의 연결 만들기 또는 업데이트 |
> | 작업 | DataCollectionRuleAssociations/삭제 | 데이터 수집 규칙과 리소스의 연결을 삭제 합니다. |
> |  | **DataCollectionRules** |  |
> | 작업 | Microsoft Insights/DataCollectionRules/Read | 데이터 수집 규칙 읽기 |
> | 작업 | Microsoft DataCollectionRules/Write/Write | 데이터 수집 규칙 만들기 또는 업데이트 |
> | 작업 | DataCollectionRules/삭제 | 데이터 수집 규칙 삭제 |
> |  | **DiagnosticSettings** |  |
...
> |  | **로그/테이블. 사용자 지정** |  |
> | 작업 | Microsoft Insights/Logs/Tables. 사용자 지정/읽기 | 사용자 지정 로그에서 데이터를 읽습니다. |
> |  | **로그/UAApp** |  |
...
> |  | **MetricBaselines** |  |
> | 작업 | Microsoft Insights/MetricBaselines/Read | 메트릭 기준 읽기 |
> |  | **MetricDefinitions** |  |
> | 작업 | Microsoft.Insights/MetricDefinitions/Read | 메트릭 정의 읽기 |
> |  | **MetricDefinitions/Microsoft** |  |
> | 작업 | Microsoft.Insights/MetricDefinitions/Microsoft.Insights/Read | 메트릭 정의 읽기 |
> |  | **MetricDefinitions/providers/Microsoft** |  |
> | 작업 | Microsoft.Insights/MetricDefinitions/providers/Microsoft.Insights/Read | 메트릭 정의 읽기 |
> |  | **Metricnamespaces** |  |
> | 작업 | Microsoft Insights/Metricnamespaces/Read | 메트릭 네임 스페이스 읽기 |
> |  | **메트릭** |  |
> | 작업 | Microsoft.Insights/Metrics/Read | 메트릭 읽기 |
> |  | **메트릭/Microsoft 정보** |  |
> | 작업 | Microsoft의 통찰력/메트릭/Microsoft. 통찰력/읽기 | 메트릭 읽기 |
> |  | **메트릭/공급자/메트릭** |  |
> | 작업 | Microsoft.Insights/Metrics/providers/Metrics/Read | 메트릭 읽기 |
> |  | **myWorkbooks** |  |
> | 작업 | Microsoft Insights/myWorkbooks 문서/쓰기 | 비공개 통합 문서 만들기 또는 업데이트 |
> | 작업 | Microsoft Insights/myWorkbooks 문서/읽기 | 비공개 통합 문서 읽기 |
> |  | **작업** |  |
> | 작업 | Microsoft.Insights/Operations/Read | 읽기 작업 |
> |  | **PrivateLinkScopeOperationStatuses** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopeOperationStatuses/Read | 개인 링크 범위 작업 상태를 읽습니다. |
> |  | **PrivateLinkScopes** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopes/Read | 개인 링크 범위 읽기 |
> | 작업 | Microsoft PrivateLinkScopes/Write/Write | 개인 링크 범위 만들기 또는 업데이트 |
> | 작업 | PrivateLinkScopes/삭제 | 개인 링크 범위 삭제 |
> |  | **PrivateLinkScopes/PrivateEndpointConnectionProxies** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Read | 개인 끝점 연결 프록시 읽기 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Write | 개인 끝점 연결 프록시 만들기 또는 업데이트 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Delete | 개인 끝점 연결 프록시를 삭제 합니다. |
> | 작업 | Microsoft. Insights/PrivateLinkScopes/PrivateEndpointConnectionProxies/Validate/Action | 개인 끝점 연결 프록시 유효성 검사 |
> |  | **PrivateLinkScopes/PrivateEndpointConnections** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Read | 개인 끝점 연결 읽기 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Write | 개인 끝점 연결 만들기 또는 업데이트 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateEndpointConnections/Delete | 개인 끝점 연결 삭제 |
> |  | **PrivateLinkScopes/PrivateLinkResources** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopes/PrivateLinkResources/Read | 개인 링크 리소스 읽기 |
> |  | **PrivateLinkScopes/ScopedResources** |  |
> | 작업 | Microsoft Insights/PrivateLinkScopes/ScopedResources/Read | 개인 링크 범위 리소스 읽기 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/ScopedResources/Write | 개인 링크 범위 리소스 만들기 또는 업데이트 |
> | 작업 | Microsoft Insights/PrivateLinkScopes/ScopedResources/Delete | 개인 링크 범위 리소스를 삭제 합니다. |
> |  | **ScheduledQueryRules** |  |
...
> |  | **통합 문서** |  |
> | 작업 | Microsoft Insights/통합 문서/쓰기 | 통합 문서 만들기 또는 업데이트 |
> | 작업 | Microsoft Insights/통합 문서/삭제 | 통합 문서 삭제 |
> | 작업 | Microsoft Insights/통합 문서/읽기 | 통합 문서 읽기 |
> |  | **DataCollectionRules/데이터** |  |
...
> | 작업 | Microsoft. IoTCentral/appTemplates/action | Azure IoT Central에서 사용 가능한 모든 응용 프로그램 템플릿을 가져옵니다. |
...
> |  | **자격 증명 모음/eventGridFilters** |  |
> | 작업 | Microsoft. KeyVault/자격 증명 모음/eventGridFilters | Key Vault에 대 한 EventGrid 구독을 표시 하 고 있음을 Microsoft. KeyVault에 알립니다. |
> | 작업 | Microsoft. KeyVault/Vault/eventGridFilters/write | Key Vault에 대 한 새 EventGrid 구독을 만들고 있음을 Microsoft. KeyVault에 알립니다. |
> | 작업 | Microsoft. KeyVault/자격 증명 모음/eventGridFilters/delete | Key Vault에 대 한 EventGrid 구독이 삭제 됨을 Microsoft KeyVault에 알립니다. |
> |  | **vaults/secrets** |  |
> | 작업 | Microsoft.KeyVault/vaults/secrets/read | 암호의 속성은 볼 수 있지만 해당 값은 볼 수 없습니다. |
> | 작업 | Microsoft.KeyVault/vaults/secrets/write | 새 비밀을 만들거나 기존 비밀의 값을 업데이트 합니다. |
> |  | **자격 증명 모음/certificatecas** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft. Kusto/등록/동작 | 구독 등록 작업 |
> | 작업 | Microsoft. Kusto/등록/동작 | 구독을 Kusto 리소스 공급자에 등록 합니다. |
> | 작업 | Microsoft. Kusto/등록 취소/작업 | Kusto 리소스 공급자에 대 한 구독을 등록 취소 합니다. |
> |  | **클러스터** |  |
...
> | 작업 | Microsoft. Kusto/클러스터/시작/작업 | 클러스터를 시작 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/중지/작업 | 클러스터를 중지 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/활성화/작업 | 클러스터를 시작 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/비활성화/작업 | 클러스터를 중지 합니다. |
> | 작업 | Microsoft .Kusto/클러스터/CheckNameAvailability/action | 클러스터 이름 가용성을 확인 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/DetachFollowerDatabases/작업 | 종동체 데이터베이스를 분리 합니다. |
> | 작업 | Microsoft .Kusto/클러스터/ListFollowerDatabases/action | 종동체의 데이터베이스를 나열 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/DiagnoseVirtualNetwork/작업 | 서비스가 종속 된 외부 리소스에 대 한 네트워크 연결 상태를 진단 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/ListLanguageExtensions/작업 | 언어 확장을 나열 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/AddLanguageExtensions/작업 | 언어 확장을 추가 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/RemoveLanguageExtensions/작업 | 언어 확장을 제거 합니다. |
> |  | **클러스터/AttachedDatabaseConfigurations** |  |
> | 작업 | Microsoft .Kusto/클러스터/AttachedDatabaseConfigurations/읽기 | 연결 된 데이터베이스 구성 리소스를 읽습니다. |
> | 작업 | Microsoft .Kusto/클러스터/AttachedDatabaseConfigurations/write | 연결 된 데이터베이스 구성 리소스를 작성 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/AttachedDatabaseConfigurations/delete | 연결 된 데이터베이스 구성 리소스를 삭제 합니다. |
> |  | **클러스터/데이터베이스** |  |
...
> | 작업 | Microsoft. Kusto/클러스터/데이터베이스/ListPrincipals/action | 데이터베이스 보안 주체를 나열 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/데이터베이스/AddPrincipals/action | 데이터베이스 보안 주체를 추가 합니다. |
> | 작업 | Microsoft. Kusto/클러스터/데이터베이스/RemovePrincipals/action | 데이터베이스 보안 주체를 제거 합니다. |
> | 작업 | Microsoft .Kusto/클러스터/데이터베이스/DataConnectionValidation/작업 | 데이터베이스 데이터 연결의 유효성을 검사 합니다. |
> | 작업 | Microsoft .Kusto/클러스터/데이터베이스/CheckNameAvailability/action | 지정 된 형식에 대 한 이름 가용성을 확인 합니다. |
> | 작업 | Microsoft .Kusto/클러스터/데이터베이스/EventHubConnectionValidation/작업 | 데이터베이스 이벤트 허브 연결의 유효성을 검사 합니다. |
> |  | **클러스터/데이터베이스/DataConnections** |  |
...
> |  | **클러스터/데이터베이스/EventHubConnections** |  |
> | 작업 | Microsoft.Kusto/Clusters/Databases/EventHubConnections/read | 이벤트 허브 연결 리소스를 읽습니다. |
> | 작업 | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | 이벤트 허브 연결 리소스를 씁니다. |
> | 작업 | Microsoft.Kusto/Clusters/Databases/EventHubConnections/delete | 이벤트 허브 연결 리소스를 삭제 합니다. |
> |  | **클러스터/데이터베이스/PrincipalAssignments** |  |
> | 작업 | Microsoft .Kusto/클러스터/데이터베이스/PrincipalAssignments/읽기 | 데이터베이스 보안 주체 할당 리소스를 읽습니다. |
> | 작업 | Microsoft .Kusto/클러스터/데이터베이스/PrincipalAssignments/write | 데이터베이스 보안 주체 할당 리소스를 씁니다. |
> | 작업 | Microsoft. Kusto/클러스터/데이터베이스/PrincipalAssignments/delete | 데이터베이스 보안 주체 할당 리소스를 삭제 합니다. |
> |  | **클러스터/DataConnections** |  |
> | 작업 | Microsoft .Kusto/클러스터/DataConnections/읽기 | 클러스터의 데이터 연결 리소스를 읽습니다. |
> | 작업 | Microsoft .Kusto/클러스터/DataConnections/write | 클러스터의 데이터 연결 리소스를 씁니다. |
> | 작업 | Microsoft. Kusto/클러스터/DataConnections/delete | 클러스터의 데이터 연결 리소스를 삭제 합니다. |
> |  | **클러스터/PrincipalAssignments** |  |
> | 작업 | Microsoft. Kusto/클러스터/PrincipalAssignments/읽기 | 클러스터 보안 주체 할당 리소스를 읽습니다. |
> | 작업 | Microsoft. Kusto/클러스터/PrincipalAssignments/write | 클러스터 보안 주체 할당 리소스를 씁니다. |
> | 작업 | Microsoft. Kusto/클러스터/PrincipalAssignments/delete | 클러스터 보안 주체 할당 리소스를 삭제 합니다. |
> |  | **클러스터/Sku** |  |
> | 작업 | Microsoft. Kusto/클러스터/Sku/읽기 | 클러스터 SKU 리소스를 읽습니다. |
> |  | **위치** |  |
> | 작업 | Microsoft .Kusto/위치/CheckNameAvailability/action | 리소스 이름 가용성을 확인 합니다. |
> | 작업 | Microsoft .Kusto/위치/s s v e r/작업 | 네트워크 의도 정책을 가져옵니다. |
> |  | **위치/operationresults** |  |
> | 작업 | Microsoft.Kusto/locations/operationresults/read | 작업 리소스를 읽습니다. |
> |  | **작업** |  |
> | 작업 | Microsoft.Kusto/Operations/read | 작업 리소스를 읽습니다. |
> |  | **SKU** |  |
> | 작업 | Microsoft. Kusto/Sku/읽기 | SKU 리소스를 읽습니다. |
...
> | 작업 | Microsoft. 서비스/랩 계정/GetPricingAndAvailability/작업 | 랩 계정의 크기, 지역 및 운영 체제 조합에 대 한 가격 책정 및 가용성을 가져옵니다. |
> | 작업 | Microsoft. 서비스/랩 계정/GetRestrictionsAndUsage/작업 | 이 구독에 대 한 핵심 제한 및 사용 현황 가져오기 |
> |  | **랩 계정/galleryImages** |  |
...
> | 작업 | Microsoft. 서비스/랩 계정/실습/GetLabPricingAndAvailability/작업 | 이 랩의 랩 단위당 가격 책정 및이 랩을 확장할 수 있는지 여부를 나타내는 가용성을 가져옵니다. |
> |  | **랩 계정/실습/environmentSettings** |  |
...
> | 작업 | Microsoft. 서비스/랩 계정/실습/environmentSettings/SaveImage/action | 랩 계정의 공유 갤러리에 현재 템플릿 이미지를 저장 합니다. |
> | 작업 | Microsoft. 서비스/랩 계정/실습/environmentSettings/ResetPassword/action | 템플릿 가상 컴퓨터에서 암호를 다시 설정 합니다. |
> |  | **랩 계정/실습/environmentSettings/환경** |  |
...
> |  | **랩 계정/실습/environmentSettings/일정** |  |
...
> | 작업 | Microsoft. 서비스/사용자/ListAllEnvironments/작업 | 사용자에 대 한 모든 환경 나열 |
...
> | 작업 | Microsoft. 서비스/사용자/UserSettings/작업 | 개인 사용자 설정을 업데이트 하 고 반환 합니다. |
...
> |  | **integrationAccounts/그룹** |  |
> | 작업 | IntegrationAccounts/그룹/읽기 | 통합 계정에서 그룹을 읽습니다. |
> | 작업 | Microsoft 논리/integrationAccounts/그룹/쓰기 | 통합 계정에서 그룹을 만들거나 업데이트 합니다. |
> | 작업 | IntegrationAccounts/그룹/삭제 | 통합 계정에서 그룹을 삭제 합니다. |
> |  | **integrationAccounts/지도** |  |
...
> | 작업 | Microsoft. 논리/integrationAccounts/rosettaNetProcessConfigurations/read | 통합 계정에서 RosettaNet 프로세스 구성을 읽습니다. |
> | 작업 | Microsoft. 논리/integrationAccounts/rosettaNetProcessConfigurations/write | 통합 계정에서 RosettaNet 프로세스 구성을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. 논리/integrationAccounts/rosettaNetProcessConfigurations/delete | 통합 계정에서 RosettaNet 프로세스 구성을 삭제 합니다. |
> |  | **integrationAccounts/일정** |  |
> | 작업 | Microsoft. 논리/integrationAccounts/일정/읽기 | 통합 계정에서 일정을 읽습니다. |
> | 작업 | Microsoft. 논리/integrationAccounts/일정/쓰기 | 통합 계정에서 일정을 만들거나 업데이트 합니다. |
> | 작업 | IntegrationAccounts/일정/삭제 | 통합 계정에서 일정을 삭제 합니다. |
> |  | **integrationAccounts/스키마** |  |
...
> | 작업 | IntegrationServiceEnvironments/availableManagedApis/read | 사용 가능한 관리 되는 Api 통합 서비스 환경을 읽습니다. |
...
> | 작업 | IntegrationServiceEnvironments/managedApis/write | Integration service environment 관리 되는 API를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft 논리/integrationServiceEnvironments/managedApis/join/action | 통합 서비스 환경 관리 되는 API에 조인 합니다. |
...
> | 작업 | IntegrationServiceEnvironments/managedApis/operationStatuses/읽기 | Integration service environment 관리 되는 API 작업 상태를 읽습니다. |
...
> |  | **워크플로/감지기** |  |
> | 작업 | Microsoft. 논리/워크플로/감지기/읽기 | 워크플로 탐지기를 읽습니다. |
> |  | **워크플로/공급자/Microsoft diagnosticSettings/** |  |
...
> | 작업 | Microsoft. 논리/워크플로/실행/삭제 | 워크플로 실행을 삭제 합니다. |
...
Azure 서비스: [Machine Learning Studio](../machine-learning/studio/index.yml)
...
> |  | **위치도** |  |
> | 작업 | MachineLearningServices/위치/Updatas/작업 | 작업 영역에서 각 VM 제품군에 대 한 할당량을 업데이트 합니다. |
> |  | **위치/computeoperationsstatus** |  |
> | 작업 | MachineLearningServices/위치/computeoperationsstatus/읽기 | 특정 컴퓨팅 작업의 상태를 가져옵니다. |
> |  | **위치/할당량** |  |
> | 작업 | MachineLearningServices/위치/할당량/읽기 | VMFamily를 기준으로 현재 할당 된 작업 영역 할당량을 가져옵니다. |
> |  | **위치/용도** |  |
...
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnectionsApproval/작업 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결을 승인 하거나 거부 합니다. |
> |  | **workspaces/computes** |  |
...
> | 작업 | MachineLearningServices/작업 영역/계산/시작/작업 | Machine Learning Services 작업 영역에서 계산 리소스 시작 |
> | 작업 | MachineLearningServices/작업 영역/계산/중지/작업 | Machine Learning Services 작업 영역에서 계산 리소스 중지 |
> | 작업 | MachineLearningServices/작업 영역/계산/다시 시작/작업 | Machine Learning Services 작업 영역에서 계산 리소스 다시 시작 |
> |  | **작업 영역/datadriftdetectors** |  |
> | 작업 | MachineLearningServices/작업 영역/datadriftdetectors/읽기 | Machine Learning Services 작업 영역에서 데이터 드리프트 감지기를 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/datadriftdetectors/쓰기 | Machine Learning Services 작업 영역에서 데이터 드리프트 감지기를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/datadriftdetectors/삭제 | Machine Learning Services 작업 영역에서 데이터 드리프트 감지기을 삭제 합니다. |
> |  | **작업 영역/데이터 집합/등록 됨** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/읽기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/쓰기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/삭제 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합을 삭제 합니다. |
> |  | **작업 영역/데이터 집합/등록/미리 보기** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/미리 보기/읽기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합에 대 한 데이터 집합 미리 보기를 가져옵니다. |
> |  | **작업 영역/데이터 집합/등록/프로필** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/프로 파일링/읽기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합에 대 한 데이터 집합 프로필을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/프로 파일링/쓰기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합에 대 한 데이터 집합 프로필을 만들거나 업데이트 합니다. |
> |  | **작업 영역/데이터 집합/등록/스키마** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록/스키마/읽기 | Machine Learning Services 작업 영역에서 등록 된 데이터 집합에 대 한 데이터 집합 스키마를 가져옵니다. |
> |  | **작업 영역/데이터 집합/등록 취소** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/읽기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/쓰기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/삭제 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합을 삭제 합니다. |
> |  | **작업 영역/데이터 집합/등록 취소/미리 보기** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/미리 보기/읽기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합에 대 한 데이터 집합 미리 보기를 가져옵니다. |
> |  | **작업 영역/데이터 집합/등록 취소/프로필** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/프로필/읽기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합에 대 한 데이터 집합 프로필을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/프로필/쓰기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합에 대 한 데이터 집합 프로필을 만들거나 업데이트 합니다. |
> |  | **작업 영역/데이터 집합/등록 취소/스키마** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 집합/등록 취소/스키마/읽기 | Machine Learning Services 작업 영역에서 등록 되지 않은 데이터 집합에 대 한 데이터 집합 스키마를 가져옵니다. |
> |  | **작업 영역/데이터 저장소** |  |
> | 작업 | MachineLearningServices/작업 영역/데이터 저장소/읽기 | Machine Learning Services 작업 영역에서 데이터 저장소를 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 저장소/쓰기 | Machine Learning Services 작업 영역에서 데이터 저장소를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/데이터 저장소/삭제 | Machine Learning Services 작업 영역에서 데이터 저장소를 삭제 합니다. |
> |  | **작업 영역/끝점/파이프라인** |  |
> | 작업 | MachineLearningServices/작업 영역/끝점/파이프라인/읽기 | Machine Learning Services 작업 영역에서 게시 된 파이프라인 및 파이프라인 끝점을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/끝점/파이프라인/쓰기 | Machine Learning Services 작업 영역에서 게시 된 파이프라인 및 파이프라인 끝점을 만들거나 업데이트 합니다. |
> |  | **작업 영역/환경** |  |
> | 작업 | MachineLearningServices/작업 영역/환경/읽기 | Machine Learning Services 작업 영역에서 환경을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/환경/readSecrets/작업 | Machine Learning Services 작업 영역에서 비밀이 포함 된 환경을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/환경/쓰기 | Machine Learning Services 작업 영역에서 환경을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/환경/빌드/작업 | Machine Learning Services 작업 영역에서 환경 빌드 |
> |  | **workspace/eventGridFilters** |  |
> | 작업 | MachineLearningServices/workspaces/eventGridFilters/read | 특정 작업 영역에 대 한 Event Grid 필터 가져오기 |
> |  | **workspaces/experiments** |  |
> | 작업 | MachineLearningServices/작업 영역/실험/읽기 | Machine Learning Services 작업 영역에서 실험을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/실험/쓰기 | Machine Learning Services 작업 영역에서 실험을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/실험/삭제 | Machine Learning Services 작업 영역에서 실험을 삭제 합니다. |
> |  | **작업 영역/실험/실행** |  |
> | 작업 | MachineLearningServices/작업 영역/실험/실행/제출/작업 | Machine Learning Services 작업 영역에서 스크립트 실행을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/실험/실행/읽기 | Machine Learning Services 작업 영역에서 실행을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/실험/실행/쓰기 | Machine Learning Services 작업 영역에서 만들기 또는 업데이트 실행 |
> |  | **작업 영역/레이블 지정** |  |
> | 작업 | MachineLearningServices/작업 영역/레이블 지정/내보내기/작업 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트의 레이블 내보내기 |
> |  | **작업 영역/레이블 지정/레이블** |  |
> | 작업 | MachineLearningServices/작업 영역/레이블/레이블/읽기 | Machine Learning Services 작업 영역에서 레이블 프로젝트의 레이블을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/레이블/레이블/쓰기 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트의 레이블을 만듭니다. |
> | 작업 | MachineLearningServices/작업 영역/레이블/레이블/거부/작업 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트의 레이블 거부 |
> |  | **작업 영역/레이블/프로젝트** |  |
> | 작업 | MachineLearningServices/작업 영역/레이블/프로젝트/읽기 | Machine Learning Services 작업 영역에서 레이블 프로젝트를 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/레이블/프로젝트/쓰기 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/레이블/프로젝트/삭제 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트를 삭제 합니다. |
> |  | **작업 영역/레이블/프로젝트/요약** |  |
> | 작업 | MachineLearningServices/작업 영역/레이블/프로젝트/요약/읽기 | Machine Learning Services 작업 영역에서 레이블 지정 프로젝트 요약을 가져옵니다. |
> |  | **작업 영역/메타 데이터/아티팩트** |  |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/아티팩트/읽기 | Machine Learning Services 작업 영역의 아티팩트를 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/아티팩트/쓰기 | Machine Learning Services 작업 영역에서 아티팩트를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/아티팩트/삭제 | Machine Learning Services 작업 영역에서 아티팩트를 삭제 합니다. |
> |  | **작업 영역/메타 데이터/비밀** |  |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/비밀/읽기 | Machine Learning Services 작업 영역에서 비밀을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/비밀/쓰기 | Machine Learning Services 작업 영역에서 비밀을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/비밀/삭제 | Machine Learning Services 작업 영역에서 비밀을 삭제 합니다. |
> |  | **작업 영역/메타 데이터/스냅숏** |  |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/스냅숏/읽기 | Machine Learning Services 작업 영역의 스냅숏을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/스냅숏/쓰기 | Machine Learning Services 작업 영역에서 스냅숏을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/메타 데이터/스냅숏/삭제 | Machine Learning Services 작업 영역에서 스냅숏을 삭제 합니다. |
> |  | **작업 영역/모델** |  |
> | 작업 | MachineLearningServices/작업 영역/모델/읽기 | Machine Learning Services 작업 영역에서 모델을 가져옵니다. |
> | 작업 | MachineLearningServices/작업 영역/모델/쓰기 | Machine Learning Services 작업 영역에서 모델을 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/모델/삭제 | Machine Learning Services 작업 영역에서 모델을 삭제 합니다. |
> | 작업 | MachineLearningServices/작업 영역/모델/패키지/작업 | Machine Learning Services 작업 영역의 패키지 모델 |
> |  | **작업 영역/모듈** |  |
...
> | 작업 | MachineLearningServices/작업 영역/pipelinedrafts/삭제 | Machine Learning Services 작업 영역에서 파이프라인 초안을 삭제 합니다. |
> |  | **작업 영역/privateEndpointConnectionProxies** |  |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnectionProxies/읽기 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결 프록시의 상태를 확인 합니다. |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnectionProxies/쓰기 | 연결 프록시의 상태를 Microsoft 네트워크 공급자의 개인 끝점 리소스로 변경 합니다. |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnectionProxies/삭제 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결 프록시를 삭제 합니다. |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnectionProxies/유효성 검사/작업 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결 프록시의 유효성을 검사 합니다. |
> |  | **작업 영역/privateEndpointConnections** |  |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnections/읽기 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결 상태를 확인 합니다. |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnections/쓰기 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결의 상태를 변경 합니다. |
> | 작업 | MachineLearningServices/작업 영역/privateEndpointConnections/삭제 | Microsoft. 네트워크 공급자의 개인 끝점 리소스에 대 한 연결을 삭제 합니다. |
> |  | **작업 영역/privateLinkResources** |  |
> | 작업 | MachineLearningServices/작업 영역/privateLinkResources/읽기 | Machine Learning Services 작업 영역의 지정 된 인스턴스에 대해 사용 가능한 개인 링크 리소스를 가져옵니다. |
> |  | **작업 영역/서비스** |  |
> | 작업 | MachineLearningServices/작업 영역/서비스/읽기 | Machine Learning Services 작업 영역에서 서비스를 가져옵니다. |
> |  | **작업 영역/서비스/aci** |  |
> | 작업 | MachineLearningServices/작업 영역/서비스/aci/쓰기 | Machine Learning Services 작업 영역에서 ACI 서비스를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/서비스/aci/listkeys/작업 | Machine Learning Services 작업 영역의 ACI 서비스에 대 한 키를 나열 합니다. |
> | 작업 | MachineLearningServices/작업 영역/서비스/aci/삭제 | Machine Learning Services 작업 영역에서 ACI 서비스를 삭제 합니다. |
> |  | **작업 영역/서비스/aks** |  |
> | 작업 | MachineLearningServices/작업 영역/서비스/aks/쓰기 | Machine Learning Services 작업 영역에서 AKS services를 만들거나 업데이트 합니다. |
> | 작업 | MachineLearningServices/작업 영역/서비스/aks/listkeys/작업 | Machine Learning Services 작업 영역에서 AKS services에 대 한 키를 나열 합니다. |
> | 작업 | MachineLearningServices/작업 영역/서비스/aks/삭제 | Machine Learning Services 작업 영역에서 AKS services를 삭제 합니다. |
> | 작업 | MachineLearningServices/작업 영역/서비스/aks/점수/작업 | Machine Learning Services 작업 영역의 점수 AKS services |
...
> |  | **신원을** |  |
> | 작업 | Microsoft.managedidentity/id/읽기 | 기존 시스템 할당 id를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft.managedidentity/작업/읽기 | Microsoft.managedidentity 리소스 공급자에서 사용할 수 있는 작업을 나열 합니다. |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft ManagedServices/register/action | 관리 서비스에 등록 합니다. |
> | 작업 | Microsoft ManagedServices/등록 취소/작업 | 관리 서비스에서 등록을 취소 합니다. |
> |  | **marketplaceRegistrationDefinitions** |  |
> | 작업 | Microsoft ManagedServices/marketplaceRegistrationDefinitions/read | 관리 서비스 등록 정의의 목록을 검색 합니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft ManagedServices/작업/읽기 | 관리 서비스 작업 목록을 검색 합니다. |
> |  | **operationStatuses** |  |
> | 작업 | Microsoft ManagedServices/operationStatuses/읽기 | 리소스의 작업 상태를 읽습니다. |
> |  | **registrationAssignments** |  |
> | 작업 | Microsoft ManagedServices/registrationAssignments/read | 관리 되는 서비스 등록 할당 목록을 검색 합니다. |
> | 작업 | Microsoft ManagedServices/registrationAssignments/write | 관리 서비스 등록 할당을 추가 하거나 수정 합니다. |
> | 작업 | Microsoft ManagedServices/registrationAssignments/delete | 관리 되는 서비스 등록 할당을 제거 합니다. |
> |  | **registrationDefinitions** |  |
> | 작업 | Microsoft ManagedServices/registrationDefinitions/읽기 | 관리 서비스 등록 정의의 목록을 검색 합니다. |
> | 작업 | Microsoft ManagedServices/registrationDefinitions/쓰기 | 관리 서비스 등록 정의를 추가 하거나 수정 합니다. |
> | 작업 | Microsoft ManagedServices/registrationDefinitions/삭제 | 관리 서비스 등록 정의를 제거 합니다. |
...
> |  | **managementGroups/하위 항목** |  |
> | 작업 | Microsoft. 관리/관리 그룹/하위 항목/읽기 | 관리 그룹의 모든 하위 항목 (관리 그룹, 구독)을 가져옵니다. |
> |  | **managementGroups/settings** |  |
> | 작업 | Microsoft. 관리/관리 그룹/설정/읽기 | 기존 관리 그룹 계층 구조 설정을 나열 합니다. |
> | 작업 | Microsoft. 관리/관리 그룹/설정/쓰기 | 관리 그룹 계층 구조 설정을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. 관리/관리 그룹/설정/삭제 | 관리 그룹 계층 구조 설정을 삭제 합니다. |
> |  | **managementGroups/subscription** |  |
...
> |  | **계정/privateAtlases** |  |
> | 작업 | Microsoft. Maps/accounts/privateAtlases/delete | 개인 Atlas 삭제 |
> | 작업 | Microsoft. Maps/accounts/privateAtlases/read | 개인 Atlas 가져오기 |
> | 작업 | Microsoft. Maps/accounts/privateAtlases/write | 개인 Atlas를 만들거나 업데이트 합니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft Maps/작업/읽기 | 공급자 작업 읽기 |
> |  | **계정/데이터** |  |
...
> | 작업 | Microsoft Marketplace/privateStores/작업 | PrivateStore를 업데이트 합니다. |
...
> |  | **privateStores** |  |
> | 작업 | Microsoft Marketplace/privateStores/write | PrivateStore를 만듭니다. |
> | 작업 | Microsoft Marketplace/privateStores/delete | PrivateStore를 삭제 합니다. |
> | 작업 | Microsoft Marketplace/privateStores/제안/작업 | PrivateStore의 업데이트 제품입니다. |
> | 작업 | Microsoft Marketplace/privateStores/read | PrivateStores를 읽습니다. |
> |  | **privateStores/제안** |  |
> | 작업 | Microsoft Marketplace/privateStores/제품/쓰기 | PrivateStore에 제품을 만듭니다. |
> | 작업 | Microsoft Marketplace/privateStores/제품/삭제 | PrivateStore에서 제안을 삭제 합니다. |
...
> |  | **작업도** |  |
> | 작업 | MarketplaceOrdering/작업/읽기 | API에서 가능한 모든 작업 나열 |
...
> |  | **windowsazure.mediaservices/asset/assetfilters** |  |
...
> |  | **assessmentprojects** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/읽기 | 평가 프로젝트의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/쓰기 | 새 평가 프로젝트를 만들거나 기존 평가 프로젝트를 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/삭제 | 평가 프로젝트를 삭제 합니다. |
> |  | **assessmentprojects/assessmentOptions** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/assessmentOptions/읽기 | 지정된 위치에서 사용할 수 있는 평가 옵션을 가져옵니다. |
> |  | **assessmentprojects/평가** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/평가/읽기 | 프로젝트 내의 평가를 나열합니다. |
> |  | **assessmentprojects/그룹** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/읽기 | 그룹의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/쓰기 | 새 그룹을 만들거나 기존 그룹을 업데이트합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/삭제 | 그룹을 삭제합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/updateMachines/작업 | 컴퓨터를 추가 또는 제거 하 여 그룹 업데이트 |
> |  | **assessmentprojects/그룹/평가** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/읽기 | 평가의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/쓰기 | 새 평가를 만들거나 기존 평가를 업데이트합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/삭제 | 평가를 삭제합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/다운로드 url/작업 | 평가 보고서의 URL을 다운로드합니다. |
> |  | **assessmentprojects/groups/평가/assessedmachines** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/그룹/평가/assessedmachines/읽기 | 평가된 머신의 속성을 가져옵니다. |
> |  | **assessmentprojects/hypervcollectors** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/읽기 | HyperV 수집기의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/write | 새 HyperV 수집기를 만들거나 기존 HyperV 수집기를 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/hypervcollectors/delete | HyperV 수집기를 삭제 합니다. |
> |  | **assessmentprojects/importcollectors** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/importcollectors/읽기 | 가져오기 수집기의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/importcollectors/write | 새 가져오기 수집기를 만들거나 기존 가져오기 수집기를 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/importcollectors/delete | 가져오기 수집기를 삭제 합니다. |
> |  | **assessmentprojects/컴퓨터** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/컴퓨터/읽기 | 머신의 속성을 가져옵니다. |
> |  | **assessmentprojects/servercollectors** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/servercollectors/읽기 | 서버 수집기의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/servercollectors/write | 새 서버 수집기를 만들거나 기존 서버 수집기를 업데이트 합니다. |
> |  | **assessmentprojects/vmwarecollectors** |  |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/읽기 | VMware 수집기의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/쓰기 | 새 VMware 수집기를 만들거나 기존 VMware 수집기를 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/assessmentprojects/vmwarecollectors/삭제 | VMware 수집기를 삭제 합니다. |
> |  | **위치도** |  |
> | 작업 | Microsoft.Migrate/locations/checknameavailability/action | 지정된 위치에서 지정된 구독의 리소스 이름의 가용성을 확인합니다. |
> |  | **위치/assessmentOptions** |  |
...
> | 작업 | Microsoft. 마이그레이션/migrateprojects/쓰기 | 새 마이그레이션 프로젝트를 만들거나 기존 마이그레이션 프로젝트를 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/삭제 | 마이그레이션 프로젝트를 삭제 합니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/registerTool/action | 마이그레이션 프로젝트에 도구 등록 |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/RefreshSummary/작업 | 프로젝트 마이그레이션 요약을 새로 고칩니다. |
> |  | **migrateprojects/DatabaseInstances** |  |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/DatabaseInstances/read | 데이터베이스 인스턴스의 속성을 가져옵니다. |
> |  | **migrateprojects/데이터베이스** |  |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/데이터베이스/읽기 | 데이터베이스의 속성을 가져옵니다. |
> |  | **migrateprojects/컴퓨터** |  |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/컴퓨터/읽기 | 머신의 속성을 가져옵니다. |
> |  | **migrateprojects/MigrateEvents** |  |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/MigrateEvents/읽기 | 마이그레이션 이벤트의 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/MigrateEvents/삭제 | 마이그레이션 이벤트를 삭제 합니다. |
> |  | **migrateprojects/솔루션** |  |
> | 작업 | Microsoft.Migrate/migrateprojects/solutions/read | 프로젝트 솔루션 마이그레이션 속성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/솔루션/쓰기 | 새 프로젝트 마이그레이션 솔루션을 만들거나 기존 마이그레이션 프로젝트 솔루션을 업데이트 합니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/솔루션/삭제 | 프로젝트 마이그레이션 솔루션을 삭제 합니다. |
> | 작업 | Microsoft.Migrate/migrateprojects/solutions/getconfig/action | 마이그레이션 프로젝트 솔루션 구성을 가져옵니다. |
> | 작업 | Microsoft. 마이그레이션/migrateprojects/솔루션/cleanupData/action | 프로젝트 솔루션 데이터 마이그레이션 정리 |
> |  | **작업** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | MixedReality/register/action | Mixed Reality 리소스 공급자에 대 한 구독을 등록 합니다. |
> |  | **remoteRenderingAccounts/providers/metricDefinitions** |  |
> | 작업 | MixedReality/remoteRenderingAccounts/providers//metricDefinitions/read | MixedReality/remoteRenderingAccounts에 대해 사용 가능한 메트릭을 가져옵니다. |
> |  | **spatialAnchorsAccounts/providers/diagnosticSettings** |  |
> | 작업 | MixedReality/spatialAnchorsAccounts/providers//diagnosticSettings/read | MixedReality/spatialAnchorsAccounts에 대 한 진단 설정을 가져옵니다. |
> | 작업 | MixedReality/spatialAnchorsAccounts/providers//diagnosticSettings/write | MixedReality/spatialAnchorsAccounts에 대 한 진단 설정을 만들거나 업데이트 합니다. |
> |  | **spatialAnchorsAccounts/providers/metricDefinitions** |  |
> | 작업 | MixedReality/spatialAnchorsAccounts/providers//metricDefinitions/read | MixedReality/spatialAnchorsAccounts에 대해 사용 가능한 메트릭을 가져옵니다. |
> |  | **ObjectUnderstandingAccounts** |  |
> | DataAction | MixedReality/ObjectUnderstandingAccounts/수집/작업 | 모델 수집 작업 만들기 |
> |  | **ObjectUnderstandingAccounts/수집** |  |
> | DataAction | MixedReality/ObjectUnderstandingAccounts/수집/읽기 | 모델 수집 작업 상태 가져오기 |
...
> |  | **RemoteRenderingAccounts/렌더링** |  |
> | DataAction | MixedReality/RemoteRenderingAccounts/렌더링/읽기 | 세션에 연결 |
> |  | **SpatialAnchorsAccounts** |  |
> | DataAction | MixedReality/SpatialAnchorsAccounts/만들기/작업 | 공간 앵커 만들기 |
> | DataAction | MixedReality/SpatialAnchorsAccounts/delete | 공간 앵커 삭제 |
> | DataAction | MixedReality/SpatialAnchorsAccounts/write | 공간 앵커 속성 업데이트 |
> |  | **SpatialAnchorsAccounts/검색** |  |
> | DataAction | MixedReality/SpatialAnchorsAccounts/검색/읽기 | 주변 공간 앵커 검색 |
> |  | **SpatialAnchorsAccounts/속성** |  |
> | DataAction | MixedReality/SpatialAnchorsAccounts/속성/읽기 | 공간 앵커의 속성을 가져옵니다. |
> |  | **SpatialAnchorsAccounts/쿼리** |  |
> | DataAction | MixedReality/SpatialAnchorsAccounts/쿼리/읽기 | 공간 앵커 찾기 |
> |  | **SpatialAnchorsAccounts/submitdiag** |  |
> | DataAction | MixedReality/SpatialAnchorsAccounts/submitdiag/read | 진단 데이터를 제출 하 여 Azure 공간 앵커 서비스의 품질 향상 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft NetApp/register/action | 구독 등록 작업 |
> | 작업 | Microsoft NetApp/등록 취소/작업 | Microsoft .Net 앱 리소스 공급자를 사용 하 여 구독 등록 취소 |
> |  | **위치도** |  |
> | 작업 | Microsoft.NetApp/locations/read | 가용성 확인 리소스를 읽습니다. |
> | 작업 | Microsoft NetApp/위치/checknameavailability/action | 리소스 이름을 사용할 수 있는지 확인 |
> | 작업 | Microsoft NetApp/위치/checkfilepathavailability/작업 | 파일 경로를 사용할 수 있는지 확인 |
> |  | **위치/operationresults** |  |
...
> | 작업 | Microsoft.NetApp/netAppAccounts/delete | 계정 리소스를 삭제 합니다. |
> |  | **netAppAccounts/accountBackups** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/accountBackups/읽기 | 계정 백업 리소스를 읽습니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/accountBackups/write | 계정 백업 리소스를 작성 합니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/accountBackups/delete | 계정 백업 리소스를 삭제 합니다. |
> |  | **netAppAccounts/backupPolicies** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/backupPolicies/읽기 | 백업 정책 리소스를 읽습니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/backupPolicies/쓰기 | 백업 정책 리소스를 씁니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/backupPolicies/삭제 | 백업 정책 리소스를 삭제 합니다. |
...
> |  | **netAppAccounts/capacityPools/볼륨/백업** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/백업/읽기 | 백업 리소스를 읽습니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/백업/쓰기 | 백업 리소스를 씁니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/백업/삭제 | 백업 리소스를 삭제 합니다. |
> |  | **netAppAccounts/capacityPools/볼륨/MountTargets** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/MountTargets/read | 마운트 대상 리소스를 읽습니다. |
> |  | **netAppAccounts/capacityPools/볼륨/Connectingtosource** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/Connectingtosource/read | 볼륨 복제 상태를 읽습니다. |
...
> | 작업 | Microsoft NetApp/netAppAccounts/snapshotPolicies/read | 스냅숏 정책 리소스를 읽습니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/snapshotPolicies/write | 스냅숏 정책 리소스를 씁니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/snapshotPolicies/delete | 스냅숏 정책 리소스를 삭제 합니다. |
> | 작업 | Microsoft NetApp/netAppAccounts/snapshotPolicies/ListVolumes/작업 | 스냅숏 정책에 연결 된 볼륨 나열 |
> |  | **netAppAccounts/자격 증명 모음** |  |
> | 작업 | Microsoft NetApp/netAppAccounts/자격 증명 모음/읽기 | 자격 증명 모음 리소스를 읽습니다. |
> |  | **작업** |  |
> | 작업 | Microsoft.NetApp/Operations/read | 작업 리소스를 읽습니다. |

## <a name="microsoftnetwork"></a>Microsoft.Network

Azure 서비스: [Virtual Network](../virtual-network/index.yml), [Load Balancer](../load-balancer/index.yml), [Application Gateway](../application-gateway/index.yml), [Azure DNS](../dns/index.yml), [express](../expressroute/index.yml)경로, [VPN Gateway](../vpn-gateway/index.yml), [Traffic Manager](../traffic-manager/index.yml), [Network Watcher](../network-watcher/index.yml), [azure 방화벽](../firewall/index.yml) [azure Front 도어 서비스](../frontdoor/index.yml), [azure 방호](../bastion/index.yml)
...
> | 작업 | Microsoft. Network/applicationGateways/getBackendHealthOnDemand/action | 지정 된 http 설정 및 백 엔드 풀에 대 한 요청 시 응용 프로그램 게이트웨이 백 엔드 상태를 가져옵니다. |
...
> | 작업 | Microsoft. Network/ApplicationGatewayWebApplicationFirewallPolicies/delete | Application Gateway WAF 정책을 삭제 합니다. |
> |  | **applicationRuleCollections** |  |
> | 작업 | Microsoft. Network/applicationRuleCollections/read | Azure 방화벽 ApplicationRuleCollection를 가져옵니다. |
> | 작업 | Microsoft. Network/applicationRuleCollections/write | CreatesOrUpdates Azure 방화벽 ApplicationRuleCollection |
> | 작업 | Microsoft. Network/applicationRuleCollections/delete | Azure 방화벽 ApplicationRuleCollection을 삭제 합니다. |
> |  | **applicationSecurityGroups** |  |
> | 작업 | Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action | IP 구성을 애플리케이션 보안 그룹에 조인합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/applicationSecurityGroups/joinNetworkSecurityRule/action | 보안 규칙을 애플리케이션 보안 그룹에 조인합니다. 했어야 하지 않습니다. |
...
> | 작업 | Microsoft. Network/bastionHosts/getactivesessions/action | 요새 호스트에서 활성 세션 가져오기 |
> | 작업 | Microsoft. Network/bastionHosts/disconnectactivesessions/action | 요새 호스트에서 지정 된 활성 세션의 연결을 끊습니다. |
...
> | 작업 | Microsoft. Network/connections/startpacketcapture/action | Virtual Network 게이트웨이 연결 패킷 캡처를 시작 합니다. |
> | 작업 | Microsoft. Network/connections/stoppacketcapture/action | Virtual Network 게이트웨이 연결 패킷 캡처를 중지 합니다. |
> |  | **연결/sharedKey** |  |
...
> | 작업 | Microsoft.Network/ddosProtectionPlans/join/action | DDoS Protection 계획에 조인 합니다. 했어야 하지 않습니다. |
> |  | **dnsoperationresults** |  |
...
> |  | **dnszones/A** |  |
> | 작업 | Microsoft.Network/dnszones/A/read | JSON 형식의 ' A ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/A/write | DNS 영역 내에서 ' A ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/A/delete | DNS 영역에서 지정 된 이름의 레코드 집합 및 ' A ' 형식을 제거 합니다. |
> |  | **dnszones/AAAA** |  |
> | 작업 | Microsoft.Network/dnszones/AAAA/read | JSON 형식으로 ' AAAA ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/AAAA/write | DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/AAAA/delete | DNS 영역에서 지정 된 이름의 레코드 집합 및 ' AAAA ' 유형을 제거 합니다. |
> |  | **dnszones/all** |  |
...
> | 작업 | Microsoft.Network/dnszones/CAA/write | DNS 영역 내에서 ' CAA ' 유형의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/CAA/delete | DNS 영역에서 지정 된 이름의 레코드 집합 및 ' CAA ' 유형을 제거 합니다. |
> |  | **dnszones/CNAME** |  |
> | 작업 | Microsoft.Network/dnszones/CNAME/read | JSON 형식으로 ' CNAME ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag가 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/CNAME/write | DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/CNAME/delete | DNS 영역에서 지정 된 이름의 레코드 집합 및 ' CNAME ' 형식을 제거 합니다. |
> |  | **dnszones/MX** |  |
> | 작업 | Microsoft.Network/dnszones/MX/read | JSON 형식으로 ' MX ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/MX/write | DNS 영역 내에서 ' MX ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/MX/delete | DNS 영역에서 지정 된 이름의 레코드 집합 및 ' MX ' 유형을 제거 합니다. |
> |  | **dnszones/NS** |  |
...
> | 작업 | Microsoft.Network/dnszones/PTR/write | DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/PTR/delete | DNS 영역에서 지정 된 이름 및 ' PTR ' 형식의 레코드 집합을 제거 합니다. |
> |  | **dnszones/recordsets** |  |
...
> |  | **dnszones/SRV** |  |
> | 작업 | Microsoft.Network/dnszones/SRV/read | JSON 형식으로 ' SRV ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/SRV/write | SRV 형식의 레코드 집합을 만들거나 업데이트합니다. |
> | 작업 | Microsoft.Network/dnszones/SRV/delete | DNS 영역에서 지정 된 이름의 레코드 집합과 ' SRV ' 형식을 제거 합니다. |
> |  | **dnszones/TXT** |  |
> | 작업 | Microsoft.Network/dnszones/TXT/read | JSON 형식으로 ' TXT ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft.Network/dnszones/TXT/write | DNS 영역 내에서 ' TXT ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/dnszones/TXT/delete | DNS 영역에서 지정 된 이름 및 ' TXT ' 형식의 레코드 집합을 제거 합니다. |
...
> | 작업 | Microsoft.Network/expressRouteCircuits/join/action | Express 경로 회로를 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/expressRouteCircuits/delete | ExpressRouteCircuit을 삭제합니다. |
> |  | **expressRouteCircuits/권한 부여** |  |
...
> |  | **expressRouteCircuits/피어 링/arpTables** |  |
> | 작업 | Microsoft. Network/expressRouteCircuits/피어 링/arpTables/읽기 | ExpressRouteCircuit Peering ArpTable을 가져옵니다. |
> |  | **expressRouteCircuits/피어 링/연결** |  |
...
> |  | **expressRouteCircuits/피어 링/Peerings** |  |
> | 작업 | Microsoft.Network/expressRouteCircuits/peerings/peerConnections/read | 피어링 기본 경로 회로 연결을 가져옵니다. |
> |  | **expressRouteCircuits/피어 링/routeTables** |  |
> | 작업 | Microsoft. Network/expressRouteCircuits/피어 링/routeTables/읽기 | ExpressRouteCircuit Peering RouteTable을 가져옵니다. |
> |  | **expressRouteCircuits/피어 링/routeTablesSummary** |  |
> | 작업 | Microsoft. Network/expressRouteCircuits/피어 링/routeTablesSummary/읽기 | ExpressRouteCircuit Peering RouteTable Summary를 가져옵니다. |
> |  | **expressRouteCircuits/피어 링/통계** |  |
> | 작업 | Microsoft.Network/expressRouteCircuits/peerings/stats/read | ExpressRouteCircuit Peering Stat을 가져옵니다. |
> |  | **expressRouteCircuits/통계** |  |
...
> | 작업 | Microsoft.Network/expressRouteCrossConnections/join/action | Express 경로 교차 연결을 조인 합니다. 했어야 하지 않습니다. |
...
> |  | **expressRouteCrossConnections/피어 링/arpTables** |  |
> | 작업 | Microsoft. Network/expressRouteCrossConnections/피어 링/arpTables/읽기 | Express Route 교차 연결 피어링 Arp 테이블을 가져옵니다. |
> |  | **expressRouteCrossConnections/피어 링/routeTables** |  |
> | 작업 | Microsoft. Network/expressRouteCrossConnections/피어 링/routeTables/읽기 | Express Route 교차 연결 피어링 경로 테이블을 가져옵니다. |
> |  | **expressRouteCrossConnections/피어 링/routeTableSummary** |  |
> | 작업 | Microsoft. Network/expressRouteCrossConnections/피어 링/routeTableSummary/읽기 | Express Route 교차 연결 피어링 경로 테이블 요약 정보를 가져옵니다. |
> |  | **expressRouteGateways** |  |
> | 작업 | Microsoft.Network/expressRouteGateways/read | Express Route 게이트웨이를 가져옵니다. |
> | 작업 | Microsoft.Network/expressRouteGateways/join/action | Express 경로 게이트웨이를 조인 합니다. 했어야 하지 않습니다. |
...
> | 작업 | Microsoft.Network/expressRoutePorts/join/action | Express 경로 포트를 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/expressRoutePorts/delete | ExpressRoutePorts를 삭제합니다. |
> |  | **expressRoutePorts/링크** |  |
...
> |  | **firewallPolicies** |  |
> | 작업 | Microsoft. Network/firewallPolicies/read | 방화벽 정책을 가져옵니다. |
> | 작업 | Microsoft. Network/firewallPolicies/write | 방화벽 정책을 만들거나 기존 방화벽 정책을 업데이트 합니다. |
> | 작업 | Microsoft. Network/firewallPolicies/join/action | 방화벽 정책을 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft. Network/firewallPolicies/delete | 방화벽 정책을 삭제 합니다. |
> |  | **firewallPolicies/ruleGroups** |  |
> | 작업 | Microsoft. Network/firewallPolicies/ruleGroups/read | 방화벽 정책 규칙 그룹을 가져옵니다. |
> | 작업 | Microsoft. Network/firewallPolicies/ruleGroups/write | 방화벽 정책 규칙 그룹을 만들거나 기존 방화벽 정책 규칙 그룹을 업데이트 합니다. |
> | 작업 | Microsoft. Network/firewallPolicies/ruleGroups/delete | 방화벽 정책 규칙 그룹을 삭제 합니다. |
> |  | **frontDoors** |  |
...
> | 작업 | Microsoft. Network/frontDoorWebApplicationFirewallPolicies/join/action | 웹 응용 프로그램 방화벽 정책을 조인 합니다. 했어야 하지 않습니다. |
> |  | **ipAllocations** |  |
> | 작업 | Microsoft. Network/ipAllocations/읽기 | IpAllocation 가져오기 |
> | 작업 | Microsoft. Network/ipAllocations/쓰기 | IpAllocation을 만들거나 기존 IpAllocation을 업데이트 합니다. |
> | 작업 | Microsoft. Network/ipAllocations/삭제 | IpAllocation을 삭제 합니다. |
> |  | **ipGroups** |  |
> | 작업 | Microsoft. Network/ipGroups/read | IpGroup을 가져옵니다. |
> | 작업 | Microsoft. Network/ipGroups/write | IpGroup을 만들거나 기존 Ipgroup를 업데이트 합니다. |
> | 작업 | Microsoft. 네트워크/i p 그룹/유효성 검사/동작 | IpGroup의 유효성을 검사 합니다. |
> | 작업 | Microsoft. Network/ipGroups/updateReferences/action | IpGroup의 참조 업데이트 |
> | 작업 | Microsoft. Network/ipGroups/join/action | IpGroup에 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft. Network/ipGroups/delete | IpGroup을 삭제 합니다. |
> |  | **loadBalancers** |  |
...
> |  | **loadBalancers 조정기/Loadbalancer.backendaddresspools** |  |
> | 작업 | Microsoft.Network/loadBalancers/backendAddressPools/read | 부하 분산 장치 백 엔드 주소 풀 정의를 가져옵니다. |
> | 작업 | Microsoft. 네트워크/loadBalancers 조정기/Loadbalancer.backendaddresspools/쓰기 | 부하 분산 장치 백 엔드 주소 풀을 만들거나 기존 부하 분산 장치 백 엔드 주소 풀을 업데이트 합니다. |
> | 작업 | Loadbalancer.backendaddresspools/loadBalancers 조정기//delete | 부하 분산 장치 백 엔드 주소 풀을 삭제 합니다. |
> | 작업 | Microsoft.Network/loadBalancers/backendAddressPools/join/action | 부하 분산 장치 백 엔드 주소 풀을 조인 합니다. 했어야 하지 않습니다. |
> |  | **loadBalancers 조정기/frontendIPConfigurations** |  |
> | 작업 | Microsoft.Network/loadBalancers/frontendIPConfigurations/read | 부하 분산 장치 프런트 엔드 IP 구성 정의를 가져옵니다. |
> | 작업 | Microsoft.Network/loadBalancers/frontendIPConfigurations/join/action | 부하 분산 장치 프런트 엔드 IP 구성을 조인합니다. 했어야 하지 않습니다. |
> |  | **loadBalancers 조정기/inboundNatPools** |  |
> | 작업 | Microsoft.Network/loadBalancers/inboundNatPools/read | 부하 분산 장치 인바운드 NAT 풀 정의를 가져옵니다. |
> | 작업 | Microsoft.Network/loadBalancers/inboundNatPools/join/action | 부하 분산 장치 인바운드 NAT 풀을 조인 합니다. 했어야 하지 않습니다. |
> |  | **loadBalancers 조정기/Loadbalancer.inboundnatrules** |  |
...
> | 작업 | Microsoft.Network/loadBalancers/inboundNatRules/join/action | 부하 분산 장치 인바운드 nat 규칙을 조인 합니다. 했어야 하지 않습니다. |
> |  | **loadBalancers 조정기/loadBalancingRules** |  |
...
> |  | **loadBalancers 조정기/outboundRules** |  |
> | 작업 | Microsoft.Network/loadBalancers/outboundRules/read | 부하 분산 장치 아웃바운드 규칙 정의를 가져옵니다. |
> |  | **loadBalancers 조정기/프로브** |  |
> | 작업 | Microsoft.Network/loadBalancers/probes/read | 부하 분산 장치 프로브를 가져옵니다. |
> | 작업 | Microsoft.Network/loadBalancers/probes/join/action | 부하 분산 장치 프로브 사용을 허용합니다. 예를 들어 이 권한이 있으면 VM 확장 집합의 healthProbe 속성이 프로브를 참조할 수 있습니다. 했어야 하지 않습니다. |
> |  | **loadBalancers 조정기/virtualMachines** |  |
...
> | 작업 | Microsoft. 네트워크/위치/autoApprovedPrivateLinkServices/읽기 | 자동 승인 된 개인 링크 서비스를 가져옵니다. |
> |  | **위치/해당 위임** |  |
> | 작업 | Microsoft.Network/locations/availableDelegations/read | 사용 가능한 위임을 가져옵니다. |
> |  | **위치/availablePrivateEndpointTypes** |  |
> | 작업 | Microsoft. 네트워크/위치/availablePrivateEndpointTypes/읽기 | 사용 가능한 개인 끝점 리소스를 가져옵니다. |
> |  | **위치/availableServiceAliases** |  |
> | 작업 | Microsoft. 네트워크/위치/availableServiceAliases/읽기 | 사용 가능한 서비스 별칭을 가져옵니다. |
> |  | **위치/checkDnsNameAvailability** |  |
...
> |  | **위치/serviceTags** |  |
> | 작업 | Microsoft. 네트워크/위치/serviceTags/읽기 | 서비스 태그 가져오기 |
> |  | **위치/supportedVirtualMachineSizes** |  |
...
> |  | **위치/virtualNetworkAvailableEndpointServices** |  |
> | 작업 | Microsoft.Network/locations/virtualNetworkAvailableEndpointServices/read | 사용 가능한 가상 네트워크 엔드포인트 서비스 목록을 가져옵니다. |
> |  | **natGateways** |  |
> | 작업 | Microsoft. Network/natGateways/join/action | NAT 게이트웨이를 조인 합니다. |
> |  | **natRuleCollections** |  |
> | 작업 | Microsoft. Network/natRuleCollections/read | Azure 방화벽 NatRuleCollection를 가져옵니다. |
> | 작업 | Microsoft. Network/natRuleCollections/write | CreatesOrUpdates Azure 방화벽 NatRuleCollection |
> | 작업 | Microsoft. Network/natRuleCollections/delete | Azure 방화벽 NatRuleCollection을 삭제 합니다. |
> |  | **networkExperimentProfiles** |  |
> | 작업 | Microsoft. Network/networkExperimentProfiles/read | 인터넷 분석기 프로필 가져오기 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/write | 인터넷 분석기 프로필 만들기 또는 업데이트 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/delete | 인터넷 분석기 프로필 삭제 |
> |  | **networkExperimentProfiles/실험** |  |
> | 작업 | Microsoft. Network/networkExperimentProfiles/실험/읽기 | 인터넷 분석기 테스트 받기 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/실험/쓰기 | 인터넷 분석기 테스트 만들기 또는 업데이트 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/실험/삭제 | 인터넷 분석기 테스트 삭제 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/실험/시계열/작업 | 인터넷 분석기 테스트의 시계열 가져오기 |
> | 작업 | Microsoft. Network/networkExperimentProfiles/실험/latencyScorecard/작업 | 인터넷 분석기 테스트의 대기 시간 측정표 가져오기 |
> |  | **networkExperimentProfiles/preconfiguredEndpoints** |  |
> | 작업 | Microsoft. Network/networkExperimentProfiles/preconfiguredEndpoints/read | 인터넷 분석기 프로필의 미리 구성 된 끝점 가져오기 |
...
> | 작업 | Microsoft.Network/networkInterfaces/join/action | 가상 컴퓨터를 네트워크 인터페이스에 조인 합니다. 했어야 하지 않습니다. |
...
> | 작업 | Microsoft. Network/networkInterfaces/UpdateParentNicAttachmentOnElasticNic/action | 탄력적 NIC와 연결 된 부모 NIC를 업데이트 합니다. |
...
> | 작업 | Microsoft.Network/networkInterfaces/ipconfigurations/join/action | 네트워크 인터페이스 IP 구성을 조인합니다. 했어야 하지 않습니다. |
> |  | **networkInterfaces/loadBalancers 장치** |  |
...
> | 작업 | Microsoft. Network/networkRuleCollections/read | Azure 방화벽 NetworkRuleCollection를 가져옵니다. |
> | 작업 | Microsoft. Network/networkRuleCollections/write | CreatesOrUpdates Azure 방화벽 NetworkRuleCollection |
> | 작업 | Microsoft. Network/networkRuleCollections/delete | Azure 방화벽 NetworkRuleCollection을 삭제 합니다. |
> |  | **networkSecurityGroups** |  |
...
> | 작업 | Microsoft.Network/networkSecurityGroups/join/action | 네트워크 보안 그룹을 조인 합니다. 했어야 하지 않습니다. |
...
> | 작업 | Microsoft. Network/networkWatchers/flowLogs/read | 흐름 로그 정보 가져오기 |
> | 작업 | Microsoft. Network/networkWatchers/flowLogs/write | 흐름 로그를 만듭니다. |
> | 작업 | Microsoft. Network/networkWatchers/flowLogs/delete | 흐름 로그를 삭제 합니다. |
...
> | 작업 | Microsoft. Network/p2sVpnGateways/getp2svpnconnectionhealthdetailed/action | P2SVpnGateway에 대 한 자세한 P2S Vpn 연결 상태를 가져옵니다. |
> | 작업 | Microsoft. Network/p2sVpnGateways/disconnectp2svpnconnections/action | P2s vpn 연결 끊기 |
> |  | **privateDnsOperationResults** |  |
> | 작업 | Microsoft. Network/privateDnsOperationResults/read | 사설 DNS 작업의 결과를 가져옵니다. |
> |  | **privateDnsOperationStatuses** |  |
> | 작업 | Microsoft. Network/privateDnsOperationStatuses/read | 사설 DNS 작업의 상태를 가져옵니다. |
> |  | **privateDnsZones** |  |
> | 작업 | Microsoft. Network/privateDnsZones/read | JSON 형식의 사설 DNS 영역 속성을 가져옵니다. 이 명령은 사설 DNS 영역이 연결 된 가상 네트워크 또는 영역 내에 포함 된 레코드 집합을 검색 하지 않습니다. |
> | 작업 | Microsoft. Network/privateDnsZones/write | 리소스 그룹 내의 사설 DNS 영역을 만들거나 업데이트 합니다. 이 명령은 영역 내에서 가상 네트워크 링크 또는 레코드 집합을 만들거나 업데이트 하는 데 사용할 수 없습니다. |
> | 작업 | Microsoft. Network/privateDnsZones/delete | 사설 DNS 영역을 삭제 합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/join/action | 사설 DNS 영역에 조인 합니다. |
> |  | **privateDnsZones/A** |  |
> | 작업 | Microsoft. Network/privateDnsZones/A/read | JSON 형식의 사설 DNS 영역 내에서 ' A ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/A/write | 사설 DNS 영역 내에서 ' A ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/A/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' A ' 형식을 제거 합니다. |
> |  | **privateDnsZones/AAAA** |  |
> | 작업 | Microsoft. Network/privateDnsZones/AAAA/read | JSON 형식의 사설 DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/AAAA/write | 사설 DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/AAAA/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' AAAA ' 형식을 제거 합니다. |
> |  | **privateDnsZones/모두** |  |
> | 작업 | Microsoft. Network/privateDnsZones/ALL/read | 형식 간에 사설 DNS 레코드 집합을 가져옵니다. |
> |  | **privateDnsZones/CNAME** |  |
> | 작업 | Microsoft. Network/privateDnsZones/CNAME/read | JSON 형식의 사설 DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 가져옵니다. |
> | 작업 | Microsoft. Network/privateDnsZones/CNAME/write | 사설 DNS 영역 내에서 ' CNAME ' 형식의 레코드 집합을 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/CNAME/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' CNAME ' 형식을 제거 합니다. |
> |  | **privateDnsZones/MX** |  |
> | 작업 | Microsoft. Network/privateDnsZones/MX/read | JSON 형식의 사설 DNS 영역 내에서 ' MX ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/MX/write | 사설 DNS 영역 내에서 ' MX ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/MX/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' MX ' 유형을 제거 합니다. |
> |  | **privateDnsZones/PTR** |  |
> | 작업 | Microsoft. Network/privateDnsZones/PTR/read | JSON 형식의 사설 DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/PTR/write | 사설 DNS 영역 내에서 ' PTR ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/PTR/delete | 사설 DNS 영역에서 지정 된 이름 및 ' PTR ' 형식의 레코드 집합을 제거 합니다. |
> |  | **privateDnsZones/레코드 집합** |  |
> | 작업 | Microsoft. Network/privateDnsZones/레코드 집합/읽기 | 형식 간에 사설 DNS 레코드 집합을 가져옵니다. |
> |  | **privateDnsZones/SOA** |  |
> | 작업 | Microsoft. Network/privateDnsZones/SOA/read | JSON 형식의 사설 DNS 영역 내에서 ' SOA ' 형식의 레코드 집합을 가져옵니다. |
> | 작업 | Microsoft. Network/privateDnsZones/SOA/write | 사설 DNS 영역 내에서 ' SOA ' 형식의 레코드 집합을 업데이트 합니다. |
> |  | **privateDnsZones/SRV** |  |
> | 작업 | Microsoft. Network/privateDnsZones/SRV/read | JSON 형식의 사설 DNS 영역 내에서 ' SRV ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/SRV/write | 사설 DNS 영역 내에서 ' SRV ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/SRV/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합과 ' SRV ' 형식을 제거 합니다. |
> |  | **privateDnsZones/TXT** |  |
> | 작업 | Microsoft. Network/privateDnsZones/TXT/read | JSON 형식의 사설 DNS 영역 내에서 ' TXT ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
> | 작업 | Microsoft. Network/privateDnsZones/TXT/write | 사설 DNS 영역 내에서 ' TXT ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/TXT/delete | 사설 DNS 영역에서 지정 된 이름 및 ' TXT ' 형식의 레코드 집합을 제거 합니다. |
> |  | **privateDnsZones/virtualNetworkLinks** |  |
> | 작업 | Microsoft. Network/privateDnsZones/virtualNetworkLinks/read | JSON 형식의 가상 네트워크 속성에 대 한 사설 DNS 영역 링크를 가져옵니다. |
> | 작업 | Microsoft. Network/privateDnsZones/virtualNetworkLinks/write | 가상 네트워크에 대 한 사설 DNS 영역 링크를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. Network/privateDnsZones/virtualNetworkLinks/delete | 가상 네트워크에 대 한 사설 DNS 영역 링크를 삭제 합니다. |
...
> | 작업 | Microsoft. Network/privateLinkServices/privateEndpointConnections/read | 개인 끝점 연결 정의를 가져옵니다. |
> | 작업 | Microsoft. Network/privateLinkServices/privateEndpointConnections/write | 새 개인 끝점 연결을 만들거나 기존 개인 끝점 연결을 업데이트 합니다. |
> | 작업 | Microsoft. Network/privateLinkServices/privateEndpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
> |  | **publicIPAddresses** |  |
...
> | 작업 | Microsoft.Network/publicIPAddresses/join/action | 공용 ip 주소를 조인 합니다. 했어야 하지 않습니다. |
> |  | **publicIPPrefixes** |  |
...
> | 작업 | Microsoft.Network/publicIPPrefixes/join/action | PublicIPPrefix을 조인 합니다. 했어야 하지 않습니다. |
> |  | **routeFilters** |  |
> | 작업 | Microsoft.Network/routeFilters/read | 경로 필터 정의를 가져옵니다. |
> | 작업 | Microsoft.Network/routeFilters/join/action | 경로 필터를 조인 합니다. 했어야 하지 않습니다. |
...
> | 작업 | Microsoft.Network/routeTables/join/action | 경로 테이블을 조인 합니다. 했어야 하지 않습니다. |
> |  | **routeTables/경로** |  |
...
> | 작업 | Microsoft. Network/securityPartnerProviders/read | SecurityPartnerProvider를 가져옵니다. |
> | 작업 | Microsoft. Network/securityPartnerProviders/write | SecurityPartnerProvider을 만들거나 기존 SecurityPartnerProvider를 업데이트 합니다. |
> | 작업 | Microsoft. Network/securityPartnerProviders/validate/action | SecurityPartnerProvider의 유효성을 검사 합니다. |
> | 작업 | Microsoft. Network/securityPartnerProviders/updateReferences/action | SecurityPartnerProvider에서 참조 업데이트 |
> | 작업 | Microsoft. Network/securityPartnerProviders/join/action | SecurityPartnerProvider을 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft. Network/securityPartnerProviders/delete | SecurityPartnerProvider를 삭제 합니다. |
...
> | 작업 | Microsoft.Network/serviceEndpointPolicies/join/action | 서비스 끝점 정책을 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/serviceEndpointPolicies/joinSubnet/action | 서브넷을 서비스 끝점 정책에 조인 합니다. 했어야 하지 않습니다. |
> |  | **serviceEndpointPolicies/Serviceendpointpolicy정의** |  |
...
> | 작업 | Microsoft. Network/virtualHubs/effectiveRoutes/action | 가상 허브에 구성 된 유효 경로를 가져옵니다. |
...
> | 작업 | Microsoft. Network/virtualHubs/routeTables/read | VirtualHubRouteTableV2 가져오기 |
> | 작업 | Microsoft. Network/virtualHubs/routeTables/write | VirtualHubRouteTableV2 만들기 또는 업데이트 |
> | 작업 | Microsoft. Network/virtualHubs/routeTables/delete | VirtualHubRouteTableV2 삭제 |
...
> | 작업 | microsoft. network/virtualnetworkgateways/disconnectvirtualnetworkgatewayvpnconnections/action | 가상 네트워크 게이트웨이 vpn 연결 끊기 |
...
> | 작업 | microsoft. network/virtualnetworkgateways/startpacketcapture/action | Virtual Network 게이트웨이 패킷 캡처를 시작 합니다. |
> | 작업 | microsoft. network/virtualnetworkgateways/stoppacketcapture/action | Virtual Network 게이트웨이 패킷 캡처를 중지 합니다. |
> |  | **virtualnetworkgateways/연결** |  |
...
> | 작업 | Microsoft. Network/virtualNetworks/joinLoadBalancer/action | 가상 네트워크에 부하 분산 장치를 조인 합니다. |
> | 작업 | Microsoft.Network/virtualNetworks/peer/action | 가상 네트워크를 다른 가상 네트워크와 피어링합니다. |
> | 작업 | Microsoft. Network/virtualNetworks/join/action | 가상 네트워크를 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/virtualNetworks/BastionHosts/action | Virtual Network의 요새 호스트 참조를 가져옵니다. |
> |  | **virtualNetworks/bastionHosts** |  |
> | 작업 | Microsoft. Network/virtualNetworks/bastionHosts/default/action | Virtual Network의 요새 호스트 참조를 가져옵니다. |
...
> | 작업 | Microsoft.Network/virtualNetworks/subnets/join/action | 가상 네트워크를 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | 스토리지 계정 또는 SQL 데이터베이스 같은 리소스를 서브넷에 조인합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/virtualNetworks/subnets/prepareNetworkPolicies/action | 필요한 네트워크 정책을 적용하여 서브넷을 준비합니다. |
> | 작업 | Microsoft. Network/virtualNetworks/서브넷/unprepareNetworkPolicies/action | 적용 된 네트워크 정책을 제거 하 여 서브넷을 Unprepare 합니다. |
> |  | **virtualNetworks/서브넷/contextualServiceEndpointPolicies** |  |
> | 작업 | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/read | 상황별 서비스 끝점 정책을 가져옵니다. |
> | 작업 | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/write | 컨텍스트 서비스 끝점 정책을 만들거나 기존 컨텍스트 서비스 끝점 정책을 업데이트 합니다. |
> | 작업 | Microsoft. Network/virtualNetworks/서브넷/contextualServiceEndpointPolicies/delete | 컨텍스트 서비스 끝점 정책을 삭제 합니다. |
> |  | **virtualNetworks/서브넷/virtualMachines** |  |
...
> | 작업 | Microsoft.Network/virtualNetworkTaps/join/action | 가상 네트워크 탭을 조인 합니다. 했어야 하지 않습니다. |
...
> |  | **virtualRouters** |  |
> | 작업 | Microsoft. Network/virtualRouters/읽기 | VirtualRouter를 가져옵니다. |
> | 작업 | Microsoft. Network/virtualRouters/write | VirtualRouter를 만들거나 기존 VirtualRouter를 업데이트 합니다. |
> | 작업 | Microsoft. Network/virtualRouters/delete | VirtualRouter를 삭제 합니다. |
> | 작업 | Microsoft. Network/virtualRouters/조인/작업 | VirtualRouter를 조인 합니다. 했어야 하지 않습니다. |
> |  | **virtualRouters/피어 링** |  |
> | 작업 | Microsoft. Network/virtualRouters/피어 링/읽기 | VirtualRouterPeering 링을 가져옵니다. |
> | 작업 | Microsoft. Network/virtualRouters/피어 링/쓰기 | VirtualRouterPeering 링을 만들거나 기존 VirtualRouterPeering 링을 업데이트 합니다. |
> | 작업 | Microsoft. Network/virtualRouters/피어 링/삭제 | VirtualRouterPeering 링을 삭제 합니다. |
> |  | **virtualWans** |  |
...
> | 작업 | Microsoft. Network/virtualwans/vpnServerConfigurations/action | VirtualWanVpnServerConfigurations 가져오기 |
> | 작업 | Microsoft. Network/virtualwans/generateVpnProfile/action | VirtualWanVpnServerConfiguration VpnProfile 생성 |
...
> | 작업 | microsoft. network/vpnGateways/vpnConnections/vpnLinkConnections/read | Vpn 링크 연결을 가져옵니다. |
> |  | **vpnServerConfigurations** |  |
> | 작업 | Microsoft. Network/vpnServerConfigurations/read | VpnServerConfiguration 가져오기 |
> | 작업 | Microsoft. Network/vpnServerConfigurations/write | VpnServerConfiguration 만들기 또는 업데이트 |
> | 작업 | Microsoft. Network/vpnServerConfigurations/delete | VpnServerConfiguration 삭제 |
> |  | **vpnsites** |  |
...
> | 작업 | microsoft. network/vpnSites/vpnSiteLinks/read | Vpn 사이트 링크를 가져옵니다. |
...
> |  | **네임 스페이스/NotificationHubs/authorizationRules** |  |
...
> |  | **네임 스페이스/NotificationHubs/metricDefinitions** |  |
...
> | 작업 | Microsoft. OffAzure/HyperVSites/healthsummary/read | Hyper-v 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/healthsummary/read | Hyper-v 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/healthsummary/read | Hyper-v 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/healthsummary/read | Hyper-v 리소스에 대 한 상태 요약을 가져옵니다. |
> |  | **HyperVSites/호스트** |  |
...
> | 작업 | Microsoft.OffAzure/HyperVSites/runasaccounts/read | 계정으로 실행된 Hyper-V 속성을 가져옵니다. |
> |  | **HyperVSites/요약** |  |
> | 작업 | Microsoft. OffAzure/HyperVSites/summary/read | Hyper-v 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/summary/read | Hyper-v 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/summary/read | Hyper-v 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/HyperVSites/summary/read | Hyper-v 사이트의 요약을 가져옵니다. |
> |  | **HyperVSites/사용량** |  |
...
> | 작업 | Microsoft.OffAzure/HyperVSites/usage/read | Hyper-V 사이트 사용량을 가져옵니다. |
> |  | **ImportSites** |  |
> | 작업 | Microsoft. OffAzure/ImportSites/read | 가져오기 사이트의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/write | 가져오기 사이트를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/delete | 가져오기 사이트를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/importuri/action | 컴퓨터 CSV 파일을 가져오기 위한 SAS uri를 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/exporturi/action | 컴퓨터 CSV 파일을 내보내기 위한 SAS uri를 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/read | 가져오기 사이트의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/write | 가져오기 사이트를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/delete | 가져오기 사이트를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/importuri/action | 컴퓨터 CSV 파일을 가져오기 위한 SAS uri를 가져옵니다. |
...
> | 작업 | Microsoft. OffAzure/ImportSites/exporturi/action | 컴퓨터 CSV 파일을 내보내기 위한 SAS uri를 가져옵니다. |
> |  | **ImportSites/job** |  |
> | 작업 | Microsoft. OffAzure/ImportSites/job/read | 가져오기 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/job/read | 가져오기 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/job/read | 가져오기 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/job/read | 가져오기 작업의 속성을 가져옵니다. |
> |  | **ImportSites/machines** |  |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/read | 가져오기 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/delete | 가져오기 컴퓨터를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/read | 가져오기 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/delete | 가져오기 컴퓨터를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/read | 가져오기 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ImportSites/machines/delete | 가져오기 컴퓨터를 삭제 합니다. |
...
> |  | **ServerSites** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/read | 서버 사이트의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/write | 서버 사이트를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/delete | 서버 사이트를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/refresh/action | 서버 사이트 내의 개체를 새로 고칩니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/read | 서버 사이트의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/write | 서버 사이트를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/delete | 서버 사이트를 삭제 합니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/refresh/action | 서버 사이트 내의 개체를 새로 고칩니다. |
...
> | 작업 | Microsoft. OffAzure/ServerSites/refresh/action | 서버 사이트 내의 개체를 새로 고칩니다. |
> |  | **ServerSites/작업** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/job/read | 서버 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/job/read | 서버 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/job/read | 서버 작업의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/job/read | 서버 작업의 속성을 가져옵니다. |
> |  | **ServerSites/machines** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/read | 서버 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/write | 서버 컴퓨터의 속성 쓰기 |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/read | 서버 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/write | 서버 컴퓨터의 속성 쓰기 |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/read | 서버 컴퓨터의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/machines/write | 서버 컴퓨터의 속성 쓰기 |
...
> | 작업 | Microsoft. OffAzure/ServerSites/operationsstatus/read | 서버 작업 상태의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/operationsstatus/read | 서버 작업 상태의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/operationsstatus/read | 서버 작업 상태의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/operationsstatus/read | 서버 작업 상태의 속성을 가져옵니다. |
> |  | **ServerSites/runasaccounts** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/runasaccounts/read | 서버 실행 계정의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/runasaccounts/read | 서버 실행 계정의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/runasaccounts/read | 서버 실행 계정의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/runasaccounts/read | 서버 실행 계정의 속성을 가져옵니다. |
> |  | **ServerSites/요약** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/summary/read | 서버 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/summary/read | 서버 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/summary/read | 서버 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/summary/read | 서버 사이트의 요약을 가져옵니다. |
> |  | **ServerSites/usage** |  |
> | 작업 | Microsoft. OffAzure/ServerSites/usage/read | 서버 사이트의 용도를 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/usage/read | 서버 사이트의 용도를 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/usage/read | 서버 사이트의 용도를 가져옵니다. |
> | 작업 | Microsoft. OffAzure/ServerSites/usage/read | 서버 사이트의 용도를 가져옵니다. |
> |  | **VMwareSites** |  |
...
> | 작업 | Microsoft. OffAzure/VMwareSites/내보내기 응용 프로그램/작업 | VMware 응용 프로그램 및 역할 데이터를 xls로 내보냅니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites updateProperties/action | 사이트의 컴퓨터에 대 한 속성을 업데이트 합니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/작업 | 컴퓨터 목록에 대 한 거칠게 맵을 생성 합니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/작업 | 자세한 VMware 거칠게 지도를 생성 합니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites clientGroupMembers/action | 선택한 클라이언트 그룹의 클라이언트 그룹 구성원을 나열 합니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites serverGroupMembers/action | 선택한 서버 그룹에 대 한 서버 그룹 구성원을 나열 합니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites getApplications/action | 선택한 컴퓨터에 대 한 응용 프로그램 정보를 가져옵니다. |
> | 작업 | Microsoft.OffAzure/VMwareSites/read | VMware 사이트 속성을 가져옵니다. |
> | 작업 | Microsoft.OffAzure/VMwareSites/write | VMware 사이트를 만들거나 업데이트합니다. |
> | 작업 | Microsoft.OffAzure/VMwareSites/delete | VMware 사이트를 삭제합니다. |
> | 작업 | Microsoft.OffAzure/VMwareSites/refresh/action | VMware 사이트 내의 개체를 새로 고칩니다. |
...
> | 작업 | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> |  | **VMwareSites/작업** |  |
...
> | 작업 | Microsoft.OffAzure/VMwareSites/machines/stop/action | VMware 머신을 중지합니다. |
> | 작업 | Microsoft.OffAzure/VMwareSites/machines/start/action | VMware 머신을 시작합니다. |
> |  | **VMwareSites/컴퓨터/응용 프로그램** |  |
> | 작업 | Microsoft. OffAzure/VMwareSites/컴퓨터/응용 프로그램/읽기 | VMware 컴퓨터 응용 프로그램의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/컴퓨터/응용 프로그램/읽기 | VMware 컴퓨터 응용 프로그램의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/컴퓨터/응용 프로그램/읽기 | VMware 컴퓨터 응용 프로그램의 속성을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites/컴퓨터/응용 프로그램/읽기 | VMware 컴퓨터 응용 프로그램의 속성을 가져옵니다. |
...
> | 작업 | Microsoft.OffAzure/VMwareSites/runasaccounts/read | 계정으로 실행된 VMware 속성을 가져옵니다. |
> |  | **VMwareSites/요약** |  |
> | 작업 | Microsoft. OffAzure/VMwareSites summary/read | VMware 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites summary/read | VMware 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites summary/read | VMware 사이트의 요약을 가져옵니다. |
> | 작업 | Microsoft. OffAzure/VMwareSites summary/read | VMware 사이트의 요약을 가져옵니다. |
> |  | **VMwareSites/사용** |  |
...
> | 작업 | operationalinsights/register/action | 구독을 Rergisters 합니다. |
> | 작업 | operationalinsights/등록 취소/작업 | 구독의 등록을 취소 합니다. |
> |  | **availableservicetiers** |  |
> | 작업 | operationalinsights/availableservicetiers/읽기 | 사용 가능한 서비스 계층을 가져옵니다. |
> |  | **클러스터** |  |
> | 작업 | OperationalInsights/클러스터/읽기 | 클러스터 가져오기 |
> | 작업 | OperationalInsights/클러스터/쓰기 | 클러스터 만들기 또는 업데이트 |
> | 작업 | OperationalInsights/클러스터/삭제 | 클러스터 삭제 |
> |  | **linkTargets** |  |
...
> |  | **작업 영역/데이터 내보내기** |  |
> | 작업 | operationalinsights/작업 영역/데이터 내보내기/읽기 | 특정 데이터 내보내기를 가져옵니다. |
> | 작업 | operationalinsights/작업 영역/데이터 내보내기/쓰기 | 데이터 내보내기를 만들거나 업데이트 합니다. |
> | 작업 | operationalinsights/작업 영역/데이터 내보내기/삭제 | 특정 데이터 내보내기를 삭제 합니다. |
> |  | **작업 영역/데이터 원본** |  |
...
> |  | **작업 영역/microsoft.intelligencepacks.updateassessment** |  |
...
> |  | **작업 영역/작업** |  |
> | 작업 | operationalinsights/작업 영역/작업/읽기 | OperationalInsights 작업 영역 작업의 상태를 가져옵니다. |
> |  | **workspaces/query** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/read | 작업 영역의 데이터에서 쿼리를 실행 |
> |  | **작업 영역/쿼리/AADDomainServicesAccountLogon** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesAccountLogon/읽기 | AADDomainServicesAccountLogon 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesAccountManagement** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesAccountManagement/읽기 | AADDomainServicesAccountManagement 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesDirectoryServiceAccess** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesDirectoryServiceAccess/읽기 | AADDomainServicesDirectoryServiceAccess 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesLogonLogoff** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesLogonLogoff/읽기 | AADDomainServicesLogonLogoff 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesPolicyChange** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesPolicyChange/읽기 | AADDomainServicesPolicyChange 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesPrivilegeUse** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesPrivilegeUse/읽기 | AADDomainServicesPrivilegeUse 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AADDomainServicesSystemSecurity** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AADDomainServicesSystemSecurity/읽기 | AADDomainServicesSystemSecurity 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/AddonAzureBackupAlerts** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AddonAzureBackupAlerts/읽기 | AddonAzureBackupAlerts 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AddonAzureBackupJobs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AddonAzureBackupJobs/읽기 | AddonAzureBackupJobs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AddonAzureBackupPolicy** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AddonAzureBackupPolicy/읽기 | AddonAzureBackupPolicy 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AddonAzureBackupProtectedInstance** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AddonAzureBackupProtectedInstance/읽기 | AddonAzureBackupProtectedInstance 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AddonAzureBackupStorage** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AddonAzureBackupStorage/읽기 | AddonAzureBackupStorage 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFActivityRun** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFActivityRun/read | ADFActivityRun 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFPipelineRun** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFPipelineRun/읽기 | ADFPipelineRun 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISIntegrationRuntimeLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISIntegrationRuntimeLogs/읽기 | ADFSSISIntegrationRuntimeLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISPackageEventMessageContext** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISPackageEventMessageContext/읽기 | ADFSSISPackageEventMessageContext 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISPackageEventMessages** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISPackageEventMessages/읽기 | ADFSSISPackageEventMessages 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISPackageExecutableStatistics** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISPackageExecutableStatistics/읽기 | ADFSSISPackageExecutableStatistics 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISPackageExecutionComponentPhases** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISPackageExecutionComponentPhases/읽기 | ADFSSISPackageExecutionComponentPhases 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFSSISPackageExecutionDataStatistics** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFSSISPackageExecutionDataStatistics/읽기 | ADFSSISPackageExecutionDataStatistics 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADFTriggerRun** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ADFTriggerRun/읽기 | ADFTriggerRun 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADReplicationResult** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ADReplicationResult/read | ADReplicationResult 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ADSecurityAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/AegDeliveryFailureLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AegDeliveryFailureLogs/읽기 | AegDeliveryFailureLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AegPublishFailureLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AegPublishFailureLogs/읽기 | AegPublishFailureLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/경고** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/Alert/read | Alert 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AlertHistory** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/AlertHistory/read | AlertHistory 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AmlComputeClusterEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AmlComputeClusterEvent/읽기 | AmlComputeClusterEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AmlComputeClusterNodeEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AmlComputeClusterNodeEvent/읽기 | AmlComputeClusterNodeEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AmlComputeJobEvent** |  |
> | 작업 | OperationalInsights/workspaces/query/AmlComputeJobEvent/read | AmlComputeJobEvent 테이블에서 데이터 읽기 |
> |  | **작업 영역/쿼리/ApiManagementGatewayLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ApiManagementGatewayLogs/읽기 | ApiManagementGatewayLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppAvailabilityResults** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppAvailabilityResults/읽기 | AppAvailabilityResults 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppBrowserTimings** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppBrowserTimings/읽기 | AppBrowserTimings 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/Appcenter 오류** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/AppCenterError/read | AppCenterError 테이블의 데이터 읽기 |
> |  | **작업 영역/쿼리/AppDependencies** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppDependencies/읽기 | AppDependencies 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppEvents** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppEvents/read | AppEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppExceptions** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppExceptions/읽기 | AppExceptions 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ApplicationInsights** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ApplicationInsights/read | ApplicationInsights 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppMetrics** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppMetrics/읽기 | AppMetrics 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppPageViews** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppPageViews/read | AppPageViews 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppPerformanceCounters** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppPerformanceCounters/읽기 | AppPerformanceCounters 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppPlatformLogsforSpring** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppPlatformLogsforSpring/읽기 | AppPlatformLogsforSpring 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppPlatformSystemLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppPlatformSystemLogs/read | AppPlatformSystemLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppRequests** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppRequests/read | AppRequests 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppServiceAppLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppServiceAppLogs/읽기 | AppServiceAppLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppServiceAuditLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppServiceAuditLogs/읽기 | AppServiceAuditLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppServiceConsoleLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppServiceConsoleLogs/읽기 | AppServiceConsoleLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/Appservice환경 Platformlogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/Appservice환경 Platformlogs/read | Appservice환경 Platformlogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppServiceFileAuditLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppServiceFileAuditLogs/읽기 | AppServiceFileAuditLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppServiceHTTPLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppServiceHTTPLogs/읽기 | AppServiceHTTPLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppSystemEvents** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppSystemEvents/읽기 | AppSystemEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AppTraces** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AppTraces/읽기 | AppTraces 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AuditLogs** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/AuditLogs/read | AuditLogs 테이블에서 데이터 읽기 |
> |  | **작업 영역/쿼리/AutoscaleEvaluationsLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AutoscaleEvaluationsLog/읽기 | AutoscaleEvaluationsLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AutoscaleScaleActionsLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AutoscaleScaleActionsLog/읽기 | AutoscaleScaleActionsLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AWSCloudTrail** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AWSCloudTrail/read | AWSCloudTrail 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AzureActivity** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/AzureActivity/read | AzureActivity 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/AzureAssessmentRecommendation** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/AzureAssessmentRecommendation/읽기 | AzureAssessmentRecommendation 테이블에서 데이터를 읽습니다. |
...
> |  | **작업 영역/쿼리/BaiClusterEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/BaiClusterEvent/읽기 | BaiClusterEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/BaiClusterNodeEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/BaiClusterNodeEvent/읽기 | BaiClusterNodeEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/BaiJobEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/BaiJobEvent/읽기 | BaiJobEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/BlockchainApplicationLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/BlockchainApplicationLog/읽기 | BlockchainApplicationLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/BlockchainProxyLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/BlockchainProxyLog/읽기 | BlockchainProxyLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/BoundPort** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/BoundPort/read | BoundPort 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/CommonSecurityLog** |  |
...
> |  | **작업 영역/쿼리/ConfigurationChange** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ConfigurationChange/read | ConfigurationChange 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ConfigurationData** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ConfigurationData/read | ConfigurationData 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerImageInventory** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ContainerImageInventory/read | ContainerImageInventory 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerInventory** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ContainerInventory/read | ContainerInventory 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerLog** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ContainerLog/read | ContainerLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerNodeInventory** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ContainerNodeInventory/읽기 | ContainerNodeInventory 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerRegistryLoginEvents** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ContainerRegistryLoginEvents/읽기 | ContainerRegistryLoginEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerRegistryRepositoryEvents** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ContainerRegistryRepositoryEvents/읽기 | ContainerRegistryRepositoryEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ContainerServiceLog** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/ContainerServiceLog/read | ContainerServiceLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/CoreAzureBackup** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/CoreAzureBackup/읽기 | CoreAzureBackup 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksAccounts** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksAccounts/읽기 | DatabricksAccounts 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksClusters** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksClusters/읽기 | DatabricksClusters 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksDBFS** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksDBFS/읽기 | DatabricksDBFS 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksInstancePools** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksInstancePools/읽기 | DatabricksInstancePools 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksJobs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksJobs/읽기 | DatabricksJobs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksNotebook** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksNotebook/읽기 | DatabricksNotebook 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksSecrets** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksSecrets/읽기 | DatabricksSecrets 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksSQLPermissions** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksSQLPermissions/읽기 | DatabricksSQLPermissions 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksSSH** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksSSH/읽기 | DatabricksSSH 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksTables** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksTables/읽기 | DatabricksTables 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DatabricksWorkspace** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/DatabricksWorkspace/읽기 | DatabricksWorkspace 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/종속성** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/종속성/읽기 | 종속성 테이블에서 데이터 읽기 |
> |  | **작업 영역/쿼리/DeviceAppCrash** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/DeviceAppCrash/read | DeviceAppCrash 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DeviceAppLaunch** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/DeviceAppLaunch/read | DeviceAppLaunch 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DeviceCalendar** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/DeviceCalendar/read | DeviceCalendar 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DeviceCleanup** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/DeviceCleanup/read | DeviceCleanup 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/DeviceConnectSession** |  |
...
> | 작업 | OperationalInsights/작업 영역/쿼리/DHCPActivity/read | DHCPActivity 테이블에서 데이터를 읽습니다. |
...
> |  | **작업 영역/쿼리/ExchangeAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/ExchangeOnlineAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/FailedIngestion** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/FailedIngestion/읽기 | FailedIngestion 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/FunctionAppLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/FunctionAppLogs/읽기 | FunctionAppLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/하트 비트** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/Heartbeat/read | Heartbeat 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/HuntingBookmark** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/HuntingBookmark/읽기 | HuntingBookmark 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/IISAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/InboundConnection** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/InboundConnection/read | InboundConnection 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/InsightsMetrics** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/InsightsMetrics/읽기 | InsightsMetrics 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/IntuneAuditLogs** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/IntuneAuditLogs/read | IntuneAuditLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/IntuneDeviceComplianceOrg** |  |
> | 작업 | OperationalInsights/workspaces/query/IntuneDeviceComplianceOrg/read | IntuneDeviceComplianceOrg 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/IntuneOperationalLogs** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/IntuneOperationalLogs/read | IntuneOperationalLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/IoTHubDistributedTracing** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/IoTHubDistributedTracing/읽기 | IoTHubDistributedTracing 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/KubeEvents** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/KubeEvents/read | KubeEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/KubeHealth** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/KubeHealth/읽기 | KubeHealth 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/KubeMonAgentEvents** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/KubeMonAgentEvents/읽기 | KubeMonAgentEvents 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/KubeNodeInventory** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/KubeNodeInventory/read | KubeNodeInventory 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/KubePodInventory** |  |
...
> |  | **작업 영역/쿼리/MAApplicationHealthIssues** |  |
...
> | 작업 | OperationalInsights/작업 영역/쿼리/MADeviceNRT/read | MADeviceNRT 테이블에서 데이터를 읽습니다. |
...
> |  | **작업 영역/쿼리/MADevicePnPHealthAlternativeVersions** |  |
...
> |  | **작업 영역/쿼리/MAOfficeAppCrashesNRT** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MAOfficeAppCrashesNRT/읽기 | MAOfficeAppCrashesNRT 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/p r o p e r** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppHealth/read | MAOfficeAppHealth 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/n e t Appinstance** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppInstance/read | MAOfficeAppInstance 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeAppInstanceHealth** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MAOfficeAppInstanceHealth/read | MAOfficeAppInstanceHealth 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeAppReadiness** |  |
...
> | 작업 | OperationalInsights/작업 영역/쿼리/MAOfficeAppSessionsNRT/read | MAOfficeAppSessionsNRT 테이블에서 데이터를 읽습니다. |
...
> |  | **작업 영역/쿼리/MAOfficeCurrencyAssessment** |  |
...
> |  | **작업 영역/쿼리/MAOfficeCurrencyAssessmentDailyCounts** |  |
...
> |  | **작업 영역/쿼리/MAOfficeDeploymentStatus** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/MAOfficeDeploymentStatus/read | MAOfficeDeploymentStatus 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeDeploymentStatusNRT** |  |
> | 작업 | OperationalInsights/workspaces/query/MAOfficeDeploymentStatusNRT/read | MAOfficeDeploymentStatusNRT 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeMacroErrorNRT** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MAOfficeMacroErrorNRT/읽기 | MAOfficeMacroErrorNRT 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeMacroGlobalHealth** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MAOfficeMacroGlobalHealth/읽기 | MAOfficeMacroGlobalHealth 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeMacroHealth** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/MAOfficeMacroHealth/read | MAOfficeMacroHealth 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAOfficeMacroHealthIssues** |  |
...
> |  | **작업 영역/쿼리/MAOfficeMacroIssueInstanceReadiness** |  |
...
> |  | **작업 영역/쿼리/MAOfficeMacroIssueReadiness** |  |
...
> |  | **작업 영역/쿼리/MAWindowsCurrencyAssessmentDailyCounts** |  |
...
> |  | **작업 영역/쿼리/MAWindowsDeploymentStatus** |  |
...
> | 작업 | OperationalInsights/작업 영역/쿼리/MAWindowsDeploymentStatusNRT/read | MAWindowsDeploymentStatusNRT 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MAWindowsSysReqInstanceReadiness** |  |
...
> |  | **작업 영역/쿼리/McasShadowItReporting** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/McasShadowItReporting/읽기 | McasShadowItReporting 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftAzureBastionAuditLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftAzureBastionAuditLogs/읽기 | MicrosoftAzureBastionAuditLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftDataShareReceivedSnapshotLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftDataShareReceivedSnapshotLog/읽기 | MicrosoftDataShareReceivedSnapshotLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftDataShareSentSnapshotLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftDataShareSentSnapshotLog/읽기 | MicrosoftDataShareSentSnapshotLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftDataShareShareLog** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftDataShareShareLog/읽기 | MicrosoftDataShareShareLog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftDynamicsTelemetryPerformanceLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftDynamicsTelemetryPerformanceLogs/읽기 | MicrosoftDynamicsTelemetryPerformanceLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftDynamicsTelemetrySystemMetricsLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftDynamicsTelemetrySystemMetricsLogs/읽기 | MicrosoftDynamicsTelemetrySystemMetricsLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/MicrosoftHealthcareApisAuditLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/MicrosoftHealthcareApisAuditLogs/읽기 | MicrosoftHealthcareApisAuditLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/네트워크 모니터링** |  |
...
> |  | **작업 영역/쿼리/SCOMAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SecurityBaselineSummary** |  |
...
> |  | **작업 영역/쿼리/SecurityIoTRawEvent** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SecurityIoTRawEvent/읽기 | SecurityIoTRawEvent 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/보안 권장 사항** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/보안 권장 사항/읽기 | SecurityRecommendation 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/ServiceFabricOperationalEvent** |  |
...
> |  | **작업 영역/쿼리/ServiceFabricReliableActorEvent** |  |
...
> |  | **작업 영역/쿼리/ServiceFabricReliableServiceEvent** |  |
...
> |  | **작업 영역/쿼리/SfBAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SfBOnlineAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SharePointOnlineAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SignalRServiceDiagnosticLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SignalRServiceDiagnosticLogs/읽기 | SignalRServiceDiagnosticLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SigninLogs** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/SigninLogs/read | SigninLogs 테이블에서 데이터 읽기 |
> |  | **작업 영역/쿼리/SPAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SQLAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/SqlDataClassification** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SqlDataClassification/읽기 | SqlDataClassification 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SQLQueryPerformance** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/SQLQueryPerformance/read | SQLQueryPerformance 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SqlThreatProtectionLoginAudits** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SqlThreatProtectionLoginAudits/읽기 | SqlThreatProtectionLoginAudits 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SqlVulnerabilityAssessmentResult** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SqlVulnerabilityAssessmentResult/읽기 | SqlVulnerabilityAssessmentResult 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/StorageBlobLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/StorageBlobLogs/읽기 | StorageBlobLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/StorageFileLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/StorageFileLogs/read | StorageFileLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/StorageQueueLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/StorageQueueLogs/읽기 | StorageQueueLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/StorageTableLogs** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/StorageTableLogs/read | StorageTableLogs 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SucceededIngestion** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/SucceededIngestion/읽기 | SucceededIngestion 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/Syslog** |  |
> | 작업 | Microsoft.OperationalInsights/workspaces/query/Syslog/read | Syslog 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/SysmonEvent** |  |
...
> |  | **작업 영역/쿼리/ThreatIntelligenceIndicator** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/ThreatIntelligenceIndicator/읽기 | ThreatIntelligenceIndicator 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/UAApp** |  |
...
> |  | **작업 영역/쿼리/WindowsClientAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/WindowsServerAssessmentRecommendation** |  |
...
> |  | **작업 영역/쿼리/WVDCheckpoints** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDCheckpoints/읽기 | WVDCheckpoints 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/WVDConnections** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDConnections/읽기 | WVDConnections 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/WVDErrors** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDErrors/읽기 | WVDErrors 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/WVDFeeds** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDFeeds/읽기 | WVDFeeds 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/WVDHostRegistrations** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDHostRegistrations/읽기 | WVDHostRegistrations 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/쿼리/WVDManagement** |  |
> | 작업 | OperationalInsights/작업 영역/쿼리/WVDManagement/읽기 | WVDManagement 테이블에서 데이터를 읽습니다. |
> |  | **작업 영역/규칙** |  |
...
> |  | **작업 영역/scopedPrivateLinkProxies** |  |
> | 작업 | operationalinsights/작업 영역/scopedPrivateLinkProxies/읽기 | 범위가 지정 된 개인 링크 프록시를 가져옵니다. |
> | 작업 | operationalinsights/작업 영역/scopedPrivateLinkProxies/쓰기 | 범위가 지정 된 개인 링크 프록시를 추가 합니다. |
> | 작업 | operationalinsights/작업 영역/scopedPrivateLinkProxies/삭제 | 범위가 지정 된 개인 링크 프록시를 삭제 합니다. |
> |  | **작업 영역/검색** |  |
...
> |  | **작업 영역/upgradetranslationfailures** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft.PolicyInsights/register/action | Microsoft Policy Insights 리소스 공급자를 등록 하 고 작업을 사용 하도록 설정 합니다. |
> | 작업 | Microsoft. PolicyInsights/등록 취소/작업 | Microsoft Policy Insights 리소스 공급자를 등록 취소 합니다. |
> |  | **asyncOperationResults** |  |
> | 작업 | Microsoft.PolicyInsights/asyncOperationResults/read | 비동기 작업 결과를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft. PolicyInsights/작업/읽기 | Microsoft PolicyInsights 네임 스페이스에 대해 지원 되는 작업을 가져옵니다. |
> |  | **policyEvents** |  |
...
> |  | **policyMetadata** |  |
> | 작업 | Microsoft. PolicyInsights/Policyinsights/read | 정책 메타 데이터 리소스를 가져옵니다. |
> |  | **policyStates** |  |
...
> | 작업 | Microsoft.PolicyInsights/remediations/write | Microsoft Policy 재구성를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.PolicyInsights/remediations/delete | 정책 수정을 삭제합니다. |
> | 작업 | Microsoft.PolicyInsights/remediations/cancel/action | 진행 중인 Microsoft Policy 재구성를 취소 합니다. |
> |  | **재구성/listDeployments** |  |
...
> |  | **consoles** |  |
> | 작업 | Microsoft.Portal/consoles/delete | Cloud Shell 인스턴스를 제거 합니다. |
> | 작업 | Microsoft.Portal/consoles/write | Cloud Shell 인스턴스를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft. 포털/콘솔/읽기 | Cloud Shell 인스턴스를 읽습니다. |
> |  | **대시보드** |  |
...
> |  | **usersettings** |  |
> | 작업 | Microsoft.Portal/usersettings/delete | Cloud Shell 사용자 설정을 제거 합니다. |
> | 작업 | Microsoft.Portal/usersettings/write | 사용자 설정 Cloud Shell 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.Portal/usersettings/read | Cloud Shell 사용자 설정을 읽습니다. |
...
> |  | **위치도** |  |
> | 작업 | Microsoft. PowerBIDedicated/위치/checkNameAvailability/action | 지정된 Power BI 전용 용량 이름이 올바르고 사용 중이 아닌지 확인합니다. |
> |  | **위치/operationresults** |  |
...
> |  | **위치/backupProtectedItem** |  |
> | 작업 | Microsoft RecoveryServices/위치/backupProtectedItem/쓰기 | 백업 보호 항목을 만듭니다. |
> |  | **위치/backupProtectedItems** |  |
> | 작업 | Microsoft RecoveryServices/위치/backupProtectedItems/읽기 | 모든 보호 항목 목록을 반환합니다. |
> |  | **위치/operationStatus** |  |
...
> |  | **자격 증명 모음/backupEncryptionConfigs** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/backupEncryptionConfigs/읽기 | 백업 리소스 암호화 구성을 가져옵니다. |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/backupEncryptionConfigs/쓰기 | 백업 리소스 암호화 구성을 업데이트 합니다. |
> |  | **자격 증명 모음/backupEngines** |  |
> | 작업 | Microsoft.RecoveryServices/Vaults/backupEngines/read | 자격 증명 모음에 등록된 모든 백업 관리 서버를 반환합니다. |
> |  | **자격 증명 모음/backupFabrics** |  |
> | 작업 | Microsoft.RecoveryServices/Vaults/backupFabrics/refreshContainers/action | 컨테이너 목록을 새로 고칩니다. |
> |  | **자격 증명 모음/backupFabrics/backupProtectionIntent** |  |
...
> |  | **자격 증명 모음/backupFabrics/operationResults** |  |
> | 작업 | Microsoft.RecoveryServices/Vaults/backupFabrics/operationResults/read | 작업의 상태를 반환합니다. |
> |  | **자격 증명 모음/backupFabrics/operationsStatus** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/operationsStatus/읽기 | 작업의 상태를 반환합니다. |
> |  | **자격 증명 모음/backupFabrics/protectableContainers** |  |
> | 작업 | Microsoft.RecoveryServices/Vaults/backupFabrics/protectableContainers/read | 보호 가능한 컨테이너를 모두 가져옵니다. |
> |  | **자격 증명 모음/backupFabrics/protectionContainers** |  |
...
> |  | **자격 증명 모음/backupFabrics/protectionContainers/항목** |  |
> | 작업 | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/items/read | 컨테이너의 모든 항목을 가져옵니다. |
> |  | **자격 증명 모음/backupFabrics/protectionContainers/operationResults** |  |
...
> |  | **자격 증명 모음/backupFabrics/protectionContainers/operationsStatus** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/protectionContainers/operationsStatus/read | 보호 컨테이너에 대해 수행 된 작업의 상태를 가져옵니다. |
> |  | **자격 증명 모음/backupFabrics/protectionContainers/protectedItems** |  |
...
> |  | **자격 증명 모음/backupFabrics/protectionContainers/protectedItems/operationResults** |  |
...
> |  | **자격 증명 모음/backupFabrics/protectionContainers/protectedItems/operationsStatus** |  |
...
> |  | **자격 증명 모음/backupFabrics/protectionContainers/protectedItems/recoveryPoints** |  |
...
> |  | **자격 증명 모음/백업 정책/operationResults** |  |
...
> |  | **자격 증명 모음/monitoringConfigurations** |  |
...
> |  | **자격 증명 모음/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnectionProxies/삭제 | 몇 분간 기다린 다음 작업을 다시 시도하세요. 문제가 지속되면 Microsoft 지원에 문의하세요. |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnectionProxies/읽기 | 보호 가능한 컨테이너를 모두 가져옵니다. |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnectionProxies/유효성 검사/작업 | 보호 가능한 컨테이너를 모두 가져옵니다. |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnectionProxies/쓰기 | 보호 가능한 컨테이너를 모두 가져옵니다. |
> |  | **자격 증명 모음/privateEndpointConnectionProxies/operationsStatus** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnectionProxies/operationsStatus/읽기 | 보호 가능한 컨테이너를 모두 가져옵니다. |
> |  | **자격 증명 모음/privateEndpointConnections** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnections/삭제 | 개인 끝점 요청을 삭제 합니다. 이 호출은 Backup 관리자에 의해 수행 됩니다. |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnections/쓰기 | 개인 끝점 요청을 승인 또는 거부 합니다. 이 호출은 Backup 관리자에 의해 수행 됩니다. |
> |  | **자격 증명 모음/privateEndpointConnections/operationsStatus** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/privateEndpointConnections/operationsStatus/읽기 | 개인 끝점 연결에 대 한 작업 상태를 반환 합니다. |
> |  | **자격 증명 모음/registeredIdentities** |  |
...
> |  | **자격 증명 모음/registeredIdentities/operationResults** |  |
...
> |  | **자격 증명 모음/replicationAlertSettings** |  |
...
> |  | **자격 증명 모음/replicationFabrics/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/operationresults/read | 리소스 패브릭에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationLogicalNetworks** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationLogicalNetworks/read | 논리 네트워크를 읽습니다. |
> |  | **자격 증명 모음/replicationFabrics/replicationNetworks** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationNetworks/read | 네트워크를 읽습니다. |
> |  | **자격 증명 모음/replicationFabrics/replicationNetworks/replicationNetworkMappings** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/operationresults/read | 리소스 보호 컨테이너에서 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems** |  |
...
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/다시 동기화/작업 | 다시 동기화 |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/migrationRecoveryPoints** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/operationresults/read | 리소스 마이그레이션 항목에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectableItems** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems** |  |
...
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/addDisks/작업 | 디스크 추가 |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/removeDisks/작업 | 디스크 제거 |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/ResolveHealthErrors/action |  |
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/operationresults/read | 리소스 보호 항목에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/recoveryPoints** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/targetComputeSizes** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/operationresults/read | 리소스 보호 컨테이너 매핑에서 비동기 작업의 결과를 추적 합니다. |
> |  | **자격 증명 모음/replicationFabrics/replicationRecoveryServicesProviders** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationRecoveryServicesProviders/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationRecoveryServicesProviders/operationresults/read | 리소스 Recovery Services 공급자에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationStorageClassifications** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationStorageClassifications/read | 스토리지 분류를 읽습니다. |
> |  | **자격 증명 모음/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationStorageClassifications/replicationStorageClassificationMappings/operationresults/read | 리소스 저장소 분류 매핑에서 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationFabrics/replicationvCenters** |  |
...
> |  | **자격 증명 모음/replicationFabrics/replicationvCenters/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationvCenters/operationresults/read | 리소스 \ 리소스에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationJobs** |  |
...
> |  | **자격 증명 모음/replicationJobs/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationJobs/operationresults/read | 리소스 작업에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationMigrationItems** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationMigrationItems/read | 마이그레이션 항목을 읽습니다. |
> |  | **자격 증명 모음/replicationNetworkMappings** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationNetworkMappings/read | 네트워크 매핑을 읽습니다. |
> |  | **자격 증명 모음/replicationNetworks** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationNetworks/read | 네트워크를 읽습니다. |
> |  | **자격 증명 모음/replicationOperationStatus** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationOperationStatus/읽기 | 자격 증명 모음 복제 작업 상태를 읽습니다. |
> |  | **자격 증명 모음/replicationPolicies** |  |
...
> |  | **자격 증명 모음/replicationPolicies/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationPolicies/operationresults/read | 리소스 정책에 대 한 비동기 작업의 결과 추적 |
> |  | **자격 증명 모음/replicationProtectedItems** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationProtectedItems/read | 보호된 항목을 읽습니다. |
> |  | **자격 증명 모음/replicationProtectionContainerMappings** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationProtectionContainerMappings/read | 보호 컨테이너 매핑을 읽습니다. |
> |  | **자격 증명 모음/replicationProtectionContainers** |  |
> | 작업 | Microsoft.RecoveryServices/vaults/replicationProtectionContainers/read | 보호 컨테이너를 읽습니다. |
> |  | **자격 증명 모음/replicationRecoveryPlans** |  |
...
> |  | **자격 증명 모음/replicationVaultHealth/operationresults** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationVaultHealth/operationresults/read | 리소스 자격 증명 모음 복제 상태에 대 한 비동기 작업의 결과를 추적 합니다. |
> |  | **자격 증명 모음/replicationVaultSettings** |  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationVaultSettings/읽기 | 모든 항목을 읽습니다.  |
> | 작업 | Microsoft RecoveryServices/자격 증명 모음/replicationVaultSettings/쓰기 | 만들기 또는 업데이트  |
> |  | **자격 증명 모음/replicationvCenters** |  |
...
> |  | **네임 스페이스/HybridConnections/authorizationRules** |  |
...
> |  | **네임 스페이스/네트워크 규칙 집합** |  |
> | 작업 | Microsoft. Relay/네임 스페이스/networkrulesets 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 작업 | Microsoft. Relay/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 작업 | Microsoft. Relay/네임 스페이스/networkrulesets 집합/삭제 | VNET 규칙 리소스 삭제 |
> |  | **네임 스페이스/operationresults** |  |
> | 작업 | Microsoft.Relay/namespaces/operationresults/read | 네임스페이스 작업의 상태를 가져옵니다. |
> |  | **네임 스페이스/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft. Relay/네임 스페이스/privateEndpointConnectionProxies/유효성 검사/작업 | 개인 끝점 연결 프록시 유효성 검사 |
> | 작업 | Microsoft. Relay/네임 스페이스/privateEndpointConnectionProxies/읽기 | 개인 끝점 연결 프록시 가져오기 |
> | 작업 | Microsoft. Relay/네임 스페이스/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 |
> | 작업 | Microsoft. Relay/네임 스페이스/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시 삭제 |
> |  | **네임 스페이스/공급자/Microsoft diagnosticSettings/** |  |
> | 작업 | Microsoft. Relay/네임 스페이스/공급자/Microsoft/diagnosticSettings/read | 네임스페이스 진단 설정 리소스 설명의 목록을 가져옵니다. |
> | 작업 | Microsoft. Relay/네임 스페이스/공급자/Microsoft/diagnosticSettings/write | 네임스페이스 진단 설정 리소스 설명의 목록을 가져옵니다. |
> |  | **네임 스페이스/공급자/Microsoft의 Insights/logDefinitions** |  |
> | 작업 | Microsoft. Relay/네임 스페이스/공급자/Microsoft의 Insights/logDefinitions/읽기 | 네임스페이스 로그 리소스 설명의 목록을 가져옵니다. |
> |  | **네임 스페이스/공급자/Microsoft metricDefinitions/** |  |
...
> |  | **네임 스페이스/WcfRelays/authorizationRules** |  |
...
> |  | **emergingissues** |  |
> | 작업 | Microsoft ResourceHealth/emergingissues/read | Azure 서비스의 새로운 문제 얻기 |
> |  | **이벤트** |  |
...
> | 작업 | CalculateTemplateHash/작업 | 제공 된 템플릿의 해시를 계산 합니다. |
> |  | **checkPolicyCompliance** |  |
> | 작업 | Microsoft .Resources/checkPolicyCompliance/읽기 | 지정된 리소스의 준수 상태를 리소스 정책과 비교하여 확인합니다. |
> |  | **배포** |  |
...
> | 작업 | Microsoft .Resources/배포/p i/작업 | 템플릿 배포 변경 사항을 예측 합니다. |
> | 작업 | Microsoft .Resources/배포/내보내기 템플릿/작업 | 배포용 템플릿 내보내기 |
> |  | **배포/작업** |  |
> | 작업 | Microsoft.Resources/deployments/operations/read | 배포 작업을 가져오거나 나열합니다. |
> |  | **배포/operationstatuses** |  |
> | 작업 | Microsoft .Resources/배포/operationstatuses/읽기 | 배포 작업 상태를 가져오거나 나열합니다. |
> |  | **deploymentScripts** |  |
> | 작업 | Microsoft .Resources/deploymentScripts/read | 배포 스크립트를 가져오거나 나열 합니다. |
> | 작업 | Microsoft .Resources/deploymentScripts/write | 배포 스크립트를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft .Resources/deploymentScripts/delete | 배포 스크립트를 삭제 합니다. |
> |  | **deploymentScripts/logs** |  |
> | 작업 | Microsoft .Resources/deploymentScripts/logs/read | 배포 스크립트 로그를 가져오거나 나열 합니다. |
> |  | **링크만** |  |
...
> |  | **subscription/resourcegroups/배포** |  |
...
> |  | **사이** |  |
> | 작업 | Microsoft .Resources/tags/read | 리소스의 모든 태그를 가져옵니다. |
> | 작업 | Microsoft .Resources/tags/write | 기존 태그를 새 태그 집합으로 대체 하거나 병합 하거나 기존 태그를 제거 하 여 리소스에 대 한 태그를 업데이트 합니다. |
> | 작업 | Microsoft .Resources/tags/delete | 리소스의 모든 태그를 제거 합니다. |
> |  | **테 넌 트** |  |
...
> |  | **jobcollections/jobs/jobcollections** |  |
...
> | 작업 | Microsoft. 검색/searchServices/listQueryKeys/action | 지정된 Azure Search 서비스에 대한 쿼리 API 키 목록을 반환합니다. |
...
> | 작업 | Microsoft. 검색/searchServices/privateEndpointConnectionProxies/유효성 검사/작업 | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 작업 | Microsoft. 검색/searchServices/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 작업 | Microsoft. 검색/searchServices/privateEndpointConnectionProxies/읽기 | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft. 검색/searchServices/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
...
> | 작업 | Microsoft. Security/adaptiveNetworkHardenings/read | Azure로 보호 되는 리소스의 적응 네트워크 강화 권장 사항을 가져옵니다. |
> | 작업 | Microsoft. Security/adaptiveNetworkHardenings/적용/작업 | 지정 된 네트워크 보안 그룹에서 일치 하는 보안 규칙을 만들어 지정 된 트래픽 강화 규칙을 적용 합니다. |
...
> |  | **assessmentMetadata** |  |
> | 작업 | Microsoft. Security/assessmentMetadata/read | 구독에서 사용 가능한 보안 평가 메타 데이터 가져오기 |
> | 작업 | Microsoft. Security/assessmentMetadata/write | 보안 평가 메타 데이터를 만들거나 업데이트 합니다. |
> |  | **인사** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft SecurityInsights/register/action | Azure 센티널에 구독을 등록 합니다. |
> | 작업 | Microsoft SecurityInsights/등록 취소/작업 | Azure 센티널에서 구독의 등록을 취소 합니다. |
> | 작업 | DataConnectorsCheckRequirements/작업 | 사용자 권한 부여 및 라이선스 확인 |
> |  | **집계** |  |
> | 작업 | Microsoft SecurityInsights/집계/읽기 | 집계 된 정보를 가져옵니다. |
> |  | **alertRules** |  |
> | 작업 | Microsoft SecurityInsights/alertRules/read | 경고 규칙을 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/alertRules/write | 경고 규칙 업데이트 |
> | 작업 | Microsoft SecurityInsights/alertRules/delete | 경고 규칙 삭제 |
> |  | **alertRules/작업** |  |
> | 작업 | AlertRules/작업/읽기 | 경고 규칙의 응답 작업을 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/alertRules/actions/write | 경고 규칙의 응답 작업을 업데이트 합니다. |
> | 작업 | AlertRules/작업/삭제 | 경고 규칙의 응답 작업을 삭제 합니다. |
> |  | **책갈피** |  |
> | 작업 | Microsoft SecurityInsights/책갈피/읽기 | 책갈피를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/책갈피/쓰기 | 책갈피 업데이트 |
> | 작업 | Microsoft SecurityInsights/책갈피/삭제 | 책갈피를 삭제 합니다. |
> | 작업 | Microsoft SecurityInsights/책갈피/확장/작업 | 특정 확장에 의해 엔터티의 관련 엔터티를 가져옵니다. |
> |  | **경우** |  |
> | 작업 | Microsoft SecurityInsights/사례/읽기 | 대/소문자를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/case/write | 사례를 업데이트 합니다. |
> | 작업 | Microsoft SecurityInsights/case/delete | 사례를 삭제 합니다. |
> |  | **사례/설명** |  |
> | 작업 | Microsoft SecurityInsights/사례/설명/읽기 | 사례 주석을 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/case/comments/write | 사례 주석을 만듭니다. |
> |  | **사례/조사** |  |
> | 작업 | Microsoft SecurityInsights/사례/조사/읽기 | 대/소문자 조사를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/사례/조사/쓰기 | 사례의 메타 데이터를 업데이트 합니다. |
> |  | **dataConnectors** |  |
> | 작업 | Microsoft SecurityInsights/dataConnectors/read | 데이터 커넥터를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/dataConnectors/write | 데이터 커넥터를 업데이트 합니다. |
> | 작업 | Microsoft SecurityInsights/dataConnectors/delete | 데이터 커넥터를 삭제 합니다. |
> |  | **사고** |  |
> | 작업 | Microsoft SecurityInsights/인시던트/읽기 | 인시던트를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/인시던트/쓰기 | 인시던트를 업데이트 합니다. |
> | 작업 | Microsoft SecurityInsights/인시던트/삭제 | 인시던트를 삭제 합니다. |
> |  | **인시던트/설명** |  |
> | 작업 | Microsoft SecurityInsights/인시던트/의견/읽기 | 인시던트 주석을 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/인시던트/의견/쓰기 | 인시던트에 대 한 설명을 만듭니다. |
> |  | **인시던트/관계** |  |
> | 작업 | Microsoft SecurityInsights/인시던트/관계/읽기 | 인시던트 및 관련 리소스 간의 관계를 가져옵니다. |
> | 작업 | Microsoft SecurityInsights/인시던트/관계/쓰기 | 인시던트 및 관련 리소스 간의 관계를 업데이트 합니다. |
> | 작업 | Microsoft SecurityInsights/인시던트/관계/삭제 | 인시던트 및 관련 리소스 간의 관계를 삭제 합니다. |
> |  | **설정** |  |
...
> |  | **네임 스페이스/migrationConfigurations** |  |
...
> |  | **네임 스페이스/네트워크 규칙 집합** |  |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
> |  | **네임 스페이스/네트워크 규칙 집합** |  |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/읽기 | NetworkRuleSet 집합 리소스를 가져옵니다. |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/쓰기 | VNET 규칙 리소스 만들기 |
> | 작업 | ServiceBus/네임 스페이스/네트워크 규칙 집합/삭제 | VNET 규칙 리소스 삭제 |
...
> |  | **네임 스페이스/privateEndpointConnectionProxies** |  |
> | 작업 | ServiceBus/네임 스페이스/privateEndpointConnectionProxies/유효성 검사/작업 | 개인 끝점 연결 프록시 유효성 검사 |
> | 작업 | ServiceBus/네임 스페이스/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | 작업 | ServiceBus/네임 스페이스/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 |
> | 작업 | ServiceBus/네임 스페이스/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시 삭제 |
> |  | **네임 스페이스/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **네임 스페이스/메시지** |  |
> | DataAction | ServiceBus/네임 스페이스/메시지/송신/동작 | 메시지 보내기 |
> | DataAction | ServiceBus/네임 스페이스/메시지/수신/동작 | 메시지 받기 |
...
> |  | **위치/operationresults/signalr** |  |
> | 작업 | Microsoft.SignalRService/locations/operationresults/signalr/read | 위치 기반 비동기 작업의 결과를 쿼리 합니다. |
> |  | **위치/operationStatuses/operationId** |  |
> | 작업 | SignalRService/위치/operationStatuses/operationId/읽기 | 위치 기반 비동기 작업의 상태 쿼리 |
> |  | **위치/용도** |  |
> | 작업 | Microsoft.SignalRService/locations/usages/read | Azure SignalR 서비스에 대한 할당량 사용량을 가져옵니다. |
> |  | **operationresults** |  |
> | 작업 | Microsoft.SignalRService/operationresults/read | 공급자 수준 비동기 작업의 결과를 쿼리 합니다. |
> |  | **작업도** |  |
> | 작업 | SignalRService/작업/읽기 | Azure SignalR service에 대 한 작업을 나열 합니다. |
> |  | **operationstatus** |  |
> | 작업 | SignalRService/operationstatus/read | 공급자 수준 비동기 작업의 상태 쿼리 |
> |  | **SignalR** |  |
...
> | 작업 | SignalRService/SignalR/eventGridFilters/read | 지정 된 event grid 필터의 속성을 가져오거나 지정 된 SignalR에 대 한 모든 event grid 필터를 나열 합니다. |
> | 작업 | SignalRService/SignalR/eventGridFilters/write | 지정 된 매개 변수를 사용 하 여 SignalR에 대 한 event grid 필터를 만들거나 업데이트 합니다. |
> | 작업 | SignalRService/SignalR/eventGridFilters/delete | SignalR에서 event grid 필터를 삭제 합니다. |
> |  | **SignalR/privateEndpointConnectionProxies** |  |
> | 작업 | SignalRService/SignalR/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 프록시 유효성 검사 |
> | 작업 | SignalRService/SignalR/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 |
> | 작업 | SignalRService/SignalR/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 읽기 |
> | 작업 | SignalRService/SignalR/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **SignalR/privateEndpointConnections** |  |
> | 작업 | SignalRService/SignalR/privateEndpointConnections/write | 개인 끝점 연결 승인 또는 거부 |
...
> | 작업 | Microsoft. 솔루션/등록 취소/작업 | 솔루션에서 등록을 취소 합니다. |
...
> | 작업 | Microsoft Solutions/applicationDefinitions/Applicationdefinitions/읽기 | 응용 프로그램 정의의 응용 프로그램 아티팩트를 나열 합니다. |
> |  | **프로그램도** |  |
...
> | 작업 | Microsoft 솔루션/응용 프로그램/refreshPermissions/작업 | 응용 프로그램 사용 권한을 새로 고칩니다. |
> | 작업 | Microsoft. Solutions/applications/updateAccess/action | 응용 프로그램 액세스를 업데이트 합니다. |
> |  | **응용 프로그램/a p i 아티팩트** |  |
> | 작업 | Microsoft. 솔루션/응용 프로그램/a p i 아티팩트/읽기 | 응용 프로그램 아티팩트를 나열 합니다. |
> |  | **jitRequests** |  |
...
> |  | **작업도** |  |
> | 작업 | Microsoft. 솔루션/작업/읽기 | 작업 목록을 가져옵니다. |

## <a name="microsoftsql"></a>Microsoft.Sql

Azure 서비스: [Azure SQL Database](../sql-database/index.yml), [SQL Data Warehouse](../sql-data-warehouse/index.yml)
...
> | 작업 | Microsoft .Sql/privateEndpointConnectionsApproval/action | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
> |  | **instancePools** |  |
...
> |  | **위치/elasticPoolAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/elasticPoolAzureAsyncOperation/read | 탄력적 풀 비동기 작업에 대한 azure 비동기 작업을 가져옵니다. |
> |  | **위치/elasticPoolOperationResults** |  |
> | 작업 | Microsoft.Sql/locations/elasticPoolOperationResults/read | 탄력적 풀 작업의 결과를 가져옵니다. |
> |  | **위치/encryptionProtectorAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/encryptionProtectorAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/encryptionProtectorOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/encryptionProtectorOperationResults/읽기 | 투명 한 데이터 암호화 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/extendedAuditingSettingsAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/extendedAuditingSettingsAzureAsyncOperation/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
> |  | **위치/extendedAuditingSettingsOperationResults** |  |
> | 작업 | Microsoft.Sql/locations/extendedAuditingSettingsOperationResults/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
> |  | **위치/firewallRulesAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/firewallRulesAzureAsyncOperation/read | 방화벽 규칙 작업의 상태를 가져옵니다. |
> |  | **위치/firewallRulesOperationResults** |  |
...
> | 작업 | Microsoft.Sql/locations/instanceFailoverGroups/write | 지정한 매개 변수를 사용 하 여 인스턴스 장애 조치 (failover) 그룹을 만들거나 지정 된 인스턴스 장애 조치 (failover) 그룹의 속성 또는 태그를 업데이트 합니다 |
...
> |  | **위치/instancePoolAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/instancePoolAzureAsyncOperation/read | 인스턴스 풀 작업의 상태를 가져옵니다. |
> |  | **위치/instancePoolOperationResults** |  |
> | 작업 | Microsoft.Sql/locations/instancePoolOperationResults/read | 인스턴스 풀 작업의 결과를 가져옵니다. |
> |  | **위치/interfaceEndpointProfileAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/interfaceEndpointProfileAzureAsyncOperation/read | 특정 인터페이스 엔드포인트 Azure 비동기 작업의 세부 정보를 반환합니다. |
> |  | **위치/인터페이스-Endpointprofileoperationresults** |  |
> | 작업 | Microsoft.Sql/locations/interfaceEndpointProfileOperationResults/read | 지정된 인터페이스 엔드포인트 프로필 작업의 세부 정보를 반환합니다. |
> |  | **위치/jobAgentAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/jobAgentAzureAsyncOperation/read | 작업 에이전트 작업의 상태를 가져옵니다. |
> |  | **위치/jobAgentOperationResults** |  |
> | 작업 | Microsoft.Sql/locations/jobAgentOperationResults/read | 작업 에이전트 작업의 결과를 가져옵니다. |
> |  | **위치/longTermRetentionBackups** |  |
> | 작업 | Microsoft.Sql/locations/longTermRetentionBackups/read | 위치에 있는 모든 서버의 모든 데이터베이스에 대한 장기 보존 백업을 나열합니다. |
> |  | **위치/longTermRetentionManagedInstanceBackups** |  |
> | 작업 | Microsoft .Sql/위치/longTermRetentionManagedInstanceBackups/읽기 | 특정 위치에 대 한 관리 되는 인스턴스 LTR 백업 목록을 반환 합니다.  |
> |  | **위치/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups** |  |
> | 작업 | Microsoft .Sql/위치/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/read | 관리 되는 인스턴스 데이터베이스의 LTR 백업 목록을 반환 합니다. |
> | 작업 | Microsoft .Sql/위치/longTermRetentionManagedInstances/longTermRetentionDatabases/longTermRetentionManagedInstanceBackups/delete | 관리 되는 인스턴스 데이터베이스의 LTR 백업을 삭제 합니다. |
> |  | **위치/longTermRetentionManagedInstances/longTermRetentionManagedInstanceBackups** |  |
> | 작업 | Microsoft .Sql/위치/longTermRetentionManagedInstances/longTermRetentionManagedInstanceBackups/읽기 | 특정 관리 되는 인스턴스에 대 한 관리 되는 인스턴스 LTR 백업 목록을 반환 합니다. |
> |  | **위치/longTermRetentionServers/longTermRetentionBackups** |  |
> | 작업 | Microsoft.Sql/locations/longTermRetentionServers/longTermRetentionBackups/read | 서버의 모든 데이터베이스에 대한 장기 보존 백업을 나열합니다. |
> |  | **위치/longTermRetentionServers/longTermRetentionDatabases/longTermRetentionBackups** |  |
...
> |  | **위치/managedDatabaseRestoreAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/managedDatabaseRestoreAzureAsyncOperation/completeRestore/action | 관리되는 데이터베이스 복원 작업을 완료합니다. |
> |  | **위치/managedInstanceEncryptionProtectorAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/managedInstanceEncryptionProtectorAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/managedInstanceEncryptionProtectorOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/managedInstanceEncryptionProtectorOperationResults/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 암호화 보호기에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/managedInstanceKeyAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/managedInstanceKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 관리 되는 인스턴스 키에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/managedInstanceKeyOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/managedInstanceKeyOperationResults/read | 투명 한 데이터 암호화 관리 되는 인스턴스 키에서 진행 중인 작업을 가져옵니다. |
> |  | **위치/managedInstanceLongTermRetentionPolicyAzureAsyncOperation** |  |
...
> |  | **위치/privateEndpointConnectionOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/privateEndpointConnectionProxyAzureAsyncOperation/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/privateEndpointConnectionProxyOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/privateEndpointConnectionProxyOperationResults/읽기 | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
> |  | **위치/serverAdministratorAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/serverAdministratorAzureAsyncOperation/읽기 | 서버 Azure Active Directory 관리자의 비동기 작업 결과 |
> |  | **위치/Server관리자 Operationresults** |  |
> | 작업 | Microsoft .Sql/위치/Server관리자 Operationresults/read | 서버 Azure Active Directory 관리자 작업 결과 |
> |  | **위치/serverKeyAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/serverKeyAzureAsyncOperation/읽기 | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **위치/serverKeyOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
> |  | **위치/shortTermRetentionPolicyOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/shortTermRetentionPolicyOperationResults/읽기 | 단기 보존 정책 작업의 상태를 가져옵니다. |
> |  | **위치/i n t e r Operationresults** |  |
...
> |  | **위치/시간 영역** |  |
> | 작업 | Microsoft .Sql/위치/시간 영역/읽기 | 위치로 관리 되는 인스턴스 표준 시간대 목록을 반환 합니다. |
> |  | **위치/transparentDataEncryptionAzureAsyncOperation** |  |
> | 작업 | Microsoft .Sql/위치/transparentDataEncryptionAzureAsyncOperation/읽기 | 논리적 데이터베이스 투명 한 데이터 암호화에 대해 진행 중인 작업을 가져옵니다. |
> |  | **위치/transparentDataEncryptionOperationResults** |  |
> | 작업 | Microsoft .Sql/위치/transparentDataEncryptionOperationResults/읽기 | 논리적 데이터베이스 투명 한 데이터 암호화에 대해 진행 중인 작업을 가져옵니다. |
> |  | **위치/용도** |  |
> | 작업 | Microsoft.Sql/locations/usages/read | 한 위치에서 이 구독의 사용량 메트릭 컬렉션을 가져옵니다. |
> |  | **위치/virtualNetworkRulesAzureAsyncOperation** |  |
> | 작업 | Microsoft.Sql/locations/virtualNetworkRulesAzureAsyncOperation/read | 지정된 가상 네트워크 규칙 azure 비동기 작업의 세부 정보를 반환합니다.  |
> |  | **위치/virtualNetworkRulesOperationResults** |  |
...
> | 작업 | Microsoft .Sql/managedInstances/databases/completeRestore/action | 관리되는 데이터베이스 복원 작업을 완료합니다. |
> |  | **managedInstances/databases/backupLongTermRetentionPolicies** |  |
> | 작업 | Microsoft .Sql/managedInstances/databases/backupLongTermRetentionPolicies/write | 관리 되는 데이터베이스에 대 한 장기 보존 정책을 업데이트 합니다. |
> | 작업 | Microsoft .Sql/managedInstances/databases/backupLongTermRetentionPolicies/read | 관리 되는 데이터베이스에 대 한 장기 보존 정책을 가져옵니다. |
...
> | 작업 | Microsoft .Sql/managedInstances/데이터베이스/열/읽기 | 관리 되는 데이터베이스에 대 한 열 목록 반환 |
...
> | 작업 | Microsoft .Sql/managedInstances/databases/currentSensitivityLabels/write | 일괄 업데이트 민감도 레이블 |
> |  | **managedInstances/databases/providers/diagnosticSettings/Microsoft** |  |
...
> | 작업 | Microsoft .Sql/managedInstances/databases/restoreDetails/read | 복원이 진행 되는 동안 관리 되는 데이터베이스 복원 세부 정보를 반환 합니다. |
> |  | **managedInstances/데이터베이스/스키마** |  |
> | 작업 | Microsoft .Sql/managedInstances/databases/스키마/읽기 | 관리 되는 데이터베이스 스키마를 가져옵니다. |
> |  | **managedInstances/데이터베이스/스키마/테이블** |  |
> | 작업 | Microsoft .Sql/managedInstances/데이터베이스/스키마/테이블/읽기 | 관리 되는 데이터베이스 테이블 가져오기 |
> |  | **managedInstances/데이터베이스/스키마/테이블/열** |  |
> | 작업 | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/읽기 | 관리 되는 데이터베이스 열 가져오기 |
...
> | 작업 | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/sensitivityLabels/사용 안 함/작업 | 지정 된 열에서 민감도 권장 사항을 사용 하지 않도록 설정 |
> | 작업 | Microsoft .Sql/managedInstances/databases/스키마/테이블/열/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
...
> | 작업 | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 관리 되는 데이터베이스 위협 검색 정책의 목록을 검색 합니다. |
...
> |  | **managedInstances/databases/vulnerabilityAssessments/scan** |  |
...
> | 작업 | Microsoft .Sql/managedInstances/Cr프로텍터/유효성 재검사/작업 | 지정된 서버 암호화 보호기에 대한 속성을 업데이트합니다. |
...
> | 작업 | Microsoft .Sql/managedInstances/inaccessibleManagedDatabases/read | 관리 되는 인스턴스에서 액세스할 수 없는 관리 되는 데이터베이스 목록을 가져옵니다. |
...
> |  | **managedInstances/providers/metricDefinitions/Microsoft** |  |
...
> | 작업 | Microsoft .Sql/servers/disableAzureADOnlyAuthentication/action | 논리 서버 에서만 Azure Active Directory 인증 사용 안 함 |
...
> | 작업 | Microsoft .Sql/servers/privateEndpointConnectionsApproval/action | 사용자가 개인 끝점 연결을 승인할 수 있는지 여부를 결정 합니다. |
> | 작업 | Microsoft.Sql/servers/import/action | 서버에서 새 데이터베이스를 만들고 DacPac 패키지의 스키마 및 데이터를 배포합니다. |
> |  | **서버/관리자 Operationresults** |  |
> | 작업 | Microsoft.Sql/servers/administratorOperationResults/read | 서버 관리자에 대해 진행 중인 작업을 가져옵니다. |
> |  | **servers/administrators** |  |
> | 작업 | Microsoft.Sql/servers/administrators/read | 특정 Azure Active Directory 관리자 개체를 가져옵니다. |
> | 작업 | Microsoft.Sql/servers/administrators/write | 특정 Azure Active Directory 관리자 개체를 추가 하거나 업데이트 합니다. |
> | 작업 | Microsoft.Sql/servers/administrators/delete | 특정 Azure Active Directory 관리자 개체를 삭제 합니다. |
> |  | **servers/advisors** |  |
...
> |  | **서버/auditingSettings/operationResults** |  |
...
> | 작업 | Microsoft.Sql/servers/databases/move/action | 기존 데이터베이스의 이름을 변경 합니다. |
> | 작업 | Microsoft.Sql/servers/databases/restorePoints/action | 새 복원 지점을 만듭니다. |
> | 작업 | Microsoft .Sql/servers/데이터베이스/장애 조치/동작 | 고객이 데이터베이스 장애 조치를 시작 했습니다. |
...
> |  | **servers/databases/advisor/recommendedActions** |  |
...
> | 작업 | Microsoft .Sql/servers/databases/backupShortTermRetentionPolicies/read | 데이터베이스에 대 한 단기 보존 정책을 가져옵니다. |
> | 작업 | Microsoft .Sql/servers/databases/backupShortTermRetentionPolicies/write | 데이터베이스에 대 한 단기 보존 정책을 업데이트 합니다. |
> |  | **서버/데이터베이스/열** |  |
> | 작업 | Microsoft .Sql/servers/databases/columns/read | 데이터베이스에 대 한 열 목록 반환 |
...
> |  | **서버/데이터베이스/currentSensitivityLabels** |  |
> | 작업 | Microsoft.Sql/servers/databases/currentSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | 작업 | Microsoft .Sql/servers/databases/currentSensitivityLabels/write | 일괄 업데이트 민감도 레이블 |
...
> |  | **서버/데이터베이스/dataWarehouseQueries** |  |
...
> |  | **서버/데이터베이스/dataWarehouseUserActivities** |  |
...
> |  | **서버/데이터베이스/확장/importExtensionOperationResults** |  |
> | 작업 | Microsoft .Sql/servers/databases/extensions/importExtensionOperationResults/read | 진행 중인 가져오기 작업을 가져옵니다. |
...
> |  | **서버/데이터베이스/공급자/Microsoft diagnosticSettings/** |  |
...
> | 작업 | Microsoft .Sql/servers/databases/스키마/테이블/열/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
> | 작업 | Microsoft .Sql/servers/데이터베이스/스키마/테이블/열/sensitivityLabels/사용 안 함/작업 | 지정 된 열에서 민감도 권장 사항을 사용 하지 않도록 설정 |
...
> |  | **서버/데이터베이스/스키마/테이블/recommendedIndexes** |  |
...
> |  | **servers/databases/syncGroups/Syncgroups/refreshSchemaOperationResults** |  |
...
> |  | **서버/데이터베이스/topQueries/statistics** |  |
...
> | 작업 | Microsoft.Sql/servers/databases/transparentDataEncryption/read | 지정 된 관리 되는 데이터베이스에서 논리 데이터베이스 투명한 데이터 암호화의 세부 정보를 검색 합니다. |
> | 작업 | Microsoft.Sql/servers/databases/transparentDataEncryption/write | 지정 된 논리 데이터베이스에 대 한 데이터베이스 투명한 데이터 암호화 변경 |
> |  | **서버/데이터베이스/transparentDataEncryption/operationResults** |  |
...
> |  | **서버/데이터베이스/vulnerabilityAssessments/검색** |  |
...
> |  | **서버/데이터베이스/workloadGroups** |  |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/read | 선택한 데이터베이스에 대 한 작업 그룹을 나열 합니다. |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/write | 특정 작업 그룹의 속성을 설정 합니다. |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/delete | 특정 작업 그룹을 삭제 합니다. |
> |  | **servers/databases/workloadGroups/workloadClassifiers** |  |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/workloadClassifiers/read | 선택한 데이터베이스에 대 한 작업 분류자를 나열 합니다. |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/workloadClassifiers/write | 특정 작업 분류자의 속성을 설정 합니다. |
> | 작업 | Microsoft .Sql/servers/databases/workloadGroups/workloadClassifiers/delete | 특정 작업 분류자를 삭제 합니다. |
...
> | 작업 | Microsoft .Sql/servers/elasticPools/failover/작업 | 고객이 탄력적 풀 장애 조치 (failover)를 시작 했습니다. |
> |  | **servers/elasticPools/advisor** |  |
...
> |  | **servers/elasticPools/advisor/recommendedActions** |  |
...
> | 작업 | Microsoft .Sql/servers///또는 유효성 재검사/작업 | 지정된 서버 암호화 보호기에 대한 속성을 업데이트합니다. |
...
> | 작업 | Microsoft .Sql/servers/inaccessibleDatabases/read | 논리 서버에서 액세스할 수 없는 데이터베이스 목록을 반환 합니다. |
> |  | **서버/인터페이스-끝점 프로필** |  |
...
> |  | **서버/작업** |  |
> | 작업 | Microsoft .Sql/servers/작업/읽기 | 서버에서 수행 된 작업 목록을 반환 합니다. |
> |  | **servers/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnectionProxies/validate/action | NRP 쪽에서 개인 끝점 연결 만들기 호출의 유효성을 검사 합니다. |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnectionProxies/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결 프록시를 만들거나 지정 된 개인 끝점 연결 프록시에 대 한 속성 또는 태그를 업데이트 합니다. |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> |  | **servers/privateEndpointConnections** |  |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnections/read | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결에 대 한 속성을 가져옵니다. |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
> | 작업 | Microsoft .Sql/servers/privateEndpointConnections/write | 기존 개인 끝점 연결을 승인 하거나 거부 합니다. |
> |  | **servers/privateLinkResources** |  |
> | 작업 | Microsoft .Sql/servers/privateLinkResources/read | 해당 sql server에 대 한 개인 링크 리소스 가져오기 |
> |  | **서버/공급자/Microsoft metricDefinitions/** |  |
...
> |  | **servers/recommendedElasticPools/데이터베이스** |  |
...
> | 작업 | Microsoft.Sql/servers/securityAlertPolicies/read | 지정 된 서버에 대해 구성 된 서버 위협 검색 정책 목록을 검색 합니다. |
...
> |  | **서버/용도** |  |
> | 작업 | Microsoft.Sql/servers/usages/read | 서버 내의 모든 데이터베이스에서 서버 DTU 할당량 및 현재 DTU 사용을 반환 합니다. |
> |  | **servers/virtualNetworkRules** |  |
...
> | 작업 | Microsoft .Sql/virtualClusters/삭제 | 기존 가상 클러스터를 삭제 합니다. |

## <a name="microsoftsqlvirtualmachine"></a>Microsoft.SqlVirtualMachine

Azure 서비스: [azure Virtual Machines에서 SQL Server](../virtual-machines/windows/sql/virtual-machines-windows-sql-server-iaas-overview.md)

> [!div class="mx-tdCol2BreakAll"]
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | SqlVirtualMachine/register/action | SqlVirtualMachine 리소스 공급자에 구독을 등록 합니다. |
> | 작업 | SqlVirtualMachine/등록 취소/작업 | SqlVirtualMachine 리소스 공급자를 사용 하 여 구독 등록 취소 |
> |  | **위치도** |  |
> | 작업 | SqlVirtualMachine/위치/registerSqlVmCandidate/작업 | SQL Vm 후보 등록 |
> |  | **위치/availabilityGroupListenerOperationResults** |  |
> | 작업 | SqlVirtualMachine/위치/availabilityGroupListenerOperationResults/읽기 | 가용성 그룹 수신기 작업의 결과를 가져옵니다. |
> |  | **위치/sqlVirtualMachineGroupOperationResults** |  |
> | 작업 | SqlVirtualMachine/위치/sqlVirtualMachineGroupOperationResults/읽기 | SQL 가상 컴퓨터 그룹 작업의 결과를 가져옵니다. |
> |  | **위치/a s s Virtualmachineoperationresults** |  |
> | 작업 | SqlVirtualMachine/위치/m s s o r e r | SQL 가상 컴퓨터 작업의 결과를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | SqlVirtualMachine/작업/읽기 |  |
> |  | **sqlVirtualMachineGroups** |  |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/read | SQL 가상 컴퓨터 그룹의 세부 정보를 검색 합니다. |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/write | 기존 SQL 가상 컴퓨터 그룹의 새 속성 또는 변경 속성을 만듭니다. |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/delete | 기존 SQL 가상 컴퓨터 그룹 삭제 |
> |  | **sqlVirtualMachineGroups/availabilityGroupListeners** |  |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/read | 지정 된 SQL 가상 컴퓨터 그룹의 SQL 가용성 그룹 수신기에 대 한 세부 정보를 검색 합니다. |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/write | 기존 SQL 가용성 그룹 수신기의 새 속성 또는 변경 속성을 만듭니다. |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/availabilityGroupListeners/delete | 기존 가용성 그룹 수신기 삭제 |
> |  | **sqlVirtualMachineGroups/sqlVirtualMachines** |  |
> | 작업 | SqlVirtualMachine/sqlVirtualMachineGroups/sqlVirtualMachines/read | 특정 sql 가상 컴퓨터 그룹 별로 Sql 가상 컴퓨터 나열 |
> |  | **sqlVirtualMachines** |  |
> | 작업 | SqlVirtualMachine/sqlVirtualMachines/읽기 | SQL 가상 컴퓨터의 세부 정보 검색 |
> | 작업 | SqlVirtualMachine/sqlVirtualMachines/write | 기존 SQL 가상 머신의 새 속성 또는 변경 속성을 만듭니다. |
> | 작업 | SqlVirtualMachine/sqlVirtualMachines/delete | 기존 SQL 가상 컴퓨터 삭제 |
...
> |  | **위치/checknameavailability** |  |
> | 작업 | Microsoft. 저장소/위치/checknameavailability/read | 해당 계정 이름이 올바른지와 사용되고 있지 않은지 확인합니다. |
> |  | **위치/용도** |  |
...
> |  | **storageAccounts** |  |
> | 작업 | Microsoft. Storage/storageAccounts/restoreBlobRanges/action | 지정 된 시간 상태로 blob 범위 복원 |
> | 작업 | Microsoft. Storage/storageAccounts/PrivateEndpointConnectionsApproval/action | 개인 끝점 연결 승인 |
> | 작업 | Microsoft. Storage/storageAccounts/failover/action | 가용성 문제가 발생 하는 경우 고객은 장애 조치 (failover)를 제어할 수 있습니다. |
...
> |  | **storageAccounts/blobServices/컨테이너** |  |
...
> |  | **storageAccounts/blobServices/컨테이너/immutabilityPolicies** |  |
...
> | 작업 | Microsoft. Storage/storageAccounts/dataSharePolicies/delete |  |
> | 작업 | Microsoft. Storage/storageAccounts/dataSharePolicies/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/dataSharePolicies/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/dataSharePolicies/write |  |
> |  | **storageAccounts/대 범위** |  |
> | 작업 | Microsoft. Storage/storageAccounts/. 범위/읽기 |  |
> | 작업 | Microsoft. Storage/storageAccounts/. 범위/읽기 |  |
> | 작업 | Microsoft. Storage/storageAccounts/대 범위/쓰기 |  |
> | 작업 | Microsoft. Storage/storageAccounts/대 범위/쓰기 |  |
> |  | **storageAccounts/fileServices** |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/공유/작업 |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/write |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/read | 파일 서비스 속성 가져오기 |
> |  | **storageAccounts/fileServices/공유** |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/공유/삭제 |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/공유/읽기 |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/공유/읽기 |  |
> | 작업 | Microsoft. Storage/storageAccounts/fileServices/공유/쓰기 |  |
> |  | **storageAccounts/localUsers** |  |
> | 작업 | Microsoft. Storage/storageAccounts/localUsers/delete |  |
> | 작업 | Microsoft. Storage/storageAccounts/localusers/listKeys/action |  |
> | 작업 | Microsoft. Storage/storageAccounts/localusers/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/localusers/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/localusers/write |  |
> |  | **storageAccounts/managementPolicies** |  |
> | 작업 | Microsoft. Storage/storageAccounts/managementPolicies/삭제 | 저장소 계정 관리 정책 삭제 |
> | 작업 | Microsoft. Storage/storageAccounts/managementPolicies/읽기 | 저장소 관리 계정 정책 가져오기 |
> | 작업 | Microsoft. Storage/storageAccounts/managementPolicies/쓰기 | 저장소 계정 관리 정책 배치 |
> |  | **storageAccounts/objectReplicationPolicies** |  |
> | 작업 | Microsoft. Storage/storageAccounts/objectReplicationPolicies/delete |  |
> | 작업 | Microsoft. Storage/storageAccounts/objectReplicationPolicies/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/objectReplicationPolicies/read |  |
> | 작업 | Microsoft. Storage/storageAccounts/objectReplicationPolicies/write |  |
> |  | **storageAccounts/privateEndpointConnectionProxies** |  |
> | 작업 | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
...
> | 작업 | Microsoft. Storage/storageAccounts/privateLinkResources/read | StorageAccount groupids 가져오기 |
> |  | **storageAccounts/queueServices** |  |
> | 작업 | Microsoft.Storage/storageAccounts/queueServices/read | 큐 서비스 속성 가져오기 |
...
> |  | **storageAccounts/queueServices/queue** |  |
...
> | 작업 | Microsoft. Storage/storageAccounts/tableServices/read | Table service 속성 가져오기 |
> |  | **마크업** |  |
> | 작업 | Microsoft.Storage/usages/read | 지정한 구독의 리소스에 대한 한도 및 현재 사용 수를 반환합니다. |
> |  | **storageAccounts/blobServices/컨테이너/b l o b** |  |
...
> | DataAction | Microsoft. Storage/storageAccounts/blobServices/컨테이너/b l o b/필터/작업 | 일치 하는 태그 필터를 사용 하 여 계정에서 blob 목록을 반환 합니다. |
...
> |  | **storageAccounts/blobServices/컨테이너/b l o b/태그** |  |
> | DataAction | Microsoft. Storage/storageAccounts/blobServices/컨테이너/b l o b/태그/읽기 | Blob 태그를 읽은 결과를 반환 합니다. |
> | DataAction | Microsoft. Storage/storageAccounts/blobServices/컨테이너/b l o b/태그/쓰기 | Blob 태그 작성 결과를 반환 합니다. |
> |  | **storageAccounts/fileServices/파일 공유/files** |  |
> | DataAction | Microsoft. Storage/storageAccounts/fileServices/파일 공유/files/read | 파일/폴더 또는 파일/폴더 목록을 반환 합니다. |
> | DataAction | Microsoft. Storage/storageAccounts/fileServices/파일 공유/files/write | 파일을 쓰거나 폴더를 만든 결과를 반환 합니다. |
> | DataAction | Microsoft. Storage/storageAccounts/fileServices/파일 공유/files/delete | 파일/폴더 삭제 결과 반환 |
> | DataAction | Microsoft. Storage/storageAccounts/fileServices/파일 공유/files/modifypermissions/action | 파일/폴더에 대 한 수정 권한이 있는 결과를 반환 합니다. |
> | DataAction | Microsoft. Storage/storageAccounts/fileServices/파일 공유/files/actassuperuser/action | 파일 관리자 권한 가져오기 |
> |  | **storageAccounts/queueServices/queue/messages** |  |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | microsoft.storagesync/register/action | 저장소 동기화 공급자에 대 한 구독을 등록 합니다. |
> | 작업 | microsoft.storagesync/등록 취소/작업 | 저장소 동기화 공급자에 대 한 구독의 등록을 취소 합니다. |
> |  | **위치도** |  |
...
> |  | **작업도** |  |
> | 작업 | microsoft.storagesync/작업/읽기 | 지원 되는 작업 목록을 가져옵니다. |
> |  | **storageSyncServices** |  |
...
> |  | **storageSyncServices/providers/metricDefinitions/Microsoft** |  |
...
> | 작업 | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/triggerChangeDetection/작업 | 이 작업을 호출 하 여 클라우드 끝점의 파일 공유에 대 한 변경 내용 검색을 트리거합니다. |
...
> |  | **관리자/accessControlRecords/operationResults** |  |
...
> |  | **관리자/bandwidthSettings/operationResults** |  |
...
> |  | **관리자/cloudApplianceConfigurations** |  |
...
> | 작업 | Microsoft.StorSimple/managers/devices/download/action | 장치에 대 한 업데이트를 다운로드 합니다. |
...
> |  | **관리자/장치/backupPolicies/일정/operationResults** |  |
...
> |  | **관리자/장치/backupScheduleGroups/operationResults** |  |
...
> |  | **관리자/장치/chapSettings/operationResults** |  |
...
> |  | **관리자/장치/hardwareComponentGroups/operationResults** |  |
...
> |  | **관리자/storageAccountCredentials/operationResults** |  |
...
> |  | **관리자/storageDomains/operationResults** |  |
...
> | 작업 | Microsoft. StreamAnalytics/streamingjobs/PublishEdgePackage/action | Stream Analytics 작업에 대 한 edge 패키지 게시 |
> | 작업 | Microsoft.StreamAnalytics/streamingjobs/Read | Stream Analytics 작업을 읽습니다. |
> | 작업 | Microsoft. StreamAnalytics/streamingjobs/Scale/action | 크기 조정 Stream Analytics 작업 |
...
> |  | **streamingjobs/함수/operationresults** |  |
...
> |  | **streamingjobs/입력/operationresults** |  |
...
> |  | **streamingjobs/공급자/Microsoft diagnosticSettings/** |  |
...
> |  | **streamingjobs/공급자/Microsoft Insights/logDefinitions** |  |
...
> |  | **streamingjobs/공급자/Microsoft metricDefinitions/** |  |
...
> | 작업 | Microsoft 구독/취소/작업 | 구독을 취소 합니다. |
> | 작업 | Microsoft. 구독/이름 바꾸기/작업 | 구독 이름 바꾸기 |
...
> | 액션 유형 | 작업(Operation) | Description |
> | --- | --- | --- |
> | 작업 | Microsoft.Support/register/action | 등록 지원 리소스 공급자 |
> | 작업 | Microsoft. Support/checkNameAvailability/action | 이름이 유효 하 고 리소스 종류에 사용 되 고 있지 않은지 확인 합니다. |
> |  | **operationresults** |  |
> | 작업 | Microsoft. Support/operationresults/read | 비동기 작업의 결과를 가져옵니다. |
> |  | **작업도** |  |
> | 작업 | Microsoft. 지원/작업/읽기 | Microsoft 지원 리소스 공급자에서 사용할 수 있는 모든 작업을 나열 합니다. |
> |  | **operationsstatus** |  |
> | 작업 | Microsoft. Support/operationsstatus/read | 비동기 작업의 상태를 가져옵니다. |
> |  | **services** |  |
> | 작업 | Microsoft. 지원/서비스/읽기 | 지원에 사용할 수 있는 하나 또는 모든 Azure 서비스를 나열 합니다. |
> |  | **서비스/problemClassifications** |  |
> | 작업 | Microsoft. 지원/서비스/problemClassifications/읽기 | Azure 서비스에 대 한 하나 또는 모든 문제 분류를 나열 합니다. |
> |  | **supportTickets** |  |
> | 작업 | Microsoft.Support/supportTickets/read | 하나 또는 모든 지원 티켓을 나열 합니다. |
> | 작업 | Microsoft.Support/supportTickets/write | 지원 티켓을 만들고 업데이트할 수 있습니다. |
> |  | **supportTickets/통신** |  |
> | 작업 | Microsoft. 지원/지원 티켓/통신/읽기 | 하나 또는 모든 지원 티켓 통신을 나열 합니다. |
> | 작업 | Microsoft. 지원/지원 티켓/통신/쓰기 | 지원 티켓에 새 통신을 추가 합니다. |
...
Azure 서비스: [App Service](../app-service/index.yml), [함수](../azure-functions/index.yml)
...
> |  | **apimanagementaccount/api/apiacls** |  |
...
> |  | **apimanagementaccount/api/connections/connectionacls** |  |
...
> |  | **apimanagementaccount/api/localizeddefinitions** |  |
...
> |  | **apimanagementaccount/connectionacls** |  |
...
> | 작업 | Microsoft 웹/hostingEnvironments/조인/작업 | App Service Environment를 조인 합니다. |
> | 작업 | Microsoft.Web/hostingEnvironments/reboot/Action | App Service 환경의 모든 컴퓨터를 다시 부팅합니다. |
> | 작업 | Microsoft 웹/hostingEnvironments/PrivateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
...
> |  | **hostingenvironments/용량** |  |
> | 작업 | microsoft.web/hostingenvironments/capacities/read | 호스팅 환경 용량을 가져옵니다. |
> |  | **hostingenvironments/감지기** |  |
> | 작업 | microsoft.web/hostingenvironments/detectors/read | 호스팅 환경 탐지기를 가져옵니다. |
> |  | **hostingenvironments/진단** |  |
> | 작업 | microsoft.web/hostingenvironments/diagnostics/read | 호스팅 환경 진단을 가져옵니다. |
> |  | **hostingEnvironments/eventGridFilters** |  |
> | 작업 | Microsoft 웹/hostingEnvironments/eventGridFilters/delete | 호스팅 환경에서 Event Grid 필터를 삭제 합니다. |
> | 작업 | Microsoft 웹/hostingEnvironments/eventGridFilters/read | 호스팅 환경에 대 한 Event Grid 필터를 가져옵니다. |
> | 작업 | Microsoft 웹/hostingEnvironments/eventGridFilters/write | 호스팅 환경에 Event Grid 필터를 추가 합니다. |
...
> |  | **hostingenvironments/multirolepools/메트릭** |  |
...
> |  | **위치/connectiongatewayinstallations** |  |
...
> |  | **위치/managedapis/apioperations** |  |
> | 작업 | microsoft.web/locations/managedapis/apioperations/read | 위치 관리되는 API 작업을 가져옵니다. |
> |  | **위치/operationResults** |  |
> | 작업 | microsoft. 웹/위치/operationResults/read | 작업을 가져옵니다. |
> |  | **위치/작업** |  |
> | 작업 | microsoft. 웹/위치/작업/읽기 | 작업을 가져옵니다. |
> |  | **작업도** |  |
...
> | 작업 | Microsoft 웹/serverfarms/eventGridFilters/delete | 서버 팜에서 Event Grid 필터를 삭제 합니다. |
> | 작업 | Microsoft 웹/serverfarms/eventGridFilters/read | 서버 팜에서 Event Grid 필터를 가져옵니다. |
> | 작업 | Microsoft 웹/serverfarms/eventGridFilters/write | 서버 팜에 Event Grid 필터를 추가 합니다. |
> |  | **serverfarms/firstpartyapps/설정** |  |
...
> |  | **serverfarms/hybridconnectionnamespaces/릴레이** |  |
...
> |  | **serverfarms/hybridconnectionnamespaces/릴레이/사이트** |  |
...
> | 작업 | Microsoft 웹/사이트/PrivateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
> | 작업 | microsoft.web/sites/functions/action | 합수 Web Apps입니다. |
> | 작업 | microsoft.web/sites/listsyncfunctiontriggerstatus/action | 동기화 함수 트리거 상태를 나열 합니다. |
...
> | 작업 | microsoft 웹/사이트/restorefromdeletedapp/작업 | 삭제된 앱에서 Web Apps를 복원합니다. |
> | 작업 | microsoft.web/sites/syncfunctiontriggers/action | 함수 트리거를 동기화 합니다. |
...
> | 작업 | Microsoft. 웹/사이트/i s d i d 필터/삭제 | 웹 앱에서 Event Grid 필터를 삭제 합니다. |
> | 작업 | Microsoft. 웹/사이트/i s d e r/r e d 필터/읽기 | 웹 앱에서 Event Grid 필터를 가져옵니다. |
> | 작업 | Microsoft. 웹/사이트/i s d i d 필터/쓰기 | 웹 앱에 Event Grid 필터를 추가 합니다. |
> |  | **사이트/확장** |  |
> | 작업 | microsoft 웹/사이트/확장/삭제 | Web Apps 사이트 확장을 삭제합니다. |
> | 작업 | microsoft 웹/사이트/확장/읽기 | Web Apps 사이트 확장을 가져옵니다. |
> | 작업 | microsoft 웹/사이트/확장/쓰기 | Web Apps 사이트 확장을 업데이트합니다. |
> |  | **사이트/함수** |  |
> | 작업 | microsoft.web/sites/functions/delete | Web Apps 함수를 삭제합니다. |
> | 작업 | microsoft.web/sites/functions/listsecrets/action | 함수 암호를 나열 합니다. |
> | 작업 | microsoft 웹/사이트/함수/listkeys/동작 | 함수 키를 나열 합니다. |
> | 작업 | microsoft.web/sites/functions/read | Web Apps 함수를 가져옵니다. |
> | 작업 | microsoft.web/sites/functions/write | Web Apps 함수를 업데이트합니다. |
> |  | **사이트/함수/키** |  |
> | 작업 | microsoft 웹/사이트/함수/키/쓰기 | 기능 키를 업데이트 합니다. |
> | 작업 | microsoft 웹/사이트/함수/키/삭제 | 함수 키를 삭제 합니다. |
> |  | **사이트/함수/masterkey** |  |
> | 작업 | microsoft.web/sites/functions/masterkey/read | Web Apps 함수 Masterkey를 가져옵니다. |
> |  | **사이트/함수/속성** |  |
> | 작업 | microsoft 웹/사이트/함수/속성/읽기 | Web Apps 함수 속성을 읽습니다. |
> | 작업 | microsoft 웹/사이트/함수/속성/쓰기 | Web Apps 함수 속성을 업데이트 합니다. |
> |  | **사이트/함수/토큰** |  |
> | 작업 | microsoft.web/sites/functions/token/read | Web Apps 함수 토큰을 가져옵니다. |
> |  | **사이트/호스트** |  |
> | 작업 | microsoft 웹/사이트/호스트/listkeys/작업 | 함수 호스트 키를 나열 합니다. |
> | 작업 | microsoft 웹/사이트/호스트/동기화/작업 | 함수 트리거를 동기화 합니다. |
> | 작업 | microsoft. 웹/사이트/호스트/listsyncstatus/작업 | 동기화 함수 트리거 상태를 나열 합니다. |
> |  | **사이트/호스트/functionkeys** |  |
> | 작업 | microsoft. 웹/사이트/호스트/functionkeys/write | 업데이트 함수는 함수 키를 호스트 합니다. |
> | 작업 | microsoft 웹/사이트/호스트/functionkeys/delete | 함수 호스트 함수 키를 삭제 합니다. |
> |  | **사이트/호스트/속성** |  |
> | 작업 | microsoft 웹/사이트/호스트/속성/읽기 | Web Apps 함수 호스트 속성을 읽습니다. |
> |  | **사이트/호스트/시스템 키** |  |
> | 작업 | microsoft. 웹/사이트/호스트/m p r/시스템 키/쓰기 | 업데이트 함수는 시스템 키를 호스트 합니다. |
> | 작업 | microsoft. 웹/사이트/호스트/m p r/systemkeys/delete | 함수 호스트 시스템 키를 삭제 합니다. |
> |  | **사이트/hostnamebindings** |  |
...
> |  | **사이트/hybridconnectionnamespaces/릴레이** |  |
...
> | 작업 | microsoft. 웹/사이트/e s t e r/operationresults/read | Web Apps 네트워크 추적 작업 결과를 가져옵니다. |
> |  | **사이트/operationresults** |  |
...
> |  | **사이트/프로세스/모듈** |  |
> | 작업 | microsoft 웹/사이트/프로세스/모듈/읽기 | Web Apps 프로세스 모듈을 가져옵니다. |
> |  | **사이트/프로세스/스레드** |  |
> | 작업 | microsoft 웹/사이트/프로세스/스레드/읽기 | 스레드를 가져오기 Web Apps를 처리 합니다. |
> |  | **사이트/publiccertificates** |  |
...
> | 작업 | microsoft 웹/사이트/슬롯/restorefromdeletedapp/작업 | 삭제된 앱에서 웹앱 슬롯을 복원합니다. |
...
> |  | **사이트/슬롯/확장** |  |
> | 작업 | microsoft 웹/사이트/슬롯/확장/읽기 | Web Apps 슬롯 확장을 가져옵니다. |
> | 작업 | microsoft 웹/사이트/슬롯/확장/쓰기 | Web Apps 슬롯 확장을 업데이트 합니다. |
> |  | **사이트/슬롯/함수** |  |
...
> |  | **사이트/슬롯/hybridconnectionnamespaces/릴레이** |  |
...
> |  | **사이트/슬롯/네트워크 추적/operationresults** |  |
> | 작업 | microsoft. 웹/사이트/슬롯/네트워크 추적/operationresults/read | Web Apps 슬롯 네트워크 추적 작업 결과를 가져옵니다. |
> |  | **사이트/슬롯/operationresults** |  |
...
> |  | **사이트/슬롯/virtualnetworkconnections** |  |
...
> |  | **사이트/슬롯/virtualnetworkconnections/게이트웨이** |  |
...
> |  | **사이트/virtualnetworkconnections/게이트웨이** |  |
