...
> | 작업 | Microsoft.Sql/managedInstances/databases/schemas/read | 관리 되는 데이터베이스 스키마를 가져옵니다. (스키마 전용) |
> | 작업 | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/read | 관리 되는 데이터베이스 열 가져오기 (스키마 전용) |
...
> | 작업 | Microsoft.Sql/managedInstances/databases/schemas/tables/read | 관리 되는 데이터베이스 테이블 가져오기 (스키마 전용) |
...
> | 작업 | Microsoft.Sql/servers/databases/schemas/read | 데이터베이스 스키마를 가져옵니다 (스키마에만 해당). |
> | 작업 | Microsoft.Sql/servers/databases/schemas/tables/columns/read | 데이터베이스 열을 가져옵니다 (스키마에만 해당). |
...
> | 작업 | Microsoft.Sql/servers/databases/schemas/tables/read | 데이터베이스 테이블을 가져옵니다 (스키마에만 해당). |
