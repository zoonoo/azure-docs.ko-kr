...
> | 작업 | Microsoft.Advisor/generateRecommendations/action | 권장 사항을 생성합니다. |
...
> | 작업 | Microsoft.Advisor/recommendations/available/action | Microsoft Advisor에 새로운 권장 사항이 제공됩니다. |
...
> | 작업 | Microsoft.Automation/automationAccounts/linkedWorkspace/read | 자동화 계정에 연결된 작업 영역을 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | 작업 | Microsoft.BingMaps/mapApis/Delete | 삭제 작업 |
> | 작업 | Microsoft.BingMaps/mapApis/listSecrets/action | 암호를 나열합니다. |
> | 작업 | Microsoft.BingMaps/mapApis/listSingleSignOnToken/action | 리소스에 대한 Single Sign-On 권한 부여 토큰을 읽습니다. |
> | 작업 | Microsoft.BingMaps/mapApis/Read | 읽기 작업 |
> | 작업 | Microsoft.BingMaps/mapApis/regenerateKey/action | 키 다시 생성 |
> | 작업 | Microsoft.BingMaps/mapApis/Write | 쓰기 작업 |
> | 작업 | Microsoft.BingMaps/Operations/read | 작업에 대한 설명입니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | 작업 | Microsoft.BotService/botServices/channels/delete | Bot Service를 삭제합니다. |
> | 작업 | Microsoft.BotService/botServices/channels/read | Bot Service를 읽습니다. |
> | 작업 | Microsoft.BotService/botServices/channels/write | Bot Service를 작성합니다. |
> | 작업 | Microsoft.BotService/botServices/connections/delete | Bot Service를 삭제합니다. |
> | 작업 | Microsoft.BotService/botServices/connections/read | Bot Service를 읽습니다. |
> | 작업 | Microsoft.BotService/botServices/connections/write | Bot Service를 작성합니다. |
...
> | 작업 | Microsoft.Cache/redis/listUpgradeNotifications/read | 캐시 테넌트에 대한 최신 업그레이드 알림을 나열합니다. |
...
> | 작업 | Microsoft.ClassicCompute/virtualMachines/start/action | 가상 컴퓨터를 시작합니다. |
...
> | 작업 | Microsoft.Compute/virtualMachineScaleSets/rollingUpgrades/cancel/action | 가상 머신 확장 집합의 롤링 업그레이드를 취소합니다. |
...
> | 작업 | Microsoft.ContainerRegistry/registries/quarantineRead/read | 컨테이너 레지스트리에서 격리된 이미지를 끌어오거나 가져옵니다. |
> | 작업 | Microsoft.ContainerRegistry/registries/quarantineWrite/write | 격리된 이미지의 격리 상태를 작성/수정합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | 작업 | Microsoft.ContentModerator/applications/delete | 삭제 작업 |
> | 작업 | Microsoft.ContentModerator/applications/listSecrets/action | 암호를 나열합니다. |
> | 작업 | Microsoft.ContentModerator/applications/listSingleSignOnToken/action | Single Sign-on 토큰을 읽습니다. |
> | 작업 | Microsoft.ContentModerator/applications/read | 읽기 작업 |
> | 작업 | Microsoft.ContentModerator/applications/write | 쓰기 작업 |
> | 작업 | Microsoft.ContentModerator/applications/write | 쓰기 작업 |
> | 작업 | Microsoft.ContentModerator/listCommunicationPreference/action | 통신 기본 설정을 나열합니다. |
> | 작업 | Microsoft.ContentModerator/operations/read | 읽기 작업 |
> | 작업 | Microsoft.ContentModerator/updateCommunicationPreference/action | 통신 기본 설정을 업데이트합니다. |
...
> | 작업 | Microsoft.Devices/elasticPools/iotHubTenants/importDevices/Action | 디바이스를 가져옵니다. |
...
> | 작업 | Microsoft.Devices/iotHubs/importDevices/Action | 디바이스를 가져옵니다. |
...
> | 작업 | Microsoft.DevTestLab/labs/artifactSources/artifacts/GenerateArmTemplate/action | 지정된 아티팩트에 대한 ARM 템플릿을 생성하고, 필요한 파일을 스토리지 계정에 업로드하고, 생성된 아티팩트의 유효성을 검사합니다. |
...
> | 작업 | Microsoft.EventGrid/topictypes/eventSubscriptions/read | 항목 유형별로 전역 이벤트 구독을 나열합니다. |
...
> | 작업 | Microsoft.HDInsight/clusters/configurations/action | HDInsight 클러스터 구성을 업데이트합니다. |
...
> | 작업 | Microsoft.LabServices/labAccounts/GetRegionalAvailability/action | 랩 계정에서 구성된 각 크기 범주에 대한 지역별 가용성 정보 가져오기 |
...
> | 작업 | Microsoft.LabServices/labAccounts/labs/environmentSettings/environments/write | 환경을 추가하거나 수정합니다. |
...
> | 작업 | Microsoft.LabServices/users/GetOperationStatus/action | 장기 실행 작업의 상태를 가져옵니다. |
...
> | 작업 | Microsoft.Logic/integrationAccounts/sessions/read | 통합 계정에서 일괄 처리 구성을 읽습니다. |
...
> | 작업 | Microsoft.Network/applicationGateways/delete | Application Gateway를 삭제합니다. |
...
> | 작업 | Microsoft.Network/applicationGateways/stop/action | Application Gateway를 중지합니다. |
> | 작업 | Microsoft.Network/applicationGateways/write | Application Gateway를 만들거나 Application Gateway를 업데이트합니다. |
...
> | 작업 | Microsoft.Network/securegateways/write | 보안 게이트웨이를 만들거나 업데이트합니다. |
...
> | 작업 | Microsoft. 검색/searchServices/listQueryKeys/action | 지정 된 Azure Cognitive Search 서비스에 대 한 쿼리 API 키 목록을 반환 합니다. |
> | 작업 | Microsoft.Search/searchServices/listQueryKeys/read | 지정 된 Azure Cognitive Search 서비스에 대 한 쿼리 API 키 목록을 반환 합니다. |
...
> | 작업 | Microsoft.Sql/servers/databases/transparentDataEncryption/read | 지정된 데이터베이스에 대한 투명한 데이터 암호화 보안 기능의 상태 및 세부 정보를 검색합니다. |
> | 작업 | Microsoft.Sql/servers/databases/transparentDataEncryption/write | 투명한 데이터 암호화 상태를 변경합니다. |
...
> | 작업 | Microsoft.StorSimple/managers/devices/download/action | 디바이스에 대한 업데이트를 다운로드합니다. |
...
> | 작업 | Microsoft.StorSimple/managers/migrateClassicToResourceManager/action | 클래식을 관리자의 리소스 관리자로 마이그레이션합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | 작업 | Microsoft.Support/register/action | 지원 리소스 공급자에 등록합니다. |
> | 작업 | Microsoft.Support/supportTickets/read | 상태, 심각도, 연락처 세부 정보, 통신 등 지원 티켓 세부 정보를 얻거나 구독의 지원 티켓 목록을 얻습니다. |
> | 작업 | Microsoft.Support/supportTickets/write | 지원 티켓을 만들거나 업데이트합니다. 기술, 청구, 할당량 또는 구독 관리 관련 문제에 대한 지원 티켓을 만들 수 있습니다. 기존 지원 티켓의 심각도, 연락처 세부 정보 및 통신을 업데이트할 수 있습니다. |
