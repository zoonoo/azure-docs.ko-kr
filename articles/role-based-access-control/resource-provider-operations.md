...
> | Microsoft Marketplace/privateStores/requestApprovals/작업 | 업데이트 요청 승인 |
> | Microsoft Marketplace/privateStores/adminRequestApprovals/읽기 | 모든 요청 승인 세부 정보, 관리자만 읽기 |
> | Microsoft Marketplace/privateStores/adminRequestApprovals/쓰기 | 관리자가 요청에 대 한 의사 결정으로 요청 업데이트 |
...
> | Microsoft Marketplace/privateStores/queryNotificationsState/read | 알림 상태 정보, 관리자만 읽기 |
> | Microsoft Marketplace/privateStores/requestApprovals/읽기 | 읽기 요청 승인 |
> | Microsoft Marketplace/privateStores/requestApprovals/write | 요청 승인 만들기 |
> | Microsoft Marketplace/privateStores/RequestApprovals/acknowledgeNotification/write | 알림 승인, 관리자만 |
> | Microsoft Marketplace/privateStores/RequestApprovals/withdrawPlan/write | 제안 알림에서 계획 철회 |
...
> | Microsoft. Compute/capacityReservationGroups/write | 새 용량 예약 그룹을 만들거나 기존 용량 예약 그룹을 업데이트 합니다. |
> | Microsoft. Compute/capacityReservationGroups/delete | 용량 예약 그룹을 삭제 합니다. |
> | Microsoft. Compute/capacityReservationGroups/capacityReservations/read | 용량 예약의 속성을 가져옵니다. |
> | CapacityReservationGroups/capacityReservations/write | 새 용량 예약을 만들거나 기존 용량 예약을 업데이트 합니다. |
> | Microsoft. Compute/capacityReservationGroups/capacityReservations/delete | 용량 예약을 삭제 합니다. |
...
> | Microsoft. Compute/diskAccesses/privateEndpointConnectionsApproval/작업 | 개인 끝점 연결 자동 승인 |
...
> | Microsoft. Compute/diskAccesses/privateEndpointConnections/읽기 | 개인 끝점 연결 가져오기 |
> | Microsoft. Compute/diskAccesses/privateEndpointConnections/쓰기 | 개인 끝점 연결 승인 또는 거부 |
...
> | Microsoft. Compute/restorePointCollections/restorePoints/diskRestorePoints/read | 증분 DiskRestorePoint 속성을 가져옵니다. |
> | Microsoft. Compute/restorePointCollections/restorePoints/diskRestorePoints/beginGetAccess/action | 증분 DiskRestorePoint SAS URI를 가져옵니다. |
> | Microsoft. Compute/restorePointCollections/restorePoints/diskRestorePoints/endGetAccess/action | 증분 DiskRestorePoint SAS URI를 취소 합니다. |
...
> | Microsoft Cdn/operationresults/profileresults/afdendpointresults/제거/작업 |  |
> | Microsoft Cdn/operationresults/profileresults/afdendpointresults/사용/작업 |  |
> | Microsoft Cdn/operationresults/profileresults/afdendpointresults/ValidateCustomDomain/action |  |
> | Microsoft Cdn/operationresults/profileresults/afd endpointresults/routeresults/read |  |
> | Microsoft Cdn/operationresults/profileresults/afd endpointresults/routeresults/write |  |
> | Microsoft Cdn/operationresults/profileresults/afd endpointresults/routeresults/delete |  |
...
> | Microsoft Cdn/operationresults/profileresults/origingroupresults/사용/작업 |  |
...
> | Microsoft Cdn/operationresults/profileresults/rulesetresults/사용/작업 |  |
...
> | Microsoft. Cdn/profiles/afd 끝점/읽기 |  |
> | Microsoft. Cdn/profiles/afd 엔드포인트/write |  |
> | Microsoft. Cdn/profiles/afd 엔드포인트/delete |  |
> | Microsoft. Cdn/profiles/afd 끝점/제거/작업 |  |
> | Microsoft. Cdn/profiles/afin 끝점/사용/작업 |  |
> | Microsoft. Cdn/profiles/afd 엔드포인트/ValidateCustomDomain/action |  |
> | Microsoft. Cdn/profiles/af. 엔드포인트/경로/읽기 |  |
> | Microsoft. Cdn/profiles/af. 엔드포인트/경로/쓰기 |  |
> | Microsoft. Cdn/profiles/af. 엔드포인트/경로/삭제 |  |
...
> | Microsoft. Cdn/profiles/origingroups/사용/작업 |  |
> | Microsoft. Cdn/profiles/origingroups/원본/읽기 |  |
> | Microsoft. Cdn/profiles/origingroups/원본/쓰기 |  |
> | Microsoft. Cdn/profiles/origingroups/원본/삭제 |  |
> | Microsoft. Cdn/프로필/규칙 집합/읽기 |  |
> | Microsoft. Cdn/프로필/규칙 집합/쓰기 |  |
> | Microsoft. Cdn/프로필/규칙 집합/삭제 |  |
> | Microsoft. Cdn/프로필/규칙 집합/사용/작업 |  |
> | Microsoft. Cdn/프로필/규칙 집합/규칙/읽기 |  |
> | Microsoft. Cdn/프로필/규칙 집합/규칙/쓰기 |  |
> | Microsoft. Cdn/프로필/규칙 집합/규칙/삭제 |  |
> | Microsoft. Cdn/프로필/비밀/읽기 |  |
> | Microsoft. Cdn/프로필/비밀/쓰기 |  |
> | Microsoft. Cdn/프로필/비밀/삭제 |  |
> | Microsoft. Cdn/profiles/비밀/ValidateSecret/작업 |  |
...
> | Microsoft. Network/applicationGateways/migrateV1ToV2/action | V1 sku에서 v2 sku로 Application Gateway 마이그레이션 |
> | Microsoft. Network/applicationGateways/getMigrationStatus/action | V1 sku에서 V2 sku로 Application Gateway 마이그레이션 상태를 가져옵니다. |
...
> | Microsoft. Network/connections/resetconnection/action | VNG에 대 한 연결을 다시 설정 합니다. |
...
> | Microsoft. Network/dnsResolvers/읽기 | JSON 형식의 DNS 확인자 속성을 가져옵니다. |
> | Microsoft. Network/dnsResolvers/write | JSON 형식으로 DNS 확인자를 만들거나 업데이트 합니다. |
> | Microsoft. Network/dnsResolvers/delete | DNS 확인자를 삭제 합니다. |
> | Microsoft. Network/dnsResolvers/inboundEndpoints/read | JSON 형식의 DNS 확인자 인바운드 끝점을 가져옵니다. |
> | Microsoft. Network/dnsResolvers/inboundEndpoints/write | JSON 형식으로 DNS 확인자 인바운드 끝점을 만들거나 업데이트 합니다. |
> | Microsoft. Network/dnsResolvers/inboundEndpoints/delete | JSON 형식의 DNS 확인자 인바운드 끝점을 삭제 합니다. |
...
> | Microsoft. 네트워크/위치/dnsResolverOperationResults/읽기 | DNS 확인자 작업의 결과를 JSON 형식으로 가져옵니다. |
> | Microsoft. 네트워크/위치/dnsResolverOperationStatuses/읽기 | DNS 확인자 작업의 상태를 가져옵니다. |
...
> | Microsoft. 네트워크/networkWatchers/토폴로지/읽기 | 리소스 그룹에 포함된 리소스의 네트워크 수준 보기 및 해당 관계를 가져옵니다. |
...
> | microsoft. network/virtualNetworkGateways/natRules/write | NAT 규칙 리소스를 넣습니다. |
> | microsoft. network/virtualNetworkGateways/natRules/delete | NAT 규칙 리소스를 삭제 합니다. |
...
> | Microsoft. Network/virtualNetworks/dnsForwardingRulesets/read | JSON 형식의 Virtual Network에 대 한 DNS 전달 규칙 집합을 가져옵니다. |
> | Microsoft. Network/virtualNetworks/dnsResolvers/읽기 | JSON 형식의 Virtual Network에 대 한 DNS 확인자를 가져옵니다. |
...
> | Microsoft. Network/virtualNetworks/서브넷/joinLoadBalancer/action | 가상 네트워크 서브넷에 부하 분산 장치를 조인 합니다. |
...
> | microsoft. network/vpnGateways/vpnConnections/vpnLinkConnections/getikesas/action | Vpn 연결 연결 IKE 보안 연결을 나열 합니다. |
> | microsoft. network/vpnGateways/vpnConnections/vpnLinkConnections/resetconnection/action | VWAN에 대 한 연결을 다시 설정 합니다. |
...
> | DataBox/등록 취소/작업 | Un-Register 공급자 Databox |
...
Azure 서비스: [Azure 데이터 공유](../data-share/index.yml)

> [!div class="mx-tableFixed"]
> | 작업 | 설명 |
> | --- | --- |
> | DataShare/register/action | 데이터 공유 리소스 공급자에 대 한 구독을 등록 합니다. |
> | DataShare/등록 취소/작업 | 데이터 공유 리소스 공급자에 대 한 구독을 등록 취소 합니다. |
> | DataShare/계정/읽기 | 데이터 공유 계정을 읽습니다. |
> | DataShare/계정/쓰기 | 데이터 공유 계정을 작성 합니다. |
> | DataShare/계정/삭제 | 데이터 공유 계정을 삭제 합니다. |
> | DataShare/계정/공유/읽기 | 데이터 공유 공유를 읽습니다. |
> | DataShare/계정/공유/쓰기 | 데이터 공유 공유를 작성 합니다. |
> | DataShare/계정/공유/삭제 | 데이터 공유 공유를 삭제 합니다. |
> | DataShare/계정/공유/listSynchronizations/작업 | 데이터 공유 ListSynchronization에 대 한 작업입니다. |
> | DataShare/계정/공유/listSynchronizationDetails/작업 | 데이터 공유 ListSynchronization 정보에 대 한 작업입니다. |
> | DataShare/계정/공유/데이터 집합/읽기 | 데이터 집합을 읽습니다. |
> | DataShare/계정/공유/데이터 집합/쓰기 | 데이터 공유 데이터 집합을 만듭니다. |
> | DataShare/계정/공유/데이터 집합/삭제 | 데이터 공유 데이터 집합을 삭제 합니다. |
> | DataShare/계정/공유/초대/읽기 | 데이터 공유 초대를 읽습니다. |
> | DataShare/계정/공유/초대/쓰기 | 데이터 공유 초대를 작성 합니다. |
> | DataShare/계정/공유/초대/삭제 | 데이터 공유 초대를 삭제 합니다. |
> | DataShare/계정/공유/operationResults/read | 데이터 공유 공유를 읽습니다. |
> | DataShare/계정/공유/providerShareSubscriptions/읽기 | 데이터 공유 공급자 ShareSubscription를 읽습니다. |
> | DataShare/계정/공유/providerShareSubscriptions/취소/작업 | 데이터 공유 구독을 해지 합니다. |
> | DataShare/계정/공유/providerShareSubscriptions/복원/작업 | 데이터 공유 구독을은 합니다. |
> | DataShare/계정/공유/synchronizationSettings/읽기 | 데이터 공유 동기화 설정을 읽습니다. |
> | DataShare/계정/공유/synchronizationSettings/쓰기 | 데이터 공유 동기화 설정을 작성 합니다. |
> | DataShare/계정/공유/synchronizationSettings/삭제 | 데이터 공유 동기화 설정을 삭제 합니다. |
> | DataShare/accounts/shareSubscriptions/cancelSynchronization/action | 데이터 공유 동기화를 취소 합니다. |
> | DataShare/accounts/shareSubscriptions/delete | 데이터 공유 공유 구독을 삭제 합니다. |
> | DataShare/accounts/shareSubscriptions/listSourceShareSynchronizationSettings/action | 데이터 공유 원본 공유 SynchronizationSettings를 나열 합니다. |
> | DataShare/accounts/shareSubscriptions/listSynchronizationDetails/action | 데이터 공유 동기화 정보를 나열 합니다. |
> | DataShare/accounts/shareSubscriptions/listSynchronizations/작업 | 데이터 공유 동기화를 나열 합니다. |
> | DataShare/계정/shareSubscriptions/읽기 | 데이터 공유 ShareSubscription을 읽습니다. |
> | DataShare/계정/shareSubscriptions/동기화/작업 | 데이터 공유 동기화 작업을 초기화 합니다. |
> | DataShare/accounts/shareSubscriptions/write | 데이터 공유 ShareSubscription을 작성 합니다. |
> | DataShare/accounts/shareSubscriptions/consumerSourceDataSets/read | 데이터 공유 소비자 원본 데이터 집합을 읽습니다. |
> | DataShare/accounts/shareSubscriptions/dataSetMappings/삭제 | 데이터 공유 DataSetMapping을 삭제 합니다. |
> | DataShare/accounts/shareSubscriptions/dataSetMappings/쓰기 | 데이터 공유 DataSetMapping을 작성 합니다. |
> | DataShare/accounts/shareSubscriptions/dataSetMappings/읽기 | 데이터 공유 DataSetMapping을 읽습니다. |
> | DataShare/accounts/shareSubscriptions/operationResults/read | 장기 실행 작업 상태를 ShareSubscription 하는 데이터 공유를 읽습니다. |
> | DataShare/accounts/shareSubscriptions/shareSubscriptionSynchronizations/read | 데이터 공유 공유 구독 동기화를 읽습니다. |
> | DataShare/accounts/shareSubscriptions/synchronizationOperationResults/read | 데이터 공유 동기화 작업 결과를 읽습니다. |
> | DataShare/accounts/shareSubscriptions/triggers/read | 데이터 공유 트리거를 읽습니다. |
> | DataShare/accounts/shareSubscriptions/triggers/write | 데이터 공유 트리거를 작성 합니다. |
> | DataShare/accounts/shareSubscriptions/triggers/delete | 데이터 공유 트리거를 삭제 합니다. |
> | DataShare/listInvitations/읽기 | 테 넌 트 수준에서 초대를 읽습니다. |
> | DataShare/위치/rejectInvitation/작업 | 데이터 공유 초대를 거부 합니다. |
> | DataShare/위치/consumerInvitations/읽기 | 데이터 공유 소비자 초대를 가져옵니다. |
> | DataShare/위치/operationResults/read | 에서 데이터 공유가 지원 되는 위치를 읽습니다. |
> | DataShare/작업/읽기 | 데이터 공유 리소스 공급자에서 사용 가능한 모든 작업을 읽습니다. |
...
> | Microsoft NetApp/netAppAccounts/capacityPools/볼륨/BackupStatus/read |  |
...
> | Microsoft NetApp/netAppAccounts/snapshotPolicies/볼륨/작업 | 스냅숏 정책에 연결 된 볼륨 나열 |
...
> | Microsoft NetApp/netAppAccounts/volumeGroups/delete | 볼륨 그룹 리소스를 삭제 합니다. |
...
> | Microsoft 저장소/resilienciesProgressions/읽기 |  |
...
> | Microsoft. Storage/storageAccounts/hnsonmigration/action | 고객은 저장소 계정에서 지속적인 Hns 마이그레이션을 중단할 수 있습니다. |
...
> | Microsoft. Storage/storageAccounts/blobServices/컨테이너/b l o b/permanentDelete/작업 |  |
...
Azure 서비스: [Azure 스프링 클라우드](../spring-cloud/index.yml)

> [!div class="mx-tableFixed"]
> | 작업 | 설명 |
> | --- | --- |
> | Microsoft AppPlatform/register/action | Microsoft AppPlatform 리소스 공급자에 구독을 등록 합니다. |
> | Microsoft AppPlatform/등록 취소/작업 | Microsoft AppPlatform 리소스 공급자에서 구독의 등록을 취소 합니다. |
> | Microsoft AppPlatform/위치/checkNameAvailability/action | 리소스 이름 가용성 확인 |
> | Microsoft AppPlatform/위치/operationResults/스프링/읽기 | 리소스 작업 결과 읽기 |
> | Microsoft AppPlatform/위치/operationStatus/operationId/읽기 | 리소스 작업 상태 읽기 |
> | Microsoft AppPlatform/작업/읽기 | Microsoft Azure 스프링 클라우드의 사용 가능한 작업 나열 |
> | Microsoft AppPlatform/sku/읽기 | Microsoft Azure 스프링 클라우드의 사용 가능한 sku 나열 |
> | Microsoft AppPlatform/스프링/쓰기 | 특정 Azure 스프링 클라우드 서비스 인스턴스를 만들거나 업데이트 합니다. |
> | Microsoft AppPlatform/스프링/delete | 특정 Azure 스프링 클라우드 서비스 인스턴스를 삭제 합니다. |
> | Microsoft AppPlatform/스프링/읽기 | Azure 스프링 클라우드 서비스 인스턴스 가져오기 |
> | Microsoft AppPlatform/스프링/enableTestEndpoint/작업 | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대해 테스트 끝점 기능 사용 |
> | Microsoft AppPlatform/스프링/disableTestEndpoint/action | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대해 테스트 끝점 기능 사용 안 함 |
> | Microsoft AppPlatform/스프링/listTestKeys/action | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 테스트 키 나열 |
> | Microsoft AppPlatform/스프링/regenerateTestKey/action | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 테스트 키 다시 생성 |
> | Microsoft AppPlatform/스프링/apps/write | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 응용 프로그램 만들기 또는 업데이트 |
> | Microsoft AppPlatform/스프링/apps/delete | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 응용 프로그램을 삭제 합니다. |
> | Microsoft AppPlatform/스프링/apps/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 응용 프로그램 가져오기 |
> | Microsoft AppPlatform/스프링/apps/getResourceUploadUrl/action | 특정 Microsoft Azure 스프링 클라우드 응용 프로그램의 리소스 업로드 URL 가져오기 |
> | Microsoft AppPlatform/스프링/apps/validateDomain/action | 특정 응용 프로그램에 대 한 사용자 지정 도메인 유효성 검사 |
> | Microsoft AppPlatform/스프링/앱/바인딩/쓰기 | 특정 응용 프로그램에 대 한 바인딩을 만들거나 업데이트 합니다. |
> | Microsoft AppPlatform/스프링/앱/바인딩/삭제 | 특정 응용 프로그램에 대 한 바인딩 삭제 |
> | Microsoft AppPlatform/스프링/앱/바인딩/읽기 | 특정 응용 프로그램에 대 한 바인딩 가져오기 |
> | Microsoft AppPlatform/스프링/앱/배포/쓰기 | 특정 응용 프로그램에 대 한 배포 만들기 또는 업데이트 |
> | Microsoft AppPlatform/스프링/앱/배포/삭제 | 특정 응용 프로그램에 대 한 배포 삭제 |
> | Microsoft AppPlatform/스프링/앱/배포/읽기 | 특정 응용 프로그램에 대 한 배포 가져오기 |
> | Microsoft AppPlatform/스프링/앱/배포/시작/작업 | 특정 응용 프로그램에 대 한 배포 시작 |
> | Microsoft AppPlatform/스프링/앱/배포/중지/작업 | 특정 응용 프로그램에 대 한 배포 중지 |
> | Microsoft AppPlatform/스프링/앱/배포/다시 시작/작업 | 특정 응용 프로그램에 대 한 배포 다시 시작 |
> | Microsoft AppPlatform/스프링/apps/배포/getLogFileUrl/작업 | 특정 Microsoft Azure 스프링 클라우드 응용 프로그램 배포의 로그 파일 URL 가져오기 |
> | Microsoft AppPlatform/스프링/앱/배포/sku/읽기 | 응용 프로그램 배포의 사용 가능한 sku 나열 |
> | Microsoft AppPlatform/스프링/앱/도메인/쓰기 | 특정 응용 프로그램에 대 한 사용자 지정 도메인 만들기 또는 업데이트 |
> | Microsoft AppPlatform/스프링/앱/도메인/삭제 | 특정 응용 프로그램에 대 한 사용자 지정 도메인 삭제 |
> | Microsoft AppPlatform/스프링/앱/도메인/읽기 | 특정 응용 프로그램에 대 한 사용자 지정 도메인 가져오기 |
> | Microsoft AppPlatform/스프링/certificate/write | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 인증서 만들기 또는 업데이트 |
> | Microsoft AppPlatform/스프링/certificate/delete | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 인증서를 삭제 합니다. |
> | Microsoft AppPlatform/스프링/certificate/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 인증서 가져오기 |
> | Microsoft AppPlatform/스프링/configServers/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 구성 서버 가져오기 |
> | Microsoft AppPlatform/스프링/configServers/write | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 구성 서버를 만들거나 업데이트 합니다. |
> | Microsoft AppPlatform/스프링/배포/읽기 | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 배포 가져오기 |
> | Microsoft AppPlatform/스프링/감지기/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 감지기 가져오기 |
> | Microsoft AppPlatform/스프링/monitoringSettings/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 모니터링 설정 가져오기 |
> | Microsoft AppPlatform/스프링/monitoringSettings/write | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 모니터링 설정 만들기 또는 업데이트 |
> | **DataAction** | **설명** |
> | Microsoft AppPlatform/스프링/configService/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 구성 콘텐츠 (예: 응용 프로그램)를 읽습니다. |
> | Microsoft AppPlatform/스프링/eurekaService/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 사용자 앱 등록 정보를 읽습니다. |
> | Microsoft AppPlatform/스프링/eurekaService/write | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 사용자 앱 등록 정보를 작성 합니다. |
> | Microsoft AppPlatform/스프링/eurekaService/delete | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 사용자 앱 등록 정보를 삭제 합니다. |
> | Microsoft AppPlatform/스프링/logstreamService/read | 특정 Azure 스프링 클라우드 서비스 인스턴스에 대 한 사용자 앱의 스트리밍 로그를 읽습니다. |
...
> | Microsoft Maps/계정/서비스/권한 상승/읽기 | 권한 상승 서비스의 데이터를 읽을 수 있습니다. |
...
> | Microsoft 미디어/비디오 분석기/읽기 | 비디오 분석기 계정 읽기 |
> | Microsoft 미디어/비디오 분석기/쓰기 | 비디오 분석기 계정 작성 |
> | Microsoft 미디어/비디오 분석기/삭제 | 비디오 분석기 계정 삭제 |
> | Microsoft Media/videoAnalyzers/syncStorageKeys/작업 | 연결 된 저장소 계정의 저장소 키 동기화 |
...
> | Microsoft. 검색/searchServices/privateEndpointConnections/write | 지정 된 매개 변수를 사용 하 여 개인 끝점 연결을 만들거나 지정 된 개인 끝점 연결에 대 한 속성 또는 태그를 업데이트 합니다. |
> | Microsoft. 검색/searchServices/privateEndpointConnections/읽기 | 개인 끝점 연결의 목록을 반환 하거나, 지정 된 개인 끝점 연결의 속성을 가져옵니다. |
> | Microsoft. 검색/searchServices/privateEndpointConnections/delete | 기존 개인 끝점 연결을 삭제 합니다. |
...
> | **DataAction** | **설명** |
> | SignalRService/SignalR/auth/accessKey/action | ClientTokens에 서명 하기 위한 임시 AccessKey를 생성 합니다. |
> | SignalRService/SignalR/auth/clientToken/action | 클라이언트 연결을 시작 하기 위한 ClientToken을 생성 합니다. |
> | SignalRService/SignalR/clientConnection/send/action | 클라이언트 연결에 직접 메시지를 보냅니다. |
> | SignalRService/SignalR/clientConnection/read | 클라이언트 연결 존재를 확인 합니다. |
> | SignalRService/SignalR/clientConnection/write | 클라이언트 연결을 닫습니다. |
> | SignalRService/SignalR/그룹/송신/작업 | 그룹에 메시지를 브로드캐스트합니다. |
> | SignalRService/SignalR/그룹/읽기 | 그룹의 존재 여부 또는 그룹의 사용자 유무를 확인 합니다. |
> | SignalRService/SignalR/그룹/쓰기 | 그룹에 참가/탈퇴 합니다. |
> | SignalRService/SignalR/허브/송신/작업 | 허브의 모든 클라이언트 연결에 메시지를 브로드캐스트합니다. |
> | SignalRService/SignalR/serverConnection/write | 서버 연결을 시작 합니다. |
> | SignalRService/SignalR/사용자/송신/작업 | 여러 클라이언트 연결로 구성 될 수 있는 사용자에 게 메시지를 보냅니다. |
> | SignalRService/SignalR/사용자/읽기 | 사용자 존재를 확인 합니다. |
> | SignalRService/SignalR/사용자/쓰기 |  |
...
> | Microsoft 웹/customhostnames 이름/읽기 | 구독에 할당 된 사용자 지정 호스트 이름을 가져옵니다. |
> | Microsoft 웹/customhostnames 이름/사이트/읽기 | 사용자 지정 호스트 이름에 할당 된 사이트의 이름을 가져옵니다. |
...
> | Microsoft. Web/hostingEnvironments/privateEndpointConnections/Write | 개인 끝점 연결을 승인 하거나 거부 합니다. |
> | Microsoft 웹/hostingEnvironments/privateEndpointConnections/읽기 | 개인 끝점 연결 또는 개인 끝점 연결 목록을 가져옵니다. |
> | Microsoft 웹/hostingEnvironments/privateEndpointConnections/Delete | 개인 끝점 연결을 삭제 합니다. |
> | Microsoft 웹/hostingEnvironments/privateLinkResources/읽기 | 개인 링크 리소스를 가져옵니다. |
...
> | Microsoft 웹/kubeEnvironments/읽기 | Kubernetes 환경의 속성을 가져옵니다. |
> | Microsoft 웹/kubeEnvironments/쓰기 | Kubernetes 환경을 만들거나 기존 환경을 업데이트 합니다. |
> | Microsoft 웹/kubeEnvironments/삭제 | Kubernetes 환경 삭제 |
> | Microsoft 웹/kubeEnvironments/조인/작업 | Kubernetes 환경을 조인 합니다. |
> | Microsoft 웹/kubeEnvironments/작업/읽기 | Kubernetes 환경에 대 한 작업 가져오기 |
...
> | Microsoft. 웹/위치/previewstaticsiteworkflowfile/작업 | 정적 사이트 워크플로 파일 미리 보기 |
...
> | Microsoft 웹/staticSites/listappsettings/Action | 정적 사이트에 대 한 앱 설정을 나열 합니다. |
...
> | Microsoft Web/staticSites/privateEndpointConnections/Write | 정적 사이트에 대 한 개인 끝점 연결 승인 또는 거부 |
> | Microsoft Web/staticSites/privateEndpointConnections/Read | 정적 사이트에 대 한 개인 끝점 연결 또는 개인 끝점 연결 목록 가져오기 |
> | Microsoft System.web/staticSites/privateEndpointConnections/Delete | 정적 사이트에 대 한 개인 끝점 연결 삭제 |
> | Microsoft Web/staticSites/privateLinkResources/Read | 개인 링크 리소스 가져오기 |
...
> | ContainerInstance/containerGroups/컨테이너/연결/작업 | 컨테이너의 출력 스트림에 연결 합니다. |
...
> | ContainerInstance/containerGroups/감지기/read | 컨테이너 그룹 감지기 나열 |
...
> | Microsoft.containerregistry/registry/privateEndpointConnections/read | 개인 끝점 연결의 속성을 가져오거나 지정 된 컨테이너 레지스트리에 대 한 모든 개인 끝점 연결을 나열 합니다. |
> | Microsoft.containerregistry/registry/privateEndpointConnections/write | 개인 끝점 연결을 승인/거부 합니다. |
> | Microsoft.containerregistry/registry/privateEndpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
...
> | ContainerService/managedClusters/runCommand/action | 관리 되는 kubernetes 서버에 대해 사용자가 발급 한 명령을 실행 합니다. |
...
> | ContainerService/managedClusters/commandResults/read | 이전에 실행 한 명령에서 결과를 검색 합니다. |
...
> | ContainerService/managedClusters/maintenanceConfigurations/read | 유지 관리 구성을 가져옵니다. |
> | ContainerService/managedClusters/maintenanceConfigurations/write | 새 MaintenanceConfiguration을 만들거나 기존 항목을 업데이트 합니다. |
> | ContainerService/managedClusters/maintenanceConfigurations/delete | 유지 관리 구성을 삭제 합니다. |
...
> | Microsoft. Cache/위치/checknameavailability/action | 새 Redis 엔터프라이즈 캐시에서 사용할 수 있는 이름 인지 확인 합니다. |
> | AsyncOperations/위치/m s/읽기 | 비동기 작업의 상태를 읽습니다. |
> | Microsoft. 캐시/위치/operationResults/read | 이전에 'Location' 헤더가 클라이언트에 반환된 장기 실행 작업의 결과를 가져옵니다 |
> | OperationsStatus/위치/m s/읽기 | 이전에 ' AzureAsync ' 헤더가 클라이언트에 반환 된 장기 실행 작업의 상태를 확인 합니다. |
...
> | Microsoft.Cache/redis/stop/action | 잠재적으로 데이터가 손실 될 수 있는 Redis에 대 한 Azure 캐시를 중지 합니다. |
> | Microsoft.Cache/redis/start/action | Redis에 대 한 Azure 캐시 시작 |
...
> | Microsoft. Cache/redisEnterprise/delete | 전체 Redis Enterprise 캐시 삭제 |
> | Microsoft Cache/redisEnterprise/read | 관리 포털에서 Redis Enterprise cache의 설정 및 구성 보기 |
> | Microsoft Cache/redisEnterprise/write | 관리 포털에서 Redis Enterprise cache의 설정 및 구성 수정 |
> | Microsoft. Cache/redisEnterprise/databases/delete | Redis Enterprise 데이터베이스와 해당 내용을 삭제 합니다. |
> | Microsoft. Cache/redisEnterprise/databases/read | 관리 포털에서 Redis Enterprise cache 데이터베이스의 설정 및 구성 보기 |
> | Microsoft. Cache/redisEnterprise/databases/write | 관리 포털에서 Redis Enterprise cache 데이터베이스의 설정 및 구성 수정 |
> | Microsoft. Cache/redisEnterprise/databases/export/action | Redis Enterprise 데이터베이스에서 저장소 blob로 데이터 내보내기  |
> | Microsoft. Cache/redisEnterprise/databases/forceUnlink 해제/작업 | Georeplica Redis Enterprise 데이터베이스를 피어에서 강제로 연결 해제 |
> | Microsoft. Cache/redisEnterprise/databases/import/action | 저장소 blob에서 Redis Enterprise 데이터베이스로 데이터 가져오기 |
> | Microsoft Cache/redisEnterprise/databases/listKeys/action | 관리 포털에서 Redis Enterprise 데이터베이스 액세스 키의 값을 확인 합니다. |
> | Microsoft Cache/redisEnterprise/databases/regenerateKey/action | 관리 포털에서 Redis Enterprise 데이터베이스 액세스 키의 값을 변경 합니다. |
> | Microsoft Cache/redisEnterprise/databases/operationResults/read | 관리 포털에서 Redis Enterprise database 작업의 결과 보기 |
> | Microsoft Cache/redisEnterprise/operationResults/read | 관리 포털에서 Redis Enterprise 작업의 결과 보기 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 프록시 유효성 검사 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다. |
> | Microsoft Cache/redisEnterprise/privateEndpointConnectionProxies/operationResults/read | 관리 포털에서 개인 끝점 연결 작업의 결과 보기 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnections/read | 개인 끝점 연결 읽기 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnections/write | 개인 끝점 연결 작성 |
> | Microsoft Cache/redisEnterprise/privateEndpointConnections/delete | 개인 끝점 연결 삭제 |
> | Microsoft Cache/redisEnterprise/privateLinkResources/read | 개인 링크를 연결할 수 있는 redis subresource의 ' groupId '를 읽습니다. |
...
> | DataFactory/factory/integrationruntimes/enableInteractiveQuery/action | 대화형 제작 세션을 사용 하도록 설정 합니다. |
> | DataFactory/factory/integrationruntimes/disableInteractiveQuery/action | 대화형 제작 세션을 사용 하지 않도록 설정 합니다. |
...
> | DataFactory/factory/managedVirtualNetworks/read | 관리 되는 Virtual Network을 읽습니다. |
> | DataFactory/공장/managedVirtualNetworks/write | 관리 되는 Virtual Network을 만들거나 업데이트 합니다. |
> | DataFactory/factory/managedVirtualNetworks/managedPrivateEndpoints/read | 관리 되는 개인 끝점을 읽습니다. |
> | DataFactory/factory/managedVirtualNetworks/managedPrivateEndpoints/write | 관리 되는 개인 끝점을 만들거나 업데이트 합니다. |
> | DataFactory/factory/managedVirtualNetworks/managedPrivateEndpoints/delete | 관리 되는 개인 끝점을 삭제 합니다. |
...
> | DataFactory/factory/queryFeaturesValue/read | 기능 목록에 대 한 노출 제어 기능 값을 읽습니다. |
...
> | DataFactory/factory/triggers/querysubscriptionevents/action | 구독 이벤트를 쿼리 합니다. |
> | DataFactory/factory/triggers/deletequeuedsubscriptionevents/action | 대기 중인 구독 이벤트를 삭제 합니다. |
...
> | DBforMariaDB/servers/resetQueryPerformanceInsightData/action | Query Performance Insight 데이터 다시 설정 |
...
> | DBforMariaDB/servers/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
...
> | Microsoft DBforMySQL/servers/resetQueryPerformanceInsightData/action | Query Performance Insight 데이터 다시 설정 |
...
> | DBforPostgreSQL/servers/resetQueryPerformanceInsightData/action | Query Performance Insight 데이터 다시 설정 |
...
> | DBforPostgreSQL/servers/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
...
> | Microsoft.DocumentDB/cassandraClusters/read | 관리 되는 Cassandra 클러스터를 읽거나 관리 되는 모든 Cassandra 클러스터를 나열 합니다. |
> | Microsoft.DocumentDB/cassandraClusters/write | 관리 되는 Cassandra 클러스터 만들기 또는 업데이트 |
> | Microsoft.DocumentDB/cassandraClusters/delete | 관리 되는 Cassandra 클러스터 삭제 |
> | Microsoft.DocumentDB/cassandraClusters/복구/작업 | 관리 되는 Cassandra keyspace에 대 한 복구 요청 |
> | Microsoft.DocumentDB/cassandraClusters/fetchNodeStatus/action | 관리 되는 Cassandra 클러스터의 모든 노드에 대 한 노드 상태를 비동기적으로 인출 |
> | Microsoft.DocumentDB/cassandraClusters/데이터 센터/읽기 | 관리 되는 Cassandra 클러스터의 데이터 센터를 읽거나 관리 되는 Cassandra 클러스터의 모든 데이터 센터를 나열 합니다. |
> | Microsoft.DocumentDB/cassandraClusters/데이터 센터/쓰기 | 관리 되는 Cassandra 클러스터에서 데이터 센터 만들기 또는 업데이트 |
> | Microsoft.DocumentDB/cassandraClusters/데이터 센터/삭제 | 관리 되는 Cassandra 클러스터에서 데이터 센터 삭제 |
...
> | Microsoft.DocumentDB/databaseAccounts/sqlRoleAssignments/read | SQL 역할 할당 읽기 |
...
> | Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions/읽기 | SQL 역할 정의 읽기 |
> | Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions/write | SQL 역할 정의 만들기 또는 업데이트 |
> | Microsoft.DocumentDB/databaseAccounts/sqlRoleDefinitions/삭제 | SQL 역할 정의 삭제 |
...
> | Microsoft .Sql/위치/administratorAzureAsyncOperation/읽기 | Azure async 관리자 작업 결과의 관리 되는 인스턴스를 가져옵니다. |
> | Microsoft .Sql/위치/관리자 Operationresults/read | 관리 되는 인스턴스 관리자의 작업 결과를 가져옵니다. |
...
> | Microsoft .Sql/위치/devOpsAuditingSettingsAzureAsyncOperation/읽기 | 서버 DevOps 감사 정책 집합 작업의 결과를 검색 합니다. |
> | Microsoft .Sql/위치/devOpsAuditingSettingsOperationResults/읽기 | 서버 DevOps 감사 정책 집합 작업의 결과를 검색 합니다. |
...
> | Microsoft .Sql/위치/hybridCertificateAzureAsyncOperation/읽기 | Azure Sql Managed Instance의 장기 하이브리드 인증서 비동기 작업 상태를 가져옵니다. |
> | Microsoft .Sql/위치/hybridCertificateOperationResults/읽기 | 장기 하이브리드 인증서 비동기 작업의 상태를 가져옵니다. |
> | Microsoft .Sql/위치/hybridLinkAzureAsyncOperation/읽기 | Azure Sql Managed Instance의 장기 하이브리드 연결 비동기 작업 상태를 가져옵니다. |
> | Microsoft .Sql/위치/hybridLinkOperationResults/읽기 | 장기 하이브리드 링크 비동기 작업의 상태를 가져옵니다. |
...
> | Microsoft .Sql/위치/longTermRetentionBackupAzureAsyncOperation/읽기 | 장기 보존 백업 작업의 상태를 가져옵니다. |
> | Microsoft .Sql/위치/longTermRetentionBackupOperationResults/읽기 | 장기 보존 백업 작업의 상태를 가져옵니다. |
> | Microsoft.Sql/locations/longTermRetentionBackups/read | 위치에 있는 모든 서버의 모든 데이터베이스에 대한 장기 보존 백업을 나열합니다. |
> | Microsoft .Sql/위치/longTermRetentionManagedInstanceBackupAzureAsyncOperation/읽기 | 관리 되는 인스턴스 장기 보존 백업 작업의 상태를 가져옵니다. |
> | Microsoft .Sql/위치/longTermRetentionManagedInstanceBackupOperationResults/읽기 | 관리 되는 인스턴스 장기 보존 백업 작업의 상태를 가져옵니다. |
...
> | Microsoft .Sql/위치/longTermRetentionServers/longTermRetentionDatabases/longTermRetentionBackups/복사/동작 | 장기 보존 백업 복사 |
> | Microsoft .Sql/위치/longTermRetentionServers/longTermRetentionDatabases/longTermRetentionBackups/update/action | 장기 보존 백업 업데이트 |
...
> | Microsoft .Sql/managedInstances/hybridCertificate/action | 지정 된 매개 변수를 사용 하 여 하이브리드 인증서를 만들거나 업데이트 합니다. |
...
> | Microsoft .Sql/managedInstances/hybridLink/read | 하이브리드 링크 목록을 반환 하거나 지정 된 분산 가용성 그룹에 대 한 속성을 가져옵니다. |
> | Microsoft .Sql/managedInstances/hybridLink/write | 지정 된 매개 변수를 사용 하 여 하이브리드 링크를 만들거나 업데이트 합니다. |
> | Microsoft .Sql/managedInstances/hybridLink/delete | 지정 된 분산 가용성 그룹을 사용 하 여 하이브리드 링크를 삭제 합니다. |
...
> | Microsoft .Sql/restorableDroppedManagedInstances/read | 복원 가능한 삭제 된 관리 되는 인스턴스의 목록을 반환 합니다. |
> | Microsoft.Sql/servers/tdeCertificates/action | TDE 인증서를 만들거나 업데이트합니다. |
> | Microsoft.Sql/servers/import/action | 새 Azure SQL Database 가져오기 |
...
> | Microsoft .Sql/servers/devOpsAuditingSettings/read | 지정 된 서버에 구성 된 서버 DevOps 감사 정책의 세부 정보를 검색 합니다. |
> | Microsoft .Sql/servers/devOpsAuditingSettings/write | 지정 된 서버에 대 한 서버 DevOps 감사 정책 변경 |
...
> | Microsoft .Sql/virtualClusters/updateManagedInstanceDnsServers/작업 | Azure SQL 가상 클러스터의 DNS 서버 구성을 가상 클러스터가 있는 Azure Virtual Network의 구성과 동기화 합니다. |
...
> | Databricks/작업 영역/migratePrivateLinkWorkspaces/작업 | ' RequiredNsgRules ' 및 ' enablePublicAccess '를 기반으로 새 NIP 템플릿을 적용 합니다. |
...
> | DataLakeStore/계정/cosmosCertMappings/읽기 | Cosmos 인증서 매핑에 대 한 정보를 가져옵니다. |
> | DataLakeStore/accounts/cosmosCertMappings/write | Cosmos 인증서 매핑을 만들거나 업데이트 합니다. |
> | DataLakeStore/accounts/cosmosCertMappings/delete | Cosmos 인증서 매핑을 삭제 합니다. |
...
> | DataLakeStore/계정/탑재 지점이/읽기 | 탑재 지점에 대 한 정보를 가져옵니다. |
...
> | Microsoft EventHub/네임 스페이스/privateEndpointConnectionsApproval/action | 개인 끝점 연결 승인 |
...
> | Microsoft .Kusto/클러스터/AttachedDatabaseConfigurations/write | 스크립트 리소스를 작성 합니다. |
> | Microsoft. Kusto/클러스터/AttachedDatabaseConfigurations/delete | 스크립트 리소스를 삭제 합니다. |
...
> | Microsoft. Kusto/클러스터/데이터베이스/스크립트/읽기 | 연결 된 데이터베이스 구성 리소스를 읽습니다. |
...
> | Microsoft .Kusto/클러스터/ManagedPrivateEndpoints/읽기 | 연결 된 데이터베이스 구성 리소스를 읽습니다. |
> | Microsoft .Kusto/클러스터/ManagedPrivateEndpoints/write |  |
> | Microsoft. Kusto/클러스터/ManagedPrivateEndpoints/delete |  |
...
> | Microsoft. PowerBIDedicated/autoScaleVCores/read | 지정 된 Power BI 자동 크기 조정 V 코어의 정보를 검색 합니다. |
> | Microsoft. PowerBIDedicated/autoScaleVCores/write | 지정 된 Power BI 자동 크기 조정 V 코어를 만들거나 업데이트 합니다. |
> | Microsoft. PowerBIDedicated/autoScaleVCores/delete | Power BI 자동 크기 조정 V 코어를 삭제 합니다. |
> | Microsoft.PowerBIDedicated/capacities/read | 지정 된 Power BI 용량의 정보를 검색 합니다. |
> | Microsoft.PowerBIDedicated/capacities/write | 지정 된 Power BI 용량을 만들거나 업데이트 합니다. |
> | Microsoft.PowerBIDedicated/capacities/delete | Power BI 용량을 삭제 합니다. |
...
> | Microsoft. PowerBIDedicated/위치/checkNameAvailability/action | 지정 된 Power BI 용량 이름이 유효 하 고 사용 중인지 확인 합니다. |
...
Azure 서비스: [Azure 부서의 범위](../purview/index.yml)

> [!div class="mx-tableFixed"]
> | 작업 | 설명 |
> | --- | --- |
> | 부서의 범위/register/action | Microsoft 부서의 범위 provider에 대 한 구독을 등록 합니다. |
> | 부서의 범위/등록 취소/작업 | Microsoft 부서의 범위 provider에 대 한 구독을 등록 취소 합니다. |
> | 부서의 범위/setDefaultAccount/action | 범위에 대 한 기본 계정을 설정 합니다. |
> | 부서의 범위/계정/읽기 | Microsoft 부서의 범위 provider에 대 한 계정 리소스를 읽습니다. |
> | 부서의 범위/계정/쓰기 | Microsoft 부서의 범위 provider에 대 한 계정 리소스를 작성 합니다. |
> | 부서의 범위/계정/삭제 | Microsoft 부서의 범위 provider에 대 한 계정 리소스를 삭제 합니다. |
> | 부서의 범위/계정/이동/작업 | Microsoft 부서의 범위 provider에 대 한 계정 리소스를 이동 합니다. |
> | 부서의 범위/계정/PrivateEndpointConnectionsApproval/작업 | 개인 끝점 연결을 승인 합니다. |
> | 부서의 범위/계정/privateEndpointConnectionProxies/읽기 | 계정 개인 끝점 연결 프록시를 읽습니다. |
> | 부서의 범위/accounts/privateEndpointConnectionProxies/write | 계정 개인 끝점 연결 프록시를 작성 합니다. |
> | 부서의 범위/accounts/privateEndpointConnectionProxies/delete | 계정 개인 끝점 연결 프록시를 삭제 합니다. |
> | 부서의 범위/accounts/privateEndpointConnectionProxies/validate/action | 계정 개인 끝점 연결 프록시를 확인 합니다. |
> | 부서의 범위/accounts/privateEndpointConnectionProxies/operationResults/read | 개인 끝점 연결 프록시 비동기 작업을 모니터링 합니다. |
> | 부서의 범위/계정/privateEndpointConnections/읽기 | 개인 끝점 연결을 읽습니다. |
> | 부서의 범위/accounts/privateEndpointConnections/write | 개인 끝점 연결을 만들거나 업데이트 합니다. |
> | 부서의 범위/accounts/privateEndpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
> | 부서의 범위/getDefaultAccount/읽기 | 범위에 대 한 기본 계정을 가져옵니다. |
> | 부서의 범위/위치/operationResults/read | 비동기 작업을 모니터링 합니다. |
> | 부서의 범위/작업/읽기 | Microsoft 부서의 범위 provider에 대해 사용 가능한 모든 작업을 읽습니다. |
> | **DataAction** | **설명** |
> | 부서의 범위/계정/데이터/읽기 | 데이터 개체를 읽습니다. |
> | 부서의 범위/계정/데이터/쓰기 | 데이터 개체를 만들고, 업데이트 하 고, 삭제 합니다. |
> | 부서의 범위/계정/검사/읽기 | 데이터 원본 및 검색을 읽습니다. |
> | 부서의 범위/계정/검사/쓰기 | 데이터 원본을 만들고, 업데이트 하 고, 삭제 하며 검색을 관리 합니다. |
...
> | 작업 | 설명 |
> | --- | --- |
> | Synapse/checkNameAvailability/action | 작업 영역 이름 가용성을 확인 합니다. |
> | Synapse/register/action | Azure Synapse Analytics (작업 영역) 리소스 공급자를 등록 하 고 작업 영역을 만들 수 있도록 합니다. |
> | Synapse/등록 취소/작업 | Azure Synapse Analytics (작업 영역) 리소스 공급자를 등록 취소 하 고 작업 영역 만들기를 사용 하지 않도록 설정 합니다. |
> | Synapse/위치/operationResults/read | 비동기 작업 결과를 읽습니다. |
> | Synapse/위치/operationStatuses/읽기 | 비동기 작업 상태를 읽습니다. |
> | Synapse/작업/읽기 | Azure Synapse Analytics 리소스 공급자에서 사용 가능한 작업을 읽습니다. |
> | Synapse/privateLinkHubs/write | PrivateLinkHubs를 만듭니다. |
> | Synapse/privateLinkHubs/읽기 | 모든 PrivateLinkHubs을 읽습니다. |
> | Synapse/privateLinkHubs/delete | PrivateLinkHubs를 삭제 합니다. |
> | Synapse/privateLinkHubs/privateEndpointConnections/write | PrivateLinkHub에 대 한 개인 끝점 연결 만들기 또는 업데이트 |
> | Synapse/privateLinkHubs/privateEndpointConnections/read | PrivateLinkHub에 대 한 개인 끝점 연결을 읽습니다. |
> | Synapse/privateLinkHubs/privateEndpointConnections/delete | PrivateLinkHub에 대 한 개인 끝점 연결 삭제 |
> | Synapse/privateLinkHubs/privateLinkResources/read | 개인 링크 리소스 목록 가져오기 |
> | Synapse/resourceGroups/operationStatuses/읽기 | 비동기 작업 상태를 읽습니다. |
> | Synapse/작업 영역/replaceAllIpFirewallRules/작업 | 작업 영역에 대 한 모든 Ip 방화벽 규칙을 바꿉니다. |
> | Synapse/작업 영역/쓰기 | 작업 영역을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/읽기 | 모든 작업 영역을 읽습니다. |
> | Synapse/작업 영역/삭제 | 작업 영역을 삭제 합니다. |
> | Synapse/workspaces/checkDefaultStorageAccountStatus/action | 기본 저장소 계정 상태를 확인 합니다. |
> | Synapse/작업 영역/관리자/쓰기 | 작업 영역에서 Active Directory 관리자 설정 |
> | Synapse/작업 영역/관리자/읽기 | 관리자 Active Directory 작업 영역 가져오기 |
> | Synapse/작업 영역/관리자/삭제 | 관리자 Active Directory 작업 영역 삭제 |
> | Synapse/작업 영역/감사 Ingsettings/write | SQL server 감사 설정을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/auditingSettings/read | 기본 SQL server 감사 설정을 읽습니다. |
> | Synapse/작업 영역/bigDataPools/쓰기 | Spark 풀을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/bigDataPools/읽기 | 모든 Spark 풀을 읽습니다. |
> | Synapse/작업 영역/bigDataPools/삭제 | 모든 Spark 풀을 삭제 합니다. |
> | Synapse/workspaces/extendedAuditingSettings/write | SQL server 확장 감사 설정을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/extendedAuditingSettings/read | 기본 SQL server 확장 감사 설정을 읽습니다. |
> | Synapse/작업 영역/firewallRules/쓰기 | IP 방화벽 규칙을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/firewallRules/읽기 | IP 방화벽 규칙 읽기 |
> | Synapse/작업 영역/firewallRules/삭제 | 모든 IP 방화벽 규칙을 삭제 합니다. |
> | Synapse/작업 영역/integrationRuntimes/읽기 | 모든 Integration Runtime을 가져옵니다. |
> | Synapse/작업 영역/integrationruntimes/쓰기 | 통합 런타임을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/integrationRuntimes/삭제 | 모든 Integration Runtime 삭제 |
> | Synapse/작업 영역/integrationRuntimes/getStatus/작업 | 모든 Integration Runtime의 상태 가져오기 |
> | Synapse/작업 영역/integrationRuntimes/createExpressSHIRInstallLink/작업 | Integration Runtime 설치 링크 만들기 |
> | Synapse/작업 영역/integrationRuntimes/시작/작업 | 모든 Integration Runtime 시작 |
> | Synapse/작업 영역/integrationRuntimes/중지/작업 | 모든 Integration Runtime 중지 |
> | Synapse/작업 영역/integrationRuntimes/getConnectionInfo/작업 | 모든 Integration Runtime에 대 한 연결 정보 가져오기 |
> | Synapse/작업 영역/integrationRuntimes/regenerateAuthKey/작업 | 모든 Integration Runtime의 인증 키 다시 생성 |
> | Synapse/workspaces/integrationRuntimes/listAuthKeys/작업 | 모든 Integration Runtime의 인증 키 나열 |
> | Synapse/workspaces/integrationRuntimes/removeNode/action | 모든 Integration Runtime 노드 제거 |
> | Synapse/작업 영역/integrationRuntimes/monitoringData/작업 | 모든 Integration Runtime의 모니터링 데이터 가져오기 |
> | Synapse/작업 영역/integrationRuntimes/syncCredentials/action | 모든 Integration Runtime에서 자격 증명 동기화 |
> | Synapse/작업 영역/integrationRuntimes/업그레이드/작업 | 모든 Integration Runtime 업그레이드 |
> | Synapse/작업 영역/integrationRuntimes/removeLinks/작업 | 모든 Integration Runtime 링크 제거 |
> | Synapse/작업 영역/integrationRuntimes/enableInteractiveQuery/작업 | 모든 Integration Runtime에서 대화형 쿼리 사용 |
> | Synapse/작업 영역/integrationRuntimes/disableInteractiveQuery/작업 | 모든 Integration Runtime에서 대화형 쿼리 사용 안 함 |
> | Synapse/workspaces/integrationRuntimes/refreshObjectMetadata/action | Intergration 런타임에 개체 메타 데이터 새로 고침 |
> | Synapse/작업 영역/integrationRuntimes/getObjectMetadata/작업 | 모든 Intergration 런타임에 개체 메타 데이터 가져오기 |
> | Synapse/작업 영역/integrationRuntimes/노드/읽기 | Integration Runtime 노드를 가져옵니다. |
> | Synapse/작업 영역/integrationRuntimes/노드/삭제 | 모든 Integration Runtime 노드를 삭제 합니다. |
> | Synapse/workspaces/integrationRuntimes/nodes/write | Integration Runtime 노드를 패치 합니다. |
> | Synapse/workspaces/integrationRuntimes/nodes/ipAddress/action | Integration Runtime Ip 주소 가져오기 |
> | Synapse/작업 영역/키/쓰기 | 작업 영역 키 만들기 또는 업데이트 |
> | Synapse/작업 영역/키/읽기 | 작업 영역 키 정의를 읽습니다. |
> | Synapse/작업 영역/키/삭제 | 작업 영역 키를 삭제 합니다. |
> | Synapse/작업 영역/라이브러리/읽기 | 라이브러리 아티팩트 읽기 |
> | Synapse/작업 영역/managedIdentitySqlControlSettings/쓰기 | 작업 영역에서 관리 되는 Id SQL 제어 설정 업데이트 |
> | Synapse/작업 영역/managedIdentitySqlControlSettings/읽기 | 관리 Id SQL 컨트롤 설정 가져오기 |
> | Synapse/workspaces/managedVirtualNetworks/managedPrivateEndpoints/read | 관리 되는 개인 끝점을 읽습니다. |
> | Synapse/workspaces/managedVirtualNetworks/managedPrivateEndpoints/delete | 관리 되는 모든 개인 끝점을 삭제 합니다. |
> | Synapse/workspaces/managedVirtualNetworks/managedPrivateEndpoints/write | 관리 되는 개인 끝점을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/operationResults/read | 비동기 작업 결과를 읽습니다. |
> | Synapse/작업 영역/작업 상태/읽기 | 비동기 작업 상태를 읽습니다. |
> | Synapse/작업 영역/privateEndpointConnections/쓰기 | 개인 끝점 연결 만들기 또는 업데이트 |
> | Synapse/작업 영역/privateEndpointConnections/읽기 | 모든 개인 끝점 연결을 읽습니다. |
> | Synapse/작업 영역/privateEndpointConnections/삭제 | 개인 끝점 연결 삭제 |
> | Synapse/작업 영역/privateLinkResources/읽기 | 개인 링크 리소스 목록 가져오기 |
> | Synapse/작업 영역/recoverableSqlpools/읽기 | SQL Analytics 풀의 지역 백업을 나타내는 리소스인 복구 가능한 SQL 분석 풀을 가져옵니다. |
> | Synapse/작업 영역/restorableDroppedSqlPools/읽기 | 복원할 수 있는 삭제 된 Sql 풀을 가져옵니다. |
> | Synapse/작업 영역/scopePools/쓰기 | 범위 풀을 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/scopePools/읽기 | 모든 범위 풀을 읽습니다. |
> | Synapse/작업 영역/scopePools/삭제 | 모든 범위 풀을 삭제 합니다. |
> | Synapse/작업 영역/securityAlertPolicies/쓰기 | SQL server 보안 경고 정책을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/securityAlertPolicies/읽기 | 기본 SQL server 보안 경고 정책을 읽습니다. |
> | Synapse/작업 영역/m p a t 관리자/쓰기 | 작업 영역에서 Active Directory 관리자 설정 |
> | Synapse/작업 영역/v m 관리자/읽기 | 관리자 Active Directory 작업 영역 가져오기 |
> | Synapse/작업 영역/m p r/삭제 | 관리자 Active Directory 작업 영역 삭제 |
> | Synapse/작업 영역/s a s 데이터베이스/쓰기 | SQL Analytics 데이터베이스를 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/s a s 데이터베이스/읽기 | SQL Analytics 데이터베이스를 읽습니다. |
> | Synapse/workspace/sqlPools/write | SQL Analytics 풀을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/read | SQL Analytics 풀을 읽습니다. |
> | Synapse/workspaces/sqlPools/delete | SQL Analytics 풀을 삭제 합니다. |
> | Synapse/workspace/sqlPools/일시 중지/작업 | SQL Analytics 풀을 일시 중지 합니다. |
> | Synapse/workspaces/sqlPools/resume/resume/action | SQL Analytics 풀을 다시 시작 합니다. |
> | Synapse/workspaces/sqlPools/restorePoints/action | SQL Analytics 풀 복원 지점을 만듭니다. |
> | Synapse/workspace/sqlPools/이동/작업 | SQL Analytics 풀의 이름을 바꿉니다. |
> | Synapse/workspaces/sqlPools/auditingSettings/read | SQL Analytics 풀 감사 설정을 읽습니다. |
> | Synapse/workspaces/sqlPools/auditingSettings/write | SQL Analytics 풀 감사 설정을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/auditRecords/read | Sql 풀 blob 감사 레코드 가져오기 |
> | Synapse/workspaces/sqlPools/columns/read | SQL Analytics 풀에 대 한 열 목록 반환 |
> | Synapse/workspaces/sqlPools/connectionPolicies/읽기 | SQL Analytics 풀 연결 정책을 읽습니다. |
> | Synapse/workspaces/sqlPools/currentSensitivityLabels/read | SQL Analytics 풀 현재 민감도 레이블을 읽습니다. |
> | Synapse/workspaces/sqlPools/currentSensitivityLabels/write | 현재 민감도 레이블을 일괄 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/dataMaskingPolicies/read | SQL Analytics 풀 데이터 마스킹 정책 목록을 반환 합니다. |
> | Synapse/workspaces/sqlPools/dataMaskingPolicies/write | SQL Analytics 풀 데이터 마스킹 정책을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/dataMaskingPolicies/규칙/읽기 | SQL Analytics 풀 데이터 마스킹 규칙의 목록을 가져옵니다. |
> | Synapse/workspaces/sqlPools/dataMaskingPolicies/rules/write | SQL Analytics 풀 데이터 마스킹 규칙을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/dataWarehouseQueries/read | SQL Analytics 풀 쿼리를 읽습니다. |
> | Synapse/workspaces/sqlPools/dataWarehouseQueries/dataWarehouseQuerySteps/read | SQL Analytics 풀 쿼리 단계를 읽습니다. |
> | Synapse/workspaces/sqlPools/dataWarehouseQueries/단계/읽기 | SQL Analytics 풀 쿼리 단계를 읽습니다. |
> | Synapse/workspaces/sqlPools/dataWarehouseUserActivities/read | SQL Analytics 풀 사용자 활동을 읽습니다. |
> | Synapse/workspaces/sqlPools/extendedAuditingSettings/read | SQL Analytics 풀 확장 감사 설정을 읽습니다. |
> | Synapse/workspaces/sqlPools/extendedAuditingSettings/write | SQL Analytics 풀 확장 감사 설정을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/extensions/read | SQL Analytics 풀 확장 가져오기 |
> | Synapse/workspaces/sqlPools/extensions/write | 지정 된 SQL Analytics 풀에 대 한 확장 변경 |
> | Synapse/workspaces/sqlPools/geoBackupPolicies/읽기 | SQL Analytics 풀 지역 백업 정책을 읽습니다. |
> | Synapse/workspaces/sqlPools/maintenanceWindowOptions/read | SQL Analytics 풀 유지 관리 기간 옵션을 읽습니다. |
> | Synapse/workspaces/sqlPools/maintenanceWindows/read | SQL Analytics 풀 유지 관리 기간을 읽습니다. |
> | Synapse/workspaces/sqlPools/maintenanceWindows/write | SQL Analytics 풀 유지 관리 기간을 읽습니다. |
> | Synapse/workspaces/sqlPools/metadataSync/write | SQL Analytics 풀 메타 데이터 동기화 구성 만들기 또는 업데이트 |
> | Synapse/workspaces/sqlPools/metadataSync/read | SQL Analytics 풀 메타 데이터 동기화 구성 읽기 |
> | Synapse/workspaces/sqlPools/operationResults/read | 비동기 작업 결과를 읽습니다. |
> | Synapse/workspace/sqlPools/작업/읽기 | SQL Analytics 풀 작업을 읽습니다. |
> | Synapse/workspaces/sqlPools/operationStatuses/읽기 | 비동기 작업 결과를 읽습니다. |
> | Synapse/workspaces/sqlPools/recommendedSensitivityLabels/read | SQL Analytics 풀 권장 민감도 레이블을 읽습니다. |
> | Synapse/workspaces/sqlPools/recommendedSensitivityLabels/write | Batch 업데이트 권장 민감도 레이블 |
> | Synapse/workspaces/sqlPools/replicationLinks/read | SQL Analytics 풀 복제 링크를 읽습니다. |
> | Synapse/workspaces/sqlPools/restorePoints/read | SQL Analytics 풀 복원 지점은 모두 읽습니다. |
> | Synapse/workspaces/sqlPools/restorePoints/delete | 복원 지점을 삭제 합니다. |
> | Synapse/workspaces/sqlPools/스키마/읽기 | SQL Analytics 풀 스키마를 읽습니다. |
> | Synapse/workspaces/sqlPools/스키마/테이블/읽기 | SQL Analytics 풀 스키마 테이블을 읽습니다. |
> | Synapse/workspaces/sqlPools/스키마/테이블/열/읽기 | SQL Analytics 풀 스키마 테이블 열을 읽습니다. |
> | Synapse/workspaces/sqlPools/스키마/테이블/열/sensitivityLabels/read | 지정 된 열의 민감도 레이블을 가져옵니다. |
> | Synapse/workspaces/sqlPools/tables/tables/columns/sensitivityLabels/enable/action | 모든 SQL Analytics 풀 민감도 레이블을 사용 하도록 설정 합니다. |
> | Synapse/workspaces/sqlPools/tables/columns/sensitivityLabels/사용 안 함/작업 | SQL Analytics 풀 민감도 레이블을 사용 하지 않도록 설정 합니다. |
> | Synapse/workspaces/sqlPools/스키마/테이블/열/sensitivityLabels/write | SQL Analytics 풀 민감도 레이블을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/스키마/테이블/열/sensitivityLabels/delete | SQL Analytics 풀 민감도 레이블을 삭제 합니다. |
> | Synapse/workspaces/sqlPools/securityAlertPolicies/읽기 | Sql Analytics 풀 위협 검색 정책을 읽습니다. |
> | Synapse/workspaces/sqlPools/securityAlertPolicies/쓰기 | SQL Analytics 풀 위협 검색 정책을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/sensitivityLabels/read | 지정 된 열의 민감도 레이블을 가져옵니다. |
> | Synapse/workspaces/sqlPools/transparentDataEncryption/read | SQL Analytics 풀 투명한 데이터 암호화 구성을 읽습니다. |
> | Synapse/workspaces/sqlPools/transparentDataEncryption/write | SQL Analytics 풀 투명한 데이터 암호화 구성을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/transparentDataEncryption/operationResults/read | SQL Analytics 풀 투명한 데이터 암호화 구성 작업 결과를 읽습니다. |
> | Synapse/workspaces/sqlPools/사용량/읽기 | SQL Analytics 풀 사용량을 읽습니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/read | SQL Analytics 풀 취약성 평가를 읽습니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/write | Sql 풀 취약성 평가를 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/delete | SQL Analytics 풀 취약성 평가를 삭제 합니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/규칙/기준/읽기 | SQL Analytics 풀 취약성 평가 규칙 기준을 가져옵니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/rules/기준선이/write | SQL Analytics 풀 취약성 평가 규칙 기준을 만들거나 업데이트 합니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/규칙/기준/삭제 | SQL Analytics 풀 취약성 평가 규칙 기준을 삭제 합니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/검색/읽기 | SQL Analytics 풀 취약성 평가 검사 레코드를 읽습니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/scan/initiateScan/action | SQL Analytics 풀 취약성 평가 검사 레코드를 시작 합니다. |
> | Synapse/workspaces/sqlPools/vulnerabilityAssessments/검색/내보내기/작업 | SQL Analytics 풀 취약성 평가 검색 레코드를 내보냅니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/read | 선택한 SQL 풀의 작업 그룹을 나열 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/write | 특정 작업 그룹의 속성을 설정 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/delete | 특정 작업 그룹을 삭제 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/operationStatuses/읽기 | SQL Analytics 풀 작업 그룹 작업 상태 |
> | Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers/read | 선택한 SQL Analytics 풀의 워크 로드 분류자를 나열 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers/write | 특정 작업 분류자의 속성을 설정 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers/delete | 특정 작업 분류자를 삭제 합니다. |
> | Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers/operationResults/read | SQL Analytics 풀 워크 로드 분류자 작업 결과 |
> | Synapse/workspaces/sqlPools/workloadGroups/workloadClassifiers/operationStatuses/읽기 | SQL Analytics 풀 워크 로드 분류자 작업 상태 |
> | Synapse/작업 영역/s s i 사용/읽기 | SQL Analytics 풀에 사용할 수 있는 사용 제한을 가져옵니다. |
> | Synapse/작업 영역/vulnerabilityAssessments/쓰기 | SQL server 취약성 assement 보고서를 만들거나 업데이트 합니다. |
> | Synapse/작업 영역/vulnerabilityAssessments/읽기 | 기본 SQL server 취약성 assement 보고서를 읽습니다. |
> | Synapse/작업 영역/vulnerabilityAssessments/삭제 | SQL server 취약성 assement 보고서를 삭제 합니다. |
...
> | **DataAction** | **설명** |
> | Cognitiveservices account/accounts/AnomalyDetector/시계열/changepoint/검색/작업 | 이 작업은 전체 계열을 사용 하 여 모델을 생성 합니다. 각 요소는 동일한 모델을 사용 하 여 검색 됩니다.<br>이 메서드를 사용 하면 특정 지점 전후에 점이 추세 변경 지점 인지 여부를 확인 하는 데 사용 됩니다.<br>전체 검색은 시계열의 모든 추세 변경 사항을 검색할 수 있습니다. |
...
> | Cognitiveservices account/accounts/ComputerVision/읽기/analyzeresults/읽기 | 이 인터페이스를 사용 하 여 읽기 작업의 상태 및 OCR 결과를 검색 합니다.  ' OperationId '를 포함 하는 URL이 읽기 작업 ' 작업-위치 ' 응답 헤더에 반환 됩니다. * |
...
> | Cognitiveservices account/계정/폼 인식기/사용자 지정/모델/작성/작업 | 구성 요청은 모델 id 목록을 포함 합니다. 레이블 모델 또는 구성 된 모델을 사용 하 여 학습 된 모든 모델의 유효성을 검사 합니다. 모델 제한의 유효성을 검사 합니다. |
...
> | Cognitiveservices account/계정/폼 인식기/미리 작성/iddocument/분석/작업 | 지정 된 Id 문서에서 필드 텍스트 및 의미 체계 값을 추출 합니다. |
> | Cognitiveservices account/accounts/FormRecognizer/미리 작성/iddocument/analyzeresults/read | 상태를 쿼리하고 Id 분석 작업의 결과를 검색 합니다. 이 인터페이스의 URL은 분석 Id 응답의 ' 작업-위치 ' 헤더에서 가져올 수 있습니다. |
> | Cognitiveservices account/계정/폼 인식기/미리 작성/송장/분석/작업 | 지정 된 송장 문서에서 필드 텍스트 및 의미 체계 값을 추출 합니다. |
> | Cognitiveservices account/계정/폼 인식기/미리 작성/송장/analyzeresults/읽기 | 상태를 쿼리하고 송장 분석 작업의 결과를 검색 합니다. 이 인터페이스의 URL은 송장 분석 응답의 ' 작업-위치 ' 헤더에서 가져올 수 있습니다. |
...
> | Cognitiveservices account/accounts/LUIS/apps/write | 새 LUIS 앱을 만듭니다. 응용 프로그램의 이름 또는 설명을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/azureaccounts/action | 응용 프로그램에 Azure 계정을 할당 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/delete | 응용 프로그램을 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/읽기 | 응용 프로그램 정보를 가져옵니다. 모든 사용자 응용 프로그램을 나열 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/가져오기/작업 | 응용 프로그램을 LUIS로 가져옵니다. 응용 프로그램의 JSON은 요청 본문에 포함 되어야 합니다. 새 앱 ID를 반환 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/게시/작업 | 응용 프로그램의 특정 버전을 게시 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/querylogsasync/action | 지난 달의 응용 프로그램에 대 한 쿼리 로그에 대 한 다운로드 요청을 시작 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/이동/작업 | 앱을 다른 LUIS authoring Azure 리소스로 이동 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/도우미/읽기 | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/apps/azureaccounts/read | 사용자의 Azure Resource Manager 토큰을 사용 하 여 응용 프로그램에 할당 된 LUIS Azure 계정을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/azureaccounts/delete | Azure Resource Manager 토큰을 사용 하 여 사용자에 대 한 LUIS Azure 계정을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/문화권/읽기 | 지원 되는 LUIS 응용 프로그램 문화권을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/culture/tokenizerversions/read | 문화권에 대해 지원 되는 LUIS 응용 프로그램 문화권과 지원 되는 토크 버전을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/customprebuiltdomains/write | 새 응용 프로그램으로 해당 모델과 함께 미리 작성 된 도메인을 추가 합니다. 새 앱 ID를 반환 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/customprebuiltdomains/read | 특정 문화권에 대해 사용 가능한 모든 사용자 지정 미리 작성 된 도메인을 가져옵니다. 모든 문화권에서 사용 가능한 사용자 지정 미리 작성 된 도메인을 모두 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/도메인/읽기 | 사용 가능한 응용 프로그램 도메인을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/끝점/읽기 | 사용 가능한 끝점 배포 지역 및 url을 반환 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/사용 권한/쓰기 | 이 LUIS 응용 프로그램에 액세스할 수 있는 사용자 목록에 사용자를 추가 합니다. 현재 사용자 액세스 목록을 본문에 전송 된 항목으로 바꿉니다. * |
> | Cognitiveservices account/계정/LUIS/앱/사용 권한/읽기 | 응용 프로그램에 액세스할 수 있는 권한이 있는 사용자 전자 메일의 목록을 가져옵니다.  |
> | Cognitiveservices account/계정/LUIS/앱/사용 권한/삭제 | 이 LUIS 응용 프로그램에 액세스할 수 있는 사용자 목록에서 사용자를 제거 했습니다. |
> | Cognitiveservices account/accounts/LUIS/apps/publishsettings/read | 응용 프로그램에 대 한 게시 설정을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/publishsettings/write | 응용 프로그램 게시 설정을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/querylogs/read | 응용 프로그램에 대 한 지난 달의 쿼리 로그를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/querylogsasync/read | 쿼리 로그에 대 한 다운로드 요청의 상태를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/설정/읽기 | 응용 프로그램 설정 가져오기 |
> | Cognitiveservices account/계정/LUIS/앱/설정/쓰기 | 응용 프로그램 설정을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/usagescenarios/read | 응용 프로그램 사용 가능 시나리오를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/학습/작업 | 지정 된 LUIS 응용 프로그램의 버전에 대 한 학습 요청을 보냅니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/복제본/작업 | 선택한 응용 프로그램 버전의 현재 스냅숏에 해당 하는 새 응용 프로그램 버전을 만듭니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/삭제 | 응용 프로그램 버전을 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/읽기 | 응용 프로그램 버전 정보를 가져옵니다. 응용 프로그램 버전 목록에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/가져오기/작업 | 새 버전을 LUIS 응용 프로그램으로 가져오고, 버전의 JSON을 요청 본문에 포함 해야 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/쓰기 | 응용 프로그램 버전의 이름 또는 설명을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/assignedkey/write | **이는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/apps/versions/assignedkey/read | **이는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closei lists/write | LUIS 앱에 목록 엔터티를 추가 합니다. 기존 closesublists의 일괄 처리를 추가 합니다. *는 닫힌 목록 모델을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closed 목록/삭제 | 응용 프로그램에서 닫힌 목록 엔터티를 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closed 목록/읽기 | 닫힌 목록 모델의 정보를 가져옵니다. Closedlist 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closei 목록/역할/쓰기 | 닫힌 목록에 대 한 역할 추가 엔터티 모델은 닫힌 목록 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closei 목록/역할/삭제 | 닫힌 목록 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closei 목록/역할/읽기 | 닫힌 목록 엔터티 모델의 역할을 가져옵니다. 닫힌 목록 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closedlists/sublists/write | 기존 닫힌 목록에 목록을 추가 하 여 닫힌 목록의 sublists 중 하나를 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/closedlists/sublists/delete | 지정 된 목록 엔터티의 하위 목록을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/write | 응용 프로그램에 복합 엔터티 추출기를 추가 합니다. 복합 엔터티 추출기를 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/delete | 응용 프로그램 버전에서 복합 엔터티 추출기를 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/read | 복합 엔터티 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 복합 엔터티 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/children/write | 기존 복합 엔터티 모델에 단일 자식을 추가 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/children/delete | 응용 프로그램 버전에서 복합 엔터티 추출기 자식을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/roles/write | 복합 엔터티 모델에 대 한 역할을 추가 합니다. 복합 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/roles/delete | 복합 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/compositeentities/roles/read | 복합 엔터티 모델의 역할을 가져옵니다. 복합 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/connectedservices/write | 의도와 서비스 간 매핑을 만들고 서비스와 서비스 간 매핑을 업데이트 합니다. * |
> | Cognitiveservices account/accounts/LUIS/apps/versions/connectedservices/delete | 의도와 서비스 간의 매핑을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/connectedservices/read | 의도와 서비스 간의 매핑을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltdomains/write | 이 응용 프로그램 버전에 모든 해당 모델과 함께 사용자 지정 가능한 미리 작성 된 도메인을 추가 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltdomains/delete | 응용 프로그램 버전에서 미리 빌드된 도메인의 모델을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltentities/write | 응용 프로그램 버전에 사용자 지정 미리 작성 된 도메인 엔터티 모델을 추가 합니다. 엔터티 id로 [엔터티 삭제](https://westus.dev.cognitive.microsoft.com/docs/services/5890b47c39e2bb17b84a55ff/operations/5890b47c39e2bb052c5b9c1f) 를 사용 하 여이 엔터티를 제거 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltentities/read | 이 응용 프로그램 버전에 대 한 사용자 지정 미리 작성 한 도메인 엔터티 정보를 모두 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltentities/roles/write | 사용자 지정 미리 작성 된 도메인 엔터티 모델에 대 한 역할을 추가 사용자 지정 미리 작성 된 도메인 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltentities/roles/delete | 사용자 지정 미리 작성 된 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltentities/roles/read | 미리 빌드된 사용자 지정 도메인 엔터티 모델의 역할을 가져옵니다. 미리 빌드된 사용자 지정 도메인 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltintents/write | 응용 프로그램에 사용자 지정 미리 작성 된 도메인 의도 모델을 추가 합니다. 의도 id로 [delete 의도](https://westus.dev.cognitive.microsoft.com/docs/services/5890b47c39e2bb17b84a55ff/operations/5890b47c39e2bb052c5b9c1c) 를 사용 하 여이 의도를 제거 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltintents/read | 이 응용 프로그램 버전에 대 한 사용자 지정 미리 작성 한 의도 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/customprebuiltmodels/read | 이 응용 프로그램 버전에 대 한 사용자 지정 미리 작성 한 도메인 모델 정보를 모두 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/쓰기 | 응용 프로그램 버전에 간단한 엔터티 추출기를 추가 합니다. 엔터티 추출기의 이름을 업데이트 합니다. 엔터티 추출기를 업데이트 합니다. * |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/삭제 | 응용 프로그램 버전에서 간단한 엔터티 추출기를 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/읽기 | 단순 엔터티 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 단순 엔터티 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/자식/쓰기 | 기존 엔터티 모델에서 단일 자식을 만듭니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/기능/쓰기 | 엔터티 모델에 대 한 기능 관계 추가 * 엔터티의 기능 관계 목록 업데이트 |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/기능/삭제 | 엔터티 모델의 기능 관계를 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/기능/읽기 | 엔터티 모델의 기능 관계를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/역할/쓰기 | 단순 엔터티 모델의 역할을 추가 하 여 단순 엔터티 모델의 역할을 업데이트 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/역할/삭제 | 단순 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/역할/읽기 | 단순 엔터티 모델의 역할을 가져옵니다. 단순 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/엔터티/역할/제안/읽기 | 엔터티 모델의 정확도를 향상 시키는 예를 제안 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/entities/제안/읽기 | 엔터티 모델의 정확도를 향상 시키는 예를 제안 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/example/write | 응용 프로그램 버전에 레이블이 지정 된 예제를 추가 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/예제/쓰기 | 지정 된 응용 프로그램에 중복 되지 않은 레이블이 지정 된 예제의 일괄 처리를 추가 합니다. Batch는 계층적 자식 엔터티를 포함할 수 없습니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/예제/삭제 | 지정 된 ID의 레이블을 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/예제/읽기 | 검토할 끝점 예제의 하위 집합을 반환 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/내보내기/읽기 | LUIS 응용 프로그램 버전을 JSON 형식으로 내보냅니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/externalkeys/delete | 이 API는 더 이상 사용 되지 않습니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/externalkeys/read | **이는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/apps/versions/externalkeys/write | **이는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/계정/LUIS/앱/버전/기능/읽기 | 모든 응용 프로그램 버전 기능을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/write | 응용 프로그램 버전에 계층적 엔터티 추출기를 추가 합니다. 계층적 엔터티 추출기 모델의 이름 및 자식을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/delete | 응용 프로그램 버전에서 계층적 엔터티 추출기를 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/read | 계층적 엔터티 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 계층적 엔터티 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/children/write | 기존 계층적 엔터티 모델에서 단일 자식을 만듭니다. 기존 계층적 엔터티 모델에서 단일 자식의 이름을 바꿉니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/children/delete | 응용 프로그램 버전에서 계층적 엔터티 추출기 자식을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/children/read | 계층적 엔터티 자식 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/roles/write | 계층적 엔터티 모델에 대 한 역할을 추가 하 여 계층적 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/roles/delete | 계층적 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/hierarchicalentities/roles/read | 계층적 엔터티 모델의 역할을 가져옵니다. 계층적 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/쓰기 | 응용 프로그램 버전에 의도 분류자를 추가 합니다. 의도 분류자의 이름을 업데이트 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/삭제 | 응용 프로그램 버전에서 의도 분류자를 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/읽기 | 의도 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 의도 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/기능/쓰기 | 의도 모델에 대 한 기능 관계를 추가 하 여 의도 *의 기능 관계 목록을 업데이트 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/기능/삭제 | 의도 모델의 기능 관계를 삭제 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/기능/읽기 | 의도 모델의 기능 관계를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/의도/patternrules/read | 특정 의도에 대 한 패턴을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/의도/제안/읽기 | 의도 모델의 정확도를 향상 시키는 예를 제안 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/listprebuilts/read | 응용 프로그램의 문화권에 따라 응용 프로그램에 대해 사용 가능한 모든 미리 작성 된 엔터티를 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/모델/읽기 | 응용 프로그램 버전 모델에 대 한 정보를 가져옵니다. 모델에 대 한 정보를 가져옵니다. * |
> | Cognitiveservices account/계정/LUIS/앱/버전/모델/예제/읽기 | 모델 예제의 목록을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/write | 패턴을 추가 합니다. 모든 엔터티 추출기는 응용 프로그램 버전에 추가 됩니다. 패턴을 업데이트 합니다. 모든 엔터티 추출기입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/delete | 패턴을 삭제 합니다. 응용 프로그램 버전의 모든 엔터티 추출기입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/read | 패턴에 대 한 정보를 가져옵니다. 모든 엔터티 모델입니다. 패턴에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 모든 엔터티 모델입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/explicitlist/write | 패턴에 항목을 추가 합니다. 명시적 목록입니다. 패턴에 대 한 명시적 목록 항목을 업데이트 합니다. 모든 엔터티 모델입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/explicitlist/delete | 패턴에서 항목을 삭제 합니다. 명시적 목록입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/explicitlist/read | 패턴의 명시적 목록 (모든 엔터티 모델)을 가져옵니다. 패턴에 대 한 명시적 목록 항목을 가져옵니다. 모든 엔터티 모델입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/roles/write | 패턴의 역할을 추가 합니다. 모든 엔터티 모델은 패턴에 대 한 역할을 업데이트 합니다. 모든 엔터티 모델. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/roles/delete | 패턴의 역할을 삭제 합니다. 모든 엔터티 모델입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternanyentities/roles/read | 패턴의 역할을 가져옵니다. 모든 엔터티 모델입니다. 패턴의 역할을 가져옵니다. 모든 엔터티 모델입니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternrule/write | 지정 된 응용 프로그램 버전에 패턴을 추가 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternrules/write | 응용 프로그램 버전에 패턴 목록을 추가 합니다. 응용 프로그램 버전에서 패턴을 업데이트 합니다. 응용 프로그램 버전의 패턴 목록을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternrules/delete | 응용 프로그램 버전에서 패턴 목록을 삭제 합니다. 응용 프로그램 버전에서 패턴을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/patternrules/read | 응용 프로그램 버전의 패턴을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/패턴/쓰기 | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/계정/LUIS/앱/버전/패턴/삭제 | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/계정/LUIS/앱/버전/패턴/읽기 | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/apps/versions/phraselists/write | 새 phraselist 기능을 만듭니다. 요소, 상태 및 phraselist 기능의 이름을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/phraselists/delete | 응용 프로그램에서 phraselist 기능을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/phraselists/read | Phraselist 기능 정보를 가져옵니다. 응용 프로그램 버전에 대 한 모든 phraselist 기능을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/write | 응용 프로그램 버전에 미리 작성 된 엔터티 추출기 목록을 추가 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/delete | 응용 프로그램 버전에서 미리 빌드된 entity 추출기를 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/read | 미리 작성 된 엔터티 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 미리 작성 된 엔터티 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/roles/write | 미리 작성 된 엔터티 모델에 대 한 역할을 추가 하 여 미리 작성 된 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/roles/delete | 미리 작성 된 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/prebuilts/roles/read | 미리 작성 된 엔터티 모델의 역할을 가져옵니다. 미리 작성 된 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/write | 응용 프로그램 버전에 정규식 엔터티 추출기를 추가 합니다. 정규식 엔터티 모델을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/delete | 응용 프로그램 버전에서 정규식 엔터티 모델을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/read | 정규식 엔터티 모델에 대 한 정보를 가져옵니다. 응용 프로그램 버전의 정규식 엔터티 모델에 대 한 정보를 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/roles/write | 정규식 엔터티 모델에 대 한 역할을 추가 합니다. 정규식 엔터티 모델에 대 한 역할을 업데이트 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/roles/delete | 정규식 엔터티 모델의 역할을 삭제 합니다. |
> | Cognitiveservices account/accounts/LUIS/apps/versions/regexentities/roles/read | 정규식 엔터티 모델의 역할을 가져옵니다. 정규식 엔터티 모델의 역할을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/설정/읽기 | 응용 프로그램 버전 설정을 가져옵니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/설정/쓰기 | 응용 프로그램 버전 설정을 업데이트 합니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/제안/삭제 | Utterance 끝점을 삭제 했습니다. 이 utterance은 "Review endpoint 길이 발언" 목록에 있습니다. |
> | Cognitiveservices account/계정/LUIS/앱/버전/학습/읽기 | 지정 된 응용 프로그램 버전에 대 한 모든 모델 (의도 및 엔터티)의 학습 상태를 가져옵니다. 이 API를 호출 하 여 교육 상태를 얻으려면 먼저 학습 API를 호출 하 여 LUIS 앱을 학습 해야 합니다. |
> | Cognitiveservices account/accounts/LUIS/azureaccounts/read | Azure Resource Manager 토큰을 사용 하 여 사용자에 대 한 LUIS Azure 계정을 가져옵니다. |
> | Cognitiveservices account/accounts/LUIS/externalkeys/write | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/externalkeys/delete | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/externalkeys/read | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/package/slot/gzip/read | LUIS 응용 프로그램을 GZip으로 게시 한 패키지 |
> | Cognitiveservices account/accounts/LUIS/package/versions/gzip/read | GZip으로 학습 된 LUIS 응용 프로그램 패키지 |
> | Cognitiveservices account/accounts/LUIS/programmatickey/write | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/subscription/write | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/subscription/delete | **이 API는 더 이상 사용 되지 않습니다.** |
> | Cognitiveservices account/accounts/LUIS/subscription/read | **이 API는 더 이상 사용 되지 않습니다.** |
...
> | Cognitiveservices account/accounts/Personalizer/rank/action | 개인 설정 순위 요청입니다. |
> | Cognitiveservices account/계정/Personalizer/평가/작업 | 새 평가를 제출 합니다. |
> | Cognitiveservices account/accounts/Personalizer/구성/클라이언트/작업 | 클라이언트 구성을 가져옵니다. |
> | Cognitiveservices account/계정/Personalizer/구성/정책/삭제 | 현재 정책을 삭제 합니다. |
> | Cognitiveservices account/계정/Personalizer/구성/정책/읽기 | 정책 구성을 가져옵니다. |
> | Cognitiveservices account/계정/Personalizer/구성/정책/쓰기 | 정책 구성을 업데이트 합니다. |
> | Cognitiveservices account/accounts/Personalizer/구성/서비스/읽기 | 서비스 구성을 가져옵니다. |
> | Cognitiveservices account/accounts/Personalizer/구성/서비스/쓰기 | 서비스 구성을 업데이트합니다. |
> | Cognitiveservices account/계정/Personalizer/평가판/삭제 | ID와 연결 된 평가를 삭제 합니다. |
> | Cognitiveservices account/계정/Personalizer/평가판/읽기 | ID와 연결 된 평가를 가져옵니다. 제출 된 모든 평가를 나열 합니다. * |
> | Cognitiveservices account/계정/Personalizer/이벤트/보상/작업 | 지정 된 이벤트에 대해 순위가 가장 높은 작업에 할당할 보상을 보고 합니다. |
> | Cognitiveservices account/계정/Personalizer/이벤트/활성화/작업 | 지정 된 이벤트가 실제로 사용자에 게 표시 되 고이에 대 한 보상을 예상 하는지 보고 합니다. |
> | Cognitiveservices account/accounts/Personalizer/logs/delete | 모든 로그를 삭제 합니다. |
> | Cognitiveservices account/accounts/Personalizer/logs/properties/read | 로그 속성을 가져옵니다. |
> | Cognitiveservices account/accounts/Personalizer/model/read | 현재 모델을 가져옵니다. |
> | Cognitiveservices account/accounts/Personalizer/model/delete | 모델을 다시 설정 합니다. |
> | Cognitiveservices account/accounts/Personalizer/모델/속성/읽기 | 모델 속성을 가져옵니다. |
> | Cognitiveservices account/계정/Personalizer/상태/읽기 | 작업의 상태를 가져옵니다. |
...
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/action | QnA Maker |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/변경/읽기 | 런타임에 변경 사항을 다운로드 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/변경/쓰기 | 변경 데이터를 바꿉니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/endpointkeys/read | 끝점에 대 한 끝점 키를 가져옵니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/endpointkeys/refreshkeys/작업 | 끝점 키를 다시 생성 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/endpointsettings/read | 끝점에 대 한 끝점 설정을 가져옵니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/endpointsettings/write | 끝점에 대 한 seettings 끝점을 업데이트 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/게시/작업 | 기술 자료의 테스트 인덱스에 있는 모든 변경 내용을 해당 prod 인덱스에 게시 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/delete | 기술 자료 및 모든 해당 데이터를 삭제 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/read | 특정 knowledgebaser의 기술 자료 또는 세부 정보 목록을 가져옵니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/write | 기술 자료를 수정 하거나 기술 자료 콘텐츠를 교체 하는 비동기 작업입니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/generateanswer/action | 기술 자료를 쿼리 하기 위한 GenerateAnswer 호출입니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/학습/작업 | 기술 자료에 제안 사항을 추가 하기 위해 호출을 학습 합니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/create/write | 새 기술 자료를 만드는 비동기 작업입니다. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/기술 자료/다운로드/읽기 | 기술 자료를 다운로드 하세요. |
> | Cognitiveservices account/accounts/TextAnalytics/QnaMaker/작업/읽기 | 특정 장기 실행 작업에 대한 세부 정보를 가져옵니다. |
...
> | Cognitiveservices account/accounts/TextTranslation/음 차/action | 특정 언어의 텍스트를 한 스크립트에서 다른 스크립트로 변환합니다. |
> | Cognitiveservices account/accounts/TextTranslation/dictionary/예제/작업 | 사전의 용어가 컨텍스트에서 사용되는 방식을 보여 주는 예제를 제공합니다. 이 작업은 사전 조회와 함께 사용됩니다. |
> | Cognitiveservices account/계정/TextTranslation/사전/조회/작업 | 하나의 단어와 소수의 관용구에 대한 대체 번역을 제공합니다.<br>각 번역에는 음성 일부 및 역번역 목록이 포함되어 있습니다.<br>역번역을 사용하면 번역 맥락을 이해할 수 있습니다.<br>사전 예제 작업을 사용하면 추가로 드릴다운하여 각 번역 쌍의 사용 예제를 볼 수 있습니다. |
> | Cognitiveservices account/accounts/TextTranslation/언어/읽기 | 현재 Translator Text API의 다른 작업에서 지원되는 언어 집합을 가져옵니다. |
...
> | MachineLearningServices/virtualclusters/읽기 | Machine Learning Services 가상 클러스터를 가져옵니다. |
> | MachineLearningServices/virtualclusters/쓰기 | Machine Learning Services 가상 클러스터를 만들거나 업데이트 합니다. |
> | MachineLearningServices/virtualclusters/삭제 | Machine Learning Services 가상 클러스터를 삭제 합니다. |
> | MachineLearningServices/virtualclusters/작업/제출/작업 | Machine Learning Services 가상 클러스터에 작업 제출 |
> | Microsoft.MachineLearningServices/workspaces/checkComputeNameAvailability/action | Machine Learning Services 작업 영역의 일괄 처리 끝점에서 계산의 이름을 확인 합니다. |
...
> | MachineLearningServices/작업 영역/batchEndpoints/읽기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점을 가져옵니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/write | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점을 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/delete | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점을 삭제 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/listKeys/작업 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점에 대 한 키를 나열 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/checkNameAvailability/read | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 이름을 확인 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/읽기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 배포를 가져옵니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/쓰기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 배포를 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/삭제 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 배포를 삭제 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/checkNameAvailability/read | Machine Learning Services 작업 영역의 일괄 처리 유추 끝점에서 배포 이름을 확인 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/작업/읽기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 배포의 작업을 읽습니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/작업/쓰기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 배포의 작업을 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/배포/작업/삭제 | Machine Learning Services 작업 영역에서 일괄 처리 유추 배포의 작업을 삭제 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/작업/읽기 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 작업을 읽습니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/job/write | Machine Learning Services 작업 영역의 일괄 처리 유추 끝점에서 작업을 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/batchEndpoints/작업/삭제 | Machine Learning Services 작업 영역에서 일괄 처리 유추 끝점의 작업을 삭제 합니다. |
...
> | MachineLearningServices/작업 영역/inferenceEndpoints/읽기 | Machine Learning Services 작업 영역에서 유추 유추 끝점을 가져옵니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/쓰기 | Machine Learning Services 작업 영역에서 유추 유추 끝점을 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/삭제 | Machine Learning Services 작업 영역에서 유추 유추 끝점을 삭제 합니다. |
> | MachineLearningServices/workspaces/inferenceEndpoints/checkNameAvailability/read | Machine Learning Services 작업 영역에서 유추 유추 끝점의 이름을 확인 합니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/배포/읽기 | Machine Learning Services 작업 영역의 유추 유추 끝점에서 배포를 가져옵니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/배포/쓰기 | Machine Learning Services 작업 영역의 유추 유추 끝점에서 배포를 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/배포/삭제 | Machine Learning Services 작업 영역의 유추 유추 끝점에서 배포를 삭제 합니다. |
> | MachineLearningServices/workspaces/inferenceEndpoints/배포/checkNameAvailability/read | Machine Learning Services 작업 영역의 유추 유추 끝점에서 배포 이름을 확인 합니다. |
> | MachineLearningServices/작업 영역/inferenceEndpoints/배포/sku/읽기 | Machine Learning Services 작업 영역의 유추 유추 끝점에서 배포에 대 한 크기 조정 sku 설정을 가져옵니다. |
...
> | MachineLearningServices/작업 영역/Linkedservices.json 및 datasets.json/읽기 | Machine Learning Services 작업 영역에 대 한 모든 연결 된 서비스를 가져옵니다. |
> | MachineLearningServices/작업 영역/Linkedservices.json 및 datasets.json/쓰기 | Machine Learning Services 작업 영역 연결 된 서비스 만들기 또는 업데이트 |
> | MachineLearningServices/작업 영역/Linkedservices.json 및 datasets.json/삭제 | Machine Learning Services 작업 영역 연결 된 서비스 삭제 |
...
> | MachineLearningServices/작업 영역/onlineEndpoints/점수/작업 | Machine Learning Services 작업 영역에서 온라인 끝점의 점수를 매기는 인증 토큰 또는 키 검색 |
...
> | MachineLearningServices/작업 영역/보고서/읽기 | Machine Learning Services 작업 영역에서 사용자 지정 보고서를 가져옵니다. |
> | MachineLearningServices/작업 영역/보고서/쓰기 | Machine Learning Services 작업 영역에서 사용자 지정 보고서를 만들거나 업데이트 합니다. |
> | MachineLearningServices/작업 영역/보고서/삭제 | Machine Learning Services 작업 영역에서 사용자 지정 보고서를 삭제 합니다. |
...
> | MachineLearningServices/작업 영역/서비스/aks/점수/작업 | Machine Learning Services 작업 영역에서 AKS services의 점수를 매기는 인증 토큰 또는 키를 검색 합니다. |
...
Azure 서비스: [IoT Hub에 대 한 장치 업데이트](../iot-hub-device-update/index.yml)

> [!div class="mx-tableFixed"]
> | 작업 | 설명 |
> | --- | --- |
> | Microsoft DeviceUpdate/checkNameAvailability/action | 이름 가용성 확인 |
> | Microsoft DeviceUpdate/register/action | 장치 업데이트 등록 |
> | Microsoft DeviceUpdate/등록 취소/작업 | 장치 업데이트 등록 취소 |
> | Microsoft DeviceUpdate/accounts/read | 장치 업데이트 계정 목록을 반환 합니다. |
> | Microsoft DeviceUpdate/accounts/write | 장치 업데이트 계정을 만들거나 업데이트 합니다. |
> | Microsoft DeviceUpdate/accounts/delete | 장치 업데이트 계정을 삭제 합니다. |
> | Microsoft DeviceUpdate/계정/인스턴스/읽기 | 장치 업데이트 인스턴스 목록을 반환 합니다. |
> | Microsoft DeviceUpdate/accounts/instances/write | 장치 업데이트 인스턴스를 만들거나 업데이트 합니다. |
> | Microsoft DeviceUpdate/계정/인스턴스/삭제 | 장치 업데이트 인스턴스를 삭제 합니다. |
> | Microsoft DeviceUpdate/위치/operationStatuses/읽기 | 작업 상태를 가져옵니다. |
> | Microsoft DeviceUpdate/위치/operationStatuses/쓰기 | 작업 상태를 업데이트 합니다. |
> | Microsoft DeviceUpdate/작업/읽기 | 장치 업데이트 작업 나열 |
> | Microsoft DeviceUpdate/registeredSubscriptions/read | 등록 된 구독 읽기 |
> | **DataAction** | **설명** |
> | Microsoft DeviceUpdate/계정/인스턴스/관리/읽기 | 관리와 관련 된 읽기 작업을 수행 합니다. |
> | Microsoft DeviceUpdate/accounts/instances/management/write | 관리와 관련 된 쓰기 작업을 수행 합니다. |
> | Microsoft DeviceUpdate/accounts/instances/management/delete | 관리와 관련 된 삭제 작업을 수행 합니다. |
> | Microsoft DeviceUpdate/계정/인스턴스/업데이트/읽기 | 업데이트와 관련 된 읽기 작업을 수행 합니다. |
> | Microsoft DeviceUpdate/계정/인스턴스/업데이트/쓰기 | 업데이트와 관련 된 쓰기 작업을 수행 합니다. |
> | Microsoft DeviceUpdate/계정/인스턴스/업데이트/삭제 | 업데이트와 관련 된 삭제 작업을 수행 합니다. |
...
> | Microsoft. TimeSeriesInsights/environment/privateendpointConnections/read | 개인 끝점 연결의 속성을 가져옵니다. |
> | Microsoft. TimeSeriesInsights/environment/privateendpointConnections/write | 환경에 대 한 새 개인 끝점 연결을 만들거나 기존 연결을 업데이트 합니다. |
> | Microsoft. TimeSeriesInsights/environment/privateendpointConnections/delete | 개인 끝점 연결을 삭제 합니다. |
...
> | MixedReality/ObjectAnchorsAccounts/delete | 개체 앵커 계정 삭제 |
> | MixedReality/ObjectAnchorsAccounts/listkeys/action | 개체 앵커 계정에 키를 나열 합니다. |
> | MixedReality/ObjectAnchorsAccounts/읽기 | 개체 앵커 계정 속성 읽기 |
> | MixedReality/ObjectAnchorsAccounts/regeneratekeys/action | 개체 앵커 계정의 키 다시 생성 |
> | MixedReality/ObjectAnchorsAccounts/write | 개체 앵커 계정 속성 업데이트 |
...
> | **DataAction** | **설명** |
> | MixedReality/ObjectAnchorsAccounts/수집/작업 | 모델 수집 작업 만들기 |
> | MixedReality/ObjectAnchorsAccounts/수집/읽기 | 모델 수집 작업 상태 가져오기 |
...
> | Microsoft.apimanagement/위치/deletedservices/삭제 | 복원 옵션을 사용 하지 않고 API Management 서비스를 삭제 합니다. |
...
> | Microsoft.apimanagement/서비스/게이트웨이/certificateAuthorities/읽기 | 게이트웨이 CAs 목록을 가져옵니다. 또는 할당 된 인증 기관 세부 정보를 가져옵니다. |
> | Microsoft.apimanagement/서비스/게이트웨이/certificateAuthorities/쓰기 | 지정 된 게이트웨이에 API를 추가 합니다. |
> | Microsoft.apimanagement/서비스/게이트웨이/a s d/삭제 | 게이트웨이에서 인증 기관 할당을 취소 합니다. |
...
> | Microsoft.apimanagement/서비스/portalRevisions/읽기 | 개발자 포털 수정 엔터티 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 개발자 포털 수정 버전을 가져옵니다. |
> | Microsoft.apimanagement/service/portalRevisions/write | 새 개발자 포털 수정 버전을 만듭니다. 또는 지정 된 포털 수정 버전에 대 한 설명을 업데이트 하거나 최신으로 만듭니다. |
...
> | Microsoft.apimanagement/service/portalSettings/write | Sign-In 설정을 업데이트 합니다. 또는 Sign-In 설정을 만들거나 업데이트 합니다. 또는 등록 설정을 업데이트 하거나 등록 설정을 업데이트 하거나 위임 설정을 업데이트 합니다. 또는 위임 설정을 만들거나 업데이트 합니다. |
> | Microsoft.apimanagement/service/portalSettings/listSecrets/작업 | 포털 위임 설정의 유효성 검사 키를 가져옵니다. 또는 미디어 콘텐츠 blob 컨테이너 uri를 가져옵니다. |
> | Microsoft.apimanagement/서비스/privateLinkResources/읽기 | 개인 링크 그룹 리소스 가져오기 |
...
> | Microsoft.apimanagement/서비스/설정/읽기 | 테 넌 트 설정의 컬렉션을 나열 합니다. 항상 비어 있습니다. 대신/srer/ws를 사용 합니다. |
...
> | Microsoft.ApiManagement/service/tenant/read | 테 넌 트 액세스 설정 컬렉션을 나열 합니다. 또는 Api Management 서비스의 전역 정책 정의를 가져옵니다. 또는 테 넌 트 액세스 정보 정보 가져오기 |
> | Microsoft.ApiManagement/service/tenant/write | 테 넌 트에 대 한 정책 구성 설정 또는 테 넌 트 액세스 세부 정보 업데이트 또는 테 넌 트 액세스 정보 업데이트 정보 |
...
> | Microsoft AppConfiguration/configurationStores/providers/Microsoft. Insights/logDefinitions/읽기 | Microsoft 앱 구성에 대 한 모든 로그 정의를 검색 합니다. |
...
> | Microsoft AzureStack/edgeSubscriptions/write | Edge 구독을 만들거나 업데이트 합니다. |
> | Microsoft AzureStack/edgeSubscriptions/delete | Edge 구독 삭제 |
> | Microsoft AzureStack/edgeSubscriptions/edgeResourceGroups/action | 에 지 리소스 그룹에서 프로젝션 된 가장자리 리소스를 읽거나 씁니다. |
> | Microsoft AzureStack/edgeSubscriptions/edgeProviders/action | 지정 된에 지 리소스 공급자 네임 스페이스에서 프로젝션 된 가장자리 리소스를 읽거나 씁니다. |
> | Microsoft AzureStack/edgeSubscriptions/작업/작업 | 프로젝션 된에 지 리소스에 대 한 비동기 작업 상태를 가져오거나 나열 합니다. |
> | Microsoft AzureStack/linkedSubscriptions/read | Azure Stack 연결 된 구독의 속성을 가져옵니다. |
> | Microsoft AzureStack/linkedSubscriptions/write | 연결 된 구독을 만들거나 업데이트 합니다. |
> | Microsoft AzureStack/linkedSubscriptions/delete | 연결 된 구독 삭제 |
> | Microsoft AzureStack/linkedSubscriptions/linkedResourceGroups/action | 연결 된 리소스 그룹에서 프로젝션 된 연결 된 리소스를 읽거나 씁니다. |
> | Microsoft AzureStack/linkedSubscriptions/linkedProviders/action | 지정 된 연결 된 리소스 공급자 네임 스페이스에서 프로젝션 된 연결 된 리소스를 읽거나 씁니다. |
> | Microsoft AzureStack/linkedSubscriptions/작업/작업 | 프로젝션 된 연결 된 리소스에 대 한 비동기 작업 상태를 가져오거나 나열 합니다. |
...
> | Microsoft AzureStack/등록/enableRemoteManagement/작업 | Azure Stack 등록을 위해 RemoteManagement 사용 |
...
> | 작업 | 설명 |
> | --- | --- |
> | DataBoxEdge/availableSkus/읽기 | 사용 가능한 sku를 나열 하거나 가져옵니다. |
...
> | DataBoxEdge/dataBoxEdgeDevices/roles/monitoringConfig/read | 모니터링 구성을 나열 하거나 가져옵니다. |
> | DataBoxEdge/dataBoxEdgeDevices/roles/monitoringConfig/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
...
> | Microsoft EventGrid/domains/PrivateEndpointConnectionsApproval/action | 도메인에 대 한 PrivateEndpointConnections 승인 |
...
> | Microsoft EventGrid/Eventgrid/getDeliveryAttributes/action | EventSubscription 배달 특성 가져오기 |
...
> | Microsoft EventGrid/함께 네임 스페이스/쓰기 | 파트너 네임 스페이스 만들기 또는 업데이트 |
> | Microsoft EventGrid/추가 네임 스페이스/읽기 | 파트너 네임 스페이스 읽기 |
> | Microsoft EventGrid/함께 네임 스페이스/삭제 | 파트너 네임 스페이스 삭제 |
> | Microsoft EventGrid/함께 네임 스페이스/listKeys/action | 파트너 네임 스페이스의 키를 나열 합니다. |
> | Microsoft EventGrid/함께 네임 스페이스/regenerateKey/작업 | 파트너 네임 스페이스에 대 한 키 다시 생성 |
> | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/read | 이벤트 채널 읽기 |
> | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/write | 이벤트 채널 만들기 또는 업데이트 |
> | Microsoft EventGrid/함께 네임 스페이스/Eventgrid/delete | 이벤트 채널 삭제 |
...
> | Microsoft EventGrid/함께 등록/쓰기 | 파트너 등록 만들기 또는 업데이트 |
> | Microsoft EventGrid/함께 등록/읽기 | 파트너 등록 읽기 |
> | Microsoft EventGrid/함께 등록/삭제 | 파트너 등록 삭제 |
> | Microsoft EventGrid/관련 항목/읽기 | 파트너 항목 읽기 |
> | Microsoft EventGrid/관련 항목/쓰기 | 파트너 항목 만들기 또는 업데이트 |
> | Microsoft EventGrid/관련 항목/삭제 | 파트너 항목 삭제 |
> | Microsoft EventGrid/제품 토픽/활성화/작업 | 파트너 활성화 항목 |
> | Microsoft EventGrid/항목 토픽/비활성화/작업 | 파트너 비활성화 항목 |
> | Microsoft EventGrid/항목 토픽/Eventgrid/write | 관련 토픽 eventSubscription 만들기 또는 업데이트 |
> | Microsoft EventGrid/항목 토픽/Eventgrid/read | 관련 토픽 eventSubscription 읽기 |
> | Microsoft EventGrid/항목 토픽/Eventgrid/delete | 관련 토픽 eventSubscription 삭제 |
> | Microsoft EventGrid/Ul토픽/Eventgrid/getFullUrl/action | 파트너 항목 이벤트 구독의 전체 url을 가져옵니다. |
> | Microsoft EventGrid/getDeliveryAttributes 토픽/Eventgrid//action | 관련 토픽 EventSubscription 배달 특성 가져오기 |
...
> | Microsoft EventGrid/systemTopics/읽기 | 시스템 항목 읽기 |
> | Microsoft EventGrid/systemTopics/쓰기 | 시스템 항목 만들기 또는 업데이트 |
> | Microsoft EventGrid/systemTopics/delete | 시스템 항목 삭제 |
> | Microsoft EventGrid/systemTopics/Eventgrid/write | SystemTopic eventSubscription 만들기 또는 업데이트 |
> | Microsoft EventGrid/systemTopics/Eventgrid/read | SystemTopic eventSubscription 읽기 |
> | Microsoft EventGrid/systemTopics/Eventgrid/delete | SystemTopic eventSubscription을 삭제 합니다. |
> | Microsoft EventGrid/systemTopics/Eventgrid/getFullUrl/action | SystemTopic 이벤트 구독에 대 한 전체 url을 가져옵니다. |
> | Microsoft EventGrid/systemTopics/Eventgrid/getDeliveryAttributes/action | SystemTopic EventSubscription 배달 특성 가져오기 |
...
> | Microsoft EventGrid/토픽/PrivateEndpointConnectionsApproval/action | PrivateEndpointConnections 승인 항목 |
...
> | IntegrationAccounts/usageConfigurations/read | 통합 계정에서 사용 구성을 읽습니다. |
> | IntegrationAccounts/usageConfigurations/write | 통합 계정에서 사용 구성을 만들거나 업데이트 합니다. |
> | IntegrationAccounts/usageConfigurations/delete | 통합 계정에서 사용 구성을 삭제 합니다. |
> | Microsoft 논리/integrationAccounts/usageConfigurations/listCallbackUrl/동작 | 통합 계정의 사용 구성에 대 한 콜백 URL을 가져옵니다. |
...
> | Microsoft Relay/네임 스페이스/privateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
...
> | ServiceBus/네임 스페이스/privateEndpointConnectionsApproval/작업 | 개인 끝점 연결 승인 |
...
> | aadiam/metricDefinitions/읽기 | Tenant-Level 메트릭 정의를 읽습니다. |
> | aadiam/메트릭/읽기 | Tenant-Level 메트릭 읽기 |
...
> | Microsoft. Security/iotDefenderSettings/write | IoT Defender 설정 만들기 또는 업데이트 |
> | Microsoft. Security/iotDefenderSettings/delete | IoT Defender 설정을 삭제 합니다. |
> | Microsoft. Security/iotDefenderSettings/PackageDownloads/작업 | 다운로드 가능한 IoT Defender 패키지 정보를 가져옵니다. |
> | Microsoft. Security/iotDefenderSettings/DownloadManagerActivation/action | 구독 할당량 데이터가 포함 된 관리자 활성화 파일 다운로드 |
...
> | Microsoft. Security/IanalyticsModels Securitysolutions//read | IoT 권장 사항을 가져옵니다. |
> | Microsoft. Security/IanalyticsModels Securitysolutions//read | 장치를 가져옵니다. |
...
> | Microsoft. Security/I이상 센서/읽기 | IoT 센서를 가져옵니다. |
> | Microsoft. Security/I이상 센서/쓰기 | IoT 센서 만들기 또는 업데이트 |
> | Microsoft. Security/I이상 센서/삭제 | IoT 센서를 삭제 합니다. |
> | Microsoft. Security/I이상 센서/다운로드 활성화/작업 | IoT 센서에 대 한 활성화 파일 다운로드 |
> | Microsoft. Security/I이상 센서/TriggerTiPackageUpdate/action | 위협 인텔리전스 패키지 업데이트를 트리거합니다. |
> | Microsoft. Security/I이상 센서/DownloadResetPassword/action | IoT 센서에 대 한 암호 다시 설정 파일을 다운로드 합니다. |
> | Microsoft. Security/iotSite/read | IoT 사이트를 가져옵니다. |
> | Microsoft. Security/iotSite/write | IoT 사이트를 만들거나 업데이트 합니다. |
> | Microsoft. Security/I이상 사이트/삭제 | IoT 사이트를 삭제 합니다. |
...
> | Microsoft SecurityInsights/automationRules/read | Automation 규칙을 가져옵니다. |
> | Microsoft SecurityInsights/automationRules/write | 자동화 규칙을 업데이트 합니다. |
> | Microsoft SecurityInsights/automationRules/delete | 자동화 규칙을 삭제 합니다. |
...
> | Microsoft SecurityInsights/인시던트/설명/삭제 | 인시던트의 의견을 삭제 합니다. |
...
> | Microsoft. 마이그레이션/등록 취소/작업 | Microsoft에서 구독의 등록을 취소 합니다. 리소스 공급자를 마이그레이션합니다. |
...
> | Microsoft. 마이그레이션/위치/rmsOperationResults/읽기 | 구독 전체의 위치 기반 작업 상태를 가져옵니다. |
...
> | Microsoft. 마이그레이션/moveCollections/읽기 | 이동 컬렉션을 가져옵니다. |
> | Microsoft. 마이그레이션/moveCollections/쓰기 | 이동 컬렉션을 만들거나 업데이트 합니다. |
> | Microsoft. 마이그레이션/moveCollections/삭제 | 이동 컬렉션을 삭제 합니다. |
> | Microsoft. 마이그레이션/moveCollections/resolveDependencies/작업 | 이동 컬렉션에서 리소스 이동의 종속성을 계산 하 고, 확인 하 고, 유효성을 검사 합니다. |
> | Microsoft. 마이그레이션/moveCollections/준비/작업 | 요청 본문에 포함 된 리소스 집합에 대 한 준비를 시작 합니다. |
> | Microsoft. 마이그레이션/moveCollections/initiateMove/작업 | 요청 본문에 포함 된 리소스 집합을 이동 합니다. |
> | Microsoft. 마이그레이션/moveCollections/취소/작업 | 요청 본문에 포함 된 리소스 집합을 삭제 합니다. |
> | Microsoft. 마이그레이션/moveCollections/커밋/작업 | 요청 본문에 포함 된 리소스 집합을 커밋합니다. |
> | Microsoft. 마이그레이션/moveCollections/대량 제거/작업 | 이동 컬렉션에서 요청 본문에 포함 된 이동 리소스 집합을 제거 합니다. |
> | Microsoft. 마이그레이션/moveCollections/moveResources/읽기 | 이동 컬렉션에서 모든 이동 리소스 또는 이동 리소스를 가져옵니다. |
> | Microsoft. 마이그레이션/moveCollections/moveResources/쓰기 | 이동 리소스를 만들거나 업데이트 합니다. |
> | Microsoft. 마이그레이션/moveCollections/moveResources/삭제 | 이동 컬렉션에서 이동 리소스를 삭제 합니다. |
> | Microsoft. 마이그레이션/moveCollections/작업/읽기 | 작업의 상태를 가져옵니다. |
> | Microsoft. 마이그레이션/moveCollections/a s/읽기 | 쿼리 매개 변수에서 전달 된 리소스를 사용 하는 리소스를 가져옵니다. |
> | Microsoft. 마이그레이션/moveCollections/unresolvedDependencies/읽기 | 이동 컬렉션에서 확인 되지 않은 종속성 목록을 가져옵니다. |
...
> | Microsoft. OffAzure/MasterSites/operationsstatus/read | 마스터 사이트 작업 상태의 속성을 가져옵니다. |
> | Microsoft. OffAzure/MasterSites/operationsstatus/read | 마스터 사이트 작업 상태의 속성을 가져옵니다. |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 프록시 유효성 검사 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 또는 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다. |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/validate/action | 개인 끝점 연결 프록시 유효성 검사 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 또는 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다. |
...
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/write | 개인 끝점 연결 프록시 만들기 또는 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnectionProxies/delete | 개인 끝점 연결 프록시를 삭제 합니다. |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/read | 개인 끝점 연결 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/write | 개인 끝점 연결 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/delete | 개인 끝점 연결 삭제 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/read | 개인 끝점 연결 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/write | 개인 끝점 연결 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/delete | 개인 끝점 연결 삭제 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/read | 개인 끝점 연결 가져오기 |
...
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/write | 개인 끝점 연결 업데이트 |
> | Microsoft. OffAzure/MasterSites/privateEndpointConnections/delete | 개인 끝점 연결 삭제 |
> | Microsoft. OffAzure/MasterSites/privateLinkResources/read | 개인 링크 리소스 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateLinkResources/read | 개인 링크 리소스 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateLinkResources/read | 개인 링크 리소스 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateLinkResources/read | 개인 링크 리소스 가져오기 |
> | Microsoft. OffAzure/MasterSites/privateLinkResources/read | 개인 링크 리소스 가져오기 |
...
> | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/healthsummary/읽기 | VMware 리소스에 대 한 상태 요약을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/호스트/읽기 | VMware 호스트의 속성을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/호스트/읽기 | VMware 호스트의 속성을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/호스트/읽기 | VMware 호스트의 속성을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/호스트/읽기 | VMware 호스트의 속성을 가져옵니다. |
> | Microsoft. OffAzure/VMwareSites/호스트/읽기 | VMware 호스트의 속성을 가져옵니다. |
...
> | AlertsManagement/resourceHealthAlertRules/write | 지정 된 구독에서 Resource Health 경고 규칙을 만들거나 업데이트 합니다. |
> | AlertsManagement/resourceHealthAlertRules/읽기 | 입력 필터에 대 한 모든 Resource Health 경고 규칙 가져오기 |
> | AlertsManagement/resourceHealthAlertRules/delete | 지정 된 구독에서 Resource Health 경고 규칙 삭제 |
...
> | Microsoft의 통찰력/토폴로지/읽기 | 토폴로지 읽기 |
> | Microsoft의 인 사이트/트랜잭션/읽기 | 읽기 트랜잭션 |
...
> | OperationalInsights/작업 영역/쿼리/AACHttpRequest/읽기 | AACHttpRequest 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/ABSBotRequests/읽기 | ABSBotRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ABSChannelToBotRequests/읽기 | ABSChannelToBotRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ABSDependenciesRequests/읽기 | ABSDependenciesRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ACSAuthIncomingOperations/읽기 | ACSAuthIncomingOperations 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ACSBillingUsage/읽기 | ACSBillingUsage 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ACSChatIncomingOperations/읽기 | ACSChatIncomingOperations 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ACSSMSIncomingOperations/read | ACSSMSIncomingOperations 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/ADFSandboxActivityRun/읽기 | ADFSandboxActivityRun 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ADFSandboxPipelineRun/읽기 | ADFSandboxPipelineRun 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/ADFSSignInLogs/읽기 | ADFSSignInLogs 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/ADPAudit/read | ADPAudit 테이블에서 데이터 읽기 |
> | OperationalInsights/작업 영역/쿼리/ADPRequests/read | ADPRequests 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/AEWAuditLogs/읽기 | AEWAuditLogs 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/AmlOnlineEndpointConsoleLog/읽기 | AmlOnlineEndpointConsoleLog 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/workspaces/query/AmlRunStatusChangedEvent/읽기 | AmlRunStatusChangedEvent 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/비정상/읽기 | 변칙 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/AzureActivityV2/읽기 | AzureActivityV2 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/ContainerLogV2/읽기 | ContainerLogV2 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/DeviceFileCertificateInfo/읽기 | DeviceFileCertificateInfo 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/DynamicEventCollection/read | DynamicEventCollection 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/IdentityInfo/읽기 | IdentityInfo 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/IntuneDevices | IntuneDevices 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/KubePVInventory/읽기 | KubePVInventory 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/NetworkSessions/read | NetworkSessions 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/PowerBIDatasetsTenant/읽기 | PowerBIDatasetsTenant 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/workspaces/query/PowerBIDatasetsTenantPreview/read | Powerbidatasetsten앤틸리스 Preview 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/PowerBIDatasetsWorkspace/읽기 | PowerBIDatasetsWorkspace 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/SecureScoreControls/읽기 | SecureScoreControls 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SecureScores/읽기 | SecureScores 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/SecurityRegulatoryCompliance/읽기 | SecurityRegulatoryCompliance 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SentinelHealth/읽기 | SentinelHealth 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/SqlAtpStatus/읽기 | SqlAtpStatus 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/SqlVulnerabilityAssessmentScanStatus/읽기 | SqlVulnerabilityAssessmentScanStatus 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/SynapseBigDataPoolApplicationsEnded/읽기 | SynapseBigDataPoolApplicationsEnded 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseBuiltinSqlPoolRequestsEnded/읽기 | SynapseBuiltinSqlPoolRequestsEnded 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseGatewayApiRequests/읽기 | SynapseGatewayApiRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseGatewayEvents/읽기 | SynapseGatewayEvents 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationActivityRuns/읽기 | SynapseIntegrationActivityRuns 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationActivityRunsEnded/읽기 | SynapseIntegrationActivityRunsEnded 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationPipelineRuns/읽기 | SynapseIntegrationPipelineRuns 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationPipelineRunsEnded/읽기 | SynapseIntegrationPipelineRunsEnded 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationTriggerRuns/읽기 | SynapseIntegrationTriggerRuns 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseIntegrationTriggerRunsEnded/읽기 | SynapseIntegrationTriggerRunsEnded 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseRBACEvents/읽기 | SynapseRBACEvents 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseRbacOperations/읽기 | SynapseRbacOperations 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseSqlPoolDmsWorkers/읽기 | SynapseSqlPoolDmsWorkers 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseSqlPoolExecRequests/읽기 | SynapseSqlPoolExecRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseSqlPoolRequestSteps/읽기 | SynapseSqlPoolRequestSteps 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseSqlPoolSqlRequests/읽기 | SynapseSqlPoolSqlRequests 테이블에서 데이터를 읽습니다. |
> | OperationalInsights/작업 영역/쿼리/SynapseSqlPoolWaits/읽기 | SynapseSqlPoolWaits 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/W3CIISLogV2/읽기 | W3CIISLogV2 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/WorkloadDiagnosticLogs/읽기 | WorkloadDiagnosticLogs 테이블에서 데이터를 읽습니다. |
...
> | OperationalInsights/작업 영역/쿼리/WVDAgentHealthStatus/읽기 | WVDAgentHealthStatus 테이블에서 데이터를 읽습니다. |
...
> | operationalinsights/작업 영역/뷰/읽기 | 작업 영역 뷰를 가져옵니다. |
> | operationalinsights/작업 영역/뷰/쓰기 | 작업 영역 보기를 만들거나 업데이트 합니다. |
> | operationalinsights/작업 영역/뷰/삭제 | 작업 영역 보기를 삭제 합니다. |
...
> | 작업 | 설명 |
> | --- | --- |
> | WorkloadMonitor/register/action | WorkloadMonitor 리소스 공급자에 구독을 등록 합니다. |
> | WorkloadMonitor/등록 취소/작업 | WorkloadMonitor 리소스 공급자를 사용 하 여 구독 등록 취소 |
> | Microsoft.WorkloadMonitor/monitors/read | 모니터 및 해당 현재 상태를 가져옵니다. |
> | WorkloadMonitor/모니터/기록/읽기 | 특정 모니터의 상태 변경 기록을 가져옵니다. |
> | Microsoft.WorkloadMonitor/operations/read | 지원 되는 작업 목록을 가져옵니다. |
...
> | Microsoft. Automation/automationAccounts/privateEndpointConnections/delete | Azure Automation 개인 끝점 연결 삭제 |
...
> | Microsoft. Automation/automationAccounts/runbook/draft/write | Runbook 초안 Azure Automation를 만듭니다. |
...
> | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/write |  |
> | Microsoft. 청구/billingAccounts/billingProfiles/invoiceSections/validateDeleteInvoiceSectionEligibility/write |  |
> | Microsoft. 청구/billingAccounts/billingProfiles/validateDeleteBillingProfileEligibility/write |  |
> | Microsoft. 청구/billingProperty/쓰기 |  |
> | Microsoft. 청구/작업/읽기 |  |
...
> | Microsoft. Capacity/listSkus/작업 | 필터가 있는 Sku 및 제한 없이 나열 |
...
> | Microsoft. Capacity/reservationorders/changedirectory/작업 | 예약의 디렉터리 변경 |
...
> | Microsoft Capacity/reservationorders/예약/보관/작업 | 만료, 분할 등과 같은 터미널 상태의 예약을 보관 합니다. |
> | Microsoft Capacity/reservationorders/예약은/archive/unarchive/action | 이전에 보관 된 예약 보관 해제 |
...
> | Microsoft. Capacity/resourceProviders/위치/serviceLimits/read | 지정 된 리소스 및 위치의 현재 서비스 제한 또는 할당량을 가져옵니다. |
> | Microsoft. Capacity/resourceProviders/위치/serviceLimits/write | 지정 된 리소스 및 위치에 대 한 서비스 제한 또는 할당량 만들기 |
> | Microsoft. Capacity/resourceProviders/위치/i n t e r/i n t e r/읽기 | 지정 된 리소스 및 위치에 대 한 서비스 제한 요청을 가져옵니다. |
...
> | Microsoft. Features/featureProviders/subscriptionFeatureRegistrations/read | 지정 된 리소스 공급자에서 구독의 기능 등록을 가져옵니다. |
> | Microsoft. Features/featureProviders/subscriptionFeatureRegistrations/write | 지정 된 리소스 공급자에서 구독의 기능 등록을 추가 합니다. |
> | Microsoft. Features/featureProviders/subscriptionFeatureRegistrations/delete | 지정 된 리소스 공급자에서 구독의 기능 등록을 삭제 합니다. |
...
> | HybridCompute/위치/operationstatus/read | HybridCompute 리소스 공급자에 대 한 작업 상태를 읽습니다. |
> | HybridCompute/위치/updateCenterOperationResults/읽기 | 컴퓨터에서 업데이트 센터 작업의 상태를 읽습니다. |
...
> | HybridCompute/machines/assessPatches/작업 | 누락 된 소프트웨어 패치를 얻기 위해 모든 Azure Arc 컴퓨터를 평가 합니다. |
> | HybridCompute/machines/installPatches/작업 | 모든 Azure Arc 컴퓨터에 패치를 설치 합니다. |
...
> | HybridCompute/machines/patchAssessmentResults/read | 모든 Azure Arc patchAssessmentResults을 읽습니다. |
> | HybridCompute/machines/patchAssessmentResults/고 패치/읽기 | 모든 Azure Arc patchAssessmentResults/\\D 패치를 읽습니다. |
> | HybridCompute/machines/patchInstallationResults/read | 모든 Azure Arc patchInstallationResults을 읽습니다. |
> | HybridCompute/machines/patchInstallationResults/고 패치/읽기 | 모든 Azure Arc patchInstallationResults/\\D 패치를 읽습니다. |
...
> | 작업 | 설명 |
> | --- | --- |
> | Kubernetes/register/action | Kubernetes 리소스 공급자에 구독을 등록 합니다. |
> | Kubernetes/등록 취소/작업 | Kubernetes 리소스 공급자를 사용 하 여 구독을 Un-Registers 합니다. |
...
> | Kubernetes/위치/operationstatuses/읽기 | 읽기 작업 상태 |
> | Kubernetes/위치/operationstatuses/쓰기 | 쓰기 작업 상태 |
> | Kubernetes/작업/읽기 | Kubernetes 리소스 공급자에서 사용할 수 있는 작업을 나열 합니다. |
...
> | Microsoft. PolicyInsights/eventGridFilters/read | 상태 변경 알림을 게시할 범위를 추적 하는 데 사용 되는 Event Grid 필터를 가져옵니다. |
> | Microsoft. PolicyInsights/eventGridFilters/write | Event Grid 필터를 만들거나 업데이트 합니다. |
> | Microsoft. PolicyInsights/eventGridFilters/delete | Event Grid 필터를 삭제 합니다. |
...
> | Microsoft. Portal/tenantConfigurations/읽기 | 테 넌 트 구성 읽기 |
> | Microsoft. Portal/tenantConfigurations/쓰기 | 테 넌 트 구성을 추가 하거나 업데이트 합니다. 사용자는이 작업에 대 한 테 넌 트 관리자 여야 합니다. |
> | Microsoft. Portal/tenantConfigurations/삭제 | 테 넌 트 구성을 제거 합니다. 사용자는이 작업에 대 한 테 넌 트 관리자 여야 합니다. |
...
> | Microsoft RecoveryServices/위치/r e r e r/작업 | 지역 간 복원을 트리거합니다. |
> | Microsoft RecoveryServices/위치/r e a p s/작업 | 보조 지역에서 Recovery Services 자격 증명 모음에 대 한 지역 간 복원 작업 세부 정보를 가져옵니다. |
> | Microsoft RecoveryServices/위치/backupCrrJobs/작업 | 보조 지역에서 Recovery Services 자격 증명 모음에 대 한 지역 간 복원 작업을 나열 합니다. |
...
> | Microsoft RecoveryServices/위치/backupAadProperties/읽기 | 지역 간 복원에 대 한 세 번째 지역에서 인증에 대 한 AAD 속성을 가져옵니다. |
> | Microsoft RecoveryServices/위치/backupCrrOperationResults/읽기 | Recovery Services 자격 증명 모음에 대 한 CRR 작업 결과를 반환 합니다. |
> | Microsoft RecoveryServices/위치/backupCrrOperationsStatus/읽기 | Recovery Services 자격 증명 모음에 대 한 CRR 작업 상태를 반환 합니다. |
...
> | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/protectionContainers/protectedItems/recoveryPointsRecommendedForMove/action | 다른 계층으로 이동 하는 데 권장 되는 복구 시점 가져오기 |
...
> | Microsoft RecoveryServices/자격 증명 모음/backupFabrics/protectionContainers/protectedItems/recoveryPoints/move/action | 복구 지점을 다른 계층으로 이동 |
...
> | Microsoft RecoveryServices/자격 증명 모음/backupOperationVaultGuardProxies/삭제 | VaultGuard 프록시 삭제 작업은 ' VaultGuard proxy ' 형식의 지정 된 Azure 리소스를 삭제 합니다. |
> | Microsoft RecoveryServices/자격 증명 모음/backupOperationVaultGuardProxies/읽기 | VaultGuard 프록시 작업 가져오기 ' VaultGuard proxy ' 형식의 Azure 리소스를 나타내는 개체를 가져옵니다. |
> | Microsoft RecoveryServices/자격 증명 모음/backupOperationVaultGuardProxies/읽기 | 리소스의 VaultGuard 프록시 목록 가져오기 |
> | Microsoft RecoveryServices/자격 증명 모음/backupOperationVaultGuardProxies/unlockDelete/action | VaultGuard 프록시 삭제 잠금 해제 작업은 다음 삭제 위험 작업의 잠금을 해제 합니다. |
> | Microsoft RecoveryServices/자격 증명 모음/backupOperationVaultGuardProxies/쓰기 | Create VaultGuard proxy 작업은 ' VaultGuard Proxy ' 형식의 Azure 리소스를 만듭니다. |
...
> | Microsoft RecoveryServices/자격 증명 모음/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/failoverCancel/action | 장애 조치 취소 |
...
> | Microsoft RecoveryServices/자격 증명 모음/replicationProtectionIntents/읽기 | 모든 항목을 읽습니다.  |
> | Microsoft RecoveryServices/자격 증명 모음/replicationProtectionIntents/쓰기 | 만들기 또는 업데이트  |
...
> | Microsoft RecoveryServices/자격 증명 모음/replicationRecoveryPlans/failoverCancel/action | 장애 조치 (Failover) 복구 계획 취소 |
...
> | Microsoft RecoveryServices/자격 증명 모음/replicationSupportedRegionMappings/읽기 | 모든 항목을 읽습니다.  |
...
> | Microsoft. Subscription/enable/action | 구독을 다시 활성화 합니다. |
...
> | Microsoft. Subscription/Subscription/write | Azure 구독을 만듭니다. |
...
> | Microsoft DesktopVirtualization/hostpools/retrieveRegistrationToken/action | 호스트 풀의 등록 토큰 검색 |
...
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnectionProxies/validate/action | PrivateEndpointConnectionProxies 리소스 유효성 검사 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnectionProxies/read | PrivateEndpointConnectionProxies 리소스 읽기 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnectionProxies/write | PrivateEndpointConnectionProxies 리소스 쓰기 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnectionProxies/delete | PrivateEndpointConnectionProxies 리소스 삭제 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnectionProxies/operationResults/read | 개인 끝점 연결 프록시에 대 한 비동기 작업의 결과를 가져옵니다. |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnections/read | PrivateEndpointConnection 리소스 읽기 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnections/write | PrivateEndpointConnection 리소스 쓰기 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnections/delete | PrivateEndpointConnection 리소스 삭제 |
> | DigitalTwins/digitalTwinsInstances/privateEndpointConnections/operationResults/read | 개인 끝점 연결에 대 한 비동기 작업의 결과를 가져옵니다. |
> | DigitalTwins/digitalTwinsInstances/privateLinkResources/read | Digital Twins에 대 한 PrivateLinkResources 읽기 |
