...
> | Action | Microsoft.AAD/domainServices/replicaSets/read | 클러스터 사이트 읽기 |
...
> | Action | Microsoft.AlertsManagement/alertsList/read | 전체 구독에서 입력 필터에 대한 모든 경고를 가져옵니다. |
...
> | Action | Microsoft.AlertsManagement/Operations/read | 제공된 작업을 읽습니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/diagnostics/write | API에 대 한 새 진단을 만들거나 기존 API를 업데이트 합니다. 또는는 해당 식별자로 지정 된 API에 대 한 진단 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/issues/attachments/write | API의 문제에 대 한 새 첨부 파일을 만들거나 기존 문제를 업데이트 합니다. |
> | 작업 | Microsoft.ApiManagement/service/apis/issues/comments/delete | 문제에서 지정 된 설명을 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/apis/issues/comments/read | 지정 된 API와 관련 된 문제에 대 한 모든 설명을 나열 합니다. 또는 해당 식별자로 지정 된 API에 대 한 문제 설명의 세부 정보를 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/operations/delete | API에서 지정 된 작업을 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/operations/read | 지정 된 API에 대 한 작업의 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 API 작업에 대 한 세부 정보를 가져옵니다. |
> | Action | Microsoft.ApiManagement/service/apis/operations/tags/delete | 작업에서 태그를 분리 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/policies/write | API에 대 한 정책 구성을 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/policy/write | API 수준에서 정책 구성 만들기 |
...
> | Action | Microsoft.ApiManagement/service/apis/schemas/delete | Api에서 스키마 구성을 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/apis/tagDescriptions/read | API의 범위에서 모든 태그 설명을 나열 합니다. Swagger-tagDescription와 유사한 모델은 API 수준에서 정의 되지만 태그는 작업에 할당 되거나 API 범위에서 태그 설명을 가져올 수 있습니다. |
...
> | Action | Microsoft.ApiManagement/service/apiVersionSets/write | Api 버전 집합을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 Api VersionSet의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/backends/delete | 지정 된 백 엔드를 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/backends/read | 지정 된 서비스 인스턴스의 백 엔드 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된 백 엔드의 세부 정보를 가져옵니다. |
...
> | 작업 | Microsoft.ApiManagement/service/backup/action | 사용자가 제공한 저장소 계정의 지정된 컨테이너로 API Management 서비스를 백업합니다. |
...
> | Action | Microsoft.ApiManagement/service/certificates/delete | 특정 인증서를 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/contentTypes/contentItems/delete | 지정된 콘텐츠 항목을 제거합니다. |
...
> | Action | Microsoft.ApiManagement/service/contentTypes/read | 콘텐츠 형식을 반환합니다. |
...
> | Action | Microsoft.apimanagement/서비스/게이트웨이/삭제 | 특정 게이트웨이를 삭제 합니다. |
...
> | Action | Microsoft.ApiManagement/service/groups/users/read | 그룹에 연결 된 사용자 엔터티의 컬렉션을 나열 합니다. |
...
> | Action | Microsoft.ApiManagement/service/issues/read | 지정 된 서비스 인스턴스의 문제 컬렉션을 나열 합니다. 또는 API Management 문제 세부 정보를 가져옵니다. |
> | Action | Microsoft.ApiManagement/service/locations/networkstatus/read | 해당 위치에는 서비스가 종속되는 리소스의 네트워크 액세스 상태를 가져옵니다. |
> | 액션(Action) | Microsoft.ApiManagement/service/loggers/delete | 지정 된로 거를 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/loggers/read | 지정 된 서비스 인스턴스에 대 한로 거 컬렉션을 나열 합니다. 또는 해당 식별자로 지정 된로 거에 대 한 세부 정보를 가져옵니다. |
> | 작업 | Microsoft.ApiManagement/service/loggers/write | 로 거를 만들거나 업데이트 합니다. 또는는 기존로 거를 업데이트 합니다. |
> | Action | Microsoft.ApiManagement/service/managedeployments/action | SKU/단위를 변경하고 API Management 서비스의 지역별 배포를 추가 또는 제거합니다. |
...
> | Action | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | 알림 목록에서 API Management 사용자를 제거 합니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/recipientUsers/read | 알림을 구독 하는 알림 받는 사람 목록을 가져옵니다. |
> | Action | Microsoft.ApiManagement/service/notifications/recipientUsers/write | 알림에 대 한 받는 사람 목록에 API Management 사용자를 추가 합니다. |
> | 작업 | Microsoft.ApiManagement/service/notifications/write | API Management 게시자 알림을 만들거나 업데이트 합니다. |
> | Action | Microsoft.ApiManagement/service/openidConnectProviders/delete | API Management 서비스 인스턴스의 특정 Openid connect Connect 공급자를 삭제 합니다. |
> | Action | Microsoft.ApiManagement/service/openidConnectProviders/read | 모든 Openid connect Connect 공급자 목록입니다. 또는 특정 Openid connect Connect 공급자를 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/policies/read | Api Management 서비스의 모든 전역 정책 정의를 나열 합니다. 또는 Api Management 서비스의 전역 정책 정의를 가져옵니다. |
...
> | Action | Microsoft.ApiManagement/service/policy/read | 테 넌 트 수준에서 정책 구성 가져오기 |
...
> | Action | Microsoft.ApiManagement/service/products/apis/read | 제품과 연결 된 Api 컬렉션을 나열 합니다. |
...
> | Action | Microsoft.ApiManagement/service/products/write | 제품을 만들거나 업데이트 합니다. 또는 기존 제품 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/properties/write | 속성을 만들거나 업데이트 합니다. 또는 특정 속성을 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/regions/read | 서비스가 존재 하는 모든 azure 지역을 나열 합니다. |
...
> | Action | Microsoft.ApiManagement/service/subscriptions/regenerateSecondaryKey/action | API Management 서비스 인스턴스에 대 한 기존 구독의 보조 키를 다시 생성 합니다. |
> | Action | Microsoft.ApiManagement/service/subscriptions/write | 지정한 제품에 대해 지정한 사용자의 구독을 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 구독의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.ApiManagement/service/templates/delete | 기본 API Management 이메일 템플릿을 다시 설정합니다. |
...
> | Action | Microsoft.ApiManagement/service/users/groups/read | 모든 사용자 그룹을 나열 합니다. |
> | 작업 | Microsoft.ApiManagement/service/users/identities/read | 모든 사용자 id의 목록입니다. |
> | Action | Microsoft.ApiManagement/service/users/keys/read | 사용자와 연결 된 키 가져오기 |
...
> | Action | Microsoft.ApiManagement/service/users/write | 사용자를 만들거나 업데이트 합니다. 또는는 해당 식별자로 지정 된 사용자의 세부 정보를 업데이트 합니다. |
...
> | Action | Microsoft.Automation/automationAccounts/read | Azure Automation 계정을 가져옵니다. |
...
> | Action | Microsoft.AzureActiveDirectory/operations/read | Microsoft.AzureActiveDirectory 리소스 공급자에 사용할 수 있는 모든 API 작업을 읽습니다. |
...
> | Action | Microsoft.Batch/locations/accountOperationResults/read | 장기 실행 배치 계정 작업의 결과를 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | 작업 | Microsoft.Billing/billingAccounts/departments/read | 청구 계정 범위에 포함된 모든 부서를 나열합니다. |
> | Action | Microsoft.Billing/billingAccounts/enrollmentAccounts/read | 청구 계정 범위에 포함된 모든 등록 계정을 나열합니다. |
> | Action | Microsoft.Billing/billingAccounts/read | 사용자가 액세스할 수 있는 모든 청구 계정을 나열합니다. |
> | 작업 | Microsoft.Billing/billingPeriods/read | 사용할 수 있는 청구 기간을 나열합니다. |
> | 작업 | Microsoft.Billing/departments/read | 사용자가 액세스할 수 있는 모든 부서를 나열합니다. |
> | Action | Microsoft.Billing/invoices/read | 사용 가능한 청구서를 나열합니다. |
> | 작업 | Microsoft.Billing/register/action | Microsoft.Billing 리소스 공급자에 구독을 등록합니다. |
...
> | Action | Microsoft.Blockchain/blockchainMembers/transactionNodes/read | 기존 Blockchain 구성원 트랜잭션 노드를 가져오거나 나열 합니다. |
> | Action | Microsoft.Blockchain/blockchainMembers/transactionNodes/write | Blockchain 구성원 트랜잭션 노드를 만들거나 업데이트 합니다. |
> | Action | Microsoft.Blockchain/blockchainMembers/write | Blockchain 멤버를 만들거나 업데이트 합니다. |
> | Action | Microsoft.Blockchain/locations/blockchainMemberOperationResults/read | Blockchain 멤버의 작업 결과를 가져옵니다. |
...
> | Action | Microsoft.Blockchain/register/action | Blockchain 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | Action | Microsoft.Blueprint/blueprints/delete | 청사진 삭제 |
> | Action | Microsoft.Blueprint/blueprints/read | 청사진 읽기 |
...
> | Action | Microsoft.Blueprint/blueprints/versions/read | 청사진 읽기 |
...
> | Action | Microsoft.Blueprint/register/action | Azure 청사진 리소스 공급자 등록 |
...
> | Action | Microsoft.Cache/unregister/action | ‘Microsoft.Cache’ 리소스 공급자를 구독에서 등록 취소합니다. |
...
> | Action | Microsoft.Capacity/calculateexchange/action | 새 구매의 교환 금액 및 가격을 계산 하 고 정책 오류를 반환 합니다. |
...
> | Action | Microsoft.Capacity/exchange/action | 모든 예약 교환 |
...
> | Action | Microsoft.Capacity/reservationorders/split/action | 예약을 분할합니다. |
> | Action | Microsoft.Capacity/reservationorders/swap/action | 예약을 교환합니다. |
> | 작업 | Microsoft.Capacity/reservationorders/write | 예약을 만듭니다. |
> | 작업 | Microsoft.Capacity/tenants/register/action | 테넌트를 등록합니다. |
> | Action | Microsoft.Capacity/unregister/action | 테넌트를 등록 취소합니다. |
...
> | Action | Microsoft.ClassicCompute/domainNames/deploymentslots/roles/roleinstances/read | 도메인 이름의 배포 슬롯에서 역할에 대한 역할 인스턴스 가져오기 |
...
> | Action | Microsoft.ClassicCompute/domainNames/deploymentslots/upgradedomain/write | 도메인 이름의 배포 슬롯에 대한 업그레이드 도메인 업데이트 |
...
> | Action | Microsoft.ClassicNetwork/virtualNetworks/gateways/stopDiagnostics/action | 가상 네트워크 게이트웨이에 대한 진단을 중지합니다. |
...
> | 작업 | Microsoft.ClassicStorage/storageAccounts/read | 지정된 계정의 저장소 계정을 반환합니다. |
...
> | Action | Microsoft.CognitiveServices/accounts/delete | API 계정을 삭제합니다. |
...
> | 작업 | Microsoft.CognitiveServices/accounts/listKeys/action | 키 나열 |
...
> | Action | Microsoft.CognitiveServices/checkDomainAvailability/action | 구독에 대해 사용 가능한 SKU를 읽습니다. |
> | Action | Microsoft.CognitiveServices/locations/checkSkuAvailability/action | 구독에 대해 사용 가능한 SKU를 읽습니다. |
> | Action | Microsoft.CognitiveServices/locations/deleteVirtualNetworkOrSubnets/action | VirtualNetworks 또는 서브넷을 삭제 하는 Microsoft 네트워크의 알림입니다. |
> | Action | Microsoft.CognitiveServices/Operations/read | 사용 가능한 모든 작업을 나열합니다. |
...
> | 작업 | Microsoft.Compute/hosts/read | 호스트의 속성을 가져옵니다. |
> | Action | Microsoft.Compute/hosts/write | 새 호스트를 만들거나 기존 호스트를 업데이트 합니다. |
...
> | Action | Microsoft.Compute/locations/logAnalytics/getRequestRateByInterval/action | 제한 진단에 도움이 되도록 시간 간격별 총 요청 수를 표시하는 로그를 만듭니다. |
> | 작업 | Microsoft.Compute/locations/logAnalytics/getThrottledRequests/action | ResourceName, OperationName 또는 적용된 제한 정책으로 그룹화된 제한된 요청 집계를 표시하는 로그를 만듭니다. |
...
> | Action | Microsoft.Compute/virtualMachines/capture/action | 가상 하드 디스크를 복사하여 가상 머신을 캡처하고 유사한 가상 머신을 만드는 데 사용할 수 있는 템플릿을 생성합니다. |
...
> | Action | Microsoft.Compute/virtualMachineScaleSets/vmSizes/read | 가상 머신 확장 집합에서 가상 머신을 만들거나 업데이트 하는 데 사용할 수 있는 크기를 나열 합니다. |
...
> | Action | Microsoft.Consumption/budgets/read | 구독 또는 관리 그룹별로 예산을 나열합니다. |
...
> | Action | Microsoft.Consumption/operations/read | Microsoft.Consumption 리소스 공급자가 지원하는 모든 작업을 나열합니다. |
...
> | Action | Microsoft.Consumption/register/action | 소비 RP에 등록합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.ContainerInstance/containerGroups/containers/exec/action | 특정 컨테이너에 실행합니다. |
> | Action | Microsoft.ContainerInstance/containerGroups/containers/logs/read | 특정 컨테이너에 대한 로그를 가져옵니다. |
...
> | Action | Microsoft.ContainerRegistry/registries/listBuildSourceUploadUrl/action | 컨테이너 레지스트리에 대한 원본 업로드 URL 위치를 가져옵니다. |
...
> | Action | Microsoft.ContainerRegistry/registries/metadata/write | 컨테이너 레지스트리에 대 한 리포지토리의 메타 데이터를 업데이트 합니다. |
...
> | Action | Microsoft.ContainerRegistry/registries/runs/cancel/action | 기존 실행을 취소합니다. |
> | 작업 | Microsoft.ContainerRegistry/registries/runs/listLogSasUrl/action | 실행을 위한 로그 SAS URL을 가져옵니다. |
> | Action | Microsoft.ContainerRegistry/registries/runs/read | 컨테이너 레지스트리 또는 목록 실행에 대한 실행 속성을 가져옵니다. |
...
> | Action | Microsoft.ContainerService/managedClusters/agentPools/delete | 에이전트 풀을 삭제 합니다. |
> | Action | Microsoft.ContainerService/managedClusters/agentPools/read | 에이전트 풀을 가져옵니다. |
> | 작업 | Microsoft.ContainerService/managedClusters/agentPools/write | 새 에이전트 풀을 만들거나 기존 에이전트 풀을 업데이트 합니다. |
> | Action | Microsoft.ContainerService/managedClusters/delete | 관리되는 클러스터를 삭제합니다. |
...
> | Action | Microsoft.ContainerService/managedClusters/resetAADProfile/action | 관리형 클러스터의 AAD 프로필을 다시 설정합니다. |
> | 작업 | Microsoft.ContainerService/managedClusters/resetServicePrincipalProfile/action | 관리형 클러스터의 서비스 주체 프로필을 다시 설정합니다. |
> | 작업 | Microsoft.ContainerService/managedClusters/upgradeprofiles/read | 클러스터의 업그레이드 프로필을 가져옵니다. |
...
> | Action | Microsoft.ContainerService/openShiftManagedClusters/read | Open Shift 관리 되는 클러스터 가져오기 |
...
> | Action | Microsoft.CostManagement/cloudConnectors/write | 지정 된 cloudConnector를 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.CostManagement/exports/write | 지정된 내보내기를 만들거나 업데이트합니다. |
...
> | Action | Microsoft.CostManagement/reports/action | 범위별 사용 현황 데이터에 관한 보고서를 예약합니다. |
> | Action | Microsoft.CostManagement/reports/read | 범위별 사용 현황 데이터에 관한 보고서를 예약합니다. |
> | Action | Microsoft.CostManagement/tenants/register/action | CostManagement의 범위에 대 한 작업을 테 넌 트에 등록 합니다. |
...
> | Action | Microsoft.DataBox/jobs/listCredentials/action | 주문과 관련된 암호화되지 않은 자격 증명을 나열합니다. |
> | Action | Microsoft.DataBox/jobs/read | 주문을 나열하거나 가져옵니다. |
> | Action | Microsoft.DataBox/jobs/write | 주문을 만들거나 업데이트합니다. |
> | 액션(Action) | Microsoft.DataBox/locations/availableSkus/action | 이 메서드는 사용할 수 있는 SKU 목록을 반환합니다. |
> | Action | DataBox/위치/availableSkus/읽기 | 사용 가능한 Sku 나열 또는 가져오기 |
> | Action | Microsoft.DataBox/locations/operationResults/read | 작업 결과를 나열하거나 가져옵니다. |
> | Action | Microsoft.DataBox/locations/validateAddress/action | 배송 주소의 유효성을 검사하고 있는 경우 대체 주소를 제공합니다. |
> | 작업 | DataBox/위치/validateInputs/작업 |  |
...
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | 리소스 확장 정보를 검색합니다. |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/orders/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/read | 역할을 나열 하거나 가져옵니다. |
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/roles/write | 역할을 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/shares/delete | 공유를 삭제 |
...
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/delete | 저장소 계정 자격 증명을 삭제 |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/operationResults/read | 작업 결과를 나열 하거나 가져옵니다. |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/read | 저장소 계정 자격 증명을 나열하거나 가져오기 |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/read | 저장소 계정 자격 증명을 나열하거나 가져오기 |
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/storageAccountCredentials/write | 저장소 계정 자격 증명을 만들거나 업데이트 |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/updateSummary/read | 업데이트 요약을 나열하거나 가져오기 |
> | 작업 | Microsoft.DataBoxEdge/dataBoxEdgeDevices/uploadCertificate/action | 디바이스 등록에 대한 인증서를 업로드 |
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/users/delete | 공유 사용자를 삭제 |
...
> | Action | Microsoft.DataBoxEdge/dataBoxEdgeDevices/write | Data Box Edge 디바이스를 만들거나 업데이트 |
...
> | Action | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/logDefinitions/read | Databricks 작업 영역에 사용할 수 있는 로그 정의를 가져옵니다. |
...
> | Action | Microsoft.DataCatalog/datacatalogs/delete | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 삭제 합니다. |
> | Action | Microsoft.DataCatalog/datacatalogs/read | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 읽습니다. |
> | Action | Microsoft.DataCatalog/datacatalogs/write | Data Catalog 리소스 공급자에 대 한 Microsoft.datacatalog 리소스를 씁니다. |
> | Action | Microsoft.DataCatalog/operations/read | Data Catalog 리소스 공급자에서 사용 가능한 모든 작업을 읽습니다. |
> | 작업 | Microsoft.DataCatalog/register/action | Data Catalog 리소스 공급자에 대 한 구독 등록 |
> | Action | Microsoft.DataCatalog/unregister/action | Data Catalog 리소스 공급자에 대 한 구독 등록 취소 |
...
> | Action | Microsoft.DataFactory/factories/dataflows/delete | 데이터 흐름을 삭제 합니다. |
...
> | Action | Microsoft.DataFactory/factories/getDataPlaneAccess/read | ADF 데이터 평면 서비스에 대한 액세스를 읽습니다. |
...
> | Action | Microsoft.DataFactory/factories/integrationruntimes/delete | 모든 Integration Runtime을 삭제합니다. |
...
> | Action | Microsoft.DataFactory/factories/integrationruntimes/listauthkeys/read | 모든 Integration Runtime에 대한 인증 키를 나열합니다. |
...
> | Action | Microsoft.DataFactory/factories/integrationruntimes/removelinks/action | 지정된 Integration Runtime에서 연결된 Integration Runtime 참조를 제거합니다. |
> | Action | Microsoft.DataFactory/factories/integrationruntimes/start/action | 모든 Integration Runtime을 시작합니다. |
...
> | Action | Microsoft.DataFactory/factories/querydebugpipelineruns/action | 디버그 파이프라인 실행을 쿼리합니다. |
...
> | Action | Microsoft.DataFactory/locations/getFeatureValue/read | 특정 위치에 대한 노출 제어 기능 값을 읽습니다. |
...
> | Action | Microsoft.DataLakeAnalytics/accounts/virtualNetworkRules/delete | 가상 네트워크 규칙을 삭제 합니다. |
...
> | Action | Microsoft.DataLakeAnalytics/operations/read | DataLakeAnalytics에서 사용 가능한 작업을 가져옵니다. |
...
> | Action | Microsoft.DataMigration/services/addWorker/action | 서비스의 사용 가능한 작업자에 대한 DMS 작업자를 추가합니다. |
...
> | 작업 | Microsoft.DataMigration/services/removeWorker/action | 서비스의 사용 가능한 작업자에 대한 DMS 작업자를 제거합니다. |
> | Action | Microsoft.DataMigration/services/serviceTasks/cancel/action | 작업이 현재 실행 중인 경우 취소합니다. |
> | 작업 | Microsoft.DataMigration/services/serviceTasks/delete | 리소스와 해당 하위 항목을 모두 삭제합니다. |
> | 작업 | Microsoft.DataMigration/services/serviceTasks/read | 리소스에 대한 정보 읽기 |
...
> | 동작 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.DBforMariaDB/checkNameAvailability/action | 지정된 서버 이름을 지정된 구독에 대해 전 세계적으로 프로비전에 사용할 수 있는지 확인합니다. |
> | 작업 | Microsoft.DBforMariaDB/locations/azureAsyncOperation/read | 서버 작업 결과 반환 (& u) |
> | Action | Microsoft.DBforMariaDB/locations/operationResults/read | ResourceGroup 기반 MariaDB 서버 작업 결과 반환 |
> | 작업 | Microsoft.DBforMariaDB/locations/operationResults/read | 서버 작업 결과 반환 (& u) |
> | Action | Microsoft.DBforMariaDB/locations/performanceTiers/read | 사용할 수 있는 성능 계층 목록을 반환합니다. |
> | Action | Microsoft.DBforMariaDB/locations/securityAlertPoliciesAzureAsyncOperation/read | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | Action | Microsoft.DBforMariaDB/locations/securityAlertPoliciesOperationResults/read | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | Action | Microsoft.DBforMariaDB/operations/read | 작업 목록 반환. |
...
> | Action | Microsoft.DBforMariaDB/servers/administrators/read | MariaDB 서버 관리자의 목록을 가져옵니다. |
> | 작업 | Microsoft.DBforMariaDB/servers/administrators/write | 지정 된 매개 변수를 사용 하 여 MariaDB 서버 관리자를 만들거나 업데이트 합니다. |
> | Action | Microsoft.DBforMariaDB/servers/advisors/createRecommendedActionSession/action | 새 권장 구성 작업 세션을 만듭니다. |
> | 작업 | Microsoft.DBforMariaDB/servers/advisors/read | 관리자 목록을 반환합니다. |
> | Action | Microsoft.DBforMariaDB/servers/advisors/read | Advisor 반환 |
...
> | Action | Microsoft.DBforMariaDB/servers/databases/read | 반환 된 데이터베이스에 대 한 속성을 가져오거나 반환 합니다. |
> | Action | Microsoft.DBforMariaDB/servers/databases/write | 지정 된 매개 변수를 사용 하 여, 지정 된 데이터베이스에 대 한 속성을 업데이트 하는에 대 한 속성을 업데이트 합니다. |
...
> | Action | Microsoft.DBforMariaDB/servers/firewallRules/read | 서버에 대한 방화벽 규칙 목록을 반환하거나 지정된 방화벽 규칙에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforMariaDB/servers/providers/Microsoft.Insights/diagnosticSettings/write | 리소스에 대한 진단 설정을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.DBforMariaDB/servers/queryTexts/action | 쿼리 목록의 텍스트 반환 |
...
> | Action | Microsoft.DBforMariaDB/servers/securityAlertPolicies/write | 지정된 서버에 대한 서버 위협 검색 정책을 변경합니다. |
> | 작업 | Microsoft.DBforMariaDB/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
> | Action | Microsoft.DBforMariaDB/servers/topQueryStatistics/read | 쿼리 통계 반환 |
...
> | Action | Microsoft.DBforMySQL/servers/advisors/recommendedActions/read | 권장 작업 반환 |
...
> | Action | Microsoft.DBforMySQL/servers/providers/Microsoft.Insights/metricDefinitions/read | 데이터베이스에 사용할 수 있는 메트릭 형식을 반환합니다. |
> | Action | Microsoft.DBforMySQL/servers/queryTexts/action | 쿼리 목록의 텍스트 반환 |
...
> | Action | Microsoft.DBforMySQL/servers/restart/action | 특정 서버를 다시 시작 합니다. |
...
> | Action | Microsoft.DBforMySQL/servers/topQueryStatistics/read | 최상위 쿼리에 대한 쿼리 통계 목록을 반환합니다. |
...
> | Action | Microsoft.DBforMySQL/servers/waitStatistics/read | 인스턴스에 대한 대기 통계를 반환합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/locations/azureAsyncOperation/read | PostgreSQL 서버 작업 결과 반환 |
...
> | Action | DBforPostgreSQL/위치/privateEndpointConnectionOperationResults/읽기 | 개인 끝점 연결 작업에 대 한 결과를 가져옵니다. |
...
> | Action | Microsoft.DBforPostgreSQL/locations/securityAlertPoliciesOperationResults/read | 서버 위협 검색 작업 결과의 목록을 반환 합니다. |
> | Action | Microsoft.DBforPostgreSQL/operations/read | PostgreSQL 작업의 목록을 반환 합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/servers/databases/delete | 기존 PostgreSQL 데이터베이스를 삭제 합니다. |
> | Action | Microsoft.DBforPostgreSQL/servers/databases/read | PostgreSQL 데이터베이스의 목록을 반환 하거나 지정 된 데이터베이스에 대 한 속성을 가져옵니다. |
> | Action | Microsoft.DBforPostgreSQL/servers/databases/write | 지정 된 매개 변수를 사용 하 여 PostgreSQL 데이터베이스를 만들거나 지정 된 데이터베이스에 대 한 속성을 업데이트 합니다. |
...
> | Action | Microsoft.DBforPostgreSQL/servers/read | 서버 목록을 가져오거나 지정된 서버에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.DBforPostgreSQL/serversv2/configurations/write | 지정된 구성의 값을 업데이트합니다. |
> | 작업 | Microsoft.DBforPostgreSQL/serversv2/delete | 기존 서버를 삭제합니다. |
> | Action | Microsoft.DBforPostgreSQL/serversv2/firewallRules/delete | 기존 방화벽 규칙을 삭제합니다. |
...
> | 액션(Action) | Microsoft.Devices/operationresults/Read | 작업 결과 가져오기 |
...
> | 작업 | Microsoft.DevTestLab/labs/ExportResourceUsage/action | 랩 리소스 사용량을 저장소 계정으로 내보냅니다. |
...
> | 작업 | Microsoft.DevTestLab/labs/idleShutdowns/delete | 유휴 종료를 삭제 합니다. |
> | Action | Microsoft.DevTestLab/labs/idleShutdowns/read | 유휴 종료를 읽습니다. |
> | 작업 | Microsoft.DevTestLab/labs/idleShutdowns/write | 유휴 종료를 추가 하거나 수정 합니다. |
...
> | Action | Microsoft.DevTestLab/labs/read | 랩을 읽습니다. |
...
> | Action | Microsoft.DevTestLab/labs/virtualMachines/read | 가상 머신을 읽습니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/delete | 컬렉션을 삭제 합니다. API 형식에만 적용 됩니다. ' mongodb '. |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' mongodb '. |
...
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/delete | 그래프를 삭제 합니다. API 형식에만 적용 됩니다. ' gremlin'. |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' gremlin'. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/databases/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Sql ', ' mongodb ', ' gremlin' API 유형에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/read | Keyspace을 읽거나 모든 keyspaces를 나열 합니다. API 형식에만 적용 됩니다. ' cassandra '. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/read | Keyspace 처리량을 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. |
...
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/read | 테이블 처리량을 읽습니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/write | 테이블 처리량을 업데이트 합니다. API 형식에만 적용 됩니다. ' cassandra '. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
...
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/tables/delete | 테이블을 삭제합니다. ' Table ' API 유형에만 적용 됩니다. |
> | 작업 | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Table ' API 유형에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/tables/read | 테이블을 읽거나 모든 테이블을 나열 합니다. ' Table ' API 유형에만 적용 됩니다. |
> | Action | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/operationResults/read | 비동기 작업의 상태를 읽습니다. ' Table ' API 유형에만 적용 됩니다. 설정 유형 (' 처리량 ')에만 적용 됩니다. |
...
> | Action | Microsoft.DocumentDB/databaseAccounts/listConnectionStrings/action | 데이터베이스 계정에 대한 연결 문자열을 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.EventGrid/domains/delete | 도메인을 삭제합니다. |
...
> | Action | Microsoft.EventGrid/domains/write | 도메인을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.EventGrid/register/action | EventGrid 리소스 공급자에 대한 구독을 등록합니다. |
> | Action | Microsoft.EventGrid/topics/delete | 항목 삭제 |
> | 액션(Action) | Microsoft.EventGrid/topics/listKeys/action | 토픽에 대한 키를 나열합니다. |
> | Action | Microsoft.EventGrid/topics/providers/Microsoft.Insights/diagnosticSettings/read | 토픽에 대한 진단 설정을 가져옵니다. |
...
> | Action | Microsoft.EventGrid/topictypes/eventtypes/read | topictype에서 지원하는 eventtype을 읽습니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.EventHub/availableClusterRegions/read | Azure 지역에서 사용 가능한 미리 프로 비전 된 클러스터를 나열 하는 읽기 작업입니다. |
...
> | Action | Microsoft.EventHub/clusters/namespaces/read | 클러스터 내의 네임 스페이스에 대 한 네임 스페이스 ARM Id를 나열 합니다. |
> | Action | Microsoft.EventHub/clusters/operationresults/read | 비동기 클러스터 작업의 상태를 가져옵니다. |
...
> | Action | Microsoft. EventHub/네임 스페이스/networkruleset 집합/쓰기 | VNET 규칙 리소스 만들기 |
...
> | Action | Microsoft.EventHub/namespaces/operationresults/read | 네임스페이스 작업의 상태를 가져옵니다. |
...
> | Action | Microsoft.EventHub/namespaces/virtualNetworkRules/write | VNET 규칙 리소스 만들기 |
> | Action | Microsoft.EventHub/namespaces/write | 네임스페이스 리소스를 만들고 해당 속성을 업데이트합니다. 네임스페이스의 태그 및 용량은 업데이트할 수 있는 속성입니다. |
...
> | Action | Microsoft.GuestConfiguration/guestConfigurationAssignments/write | 새 게스트 구성 할당을 만듭니다. |
> | Action | Microsoft.GuestConfiguration/register/action | GuestConfiguration 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | Action | Microsoft.IoTCentral/register/action | Azure IoT Central 리소스 공급자에 대한 구독 등록 |
...
> | Action | Microsoft.IoTSpaces/Graph/read | Microsoft.IoTSpaces Graph 리소스를 가져오기 |
> | Action | Microsoft.IoTSpaces/Graph/write | Microsoft.IoTSpaces Graph 리소스를 만들기 |
> | Action | Microsoft.IoTSpaces/register/action | 리소스를 만들 수 있게 설정하려면 Microsoft.IoTSpaces Graph 리소스 공급자에 대한 구독을 등록하세요. |
...
> | Action | Microsoft.KeyVault/vaults/eventGridFilters/write | Key Vault에 대한 새 EventGrid 구독이 생성됨을 Microsoft.KeyVault에 알립니다. |
> | Action | Microsoft.KeyVault/vaults/read | Key Vault의 속성을 봅니다. |
...
> | Action | Microsoft.KeyVault/vaults/write | 새 Key Vault를 만들거나 기존 Key Vault의 속성을 업데이트합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.Kusto/Clusters/Activate/action | 클러스터를 시작 합니다. |
> | Action | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/delete | 연결 된 데이터베이스 구성 리소스를 삭제 합니다. |
> | Action | Microsoft.Kusto/Clusters/AttachedDatabaseConfigurations/read | 연결 된 데이터베이스 구성 리소스를 읽습니다. |
...
> | Action | Microsoft.Kusto/Clusters/Databases/DataConnectionValidation/action | 데이터베이스 데이터 연결의 유효성을 검사 합니다. |
...
> | Action | Microsoft.Kusto/Clusters/Databases/EventHubConnections/write | 이벤트 허브 연결 리소스를 씁니다. |
> | 작업 | Microsoft.Kusto/Clusters/Databases/EventHubConnectionValidation/action | 데이터베이스 이벤트 허브 연결의 유효성을 검사 합니다. |
> | Action | Microsoft.Kusto/Clusters/Databases/ListPrincipals/action | 데이터베이스 보안 주체를 나열 합니다. |
> | 작업 | Microsoft.Kusto/Clusters/Databases/read | 데이터베이스 리소스를 읽습니다. |
> | Action | Microsoft.Kusto/Clusters/Databases/RemovePrincipals/action | 데이터베이스 보안 주체를 제거 합니다. |
...
> | Action | Microsoft.Kusto/Clusters/SKUs/read | 클러스터 SKU 리소스를 읽습니다. |
> | Action | Microsoft.Kusto/Clusters/Start/action | 클러스터를 시작 합니다. |
> | Action | Microsoft.Kusto/Clusters/Stop/action | 클러스터를 중지 합니다. |
...
> | Action | Microsoft. 서비스/랩 계정/idleShutdowns/삭제 | Idleshutdowns를 삭제 합니다. |
> | 작업 | Microsoft. 서비스/랩 계정/idleShutdowns/읽기 | Idleshutdowns을 읽습니다. |
...
> | Action | Microsoft.LabServices/labAccounts/labs/environmentSettings/environments/ResetPassword/action | 환경의 사용자 암호 다시 설정 |
...
> | Action | Microsoft.LabServices/labAccounts/labs/environmentSettings/schedules/read | 일정을 읽습니다. |
...
> | Action | Microsoft.LabServices/labAccounts/labs/environmentSettings/write | 환경 설정을 추가하거나 수정합니다. |
...
> | Action | Microsoft.LabServices/labAccounts/sharedGalleries/write | sharedgalleries를 추가 또는 수정합니다. |
> | Action | Microsoft.LabServices/labAccounts/sharedImages/delete | sharedimages를 삭제합니다. |
...
> | 작업 | Microsoft.LabServices/users/ListEnvironments/action | 사용자에 대한 환경을 나열합니다. |
...
> | Action | Microsoft.Logic/integrationServiceEnvironments/read | 통합 서비스 환경을 읽습니다. |
...
> | Action | Microsoft.Logic/locations/workflows/validate/action | 워크플로의 유효성을 검사합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.MachineLearningServices/locations/computeoperationsstatus/read | 특정 컴퓨팅 작업의 상태를 가져옵니다. |
...
> | Action | Microsoft.MachineLearningServices/workspaces/computes/listNodes/action | Machine Learning Services 작업 영역의 컴퓨팅 리소스에 대한 노드를 나열합니다. |
> | Action | Microsoft.MachineLearningServices/workspaces/computes/read | Machine Learning Services 작업 영역에서 컴퓨팅 리소스를 가져옵니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.managedidentity/id/읽기 | 기존 시스템 할당 id를 가져옵니다. |
...
> | Action | Microsoft ManagedServices/operationStatuses/읽기 | 리소스의 작업 상태를 읽습니다. |
...
> | 작업 | Microsoft ManagedServices/registrationAssignments/write | 관리 서비스 등록 할당을 추가하거나 수정합니다. |
> | Action | Microsoft ManagedServices/registrationDefinitions/삭제 | 관리 서비스 등록 정의를 제거합니다. |
> | Action | Microsoft ManagedServices/registrationDefinitions/읽기 | 관리 서비스 등록 정의 목록을 검색합니다. |
> | Action | Microsoft ManagedServices/registrationDefinitions/쓰기 | 관리 서비스 등록 정의를 추가하거나 수정합니다. |
> | Action | Microsoft ManagedServices/등록 취소/작업 | 관리 서비스에서 등록을 취소 합니다. |
...
> | Action | Microsoft.Maps/register/action | 공급자를 등록합니다. |
...
> | Action | Microsoft.Marketplace/register/action | 구독에서 Microsoft.Marketplace 리소스 공급자를 등록합니다. |
...
> | Action | Microsoft.Media/mediaservices/eventGridFilters/delete | 모든 Event Grid 필터를 삭제합니다. |
...
> | Action | Microsoft.Migrate/assessmentprojects/groups/assessments/downloadurl/action | 평가 보고서의 URL 다운로드 |
...
> | 작업 | Microsoft.Migrate/assessmentprojects/groups/read | 그룹의 속성 가져오기 |
> | 작업 | Microsoft.Migrate/assessmentprojects/groups/updateMachines/action | 컴퓨터를 추가 또는 제거 하 여 그룹 업데이트 |
> | Action | Microsoft.Migrate/assessmentprojects/groups/write | 새 그룹을 만들거나 기존 그룹 업데이트 |
...
> | 작업 | Microsoft.Migrate/assessmentprojects/machines/read | 머신의 속성 가져오기 |
> | Action | Microsoft.Migrate/assessmentprojects/read | 평가 프로젝트의 속성을 가져옵니다. |
...
> | 작업 | Microsoft.Migrate/migrateprojects/machines/read | 머신의 속성 가져오기 |
> | Action | Microsoft.Migrate/migrateprojects/MigrateEvents/Delete | 마이그레이션 이벤트를 삭제 합니다. |
...
> | Action | Microsoft.Migrate/migrateprojects/solutions/cleanupData/action | 프로젝트 솔루션 데이터 마이그레이션 정리 |
...
> | 동작 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.MixedReality/register/action | Mixed Reality 리소스 공급자에 대 한 구독을 등록 합니다. |
...
> | Action | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/delete | 볼륨 리소스를 삭제합니다. |
...
> | Action | Microsoft.NetApp/netAppAccounts/capacityPools/volumes/snapshots/read | 스냅샷 리소스를 읽습니다. |
...
> | Action | Microsoft.Network/applicationGateways/start/action | Application Gateway를 시작합니다. |
...
> | Action | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/delete | Application Gateway WAF 정책을 삭제 합니다. |
> | 작업 | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/read | Application Gateway WAF 정책을 가져옵니다. |
> | Action | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/write | Application Gateway WAF 정책을 만들거나 Application Gateway WAF 정책을 업데이트 합니다. |
...
> | Action | Microsoft.Network/ddosCustomPolicies/read | DDoS 사용자 지정 정책 정의 가져오기 |
...
> | 작업 | Microsoft.Network/expressRouteCircuits/peerings/arpTables/action | ExpressRouteCircuit Peering ArpTable을 가져옵니다. |
...
> | Action | Microsoft.Network/expressRouteCrossConnections/join/action | Express 경로 교차 연결을 조인 합니다. 했어야 하지 않습니다. |
> | 작업 | Microsoft.Network/expressRouteCrossConnections/peerings/arpTables/action | Express Route 교차 연결 피어링 Arp 테이블을 가져옵니다. |
...
> | Action | Microsoft. Network/firewallPolicies/delete | 방화벽 정책을 삭제 합니다. |
> | Action | Microsoft. Network/firewallPolicies/join/action | 방화벽 정책을 조인 합니다. 했어야 하지 않습니다. |
> | Action | Microsoft. Network/firewallPolicies/read | 방화벽 정책을 가져옵니다. |
...
> | Action | Microsoft.Network/frontDoors/delete | Front Door 삭제 |
...
> | Action | Microsoft.Network/frontDoors/frontendEndpoints/enableHttps/action | 프런트 엔드 엔드포인트에서 HTTPS를 사용하도록 설정 |
> | Action | Microsoft.Network/frontDoors/frontendEndpoints/read | 프런트 엔드 엔드포인트 가져오기 |
...
> | Action | Microsoft.Network/frontDoors/loadBalancingSettings/read | 부하 분산 설정 가져오기 |
> | 작업 | Microsoft.Network/frontDoors/loadBalancingSettings/write | 부하 분산 설정을 만들거나 업데이트 |
> | Action | Microsoft.Network/frontDoors/purge/action | Front Door에서 캐시된 콘텐츠 제거 |
> | Action | Microsoft.Network/frontDoors/read | Front Door 가져오기 |
...
> | Action | Microsoft.Network/frontDoors/validateCustomDomain/action | Front Door에 대한 프런트 엔드 엔드포인트 유효성 검사 |
...
> | Action | Microsoft.Network/frontDoorWebApplicationFirewallPolicies/write | 웹 애플리케이션 방화벽 정책을 만들거나 업데이트 |
...
> | Action | Microsoft.Network/loadBalancers/inboundNatPools/read | 부하 분산 장치 인바운드 NAT 풀 정의를 가져옵니다. |
...
> | Action | Microsoft.Network/loadBalancers/probes/read | 부하 분산 장치 프로브를 가져옵니다. |
> | Action | Microsoft.Network/loadBalancers/read | 부하 분산 장치 정의를 가져옵니다. |
...
> | Action | Microsoft.Network/locations/availableDelegations/read | 사용 가능한 위임을 가져옵니다. |
> | Action | Microsoft.Network/locations/availablePrivateEndpointTypes/read | 사용 가능한 개인 끝점 리소스를 가져옵니다. |
> | Action | Microsoft.Network/locations/bareMetalTenants/action | 운영 체제 미 설치 컴퓨터 테넌트를 할당하거나 유효성을 검사합니다. |
...
> | Action | Microsoft.Network/locations/virtualNetworkAvailableEndpointServices/read | 사용 가능한 가상 네트워크 엔드포인트 서비스 목록을 가져옵니다. |
...
> | Action | Microsoft.Network/networkInterfaces/tapConfigurations/delete | 네트워크 인터페이스 탭 구성을 삭제합니다. |
...
> | Action | Microsoft.Network/p2sVpnGateways/getp2svpnconnectionhealth/action | P2SVpnGateway에 대한 P2S Vpn 연결 상태를 가져옵니다. |
...
> | Action | Microsoft.Network/privateDnsZones/A/write | 사설 DNS 영역 내에서 ' A ' 형식의 레코드 집합을 만들거나 업데이트 합니다. 지정된 레코드는 레코드 집합의 현재 레코드를 대체합니다. |
> | 작업 | Microsoft.Network/privateDnsZones/AAAA/delete | 사설 DNS 영역에서 지정 된 이름의 레코드 집합 및 ' AAAA ' 형식을 제거 합니다. |
> | Action | Microsoft.Network/privateDnsZones/AAAA/read | JSON 형식의 사설 DNS 영역 내에서 ' AAAA ' 형식의 레코드 집합을 가져옵니다. 레코드 집합에는 TTL, 태그 및 etag 뿐만 아니라 레코드 목록도 포함됩니다. |
...
> | Action | Microsoft.Network/privateDnsZones/delete | 사설 DNS 영역을 삭제 합니다. |
...
> | Action | Microsoft.Network/privateDnsZones/PTR/delete | 사설 DNS 영역에서 지정 된 이름 및 ' PTR ' 형식의 레코드 집합을 제거 합니다. |
...
> | Action | Microsoft.Network/privateDnsZones/virtualNetworkLinks/delete | 가상 네트워크에 대 한 사설 DNS 영역 링크를 삭제 합니다. |
> | 작업 | Microsoft.Network/privateDnsZones/virtualNetworkLinks/read | JSON 형식의 가상 네트워크 속성에 대 한 사설 DNS 영역 링크를 가져옵니다. |
> | Action | Microsoft.Network/privateDnsZones/virtualNetworkLinks/write | 가상 네트워크에 대 한 사설 DNS 영역 링크를 만들거나 업데이트 합니다. |
...
> | Action | Microsoft.Network/privateEndpoints/read | 개인 끝점 리소스를 가져옵니다. |
...
> | Action | Microsoft.Network/routeTables/delete | 경로 테이블 정의를 삭제합니다. |
...
> | Action | Microsoft.Network/serviceEndpointPolicies/read | 서비스 엔드포인트 정책 설명을 가져옵니다. |
...
> | Action | Microsoft.Network/virtualNetworkGateways/read | VirtualNetworkGateway를 가져옵니다. |
...
> | Action | Microsoft.Network/virtualNetworks/bastionHosts/default/action | Virtual Network의 요새 호스트 참조를 가져옵니다. |
...
> | 작업 | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | 저장소 계정 또는 SQL 데이터베이스 같은 리소스를 서브넷에 조인합니다. 했어야 하지 않습니다. |
> | Action | Microsoft.Network/virtualNetworks/subnets/prepareNetworkPolicies/action | 필요한 네트워크 정책을 적용하여 서브넷을 준비합니다. |
...
> | Action | Microsoft.Network/virtualNetworks/usages/read | 가상 네트워크의 각 서브넷에 대한 IP 사용량을 가져옵니다. |
...
> | Action | Microsoft.network/virtualWans/p2sVpnServerConfigurations/delete | 가상 Wan P2SVpnServerConfiguration을 삭제합니다. |
...
> | 작업 | Microsoft.OffAzure/HyperVSites/machines/start/action | Hyper-V 머신을 시작합니다. |
> | 작업 | Microsoft.OffAzure/HyperVSites/machines/stop/action | Hyper-V 머신을 중지합니다. |
...
> | Action | microsoft.operationalinsights/register/action | 구독을 Rergisters 합니다. |
> | Action | Microsoft.OperationalInsights/register/action | 리소스 공급자에 구독을 등록합니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/AADDomainServicesDirectoryServiceAccess/read | AADDomainServicesDirectoryServiceAccess 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/ADFPipelineRun/read | ADFPipelineRun 테이블에서 데이터를 읽습니다. |
> | Action | Microsoft.OperationalInsights/workspaces/query/ADFTriggerRun/read | ADFTriggerRun 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/AzureActivity/read | AzureActivity 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/DatabricksNotebook/read | DatabricksNotebook 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/DatabricksWorkspace/read | DatabricksWorkspace 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/HuntingBookmark/read | HuntingBookmark 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/InsightsMetrics/read | InsightsMetrics 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MADevicePnPHealth/read | MADevicePnPHealth 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppReadiness/read | MAOfficeAppReadiness 테이블에서 데이터를 읽습니다. |
> | Action | Microsoft.OperationalInsights/workspaces/query/MAOfficeAppSessionsNRT/read | MAOfficeAppSessionsNRT 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MAOfficeMacroHealth/read | MAOfficeMacroHealth 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MAWindowsDeploymentStatusNRT/read | MAWindowsDeploymentStatusNRT 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/MicrosoftWebFunctionExecutionLogs/read | MicrosoftWebFunctionExecutionLogs 테이블에서 데이터를 읽습니다. |
> | Action | Microsoft.OperationalInsights/workspaces/query/MicrosoftWebStdOutStdErrLog/read | MicrosoftWebStdOutStdErrLog 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/read | 작업 영역의 데이터에서 쿼리를 실행 |
> | Action | Microsoft.OperationalInsights/workspaces/query/ReservedAzureCommonFields/read | ReservedAzureCommonFields 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/SigninLogs/read | SigninLogs 테이블에서 데이터 읽기 |
> | Action | Microsoft.OperationalInsights/workspaces/query/SPAssessmentRecommendation/read | SPAssessmentRecommendation 테이블에서 데이터를 읽습니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/query/UAApp/read | UAApp 테이블에서 데이터를 읽습니다. |
...
> | Action | microsoft.operationalinsights/workspaces/savedsearches/results/read | 저장된 검색 결과를 가져옵니다. 사용되지 않음 |
> | Action | microsoft.operationalinsights/workspaces/savedsearches/schedules/actions/delete | 예약된 검색 작업을 삭제합니다. |
...
> | Action | microsoft.operationalinsights/workspaces/savedsearches/schedules/read | 예약된 검색을 가져옵니다. |
...
> | Action | Microsoft.OperationalInsights/workspaces/upgradetranslationfailures/read | 작업 영역에 대한 검색 업그레이드 변환 오류 로그를 가져옵니다. |
> | 작업 | Microsoft.OperationalInsights/workspaces/usages/read | 작업 영역에서 읽는 데이터 양을 포함하여 작업 영역에 대한 사용 현황 데이터를 가져옵니다. |
...
> | Action | Microsoft.Portal/consoles/write | Cloud Shell 인스턴스를 만들거나 업데이트합니다. |
> | Action | Microsoft.Portal/dashboards/delete | 구독에서 대시보드를 제거합니다. |
...
> | 액션 유형 | 작업(Operation) | 설명 |
> | --- | --- | --- |
> | Action | Microsoft.PowerBIDedicated/capacities/delete | Power BI 전용 용량을 삭제합니다. |
...
> | Action | Microsoft.PowerBIDedicated/locations/operationresults/read | 지정된 작업 결과에 대한 정보를 검색합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupEngines/read | 자격 증명 모음에 등록된 모든 백업 관리 서버를 반환합니다. |
...
> | 작업 | microsoft.recoveryservices/Vaults/backupFabrics/operationResults/read | 작업 상태를 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectableContainers/read | 보호 가능한 컨테이너를 모두 가져옵니다. |
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/delete | 등록된 컨테이너를 삭제합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/protectedItems/operationResults/read | 보호 항목에 대해 수행된 작업의 결과를 가져옵니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/protectedItems/recoveryPoints/restore/action | 보호 항목의 복구 지점을 복원합니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/read | 등록된 모든 컨테이너를 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupFabrics/protectionContainers/write | 등록된 컨테이너를 만듭니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupOperations/read | Recovery Services 자격 증명 모음의 Backup 작업 상태를 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupPolicies/delete | 보호 정책을 삭제합니다. |
> | 작업 | microsoft.recoveryservices/Vaults/backupPolicies/operationResults/read | 정책 작업 결과를 가져옵니다. |
> | Action | microsoft.recoveryservices/Vaults/backupPolicies/operations/read | 정책 작업의 상태를 가져옵니다. |
...
> | Action | microsoft.recoveryservices/Vaults/backupProtectableItems/read | 모든 보호 가능한 항목 목록을 반환합니다. |
> | 작업 | microsoft.recoveryservices/Vaults/backupProtectedItems/read | 모든 보호 항목 목록을 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupProtectionContainers/read | 구독 항목에 속하는 컨테이너를 모두 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupProtectionIntents/read | 모든 백업 보호 의도를 나열합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupSecurityPIN/action | Recovery Services 자격 증명 모음에 대한 보안 PIN 정보를 반환합니다. |
> | 작업 | microsoft.recoveryservices/Vaults/backupstorageconfig/read | Recovery Services 자격 증명 모음에 대한 저장소 구성을 반환합니다. |
> | 작업 | microsoft.recoveryservices/Vaults/backupstorageconfig/write | Recovery Services 자격 증명 모음에 대한 저장소 구성을 업데이트합니다. |
> | 작업 | microsoft.recoveryservices/Vaults/backupUsageSummaries/read | Recovery Services의 보호된 항목 및 보호된 서버에 대한 요약을 반환합니다. |
> | Action | microsoft.recoveryservices/Vaults/backupValidateOperation/action | 보호된 항목에 대한 작업의 유효성을 검사합니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/migrate/action | 마이그레이션 항목 |
> | Action | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/migrationRecoveryPoints/read | 마이그레이션 복제 복구 지점을 읽습니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/testMigrate/action | 테스트 마이그레이션 |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationMigrationItems/write | 마이그레이션 항목을 만들거나 업데이트합니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/removeDisks/action | 디스크 제거 |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationMigrationItems/read | 마이그레이션 항목을 읽습니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationUsages/read | 자격 증명 모음 복제 사용 현황을 읽습니다. |
...
> | Action | Microsoft.RecoveryServices/vaults/replicationVaultSettings/read | 모든 항목을 읽습니다.  |
...
> | Action | Microsoft.Relay/namespaces/authorizationRules/action | 네임스페이스 권한 부여 규칙을 업데이트합니다. 이 API는 더 이상 사용되지 않습니다. 그 대신 PUT 호출을 사용하여 네임스페이스 권한 부여 규칙을 업데이트하세요. 이 작업은 API 버전 2017-04-01에서 지원되지 않습니다. |
...
> | Action | Microsoft.ResourceHealth/Operations/read | Microsoft ResourceHealth에 대해 사용 가능한 작업 가져오기 |
...
> | Action | Microsoft.Resources/tags/delete | 리소스의 모든 태그를 제거 합니다. |
...
> | Action | Microsoft.Search/searchServices/read | Search 서비스를 읽습니다. |
...
> | Action | Microsoft.Security/informationProtectionPolicies/write | 리소스에 대한 정보 보호 정책을 업데이트합니다. |
...
> | Action | Microsoft.ServiceBus/namespaces/ipFilterRules/read | IP 필터 리소스 가져오기 |
> | Action | Microsoft.ServiceBus/namespaces/ipFilterRules/write | IP 필터 리소스 만들기 |
> | DataAction | Microsoft.ServiceBus/namespaces/messages/browse/action | Messges 찾아보기 |
...
> | Action | Microsoft.ServiceBus/namespaces/networkrulesets/write | VNET 규칙 리소스 만들기 |
...
> | Action | Microsoft.SignalRService/SignalR/eventGridFilters/write | 지정 된 매개 변수를 사용 하 여 SignalR에 대 한 event grid 필터를 만들거나 업데이트 합니다. |
> | 작업 | Microsoft.SignalRService/SignalR/listkeys/action | 관리 포털에서 또는 API를 통해 SignalR 액세스 키 값을 봅니다. |
> | Action | Microsoft.SignalRService/SignalR/read | 관리 포털 또는 API를 통해 SignalR의 설정과 구성을 확인합니다. |
...
> | Action | Microsoft.Sql/instancePools/read | 인스턴스 풀을 가져옵니다. |
> | 작업 | Microsoft.Sql/instancePools/usages/read | 인스턴스 풀의 사용 정보를 가져옵니다. |
> | 작업 | Microsoft.Sql/instancePools/write | 인스턴스 풀을 만들거나 업데이트합니다. |
> | Action | Microsoft.Sql/locations/auditingSettingsAzureAsyncOperation/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
...
> | Action | Microsoft.Sql/locations/extendedAuditingSettingsAzureAsyncOperation/read | 확장된 서버 blob 감사 정책 집합 작업의 결과를 검색합니다. |
...
> | Action | Microsoft.Sql/locations/firewallRulesOperationResults/read | 방화벽 규칙 작업의 상태를 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/jobAgentAzureAsyncOperation/read | 작업 에이전트 작업의 상태를 가져옵니다. |
> | 작업 | Microsoft.Sql/locations/jobAgentOperationResults/read | 작업 에이전트 작업의 결과를 가져옵니다. |
> | Action | Microsoft.Sql/locations/longTermRetentionBackups/read | 위치에 있는 모든 서버의 모든 데이터베이스에 대한 장기 보존 백업을 나열합니다. |
...
> | Action | Microsoft.Sql/locations/managedInstanceKeyOperationResults/read | 투명 한 데이터 암호화 관리 되는 인스턴스 키에서 진행 중인 작업을 가져옵니다. |
> | Action | Microsoft.Sql/locations/managedTransparentDataEncryptionAzureAsyncOperation/read | 관리되는 데이터베이스 투명한 데이터 암호화에 대해 진행 중인 작업을 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/privateEndpointConnectionProxyOperationResults/read | 개인 끝점 연결 프록시 작업의 결과를 가져옵니다. |
...
> | Action | Microsoft.Sql/locations/serverKeyOperationResults/read | 투명 한 데이터 암호화 서버 키에 대 한 진행 중인 작업을 가져옵니다. |
...
> | Action | Microsoft.Sql/managedInstances/databases/currentSensitivityLabels/write | 일괄 업데이트 민감도 레이블 |
> | Action | Microsoft.Sql/managedInstances/databases/delete | 기존 관리되는 데이터베이스를 삭제합니다. |
...
> | Action | Microsoft.Sql/managedInstances/databases/recommendedSensitivityLabels/read | 지정된 데이터베이스의 민감도 레이블을 나열합니다. |
> | Action | Microsoft.Sql/managedInstances/databases/schemas/read | 관리 되는 데이터베이스 스키마를 가져옵니다. |
...
> | Action | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/write | 지정된 열의 민감도 레이블을 만들거나 업데이트합니다. |
> | Action | Microsoft.Sql/managedInstances/databases/schemas/tables/read | 관리 되는 데이터베이스 테이블 가져오기 |
...
> | Action | Microsoft.Sql/servers/databases/dataMaskingPolicies/read | 데이터베이스 데이터 마스킹 정책 목록을 반환합니다. |
...
> | Action | Microsoft.Sql/servers/databases/replicationLinks/delete | 잠재적 데이터 손실이 발생하는 상태로 강제로 복제 관계를 종료합니다. |
...
> | Action | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/disable/action | 지정 된 열에서 민감도 권장 사항을 사용 하지 않도록 설정 |
> | 작업 | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/enable/action | 지정 된 열에 대 한 민감도 권장 사항 사용 |
> | Action | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/read | 지정된 열의 민감도 레이블을 가져옵니다. |
...
> | Action | Microsoft.Sql/servers/databases/securityAlertPolicies/write | 지정된 데이터베이스에 대한 데이터베이스 위협 탐지 정책을 변경합니다. |
> | Action | Microsoft.Sql/servers/databases/securityMetrics/read | 데이터베이스 보안 메트릭 컬렉션을 가져옵니다. |
...
> | Action | Microsoft.Sql/servers/jobAgents/write | Azure SQL DB 작업 에이전트를 만들거나 업데이트합니다. |
...
> | Action | Microsoft.Sql/servers/privateEndpointConnectionProxies/delete | 기존 개인 끝점 연결 프록시를 삭제 합니다. |
> | Action | Microsoft.Sql/servers/privateEndpointConnectionProxies/read | 개인 끝점 연결 프록시의 목록을 반환 하거나, 지정 된 개인 끝점 연결 프록시에 대 한 속성을 가져옵니다. |
...
> | Action | Microsoft.Sql/servers/privateLinkResources/read | 해당 sql server에 대 한 개인 링크 리소스 가져오기 |
...
> | Action | Microsoft.Sql/virtualClusters/read | 가상 클러스터 목록을 반환하거나 지정된 가상 클러스터에 대한 속성을 가져옵니다. |
...
> | Action | Microsoft.Storage/storageAccounts/blobServices/containers/lease/action | Blob 컨테이너 임대 결과를 반환합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/blobServices/generateUserDelegationKey/action | Blob Service에 대한 사용자 위임 키를 반환합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/fileServices/read | 파일 서비스 속성 가져오기 |
> | 작업 | Microsoft.Storage/storageAccounts/listAccountSas/Action | 지정된 저장소 계정에 대한 계정 SAS 토큰을 반환합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/privateLinkResources/read | StorageAccount groupids 가져오기 |
> | Action | Microsoft.Storage/storageAccounts/queueServices/queues/delete | 큐 삭제 결과를 반환합니다. |
...
> | Action | Microsoft.Storage/storageAccounts/queueServices/read | 큐 서비스 속성 또는 통계를 반환합니다. |
...
> | 작업 | Microsoft.Storage/storageAccounts/revokeUserDelegationKeys/action | 지정된 저장소 계정에 대한 모든 사용자 위임 키를 취소합니다. |
...
> | 작업 | Microsoft.Storage/storageAccounts/write | 지정된 매개 변수를 사용하여 저장소 계정을 만들거나, 속성 또는 태그를 업데이트하거나, 지정된 저장소 계정의 사용자 지정 도메인을 추가합니다. |
...
> | Action | microsoft.storagesync/storageSyncServices/syncGroups/cloudEndpoints/postbackup/action | 백업 후 이 작업을 호출합니다. |
...
> | Action | Microsoft.StorSimple/managers/storageAccountCredentials/delete | Storage 계정 자격 증명을 삭제합니다. |
...
> | Action | microsoft.web/sites/hybridconnection/delete | Web Apps 하이브리드 연결을 삭제합니다. |
...
> | Action | microsoft.web/sites/instances/extensions/processes/read | Web Apps 인스턴스 확장 프로세스를 가져옵니다. |
> | Action | microsoft.web/sites/instances/extensions/read | Web Apps 인스턴스 확장을 가져옵니다. |
...
> | Action | Microsoft.Web/sites/PrivateEndpointConnectionsApproval/action | 개인 끝점 연결 승인 |
...
> | Action | microsoft.web/sites/slots/newpassword/action | Newpassword Web Apps 슬롯입니다. |
...
> | Action | microsoft.web/sites/slots/processes/read | Web Apps 슬롯 프로세스를 가져옵니다. |
...
> | Action | microsoft 웹/사이트/슬롯/restorefromdeletedapp/작업 | 삭제된 앱에서 웹앱 슬롯을 복원합니다. |
