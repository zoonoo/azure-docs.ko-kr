---
title: Azure CLI 스크립트 샘플 - 다중 계층 애플리케이션을 위한 가상 네트워크 만들기
...
---
# <a name="use-an-azure-cli-script-sample-to-create-a-network-for-multi-tier-applications"></a>Azure CLI 스크립트 샘플을 사용하여 다중 계층 애플리케이션을 위한 가상 네트워크 만들기
