---
title: Azure CLI 스크립트 샘플-네트워크 가상 어플라이언스를 통한 트래픽 라우팅
...
ms.locfileid: "87503840"
---
# <a name="use-an-azure-cli-script-to-route-traffic-through-a-network-virtual-appliance"></a>Azure CLI 스크립트를 사용 하 여 네트워크 가상 어플라이언스를 통해 트래픽을 라우팅합니다.
