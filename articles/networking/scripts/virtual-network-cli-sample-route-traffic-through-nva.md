...
ms.locfileid: "107763184"
---
# <a name="use-an-azure-cli-script-to-route-traffic-through-a-network-virtual-appliance"></a>Azure CLI 스크립트로 네트워크 가상 어플라이언스를 통한 트래픽 라우팅
