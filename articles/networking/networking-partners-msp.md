---
title: '네트워킹 파트너: Azure 네트워킹 | 마이크로 소프트 문서'
description: 이 문서에서는 MSP 네트워킹 파트너 의 목록을 제공합니다.
services: networking
author: skishen525
...
ms.locfileid: "81536610"
---
# <a name="about-azure-networking-msp-partners"></a>Azure 네트워킹 MSP 파트너 정보

[Azure 네트워킹 관리 형 서비스 공급자(MSP) 파트너 프로그램을](https://azure.microsoft.com/blog/enhancing-the-customer-experience-with-the-azure-networking-msp-partner-program/) 사용하면 네트워크 서비스 중심의 MSP, Telcos 및 시스템 통합업체(SIs)를 통해 Azure의 네트워킹 제품 및 서비스 포트폴리오를 중심으로 클라우드 및 하이브리드 네트워킹 서비스를 제공할 수 있습니다.

Azure 네트워킹 MSP는 클라우드 및 하이브리드 네트워킹의 모든 측면에서 엔터프라이즈 클라우드 네트워킹 요구 사항과 과제를 해결하는 특수 관리형 서비스 공급자 집합입니다. 관리되는 네트워크 서비스에는 네트워크 아키텍처, 계획, 배포, 운영, 유지 관리 및 최적화와 같은 서비스 중 하나 이상이 포함됩니다.

![Msp][0]

고객은 Azure 마켓플레이스에서 또는 MSP에서 직접 MSP 관리 서비스 오퍼를 구입할 수 있습니다. MSP는 [Azure 등대](https://azure.microsoft.com/services/azure-lighthouse/)를 사용하여 고객의 구독 및 리소스 그룹에 Azure 네트워킹 리소스를 배포하고 관리할 수 있습니다.

## <a name="azure-marketplace-offers-by-azure-networking-msp-partners"></a><a name="msp"></a>Azure 네트워킹 MSP 파트너의 Azure 마켓플레이스 제공

Azure 네트워킹 MSP 파트너가 제공하는 관리형 클라우드 네트워킹 서비스에 대한 자세한 내용은 이 섹션의 링크를 참조하십시오. 클라우드 네트워크 서비스 파트너가 아래 섹션에 나열되지 않은 경우 공급자에게 문의하십시오. ManagedVirtualWAN@microsoft.com으로 이메일을 전송하여 연락할 수 있습니다. 

| **Msp** | **클라우드 네트워크 혁신 서비스** | **관리되는 익스프레스루트** | **관리되는 가상 WAN** |
| ---| ---| ---| ---|
...
|[Tata Communications](https://www.tatacommunications.com/about/our-alliances/microsoft-alliance/)||[관리되는 Azure 익스프레스루트](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/tata_communications.managed_expressroute?tab=Overview)|[관리되는 가상 WAN](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/tata_communications.managed_azure_vwan_for_sdwan?tab=Overview)|||
|[방심IT](https://vigilant.it/manage-cloud-service/)|[Azure 상태 확인: 5일 평가](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/vigilant-it.ahc01)|[익스프레스루트: 5일 구현](https://azuremarketplace.microsoft.com/en-us/marketplace/consulting-services/vigilant-it.erd01)|||
|[반디스 (주)](https://www.vandis.com/microsoft-azure-practice/)||[반디스 관리 익스프레스루트](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_expressroute?tab=Overview)|[반디스 는 포르티트에 의해 구동 VWAN 관리;](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_vwan_powered_by_fortinet?tab=Overview) [팔로 알토 네트웍스로 구동되는 반디스 관리 VWAN](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/vandis.vandis_managed_vwan_powered_by_palo_alto_networks?tab=Overview)|

다음 Azure 네트워킹 MSP 파트너의 새로운 관리되는 보안 서비스 및 관리되는 MEC 서비스를 포함한 Azure Marketplace 의 제안은 [로드맵에](https://www.amdocs.com/)있습니다. [AXESDN;](https://www.axesdn.com/en/azure-msp.html) [센추리링크;](https://www.centurylink.com/business/networking/cloud-connectivity.html)    [IX 도달](https://www.ixreach.com/services/sdn-cloud-connect/)범위;  [인터 클라우드;](https://intercloud.com/partners/microsoft-azure/)  [킨크스;](https://www.kinx.net/service/cloud/?lang=en) [메가 포트;](https://www.megaport.com/services/microsoft-expressroute/)  [옴니 클라우드](https://omniclouds.com/services/);  [세종텔레콤;](https://www.sejongtelecom.net/en/pages/service/cloud_ms)  [테크 마히드라;](https://networkservices.techmahindra.com/pages/default.aspx) [페더레이션 무선](https://www.federatedwireless.com/caas/)

## <a name="expressroute-partners"></a><a name="expressroute"></a>익스프레스루트 파트너

파트너에 대한 자세한 내용은 [ExpressRoute 파트너 및 위치를](../expressroute/expressroute-locations-providers.md)참조하십시오.

## <a name="virtual-wan-partners"></a><a name="vwan"></a>Virtual WAN 파트너

파트너에 대한 자세한 내용은 [가상 WAN 파트너 및 공급자를](../virtual-wan/virtual-wan-locations-partners.md)참조하십시오.
