...
[Azure 기계 학습을 사용한 예측 솔루션 개발][Azure 기계 학습을 사용한 예측 솔루션 개발] 자습서의 첫 번째 단계입니다.
...
# 1단계: Azure Machine Learning 작업 영역 만들기
...
**다음: [기존 데이터 업로드][기존 데이터 업로드]**
  ...
  [작업 영역 만들기]: ./media/machine-learning-walkthrough-1-create-ml-workspace/create1.png
