...
[![Azure Notebooks 내 프로젝트 대시보드](media/my-projects-dashboard.png)](media/my-projects-dashboard.png#lightbox)
...
프로젝트 ID도 프로젝트 URL의 일부 이므로 ad 차단기 소프트웨어는 특정 키워드 (예: "보급")의 사용을 차단할 수 있습니다. 이러한 경우 프로젝트 ID에 다른 단어를 사용 합니다.
