---
title: Azure 노트북 미리 보기에 슬라이드쇼로 Jupyter 노트북 표시
description: Jupyter 노트북에서 슬라이드쇼 모드용 셀을 구성한 다음 RISE 확장을 사용하여 슬라이드쇼를 표시하는 방법을 알아봅니다.
ms.topic: how-to
ms.date: 12/04/2018
...
---
# <a name="run-a-notebook-slideshow-in-azure-notebooks-preview"></a>Azure 노트북 미리 보기에서 노트북 슬라이드쇼 실행
...
1. 코드 셀에서 재생 단추를 사용하여 코드를 실행하면 출력이 슬라이드에 표시됩니다.
    ...
    > [!Tip]
    > 슬라이드 쇼에서 셀 출력은 셀의 일부로 간주됩니다. Notebook 또는 슬라이드 쇼 보기에서 셀을 실행하는 경우 출력은 다른 보기에서도 나타납니다. 출력을 지우려면 **셀** > **전류 출력** > **지우기** 명령(현재 셀의 경우) 또는 **셀** > 모든 출력**지우기(모든** 셀에 대해)를**All Outputs** > 사용합니다.
