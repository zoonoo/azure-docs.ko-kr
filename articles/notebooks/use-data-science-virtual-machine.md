...
파일 시스템 액세스는 DSVM 버전 19.06.15 이상에서 지원 됩니다. 버전을 확인 하려면 먼저 SSH를 통해 DSVM에 연결한 후 다음 명령을 실행 합니다. `curl -H Metadata:true "http://169.254.169.254/metadata/instance?api-version=2018-10-01"` (여기에 표시 된 정확한 IP 주소를 사용 해야 합니다.) 버전 번호는 "버전"에 대 한 출력에 표시 됩니다.
