<properties title="Azure Machine Learning Sample: Credit risk prediction" pageTitle="기계 학습 샘플: 신용 위험 예측 | Azure" description="신청자의 신용 위험이 낮은지 또는 높은지를 예측하는 이진 분류 모델을 개발할 샘플 Azure 기계 학습 실험입니다." metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="garye" manager="paulettm" editor="cgronlun"  videoId="" scriptId="" />
...
*이 실험의 간소화된 버전을 만들고 사용하는 방법에 대한 자세한 연습은 [Azure 기계 학습을 사용하여 예측 솔루션 개발](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-walkthrough-develop-predictive-solution/)(영문)을 참조하세요.*
...
이 웹 사이트의 german.data 파일을 사용합니다.
