...
<!-- Legacy MSDN URL = https://msdn.microsoft.com/ko-KR/library/azure/dn268600.aspx -->
...
* 글로벌 Azure 플랫폼을 사용하려는 경우 **Active Set**(활성 설정) 드롭다운 목록에서 **windowsazure.com**을 선택하고 **확인**을 클릭합니다.
...
* 개인 Azure 플랫폼을 사용하려면:
    ...
    6. **Active Set**(활성 설정) 드롭다운 목록에서 만들어진 활성 설정을 선택하고**확인**을 클릭합니다.
