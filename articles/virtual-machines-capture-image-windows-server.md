<properties pageTitle="Windows Server를 실행하는 가상 컴퓨터의 이미지 캡처" description="Windows Server 2008 R2를 실행하는 Azure VM(가상 컴퓨터)의 이미지를 캡처하는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
