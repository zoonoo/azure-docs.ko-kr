<properties
   pageTitle="Power BI Embedded를 사용하는 행 수준 보안"
...
**사용자** - 보고서를 보는 실제 최종 사용자입니다. Power BI Embedded에서 사용자는 앱 토큰의 사용자 이름 속성으로 식별됩니다.

**역할** - 사용자는 역할에 속합니다. 역할은 규칙에 대한 컨테이너로, "Sales Manager" 또는 "Sales Rep"와 같이 이름을 지정할 수 있습니다. Power BI Embedded에서 사용자는 앱 토큰의 역할 속성으로 식별됩니다.
