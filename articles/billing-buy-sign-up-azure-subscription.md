...
3. **사용자 정보** 섹션에 개인 정보를 입력합니다. 개인 정보 정확하게 입력하기에 대해 [자세히 알아봅니다](billing-troubleshoot-azure-sign-up-issues.md#i-am-getting-an-error-when-entering-my-information-to-sign-up).

    ![여기에 개인 정보를 입력합니다.](./media/billing-buy-sign-up-azure-subscription/AboutYou.png)

    >[AZURE.NOTE] Azure 구독에 등록할 때 제공하는 전자 메일 주소 및 국가 정보는 항상 구독과 연결되며 나중에 변경할 수 없습니다.
...
- [Azure 무료 평가판을 활성화할 수 없습니다.](billing-troubleshoot-azure-sign-up-issues.md#i-cant-activate-an-azure-free-trial)
