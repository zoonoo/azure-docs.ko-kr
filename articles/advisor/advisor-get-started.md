...
Advisor는 7일 동안 가상 시스템 사용량을 모니터링한 다음 사용률이 낮은 가상 컴퓨터를 식별합니다. 가상 컴퓨터는 CPU 사용률이 5% 이하이고 네트워크 사용률이 2% 미만이거나 현재 워크로드를 더 작은 가상 시스템 크기로 수용할 수 있는 경우 사용률이 낮은 것으로 간주됩니다.
