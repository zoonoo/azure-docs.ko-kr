...
[Azure 포털을](https://aka.ms/azureadvisordashboard)통해 Advisor에 액세스할 수 있습니다. [Portal](https://portal.azure.com)에 로그인하고 탐색 메뉴에서 **Advisor**를 찾거나 **모든 서비스** 메뉴에서 검색합니다.
...
* **운영 우수성**: 프로세스 및 워크플로 효율성, 리소스 관리 용이성 및 배포 모범 사례를 달성하는 데 도움이 됩니다. . 자세한 내용은 [고문 운영 우수성 권장 사항을](advisor-operational-excellence-recommendations.md)참조하십시오.
...
Advisor는 응용 프로그램 게이트웨이, 앱 서비스, 가용성 집합, Azure 캐시, Azure 데이터 팩토리, MySQL용 Azure 데이터베이스, PostgreSQL용 Azure 데이터베이스, MariaDB용 Azure 데이터베이스, Azure ExpressRoute, Azure Cosmos DB, Azure Public에 대한 권장 사항을 제공합니다. IP 주소, SQL 데이터 웨어하우스, SQL 서버, 저장소 계정, 트래픽 관리자 프로필 및 가상 시스템.

Azure Advisor에는 추가 리소스 유형에 대한 권장 사항이 포함될 수 있는 [Azure 보안 센터의](https://docs.microsoft.com/azure/security-center/security-center-recommendations) 권장 사항도 포함되어 있습니다.
