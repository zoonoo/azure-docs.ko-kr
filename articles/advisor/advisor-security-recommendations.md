---
title: Azure Advisor로 리소스를 보다 안전하게 만들기
...
보안 권장 사항에 대 한 자세한 내용은 [Azure Security Center에서 보안 권장 사항 관리](https://azure.microsoft.com/documentation/articles/security-center-recommendations/)를 참조 하세요.
