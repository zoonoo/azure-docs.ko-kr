<properties pageTitle="Xamarin iOS 앱용 모바일 서비스 시작 - Azure 모바일 서비스" description="이 자습서에 따라 Azure 모바일 서비스를 사용하여 Xamarin iOS 개발을 시작할 수 있습니다." services="" documentationCenter="xamarin" authors="lindydonna" manager="dwrede" editor="mollybos"/>
