...
모바일 서비스를 사용하는 Xamarin 앱을 만들기 시작하려면 Xamarin 빠른 시작 자습서([iOS](partner-xamarin-mobile-services-ios-get-started.md) / [Android](partner-xamarin-mobile-services-android-get-started.md))를 참조하십시오.
