---
title: 백서 및 사례 연구 - Azure용 Avere vFXT
...
이 문서에서는 사례 연구, 기술 백서, 인포그래픽 및 Azure용 Avere vFXT가 워크플로에 어떻게 적합한지 이해하는 데 도움이 되는 기타 리소스를 나열합니다.

## <a name="deploy-agisoft-photoscan-on-azure"></a>Azure에 Agisoft PhotoScan 배포

**링크:** [Azure 또는 BeeGFS용 Avere vFXT를 통해 Azure에 Agisoft PhotoScan 배포](https://azure.microsoft.com/mediahandler/files/resourcefiles/deploy-agisoft-photoscan-on-azure-with-azere-vfxt-for-azure-or-beegfs/AgiSoft%20PhotoScan%20on%20Azure%20using%20Avere%20vFXT%20or%20BeeGFS.pdf)
...
## <a name="datasheet-avere-vfxt-for-azure"></a>데이터 시트: Azure용 Avere vFXT

**링크:** [Azure 데이터시트용 Avere vFXT](https://azure.microsoft.com/resources/avere-vfxt-for-azure-data-sheet/)
...
**링크:** [인포그래픽: 파일 기반 워크로드를 위한 하이브리드 클라우드 구축](https://azure.microsoft.com/resources/building-a-hybrid-cloud-for-file-based-hpc-workloads/)
