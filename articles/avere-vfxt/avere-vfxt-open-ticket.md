...
1. [https://portal.azure.com](https://portal.azure.com)에서 **리소스 그룹**을 선택합니다. 문제가 발생 한 vFXT 클러스터가 포함 된 리소스 그룹을 찾아 Avere 클러스터 가상 머신 중 하나를 클릭 합니다.
