...
2.  웹 사이트를 백업할 저장소 계정을 선택합니다. 저장소 계정은 백업할 웹 사이트와 동일한 구독에 속해야 합니다.
...
3.  **포함된 데이터베이스** 옵션에서 백업할 웹 사이트에 연결할 데이터베이스(SQL 서버 또는 MySQL)를 선택합니다.
    ...
    > [WACOM.NOTE] 이 목록에 표시될 데이터베이스의 경우 연결 문자열이 포털에서 구성 탭의 **연결 문자열** 섹션에 있어야 합니다.
...
5.  **포함된 데이터베이스** 섹션에서 백업할 웹 사이트에 연결할 데이터베이스(SQL 또는 MySQL)을 선택합니다. 목록에 표시될 데이터베이스의 경우 연결 문자열이 포털에서 구성 탭의 **연결 문자열** 섹션에 있어야 합니다.
...
-   백업 및 복원 기능이 데이터베이스를 포함할 수 있도록 웹 사이트의 구성 탭에서 각 데이터베이스의 연결 문자열을 제대로 설정했는지 확인하십시오.
