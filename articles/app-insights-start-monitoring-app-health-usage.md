...
[Microsoft Azure][Microsoft Azure]의 계정이 필요합니다(무료 평가 기간 있음).

다음의 두 가지 방법으로 Application Insights를 시작할 수 있습니다.

-   (권장) 응용 프로그램 성능과 사용 현황 모니터링을 위해 [Visual Studio의 프로젝트에 Application Insights를 추가합니다][Visual Studio의 프로젝트에 Application Insights를 추가합니다].
-   [웹 사이트를 다시 배포하지 않고 서버에 에이전트를 설치합니다][웹 사이트를 다시 배포하지 않고 서버에 에이전트를 설치합니다]. 이렇게 하면 라이브 웹 사이트를 다시 배포하거나 소스 코드를 변경하지 않고도 해당 웹 사이트를 모니터링할 수 있습니다. 이 경우 성능 및 예외 모니터링 기능이 제공되며 사용 현황 모니터링은 나중에 추가할 수 있습니다.

> [WACOM.NOTE] Visual Studio Online에는 보다 광범위한 응용 프로그램 유형을 지원하는 [이전 버전의 Application Insights][이전 버전의 Application Insights]가 포함되어 있습니다. 현재 Microsoft Azure의 일부분으로 Application Insights를 처음부터 다시 빌드하는 중이며 이 문서에서는 새 버전에 대한 정보를 제공합니다.

## <a name="add"></a>프로젝트에 Application Insights 추가

[Visual Studio 2013 업데이트 3][Visual Studio 2013 업데이트 3] 이상이 필요합니다.
...
![클릭하여 추가 데이터 확인][클릭하여 추가 데이터 확인]

보다 자세한 정보를 확인하려면 원하는 타일을 클릭합니다. 보고서에 표시되는 항목을 변경할 수 있습니다. [응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.][응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.]
...
![Application Insights의 프로젝트에서 빠른 시작, 웹 사이트 계측을 차례로 클릭한 다음 코드 복사][Application Insights의 프로젝트에서 빠른 시작, 웹 사이트 계측을 차례로 클릭한 다음 코드 복사]
...
[보다 자세한 정보를 확인하려면 차트를 클릭합니다.][응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.]

### <a name="deploy"></a>5. 응용 프로그램 배포

응용 프로그램을 배포하고 누적되는 데이터를 관찰합니다.

라이브 응용 프로그램을 만든 후에는 [웹 테스트를 설정][웹 테스트를 설정]하여 응용 프로그램이 라이브 상태로 유지되는지 확인합니다.
...
[웹 앱 사용 현황 추적][웹 앱 사용 현황 추적]

[웹 응용 프로그램의 성능 모니터링][응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.]
...
-   [Application Insights - 시작][Application Insights - 시작]
-   [라이브 웹 서버 모니터링][웹 사이트를 다시 배포하지 않고 서버에 에이전트를 설치합니다]
-   [웹 응용 프로그램의 성능 모니터링][응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.]
-   [진단 로그 검색][진단 로그 캡처 및 검색]
-   [웹 테스트를 사용한 가용성 추적][웹 테스트를 설정]
-   [사용 현황 추적][웹 앱 사용 현황 추적]
-   [질문과 대답 및 문제 해결][문제 해결]

<!--Link references-->

  [Microsoft Azure]: http://azure.com
  [Visual Studio의 프로젝트에 Application Insights를 추가합니다]: #add
  [웹 사이트를 다시 배포하지 않고 서버에 에이전트를 설치합니다]: ../app-insights-monitor-performance-live-website-now/
  [이전 버전의 Application Insights]: http://msdn.microsoft.com/en-us/library/dn481095.aspx
  [Visual Studio 2013 업데이트 3]: http://go.microsoft.com/fwlink/?linkid=397827&clcid=0x409
  ...
  [응용 프로그램 상태 보고서 구성 방법에 대해 자세히 알아보세요.]: ../app-insights-web-monitor-performance/
