<properties 
	pageTitle="Azure 웹 사이트에서 PHP 웹 사이트를 만드는 방법" 
	description="Azure 웹 사이트에서 PHP 웹 사이트를 만드는 방법에 대해 알아봅니다." 
...
일반적으로, PHP 웹 사이트를 만드는 작업은 Azure 웹 사이트에서  *any* 웹 사이트를 만드는 방법과 동일합니다. 기본적으로, PHP는 모든 웹 사이트에 대해 사용할 수 있습니다. PHP 구성(또는 사용자 지정된 PHP 런타임 제공)에 대한 자세한 내용은 [Azure 웹 사이트에서 PHP를 구성하는 방법][configure-php].을 참조하세요.
