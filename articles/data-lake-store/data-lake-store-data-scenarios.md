---
title: Data Lake 저장소와 관련된 데이터 시나리오 | Microsoft Docs
...
* [Azure 스트림 분석](../stream-analytics/stream-analytics-data-lake-output.md) - Azure Data Lake Store 출력을 사용하면 이벤트 허브에 수집된 이벤트를 Azure Data Lake에 쓸 수 있습니다.
