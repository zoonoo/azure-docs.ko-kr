...
4. **만들기**를 클릭합니다. 계정을 대시보드에 고정하도록 선택한 경우 대시보드로 다시 돌아가고 Data Lake Store 계정 프로비전의 진행률을 볼 수 있습니다. Data Lake Store 계정이 프로비전되면 계정 블레이드가 표시됩니다.
...
> [!NOTE]
> Azure Resource Manager 템플릿을 사용하여 Data Lake Store 계정을 만들 수도 있습니다. 이러한 템플릿은 [Azure QuickStart 템플릿](https://azure.microsoft.com/resources/templates/?term=data+lake+store)에서 액세스할 수 있습니다.
...
## <a name="createfolder"></a>Azure Data Lake Store 계정에서 폴더 만들기
Data Lake Store 계정에서 폴더를 만들어 데이터를 관리하고 저장할 수 있습니다.
...
## <a name="uploaddata"></a>Azure Data Lake Store 계정에 데이터 업로드
루트 수준에서 Azure Data Lake Store 계정에 직접 데이터를 업로드하거나 계정 내에서 만든 폴더에 업로드할 수 있습니다. 
...
업로드할 일부 샘플 데이터를 찾는 경우 **Azure Data Lake Git 리포지토리** 의 [Ambulance Data](https://github.com/MicrosoftBigData/usql/tree/master/Examples/Samples/Data/AmbulanceData)폴더에 있을 수 있습니다.
...
Azure Active Directory 및 액세스 제어(ACL)를 사용하여 Azure Data Lake Store 계정에 저장된 데이터를 보호할 수 있습니다. 작업 수행 방법에 대한 지침은 [Azure Data Lake Store의 데이터 보안](data-lake-store-secure-data.md)을 참조하세요.

## <a name="delete-azure-data-lake-store-account"></a>Azure Data Lake Store 계정 삭제
Azure Data Lake Store 계정을 삭제하려면 Data Lake Store 블레이드에서 **삭제**를 클릭합니다. 작업을 확인하려면 삭제하려는 계정의 이름을 입력하라는 메시지가 표시됩니다. 계정의 이름을 입력한 다음 **삭제**를 클릭합니다.
...
* [Azure Data Lake 분석에 Data Lake Store 사용](../data-lake-analytics/data-lake-analytics-get-started-portal.md)
