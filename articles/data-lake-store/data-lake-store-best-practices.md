...
Data Lake Storage Gen1에서 빅 데이터를 사용할 때는 대부분의 경우 Azure HDInsight와 같은 서비스가 데이터 작업을 수행할 수 있도록 서비스 사용자가 사용됩니다. 그러나 개별 사용자가 데이터에 액세스해야 하는 경우도 있을 수 있습니다. 이 경우 개별 사용자를 폴더 및 파일에 할당하는 대신 Azure Active Director [보안 그룹](data-lake-store-secure-data.md#create-security-groups-in-azure-active-directory)을 사용해야 합니다. 
...
* [Azure Data Lake Storage Gen1에 대한 Azure Data Factory를 사용한 데이터 오케스트레이션](https://mix.office.com/watch/1oa7le7t2u4ka)
