...
* 자습서를 신속하게 완료할 수 있도록 이 코드 조각은 기본적으로 모든 Azure 구독에서 사용할 수 있는 Microsoft Azure Active Directory 도메인 및 클라이언트 ID를 사용합니다. 따라서 **이 코드 조각을 응용 프로그램에서 있는 그대로 사용**할 수 있습니다.
