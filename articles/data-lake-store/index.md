...
<ul class="panelContent cardsW">
    ...
                        <p><a href="/python/api/azure-mgmt-datalake-store/">Python(계정 관리)</a></p>
                        <p><a href="https://docs.microsoft.com/python/api/azure-datalake-store/azure.datalake.store.core">Python(파일 시스템 관리)</a></p>
                    </div>
                </div>
            </div>
        </div>
