...
Azure Data Lake Storage Gen1 Java SDK를 사용하여 폴더 만들기, 데이터 파일 업로드 및 다운로드 등과 같은 기본 작업을 수행하는 방법을 알아봅니다. 데이터 레이크 저장소 Gen1에 대한 자세한 내용은 [Azure 데이터 레이크 저장소 Gen1을](data-lake-store-overview.md)참조하십시오.
