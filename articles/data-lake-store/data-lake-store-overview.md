...
* [Get Started with Data Lake 저장소 Gen1가 Azure Portal을 사용 하 여](data-lake-store-get-started-portal.md)
* [Azure 데이터 레이크 저장소 Gen1 시작.NET SDK를 사용 하 여](data-lake-store-get-started-net-sdk.md)
