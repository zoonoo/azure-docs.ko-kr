...
description: "Azure PowerShell을 사용하여 Data Lake Store 계정을 만들고 기본 작업을 수행합니다."
...
---
# <a name="get-started-with-azure-data-lake-store-using-azure-powershell"></a>Azure PowerShell을 사용하여 Azure Data Lake Store 시작
...
Azure PowerShell을 사용하여 Azure Data Lake Store 계정을 만들고 폴더 만들기, 데이터 파일 업로드 및 다운로드, 계정 삭제 등의 기본 작업을 수행하는 방법에 대해 알아봅니다. Data Lake Store에 대한 자세한 내용은 [Data Lake Store 개요](data-lake-store-overview.md)를 참조하세요.
...
2. Azure Data Lake Store 계정은 Azure 리소스 그룹과 연결됩니다. Azure 리소스 그룹을 만드는 작업부터 시작합니다.
...
3. Azure Data Lake Store 계정을 만듭니다. 지정하는 이름은 소문자와 숫자만 포함해야 합니다.
...
## <a name="create-directory-structures-in-your-azure-data-lake-store"></a>Azure Data Lake Store에서 디렉터리 구조 만들기
Azure Data Lake Store 계정에서 디렉터리를 만들어 데이터를 관리하고 저장할 수 있습니다.
...
## <a name="upload-data-to-your-azure-data-lake-store"></a>Azure Data Lake Store에 데이터 업로드
...
## <a name="rename-download-and-delete-data-from-your-data-lake-store"></a>Data Lake Store에서 데이터 이름 바꾸기, 다운로드 및 삭제
...
## <a name="delete-your-azure-data-lake-store-account"></a>Azure Data Lake Store 계정 삭제
