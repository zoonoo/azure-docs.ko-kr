...
이 작업은 [여기](https://docs.microsoft.com/en-us/rest/api/datalakestore/accounts/create)에 정의된 REST API 호출을 기반으로 합니다.
...
이 작업은 [여기](https://docs.microsoft.com/en-us/rest/api/datalakestore/accounts/delete)에 정의된 REST API 호출을 기반으로 합니다.
