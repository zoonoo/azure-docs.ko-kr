...
지도 및/또는 감소 작업에 필요한 메모리 양에 따라이 숫자를 조정 합니다. Yarn 구성을 통해 Ambari의 `mapreduce.map.memory` 및 `mapreduce.reduce.memory` 기본값을 볼 수 있습니다. Ambari에서 YARN로 이동 하 여 **Configs** 탭을 봅니다. YARN 메모리가 표시 됩니다.
...
### <a name="step-5-set-mapreducejobmapsmapreducejobreduces"></a>5 단계: mapreduce/mapreduce. 작업을 설정 합니다.
...
### <a name="step-4-calculate--of-yarn-containers"></a>4 단계: YARN 컨테이너 개수 계산
