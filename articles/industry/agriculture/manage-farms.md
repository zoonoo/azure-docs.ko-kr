...
1. 팜 가속기에 **로그인 하면 팜 페이지가 표시** 됩니다.
    **팜** 페이지는 구독에서 이미 만들어져 있는 경우의 팜 목록을 표시 합니다.
    ...
    ![프로젝트 팜 비트](./media/create-farms/create-farm-main-page-1.png)
...
1. **지도에 표시**: 지도 컨트롤 도구를 사용 하 여 팜의 경계를 그리거나 표시 합니다. 경계를 표시 하기 위해 ![프로젝트 팜](./media/create-farms/pencil-icon-1.png)를 보다 정확 하 게 표시 하 고 정확한 경계를 표시 합니다.

    ![프로젝트 팜 비트](./media/create-farms/create-farm-mark-on-map-1.png)
...
도구 설명을 사용 하 여 정보를 입력 합니다.
    ...
    ![프로젝트 팜 비트](./media/create-farms/create-new-farm-1.png)

4.  **제출** 을 선택 하 여 팜을 만듭니다. 새 팜이 만들어지고 **팜** 페이지에 표시 됩니다.
...
2.  팜 **삭제** 를 선택 하 여 팜을 삭제 합니다.
    ...
    ![프로젝트 팜 비트](./media/create-farms/delete-farm-1.png)
