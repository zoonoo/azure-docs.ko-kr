...
Azure FarmBeats를 사용 하 여 데이터 파트너가 되기 때문에 시스템을 열어서 더 광범위 한 채택을 제공 하 고 데이터 제공을 통해 더 많은 고객에 게 연락할 수 있습니다. Azure FarmBeats는 데이터 허브 라는 확장 가능한 API 계층을 제공 합니다 .이를 통해 장치에서 데이터를 체계적으로 수집 하 고 표준화 된 스키마로 수집할 수 있습니다.

고객의 Azure FarmBeats 인스턴스 내에서 데이터를 사용할 수 있게 되 면 고객은 데이터를 기반으로 다양 한 분석 및 도구를 빌드할 수 있습니다.

## <a name="next-steps"></a>다음 단계

센서 데이터 통합에 대 한 자세한 내용은 [센서 데이터 통합](sensor-partner-integration.md) 및 이미지 파트너 통합을 참조 하세요. [이미지 파트너 통합](imagery-partner-integration.md)을 참조 하세요.
