...
이 단계는 일회성 설정입니다. 이 새 장면 형식의 범위는 FarmBeats 프로젝트가 배포 된 구독으로 제한 됩니다.
...
REST API 기반 통합 정보에 대 한 자세한 내용은 [REST API](references-for-farmbeats.md#rest-api)을 참조 하세요.
