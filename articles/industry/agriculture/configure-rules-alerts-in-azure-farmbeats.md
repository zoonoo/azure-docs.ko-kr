...
2. **새 규칙**을 선택 합니다. 새 규칙 창이 표시 됩니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/new-rule-1.png)

3. **규칙 이름** 및 **규칙 설명을** 입력 한 다음 **팜 선택** 드롭다운 메뉴에서 팜을 선택 합니다.
4. 팜 이름을 입력 하 여 동일한 창에 표시 되는 팜 및 **조건** 섹션을 선택 합니다.  

    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/new-rule-condition-1.png)
...
9. **작업**에서 전자 메일 **사용** 토글 단추를 전환 하 여 전자 메일 경고를 사용 하도록 설정 합니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/new-rule-email-1.png)
...
**팜** 페이지에는 사용 가능한 규칙 목록이 표시 됩니다. **규칙 이름을**선택 합니다. 창에는 선택한 규칙에 적용 되는 다음과 같은 세부 정보가 표시 됩니다.
 ...
 - 규칙의 영향을 받는 장치 수
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/view-rule-1.png)
...
2. 편집 하려는 규칙을 선택 합니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/edit-rule-action-bar-1.png)

3. 작업 모음에서 **편집** 을 선택 하면 **규칙 편집** 창이 표시 됩니다.

    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/edit-rule-one-1.png)
...
8. **+ 조건 추가** 를 선택 하 여 규칙에 조건을 추가/편집 합니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/edit-rule-two-1.png)
...
2. 상태를 변경 하려는 규칙을 선택 합니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/change-status-rule-action-bar-1.png)

3. 작업 모음에서 **상태 변경** 을 선택 합니다. **상태 변경** 창이 표시 됩니다.

    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/rule-change-status-1.png)
...
2. 삭제 하려는 규칙을 선택 합니다.
    ...
    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/delete-rule-action-bar-1.png)

3. 작업 모음에서 **삭제** 를 선택 합니다.

    ![프로젝트 팜 비트](./media/configure-rules-and-alerts-in-azure-farmbeats/delete-rule-1.png)
