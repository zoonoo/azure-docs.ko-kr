---
title: 사용자 관리
description: 이 문서에서는 사용자를 관리 하는 방법을 설명 합니다.
author: uhabiba04
ms.topic: article
ms.date: 12/02/2019
ms.author: v-umha
...
ms.locfileid: "74942323"
---
# <a name="manage-users"></a>사용자 관리

Azure FarmBeats에는 Azure Active Directory의 일부인 사용자를 위한 사용자 관리 (Azure AD)가 포함 되어 있습니다. Azure FarmBeats 인스턴스에 사용자를 추가 하 여 Api에 액세스 하 고, 생성 된 맵과 팜에서 센서 원격 분석을 볼 수 있습니다.
...
Azure FarmBeats에 사용자를 추가 하는 단계를 수행 합니다.

1.  액셀러레이터 키에 로그인 한 후 **설정** 아이콘을 선택 합니다.
2.  **Access Control**를 선택 합니다.

    ![프로젝트 팜 비트](./media/create-farms/settings-users-1.png)

3.  액세스를 제공 하려는 사용자의 전자 메일 ID를 입력 합니다.
...
Azure FarmBeats 시스템에서 사용자를 제거 하는 단계를 수행 합니다.

1.  액셀러레이터 키에 로그인 한 후 **설정** 아이콘을 선택 합니다.
2.  **Access Control**를 선택 합니다.
3.  사용자를 삭제 하려면 **삭제** 를 선택 합니다.

사용자가 시스템에서 삭제 됩니다. 성공적인 작업을 확인 하기 위해 다음 메시지가 표시 됩니다.
...
> [!NOTE]
> 사용자가 Azure AD 테 넌 트에 없는 경우 아래 단계에 따라 Azure FarmBeats에 대 한 사용자 액세스 권한을 제공 합니다. 사용자가 Azure AD 테 넌 트에 있는 경우 아래 단계를 건너뛸 수 있습니다.
>
...
Azure FarmBeats 인스턴스에 사용자를 추가 했습니다. 이제 [팜을 만드는](manage-farms.md#create-farms)방법을 알아봅니다.
