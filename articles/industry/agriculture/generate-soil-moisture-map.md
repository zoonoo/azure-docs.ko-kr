...
팜은 토양 습기 열 지도를 만드는 데 필요한 지리적 영역입니다. 팜 [API](https://aka.ms/FarmBeatsDatahubSwagger) 또는 [FarmsBeats Accelerator UI](manage-farms.md#create-farms) 를 사용 하 여 팜을 만들 수 있습니다.
...
2. 작업 상태가 *성공*으로 표시 되 면 메뉴에서 **지도** 를 클릭 합니다.
