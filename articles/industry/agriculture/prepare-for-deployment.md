...
1. 필드 "온전성 테스트"를 사용해 보세요. 

     - 성공적인 배포에 대 한 출력으로 받은 Datahub 링크를 사용 하 여 Swagger 포털에 성공적으로 로그인 합니다.
     - 확장 형식 API 가져오기-"사용해 보기/Execute"를 선택 합니다.
     - "403 권한이 없는 사용자"와 같은 예외는 발생 하지 않고 서버 응답 코드 200을 수신 해야 합니다.
