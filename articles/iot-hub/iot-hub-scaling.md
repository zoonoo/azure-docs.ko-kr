...
| [대량 장치 작업](https://docs.microsoft.com/rest/api/iot-dps/deviceenrollment/bulkoperation) | 예, IoT Edge 기능을 제외하고 맞습니다. | yes | 
...
* IoT Hub 기능 및 성능 세부 정보에 대한 자세한 내용은 [IoT Hub 가격 책정][lnk-pricing] 또는 [IoT Hub 할당량 및 제한][IoT Hub quotas and throttles]을 참조하세요.
