...
* [직접 메서드](iot-hub-devguide-direct-methods.md) 결과를 즉시 확인해야 하는 통신의 경우 대화형 디바이스 제어(예: 선풍기 켜기)에 대해 직접 메서드를 자주 사용합니다.
...
| 크기 | 최대 직접 메서드 페이로드 크기는 128KB입니다. | 원하는 최대 속성 크기는 32KB입니다. | 최대 64KB 메시지 |
...
* [원하는 속성을 사용하여 장치 구성](tutorial-device-twins.md) 
