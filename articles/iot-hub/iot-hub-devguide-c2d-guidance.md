---
title: "Azure IoT Hub 클라우드-장치 통신 지침 | Microsoft 문서"
description: "Azure IoT Hub 개발자 가이드 - 직접 메서드, 장치 쌍의 desired 속성 또는 클라우드-장치 메시지를 사용하는 경우에 대한 지침입니다."
services: iot-hub
documentationcenter: 
author: fsautomata
manager: timlt
...
IoT Hub는 백 엔드에 기능을 공개하는 세 가지 옵션을 장치 앱에 제공합니다.
...
| 데이터 흐름 | 양방향. 장치 앱에서 메서드에 즉시 응답할 수 있습니다. 백 엔드에서 컨텍스트에 따라 요청에 대한 결과를 수신합니다. | 단방향. 장치 앱에서 속성 변경 알림을 수신합니다. | 단방향. 장치 앱에서 메시지를 수신합니다.
...
* [desired 속성을 사용하여 장치 구성][lnk-twin-properties] 
