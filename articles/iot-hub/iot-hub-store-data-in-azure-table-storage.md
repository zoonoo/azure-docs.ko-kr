...
1. 함수 앱에서 새 함수를 만듭니다.
   ...
   1. **이 함수 만들기**를 클릭한 다음, **새 함수**를 클릭합니다.
   1. 언어에서 **JavaScript**를, 시나리오에서 **데이터 처리**를 선택합니다.
...
1. 함수의 출력을 구성합니다.
   ...
   1. 필요한 정보를 입력합니다.
      ...
      **저장소 계정 연결**: **새로 만들기**를 클릭하고 저장소 계정을 선택하거나 입력합니다. 저장소 계정에 볼 수 없는 경우 [저장소 계정 요구 사항](https://docs.microsoft.com/azure/azure-functions/functions-create-function-app-portal#storage-account-requirements)을 참조하세요.
