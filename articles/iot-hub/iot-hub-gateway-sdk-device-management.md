---
title: 게이트웨이 SDK를 사용하는 장치 관리 | Microsoft Docs
...
> [!NOTE]
> 사용자 지정 이미지를 구축하는 스크립트는 4개 CPU 코어 컴퓨터에서 실행되는 데 최대 6시간이 걸릴 수 있습니다. 더 많은 CPU 코어가 있는 보다 강력한 컴퓨터를 사용하여 이 시간을 줄일 수 있습니다.
> 
> 
