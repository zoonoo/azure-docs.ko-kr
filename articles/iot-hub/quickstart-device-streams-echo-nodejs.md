---
title: Azure IoT Hub 디바이스 스트림 Node.js 빠른 시작(미리 보기) | Microsoft Docs
...
[Node.js.org](https://Node.js.org)에서 여러 플랫폼에 대한 Node.js를 다운로드할 수 있습니다.
...
앞에서 설명한 대로 IoT Hub Node.js SDK는 서비스 쪽에서 디바이스 스트림을 지원합니다. 디바이스 쪽 애플리케이션의 경우 [C 빠른 시작](./quickstart-device-streams-echo-c.md) 또는 [C# 빠른 시작](./quickstart-device-streams-echo-csharp.md) 가이드에서 사용할 수 있는 함께 제공되는 디바이스 프로그램을 사용합니다. 다음 단계로 진행하기 전에 디바이스 쪽 애플리케이션이 실행 중인지 확인합니다.
...
서비스 쪽의 콘솔 출력: ![대체 텍스트](./media/quickstart-device-streams-echo-nodejs/service-console-output.PNG "서비스 쪽의 콘솔 출력")
