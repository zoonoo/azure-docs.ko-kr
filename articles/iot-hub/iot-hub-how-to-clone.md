...
1. 이 페이지의 IoT c # 샘플 사용: [c #에 대 한 Azure Iot 샘플](https://azure.microsoft.com/resources/samples/azure-iot-samples-csharp/). Zip 파일을 다운로드 하 고 컴퓨터에 압축을 풉니다. 
...
1. 5 개 옵션에 대해 ImportExportDevicesSample 폴더에 있는 Program. cs의 맨 위에 있는 변수를 설정 합니다.
