...
IoT Hub는 장치측 통신에 대해 [MQTT][lnk-mqtt], WebSocket을 통한 MQTT, [AMQP][lnk-amqp], WebSocket을 통한 AMQP 및 HTTP 프로토콜을 지원합니다. 이러한 프로토콜이 특정 IoT Hub 기능을 지원하는 방식에 대한 내용은 [장치-클라우드 통신 지침][lnk-d2c-guidance] 및 [클라우드-장치 통신 지침][lnk-c2d-guidance]을 참조하세요.
