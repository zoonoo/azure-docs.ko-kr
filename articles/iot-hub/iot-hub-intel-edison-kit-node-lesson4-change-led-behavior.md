...
## <a name="add-functions-to-appjs-and-gulpfilejs"></a>app.js 및 gulpfile.js에 기능 추가
1. 다음 명령을 실행하여 Visual Studio Code에서 샘플 응용 프로그램을 엽니다.
   ...
   code .
   ```
2. `app.js` 파일을 연 후, 다음 함수를 blinkLED() 함수 뒤에 추가합니다.
...
3. `receiveMessageCallback` 함수의 switch-case 블록에 있는 ‘깜박임’ case 앞에 다음 조건을 추가합니다.
