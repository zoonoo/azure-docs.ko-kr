...
| 클라우드-장치 보내기<sup>1</sup> | 1.67 전송 작업/초/단위 (100 메시지/분/단위) | 1.67 전송 작업/초/단위 (100 전송 작업/분/단위) | 83.33 전송 작업/초/단위 (5000 전송 작업/분/단위) |
| 클라우드-장치 받기<sup>1</sup> <br/> (디바이스에서 HTTPS를 사용하는 경우에만)| 16.67 수신 작업/초/단위 (1000 수신 작업/분/단위) | 16.67 수신 작업/초/단위 (1000 수신 작업/분/단위) | 833.33 수신 작업/초/단위 (5만 수신 작업/분/단위) |
