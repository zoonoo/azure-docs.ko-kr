...
| 장치 쌍 업데이트(태그 및 속성) | 장치 및 솔루션 백 엔드에서의 장치 쌍 업그레이드는 512바이트 청크 메시지로 요금이 청구됩니다. 예를 들어 6KB 장치 쌍 읽기는 12개 메시지로 요금이 청구됩니다. |
...
장치는 장치-클라우드 메시지에 대해 25개(100KB/4KB) 메시지 * 24시간을 사용하고, 장치 쌍 업데이트에 대해 하루에 2개 메시지(1KB/0.5KB) * 6번, 하루에 총 612개 메시지를 사용합니다.
