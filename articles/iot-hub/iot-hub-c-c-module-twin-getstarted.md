---
title: Azure IoT Hub 모듈 ID & 모듈 트윈(C) 시작하기
...
ms.locfileid: "81733450"
---
# <a name="get-started-with-iot-hub-module-identity-and-module-twin-c"></a>IoT Hub 모듈 ID 및 모듈 트윈(C) 시작하기
