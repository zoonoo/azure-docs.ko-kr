...
**무료**, **표준 1** 및 **표준 2**의 3개 계층 중에서 선택할 수 있습니다. 무료 계층에서는 IoT Hub에 10개 장치만 연결할 수 있습니다.
...
**S2(높은 빈도)**: IoT Hub S2(높은 빈도) edition은 장치가 대량의 데이터를 생성하는 IoT 솔루션을 위해 설계되었습니다. S2(높은 빈도) edition의 각 단위에서 모든 연결된 장치 사이에 하루에 최대 500개의 장치 또는 최대 150만 개의 메시지를 연결할 수 있습니다.
...
IoT Hub 단위에는 500개의 장치가 포함되므로 IoT 단위 수를 선택하면 이 허브에 대해 지원되는 총 장치 수는 단위 수를 500으로 곱한 것입니다. 예를 들어 IoT Hub에서 1000개의 장치를 지원하도록 하려면 2단위를 선택합니다.
...
위치 옵션은 IoT Hub가 제공되는 지역 목록을 제공합니다. IoT Hub는 미국 동부, 미국 서부, 북유럽, 서유럽, 동아시아 및 동남 아시아와 같은 지역에서 배포할 수 있습니다.
