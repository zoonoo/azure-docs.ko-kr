...
3. 모니터링하고자 하는 모니터링 범주를 선택한 다음 **저장**을 클릭합니다. 이벤트는 **모니터링 설정**에 나열된 이벤트 허브-호환 끝점에서 읽어오는 데 사용할 수 있습니다.
...
연결 범주는 IoT Hub에 연결되거나 연결이 해제된 장치에 의해 발생한 이벤트를 추적합니다. 이 범주를 추적하는 것은 무단 연결 시도를 식별하고 연결 상태가 좋지 않은 영역에서 장치의 연결이 끊어졌을 때 추적하는 데 유용합니다.
