...
| ------- | --------------- | ---------- |
| **장치 메시지 및 이벤트** | 예, 원격 분석 데이터, 장치 쌍 변경, 장치 수명 주기 이벤트 및 디지털 쌍 변경 이벤트에 대해 메시지 라우팅을 사용할 수 있습니다. | 예, Event Grid는 장치 생성/삭제/연결/연결 끊김 등의 원격 분석 데이터 및 장치 이벤트에 사용할 수 있습니다. 그러나 Event grid는 장치 쌍 변경 이벤트 및 디지털 쌍 변경 이벤트에 사용할 수 없습니다. |
