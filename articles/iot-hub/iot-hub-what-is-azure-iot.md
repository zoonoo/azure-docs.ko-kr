...
Azure IoT Hub는 장치에서 대규모로 원격 분석을 수신하고 해당 데이터를 스트림 이벤트 프로세서로 라우트하는 Azure 서비스입니다. 사용자 고유의 솔루션 백 엔드를 구현하기 위해 IoT Hub를 사용할 수 있습니다. IoT Hub는 특정 장치에 클라우드-장치 명령을 보낼 수도 있습니다. 또한 IoT Hub에는 장치를 프로비전하고 허브에 연결할 수 있는 장치를 관리하는 데 사용할 수 있는 장치 ID 레지스트리가 포함되어 있습니다. 자세한 내용은 다음을 참조하세요.
