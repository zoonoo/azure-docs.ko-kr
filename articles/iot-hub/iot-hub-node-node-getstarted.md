...
---
# <a name="get-started-with-azure-iot-hub-for-nodejs"></a>Node.js용 Azure IoT Hub 시작
...
* **SimulatedDevice.js**는 앞에서 만든 장치 ID로 IoT Hub에 연결하고 AMQP 프로토콜을 사용하여 매초마다 원격 분석 메시지를 보냅니다.
