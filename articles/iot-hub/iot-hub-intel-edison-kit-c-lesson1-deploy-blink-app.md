...
### <a name="install-the-azure-iot-hub-sdk-on-edison"></a>Edison에 Azure IoT Hub SDK 설치
다음 명령을 실행하여 Azure Linux Hub SDK를 Edison에 설치합니다.

```bash
gulp install-tools
```

이 작업은 네트워크 연결에 따라 완료하는 데 오래 걸릴 수 있습니다. 하나의 Edison에 대해 한 번만 실행해야 합니다.
