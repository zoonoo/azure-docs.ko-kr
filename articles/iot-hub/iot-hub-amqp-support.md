...
ms.locfileid: "67432607"
---
# <a name="communicate-with-your-iot-hub-by-using-the-amqp-protocol"></a>AMQP 프로토콜을 사용 하 여 IoT hub와 통신

Azure IoT Hub에서 지 원하는 [OASIS AMQP Advanced Message Queuing Protocol () 버전 1.0](https://docs.oasis-open.org/amqp/core/v1.0/os/amqp-core-complete-v1.0-os.pdf) 다양 한 장치 지향 및 서비스 지향 끝점을 통해 기능을 제공 합니다. 이 문서에서는 IoT Hub 기능을 사용 하 여 IoT hub에 연결 하기 위해 AMQP 클라이언트의 사용을 설명 합니다.
...
AMQP 프로토콜에 대 한 자세한 내용은 참조는 [AMQP v1.0 사양을](https://www.amqp.org/sites/amqp.org/files/amqp.pdf)합니다.
