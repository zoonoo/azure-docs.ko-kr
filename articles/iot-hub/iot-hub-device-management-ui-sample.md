---
title: IoT Hub 장치 관리 UI 사용 | Microsoft Docs
...
> [!NOTE]
> 하위 작업이 “실패함" 상태를 반환하면 시뮬레이션 장치가 테스트 시스템에서 실행 중이 아닌지 확인합니다. 그렇지 않다면 simulate.bat 또는 simulate.sh 스크립트를 다시 실행하고 이전 섹션의 장치 다시 부팅 작업 단계를 반복합니다.
> 
> 
