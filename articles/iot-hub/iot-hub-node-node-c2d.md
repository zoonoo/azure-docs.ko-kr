...
이 예제에서 장치는 메시지를 처리 하 고 장치 큐에서 안전 하 게 제거할 수 있음을 IoT Hub 알리기 위해 **complete** 함수를 호출 합니다. MQTT 전송을 사용하고 있는 경우 **complete** 호출이 필요하지 않으므로 건너 뛰어도 됩니다. AMQP 및 HTTPS에 필요 합니다.
