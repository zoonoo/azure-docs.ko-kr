---
title: IoT Hub 장치 id의 내보내기 가져오기 | Microsoft Docs
...
> [!WARNING]
> 가져오기 작업은 실행 취소할 수 없습니다. 장치 ID 레지스트리를 대량 변경하기 전에 언제나 **ExportDevicesAsync** 메서드를 사용하여 기존 데이터를 다른 blob 컨테이너에 백업해야 합니다.
> 
> 
