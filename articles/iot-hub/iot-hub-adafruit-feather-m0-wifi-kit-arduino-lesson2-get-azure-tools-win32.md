...
Python 및 Azure CLI(Azure 명령줄 인터페이스)를 설치합니다. 문제가 발생하면 [문제 해결 페이지](iot-hub-adafruit-feather-m0-wifi-kit-arduino-troubleshooting.md)에서 Adafruit Feather M0 WiFi Arduino 보드에 대한 솔루션을 찾으세요.
