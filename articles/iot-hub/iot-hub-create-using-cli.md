<properties
    pageTitle="CLI를 사용하여 IoT Hub 만들기 | Microsoft Azure"
...
> [AZURE.NOTE] Azure에는 리소스를 만들고 작업하는 [Resource Manager와 클래식](../resource-manager-deployment-model.md)이라는 두 가지 배포 모델이 있습니다. Azure CLI는 Azure Resource Manager 모드여야 합니다.
```
...
> [AZURE.TIP] [Azure 리소스 및 리소스 그룹 관리를 위해 Azure CLI 사용][lnk-CLI-arm] 문서는 Azure CLI를 사용하여 Azure 리소스를 관리하는 방법에 대해 자세한 정보를 제공합니다. 
...
> [AZURE.NOTE] 이 CLI 명령은 대금이 청구되는 S1 표준 IoT Hub를 만듭니다. 다음 명령을 사용하여 IoT hub **exampleIoTHubName**을 삭제할 수 있습니다. 
```
