...
4. Arduino 구성
    * **Windows**: **Windows**에서 **파일 > 기본 설정 > 설정**을 열고 **...** 을 클릭한 다음, settings.json을 열고 다음 줄을 추가하여 Arduino를 구성합니다. 
    ...
    * **macOS**: **macOS**에서 **코드 > 기본 설정 > 설정**을 열고 **...** 을 클릭한 다음, settings.json을 열고 다음 줄을 추가하여 Arduino를 구성합니다.
