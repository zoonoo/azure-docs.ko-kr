---
title: REST API를 사용하여 IoT Hub 만들기 | Microsoft Docs
...
> [!NOTE]
> 이 예제 응용 프로그램은 대금이 청구되는 S1 표준 IoT Hub를 추가합니다. 작업이 완료되면 [포털][lnk-azure-portal]을 통해 또는 **Remove-AzureRmResource** PowerShell cmdlet을 사용하여 IoT Hub를 삭제할 수 있습니다.
> 
> 
