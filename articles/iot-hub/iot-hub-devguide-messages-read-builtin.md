...
ms.locfileid: "47585514"
---
# <a name="read-device-to-cloud-messages-from-the-built-in-endpoint"></a>기본 제공 엔드포인트에서 장치-클라우드 메시지 읽기

기본적으로 메시지는 [Event Hubs](http://azure.microsoft.com/documentation/services/event-hubs/
...
[.NET용 Azure Service Bus SDK](https://www.nuget.org/packages/WindowsAzure.ServiceBus) 또는 [Event Hubs - 이벤트 프로세서 호스트](..//event-hubs/event-hubs-dotnet-standard-getstarted-receive-eph.md)를 사용하는 경우 적절한 권한으로 모든 IoT Hub 연결 문자열을 사용할 수 있습니다. **이벤트/메시지** 를 이벤트 허브 이름으로 사용합니다.
