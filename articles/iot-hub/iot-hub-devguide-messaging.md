...
> [!NOTE]
> SDK가 **호스트 이름** 또는 **네임스페이스** 값을 필요로 하는 경우 **Event Hub 호환 끝점**에서 스키마를 제거합니다. 예를 들어 Event Hubs 호환 끝점이 **sb://iothub-ns-myiothub-1234.servicebus.windows.net/**인 경우 **호스트 이름**은 **iothub-ns-myiothub-1234.servicebus.windows.net**이 되고 **네임스페이스**는 **iothub-ns-myiothub-1234**가 됩니다.
> 
> 
