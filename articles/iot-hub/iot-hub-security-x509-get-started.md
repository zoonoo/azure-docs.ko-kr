...
1. **새 프로젝트 구성**에서 프로젝트 이름을 *SimulateX509Device*로 지정한 다음, **만들기**를 선택 합니다.
   ...
   ![Visual Studio에서 x.509 장치 프로젝트 만들기](./media/iot-hub-security-x509-get-started/create-device-project-vs2019.png)
...
1. 앱을 실행합니다. 이 응용 프로그램은 *.pfx* 파일에 액세스 하므로이 앱을 관리자 권한으로 실행 해야 할 수 있습니다.
   ...
   1. 명령 프롬프트에서 **SimulateX509Device** 응용 프로그램을 실행 합니다.
