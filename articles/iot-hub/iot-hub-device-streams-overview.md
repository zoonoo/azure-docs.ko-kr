...
또는 허브의 속성 섹션, 특히 `property.hostname` 및 `property.deviceStreams` 키에서 Azure CLI를 사용 하 여 끝점 정보를 검색할 수 있습니다.
...
장치 스트리밍 끝점의 호스트 이름은 개요 탭의 Azure IoT Hub 포털에서 찾을 수 있습니다. !["장치 스트림 끝점"을](./media/iot-hub-device-streams-overview/device-stream-in-portal.png)
...
에코 샘플은 서비스와 디바이스 애플리케이션 간에 바이트를 보내고 받는 디바이스 스트림을 프로그래밍 방식으로 사용하는 방법을 보여 줍니다. 서비스 및 장치 프로그램은 다양 한 언어로 사용할 수 있습니다. 예를 들어 C 장치 프로그램을 C# 서비스 프로그램과 함께 사용할 수 있습니다.
