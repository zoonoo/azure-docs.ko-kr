...
1. Azure Portal에서 IoT hub로 이동 합니다. 왼쪽 창의 **모니터링** 아래에서 **진단 설정** 을 선택 합니다. 그런 다음, **진단 설정 추가** 를 선택합니다.
...
IoT Hub 페이지에는 두 개의 [빠른 시작 샘플이](./index.yml) 있습니다. 응용 프로그램에의 한 장치 스트림의 사용을 보여 줍니다.
