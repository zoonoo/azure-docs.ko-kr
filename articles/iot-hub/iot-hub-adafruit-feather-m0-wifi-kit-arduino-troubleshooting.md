---
title: "Adafruit Feather M0 WiFi Azure IoT 시작 키트 문제 해결 | Microsoft Docs"
...
Adafruit Feather M0 WiFi Arduino 보드의 일반적인 문제 해결에 대한 내용은 [공식 문제 해결 페이지](https://learn.adafruit.com/adafruit-feather-m0-wifi-atwinc1500?view=all#faq)를 참조하세요.
...
또는 `--listen`를 추가하여 장치 로그 정보를 출력하기 위한 직렬 포트를 열 수 있습니다.
