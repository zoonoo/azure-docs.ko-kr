...
- [Azure Storage 계정은](../storage/common/storage-account-overview.md?toc=%2fazure%2fstorage%2fblobs%2ftoc.json#types-of-storage-accounts) **범용 V2** 계정 이지만 Azure Blob 저장소를 지 원하는 Azure Storage 계정도 작동 합니다.
