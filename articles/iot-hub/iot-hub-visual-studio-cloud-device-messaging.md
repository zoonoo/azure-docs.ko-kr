---
title: VS 클라우드 탐색기를 사용하여 Azure IoT Hub 디바이스 메시징 관리
...
- Microsoft Visual Studio 2017 업데이트 9 이상 이 문서에서는 [Visual Studio 2019](https://www.visualstudio.com/vs/)를 사용합니다.

- 기본적으로 Azure 워크로드로 선택되는 Visual Studio 설치 관리자의 클라우드 탐색기 구성 요소입니다.
...
1. 구독을 확장한 다음, **IoT Hub** 를 확장합니다.  각 허브 아래에서 해당 허브에 대한 디바이스를 볼 수 있습니다.
