---
title: Azure IoT Hub에 원격 분석 전송 빠른 시작(Xamarin.Forms)
description: 샘플 Xamarin.Forms 애플리케이션을 실행하여 시뮬레이션된 원격 분석 데이터를 IoT 허브로 보내고, 클라우드에서 처리할 원격 분석 데이터를 IoT 허브에서 읽습니다.
author: cmaneu
manager: philmea
ms.author: chmaneu
ms.service: iot-hub
