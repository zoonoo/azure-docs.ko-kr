---
title: "Azure IoT에 Intel Edison(C) 연결 - 단원 4: 메시지 수신 | Microsoft Docs"
...
1. repo 폴더 `iot-hub-c-edison-getting-started`에 있어야 합니다. 다음 명령을 실행하여 Visual Studio Code에서 샘플 응용 프로그램을 엽니다.
