...
2. 또한 백 엔드 애플리케이션을 IoT 허브에 연결하여 메시지를 검색할 수 있게 하려면 _서비스 연결 문자열_이 필요합니다. 다음 명령은 IoT Hub에 대한 서비스 연결 문자열을 검색합니다.
...
![대체 텍스트](./media/quickstart-device-streams-proxy-nodejs/rdp-screen-capture.PNG "RDP 클라이언트에서 서비스-로컬 프록시에 연결합니다.")
