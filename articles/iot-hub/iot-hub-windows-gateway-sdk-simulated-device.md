...
# <a name="iot-gateway-sdk-(beta)-–-send-device-to-cloud-messages-with-a-simulated-device-using-windows"></a>IoT Gateway SDK(베타) – Windows를 사용하는 시뮬레이션된 장치에서 장치-클라우드 메시지 보내기
