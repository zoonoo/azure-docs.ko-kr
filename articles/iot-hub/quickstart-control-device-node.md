...
description: 이 빠른 시작에서 두 개의 샘플 Node.js 응용 프로그램을 실행합니다. 하나의 애플리케이션은 허브에 연결된 디바이스를 원격으로 제어할 수 있는 백 엔드 애플리케이션입니다. 또 다른 애플리케이션은 원격으로 제어할 수 있는 허브에 연결된 디바이스를 시뮬레이션 합니다.
author: dominicbetts
manager: timlt
ms.service: iot-hub
services: iot-hub
...
---
# <a name="quickstart-control-a-device-connected-to-an-iot-hub-nodejs"></a>빠른 시작: IoT 허브(Node.js)에 연결된 디바이스 제어
