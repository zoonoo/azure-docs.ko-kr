...
이전 [빠른 시작: 원격 분석을 디바이스에서 IoT 허브로 전송](../iot-develop/quickstart-send-telemetry-iot-hub.md?pivots=programming-language-nodejs)을 완료한 경우 이 단계를 건너뛸 수 있습니다.
