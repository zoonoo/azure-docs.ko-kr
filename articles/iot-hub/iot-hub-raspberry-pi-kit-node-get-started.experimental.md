...
아직 키트가 없으세요? [Raspberry Pi 3 에뮬레이터](https://blogs.msdn.microsoft.com/iliast/2016/11/10/how-to-emulate-raspberry-pi/)를 사용하세요. 또는 새 키트를 [여기](https://azure.microsoft.com/develop/iot/starter-kits)에서 구입합니다.
...
1. 호스트 컴퓨터에서 다음 SSH 클라이언트 중 하나를 사용하여 Intel NUC에 연결합니다.
