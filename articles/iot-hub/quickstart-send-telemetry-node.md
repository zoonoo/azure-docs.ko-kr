...
ms.locfileid: "51514930"
---
# <a name="quickstart-send-telemetry-from-a-device-to-an-iot-hub-and-read-the-telemetry-from-the-hub-with-a-back-end-application-nodejs"></a>빠른 시작: 디바이스에서 IoT 허브로 원격 분석을 보내고 백 엔드 응용 프로그램(Node.js)으로 허브에서 원격 분석을 읽습니다.
...
빠른 시작은 두 개의 미리 작성된 Node.js 응용 프로그램을 사용합니다. 하나는 원격 분석을 보내고 다른 하나는 허브에서 원격 분석을 읽기 위한 것입니다. 이 두 응용 프로그램을 실행하기 전에 IoT 허브를 만들고 허브에 디바이스를 등록합니다.
...
시뮬레이션된 디바이스 응용 프로그램은 IoT 허브의 디바이스 관련 엔드포인트에 연결하고 시뮬레이션된 온도 및 습도 원격 분석을 전송합니다.
...
1. 로컬 터미널 창에서 다음 명령을 실행하여 필요한 라이브러리를 설치하고 백 엔드 응용 프로그램을 실행합니다.
    ...
    ![백 엔드 응용 프로그램 실행](media/quickstart-send-telemetry-node/ReadDeviceToCloud.png)
...
이 빠른 시작에서 IoT 허브를 설치하고, 디바이스를 등록하고 Node.js 응용 프로그램을 사용하여 허브에 시뮬레이션된 원격 분석을 보내고, 간단한 백 엔드 응용 프로그램을 사용하여 허브에서 원격 분석을 읽었습니다.
