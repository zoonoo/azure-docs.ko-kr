...
저장소 계정 복제에 대한 가격 정보는 [저장소 가격 정보](http://www.windowsazure.com/ko-kr/pricing/details/storage/)를 참조하십시오.
...
**키 관리**를 사용하여 연결 문자열에 사용할 저장소 액세스 키를 복사할 수 있습니다. 연결 문자열에는 인증에 사용할 저장소 계정 이름과 키가 있어야 합니다. Azure 저장소 서비스에 액세스하기 위한 연결 문자열 구성에 대한 자세한 내용은 [연결 문자열 구성](http://msdn.microsoft.com/ko-kr/library/ee758697.aspx)을 참조하십시오.
