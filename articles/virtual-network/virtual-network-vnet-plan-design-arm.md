...
또한 각 VNet에 대한 주소 공간도 지정해야 합니다. 온-프레미스 데이터 센터 및 Azure 지역 간의 연결이 필요하므로 Azure VNet에 사용되는 주소 공간은 온-프레미스와 충돌할 수 없으며 각 VNet에 사용되는 주소 공간은 기존의 다른 VNet과 충돌하지 않아야 합니다. 이러한 요구 사항을 충족하기 위해 아래 표의 주소 공간을 사용할 수 있습니다.
