---
title: Azure PowerShell 스크립트 샘플 - 표준 Load Balancer를 사용하여 IPv6 프런트 엔드 구성(미리 보기)
titlesuffix: Azure Virtual Network
description: 표준 Load Balancer를 사용하여 가상 네트워크 스크립트 샘플에서 IPv6 프런트 엔드를 구성하는 방법에 대해 알아봅니다.
...
---
# <a name="configure-ipv6-frontend-in-virtual-network-script-sample-with-standard-load-balancerpreview"></a>표준 Load Balancer를 사용하여 가상 네트워크 스크립트 샘플에서 IPv6 프런트 엔드 구성(미리 보기)
