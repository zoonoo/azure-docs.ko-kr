...
이 문서에서는 리소스 관리자 배포 모델을 사용하여 VNet을 만드는 방법을 설명합니다. [Azure Preview 포털을 사용하여 클래식 배포 모델에서 가상 네트워크를 만들 수도 있습니다](virtual-networks-create-vnet-classic-pportal.md).
