...
- **[Azure Synapse Analytics](../azure-sql/database/vnet-service-endpoint-rule-overview.md?toc=%2fazure%2fvirtual-network%2ftoc.json)** (*Microsoft .sql*): 전용 SQL 풀 (이전의 sql DW)의 모든 azure 지역에서 일반 공급 됩니다.
