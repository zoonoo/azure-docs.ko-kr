---
title: "가상 네트워크에서 공용 IP 주소를 사용하는 방법"
...
---
# <a name="public-ip-address-space-in-a-virtual-network-vnet"></a>VNet(가상 네트워크)의 공용 IP 주소 공간
...
## <a name="how-do-i-add-a-public-ip-address-range"></a>공용 IP 주소 범위를 어떻게 추가하나요?
...
## <a name="are-there-any-limitations"></a>제한 사항이 있나요?
