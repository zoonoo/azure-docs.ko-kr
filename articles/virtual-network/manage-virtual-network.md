...
3. 선택한 가상 네트워크에 대해 다음 설정이 나열됩니다.
   ...
   - **피어링**: 구독에 기존 피어링이 있는 경우 여기에 나열됩니다. 기존 피어링에 대한 설정을 보거나, 피어링을 만들거나 변경하거나 삭제할 수 있습니다. 피어링에 대한 자세한 내용은 [가상 네트워크 피어링](virtual-network-peering-overview.md)을 참조하세요.
