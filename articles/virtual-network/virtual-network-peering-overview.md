...
* 양쪽 구독의 권한 있는 사용자가 피어링을 허용하고 구독이 동일한 Azure Active Directory 테넌트에 연결되면 다른 두 개의 구독에 있는 가상 네트워크를 피어링할 수 있습니다. [VPN Gateway](../vpn-gateway/vpn-gateway-about-vpngateways.md?toc=%2fazure%2fvirtual-network%2ftoc.json#V2V)를 사용하여 다른 Active Directory 테넌트에 연결된 구독에서 가상 네트워크를 연결할 수 있습니다.
