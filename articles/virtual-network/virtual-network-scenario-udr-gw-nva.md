...
- 아래 나열된 대로 분할된 **azurevnet**이라는 VNet
	...
	- **GatewaySubnet**. 다른 네트워크와 Azure Vnet 간의 연결을 제공하기 위해 Express 경로 및 VPN 게이트웨이에 필요한 Azure 하이브리드 연결 서브넷입니다.
...
IP 전달에 대한 자세한 내용은 [사용자 정의된 경로 및 IP 전달이란](./virtual-networks-udr-overview.md#ip-forwarding)을 참조하세요.
