...
### VM
개인 IP 주소는 [가상 컴퓨터](../virtual-machines/virtual-machines-linux-about.md)의 NIC(**네트워크 인터페이스 카드**)에 할당됩니다. 다중 NIC VM의 경우 각 NIC가 할당된 개인 IP 주소를 가져옵니다. NIC의 할당 방법을 동적 또는 정적으로 지정할 수 있습니다.
