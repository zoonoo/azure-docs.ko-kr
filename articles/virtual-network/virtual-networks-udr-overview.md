...
|기본값                |여러 개                               |VirtualNetworkServiceEndpoint|서비스 엔드포인트를 사용하도록 설정된 서브넷만|
