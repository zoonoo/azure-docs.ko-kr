...
> [!IMPORTANT]
> 사용자 정의 경로는 서브넷에서 나가는 트래픽에만 적용됩니다. 트래픽이 인터넷에서 서브넷으로 들어오는 방법 등을 지정하는 경로를 만들 수는 없습니다. 또한 트래픽을 전달하는 기기는 트래픽이 시작되는 위치와 동일한 서브넷에 있을 수 없습니다. 항상 기기를 위한 별도의 서브넷을 만드세요. 
> 
> 
