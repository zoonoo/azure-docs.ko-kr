...
|Source                 |주소 접두사                       |다음 홉 형식|경로가 추가되는 가상 네트워크 내의 서브넷|
|-----                  |----                                   |---------                    |--------|
...
|다음 홉 형식                   |Azure CLI 및 PowerShell(Resource Manager) |Azure 클래식 CLI 및 PowerShell(클래식)|
|-------------                   |---------                                       |-----|
...
|가상 네트워크 피어링         |VNet 피어링                                    |적용할 수 없음|
|가상 네트워크 서비스 엔드포인트|VirtualNetworkServiceEndpoint                   |적용할 수 없음|
...
|ID  |Source |시스템 상태  |주소 접두사    |다음 홉 형식          |다음 홉 IP 주소|사용자 정의 경로 이름| 
|----|-------|-------|------              |-------                |--------           |--------      |
|1   |Default|잘못됨|10.0.0.0/16         |가상 네트워크        |                   |              |
|2   |사용자   |활성 |10.0.0.0/16         |가상 어플라이언스      |10.0.100.4         |Within-VNet1  |
|3   |사용자   |활성 |10.0.0.0/24         |가상 네트워크        |                   |Within-Subnet1|
|4   |Default|잘못됨|10.1.0.0/16         |VNet 피어링           |                   |              |
|5   |Default|잘못됨|10.2.0.0/16         |VNet 피어링           |                   |              |
|6   |사용자   |활성 |10.1.0.0/16         |없음                   |                   |ToVNet2-1-Drop|
|7   |사용자   |활성 |10.2.0.0/16         |없음                   |                   |ToVNet2-2-Drop|
|8   |Default|잘못됨|10.10.0.0/16        |가상 네트워크 게이트웨이|[X.X.X.X]          |              |
|9   |사용자   |활성 |10.10.0.0/16        |가상 어플라이언스      |10.0.100.4         |To-On-Prem    |
|10  |Default|활성 |[X.X.X.X]           |VirtualNetworkServiceEndpoint    |         |              |
|11  |Default|잘못됨|0.0.0.0/0           |인터넷               |                   |              |
...
|Source  |시스템 상태  |주소 접두사    |다음 홉 형식             |다음 홉 IP 주소|
|------- |-------|------              |-------                   |--------           
|Default |활성 |10.0.0.0/16         |가상 네트워크           |                   |
|Default |활성 |10.1.0.0/16         |VNet 피어링              |                   |
|Default |활성 |10.2.0.0/16         |VNet 피어링              |                   |
|Default |활성 |10.10.0.0/16        |가상 네트워크 게이트웨이   |[X.X.X.X]          |
|Default |활성 |0.0.0.0/0           |인터넷                  |                   |
|Default |활성 |10.0.0.0/8          |없음                      |                   |
|Default |활성 |100.64.0.0/10       |없음                      |                   |
|Default |활성 |172.16.0.0/12       |없음                      |                   |
|Default |활성 |192.168.0.0/16      |없음                      |                   |
