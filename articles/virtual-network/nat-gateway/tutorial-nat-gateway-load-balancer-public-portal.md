...
5. **부하 분산 장치 만들기** 페이지에서 다음 정보를 입력하거나 선택합니다. 
    ...
    | Resource group         | **새로 만들기** 를 선택하고 텍스트 상자에 **TutorPubLBNAT-rg** 를 입력합니다. </br> **확인** 을 선택합니다.|
    | **인스턴스 세부 정보** |   |
    ...
    | 공용 IPv6 주소 추가 | **아니오** 를 선택합니다. </br> IPv6 주소 및 부하 분산 장치에 대한 자세한 내용은 [Azure Virtual Network용 IPv6이란?](../ipv6-overview.md)을 참조하세요.  |
