...
포털은 네트워크 인터페이스를 응용 프로그램 보안 그룹에 할당하는 옵션을 제공하지 않지만 Azure CLI 및 PowerShell은 제공합니다. 응용 프로그램 보안 그룹에 대한 자세한 내용은 [응용 프로그램 보안 그룹](security-overview.md#application-security-groups)을 참조하세요.
