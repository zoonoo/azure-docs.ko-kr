...
## <a name="about-peering"></a>요구 사항 및 제약 조건 
...
6. 해당 설정을 변경합니다. 이 문서의 피어링 만들기 섹션에 있는 [6단계](#add-peering)의 각 설정에 대한 옵션에 대해 읽어보세요. 
    ...
    >[!NOTE]
    >피어링을 성공적으로 만들려면 몇 가지 요구 사항, 제약 조건 및 고려 사항이 있습니다. 피어링을 만들기 전에 먼저 이 문서의 [요구 사항 및 제약 조건](#about-peering) 섹션에 있는 구성 목록에 익숙해지도록 합니다.
    >
