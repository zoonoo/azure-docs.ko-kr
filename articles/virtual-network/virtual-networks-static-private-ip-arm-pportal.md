<properties 
   pageTitle="Azure 포털을 사용하여 ARM 모드에서 정적 개인 IP를 설정하는 방법 | Microsoft Azure"
...
# Azure 포털에서 정적 개인 IP 주소를 설정하는 방법
...
1. Azure 포털에서 **모두 찾아보기** > **가상 컴퓨터** > **DNS01** > **모든 설정** > **네트워크 인터페이스**를 클릭한 후 나열된 네트워크 인터페이스만 클릭합니다.
