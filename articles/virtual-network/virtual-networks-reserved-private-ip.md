...
>[AZURE.NOTE]안전한 환경에서 위 명령을 테스트하려는 경우 [가상 네트워크 만들기](https://msdn.microsoft.com/library/azure/dn631643.aspx)의 지침에 따라 *TestVnet*이라는 이름의 VNet을 만들어 *10.0.0.0/8* 주소 공간을 사용하도록 합니다.
