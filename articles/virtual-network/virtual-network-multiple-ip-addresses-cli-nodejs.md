...
1. [Azure CLI 설치 및 구성](../xplat-cli-install.md) 문서에 나오는 단계에 따라 Azure CLI 1.0을 설치 및 구성하고 `azure-login` 명령을 사용하여 Azure 계정에 로그인합니다.

2. 로그인하고 적절한 구독을 선택한 후에 PowerShell(CLI를 사용하여 등록할 수 없음)에서 다음 명령을 실행하여 미리 보기에 등록합니다.
