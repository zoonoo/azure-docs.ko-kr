...
- [Security Center에서 제공 하는 네트워크 보안 이해](https://docs.microsoft.com/azure/security-center/security-center-network-recommendations)
...
- [Security Center에서 위협 방지](https://docs.microsoft.com/azure/security-center/threat-protection)
...
- [VPN gateway에 대 한 패킷 캡처 구성](https://docs.microsoft.com/azure/vpn-gateway/packet-capture) 
...
- [Azure 활동 로그 이벤트를 보고 검색하기](https://docs.microsoft.com/azure/azure-monitor/platform/activity-log-view)
...
- [Security Center에서 경고를 관리 하는 방법](https://docs.microsoft.com/azure/security-center/security-center-managing-and-responding-alerts)
...
- [Security Center 위험 탐지 이해 (의심 스러운 활동)](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-risk-events) 
...
- [네트워크 보안 그룹에 대한 진단 로깅](https://docs.microsoft.com/azure/virtual-network/virtual-network-nsg-manage-log)
...
- [Virtual network에 대 한 Azure policy 샘플 기본 제공](https://docs.microsoft.com/azure/virtual-network/policy-samples)
...
- [가상 네트워크용 Azure Resource Manager 템플릿 샘플](https://docs.microsoft.com/azure/virtual-network/template-samples)
...
- [Security Center에서 권장 사항을 수정 하는 방법](https://docs.microsoft.com/azure/security-center/security-center-remediate-recommendations)
...
- [Security Center의 보안 경고](https://docs.microsoft.com/azure/security-center/security-center-alerts-overview)
...
- [Security Center 보안 연락처를 설정 하는 방법](https://docs.microsoft.com/azure/security-center/security-center-provide-security-contact-details)
