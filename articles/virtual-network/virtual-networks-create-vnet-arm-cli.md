...
description: "Azure CLI를 사용하여 가상 네트워크를 만드는 방법을 알아봅니다."
...
다른 도구를 사용하여 Resource Manager를 통해 가상 네트워크를 만들거나 다음 목록에서 다른 옵션을 선택하여 클래식 배포 모델을 통해 가상 네트워크를 만들 수도 있습니다.
...
- 가상 머신(VM)에서 가상 네트워크 연결은 [Linux VM 만들기](../virtual-machines/linux/quick-create-cli.md) 문서를 참조하세요. 해당 문서의 단계에서 VNet 및 서브넷을 만드는 대신 기존 VNet 및 서브넷을 VM에 연결하도록 선택할 수 있습니다.
