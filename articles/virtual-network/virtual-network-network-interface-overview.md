...
description: "Azure 네트워크 인터페이스 및 가상 컴퓨터와 함께 사용하는 방법에 대해 알아봅니다."
...
---
# <a name="what-are-network-interfaces"></a>네트워크 인터페이스란?
...
7. 연결된 하나 이상의 공용 IP 리소스의 주소를 가질 수 있습니다. 자세한 내용은 [NIC당 여러 IP 주소](virtual-network-multiple-ip-addresses-portal.md) 설명서를 참조하세요.
