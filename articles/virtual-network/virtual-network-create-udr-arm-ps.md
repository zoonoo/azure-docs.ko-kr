---
title: PowerShell을 사용하여 리소스 관리자에서 라우팅 제어 및 가상 어플라이언스 사용 | Microsoft Docs
...
이 문서에서는 리소스 관리자 배포 모델에 대해 설명합니다. [클래식 배포 모델에서 UDR을 만들](virtual-network-create-udr-classic-ps.md) 수도 있습니다.
...
2. 위에서 만든 경로가 포함된 **westus** 지역에 **UDR-FrontEnd**라는 이름의 경로 테이블을 만듭니다.
