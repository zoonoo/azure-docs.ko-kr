...
ms.locfileid: "72952109"
---
# <a name="add-ipv6-to-an-ipv4-application-in-azure-virtual-network---azure-cli-preview"></a>Azure virtual network에서 IPv4 응용 프로그램에 IPv6 추가-Azure CLI (미리 보기)
...
Azure에서 이중 스택 응용 프로그램을 배포 하기 전에 다음 Azure CLI를 사용 하 여이 미리 보기 기능에 대 한 구독을 구성 해야 합니다.
...
표준 Load Balancer에 대 한 [az network 공용-ip create](/cli/azure/network/public-ip) 를 사용 하 여 공용 IPv6 주소를 만듭니다. 다음 예제에서는 *Myresourcegroupslb* 리소스 그룹에 *PublicIP_v6* 라는 IPv6 공용 IP 주소를 만듭니다.
