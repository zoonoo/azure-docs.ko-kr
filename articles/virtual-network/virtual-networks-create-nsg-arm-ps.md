---
title: PowerShell을 사용하여 Azure 리소스 관리자에서 NSG를 만드는 방법 | Microsoft Docs
...
---
# <a name="how-to-create-nsgs-in-resource-manager-by-using-powershell"></a>PowerShell을 사용하여 리소스 관리자에서 NSG를 만드는 방법
