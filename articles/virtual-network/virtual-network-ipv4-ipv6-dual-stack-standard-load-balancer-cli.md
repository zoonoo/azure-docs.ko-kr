...
[az network nic create](/cli/azure/network/nic#az_network_nic_create)를 사용하여 각 VM에 대한 가상 NIC를 만듭니다. 다음 예에서는 각 VM에 대한 가상 NIC를 만듭니다. 각 NIC에는 2개의 IP 구성(IPv4 구성, IPv6 구성)이 있습니다. [az network nic ip config create](/cli/azure/network/nic/ip-config#az_network_nic_ip_config_create)를 사용하여 IPV6 구성을 만듭니다.
