...
애플리케이션 설계 모범 사례와 결합된 Azure DDoS Protection은 DDoS 공격에 대한 방어 기능을 제공합니다. Azure의 모든 속성은 Azure 인프라 DDoS (기본) 보호를 통해 보호 됩니다.Azure DDoS protection 표준은 Azure Virtual Network 리소스에 맞게 특별히 조정 된 기본 서비스 계층에 대 한 추가 완화 기능을 제공 합니다. 
...
![다이어그램에서는 두 개의 공용 I P 주소에서 끝나는 정책 생성을 통해 공용 I P 주소를 통해 DDoS Protection Azure Portal를 통해 고객으로 시작 하는 흐름을 보여 줍니다.](./media/ddos-protection-overview/mitigation.png)
...
- [Azure DDoS Protection 가격 책정](https://azure.microsoft.com/pricing/details/ddos-protection/)
