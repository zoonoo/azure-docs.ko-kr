...
ms.locfileid: "100576605"
---
# <a name="azure-security-baseline-for-virtual-network-nat"></a>Virtual Network NAT에 대 한 Azure 보안 기준

이 보안 기준은 [Azure Security 벤치 마크 버전 1.0](../security/benchmarks/overview-v1.md) 의 지침을 MICROSOFT Virtual Network NAT에 적용 합니다. Azure Security Benchmark는 Azure에서 클라우드 솔루션을 보호하는 방법에 대한 권장 사항을 제공합니다.
...
- [Azure 리소스 그래프 쿼리](../governance/resource-graph/first-query-portal.md)
