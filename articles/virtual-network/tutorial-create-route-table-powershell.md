...
사용 하 여 세 개의 서브넷 구성을 만들어 세 개의 서브넷을 만듭니다 [새로 만들기-AzVirtualNetworkSubnetConfig](/powershell/module/az.network/new-azvirtualnetworksubnetconfig)합니다. 다음 예제에서는 *공용*, *개인* 및 *DMZ* 서브넷에 대한 세 개의 서브넷 구성을 만듭니다.
