...
5. 다음을 지정한 다음, **확인**을 선택합니다.
   ...
   |설정|Required?|세부 정보|
   |---|---|---|
   |name|yes|네트워크 인터페이스에 대해 고유해야 합니다.|
