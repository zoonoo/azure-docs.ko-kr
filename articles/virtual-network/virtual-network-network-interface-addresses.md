...
[Azure 제한](../azure-resource-manager/management/azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits) 문서에 나열된 제한 내에서 필요한 만큼 많은 [프라이빗](#private) 및 [공용](#public) [IPv4](#ipv4) 주소를 네트워크 인터페이스에 추가할 수 있습니다. 기존 네트워크 인터페이스에 대해 하나의 [보조 IP 구성에](#secondary) 개인 IPv6 주소를 추가할 수 있습니다(기존 보조 IP 구성이 없는 경우). 각 네트워크 인터페이스에는 IPv6 개인 주소가 하나일 수 있습니다. 선택적으로 IPv6 네트워크 인터페이스 구성에 공용 IPv6 주소를 추가할 수 있습니다. IPv6 주소 사용에 대한 자세한 내용은 [IPv6](#ipv6)을 참조하세요.
...
|PowerShell|[추가-아즈네트워크인터페이스IpConfig](/powershell/module/az.network/add-aznetworkinterfaceipconfig)|
...
|PowerShell|[제거-아즈네트워크인터페이스IpConfig](/powershell/module/az.network/remove-aznetworkinterfaceipconfig)|
...
- [공용](#public) IPv4 주소도 할당되어 있을 수 있습니다. 공용 IPv6 주소를 기본(IPv4) IP 구성에 할당할 수 없습니다. 
...
- 공용 IPv4 또는 IPv6 주소가 할당되어 있을 수도 있습니다. 네트워크 인터페이스에 여러 개의 IPv4 주소를 할당하면 다음과 같은 시나리오에 유용합니다.
  - 단일 서버에서 서로 다른 IP 주소와 TLS/SSL 인증서를 가진 여러 웹 사이트 또는 서비스를 호스팅합니다.
...
프라이빗 [IPv4](#ipv4) 또는 IPv6 주소를 사용하면 가상 시스템이 가상 네트워크 또는 기타 연결된 네트워크의 다른 리소스와 통신할 수 있습니다. 
...
공용 또는 개인 정적 IPv4 또는 IPv6 주소를 IP 구성에 할당할 수 있습니다. Azure에서 고정 공용 IPv4 주소를 할당하는 방법에 대해 자세히 알아보려면 [공용 IP 주소](virtual-network-public-ip-address.md)를 참조하세요.
...
네트워크 인터페이스의 보조 IP 구성 하나에 프라이빗 [IPv6](#ipv6) 주소 하나를 할당할 수도 있고 할당하지 않을 수도 있습니다. 네트워크 인터페이스는 기존 보조 IP 구성을 포함할 수 없습니다. 각 네트워크 인터페이스에는 IPv6 개인 주소가 하나일 수 있습니다. 선택적으로 IPv6 네트워크 인터페이스 구성에 공용 IPv6 주소를 추가할 수 있습니다.
