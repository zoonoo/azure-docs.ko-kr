...
이 문서에서는 클래식 배포 모델을 사용하여 VNet을 만드는 방법을 설명합니다. [Azure Portal을 사용하여 Resource Manager 배포 모델에서 가상 네트워크를 만들](quick-create-portal.md)수도 있습니다.
