---
title: Azure Virtual Network에 대 한 IPv6 개요
...
---
# <a name="what-is-ipv6-for-azure-virtual-network"></a>Azure Virtual Network에 대 한 i p v 6은 무엇 인가요?
...
- [표준 IPv6 공용 Load Balancer](virtual-network-ipv4-ipv6-dual-stack-standard-load-balancer-powershell.md) 지원 되는 다음과 같은 복원 력 있는 응용 프로그램을 만들 수 있습니다.
    ...
    - 참고: 부하 분산은 프로토콜 변환 (NAT64 없음)을 수행 하지 않습니다. 
...
- Azure virtual network에 대 한 IPv6은 모든 배포 방법을 사용 하 여 모든 글로벌 Azure 상용 지역에서 사용할 수 있습니다.  미국 정부 클라우드의 배포는 일시적으로 ARM (JSON) 템플릿, CLI (명령줄 인터페이스) 및 Powershell로 제한 됩니다.  미국 정부 클라우드 포털의 IPv6 지원은 곧 제공 될 예정입니다.  
- Express 경로 게이트웨이는 i p v 6를 사용 하는 VNET에서 IPv4 전용 트래픽에 사용할 수 있습니다.  IPv6 트래픽을 지원 합니다.   
- VPN 게이트웨이는 직접 또는 피어 링 "UseRemoteGateway"를 사용 하 여 IPv6이 사용 되는 VNET에서 사용할 수 없습니다.
