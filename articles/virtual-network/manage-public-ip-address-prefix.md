...
공용 IP 주소 접두사 및 해당 IP 주소를 생성, 변경 및 삭제하는 방법에 대해 알아봅니다. 공용 IP 주소 접두사는 사용자가 지정하는 공용 IP 주소 수에 기반을 둔 연속 주소 범위입니다. 주소는 구독에 할당됩니다. 공용 IP 주소 리소스를 만들 때 접두사에서 정적 공용 IP 주소를 할당하고 주소를 가상 컴퓨터, 로드 밸런서 또는 기타 리소스에 연결하여 인터넷 연결을 활성화할 수 있습니다. 공용 IP 주소 접두사에 익숙하지 않다면 [공용 IP 주소 접두사 개요](public-ip-address-prefix.md)를 참조하세요.
...
|PowerShell|[뉴 아즈퍼블릭IpPrefix](/powershell/module/az.network/new-azpublicipprefix)|
...
또는 아래의 CLI 및 PS 명령을 --public-ip-접두사(CLI) 및 -PublicIpPrefix(PS) 매개 변수와 함께 사용하여 공용 IP 주소 리소스를 만들 수 있습니다. 
...
|PowerShell|[Get-AzPublicIpPrefix는](/powershell/module/az.network/get-azpublicipprefix) 공용 IP 주소 개체를 검색하고 설정을 볼 수 [있습니다.](/powershell/module/az.network/set-azpublicipprefix) [삭제할-AzPublicIpPrefix](/powershell/module/az.network/remove-azpublicipprefix) 제거|
