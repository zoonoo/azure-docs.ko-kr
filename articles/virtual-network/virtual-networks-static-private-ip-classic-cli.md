<properties 
   pageTitle="CLI를 사용하여 클래식 모드에서 정적 개인 IP를 설정하는 방법 | Microsoft Azure"
...
2. **azure create vm** 명령을 실행하여 VM을 만듭니다. 정적 개인 IP 주소에 대한 값을 확인합니다. 출력 다음에 표시되는 목록은 사용되는 매개 변수를 설명합니다.
