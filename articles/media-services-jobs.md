...
>[AZURE.NOTE]현재 작업당 태스크가 30개로 제한됩니다. 30개 이상의 작업을 연결해야 하는 경우 둘 이상의 작업을 만들어 작업을 연결합니다.
...
[할당량 및 제한 사항](../media-services-quotas-and-limitations) - 미디어 서비스 인코더의 제한 사항 및 사용된 할당량에 대해 설명합니다.
