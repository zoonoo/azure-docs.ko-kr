...
Data Box 장치에 연결된 클라이언트를 통해 데이터 복사 작업에 대해 지원되는 운영 체제의 목록은 다음과 같습니다.
...
Data Box 장치에 대해 지원되는 저장소 형식의 목록은 다음과 같습니다.
...
| Internet Explorer |최신 버전 |로그인할 수 없는 경우 쿠키 및 Javascript가 사용 가능한지 확인합니다. UI 액세스를 사용하려면 장치에서 쿠키에 액세스할 수 있도록 장치 IP를 **개인 정보 작업**에 추가합니다. |
