...
ms.locfileid: "81461738"
---
# <a name="open-a-support-ticket-for-azure-data-box"></a>Azure Data Box에 대한 지원 티켓 열기

이 문서는 Azure Data Box 서비스에 의해 관리 되는 Azure Data Box, Azure Data Box Heavy 및 Azure Data Box Disk에 적용 됩니다. Azure Data Box 서비스에 문제가 발생하는 경우 기술 지원을 위한 서비스 요청을 만들 수 있습니다. 이 문서에서는 다음을 안내합니다.
...
2. **새 지원 요청**에서 **기본**을 선택합니다. **기본**에서 다음 단계를 수행합니다.
    ...
    2. **구독**을 선택 합니다.
    3. **서비스** 아래에서 **모든 서비스**를 선택합니다. 드롭다운 목록에서 **Data Box**을 선택 합니다. 
    4. **지원 계획**을 지정합니다.
    5. **다음**을 클릭합니다.
...
3. **새 지원 요청**에서 **2단계 문제**를 선택합니다. **문제**에서 다음 단계를 수행합니다.
    ...
    8. **다음**을 클릭합니다.
       ...
       ![문제점](./media/data-box-disk-contact-microsoft-support/data-box-disk-support2.png)
...
4. **새 지원 요청**에서 **3단계 연락처 정보**를 클릭합니다. **연락처 정보**에서 다음 단계를 수행합니다.
   ...
   2. **연락처 정보**에서 이름, 전자 메일, 선택적 연락처, 국가/지역을 입력 합니다. **향후 지원 요청에 대한 연락처 변경 내용 저장**을 선택합니다.
   3. **만들기**를 클릭합니다.
...
[Data Box와 관련 된 문제를 해결](data-box-troubleshoot.md)하는 방법을 알아봅니다.
[Data Box Blob storage와 관련 된 문제를 해결](data-box-troubleshoot-rest.md)하는 방법에 대해 알아봅니다.
