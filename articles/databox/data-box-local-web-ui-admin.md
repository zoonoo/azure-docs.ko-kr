...
BOM(Bill of Material) 또는 매니페스트 파일은 Data Box에 복사되는 파일 목록을 포함하고 있습니다. 이러한 파일은 Data Box 배송을 준비할 때 생성됩니다.

시작하기 전에 Data Box에서 **배송 준비** 단계를 완료했는지 확인합니다. 다음 단계에 따라 BOM 또는 매니페스트 파일을 다운로드합니다.

1. Data Box의 로컬 웹 UI로 이동합니다. Data Box가 배송 준비를 완료한 것으로 나타날 것입니다. 디바이스 준비가 완료되면 디바이스 상태가 **배송 준비 완료**로 표시됩니다.
...
이 파일에는 Data Box에 복사된 모든 파일 목록이 포함되어 있습니다. 이 파일의 *crc64* 값은 해당 파일에 대해 생성된 체크섬과 관련이 있습니다.
