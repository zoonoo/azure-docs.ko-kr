...
* **서비스 담당자 전용**: 배터리가 잘못 된 유형으로 대체 된 경우 폭발의 위험. 사용한 배터리는 지침에 따라 폐기하세요.
...
- 다음 환경에서 작동하도록 설계되었습니다. 
    - 운영 온도: 50 ° ~ 95 ° F (10 °에서 35 ° C로)
    - 보관 온도: -4°~122°F(-20°~50°C)
    - 상대 습도: 15% ~ 85% (비응축) 
    - 운영 이상: 최대 6500 피트 (0 미터 ~ 2000 미터) 테스트
...
이 디바이스는 FCC 규칙 파트 15 및 Industry Canada 라이선스 면제 RSS 표준을 따릅니다. 작업에는 다음 두 가지 조건이 적용 됩니다. (1)이 장치에서 유해한 간섭이 발생 하지 않을 수 있으며 (2)이 장치는 장치를 원치 않는 작업을 일으킬 수 있는 간섭을 포함 하 여 수신 된 모든 간섭을 수락 해야 합니다.
