...
| ![안전 주의 사항 읽기 아이콘](./media/data-box-safety/read_safety_and_health_information_icon.png) **먼저 모든 지침 읽기** | |
...
* *받은* 디바이스의 손상을 검사합니다. 디바이스 엔클로저가 손상된 경우 [Microsoft 지원에 문의](data-box-disk-contact-microsoft-support.md)하여 교체품을 받으세요. 디바이스를 작동하려 하지 마세요. 
* 디바이스에 조작 방지 나사가 장착되어 있습니다. 디바이스 오작동이 의심되는 경우 [Microsoft 지원에 문의](data-box-disk-contact-microsoft-support.md)하여 교체품을 받으세요. 디바이스를 정비하려 하지 마세요. 
...
이 장비는 FCC 규칙 파트 15에 따라 테스트한 결과, 클래스 A 디지털 디바이스에 대한 제한을 준수하는 것으로 확인되었습니다. 이러한 제한은 장비가 상용 환경에서 작동할 때 유해한 간섭을 적절하게 차단할 수 있도록 설계되었습니다. 이 장비는 무선 주파수 에너지를 생성 및 사용하고 방출할 수 있으며, 사용 설명서에 따라 설치하고 사용하지 않을 경우 무선 통신에 해로운 간섭을 일으킬 수 있습니다. 주거 지역에서 장비를 작동하면 유해한 간섭이 발생할 수 있으며, 이때 사용자는 자신의 비용으로 간섭을 바로잡아야 합니다.
...
![캐나다에 필요한 알림이 표시된 스크린샷](./media/data-box-safety/canada.png)
...
[EU 적합성 선언문의 복사본을 요청합니다](mailto:CSI_Compliance@microsoft.com).
...
![일본에 필요한 알림을 보여주는 스크린샷](./media/data-box-safety/japan.png)
