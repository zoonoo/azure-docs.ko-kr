...
* *받은* 장치의 손상을 검사합니다. 장치 인클로저가 손상된 경우 Microsoft 지원에 문의하여 교체품을 받으세요. 장치를 작동하려 하지 마세요. 
* 장치에 조작 방지 나사가 장착되어 있습니다. 장치 오작동이 의심되는 경우 Microsoft 지원에 문의하여 교체품을 받으세요. 장치를 정비하려 하지 마세요. 
* 장치에 사용자 서비스 가능 부품이 없습니다. 내부에 위험한 수준의 전압, 전류 및 에너지가 있습니다. 열지 마세요. 장치를 Microsoft로 보내서 점검을 받으세요.
...
* 장치가 기울어지지 않도록 장치를 평평하고 단단하고 안정적인 곳에 배치하세요.
...
* 장치 주변 공기가 원활하게 순환되도록 장치를 작업 영역에 설치하세요.
* 온도가 조절되고 전도성 오염 물질이 없는 실내 영역에 장치를 설치하고 장치 주변 공기를 적절하게 순환해 주세요.
* 액체가 나오는 곳과 습기가 과도하게 높은 환경에서 장치를 사용하지 마세요.
...
* 전원 공급 장치 코드의 플러그가 기본 차단 장치라면, 소켓 콘센트가 장치 근처에 있고 쉽게 액세스할 수 있는지 확인하세요.
* 다음 조건 중 하나라도 있으면 전원 코드를 분리하고(코드가 아닌 플러그를 당겨서) 모든 케이블을 분리하세요.

    - 전원 코드 또는 플러그가 해어지거나 손상되었습니다.
    - 장치 케이스에 무언가를 쏟았습니다.
    - 장치가 비 또는 과도한 습기에 노출되었습니다.
    - 장치가 바닥에 떨어져서 장치 케이스가 손상되었습니다.
    - 장치를 점검하거나 수리를 받아야 할 것 같습니다.
...
* 이 장치는 코인 셀 배터리를 포함하고 있습니다. 장치를 정비하려 하지 마세요. 이 장치의 배터리는 사용자가 점검할 수 없습니다. 
...
* 장치가 실행되는 동안 전면 및 후면 도어를 완전히 개방해야 합니다.
...
전원 공급 등급은 장치와 함께 제공되는 장치 등급 레이블을 참조하세요. 

![참고 아이콘](./media/data-box-safety/notice_icon.png) **고지:** 

Microsoft의 명시적 승인 없이 장치를 변경 또는 수정할 경우 사용자의 장치 작동 권한이 무효화될 수 있습니다.

**캐나다 및 미국:**

![참고 아이콘](./media/data-box-safety/notice_icon.png) **고지:** 

이 장비는 FCC 규칙 파트 15에 따라 테스트한 결과, 클래스 A 디지털 장치에 대한 제한을 준수하는 것으로 확인되었습니다. 이러한 제한은 장비가 상용 환경에서 작동할 때 유해한 간섭을 적절하게 차단할 수 있도록 설계되었습니다. 이 장비는 무선 주파수 에너지를 생성 및 사용하고 방출할 수 있으며, 사용 설명서에 따라 설치하고 사용하지 않을 경우 무선 통신에 해로운 간섭을 일으킬 수 있습니다. 이 장치를 주거 지역에서 작동할 경우 유해한 간섭을 일으킬 수 있으며, 이 경우 사용자가 자비로 간섭을 해결해야 합니다.

이 장치는 FCC 규칙 파트 15 및 Industry Canada 라이선스 면제 RSS 표준을 따릅니다. 작동 시 다음 두 조건이 적용됩니다. (1) 이 장치는 해로운 간섭을 일으키지 않을 것입니다. (2) 이 장치는 오작동을 일으킬 수 있는 간섭을 포함하여 모든 간섭을 받습니다.
...
안전 공지를 검토한 후에는 장치를 설치하고 케이블을 연결합니다.
