...
* *받은* 디바이스의 손상을 검사합니다. 디바이스 인클로저가 손상된 경우 Microsoft 지원에 문의하여 교체품을 받으세요. 디바이스를 작동하려 하지 마세요. 
...
- 다음 환경에서 작동하도록 설계되었습니다. 
    - 온도 운영 합니다. ~ 95 ° F (10 ° 35 ° C)
    - 보관 온도: -4°~122°F(-20°~50°C)
    - 상대 습도: 15%에서 85% (비응축) 
    - 고도 작동 합니다. 최대 6500 미터 (0 2000 미터제로 바뀌는) 테스트
