---
title: Azure Data Box/Azure Data Box Heavy를 통해 핫, 콜드, 보관 blob 계층으로 데이터 보내기
description: Azure Data Box 또는 Azure Data Box Heavy를 사용 하 여 핫, 콜드, 보관 등의 적절 한 블록 blob 저장소 계층으로 데이터를 전송 하는 방법을 설명 합니다.
services: databox
author: alkohli
ms.service: databox
ms.subservice: pod
...
이 문서에서는 Data Box에 업로드된 데이터를 핫/콜드/보관 Blob 계층으로 이동하는 방법을 설명합니다. 이 문서는 Azure Data Box 및 Azure Data Box Heavy에 모두 적용 됩니다.
