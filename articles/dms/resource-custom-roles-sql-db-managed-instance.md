...
* "DMS 역할-앱 ID" 역할은 마이그레이션에 사용 되는 앱 ID에 부여 되어야 하 고 저장소 계정, Azure Database Migration Service 인스턴스 및 SQL Database 관리 되는 인스턴스 리소스 수준 에서도 부여 되어야 합니다.
...
**SQL Database 관리 되는 인스턴스의 앱 ID에 대 한 사용자 지정 역할**
