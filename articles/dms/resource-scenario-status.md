...
> [!IMPORTANT]
> Azure Database Migration Service 비공개 미리 보기에서에서 현재 지 원하는 시나리오를 보려면 합니다 [DMS 미리 보기 사이트](https://aka.ms/dms-preview)합니다.

### <a name="offline-one-time-migration-support"></a>오프라인(일회성) 마이그레이션 지원
다음 표에서 오프 라인 마이그레이션에 대 한 Azure Database Migration Service 지원 합니다.
...
다음 표에서 Azure Database Migration Service, 공개 미리 보기 또는 일반 공급 온라인 마이그레이션 지원이 보여 줍니다.
