...
| Oracle | PostgreSQL용 Azure DB | [MAP 도구 키트](https://msdn.microsoft.com/library/bb977556.aspx)<br/>[Azure Migrate](https://azure.microsoft.com/services/azure-migrate/) |  |  |
...
| PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 | [Azure Migrate](https://azure.microsoft.com/services/azure-migrate/) |  | [TCO 계산기](https://azure.microsoft.com/pricing/tco/calculator/) |
| RDS PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 |  |  | [TCO 계산기](https://azure.microsoft.com/pricing/tco/calculator/) |
...
| Oracle | PostgreSQL 용 Azure DB-단일 서버 |  | [Ora2Pg*](http://ora2pg.darold.net/start.html) |  |
| MongoDB | Cosmos DB |  | [Cloudamize*](https://www.cloudamize.com/) | [Cloudamize*](https://www.cloudamize.com/) |
| Cassandra | Cosmos DB |  |  |  |
...
| PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 |  |  |  |
| RDS PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 |  |  |  |
...
| Oracle | PostgreSQL 용 Azure DB-단일 서버 |  |  | [DMS](https://azure.microsoft.com/services/database-migration/) |
...
| PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 | [PG dump*](https://www.postgresql.org/docs/11/static/app-pgdump.html) |  | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
| RDS PostgreSQL | PostgreSQL 용 Azure DB-단일 서버 | [PG dump*](https://www.postgresql.org/docs/11/static/app-pgdump.html) |  | [DMS](https://azure.microsoft.com/services/database-migration/)<br/>[Attunity*](https://www.attunity.com/products/replicate/)<br/>[Striim*](https://www.striim.com/partners/striim-for-microsoft-azure/) |
