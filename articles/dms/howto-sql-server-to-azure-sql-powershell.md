...
* [Install-Module PowerShell cmdlet](/powershell/module/powershellget/Install-Module)을 사용 하 여 PowerShell 갤러리에서 microsoft.datamigration 모듈을 다운로드 하 고 설치 하려면 관리자 권한으로 실행을 사용 하 여 PowerShell 명령 창을 열어야 합니다.
