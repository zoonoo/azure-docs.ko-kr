...
- [Azure Portal을 사용하여 Azure SQL Database에서 데이터베이스 만들기](https://docs.microsoft.com/azure/sql-database/sql-database-single-database-get-started) 문서의 세부 지침에 따라 Azure SQL Database에 데이터베이스를 만듭니다.
