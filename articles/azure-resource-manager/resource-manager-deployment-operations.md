...
1. 상관 관계 ID를 포함 하 여 배포 요약이 표시 됩니다. 
    ...
    ![배포 요약](./media/resource-manager-deployment-operations/show-correlation-id.png)
...
리소스 그룹에 대 한 배포를 나열 하려면 [az group deployment list](/cli/azure/group/deployment?view=azure-cli-latest#az-group-deployment-list)를 사용 합니다.

```azurecli-interactive
az group deployment list --resource-group ExampleGroup
```

특정 배포를 가져오려면 [az group deployment show](/cli/azure/group/deployment?view=azure-cli-latest#az-group-deployment-show)를 사용 합니다.
...
1. 배포에 대 한 요약에서 **작업 세부 정보**를 선택 합니다.
    ...
    ![배포 작업 선택](./media/resource-manager-deployment-operations/get-operation-details.png)

1. 배포 단계에 대 한 세부 정보가 표시 됩니다. 오류가 발생 하면 세부 정보에 오류 메시지가 포함 됩니다.

    ![작업 세부 정보 표시](./media/resource-manager-deployment-operations/see-operation-details.png)
...
리소스 그룹에 배포 하기 위한 배포 작업을 보려면 [az group deployment operation list](/cli/azure/group/deployment/operation?view=azure-cli-latest#az-group-deployment-operation-list) 명령을 사용 합니다.
