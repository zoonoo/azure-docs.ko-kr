...
- 업로드된 파일은 보호됩니다. 출력 URL에는 배포 중에 파일에 액세스하기 위한 [SAS 토큰](../../storage/common/storage-sas-overview.md?toc=/azure/storage/blobs/toc.json)이 포함됩니다.
