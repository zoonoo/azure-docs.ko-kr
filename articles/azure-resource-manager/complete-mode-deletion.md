...
> | ------------- | ----------- |
> | registrations | 예 |
> | 등록/customerSubscriptions | 아니오 |
> | 등록/제품 | 아니오 |
> | verificationKeys | 아니오 |
...
> | billingAccounts/billingProfiles/송장 | 아니오 |
> | billingAccounts/billingProfiles/청구서/가격표 | 아니오 |
...
> | billingAccounts/billingProfiles/정책 | 아니오 |
> | billingAccounts/billingProfiles/가격표 | 아니오 |
> | billingAccounts / billingProfiles / pricesheetDownloadOperations | 아니오 |
> | billingAccounts/billingProfiles/제품 | 아니오 |
> | billingAccounts/billingProfiles/트랜잭션 | 아니오 |
...
> | billingAccounts/billingSubscriptions/송장 | 아니오 |
...
> | billingAccounts/부서 | 아니오 |
> | billingAccounts / enrollmentAccounts | 아니오 |
> | billingAccounts/송장 | 아니오 |
...
> | billingAccounts/invoiceSections/제품 | 아니오 |
...
> | invoices | 아니오 |
> | transfers | 아니오 |
> | 전송/acceptTransfer | 아니오 |
> | 전송/declineTransfer | 아니오 |
> | 전송/operationStatus | 아니오 |
...
> | reservationOrders/병합 | 아니오 |
> | reservationOrders/예약 | 아니오 |
> | reservationOrders/예약/수정 버전 | 아니오 |
> | reservationOrders/반환 | 아니오 |
> | reservationOrders/분할 | 아니오 |
> | reservationOrders/교환 | 아니오 |
> | reservations | 아니오 |
> | 리소스 | 아니오 |
...
> | ------------- | ----------- |
> | certificateOrders | 예 |
> | certificateOrders/certificate | 아니오 |
...
> | domainNames | 예 |
> | domainNames/기능 | 아니오 |
> | domainNames/internalLoadBalancers 장치 | 아니오 |
> | domainNames/serviceCertificates | 아니오 |
> | domainNames/슬롯 | 아니오 |
> | domainNames/슬롯/역할 | 아니오 |
...
> | expressRouteCrossConnections/피어 링 | 아니오 |
...
> | virtualMachineScaleSets/확장 | 아니오 |
...
> | 레지스트리/빌드 | 아니오 |
> | 레지스트리/빌드/취소 | 아니오 |
> | 레지스트리/빌드/getLogLink | 아니오 |
> | 레지스트리/buildTasks | 예 |
> | 레지스트리/buildTasks/단계 | 아니오 |
> | 레지스트리/eventGridFilters | 아니오 |
> | 레지스트리/generateCredentials | 아니오 |
> | 레지스트리/getBuildSourceUploadUrl | 아니오 |
> | 레지스트리/GetCredentials | 아니오 |
> | 레지스트리/importImage | 아니오 |
> | 레지스트리/queueBuild | 아니오 |
> | 레지스트리/regenerateCredential | 아니오 |
> | 레지스트리/regenerateCredentials | 아니오 |
> | 레지스트리/복제 | 예 |
> | 레지스트리/실행 | 아니오 |
> | 레지스트리/실행/취소 | 아니오 |
> | 레지스트리/scheduleRun | 아니오 |
> | 레지스트리/scopeMaps | 아니오 |
> | 레지스트리/taskRuns | 예 |
> | 레지스트리/작업 | 예 |
> | 레지스트리/토큰 | 아니오 |
> | 레지스트리/updatePolicies | 아니오 |
> | 레지스트리/웹 후크 | 예 |
> | registry/웹 후크/getcallbackconfig | 아니오 |
> | registry/웹 후크/ping | 아니오 |
...
> | ------------- | ----------- |
> | workspaces | 예 |
> | 작업 영역/virtualNetworkPeerings | 아니오 |
...
> | ------------- | ----------- |
> | 계정 | 예 |
> | 계정/dataLakeStoreAccounts | 아니오 |
> | 계정/storageAccounts | 아니오 |
> | 계정/storageAccounts/컨테이너 | 아니오 |
...
> | ------------- | ----------- |
> | 계정 | 예 |
> | 계정/eventGridFilters | 아니오 |
> | 계정/firewallRules | 아니오 |
...
> | clusters | 예 |
> | namespaces | 예 |
> | 네임 스페이스/authorizationrules | 아니오 |
> | 네임 스페이스/disasterrecoveryconfigs | 아니오 |
> | 네임 스페이스/eventhubs | 아니오 |
> | 네임 스페이스/eventhubs/authorizationrules | 아니오 |
> | 네임 스페이스/eventhubs/consumergroups | 아니오 |
...
> | 클러스터/데이터베이스 | 아니오 |
> | 클러스터/데이터베이스/dataconnections | 아니오 |
> | 클러스터/데이터베이스/eventhubconnections | 아니오 |
...
> | offerTypes | 아니오 |
> | offerTypes/게시자 | 아니오 |
> | offerTypes/게시자/제안 | 아니오 |
> | offerTypes/게시자/제품/계획 | 아니오 |
> | offerTypes/게시자/제품/계획/규약 | 아니오 |
> | offerTypes/게시자/제품/계획/configs | 아니오 |
> | offerTypes/publishers/제품/계획/configs/importImage | 아니오 |
...
> | ------------- | ----------- |
> | mediaservices | 예 |
> | windowsazure.mediaservices/accountFilters | 아니오 |
> | windowsazure.mediaservices/자산 | 아니오 |
> | windowsazure.mediaservices/asset/assetFilters | 아니오 |
> | windowsazure.mediaservices/Contentkeypolicy | 아니오 |
> | windowsazure.mediaservices/eventGridFilters | 아니오 |
> | windowsazure.mediaservices/liveEventOperations | 아니오 |
> | windowsazure.mediaservices/liveEvents | 예 |
> | windowsazure.mediaservices/liveEvents/Liveoutput | 아니오 |
> | windowsazure.mediaservices/liveOutputOperations | 아니오 |
> | windowsazure.mediaservices/mediaGraphs | 아니오 |
> | windowsazure.mediaservices/streamingEndpointOperations | 아니오 |
> | windowsazure.mediaservices/streamingEndpoints | 예 |
> | windowsazure.mediaservices/streamingLocators | 아니오 |
> | windowsazure.mediaservices/streamingPolicies | 아니오 |
> | windowsazure.mediaservices/변환 | 아니오 |
> | windowsazure.mediaservices/변환/작업 | 아니오 |
...
> | trafficmanagerprofiles/열 지도 | 아니오 |
...
> | workspaces | 예 |
> | 작업 영역/데이터 원본 | 아니오 |
> | 작업 영역/Linkedservices.json 및 datasets.json | 아니오 |
> | 작업 영역/쿼리 | 아니오 |
...
> | namespaces | 예 |
> | 네임 스페이스/authorizationrules | 아니오 |
> | 네임 스페이스/hybridconnections | 아니오 |
> | 네임 스페이스/hybridconnections/authorizationrules | 아니오 |
> | 네임 스페이스/wcfrelays | 아니오 |
> | 네임 스페이스/wcfrelays/authorizationrules | 아니오 |
...
> | 구독/리소스 | 아니오 |
> | 구독/tagnames | 아니오 |
> | subscription/tagNames/tagValues | 아니오 |
> | tenants | 아니오 |
...
> | 네임 스페이스/authorizationrules | 아니오 |
> | 네임 스페이스/disasterrecoveryconfigs | 아니오 |
> | 네임 스페이스/eventgridfilters | 아니오 |
> | 네임 스페이스/네트워크 규칙 집합 | 아니오 |
> | 네임 스페이스/큐 | 아니오 |
> | 네임 스페이스/큐/authorizationrules | 아니오 |
> | 네임 스페이스/항목 | 아니오 |
> | 네임 스페이스/토픽/authorizationrules | 아니오 |
> | 네임 스페이스/토픽/구독 | 아니오 |
> | 네임 스페이스/항목/구독/규칙 | 아니오 |
...
> | managedInstances/데이터베이스/스키마/테이블/열/sensitivityLabels | 아니오 |
> | managedInstances/databases/vulnerabilityAssessments | 아니오 |
> | managedInstances/databases/vulnerabilityAssessments/rules/기준선 | 아니오 |
> | managedInstances/가 나 보호기 | 아니오 |
> | managedInstances/키 | 아니오 |
...
> | Apimanagementaccount/apiAcls | 아니오 |
> | Apimanagementaccount/api | 아니오 |
> | Apimanagementaccount/api/apiAcls | 아니오 |
> | Apimanagementaccount/api/connectionAcls | 아니오 |
> | Apimanagementaccount/api/연결 | 아니오 |
> | Apimanagementaccount/api/connections/connectionAcls | 아니오 |
> | Apimanagementaccount/api/localizedDefinitions | 아니오 |
> | Apimanagementaccount/connectionAcls | 아니오 |
> | Apimanagementaccount/연결 | 아니오 |
> | billingMeters | 아니오 |
> | 인증서 | 예 |
...
> | 사이트/hostNameBindings | 아니오 |
> | 사이트/네트워크 구성 | 아니오 |
> | 사이트/premieraddons | 예 |
> | 사이트/슬롯 | 예 |
> | 사이트/슬롯/eventGridFilters 필터 | 아니오 |
> | 사이트/슬롯/hostNameBindings | 아니오 |
> | 사이트/슬롯/네트워크 구성 | 아니오 |
> | sourceControls | 아니오 |
> | validate | 아니오 |
