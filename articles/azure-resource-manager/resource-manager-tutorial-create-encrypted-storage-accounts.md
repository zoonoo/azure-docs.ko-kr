...
2. 왼쪽의 TOC에서 **참조**->**저장소**->**저장소 계정**을 선택합니다. **제목으로 필터링** 필터에서 **저장소**를 입력할 수도 있습니다.  이 페이지에는 저장소 계정 정보를 정의하기 위한 스키마가 포함되어 있습니다.
3. 암호화 관련 정보를 탐색합니다.  
...
Visual Studio Code에서 최종 리소스 요소가 다음과 같이 표시되도록 템플릿을 수정합니다.
