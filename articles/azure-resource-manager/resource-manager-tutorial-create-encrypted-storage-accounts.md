...
2. **리소스**를 확장합니다. `Microsoft.Storage/storageAccounts` 리소스가 정의되어 있습니다. 이 템플릿은 암호화되지 않은 스토리지 계정을 만듭니다.
    ...
    ![Resource Manager 템플릿 스토리지 계정 정의](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resource.png)
...
3. 다음 스크린샷과 같이 **참조/템플릿 참조/스토리지/&lt;버저>/스토리지 계정**을 차례로 선택합니다.
    ...
    ![Resource Manager 템플릿 참조 스토리지 계정](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts.png)
...
4. 암호화 관련 정의 정보를 탐색합니다.
    ...
    ![Resource Manager 템플릿 참조 스토리지 계정 암호화](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption.png)
    ...
    ![Resource Manager 템플릿 참조 스토리지 계정 암호화 개체](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-resources-reference-storage-accounts-encryption-object.png)
...
![Resource Manager 템플릿 암호화된 스토리지 계정 리소스](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-resources.png)
...
![Azure Resource Manager 암호화된 스토리지 계정](./media/resource-manager-tutorial-create-encrypted-storage-accounts/resource-manager-template-encrypted-storage-account.png)
