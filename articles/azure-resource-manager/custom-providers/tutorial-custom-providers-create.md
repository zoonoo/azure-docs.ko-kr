...
사용자 지정 공급자는 Azure와 엔드포인트 사이의 계약입니다. 사용자 지정 공급자를 사용하면 Azure에서 워크플로를 변경할 수 있습니다. 이 자습서에서는 사용자 지정 공급자를 만드는 프로세스를 살펴봅니다. Azure 사용자 지정 공급자가 생소한 경우에는 [Azure 사용자 지정 리소스 공급자에 대한 개요](overview.md)를 참조하세요.
