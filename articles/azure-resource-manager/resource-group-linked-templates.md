...
---
# <a name="using-linked-templates-with-azure-resource-manager"></a>Azure Resource Manager에서 연결된 템플릿 사용
...
## <a name="conditionally-linking-to-templates"></a>조건부로 템플릿에 연결
