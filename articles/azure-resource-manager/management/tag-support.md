...
> | privateClouds/workloadNetworks/게이트웨이 | 예 | 예 |
> | privateClouds / workloadNetworks / portMirroringProfiles | 예 | 예 |
> | privateClouds/workloadNetworks/세그먼트 | 예 | 예 |
...
> | billingAccounts/billingProfiles/예약 | 예 | 예 |
...
> | ------------- | ----------- | ----------- |
> | 계정 | 예 | 예 |
> | 계정/privateEndpointConnectionProxies | 예 | 예 |
> | 계정/privateEndpointConnections | 예 | 예 |
> | 계정/privateLinkResources | 예 | 예 |
...
> | registeredSubscriptions | 예 | 예 |
> | 판매 | 예 | 예 |
> | 공급 업체/vendorSkus | 예 | 예 |
> | 공급 업체/vendorSkus/previewSubscriptions | 예 | 예 |
...
> | windowsazure.mediaservices/privateEndpointConnectionOperations | 예 | 예 |
> | windowsazure.mediaservices/privateEndpointConnectionProxies | 예 | 예 |
> | windowsazure.mediaservices/privateEndpointConnections | 예 | 예 |
...
> | iotSecuritySolutions/I이상 권장 사항 | 예 | 예 |
> | IiotRecommendationTypes Securitysolutions/ | 예 | 예 |
> | I이상 센서 | 예 | 예 |
...
> | 별칭 | 예 | 예 |
> | cancel | 예 | 예 |
> | Changeten앤틸리스 요청 | 예 | 예 |
> | Changeten앤틸리스 상태 | 예 | 예 |
