...
> | ------------- | ----------- | ---------- |
> | 위치 | 예 | 예 |
> | locations / checkquotaavailability | 예 | 예 |
> | 작업 | 예 | 예 |
> | privateclouds | 예 | 예 |
...
> | 작업 | 예 | 예 |
> | workspaces | 예 | 예 |
> | workspaces / clusters | 예 | 예 |
> | workspaces / experiments | 예 | 예 |
> | workspaces / experiments / jobs | 예 | 예 |
> | workspaces / fileservers | 예 | 예 |
