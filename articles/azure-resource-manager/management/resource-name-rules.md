...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | 서비스 | 글로벌 | 1-50 | 영숫자와.<br><br>문자로 시작 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | blockchainMembers | 글로벌 | 2-20 | 소문자 및 숫자<br><br>소문자로 시작 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | botServices | 글로벌 | 2-64 |  영숫자, 밑줄, 마침표 및 하이픈입니다.<br><br>영숫자로 시작 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | Redis | 글로벌 | 1-63 | 영숫자 및 하이픈<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. 연속 하이픈이 허용 되지 않습니다. |
...
> | 프로필/끝점 | 글로벌 | 1-50 | 영숫자 및 하이픈<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
...
> | virtualMachines | 리소스 그룹 | 1-15 (Windows)<br>1-64 (Linux)<br><br>다음 참고를 참조하세요. | 사용할 수 없음:<br> `\/""[]:|<>+=;,?*@&`<br><br>밑줄로 시작할 수 없습니다. 마침표 또는 하이픈으로 끝날 수 없습니다. |
> | virtualMachineScaleSets | 리소스 그룹 | 1-15 (Windows)<br>1-64 (Linux)<br><br>다음 참고를 참조하세요. | 사용할 수 없음:<br> `\/""[]:|<>+=;,?*@&`<br><br>밑줄로 시작할 수 없습니다. 마침표 또는 하이픈으로 끝날 수 없습니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | containerGroups | 리소스 그룹 | 1-63 | 소문자, 숫자 및 하이픈<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. 연속 하이픈은 허용되지 않습니다. |
...
> | 허브/a p i 정책 | 허브 | 1-50 | 영숫자, 밑줄 및 마침표입니다.<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
> | 허브/커넥터 | 허브 | 1-128 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/커넥터/매핑 | 커넥터 | 1-128 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/상호 작용 | 허브 | 1-128 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/kpi | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/링크 | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/예측 | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/프로필 | 허브 | 1-128 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/relationshipLinks | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/관계 | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/역할 할당 | 허브 | 1-128 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
> | 허브/뷰 | 허브 | 1-512 | 영숫자 및 밑줄<br><br>문자로 시작 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | factories | 글로벌 | 3-63 | 영숫자 및 하이픈<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | 서버 | 글로벌 | 3-63 | 소문자, 하이픈 및 숫자입니다.<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. |
...
> | IotHubs/인증서 | IoT 허브 | 1-64 | 영숫자, 하이픈, 마침표 및 밑줄 |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | databaseAccounts | 글로벌 | 3-31 | 소문자, 숫자 및 하이픈<br><br>소문자 또는 숫자로 시작 합니다. |
...
> | 네임스페이스 | 글로벌 | 6-50 | 영숫자 및 하이픈<br><br>문자로 시작 합니다. 문자 또는 숫자로 끝납니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | clusters | 글로벌 | 3-59 | 영숫자 및 하이픈<br><br>문자 또는 숫자로 시작 하 고 종료 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | IoTApps | 글로벌 | 2-63 | 소문자, 숫자 및 하이픈<br><br>소문자 또는 숫자로 시작 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | vaults | 글로벌 | 3-24 | 영숫자 및 하이픈<br><br>문자로 시작 합니다. 문자 또는 숫자로 끝납니다. 연속 하이픈을 포함할 수 없습니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | clusters | 글로벌 | 4-22 | 소문자 및 숫자<br><br>문자로 시작 합니다. |
...
> | frontDoors | 글로벌 | 5-64 | 영숫자 및 하이픈<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
...
> | trafficmanagerprofiles | 글로벌 | 1-63 | 영숫자, 하이픈 및 마침표입니다.<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | 네임스페이스 | 글로벌 | 6-50 | 영숫자 및 하이픈<br><br>영숫자를 사용 하 여 시작 하 고 종료 합니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | 네임스페이스 | 글로벌 | 6-50 | 영숫자 및 하이픈<br><br>문자로 시작합니다. 문자 또는 숫자로 끝납니다.<br><br>자세한 내용은 [네임 스페이스 만들기](/rest/api/servicebus/create-namespace)를 참조 하세요. |
> | 네임 스페이스/AuthorizationRules | 네임스페이스 | 1-50 | 영숫자, 마침표, 하이픈 및 밑줄<br><br>Alphnumeric로 시작 하 고 종료 합니다. |
> | 네임 스페이스/disasterRecoveryConfigs | 글로벌 | 6-50 | 영숫자 및 하이픈<br><br>문자로 시작 합니다. 영숫자로 끝납니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | signalR | 글로벌 | 3-63 | 영숫자 및 하이픈<br><br>문자로 시작 합니다. 문자 또는 숫자로 끝납니다.  |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | managedInstances | 글로벌 | 1-63 | 소문자, 숫자 및 하이픈<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. |
> | 서버 | 글로벌 | 1-63 | 소문자, 숫자 및 하이픈<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. |
...
> | servers/failoverGroups | 글로벌 | 1-63 | 소문자, 숫자 및 하이픈<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. |
...
> | 엔터티 | 범위 | 길이 | 사용할 수 있는 문자 |
> | --- | --- | --- | --- |
> | storageAccounts | 글로벌 | 3-24 | 소문자 및 숫자 |
...
> | sites | 글로벌 | 2-60 | 영숫자 및 하이픈을 포함 합니다.<br><br>하이픈으로 시작 하거나 끝날 수 없습니다. |
