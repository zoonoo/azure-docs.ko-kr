...
동일한 구독 내에서 새 리소스 그룹으로 클래식 리소스를 이동 하려면 포털, Azure PowerShell Azure CLI 또는 REST API를 통해 [표준 이동 작업](../move-resource-group-and-subscription.md) 을 사용 합니다. Resource Manager 리소스 이동을 위해 사용하는 동일한 작업을 사용합니다.
