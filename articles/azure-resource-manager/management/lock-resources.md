...
리소스 그룹에 대한 잠금을 설정하는 방법에 대한 예제는 [리소스 그룹 만들기 및 잠그기](https://github.com/Azure/azure-quickstart-templates/tree/master/subscription-level-deployments/create-rg-lock-role-assignment)를 참조하세요.
