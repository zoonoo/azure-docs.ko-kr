...
ms.locfileid: "74146520"
---
# <a name="manage-azure-resources-by-using-azure-powershell"></a>Azure PowerShell를 사용 하 여 Azure 리소스 관리

[Azure Resource Manager](resource-group-overview.md) 에서 Azure PowerShell를 사용 하 여 Azure 리소스를 관리 하는 방법을 알아봅니다. 리소스 그룹 관리에 대 한 자세한 내용은 [Azure PowerShell를 사용 하 여 Azure 리소스 그룹 관리](./manage-resource-groups-powershell.md)를 참조 하세요.
...
태그를 지정 하면 리소스 그룹 및 리소스를 논리적으로 구성할 수 있습니다. 자세한 내용은 [태그를 사용 하 여 Azure 리소스 구성](./resource-group-using-tags.md#powershell)을 참조 하세요.
