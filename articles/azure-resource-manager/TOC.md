...
## [지원되는 서비스, 지역 및 API 버전](resource-manager-supported-services.md)
## [Resource Manager 및 클래식 배포 이해](resource-manager-deployment-model.md)
## [규범적 구독 거버넌스](resource-manager-subscription-governance.md)
## [엔터프라이즈를 위한 거버넌스 예제](resource-manager-subscription-examples.md)
