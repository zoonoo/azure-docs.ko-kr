...
인라인 설명의 경우 `//` 또는 `/* ... */`를 사용할 수 있습니다.

> [!NOTE]
>
> 설명과 함께 템플릿을 배포하려면 Azure PowerShell 또는 Azure CLI를 사용합니다. CLI의 경우 버전 2.3.0 이상을 사용하고 `--handle-extended-json-format` 스위치를 지정합니다.
>
