...
1. 왼쪽 메뉴에서 **확장** 을 선택 합니다. 또는 **보기** 메뉴에서 **확장** 을 선택 하 여 확장 창을 엽니다.
    ...
    ![Visual Studio Code 리소스 관리자 도구 확장 설치](./media/use-vs-code-to-create-template/resource-manager-visual-studio-code-tools-extension.png)
1. **리소스 관리자**를 검색 합니다.
...
![Visual Studio Code 리소스 관리자 도구 확장 색 지정](./media/use-vs-code-to-create-template/resource-manager-tools-extension-colorization.png)
...
- 기본 제공 함수 이름
    ...
    ![Visual Studio Code 리소스 관리자 도구 확장 intellisense 함수](./media/use-vs-code-to-create-template/resource-manager-tools-extension-intellisense-functions.png)

- 매개 변수 참조

    ![Visual Studio Code 리소스 관리자 도구 확장 intellisense 매개 변수](./media/use-vs-code-to-create-template/resource-manager-tools-extension-intellisense-parameters.png)

- 변수 참조

    ![Visual Studio Code 리소스 관리자 도구 확장 intellisense 변수](./media/use-vs-code-to-create-template/resource-manager-tools-extension-intellisense-variables.png)

- resourceGroup () 속성

    ![Visual Studio Code 리소스 관리자 도구 확장 intellisense 함수](./media/use-vs-code-to-create-template/resource-manager-tools-extension-intellisense-resourcegroup.png)
...
![Visual Studio Code 리소스 관리자 도구 확장 서명 함수](./media/use-vs-code-to-create-template/resource-manager-tools-extension-signature-function.png)

### <a name="go-to-definition-for-variable-and-parameter-references"></a>변수 및 매개 변수 참조에 대 한 정의로 이동

**Ctrl + 클릭**을 사용 하 여 정의로 이동 하거나 스크린샷에 표시 된 상황에 맞는 메뉴를 사용 하 여 (![Visual Studio Code 리소스 관리자 도구 확장 정의로 이동)를 사용할 수 있습니다](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
...
![Visual Studio Code 리소스 관리자 도구 확장 피킹 편집기](./media/use-vs-code-to-create-template/resource-manager-tools-extension-peek-editor.png)
...
![Visual Studio Code 리소스 관리자 도구 확장 모든 참조 찾기](./media/use-vs-code-to-create-template/resource-manager-tools-extension-find-all-references.png)
...
![Visual Studio Code 리소스 관리자 도구 확장 가리키기 정의](./media/use-vs-code-to-create-template/resource-manager-tools-extension-hover-parameters.png)

### <a name="brace-matching"></a>중괄호 일치

짝이 되는 대괄호는 커서가 그 근처에 있는 즉시 강조 표시 됩니다. 중괄호를 클릭 하면 다음 스크린샷에 표시 된 것 처럼 짝이 되는 중괄호도 강조 표시 됩니다.

![Visual Studio Code 리소스 관리자 도구 확장 중괄호 일치](./media/use-vs-code-to-create-template/resource-manager-tools-extension-brace-matching.png)
...
- Visual Studio Code를 사용 하 여 빠른 시작을 진행 하려면 [빠른 시작:를 사용 하 여 Azure Resource Manager 템플릿 만들기](quickstart-create-templates-use-visual-studio-code.md) 를 참조 하세요 Visual Studio Code
