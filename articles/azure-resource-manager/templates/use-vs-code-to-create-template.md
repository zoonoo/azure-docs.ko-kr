...
**Ctrl + 클릭**을 사용 하거나 스크린샷에 표시 된 상황에 맞는 메뉴를 사용 하 여 해당 정의로 이동할 수 있습니다 ![. Visual Studio Code 리소스 관리자 도구 확장 정의로 이동](./media/use-vs-code-to-create-template/resource-manager-tools-extension-context-menu.png)
