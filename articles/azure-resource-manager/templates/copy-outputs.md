...
description: Azure Resource Manager 템플릿 (ARM 템플릿)의 복사 작업을 사용 하 여 배포에서 값을 반환할 때 여러 번 반복 합니다.
ms.topic: conceptual
ms.date: 04/17/2020
...
ms.locfileid: "96905947"
---
# <a name="output-iteration-in-arm-templates"></a>ARM 템플릿의 출력 반복

이 문서에서는 Azure Resource Manager 템플릿 (ARM 템플릿)에서 출력에 대 한 값을 두 개 이상 만드는 방법을 보여 줍니다. `copy`템플릿의 출력 섹션에 요소를 추가 하 여 배포 하는 동안 여러 항목을 동적으로 반환할 수 있습니다.
