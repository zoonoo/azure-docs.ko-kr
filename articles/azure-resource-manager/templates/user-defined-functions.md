...
* 함수는 [dateTimeAdd](template-functions-date.md#datetimeadd) 함수를 사용할 수 없습니다.
* 함수의 매개 변수는 기본값을 가질 수 없습니다.

## <a name="next-steps"></a>다음 단계

* 사용자 정의 함수에 사용할 수 있는 속성에 대한 자세한 내용은 [ARM 템플릿의 구조 및 구문 이해](./syntax.md)를 참조하세요.
