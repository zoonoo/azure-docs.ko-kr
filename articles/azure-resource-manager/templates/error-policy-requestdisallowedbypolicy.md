...
description: Azure 리소스 관리자를 사용 하 여 리소스를 배포할 때 RequestDisallowedByPolicy 오류의 원인을 설명 합니다.
author: genlin
...
- [규정 준수를 시행하기 위한 정책 생성 및 관리](../../governance/policy/tutorials/create-and-manage.md)
