...
* Azure 구독에 대 한 [서비스 연결](/azure/devops/pipelines/library/connect-to-azure?view=azure-devops) 을 구성 했습니다. 파이프라인의 작업은 서비스 주체의 id로 실행 됩니다. 연결을 만드는 단계는 [DevOps 프로젝트 만들기](template-tutorial-use-azure-pipelines.md#create-a-devops-project)를 참조 하세요.
...
리소스 관리자 템플릿과 함께 Azure Pipelines를 사용 하는 방법에 대 한 단계별 프로세스는 [자습서: Azure Resource Manager 템플릿의 연속 통합 Azure Pipelines](template-tutorial-use-azure-pipelines.md)를 참조 하세요.
