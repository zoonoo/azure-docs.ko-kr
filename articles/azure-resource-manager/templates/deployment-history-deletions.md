...
배포는 790 배포에 도달할 때 배포 기록에서 삭제 됩니다. Azure Resource Manager는 향후 배포를 위해 공간을 확보 하기 위해 가장 오래 된 배포의 작은 집합을 삭제 합니다. 대부분의 기록은 변경 되지 않은 상태로 유지 됩니다. 가장 오래 된 배포는 항상 먼저 삭제 됩니다.
