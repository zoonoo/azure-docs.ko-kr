...
* 종속성 설정 시 권장 사항은 [ARM 템플릿 모범 사례](./best-practices.md)를 참조하세요.
* 배포 중 종속성 문제 해결에 대해 알아보려면 [Azure Resource Manager를 사용한 일반적인 Azure 배포 오류 해결](common-deployment-errors.md)을 참조하세요.
* Azure Resource Manager 템플릿 만들기에 대해 알아보려면 [ARM 템플릿의 구조 및 구문 이해](./syntax.md)를 참조하세요.
