...
[이전 자습서](./deployment-tutorial-linked-template.md)에서 연결된 템플릿을 배포합니다.  이 자습서에서는 Azure Pipelines를 사용하여 Azure Resource Manager 템플릿을 지속적으로 빌드하고 배포하는 방법에 대해 알아봅니다.
