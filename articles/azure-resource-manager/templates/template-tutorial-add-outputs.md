...
description: 구문을 간소화하기 위해 ARM 템플릿(Azure Resource Manager 템플릿)에 출력을 추가합니다.
author: mumian
ms.date: 03/27/2020
ms.topic: tutorial
ms.author: jgao
...
ms.locfileid: "101707288"
---
# <a name="tutorial-add-outputs-to-your-arm-template"></a>자습서: ARM 템플릿에 출력 추가

이 자습서에서는 ARM 템플릿(Azure Resource Manager 템플릿)에서 값을 반환하는 방법에 대해 알아봅니다. 배포된 리소스의 값이 필요한 경우 출력을 사용합니다. 이 자습서를 완료하는 데 **7분** 이 소요됩니다.
