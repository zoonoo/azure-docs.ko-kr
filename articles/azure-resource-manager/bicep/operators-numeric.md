...
ms.locfileid: "111027231"
---
# <a name="bicep-numeric-operators"></a>Bicep 숫자 연산자

숫자 연산자는 정수를 사용하여 계산을 수행하고 정수 값을 반환합니다. 예제를 실행하려면 Azure CLI 또는 Azure PowerShell을 사용하여 [Bicep 파일을 배포](./quickstart-create-bicep-use-visual-studio-code.md#deploy-the-bicep-file)합니다.
