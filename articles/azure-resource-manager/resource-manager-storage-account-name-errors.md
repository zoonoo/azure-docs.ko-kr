...
Storage 계정 이름은 3자에서 24자 사이여야 하고 숫자 및 소문자만 사용해야 합니다. 이름은 고유 해야 합니다.

## <a name="solution"></a>해결 방법

스토리지 계정 이름이 고유한지 확인합니다. 명명 규칙과 [uniqueString](resource-group-template-functions-string.md#uniquestring) 함수 결과를 연결하여 고유한 이름을 만들 수 있습니다.
...
스토리지 계정 이름이 24자를 초과하지 않는지 확인합니다. [uniqueString](resource-group-template-functions-string.md#uniquestring) 함수는 13자를 반환합니다. **uniqueString** 결과에 접두사 또는 접미사를 연결하는 경우 11자 이하의 값을 제공합니다.
