...
description: Azure PowerShell를 사용 하 여 Azure Resource Manager 그룹을 관리 합니다.
...
[Azure Resource Manager](resource-group-overview.md) 에서 Azure PowerShell를 사용 하 여 Azure 리소스 그룹을 관리 하는 방법을 알아봅니다. Azure 리소스 관리에 대 한 자세한 내용은 [Azure PowerShell를 사용 하 여 azure 리소스 관리](./manage-resources-powershell.md)를 참조 하세요.
...
리소스 그룹 및 리소스에 태그를 적용하여 논리적으로 자산을 구성할 수 있습니다. 자세한 내용은 [태그를 사용 하 여 Azure 리소스 구성](./resource-group-using-tags.md#powershell)을 참조 하세요.
