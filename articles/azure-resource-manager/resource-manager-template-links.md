---
title: "리소스 연결을 위한 Resource Manager 템플릿 | Microsoft Docs"
...
---
# <a name="resource-links-template-schema"></a>리소스 링크 템플릿 스키마
...
| 이름 |String<br />필수<br />**{resouce}/Microsoft.Resources/{linkname}**<br /> 최대 64자, <, > %, &, ? 또는 제어 문자는 포함할 수 없습니다.<br /><br />원본 리소스의 이름과 링크에 대한 이름을 둘 다 지정하는 값입니다. |
| dependsOn |배열<br />옵션<br />리소스 이름 또는 리소스 고유 식별자의 쉼표로 구분된 목록입니다.<br /><br />이 링크에 따라 달라지는 리소스 컬렉션입니다. 연결하는 리소스가 동일한 템플릿에서 배포되는 경우 이 요소의 해당 리소스 이름을 포함하여 먼저 배포되도록 합니다. |
| properties |Object<br />필수<br />[properties 개체](#properties)<br /><br />연결할 리소스를 식별하는 개체 및 링크에 대한 메모입니다. |
...
| 이름 | 값 |
| --- | --- |
| 대상 ID |문자열<br />필수<br />**{resource id}**<br /><br />. |
| 정보 |String<br />옵션<br />최대 512자<br /><br />잠금에 대한 설명입니다. |

## <a name="how-to-use-the-link-resource"></a>링크 리소스를 사용하는 방법
