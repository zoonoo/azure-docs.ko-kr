...
####저장소 계정 가져오기
이 자습서의 나머지 부분을 계속 완료하려면 저장소 계정이 필요합니다. 이 작업을 수행하는 방법을 잘 모를 경우 [Azure 저장소 계정 만들기]를(#tutorial1_storage)참조하세요.
...
>[WACOM.NOTE] Azure 저장소 팀은 파일 업로드에 도움이 될 수 있는 Azure 저장소 탐색기를 표시하는 [블로그 게시물](http://blogs.msdn.com/b/windowsazurestorage/archive/2014/03/11/windows-azure-storage-explorers-2014.aspx)(영문)을 제공합니다.
