...
> [!NOTE]
> 프로그래밍 방식으로 만든 Stream Analytics 작업은 기본적으로 모니터링이 설정되어 있지 않습니다.  작업 모니터 페이지로 이동 하 고 사용 단추를 클릭 하 여 Azure Portal에서 모니터링을 수동으로 사용 하도록 설정 하거나, [Azure Stream Analytics-프로그래밍 방식으로 Stream Analytics 작업 모니터링](stream-analytics-monitor-jobs.md)에 있는 단계를 수행 하 여 프로그래밍 방식으로이 작업을 수행할 수 있습니다.
> 
> 
