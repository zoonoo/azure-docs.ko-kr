...
> [!NOTE]
> `Script`파일에 생성 된 **testConfig.js** 의 값은 컨텍스트를 제공 하기 위한 것입니다. 테스트 논리에는 사용 되지 않습니다. 
...
> [!NOTE]
> 현재 요소에 허용 되는 값은 이며 기본값 이기도 합니다 `ScriptType` `InputMock` . 이 값을 다른 값으로 설정 하면 무시 되 고 기본값 ( `InputMock` )이 사용 됩니다. 
