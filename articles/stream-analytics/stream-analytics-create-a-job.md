...
4.  새 스트림 분석 작업 옵션이 구성되면 **스트림 분석 작업 만들기**를 클릭합니다. 스트림 분석 작업을 만드는 데 몇 분 정도 걸릴 수 있습니다. 상태를 확인하려면 알림 허브에서 진행률을 모니터링할 수 있습니다.
    ...
    ![Azure Preview 포털 데이터 분석 처리 작업 만들기](./media/stream-analytics-create-a-job/5-stream-analytics-create-a-job.png)
...
5.  새 작업이 **생성됨** 상태로 표시됩니다. **시작** 단추를 사용할 수 없습니다. 작업을 시작하려면 먼저 작업 입력, 쿼리 및 출력을 구성해야 합니다.
    ...
    ![Azure Preview 포털 데이터 분석 처리 작업 상태](./media/stream-analytics-create-a-job/6-stream-analytics-create-a-job.png)
