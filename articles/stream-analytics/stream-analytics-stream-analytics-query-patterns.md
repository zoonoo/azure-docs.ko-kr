...
| Make |Dispatch_to_lane | 시간 |
| --- | --- | --- |
| Make1 |은 |2015-01-01T00:오전 12:01.0000000Z |
...
| Make | 시간 | Current_car_license_plate | First_car_license_plate | First_car_time |
| --- | --- | --- | --- | --- |
...
| 사용자 | 기능 | 이벤트 | 시간 |
| --- | --- | --- | --- |
| user@location.com |RightMenu |Start |2015-01-01T00:오전 12:01.0000000Z |
...
**COUNT(DISTINCT Time)** 는 시간 범위 내에서 Time 열의 고유한 값 수를 반환합니다. 그런 다음 첫 번째 단계의 출력은 중복 항목을 삭제 하 여 장치당 평균을 계산 하는 데 사용할 수 있습니다.
...
## <a name="language-extensibility-with-user-defined-function-in-javascript-and-c"></a>JavaScript 및 C에서 사용자 정의 함수가 포함 된 언어 확장성 #
...
자세한 내용은 [JavaScript](/azure/stream-analytics/stream-analytics-javascript-user-defined-functions) 및 [c #](/azure/stream-analytics/stream-analytics-edge-csharp-udf)을 참조 하세요.
