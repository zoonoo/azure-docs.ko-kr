...
---
# <a name="test-stream-analytics-queries-locally-with-sample-data-using-visual-studio-code"></a>Visual Studio Code를 사용 하 여 샘플 데이터를 사용 하 여 로컬로 쿼리 Stream Analytics 테스트
