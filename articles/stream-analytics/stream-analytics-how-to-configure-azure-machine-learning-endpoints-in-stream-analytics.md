---
title: 스트림 분석에서 Azure 기계 학습 끝점을 구성하는 방법 | Microsoft Docs
...
---
# <a name="machine-learning-integration-in-stream-analytics"></a>스트림 분석의 기계 학습 통합
...
## <a name="overview:-azure-machine-learning-terminology"></a>개요: Azure 기계 학습 용어
...
## <a name="machine-learning-resources-that-needed-for-stream-analytics-jobs"></a>스트림 분석 작업에 필요한 기계 학습 리소스
...
## <a name="configure-a-stream-analytics-and-machine-learning-udf-via-rest-api"></a>REST API를 통해 스트림 분석 및 기계 학습 UDF 구성
...
## <a name="implement-stream-analytics-transformation-to-call-the-udf"></a>UDF를 호출하는 스트림 분석 변환 구현
