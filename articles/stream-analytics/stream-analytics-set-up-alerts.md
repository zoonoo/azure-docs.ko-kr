...
포털을 통한 작업 로그 데이터에서 프로그래밍 방식으로 메트릭에 대한 규칙을 정의할 수 [있습니다.](https://code.msdn.microsoft.com/windowsazure/Receive-Email-Notifications-199e2c9a)

## <a name="set-up-alerts-in-the-azure-portal"></a>Azure Portal에서 경고 설정
### <a name="get-alerted-when-a-job-stops-unexpectedly"></a>작업이 예기치 않게 중지될 때 경고 받기
...
5. **신호 논리 구성**에서 **이벤트 수준**을 **모두**로 변경하고 **상태**를 **실패**로 변경합니다. 빈 **으로 시작된 이벤트를** 두고 **완료를**선택합니다.
