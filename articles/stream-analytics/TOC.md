...
## 확장
### [스트리밍 단위로 크기 조정](stream-analytics-streaming-unit-consumption.md)
### [쿼리 병렬화로 크기 조정](stream-analytics-parallelization.md)
#### [처리량 증가](stream-analytics-scale-jobs.md)
### [ML 함수로 크기 조정](stream-analytics-scale-with-machine-learning-functions.md)

## 자동화
### [.NET SDK 사용](stream-analytics-dotnet-management-sdk.md)
### [Azure PowerShell 사용](https://github.com/Azure/azure-stream-analytics/tree/master/Samples/ASAOneClick)
...
### [SELECT INTO 문](stream-analytics-select-into.md)
### [이벤트 허브 수신기](stream-analytics-event-hub-consumer-groups.md)
