...
Stream Analytics는 다양한 입력 및 출력 형식을 지원합니다. 작업에서 입력 및 출력 리소스에 액세스할 수 있도록 클러스터에 [프라이빗 엔드포인트를 만들](private-endpoints.md) 수 있습니다. 현재 Azure SQL Database, Azure Cosmos DB, Azure Storage, Azure Data Lake Storage Gen2, Azure Event Hub, Azure IoT Hubs, Azure Function 및 Azure Service Bus는 관리형 프라이빗 엔드포인트를 만들 수 있도록 지원되는 서비스입니다. 
