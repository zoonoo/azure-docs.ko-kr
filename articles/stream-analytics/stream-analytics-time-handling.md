...
원본 시스템이나 네트워크에서 지연을 고려하기 위해 temporal 논리가 사용되는 경우 페이로드에 타임스탬프를 사용하는 것이 중요합니다. 이벤트에 할당된 시간은 [SYSTEM.TIMESTAMP](/stream-analytics-query/system-timestamp-stream-analytics)에서 사용할 수 있습니다.
...
- [Azure Stream Analytics 이벤트 순서 고려 사항]()
