---
title: Visual Studio Code (미리 보기)를 사용 하 여 로컬로 쿼리 Azure Stream Analytics 테스트
...
1. Stream Analytics 작업을 만들었으면 **Ctrl + Shift + P** 를 사용 하 여 명령 팔레트를 엽니다. 그런 다음 **ASA를 입력 하 고 선택 합니다. Add Input**을 입력합니다.
