...
했으면 [패키지를 다운로드 한](https://www.npmjs.com/package/azure-streamanalytics-cicd), 다음 명령을 사용 하 여 Azure Resource Manager 템플릿 출력 합니다. 경우는 **outputPath** 지정 하지 않으면 서식 파일에 배치 됩니다 합니다 **배포** 프로젝트의 폴더 **bin** 폴더입니다.
