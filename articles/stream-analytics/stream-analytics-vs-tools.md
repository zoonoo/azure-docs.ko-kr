...
description: 이 문서에서는 Visual Studio에서 Azure Stream Analytics 작업을 보고 관리 하는 방법을 설명 합니다.
...
* [자습서: Azure Pipelines를 사용 하 여 CI/CD로 Azure Stream Analytics 작업 배포](stream-analytics-tools-visual-studio-cicd-vsts.md)
