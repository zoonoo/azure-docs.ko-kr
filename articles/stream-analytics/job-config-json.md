...
|StreamingUnits|integer|Yes|스트리밍 작업에서 사용 하는 스트리밍 단위 수를 지정 합니다.|
...
|ScriptType|문자열|Yes|이 소스 파일의 형식을 나타내는 예약 된 속성입니다. 사용할 수 있는 값은 JobConfig.js에 "JobConfig"입니다.|
...
* [CI/CD npm 패키지를 사용 하 여 Azure Stream Analytics 작업 배포](./cicd-overview.md)