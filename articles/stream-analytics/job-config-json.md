...
* [Visual Studio Code를 사용 하 여 샘플 데이터를 사용 하 여 로컬로 쿼리 Stream Analytics 테스트](visual-studio-code-local-run.md)
* [CI/CD npm 패키지를 사용 하 여 Azure Stream Analytics 작업을 배포](setup-cicd-vs-code.md)
