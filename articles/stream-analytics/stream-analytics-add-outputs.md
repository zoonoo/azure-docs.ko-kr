...
2. 출력의 형식을 지정합니다.
    ...
    ![Azure Preview 포털 데이터 이동 형식 선택](./media/stream-analytics-add-outputs/6-stream-analytics-add-outputs.png)
...
4. 출력 형식에 따라 데이터를 직렬화하거나 형식을 지정하는 방법을 지정해야 할 수도 있습니다. 각 출력 형식에 대한 특정 직렬화 설정은 여기에 문서화되어 있습니다.
    ...
    ![이벤트 허브로 Azure Preview 포털 데이터 출력](./media/stream-analytics-add-outputs/7-stream-analytics-add-outputs.png)
