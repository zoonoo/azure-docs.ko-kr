---
title: 스트림 분석에서 참조 데이터 및 조회 테이블 사용 | Microsoft Docs
...
> [!NOTE]
> 현재 스트림 분석 작업은 컴퓨터 시간이 Blob 이름에 인코딩된 시간으로 진행하는 경우에만 Blob 새로 고침을 찾습니다. 예를 들어 작업은 가능한 빨리 `sample/2015-04-16/17:30/products.csv`을(를) 찾지만 표준 시간대 2015년 4월 16일 오후 5시 30분보다 이르지 않습니다. 발견된 마지막 파일보다 이전에 인코딩된 시간으로 파일을 찾지 *않습니다*.
> 
