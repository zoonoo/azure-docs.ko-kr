...
API 엔드포인트는 _api_ 경로를 통해 웹앱에서 사용할 수 있습니다. 이 경로가 고정 되어 있는 동안 연결 된 Azure Functions 앱을 찾는 폴더와 프로젝트를 제어할 수 있습니다. 리포지토리의 _.github/workflows_ 에 있는 [워크플로 YAML 파일을 편집](github-actions-workflow.md#build-and-deploy)하여 이 위치를 변경할 수 있습니다.
