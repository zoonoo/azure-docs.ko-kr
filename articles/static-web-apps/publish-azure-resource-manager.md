...
- **Azure CLI 또는 Azure PowerShell**: ARM 템플릿을 배포하려면 명령줄 도구가 필요합니다. 설치 지침은 다음을 참조하세요.
  - [Windows OS에 Azure CLI 설치](https://docs.microsoft.com/cli/azure/install-azure-cli-windows)
  - [Linux OS에 Azure CLI 설치](https://docs.microsoft.com/cli/azure/install-azure-cli-linux)
  - [macOS에 Azure CLI 설치](https://docs.microsoft.com/cli/azure/install-azure-cli-macos)
