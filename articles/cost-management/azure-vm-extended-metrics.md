...
예를 들어 Azure VM의 CPU %와 메모리 %를 모니터링하고자 할 수 있습니다. Azure VM 메트릭은 사용 중인 _CPU의 백분율_ 및 _\memory @ No__t-2 커밋된 바이트_에 해당 합니다.
...
표준 메트릭은 호스트 컴퓨터 메트릭입니다. _CPU의 백분율_ 메트릭은 한 가지 예입니다. 게스트 VM의 기본 메트릭도 있는데 역시 확장 메트릭이라고 합니다. 확장 메트릭의 예로는 _\Memory @ no__t-1 커밋된 바이트 사용_ 및 _\Memory\available bytes_가 있습니다.
