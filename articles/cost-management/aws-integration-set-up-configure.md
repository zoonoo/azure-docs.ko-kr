...
비용 및 사용 현황 보고서 사용 권한을 구성 합니다.

1. 형식 **비용 및 사용 현황 보고서**합니다.
2. 선택 **액세스 수준**하십시오 **읽기** > **DescribeReportDefinitions**합니다. 이렇게 하면 Cost Management는 현재 정의 되어 있고 보고서 정의 필수 구성 요소 일치 하는지 확인 보고서 읽기 수 있습니다.
3. 클릭 **사용 권한을 추가**합니다.

S3 버킷 및 개체 권한을 구성 합니다.

1. 클릭 **서비스를 선택**합니다.
2. 형식 _S3_합니다.
3. 선택 **액세스 수준**하십시오 **목록** > **ListBucket**합니다. 이 작업 S3 버킷에서 개체 목록을 가져옵니다.
4. 선택 **액세스 수준**하십시오 **읽기** > **GetObject**합니다. 이 작업을 사용 하면 파일 다운로드를 청구 합니다.
5. 선택 **리소스**합니다.
6. 선택 **버킷 – 추가 ARN**합니다.
...
비용 탐색기 사용 권한을 구성 합니다.

1. 클릭 **서비스를 선택**합니다.
2. 형식 _탐색기 서비스 비용_합니다.
...
3. **정책 검토**, 새 정책의 이름을 입력 합니다. 올바른 정보를 입력 했는지 확인 한 다음 클릭 확인 **정책 만들기**합니다.
4. 이전 탭으로 돌아가서 브라우저의 웹 페이지를 새로 고칩니다. 검색 창에서 새 정책을 검색 합니다.
5. 선택 **다음: 검토**합니다.
6. 새 역할에 대 한 이름을 입력 합니다. 올바른 정보를 입력 했는지 확인 한 다음 클릭 확인 **Create Role**합니다.
