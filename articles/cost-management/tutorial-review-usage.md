...
시간 경과별 보고서를 통해 사용량 및 비용에 소요된 실제 금액을 추적하여 추세를 확인합니다. 추세 확인을 보려면 시간 경과별 실제 비용 보고서를 사용합니다. 포털 위쪽의 메뉴에서 **비용** > **비용 분석** > **시간에 따른 실제 비용**을 차례로 클릭합니다. 보고서를 처음 열면 그룹이나 필터가 적용되어 있지 않습니다.
