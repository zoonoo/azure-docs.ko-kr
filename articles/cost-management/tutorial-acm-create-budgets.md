...
예산은 모든 Azure EA 고객에게 제공됩니다. 예산을 만들고 관리하려면 Azure EA 구독에 대한 읽기 권한이 있어야 합니다. EA 청구 계정은 예산에서 지원되지 않습니다.

예산은 구독 또는 리소스 그룹 수준에서 개별적으로 만들어집니다. 다음 Azure 사용 권한은 사용자 및 그룹별 예산에 대한 구독에 따라 지원됩니다.
