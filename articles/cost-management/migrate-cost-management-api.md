...
비용 보고를 위해 Power BI를 사용 하는 경우 다음으로 전환 해야 합니다.

- Power BI 앱 Microsoft Azure Consumption Insights
- Azure Consumption Insights 데스크톱 커넥터


커넥터는 가장 유연 하 게 사용할 수 있는 조직에 권장 됩니다. 그러나 Power BI 앱은 빠른 설치에도 사용할 수 있습니다.

- [Microsoft Azure Consumption Insights Power BI 앱](https://appsource.microsoft.com/product/power-bi/pbi_azureconsumptioninsights.pbi-azure-consumptioninsights?tab=overview) 설치
- [Azure Consumption Insights 커넥터를 사용 하 여 연결](/power-bi/desktop-connect-azure-consumption-insights)

이전 소비 정보 콘텐츠 팩 및 커넥터는 등록 수준에서 작동 했습니다. 최소한 읽기 액세스 권한이 필요 합니다. 새 소비 통찰력 Power BI 앱 및 새로운 Azure Consumption Insights 커넥터를 청구 프로필 사용자에 게 제공 합니다. 비용을 검토 하거나 청구 프로필에 대 한 비용을 볼 수 있는 추가 옵션이 필요한 팀은 [비용 분석](https://ms.portal.azure.com/#blade/Microsoft_Azure_CostManagement/Menu/costanalysis) Azure Portal를 사용 해야 합니다.
