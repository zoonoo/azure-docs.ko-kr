---
title: 자습서 - Azure Cost Management에서 데이터 내보내기
...
Azure Storage 계정에 대한 구독을 지정하고 스토리지 계정을 선택합니다.  내보내기 파일을 보낼 스토리지 컨테이너 및 디렉터리 경로를 지정합니다.  **다음**을 클릭합니다.
