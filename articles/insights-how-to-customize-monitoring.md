...
1.  [Azure 포털 Preview][Azure 포털 Preview]에서 **찾아보기**를 클릭한 후 모니터링할 리소스를 클릭합니다.
2.  **모니터링** 렌즈에는 각 Azure 리소스에 대한 가장 중요한 메트릭이 포함됩니다. 예를 들어 웹 사이트에는 요청, 오류 [웹 테스트][웹 테스트] 및 [분석][분석]이 있습니다. **오늘의 요청 및 오류** 파트를 클릭하면 **메트릭** 블레이드가 표시됩니다.
    ![모니터링 렌즈][모니터링 렌즈]
