...
Azure 방호는 가상 네트워크 별로 배포 되며, 회사는 azure 가상 네트워크 내에서 가상 머신에 대 한 원격 사용자 액세스를 빠르게 지원할 수 있도록 Azure 방호를 구성 하 고 관리할 수 있습니다. Azure 방호를 만들고 관리 하는 방법에 대 한 지침은 [요새 호스트 만들기](bastion-create-host-portal.md)를 참조 하세요.

## <a name="next-steps"></a>다음 단계

* [Azure Portal](bastion-create-host-portal.md), [PowerShell](bastion-create-host-powershell.md)또는 Azure CLI를 사용 하 여 Azure 방호를 구성 합니다.
