...
* 가상 네트워크의 Windows 가상 컴퓨터입니다.
* 필요한 역할은 다음과 같습니다.
  * 가상 컴퓨터에 대 한 읽기 권한자 역할입니다.
  * 가상 컴퓨터의 개인 IP를 사용 하는 NIC의 읽기 역할입니다.
  * Azure 방호 리소스에 대 한 읽기 권한자 역할입니다.
* 포트: Windows VM에 연결 하려면 다음 포트가 Windows VM에서 열려 있어야 합니다.
  * 인바운드 포트: RDP (3389)
