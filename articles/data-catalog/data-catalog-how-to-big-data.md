<properties
   ...
   description="방법 문서는 Azure Blob 저장소, Azure 데이터 레이크 및 Hadoop HDFS 등 '빅 데이터' 데이터 원본과 함께 Azure 데이터 카탈로그를 사용하기 위한 패턴을 강조 표시합니다."
...
이 예에서는 vehicle\_maintenance\_events 및 location\_tracking\_events가 논리 데이터 집합을 나타냅니다. 이러한 폴더 각각에는 년 및 월 단위로 하위 폴더에 정리된 데이터 파일이 있습니다. 이러한 폴더 각각에는 수백 또는 수천 개의 파일이 있을 수 있습니다.
