...
**Azure Data Catalog** 설명서를 사용하는 장점은 데이터 카탈로그를 콘텐츠 리포지토리로 사용하여 데이터 자산의 전체 설명을 만들 수 있다는 점입니다. 사용자는 컨테이너 및 테이블을 설명하는 자세한 내용을 둘러볼 수 있습니다. SharePoint 또는 파일 공유 등의 다른 콘텐츠 리포지토리의 내용이 이미 있는 경우 이 기존 콘텐츠를 참조하는 자산 설명서 링크를 추가할 수 있습니다. 이렇게 하면 기존 문서를 더 쉽게 검색할 수 있습니다.

> [AZURE.NOTE] 설명서는 검색 인덱스에 포함되지 않습니다.
