...
사용자는 데이터 카탈로그 포털에서 소유권 수집 옵션을 선택하여 데이터 자산의 **소유권을** 가져갈 수 있습니다. 소유되지 않은 데이터 자산의 소유권을 가져오는 데 특별한 권한이 필요하지 않습니다. 모든 사용자는 소유되지 않은 데이터 자산을 소유할 수 있습니다.
...
소유자로 자신을 제거한 자산 소유자는 더 이상 자산을 관리할 수 없습니다. 자산 소유자가 소유자로 자신을 제거하고 다른 공동 소유자가 없는 경우 자산은 소유되지 않은 상태로 되돌아갑니다.
