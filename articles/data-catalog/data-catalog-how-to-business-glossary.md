...
데이터 카탈로그 관리자는 비즈니스 용어집에서 용어를 만들고, 편집하고, 삭제할 수 있습니다. 모든 데이터 카탈로그 사용자는 용어 정의를 볼 수 있고, 용어를 사용하여 자산에 태그를 지정할 수 있습니다.
...
데이터 카탈로그 관리자는 새 용어 단추를 클릭하여 다음과 같은 필드를 포함하는 새 용어를 만들 수 있습니다.
