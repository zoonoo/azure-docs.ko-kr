<properties
   pageTitle="Azure Data Catalog에 대한 질문과 대답 | Microsoft Azure"
...
##<a name="q:-does-azure-data-catalog-work-with-this-other-data-source-i’m-interested-in?"></a>질문: Azure 데이터 카탈로그에서 관심이 있는 다른 데이터 원본과 함께 작업하나요?
...
## <a name="q:-my-question-isn’t-answered-here-–-what-should-i-do?"></a>질문: 내 질문에 대답이 없습니다. 어떻게 하나요?
