...
이 샘플 항목은 Azure PowerShell을 사용하여 Azure HDInsight와 함께 범용 GraySort를 실행하는 방법을 보여 줍니다. GraySort는 메트릭이 대량의 데이터를 정렬하는 동안 도달하는 정렬 속도(TB/분)가 일반적으로 최소 100TB인 벤치마크 정렬입니다.
...
TerraSort MapReduce 프로그램의 Java 코드
----------------------------------------
