...
Azure Cloud Shell을 사용하지 않으려면, 대신 PowerShell을 로컬에 설치할 수 있습니다. PowerShell을 로컬에 설치하여 사용하는 경우 최신 버전의 Azure Resource Manager PowerShell cmdlet을 설치해야 합니다. PowerShell cmdlet은 자주 업데이트됩니다. 일반적으로 최신 기능 기능을 얻으려면 PowerShell cmdlet을 업데이트 해야 합니다. 그렇지 않으면 문제가 발생할 수 있습니다.
