...
ms.locfileid: "75774550"
---
**피어 링** 리소스가 성공적으로 배포 되 면 아래 단계에 따라 해당 리소스를 볼 수 있습니다.
...
1. **개요** 페이지에는 높은 수준의 정보가 표시 됩니다. 아래에 강조 표시 된 정보를 확인 합니다.
    ...
    > [!div class="mx-imgBorder"]
    > ![피어 링 리소스 뷰](../media/setup-exchange-get-overview.png)
...
1. 왼쪽에서 **연결**을 클릭 합니다. Metro 내의 여러 시설에서 ASN과 Microsoft 간의 피어 링 연결에 대 한 요약을 확인 하세요. 위에 강조 표시 된 가운데 창에서 **연결** 을 클릭 하 여 **개요** 페이지의 연결 요약에도 도착할 수 있습니다.
    ...
    > [!div class="mx-imgBorder"]
    > ![피어 링 리소스 뷰](../media/setup-exchange-get-connectionssummary.png)

    * **연결 상태** 는 피어 링 연결 설정 상태에 해당 합니다. 이 필드에 표시 되는 상태는 [Exchange 피어 링 연습](../walkthrough-exchange-all.md) 에 표시 된 상태 다이어그램을 따릅니다.
