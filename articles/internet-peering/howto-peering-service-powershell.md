---
title: PowerShell을 사용하여 직접 피어링에서 Azure 피어링 서비스 활성화
titleSuffix: Azure
description: PowerShell을 사용하여 직접 피어링에서 Azure 피어링 서비스 활성화
...
---
# <a name="enable-azure-peering-service-on-a-direct-peering-by-using-powershell"></a>PowerShell을 사용하여 직접 피어링에서 Azure 피어링 서비스 활성화

이 문서에서는 PowerShell cmdlet 및 Azure 리소스 관리자 배포 모델을 사용하여 직접 피어링에서 Azure [피어링 서비스를](overview-peering-service.md) 사용하도록 설정하는 방법에 대해 설명합니다.

원하는 경우 Azure [포털을](howto-peering-service-portal.md)사용하여 이 가이드를 완료할 수 있습니다.
...
* 피어링 서비스를 사용하도록 설정하려는 구독에서 직접 피어링을 선택합니다. 레거시 직접 피어링을 변환하거나 새 직접 피어링을 만들 수 있는 경우 다음을 수행합니다.
    * 레거시 직접 피어링을 변환하려면 PowerShell 을 [사용하여 레거시 직접 피어링](howto-legacy-direct-powershell.md)변환의 지침을 Azure 리소스로 변환합니다.
...
이전 단계에서 Direct 피어링을 받은 후 피어링 서비스에 사용하도록 설정합니다.
[!INCLUDE [peering-direct-modify](./includes/peering-service-direct-powershell.md)]

## <a name="modify-a-direct-peering-connection"></a>직접 피어링 연결 수정

연결 설정을 수정해야 하는 경우 PowerShell 을 [사용하여 직접 피어링 만들기 또는 수정에서](howto-direct-powershell.md)"직접 피어링 수정" 절을 참조하십시오.
