...
---
# <a name="convert-a-legacy-direct-peering-to-azure-resource-using-the-portal"></a>포털을 사용 하 여 레거시 직접 피어 링을 Azure 리소스로 변환

이 문서에서는 포털을 사용 하 여 기존 레거시 직접 피어 링을 Azure 리소스로 변환 하는 방법을 설명 합니다.
...
### <a name=create></a>레거시 직접 피어 링 변환
