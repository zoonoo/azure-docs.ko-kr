---
title: Microsoft를 사용 하 여 피어 링을 설정 하기 위한 필수 구성 요소
titleSuffix: Azure
description: Microsoft를 사용 하 여 피어 링을 설정 하기 위한 필수 구성 요소
...
---
# <a name="prerequisites-to-set-up-peering-with-microsoft"></a>Microsoft를 사용 하 여 피어 링을 설정 하기 위한 필수 구성 요소
