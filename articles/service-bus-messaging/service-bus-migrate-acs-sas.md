...
description: Azure Active Directory Access Control Service에서 공유 액세스 서명 권한 부여로 마이그레이션하는 작업에 관해 알아봅니다.
ms.topic: article
ms.date: 06/23/2020
