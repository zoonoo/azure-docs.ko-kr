...
1. 기본 네임 스페이스를 만듭니다.
1. 구독에 보조 네임 스페이스를 만들고, 다른 지역에는 기본 네임 스페이스가 있는 리소스 그룹을 만듭니다. 이 단계는 선택 사항입니다. 다음 단계에서 페어링을 만드는 동안 보조 네임 스페이스를 만들 수 있습니다. 
...
1. **페어링 시작** 페이지에서 다음 단계를 수행 합니다.
    1. 기존 보조 네임 스페이스를 선택 하거나 구독에서 기본 네임 스페이스가 있는 리소스 그룹을 만듭니다. 이 예제에서는 기존 네임 스페이스를 보조 네임 스페이스로 사용 합니다.  
