...
- Azure 구독. Azure는 구독 기반 플랫폼입니다. 구독을 얻는 방법에 대한 자세한 내용은 [구매 옵션][], [구성원 제공 토픽][] 또는 [무료 계정][]을 참조하세요.
...
[구성원 제공 토픽]: http://azure.microsoft.com/pricing/member-offers/
...
[Service Bus용 .NET API]: https://msdn.microsoft.com/ko-KR/library/azure/mt419900.aspx
