...
구독이 있으면 [새 네임스페이스를 만들 수 있습니다](../service-bus/service-bus-create-namespace-portal.md). 각각의 네임스페이스는 서비스 버스 엔터티 집합에 대한 범위 컨테이너입니다. 모든 서비스 버스 계정에서 새 네임스페이스에 고유한 이름을 지정합니다.
