...
1. [require-once][require-once] 문을 사용하여 자동 로더 파일 참조
...
지금까지 Service Bus 큐의 기본 사항에 대해 알아보았습니다. 자세한 내용은 [큐, 토픽 및 구독][큐, 토픽 및 구독]을 참조하세요.
