...
| 잘못된 요청 | 40000 | 하위 코드 = 40000. 기존 큐 또는 토픽의 ' Queuedescription.requiresduplicatedetection ' 속성 값은 변경할 수 없습니다. | 중복 검색은 엔터티를 만들 때 설정/해제 해야 합니다. 만든 후에는 중복 검색 구성 매개 변수를 변경할 수 없습니다. | 이전에 만든 큐/토픽에서 중복 검색을 사용 하도록 설정 하려면 중복 검색을 사용 하 여 새 큐/항목을 만든 다음 원래 큐에서 새 큐/토픽으로 전달할 수 있습니다. |
