...
요청 메시지 본문은 다음 항목을 포함 하는 **맵을** 포함 하는 **amqp 값** 섹션으로 구성 되어야 합니다.  
...
응답 메시지 본문은 다음 항목을 포함 하는 **맵을** 포함 하는 **amqp 값** 섹션으로 구성 되어야 합니다.  
...
**규칙 설명** 맵은 다음 항목을 포함 해야 합니다. 여기서 **sql 필터** 및 **상관 관계 필터** 는 함께 사용할 수 없습니다.  
...
**상관 관계 필터** 맵은 다음 항목 중 하나 이상을 포함 해야 합니다.  
...
|receiver-settle-mode|ubyte|예|AMQP 코어 v 1.0에 지정 된 **받는 사람** 에 대 한 모드입니다.|  
