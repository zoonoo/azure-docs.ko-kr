...
|구독(subscription)|`<topic_name>/Subscriptions/<subscription_name>`|`“myTopic/Subscriptions/MySub”`|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:renew-lock`|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|---------|----------------|--------------|--------------------|  
|statusCode|int|예|HTTP 응답 코드 [RFC2616]<br /><br /> 200: OK – 성공, 그렇지 않으면 실패|  
|rule| 맵의 배열|예|규칙의 배열입니다. 각 규칙은 맵으로 표시됩니다.|
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
...
|Key|값 형식|필요한 공간|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|string|예|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|아니요|작업 서버 제한 시간(밀리초)입니다.|  
