...
|session-id|string|아니오|`amqpMessage.Properties.GroupId as string`|  
|파티션 키|string|아니오|`amqpMessage.MessageAnnotations.”x-opt-partition-key"`|
|via-partition-key|string|아니오|`amqpMessage.MessageAnnotations."x-opt-via-partition-key"`|
|Message|바이트 배열|예|AMQP 1.0 실시간 인코딩된 메시지입니다.|  
...
|properties|map|아니오|Service Bus [BrokeredMessage.Properties](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage#Microsoft_ServiceBus_Messaging_BrokeredMessage_Properties)로 매핑합니다.|  
