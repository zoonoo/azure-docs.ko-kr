---
title: Azure Service Bus에서 AMQP 1.0 요청/응답 작업
description: 이 문서에서는 Microsoft Azure Service Bus의 AMQP 요청/응답 기반 작업 목록을 정의 합니다.
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:renew-lock`|  
...
|statusDescription|문자열|아닙니다.|상태에 대한 설명입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|session-id|문자열|아닙니다.|`amqpMessage.Properties.GroupId as string`|  
|파티션 키|문자열|아닙니다.|`amqpMessage.MessageAnnotations.”x-opt-partition-key"`|
|via-partition-key|문자열|아닙니다.|`amqpMessage.MessageAnnotations."x-opt-via-partition-key"`|
|message|바이트 배열|예|AMQP 1.0 실시간 인코딩된 메시지입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|correlation-id|문자열|아닙니다.||  
|message-id|문자열|아닙니다.||  
|to|문자열|아닙니다.||  
|reply-to|문자열|아닙니다.||  
|label|문자열|아닙니다.||  
|session-id|문자열|아닙니다.||  
|reply-to-session-id|문자열|아닙니다.||  
|content-type|문자열|아닙니다.||  
|properties|map|아닙니다.|Service Bus [BrokeredMessage.Properties](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage)로 매핑합니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|operation(작업)|문자열|예|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|deadletter-reason|문자열|아닙니다.|처리 상태가 **일시 중단됨**으로 설정된 경우 설정할 수 있습니다.|  
|deadletter-description|문자열|아닙니다.|처리 상태가 **일시 중단됨**으로 설정된 경우 설정할 수 있습니다.|  
|properties-to-modify|map|아닙니다.|수정할 Service Bus broker 저장 메시지 목록입니다.|  
