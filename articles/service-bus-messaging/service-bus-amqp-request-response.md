...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예|`com.microsoft:renew-lock`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|statusDescription|string|아닙니다.|상태에 대한 설명입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:peek-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예|`com.microsoft:schedule-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|session-id|string|아닙니다.|`amqpMessage.Properties.GroupId as string`|  
|파티션 키|string|아닙니다.|`amqpMessage.MessageAnnotations.”x-opt-partition-key"`|
|via-partition-key|string|아닙니다.|`amqpMessage.MessageAnnotations."x-opt-via-partition-key"`|
|Message|바이트 배열|예.|AMQP 1.0 실시간 인코딩된 메시지입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:cancel-scheduled-message`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:renew-session-lock`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:set-session-state`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:get-session-state`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:get-message-sessions`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|건너뛰기|int|예|상태 코드가 200인 경우 건너뛴 세션 수입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:add-rule`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|correlation-id|string|아닙니다.||  
|message-id|string|아닙니다.||  
|to|string|아닙니다.||  
|reply-to|string|아닙니다.||  
|label|string|아닙니다.||  
|session-id|string|아닙니다.||  
|reply-to-session-id|string|아닙니다.||  
|content-type|string|아닙니다.||  
|properties|지도(map)|아닙니다.|Service Bus [BrokeredMessage.Properties](/dotnet/api/microsoft.servicebus.messaging.brokeredmessage)로 매핑합니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:remove-rule`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예|`com.microsoft:enumerate-rules`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|건너뛰기|int|예.|건너뛸 규칙의 수입니다. 규칙의 목록에서 시작하는 인덱스(+1)을 정의합니다. | 
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:receive-by-sequence-number`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|키|값 형식|필수|값 내용|  
|---------|----------------|--------------|--------------------|  
|작업|string|예.|`com.microsoft:update-disposition`|  
|`com.microsoft:server-timeout`|uint|아닙니다.|작업 서버 제한 시간(밀리초)입니다.|  
...
|deadletter-reason|string|아닙니다.|처리 상태가 **일시 중단됨**으로 설정된 경우 설정할 수 있습니다.|  
|deadletter-description|string|아닙니다.|처리 상태가 **일시 중단됨**으로 설정된 경우 설정할 수 있습니다.|  
|properties-to-modify|지도(map)|아닙니다.|수정할 Service Bus broker 저장 메시지 목록입니다.|  
