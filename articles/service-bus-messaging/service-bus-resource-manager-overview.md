...
> [!NOTE]
> 이 문서의 예제에서는 Azure Resource Manager를 사용하여 Service Bus 네임스페이스와 메시징 엔터티(큐)를 만드는 방법을 보여 줍니다. 다른 템플릿 예제를 보려면 [Azure 빠른 시작 템플릿 갤러리][Azure Quickstart Templates gallery] 를 방문 하 고 **Service Bus**를 검색 하세요.
