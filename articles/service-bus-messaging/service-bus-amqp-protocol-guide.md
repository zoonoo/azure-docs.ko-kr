...
![두 컨테이너 간의 링크 연결을 carryign 세션을 보여 주는 스크린샷][2]
...
![원본, 대상, 원본 포트, 대상 포트 및 프로토콜 이름을 보여 주는 로그의 스크린샷 Fiest 행의 대상 포트 10401 (0x28 A 1)에 검은색으로 표시 되어 있습니다.][4]
