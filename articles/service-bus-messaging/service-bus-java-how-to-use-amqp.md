...
- **[username]**: Service Bus 발급자 이름입니다.
- **[password]**: URL 인코딩된 형식의 Service Bus 발급자 키입니다.
...
이 문서에서는 널리 사용되는 JMS API 및 AMQP 1.0을 통해 Java에서 Service Bus 메시징 기능(큐 및 게시/구독 토픽)을 사용하는 방법을 설명했습니다.
