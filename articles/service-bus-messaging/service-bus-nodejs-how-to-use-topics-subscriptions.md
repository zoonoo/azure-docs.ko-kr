<properties 
    pageTitle="Node.js와 함께 Service Bus 토픽을 사용하는 방법 | Microsoft Azure" 
...
빈 Node.js 응용 프로그램을 만듭니다. Node.js 응용 프로그램을 만드는 방법에 대한 지침은 [Node.js 응용 프로그램을 만들어 Azure 웹 사이트에 배포], Windows PowerShell을 사용하는 [Node.js 클라우드 서비스][] 또는 WebMatrix를 사용하는 웹 사이트를 참조하세요.
...
Azure 클라우드 서비스의 구성 파일에서 환경 변수를 설정하는 방법에 대한 예제는 [저장소를 포함한 Node.js 클라우드 서비스][]를 참조하세요.

Azure 웹 사이트의 [Azure 클래식 포털][]에서 환경 변수를 설정하는 방법에 대한 예제는 [저장소를 포함한 Node.js 웹 응용 프로그램][]을 참조하세요.
...
토픽과 구독은 영구적이므로, [Azure 클래식 포털][] 또는 프로그래밍 방식을 통해 명시적으로 삭제해야 합니다.
...
-   GitHub에서 [Node용 Azure SDK][] 리포지토리를 방문하세요.
