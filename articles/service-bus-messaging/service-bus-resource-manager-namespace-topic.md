---
title: "Azure Resource Manager 템플릿을 사용하여 토픽 및 구독이 있는 Service Bus 네임스페이스 만들기 | Microsoft Docs"
...
전체 템플릿은 [토픽 및 구독이 있는 서비스 버스 네임스페이스][토픽 및 구독이 있는 서비스 버스 네임스페이스] 템플릿을 참조하세요.
