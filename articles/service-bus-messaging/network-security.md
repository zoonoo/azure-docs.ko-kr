...
> [!NOTE]
> **프리미엄** 네임 스페이스에 대해서만 서비스 태그를 사용할 수 있습니다. **표준** 네임 스페이스를 사용 하는 경우 다음 명령을 실행할 때 표시 되는 IP 주소를 사용 `nslookup <host name for the namespace>` 합니다. 예를 들어 `nslookup contosons.servicebus.windows.net`을 참조하십시오. 
