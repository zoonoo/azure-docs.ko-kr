...
RBAC 역할을 할당 하는 방법에 대 한 자세한 내용은 [Service Bus 리소스에 대 한 액세스를 위해 Azure Active Directory 인증 및 권한 부여](authenticate-application.md#built-in-rbac-roles-for-azure-service-bus)를 참조 하세요.
