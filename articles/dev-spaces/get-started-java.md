---
title: Java 및 VS Code를 사용하여 클라우드에서 Kubernetes 개발 환경 만들기 | Microsoft Docs
...
> [!IMPORTANT]
> Azure CLI가 이미 설치되어 있는 경우 2.0.43 이상 버전을 사용하고 있는지 확인합니다.
...
> [팀 개발 알아보기](team-development-java.md)