---
title: 클라우드에서 Kubernetes 개발 환경 만들기
...
- 미국 동부, 미국 동부 2, 미국 중부, 미국 서부 2, 서유럽, 동남 아시아, 캐나다 중부 또는 캐나다 동부 지역에서 Kubernetes 1.10.3 이상을 실행하는 Kubernetes 클러스터.
