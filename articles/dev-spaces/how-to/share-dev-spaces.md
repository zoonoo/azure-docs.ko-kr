...
1. Azure Dev Space의 **리소스 그룹**을 각 팀 멤버에 대해 [기여자 액세스 권한을 부여](/azure/active-directory/role-based-access-control-configure)하도록 구성합니다. `azds list` 명령을 실행하여 개발 공간의 리소스 그룹을 확인할 수 있습니다.
