---
title: Azure Dev Spaces를 사용 하 여 Windows 컨테이너와 상호 작용
...
예제 응용 프로그램에서는 [투구][helm-installed] 를 사용 하 여 클러스터에서 Windows 서비스를 실행 합니다. 클러스터에 투구를 설치 하 고 올바른 권한을 부여 합니다.
