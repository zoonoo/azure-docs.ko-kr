---
title: Azure의 Docker
description: Docker 배포 및 Azure와 통합
services: multiple
author: czeumault
manager: carolz
layout: LandingPage
...
ms.locfileid: "23069106"
---
<div class="content">
   <h1>Azure의 Docker</h1>   
    <div class="introHolder" style="justify-content: space-between;">
    <div class="intro" style="min-width: 200px">
     <img src="media/Docker.png" align="right" alt="Docker Logo"> Docker는 Linux 및 Windows에서 컨테이너와 함께 빠르게 사용할 수 있는 인기 있는 컨테이너 관리 및 이미징 플랫폼입니다.  빠른 시작 및 자습서를 사용하여 Azure에서 Docker를 사용하는 방법을 알아보세요.
    </div>
    </div>
<h2>5분 빠른 시작</h2>
...
<ol>
  ...
  <li><a href="/azure/container-service/container-service-docker-swarm-mode-setup-ci-cd-acs-engine">Docker Swarm 및 Visual Studio Team Services를 사용하는 CI/CD</a></li>
