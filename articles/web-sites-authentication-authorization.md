...
-	[Azure AD](../web-sites-dotnet-lob-application-azure-ad/)  - Azure AD를 사용하여 웹 사이트에 대한 인증 및 권한 부여를 구현할 수 있습니다. Azure AD를 ID 공급자로 사용할 경우의 특징은 다음과 같습니다.
	...
	-	Azure, Office 365, Dynamics CRM Online, Windows InTune 및 수천 개의 타사 클라우드 응용 프로그램을 포함하여 [Azure AD에서 지원하는 모든 응용 프로그램](http://azure.microsoft.com/marketplace/active-directory/)에 SSO를 제공합니다. 
