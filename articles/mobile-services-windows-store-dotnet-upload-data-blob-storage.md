...
2.  [삽입 스크립트를 업데이트하여 SAS 생성][삽입 스크립트를 업데이트하여 SAS 생성]
3.  [클라이언트 앱을 업데이트하여 이미지 캡처][클라이언트 앱을 업데이트하여 이미지 캡처]
4.  [이미지를 업로드하여 앱 테스트][이미지를 업로드하여 앱 테스트]
...
이제 모바일 서비스를 Blob 서비스와 통합하여 이미지를 안전하게 업로드할 수 있게 되었으므로 몇 가지 기타 백 엔드 서비스 및 통합 항목을 확인해보십시오.

-   [SendGrid로 모바일 서비스에서 전자 메일 보내기][SendGrid로 모바일 서비스에서 전자 메일 보내기]
...
-   [모바일 서비스에서 백 엔드 작업 예약][모바일 서비스에서 백 엔드 작업 예약]
