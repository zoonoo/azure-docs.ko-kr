<properties
   pageTitle="Azure에서의 큰 계산: 배치 및 HPC(고성능 컴퓨팅)에 대한 기술 리소스"
   description="이 문서에는 Azure에서 대규모 병렬, 배치 및 HPC 작업을 실행할 수 있도록 지원하는 기술 리소스가 나열되어 있습니다."
...
* [개요](https://msdn.microsoft.com/library/azure/dn482130.aspx)
...
* [비디오: Azure 배치 소개](http://azure.microsoft.com/documentation/videos/introduction-to-azure-batch-with-mark-scurrell/)

* [비디오: Mark Russinovich의 Azure 배치 서비스 데모](http://azure.microsoft.com/documentation/videos/azure-batch-demo-blender/)

* [비디오: 배치 서비스 구축](http://azure.microsoft.com/documentation/videos/azure-batch-build-a-batch-service/)
...
[HPC 팩](https://technet.microsoft.com/library/cc514029)은 온-프레미스, 하이브리드 및 클라우드 기반 HPC를 위한 Microsoft의 무료 클러스터 관리자 및 작업 일정 예약 솔루션입니다.
...
* [A8 및 A9 인스턴스에서 MPI 응용 프로그램 실행](https://msdn.microsoft.com/library/azure/dn592104.aspx)
...
* [Azure 배치 코드 샘플](https://code.msdn.microsoft.com/site/search?f[0].Type=Topic&f[0].Value=Azure%20Batch&f[0].Text=Azure%20Batch)
