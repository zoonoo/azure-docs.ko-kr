...
계층의 노드 수가 자동으로 결정되도록 지정하려면 **자동** 키워드를 사용합니다. **자동** 키워드는 계층에 따라 다른 영향을 미칩니다.  
...
* 커널당 가중치 수는 *1 + **KernelShape**\[0] * **KernelShape**\[1]  *KernelShape**\[2] = 1 + 1 * 5 * 5 = 26  또는 26 * 50 = 1300*입니다.
