<properties
    pageTitle="여러 지역에 웹 서비스를 배포하는 방법 | Microsoft Azure"
...
6. **리소스 그룹** 드롭다운에서 계획에 대한 리소스 그룹을 선택합니다. 리소스 그룹에 대한 자세한 내용은 [포털을 통해 Azure 리소스 관리](../azure-portal/resource-group-portal.md)를 참조하세요.
...
7. **리소스 그룹** 드롭다운에서 웹 서비스에 대한 리소스 그룹을 선택합니다. 리소스 그룹에 대한 자세한 내용은 [포털을 통해 Azure 리소스 관리](../azure-portal/resource-group-portal.md)를 참조하세요.
