...
Azure 관리 포털을 사용하여 기계 학습 작업 영역을 관리하면 다음을 수행할 수 있습니다.
...
1.	Azure 구독과 연결된 계정을 사용하여 Microsoft Azure 계정에 로그인합니다.
2.	[Azure 관리 포털](https://manage.windowsazure.com/)의 Microsoft Azure 서비스 패널에서 **기계 학습**을 클릭합니다.
...
- **사용 개요**는 작업 영역에서 사용 중인 저장소를 표시합니다. 참고: Azure 기계 학습 공용 미리 보기에서는 저장소 모니터링 사용할 수 없습니다.
- **빠른 보기**는 작업 영역 정보 및 유용한 링크의 요약 정보를 제공합니다.

> [AZURE.NOTE]**스튜디오에서 열기** 링크를 클릭하면 현재 로그인된 Microsoft 계정을 사용하여 기계 학습 스튜디오가 열립니다. Azure 포털에 로그인하여 작업 영역을 만들 때 사용한 Microsoft 계정에는 해당 작업 영역을 열 수 있는 권한이 자동으로 부여되지 않습니다. 작업 영역을 열려면 작업 영역의 소유자로 정의된 Microsoft 계정으로 로그인하거나 작업 공간 소유자의 참가 초대를 받아야 합니다.
...
- 다른 Microsoft 계정을 지정하여 작업 영역의 소유자를 변경합니다. 

기계 학습 스튜디오에서 작업 영역에 액세스할 수 있는 사용자를 관리하려면 **스튜디오에서 열기**를 클릭합니다(위의 **스튜디오에서 열기** 참고 사항을 참조). 그러면 작업 영역에서 기계 학습 스튜디오가 열립니다. 여기에서 **설정** 탭을 클릭한 다음 **사용자**를 클릭합니다. **더 많은 사용자 초대**를 클릭하여 사용자에게 작업 영역에 대한 액세스 권한을 부여하거나 사용자를 선택하고 **제거**를 클릭할 수 있습니다.
...
- "기본" 끝점 외에도 추가 끝점을 정의할 수 있습니다. 끝점을 추가하려면 페이지 하단의 **끝점 추가**를 클릭합니다.
