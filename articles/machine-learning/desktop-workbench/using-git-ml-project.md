...
원격 리포지토리 통합이 가능한 새로운 Machine Learning 프로젝트가 만들어집니다. 프로젝트 폴더는 항상 로컬 Git 리포지토리로 Git 초기화됩니다. Git 원격이 원격 Team Services Git 리포지토리로 설정되어 커밋을 원격 Git 리포지토리로 푸시할 수 있습니다.
