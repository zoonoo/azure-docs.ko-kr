...
ms.locfileid: "53270810"
---
# <a name="python-packages-for-azure-machine-learning"></a>Azure Machine Learning용 Python 패키지

[!INCLUDE [workbench-deprecated](../../../includes/aml-deprecating-preview-2017.md)] 

Azure Machine Learning(미리 보기)용으로 Microsoft에서 제공하는 전용 Python 패키지에 대해 알아봅니다. 이러한 라이브러리와 기능은 다른 오픈 소스 또는 타사 패키지와 함께 사용할 수 있지만 전용 패키지를 사용하려면 인터프리터를 제공하는 컴퓨터나 서비스에 Python 코드를 실행해야 합니다.
