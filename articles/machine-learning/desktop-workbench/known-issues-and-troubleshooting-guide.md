...
질문을 게시할 수 있는 MSDN 포럼이 있습니다. 제품 팀에서 포럼을 적극적으로 모니터링합니다. 포럼 URL은 [https://aka.ms/aml-forum-service](https://aka.ms/aml-forum-service)입니다. 
...
![이미지 업데이트](../service/media/known-issues-and-troubleshooting-guide/update.png)
