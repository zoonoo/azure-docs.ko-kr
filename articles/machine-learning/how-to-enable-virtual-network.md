...
> [!WARNING]
> Azure Machine Learning 디자이너를 사용 하는 데이터 과학자 있는 경우 가상 네트워크 내의 저장소 계정에서 데이터를 시각화할 때 오류가 표시 됩니다. 다음 텍스트는 수신 되는 오류입니다.
>
> __오류:이 데이터 집합을 프로 파일링 할 수 없습니다. 데이터가 가상 네트워크에 저장 되어 있거나 데이터가 프로필을 지원 하지 않기 때문일 수 있습니다.__
...
## <a name="use-a-machine-learning-compute"></a><a name="compute-instance"></a>Machine Learning 컴퓨팅 사용
...
1. Azure Portal 또는 Azure CLI를 사용 하 여 VM 또는 HDInsight 클러스터를 만들고, 클러스터를 Azure virtual network에 배치 합니다. 자세한 내용은 다음 아티클을 참조하세요.
