...
- [Azure Machine Learning에서 모델 성능을 평가하는 방법](machine-learning-evaluate-model-performance.md)
- [Azure Machine Learning에서 알고리즘을 최적화하는 매개 변수 선택](machine-learning-algorithm-parameters-optimize.md)
