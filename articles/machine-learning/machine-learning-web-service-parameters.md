---
title: Azure 기계 학습 웹 서비스 매개 변수 사용 | Microsoft Docs
...
> [!NOTE]
> 기존 웹 서비스에 대한 API 설명서는 기계 학습 스튜디오에서 웹 서비스 **대시보드**의 **API 도움말 페이지** 링크를 통해 제공됩니다. 새 웹 서비스에 대한 API 설명서는 웹 서비스에 대한 **사용** 및 **Swagger API** 페이지의 [Azure 기계 학습 웹 서비스](https://services.azureml.net/Quickstart) 포털을 통해 제공됩니다.
> 
> 
