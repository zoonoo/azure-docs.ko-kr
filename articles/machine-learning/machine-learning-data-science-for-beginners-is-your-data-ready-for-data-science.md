...
# 데이터 과학에 사용할 수 있게 데이터가 준비되었나요? 초급자를 위한 데이터 과학 비디오 2
...
![연결된 데이터 및 연결되지 않은 데이터 - 데이터 기준](./media/machine-learning-data-science-for-beginners-is-your-data-ready-for-data-science/machine-learning-data-science-connected-vs-disconnected-data.png)
