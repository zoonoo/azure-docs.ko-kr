...
대신 Azure Machine Learning 작업 영역에 [Azure Key Vault](../key-vault/general/overview.md)라는 연결 된 리소스가 있습니다. 이 Key Vault를 사용 하 여 Azure Machine Learning Python SDK의 Api 집합을 통해 안전 하 게 원격으로 실행할 수 있습니다.
