...
description: Azure Machine Learning Studio(클래식) 작업 영역에 대한 액세스를 관리하고, Machine Learning API 웹 서비스를 배포 및 관리합니다.
...
---
# <a name="manage-an-azure-machine-learning-studio-classic-workspace"></a>Azure Machine Learning 스튜디오(클래식) 작업 영역 관리
...
이 Studio(클래식) 작업 영역과 연결된 웹 서비스를 관리하려면 Machine Learning 웹 서비스 포털을 사용하세요. 자세한 내용은 [Azure Machine Learning 웹 서비스 포털에서 웹 서비스 관리](manage-new-webservice.md)를 참조하세요.
