...
**적용 대상:**  ![적용 대상:](../../../includes/media/aml-applies-to-skus/no.png)[Machine Learning Studio(클래식)  ](../../../includes/media/aml-applies-to-skus/yes.png)적용되지 않는 대상:![Azure Machine Learning](../compare-azure-ml-to-studio-classic.md)
