---
title: 'Two-Class 신경망: 모듈 참조'
titleSuffix: Azure Machine Learning
description: Azure Machine Learning에서 Two-Class 신경망 모듈을 사용 하 여 두 개의 값만 포함 된 대상을 예측 하는 데 사용할 수 있는 신경망 모델을 만드는 방법에 대해 알아봅니다.
