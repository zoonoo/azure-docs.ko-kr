...
| 권장 구성 | 권장 사항 모델을 작성 합니다. | [추천 평가](evaluate-recommender.md) <br/> [.SVD 추천 점수 매기기](score-svd-recommender.md) <br/> [.SVD 추천 학습](train-SVD-recommender.md) |
