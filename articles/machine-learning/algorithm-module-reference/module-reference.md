...
| Text Analytics | 구조화 된 텍스트와 구조화 되지 않은 텍스트를 모두 사용 하기 위한 특수 한 계산 도구를 제공 합니다. | [텍스트에서 N 개의 문법 기능 추출](extract-n-gram-features-from-text.md) <br/> [기능 해시](feature-hashing.md) <br/> [텍스트 전처리](preprocess-text.md) |
