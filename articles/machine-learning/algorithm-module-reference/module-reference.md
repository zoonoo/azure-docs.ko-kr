...
> [!TIP]
> 시각적 인터페이스의 모든 실험에서 특정 모듈에 대 한 정보를 가져올 수 있습니다. 모듈을 선택한 다음 **빠른 도움말** 창에서 **추가 도움말** 링크를 선택 합니다.
...
| 회귀 | 값을 예측 합니다. | [선형 회귀](linear-regression.md)  <br/> [신경망 회귀](neural-network-regression.md)  <br/> [의사 결정 포리스트 회귀](decision-forest-regression.md)  <br/> [승격&nbsp;된&nbsp;의사&nbsp;결정 트리 회귀](boosted-decision-tree-regression.md)
|  | **모델 작성 및 평가**: | |
| 기차   | 알고리즘을 통해 데이터를 실행 합니다. | [모델 학습](train-model.md)  <br/> [클러스터링 모델 학습](train-clustering-model.md)    |
| 모델 평가 | 학습 된 모델의 정확도를 측정 합니다. |  [모델 평가](evaluate-model.md)
| 점수 | 방금 학습 한 모델에서 예측을 가져옵니다. | [변환 적용](apply-transformation.md)<br/>[클러스터에&nbsp;&nbsp;데이터&nbsp;할당](assign-data-to-clusters.md) <br/>[모델 점수 매기기](score-model.md)
