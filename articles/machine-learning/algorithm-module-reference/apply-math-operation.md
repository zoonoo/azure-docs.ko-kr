...
더 복잡 한 계산을 수행 해야 하는 경우 여러 인스턴스를 연결 하 여 **산술 연산을 적용할**수 있습니다. 예를 들어 **수학 연산 적용**의 인스턴스 하나를 사용 하 여 두 개의 열을 추가한 다음 **수학 연산 적용** 의 다른 인스턴스를 사용 하 여 합계를 상수로 나눠 평균을 얻을 수 있습니다.  
