...
| PatientID | 이니셜| Gender|나이|연결 되도록 허용|
|----|----|----|----|----|
|1|F.M.| M| 53| 1월|
|2| F.A.M.| M| 53| 1월|
|3| F.A.M.| M| 24| 1월|
...
3. **속성** 창의 **키 열 선택 필터 식**에서 **열 선택기 시작**을 클릭 하 여 중복 항목을 식별 하는 데 사용할 열을 선택 합니다.
    ...
    + "Id가 고유한 지 확인 합니다."는 다음과 같습니다. ID 열만 선택 합니다.
    + "First name, last name 및 ID의 조합이 고유한 지 확인 합니다." 세 열을 모두 선택 합니다.
