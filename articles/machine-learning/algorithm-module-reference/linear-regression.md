...
3. **L2 정규화 가중치** 에서 l2 정규화에 대 한 가중치로 사용할 값을 입력 합니다. 과잉 맞춤을 방지 하려면 0이 아닌 값을 사용 하는 것이 좋습니다.
     ...
     정규화가 모델 피팅에 미치는 영향에 대해 자세히 알아보려면 다음 문서를 참조 하세요. [L1 및 L2 정규화 for Machine Learning](/archive/msdn-magazine/2015/february/test-run-l1-and-l2-regularization-for-machine-learning)
