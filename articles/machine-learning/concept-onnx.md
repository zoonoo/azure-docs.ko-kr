...
[Onnx Runtime](https://github.com/Microsoft/onnxruntime) 은 프로덕션에 onnx 모델을 배포 하기 위한 고성능 유추 엔진입니다. 클라우드 및에 지에 최적화 되어 있으며 Linux, Windows 및 Mac에서 작동 합니다. C + +로 작성 된 C, Python 및 c # Api도 있습니다. ONNX Runtime은 모든 ONNX-ML 사양에 대 한 지원을 제공 하며, NVidia Gpu의 TensorRT와 같은 다른 하드웨어의 액셀러레이터와도 통합 됩니다.
