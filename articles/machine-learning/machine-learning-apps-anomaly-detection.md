<properties 
	pageTitle="기계 학습 앱: 이상 감지 서비스 | Azure" 
...
이 서비스는 웹 또는 모바일 응용 프로그램, R, Python, Excel 등 다양한 방법으로 사용할 수 있는 REST 기반 API를 HTTPS를 통해 제공합니다. Microsoft에는 데이터에 대한 이상 감지 웹 서비스를 실행하고 결과를 시각화하도록 도와주는 [Azure 웹 응용 프로그램](http://anomalydetection-aml.azurewebsites.net/)이 있습니다. 
