...
기계 학습 스튜디오는 데이터 과학, 예측 분석, 클라우드 리소스 및 데이터가 만나는 장소로 "Azure 기계 학습 스튜디오"라고도 합니다.
...
**Azure 기계 학습 스튜디오**에서는 예측 분석 모델을 간편하게 빌드, 테스트, 반복할 수 있는 대화형 시각적 작업 영역을 제공합니다. ***데이터 집합***과 분석 ***모듈***을 대화형 ***캔버스***로 끌어서 놓고 함께 연결하여 ***실험***을 생성하고 기계 학습 스튜디오에서 ***실행***합니다. 모델 디자인을 반복하려면 실험을 ***편집***하고 필요에 따라 복사본을 ***저장***하고 실험을 다시 실행합니다. 준비가 되면 실험 모델에 다른 사용자가 액세스할 수 있도록 ***웹 서비스***로 ***게시***할 수 있습니다.
...
- **스튜디오 홈** - 설명서 및 기타 리소스에 대한 링크 집합
- **실험** - 만들고 실행하고 초안으로 저장한 실험입니다. 
- **웹 서비스** - 게시한 실험 목록입니다. 
- **설정** - 계정과 리소스를 구성하는 데 사용할 수 있는 설정 모음입니다. 

>[AZURE.NOTE]실험을 생성할 때 사용 가능한 데이터 집합 및 모듈의 작업 목록이 캔버스 왼쪽에 표시됩니다. 이 목록은 모델을 빌드하는 데 사용할 구성 요소 목록입니다.
...
간단한 실험을 만드는 예는 [Azure 기계 학습 스튜디오에서 간단한 실험 만들기](machine-learning-create-experiment.md)를 참조하세요. 예측 분석 솔루션을 만드는 자세한 연습 과정은 [Azure 기계 학습을 사용한 예측 솔루션 개발](machine-learning-walkthrough-develop-predictive-solution.md)을 참조하세요.
...
실험을 빌드할 때 캔버스의 왼쪽에서 데이터 집합의 작업 목록을 사용할 수 있습니다.
...
실험을 빌드할 때 캔버스의 왼쪽에서 모듈의 작업 목록을 사용할 수 있습니다.
