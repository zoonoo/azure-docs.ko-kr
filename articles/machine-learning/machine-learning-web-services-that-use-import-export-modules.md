<properties
	pageTitle="데이터 가져오기 및 데이터 내보내기 모듈을 사용하는 Azure ML 웹 서비스 배포 | Microsoft Azure"
...
# 데이터 가져오기 및 데이터 내보내기 모듈을 사용하는 Azure ML 웹 서비스 배포 
...
5.	속성 패널의 **데이터 원본**에서 **Azure SQL 데이터베이스**를 선택합니다.
...
2.	실행이 완료되면 **웹 서비스 배포**를 클릭하고 **웹 서비스 배포[기존]**를 선택합니다.
3.	웹 서비스 대시보드에서 API 키를 찾습니다. 나중에 사용할 수 있게 복사한 다음 저장합니다.
4.	**기본 끝점** 테이블에서 **배치 실행** 링크를 클릭하여 API 도움말 페이지를 엽니다.
