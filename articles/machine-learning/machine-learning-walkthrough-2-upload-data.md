...
- - -
신용 위험에 대한 예측 모델을 개발하려면 모델을 학습 후 테스트할 수 있는 데이터가 필요합니다. 이 연습에서는 UCI 기계 학습 리포지토리의 "UCI Statlog(독일 신용 데이터) 데이터 집합"을 사용합니다. 이 데이터 집합은   
...
> [!TIP]
> 스튜디오에 업로드된 데이터 집합을 관리하려면 스튜디오 창 왼쪽의 **데이터 집합** 탭을 클릭합니다.
> 
> 
