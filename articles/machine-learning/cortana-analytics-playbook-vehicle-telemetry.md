...
## 개요
슈퍼 컴퓨터가 랩 밖으로 나와 이제 차고에 주차되어 있습니다. 이러한 최첨단 자동차는 수많은 센서를 포함하고 있어서 초당 수백만 개의 이벤트를 추적하고 모니터링할 수 있습니다. 2020년까지 이러한 자동차 대부분이 인터넷에 연결될 것으로 기대하고 있습니다. 이러한 엄청난 데이터를 활용하여 최고의 안전과 안정성 및 승차 환경을 제공한다고 상상해 보세요. Microsoft는 Cortana Intelligence를 통해 이 상상을 현실화했습니다.
