...
1. 사용할 입력 포트를 적어 둡니다. 디자이너가 왼쪽 입력 포트를 변수에 `dataset1` 할당 하 고 중간 입력 포트를에 `dataset2`할당 합니다. 
...
1. 다음 코드를 복사 하 여 입력란에 붙여 넣습니다.
    ...
    진입점 스크립트는 함수 `azureml_main`를 포함 해야 합니다. **Python 스크립트 실행** 모듈에 대 한 두 개의 입력 포트에 매핑되는 두 개의 함수 매개 변수가 있습니다.
