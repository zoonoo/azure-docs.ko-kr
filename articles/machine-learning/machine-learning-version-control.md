...
Azure Machine Learning에서 학습된 모델은 .iLearner 파일이라는 형식으로 직렬화되고 작업 영역과 연결된 Azure Blob Storage 계정에 저장됩니다. 재학습 API를 통해 .iLearner 파일의 사본을 얻을 수 있습니다. [이 문서](machine-learning-retrain-models-programmatically.md)에서는 재학습 API의 작동 방법을 설명합니다. 대략적인 단계는 다음과 같습니다.
