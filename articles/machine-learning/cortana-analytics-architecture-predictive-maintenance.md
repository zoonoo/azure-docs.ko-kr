<properties
	pageTitle="예측 유지 관리를 위한 Cortana Analytics 솔루션 템플릿 아키텍처 | Microsoft Azure"
	description="예측 유지 관리를 위한 Microsoft Cortana Analytics 솔루션 템플릿의 아키텍처"
	keywords="솔루션 가속기;cortana analytics;예측 유지 관리"
...
# 예측 유지 관리를 위한 Cortana Analytics 솔루션 템플릿 아키텍처
