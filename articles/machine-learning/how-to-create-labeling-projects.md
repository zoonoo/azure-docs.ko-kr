...
Azure Machine Learning는 진행률을 추적 하 고 불완전 한 레이블 지정 작업의 큐를 유지 관리 합니다.

프로젝트를 시작 및 중지 하 고 레이블 지정 진행률을 모니터링할 수 있습니다. 레이블이 지정된 데이터는 COCO 형식 또는 Azure Machine Learning 데이터 세트로 내보낼 수 있습니다.
...
레이블 지정 프로젝트는 Azure Machine Learning에서 관리됩니다. 프로젝트 **레이블** 지정 페이지를 사용 하 여 프로젝트를 관리 합니다.
...
이 기능은 이미지 분류(다중 클래스 또는 다중 레이블) 작업에 사용할 수 있습니다.  
