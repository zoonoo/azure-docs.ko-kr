...
| **지원 되는 VM 시리즈**  | **제한 사항** | **범주** | **지원 요소** |
|------------|------------|------------|------------|
| D | 없음 | 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| DDSv4 | 없음 | 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| Dv2 | 없음 | 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| Dv3 | 없음| 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| DSv2 | 없음 | 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| DSv3 | 없음| 범용 가상 컴퓨터 | 계산 클러스터 및 인스턴스 |
| EAv4 | 없음 | 메모리에 최적화 | 계산 클러스터 및 인스턴스 |
| Ev3 | 없음 | 메모리에 최적화 | 계산 클러스터 및 인스턴스 |
| FSv2 | 없음 | 컴퓨팅 최적화 | 계산 클러스터 및 인스턴스 |
| H | 없음 | 고성능 컴퓨팅 | 계산 클러스터 및 인스턴스 |
| HB | 승인이 필요 합니다. | 고성능 컴퓨팅 | 계산 클러스터 및 인스턴스 |
| HBv2 | 승인이 필요 합니다. |  고성능 컴퓨팅 | 계산 클러스터 및 인스턴스 |
| HCS | 승인이 필요 합니다. |  고성능 컴퓨팅 | 계산 클러스터 및 인스턴스 |
| M | 승인이 필요 합니다. | 메모리에 최적화 | 계산 클러스터 및 인스턴스 |
| NC | 없음 |  GPU | 계산 클러스터 및 인스턴스 |
| NC 프로 모션 | 없음 | GPU | 계산 클러스터 및 인스턴스 |
| NCsv2 | 승인이 필요 합니다. | GPU | 계산 클러스터 및 인스턴스 |
| NCsv3 | 승인이 필요 합니다. | GPU | 계산 클러스터 및 인스턴스 |  
| NDs | 승인이 필요 합니다. | GPU | 계산 클러스터 및 인스턴스 | 
| NDv2 | 승인이 필요 합니다. | GPU | 계산 클러스터 및 인스턴스 | 
| NV | 없음 | GPU | 계산 클러스터 및 인스턴스 | 
| NVv3 | 승인이 필요 합니다. | GPU | 계산 클러스터 및 인스턴스 | 
