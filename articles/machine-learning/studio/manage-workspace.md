...
description: Azure 기계 학습 스튜디오(클래식) 작업 영역에 대한 액세스를 관리하고 기계 학습 API 웹 서비스를 배포 및 관리합니다.
...
ms.locfileid: "79217959"
---
# <a name="manage-an-azure-machine-learning-studio-classic-workspace"></a>Azure 기계 학습 스튜디오(클래식) 작업 영역 관리
...
Azure 포털에서 기계 학습 스튜디오(클래식) 작업 영역을 관리할 수 있습니다.



## <a name="use-the-azure-portal"></a>Azure Portal 사용

Azure 포털에서 스튜디오(클래식) 작업 영역을 관리하려면 다음을 수행합니다.

1. Azure 구독 관리자 계정을 사용하여 [Azure Portal](https://portal.azure.com/)에 로그인합니다.
2. 페이지 상단의 검색 상자에서 "기계 학습 스튜디오(클래식) 작업 영역"을 입력한 다음 **기계 학습 스튜디오(클래식) 작업 영역을**선택합니다.
...
이 Studio(클래식) 작업 영역과 연결된 웹 서비스를 관리하려면 기계 학습 웹 서비스 포털을 사용합니다. 자세한 내용은 [Azure Machine Learning 웹 서비스 포털에서 웹 서비스 관리](manage-new-webservice.md)를 참조하세요.

> [!NOTE]
> 새로운 웹 서비스를 배포 또는 관리하려면 웹 서비스가 배포된 구독에 대한 참여자 또는 관리자 역할을 할당받아야 합니다. 다른 사용자를 기계 학습 Studio(클래식) 작업 영역에 초대하는 경우 웹 서비스를 배포하거나 관리하기 전에 구독의 기여자 또는 관리자 역할에 할당해야 합니다. 
> 
