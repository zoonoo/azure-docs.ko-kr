...
description: Azure 기계 학습 스튜디오(클래식)를 사용하면 코드를 작성할 필요 없이 Excel에서 직접 웹 서비스를 호출할 수 있습니다.
...
ms.locfileid: "79218222"
---
# <a name="consuming-an-azure-machine-learning-studio-classic-web-service-from-excel"></a>Excel에서 Azure 기계 학습 스튜디오(클래식) 웹 서비스 사용

[!INCLUDE [Notebook deprecation notice](../../../includes/aml-studio-notebook-notice.md)]

Azure 기계 학습 스튜디오(클래식)를 사용하면 코드를 작성할 필요 없이 Excel에서 직접 웹 서비스를 호출할 수 있습니다.
...
## <a name="steps"></a>단계
웹 서비스를 게시합니다. [자습서 3: 신용 위험 모델 배포](tutorial-part3-credit-risk-deploy.md) 방법을 설명 합니다. 현재 Excel 통합 문서 기능은 단일 출력(즉, 단일 점수 매기기 레이블)이 있는 요청/응답 서비스에 대해서만 지원됩니다. 
...
2. 보안 경고가 표시되면 **편집 사용** 단추를 클릭합니다.
    ...
    ![편집을 활성화하여 보호된 보기 보안 경고를 제거합니다.](./media/consuming-from-excel/enableeditting.png)
3. 보안 경고가 표시됩니다. **콘텐츠 사용** 단추를 클릭하여 스프레드시트에서 매크로를 실행합니다.

    ![매크로를 사용하지 않도록 설정하는 보안 경고를 해제하도록 콘텐츠 가 설정](./media/consuming-from-excel/enablecontent.png)
