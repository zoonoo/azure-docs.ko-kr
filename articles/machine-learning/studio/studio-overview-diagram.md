---
title: Machine Learning Studio 기능에 대한 개요 다이어그램
...
[Azure Machine Learning Studio](https://studio.azureml.net/) 에는 데이터 입력, 출력, 준비 및 시각화를 지원하는 모듈과 함께 다수의 사용 가능한 기계 학습 알고리즘이 있습니다. 이러한 구성 요소를 사용하여 예측 분석 실험을 개발하고 반복해서 사용하여 모델을 학습할 수 있습니다.
그런 다음에는 새 데이터의 점수를 매기는 데 사용할 수 있도록 한 번 클릭으로 Azure 클라우드에서 모델을 운영할 수 있습니다.

이 다이어그램에서는 이러한 모든 과정이 서로 간에 맞물려 작동하는 방식을 보여 줍니다.

> [!NOTE]
> 전체를 탐색해 보고 Machine Learning Studio에서 사용 가능한 기계 학습 알고리즘을 선택하는 데 대한 추가 도움이 필요하면 [Microsoft Azure Machine Learning Studio용 기계 학습 알고리즘 참고 자료](algorithm-cheat-sheet.md)를 참조하세요.
> 
> 
