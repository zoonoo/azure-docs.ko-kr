...
일반적인 질문은 [Microsoft Azure Machine Learning 포럼](https://social.msdn.microsoft.com/forums/azure/home?forum=MachineLearning)을 사용하세요.
...
4. 웹 서비스를 대회 응모작으로 제출하고, Azure AI 갤러리 대회 페이지에서 공용 점수를 확인합니다. 리더 보드에 내 이름이 있다면 정말 좋겠죠!  

항목을 제출한 후 복사된 시작 실험으로 돌아갈 수 있습니다. 그런 다음 예측 실험을 반복해서 업데이트하고 웹 서비스를 업데이트한 후 새 항목을 제출합니다.   
