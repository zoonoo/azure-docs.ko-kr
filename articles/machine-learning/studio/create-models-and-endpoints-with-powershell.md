...
가장 좋은 방법일 수 있지만 Azure Machine Learning Studio의 클래식 버전에서 각각 고유한 위치를 나타내는 1000 학습 실험을 만들지 않으려고 합니다. 이는 엄청난 작업일 뿐 아니라, 각 실험마다 학습 데이터 세트를 제외하고는 모든 구성 요소가 동일하므로 비효율적입니다.
...
[Cortana Intelligence 갤러리](https://gallery.azure.ai/Experiment/Bike-Rental-Training-Experiment-1)에 있는 예제 [학습 실험](https://gallery.azure.ai)을 사용합니다. [Azure Machine Learning Studio (클래식)](https://studio.azureml.net) 작업 영역에서이 실험을 엽니다.
