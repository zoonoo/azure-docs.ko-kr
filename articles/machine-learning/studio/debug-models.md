...
description: Azure 기계 학습 스튜디오(클래식)에서 학습 모델 및 점수 모델 모듈에서 생성된 오류를 디버깅하는 방법.
...
---
# <a name="debug-your-model-in-azure-machine-learning-studio-classic"></a>Azure 기계 학습 스튜디오에서 모델 디버깅(클래식)
...
1. Azure 기계 학습 스튜디오(클래식)에서 제공하는 모델 컬렉션의 기계 학습 모델 유형입니다.
