...
Excel 모델을 사용하여 기준을 만들었으므로 이제 Machine Learning 선형 회귀 모델을 최적화하는 과정을 진행했습니다. [Filter-Based Feature Selection][filter-based-feature-selection] 모듈을 사용하여 초기 데이터 요소 선택을 개선함으로써 절대 평균 오차가 4.6%로 향상되는 효과를 얻었습니다. 이후 프로젝트의 경우이 기능을 사용 하 여 모델링에 사용할 올바른 기능 집합을 찾기 위해 데이터 특성을 반복 하는 데 주가를 절감할 수 있습니다. 
...
또한 향후 예측 프로젝트를 가속화하려면 [Filter-Based Feature Selection][filter-based-feature-selection]을 사용하는 것이 좋다는 것도 알았습니다. 데이터에 기능 선택을 적용 하면 향상 된 전체 성능을 통해 Studio (클래식)에서 향상 된 모델을 만들 수 있습니다. 
...
* Excel의 회귀 Excel에서 회귀를 사용해 본 적이 없는 경우이 자습서를 통해 쉽게 수행할 수 있습니다.[https://www.excel-easy.com/examples/regression.html](https://www.excel-easy.com/examples/regression.html)
