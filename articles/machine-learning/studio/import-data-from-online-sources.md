...
> 
> 자세한 내용은 [Azure Blob Storage: 핫 및 쿨 저장소 계층](../../storage/blobs/storage-blob-storage-tiers.md)을 참조하세요.
> 
> 
...
[데이터 가져오기 및 데이터 내보내기 모듈을 사용하는 Azure ML 웹 서비스 배포](web-services-that-use-import-export-modules.md)
