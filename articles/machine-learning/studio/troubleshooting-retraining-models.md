...
* 점수 매기기 웹 서비스에 추가된 새 엔드포인트입니다.  프로그래밍 방식으로 항목 또는 Azure Machine Learning 웹 서비스 포털을 통해 Machine Learning 재학습 모델에서 참조한 샘플 코드를 사용하여 프로그래밍 방식으로 엔드포인트를 추가할 수 있습니다.

그런 다음 학습 웹 서비스 API 도움말 페이지에서 샘플 C# 코드를 사용하여 모델을 재학습할 수 있습니다. 결과를 평가했고 만족한다면 추가한 새 엔드포인트를 사용하여 학습된 모델 점수 매기기 웹 서비스를 업데이트합니다.
...
3. 예측 웹 서비스를 선택합니다.
4. 웹 서비스에 새 엔드포인트가 추가되었는지 확인합니다.
