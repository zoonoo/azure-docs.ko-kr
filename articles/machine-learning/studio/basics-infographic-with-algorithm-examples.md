...
## <a name="popular-algorithms-in-machine-learning-studio-classic"></a>Machine Learning Studio의 인기 있는 알고리즘 (클래식)

[Azure Machine Learning Studio (클래식)](https://studio.azureml.net/) 은 예측 분석을 위한 많은 알고리즘 라이브러리와 함께 제공 됩니다. 이 인포 그래픽은 가장 널리 사용 되는 알고리즘 패밀리 (회귀, 변칙 검색, 클러스터링 및 분류)를 식별 하 고 [Azure AI Gallery](https://gallery.azure.ai/)의 작업 예제에 대 한 링크를 제공 합니다. 갤러리는 이러한 알고리즘을 여러 실제 솔루션에 적용하는 방법을 보여주는 예제 실험 및 자습서를 포함하고 있습니다.

## <a name="download-the-infographic-with-algorithm-examples"></a>알고리즘 예제와 함께 인포그래픽을 다운로드합니다.

**[다운로드: 알고리즘 예제에 대한 링크를 포함하는 Machine Learning 기본 사항의 인포그래픽(PDF)](https://download.microsoft.com/download/0/5/A/05AE6B94-E688-403E-90A5-6035DBE9EEC5/machine-learning-basics-infographic-with-algorithm-examples.pdf)**
...
* 다양 한 유형의 기계 학습 알고리즘, 사용 방법 및 솔루션에 적합 한 알고리즘을 선택 하는 방법에 대 한 자세한 내용은 [Microsoft Azure Machine Learning Studio에 대 한 알고리즘을 선택 하는 방법 (클래식)](algorithm-choice.md)을 참조 하세요.
* 클래식 버전의 Machine Learning Studio에서 사용할 수 있는 모든 기계 학습 알고리즘의 범주별 목록은 Machine Learning Studio (클래식) 알고리즘 및 모듈 도움말에서 [모델 초기화][initialize-model] 를 참조 하세요.
* Machine Learning Studio 클래식 버전의 알고리즘 및 모듈에 대 한 전체 목록은 Machine Learning Studio (클래식) 알고리즘 및 모듈 도움말에서 [Machine Learning Studio (클래식) 모듈의 a-z 목록][a-z-list] 을 참조 하세요.
