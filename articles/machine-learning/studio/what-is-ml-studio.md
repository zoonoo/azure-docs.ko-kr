...
[Machine Learning Studio](https://studio.azureml.net)를 처음 시작하면 **홈** 페이지가 표시됩니다. 여기에서 설명서, 비디오 및 웹 세미나를 보고 다른 유용한 리소스를 찾을 수 있습니다.
...
[자습서: 그래픽 인터페이스를 사용하여 자동차 가격 예측](../service/ui-tutorial-automobile-price-train-score.md)
