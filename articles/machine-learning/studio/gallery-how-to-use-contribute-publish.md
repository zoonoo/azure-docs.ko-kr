...
* **실험** - 갤러리에는 Azure 기계 학습 스튜디오(클래식)에서 개발된 다양한 실험이 포함되어 있습니다. 이러한 실험은 특정한 기계 학습 기법을 보여주는 빠른 개념 증명 실험에서 복잡한 기계 학습 문제에 대한 완전히 개발된 솔루션에 이르기까지 다양합니다.
...
* **사용자 지정 모듈** - 사용자 지정 모듈을 Studio(클래식) 작업 공간으로 다운로드하여 실험에 사용할 수 있습니다.
...
**실험,** 사용자 지정 모듈 및 **Jupyter** **노트북을**자체 기계 학습 스튜디오(클래식) 작업 공간에 다운로드하여 자체 솔루션을 개발하는 데 사용할 수 있습니다.
...
스튜디오 (클래식) 내에서 리소스를 다운로드하려면 :

1. 스튜디오(클래식)에서 **NEW를**선택합니다.
1. **모듈**, **실험** 또는 **노트**를 선택합니다.
1. Gallery 리소스를 찾아보거나 검색합니다.
1. 마우스로 리소스를 가리킨 다음, **Studio에서 열기**를 선택합니다.
    ![기계 학습 스튜디오 내부에서 열린 갤러리 실험 (클래식)](./media/gallery-how-to-use-contribute-publish/open-experiment-from-studio.png)

리소스가 작업 영역에 있으면 Studio(클래식)에서 만든 것과 마찬가지로 사용자 지정하고 사용할 수 있습니다.

가져온 사용자 지정 모듈을 사용하려면

1. 실험을 만들거나 기존 실험을 엽니다.
1. 작업 영역에서 사용자 지정 모듈 목록을 확장하려면 모듈 팔레트에서 **사용자 지정**을 선택합니다. 모듈 팔레트는 실험 캔버스의 왼쪽에 있습니다.
1. 가져온 모듈을 선택한 후 실험으로 끌어옵니다.

## <a name="contribute-experiments"></a>실험 기여

분석 기술을 시연하거나 다른 사람에게 솔루션에 대한 점프 스타트를 제공하려면 Studio(클래식)에서 개발한 **실험에** 기여할 수 있습니다.
...
1. 스튜디오 (클래식)에서 실험을 엽니 다.

1. 실험 캔버스 아래의 작업 목록에서 **Gallery에 게시**를 선택합니다.

1. Gallery에서 설명을 포함하는 **이름** 및 **태그**를 입력합니다. 사용한 기법이나 해결하고 있는 실제 문제를 강조 표시합니다. 설명이 있는 실험 제목의 예로는 '이진 분류: 트위터 감정 분석'이 있습니다.
...
필요에 따라 갤러리에 게시한 실험의 워크플로(모듈, 매개 변수 등)를 변경할 수 있습니다. 기계 학습 스튜디오(클래식)에서는 실험을 변경하고 다시 게시할 수 있습니다. 게시되어 있는 실험이 변경한 내용으로 업데이트됩니다.
...
1. **설명** 페이지에서 **항목 형식**에 대해 **자습서** 또는 **컬렉션**을 선택합니다. 다른 사용자가 자습서를 찾는 데 도움이 되는 이름, 간략한 요약, 자세한 설명 및 태그를 입력합니다. 그리고 **다음**을 클릭합니다.

1. **이미지 선택** 페이지에서 기고 내용과 함께 표시되는 이미지를 선택합니다. 사용자 고유의 이미지 파일을 업로드하거나 스톡 이미지를 선택할 수 있습니다. 사용자가 기고 내용의 콘텐츠 및 목적을 식별하는 데 도움이 될 수 있는 이미지를 선택합니다. 그리고 **다음**을 클릭합니다.
...
**실험에 사용한 데이터 집합은 어떻게 됩니까? 데이터 집합도 갤러리에 게시되어 있습니까?**
...
**데이터 가져오기 모듈을 사용하여 Azure HDInsight 또는 SQL Server에서 데이터를 가져오는 실험이 있습니다. 내 자격 증명을 사용하여 데이터를 검색합니다. 이런 종류의 실험을 게시할 수 있습니까? 자격 증명이 공유되지 않는다는 것을 어떻게 확신할 수 있습니까?**
