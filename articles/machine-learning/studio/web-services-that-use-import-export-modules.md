...
데이터 가져오기 및 내보내기 데이터 모듈은 HTTP를 통한 웹 URL, Hive 쿼리, Azure SQL 데이터베이스, Azure Table Storage, Azure Blob Storage, 데이터 피드 또는 SQL Server 데이터베이스 등의 다양한 데이터 위치에서 읽고 쓸 수 있습니다.
