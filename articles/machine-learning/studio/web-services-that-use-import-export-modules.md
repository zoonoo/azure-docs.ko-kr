...
5. Visual Studio에서 c # 콘솔 응용 프로그램을 만듭니다. **새** > **프로젝트** > **Visual c #** > **Windows 클래식 데스크톱** > **콘솔 앱 (.NET Framework)**.
...
6. Visual Studio에서 c # 콘솔 응용 프로그램을 만듭니다. **새** > **프로젝트** > **Visual c #** > **Windows 클래식 데스크톱** > **콘솔 앱 (.NET Framework)**.
