...
* 기계 학습 스튜디오로 기계 학습 실험 만들기는 [Azure 기계 학습 스튜디오에서 첫 번째 실험 만들기](create-experiment.md)
* 웹 서비스로서 기계 학습 실험을 배포하는 방법은 [Azure 기계 학습 웹 서비스 배포](publish-a-machine-learning-web-service.md)
* 웹 서비스에 액세스하는 다른 방법은 [Azure Machine Learning 웹 서비스](consume-web-services.md)를 참조하세요.
