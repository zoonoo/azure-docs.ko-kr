...
* **저장소 계정 키** 웹 서비스 변경 내용과 연결된 저장소 계정 키를 업데이트할 수 있습니다. 
...
## <a name="grant-or-suspend-access-to-web-services-for-users-in-the-portal"></a>포털에서 사용자의 웹 서비스 액세스 허용 또는 일시 중단
Azure 클래식 포털에서 특정 사용자의 액세스를 허용하거나 거부할 수 있습니다.

### <a name="access-for-users-of-new-web-services"></a>새 웹 서비스 사용자의 액세스
다른 사용자가 Azure Machine Learning 웹 서비스 포털의 웹 서비스를 사용하려면 Azure 구독에 해당 사용자를 공동 관리자로 추가해야 합니다.

Microsoft Azure 계정을 사용하여 [Azure 클래식 포털](https://manage.windowsazure.com/)에 로그인합니다. Azure 구독에 연결된 계정을 사용합니다.

1. 탐색 창에서 **설정**, **관리자**를 차례로 클릭합니다.
2. 창 아래에서 **추가**를 클릭합니다. 
3. 공동 관리자 추가 대화 상자에서 공동 관리자로 추가할 사람의 메일 주소를 입력한 다음 공동 관리자가 액세스하려는 구독을 선택합니다.
4. **Save**를 클릭합니다.
...
2. 관리하려는 작업 영역을 클릭합니다.
3. **구성** 탭을 클릭합니다.

구성 탭에서 **거부**를 클릭하면 Machine Learning 작업 영역에 대한 액세스를 일시 중단할 수 있습니다. 사용자는 더 이상 기계 학습 스튜디오에서 작업 영역을 열 수 없습니다. 액세스를 복원하려면 **허용**을 클릭합니다.

특정 사용자의 경우

Machine Learning Studio의 작업 영역에 액세스할 수 있는 계정을 추가로 관리하려면 **대시보드** 탭에서 **ML Studio에 로그인**을 클릭합니다. 그러면 작업 영역에서 기계 학습 스튜디오가 열립니다. 여기서 **설정** 탭을 클릭한 다음 **사용자**를 클릭합니다. **더 많은 사용자 초대**를 클릭하여 사용자에게 작업 영역에 대한 액세스 권한을 부여하거나 사용자를 선택하고 **제거**를 클릭할 수 있습니다.
