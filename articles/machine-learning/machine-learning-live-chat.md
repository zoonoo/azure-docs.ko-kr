...
[Azure 기계 학습 스튜디오](machine-learning-what-is-ml-studio.md) 에서는 기계 학습 모델을 작성하는 직관적인 인터페이스를 제공합니다. 시작하는데 도움을 주는 커뮤니티가 작성한 예제의 [갤러리](machine-learning-gallery-how-to-use-contribute-publish.md)가 있습니다. 그리고 계속 진행하는 데 도움이 되는 질문을 할 수 있는 [포럼](https://social.msdn.microsoft.com/forums/azure/home?forum=MachineLearning)이 있습니다. 
