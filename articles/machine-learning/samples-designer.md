...
이러한 기본 제공 분류 샘플을 살펴보세요. 샘플을 열고 디자이너에서 모듈 주석을 보면 샘플에 대해 자세히 알아볼 수 있습니다.
...
| [사용자 지정 Python 스크립트를 통한 이진 분류 - 신용 위험 예측](https://github.com/Azure/MachineLearningDesigner/blob/master/articles/samples/binary-classification-python-credit-prediction.md) | 신용 애플리케이션을 위험 수준 높음 또는 위험 수준 낮음으로 분류합니다. Python 스크립트 실행 모듈을 사용하여 데이터에 가중치를 부여합니다.
...
기본 제공 컴퓨터 비전 예제를 살펴보세요. 샘플을 열고 디자이너에서 모듈 주석을 보면 샘플에 대해 자세히 알아볼 수 있습니다.
...
이러한 기본 제공 추천 샘플을 살펴보세요. 샘플을 열고 디자이너에서 모듈 주석을 보면 샘플에 대해 자세히 알아볼 수 있습니다.
...
기계 학습 유틸리티 및 기능을 보여 주는 샘플에 대해 자세히 알아보세요. 샘플을 열고 디자이너에서 모듈 주석을 보면 샘플에 대해 자세히 알아볼 수 있습니다.
