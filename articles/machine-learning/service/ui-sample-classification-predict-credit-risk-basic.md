...
description: 이 시각적 인터페이스 샘플 실험에는 신용 응용 프로그램에서 제공 하는 정보를 기반으로 하는 신용 위험 예측 이진 분류를 수행 하는 방법을 보여 줍니다.
...
ms.locfileid: "65028532"
---
# <a name="sample-3---classification-predict-credit-risk"></a>3-분류 샘플: 신용 위험 예측

이 시각적 인터페이스 샘플 실험에는 신용 응용 프로그램에서 제공 하는 정보를 기반으로 하는 신용 위험 예측 이진 분류를 수행 하는 방법을 보여 줍니다. 데이터 처리 작업을 비롯 한 기본 분류를 수행, 데이터 집합 학습 및 테스트 집합으로 분할 모델을 학습, 테스트 데이터 집합을 채 점 하는 방법 예측 평가 보여 줍니다.
