...
```
 ...
 데이터 집합을 사용 하 여 작업 하는 방법에 대 한 자세한 내용은 [데이터 집합 추가 & 등록](how-to-create-register-datasets.md) 또는 [이 샘플 노트북](https://aka.ms/tabulardataset-samplenotebook)을 확인 하세요.
