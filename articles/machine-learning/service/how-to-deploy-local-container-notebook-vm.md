...
>작업 영역이 다른 지역에 있는 경우 계속 해 서 [노트북 VM](concept-compute-instance.md#notebookvm) 을 만들고 사용할 수 있습니다.  이 문서의 단계를 사용 하 여 계산 인스턴스 또는 노트북 VM에 모델을 배포할 수 있습니다.
