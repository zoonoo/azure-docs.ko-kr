...
|**다양한 혼합형 계산**|확장 가능한 이기종 계산 및 저장소에 안정적으로 조정되는 여러 파이프라인을 사용합니다. HDInsight, GPU 데이터 과학 VM, Databricks 등 다양한 컴퓨팅 대상에서 개별 파이프라인 단계를 실행할 수 있습니다. 이를 통해 사용 가능한 컴퓨팅 옵션을 효율적으로 사용할 수 있습니다.|
