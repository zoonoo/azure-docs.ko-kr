...
기계 학습을 시작 하는 경우이 실험의 [기본 버전](how-to-ui-sample-regression-predict-automobile-price-basic.md) 을 살펴보겠습니다.

이 실험의 완료 된 그래프는 다음과 같습니다.

[![실험 그래프](media/how-to-ui-sample-regression-predict-automobile-price-compare-algorithms/graph.png)](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/graph.png#lightbox)
...
4. 샘플 2 실험의 **열기** 단추를 선택 합니다.
    ...
    ![실험 열기](media/how-to-ui-sample-regression-predict-automobile-price-compare-algorithms/open-sample2.png)

## <a name="experiment-summary"></a>실험 요약

다음 단계를 사용 하 여 기계 학습 실험을 빌드합니다.
...
다양 한 알고리즘의 성능을 비교 하기 위해 모델을 작성 하는 데 사용할 수 있는 두 가지 비선형 알고리즘, **의사 결정 트리 회귀** 및 **의사 결정 포리스트 회귀**를 사용 합니다. 두 알고리즘 모두 변경할 수 있는 매개 변수를 갖지만이 예제에서는이 실험의 기본값을 사용 합니다.
