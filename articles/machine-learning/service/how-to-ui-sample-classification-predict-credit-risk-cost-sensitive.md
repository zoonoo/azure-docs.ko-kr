...
그런 다음 위험 예측 모델을 개발 하는 데 사용 되는 학습 및 테스트 집합을 생성 합니다. **데이터 분할** 모듈을 사용 하 여 원래 데이터 집합을 동일한 크기의 학습 및 테스트 집합으로 분할 합니다. 같은 크기의 집합을 만들려면 **첫 번째 출력 데이터 집합 옵션에서 행의 분수** 를 0.5으로 설정 합니다.
