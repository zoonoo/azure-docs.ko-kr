...
Azure Machine Learning Service는 오픈 소스 기술을 완벽하게 지원합니다. 따라서 Machine Learning 구성 요소와 함께 수많은 오픈 소스 Python 패키지를 사용할 수 있습니다. TensorFlow 및 scikit-learn을 그 예로 들 수 있습니다.
다양한 도구에 대한 지원을 통해 손쉽게 데이터를 대화식으로 탐색하고, 변환한 다음, 모델을 개발 및 테스트할 수 있습니다. [Jupyter Notebook](http://jupyter.org) 또는 [Visual Studio Code용 Azure Machine Learning](https://marketplace.visualstudio.com/items?itemName=ms-toolsai.vscode-ai#overview) 확장을 그 예로 들 수 있습니다.
...
Azure Machine Learning Service는 모델을 자동으로 학습하여 사용자에 맞게 자동으로 조정할 수 있습니다.
예제는 [자동화된 Machine Learning을 사용하여 회귀 모델 학습](tutorial-auto-train-models.md)을 참조하세요.

Python용 Azure Machine Learning <a href="https://aka.ms/aml-sdk" target="_blank">SDK</a>와 오픈 소스 Python 패키지를 함께 사용하여 Azure Machine Learning Service 작업 영역에서 매우 정확한 Machine Learning 및 딥 러닝 모델을 직접 빌드 및 교육할 수 있습니다.
...
- [Azure Portal을 사용](quickstart-get-started.md)하거나 [Python에서](quickstart-create-workspace-with-python.md) 시작하도록 Machine Learning Service 작업 영역을 만듭니다.

- 전체 자습서 [Azure Machine Learning Service로 이미지 분류 모델 학습](tutorial-train-models-with-aml.md)을 따릅니다.

- [Azure Machine Learning을 사용하여 모델을 자동으로 생성 및 자동 조정합니다](tutorial-auto-train-models.md).
