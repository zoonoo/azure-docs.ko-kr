...
Interpretability 클래스는 두 개의 Python 패키지를 통해 가능 합니다. 설명 하는 방법 [Azure Machine Learning에 대 한 SDK 패키지를 설치](https://docs.microsoft.com/python/api/overview/azure/ml/install?view=azure-ml-py)합니다.
