...
[파이프라인 ![Graph](media/how-to-ui-sample-classification-predict-flight-delay/pipeline-graph.png)](media/how-to-ui-sample-classification-predict-credit-risk-cost-sensitive/graph.png#lightbox)

## <a name="prerequisites"></a>전제 조건

[!INCLUDE [aml-ui-prereq](../../../includes/aml-ui-prereq.md)]

4. 샘플 6 파이프라인에 대 한 **열기** 단추를 선택 합니다.

    ![파이프라인 열기](media/how-to-ui-sample-classification-predict-flight-delay/open-sample6.png)
