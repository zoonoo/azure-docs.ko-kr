...
ms.locfileid: "73796683"
---
# <a name="use-secrets-in-training-runs"></a>학습 실행에서 비밀 사용
[!INCLUDE [applies-to-skus](../../../includes/aml-applies-to-basic-enterprise-sku.md)]

이 문서에서는 학습 실행 시 안전 하 게 암호를 사용 하는 방법에 대해 알아봅니다. 예를 들어 외부 데이터베이스에 연결 하 여 학습 데이터를 쿼리하려면 원격 실행 컨텍스트에 사용자 이름 및 암호를 전달 해야 합니다. 이러한 값을 일반 텍스트의 학습 스크립트에 코딩 하는 것은 암호를 노출 하므로 안전 하지 않습니다. 
...
[List_secrets](https://docs.microsoft.com/python/api/azureml-core/azureml.core.keyvault.keyvault?view=azure-ml-py#list-secrets--) 메서드를 사용 하 여 암호 이름을 나열할 수 있습니다. __Set_secret__ 메서드는 이름이 이미 있는 경우 비밀 값을 업데이트 합니다.
