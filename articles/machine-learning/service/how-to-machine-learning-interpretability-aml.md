...
ms.locfileid: "74158714"
---
# <a name="model-interpretability-for-local-and-remote-runs"></a>로컬 및 원격 실행에 대 한 모델 interpretability

[!INCLUDE [applies-to-skus](../../../includes/aml-applies-to-basic-enterprise-sku.md)]

이 문서에서는 Azure Machine Learning Python SDK의 interpretability 패키지를 사용 하 여 모델이 예측을 수행한 이유를 이해 하는 방법을 알아봅니다. 다음 방법에 대해 알아봅니다.
...
자세한 내용은 [Azure Machine Learning service에서 모델 interpretability](how-to-machine-learning-interpretability.md)을 참조 하세요.
...
* **실험** 창 (미리 보기)
  1. 왼쪽 창에서 **실험** 을 선택 하 Azure Machine Learning 서비스에서 실행 한 실험 목록을 표시 합니다.
