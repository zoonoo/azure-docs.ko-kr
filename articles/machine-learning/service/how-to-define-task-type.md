...
## <a name="What is a machine learning task?"></a>Machine learning 작업 이란?
...
회귀 | 연속 수량 출력을 예측 하기 위한 작업입니다. | 자동차 비용은 해당 기능에 따라 달라 **집니다.**
...
+ 자동화 된 [Machine Learning 분류](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/automated-machine-learning/model-explanation) 자습서를 사용해 보세요.
+ 자동화 된 [Machine Learning 회귀](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/automated-machine-learning/model-explanation) 샘플 노트북을 사용해 보세요.
