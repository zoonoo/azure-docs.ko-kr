...
| [Designer](ui-concept-visual-interface.md) (미리 보기) | 이전에 디자이너로 알려진 기계 학습 모델링 도구를 끌어서 놓습니다. | 엔터프라이즈 |
...
+ **버그 수정 및 향상 된 기능**
  + **azure-cli-ml**
    ...
    + 데이터 집합 CLI를 추가 했습니다. 자세한 내용은 `az ml dataset --help`를 참조하십시오.
