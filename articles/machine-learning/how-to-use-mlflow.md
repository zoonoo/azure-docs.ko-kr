...
+ Azure Machine Learning 백엔드 지원 (미리 보기)을 사용 하 여 [Mlflow 프로젝트](https://www.mlflow.org/docs/latest/projects.html) 와 함께 학습 작업을 제출 합니다. Azure Machine Learning 추적을 사용 하 여 로컬로 작업을 제출 하거나 실행을 [Azure Machine Learning 계산](./how-to-create-attach-compute-cluster.md)을 통해 클라우드로 마이그레이션할 수 있습니다.
...
`azureml-mlflow`실험에서 Azure Machine Learning 하 여 MLflow 추적을 로컬로 사용 하려면 패키지를 설치 합니다. 실험은 Jupyter Notebook 또는 코드 편집기를 통해 실행할 수 있습니다.
