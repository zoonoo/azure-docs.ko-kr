---
title: Machine Learning Python 클라이언트 라이브러리를 사용하여 데이터 세트에 액세스 | Microsoft Docs
...
2. 액세스하려는 데이터 세트를 선택합니다. **내 데이터 집합** 목록 또는 **샘플** 목록에서 데이터 집합을 선택할 수 있습니다.
