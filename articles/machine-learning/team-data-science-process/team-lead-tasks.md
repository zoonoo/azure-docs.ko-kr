...
버전 관리 및 협업을 위한 코드 호스팅 플랫폼으로 Azure DevOps를 사용하는 경우 이 단계를 완료합니다. 이 섹션에서는 그룹의 Azure DevOps Services에 세 가지 아티팩트를 만듭니다.
