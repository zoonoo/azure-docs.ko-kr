...
이 문서는 고급 분석 및 Cognitive Services 솔루션 구현에 관련된 DevOps(개발자 작업) 함수를 탐색합니다. 해당 학습 자료는 데이터 과학 솔루션을 구상, 실행, 전달하는 데 도움이 되는 TDSP(Team Data Science Process)와 Microsoft 및 오픈 소스 소프트웨어 및 도구 세트를 구현합니다. 데이터 과학과 AI 프로젝트 및 솔루션과 관련된 DevOps 도구 체인을 설명하는 토픽을 참조합니다.

## <a name="lesson-path"></a>단원 경로
다음 표에서는 Azure에서 데이터 과학 솔루션을 구현하기 위한 DevOps 목표를 완료하는 데 도움이 되는 수준 기반 지침을 제공합니다.
...
| DevOps 프로세스 이해 및 구현 | DevOps 기본 사항 | [이 비디오 시리즈는 DevOps의 기본 사항에 대해 설명하고 DevOps 구성 요소에 매핑하는 방법도 설명합니다.](https://channel9.msdn.com/Series/DevOps-Fundamentals/Introduction-to-DevOps) | DevOps, Microsoft Azure Platform, Azure DevOps | 경험함 | SDLC 사용함, Agile 및 기타 개발 프레임 워크 사용 경험, IT 운영 경험 |
...
|  |  | [App Service 편집기를 사용하여 Azure Portal에서 직접 코드를 작성할 수 있습니다. 이 도구와의 연속 통합에 대한 자세한 내용은 이 리소스를 확인하세요.](https://github.com/projectkudu/kudu/wiki/App-Service-Editor) | Azure portal | 많이 경험함 | 데이터 과학 배경 - 하지만 이를 참조하세요. |
|  |  | [이 리소스는 웹 기반 Azure Machine Learning Studio(클래식) 도구를 사용하여 예측 분석 실험을 코딩하고 만드는 방법을 설명합니다.](../overview-what-is-machine-learning-studio.md#ml-studio-classic-vs-azure-machine-learning-studio) | Azure Machine Learning Studio(클래식) | 경험함 | 소프트웨어 개발 |
...
|  | 빌드 | [이 과정은 Visual Studio Codespace 빌드를 사용하여 DevOps 구성 요소를 사용하도록 설정하는 방법을 설명합니다.](https://mva.microsoft.com/training-courses/enabling-devops-practices-with-visual-studio-online-build-12478?l=ipCj6MuNB_6305094681) | Visual Studio Codespace | 경험함 | 소프트웨어 개발, SDLC 사용 경험 |
...
|  | 테스트 | [테스트 사례 관리를 위해 Visual Studio Codespace를 사용하는 방법을 이해하려면 이 참조를 사용합니다.](http://www.almguide.com/2014/07/visual-studio-online-test-case-management/) | Visual Studio Codespace | 경험함 | 소프트웨어 개발, SDLC 사용 경험 |
...
|  |  | [테스트뿐 아니라 개발의 일환으로 보안을 빌드해야 합니다. Microsoft SDL Threat Modeling Tool은 모든 단계에서 도움이 될 수 있습니다. 자세히 알아보고 여기에서 다운로드하세요.](https://www.microsoft.com/SDL/adopt/threatmodeling.aspx) | Threat Monitoring Tool | 경험함 | 보안 개념 사용 경험, 소프트웨어 개발 |
...
|  |  | [이 블로그 항목에서는 Azure Data Factory를 사용하여 고급 분석 파이프라인을 모니터링하고 관리하는 방법을 설명합니다.](https://azure.microsoft.com/blog/azure-data-factory-updates-monitoring-and-management-enhancements/) | Azure Data Factory | 중급 | Azure Data Factory 사용 경험 |
|  |  | [이 비디오는 Azure Monitor 로그 사용하여 로그를 모니터링하는 방법을 보여 줍니다.](https://channel9.msdn.com/Shows/Data-Exposed/Enterprise-HDInsight-Monitoring-with-Operations-Management-Suite) | Azure 로그, PowerShell | 경험함 | Azure 플랫폼 사용 경험 |
...
|  |  | [이 자습서는 연속 통합 및 배포 CI/CD 파이프라인을 사용하여 애플리케이션 개발의 빌드 및 테스트 단계를 자동화하는 방법을 설명합니다.](/azure/developer/jenkins/pipeline-with-github-and-docker) | Jenkins | 경험함 | Azure 플랫폼 사용 경험, DevOps 사용 경험, Jenkins 사용 경험 |
...
[데이터 과학자용 TDSP(Team Data Science Process)](team-data-science-process-for-data-scientists.md) 이 문서는 Azure로 데이터 과학 솔루션을 구현하기 위한 지침을 제공합니다.
