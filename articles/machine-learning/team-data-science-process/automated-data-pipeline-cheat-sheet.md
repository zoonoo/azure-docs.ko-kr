...
점수 매기기를 위해 웹 서비스 엔드포인트로 데이터를 이동할 때 데이터가 온-프레미스인지, 클라우드에 있는지, 실시간 스트리밍인지에 따라 여러 메커니즘을 사용할 수 있습니다.
...
* Microsoft Azure Machine Learning의 개요는 [Microsoft Azure의 기계 학습 소개](../classic/index.yml)를 참조하세요.
