...
데이터가 온-프레미스인지, 클라우드에서 든 실시간 스트리밍인지에 따라 데이터를 웹 서비스 끝점으로 이동하여 점수를 매기는 데 사용할 수 있는 다양한 메커니즘이 있습니다.
...
![마이크로소프트 Azure 기계 학습 스튜디오 (클래식) 기능 개요][op-cheat-sheet]
...
* Microsoft Azure 기계 학습에 대한 개요는 [Microsoft Azure에서 기계 학습 소개를](../studio/what-is-machine-learning.md)참조하십시오.
