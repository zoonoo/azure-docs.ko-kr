...
* Microsoft Azure 기계 학습의 개요는 [Microsoft Azure의 기계 학습 소개](../studio/what-is-machine-learning.md)를 참조하세요.
* 점수 매기기 웹 서비스를 배포하는 방법에 대한 자세한 내용은 [Azure 기계 학습 웹 서비스 배포](../studio/publish-a-machine-learning-web-service.md)를 참조하세요.
