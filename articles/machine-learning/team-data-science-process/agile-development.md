...
- **기능**: 프로젝트 참여에 해당 하는 기능입니다. 클라이언트를 사용 하는 다양 한 계약은 다양 한 기능으로, 프로젝트의 여러 단계를 다양 한 기능으로 간주 하는 것이 가장 좋습니다. 등의 스키마를 선택 하 여 *\<ClientName>-\<EngagementName>* 기능 이름을 지정할 경우 프로젝트의 컨텍스트를 쉽게 인식 하 고 이름 자체에서 참여를 제공 합니다.
...
## <a name="plan-sprints"></a><a name='SprintPlanning-2'></a>스 프린트 계획
...
사용자 스토리에 작업을 추가 하려면 사용자 스토리 항목 옆에 있는를 선택 하 **+** 고 **작업**을 선택 합니다. 작업의 제목 및 기타 정보를 입력 합니다.
...
1. TDSP 프로젝트에서 작업 항목을 추가 하려면 프로젝트 옆에 있는를 선택 하 **+** 고 만들 작업 항목의 형식을 선택 합니다. 
