...
3. **Azure Storage에 연결** 마법사를 시작 하려면 **Azure Storage에 연결** 아이콘을 선택 합니다. !["Azure Storage에 연결"을 클릭](./media/move-data-to-azure-blob-using-azure-storage-explorer/connect-to-azure-storage-1.png)
4. **Azure Storage에 연결** 마법사의 Azure Storage 계정에서 액세스 키를 입력 한 후 **다음**을 클릭 합니다. Azure Storage 계정에서 액세스 키를 입력 ![](./media/move-data-to-azure-blob-using-azure-storage-explorer/connect-to-azure-storage-2.png)
...
7. 컨테이너에 데이터를 업로드 하려면 대상 컨테이너를 선택 하 고 **업로드** 단추를 클릭 합니다.
