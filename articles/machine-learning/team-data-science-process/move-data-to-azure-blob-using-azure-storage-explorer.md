...
* 저장소 계정을 만들고 계정 및 키 정보를 가져오는 방법에 대 한 지침은 [Azure Storage 계정 정보](../../storage/common/storage-account-create.md)를 참조 하세요. Storage 계정의 선택키를 적어 두세요. Azure Storage Explorer 도구를 사용하여 계정에 연결하려면 이 키가 있어야 합니다.
