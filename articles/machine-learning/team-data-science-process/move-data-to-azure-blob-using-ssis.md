...
SSIS 기능 팩을 사용 하 여 온-프레미스에서 Azure blob 저장소로 데이터를 이동 하려면 다음과 같이 [**Azure Blob 업로드 작업**](/sql/integration-services/control-flow/azure-blob-upload-task)의 인스턴스를 사용 합니다.
