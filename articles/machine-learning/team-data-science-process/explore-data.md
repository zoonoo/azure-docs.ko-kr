...
또한 [Azure Machine Learning Studio에서 데이터를 전처리](https://azure.microsoft.com/documentation/videos/preprocessing-data-in-azure-ml-studio/)하는 비디오는 데이터를 정리하고 변환하기 위해 일반적으로 사용되는 모듈에 대해 설명합니다.
