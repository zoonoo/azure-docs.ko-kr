...
>
> 불필요 한 열 또는 대상 누수를 제외 하려면 [데이터 집합의 열 선택][select-columns] 모듈 또는 [메타 데이터 편집][edit-metadata]을 사용 합니다. 자세한 내용은 [데이터 집합에서 열 선택][select-columns] 및 [메타 데이터][edit-metadata] 참조 페이지 편집을 참조 하세요.
>
>
