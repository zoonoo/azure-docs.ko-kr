...
* 신속한 데이터 로드를 위해 대량 가져오기 작업을 병렬로 실행합니다. SQL Server 데이터베이스로 빅 데이터를 대량 으로 가져오는 데 대한 팁은 [1시간 이내에 1TB 로드를](https://blogs.msdn.com/b/sqlcat/archive/2006/05/19/602142.aspx)참조하십시오.
