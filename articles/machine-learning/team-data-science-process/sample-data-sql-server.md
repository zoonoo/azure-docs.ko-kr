...
[데이터 가져오기][import-data] Azure Machine Learning 모듈의 위의 샘플 쿼리를 직접 사용 하 여 즉시 데이터를 다운 샘플링 하 고 Azure Machine Learning 실험으로 가져올 수 있습니다. 판독기 모듈을 사용 하 여 샘플링 된 데이터를 읽는 스크린 샷은 다음과 같습니다.
...
다음 샘플 코드를 사용하여 다운 샘플링한 데이터를 파일에 저장한 후 Azure Blob에 업로드할 수 있습니다. [데이터 가져오기][import-data] 모듈을 사용 하 여 Azure Machine Learning 실험으로 blob의 데이터를 직접 읽을 수 있습니다. 단계는 다음과 같습니다. 
...
3. 다음 화면에 표시 된 것 처럼 Azure Machine Learning [데이터 가져오기][import-data] 모듈을 사용 하 여 Azure blob에서 데이터를 읽습니다.
