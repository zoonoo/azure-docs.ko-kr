...
다음 메뉴는 [TDSP(팀 데이터 과학 프로세스)](overview.md)에서 사용되는 다양한 데이터 과학 환경의 설정 방법을 설명하는 항목에 연결됩니다.
...
![작업 영역 만들기](./media/customize-hadoop-cluster/customize-cluster-img1.png)
...
![작업 영역 만들기](./media/customize-hadoop-cluster/customize-cluster-img3.png)

구성 페이지 3에서 HDInsight Hadoop 클러스터의 사용자 이름 및 암호를 제공합니다. *Hive/Oozie Metastore 입력*은 선택하지 **마세요**. 그런 다음 화살표를 클릭하여 다음 구성 페이지로 이동합니다. 

![작업 영역 만들기](./media/customize-hadoop-cluster/customize-cluster-img4.png)
...
![작업 영역 만들기](./media/customize-hadoop-cluster/customize-cluster-img5.png)
...
![작업 영역 만들기](./media/customize-hadoop-cluster/script-actions.png)
...
1. [**Azure 클래식 포털**](https://manage.windowsazure.com/)에 로그인하여 왼쪽에서 **HDInsight**를 선택하고 클러스터 목록에서 Hadoop 클러스터를 선택한 후 **구성** 탭을 클릭하고 페이지 아래쪽에서 **원격 사용** 아이콘을 클릭합니다.
    ...
    ![작업 영역 만들기](./media/customize-hadoop-cluster/enable-remote-access-1.png)
2. **원격 데스크톱 구성** 창에서 사용자 이름 및 암호 필드를 입력하고 원격 액세스의 만료 날짜를 선택합니다. 그런 다음 확인 표시를 클릭하여 Hadoop 클러스터의 헤드 노드에 대한 원격 액세스를 설정합니다.
   
    ![작업 영역 만들기](./media/customize-hadoop-cluster/enable-remote-access-2.png)
...
![작업 영역 만들기](./media/customize-hadoop-cluster/enable-remote-access-3.png)
