...
이 Hive 쿼리에서는 * \<datetime 필드>* 기본 날짜/시간 형식으로 되어 있다고 가정 합니다.
...
이 쿼리에서 * \<datetime 필드>* 의 패턴이 *03/26/2015 12:04:39*인 경우 * \<datetime 필드> '의 패턴* 은 이어야 `'MM/dd/yyyy HH:mm:ss'`합니다. 이를 테스트하려면 다음 명령을 실행합니다.
