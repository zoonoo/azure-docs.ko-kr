...
기계 학습 웹 서비스에서 웹 서비스 API 키를 가져옵니다. 기계 학습 스튜디오 또는 Azure 포털에서 가져올 수 있습니다.
### 기계 학습 스튜디오 ###
...
**기계 학습 API 도움말 페이지** 기계 학습 API 도움말 페이지에는 예측 웹 서비스에 대한 세부 정보가 포함되어 있습니다.
