...
|| Excel|Azure 기계 학습(초기)|Azure 기계 학습(최소 자승법 사용)|
|---|:---:|:---:|:---:|
|레이블 값 |실제 데이터(숫자)|동일|동일|
|학습자 |Excel -> 데이터 분석 -> 회귀|선형 회귀|선형 회귀|
|학습자 옵션|해당 없음|기본값|최소 자승법<br />L2 = 0.005|
|데이터 집합|행 26개, 기능 3개, 레이블 1개. 모든 숫자|동일|동일|
|분할: 학습|Excel에서 처음 18개 행을 학습하고 마지막 8개 행을 테스트함|동일|동일|
|분할: 테스트|마지막 8개 행에 Excel 회귀 공식 적용|동일|동일|
|**성능**||||
|조정된 R 제곱|0.96|해당 없음||
|결정 계수|해당 없음|0.78|0.952049|
|평균 절대 오차 |$9.5M|$ 19.4M|$9.5M|
...
|---|:---:|:---:|
|인터셉트/바이어스|19470209.88|19328500|
