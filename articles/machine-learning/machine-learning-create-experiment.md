...
---
# 기계 학습 자습서: Azure 기계 학습 스튜디오에서 첫 번째 데이터 과학 실험 만들기
...
## 기계 학습 스튜디오는 도움이 되나요?
기계 학습 스튜디오를 사용하면 예측 모델링 기술로 프로그램한 끌어서 놓기 모듈을 사용하여 실험을 쉽게 설정할 수 있습니다. 실험을 실행하고 답변을 예측하려면 기계 학습 스튜디오를 사용하여 *모델을 만들고*, *모델을 학습하고* *모델의 점수를 매기기고 테스트*합니다.
...
> [!TIP]
> 실험 반복의 복사본을 만들려면 실험 캔버스 아래에 있는 **SAVE AS** 단추를 사용하세요. 캔버스 아래에서 **VIEW RUN HISTORY**를 클릭하여 실험의 모든 반복을 볼 수 있습니다. 자세한 내용은 [Azure 기계 학습 스튜디오에서 실험 반복 관리][runhistory]를 참조하세요.
> 
> 
