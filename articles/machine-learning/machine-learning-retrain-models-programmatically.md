...
* Machine Learning 웹 서비스 포털에서 기존 웹 서비스를 배포한 경우 [기존 웹 서비스 재학습](machine-learning-retrain-a-classic-web-service.md)을 참조하세요. 
* 새 웹 서비스를 배포한 경우 [Machine Learning Management cmdlet을 사용하여 새 웹 서비스 재학습](machine-learning-retrain-new-web-service-using-powershell.md)을 참조하세요.

재학습 프로세스의 개요의 경우 [Machine Learning 모델 재학습](machine-learning-retrain-machine-learning-model.md)을 참조하세요.

기존의 새 Azure Resource Manager 기반 웹 서비스로 시작하려는 경우 [기존 예측 웹 서비스 재학습](machine-learning-retrain-existing-resource-manager-based-web-service.md)을 참조하세요.
