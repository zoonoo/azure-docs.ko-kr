...
이 자세한 연습에서는 기계 학습 스튜디오에서 예측 분석 모델을 개발한 다음 Azure 기계 학습 웹 서비스에 게시하는 프로세스를 따릅니다. 공개적으로 사용 가능한 신용 위험 데이터에서 시작하여 해당 데이터를 기반으로 예측 모델의 학습을 진행한 다음 다른 사람이 사용할 수 있는 웹 서비스로 모델을 게시합니다.
