...
1. Azure 스트림 분석(ASA)에 Power BI 출력을 추가합니다.
   ...
   * [Azure 스트림 분석 및 Power BI: 스트리밍 데이터의 실시간 가시성에 대한 실시간 분석 대시보드](../stream-analytics/stream-analytics-power-bi-dashboard.md)의 침에 따라 Power BI 대시보드로 Azure 스트림 분석 작업의 출력을 설정해야 합니다.
