...
이 연습에서는 SQL Server, SQL Server R Services 및 SQL Server Python Services를 사용하여 예측 분석을 수행합니다. R 및 Python 코드는 저장 프로시저에 배포됩니다. Team Data Science Process에 설명된 단계를 따릅니다. Team Data Science Process의 개요는 [데이터 과학 프로세스](data-science-process-overview.md)를 참조하세요. 
...
[SQL Server 사용](machine-learning-data-science-process-sql-walkthrough.md) 연습에서는 SQL Server와 공개적으로 사용 가능한 NYC Taxi Trip 및 요금 데이터 집합을 사용하여 기계 학습 분류 및 회귀 모델을 구축하고 배포하는 방법을 보여 줍니다.
