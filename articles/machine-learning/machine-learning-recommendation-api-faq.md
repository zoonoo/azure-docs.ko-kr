...
API 설명서는 [Azure 기계 학습 권장 사항 - 빠른 시작 가이드](machine-learning-recommendation-api-quick-start-guide.md)에 있습니다.
...
각 데이터 집합은 카탈로그 항목 최대 100,000 개와 사용 데이터 최대 2048MB를 포함할 수 있습니다. 또한 구독은 데이터 집합(모델) 최대 10 개를 포함할 수 있습니다.
