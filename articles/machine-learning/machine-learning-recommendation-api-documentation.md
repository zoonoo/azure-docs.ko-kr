...
권장 사항 추론은 기능 사용의 또 다른 측면입니다. 실제로 Azure Machine Learning 권장 사항 엔진은 기능을 사용하여 권장 사항 설명( 추론이라고도 함)을 제공할 수 있으며, 이는 권장 소비자에게 권장 항목에 대한 확신을 심어 줍니다.
...
| Name | 필수 | 형식 | 설명 |
|:--- |:--- |:--- |:--- |
| 항목 ID |예 |[A-z], [a-z], [0-9], [_] &#40;밑줄&#41;, [-] &#40;Dash&#41;<br>  최대 길이: 50 |항목의 고유 식별자 |
