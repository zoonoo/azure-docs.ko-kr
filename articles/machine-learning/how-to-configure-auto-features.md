...
|**더 많은 기능 생성** _ |DateTime 기능: 연도, 월, 일, 요일, 연간 일자, 분기, 연간 주, 시간, 분, 초<br><br> _For 예측 작업, * 이러한 추가 DateTime 기능 (ISO 연도, 반기, 월, 문자열, 주, 요일, 요일, 월, 일, 월, 오전 1 시, 오전 1 시, 오전 1 시, 오전 1 시, 오전 1 시, 오전 12 시), am/PM<br/><br/>텍스트 기능의 경우: 선 그램, bigrams 및 trigrams을 기반으로 하는 용어 빈도. [BERT를 사용 하 여이 작업을 수행 하는 방법](#bert-integration) 에 대해 자세히 알아보세요.|
