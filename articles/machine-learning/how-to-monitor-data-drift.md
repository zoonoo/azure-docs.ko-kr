...
Azure Machine Learning를 사용 하 여 AKS에 배포 된 모델에 대 한 입력을 모니터링 하 고이 데이터를 모델에 대 한 학습 데이터 집합과 비교할 수 있습니다. 정기적으로 유추 데이터는 [스냅샷과 프로 파일링](https://docs.microsoft.com/python/api/azureml-core/azureml.core.dataset.dataset?view=azure-ml-py)된 다음, 데이터 드리프트 분석을 생성 하기 위해 기준선 데이터 집합에 대해 계산 됩니다. 
