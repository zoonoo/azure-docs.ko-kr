...
2. [빠른 시작 설치 가이드](./quickstart-installation.md)에 따라 [Azure Machine Learning Workbench](./overview-what-is-azure-ml.md)의 설치 복사본으로 프로그램을 설치하고 작업 공간을 만듭니다.
...
|  | CreationDate | Timestamp | 질문을 받은 시간의 타임스탬프
...
|  | CreationDate | Timestamp | 중복 질문을 받은 시간의 타임스탬프
