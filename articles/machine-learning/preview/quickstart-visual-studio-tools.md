...
Visual Studio가 다시 로드되면 확장이 활성화됩니다. [확장 찾기에 대해 자세히 알아보세요](hhttps://docs.microsoft.com/en-us/visualstudio/ide/finding-and-using-visual-studio-extensions).
