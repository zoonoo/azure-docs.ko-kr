...
1. A depenencies.yml 파일: [PyPi]( https://pypi.python.org/pypi)에서 설치할 수 있는 종속성을 관리하기 위해 Workbench 프로젝트의 conda_dependencies.yml 파일을 사용하거나 직접 만들 수 있습니다. 이 방법은 pip 설치 가능 Python 종속성을 설치하는 데 권장되는 방법입니다.
