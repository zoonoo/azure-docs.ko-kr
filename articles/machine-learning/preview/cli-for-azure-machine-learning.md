---
title: 최상위 Azure Machine Learning 작업에 대한 기계 학습 CLI 설치 및 사용
...
>[!NOTE]
>Azure Machine Learning 서비스와 함께 제공되는 CLI는 Azure 리소스 관리에 사용되는 [Azure CLI](https://docs.microsoft.com/en-us/cli/azure/?view=azure-cli-latest)와 다릅니다.
