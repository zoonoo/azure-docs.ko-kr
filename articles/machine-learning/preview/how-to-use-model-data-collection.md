...
Azure Machine Learning Workbench에서 모델 데이터 컬렉션 기능을 사용하여 웹 서비스의 모델 입력 및 예측을 보관할 수 있습니다.
...
Microsoft 소프트웨어 및 오픈 소스 도구를 통해 다양한 방법으로 Azure Blob에서 데이터를 사용할 수 있습니다. 다음은 몇 가지 예입니다.
