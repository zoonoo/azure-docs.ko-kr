...
| 이름 | 위치 | 설명 | 필수 | 스키마
|--------------------|--------------------|--------------------|--------------------|--------------------|
| subscriptionId | path | Azure 구독 ID입니다. | 예 | string |
| resourceGroupName | path | 모델 관리 계정이 있는 리소스 그룹의 이름 | 예 | string |
| accountName | path | 모델 관리 계정의 이름입니다. | 예 | string |
...
| model | body | 모델을 등록하는 데 사용되는 페이로드입니다. | 예 | [Model](#model) |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | string |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | string |
| manifestRequest | body | 매니페스트를 등록하는 데 사용되는 페이로드입니다. | 예 | [Manifest](#manifest) |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | string |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | string |
| imageRequest | body | 이미지를 만드는 데 사용되는 페이로드입니다. | 예 | [ImageRequest](#imagerequest) |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | string |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | string |
| serviceRequest | body | 서비스를 만드는 데 사용되는 페이로드입니다. | 예 | [ServiceCreateRequest](#servicecreaterequest) |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | string |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | string |
| serviceUpdateRequest | body | 기존 서비스를 업데이트하는 데 사용되는 페이로드입니다. | 예 |  [ServiceUpdateRequest](#serviceupdaterequest) |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | string |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | string |
| regenerateKeyRequest | body | 기존 서비스를 업데이트하는 데 사용되는 페이로드입니다. | 예 | [ServiceRegenerateKeyRequest](#serviceregeneratekeyrequest) |
