...
| Name | 위치 | 설명 | 필수 | 스키마
|--------------------|--------------------|--------------------|--------------------|--------------------|
| subscriptionId | 경로 | Azure 구독 ID입니다. | 예 | 문자열 |
| resourceGroupName | 경로 | 모델 관리 계정이 있는 리소스 그룹의 이름 | 예 | 문자열 |
| accountName | 경로 | 모델 관리 계정의 이름입니다. | 예 | 문자열 |
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
| 이름 | 쿼리 | 개체 이름입니다. | 아니요 | 문자열 |
| tag | 쿼리 | 모델 태그입니다. | 아니요 | 문자열 |
| count | 쿼리 | 한 페이지에서 검색할 항목의 수입니다. | 아니오 | 문자열 |
| $skipToken | 쿼리 | 다음 페이지를 검색하기 위한 연속 토큰입니다. | 아니요 | 문자열 |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
| modelId | 쿼리 | 모델 ID입니다. | 아니요 | 문자열 |
| manifestName | 쿼리 | 매니페스트 이름입니다. | 아니요 | 문자열 |
| count | 쿼리 | 한 페이지에서 검색할 항목의 수입니다. | 아니요 | 문자열 |
| $skipToken | 쿼리 | 다음 페이지를 검색하기 위한 연속 토큰입니다. | 아니요 | 문자열 |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
| manifestId | 쿼리 | 매니페스트 ID입니다. | 아니요 | 문자열 |
| manifestName | 쿼리 | 매니페스트 이름입니다. | 아니오 | 문자열 |
| count | 쿼리 | 한 페이지에서 검색할 항목의 수입니다. | 아니요 | 문자열 |
| $skipToken | 쿼리 | 다음 페이지를 검색하기 위한 연속 토큰입니다. | 아니오 | 문자열 |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
| serviceName | 쿼리 | 서비스 이름입니다. | 아니요 | 문자열 |
| modelId | 쿼리 | 모델 이름입니다. | 아니오 | 문자열 |
| modelName | 쿼리 | 모델 ID입니다. | 아니요 | 문자열 |
| manifestId | 쿼리 | 매니페스트 ID입니다. | 아니요 | 문자열 |
| manifestName | 쿼리 | 매니페스트 이름입니다. | 아니오 | 문자열 |
| imageId | 쿼리 | 이미지 ID입니다. | 아니오 | 문자열 |
| computeResourceId | 쿼리 | Machine Learning 계산 리소스 ID입니다. | 아니요 | 문자열 |
| count | 쿼리 | 한 페이지에서 검색할 항목의 수입니다. | 아니요 | 문자열 |
| $skipToken | 쿼리 | 다음 페이지를 검색하기 위한 연속 토큰입니다. | 아니요 | 문자열 |
...
| api-version | 쿼리 | 사용할 Microsoft.Machine.Learning 리소스 공급자 API의 버전입니다. | 예 | 문자열 |
| 권한 부여 | 머리글 | 권한 부여 토큰입니다. "Bearer XXXXXX"와 같아야 합니다. | 예 | 문자열 |
| serviceId | 쿼리 | 서비스 ID입니다. | 아니오 | 문자열 |
...
|Name|설명|스키마|
|---|---|---|
|**id**  <br>*선택 사항*|자산 ID입니다.|문자열|
|**mimeType**  <br>*선택 사항*|모델 콘텐츠의 MIME 형식입니다. MIME 형식에 대한 자세한 내용은 [IANA 미디어 유형 목록](https://www.iana.org/assignments/media-types/media-types.xhtml)을 참조하세요.|문자열|
|**unpack**  <br>*선택 사항*|Docker 이미지를 생성하는 동안 콘텐츠의 압축을 풀어야 할지 여부를 나타냅니다.|부울|
|**url**  <br>*선택 사항*|자산 위치 URL입니다.|문자열|
...
|**id**  <br>*선택 사항*|비동기 작업 ID입니다.|문자열|
|**operationType**  <br>*선택 사항*|비동기 작업 유형입니다.|enum (Image, Service)|
|**resourceLocation**  <br>*선택 사항*|비동기 작업에 의해 리소스가 생성/업데이트됩니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**primaryKey**  <br>*선택 사항*|기본 키입니다.|문자열|
|**secondaryKey**  <br>*선택 사항*|보조 키입니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**cpu**  <br>*선택 사항*|CPU 예약을 지정합니다. Kubernetes에 대한 형식: [CPU 의미](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/#meaning-of-cpu)를 참조하세요.|문자열|
|**memory**  <br>*선택 사항*|메모리 예약을 지정합니다. Kubernetes에 대한 형식: [메모리 의미](https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/#meaning-of-memory)를 참조하세요.|문자열|
...
|**id**  <br>*선택 사항*|배포 ID입니다.|문자열|
|**imageId**  <br>*선택 사항*|이 배포에 연결된 이미지 ID입니다.|문자열|
|**serviceName**  <br>*선택 사항*|서비스 이름입니다.|문자열|
|**상태**  <br>*선택 사항*|현재 배포 상태입니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**code**  <br>*필수*|오류 코드|문자열|
|**message**  <br>*필수*|오류 메시지입니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**computeResourceId**  <br>*선택 사항*|Machine Learning 계산 리소스에서 만든 환경 ID입니다.|문자열|
|**createdTime**  <br>*선택 사항*|이미지 만든 시간(UTC)입니다.|string (date-time)|
|**creationState**  <br>*선택 사항*||[AsyncOperationState](#asyncoperationstate)|
|**description**  <br>*선택 사항*|이미지 설명 텍스트입니다.|문자열|
|**error**  <br>*선택 사항*||[ErrorResponse](#errorresponse)|
|**id**  <br>*선택 사항*|이미지 ID입니다.|문자열|
|**imageBuildLogUri**  <br>*선택 사항*|이미지 빌드에서 업로드한 로그의 URI입니다.|문자열|
|**imageLocation**  <br>*선택 사항*|만든 이미지에 대한 Azure Container Registry 위치 문자열입니다.|문자열|
|**imageType**  <br>*선택 사항*||[ImageType](#imagetype)|
|**manifest**  <br>*선택 사항*||[Manifest](#manifest)|
|**name**  <br>*선택 사항*|이미지 이름입니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**computeResourceId**  <br>*필수*|Machine Learning 계산 리소스에서 만든 환경 ID입니다.|문자열|
|**description**  <br>*선택 사항*|이미지 설명 텍스트입니다.|문자열|
|**imageType**  <br>*필수*||[ImageType](#imagetype)|
|**manifestId**  <br>*필수*|이미지를 만들 매니페스트의 ID입니다.|문자열|
|**name**  <br>*필수*|이미지 이름입니다.|문자열|
...
|**description**  <br>*선택 사항*|매니페스트 설명 텍스트입니다.|문자열|
|**driverProgram**  <br>*필수*|매니페스트의 드라이버 프로그램입니다.|문자열|
|**id**  <br>*선택 사항*|매니페스트 ID입니다.|문자열|
...
|**description**  <br>*선택 사항*|모델 설명 텍스트입니다.|문자열|
|**id**  <br>*선택 사항*  <br>*읽기 전용*|모델 ID입니다.|문자열|
|**mimeType**  <br>*필수*|모델 콘텐츠의 MIME 형식입니다. MIME 형식에 대한 자세한 내용은 [IANA 미디어 유형 목록](https://www.iana.org/assignments/media-types/media-types.xhtml)을 참조하세요.|문자열|
|**name**  <br>*필수*|모델 이름입니다.|문자열|
|**태그**  <br>*선택 사항*|모델 태그 목록입니다.|<string> 배열|
|**unpack**  <br>*선택 사항*|Docker 이미지를 생성하는 동안 모델의 압축을 풀어야 할지 여부를 나타냅니다.|부울|
|**url**  <br>*필수*|모델의 URL입니다. 일반적으로 여기에 공유 액세스 서명 URL을 넣습니다.|문자열|
...
|Name|설명|스키마|
|---|---|---|
|**nextLink**  <br>*선택 사항*|목록에서 결과의 다음 페이지에 대한 연속 링크(절대 URI)입니다.|문자열|
...
|**ID**  <br>*선택 사항*|서비스 ID입니다.|문자열|
|**image**  <br>*선택 사항*||[이미지](#image)|
|**manifest**  <br>*선택 사항*||[Manifest](#manifest)|
|**models**  <br>*선택 사항*|모델의 목록입니다.|<[모델](#model)> 배열|
|**name**  <br>*선택 사항*|서비스 이름입니다.|문자열|
|**scoringUri**  <br>*선택 사항*|서비스의 점수를 매기기 위한 URI입니다.|문자열|
|**state**  <br>*선택 사항*||[AsyncOperationState](#asyncoperationstate)|
...
|**containerResourceReservation**  <br>*선택 사항*||[ContainerResourceReservation](#containerresourcereservation)|
|**dataCollection**  <br>*선택 사항*||[ModelDataCollection](#modeldatacollection)|
|**imageId**  <br>*선택 사항*|서비스를 만들 이미지입니다.|문자열|
|**maxConcurrentRequestsPerContainer**  <br>*선택 사항*|최대 동시 요청 수입니다.  <br>**최소값**: `1`|정수|
|**numReplicas**  <br>*선택 사항*|언제든지 실행되는 pod 복제본의 수입니다. Autoscaler가 사용되도록 설정되면 지정할 수 없습니다.  <br>**최소값**: `0`|정수|
