...
* 원격 Linux 컴퓨터의 Docker 컨테이너 내부에 있는 conda Python 환경. 예를 들어 [Azure의 Ubuntu 기반 DSVM](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-ads.linux-data-science-vm-ubuntu)이 있습니다.
