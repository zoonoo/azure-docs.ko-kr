---
title: "Azure Storage 탐색기를 사용하여 Azure Blob Storage의 데이터 이동 | Microsoft Docs"
...
---
# <a name="move-data-to-and-from-azure-blob-storage-using-azure-storage-explorer"></a>Azure 저장소 탐색기를 사용하여 Azure Blob 저장소의 데이터 이동
...
4. **Azure Storage에 연결** 마법사에서 Azure Storage 계정의 선택키를 입력한 후에 **다음**을 클릭합니다. ![](./media/machine-learning-data-science-move-data-to-azure-blob-using-azure-storage-explorer/connect-to-azure-storage-2.png)
...
9. 데이터를 다운로드하려면 해당 컨테이너에서 다운로드하려는 Blob를 선택한 후에 **다운로드**를 클릭합니다. ![](./media/machine-learning-data-science-move-data-to-azure-blob-using-azure-storage-explorer/download-files-from-blob.png)
