...
> [!TIP]
> 이 섹션의 명령은 기본 버전 작업 영역을 만듭니다. 엔터프라이즈 작업 영역을 만들려면 `--sku enterprise` `az ml workspace create` 명령과 함께 스위치를 사용 합니다. Azure Machine Learning 버전에 대 한 자세한 내용은 [Azure Machine Learning 항목](overview-what-is-azure-ml.md#sku)을 참조 하세요.
