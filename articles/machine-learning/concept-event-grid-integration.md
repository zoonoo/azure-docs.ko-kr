...
Azure Machine Learning는 모델 학습, 모델 배포 및 모니터링을 포함 하 여 기계 학습 프로세스의 전체 수명 주기를 관리 합니다. 최신 서버를 사용 하지 않는 아키텍처를 사용 하 여 응용 프로그램에서 기계 학습 수명 주기 동안 이벤트에 대응할 수 있도록 하는 Azure Machine Learning 이벤트 (예: 학습 실행 완료, 모델 등록 및 배포, 데이터 드리프트 검색)를 허용 합니다. 
