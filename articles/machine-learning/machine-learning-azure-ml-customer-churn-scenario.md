<properties 
	pageTitle="Microsoft 학습을 사용하여 고객 이탈 분석 | Microsoft Azure" 
...
> 이 데이터는 비공개 데이터이므로 모델 및 데이터를 공유할 수 없습니다. 그러나 공개적으로 사용할 수 있는 데이터를 사용하는 유사한 모델의 경우 [모델 갤러리](http://gallery.azureml.net/): [Telco 고객 이탈](http://gallery.azureml.net/Experiment/31c19425ee874f628c847f7e2d93e383)에서 이 샘플 실험을 참조하세요.
> 
