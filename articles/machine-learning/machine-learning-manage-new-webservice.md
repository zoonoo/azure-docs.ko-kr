...
> [!NOTE]
> 이 섹션의 절차는 Azure Machine Learning 웹 서비스 포털을 통해 기본 웹 서비스를 관리하는 것과 관련됩니다. Machine Learning Studio 및 Azure 클래식 포털을 통한 기존 웹 서비스 관리에 대한 내용은 [Azure Machine Learning 작업 영역 관리](machine-learning-manage-workspace.md)를 참조하세요.
> 
> 
