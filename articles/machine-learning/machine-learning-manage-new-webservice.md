<properties
    pageTitle="Azure Machine Learning 웹 서비스 포털에서 웹 서비스 관리 | Microsoft Azure"
...
> [AZURE.NOTE] 이 섹션의 절차는 Azure Machine Learning 웹 서비스 포털을 통해 기본 웹 서비스를 관리하는 것과 관련됩니다. Machine Learning Studio 및 Azure 클래식 포털을 통한 기존 웹 서비스 관리에 대한 내용은 [Azure Machine Learning 작업 영역 관리](machine-learning-manage-workspace.md)를 참조하세요.
...
기존 웹 서비스 끝점 페이지에서 서비스의 끝점을 추가하거나 삭제할 수 있습니다. 끝점 추가에 대한 자세한 내용은 [끝점 만들기](machine-learning-create-endpoint.md)를 참조하세요.
