<properties
	pageTitle="예측 유지 관리를 위한 Cortana Analytics 솔루션 템플릿 플레이 북 | Microsoft Azure"
	description="예측 유지 관리를 위한 Microsoft Cortana Analytics 솔루션 템플릿입니다."
...
# 예측 유지 관리를 위한 Cortana Analytics 솔루션 템플릿 플레이 북
...
>[AZURE.TIP]이 템플릿에 대한 아키텍처 개요를 제공하는 다이어그램을 다운로드하려면 [예측 유지 관리를 위한 Cortana Analytics 솔루션 템플릿 아키텍처](cortana-analytics-architecture-predictive-maintenance.md)를 참조하세요.
