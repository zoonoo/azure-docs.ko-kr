...
AKS(Azure Kubernetes Service)를 사용하면 Azure Machine Learning과 함께 사용하면 다양한 구성 옵션을 사용할 수 있습니다. 자세한 내용은 [Azure Kubernetes Service를 만들고 연결하는 방법](how-to-create-attach-kubernetes.md)을 참조하세요.
