...
Azure 컨테이너 인스턴스는 디스크 암호화를 지원하지 않습니다. 디스크 암호화가 필요한 경우 [대신 Azure Kubernetes 서비스 인스턴스에 배포하는](how-to-deploy-azure-kubernetes-service.md) 것이 좋습니다. 이 경우 역할 기반 액세스 컨트롤에 대한 Azure Machine Learning의 지원을 사용하여 구독의 Azure 컨테이너 인스턴스에 대한 배포를 방지할 수도 있습니다.
