---
title: Azure Machine Learning과 ML Studio(클래식)
description: Azure Machine Learning과 ML Studio(클래식)의 차이점
...
## <a name="comparison-azure-machine-learning-vs-ml-studio-classic"></a>비교: Azure Machine Learning과 ML Studio(클래식)
...
- [Azure Machine Learning 개요](service/tutorial-first-experiment-automated-ml.md) 읽기 
...
Azure Machine Learning에는 디자이너의 끌어서 놓기 기능 외에도 다른 도구가 있습니다.  
  + [Python Notebook을 사용하여 ML 모델 학습 및 배포](./service/tutorial-1st-experiment-sdk-setup.md)
  + [R Markdown을 사용하여 ML 모델을 학습 및 배포](./service/tutorial-1st-r-experiment.md) 
  + [자동화된 Machine Learning을 사용하여 ML 모델 학습 및 배포](./service/tutorial-designer-automobile-price-train-score.md) 
  + [기계 학습 CLI를 사용하여 모델 학습 및 배포](./service/tutorial-train-deploy-model-cli.md)
