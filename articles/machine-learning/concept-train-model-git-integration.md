...
> ```
>
> 을 설치 하 고 경로에 `git version 2.4.1`와 유사한 응답을 받게 됩니다. 개발 환경에 git을 설치 하는 방법에 대 한 자세한 내용은 [git 웹 사이트](https://git-scm.com/)를 참조 하세요.
...
1. __로그__를 선택한 다음 __로그__ 및 __azureml__ 항목을 확장 합니다. __Azure \_###__ 시작 하는 링크를 선택 합니다.
...
`az ml run` CLI 명령은 실행에서 속성을 검색 하는 데 사용할 수 있습니다. 예를 들어 다음 명령은 `train-on-amlcompute`실험에서 마지막으로 실행 된 속성을 반환 합니다.
