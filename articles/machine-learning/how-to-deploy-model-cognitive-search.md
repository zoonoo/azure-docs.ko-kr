...
> [!TIP]
> 배포의 메모리, CPU 또는 GPU 요구 사항에 대해 잘 모를 경우 프로 파일링을 사용 하 여 이러한 정보를 확인할 수 있습니다. 자세한 내용은 [모델을 배포 하는 방법 및 위치](how-to-deploy-and-where.md#prepare-to-deploy)를 참조 하세요.
