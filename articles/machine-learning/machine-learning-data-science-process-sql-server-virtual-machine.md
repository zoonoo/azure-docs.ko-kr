...
---
# <a name="a-nameheadingaprocess-data-in-sql-server-virtual-machine-on-azure"></a><a name="heading"></a>Azure의 SQL Server 가상 컴퓨터에서 데이터 처리
...
### <a name="a-namesql-dataexplorationadata-exploration"></a><a name="sql-dataexploration"></a>데이터 탐색
...
### <a name="a-namesql-featuregenafeature-generation"></a><a name="sql-featuregen"></a>기능 생성
