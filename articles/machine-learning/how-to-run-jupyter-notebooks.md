...
컴퓨팅 인스턴스 실행이 실행되는 경우 모든 Python Notebook에서[Intellisense](https://code.visualstudio.com/docs/editor/intellisense) 기반 코드 완성 기능을 사용할 수 있습니다.
