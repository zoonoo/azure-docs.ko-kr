...
* 회사 및 공개 데이터 집합의 관리 및 검색

이 문서 시리즈에서는 이러한 각 특성과 관련된 지침 및 조언을 제공합니다. [Azure 아키텍처 센터](https://docs.microsoft.com/en-us/azure/architecture/)는 분석 인프라에 대한 더 자세한 통합된 아키텍처를 제공합니다.  
