...
3. Geo-DSVM을 만드는 데 사용되는 마법사에서 이 그림의 오른쪽에 열거된 **네 단계** 각각에 대한 **입력**이 필요합니다. 다음은 이러한 각 단계를 구성하는 데 필요한 입력입니다.
   ...
   - **설정**: Geo DSVM에서 GPU에 대한 딥러닝을 실행하려는 경우 NC 시리즈 GPU 가상 머신 크기 중 하나를 선택합니다. 그렇지 않으면, CPU 기반 인스턴스 중 하나를 선택할 수 있습니다.  VM에 대한 스토리지 계정을 만듭니다. 
...
유료 또는 평가판 ArcGIS 계정 중 하나에 등록한 후 [ArcGIS Pro 시작](https://www.esri.com/library/brochures/getting-started-with-arcgis-pro.pdf)의 지침에 따라 계정에서 ArcGIS Pro에 권한을 부여할 수 있습니다. 
