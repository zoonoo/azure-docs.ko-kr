...
> [!NOTE]
> SQL Server 2016 Developer Edition은 개발 및 테스트 목적 으로만 사용할 수 있습니다. 프로덕션에서 실행하려면 라이선스나 SQL Server VM 중 하나가 필요합니다.
...
| 지원 되는 DSVM 버전      | Linux <br /> Windows (실험적)      |
...
> [!NOTE]
> DSVM의 Spark 컨텍스트에서 Microsoft Machine Learning Server 실행은 Ubuntu Linux DSVM 버전 에서만 지원 됩니다.
