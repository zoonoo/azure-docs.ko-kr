...
|[Chainer](https://chainer.org/) |아니요 | 예 |Chainer는 [Python 3.5](dsvm-languages.md#python-linux-and-windows-server-2012-edition)에 설치됩니다. ChainerRL 및 ChainerCV도 설치됩니다. <br/><br/>샘플 노트북은 JupyterHub에 포함되어 있습니다.<br/><br/>**실행 하려면 다음을 수행 합니다**. <br/>터미널과 [Python 3.5](dsvm-languages.md#python-linux-and-windows-server-2012-edition) 환경을 활성화 하 고, _python_을 실행 한 다음, 체 이너를 가져옵니다. <br/> JupyterHub [JupyterHub에 연결한](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)다음, 체 이너 디렉터리로 이동 하 여 샘플 노트북을 찾습니다.|
