...
| 파이썬 2.7로 전환하는 방법 | `source activate root`를 실행합니다. |
...
|    |           |
| ------------- | ------------- |
| 정의   | MXNet 및 ONNX 모델에 대한 HTTP 엔드포인트를 만들 서버      |
| 지원되는 DSVM 버전      | Linux     |
...
|    |           |
| ------------- | ------------- |
| 정의   | TensorFlow에 대 한 분산형 심층 학습 프레임 워크      |
| 지원되는 DSVM 버전      | Ubuntu     |
...
|    |           |
| ------------- | ------------- |
| 정의   | 심층 학습 모델을 빠르게 훈련하기 위한 NVIDIA의 심층 교육 시스템      |
| 지원되는 DSVM 버전      | Ubuntu     |
...
|    |           |
| ------------- | ------------- |
| 정의   | TensorFlow 모델에서 유추를 실행하는 서버      |
| 지원되는 DSVM 버전      | Linux     |
