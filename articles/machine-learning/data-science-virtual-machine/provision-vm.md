...
[CentOS](linux-dsvm-intro.md) 이미지도 Windows 이미지와 같은 많은 도구와 함께 사용할 수 있습니다. [Ubuntu](dsvm-ubuntu-intro.md) 이미지도 비슷한 많은 도구 및 심층 학습 프레임워크와 함께 사용할 수 있습니다.
...
Python과 R에 몇 가지 샘플 노트북을 패키지했습니다. Jupyter에 로그인하면 Jupyter 노트북에서 Microsoft R Server, SQL Server 2016 R Services(데이터베이스 내 분석), Python, Microsoft Cognitive ToolKit를 심층 학습 및 다른 Azure 기술에 사용하는 방법을 보여 줍니다. 이전 단계에서 만든 암호를 사용하여 Jupyter 노트북에 인증한 후에 노트북 홈 페이지에서 샘플에 대한 링크를 볼 수 있습니다. 
