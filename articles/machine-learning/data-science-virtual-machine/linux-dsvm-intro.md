---
title: "Azure에서 Linux CentOS 데이터 과학 가상 컴퓨터 프로비전 | Microsoft Docs"
...
---
# <a name="provision-a-linux-centos-data-science-virtual-machine-on-azure"></a>Azure에서 Linux CentOS 데이터 과학 가상 컴퓨터 프로비전
...
* [Linux 데이터 과학 가상 컴퓨터의 데이터 과학](linux-dsvm-walkthrough.md) 연습은 여기에 프로비전된 Linux 데이터 과학을 사용하여 여러 가지 일반적인 데이터 과학 작업을 수행하는 방법을 보여 줍니다. 
