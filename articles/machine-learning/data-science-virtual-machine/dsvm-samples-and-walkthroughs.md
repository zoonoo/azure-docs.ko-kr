...
| Julia 언어  | 줄리아의 그리기 및 심층 학습에 대 한 자세한 설명을 제공 합니다. 또한 줄리아에서 C 및 Python을 호출 하는 방법을 설명 합니다. <br/> [줄리아 언어](#julia-language) |<br/> Windows:<br/> `~notebooks/Julia_notebooks`<br/><br/> Linux:<br/> `~notebooks/julia`<br/><br/> |
