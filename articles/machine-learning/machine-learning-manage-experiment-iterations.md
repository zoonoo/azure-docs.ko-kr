<properties 
	pageTitle="기계 학습 스튜디오에서 반복 실험 관리 | Azure" 
...
> [AZURE.TIP] 반복 실험을 문서화하려면 실행할 때마다 제목을 수정하고, 속성 창에서 실험의 **요약**을 업데이트하며, 변경 사항을 기록하기 위해 개별 모듈에 대한 주석을 추가하거나 업데이트할 수 있습니다. 제목, 요약 및 모듈 주석은 실험이 실행될 때마다 저장됩니다.
