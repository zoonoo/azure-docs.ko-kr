...
## 학습, 평가 및 비교  
동일한 [모델 조정 하이퍼 매개 변수][tune-model-hyperparameters] 모듈이 매개 변수 집합에 해당하는 모든 모델을 학습하고, 여러 메트릭을 평가한 다음, 사용자가 선택한 메트릭을 기반으로 최상의 학습된 모델을 출력합니다. 이 모듈에는 다음 두 개의 필수 입력이 있습니다.
