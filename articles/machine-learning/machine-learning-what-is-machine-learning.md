<properties
    pageTitle="Azure의 기계 학습이란 무엇인가요? | Microsoft Azure"
...
Azure 기계 학습은 특히 예측 분석을 수행하는 강력한 방법입니다. 사용할 준비가 되어 있는 알고리즘 라이브러리에서 작업하고, 인터넷에 연결된 PC에서 모델을 만들며, 예측 솔루션을 신속하게 배포할 수 있습니다. 결과를 신속하게 얻으려면 [Cortana Intelligence Gallery](http://gallery.cortanaintelligence.com/)에서 즉시 사용 예제와 솔루션을 시작합니다.
