<properties pageTitle="Azure 기계 학습을 위해 Azure SQL 데이터베이스로 데이터 이동 | Azure" description="SQL 테이블 만들기 및 SQL 테이블에 데이터 로드" services="machine-learning" documentationCenter="" authors="fashah" manager="jacob.spoelstra" editor="" videoId="" [hee scriptId="" />
