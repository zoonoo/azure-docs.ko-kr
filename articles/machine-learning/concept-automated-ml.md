...
---
# <a name="what-is-automated-machine-learning-automl"></a>자동 기계 학습(AutoML)이란 무엇입니까?

자동화된 기계 학습은 자동화ML 또는 AutoML이라고도 하며, 기계 학습 모델 개발의 시간 소모적이고 반복적인 작업을 자동화하는 프로세스입니다. 이를 통해 데이터 과학자, 분석가 및 개발자는 모델 품질을 유지하면서 높은 규모, 효율성 및 생산성으로 ML 모델을 구축할 수 있습니다. 자동화 된 ML은 Microsoft [연구 부서의](https://arxiv.org/abs/1705.05355)돌파구를 기반으로합니다.
...
## <a name="when-to-use-automl-classify-regression--forecast"></a>AutoML 사용 시기: 분류, 회귀, & 예측
...
분류는 일반적인 기계 학습 작업입니다. 분류는 모델이 학습 데이터를 사용하여 학습하고 이러한 학습을 새 데이터에 적용하는 감독학습 유형입니다. Azure 기계 학습은 분류를 위한 심층 신경망 텍스트 위화기와 같은 이러한 작업에 대해 특별히 위화기를 제공합니다. [위화 옵션에](how-to-use-automated-ml-for-ml-models.md#featurization)대해 자세히 알아보십시오. 
...
이러한 Python 노트북에서 예측에 대한 회귀 및 자동화된 기계 학습 의 예: [CPU 성능 예측,](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/automated-machine-learning/regression-hardware-performance-explanation-and-featurization/auto-ml-regression-hardware-performance-explanation-and-featurization.ipynb) 

### <a name="time-series-forecasting"></a>시계열 예측

빌딩 예측은 수익, 재고, 판매 또는 고객 수요 등 모든 비즈니스에서 필수적인 부분입니다. 자동화된 ML을 사용하여 기술과 접근 방식을 결합하고 권장되는 고품질 의 시간계 예측을 얻을 수 있습니다. 이 방법: [타임시리즈 예측을 위한 자동화된 기계 학습을](how-to-auto-train-forecast.md)통해 자세히 알아보십시오. 
...
이러한 Python 노트북의 예측에 대한 회귀 및 자동화된 기계 학습의 예를 참조하십시오: [판매 예측,](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/automated-machine-learning/forecasting-orange-juice-sales/auto-ml-forecasting-orange-juice-sales.ipynb) [수요 예측](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/automated-machine-learning/forecasting-energy-demand/auto-ml-forecasting-energy-demand.ipynb)및 음료 [생산 예측.](https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/automated-machine-learning/forecasting-beer-remote/auto-ml-forecasting-beer-remote.ipynb)

## <a name="how-automl-works"></a>자동 ML 작동 방식

학습 하는 동안 Azure 기계 학습 은 다른 알고리즘 및 매개 변수를 시도 하는 병렬로 파이프라인의 수를 만듭니다. 이 서비스는 기능 선택과 페어링된 ML 알고리즘을 반복하며, 각 반복은 학습 점수가 있는 모델을 생성합니다. 점수가 높을수록 모델이 데이터에 "적합"하게 간주됩니다.  실험에 정의된 종료 기준에 도달하면 중지됩니다. 

**Azure 기계 학습을**사용하여 다음 단계를 사용하여 자동화된 ML 학습 실험을 디자인하고 실행할 수 있습니다.

1. 해결해야 할 **ML 문제 식별:** 분류, 예측 또는 회귀

1. **파이썬 SDK 또는 스튜디오 웹 환경을 사용할지 선택**: [파이썬 SDK와 스튜디오 웹 환경](#parity)사이의 패리티에 대해 알아보십시오.

   * 코드 환경이 제한되거나 없는 경우 Azure 기계 학습 스튜디오 웹 환경을[https://ml.azure.com](https://ml.azure.com/)  
   * 파이썬 개발자의 경우 [Azure 기계 학습 파이썬 SDK를](how-to-configure-auto-train.md) 확인하십시오. 
...
1. **자동화된 기계 학습 매개 변수를 구성하여** 다양한 모델에 대한 반복 수, 하이퍼매개 변수 설정, 고급 전처리/위화및 최적의 모델을 결정할 때 살펴볼 메트릭을 결정합니다.  
1. **교육 실행을 제출합니다.**
...
### <a name="advanced-preprocessing--featurization"></a>고급 전처리 & 위화
...
## <a name="the-studio-vs-sdk"></a>스튜디오 vs SDK

Python SDK를 통해 사용할 수 있는 고급 자동화 ML 기능과 Azure 기계 학습의 스튜디오 간의 패리티 및 차이점에 대해 알아봅니다. 

### <a name="experiment-settings"></a>실험 설정 

다음 설정을 통해 자동화된 ML 실험을 구성할 수 있습니다. 

| |Python SDK|스튜디오 웹 경험|
----|:----:|:----:
...
## <a name="automl--onnx"></a>오토ML & ONNX
