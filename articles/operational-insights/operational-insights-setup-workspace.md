...
1. 작업 영역 이름을 클릭합니다.![작업 영역 이름](./media/operational-insights-setup-workspace/settings01.png)
2. 구성 아이콘을 클릭합니다.![구성 아이콘](./media/operational-insights-setup-workspace/settings02.png)
3. Operational Insights **설정** 페이지의 **사용자 계정 관리** 섹션에서 **사용자 관리**를 클릭합니다.![사용자 관리](./media/operational-insights-setup-workspace/settings03.png)
...
1. 작업 영역 이름을 클릭합니다.
2. 구성 아이콘을 클릭합니다.
3. Operational Insights **설정** 페이지의 **사용자 계정 관리** 섹션에서 **사용자 관리**를 클릭합니다.![사용자 관리](./media/operational-insights-setup-workspace/settings04.png)
4. **사용자 관리** 창에서 **추가**를 클릭합니다. ![설정 페이지](./media/operational-insights-setup-workspace/manage-users01.png)
5. Operational Insights 계정이 Azure Active Directory와 연결된 경우 **조직 계정**을 지정합니다.[AZURE.NOTE]Operational Insights 계정에서 Microsoft 계정만 사용하는 경우 이 단계가 표시되지 않습니다. ![사용자 계정 유형 추가](./media/operational-insights-setup-workspace/manage-users02.png)
6. Microsoft 계정 또는 조직 계정에 대한 새 사용자 정보를 입력합니다. 조직 계정을 추가하는 경우 사용자 또는 그룹 이름 또는 이메일 별칭의 일부를 입력하고 **이름 확인**을 클릭하여 특정 사용자 또는 그룹을 찾을 수 있습니다.>[AZURE.NOTE]최상의 성능 결과를 얻으려면 단일 Operational Insights 계정과 연결된 Active Directory 그룹 수를 두 개(관리자용 그룹 및 사용자용 그룹)로 제한합니다. 더 많은 그룹을 사용하면 Operational Insights의 성능에 영향을 줄 수 있습니다.
7. 이 새로운 사용자의 역할을 **관리자** 또는 **사용자** 중에서 선택합니다.![사용자 작업 영역 역할 추가](./media/operational-insights-setup-workspace/manage-users03.png)
8. **확인**을 클릭합니다.

  Microsoft 계정을 추가하는 경우 계정에 가입하라는 초대가 제공한 메일로 전송됩니다. 사용자가 초대장의 지침에 따라 Operational Insights에 가입하면 이 Operational Insights 계정에 대한 경고와 계정 정보를 볼 수 있으며, **사용자 관리** 창에서 사용자 정보를 볼 수 있습니다. 조직 계정을 추가하는 경우 사용자가 즉시 Operational Insights에 액세스할 수 있습니다.![초대](./media/operational-insights-setup-workspace/manage-users04.png)
...
1. Operational Insights 설정 페이지에서 **조직 추가**를 클릭합니다.![초대](./media/operational-insights-setup-workspace/add-org.png)
