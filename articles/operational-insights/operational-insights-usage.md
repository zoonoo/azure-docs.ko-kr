...
Operational Insights는 주기적으로 데이터를 수집하여 Operational Insights에 보냅니다. **사용량** 대시보드를 사용하여 Operational Insights 서비스에 보내지는 데이터 크기를 볼 수 있습니다. **사용량** 대시보드는 솔루션에서 매일 전송되는 데이터 크기 및 관리 그룹이 데이터를 보내는 빈도도 표시합니다.
...
3. 불필요하게 할당량을 많이 사용 중인 솔루션에 대한 데이터가 있으면 해당 솔루션을 제거하는 것이 좋습니다.
