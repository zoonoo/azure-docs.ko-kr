...
|**Azure Search** | Microsoft. 검색/searchService| searchService|  
...
|**Azure Event Grid** | Microsoft EventGrid/도메인    | 도메인 |
...
전용 끝점에 대 한 DNS를 구성 하기 위한 모범 사례 및 권장 사항에 대 한 자세한 내용은 [개인 끝점 dns 구성 문서](private-endpoint-dns.md)를 참조 하세요.
