...
|연결 승인 방법    |  자동 또는 수동. Azure RBAC (역할 기반 액세스 제어) 사용 권한에 따라 개인 끝점이 자동으로 승인 될 수 있습니다. RBAC 없이 개인 링크 리소스에 연결 하려고 하면 수동 메서드를 사용 하 여 리소스 소유자가 연결을 승인할 수 있도록 허용 합니다.        |
