...
1. **프라이빗 링크 서비스 만들기 - 액세스 보안** 에서 **표시 유형** 을 선택한 다음, **역할 기반 액세스 제어 전용** 을 선택합니다.
...
이 빠른 시작에서는 내부 Azure 부하 분산 장치와 Private Link 서비스를 만들었습니다. 또한 [Azure Portal을 사용하여 프라이빗 엔드포인트를 만드는 방법](./create-private-endpoint-portal.md)을 알아볼 수도 있습니다.