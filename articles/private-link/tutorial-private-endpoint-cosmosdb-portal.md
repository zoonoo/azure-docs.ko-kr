...
description: Azure Private 엔드포인트를 사용하여 Azure Cosmos 계정에 개인적으로 연결합니다.
author: asudbring
ms.author: allensu
...
12. Storage Explorer에서 마우스 오른쪽 단추로 **Cosmos DB 계정**을 클릭하고, **Cosmos DB에 연결**을 선택합니다.
