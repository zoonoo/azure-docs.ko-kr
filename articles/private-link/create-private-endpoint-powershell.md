...
> [!CAUTION]
> `PrivateEndpointNetworkPoliciesFlag` 매개 변수를 사용 가능한 다른 플래그 (`PrivateLinkServiceNetworkPoliciesFlag`)와 혼동 하기 쉽습니다. 이러한 플래그는 긴 단어 이며 모양은 동일 하기 때문입니다.  `PrivateEndpointNetworkPoliciesFlag`올바른를 사용 하 고 있는지 확인 합니다.
