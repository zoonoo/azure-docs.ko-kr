...
|Service Provider Action   |Service Consumer Private Endpoint State   |설명   |
|---------|---------|---------|
|없음    |    Pending     |    Connection is created manually and is pending for approval by the Private Link resource owner.       |
|승인    |  승인됨       |  Connection was automatically or manually approved and is ready to be used.     |
|거부     | 거부됨        | Connection was rejected by the private link resource owner.        |
|제거    |  Disconnected       | Connection was removed by the private link resource owner, the private endpoint becomes informative and should be deleted for clean up.        |
|   |         |         |
