...
-   serviceOptions는 선택적인 개체입니다. 다음 속성이 포함될 수 있습니다.
    ...
    -   Location - 기본적으로 'Azure 미리 보기'로 설정 - 릴리스되면 TODO가 변경됩니다.
-   콜백이 필요합니다.
...
API는 배포, 역할 또는 디스크를 만들거나 수정할 때 입력으로 개체를 가져옵니다. 다른 API는 가져오기 또는 목록 작업에서 비슷한 개체를 반환합니다. 이 섹션에서는 개체 속성을 나열합니다. 배포
