<properties pageTitle="Azure 클라우드 서비스에서 가상 컴퓨터 연결" description="Azure 클라우드 서비스에 가상 컴퓨터를 연결하는 방법에 대해 알아봅니다." services="virtual-machines, cloud-services" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
