<properties pageTitle="Azure에서 Linux의 인증 배포 수행" description="Ubuntu, OpenLogic 및 SUSE 관련 지침을 포함하여 Azure에서 Linux의 인증 배포를 수행하는 방법에 대해 알아봅니다." services="virtual-machines" documentationCenter="" authors="szarkos" manager="timlt" editor="tysonn"/>
