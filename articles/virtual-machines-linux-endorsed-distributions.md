<properties urlDisplayName="Endorsed distributions" pageTitle="Azure에서 Linux의 인증 배포 수행" metaKeywords="" description="Ubuntu, OpenLogic 및 SUSE 관련 지침을 포함하여 Azure에서 Linux의 인증 배포를 수행하는 방법에 대해 알아봅니다." metaCanonical="" services="virtual-machines" documentationCenter="" title="Azure 인증 배포의 Linux" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
<td>
Ubuntu 12.04.1 이상, 14.04 및 14.10
...
<td>
[12.04 또는 12.04.01에만 필요함][12.04 또는 12.04.01에만 필요함]
...
<td>
CentOS 6.3: [LIS 드라이버][여기]; CentOS 6.4 이상 드라이버: 커널에 있음
...
<td>
패키지: walinuxagent의 [Open Logic 패키지 리포지토리][Open Logic 패키지 리포지토리]에 있음
 원본: [GitHub][GitHub]
...
<td>
패키지: [Cloud:Tools][Cloud:Tools] 리포지토리에 있음. 이름: WALinuxAgent
 소스 코드: [GitHub][GitHub]
...
<sup>1</sup> **참고:** Azure의 CoreOS는 현재 개발자 미리 보기(*alpha*) 상태입니다.
