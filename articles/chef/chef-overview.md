...
회사는 디지털 시장에서 경쟁하려면 속도, 개발속도 및 안전을 요구합니다. Chef 및 Microsoft는 개인, 팀 및 기업이 이러한 모든 작업을 완수하도록 도와줍니다. 하나의 플랫폼인 Chef 자동화를 사용하여 Microsoft 자산 전체에 인프라, 애플리케이션 및 준수를 자동화하고 지속적으로 제공할 수 있습니다.
