...
<table border="1">
<tr><th>헤더</th><th>유형</th><th>값</th></tr>
<tr><td>Date</td><td>RFC 1123 날짜</td><td>요청 타임스탬프</td></tr>
...
<table border="1">
<tr><th>헤더</th><th>유형</th><th>값</th></tr>
<tr><td>request-id</td><td>String</td><td>현재 작업에 대한 고유 식별자로 서비스를 생성합니다.</td></tr>
<tr><td>client-request-id</td><td>String</td><td>호출자가 원래 요청을 통해 지정한 식별자입니다(있는 경우).</td></tr>
<tr><td>Date</td><td>RFC 1123 날짜</td><td>요청이 처리된 날짜입니다.</td></tr>
