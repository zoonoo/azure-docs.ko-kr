...
> [!IMPORTANT]
> 에이전트 없는 종속성 시각화는 현재 VMware Vm에 대 한 미리 보기로 제공 되며 Azure Migrate: 서버 평가 도구를 사용 하 여 검색 되었습니다.
...
- 에이전트 없는 종속성 분석 [에 대해 알아봅니다](concepts-dependency-visualization.md#agentless-analysis) .
- VMware Vm에 대 한 에이전트 없는 종속성 시각화를 설정 하기 위한 필수 구성 요소 및 지원 요구 사항을 [검토](migrate-support-matrix-vmware.md#agentless-dependency-analysis-requirements) 합니다.
...
서버 평가가 검색을 위해 VM에 액세스할 수 있도록 사용자 계정을 설정 합니다. 계정 요구 사항에 [대해 알아봅니다](migrate-support-matrix-vmware.md#agentless-dependency-analysis-requirements) .
