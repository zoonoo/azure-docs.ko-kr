...
**총 디스크 읽기 작업** | 예 | 결합된 모든 디스크에 대한 초당 읽기 작업입니다. <br/> 디스크 수준 데이터를 제공할 수 없는 경우 이 필드를 사용합니다. 
**총 디스크 쓰기 작업** | 예 | 결합된 모든 디스크에 대한 초당 쓰기 작업입니다. <br/> 디스크 수준 데이터를 제공할 수 없는 경우 이 필드를 사용합니다.
**총 디스크 읽기 처리량** | 예 | 초당 모든 디스크에서 읽은 데이터(MB/초)입니다. <br/> 디스크 수준 데이터를 제공할 수 없는 경우 이 필드를 사용합니다. 
**총 디스크 쓰기 처리량** | 예 | 초당 모든 디스크에서 쓴 데이터(MB/초)입니다. <br/> 디스크 수준 데이터를 제공할 수 없는 경우 이 필드를 사용합니다.
...
디스크 수준 데이터를 제공할 수 없는 경우 다음 필드를 사용하여 서버별 디스크 성능 데이터를 제공할 수 있습니다. 각 필드에 대한 자세한 내용은 [이](#add-server-information) 섹션을 참조하세요.
- 총 디스크 읽기 작업
- 총 디스크 쓰기 작업
- 총 디스크 읽기 처리량
- 총 디스크 쓰기 처리량
