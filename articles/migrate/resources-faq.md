...
프로 파일링 성능 데이터를 지속적으로 사용하기 위해서 vCenter Server 통계 수준을 성능 기반 평가 실행 하도록 변경할 필요가 없습니다. 수집기 어플라이언스에서는 가상 컴퓨터의 성능 데이터를 측정하기 위해 온-프레미스 컴퓨터를 프로 파일링 합니다. 그러므로 ESXi 호스트와 vCenter Server의 성능에 대한 영향은 거의 없습니다.
