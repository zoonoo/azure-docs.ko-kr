...
구독에 여러 개의 Azure Migrate 프로젝트가 있을 수 있습니다. 처음으로 프로젝트를 만들거나 추가 프로젝트를 [추가](create-manage-projects.md#create-additional-projects) 하 [는 방법에 대해 알아봅니다](./create-manage-projects.md) .
...
이전 버전의 Azure Migrate 프로젝트는 업데이트할 수 없습니다. [새 프로젝트를 만들고이 프로젝트](./create-manage-projects.md)에 도구를 추가 해야 합니다.
