---
title: 이전 버전의 Azure Migrate 사용 | Microsoft Docs
description: 이전 버전의 Azure Migrate를 사용하는 방법을 요약해서 설명합니다.
...
예상 비용은 각 머신의 세부 사항과 함께 Azure에서 VM을 실행하는 데 필요한 총 계산 및 스토리지 비용을 보여 줍니다.
