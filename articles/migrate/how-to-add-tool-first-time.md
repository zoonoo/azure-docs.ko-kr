...
5. **평가 도구 선택**에서 평가 도구를 추가 합니다. 평가 도구가 필요 하지 않은 경우 **지금 다음에 대 한 평가 도구 추가 건너뛰기**를 선택  >  **Next**합니다. 
2. **마이그레이션 도구 선택**에서 필요에 따라 마이그레이션 도구를 추가 합니다. 지금은 마이그레이션 도구가 필요 하지 않은 경우 **지금 마이그레이션 도구 추가 건너뛰기**를 선택  >  **Next**합니다.
