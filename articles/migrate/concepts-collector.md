...
- Azure Migrate는 각 메트릭의 최고 카운터가 아닌 평균 카운터를 수집합니다.

### <a name="continuous-discovery"></a>연속 검색

연속 검색 시에는 Collector 어플라이언스가 Azure Migrate 프로젝트에 계속 연결되어 있습니다.
...
> [!NOTE]
> 연속 검색 기능은 미리 보기 상태입니다. vCenter Server 통계 설정이 수준 3으로 설정되어 있지 않으면 이 방법을 사용하는 것이 좋습니다.
...
net.received.average | 2 | 3 |  VM 크기 및 네트워크 비용 계산                        |
net.transmitted.average | 2 | 3 | VM 크기 및 네트워크 비용 계산    
