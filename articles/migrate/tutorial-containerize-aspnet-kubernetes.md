---
title: ASP.NET 애플리케이션을 컨테이너화하고 Azure Kubernetes Service로 마이그레이션
description: ASP.NET 애플리케이션을 컨테이너화하고 Azure Kubernetes Service로 마이그레이션하는 방법을 알아봅니다.
services: ''
author: rahugup
manager: bsiva
ms.topic: tutorial
