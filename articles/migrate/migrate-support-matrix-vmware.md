...
**지원** | **세부 정보**
--- | ---
**지원되는 머신** | 앱 검색은 현재 VMware VM에만 지원됩니다. 각 Azure Migrate 어플라이언스에서 최대 1만 VMware Vm에 설치 된 앱을 검색할 수 있습니다.
**운영 체제** | 앱 검색은 모든 Windows 및 Linux 버전을 실행 하는 Vm에 대해 지원 됩니다.
