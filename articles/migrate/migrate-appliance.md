...
description: Azure Migrate 어플라이언스에 대 한 개요를 제공 합니다.
...
**에이전트** | **세부 정보**
--- | ---
검색 에이전트 | 온-프레미스 Vm에서 구성 데이터를 수집 합니다.
...
가상 하드 디스크 유형 | Msvm_VirtualHardDiskSettingData | 형식
...
- 자동 업데이트를 사용 하지 않도록 설정 하려면 HKLM\SOFTWAREMicrosoft\Azure.에서 레지스트리 키 어플라이언스 자동 업데이트를 설정 합니다.
