...
1. 어플라이언스의 모든 브라우저 창과 열린 파일 및 폴더를 닫습니다.
...
몇 가지 UI 기능이 포함되어 있습니다.

업그레이드 [1.0.10.14 패키지](https://aka.ms/migrate/col/upgrade_10_14)에 대한 해시 값
...
어플라이언스에서 Azure 클라우드를 선택할 때 발생하는 문제에 대한 수정 사항을 포함합니다.

업그레이드 [패키지 1.0.10.12](https://aka.ms/migrate/col/upgrade_10_12)에 대한 해시 값
