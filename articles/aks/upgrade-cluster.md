...
여러 노드 풀을 사용 하는 AKS 클러스터는 [AKS에서 노드 풀 업그레이드][nodepool-upgrade]를 참조 하세요.
...
>
>  -> *1.14*에서 업그레이드 하려면 먼저 *1.12* -> . x*1.13.* *x에서 업그레이드*한 다음 *1.13.* -> x*1.14*에서 업그레이드 합니다.
