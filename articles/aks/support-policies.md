...
> [!NOTE]
> 작업자 노드에서 제어 평면 구성 요소가 작동 하지 않는 경우 AKS 팀에서 전체 작업자 노드를 다시 부팅 해야 할 수 있습니다. 고객의 활성 워크 로드 및 데이터에 대 한 제한 된 액세스로 인해 AKS 팀은 고객이 문제를 에스컬레이션 하는 경우에만 작업자 노드를 다시 부팅 합니다. 가능 하면 AKS 팀이 응용 프로그램에 영향을 주는 데 필요한 재부팅을 방지 하기 위해 작업 합니다.
