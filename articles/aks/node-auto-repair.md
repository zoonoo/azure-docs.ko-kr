...
노드가 위의 규칙을 기반으로 비정상으로 확인 되 고 10 분 연속으로 비정상 상태로 유지 되는 경우 AKS는 노드를 다시 부팅 합니다. 초기 복구 작업 후 노드가 비정상 상태로 유지 되는 경우에는 AKS 엔지니어가 추가 재구성 조사 됩니다.
