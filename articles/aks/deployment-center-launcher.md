...
1. 코드의 위치를 선택하고, **다음** 을 선택합니다. 그런 다음, 현재 지원되는 **[Azure Repos](/azure/devops/repos/index)** 또는 **GitHub** 리포지토리 중 하나를 선택합니다.
...
1. 기존 컨테이너 레지스트리를 선택하거나 새로 만든 다음, **마침** 을 선택합니다. 파이프라인이 자동으로 만들어지고, [Azure Pipelines](/azure/devops/pipelines/index)에서 빌드를 큐에 넣습니다.
