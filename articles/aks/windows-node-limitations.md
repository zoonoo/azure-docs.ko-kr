...
- AKS 클러스터는 Azure CNI (고급) 네트워킹 모델을 사용 해야 합니다.
    ...
    - Azure CNI 네트워크 모델에는 추가 계획 및 IP 주소 관리에 대 한 고려 사항에 필요합니다. 계획 하 고 Azure CNI를 구현 하는 방법에 대 한 자세한 내용은 참조 하세요. [AKS에서 Azure CNI 구성 네트워킹][configure-azure-cni]합니다.
