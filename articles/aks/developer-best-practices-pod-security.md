...
이 모범 사례 문서에서는 AKS에서 pod를 보호 하는 방법을 중점적으로 설명 합니다. 다음 방법을 알아봅니다.
...
* **Linux 기능**을 사용하여 pod가 기본 노드 프로세스에 액세스하도록 할 수 있습니다. 이러한 기능을 할당할 때는 주의해야 합니다. 필요한 최소 권한 수를 할당합니다. 자세한 내용은 [Linux 기능][linux-capabilities]을 참조 하세요.
* **SELinux 레이블**은 서비스, 프로세스 및 파일 시스템 액세스에 대한 액세스 정책을 정의할 수 있는 Linux 커널 보안 모듈입니다. 마찬가지로 필요한 최소 권한 수를 할당합니다. 자세한 내용은 [Kubernetes의 Selinux 옵션][selinux-labels] 을 참조 하세요.
