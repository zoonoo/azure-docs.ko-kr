...
예를 들어 AKS 소개 *1.13.x* 오늘날에 지원 됩니다 *1.12.a* + *1.12.b*하십시오 *1.11.c*  +  *1.11 d*, *1.10.e* + *1.10f* (목차의 문자 패치 릴리스는 두 안정적인 최신 빌드).

새로운 부 버전이 릴리스되면 지원되는 가장 오래된 부 버전 및 패치 릴리스는 사용 중지됩니다. 새로운 부 버전 및 예정 된 버전 사용 중지의 릴리스 전에 30 일 알림을 통해 생성 되는 [Azure 업데이트 채널][azure-update-channel]합니다. Where 위의 예에서 *1.13.x* 은 사용 중지 된 버전은 출시 *1.9.g* + *1.9.h*합니다.

포털에서 또는 Azure CLI를 사용하여 배포하는 AKS 클러스터는 항상 n-1 부 버전 및 최신 패치로 설정됩니다. 예를 들어, AKS에서 지 원하는 경우 *1.13.x*를 *1.12.a* + *1.12.b*하십시오 *1.11.c*  +   *1.11 d*, *1.10.e* + *1.10f*, 새 클러스터에 대 한 기본 버전은 *1.11.b*합니다.
...
- 지원 되는 AKS 버전이 *1.13.x*를 *1.12.a* + *1.12.b*하십시오 *1.11.c*  +  *1.11 d*, 및 *1.10.e* + *1.10f* 에서 되며 *1.9.g* 또는 *1.9.h*, SLO를 벗어나는 합니다.
- 경우로 업그레이드 *1.9.g* 하거나 *1.9.h* 에 *1.10.e* 또는 *1.10.f* 성공 하면 SLO 전환 됩니다.
