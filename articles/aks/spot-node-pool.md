...
클러스터를 만들어 별색 노드 풀을 사용할 경우 해당 클러스터는 노드 풀 및 *표준* SKU 부하 분산 장치에 대 한 Virtual Machine Scale Sets도 사용 해야 합니다. 또한 클러스터를 만든 후에는 별색 노드 풀을 사용 하기 위해 추가 노드 풀을 추가 해야 합니다. 추가 노드 풀 추가는 이후 단계에서 설명 합니다.
