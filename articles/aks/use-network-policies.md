...
Calico, 오픈 소스 네트워킹 및 네트워크 보안 솔루션 Tigera, 설립한 Kubernetes 네트워크 정책 규칙을 구현할 수 있는 네트워크 정책 엔진을 제공 합니다. 이 문서에서는 Calico 네트워크 정책 엔진을 설치 하 고 AKS의 pod 간의 트래픽 흐름을 제어 하는 Kubernetes 네트워크 정책을 만들 방법을 보여 줍니다.
...
네트워크 정책은 pod 간 트래픽 흐름을 제어할 수 있는 Kubernetes 리소스입니다. 허용 하거나 할당 된 레이블, 네임 스페이스 또는 트래픽 포트와 같은 설정에 따라 트래픽을 거부 하도록 선택할 수 있습니다. YAML 매니페스트 네트워크 정책은 정의 됩니다. 이러한 정책은 또한 배포 또는 서비스를 만드는 더 넓은 매니페스트의 일부로 포함할 수 있습니다.
