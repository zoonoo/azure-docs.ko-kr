...
|----------------------------------------------------------------------------------------------|-----------|-----------|
| 기존 또는 새 가상 네트워크에 클러스터 배포                                            | 지원 됨-UDRs 수동 적용 됨 | 지원 여부 |
...
| 서비스 끝점으로 보호 되는 리소스에 대 한 액세스                                             | 지원 여부 | 지원 여부 |
| 부하 분산 장치 서비스, 앱 게이트웨이 또는 수신 컨트롤러를 사용 하 여 Kubernetes services 노출 | 지원 여부 | 지원 여부 |
| 기본 Azure DNS 및 개인 영역                                                          | 지원 여부 | 지원 여부 |
