...
보안 [센터의 컨테이너 보안을][security-center-containers] 사용하여 컨테이너에 취약점이 있는지 검색할 수도 있습니다.  또한 [Azure 컨테이너 레지스트리와][security-center-acr] 보안 센터 통합을 통해 이미지 및 레지스트리를 취약점으로부터 보호할 수 있습니다.
