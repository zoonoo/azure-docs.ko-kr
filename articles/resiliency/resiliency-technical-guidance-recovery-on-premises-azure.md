---
title: '기술 지침: 온-프레미스에서 Azure로 복구 | Microsoft Docs'
...
* **계산**: Hyper-V 온-프레미스를 사용하는 고객은 Azure에 기존 VM(가상 컴퓨터)를 “전환”할 수 있습니다.
* **저장소**: StorSimple을 사용하여 Azure 저장소에 파일 시스템을 확장할 수 있습니다. Azure 백업 서비스는 파일 및 SQL 데이터베이스를 Azure 저장소에 백업하는 기능을 제공합니다.
* **데이터베이스 복제**: SQL 서버 2014(또는 이상) 가용성 그룹을 통해 온-프레미스 데이터에 대한 고가용성 및 재해 복구를 구현할 수 있습니다.
