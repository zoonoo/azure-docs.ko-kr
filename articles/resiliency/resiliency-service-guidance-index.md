---
title: "서비스 복원력 지침 | Microsoft Azure"
...
---
# <a name="microsoft-azure-service-resiliency-guidance"></a>Microsoft Azure 서비스 복원력 지침
...
## <a name="service-guidance"></a>서비스 지침
| 부여 | 재해 복구 지침 | 디자인 지침 |
|:--- |:---:|:---:|
...
| [SQL 데이터베이스](https://azure.microsoft.com/services/sql-database/ "Azure SQL 데이터베이스") |[link](../sql-database/sql-database-disaster-recovery.md "Azure SQL 데이터베이스 재해 복구 지침") |[link](../sql-database/sql-database-performance-guidance.md "Azure SQL Database 설계 지침") |
