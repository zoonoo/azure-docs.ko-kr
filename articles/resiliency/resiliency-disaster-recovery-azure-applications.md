...
다음 다이어그램에서 사용자는 트래픽 관리자에 지정된 URL(__http://myATMURL.trafficmanager.net__)에 연결하고 실제 사이트 URL(__http://app1URL.cloudapp.net__) 및 \_\___http://app2URL.cloudapp.net__)를 추상화합니다. 사용자를 라우팅할 시기에 대한 조건을 구성하는 방법에 따라 정책이 요구하는 경우 사용자를 올바른 실제 사이트로 전송합니다. 정책 옵션에는 라운드 로빈, 성능 또는 장애 조치가 있습니다. 이 문서에서는 장애 조치 옵션에 대해서만 알아보겠습니다.
