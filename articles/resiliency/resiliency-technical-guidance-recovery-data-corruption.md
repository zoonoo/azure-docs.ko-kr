---
title: "데이터 손상 또는 우발적 삭제로부터 복구하기 위한 복원력 기술 지침 | Microsoft 문서"
...
### <a name="blob-and-table-storage-backup"></a>Blob 및 테이블 저장소 백업
...
### <a name="sql-database-backup"></a>SQL 데이터베이스 백업
...
### <a name="sql-server-on-virtual-machines-backup"></a>가상 컴퓨터 백업의 SQL Server
...
## <a name="sql-server-on-virtual-machines-backup-checklist"></a>가상 컴퓨터 백업 검사 목록의 SQL Server
...
이 문서는 [Azure 복구 기술 지침](resiliency-technical-guidance.md)에 대한 시리즈의 일부입니다. 복원력, 재해 복구 및 고가용성 리소스에 대해 자세히 알아보려면 Azure 복원력 기술 지침 [추가 리소스](resiliency-technical-guidance.md#additional-resources)를 참조하세요.
