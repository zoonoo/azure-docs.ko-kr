...
이 섹션에서는 특정 요소(예: 페이지 머리글)의 스타일만 변경하겠습니다. 편집기 도구 모음에서 **요소 선택** 옵션을 클릭한 후 **사용자 지정할 요소 선택**을 클릭합니다. 이제 마우스를 요소 위로 가져가면 요소가 강조 표시되어 클릭하면 어느 요소의 스타일이 표시되는지가 나타납니다.
...
[사용자 지정 도구 모음]: ./media/api-management-howto-customize-look-and-feel/api-management-customization-toolbar.png
[색 선택]: ./media/api-management-howto-customize-look-and-feel/api-management-customization-toolbar-color-picker.png
[게시 양식]: ./media/api-management-howto-customize-look-and-feel/api-management-customization-toolbar-publish-form.png
