...
가상 노드는 용량이 무제한 인 노드로 등록 하 여 오픈 소스 [가상 Kubelet][aci-connector-k8s] to mimic the Kubernetes [kubelet][kubelet-doc] 을 사용 합니다. 가상 Kubelet는 Azure Container Instances의 컨테이너 그룹으로 [pod][pod-doc] 만들기를 디스패치합니다.
