...
Azure Container Instances에서는 오케스트레이션 플랫폼의 기본 예약 기능 중 일부를 제공하지만 실제로 해당 플랫폼이 제공하는 고급 서비스를 제공하지 않고 보완할 수 있습니다. 이 문서에서는 Azure Container Instances에서 처리하는 범위 및 전체 컨테이너 오케스트레이터가 상호 작용할 수 있는 방법에 대해 설명합니다.
