...
| 속성 속성 | 개체 | 아니요 | 컨테이너 그룹의 암호화 속성입니다. - [속성 개체](#encryptionproperties-object) | 
...
|  Name | Type | 필수 | 값 |
|  ---- | ---- | ---- | ---- |
|  memoryInGB | 숫자 | 예 | 이 컨테이너 인스턴스의 메모리 요청 (GB)입니다. |
|  cpu | 숫자 | 예 | 이 컨테이너 인스턴스의 CPU 요청입니다. |
...
|  Name | Type | 필수 | 값 |
|  ---- | ---- | ---- | ---- |
|  memoryInGB | 숫자 | 아니요 | 이 컨테이너 인스턴스의 메모리 한도 (GB)입니다. |
|  cpu | 숫자 | 아니요 | 이 컨테이너 인스턴스의 CPU 한도입니다. |
