...
GPU 리소스를 사용하면 많은 비용이 발생할 수 있으므로 컨테이너가 예기치 않게 오래 실행되지 않도록 주의해야 합니다. Azure Portal에서 컨테이너를 모니터링 하거나 [az container show][az-container-show] 명령을 사용 하 여 컨테이너 그룹의 상태를 확인 합니다. 다음은 그 예입니다.
