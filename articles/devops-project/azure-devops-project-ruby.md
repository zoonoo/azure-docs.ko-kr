...
**Azure DevOps 프로젝트**를 사용하여 Ruby on Rails 응용 프로그램에 대한 CI(연속 통합) 및 CD(지속적인 업데이트)를 구성합니다.  Azure DevOps 프로젝트는 Azure DevOps Services 빌드 및 릴리스 파이프라인의 초기 구성을 간소화합니다.
