...
클라우드 서비스 프로젝트에서 프로그래밍 방식으로 blob에 액세스하려면 다음 작업을 수행해야 합니다.
...
Blob으로 작업을 수행하려면 먼저 Blob을 저장할 저장소 계정의 연결 문자열을 가져와야 합니다. **CloudStorageAccount** 유형을 사용하여 저장소 계정 정보를 나타낼 수 있습니다. 클라우드 서비스 프로젝트의 경우 다음 코드에 나온 대로 **CloudConfigurationManager** 유형을 사용하여 Azure 서비스 구성에서 저장소 연결 문자열과 저장소 계정 정보를 검색할 수 있습니다.
