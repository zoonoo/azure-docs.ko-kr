...
6.  HTML 페이지를 저장하고 웹 서버에 게시합니다. 즐겨 사용하는 FlashÂ® Player 지원 인터넷 브라우저(Internet Explorer, Chrome, Firefox 등)를 사용하여 게시된 웹 페이지로 이동합니다.
7.  AdobeÂ® FlashÂ® Player에서 부드러운 스트리밍 콘텐츠를 즐깁니다.
