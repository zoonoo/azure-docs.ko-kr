<properties 
	pageTitle="Azure 웹 사이트에 Azure WebJob 배포" 
	description="Visual Studio를 사용하여 Azure 웹 사이트에 Azure WebJobs를 배포하는 방법에 대해 알아봅니다." 
	services="web-sites" 
	documentationCenter="" 
	authors="tdykstra" 
	manager="wpickett" 
...
- [Azure WebJob 추가 대화 상자](#configure)
...
* 특정 시간에 실행되도록 예약된 WebJob에 대해 [Azure 스케줄러 작업]을(#scheduler) 설정합니다(연속 WebJob에는 필요하지 않습니다.)
...
프로젝트를 WebJob 자체로 배포하거나 웹 프로젝트를 배포할 때마다 자동으로 배포되도록 웹 프로젝트에 연결할 수 있습니다. 프로젝트를 연결할 수 있게 Visual Studio는 웹 프로젝트의 [webjobs-list.json] 파일에(#webjobslist) WebJob 지원 프로젝트의 이름을 포함합니다.
