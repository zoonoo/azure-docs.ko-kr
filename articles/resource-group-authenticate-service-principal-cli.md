...
1. 계정에 로그인합니다.
        ...
        azure login
2. 응용 프로그램에 대한 서비스 주체를 만듭니다. 표시 이름, 응용 프로그램을 설명하는 페이지에 대한 링크, 응용 프로그램을 식별하는 URI, 응용 프로그램 ID에 대한 암호를 제공합니다. 이 명령은 AD 응용 프로그램 및 서비스 주체를 모두 만듭니다.
...
4. 계정에 로그인합니다.
        ...
        azure config mode arm
        azure login
5. 응용 프로그램에 대한 서비스 주체를 만듭니다. 표시 이름, 응용 프로그램을 설명하는 페이지에 대한 URI, 응용 프로그램을 식별하는 URI 및 복사한 인증서 데이터를 제공합니다. 이 명령은 AD 응용 프로그램 및 서비스 주체를 모두 만듭니다.
