...
> [WACOM.NOTE] 이 설명서에서는 AzCopy 3.0.0 이상을 설치했다고 가정합니다. AzCopy 3.x는 현재 GA(일반 공급) 상태입니다.
> 이 가이드에서는 AzCopy의 미리 보기 릴리스인 AzCopy 4.0.0 사용법도 다룹니다. 이 가이드 전체에서 미리 보기 릴리스에서만 제공되는 기능에는 *미리 보기*가 표시되어 있습니다.
> AzCopy 4.x의 경우에는 이후 릴리스에서 명령줄 옵션 및 기능이 변경될 수 있습니다.
...
-   [AzCopy를 사용하여 Azure 파일 공유의 파일 복사(미리 보기 버전 전용)][AzCopy를 사용하여 Azure 파일 공유의 파일 복사(미리 보기 버전 전용)]
-   [AzCopy를 사용하여 Azure 테이블 엔터티 복사(미리 보기 버전 전용)][AzCopy를 사용하여 Azure 테이블 엔터티 복사(미리 보기 버전 전용)]
-   [AzCopy 버전][AzCopy 버전]
-   [다음 단계][다음 단계]

## <span id="install"></span></a> AzCopy 다운로드 및 설치

1.  [최신 버전의 AzCopy][최신 버전의 AzCopy] 또는 [최신 미리 보기 버전][최신 미리 보기 버전]을 다운로드합니다.
...
> [WACOM.NOTE] AzCopy version 3.0.0부터는 AzCopy 명령줄 구문에서는 모든 매개 변수가 매개 변수 이름을 포함하도록 지정해야 합니다(*예*: `/ParameterName:ParameterValue`).
...
| 옵션 이름                                                               | 설명                                                                                                                                                                                                                                                                       | Blob 저장소 해당 여부(Y/N) | 파일 저장소 해당 여부(Y/N)(미리 보기 릴리스 전용) | 테이블 저장소 해당 여부(Y/N)(미리 보기 릴리스 전용) |
|-------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------|---------------------------------------------------|-----------------------------------------------------|
| **/Source:\<source\>**                                                  | 복사할 소스 데이터를 지정합니다. 소스는 파일 시스템 디렉터리, Blob 컨테이너, Blob 가상 디렉터리, 저장소 파일 공유, 저장소 파일 디렉터리 또는 Azure 테이블일 수 있습니다.                                                                                                   | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/Dest:\<destination\>**                                               | 복사할 대상을 지정합니다. 대상은 파일 시스템 디렉터리, Blob 컨테이너, Blob 가상 디렉터리, 저장소 파일 공유, 저장소 파일 디렉터리 또는 Azure 테이블일 수 있습니다.                                                                                                          | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/Pattern:\<file-pattern\>**                                           | 복사할 파일을 나타내는 파일 패턴을 지정합니다. 선택적 /Pattern 매개 변수의 동작은 소스 데이터의 위치 및 재귀 모드 옵션 유무에 따라 결정됩니다. 재귀 모드는 /S 옵션을 통해 지정됩니다.                                                                                      
                                                                            ...
                                                                            파일 패턴을 지정하지 않을 때 사용되는 기본 파일 패턴은 파일 시스템 위치의 경우 \*.\* 이고 Azure 저장소 위치의 경우에는 빈 접두사입니다. 여러 파일 패턴을 지정할 수는 없습니다.                                                                                             | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/DestKey:\<storage-key\>**                                            | 대상 리소스에 대한 저장소 계정 키를 지정합니다.                                                                                                                                                                                                                            | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/DestSAS:\<sas-token\>**                                              | 대상 컨테이너에 대한 SAS(공유 액세스 서명)를 지정합니다(해당되는 경우). SAS가 특수한 명령줄 문자를 포함할 수 있으므로 큰따옴표로 묶습니다.                                                                                                                                 
                                                                            대상 리소스가 Blob 컨테이너 또는 테이블이면 이 옵션을 지정하고 SAS 토큰을 지정하거나 이 옵션 없이 대상 Blob URI의 일부로 SAS를 지정할 수 있습니다.                                                                                                                         
                                                                            소스와 대상이 모두 Blob이면 대상 Blob는 소스 Blob와 같은 저장소 계정 내에 있어야 합니다.                                                                                                                                                                                   | Y                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/SourceKey:\<storage-key\>**                                          | 소스 리소스에 대한 저장소 계정 키를 지정합니다.                                                                                                                                                                                                                            | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/SourceSAS:\<sas-token\>**                                            | 소스 컨테이너에 대한 SAS(공유 액세스 서명)를 지정합니다(해당되는 경우). SAS가 특수한 명령줄 문자를 포함할 수 있으므로 큰따옴표로 묶습니다.                                                                                                                                 
                                                                            소스 리소스가 Blob 컨테이너인 경우 키와 SAS를 모두 지정하지 않으면 익명 액세스를 통해 Blob 컨테이너를 읽습니다.                                                                                                                                                            
                                                                            소스가 테이블이면 키나 SAS를 지정해야 합니다.                                                                                                                                                                                                                              | Y                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/S**                                                                  | 복사 작업의 재귀 모드를 지정합니다. 재귀 모드에서 AzCopy는 하위 폴더의 Blob 또는 파일을 비롯하여 지정된 파일 패턴과 일치하는 모든 Blob 또는 파일을 복사합니다.                                                                                                             | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/BlobType:\<block | page\>**                                          | 대상 Blob가 블록 Blob인지 아니면 페이지 Blob인지를 지정합니다. 이 옵션은 Blob를 업로드할 때만 적용되며 그 외의 경우에는 오류가 생성됩니다. 대상이 Blob인데 이 옵션을 지정하지 않으면 기본적으로 AzCopy는 블록 Blob를 만듭니다.                                             | Y                          | N                                                 | N                                                   |
| **/CheckMD5**                                                           | 다운로드한 데이터의 MD5 해시를 계산하고 Blob 또는 파일의 Content-MD5 속성에 저장된 MD5 해시가 계산된 해시와 일치하는지 확인합니다. 기본적으로 이 MD5 검사는 해제되어 있으므로 데이터를 다운로드할 때 MD5 검사를 수행하도록 이 옵션을 지정해야 합니다.                      
                                                                            Azure 저장소는 Blob 또는 파일에 대해 저장된 MD5 해시가 최신 버전임을 보장하지 않습니다. Blob 또는 파일이 수정될 때마다 MD5를 업데이트하는 것은 클라이언트의 책임입니다.                                                                                                    
                                                                            AzCopy는 Azure Blob 또는 파일을 서비스로 업로드하기 전에 항상 해당 Content-MD5 속성을 설정합니다.                                                                                                                                                                          | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/Snapshot**                                                           | 스냅숏을 전송할지 여부를 나타냅니다. 이 옵션은 소스가 Blob일 때만 유효합니다.                                                                                                                                                                                              
                                                                            전송된 Blob 스냅숏은 다음 형식으로 이름이 바뀝니다. [blob-name] (snapshot-time)[extension].                                                                                                                                                                                
                                                                            기본적으로 스냅숏은 복사되지 않습니다.                                                                                                                                                                                                                                     | Y                          | N                                                 | N                                                   |
| **/V:[verbose log-file]**                                               | 세부 정보 표시 상태 메시지를 로그 파일로 출력합니다. 기본적으로 세부 정보 표시 로그 파일 이름은 `%LocalAppData%\Microsoft\Azure\AzCopy`에서 `AzCopyVerbose.log`로 바뀝니다. 이 옵션에 기존 파일 위치를 지정하면 세부 정보 표시 로그가 해당 파일에 추가됩니다.              | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/Z:[journal-file-folder]**                                            | 작업을 다시 시작하기 위한 저널 파일 폴더를 지정합니다.                                                                                                                                                                                                                     
                                                                            AzCopy는 항상 작업이 중단되었을 때 다시 시작을 지원합니다.                                                                                                                                                                                                                 
                                                                            이 옵션을 지정하지 않거나 폴더 경로 없이 지정하면 AzCopy는 기본 위치인 `%LocalAppData%\Microsoft\Azure\AzCopy`에 저널 파일을 만듭니다.                                                                                                                                     
                                                                            ...
                                                                            이전 버전의 AzCopy에서 만들어진 저널 파일에서 작업을 다시 시작하는 것은 지원되지 않습니다.                                                                                                                                                                                 | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/@:parameter-file**                                                   | 매개 변수를 포함하는 파일을 지정합니다. AzCopy는 파일의 매개 변수가 마치 명령줄에 지정된 것처럼 처리합니다.                                                                                                                                                                
                                                                            지시 파일에서 단일 줄에 여러 매개 변수를 지정하거나 한 줄에 매개 변수를 하나씩 지정할 수 있습니다. 하나의 매개 변수가 여러 줄에 걸쳐 있을 수 없습니다.                                                                                                                     
                                                                            지시 파일은 `#` 기호로 시작하는 명령줄을 포함할 수 있습니다.                                                                                                                                                                                                               
                                                                            여러 지시 파일을 지정할 수 있습니다. 그렇지만 AzCopy는 중첩된지시 파일을 지원하지 않습니다.                                                                                                                                                                                | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/Y**                                                                  | 모든 AzCopy 확인 프롬프트를 표시하지 않습니다.                                                                                                                                                                                                                             | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/L**                                                                  | 열거 작업만 지정하고 데이터는 복사되지 않습니다.                                                                                                                                                                                                                           | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/MT**                                                                 | 다운로드한 파일의 마지막으로 수정한 시간을 소스 Blob 또는 파일과 동일하게 설정합니다.                                                                                                                                                                                      | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/XN**                                                                 | 최신 소스 리소스를 제외합니다. 이 리소스는 소스가 대상보다 최신이면 복사되지 않습니다.                                                                                                                                                                                     | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/XO**                                                                 | 오래된 소스 리소스를 제외합니다. 이 리소스는 소스 리소스가 대상보다 오래되었으면 복사되지 않습니다.                                                                                                                                                                        | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/A**                                                                  | Archive 특성 집합이 있는 파일만 업로드합니다.                                                                                                                                                                                                                              | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/IA:[RASHCNETOI]**                                                    | 지정된 특성 집합 중 하나라도 있는 파일만 업로드합니다.                                                                                                                                                                                                                     
                                                                            ...
                                                                            I   인덱싱되지 않은 파일                                                                                                                                                                                                                                                   | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/XA:[RASHCNETOI]**                                                    | 지정된 특성 집합 중 하나라도 있는 파일만 제외합니다.                                                                                                                                                                                                                       
                                                                            사용 가능한 특성에는 다음이 포함됩니다.                                                                                                                                                                                                                                    
                                                                            R   읽기 전용 파일                                                                                                                                                                                                                                                         
                                                                            A   보관 준비가 된 파일                                                                                                                                                                                                                                                    
                                                                            S   시스템 파일                                                                                                                                                                                                                                                            
                                                                            ...
                                                                            I   인덱싱되지 않은 파일                                                                                                                                                                                                                                                   | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/Delimiter:\<delimiter\>**                                            | Blob 이름에서 가상 디렉터리를 구분하는 데 사용되는 구분 문자를 나타냅니다.                                                                                                                                                                                                 
                                                                            ...
                                                                            이 옵션은 Blob을 다운로드하는 데만 적용됩니다.                                                                                                                                                                                                                             | Y                          | N                                                 | N                                                   |
| **/NC:\<number-of-concurrents\>**                                       | 동시 작업의 수를 지정합니다.                                                                                                                                                                                                                                               
                                                                            ...
                                                                            동시 작업의 상한은 512개입니다.                                                                                                                                                                                                                                            | Y                          | Y                                                 
                                                                                                                                                                                                                                                                                                                                                                                     (미리 보기 전용)                                   | N                                                   |
| **/SourceType:Blob|Table**                                              | `source` 리소스를 저장소 에뮬레이터에서 실행되는 로컬 개발 환경에서 사용할 수 있는 Blob로 지정합니다.                                                                                                                                                                      | Y                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/DestType:Blob|Table**                                                | `destination` 리소스를 저장소 에뮬레이터에서 실행되는 로컬 개발 환경에서 사용할 수 있는 Blob로 지정합니다.                                                                                                                                                                 | Y                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/PKRS:\<"key1\#key2\#key3\#..."\>**                                   | 테이블 데이터를 병렬로 내보낼 수 있도록 파티션 키 범위를 분할합니다. 그러면 내보내기 작업의 속도가 빨라집니다.                                                                                                                                                             
                                                                            ...
                                                                               [bb, \<마지막 파티션 키\>]                                                                                                                                                                                                                                              | N                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/SplitSize:**<file-size>**\<file-size\>**                             | 내보내는 파일 분할 크기를 MB로 지정합니다.                                                                                                                                                                                                                                 
                                                                            이 옵션을 지정하지 않으면 AzCopy는 단일 파일로 테이블 데이터를 내보냅니다.                                                                                                                                                                                                 
                                                                            테이블 데이터를 Blob로 내보내는데 내보낸 파일 크기가 Blob 크기에 대한 제한인 200GB에 도달하면 AzCopy는 이 옵션을 지정하지 않은 경우에도 내보낸 파일을 분할합니다.                                                                                                          | N                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/EntityOperation:\<InsertOrSkip | InsertOrMerge | InsertOrReplace\>** | 테이블 데이터 가져오기 동작을 지정합니다.                                                                                                                                                                                                                                  
                                                                            InsertOrSkip - 기존 엔터티를 건너뛰거나 테이블에 엔터티가 없으면 새 엔터티를 삽입합니다.                                                                                                                                                                                   
                                                                            InsertOrMerge - 기존 엔터티를 병합하거나 테이블에 엔터티가 없으면 새 엔터티를 삽입합니다.                                                                                                                                                                                  
                                                                            InsertOrReplace - 기존 엔터티를 바꾸거나 테이블에 엔터티가 없으면 새 엔터티를 삽입합니다.                                                                                                                                                                                  | N                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
| **/Manifest:\<manifest-file\>**                                         | 가져오기 작업을 위한 매니페스트 파일을 지정합니다.                                                                                                                                                                                                                         
                                                                            매니페스트 파일은 내보내기 작업 중에 생성됩니다.                                                                                                                                                                                                                           | N                          | N                                                 | Y                                                   
                                                                                                                                                                                                                                                                                                                                                                                                                                         (미리 보기 전용)                                     |
...
## <span id="copy-files"></span></a> AzCopy를 사용하여 Azure 파일 저장소의 파일 복사(미리 보기 버전 전용)
...
## <span id="copy-entities"></span></a> AzCopy를 사용하여 Azure 테이블의 엔터티 복사(미리 보기 버전 전용)
...
생성된 JSON 데이터 파일은 최소 메타데이터의 페이로드 형식을 따릅니다. 이 페이로드 형식에 대한 자세한 내용은 [테이블 서비스 작업을 위한 페이로드 형식][테이블 서비스 작업을 위한 페이로드 형식]을 참조하세요.
...
| 버전       | 새로운 기능                                                                                                                                                                                     |
|------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **V4.0.0** | **최신 미리 보기 버전으로, V3.0.0 이후의 모든 기능을 포함합니다. 또한 Azure 파일 저장소에 대한 파일 복사와 Azure 테이블 저장소에 대한 엔터티 복사도 지원합니다.**                               |
| **V3.0.0** | **최신 릴리스 버전입니다. 매개 변수 이름을 포함해야 하도록 AzCopy 명령줄 구문이 수정되었으며 명령줄 도움말이 다시 디자인되었습니다. 이 버전에서는 Azure Blob 저장소에 대한 복사만 지원됩니다.** |
| V2.5.1     | 최신 버전입니다. /xo 및 /xn 옵션 사용 시 성능을 최적화합니다. 소스 파일 이름의 특수 문자 관련 버그와 사용자가 잘못된 명령줄 구문을 입력한 후의 저널 파일 손상 현상이 수정되었습니다.            |
...
-   [AzCopy: Windows Azure Blob 파일 업로드/다운로드][AzCopy: Windows Azure Blob 파일 업로드/다운로드](영문)
  ...
  [최신 미리 보기 버전]: http://aka.ms/downloadazcopypr
  ...
  [테이블 서비스 작업을 위한 페이로드 형식]: http://msdn.microsoft.com/library/azure/dn535600.aspx
