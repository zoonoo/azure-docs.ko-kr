...
구독에서 메시지를 받을 때는
**ServiceBusService** 개체의 **receive\_subscription\_message** 메서드를 사용합니다.

	msg = bus_service.receive_subscription_message('mytopic', 'LowMessages', peek_lock=False)
	print(msg.body)

매개 변수
**peek\_lock**이 **False**로 설정된 경우 메시지를 읽으면 구독에서 해당 메시지가 삭제됩니다. 매개 변수
**peek\_lock**을 **True**로 설정하면 메시지를 큐에서 삭제하지 않고 읽은(미리 본) 다음 잠글 수 있습니다.
