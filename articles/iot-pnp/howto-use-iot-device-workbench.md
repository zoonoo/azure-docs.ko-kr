---
title: Azure IoT 장치 워크 벤치를 사용 하 여 IoT 플러그 앤 플레이 미리 보기 장치 빌드 | Microsoft Docs
description: Visual Studio Code에서 Azure IoT 장치 워크 벤치 확장을 사용 하 여 IoT 플러그 앤 플레이 장치 모델을 신속 하 게 작성 하 고 장치 코드를 구현할 수 있습니다.
author: liydu
ms.author: liydu
ms.date: 07/25/2019
ms.topic: conceptual
...
ms.locfileid: "70881250"
---
# <a name="use-azure-iot-device-workbench-extension-in-visual-studio-code"></a>Visual Studio Code에서 Azure IoT 장치 워크 벤치 확장 사용

Azure IoT 장치 워크 벤치 Visual Studio Code 확장은 DCM (장치 기능 모델) 및 인터페이스를 작성 하 고, 모델 리포지토리에 게시 하 고, 기본 C 코드를 생성 하 여 장치 응용 프로그램을 구현 하는 통합 환경을 제공 합니다.
...
장치 워크 벤치 확장을 사용 하 여 IoT 장치를 개발 하는 방법 [https://github.com/microsoft/vscode-iot-workbench](https://github.com/microsoft/vscode-iot-workbench)에 대 한 자세한 내용은을 참조 하세요.

## <a name="prerequisites"></a>필수 구성 요소

[Visual Studio Code](https://code.visualstudio.com/)를 설치합니다.

VS Code에 확장을 설치 하려면 다음 단계를 따르십시오.

1. VS Code에서 **확장** 탭을 선택 합니다.
1. Marketplace에서 **Azure IoT 장치 워크 벤치** 를 검색 하 고 설치 합니다.
...
1. **팀 탐색기**에서 **azure-iot-c** 리포지토리를 열고 **분기**를 선택 하 고, **공개-미리 보기** 분기를 검색 하 여 체크 아웃 합니다.
    ...
    ![공개 미리 보기](media/howto-use-iot-device-workbench/vs-public-preview.png)
...
1. **일반** 도구 모음에서 **구성** 드롭다운을 찾습니다. **구성 관리** 를 선택 하 여 프로젝트에 대 한 cmake 설정을 추가 합니다.
    ...
    ![구성 관리](media/howto-use-iot-device-workbench/vs-manage-config.png)
...
Azure IoT 장치 워크 벤치 확장은 GitHub의 오픈 소스 프로젝트입니다. 모든 문제 및 기능 요청에 대해 [GitHub에서 문제를 만들](https://github.com/microsoft/vscode-iot-workbench/issues)수 있습니다.

## <a name="next-steps"></a>다음 단계

이 방법 문서에서는 Azure IoT 장치 워크 벤치를 사용 하 여 DCM 및 인터페이스 파일을 작성 하는 방법에 대해 알아보았습니다. 또한 장치 응용 프로그램을 구현 하는 기본 C 코드를 생성 하는 방법도 알아보았습니다. 제안 된 다음 단계는 [Azure IoT 탐색기 도구를 설치 하 고 사용](./howto-install-iot-explorer.md) 하는 방법을 배우는 것입니다.
