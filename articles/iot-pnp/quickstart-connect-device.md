---
title: 빠른 시작 - IoT 플러그 앤 플레이 샘플 디바이스 코드를 Azure IoT Hub에 연결 | Microsoft Docs
description: 빠른 시작 - IoT 허브에 연결하는 Linux 또는 Windows에서 IoT 플러그 앤 플레이 샘플 디바이스 코드(C, C#, Java, JavaScript 또는 Python)를 빌드하고 실행합니다. Azure IoT 탐색기 도구를 사용하여 디바이스에서 허브로 전송된 정보를 봅니다.
author: ericmitt
ms.author: ericmitt
ms.date: 07/14/2020
ms.topic: quickstart
...
> [방법: 디바이스에 연결 및 상호 작용](./quickstart-service.md)
