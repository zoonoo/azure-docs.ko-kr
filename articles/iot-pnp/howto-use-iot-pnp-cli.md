...
이 방법 문서에서는 Azure CLI용 Azure IoT 확장을 설치 및 사용하여 플러그 앤 플레이 디바이스와 상호 작용하는 방법을 배웠습니다. 제안 된 다음 단계는 [장치에서 Azure IoT 탐색기](./howto-use-iot-explorer.md)를 사용 하는 방법을 알아보는 것입니다.
