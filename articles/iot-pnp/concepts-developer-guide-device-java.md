---
title: 장치 개발자 가이드 (Java)-IoT 플러그 앤 플레이 | Microsoft Docs
description: Java 장치 개발자를 위한 IoT 플러그 앤 플레이 설명
author: rido-min
ms.author: rmpablos
ms.date: 09/24/2020
ms.topic: conceptual
...
ms.locfileid: "91580059"
---
# <a name="iot-plug-and-play-device-developer-guide-java"></a>IoT 플러그 앤 플레이 장치 개발자 가이드 (Java)
