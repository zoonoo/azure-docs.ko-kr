...
| -------- | ---------------------- | ---------------------------- |
| .NET     | [설명서](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices) <br/> [샘플](https://github.com/Azure-Samples/azure-iot-samples-csharp/tree/master/iot-hub/Samples/service/PnpServiceSamples)| [샘플](https://github.com/Azure-Samples/azure-iot-samples-csharp/tree/master/iot-hub/Samples/service/DigitalTwinClientSamples) |
