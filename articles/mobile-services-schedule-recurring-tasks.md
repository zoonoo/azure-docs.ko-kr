<properties urlDisplayName="Schedule Backend Tasks" pageTitle="스케줄러를 사용하여 백 엔드 작업 예약 - 모바일 서비스" metaKeywords="" description="Use the Azure Mobile Services Scheduler to schedule jobs for your mobile app." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Schedule recurring jobs in Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
