...
> [!INCLUDE [SharePoint에 대한 연결을 만드는 단계](../../includes/connectors-create-api-sharepointonline.md)]
> 
> 
...
> [!INCLUDE [SharePoint Online 트리거를 만드는 단계](../../includes/connectors-create-api-sharepointonline-trigger.md)]
> 
> 
...
> [!INCLUDE [SharePoint Online 작업을 만드는 단계](../../includes/connectors-create-api-sharepointonline-action.md)]
> 
> 
