...
1. 로그인하라는 메시지가 표시되면 필요한 연결 정보를 입력합니다. SharePoint 서버를 사용하는 경우 **온-프레미스 데이터 게이트웨이를 통해 연결을**선택해야 합니다. 작업을 완료하면 **만들기**를 선택합니다.
