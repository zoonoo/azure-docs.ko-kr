...
논리 앱을 처음 접하는 경우 [Azure Logic Apps?](../logic-apps/logic-apps-overview.md)을 검토 하세요.
...
1. 다음과 같은 트리거 세부 정보를 제공합니다.
   ...
   | **간격은** | 예 | 다음 확인 때까지 경과할 초, 분, 시간, 일, 주, 달 수 |
   ||| 
...
| **소유자 유형** | 는 또는 `teams`중 `systemusers` 하나 여야 합니다. |
...
2. 작업 도구 모음에서 이러한 단계 중 하나를 선택합니다.
   ...
   * **Pop Out**을 선택 합니다. ![팝아웃 레코드](./media/connectors-create-api-crmonline/popout-record.png) 
