...
>
> [Common Data Service 커넥터](https://docs.microsoft.com/connectors/commondataservice/)는 사용되지 않는 Dynamics 365 커넥터와 동일한 기능을 제공하지만 안정성을 높이는 향상된 기능이 포함되어 있습니다. 논리 앱에서 Common Data Service 커넥터를 사용하는 방법에 대한 자세한 내용은 [Azure Logic Apps를 사용하여 Common Data Service 레코드 만들기 및 관리](../connectors/connect-common-data-service.md)를 참조하세요.
