...
>[AZURE.NOTE] 이 버전의 문서는 논리 앱 2015-08-01-preview 스키마 버전에 적용됩니다. 2014-12-01-preview 스키마 버전의 경우 [Azure 서비스 버스](../app-service-logic/app-service-logic-connector-Azure Service Bus.md)를 클릭합니다.
