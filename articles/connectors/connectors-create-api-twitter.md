...
### Twitter에 대한 연결 만들기
> [!INCLUDE [Twitter에 대한 연결을 만드는 단계](../../includes/connectors-create-api-twitter.md)]
> 
> 
...
3. **값 선택** 컨트롤을 선택합니다. 이 컨트롤에서는 조건이 true 또는 false로 평가될 값으로 이전 작업 또는 트리거 중 하나 이상의 속성을 선택할 수 있습니다.  
...
8. *보다 큼* 연산자의 피연산자로 50을 입력합니다. 이제 조건이 추가됩니다. 위의 메뉴에서 **저장** 링크를 사용하여 작업을 저장합니다.  
