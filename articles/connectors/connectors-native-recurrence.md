...
| 되풀이 | Interval | Frequency(빈도) | 시작 시간 | 요일 선택 | 시간 선택 | 분 선택 | 참고 |
| ---------- | -------- | --------- | ---------- | ------------- | -------------- | ---------------- | ---- |
