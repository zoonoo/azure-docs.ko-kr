...
| 커넥터 |  |  |  |
| --- | --- | --- | --- |
|[![API Icon][API/Web-Appicon]<br/>**API/Web App**][API/Web-Appdoc]|![API 아이콘][appFiguresicon]<br/>**appFigures**|![API 아이콘][Asanaicon]<br/>**Asana**|![API 아이콘][Azure-DocumentDBicon]<br/>**Azure DocumentDB**|
...
[Dynamics-365doc]: ./connectors-create-api-crmonline.md "Dynamics CRM Online에 연결하고 CRM Online 데이터를 사용하여 더 많은 작업을 수행합니다."
...
[office365-outlookdoc]: ./connectors-create-api-office365-outlook.md "Office 365 커넥터는 메일을 보내고 받고, 일정을 관리하고, Office 365 계정을 사용하여 연락처를 관리할 수 있습니다."
...
[sql-serverdoc]: ./connectors-create-api-sqlazure.md "SQL Azure 데이터베이스에 연결합니다. SQL Database 테이블의 항목 생성, 업데이트, 가져오기 및 삭제 작업을 수행할 수 있습니다."
...
[sapconnector]: ..//app-service-logic/app-service-logic-enterprise-connector-sap-connector.md "SAP 커넥터에 대해 알아보기"
