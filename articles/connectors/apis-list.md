...
| [![기본 제공 아이콘][terminate-icon]<br>**종료**][terminate-doc] | 활발히 실행 중인 논리 앱 워크플로를 중지합니다. | [![다음][until-icon]<br>**까지** 기본 제공 아이콘][until-doc] | 지정된 조건이 true이거나 일부 상태가 변경될 때까지 작업을 반복합니다. |
|||||
