...
> [!TIP]
> 이 토픽의 [A-Z 전체 목록](#az)은 Logic Apps에서 사용할 수 있는 모든 커넥터를 나열합니다.
...
Logic Apps에는 다음과 같은 유형의 트리거가 포함되어 있습니다.  
