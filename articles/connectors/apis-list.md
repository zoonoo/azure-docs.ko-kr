...
| 커넥터 |  |  |  |
| --- | --- | --- | --- |
|[![API 아이콘][API/Web-Appicon]<br/>**API/Web App**][API/Web-Appdoc]|![API 아이콘][appFiguresicon]<br/>**Appfigures**|![API 아이콘][Asanaicon]<br/>**Asana**|![API 아이콘][Azure-DocumentDBicon]<br/>**Azure DocumentDB**|
|![API 아이콘][Azure-MLicon]<br/>**Azure ML**|[![API 아이콘][Azure-Functionsicon]<br/>**Azure<br/>Functions**][Azure-Functionsdoc]|[![API 아이콘][AzureBlobStorageicon]<br/>**Azure Blob<br/>Storage**][AzureBlobStoragedoc]|![API 아이콘][Basecamp-3icon]<br/>**Basecamp 3**|
...
|![API 아이콘][Google-Sheetsicon]<br/>**Google Sheets**|![API 아이콘][Google-Tasksicon]<br/>**Google 태스크**|![API 아이콘][HipChaticon]<br/>**HipChat**|[![API 아이콘][HTTPicon]<br/>**HTTP**][HTTPdoc]|
...
|[![API 아이콘][Office-365-Outlookicon]<br/>**Office 365<br/>Outlook**][office365-outlookdoc]|[![API 아이콘][Office-365-Usersicon]][office365-usersdoc]<br/>**Office 365<br/>사용자**|[![API 아이콘][Office-365-Videoicon]<br/>**Office 365<br/>비디오**][office365-videodoc]|[![API 아이콘][OneDriveicon]<br/>**OneDrive**][OneDrivedoc]|
|[![API 아이콘][OneDrive-for-Businessicon]<br/>**비즈니스용<br/>OneDrive**][OneDrive-for-Businessdoc]|[![API 아이콘][Oracle-DB-icon]<br/>**Oracle DB**][oracle-db-doc]|[![API 아이콘][Outlook.comicon]<br/>**Outlook.com**][Outlook.comdoc]|![API 아이콘][PagerDutyicon]<br/>**PagerDuty**|
...
[oracle-db-doc]: https://powerapps.microsoft.com/blog/connecting-to-oracle-database-from-powerapps-flow-and-logic-apps "Oracle 데이터베이스에 연결"
