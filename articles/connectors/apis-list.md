...
[bingsearchDoc]: ./create-api-bingsearch.md "웹, 이미지, 뉴스 및 비디오에 대한 Bing을 검색합니다."
[boxDoc]: ./create-api-box.md "상자에 연결하고 업로드, 가져오기, 삭제, 나열 및 추가 파일 작업을 수행할 수 있습니다."
[crmonlinedoc]: ./create-api-crmonline.md "Dynamics CRM Online에 연결하고 CRM Online 데이터를 사용하여 더 많은 작업을 수행합니다."
[dropboxdoc]: ./create-api-dropbox.md "Dropbox에 연결하고 가져오기, 삭제, 나열 및 추가 파일 작업을 수행할 수 있습니다."
[exceldoc]: ./create-api-excel.md "Excel에 연결합니다."
[facebookdoc]: ./create-api-facebook.md "Facebook에 연결하여 타임라인에 게시, 페이지 피드 가져오기 등의 작업을 수행합니다."
[ftpdoc]: ./create-api-ftp.md "FTP / FTPS 서버에 연결하여 파일 등의 업로드, 가져오기, 삭제를 포함한 다른 FTP 작업을 수행합니다."
[googledrivedoc]: ./create-api-googledrive.md "Google 드라이브에 연결하고 데이터를 조작합니다."
[microsofttranslatordoc]: ./create-api-microsofttranslator.md
[office365outlookdoc]: ./create-api-office365-outlook.md "Office 365 커넥터는 메일을 보내고 받고, 일정을 관리하고, Office 365 계정을 사용하여 연락처를 관리할 수 있습니다."
...
[sqldoc]: ./create-api-sqlazure.md "SQL Azure 데이터베이스에 연결합니다. SQL 데이터베이스 테이블의 항목 생성, 업데이트, 가져오기 및 삭제 작업을 수행할 수 있습니다."
[twiliodoc]: ./create-api-twilio.md "Twilio에 연결하여 메시지를 보내고 가져오고, 사용 가능한 번호를 가져와 수신 전화 번호 등을 관리합니다."
[twitterdoc]: ./create-api-twitter.md "Twitter에 연결하여 타임 라인을 가져오고 트윗에 게시합니다."
[yammerdoc]: ./create-api-yammer.md "Yammer에 연결하여 메시지를 게시하고 새 메시지를 받습니다."
