...
5. 완료하면 새 AAD 앱이 열립니다. **구성**을 선택합니다. ![Contoso AAD 앱][10]

6. **OAuth 2** 섹션에서 **회신 URL**을 Azure 포털에서 Office 365 사용자 API를 추가했을 때 표시된 URL 리디렉션 값으로 설정합니다. **응용 프로그램 추가**를 선택합니다. ![Contoso AAD 앱 구성][11]
