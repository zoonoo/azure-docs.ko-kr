<properties
pageTitle="논리 앱에서 FTP 커넥터를 사용하는 방법 알아보기 | Microsoft Azure"
...
>[AZURE.INCLUDE [FTP에 대한 연결을 만드는 단계](../../includes/connectors-create-api-ftp.md)]
...
>[AZURE.IMPORTANT]FTP 커넥터를 사용하려면 인터넷에서 액세스할 수 있고 PASSIVE 모드로 작동하도록 구성된 FTP 서버가 필요합니다. 또한 FTP 커넥터는 **암시적 FTPS(FTP over SSL)와 호환되지 않습니다**. FTP 커넥터는 명시적 FTPS(FTP over SSL)만 지원합니다.
