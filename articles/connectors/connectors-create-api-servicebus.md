...
> [!INCLUDE [Azure 서비스 버스에 대한 연결을 만드는 단계](../../includes/connectors-create-api-servicebus.md)]
> 
> 
...
> [!INCLUDE [서비스 버스 트리거를 만드는 단계](../../includes/connectors-create-api-servicebus-trigger.md)]
> 
> 
...
[!INCLUDE [서비스 버스 작업을 만드는 단계](../../includes/connectors-create-api-servicebus-action.md)]
