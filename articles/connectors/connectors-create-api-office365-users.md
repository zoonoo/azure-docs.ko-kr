...
| 트리거 | actions |
| --- | --- |
| 없음 |<ul><li>관리자 가져오기</li><li>내 프로필 가져오기</li><li>부하 직원을 가져옵니다.</li><li>사용자 프로필 가져오기</li><li>사용자 검색</li></ul> |
...
> [!TIP]
> 다른 논리 앱에서 이와 동일한 Office 365 사용자 연결을 사용할 수 있습니다.
> 
> 

## <a name="office-365-users-rest-api-reference"></a>Office 365 사용자 REST API 참조
적용 버전: 1.0

### <a name="get-my-profile"></a>내 프로필 가져오기
...
### <a name="get-user-profile"></a>사용자 프로필 가져오기
특정 사용자 프로필을 검색합니다.  
```GET: /users/{userId}``` 

| 이름 | 데이터 형식 | 필수 | 위치 | 기본값 | 설명 |
| --- | --- | --- | --- | --- | --- |
| userId |string |예 |path |없음 |사용자 계정 이름 또는 전자 메일 ID |
...
### <a name="get-direct-reports"></a>부하 직원을 가져옵니다.
부하 직원을 가져옵니다.  
...
#### <a name="user-user-model-class"></a>User: 사용자 모델 클래스입니다.
| 속성 이름 | 데이터 형식 | 필수 |
| --- | --- | --- |
