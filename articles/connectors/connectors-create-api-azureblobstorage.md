---
title: 논리 앱에 Azure Blob 저장소 커넥터 추가 | Microsoft Docs
...
#### 연결 만들기
> [!INCLUDE [Azure Blob 저장소에 대한 연결 만들기](../../includes/connectors-create-api-azureblobstorage.md)]
> 
> 
...
> [!TIP]
> [Storage Explorer](http://storageexplorer.com/)는 여러 저장소 계정을 관리하는 유용한 도구입니다.
> 
> 
