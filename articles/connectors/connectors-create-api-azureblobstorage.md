...
커넥터의 Open API (이전의 Swagger) 파일에 설명 된 대로 트리거, 작업 및 제한과 같은 기술 세부 정보는 [커넥터의 참조 페이지](https://docs.microsoft.com/connectors/azureblobconnector/)를 참조 하세요.
