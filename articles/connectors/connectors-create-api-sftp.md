...
### SFTP에 대한 연결 만들기
> [!INCLUDE [SFTP에 대한 연결을 만드는 단계](../../includes/connectors-create-api-sftp.md)]
> 
> 
...
> [!INCLUDE [SFTP 트리거를 만드는 단계](../../includes/connectors-create-api-sftp-trigger.md)]
> 
> 

## 조건 추가
> [!INCLUDE [조건을 추가하는 단계](../../includes/connectors-create-api-sftp-condition.md)]
> 
> 
...
> [!INCLUDE [SFTP 작업을 만드는 단계](../../includes/connectors-create-api-sftp-action.md)]
> 
> 
