...
* SFTP-SSH 작업 읽기 또는 파일을 쓸 수 있습니다 *1GB 이하로* 데이터를 관리 하 여 *50 MB 개의*하지 1, GB 부분.
...
* 작업 수 파일 읽기 / 쓰기 *최대 1GB* 조각을 처리 데이터를 50 MB 조각, 1GB 없습니다 하지만 SFTP 커넥터를 비교 합니다. 1GB보다 큰 파일의 경우 작업에서 [메시지 청크 분할](../logic-apps/logic-apps-handle-large-messages.md)을 사용할 수도 있습니다. 현재 SFTP-SSH 트리거 청크를 지원 하지 않습니다.
