---
title: 상자에 연결
description: Azure Logic Apps를 사용하여 Box에서 파일을 만들고 관리하는 작업 및 워크플로 자동화
services: logic-apps
...
ms.locfileid: "75666774"
---
# <a name="create-and-manage-files-in-box-by-using-azure-logic-apps"></a>Azure 논리 앱을 사용하여 상자에서 파일 만들기 및 관리
...
커넥터의 OpenAPI(이전 Swagger) 파일에서 설명한 대로 트리거, 작업 및 제한과 같은 기술적 세부 정보는 [커넥터의 참조 페이지를](/connectors/box/)참조하십시오.
