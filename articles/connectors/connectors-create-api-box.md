---
title: Box에 연결
description: Azure Logic Apps를 사용 하 여 Box에서 파일을 만들고 관리 하는 작업 및 워크플로 자동화
services: logic-apps
...
---
# <a name="create-and-manage-files-in-box-by-using-azure-logic-apps"></a>Azure Logic Apps를 사용 하 여 Box에서 파일 만들기 및 관리
