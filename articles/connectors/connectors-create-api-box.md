---
title: Logic Apps에 Box 커넥터 추가 | Microsoft Docs
...
Box에 연결하여 파일 만들기, 파일 삭제 등의 작업을 수행합니다. Box를 사용하여 다음을 수행할 수 있습니다.
...
[커넥터 세부 정보](/connectors/box/)에서 swagger에 정의된 모든 트리거 및 작업과 제한 사항도 확인할 수 있습니다.
