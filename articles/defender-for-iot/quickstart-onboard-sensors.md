...
| **활성화하기 전에 센서 네트워크 매개 변수 업데이트** | 센서 설치 중에 정의된 매개 변수를 업데이트합니다. 자세한 내용은 **오류! 참조 소스를 찾을 수 없음** 을 참조하세요.|
...
4. 센서 획득 옵션을 선택합니다.
   ...
   ![Azure Defender for IoT 네트워크 섹터 보기](media/updates/image6.png)
