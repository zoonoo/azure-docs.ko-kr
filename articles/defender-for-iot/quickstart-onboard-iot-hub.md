...
IoT 솔루션의 보안을 유지하기 위해 IoT 디바이스, IoT Edge 및 IoT Hub와 주고 받는 수신 및 발신 연결의 IP 주소가 기본적으로 수집 및 저장됩니다. 이 정보는 의심스러운 IP 원본에서 시도하는 비정상적인 연결을 검색하는 데 필요합니다. 알려진 봇넷의 IP 원본 또는 지리적 위치 외부의 IP 원본에서 연결하려는 시도를 예로 들 수 있습니다. Defender for IoT 서비스는 언제든지 IP 주소 데이터 수집을 설정 또는 해제할 수 있습니다.
...
기본적으로 Defender for IoT 솔루션을 켜면 Azure 구독 내 모든 IoT Hub가 자동으로 보호됩니다.
