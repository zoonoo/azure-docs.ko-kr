...
1. 다음 **을 선택 하면** 관리 콘솔에 대 한 사용자 및 시스템 생성 암호가 표시 됩니다.
    ...
    > [!NOTE]
    > 처음으로 센서 또는 온-프레미스 관리 콘솔에 로그인 하면 연결 된 구독에 연결 됩니다. CyberX 또는 지원 사용자에 대 한 암호를 다시 설정 해야 하는 경우 해당 구독을 선택 해야 합니다. CyberX 또는 지원 사용자 암호를 복구 하는 방법에 대 한 자세한 내용은 [암호 재설정](how-to-create-and-manage-users.md#resetting-passwords)을 참조 하세요.
