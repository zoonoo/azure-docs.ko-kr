---
title: 의심 스러운 장치 조사
description: 이 방법 가이드에서는 IoT 용 Defender를 사용 하 여 Log Analytics를 사용 하 여 의심 스러운 IoT 장치를 조사 하는 방법을 설명 합니다.
ms.topic: conceptual
ms.date: 09/04/2020
...
ms.locfileid: "104782013"
---
# <a name="investigate-a-suspicious-iot-device"></a>의심스러운 IoT 디바이스 조사

IoT 서비스 경고에 대 한 Defender는 IoT 장치에서 의심 스러운 활동에 참여 하는 것으로 의심 되는 경우 또는 장치가 손상 된 경우 표시 될 때 명확한 표시를 제공 합니다.
...
기본적으로 Defender for IoT는 Log Analytics 작업 영역에 보안 경고 및 권장 사항을 저장 합니다. 원시 보안 데이터를 저장하도록 선택할 수도 있습니다.
