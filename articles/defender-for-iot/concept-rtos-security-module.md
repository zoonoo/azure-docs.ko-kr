---
title: Azure RTOS 보안 모듈의 기본 사항에 대 한 개념 설명
description: Azure RTOS 개념 및 워크플로의 보안 모듈에 대 한 기본 사항을 알아봅니다.
...
Azure RTOS 용 보안 모듈은 IoT 장치에 대 한 무료 다운로드로 제공 됩니다. IoT 클라우드 서비스용 Defender는 Azure 구독 당 30 일 평가판으로 사용할 수 있습니다. [지금 보안 모듈을 다운로드](https://github.com/azure-rtos/azure-iot-preview/releases) 하 여 시작 해 보세요. 
