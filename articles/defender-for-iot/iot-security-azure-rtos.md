...
description: IoT 용 Azure Defender의 일부로 Azure RTOS 지원 및 구현에 대 한 보안 모듈에 대해 자세히 알아보세요.
...
![IoT Azure RTOS 용 Defender의 시각화.](./media/architecture/azure-rtos-security-monitoring.png)
...
이 문서에서는 Azure RTOS의 보안 모듈에 대해 알아보았습니다. 보안 모듈에 대 한 자세한 내용을 알아보고 시작 하려면 다음 문서를 참조 하세요.
