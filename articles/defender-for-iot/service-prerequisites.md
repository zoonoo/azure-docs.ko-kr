...
## <a name="working-with-defender-for-iot-service"></a>IoT 서비스용 Defender 사용

Defender for IoT insights 및 보고는 Azure IoT Hub 및 Azure Security Center를 사용 하 여 사용할 수 있습니다. Azure IoT Hub에서 IoT에 대해 Defender를 사용 하도록 설정 하려면 **소유자** 수준의 권한이 있는 계정이 필요 합니다. IoT Hub에서 IoT for IoT를 사용 하도록 설정 하 고 나면 Defender for iot insights는 Azure IoT Hub의 **보안** 기능 및 Azure Security Center의  **iot** 로 표시 됩니다.

## <a name="supported-service-regions"></a>지원되는 서비스 지역

IoT 용 Defender는 현재 다음 Azure 지역에서 IoT Hub에 대해 지원 됩니다.
...
IoT 용 Defender 에이전트는 장치 및 플랫폼의 증가 하는 목록을 지원 합니다. 기존 또는 계획 된 장치 라이브러리를 확인 하려면 [지원 되는 플랫폼 목록](how-to-deploy-agent.md) 을 참조 하세요.
