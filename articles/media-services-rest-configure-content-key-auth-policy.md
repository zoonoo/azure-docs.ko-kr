...
미디어 서비스에서 자산을 암호화하려는 경우 암호화 키(**CommonEncryption** 또는 **EnvelopeEncryption**)를 자산([여기]에 설명되어 있음(../media-services-rest-create-contentkey/))에 연결하고 해당 키에 대해 권한 부여 정책(이 문서에서 설명)도 구성해야 합니다. 
...
##다음 단계
콘텐츠 키의 권한 부여 정책을 구성했으므로 [자산 배달 정책을 구성하는 방법](../media-services-rest-configure-asset-delivery-policy/) 항목으로 이동하세요.
