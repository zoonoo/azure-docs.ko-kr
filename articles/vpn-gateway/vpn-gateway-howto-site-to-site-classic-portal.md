...
2. **+ 리소스 만들기를*클릭 합니다. **마켓플레이스 검색** 필드에 ‘Virtual Network’를 입력합니다. 반환 된 목록에서 **Virtual Network** 을 찾고를 클릭 하 여 **Virtual Network** 페이지를 엽니다.
...
## <a name="2-add-additional-address-space"></a><a name="additionaladdress"></a>2. 추가 주소 공간 추가
...
## <a name="6-specify-the-sku-and-vpn-type"></a><a name="sku"></a>6. SKU 및 VPN 유형을 지정 합니다.
