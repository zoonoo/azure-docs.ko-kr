...
### <a name="workflow"></a>워크플로
  ...
  3. (이 문서) - 선택한 인증 옵션에 대한 VPN 클라이언트 구성을 가져오고 이 구성을 사용하여 Windows 장치에서 VPN 클라이언트를 설정합니다. 이렇게 하면 P2S 연결을 통해 Azure Vnet에 연결할 수 있습니다.
...
* **GenericDevice** - 이 폴더에는 자체 VPN 클라이언트 구성을 만드는 데 사용되는 일반 정보가 포함되어 있습니다. 이 폴더는 사용자 이름/암호 인증 구성에 필요하지 않습니다.
...
## <a name="setupusername"></a> 2. Windows 및 Mac VPN 클라이언트 구성
...
### <a name="certmaccli"></a>Mac(OSX) VPN 클라이언트 설정
