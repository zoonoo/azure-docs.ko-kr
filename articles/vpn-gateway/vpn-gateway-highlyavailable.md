---
title: 'Azure VPN Gateway: 개요 - 가용성 성능이 뛰어난 게이트웨이 구성'
...
![Azure에서 호스트된 서브넷에 연결하기 위해 활성 Azure VPN 게이트웨이에 연결된 온-프레미스 VPN 및 프라이빗 IP 서브넷이 있고 대기 게이트웨이를 사용할 수 있는 온-프레미스 사이트를 보여 주는 다이어그램](./media/vpn-gateway-highlyavailable/active-standby.png)
...
![Azure에서 호스트된 서브넷에 연결하기 위해 두 개의 활성 Azure VPN 게이트웨이에 연결된 온-프레미스 VPN 및 프라이빗 IP 서브넷이 있는 온-프레미스 사이트를 보여 주는 다이어그램](./media/vpn-gateway-highlyavailable/active-active.png)
...
![두 개의 가상 사이트가 연결하는 데 사용되는 두 개의 Azure VPN 게이트웨이 및 프라이빗 IP 서브넷을 호스트하는 두 개의 Azure 지역을 보여 주는 다이어그램](./media/vpn-gateway-highlyavailable/vnet-to-vnet.png)
