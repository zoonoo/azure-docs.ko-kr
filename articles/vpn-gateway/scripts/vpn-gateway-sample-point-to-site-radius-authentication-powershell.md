---
title: Azure PowerShell 스크립트 샘플 - RADIUS 사용자 이름/암호 인증으로 지점 및 사이트 간 VPN 구성 | Microsoft Docs
description: RADIUS 사용자 이름/암호 인증으로 지점 및 사이트 간 VPN을 구성합니다. 이 문서에서는 PowerShell을 사용합니다.
