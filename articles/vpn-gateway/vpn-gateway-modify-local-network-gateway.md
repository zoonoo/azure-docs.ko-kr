...
때로는 로컬 네트워크 게이트웨이 AddressPrefix 또는 GatewayIPAddress에 대한 설정을 변경합니다. 이 문서는 로컬 네트워크 게이트웨이 설정을 수정하는 방법을 안내합니다. Azure Portal 또는 Azure CLI를 사용하여 이러한 설정을 수정할 수도 있습니다.
