...
## <a name="a-name-aagatewayapart-1---create-and-configure-active-active-vpn-gateways"></a><a name ="aagateway"></a>1부 - 활성-활성 VPN Gateway 만들기 및 구성
...
## <a name="a-name-aacrosspremapart-2---establish-an-active-active-cross-premises-connection"></a><a name ="aacrossprem"></a>2부 - 활성-활성 프레미스 간 연결 설정
...
## <a name="a-name-aav2vapart-3---establish-an-active-active-vnet-to-vnet-connection"></a><a name ="aav2v"></a>3부 - 활성-활성 VNet 간 연결 설정
...
## <a name="a-name-aaupdateapart-4---update-existing-gateway-between-active-active-and-active-standby"></a><a name ="aaupdate"></a>4부 - 활성-활성 및 활성-대기 간에 기존 게이트웨이 업데이트
