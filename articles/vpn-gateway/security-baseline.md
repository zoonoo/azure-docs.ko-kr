...
- [Azure Portal을 사용하여 경로 기반 VPN 게이트웨이 만들기](./tutorial-create-gateway-portal.md)
...
- [Virtual network에 대 한 Azure policy 샘플 기본 제공](../virtual-network/policy-reference.md)
