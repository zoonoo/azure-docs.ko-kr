---
title: VPN 게이트웨이에 대한 암호화 요구 사항
titleSuffix: Azure VPN Gateway
description: 프레미스 간 S2S VPN 터널 및 Azure VNet 간 연결 모두에 대한 암호화 요구 사항을 충족하도록 Azure VPN 게이트웨이를 구성하는 방법을 알아봅니다.
