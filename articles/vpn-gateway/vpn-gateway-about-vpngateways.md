...
## <a name="a-namediagramsaconnection-topology-diagrams"></a><a name="diagrams"></a>연결 토폴로지 다이어그램
...
### <a name="site-to-site-and-multi-site-connections"></a>사이트 간 및 다중 사이트 연결
#### <a name="a-names2sasite-to-site"></a><a name="S2S"></a>사이트 간
...
#### <a name="a-namemultiamulti-site"></a><a name="Multi"></a>다중 사이트
...
### <a name="a-namev2vavnet-to-vnet-connections"></a><a name="V2V"></a>VNet 간 연결
...
### <a name="a-namecoexistingasite-to-site-and-expressroute-coexisting-connections"></a><a name="coexisting"></a>사이트 간 및 ExpressRoute 공존 연결
