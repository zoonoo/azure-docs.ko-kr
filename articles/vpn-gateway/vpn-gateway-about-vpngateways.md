...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] 기본 SKU를 사용해야만 게이트웨이에 PolicyBased VPN을 만들 수 있습니다.
게이트웨이 SKU에 대한 자세한 내용은 [게이트웨이 SKU](vpn-gateway-about-vpn-gateway-settings.md#gwsku)를 참조하세요.
...
![지점 및 사이트 간 연결](./media/vpn-gateway-about-vpngateways/demop2s.png "point-to-site")
