...
| 보안 제어 | 예/아니요 | 메모 |
|---|---|--|
| 미사용 서버 쪽 암호화: Microsoft 관리 키 | N/A | VPN gateway에서 고객 데이터를 전송 하 고 고객 데이터를 저장 하지 않음 |
...
| 미사용 서버 쪽 암호화: 고객 관리 키 (BYOK) | 아닙니다. | 사용자가 지정한 미리 공유한 키는 미사용 시 암호화 됩니다. 하지만 CMK와는 아직 통합 되지 않았습니다. |
