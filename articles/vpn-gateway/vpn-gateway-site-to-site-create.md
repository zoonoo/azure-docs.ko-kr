...
## <a name="CreateVNet"></a>가상 네트워크 만들기
...
## <a name="Details"></a>가상 네트워크 세부 정보 페이지
다음 정보를 입력합니다.
...
## <a name="DNS"></a>DNS 서버 및 VPN 연결 페이지
...
## <a name="Address"></a>가상 네트워크 주소 공간 페이지
...
## <a name="VNetGateway"></a>가상 네트워크 게이트웨이 구성
