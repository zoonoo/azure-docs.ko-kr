...
- 사용하려는 VPN 장치가 프레미스 간 가상 네트워크 연결을 만드는 데 필요한 요구 사항을 충족하는지 확인합니다. 자세한 내용은 [가상 네트워크 연결을 위한 VPN 장치 정보](http://go.microsoft.com/fwlink/p/?LinkId=615099)를 참조하세요.
...
다음에는 **가상 네트워크 게이트웨이**를 구성하여 안전한 사이트 간 VPN 연결을 만들겠습니다. [관리 포털에서 가상 네트워크 게이트웨이 구성](vpn-gateway-configure-vpn-gateway-mp.md)을 참조하세요.
