...
다음 예제에서는 패킷 캡처를 시작 및 중지 하는 PowerShell 명령을 보여 줍니다. 매개 변수 옵션에 대 한 자세한 내용은 [이 PowerShell 문서](https://docs.microsoft.com/powershell/module/az.network/start-azvirtualnetworkgatewaypacketcapture)를 참조 하세요.
