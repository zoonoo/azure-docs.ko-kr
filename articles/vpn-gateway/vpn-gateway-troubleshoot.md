...
* [VPN 및 방화벽 장치 설정](vpn-gateway-third-party-settings.md)<br>이 문서에서는 VPN Gateway와 함께 사용되는 타사 VPN 또는 방화벽 디바이스에 대해 제안된 몇 가지 솔루션을 제공합니다. 타사 VPN 또는 방화벽 디바이스에 대한 기술 지원은 디바이스 공급업체에서 제공합니다.
