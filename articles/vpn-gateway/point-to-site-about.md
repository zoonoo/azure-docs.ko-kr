...
>[!NOTE]
>P2S용 IKEv2는 현재 미리 보기로 있으며 Resource Manager 배포 모델에서 사용할 수 있습니다.
>
...
### <a name="which-gateway-skus-support-p2s-vpn"></a>어떤 게이트웨이 SKU에서 P2S VPN을 지원합니까?
...
[P2S 연결 구성 - Azure 기본 인증서 인증](vpn-gateway-howto-point-to-site-rm-ps.md)
