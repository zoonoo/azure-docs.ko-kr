...
## <a name="subnets"></a>2. 다른 주소 공간 및 서브넷 추가
...
## <a name="gatewaysubnet"></a>4. 게이트웨이 서브넷 만들기
...
## <a name="LocalNetworkGateway"></a>6. 로컬 네트워크 게이트웨이 만들기
...
## <a name="CreateConnection"></a>8. 사이트 간 VPN 연결 만들기
...
## <a name="VerifyConnection"></a>9. VPN 연결 확인
