...
* *--게이트웨이-IP-주소는* 온-프레미스 VPN 장치의 IP 주소입니다.
...
## <a name="7-create-the-vpn-gateway"></a><a name="CreateGateway"></a>7. VPN 게이트웨이 만들기

가상 네트워크 VPN Gateway 만들기. VPN Gateway 만들기를 완료하는 데 45분 이상 걸릴 수 있습니다.

다음 값을 사용합니다.

* 사이트 간 구성에 대한 *--게이트웨이 유형은* *Vpn입니다.* 게이트웨이 유형은 항상 구현하는 구성에 따라 다릅니다. 자세한 내용은 [게이트웨이 유형을](vpn-gateway-about-vpn-gateway-settings.md#gwtype)참조하십시오.
...
* 강제 터널링에 대한 자세한 내용은 [강제 터널링 정보를](vpn-gateway-forced-tunneling-rm.md)참조하십시오.
