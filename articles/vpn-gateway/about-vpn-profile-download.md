...
---
# <a name="working-with-p2s-vpn-client-profile-files"></a>P2S VPN 클라이언트 프로필 파일 작업

프로필 파일에는 VPN 연결을 구성 하는 데 필요한 정보가 포함 되어 있습니다. 이 문서는 VPN 클라이언트 프로필에 필요한 정보를 얻고 이해하는 데 도움이 됩니다.
...
PowerShell을 사용 하 여 생성 하려면 다음 예제를 사용할 수 있습니다.
