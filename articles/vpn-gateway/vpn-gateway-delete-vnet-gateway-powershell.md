---
title: 'Azure VPN 게이트웨이: 게이트웨이 삭제: PowerShell'
...
> * [파워 쉘 (클래식)](vpn-gateway-delete-vnet-gateway-classic-powershell.md)
>
>
...
### <a name="1-download-the-latest-azure-resource-manager-powershell-cmdlets"></a>1. 최신 Azure 리소스 관리자 PowerShell cmdlet을 다운로드합니다.
...
### <a name="6-delete-the-public-ip-address-resources"></a>6. 공용 IP 주소 리소스 삭제
...
### <a name="3-delete-the-public-ip-address-resources"></a>3. 공용 IP 주소 리소스 삭제
