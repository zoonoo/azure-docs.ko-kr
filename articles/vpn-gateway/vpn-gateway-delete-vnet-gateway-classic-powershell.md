...
##<a name="step-1-connect-to-azure"></a>1단계: Azure에 연결
...
## <a name="step-2-export-and-view-the-network-configuration-file"></a>2단계: 네트워크 구성 파일 내보내기 및 확인
...
## <a name="step-4-modify-the-network-configuration-file"></a>4단계: 네트워크 구성 파일 수정
...
## <a name="step-5-upload-the-network-configuration-file"></a>5단계: 네트워크 구성 파일 업로드
