...
## <a name="step-2-export-and-view-the-network-configuration-file"></a><a name="export"></a>2단계: 네트워크 구성 파일 내보내기 및 확인
...
## <a name="step-4-modify-the-network-configuration-file"></a><a name="modify"></a>4단계: 네트워크 구성 파일 수정
...
### <a name="local-network-sites"></a><a name="lns"></a>로컬 네트워크 사이트 수
...
## <a name="step-5-upload-the-network-configuration-file"></a><a name="upload"></a>5단계: 네트워크 구성 파일 업로드
