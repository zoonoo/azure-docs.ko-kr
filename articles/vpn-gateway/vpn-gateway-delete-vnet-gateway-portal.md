...
description: Azure Portal를 사용 하 여 가상 네트워크 게이트웨이 삭제
...
이 문서에서는 가상 네트워크 게이트웨이를 삭제 하는 방법을 설명 합니다. VPN gateway 구성에 대 한 게이트웨이를 삭제 하려는 경우에는 몇 가지 다른 방법을 사용할 수 있습니다.
...
> [!IMPORTANT]
> 이 문서의 단계는 Resource Manager 배포 모델에 적용됩니다. 클래식 배포 모델을 사용 하 여 배포 된 VPN gateway를 삭제 하려면 [게이트웨이 삭제: 클래식](vpn-gateway-delete-vnet-gateway-classic-powershell.md) 문서의 단계를 사용 합니다.
...
### <a name="to-delete-additional-resources"></a>추가 리소스를 삭제 하려면

다음 단계는 더 이상 사용 되지 않는 리소스를 삭제 하는 데 도움이 됩니다.
