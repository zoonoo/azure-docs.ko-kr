...
공용 IP 주소의 이름을 알고 있는 경우 [Get-AzureRmPublicIpAddress](/powershell/module/azurerm.network/Reset-AzureRmPublicIpAddress) 명령을 사용하여 게이트웨이에 할당된 공용 IP 주소를 표시합니다.
