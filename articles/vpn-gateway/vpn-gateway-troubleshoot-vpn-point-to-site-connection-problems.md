...
***게이트웨이 이름*&gt;&lt;가상 네트워크 게이트웨이를 저장 하지 못했습니다. 인증서 &lt;인증서 *ID*&gt;에 대 한 데이터가 잘못 되었습니다.**
...
***게이트웨이 이름*&gt;&lt;가상 네트워크 게이트웨이를 저장 하지 못했습니다.&gt; *업로드 하려는 인증서 이름* &lt;리소스 이름이 잘못**되었습니다.
