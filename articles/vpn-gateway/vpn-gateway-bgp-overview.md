...
description: 라우팅 및 연결 가능성 정보를 교환 하는 데 사용 되는 표준 라우팅 프로토콜인 Border Gateway Protocol를 지 원하는 Azure VPN Gateway에 대해 알아봅니다.
...
## <a name="why-use-bgp"></a><a name="why"></a>BGP를 사용하는 이유
...
### <a name="support-automatic-and-flexible-prefix-updates"></a><a name="prefix"></a>자동 및 유연한 접두사 업데이트 지원
...
### <a name="support-multiple-tunnels-between-a-vnet-and-an-on-premises-site-with-automatic-failover-based-on-bgp"></a><a name="multitunnel"></a>BGP를 기준으로 자동 장애 조치(failover)가 있는 VNet과 온-프레미스 사이트 간 여러 터널 지원
...
### <a name="support-transit-routing-between-your-on-premises-networks-and-multiple-azure-vnets"></a><a name="transitrouting"></a>온-프레미스 네트워크와 여러 Azure VNet 간 전송 라우팅 지원
