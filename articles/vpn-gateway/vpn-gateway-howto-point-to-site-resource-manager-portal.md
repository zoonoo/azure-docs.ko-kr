---
title: "지점 및 사이트 간을 사용하여 Azure 가상 네트워크에 연결: 포털 | Microsoft Docs"
...
---
# <a name="configure-a-point-to-site-connection-to-a-vnet-using-the-azure-portal"></a>Azure Portal을 사용하여 VNet에 지점 및 사이트 간 연결 구성
