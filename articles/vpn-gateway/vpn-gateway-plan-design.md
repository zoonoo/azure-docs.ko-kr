...
### <a name="a-namecompareacross-premises-connectivity-options"></a><a name="compare"></a>프레미스 간 연결 옵션
...
### <a name="a-namegwrequireagateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>VPN 유형 및 SKU별 게이트웨이 요구 사항
...
### <a name="a-namewfaworkflow"></a><a name="wf"></a>워크플로
...
## <a name="design"></a>디자인
### <a name="a-nametopologiesaconnection-topologies"></a><a name="topologies"></a>연결 토폴로지
...
### <a name="a-namedesignbasicsadesign-basics"></a><a name="designbasics"></a>디자인 기본 사항
다음 섹션은 VPN 게이트웨이 기본 사항에 대해 설명합니다. 또한 [네트워킹 서비스 제한 사항](../azure-subscription-service-limits.md#networking-limits)을 고려하세요.

#### <a name="a-namesubnetsaabout-subnets"></a><a name="subnets"></a>서브넷 정보
...
#### <a name="a-namelocalaabout-local-network-gateways"></a><a name="local"></a>로컬 네트워크 게이트웨이 정보
...
#### <a name="a-namegwtypeaabout-gateway-types"></a><a name="gwtype"></a>게이트웨이 형식 정보
...
#### <a name="a-nameconnectiontypeaabout-connection-types"></a><a name="connectiontype"></a>연결 형식 정보
...
#### <a name="a-namevpntypeaabout-vpn-types"></a><a name="vpntype"></a>VPN 형식 정보
...
### <a name="a-namedevicesavpn-devices-for-site-to-site-connections"></a><a name="devices"></a>사이트 간 연결에 대한 VPN 장치
...
### <a name="a-nameforcedtunnelaconsider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>강제 터널 라우팅 고려
