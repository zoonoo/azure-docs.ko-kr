---
title: VPN 게이트웨이 계획 및 설계 | Microsoft Docs
...
---
# <a name="planning-and-design-for-vpn-gateway"></a>VPN 게이트웨이 계획 및 설계
...
### <a name="<a-name="compare"></a>cross-premises-connectivity-options"></a><a name="compare"></a>프레미스 간 연결 옵션
...
### <a name="<a-name="gwrequire"></a>gateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>VPN 유형 및 SKU별 게이트웨이 요구 사항
...
<br>
 다음 표에서는 게이트웨이 형식과 예상 총 처리량을 보여 줍니다. 예상되는 총 처리량은 설계의 결정적 요인이 될 수 있습니다.
가격은 게이트웨이 SKU마다 다릅니다. 가격에 대한 자세한 내용은 [VPN 게이트웨이 가격](https://azure.microsoft.com/pricing/details/vpn-gateway/)을 참조하세요. 이 표는 리소스 관리자 배포 모델과 클래식 배포 모델 모두에 적용됩니다.

[!INCLUDE [vpn-gateway-table-gwtype-aggtput](../../includes/vpn-gateway-table-gwtype-aggtput-include.md)]

### <a name="<a-name="wf"></a>workflow"></a><a name="wf"></a>워크플로
...
## <a name="design"></a>디자인
### <a name="<a-name="topologies"></a>connection-topologies"></a><a name="topologies"></a>연결 토폴로지
...
### <a name="<a-name="designbasics"></a>design-basics"></a><a name="designbasics"></a>디자인 기본 사항
다음 섹션은 VPN 게이트웨이 기본 사항에 대해 설명합니다. 또한 [네트워킹 서비스 제한 사항](../azure-subscription-service-limits.md#networking-limits)을 고려하세요.

#### <a name="<a-name="subnets"></a>about-subnets"></a><a name="subnets"></a>서브넷 정보
...
#### <a name="<a-name="local"></a>about-local-network-gateways"></a><a name="local"></a>로컬 네트워크 게이트웨이 정보
...
#### <a name="<a-name="gwtype"></a>about-gateway-types"></a><a name="gwtype"></a>게이트웨이 형식 정보
...
#### <a name="<a-name="connectiontype"></a>about-connection-types"></a><a name="connectiontype"></a>연결 형식 정보
...
#### <a name="<a-name="vpntype"></a>about-vpn-types"></a><a name="vpntype"></a>VPN 형식 정보
...
### <a name="<a-name="devices"></a>vpn-devices-for-site-to-site-connections"></a><a name="devices"></a>사이트 간 연결에 대한 VPN 장치
...
### <a name="<a-name="forcedtunnel"></a>consider-forced-tunnel-routing"></a><a name="forcedtunnel"></a>강제 터널 라우팅 고려
