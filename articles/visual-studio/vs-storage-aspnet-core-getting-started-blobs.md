---
title: Visual Studio를 사용 하 여 Azure Blob storage 시작 (ASP.NET Core)
...
2. 상황에 맞는 메뉴에서**연결 된 서비스** **추가** > 를 선택 합니다.
...
2. 상황에 맞는 메뉴에서**새 폴더** **추가** > 를 선택 합니다. 새 폴더 이름을 *Blobs*로 지정합니다. 

1. **솔루션 탐색기**에서 **뷰** 폴더를 확장하고 **Blob**을 마우스 오른쪽 단추로 클릭합니다.

4. 상황에 맞는 메뉴에서 뷰 **추가** > **View**를 선택 합니다.
