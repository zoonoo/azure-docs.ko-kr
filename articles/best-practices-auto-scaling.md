...
* 웹 포털 UI를 사용하여 SQL 데이터베이스 인스턴스 및 큐와 같은 리소스를 계산 서비스 인스턴스에 연결할 수 있습니다. 따라서 연결된 각 리소스에 대한 별도의 수동 및 자동 크기 조정 구성 옵션에 더 쉽게 액세스할 수 있습니다. 자세한 내용은 [방법: 클라우드 서비스에 리소스 연결](cloud-services/cloud-services-how-to-manage.md#linkresources) 및 [응용 프로그램의 크기를 조정하는 방법](cloud-services/cloud-services-how-to-scale.md)을 참조하세요.
...
* [웹 역할, 작업자 역할 또는 가상 컴퓨터를 실행 중인 응용 프로그램의 크기 자동 조정](cloud-services/cloud-services-how-to-manage.md#linkresources)
* [방법: 클라우드 서비스에 리소스 연결](cloud-services/cloud-services-how-to-manage.md#linkresources)
