...
이 자습서에서는 PTVS 샘플 템플릿 중 하나를 사용하여 간단한 설문 조사 응용 프로그램을 만들기 위해 [Python Tools for Visual Studio][]를 사용해 보겠습니다. 이 자습서는 [비디오](https://www.youtube.com/watch?v=oKCApIrS0Lo)로도 제공됩니다.
...
1.  탐색 창 맨 아래에 있는 **새로 만들기**를 클릭합니다.
  	...
  	![새 단추](./media/web-sites-python-ptvs-django-mysql/PollsCommonAzurePlusNew.png)

1.  **스토어**, **ClearDB MySQL 데이터베이스**를 클릭합니다.

  	![추가 기능 대화 상자 선택](./media/web-sites-python-ptvs-django-mysql/PollsDjangoClearDBAddon1.png)
...
1.  데이터베이스 서비스를 찾을 영역/선호도 그룹을 선택합니다. Azure 응용 프로그램에서 데이터베이스를 사용하는 경우 응용 프로그램을 배포할 영역과 동일한 영역을 선택합니다.
  	...
  	![추가 기능 대화 상자 개인 설정](./media/web-sites-python-ptvs-django-mysql/PollsDjangoClearDBAddon2.png)
...
1.  **연결 정보**를 클릭합니다.  복사 단추를 사용하여 **CONNECTIONSTRING** 값을 클립보드에 저장합니다.
  	...
  	![연결 정보 대화 상자](./media/web-sites-python-ptvs-django-mysql/PollsDjangoMySQLConnectionInfo.png)
...
1.  **사이트 이름** 및 **지역**을 선택하고 **만들기**를 클릭합니다.
  	...
  	![Microsoft Azure에서 사이트 만들기 대화 상자](./media/web-sites-python-ptvs-django-mysql/PollsCommonCreateWebSite.png)
