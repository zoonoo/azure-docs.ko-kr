...
이 시나리오를 고려할 때 몇 가지 중요한 사항은 다음과 같습니다.
...
## 디렉터리에 액세스하는 데 LDAP 읽기를 사용하는 온-프레미스 응용 프로그램을 Azure 인프라 서비스에 들어올려서 옮기기
...
## Azure RemoteApp
Azure RemoteApp을 통해 Contoso의 관리자는 도메인에 가입된 컬렉션을 만들 수 있습니다. 이렇게 하면 Azure RemoteApp에서 제공되는 원격 응용 프로그램을 도메인에 가입된 컴퓨터에서 실행하고 Windows 통합 인증을 사용하여 다른 리소스에 액세스할 수 있습니다. Contoso는 Azure AD 도메인 서비스를 사용하여 Azure RemoteApp 도메인에 가입된 컬렉션에서 사용하는 관리되는 도메인을 제공할 수 있습니다.
