...
* **그룹 정책:** 사용자 계정과 도메인 가입 컴퓨터에서 필수 보안 정책을 준수하기 위해 사용자 및 컴퓨터 컨테이너마다 기본 제공 단일 GPO를 사용할 수 있습니다. [그룹 정책을 관리](active-directory-ds-admin-guide-administer-group-policy.md)하기 위해 자체 사용자 지정 GPO를 만든 후 사용자 지정 조직 구성 단위에 할당할 수도 있습니다.
