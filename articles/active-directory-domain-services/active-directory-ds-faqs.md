<properties
	pageTitle="Azure Active Directory Domain Services: FAQ | Microsoft Azure"
...
#### Azure AD Domain Services를 내 구독 내의 여러 가상 네트워크에서 사용할 수 있나요?
...
관리 그룹에 추가한 사용자(예: ‘AAD DC Administrators’)은 컴퓨터를 도메인에 가입시킬 수 있습니다. 또한 이 그룹의 사용자에게는 도메인에 가입 된 컴퓨터에 대한 원격 데스크톱 액세스가 부여됩니다.
...
#### Azure AD Domain Services는 유료 서비스인가요?
서비스는 공개 미리 보기 기간 동안 특별히 절감된 가격에 사용할 수 있습니다. 서비스가 일반적으로 사용 가능(GA)하면 전체 가격을 지불합니다. 자세한 내용은 [가격 책정 페이지](https://azure.microsoft.com/pricing/details/active-directory-ds/)를 참조하세요.
...
아니요, Azure AD 도메인 서비스는 종량제 Azure 서비스이며 EMS의 일부가 아닙니다. Azure AD의 SKU 모두에 사용 가능한 Azure AD Domain Services(무료, 기본, 및 프리미엄)는 사용량에 따라 시간을 기준으로 요금이 청구됩니다.
...
현재 서비스가 일반 공급 상태에 도달하는 시기에 대한 타임라인을 공유할 수 없습니다.
