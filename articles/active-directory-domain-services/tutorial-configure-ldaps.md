...
특정 컨테이너를 직접 쿼리하려면 **보기 > 트리** 메뉴에서 **BaseDN**(예: *OU=AADDC Users,DC=CONTOSO,DC=COM* 또는 *OU=AADDC Computers,DC=CONTOSO,DC=COM*)을 지정할 수 있습니다. 쿼리를 형식 지정하고 만드는 방법에 대한 자세한 내용은 [LDAP 쿼리 기본 사항][ldap-query-basics]을 참조하세요.
