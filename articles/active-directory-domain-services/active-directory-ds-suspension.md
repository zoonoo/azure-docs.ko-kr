...
Azure Portal의 Azure AD DS 상태 페이지에 도메인이 일시 중단되었다고 선언하는 [경고](active-directory-ds-troubleshoot-alerts.md)가 표시됩니다. 도메인 상태도 “일시 중단됨”으로 표시됩니다.
...
- [Azure Active Directory Domain Services에 대해 자세히 알아보기](active-directory-ds-overview.md)
