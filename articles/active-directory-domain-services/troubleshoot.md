...
* **자격 증명 형식** -UPN 형식을 사용 하 여와 `dee@aaddscontoso.onmicrosoft.com`같은 자격 증명을 지정 합니다. UPN 형식은 Azure AD DS에서 자격 증명을 지정 하는 데 권장 되는 방법입니다. 이 UPN이 Azure AD에서 올바르게 구성 되어 있는지 확인 합니다.
