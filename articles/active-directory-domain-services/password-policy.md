...
1. 관리 되는 도메인을 관리 하는 데 사용 하는 Windows VM에 로그인 합니다 (최소 Windows Server 2012 R2 이상 이어야 함). [Azure AD Domain Services 도메인을 관리](manage-domain.md)하는 방법에 대 한 지침을 따릅니다.
