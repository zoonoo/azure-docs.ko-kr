...
Azure AD 응용 프로그램 프록시 커넥터를 실행 하는 VM은 관리 되는 도메인과 동일 하거나 피어 링 가상 네트워크에 있어야 합니다. 그런 다음 응용 프로그램 프록시를 사용 하 여 게시 하는 응용 프로그램을 호스트 하는 Vm도 동일한 Azure 가상 네트워크에 배포 해야 합니다.
