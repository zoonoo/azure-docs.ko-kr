...
이 문서는 Azure AD 도메인 서비스를 설치하거나 관리할 때 발생할 수 있는 문제에 대한 문제해결 힌트를 제공합니다.
...
- **동기화된 계정:** 영향을 받는 사용자 계정이 온-프레미스 디렉터리에서 동기화되는 경우 다음 단계를 따르도록 합니다.
    - Azure AD Connect의 GA 릴리스로 배포되거나 업데이트됩니다. 이전 버전은 NTLM/Kerberos 인증에 필요한 자격 증명 해시를 동기화하지 않습니다.
