...
- 기존 가상 네트워크를 사용할 계획인 경우 해당 네트워크가 지역 가상 네트워크인지 확인합니다. 레거시 선호도 그룹 메커니즘을 사용하는 가상 네트워크는 Azure AD 도메인 서비스와 함께 사용할 수 없습니다. [레거시 가상 네트워크를 지역 가상 네트워크로 마이그레이션](../virtual-network/virtual-networks-migrate-to-regional-vnet.md)해야 합니다.
