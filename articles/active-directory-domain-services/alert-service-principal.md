...
*Azure AD Domain Services 하는 데 필요한 서비스 주체가 Azure AD 디렉터리에서 삭제 되었습니다. 이 구성은 관리 되는 도메인을 모니터링, 관리, 패치, 동기화 하는 Microsoft의 기능에 영향을 줍니다.*
...
Azure AD 디렉터리에서 응용 프로그램 ID *443155a6-77f3-45e3-882b-22b3a8d431fb*, *abba844e-bc0e-44b0-947a-dc74e5d09022*또는 *d87dcbc6-a371-462e-88e3-28ad15ec4e64* 가 누락 된 경우 다음 단계를 완료 하 여 *Microsoft AAD* 리소스 공급자를 다시 등록 합니다.
