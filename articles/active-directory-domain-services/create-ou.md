...
* Azure AD 테 넌 트에서 동기화 된 사용자 계정이 포함 된 *Aaddc 사용자* 에 대 한 기본 OU가 만들어집니다.
...
1. **작업** 창은 Active Directory 관리 센터 오른쪽에 표시 됩니다. *Contoso.com*와 같은 도메인에서 **새로 만들기 > 조직 구성 단위**를 선택 합니다.
