...
6. **확인**을 클릭합니다.
	...
	![Azure에 로그인함](./media/web-sites-dotnet-get-started-vs2013/configuresitesettings2.png)
	...
	**Azure 앱 서비스 작업** 창에 웹앱이 만들어졌다고 표시됩니다.
	...
	![웹앱이 생성됨](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated1.png)

	이제 서버 탐색기에서 웹 응용 프로그램을 볼 수 있습니다.

	![웹앱이 생성됨](./media/web-sites-dotnet-get-started-vs2013/siteinse.png)

## Azure에 응용 프로그램 배포

7. **Azure 앱 서비스 작업** 창에서 **지금 이 웹앱에 MyExample 게시**를 클릭합니다.

	![웹앱이 생성됨](./media/web-sites-dotnet-get-started-vs2013/GS13sitecreated.png)
...
12. **게시**를 클릭합니다.
	...
	**출력** 및 **Web Publish Activity** 창에 수행된 배포 작업이 표시되고 성공적인 배포 완료가 보고됩니다.
	...
	![Azure에서 실행되는 웹앱](./media/web-sites-dotnet-get-started-vs2013/GS13deployedsite.png)
...
1. Ctrl+F5 키를 눌러서 로컬 컴퓨터에서 웹 응용 프로그램을 실행하여 업데이트된 제목을 표시합니다.
	...
	![로컬 실행되는 웹앱](./media/web-sites-dotnet-get-started-vs2013/localandazure.png)
...
2. **찾아보기 \> 웹앱**을 클릭한 다음 웹 응용 프로그램의 이름을 클릭합니다.
	...
	![웹앱 블레이드](./media/web-sites-dotnet-get-started-vs2013/portaldashboard.png)
