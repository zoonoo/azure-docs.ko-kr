...
>[AZURE.NOTE]**Visual Studio 2015 Preview를 사용하여 빌드된 Cordova 프로젝트에서 Azure 모바일 서비스를 사용하려면 이 [해결 방법](http://go.microsoft.com/fwlink/?LinkId=518765)을 따릅니다. 이후 버전의 Visual Studio 2015를 사용하는 프로젝트에는 이 해결 방법이 필요 없습니다.**
