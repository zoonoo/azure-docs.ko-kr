...
## <a name="data-management-settings"></a>데이터 관리 설정
...
캐시에 대한 [메트릭 보기](cache-how-to-monitor.md#how-to-view-metrics-and-customize-charts)를 수행하려면 **Redis 메트릭**을 클릭하고, **경고 규칙 설정**을 수행하려면 [경고 규칙](cache-how-to-monitor.md#operations-and-alerts)을 클릭합니다.
...
## <a name="resource-management-settings"></a>리소스 관리 설정
