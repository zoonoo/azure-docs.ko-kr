---
title: Azure Redis Cache를 사용하는 방법 | Microsoft Docs
...
> [!IMPORTANT]
> 경고: 소스 코드에 자격 증명을 저장해서는 안 됩니다. 이 샘플을 단순하게 유지하기 위해 소스 코드로 표시합니다. [응용 프로그램 설정 및 연결 문자열 작동 방식][응용 프로그램 설정 및 연결 문자열 작동 방식]\(영문)에서 자격 증명 저장 방법에 대해 자세히 알아보세요.
> 
> 
...
* [StackExchange.Redis 캐시 클라이언트 설명서][StackExchange.Redis 캐시 클라이언트 설명서]\(영문)를 확인하세요.
