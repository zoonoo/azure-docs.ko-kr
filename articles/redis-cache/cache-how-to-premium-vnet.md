...
> [!IMPORTANT]
> 서브넷의 처음 4개 주소는 예약되어 있으므로 사용할 수 없습니다. 자세한 내용은 [이러한 서브넷 내에서 IP 주소를 사용하는데 제한 사항이 있습니까?](../virtual-network/virtual-networks-faq.md#are-there-any-restrictions-on-using-ip-addresses-within-these-subnets)를 참조하세요.
> 
> 
