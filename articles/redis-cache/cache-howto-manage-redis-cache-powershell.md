...
[클래식 배포 모델](#classic) 은 이 문서의 뒷부분에서 설명합니다.
...
> [!IMPORTANT]
> 다시 부팅은 [프리미엄 계층](cache-premium-tier-intro.md) 캐시에만 사용할 수 있습니다. 캐시를 다시 부팅하는 방법에 대한 자세한 내용은 [캐시 관리 - 다시 부팅](cache-administration.md#reboot)을 참조하세요.
> 
> 
