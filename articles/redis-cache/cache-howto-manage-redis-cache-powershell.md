...
이 토픽에서는 Azure Redis Cache를 만들고, 업데이트하고, 삭제하는 방법을 설명합니다.
...
- [리소스 그룹을 사용하여 Azure 리소스 관리](../azure-portal/resource-group-portal.md): Azure Preview 포털에서 리소스 그룹을 만들고 관리하는 방법에 대해 알아봅니다.
