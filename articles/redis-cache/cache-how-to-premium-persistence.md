...
AOF 지속성을 구성하려면 **첫 저장소 계정**을 지정합니다. 이 저장소 계정은 캐시와 동일한 영역에 있어야 하며 높은 처리량을 가진 **프리미엄 저장소** 계정을 사용하는 것이 좋습니다. 경우에 따라 **두 번째 저장소 계정**이라는 추가 저장소 계정을 구성할 수 있습니다. 두 번째 저장소 계정이 구성된 경우 복제본 캐시에 대한 쓰기는 이 두 번째 저장소 계정에 기록됩니다. 구성된 각 저장소 계정에 대해 **저장소 키** 드롭다운에서 사용할 **기본 키** 또는 **보조 키**를 선택합니다. 
