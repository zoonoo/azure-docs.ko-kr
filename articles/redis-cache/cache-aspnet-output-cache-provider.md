...
# <a name="asp.net-output-cache-provider-for-azure-redis-cache"></a>Azure Redis Cache에 대한 ASP.NET 출력 캐시 공급자
...
## <a name="store-asp.net-page-output-in-the-cache"></a>ASP.NET 페이지 출력을 캐시에 저장
