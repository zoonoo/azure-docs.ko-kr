---
title: 내보낸 Resource Manager 템플릿 사용자 지정 | Microsoft Docs
...
1. 사용자 고유 스크립트를 사용하여 배포하려면 다음 중 하나를 사용합니다.
...
2. 내보낸 템플릿과 스크립트를 다운로드한 경우 **deploy.ps1** 파일\(PowerShell\) 또는 **deploy.sh** 파일\(Azure CLI\)을 검색합니다.
