...
3. [여기](./customize-ui-with-html.md#3-configure-cors) 에 CORS 요구 사항에 따라 선택한 공급자에서 HTML 파일을 호스팅합니다.
