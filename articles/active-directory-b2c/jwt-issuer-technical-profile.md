...
| attribute | 필수 | Description |
| --------- | -------- | ----------- |
| issuer_secret | yes | JWT 토큰에 서명하는 데 사용할 X509 인증서(RSA 키 집합)입니다. `B2C_1A_TokenSigningKeyContainer`사용자 지정 정책 시작[에서 구성한 ](custom-policy-get-started.md) 키입니다. |
| issuer_refresh_token_key | yes | 새로 고침 토큰을 암호화하는 데 사용할 X509 인증서(RSA 키 집합)입니다. `B2C_1A_TokenEncryptionKeyContainer`사용자 지정 정책 시작[에서 ](custom-policy-get-started.md) 키를 구성했습니다. |
