...
|RefreshTokenUserJourneyId| 예 | 끝점에 대 한 액세스 토큰 게시 요청을 [새로 고치](authorization-code-flow.md#4-refresh-the-token) 는 동안 실행 해야 하는 사용자 경험의 식별자입니다 `/token` . |
