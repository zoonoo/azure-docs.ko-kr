...
4. **콜백 URL**에 `https://{tenant}.b2clogin.com/te/{tenant}.onmicrosoft.com/{policyId}/oauth1/authresp`를 입력합니다. **{tenant}** 를 테넌트의 이름(예: contosob2c)으로 바꾸고 **{policyId}** 를 정책 ID(예: b2c_1_policy)로 바꿔야 합니다. Twitter 계정을 사용하는 모든 정책에 대한 콜백 URL을 추가해야 합니다. 
