...
> [AZURE.NOTE]Azure AD B2C Preview는 현재 무료로 사용하지만 제한이 있습니다(테넌트당 사용자 최대 5만명). Azure 구독은 [Azure 포털](http://manage.windowsazure.com/)에 액세스하는 데 필요합니다.
...
4. B2C 기능 블레이드를 사용한 Azure Preview 포털은 새 브라우저 탭 또는 창에서 열립니다.
...
5. 쉽게 액세스할 수 있도록 이 블레이드(오른쪽 위 구석 확인)를 시작 보드에 고정합니다.
    ...
    > [AZURE.NOTE][Azure 포털](https://manage.windowsazure.com/)에서 테넌트의 사용자와 그룹, 셀프 서비스 암호 재설정 구성 및 회사 브랜딩 기능을 관리할 수 있습니다.
