...
1. **이름** 을 입력합니다. 예를 들어 *Contoso* 를 입력 합니다.
...
1. Id 공급자를 추가 하려는 사용자 흐름을 클릭 합니다. 
1. **소셜 id 공급자** 에서 추가한 id 공급자를 선택 합니다. 예: *Contoso*.
1. **저장** 을 선택합니다.
...
1. 등록 또는 로그인 페이지에서 로그인 할 id 공급자를 선택 합니다. 예: *Contoso*.
