...
Azure Active Directory B2C (Azure AD B2C)에서 Google 계정을 [id 공급자로](authorization-code-flow.md) 사용 하려면 Google 개발자 콘솔에서 응용 프로그램을 만들어야 합니다. Google 계정이 아직 없는 경우에서 [https://accounts.google.com/SignUp](https://accounts.google.com/SignUp)등록할 수 있습니다.
...
응용 프로그램의 **이름을** 입력 합니다. **권한 있는 도메인** 섹션에 *b2clogin.com* 를 입력 하 고 **저장**을 선택 합니다.
