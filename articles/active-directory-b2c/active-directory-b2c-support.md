...
1. B2C 테넌트를, 연결된 Azure 구독이 있는 다른 테넌트로 전환합니다. 일반적으로 후자는 직원 테넌트 또는 Azure 구독에 등록할 경우 만들어진 기본 테넌트입니다. 자세한 내용은 [Azure 구독과 Azure AD의 연관 관계](../active-directory/fundamentals/active-directory-how-subscriptions-associated-directory.md)를 참조하세요.
    ...
    ![강조 표시 하는 테 넌 트 선택 영역을 사용 하 여 azure portal](./media/active-directory-b2c-support/support-switch-dir.png)

3. 테넌트를 전환한 후 **도움말 + 지원**을 클릭합니다.

    ![도움말 + 지원 타일 Azure 포털에서 강조 표시](./media/active-directory-b2c-support/support-support.png)

4. **새 지원 요청**을 클릭합니다.

    ![Azure 포털에서 강조 표시 하는 새 지원 요청 타일](./media/active-directory-b2c-support/support-new.png)
5. **기본 사항** 블레이드에서 이러한 세부 정보를 사용하고 **다음**을 클릭합니다.
   ...
   * 적합한 **지원 계획**을 선택합니다. 아직 선택하지 않은 경우 [여기](https://azure.microsoft.com/support/plans/)에서 하나를 등록할 수 있습니다.
     ...
     ![Azure 포털에서 강조 표시 한 다음 단추를 사용 하 여 기본 페이지](./media/active-directory-b2c-support/support-basics.png)
6. **문제** 블레이드에서 이러한 세부 정보를 사용하고 **다음**을 클릭합니다.
   ...
   * **파일 업로드**에서 문제 해결에 도움이 될만한 모든 스크린샷과 파일을 업로드합니다.
     ...
     ![Azure 포털에서 강조 표시 한 다음 단추를 사용 하 여 문제 페이지](./media/active-directory-b2c-support/support-problem.png)
7. **연락처 정보** 블레이드에서 연락처 정보를 추가합니다. **만들기**를 클릭합니다.

    ![Azure 포털에서 강조 표시 하는 만들기 단추를 사용 하 여 연락처 정보 페이지](./media/active-directory-b2c-support/support-contact.png)
