...
이 공급자는 신뢰 당사자 응용 프로그램 또는 페더레이션된 SAML id 공급자 간의 Azure AD B2C SAML 세션을 관리 하는 데 사용 됩니다. SSO 공급자를 사용 하 여 SAML id 공급자 세션을 저장 하는 `RegisterServiceProviders` 경우를로 `false`설정 해야 합니다. `SM-Saml-idp` [SAML 기술 프로필](saml-technical-profile.md)에서 사용 하는 기술 프로필은 다음과 같습니다.
...
`SM-Saml-idp` [SAML 발급자 기술 프로필](saml-issuer-technical-profile.md) 에서 사용 하는 기술 프로필은 다음과 같습니다.
