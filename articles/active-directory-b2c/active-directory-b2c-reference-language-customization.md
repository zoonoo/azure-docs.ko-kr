...
언어 사용자 지정을 통해 고객 요구에 맞게 사용자 경험을 다른 언어로 변경할 수 있습니다.  37개 언어에 대한 번역을 제공합니다([추가 정보](#additional-information) 참조).  단일 언어로만 환경이 제공되더라도 사용자 요구에 맞게 페이지에 있는 텍스트를 사용자 지정할 수 있습니다.  
...
3. **정책 기본 언어** - 언어에서 언어를 지정하지 않거나 지원되지 않는 언어를 지정하면 정책 기본 언어로 번역됩니다.
...
3. **지원되는 언어** 블레이드로 이동합니다.  여기에서 **리소스 추가**를 선택할 수 있습니다.
