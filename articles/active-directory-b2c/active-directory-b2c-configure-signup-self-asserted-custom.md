...
---
# <a name="azure-active-directory-b2c-modify-signup-to-add-new-claims-and-configure-user-input"></a>Azure Active Directory B2C: 새 클레임을 추가하도록 등록 수정 및 사용자 입력 구성
...
## <a name="add-the-claim-to-the-singupsign-user-journey"></a>등록/로그인 사용자 경험에 클레임 추가
...
테스트 모드의 등록 화면은 다음과 유사하게 표시됩니다. ![수정된 등록 옵션의 스크린샷](./media/active-directory-b2c-configure-signup-self-asserted-custom/signup-with-city-claim-dropdown-example.png)
