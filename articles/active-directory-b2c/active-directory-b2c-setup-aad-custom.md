...
1. 정책 키의 **이름**을 입력합니다. 예를 들어, `ContosoAppSecret`을 입력합니다.  접두사 `B2C_1A_`은 생성 될 때 키 이름에 자동으로 추가 되므로 다음 섹션의 XML 참조는 *B2C_1A_ContosoAppSecret*입니다.
