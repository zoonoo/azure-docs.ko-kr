...
* 사용자 지정 정책을 사용하여 사용자 지정 인증 사용자 경험을 작성 및 업로드합니다. 
   ...
   * 사용자 경험에서 조건부 분기를 정의합니다. * 사용자 지정 인증 사용자 경험에서 REST API 사용 서비스를 통합합니다.  
...
* 새로운 기능은 평가 목적으로만 사용하는 것이 좋습니다.<br>
* 프로덕션 환경에서는 새로운 기능을 사용할 수 없습니다.<br>
* Service Level Agreement(서비스 수준 약정)는 새로운 기능에 적용되지 않습니다. <br>
* 정식 지원 채널을 통해 지원 요청을 제출할 수 있습니다. <br>
