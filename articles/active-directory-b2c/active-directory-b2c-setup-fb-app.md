...
4. 양식에서 **표시 이름**, 유효한 **연락처 전자 메일**, 적절한 **범주**를 제공한 후 **앱 ID 만들기**를 클릭합니다. Facebook 플랫폼 정책을 수용하고 온라인 보안 검사를 완료해야 합니다.
...
7. **사이트 URL** 필드에 [https://login.microsoftonline.com/](https://login.microsoftonline.com/)를 입력한 다음 **변경 내용 저장**을 클릭합니다.
   
    ![Facebook - 사이트 URL](./media/active-directory-b2c-setup-fb-app/fb-site-url.png)
8. **앱 ID**의 값을 복사합니다. **표시**를 클릭하고 **앱 비밀** 값을 복사합니다. 테넌트에서 Facebook을 ID 공급자로 구성하려면 둘 다 필요합니다. **앱 암호** 는 중요한 보안 자격 증명입니다.
