...
Azure AD B2C는 각 사용자 계정에 저장된 특성 집합을 확장합니다. 확장 특성은 디렉터리에서 사용자 개체의 [스키마를 확장](/graph/extensibility-overview#schema-extensions)합니다. 확장 특성은 사용자에 대한 데이터를 포함할 수 있더라도 애플리케이션 개체에만 등록할 수 있습니다. 확장 특성은 b2c-extensions-app이라는 애플리케이션에 연결됩니다. 이 애플리케이션은 사용자 데이터 저장을 위해 Azure AD B2C에서 사용하므로 수정하지 않습니다. 이 애플리케이션은 Azure Active Directory App 등록 아래에서 확인할 수 있습니다.
