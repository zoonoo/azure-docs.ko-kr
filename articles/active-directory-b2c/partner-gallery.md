...
| ISV 파트너 | 설명 및 통합 연습  |
| :--- | :--- |
| ![Arkos Labs 로고의 스크린샷](./media/partner-gallery/arkose-logo.png) | [Arkose Labs](./partner-arkose-labs.md) 는 조직이 봇 공격, 계정 인수 공격 및 사기성 계정 입구를 방지 하는 데 도움이 되는 사기 행위 방지 솔루션 공급자입니다.
...
| ![HYPR 로고의 스크린샷](./media/partner-gallery/hypr-logo.png) | [HYPR](./partner-hypr.md) 는 암호를 공개 키 암호화로 바꿔서 사기 행위, 피싱 및 자격 증명 재사용을 제거 하는 진정한 암호 없는 인증 공급자입니다.|
...
| ![네비스 로고의 스크린샷](./media/partner-gallery/nevis-logo.png) | [네비스](./partner-nevis.md) 는 강력한 고객 인증을 제공 하 고 PSD2 (결제 서비스 지시어 2) 트랜잭션 요구 사항을 준수 하기 위해 네비스 Access 앱과의 모바일 우선, 완전 한 브랜드 최종 사용자 환경을 제공 합니다. |
...
| ![WhoIAM 로고를 보여 주는 스크린샷](./media/partner-gallery/whoiam-logo.png) | [WhoIAM](./partner-whoiam.md) 는 조직이 음성, SMS 및 전자 메일을 기준으로 사용자를 확인할 수 있도록 하는 BRIMS (브랜드 Identity Management System) 응용 프로그램입니다. 
