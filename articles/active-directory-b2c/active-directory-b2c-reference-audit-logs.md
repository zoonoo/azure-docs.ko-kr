...
![Azure Portal의 두 작업 이벤트를 사용 하는 예제 필터](media/active-directory-b2c-reference-audit-logs/audit-logs-example-filter.png)
...
다른 관리 작업 (예: [.net을 사용 하 여 사용자 관리](active-directory-b2c-devquickstarts-graph-dotnet.md))을 자동화할 수 있습니다.
