...
1. **사이트 URL**에 웹 사이트의 주소를 입력 합니다 (예:) `https://contoso.com` . **개인 정보 취급 방침 URL**의 URL(예: `http://www.contoso.com/privacy`)을 입력합니다. 정책 URL은 애플리케이션에 대한 개인 정보를 제공하기 위해 유지 관리하는 페이지입니다.
1. **변경 내용 저장**을 선택합니다.
