...
[자습서: 네이티브 데스크톱 클라이언트에서 사용자 인증](active-directory-b2c-tutorials-desktop-app.md)의 단계와 필수 조건을 완료합니다.
...
![WPF 데스크톱 애플리케이션의 위쪽 창에 표시된 표시 이름](media/active-directory-b2c-tutorials-desktop-app-webapi/desktop-app-01-post-api-call.png)
