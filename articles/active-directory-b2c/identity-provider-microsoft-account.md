...
Azure Active Directory B2C (Azure AD B2C)에서 Microsoft 계정를 [id 공급자로](openid-connect.md) 사용 하려면 Azure AD 테 넌 트에서 응용 프로그램을 만들어야 합니다. Azure AD 테넌트는 Azure AD B2C 테넌트와 다릅니다. Microsoft 계정 아직 없는 경우에서 [https://www.live.com/](https://www.live.com/)가져올 수 있습니다.
