...
| 특성 | 필수 | 설명 |
| --------- | -------- | ----------- |
| Name | 예 | Azure AD B2C에서 지원하는 유효한 프로토콜의 이름입니다. 가능한 값은 다음과 같습니다.  OAuth1, OAuth2, SAML2, OpenIdConnect, WsFed 또는 WsTrust. |
...
![마스크가 포함된 클레임 형식 사용](./media/claimsschema/mask.png)
...
![마스크가 포함된 클레임 형식 사용](./media/claimsschema/mask-regex.png)
...
![드롭다운 city 목록](./media/claimsschema/dropdownsingleselect.png)
...
![pattern이 포함된 클레임 형식 사용](./media/claimsschema/pattern.png)
...
![textbox가 포함된 클레임 형식 사용](./media/claimsschema/textbox.png)
...
![emailbox가 포함된 클레임 형식 사용](./media/claimsschema/emailbox.png)
