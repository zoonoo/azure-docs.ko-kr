...
- Azure AD B2C [사용자 흐름](user-flow-javascript-overview.md) 또는 [사용자 지정 정책](page-layout.md)에서 JavaScript 클라이언트 쪽 코드를 사용할 수 있습니다.
...
![Azure Portal의 사용자 흐름 페이지에서 템플릿 선택 드롭다운](media/customize-ui-overview/template.png)

목록에서 템플릿을 선택합니다. 예를 들어 **Ocean Blue** 템플릿은 다음 레이아웃을 사용자 흐름 페이지에 적용합니다.

![등록 로그인 페이지에서 렌더링 된 대양 Blue 템플릿의 예](media/customize-ui-overview/ocean-blue.png)
