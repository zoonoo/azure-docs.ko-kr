<properties
	pageTitle="Azure Active Directory B2C 미리 보기: 개요 | Microsoft Azure"
...
Azure Active Directory B2C는 미리 보기에 있습니다. 이 시간 동안 작업을 시도할 때 여러분의 의견 및 경험을 듣고자 합니다. 사용자 의견에 기반하여 주요 서비스를 향상시키기 위해 주요 내용을 변경할 수 있습니다. 이 기간 동안 미리 보기를 사용하는 프로덕션 응용 프로그램을 릴리스하면 안 됩니다. [사용자 음성](https://feedback.azure.com/forums/169401-azure-active-directory/)을 사용하여 의견을 보내주세요.
...
[OAuth 2.0](active-directory-b2c-reference-protocols.md#oauth2-authorization-code-flow) 또는 [Open ID 연결](active-directory-b2c-reference-protocols.md#openid-connect-sign-in-flow)을 사용하여 프로토콜 메시지를 직접 보내도록 선택하거나 작업을 수행하는 라이브러리를 사용하여 Azure Active Directory B2C 서비스에 대해 응용 프로그램을 작성할 수 있습니다. 다음 테이블에서 원하는 플랫폼을 선택하고 시작합니다.
...
- Azure Active Directory B2C에서 제공하는 [등록, 로그인 및 다른 소비자용 페이지의 모양과 느낌을 사용자 지정](active-directory-b2c-reference-ui-customization.md)합니다.
