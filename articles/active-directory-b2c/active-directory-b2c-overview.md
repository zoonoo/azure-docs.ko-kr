...
![Azure AD B2C ID 공급자 및 다운스트림 애플리케이션의 인포그래픽](media/active-directory-b2c-overview/azureadb2c-overview.png)
...
![사용자 지정된 가입 및 로그인 페이지 및 배경 이미지](media/active-directory-b2c-overview/sign-in-small.png)
...
![Azure AD B2C에 페더레이션하는 타사 ID의 다이어그램](media/active-directory-b2c-overview/scenario-singlesignon.png)
...
![외부 사용자 저장소와 통신하는 Azure AD B2C의 논리적 다이어그램](media/active-directory-b2c-overview/scenario-remoteprofile.png)
...
![프로그레시브 프로파일링의 시각적 표현](media/active-directory-b2c-overview/scenario-progressive.png)
...
![타사 ID 교정을 위한 사용자 흐름을 보여 주는 다이어그램](media/active-directory-b2c-overview/scenario-idproofing.png)
...
![개별(B2C), 비즈니스(B2C) 및 파트너(B2B) 로그인 페이지](media/active-directory-b2c-overview/woodgrove-overview.png)
...
![Azure AD B2C에서 호스팅하는 사용자 지정 WoodGrove 로그인 페이지](media/active-directory-b2c-overview/sign-in.png)
...
![Azure AD B2C에서 호스팅하는 사용자 지정 WoodGrove 가입 페이지](media/active-directory-b2c-overview/sign-up.png)
...
![사용자가 로그인되어 있음을 보여 주는 WoodGrove Groceries 웹 사이트 헤더](media/active-directory-b2c-overview/signed-in-individual.png)
