...
[GitHub](https://github.com/azure-ad-b2c/samples/tree/master/policies/conditional-access)에서 조건부 액세스 정책의 예를 찾을 수 있습니다.

또한 [사용자 지정 정책에서 조건부 액세스 기술 프로필을 정의](conditional-access-technical-profile.md)하는 방법을 자세히 알아볼 수 있습니다.
