...
| 코드 | 를 사용한 경우 응용 프로그램이 요청한 인증 코드입니다 `response_type=code+id_token` . 응용 프로그램은 권한 부여 코드를 사용 하 여 대상 리소스에 대 한 액세스 토큰을 요청할 수 있습니다. 인증 코드는 일반적으로 약 10 분 후에 만료 됩니다. |
...
| 코드 | 예 | 사용자 흐름의 시작 부분에서 얻은 인증 코드입니다. |
