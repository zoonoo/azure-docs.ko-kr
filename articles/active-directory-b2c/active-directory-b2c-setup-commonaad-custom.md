...
6. **client_id**를 Azure AD 다중 테넌트 앱 등록의 응용 프로그램 ID로 설정합니다.

### <a name="restrict-access"></a>액세스 제한

> [!NOTE]
> **ValidTokenIssuerPrefixes**의 값으로 `https://sts.windows.net`를 사용하면 모든 Azure AD 사용자가 응용 프로그램에 로그인할 수 있습니다.
