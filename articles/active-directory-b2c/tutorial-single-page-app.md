...
1. 등록 워크플로에서 이메일 주소를 사용하여 사용자의 ID를 수집하고 확인하는 페이지를 제공합니다. 또한 가입 워크플로에서도 사용자 흐름에 정의된 사용자의 암호와 요청된 특성을 수집합니다.
    ...
    ![로그인/등록 사용자 흐름에서 제공되는 등록 페이지](./media/tutorial-single-page-app/azure-ad-b2c-sign-up-workflow.png)
...
> [자습서: Azure AD B2C를 사용하여 SPA에서 ASP.NET Core 웹 API에 대한 액세스 권한 부여 >](tutorial-single-page-app-webapi.md)
