...
2. **응용 프로그램 만들기** 창에서 다음을 수행합니다.
    ...
    b. **웹 사이트** 상자에 **https://login.microsoftonline.com**을 붙여넣습니다. 

    c. **콜백 URL** 상자에 **https://login.microsoftonline.com/te/{tenant}.onmicrosoft.com/oauth2/authresp**를 붙여넣습니다. {*tenant*}를 사용자의 테넌트 이름(예: contosob2c.onmicrosoft.com)으로 바꿉니다. HTTPS 체계를 사용 중인지 확인합니다. 
...
[사용자 지정 정책 시작](active-directory-b2c-get-started-custom.md) 연습을 완료한 후에 고유한 사용자 지정 정책 파일을 사용하여 시나리오를 빌드하는 것이 좋습니다. 참조를 위해 [샘플 정책 파일](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack/tree/master/scenarios/aadb2c-ief-setup-twitter-app)을 제공했습니다.
