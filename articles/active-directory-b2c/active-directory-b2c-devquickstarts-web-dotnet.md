...
>[AZURE.NOTE] 또한 Azure AD B2C는 이 자습서에서는 자세히 다루지 않는 통합된 등록 또는 로그인 정책을 지원합니다. 등록 또는 로그인 정책은 [이 해당 자습서](active-directory-b2c-devquickstarts-web-dotnet-susi.md)에 제공됩니다.
...
이 샘플에 대한 코드는 [GitHub에서 유지 관리](https://github.com/AzureADQuickStarts/B2C-WebApp-OpenIdConnect-DotNet)됩니다. 진행하면서 샘플을 빌드하기 위해 [골격 프로젝트를 .zip 파일로 다운로드](https://github.com/AzureADQuickStarts/B2C-WebApp-OpenIdConnect-DotNet/archive/skeleton.zip)할 수 있습니다. 구조를 복제할 수도 있습니다.
