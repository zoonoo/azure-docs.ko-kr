...
3. 정책(예: "B2C_1_SiUp")을 클릭하여 엽니다. 
4. 블레이드 위쪽에서 **편집** 을 클릭합니다.
5. **페이지 UI 사용자 지정**을 클릭합니다.
6. **로컬 계정 등록 페이지**를 클릭합니다.
7. **등록 특성** 섹션의 **이름** 열에 있는 **전자 메일 주소**를 클릭합니다.
8. **확인 필요** 옵션을 **아니요**로 전환합니다.
9. **정책 편집** 블레이드에 도달할 때까지 아래쪽의 **확인**을 클릭합니다.
10. 블레이드 위쪽에서 **저장**을 클릭합니다. 완료되었습니다!
