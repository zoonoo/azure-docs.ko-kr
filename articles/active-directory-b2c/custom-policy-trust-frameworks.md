...
Azure AD B2C 사용자 지정 정책은 ID 환경 프레임워크를 사용하여 다음 질문에 답할 수 있도록 합니다.
...
- **디지털 신원 정보의 생산 및 소비에 대한 기술 정책, 따라서 LOA 및 LOP 측정을위한. 이러한 서면 정책에는 일반적으로 다음과 같은 범주의 정책이 포함됩니다.**
...
- **디지털 ID 정보의 생산 및 소비를 위한 기술 프로필입니다. 이러한 프로필에는 다음이 포함됩니다.**
