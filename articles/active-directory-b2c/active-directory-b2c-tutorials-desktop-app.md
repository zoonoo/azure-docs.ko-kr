...
> * Azure AD B2C 테넌트를 사용하도록 애플리케이션 예제를 구성합니다.
...
등록된 앱은 Azure AD B2C 테넌트에 대한 애플리케이션 목록에 표시됩니다. 목록에서 해당 데스크톱 앱을 선택합니다. 등록된 데스크톱 앱의 속성 창이 표시됩니다.
