...
7. **SSO(Single Sign-On) 세션 관리** - [SSO 세션 관리](custom-policy-reference-sso.md)는 사용자가 이미 인증된 후 사용자에 대한 상호 작용을 제어합니다. 예를 들어 관리자는 ID 공급자의 선택이 표시되는지 여부 또는 로컬 계정 세부 정보를 다시 입력해야 하는지 여부를 제어할 수 있습니다.
