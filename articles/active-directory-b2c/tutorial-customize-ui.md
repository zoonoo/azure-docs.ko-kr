...
1. 로컬 폴더에서 다음 파일을 만들고 `your-storage-account`를 저장소 계정 이름으로 변경하고 `your-container`를 생성된 컨테이너의 이름으로 변경해야 합니다. `https://store1.blob.core.windows.net/b2c/style.css` )을 입력합니다.
