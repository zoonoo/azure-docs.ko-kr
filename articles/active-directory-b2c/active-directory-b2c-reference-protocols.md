...
![OAuth 2.0 역할 4 개를 보여 주는 다이어그램](./media/active-directory-b2c-reference-protocols/protocols_roles.png)
...
전달자는 토큰을 제공할 수 있는 당사자입니다. Azure AD에서 전달자 토큰을 받으려면 먼저 당사자를 인증해야 합니다. 하지만 전송 및 스토리지 시 토큰을 보호하는 데 필요한 단계를 수행하지 않으면 의도하지 않은 당사자가 가로채서 사용할 수 있습니다.
