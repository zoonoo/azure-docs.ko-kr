---
title: Azure Active Directory B2C의 응용 프로그램 유형 | Microsoft Docs
...
<!-- TODO: Need a page for libraries to link to --> 이러한 단계는 빌드 중인 앱의 유형에 따라 약간씩 다를 수 있습니다.
