---
title: 세션 및 Single Sign-On 구성
titleSuffix: Azure AD B2C
description: Azure Active Directory B2C의 세션 및 Single Sign-On (SSO) 구성입니다.
...
ms.locfileid: "74950071"
---
# <a name="session-and-single-sign-on-configuration-in-azure-active-directory-b2c"></a>Azure Active Directory B2C의 세션 및 Single Sign-On 구성
