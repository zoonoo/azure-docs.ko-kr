...
> [AZURE.NOTE]
> 로컬 계정의 경우 Azure AD B2C 등록 정책은 "강력한" 암호(“만료되지 않음"으로 설정됨)를 사용합니다. 다른 설정(현재는 Azure AD B2C에서 사용되지 않음)에 대해서는 [Azure AD 암호 정책](https://msdn.microsoft.com/library/azure/jj943764.aspx)을 참조하세요.
