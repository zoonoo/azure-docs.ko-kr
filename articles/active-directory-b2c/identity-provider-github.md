...
Azure Active Directory B2C (Azure AD B2C)에서 GitHub 계정을 [id 공급자로](authorization-code-flow.md) 사용 하려면 테 넌 트에서 응용 프로그램을 나타내는 응용 프로그램을 만들어야 합니다. 아직 GitHub 계정이 없으면 [https://www.github.com/](https://www.github.com/)에서 등록할 수 있습니다.
...
1. `https://your-tenant-name.b2clogin.com/your-tenant-name.onmicrosoft.com/oauth2/authresp`권한 부여 콜백 URL**에** 를 입력합니다. `your-tenant-name`은 Azure AD B2C 테넌트의 이름으로 바꿉니다. Azure AD B2C에서 테넌트가 대문자로 정의되어 있더라도 테넌트 이름을 입력할 때는 소문자만 사용합니다.
