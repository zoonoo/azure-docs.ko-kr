---
title: "Azure Active Directory B2C: 사용자 인터페이스(UI) 사용자 지정 | Microsoft Docs"
...
### <a name="the-most-basic-html-content-for-testing"></a>테스트를 위한 가장 기본적인 HTML 콘텐츠
...
### <a name="azure-ad-b2c-content-inserted-into-the-local-account-sign-up-page"></a>"로컬 계정 등록 페이지"에 삽입되는 Azure AD B2C 콘텐츠
...
### <a name="azure-ad-b2c-content-inserted-into-the-social-account-sign-up-page"></a>"소셜 계정 등록 페이지"에 삽입되는 Azure AD B2C 콘텐츠
...
### <a name="azure-ad-b2c-content-inserted-into-the-unified-sign-up-or-sign-in-page"></a>"통합 등록 또는 로그인 페이지"에 삽입되는 Azure AD B2C 콘텐츠
...
### <a name="azure-ad-b2c-content-inserted-into-the-multi-factor-authentication-page"></a>"Multi-Factor Authentication 페이지"에 삽입되는 Azure AD B2C 콘텐츠
...
### <a name="azure-ad-b2c-content-inserted-into-the-error-page"></a>"오류 페이지"에 삽입되는 Azure AD B2C 콘텐츠
```HTML
