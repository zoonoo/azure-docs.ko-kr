...
Azure Active Directory B2C (Azure AD B2C)에서 Google 계정을 [id 공급자로](active-directory-b2c-reference-oauth-code.md) 사용 하려면 Google 개발자 콘솔에서 응용 프로그램을 만들어야 합니다. Google 계정이 아직 없는 경우 [https://accounts.google.com/SignUp](https://accounts.google.com/SignUp)에서 등록할 수 있습니다.
