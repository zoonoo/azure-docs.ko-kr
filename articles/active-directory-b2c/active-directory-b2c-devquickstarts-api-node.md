<properties
	...
	description="B2C 테넌트에서 토큰을 수락하는 NodeJS 웹 API를 빌드하는 방법"
...
## 8: Web API에 Passport-Azure-AD 추가
...
## 12: Azure AD 설정을 저장하기 위한 구성 파일 만들기
...
## 20: 서버 응용 프로그램을 다시 실행하고 사용자를 거부하는지 확인
