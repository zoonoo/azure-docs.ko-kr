...
제공 된 [API 코드](https://github.com/azure-ad-b2c/partner-integrations/tree/master/samples/Dynamics-Fraud-Protection/API) 를 Azure 서비스에 배포 합니다. [Visual Studio에서](/visualstudio/deployment/quickstart-deploy-to-azure)코드를 게시할 수 있습니다.
