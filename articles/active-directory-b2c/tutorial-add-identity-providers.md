...
Azure AD B2C의 ID 공급자로 Facebook 계정을 사용하려면 Facebook에서 애플리케이션을 만들어야 합니다. Facebook 계정이 아직 없는 경우에서 [https://www.facebook.com/](https://www.facebook.com/)가져올 수 있습니다.
...
1. **이름을**입력 합니다. 예를 들어 *Contoso Azure AD*를 입력합니다.
