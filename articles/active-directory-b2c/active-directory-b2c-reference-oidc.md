...
| 매개 변수 | Required? | 설명 |
| --- | --- | --- |
| client_id |필수 |[Azure Portal](https://portal.azure.com/) 이 앱에 할당된 응용 프로그램 ID입니다. |
...
| client_secret |필수 |[Azure Portal](https://portal.azure.com/)에서 생성한 응용 프로그램 암호입니다. 이 응용 프로그램 암호는 중요한 보안 아티팩트입니다. 서버에 안전하게 저장해야 합니다. 또한 이 클라이언트 비밀도 정기적으로 회전해야 합니다. |
