---
title: Amazon 계정으로 등록 및 로그인 설정-Azure Active Directory B2C
...
Amazon 계정을 Azure Active Directory B2C (Azure AD B2C)에서 [id 공급자로](active-directory-b2c-reference-oauth-code.md) 사용 하려면 테 넌 트에서 응용 프로그램을 나타내는 응용 프로그램을 만들어야 합니다. Amazon 계정이 아직 없는 경우에서 [https://www.amazon.com/](https://www.amazon.com/)등록할 수 있습니다.
