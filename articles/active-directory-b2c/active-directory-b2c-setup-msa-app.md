...
Azure AD(Azure Active Directory) B2C에서 Microsoft 계정을 ID 공급자로 사용하려면 테넌트에 해당 계정을 나타내는 애플리케이션을 만들어야 합니다. Microsoft 계정이 없는 경우 [https://www.live.com/](https://www.live.com/)에서 얻을 수 있습니다.
...
3. 응용 프로그램의 **이름**을 입력합니다. 예를 들어 *MSAapp1* 등을 입력합니다.
