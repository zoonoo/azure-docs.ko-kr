...
6. **권한이 부여된 리디렉션 URL** 필드에 `https://login.microsoftonline.com/te/{tenant}/oauth2/authresp`을 입력합니다(**OAuth 2.0**). **{테넌트}**를 사용자의 테넌트 이름(예: contoso.onmicrosoft.com)으로 바꿉니다. **추가**를 클릭한 후 **업데이트**를 클릭합니다.
