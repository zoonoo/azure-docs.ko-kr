...
[Microsoft Azure Portal](https://portal.azure.com)에서 데이터를 표시하고 싶은 [Application Insights](app-insights-overview.md) 리소스를 엽니다. (또는 [새 리소스를 만듭니다](app-insights-create-new-resource.md).)
