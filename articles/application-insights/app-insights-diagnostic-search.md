...
![진단 검색 그래프 스크린샷](./media/app-insights-diagnostic-search/002.png)
...
![개별 종속성 요청 스크린샷](./media/app-insights-diagnostic-search/003.png)

종단 간 트랜잭션 세부 정보 보기가 시작됩니다.

![종단 간 트랜잭션 세부 정보 보기 스크린샷입니다.](./media/app-insights-diagnostic-search/004.png)
