...
시작하려면 [Microsoft Azure](https://azure.com)에서 계정을 얻습니다. (사용 항목에 대해서만 부담하며 실험적으로 사용된 일정 시간에 대해서는 요금이 없습니다.)
...
### <a name="run-your-project-and-see-first-results"></a>프로젝트 실행 및 첫 번째 결과 보기
...
## <a name="analytics-out-of-the-box"></a>즉시 분석
...
![더 많은 속성을 보려면 이벤트 목록에서 이벤트를 열고 '...'를 클릭합니다.](./media/app-insights-overview-usage/11-details.png)
