...
* 구성 요소 ID에 대한 세그먼트와 필터를 허용하는 모든 원격 분석에 속성을 추가합니다. 서버 역할 인스턴스가 자동으로 발생되지만 다른 경우에 [원격 분석 이니셜라이저](app-insights-api-filtering-sampling.md#add-properties)를 사용하여 속성을 추가할 수 있습니다.
...
## 추가 Application Insights 리소스 만들기
