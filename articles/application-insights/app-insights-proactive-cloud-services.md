...
![규칙 만들기 스크린샷](./media/app-insights-proactive-cloud-services/001.png)

**규칙 만들기** 창의 **경고 조건 정의** 섹션에서 **기준 추가**를 클릭한 다음, **사용자 지정 로그 검색**을 선택합니다.

![경고에 대한 조건 기준 정의의 스크린샷](./media/app-insights-proactive-cloud-services/002.png)
...
![신호 논리 구성 쿼리의 스크린샷](./media/app-insights-proactive-cloud-services/003.png)

**경고 세부 정보 정의** 섹션에서 경고 규칙에 대한 **이름** 및 **설명**을 입력하고 **심각도**를 설정합니다.
또한 **규칙을 만들면 바로 사용** 단추가 **예**로 설정되어 있는지 확인합니다.

![경고 세부 정보 스크린샷](./media/app-insights-proactive-cloud-services/004.png)

**작업 그룹 정의** 섹션에서 기존 **작업 그룹**을 선택하거나 새로 만들 수 있습니다.
작업 그룹에 다양한 종류의 여러 작업을 포함하도록 선택할 수도 있습니다.

![작업 그룹 스크린샷](./media/app-insights-proactive-cloud-services/005.png)
