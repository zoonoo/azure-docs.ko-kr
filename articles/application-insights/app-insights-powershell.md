---
title: PowerShell을 사용하여 Application Insights 리소스 만들기
...
1. [Azure 리소스 관리자](https://resources.azure.com/)를 엽니다. subscriptions, resourceGroups, components 앱 리소스로 이동합니다.
