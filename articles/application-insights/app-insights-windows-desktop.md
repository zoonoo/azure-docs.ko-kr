...
데스크톱 앱, 백그라운드 서비스 및 작업자 역할을 포함하는 모든 Windows 응용 프로그램은 Application Insights SDK를 사용하여 원격 분석을 Application Insights에 보낼 수 있습니다. 또한 클래스 라이브러리 프로젝트에 Application Insights SDK를 추가할 수 있습니다.
