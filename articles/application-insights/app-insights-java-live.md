<properties 
	pageTitle="이미 라이브 상태인 Java 웹앱용 Application Insights" 
...
> [AZURE.NOTE] 이 페이지의 절차는 런타임에서 웹앱에 SDK를 추가합니다. 이 런타임 계측은 소스 코드를 업데이트하거나 다시 작성하지 않을 경우에 유용합니다. 하지만 가능하면 [소스 코드에 SDK를 추가](app-insights-java-get-started.md)할 것을 권장합니다. 그러면 사용자 활동을 추적하는 코드를 작성하는 등 추가 옵션이 제공됩니다.
