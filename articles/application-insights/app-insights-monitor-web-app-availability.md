...
1. 메트릭 환경에서 Application Insights 리소스를 선택하고, 가용성 메트릭:  ![가용성 메트릭 선택](./media/app-insights-monitor-web-app-availability/selectmetric.png)을 선택합니다.
