...
* 수집 샘플링은 Application Insights 포털에서 받는 원격 분석으로 작동하므로 사용하는 SDK에 관계없이 사용할 수 있습니다. 네트워크에서 원격 분석 트래픽을 감소시키지는 않지만 Application Insights에서 처리 및 저장된 양을 줄여 줍니다. 보존된 원격 분석만 월간 할당량에 계산합니다. 
