...
4. 빨간색 느낌표 옆에서 파란색 텍스트를 선택하여 **환경 작업을 봅니다**.
   ...
   ![환경 작업 보기](.\media\app-insights-continuous-monitoring\002.png)
...
3. 서비스 수준 요구 사항을 충족하도록 가용성 **임계값**을 수정합니다.
   ...
   ![경고 수정](.\media\app-insights-continuous-monitoring\003.png)
...
1. **파이프라인**을 클릭하고 연속 모니터링 게이트가 필요한 단계에 따라 **배포 전 조건** 또는 **배포 후 조건**을 선택합니다.
   ...
   ![배포 전 조건](.\media\app-insights-continuous-monitoring\004.png)
...
![로그](.\media\app-insights-continuous-monitoring\006.png)

## <a name="next-steps"></a>다음 단계

VSTS 빌드 및 릴리스에 대해 자세히 알아보려면 이 [빠른 시작](https://docs.microsoft.com/en-us/vsts/build-release/)을 사용해 보세요.
