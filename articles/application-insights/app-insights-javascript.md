...
[ASP.NET][greenbrown] 또는 [Java][java] 웹 앱에 대해 이미 서버 원격 분석을 설정한 경우 클라이언트와 서버에 대한 정보를 모두 얻을 수 있습니다. 두 스트림은 Application Insights 포털에 통합될 것입니다.
...
* [Java 웹 앱에 Application Insights 추가][java]
