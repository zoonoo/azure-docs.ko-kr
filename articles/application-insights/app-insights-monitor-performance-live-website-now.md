...
# Application Insights를 사용한 런타임 시 웹앱 계측
...
Application Insights를 .NET 웹 응용 프로그램에 적용하는 세 가지 방법이 있습니다.
...
|[시스템 성능 카운터](app-insights-web-monitor-performance.md#system-performance-counters)||Azure 웹앱이 아닌 IIS 또는 Azure 클라우드 서비스의 경우|
...
1. [Azure 포털](https://portal.azure.com)에서 ASP.NET.형식의 Application Insights 리소스를 만듭니다. 이는 응용 프로그램 원격 분석이 저장, 분석 및 표시되는 장소입니다.
...
2. 이제 Azure 웹앱의 컨트롤 블레이드를 열고 **도구 > 성능 모니터링**을 열고 Application Insights 확장을 추가합니다.
    ...
    방금 만든 Application Insights 리소스를 선택합니다.
