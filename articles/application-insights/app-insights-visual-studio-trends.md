...
> [!NOTE]
> Application Insights 추세는 Visual Studio 2015 업데이트 3 이상에서 또는 [개발자 분석 도구 확장](https://visualstudiogallery.msdn.microsoft.com/82367b81-3f97-4de1-bbf1-eaf52ddc635a) 버전 5.209 이상과 함께 사용할 수 있습니다.
> 
> 
...
3. 두 번째 필터를 적용합니다.
4. 원격 분석의 특정 하위 집합에서 추세를 찾기 위해 프로세스를 반복합니다. 예를 들어, "GET Home/Index"라는 서버 요청_과_ 독일에서 제공되고 *그리고* 500 응답 코드를 수신하는 서버 요청입니다.
