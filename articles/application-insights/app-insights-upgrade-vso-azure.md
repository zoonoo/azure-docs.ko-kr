...
4. AppInsightsAgent 폴더 및 해당 폴더에 들어 있는 파일을 삭제합니다.

    ![](./media/app-insights-upgrade-vso-azure/folder.png)

5. ServiceDefinition.csdef 및 ServiceConfiguration.csfg에서 모든 Microsoft.AppInsights 설정 이름 및 값 제거
...
2. 웹 서비스에서 다시 시작합니다.
3. Microsoft Azure 포털에서 [새 Application Insights 리소스를 추가][java]합니다. 개발 컴퓨터에서 [Java SDK][java]를 웹 프로젝트에 추가합니다.
