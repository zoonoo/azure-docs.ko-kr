...
* `PageViews`는 분석하려는 데이터의 형식입니다. 사용 가능한 형식은 연속 내보내기에 설정한 필터에 따라 다릅니다. 내보낸 데이터를 검사하여 사용 가능한 다른 형식을 확인합니다.
...
이제 보고서에서 이 데이터 집합을 사용하고 [Power BI](https://powerbi.microsoft.com)에서 대시보드를 사용할 수 있습니다.
