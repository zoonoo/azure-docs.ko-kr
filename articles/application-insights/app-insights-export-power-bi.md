---
title: Application Insights에서 Power BI로 내보내기
description: 문서
...
> [!TIP]
> Power BI에서 Application Insights 데이터를 확인하기 위해 **이 문서의 나머지 부분에 있는 절차(스트림 분석 사용)를 따르지 않아도 됩니다**. 훨씬 더 쉬운 방법이 있습니다! 대신 [무료 어댑터를 사용](https://powerbi.microsoft.com/documentation/powerbi-content-pack-application-insights/)할 수 있습니다. 해당 어댑터에서 원하는 모든 데이터를 제공하지 않거나, 데이터에 대한 사용자 고유의 집계 또는 함수를 정의하려는 경우에만 이 문서의 나머지 부분을 따르세요.
> 
> 
