...
아직 실행하지 않은 경우 [앱 프로젝트에 Application Insights][platforms]를 추가하고 다시 게시합니다.
...
![충돌 차트에서 경고 규칙 다음에 경고 추가를 클릭합니다.](./media/app-insights-crashes/appinsights-d023-alert.png)
