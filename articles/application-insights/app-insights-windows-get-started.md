...
앱에 서버측이 있으면, [Application Insights](app-insights-overview.md)를 사용하여 [ASP.NET](app-insights-asp-net.md) 또는 [J2EE](app-insights-java-get-started.md)에서 앱의 웹 서버측을 모니터링합니다. 양측의 이벤트에 상관 관계를 지정할 수 있도록 하려면 동일한 Application Insights 리소스에 원격 분석을 보냅니다.

Application Insights 포털에 원격 분석을 보내는 [C++ 유니버설 앱용 Application Insights SDK](https://github.com/Microsoft/ApplicationInsights-CPP)도 있습니다.
