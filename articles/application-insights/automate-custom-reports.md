...
7. **함수 앱** > **플랫폼 기능** > **응용 프로그램 설정**을 선택합니다.
    ...
    ![Azure 함수 응용 프로그램 설정 스크린샷](./media/automate-custom-reports/function-app-07.png)

8. 적절한 해당 값 ``AI_APP_ID``, ``AI_APP_KEY`` 및 ``SendGridAPI``로 3개의 새 응용 프로그램 설정을 만듭니다. **저장**을 선택합니다.
