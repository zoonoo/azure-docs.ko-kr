---
title: '코드 샘플: Application Insights에서 내보낸 데이터 구문 분석'
...
1. 해당 앱 유형의 SDK를 설정하는 방법을 찾으려면 빠른 시작을 엽니다.
...
2. 이 예제에서는 웹앱을 모니터링하므로 Visual Studio에서 Azure 도구를 사용하여 SDK를 설치할 수 있습니다. 여기에 Application Insights 리소스의 이름을 알려줍니다.
