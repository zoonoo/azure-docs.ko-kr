...
* 사용자 지정 속성 및 메트릭을 포함하여 필드를 기준으로 원시 앱 원격 분석을 [필터링](app-insights-analytics-queries.md)합니다.
* 다중 테이블 [조인](app-insights-analytics-queries.md#join-operator) - 요청을 페이지 뷰, 종속성 호출, 예외 및 로그 추적과 상호 연결합니다.
* 유용한 통계 [집계](app-insights-analytics-aggregations.md) 기능이 있습니다.
