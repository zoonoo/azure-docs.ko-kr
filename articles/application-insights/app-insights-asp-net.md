...
*SDK 설치만*을 선택하지 않은 경우 Application Insights 웹 포털에서 원격 분석을 확인할 수 있습니다.
...
* **검색**(1)에 개별 이벤트가 표시됩니다. 데이터는 여기(및 라이브 스트림)에서 처음으로 표시됩니다. 이벤트를 클릭하여 속성을 확인합니다. 
...
원하는 경우 [이러한 단계를 수동으로 수행](app-insights-asp-net-manual.md)할 수 있습니다.
...
| | 
|---|---
|**[Visual Studio에서 Application Insights로 작업](app-insights-visual-studio.md)**<br/>원격 진단, 분석 검색을 디버깅하여 코드에 드릴스루합니다.|![Visual studio](./media/app-insights-asp-net/61.png)
