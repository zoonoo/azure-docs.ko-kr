...
|[Custom Vision Service](https://docs.microsoft.com/azure/cognitive-services/Custom-Vision-Service/home "Custom Vision Service")(미리 보기)|Custom Vision Service를 사용하면 사용자 지정 이미지 분류자를 빌드할 수 있습니다.|
...
|[Emotion API](https://docs.microsoft.com/azure/cognitive-services/emotion/home "Emotion API")(미리 보기)|Emotion API는 이미지를 입력으로 사용하고, 이미지에 있는 각 얼굴의 감정 집합에 대한 신뢰도를 반환합니다.|
...
|[Web Language Model](https://docs.microsoft.com/azure/cognitive-services/web-language-model/home "Web Language Model")(미리 보기)|단어 순서, 완료 및 공백 없는 문자열의 단어 분리 예측을 위한 자연어 처리를 제공합니다.|
...
## <a name="knowledge-apis"></a>Knowledge API

|서비스 이름|서비스 설명|
|:-----------|:------------------|
| [Custom Decision Service](https://docs.microsoft.com/azure/cognitive-services/custom-decision-service/ "Custom Decision Search")(미리 보기)|Custom Decision Service를 통해 사용자 환경을 개인별로 설정하고 최적화하기 위한 상황에 따른 의사 결정을 지원하는 지능형 시스템을 만들 수 있습니다.|
...
Microsoft 계정으로 로그인하면 [내 구독](https://www.microsoft.com/cognitive-services/en-us/subscriptions "내 구독")에 액세스하여 사용하는 제품, 나머지 할당량 및 구독에 추가 제품을 추가하는 기능을 보여줄 수 있습니다.

## <a name="upgrade-to-unlock-limits"></a>제한을 해제하려면 업그레이드

모든 API에는 평가판 요금제가 있습니다.  유료 제안이 각 API에 대해 사용할 수 있게 됐으므로 구매를 완료하려면 Azure Portal로 이동됩니다.  이미 사용하고 있는 경우 구독 페이지에서 *구입* 링크를 찾을 수 있습니다. 또는 평가판을 건너뛰고 [가격 책정](https://www.microsoft.com/cognitive-services/en-us/pricing "가격 책정")에서 제공된 링크로 구매할 수 있습니다.  신용 카드 및 전화번호로 Azure 구독자 계정을 설정해야 합니다. 특별한 요구 사항이 있거나 단지 판매에 관해 상담하려는 경우 가격 책정 페이지 상단에 있는 “문의” 단추를 클릭하세요.
