...
|코드 | 언어 | 코드 | 언어 |
|-----|-----|-----|-----|
| ar 예 | 아랍어(이집트), 현대 표준 | hi-IN | 힌디어 (인도) |
| ca-ES | 카탈로니아어 | it-IT | 이탈리아어(이탈리아)  |
| da-DK | 덴마크어(덴마크) | ja-JP | 일본어 (일본) |
| de-DE | 독일어 (독일) |ko-KR | 한국어 (대한민국) |
| en-AU | 영어(오스트레일리아) |nb-NO | 노르웨이어(복말)(노르웨이)  |
| en-CA | 영어(캐나다) | nl-NL | 네덜란드어(네덜란드)   |
| en-GB | English (United Kingdom) |pl-PL | 폴란드어(폴란드) |
| en-IN | 영어(인도) | pt-BR | 포르투갈어(브라질)  |
| en-NZ | 영어(뉴질랜드) |pt-PT | 포르투갈어(포르투갈)  |
| ko-KR | 영어 (미국) | ru-RU | 러시아어(러시아) |
...
| 코드 | 언어 | 코드 | 언어 |
|-----|-----|-----|-----|
| ar 예 | 아랍어(이집트), 현대 표준 | It-IT | 이탈리아어(이탈리아) |
