...
description: 리소스를 보다 효율적으로 관리 하기 위해 QnA Maker 서비스를 공유 하거나 업그레이드 합니다.
...
ms.locfileid: "69640477"
---
# <a name="share-or-upgrade-your-qna-maker-service"></a>QnA Maker 서비스 공유 또는 업그레이드
리소스를 보다 효율적으로 관리 하기 위해 QnA Maker 서비스를 공유 하거나 업그레이드 합니다. 
...
QnA Maker는 여러 Azure 리소스를 만듭니다. 관리를 줄이고 비용 공유를 활용 하기 위해 다음 표를 사용 하 여 공유할 수 있는 항목과 공유할 수 없는 항목을 이해 합니다.
...
App Service를 [확장](https://docs.microsoft.com/azure/app-service/manage-scale-up)하거나 축소할 수 있습니다.
