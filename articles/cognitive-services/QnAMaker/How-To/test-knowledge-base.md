...
2.  테스트 슬라이드 아웃 패널에 액세스하려면 응용 프로그램의 위쪽 패널에서 **테스트**를 선택합니다.
    ...
    ![액세스 테스트](../media/qnamaker-how-to-test-kb/access-test.png)
...
![액세스 테스트](../media/qnamaker-how-to-test-kb/choose-answer.png)
...
![액세스 테스트](../media/qnamaker-how-to-test-kb/add-alternate-question.png)
...
![액세스 테스트](../media/qnamaker-how-to-test-kb/add-answer.png)
