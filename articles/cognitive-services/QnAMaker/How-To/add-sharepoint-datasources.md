...
SharePoint 사이트에서 QnA Maker 지원 되는 모든 [파일 형식을](../Concepts/data-sources-supported.md) 기술 자료에 추가할 수 있습니다. 파일 리소스를 안전 하 게 보호 하는 경우 [사용 권한을](#permissions) 부여 해야 할 수 있습니다.
