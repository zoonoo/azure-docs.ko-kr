---
title: '빠른 시작: C# 업데이트 기술 자료 - QnA Maker'
titleSuffix: Azure Cognitive Services
description: QnA Maker용 C#으로 기술 자료를 업데이트하는 방법입니다.
...
ms.locfileid: "47035830"
---
# <a name="update-a-knowledge-base-in-c"></a>C#으로 기술 자료 업데이트
...
1. 즐겨찾는 IDE에서 .NET Framework C# 콘솔 응용 프로그램을 새로 만듭니다.
1. 아래 제공된 코드를 추가합니다.
...
기술 자료가 업데이트되면 QnA Maker 포털의 [내 기술 자료](https://www.qnamaker.ai/Home/MyServices) 페이지에서 볼 수 있습니다. 기술 자료 이름이 변경된 것에 유의하세요. 예를 들어 QnA Maker FAQ(또는 기존 기술 자료 이름)가 이제는 New KB Name입니다.

기술 자료의 다른 요소를 수정하려면 QnA Maker [JSON 스키마](https://westus.dev.cognitive.microsoft.com/docs/services/5a93fcf85b4ccd136866eb37/operations/5ac266295b4ccd1554da7600)를 참조하여 `new_kb` 문자열을 수정합니다.
