...
Visual Studio 및 Python에 대한 자세한 도움말은 [Windows 기반의 Visual Studio에서 Python 사용](https://docs.microsoft.com/visualstudio/python/overview-of-python-tools-for-visual-studio)을 참조하세요.
