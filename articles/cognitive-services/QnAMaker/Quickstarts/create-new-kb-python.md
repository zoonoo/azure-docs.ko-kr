---
title: Microsoft QnA Maker API(V4)용 기술 자료(빠른 시작 Python) – 새로 만들기 - Azure Cognitive Services | Microsoft Docs
description: QnA Maker를 시작할 수 있도록 Python으로 기술 자료를 만들어서 FAQ나 제품 설명서를 보관합니다.
