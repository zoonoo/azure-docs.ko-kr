...
---
# <a name="quickstart-create-a-knowledge-base-in-qna-maker-using-c-with-rest"></a>빠른 시작: REST를 사용 하 여 C# QnA Maker에서 기술 자료 만들기
...
* [KB 만들기](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker/knowledgebase/create)
...
콘솔 창(예: cmd, PowerShell 또는 Bash)에서 `dotnet new` 명령을 사용하여 `qna-maker-quickstart`라는 새 콘솔 앱을 만듭니다. 이 명령은 단일 소스 파일 ( *Program.cs*) C# 을 사용 하 여 간단한 "Hello World" 프로젝트를 만듭니다.
