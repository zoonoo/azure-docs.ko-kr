---
title: 기술 자료, Java 빠른 시작 업데이트 - Azure Cognitive Services | Microsoft Docs
...
1. [apache httpclient](http://hc.apache.org/downloads.cgi) 라이브러리가 필요합니다. 예를 들어, 바이너리 HttpClient 4.x.x.tar.gz를 다운로드하여 프로젝트로 가져오는 데 필요한 모든 jar 파일을 찾습니다.
