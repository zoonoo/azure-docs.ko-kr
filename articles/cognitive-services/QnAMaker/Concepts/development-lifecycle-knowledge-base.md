...
많은 기술 자료를 사용 하 여 자동화 된 테스트를 [generateAnswer API](../how-to/metadata-generateanswer-usage.md#get-answer-predictions-with-the-generateanswer-api) 하며 `isTest=true` 쿼리 문자열 매개 변수는 쿼리는 `test` 대신 하 여 게시 된 기술 자료입니다. 
