...
활성 학습은 QnA Maker에서 반환 하는 가장 많은 답변의 점수를 기준으로 트리거됩니다. 쿼리와 일치 하는 QnA 집합 간의 점수 차이가 작은 범위 내에 있는 경우 쿼리는 가능한 각 QnA 쌍에 대 한 가능한 제안 (대체 질문)으로 간주 됩니다. 특정 QnA 쌍에 대해 제안 된 질문을 수락한 후에는 다른 쌍에 대해 거부 됩니다. 제안을 수락한 후 저장 하 고 학습 해야 합니다.
