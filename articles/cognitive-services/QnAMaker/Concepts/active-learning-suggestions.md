...
description: 활성 학습 제안을 사용하면 사용자가 제출한 정보에 따라 질문과 대답 쌍에 대체 질문을 제안하여 기술 자료 품질을 개선할 수 있습니다.
...
기본적으로 활성 학습이 **해제** 되어 있습니다.
활성 학습을 사용하려면 다음을 수행합니다.
* QnA Maker에서 기술 자료에 대한 대체 질문을 수집하려면 [활성 학습을 설정](../How-To/use-active-learning.md#turn-on-active-learning-for-alternate-questions)해야 합니다.
* 제안된 대체 질문을 보려면 편집 페이지의 [보기 옵션을 사용](../How-To/improve-knowledge-base.md#view-suggested-questions)합니다.
...
QnA Maker의 암시적 피드백은 알고리즘을 사용하여 근접 점수를 결정한 후 활성 학습 제안을 만듭니다. 점수 범위를 결정하는 알고리즘은 단순한 계산이 아닙니다. 다음 예의 범위는 고정된 범위가 아니며, 알고리즘의 영향을 파악하기 위한 참조 범위로만 사용해야 합니다.
