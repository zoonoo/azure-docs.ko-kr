...
학습 및 [게시](../quickstarts/create-publish-knowledge-base.md#publish-the-knowledge-base) 된 QnA Maker 기술 자료는 [generateanswer API](../how-to/metadata-generateanswer-usage.md)에서 봇 또는 다른 클라이언트 응용 프로그램의 사용자 쿼리를 수신 합니다. 다음 다이어그램에서는 사용자 쿼리를 수신 하는 프로세스를 보여 줍니다.
