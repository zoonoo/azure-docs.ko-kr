---
title: Chat bot에 LUIS과 함께 NLP 사용
description: Language Understanding를 사용 하는 시기 및 QnA Maker를 사용 하는 시기와 사용 시기를 알아봅니다.
...
* [Azure 리소스를 관리 하는 방법](How-To/set-up-qnamaker-service-azure.md) 알아보기