...
* [XLS 파일 형식](concepts/data-sources-supported.md)을 사용하여 가져오기 및 내보내기 

### <a name="june-2019"></a>2019년 6월

* 프랑스어, 이탈리아어, 독일어, 스페인어, 포르투갈어용 [순위지정(ranker) 모델](concepts/knowledge-base.md#ranker-process)이 향상됨
...
* 영어에 대한 향상된 NLP(자연어 처리) [우선순위(ranker)](concepts/knowledge-base.md#ranker-process) 모델 
