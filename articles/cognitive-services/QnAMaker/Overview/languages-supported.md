---
title: 지원되는 언어 - QnA Maker - Azure Cognitive Services | Microsoft Docs
description: QnA Maker에서 지원되는 언어를 알아봅니다.
...
QnA Maker는 결과를 제공할 때 Azure의 [언어 분석기](https://docs.microsoft.com/en-us/rest/api/searchservice/language-support)에 의존합니다. 특수한 순위 재지정 기능은 더 나은 관련성을 제공하는 En-* 언어에서 사용할 수 있습니다.
