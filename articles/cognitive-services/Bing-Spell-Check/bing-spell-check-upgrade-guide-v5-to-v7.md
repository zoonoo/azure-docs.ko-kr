...
ms.locfileid: "35372831"
---
# <a name="spell-check-api-upgrade-guide"></a>Spell Check API 업그레이드 가이드

이 업그레이드 가이드는 Bing Spell Check API의 버전 5와 버전 7 사이의 변경 내용을 식별합니다. 이 가이드를 사용하면 버전 7을 사용하도록 업데이트해야 하는 응용 프로그램의 부분을 식별하는 데 유용합니다.

## <a name="breaking-changes"></a>주요 변경 내용

### <a name="endpoints"></a>Endpoints

- 엔드포인트의 버전 번호가 v5에서 v7로 변경되었습니다. 예: https://api.cognitive.microsoft.com/bing/\*\*v7.0**/맞춤법 검사.
