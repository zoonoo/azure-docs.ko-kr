...
description: 단일 페이지 웹 응용 프로그램에서 Bing Spell Check API를 사용하는 방법을 보여 주는 자습서의 소스 코드입니다.
...
ms.locfileid: "35372727"
---
# <a name="tutorial-single-page-web-app"></a>자습서: 단일 페이지 웹앱

Bing Spell Check API에 대한 [단일 페이지 앱 자습서](spellcheck.md)에서 설명하는 전체 소스 코드입니다. 앱을 실행하려면 소스 코드를 텍스트 편집기에 복사하고 `spellcheck.html` 파일로 저장합니다. 그런 다음, 웹 브라우저에서 저장된 파일을 엽니다.
