---
title: '빠른 시작: 텍스트 스크립트 변환, Node.js - Translator Text API'
...
ms.locfileid: "49646199"
---
# <a name="quickstart-transliterate-text-with-the-translator-text-rest-api-nodejs"></a>빠른 시작: Translator Text REST API(Node.js)로 텍스트 음역
