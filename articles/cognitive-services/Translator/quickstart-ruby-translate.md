---
title: Translator Text Ruby를 사용하여 텍스트 번역 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 이 빠른 시작에서는 Cognitive Services에서 Ruby와 함께 Translator Text API를 사용하여 텍스트를 한 언어에서 다른 언어로 번역합니다.
...
ms.locfileid: "43750495"
---
# <a name="quickstart-translate-text-with-ruby"></a>빠른 시작: Ruby를 사용하여 텍스트 번역
