---
title: '자습서: C# - Translator Text API로 WPF 애플리케이션 만들기'
...
ms.locfileid: "55476505"
---
# <a name="tutorial-write-a-wpf-application-for-translator-text-using-c35"></a>자습서: C&#35;을 사용하여 Translator Text에 대한 WPF 애플리케이션 작성
