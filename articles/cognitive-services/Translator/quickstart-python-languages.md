---
title: '빠른 시작: 지원되는 언어 가져오기, Python - Translator Text API'
...
ms.locfileid: "49644728"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-python"></a>빠른 시작: Translator Text REST API(Python)로 지원되는 언어 가져오기
