---
title: '빠른 시작: 지원되는 언어 가져오기 - Translator Text, Python'
...
ms.locfileid: "46121739"
---
# <a name="quickstart-get-supported-languages-with-python"></a>빠른 시작: Python을 사용하여 지원되는 언어 가져오기
