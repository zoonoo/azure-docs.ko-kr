---
title: '빠른 시작: 텍스트 언어 감지, Java - Translator Text API'
...
이 빠른 시작에서는 Java 및 Translator Text REST API를 사용하여 제공된 텍스트의 언어를 검색하는 방법을 알아봅니다.
