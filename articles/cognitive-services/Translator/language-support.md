...
| 및 | `zh-Hans` | 중국어 간체 `Hans`| <--> | 라틴어 `Latn` |
| 및 | `zh-Hans` | 중국어 간체 `Hans`| <--> | 중국어 번체 `Hant`|
| 옵션 대신, | `zh-Hant` | 중국어 번체 `Hant`| <--> | 라틴어 `Latn` |
| 옵션 대신, | `zh-Hant` | 중국어 번체 `Hant`| <--> | 중국어 간체 `Hans` |
