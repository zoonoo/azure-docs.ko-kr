...
<table width="100%">
  ...
  <tr>
    <td>카테고리</td>
    <td>*선택적 매개 변수*입니다.<br/>번역의 범주(도메인)를 지정하는 문자열입니다. 이 매개 변수를 사용하여 [Custom Translator](../customization.md)로 작성된 사용자 지정 시스템의 번역을 가져옵니다. 기본값은 `general`입니다.</td>
  </tr>
  <tr>
