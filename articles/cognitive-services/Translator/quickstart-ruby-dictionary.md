---
title: '빠른 시작: 이중 언어 사전이 있는 단어 조회, Ruby - Translator Text API'
...
ms.locfileid: "55461154"
---
# <a name="quickstart-look-up-words-with-bilingual-dictionary-using-ruby"></a>빠른 시작: Ruby를 사용하여 이중 언어 사전이 있는 단어 조회
