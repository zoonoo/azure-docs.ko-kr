---
title: Translator Text Ruby를 사용하여 대체 번역 찾기 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 이 빠른 시작에서는 Cognitive Services에서 Ruby와 함께 Translator Text API를 사용하여 컨텍스트의 용어를 대체하는 번역과 예제를 찾아봅니다.
...
ms.locfileid: "43750476"
---
# <a name="quickstart-find-alternate-translations-and-usage-with-ruby"></a>빠른 시작: Ruby를 사용하여 대체 번역 및 사용법 찾기
