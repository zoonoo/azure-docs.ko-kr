---
title: '빠른 시작: 대체 번역 찾기, Ruby - Translator Text API'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작에서는 Ruby와 함께 Translator Text API를 사용하여 컨텍스트의 용어를 대체하는 번역과 예제를 찾아봅니다.
...
ms.locfileid: "49649621"
---
# <a name="quickstart-find-alternate-translations-with-the-translator-text-rest-api-ruby"></a>빠른 시작: Translator Text REST API(Ruby)로 대체 번역 찾기
