...
ms.locfileid: "49647207"
---
# <a name="quickstart-identify-language-from-text-with-the-translator-text-rest-api-go"></a>빠른 시작: Translator Text REST API(Go)로 텍스트의 언어 식별
