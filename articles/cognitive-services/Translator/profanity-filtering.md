---
title: 욕설 필터링 - Translator
titleSuffix: Azure Cognitive Services
description: 욕설 필터링을 사용하여 Azure Cognitive Services Translator에서 텍스트로 번역되는 욕설 수준을 확인합니다.
...
---
# <a name="add-profanity-filtering-with-the-translator"></a>Translator에서 욕설 필터링 추가
...
| Marked | 욕설 단어가 XML 태그 \<profanity> ... \</profanity>로 묶여 있습니다. | 彼は変態です。 | He is a \<profanity>jerk\</profanity>. |
| 삭제됨 | 욕설 단어가 바뀌지 않고 출력에서 제거됩니다. | 彼は。 | He is a. |

## <a name="next-steps"></a>다음 단계
> [!div class="nextstepaction"]
> [Translator 호출을 사용하여 욕설 필터링 적용](reference/v3-0-translate.md)
