...
- 구 사전은 제품 이름 ("Microsoft SQL Server"), 적절 한 이름 ("City of 함부르크") 또는 제품의 기능 ("피벗 테이블")과 같은 복합 명사에 대해 잘 작동 합니다. 동사 또는 형용사는 일반적으로 원본 또는 대상 언어에서 크게 굴절되기 때문에 동일하게 작동하지는 않습니다. 모범 사례는 복합 명사를 제외한 모든 항목에 대 한 구 사전 항목을 방지 하는 것입니다.
