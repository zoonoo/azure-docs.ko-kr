...
Custom Translator는 36개가 넘는 언어를 지원하며, NMT에 제공되는 언어에 직접 매핑됩니다. 전체 목록은 [Microsoft Translator 언어]( https://docs.microsoft.com/azure/cognitive-services/translator/language-support)를 참조하세요.
