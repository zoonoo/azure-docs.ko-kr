...
description: 이 문서에서는 Custom Translator 서비스의 프로젝트 범주 및 레이블뿐만 아니라 작업 영역과 프로젝트의 차이점에 대해 설명합니다.
