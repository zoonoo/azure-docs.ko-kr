...
| **단어 또는 구**       | **정의**                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 원본 언어          | 원본 언어는로 시작 하는 언어 이며 다른 언어 ("대상")로 변환 하려고 합니다.                                                                                                                                                                                                                                                                                                                                                         |
...
| 테스팅 파일            | 이러한 파일은 종종 학습 세트에서 임의로 선택된 파일에서 파생됩니다(테스트 세트를 선택하지 않은 경우). 이러한 문장의 목적은 변환 모델의 정확도를 평가 하는 것입니다. 이러한 문장은 시스템이 정확하게 번역하길 원하는 문장입니다. 따라서 테스트 집합을 만들어 변환기에 업로드 하 여 이러한 문장이 시스템의 평가에서 사용 되도록 할 수 있습니다 (BLEU 점수 생성).   |
...
| BLEU 점수               | [BLEU](what-is-bleu-score.md) 는 변환 모델의 "전체 자릿수" 또는 정확도를 평가 하는 업계 표준 방법입니다. 다른 평가 방법도 존재하지만 Microsoft Translator는 BLEU 방법을 사용하여 프로젝트 소유자에게 정확도를 보고합니다.
