...
> [!Note]
> 학습에 성공 하려면 사용자 지정 변환기에 1만의 고유 하 고 압축을 푼 문장이 필요 합니다. 사용자 지정 번역기는 [제안 된 최소값](sentence-alignment.md#suggested-minimum-number-of-extracted-and-aligned-sentences)보다 작은 학습을 수행할 수 없습니다.
