...
배포된 시스템은 CategoryID를 지정하여 Microsoft Translator Text API V3을 통해 액세스할 수 있습니다. Translator Text API에 대한 자세한 정보는 [API 참조](../reference/v3-0-reference.md) 웹 페이지에서 확인할 수 있습니다.
