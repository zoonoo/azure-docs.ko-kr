...
description: Bing Entity Search SDK 콘솔 애플리케이션을 설치합니다.
...
ms.locfileid: "55149275"
---
# <a name="quickstart-bing-entity-search-sdk-with-java"></a>빠른 시작: Java를 사용하는 Bing Entity Search SDK
