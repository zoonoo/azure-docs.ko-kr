...
- API 수준 22 이상이 포함된 [Android Studio](https://developer.android.com/studio/).
...
이 자습서에서는 Face Java SDK를 사용하여 이미지에서 얼굴을 감지하고 프레임화하는 애플리케이션을 만드는 방법을 알아보았습니다. 다음으로, 얼굴 감지에 대해 자세히 알아보세요.
