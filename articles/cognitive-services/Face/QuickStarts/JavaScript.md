---
title: '빠른 시작: 이미지에서 얼굴 감지 - Face API, JavaScript'
...
ms.locfileid: "49340191"
---
# <a name="quickstart-detect-faces-in-an-image-using-javascript"></a>빠른 시작: JavaScript를 사용하여 이미지에서 얼굴 감지
