...
이 가이드에서는 얼굴 개체의 사각형을 회전하기 위해 감지된 얼굴 특성 HeadPose를 사용합니다. 이 가이드에서 샘플 코드인 [Cognitive Services Face WPF](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/app-samples/Cognitive-Services-Face-WPF) 샘플 앱에서는 .NET SDK를 사용합니다.
...
회전된 얼굴 사각형의 작업 예제는 GitHub의 [Cognitive Services Face WPF](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/app-samples/Cognitive-Services-Face-WPF) 앱을 참조합니다. 또는 [Face API HeadPose 샘플](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/tree/master/app-samples) 앱을 참조할 수 있는데 이는 다양한 머리 움직임(고개 끄덕이기, 흔들기)을 감지하기 위해 실시간으로 HeadPose 특성을 추적하는 앱입니다.
