---
title: Face API를 사용하여 이미지에서 얼굴 식별 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Cognitive Services의 Face API를 사용하여 이미지의 얼굴을 식별할 수 있습니다.
...
---
# <a name="how-to-identify-faces-in-images"></a>이미지에서 얼굴을 식별하는 방법
...
## <a name="step1"></a> 1단계: API 호출 권한 부여
...
## <a name="step2"></a> 2단계: PersonGroup 만들기
...
### <a name="step2-1"></a> 2.1는 PersonGroup에 대한 사람 정의
...
## <a name="step3"></a> 3단계: PersonGroup 학습
...
## <a name="step4"></a> 4단계: 정의된 PersonGroup에 대해 얼굴 식별
