---
title: Face API에서 대규모 기능 사용 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Cognitive Services의 Face API에서 대규모 기능을 사용합니다.
...
---
# <a name="how-to-use-the-large-scale-feature"></a>대규모 기능을 사용하는 방법
...
Microsoft Face API는 최근 대규모 작업으로 통칭되는 대규모 시나리오, LargePersonGroup 및 LargeFaceList를 활성화하는 두 개의 기능을 릴리스했습니다.
...
## <a name="initialization"></a>1단계: API 호출 권한 부여
...
## <a name="migrate"></a> 2단계: 작업에서 코드 마이그레이션
...
## <a name="largepersongroup"></a> 2.1단계: LargePersonGroup으로 PersonGroup 마이그레이션
...
## <a name="largefacelist"></a> 2.2단계: LargeFaceList로 FaceList 마이그레이션
...
## <a name="interval"></a>3.1단계: 시간 간격 사용자 지정
...
## <a name="standalone"></a>3.3단계: 독립 실행형 학습
...
`System.Timers`에서 [`Timer`](https://msdn.microsoft.com/library/system.timers.timer(v=vs.110).aspx) 클래스를 호출하여 LargePersonGroup에 대한 독립 실행형 학습의 일반적인 구현은 다음과 같습니다.
