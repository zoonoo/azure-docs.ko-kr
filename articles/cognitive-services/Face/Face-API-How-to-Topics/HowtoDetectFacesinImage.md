---
title: Face API를 사용하여 이미지에서 얼굴 감지 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: Cognitive Services의 Face API를 사용하여 이미지에서 얼굴을 감지합니다.
...
ms.locfileid: "35373199"
---
# <a name="how-to-detect-faces-in-image"></a>이미지에서 얼굴을 감지하는 방법
...
## <a name="step1"></a>1 단계: API 호출 권한 부여
...
## <a name="step2"></a> 2단계: 서비스에 이미지를 업로드하고 얼굴 감지를 실행
...
## <a name="step3"></a> 3단계: 얼굴 이정표에 대한 이해 및 사용
...
## <a name="step4"></a> 4단계: 다른 얼굴 특성 사용
