...
* **머리 포즈** 3D 공간에서의 얼굴의 방향입니다. 피치, 롤 및 요 각도로 설명합니다. 값 범위는 각각 [-90, 90] [-180, 180] 및 [-90, 90] 입니다. 각도 매핑은 다음 다이어그램을 참조하세요.
