...
Custom Decision Service는 콘텐츠 개인 설정 도메인에 없는 응용 프로그램에 사용할 수 있습니다. 이러한 응용 프로그램은 사용자 지정 미리 보기에 잘 맞을 수도 있습니다. 자세한 내용을 알아보려면 [문의](https://azure.microsoft.com/overview/sales-number/)하세요.
...
* **보상**: 사용자가 렌더링된 콘텐츠에 응답하는 방식에 대한 측정값입니다. Custom Decision Service는 클릭을 사용하여 사용자 응답을 측정합니다. 클릭은 응용 프로그램에 삽입된 사용자 지정 코드를 사용하여 시스템에 보고됩니다.
