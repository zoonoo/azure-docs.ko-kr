...
대화형 경험을 제공하려면 사용자가 입력한 각 문자 뒤에서 이 메서드를 반복적으로 호출하면 됩니다. 이 경우 **complete** 매개 변수를 1로 설정하여 자동 완성 제안을 사용해야 합니다. 응용 프로그램에 자동 완성이 필요 없는 경우 **complete** 매개 변수를 0으로 설정해야 합니다.
