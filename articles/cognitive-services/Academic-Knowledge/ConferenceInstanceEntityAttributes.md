...
CISD    |컨퍼런스 인스턴스의 시작 날짜  |날짜       |Equals,<br/>IsBetween
CIED    |컨퍼런스 인스턴스의 종료 날짜    |날짜       |Equals,<br/>IsBetween
CIARD   |컨퍼런스 인스턴스의 요약 등록 기한  |날짜       |Equals,<br/>IsBetween
CISDD   |컨퍼런스 인스턴스의 제출 기한     |날짜       |Equals,<br/>IsBetween
CIFVD   |컨퍼런스 인스턴스의 최종 버전 기한  |날짜       |Equals,<br/>IsBetween
CINDD   |컨퍼런스 인스턴스의 알림 날짜   |날짜       |Equals,<br/>IsBetween
CD.T    |컨퍼런스 인스턴스 이벤트의 제목   |날짜       |Equals,<br/>IsBetween
CD.D    |컨퍼런스 인스턴스 이벤트의 날짜    |날짜       |Equals,<br/>IsBetween
