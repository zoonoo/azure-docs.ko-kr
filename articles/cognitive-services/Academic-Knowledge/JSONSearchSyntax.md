---
title: Academic Knowledge API의 JSON 검색 구문 | Microsoft Docs
description: Microsoft Cognitive Services의 Academic Knowledge API에서 사용할 수 있는 JSON 검색 구문에 대해 알아봅니다.
