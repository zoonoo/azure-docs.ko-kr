...
ms.locfileid: "71803875"
---
# <a name="quickstart-synthesize-speech-in-java-on-android-by-using-the-speech-sdk"></a>빠른 시작: Speech SDK를 사용하여 Android의 Java에서 음성 합성

빠른 시작은 [음성 인식](quickstart-java-android.md) 및 [음성 우선 가상 도우미](quickstart-virtual-assistant-java-android.md)에도 사용할 수 있습니다.

이 문서에서는 Cognitive Services Speech SDK를 사용하여 음성을 텍스트로 합성하는 Android용 Java 애플리케이션을 개발하는 방법을 설명합니다.
애플리케이션은 Speech SDK Maven 패키지 버전 1.7.0 및 Android Studio 3.3을 기반으로 합니다.
...
![Android 애플리케이션 스크린샷](media/sdk/qs-java-android-13-2-gui-on-device-tts.png)
