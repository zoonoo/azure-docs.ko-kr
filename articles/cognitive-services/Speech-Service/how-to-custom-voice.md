...
Custom Speech 포털을 사용 하 여 사용자 지정 모델을 만들려면 먼저 Speech Services 구독이 필요 합니다. Azure에서 음성 서비스 구독을 만들려면 다음 지침을 따르세요. Azure 계정이 없는 경우 새 계정을 등록할 수 있습니다.  
