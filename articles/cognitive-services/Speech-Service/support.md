...
[릴리스 정보](https://aka.ms/csspeech/whatsnew) 는 새 릴리스를 사용할 수 있는 즉시 업데이트 됩니다. 이 메모에는 새로운 기능, 향상 된 기능 및 버그 수정에 대 한 정보가 포함 되어 있습니다.
...
> * [최소, 완전 및 안정형 예제를 만드는 방법](https://stackoverflow.com/help/mcve)
