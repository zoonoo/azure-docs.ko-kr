...
1. 완료 규칙 옆에 있는 `+` 아이콘을 선택 하 여 새 완료 규칙을 만듭니다.
1. 규칙 이름 입력
1. 작업 추가
   1. 작업 옆에 있는 `+` 아이콘을 선택 하 고를 선택 하 여 새 음성 응답 작업을 만듭니다 `SpeechResponse`
   1. 응답 입력
   ...
   > [!div class="mx-imgBorder"]
   > 음성 응답을 만들 ![](media/custom-speech-commands/create-speech-response-action.png)
...
> [!div class="mx-imgBorder"]
> 웹 채팅](media/custom-speech-commands/create-basic-test-chat.png)를 사용 하 여 테스트 ![
