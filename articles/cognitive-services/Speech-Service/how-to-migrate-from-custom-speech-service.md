...
description: Custom Speech Service은 이제 음성 서비스의 일부입니다. 최신 품질 및 기능 업데이트를 활용 하려면 Speech service로 전환 하세요.
...
ms.locfileid: "74805929"
---
# <a name="migrate-from-the-custom-speech-service-to-the-speech-service"></a>Custom Speech Service에서 Speech Service로 마이그레이션

이 문서를 사용 하 여 Custom Speech Service에서 음성 서비스로 응용 프로그램을 마이그레이션합니다.

Custom Speech Service은 이제 음성 서비스의 일부입니다. 최신 품질 및 기능 업데이트를 활용 하려면 Speech service로 전환 하세요.

## <a name="migration-for-new-customers"></a>신규 고객에 대한 마이그레이션

가격 책정 모델은 음성 서비스에 대 한 시간 기반 가격 책정 모델을 사용 하 여 더 간단 합니다.  
...
음성 서비스 포털에서 기존 리소스 키를 음성 서비스로 마이그레이션합니다. 다음 단계를 사용하세요.
