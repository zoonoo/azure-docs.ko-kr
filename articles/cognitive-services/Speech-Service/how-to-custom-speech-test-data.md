...
| 데이터 형식 | 테스트 사용 | 권장 수량 | 학습에 사용 됨 | 권장 수량 |
|-----------|-----------------|----------|-------------------|----------|
| [오디오](#audio-data-for-testing) | yes<br>시각적 조사에 사용됨 | 5 + 오디오 파일 | 아닙니다. | 해당 사항 없음 |
| [오디오 + 사람 레이블 기록](#audio--human-labeled-transcript-data-for-testingtraining) | yes<br>정확도 평가에 사용됨 | 0.5-5시간의 오디오 | yes | 1-1,000시간의 오디오 |
| [관련 텍스트](#related-text-data-for-training) | 아닙니다. | 해당 사항 없음 | yes | 1-200 MB의 관련 텍스트 |
...
전사는 시스템에서 처리할 수 있도록 텍스트로 정규화됩니다. 그러나 Speech Studio에 데이터를 업로드 하기 _전에_ 사용자가 수행 해야 하는 몇 가지 중요 한 normalizations 있습니다. 기록을 준비할 때 사용할 적절한 언어에 대해서는 [사람 레이블 기록을 만드는 방법](how-to-custom-speech-human-labeled-transcriptions.md)을 확인합니다.
...
> [!IMPORTANT]
> 일반적인 단어의 발음을 변경하기 위해 이 기능을 사용하는 것을 권장하지 않습니다.
...
사용자 지정된 발음은 영어(EN-US) 및 독일어(DE-DE)에서 제공됩니다. 다음 표는 각 언어에서 지원되는 문자를 보여줍니다.
...
이 표를 사용하여 발음에 대한 관련된 데이터 파일의 형식이 올바른지 확인합니다. 발음 파일은 작으며 몇 KB를 초과하지 않아야 합니다.
