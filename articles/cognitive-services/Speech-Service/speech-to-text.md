...
음성 SDK 및 REST Api를 사용 하 여 마이크에서 오디오를 쉽게 캡처하거나, 스트림에서 읽거나, 저장소에서 오디오 파일에 액세스할 수 있습니다. Speech SDK는 음성 인식을 위해 WAV/PCM 16비트, 16kHz/8kHz, 단일 채널 오디오를 지원합니다. [음성 텍스트 변환 REST 엔드포인트](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-apis) 또는 [일괄 처리 전사 서비스](https://docs.microsoft.com/azure/cognitive-services/speech-service/batch-transcription#supported-formats)를 사용하여 추가 오디오 형식을 지원합니다.
...
| 스트리밍 오디오 및 긴 길이 발언 연속 기록 (> 15 초)입니다. 중간 및 최종 기록 결과를 지원 합니다. | 예 | 아니오 |
| [LUIS](https://docs.microsoft.com/azure/cognitive-services/luis/what-is-luis)를 사용하여 인식 결과를 도출합니다. | 예 | 아니요\* |
| 오디오 파일의 일괄 처리를 비동기적으로 처리 합니다. | 아니오  | 예\*\* |
| 음성 모델을 만들고 관리합니다. | 아니오 | 예\*\* |
| 사용자 지정 모델 배포를 만들고 관리합니다. | 아니오  | 예\*\* |
| 사용자 지정 모델과 기본 모델과 비교하여 정확도를 측정하는 정확도 테스트를 만듭니다. | 아니오  | 예\*\* |
| 구독을 관리합니다. | 아니오  | 예\*\* |

_별도의 LUIS 구독을 사용 하 여 \*LUIS 의도 및 엔터티를 파생할 수 있습니다. 이 구독을 사용 하 여 SDK는 사용자를 위해 LUIS를 호출 하 고 엔터티 및 의도 결과를 제공할 수 있습니다. REST API를 사용 하 여 LUIS를 직접 호출 하 여 LUIS 구독으로 의도 및 엔터티를 파생 시킬 수 있습니다._

\*\*_cris.ai 끝점을 사용 하 여 이러한 서비스를 사용할 수 있습니다. [Swagger 참조](https://westus.cris.ai/swagger/ui/index)를 참조 하세요._
