...
개발자는 음성 출력을 사용하여 애플리케이션을 지원할 수 있습니다. Speech Service는 많은 수의 [언어](supported-languages.md)에 대해 음성을 합성할 수 있으며, 앱에 액세스하여 해당 기능을 추가하기 위한 [끝점](rest-apis.md)을 제공합니다.
