---
title: Azure Cognitive Services 음성 시나리오 | Azure Microsoft Docs
description: 시나리오
...
많은 사용자가 해당 응용 프로그램에서 음성 입력을 지원하려고 합니다. 음성 입력은 앱을 유연하게 만들거나, 핸즈프리를 지원하거나(예: 자동차), 뉴스나 날씨 정보를 묻는 것과 같은 다양한 작업을 빠르게 처리하는 유용한 방법입니다. 
...
먼저 [Azure 구독 키](https://azure.microsoft.com/try/cognitive-services/)를 가져온 후 [설명서]([Batch transcription API](batch-transcription.md))를 참조해야 합니다.
