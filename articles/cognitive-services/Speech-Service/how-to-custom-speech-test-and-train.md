---
title: 사용자 지정 음성 - 음성 서비스에 대한 데이터 준비
...
|-----------|-----------------|----------|-------------------|----------|
| [오디오](#audio-data-for-testing) | 예<br>육안으로 검사하는 데 사용됩니다. | 5+ 오디오 파일 | 예 | 해당 사항 없음 |
| [오디오 + 사람이 표시한 성적 증명서](#audio--human-labeled-transcript-data-for-testingtraining) | 예<br>정확도 를 평가하는 데 사용됩니다. | 0.5-5시간 의 오디오 | 예 | 1-1,000시간의 오디오 |
| [관련 텍스트](#related-text-data-for-training) | 예 | 해당 사항 없음 | 예 | 관련 텍스트 1-200MB |
