...
> [!TIP] 
> 많은 발화를 사용하는 경우 하나의 발화가 결과 사용자 지정 음성에 두드러진 영향을 주지 않을 수 있습니다. 문제가 있는 발화를 간단히 메모하고, 데이터 세트에서 제외하고, 사용자 지정 음성의 결과를 확인하는 것이 더 편리할 수 있습니다. 나중에 항상 스튜디오로 돌아와 누락된 샘플을 다시 녹음할 수 있습니다.
