...
마지막으로 각 WAV 파일과 관련된 해당 발언의 텍스트 버전인 *스크립트*(대본)를 만듭니다. [사용자 지정 음성 글꼴 만들기](./how-to-custom-voice-create-voice.md) 과정에는 필요한 형식의 세부 정보가 포함됩니다. 스크립트에서 직접 텍스트를 복사할 수 있습니다. 그런 다음, WAV 파일 및 텍스트 기록이 포함된 Zip 파일을 만듭니다.
