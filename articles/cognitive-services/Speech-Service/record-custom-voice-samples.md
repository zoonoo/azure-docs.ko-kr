...
성공적인 일관된 음성 제작의 나머지 절반은 성우가 좌우합니다. 일관 된 속도, 볼륨 수준, 피치 및 어조 대화할 수 있어야 합니다. 명확한 발음도 필수입니다. 인재가 피치 변화, 감정적인 영향 및 음성 mannerisms 엄격 하 게 제어할 수 해야 합니다.
...
Studio의 기록 엔지니어를 사용 하 여 프로젝트에 설명 하 고 해당 통지를 수신 대기 합니다. 녹음은 동적 범위 압축이 거의 없거나 전혀 없어야 합니다(최대 4:1). 원치 않는 소리는 배제해야 하며 오디오는 일관된 볼륨과 높은 신호 대 잡음 비율을 유지해야 합니다.
...
스튜디오 시간을 낭비하지 않으려면 녹음 세션 전에 성우와 함께 스크립트를 살펴봅니다. 음성 재능 텍스트를 사용 하 여 친숙 한 되 면 하는 동안 알 수 없는 모든 단어의 발음을 명확히 설명할 수 있습니다 이러한 합니다.
...
성우는 발화에서 강조해야 하는 단어("중요한 단어")를 물어볼 수 있습니다. 특정 없음 강조를 사용 하 여 자연 스러운 읽기 한다고 알려줍니다. 음성이 합성될 때 강조가 추가될 수 있지만 원본 녹음에는 필요하지 않습니다.
...
일반 나누기를 수행 하 고 음성 재능 음성 인식을 양호한 상태 유지 하는 데 음료를 제공 합니다.
