---
title: '빠른 시작: Cognitive Services Speech SDK를 사용하여 Linux 기반 C++에서 음성 인식'
titleSuffix: Microsoft Cognitive Services
description: 'Cognitive Services Speech # SDK를 사용하여 Linux 기반 C++에서 음성을 인식하는 방법 알아보기'
