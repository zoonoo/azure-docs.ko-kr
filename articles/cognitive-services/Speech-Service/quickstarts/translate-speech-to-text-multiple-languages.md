...
description: 이 빠른 시작에서는 Speech SDK를 사용하여 대화형 방식으로 한 언어의 음성을 다른 언어의 음성으로 번역합니다.
...
ms.locfileid: "85391318"
---
# <a name="quickstart-translate-speech-to-multiple-languages"></a>빠른 시작: 음성을 여러 언어로 번역
