---
title: '빠른 시작: 음성 인식, Objective-C - Speech Service(iOS)'
titleSuffix: Azure Cognitive Services
description: Cognitive Services Speech SDK를 사용하여 iOS 디바이스의 Objective-C에서 음성을 인식하는 앱을 만드는 방법을 알아봅니다.
