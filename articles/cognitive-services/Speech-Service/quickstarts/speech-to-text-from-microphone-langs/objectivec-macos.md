...
빠른 시작은 [음성 합성](~/articles/cognitive-services/Speech-Service/quickstarts/text-to-speech-langs/objectivec-macos.md)에도 사용할 수 있습니다.
...
1. **프로젝트 옵션** 대화 상자에서:
    ...
    ![프로젝트 설정](~/articles/cognitive-services/Speech-Service/media/sdk/qs-objectivec-macos-project-settings.png)
...
1. 네트워크 및 마이크 액세스에 대한 자격을 설정합니다. 앱 구성으로 이동하려면 왼쪽의 개요에서 첫 번째 줄에 있는 앱 이름을 선택합니다. 그런 다음, **기능** 탭을 선택합니다.
    ...
    ![샌드박스 설정](~/articles/cognitive-services/Speech-Service/media/sdk/qs-objectivec-macos-sandbox.png)

1. 또한 앱은 `Info.plist` 파일에서 마이크 사용을 선언해야 합니다. 개요에서 파일을 선택하고 *음성 인식에 마이크 필요*와 같은 값을 사용하여 **개인 정보 - 마이크 사용 설명** 키를 추가합니다.

    ![Info.plist의 설정](~/articles/cognitive-services/Speech-Service/media/sdk/qs-objectivec-macos-info-plist.png)
