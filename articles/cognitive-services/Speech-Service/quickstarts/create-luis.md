...
description: 이 빠른 시작에서는 LUIS 애플리케이션을 만들고 키를 가져오는 방법을 알아봅니다.
...
이 자습서에서는 엔드포인트 키 형식이 필요합니다. 이 자습서에서는 [미리 빌드된 홈 자동화 앱 사용](../../luis/luis-get-started-create-app.md) 빠른 시작의 단계에 따라 만들 수 있는 홈 자동화 LUIS 앱 예제를 사용합니다. LUIS 앱을 직접 만든 경우 그 앱을 사용해도 됩니다.
...
> [의도 인식](~/articles/cognitive-services/Speech-Service/get-started-intent-recognition.md)