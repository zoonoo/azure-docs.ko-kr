---
title: 키워드 명명 지침-Speech service
titleSuffix: Azure Cognitive Services
description: 유효 키워드를 만드는 것은 장치가 일관적이 고 정확 하 게 응답 하는지 확인 하는 데 중요 합니다.
...
ms.locfileid: "75462378"
---
# <a name="guidelines-for-creating-an-effective-keyword"></a>유효 키워드 만들기에 대 한 지침

유효 키워드를 만드는 것은 장치가 일관적이 고 정확 하 게 응답 하는지 확인 하는 데 중요 합니다. 키워드를 사용자 지정 하는 것은 장치를 차별화 하 고 브랜딩을 강화 하는 효과적인 방법입니다. 이 문서에서는 효과적인 키워드를 만들기 위한 몇 가지 가이드 원칙에 대해 알아봅니다.
...
[Speech Studio를 사용 하 여 사용자 지정 키워드를 만드는](speech-devices-sdk-create-kws.md)방법에 대해 알아봅니다.
