...
> [!IMPORTANT]
> IOS에서 압축 오디오를 스트리밍하는 경우 Speech SDK 버전 1.7.0 이상이 필요 합니다. [ C++Linux의, C#및 java (ubuntu 16.04, ubuntu 18.04, Debian 9, RHEL 8, CentOS 8)](how-to-use-codec-compressed-audio-input-streams.md) 및 Android의 java 에서도 지원 됩니다 [.](how-to-use-codec-compressed-audio-input-streams-android.md)
...
1. `$(SRCROOT)/..` 디렉터리를 _검색 경로_ 제목 아래의 **프레임워크 검색 경로**에 추가합니다.
