...
* [음성 인식 모드를 선택](./get-started-speech-to-text.md) 합니다. 설명서에 JavaScript 지침이 추가 되었습니다.
* [SPEECH SDK 용 RHEL/CentOS 7 구성](how-to-configure-rhel-centos-7.md) -향상 된 설치 지침을 참조 하세요.
* 설명서에 [대 한 음성 텍스트](./get-started-speech-to-text.md) 추가 JavaScript 명령의 구 목록입니다.
...
* [빠른 시작: 발표자에 게 음성 합성](./get-started-text-to-speech.md) -설명서에 JavaScript 명령이 추가 되었습니다.
