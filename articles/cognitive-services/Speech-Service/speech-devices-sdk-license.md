...
b)  포함된 Microsoft 애플리케이션. 소프트웨어에 다른 Microsoft 애플리케이션이 포함될 수 있습니다. 다른 Microsoft 애플리케이션과 함께 다른 사용 조건이 제공되지 않은 한, 이러한 사용 조건이 포함된 애플리케이션에 적용됩니다.

c)  타사 구성 요소. 소프트웨어에 동봉된 타사 고지 사항 파일에 설명된 대로, 소프트웨어는 별도의 법적 고지 사항을 포함하거나 다른 계약에 의해 규제되는 타사 구성 요소를 포함할 수 있습니다.

d)  패키지 관리자 소프트웨어에 NuGet과 같은 패키지 관리자가 포함될 수 있으며, 패키지 관리자를 통해 애플리케이션에서 사용할 다른 Microsoft 및 타사 소프트웨어 패키지를 다운로드할 수 있습니다. 해당 패키지에는 이 계약이 아니라 자체 라이선스가 적용됩니다. Microsoft는 타사 패키지를 배포하거나, 사용을 허가하거나, 보증을 제공하지 않습니다.
