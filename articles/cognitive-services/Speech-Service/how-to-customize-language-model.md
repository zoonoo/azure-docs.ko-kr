...
선택할 두 가지 기본 언어 모델이 있습니다. 검색 및 받아쓰기 모델은 명령, 검색 쿼리 또는 받아쓰기 등의 애플리케이션의 지시 음성에 적합합니다. 대화형 모델은 대화 스타일로 통용되는 음성을 인식하는 데 적합합니다. 이런 유형의 음성은 일반적으로 다른 사람을 대상으로 지시하며 콜센터나 회의에서 사용됩니다.

검색 및 받아쓰기 모델은 명령, 검색 쿼리 또는 받아쓰기 등의 애플리케이션의 지시 음성에 적합합니다. 대화형 모델은 대화 스타일로 통용되는 음성을 인식하는 데 적합합니다. 이런 유형의 음성은 일반적으로 다른 사람을 대상으로 지시하며 콜센터나 회의에서 사용됩니다. "범용"이라는 새 모델도 공개적으로 사용할 수 있습니다. 범용은 모든 시나리오에 대응하고 결국 검색, 받아쓰기 및 대화형 모델을 대체하는 것이 목적입니다.
