---
title: Azure에서 음성 서비스가 포함된 사용자 지정 음성 엔드포인트 만들기 | Microsoft Docs
description: Cognitive Services에서 음성 서비스가 포함된 사용자 지정 음성-텍스트 엔드포인트를 만드는 방법을 알아봅니다.
