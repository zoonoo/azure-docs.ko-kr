...
Microsoft에서 제공 하는 제한 된 액세스 기능 키를 사용 하 여 음성 도우미 기능의 잠금을 해제 합니다. Windows SDK에서 [LimitedAccessFeature](/uwp/api/windows.applicationmodel.limitedaccessfeatures) 클래스를 사용 하 여이 작업을 수행 합니다.
