---
title: Speaker Recognition 기본 사항 - 음성 서비스
titleSuffix: Azure Cognitive Services
description: 음성 SDK를 사용하여 질문에 대답하는 "말하는 사람"을 사용하는 방법을 알아봅니다. 이 문서에서는 화자 검증과 식별을 모두 사용하기 위한 일반적인 디자인 패턴에 대해 알아봅니다.
...
ms.locfileid: "84632311"
---
# <a name="learn-the-basics-of-speaker-recognition"></a>Speaker Recognition의 기본 사항 알아보기

이 문서에서는 다음을 포함하여 음성 SDK를 사용하는 Speaker Recognition에 대한 기본적인 디자인 패턴을 알아봅니다:
