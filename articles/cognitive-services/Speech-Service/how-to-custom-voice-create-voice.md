...
3.  그런 다음이 모델을 식별 하는 데 도움이 되는 **이름** 및 **설명을** 입력 합니다.
    ...
    신중하게 이름을 선택합니다. 여기에 입력한 이름은 음성 합성 요청에서 음성을 지정할 때 SSML 입력의 일부로 사용됩니다. 문자, 숫자 및-, \_, 등의 몇 가지 문장 부호 문자만 사용할 수 있습니다. 음성 모델 마다 다른 이름을 사용 합니다.
