...
1. 방금 빌드한 `GStreamerWrapper.framework`와 [여기](https://aka.ms/csspeech/iosbinary)에서 다운로드할 수 있는 COGNITIVE SERVICES Speech SDK의 프레임 워크를 샘플 프로젝트가 포함 된 디렉터리로 복사 합니다.
