...
ms.locfileid: "67717266"
---
## <a name="create-a-speech-resource"></a>음성 리소스 만들기

1. [Azure Portal](https://portal.azure.com)에 로그인합니다.
1. 클릭 [Create **Speech** ](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesSpeechServices) 리소스
1. 모든 필수 설정을 입력 합니다.
...
1. 수집 구성 `endpoint` 및 API 키:
    ...
    |포털에서 리소스 탭|설정|값|
    |--|--|--|
    |**개요**|엔드포인트|끝점을 복사 합니다. 유사 하 게 표시 `https://speech.cognitiveservices.azure.com/sts/v1.0/issuetoken`|
