...
| 언어 | 추가 빠른 시작 | 코드 샘플 |
|--|--|--|
| C# | [마이크에서][1-mic], [Blob에서][1-blob] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [마이크에서][2-mic], [Blob에서][2-blob] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [마이크에서][3-mic], [Blob에서][3-blob] | [Android][java-android], [JRE][java-jre] |
...
| Python | [마이크에서][4-mic], [Blob에서][4-blob] | [Windows, Linux, macOS][python] |
