...
description: 이 가이드를 통해 Speech Services SDK를 사용하여 Windows 또는 macOS의 .NET Core에서 C#용 플랫폼을 설정합니다.
...
ms.locfileid: "73500351"
---
이 가이드에서는 C# .NET Core용 [Speech SDK](~/articles/cognitive-services/speech-service/speech-sdk.md)를 설치하는 방법을 보여 줍니다.
