...
> [!div class="checklist"]
> * [개발 환경을 설정하고 빈 프로젝트 만들기](../../../../quickstarts/setup-platform.md?tabs=vs&pivots=programmming-language-csharp)
...
다음으로, 전사 요청을 생성합니다. `TranscribeAsync`에 이 코드를 추가합니다.
...
결과가 로드된 후에는 콘솔에 출력할 수 있습니다. `case "Succeeded":` 레이블에 다음 코드를 추가합니다.
