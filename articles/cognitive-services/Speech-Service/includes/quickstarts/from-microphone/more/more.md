...
| 언어 | 추가 빠른 시작 | 코드 샘플 |
|--|--|--|
| C# | [파일에서][1-file], [Blob에서][1-blob] | [.NET Framework][dotnet], [.NET Core][netcore], [UWP][uwp], [Unity][unity], [Xamarin][xamarin] |
| C++ | [파일에서][2-file], [Blob에서][2-blob] | [Windows][cpp-windows], [Linux][cpp-linux], [macOS][cpp-mac] |
| Java | [파일에서][3-file], [Blob에서][3-blob] | [Android][java-android], [JRE][java-jre] |
...
| Python | [파일에서][4-file], [Blob에서][4-blob] | [Windows, Linux, macOS][python] |
