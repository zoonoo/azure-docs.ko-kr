...
직접 샘플 코드를 건너뛰려면 GitHub의 [c # 빠른 시작 샘플](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/csharp/dotnet/translate-speech-to-text) 을 참조 하세요.
