...
다음 값을 변경할 수도 있습니다.
- 오디오 출력 형식을 제어하는 `X-Microsoft-OutputFormat` 헤더 값입니다. 지원되는 오디오 출력 형식 목록은 [텍스트 음성 변환 REST API 참조](https://docs.microsoft.com/azure/cognitive-services/speech-service/rest-text-to-speech#audio-outputs)에서 찾을 수 있습니다.
