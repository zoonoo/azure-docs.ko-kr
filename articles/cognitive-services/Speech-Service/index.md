    ...
    <div class="container">
        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="start">
                    <li>
                        <a href="#speechtotext">음성 텍스트 변환</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>마이크에서 음성 인식</h3>
                                                    <p>음성 SDK를 사용하여 마이크에서 음성을 인식하고 출력을 전사합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>오디오 파일에서 음성 인식</h3>
                                                    <p>음성 SDK를 사용하여 단일 파일에서 음성을 인식하고 출력을 전사합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Blob에서 비동기 인식</h3>
                                                    <p>REST 서비스를 사용하여 Azure Blob Storage에 저장된 파일에서 음성을 비동기적으로 인식합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>언어 지원</h3>
                                                    <p>음성 텍스트 변환을 위한 프로그래밍 및 음성 언어 지원에 대해 자세히 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>문서 읽기</h3>
                                                    <p>앱, 도구 및 제품에 음성 인식을 추가하는 방법에 대해 알아봅니다. 개념, 자습서, API 참조 및 릴리스 정보가 포함되어 있습니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <li>
                            <a href="#texttospeech">텍스트 음성 변환</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>스피커로 음성 합성</h3>
                                                    <p>음성 SDK를 사용하여 음성을 스피커와 같은 오디오 출력으로 합성합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>오디오 파일로 음성 합성</h3>
                                                    <p>음성 SDK를 사용하여 음성을 오디오 파일로 합성합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Speech Synthesis Markup Language를 사용하여 오디오 출력의 피치, 운율 및 말하기 속도를 세밀하게 튜닝합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>문서 읽기</h3>
                                                    <p>앱, 도구 및 제품에 음성 합성을 추가하는 방법에 대해 알아봅니다. 개념, 자습서, API 참조 및 릴리스 정보가 포함되어 있습니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#intentrecognition">의도 인식</a>
                    ...
                    <li>
                        <a href="#speechtranslation">음성 번역</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>마이크에서 음성을 텍스트로 번역</h3>
                                                    <p>음성 SDK를 사용하여 마이크에서 음성을 텍스트로 번역합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>음성을 여러 대상 언어로 번역</h3>
                                                    <p>음성 SDK를 사용하여 음성을 여러 대상 언어 출력으로 번역합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>음성을 음성으로 번역</h3>
                                                    <p>음성 SDK를 사용하여 음성을 음성으로 번역합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>언어 지원</h3>
                                                    <p>음성 번역을 위한 프로그래밍 및 음성 언어 지원에 대해 자세히 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>문서 읽기</h3>
                                                    <p>앱, 도구 및 제품에 음성 번역을 추가하는 방법에 대해 알아봅니다. 개념, 자습서, API 참조 및 릴리스 정보가 포함되어 있습니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>실시간 대화 전사</h3>
                                                    <p>대화를 실시간으로 전사하는 방법에 대해 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>비동기 대화 전사</h3>
                                                    <p>대화를 비동기적으로 전사하고, 상태를 폴링하고, 출력을 다운로드하는 방법에 대해 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>언어 지원</h3>
                                                    <p>대화 전사를 위한 프로그래밍 및 음성 언어 지원에 대해 자세히 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Bot Framework와 통합</h3>
                                                    <p>Bot Framework, Direct Line Speech 채널 등에 대해 자세히 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>GitHub 문제</h3>
                                                    <p>GitHub에서 미해결 문제를 찾아보고 또는 음성 SDK에 대한 새 문제를 만듭니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>스택 오버플로</h3>
                                                    <p>질문을 하고, 스택 오버플로에 대한 음성 서비스 커뮤니티의 도움을 받으세요.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>UserVoice 포럼</h3>
                                                    <p>아이디어를 공유하거나, 향상된 기능을 제안하거나, 음성 서비스에 대한 새 기능을 요청하세요.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            <li>
                <a href="#customization">사용자 지정</a>
                <ul id="customization">
                    <li>
                        <a href="#speech-to-text-customization">음성 텍스트 변환</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>문구 목록을 사용하여 정확도 향상</h3>
                                                    <p>음성 SDK의 문구 목록을 사용하여 인식 정확도를 향상시킵니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>테넌트 모델을 사용하여 정확도 향상</h3>
                                                    <p>Office365 데이터를 사용하여 조직 고유의 용어에 대한 음성 인식 정확도를 최적화하는 사용자 지정 모델을 생성합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Custom Speech를 사용하여 정확도 향상</h3>
                                                    <p>앱, 도구 및 제품에 대한 Microsoft의 음성 텍스트 변환 정확도를 평가하고 향상시킬 수 있는 온라인 도구 세트입니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>언어 지원</h3>
                                                    <p>Custom Speech를 위한 프로그래밍 및 음성 언어 지원에 대해 자세히 알아봅니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#text-to-speech-customization">텍스트 음성 변환</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SSML을 사용하여 합성 향상</h3>
                                                    <p>Speech Synthesis Markup Language를 사용하여 오디오 출력의 피치, 운율 및 말하기 속도를 세밀하게 튜닝합니다.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Custom Voice를 사용하여 합성 향상</h3>
                                                    <p>사용 가능한 발언 데이터를 사용하여 텍스트 음성 변환 앱에 대한 다양한 종류의 음성을 만듭니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>오디오 콘텐츠 만들기를 사용하여 합성 향상</h3>
                                                    <p>오디오 콘텐츠 만들기 도구를 사용하여 합성된 음성 출력을 세밀하게 튜닝합니다.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>사용자 지정 신경망 음성에 대한 액세스 권한 얻기</h3>
                                                    <p>사용자 지정 신경망 음성을 만들 수 있도록 하는 게이트 기능입니다. 액세스 및 제한 사항에 대해 자세히 알아봅니다.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
