---
title: '빠른 시작: 사용자 지정 음성 도우미(미리 보기), Java(Windows, Linux) - Speech Service'
...
ms.locfileid: "73500799"
---
# <a name="quickstart-create-a-voice-assistant-with-the-speech-sdk-java"></a>빠른 시작: Speech SDK를 사용하여 음성 도우미 만들기, Java
