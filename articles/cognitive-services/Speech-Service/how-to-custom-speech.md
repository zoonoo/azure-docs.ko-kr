...
> [!IMPORTANT]
> [Custom Speech 포털이](https://aka.ms/custom-speech) 최근에 업데이트 되었습니다. CRIS 포털 또는 Api에서 데이터, 모델, 테스트 및 게시 된 끝점이 포함 된 이전 프로젝트를 만든 경우 새 포털에서 새 프로젝트를 만들어 이러한 이전 엔터티에 연결 해야 합니다.
