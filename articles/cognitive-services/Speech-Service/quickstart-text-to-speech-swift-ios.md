...
description: Speech SDK를 사용하여 iOS에서 Swift로 음성 합성 방법 알아보기
...
1. 자동으로 생성된 `ViewController.swift` 파일의 콘텐츠를 다음으로 바꿉니다.  
