...
|디바이스|사양|설명|시나리오|
|--|--|--|--|
|[Roobo Smart Audio Dev Kit](http://ddk.roobo.com)</br>[설치 프로그램](speech-devices-sdk-roobo-v1.md) / [퀵 스타트](speech-devices-sdk-android-quickstart.md)![Roobo 스마트 오디오 Dev 키트](media/speech-devices-sdk/device-roobo-v1.jpg)|7 mic 배열에 ARM SOC WIFI, 오디오 출력, IO입니다. </br>Android|Microsoft Mic 배열 및 고품질 기록 및 음성 시나리오를 개발 하기 위한 SDK를 처리 하는 앞에 맞게 첫 번째 음성 장치 SDK|대화 기록, 스마트 발표자 음성 에이전트, 착용 식|
