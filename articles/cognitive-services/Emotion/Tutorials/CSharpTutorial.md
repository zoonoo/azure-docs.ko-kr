---
title: Emotion API C# 자습서 | Microsoft Docs
description: 이미지의 얼굴에 의해 표현된 감정을 인식하려면 Cognitive Services Emotion API를 사용하는 기본 Windows 앱을 탐색합니다.
...
ms.locfileid: "35374175"
---
# <a name="emotion-api-in-c35-tutorial"></a>C&#35; 자습서의 Emotion API
...
예제를 만들기 전에 Microsoft Cognitive Services의 일부인 Emotion API를 구독해야 합니다. [구독](https://azure.microsoft.com/try/cognitive-services/)을 참조하세요. 이 자습서에서는 기본 키와 및 보조 키를 둘 다 사용할 수 있습니다. API 키의 비밀과 안전을 유지하려면 모범 사례를 따라야 합니다.  
