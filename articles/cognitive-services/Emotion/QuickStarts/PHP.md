---
title: Emotion API PHP 빠른 시작 | Microsoft Docs
description: Cognitive Services에서 PHP로 Emotion API를 빠르게 사용하는 데 도움이 되는 정보 및 코드 샘플을 가져옵니다.
...
ms.locfileid: "37019400"
---
# <a name="emotion-api-php-quick-start"></a>Emotion API PHP 빠른 시작
