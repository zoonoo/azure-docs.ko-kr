...
응용 프로그램은 URL Preview를 사용하여 미리 보기 URL에 할당된 쿼리를 통해 엔드포인트에 웹 요청을 보냅니다.  JSON 응답은 이름, 리소스의 설명, *familyFriendly* 플래그 및 전체 리소스와 대표 이미지에 대한 온라인 액세스를 제공하는 링크 등의 미리 보기 정보를 포함합니다. 
