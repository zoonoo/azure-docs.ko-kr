---
title: Conversation Learner 모델에서 버전 관리 및 태그 지정을 사용하는 방법 - Microsoft Cognitive Services | Microsoft Docs
titleSuffix: Azure
...
### <a name="create-an-model"></a>모델을 만듭니다.
...
- 모델 ID를 CONVERSATION_LEARNER_MODEL_ID의 값으로 붙여넣습니다.
...
4. “버전 1”을 “라이브”로 설정합니다.  
    ...
    - 태그가 지정된 모델 버전은 편집(작업 및 엔터티 변경, 학습 대화 추가)의 영향을 받지 않습니다.  
    - 모델 편집(작업 및 엔터티 변경, 학습 대화 추가)은 항상 “마스터” 태그에서 수행됩니다.  즉, “마스터”는 변경 가능한 유일한 태그이고 다른 태그는 고정된 스냅숏입니다.
...
1. 로그 대화를 클릭합니다(대화가 표시되지 않는 경우 새로 고침 단추 클릭).
