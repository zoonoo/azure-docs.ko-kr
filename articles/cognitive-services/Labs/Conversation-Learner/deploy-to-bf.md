...
Bot가 배포 되 고 실행 되 면 Facebook, 팀, Skype 등의 다른 채널에 연결할 수 있습니다. Azure Bot Channel 등록 사용. 해당 프로세스에 대한 문서는 다음을 참조하세요. https://docs.microsoft.com/bot-framework/bot-service-quickstart-registration
