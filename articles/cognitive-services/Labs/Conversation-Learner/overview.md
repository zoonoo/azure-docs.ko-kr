...
이 접근 방법을 사용하면 대화 제어 논리의 수동 코딩이 감소하며, 비즈니스 소유자나 도메인 전문가가 사전 Machine Learning 지식 없이도 대화형 인터페이스에 참여할 수 있습니다. 봇, 스마트 장치 또는 지능형 에이전트의 일부로 배포하든 간에 Conversation Learner는 새로운 기술, 동작 또는 역량을 신속하게 반복하고 품질을 빠르게 개선할 수 있습니다. 
