...
|이름|값|형식|필수|  
|----------|-----------|----------|--------------|  
|<a name="mkt" />mkt|결과가 나오는 지역/국가입니다. <br /><br />가능한 지역/국가 값 목록은 지역/국가 코드를 참조하세요.<br /><br /> **참고:** URL Preview API는 현재 en-us 지역/국가와 언어만 지원합니다.<br /><br />|String|예|  
...
|라이선스|콘텐츠를 사용할 수 있는 라이선스입니다.|[라이선스](#license)|  
