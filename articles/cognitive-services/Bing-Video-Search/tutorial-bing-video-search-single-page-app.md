...
이 자습서에서는 소스 코드의 선택된 부분에 대해 설명합니다. 전체 [소스 코드]()를 확인할 수 있습니다. 예제를 실행하려면 소스 코드를 복사한 후 텍스트 편집기에 붙여넣고 `bing.html`로 저장합니다.
...
> [Bing Video Search API 참조](/rest/api/cognitiveservices/bing-video-api-v7-reference)