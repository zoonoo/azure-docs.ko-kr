---
title: Azure Cognitive Services, Bing Video Search API에 대한 Java 빠른 시작 | Microsoft Docs
...
ms.locfileid: "35376950"
---
# <a name="quickstart-for-bing-video-search-api-with-java"></a>Bing Video Search API 및 Java에 대한 빠른 시작

이 문서는 Azure의 Microsoft Cognitive Services 일부인 Bing Search API를 사용하는 방법을 보여 줍니다. 이 문서에서는 Java를 사용하지만 API는 RESTful 웹 서비스로, HTTP 요청을 수행하고 JSON을 구문 분석할 수 있는 모든 프로그래밍 언어와 호환됩니다. 
