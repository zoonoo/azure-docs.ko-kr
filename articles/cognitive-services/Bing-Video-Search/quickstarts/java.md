---
title: '빠른 시작: Bing Video Search REST API 및 Java를 사용하여 비디오 검색'
...
3. API 엔드포인트 호스트 및 경로, 사용자의 구독 키 및 검색어에 대한 변수를 사용하여 `SearchVideos()`라는 새 메서드를 만듭니다. `SearchResults` 개체를 반환합니다. 
