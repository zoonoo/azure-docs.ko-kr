---
title: Bing 비디오 검색 API를 사용하여 동영상 검색
titleSuffix: Azure Cognitive Services
description: Bing 비디오 검색 APIfinds 및 웹에서 관련 비디오를 반환, 그것은 웹에서 지능적이고 집중된 비디오 검색을위한 몇 가지 기능을 제공합니다.
...
- [가격 책정](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#pricing)&mdash;가격(예: 무료이거나 비용을 지불해야 하는 동영상)에 따라 동영상 필터링
- [해상도](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#resolution)&mdash;해상도 해상도로 동영상 필터링(예: 해상도가 720p 이상인 동영상)
- [videoLength](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#videolength)&mdash;비디오 길이별로 비디오 필터링(예: 길이가 5분 미만인 동영상)
- [최신성](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-video-api-v7-reference#freshness)&mdash;연령별 동영상 필터링(예: 지난 주 Bing에서 발견한 동영상)
