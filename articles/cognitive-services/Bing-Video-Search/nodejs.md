---
title: Azure Cognitive Services, Bing Video Search API에 대한 Node.js 빠른 시작 | Microsoft Docs
...
ms.locfileid: "35376942"
---
# <a name="quickstart-for-bing-video-search-api-with-nodejs"></a>Bing Video Search API 및 Node.js에 대한 빠른 시작
