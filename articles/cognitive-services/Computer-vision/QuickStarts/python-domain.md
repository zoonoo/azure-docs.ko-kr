...
이 빠른 시작에서는 도메인 모델을 사용하여 Computer Vision REST API를 통해 원격으로 저장된 이미지에서 랜드마크 또는 선택적으로 유명인을 식별합니다. [도메인 특정 콘텐츠 인식](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/56f91f2e778daf14a499f311) 메서드를 사용하면 도메인 특정 모델을 적용하여 이미지에서 콘텐츠를 인식할 수 있습니다.
