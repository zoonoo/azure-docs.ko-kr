---
title: Computer Vision API C# 빠른 시작 만들기 썸네일 | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 이 빠른 시작에서는 Cognitive Services에서 C#과 함께 Computer Vision을 사용하여 이미지에서 썸네일을 생성합니다.
...
ms.locfileid: "43750660"
---
# <a name="quickstart-generate-a-thumbnail---rest-c35"></a>빠른 시작: 썸네일 생성 - REST, C&#35;
...
썸네일은 "_thumb" 접미사를 포함한 원래 이름을 사용하여 로컬 이미지와 같은 폴더에 저장됩니다.
