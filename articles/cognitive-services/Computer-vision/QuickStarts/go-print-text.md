---
title: Computer Vision API Go 빠른 시작 OCR | Microsoft Docs
titleSuffix: Microsoft Cognitive Services
description: 이 빠른 시작에서는 Cognitive Services에서 Go와 함께 Computer Vision을 사용하여 이미지에서 인쇄된 텍스트를 추출합니다.
...
ms.locfileid: "43750670"
---
# <a name="quickstart-extract-printed-text-ocr---rest-go"></a>빠른 시작: 인쇄된 텍스트(OCR) 추출 - REST, Go
...
1. 파일을 빌드합니다(예: `go build get-printed-text.go`).
1. 파일을 실행합니다(예: `get-printed-text`).
