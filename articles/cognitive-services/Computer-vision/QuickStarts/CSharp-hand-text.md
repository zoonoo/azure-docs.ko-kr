...
ms.locfileid: "83681198"
---
# <a name="quickstart-extract-printed-and-handwritten-text-using-the-computer-vision-21-and-30-rest-api-and-c"></a>빠른 시작: Computer Vision 2.1, 3.0 REST API 및 C#을 사용하여 인쇄 및 필기 텍스트 추출
...
Computer Vision 2.1 및 3.0과 비교하여 Computer Vision 3.0 공개 미리 보기에서 제공하는 이점은 다음과 같습니다.
