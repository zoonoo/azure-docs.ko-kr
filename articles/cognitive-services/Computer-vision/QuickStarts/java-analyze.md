...
이 빠른 시작에서는 Java 및 Computer Vision REST API를 사용하여 원격으로 저장된 이미지를 분석하여 시각적 기능을 추출합니다. [이미지 분석](https://westcentralus.dev.cognitive.microsoft.com/docs/services/computer-vision-v3-1-ga/operations/56f91f2e778daf14a499f21b) 메서드를 사용하면 이미지 콘텐츠를 기반으로 하여 시각적 특징을 추출할 수 있습니다.

## <a name="prerequisites"></a>필수 구성 요소

* Azure 구독 - [체험 구독 만들기](https://azure.microsoft.com/free/cognitive-services/)
* [Java&trade; 플랫폼, Standard Edition Development Kit 7 또는 8](/azure/developer/java/fundamentals/java-jdk-long-term-support)(JDK 7 또는 8)
...
> [Computer Vision API Java 자습서](https://github.com/Azure-Samples/cognitive-services-java-computer-vision-tutorial)