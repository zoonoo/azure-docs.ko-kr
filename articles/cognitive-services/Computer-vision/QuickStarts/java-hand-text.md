...
ms.locfileid: "67604392"
---
# <a name="quickstart-extract-handwritten-text-using-the-computer-vision-rest-api-and-java"></a>빠른 시작: Computer Vision REST API 및 Java를 사용하여 필기 텍스트 추출
