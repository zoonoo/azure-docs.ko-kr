...
ms.locfileid: "55870591"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-rest-api-and-nodejs-in-computer-vision"></a>빠른 시작: Computer Vision에서 REST API 및 Node.js를 사용하여 인쇄된 텍스트 추출(OCR)
