...
description: 이 빠른 시작에서는 Cognitive Services에서 Java와 함께 Computer Vision을 사용하여 이미지에서 썸네일을 생성합니다.
...
ms.locfileid: "43750703"
---
# <a name="quickstart-generate-a-thumbnail---rest-java"></a>빠른 시작: 썸네일 생성 - REST, Java
