...
description: 이 빠른 시작에서는 Cognitive Services에서 Java와 함께 Computer Vision을 사용하여 이미지에서 인쇄된 텍스트를 추출합니다.
...
ms.locfileid: "43750661"
---
# <a name="quickstart-extract-printed-text-ocr---rest-java"></a>빠른 시작: 인쇄된 텍스트(OCR) 추출 - REST, Java
...
성공적인 응답이 JSON을 통해 반환됩니다. OCR 결과에는 검색된 텍스트 및 지역의 경계 상자, 선 및 단어가 포함됩니다.

이 프로그램은 다음 JSON과 유사한 출력을 생성해야 합니다.
