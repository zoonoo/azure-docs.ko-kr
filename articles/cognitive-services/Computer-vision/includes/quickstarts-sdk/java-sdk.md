...
새 메서드에서 엔드포인트와 키를 사용하여 [ComputerVisionClient](https://docs.microsoft.com/java/api/com.microsoft.azure.cognitiveservices.vision.computervision.computervisionclient?view=azure-java-stable) 개체를 인스턴스화합니다.
