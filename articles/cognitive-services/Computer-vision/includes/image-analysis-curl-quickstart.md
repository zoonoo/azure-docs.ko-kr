---
title: '빠른 시작: 이미지 분석 REST API'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작에서 이미지 분석 REST API를 시작합니다.
...
ms.locfileid: "107800280"
---
이미지 분석 REST API를 사용하여 다음을 수행합니다.
...
이미지 분석을 사용하여 스마트 자르기로 썸네일을 생성할 수 있습니다. 원하는 높이 및 너비를 지정하면 입력 이미지와 가로 세로 비율이 다를 수 있습니다. 이미지 분석은 스마트 자르기를 사용하여 관심 영역을 지능적으로 식별하고 해당 영역을 기준으로 자르기 좌표를 생성합니다.
...
이 빠른 시작에서는 설치하고 REST API를 사용하여 기본 이미지 분석을 호출하는 방법을 배웠습니다. 다음으로, Analyze API 기능에 대해 자세히 알아보세요.
