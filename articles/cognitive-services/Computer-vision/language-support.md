...
Computer Vision의 일부 기능은 여러 언어 지원합니다; 여기서 언급 하지 않은 기능은 영어만 지원 합니다.

## <a name="text-recognition"></a>텍스트 인식

Computer Vision 다양 한 언어로 텍스트를 인식할 수 있습니다. 특히 [OCR](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/56f91f2e778daf14a499e1fc) API는 다양한 언어를 지원하는 반면, [읽기](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/2afb498089f74080d7ef85eb) API 및 [텍스트 인식](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/587f2c6a154055056008f200) API는 영어만 지원 합니다. 각 API의 장점과 기능에 대한 자세한 내용은 [인쇄 및 필기된 텍스트 인식](concept-recognizing-text.md)를 참조 합니다.

OCR은 입력 내용의 언어를 자동으로 감지 하므로 API 호출에서 언어 코드를 지정 하지 않아도 되며 언어 코드는 JSON 응답에서 `"language"` 노드의 값으로 항상 반환됩니다.
...
일부 [이미지-분석](https://westus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/56f91f2e778daf14a499e1fa) API의 작업은 `language` 쿼리 매개 변수로 지정된 다른 언어의 결과를 반환할 수 있습니다. 어떤 작업은 어떤 언어를 지정 하는 것에 관계 없이 영어로 결과를 반환 하고 지원 되지 않는 언어에 대한 예외를 throw 합니다. 작업은 `visualFeatures` 및 `details` 쿼리 매개 변수를 사용하여 지정합니다. 이미지 분석을 사용하여 할 수 있는 모든 작업의 목록은 [개요](home.md)를 참조 하세요.
...
이 가이드에서 설명한 Computer Vision 기능을 사용하여 시작하십시오.

* [로컬 이미지 (REST)를 분석 합니다.](./quickstarts/csharp-analyze.md)
* [인쇄된 텍스트 (REST)를 추출 합니다.](./quickstarts/csharp-print-text.md)
