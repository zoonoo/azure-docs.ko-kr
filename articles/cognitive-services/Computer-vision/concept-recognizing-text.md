...
![회전 중인 이미지와 해당 텍스트를 읽고 구분 하 고 있습니다.](./Images/vision-overview-ocr-read.png)
...
읽기 API는 영어, 스페인어, 독일어, 프랑스어, 이탈리아어, 포르투갈어 및 네덜란드어 언어로 인쇄 텍스트 추출을 지원 합니다. 시나리오에서 더 많은 언어를 지원 해야 하는 경우이 문서의 OCR API 개요를 참조 하세요. [지원 되](https://docs.microsoft.com/azure/cognitive-services/computer-vision/language-support#text-recognition) 는 모든 언어 목록 참조
