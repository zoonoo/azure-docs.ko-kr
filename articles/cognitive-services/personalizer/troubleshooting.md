...
### <a name="i-created-an-offline-evaluation-and-it-succeeded-almost-instantly-why-is-that-i-dont-see-any-results"></a>오프 라인 평가를 만들었으며 거의 즉시 성공 했습니다. 왜 그럴까요? 결과가 표시 되지 않나요?
