---
title: 오프라인 평가 방법 사용 - 개인화
titleSuffix: Azure Cognitive Services
description: 이 문서에서는 오프라인 평가를 사용하여 앱의 효과를 측정하고 학습 루프를 분석하는 방법을 설명합니다.
...
오프라인 평가는 코드를 변경하거나 사용자 환경에 영향을 주지 않고 Personalizer 서비스의 효율성을 테스트하고 평가할 수 있는 방법입니다. 오프라인 평가는 응용 프로그램에서 순위 및 보상 API로 전송된 이전 데이터를 사용하여 다른 순위가 수행된 방식을 비교합니다.
...
오프라인 평가가 수행되면 현재 온라인 정책과 비교하여 새 정책을 사용한 Personalizer의 비교 효율성을 확인할 수 있습니다. 그런 다음 해당 학습 정책을 적용하여 모델 및 정책 패널에 다운로드하여 업로드하여 Personalizer에서 즉시 효과적으로 적용할 수 있습니다. 향후 분석 또는 사용을 위해 다운로드할 수도 있습니다.
...
|**기준선**|응용 프로그램의 기본값(Rank 호출에서 전송된 첫 번째 작업에 의해 결정)|
...
* 실수로 포함된 기능이 있나요? 이러한 예는 다음과 같습니다: 사용자 식별 정보, 중복 ID, 기타.
...
[개인 설정](how-to-settings.md)
[오프라인 평가 구성](how-to-offline-evaluation.md) 개인 [설정](how-personalizer-works.md)
