...
keywords: 문서 처리
ms.openlocfilehash: 7ddbcd7ff72d8989b2f70d91a94aa775698e273e
ms.sourcegitcommit: 17345cc21e7b14e3e31cbf920f191875bf3c5914
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 05/19/2021
ms.locfileid: "110084346"
---
...
---
  ...
  3. 이제 `docker run`을 사용하여 컨테이너를 실행할 준비가 되었습니다.
...
1. 먼저 태그 편집기 창을 사용하여 식별할 태그를 만듭니다.
   ...
   1. 태그 이름을 입력합니다.
   1. Enter 키를 눌러 태그를 저장합니다.
1. 주 편집기에서 강조 표시된 텍스트 요소에서 단어를 선택합니다.
1. 적용하려는 태그를 선택하거나 해당 키보드 키를 누릅니다. 숫자 키는 처음 10개 태그에 대한 바로 가기 키로 할당됩니다. 태그 편집기 창에서 위쪽 및 아래쪽 화살표 아이콘을 사용하여 태그를 다시 정렬할 수 있습니다.
    > [!Tip]
    > 양식에 레이블을 지정할 때 다음 팁을 참조하세요.
    >
...
왼쪽에 있는 예측(전구) 아이콘을 선택하여 모델을 테스트합니다. 학습 프로세스에서 사용하지 않은 양식 문서를 업로드합니다. 그런 다음, 오른쪽에 있는 **예측** 단추를 선택하여 양식에 대한 키/값 예측을 가져옵니다. 이 도구는 태그를 경계 상자에 적용하고, 각 태그의 신뢰도를 보고합니다.
