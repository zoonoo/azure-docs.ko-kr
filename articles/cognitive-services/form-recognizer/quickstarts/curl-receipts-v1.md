...
> [!IMPORTANT]
> 이 빠른 시작에서는 Form Recognizer v1.0 API를 사용합니다. 구독이 `West US 2` 또는 `West Europe` 지역에 있는 경우 대신 v[2.0 API 빠른 시작](./python-train-extract.md)을 따라야 합니다.
