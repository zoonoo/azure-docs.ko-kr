...
바인딩 탑재를 사용하여 컨테이너에서 또는 컨테이너로 읽고 씁니다. 명령에서 옵션을 `--mount` 지정 하 여 입력 탑재 또는 출력 탑재를 지정할 수 있습니다. [ `docker run` ](https://docs.docker.com/engine/reference/commandline/run/)
