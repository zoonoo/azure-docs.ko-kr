...
description: Azure Cognitive Services에서 지원되는 인간 언어 목록입니다.
...
> ² LUIS, Speech Service: Speech-to-Text 및 Video Indexer: Speech-to-Text가 지원되지 않습니다.
