...
<h1>Azure Cognitive Services 설명서</h1>
        ...
        <p> 각 서비스에는 완전 학습된 모델부터 완전 사용자 지정 가능한 모델에 이르기까지 자체 <a href="/azure/cognitive-services/language-support">언어 지원</a> 및 <a href="/azure/cognitive-services/cognitive-services-and-machine-learning#service-requirements-for-the-data-model">데이터 모델 요구 사항</a>이 있습니다. 
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Cognitive Services란?</h3>
                                <p>Azure Cognitive Services 및 다른 API를 사용하여 지능형 앱을 빌드하는 방법을 알아봅니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Cognitive Services 및 기계 학습</h3>
                                <p>Azure Cognitive Services가 기계 학습을 위한 다른 Azure 제품과 어디에 적합한지 알아봅니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>Cognitive Services 리소스 만들기</h3>
                                <p>Azure Cognitive Services 리소스를 만드는 방법을 알아봅니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="cardSize">
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                <h3>요청 인증</h3>
                                <p>Azure Cognitive Services에 대한 API 요청을 인증하는 방법을 알아봅니다.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="cardPadding">
                        <div class="card">
                            ...
                            <div class="cardText">
                                ...
                                <p>오늘날의 개발자 및 기술 책임자에 맞게 조정되고, 업계 공인 Microsoft 인증에 대비할 수 있게 설계된 모듈 또는 학습 경로를 사용하여 기량을 향상시키세요.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>시각</h3>
                        <h4>사진, 동영상 및 디지털 잉크 콘텐츠를 인식 및 식별하고 캡션을 추가하고 인덱싱 및 조정합니다.</h4><br>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Speech</h3>
                        <h4>음성을 텍스트로 변환하고 텍스트를 자연스러운 음성으로 변환합니다. 한 언어를 다른 언어로 번역하고 화자 검증 및 인식 기능을 사용하도록 설정할 수 있습니다.</h4><br>
                        <p><a href="/azure/cognitive-services/speech-service">음성 서비스</a></p>
                        ...
                        <p><a href="/azure/cognitive-services/speech/home"><span>Bing Speech API&nbsp;<sup style="font-size:70%">사용 중지</sup></span></a></p>
                        <p><a href="/azure/cognitive-services/translator-speech/"><span>Translator Speech&nbsp;<sup style="font-size:70%">사용 중지</sup></span></a></p>
                     </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>언어</h3>
                        <h4>앱에서 사전 구축된 스크립트를 통해 자연어를 처리하고, 감성을 평가하며, 사용자가 원하는 것을 인식하는 방법을 학습하도록 지원하세요.</h4><br>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>검색</h3>
                        <h4>Bing Search API를 앱에 추가하고, 단일 API 호출을 통해 수십억 개의 웹 페이지, 이미지, 비디오 및 뉴스를 검색하세요.</h4><br>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>의사 결정 API</h3>
                        <h4>합리적이고 효율적인 의사 결정을 위해 권장 사항을 표시하는 앱을 빌드하세요.</h4><br>
                        <p><a href="/azure/cognitive-services/anomaly-detector/"><span>Anomaly Detector&nbsp;<sup style="font-size:70%">미리 보기</sup></span></a></p>
                        <p><a href="/azure/cognitive-services/content-moderator/">Content Moderator</a></p>
                        <p><a href="https://go.microsoft.com/fwlink/?linkid=2088324"><span>Personalizer&nbsp;<sup style="font-size:70%">미리 보기</sup></span></a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Computer Vision을 사용하여 이미지 분석</h3>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>LUIS를 사용하여 의도 알기</h3>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-cs-get-intent">C# 사용</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-java-get-intent">Java 사용</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-node-get-intent">Node.js 사용</a></p>
                        <p><a href="/azure/cognitive-services/luis/luis-get-started-python-get-intent">Python 사용</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Text Analytics를 사용하여 언어 검색, 감정 분석</h3>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/csharp">C# 사용</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/java">Java 사용</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/nodejs">Node.js 사용</a></p>
                        <p><a href="/azure/cognitive-services/Text-Analytics/quickstarts/python">Python 사용</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bing Web Search를 사용하여 관련 웹 쿼리 가져오기</h3>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Bing Image Search를 사용하여 관련 이미지 쿼리 가져오기</h3>
...
<ul class="cardsM panelContent singlePanelContent cols cols3" style="display:flex!important;">
    <li>
        <a class="card" href="/azure/cognitive-services/Computer-vision/tutorials/csharptutorial" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>Computer Vision API를 사용하여 앱 만들기</h3>
            </div>
        </a>
    </li>
    <li>
        <a class="card" href="/azure/cognitive-services/speech-service/how-to-recognize-intents-from-speech-csharp" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText" >
                <h3>Speech SDK 및 LUIS를 사용하여 의도 인식</h3>
            </div>
        </a>
    </li>
    <li>
    ...
    <li>
        <a class="card" href="/azure/cognitive-services/Text-Analytics/tutorials/tutorial-power-bi-key-phrases" data-linktype="external"><img class="cardImage" alt="" src="media/index/i_tasks.svg" data-linktype="external">
            <div class="cardText">
                <h3>Power BI와 함께 Text Analytics 사용</h3>
            </div>
        </a>
    </li>
    <li>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3></h3>
                        <p><a href="https://docs.microsoft.com/rest/api/cognitiveservices/">REST API</a></p>
                     </div>
                </div>
            </div>
        </div>
