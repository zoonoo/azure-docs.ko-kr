...
| 음성 | 사용자 지정 명령 | https://speech.microsoft.com/ | [빠른 시작](./speech-service/custom-commands.md) |
| 음성 | Custom Speech | https://speech.microsoft.com/ | [빠른 시작](./speech-service/custom-speech-overview.md) |
| 음성 | Custom Voice | https://speech.microsoft.com/ | [빠른 시작](./speech-service/how-to-custom-voice.md) |  
