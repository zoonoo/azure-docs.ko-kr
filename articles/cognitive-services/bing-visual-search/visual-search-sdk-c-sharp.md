---
title: Visual search SDK C# 빠른 시작 | Microsoft Docs
...
ms.locfileid: "37026307"
---
# <a name="visual-search-sdk-c-quickstart"></a>Visual search SDK C# 빠른 시작
...
Bing search 샘플에서는 SDK의 다양한 기능을 보여줍니다.  다음 함수를 이전에 정의된 `VisualSrchSDK` 클래스에 추가합니다.
...
## <a name="tags-actions-and-actiontype"></a>태그, 동작 및 actionType
