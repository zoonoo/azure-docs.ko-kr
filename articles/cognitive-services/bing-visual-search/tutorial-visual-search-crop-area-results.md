...
Bing Web Search SDK를 사용하여 콘솔 애플리케이션을 설정하려면 Visual Studio의 솔루션 탐색기에서 NuGet 패키지 관리 옵션을 찾습니다. Microsoft.Azure.CognitiveServices.Search.VisualSearch 패키지를 추가합니다.
