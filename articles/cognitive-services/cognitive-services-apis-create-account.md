...
3. **만들기** 페이지에서 다음 정보를 제공합니다.
    ...
    **만들기**를 클릭합니다.
    ...
    ![단일 리소스 생성 화면](media/cognitive-services-apis-create-account/resource_create_screen.png)
