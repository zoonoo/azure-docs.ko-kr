---
title: Knowledge Exploration Service API의 구조화된 쿼리 식 | Microsoft Docs
description: Cognitive Services의 KES(Knowledge Exploration Service) API에서 구조화된 쿼리 식을 사용하는 방법에 대해 알아봅니다.
