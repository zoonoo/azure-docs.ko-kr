---
title: Knowledge Exploration Service 시작 | Microsoft Docs
description: KES(Knowledge Exploration Service)를 사용하여 Microsoft Cognitive Services의 학술 게시에 대한 대화형 검색 환경 엔진을 만듭니다.
...
사용 가능한 VM 크기 목록은 [가상 머신의 크기](../../../articles/virtual-machines/virtual-machines-windows-sizes.md)를 참조하세요.
