---
title: Knowledge Exploration Service API의 의미 해석 | Microsoft Docs
description: Cognitive Services의 KES(Knowledge Exploration Service) API에서 의미 해석을 사용하는 방법에 대해 알아봅니다.
