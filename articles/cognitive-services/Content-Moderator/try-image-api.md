...
Azure 콘텐츠 중재자의 [이미지 중재 API를](https://westus.dev.cognitive.microsoft.com/docs/services/57cf753a3f9b070c105bd2c1/operations/57cf753a3f9b070868a1f66c) 사용하여 이미지 콘텐츠에 대한 검색 및 검토 검토 워크플로를 시작합니다. 중재 작업은 콘텐츠를 비속어로 검사하고 사용자 지정 및 공유 차단 목록과 비교합니다.
...
4. **전송을 선택합니다.** 이 예제에서는 API가 두 얼굴을 찾아서 이미지의 해당 좌표를 반환합니다.
...
5. **전송을 선택합니다.** 추출된 텍스트는 JSON으로 표시됩니다.

   ![이미지 - OCR 샘플 응답 콘텐츠 상자](images/try-image-api-ocr.PNG)

## <a name="next-steps"></a>다음 단계

코드에서 REST API를 사용하거나 [.NET SDK 퀵스타트를](dotnet-sdk-quickstart.md) 따라 응용 프로그램에 이미지 조정을 추가합니다.
