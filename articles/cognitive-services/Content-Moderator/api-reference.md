...
- [Content Moderator 검토 도구](https://contentmoderator.cognitive.microsoft.com/)로 등록하려면 [웹에서 Content Moderator 사용해 보기](quick-start.md)를 참조하세요.
...
| **Text Moderation API**<br /><br />텍스트 콘텐츠를 검사합니다. 욕설 및 개인 정보가 반환됩니다. <br /><br />이 정보를 사용하여 수정 후 워크플로의 콘텐츠를 게시, 거부 또는 검토합니다.<br /><br /> | [Text Moderation API 참조](https://westus.dev.cognitive.microsoft.com/docs/services/57cf753a3f9b070c105bd2c1/operations/57cf753a3f9b070868a1f66f "Text Moderation API 참조")   |
