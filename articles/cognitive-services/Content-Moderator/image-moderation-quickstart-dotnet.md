---
title: Azure Content Moderator - .NET을 사용한 이미지 조정 | Microsoft Docs
description: .NET용 Azure Content Moderator SDK를 사용하여 이미지를 조정하는 방법
...
ms.locfileid: "35373174"
---
# <a name="moderate-images-using-net"></a>.NET을 사용하여 이미지 조정
