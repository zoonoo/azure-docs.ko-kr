---
title: Azure Content Moderator에서 사용자 지정 용어 목록을 사용하여 텍스트 조정 | Microsoft Docs
description: Content Moderator API 콘솔에서 사용자 지정 용어 목록을 시험 사용합니다.
...
코드에서 REST API를 사용하거나 [용어 목록 .NET 빠른 시작](term-lists-quickstart-dotnet.md)을 시작하여 응용 프로그램을 통합합니다.
