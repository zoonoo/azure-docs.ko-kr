...
| Data | 내보내기 작업 | 삭제 작업 |
| ---- | ---------------- | ---------------- |
| 계정 정보(구독 키) | 해당 없음 | Azure Portal(Azure 구독)을 사용하여 삭제합니다. 또는 **검토 UI** 팀 설정 페이지에서 [팀 삭제](https://contentmoderator.cognitive.microsoft.com/) 단추를 사용합니다. |
...
| 태그 | 해당 없음 | 검토 UI 태그 설정 페이지에서 각 태그에 대해 사용할 수 있는 **삭제** 아이콘을 사용합니다. 또는 **검토 UI** 팀 설정 페이지에서 [팀 삭제](https://contentmoderator.cognitive.microsoft.com/) 단추를 사용합니다. |
| 검토 | [검토 가져오기 API](https://westus.dev.cognitive.microsoft.com/docs/services/580519463f9b070e5c591178/operations/580519483f9b0709fc47f9c2) 호출 | **검토 UI** 팀 설정 페이지에서 [팀 삭제](https://contentmoderator.cognitive.microsoft.com/) 단추를 사용합니다.
| 사용자 | 해당 없음 | **검토 UI** 팀 설정 페이지에서 각 사용자에 대해 사용할 수 있는 [삭제](https://contentmoderator.cognitive.microsoft.com/) 아이콘을 사용합니다. 또는 **검토 UI** 팀 설정 페이지에서 [팀 삭제](https://contentmoderator.cognitive.microsoft.com/) 단추를 사용합니다. |
