---
title: Azure Cognitive Services, 텍스트 분석 API에 대한 Node.js 빠른 시작 | Microsoft Docs
...
ms.locfileid: "43840425"
---
# <a name="quickstart-for-text-analytics-api-with-nodejs"></a>텍스트 분석 API 및 Node.js에 대한 빠른 시작 
<a name="HOLTop"></a>
