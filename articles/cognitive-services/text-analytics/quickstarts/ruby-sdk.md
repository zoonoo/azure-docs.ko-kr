---
title: '빠른 시작: Ruby용 Text Analytics 클라이언트 라이브러리 | Microsoft Docs'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작에서는 Azure Cognitive Services의 Ruby Text Analytics 클라이언트 라이브러리를 사용하여 언어를 감지합니다.
