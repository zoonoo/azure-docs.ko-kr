---
title: Text Analytics API에 대한 FAQ(질문과 대답) - Azure Cognitive Services | Microsoft Docs
description: Azure에서 Microsoft Cognitive Services Text Analytics API에 대한 일반적인 질문에 대한 대답을 가져옵니다.
