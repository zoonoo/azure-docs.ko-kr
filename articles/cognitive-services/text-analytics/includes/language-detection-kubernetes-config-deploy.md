...
1. 텍스트 편집기 내에서 *language.yaml* 이라는 새 파일을 만들고 다음 YAML을 붙여넣습니다. `billing/value` 및 `apikey/value`를 사용자 고유의 정보로 바꿉니다.
...
1. *language.yaml* 파일을 대상으로 하여 Kubernetes `apply` 명령을 실행합니다.
