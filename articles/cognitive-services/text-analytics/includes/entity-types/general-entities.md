...
|------------|-------------|--------------------------------------|-------------------------------------------------------------|--------------------------------------|
| Person     | N/A         | 사람의 이름입니다.  | `2019-10-01`  | NER v 2.1에서 반환 됩니다. |
...
| Product | N/A | 다양 한 범주의 물리적 개체 | `2020-02-01` | |
| Product | 제품 컴퓨팅 | 제품을 계산 합니다. |  `2020-02-01 ` | |
...
| Email | N/A | 전자 메일 주소. | `2019-10-01` | NER v 2.1에서 반환 됩니다. |
