...
자세한 내용은 [지원 언어](../text-analytics-supported-languages.md)를 참조하세요.
...
이 문서에서는 Cognitive Services에서 Text Analytics를 사용 하 여 핵심 문구 추출에 대 한 개념과 워크플로를 배웠습니다. 요약하자면 다음과 같습니다.
...
+ POST 요청은 개인 설정된 [액세스 키와 구독에 유효한 끝점](../../cognitive-services-apis-create-account.md#get-the-keys-for-your-resource)을 사용하여 `/keyphrases` 끝점에 대해 수행됩니다.
