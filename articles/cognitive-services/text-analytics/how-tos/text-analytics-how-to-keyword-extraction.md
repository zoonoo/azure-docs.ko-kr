...
+ **POST** 요청을 만듭니다. 이 요청에 대한 API 문서인 [핵심 문구 API](https://westcentralus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v2-1/operations/56f30ceeeda5650db055a3c6)를 확인합니다.
