...
Text Analytics [버전 2.1](https://westcentralus.dev.cognitive.microsoft.com/docs/services/TextAnalytics-v2-1/operations/5ac4251d5b4ccd1554da7634)에서는 엔터티 연결 및 명명 된 엔터티 인식 (NER)을 여러 언어로 사용할 수 있습니다. 자세한 내용은 [언어 지원](../language-support.md#sentiment-analysis-key-phrase-extraction-and-named-entity-recognition) 문서를 참조 하세요.
...
+ POST 요청은 개인 설정된 [액세스 키와 구독에 유효한 끝점](../../cognitive-services-apis-create-account.md#get-the-keys-for-your-resource)을 사용하여 `/entities` 끝점에 대해 수행됩니다.
