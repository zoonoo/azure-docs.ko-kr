...
이 기능에 대한 언어의 정확한 목록을 게시하지는 않습니다. 하지만 다양한 언어, 변형, 방언 및 일부 국가/문화권 언어를 감지할 수 있습니다. 
...
\*\* 해당 언어의 경우, 명명된 엔터티 인식과 [엔터티 링크](how-tos/text-analytics-how-to-entity-linking.md) 모두 사용 가능합니다.    
