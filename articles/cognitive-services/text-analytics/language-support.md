...
ms.locfileid: "112078261"
---
# <a name="text-analytics-api-v3-language-support"></a>Text Analytics API v3 언어 지원 

> [!NOTE]
> 특정 Text Analytics 기능에 대한 새 모델 버전이 릴리스됨에 따라 언어가 추가됩니다. 사용 중인 기능에 대한 최신 모델 버전 및 자세한 내용은 [모델 버전 관리](concepts/model-versioning.md)를 참조하세요.   
