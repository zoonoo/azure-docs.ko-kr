...
---
코그너티브 서비스는 언어 [이해와](../luis/what-is-luis.md) [QnA Maker라는](../qnamaker/overview/overview.md)두 가지 자연어 처리 서비스를 제공하며, 각각 다른 목적을 가지고 있습니다. 각 서비스를 사용해야 하는 시기와 각 서비스를 어떻게 칭찬하는지 이해한다.
