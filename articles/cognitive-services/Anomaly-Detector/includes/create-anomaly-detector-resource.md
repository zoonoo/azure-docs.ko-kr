...
ms.locfileid: "67717110"
---
## <a name="create-an-anomaly-detector-resource"></a>비정상 탐지기 리소스 만들기

1. [Azure Portal](https://portal.azure.com)에 로그인합니다.
1. 클릭 [Create **이상 감지기** ](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesAnomalyDetector) 리소스
1. 모든 필수 설정을 입력 합니다.
    ...
    |미리 보기 확인 확인란을 선택 (필수)|읽은 여부는 **미리 보기** 확인|
...
1. 수집 구성 `endpoint` 및 API 키:
    ...
    |포털에서 리소스 탭|설정|값|
    |--|--|--|
    |**개요**|엔드포인트|끝점을 복사 합니다. 유사 하 게 표시 `https://westus2.api.cognitive.microsoft.com/`|
