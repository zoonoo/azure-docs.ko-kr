...
| 기능 목록 | 아니요 | 영숫자 문자 <br> 최대 길이: 4000, 최대 기능 수: 20 | 쉼표로 구분된 기능 이름 목록=모델 권장을 강화하기 위해 사용할 수 있는 기능 값.|
...
| 이름 | 필수 | 형식 | 설명
|-------|------------|------|---------------
|User Id| 예|[A-z], [a-z], [0-9], [\_] &#40;밑줄&#41;, [-] &#40;대시&#41;<br> 최대 길이: 255 |사용자의 고유 식별자. 
|Item Id|Yes|[A-z], [a-z], [0-9], [&#95;] &#40;밑줄&#41;, [-] &#40;대시&#41;<br> 최대 길이: 50|항목의 고유 식별자. 
|시간|예|시간 형식: YYYY/MM/DDTHH:MM:SS (e.g. 2013/06/20T10:00:00)|데이터의 시간. 
|이벤트|번호 | 다음 중 하나:<br>• 클릭<br>• RecommendationClick<br>• AddShopCart<br>• RemoveShopCart<br>• 구매| 트랜잭션의 형식. |
