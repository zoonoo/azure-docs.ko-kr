...
이 가이드에서는 [첫 번째 버전의 API](../machine-learning-apps-text-analytics/)를 사용하는 코드를 두 번째 버전으로 업그레이드하는 프로세스를 안내합니다.
...
1. [Cortana 분석 갤러리](//gallery.cortanaanalytics.com/MachineLearningAPI/Text-Analytics-2)를 통해 텍스트 분석 서비스로 이동합니다. 여기에는 설명서 및 코드 샘플에 대한 링크도 있습니다.

1. **등록**을 클릭합니다. 이 링크를 클릭하면 서비스에 등록할 수 있는 Azure 관리 포털로 이동합니다.

1. 요금제를 선택합니다. **월별 5,000트랜잭션당 무료 계층**을 선택할 수 있습니다. 무료 요금제이므로 서비스 사용 요금이 청구되지 않습니다. Azure 구독에 로그인해야 합니다.
