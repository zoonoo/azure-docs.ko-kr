...
| 조각 이름 | Description                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 도메인     | 도메인 조각에는 인터넷 도메인 내에서 찾은 모든 콘텐츠가 포함됩니다. `www.microsoft.com` )을 입력합니다. `www.`를 생략하면 Bing에서 도메인의 하위 도메인도 검색합니다. 예를 들어를 지정 `microsoft.com`하는 경우 Bing은 또는 `technet.microsoft.com`에서 `support.microsoft.com` 결과를 반환 합니다. |
| 하위 페이지    | 하위 페이지 조각에는 하위 페이지와 그 아래 경로에서 찾은 모든 콘텐츠가 포함됩니다. 경로에서 최대 두 개의 하위 페이지를 지정할 수 있습니다. 예를 들면 `www.microsoft.com/en-us/windows/`                                                                                                                       |
...
|            |                                                                                                                                                                      |
|------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 블록      | 도메인, 하위 페이지 또는 웹 페이지를 차단됨 목록으로 이동합니다. Bing에서는 선택한 사이트의 콘텐츠가 검색 결과에 표시되지 않습니다.                    |
