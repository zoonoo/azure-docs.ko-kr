...
| 조각 이름 | Description                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 도메인     | 도메인 조각에는 인터넷 도메인 내에서 찾은 모든 콘텐츠가 포함됩니다. `www.microsoft.com`)을 입력합니다. `www.`를 생략하면 Bing에서 도메인의 하위 도메인도 검색합니다. 예를 들어를 지정 `microsoft.com`하는 경우 Bing은 또는 `support.microsoft.com` `technet.microsoft.com`에서 결과를 반환 합니다. |
