...
| 조각 이름 | 설명                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Domain     | 도메인 조각에는 인터넷 도메인 내에서 찾은 모든 콘텐츠가 포함됩니다. 예: `www.microsoft.com`. `www.`를 생략하면 Bing에서 도메인의 하위 도메인도 검색합니다. 예를 들어 `microsoft.com`지정 하는 경우 Bing은 `support.microsoft.com` 또는 `technet.microsoft.com`에서 결과를 반환 합니다. |
