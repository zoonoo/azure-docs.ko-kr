...
description: 포털에서 웹 조각을 지정 하는 검색 인스턴스를 만들 수 있습니다. 도메인, 하위 페이지 및 웹 페이지.
...
| 조각 이름 | Description                                                                                                                                                                                                                                                                                                |
|------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 도메인     | 도메인 조각에는 인터넷 도메인 내에서 찾은 모든 콘텐츠가 포함됩니다. 예들 들어 `www.microsoft.com`입니다. `www.`를 생략하면 Bing에서 도메인의 하위 도메인도 검색합니다. 예를 들어를 지정 하는 경우 `microsoft.com` Bing은 또는에서 결과를 반환 합니다 `support.microsoft.com` `technet.microsoft.com` . |
...
**활성** 목록의 **순위 조정** 컨트롤을 사용 하거나 미리 보기 창에서 상승 및 수준 내리기 컨트롤을 사용 하 여 항목을 승격 하거나 승격 하거나 수준을 내릴 수 있습니다. 활성 목록에 조각이 추가되고 그에 따라 순위가 조정됩니다.
