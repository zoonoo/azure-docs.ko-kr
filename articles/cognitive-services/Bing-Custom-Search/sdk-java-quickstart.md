...
ms.locfileid: "71147405"
---
# <a name="quickstart-bing-custom-search-client-library-for-java"></a>빠른 시작: Java용 Bing Custom Search 클라이언트 라이브러리

Java용 Bing Custom Search 클라이언트 라이브러리를 시작합니다. 이러한 단계에 따라 패키지를 설치하고 기본 작업을 위한 예제 코드를 사용해 봅니다. Bing Custom Search API를 사용하면 관심 있는 토픽에 대한 맞춤형 광고 없는 검색 경험을 만들 수 있습니다.
...
평가판 구독 또는 리소스에서 키를 가져오면 `AZURE_BING_CUSTOM_SEARCH_API_KEY`라는 키에 대한 [환경 변수를 만듭니다](https://docs.microsoft.com/azure/cognitive-services/cognitive-services-apis-create-account#configure-an-environment-variable-for-authentication).
