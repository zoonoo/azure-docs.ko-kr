...
ms.locfileid: "57871588"
---
# <a name="quickstart-call-your-bing-custom-search-endpoint-using-the-c-sdk"></a>Quickstart: Call your Bing Custom Search endpoint using the C# SDK 
...
## <a name="create-and-initialize-the-application"></a>Create and initialize the application
...
## <a name="send-the-search-request-and-receive-a-response"></a>Send the search request and receive a response
