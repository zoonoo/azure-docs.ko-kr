...
|도메인|목적|
|---|---|
|__일반__| 광범위한 이미지 분류 작업에 최적화되었습니다. 다른 특정 도메인도 적절 하지 않거나 선택할 도메인을 잘 모를 경우 일반 도메인 중 하나를 선택 합니다. ID: `ee85a74c-405e-4adc-bb47-ffa8ca0c9f31`|
...
|__일반 [A2]__| 일반 [A1] 및 일반 도메인 보다 더 빠른 유추 시간으로 더 나은 정확도를 위해 최적화 되었습니다. 대부분의 데이터 집합에 권장 됩니다. 이 도메인은 일반적인 [A1] 도메인 보다 학습 시간이 더 적습니다. ID: `2e37d7fb-3a54-486a-b4d6-cfc369af0018` |
...
> [!NOTE]
> 일반 [A1] 및 일반 [A2] 도메인은 광범위 한 시나리오에 사용할 수 있으며 정확도를 위해 최적화 되어 있습니다. 더 나은 유추 속도와 학습 시간을 단축 하기 위해 일반 [A2] 모델을 사용 합니다. 더 큰 데이터 집합의 경우에는 일반적인 [A1]을 사용 하 여 더 많은 학습 및 유추 시간이 필요 하지만 일반 [A2] 보다 정확도를 향상 시킬 수 있습니다. 일반 모델에는 일반 [A1] 및 일반 [A2] 보다 더 많은 유추 시간이 필요 합니다.
