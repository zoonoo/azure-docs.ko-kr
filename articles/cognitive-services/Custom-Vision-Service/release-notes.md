...
- 성인 도메인을 제거 합니다. 일반 도메인 대신이 좋습니다.
- 발표 [가격 책정](https://azure.microsoft.com/pricing/details/cognitive-services/custom-vision-service/) 일반 공급 됩니다.  
...
특수 문자를 사용 하 여 ONNX 내보내기에 대 한 포함 되는 버그 수정.
...
- 버그 수정 및 백 엔드 개선 합니다.
- 이미지 레이블 하나만 있는 프로젝트에 대 한 다중 클래스 분류를 사용할 수 있습니다. 다중 클래스 모드에 대 한 예측의 확률 하나으로 합계 됩니다 (모든 이미지는 지정 된 태그 간에 분류).
...
- 유료 미리 보기로 및 Azure portal에 온 보 딩을 입력 합니다. 이제 F0(무료) 또는 S0(표준) 계층으로 Azure 리소스에 프로젝트를 연결할 수 있습니다. 최대 태그 100개 이미지 25,000개까지 허용하는 S0 계층 프로젝트가 도입되었습니다.
