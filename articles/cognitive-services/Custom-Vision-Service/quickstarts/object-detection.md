---
title: '빠른 시작: Custom Vision SDK를 사용하여 개체 검색 만들기'
description: '빠른 시작: Custom Vision SDK를 사용하여 프로젝트를 만들고, 태그를 추가하고, 이미지를 업로드하고, 프로젝트를 학습하고, 개체를 검색합니다.'
...
ms.locfileid: "87407316"
---
# <a name="quickstart-create-an-object-detection-project-with-the-custom-vision-sdk"></a>빠른 시작: Custom Vision SDK를 사용하여 개체 검색 프로젝트 만들기
