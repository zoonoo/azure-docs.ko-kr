---
title: '자습서: Python용 Custom Vision SDK를 사용하여 개체 검색 프로젝트 만들기 - Custom Vision Service'
...
ms.locfileid: "49958536"
---
# <a name="tutorial-create-an-object-detection-project-with-the-custom-vision-sdk-for-python"></a>Python용 Custom Vision SDK를 사용하여 개체 검색 프로젝트 만들기
