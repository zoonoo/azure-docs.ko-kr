---
title: 언어 지원 - Bing Image Search API
...
Bing News Search 엔드포인트에 대한 자세한 내용은 [News Image Search API v7 참조](/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference)를 참조하세요.