...
원본 이미지에 있는 제품과 시각적으로 유사한 제품을 포함하는 이미지를 찾으려면 [모듈](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-images-api-v7-reference#modulesrequested) 쿼리 매개 변수를 SimilarProducts로 설정합니다.  
