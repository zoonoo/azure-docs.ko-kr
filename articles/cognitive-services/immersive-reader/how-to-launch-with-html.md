---
title: HTML 콘텐츠를 사용 하 여 몰입 형 판독기 시작
...
컨테이너 요소 내에서 몰입 형 판독기에 렌더링 하려는 콘텐츠를 저장 합니다. Container 요소에 고유한 `id`있어야 합니다. 몰입 형 판독기는 기본 HTML 요소에 대 한 지원을 제공 합니다. 자세한 내용은 [참조](./reference.md#html-support) 를 참조 하세요.
...
`ImmersiveReader.launchAsync`를 호출 하는 경우 청크의 `mimeType` 속성을 `text/html`로 설정 하 여 HTML 렌더링을 사용 하도록 설정 합니다.
