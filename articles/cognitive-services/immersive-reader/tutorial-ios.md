...
ms.locfileid: "86049331"
---
# <a name="tutorial-launch-the-immersive-reader-using-the-swift-ios-code-sample"></a>자습서: Swift iOS 코드 샘플을 사용하여 몰입형 리더 시작
...
> [!div class="checklist"]
> * 샘플 프로젝트를 사용하여 iOS용 Swift 앱 구성 및 실행
> * 액세스 토큰 획득
...
2. 상단 메뉴에서 **제품 > 구성표 > 구성표 편집...** 을 클릭합니다.
3. **실행** 보기에서 **인수** 탭을 클릭합니다.
4. **환경 변수** 섹션에서 몰입형 판독기 리소스를 만들 때 지정된 값을 제공하여 다음 이름 및 값을 추가합니다.
...
이 파일에는 공개되어서는 안 되는 비밀이 있으므로 위의 변경 사항을 소스 제어에 커밋하지 마십시오.

## <a name="launch-the-immersive-reader-with-sample-content"></a>샘플 콘텐츠를 사용하여 몰입형 판독기 시작

1. Xcode에서 **Ctrl-R** 키를 눌러서 프로젝트를 실행합니다.
