...
ms.locfileid: "86049325"
---
# <a name="tutorial-launch-the-immersive-reader-using-the-android-java-code-sample"></a>자습서: Android Java 코드 샘플을 사용하여 몰입형 리더 시작
...
> [!div class="checklist"]
> * 샘플 프로젝트를 사용하여 Android용 앱 구성 및 실행
> * 액세스 토큰 획득
...
2. **/assets** 폴더에 **env**라는 파일을 만들고 다음을 추가하여 적절한 값을 제공합니다. 이 파일에는 공개되어서는 안 되는 비밀이 있으므로 이 파일을 소스 제어에 커밋하지 않아야 합니다.
...
1. AVD Manager에서 디바이스 에뮬레이터를 선택하고 프로젝트를 실행합니다.
