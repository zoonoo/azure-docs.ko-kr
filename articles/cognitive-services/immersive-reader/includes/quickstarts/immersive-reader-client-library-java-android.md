...
```
![Android Studio의 환경 변수를 보여주는 스크린샷.](../../media/android/java/android-studio-assets-and-env-file.png)
...
## <a name="set-up-the-app-java-code"></a>앱 Java 코드 설정
...
새 **AuthenticationTask.java** Java 클래스 파일을 만듭니다.
