...
[개요](./overview.md)에서는 몰입형 판독기란 무엇이며 어떻게 언어 학습자, 신흥 독자 및 학습 차이가 있는 사람들의 독해력 향상을 위해 입증된 기술을 구현하는지에 대해 알아보았습니다. 이 문서에서는 몰입형 리더 JavaScript, Python, Android 또는 iOS를 시작하는 방법을 보여줍니다. 
