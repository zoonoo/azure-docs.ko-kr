...
| Name | 유형 | 설명 |
| ---- | ---- |------------ |
| `options` | [renderButtons 옵션](#renderbuttons-options) | RenderButtons 함수의 특정 동작을 구성 하는 옵션입니다. (선택 사항) |
...
| application/mathml + xml | MathML (수학 Markup Language). [자세히 알아봅니다](./how-to/display-math.md).
