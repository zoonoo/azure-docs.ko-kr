---
title: '빠른 시작: Ruby를 사용하여 검색 수행 - Bing Web Search API'
titleSuffix: Azure Cognitive Services
description: 이 빠른 시작에서는 Ruby를 사용하여 Bing Web Search API를 처음 호출하고 JSON 응답을 받는 방법을 알아봅니다.
