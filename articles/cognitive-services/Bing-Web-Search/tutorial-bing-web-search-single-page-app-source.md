---
title: Bing Web Search 단일 페이지 웹앱(소스 코드) | Microsoft Docs
description: 단일 페이지 웹 응용 프로그램에서 Bing Web Search API를 사용하는 방법을 보여 주는 자습서의 소스 코드입니다.
...
ms.locfileid: "35373135"
---
# <a name="tutorial-single-page-web-app"></a>자습서: 단일 페이지 웹앱

Bing Web Search에 대한 [단일 페이지 앱 자습서](tutorial-bing-web-search-single-page-app.md)에서 설명하는 전체 소스 코드입니다. 앱을 실행하려면 소스 코드를 메모장이나 다른 텍스트 편집기에 복사하고 `bing.html`로 저장합니다. 그런 다음, Microsoft Edge 또는 다른 인기 브라우저에서 저장된 파일을 엽니다.
