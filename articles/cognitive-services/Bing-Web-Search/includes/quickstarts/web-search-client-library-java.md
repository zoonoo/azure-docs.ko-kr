---
title: Bing Web Search Java 클라이언트 라이브러리 빠른 시작
...
지금 코드를 보시겠나요? [Java용 Bing Search 클라이언트 라이브러리](https://github.com/Azure-Samples/cognitive-services-java-sdk-samples/tree/master/Search) 샘플은 GitHub에서 사용할 수 있습니다.
...
* [Azure Java SDK 참조](/java/api/overview/azure/cognitiveservices/client/bingwebsearchapi)
