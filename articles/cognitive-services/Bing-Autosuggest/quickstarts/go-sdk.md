---
title: '빠른 시작: Go용 Bing Autosuggest 클라이언트 라이브러리 | Microsoft Docs'
description: Go용 Bing Autosuggest 클라이언트 라이브러리를 시작하고, 부분 쿼리 문자열을 기반으로 검색 제안을 가져옵니다.
...
ms.locfileid: "80238997"
---
# <a name="quickstart-bing-autosuggest-client-library-for-go"></a>빠른 시작: Go용 Bing Autosuggest 클라이언트 라이브러리
