---
title: '빠른 시작: .NET용 Bing Autosuggest 클라이언트 라이브러리 | Microsoft Docs'
description: .NET용 Bing Autosuggest 클라이언트 라이브러리를 시작하고, 부분 쿼리 문자열을 기반으로 검색 제안을 가져옵니다.
...
ms.locfileid: "75462324"
---
# <a name="quickstart-bing-autosuggest-client-library-for-net"></a>빠른 시작: .NET용 Bing Autosuggest 클라이언트 라이브러리
