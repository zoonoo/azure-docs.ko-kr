...
이 업그레이드 가이드는 Bing Autosuggest API 버전 5와 버전 7 사이의 변경 내용을 식별합니다. 버전 7을 사용하도록 응용 프로그램을 업데이트하는 데 도움이 되는 이 가이드를 사용합니다.

## <a name="breaking-changes"></a>호환성이 손상되는 변경

### <a name="endpoints"></a>엔드포인트

- 엔드포인트의 버전 번호가 v5에서 v7로 변경되었습니다. 예를 들어 https:\/\*\*/api.cognitive.microsoft.com/bing/ v7.0**/제안.
