...
ms.locfileid: "51345626"
---
# <a name="tutorial-single-page-web-app"></a>자습서: 단일 페이지 웹앱

Bing Autosuggest API에 대한 [단일 페이지 앱 자습서](autosuggest.md)에서 설명하는 전체 소스 코드입니다. 앱을 실행하려면 소스 코드를 텍스트 편집기에 복사하고 `autosuggest.html` 파일로 저장합니다. 그런 다음, 웹 브라우저에서 저장된 파일을 엽니다.
