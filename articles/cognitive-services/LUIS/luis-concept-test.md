...
## <a name="batch-testing"></a>테스트 일괄 처리
...
LUIS가 확신하지 않는 모든 발언은 **LUIS[ 웹 사이트의 ](luis-how-to-review-endpoint-utterances.md)** 엔드포인트 발언 검토[](luis-reference-regions.md) 페이지에 나열됩니다. 
