---
title: Python을 사용하여 LUIS(Language Understanding) 앱을 호출하는 방법을 알아보는 자습서 | Microsoft Docs
...
ms.locfileid: "36264587"
---
# <a name="tutorial-call-a-luis-endpoint-using-python"></a>자습서: Python을 사용하여 LUIS 엔드포인트 호출
...
2. `Ocp-Apim-Subscription-Key` 필드 값을 LUIS 구독 키로 바꿉니다.

3. 스크립트를 실행합니다. 브라우저 창에서 앞서 본 것과 동일한 JSON을 표시합니다.
<!-- 
