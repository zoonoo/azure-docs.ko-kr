...
> [!CAUTION]
> 편의를 위해 대부분의 샘플은 [할당량](luis-limits.md#key-limits)에 몇 가지 무료 예측 끝점 호출을 제공 하므로 [스타터 키](#starter-key) 를 사용 합니다.
...
**마이그레이션된 [리소스](luis-migration-authoring.md) 를 마이그레이션한 사용자의 경우**: 리소스 소유자는를 `contributor`추가할 수 있습니다.
