...
1. **number** 엔터티를 앱에 추가하고 앱을 [학습](interactive-test.md) 및 [게시](PublishApp.md)합니다.
...
1. **datetimeV2** 엔터티를 앱에 추가하고 앱을 [학습](interactive-test.md) 및 [게시](PublishApp.md)합니다.
2. **앱 게시** 페이지에서 끝점 URL을 클릭하여 웹 브라우저에서 LUIS 끝점을 엽니다. 
