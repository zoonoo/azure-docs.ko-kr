...
다음 섹션에서는 [Traffic Manager PowerShell cmdlet](/powershell/module/az.trafficmanager/#traffic_manager)을 사용합니다.
...
**[New-AzResourceGroup](/powershell/module/az.resources/new-azresourcegroup)** cmdlet을 사용하여 리소스 그룹을 만듭니다.
...
2. [LUIS][LUIS] 웹 사이트의 **관리** 섹션에 있는 **Azure Resources** 페이지에서 앱에 키를 할당하고, 오른쪽 상단 메뉴의 **게시** 단추를 선택하여 앱을 다시 게시합니다.
...
각 LUIS 엔드포인트에는 고유한 경로가 필요하므로 고유한 Traffic Manager 프로필이 필요합니다. 프로필을 관리하려면[‘중첩’ Traffic Manager](../../traffic-manager/traffic-manager-nested-profiles.md) 아키텍처를 만듭니다. 하나의 부모 프로필은 자식 프로필을 가리키고 이러한 프로필의 트래픽을 관리합니다.
...
1. **[New-AzTrafficManagerProfile](/powershell/module/az.trafficmanager/new-aztrafficmanagerprofile)** cmdlet을 사용하여 프로필 만들기
...
2. **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.trafficmanager/add-aztrafficmanagerendpointconfig)** cmdlet을 사용하여 미국 동부 엔드포인트 추가
...
3. **[Set-AzTrafficManagerProfile](/powershell/module/az.trafficmanager/set-aztrafficmanagerprofile)** cmdlet을 사용하여 미국 동부 엔드포인트 설정
...
2. **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** cmdlet을 사용하여 미국 서부 엔드포인트 추가
...
3. **[Set-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/Set-azTrafficManagerProfile)** cmdlet을 사용하여 미국 서부 엔드포인트 설정
...
1. **[New-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/New-azTrafficManagerProfile)** cmdlet을 사용하여 부모 프로필 만들기
...
2. **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** 및 **NestedEndpoints** 형식을 사용하여 부모에 미국 동부 자식 프로필 추가
    ...
    |-Type|NestedEndpoints|자세한 내용은 [Add-AzTrafficManagerEndpointConfig](/powershell/module/az.trafficmanager/Add-azTrafficManagerEndpointConfig)를 참조하세요. |
...
3. **[Add-AzTrafficManagerEndpointConfig](/powershell/module/az.TrafficManager/Add-azTrafficManagerEndpointConfig)** cmdlet 및 **NestedEndpoints** 형식을 사용하여 부모에 미국 서부 자식 프로필 추가
...
4. **[Set-AzTrafficManagerProfile](/powershell/module/az.TrafficManager/Set-azTrafficManagerProfile)** cmdlet을 사용하여 엔드포인트 설정
