---
title: PHP를 사용하여 LUIS(Language Understanding) 앱 호출 | Microsoft Docs
...
ms.locfileid: "36265129"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>자습서: PHP를 사용하여 LUIS 엔드포인트 호출
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>PHP에서 엔드포인트 API를 사용하여 LUIS 결과 사용 
...
3. PHP 응용 프로그램을 실행합니다. 브라우저 창에서 앞서 본 것과 동일한 JSON을 표시합니다.
