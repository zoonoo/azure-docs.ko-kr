...
1.  [앱 JSON 파일](https://github.com/Azure-Samples/cognitive-services-language-understanding/blob/master/documentation-samples/tutorials/custom-domain-review-HumanResources.json?raw=true)을 다운로드하고 저장합니다.
...
1. 텍스트 편집기에서 `HumanResources-jobs-batch.json`을 만들거나 [다운로드](https://github.com/Azure-Samples/cognitive-services-language-understanding/blob/master/documentation-samples/tutorials/HumanResources-jobs-batch.json?raw=true)합니다.
...
3. **데이터 세트 가져오기**를 선택합니다.
    ...
    > ![데이터 세트 가져오기가 강조 표시된 LUIS 앱의 스크린샷](./media/luis-tutorial-batch-testing/hr-import-dataset-button.png)
...
1. [VSCode](https://code.visualstudio.com/) 같은 텍스트 편집기에서 `HumanResources-entities-batch.json`을 만들거나 [다운로드](https://github.com/Azure-Samples/cognitive-services-language-understanding/blob/master/documentation-samples/tutorials/HumanResources-entities-batch.json?raw=true)합니다.
