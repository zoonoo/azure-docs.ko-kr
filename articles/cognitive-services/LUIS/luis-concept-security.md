...
[LUIS][LUIS] 웹 사이트 또는 [작성 API](https://aka.ms/luis-authoring-apis)에서 앱에 액세스하는 것은 앱 소유자가 제어합니다. 
...
|모델 수정|
|게시|
|[활성 학습](label-suggested-utterances.md)의 끝점 발화 검토|
|학습|
...
|**[게시](publishapp.md)** 페이지에서 추가된 끝점 키|소유자 및 협력자가 끝점 키를 추가할 수 있음|
