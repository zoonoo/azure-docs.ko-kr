...
1. **새 용도 만들기** 대화 상자에서 의도 이름 (예: `ModifyOrder`)을 입력 하 고 **완료**를 선택 합니다.
...
1. 의도 세부 정보 페이지에서 의도 이름 아래에 있는 텍스트 상자와 `Deliver a large cheese pizza` 같이 사용자에 게 필요한 관련 utterance를 입력 한 다음 enter 키를 누릅니다.
