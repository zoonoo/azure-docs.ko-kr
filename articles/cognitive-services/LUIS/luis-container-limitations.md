...
## <a name="supported-dependencies-for-latest-container"></a>`latest` 컨테이너에 대해 지원 되는 종속성
...
## <a name="unsupported-dependencies-for-latest-container"></a>`latest` 컨테이너에 대해 지원 되지 않는 종속성
...
|영어 (`en-US`) 문화권에 대해 지원 되지 않는 엔터티입니다.|[GeographyV2](luis-reference-prebuilt-geographyV2.md) 미리 빌드된 엔터티|
...
| language | Locale | 미리 빌드된 도메인 | 미리 빌드된 엔터티 | 구 목록 권장 사항 | **[Text Analytics](../text-analytics/language-support.md)<br>(감정 및<br>키워드)|
|--|--|:--:|:--:|:--:|:--:|
| 미국 영어 | `en-US` | ✔️ | ✔️ | ✔️ | ✔️ |
