---
title: Ruby를 사용하여 LUIS(Language Understanding) 앱을 호출하는 방법을 알아보는 자습서 | Microsoft Docs
...
ms.locfileid: "36265112"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>자습서: Ruby를 사용하여 LUIS 엔드포인트 호출
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>Ruby에서 엔드포인트 API를 사용하여 LUIS 결과 사용 
...
2. `"YOUR-SUBSCRIPTION-KEY"`를 이 코드 줄(`subscriptionKey = "YOUR-SUBSCRIPTION-KEY"`)의 구독 키로 바꿉니다.

3. Ruby 응용 프로그램을 실행합니다. 브라우저 창에서 앞서 본 것과 동일한 JSON을 표시합니다.
