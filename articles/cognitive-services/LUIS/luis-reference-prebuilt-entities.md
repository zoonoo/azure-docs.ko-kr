...
|한국어|[en-US](#korean-entity-support)||
...
|터키어|[터키어](#turkish-entity-support)|터키어로 지원되는 사전 구축된 엔터티없음|

## <a name="prediction-endpoint-runtime"></a>예측 끝점 런타임

특정 언어로 미리 빌드된 엔터티의 가용성은 예측 끝점 런타임 버전에 의해 결정됩니다.
...
|미리 빌드된 엔터티|```zh-CN``` |
------|:------:|
[Age](luis-reference-prebuilt-age.md):<br>year<br>month<br>week<br>일   |    V2, V3   |
...
[치수 :](luis-reference-prebuilt-dimension.md)<br>볼륨<br>area<br>weight<br>information(예: bit/byte)<br>length(예: meter)<br>speed(예: mile per hour)  |    V2, V3   |
[메일 주소](luis-reference-prebuilt-email.md)   |    V2, V3   |
[GeographyV2](luis-reference-prebuilt-geographyV2.md)   |    -   |
[KeyPhrase](luis-reference-prebuilt-keyphrase.md)   |    -   |
[수](luis-reference-prebuilt-number.md)   |    V2, V3   |
[서](luis-reference-prebuilt-ordinal.md)   |    V2, V3   |
[서수V2](luis-reference-prebuilt-ordinal-v2.md)   |    -   |
[백분율](luis-reference-prebuilt-percentage.md)   |    V2, V3   |
...
[수](luis-reference-prebuilt-number.md)   |    V2, V3   |
[서](luis-reference-prebuilt-ordinal.md)   |    V2, V3   |
[서수V2](luis-reference-prebuilt-ordinal-v2.md)   |    V2, V3   |
[백분율](luis-reference-prebuilt-percentage.md)   |    V2, V3   |
[PersonName](luis-reference-prebuilt-person.md)   |    V2, V3   |
[Phonenumber](luis-reference-prebuilt-phonenumber.md)   |    V2, V3   |
[Temperature](luis-reference-prebuilt-temperature.md):<br>fahrenheit<br>kelvin<br>rankine<br>delisle<br>celsius   |    V2, V3   |
...
이탈리아어 미리 빌드 된 나이, 통화, 차원, 수, 백분율 _해상도_ V2 및 V3 미리 보기에서 변경 되었습니다.
...
|미리 빌드된 엔터티|```ja-JP``` |
------|:------:|
[Age](luis-reference-prebuilt-age.md):<br>year<br>month<br>week<br>일   |    V2, -   |
[통화(금액)](luis-reference-prebuilt-currency.md):<br>달러<br>소수부 단위(예: penny)  |    V2, -   |
[Datetime](luis-reference-prebuilt-deprecated.md)   |    -   |
[치수 :](luis-reference-prebuilt-dimension.md)<br>볼륨<br>area<br>weight<br>information(예: bit/byte)<br>length(예: meter)<br>speed(예: mile per hour)  |    V2, -   |
[메일 주소](luis-reference-prebuilt-email.md)   |    V2, V3   |
[GeographyV2](luis-reference-prebuilt-geographyV2.md)   |    -   |
[KeyPhrase](luis-reference-prebuilt-keyphrase.md)   |    V2, V3   |
[수](luis-reference-prebuilt-number.md)   |    V2, -   |
[서](luis-reference-prebuilt-ordinal.md)   |    V2, -   |
[서수V2](luis-reference-prebuilt-ordinal-v2.md)   |    -   |
[백분율](luis-reference-prebuilt-percentage.md)   |    V2, -   |
[PersonName](luis-reference-prebuilt-person.md)   |    -   |
[Phonenumber](luis-reference-prebuilt-phonenumber.md)   |    V2, V3   |
...
[Datetime](luis-reference-prebuilt-deprecated.md)   |    -   |
[치수 :](luis-reference-prebuilt-dimension.md)<br>볼륨<br>area<br>weight<br>information(예: bit/byte)<br>length(예: meter)<br>speed(예: mile per hour)  |    -   |
[메일 주소](luis-reference-prebuilt-email.md)   |    V2, V3   |
[GeographyV2](luis-reference-prebuilt-geographyV2.md)   |    -   |
[KeyPhrase](luis-reference-prebuilt-keyphrase.md)   |    V2, V3   |
[수](luis-reference-prebuilt-number.md)   |    -   |
[서](luis-reference-prebuilt-ordinal.md)   |    -   |
[서수V2](luis-reference-prebuilt-ordinal-v2.md)   |    -   |
[백분율](luis-reference-prebuilt-percentage.md)   |    -   |
[PersonName](luis-reference-prebuilt-person.md)   |    -   |
[Phonenumber](luis-reference-prebuilt-phonenumber.md)   |    V2, V3   |
