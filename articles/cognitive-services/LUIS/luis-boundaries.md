...
| [미리 빌드된 엔터티](./Pre-builtEntities.md) | 제한 없음|
...
작성 키는 작성 및 끝점에 대한 제한이 다릅니다. LUIS 서비스 구독 키는 끝점 쿼리에만 유효합니다.
...
|[감정 분석 통합](publishapp.md#enable-sentiment-analysis)|잘못됨|무료|핵심 구 데이터 추출을 포함하여 감정 정보 추가 |
