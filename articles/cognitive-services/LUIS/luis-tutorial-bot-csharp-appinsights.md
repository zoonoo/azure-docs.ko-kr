---
title: C#을 사용하여 Application Insights에 LUIS 데이터 추가 | Microsoft Docs
titleSuffix: Azure
...
이 자습서의 모든 코드는 [LUIS-Samples GitHub 리포지토리](https://github.com/Microsoft/LUIS-Samples/tree/master/documentation-samples/tutorial-web-app-bot-application-insights/csharp)에서 사용 가능하며 이 자습서와 연결된 각 줄은 `//LUIS Tutorial:`을 사용하여 주석으로 처리됩니다. 
