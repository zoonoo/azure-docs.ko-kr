...
`Phonenumber`은 [인식자-텍스트](https://github.com/Microsoft/Recognizers-Text/blob/master/Patterns/Base-PhoneNumbers.yaml) GitHub 리포지토리에서 관리 됩니다.
