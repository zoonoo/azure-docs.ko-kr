...
ms.locfileid: "98179642"
---
# <a name="correct-misspelled-words-with-bing-search-resource"></a>Bing Search 리소스에서 철자가 잘못 된 단어 수정

LUIS가 utterance의 점수와 엔터티를 예측 하기 전에 LUIS 앱을 [Bing Search](https://ms.portal.azure.com/#create/Microsoft.BingSearch) 와 통합 하 여 길이 발언에서 철자가 잘못 된 단어를 수정할 수 있습니다.
...
4. 법적 고지 사항을 비롯한 정보가 포함되는 정보 패널이 오른쪽에 표시됩니다. **만들기** 를 선택하여 구독 만들기 프로세스를 시작합니다.
    ...
    :::image type="content" source="./media/luis-tutorial-bing-spellcheck/bing-search-resource-portal.png" alt-text="Bing Spell Check API V7 리소스":::
...
8. `mkt-bing-spell-check-key`예측 요청 헤더에 키를 추가 합니다.
