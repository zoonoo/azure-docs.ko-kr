...
대괄호를 사용 하는 **선택적** 구문은 두 수준 중첩할 수 있습니다. 예제: `[[this]is] a new form`. 이 예에서는 다음 길이 발언을 허용 합니다. 
...
괄호를 사용 하는 **그룹화** 구문은 두 수준 중첩할 수 있습니다. 예제: `(({Entity1.RoleName1} | {Entity1.RoleName2} ) | {Entity2} )`. 이 기능을 사용 하면 세 가지 엔터티를 일치 시킬 수 있습니다. 
