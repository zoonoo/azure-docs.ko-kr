...
4. [게시](luis-how-to-publish-app.md) 페이지에서 **예측된 모든 의도 점수 포함** 확인란을 선택합니다. 확인란이 선택되면 모든 의도가 반환됩니다. 확인란이 선택 취소되면 상위 의도만 반환됩니다. 

5. 앱을 [게시](luis-how-to-publish-app.md)합니다. 앱을 게시하면 HTTPS 끝점을 사용하여 테스트할 수 있습니다. 
...
> * [끝점 테스트](luis-how-to-publish-app.md#test-your-published-endpoint-in-a-browser)를 사용하여 정확한 LUIS 응답 JSON을 볼 수 있습니다. 

## <a name="get-the-entity-score-with-the-endpoint-test"></a>끝점 테스트로 엔터티 점수 가져오기
엔터티 점수를 보려면 [모델을 게시](luis-how-to-publish-app.md)하고 끝점을 쿼리합니다. 
