...
|Name|값|형식|필수|  
|----------|-----------|----------|--------------|
|<a name="count"></a>count|매개 변수로 지정 된 인덱스부터 시작 하 여 반환할 결과 수입니다 `offset` .|String|예|   
