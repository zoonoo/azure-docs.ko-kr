<properties title="HDInsight와 함께 Hive를 사용하여 센서 데이터 분석" pageTitle="Hive 및 Microsoft Azure HDInsight(Hadoop)를 사용하여 센서 데이터 분석" description="Hive와 Excel을 사용하여 HDInsight(Hadoop)에서 센서 데이터를 분석 및 시각화하는 방법에 대해 알아봅니다." metaKeywords="Azure hdinsight hive, Azure hdinsight hive sensor, azure hadoop hive, azure hadoop sensor, azure hadoop excel, azure hdinsight excel" services="hdinsight" solutions="" documentationCenter="big-data" authors="larryfr" videoId="" scriptId="" />
...
![솔루션 아키텍처 다이어그램][솔루션 아키텍처 다이어그램]

## 필수 조건:

-   HDInsight(Hadoop) 클러스터 - 클러스터를 만드는 방법에 대한 자세한 내용은 [HDInsight에서 Hadoop 클러스터 프로비전][HDInsight에서 Hadoop 클러스터 프로비전]을 참조하세요.

-   Microsoft Excel 2013

    > [WACOM.NOTE] Microsoft Excel은 현재 Windows에서만 제공되는 [Power View][Power View]를 사용한 데이터 시각화에 사용됩니다.

-   [Microsoft Hive ODBC 드라이버][Microsoft Hive ODBC 드라이버]
