...
제품을 라이브로 전환한 후 다음과 같은 다양한 종류의 업데이트를 수행할 수 있습니다.

1.  기존 SKU에 새 \"패키지\" 추가
2.  기존 제품에 새 SKU 추가
3.  제품/SKU 마켓플레이스 메타데이터 업데이트

Cloud 파트너 포털을 사용하여 이러한 변경 내용을 구현한 다음, 제품을 다시 게시합니다. 이 문서에서는 Azure 애플리케이션 제품 업데이트에 대한 다양한 측면을 안내합니다.

<a name="unpermitted-changes-to-azure-application-offer"></a>Azure 애플리케이션 제품에 허용되지 않는 변경 내용 
-----------------------------------------------
...
게시자가 기존 패키지를 업데이트하기 위해 패키지의 새 버전을 추가할 수 있습니다. 이 추가는 다른 버전 번호로 새 패키지를 업로드하여 수행할 수 있습니다.
...
2.  **모든 제품**에서 업데이트할 제품을 찾습니다.
3.  Marketplace 양식으로 이동하여 [여기](../cloud-partner-portal/azure-applications/cpp-marketplace-tab.md)에 있는 지침에 따라 변경합니다.
