...
- **인스턴스 URL**: 시험 사용 사용자가 시험 사용을 시작할 때 처음으로 이동할 URL을 입력하합니다. 일반적으로는 앱과 샘플 데이터가 설치된 Dynamics 365 인스턴스의 URL입니다. 예제 값은 https://testdrive.crm.dynamics.com과 같습니다.
...
- **인스턴스 웹 API URL**: Dynamics 365 인스턴스의 웹 API URL을 입력합니다. Microsoft Dynamics 365 인스턴스에 로그인하여 설정 -\> 사용자 지정 -\> 개발자 리소스 -\> 인스턴스 웹 API로 이동하면 이 값을 검색할 수 있습니다(인스턴스 웹 API URL을 복사해야 함). 예제 값은 https://testdrive.crm.dynamics.com/api/data/v9.0과 같습니다. 
