...
- **모든 제안** -현재 제품의 상태와 상태를 확인 합니다.
- **사용자** - [회사에 대한 액세스를 관리 및 제어합니다](./cloud-partner-portal-manage-users.md).
- **학습-학습** 을 바로 시작 하 고 파트너 포털의 새로운 기능을 최신 상태로 유지 합니다.
...
- 두 최상위 모드 ( **편집기** 와 **상태**) 사이를 전환 하 여 콘텐츠를 추가 하거나 제품의 상태를 확인 합니다.
- **작업 모음** 을 사용 하 여 입력을 저장 하 고 삭제 하 여 제품 변경 내용을 명시적으로 관리 합니다.
- 제품의 설정을 변경 하는 경우 각 제품에 필요한 **양식** 간을 이동 합니다.
...
-   **도움이 필요한가요?** – 잘 모르는 부분이 있어서 도움이 필요한 경우 지원 요청을 작성하고 설명서 링크를 찾아보세요.
-   **사용자 의견** -원하는 내용이 있나요? 여기서 알려주세요. Microsoft는 Azure Marketplace, AppSource 게시 프로세스 및 전반적인 클라우드 파트너 포털 환경을 최대한 쉽고 직관적으로 만들려고 합니다. Microsoft는 모든 피드백을 심사 및 검토하며, 언제나 고객의 개인 정보를 보호합니다. 추가 정보가 필요한 경우에만 연락을 드립니다.
