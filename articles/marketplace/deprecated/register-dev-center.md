...
* **개발자 센터 계정이 필요한 이유는 무엇인가요?**
  > 개발자 센터 계정은 Microsoft가 거래 목록 유형에 대해 게시자를 대신하여 고객에게 청구할 수 있도록 하는 데 필요합니다. 개발자 센터 계정을 등록하면 Microsoft가 회사의 법률, 세금 및 은행 정보의 유효성을 검사할 수 있습니다. 자세한 내용을 보려면 [여기를 클릭하십시오.](https://docs.microsoft.com/azure/marketplace/become-publisher)

* **개발자 센터 등록을 시작하려면 어떻게 할까요?**
  > 중복을 방지하려면 회사에 등록된 개발자 센터 계정이 없는지 확인합니다. 개발자 계정과 연결하려는 Microsoft 계정으로 로그인해야 합니다. 아직 Microsoft 계정이 없는 경우 여기에서 새 계정을 만들 수 [있습니다.](https://signup.live.com/signup?contextid=AEB123C8F2B1DA7A&bk=1529968434&ru=https%3a%2f%2flogin.live.com%2flogin.srf%3fcontextid%3dAEB123C8F2B1DA7A%26mkt%3dEN-US%26lc%3d1033%26bk%3d1529968434&uiflavor=web&uaid=9987e727fedb459780d95c1b9e46c82c&mkt=EN-US&lc=1033&lic=1) (예: contoso_marketplace@live.com) 로그인하고 등록하려면 https://dev.windows.com/registration?accountProgram=Azure로 이동합니다.
...
* **도시에 올바르게 들어갔지만 '도시가 필요함' 오류 메시지가 있는 이유는 무엇입니까?**
  > 우편 번호도 올바르게 입력되어 있는지 확인합니다. 도시, 우편 번호 유효성 검사가 있습니다.

* **프로모션 코드를 어떻게 얻을 수 있나요?**
  > [Marketplace 등록](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv) 양식을 완료하여 개발자 센터 프로모션 코드를 받습니다. 자세한 내용은 [파트너 센터 계정을 만드는](https://docs.microsoft.com/azure/marketplace/partner-center-portal/create-account) 방법을 참조하세요.
 
* **등록을 완료한 후에는 어떻게 되나요?**
  > verify@microsoft.com "필요한 조치: Microsoft로 전자 메일 계정 확인"이라는 제목의 전자 메일을 찾습니다. 등록을 완료하려면 시간이 중요한 확인 링크를 클릭합니다. *24시간 내에 이메일을 받지 못한 경우 스팸 폴더를 확인하세요.*

* **개발자 센터를 확인한 후에 다음 단계는 무엇인가요?**
  > "프로그램"으로 이동하여https://developer.microsoft.com/dashboard/Account/Programs) 개발자 센터 계정에 로그인합니다. Azure를 등록된 프로그램으로 표시하지 않는 경우 "권장 프로그램"을 참조한 다음 Azure에서 "시작하기"를 선택합니다.
