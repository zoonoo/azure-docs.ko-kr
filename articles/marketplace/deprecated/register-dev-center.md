...
* **개발자 센터 계정이 필요한 이유는 무엇인가요?**
  > 개발자 센터 계정은 Microsoft에서 고객에 게 Transact-sql을 대신 하 여 고객에 게 요금을 청구할 수 있도록 하는 데 필요한입니다. 개발자 센터 계정을 등록하면 Microsoft가 회사의 법률, 세금 및 은행 정보의 유효성을 검사할 수 있습니다. 자세히 알아보려면 여기를 클릭 [하세요.](https://docs.microsoft.com/azure/marketplace/become-publisher)
...
* **등록을 완료한 후에는 어떻게 되나요?**
  > 제목 줄 "작업 필요 verify@microsoft.com : Microsoft 전자 메일 계정 확인"을 사용 하 여 전자 메일을 찾습니다. 등록을 완료하려면 시간이 중요한 확인 링크를 클릭합니다. *24시간 내에 이메일을 받지 못한 경우 스팸 폴더를 확인하세요.*

* **개발자 센터를 확인한 후에 다음 단계는 무엇인가요?**
  > "사용자의 프로그램"https://developer.microsoft.com/dashboard/Account/Programs) 으로 이동 하 여 개발자 센터 계정에 로그인 합니다. Azure가 등록 된 프로그램으로 표시 되지 않는 경우 "권장 프로그램을 선택 하십시오."를 확인 한 다음 Azure에서 "시작"을 선택 합니다.
