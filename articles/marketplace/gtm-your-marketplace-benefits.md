...
5. AAD 통합 및 개발 및 테스트 스폰서쉽: transactable (배포 하 고 청구 가능 제품을)를 사용 하 여 라이브 이동 하면 옵트인 됩니다. Go 시장 진출 혜택을 사용 하 여 시작 하는 방법에 대 한 다음 섹션을 참조 하세요.
...
| 상점 | 사용 가능한 추가 혜택 |
|:--- |:--- |
| AppSource |  Microsoft Gold 파트너 <br> 제품-Marketplace 보상 트랜잭션 <br> 평가판 앱 |
| Azure Marketplace | 제품-Marketplace 보상 트랜잭션 <br> 평가판 제품 |
...
제품 목록, 평가판 또는 Transact-Marketplace 보상 프로그램 솔루션 상태에 따라 받게 자가 진단 리소스를 사용 하 여 전자 메일 또는 컨설팅 호출 된 전용된 Engagement 관리자 초대 합니다. 통화를 시작하기 위해 특별한 작업을 수행할 필요는 없습니다. Marketplace 온보딩 팀이 [Cloud 파트너 포털](https://cloudpartner.azure.com/)에서 제공한 정보에 따라 연락을 드립니다.

마켓플레이스에서 제품을 확장함에 따라 사용 가능한 활동 범위도 확장됩니다. 모든 목록 추가 시 기본 수준의 최적화 권장 사항 및 프로모션을 받게 됩니다.  이러한 목록 솔루션 상태 (목록, 평가판 또는 Transact-marketplace 보상) 선택한 marketplace 및 Microsoft 파트너 역량 도전 과제를 기반으로 하는 추가 마케팅 혜택의 자격이 이기도 합니다.

아래 표에서 목록 및 평가판 제품에 대 한 자격 요구 사항을 요약 합니다.
...
## <a name="marketplace-rewards-for-transact-partners"></a>Transact 파트너용 marketplace 보상

Marketplace 보상에 대 한 혜택의 전체 목록을 볼 수 있습니다 합니다 [요약 슬라이드 프로그램](https://onedrive.live.com/view.aspx?resid=1900675C97CA6FE0!630&ithint=file%2cpptx&authkey=!APQ6LSnDenx2FKM)합니다.
