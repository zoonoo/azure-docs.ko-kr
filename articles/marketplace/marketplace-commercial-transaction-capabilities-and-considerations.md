...
>[!NOTE]
>거래 게시 옵션에 대한 모든 보고 및 인사이트는 파트너 센터의 분석 섹션을 통해 확인할 수 있습니다.

#### <a name="billing-questions-and-support"></a>청구 관련 질문 및 지원

자세한 정보 및 법적 정책은 [게시자 계약(파트너](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE3ypvt) 센터에서 사용 가능)을 참조하세요.
