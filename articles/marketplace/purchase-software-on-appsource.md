...
- 회사 또는 학교 계정 회사 또는 학교 계정이 없는 경우 구매 프로세스 중 "무료 계정에 등록" 링크를 따르세요.

- 제품을 구매 하는 국가/지역의 유효한 신용 카드입니다.

    > [!Note]
    > 신용 카드 청구 국가는 Azure Active Directory 인스턴스 위치로 잠길 수 있습니다.
