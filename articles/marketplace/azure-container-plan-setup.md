---
title: Microsoft AppSource에서 Azure Container 제안에 대한 플랜을 설정합니다.
description: Microsoft AppSource에서 Azure Container 제안에 대한 플랜을 설정합니다.
...
ms.locfileid: "107892407"
---
# <a name="set-up-plans-for-an-azure-container-offer"></a>Azure Container 제안에 대한 플랜 설정
...
모든 Azure Container 제안은 자동으로 **전 세계 Azure** 에서 사용할 수 있습니다.  플랜은 마켓플레이스를 사용하는 전 세계 모든 Azure 지역의 고객이 사용할 수 있습니다. 자세한 내용은 [지리적 가용성 및 통화 지원](marketplace-geo-availability-currencies.md)을 참조하세요.
...
- [플랜 목록 설정](azure-container-plan-listing.md)
