---
title: Azure 및 Dynamics 365 컨설팅 서비스 필수 조건-Azure Marketplace
description: 파트너 센터의 Azure 또는 Dynamics 365 컨설팅 서비스 제품에 대 한 필수 구성 요소
author: anbene
...
이 제품 유형에 대 한 요구 사항을 포함 하 여 컨설팅 서비스 제품에 대 한 자세한 내용은 [Azure Marketplace 및 AppSource에 대 한 컨설팅 서비스](https://docs.microsoft.com/azure/marketplace/consulting-services)를 참조 하세요. 다음 표에서는 특정 컨설팅 서비스 유형에 대 한 추가 요구 사항을 보여 줍니다.
...
|Power Apps | Power Apps | 는 [Power Apps 파트너 관계](https://aka.ms/PowerAppsPartner) 프로그램의 고급 혜택을 받을 자격이 있거나, 서비스가 관련 된 기본 제품에 대 한 공동 판매 제품을 보유 해야 합니다. |

제품을 만들 준비가 되 면 [컨설팅 서비스 제품 만들기](./create-consulting-service-offer.md)를 참조 하세요.
