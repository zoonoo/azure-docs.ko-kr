...
* **추가 기능** – 추가 기능 앱은 Dynamics 365 Business Central의 경험 및 기존 기능을 확장합니다. 자세한 내용은 [추가 기능 앱](/dynamics365/business-central/dev-itpro/developer/readiness/readiness-add-on-apps)을 참조하세요.
* **Connect** – Dynamics 365 Business Central과 타사 솔루션 또는 서비스 간에 지점 간 연결을 설정해야 하는 시나리오에서 Connect 앱을 사용할 수 있습니다. 자세한 내용은 [Connect 앱](/dynamics365/business-central/dev-itpro/developer/readiness/readiness-connect-apps)을 참조하세요.
