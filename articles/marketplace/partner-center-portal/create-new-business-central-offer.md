...
위에서 **추가** 를 선택한 경우 여기에서 종속성이 있는 모든 확장에 대 한 패키지 파일과 함께 제품의 패키지 파일을 업로드 합니다.
...
제품을 marketplace에 이미 게시 된 다른 확장과 함께 설치 해야 하는 경우에 필요 합니다. 그럴 경우 여기에 해당 앱 또는 .zip 파일을 업로드 합니다.
