...
- **Azure를 통해 청구**됩니다. Microsoft를 [통해 제품](./create-new-saas-offer.md#sell-through-microsoft) 을이 라이선스 유형과 함께 판매 하기로 선택 하는 경우 microsoft는 귀하를 대신 하 여 고객에 게 요금을 청구 합니다. 지불 유형은 신용 카드나 기업 청구서를 통해 종 량 제를 포함 합니다.
- 사용자 **고유의 라이선스 가져오기**: Microsoft는이 유형의 marketplace 제품 사용에 대해 고객에 게 요금을 청구 하지 않습니다. Marketplace에서 **[지금 가져오기 (무료)](./create-new-saas-offer.md#get-it-now-free)** 로 표시 됩니다.
- **체험**: Microsoft는이 유형의 marketplace 제품 사용에 대해 고객에 게 요금을 청구 하지 않습니다. Marketplace에서 **[무료 평가판](./create-new-saas-offer.md##free-trial-listing)** 으로 나열 됩니다.
...
| 제안 유형: 관리 되는 응용 프로그램  | 주문을 | 다음 조건이 필요한 경우 Azure 앱: 관리되는 앱 제품 형식을 사용합니다. VM 또는 전체 IaaS 기반 솔루션을 사용하여 고객에게 구독 기반 솔루션을 배포합니다. 사용자 또는 고객은 파트너가 솔루션을 관리 해야 합니다. |
...
| 제안 유형: Dynamics 365 Business Central| 주문| 솔루션이 재무 및 운영에 대 한 Dynamics 365와 통합 된 경우이 제안 유형을 사용 합니다.| |
| 제안 유형: Dynamics 365 for Customer Engagement | 주문| 솔루션이 고객 참여를 위해 Dynamics 365와 통합 되는 경우이 제안 유형을 사용 합니다.||
