...
세금 양식에 제출한 정보에 따라 적절한 원천 징수율이 결정됩니다. 원천 징수율은 미국에서 이뤄지는 판매에만 적용됩니다. 미국 이외의 국가에서 이뤄지는 판매는 원천 징수 대상이 아닙니다. 원천 징수율은 다르지만, 미국 이외 국가에 등록된 개발자의 경우 대부분 기본 세율이 30%입니다. 국가/지역이 미국과 체결한 소득세 조약에 동의한 경우 이 세율을 삭감할 수 있습니다.
...
기본적으로 Microsoft는 월 단위로 결제 대금을 보냅니다. 그러나 지급을 보류하여 계정에 결제 대금을 보내지 못하게 하는 옵션이 있습니다. 지급을 보류하기로 선택하면 Microsoft에서 계속 거둔 수익을 기록하고 **지급 요약**에 세부 정보를 제공합니다. 그러나 보류 상태를 제거할 때까지 계정으로 결제 대금은 보내지 않습니다. 
...
3. 사용자 선택을 완료하면 **선택한 항목 추가**를 클릭합니다.
...
3. 그룹 선택을 완료하면 **선택한 항목 추가**를 클릭합니다.
...
3. Azure AD 애플리케이션 선택을 완료하면 **선택한 항목 추가**를 클릭합니다.
...
1. **사용자** 페이지(**계정 설정** 아래)에서 Azure AD 애플리케이션의 이름을 선택합니다. 키가 만들어진 날짜와 만료될 시기를 포함하여 Azure AD 애플리케이션에 대한 활성 키가 모두 표시됩니다. 
...
회사 사용자에게 파트너 센터의 상업용 Marketplace 프로그램에 대해 다음과 같은 역할과 권한을 할당할 수 있습니다.
...
파트너 센터의 **규약** 섹션(**계정 설정** 아래)에서는 권한이 부여된 게시 규약의 목록을 볼 수 있습니다. 이러한 규약은 수락한 날짜와 규약을 수락한 사용자의 이름을 포함하여 이름 및 버전 번호에 따라 나열됩니다.
