...
![권장 해결 방법](./media/recommended-solutions.png)

**권장 솔루션**에서 답변을 찾을 수 없는 경우 **문제 세부 정보 제공**을 클릭 합니다.  형식 및 모든 필수 필드를 입력 하 여 해상도 프로세스의 속도를 향상 시킬 수 있습니다.  그런 다음 **제출**을 클릭 합니다.
