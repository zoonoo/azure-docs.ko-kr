...
[관리형 서비스 인증 정책](/legal/marketplace/certification-policies#700-managed-services)에 따라 **잠재 대상 고객** 이 필요합니다. 고객이 제품을 배포할 때마다 CRM 시스템에 레코드가 생성됩니다.
