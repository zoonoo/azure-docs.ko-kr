...
검토는 게시 된 시간 순으로 표시 됩니다. 기본 보기에는 모든 검토가 표시 되며 드롭다운 메뉴의 **등급 필터** 를 사용 하 여 별 등급 별 리뷰를 기준으로 필터링 할 수 있습니다. 또한 검토에 표시 되는 키워드를 기준으로 검색할 수 있습니다.  
