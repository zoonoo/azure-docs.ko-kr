...
이 프로그램은 긍정적인 피드백 루프를 만듭니다. 각 성장 단계의 이점은 다음 단계로 진행 하는 데 도움이 되며, microsoft의 필드를 사용 하 고 상업적 marketplace를 플랫폼으로 활용 하 여 microsoft의 채널을 통해 비즈니스를 Microsoft 고객에 게 성장 하는 데 도움이 됩니다.

귀하의 혜택은 귀하의 제품이 [연락처 인지, 무료 평가판 또는](../determine-your-listing-type.md)거래 인지에 따라 차별화 됩니다.
...
1. 혜택 목록을 보려면 파트너 센터의 [Marketplace 보상](https://partner.microsoft.com/dashboard/mpn/program/commercialmarketplace) 페이지로 이동 하 여 **영업 및 마케팅 혜택** 탭을 선택 합니다.
