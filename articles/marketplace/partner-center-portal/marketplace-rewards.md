...
>[!Note]
>제품이 4 주 이상 지속 되 고 메시지를 받지 못한 경우 Cloud 파트너 포털 또는 파트너 센터에서 확인 하 여 해당 제품의 소유자 인 조직 내에서 확인 하세요. 연락을 취하고 다음 단계를 수행해야 합니다.

>[!Note] 
>소유자를 확인할 수 없거나 소유자가 회사를 떠난 경우에서 지원 티켓을 발생 시킬 수 있습니다 https://aka.ms/marketplacepublishersupport .
