...
- 기존 Microsoft 파트너 네트워크 등록을 사용 하는 경우 [Microsoft 파트너 네트워크에 등록 된](#what-if-im-already-enrolled-in-the-microsoft-partner-network)를 사용 하 여 계정을 만듭니다.
