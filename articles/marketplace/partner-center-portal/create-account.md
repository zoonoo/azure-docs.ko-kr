...
- 이미 Microsoft 파트너 네트워크에 등록 한 경우 [Microsoft 파트너 네트워크 등록을 사용 하 여 계정 만들기](#create-an-account-using-your-microsoft-partner-network-enrollment)를 사용 하 여 파트너 센터에서 직접 계정을 만듭니다.
...
## <a name="create-an-account-using-your-microsoft-partner-network-enrollment"></a>Microsoft 파트너 네트워크 등록을 사용 하 여 계정 만들기

이미 Microsoft 파트너 네트워크에 등록 한 경우이 섹션을 사용 하 여 다음 단계를 사용 하 여 파트너 센터에서 직접 계정을 만들 수 있습니다.

- [회사 계정을 사용 하 여 파트너 센터에 로그인 합니다.](#sign-into-partner-center-with-your-work-account)
- [게시자 프로필 입력](#enter-your-publisher-profile)

Microsoft 파트너 네트워크 계정 정보를 편리 하 게 사용할 수 있는지 확인 합니다.

>[!Important]
>파트너 센터로 이동 된 [Cloud 파트너 포털 (CPP)](https://cloudpartner.azure.com) 의 계정이 있는 경우 새 계정을 만들 필요가 없습니다. 자세한 내용은 [CPP에서 이동](#publishers-moving-from-cpp) 하는 게시자를 참조 하세요.

### <a name="sign-into-partner-center-with-your-work-account"></a>회사 계정을 사용 하 여 파트너 센터에 로그인 합니다.
...
### <a name="enter-your-publisher-profile"></a>게시자 프로필 입력

로그인 한 후이 섹션의 단계를 사용 하 여 계정 설정을 마칩니다.
