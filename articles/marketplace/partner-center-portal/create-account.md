...
제품을 [Azure Marketplace](https://azuremarketplace.microsoft.com/) 또는 [appsource](https://appsource.microsoft.com/)에 게시 하려면 파트너 센터의 상용 Marketplace 프로그램에서 계정을 만들어야 합니다.
...
### <a name="to-create-a-commercial-marketplace-account-in-partner-center"></a>파트너 센터에서 상업적 Marketplace 계정을 만들려면
...
따라서 회사의 업무용 메일 계정 도메인을 새 파트너 센터 계정에 연결할 수 있습니다. 회사 직원은 이러한 계정을 연결 하 여 회사 계정 사용자 이름 및 암호를 사용 하 여 파트너 센터에 로그인 할 수 있습니다.
...
파트너 센터에서 계정을 만들어 주셔서 감사 합니다. 이제 [상업용 마켓플레이스 개요](./commercial-marketplace-overview.md) 페이지로 이동 합니다.
...
>[!Note]
>새 게시자를 추가 하기 전에 파트너 센터에 로그인 하 여 기존 게시자를 검토 하 고 **계정 설정** -> **게시자** 를 선택 하 여 기존 게시자 목록을 볼 수 있습니다.
...
1. **회사 계정으로 로그인** 을 선택 하 고 회사 메일 주소를 입력 합니다.
1. **게시자 추가** 단추를 선택 합니다.
1. 게시자에 연결할 MPN ID를 선택 합니다.
1. 양식의 **게시자 세부 정보** 를 업데이트 합니다. <br>

   1. **게시자 이름**: 제공 된 Azure Marketplace 또는 AppSource에 표시 되는 이름입니다. <br>
   1. **PublisherID**: 파트너 센터에서 게시자를 고유 하 게 식별 하는 데 사용 되는 식별자입니다. 이 필드의 기본값은 시스템에서 사용할 수 없는 기존 `PublisherID` 및 고유에 매핑됩니다. 따라서이 필드를 업데이트 해야 합니다. <br>
   1. **연락처 정보**: 필요한 경우 연락처 정보를 업데이트 합니다.

1. 프로세스를 완료 한 후에는 왼쪽 탐색 메뉴에 나열 된 **상용 Marketplace** 프로그램으로 이동 하 여 새로 만든 게시자를 관리할 수 있습니다. **상업적 Marketplace** 프로그램이 표시 되지 않으면 페이지를 새로 고칩니다.  새 게시자가 **게시자** 목록에 표시 됩니다.
