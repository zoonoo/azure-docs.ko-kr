---
title: SaaS 제품 만들기 검사 목록 - Azure 상업용 Marketplace
description: SaaS 제품 만들기 프로세스에서 제공할 수 있는 세부 정보입니다. - Azure 상업용 Marketplace
author: dsindona
ms.author: dsindona
...
| [제품 기술 구성 페이지](#technical-configuration-page)  | Microsoft를 통해 제품을 판매하도록 선택한 경우에만 사용할 수 있습니다. 제품에 연결하는 데 사용되는 기술 세부 정보(URL 경로, 웹후크, 테넌트 ID 및 앱 ID)를 정의합니다. |
...
| 매장 로고(소형, 중형, 대형, 광폭, Hero)  | 소형(48 X 48) 및 대형(216 X 216)은 필수, 다른 크기는 선택 사항이지만 다음을 권장합니다. 중형(90 x 90), 광폭(255 x 115), Hero(815 x 290). 로고는 PNG 형식이어야 합니다. |
