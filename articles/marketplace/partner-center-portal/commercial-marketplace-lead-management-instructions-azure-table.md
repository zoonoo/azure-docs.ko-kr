...
* *공유 저장소 키* - Azure 테이블에 대한 저장소 계정의 키 값을 제공합니다. 저장소 계정의 **액세스 키** 페이지에서 찾을 수 있습니다.
    ![Azure 테이블 저장소입니다.](./media/commercial-marketplace-lead-management-instructions-azure-table/azure-table-storage.png)
...
* *쿼리 필터* - 이 필드를 선택하고 이 함수를 필드에 붙여넣습니다: `Timestamp gt datetime'@{body('Get_past_time')}'` ![Azure Table get 엔터티 - 필터 쿼리.](./media/commercial-marketplace-lead-management-instructions-azure-table/azure-table-get-entities-filter-query.png)
