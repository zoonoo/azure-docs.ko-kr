...
[Azure Active Directory (AZURE AD)를 사용 하 여 한 번의 클릭으로 인증](https://docs.microsoft.com/azure/marketplace/marketplace-saas-applications-technical-publishing-guide#using-azure-active-directory-to-enable-trials)을 통해 평가판을 얻을 수 있는 올바른 URL ( *http* 또는 *https*로 시작)을 제공 하 여 고객에 게 제품을 무료로 제공 합니다.  `https://contoso.com/saas-app`
...
시험 사용한 고객에 게 제품을 고객에 게 제공 하는 좋은 방법은 ' 구매 전 시도 '를 선택 하 여 변환 및 높은 우량 잠재 고객을 생성 하는 옵션을 제공 하는 것입니다. 자세한 내용은 [고객이 제품을 테스트할 수 있도록 허용](./test-drive.md)을 참조 하세요.
...
- [시험 드라이브 개요 (PDF 다운로드)](https://assetsprod.microsoft.com/mpn/azure-marketplace-appsource-test-drives.pdf)
...
제품의 각 요금제에 대해 무료 평가판을 구성 하는 기능을 사용할 수 있습니다. 각 제품에 대 한 가격 책정 및 가용성으로 이동 하 여 1 개월 평가판을 허용 하는 확인란을 선택 합니다.
...
요금제에 대 한 가격을 미국 달러 (USD)로 설정 하 고 다른 시장 위치를 추가 하는 경우 새 시장의 가격은 현재 환율이 따라 계산 됩니다. 게시 하기 전에 각 시장의 가격을 검토 합니다. 변경 내용을 저장 한 후 "가격 (.xlsx) 내보내기" 링크를 사용 하 여 가격 책정을 검토할 수 있습니다.
