...
기본 및 보조 범주 (선택 사항)를 포함 하 여 최대 2 개의 범주를 선택 합니다. 각 주 및/또는 보조 범주에 대해 최대 2 개의 하위 범주를 선택 합니다. 하위 범주를 선택 하지 않은 경우에는 선택한 범주에서 계속 검색할 수 있습니다.
...
**소형 (48 x 48)** 및 **큼 (216 x 216)** 의 두 가지 크기로 제품 로고를 제공 해야 합니다.
