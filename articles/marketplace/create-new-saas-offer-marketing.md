...
CSP (클라우드 솔루션 공급자) 프로그램에서 제품을 사용할 수 있도록 선택 하는 경우 Csp는 고객에 게 번들로 제공 되는 솔루션의 일부로 제품을 판매할 수 있습니다. CSP 프로그램을 통해 제품을 재판매 하는 방법 및 **csp** 탭을 구성 하는 단계별 지침에 대 한 자세한 내용은 [클라우드 솔루션 공급자 프로그램](cloud-solution-providers.md)(영문)을 참조 하세요.
