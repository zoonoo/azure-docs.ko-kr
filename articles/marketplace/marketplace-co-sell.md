...
- Biz 앱 ISV는 표준 또는 프리미엄 동기 표준을 연결 합니다.
- Biz 앱 ISV 연결 Standard 또는 Premium 동기 프리미엄  
...
- _AZURE IP 공동 판매 incentivized_ 또는 BIZ 앱 ISV를 실현 하는 제품은 _표준 또는 프리미엄 동기를 제공 합니다._ 상태는 온라인 상점의 제품 목록 페이지에서 **Microsoft 기본 솔루션** 배지를 받게 됩니다. 배지는 특정 산업 수직 또는 솔루션 영역에서 고객의 요구를 해결 하는 제품의 품질, 성능 및 기능을 홍보 합니다.
