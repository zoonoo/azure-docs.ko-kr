...
|<ol start=2><li>필요한 공동 판매 자료를 제출 합니다.</li>|[파트너 센터의 공동 판매 옵션](https://docs.microsoft.com/azure/marketplace/partner-center-portal/commercial-marketplace-co-sell) *을 사용한* IP 제안|[파트너 센터에서 필수 자료 업로드](#how-to-submit-co-sell-materials-in-partner-center)|공동 판매 준비|
...
1. Microsoft 판매자가 **목록** 섹션에서 제품을 신속 하 게 정렬 하 고 검색 하는 데 도움이 되는 기본 목록 세부 정보를 제공 합니다. (*필수: 모든 필드*)
    ...
    :::image type="content" source="media/co-sell/co-sell-listing-section.png" alt-text="이 이미지는 Microsoft와 공동 판매 탭의 위치를 보여 줍니다.":::  

1. 제품에 대 한 세부 정보를 제공 하 고 **문서** 섹션에서 참고 자료를 업로드 합니다. Microsoft 판매자는이 정보를 사용 하 여 제품을 권장 하 고 판매 합니다. (*필수: 고객 1 호출기 및 고객 프레젠테이션 데크*)

    :::image type="content" source="media/co-sell/co-sell-documents-section.png" alt-text="이 이미지는 Microsoft와 공동 판매 탭의 위치를 보여 줍니다.":::
