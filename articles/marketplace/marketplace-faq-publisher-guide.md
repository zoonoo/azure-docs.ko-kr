...
판매자는 제품을 판매하는 모든 Azure 데이터 센터 지역에 제품을 배포할 수 있습니다. 성능을 최적화하고 예산을 제어하려면 서비스 지역과 가장 가까운 데이터 센터 위치를 선택하는 것이 좋습니다.
...
현재는 Azure CSP 및 Open 고객을 대상으로 무료 및 BYOL(사용자 라이선스 필요) Marketplace 제품만 제공됩니다.
...
고객은 판매자가 사용하도록 설정한 모든 Azure 데이터 센터 지역에 제품을 배포할 수 있습니다. 성능을 최적화하고 예산을 제어하려는 경우 서비스 지역과 가장 가까운 데이터 센터 위치를 선택할 수 있습니다.
...
**Azure CSP(클라우드 솔루션 공급자)에서 Azure Marketplace 솔루션을 구매할 수 있나요?**
