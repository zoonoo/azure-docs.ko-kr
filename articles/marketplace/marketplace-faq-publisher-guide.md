...
[Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace)는 Microsoft와 파트너가 제공하는 솔루션과 서비스에 액세스하고 해당 정보를 확인할 수 있는 위치입니다. 고객은 Azure를 기반으로 하거나 기반으로 하는 클라우드 소프트웨어 솔루션을 검색, 시도 또는 구매할 수 있습니다. 8,000개가 넘는 제품이 포함된 Microsoft 카탈로그에서는 VM(가상 머신), API, Azure 앱, 솔루션 템플릿/관리되는 애플리케이션, SaaS 앱, 컨테이너, 컨설팅 서비스 등의 Azure 구성 요소가 제공됩니다.

**Azure Marketplace는 어떤 고객을 대상으로 하나요?**

Azure Marketplace는 상용 IT 소프트웨어 및 서비스에 관심이 있는 IT 전문가 및 클라우드 개발자를 위해 설계되었습니다.

**Azure Marketplace는 현재 어떤 유형의 제품을 제공하나요?**

Azure Marketplace는 Azure 제품과 서비스를 확장하기 위해 빌드된 Microsoft 및 파트너의 기술 솔루션과 서비스를 제공합니다. 솔루션 카탈로그는 다음을 포함한 여러 범주에 걸쳐 있습니다.
...
**Azure 마켓플레이스 구매를 배포할 Azure 지역을 선택할 수 있습니까?**

고객은 활성화한 모든 Azure 데이터 센터 지역에 배포할 수 있습니다. 성능을 최적화하고 예산을 제어하려면 서비스 지역과 가장 가까운 데이터 센터 위치를 선택하는 것이 좋습니다.

**실수로 Azure 마켓플레이스 구매를 삭제한 경우 작업을 *실행 취소할* 수 있습니까?**
...
게시자가 CSP(클라우드 솔루션 공급자) 채널을 통해 오퍼링을 사용할 수 있도록 구성한 경우 클라우드 솔루션 공급자 파트너는 솔루션을 재판매할 수 있습니다.

**Azure 마켓플레이스를 통해 판매/프로비전된 응용 프로그램 및 서비스 구매에 대해 지원되는 국가/지역은 무엇입니까?**

Azure 마켓플레이스는 [참여 정책에](/legal/marketplace/participation-policy)나열된 국가/지역의 Azure 고객이 사용할 수 있습니다.

**Azure 마켓플레이스에서 지원하는 통화는 무엇입니까?**

거래는 AUD, BRL, CAD, CHF, DKK, EUR, GBP, INR, JPY, 원화, NOK, NZD, RUB, SEK, TWD, USD, RMB 의 17개 통화로 진행될 수 있습니다.

### <a name="deploying-a-solution-from-azure-marketplace"></a>Azure Marketplace에서 솔루션 배포

**구독에 Azure 마켓플레이스 가상 머신(VM)을 배포했으며 이제 구독을 한 Azure 계정에서 다른 Azure 계정으로 마이그레이션하려고 합니다. 현재 지원되고 있습니까?**

Azure Marketplace VM 및 서비스를 포함한 Azure 구독을 마이그레이션하려면 새 Azure 계정에 연결하기 전에 이전 Azure 구독을 삭제하거나 취소합니다. 마이그레이션이 완료되면 새 등록된 계정의 결제 방법을 사용하여 이로 인한 사용 요금이 청구됩니다.

**Azure 마켓플레이스 가상 머신(VM) 구독을 엔터프라이즈 계약으로 마이그레이션하려고 합니다. 현재 지원되고 있습니까?**

Azure Marketplace VM(가상 머신) 구독을 기업계약으로 마이그레이션하려면 마이그레이션 전에 이전 구독을 중지하거나 취소합니다. Azure 계정 및 연결된 구독의 마이그레이션이 완료되면 Azure Marketplace VM 또는 서비스를 다시 구입할 수 있습니다.  그 이후의 사용 요금은 기업계약에 따라 분기별로 청구됩니다.
...
+ *BYOL(사용자 라이선스 가져오기) 모델*: 게시자 나 리셀러로부터 직접 소프트웨어 라이센스를 취득할 때 추가 소프트웨어 관련 요금이나 수수료가 없습니다.

*번들 포함:*

Azure 구독은 게시자의 ISV(독립 소프트웨어 공급업체) 솔루션 가격 책정에 포함됩니다.

*요금 청구 방식:*

+ *무료:* 무료 SKU. 소프트웨어 라이선스 요금 또는 제품 사용 요금이 적용되지 않습니다.

+ *무료 소프트웨어 평가판:* 제한된 기간 동안 무료 혜택. 평가판 기간 동안 사용시 게시자의 소프트웨어 라이센스 비용은 부과되지 않습니다. 평가 기간이 만료되면 판매자가 정한 표준 요율에 따라 유료 제품으로 자동 변환됩니다.

+ *사용량 기반:* 요금은 오퍼링의 사용량에 따라 청구되거나 청구됩니다. 가상 머신 이미지의 경우 시간 단위로 요금이 청구됩니다. 개발자 서비스와 API의 경우에는 제품별로 정의된 측정 단위당 요금이 청구됩니다.

+ *정액 요금:* SaaS 구독은 매월 또는 연간 청구되는 고정 요금으로 책정될 수 있습니다. 여기에는 소비에 따라 청구되는 추가 청구 기준(예: 대역폭, 이메일 또는 티켓)도 포함될 수 있습니다. 
...
BYOL 솔루션용 라이선스 자격 증명을 확보하고 적용하는 작업은 판매자가 수행해야 합니다. 가상 머신 제공의 경우 일반적으로 응용 프로그램이 시작된 후 게시자의 응용 프로그램에서 라이센스 키를 획득합니다. Azure 응용 프로그램 솔루션 템플릿을 통해 배포된 가상 컴퓨터 오퍼를 사용하는 경우 리소스 관리자 템플릿을 구성하여 사용자에게 라이선스 자격 증명을 포함한 다양한 입력을 표시하도록 할 수 있습니다.
...
+ *옵션 2:* 라이센스 키는 선택한 구독에서 VM 오퍼를 배포한 후 최종 사용자(오퍼에서 제공하는 명령줄/웹 인터페이스를 통해)에 의해 입력됩니다. 라이선스는 키 및/또는 파일일 수 있습니다(판매자가 결정함).

*Azure 앱(솔루션 템플릿 및 관리되는 앱):*

+ *옵션 1:* 리소스 관리자 템플릿을 구성하여 라이센스 자격 증명을 포함한 다양한 입력을 입력하라는 메시지를 표시할 수 있습니다. 최종 사용자 구독에서 제품 배포 전에 라이선스 파일(파일 업로드) 또는 키(텍스트 상자 입력) 형태로 라이선스 자격 증명을 입력할 수 있습니다.

+ *옵션 2:* 오퍼에서 제공하는 명령줄/웹 인터페이스를 통해 라이센스 키를 입력할 수 있습니다.  선택한 구독에서 Azure Apps를 배포한 후에 키 입력을 수행합니다. 라이선스는 키 및/또는 파일일 수 있습니다(판매자가 결정함).

**어떤 종류의 시험이 지원됩니까?**

게시자는 유료 SaaS 오퍼에 대해 1개월을 추가하고 VM 이미지에 대해 1~3개월의 무료 소비를 추가할 수 있습니다. 무료 평가판 혜택은 평가판을 시작하기 위한 클릭 유도문의 목록이 있습니다. 이렇게 하면 고객이 게시자가 정의한 웹 사이트로 이동하여 평가판 환경을 설정합니다. 평가판은 첫 달이 무료인 유료 오퍼링에도 추가될 수 있습니다. 

**무료 계층 또는 BYOL(사용자 라이선스 필요) 제품을 배포하는 경우 신용 카드 등의 결제 방법을 등록해야 하나요?**

아니요. 무료 계층 또는 BYOL 제품을 배포하는 경우에는 결제 방법이 필요하지 않습니다. 그러나 무료 평가판 제품의 경우 결제 방법이 필요합니다. **지금 설치해 보기** 또는 **무료 소프트웨어 평가판** 단추가 포함된 제품은 선택한 Azure 구독에 배포됩니다.  이러한 목록은 선택한 계정의 등록된 결제 방법을 사용하여 청구됩니다. Azure 사용 요금은 소프트웨어 라이선스 요금과 별도로 청구됩니다.
...
현금 약정 금액에서 차감되지 않은 모든 Azure Marketplace 제품 비용은 매월 연체 요금으로 청구됩니다. 연간 SaaS 구독은 1년 동안 한 번 청구됩니다.

MOSP - [Microsoft 온라인 구독 프로그램(웹](https://azure.microsoft.com/support/legal/subscription-agreement/) 직접) 고객은 Azure 구독 프로필에 대해 파일에 있는 것과 동일한 신용 카드에 대해 매월 요금이 청구됩니다. 연간 SaaS 구독은 1년 동안 한 번 청구됩니다.
...
**Azure 마켓플레이스에서 제공하는 가상 머신의 비용 구조에서 *가격,* *소프트웨어 가격*및 *총 가격의* 차이점은 무엇입니까?**

*가격은* 소프트웨어를 실행하는 Azure 가상 시스템의 비용을 나타냅니다. *소프트웨어 가격은* Azure 가상 컴퓨터에서 실행되는 마켓플레이스 게시자의 소프트웨어 비용을 나타냅니다. *총 가격은* Azure 가상 머신과 Azure 가상 컴퓨터에서 실행되는 마켓플레이스 게시자의 소프트웨어의 총 비용을 합한 값을 나타냅니다.
...
[Azure 마켓플레이스에서](https://azuremarketplace.microsoft.com/) 구입한 항목은 반환할 수 없지만 취소/삭제할 수 있습니다. 소비 기반 오퍼는 사용량에 따라 청구되므로 중지되면 요금도 중지됩니다. 구독은 취소되며 현재 청구 기간을 초과하여 청구되지 않습니다. 구매 직후 구독이 취소된 경우(월간 24시간, 연간 14일) 전액 환불됩니다.
...
**중기 적으로 증가하면 라이선스 추가는 어떻게 처리됩니까?**

기존 구독에 추가된 라이선스는 구독 기간의 나머지 기간 동안 비례 배분됩니다.

**중기 적으로 라이선스 제거는 어떻게 처리됩니까?**

취소된 라이선스에는 이 FAQ에 있는 환불 정책이 적용됩니다.  취소된 모든 라이선스는 계정에서 즉시 제거되며 더 이상 사용할 수 없습니다.

**소비 기반 오퍼에 대한 환불이 지원되나요?**

시간당 VM이든 커스텀 미터이든 소비를 기준으로 한 모든 요금은 취소를 통해 환불되지 않습니다. 소비가 발생하면 요금은 Microsoft 상거래 플랫폼에서 처리되며 환불이 요청되는 서비스 품질 분쟁은 게시자와 고객 간에 Microsoft 시스템 외부에서 직접 처리됩니다. 정액 요금과 계량 결제를 지원하는 혜택은 정액 요금에 대한 표준 환불 정책을 따릅니다.

**중기적으로 계획을 변경할 수 있습니까?**

아니요, 월별 및 연간 전환은 불가능합니다.

**고객이 동일한 오퍼에서 두 가지 플랜을 구매할 수 있습니까?**

예. 고객이 동일한 오퍼에서 두 가지 플랜을 동시에 소유할 수 있습니다.
...
Azure Marketplace에서는 제품과 서비스를 Azure 고객에게 홍보하고 판매할 수 있는 시장을 Microsoft 파트너에게 제공합니다. 게시자는 140개 글로벌 시장, 300,000개 이상의 파트너 및 Azure의 엔터프라이즈 고객 네트워크에 즉시 액세스할 수 있습니다.  이 마켓플레이스에는 포춘지 선정 500대 기업 중 90% 이상이 포함되며 세계 유수의 개발자들이 많이 있습니다. Azure 마켓플레이스의 새로운 파트너는 Azure 마켓플레이스에서 제공되는 오퍼에 대한 인식을 높이는 데 도움이 되는 [무비용 Go-To-Market 혜택](gtm-your-marketplace-benefits.md#list-trial-and-consulting-benefits) 세트를 자동으로 제공합니다.

**Azure Marketplace와 AppSource 간의 차별화 요소는 무엇인가요?**

Microsoft 파트너는 대상 고객에 따라 제품을 판매할 위치를 선택할 수 있습니다.

Microsoft는 두 개의 고유한 클라우드 마켓플레이스 저장소인 Azure 마켓플레이스및 AppSource를 제공합니다. 이러한 상점을 통해 고객은 클라우드 애플리케이션과 서비스를 찾고, 사용해 보고, 구매할 수 있습니다. 고객은 각 상점에서 고유한 요구 사항을 충족할 수 있으며, Microsoft 파트너는 대상 고객을 기준으로 하여 판매할 솔루션이나 서비스를 선택할 수 있습니다.
...
Azure Marketplace에서 솔루션을 판매하려는 파트너는 애플리케이션이 Azure에서 실행되거나 Azure를 확장함을 입증해야 합니다. 게시자는 고객에게 서비스 수준 [계약,](https://azure.microsoft.com/support/legal/sla/) [개인 정보 보호 정책,](https://privacy.microsoft.com/privacystatement)전화 및 온라인 지원을 제공해야 합니다. 다수의 워크로드에서는 추가 요구 사항을 충족해야 합니다. [Azure Marketplace 참가 정책](./marketplace-participation-policy.md) 및 [판매자 가이드](marketplace-publishers-guide.md)에서 추가 지침을 검토하세요.
...
Microsoft는 게시자가 활용할 수 있는 표준 계약 조건을 제공하므로 고객은 간소화된 조달 및 법적 검토 프로세스를 갖습니다.
...
아직 Microsoft 계정이 없는 경우 [계정을 만들](https://signup.live.com/) 수 있습니다(예: contoso_marketplace@live.com).
...
**내 변경 사항이 오퍼에 반영되지 않는 이유는 무엇입니까?**

파트너 센터 내에서 변경된 내용은 제안을 다시 게시한 후에만 시스템 및 스토어 프론트에서 업데이트됩니다. 수정 후 게시 제안을 제출했는지 확인하십시오.

### <a name="benefits-and-go-to-market-gtm-resources"></a>혜택 및 GTM(출시) 리소스

**Azure Marketplace에 등록한 판매자용으로 제공되는 출시 혜택으로는 어떤 것이 있나요?**

Microsoft와 함께 진행하는 출시 작업과 공동 판매 파트너 관계는 Azure Marketplace에서 시작됩니다. Azure 마켓플레이스의 모든 새 목록은 Microsoft 고객에게 제공되는 제안에 대한 인식을 높이는 데 도움이 되는 [무비용 Go-To-Market 혜택](https://assetsprod.microsoft.com/mpn/marketplace-gtm-benefits.pdf) 세트를 자동으로 제공합니다. 제품이 판매되면 Microsoft GTM 팀이 판매자에게 연락을 드리며 혜택 제공이 시작됩니다.
...
유용성 또는 문제 해결에 대한 일반적인 응용 프로그램 지원은 [파트너 센터 지원](https://support.microsoft.com/getsupport?wf=0&tenant=ClassicCommercial&oaspworkflow=start_1.0.0.0&locale=en-us&supportregion=en-us&pesid=16230&ccsid=636565784998876007)팀에 문의하십시오.
...
**다른 국가/지역에서 판매할 수 있도록 지리적 가용성을 정의하려면 어떻게 해야 하나요?**

1.  파트너 센터에서 새 국가/지역을 추가할 SKU로 이동합니다.  **SKU 세부 정보**내에서 **국가/지역 가용성으로** 이동한 다음 **지역 선택을**클릭합니다.

    ![지역 선택](media/marketplace-publishers-guide/FAQ-choose-geo.png)

1.  판매할 사용 가능한 모든 국가/지역과 함께 목록이 표시됩니다.  이 SKU를 사용할 수 있도록 하려는 각 국가/지역 옆의 확인란을 클릭합니다. **확인**을 클릭합니다.

    ![국가/지역 목록 선택](media/marketplace-publishers-guide/FAQ-select-countries.png)

1.  마지막으로 변경 내용을 라이브 오퍼에 적용하려면 **게시를**클릭합니다.  

    > [!Note]
    > 변경 사항이 적용되기까지 24시간이 걸립니다.

<!---    ![Publish offer](media/marketplace-publishers-guide/FAQ-publish-offer.png) -->

**게시자는 기존 오퍼의 지리적 가용성을 어떻게 변경할 수 있습니까?**

게시자는 기존 오퍼를 편집하고, 새 국가/지역을 선택하고, 스프레드시트 다운로드/업로드 기능을 사용하여 가격을 설정할 수 있습니다.

**고객이 Azure 마켓플레이스 제품을 구매할 수 있는 국가/리전에서?**

Azure Marketplace는 고객의 청구 주소에 정의된 141개의 구매-에서 구매 지역을 지원합니다. 국가/지역 목록은 [참여 정책을](/legal/marketplace/participation-policy) 참조하세요.

**Azure 마켓플레이스에서 지원하는 통화는 무엇입니까?**

거래는 AUD, BRL, CAD, CHF, DKK, EUR, GBP, INR, JPY, 원화, NOK, NZD, RUB, SEK, TWD 및 USD의 17개 통화로 진행될 수 있습니다.
...
**구매 및 프로비저닝 흐름을 끝까지 검증하는 프로세스는 무엇입니까?**

게시 프로세스 중에 쿠폰 미리 보기에 대한 액세스 권한이 제공됩니다. 액세스는 미리 보기 탭에서 지정한 사용자로 제한되며 다른 사람이 볼 수 없는 라이브 오퍼입니다. 이 것을 구입하고 프로세스를 테스트 할 수 있습니다. 그러나 오퍼의 구성에 따라 전체 금액이 청구됩니다.

매우 저렴한 가격으로 구매를 완료하기 위해 Microsoft는 테스트 비용으로 수락할 수 있는 가격으로 개인 계획을 게시할 것을 제안합니다. 0은 지원되지만 유료 구독과 같은 전체 환경을 반영하지는 않습니다.

**Microsoft는 표준 정책 외부에서 환불을 제공합니까?**

예. 지원 티켓을 통해 요청시 Microsoft는 적절하다고 판단되는 경우 고객에게 크레딧을 처리합니다.
