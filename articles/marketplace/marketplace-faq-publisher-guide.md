...
**Azure Marketplace 고객은 누구인가요?**

Azure Marketplace는 상용 IT 소프트웨어와 서비스에 관심이 있는 IT 전문가 및 클라우드 개발자용입니다.

**Azure Marketplace에서 어떤 유형의 제품을 현재 사용할 수 있습니다?**
...
**Azure Marketplace를 사용하면 어떤 주요 혜택이 있나요?**
...
**Azure Marketplace에서 제품을 어떻게 구매하나요?**
...
**Azure 클라우드 솔루션 공급자로부터 Azure Marketplace 솔루션을 구매할 수 있나요?**

게시자가 CSP 채널을 통해 사용 가능 하도록 해당 제품을 구성한 경우 재판매인을 통해 제공 됩니다.

**어떤 국가 응용 프로그램 및 서비스 판매/프로 비전 된 Azure Marketplace를 통해 구매 하는 것에 대 한 지원 되나요?**
...
**구독에 Azure Marketplace 가상 머신 (VM)에 배포 했으며 이제 하 고 싶어을 Azure 계정 구독 마이그레이션 간입니다. 이 기능이 현재 지원되나요?**
...
**Azure Marketplace VM(가상 머신) 구독을 기업계약으로 마이그레이션하려고 합니다. 이 기능이 현재 지원되나요?**
...
제품별 가격 정보는 솔루션 세부 정보 페이지([https://azure.microsoft.com/en-us/pricing/](https://azure.microsoft.com/pricing/)) 또는 [Microsoft Azure 관리 포털](https://portal.azure.com/) 내에서 확인할 수 있습니다.

>[!Note]
> 월별 요금을 제외하고는 별도로 명시된 경우가 아니면 모든 가격 책정 모델에 Azure 사용 요금이 적용됩니다.

**BYOL marketplace 솔루션에 대 한 내 소프트웨어 라이선스 키를 어떻게 제공 해야 하 고 어떤 Azure Marketplace의 역할은?**
...
**' 평가판 ' 및 ' 무료 소프트웨어 평가판 ' 간의 차이 무엇입니까?**

'무료 평가판' 구독 제품은 영구적으로 무료 사용이 가능합니다.  반면 '무료 소프트웨어 평가판(지금 사용해 보기)' 제품은 제한된 평가 기간 동안만 무료인 유료 제품입니다.

**무료 계층을 배포 하거나 사용자 고유의 라이선스 (BYOL) 제품을 제공 하는 파일에 결제 방법 (예: 신용 카드)에 있어야 하나요?**
...
**Azure Marketplace에서 판매 되는 제품에 대 한 가격 책정에 대 한 질문, 있는 경우 누구에 EA (기업 계약) indirect 고객에 게 문의?**

EA(기업계약) 간접 고객의 경우 모든 Azure Marketplace 가격 관련 질문을 LSP(라이선스 솔루션 공급자)에게 문의해야 합니다.

**Azure Marketplace 및 구매 권한에 내 직원의 액세스를 제어할 수 있나요?**
...
**Azure 구독 크레딧 적용할 수 있습니다 또는 현금 약정 금액을 내 계정의 Azure Marketplace에서 제공?**
...
**이러한 구독에 대해 결제하려면 어떻게 해야 하나요? Azure 청구서에 표시 됩니까 내 Azure Marketplace 구매 또는 다른 자재 명세서가?**
...
**Azure Marketplace 구독 정보와 청구 정보는 어디서 볼 수 있나요?**
...
**Azure VM에 Azure Marketplace 추가 기능을 취소 하는 방법**
...
**Azure Marketplace에서 구매한 제품은 얼마나 자주 청구 고 되나요?**
...
**Azure Marketplace에서 구매한 제품을 내 MOSP 구독에서 Direct EA(기업계약) 구독으로 전환하려면 어떻게 해야 하나요?**
...
**Azure Marketplace에서 제품 가상 머신에 대 한 비용 구조에서 "price", "소프트웨어 가격" 및 "총 가격" 간의 차이점은 무엇입니까?**
...
**Azure 구독 크레딧 또는 통화 금액 내 계정의 Azure 제품과 Azure Marketplace 제품을 실행 하는 데 필요한 서비스에 적용할 수 있나요?**
...
**Azure Marketplace와 관련된 일반적인 지원 문제가 있을 경우 누구에게 연락해야 하나요?**
...
**청구 지원/Marketplace에서 구매한 타사 솔루션과 관련 된 질문에 대 한 문의**
...
**Azure Marketplace에 대 한 지원 포럼, 없습니다?**

예. 커뮤니티 지원을 받으려면 [Azure Marketplace 포럼](https://social.msdn.microsoft.com/Forums/home?forum=DataMarket)을 방문하세요.
...
**Azure Marketplace에서 내 응용 프로그램을 게시 해야는 이유는 무엇 이며 어떻게이 언제 활용 하나요 me?**
...
**Azure Marketplace 및 AppSource 간의 차별화 요소는 무엇입니까?**
...
**Azure Marketplace에서 게시를 어떻게 시작하나요?**
...
**내 응용 프로그램을 사용 하 여 Azure Active Directory (AAD) 통합에 대 한 지침을 어디서 찾을 수 있습니까?**
...
**잠재 고객 및 이유 Marketplace에서 게시자로 중요 한는 무엇 인가요?**
...
**Marketplace에서 제품을 게시 하는 잠재 고객 대상을 구성 하려면 필요 합니까?**

예. **나에게 연락**, **SaaS 앱** 또는 **컨설팅 서비스** 제품을 판매하는 경우 리드 대상을 구성해야 합니다.

**잠재 고객 구성이 올바른지 확인할 수는?**
...
**Azure Marketplace에 나열된 게시자용으로 제공되는 몇 가지 Go-To-Market 혜택은 무엇인가요?**
...
**Azure Marketplace 솔루션은 Microsoft 웹 속성 중 어디에서 프로모션되나요?**
...
**Azure Marketplace에서 판매한에 대해 지불 받으려면 어떻게 해야 합니까?**
...
**사용량 기반 청구를 사용 하 여 구매한 가상 머신 기반 솔루션에 대 한 고객 최대 크기, 기본 가상 컴퓨터를 줄이면 경우 따르지 내 소프트웨어 라이선스의 가격 책정?**

예, 새 가격이 즉시 청구됩니다.  고객이 가상 머신 크기를 변경하고 가격표에서 가상 머신 크기를 기준으로 하는 다른 가격을 지정하면 가격이 변경됩니다.

**노드당 청구 사용할 수 있는 Azure Marketplace에 대 한?**
...
**청구 또는 제안 관리와 관련된 질문이 있을 경우 누구에게 연락해야 하나요?**
...
**있습니까? 경고 내 응용 프로그램 중 하나에 의해 사용 되는 Azure Marketplace에서 구매한 제품을 삭제 하려고 하는 경우**

아니요, 구매한 제품 중 애플리케이션이 사용하는 제품을 삭제해도 경고는 표시되지 않습니다.

**Azure Marketplace 구매에 종속성을 Azure 웹 사이트와 같은 다른 자산에 대 한 경우 다음 있습니까 관리 하기 위해?**
...
**구독에 Azure Marketplace 가상 머신 (VM)에 배포 했으며 이제 해당 구독을 Azure 계정 마이그레이션 하려고 및 다른 합니다. 이 기능이 현재 지원되나요?**
...
가격 정보는 솔루션 세부 정보 페이지([https://azure.microsoft.com/en-us/pricing/](https://azure.microsoft.com/pricing/)) 또는 Microsoft Azure 관리 포털 내에서 확인할 수 있습니다.
...
**Azure Marketplace 및 구매 권한에 대해 직원의 액세스를 제어할 수 있나요?**
...
**내 Microsoft 볼륨 라이선스/기업계약으로 Azure Marketplace에서 구매할 수 있나요?**
...
**내 계정의 Azure 구독 크레딧 또는 현금 약정 금액을 Azure Marketplace 제품에 적용할 수 있나요?**
...
**이러한 구독에 대해 결제하려면 어떻게 해야 하나요? Azure 청구서에 Azure Marketplace에서 구매한 제품은 내 표시 됩니까 아니면 다른 청구서 있습니까?**
...
**Azure Marketplace의 Virtual Machines 제품에 대한 비용 구조에서 "가격," "소프트웨어 가격" 및 "총 가격" 간의 차이점은 무엇인가요?**

"가격"은 소프트웨어를 실행하는 데 드는 Azure Virtual Machine 비용을 의미합니다. "소프트웨어 가격"은 Azure Virtual Machine에서 실행되는 Marketplace 판매자 소프트웨어 비용을 의미합니다. "총 가격"은 Azure Virtual Machine과 Azure Virtual Machine에서 실행되는 Marketplace 판매자 소프트웨어의 비용을 합산한 총액을 의미합니다.

**Azure 구독 크레딧 또는 현금 약정 금액을 Azure 제품 및 Azure Marketplace 제품을 실행 하는 데 필요한 서비스 계정에 적용할 수 있나요?**
...
Azure Marketplace 포럼은 [여기](https://social.msdn.microsoft.com/Forums/azure/home?forum=DataMarket)서 확인할 수 있습니다.
