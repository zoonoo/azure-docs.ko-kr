...
[게시 옵션을 결정](determine-your-listing-type.md)한 후 제품 만들기를 시작 하기 전에 제품 유형을 선택 해야 합니다. 제품 유형은 게시하려는 솔루션, 앱 또는 서비스 제품의 유형뿐만 아니라 Microsoft 제품 및 서비스에 대한 맞춤도 해당됩니다.
...
| [**SaaS**](plan-saas-offer.md) | Saas (software as a service) 제품 유형을 사용 하면 고객이 SaaS 기반 기술 솔루션을 구독으로 구매할 수 있습니다. |
...
| [**Microsoft 365, Dynamics 365 및 Power BI**](./appsource-offer-publishing-guide.md) | Dynamics 365, Microsoft 365, Power BI 및 Power Apps를 빌드하거나 확장 하는 AppSource 제품을 게시할 수 있습니다.|
