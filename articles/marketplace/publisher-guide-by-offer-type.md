---
title: Azure Marketplace |에서 게시 옵션 결정 Azure Marketplace
...
| [**컨설팅 서비스**](https://docs.microsoft.com/azure/marketplace/consulting-services) | 컨설팅 서비스는 고객을 서비스와 연결 하 여 Azure, Dynamics 365 또는 Power Suite 서비스의 사용을 지원 하 고 확장 하는 데 도움이 됩니다.|
