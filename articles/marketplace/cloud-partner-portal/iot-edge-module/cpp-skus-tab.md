...
다음 표에서는 **SKU 세부 정보** 아래의 필드에 대한 용도, 내용 및 형식을 설명합니다. 필수 필드는 별표(*)로 표시됩니다.
...
| **Description\***  | 이 SKU의 짧은 설명입니다. 최대 길이는 3,000자입니다. 제품을 설명하지 마십시오. 이 SKU만 설명합니다. Azure Marketplace 및 Azure Portal에 표시 됩니다. Azure Portal Marketplace 탭에 정의 된 제품을 설명 하는 Marketplace 설명에 추가 됩니다.  SKU 요약과 동일할 수 있습니다. 이 필드가 표시되는 위치를 정확하게 확인하려면 아래 그림을 참조하세요.|
