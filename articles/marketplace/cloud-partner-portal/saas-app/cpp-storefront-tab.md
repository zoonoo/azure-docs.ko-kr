...
|      제품 설명              |      애플리케이션 세부 정보 페이지에 표시되는 설명입니다. 허용되는 최댓값은 1300자입니다. 기본 HTML 태그를 사용하여 콘텐츠에 서식을 지정할 수 있습니다. 예를 들면 &lt;p&gt;, &lt;h1&gt;, &lt;h2&gt; 및 &lt;li&gt;와 같습니다. 서식이 지정된 설명의 모양을 확인하려면 온라인 실시간 HTML 도구(예: http://htmledit.squarefree.com)를 사용하세요.             |
