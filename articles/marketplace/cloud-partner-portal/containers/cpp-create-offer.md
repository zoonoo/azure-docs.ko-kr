---
title: Azure 컨테이너 제품을 만드는 | Azure Marketplace
...
컨테이너 제품 유형에 대한 **새 제품** 페이지는 새 제품을 만드는 데 사용할 탭 집합 및 양식 필드를 제공합니다. 다음 각 문서는 탭을 사용하여 새 컨테이너 제품에 대한 자산 그룹 및 지원 서비스를 정의하는 방법을 설명합니다.
