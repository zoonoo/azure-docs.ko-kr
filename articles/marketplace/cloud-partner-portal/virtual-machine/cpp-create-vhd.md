---
title: Azure Marketplace에 대 한 Azure 호환 VHD 만들기
...
5. 적절한 가상 이미지를 선택한 후 다음 값을 입력합니다.
   ...
   * VM에서 로컬 계정을 만드는 데 사용되는 **사용자 이름**과 강력한 **암호**를 입력합니다.  (여기서 `adminUser` 는를 사용 합니다.)  암호는 8-123 자 여야 하며, 대문자 1 자, 대문자 1 자, 숫자 1 개, 특수 문자 1 개 등 4 가지 복잡성 요구 사항 중 3 가지를 충족 해야 합니다. 자세한 내용은 [사용자 이름 및 암호 요구 사항](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-faq#what-are-the-username-requirements-when-creating-a-vm)을 참조 하세요.
