...
-   [필수 조건](./cpp-prerequisites.md). 만들고 Power BI 앱을 게시에 대 한 기술 및 비즈니스 요구 사항을 제공 합니다.
-   [Power BI 앱 제품을 만드는](./cpp-create-offer.md)합니다. 사용 하 여 Power BI 앱 제품 항목을 만드는 방법 합니다 [클라우드 파트너 포털](https://cloudpartner.azure.com)합니다.
-   [Power BI 앱 제품을 게시](./cpp-publish-offer.md)합니다. 게시에 대 한 AppSource에 새 제품을 제출 하는 방법 및 기존 제품을 업데이트 하는 방법입니다.


## <a name="publishing-steps"></a>게시 단계

Power BI 앱 제품을 게시 하는 대략적인 단계는 다음과 같습니다.

![Power BI 앱 게시 단계를 제공 합니다.](media/publishing-steps.png)
...
Power BI 앱 제품을 만들고 AppSource에 게시 하기 전에 충족 해야 합니다는 [요구 사항](./cpp-prerequisites.md) Power BI 앱을 AppSource에 게시 합니다.
