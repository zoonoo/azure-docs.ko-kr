---
title: Power BI 앱 제품 만들기 - Azure Marketplace | Microsoft Docs
...
| 상점 세부 정보 | 마케팅, 법적 정보 및 잠재 고객 관리 자산을 포함합니다. 마케팅 자산에는 제품 설명 및 로고가 포함됩니다. 법적 정보 자산에는 개인정보처리방침, 사용 약관 및 기타 법률 문서가 포함됩니다. 잠재 고객 관리 정책을 사용하면 AppSource 사용자 포털에서 잠재 고객을 처리하는 방법을 지정할 수 있습니다. |
| 연락처           | 지원 연락처 및 정책 정보가 포함됩니다.                                     |

## <a name="new-offer-form"></a>새 제안 양식

Cloud 파트너 포털에 로그인한 후 왼쪽 창에서 **새 제품**을 선택합니다. 그런 다음, 새 제품 양식을 표시하고 새 앱 제품에 대한 자산을 정의하는 프로세스를 시작하려면 **Power BI 앱**을 선택합니다.

![Power BI 제품 메뉴 항목](./media/new-offer-menu.png)

> [!NOTE] 
> **Power BI 앱** 옵션이 표시되지 않거나 사용할 수 없는 경우 이 제품 유형을 만들 수 있는 권한이 계정에 없는 것입니다. 개발자 계정 등록을 포함하여 이 제품 유형에 대한 [필수 조건](./cpp-prerequisites.md)이 모두 충족되었는지 확인합니다.


## <a name="next-steps"></a>다음 단계

다음 문서에서는 Power BI 앱 제품 유형에 대한 **새 제품** 페이지의 탭에 대해 설명합니다. 각 문서에서 새 Power BI 앱 제품에 대한 자산 그룹 및 지원 서비스를 설명합니다.
