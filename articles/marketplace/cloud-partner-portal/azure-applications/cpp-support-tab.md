---
title: Azure 응용 프로그램 지원을 구성 | Azure Marketplace
...
1. **엔지니어링 연락처** 아래에서 다음 필드에 대한 정보를 제공합니다.
   ...
   - **이름을\***  -앱에 대 한 엔지니어링 연락처의 이름을 입력 합니다. 이 연락처는 Microsoft에서 기술 관련 통신을 받게 됩니다.
   - **전자 메일\***  -엔지니어링 연락처의 전자 메일 주소를 입력 합니다.
   - **Phone\***  -엔지니어링 연락처의 전화 번호를 입력 합니다.
  
2. **지원 연락처** 아래에서 다음 필드에 대한 정보를 제공합니다.

   - **이름을\***  -앱에 대 한 지원 연락처의 이름을 입력 합니다. 이 연락처는 Microsoft에서 지원 관련 통신을 받게 됩니다.
   - **전자 메일\***  -앱에 대 한 지원 담당자의 전자 메일 주소를 입력 합니다.
   - **Phone\***  -지원 담당자의 전화 번호를 입력 합니다.
