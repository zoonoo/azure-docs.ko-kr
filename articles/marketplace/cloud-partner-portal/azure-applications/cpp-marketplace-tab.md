---
title: Azure 응용 프로그램 제품 Marketplace 탭
...
다음 표에서는 제품용 상점을 만드는 데 사용할 설정을 설명합니다.   별표를 사용 하 여 추가 된 필드는 필수입니다.
...
| **중간\***       | 중간 로고: 90 x 90 픽셀 PNG 형식    |
| **큼\***        | 큰 로고: 115 x 115 픽셀 PNG 형식   |
| **와이드\***         | 큰 로고: 255 x 115 픽셀 PNG 형식    |
| **대표**           | 선택적 대표 로고: 815 x 290 픽셀 PNG 형식입니다. **참고:** 대표 아이콘은 업로드한 후에 삭제할 수 없습니다. |
...
| **비디오를 추가 합니다.**      | 선택적 비디오는 제품 세부 정보 페이지에 표시 됩니다. 애플리케이션의 의미 및 작동 방식을 시각적으로 알려주는 좋은 방법입니다. 비디오를 추가하려면 <ul><li>**+ 비디오 추가**를 선택하여 비디오 창을 엽니다.</li><li>**이름** - 이름/제목(최대 100자)을 입력합니다.</li><li>**링크** – 비디오를 호스트하는 사이트(YouTube 또는 Vimeo)의 URL을 입력합니다.</li><li>**썸네일** – 썸네일을 업로드합니다. PNG 형식이어야 하며 크기는 533x324 픽셀입니다.</li></ul>          |
|  |  |
...
- **개인정보 처리 방침 URL\***  – 앱의 개인 정보 취급 방침에 대 한 링크를 입력 합니다.
