---
title: Azure 애플리케이션 제품 필수 구성 요소 | Azure Marketplace
...
ms.locfileid: "73826136"
---
# <a name="azure-application-prerequisites"></a>Azure 애플리케이션 필수 구성 요소

이 문서에서는 Azure Marketplace에 관리되는 애플리케이션 제품을 게시하기 위한 기술 및 비즈니스 필수 구성 요소를 설명합니다.  아직 수행 하지 않은 경우 다음 정보 소스를 검토 합니다.
- SKU 유형에 따라 [Azure 응용 프로그램: 솔루션 템플릿 제품 게시 가이드](../../marketplace-solution-templates.md) 또는 [azure 응용 프로그램: 관리 되는 응용 프로그램 제공 게시 가이드](../../marketplace-managed-apps.md)
- [Azure Marketplace 비디오에 대 한 솔루션 템플릿 및 관리 되는 응용 프로그램 빌드](https://channel9.msdn.com/Events/Build/2018/BRK3603)
...
* Azure 빠른 시작 템플릿<br> 자세한 내용은 다음을 참조하세요.
  ...
  * [GitHub: 빠른 시작 템플릿을 Azure Resource Manager](https://github.com/azure/azure-quickstart-templates)합니다. 이 리포지토리는 커뮤니티가 참여한 현재 사용 가능한 모든 Azure Resource Manager 템플릿을 포함합니다. 검색 가능 템플릿 인덱스는 https://azure.microsoft.com/documentation/templates/에서 유지 관리됩니다.
* UI 정의 만들기<br>
...
* 등록된 Cloud Marketplace 게시자여야 합니다. 등록 되지 않은 경우 [클라우드 마켓플레이스 게시자](https://docs.microsoft.com/azure/marketplace/become-publisher
)로 문서의 단계를 따릅니다.

>[!NOTE]
>동일한 Microsoft 개발자 센터 등록 계정을 사용하여 Cloud 파트너 포털에 로그온해야 합니다. Azure Marketplace 제품에 대해 Microsoft 계정이 하나만 있으면 됩니다. 이 계정은 개별 서비스 또는 제품에 국한 되지 않습니다.

* 회사 (또는 해당 자회사)는 Azure Marketplace에서 지 원하는 판매-국가/지역에 있어야 합니다. 이러한 국가/지역의 최신 목록은 [Microsoft Azure Marketplace 참가 정책](https://azure.microsoft.com/support/legal/marketplace/participation-policies/)을 참조 하세요.
* 제품은 Azure Marketplace에서 지 원하는 청구 모델과 호환 되는 방식으로 허가를 받아야 합니다. 자세한 내용은 Azure Marketplace의 [청구 옵션](https://docs.microsoft.com/azure/marketplace/marketplace-commercial-transaction-capabilities-and-considerations)을 참조하세요.
