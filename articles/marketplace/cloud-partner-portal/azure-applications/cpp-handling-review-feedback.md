...
![Azure DevOps 피드백을 사용 하 여 단계 게시](./media/pub-flow-vsts-access.png)
...
2. 필드 창의 오른쪽에 있는 **정책**섹션에서 문제 메시지 (이 예에서는 **정책 유효성 검사 실패**)를 클릭 하 여 관련 로그 파일을 포함 하 여 문제에 대 한 하위 수준 세부 정보를 조사 합니다.  일반적으로 오류는 로그 파일의 맨 아래에 표시됩니다.
