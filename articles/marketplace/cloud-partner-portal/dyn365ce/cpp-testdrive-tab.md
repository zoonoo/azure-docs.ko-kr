---
title: Dynamics 365 for Customer Engagement 응용 프로그램 제품 테스트 드라이브 탭 | Azure Marketplace
description: 사용 되지 않는 CPP 문서, PC에 연결 됨 문서 "AppSource Marketplace에서 고객 관계 응용 프로그램 제품에 대 한 Dynamics 365에 대 한 테스트 드라이브를 구성 하는 방법"입니다.
