---
title: 컨설팅 혜택에 대한 매장 정보 입력 | Azure 마켓플레이스
description: 클라우드 파트너 포털에서 Azure 또는 Dynamics 365 컨설팅 서비스 제공에서 저장소 세부 정보를 정의합니다.
author: qianw211
...
### <a name="offer-summary"></a>오퍼 요약\*

제품 요약은 제품 이름 바로 아래에 표시되는 제품의 간략한 설명입니다. 일반 텍스트를 사용하여 줄 바꿈 없이 제품 요약을 입력합니다. 아래에는 해당 제품 이름에 적합한 제품 요약의 예제가 나와 있습니다.

*실시예 1*

-   **오퍼 이름**: 클라우드 분석: 3일 워크샵
-   **제공 요약**: Microsoft Azure 및 Power BI, 현재 환경 평가 및 미니 POC 개요입니다.

*실시예 2*

-   **제안 이름**: 산업용 Azure IoT: 30일 개념 증명
-   **제안 요약**: 대시보드, 보고서 및 알림을 통해 현장의 장비를 Azure IoT Hub 솔루션에 안전하게 연결하는 산업용 연결 제품 파일럿을 만듭니다.

*실시예 3*

-   **제공명**: 전문서비스: 1시간 브리핑
-   **제공 요약**: 전문 서비스를 위한 프로젝트, 청구 및 리소스의 향상된 관리를 제공하는 운영 솔루션에 대해 미리 구성된 확장Dynamics 365의 개요 및 데모입니다.

*실시예 4*

-   **오퍼 이름**: 당신의 세계에서 파워 BI : 4 시간 워크샵
-   **제공 요약**: 첫 번째 대시보드를 통해 시작하고 실행하고 모범 사례를 알아봅니다. 알아봅니다(수강자 최대 12명, 현장 진행).

*예제 5*

-   **제안 이름**: 역학 및 프로젝트 : 3 일 평가
-   **제공 요약**: 전문 서비스 회사 및 프로젝트 중심 비즈니스를 위해 설계된 ERP 솔루션에 대한 요구 사항 수집 및 평가.
...
**제공 설명**: 이 3 일 간의 워크샵은 기술 및 비즈니스 리더를위한 것이며 고객의 시설에서 현장에서 개최됩니다.
...
-   개념 증명 : 솔루션이 **고객의**요구 사항을 충족하는지 여부를 결정하는 제한된 범위 구현입니다.
-   **워크샵**: 고객의 데이터 또는 환경에 구축된 교육 세션, 브리핑, 평가 또는 데모를 포함할 수 있는 고객 의 구내에서 수행되는 대화형 참여입니다.
...
>[!Note]
>AppSource 컨설팅 서비스는 현재 미국, 영국 및 캐나다에서 실시간으로 제공됩니다. 아직 거주하지 않은 국가/지역에 대한 쿠폰을 제출할 수 있으며, 검토하여 라이브로 진행할 수 있습니다. 새로운 국가/지역을 열려면 라이브로 진행할 수 있는 최소 수의 오퍼가 필요하므로 거주하지 않는 국가/지역에 대한 오퍼를 권장합니다.
