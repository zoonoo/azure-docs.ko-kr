---
title: Azure 및 Dynamics 365 컨설팅 서비스는 전제 조건을 제공합니다 | Azure 마켓플레이스
description: 클라우드 파트너 포털에서 Azure 또는 Dynamics 365 컨설팅 서비스를 제공하는 필수 구성 조건입니다.
author: qianw211
...
|Power Apps | [PowerApps 파트너십 프로그램에서](https://aka.ms/PowerAppsPartner)고급 혜택을 받을 자격이 있어야 합니다. |

## <a name="next-steps"></a>다음 단계

위의 요구 사항을 충족하면 [컨설팅 서비스 오퍼를 만들](./cpp-consulting-service-create-offer.md)준비가 된 것입니다.
