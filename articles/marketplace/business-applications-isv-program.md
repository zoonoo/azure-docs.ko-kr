...
ISV 연결 프로그램에 대 한 계정을 설정 하 고 관리 하려면 [파트너 센터에서 상업용 마켓플레이스 계정 만들기](./partner-center-portal/create-account.md)문서에서 설명 하는 단계를 완료 합니다. 이 문서에서는 새 계정을 만드는 모든 단계와 새 게시자를 상업적 marketplace 프로그램에 추가 하는 방법에 대 한 정보를 제공 합니다.
...
1. [파트너 센터](https://partner.microsoft.com/dashboard)에 로그인합니다.
1. **설정** (기어 아이콘) > **계정 설정** 을 선택 합니다.
1. **조직 프로필** 에서 **청구 프로필** , **개발자** 탭을 차례로 선택 합니다.
...
- [Dynamics 365 고객 Engagement의 경우](/powerapps/developer/common-data-service/publish-app-appsource) 
- [금융 및 운영에 대 한 Dynamics 365](/dynamics365/fin-ops-core/dev-itpro/lcs-solutions/lcs-solutions-app-source)

> [!IMPORTANT]
> 앱을 AppSource에 라이브 상태로 유지 하기 위해 6 개월 마다 다시 인증 해야 합니다. 자세한 내용은 marketplace 정책 [상업적 Marketplace 인증 정책](/legal/marketplace/certification-policies)을 참조 하세요.
...
- [BUSINESS APPLICATIONS ISV 연결 프로그램 FAQ](https://assetsprod.microsoft.com/faq-using-partner-center-isv-connect.pdf) (PDF)
