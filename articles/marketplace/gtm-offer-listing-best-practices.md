...
| :------------------- |:----------------:|:------:|:-------------:|
| **제품 유형**   |  **Azure Marketplace**  | **AppSource**  |
| Azure 앱 | X | |
| 컨테이너 | X | |
| 컨설팅 서비스 | | | X |
...
Microsoft AppSource 및 Azure Marketplace는 다른 솔루션 유형을 제공 하는 온라인 상점입니다. Azure Marketplace는 또는 Azure에 대해 구축 된 IT 솔루션을 제공 합니다.  Microsoft AppSource 업계 SaaS 응용 프로그램, Dynamics 365 추가 기능, Microsoft 365 추가 기능, 강력한 플랫폼 앱 등의 비즈니스 솔루션을 제공 합니다.

범주 및 하위 범주는 솔루션 유형에 따라 각 온라인 저장소에 매핑됩니다. 제품은 제품 유형, 제품의 트랜잭션 기능 및 범주/하위 범주 선택에 따라 Microsoft AppSource 또는 Azure Marketplace에 게시 됩니다. 

솔루션 유형과 가장 잘 맞는 범주 및 하위 범주를 선택 합니다. 선택 옵션:
...
| 설정 | 모범 사례 |
|:--- |:--- |  
| 제공 로고 (216 × 216에서 350 x 350 px로 제공 되는 PNG 형식): 앱 세부 정보 페이지 | 로고는 디지털 매체에 맞게 설계하고 최적화합니다.<br>제품의 앱 세부 정보 목록 페이지에 PNG 형식의 로고를 업로드합니다. 파트너 센터는 필요한 로고 크기로 크기를 조정 합니다. |
| 제품 로고 (PNG 형식, 48 x 48 픽셀): 검색 페이지 | 파트너 센터는 업로드 한 긴 로고에서이 로고를 생성 합니다. 필요에 따라 나중에 다른 이미지로이를 바꿀 수 있습니다. |
