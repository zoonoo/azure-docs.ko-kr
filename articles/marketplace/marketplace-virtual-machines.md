...
가상 컴퓨터 제공은 Azure Marketplace를 통해 배포 되 고 청구 되는 트랜잭션 제품입니다. 사용자에 게 표시 되는 동작에 대 한 호출은 *지금 가져옵니다*.
...
> 
> [!NOTE]
> 이미지와 가격을 개인 제품으로 게시 하 여 VM의 검색 및 배포를 특정 고객 집합으로 제한할 수 있습니다. 비공개 제품은 가장 가까운 고객을 위한 독점적인 제품을 만들고 사용자 지정 된 소프트웨어 및 조건을 제공 하는 기능을 잠금 해제 합니다. 이러한 사용자 지정된 사용 약관을 사용하면 사용자가 전문화된 가격 책정 및 조건뿐 아니라 제한된 릴리스 소프트웨어에 대한 초기 액세스를 사용하여 선도적인 거래를 포함한 다양한 시나리오를 강조 표시할 수 있습니다. 개인 제공 기능을 사용 하면 해당 세부 정보를 사용 하 여 새 SKU를 만들어 제한 된 고객 집합에 특정 가격 책정 또는 제품을 제공할 수 있습니다.  
>
