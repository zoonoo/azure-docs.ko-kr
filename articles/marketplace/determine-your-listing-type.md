...
**목록** – 마켓플레이스 사용자가 **연락처** CTA를 통해 고객과 연결하도록 요청할 수 있는 응용 프로그램 또는 서비스의 단순한 목록입니다.

**평가판** – 마켓플레이스를 사용하여 응용 프로그램의 평가판 환경의 자동 프로비저닝 및 검색 기능을 향상시키면서 잠재 사용자가 구입 전에 제한된 시간 동안 무료로 SaaS, IaaS 또는 Microsoft 앱 내 환경을 사용하게 할 수 있습니다. 평가판 게시 옵션에 사용된 CTA(calls-to-action)는 **평가판** 또는 **시험 사용** 중 하나입니다.

**거래** – 고객이 Get it Now CTA(calls-to-action)를 선택하는 경우 응용 프로그램은 Azure에서 실행되며 고객의 Azure 구독에 리소스로 직접 프로비전될 수 있습니다. 소프트웨어 라이선스 요금은 필요에 따라 고객의 결제 수단 및 조건 선택을 통해 구매 및 청구될 수 있으며, **무료 소프트웨어 평가판**(Azure Marketplace에서만 사용 가능)에 대한 시간 제한 액세스를 제공하도록 선택할 수 있습니다. 

## <a name="select-an-offer-type"></a>제품 유형 선택

게시 옵션을 결정했으면 제품을 제공하는 데 사용할 수 있는 제품 유형을 선택할 준비가 된 것입니다. 

제품은 Cloud 파트너 포털에서 만들고 게시하고 관리할 게시 개체입니다. 마켓플레이스에 제품을 제공하는 데 사용된 메타데이터, 아티팩트 및 기타 콘텐츠를 포함한 제품 구조는 제품 유형에 의해 정의됩니다.
