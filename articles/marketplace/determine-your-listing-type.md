...
게시 옵션을 선택하기 전에 상용 마켓플레이스 솔루션, 앱 및 서비스에 대한 스토어프론트 자격 요건을 이해하는 것이 중요합니다.

**Microsoft AppSource** 응용 프로그램은 Azure에 기본 제공하거나 사용할 수 있는 업무 용 솔루션입니다: 역학 365, Office 365, Power BI 또는 Power Apps. AppSource 컨설팅 서비스는 고객이 Dynamics 365 및 Power BI 사용을 시작하거나 가속화하도록 도와주는 전문 서비스 제품입니다.

**Azure Marketplace** 응용 프로그램은 Azure를 위해 기본 제공또는 기본 제공된 기술 "빌딩 블록" 솔루션이며 IT 또는 개발자 대상을 위한 것입니다. Azure Marketplace 컨설팅 서비스는 고객이 Azure 사용을 시작하거나 가속화하도록 도와주는 전문 서비스 제품입니다.

## <a name="understand-storefront-selection"></a>상점 선택 이해

각 상점은 고유한 고객 요구 사항을 제공합니다. 쿠폰이 게시되는 스토어프론트는 특정 잠재고객을 타겟팅하기 위해 오퍼 유형, 거래 기능 및 카테고리 및/또는 업계 선택에 따라 결정됩니다. 

>[!Note]
>'교차 목록'(SaaS 앱에만 해당): 목록 또는 평가판 기반 오퍼가 기술 및 비즈니스 사용자 잠재고객 모두의 기준을 충족하는 경우 오퍼가 두 스토어모두에 나열됩니다. 아래 게시 옵션에 대해 자세히 알아봅니다.

## <a name="choose-a-publishing-option"></a>게시 옵션 선택

사용 가능한 게시 옵션은 차별화된 고객 참여를 제공하면서 잠재 고객 공유 및 [상업용 마켓플레이스 혜택에](https://docs.microsoft.com/azure/marketplace/gtm-your-marketplace-benefits)대한 액세스를 제공합니다.  게시 옵션에 해당하는 CTA(calls-to-action)를 참고합니다.

| **게시 옵션**    | **설명**  |
| :------------------- | :-------------------|
| **목록** | 상용 마켓플레이스 사용자가 연락처 예약-투-액션을 통해 고객과 연결하도록 **Contact Me** 요청할 수 있는 애플리케이션 또는 서비스의 간단한 목록입니다. |
| **평가판** | 상용 마켓플레이스를 사용하여 검색 가능성을 향상시키고 솔루션 평가판 환경의 프로비저닝을 자동화하여 잠재 사용자가 구매하기 전에 제한된 시간 동안 무료로 SaaS, IaaS 또는 Microsoft 인앱 환경을 사용할 수 있습니다. 평가판 게시 옵션에 사용되는 클릭 유도대 는 **무료 평가판** 또는 **테스트 드라이브**입니다. |
| **BYOL** | 상용 마켓플레이스를 사용하여 검색 가능성을 높이고 솔루션 프로비저닝을 자동화하고 금융 거래를 별도로 완료하십시오. BYOL 제공 유형은 온-프레미스에서 클라우드 마이그레이션에 이상적입니다. 클릭 유도문의 경우 **Get it Now.**
| **거래** | 거래 제안은 상업 시장을 통해 판매됩니다. Microsoft는 청구 및 컬렉션에 대한 책임이 있습니다. 클릭 유도문의 경우 **Get it Now.**|
