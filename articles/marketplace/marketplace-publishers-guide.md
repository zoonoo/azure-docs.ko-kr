...
클라우드 마켓플레이스에서 게시자로 등록하려면 아래 단계를 따릅니다. Microsoft 및 선택된 등록 형식을 사용하는 기존 방법에 따라 몇 가지 단계가 필요하지 않을 수 있습니다. 
...
**3.    전체 제품 및 등록 형식 필수 구성 요소:**

마케팅 및 기술 콘텐츠 요구 사항은 상점, 제품 형식 및 등록 형식에 따라 달라집니다. 충족하는지 확인하기 위해 다음 사양을 검토합니다.
-   상점 요구 사항: Azure Marketplace 및 AppSource
-   등록 형식 요구 사항: 목록, 평가판 및 거래
-   제품 형식 요구 사항: 
 -  앱 - 가상 머신, 컨테이너 또는 SaaS
 -  제품 컨설팅
...
**Azure Marketplace: 게시 옵션에 대한 필수 구성 요소**
...
#### <a name="prerequisites-specific-to-transaction-publishing-for-containers"></a>컨테이너에 대한 트랜잭션 게시와 관련된 필수 구성 요소
...
**Marketplace에 대한 Azure AD 통합 인증: 다중 테넌트 응용 프로그램**
...
**Marketplace에 대한 Azure AD 통합 인증: 단일 테넌트 응용 프로그램**
...
이 섹션에서는 다음을 수행하는 단계를 설명합니다. <ul><li>Azure Marketplace 및 AppSource에서 게시자가 됩니다.</li><li>Cloud 파트너 포털에 대한 액세스 권한을 얻습니다. 해당 포털을 사용하여 제품을 빌드, 게시 및 유지 관리합니다.</li></ul>
...
비즈니스 사용자가 **AppSource**에서 비즈니스 결과를 추진하고 투자 비용 회수 기간을 줄이는 데 도움이 되는 기간 업무 SaaS 응용 프로그램과 구현 서비스를 찾고 체험 및 다운로드하도록 유도합니다. 
