...
ms.locfileid: "90030466"
---
# <a name="comparing-microsoft-appsource-and-azure-marketplace"></a>Microsoft AppSource 및 Azure Marketplace 비교

Microsoft 상업적 marketplace에는 [Microsoft AppSource](https://appsource.microsoft.com) 및 [Azure Marketplace](https://azuremarketplace.microsoft.com)포함 되어 있습니다. 각 온라인 저장소는 고유한 시나리오와 다양 한 솔루션 유형을 제공 하므로 올바른 고객이 솔루션 또는 서비스를 사용할 수 있는지 확인할 수 있습니다.

## <a name="understanding-the-differences-between-online-stores"></a>온라인 상점 간의 차이점 이해

온라인 저장소를 선택 하려면 먼저 제공 하는 솔루션 유형을 식별 합니다. 제품이 IT 및 비즈니스 솔루션인 경우 여러 매장에서 판매 하기 위해 한 번 게시할 수 있습니다.
...
| **고객에 대 한 상황에 맞는 프레젠테이션** | 상황별 검색을 위해 Azure Portal 내 환경에서 사용자 솔루션을 사용하도록 할 수 있습니다. 가상 머신 및 Azure 앱 사용: 솔루션 템플릿 게시 옵션 | Dynamics 365, Power BI, Microsoft 365 등의 Microsoft 제품에 대 한 앱 내 환경을 통해 더 많은 고객에 게 도달 하세요. |

## <a name="next-steps"></a>다음 단계

* [상업용 마켓플레이스 게시 가이드](marketplace-publishers-guide.md)
