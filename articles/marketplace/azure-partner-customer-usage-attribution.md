...
> [!NOTE]
> 기존 Azure 앱의 경우 각 계획의 기술 구성에서 추적 Id를 업데이트 하기 위해 3 월 2021 일에 일회성 마이그레이션이 시작 됩니다. 이러한 제품의 이전 배포에 대 한 사용량은 Microsoft 시스템에서 계속 추적 됩니다.
>
>제품을 업데이트할 때 기본 템플릿 파일에 더 이상 **Microsoft .resources/배포** 리소스 유형을 추가할 필요가 없습니다.
