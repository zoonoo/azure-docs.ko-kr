---
title: 상업적 마켓플레이스 파트너 및 고객 사용 특성
description: Azure Marketplace 솔루션에 대 한 고객 사용 추적 개요를 확인 하세요.
author: dsindona
...
ms.locfileid: "82186206"
---
# <a name="commercial-marketplace-partner-and-customer-usage-attribution"></a>상업적 마켓플레이스 파트너 및 고객 사용 특성

고객 사용 특성은 사용자를 파트너와 함께 사용 하 여 솔루션을 실행 하기 위해 배포 된 고객 구독에서 실행 되는 Azure 리소스를 연결 하는 방법입니다. 내부 Microsoft 시스템에서 이러한 연결을 형성 하면 소프트웨어를 실행 하는 Azure의 공간을 보다 잘 파악할 수 있습니다. 이 추적 기능을 채택 하는 경우 Microsoft 영업 팀에 맞추고 Microsoft 파트너 프로그램의 크레딧을 얻으세요.

영구 IP (예: 앱 개발)를 만드는 Azure Marketplace, 빠른 시작 리포지토리, 개인 GitHub 리포지토리 및 1:1 고객 계약을 통해 연결을 구성할 수 있습니다.

고객 사용 특성은 세 가지 배포 옵션을 지원 합니다.
...
- Terraform: 파트너는 Terraform을 사용 하 여 리소스 관리자 템플릿을 배포 하거나 Azure 서비스를 직접 배포할 수 있습니다.

>[!IMPORTANT]
>- 고객 사용 특성은 Azure에서 실행 되는 소프트웨어를 배포 하 고 관리 하기 위해 설계 된 시스템 통합 업체, 관리 서비스 공급자 또는 도구의 작업을 추적 하기 위한 것이 아닙니다.
>
>- 고객 사용 특성은 새 배포에 사용 되며 이미 배포 된 기존 리소스의 태그 지정은 지원 하지 않습니다.
>
>- Azure Marketplace에 게시 된 [Azure 애플리케이션](./partner-center-portal/create-new-azure-apps-offer.md) 제품에 대 한 고객 사용 특성이 필요 합니다.

[!INCLUDE [updated-for-az](../../includes/updated-for-az.md)]

## <a name="create-guids"></a>GUID 만들기

GUID는 32 16 진수가 있는 고유한 참조 식별자입니다. 추적을 위한 GUID를 만들려면 GUID 생성기를 사용해야 합니다. Azure Storage 팀은 [GUID 생성기 양식](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR3i8TQB_XnRAsV3-7XmQFpFUMVRVVFFLTDFLS0E2QzNYSkFZR1U3WVJCTSQlQCN0PWcu)을 만든 후 이 양식을 통해 올바른 형식의 GUID를 이메일로 전달합니다. 이 GUID를 다른 추적 시스템에서 다시 사용할 수 있습니다.

> [!NOTE]
> GUID를 만드는 [Azure Storage의 guid 생성기 형식을](https://forms.office.com/Pages/ResponsePage.aspx?id=v4j5cvGGr0GRqy180BHbR3i8TQB_XnRAsV3-7XmQFpFUMVRVVFFLTDFLS0E2QzNYSkFZR1U3WVJCTSQlQCN0PWcu) 사용 하는 것이 좋습니다. 자세한 내용은 [FAQ](#faq)를 참조하세요.
...
보고는 Microsoft 파트너 네트워크 ID 및 GUID를 통해 수행 됩니다.

추가 Guid를 등록 하 고 계획 사이에 Guid를 변경 하 여 더 세부적인 수준에서 사용량을 추적할 수도 있습니다. 여기서 요금제는 제품의 변형입니다.

## <a name="register-guids"></a>Guid 등록

고객 사용 특성을 사용 하려면 Guid를 파트너 센터에 등록 해야 합니다.

템플릿 또는 사용자 에이전트에 GUID를 추가 하 고 파트너 센터에 GUID를 등록 하면 이후 배포가 추적 됩니다.

1. [파트너 센터](https://partner.microsoft.com/dashboard)에 로그인 합니다.

1. [상업적 마켓플레이스 게시자](https://partner.microsoft.com/dashboard/account/v3/enrollment/introduction/azureisv)로 등록 합니다.
   ...
   * 파트너는 비 marketplace 솔루션 템플릿 및 제품에 대해 Guid를 등록할 수 있습니다.
...
많은 파트너 솔루션이 Azure Resource Manager 템플릿을 사용 하 여 배포 됩니다. Azure Marketplace, GitHub 또는 빠른 시작에서 사용할 수 있는 리소스 관리자 템플릿이 있는 경우 고객 사용 특성을 사용 하도록 템플릿을 수정 하는 프로세스가 바로 진행 됩니다.
...
>* [Azure 애플리케이션 제품](./partner-center-portal/create-new-azure-apps-offer.md)입니다.
...
Python의 경우 **config** 특성을 사용합니다. 이 특성은 UserAgent에만 추가할 수 있습니다. 아래 예를 살펴보세요.
...
Terraform에 대 한 지원은 Azure 공급자의 1.21.0 릴리스를 통해 제공 [https://github.com/terraform-providers/terraform-provider-azurerm/blob/master/CHANGELOG.md#1210-january-11-2019](https://github.com/terraform-providers/terraform-provider-azurerm/blob/master/CHANGELOG.md#1210-january-11-2019)됩니다.  이 지원은 Terraform을 통해 솔루션을 배포 하는 모든 파트너와 Azure 공급자 (버전 1.21.0 이상)에서 배포 및 계량 되는 모든 리소스에 적용 됩니다.
...
파트너 센터 대시보드 ([https://partner.microsoft.com/dashboard/mpn/analytics/CPP/MicrosoftAzure](https://partner.microsoft.com/dashboard/mpn/analytics/CPP/MicrosoftAzure))에서 고객 사용 특성에 대 한 보고서를 찾을 수 있습니다. 보고서를 보려면 파트너 센터 자격 증명을 사용 하 여 로그인 해야 합니다. 보고서 또는 로그인에 문제가 발생 하는 경우 지원 받기 섹션의 지침에 따라 지원 요청을 만듭니다.
...
1. [파트너 기술 서비스](https://partner.microsoft.com/training/partner-technical-services)를 참조 하세요.
...
[기술 예약 판매 및 배포 서비스 사용](https://support.microsoft.com/help/3121537/using-technical-presales-and-deployment-services#request%20a%20technical%20consultation)의 스크린샷에 대 한 단계별 지침을 확인 하세요.
...
예, 템플릿을 배포할 때 GUID가 있는 한 사용량이 추적됩니다. 파트너는 여전히 Guid를 등록 해야 합니다.

**고객도 보고를 받나요?**

고객은 Azure Portal 내에서 개별 리소스 또는 고객 정의 리소스 그룹의 사용량을 추적할 수 있습니다. 고객은 GUID로 분류 된 사용량을 볼 수 없습니다.
