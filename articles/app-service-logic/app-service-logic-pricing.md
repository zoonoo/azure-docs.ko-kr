---
title: "논리 앱 가격 책정 모델 | Microsoft Docs"
...
소비 기반 사용량에는 추가 비용 없이 Logic Apps의 [B2B/EDI](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-b2b?toc=%2fazure%2flogic-apps%2ftoc.json) 및 [XML 처리](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-xml?toc=%2fazure%2flogic-apps%2ftoc.json) 기능을 사용할 수 있도록 하는 탐색, 개발 및 테스트 목적의 [통합 계정](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-create-integration-account?toc=%2fazure%2flogic-apps%2ftoc.json)이 포함되어 있습니다. 하위 지역당 최대 1개의 계정을 만들고 최대 10개의 규약과 25개의 지도를 저장할 수 있습니다. 스키마, 인증서 및 파트너에는 제한이 없고 필요한 만큼 업로드할 수 있습니다.

소비에 통합 계정을 포함하는 것 외에도, 표준 Logic Apps SLA를 사용하여 이러한 제한이 없는 표준 통합 계정을 만들 수도 있습니다. 자세한 내용은 [여기](https://azure.microsoft.com/pricing/details/logic-apps)를 참조하세요.
...
* [첫 번째 논리 앱 만들기][만들기] [가격 책정]: https://azure.microsoft.com/pricing/details/logic-apps/ [whatis]: app-service-logic-what-are-logic-apps.md [만들기]: app-service-logic-create-a-logic-app.md
