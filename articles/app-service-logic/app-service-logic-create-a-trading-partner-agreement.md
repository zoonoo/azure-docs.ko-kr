---
title: "Azure App Service에서 거래 업체 규약 만들기 | Microsoft Docs"
...
---
# <a name="creating-a-trading-partner-agreement"></a>거래 업체 규약 만들기
...
### <a name="biztalk-api-apps-that-support-b2b-scenarios"></a>B2B 시나리오를 지원하는 BizTalk API 앱
다음 API 앱에서는 Azure 포털의 다양하고 직관적인 환경을 사용하여 이러한 기능을 사용할 수 있습니다.

## <a name="biztalk-trading-partner-management-tpm"></a>BizTalk TPM(거래 업체 관리)
...
## <a name="as2-connector"></a>AS2 커넥터
