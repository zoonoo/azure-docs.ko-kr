---
title: 논리 앱에서 FTP 커넥터 사용 | Microsoft Docs
...
> [!NOTE]
> 이 문서 버전은 논리 앱 2014-12-01-미리 보기 스키마 버전에 적용됩니다. 2015-08-01-preview 스키마 버전에 대한 내용을 보려면 [FTP API](../connectors/connectors-create-api-ftp.md)를 클릭하세요.
> 
> 
