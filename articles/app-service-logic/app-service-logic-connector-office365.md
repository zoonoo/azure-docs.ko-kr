...
2.	'논리 앱 만들기' 페이지에서 이름, 앱 서비스 계획 및 위치와 같은 필요한 세부 정보를 제공합니다. ![][2]

3.	'트리거 및 작업'을 클릭하면 논리 앱 편집기가 열립니다. ![][3]

4.	흐름에 추가하기 위해서 갤러러의 '이 리소스 그룹의 API 앱' 섹션에서 Office 365 트리거를 선택합니다. ![][4]
...
8.	권한 부여가 완료되면 Office 365 트리거 표시됩니다. ![][8]
...
11. Office 365 '새 메일' 트리거가 구성되며 출력 매개 변수도 표시되는 것을 볼 수 있습니다. ![][10]

12.	갤러리의 'Recently Used(최근에 사용한 항목)' 섹션에서 'Office 365 Connector'를 선택하면 새 'Office 365' 동작이 추가됩니다.

13.	동작 목록에서 ‘이벤트 보내기’를 선택하면 ‘이벤트 보내기’ 동작의 입력 매개 변수가 표시됩니다. ![][11]

14.	이벤트 세부 정보를 지정하고 ✓를 클릭 합니다. ![][12]

15.	갤러리의 'Recently Used(최근에 사용한 항목)' 섹션에서 'Office 365 Connector'를 선택하면 새 'Office 365' 동작이 추가됩니다.

16.	동작 목록에서 '연락처 추가'를 선택하면 '연락처 추가' 동작의 입력 매개 변수가 표시됩니다. ![][13]

17.	'메일 주소' 필드 옆에 있는 '+'에 클릭하고 트리거에서 'From' 출력 필드 값을 선택 합니다. ![][14]

18. ✓ 를 클릭하고 동작 구성이 완료됩니다. ![][15]

19.	갤러리의 'Recently Used(최근에 사용한 항목)' 섹션에서 'Office 365 Connector'를 선택하면 새 'Office 365' 동작이 추가됩니다.


20.	동작 목록에서 ‘메일 보내기'를 선택하면 ‘메일 보내기’ 동작의 입력 매개 변수가 표시됩니다. ![][19]
...
23.	동작 목록에서 'Reply To'를 선택하면 'Reply To' 동작의 입력 매개 변수가 표시됩니다. ![][16]

24.	'From' 필드 옆에 있는 '+'에 클릭하고 트리거의 출력 메시지 ID의 값을 선택하고 ✓를 클릭합니다.![][17]
