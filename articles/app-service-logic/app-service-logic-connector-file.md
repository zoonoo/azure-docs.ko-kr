---
title: 논리 앱에서 File 커넥터 사용 | Microsoft Docs
...
5. 각각은 특정 속성을 노출합니다. 아래 이미지는 트리거 및 파일 가져오기 작업에 대한 속성을 나열합니다. ![][6]
...
> [!NOTE]
> Azure 계정을 등록하기 전에 Azure Logic apps을 시작하려는 경우 [논리 앱 평가](https://tryappservice.azure.com/?appservice=logic)로 이동합니다. App Service에서 즉시 단기 스타터 논리 앱을 만들 수 있습니다. 신용 카드는 필요하지 않으며 약정도 필요하지 않습니다.
> 
> 
