...
1. Azure Portal 왼쪽에 있는 + 새로 만들기 옵션을 사용하여 Azure Marketplace를 엽니다.
2. "파일 커넥터"를 검색합니다.
...
커넥터의 성능 통계를 검토하고 보안을 제어할 수 있습니다. [논리 앱 모니터링](app-service-logic-monitor-your-logic-apps.md)을 참조하세요.
