...
>[AZURE.NOTE] 이 문서 버전은 논리 앱 2014-12-01-preview 스키마 버전에 적용됩니다.
...
1. Azure 포털에 로그인합니다.
2. 새로 만들기-> 마켓플레이스를 선택한 다음 *BizTalk 규칙*을 검색합니다.
...
4.	*만들기*를 선택합니다. 몇 분 내에 BizTalk 규칙 API 앱이 만들어집니다.
...
1.	"추가"를 클릭하면 새 "정의 추가" 블레이드가 열립니다. 다음 값을 입력합니다.
  ...
  5. 입력 – 정의 값을 입력합니다. 여기서 입력하는 값은 선택한 데이터 형식을 준수해야 합니다. 단일 값, 쉼표로 구분된 값 집합 또는 키워드 *to*를 사용하여 값 범위를 입력할 수 있습니다. 예를 들어 고유 값 1, 집합 1, 2, 3 또는 1~5(1 to 5) 범위를 입력할 수 있습니다. 범위는 숫자에만 지원됩니다.
  6. *확인*을 선택합니다.
