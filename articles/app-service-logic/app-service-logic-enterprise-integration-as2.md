...
2. 열린 **통합 계정** 블레이드에서 규약을 만들 통합 계정을 선택합니다. 통합 계정 목록이 표시되지 않으면 [먼저 계정을 만듭니다](app-service-logic-enterprise-integration-accounts.md "All about integration accounts").  
...
5. 규약의 **이름**을 입력한 다음 열린 규약 블레이드에서 **호스트 파트너**, **호스트 ID**,  **게스트 파트너**, **게스트 ID**를 선택합니다.  
...
1. **수신 설정** 을 선택하여 규약을 통해 수신된 메시지를 처리하는 방법을 구성합니다.  
   ...
   * 또한 메시지를 압축해야 할 수 있습니다. 이를 위해 **메시지 압축 필요** 확인란을 선택합니다.  
