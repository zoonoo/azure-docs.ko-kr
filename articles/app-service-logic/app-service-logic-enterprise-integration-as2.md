...
3. 열린 **통합 계정** 블레이드에서 규약을 만들 통합 계정을 선택합니다. 통합 계정 목록이 표시되지 않으면 [먼저 계정을 만듭니다](./app-service-logic-enterprise-integration-accounts.md "통합 계정에 대한 모든 정보"). ![](./media/app-service-logic-enterprise-integration-overview/overview-3.png)
4.  **규약** 타일을 선택합니다. 규약 타일이 표시되지 않으면 먼저 추가합니다. ![](./media/app-service-logic-enterprise-integration-agreements/agreement-1.png)
5. 열린 규약 블레이드에서 **추가** 단추를 선택합니다. ![](./media/app-service-logic-enterprise-integration-agreements/agreement-2.png)
6. 규약의 **이름**을 입력한 다음 열린 규약 블레이드에서 **호스트 파트너**, **호스트 ID**, **게스트 파트너**, **게스트 ID**를 선택합니다. ![](./media/app-service-logic-enterprise-integration-agreements/agreement-3.png)
...
다음을 계속합니다.
7. **수신 설정**을 선택하여 규약을 통해 수신된 메시지를 처리하는 방법을 구성합니다.
...
|URL|메시지를 전송할 URL입니다.|
다음을 계속합니다.
8. **송신 설정**을 선택하여 규약을 통해 전송된 메시지를 처리하는 방법을 구성합니다. ![](./media/app-service-logic-enterprise-integration-agreements/agreement-5.png)
