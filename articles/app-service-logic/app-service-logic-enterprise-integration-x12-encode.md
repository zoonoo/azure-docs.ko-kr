---
title: "엔터프라이즈 통합 팩 X12 메시지 인코딩 커넥터에 대해 알아보기 | Microsoft Docs"
...
### <a name="connect-to-encode-x12-message-using-the-following-steps"></a>다음 단계를 사용하여 X12 메시지 인코딩에 연결합니다.
...
#### <a name="x12---encode-x12-message-by-agreement-name"></a>X12 - 규약 이름으로 X12 메시지 인코딩
1. 드롭다운 목록에서 X12 규약 및 인코딩할 xml 메시지를 선택합니다.
   
    ![필수 필드 제공](./media/app-service-logic-enterprise-integration-x12connector/x12encodeimage4.png) 

#### <a name="x12---encode-x12-message-by-identities"></a>X12 - ID로 X12 메시지 인코딩
1. 보낸 사람 식별자, 보낸 사람 한정자, 받는 사람 식별자 및 받는 사람 한정자를 X12 규약에 구성된 대로 제공합니다.  인코딩할 xml 메시지 선택
   
   ![필수 필드 제공](./media/app-service-logic-enterprise-integration-x12connector/x12encodeimage5.png) 

## <a name="x12-encode-does-following"></a>X12 인코딩은 다음을 수행합니다.
