...
2. Blob 보안 액세스 수준이 **익명 액세스 없음**인 경우  
...
3. 새로 추가된 스키마가 표시됩니다. ![](./media/app-service-logic-enterprise-integration-schemas/schema-41.png)
