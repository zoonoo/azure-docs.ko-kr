...
7. 2MB(최대 8MB)보다 큰 스키마 파일을 추가하려면
   * 스키마를 저장소에 업로드하고 URI를 복사합니다. ![](./media/app-service-logic-enterprise-integration-schemas/schema-blob.png)
   * 스키마 추가에서 큰 파일을 선택하고 콘텐츠 URI에 URI를 제공합니다. ![](./media/app-service-logic-enterprise-integration-schemas/schema-largefile.png) 8. 새로 추가된 스키마가 표시됩니다. ![](./media/app-service-logic-enterprise-integration-schemas/schema-41.png)
