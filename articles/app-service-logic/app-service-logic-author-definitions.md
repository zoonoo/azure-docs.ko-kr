...
```
{
	...
	"parameters": {
		"dataFeeds": {
			"defaultValue": ["https://www.microsoft.com/ko-KR/default.aspx", "https://gibberish.gibberish/"],
			"type": "Array"
		}
	},
	"triggers": {
...
```
{
	...
	"parameters": {
		"dataFeeds": {
			"defaultValue": ["https://www.microsoft.com/ko-KR/default.aspx", "https://office.live.com/start/default.aspx"],
			"type": "Array"
		}
	},
	"triggers": {
