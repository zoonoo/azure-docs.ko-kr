---
title: Microsoft Azure 앱 서비스에서 DB2 커넥터 사용 | Microsoft Docs
...
> [!TIP]
> DB2 연결 "*EntitySet에 게시*"는 ID 열 값을 반환하고 "*API 삽입*"은 영향을 받는 행을 반환합니다.
> 
> 
...
> [!TIP]
> 다음 SQL 문을 사용하여 샘플 테이블 및 저장 프로시저를 만듭니다.
> 
> 
...
## 하이브리드 구성(선택 사항)
> [!NOTE]
> 이 단계는 방화벽 뒤의 DB2 커넥터 온-프레미스를 사용하는 경우에만 필요합니다.
> 
> 
