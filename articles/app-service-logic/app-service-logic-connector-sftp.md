...
5. 찾아보기 -> API 앱 -> <Name of the API App just created>을 통해 방금 만든 API 앱으로 이동하면 "보안" 구성 요소가 구성되지 않은 것을 확인할 수 있습니다. ![][2]
6. "보안" 구성 요소를 클릭하여 SFTP 커넥터에 대한 보안(사용자 이름, 암호, 개인 키, PPK 파일 암호)을 구성합니다. 보안에서 "Password" 또는 "Privatekey" 또는 "MutliFactor" 인증 탭을 선택하고 필요한 속성을 제공합니다. ![][3] ![][4] ![][5]  
...
1.	새 논리 앱을 만들고 SFTP 커넥터가 있는 동일한 리소스 그룹을 선택합니다. ![][6]
2.	"트리거 및 동작"을 열어 논리 앱 디자이너를 열고 흐름을 구성합니다. ![][7]
3.	SFTP 커넥터가 오른쪽의 갤러리에 있는 "이 리소스 그룹의 API 앱" 섹션에 나타납니다. ![][8]
