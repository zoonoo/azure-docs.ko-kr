---
title: "엔터프라이즈 통합 팩 AS2 메시지 디코딩 커넥터에 대해 알아보기 | Microsoft Docs"
...
---
# <a name="get-started-with-decode-as2-message"></a>AS2 메시지 디코딩 시작
...
### <a name="connect-to-decode-as2-message-using-the-following-steps"></a>다음 단계를 사용하여 AS2 메시지 디코딩에 연결합니다.
...
## <a name="the-as2-decode-does-the-following"></a>AS2 디코딩은 다음 작업을 수행합니다.
* AS2/HTTP 헤더 처리
* 서명 확인(구성된 경우)
* 메시지 암호 해독(구성된 경우)
* 메시지 압축 해제(구성된 경우)
