...
---
# <a name="get-started-with-decode-x12-message"></a>X12 메시지 디코딩 시작
...
### <a name="connect-to-decode-x12-message-using-the-following-steps"></a>다음 단계를 사용하여 X12 메시지 디코딩에 연결합니다.
...
## <a name="x12-decode-does-following"></a>X12 디코딩은 다음을 수행합니다.
