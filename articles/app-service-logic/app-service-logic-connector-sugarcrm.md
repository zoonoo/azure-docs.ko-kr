...
5.	갤러리에서 ‘이 리소스 그룹의 API 앱’을 확장하여 사용할 수 있는 모든 API 앱을 확인합니다. 갤러리에서 ‘SugarCRM’을 선택하면 ‘SugarCRM 커넥터’가 흐름에 추가됩니다.
...
12.	이름으로 ‘Microsoft 계정’을 입력하고 ✓을 클릭합니다.

	![][5]

13.	갤러리의 ‘최근에 사용한 항목’ 섹션에서 ‘SugarCRM 커넥터’를 선택하면 새 SugarCRM 작업이 추가됩니다.

14.	작업의 목록에서 '계정 업데이트'(고급 작업 '...' 아래에 있음)를 선택하면 '계정 업데이트' 작업의 입력 매개 변수가 표시됩니다.
...
18. 새로 만든 논리 앱을 찾아 ‘지금 실행’을 클릭하여 실행을 시작합니다.
