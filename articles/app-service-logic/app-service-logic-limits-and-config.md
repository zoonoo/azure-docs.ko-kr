...
|Name|제한|참고 사항|
|----|----|----|
|요청 시간 초과|90초|필요에 따라 [비동기 패턴](app-service-logic-create-api-app.md) 또는 [until 루프](app-service-logic-loops-and-scopes.md)를 보완할 수 있음|

#### <a name="message-size"></a>메시지 크기

|Name|제한|참고 사항|
|----|----|----|
|메시지 크기|50MB|일부 커넥터 및 API에서는 50MB를 지원하지 않을 수 있음 |
...
|재시도 최소 지연 시간|20초|[재시도 정책 매개 변수](https://msdn.microsoft.com/en-us/library/azure/mt643939.aspx)로 구성할 수 있음|
...
|이름|제한|참고 사항|
|----|----|----|
|스키마|8MB|[blob URI](app-service-logic-enterprise-integration-schemas.md)를 사용하여 2MB보다 큰 파일을 업로드할 수 있음 |
|맵(XSLT 파일)|2MB| |
...
논리 앱에서의 직접 호출(즉, [HTTP](../connectors/connectors-native-http.md) 또는 [HTTP + Swagger](../connectors/connectors-native-http-swagger.md)를 통해)은 [Azure 데이터 센터 IP 범위](https://www.microsoft.com/en-us/download/details.aspx?id=41653) 중에서 발생할 수 있습니다.
