---
title: 논리 앱에서 BizTalk 플랫 파일 인코더 사용 | Microsoft Docs
...
3. "스키마" 구성 요소 ![BizTalk 플랫 파일 인코더 스키마 파트][2]를 선택합니다.
4. 그런 다음 열린 스키마 블레이드에서 "새로 추가" 선택 ![BizTalk 플랫 파일 인코더 작업 목록][7]
5. 세 옵션 중 하나를 선택하여 스키마 제공 옵션은 새 스키마 업로드, JSON에서 생성 및 플랫 파일에서 생성 ![BizTalk 플랫 파일 인코더 작업 목록][8]
6. 이전 단계에서 선택한 항목에 기반하여 스키마를 제공하는 단계 수행 그런 다음 스키마가 업로드된 것을 확인합니다.![BizTalk 플랫 파일 인코더 작업 목록][9]
