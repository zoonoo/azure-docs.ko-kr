---
title: "Azure 논리 앱의 보안 설정 | Microsoft Docs"
description: "Azure 논리 앱의 입력, 액세스 및 제어 보안"
services: logic-apps
...
배포를 자동화하기 위해 [배포 템플릿](app-service-logic-create-deploy-template.md)을 사용하는 경우 리소스 템플릿에서 IP 범위 설정을 구성할 수 있습니다.  
...
논리 앱의 모든 호출은 영역당 특정 IP 주소 집합에서 나옵니다.  지정된 IP 주소의 요청만 수락하도록 필터링을 추가할 수 있습니다.  이러한 IP 주소 목록은 [이 문서에서](app-service-logic-limits-and-config.md#configuration) 찾아볼 수 있습니다.
...
논리 앱의 많은 관리형 커넥터는 파일 시스템, SQL, SharePoint, DB2 등 온-프레미스 시스템에 보안 연결을 제공합니다.  게이트웨이는 Azure Service Bus를 통해 암호화된 채널을 활용하여 온-프레미스 데이터를 전달하고, 모든 트래픽은 게이트웨이 에이전트의 보안 아웃바운드 트래픽에서 발생합니다.  게이트웨이의 작동 방식에 대한 자세한 내용은 [이 문서에](app-service-logic-gateway-install.md#how-the-gateway-works) 나와 있습니다.
...
[배포 템플릿 만들기](app-service-logic-create-deploy-template.md)  
[예외 처리](app-service-logic-exception-handling.md)  
[논리 앱 모니터링](app-service-logic-monitor-your-logic-apps.md)  
[논리 앱 오류 진단 및 문제](app-service-logic-diagnosing-failures.md)  
