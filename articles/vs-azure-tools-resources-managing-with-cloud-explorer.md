...
- **리소스 종류** 보기는 Azure 포털에서 사용되는 일반적인 보기로, 웹앱, 저장소 계정 및 가상 컴퓨터와 같은 형식별으로 분류된 Azure 리소스를 보여 줍니다. Azure 리소스가 서버 탐색기에 나타나는 방법과 유사합니다.
...
모든 리소스에는 **포털에서 열기** 작업이 있습니다. 이 작업을 선택하면 클라우드 탐색기는 Azure 포털에서 선택한 리소스를 표시합니다. 이 기능은 여러 층으로 중첩된 리소스를 탐색하기에 더욱 간편합니다.
