<properties 
    pageTitle="클라우드 서비스(클래식)에 대해 SSL 구성 | Microsoft Azure" 
...
> [AZURE.NOTE] 이 작업의 절차는 Azure 클라우드 서비스에 적용됩니다. 앱 서비스에 대해서는 [이](../app-service-web/web-sites-configure-ssl-certificate.md) 문서를 참조하세요.
