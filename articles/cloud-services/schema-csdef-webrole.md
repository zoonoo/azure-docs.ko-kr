...
| 특성 | 형식 | 설명 |  
| --------- | ---- | ----------- |  
|name|string|필수입니다. 웹 역할에 대한 이름입니다. 역할의 이름은 고유해야 합니다.|  
...
|protocol|string|필수입니다. 외부 끝점에 대한 전송 프로토콜입니다. 웹 역할의 경우 가능한 값은 `HTTP`, `HTTPS`, `UDP` 또는 `TCP`입니다.|  
...
| 특성 | 형식 | 설명 |  
| --------- | ---- | ----------- |  
|name|string|필수입니다. 웹 사이트 또는 응용 프로그램의 이름입니다.|  
...
| 특성 | 형식 | 설명 |  
| --------- | ---- | ----------- |  
|name|string|필수입니다. 가상 응용 프로그램을 식별하는 이름을 지정합니다.|  
|physicalDirectory|string|필수입니다. 가상 응용 프로그램을 포함하는 개발 컴퓨터의 경로를 지정합니다. 계산 에뮬레이터에서 IIS는 이 위치에서 콘텐츠를 검색하도록 구성됩니다. Azure로 배포하는 경우 실제 디렉터리의 콘텐츠는 서비스의 나머지 부분과 함께 패키지됩니다. 서비스 패키지를 Azure에 배포하는 경우 IIS는 패키지되지 않은 콘텐츠의 위치로 구성됩니다.|  
...
| 특성 | 형식 | 설명 |  
| --------- | ---- | ----------- |  
|name|string|필수입니다. 가상 디렉터리를 식별하는 이름을 지정합니다.|  
|값|physicalDirectory|필수입니다. 웹 사이트 또는 가상 디렉터리 콘텐츠를 포함하는 개발 컴퓨터의 경로를 지정합니다. 계산 에뮬레이터에서 IIS는 이 위치에서 콘텐츠를 검색하도록 구성됩니다. Azure로 배포하는 경우 실제 디렉터리의 콘텐츠는 서비스의 나머지 부분과 함께 패키지됩니다. 서비스 패키지를 Azure에 배포하는 경우 IIS는 패키지되지 않은 콘텐츠의 위치로 구성됩니다.|  
...
| 특성 | 형식 | 설명 |  
| --------- | ---- | ----------- |  
|name|string|필수입니다. 바인딩을 식별하는 이름을 지정합니다.|  
|endpointName|string|필수입니다. 바인딩할 끝점 이름을 지정합니다.|  
