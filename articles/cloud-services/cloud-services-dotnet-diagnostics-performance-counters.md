...
| --- | --- | --- |
| .NET CLR 예외(*전역*) |# Exceps Thrown / sec |예외 성능 카운터 |
| .NET CLR 메모리(*전역*) |% Time in GC |메모리 성능 카운터 |
...
| ASP.NET 응용 프로그램(**총 수**) |총 요청 수 |ASP.NET용 성능 카운터 |
| ASP.NET 응용 프로그램(**총 수**) |Requests/Sec |ASP.NET용 성능 카운터 |
