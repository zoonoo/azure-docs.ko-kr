...
* Dv3 시리즈, Dv2 시리즈, D 시리즈, G 시리즈는 더 빠른 CPU와 더 좋은 로컬 디스크 성능을 요구하거나 더 높은 메모리 요구량을 가진 애플리케이션에 이상적입니다. 이러한 시리즈는 대부분 엔터프라이즈급 애플리케이션을 위한 강력한 조합을 제공합니다.
...
| 크기            | CPU 코어 수 | 메모리: GiB  | 임시 스토리지: GiB       | 최대 NIC 수/네트워크 대역폭 |
|---------------- | --------- | ------------ | -------------------- | ---------------------------- |
...
| 크기            | CPU 코어 수 | 메모리: GiB  | 임시 스토리지(SSD): GiB       | 최대 NIC 수/네트워크 대역폭 |
|---------------- | --------- | ------------ | -------------------- | ---------------------------- |
