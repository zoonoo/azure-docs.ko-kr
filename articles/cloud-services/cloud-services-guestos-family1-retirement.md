...
추가 질문이 있으면 [클라우드 서비스 포럼](http://social.msdn.microsoft.com/Forums/home?forum=windowsazuredevelopment&filter=alltypes&sort=lastpostdesc)을 방문하거나 [Azure 지원에 문의](http://azure.microsoft.com/support/options/)하세요.
...
3. Azure 관리 포털은 게스트 운영 체제 제품군 값을 "Windows Server 2008"로 표시합니다. [이 ](https://msdn.microsoft.com/library/azure/gg456325.aspx)을 참조하여 값을 찾습니다.

어떤 클라우드 서비스가 어떤 OS 제품군을 실행 중인지 알기 위해, Azure PowerShell에서 아래 스크립트를 실행할 수 있지만 먼저 [Azure PowerShell을 설정](../install-configure-powershell.md) 해야 합니다. 스크립트에 대한 추가 세부 정보는 [Azure 게스트 OS 제품군 1 만료: 2014년 6월](http://blogs.msdn.com/b/ryberry/archive/2014/04/02/azure-guest-os-family-1-end-of-life-june-2014.aspx)을 참조하세요. 
