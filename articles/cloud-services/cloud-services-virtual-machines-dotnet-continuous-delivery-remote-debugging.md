...
1. Azure 가상 컴퓨터를 만듭니다. [Windows Server를 실행하는 가상 컴퓨터 만들기](/virtual-machines/virtual-machines-windows-tutorial.md) 또는 [Visual Studio에서 Azure 가상 컴퓨터 만들기 및 관리](/vs-azure-tools-virtual-machines-create-manage.md)를 참조하세요.
