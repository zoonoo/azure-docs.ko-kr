...
## <a name="problem-i-cannot-access-my-website-but-my-deployment-is-started-and-all-role-instances-are-ready"></a>문제: 내 웹 사이트에 액세스할 수 없지만 내 배포가 시작 되 고 모든 역할 인스턴스가 준비 되었습니다.
...
## <a name="problem-my-role-instances-recycled-without-me-doing-anything"></a>문제: 아무것도 수행 하지 않고 내 역할 인스턴스가 재생 되었습니다.
...
## <a name="problem-i-cannot-do-a-vip-swap-and-receive-an-error"></a>문제: VIP 교체를 수행할 수 없으며 오류를 수신할 수 없습니다.
...
## <a name="problem-a-role-instance-is-looping-between-started-initializing-busy-and-stopped"></a>문제: 역할 인스턴스가 시작 됨, 초기화 중, 사용 중 및 중지 됨 사이에서 반복 됩니다.
...
## <a name="problem-my-application-stopped-working"></a>문제: 내 응용 프로그램의 작동이 중지 됨
