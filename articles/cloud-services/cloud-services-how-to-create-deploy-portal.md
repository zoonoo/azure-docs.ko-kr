...
2. **새로 만들기**를 클릭하고 **계산**을 클릭한 다음 아래로 스크롤하여 **클라우드 서비스**를 클릭합니다.
...
9. **인증서**를 선택하고 **인증서 추가** 블레이드에서 SSL 인증서.pfx 파일을 선택하고 인증서에 대한 **암호**를 제공합니다. 
10. **인증서 첨부**를 클릭하고 **인증서 추가** 블레이드에서 **확인**을 클릭합니다.
