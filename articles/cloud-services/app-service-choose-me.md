<properties 
	pageTitle="Azure의 앱 서비스가 내가 원하는 계산 옵션인가요?" 
...
Azure는 응용 프로그램을 실행하기 위한 여러 호스팅 모델을 제공합니다. 각각은 다양한 서비스 세트를 제공하므로 정확히 무엇을 수행하고자 하는지에 따라 선택 항목이 달라집니다. 앱 서비스가 적절한 선택입니까?
