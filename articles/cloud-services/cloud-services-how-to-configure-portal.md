...
1. [Azure 포털](http://portal.azure.com/)에서 클라우드 서비스로 이동합니다.
...
>[AZURE.NOTE]클라우드 서비스에 사용되는 운영 체제는 **Azure 포털**을 사용하여 변경할 수 없으며, [Azure 클래식 포털](http://manage.windowsazure.com/)을 통해서만 이 설정을 변경할 수 있습니다. 이 내용은 [여기](cloud-services-how-to-configure.md#update-a-cloud-service-configuration-file)에 자세히 설명되어 있습니다.
...
원격 액세스는 **Azure 포털**을 사용하여 구성할 수 없으며, [Azure 클래식 포털](http://manage.windowsazure.com/)을 통해서만 이 설정을 변경할 수 있습니다. 이에 대해서는 [여기](cloud-services-role-enable-remote-desktop.md)에서 설명합니다.
