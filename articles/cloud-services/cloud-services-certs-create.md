...
>[!Note]
>[Cloud Services FAQ](cloud-services-faq.md#certificates) 문서에는 인증서에 대한 몇 가지 유용한 정보가 들어 있습니다.
...
* 주체 이름은 클라우드 서비스 액세스에 사용되는 도메인과 일치해야 합니다. 
    > cloudapp.net(또는 Azure 관련) 도메인용 SSL 인증서를 얻을 수 없으므로, 인증서의 주체 이름은 사용 중인 응용 프로그램 액세스에 사용되는 사용자 지정 도메인 이름과 일치해야 합니다. 예를 들어, **contoso.cloudapp.net**이 아니라**contoso.net**입니다.
