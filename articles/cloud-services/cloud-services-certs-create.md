...
[서비스 인증서를 Azure 포털에 업로드](cloud-services-configure-ssl-certificate.md)(또는[Preview 포털](cloud-services-configure-ssl-certificate-portal.md)에 업로드)하고 클라우드 서비스에 사용하도록 구성합니다.
