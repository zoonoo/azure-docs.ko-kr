...
> [AZURE.NOTE] Azure Tools for Microsoft Visual Studio를 사용하는 경우 역할의 **속성** 페이지 내에서 로컬 저장소 리소스를 정의할 수 있습니다.
...
- [Azure용 클라우드 서비스 설정](cloud-services-model-and-package.md)
