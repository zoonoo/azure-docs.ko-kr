...
## <a name="how-to-create-a-cloud-service-using-quick-create"></a>방법: 빠른 생성을 사용하여 클라우드 서비스 만들기
...
## <a name="how-to-upload-a-certificate-for-a-cloud-service"></a>방법: 클라우드 서비스에 대한 인증서 업로드
...
## <a name="how-to-deploy-a-cloud-service"></a>방법: 클라우드 서비스 배포
...
7. **확인** (확인 표시)을 클릭하여 클라우드 서비스 배포를 시작합니다.
