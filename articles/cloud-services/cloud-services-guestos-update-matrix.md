...
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 4\.25 | WA-GUEST-OS-4.25\_201510-01 | 2015년 11월 13일 출시 예정 | 4\.27이 릴리스되면 업데이트됩니다. | TBD |
...
| 게스트 OS 버전 | 구성 문자열 | 릴리스 날짜 | 비활성화 날짜 | 만료 날짜 |
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 3\.32 | WA-GUEST-OS-3.32\_201510-01 | 2015년 11월 13일 출시 예정 | 3\.34가 릴리스되면 업데이트됩니다. | TBD |
...
| 게스트 OS 버전 | 구성 문자열 | 릴리스 날짜 | 비활성화 날짜 | 만료 날짜 |
| ---------------- | -------------------------- | ---------------------- | ------------ | --- |
| 2\.44 | WA-GUEST-OS-2.44\_201510-01 | 2015년 11월 13일 출시 예정 | 2\.46이 릴리스되면 업데이트됩니다. | TBD |
