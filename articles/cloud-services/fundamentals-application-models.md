...
1. 소유한 VHD 업로드 
2. Azure 가상 컴퓨터 갤러리 또는 Microsoft 오픈 소스 [VMDepot](http://vmdepot.msopentech.com/)(영문) 웹 사이트에서 Microsoft 및 해당 파트너가 제공하는 VHD 사용 
...
<h2><a id="WhatShouldIUse"></a>사용해야 하는 모델 선택</h2>
