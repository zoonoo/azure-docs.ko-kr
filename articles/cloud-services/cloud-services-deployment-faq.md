...
이러한 할당 오류를 완화 하는 데 도움이 [필요 하면 클라우드 서비스 할당 실패: 솔루션](cloud-services-allocation-failures.md#solutions).
...
해당 지역에서 사용할 수 있는 크기를 확인 하려면 [Microsoft Azure를 참조 하세요. 지역별](https://azure.microsoft.com/regions/services)사용 가능한 제품.
...
포털에서 구독에 대 한 현재 사용량/할당량을 추적할 수도 있습니다. Azure Portal = > subscription = > \<적절 한 구독 > = > "사용량 + 할당량"입니다.
