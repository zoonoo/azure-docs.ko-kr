...
> [!NOTE]
> 이 문서에서는 클라우드 서비스 웹 및 작업자 역할에 중점을 둡니다. 가상 컴퓨터(클래식)를 직접 만든 경우 이 가상 컴퓨터는 클라우드 서비스에서 호스트됩니다. 표준 가상 컴퓨터를 [가용성 집합](../virtual-machines/virtual-machines-windows-classic-configure-availability.md)에 연결하여 규모를 조정하고 수동으로 켜거나 끌 수 있습니다.
> 
> 
