...
Node.js에는 핵심 런타임에 최소한의 기능이 들어 있습니다. 개발자는 Node.js 응용 프로그램을 개발할 때 추가 기능을 제공하기 위해 종종 타사 모듈을 사용합니다. 이 자습서에서는 Node.js 웹 응용 프로그램을 만들기 위한 MVC 프레임워크를 제공하는 [Express][] 모듈을 사용하여 새 응용 프로그램을 만들어봅니다.
