...
![네트워크 리소스 모델](./media/resource-group-networking/Figure1.png)

다중 계층 응용 프로그램을 포함하는 샘플 배포의 개념 보기는 아래와 같습니다. 모든 네트워크 리소스는 파란색 윤곽선으로 색이 지정됩니다.

![네트워크 리소스 모델](./media/resource-group-networking/Figure2.png)
...
![단일 VM의 NIC](./media/resource-group-networking/Figure3.png)
...
![단일 VM의 NIC](./media/resource-group-networking/Figure4.png)
...
![단일 VM의 NIC](./media/resource-group-networking/Figure5.png)
...
![샘플 템플릿 배포](./media/resource-group-networking/Figure6.png)
