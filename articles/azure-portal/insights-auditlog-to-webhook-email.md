---
title: Azure 활동 로그 경고에 대한 웹후크 구성 | Microsoft Docs
...
[Azure PowerShell Cmdlet](../monitoring-and-diagnostics/insights-powershell-samples.md#create-alert-rules), [플랫폼 간 CLI](../monitoring-and-diagnostics/insights-cli-samples.md#work-with-alerts) 또는 [Insights REST API](https://msdn.microsoft.com/library/azure/dn933805.aspx)를 사용하여 활동 로그 경고를 설정할 수 있습니다.
