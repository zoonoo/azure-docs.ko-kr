...
description: Azure 포털 테마를 변경하여 표시된 배경 및 글꼴 색상을 선택합니다. 높은 대비를 설정하면 Azure 포털을 더 빠르고 쉽게 읽을 수 있습니다.
...
대비가 높은 설정을 사용하면 Azure 포털을 더 쉽게 읽을 수 있습니다. 포털의 배경 색을 변경하는 테마를 선택할 수도 있습니다.

Azure Portal에서 더 많은 대비가 필요하거나 색 구성표를 변경하려면 포털 설정으로 이동하여 변경합니다.

## <a name="turn-on-high-contrast"></a>고대비 켜기

1. [Azure 포털의](https://portal.azure.com)헤더에서 **설정을**선택합니다.
...
> [!NOTE]
> 고대비 테마를 선택하면 다른 모든 테마 선택항목이 재정의됩니다.
>
>
