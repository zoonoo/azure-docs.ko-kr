...
15. Application Insights나 Log Analytics를 사용하지 않을 경우 기존 모니터링, 로깅, 경고 제품과 Azure Monitor를 함께 사용할 수 있습니다. 통합 방법에 대한 지침 및 전체 목록은 [파트너 페이지](../monitoring-and-diagnostics/monitoring-partners.md)를 참조하세요.
...
## 다음 단계
* [Azure Monitor 개요](../monitoring-and-diagnostics/monitoring-overview.md) 확인
