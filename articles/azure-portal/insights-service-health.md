---
title: Azure insights를 사용하여 서비스 상태 추적 | Microsoft Docs
...
## 전체 서비스 상태 로그 찾아보기
1. **찾아보기**를 클릭하고 **감사 로그**를 선택합니다. ![찾아보기 허브](./media/insights-service-health/Insights_Browse.png)
2. 지난 7일간 구독에 영향을 준 이벤트를 모두 보여 주는 블레이드가 열립니다. 이 목록에 서비스 상태 항목이 나타나지만 이 목록은 길기 때문에 검색이 어려울 수도 있습니다.
3. **필터** 명령을 클릭합니다.
4. **이벤트 범주**를 선택하고 **서비스 상태**: ![모든 이벤트](./media/insights-service-health/Insights_Filter.png)를 선택합니다.
5. **업데이트됨**을 클릭합니다.
6. 이제 자신의 구독에 영향을 준 모든 서비스 상태 이벤트를 볼 수 있습니다.![리소스 그룹](./media/insights-service-health/Insights_HealthEvent.png)
7. 여기서 세부 정보 블레이드로 이동하여 이벤트의 세부 정보를 확인할 수 있습니다.
