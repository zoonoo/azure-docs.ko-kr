...
---
# Azure Monitor에서의 역할, 권한 및 보안 시작
...
* [Azure Monitor REST API](https://msdn.microsoft.com/library/azure/dn931930.aspx), [PowerShell cmdlets](../monitoring-and-diagnostics/insights-powershell-samples.md) 또는 [cross-platform CLI](../monitoring-and-diagnostics/insights-cli-samples.md)를 사용하여 메트릭을 쿼리합니다.
...
* 구독에 대한 [로그 프로필](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles)을 봅니다.
* 자동 크기 조정 설정을 봅니다.
* 경고 활동 및 설정을 봅니다.
...
> [!NOTE]
> 이 역할은 이벤트 허브에 스트리밍되었거나 저장소 계정에 저장된 로그 데이터에 대한 읽기 액세스를 부여하지 않습니다. 이러한 리소스에 대한 액세스 구성에 대한 내용은 [아래를 참조하세요](#security-considerations-for-monitoring-data).
> 
> 
...
* 구독에 대한 [로그 프로필](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md#export-the-activity-log-with-log-profiles)을 설정합니다.*
* 경고 활동 및 설정을 구성합니다.
...
> [!NOTE]
> 이 역할은 이벤트 허브에 스트리밍되었거나 저장소 계정에 저장된 로그 데이터에 대한 읽기 액세스를 부여하지 않습니다. 이러한 리소스에 대한 액세스 구성과 관련한 내용은 [아래를 참조하세요](#security-considerations-for-monitoring-data).
> 
> 

## 권한 및 사용자 지정 RBAC 역할 모니터링
...
* [Azure의 모니터링 개요 읽기](../monitoring-and-diagnostics/monitoring-overview.md)
