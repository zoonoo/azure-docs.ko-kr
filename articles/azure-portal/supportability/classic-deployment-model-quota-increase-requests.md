...
이러한 두 배포 모델에 대 한 자세한 내용 및 리소스 관리자 사용의 이점에 대 한 자세한 내용은 [리소스 관리자 및 클래식 배포](../../azure-resource-manager/management/deployment-models.md) 페이지를 참조 하세요.
