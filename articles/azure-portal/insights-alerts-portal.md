...
---
# Azure 포털을 사용하여 Azure 서비스에 대한 경고 만들기
...
3. **Add alert** 명령을 선택하고 필드에 입력합니다.
    ...
    ![경고 추가](./media/insights-alerts-portal/AddAlertOnlyParamsPage.png)
...
7. 경고가 발생했을 때 다른 이메일 주소에서 알림을 받으려면 해당 이메일을 **추가 관리자 이메일** 필드에 추가합니다. 여러 이메일은 세미콜론(*email@contoso.com;email2@contoso.com*)으로 구분합니다.
