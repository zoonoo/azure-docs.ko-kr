...
---
# Resource Manager 템플릿을 사용하여 메트릭 경고 만들기
...
## 메트릭 경고를 위한 Resource Manager 템플릿
...
## 경고가 있는 리소스에 대한 Resource Manager 템플릿
...
* Resource Manager 템플릿을 사용하여 [진단 설정 추가](../monitoring-and-diagnostics/monitoring-enable-diagnostic-logs-using-template.md)
