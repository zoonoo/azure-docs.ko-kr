...
다음 명령은 감사 로그의 마지막 1000개 이벤트를 검색합니다.
...
각각 `New-AzureRmAlertRuleEmail` 및 `New-AzureRmAlertRuleWebhook`을 사용하여 전자 메일 및 webhook을 만들 수 있습니다. 경고 규칙 cmdlet에서, 이러한 것들을 경고 규칙의 **동작** 속성에 동작으로 할당합니다.
...
## 자동 크기 조정 기록
다음은 최근에 있었던 자동 크기 조정 및 경고 이벤트를 보는 방법을 알려주는 예입니다. 감사 로그 검색을 사용하여 자동 크기 조정 기록을 봅니다.
