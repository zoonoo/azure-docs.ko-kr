...
- **Azure Monitor** - Azure Monitor에서는 메트릭 값과 활동 로그 이벤트 모두를 기반으로 한 경고가 가능합니다. Azure Monitor에는 [Azure Insights REST API](https://msdn.microsoft.com/library/dn931943.aspx)가 포함됩니다. [Azure 포털, PowerShell 또는 명령줄 인터페이스를 사용하여 경고 만들기](insights-alerts-portal.md)도 참조하세요.
