...
Azure 빠른 시작 센터에는 시작하기 위한 세 가지 옵션이 있습니다.
...
* **온라인 학습**: Azure 빠른 시작 센터의 이 섹션에서는 Microsoft Learn에서 제공하는 무료 소개 과정 모듈을 강조 표시합니다. 타일을 선택하여 과정을 시작하고 Azure에서 클라우드 개념 및 리소스 관리에 대해 자세히 알아봅니다.

## <a name="how-to-use-azure-quickstart-center"></a>Azure 빠른 시작 센터를 사용하는 방법

1. [Azure Portal](https://portal.azure.com)에 로그인합니다.

1. Azure Portal 메뉴에서 **모든 서비스** 를 선택합니다.

1. **일반** > **빠른 시작 센터** 를 선택합니다.
