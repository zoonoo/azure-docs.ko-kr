...
- Windows Server 2012 또는 Windows Server 2012 R2가 실행되는 가상 컴퓨터를 만들 때 관리 포털을 사용하여 Chef 클라이언트를 설치합니다. 지침은 [Microsoft Azure 포털](https://docs.chef.io/azure_portal.html)을 참조하세요.
