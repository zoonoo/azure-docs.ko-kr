...
4.  이제 보조 서비스를 사용하여 기본 서비스를 복구할 수 있습니다.
    ...
    **중요**
    ...
    준비가 되면 다음 명령을 실행합니다.
         ...
         경고: this action will use the capacity from the mobile service 'SecondaryService' and delete it. Do you want to recover the mobile service 'PrimaryService'
         (y/n): y
         + Performing recovery
         + Cleaning up
    ...
    **참고**
    ...
    명령이 완료된 후 포털에서 변경 내용이 표시될 때까지 몇 분 정도 걸릴 수 있습니다.
