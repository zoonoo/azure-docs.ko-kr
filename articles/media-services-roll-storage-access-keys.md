...
- 미디어 서비스 관리 REST API를 사용합니다. 
	...
	다음 코드 예시는 미디어 서비스와 지정된 저장소 키를 동기화하기 위해 https://endpoint/<subscriptionId>/services/mediaservices/Accounts/<accountName>/StorageAccounts/<storageAccountName>/Key 요청을 생성하는 방법을 보여 줍니다. 이 경우에는 보조 저장소 키 값이 사용됩니다. 자세한 내용은 [방법: 미디어 서비스 관리 REST API](http://msdn.microsoft.com/library/azure/dn167656.aspx)를 사용합니다.
