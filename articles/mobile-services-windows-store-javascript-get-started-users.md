...
<ol start="5">
<li><p>(선택 사항) <a href="/ko-kr/documentation/articles/mobile-services-how-to-register-store-app-package-microsoft-authentication/">Microsoft 인증을 위해 Windows 스토어 앱 패키지 등록</a>을 참조하세요.</p>
...
<ol start="3">
<li><p>Visual Studio 2012 Express for Windows 8에서 <a href="/ko-kr/develop/mobile/tutorials/get-started/">모바일 서비스 시작(영문)</a>.</p></li> 
