---
title: Azure 클라우드 서비스 및 가상 컴퓨터에 대한 진단 구성 | Microsoft Docs
...
8. 수집할 진단 데이터의 각 탭에서 **<로그 유형> 전송 사용** 확인란을 선택합니다. 예를 들어 응용 프로그램 로그를 수집하려는 경우 **응용 프로그램 로그** 탭에서 **응용 프로그램 로그 전송 사용** 확인란을 선택합니다. 또한 각 진단 데이터 형식에 필요한 기타 정보를 지정합니다. 각 탭에 대한 구성 정보는 이 항목의 뒷부분에 있는 **진단 데이터 원본 구성** 섹션을 참조하세요.
