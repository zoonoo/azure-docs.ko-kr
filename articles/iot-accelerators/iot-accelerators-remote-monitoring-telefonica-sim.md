...
[Telefónica IoT Connectivity Platform Portal](https://m2m-movistar-es.telefonica.com/) > SIM Inventory로 이동하여 자신의 SIM을 선택하고 각 SIM의 "alias"를 원하는 쌍 장치 ID로 업데이트합니다. 이 작업은 대량 모드로 수행할 수도 있습니다(Telefónica IoT Connectivity Platform 사용자 설명서 참조).
