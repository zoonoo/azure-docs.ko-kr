...
- [Azure Portal을 사용하여 대규모 IoT 디바이스 구성 및 모니터링](../iot-hub/iot-hub-auto-device-config.md)
...
1. **구성 파일 다운로드**를 클릭합니다.
    ...
    [![Download 구성 파일](./media/iot-accelerators-remote-monitoring-import-adm-package/download-inline.png)](./media/iot-accelerators-remote-monitoring-import-adm-package/download-expanded.png#lightbox)
