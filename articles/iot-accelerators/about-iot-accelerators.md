...
IoT 솔루션 가속기는 원격 모니터링, 연결된 팩터리, 예측 유지 관리, 장치 시뮬레이션 같은 일반적인 IoT 시나리오를 구현하는 완전하고 배포할 준비가 된 IoT 솔루션의 컬렉션입니다. 솔루션 가속기를 배포할 때 배포에는 필수 응용 프로그램 코드와 함께 모든 필수 클라우드 기반 서비스가 포함됩니다.
...
* [장치 시뮬레이션 솔루션 사용](quickstart-device-simulation-deploy.md)
