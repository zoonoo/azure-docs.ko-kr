...
연결된 팩터리를 사용하면 클라우드에서 직접 산업용 장치에 명령을 내리고 제어할 수 있습니다. 이 기능을 사용하여 디바이스에서 생성한 알람에 대응할 수 있습니다. 예를 들어 압력 방출 밸브를 여는 명령을 디바이스에 보낼 수 있습니다. OPC UA 서버 브라우저 트리의 **StationCommands** 노드에서 사용 가능한 명령을 찾을 수 있습니다. 이 시나리오에서는 뮌헨에 위치한 생산 라인의 어셈블리 스테이션 압력 방출 밸브를 엽니다. 명령 및 제어 기능을 사용하려면 솔루션 가속기 배포에 대한 **관리자** 역할에 속해야 합니다.
