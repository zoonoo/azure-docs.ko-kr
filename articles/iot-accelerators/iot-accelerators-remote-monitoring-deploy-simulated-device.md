...
이 가이드에서는 원격 모니터링 솔루션 가속기에 사용자 지정 디바이스 모델을 배포하는 방법을 살펴보았습니다. 제안된 다음 단계는 [물리적 장치를 원격 모니터링 솔루션에 연결](iot-accelerators-connecting-devices-node.md)하는 방법을 알아보기 위한 것입니다.
