---
title: 사용자 지정 시뮬레이션된 디바이스 만들기 - Azure | Microsoft Docs
description: 이 자습서에서는 디바이스 시뮬레이션을 사용하여 시뮬레이션에서 사용하기 위한 사용자 지정 시뮬레이션된 디바이스를 만듭니다.
author: troyhopwood
manager: timlt
