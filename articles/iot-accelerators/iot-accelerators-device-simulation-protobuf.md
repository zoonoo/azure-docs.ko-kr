...
* .NET Core [Mac, Linux 및 Windows용 .NET Core를 다운로드](https://dotnet.microsoft.com/download)할 수 있습니다.
...
GitHub에서 [디바이스 시뮬레이션 마이크로 서비스](https://github.com/Azure/azure-iot-pcs-device-simulation/archive/master.zip)를 로컬 머신의 적합한 위치에 다운로드하고 압축을 풉니다.
...
이제 Protobuf를 사용하여 원격 분석을 보내는 디바이스 시뮬레이션을 사용자 지정하는 방법을 알아보았으므로, 다음 단계에서는 GitHub를 방문하여 [디바이스 시뮬레이션](https://github.com/Azure/azure-iot-pcs-device-simulation)을 자세히 알아봅니다.
