...
### <a name="step-1-register-your-opc-ua-application"></a>1 단계: OPC UA 응용 프로그램 등록 
...
### <a name="step-2-secure-your-application-with-a-ca-signed-application-certificate"></a>2 단계: CA 서명 된 응용 프로그램 인증서를 사용 하 여 응용 프로그램 보호
