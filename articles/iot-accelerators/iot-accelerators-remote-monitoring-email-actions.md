...
1. 솔루션 가속기에서 이메일 작업을 처음 사용하도록 설정할 경우 [Outlook에 로그인](#outlook)해야 합니다.
...
> [!NOTE]
> 솔루션 가속기 알림용으로만 특정 Outlook 계정을 생성하고 첫 번째 이메일 작업을 사용하도록 설정할 때 해당 계정을 사용해야 합니다.
...
1. 클릭하여 Outlook에 로그인합니다. Azure Portal로 이동됩니다.
