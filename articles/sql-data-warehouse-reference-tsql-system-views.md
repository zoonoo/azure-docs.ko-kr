<properties
   pageTitle="SQL 데이터 웨어하우스 시스템 보기 | Microsoft Azure"
...
- [dbo.server_quotas(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth_usage(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats(Azure SQL 데이터베이스)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage(Azure SQL 데이터베이스)
...
## SQL 데이터 웨어하우스에서 사용할 수 있는 SQL Server DMV 목록
...
>[AZURE.NOTE]이러한 보기를 사용하기 위해 다음 테이블과 같이 이름에 'pdw_nodes_'를 삽입합니다.
...
| sys.dm_pdw_nodes_tran_commit_table | Transact-SQL 문서는 사용할 수 없습니다. |
...
다음은 SQL Server PDW에서 사용할 수 있는 SQL Server 정보 스키마 보기에 연결하는 링크입니다. SQL Server에서 볼 수 있는 모든 INFORMATION_SCHEMA 보기는 SQL Server PDW에서 사용할 수 있습니다.
