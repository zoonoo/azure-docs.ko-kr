<properties pageTitle="Windows 스토어 클라이언트에서 사용자 지정 API 호출 - 모바일 서비스" description="사용자 지정 API를 정의한 다음 Microsoft Azure 모바일 서비스를 사용하는 Microsoft Azure 앱에서 이를 호출하는 방법에 대해 알아봅니다." services="mobile-services" documentationCenter="windows" authors="ggailey777" writer="glenga" manager="dwrede" editor=""/>
...
이 자습서는 모바일 서비스 퀵 스타트를 기반으로 합니다. 이 자습서를 시작하기 전에 먼저 [모바일 서비스 시작](영문) 또는 [데이터 시작]을 완료해야 합니다. 이 자습서에서는 Visual Studio 2012 Express for Windows 8을 사용합니다.
