...
![인스턴스를 선택한 다음 '...'를 선택합니다.](./media/appinsights/appinsights-23-customevents-4.png)


검색 필드를 사용하여 특정 속성 값이 포함된 이벤트 항목을 볼 수 있습니다.


![검색에 용어를 입력합니다.](./media/appinsights/appinsights-23-customevents-5.png)
...
![개요 블레이드의 사용 현황 렌즈](./media/appinsights/appinsights-47usage-2.png)
