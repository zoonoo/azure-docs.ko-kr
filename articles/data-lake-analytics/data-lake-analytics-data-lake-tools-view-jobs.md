...
* 작업 요약
  ...
  * 기본 정보
    ...
    * 총 컴퓨팅 시간: 전체 꼭짓점 실행 시간으로, 작업이 한 가지 꼭짓점에서만 실행되는 시간과 같습니다. 꼭짓점에 대한 자세한 내용은 전체 꼭짓점 수를 참조하세요.
...
* 작업 그래프
  ...
  * 총 컴퓨팅 시간: 단계의 모든 꼭짓점 실행 시간의 합계, 단계의 모든 작업을 한 개 꼭짓점에서만 실행할 경우 소요되는 시간으로 간주할 수 있습니다.
  ...
  * 작업 열 지도 표시 
    ...
    * 진행률: 작업 실행 진행률. 자세한 내용은 단계 정보를 참조하세요.
