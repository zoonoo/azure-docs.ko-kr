...
---
# <a name="debug-c-code-in-u-sql-for-data-lake-analytics-jobs"></a>Data Lake Analytics 작업에 대한 U-SQL에서 C# 코드 디버깅
...
## <a name="create-and-configure-debug-projects"></a>디버그 프로젝트를 만들고 구성합니다.
...
2. Visual Studio 기반 디버깅 환경(조사식, 변수, 등)을 사용하여 문제를 해결합니다. 
3. 문제를 식별 한 후 코드를 수정하고 모든 문제가 해결될 때까지 C# 프로젝트를 다시 빌드한 후 다시 테스트합니다. 디버그가 완료되면 다음과 같은 메시지가 표시되는 출력 창이 나타납니다. 
   
     'LocalVertexHost.exe' 프로그램이 코드 0(0x0)과 함께 종료되었습니다.
