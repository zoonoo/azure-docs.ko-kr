...
2. Data Lake Analytics 계정을 열고 __모니터링__ 섹션에서 **진단 로그** 를 선택합니다. 다음으로, __진단 상태 켜기__ 를 선택합니다.
    ...
    ![‘진단 로그’ 작업이 선택되고 ‘진단을 켜서 다음 로그 수집’이 강조 표시된 스크린샷입니다.](./media/data-lake-analytics-diagnostic-logs/turn-on-logging.png)
...
3. __진단 설정__ 에서 이 로깅 구성에 __이름__ 을 입력하고 로깅 옵션을 선택합니다.
   ...
   * 세 가지 방법으로 데이터를 저장/처리하도록 선택할 수 있습니다.
     ...
     * __Log Analytics로 보내기__ 를 선택하여 데이터를 Azure Monitor 서비스로 보냅니다. Azure Monitor 로그를 사용하여 로그를 수집하고 분석하려는 경우 이 옵션을 사용합니다.
