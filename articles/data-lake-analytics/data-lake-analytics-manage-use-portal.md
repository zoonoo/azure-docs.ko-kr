---
title: Azure 포털을 사용하여 Azure 데이터 레이크 분석 관리 | Microsoft Docs
...
분석 계정을 삭제해도 종속 데이터 레이크 저장소 계정은 삭제되지 않습니다. 데이터 레이크 저장소 계정 삭제에 대한 자세한 내용은 [데이터 레이크 저장소 계정 삭제](../data-lake-store/data-lake-store-get-started-portal.md#delete-azure-data-lake-store-account)를 참조하세요.
