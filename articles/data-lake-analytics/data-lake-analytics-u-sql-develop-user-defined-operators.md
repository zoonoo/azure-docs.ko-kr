...
---
# <a name="develop-u-sql-user-defined-operators-for-azure-data-lake-analytics-jobs"></a>Azure 데이터 레이크 분석 작업에 대한 U-SQL 사용자 정의 연산자를 개발합니다.
...
## <a name="define-and-use-user-defined-operator-in-u-sql"></a>U-SQL에서 사용자 정의 연산자를 정의하고 사용합니다.
**U-SQL 작업을 만들고 제출하기**
