...
Azure PowerShell을 사용하여 Azure Data Lake 분석 계정을 만들고, [U-SQL](data-lake-analytics-u-sql-get-started.md)로 Data Lake 분석 작업을 정의하고, 작업을 Data Lake 분석 계정에 제출하는 방법에 대해 알아봅니다. Data Lake Analytics에 대한 자세한 내용은 [Azure Data Lake Analytics 개요](data-lake-analytics-overview.md)를 참조하세요.
...
## <a name="upload-data-to-data-lake"></a>데이터 레이크에 데이터 업로드
...
> [!NOTE]
> Azure 포털은 기본 데이터 레이크 저장소 계정에 샘플 데이터 파일을 복사하는 사용자 인터페이스를 제공합니다. 자세한 내용은 [Azure 포털을 사용하여 Azure 데이터 레이크 분석 시작](data-lake-analytics-get-started-portal.md#prepare-source-data)을 참조하세요.
>
>
