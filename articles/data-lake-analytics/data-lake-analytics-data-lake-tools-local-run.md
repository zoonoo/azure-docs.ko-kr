...
**Local-machine** 계정은 로컬 저장소 계정으로서 단일 로컬 데이터 루트 폴더를 갖는 공유 로컬 컴퓨팅 계정입니다. 기본적으로 데이터 루트 폴더의 위치는 **C:\Users\<username>\AppData\Local\USQLDataRoot** 입니다. 또한 **도구** > **Data Lake** > **옵션 및 설정** 을 통해 구성할 수 있습니다.
