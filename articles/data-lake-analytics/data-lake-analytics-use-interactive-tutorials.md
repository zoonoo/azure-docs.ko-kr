...
---
# <a name="use-azure-data-lake-analytics-interactive-tutorials"></a>Azure 데이터 레이크 분석 대화형 자습서 사용
...
9. **만들기**를 클릭합니다. 포털 시작 보드로 이동됩니다. 새 타일이 "Azure 데이터 레이크 분석 배포" 레이블을 사용하여 홈 페이지에 추가됩니다. Data  Lake Analytics 계정을 만드는 데 몇 분 정도 걸립니다. 계정이 만들어지면 포털이 새 블레이드에 해당 계정을 엽니다.
