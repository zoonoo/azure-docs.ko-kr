...
## <a name="create-console-application"></a>콘솔 응용 프로그램 만들기
...
Data Lake Analytics 작업은 U-SQL 언어로 작성됩니다. U-SQL에 대한 자세한 내용은 [U-SQL 언어 시작](data-lake-analytics-u-sql-get-started.md) 및 [U-SQL 언어 참조](http://go.microsoft.com/fwlink/?LinkId=691348)를 참조하세요.
...
연결된 저장소 계정의 파일에 액세스하려면 절대 경로를 사용해야 합니다.  연결된 Azure Storage 계정에 저장된 파일에 대한 구문은 다음과 같습니다.

    wasb://<BlobContainerName>@<StorageAccountName>.blob.core.windows.net/Samples/Data/SearchLog.tsv

> [!NOTE]
> 현재 Azure Data Lake 서비스와 관련된 알려진 문제가 있습니다.  샘플 앱이 중단되거나 오류가 발생할 경우, 스크립트가 생성하는 Data Lake 저장소 및 Data Lake 분석 계정을 수동으로 삭제해야 할 수 있습니다.  Azure Portal에 친숙하지 않다면 [Azure Portal을 사용한 Azure Data Lake Analytics 관리](data-lake-analytics-manage-use-portal.md) 가이드로 시작해 보세요.       
> 
> 
