...
>[AZURE.NOTE] 완성된 앱의 소스 코드를 보려면 <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures/GettingStartedWithPush/Android" target="_blank">여기로 이동하세요</a>.
...
1. Eclipse를 다시 시작한 후 패키지 탐색기에서 프로젝트를 마우스 오른쪽 단추로 클릭하고 **속성**, **Android**를 차례로 클릭한 후 **Google API**를 선택하고 **확인**을 클릭합니다.
...
[Google Play 서비스 SDK]: http://go.microsoft.com/fwlink/?LinkId=389801
...
[구독자에게 브로드캐스트 알림 보내기]: /ko-kr/documentation/articles/notification-hubs-android-send-breaking-news/
