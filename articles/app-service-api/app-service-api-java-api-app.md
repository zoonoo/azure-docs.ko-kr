...
## 필수 조건
1. [Java 개발자 키트 8](또는 이상.md)
2. 개발 컴퓨터에 [Maven] 설치됨
3. 개발 컴퓨터에 [Git] 설치됨
4. [Microsoft Azure]에 대한 유료 또는 [무료 평가판] 구독
5. [Postman]과 같은 HTTP 테스트 응용 프로그램
...
2. API 앱을 만들면 앱의 **설정** 블레이드를 열고 **응용 프로그램 설정** 메뉴 항목을 클릭합니다. 사용 가능한 옵션에서 최신 Java 버전을 선택한 다음 **웹 컨테이너 메뉴**에서 최신 Tomcat을 선택하고 **저장**을 클릭합니다.
