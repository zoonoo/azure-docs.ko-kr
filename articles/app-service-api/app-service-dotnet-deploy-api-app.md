...
API 앱은 API 호스팅을 위한 추가 기능이 있는 웹앱입니다. 즉 웹 응용 프로그램을 사용하는 모든 배포 방법을 사용할 수 있습니다. 웹앱에 배포 옵션에 대한 자세한 내용은 [Azure 앱 서비스에서 웹앱 배포](../app-service-web/web-sites-deploy.md)를 참조하세요.
