...
예를 들어 클라이언트 코드에서 [Twitter Connector API 앱](../connectors/connectors-create-api-twitter.md) 을 사용하는 경우 코드는 특정 단어가 포함된 새 트윗을 기반으로 작업을 수행해야 합니다. 이 경우 밀어넣기 또는 끌어오기 트리거를 설정하면 용이할 수 있습니다.
