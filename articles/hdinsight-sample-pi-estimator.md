...
이 항목에서는 Azure Powershell을 사용하여 Azure HDinsight에서 수학 상수 Pi의 값을 추정하는 간단한 MapReduce 프로그램의 실행 방법을 보여 줍니다.
...
HDInsight를 사용하여 MapReduce 작업을 실행하는 데 도움이 될 수 있는 기타 샘플이 실행 방법 지침에 대한 링크와 함께 [HDInsight 샘플 실행](/en-us/manage/services/hdinsight/howto-run-samples)에 나열되어 있습니다.
...
Azure PowerShell로 Azure HDInsight에서 Pig, Hive 및 MapReduce 작업을 사용하는 방법에 대한 지침을 제공하고 다른 샘플을 실행하는 자습서에 대해서는 다음 항목을 참조하십시오.
