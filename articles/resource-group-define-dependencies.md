...
리소스와 copy 루프를 통해 만들어진 리소스 사이의 의존성을 정의해야 하는 경우 dependsOn 요소를 루프의 이름으로 설정할 수 있습니다. 예제는 [Azure 리소스 관리자에서 리소스의 여러 인스턴스 만들기](resource-group-create-multiple.md)를 참조하세요.
