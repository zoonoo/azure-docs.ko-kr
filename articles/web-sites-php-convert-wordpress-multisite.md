...
Azure 웹 사이트에서는 웹 사이트에 도메인을 무제한으로 추가할 수 있습니다. 다른 도메인을 추가하려면 각 도메인에 대해 **도메인 확인** 및 **도메인 A 레코드 설정** 섹션을 실행해야 합니다.
  ...
  [벤 로바우(Ben Lobaugh)]: http://ben.lobaugh.net
  [Microsoft Open Technologies Inc.]: http://msopentech.com
  [Azure의 갤러리에서 WordPress 웹 사이트 만들기]: https://www.windowsazure.com/ko-KR/develop/php/tutorials/website-from-gallery/
  [WordPress Codex]: http://codex.wordpress.org
  [네트워크 만들기]: http://codex.wordpress.org/Create_A_Network
  [MySQL 및 FTP를 사용하는 PHP 웹 사이트(영문)]: https://www.windowsazure.com/ko-KR/develop/php/tutorials/website-w-mysql-and-ftp/#header-0
  [MySQL 및 Git를 사용하는 PHP 웹 사이트(영문)]: https://www.windowsazure.com/ko-KR/develop/php/tutorials/website-w-mysql-and-git/#header-1
  [네트워크 설정 화면]: ./media/web-sites-php-convert-wordpress-multisite/wordpress-network-setup.png
  [멀티 사이트 네트워크 유형]: http://codex.wordpress.org/Before_You_Create_A_Network#Types_of_multisite_network
  [WordPress MU 도메인 매핑]: http://wordpress.org/extend/plugins/wordpress-mu-domain-mapping/
