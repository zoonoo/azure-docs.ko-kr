...
<li><p>솔루션 탐색기에서 <strong>Azure</strong>, <strong>모바일 서비스</strong>, 서비스 이름 및 <strong>channels</strong>를 확장한 후 insert.js 파일을 엽니다.</p> 
