...
[.NET 백 엔드](/en-us/documentation/articles/mobile-services-dotnet-backend-windows-store-javascript-get-started-push/ ".NET 백 엔드") | [JavaScript 백 엔드](/en-us/documentation/articles/mobile-services-windows-store-javascript-get-started-push/ "JavaScript 백 엔드")
...
> [WACOM.NOTE]이제 모바일 서비스가 Azure 알림 허브와 통합되어 템플릿, 다중 플랫폼, 확장 등 추가적인 푸시 알림 기능을 지원합니다. 이 통합 기능은 현재 사전 검토 단계입니다. 자세한 내용은 [푸시 알림 시작하기](/en-us/documentation/articles/mobile-services-javascript-backend-windows-store-javascript-get-started-push/)를 참조하십시오.
