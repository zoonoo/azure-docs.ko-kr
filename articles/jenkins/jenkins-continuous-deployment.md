...
![AKS에서 실행 중인 Azure 투표 애플리케이션 예제](media/jenkins-continuous-deployment/azure-vote.png)
...
![서비스 주체 정보를 사용하여 Jenkins 자격 증명 개체 만들기](media/jenkins-continuous-deployment/acr-credentials.png)
...
![Jenkins 테스트 빌드](media/jenkins-continuous-deployment/test-build.png)
...
![Jenkins 빌드 작업으로 업데이트된 샘플 AKS 투표](media/jenkins-continuous-deployment/azure-vote-updated.png)
