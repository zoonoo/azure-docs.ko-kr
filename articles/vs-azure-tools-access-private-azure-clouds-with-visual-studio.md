...
3. **Microsoft Azure 구독 관리** 대화 상자에서 **인증서** 탭을 클릭한 후 **가져오기**를 클릭합니다.
   
    ![Azure 인증서 가져오기](./media/vs-azure-tools-access-private-azure-clouds-with-visual-studio/IC790779.png)
4. **Microsoft Azure 구독 가져오기** 대화 상자에서 게시 설정 파일을 저장한 폴더를 찾고 파일을 선택 한 다음 **가져오기** 단추를 선택합니다. 이렇게 하면 Visual Studio로 게시 설정 파일에서 인증서를 가져옵니다. 이제 사설 클라우드 리소스와 상호 작용할 수 있습니다.
