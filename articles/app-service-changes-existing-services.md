...
<p><li>기존 웹 사이트는 <a href="http://go.microsoft.com/fwlink/?LinkId=529715">Azure 포털</a>을 통해 액세스할 수 있으며, 모든 기존 사이트가 <em>웹앱</em>아래에 있습니다.</p>
<p><li><em>웹 호스팅 계획</em> 은 이제 <em>앱 서비스 계획</em>입니다.  <em>앱 서비스 계획</em> 은 웹, 모바일, 논리 또는 API 앱과 같은 앱 서비스의 모든 앱 유형을 호스트할 수 있습니다.</p>
