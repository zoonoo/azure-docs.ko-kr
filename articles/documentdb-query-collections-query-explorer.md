...
1. 각 블레이드 하단 근처에는 **쿼리 탐색기** 타일이 포함된 **개발자 도구** 렌즈가 있습니다.
...
##<a id="Create"></a>쿼리 탐색기를 사용해서 쿼리 만들기, 편집 및 실행##
...
- 기본적으로 쿼리 탐색기는 100개 단위로 결과를 반환합니다.  쿼리로 생성되는 결과가 100개 이상이면 단순히 **다음 페이지** 및 **이전 페이지** 명령을 사용해서 결과 집합을 탐색할 수 있습니다.
