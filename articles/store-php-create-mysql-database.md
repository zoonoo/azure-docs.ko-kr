...
> [!NOTE]
> 다음 단계에서는 [Azure에 PHP 웹앱 만들기, 구성 및 배포](app-service-web/app-service-web-php-get-started.md)자습서를 완료했다고 가정합니다.
>
>
...
5. `.env` 설정을 Azure 웹앱에 복제해야 합니다. 다음 Azure CLI 명령을 실행합니다.
    ...
    [Azure 웹앱 구성](app-service-web/app-service-web-get-started-php.md#configure-to-use-php)에서 이 명령이 어떻게 작동하는지 알아보세요.
