...
[Hello world](https://github.com/rustd/RedisSamples/tree/master/HelloWorld) 샘플은 [StackExchange.Redis](https://github.com/StackExchange/StackExchange.Redis) .NET 클라이언트를 사용하여 캐시에서 항목을 읽고 쓰는 방법을 보여 줍니다.

[Azure Redis Cache를 Node.js와 함께 사용하는 방법](cache-nodejs-get-started.md)에서는 Node.js와 [node_redis](https://github.com/mranney/node_redis) 클라이언트를 사용하여 Azure Redis Cache를 시작하는 방법을 보여 줍니다.
...
[PHP 예제](https://msdn.microsoft.com/library/azure/dn690470.aspx#PHPExample)는 Azure Redis Cache를 PHP 및 [predis](https://github.com/nrk/predis) 클라이언트와 함께 사용하는 방법을 보여 줍니다.
...
## MAML을 사용하여 Azure Redis Cache 관리
