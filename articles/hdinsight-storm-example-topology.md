<properties
 pageTitle="HDInsight의 Apache Storm에 대한 예제 Storm 토폴로지"
 description="HDInsight의 Apache Storm으로 만들고 테스트한 예제 Storm 토폴로지 목록입니다."
 services="hdinsight"
 documentationCenter=""
 authors="Blackmist"
 manager="paulettm"
...
[2b8c3488]: hdinsight-storm-getting-started.md "HDInsight 클러스터에서 Storm을 만들고 Storm Dashboard를 사용하여 예제 토폴로지를 배포하는 방법에 대해 알아봅니다."
