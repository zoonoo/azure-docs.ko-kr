...
## <a name="modify-settingsphp"></a><span class="short-header">settings.php에서 데이터베이스 연결 정보 수정</span>3. settings.php에서 데이터베이스 연결 정보 수정
...
## <a name="deploy-drupalcode"></a><span class="short-header">Git 또는 FTP를 사용하여 Drupal 코드 배포</span>4. Git 또는 FTP를 사용하여 Drupal 코드 배포
...
## <a name="related-information"></a><span class="short-header">관련 정보</span>관련 정보
