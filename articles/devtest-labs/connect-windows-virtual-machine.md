...
1. VM에 대 한 **가상 머신** 페이지의 도구 모음에서 **연결** 을 선택 합니다. VM이 중지 된 경우 먼저 **시작** 을 선택 하 여 vm을 시작 합니다.
    ...
    :::image type="content" source="./media/connect-windows-virtual-machine/select-connect.png" alt-text="도구 모음에서 연결을 선택 합니다.":::                    
1. Edge 브라우저를 사용 하는 경우 **다운로드 한 RDP 파일** 에 대 한 링크가 브라우저 아래쪽에 표시 됩니다. 

    :::image type="content" source="./media/connect-windows-virtual-machine/rdp-download.png" alt-text="RDP 다운로드 됨":::                        
