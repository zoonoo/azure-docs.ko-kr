...
DevTest Labs 관련 명령을 실행 하기 전에 명령을 사용 하 여 적절 한 Azure 컨텍스트를 설정 합니다 `az account set` .

```azurecli
az account set --subscription 11111111-1111-1111-1111-111111111111
```

가상 컴퓨터를 만드는 `az lab vm create` 명령은 다음과 같습니다. 랩, 랩 이름 및 가상 컴퓨터 이름에 대 한 리소스 그룹이 모두 필요 합니다. 나머지 인수는 가상 컴퓨터의 형식에 따라 달라 집니다.
