...
1. 랩 목록에서 *랩을*선택 합니다. 
    ...
    > [!NOTE]
    > Azure 방호는 현재 미리 보기 상태입니다. 미국 서 부, 미국 동부, 유럽 서부, 미국 중부 중부, 오스트레일리아 동부 및 일본 동부 지역으로 제한 됩니다. 따라서 랩을 이러한 지역 중 하나에 없는 경우 이러한 지역 중 하나에서 랩을 만듭니다. 
