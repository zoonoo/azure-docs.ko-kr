...
2. 랩에서 모든 랩 OS 디스크의 암호화를 처리 하려면 랩 소유자는 랩의 **시스템 할당 id** 에 디스크 암호화 집합에 대 한 사용 권한을 명시적으로 부여 해야 합니다. 랩 소유자는 다음 단계를 완료 하 여이 작업을 수행할 수 있습니다.

    > [!IMPORTANT]
    > 8/1/2020 후 또는 이후에 생성 된 랩에서는 이러한 단계를 수행 해야 합니다. 해당 날짜 이전에 생성 된 랩에서는 작업이 필요 하지 않습니다.
