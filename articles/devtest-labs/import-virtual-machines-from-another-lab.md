...
[GitHub](https://github.com/Azure/azure-devtestlab/tree/master/samples/DevTestLabs/Scripts/ImportVirtualMachines)에서 ImportVirtualMachines.ps1 파일을 다운로드 합니다. 스크립트를 사용 하 여 원본 랩에서 단일 VM 또는 모든 Vm을 대상 랩으로 가져올 수 있습니다.
