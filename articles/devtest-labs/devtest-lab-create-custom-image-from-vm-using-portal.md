...
1. VM의 관리 창에서 **작업**아래에서 **사용자 지정 이미지 만들기** 를 선택 합니다.
...
1. **사용자 지정 이미지** 창에서 사용자 지정 이미지에 대한 이름 및 설명을 입력합니다. 이 정보는 VM을 만들 때 기본 목록에 표시됩니다. 사용자 지정 이미지에는 OS 디스크 및 가상 머신에 연결된 모든 데이터 디스크가 포함됩니다.
    ...
    :::image type="content" source="./media/devtest-lab-create-template/create-custom-image-blade.png" alt-text="사용자 지정 이미지 만들기 메뉴 항목":::
...
1. 완료했으면 **확인** 을 선택하여 사용자 지정 이미지를 만듭니다.
    ...
    :::image type="content" source="./media/devtest-lab-create-template/custom-image-available-as-base.png" alt-text="사용자 지정 이미지 만들기 메뉴 항목":::
