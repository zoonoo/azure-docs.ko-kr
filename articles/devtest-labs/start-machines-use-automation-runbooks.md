...
이제 automation 계정에 runbook을 추가 하려면 왼쪽 메뉴에서 **runbook** 을 선택 합니다. 메뉴에서 **Runbook 추가** 를 선택 하 고 지침에 따라 [PowerShell runbook을 만듭니다](../automation/learn/automation-tutorial-runbook-textual-powershell.md).
...
이 스크립트를 매일 실행 하려면 automation 계정에 [일정을 만듭니다](../automation/shared-resources/schedules.md#create-a-schedule) . 일정이 만들어지면 [runbook에 연결](../automation/shared-resources/schedules.md#link-a-schedule-to-a-runbook)합니다. 
