...
description: 자세한 장치 사양에 대해서는 Azure Percept 진한 데이터 시트를 확인 하세요.
author: elqu20
ms.author: v-elqu
...
|제품 사양           |값     |
|--------------------------------|--------|
|산업 설계               |통합 80/20 1010 시리즈 탑재 |
|성능                     |0.7 위쪽 (Azure Percept 비전)|
|대상 산업               |소매 <br> 제조업 <br> 접객 <br> 스마트 빌딩 <br> 자동 |
|주인공 시나리오                  |10 분 이내에 첫 번째 AI 프레임을 기본으로 <br> 30 분 내에 기본으로 프로토타입 <br> 초기 학습 데이터 캡처 및 레이블 <br> 기본 AI 모델 사용자 지정 <br> 고급 AI 모델 사용자 지정 |
