...
ms.locfileid: "101663683"
---
# <a name="introduction-to-azure-percept-audio"></a>Azure Percept 오디오 소개

Azure Percept Audio는 Azure Percept에 음성 AI 기능을 추가 하는 액세서리 장치입니다. 여기에는 미리 구성 된 음성 AI 가속기와 4 개의 마이크 선형 배열이 포함 되어 있으며,이를 통해 로컬 수신 장치에 사용자 지정 명령, 키워드 발견 및 far 필드 음성을 적용할 수 있습니다. Azure Percept Audio를 사용 하면 장치 제조업체에서 Azure Percept 진한 비전 기능을 새로운 스마트 음성 활성화 장치로 확장할 수 있습니다. Azure Percept 진한, Azure Percept Studio 및 기타 Azure edge 관리 서비스와 함께 기본적으로 통합 됩니다. [Microsoft online 스토어](https://go.microsoft.com/fwlink/p/?LinkId=2155270)에서 구매할 수 있습니다.

![Azure Percept 오디오 장치.](./media/overview-azure-percept-audio/percept-audio.png)
...
- 4 개의 마이크 선형 배열을 사용 하는 프로덕션이 준비 된 Azure SoM (Percept Audio device)
- 개발자 보드 (2x 단추, 3, 3 개 Led, USB 마이크로 및 3.5 mm 오디오 잭 포함)
- 필요한 케이블: 플렉스 케이블, USB 마이크로 유형-B-USB-A
- 환영 카드
