<properties 
   pageTitle="Application Gateway에 대한 액세스 및 성능 로그와 메트릭 모니터링 | Microsoft Azure"
...
# Application Gateway에 대한 진단 로깅 및 메트릭
...
현재 지원되는 메트릭 목록을 보려면 [Azure Monitor에 지원되는 메트릭](../azure-portal/monitoring-supported-metrics.md)을 방문하세요.
...
경고 알림에 대한 자세한 내용은 [경고 알림 받기](../azure-portal/insights-receive-alert-notifications.md)를 방문하세요.

웹후크에 대한 자세한 내용 및 웹후크를 경고와 함께 사용하는 방법을 알아보려면 [Azure 활동 메트릭 경고에 대한 웹후크 구성](../azure-portal/insights-webhooks-alerts.md)을 방문하세요.
