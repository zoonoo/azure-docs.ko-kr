...
현재 지원되는 메트릭 목록을 보려면 [Azure Monitor에 지원되는 메트릭](../azure-portal/monitoring-supported-metrics.md)
...
웹후크에 대한 자세한 내용 및 웹후크를 경고와 함께 사용하는 방법을 알아보려면 [Azure 활동 메트릭 경고에 대한 웹후크 구성](../azure-portal/insights-webhooks-alerts.md)
