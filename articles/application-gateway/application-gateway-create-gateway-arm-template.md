...
---
title: Azure Resource Manager 템플릿을 사용하여 응용 프로그램 게이트웨이 만들기 | Microsoft Docs
...
1. **resources** 아래의 내용을 확인하고 다음을 검토합니다.
...
2. [https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create/](https://github.com/Azure/azure-quickstart-templates/blob/master/101-application-gateway-create)로 이동합니다.
3. **azuredeploy-paremeters.json**을 클릭하고 **RAW**를 클릭합니다.
4. 파일을 컴퓨터의 로컬 폴더에 저장합니다.
5. 저장한 파일을 열고 매개 변수 값을 편집합니다. 다음 값을 사용하여 이 시나리오에 설명된 응용 프로그램 게이트웨이를 배포합니다.
...
6. 파일을 저장합니다. [JSlint.com](http://www.jslint.com/)같은 JSON 유효성 검사 도구를 사용하여 JSON 템플릿과 매개 변수 템플릿을 테스트할 수 있습니다.
