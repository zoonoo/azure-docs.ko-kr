...
> [응용 프로그램 게이트웨이 사용 하 여 수행할 수 있는 작업에 대해 자세히 알아보기](application-gateway-introduction.md)
