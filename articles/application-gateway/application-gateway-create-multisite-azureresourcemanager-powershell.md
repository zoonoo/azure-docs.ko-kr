...
>[AZURE.NOTE] 응용 프로그램 게이트웨이에 사용자 지정 프로브를 구성해야 하는 경우 [PowerShell을 사용하여 사용자 지정 프로브로 응용 프로그램 게이트웨이 만들기](application-gateway-create-probe-ps.md)를 참조하세요. 자세한 내용은 [사용자 지정 프로브 및 상태 모니터링](application-gateway-probe-overview.md)으로 이동하세요.
...
IP 주소가 "10.0.1.100, 10.0.1.101,10.0.1.102"인 "pool1"과 IP 주소가 "10.0.1.103, 10.0.1.104, 10.0.1.105"인 "pool2"로 백 엔드 IP 주소 풀, “pool01”과 “pool2”를 구성합니다.
