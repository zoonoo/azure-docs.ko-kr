...
Azure CLI를 사용하여 백 엔드 서버에 [가상 머신 확장 집합](application-gateway-introduction.md)을 사용하는 [애플리케이션 게이트웨이](../virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md)를 만들 수 있습니다. 이 예제에서 확장 집합은 애플리케이션 게이트웨이의 기본 백 엔드 풀에 추가되는 두 개의 가상 머신 인스턴스를 포함합니다.
