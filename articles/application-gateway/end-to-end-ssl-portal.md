...
자세한 내용은 [Application Gateway를 사용 하는 tls 종료 및 종단 간 Tls 개요](https://docs.microsoft.com/azure/application-gateway/ssl-overview)를 참조 하세요.
...
자세히 알아보려면 [새 응용 프로그램 게이트웨이를 만드는 동안 TLS 종료 사용](https://docs.microsoft.com/azure/application-gateway/create-ssl-portal)을 참조 하세요.
