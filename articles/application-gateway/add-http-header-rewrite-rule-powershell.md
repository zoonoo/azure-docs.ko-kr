...
이 문서에서는 Azure PowerShell를 사용 하 여 요청 및 응답에서 HTTP 헤더를 다시 작성 하도록 [Application Gateway V2 SKU](<https://docs.microsoft.com/azure/application-gateway/application-gateway-autoscaling-zone-redundant>) 인스턴스를 구성 하는 방법을 설명 합니다.
