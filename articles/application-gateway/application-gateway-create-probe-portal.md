...
### <a name="step-1"></a>1단계
http://portal.azure.com으로 이동하여 기존 Application Gateway를 선택합니다.
...
* **호스트** - 프로브에 사용되는 호스트 이름입니다. 다중 사이트를 Application Gateway에 구성하는 경우에만 적용할 수 있습니다. 그렇지 않으면 '127.0.0.1'을 사용합니다. VM 호스트 이름과 다릅니다.
