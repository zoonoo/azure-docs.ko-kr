...
- **모두 같음**: 이 연산자는 모든 요청 필드와 일치 합니다. *는 선택기 값이 됩니다.
...
이 헤더의 평가를 사용 하지 않도록 설정 하는 데는 여러 가지 이유가 있을 수 있습니다. WAF가 확인 하 고 악성 이라고 가정할 수 있는 문자열이 있을 수 있습니다. 예를 들어, 문자열에서 클래식 SQL 공격 "x = x"가 있습니다. 경우에 따라 합법적인 트래픽이 될 수 있습니다. 따라서 WAF evaluation에서이 헤더를 제외 해야 할 수도 있습니다.
