<properties
   pageTitle="Application Gateway에서 SSL 정책 및 종단 간 SSL을 사용하도록 설정 | Microsoft Azure"
...
# Application Gateway에서 SSL 정책 및 종단 간 SSL을 사용하도록 설정
...
이 예에서 https://contoso.com에 대한 요청은 HTTP를 통해 ContosoServerPool으로 라우팅할 수 있으며, https://fabrikam.com은 종단 간 SSL을 사용하여 HTTPS를 통해 FabrikamServerPool로 라우팅됩니다.

## 종단 간 SSL 및 인증서 허용 목록
...
2. SSL 정책 정의를 사용하여 3개 프로토콜 TLSv1_0, TLSv1_1, TLSv1\_2 중에서 원하는 것을 비활성화할 수 있습니다.
3. SSL 정책을 하나도 정의하지 않으면 3개(TLSv1_0, TLSv1_1, TLSv1\_2) 모두 활성화됩니다.
