<properties
   pageTitle="Azure Resource Manager를 사용하여 ILB(내부 부하 분산 장치)에서 응용 프로그램 게이트웨이 만들기 및 구성 | Microsoft Azure"
...
> [AZURE.SELECTOR]
- [Azure 클래식 단계](application-gateway-ilb.md)
- [리소스 관리자 PowerShell 단계](application-gateway-ilb-arm.md)
...
>[AZURE.NOTE]  *InstanceCount* 에 대한 기본값은 2이고, 최대값은 10입니다. *GatewaySize* 에 대한 기본값은 보통입니다. Standard_Small, Standard_Medium 및 Standard_Large 간에 선택할 수 있습니다.
