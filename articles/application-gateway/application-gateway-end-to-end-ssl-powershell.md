...
> [!NOTE]
> 정규화된 도메인 이름(FQDN) 역시 백 엔드 서버의 IP 주소를 대체할 수 있는 유효한 값입니다.
> 
> 
...
> [!NOTE]
> 이 단계에서 제공하는 인증서는 백 엔드에 있는 pfx 인증서의 공개 키이어야 합니다. 이 단계에서는 Application Gateway를 통해 백 엔드를 허용 목록에 추가합니다. 
> 
> 
