...
예. Application Gateway에서 경고는 메트릭에 대해 구성됩니다. 자세한 내용은 [Application Gateway 메트릭](./application-gateway-metrics.md) 및 [경고 알림 받기](../azure-monitor/alerts/alerts-overview.md)를 참조하세요.
