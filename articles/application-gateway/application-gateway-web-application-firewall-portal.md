...
1. **개요** 페이지에서 애플리케이션 게이트웨이의 공용 IP 주소를 찾습니다.![애플리케이션 게이트웨이의 공용 IP 주소 기록](./media/application-gateway-create-gateway-portal/application-gateway-record-ag-address.png) 
...
> [웹 애플리케이션 방화벽에 대한 자세한 정보](waf-overview.md)
