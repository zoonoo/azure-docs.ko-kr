...
4. **프런트 엔드 IP 구성**을 선택합니다. **프런트 엔드 IP 구성** 아래에서 **IP 주소 유형**이 **공용**으로 설정되었는지 확인합니다. **공용 IP 주소** 아래에서 **새로 만들기**가 선택되었는지 확인합니다. <br>사용 사례에 따라 프런트 엔드 IP를 공용 또는 개인 IP로 구성할 수 있습니다. 여기서 공용 프런트 엔드 IP를 선택합니다.
