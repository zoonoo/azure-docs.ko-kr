...
이제 통합 된 SECaaS (타사 Security as a service) 파트너를 사용할 수 있습니다. 
...
1. 파트너에 게 제공 된 지침에 따라 설치를 완료 합니다. 여기에는 허브를 검색 하 고 연결 하는 AAD 정보를 제출 하 고, 송신 정책을 업데이트 하 고, 연결 상태와 로그를 확인 하는 작업이 포함 됩니다.
   ...
   - [Check Point: 가상 WAN 통합 Microsoft Azure 구성](https://sc1.checkpoint.com/documents/Infinity_Portal/WebAdminGuides/EN/CloudGuard-Connect-Azure-Virtual-WAN/Default.htm)합니다.
   - [iboss: Microsoft Azure 가상 WAN 통합을 구성](https://www.iboss.com/blog/securing-microsoft-azure-with-iboss-saas-network-security)합니다. 
