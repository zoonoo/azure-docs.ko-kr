...
### <a name="create-a-spoke-virtual-network-and-subnets"></a>스포크 가상 네트워크 및 서브넷 만들기
...
1. **주소 공간**의 경우 기본값 **10.0.0.0/16**을 적용합니다.
3. **서브넷 이름** 아래에서 **기본값**을 선택합니다.
4. 서브넷 이름을 **워크로드-SN**으로 변경합니다.
