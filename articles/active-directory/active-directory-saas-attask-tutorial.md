<properties
    pageTitle="자습서: @Task|와(과) Azure Active Directory 통합 | Microsoft Azure"
...
4. **[@Tasktest 사용자 만들기](#creating-a-halogen-software-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 @Taskthat에 만듭니다.
