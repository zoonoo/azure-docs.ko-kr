...
---
# <a name="configure-automatic-device-registration-for-windows-81-domain-joined-devices"></a>Windows 8.1 도메인 가입 장치에 대한 자동 장치 등록 구성
...
## <a name="configure-the-group-policy-for-your-windows-81-domain-joined-devices"></a>Windows 8.1 도메인 가입 장치에 대한 그룹 정책 구성
...
## <a name="unregistering-your-windows-81-domain-joined-devices"></a>Windows 8.1 도메인 가입 장치 등록 취소
