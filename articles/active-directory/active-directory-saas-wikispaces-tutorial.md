...
이 자습서는 Azure 및 Wikispaces의 통합을 보여 주기 위한 것입니다.  
...
### <a name="to-enable-the-application-integration-for-wikispaces-perform-the-following-steps"></a>Wikispaces에 응용 프로그램 통합을 사용하도록 설정하려면
...
5. 메타데이터를 Wikispaces 지원팀에 보냅니다.
    ...
    > [!NOTE]
    > Single Sign-On 구성을 Wikispaces 지원팀에서 수행할 수 있습니다. 구성이 완료되는 즉시 알림을 받아볼 수 있습니다.
    > 
    > 
...
### <a name="to-assign-users-to-wikispaces-perform-the-following-steps"></a>Wikispaces에 사용자를 할당하려면 다음 단계를 수행합니다.
