...
다음 문서는 하이브리드 ID 솔루션을 구현하는 데 필요한 필수 포트 및 프로토콜에 정보를 제공하는 기술 참조입니다. 아래 그림을 사용하고 해당 테이블을 참조하십시오.
...
|RPC |1024-65353(임의 높은 RPC 포트)(TCP/UDP)|AD 포리스트를 바인딩할 때 Azure AD Connect의 초기 구성 중에 사용합니다.
