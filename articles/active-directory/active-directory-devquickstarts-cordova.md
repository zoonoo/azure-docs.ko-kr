...
#### Windows 10:
   ...
   **참고**: 처음 실행할 때는 개발자 라이선스를 확인하기 위해 로그인하라는 메시지가 표시될 수 있습니다. 자세한 내용은 [개발자 라이선스](https://msdn.microsoft.com/library/windows/apps/hh974578.aspx)를 참조하세요.
...
#### Android:
   ...
   **참고**: *필수 구성 요소* 섹션에 표시된 것처럼 *AVD Manager*를 사용하여 에뮬레이터 인스턴스를 만들었는지 확인합니다.
...
#### iOS:
   ...
   **참고**: `ios-sim` 패키지가 에뮬레이터에서 실행되도록 설치되어 있는지 확인합니다. 자세한 내용은 *필수 구성 요소* 섹션을 참조하세요.
