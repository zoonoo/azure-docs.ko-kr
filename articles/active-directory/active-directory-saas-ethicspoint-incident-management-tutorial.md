...
4. 검색 상자에 **EPIM(EthicsPoint Incident Management)**을 입력합니다.
...
5. 결과 창에서 **EPIM(EthicsPoint Incident Management)**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[EPIM(EthicsPoint Incident Management) 테스트 사용자 만들기](#creating-a-ethicspoint-incident-management-epim-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 EPIM(EthicsPoint Incident Management)에 만듭니다.
...
3. **EPIM(EthicsPoint Incident Management) 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    c. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<servername>.navexglobal.com/adfs/ls/`
...
6. **EPIM(EthicsPoint Incident Management)** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [EPIM(EthicsPoint Incident Management) 지원 팀](http://www.navexglobal.com/company/contact-us)으로 보내야 합니다.
