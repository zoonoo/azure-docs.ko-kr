...
- **보안 판독기**: ID 보안 센터, Privileged Identity Management, Office 365 서비스 상태 모니터링 및 Office 365 보호 센터의 여러 보안 기능에 읽기 전용 액세스합니다.

- **보안 관리자**: **보안 판독기** 역할의 모든 읽기 전용 권한에다 동일한 서비스에 대한 ID 보안 센터, Privileged Identity Management, Office 365 서비스 상태 모니터링 및 Office 365 보호 센터와 같은 여러 관리자 권한를 추가했습니다.
...
<p>Office 365 서비스 상태 모니터링</p><p>Office 365 보호 센터</p> | <ul><li>경고 읽기 및 관리<li>보안 정책 읽기<li>위협 인텔리전스, 클라우드 앱 검색, 검색 및 조사에서의 격리 읽기<li>모든 보고서 읽기
...
<p>Office 365 서비스 상태 모니터링</p><p>Office 365 보호 | <ul><li>보안 판독기 역할의 모든 사용 권한.<li>고급 위협 방지 기능(맬웨어 및 바이러스 보호, 악성 URL 구성, URL 추적 등)에서 모든 설정을 구성할 수 있습니다.
