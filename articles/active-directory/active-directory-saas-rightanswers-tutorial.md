...
* 유효한 Azure 구독
* RightAnswers SSO(Single Sign-On)가 설정된 구독
...
## <a name="enable-the-application-integration-for-rightanswers"></a>RightAnswers에 응용 프로그램 통합 사용
...
Azure AD 사용자가 RightAnswers에 로그인할 수 있도록 하려면 RightAnswers로 프로비전되어야 합니다. RightAnswers의 경우 프로비전은 자동 작업이므로 수행할 작업이 없습니다.
