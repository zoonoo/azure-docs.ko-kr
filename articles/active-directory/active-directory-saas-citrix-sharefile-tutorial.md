...
## <a name="enable-the-application-integration-for-citrix-sharefile"></a>Citrix ShareFile에 응용 프로그램 통합 사용
...
8. **기본 설정**의 **Single Sign-on/SAML 2.0 구성** 대화 상자 페이지에서 다음 단계를 수행 합니다.
   ...
   5. **X.509 인증서** 필드 옆의 **변경**을 클릭한 다음 Azure AD 클래식 포털에서 다운로드한 인증서를 업로드합니다. 
      ...
      ![기본 설정](./media/active-directory-saas-citrix-sharefile-tutorial/IC773629.png "기본 설정")
