<properties 
	pageTitle="Azure AD Connect Health 버전 내역" 
...
# Azure AD Connect Health: 버전 릴리스 내역
...
- [역할 기반 액세스 제어](active-directory-aadconnect-health-operations.md#manage-access-with-role-based-access-control)에 대한 지원
