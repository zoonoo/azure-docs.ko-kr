...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에 **“https://sso.tangoe.com/sp/startSSO.ping?PartnerIdpId=\<tenant issuer\>&Target=\<target page URL\>”** 패턴을 사용하여 사용자가 Tangoe Command Premium Mobile에 로그온하는 데 사용하는 URL을 입력합니다.
