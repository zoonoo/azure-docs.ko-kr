...
1. Azure CLI를 로컬 콘솔에서 사용하는 경우 [az login](/cli/azure/#az_login)을 사용하여 먼저 Azure에 로그인합니다. 가상 머신 확장 집합을 배포하려는 Azure 구독과 연결된 계정을 사용합니다.
...
1. Azure CLI를 로컬 콘솔에서 사용하는 경우 [az login](/cli/azure/#az_login)을 사용하여 먼저 Azure에 로그인합니다. 가상 머신 확장 집합이 포함된 Azure 구독과 연결된 계정을 사용합니다.
