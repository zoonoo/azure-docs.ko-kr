...
3. **Canvas 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **식별자** 텍스트 상자에 `https://<tenant-name>.instructure.com/saml2` 패턴으로 값을 입력합니다.
...
10. 현재 통합 페이지에서 다음 단계를 수행합니다.
    ...
    나. Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL** 값을 **로그온 URL** 텍스트 상자에 붙여넣습니다.
...
5. 새 사용자 추가 대화 상자 페이지에서 다음 단계를 수행합니다.
   ...
   나. **전자 메일** 텍스트 상자에 **brittasimon@contoso.com**과 같은 사용자의 전자 메일 주소를 입력합니다.
