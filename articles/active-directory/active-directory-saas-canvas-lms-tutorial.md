...
## <a name="enable-the-application-integration-for-canvas"></a>Canvas에 응용 프로그램 통합 사용
...
Canvas에 대한 SSO를 구성하려면 인증서의 지문 값을 검색해야 합니다. 이 절차를 잘 모르는 경우 [인증서의 지문 값을 검색하는 방법](http://youtu.be/YKQF266SAxI)
...
2. **Canvas** 응용 프로그램 통합 페이지에서 **사용자 할당**을 클릭합니다.
   ...
   ![사용자 지정](./media/active-directory-saas-canvas-lms-tutorial/IC775998.png "사용자 할당")
