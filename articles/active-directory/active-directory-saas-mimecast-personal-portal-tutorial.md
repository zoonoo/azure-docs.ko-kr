...
4. 검색 상자에 **Mimecast Personal Portal**을 입력합니다.
...
5. 결과 창에서 **Mimecast Personal Portal**을 선택하고 **추가**를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Mimecast Personal Portal 테스트 사용자 만들기](#creating-a-mimecast-personal-portal-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Mimecast Personal Portal에 만듭니다.
...
3. **Mimecast Personal Portal 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 로그온 URL 및 식별자로 값을 업데이트합니다. 이러한 값을 얻으려면 [Mimecast Personal Portal 클라이언트 지원 팀](https://www.mimecast.com/customer-success/technical-support/)에 문의하세요. 
...
11. **인증 프로필** 섹션에서 다음 단계를 수행합니다.
    ...
    d. **발급자 URL** 텍스트 상자에 Azure Portal에서 복사한 **SAML 엔터티 ID** 값을 붙여넣습니다.
   
    e. Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL** 값을 **로그인 URL** 텍스트 상자에 붙여넣습니다.
...
### <a name="creating-a-mimecast-personal-portal-test-user"></a>Mimecast Personal Portal 테스트 사용자 만들기
...
액세스 패널에서 Mimecast Personal Portal 타일을 클릭하면 Mimecast Personal Portal 응용 프로그램에 자동으로 로그온됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](active-directory-saas-access-panel-introduction.md)를 참조하세요.
