...
4. **Moxtra의 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_05.png) <br>
...
1. 왼쪽의 도구 모음에서 **관리 콘솔 > SAML Single Sign-On**, **새로 만들기**를 차례로 클릭합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_06.png) <br>
...
1. SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가하려면 위쪽 메뉴에서 **특성**을 클릭하여 **SAML 토큰 특성** 대화 상자를 엽니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-moxtra-tutorial/tutorial_general_80.png) <br>
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-moxtra-tutorial/create_aaduser_09.png) <br> 
...
1. 왼쪽의 도구 모음에서 **관리 콘솔 > 사용자 관리**, **사용자 추가**를 차례로 클릭합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_10.png) <br>
