...
12. **페더레이션 ID 공급자 사용자 설정 편집** 페이지에서 다음 작업을 수행하고 **저장**을 클릭합니다.
    ...
    b. **전체 이름**으로 **기타**를 선택하고 **특성 이름** 텍스트 상자에 http://schemas.microsoft.com/identity/claims/displayname 값을 넣습니다.
    
    c. **전자 메일**로 **기타**를 선택하고 **특성 이름** 텍스트 상자에 http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress 값을 넣습니다.
...
### <a name="creating-a-moveit-transfer-test-user"></a>MOVEit Transfer 테스트 사용자 만들기
