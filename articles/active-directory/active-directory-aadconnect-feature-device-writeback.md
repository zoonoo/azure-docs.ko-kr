...
>[AZURE.IMPORTANT]
<li>장치가 사용자와 동일한 포리스트에 있어야 합니다. 장치를 단일 포리스트에 쓰기 저장해야 하기 때문에 이 기능은 현재 사용자 포리스트가 여러 개인 배포를 지원하지 않습니다.</li> <li>온-프레미스 Active Directory 포리스트에는 하나의 장치 등록 구성 개체만 추가할 수 있습니다. 이 기능은 온-프레미스 Active Directory가 여러 Azure AD 디렉터리와 동기화되는 토폴로지와 호환되지 않습니다.</li>
