...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Promapp 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Promapp의 관련 사용자 간에 연결이 형성되어야 합니다.  
...
즉, 필요한 경우 액세스 패널을 사용하여 응용 프로그램에 액세스하는 동안 사용자 계정은 자동으로 만들어집니다.  
