...
* 유효한 Azure 구독
* Cherwell SSO(Single Sign-On)가 설정된 구독
...
## <a name="enable-the-application-integration-for-cherwell"></a>Cherwell에 응용 프로그램 통합 사용
이 섹션은 Cherwell에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

**Cherwell에 응용 프로그램 통합을 사용하도록 설정하려면 다음**
 단계를 수행합니다.
...
3. **앱 URL 구성** 페이지에서 다음 단계를 수행합니다.
  ...
  1. **로그온 URL** 텍스트 상자에서 사용자가 **Cherwell**에 로그인하는 데 사용할 URL을 입력합니다(예: *https://\<company name\>.cherwellondemand.com/cherwellclient*). 
  2.  **다음**을 클릭합니다.
