...
* 유효한 Azure 구독
* ShiftPlanning SSO(Single Sign-On)가 설정된 구독
...
## <a name="enable-the-application-integration-for-shiftplanning"></a>ShiftPlanning에 응용 프로그램 통합 사용
이 섹션은 ShiftPlanning에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

**ShiftPlanning에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.**
...
>[!NOTE]
>다른 ShiftPlanning 사용자 계정 생성 도구 또는 ShiftPlanning이 제공한 API를 사용하여 AAD 사용자 계정을 프로비전할 수 있습니다.
> 
> 
