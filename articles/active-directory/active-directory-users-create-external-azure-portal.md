---
title: "Azure Active Directory 미리 보기의 다른 디렉터리 또는 파트너 회사에서 사용자 추가 | Microsoft Docs"
...
---
# <a name="add-users-from-other-directories-or-partner-companies-in-azure-active-directory-preview"></a>Azure Active Directory 미리 보기의 다른 디렉터리 또는 파트너 회사에서 사용자 추가
...
6. 필요에 따라 **프로필** 을 선택하여 사용자 이름, 성, 직위, 부서 이름을 추가합니다.
    ...
    ![사용자 프로필 열기](./media/active-directory-users-create-external-azure-portal/create-users-user-profile.png)
