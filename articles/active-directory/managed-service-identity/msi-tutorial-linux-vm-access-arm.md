...
ms.locfileid: "33931400"
---
# <a name="use-a-user-assigned-identity-on-a-linux-vm-to-access-azure-resource-manager"></a>Linux VM에서 사용자 할당 ID를 사용하여 Azure Resource Manager에 액세스
