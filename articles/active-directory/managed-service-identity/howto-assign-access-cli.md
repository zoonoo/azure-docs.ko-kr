...
2. 다음 예제에서는 저장소 계정 액세스 권한을 Azure 가상 머신에 부여합니다. 먼저 [az resource list](/cli/azure/resource/#az-resource-list)를 사용하여 "myVM"이라는 가상 머신에 대한 서비스 사용자를 가져옵니다.
...
리소스의 MSI가 사용 가능한 ID 목록에 표시되지 않으면 MSI가 올바르게 사용하도록 설정되었는지 확인하세요. 여기서는 [Azure Portal](https://portal.azure.com)의 Azure 가상 머신 또는 가상 머신 확장 집합으로 돌아가서 다음을 수행할 수 있습니다.
