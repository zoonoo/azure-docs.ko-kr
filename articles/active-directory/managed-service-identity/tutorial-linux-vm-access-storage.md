---
title: Linux VM 관리 ID를 사용하여 Azure Storage에 액세스
description: Linux VM에서 시스템 할당 관리 ID를 사용하여 Azure Storage에 액세스하는 프로세스를 안내하는 자습서입니다.
...
이 자습서에서는 Linux 가상 머신 관리 ID를 활성화하여 Azure Storage에 액세스하는 방법을 알아보았습니다.  Azure Storage에 대한 자세한 내용은 다음을 참조하세요.
