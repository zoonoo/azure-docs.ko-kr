<properties
	pageTitle="자습서: Aravo와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: Aravo와 Azure Active Directory 통합
...
7. 결과 창에서 **Aravo**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다.

	![갤러리에서 앱 선택](./media/active-directory-saas-aravo-tutorial/tutorial_aravo_0001.png)


##  Azure AD Single Sign-on 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Aravo에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.
...
이 섹션에서는 클래식 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 Aravo 응용 프로그램에서 Single Sign-On을 구성합니다.
...
2. **Aravo에 대한 사용자 로그인 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행하고 **다음**을 선택합니다.
    ...
    a. **식별자** 텍스트 상자에 다음 패턴으로 URL을 입력합니다. `https://<company name>.aravo.com`

    b. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다. `https://<company name>.aravo.com/aems/login.do`

	c. **다음**를 클릭합니다.

	> [AZURE.NOTE] 이러한 값은 실제 값이 아닙니다. 실제 식별자 및 회신 URL로 값을 업데이트해야 합니다. 이러한 값을 가져오려면 Aravo에 문의하십시오.
