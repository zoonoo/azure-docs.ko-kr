...
* 사용자가 해당 Azure AD 계정으로 Aravo SSO(Single Sign-on)에 자동으로 로그온되도록 설정할 수 있습니다.
...
이 자습서는 테스트 환경에서 Microsoft Azure AD SSO를 테스트하는 데 도움을 주기 위해 제공되었습니다.
...
## <a name="add-aravo-from-the-gallery"></a>갤러리에서 Aravo 추가
...
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Aravo에서 Microsoft Azure AD SSO를 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

SSO가 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Aravo 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Aravo의 관련 사용자 간에 연결이 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 Aravo의 **Username** 값으로 할당하여 설정합니다.

Aravo에서 Microsoft Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.
...
이 섹션에서는 클래식 포털에서 Microsoft Azure AD SSO를 사용하도록 설정하고 Aravo 응용 프로그램에서 Single Sign-On을 구성합니다.

**Aravo에서 Microsoft Azure AD SSO를 구성하려면 다음 단계를 수행합니다.**
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행하고 **다음**을 클릭합니다.
  ...
  1. **식별자** 텍스트 상자에서 `https://<company name>.aravo.com` 패턴을 사용하여 URL을 입력합니다.
  2. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<company name>.aravo.com/aems/login.do`
  3. **다음**을 클릭합니다.
...
### <a name="create-a-aravo-test-user"></a>Aravo 테스트 사용자 만들기
이 섹션은 Aravo에서 Britta Simon이라는 사용자를 만들기 위한 것입니다. Aravo 계정에 사용자를 추가하려면 Aravo 지원 팀에 문의하세요.

### <a name="assign-the-azure-ad-test-user"></a>Azure AD 테스트 사용자 할당
이 섹션은 Britta Simon에게 Aravo에 대한 액세스 권한을 부여하여 Azure SSO를 사용할 수 있도록 하기 위한 것입니다.
