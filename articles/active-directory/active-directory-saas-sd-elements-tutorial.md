...
이 자습서에서는 SD Elements와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다.  
...
이 연결 관계는 Azure AD의 **사용자 이름** 값을 SD Elements의 **Username** 값으로 할당하여 설정합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. **발급자** 텍스트 상자에서 *https://\<your tenant name\>.sdelements.com/sso/saml2/metadata* 패턴을 사용하여 테넌트의 발급자 URL을 입력합니다.

    b. **회신 URL** 텍스트 상자에서 *https://\<your tenant name\>.sdelements.com/sso/saml2/acs/* 패턴을 사용하여 테넌트의 회신 URL을 입력합니다.       
...
8. 위쪽 메뉴에서 **특성** to open the **SAML Token 특성** 대화 상자를 엽니다. 
   
    ![Single Sign-On 구성][21]
9. 다음 테이블에서 각 행에 대해 다음 단계를 수행합니다.
