...
이 자습서는 Azure AD(Azure Active Directory)에 SD Elements를 통합하는 방법을 보여 주기 위한 것입니다.<br>Azure AD에 SD Elements를 통합하면 다음과 같은 이점을 얻을 수 있습니다.
...
6. 검색 상자에 **SD Elements**를 입력합니다.<br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_01.png)<br>
7. 결과 창에서 **SD Elements**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_02.png)<br>


##  Azure AD Single Sign-on 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 SD Elements에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 SD Elements 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 SD Elements의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 SD Elements의 **Username** 값으로 할당하여 설정합니다.
...
![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_14.png) <br>



**SD Elements에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure 클래식 포털의 **SD Elements** 응용 프로그램 통합 페이지에서 **Single Sign-on 구성**을 클릭하여 **Single Sign-on 구성** 대화 상자를 엽니다. <br><br> ![Single Sign-On 구성][6] <br>

2. **SD Elements에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다. <br><br> ![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_03.png) <br>

3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_04.png) <br>
...
4. **SD Elements에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_05.png) <br>
...
6. 위쪽의 메뉴에서 시스템 및 Single Sign-On을 차례로 클릭합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_09.png) <br>


7. **Single Sign-On 설정** 대화 상자에서 다음 단계를 수행합니다.<br><br>![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_10.png) <br>
...
1. 위쪽 메뉴에서 **특성**을 클릭하여 **SAML 토큰 특성** 대화 상자를 엽니다. <br><br>![Single Sign-On 구성][21]<br>
...
2. 다음 테이블에서 각 행에 대해 다음 단계를 수행합니다.
    ...
    a. **사용자 특성 추가**를 클릭합니다. <br><br>![Single Sign-On 구성][23]<br>

    b. **특성 이름** 텍스트 상자에 **특성 이름**을 입력하고 **특성 값**으로 해당 행에 대해 표시되는 특성 값을 선택합니다. <br><br>![Single Sign-On 구성][22]<br>

    c. **사용자 특성 추가**를 클릭합니다. <br><br>![Single Sign-On 구성][23]<br>

1. **변경 내용 적용**을 클릭합니다. <br><br>![Single Sign-On 구성][24]<br>
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/create_aaduser_09.png) <br>
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/create_aaduser_06.png) <br>
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/create_aaduser_07.png) <br>

8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/create_aaduser_08.png) <br>
...
2.	위쪽 메뉴에서 사용자 관리를 클릭한 다음 사용자를 클릭합니다.
    ...
    ![SD Elements 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_11.png) <br>

3.	새 사용자 추가를 클릭합니다.
 
    ![SD Elements 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_12.png) <br>

4.	새 사용자 추가 대화 상자에서 다음 단계를 수행합니다.

    ![SD Elements 테스트 사용자 만들기](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_13.png) <br>
...
이 섹션은 Britta Simon에게 SD Elements에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하기 위한 것입니다. <br><br>![사용자 할당][200] <br>
...
2. 응용 프로그램 목록에서 **SD Elements**를 선택합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-sd-elements-tutorial/tutorial_sd-elements_50.png) <br>
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다.<br> 액세스 패널에서 SD Elements 타일을 클릭하면 SD Elements 응용 프로그램에 자동으로 로그온됩니다.
