<properties
	pageTitle="자습서: Small Improvements와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: Small Improvements와 Azure Active Directory 통합

이 자습서에서는 Small Improvements와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. Small Improvements를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Small Improvements 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Small Improvements의 관련 사용자 간에 연결이 형성되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Small Improvements의 **Username** 값으로 할당하여 설정합니다.
...
### Small Improvements 테스트 사용자 만들기

이 섹션은 Small Improvements에서 Britta Simon이라는 사용자를 만들기 위한 것입니다. 이미 [Azure AD Single Sign-On 구성](#configuring-azure-ad-single-single-sign-on)에서 사용하도록 설정했습니다.
...
1. **팀 멤버 추가**를 클릭합니다. ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_11.png)

1. 관련된 텍스트 상자에 프로비전할 유효한 사용자의 **이름**, **성** 및 **메일 주소**를 입력합니다. ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_12.png)
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 Small Improvements 타일을 클릭하면 Small Improvements 응용 프로그램에 자동으로 로그온됩니다.
