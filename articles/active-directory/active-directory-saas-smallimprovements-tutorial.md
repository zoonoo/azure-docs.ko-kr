...
Small Improvements에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Small Improvements 응용 프로그램에서 Single Sign-On을 구성합니다.

**Small Improvements에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Small Improvements** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Small Improvements 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Small Improvements 구성** 섹션에서 **Small Improvements 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_configure.png) 

7. 다른 웹 브라우저 창에서 Small Improvements 회사 사이트에 관리자로 로그인합니다.

8. 기본 대시보드 페이지의 왼쪽에서 **관리** 단추를 클릭합니다.
   
    ![Single Sign-On 구성](./media/active-directory-saas-smallimprovements-tutorial/tutorial_smallimprovements_06.png) 

9. **통합** 섹션에서 **SAML SSO** 단추를 클릭합니다.
...
5. **사용자 추가** 대화 상자에서 다음 단계를 수행합니다. 
    ...
    c. 사용자의 **전자 메일**(예: **brittasimon@contoso.com** )을 입력합니다. 
