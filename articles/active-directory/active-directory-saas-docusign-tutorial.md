...
1. **사용자 지정 특성 매핑** 섹션에서 Azure AD 클레임을 사용하여 매핑하려는 필드를 선택합니다. 이 예에서는 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress** 값으로 **emailaddress** 클레임이 매핑됩니다. 이는 Azure Ad의 전자 메일 클레임에 대한 기본 클레임 이름입니다.
