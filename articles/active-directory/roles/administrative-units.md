...
예를 들어 지원하는 지역 내의 사용자만 관리하도록 권한이 제한된 지역 지원 전문가인 [기술 지원팀 관리자](permissions-reference.md#helpdesk-administrator) 역할을 위임할 수 있습니다.
...
- [역할을 만들고, 관리 단위에 추가 또는 제거하고, 정보 채우기](admin-units-manage.md): 전체 방법 절차
...
- [AU 관리](admin-units-manage.md)
- [AU에서 사용자 관리](admin-units-add-manage-users.md)
- [AU에서 그룹 관리](admin-units-add-manage-groups.md)
- [범위가 지정된 역할을 AU에 할당](admin-units-assign-roles.md)
