...
SharePoint Online | [Azure AD 관리자 역할](permissions-reference.md)<br>또한 [Microsoft 365의 SharePoint 관리자 역할에 대 한 정보](/sharepoint/sharepoint-admin-role) | [그래프 API](/graph/api/overview)<br>[역할 할당 가져오기](/graph/api/directoryrole-list)
