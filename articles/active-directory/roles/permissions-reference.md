...
description: Azure Active Directory 기본 제공 역할 및 사용 권한을 설명 합니다.
...
> | [인증 관리자](#authentication-administrator) | 관리자가 아닌 사용자에 대 한 인증 방법 정보를 보고 설정 하 고 다시 설정 하기 위해에 액세스할 수 있습니다. | c4e39bd9-1100-46d3-8c65-fb160da0071f |
> | [인증 정책 관리자](#authentication-policy-administrator) | 는 인증 방법 및 암호 보호 정책의 모든 측면을 만들고 관리할 수 있습니다. | 0526716b-113d-4c15-b2c8-68e3c22b9f80 |
> | [Azure AD 조인 장치 로컬 관리자](#azure-ad-joined-device-local-administrator) | 이 역할에 할당된 사용자는 Azure AD에 조인된 디바이스의 로컬 관리자 그룹에 추가됩니다. | 9f06204d-73c1-4d4c-880a-6edb90606fd8 |
...
> | [B2C IEF 키 세트 관리자](#b2c-ief-keyset-administrator) | IEF (Identity Experience Framework)에서 페더레이션 및 암호화에 대 한 암호를 관리할 수 있습니다. | aaf43236-0c0d-4d5f-883a-6955382ac081 |
> | [B2C IEF 정책 관리자](#b2c-ief-policy-administrator) | IEF (Identity Experience Framework)에서 신뢰 프레임 워크 정책을 만들고 관리할 수 있습니다. | 3edaf663-341e-4475-9f94-5c398ef6c070 |
...
> | [클라우드 디바이스 관리자](#cloud-device-administrator) | Azure AD에서 장치를 관리 하기 위한 제한 된 액세스. | 7698a772-787b-4ac8-901f-60d6b08affd2 |
...
> | [Desktop Analytics 관리자](#desktop-analytics-administrator) | 데스크톱 관리 도구 및 서비스에 액세스 하 고 관리할 수 있습니다. | 38a96431-2bdf-4b4c-8b6e-5d3d8abac1a4 |
> | [디렉터리 읽기 권한자](#directory-readers) | 기본 디렉터리 정보를 읽을 수 있습니다. 일반적으로 응용 프로그램과 게스트에 대 한 디렉터리 읽기 액세스 권한을 부여 하는 데 사용 됩니다. | 88d8e3e3-8f55-4a1e-953a-9b9898b8876b |
...
> | [도메인 이름 관리자](#domain-name-administrator) | 는 클라우드 및 온-프레미스에서 도메인 이름을 관리할 수 있습니다. | 8329153b-31d0-4727-b945-745eb3bc5f31 |
...
> | [하이브리드 ID 관리자](#hybrid-identity-administrator) | Azure AD 클라우드 프로 비전, Azure AD Connect 및 페더레이션 설정에 대 한 AD를 관리할 수 있습니다. | 8ac3fc64-6eca-42ea-9e69-59f4c7b60eb2 |
> | [Insights 관리자](#insights-administrator) | Microsoft 365 Insights 앱에서 관리 권한이 있습니다. | eb1f4a8d-243a-41f0-9fbd-c7cdf6c5ef7c |
> | [Insights 비즈니스 리더](#insights-business-leader) | M365 Insights 앱을 통해 대시보드와 정보를 보고 공유할 수 있습니다. | 31e939ad-9672-4796-9c2e-873181342d2d |
...
> | [기술 관리자](#knowledge-administrator) | 기술 자료, 학습 및 기타 지능형 기능을 구성할 수 있습니다. | b5a8dcf3-09d5-43a9-a639-8e29ef291470 |
> | [라이선스 관리자](#license-administrator) | 사용자 및 그룹의 제품 라이선스를 관리할 수 있습니다. | 4d6ac14f-3453-41d0-bef9-a3e0c569773a |
> | [메시지 센터 개인 정보 읽기 권한자](#message-center-privacy-reader) | Office 365 메시지 센터 에서만 보안 메시지 및 업데이트를 읽을 수 있습니다. | ac16e43d-7b2d-40e0-ac05-243ff356ab5b |
...
> | [Office 앱 관리자](#office-apps-administrator) | 는 정책 및 설정 관리를 비롯 한 Office 앱 클라우드 서비스를 관리할 수 있으며, 최종 사용자의 장치에 ' 새로운 기능 ' 기능 콘텐츠를 선택, 선택 취소 및 게시 하는 기능을 관리할 수 있습니다. | 2b745bdf-0803-4d80-aa65-822c4493daac |
...
> | [암호 관리자](#password-administrator) | 관리자가 아닌 관리자 및 암호 관리자에 대 한 암호를 다시 설정할 수 있습니다. | 966707d0-3269-4727-9be2-8c3a10f19b9d |
...
> | [권한 있는 인증 관리자](#privileged-authentication-administrator) | 모든 사용자 (관리자 또는 비 관리자)에 대 한 인증 방법 정보를 보고 설정 하 고 다시 설정 하기 위해에 액세스할 수 있습니다. | 7be44c8a-adaf-4e2a-84d6-ab2649e08a13 |
> | [권한 있는 역할 관리자](#privileged-role-administrator) | Azure AD의 역할 할당 및 Privileged Identity Management의 모든 측면을 관리할 수 있습니다. | e8611ab8-c189-46e8-94e1-60213ab1f814 |
...
> | 보안 관리자 | 보안 정보 및 보고서를 읽고 Azure AD 및 Office 365에서 구성을 관리할 수 있습니다. | 194ae4cb-b126-40b2-bd5b-6091b380977d |
...
> | [Teams 디바이스 관리자](#teams-devices-administrator) | 팀 인증 장치에서 관리 관련 작업을 수행할 수 있습니다. | 3d762c5a-1b6c-493f-843e-55a3b42923d4 |
> | [사용 요약 보고서 판독기](#usage-summary-reports-reader) | Microsoft 365 사용량 분석과 생산성 점수에서 테 넌 트 수준 집계만 볼 수 있습니다. | 75934031-6c7e-415a-99d7-48dbd49e875e |
...
또한이 역할은 Microsoft Graph 및 Azure AD Graph 모두에 대 한 응용 프로그램 권한을 제외 하 고 위임 된 권한 및 응용 프로그램 권한에 대해 동의 하는 기능을 부여 합니다.

> [!IMPORTANT]
> 이 예외는 _다른_ 앱 (예: 타사 앱 또는 등록 한 앱)에 대 한 응용 프로그램 사용 권한에 여전히 동의할 수 있음을 의미 합니다. 앱 등록의 일부로 이러한 권한을 계속 _요청할_ 수 있지만 이러한 권한을 _부여_ (즉, 동의) 하는 것은 전역 관리자와 같은 권한 있는 관리자가 필요 합니다.
>
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.directory/applications/create | 모든 종류의 응용 프로그램 만들기 |
> | microsoft.directory/applications/delete | 모든 종류의 응용 프로그램을 삭제 합니다. |
> | microsoft.directory/applications/applicationProxy/read | 모든 응용 프로그램 프록시 속성 읽기 |
> | microsoft.directory/applications/applicationProxy/update | 모든 응용 프로그램 프록시 속성 업데이트 |
> | microsoft. directory/응용 프로그램/applicationProxyAuthentication/update | 응용 프로그램 프록시 인증 속성 업데이트 |
> | microsoft. directory/응용 프로그램/applicationProxySslCertificate/업데이트 | 응용 프로그램 프록시 사용자 지정 도메인 업데이트 |
> | microsoft. directory/applications/applicationProxyUrlSettings/update | 응용 프로그램 프록시 내부 및 외부 Url 업데이트 |
> | microsoft. directory/응용 프로그램/a p i/업데이트 | 모든 유형의 응용 프로그램에서 appRoles 속성 업데이트 |
> | microsoft.directory/applications/audience/update | 응용 프로그램의 대상 그룹 속성 업데이트 |
> | microsoft.directory/applications/authentication/update | 모든 유형의 응용 프로그램에 대 한 인증 업데이트 |
> | microsoft.directory/applications/basic/update | 응용 프로그램의 기본 속성 업데이트 |
> | microsoft.directory/applications/credentials/update | 응용 프로그램 자격 증명 업데이트 |
> | microsoft.directory/applications/owners/update | 응용 프로그램의 소유자 업데이트 |
> | microsoft.directory/applications/permissions/update | 모든 유형의 응용 프로그램에 대해 노출 된 권한 및 필요한 권한 업데이트 |
> | microsoft.directory/applications/policies/update | 응용 프로그램 정책 업데이트 |
> | microsoft. 디렉터리/응용 프로그램/확인/업데이트 | Applicationsverification 속성 업데이트 |
> | microsoft.directory/applications/synchronization/standard/read | 애플리케이션 개체와 연결된 프로비저닝 설정 읽기 |
> | microsoft.directory/applicationTemplates/instantiate | 응용 프로그램 템플릿에서 갤러리 응용 프로그램 인스턴스화 |
> | microsoft.directory/auditLogs/allProperties/read | 권한 있는 속성을 포함 하 여 감사 로그의 모든 속성을 읽습니다. |
> | microsoft.directory/connectors/create | 응용 프로그램 프록시 커넥터 만들기 |
> | microsoft. directory/커넥터/allProperties/read | 응용 프로그램 프록시 커넥터의 모든 속성 읽기 |
> | microsoft.directory/connectorGroups/create | 응용 프로그램 프록시 커넥터 그룹 만들기 |
> | microsoft.directory/connectorGroups/delete | 응용 프로그램 프록시 커넥터 그룹 삭제 |
> | microsoft. directory/Congroups/allProperties/read | 응용 프로그램 프록시 커넥터 그룹의 모든 속성 읽기 |
> | microsoft. directory/Congroups/allProperties/update | 응용 프로그램 프록시 커넥터 그룹의 모든 속성 업데이트 |
> | microsoft.directory/oAuth2PermissionGrants/allProperties/allTasks | OAuth 2.0 권한 부여를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/applicationPolicies/create | 응용 프로그램 정책 만들기 |
> | microsoft.directory/applicationPolicies/delete | 응용 프로그램 정책 삭제 |
> | microsoft.directory/applicationPolicies/standard/read | 응용 프로그램 정책의 표준 속성 읽기 |
> | microsoft.directory/applicationPolicies/owners/read | 응용 프로그램 정책에서 소유자 읽기 |
> | microsoft.directory/applicationPolicies/policyAppliedTo/read | 개체 목록에 적용 된 응용 프로그램 정책 읽기 |
> | microsoft.directory/applicationPolicies/basic/update | 응용 프로그램 정책의 표준 속성 업데이트 |
> | microsoft.directory/applicationPolicies/owners/update | 응용 프로그램 정책의 owner 속성 업데이트 |
...
> | microsoft.directory/servicePrincipals/delete | 서비스 사용자 삭제 |
> | microsoft.directory/servicePrincipals/disable | 서비스 사용자 사용 안 함 |
> | microsoft.directory/servicePrincipals/enable | 서비스 주체를 사용하도록 설정 |
> | microsoft.directory/servicePrincipals/getPasswordSingleSignOnCredentials | 서비스 사용자에 대 한 암호 Single Sign-On 자격 증명 관리 |
> | microsoft.directory/servicePrincipals/synchronizationCredentials/manage | 응용 프로그램 프로 비전 비밀 및 자격 증명 관리 |
> | microsoft.directory/servicePrincipals/synchronizationJobs/manage | 응용 프로그램 프로 비전 동기화 작업 시작, 다시 시작 및 일시 중지 |
> | microsoft.directory/servicePrincipals/synchronizationSchema/manage | 응용 프로그램 프로 비전 동기화 작업 및 스키마 만들기 및 관리 |
> | microsoft.directory/servicePrincipals/managePasswordSingleSignOnCredentials | 서비스 사용자에 대 한 암호 Single Sign-On 자격 증명 읽기 |
> | microsoft. directory/servicePrincipals/managePermissionGrantsForAll. microsoft-application-admin | Microsoft Graph 및 Azure AD Graph의 응용 프로그램 권한을 제외한 모든 사용자 또는 모든 사용자를 대신 하 여 응용 프로그램 사용 권한 및 위임 된 권한에 대 한 동의를 부여 합니다. |
> | microsoft.directory/servicePrincipals/appRoleAssignedTo/update | 서비스 사용자 역할 할당 업데이트 |
> | microsoft.directory/servicePrincipals/audience/update | 서비스 사용자의 대상 속성 업데이트 |
> | microsoft.directory/servicePrincipals/authentication/update | 서비스 사용자에 대 한 인증 속성 업데이트 |
> | microsoft.directory/servicePrincipals/basic/update | 서비스 사용자의 기본 속성 업데이트 |
> | microsoft.directory/servicePrincipals/credentials/update | 서비스 사용자의 자격 증명 업데이트 |
> | microsoft.directory/servicePrincipals/owners/update | 서비스 사용자의 소유자 업데이트 |
> | microsoft.directory/servicePrincipals/permissions/update | 서비스 사용자의 사용 권한 업데이트 |
> | microsoft.directory/servicePrincipals/policies/update | 서비스 사용자의 정책 업데이트 |
> | microsoft.directory/servicePrincipals/tag/update | 서비스 사용자에 대 한 tag 속성 업데이트 |
> | microsoft.directory/servicePrincipals/synchronization/standard/read | 서비스 주체와 연결된 프로비저닝 설정 읽기 |
> | microsoft.directory/signInReports/allProperties/read | 권한 있는 속성을 포함 하 여 로그인 보고서의 모든 속성을 읽습니다. |
...
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.directory/applications/createAsOwner | 모든 종류의 응용 프로그램을 만들고 작성자가 첫 번째 소유자로 추가 됩니다. |
> | microsoft.directory/appRoleAssignments/createAsOwner | 첫 번째 소유자로 생성자를 사용 하 여 응용 프로그램 역할 할당 만들기 |
> | microsoft.directory/oAuth2PermissionGrants/createAsOwner | 첫 번째 소유자로 만든이를 사용 하 여 OAuth 2.0 권한 부여를 만듭니다. |
> | microsoft.directory/servicePrincipals/createAsOwner | 첫 번째 소유자로 생성자를 사용 하 여 서비스 사용자 만들기 |
...
> | 동작 | Description |
> | --- | --- |
> | protectionCenter/attackSimulator/office365/allProperties/Allproperties | 공격 시뮬레이터에서 공격 페이로드 만들기 및 관리 |
> | protectionCenter/attackSimulator/office365/allProperties/read | 공격 시뮬레이션, 응답 및 관련 교육에 대 한 보고서 읽기 |
...
> | protectionCenter/attackSimulator/office365/allProperties/Allproperties | 공격 시뮬레이터에서 공격 페이로드 만들기 및 관리 |
> | protectionCenter/attackSimulator/office365/allProperties/read | 공격 시뮬레이션, 응답 및 관련 교육에 대 한 보고서 읽기 |
> | office365. protectionCenter/attackSimulator/시뮬레이션/allProperties/Allproperties | 공격 시뮬레이터에서 공격 시뮬레이션 템플릿 만들기 및 관리 |

## <a name="authentication-administrator"></a>인증 관리자

이 역할을 가진 사용자는 관리자가 아닌 사용자 및 일부 역할에 대해 인증 방법 (암호 포함)을 설정 하거나 다시 설정할 수 있습니다. 인증 관리자는 관리자가 아닌 사용자 또는 일부 역할이 할당된 사용자가 기존의 비암호 자격 증명(예: MFA 또는 FIDO)을 재등록하도록 요구할 수 있으며, 다음에 로그인할 때 MFA를 요청하도록 **디바이스에 MFA 저장** 을 철회할 수도 있습니다. 인증 관리자가 인증 방법을 읽거나 업데이트할 수 있는 역할 목록은 [암호 재설정 권한](#password-reset-permissions)을 참조 하세요.
...
> [!IMPORTANT]
> 이 역할은 현재 레거시 MFA 관리 포털에서 사용자 단위 MFA를 관리할 수 없습니다. [Set-msoluser](/powershell/module/msonline/set-msoluser) 이상 Azure AD Powershell 모듈을 사용 하 여 동일한 기능을 수행할 수 있습니다.

> [!div class="mx-tableFixed"]
> | 동작 | Description |
> | --- | --- |
> | microsoft.directory/users/invalidateAllRefreshTokens | 사용자 새로 고침 토큰을 무효화 하 여 강제로 로그 아웃 |
> | microsoft.directory/users/strongAuthentication/update | 사용자에 대 한 강력한 인증 속성 업데이트 |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/조직/strongAuthentication/업데이트 | 조직의 강력한 auth 속성 업데이트 |
> | microsoft. directory/userCredentialPolicies/만들기 | 사용자에 대 한 자격 증명 정책 만들기 |
> | microsoft. directory/userCredentialPolicies/삭제 | 사용자에 대 한 자격 증명 정책 삭제 |
> | microsoft. directory/userCredentialPolicies/표준/읽기 | 사용자에 대 한 자격 증명 정책의 표준 속성을 읽습니다. |
> | microsoft. directory/userCredentialPolicies/소유자/읽기 | 사용자에 대 한 자격 증명 정책의 소유자 읽기 |
> | microsoft. directory/userCredentialPolicies/policyAppliedTo/read | 정책 읽기. appliesTo 탐색 링크 |
> | microsoft. directory/userCredentialPolicies/기본/업데이트 | 사용자에 대 한 기본 정책 업데이트 |
> | microsoft. directory/userCredentialPolicies/소유자/업데이트 | 사용자에 대 한 자격 증명 정책의 소유자 업데이트 |
> | microsoft. directory/userCredentialPolicies/tenantDefault/update | IsOrganizationDefault 속성을 업데이트 합니다. |

## <a name="azure-ad-joined-device-local-administrator"></a>Azure AD 조인 장치 로컬 관리자
...
> | microsoft. directory/groupSettingTemplates/standard/read | 그룹 설정 템플릿에 대 한 기본 속성 읽기 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/b2cTrustFrameworkKeySet/allProperties/Allproperties | 권한 부여 정책의 모든 속성을 읽고 업데이트 합니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/b2cTrustFrameworkPolicy/allProperties/Allproperties | Azure Active Directory B2C에서 키 집합 읽기 및 구성 |
...
> | --- | --- |
> | microsoft.directory/auditLogs/allProperties/read | 권한 있는 속성을 포함 하 여 감사 로그의 모든 속성을 읽습니다. |
> | microsoft. directory/bitlockerKeys/키/읽기 | 장치의 bitlocker 메타 데이터 및 키 읽기 |
> | microsoft.directory/devices/delete | Azure AD에서 장치 삭제 |
> | microsoft.directory/devices/disable | Azure AD에서 장치 사용 안 함 |
> | microsoft.directory/devices/enable | Azure AD에서 장치 사용 |
> | microsoft. directory/devices/extensionAttributes/update | 장치에 대 한 모든 값 업데이트 extensionAttributes 속성 |
> | microsoft. directory/deviceManagementPolicies/standard/read | 장치 관리 응용 프로그램 정책에서 표준 속성을 읽습니다. |
> | microsoft. directory/deviceManagementPolicies/basic/update | 장치 관리 응용 프로그램 정책에 대 한 기본 속성 업데이트 |
> | microsoft. directory/deviceRegistrationPolicy/standard/read | 장치 등록 정책의 표준 속성 읽기 |
> | microsoft. directory/deviceRegistrationPolicy/basic/update | 장치 등록 정책에 대 한 기본 속성 업데이트 |
> | microsoft.directory/signInReports/allProperties/read | 권한 있는 속성을 포함 하 여 로그인 보고서의 모든 속성을 읽습니다. |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
...
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft. directory/entitlementManagement/allProperties/read | Azure AD 자격 관리의 모든 속성 읽기 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/cloudAppSecurity/allProperties/Allproperties | 모든 리소스를 만들고 삭제 하 고, Microsoft Cloud App Security에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.azure.informationProtection/allEntities/allTasks | Azure Information Protection의 모든 측면 관리 |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft.office365.complianceManager/allEntities/allTasks | Office 365 준수 관리자의 모든 측면을 관리합니다. |
...
> | microsoft. directory/conditionalAccessPolicies/standard/read | ConditionalAccess 속성을 읽습니다. |
> | microsoft. directory/conditionalAccessPolicies/소유자/읽기 | ConditionalAccess 속성을 읽습니다. |
> | microsoft. directory/conditionalAccessPolicies/policyAppliedTo/read | ConditionalAccess 속성을 읽습니다. |
> | microsoft. directory/conditionalAccessPolicies/basic/update | 조건부 액세스 정책에 대 한 기본 속성 업데이트 |
> | microsoft. directory/conditionalAccessPolicies/소유자/업데이트 | ConditionalAccess 속성을 업데이트 합니다. |
> | microsoft. directory/conditionalAccessPolicies/tenantDefault/update | ConditionalAccess 속성을 업데이트 합니다. |
> | microsoft. directory/crossTenantAccessPolicies/create | 테 넌 트 간 액세스 정책 만들기 |
> | microsoft. directory/crossTenantAccessPolicies/delete | 교차 테 넌 트 액세스 정책 삭제 |
> | microsoft. directory/crossTenantAccessPolicies/standard/read | 테 넌 트 간 액세스 정책의 기본 속성 읽기 |
> | microsoft. directory/crossTenantAccessPolicies/소유자/읽기 | 교차 테 넌 트 액세스 정책의 소유자 읽기 |
> | microsoft. directory/crossTenantAccessPolicies/policyAppliedTo/read | 테 넌 트 간 액세스 정책의 policyAppliedTo 속성을 읽습니다. |
> | microsoft. directory/crossTenantAccessPolicies/basic/update | 교차 테 넌 트 액세스 정책의 기본 속성 업데이트 |
> | microsoft. directory/crossTenantAccessPolicies/소유자/업데이트 | 교차 테 넌 트 액세스 정책의 소유자 업데이트 |
> | microsoft. directory/crossTenantAccessPolicies/tenantDefault/update | 테 넌 트 간 액세스 정책에 대 한 기본 테 넌 트 업데이트 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/administrativeUnits/standard/read | 관리 단위에 대 한 기본 속성 읽기 |
> | microsoft.directory/administrativeUnits/members/read | 관리 단위의 구성원 읽기 |
> | microsoft. 디렉터리/응용 프로그램/표준/읽기 | 응용 프로그램의 표준 속성 읽기 |
> | microsoft.directory/applications/owners/read | 응용 프로그램의 소유자 읽기 |
> | microsoft.directory/applications/policies/read | 응용 프로그램 정책 읽기 |
> | microsoft. directory/연락처/표준/읽기 | Azure AD의 연락처에 대 한 기본 속성 읽기 |
> | microsoft.directory/contacts/memberOf/read | Azure AD의 모든 연락처에 대 한 그룹 멤버 자격 읽기 |
> | microsoft. directory/계약/표준/읽기 | 파트너 계약의 기본 속성 읽기 |
> | microsoft. directory/장치/표준/읽기 | 장치의 기본 속성 읽기 |
> | microsoft.directory/devices/memberOf/read | 장치 구성원 자격 읽기 |
> | microsoft.directory/devices/registeredOwners/read | 등록 된 장치의 등록 된 소유자 읽기 |
> | microsoft.directory/devices/registeredUsers/read | 등록 된 장치의 등록 된 사용자를 읽습니다. |
...
> | microsoft. 디렉터리/도메인/표준/읽기 | 도메인의 기본 속성 읽기 |
> | microsoft. directory/groups/standard/read | 그룹의 기본 속성 읽기 |
> | microsoft.directory/groups/appRoleAssignments/read | 그룹의 응용 프로그램 역할 할당 읽기 |
...
> | microsoft.directory/groups/owners/read | 그룹 소유자 읽기 |
...
> | microsoft. directory/조직/표준/읽기 | 조직의 기본 속성 읽기 |
> | microsoft.directory/organization/trustedCAsForPasswordlessAuth/read | 암호 없는 인증에 대 한 신뢰할 수 있는 인증 기관 읽기 |
> | microsoft.directory/applicationPolicies/standard/read | 응용 프로그램 정책의 표준 속성 읽기 |
> | microsoft. directory/roleAssignments/standard/read | 역할 할당에 대 한 기본 속성 읽기 |
> | microsoft. directory/roleDefinitions/표준/읽기 | 역할 정의에 대 한 기본 속성 읽기 |
> | microsoft.directory/servicePrincipals/appRoleAssignedTo/read | 서비스 사용자 역할 할당 읽기 |
> | microsoft.directory/servicePrincipals/appRoleAssignments/read | 서비스 사용자에 게 할당 된 역할 할당 읽기 |
> | microsoft.directory/servicePrincipals/standard/read | 서비스 사용자의 기본 속성 읽기 |
> | microsoft.directory/servicePrincipals/memberOf/read | 서비스 사용자의 그룹 멤버 자격 읽기 |
> | microsoft.directory/servicePrincipals/oAuth2PermissionGrants/read | 서비스 사용자에 대 한 위임 된 권한 부여 읽기 |
> | microsoft.directory/servicePrincipals/owners/read | 서비스 사용자의 소유자 읽기 |
> | microsoft.directory/servicePrincipals/ownedObjects/read | 서비스 사용자의 소유 개체 읽기 |
> | microsoft.directory/servicePrincipals/policies/read | 서비스 사용자의 정책 읽기 |
> | microsoft. directory/subscribedSkus/standard/read | 구독에 대 한 기본 속성 읽기 |
> | microsoft. directory/users/standard/read | 사용자의 기본 속성 읽기 |
> | microsoft.directory/users/appRoleAssignments/read | 사용자의 응용 프로그램 역할 할당 읽기 |
> | microsoft.directory/users/directReports/read | 사용자에 대 한 직접 보고서 읽기 |
> | microsoft.directory/users/manager/read | 사용자 관리자 읽기 |
> | microsoft.directory/users/memberOf/read | 사용자의 그룹 멤버 자격 읽기 |
> | microsoft. directory/users/oAuth2PermissionGrants/read | 사용자에 게 위임 된 권한 부여 읽기 |
> | microsoft.directory/users/ownedDevices/read | 소유 된 사용자 장치 읽기 |
> | microsoft.directory/users/ownedObjects/read | 소유 된 사용자 개체 읽기 |
> | microsoft.directory/users/registeredDevices/read | 등록 된 사용자 장치를 읽습니다. |
...
> | microsoft. directory/정책/policyAppliedTo/읽기 | PolicyAppliedTo 속성을 읽습니다. |
> | microsoft.directory/policies/basic/update | 정책에 대 한 기본 속성 업데이트 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. 디렉터리/그룹/할당 라이선스 | 그룹 기반 라이선스 그룹에 제품 라이선스 할당 |
> | microsoft.directory/groups/create | 역할 할당 가능 그룹을 제외한 그룹 만들기 |
> | microsoft. directory/groups/reprocessLicenseAssignment | 그룹 기반 라이선스에 대 한 라이선스 할당 다시 처리 |
> | microsoft.directory/groups/basic/update | 역할 할당 가능 그룹을 제외 하 고 그룹의 기본 속성 업데이트 |
> | microsoft. 디렉터리/그룹/분류/업데이트 | 역할 할당 가능 그룹을 제외 하 고 그룹의 분류 속성 업데이트 |
> | microsoft. directory/groups/dynamicMembershipRule/update | 역할 할당 가능 그룹을 제외 하 고 그룹의 동적 멤버 자격 규칙 업데이트 |
> | microsoft. directory/groups/groupType/update | 그룹에 대 한 groupType 속성 업데이트 |
> | microsoft.directory/groups/members/update | 역할 할당 가능 그룹을 제외 하 고 그룹의 구성원 업데이트 |
> | microsoft. directory/groups/onPremWriteBack/update | 온-프레미스에 다시 쓸 수 있도록 Azure AD 그룹 업데이트 |
> | microsoft.directory/groups/owners/update | 역할 할당 가능 그룹을 제외한 그룹의 소유자 업데이트 |
> | microsoft.directory/groups/settings/update | 그룹의 설정 업데이트 |
...
> | microsoft.directory/servicePrincipals/synchronizationJobs/manage | 응용 프로그램 프로 비전 동기화 작업 시작, 다시 시작 및 일시 중지 |
> | microsoft.directory/servicePrincipals/synchronizationSchema/manage | 응용 프로그램 프로 비전 동기화 작업 및 스키마 만들기 및 관리 |
> | microsoft. directory/servicePrincipals/managePermissionGrantsForGroup. microsoft-all-application-permissions | 그룹 데이터에 대 한 직접 액세스를 서비스 대 한 주체의에 부여 |
> | microsoft.directory/servicePrincipals/appRoleAssignedTo/update | 서비스 사용자 역할 할당 업데이트 |
...
> | microsoft.directory/users/invalidateAllRefreshTokens | 사용자 새로 고침 토큰을 무효화 하 여 강제로 로그 아웃 |
> | microsoft. directory/users/reprocessLicenseAssignment | 사용자에 대 한 라이선스 할당 다시 처리 |
> | microsoft.directory/users/basic/update | 사용자의 기본 속성 업데이트 |
> | microsoft.directory/users/manager/update | 사용자 용 업데이트 관리자 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.directory/domains/allProperties/allTasks | 도메인을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
...
> | microsoft. directory/groups. 통합/만들기 | 역할 할당 가능 그룹을 제외 하 고 Microsoft 365 그룹 만들기 |
> | microsoft. directory/groups. 통합/삭제 | 역할 할당 가능 그룹을 제외 하 고 Microsoft 365 그룹을 삭제 합니다. |
> | microsoft. directory/groups. 통합/복원 | Microsoft 365 그룹 복원 |
> | microsoft. directory/groups. 통합/기본/업데이트 | 역할 할당 가능 그룹을 제외 하 고 Microsoft 365 그룹의 기본 속성 업데이트 |
> | microsoft. directory/groups. 통합/멤버/업데이트 | 역할 할당 가능 그룹을 제외 하 고 Microsoft 365 그룹의 구성원 업데이트 |
> | microsoft. directory/groups. 통합/소유자/업데이트 | 역할 할당 가능 그룹을 제외 하 고 Microsoft 365 그룹의 소유자를 업데이트 합니다. |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | office365/allEntities/기본/Allentities | Exchange Online의 모든 측면 관리 |
> | microsoft.office365.network/performance/allProperties/read | Microsoft 365 관리 센터에서 모든 네트워크 성능 속성을 읽습니다. |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | office365/allEntities/Allentities/read | Office 365 사용 보고서 읽기 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/b2cUserFlow/allProperties/Allproperties | Azure Active Directory B2C에서 사용자 특성을 읽고 구성 합니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/b2cUserAttribute/allProperties/Allproperties | Azure Active Directory B2C에서 사용자 지정 정책 읽기 및 구성 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/identityProviders/allProperties/Allproperties | Azure Active Directory B2C에서 id 공급자를 읽고 구성 합니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/accessReviews/allProperties/Allproperties | Azure AD에서 액세스 검토를 만들고 삭제 하 고 액세스 검토의 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/administrativeUnits/allProperties/allTasks | 관리 단위(구성원 포함)를 만들고 관리합니다. |
> | microsoft.directory/applications/allProperties/allTasks | 응용 프로그램을 만들고 삭제 하며, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/applications/synchronization/standard/read | 애플리케이션 개체와 연결된 프로비저닝 설정 읽기 |
> | microsoft.directory/applicationTemplates/instantiate | 응용 프로그램 템플릿에서 갤러리 응용 프로그램 인스턴스화 |
> | microsoft.directory/appRoleAssignments/allProperties/allTasks | AppRoleAssignments를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/auditLogs/allProperties/read | 권한 있는 속성을 포함 하 여 감사 로그의 모든 속성을 읽습니다. |
> | microsoft. directory/authorizationPolicy/allProperties/Allproperties | 권한 부여 정책의 모든 측면 관리 |
> | microsoft. directory/bitlockerKeys/키/읽기 | 장치의 bitlocker 메타 데이터 및 키 읽기 |
> | microsoft. directory/cloudAppSecurity/allProperties/Allproperties | 모든 리소스를 만들고 삭제 하 고, Microsoft Cloud App Security에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/connectors/create | 응용 프로그램 프록시 커넥터 만들기 |
> | microsoft. directory/커넥터/allProperties/read | 응용 프로그램 프록시 커넥터의 모든 속성 읽기 |
...
> | microsoft. directory/Congroups/allProperties/read | 응용 프로그램 프록시 커넥터 그룹의 모든 속성 읽기 |
> | microsoft. directory/Congroups/allProperties/update | 응용 프로그램 프록시 커넥터 그룹의 모든 속성 업데이트 |
> | microsoft.directory/contacts/allProperties/allTasks | 연락처를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/contracts/allProperties/allTasks | 파트너 계약을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/devices/allProperties/allTasks | 장치를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft. directory/deviceManagementPolicies/standard/read | 장치 관리 응용 프로그램 정책에서 표준 속성을 읽습니다. |
> | microsoft. directory/deviceManagementPolicies/basic/update | 장치 관리 응용 프로그램 정책에 대 한 기본 속성 업데이트 |
> | microsoft. directory/deviceRegistrationPolicy/standard/read | 장치 등록 정책의 표준 속성 읽기 |
> | microsoft. directory/deviceRegistrationPolicy/basic/update | 장치 등록 정책에 대 한 기본 속성 업데이트 |
> | microsoft.directory/directoryRoles/allProperties/allTasks | 디렉터리 역할을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/directoryRoleTemplates/allProperties/allTasks | Azure AD 역할 템플릿을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/domains/allProperties/allTasks | 도메인을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
...
> | microsoft.directory/groupSettings/allProperties/allTasks | 그룹 설정을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/groupSettingTemplates/allProperties/allTasks | 그룹 설정 템플릿을 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft. directory/identityProtection/allProperties/Allproperties | 모든 리소스를 만들고 삭제 하 고, Azure AD ID 보호에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft. directory/loginOrganizationBranding/allProperties/Allproperties | LoginTenantBranding 만들기 및 삭제, 모든 속성 읽기 및 업데이트 |
> | microsoft.directory/oAuth2PermissionGrants/allProperties/allTasks | OAuth 2.0 권한 부여를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/organization/allProperties/allTasks | 조직을 만들고 삭제 하며, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/policies/allProperties/allTasks | 정책을 만들고 삭제 하며, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft. directory/conditionalAccessPolicies/allProperties/Allproperties | 조건부 액세스 정책의 모든 속성 관리 |
> | microsoft. directory/privilegedIdentityManagement/allProperties/read | Privileged Identity Management의 모든 리소스 읽기 |
> | microsoft.directory/provisioningLogs/allProperties/read | 프로비저닝 로그의 모든 속성을 읽습니다. |
...
> | microsoft.directory/serviceAction/activateService | 서비스에 대해 "서비스 활성화" 작업을 수행할 수 있습니다. |
> | microsoft.directory/serviceAction/disableDirectoryFeature | "디렉터리 기능 사용 안 함" 서비스 작업을 수행할 수 있습니다. |
> | microsoft.directory/serviceAction/enableDirectoryFeature | "디렉터리 기능 사용" 서비스 작업을 수행할 수 있습니다. |
> | microsoft.directory/serviceAction/getAvailableExtentionProperties | Get사용할 수 있는 Extneonproperties 서비스 작업을 수행할 수 있습니다. |
> | microsoft.directory/servicePrincipals/allProperties/allTasks | 서비스 사용자 만들기 및 삭제, 모든 속성 읽기 및 업데이트 |
> | microsoft. directory/servicePrincipals/managePermissionGrantsForAll. microsoft-company-admin | 모든 응용 프로그램에 대 한 모든 사용 권한 부여 |
> | microsoft. directory/servicePrincipals/managePermissionGrantsForGroup. microsoft-all-application-permissions | 그룹 데이터에 대 한 직접 액세스를 서비스 대 한 주체의에 부여 |
> | microsoft.directory/servicePrincipals/synchronization/standard/read | 서비스 주체와 연결된 프로비저닝 설정 읽기 |
> | microsoft.directory/signInReports/allProperties/read | 권한 있는 속성을 포함 하 여 로그인 보고서의 모든 속성을 읽습니다. |
> | microsoft.directory/subscribedSkus/allProperties/allTasks | 구독 구입 및 관리 및 구독 삭제 |
...
> | microsoft. directory/servicePrincipalCreationPolicies/delete | 서비스 사용자 만들기 정책 삭제 |
> | microsoft. directory/servicePrincipalCreationPolicies/standard/read | 서비스 사용자 만들기 정책의 표준 속성 읽기 |
> | microsoft. directory/servicePrincipalCreationPolicies/basic/update | 서비스 사용자 만들기 정책의 기본 속성 업데이트 |
> | advancedThreatProtection/allEntities/Allentities | Azure Advanced Threat Protection의 모든 측면 관리 |
> | microsoft.azure.informationProtection/allEntities/allTasks | Azure Information Protection의 모든 측면 관리 |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft.commerce.billing/allEntities/allTasks | Office 365 청구의 모든 측면 관리 |
> | microsoft.dynamics365/allEntities/allTasks | Dynamics 365의 모든 측면 관리 |
> | microsoft.flow/allEntities/allTasks | Microsoft Power 자동화의 모든 측면 관리 |
> | microsoft.intune/allEntities/allTasks | Microsoft Intune의 모든 측면 관리 |
> | microsoft.office365.complianceManager/allEntities/allTasks | Office 365 준수 관리자의 모든 측면을 관리합니다. |
> | microsoft.office365.desktopAnalytics/allEntities/allTasks | 데스크톱 분석의 모든 측면 관리 |
> | office365/allEntities/기본/Allentities | Exchange Online의 모든 측면 관리 |
> | microsoft.office365.lockbox/allEntities/allTasks | 고객 Lockbox의 모든 측면 관리 |
> | microsoft.office365.messageCenter/messages/read | 보안 메시지를 제외 하 고 Microsoft 365 관리 센터의 메시지 센터에서 메시지를 읽습니다. |
> | microsoft.office365.messageCenter/securityMessages/read | Microsoft 365 관리 센터의 메시지 센터에서 보안 메시지를 읽습니다. |
> | microsoft.office365.network/performance/allProperties/read | Microsoft 365 관리 센터에서 모든 네트워크 성능 속성을 읽습니다. |
> | office365. protectionCenter/allEntities/Allentities/Allentities | 보안 및 규정 준수 센터의 모든 측면 관리 |
> | office365/내용/관리 | Microsoft Search에서 콘텐츠를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.securityComplianceCenter/allEntities/allTasks | 모든 리소스를 만들고 삭제 하며 Microsoft 365 보안 및 규정 준수 센터에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | office365/allEntities/Allentities | SharePoint에서 모든 리소스를 만들고 삭제 하 고 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.skypeForBusiness/allEntities/allTasks | 비즈니스용 Skype Online의 모든 측면을 관리 합니다. |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | office365/allEntities/Allentities/read | Office 365 사용 보고서 읽기 |
> | microsoft.office365.userCommunication/allEntities/allTasks | 새 메시지 표시 유형을 읽고 업데이트 합니다. |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | defenderAdvancedThreatProtection/allEntities/Allentities | Microsoft Defender for Endpoint의 모든 측면 관리 |
...
> | microsoft. directory/conditionalAccessPolicies/policyAppliedTo/read | ConditionalAccess 속성을 읽습니다. |
> | microsoft.directory/provisioningLogs/allProperties/read | 프로비저닝 로그의 모든 속성을 읽습니다. |
> | microsoft.directory/servicePrincipals/authentication/read | 서비스 사용자에 대 한 인증 속성 읽기 |
> | microsoft.directory/servicePrincipals/synchronization/standard/read | 서비스 주체와 연결된 프로비저닝 설정 읽기 |
> | microsoft.directory/signInReports/allProperties/read | 권한 있는 속성을 포함 하 여 로그인 보고서의 모든 속성을 읽습니다. |
> | microsoft.directory/users/strongAuthentication/read | 사용자에 대 한 강력한 인증 속성 읽기 |
> | microsoft.commerce.billing/allEntities/read | Office 365 청구의 모든 리소스 읽기 |
> | office365/allEntities/표준/읽기 | Exchange Online의 모든 리소스 읽기 |
> | microsoft.office365.messageCenter/messages/read | 보안 메시지를 제외 하 고 Microsoft 365 관리 센터의 메시지 센터에서 메시지를 읽습니다. |
> | microsoft.office365.messageCenter/securityMessages/read | Microsoft 365 관리 센터의 메시지 센터에서 보안 메시지를 읽습니다. |
> | microsoft.office365.network/performance/allProperties/read | Microsoft 365 관리 센터에서 모든 네트워크 성능 속성을 읽습니다. |
> | office365. protectionCenter/allEntities/Allentities/read | 보안 및 규정 준수 센터의 모든 속성 읽기 |
...
> | microsoft. directory/bitlockerKeys/키/읽기 | 장치의 bitlocker 메타 데이터 및 키 읽기 |
> | microsoft.directory/users/invalidateAllRefreshTokens | 사용자 새로 고침 토큰을 무효화 하 여 강제로 로그 아웃 |
> | microsoft.directory/users/password/update | 모든 사용자에 대 한 암호 다시 설정 |
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
...
이 역할의 사용자는 클라우드 프로 비전을 사용 하 고 Azure AD Connect 및 페더레이션 설정을 관리 하 여 AD에서 Azure AD로의 프로 비전 구성 설정을 만들고 관리 하 고 배포할 수 있습니다. 또한 사용자는이 역할을 사용 하 여 로그 문제를 해결 하 고 모니터링할 수 있습니다.
...
> | microsoft. 디렉터리/도메인/페더레이션/업데이트 | 도메인의 페더레이션 속성 업데이트 |
> | microsoft.directory/organization/dirSync/update | 조직 디렉터리 동기화 속성 업데이트 |
> | microsoft.directory/provisioningLogs/allProperties/read | 프로비저닝 로그의 모든 속성을 읽습니다. |
> | microsoft.directory/servicePrincipals/create | 서비스 주체 만들기 |
> | microsoft.directory/servicePrincipals/delete | 서비스 사용자 삭제 |
...
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft insights/allEntities/Allentities | Insights 앱의 모든 측면 관리 |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | microsoft insights/프로그램/업데이트 | Insights 앱에서 프로그램 배포 및 관리 |
...
> | microsoft.directory/contacts/basic/update | 연락처에 대 한 기본 속성 업데이트 |
> | microsoft.directory/devices/create | 장치 만들기 (Azure AD에 등록) |
> | microsoft.directory/devices/delete | Azure AD에서 장치 삭제 |
> | microsoft.directory/devices/disable | Azure AD에서 장치 사용 안 함 |
> | microsoft.directory/devices/enable | Azure AD에서 장치 사용 |
> | microsoft.directory/devices/basic/update | 장치에서 기본 속성 업데이트 |
> | microsoft. directory/devices/extensionAttributes/update | 장치에 대 한 모든 값 업데이트 extensionAttributes 속성 |
> | microsoft.directory/devices/registeredOwners/update | 등록 된 장치의 등록 된 소유자 업데이트 |
> | microsoft.directory/devices/registeredUsers/update | 등록 된 장치의 등록 된 사용자 업데이트 |
> | microsoft. directory/deviceManagementPolicies/standard/read | 장치 관리 응용 프로그램 정책에서 표준 속성을 읽습니다. |
> | microsoft. directory/deviceRegistrationPolicy/standard/read | 장치 등록 정책의 표준 속성 읽기 |
> | microsoft.directory/groups/hiddenMembers/read | 그룹의 숨겨진 구성원 읽기 |
> | microsoft. directory/groups. 보안/만들기 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹 만들기 |
> | microsoft. directory/groups. 보안/삭제 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹 삭제 |
> | microsoft. directory/groups. security/basic/update | 역할 할당 가능 그룹을 제외 하 고 보안 그룹의 기본 속성을 업데이트 합니다. |
...
> | microsoft. directory/groups. 보안/멤버/업데이트 | 역할 할당 가능 그룹 제외를 사용 하 여 보안 그룹의 구성원 업데이트 |
> | microsoft. directory/groups. 보안/소유자/업데이트 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹의 소유자를 업데이트 합니다. |
...
## <a name="knowledge-administrator"></a>기술 관리자

이 역할의 사용자는 Microsoft 365 관리 센터의 모든 기술 자료, 학습 및 인텔리전트 기능 설정에 대 한 모든 권한을 갖습니다. 제품 모음에 대 한 일반적인 이해를 담당 하며, 라이선스 정보를 통해 액세스를 제어 해야 합니다. 기술 관리자는 토픽, 머리글자어 및 학습 리소스와 같은 콘텐츠를 만들고 관리할 수 있습니다. 또한 이러한 사용자는 콘텐츠 센터를 만들고, 서비스 상태를 모니터링 하 고, 서비스 요청을 만들 수 있습니다.

> [!div class="mx-tableFixed"]
> | 동작 | Description |
> | --- | --- |
> | microsoft. directory/groups. 보안/만들기 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹 만들기 |
> | microsoft. directory/groups. security/createAsOwner | 역할 할당 가능 그룹 및 작성자를 제외 하 고 보안 그룹 만들기가 첫 번째 소유자로 추가 됩니다. |
> | microsoft. directory/groups. 보안/삭제 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹 삭제 |
> | microsoft. directory/groups. security/basic/update | 역할 할당 가능 그룹을 제외 하 고 보안 그룹의 기본 속성을 업데이트 합니다. |
> | microsoft. directory/groups. 보안/멤버/업데이트 | 역할 할당 가능 그룹 제외를 사용 하 여 보안 그룹의 구성원 업데이트 |
> | microsoft. directory/groups. 보안/소유자/업데이트 | 역할 할당 가능 그룹을 제외 하 고 보안 그룹의 소유자를 업데이트 합니다. |
> | office365/contentUnderstanding/allProperties/Allproperties | Microsoft 365 관리 센터에서 콘텐츠 이해의 모든 속성을 읽고 업데이트 합니다. |
> | office365/knowledgeNetwork/allProperties/Allproperties | Microsoft 365 관리 센터에서 기술 네트워크의 모든 속성을 읽고 업데이트 합니다. |
> | office365 protectionCenter/sensitivityLabels/allProperties/read | 보안 및 규정 준수 센터의 민감도 레이블 읽기 |
> | office365/allEntities/Allentities | SharePoint에서 모든 리소스를 만들고 삭제 하 고 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | microsoft.office365.webPortal/allEntities/basic/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> [!IMPORTANT]
> 이 역할은 관리자가 아닌 경우에만 암호를 다시 설정 하 고 새로 고침 토큰을 무효화할 수 있습니다. 이 역할은 사용 되지 않으므로 API에서 더 이상 반환 되지 않으므로 사용 하면 안 됩니다.
...
> | microsoft. 디렉터리/사용자/사용 | 사용자 사용 |
> | microsoft.directory/users/invalidateAllRefreshTokens | 사용자 새로 고침 토큰을 무효화 하 여 강제로 로그 아웃 |
> | microsoft.directory/users/restore | 삭제 된 사용자 복원 |
> | microsoft.directory/users/basic/update | 사용자의 기본 속성 업데이트 |
> | microsoft.directory/users/manager/update | 사용자 용 업데이트 관리자 |
> | microsoft.directory/users/password/update | 모든 사용자에 대 한 암호 다시 설정 |
> | microsoft.directory/users/userPrincipalName/update | 사용자의 사용자 계정 이름 업데이트 |
...
> [!IMPORTANT]
> 이 역할은 암호를 다시 설정할 수 있으며 전역 관리자를 포함 하 여 관리자가 아닌 모든 관리자에 대 한 새로 고침 토큰을 무효화 합니다. 이 역할은 사용 되지 않으므로 API에서 더 이상 반환 되지 않으므로 사용 하면 안 됩니다.
...
> | microsoft.directory/contacts/delete | 연락처 삭제 |
> | microsoft.directory/contacts/basic/update | 연락처에 대 한 기본 속성 업데이트 |
> | microsoft. directory/도메인/기본/allTasks | 도메인을 만들고 삭제 하며 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/groups/create | 역할 할당 가능 그룹을 제외한 그룹 만들기 |
> | microsoft.directory/groups/delete | 역할 할당 가능 그룹을 제외한 그룹 삭제 |
> | microsoft.directory/groups/restore | 삭제된 그룹 복원 |
> | microsoft.directory/groups/members/update | 역할 할당 가능 그룹을 제외 하 고 그룹의 구성원 업데이트 |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.azure.print/allEntities/allProperties/allTasks | Microsoft 인쇄에서 프린터 및 커넥터를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.azure.print/connectors/allProperties/read | Microsoft 인쇄에서 커넥터의 모든 속성 읽기 |
> | microsoft.azure.print/printers/allProperties/read | Microsoft 인쇄에서 프린터의 모든 속성 읽기 |
> | microsoft.azure.print/printers/register | Microsoft 인쇄에 프린터 등록 |
...
이 역할을 가진 사용자는 전역 관리자를 포함 하 여 모든 사용자에 대 한 인증 방법 (암호 포함)을 설정 하거나 다시 설정할 수 있습니다. 권한 있는 인증 관리자는 사용자가 기존의 비암호 자격 증명(예: MFA 또는 FIDO)을 다시 등록하고 ‘디바이스에 MFA 저장’을 철회하도록 강제 적용한 다음, 모든 사용자가 다음에 로그인할 때 MFA를 요청할 수 있습니다.
...
> | microsoft. directory/groupsAssignableToRoles/allProperties/update | 역할 할당 가능 그룹 업데이트 |
> | microsoft.directory/oAuth2PermissionGrants/allProperties/allTasks | OAuth 2.0 권한 부여를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft. directory/privilegedIdentityManagement/allProperties/Allproperties | 모든 리소스를 만들고 삭제 하 고, Privileged Identity Management에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/roleAssignments/allProperties/allTasks | 역할 할당을 만들고 삭제 하며 모든 역할 할당 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/roleDefinitions/allProperties/allTasks | 역할 정의를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
> | microsoft.directory/scopedRoleMemberships/allProperties/allTasks | ScopedRoleMemberships 만들기 및 삭제, 모든 속성 읽기 및 업데이트 |
> | microsoft.directory/servicePrincipals/appRoleAssignedTo/update | 서비스 사용자 역할 할당 업데이트 |
...
> | microsoft. directory/bitlockerKeys/키/읽기 | 장치의 bitlocker 메타 데이터 및 키 읽기 |
> | microsoft. directory/entitlementManagement/allProperties/read | Azure AD 자격 관리의 모든 속성 읽기 |
> | microsoft. directory/identityProtection/allProperties/read | Azure AD ID 보호의 모든 리소스 읽기 |
> | microsoft. directory/identityProtection/allProperties/update | Azure AD ID 보호의 모든 리소스 업데이트 |
> | microsoft.directory/policies/create | Azure AD에서 정책 만들기 |
> | microsoft.directory/policies/delete | Azure AD에서 정책 삭제 |
> | microsoft.directory/policies/basic/update | 정책에 대 한 기본 속성 업데이트 |
> | microsoft.directory/policies/owners/update | 정책의 소유자 업데이트 |
...
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | office365. protectionCenter/allEntities/standard/read | 보안 및 규정 준수 센터에서 모든 리소스의 표준 속성을 읽습니다. |
> | office365. protectionCenter/allEntities/기본/업데이트 | 보안 및 규정 준수 센터에서 모든 리소스의 기본 속성 업데이트 |
> | protectionCenter/attackSimulator/office365/allProperties/Allproperties | 공격 시뮬레이터에서 공격 페이로드 만들기 및 관리 |
> | protectionCenter/attackSimulator/office365/allProperties/read | 공격 시뮬레이션, 응답 및 관련 교육에 대 한 보고서 읽기 |
> | office365. protectionCenter/attackSimulator/시뮬레이션/allProperties/Allproperties | 공격 시뮬레이터에서 공격 시뮬레이션 템플릿 만들기 및 관리 |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
...
> | advancedThreatProtection/allEntities/Allentities | Azure Advanced Threat Protection의 모든 측면 관리 |
> | microsoft.azure.supportTickets/allEntities/allTasks | Azure 지원 티켓 만들기 및 관리 |
> | microsoft intune/allEntities/읽기 | Microsoft Intune의 모든 리소스 읽기 |
> | microsoft.office365.securityComplianceCenter/allEntities/allTasks | 모든 리소스를 만들고 삭제 하며 Microsoft 365 보안 및 규정 준수 센터에서 표준 속성을 읽고 업데이트 합니다. |
> | microsoft.office365.supportTickets/allEntities/allTasks | Microsoft 365 서비스 요청 만들기 및 관리 |
> | defenderAdvancedThreatProtection/allEntities/Allentities | Microsoft Defender for Endpoint의 모든 측면 관리 |
...
> | microsoft.azure.serviceHealth/allEntities/allTasks | Azure Service Health 읽기 및 구성 |
> | office365. protectionCenter/allEntities/standard/read | 보안 및 규정 준수 센터에서 모든 리소스의 표준 속성을 읽습니다. |
> | protectionCenter/attackSimulator/office365/allProperties/read | 공격 시뮬레이터에서 공격 페이로드의 모든 속성을 읽습니다. |
> | protectionCenter/attackSimulator/office365/allProperties/read | 공격 시뮬레이션, 응답 및 관련 교육에 대 한 보고서 읽기 |
> | office365 protectionCenter/attackSimulator/시뮬레이션/allProperties/read | 공격 시뮬레이터의 모든 공격 시뮬레이션 템플릿 속성을 읽습니다. |
> | microsoft.office365.serviceHealth/allEntities/allTasks | Microsoft 365 관리 센터에서 Service Health 읽기 및 구성 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | office365/allEntities/Allentities/read | Office 365 사용 보고서 읽기 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
> | microsoft 팀/allEntities/Allentities/Allentities | 팀의 모든 리소스 관리 |
...
> | office365/allEntities/Allentities/read | Office 365 사용 보고서 읽기 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
> | microsoft 팀/callQuality/allProperties/read | CQD (통화 품질 대시보드)의 모든 데이터 읽기 |
> | microsoft. 팀/모임/allProperties/Allproperties | 모임 정책, 구성 및 회의 브리지를 포함 하 여 모임 관리 |
...
> | microsoft.office365.skypeForBusiness/allEntities/allTasks | 비즈니스용 Skype Online의 모든 측면을 관리 합니다. |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
> | microsoft 팀/callQuality/standard/read | CQD (통화 품질 대시보드)에서 기본 데이터를 읽습니다. |
...
> | --- | --- |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
> | microsoft. 팀/장치/표준/읽기 | 구성 정책을 포함 하 여 팀 인증 장치의 모든 측면 관리 |

## <a name="usage-summary-reports-reader"></a>사용 요약 보고서 판독기
...
> | --- | --- |
> | microsoft.office365.network/performance/allProperties/read | Microsoft 365 관리 센터에서 모든 네트워크 성능 속성을 읽습니다. |
> | office365/allEntities/표준/읽기 | 테 넌 트 수준 집계 Office 365 사용 보고서 읽기 |
> | microsoft.office365.webPortal/allEntities/standard/read | Microsoft 365 관리 센터의 모든 리소스에 대 한 기본 속성을 읽습니다. |
...
> | 동작 | Description |
> | --- | --- |
> | microsoft.directory/appRoleAssignments/create | 응용 프로그램 역할 할당 만들기 |
> | microsoft.directory/appRoleAssignments/delete | 응용 프로그램 역할 할당 삭제 |
> | microsoft. directory/appRoleAssignments/basic/update | 응용 프로그램 역할 할당의 기본 속성 업데이트 |
> | microsoft.directory/contacts/create | 연락처 만들기 |
> | microsoft.directory/contacts/delete | 연락처 삭제 |
> | microsoft.directory/contacts/basic/update | 연락처에 대 한 기본 속성 업데이트 |
> | microsoft. directory/entitlementManagement/allProperties/Allproperties | Azure AD 자격 관리에서 리소스를 만들고 삭제 하 고, 모든 속성을 읽고 업데이트 합니다. |
...
암호를 다시 설정할 수 있습니다. | 암호 관리자 | 기술 지원팀 관리자 | 인증 관리자 | 사용자 관리 | 권한 있는 인증 관리자 | 전역 관리자
------ | ------ | ------ | ------ | ------ | ------ | ------
