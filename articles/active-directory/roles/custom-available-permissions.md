...
[이러한 권한은 새 등록 포털 명령에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/new-custom-role.png)
...
![이러한 권한은 앱 등록 삭제 명령에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/delete-app-registration.png)
...
![이 사용 권한은 앱 등록 소유자 페이지에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/app-registration-owners.png)
...
![이 권한은 인증 페이지에서 앱 등록 지원 계정 유형 속성에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/supported-account-types.png)
...
![앱 등록 인증에 대 한 액세스 권한을 부여 하지만 지원 되는 계정 유형은 지원 하지 않습니다.](./media/custom-available-permissions/supported-account-types.png)
...
![이 사용 권한은 앱 등록 브랜딩 페이지에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/app-registration-branding.png)
...
![이 권한은 앱 등록 인증서 & 암호 페이지에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/app-registration-secrets.png)
...
![이 사용 권한은 앱 등록 API 사용 권한 페이지에 대 한 액세스 권한을 부여 합니다.](./media/custom-available-permissions/app-registration-api-permissions.png)

![이 권한은 앱 등록에 대 한 액세스 권한을 부여 하 여 API 페이지를 노출 합니다.](./media/custom-available-permissions/app-registration-expose-api.png)
...
- [Azure Portal, AZURE AD PowerShell 및 Graph API](custom-create.md) 를 사용 하 여 사용자 지정 역할을 만듭니다.
