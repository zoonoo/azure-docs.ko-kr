...
1. **할당** 을 선택 하 여 역할에 대 한 할당을 확인 합니다.
    ...
    ![목록에서 역할을 열 때 역할 할당 및 사용 권한 보기](./media/view-assignments/role-assignments.png)
...
1. 앱 등록에서 **역할 및 관리자** 를 선택한 다음 해당 속성을 볼 역할을 선택 합니다.
    ...
    ![앱 등록 페이지에서 앱 등록 역할 할당 보기](./media/view-assignments/app-reg-assignments.png)

1. **할당** 을 선택 하 여 역할에 대 한 할당을 확인 합니다. 앱 등록 내에서 할당 보기를 열면이 Azure AD 리소스로 범위가 지정 된 할당이 표시 됩니다.

    ![앱 등록의 속성에서 앱 등록 역할 할당 보기](./media/view-assignments/app-reg-assignments-2.png)
