...
4. 검색 상자에 **Dealpath**를 입력하고 결과 패널에서 **Dealpath**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
    ...
    ![결과 목록의 Dealpath](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_addfromgallery.png)
...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_samlbase.png)

3. **Dealpath 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Dealpath 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_url.png)
...
4. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_certificate.png) 

5. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-dealpath-tutorial/tutorial_general_400.png)

6. **Dealpath 구성** 섹션에서 **Dealpath 구성**을 클릭하여 **로그인 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Dealpath 구성](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_configure.png) 

7. 다른 웹 브라우저 창에서 Dealpath에 관리자로 로그인합니다.

8. 오른쪽 위에서 **관리 도구**를 클릭하고 **통합**으로 이동한 다음, **SAML 2.0 인증** 섹션에서 **업데이트 설정**을 클릭합니다.

    ![Dealpath 구성](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_admin.png)

9. **SAML 2.0 인증 설정** 페이지에서 다음 단계를 수행합니다.

    ![Dealpath 구성](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_saml.png) 
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-dealpath-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-dealpath-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-dealpath-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-dealpath-tutorial/create_aaduser_04.png)
...
2. 응용 프로그램 목록에서 **Dealpath**를 선택합니다.
    ...
    ![응용 프로그램 목록의 Dealpath 링크](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_app.png)  
