...
이 문서에서는 Azure AD(Azure Active Directory) 또는 Microsoft 계정을 보호하기 위해 사용자 또는 관리자로서 수행할 수 있는 몇 가지 모범 사례를 설명합니다.
 ...
 > [!NOTE]
 > **로그인하는 데 문제가 있나요?** 그렇다면 [암호를 변경하고 재설정하는 방법은 다음과 같습니다](user-help/active-directory-passwords-update-your-own-password.md).
 >
 > Azure AD 관리자는 [Azure Active Directory에서 사용자 암호 재설정](fundamentals/active-directory-users-reset-password-azure-portal.md) 문서의 지침을 사용하여 사용자 암호를 다시 설정할 수 있습니다.
 >
...
Azure Active Directory의 암호 재설정에 대한 자세한 내용은 [IT 전문가를 위한 Azure AD 셀프 서비스 암호 재설정](user-help/active-directory-passwords-update-your-own-password.md) 항목을 참조하세요.
...
* [고유한 암호를 업데이트하는 방법](user-help/active-directory-passwords-update-your-own-password.md)
