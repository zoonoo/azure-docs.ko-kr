...
| properties | 로그인과 연결된 모든 속성을 나열합니다. 자세한 내용은 [Microsoft Graph API 참조](https://developer.microsoft.com/en-us/graph/docs/api-reference/beta/resources/signin)를 참조하세요. 이 스키마는 읽기 쉽도록 하기 위해 로그인 리소스와 동일한 특성 이름을 사용합니다.
