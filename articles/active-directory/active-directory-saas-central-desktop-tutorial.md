...
4. 검색 상자에 **Central Desktop**을 입력합니다. 결과 패널에서 **Central Desktop**을 선택한 다음, **추가**를 선택하여 응용 프로그램을 추가합니다.
    ...
    ![결과 목록의 Central Desktop](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_addfromgallery.png)
...
2. Single Sign-On을 사용하려면 **Single Sign-On** 대화 상자의 **모드** 드롭다운 목록에서 **SAML 기반 로그온**을 선택합니다.
    ...
    ![Single Sign-On 대화 상자](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_samlbase.png)

3. **Central Desktop 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Central Desktop 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_url.png)
...
4. **SAML 서명 인증서** 섹션 아래에서 **인증서**를 선택합니다. 그런 다음, 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_certificate.png) 

5. **저장** 단추를 선택합니다.

    ![Single Sign-On 저장 단추 구성](./media/active-directory-saas-central-desktop-tutorial/tutorial_general_400.png)
...
6. **Central Desktop 구성** 섹션에서 **Central Desktop 구성**을 선택하여 **로그온 구성** 창을 엽니다. **빠른 참조** 섹션에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
    ...
    ![Central Desktop 구성](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_configure.png) 
...
10. **메시지 서명 확인 방법** 섹션에서 다음 단계를 수행합니다.
    ...
    ![메시지 서명 확인 방법](./media/active-directory-saas-central-desktop-tutorial/ic769565.png "메시지 서명 확인 방법") **인증서**를 선택합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 선택합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-central-desktop-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동합니다. 그런 다음 **모든 사용자**를 선택합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-central-desktop-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 선택합니다.

    ![추가 단추](./media/active-directory-saas-central-desktop-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-central-desktop-tutorial/create_aaduser_04.png)
...
4. **새 멤버의 메일 주소** 상자에 프로비전할 Azure AD 계정을 입력한 후, **다음**을 선택합니다.
    ...
    ![새 멤버의 메일 주소](./media/active-directory-saas-central-desktop-tutorial/ic781052.png "새 멤버의 메일 주소")
...
2. 응용 프로그램 목록에서 **Central Desktop**을 선택합니다.
    ...
    ![응용 프로그램 목록의 Central Desktop 링크](./media/active-directory-saas-central-desktop-tutorial/tutorial_centraldesktop_app.png)  
