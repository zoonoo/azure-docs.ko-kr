...
> Privileged Identity Management PowerShell cmdlet은 Azure AD 미리 보기 모듈을 통해 지원 됩니다. 다른 모듈을 사용 중이 고 해당 모듈이 이제 오류 메시지를 반환 하는 경우이 새 모듈을 사용 하 여 시작 하세요. 다른 모듈 위에 빌드된 프로덕션 시스템이 있는 경우 다음으로 문의 하세요.pim_preview@microsoft.com
...
> [!Note]
> EndDateTime의 값이 null로 설정 된 경우 영구적 할당을 나타냅니다.
