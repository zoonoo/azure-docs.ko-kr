...
> [!WARNING]
> 하나 이상의 전역 관리자와 조직 계정을 사용 하는 권한 있는 역할 관리자가 둘 이상 있는 것이 중요 합니다 (Microsoft 계정). 권한 있는 역할 관리자가 하나만 있는 경우 해당 계정이 삭제 된 경우 조직에서 Privileged Identity Management를 관리할 수 없습니다.
