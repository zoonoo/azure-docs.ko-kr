...
ms.locfileid: "72895110"
---
# <a name="license-requirements-to-use-privileged-identity-management"></a>Privileged Identity Management 사용할 라이선스 요구 사항
...
Privileged Identity Management와 상호 작용 하거나 혜택을 받는 각 관리자나 사용자에 게는 라이선스가 있어야 합니다. 다음은 이러한 템플릿의 예입니다.
...
- Azure Portal의 Privileged Identity Management 서비스 및 Privileged Identity Management의 Graph API cmdlet 및 PowerShell 인터페이스는 사용자가 더 이상 권한 있는 역할을 활성화 하거나, 권한 있는 액세스를 관리 하거나, 수행할 수 없습니다. 권한 있는 역할에 대 한 액세스를 검토 합니다.
