...
## <a name="licenses-you-must-have"></a>라이선스 필요

디렉터리에 다음 작업을 수행할 직원 수만큼 Azure AD Premium P2 라이선스가 있어야 합니다.

- Azure AD에 적격 한 사용자 또는 PIM을 사용 하 여 관리 되는 Azure 역할에 할당 된 사용자
- 권한 있는 액세스 그룹의 적격 구성원 또는 소유자로 할당 된 사용자
...
- PIM을 설정 하 고, 정책을 구성 하 고, 경고를 수신 하 고, 액세스 검토를 설정 하는 사용자에 게 라이선스가 필요 하지 않습니다.
...
## <a name="when-a-license-expires"></a>라이선스가 만료 되는 경우
