...
---
# <a name="privileged-identity-management---resource-role---perform-access-review"></a>Privileged Identity Management - 리소스 역할 - 액세스 검토 수행
Azure 리소스에 대한 Privileged Identity Management에서는 기업이 Azure에서 리소스에 대해 권한 있는 액세스를 관리하는 방법을 간소화합니다. 
...
1. Azure AD Privileged Identity Management 응용 프로그램으로 이동합니다.
