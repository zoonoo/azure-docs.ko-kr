...
| UpgradeNotSupportedNonMsolAccount |[AD Connector 계정](connect/active-directory-aadconnect-accounts-permissions.md#active-directory-account)이 더 이상 기본 MSOL_ 계정이 아닙니다. |
