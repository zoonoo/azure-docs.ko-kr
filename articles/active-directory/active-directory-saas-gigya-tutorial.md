...
이 자습서는 Azure 및 Gigya의 통합을 보여주기 위한 것입니다.  
...
### <a name="to-enable-the-application-integration-for-gigya-perform-the-following-steps"></a>Gigya에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
이 섹션은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 Gigya에 인증할 수 있게 하는 방법을 간략하게 설명하기 위한 것입니다.  
...
7. **SAML 로그인** 섹션에서 다음 단계를 수행합니다.
    ...
    b. Azure 클래식 포털의 **Gigya에서 Single Sign-On 구성** 대화 상자 페이지에서 **발급자 URL** 값을 복사한 다음 **발급자** 텍스트 상자에 붙여넣습니다.
   
    c. Azure 클래식 포털의 **Gigya에서 Single Sign-On 구성** 대화 상자 페이지에서 **Single Sign-On 서비스 URL** 값을 복사한 다음 **Single Sign-On 서비스 URL** 텍스트 상자에 붙여넣습니다.
   
    d. Azure 클래식 포털의 **Gigya에서 Single Sign-On 구성** 대화 상자 페이지에서 **이름 식별자 형식** 값을 복사한 다음 **이름 ID 형식** 텍스트 상자에 붙여넣습니다.
...
### <a name="to-assign-users-to-gigya-perform-the-following-steps"></a>Gigya에 사용자를 할당하려면 다음 단계를 수행합니다.
