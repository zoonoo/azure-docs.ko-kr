...
3. **Gigya 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **식별자** 텍스트 상자에서 `https://fidm.gigya.com/saml/v2.0/<companyname>` 패턴을 사용하여 URL을 입력합니다.
...
6. **Gigya 구성** 섹션에서 **Gigya 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조** 섹션에서 **SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
9. **SAML 로그인** 섹션에서 다음 단계를 수행합니다.
    ...
    다. Azure Portal에서 복사한 **Single Sign-On 서비스 URL**을 **Single Sign-On 서비스 URL** 텍스트 상자에 붙여넣습니다.
