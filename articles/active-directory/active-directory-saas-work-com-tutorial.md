...
14. **SAML Single Sign-On 설정** 섹션에서 다음 단계를 수행합니다.
    ...
    1. **이름** 텍스트 상자에 구성할 이름을 입력합니다.  
       ...
       > 
       > 
    2. Azure 클래식 포털의 **Work.com에서 Single Sign-On 구성** 대화 상자 페이지에서 **발급자 URL** 값을 복사한 다음 **발급자 URL** 텍스트 상자에 붙여넣습니다.
    3. 다운로드한 인증서를 업로드하려면 **찾아보기**를 클릭합니다.
    4. **엔터티 Id** 텍스트 상자에 **https://salesforce-work.com**을 입력합니다.
...
> [!NOTE]
> 다른 Work.com 사용자 계정 생성 도구 또는 Work.com이 제공한 API를 사용하여 AAD 사용자 계정을 프로비전할 수 있습니다.
> 
> 
