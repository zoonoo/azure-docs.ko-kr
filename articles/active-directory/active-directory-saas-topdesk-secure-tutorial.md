<properties pageTitle="자습서: TOPdesk - Secure와 Azure Active Directory 통합 | Microsoft Azure" description="Azure Active Directory에서 TOPdesk - Secure을 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#자습서: TOPdesk - Secure와 Azure Active Directory 통합
>[AZURE.TIP]피드백을 보내려면 [여기](http://go.microsoft.com/fwlink/?LinkId=529789)를 클릭하십시오.
...
이 자습서를 완료한 후 TOPdesk – Secure에 할당한 Azure AD 사용자가 TOPdesk – Secure 회사 사이트 (서비스 공급자가 시작한 로그온)에서나 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 사용하여 응용 프로그램에 Single Sign-On할 수 있습니다.
...
##TOPdesk - Secure에 응용 프로그램 통합 사용
  
이 섹션은 TOPdesk - Secure에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

###TOPdesk - Secure에 응용 프로그램 통합을 사용하도록 설정하려면
...
8.  **TOPdesk - Secure에 대한 사용자 로그온 방법을 선택하십시오** 페이지에서 **Microsoft Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
9.  **앱 URL 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    2.  **TOPdesk – Secure Reply URL** 텍스트 상자에서 **TOPdesk - Secure AssertionConsumerService URL**을 붙여넣기합니다 (예: "*https://qssolutions.topdesk.net/tas/public/login/saml*")
    3.  **다음**을 클릭합니다.

10. **TOPdesk - Secure에서 Single Sign-On 구성** 페이지에서 메타데이터를 다운로드 하려면 **메타데이터 다운로드**를 클릭한 다음 컴퓨터에 로컬 저장합니다.
...
11. 인증서 파일을 만들려면 다음 단계를 수행하십시오.
    ...
    2.  **fed:ApplicationServiceType**의 **xsi:type**를(을) 가진 **RoleDescriptor** 노드를 확장합니다.
...
16. **SAML 구성 도우미** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    4.  **사용자 이름 특성** 텍스트 상자에서 ****http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**를(을) 입력합니다.
5.  **이름 표시** 텍스트 상자에서 구성할 이름을 입력합니다.
    6.  **Save**를 클릭합니다.
...
###TOPdesk - Secure에 사용자를 할당하려면 다음 단계를 수행합니다.
