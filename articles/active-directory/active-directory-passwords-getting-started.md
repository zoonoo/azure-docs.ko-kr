...
> [!IMPORTANT]
> 관리자가 아닌 사용자로 SSPR을 테스트합니다. Microsoft가 Azure 관리자 계정에 강력한 인증 요구 사항을 적용하기 때문입니다. 관리자 암호 정책에 대한 자세한 내용은 [암호 정책](active-directory-passwords-policy.md#administrator-password-policy-differences) 문서를 참조하세요.
...
다음 문서는 Azure AD를 통한 암호 재설정에 대한 추가 정보를 제공합니다.
