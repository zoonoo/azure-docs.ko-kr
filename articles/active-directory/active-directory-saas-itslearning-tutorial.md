...
3. **Itslearning 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에 URL `urn:mace:saml2v2.no:services:com.itslearning`을 입력합니다.
...
6. **Itslearning** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [itslearning 지원 팀](mailto:support@itslearning.com)에 보내야 합니다. 그러면 SAML SSO 연결이 양쪽에 제대로 설정되도록 지정합니다.
