...
1. **Bynder에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행하고 **다음**을 클릭합니다.
    ...
    b. **Next**를 클릭합니다.
2. 응용 프로그램에 대해 SSO를 구성하려면 Bynder 지원 팀에 문의하세요. 다운로드한 메타데이터 파일을 첨부하고 Bynder 팀에서 SSO를 설정할 수 있게 공유하세요.
...
> [!NOTE]
> 사용자를 수동으로 만들어야 하는 경우 Bynder 지원 팀에 문의해야 합니다.
> 
> 
