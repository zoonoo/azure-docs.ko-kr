<properties
   pageTitle="Azure 권위 있는 ID 관리: 역할에 대한 기본 설정을 변경하거나 보는 방법"
   description="Azure 권위 있는 ID 관리 확장을 사용하여 권한 있는 ID에 대한 기본 설정을 변경하는 방법을 알아봅니다."
...
# Azure 권위 있는 ID 관리: 역할에 대한 기본 활성화 설정을 변경하거나 보는 방법
...
7. 전역 관리자를 임시로 허용하거나 허용하지 않으려는 경우 **사용** 또는 **사용 안 함**을 클릭합니다. 이 설정에 대한 자세한 내용은 아래를 참조하세요.
8. **Save**를 클릭합니다.
