<properties pageTitle="자습서: Coupa와 Azure Active Directory 통합 | Microsoft Azure" description="Azure Active Directory에서 Coupa를 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#자습서: Coupa와 Azure Active Directory 통합
>[AZURE.TIP]사용자 의견을 보내려면 [여기](http://go.microsoft.com/fwlink/?LinkId=529806)를 클릭하십시오.
...
이 자습서를 완료한 후 Coupa에 할당한 Azure AD 사용자가 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 사용하여 응용 프로그램에 Single Sign-On 할 수 있습니다.
...
이 섹션은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 Coupa에 인증할 수 있게 하는 방법을 간략하게 설명하기 위한 것입니다. Coupa에 대한 Single Sign-on을 구성하려면 인증서의 손도장(thumbprint) 값을 검색해야 합니다. 이 절차를 잘 모르는 경우 [인증서의 손도장 값을 검색하는 방법](http://youtu.be/YKQF266SAxI)을 참조하십시오.
...
4.  다른 브라우저 창에서 Azure Active Directory 포털에 로그인합니다.
...
7.  **앱 URL 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    2.  다운로드한 Coupa 메타데이터 파일을 연 다음 **AssertionConsumerService 인덱스/URL**를 복사합니다.
    3.  **URL Coupa 회신** 텍스트 상자에 **AssertionConsumerService 인덱스/URL** 값을 붙여 넣습니다.
    4.  **다음**을 클릭합니다.
