...
2. **Everbridge에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
### <a name="creating-a-everbridge-test-user"></a>Everbridge 테스트 사용자 만들기

이 섹션에서는 Everbridge에서 Britta Simon이라는 사용자를 만듭니다. <mailto:support@everbridge.com>을 통해 Everbridge 지원 팀과 함께 작업하여 Everbridge 플랫폼에 사용자를 추가합니다.
