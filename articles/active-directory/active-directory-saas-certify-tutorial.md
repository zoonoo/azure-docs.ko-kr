...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Certify 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Certify의 관련 사용자 간에 연결이 형성되어야 합니다.  
...
1. **Certify에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    b. **Next**를 클릭합니다.
2. 응용 프로그램에 대해 SSO를 구성하려면 support@certify.com. 다운로드한 인증서 파일을 메일에 첨부하고 해당하는 쪽에 SSO를 설정하기 위해 Certify 팀과 메타데이터 URL(엔터티 ID, SSO 로그인 URL 및 로그아웃 URL)을 공유합니다.
