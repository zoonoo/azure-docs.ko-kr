<properties
	pageTitle="자습서: Certify와 Azure Active Directory 통합 | Microsoft Azure"
...
4. **[Certify 테스트 사용자 만들기](#creating-a-certify-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Certify에 만듭니다.
