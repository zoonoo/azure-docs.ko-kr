---
title: Azure Active Directory Identity Protection에서 multi-factor authentication 등록 정책을 구성 하는 방법
...
1. **Azure Active Directory** > **Security** > **id 보호** > **MFA 등록 정책**으로 이동 합니다.
   1. **할당** 아래
