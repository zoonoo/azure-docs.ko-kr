...
**검색 유형:** 오프라인 <br>
**이전 이름:** 이 검색 (위험, 위험 이벤트 플래그가 지정 된 사용자)를 사용 하는 기존 Azure AD Id 보호 보고서에 '자격 증명이 유출된 된 사용자'로 표시 됩니다.

이 위험 이벤트 유형은 지정된 된 사용자에 대 한 일반적이 지 않습니다 또는 Microsoft의 내부 및 외부 위협 인텔리전스 원본을 기반으로 하는 알려진된 공격 패턴과 일치 하는 사용자 활동을 나타냅니다.
