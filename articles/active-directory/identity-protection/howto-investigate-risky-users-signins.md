...
ms.locfileid: "68370315"
---
# <a name="how-to-investigate-risky-users-and-sign-ins"></a>방법: 위험한 사용자 및 로그인 조사 

위험한 로그인 및 위험한 사용자 보고서를 사용 하 여 사용자 환경에서 위험을 조사 하 고 통찰력을 얻을 수 있습니다. 위험한 로그인 및 사용자를 필터링하고 정렬하는 기능을 사용하여 조직에서 잠재적인 침입 가능성을 더 잘 파악할 수 있습니다. 
...
- 사용자의 활성 위험 이벤트가 가양성이라고 생각되면 사용자 위험을 해제합니다. 자세한 내용은 [Azure AD ID 보호에서 위험 이벤트에 대 한 피드백 제공](howto-provide-risk-event-feedback.md)문서를 참조 하세요.
...
자세한 내용은 [Azure AD ID 보호에서 위험 이벤트에 대 한 피드백 제공](howto-provide-risk-event-feedback.md)문서를 참조 하세요.
