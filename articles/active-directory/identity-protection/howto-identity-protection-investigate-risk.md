...
> [!NOTE] 
> 시스템에서 위험 사용자 위험 점수에 영향을 주는 위험 이벤트가 가양성 인지 또는 사용자 위험에 대해 MFA 프롬프트를 완료 하거나 암호를 안전 하 게 변경 하는 등의 정책을 적용할 수 있음을 감지할 수 있습니다. 따라서 시스템은 위험 상태를 해제 하 고 "AI가 확인 된 로그인 안전"의 위험 정보를 제공 하므로 더 이상 사용자의 위험에 영향을 주지 않습니다. 
