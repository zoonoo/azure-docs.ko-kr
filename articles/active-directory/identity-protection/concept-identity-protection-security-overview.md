...
:::image type="content" source="./media/concept-identity-protection-security-overview/02.png" alt-text="높은 위험 수준 및 중간 위험 사용자 및 기타 위험 요소에 대해 타일이 표시 된 Azure Portal 보안 개요의 스크린샷" border="false":::
