...
1. 글로벌 관리자로 [Azure Portal](https://ms.portal.azure.com/)에 로그온합니다. 
...
3. 응용 프로그램 목록에서 **ID**를 클릭합니다.
    ...
    ![만들기](./media/active-directory-identityprotection-enable/05.png "만들기")

4. **Azure AD ID 보호**를 클릭합니다.
   
    ![만들기](./media/active-directory-identityprotection-enable/06.png "만들기")
