<properties
	pageTitle="Azure Active Directory ID 보호 활성화 | Microsoft Azure"
...
# Azure Active Directory ID 보호 활성화 
...
## Azure Active Directory ID 보호를 활성화하는 단계 


1. 관리자 권한으로 Azure 포털에 [로그온](https://ms.portal.azure.com/)합니다.

1. Azure 포털에서 **Marketplace**를 클릭합니다.

	![생성](./media/active-directory-identityprotection-enable/01.png "생성")

1. 응용 프로그램 목록에서 **보안 + ID**를 클릭합니다.

	![생성](./media/active-directory-identityprotection-enable/02.png "생성")

1. **Azure AD ID 보호**를 클릭합니다.

	![생성](./media/active-directory-identityprotection-enable/03.png "생성")

1. **Azure AD ID 보호** 블레이드에서 **만들기**를 클릭합니다.

	![생성](./media/active-directory-identityprotection-enable/04.png "생성")
