...
* [Office 365 및 기타 Azure Active Directory 연결 앱과 함께 조건부 액세스 사용](active-directory-conditional-access-azure-portal.md)
* [Azure AD 조건부 액세스 시작하기](active-directory-conditional-access-azure-portal-get-started.md) 
