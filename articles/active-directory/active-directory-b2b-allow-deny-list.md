...
정책을 가져오려면 [Get-AzureADPolicy](https://docs.microsoft.com/en-us/powershell/module/azuread/get-azureadpolicy?view=azureadps-2.0-preview) cmdlet을 사용합니다. 예: 
...
- 조건부 액세스 및 B2B 공동 작업에 대한 내용은 [B2B 공동 작업 사용자에 대 한 조건부 액세스](active-directory-b2b-mfa-instructions.md)를 참조하세요.
