...
1.  Azure AD 포털의 **Concur ** 응용 프로그램 통합 페이지에서 **Single Sign-on 구성**을 클릭하여 **Single Sign-on 구성** 대화 상자를 엽니다.
...
6.  Azure 관리 포털의 응용 프로그램 목록에서 **Concur**을 선택하여 **Concur** 대화 상자 페이지를 엽니다.
