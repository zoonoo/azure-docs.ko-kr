...
| 디바이스 등록이란? | 조직에서 장치를 등록 하 여 파일 및 앱과 같은 보안 리소스에 액세스 하는 장치를 파악 하 고, 조건부 액세스를 설정 하 여 해당 리소스에 부적절 하 게 액세스 하는 위험을 줄일 수 있습니다. **설정**을 사용하여 디바이스 등록을 취소할 수 있지만, Outlook의 이메일과 OneDrive의 파일에 액세스할 수 없게 될 수 있고 휴대폰 로그인 기능을 잃게 됩니다. |
