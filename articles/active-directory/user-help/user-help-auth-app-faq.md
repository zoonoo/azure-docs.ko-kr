...
1. Authenticator **설정** 을 열고 **베타** 아래에서 자동 **채우기를** 켭니다.
1. 앱 내의 **암호** 탭에서 [Microsoft 계정](https://account.microsoft.com/account)를 사용 하 여 로그인 합니다.
1. 다음 중 하나를 수행합니다.

   - IOS의 **설정** 에서 자동 채우기 설정 섹션에서 **자동 채우기 설정 방법** 을 선택 하 여 기본 자동 채우기 공급자로 인증자를 설정 하는 방법을 알아봅니다.
   - Android의 **설정** 에서 자동 채우기 설정 섹션에서 자동 채우기 **공급자로 설정** 을 선택 하 여 인증자를 기본 자동 채우기 공급자로 설정 합니다.

**Q**: 설정에서 자동 **채우기** 스위치가 회색으로 표시 되 면 어떻게 되나요?

**A**: 자동 채우기는 현재 베타 버전 이며 모든 조직 또는 계정 유형에 대해 아직 사용 하도록 설정 되지 않았습니다. **설정** 의 자동 **채우기** 스위치가 회색으로 표시 되 면 회사 계정으로 Authenticator 앱을 사용 하 고 있기 때문일 수 있습니다. 회사 계정이 추가 되지 않은 장치에서이 기능을 사용할 수 있습니다. 조직이 Microsoft와 함께 작업 하는 경우 작업 계정이 인증자에 추가 된 경우에도 자동 **채우기** 스위치를 사용 하도록 설정 됩니다.
...
- **Authenticator 앱에는 강력한 인증이 필요** 합니다. 인증자에 로그인 하려면 두 번째 요소가 필요 합니다. 이는 사용자에 게 Microsoft 계정 암호가 있더라도 Authenticator 앱 내의 암호에 액세스할 수 없음을 의미 합니다.
- 자동 **채우기 데이터는 생체 인식 및 암호를 사용 하 여 보호 됩니다**. 앱 또는 사이트에서 암호를 자동으로 채우기 전에 인증자에 게 생체 인식 또는 장치 암호가 필요 합니다. 이렇게 하면 다른 사람이 장치에 액세스할 수 있는 경우라도 생체 인식 또는 장치 PIN을 제공할 수 없기 때문에 암호를 채우거 나 볼 수 없습니다. 또한 사용자는 앱 설정에서 앱 잠금을 해제 하는 경우에도 생체 인식 또는 PIN을 제공 하지 않는 한 암호 페이지를 열 수 없습니다.
- **장치에서 암호화 된 암호**: 장치의 암호는 암호화 되 고 암호화/암호 해독 키는 저장 되지 않으며 항상 즉시 생성 됩니다. 암호는 사용자가 입력 하는 경우, 즉 자동 채우기 중에 또는 사용자가 암호를 확인 하려는 경우에만 해독 됩니다 .이 경우에는 모두 생체 인식 또는 PIN이 필요 합니다.
- **클라우드 및 네트워크 보안**: 클라우드의 암호는 장치에 도달 하는 경우에만 암호화 및 암호 해독 됩니다. 암호는 SSL로 보호 된 HTTPS 연결을 통해 동기화 되므로 공격자가 중요 한 데이터를 동기화 할 때 도청 수 없습니다. 암호화 해시 된 함수 (특히 해시 기반 메시지 인증 코드)를 사용 하 여 네트워크를 통해 동기화 되는 데이터의 온전성도 확인 합니다.

## <a name="autofill-for-it-admins"></a>IT 관리자를 위한 자동 채우기

**Q**: 내 직원 또는 학생이 Authenticator 앱에서 암호 자동 채우기를 사용 하나요?

**A**: 아니요. 자동 채우기 기능은 현재 베타 버전 이며 모든 조직 또는 계정 유형에 대해 아직 사용 하도록 설정 되지 않았습니다. 직원 또는 학생이 Microsoft Authenticator 앱에 회사 또는 학교 계정을 추가한 경우 암호 자동 채우기를 사용할 수 없습니다. 이러한 제한에 대 한 한 가지 예외는 직원 또는 학생이 [외부 또는 타사 계정](user-help-auth-app-add-non-ms-account.md)으로 Microsoft 클라우드 기반 multi-factor authentication에 회사 또는 학교 계정을 추가 하는 경우입니다.

**Q**: 내 직원이 나 학생 들에 게 자동 채우기 기능을 사용할 수 있나요?

**A**: 예. 직원 또는 학교를 사용 하도록 설정 하려면 회사 또는 학교를 허용 목록에 추가할 수 있습니다. 지원 또는 Microsoft 담당자에 게 연락 하 여 허용 목록에 추가 하세요. 또한 조직의 IT 관리자 인 경우 양식을 작성 하 여 [Authenticator에서 자동 채우기를 위해 허용 목록 엔터프라이즈](https://aka.ms/RequestAutofillInAuthenticator)에 조인 하는 관심을 표현할 수 있습니다.
...
**Q**: 내 조직의 특정 사용자만 자동 채우기로 나열할 수 있나요?

**A**: 아니요. 현재 기업에서는이 시점에서 직원 중 일부 또는 모두에 대해 암호 자동 채우기를 사용 하도록 설정할 수 있습니다. 이러한 컨트롤은 점차 확장 될 예정입니다.
