...
|디바이스 등록이란?|조직의 장치에 파일 및 앱 같은 보안된 리소스에 액세스 하는 것을 알 수는 장치를 등록 하 고 가능한 경우 해당 리소스에 대 한 부적절 한 액세스의 위험을 줄이기 위해 조건부 액세스를 켤 수 좋습니다. **설정**을 사용하여 디바이스 등록을 취소할 수 있지만, Outlook의 이메일과 OneDrive의 파일에 액세스할 수 없게 될 수 있고 휴대폰 로그인 기능을 잃게 됩니다.|
