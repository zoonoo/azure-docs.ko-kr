---
title: 마이크로 소프트 인증자 응용 프로그램에 비 마이크로 소프트 계정을 추가 - Azure AD
description: 2단계 인증을 사용하는 동안 사용자의 신원을 확인하기 위해 Microsoft 인증자 앱에 Google 또는 Facebook과 같은 비 Microsoft 계정을 추가합니다.
...
---
# <a name="add-non-microsoft-accounts-to-the-microsoft-authenticator-app"></a>Microsoft 인증자 앱에 Microsoft 이외의 계정 추가
...
1. 컴퓨터에서 Facebook을 열고 오른쪽 상단 모서리의 드롭다운 메뉴를 선택한 다음 **설정** > **보안 및 로그인으로**이동합니다.
...
11. 거의 **완료된** 페이지에서 컴퓨터를 신뢰할 수 있는 장치로 만들지 여부를 결정한 다음 **가져오기를 선택합니다. 2단계 확인을 켭니다.**
