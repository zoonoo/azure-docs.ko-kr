---
title: My Apps 포털 개요 - Azure Active Directory | Microsoft Docs
description: My Apps 포털 및 해당 기능의 개괄적인 개요 및 자세한 내용을 제공하는 링크입니다.
...
## <a name="my-apps-portal-articles"></a>My Apps 포털 문서

**My Apps** 포털에서 사용할 수 있는 기능에 대한 자세한 내용 및 지침을 보려면 다음 문서를 참조하세요.
