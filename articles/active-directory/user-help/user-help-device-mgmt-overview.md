...
회사 소유 장치와 개인 장치 모두에서 잠재적으로 조직의 제한된 리소스 모두에 액세스할 수 있는지 확인합니다.

|문서 |설명 |
|------|------------|
|[작업 장치 조인](user-help-join-device-on-network.md)|회사 소유 장치를 조직의 네트워크에 조인하는 방법을 알아봅니다.|
|[개인 장치 등록](user-help-register-device-on-network.md)|조직의 네트워크에 개인 장치를 등록하는 방법을 알아봅니다.|