---
title: 전화 번호를 인증 방법으로 설정 - Azure AD
description: 보안 정보(미리 보기) 페이지를 설정하여 휴대폰 번호와 휴대 기기를 인증 방법으로 사용하여 신원을 확인하는 방법.
...
---
# <a name="set-up-a-phone-number-as-your-verification-method"></a>전화번호를 인증 방법으로 설정
