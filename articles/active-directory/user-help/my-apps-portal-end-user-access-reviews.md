...
## <a name="using-myappsmicrosoftcom"></a>Myapps.microsoft.com 사용
...
## <a name="using-myapplicationsmicrosoftcom"></a>Myapplications.microsoft.com 사용
...
>[!Note]
>**액세스 검토** 타일이 표시 되지 않는 경우 액세스 검토를 수행할 수 있는 권한이 없거나 승인을 기다리는 보류 중인 검토가 없는 것일 수 있습니다. 타일에 대 한 액세스 권한이 있다고 생각 되 면 지원 센터에 문의 하세요.

## <a name="to-perform-access-reviews"></a>액세스 검토를 수행 하려면
