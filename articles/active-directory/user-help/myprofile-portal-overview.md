---
title: 내 프로필(미리 보기) 포털 개요 - Azure Active Directory | Microsoft Docs
description: 기능에 대한 다른 문서로의 링크를 포함하여 내 프로필 포털에 대해 개괄적으로 설명합니다.
...
## <a name="access-the-my-profile-portal"></a>내 프로필 포털에 액세스
다음 브라우저 중 하나의 현재 버전에서 https://myprofile.microsoft.com으로 이동하여 **내 프로필** 포털로 이동할 수 있습니다.
