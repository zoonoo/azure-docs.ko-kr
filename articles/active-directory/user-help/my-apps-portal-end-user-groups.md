...
2. 웹 브라우저를 열고로 https://myapps.microsoft.com이동 하거나 조직에서 제공한 링크를 사용 합니다. 예를 들어와 https://myapps.microsoft.com/contoso.com같은 조직의 사용자 지정 페이지로 이동할 수 있습니다.
...
2. 필요한 정보를 입력합니다.
    ...
    - **그룹 유형:**
        ...
        - **Office 365.** 공유 사서함, 일정, 파일, SharePoint 사이트 등에 대한 액세스를 멤버에게 부여하여 협업 기회를 제공합니다. 또한 이 옵션을 사용하면 조직 외부인에게도 그룹 액세스 권한을 부여할 수 있습니다.

    - **그룹 이름입니다.** 기억하기 쉽고 의미 있는 그룹 이름을 추가합니다.
