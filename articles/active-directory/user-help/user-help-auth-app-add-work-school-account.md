---
title: Microsoft 인증자 앱에 직장 또는 학교 계정 추가 - Azure AD
description: 2단계 확인을 사용하는 동안 Microsoft 인증자 앱에 직장 또는 학교 계정을 추가하여 신원을 확인합니다.
...
---
# <a name="add-your-work-or-school-account-to-the-microsoft-authenticator-app"></a>Microsoft 인증자 앱에 직장 또는 학교 계정 추가
...
1. 컴퓨터에서 [추가 보안 확인](https://account.activedirectory.windowsazure.com/proofup.aspx?proofup=1) 페이지로 이동합니다.
    ...
    >[!Note]
    >**추가 보안 인증** 페이지가 표시되지 않는 경우에는 관리자가 보안 정보(미리 보기) 환경을 켰을 수 있습니다. 이 경우 [인증자 앱을 사용하도록 보안 정보 설정](security-info-setup-auth-app.md) 섹션의 지침을 따라야 합니다. 이외의 경우에는 조직의 지원 센터에 도움을 요청해야 합니다. 보안 정보에 대한 자세한 내용은 [보안 정보(미리 보기) 개요를](user-help-security-info-overview.md)참조하십시오.
