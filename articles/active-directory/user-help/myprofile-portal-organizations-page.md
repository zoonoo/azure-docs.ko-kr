---
title: 내 프로필(미리 보기) 포털에서 조직 관리 - Azure Active Directory | Microsoft Docs
description: 내 프로필 포털의 조직 페이지에 대한 개괄적인 개요입니다.
...
>[!Important]
>실수로 조직에서 나가면 실행 취소할 수 없습니다. 조직을 다시 추가해야 합니다.

1. **내가 작업하는 기타 조직** 영역에서 계정에 로그인합니다.

2. **조직 나가기**를 선택한 다음, **예**를 선택하여 조직에서 나갈 것을 확인합니다.

    ![강조 표시된 조직 나가기 링크가 있는 조직 페이지](media/myprofile-portal/myprofile-portal-organizations-leave.png)
