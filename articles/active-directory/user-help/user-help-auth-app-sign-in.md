...
- 앱의 **계정** 화면에서 **회사 또는 학교 계정을 찾을 수 없는 경우** 앱에 아직 추가 하지 않았음을 의미 합니다. 회사 또는 학교 계정 추가 문서의 단계를 수행하여 회사 또는 학교 계정을 추가합니다.
...
| 휴대폰 로그인에 회사 또는 학교 계정을 둘 이상 사용할 수 없는 이유는 무엇인가요? | 한 휴대폰은 하나의 회사 또는 학교 계정에 등록되어야 합니다. 다른 회사 또는 학교 계정에 대해 휴대폰 로그인을 설정 하려면 **설정** 페이지를 통해이 장치에서 계정의 등록을 취소 해야 합니다. |
