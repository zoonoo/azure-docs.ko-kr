---
title: Microsoft 인증자 앱을 사용하여 로그인 - Azure AD
...
2단계 인증을 사용하는 경우 Microsoft 인증자 앱을 사용하여 계정에 로그인하는 데 도움이 됩니다. 2단계 인증을 사용하면 특히 중요한 정보를 볼 때 보다 안전하게 계정에 액세스할 수 있습니다. 암호를 잊어버리거나 암호가 노출될 수 있으므로 2단계 인증은 다른 사람이 침입하기 어렵게 만들어서 계정을 보호하는 추가 보안 단계입니다.
...
Microsoft 인증자 앱을 열고 직장 또는 학교 계정으로 이동한 다음 전화 로그인을 켭니다.
...
- **이미 2단계 인증을 위해 앱을 사용하고 있는 경우.** 이미 앱 및 2단계 확인을 사용 중이면 계정 이름 옆에 있는 화살표를 선택한 다음 **전화 로그인 사용을**선택할 수 있습니다.
...
- **계정 타일을 탭하면**계정이 계정의 전체 화면 보기로 열립니다. **전화 로그인이 활성화되어** 있는 경우 암호 없이 로그인하도록 완전히 설정되어 있습니다. **전화 로그인 사용 이**표시되면 탭하여 전화 로그인을 켭니다.
- **이미 2단계 인증을 위해 앱을 사용한 경우**계정 타일을 탭한 다음 계정의 전체 화면 보기로 확장할 수 있습니다. 그런 다음 **전화 로그인 활성화를** 눌러 전화 로그인을 켭니다.
- 앱의 **계정** 화면에서 **직장 또는 학교 계정을 찾을 수 없는 경우** 아직 앱에 추가하지 않았음을 의미합니다. 회사 또는 학교 계정 추가 문서의 단계를 수행하여 회사 또는 학교 계정을 추가합니다.
...
- **이 아이콘 ![설정을 보여주는 아이콘](media/user-help-auth-app-sign-in/icon.png)이 있는 경우** 이 아이콘이 개인 Microsoft 계정 이름 옆에 나타나면 계정에 대한 전화 로그인을 이미 설정했다는 의미입니다. 앱 외부에서 인증 요청에 대한 알림을 받을 수 있도록 계정에 대한 푸시 알림을 추가하라는 메시지가 표시될 수 있습니다.
- **2단계 인증에 대한 앱을 사용하고 있는 경우** 이미 앱 및 2단계 확인을 사용 중이면 계정 이름 옆에 있는 화살표를 선택한 다음 **전화 로그인 사용을**선택할 수 있습니다.
- **회사 또는 학교 계정을 찾을 수 없는 경우** 앱의 **계정** 화면에서 계정을 찾을 수 없는 경우 앱에 계정을 아직 추가하지 않은 것을 의미합니다. [개인 Microsoft 계정 추가](user-help-auth-app-add-personal-ms-account.md) 문서의 단계에 따라 계정을 추가합니다.

iOS 기기에서:

- **계정 타일을 탭하면**계정이 계정의 전체 화면 보기로 열립니다. **전화 로그인이 활성화되어** 있는 경우 암호 없이 로그인하도록 완전히 설정되어 있습니다. **전화 로그인 사용 이**표시되면 탭하여 전화 로그인을 켭니다.
- **이미 2단계 인증을 위해 앱을 사용하고**있는 경우 계정 타일을 탭한 다음 계정의 전체 화면 보기로 확장할 수 있습니다. 그런 다음 **전화 로그인 활성화를** 눌러 전화 로그인을 켭니다.
- 앱의 **계정** 화면에서 **계정을 찾을 수 없는 경우** 아직 앱에 계정을 추가하지 않았음을 의미합니다. 개인 Microsoft 계정 추가 문서의 단계에 따라 [개인 Microsoft 계정을](user-help-auth-app-add-personal-ms-account.md) 추가합니다.
...
표준 2단계 확인 방법을 사용하려면 로그인하는 장치에 사용자 이름과 암호를 입력해야 합니다. 그런 다음 Microsoft 인증자 앱을 열고 계정에 대해 임의로 생성된 코드를 **입력 코드** 상자에 입력합니다. Android 기기에서 이러한 확인 코드는 **계정** 화면에서 찾을 수 있습니다. iOS 기기에서 이러한 확인 코드는 계정 유형에 따라 **계정** 화면 또는 계정의 전체 화면 보기에서 찾을 수 있습니다. Microsoft Authenticator 앱에 계정을 추가하는 프로세스의 일환으로 계정에 대해 2단계 인증을 설정합니다.
...
| 휴대폰을 분실하거나 휴대하지 않은 경우 계정에 액세스하려면 어떻게 해야 하나요? | 언제든지 로그인 페이지에서 [암호를 대신 사용]을 선택하여 암호를 사용하도록 전환할 수 있습니다. 그러나 2단계 인증을 사용하더라도 여전히 두 번째 방법을 사용하여 신분을 증명해야 합니다.<br><br>**중요**<br>계정에 두 가지 이상의 최신 인증 방법을 연결하는 것이 좋습니다.<br><br>[보안 설정](https://account.live.com/proofs/manage) 페이지에서 개인 계정의 인증 방법을 관리할 수 있습니다. 회사 또는 학교 계정이면 관리자가 보안 정보를 설정한 경우 조직의 [추가 보안 인증](https://account.activedirectory.windowsazure.com/proofup.aspx?proofup=1) 페이지 또는 **계정 보안 유지** 페이지로 이동하면 됩니다. 보안 정보에 대한 자세한 내용은 [보안 정보(미리 보기) 개요를](user-help-security-info-overview.md)참조하십시오.<br><br>인증 방법을 관리할 수 없으면 관리자에게 문의해야 합니다. |
| 이 기능을 중지하고 다시 암호를 사용하려면 어떻게 해야 하나요? | 개인 계정의 경우 로그인하는 동안 **암호를 대신 사용** 링크를 선택합니다. 가장 최근에 사용한 방법이 저장되어 다음에 로그인할 때 기본값으로 제공됩니다. 다시 휴대폰 로그인을 사용하려면 로그인하는 동안 **앱을 대신 사용** 링크를 선택합니다.<br><br>직장 또는 학교 계정의 경우 Microsoft 인증자 앱의 **설정** 페이지에서 장치를 등록 취소하거나 프로필의 **장치 & 활동** 영역에서 장치를 비활성화해야 합니다. 프로필에서 기기를 사용하지 않도록 설정하는 것에 대한 자세한 내용은 [내 앱 포털에서 프로필 및 계정 정보 업데이트를](my-apps-portal-end-user-update-profile.md#view-your-organization-related-profile-information)참조하세요. |
| 휴대폰 로그인에 회사 또는 학교 계정을 둘 이상 사용할 수 없는 이유는 무엇인가요? | 한 휴대폰은 하나의 회사 또는 학교 계정에 등록되어야 합니다. 다른 직장 또는 학교 계정에 대한 전화 로그인을 사용 설정하려면 **설정** 페이지를 통해 이 기기에서 계정을 등록 취소해야 합니다. |
...
- 보안 정보에 대한 자세한 내용은 [보안 정보(미리 보기) 개요를](user-help-security-info-overview.md) 참조하세요.
