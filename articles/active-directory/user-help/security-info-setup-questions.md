...
description: 미리 정의된 보안 질문을 확인 방법으로 사용하여 신원을 확인하기 위해 보안 정보(미리 보기) 페이지를 설정하는 방법.
...
ms.locfileid: "77063971"
---
# <a name="set-up-security-questions-as-your-verification-method"></a>보안 질문을 인증 방법으로 설정
...
>[!Note]
>보안 질문 옵션이 표시되지 않으면 조직에서 암호 재설정 방법에 이 옵션을 사용하지 않을 수 있습니다. 이 경우 다른 방법을 선택하거나 조직의 헬프 데스크에 문의하여 추가 도움을 받아야 합니다.
...
>
> 관리자 계정은 보안 질문을 암호 재설정 방법으로 사용할 수 없습니다. 관리자 수준 계정으로 로그인한 경우 이러한 옵션이 표시되지 않습니다.
