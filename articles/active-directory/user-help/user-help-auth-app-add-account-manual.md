...
1. 컴퓨터의 **인증자 설정** 페이지에서 QR 코드와 함께 표시된 **스캔할 수 없음**을 선택합니다.
...
4. 컴퓨터의 **인증자 설정** 페이지에서 앱에 제공된 Google 계정용 6자리 확인 코드를 입력한 다음, **확인**을 선택합니다.
...
4. 컴퓨터의 **2단계 인증자** 페이지에서 앱에 제공된 Facebook 계정용 6자리 확인 코드를 입력한 다음, **확인**을 선택합니다.
