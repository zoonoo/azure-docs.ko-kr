---
title: 확인 방법으로 전자 메일 주소를 설정 - Azure AD
description: 확인 방법으로 이메일 주소를 사용하여 신원을 확인하기 위해 보안 정보(미리 보기) 페이지를 설정하는 방법.
...
>[!Note]
>전자 메일 옵션이 표시되지 않으면 조직에서 암호 재설정 방법에 이 옵션을 사용하지 않을 수 있습니다. 이 경우 다른 방법을 선택하거나 조직의 헬프 데스크에 문의하여 추가 도움을 받아야 합니다.

## <a name="security-vs-password-reset-verification"></a>보안 대 암호 재설정 확인
