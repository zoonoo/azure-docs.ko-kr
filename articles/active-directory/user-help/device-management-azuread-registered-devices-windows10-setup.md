...
**BYOD(Bring Your Own Device)** 시나리오를 사용하도록 설정하려면 Azure AD 등록 장치를 구성합니다. Azure AD에서 Windows 10, iOS, Android 및 macOS용 Azure AD 등록 디바이스를 구성할 수 있습니다. 이 아티클에서는 Windows 10 디바이스의 관련 단계를 제공합니다. 


## <a name="before-you-begin"></a>시작하기 전에

Windows 10 디바이스를 등록하려면 디바이스를 등록할 수 있도록 디바이스 등록 서비스를 구성해야 합니다. 또한 구성된 최댓값보다 적은 수의 디바이스가 등록되어야 합니다. 자세한 내용은 [디바이스 설정 구성](../devices/device-management-azure-portal.md#configure-device-settings)을 참조하세요.
...
이 섹션에서는 Windows 10 디바이스를 Azure AD에 등록하는 단계를 제공합니다. 성공적으로 등록된 디바이스는 **작업 또는 학교 계정** 항목으로 표시됩니다.
...
또는 Azure AD 포털에서 디바이스 설정을 검토할 수 있습니다.
...
- 자세한 내용은 [Azure Active Directory의 디바이스 관리 소개](../device-management-introduction.md)를 참조하세요.
