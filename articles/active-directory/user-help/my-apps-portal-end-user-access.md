...
- [ **내 그룹** 포털로 이동](https://account.activedirectory.windowsazure.com/r#/groups)
- [ **내 계정** 포털로 이동 합니다.](https://myaccount.microsoft.com/)

**내 앱** 포털에 대 한 액세스 권한이 없는 경우 조직의 기술 지원팀에 문의 하세요.
...
1. 지원 되는 웹 브라우저에서로 이동 https://myapps.microsoft.com 하거나,와 같은 사용자 지정 페이지로 이동 하는 경우 조직에서 제공 하는 링크를 사용 `https://myapps.microsoft.com/contoso.com` 합니다.
...
**내 앱 보안 로그인 확장** 을 사용 하면 다음과 같은 작업을 할 수 있습니다.

- 로그인 페이지에서 앱에 직접 로그인합니다.
- **빠른 검색** 기능을 사용하여 앱을 시작합니다.
- **최근에 사용** 섹션에서 마지막으로 사용한 앱을 확인합니다.
- [응용 프로그램 프록시](../manage-apps/application-proxy.md)를 원격으로 사용 하는 경우 내부 회사 url을 사용 합니다.
...
## <a name="access-and-use-the-my-apps-portal-on-mobile-edge"></a>Mobile Edge에서 My Apps 포털 액세스 및 사용

장치의 Edge 브라우저 모바일 버전에서 조직의 앱을 보고 사용 합니다.

1. 모바일 장치에서 Apple 앱 스토어 및 Google Play 스토어에서 mobile Edge 브라우저 앱을 다운로드 하 여 설치 합니다.

1. Mobile Edge 브라우저를 열고로 이동 https://myapps.microsoft.com 하거나, 사용자 지정 된 페이지 (예:)로 이동 하는 경우 조직에서 제공 하는 링크를 사용 https://myapps.microsoft.com/contoso.com 합니다.
...
- 앱 계정을 만들고, 업데이트 하 고, 제거 합니다. 자세한 내용은 [응용 프로그램 사용 권한 편집 또는 해지](my-applications-portal-permissions-saved-accounts.md)를 참조 하세요.
- 계정 관리를 위해 **내 앱** 포털에서 [**내 계정**](my-account-portal-overview.md) 에 액세스 합니다.
  
  - 비정상적인 로그인 활동을 확인 하는 중
  - 암호 관리
  - 연결 된 장치, 구독, 조직 및 Office 앱 관리

>[!NOTE]
>사용 가능한 컬렉션이나 범주가 표시되지 않으면 관리자가 설정하지 않았거나 사용자와 공유하지 않은 것입니다. 공유 컬렉션을 보려면 조직의 지원 센터에 문의 하세요.
