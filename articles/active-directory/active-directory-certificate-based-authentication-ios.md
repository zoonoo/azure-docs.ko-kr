---
title: "iOS에서 인증서 기반 인증 시작 | Microsoft Docs"
...
ms.openlocfilehash: 7fb47b9f40f92b956cd2152d143cd510e2ff6f13


---
# <a name="get-started-with-certificate-based-authentication-on-ios---public-preview"></a>iOS에서 인증서 기반 인증 시작 - 공개 미리 보기
...
## <a name="supported-scenarios-and-requirements"></a>지원되는 시나리오 및 요구 사항
...
이 정보를 업로드하려면 Windows PowerShell을 통해 Azure AD 모듈을 사용할 수 있습니다.  
다음은 인증 기관을 추가, 제거 또는 수정하는 예제입니다. 
...
### <a name="adding-a-new-certificate-authority"></a>새 인증 기관 추가
...
### <a name="retrieving-the-list-certificate-authorities"></a>인증 기관 목록 검색
...
### <a name="testing-eas-client-applications-on-ios"></a>iOS에서 EAS 클라이언트 응용 프로그램 테스트
