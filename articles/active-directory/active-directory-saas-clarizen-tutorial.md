...
이 자습서는 Azure 및 Clarizen의 통합을 보여주기 위한 것입니다.  
...
![시나리오](./media/active-directory-saas-clarizen-tutorial/IC784679.png "Scenario")

## <a name="enabling-the-application-integration-for-clarizen"></a>Clarizen에 응용 프로그램 통합 사용
이 섹션은 Clarizen에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

### <a name="to-enable-the-application-integration-for-clarizen-perform-the-following-steps"></a>Clarizen에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
3. 응용 프로그램 보기를 열려면 디렉터리 보기의 최상위 메뉴에서 **응용 프로그램** 을 클릭합니다.
   ...
   ![응용 프로그램](./media/active-directory-saas-clarizen-tutorial/IC700994.png "Applications")
4. 페이지 맨 아래에 있는 **추가** 를 클릭합니다.
   
   ![응용 프로그램 추가](./media/active-directory-saas-clarizen-tutorial/IC749321.png "Add application")
5. **수행할 작업** 대화 상자에서 **갤러리에서 응용 프로그램 추가**를 클릭합니다.
   
   ![갤러리에서 응용 프로그램 추가](./media/active-directory-saas-clarizen-tutorial/IC749322.png "Add an application from gallerry")
6. **검색 상자**에 **Clarizen**을 입력합니다.
   
   ![응용 프로그램 갤러리](./media/active-directory-saas-clarizen-tutorial/IC784680.png "Application Gallery")
...
1. Azure 클래식 포털의 **Clarizen** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
   ...
   ![Single Sign-on 구성](./media/active-directory-saas-clarizen-tutorial/IC784682.png "Configure Single Sign-On")
2. **Clarizen에 대한 사용자 로그온 방법을 선택하세요.** 페이지에서 **Microsoft Azure AD Single Sign-on**을 선택하고 **다음**을 클릭합니다.
   
   ![Single Sign-on 구성](./media/active-directory-saas-clarizen-tutorial/IC784683.png "Configure Single Sign-On")
3. **Clarizen에서 Single Sign-On 구성** 페이지에서 인증서를 다운로드하려면 **인증서 다운로드**를 클릭한 다음 컴퓨터에 인증서 파일을 저장합니다.
   
   ![Single Sign-On 구성](./media/active-directory-saas-clarizen-tutorial/IC784684.png "Configure Single Sign-On")
...
5. 사용자 이름을 클릭한 다음 **설정**을 클릭합니다.
   ...
   ![설정](./media/active-directory-saas-clarizen-tutorial/IC784685.png "Settings")
6. **전역 설정** 탭을 클릭한 다음 **페더레이션 인증** 옆의 **편집**을 클릭합니다.
   
   ![전역 설정](./media/active-directory-saas-clarizen-tutorial/IC786906.png "Global Settings")
7. **페더레이션 인증** 대화 상자에서 다음 단계를 수행합니다.
   
   ![페더레이션 인증](./media/active-directory-saas-clarizen-tutorial/IC785892.png "Federated Authentication")
...
8. Azure 클래식 포털에서 Single Sign-On 구성 확인을 선택하고 **완료**를 클릭하여 **Single Sign-On 구성** 대화 상자를 닫습니다.
   ...
   ![Single Sign-on 구성](./media/active-directory-saas-clarizen-tutorial/IC784688.png "Configure Single Sign-On")
   
   ## <a name="configuring-user-provisioning"></a>사용자 프로비전 구성

Azure AD 사용자가 Clarizen에 로그인할 수 있도록 하려면 Clarizen로 프로비전되어야 합니다.  
Clarizen의 경우 프로비전은 수동 작업입니다.
...
2. **피플**을 클릭합니다.
   ...
   ![피플](./media/active-directory-saas-clarizen-tutorial/IC784689.png "People")
3. **사용자 초대**를 클릭합니다.
   
   ![사용자 초대](./media/active-directory-saas-clarizen-tutorial/IC784690.png "Invite Users")
4. 피플 초대 대화 상자 페이지에서 다음 단계를 수행합니다.
   
   ![피플 초대](./media/active-directory-saas-clarizen-tutorial/IC784691.png "Invite People")
...
### <a name="to-assign-users-to-clarizen-perform-the-following-steps"></a>Clarizen에 사용자를 할당하려면 다음 단계를 수행합니다.
1. Azure 클래식 포털에서 테스트 계정을 만듭니다.
2. **Clarizen** 응용 프로그램 통합 페이지에서 **사용자 할당**을 클릭합니다.
   
   ![사용자 할당](./media/active-directory-saas-clarizen-tutorial/IC784692.png "Assign Users")
3. 테스트 사용자를 선택하고 **할당**을 클릭한 다음 **예**를 클릭하여 할당을 확인합니다.
   
   ![예](./media/active-directory-saas-clarizen-tutorial/IC767830.png "Yes")
