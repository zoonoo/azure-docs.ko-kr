...
그룹 기반 라이선싱을 사용하는 경우 [이 오류 조건](active-directory-licensing-group-problem-resolution-azure-portal.md#conflicting-service-plans)이 발생합니다. PowerShell을 사용 하는 경우 *MutuallyExclusiveViolation* 오류가 발생합니다.

이 섹션은 가장 일반적인 상호 배타적 서비스 계획을 서비스 형식별로 그룹화하여 나열합니다. 이 정보를 사용하여 라이선스 배포를 계획하고 할당 오류를 방지할 수 있습니다.
