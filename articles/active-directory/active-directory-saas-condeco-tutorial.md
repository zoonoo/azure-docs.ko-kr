...
이 자습서는 Azure AD(Azure Active Directory)에 Condeco를 통합하는 방법을 보여 주기 위한 것입니다.<br>Azure AD에 Condeco를 통합하면 다음과 같은 이점을 얻을 수 있습니다.
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-condeco-tutorial/create_aaduser_06.png) <br>
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-condeco-tutorial/create_aaduser_07.png) <br>

8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-condeco-tutorial/create_aaduser_08.png) <br>
...
이 섹션의 목적은 Britta Simon에게 Condeco에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하는 것입니다. <br><br>![사용자 할당][200] <br>
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다.<br> 액세스 패널에서 Condeco 타일을 클릭하면 Condeco 응용 프로그램에 자동으로 로그온됩니다.
