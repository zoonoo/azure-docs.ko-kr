...
# 그룹 설정을 구성하는 Azure Active Directory cmdlets
 ...
 **설정** | **설명**                                                                                             
--------------------------------------|-----------------------------------------------
 <ul><li>ClassificationList<li>형식: 문자열<li>기본값: “” | 통합 그룹에 적용할 수 있는 유효한 분류 값을 쉼표로 구분한 목록입니다.                
 <ul><li>EnableGroupCreation<li>형식: 부울<li>기본값: True | 디렉터리에서 통합 그룹 만들기가 허용되는지 나타내는 플래그입니다.                               
 <ul><li>GroupCreationAllowedGroupId<li>형식: 문자열<li>기본값: "" | EnableGroupCreation == false일 때도 통합 그룹을 만들도록 허용된 보안 그룹의 GUID입니다.
...
## SettingsTemplate 개체 참조(Group.Unified SettingsTemplate 개체)
