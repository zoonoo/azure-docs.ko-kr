...
3. **Samanage 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<Company Name>.samanage.com` 패턴을 사용하여 URL을 입력합니다.
...
10. **SAML을 사용하여 로그인** 섹션으로 이동하고 다음 단계를 수행합니다.
    ...
    b. Azure Portal에서 복사한 **SAML 엔터티 ID** 값을 **Identity Provider URL**(ID 공급자 URL) 텍스트 상자에 붙여넣습니다.    
 
    c. **로그인 URL**이 Azure Portal **Samanage 도메인 및 URL**의 **로그온 URL**과 일치하는지 확인합니다.
