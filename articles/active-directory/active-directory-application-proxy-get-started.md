...
## 시작하는 방법
Azure AD 기본 또는 프리미엄 구독이 있고 자신이 전역 관리자인 Azure AD 디렉터리가 있는지 확인합니다. 앱에 액세스하는 디렉터리 관리자 및 사용자용 Azure AD 기본 또는 프리미엄 라이선스도 필요합니다. Azure AD 버전에 대한 자세한 내용은 [여기](active-directory-editions.md)를 참조하세요.
