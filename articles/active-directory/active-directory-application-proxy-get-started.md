...
요즈음 직원은 어디서나 언제든지 어느 장치에서나 생산성을 높이기를 원합니다. 태블릿, 휴대폰 또는 랩톱을 막론하고 자신의 장치에서 일하기를 원합니다. 그리고 자신의 모든 응용 프로그램, 즉 클라우드의 응용 프로그램뿐만 아니라 다른 온-프레미스 회사 앱에도 액세스할 수 있는 것으로 기대합니다. 온-프레미스 응용 프로그램에 대한 액세스를 제공하려면 일반적으로 가상 사설망(VPN), 완충 영역(DMZ) 또는 온-프레미스 역방향 프록시가 필요했습니다. 이러한 솔루션은 복잡하고 안전하게 만들기도 어려울 뿐만 아니라 설정과 관리에도 비용이 많이 듭니다.
...
Azure AD 응용 프로그램 프록시는 온-프레미스에 호스트된 웹 응용 프로그램에 대한 SSO(Single Sign-On) 및 보안된 원격 액세스를 제공합니다. 이는 SharePoint 사이트, Outlook Web Access 또는 사용자가 가지고 있는 다른 LOB 웹 응용 프로그램을 포함할 수 있습니다. 이러한 온-프레미스 웹 응용 프로그램은 Azure AD, 동일한 ID 및 O365에서 사용되는 제어 플랫폼과 통합됩니다. 그 후 최종 사용자는 VPN 또는 네트워크 인프라를 변경할 필요 없이 O365 및 Azure AD와 통합된 다른 SaaS 앱에 액세스할 때와 같은 방법으로 온-프레미스 응용 프로그램에 액세스할 수 있습니다.
