...
## <a name="enable-the-application-integration-for-cisco-webex"></a>Cisco Webex에 응용 프로그램 통합 사용
...
이 절차의 일부로 base-64로 인코딩된 인증서 파일을 만들어야 합니다. 이 절차를 잘 모르는 경우 [이진 인증서를 텍스트 파일로 변환하는 방법](http://youtu.be/PlgrzUZ-Y1o)
