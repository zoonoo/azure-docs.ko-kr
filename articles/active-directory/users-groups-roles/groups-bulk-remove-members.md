---
title: csv 파일을 업로드하여 그룹 구성원을 일괄 제거 - Azure Active Directory | 마이크로 소프트 문서
...
ms.locfileid: "72517096"
---
# <a name="bulk-remove-group-members-preview-in-azure-active-directory"></a>Azure Active Directory에서 그룹 구성원을 일괄 제거(미리 보기)
...
1. 대량 **제거 그룹 구성원(미리 보기)** 페이지에서 **다운로드를** 선택하여 필요한 그룹 구성원 속성이 있는 CSV 파일 템플릿을 가져옵니다.
...
1. 대량 **제거 그룹 구성원(미리 보기)** 페이지에서 **csv 파일 업로드에서**파일을 찾아봅니다. 파일을 선택하면 .csv 파일의 유효성 검사가 시작됩니다.
