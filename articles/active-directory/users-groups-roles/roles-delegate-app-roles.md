...
1. [your Azure AD organization](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview)   조직의 응용 프로그램 관리자 또는 클라우드 응용 프로그램 관리자에 게 적합 한 계정을 사용 하 여 Azure AD 조직에 로그인 합니다.
