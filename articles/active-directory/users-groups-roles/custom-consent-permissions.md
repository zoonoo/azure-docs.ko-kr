...
> [!NOTE]
> Azure AD 관리 포털에서는 아직 이 문서에 나열된 권한을 사용자 지정 디렉터리 역할 정의에 추가하는 것을 지원하지 않습니다. 이 문서에 나열된 권한이 있는 [사용자 지정 디렉터리 역할을 만들려면 Azure AD PowerShell을 사용해야 합니다](roles-create-custom.md#create-a-role-using-powershell).
...
- [Azure Portal, Azure AD PowerShell 및 Graph API를 사용하여 사용자 지정 역할 만들기](roles-create-custom.md)
