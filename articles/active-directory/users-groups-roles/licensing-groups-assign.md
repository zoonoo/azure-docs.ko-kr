...
1. **라이선스 할당** 페이지에서 이전에 선택한 두 제품에 포함 된 모든 서비스 계획을 표시 하는 **할당 옵션**을 클릭 합니다. **Yammer Enterprise**를 찾은 후 **해제**하여 제품 라이선스에서 해당 서비스를 사용하지 않도록 설정합니다. **라이선스 옵션**아래에서 **확인을** 클릭 하 여 확인 합니다.
