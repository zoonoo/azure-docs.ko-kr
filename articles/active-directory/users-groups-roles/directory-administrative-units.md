...
이 문서에서는 사용자의 하위 집합에 대 한 관리 권한을 위임 하 고 일부 사용자에 게 정책을 적용 하는 데 사용할 수 있는 리소스 컨테이너인 Azure Active Directory (Azure AD)의 관리 단위에 대해 설명 합니다. Azure AD에서 관리 단위를 통해 중앙 관리자는 지역 관리자에 게 권한을 위임 하거나 세부적인 수준에서 정책을 설정할 수 있습니다.
...
> [!IMPORTANT]
> 관리 단위를 사용 하려면 관리 단위 관리자가 Azure Active Directory Premium 라이선스를 보유 해야 합니다. 자세한 내용은 [Azure AD Premium 시작을 참조하세요](../fundamentals/active-directory-get-started-premium.md).
>
