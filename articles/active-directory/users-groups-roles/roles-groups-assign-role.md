...
1. ***역할 이름*** 페이지에서 **할당 > 추가**를 선택 합니다.

   ![새 역할 할당 추가](./media/roles-groups-assign-role/add-assignment.png)

1. 그룹을 선택합니다. Azure AD 역할에 할당 될 수 있는 그룹만 표시 됩니다.

    [![할당 가능한 그룹만 새 역할 할당에 대해 표시 됩니다.](media/roles-groups-assign-role/eligible-groups.png "할당 가능한 그룹만 새 역할 할당에 대해 표시 됩니다.")](media/roles-groups-assign-role/eligible-groups.png#lightbox)
