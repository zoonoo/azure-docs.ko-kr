...
### <a name="compliance-data-administrator"></a>[준수 데이터 관리자](#compliance-data-administrator-permissions)
...
### <a name="device-administrator"></a>[장치 관리자](#device-administrators-permissions)
...
### <a name="directory-readers"></a>[디렉터리 판독기](#directory-readers-permissions)
...
> [!NOTE]
> Microsoft Graph API 및 Azure AD PowerShell에서이 역할은 "Dynamics 365 Service Administrator"로 식별 됩니다. [Azure Portal](https://portal.azure.com)에서 이 역할은 "Dynamics 365 관리자"입니다.
...
> [!NOTE]
> Microsoft Graph API 및 Azure AD PowerShell에서이 역할은 "Exchange 서비스 관리자"로 식별 됩니다. [Azure Portal](https://portal.azure.com)에서 이 역할은 "Exchange 관리자"입니다. [Exchange 관리 센터](https://go.microsoft.com/fwlink/p/?LinkID=529144)의 "exchange Online administrator"입니다.
...
### <a name="global-reader"></a>[전역 판독기](#global-reader-permissions)
...
### <a name="message-center-reader"></a>[메시지 센터 판독기](#message-center-reader-permissions)
...
> [!NOTE]
> Microsoft Graph API 및 Azure AD PowerShell에서이 역할은 "Power BI 서비스 관리자"로 식별 됩니다. [Azure Portal](https://portal.azure.com)에서 이 역할은 "Power BI 관리자"입니다.
...
이 역할을 가진 사용자는 경고를 관리 하 고 보안 관련 기능에 대 한 전역 읽기 전용 액세스 권한 (Microsoft 365 security center, Azure Active Directory, Id 보호, Privileged Identity Management 및 Office 365의 모든 정보 포함)을 사용할 수 있습니다. 보안 및 준수 센터. Office 365 사용 권한에 대한 자세한 정보는 [Office 365 보안 및 규정 준수 센터의 사용 권한](https://docs.microsoft.com/office365/securitycompliance/permissions-in-the-security-and-compliance-center)에서 제공됩니다.
...
> [!NOTE]
> Microsoft Graph API 및 Azure AD PowerShell에서이 역할은 "SharePoint 서비스 관리자"로 식별 됩니다. [Azure Portal](https://portal.azure.com)에서 이 역할은 "SharePoint 관리자"입니다.
...
### <a name="teams-service-administrator"></a>[팀 서비스 관리자](#teams-service-administrator-permissions)
