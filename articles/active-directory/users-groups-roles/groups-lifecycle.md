...
1. 만료 설정 구성 New-AzureADMSGroupLifecyclePolicy cmdlet을 사용 하 여 Azure AD 조직에 있는 모든 Microsoft 365 그룹의 수명을 365 일로 설정 합니다. 소유자가 없는 Microsoft 365 그룹에 대 한 갱신 알림이 ' ' (으)로 전송 됩니다. emailaddress@contoso.com
