...
![동기화 오류 진단 단계](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixSteps.png)
...
![동기화 오류 분리된 개체 진단 *사용자 있음* 시나리오](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![동기화 오류 분리된 개체 진단 *동일한 사용자* 시나리오](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixOrphanedCase.png)
...
![수정 후 동기화 오류 진단](./media/active-directory-aadconnect-health-sync-iidfix/IIdFixAfterFix.png)
