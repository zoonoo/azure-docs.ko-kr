...
이 자습서에서는 Kindling과 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다.  
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Kindling 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Kindling의 관련 사용자 간에 연결이 형성되어야 합니다.  
...
Kindling에 Single Sign-On을 구성하려면 등록된 도메인이 필요합니다. 등록된 도메인이 아직 없는 경우 [support@kindlingapp.com](mailto:support@kindlingapp.com)을 참조하세요.  
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에 `https://<company name>.kindlingapp.com/` 패턴을 사용하여 사용자가 Kindling 응용 프로그램에 로그온하는 데 사용할 URL을 입력합니다.

    b. **발급자** 및 **회신 URL** 값을 가져오려면 [support@kindlingapp.com](mailto:support@kindlingapp.com)을 통해 Kindling 지원팀에 문의합니다.   
...
1. **Kindling에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
...
2.  [support@kindlingapp.com](mailto:support@kindlingapp.com) 을 통해 Kindling 지원 팀에 문의하고 다음을 제공합니다.
...
이 섹션은 Kindling에서 Britta Simon이라는 사용자를 만들기 위한 것입니다.
Kindling은 Just-In-Time 프로비전을 지원합니다. 이미 [Azure AD Single Sign-On 구성](#configuring-azure-ad-single-single-sign-on)에서 사용하도록 설정했습니다.
