...
1. Azure 클래식 포털의 **Kindling** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다. <br><br> ![Single Sign-On 구성][6] <br>
...
4. **Kindling에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-kindling-tutorial/tutorial_kindling_05.png) <br>
    ...
    b. Kindling 지원팀에 문의하고 응용 프로그램에 SSO를 설치하도록 요청합니다. 다운로드한 인증서, Kindling의 **엔터티 ID**에 매핑되는 **발급자 URL** 값, Kindling의 **SSO Sign-on URL**에 매핑하는 **Single Sign-On 서비스 URL** 및 Kindling의 **SSO 로그아웃 URL**에 매핑하는 **Single Sign-Out 서비스 URL**을 지원팀을 제공해야 합니다.
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-kindling-tutorial/create_aaduser_09.png) <br> 
