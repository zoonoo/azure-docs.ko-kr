...
4. 그런 다음 IDP는 유효성을 검사하고 인증 토큰을 발급하여 사용자 및 장치가 보호된 리소스에 액세스할 수 있도록 합니다. IDP는 크로스 플랫폼 앱을 작성하거나 JavaScript/Webcrypto API를 통해 브라우저 지원을 사용하여 해당 사용자에 대한 Microsoft Passport 자격 증명을 만들고 사용할 수 있습니다.
