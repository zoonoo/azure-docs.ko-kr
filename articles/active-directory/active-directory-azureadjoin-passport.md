...
Microsoft Passport 인증 수명 주기 ![](./media/active-directory-azureadjoin/active-directory-azureadjoin-microsoft-passport.png) 위의 다이어그램에서는 개인-공개 키 쌍과 ID 공급자의 유효성 검사를 보여 줍니다. 각 단계는 아래에 자세히 설명되어 있습니다.
