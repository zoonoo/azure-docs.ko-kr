...
[Azure Portal](https://portal.azure.com)에서는 SAML 토큰으로 애플리케이션에 전송된 클레임을 보거나 편집할 수 있습니다. 설정에 액세스 하려면 **single sign-on**을 > Single Sign-On 하도록 구성 된 응용 프로그램 > **Azure Active Directory** > **엔터프라이즈 응용 프로그램** 을 선택 합니다. SAML 토큰 설정은 **사용자 특성** 섹션을 참조하세요.
