...
[Azure Portal](https://portal.azure.com)에서는 SAML 토큰으로 애플리케이션에 전송된 클레임을 보거나 편집할 수 있습니다. 설정에 액세스하려면 단일 사인온 > **Single Sign-On에**대해 구성된 응용 프로그램을 > **Azure Active Directory** > **Enterprise 응용** 프로그램을 선택합니다. SAML 토큰 설정은 **사용자 특성** 섹션을 참조하세요.
