...
보안 정책 및 규정 준수: 호스트/초대한 조직에 의해 관리됩니다(예: [조건부 액세스 정책](https://docs.microsoft.com/azure/active-directory/b2b/conditional-access) 사용).  | 보안 정책 및 규정 준수: 응용 프로그램에 의해 관리됩니다.
