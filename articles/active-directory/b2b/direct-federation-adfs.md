...
4. **Select Data Source**에 대 한 신뢰 당사자 트러스트 추가 마법사에서 **온라인 또는 로컬 네트워크에 게시 된 신뢰 당사자에 대 한 데이터 가져오기**옵션을 사용 합니다. 이 페더레이션 메타 데이터 URL을 https://nexus.microsoftonline-p.com/federationmetadata/saml20/federationmetadata.xml지정 합니다. 다른 기본 선택 항목을 유지 합니다. **닫기**를 선택합니다.
...
1. 신뢰 당사자 트러스트 추가 마법사에서 **데이터 원본 선택**에 대해 **온라인 또는 로컬 네트워크에 게시 된 신뢰 당사자에 대 한 데이터 가져오기**옵션을 사용 합니다. 페더레이션 메타 데이터 URL `https://nexus.microsoftonline-p.com/federationmetadata/2007-06/federationmetadata.xml`을 지정 합니다.  다른 기본 선택 항목을 유지 합니다. **닫기**를 선택합니다.
