...
Azure AD(Active Directory) B2B(기업 간) 협업 시에는 유료 Azure AD 서비스를 사용하도록 외부 사용자("게스트 사용자")를 초대할 수 있습니다. 사용자에게 할당하는 유료 Azure AD 라이선스마다 외부 사용자 허용에 따라 게스트 사용자를 5명까지 초대할 수 있습니다.
