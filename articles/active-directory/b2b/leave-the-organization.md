...
> [!NOTE]
> 게스트 사용자는 계정이 홈 테 넌 트 또는 리소스 테 넌 트에서 사용 하지 않도록 설정 된 경우 조직을 벗어날 수 없습니다. 계정이 사용 하지 않도록 설정 된 경우 게스트 사용자는 테 넌 트 관리자에 게 문의 해야 합니다. 여기서 게스트 계정을 삭제 하거나 게스트 계정을 사용 하도록 설정 하 여 사용자가 조직을 나갈 수 있습니다.
