...
7. **액세스 보안** 탭을 클릭한 후 **설정 변경**을 클릭합니다.

    ![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_08.png) 
    
8. **인증서 변경** 대화 상자 페이지에서 다운로드한 인증서를 업로드하려면 **파일 선택**을 클릭한 후, **다음**을 클릭합니다.

    ![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png) 

9. Azure 클래식 포털의 **Mixpanel single sign-on 구성** 대화 상자 페이지에서 **Single Sign-on 서비스 URL** 값을 복사하여 **인증 URL을 변경** 대화 상자 페이지에서 인증 URL 텍스트 상자에 붙여넣은 후, **다음**을 클릭합니다.
