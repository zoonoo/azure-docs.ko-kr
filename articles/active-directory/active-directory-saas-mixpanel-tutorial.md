<properties
	pageTitle="자습서: Mixpanel과 Azure Active Directory 통합 | Microsoft Azure"
...
이 자습서는 Azure AD(Azure Active Directory)에 Mixpanel을 통합하는 방법을 보여 주기 위한 것입니다.<br>Azure AD에 Mixpanel을 통합하면 다음과 같은 이점을 얻을 수 있습니다.
...
6. 검색 상자에 **Mixpanel**을 입력합니다.<br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_01.png)<br>
7. 결과 창에서 **Mixpanel**을 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다. <br><br>

##  Azure AD Single Sign-on 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Mixpanel에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위한 것입니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Mixpanel 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자 및 Mixpanel의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Mixpanel의 **Username** 값으로 할당하여 설정합니다.

Mixpanel에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Mixpanel 테스트 사용자 만들기](#creating-a-mixpanel-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Mixpanel에 만듭니다.
...
1. Azure 클래식 포털의 **Mixpanel** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다. <br><br> ![Single Sign-On 구성][6] <br>

2. **Mixpanel에 대한 사용자 로그인 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다. <br><br> ![Single Sign-On 구성](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_03.png) <br>

3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_04.png) <br>
...
4. **Mixpanel의 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_05.png) <br>
...
5. 다른 브라우저 창에서 Mixpanel 응용 프로그램에 관리자 권한으로 로그인합니다.
   
6. 페이지 왼쪽 아래에 있는 작은 **기어**아이콘을 클릭합니다. <br><br>![Mixpanel Single Sign-On](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_06.png) <br>

7. **액세스 보안** 탭을 클릭 한 후 **설정 변경**을 클릭합니다. <br><br>![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_08.png) <br>
    
8. **인증서 변경** 대화 상자 페이지에서 다운로드한 인증서를 업로드하기 위해 **파일 선택**을 클릭한 다음에 **다음**을 클릭합니다. <br><br>![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png) <br>

9. Azure 클래식 포털의 **Mixpanel single sign-on 구성** 도구 상자 페이지에서 **Single Sign-on 서비스 URL** 값을 복사하여 **인증 URL을 변경** 도구 상자 페이지에서 인증 URL 텍스트 상자에 붙여 넣은 다음 **다음**을 클릭합니다. <br><br>![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_10.png) <br>
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_09.png) <br>
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_05.png) <br>
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_06.png) <br>
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_07.png) <br>
...
4. **팀 멤버** 텍스트 상자에 Azure에 있는 Britta의 메일 주소를 입력합니다. <br><br>![Mixpanel 설정](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_11.png) <br>
...
이 섹션은 Britta Simon에게 Mixpanel에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하기 위한 것입니다. <br><br>![사용자 할당][200] <br>
...
2. 응용 프로그램 목록에서 **Mixpanel**을 선택합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_50.png) <br>
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다.<br> 액세스 패널에서 Mixpanel 타일을 클릭하면 Mixpanel 응용 프로그램에 자동으로 로그인됩니다.
