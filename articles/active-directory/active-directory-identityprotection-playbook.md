<properties
	pageTitle="Azure Active Directory ID 보호 플레이 북 | Microsoft Azure"
...
로그인이 2-4시간 이내에 ID 보호 대시보드에 나타납니다.<br> 포함된 복잡한 기계 학습 모델 때문에 선택되지 않을 수 있습니다.<br> 여러 Azure AD 계정에 이러한 단계를 복제할 수도 있습니다.
...
14. 이제 위험 수준이 상승한 사용자로 로그인하여 위험 기반 조건부 액세스를 테스트할 수 있습니다. 사용자 위험이 보통인 경우 정책 구성에 따라 로그인이 차단되거나 암호를 변경하도록 강제됩니다. <br><br> ![플레이 북](./media/active-directory-identityprotection-playbook/201.png "플레이 북") <br>
...
11.	이제 둘 다 **보통** 위험 이벤트이기 때문에 알 수 없는 위치 또는 익명 IP 위험 이벤트를 시뮬레이트하여 위험 기반 조건부 액세스를 테스트할 수 있습니다.

<br> ![플레이 북](./media/active-directory-identityprotection-playbook/200.png "플레이 북") <br>
