...
>[!TIP]
>피드백에 대 한 참조는 [Azure 지원 페이지](http://go.microsoft.com/fwlink/?LinkId=521878)합니다. 
> 
...
## <a name="enable-the-application-integration-for-salesforce-sandbox"></a>Salesforce 샌드박스에 응용 프로그램 통합 사용
...
10. SAML Single Sign-On 설정 섹션에서 다음 단계를 수행합니다.
 ...
 2. Azure 클래식 포털의 **Salesforce Sandbox에서 Single Sign-On 구성** 대화 상자 페이지에서 **발급자 URL** 값을 복사하여 **발급자** 텍스트 상자에 붙여넣습니다.
...
**Salesforce 샌드박스에 사용자를 할당하려면 다음 단계를 수행합니다.**
...
SSO 설정을 테스트하려면 액세스 패널을 엽니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 참조하세요.
