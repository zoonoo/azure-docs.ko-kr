...
6. **SuccessFactors 구성** 섹션에서 **SuccessFactors 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
    ...
    ![Single Sign-on 구성](./media/active-directory-saas-successfactors-tutorial/tutorial_successfactors_configure.png) 
...
10. 아래 스크린샷으로 이동하고 다음 작업을 수행합니다.
    ...
    c. **발급자 URL** 텍스트 상자에 Azure Portal에서 복사한 **SAML 엔터티 ID** 값을 붙여넣습니다.
