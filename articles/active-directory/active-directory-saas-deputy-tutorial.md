...
3. **앱 설정 구성** 대화 상자 페이지에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행하고 **다음**을 클릭합니다.
    ...
    b. **회신 URL** 텍스트 상자에 `https://<your-subdomain>.<region>.deputy.com/exec/devapp/samlacs` 패턴으로 URL을 입력합니다.
...
8. 이 **보안 설정** 페이지에서 아래 단계를 수행합니다.
    ...
    c. SAM SSO URL 텍스트 상자에 `https://<your subdomain>.deputy.com/exec/devapp/samlacs?dpLoginTo=<saml sso url>`
...
2.  탐색 창 상단에서 **사람**을 클릭합니다.
    ...
    ![사람](./media/active-directory-saas-deputy-tutorial/tutorial_deputy_001.png "People")

3.  **구성원 추가** 단추를 클릭하고 **단일 구성원 추가**를 클릭합니다.

    ![구성원 추가](./media/active-directory-saas-deputy-tutorial/tutorial_deputy_002.png "Add People")

4.  다음 단계를 수행하고 **저장 및 초대**를 클릭합니다.

    ![새 사용자](./media/active-directory-saas-deputy-tutorial/tutorial_deputy_003.png "New User")
