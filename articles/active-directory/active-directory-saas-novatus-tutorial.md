...
* 사용자가 해당 Azure AD 계정으로 Novatus SSO(Single Sign-on)에 자동으로 로그온되도록 설정할 수 있습니다.
...
* Azure AD 구독
* Novatus SSO(Single Sign-on)가 설정된 구독
...
## <a name="add-novatus-from-the-gallery"></a>갤러리에서 Novatus 추가
...
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Novatus에서 Azure AD SSO를 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

SSO가 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Novatus 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Novatus의 관련 사용자 간에 연결이 형성되어야 합니다.
...
3. **[Novatus 테스트 사용자 만들기](#creating-a-Novatus-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Novatus에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성
이 섹션은 Azure 클래식 포털에서 Azure AD SSO를 사용하도록 설정하고 Novatus 응용 프로그램에서 SSO를 구성하는 방법을 설명하기 위한 것입니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
  ...
  * 로그온 URL 텍스트 상자에 **“https://sso.novatuscontracts.com/companyname”**의 패턴을 사용하여 사용자가 Novatus 응용 프로그램에 로그온하는 데 사용할 URL을 입력합니다. **companyname** 을 실제 이름으로 교체해야 하는 일반 이름을 참조하는 경우
...
### <a name="create-a-novatus-test-user"></a>Novatus 테스트 사용자 만들기
...
>[!NOTE]
>사용자를 수동으로 만들어야 하는 경우 Novatus 지원 팀에 문의해야 합니다. 
> 
