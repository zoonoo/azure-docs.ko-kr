...
이 자습서는 Azure AD(Azure Active Directory)에 Novatus를 통합하는 방법을 보여 주기 위한 것입니다.<br>Azure AD에 Novatus를 통합하면 다음과 같은 이점을 얻을 수 있습니다.
...
6. 검색 상자에서 **Novatus**를 입력합니다.<br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_01.png)<br>
7. 결과 창에서 **Novatus**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_02.png)<br>

##  Azure AD Single Sign-on 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Novatus에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Novatus 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Novatus의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Novatus의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션은 Azure AD 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Novatus 응용 프로그램에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.



**Novatus에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure AD 포털의 **Novatus** 응용 프로그램 통합 페이지에서 **Single Sign-on 구성**을 클릭하여 **Single Sign-on 구성** 대화 상자를 엽니다. <br><br> ![Single Sign-On 구성][6] <br>

2. **Novatus에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.<br><br> ![Single Sign-On 구성](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_03.png) <br>

3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_04.png) <br>


    a. 로그인 URL 텍스트 상자에 다음의 패턴을 사용하여 사용자가 Novatus 응용 프로그램에 로그인하는 데 사용할 URL을 입력합니다. **“https://sso.novatuscontracts.com/companyname”**. **companyname**을 실제 이름으로 교체해야 하는 일반 이름을 참조하는 경우


4. **Novatus의 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_05.png) <br>
...
1. **Azure 관리 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다.<br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_09.png) <br>

2. **디렉터리** 목록에서 디렉터리 통합을 사용하도록 설정할 디렉터리를 선택합니다.

3. 사용자 목록을 표시하려면 위쪽 메뉴에서 **사용자**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_03.png) <br>

4. **사용자 추가** 대화 상자를 열려면 아래쪽 도구 모음에서 **사용자 추가**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_04.png) <br>

5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_05.png) <br>
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_06.png) <br>
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_07.png) <br>

8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-novatus-tutorial/create_aaduser_08.png) <br>
...
이 섹션은 Britta Simon에게 Novatus에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하기 위한 것입니다. <br><br>![사용자 할당][200] <br>
...
2. 응용 프로그램 목록에서 **Novatus**를 선택합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-novatus-tutorial/tutorial_novatus_50.png) <br>
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다.<br> 액세스 패널에서 Novatus 타일을 클릭하면 Novatus 응용 프로그램에 자동으로 로그온됩니다.
