...
* 사용자가 해당 Azure AD 계정으로 FileCloud에 자동으로 로그온(Single Sign-on)되도록 설정할 수 있습니다.
...
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 FileCloud에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.
...
이 섹션에서는 클래식 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 FileCloud 응용 프로그램에서 Single Sign-On을 구성합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행하고 **다음**을 클릭합니다.
    ...
    a. **로그온 URL** 텍스트 상자에서 `https://<subdomain>.filecloudhosted.com` 패턴을 사용하여 URL을 입력합니다.
...
### <a name="creating-a-filecloud-test-user"></a>FileCloud 테스트 사용자 만들기
...
이 섹션의 목적은 Britta Simon에게 FileCloud에 대한 액세스 권한을 부여하여 Azure Single Sign-On을 사용할 수 있도록 하는 것입니다.
