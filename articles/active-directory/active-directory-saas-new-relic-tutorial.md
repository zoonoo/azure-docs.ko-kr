...
2.  **New Relic에 대한 사용자 로그온 방법을 선택하십시오.** 페이지에서 **Microsoft Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
7.  **보안 및 인증** 탭을 클릭한 후 **Single sign on** 탭을 클릭합니다.
    ...
    ![SSO(Single sign-on)](./media/active-directory-saas-new-relic-tutorial/IC797037.png "SSO(Single sign-on)")
...
8.  SAML 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    2.  Azure 클래식 포털의 **New Relic에서 Single Sign-On 구성** 페이지에서 **원격 로그인 URL** 값을 복사한 다음 **원격 로그인 URL** 텍스트 상자에 붙여넣습니다.
    3.  Azure 클래식 포털의 **New Relic에서 Single Sign-On 구성** 페이지에서 **원격 로그아웃 URL** 값을 복사한 다음 **로그아웃 방문 URL** 텍스트 상자에 붙여넣습니다.
...
>[AZURE.NOTE]다른 New Relic 사용자 계정 생성 도구 또는 New Relic이 제공한 API를 사용하여 AAD 사용자 계정을 프로비전할 수 있습니다.
