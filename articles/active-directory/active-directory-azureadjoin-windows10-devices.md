...
## Windows 10에서 Azure AD 조인 및 도메인 가입된 회사 소유의 장치 사용
...
## Azure AD에 도메인 가입을 사용하기 위한 요구 사항
...
Windows 10에서 도메인 조인에 대한 자세한 내용은 <link-to-DJ-in-Win10-deployment-guide>을(를) 참조하세요.

## BYOD 및 "회사 또는 학교 계정 추가" 사용을 위한 요구 사항
...
## Microsoft Passport 사용을 위한 요구 사항
...
## 질문과 대답
### Azure AD와 통합되는 파트너 모바일 장치 관리 제품은 무엇인가요?
...
### 사용자가 Windows 10의 해당 도메인 계정에 해당 Microsoft 계정을 연결할 수 있나요?
