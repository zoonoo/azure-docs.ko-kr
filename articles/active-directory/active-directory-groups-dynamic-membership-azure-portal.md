...
이 기능을 지원하기 위해 Azure Portal을 업데이트 하는 중입니다. 그 전까지 [Azure 클래식 포털](https://manage.windowsazure.com)([여기](active-directory-groups-dynamic-membership-azure-portal.md)의 지침에 따라)을 사용하거나 다음과 같이 PowerShell cmdlet을 사용할 수 있습니다.
