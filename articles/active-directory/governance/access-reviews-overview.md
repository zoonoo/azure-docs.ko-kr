...
| 시나리오 | 계산 | 필요한 라이선스 수 |
| --- | --- | --- |
| 관리자가 500 사용자로 그룹 A에 대 한 액세스 검토를 만듭니다.<br/>3 개의 그룹 소유자를 검토자로 할당 합니다. | 1 명의 관리자 + 3 그룹 소유자 | 4 |
| 관리자가 500 사용자로 그룹 A에 대 한 액세스 검토를 만듭니다.<br/>자체 검토를 수행 합니다. | 사용자 1 명의 관리자 + 500 사용자를 자체 검토자로 | 501 |
| 관리자는 5 명의 사용자와 25 명의 게스트 사용자가 있는 그룹 A에 대 한 액세스 검토를 만듭니다.<br/>자체 검토를 수행 합니다. | 1 명의 관리자 + 5 명의 사용자를 자체 검토자로<br/>(게스트 사용자는 필요한 1:5 비율로 적용 됩니다.) | 6 |
| 관리자가 사용자 5 명 및 28 게스트 사용자가 있는 그룹 A에 대 한 액세스 검토를 만듭니다.<br/>자체 검토를 수행 합니다. | 사용자 1 명의 관리자 + 5 명의 사용자가 게스트 사용자에 게 필요한 1:5 비율 내에서 사용자를 처리할 수 있는 사용자 1 명 | 7 |
