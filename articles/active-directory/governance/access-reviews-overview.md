...
| 관리자가 6 명의 멤버 사용자 및 108 게스트 사용자를 사용 하 여 그룹 D에 대 한 액세스 검토를 만듭니다. 자체 검토를 수행 합니다. | 각 사용자에 대 한 라이선스 6 개-모든 108 게스트 사용자에 게 필요한 1:5 비율 내에 있는 자체 검토자 + 16 추가 라이선스 6\*5 = 30 게스트 사용자를 포함 하는 라이선스 나머지 (108-6\*5) = 78 게스트 사용자의 경우 78/5 = 16 추가 라이선스가 필요 합니다. 따라서 총 6 + 16 = 22 개의 라이선스가 필요 합니다. | 22 |
