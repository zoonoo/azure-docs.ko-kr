...
| resource | 사용자에 게 사용 권한을 부여할 수 있는 자산 또는 서비스 (예: 그룹, 응용 프로그램 또는 사이트)입니다. |
...
| 할당 된 사용자 | 사용자 또는 그룹에 액세스 패키지를 할당 합니다. |
