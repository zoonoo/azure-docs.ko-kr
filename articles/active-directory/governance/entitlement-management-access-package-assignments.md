---
title: Azure AD 자격 관리 (미리 보기)에서 액세스 패키지에 대 한 할당 보기, 추가 및 제거-Azure Active Directory
description: Azure Active Directory 자격 관리 (미리 보기)에서 액세스 패키지에 대 한 할당을 확인, 추가 및 제거 하는 방법에 대해 알아봅니다.
