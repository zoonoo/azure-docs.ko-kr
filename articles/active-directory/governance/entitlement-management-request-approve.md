...
1. [https://myaccess.microsoft.com](https://myaccess.microsoft.com)에서 내 액세스 포털에 로그인 합니다.  (미국 정부의 경우 내 액세스 포털 링크의 도메인이 `myaccess.microsoft.us`됩니다.)
