...
또 다른 예로 조건부 액세스의 [명명 된 위치](../conditional-access/location-condition.md) 를 사용 하 여 사용자가 테 넌 트에 액세스 하지 못하도록 할 수 있는 지방 및 지역 집합을 구성할 수 있습니다.
...
5. 사용자가 검토 요청에 응답 하지 않으면 해당 사용자는 그룹에서 자동으로 제거 되므로 해당 국가/지역으로 이동 하는 동안 더 이상 테 넌 트에 액세스할 수 없습니다.
