...
* 내 액세스 포털에서 사용자가 요청자 이자 승인자 인 경우 **승인** 페이지에서 액세스 패키지에 대 한 요청이 표시 되지 않습니다. 이 동작은 의도적인 것입니다. 사용자가 자신의 요청을 승인할 수 없습니다. 요청 하는 액세스 패키지에 정책에 구성 된 추가 승인자가 있는지 확인 합니다. 자세한 내용은 [기존 정책 편집](entitlement-management-access-package-edit.md#edit-an-existing-policy)을 참조 하세요.
