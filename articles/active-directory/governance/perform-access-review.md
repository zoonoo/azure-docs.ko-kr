---
title: 그룹 또는 응용 프로그램에서 Azure AD 액세스 검토에 대 한 액세스 검토 | Microsoft Docs
...
ms.locfileid: "56728389"
---
# <a name="review-access-to-groups-or-applications-in-azure-ad-access-reviews"></a>그룹 또는 응용 프로그램에서 Azure AD 액세스 검토에 대 한 액세스를 검토 합니다.

Azure Active Directory (Azure AD) 기업에서는 Azure AD에서 그룹 및 응용 프로그램에 대 한 액세스를 관리 하는 방법을 간소화 하 고 Microsoft Online Services 기능을 사용 하 여 다른 Azure AD 액세스 검토 호출 합니다.
