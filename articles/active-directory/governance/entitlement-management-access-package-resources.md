...
모든 [AZURE AD 보안 그룹 또는 Microsoft 365 그룹](../fundamentals/active-directory-groups-create-azure-portal.md)을 선택할 수 있습니다. 관리자는 카탈로그에 모든 그룹을 추가할 수 있습니다. 카탈로그 소유자는 그룹의 소유자 인 경우 카탈로그에 모든 그룹을 추가할 수 있습니다. 그룹을 선택할 때 다음 Azure AD 제약 조건을 염두에 두어야 합니다.
...
자세한 내용은 [그룹 비교](/office365/admin/create-groups/compare-groups) 및 그룹 [및 Microsoft 팀 Microsoft 365](/microsoftteams/office-365-groups)을 참조 하세요.
