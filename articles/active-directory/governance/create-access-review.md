...
액세스 검토가 시작되면 Azure AD에서 검토자에게 액세스 검토를 요청하는 전자 메일을 자동으로 보냅니다. 사용자가 전자 메일을 받지 못한 경우 [액세스를 검토하는 방법](perform-access-review.md)의 지침을 보낼 수 있습니다. 
