...
- Azure AD Premium P2
- 전역 관리자 또는 사용자 관리자
- 모드 Microsoft 365 그룹의 리소스 소유자는 자신이 소유 하 고 있는 Microsoft 365 그룹에 대 한 검토를 만들 수 있습니다.
- 모드 Azure AD 보안 그룹의 리소스 소유자는 자신이 소유한 Azure AD 보안 그룹에 대 한 검토를 만들 수 있습니다.
