<properties pageTitle="자습서: XMatters OnDemand와 Azure Active Directory 통합 | Microsoft Azure" description="Azure Active Directory에서 XMatters OnDemand를 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#자습서: xMatters OnDemand와 Azure Active Directory 통합
>[AZURE.TIP]피드백을 보내려면 [여기](http://go.microsoft.com/fwlink/?LinkId=524330)를 클릭하십시오.
...
이 자습서를 완료한 후 xMatters OnDemand에 할당한 Azure AD 사용자가 xMatters OnDemand 회사 사이트 (서비스 공급자가 시작한 로그온)에서나 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 사용하여 응용 프로그램에 Single Sign-On할 수 있습니다.
...
3.  **앱 URL 구성** 페이지의 **xMatters OnDemand 로그인 URL** 텍스트 상자에 다음 패턴 "*https://\<tenant-name>.xMatters OnDemand.com*"을 사용하여 URL을 입력한 후 **다음**을 클릭합니다.
...
7.  **SAML 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    1.  **SAML 사용**을 선택합니다.
    2.  Azure 포털의 **XMatters OnDemand에서 Single Sign-On 구성** 대화 상자 페이지에서 **ID 공급자 ID** 값을 복사한 다음 **ID 공급자 URL** 텍스트 상자에 붙여넣습니다.
    3.  Azure 포털의 **XMatters OnDemand에 대한 Single Sign-On 구성** 대화 상자 페이지에서 **Single Sign-On 서비스 URL** 값을 복사한 다음 **Single 로그온 URL** 텍스트 상자에 붙여넣습니다.
    4.  Azure 포털의 **XMatters OnDemand에 대한 Single Sign-On 구성** 대화 상자 페이지에서 **Single Sign-Out 서비스 URL** 값을 복사한 다음 **Single 로그아웃 URL** 텍스트 상자에 붙여넣습니다.
