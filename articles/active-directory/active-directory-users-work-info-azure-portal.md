<properties
	pageTitle="Azure Active Directory 미리 보기에서 사용자에 대한 작업 정보 추가 또는 변경 | Microsoft Azure"
...
# Azure Active Directory 미리 보기에서 사용자에 대한 작업 정보 추가 또는 변경
...
3.  **사용자 및 그룹** 블레이드에서 **사용자**를 선택합니다.
    ...
    ![사용자 블레이드 열기](./media/active-directory-users-work-info-azure-portal/create-users-opko-KRers-blade.png)
...
6. 작업 정보를 추가 또는 변경한 다음 명령 모음에서 **저장**을 선택합니다.
