<properties
   pageTitle="Azure AD Connect Sync: 운영 작업 및 고려 사항"
...
## 다음 단계
Azure AD Connect Sync를 위한 구성에 대해 자세한 내용을 보려면 [Azure AD Connect Sync](active-directory-aadconnectsync-whatis.md)를 참조하십시오.
