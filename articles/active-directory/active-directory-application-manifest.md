<properties
   ...
   description="Azure AD 응용 프로그램 매니페스트에 추가 세부 정보를 제공하며 Azure AD 테넌트에서 각 응용 프로그램 구성을 함께 제공합니다."
...
이것으로 끝입니다. 이제 새 응용 프로그램 구성을 사용하여 응용 프로그램을 실행하며 이는 매니페스트의 변경 내용에 기반합니다.
