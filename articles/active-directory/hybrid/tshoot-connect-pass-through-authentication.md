...
![Azure Active Directory 관리 센터 - 통과 인증 블레이드](./media/tshoot-connect-pass-through-authentication/pta11.png)
...
> [!IMPORTANT]
> [Azure AD Connect: 필수 조건](./how-to-connect-install-prerequisites.md#installation-prerequisites)에 설명된 요구 사항에 반해 Azure AD Connect 서버가 도메인에 가입되지 않은 경우 이로 인해 잘못된 사용자 이름/암호 문제가 발생합니다.
...
인증 에이전트가 설치된 서버가 [여기](how-to-connect-pta-quick-start.md#step-1-check-the-prerequisites)에 나열된 서비스 URL 및 포트와 통신할 수 있는지 확인합니다.
...
Azure AD Connect가 설치된 서버가 [여기](how-to-connect-pta-quick-start.md#step-1-check-the-prerequisites)에 나열된 서비스 URL 및 포트와 통신할 수 있는지 확인합니다.
...
![통과 인증](./media/tshoot-connect-pass-through-authentication/pta3.png)
