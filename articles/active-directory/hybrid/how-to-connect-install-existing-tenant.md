...
신뢰할 수 없는 온-프레미스 사용자가 관리자 역할이 있는 클라우드 사용자와 일치 하지 않도록 하기 위해 Azure AD Connect는 관리 역할이 있는 개체와 온-프레미스 사용자 개체를 일치 시 키 지 않습니다. 이는 기본적으로입니다. 이 동작을 해결 하려면 다음을 수행할 수 있습니다.
