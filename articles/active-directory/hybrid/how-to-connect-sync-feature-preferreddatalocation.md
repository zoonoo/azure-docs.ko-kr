...
## <a name="step-2-refresh-the-schema-for-active-directory"></a>2 단계: Active Directory에 대 한 스키마 새로 고침
...
## <a name="step-3-add-the-source-attribute-to-the-on-premises-active-directory-connector-schema"></a>3 단계: 온-프레미스 Active Directory 커넥터 스키마에 원본 특성 추가
...
5. **범위 지정 필터** 탭으로 이동 하 여 다음 두 절이 있는 단일 범위 지정 필터 그룹을 추가 합니다.
...
## <a name="step-7-run-full-synchronization-cycle"></a>7 단계: 전체 동기화 주기 실행
...
## <a name="step-8-re-enable-sync-scheduler"></a>8 단계: 동기화 스케줄러 다시 사용
