...
사용자 지정 설정이나 고급 구성에 대한 추가 정보 및 지침은 [Azure Active Directory와 온-프레미스 ID 통합](whatis-hybrid-identity.md)을 시작하세요.  이 페이지는 추가 지침에 대한 정보 및 링크를 제공합니다.
