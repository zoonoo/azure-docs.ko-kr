...
* **하이브리드 Azure AD 조인**: 사용자의 환경에 온-프레미스 AD 공간이 있고 Azure AD의 이점을 원하는 경우 하이브리드 Azure AD 가입 장치를 구현할 수 있습니다. 이 디바이스는 온-프레미스 Active Directory와 Azure Active Directory에 모두 가입됩니다.
...
1.  Azure AD Connect를 실행합니다. **추가 작업** 페이지에서 **장치 옵션 구성**을 선택합니다.  **다음**을 클릭합니다.
    ![장치 옵션 구성](./media/how-to-connect-device-options/deviceoptions.png) 
...
* [장치 쓰기 저장 구성/해제](how-to-connect-device-writeback.md)
