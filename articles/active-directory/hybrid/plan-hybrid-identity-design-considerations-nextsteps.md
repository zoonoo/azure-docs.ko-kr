...
* [MDM for Microsoft 365](/microsoft-365/admin/basic-mobility-security/overview)를 사용하면 Microsoft 365 조직에 연결되어 있을 때 모바일 디바이스를 관리하고 보호할 수 있습니다. MDM for Microsoft 365를 사용하여 디바이스 보안 정책 및 액세스 규칙을 설정하고 모바일 디바이스를 분실하거나 도난당한 경우 해당 디바이스를 초기화할 수 있습니다.
