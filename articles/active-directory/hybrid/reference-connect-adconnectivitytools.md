...
Active Directory 커넥터를 구성하려면 사용자가 연결하려고 하는 포리스트 및 이 포리스트와 연결된 도메인 컨트롤러에 모두 이름 확인이 있어야 합니다.
...
Active Directory 커넥터 구성에 성공하려면 _.ldap._tcp.\<forestfqdn\>은
계속 확인할 수 있어야 합니다.
