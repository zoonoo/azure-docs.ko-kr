...
- Azure AD Connect의 모든 로그인 메서드에 대해 6 개의 페더레이션 관리 작업을 사용 하도록 설정 했습니다.  (이전에는 "AD FS SSL 인증서 업데이트" 작업을 모든 로그인에 사용할 수 있었습니다.)
...
- AD FS 팜에 대 한 SSL 또는 토큰 서명 인증서를 업데이트 하는 하위 작업을 포함 하는 "인증서 관리" 라는 새 페더레이션 관리 작업을 추가 했습니다.
