...
응용 프로그램에 대 한 그룹 할당 관리에 대 한 자세한 내용은 [앱에 사용자 및 그룹을 할당](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups) 하는 문서 메서드를 참조 하세요.
...
3. 그룹 이름 구성 선택적 클레임을 설정 합니다.
   ...
   토큰의 그룹이 온-프레미스 AD 그룹 특성을 포함 하도록 하려면 선택적인 클레임 섹션에서 적용할 토큰 유형 (선택 사항)을 지정 합니다.  여러 토큰 유형이 나열 될 수 있습니다.
...
[응용 프로그램에 사용자 및 그룹을 할당 하는 방법](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)
