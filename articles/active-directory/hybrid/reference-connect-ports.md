...
| RPC |49152- 65535(임의의 높은 RPC 포트)(TCP) |AD 포리스트를 바인딩할 때 Azure AD Connect의 초기 구성 중 및 암호 동기화 중에 사용합니다. 동적 포트가 변경된 경우 해당 포트를 열어야 합니다. 자세한 내용은 [KB929851](https://support.microsoft.com/kb/929851), [KB832017](https://support.microsoft.com/kb/832017) 및 [KB224196](https://support.microsoft.com/kb/224196)을 참조하세요. |
|WinRM  | 5985(TCP) |Azure AD Connect 마법사에서 gMSA를 사용하여 AD FS를 설치하는 경우에만 사용|
|AD DS 웹 서비스 | 9389(TCP) |Azure AD Connect 마법사에서 gMSA를 사용하여 AD FS를 설치하는 경우에만 사용 |
...
방화벽에서 열어야 하는 URL 및 IP 주소 목록은 [Office 365 URL 및 IP 주소 범위](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2) 및 [Azure AD Connect 연결 문제 해결](tshoot-connect-connectivity.md#troubleshoot-connectivity-issues-in-the-installation-wizard)을 참조하세요.
...
최신 버전의 에이전트에는 Azure Service Bus 포트 5671이 더 이상 필요하지 않습니다. 최신 Azure AD Connect Health 에이전트 버전에는 포트 443만 필요합니다.
