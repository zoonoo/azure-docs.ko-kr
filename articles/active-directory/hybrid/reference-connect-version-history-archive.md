...
>[!NOTE] 
> 이 문서에는 보관된 모든 Azure AD 버전(1.3.20.0 이하)에 대한 버전 참조 정보가 포함되어 있습니다.  현재 릴리스는 [Azure AD Connect 버전 릴리스 기록](reference-connect-version-history.md)을 참조하세요.
