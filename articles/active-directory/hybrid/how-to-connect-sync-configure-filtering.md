...
예:  
![범위 지정 필터를 추가 하는 예제를 보여 주는 스크린샷](./media/how-to-connect-sync-configure-filtering/scope.png)  
...
4. 사용 하는 연결의 버전에 따라 azure AD로 이름이 지정 된 규칙 ( **사용자 조인** 또는 **외부 Azure Ad-사용자 조인 SOAInAD)** 을 찾고 **편집**을 클릭 합니다.
