...
2. 페더레이션된 도메인 내에서 RegisteredDevices를 확장합니다.
   ...
   ![Active Directory 관리 센터 등록 장치](./media/how-to-connect-device-writeback/devicewriteback5.png)
...
![문제 해결, 장치 등록 구성에 대한 권한 확인](./media/how-to-connect-device-writeback/troubleshoot6.png)
