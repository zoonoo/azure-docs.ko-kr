...
- 이 기능은 MFA(다단계 인증)와 같은 [조건부 액세스](../active-directory-conditional-access-azure-portal.md) 기능과 원활하게 작동하여 사용자를 보호합니다.
...
- [Azure AD Connect를](whatis-hybrid-identity.md)통해 사용할 수 있습니다.
