...
다음 문서는 AZure AD Connect Health와 함께 AD FS 인프라 모니터링에 중점을 둡니다. Azure AD Connect Health를 사용하여 Azure AD Connect(동기화)를 모니터링하는 방법에 대한 자세한 내용은 [동기화에 Azure AD Connect Health 사용](how-to-connect-health-sync.md)을 참조하세요. 또한 Azure AD Connect Health를 사용하여 Active Directory Domain Services를 모니터링하는 방법에 대한 자세한 내용은 [AD DS에서 Azure AD Connect Health 사용](how-to-connect-health-adds.md)을 참조하세요.
...
![경고가 선택되고 “경고 세부 정보” 창이 표시된 Azure AD Connect Health “경고” 페이지 스크린샷](./media/how-to-connect-health-adfs/alert2.png)
...
![Azure AD Connect Health “사용량 현황 분석” 페이지 스크린샷](./media/how-to-connect-health-adfs/report1.png)
...
![Azure AD Connect Health 성능 “모니터링” 페이지 스크린샷](./media/how-to-connect-health-adfs/perf1.png)
...
![지난 30일 동안의 잘못된 암호 시도 횟수가 표시된 “보고서” 섹션 스크린샷](./media/how-to-connect-health-adfs/report1a.png)
