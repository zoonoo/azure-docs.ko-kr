...
다음 응용 프로그램은 대상 서비스에 설정된 장치 기반 정책을 지원합니다.

| 응용 프로그램 | 대상 서비스 | 플랫폼 |
| :--                                     | :--            | :--      |
| Mail/Calendar/People | Exchange | Windows 10, Windows Mobile 10 |
| Office 유니버설: Word/Excel/PowerPoint | SharePoint | Windows 10, Windows Mobile 10 |
| Outlook 2016 | Exchange | Windows 10, Windows Mobile 10, Windows 8.1, Windows 7 |
|Outlook 2013(최신 인증 활성화 필요) | Exchange | Windows 8.1, Windows 7 |


다음 응용 프로그램은 대상 서비스에 설정된 장치 기반 정책을 지원하지 않습니다.

| 응용 프로그램 | 대상 서비스 | 플랫폼 |
| :--                                     | :--            | :--      |
| 차세대 동기화 클라이언트(NGSC)를 사용한 비즈니스용 One Drive(사용자 및 팀 사이트) | SharePoint | Windows 10, Windows Mobile 10 |
| My Apps 앱 | 모두 | iOS, Android |
...
### 옵션 1: Exchange ActiveSync를 허용하고 인트라넷에 있는 레거시 앱만 허용합니다.
