...
3. **[Innotas 테스트 사용자 만들기](#creating-an-innotas-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Innotas에 만듭니다.
...
3. **Innotas 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Innotas** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Innotas 지원 팀](https://www.innotas.com/contact)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
2. 응용 프로그램 목록에서 **Innotas**를 선택합니다.
