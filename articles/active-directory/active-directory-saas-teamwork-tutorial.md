...
---
# <a name="tutorial-azure-active-directory-integration-with-teamwork"></a>자습서: Teamwork와 Azure Active Directory 통합

이 자습서에서는 Azure AD(Azure Active Directory)와 Teamwork를 통합하는 방법에 대해 알아봅니다.

Teamwork와 Azure AD를 통합하면 다음과 같은 이점이 제공됩니다.

- Teamwork에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
- 사용자가 해당 Azure AD 계정으로 Teamwork(Single Sign-On)에 자동으로 로그온되도록 설정할 수 있습니다.
...
Teamwork와 Azure AD 통합을 구성하려면 다음 항목이 필요합니다.

- Azure AD 구독
- Teamwork Single Sign-on이 설정된 구독
...
## <a name="adding-teamwork-from-the-gallery"></a>갤러리에서 Teamwork 추가
Azure AD에 Teamwork를 통합하도록 구성하려면 갤러리의 Teamwork를 관리되는 SaaS 앱 목록에 추가해야 합니다.

**갤러리에서 Teamwork를 추가하려면 다음 단계를 수행합니다.**
...
4. 검색 상자에 **Teamwork**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_001.png)

5. 결과 창에서 **Teamwork**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_0001.png)


##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Azure AD Single Sign-on 구성 및 테스트
이 섹션에서는 "Britta Simon"이라는 테스트 사용자를 기반으로 Teamwork에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD 사용자에 해당하는 Teamwork 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Teamwork의 관련 사용자 간에 연결이 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 Teamwork의 **Username** 값으로 할당하여 설정합니다.

Teamwork에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-on 테스트하는 데 사용합니다.
3. **[Teamwork 테스트 사용자 만들기](#creating-a-teamwork-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Teamwork에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Testing Single Sign-On](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure 관리 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 Teamwork 응용 프로그램에서 Single Sign-On을 구성합니다.

**Teamwork에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure 관리 포털의 **Teamwork** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Teamwork 도메인 및 URL** 섹션에서 **로그인 URL** 텍스트 상자에 다음 패턴을 사용하여 URL을 입력합니다.`https://<company name>.teamwork.com`

    ![Single Sign-On 구성](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_02.png)

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이 값은 실제 로그인 URL로 업데이트해야 합니다. 이 값을 가져오려면 [Teamwork 지원 팀](mailto:support@teamwork.com)에 문의합니다. 
...
9. 응용 프로그램에 대해 SSO를 구성하려면 [Teamwork 지원 팀](mailto:support@teamwork.com)에 문의하고 다운로드한 **메타데이터**를 제공합니다.
...
### <a name="creating-a-teamwork-test-user"></a>Teamwork 테스트 사용자 만들기

이 섹션에서는 Teamwork에서 Britta Simon이라는 사용자를 만듭니다. [Teamwork 지원 팀](mailto:support@teamwork.com)에 문의하여 Teamwork 플랫폼에 사용자를 추가하세요.


### <a name="assigning-the-azure-ad-test-user"></a>Azure AD 테스트 사용자 할당

이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 Britta Simon에게 Teamwork에 대한 액세스 권한을 부여합니다.

![사용자 할당][200] 

**Britta Simon을 Teamwork에 할당하려면 다음 단계를 수행합니다.**

1. Azure 관리 포털에서 응용 프로그램 보기를 열고 디렉터리 보기로 이동하고 **엔터프라이즈 응용 프로그램**으로 이동한 후 **모든 응용 프로그램**을 클릭합니다.

    ![사용자 할당][201] 

2. 응용 프로그램 목록에서 **Teamwork**를 선택합니다.
...
액세스 패널에서 Teamwork 타일을 클릭하면 Teamwork 응용 프로그램에 자동으로 로그온됩니다.
