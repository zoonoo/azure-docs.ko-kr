---
title: "Azure Active Directory 그룹을 사용하여 리소스에 대한 액세스 관리 | Microsoft Docs"
...
---
# <a name="managing-access-to-resources-with-azure-active-directory-groups"></a>Azure Active Directory 그룹을 사용하여 리소스에 대한 액세스 관리
