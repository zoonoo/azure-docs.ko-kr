...
- 사용자가 해당 Azure AD 계정으로 MaxxPoint(Single Sign-on)에 자동으로 로그온되도록 설정할 수 있습니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자에 해당하는 MaxxPoint 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 MaxxPoint의 관련 사용자 간에 연결이 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 MaxxPoint의 **Username** 값으로 할당하여 설정합니다.

MaxxPoint에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
3. **[MaxxPoint 테스트 사용자 만들기](#creating-a-maxxpoint-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 MaxxPoint에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Testing Single Sign-On](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure 관리 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 MaxxPoint 응용 프로그램에서 Single Sign-On을 구성합니다.

**MaxxPoint에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure 관리 포털의 **MaxxPoint** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **MaxxPoint 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 단계를 수행하지 않아도 됩니다.

    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_02.png)
    
4. **MaxxPoint 도메인 및 URL** 섹션에서 **SP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_03.png)

    a. **고급 URL 설정 표시** 옵션을 클릭합니다.

    b. **로그온 URL** 텍스트 상자에서 다음 패턴 `https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이 값은 실제 로그인 URL로 업데이트해야 합니다. 이러한 값을 얻으려면 [MaxxPoint 지원 팀](mailto:iumsupport@intercall.com)에 문의하세요.
...
6. **새 인증서 만들기** 대화 상자에서 달력 아이콘을 클릭하고 **만료 날짜**를 선택합니다. 그런 후 **저장** 단추를 클릭합니다.
    ...
    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_general_500.png)

7. **SAML 서명 인증서** 섹션에서 **새 인증서 활성화**를 선택한 후 **저장** 단추를 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_maxxpoint_05.png)

8. 팝업 **롤오버 인증서** 창에서 **확인**을 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-maxxpoint-tutorial/tutorial_general_600.png)
...
10. 응용 프로그램에 대해 SSO를 구성하려면 [MaxxPoint 지원 팀](mailto:iumsupport@intercall.com)에 문의하고 다운로드한 **메타데이터**를 제공합니다. 
...
이 섹션에서는 MaxxPoint에서 Britta Simon이라는 사용자를 만듭니다. MaxxPoint 플랫폼에서 사용자를 추가하려면 [MaxxPoint 지원 팀](mailto:iumsupport@intercall.com)에 문의하세요.
