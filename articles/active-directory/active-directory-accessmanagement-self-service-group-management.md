...
셀프 서비스 그룹 관리를 사용하면 사용자가 Microsoft Azure AD(Active Directory)에서 보안 그룹을 만들고 관리할 수 있으며 보안 그룹 멤버 자격을 요청할 수 있습니다. 이러한 멤버 자격은 이후 해당 그룹 소유자가 승인하거나 거부할 수 있습니다. 셀프 서비스 그룹 관리 기능을 사용하면 그룹 멤버 자격에 대한 일상적인 제어를 해당 멤버 자격에 대한 비즈니스 컨텍스트를 이해하는 사람에게 위임할 수 있습니다.
