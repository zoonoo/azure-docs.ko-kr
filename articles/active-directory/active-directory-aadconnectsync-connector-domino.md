<properties
   pageTitle="Azure AD Connect 동기화: Lotus Domino 커넥터 | Microsoft Azure"
...
**참고:** 커넥터의 서비스 계정으로 사용할 계정과 동일한 서버에 있는 사용자를 사용하여 Lotus Notes를 시작해야 합니다. 또한 서버의 Lotus Notes 클라이언트를 닫습니다. 커넥터를 Domino 서버에 연결하려는 동시에 실행할 수 없습니다.
