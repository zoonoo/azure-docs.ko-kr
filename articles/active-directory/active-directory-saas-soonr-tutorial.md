...
이 자습서에서는 Soonr Workplace와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. Soonr Workplace를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
4. **Soonr Workplace에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 Soonr Workplace 타일을 클릭하면 Soonr Workplace 응용 프로그램에 자동으로 로그온됩니다.
