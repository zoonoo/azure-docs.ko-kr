...
1. **Soonr Workplace에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    b. **Next**를 클릭합니다.
2. 응용 프로그램에 구성된 SSO를 가져오려면 자세한 내용은 Soonr Workplace SSO 통합 가이드를 참조하거나 통합 파트너를 참조할 수 있습니다.
...
> [!NOTE]
> 사용자를 수동으로 만들어야 하는 경우 Soonr Workplace 지원 팀에 문의해야 합니다.
> 
> 
