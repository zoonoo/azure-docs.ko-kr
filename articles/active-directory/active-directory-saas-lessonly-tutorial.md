<properties
    pageTitle="자습서: Lesson.ly와 Azure Active Directory 통합 | Microsoft Azure"
...
6. 검색 상자에서 **Lesson.ly**를 입력합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_01.png)

7. 결과 창에서 **Lesson.ly**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다.


![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_02.png)
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Lesson.ly 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Lesson.ly의 관련 사용자 간에 연결이 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 Lesson.ly의 **Username** 값으로 할당하여 설정합니다.
...
Lesson.ly 응용 프로그램은 특정 서식에서 SAML 어설션을 예상하며, **SAML 토큰 특성** 구성에 사용자 할당 특성 매핑을 추가해야 합니다.
...
1. Azure 클래식 포털의 Lesson.ly 응용 프로그램 통합 페이지에 있는 상단의 메뉴에서 **특성**을 클릭하여 **SAML 토큰 특성** 대화 상자를 엽니다.

    ![Single Sign-On 구성](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_07.png) 

2. 필요한 특성 매핑을 추가하려면 다음 단계를 수행합니다.

    ![Single Sign-On 구성](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_08.png) 
...
5. 페이지 맨 아래에 있는 **Configure single sign-on** to open the **Single Sign-On 구성** 대화 상자를 클릭합니다.

    ![Single Sign-On 구성][6] 

6. **Lesson.ly에 대한 사용자 로그인 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_03.png) 
...
8. **Lesson.ly에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.

    ![Single Sign-On 구성](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_05.png) 
...
9. 응용 프로그램에 대해 SSO를 구성하려면 dev@lesson.ly. 다운로드한 인증서 파일을 메일에 첨부하고 해당하는 쪽에 SSO를 설정하기 위해 Lesson.ly 팀과 메타데이터 URL(엔터티 ID, SSO 로그인 URL 및 로그아웃 URL)을 공유합니다.
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-lessonly-tutorial/create_aaduser_09.png) 
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-lessonly-tutorial/create_aaduser_05.png) 
...
8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-lessonly-tutorial/create_aaduser_08.png) 
...
이 섹션의 목적은 Britta Simon에게 Lesson.ly에 대한 액세스 권한을 부여하여 Azure Single Sign-On을 사용할 수 있도록 하는 것입니다.
...
2. 응용 프로그램 목록에서 **Lesson.ly**를 선택합니다.
    ...
    ![Single Sign-On 구성](./media/active-directory-saas-lessonly-tutorial/tutorial_lessonly_50.png) 
