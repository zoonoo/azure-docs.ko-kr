...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. 로그인 URL 텍스트 상자에 **“https://mail.skydesk.jp/portal/\<company name\>”** 패턴을 사용하여 사용자가 Skydesk Email 응용 프로그램에 로그인하는 데 사용할 URL을 입력합니다.
...
3. **SAML 인증** 대화 상자 페이지에서 다음 단계를 수행합니다.
   ...
   > 
    ...
    d. **파일에서 키 가져오기**를 클릭하여 다운로드한 Skydesk Email 인증서를 선택하고 **열기**를 클릭하여 인증서를 업로드합니다.
