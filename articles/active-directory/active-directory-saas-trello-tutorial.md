<properties
	pageTitle="자습서: Trello와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: Trello와 Azure Active Directory 통합
...
Single Sign-On이 작동하려면 Azure AD 사용자에 해당하는 Trello 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Trello의 관련 사용자 간에 연결 관계가 설정되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Trello의 **Username** 값으로 할당하여 설정합니다. Trello에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Trello 테스트 사용자 만들기](#creating-a-the-funding-portal-test-user)** - Azure AD 표현과 연결된 Trello의 Britta Simon에 해당하는 사용자를 만듭니다.
...
4. 클래식 포털의 **Trello** 응용 프로그램 통합 페이지에서 **Single Sign-on 구성**을 클릭하여 **Single Sign-on 구성** 대화 상자를 엽니다.

	![Single Sign-On 구성][7]

5. **Trello에 대한 사용자 로그인 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
 	
	![Single Sign-On 구성](./media/active-directory-saas-trello-tutorial/tutorial_trello_06.png)

6. **앱 설정 구성** 대화 상자 페이지에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
> [AZURE.NOTE] Trello에서 **<enterprise>** 동적 필드를 가져와야 합니다. 동적 필드 값이 없는 경우 <support@trello.com>의 Trello 지원 팀에 문의하여 엔터프라이즈의 동적 필드를 가져오세요.

6. **앱 설정 구성** 대화 상자 페이지에서 **SP 시작 모드**로 응용 프로그램을 구성하려는 경우 **"고급 설정 표시(선택 사항)"**를 클릭하고 **로그온 URL**을 입력합니다.

	![Single Sign-On 구성](./media/active-directory-saas-trello-tutorial/tutorial_trello_08.png)

	a. **로그인 URL** 텍스트 상자에서 다음과 같은 패턴을 사용하여 URL을 입력합니다. `https://trello.com/auth/saml/consume/<enterprise>`

	b. **다음**를 클릭합니다.

7. **Trello에서 Single Sign-On 구성** 페이지에서, **인증서 다운로드**를 클릭하여 컴퓨터에 파일을 저장합니다.

	![Single Sign-On 구성](./media/active-directory-saas-trello-tutorial/tutorial_trello_09.png)

6. 응용 프로그램에 구성된 SSO를 가져오려면 [Trello Enterprise SSO 구성](https://trello.com/sso-configuration) 페이지로 이동하여 Trello 팀에 로그온 URL을 보내고 다운로드한 인증서를 첨부합니다.
