...
3. **[Trello 테스트 사용자 만들기](#creating-a-trello-test-user)** - Azure AD 표현과 연결된 Trello의 Britta Simon에 해당하는 사용자를 만듭니다.
...
6. **Trello 구성** 섹션에서 **Trello 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-trello-tutorial/tutorial_trello_configure.png) 

9. 응용 프로그램에 구성된 SSO를 가져오려면 [Trello Enterprise SSO 구성](https://trello.com/sso-configuration) 페이지로 이동하여 [Trello 지원 팀](mailto:support@trello.com)에 **SAML Single Sign-On 서비스 URL**을 보내고 **인증서(Base64)**를 첨부합니다.
