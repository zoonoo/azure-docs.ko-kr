...
4. 검색 상자에 **Workstars**를 입력하고 결과 패널에서 **Workstars**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_addfromgallery.png)
...
3. **[Workstars 테스트 사용자 만들기](#create-a-workstars-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Workstars에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Workstars 응용 프로그램에서 Single Sign-On을 구성합니다.

**Workstars에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Workstars** 응용 프로그램 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
3. **Workstars 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<subdomain>.workstars.com/saml/login_check`
...
4. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_certificate.png) 

5. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-workstars-tutorial/tutorial_general_400.png)

6. **Workstars 구성** 섹션에서 **Workstars 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Workstars 구성](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_configure.png) 

7. 다른 웹 브라우저 창에서 Workstars 회사 사이트에 관리자로 로그인합니다.

8. 주 도구 모음에서 **설정**을 클릭합니다.
...
10. **Single Sign On(SAML) - 설정** 페이지에서 다음 단계를 수행합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-workstars-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-workstars-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-workstars-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-workstars-tutorial/create_aaduser_04.png)
...
2. 응용 프로그램 목록에서 **Workstars**를 선택합니다.

    ![응용 프로그램 목록의 Workstars 연결](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_app.png)  
...
액세스 패널에서 Workstars 타일을 클릭하면 Workstars 응용 프로그램에 자동으로 로그온됩니다.
