...
이 자습서에서는 Azure와 Zoom의 통합을 보여줍니다.  
이 자습서에 설명된 시나리오에서는 사용자에게 이미 다음 항목이 있다고 가정합니다.

* 유효한 Azure 구독
* Zoom 테넌트

이 자습서를 완료하면, Zoom에 할당한 Azure AD 사용자들은 Zoom 회사 사이트(로그온을 시작한 서비스 공급자)에서 또는, [액세스 패널 소개](active-directory-saas-access-panel-introduction.md)
...
### <a name="to-enable-the-application-integration-for-zoom-perform-the-following-steps"></a>Zoom에 응용 프로그램 통합을 사용하려면, 다음 단계를 수행합니다.
...
> [!NOTE]
> 다른 Zoom 사용자 계정 생성 도구 또는 Zoom에서 제공하는 API를 사용하여 AAD 사용자 계정을 프로비전할 수 있습니다.
> 
> 
...
### <a name="to-assign-users-to-zoom-perform-the-following-steps"></a>사용자를 Zoom에 할당하려면 다음 단계를 수행합니다.
