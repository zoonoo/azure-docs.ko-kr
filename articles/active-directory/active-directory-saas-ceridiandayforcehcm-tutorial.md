...
이 자습서에서는 Ceridian Dayforce HCM과 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다.  
...
![Single Sing-on 구성](./media/active-directory-saas-ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_02.png) 
...
3. **사용자 특성 편집** 대화 상자에서 다음 단계를 수행합니다.
    ...
    a. **특성 값** 목록에서 구현에 사용할 사용자 특성을 선택합니다.  
...
7. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    b. **회신 URL** 텍스트 상자에 Azure AD가 응답을 게시해야 하는 URL을 입력합니다.  
...
2. 응용 프로그램 목록에서 **Ceridian Dayforce HCM**을 선택합니다.
    ...
    ![Single Sing-on 구성](./media/active-directory-saas-ceridiandayforcehcm-tutorial/tutorial_ceridiandayforcehcm_50.png) 
