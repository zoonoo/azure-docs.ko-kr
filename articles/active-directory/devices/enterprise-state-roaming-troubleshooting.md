...
1. 장치는 Azure AD나 하이브리드 Azure AD에 조인되어 있습니다. 자세한 내용은 [Azure AD에서 장치를 제어하는 방법](overview.md)을 참조하세요.
