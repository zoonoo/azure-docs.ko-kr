...
1. 왼쪽 탐색 모음에서 **Azure Active Directory**를 클릭합니다. 
...
- 장치 기반 조건부 액세스에 대 한 자세한 내용은 참조 하세요 [Azure Active Directory 장치 기반 조건부 액세스 정책을 구성할](../conditional-access/require-managed-devices.md)합니다.
