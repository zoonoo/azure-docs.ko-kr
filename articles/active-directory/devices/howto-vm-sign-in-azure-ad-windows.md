...
> [!IMPORTANT]
> Azure ad에 가입 된 Vm에 대 한 원격 연결은 azure AD가 등록 된 (Windows 10 20H1부터), Azure ad 조인 또는 하이브리드 Azure AD가 VM과 **동일한** 디렉터리에 조인 된 Windows 10 pc 에서만 허용 됩니다. 
...
`provisioningState` `Succeeded` 확장이 VM에 설치 되 면의가 표시 됩니다.
