...
**A:** 이것은 의도적인 작동입니다. 디바이스는 클라우드의 리소스에 액세스할 수 없습니다. 
...
**A:** 특정 장치 상태를 요구하도록 특정 조건부 액세스 규칙을 구성했거나 장치가 조건을 충족하지 않을 경우 사용자가 차단되고 다음 메시지가 표시됩니다. 조건부 액세스 정책 규칙을 평가하고 디바이스가 이 조건을 충족하는지 확인하여 이 메시지가 표시되지 않도록 하세요.
