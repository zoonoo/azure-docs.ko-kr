...
- AAD 업그레이드는 버전 1.4. xx. x에 연결 합니다. [Azure AD Connect 1.4. x x x x. x 및 장치 disappearance을 이해](https://docs.microsoft.com/azure/active-directory/hybrid/reference-connect-device-disappearance)합니다.
