...
> [!NOTE]
> 타사 ID 공급자는 Windows 10 디바이스에서 PRT 발급이 이루어지도록 WS-Trust 프로토콜을 지원해야 합니다. WS-Trust를 사용하지 않으면 하이브리드 Azure AD 조인 또는 Azure AD 조인 디바이스에서 사용자에게 PRT를 발급할 수 없습니다.
