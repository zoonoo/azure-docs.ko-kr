...
- 사용자가 [Azure Active Directory의 장치 관리 소개](overview.md)를 잘 숙지한 것으로 가정합니다.
...
Azure Portal을 사용하여 장치를 관리하려면 해당 장치가 Azure AD에 [등록되거나 조인](overview.md#getting-devices-under-the-control-of-azure-ad)되어야 합니다. 관리자는 장치 설정을 구성하여 장치 등록 및 조인 프로세스를 구체적으로 조정할 수 있습니다. 
