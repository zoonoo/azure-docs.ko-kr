...
PIM에서는 사용자가 [필요할 때 역할을 활성화](active-directory-privileged-identity-management-how-to-activate-role.md)할 수 있도록 [이러한 역할을 사용자에게 할당](active-directory-privileged-identity-management-how-to-add-role-to-user.md)할 수 있습니다.
