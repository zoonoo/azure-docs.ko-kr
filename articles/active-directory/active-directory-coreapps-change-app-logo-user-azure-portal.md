---
title: "Azure Active Directory 미리 보기에서 엔터프라이즈 앱의 이름 또는 로고 변경 | Microsoft Docs"
...
---
# <a name="change-the-name-or-logo-of-an-enterprise-app-in-azure-active-directory-preview"></a>Azure Active Directory 미리 보기에서 엔터프라이즈 앱의 이름 또는 로고 변경
