<properties
	pageTitle="자습서: 8x8 Virtual Office와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: 8x8 Virtual Office와 Azure Active Directory 통합
...
### 8x8 Virtual Office 테스트 사용자 만들기
...
> [AZURE.NOTE] 사용자를 수동으로 만들어야 하는 경우 8x8 Virtual Office 지원 팀에 문의해야 합니다.
...
2. 응용 프로그램 목록에서 **8x8 Virtual Office**를 선택합니다.
	...
	![Single Sign-On 구성](./media/active-directory-saas-8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_50.png)
