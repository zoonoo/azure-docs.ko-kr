...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Workrite 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Workrite의 관련 사용자 간에 연결이 형성되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Workrite의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 Workrite 타일을 클릭하면 Workrite 응용 프로그램에 자동으로 로그온됩니다.
