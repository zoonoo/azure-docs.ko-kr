...
이 섹션은 Azure AD 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Workrite에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.<br>
...
1. **Azure 관리 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다.<br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-workrite-tutorial/create_aaduser_09.png) <br> 
