<properties
	pageTitle="자습서: Workrite와 Azure Active Directory 통합 | Microsoft Azure"
...
이 자습서는 Azure AD(Azure Active Directory)에 Workrite를 통합하는 방법을 보여 주기 위한 것입니다.<br>Azure AD에 Workrite를 통합하면 다음과 같은 이점을 얻을 수 있습니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Workrite 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Workrite의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Workrite의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션은 Azure 클래식 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Workrite에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.<br>

**Workrite에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure 클래식 포털의 **Workrite** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Configure Single Sign-On** 대화 상자를 엽니다.<br><br> ![Single Sign-On 구성][6] <br>
...
4. **Workrite의 Single Sign-On을 구성** 페이지에서 다음 단계를 수행합니다.<br><br>![Azure AD Single Sign-On][9] <br>
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-workrite-tutorial/create_aaduser_09.png) <br> 

2. **디렉터리** 목록에서 디렉터리 통합을 사용하도록 설정할 디렉터리를 선택합니다.

3. 사용자 목록을 표시하려면 위쪽 메뉴에서 **사용자**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-workrite-tutorial/create_aaduser_03.png) <br>
 
4. **사용자 추가** 대화 상자를 열려면 아래쪽 도구 모음에서 **사용자 추가**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-workrite-tutorial/create_aaduser_04.png) <br>
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-workrite-tutorial/create_aaduser_06.png) <br>
...
2. 탐색 창에서 **Admin**을 클릭합니다.<br><br>![사용자 할당][400]<br>

3. 빠른 링크로 이동한 다음 **사용자 만들기**를 클릭합니다. <br><br>![사용자 할당][401]<br>

4. **사용자 만들기** 대화 상자에서 다음 단계를 수행합니다.<br><br>![사용자 할당][402]<br>
...
이 섹션의 목적은 Britta Simon에게 Workrite에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하는 것입니다.<br><br>![사용자 할당][200]<br>
...
2. 응용 프로그램 목록에서 **Workrite**를 선택합니다. <br><br>![사용자 할당][202]<br>
...
이 섹션의 목적은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하는 것입니다.<br> 액세스 패널에서 Workrite 타일을 클릭하면 Workrite 응용 프로그램에 자동으로 로그온됩니다.
