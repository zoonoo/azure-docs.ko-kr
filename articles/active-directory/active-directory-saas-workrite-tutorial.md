...
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Workrite에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Workrite 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Workrite의 관련 사용자 간에 연결이 형성되어야 합니다.  
...
이 섹션은 Azure 클래식 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Workrite에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD Single Sign-On][8] 
     ...
     a. **로그온 URL** 텍스트 상자에 사용자가 Workrite 사이트에 로그온하는 데 사용하는 URL(예: *https://app.workrite.co.uk/securelogin/samlgateway.aspx?id=1a82b5aa-4dd6-4472-9721-7d0193f59e22*)을 입력합니다.
...
### <a name="creating-a-workrite-test-user"></a>Workrite 테스트 사용자 만들기
...
4. **사용자 만들기** 대화 상자에서 다음 단계를 수행합니다.
    ...
    a. 프로비전하려는 유효한 Azure AD 사용자의 **메일**, **이름** 및 **성**을 입력합니다.
...
이 섹션의 목적은 Britta Simon에게 Workrite에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하는 것입니다.
