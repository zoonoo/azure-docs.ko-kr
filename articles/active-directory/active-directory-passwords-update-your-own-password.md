<properties 
	pageTitle="방법: Azure AD 암호 변경 및 재설정 | Microsoft Azure" 
	description="암호 재설정을 위해 등록하는 방법, 암호를 변경하는 방법 및 잊어버린 경우 고유한 암호를 재설정하는 방법을 알아봅니다." 
...
암호 재설정을 위해 등록하는 가장 빠른 방법은 http://aka.ms/ssprsetup로 이동하는 것입니다.
 ...
 7. **감사합니다**가 표시되면 됩니다! 언제든지 https://passwordreset.microsoftonline.com으로 이동하여 암호를 재설정하기 위해 등록한 옵션을 사용할 수있습니다.
...
회사 또는 학교 계정 로그인 화면에서 회사 또는 학교 계정 암호를 재설정하려면 아래 단계를 따릅니다.
 ...
 >[AZURE.IMPORTANT] 이 기능은 관리자가 설정한 경우에 사용할 수 있습니다. 설정되지 않은 경우 사용자 계정이 이 기능에 대해 사용 불가능하다는 내용의 메시지가 표시됩니다. 이 경우에 "관리자에게 문의" 링크를 사용하여 계정의 잠금을 해제하기 위해 관리자 회사에 연락할 수 있습니다.<br><br>관리자가 이 기능을 활성화할 경우 사용하기 전에 먼저 등록해야 합니다. http://aka.ms/ssprsetup에서 수행할 수 있습니다.
 ...
 2. "누구십니까?" 페이지에서 회사 또는 학교 계정 ID를 입력하고 captcha를 전달하여 로봇이 아님을 입증합니다.
