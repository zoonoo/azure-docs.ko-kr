...
Azure Active Directory는 실제로 조직이 소유하는 IP 주소에 대해 *비정상적 위치 간 이동 불가능* 및 *의심스러운 활동을 포함하는 IP 주소의 로그인* [위험 이벤트 유형](active-directory-identity-protection-risk-events.md#risk-event-types)의 거짓 긍정을 검색할 수 있습니다. 
