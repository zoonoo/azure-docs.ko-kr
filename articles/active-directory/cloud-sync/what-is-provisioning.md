...
![Azure Active Directory를 사용한 클라우드 프로비저닝을 보여 주는 다이어그램입니다.](media/what-is-provisioning/cloud-1.png)
...
![클라우드 HR, 온-프레미스 HR 및 Azure Active Directory를 사용하여 HR 기반 프로비저닝을 보여 주는 다이어그램입니다.](media/what-is-provisioning/cloud-2.png)
...
![온-프레미스 앱, 타사 클라우드 앱 및 Azure Active Directory를 사용하여 앱 프로비저닝을 보여 주는 다이어그램입니다.](media/what-is-provisioning/cloud-3.png)
...
![클라우드 프로비저닝](media/what-is-provisioning/cloud-4.png)
