---
title: Azure AD Connect 클라우드 동기화 주문형 프로 비전
...
Azure AD Connect 클라우드 동기화에는 단일 사용자에 게이 변경 내용을 적용 하 여 구성 변경을 테스트할 수 있는 새로운 기능이 도입 되었습니다.  이를 사용 하 여 구성에 대 한 변경 내용이 제대로 적용 되었으며 Azure AD에 올바르게 동기화 되었는지 확인할 수 있습니다.  
...
5. **유효성 검사** 아래에서 **사용자 프로 비전** 단추를 클릭 합니다. 
 ...
 ![사용자 프로 비전](media/how-to-on-demand-provision/on-demand-2.png)

6. 요청 시 프로 비전 화면  사용자의 **고유 이름을** 입력 하 고 **프로 비전** 단추를 클릭 합니다.  
 
 ![요청 시 프로 비전](media/how-to-on-demand-provision/on-demand-3.png)
...
![사용자 가져오기](media/how-to-on-demand-provision/on-demand-5.png)

이 정보를 사용 하 여 가져온 다양 한 특성 및 해당 값을 확인할 수 있습니다.  사용자 지정 특성 매핑을 만든 경우 여기에 값을 확인할 수 있습니다.
![사용자 정보 가져오기](media/how-to-on-demand-provision/on-demand-6.png)
...
![사용자 범위](media/how-to-on-demand-provision/on-demand-7.png)

이 정보를 사용 하 여 사용자 범위에 대 한 추가 정보를 볼 수 있습니다.

![사용자 범위 세부 정보](media/how-to-on-demand-provision/on-demand-10a.png)
...
![세부 정보 보기](media/how-to-on-demand-provision/on-demand-8.png)

이 정보를 사용 하 여 일치 항목을 찾을 것인지 아니면 새 사용자를 만들 것인지를 확인할 수 있습니다.

![사용자 정보](media/how-to-on-demand-provision/on-demand-11.png)
...
![작업 세부 정보 수행](media/how-to-on-demand-provision/on-demand-9.png)
...
![추적 특성](media/how-to-on-demand-provision/on-demand-12.png)
