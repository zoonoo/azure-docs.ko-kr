...
## <a name="server-or-daemon-application-to-web-api"></a>서버 또는 디먼 응용 프로그램-Web API
...
| C#/.NET |[ADAL - 네이티브 앱-REST 서비스 - 브라우저 대화 상자를 통해 ACS를 사용한 인증](http://code.msdn.microsoft.com/AAL-Native-App-to-REST-de57f2cc) |[Azure ADAL(AD 인증 라이브러리)](active-directory-authentication-libraries.md) 및 [ACS(Access Control Service 2.0)](http://msdn.microsoft.com/library/azure/hh147631.aspx)를 사용하여 WPF 클라이언트에 사용자 인증 기능을 추가합니다. |
