...
조건부 액세스 배포를 계획 하는 것이 조직에서 앱 및 리소스에 대 한 필수 액세스 전략을 달성 해야 중요 합니다. 배포의 계획 단계에 대부분의 시간을 할애하여 선택한 조건에서 사용자에게 액세스 권한을 부여하거나 차단하는 데 필요한 다양한 정책을 디자인해야 합니다. 이 문서에서는 안전 하 고 효과적인 조건부 액세스 정책을 구현 하기 위해 취해야 하는 단계를 설명 합니다. 시작 하기 전에 이해 해야 하는 방법 [조건부 액세스](overview.md) 방식과 때 사용 해야 합니다.
