---
title: Azure Active Directory에서 조건부 액세스를 사용 하 여 cloud app access에 승인 된 클라이언트 앱을 요구 하는 방법 | Microsoft Docs
...
ms.locfileid: "68515144"
---
# <a name="how-to-require-approved-client-apps-for-cloud-app-access-with-conditional-access"></a>방법: 조건부 액세스를 사용 하 여 cloud app access에 승인 된 클라이언트 앱 필요 
