---
title: Azure Active Directory 조건부 액세스의 위치 조건 이란? | Microsoft Docs
...
사용 하 여 [Azure Active Directory (Azure AD) 조건부 액세스](../active-directory-conditional-access-azure-portal.md)를 어떻게 권한이 있는 사용자를 제어할 수 있습니다. 클라우드 앱에 액세스할 수 있습니다. 조건부 액세스 정책의 위치 조건을 사용 하면 사용자의 네트워크 위치에 액세스 제어 설정을 연결할 수 있습니다.
...
명명 된 위치에 액세스할 수 있습니다 합니다 **관리** 조건부 액세스 페이지의 섹션입니다.
...
- **신뢰할 수 있는 위치로 표시** - 신뢰할 수 있는 위치를 나타내기 위해 명명된 위치에 대해 설정할 수 있는 플래그입니다. 일반적으로 신뢰할 수 있는 위치는 IT 부서에서 제어하는 네트워크 영역입니다. 조건부 액세스 하는 것 외에도 신뢰할 수 있는 명명 된 위치는 Azure Id 보호와 Azure AD 보안 보고서를 줄이는 데도 사용 [거짓 긍정](../reports-monitoring/concept-risk-events.md#impossible-travel-to-atypical-locations-1)합니다.
...
다단계 인증 서비스 설정 페이지에서 **인트라넷의 페더레이션 사용자로부터 발생한 요청인 경우 다단계 인증 건너뛰기**를 선택하여 회사 인트라넷 사용자를 식별할 수 있습니다. 이 설정은 AD FS에서 발급한 내부 회사 네트워크 클레임이 신뢰되며, 사용자를 회사 네트워크에 있는 것으로 식별하는 데 사용됨을 나타냅니다. 자세한 내용은 [조건부 액세스를 사용 하 여 신뢰할 수 있는 Ip 기능을 사용할](../authentication/howto-mfa-mfasettings.md#enable-the-trusted-ips-feature-by-using-conditional-access)합니다.
...
API 및 PowerShell은 아직 없습니다 명명 된 위치 또는 조건부 액세스 정책에 대 한 합니다.
