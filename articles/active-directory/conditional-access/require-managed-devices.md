...
:::image type="content" source="./media/require-managed-devices/47.png" alt-text="Azure A D Grant 창의 스크린샷. 장치를 준수 하 고 하이브리드 Azure A D에 연결 된 확인란을 선택 하 여 액세스 권한 부여를 선택 합니다." border="false":::
...
:::image type="content" source="./media/require-managed-devices/10.png" alt-text="Azure A D Grant 창의 스크린샷. 액세스 권한 부여를 선택 합니다. 장치를 하이브리드 Azure로 연결 하는 확인란도 선택 됩니다." border="false":::
...
:::image type="content" source="./media/require-managed-devices/45.png" alt-text="이름, 활성화 된 상태, O S, 버전, 조인 유형, 소유자, M D M 및 장치의 규격 상태를 나열 하는 테이블입니다. 규격 상태는 아니요입니다." border="false":::
...
:::image type="content" source="./media/require-managed-devices/11.png" alt-text="Azure A D Grant 창의 스크린샷. 액세스 권한 부여를 선택 합니다. 장치를 규격으로 표시 해야 하는 확인란도 선택 됩니다." border="false":::
...
:::image type="content" source="./media/require-managed-devices/46.png" alt-text="이름, 활성화 된 상태, O S, 버전, 조인 유형, 소유자, M D M 및 장치의 규격 상태를 나열 하는 테이블입니다. 규격 상태가 강조 표시 됩니다." border="false":::
