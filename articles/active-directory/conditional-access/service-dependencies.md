...
| 클라이언트 앱         | Downstream service                          | Enforcement |
| :--                 | :--                                         | ---         | 
| Azure Data Lake     | Microsoft Azure Management (portal and API) | Early-bound |
| Microsoft Classroom | 교환                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
| Microsoft Teams     | 교환                                    | Early-bound |
|                     | MS Planner                                  | Late-bound  |
|                     | SharePoint                                  | Early-bound |
|                     | 비즈니스 온라인용 Skype                   | Early-bound |
| Office Portal       | 교환                                    | Late-bound  |
|                     | SharePoint                                  | Late-bound  |
| Outlook groups      | 교환                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
...
| 비즈니스용 Skype  | 교환                                    | Early-bound |
| Visual Studio       | Microsoft Azure Management (portal and API) | Early-bound |
| Microsoft Forms     | 교환                                    | Early-bound |
|                     | SharePoint                                  | Early-bound |
| Microsoft To-Do     | 교환                                    | Early-bound |
