...
1. **클라우드 앱 또는 작업**에서 다음 옵션을 선택 합니다.
   ...
   1. **제외**아래에서 **Office 365**을 선택 하 고 **선택**을 선택한 다음 **완료**를 선택 합니다.
1. **조건**에서:
...
1. **할당**에서 **사용자 및 그룹**을 선택합니다.
   ...
   1. **제외**에서 **사용자 및 그룹**을 선택하고 조직의 응급 액세스 또는 비상 계정을 선택합니다. 
   1. **완료** 를 선택합니다.
1. **클라우드 앱 또는 작업**아래에서  >  **Include** **앱 선택**을 선택 하 고, **Office 365**을 선택 하 고, **선택**, **완료**를 차례로 선택 합니다.
