...
1. **할당**아래에서 **사용자 및 그룹** 을 선택 합니다.
   ...
   1. **완료** 를 선택합니다.
1. **클라우드 앱 또는 작업**@no__t에서 다음을**포함**하 여 **모든 클라우드 앱**을 선택 합니다.
...
1. **조건** > **클라이언트 앱 (미리 보기)** 에서 **구성** 을 **예**로 설정 합니다.
   1. **모바일 앱 및 데스크톱 클라이언트만**@no__t 1**다른 클라이언트**를 선택 합니다.
   2. **완료** 를 선택합니다.
1. **액세스 제어** > **부여**에서 **액세스 차단**을 선택 합니다.
   1. **선택**을 선택합니다.
