...
1. **조건**아래에서 **클라이언트 앱**을 선택 합니다.
   1. **구성**을 **예**로 설정합니다.
   1. **모바일 앱 및 데스크톱 클라이언트** 를 선택 하 고 다른 모든 항목을 선택 취소 합니다.
...
1. **조건**아래에서 **클라이언트 앱**을 선택 합니다.
   1. **구성**을 **예**로 설정합니다.
   1. **Exchange ActiveSync 클라이언트** 를 선택 하 고 다른 모든 항목을 선택 취소 합니다.
...
1. **조건**아래에서 **클라이언트 앱**을 선택 합니다.
   1. **구성**을 **예**로 설정합니다.
   1. **브라우저** 를 선택 하 고 다른 모든 항목을 선택 취소 합니다.
1. **액세스 제어** > **권한 부여**에서 다음 옵션을 선택합니다.
   - **승인된 클라이언트 앱 필요**
   - **앱 보호 정책 필요(미리 보기)**
   - **선택된 컨트롤이 모두 필요**
