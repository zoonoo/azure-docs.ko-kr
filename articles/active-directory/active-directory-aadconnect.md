...
---
# <a name="integrating-your-onpremises-identities-with-azure-active-directory"></a>Azure Active Directory와 온-프레미스 ID 통합
...
| ADFS에 하위 도메인 구성 |
| AD FS 팜 관리 |
| 페더레이션 인증서를 수동으로 업데이트 |

## <a name="more-information-and-references"></a>자세한 내용 및 참조
| 항목 |
| --- | --- |
| 버전 기록 |
| DirSync, Azure ADSync 및 Azure AD Connect 비교 |
| Azure AD의 비 ADFS 호환성 목록 |
| 동기화된 특성 |
| Azure AD Connect Health를 사용하여 모니터링 |
| 질문과 대답 |
