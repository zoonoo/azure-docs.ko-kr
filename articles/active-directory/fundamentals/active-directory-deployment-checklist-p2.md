...
| [조직 특정 사용자 지정 금지 된 암호 목록 만들기](../authentication/howto-password-ban-bad-configure.md) | 사용자가 조직이나 영역에서 사용하는 일반적인 단어 또는 구를 포함하여 암호를 만들지 못하도록 합니다. | |
...
| [조건부 액세스를 사용 하 여 Azure AD에 대 한 레거시 인증 차단](../conditional-access/block-legacy-authentication.md) | Multi-Factor Authentication 적용할 수 없는 POP, SMTP, IMAP, MAPI 등의 레거시 인증 프로토콜을 차단 하 여 악의적 사용자의 기본 진입점으로 만듭니다. | Azure AD Premium P1 |
...
## <a name="phase-3-manage-applications"></a>3 단계: 응용 프로그램 관리
...
## <a name="phase-4-audit-privileged-identities-complete-an-access-review-and-manage-user-lifecycle"></a>4 단계: 권한 있는 id 감사, 액세스 검토 완료 및 사용자 수명 주기 관리
