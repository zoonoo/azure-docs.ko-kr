...
| [조직별 사용자 지정 금지된 암호 목록 만들기](../authentication/howto-password-ban-bad-configure.md) | 사용자가 조직이나 영역에서 사용하는 일반적인 단어 또는 구를 포함하여 암호를 만들지 못하도록 합니다. | Azure AD Basic |
