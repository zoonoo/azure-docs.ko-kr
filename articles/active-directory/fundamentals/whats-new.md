...
이제 차세대 B2C 사용자 흐름은 사용자가 영구 쿠키를 사용 하 여 웹 및 네이티브 응용 프로그램의 사용자에 대 한 세션 수명을 연장할 수 있는 [로그인 유지 (KMSI)](https://docs.microsoft.com/azure/active-directory-b2c/session-behavior?pivots=b2c-custom-policy#enable-keep-me-signed-in-kmsi) 기능을 지원 합니다.  기능은 사용자가 브라우저를 닫았다가 다시 열고 사용자가 로그 아웃할 때 취소 되는 경우에도 세션을 활성 상태로 유지 합니다.
...
자세한 내용은 [AZURE AD를 사용 하 여 SaaS 응용 프로그램에 대 한 사용자 프로 비전 자동화](https://docs.microsoft.com/azure/active-directory/manage-apps/user-provisioning)를 참조 하세요.
...
### <a name="public-preview---customize-and-configure-android-shared-devices-for-firstline-workers-at-scale"></a>공개 미리 보기-대규모로 Firstline 작업자를 위한 Android 공유 장치 사용자 지정 및 구성

**유형:** 새로운 기능  
**서비스 범주:** 장치 등록 및 관리  
**제품 기능:** Id 보안 & 보호
 
Azure AD 및 Microsoft 끝점 관리자 팀은 Firstline Worker 장치를 사용자 지정 하 고, 크기를 조정 하 고, 보호 하는 기능을 결합 했습니다.
...
자세히 알아보려면 [대규모의 Firstline worker에 대 한 공유 장치 사용자 지정 및 구성](https://techcommunity.microsoft.com/t5/azure-active-directory-identity/customize-and-configure-shared-devices-for-firstline-workers-at/ba-p/1751708)을 참조 하세요.
