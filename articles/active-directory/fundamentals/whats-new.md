...
새로운 앱 등록 환경에 대해 자세히 알아보려면 [Azure Portal 학습 가이드에서 앱 등록](https://docs.microsoft.com/azure/active-directory/develop/app-registrations-training-guide)를 참조 하세요.
