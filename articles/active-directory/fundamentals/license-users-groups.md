...
많은 Azure Active Directory (Azure AD) 서비스에서 해당 서비스에 대 한 각 사용자 또는 그룹 (및 연결 된 멤버)에 대 한 라이선스를 요구 합니다. 활성 라이선스가 있는 사용자만 사용이 허가 된 Azure AD 서비스에 액세스 하 여 사용할 수 있습니다.
