...
description: 레거시 인증 프로토콜 및 동기화 패턴과 Azure AD 통합에 대 한 아키텍처 지침
...
---
# <a name="azure-active-directory-integrations-with-authentication-and-synchronization-protocols"></a>인증 및 동기화 프로토콜을 사용한 Azure Active Directory 통합
...
다음 표에서는 레거시 인증 프로토콜 및 해당 기능과의 인증 Azure AD 통합을 보여 줍니다. 확인할 인증 프로토콜의 이름을 선택 합니다.
...
| [SSH (Secure Shell)](auth-ssh.md) |  ![확인 표시](./media/authentication-patterns/check.png)| | ![확인 표시](./media/authentication-patterns/check.png)| ![확인 표시](./media/authentication-patterns/check.png) |
...
다음 표에서는 동기화 패턴 및 해당 기능과의 Azure AD 통합을 보여 줍니다. 표시할 패턴의 이름을 선택 합니다.
