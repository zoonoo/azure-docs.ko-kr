...
* [Azure Active Directory 자격 증명을 사용 하 여 Linux® VM에 로그인-Azure Virtual Machines ](../../virtual-machines/linux/login-using-aad.md) 

* [OAuth 2.0 장치 코드 흐름-Microsoft identity platform ](../develop/v2-oauth2-device-code.md)
