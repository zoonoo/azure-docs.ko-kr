...
오스트레일리아 및 뉴질랜드에서 주소를 제공 하 고 Azure AD free edition을 사용 하는 고객의 경우 Azure AD는 오스트레일리아 데이터 센터 내에서 PII 데이터를 미사용 상태로 유지 합니다. 

다른 모든 Azure AD premium 서비스는 고객 데이터를 글로벌 데이터 센터에 저장 합니다. 서비스의 데이터 센터를 찾으려면 [Azure Active Directory – 데이터가 어디에 있나요?](https://www.microsoft.com/trustcenter/privacy/where-your-data-is-located) 를 참조 하세요.

## <a name="microsoft-azure-multi-factor-authentication-mfa"></a>Microsoft Azure multi-factor authentication (MFA)

Azure AD의 MFA 서비스는 미사용 글로벌 데이터 센터에 고객 데이터를 저장 합니다. 클라우드 기반 Azure MFA 및 Azure MFA 서버에서 수집 하 고 저장 하는 사용자 정보에 대 한 자세한 내용은 [azure Multi-Factor Authentication 사용자 데이터 컬렉션](https://docs.microsoft.com/azure/active-directory/authentication/concept-mfa-data-residency)을 참조 하세요. 고객이 MFA를 사용 하는 경우 해당 데이터는 미사용 데이터 센터 외부에 저장 됩니다. 
