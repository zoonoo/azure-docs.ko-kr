...
* [Microsoft 기술 커뮤니티는](https://techcommunity.microsoft.com/) IT 전문가 파트너와 고객이 협업하고 공유하고 배울 수 있는 장소입니다. [Microsoft 기술 커뮤니티 정보 센터는](https://techcommunity.microsoft.com/t5/Community-Info-Center/ct-p/Community-Info-Center) 공지 사항, 블로그 게시물, 전문가와의 AMA(질문) 상호 작용 등에 사용됩니다. 또한 [커뮤니티에 참여하여 아이디어를 제출](https://techcommunity.microsoft.com/t5/Communities/ct-p/communities)할 수도 있습니다.
...
> [!NOTE]
> 청구 또는 구독 문제의 경우 [Microsoft 365 관리 센터를](https://admin.microsoft.com)사용해야 합니다.
> 

1. [Azure Portal](https://portal.azure.com)에 로그인하여 **Azure Active Directory**를 엽니다.
   
2. **문제 해결 + 지원**이 나올 때까지 아래로 스크롤한 후 **새 지원 요청**을 선택합니다.
   
3. **기본 사항** 블레이드에서 **문제 유형**으로 **기술**을 선택합니다.

4. **구독**을 선택합니다.

5. **서비스의**경우 **Azure 활성 디렉터리**를 선택합니다.

6. 요청에 대한 **요약을** 만듭니다. 요약은 140자 미만이어야 합니다.
  
7. 문제 **유형을**선택한 다음 해당 유형에 대한 범주를 선택합니다. 현재는 문제 범주에 대한 자가 진단 정보도 제공됩니다.
  
7. 나머지 문제 정보를 추가하고 **다음**을 클릭합니다. 

8. 이 시점에서 솔루션 **블레이드에서** 자가 솔루션 및 설명서를 제공합니다. 문제를 해결하는 해결 방법이 없는 경우 다음 을 **클릭합니다.** 

9. 세부 **정보** 블레이드에서 필요한 세부 정보를 작성하고 [심각도](https://azure.microsoft.com/support/plans/response/)를 선택합니다. 
 
![이미지](https://user-images.githubusercontent.com/13383753/76565580-1c284900-6468-11ea-8c0f-85af98097b6f.png)
 
10. 연락처 정보를 제공하고 **다음을**선택합니다. 


8. 연락처 정보를 입력하고 **만들기**를 선택합니다.
  ![문제 범주 자체 도움말 스크린샷](./media/active-directory-troubleshooting-support-howto/open-support-ticket.png)
...
> [!NOTE]
> [Microsoft 365 관리 센터에서](https://admin.microsoft.com) Azure AD에 대한 지원은 관리자에게만 제공됩니다. 

1. EMS(엔터프라이즈 이동성 + 보안) 라이선스가 있는 계정으로 [Microsoft 365 관리 센터에](https://admin.microsoft.com) 로그인합니다.
...
7. 계속하면 자세한 내용을 요청하는 메시지가 표시됩니다. 문제를 나타내는 모든 파일을 첨부한 후 **다음**을 선택합니다.

8. 연락처 정보를 입력하고 **요청 제출**을 선택합니다.
