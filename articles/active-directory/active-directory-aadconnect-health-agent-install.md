...
> [!WARNING]
> AD FS 감사를 사용하지 않도록 설정하는 그룹 정책이 있으면 Azure AD Connect Health Agent가 정보를 수집할 수 없습니다. 감사를 사용하지 않도록 설정할 수 있는 그룹 정책이 없는지 확인합니다.
> 
> 
...
> [!NOTE]
> 프록시 설정이 업데이트되도록 하려면 모든 Azure AD Connect Health Agent 서비스를 다시 시작해야 합니다. 다음 명령을 실행합니다.<br> Restart-Service AdHealth*
> 
> 
