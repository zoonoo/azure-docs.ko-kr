---
title: "감사 로그를 사용하는 방법 | Microsoft Docs"
...
---
# <a name="how-to-use-the-audit-log-in-azure-ad-privileged-identity-management"></a>Azure AD Privileged Identity Management에서 감사 로그를 사용하는 방법
