...
4. 검색 상자에 **OpenAthens**를 입력하고 결과 패널에서 **OpenAthens**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 OpenAthens 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 OpenAthens의 관련 사용자 간에 연결 관계가 형성되어야 합니다.
...
1. Azure Portal의 **OpenAthens** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **OpenAthens 도메인 및 URL** 섹션의 **식별자** 텍스트 상자에 `https://login.openathens.net/saml/2/metadata-sp` 값을 입력합니다.
...
4. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_certificate.png) 

5. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-openathens-tutorial/tutorial_general_400.png)

6. 다른 웹 브라우저 창에서 OpenAthens 회사 사이트에 관리자로 로그인합니다.

7. **관리** 탭 아래에서 **연결**을 선택합니다. 

    ![Single Sign-on 구성](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application1.png)

8. **SAML 1.1/2.0**을 선택하고 **구성** 단추를 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application2.png)
    
9.  **찾아보기** 단추를 클릭하여 Azure Portal에서 다운로드한 메타데이터 xml 파일을 업로드합니다. **추가**를 클릭하여 구성을 추가합니다.
...
### <a name="create-a-openathens-test-user"></a>OpenAthens 테스트 사용자 만들기
...
**Britta Simon을 OpenAthens에 할당하려면 다음 단계를 수행합니다.**
...
액세스 패널에서 OpenAthens 타일을 클릭하면 OpenAthens 응용 프로그램에 자동으로 로그온됩니다.
