---
title: Azure 포털 - Azure AD에서 관리되는 ID의 서비스 주체 보기
...
2. **응용 프로그램 유형에서**모든 응용 프로그램을 선택한 다음 **적용을** **클릭합니다.**
...
[Azure 리소스에 대한 관리되는 ID](/azure/active-directory/managed-identities-azure-resources/overview)
