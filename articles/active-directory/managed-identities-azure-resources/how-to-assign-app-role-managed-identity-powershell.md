...
## <a name="use-azure-ad-to-assign-a-managed-identity-access-to-another-applications-app-role"></a>Azure AD를 사용 하 여 다른 응용 프로그램의 앱 역할에 관리 되는 id 액세스 권한 부여
...
1. 관리 id에 앱 역할을 할당 합니다. 앱 역할을 할당 하려면 다음 정보가 필요 합니다.
    ...
    * `serverApplicationObjectId`: 4 단계에서 찾은 서버 응용 프로그램의 서비스 주체에 대 한 개체 ID입니다.
