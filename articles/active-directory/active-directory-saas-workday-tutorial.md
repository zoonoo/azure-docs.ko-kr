...
이 섹션은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 Workday에 인증할 수 있게 하는 방법을 간략하게 설명하기 위한 것입니다.  
이 절차의 일부로 base-64로 인코딩된 인증서를 만들어야 합니다.  
...
3. **앱 URL 구성** 페이지에서 다음 단계를 수행하고 **다음**을 선택합니다.
    ...
    b.  **Workday 회신 URL** 텍스트 상자에서 `https://impl.workday.com/<tenant>/login-saml.htmld` 패턴을 사용하여 Workday 회신 URL을 입력합니다.
   
    > [!NOTE]
    > 회신 URL에 하위 도메인이 있어야 합니다(예: www, wd2, wd3, wd3-impl, wd5, wd5-impl). "*http://www.myworkday.com*"과 같은 것은 작동하지만 "*http://myworkday.com*"은 작동하지 않습니다. 
    > 
    > 
...
Workday 지원팀이 사용자를 만듭니다.

## <a name="assigning-users"></a>사용자 할당
구성을 테스트하려면 응용 프로그램 사용을 허용하려는 Azure AD 사용자를 할당하여 액세스 권한을 부여해야 합니다.

### <a name="to-assign-users-to-workday-perform-the-following-steps"></a>Workday에 사용자를 할당하려면 다음 단계를 수행합니다.
