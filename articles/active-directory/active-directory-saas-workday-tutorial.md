...
>[AZURE.TIP]피드백을 보내려면 [여기](http://go.microsoft.com/fwlink/?LinkId=330042)를 클릭하세요.
...
이 섹션은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 Workday에 인증할 수 있게 하는 방법을 간략하게 설명하기 위한 것입니다. 이 절차의 일부로 base-64로 인코딩된 인증서를 만들어야 합니다. 이 절차를 잘 모르는 경우 [이진 인증서를 텍스트 파일로 변환하는 방법](http://youtu.be/PlgrzUZ-Y1o)을 참조하세요.
...
11. SAML ID 공급자 섹션에서 다음 단계를 수행합니다.
    ...
    ![SAML ID 공급자](./media/active-directory-saas-workday-tutorial/IC7829271.png "SAML ID 공급자")
     ...
     11\.5. **x509 공개 키 보기** 섹션에서 다음 단계를 수행합니다. <br><br> ![x509 공개 키 보기](./media/active-directory-saas-workday-tutorial/IC782930.png "x509 공개 키 보기") <br>
      ...
      4.  다운로드한 인증서에서 **Base-64로 인코드된** 파일을 만듭니다.
