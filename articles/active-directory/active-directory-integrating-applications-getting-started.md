<properties
   pageTitle="응용 프로그램과 Azure Active Directory 통합 시작 가이드 | Microsoft Azure"
...
# 응용 프로그램과 Azure Active Directory 통합 시작 가이드
## 개요
이 항목은 Azure Active Directory(AD)와 응용 프로그램을 통합하기 위한 로드맵을 제공하려는 용도로 제공됩니다. 아래의 각 섹션은 더 자세한 항목을 요약하므로 이 시작 가이드에서 어떤 부분이 사용자와 관련 있는지 식별할 수 있습니다. 각 주제에 대해 자세히 알아보려면 링크를 따라갑니다.

## 시작 하기 전에 인벤토리를 수행합니다.
...
위에서 설명한 대로 지금까지 조직에서 관리하지 않은 응용 프로그램이 있을 수 있습니다. 인벤토리 프로세스의 일부로 허용되지 않은 클라우드 응용 프로그램을 찾을 수 있습니다. [클라우드 앱 검색을 사용하여 허용되지 않은 클라우드 응용 프로그램 찾기](active-directory-cloudappdiscovery-whatis.md)를 참조하세요.
