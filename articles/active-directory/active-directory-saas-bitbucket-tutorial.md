...
- 사용자가 해당 Azure AD 계정으로 SAML SSO for Bitbucket by resolution GmbH에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
1. 갤러리에서 SAML SSO for Bitbucket by resolution GmbH 추가
...
4. 검색 상자에 **SAML SSO for Bitbucket by resolution GmbH**를 입력하고 결과 패널에서 **SAML SSO for Bitbucket by resolution GmbH**를 선택한 다음 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 SAML SSO for Bitbucket by resolution GmbH](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addfromgallery.png)
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 SAML SSO for Bitbucket by resolution GmbH 사용자가 누구인지 알고 있어야 합니다. 즉 Azure AD 사용자와 SAML SSO for Bitbucket by resolution GmbH의 관련 사용자 간의 링크 관계가 설정되어야 합니다.

SAML SSO for Bitbucket by resolution GmbH에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.
...
3. **[SAML SSO for Bitbucket by resolution GmbH 테스트 사용자 만들기](#create-a-saml-sso-for-bitbucket-by-resolution-gmbh-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 SAML SSO for Bitbucket by resolution GmbH에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 SAML SSO for Bitbucket by resolution GmbH 응용 프로그램에서 Single Sign-On을 구성합니다.

**SAML SSO for Bitbucket by resolution GmbH에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **SAML SSO for Bitbucket by resolution GmbH** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_samlbase.png)

3. **SAML SSO for Bitbucket by resolution GmbH 도메인 및 URL** 섹션에서 IDP 시작 모드에서 응용 프로그램을 구성하려면 다음 단계를 수행합니다.

    ![SAML SSO for Bitbucket by resolution GmbH 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url.png)
...
4. **SP** 시작 모드에서 응용 프로그램을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.
    ...
    ![SAML SSO for Bitbucket by resolution GmbH 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_url1.png)

    **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<server-base-url>/plugins/servlet/samlsso`
     
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이러한 값을 실제 식별자, 회신 URL 및 로그온 URL로 업데이트합니다. 이러한 값을 얻으려면 [SAML SSO for Bitbucket by resolution GmbH 지원 팀](https://marketplace.atlassian.com/plugins/com.resolution.atlasplugins.samlsso-bitbucket/server/support)에 문의하세요. 

5. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.

    ![인증서 다운로드 링크](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_certificate.png) 

6. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-bitbucket-tutorial/tutorial_general_400.png)
    
7. SAML SSO for Bitbucket by resolution GmbH 회사 사이트에 관리자로 로그인합니다.

8. 주 도구 모음의 오른쪽에서 **설정**을 클릭합니다.

9. ACCOUNTS 섹션으로 이동하여 메뉴 모음의 **SAML SingleSignOn**을 클릭합니다.
...
10. **SAML SIngleSignOn Plugin Configuration page**(SAML SIngleSignOn 플러그 인 구성 페이지)에서 **Add idp**(idp 추가)를 클릭합니다. 
    ...
    ![idp 추가](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_addidp.png)

11. **Choose your SAML Identity Provider**(SAML ID 공급자 선택) 페이지에서 다음 단계를 수행합니다.

    ![ID 공급자](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityprovider.png)
...
12. **Identity provider configuration**(ID 공급자 구성) 페이지에서 **다음**을 클릭합니다.
    ...
    ![ID 구성](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_identityconfig.png)
...
15. **설정 저장**을 클릭합니다.
    ...
    ![저장](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_save.png)
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-bitbucket-tutorial/create_aaduser_04.png)
...
### <a name="create-a-saml-sso-for-bitbucket-by-resolution-gmbh-test-user"></a>SAML SSO for Bitbucket by resolution GmbH 테스트 사용자 만들기
...
**Britta Simon을 SAML SSO for Bitbucket by resolution GmbH에 할당하려면 다음 단계를 수행합니다.**

1. Azure Portal에서 응용 프로그램 보기를 연 다음 디렉터리 보기로 이동하고 **엔터프라이즈 응용 프로그램**으로 이동한 후 **모든 응용 프로그램**을 클릭합니다.

    ![사용자 할당][201] 

2. 응용 프로그램 목록에서 **SAML SSO for Bitbucket by resolution GmbH**를 선택합니다.

    ![응용 프로그램 목록의 SAML SSO for Bitbucket by resolution GmbH 링크](./media/active-directory-saas-bitbucket-tutorial/tutorial_bitbucket_app.png)  
