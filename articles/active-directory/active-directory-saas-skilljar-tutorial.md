...
7. 결과 창에서 **Skilljar**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다. <br><br>

##  Azure AD Single Sign-on 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Skilljar에서 Azure AD Single Sign-On을 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Skilljar 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Skilljar의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Skilljar의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션은 Azure AD 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Skilljar 응용 프로그램에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.



**Skilljar에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure AD 포털의 **Skilljar** 응용 프로그램 통합 페이지에서 **Single Sign-on 구성**을 클릭하여 **Single Sign-on 구성** 대화 상자를 엽니다. <br><br> ![Single Sign-On 구성][6] <br>
...
5. 응용 프로그램에 대해 SSO를 구성하려면 전자 메일을 통해 Skilljar 지원팀에 문의하고, 이전 단계의 **이름 식별자 형식** 값을 포함하고 다운로드한 메타데이터 파일을 메일에 첨부합니다.
...
1. **Azure 관리 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-skilljar-tutorial/create_aaduser_09.png) <br>
...
4. **사용자 추가** 대화 상자를 열려면 아래쪽의 도구 모음에서 **사용자 추가**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-skilljar-tutorial/create_aaduser_04.png) <br>
...
이 섹션의 목적은 Britta Simon에게 Skilljar에 대한 액세스 권한을 부여하여 Single Sign-On을 사용할 수 있도록 하는 것입니다. <br><br>![사용자 할당][200] <br>
