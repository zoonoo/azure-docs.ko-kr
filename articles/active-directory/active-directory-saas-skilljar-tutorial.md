...
이 자습서에서는 Skilljar와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. Skilljar를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Skilljar 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Skilljar의 관련 사용자 간에 연결 관계가 형성되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 Skilljar의 **Username** 값으로 할당하여 설정합니다.
