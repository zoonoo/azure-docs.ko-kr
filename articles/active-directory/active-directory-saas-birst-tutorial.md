...
* 사용자가 해당 Azure AD 계정으로 Birst Agile Business Analytics SSO(Single Sign-on)에 자동으로 로그온되도록 설정할 수 있습니다.
...
* Azure AD 구독
* Birst Agile Business Analytics SSO가 설정된 구독
...
## <a name="add-birst-agile-business-analytics-from-the-gallery"></a>갤러리에서 Birst Agile Business Analytics 추가
...
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Birst Agile Business Analytics에서 Azure AD SSO를 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

SSO가 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Birst Agile Business Analytics 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Birst Agile Business Analytics의 관련 사용자 간에 연결이 형성되어야 합니다.
...
이 섹션은 Azure 클래식 포털에서 Azure AD SSO를 사용하도록 설정하고 Birst Agile Business Analytics 응용 프로그램에서 SSO를 구성하는 방법을 설명하기 위한 것입니다.

**Birst Agile Business Analytics에서 Azure AD SSO를 구성하려면 다음 단계를 수행합니다.**
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
  ...
  1. 로그인 URL 텍스트 상자에 “https://login.bws.birst.com/SAMLSSO/Services.aspx?birst.idpid=TENANTIDPID”의 패턴을 사용하여 사용자가 Birst Agile Business Analytics 응용 프로그램에 로그인하는 데 사용할 URL을 입력합니다.
...
### <a name="create-a-birst-agile-business-analytics-test-user"></a>Birst Agile Business Analytics 테스트 사용자 만들기
...
>[!NOTE]
>사용자를 수동으로 만들어야 하는 경우 Birst Agile Business Analytics 지원 팀에 문의해야 합니다.
> 

### <a name="assign-the-azure-ad-test-user"></a>Azure AD 테스트 사용자 할당
이 섹션에서는 Britta Simon에게 Birst Agile Business Analytics에 대한 액세스 권한을 부여하여 Azure SSO를 사용할 수 있도록 하는 방법을 설명합니다.
