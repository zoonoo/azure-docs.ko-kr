...
이 자습서에서는 HR2day by Merces와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. HR2day by Merces를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 HR2day by Merces 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 HR2day by Merces의 관련 사용자 간에 연결이 형성되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 HR2day by Merces의 **Username** 값으로 할당하여 설정합니다.
...
1. 위쪽 메뉴에서 **빠른 시작**을 클릭하여 **빠른 시작** 대화 상자를 엽니다.
...
2. **HR2day by Merces에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 HR2day by Merces 타일을 클릭하면 HR2day by Merces 응용 프로그램에 자동으로 로그온됩니다.
