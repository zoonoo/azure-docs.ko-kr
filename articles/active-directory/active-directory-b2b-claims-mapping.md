...
![UI에 SAML 토큰 특성 표시](media/active-directory-b2b-claims-mapping/view-claims-in-saml-token.png)
...
- B2B 공동 작업 사용자 속성에 대한 자세한 내용은 [Azure Active Directory B2B 공동 작업 사용자 속성](active-directory-b2b-user-properties.md)을 참조하세요.
- B2B 공동 작업 사용자를 위한 사용자 토큰에 대한 자세한 내용은 [Azure AD B2B 공동 작업의 사용자 토큰 이해](active-directory-b2b-user-token.md)를 참조하세요.
