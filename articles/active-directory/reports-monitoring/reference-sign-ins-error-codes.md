...
|50005|사용자가 조건부 액세스 정책을 통해 현재 지원 되지 않는 플랫폼에서 장치에 로그인 하려고 합니다.|
...
|50131|다양 한 조건부 액세스 오류에 사용 합니다. 예: Windows 디바이스 상태가 잘못되었습니다. 의심스러운 활동, 액세스 정책 및 보안 정책 결정으로 인해 요청이 차단되었습니다.|
...
|53002|사용 되는 응용 프로그램이 조건부 액세스에 대 한 허용된 된 응용 프로그램이 아닙니다. 사용자가 액세스 권한을 부여받으려면 사용하도록 승인된 애플리케이션 목록에 있는 애플리케이션 중 하나를 사용해야 합니다.|
