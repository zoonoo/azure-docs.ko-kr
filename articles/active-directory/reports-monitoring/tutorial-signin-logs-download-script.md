...
* Windows 10 머신에서 다운로드된 스크립트를 실행하려는 경우 [Azure PowerShell 모듈을 설정하고 실행 정책을 설정](concept-sign-ins.md#running-the-script-on-a-windows-10-machine)합니다.
