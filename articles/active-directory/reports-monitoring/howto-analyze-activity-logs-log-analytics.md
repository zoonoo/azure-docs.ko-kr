...
[Azure AD 활동 로그를 Azure Monitor 로그에 통합](howto-integrate-activity-logs-with-log-analytics.md)하면 Azure Monitor 로그의 기능을 사용하여 사용자 환경에 대한 인사이트를 얻을 수 있습니다. 또한 [AZURE AD 활동 로그에 대 한 Log analytics 보기](howto-install-use-log-analytics-views.md) 를 설치 하 여 사용자 환경의 감사 및 로그인 이벤트에 대 한 미리 작성 된 보고서에 액세스할 수 있습니다.
...
[AZURE AD 활동 로그에 대 한 log analytics 보기를 설치 하 고 사용](howto-install-use-log-analytics-views.md)하는 방법을 알아봅니다. 
