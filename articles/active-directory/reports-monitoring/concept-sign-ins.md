...
기술 구현 외에도 다운로드할 수 있는 레코드의 수는 [Azure Active Directory 보고서 보존 정책](reference-reports-data-retention.md)에 의해 제한됩니다.  
...
로그인 활동 오류 코드에 대해 자세히 알아보려면 [Azure Active Directory 포털의 로그인 활동 보고서 오류 코드](reference-sign-ins-error-codes.md)를 참조하세요.
