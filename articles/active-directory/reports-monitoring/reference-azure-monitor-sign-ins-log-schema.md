...
| riskState | riskState | 위험한 사용자, 로그인 또는 위험 검색의 상태를 보고 합니다. 가능한 값 `none`은, `confirmedSafe`, `remediated`, `dismissed` ,,`unknownFutureValue`,입니다. `atRisk` `confirmedCompromised` |
