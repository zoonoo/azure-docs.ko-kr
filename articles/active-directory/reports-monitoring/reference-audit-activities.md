...
|감사 범주|활동|
|---|---|
|관리 단위 관리|단일 위험 탐지 유형 다운로드|
|관리 단위 관리|관리자 및 주간 다이제스트 옵트인 상태 다운로드|
|관리 단위 관리|모든 위험 탐지 유형 다운로드|
|관리 단위 관리|무료 사용자 위험 탐지 다운로드|
...
|그룹 관리|대량 다운로드 그룹 구성원 - 시작|
|그룹 관리|대량 다운로드 그룹 구성원 - 완료|
|그룹 관리|대량 가져오기 그룹 구성원 - 시작|
|그룹 관리|대량 가져오기 그룹 구성원 - 완료|
|그룹 관리|그룹 구성원 일괄 제거 - 시작됨|
...
|사용자 관리|추가됨|
|사용자 관리|할당|
|사용자 관리|대량 사용자 만들기 - 시작|
|사용자 관리|대량 사용자 만들기 - 완료|
|사용자 관리|대량 사용자 삭제 - 시작|
|사용자 관리|대량 삭제 사용자 - 완료|
|사용자 관리|대량 다운로드 사용자 - 시작|
|사용자 관리|대량 다운로드 사용자 - 완료|
|사용자 관리|대량 복원 삭제된 사용자 - 시작됨|
|사용자 관리|대량 복원 삭제 된 사용자 - 완료|
|사용자 관리|대량 초대 사용자 - 시작|
|사용자 관리|대량 초대 사용자 - 완료|
