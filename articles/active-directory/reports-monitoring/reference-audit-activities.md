...
|사용자 관리|애플리케이션 삭제|
|사용자 관리|애플리케이션 업데이트|
|사용자 관리|애플리케이션 Single Sign-On 모드 업데이트|
|사용자 관리|자동화된 암호 롤오버|
|사용자 관리|V2 애플리케이션 권한 추가|
|사용자 관리|V1 애플리케이션 만들기|
|사용자 관리|V2 애플리케이션 만들기|
|사용자 관리|V1 애플리케이션 삭제|
|사용자 관리|V2 애플리케이션 삭제|
|사용자 관리|V2 애플리케이션 권한 부여 삭제|
|사용자 관리|V1 및 V2 애플리케이션 가져오기|
|사용자 관리|V1 애플리케이션 가져오기|
|사용자 관리|V1 애플리케이션 가져오기|
|사용자 관리|V2 애플리케이션 가져오기|
|사용자 관리|V2 애플리케이션 가져오기|
...
|권한 부여|사용자 권한 부여: 테넌트 기능 세트에 API 사용 안 함|
...
|역할 관리|사용자에 대한 애플리케이션 암호 만들기|
|역할 관리|사용자에 대한 애플리케이션 암호 삭제|
|역할 관리|사용자 삭제|
|역할 관리|계정 사용 안 함|
|역할 관리|강력한 인증 사용|
|역할 관리|사용자 영구 삭제|
