...
|감사 범주|활동|
|---|---|
|애플리케이션 관리|V2 응용 프로그램 권한 부여 검색|
|애플리케이션 관리|현재 테넌트의 V2 응용 프로그램 서비스 사용자 검색|
|애플리케이션 관리|V1 응용 프로그램 업데이트|
|애플리케이션 관리|V2 응용 프로그램 업데이트|
|애플리케이션 관리|V2 응용 프로그램 권한 부여 업데이트|
...
|감사 범주|활동|
|---|---|
|애플리케이션 관리|응용 프로그램 추가|
|애플리케이션 관리|응용 프로그램에 소유자 추가|
...
|감사 범주|활동|
|---|---|
|애플리케이션 관리|응용 프로그램 복원|
|애플리케이션 관리|동의 철회|
|애플리케이션 관리|응용 프로그램 업데이트|
|애플리케이션 관리|외부 암호 업데이트|
|애플리케이션 관리|서비스 주체 업데이트|
|애플리케이션 관리|응용 프로그램에 액세스 토큰 발급|
|애플리케이션 관리|응용 프로그램에 권한 부여 코드 발급|
|애플리케이션 관리|응용 프로그램에 id_token 발급|
|애플리케이션 관리|로컬 계정 자격 증명 유효성 검사|
|애플리케이션 관리|사용자 인증 유효성 검사|
|애플리케이션 관리|V2 응용 프로그램 권한 추가|
