...
3. **BlueJeans 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<companyname>.BlueJeans.com` 패턴을 사용하여 URL을 입력합니다.
...
10. 다음 단계로 이동합니다.
    ...
    b. **SAML Single Sign-On 서비스 URL**을 **로그인 URL** 텍스트 상자에 붙여 넣습니다.
   
    c. **암호 변경 URL**을 **암호 변경 URL** 텍스트 상자에 붙여 넣습니다.
