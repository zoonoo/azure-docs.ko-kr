...
---
# <a name="tutorial-azure-ad-integration-with-bluejeans"></a>자습서: BlueJeans와 Azure AD 통합
이 자습서는 Azure 및 BlueJeans의 통합을 보여주기 위한 것입니다.  
...
### <a name="to-enable-the-application-integration-for-bluejeans-perform-the-following-steps"></a>BlueJeans에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
8. 다음 단계로 이동합니다.
   ...
   3. Azure 클래식 포털의 **BlueJeans에서 Single Sign-On 구성** 대화 상자 페이지에서 **변경 암호 URL** 값을 복사한 다음 **암호 변경 URL** 텍스트 상자에 붙여넣습니다.
...
Azure AD 사용자가 BlueJeans에 로그인할 수 있도록 하려면 BlueJeans로 프로비전되어야 합니다.  
...
### <a name="to-assign-users-to-bluejeans-perform-the-following-steps"></a>BlueJeans에 사용자를 할당하려면 다음 단계를 수행합니다.
