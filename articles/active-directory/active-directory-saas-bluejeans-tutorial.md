<properties 
    pageTitle="자습서: BlueJeans와 Azure Active Directory 통합 | Microsoft Azure" 
...
3.  **앱 URL 구성** 페이지의 **BlueJeans 로그온 URL** 텍스트 상자에 다음 패턴 "*https://company.BlueJeans.com*"을 사용하여 URL을 입력한 후 **다음**을 클릭합니다.
