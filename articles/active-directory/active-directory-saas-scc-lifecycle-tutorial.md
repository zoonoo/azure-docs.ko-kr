<properties pageTitle="자습서: SCC LifeCycle과 Azure Active Directory 통합 | Microsoft Azure" description="Azure Active Directory에서 SCC LifeCycle를 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#자습서: SCC LifeCycle과 Azure Active Directory 통합
>[AZURE.TIP]피드백을 보내려면 [여기](http://go.microsoft.com/fwlink/?LinkId=533911)를 클릭하십시오.
  
이 자습서는 Azure와 SCC LifeCycle의 통합을 보여주기 위한 것입니다. 이 자습서에 설명된 시나리오에서는 사용자에게 이미 다음 항목이 있다고 가정합니다.

-   유효한 Azure 구독
-   SCC LifeCycle Single Sign-On이 설정된 구독
  
이 자습서를 완료한 후 SCC LifeCycle에 할당한 Azure AD 사용자가 SCC LifeCycle 회사 사이트 (서비스 공급자가 시작한 로그온)에서나 [액세스 패널 소개](https://msdn.microsoft.com/library/dn308586)를 사용하여 응용 프로그램에 Single Sign-On할 수 있습니다.
...
2.  **SCC LifeCycle에 대한 사용자 로그온 방법을 선택하십시오.** 페이지에서 **Microsoft Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.

    ![Single Sign-On 구성](./media/active-directory-saas-scc-lifecycle-tutorial/IC794123.png "Single Sign-On 구성")

3.  **앱 URL 구성** 페이지의 **Sign-on URL** 텍스트 상자에 다음 패턴 "**https://bs1.scc.com/lc7/welcome/customer/PICTtest.aspx*"을 사용하여 SCC LifeCycle 응용 프로그램에 로그인하기 위해 사용자가 사용한 URL을 입력한 후 **다음**을 클릭합니다.
...
SCC LifeCycle를 프로비전하는 사용자를 구성할 작업 항목이 없습니다. 할당된 사용자가 SCC LifeCycle에 로그인하려고 하는 경우, 필요하면 SCC LifeCycle 계정이 자동으로 생성됩니다.
