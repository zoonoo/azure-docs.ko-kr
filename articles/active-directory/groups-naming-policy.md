...
3. [그룹 설정을 구성하는 Azure Active Directory cmdlet](users-groups-roles/groups-settings-cmdlets.md)의 단계에 따라 이 테넌트에 대한 그룹 설정을 만듭니다.
...
자세한 내용은 [그룹 설정 구성을 위한 Azure Active Directory cmdlet](users-groups-roles/groups-settings-cmdlets.md) 문서를 참조하세요.
...
* [Office 365 그룹에 대한 만료 정책](users-groups-roles/groups-lifecycle.md)
