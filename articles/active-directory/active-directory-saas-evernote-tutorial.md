...
- Azure AD 구독
- Evernote Single Sign-On을 사용하도록 설정된 구독
...
4. 검색 상자에서 **Evernote**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_search01.png)

5. 결과 창에서 **Evernote**를 선택한 다음 **추가** 단추를 클릭하여 해당 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_search_result01.png)
...
이 연결 관계는 Azure AD의 **사용자 이름** 값을 Evernote의 **Username** 값으로 할당하여 설정합니다.
...
4. **[Testing Single Sign-On](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure 관리 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 Evernote 응용 프로그램에서 Single Sign-On을 구성합니다.

**Evernote에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure 관리 포털의 **Evernote** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-on 구성][4]

2. **Single sign on** 대화 상자에서 **모드**로 **SAML 기반 로그온**을 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_samlbase.png)

3. **Evernote 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 어떤 단계도 수행할 필요가 없습니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_idp.png)
    
4. **Evernote 도메인 및 URL** 섹션에서 **SP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![Single Sign-On 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_sp_01.png)
    
    a. **고급 URL 설정 표시** 옵션을 클릭합니다.

    b. **로그인 URL** 텍스트 상자에서 `https://www.evernote.com/Login.action` 로그인 URL을 입력합니다.

5. **SAML 서명 인증서** 섹션에서 **새 인증서 만들기**를 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_cert.png)     

6. **새 인증서 만들기** 대화 상자에서 달력 아이콘을 클릭하고 **만료 날짜**를 선택합니다. 그런 후 **저장** 단추를 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_general_300.png)

7. **SAML 서명 인증서** 섹션에서 **새 인증서 활성화**를 선택한 후 **저장** 단추를 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_makecertactive.png)

8. 팝업 **롤오버 인증서** 창에서 **확인**을 클릭합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_general_400.png)

9. **SAML 서명 인증서** 섹션에서 **인증서(Base64)**를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_certificate.png) 

10. **Evernote 구성** 섹션에서 **Evernote 구성**을 클릭하여 **로그온 구성** 창을 엽니다.

    ![Single Sign-On 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_configure.png) 

    ![Single Sign-On 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_configuresignon.png)

11. 다른 웹 브라우저 창에서 Evernote 회사 사이트에 관리자로 로그인합니다.

12. **'관리 콘솔'**로 이동합니다.

    ![관리 콘솔](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_adminconsole.png)

13. **'관리 콘솔'**에서 **'보안'**으로 이동하고 **'Single Sign-On'**을 선택합니다.
...
14. 다음 값을 구성 합니다.
    ...
    b. **SAML HTTP 요청 URL** - Azure AD의 **Evernote 구성** 섹션에서 **SAML Single Sign-On 서비스 URL**을 입력합니다.

    c. **X.509 인증서** - Azure AD에서 다운로드한 인증서를 메모장에서 열고 "BEGIN CERTIFICATE"(인증서 시작) 및 "END CERTIFICATE"(인증서 끝)를 포함한 내용을 복사합니다.
...
1. **Azure 관리 포털**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/create_aaduser_01.png) 

2. **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭하여 사용자 목록을 표시합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/create_aaduser_02.png) 

3. 대화 상자 위쪽에서 **추가**를 클릭하여 **사용자** 대화 상자를 엽니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/create_aaduser_03.png) 

4. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-evernote-tutorial/create_aaduser_04.png) 
...
### <a name="creating-an-evernote-test-user"></a>Evernote 테스트 사용자 만들기
...
2. 응용 프로그램 목록에서 **Evernote**를 선택합니다.
    ...
    ![Single Sign-on 구성](./media/active-directory-saas-evernote-tutorial/tutorial_evernote_app.png) 
