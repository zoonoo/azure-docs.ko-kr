...
Azure Active Directory Device Registration은 Azure Active Directory에서 사용할 수 있습니다. 서비스에는 iOS, Android 및 Windows 장치 지원이 포함됩니다. Azure Active Directory Device Registration을 활용하는 개별 시나리오에는 보다 구체적인 요구 사항 및 플랫폼 지원이 있을 수도 있습니다.
