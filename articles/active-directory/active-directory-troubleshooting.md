...
액세스 제어 네임스페이스 또는 Multi-Factor Authentication 공급자를 만들려면 **+새로 만들기** > **App Services** > **Active Directory**를 클릭합니다.
...
**+새로 만들기** > **App Services**를 클릭하면 **Active Directory** 항목이 나타납니다. 특히, Active Directory 항목은 현재 사용자가 디렉터리, 액세스 제어 또는 Multi-Factor Authentication 공급자와 같은 Active Directory 기능을 모두 사용할 수 있을 때 나타납니다.
