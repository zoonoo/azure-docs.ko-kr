...
2. 사용자 지정 규칙을 선택합니다. **내보내기**를 클릭합니다. 메모장 창이 표시됩니다. PS1 확장명을 사용하여 임시 파일을 저장합니다. 그러면 PowerShell 스크립트로 저장됩니다. ps1 파일을 준비 서버에 복사합니다. ![동기화 규칙 내보내기](./media/active-directory-aadconnect-upgrade-previous-version/exportrule.png)
