...
이 섹션에서는 Azure 관리 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 Fuse 응용 프로그램에서 Single Sign-On을 구성합니다.
...
3. **Fuse 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에서 다음 패턴 `https://<tenant name>.fusion-universal.com/`을 사용하여 URL을 입력합니다.

    b. **식별자** 텍스트 상자에서 `https://<tenant name>.fusion-universal.com` 패턴을 사용하여 URL을 입력합니다.
