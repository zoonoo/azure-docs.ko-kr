...
* 다음 방법 중 하나를 통해 암호 재설정 링크를 사용하도록 설정을 구성하고 배포.
   ...
   * [레지스트리 키](active-directory-passwords-login.md#configure-reset-password-link-using-the-registry)
...
* [SSPR을 배포하려면 어떻게 하나요?](active-directory-passwords-best-practices.md)
...
[CreateProfile]: ./media/active-directory-passwords-login/create-profile.png "Windows 10 로그온 화면에서 암호 재설정 링크를 사용하도록 설정하기 위한 Intune 장치 구성 프로필 만들기"
[Assignment]: ./media/active-directory-passwords-login/profile-assignment.png "Windows 10 장치 그룹에 Intune 장치 구성 정책 할당"
[LoginScreen]: ./media/active-directory-passwords-login/logon-reset-password.png "Windows 10 로그온 화면의 암호 재설정 링크"
