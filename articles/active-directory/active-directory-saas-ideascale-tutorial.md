<properties 
    pageTitle="자습서: IdeaScale과 Azure Active Directory 통합 | Microsoft Azure" 
...
이 섹션에서는 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 IdeaScale에 인증할 수 있게 하는 방법을 간략하게 설명합니다. IdeaScale에 대한 Single Sign-On을 구성하려면 인증서의 손도장(thumbprint) 값을 검색해야 합니다. 이 절차를 잘 모르는 경우 [인증서의 지문 값을 검색하는 방법](http://youtu.be/YKQF266SAxI)을 참조하십시오.
