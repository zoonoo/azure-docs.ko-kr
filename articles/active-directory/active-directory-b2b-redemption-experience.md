...
![액세스 패널에서 사용자 설정을 보여주는 스크린샷](media/active-directory-b2b-redemption-experience/ConsentScreen.png) 
...
- [Azure Portal에서 Azure Active Directory B2B 공동 작업 사용자 추가](active-directory-b2b-admin-add-users.md)
- [정보 근로자가 Azure Active Directory에 B2B 공동 작업 사용자를 추가하는 방법](active-directory-b2b-iw-add-users.md)
- [PowerShell을 사용하여 Azure Active Directory B2B 공동 작업 사용자 추가](active-directory-b2b-api.md#powershell)
- [게스트 사용자로써 조직 나가기](active-directory-b2b-leave-the-organization.md)