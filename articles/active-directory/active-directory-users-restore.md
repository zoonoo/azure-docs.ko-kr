---
title: "Azure Active Directory에서 삭제된 사용자 복원 | Microsoft Docs"
...
## <a name="how-to-restore-a-deleted-user"></a>삭제된 사용자를 복원하는 방법

Azure Portal에서 삭제된 사용자를 복원하거나 삭제된 사용자를 영구적으로 삭제할 수 있습니다.
