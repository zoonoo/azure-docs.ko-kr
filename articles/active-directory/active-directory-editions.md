...
* [고유한 암호를 업데이트하는 방법](active-directory-passwords-update-your-own-password.md#reset-or-unlock-my-password-for-a-work-or-school-account)
...
#### <a name="cloud-app-discovery"></a>클라우드 앱 검색
**유형:** Premium 기능
