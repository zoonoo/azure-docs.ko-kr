...
다음 표는 수집하는 자격 증명에 대한 요약 및 express 설치 프로그램에서 사용되는 용도입니다.
...
<br> <br> 다음 표는 수집하는 자격 증명에 대한 요약 및 express 설치 프로그램에서 사용되는 용도입니다.
...
<br> <br> 다음 표는 특정 시나리오에 필요한 사용 권한에 대한 요약입니다.
...
<br> <br> 다음 표는 Azure AD Connect에서 만든 계정에 대한 요약입니다.



만든 계정 |할당된 사용 권한 | 용도
------------- | ------------- |------------- |
동기화를 위한 Azure AD 계정| 전역 관리자|진행 중인 동기화 작업(Azure AD MA 계정)
