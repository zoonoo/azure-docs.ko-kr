...
## <a name="enabling-the-application-integration-for-smarteru"></a>SmarterU에 응용 프로그램 통합 사용
이 섹션은 SmarterU에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

### <a name="to-enable-the-application-integration-for-smarteru-perform-the-following-steps"></a>SmarterU에 응용 프로그램 통합을 사용하도록 설정하려면
...
### <a name="to-assign-users-to-smarteru-perform-the-following-steps"></a>SmarterU에 사용자를 할당하려면 다음 단계를 수행합니다.
