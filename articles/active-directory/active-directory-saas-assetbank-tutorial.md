...
2. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. 로그온 URL 텍스트 상자에 **“https://\<company name\>.assetbank-server.com”** 패턴을 사용하여 사용자가 Asset Bank 응용 프로그램에 로그온하는 데 사용할 URL을 입력합니다.
...
### <a name="creating-a-asset-bank-test-user"></a>Asset Bank 테스트 사용자 만들기
