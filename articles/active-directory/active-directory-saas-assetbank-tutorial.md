...
2. **Asset Bank에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. 로그온 URL 텍스트 상자에 **“https://<회사 이름>.assetbank-server.com”** 패턴을 사용하여 사용자가 Asset Bank 응용 프로그램에 로그온하는 데 사용할 URL을 입력합니다.

    b. **다음**을 클릭합니다.

4. **Asset Bank에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
...
5. 응용 프로그램에 대한 SSO를 구성하려면 [support@assetbank.co.uk](mailto:support@assetbank.co.uk)를 통해 Asset Bank 지원 팀에 문의하고 메타데이터 파일을 메일에 첨부합니다.
...
이 섹션의 목적은 Britta Simon에게 Asset Bank에 대한 액세스 권한을 부여하여 Azure Single Sign-On을 사용할 수 있도록 하는 것입니다.
