...
> [AZURE.IMPORTANT] 다음 서명 키 롤오버는 2016년 8월 15일로 예정되었으며 클라이언트 응용 프로그램, 갤러리에서 추가한 응용 프로그램(사용자 지정 포함), 응용 프로그램 프록시를 통해 게시된 응용 프로그램 또는 B2C 테넌트의 응용 프로그램에 영향을 주지 **않습니다**.
