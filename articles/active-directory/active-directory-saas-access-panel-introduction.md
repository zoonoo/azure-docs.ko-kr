...
> [!NOTE]
> Azure AD로 페더레이션을 지원하는 응용 프로그램은 플러그인 또는 모바일 앱을 요구하지 않고 모든 장치에서 거의 모든 웹 브라우저에서 (Salesforce, Google Apps, Dropbox, 상자, Concur, Workday, Office 365 등 70 포함) 로그인할 수 있습니다. [https://myapps.microsoft.com](https://myapps.microsoft.com/) 의 다른 액세스 패널 환경의 경우에도 모바일 장치에서 My Apps 모바일 앱을 사용할 필요가 없습니다.
> 
> 
