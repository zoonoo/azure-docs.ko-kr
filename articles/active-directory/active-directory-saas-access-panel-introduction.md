...
액세스 패널에 도달하기 위해 사용자는 Azure AD에서 조직 계정을 사용해 인증되어야 합니다. <br> 사용자는 Azure AD에서 직접 인증을 받을 수 있습니다. <br> 또는 조직이 ADFS나 다른 기술을 사용하여 페더레이션을 구성한 경우 Windows Server Active Directory에서 인증을 받을 수도 있습니다.
