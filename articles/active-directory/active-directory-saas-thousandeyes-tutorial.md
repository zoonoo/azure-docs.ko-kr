...
11. **Single Sign-On 설정** 섹션에서 다음 단계를 수행합니다.
    ...
    나. Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL**을 **Login Page URL**(로그인 페이지 URL) 텍스트 상자에 붙여넣습니다.
  
    다. Azure Portal에서 복사한 **로그아웃 URL**을 **Logout Page URL**(로그아웃 페이지 URL) 텍스트 상자에 붙여넣습니다.
