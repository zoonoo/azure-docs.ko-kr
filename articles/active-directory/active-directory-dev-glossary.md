...
## 보안 토큰
OAuth2 토큰 또는 SAML 2.0 어설션과 같은 클레임을 포함한 서명된 문서입니다. OAuth2 [권한 부여](#authorization-grant)의 경우, [액세스 토큰](#access-token)(OAuth2)과 [ID 토큰](OpenID Connect.md)은 보안 토큰의 유형으로 둘 다 [JSON Web Token(JWT)][JWT]으로 구현됩니다.
