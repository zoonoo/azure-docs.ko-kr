<properties
	pageTitle="Azure 리소스 액세스 권한 할당 보기 | Microsoft Azure"
...
# Azure Portal에서 사용자 및 그룹에 대한 액세스 권한 할당 보기 - 공개 미리 보기
...
2. **사용자 및 그룹** 및 **모든 사용자** 또는 **모든 그룹**을 차례로 선택합니다. 이 예제에서는 개별 사용자에게 집중합니다. ![Azure Active Directory에서 사용자 및 그룹 관리 - 스크린샷](./media/role-based-access-control-manage-assignments/rbac_users_groups.png)
...
2. **제거** 및 **예**를 차례로 선택하고 확인합니다. ![액세스 권한 할당 제거 - 스크린샷](./media/role-based-access-control-manage-assignments/delete_assignment.png)

## 관련된 항목

- [역할 할당을 사용하여 Azure 구독 리소스에 대한 액세스를 관리](role-based-access-control-configure.md)하려면 역할 기반 액세스 제어를 시작합니다.
