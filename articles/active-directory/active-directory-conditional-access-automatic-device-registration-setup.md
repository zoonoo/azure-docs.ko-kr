...
> [AZURE.NOTE] Windows 10 2015년 11월 업데이트는 향상된 사용자 경험 중 일부를 지원하지만 이는 장치 기반 조건부 액세스를 완전히 지원하는 1주년 업데이트입니다.  
...
> [AZURE.NOTE] $aadAdminCred = Get-Credential을 실행하는 경우 Get-Credential 팝업이 표시될 때 입력되는 자격 증명의 사용자 이름에 대한 형식 user@example.com을(를) 사용합니다.  
