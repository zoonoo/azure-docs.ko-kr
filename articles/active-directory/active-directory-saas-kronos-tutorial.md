...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. 식별자 텍스트 상자에 `https://<company name>.kronos.net/`

    b. 회신 URL에 `https://<company name>.kronos.net/wfc/navigator/logonWithUID`
...
### <a name="creating-an-kronos-test-user"></a>Kronos 테스트 사용자 만들기
