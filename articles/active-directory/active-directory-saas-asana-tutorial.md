...
1. **Asana에서 Single Sign-On 구성** 페이지에서 **인증서 다운로드**를 클릭한 다음 컴퓨터에 파일을 저장합니다. 또한 SAML SSO URL에 대한 값을 복사합니다.
...
6. Azure AD에서 **Asana의 Single Sign-On 구성** 페이지로 이동하고 Single Sign-On 구성 확인을 선택한 후 **다음**을 클릭합니다.
