...
description: "Azure Active Directory에서 JobScore를 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다."
...
6. 검색 상자에 **JobScore**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_001.png)

7. 결과 창에서 **JobScore**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_0001.png)
...
이 연결 관계는 Azure AD의 **사용자 이름** 값을 JobScore의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션에서는 클래식 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 JobScore 응용 프로그램에서 Single Sign-On을 구성합니다.


**JobScore에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure 클래식 포털의 **JobScore** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.

    ![Single Sign-on 구성][6]

2. **JobScore에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
 
    ![Single Sign-on 구성](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_02.png)

3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.

    ![Single Sign-On 구성](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_03.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴 `https://hire.jobscore.com/auth/adfs/<company name>`을 사용하여 URL을 입력합니다.

    b. **다음**을 클릭합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이 값은 실제 로그인 URL로 업데이트해야 합니다. 이 값을 얻으려면 [JobScore 지원 팀](emaiLto:support@jobscore.com)에 문의하세요.

4. **JobScore에서 Single Sign-On 구성** 페이지에서 **메타데이터 다운로드**를 클릭한 다음 컴퓨터에 파일을 저장합니다.

    ![Single Sign-on 구성](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_04.png) 

5. 응용 프로그램에 대해 SSO를 구성하려면 [JobScore 지원 팀](emaiLto:support@jobscore.com)에 문의하고 다운로드한 **메타데이터**를 제공합니다.
...
1. **Azure 클래식 포털**의 왼쪽 탐색 창에서 **Active Directory**를 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_09.png) 

2. **디렉터리** 목록에서 디렉터리 통합을 사용하도록 설정할 디렉터리를 선택합니다.

3. 사용자 목록을 표시하려면 위쪽 메뉴에서 **사용자**를 클릭합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_03.png) 

4. **사용자 추가** 대화 상자를 열려면 아래쪽 도구 모음에서 **사용자 추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_04.png) 

5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_05.png) 
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_06.png) 
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_07.png) 

8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-jobscore-tutorial/create_aaduser_08.png) 
...
이 섹션에서는 JobScore에서 Britta Simon이라는 사용자를 만듭니다. JobScore 플랫폼에서 사용자를 추가하려면 [JobScore 지원 팀](emaiLto:support@jobscore.com)에 문의하세요.
...
2. 응용 프로그램 목록에서 **JobScore**를 선택합니다.
    ...
    ![Single Sign-On 구성](./media/active-directory-saas-jobscore-tutorial/tutorial_jobscore_50.png) 
