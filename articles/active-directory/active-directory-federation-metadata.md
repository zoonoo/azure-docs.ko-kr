...
**테넌트에 독립적인 끝점**의 경우 `TenantDomainName`는 `common`입니다. 이 문서는 login.microsoftonline.com에서 호스트되는 모든 Azure AD 테넌트에 공통된 페더레이션 메타데이터 요소만을 나열합니다.
