...
4. 검색 상자에 **EBSCO**를 입력하고 결과 패널에서 **EBSCO**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 EBSCO](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_addfromgallery.png)
...
3. **[EBSCO 테스트 사용자 만들기](#create-an-ebsco-test-user)** - EBSCOhost 사용자 프로비저닝/개인 설정을 자동화할 수 있습니다. EBSCO는 Just-In-Time 사용자 프로비저닝을 지원합니다.
...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_samlbase.png)

3. **EBSCO 도메인 및 URL** 섹션에서 **IDP** 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![EBSCO 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_url.png)

    **식별자** 텍스트 상자에 URL `pingsso.ebscohost.com`를 입력합니다.

4. **SP** 시작 모드에서 응용 프로그램을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.

    ![EBSCO 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_url1.png)
...
5. EBSCO 응용 프로그램은 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
    ...
    > [!Note]
    > **name** 특성은 필수이며 EBSCO 응용 프로그램의 **사용자 식별자**에 매핑됩니다. 기본적으로 추가되므로 수동으로 추가할 필요가 없습니다.
...
7. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_certificate.png) 

8. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-ebsco-tutorial/tutorial_general_400.png)
    
9. **EBSCO** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [EBSCO 지원 팀](mailto:sso@ebsco.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-ebsco-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-ebsco-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-ebsco-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-ebsco-tutorial/create_aaduser_04.png)
...
2. 응용 프로그램 목록에서 **EBSCO**를 선택합니다.

    ![응용 프로그램 목록의 EBSCO 연결](./media/active-directory-saas-ebsco-tutorial/tutorial_ebsco_app.png)  
...
2. 응용 프로그램에 로그인한 후에 오른쪽 위 구석에 있는 **로그인** 단추를 클릭합니다.
...
4. 위 설정이 완료되면 쿠키/캐시를 지우고 다시 로그인합니다. 다시 수동으로 로그인할 필요는 없습니다. 개인 설정은 저장됩니다.
