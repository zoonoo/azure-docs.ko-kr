...
| Azure AD 끝점 | Azure AD Connect는 Azure AD 신뢰에 구성된 엔드포인트가 항상 복원력 및 성능에 권장되는 최신 값을 따르도록 합니다. |
...
![기존 Azure AD 신뢰 백업에 대한 메시지를 보여주는 Azure AD Connect 페이지](media/active-directory-azure-ad-connect-azure-ad-trust/backup2.png)
...
![Azure AD 신뢰의 백업 예에 대한 스크린샷](media/active-directory-azure-ad-connect-azure-ad-trust/backup.png)
