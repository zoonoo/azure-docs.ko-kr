...
| **AD FS 구성 수정** | |
| [트러스트 복구](active-directory-aadconnect-federation-management.md#repairthetrust) |온-프레미스 AD FS와 Office 365/Azure 사이의 현재 트러스트를 복구하는 방법 |
...
| [AD FS 클레임 규칙 수정](active-directory-aadconnect-federation-management.md#modclaims) |Azure AD Connect 동기화 구성에 해당하는 AD FS의 클레임 규칙 수정/추가 |
