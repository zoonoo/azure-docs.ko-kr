...
### <a name="highlevel-steps-for-upgrading-from-dirsync-to-azure-ad-connect"></a>DirSync에서 Azure AD Connect로 업그레이드하기 위한 대략적인 단계
...
## <a name="inplace-upgrade"></a>전체 업그레이드
