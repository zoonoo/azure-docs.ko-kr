---
title: "Azure AD Connect: Azure Active Directory와 온-프레미스 ID 통합 | Microsoft Docs"
...
---
# <a name="integrating-your-on-premises-identities-with-azure-active-directory"></a>Azure Active Directory와 온-프레미스 ID 통합
