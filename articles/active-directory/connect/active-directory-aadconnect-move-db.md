...
- [기존 ADSync 데이터베이스를 사용하여 Azure AD Connect 설치](active-directory-aadconnect-existing-database.md)
- [ISQL 위임된 관리자 권한을 사용하여 Azure AD Connect 설치](active-directory-aadconnect-sql-delegation.md)
