...
![Azure AD Connect의 정의](./media/active-directory-aadconnect-ports/required2.png)
...
## <a name="table-6---pass-through-authentication"></a>테이블 6 - 통과 인증
이 테이블은 커넥터 및 Azure AD 간의 통신에 필요한 포트와 프로토콜에 대해 설명합니다.
