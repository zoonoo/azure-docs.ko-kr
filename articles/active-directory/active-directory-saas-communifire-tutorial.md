...
4. 검색 상자에 **Communifire**를 입력하고 결과 패널에서 **Communifire**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 Communifire](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_addfromgallery.png)
...
3. **[Communifire 테스트 사용자 만들기](#create-a-communifire-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Communifire에 만듭니다.
...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_samlbase.png)

3. **Communifire 도메인 및 URL** 섹션에서 IDP 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![Communifire 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_url.png)

    a. **식별자** 텍스트 상자에서 `https://<subdomain>.communifire.com` 패턴을 사용하여 URL을 입력합니다.

    b. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<subdomain>.communifire.com/SAML/AssertionConsumerService.aspx`

4. **SP** 시작 모드에서 응용 프로그램을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.

    ![Communifire 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_url1.png)
...
5. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_certificate.png) 

6.  **고급 인증서 서명 설정 표시** 확인란을 선택하고 **서명 옵션**을 **SAML 응답 및 어설션 서명**으로 선택합니다.

    ![인증서 옵션](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_certificateoption.png) 

7. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-communifire-tutorial/tutorial_general_400.png)
    
8. **Communifire** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Communifire 지원팀](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-communifire-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-communifire-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-communifire-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-communifire-tutorial/create_aaduser_04.png)
...
2. 응용 프로그램 목록에서 **Communifire**를 선택합니다.

    ![응용 프로그램 목록의 Communifire 링크](./media/active-directory-saas-communifire-tutorial/tutorial_communifire_app.png)  
