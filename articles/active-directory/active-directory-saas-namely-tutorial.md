...
4. 검색 상자에서 **Namely**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-namely-tutorial/tutorial_namely_search.png)

5. 결과 패널에서 **Namely**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-namely-tutorial/tutorial_namely_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Azure AD Single Sign-on 구성 및 테스트
이 섹션에서는 “Britta Simon”이라는 테스트 사용자를 기반으로 Namely에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Namely 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Namely의 관련 사용자 간에 연결이 형성되어야 합니다.

Namely에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.

Namely에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Configuring Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
3. **[Namely 테스트 사용자 만들기](#creating-a-namely-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Namely에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Namely 응용 프로그램에서 Single Sign-On을 구성합니다.

**Namely에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Namely** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Namely 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Configure Single Sign-On](./media/active-directory-saas-namely-tutorial/tutorial_namely_url.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<subdomain>.namely.com`

    나. **식별자** 텍스트 상자에서 `https://<subdomain>.namely.com/saml/metadata` 패턴을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 로그온 URL 및 식별자로 값을 업데이트합니다. 이러한 값을 얻으려면 [Namely 클라이언트 지원 팀](https://www.namely.com/contact/)에 문의하세요. 
...
6. **Namely 구성** 섹션에서 **Namely 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/active-directory-saas-namely-tutorial/tutorial_namely_configure.png) 

7. 다른 웹 브라우저 창에서 Namely 회사 사이트에 관리자로 로그인합니다.

8. 위쪽 도구 모음에서 **회사**를 클릭합니다.
...
11. **SAML 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    나. Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL** 값을 **ID 공급자 SSO URL** 텍스트 상자에 붙여넣습니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 Britta Simon에게 Namely에 대한 액세스 권한을 부여합니다.
