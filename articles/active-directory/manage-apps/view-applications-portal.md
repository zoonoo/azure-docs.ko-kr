...
4. 더 많은 애플리케이션을 보려면 목록 아래에서 **추가 로드**를 클릭합니다. 테넌트에 있는 애플리케이션 수에 따라 목록을 스크롤하는 것보다 [특정 애플리케이션을 검색](#search-for-a-tenant-application)하는 것이 더 쉬울 수 있습니다.
