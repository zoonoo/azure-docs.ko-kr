...
5. Microsoft Windows Installer 패키지(.msi 파일) [Access Panel Extension.msi](https://account.activedirectory.windowsazure.com/Applications/Installers/x64/Access%20Panel%20Extension.msi)를 다운로드합니다.
...
5. **소프트웨어 배포** 프롬프트에서 배포 방법으로 **할당**을 선택합니다. 그런 후 **OK**를 클릭합니다.
    ...
    ![할당됨을 선택하고 확인을 클릭합니다.](./media/deploy-access-panel-browser-extension/deployment-method.png)
...
2. **추가 기능 목록**을 마우스 오른쪽 단추로 클릭하고 **편집**을 선택합니다.
    ![추가 기능 목록을 편집합니다.](./media/deploy-access-panel-browser-extension/edit-add-on-list.png)
...
4. **내용 표시** 창에서 다음 단계를 수행합니다.
   ...
   3. **확인**을 클릭하여 **내용 표시** 창을 닫습니다.
      ...
      ![위에서 지정한 대로 값을 입력합니다.](./media/deploy-access-panel-browser-extension/show-contents.png)
...
![암호 프롬프트](./media/deploy-access-panel-browser-extension/remember-password-prompt.png)
...
2. 이름이 **양식의 사용자 이름과 암호에 자동 완성 기능 사용**인 설정을 찾습니다.
   ...
   > 
    ...
    ![사용자 설정에서 이 내용을 찾아야 합니다.](./media/deploy-access-panel-browser-extension/disable-auto-complete.png)
3. 위 설정을 마우스 오른쪽 단추로 클릭하고 **편집**을 선택합니다.
4. **양식의 사용자 이름과 암호에 자동 완성 기능 사용** 창에서 **사용 안함**을 선택합니다.
   
    ![사용 안함 선택](./media/deploy-access-panel-browser-extension/disable-passwords.png)
...
4. 다시 시작한 후 **Internet Explorer**를 엽니다. 창의 오른쪽 위 모퉁이에서 **도구**(기어 아이콘)를 클릭한 다음 **추가 기능 관리**를 선택합니다.
    ...
    ![도구 > 추가 기능 관리로 이동](./media/deploy-access-panel-browser-extension/manage-add-ons.png)
