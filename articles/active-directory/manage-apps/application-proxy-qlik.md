...
**5단계**: 내부 URL은 애플리케이션에서 사용하는 인증 포트를 사용하는 QlikSense URL이어야 합니다. 기본값은 HTTPS의 경우 **4244이고,** 2018년 4월 이전에 QlikSense 릴리스의 경우 HTTP의 경우 **4248입니다.** 2018년 4월 이후에 출시된 QlikSense의 기본값은 HTTPS의 경우 **443이고** HTTP의 경우 **80입니다.**  예: **https&#58;//demo.qlik.com:4244**</br></br>
**단계 #10:** SSO를 설정하지 않고 단일 **사인온을 사용하지 않도록 설정하지** 마십시오.
...
응용 프로그램 프록시를 사용하여 Qlik Sense를 게시하는 것에 대한 자세한 내용은 Qlik 커뮤니티 문서를 참조하십시오. 
- [Qlik 센스를 가진 Kerberos 제한된 위임을 사용하여 통합 된 Windows 인증을 가진 Azure AD](https://community.qlik.com/docs/DOC-20183)
- [Azure AD 응용 프로그램 프록시와 Qlik 감지 통합](https://community.qlik.com/t5/Technology-Partners-Ecosystem/Azure-AD-Application-Proxy/ta-p/1528396)
