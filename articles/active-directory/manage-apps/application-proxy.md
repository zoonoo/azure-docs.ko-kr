...
- **간편한 사용**. 사용자는 Microsoft 365 및 Azure AD와 통합 된 다른 SaaS 앱에 액세스 하는 것과 동일한 방식으로 온-프레미스 응용 프로그램에 액세스할 수 있습니다. 애플리케이션 프록시를 사용하도록 애플리케이션을 변경하거나 업데이트할 필요가 없습니다.
