---
title: Azure AD 응용 프로그램 프록시에 대 한 고가용성 및 부하 분산 | Microsoft Docs
...
### <a name="scenario-1-back-end-application-does-not-require-session-persistence"></a>시나리오 1: 백 엔드 응용 프로그램에는 세션 지 속성이 필요 하지 않습니다.
...
### <a name="scenario-2-back-end-application-requires-session-persistence"></a>시나리오 2: 백 엔드 응용 프로그램에는 세션 지 속성이 필요 합니다.
...
- 옵션 2: X 전달-헤더 필드에서 세션 지 속성을 기반으로 합니다. 이 옵션을 사용 하려면이 기능을 사용 하는 계층 7 부하 분산 장치가 필요 하며 HTTP 트래픽을 처리 하 고 SSL 연결을 종료할 수 있습니다.  

- 옵션 3: 백 엔드 응용 프로그램에서 세션을 지 원하는 것을 요구 하지 않도록 구성 합니다.
