...
![앱 또는 id 저장소에 Azure AD에서 프로 비전 보여 줍니다.][0]<br/>
...
![사용자 프로 비전 및 시퀀스 프로 비전 해제를 보여 줍니다.][4]<br/>
...
![그룹 프로 비전 및 시퀀스 프로 비전 해제를 보여 줍니다.][5]<br/>
...
###### <a name="request-1"></a>요청
*GET /Users/5d48a0a8e9f04aa38008* 

###### <a name="response-1"></a>응답
*HTTP/1.1 200 OK*
```json
{
    "schemas": ["urn:ietf:params:scim:schemas:core:2.0:User"],
...
##### <a name="request-2"></a>요청

*GET /Users?filter=userName eq "Test_User_dfeef4c5-5681-4387-b016-bdf221e82081"*

##### <a name="response-2"></a>응답
...
##### <a name="request-3"></a>요청

*GET /Users?filter=userName eq "non-existent user"*

##### <a name="response-3"></a>응답
...
##### <a name="request-6"></a>요청

*DELETE /Users/5171a35d82074e068ce2 HTTP/1.1*

##### <a name="response-6"></a>응답
...
##### <a name="request-8"></a>요청

*GET /Groups/40734ae655284ad3abcc?excludedAttributes=members HTTP/1.1*

##### <a name="response-8"></a>응답
*HTTP/1.1 200 OK*
```json
{
    "schemas": ["urn:ietf:params:scim:schemas:core:2.0:Group"],
...
##### <a name="request-9"></a>요청
*GET /Groups?excludedAttributes=members&filter=displayName eq "displayName" HTTP/1.1*

##### <a name="response-9"></a>응답
...
##### <a name="response-12"></a>응답

*HTTP/1.1 204 No Content*

#### <a name="delete-group"></a>그룹 삭제

##### <a name="request-13"></a>요청

*DELETE /Groups/cdb1ce18f65944079d37 HTTP/1.1*

##### <a name="response-13"></a>응답
...
1. 해당 메서드에 지정 된 테 넌 트를 Azure AD Graph 웹 서비스에 대 한 액세스에 대 한 Azure Active Directory에서 발급 한 토큰을 갖도록 인증 서비스의 끝점 중 하나가 요청에 다음 코드를 추가 합니다. 
...
1. 쿼리할 때 응답으로 사용자의 mailNickname 특성 값과 일치 하는 externalId 특성 값을 사용 하 여 사용자에 대 한 웹 서비스에 사용자를 반환 하지 않으면, 그런 다음 Azure Active Directory 요청 서비스는 해당 하는 사용자를 프로 비전 Azure Active directory 의미 합니다.  다음은 그러한 요청의 예제입니다. 
...
1. 참조 특성을 업데이트할 경우 다음 Azure Active Directory 서비스를 쿼리하여 일치 여부를 확인에 의해 제어 되는 id 저장소에서 참조 특성의 현재 값을 서비스 이미 Azure Active의 해당 특성 값 디렉터리입니다. 사용자의 경우 현재 값이 이 방식으로 쿼리된 유일한 특성은 관리자 특성입니다. 특정 사용자 개체의 관리자 특성 값에 현재 특정 값이 있는지 여부를 결정하는 요청의 예는 다음과 같습니다. 
