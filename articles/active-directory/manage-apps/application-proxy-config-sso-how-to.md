...
특정 유형의 Single Sign-On을 구성합니다. 로그온 방법은 백 엔드 응용 프로그램에서 사용하는 인증 유형에 따라 분류됩니다. 앱 프록시 애플리케이션에서 지원하는 세 가지 유형의 로그온은 다음과 같습니다.
...
이 페이지에는 추가 로그온 옵션인 연결된 로그온도 표시됩니다. 이 옵션은 애플리케이션 프록시에서도 지원됩니다. 그러나 이 옵션은 애플리케이션에 Single Sign-On을 추가하지 않습니다. 즉, 응용 프로그램에 이미 Active Directory Federation Services와 같은 다른 서비스를 사용하여 Single Sign-On이 구현되어 있을 수 있습니다. 
