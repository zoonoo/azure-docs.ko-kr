...
description: 암호 single sign-on에 대해 구성 된 Azure AD 갤러리 응용 프로그램의 문제를 해결 하는 방법입니다.
documentationcenter: ''
author: msmimart
manager: CelesteDG
ms.assetid: ''
...
액세스 패널에서 암호 기반 SSO (single sign-on)를 사용 하려면 브라우저에 액세스 패널 확장을 설치 해야 합니다. 암호 기반 SSO 용으로 구성 된 앱을 선택 하면 확장이 자동으로 다운로드 됩니다.
...
-   GPO (그룹 정책 개체)를 편집할 수 있는 "설정 편집" 권한이 있습니다. 기본적으로 다음 보안 그룹의 구성원에게는 이 권한이 있습니다: 도메인 관리자, 엔터프라이즈 관리자 및 그룹 정책 작성 소유자. [자세히 알아보기](https://technet.microsoft.com/library/cc781991%28v=ws.10%29.aspx).
