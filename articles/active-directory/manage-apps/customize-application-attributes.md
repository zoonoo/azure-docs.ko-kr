...
>[!TIP]
>그룹 개체(속성 및 멤버) 프로비전은 응용 프로그램에 [그룹을 할당](assign-user-or-group-access-portal.md)하는 것과 별개의 개념입니다. 응용 프로그램에 그룹을 할당할 수 있지만 그룹에 포함된 사용자 개체만 프로비전할 수 있습니다. 할당에서 그룹을 사용하기 위해 전체 그룹 개체를 프로비전할 필요는 없습니다.
