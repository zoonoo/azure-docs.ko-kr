...
응용 프로그램을 디렉터리에 추가 하는 방법 및 이유에 대 한 자세한 내용은 [AZURE AD에 응용 프로그램을 추가 하는 방법](../develop/active-directory-how-applications-are-added.md)을 참조 하세요.
