...
|---|---|
| 서비스 유형| 예: SharePoint, SAP, CRM, 사용자 지정 웹 응용 프로그램, API |
...
**커넥터 호스트와 대상 응용 프로그램 간 SSL**: 보안이 가장 중요 하므로 커넥터 호스트와 대상 응용 프로그램 간의 TLS는 항상 사용 해야 합니다. 특히 웹 응용 프로그램이 FBA (폼 기반 인증)에 대해 구성 된 경우 사용자 자격 증명은 일반 텍스트로 효과적으로 전송 됩니다.
...
응용 프로그램을 게시 한 후에는 브라우저에서 외부 URL을 입력 하거나 [https://myapps.microsoft.com](https://myapps.microsoft.com/)의 아이콘으로 응용 프로그램에 액세스할 수 있어야 합니다.
