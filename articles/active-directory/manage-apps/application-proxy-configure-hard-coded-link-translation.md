...
description: Azure AD 애플리케이션 프록시를 통하여 게시된 앱에 대하여 하드 코드된 링크를 리디렉션하는 방법을 알아봅니다.
...
ms.locfileid: "108169520"
---
# <a name="redirect-hard-coded-links-for-apps-published-with-azure-ad-application-proxy"></a>Azure AD 애플리케이션 프록시를 통하여 게시된 앱에 대하여 하드 코드된 링크를 리디렉션
