---
title: Azure AD 응용 프로그램에 대 한 연결 된 로그인-Microsoft identity platform | Microsoft Docs
description: Microsoft id 플랫폼 (Azure AD)에서 Azure AD 엔터프라이즈 응용 프로그램에 연결 된 SSO (single sign-on) 구성
