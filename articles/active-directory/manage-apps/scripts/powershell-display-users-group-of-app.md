---
title: PowerShell 샘플 - 애플리케이션 프록시 앱의 사용자 및 그룹 나열
...
| 명령 | 메모 |
|---|---|
| [Get-AzureADUser](/powershell/module/AzureAD/get-azureaduser?view=azureadps-2.0)| 사용자를 가져옵니다. |
| [Get-AzureADGroup](/powershell/module/AzureAD/get-azureadgroup?view=azureadps-2.0)| 그룹을 가져옵니다. |
| [Get-AzureADServicePrincipal](/powershell/module/azuread/get-azureadserviceprincipal?view=azureadps-2.0) | 서비스 주체를 가져옵니다. |
| [Get-AzureADUserAppRoleAssignment](/powershell/module/AzureAD/get-azureaduserapproleassignment?view=azureadps-2.0) | 사용자 애플리케이션 역할 할당을 가져옵니다. |
| [Get-AzureADGroupAppRoleAssignment](/powershell/module/AzureAD/get-azureadgroupapproleassignment?view=azureadps-2.0) | 그룹 애플리케이션 역할 할당을 가져옵니다. |
