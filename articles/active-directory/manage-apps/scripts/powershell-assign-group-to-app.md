---
title: PowerShell 샘플 - 애플리케이션 프록시 앱에 그룹 할당
...
| 명령 | 메모 |
|---|---|
| [New-AzureADGroupAppRoleAssignment](https://docs.microsoft.com/powershell/module/AzureAD/New-azureadgroupapproleassignment?view=azureadps-2.0) | 애플리케이션 역할에 그룹을 할당합니다. |
