...
---
# <a name="get-all-application-proxy-apps-with-a-token-lifetime-policy"></a>토큰 수명 정책을 사용 하 여 모든 응용 프로그램 프록시 앱 가져오기
...
|[New-azureadpolicy](https://docs.microsoft.com/powershell/module/azuread/get-azureadpolicy?view=azureadps-2.0-preview) | Azure AD에서 정책을 가져옵니다. |
|[AzureADServicePrincipalPolicy](https://docs.microsoft.com/powershell/module/azuread/get-azureadserviceprincipalpolicy?view=azureadps-2.0-preview) | Azure AD의 서비스 주체에 대 한 정책을 가져옵니다. |
