...
| [AzureADApplicationProxyConnectorGroup](https://docs.microsoft.com/powershell/module/azuread/set-azureadapplicationproxyapplicationconnectorgroup?view=azureadps-2.0) | 지정 된 응용 프로그램에 지정 된 커넥터 그룹을 할당 합니다.|
