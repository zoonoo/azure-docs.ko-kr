...
5.  **모든 애플리케이션**을 클릭하여 모든 애플리케이션의 목록을 봅니다.
    ...
    1.  여기에 표시 하려는 응용 프로그램이 표시 되지 않으면 **모든 응용 프로그램 목록** 의 맨 위에 있는 **필터** 컨트롤을 사용 하 고 **표시** 옵션을 **모든 응용 프로그램** 으로 설정 합니다.
...
11. 목록에서 **사용자** 를 마우스로 가리켜서 **확인란**을 표시 합니다. 사용자를 **선택됨** 목록에 추가하려면 사용자의 프로필 사진이나 로고 옆의 확인란을 클릭합니다.
...
15. **할당** 단추를 클릭 하 여 선택한 사용자에 게 응용 프로그램을 할당 합니다.
