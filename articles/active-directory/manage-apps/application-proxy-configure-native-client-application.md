...
다른 애플리케이션과 마찬가지로 프록시 애플리케이션을 게시하고 애플리케이션에 액세스하도록 사용자를 할당합니다. 자세한 내용은 [응용 프로그램 프록시를 사용 하 여 응용 프로그램 게시](application-proxy-add-on-premises-application.md)를 참조 하세요.
...
| --- | --- |
| \<테 넌 트 ID> | **Azure Active Directory** > **Properties**속성 > **디렉터리 ID** |
| \<프록시 앱>의 외부 Url | **엔터프라이즈 응용** > 프로그램*프록시 응용* > 프로그램**프록시** > **외부 Url** |
| \<네이티브 앱의 앱 ID> | **엔터프라이즈 응용** > 프로그램*네이티브 응용 프로그램* > **속성** > **응용 프로그램 ID** |
| \<네이티브 앱의 리디렉션 URI> | **Azure Active Directory** > **App registrations** > *네이티브 응용*프로그램 > **리디렉션 uri** 를 앱 등록 Azure Active Directory |
| \<프록시 앱 API Url> | **Azure Active Directory** > **App registrations**앱 등록 > *네이티브 응용 프로그램* > **api 권한** > **api/사용 권한 이름** |
