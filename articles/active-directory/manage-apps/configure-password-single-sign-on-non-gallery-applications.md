---
title: Azure AD 앱에 대 한 암호 single sign-on을 구성 하는 방법 | Microsoft Docs
description: Microsoft id 플랫폼 (Azure AD)에서 Azure AD 엔터프라이즈 응용 프로그램에 대 한 암호 SSO (single sign-on)를 구성 하는 방법
...
## <a name="open-the-app-and-select-password-single-sign-on"></a>앱을 열고 암호 single sign-on을 선택 합니다.
...
4. 검색 상자에 응용 프로그램의 이름을 입력 한 다음 결과에서 응용 프로그램을 선택 합니다.
...
1. 응용 프로그램  **이름 > 구성에서 응용 프로그램 이름 > 암호 Single sign-on 설정 구성을 선택 하 여 로그온 구성 페이지를 표시 \<** 합니다.  **\<** 
