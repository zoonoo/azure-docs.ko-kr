...
-   사용자가 자격 증명을 입력하는 경우 **애플리케이션 액세스 패널**에 표시되는 사용자 이름 및 암호 입력 필드의 [레이블 사용자 지정](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)
...
2. **Azure Active Directory** > **Enterprise 응용 프로그램**으로 이동 합니다. Azure AD 테넌트에 있는 애플리케이션 샘플이 임의로 표시됩니다. 
...
1. **\<응용 프로그램 이름 > 구성**에서 **\<응용 프로그램 이름 구성 > 암호 Single sign-on 설정** 을 선택 하 여 로그온 **구성** 페이지를 표시 합니다. 
