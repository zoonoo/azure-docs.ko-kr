...
| [인증서를 업로드 하지 않고 게시 된 모든 Azure AD 프록시 응용 프로그램 앱 가져오기](scripts/powershell-get-all-custom-domain-no-cert.md) | 사용자 지정 도메인을 사용 하지만 유효한 SSL 인증서를 업로드 하지 않은 모든 응용 프로그램 프록시 앱을 나열 합니다. |
