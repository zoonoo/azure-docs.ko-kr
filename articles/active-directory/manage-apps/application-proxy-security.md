...
애플리케이션 프록시를 통해 게시된 애플리케이션은 DDoS(서비스 분산 거부) 공격으로부터 보호됩니다. 이 보호는 Microsoft에서 관리 하며 모든 데이터 센터에서 자동으로 사용 하도록 설정 됩니다. Azure DDoS protection 서비스는 상시 트래픽 모니터링과 일반적인 네트워크 수준 공격에 대 한 실시간 완화 기능을 제공 합니다. 
