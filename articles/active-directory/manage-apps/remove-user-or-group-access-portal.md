---
title: Azure AD의 앱에서 사용자 또는 그룹 할당 제거
...
Azure Active Directory(Azure AD)의 엔터프라이즈 응용 프로그램 중 하나에 대한 할당된 액세스에서 사용자 또는 그룹을 쉽게 제거할 수 있습니다. 엔터프라이즈 앱을 관리하려면 적절한 권한이 필요합니다. 또한 디렉터리에 대한 전역 관리자여야 합니다.
...
1. Azure **Active Directory - *디렉터리 이름* ** 페이지(즉, 관리하는 디렉터리의 Azure AD 페이지)에서 **엔터프라이즈 응용 프로그램을 선택합니다.**
1. 엔터프라이즈 **응용 프로그램 - 모든 응용 프로그램** 페이지에서 관리할 수 있는 앱 목록이 표시됩니다. 앱을 선택합니다.
1. 앱 ***이름*** 개요 페이지(즉, 제목에서 선택한 앱의 이름이 있는 페이지)에서 **사용자 & 그룹을**선택합니다.
...
1. 다음 스크립트를 사용하여 응용 프로그램에서 사용자 및 역할을 제거합니다.
