...
> [!NOTE]
> 응용 프로그램은를 사용할 때 렌더링 된 XML에 있는 바이트 순서 표식을 처리할 수 있어야 합니다 https://login.microsoftonline.com/{tenant-id}/federationmetadata/2007-06/federationmetadata.xml?appid={app-id} . 바이트 순서 표시는 인쇄할 수 없는 ASCII 문자» 하면으로 표시 되 고 16 진수로 표시 됩니다. XML 데이터를 검토할 때 EF BB BF로 표시 됩니다.
