...
|3 | 커넥터 서버에서 포트 테스트 실행 | 커넥터 서버에서 [텔넷](/windows-server/administration/windows-commands/telnet) 또는 기타 포트 테스트 도구를 사용 하 여 포트 [443 및 80이 열려](application-proxy-add-on-premises-application.md#open-ports)있는지 확인 하는 방식으로 포트 테스트를 실행 합니다.|
