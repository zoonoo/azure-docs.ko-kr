...
![Azure AD IaaS 네트워크를 보여 주는 다이어그램](./media/application-proxy-connector-groups/application-proxy-iaas-network.png)
...
![예제에서는 Azure AD 커넥터 그룹 없음](./media/application-proxy-connector-groups/application-proxy-sample-config-2.png)
