---
title: 액세스 패널의 암호 기반 단일 사인온(SSO) | 마이크로 소프트 문서
description: 암호 단일 사인온으로 구성된 Azure AD Gallery 응용 프로그램에 로그인과 관련된 문제를 해결하는 방법에 대한 지침을 제공하는 문제 영역에 대해 설명합니다.
...
-   그룹 정책 개체(GPO)를 편집하는 "설정 편집" 사용 권한이 있어야 합니다. 기본적으로 도메인 관리자, 엔터프라이즈 관리자 및 그룹 정책 작성자/소유자 보안 그룹의 멤버에게 이 권한이 있습니다. [자세히 알아봅니다](https://technet.microsoft.com/library/cc781991%28v=ws.10%29.aspx).
