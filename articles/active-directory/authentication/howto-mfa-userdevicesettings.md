---
title: 관리자가 사용자 및 장치 관리-Azure MFA-Azure Active Directory
...
조직에서는 다음을 사용 하 여 PowerShell을 통해 이러한 단계를 완료 하 여 `StrongAuthenticationMethods` 특성을 지울 수 있습니다.
...
이 확인란을 선택 하면 **모든 기억 된 장치에서 multi-factor authentication을 복원** 합니다. 사용자가 다음 번에 로그인 할 때 장치를 신뢰할 수 있는 것으로 표시 한 경우에도 2 단계 인증을 수행 해야 합니다.
