---
title: 인증 방법 사용 & insights 보고 (미리 보기)-Azure Active Directory
...
1. **Azure Active Directory** > **암호 재설정**@no__t 3**사용 & insights**로 이동 합니다.
...
사용 & 정보에 직접 액세스 하려면 [https://portal.azure.com/#blade/Microsoft_AAD_IAM/AuthMethodsOverviewBlade](https://portal.azure.com/#blade/Microsoft_AAD_IAM/AuthMethodsOverviewBlade)로 이동 합니다. 이 링크를 누르면 등록 개요가 표시 됩니다.

등록 된 사용자, 사용자 설정 및 사용자 지원 타일에는 사용자에 대 한 다음과 같은 등록 데이터가 표시 됩니다.

- 등록 사용자가 조직의 SSPR 또는 Multi-Factor Authentication 정책을 충족 하기에 충분 한 인증 방법을 등록 한 경우에는 등록 된 것으로 간주 됩니다.
- 사용: SSPR 정책에 대 한 범위 내에 있는 경우 사용자가 사용 하도록 설정 된 것으로 간주 됩니다. 그룹에 대해 SSPR를 사용 하는 경우 사용자가 해당 그룹에 있는 경우 사용 하도록 설정 된 것으로 간주 됩니다. 모든 사용자에 대해 SSPR를 사용 하도록 설정한 경우에는 테 넌 트의 모든 사용자 (게스트 제외)가 사용 하도록 설정 된 것으로 간주 됩니다.
- 지원 사용자가 등록 되 고 사용 하도록 설정 된 경우 사용자가 사용할 수 있는 것으로 간주 됩니다. 이 상태는 필요한 경우 언제 든 지 SSPR를 수행할 수 있음을 의미 합니다.
