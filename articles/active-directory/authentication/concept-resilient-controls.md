...
1. 회사 네트워크 아웃바운드 IP 주소가 있으면 회사 네트워크에만 인증할 수 있도록 이를 신뢰할 수 있는 IP로 추가합니다.
 2. 아웃바운드 IP 주소의 인벤토리가 없거나 회사 네트워크 내부 및 외부에서 액세스할 수 있어야 하는 경우 전체 IPv4 주소 공간을 CIDR 표기법 형식의 신뢰할 수 있는 IP(예: 192.168.1.1/24)로 추가할 수 있습니다.
