---
title: Windows 용 Azure AD 셀프 서비스 암호 재설정-Azure Active Directory
...
### <a name="windows-10-specific-prerequisites"></a>Windows 10 특정 필수 구성 요소
...
### <a name="windows-7-8-and-81-specific-prerequisites"></a>Windows 7, 8 및 8.1 관련 필수 구성 요소
