...
- "\<> 사용자 이름" (검색에 따옴표 포함)에 대 한 `C:\Program Files\Multi-Factor Authentication Server\Logs\MultiFactorAuthSvc.log` 및 모든 백업을 검색 하 여 추가 되거나 변경 되는 사용자 레코드의 모든 인스턴스를 찾습니다.
