...
> [!NOTE]
> 사용자에게는 셀프 서비스 암호 재설정 등록을 위해 모바일 앱을 등록하는 옵션이 없습니다. 대신 사용자는에서 [https://aka.ms/mfasetup](https://aka.ms/mfasetup) 또는의 보안 정보 등록 미리 보기에 모바일 앱을 등록할 수 [https://aka.ms/setupsecurityinfo](https://aka.ms/setupsecurityinfo)있습니다.
>
...
> [!WARNING]
> 재설정을 위해 한 가지 메서드만 필요한 경우 셀프 서비스 암호 재설정을 위해 사용자가 **가장 높은 수준의 보안을 유지할**수 있는 유일한 옵션입니다.
>
