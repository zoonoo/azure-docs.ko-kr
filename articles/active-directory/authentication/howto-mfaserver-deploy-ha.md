...
MFA 마스터와 하위 MFA 서버는 모두 2단계 인증이 필요한 경우 MFA 서비스와 통신합니다. 예를 들어 사용자가 2단계 인증을 요구하는 응용 프로그램에 액세스하려고 하는 경우 사용자는 AD(Active Directory)와 같은 ID 공급자에 의해 먼저 인증됩니다.
