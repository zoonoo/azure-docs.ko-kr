...
* ‘Azure Multi-Factor Authentication 사용자 일치 필요’가 선택되고 사용자가 사용자 목록에 없는 경우 다시 부팅한 후 머신에 로그인할 수 없습니다.
...
## <a name="to-secure-an-application-with-windows-authentication-use-the-following-procedure"></a>Windows 인증을 사용하여 애플리케이션을 보호하려면 다음 절차를 사용합니다.
