---
title: Azure MFA 서버 시작 - Azure 활성 디렉터리
...
![온-프레미스에서 MFA 서버 시작](./media/howto-mfaserver-deploy/server2.png)</center>
...
2. *Azure Active Directory*를 검색하고 선택합니다. **보안** > **MFA를**선택합니다.
3. **관리자 MFA 서버에서** **서버 설정을**선택합니다.
4. **다운로드**를 선택하고 다운로드 페이지의 지침을 따라 설치 관리자를 저장합니다. 

   ![Azure 포털에서 MFA 서버 다운로드](./media/howto-mfaserver-deploy/downloadportal.png)
...
![콘솔의 MFA 서버 이메일 템플릿](./media/howto-mfaserver-deploy/email2.png)
...
4. 오른쪽의 모든 사용자를 강조 표시하고 **가져오기**를 클릭합니다. 성공했음을 알려주는 팝업 메시지가 나타납니다. 가져오기 창을 닫습니다.
   ...
   ![활성 디렉터리에서 MFA 서버 사용자 가져오기](./media/howto-mfaserver-deploy/import2.png)
