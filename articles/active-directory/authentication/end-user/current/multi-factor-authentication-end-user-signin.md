...
[2단계 확인 설정 관리](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md) 방법 알아보기

문자 메시지 및 전화 대신 알림을 사용하여 로그인할 수 있도록 [Microsoft Authenticator 앱 시작](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md) 방법을 알아보세요.
