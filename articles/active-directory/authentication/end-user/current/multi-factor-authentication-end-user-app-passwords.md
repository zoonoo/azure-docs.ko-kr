...
- [Microsoft Authenticator 앱](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)을 사용하여 텍스트 또는 전화를 받는 대신 앱 알림으로 로그인을 확인합니다.
