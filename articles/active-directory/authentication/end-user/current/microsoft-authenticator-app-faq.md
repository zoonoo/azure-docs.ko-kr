...
iOS 장치를 실행하고, **자동 백업**을 켰고, 기존 장치에 계정 백업을 만든 경우 해당 백업을 사용하여 새 장치에 계정 자격 증명을 복구할 수 있습니다. 자세한 내용은 [Microsoft Authenticator 앱을 사용하여 계정 자격 증명 백업 및 복구](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-backup-and-recovery.md) 문서를 참조하세요. 
