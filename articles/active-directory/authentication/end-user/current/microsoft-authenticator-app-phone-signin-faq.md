...
1. 계정에 대해 휴대폰 로그인을 사용하도록 설정합니다.
  ...
  - Microsoft Authenticator 앱이 아직 없는 경우 [Microsoft Authenticator 페이지](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)의 단계에 따라 개인 Microsoft 계정을 설치하고 추가합니다. 새로 추가된 계정이 자동으로 활성화되므로 계속 진행할 수 있습니다.
...
일반적으로 앱에 대한 질문이 있으면 [Microsoft Authenticator FAQ](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md)를 살펴보세요.
