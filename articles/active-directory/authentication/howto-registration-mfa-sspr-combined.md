...
2. **Azure Active Directory** > **사용자 설정** > **사용자 기능 관리 미리 보기 설정**으로 이동 합니다.
...
![보안 정보 등록을 제어 하는 CA 정책 만들기](media/howto-registration-mfa-sspr-combined/require-registration-from-trusted-location.png)
