...
**하이브리드 AZURE AD 가입 장치의**경우 조직은 FIDO 보안 키 로그인을 사용 하도록 다음 그룹 정책 설정을 구성할 수 있습니다. 설정은 **컴퓨터 구성** > **관리 템플릿** > **System** > **Logon** > **보안 키 로그인 설정**에서 찾을 수 있습니다.
