...
![신호 조사 및 필요한 경우 MFA 적용](./media/concept-mfa-get-started/verify-signals-and-perform-mfa-if-required.png)
...
Azure AD의 무료 혜택을 활용 하는 고객은 [보안 기본값](../conditional-access/concept-conditional-access-security-defaults.md) 을 사용 하 여 환경에서 multi-factor authentication을 사용 하도록 설정할 수 있습니다.

## <a name="office-365"></a>PowerApps

Office 365를 사용 하는 고객의 경우 다음 두 가지 옵션을 사용할 수 있습니다.

- Azure AD를 통해 [보안 기본값](../conditional-access/concept-conditional-access-security-defaults.md) 을 사용 하도록 설정 하 여 모든 사용자를 azure Multi-Factor Authentication로 보호할 수 있습니다.
