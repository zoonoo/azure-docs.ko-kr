<properties
	pageTitle="자습서: OpsGenie와 Azure Active Directory 통합 | Microsoft Azure"
...
2. **OpsGenie에 대한 사용자 로그인 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
9. Azure Active Directory 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. Azure 클래식 포털의 **OpsGenie에서 Single Sign-on 구성** 대화 상자 페이지에서 **Single Sign-On 서비스 URL** 값을 복사한 다음 **SAML 2.0 끝점** 텍스트 상자에 붙여 넣습니다.
