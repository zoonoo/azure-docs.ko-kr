...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 OpsGenie 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 OpsGenie의 관련 사용자 간에 연결이 형성되어야 합니다.<br> 이 연결 관계는 Azure AD의 **사용자 이름** 값을 OpsGenie의 **Username** 값으로 할당하여 설정합니다.
...
이 섹션은 Azure AD 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 OpsGenie 응용 프로그램에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-opsgenie-tutorial/tutorial_opsgenie_04.png) <br>
...
4. **OpsGenie에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다. <br><br>![Single Sign-On 구성](./media/active-directory-saas-opsgenie-tutorial/tutorial_opsgenie_05.png) <br>
...
9. Azure Active Directory 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![OpsGenie 설정](./media/active-directory-saas-opsgenie-tutorial/tutorial_opsgenie_09.png) <br>
    ...
    a. Azure 포털의 **OpsGenie에서 Single Sign-on 구성** 대화 상자 페이지에서 **Single Sign-On 서비스 URL** 값을 복사한 다음 **SAML 2.0 끝점** 텍스트 상자에 붙여 넣습니다.
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-opsgenie-tutorial/create_aaduser_05.png) <br>
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-opsgenie-tutorial/create_aaduser_06.png) <br>
...
7. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다. <br><br> ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-opsgenie-tutorial/create_aaduser_07.png) <br>

8. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다. <br><br>![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-opsgenie-tutorial/create_aaduser_08.png) <br>
...
2.	왼쪽 패널에서 **사용자**를 클릭하여 사용자 목록으로 이동합니다. <br><br>![OpsGenie 설정](./media/active-directory-saas-opsgenie-tutorial/tutorial_opsgenie_10.png) <br>
