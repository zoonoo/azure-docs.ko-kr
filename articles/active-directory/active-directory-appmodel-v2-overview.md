...
또한 앱은 계정 중 하나를 사용하여 [Office 365 REST API 집합](https://msdn.microsoft.com/office/office365/howto/authenticate-Office-365-APIs-using-v2)을 사용할 수 있습니다. 현재, 이러한 API는 Outlook의 메일, 연락처 및 일정 API를 포함합니다. 추가 서비스는 나중에 추가됩니다.<!-- TODO: customer reference article --><!-- Several apps have already begun to bridge the gap between consumer and enterprise accounts, including: [Boomerang](), [TripIt](), & [Uber](). -->
