...
- [조건부 액세스 정책을 구성하는](conditional-access/app-based-mfa.md) 방법.

- [조건부 액세스 정책의 마이그레이션](conditional-access/best-practices.md#policy-migration).
...
조건부 액세스 정책을 구성하는 방법을 알아보려면 [Azure Active Directory 조건부 액세스를 사용하는 특정 앱에 MFA 요구](conditional-access/app-based-mfa.md)를 참조하세요.
