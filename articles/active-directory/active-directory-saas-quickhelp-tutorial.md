...
이 자습서에서는 QuickHelp와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. QuickHelp를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
5. **원하는 작업을 선택하세요.** 대화 상자에서 **갤러리에서 응용 프로그램 추가**를 클릭합니다.
    ...
    ![응용 프로그램][4]
6. 검색 상자에 **QuickHelp**를 입력합니다.
   
    ![응용 프로그램][5]
7. 결과 창에서 **QuickHelp**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션은 Azure 클래식 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 QuickHelp 응용 프로그램에서 Single Sign-On을 구성하는 방법을 설명하기 위한 것입니다.

**QuickHelp에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure 클래식 포털의 **QuickHelp** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
   
    ![Single Sign-On 구성][6]
2. **QuickHelp에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
   ...
   > [!NOTE]
   > 로그인 URL 값을 모를 경우 QuickHelp 지원에 문의합니다.
   > 
   > 
   
     b. **Next**를 클릭합니다.
4. **QuickHelp에서 Single Sign-On 구성** 페이지에서 다음을 수행합니다. **메타데이터 다운로드**를 클릭한 다음 메타데이터 파일을 컴퓨터에 로컬로 저장합니다.
   
    ![Azure AD Connect의 정의][9]
5. QuickHelp 회사 사이트에 관리자로 로그인합니다.
6. 위쪽의 메뉴에서 **관리자**를 클릭합니다.
   
    ![Single Sign-On 구성][21]
7. **QuickHelp 관리자** 메뉴에서 **설정**을 클릭합니다.
   
    ![Single Sign-On 구성][22]
8. **인증 설정**을 클릭합니다.
9. **인증 설정** 페이지에서 다음 단계를 수행합니다.
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-quickhelp-tutorial/create_aaduser_05.png)
...
6. **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다.
   ...
   ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-quickhelp-tutorial/create_aaduser_06.png)
...
![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-quickhelp-tutorial/create_aaduser_07.png)

1. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-quickhelp-tutorial/create_aaduser_08.png)
...
### Azure AD 테스트 사용자 할당
이 섹션은 Britta Simon에게 QuickHelp에 대한 액세스 권한을 부여하여 Azure Single Sign-On을 사용할 수 있도록 하기 위한 것입니다.
...
### Single Sign-On 테스트
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 QuickHelp 타일을 클릭하면 QuickHelp 응용 프로그램에 자동으로 로그온됩니다.
