...
이 자습서에서는 QuickHelp와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다.  
...
9. **인증 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    c. **전자 메일** 텍스트 상자에 **http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress**를 입력합니다.
