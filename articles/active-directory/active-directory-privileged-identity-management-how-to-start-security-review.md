...
![액세스 검토 시작 - 스크린 샷](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_start_review.png)

### <a name="configure-the-review"></a>검토 구성
액세스 검토를 만들려면 이름을 지정하고 시작 및 종료 날짜를 설정해야 합니다.

![검토 구성 - 스크린 샷](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_configure.png)
...
1. **역할 멤버 자격 검토**
    ...
    ![역할 멤버 자격 검토 - 스크린샷](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_role.png)
...
1. **검토자 선택**
    ...
    ![검토자 선택 - 스크린 샷](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_reviewers.png)
2. 옵션 중 하나를 선택하십시오.
