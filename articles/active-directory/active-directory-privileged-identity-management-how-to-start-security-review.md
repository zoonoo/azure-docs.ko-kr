...
## 액세스 검토 시작
> [!NOTE]
> Azure 포털의 대시보드에 PIM 응용 프로그램을 추가하지 않았으면 [Azure Privileged Identity Management 시작](active-directory-privileged-identity-management-getting-started.md)의 단계를 참조하세요.
> 
> 
