...
---
# <a name="tutorial-azure-active-directory-integration-with-kintone"></a>자습서: Kintone와 Azure Active Directory 통합
이 자습서는 Azure 및 Kintone의 통합을 보여주기 위한 것입니다.  
...
### <a name="to-enable-the-application-integration-for-kintone-perform-the-following-steps"></a>Kintone에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
Azure AD 사용자가 Kintone에 로그인할 수 있도록 하려면 Kintone로 프로비전되어야 합니다.  
...
### <a name="to-assign-users-to-kintone-perform-the-following-steps"></a>Kintone에 사용자를 할당하려면 다음 단계를 수행합니다.
