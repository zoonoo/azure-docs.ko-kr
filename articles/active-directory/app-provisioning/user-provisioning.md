---
title: Azure AD에서 자동 SaaS 앱 사용자 프로 비전
...
ms.locfileid: "82593117"
---
# <a name="automate-user-provisioning-and-deprovisioning-to-applications-with-azure-ad"></a>Azure AD를 사용 하 여 응용 프로그램에 대 한 사용자 프로 비전 및 프로 비전 해제 자동화
...
응용 프로그램에 사용자 및 그룹 프로 비전 및 프로 비전 해제를 자동화 하는 SCIM 끝점을 개발 하는 방법에 대 한 자세한 지침은 [scim 끝점 빌드 및 사용자 프로 비전 구성](use-scim-to-provision-users-and-groups.md)을 참조 하세요. 갤러리에서 사전 통합 된 응용 프로그램의 경우 (여유 시간, Azure Databricks, 눈송이 등) 개발자 설명서를 건너뛰고 [여기](../saas-apps/tutorial-list.md)에 제공 된 자습서를 사용할 수 있습니다.
