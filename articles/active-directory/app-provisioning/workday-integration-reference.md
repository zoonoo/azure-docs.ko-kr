...
| 7  | 회사                              | 예                 | 회사가                                                                     |
| 8  | 조합                        | 예                  | ' 사업부 \_ '                                                              |
| 9  | 비즈니스 단위 계층 구조              | 예                  | ' 사업부 \_ \_ 계층 구조 '                                                   |
| 10 | 회사 계층 구조                    | 예                  | ' 회사 \_ 계층 구조 '                                                          |
| 11 | Cost Center                          | 아니요                  | ' 비용 \_ 센터 '                                                                |
| 12 | 비용 센터 계층 구조                | 예                  | ' 비용 \_ 센터 \_ 계층 구조 '                                                     |
| 13 | 모금                                 | 예                  | 모금                                                                        |
| 14 | 기금 계층                       | 예                  | ' 펀드 \_ 계층 구조 '                                                             |
| 15 | 선물                                 | 예                  | 선물                                                                        |
| 16 | 선물 계층                       | 예                  | ' 선물 \_ 계층 구조 '                                                             |
| 17 | 허용                                | 예                  | 부여                                                                       |
| 18 | 계층 구조 부여                      | 예                  | ' 권한 부여 \_ 계층 구조 '                                                            |
| 19 | 비즈니스 사이트 계층 구조              | 예                  | ' 비즈니스 \_ 사이트 \_ 계층 구조 '                                                   |
| 20 | 행렬 조직                  | 예                  | 행렬                                                                      |
| 21 | 지불 그룹                            | 예                  | ' 지불 \_ 그룹 '                                                                  |
| 22 | 프로그램                             | 예                  | 프로그램인                                                                    |
| 23 | 프로그램 계층 구조                    | 예                  | ' 프로그램 \_ 계층 구조 '                                                          |
| 24 | 지역                               | 예                  | ' 지역 \_ 계층 구조 '                                                           |
| 25 | 위치 계층 구조                   | 예                  | ' 위치 \_ 계층 구조 '                                                         |
| 26 | 계정 프로 비전 데이터            | 예                  | wd: Worker \_ data/wd: 계정 \_ 프로 비전 \_ 데이터                                |
| 27 | 백그라운드 확인 데이터                | 예                  | wd: Worker \_ data/wd: Background \_ Check \_ 데이터                                    |
| 28 | 혜택 자격 데이터             | 예                  | wd: Worker \_ data/wd: 혜택 \_ 자격 \_ 데이터                                 |
| 29 | 혜택 등록 데이터              | 예                  | wd: Worker \_ data/wd: 혜택 \_ 등록 \_ 데이터                                  |
| 30 | 커리어 데이터                          | 예                  | wd: Worker \_ 데이터/wd: 커리어 \_ 데이터                                               |
| 31 | 보정 데이터                    | 예                  | wd: Worker \_ data/wd: 보정 \_ 데이터                                         |
| 32 | 불확정 작업자 세금 기관 데이터 | 예                  | wd: Worker \_ Data/wd: 불확정 \_ 작업자 \_ 세금 \_ 기관 \_ 양식 \_ 형식 \_ 데이터       |
| 33 | 개발 항목 데이터                | 예                  | wd: Worker \_ data/wd: 개발 \_ 항목 \_ 데이터                                    |
| 34 | 직원 계약 데이터              | 예                  | wd: Worker \_ data/wd: Employee \_ 계약 \_ 데이터                                  |
| 35 | 직원 검토 데이터                 | 예                  | wd: Worker \_ 데이터/wd: 직원 \_ 검토 \_ 데이터                                     |
| 36 | 사용자 의견 수신 데이터               | 예                  | wd: Worker \_ data/wd: 피드백 \_ 수신 \_ 데이터                                   |
| 37 | 작업자 목표 데이터                     | 예                  | wd: Worker \_ data/wd: worker \_ 목표 \_ 데이터                                         |
| 38 | 사진 데이터                           | 예                  | wd: Worker \_ 데이터/wd: 사진 \_ 데이터                                                |
| 39 | 자격 데이터                   | 예                  | wd: Worker \_ data/wd: 자격 \_ 데이터                                        |
| 40 | 관련 된 사람 데이터                 | 예                  | wd: Worker \_ data/wd: 관련 된 \_ 사람 \_ 데이터                                     |
| 41 | 역할 데이터                            | 예                  | wd: Worker \_ 데이터/wd: 역할 \_ 데이터                                                 |
| 42 | 기술 데이터                           | 예                  | wd: Worker \_ data/wd: 기술 \_ 데이터                                                |
| 43 | 연속 프로필 데이터              | 예                  | wd: Worker \_ data/wd: 연속 \_ 프로필 \_ 데이터                                  |
| 44 | 인재 평가 데이터               | 예                  | wd: Worker \_ data/wd: 인재 \_ 평가 \_ 데이터                                   |
| 45 | 사용자 계정 데이터                    | 예                  | wd: Worker \_ data/wd: 사용자 \_ 계정 \_ 데이터                                        |
| 46 | 작업자 문서 데이터                 | 예                  | wd: Worker \_ data/wd: worker \_ 문서 \_ 데이터                                     |
...
기본적으로 Workday 커넥터는 작업자의 기본 작업에 연결 된 특성을 검색 합니다. 또한 커넥터는 국제 작업 할당 또는 보조 작업과 관련 된 *추가 작업 데이터* 검색을 지원 합니다. 

다음 단계를 사용 하 여 국가별 작업 할당과 관련 된 특성을 검색 합니다. 

1. Workday 연결 URL이 Workday 웹 서비스 API 버전 30.0 이상을 사용 하도록 설정 합니다. 따라서 Workday 프로비저닝 앱에서 [올바른 XPATH 값](workday-attribute-reference.md#xpath-values-for-workday-web-services-wws-api-v30) 을 설정 합니다. 
1. 노드의 선택기를 사용 `@wd:Primary_Job=0` `Worker_Job_Data` 하 여 올바른 특성을 검색 합니다. 
   * **예 1:** XPATH를 `SecondaryBusinessTitle` 사용 하려면 `wd:Worker/wd:Worker_Data/wd:Employment_Data/wd:Worker_Job_Data[@wd:Primary_Job=0]/wd:Position_Data/wd:Business_Title/text()`
   * **예 2:** XPATH를 `SecondaryBusinessLocation` 사용 하려면 `wd:Worker/wd:Worker_Data/wd:Employment_Data/wd:Worker_Job_Data[@wd:Primary_Job=0]/wd:Position_Data/wd:Business_Site_Summary_Data/wd:Location_Reference/@wd:Descriptor`
