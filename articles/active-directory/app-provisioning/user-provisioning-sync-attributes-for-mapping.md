---
title: 매핑을 위해 Azure AD에 특성 동기화 | Microsoft Docs
...
6. Azure Portal에서 [사용자 특성 매핑을 편집](customize-application-attributes.md)하는 동안 **원본 특성** 목록에는 `<attributename> (extension_<appID>_<attributename>)`형식으로 추가 된 특성이 포함 됩니다. 특성을 선택 하 고 프로 비전을 위한 대상 응용 프로그램에 매핑합니다.
