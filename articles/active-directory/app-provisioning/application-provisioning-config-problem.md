...
- **특성 값에 따라 사용자를 필터링 하**는 **범위 지정 필터가 구성** 되었습니다. 자세한 내용은 [범위 지정 필터를 사용한 특성 기반 응용 프로그램 프로 비전](../app-provisioning/define-conditional-rules-for-provisioning-user-accounts.md)을 참조 하세요.
