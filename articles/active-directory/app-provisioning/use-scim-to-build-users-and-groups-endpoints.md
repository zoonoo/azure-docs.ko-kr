...
끝점은 `{host}/scim/` 디렉터리에 있으며 표준 HTTP 요청을 사용 하 여 상호 작용할 수 있습니다. 경로를 수정 하려면 `/scim/` **AzureADProvisioningSCIMreference** scimreferenceapi 컨트롤러의 *controllerconstant .cs* 를 참조 하세요  >    >  .
