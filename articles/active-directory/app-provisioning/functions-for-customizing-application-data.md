...
* 서로 함수를 중첩할 수 있습니다. 예: <br> *FunctionOne (Functionone ( `<<argument1>>` ))*
...
| **접미어** |필수 |String |원본 값의 끝에 추가하려는 문자열입니다. |
...
| --- | --- | --- | --- |
| **source** |필수 |String |대개는 원본 개체의 특성 이름입니다. |
| **inputFormat** |필수 |String |원본 값의 예상된 형식입니다. 지원 되는 형식에 대해서는을 참조 [https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx](https://msdn.microsoft.com/library/8kb3ddd4%28v=vs.110%29.aspx) 하세요. |
