<properties
	pageTitle="자습서: Evidence.com과 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: Evidence.com과 Azure Active Directory 통합
...
4.	응용 프로그램 갤러리를 열려면 앱 **추가**를 클릭한 다음 **갤러리에서 응용 프로그램 추가**를 클릭합니다.
...
3.	앱 URL 구성 화면에서 사용자가 Evidence.com 테넌트 URL(Example: https://yourtenant.evidence.com에 로그인하려는 URL을 입력하고 **다음**을 클릭합니다.
...
6.	**Agency Single Sign On**을 클릭합니다.
 
7.	**SAML 기반 Single Sign On**을 선택합니다.
