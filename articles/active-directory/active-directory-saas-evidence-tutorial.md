...
# <a name="tutorial:-azure-active-directory-integration-with-evidence.com"></a>자습서: Evidence.com과 Azure Active Directory 통합
...
## <a name="add-evidence.com-to-your-directory"></a>디렉터리에 Evidence.com 추가
...
## <a name="creating-an-evidence.com-test-user"></a>Evidence.com 테스트 사용자 만들기
...
## <a name="assigning-users-to-evidence.com"></a>Evidence.com에 사용자 할당
