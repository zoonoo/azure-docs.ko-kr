<properties
	pageTitle="자습서: SAP NetWeaver와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: SAP NetWeaver와 Azure Active Directory 통합
...
이 연결 관계는 Azure AD의 **사용자 이름** 값을 SAP NetWeaver의 **Username** 값으로 할당하여 설정합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    a. **로그인 URL** 텍스트 상자에 다음 패턴 **https://\<your company instance of SAP NetWeaver>**를 사용하여 사용자가 SAP NetWeaver 응용 프로그램에 로그인하는 데 사용할 URL을 입력합니다.
	
	b. **식별자** 텍스트 상자에 다음 패턴 **https://\<SAP NetWeaver의 회사 인스턴스>**를 사용하여 URL을 입력합니다.

	c. **회신 URL** 텍스트 상자에 다음 패턴 **https://\<SAP NetWeaver의 회사 인스턴스>/sap/saml2/sp/acs/100**을 사용하여 URL을 입력합니다.

	> [AZURE.NOTE] SAP NetWeaver 파트너가 제공하는 페더레이션 메타데이터 문서에서 이러한 모든 값을 찾을 수 있습니다.
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다. ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sap-netweaver-tutorial/create_aaduser_05.png)
...
6.  **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다. ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-sap-netweaver-tutorial/create_aaduser_06.png)
