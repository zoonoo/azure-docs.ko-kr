...
3. **SAP NetWeaver 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **식별자** 텍스트 상자에서 `https://<your company instance of SAP NetWeaver>` 패턴을 사용하여 URL을 입력합니다.

    다. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<your company instance of SAP NetWeaver>/sap/saml2/sp/acs/100`
