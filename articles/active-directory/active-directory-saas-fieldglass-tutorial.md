...
7. **Fieldglass** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)** 및 **로그아웃 URL, SAML 엔터티 ID**를 [Fieldglass 지원 팀](http://www.fieldglass.com/solutions/support)에 보내야 합니다. 그러면 SAML SSO 연결이 양쪽에 제대로 설정되도록 지정합니다.
