---
title: "Azure Active Directory B2B 공동 작업 미리 보기에 대한 외부 사용자 개체 특성 변경 | Microsoft Docs"
...
---
# <a name="azure-ad-b2b-collaboration-preview-external-user-object-attribute-changes"></a>Azure AD B2B 공동 작업 미리 보기: 외부 사용자 개체 특성 변경
...
* **DisplayName** 특성은 사용자 계정 이름((user_fabrikam.com#EXT#@contoso.com))에서 로그인 이름((user@fabrikam.com))으로 변경됩니다.
