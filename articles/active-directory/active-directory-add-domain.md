<properties
	pageTitle="Azure Active Directory에 고유한 도메인 이름 추가 | Microsoft Azure"
...
Microsoft 클라우드 서비스에 등록하면 contoso.onmicrosoft.com과 같은 형식의 도메인 이름이 제공됩니다. 해당 초기 도메인 이름을 계속 사용하거나 고유한 사용자 지정 도메인 이름을 클라우드 서비스에 추가할 수 있습니다. 이 항목에서는 고유한 도메인 이름 및 Azure Active Directory(Azure AD) 관련 정보를 추가하는 방법에 대해 설명합니다.
...
다음 중 하나를 사용하여 Azure AD 디렉터리에 최대 900개의 도메인 이름을 추가할 수 있습니다.

- Azure 클래식 포털, Office 365 포털 또는 Microsoft Intune 포털
- Windows PowerShell용 Azure Active Directory 모듈. 이 모듈에 사용할 수 있는 cmdlet에 대한 자세한 내용은 [Azure AD에서 메인 관리](https://msdn.microsoft.com/library/azure/dn919677.aspx)를 참조하세요.
...
### Azure 클래식 포털을 사용하여 도메인 추가 및 확인

1. Azure 클래식 포털에서 **Active Directory**를 클릭한 다음 조직의 디렉터리 이름을 클릭합니다. 다음 중 하나를 수행할 수 있습니다.
...
1. Azure 클래식 포털의 왼쪽 창에서 **도메인**을 클릭합니다.
...
Azure 클래식 포털을 사용하는 경우:

1. Azure 클래식 포털에서 **Active Directory**를 클릭한 다음 디렉터리 이름을 클릭한 다음 **도메인**을 클릭합니다.
...
1. Azure 클래식 포털의 Azure Active Directory에서 **도메인**으로 이동합니다.
...
1. Azure 클래식 포털의 왼쪽 위 모서리에서 조직 이름을 클릭합니다.
2. **편집**을 클릭합니다.
...
1. Azure 클래식 포털에 있는 Azure AD의 왼쪽 창에서 **도메인**을 클릭합니다.
...
문제를 추적하는 한 가지 방법은 도메인 문제 해결 마법사를 사용하는 것입니다. 마법사를 시작하려면 Azure 클래식 포털의 관리 페이지에서 **도메인**을 클릭하고 확인하려는 도메인 이름을 두 번 클릭합니다. 그런 다음 **문제 해결**에서 **도메인 문제 해결**을 클릭합니다.
