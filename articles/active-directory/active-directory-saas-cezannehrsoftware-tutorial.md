...
7. 결과 창에서 **Cezanne HR 소프트웨어**를 선택한 다음 **완료**를 클릭하여 응용 프로그램을 추가합니다.
...
1. 클래식 포털의 **Cezanne HR Software** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
    ...
    ![Single Sign-on 구성][6] 
2. **Cezanne HR Software에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택한 후 **다음**을 클릭합니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행하고 **다음**을 클릭합니다.
    ...
    a. **로그온 URL** 텍스트 상자에서 `https://w3.cezanneondemand.com/cezannehr/-/<tenant id>` 패턴을 사용하여 URL을 입력합니다.
   
    b. **회신 URL** 텍스트 상자에 `https://w3.cezanneondemand.com:443/CezanneOnDemand/-/<tenant id>/Saml/samlp` 패턴으로 URL을 입력합니다.
   
    c.  **다음**
   
   > [!NOTE]
   > 이러한 값은 실제 로그온 URL 및 회신 URL로 업데이트해야 합니다. 이러한 값을 가져오려면 Cezanne HR Software 지원 팀에 <mailto:info@cezannehr.com>을 통해 문의합니다.
   > 
   > 
...
7. **다음 SSO(Single Sign-On) Service를 사용한 사용자 로그온 허용** 패널에서 **SAML 2.0** 상자를 선택하고 그 옆에 있는 **고급 구성** 옵션을 선택합니다.
...
9. **SAML 2.0 ID 공급자** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **엔터티 식별자** 텍스트 상자에서 Azure AD 응용 프로그램 구성 마법사에서 나온 **엔터티 ID** 값을 입력합니다.
   
    c. **SAML 바인딩** 을 'POST'로 변경합니다.
   
    d. **Security Token Service 끝점** 텍스트 상자에서 Azure AD 응용 프로그램 구성 마법사에 나온**Single Sign-On Service URL** 값을 입력합니다.
...
2. 왼쪽 탐색 창에서 **시스템 설정**을 클릭합니다. **사용자 관리**로 이동합니다. 그런 다음 **새 사용자 추가**로 이동합니다.
   ...
   ![새 사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_005.png "New User")
3. **사람 세부 정보** 섹션에서 다음 단계를 수행합니다.
   
   ![새 사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_006.png "New User")
...
4. **계정 정보** 섹션에서 다음 단계를 수행합니다.
   ...
   ![새 사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_007.png "New User")
...
5. **Single Sign-On** 탭으로 이동하고 **SAML 2.0 식별자** 영역에서 **새로 추가**를 선택합니다.
    ...
    ![사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_008.png "User")
6. **ID 공급자**에 대해 사용자의 ID 공급자를 선택하고 **사용자 식별자** 텍스트 상자에서 Britta Simon 계정의 전자 메일 주소를 입력합니다.
   
    ![사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_009.png "User")
7. **저장** 단추를 클릭합니다.
   
    ![사용자](./media/active-directory-saas-cezannehrsoftware-tutorial/tutorial_cezannehrsoftware_010.png "User")
