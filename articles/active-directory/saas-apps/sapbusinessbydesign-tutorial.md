...
1. 검색 상자에 **SAP Business ByDesign**을 입력하고 결과 패널에서 **SAP Business ByDesign**을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 SAP Business ByDesign](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_addfromgallery.png)
...
1. **[SAP Business ByDesign 테스트 사용자 만들기](#create-an-sap-business-bydesign-test-user)** - Azure AD를 대표하여 SAP Business ByDesign에서 Britta Simon에 해당하는 사용자가 있어야 합니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 SAP Business ByDesign 애플리케이션에서 Single Sign-On을 구성합니다.

**SAP Business ByDesign에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **SAP Business ByDesign** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_samlbase.png)

1. **SAP Business ByDesign 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![SAP Business ByDesign 도메인 및 URL Single Sign-On 정보](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_url.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<servername>.sapbydesign.com`

    나. **식별자** 텍스트 상자에서 `https://<servername>.sapbydesign.com` 패턴을 사용하여 URL을 입력합니다.
...
1. **사용자 특성** 섹션에서 다음 단계를 수행합니다.

    ![SAP Business ByDesign 특성 섹션](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_attribute.png)
    
    a. **사용자 ID** 목록에서 **ExtractMailPrefix()** 함수를 선택합니다.
    
    나. **메일** 목록에서 구현에 사용할 사용자 특성을 선택합니다. 예를 들어, EmployeeID를 고유한 사용자 식별자로 사용하고자 하고 ExtensionAttribute2에 특성 값을 저장했다면 user.extensionattribute2를 선택합니다.     

1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.

    ![인증서 다운로드 링크](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/sapbusinessbydesign-tutorial/tutorial_general_400.png)

1. **SAP Business ByDesign 구성** 섹션에서 **SAP Business ByDesign 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![SAP Business ByDesign 구성](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_configure.png) 

1. 애플리케이션에 SSO를 구성하려면 다음 단계를 수행합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/sapbusinessbydesign-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/sapbusinessbydesign-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/sapbusinessbydesign-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/sapbusinessbydesign-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **SAP Business ByDesign**을 선택합니다.
    ...
    ![애플리케이션 목록의 SAP Business ByDesign 연결](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_app.png)  
...
액세스 패널에서 SAP Business ByDesign 타일을 클릭하면 SAP Business ByDesign 애플리케이션에 자동으로 로그온됩니다.
