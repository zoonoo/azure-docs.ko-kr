...
1. 검색 상자에 **SAP Business ByDesign**을 입력하고 결과 패널에서 **SAP Business ByDesign**을 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. 응용 프로그램에 SSO를 구성하려면 다음 단계를 수행합니다.
...
1. 응용 프로그램 목록에서 **SAP Business ByDesign**을 선택합니다.

    ![응용 프로그램 목록의 SAP Business ByDesign 연결](./media/sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_app.png)  
