...
4. 검색 상자에 **Netsuite**를 입력합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/netsuite-tutorial/tutorial_netsuite_search.png)

5. 결과 패널에서 **Netsuite**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/netsuite-tutorial/tutorial_netsuite_addfromgallery.png)
