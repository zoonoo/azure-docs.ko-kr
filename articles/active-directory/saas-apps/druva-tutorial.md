...
* Druva Single Sign-On을 사용하도록 설정된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Druva에서 **SP** 및 **IDP** 시작 SSO를 지원합니다.
...
4. 검색 상자에 **Druva**를 입력하고 결과 패널에서 **Druva**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Druva의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Druva에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Druva Single Sign-On 구성](#configure-druva-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Druva** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Druva 도메인 및 URL Single Sign-On 정보](common/idp-identifier.png)

    **식별자** 텍스트 상자에서 `druva-cloud` 문자열 값을 입력합니다.

5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.

    ![이미지](common/both-preintegrated-signon.png)

    **로그온 URL** 텍스트 상자에 `https://cloud.druva.com/home` URL을 입력합니다.

6. Druva 애플리케이션에는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성** 대화 상자를 엽니다.
...
9. **Druva 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-druva-single-sign-on"></a>Druva Single Sign-On 구성
...
3. Single Sign-On 설정 대화 상자에서 다음 단계를 수행합니다.
...
4. **설정** 페이지에서 **SSO 토큰 생성**을 클릭합니다.

    ![설정](./media/druva-tutorial/ic795093.png "설정")

5. **Single Sign-On 인증 토큰** 대화 상자에서 다음 단계를 수행합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Druva**를 차례로 선택합니다.
