...
* Azure AD에서 Autotask Workplace에 대한 액세스 권한이 있는 사용자를 제어할 수 있습니다.
* 사용자가 자신의 Azure AD 계정으로 Autotask Workplace에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
* Autotask Workplace Single Sign-On을 사용하도록 설정된 구독
...
Single Sign-On이 작동하려면, Azure AD 사용자와 Autotask Workplace의 관련 사용자 간에 연결 관계가 설정되어야 합니다.

Autotask Workplace에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Autotask Workplace Single Sign-On 구성](#configure-autotask-workplace-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Autotask Workplace 테스트 사용자 만들기](#create-autotask-workplace-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Autotask Workplace에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Autotask Workplace** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Autotask Workplace 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.
    ...
    ![Autotask Workplace 도메인 및 URL Single Sign-On 정보](common/metadata-upload-additional-signon.png)
...
### <a name="configure-autotask-workplace-single-sign-on"></a>Autotask Workplace Single Sign-On 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**을 선택한 다음, **모든 애플리케이션**을 선택하고 **Autotask Workplace**를 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Autotask Workplace**를 선택합니다.

    ![애플리케이션 목록에서 Autotask Workplace 연결](common/all-applications.png)
...
액세스 패널에서 Autotask Workplace 타일을 클릭하면 SSO를 설정한 Autotask Workplace에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
