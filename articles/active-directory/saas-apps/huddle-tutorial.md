...
5. **IDP** 시작 모드에서 응용 프로그램을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Huddle 도메인 및 URL Single Sign-On 정보](./media/huddle-tutorial/tutorial_huddle_url.png)
    ...
    ![Huddle 도메인 및 URL Single Sign-On 정보](./media/huddle-tutorial/tutorial_huddle_url1.png)

    **로그온 URL** 텍스트 상자에서 다음 패턴을 사용하여 URL 중 하나를 입력합니다.
...
8. **Huddle** 쪽에서 Single Sign-On을 구성하려면 다운로드한 인증서와 **Huddle** **설정** 섹션에서 복사한 URL을 Azure Portal에서 [Huddle 클라이언트 지원 팀](https://huddle.zendesk.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
