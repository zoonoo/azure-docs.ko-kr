...
## <a name="configure-and-test-azure-ad-single-sign-on-for-8x8"></a>8x8에 대한 Azure AD Single Sign-On 구성 및 테스트
...
1. 8x8 [Configuration Manager](https://vo-cm.8x8.com/)에 로그인합니다.
