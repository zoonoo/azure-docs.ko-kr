...
4. 검색 상자에 **8x8 Virtual Office**를 입력하고, 결과 패널에서 **8x8 Virtual Office**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
액세스 패널에서 8x8 Virtual Office 타일을 클릭하면 8x8 Virtual Office 애플리케이션에 자동으로 로그인됩니다.
