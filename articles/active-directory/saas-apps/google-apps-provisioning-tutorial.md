...
1. 이미 G Suite에 Single Sign-On을 구성한 경우 검색 필드를 사용하여 G Suite의 인스턴스를 검색합니다. 그렇지 않은 경우 **추가**를 선택하고 애플리케이션 갤러리에서 **G Suite** 또는 **Google Apps**를 검색합니다. 검색 결과에서 앱을 선택하고 애플리케이션 목록에 추가합니다.
