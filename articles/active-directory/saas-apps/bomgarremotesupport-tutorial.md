...
BeyondTrust Remote Support에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **BeyondTrust Remote Support** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On**을 선택합니다.
...
1. 드롭다운 메뉴에서 **SAML**을 선택하고 **공급자 만들기** 단추를 클릭합니다.
...
액세스 패널에서 BeyondTrust Remote Support 타일을 클릭하면 SSO를 설정한 BeyondTrust Remote Support에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD에서 BeyondTrust Remote Support 사용해보기](https://aad.portal.azure.com/)
