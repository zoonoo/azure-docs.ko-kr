...
1. 검색 상자에서 **Expensify**를 입력하고, 결과 패널에서 **Expensify**를 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 Expensify](./media/expensify-tutorial/tutorial_expensify_addfromgallery.png)
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/expensify-tutorial/tutorial_expensify_samlbase.png)

1. **Expensify 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Expensify 도메인 및 URL Single Sign-On 정보](./media/expensify-tutorial/tutorial_expensify_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/expensify-tutorial/tutorial_expensify_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/expensify-tutorial/tutorial_general_400.png)

1. Expensify에서 SSO를 사용하도록 설정하려면 먼저 응용 프로그램에서 **도메인 컨트롤**을 사용하도록 설정해야 합니다. [여기에](http://help.expensify.com/domain-control) 나열된 단계를 수행하여 응용 프로그램에서 도메인 컨트롤을 사용하도록 설정할 수 있습니다. 추가 지원은 [Expensify 클라이언트 지원 팀](mailto:help@expensify.com)에 문의하세요. 도메인 컨트롤을 사용하도록 설정한 후에는 다음 단계를 따릅니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/expensify-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/expensify-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/expensify-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/expensify-tutorial/create_aaduser_04.png)
...
1. 응용 프로그램 목록에서 **Expensify**를 선택합니다.

    ![응용 프로그램 목록의 Expensify 링크](./media/expensify-tutorial/tutorial_expensify_app.png)  
