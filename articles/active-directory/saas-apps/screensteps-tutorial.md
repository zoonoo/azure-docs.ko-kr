...
1. 검색 상자에 **ScreenSteps**를 입력하고 결과 패널에서 **ScreenSteps**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **Single Sign-on 끝점 만들기**를 클릭합니다.

    ![원격 인증](./media/screensteps-tutorial/ic778525.png "원격 인증")

1. **Single Sign-on 끝점 만들기** 섹션에서 다음 단계를 수행합니다.
...
1. **Single Sign-on 끝점 편집** 섹션에서 다음 단계를 수행합니다.
...
1. 응용 프로그램 목록에서 **ScreenSteps**를 선택합니다.
