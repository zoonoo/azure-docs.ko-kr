...
1. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **Cisco Cloud 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<subdomain>.cisco.com/sp/ACS.saml2`
