...
1. **[Mindflash 테스트 사용자 만들기](#creating-a-mindflash-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Mindflash에 만듭니다.
...
1. **Mindflash 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Mindflash** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Mindflash 지원 팀](https://www.mindflash.com/contact/)에 보내야 합니다.
