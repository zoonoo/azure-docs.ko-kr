...
* 사용자가 자신의 Azure AD 계정으로 Appraisd에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
4. 검색 상자에 **Appraisd**를 입력하고 결과 패널에서 **Appraisd**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
     ...
     ![결과 목록의 Appraisd](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 Appraisd에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Appraisd의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Appraisd에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Appraisd Single Sign-On 구성](#configure-appraisd-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Appraisd 테스트 사용자 만들기](#create-appraisd-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Appraisd에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Appraisd** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Appraisd 도메인 및 URL Single Sign-On 정보](common/both-preintegrated-advanced-urls.png)
...
5. Appraisd 응용 프로그램은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성** 대화 상자를 엽니다.
...
### <a name="configure-appraisd-single-sign-on"></a>Appraisd Single Sign-On 구성

1. 다른 웹 브라우저 창에서 Appraisd에 보안 관리자로 로그인합니다.

2. 페이지의 오른쪽 위에 있는 **설정** 아이콘을 클릭한 다음,  **구성**으로 이동합니다.

    ![이미지](./media/appraisd-tutorial/tutorial_appraisd_sett.png)

3. 메뉴 왼쪽에서 **SAML Single Sign-On**을 클릭합니다.

    ![이미지](./media/appraisd-tutorial/tutorial_appraisd_single.png)

4. **SAML 2.0 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
...
5. **사용자 식별** 아래 동일한 페이지를 아래로 스크롤하여 다음 단계를 수행합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Appraisd**를 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Appraisd**를 선택합니다.

    ![애플리케이션 목록의 Appraisd 링크](common/all-applications.png)
...
액세스 패널에서 Appraisd 타일을 클릭하면 SSO를 설정한 Appraisd에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
