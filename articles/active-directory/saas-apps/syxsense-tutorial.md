...
* Syxsense를 구성한 후에는 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
...
1. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**를 클릭하고 다음 단계를 수행합니다.
    ...
    **로그인 URL** 텍스트 상자에서 `https://<SUBDOMAIN>.cloudmanagementsuite.com/samlautologin` 패턴을 사용하여 URL을 입력합니다.
...
1. **설정 아이콘**을 클릭합니다.
    ...
    ![Syxsense 구성](./media/syxsense-tutorial/configure1.png)

1. **외부 인증**을 클릭하고 **앱 페더레이션 메타데이터 Url** 값을 **SAML 2.0 메타데이터** 텍스트 상자에 제공하고 **저장**을 클릭합니다.

    ![Syxsense 구성](./media/syxsense-tutorial/configure2.png)
...
1. 왼쪽 탐색 패널에서 **사용자 계정**을 클릭합니다.
    ...
    ![Syxsense 구성](./media/syxsense-tutorial/user1.png)

1. **추가**를 클릭합니다.

    ![Syxsense 구성](./media/syxsense-tutorial/user2.png)

1. 조직 요구 사항에 따라 사용자 세부 정보를 제공하고 **저장**을 클릭합니다.

    ![Syxsense 구성](./media/syxsense-tutorial/user3.png)

## <a name="test-sso"></a>SSO 테스트

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Syxsense 타일을 클릭하면, SSO를 설정한 Syxsense에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [고급 표시 유형 및 컨트롤을 사용하여 Syxsense를 보호하는 방법](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)