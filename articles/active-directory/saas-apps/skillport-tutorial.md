...
3. 대화 상자 맨 위에서 **새 응용 프로그램** 단추를 클릭합니다.

    ![응용 프로그램][3]

4. 검색 상자에 **Skillport**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/skillport-tutorial/tutorial_skillport_search.png)

5. 결과 창에서 **Skillport**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Skillport 테스트 사용자 만들기](#creating-a-skillport-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Skillport에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Skillport 응용 프로그램에서 Single Sign-On을 구성합니다.

**Skillport에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Skillport** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Skillport 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Skillport** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Skillport 지원 팀](https://www.skillsoft.com/contact.asp)에 보내야 합니다. 그러면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
2. 응용 프로그램 목록에서 **Skillport**를 선택합니다.
...
액세스 패널에서 Skillport 타일을 클릭하면 Skillport 응용 프로그램에 자동으로 로그온됩니다.
