...
ms.locfileid: "36222668"
---
# <a name="tutorial-azure-active-directory-integration-with-23-video"></a>자습서: 23 Video와 Azure Active Directory 통합

이 자습서에서는 Azure AD(Azure Active Directory)와 23 Video를 통합하는 방법에 대해 알아봅니다.

23 Video를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
4. 검색 상자에 **23 Video**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/tutorial_23video_search.png)

5. 결과 창에서 **23 Video**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/tutorial_23video_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Azure AD Single Sign-on 구성 및 테스트
이 섹션에서는 "Britta Simon"이라는 테스트 사용자를 기반으로 23 Video에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 23 Video 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 23 Video의 관련 사용자 간에 연결이 형성되어야 합니다.

23 Video에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.

23 Video에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Configuring Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
3. **[23 Video 테스트 사용자 만들기](#creating-a-23-video-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 23 Video에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 23 Video 응용 프로그램에서 Single Sign-On을 구성합니다.

**23 Video에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **23 Video** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **23 Video 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Configure Single Sign-On](./media/23video-tutorial/tutorial_23video_url.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<subdomain>.23video.com`

    나. **식별자** 텍스트 상자에서 `https://www.23video.com/saml/trust/<uniqueid>` 패턴을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 로그온 URL 및 식별자로 값을 업데이트합니다. 이러한 값을 얻으려면 [23 Video 클라이언트 지원 팀](mailto:support@23company.com)에 문의하세요. 
...
6. **23 Video 구성** 섹션에서 **23 Video 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/create_aaduser_01.png) 

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/create_aaduser_02.png) 

3. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/create_aaduser_03.png) 

4. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/23video-tutorial/create_aaduser_04.png) 
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 Britta Simon에게 23 Video에 대한 액세스 권한을 부여합니다.
...
2. 응용 프로그램 목록에서 **23 Video**를 선택합니다.
...
액세스 패널에서 23 Video 타일을 클릭하면 23 Video 응용 프로그램에 자동으로 로그온됩니다. 
