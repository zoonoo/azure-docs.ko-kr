...
3. **23 Video 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://www.23video.com/saml/trust/<uniqueid>` 패턴을 사용하여 URL을 입력합니다.
...
액세스 패널에서 23 Video 타일을 클릭하면 23 Video 애플리케이션에 자동으로 로그온됩니다. 
