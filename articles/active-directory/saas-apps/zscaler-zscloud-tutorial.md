...
1. 검색 상자에 **Zscaler ZSCloud**를 입력합니다.
...
1. **[프록시 설정 구성](#configuring-proxy-settings)** - Internet Explorer에서 프록시 설정을 구성하려면
1. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
1. **[Zscaler ZSCloud 테스트 사용자 만들기](#creating-a-zscaler-zscloud-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Zscaler ZSCloud에 만듭니다.
...
1. **Zscaler ZSCloud 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Zscaler ZSCloud 구성** 섹션에서 **Zscaler ZSCloud 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/zscaler-zscloud-tutorial/tutorial_zscalerzscloud_configure.png) 

1. 다른 웹 브라우저 창에서 ZScaler ZSCloud 회사 사이트에 관리자로 로그인합니다.
...
1. **관리자 & 역할 관리**에서 **사용자 및 인증 관리**를 클릭합니다.   
    ...
    ![사용자 및 인증 관리](./media/zscaler-zscloud-tutorial/ic800207.png "사용자 및 인증 관리")

1. **구성에 대한 인증 옵션 선택** 섹션에서, 다음 단계를 수행합니다.   
                
    ![인증](./media/zscaler-zscloud-tutorial/ic800208.png "인증")
...
1. **사용자 인증 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![관리](./media/zscaler-zscloud-tutorial/ic800210.png "관리")
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/zscaler-zscloud-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/zscaler-zscloud-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/zscaler-zscloud-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/zscaler-zscloud-tutorial/create_aaduser_04.png) 
...
1. **관리**를 클릭합니다.   
    ...
    ![관리](./media/zscaler-zscloud-tutorial/ic781035.png "관리")

1. **사용자 관리**를 클릭합니다.   
        
     ![추가](./media/zscaler-zscloud-tutorial/ic781037.png "추가")
...
1. 사용자 추가 섹션에서 다음 단계를 수행합니다.
    ...
    ![사용자 추가](./media/zscaler-zscloud-tutorial/ic781038.png "사용자 추가")
