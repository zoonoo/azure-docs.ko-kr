...
1. 검색 상자에 **Communifire**를 입력하고 결과 패널에서 **Communifire**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Communifire 애플리케이션에서 Single Sign-On을 구성합니다.

**Communifire에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Communifire** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
1. **Communifire 도메인 및 URL** 섹션에서 IDP 시작 모드로 애플리케이션을 구성하려는 경우 다음 단계를 수행합니다.
...
>[!Note]
>사용자를 수동으로 만들어야 하는 경우  [Communifire 지원 팀](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome)에 문의하세요.
...
1. 애플리케이션 목록에서 **Communifire**를 선택합니다.
    ...
    ![애플리케이션 목록의 Communifire 링크](./media/communifire-tutorial/tutorial_communifire_app.png)  
...
액세스 패널에서 Communifire 타일을 클릭하면 Communifire 애플리케이션에 자동으로 로그온됩니다.
