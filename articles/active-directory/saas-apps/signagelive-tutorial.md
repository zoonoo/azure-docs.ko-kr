...
* Signagelive Single Sign-On이 설정된 구독
...
## <a name="adding-signagelive-from-the-gallery"></a>갤러리에서 Signagelive 추가
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Signagelive의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Signagelive에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.
...
5. **[Signagelive 테스트 사용자 만들기](#create-signagelive-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Signagelive에 만듭니다.
...
6. **Signagelive 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
**Signagelive** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(원시)** 및 Azure Portal에서 복사한 적절한 URL을 [Signagelive 지원 팀](mailto:support@signagelive.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**을 선택한 다음, **Signagelive**을 선택합니다.
...
이 섹션에서는 Signagelive에서 Britta Simon이라는 사용자를 만듭니다. Signagelive 플랫폼에서 사용자를 추가하려면  [Signagelive 지원 팀](mailto:support@signagelive.com)에 문의하세요. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

### <a name="test-single-sign-on"></a>Single Sign-On 테스트 

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Signagelive 타일을 클릭하면, SSO를 설정한 Signagelive에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
