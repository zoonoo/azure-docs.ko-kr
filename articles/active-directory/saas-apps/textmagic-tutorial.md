...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 TextMagic 애플리케이션에서 Single Sign-On을 구성합니다.

**TextMagic에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **TextMagic** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
5. TextMagic 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성 및 클레임** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성 및 클레임** 대화 상자를 엽니다.
...
액세스 패널에서 TextMagic 타일을 클릭하면 TextMagic 애플리케이션에 자동으로 로그온됩니다.
