...
## <a name="configure-and-test-azure-ad-single-sign-on-for-textmagic"></a>TextMagic용 Azure AD Single Sign-On 구성 및 테스트
...
TextMagic에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **TextMagic** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On** 을 선택합니다.
...
4. 사용자 이름에서 **계정 설정** 을 선택합니다.
    ...
    ![스크린샷은 사용자에서 선택한 계정 설정을 보여줍니다.](./media/textmagic-tutorial/config1.png)

5. **SSO(Single Sign-On)** 탭을 클릭하고 다음 필드를 입력합니다.  

    ![스크린샷은 설명된 값을 입력할 수 있는 Single Sign-On 탭을 보여줍니다.](./media/textmagic-tutorial/config2.png)
...
액세스 패널에서 TextMagic 타일을 클릭하면 SSO를 설정한 TextMagic에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure AD에서 TextMagic 사용해보기](https://aad.portal.azure.com/)