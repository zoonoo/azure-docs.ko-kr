...
* 사용자가 자신의 Azure AD 계정으로 Envoy에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
4. 검색 상자에 **Envoy**를 입력하고, 결과 패널에서 **Envoy**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Envoy의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Envoy에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Envoy Single Sign-On 구성](#configure-envoy-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Envoy 테스트 사용자 만들기](#create-envoy-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Envoy에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Envoy** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Envoy 도메인 및 URL Single Sign-On 정보](common/sp-signonurl.png)
...
7. **Envoy 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-envoy-single-sign-on"></a>Envoy Single Sign-On 구성
...
5. **SAML 인증** 구성 섹션에서 다음 단계를 수행합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Envoy**를 차례로 선택합니다.
