...
1. 검색 상자에서 **Gigya**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/tutorial_gigya_search.png)

1. 결과 패널에서 **Gigya**를 선택하고 **추가** 단추를 클릭하여 해당 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[Gigya 테스트 사용자 만들기](#creating-a-gigya-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Gigya에 만듭니다.
...
1. **Gigya 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Gigya 구성** 섹션에서 **Gigya 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조** 섹션에서 **SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/gigya-tutorial/tutorial_gigya_configure.png) 

1. 다른 웹 브라우저 창에서 Gigya 회사 사이트에 관리자로 로그인합니다.

1. **설정 \> SAML 로그인**으로 이동한 다음 **추가** 단추를 클릭합니다.
   
    ![SAML 로그인](./media/gigya-tutorial/ic789532.png "SAML 로그인")

1. **SAML 로그인** 섹션에서 다음 단계를 수행합니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. **관리자 \> 사용자 관리**로 이동한 다음 **사용자 초대**를 클릭합니다.
   
    ![사용자 관리](./media/gigya-tutorial/ic789535.png "사용자 관리")

1. 사용자 초대 대화 상자에서 다음 단계를 수행합니다.
