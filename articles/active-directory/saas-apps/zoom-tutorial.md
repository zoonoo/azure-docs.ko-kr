...
1. 검색 상자에 **Zoom**을 입력하고 결과 패널에서 **Zoom**을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Zoom in](./media/zoom-tutorial/tutorial_zoom_addfromgallery.png)
...
1. **[Zoom 테스트 사용자 만들기](#create-a-zoom-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Zoom에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Zoom 애플리케이션에서 Single Sign-On을 구성합니다.

**Zoom에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Zoom** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/zoom-tutorial/tutorial_zoom_samlbase.png)

1. **Zoom 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Zoom 도메인 및 URL Single Sign-On 정보](./media/zoom-tutorial/tutorial_zoom_url.png)
...
1. Zoom 응용 프로그램은 특정 서식에서 SAML 어설션을 예상하며, SAML 토큰 특성 구성에 사용자 할당 특성 매핑을 추가해야 합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 
...
1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/zoom-tutorial/tutorial_zoom_certificate.png)

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/zoom-tutorial/tutorial_general_400.png)

1. **Zoom 구성** 섹션에서 **Zoom 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Zoom 구성](./media/zoom-tutorial/tutorial_zoom_configure.png)
...
1. **보안 제어**를 클릭하고, **Single Sign-On** 설정으로 이동합니다.
...
1. Single Sign-On 섹션에서 다음 단계를 수행 합니다.
    ...
    > [!NOTE] 
    > 자세한 내용은 확대/축소 설명서 [https://zoomus.zendesk.com/hc/en-us/articles/115005887566](https://zoomus.zendesk.com/hc/en-us/articles/115005887566)를 참조하세요.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/zoom-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/zoom-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/zoom-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/zoom-tutorial/create_aaduser_04.png)
...
1. **계정 관리** 탭을 클릭한 후 **사용자 관리**를 클릭합니다.

1. 사용자 관리 섹션에서 **사용자 추가**를 클릭합니다.
   
    ![사용자 관리](./media/zoom-tutorial/IC784703.png "사용자 관리")

1. **사용자 추가** 페이지에서 다음 단계를 수행합니다.
...
1. 애플리케이션 목록에서 **Zoom**을 선택합니다.
    ...
    ![애플리케이션 목록의 Zoom 연결](./media/zoom-tutorial/tutorial_zoom_app.png)  
...
액세스 패널에서 Zoom 타일을 클릭하면 Zoom 애플리케이션에 자동으로 로그온됩니다.
