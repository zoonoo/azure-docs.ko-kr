...
내 앱 포털에서 Trelica 타일을 클릭하면 SSO를 설정한 Trelica에 자동으로 로그인됩니다. 내 앱 포털에 대한 자세한 내용은 [내 앱 포털 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
