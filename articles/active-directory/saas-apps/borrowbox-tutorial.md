...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 BorrowBox 애플리케이션에서 Single Sign-On을 구성합니다.
...
액세스 패널에서 BorrowBox 타일을 클릭하면 BorrowBox 애플리케이션에 자동으로 로그온됩니다.
