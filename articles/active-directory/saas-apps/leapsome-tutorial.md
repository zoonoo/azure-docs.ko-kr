...
ms.locfileid: "92458711"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-leapsome"></a>자습서: Leapsome과 Azure Active Directory SSO(Single Sign-On) 연결
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-leapsome"></a>Leapsome용 Azure AD Single Sign-On 구성 및 테스트
...
Leapsome에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. **[Leapsome SSO 구성](#configure-leapsome-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[Leapsome 테스트 사용자 만들기](#create-leapsome-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Leapsome에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Leapsome** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 다음, **Single Sign-On** 을 선택합니다.
...
액세스 패널에서 Leapsome 타일을 클릭하면 SSO를 설정한 Leapsome에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure AD를 사용하여 Leapsome 사용해 보기](https://aad.portal.azure.com/)