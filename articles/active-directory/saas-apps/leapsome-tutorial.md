...
4. 검색 상자에 **Leapsome**을 입력하고 결과 패널에서 **Leapsome**을 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Leapsome 테스트 사용자 만들기](#create-a-leapsome-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Leapsome에 만듭니다.
...
3. **Leapsome 도메인 및 URL** 섹션에서 **IDP** 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
5. Leapsome 응용 프로그램은 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 예제를 보여 줍니다.
...
9. **Leapsome 구성** 섹션에서 **Leapsome 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Leapsome 구성](./media/leapsome-tutorial/tutorial_leapsome_configure.png)

10. 다른 웹 브라우저 창에서 Leapsome에 보안 관리자로 로그인합니다.

11. 오른쪽 위에서 설정 로고를 클릭한 다음, **관리 설정**을 클릭합니다. 

    ![Leapsome 설정](./media/leapsome-tutorial/tutorial_leapsome_admin.png)

12. 왼쪽 메뉴 모음에서 **SSO(Single Sign On)** 를 클릭하고, **SSO(SAML 기반 Single Sign-On)** 페이지에서 다음 단계를 수행합니다.
...
2. 응용 프로그램 목록에서 **Leapsome**을 선택합니다.
