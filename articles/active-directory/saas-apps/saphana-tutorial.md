...
1. 검색 상자에 **SAP HANA**를 입력합니다. 그런 다음 결과 창에서 **SAP HANA**를 선택합니다. 마지막으로 **추가** 단추를 선택하여 응용 프로그램을 추가합니다. 
...
1. SAP HANA 응용 프로그램에는 특정 형식의 SAML 어설션이 필요합니다. 다음 스크린샷은 이 형식에 대한 예제를 보여 줍니다. 
