...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/trello-tutorial/tutorial_trello_samlbase.png)

3. **Trello 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![Trello 도메인 및 URL Single Sign-On 정보](./media/trello-tutorial/tutorial_trello_url.png)
...
4. **SP** 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
    ...
    ![Trello 도메인 및 URL Single Sign-On 정보](./media/trello-tutorial/tutorial_trello_url1.png)
...
7. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/trello-tutorial/tutorial_trello_certificate.png) 

8. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/trello-tutorial/tutorial_general_400.png)
    
9. **Trello 구성** 섹션에서 **Trello 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Trello 구성](./media/trello-tutorial/tutorial_trello_configure.png) 
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/trello-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/trello-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/trello-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/trello-tutorial/create_aaduser_04.png)
