...
3. **Add a Person**(사람 추가) 옵션을 클릭하여 양식을 열고 다음 옵션을 입력합니다.
    ...
    다. 에 **전자 메일 주소** 텍스트 상자 형식 사용자의 전자 메일 주소와 같은 **BrittaSimon\@contoso.com**합니다.
...
5. 클릭할 **저장 및 초대 보내기** (초대 메일을 통해 필요한 경우) 또는 **저장** (바로 저장)을 사용자 등록을 완료 합니다.
