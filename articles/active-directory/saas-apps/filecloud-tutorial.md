...
1. 검색 상자에 **FileCloud**를 입력하고 결과 패널에서 **FileCloud**를 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 FileCloud](./media/filecloud-tutorial/tutorial_filecloud_addfromgallery.png)
...
1. **[FileCloud 테스트 사용자 만들기](#create-a-filecloud-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 FileCloud에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 FileCloud 애플리케이션에서 Single Sign-On을 구성합니다.

**에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **FileCloud** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/filecloud-tutorial/tutorial_filecloud_samlbase.png)

1. **FileCloud 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![FileCloud 도메인 및 URL Single Sign-On 정보](./media/filecloud-tutorial/tutorial_filecloud_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/filecloud-tutorial/tutorial_filecloud_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/filecloud-tutorial/tutorial_general_400.png)

1. **FileCloud Configuration**(FileCloud 구성) 섹션에서 **Configure FileCloud**(FileCloud 구성)를 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID**를 복사합니다.

    ![FileCloud 구성](./media/filecloud-tutorial/tutorial_filecloud_configure.png) 
...
1. 설정 섹션에서 **SSO** 탭을 클릭합니다. 
   
    ![앱 쪽에서 Single Sign-On 구성](./media/filecloud-tutorial/tutorial_filecloud_001.png)

1. **SSO(Single Sign On) 설정** 패널에서 **기본 SSO 형식**으로 **SAML**을 선택합니다.
   
    ![앱 쪽에서 Single Sign-On 구성](./media/filecloud-tutorial/tutorial_filecloud_002.png)

1. Azure Portal에서 복사한 **SAML 엔터티 ID** 값을 **IdP 끝점 URL** 텍스트 상자에 붙여넣습니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/filecloud-tutorial/tutorial_filecloud_003.png)

1. 다운로드된 메타데이터 파일을 메모장에서 열고, 내용을 클립보드에 복사한 다음 **SAML 설정** 패널의 **IdP 메타데이터** 텍스트 상자에 붙여넣습니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/filecloud-tutorial/tutorial_filecloud_004.png)
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/filecloud-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/filecloud-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/filecloud-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/filecloud-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **FileCloud**를 선택합니다.
    ...
    ![애플리케이션 목록의 FileCloud 링크](./media/filecloud-tutorial/tutorial_filecloud_app.png)  
...
액세스 패널에서 FileCloud 타일을 클릭하면 FileCloud 애플리케이션에 자동으로 로그온됩니다.
