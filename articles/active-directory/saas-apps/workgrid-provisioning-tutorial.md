---
title: '자습서: Azure Active Directory을 사용 하 여 자동 사용자 프로 비전을 위한 작업 표 구성 Microsoft Docs'
...
* 사용자를 회사 그리드에 할당할 때 할당 대화 상자에서 유효한 응용 프로그램별 역할 (사용 가능한 경우)을 선택 해야 합니다. **기본 액세스** 역할이 있는 사용자는 프로 비전에서 제외 됩니다.
...
> [!TIP]
> 또한 워크플로를 사용 하는 [single sign-on 자습서](Workgrid-tutorial.md)에 제공 된 지침에 따라 업무 그리드에 SAML 기반 Single Sign-On를 사용 하도록 선택할 수 있습니다. Single sign-on은 자동 사용자 프로 비전과 독립적으로 구성 될 수 있지만,이 두 가지 기능은 서로 보완 됩니다.
