...
4. 검색 상자에 **Ariba**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/tutorial_ariba_search.png)

5. 결과 패널에서 **Ariba**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Ariba 테스트 사용자 만들기](#creating-an-ariba-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Ariba에 만듭니다.
...
3. **Ariba 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. 응용 프로그램에 SSO를 구성하려면 **1-866-218-2155**에서 Ariba 지원팀에 문의하세요. 그러면 다운로드한 **인증서(Base64)** 파일을 제공하는 방법을 추가로 지원합니다.  
