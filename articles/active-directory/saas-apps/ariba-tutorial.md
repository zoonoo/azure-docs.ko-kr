...
1. 결과 패널에서 **Ariba**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Ariba 응용 프로그램에서 Single Sign-On을 구성합니다.

**Ariba에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Ariba** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. 응용 프로그램에 SSO를 구성하려면 **1-866-218-2155**에서 Ariba 지원팀에 문의하세요. 그러면 다운로드한 **인증서(Base64)** 파일을 제공하는 방법을 추가로 지원합니다.  
