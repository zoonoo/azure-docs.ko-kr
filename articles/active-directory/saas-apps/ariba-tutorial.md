...
1. 검색 상자에 **Ariba**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/tutorial_ariba_search.png)

1. 결과 패널에서 **Ariba**를 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/tutorial_ariba_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Azure AD Single Sign-on 구성 및 테스트
이 섹션에서는 "Britta Simon"이라는 테스트 사용자를 기반으로 Ariba에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Ariba 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Ariba의 관련 사용자 간에 연결이 형성되어야 합니다.

Ariba에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.

Ariba에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Configuring Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
1. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
1. **[Ariba 테스트 사용자 만들기](#creating-an-ariba-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Ariba에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Ariba 애플리케이션에서 Single Sign-On을 구성합니다.

**Ariba에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Ariba** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Ariba 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Configure Single Sign-On](./media/ariba-tutorial/tutorial_ariba_url.png)

    a. **로그온 URL** 텍스트 상자에서 `https://<subdomain>.sourcing.ariba.com` 또는 `https://<subdomain>.supplier.ariba.com` 패턴을 사용하여 URL을 입력합니다.

    나. **식별자** 텍스트 상자에서 `http://<subdomain>.procurement-2.ariba.com` 패턴을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 로그온 URL 및 식별자로 값을 업데이트합니다. 식별자에는 고유한 문자열 값을 사용하는 것이 좋습니다. 이러한 값을 가져오려면 **1-866-218-2155**에서 Ariba 클라이언트 지원팀에 문의하세요. 
...
1. 애플리케이션에 SSO를 구성하려면 **1-866-218-2155**에서 Ariba 지원팀에 문의하세요. 그러면 다운로드한 **인증서(Base64)** 파일을 제공하는 방법을 추가로 지원합니다.  
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/ariba-tutorial/create_aaduser_04.png) 
...
### <a name="creating-an-ariba-test-user"></a>Ariba 테스트 사용자 만들기

이 섹션은 Ariba에서 Britta Simon이라는 사용자를 만들기 위한 것입니다. **1-866-218-2155**에서 Ariba 지원팀과 함께 Ariba 시스템에 사용자를 추가하세요. 

 >[!NOTE]
 >사용자를 수동으로 만들어야 하는 경우 **1-866-218-2155**에서 Ariba 지원팀에 문의해야 합니다.
 >  
...
액세스 패널에서 Ariba 타일을 클릭하면 Ariba 애플리케이션에 자동으로 로그온됩니다. 
