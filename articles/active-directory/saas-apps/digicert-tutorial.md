...
1. 검색 상자에 **DigiCert**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/tutorial_digicert_search.png)

1. 결과 패널에서 **DigiCert**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/tutorial_digicert_addfromgallery.png)
...
1. **[DigiCert 테스트 사용자 만들기](#creating-a-digicert-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 해당 사용자를 DigiCert에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 DigiCert 애플리케이션에서 Single Sign-On을 구성합니다.

**DigiCert에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **DigiCert** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **DigiCert 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. DigiCert 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이 구성에 대한 예제를 보여줍니다. 
...
1. **DigiCert** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Direct 지원 팀](mailto:support@digicert.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/digicert-tutorial/create_aaduser_04.png) 
...
액세스 패널에서 DigiCert 타일을 클릭하면 DeigiCert 애플리케이션에 자동으로 로그온됩니다.
