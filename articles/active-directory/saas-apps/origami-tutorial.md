...
* Origami에 대 한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
* 사용자가 자동으로 로그인 (Single Sign-on) Origami에 해당 Azure AD 계정으로 사용할 수 있습니다.
...
* Origami single sign-on이 설정 된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Origami 지원 **SP** 에서 시작한 SSO
...
4. 검색 상자에 입력 **Origami**를 선택 **Origami** 결과 패널에서 클릭 **추가** 단추는 응용 프로그램을 추가 합니다.

     ![결과 목록의 origami](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 구성 하 고이 Azure AD single sign-on 테스트 이라는 테스트 사용자를 기반으로 Origami **Britta Simon**합니다.
Single sign-on 작업에 대 한 Azure AD 사용자와 Origami의 관련된 사용자 간에 연결 관계가 설정 해야 합니다.

Origami에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Origami Single Sign-on 구성](#configure-origami-single-sign-on)**  -응용 프로그램 쪽에서 Single Sign-on 설정을 구성 합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Origami 테스트 사용자 만들기](#create-origami-test-user)**  -Britta simon 이라는 사용자를 Azure AD 표현과 연결 된 Origami 합니다.
...
Origami를 사용 하 여 Azure AD에서 single sign-on 구성 하려면 다음 단계를 수행 합니다.

1. 에 [Azure portal](https://portal.azure.com/)의 합니다 **Origami** 응용 프로그램 통합 페이지에서 선택 **Single sign on**합니다.
...
6. 에 **Origami 설정** 섹션, 요구 사항에 따라 적절 한 URL을 복사 합니다.
...
3. Single Sign-On 설정 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    b. 에 **Id 공급자의 로그인 페이지 URL** 텍스트 상자 값을 붙여넣습니다 **로그인 URL**, Azure portal에서 복사한 합니다.

    다. 에 **Id 공급자 로그 아웃 페이지 URL** 텍스트 상자 값을 붙여넣습니다 **로그 아웃 URL**, Azure portal에서 복사한 합니다.
...
1. Azure portal에서 선택 **엔터프라이즈 응용 프로그램**를 선택 **모든 응용 프로그램**을 선택한 후 **Origami**합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Origami**를 선택합니다.

    ![응용 프로그램 목록에서 Origami 링크](common/all-applications.png)
...
5. 새 사용자 추가 대화 상자에서 다음 단계를 수행합니다.
    ...
    a. 에 **사용자 이름** 텍스트 상자과 같은 사용자의 전자 메일 입력 **brittasimon\@contoso.com**합니다.
...
액세스 패널에서 Origami 타일을 클릭 하면 로그인 되어야 합니다 수 자동으로 SSO를 설정 하 여 Origami에 있습니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
