...
ms.locfileid: "68825383"
---
# <a name="tutorial-integrate-workplace-by-facebook-with-azure-active-directory"></a>자습서: Workplace by Facebook과 Azure Active Directory 통합
...
5. **[Workplace by Facebook 테스트 사용자 만들기](#create-workplace-by-facebook-test-user)** - B.Simon의 Azure AD 표현과 연결된 사용자를 Workplace by Facebook에 만듭니다.
