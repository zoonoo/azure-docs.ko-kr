...
2. **사용자 아이콘**을 클릭하고 **팀 관리** 탭을 선택합니다.
    ...
    ![Single Sign-on 구성](./media/saucelabs-mobileandwebtesting-tutorial/configure1.png)

3. 텍스트 상자에 **도메인 이름**을 입력합니다.

    ![Single Sign-on 구성](./media/saucelabs-mobileandwebtesting-tutorial/configure2.png)

4. **구성** 탭을 클릭합니다.

    ![Single Sign-on 구성](./media/saucelabs-mobileandwebtesting-tutorial/configure3.png)
...
액세스 패널에서 Sauce Labs - Mobile and Web Testing 타일을 클릭하면 SSO를 설정한 Sauce Labs - Mobile and Web Testing 애플리케이션에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
