...
* 사용자가 해당 Azure AD 계정으로 ServiceChannel에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
4. 검색 상자에 **ServiceChannel**을 입력하고 결과 패널에서 **ServiceChannel**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 ServiceChannel](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 ServiceChannel에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 ServiceChannel의 관련 사용자 간에 연결 관계를 설정해야 합니다.

ServiceChannel에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[ServiceChannel Single Sign-On 구성](#configure-servicechannel-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[ServiceChannel 테스트 사용자 만들기](#create-servicechannel-test-user)** - Azure AD의 Britta Simon 사용자에 연결된 해당 사용자를 ServiceChannel에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **ServiceChannel** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **SAML로 Single Sign-On 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    ![ServiceChannel 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
8. **ServiceChannel 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-servicechannel-single-sign-on"></a>ServiceChannel Single Sign-On 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **ServiceChannel**을 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **ServiceChannel**을 선택합니다.

    ![애플리케이션 목록의 ServiceChannel 링크](common/all-applications.png)
