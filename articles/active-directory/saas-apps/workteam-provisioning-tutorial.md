---
title: '자습서: Azure Active Directory를 사용 하 여 자동 사용자 프로 비전을 위한 근무 팀 구성 Microsoft Docs'
...
ms.locfileid: "69908174"
---
# <a name="tutorial-configure-workteam--for-automatic-user-provisioning"></a>자습서: 자동 사용자 프로 비전을 위한 근무 팀 구성
...
> [!TIP]
> 공동 [팀 single sign-on 자습서](workteam-tutorial.md)에 제공 된 지침에 따라 회사 팀에 대해 SAML 기반 single sign-on을 사용 하도록 선택할 수도 있습니다. Single sign-on은 자동 사용자 프로 비전과 독립적으로 구성 될 수 있지만,이 두 가지 기능은 서로 보완 됩니다.
