...
1. 결과 패널에서 **Dropbox for Business**를 선택한 다음, 앱을 추가합니다. 앱이 테넌트에 추가될 때까지 잠시 동안 기다려 주세요.
...
1. **[Dropbox for Business SSO 구성](#configure-dropbox-for-business-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    1. **[Dropbox for Business 테스트 사용자 만들기](#create-dropbox-for-business-test-user)** - Britta Simon의 Azure AD 표현과 연결된 사용자를 Dropbox for Business에 만듭니다.
...
2. 브라우저에 확장이 추가된 후 **Dropbox for Business 설정**을 클릭하면 Dropbox for Business 애플리케이션으로 이동합니다. 여기서 관리자 자격 증명을 제공하여 Dropbox for Business에 로그인합니다. 브라우저 확장이 애플리케이션을 자동으로 구성하고 3-8단계를 자동으로 수행합니다.
...
- [고급 표시 유형 및 컨트롤을 사용하여 Dropbox를 보호하는 방법](https://docs.microsoft.com/cloud-app-security/protect-dropbox)