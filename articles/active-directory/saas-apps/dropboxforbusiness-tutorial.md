...
* Dropbox를 구성한 후에는 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법 알아보기](/cloud-app-security/proxy-deployment-aad)

## <a name="adding-dropbox-business-from-the-gallery"></a>갤러리에서 Dropbox Business 추가
...
Dropbox Business에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Dropbox Business** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고 **Single Sign-On** 을 선택합니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 Britta Simon에게 Dropbox Business에 대한 액세스 권한을 부여합니다.
...
액세스 패널에서 Dropbox Business 타일을 선택하면 SSO를 설정한 Dropbox Business에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure Active Directory의 조건부 액세스란?](/cloud-app-security/proxy-intro-aad)

- [Azure AD를 사용하여 Dropbox Business 사용해보기](https://aad.portal.azure.com/)
