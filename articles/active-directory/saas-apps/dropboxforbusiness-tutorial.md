...
- [Azure Active Directory의 조건부 액세스란?](https://docs.microsoft.com/cloud-app-security/protect-dropbox)

- [고급 표시 유형 및 컨트롤을 사용하여 Dropbox를 보호하는 방법](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
