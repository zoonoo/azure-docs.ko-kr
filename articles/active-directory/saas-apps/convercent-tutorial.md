...
- 사용자가 해당 Azure AD 계정으로 Convercent에 자동으로 로그온(Single Sign-on)되도록 설정할 수 있습니다.
...
이 섹션에서는 “Britta Simon”이라는 테스트 사용자를 기반으로 Convercent에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Convercent 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Convercent의 관련 사용자 간에 연결이 형성되어야 합니다.
...
1. **[Convercent 테스트 사용자 만들기](#creating-a-convercent-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Convercent에 만듭니다.
...
1. **Convercent 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![Configure Single Sign-On](./media/convercent-tutorial/tutorial_convercent_url.png)

    **식별자** 텍스트 상자에서 `https://<instancename>.convercent.com/` 패턴을 사용하여 URL을 입력합니다.
 
1. **SP 시작 모드**에서 응용 프로그램을 구성하려는 경우 **Convercent 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    
    ![Configure Single Sign-On](./media/convercent-tutorial/tutorial_convercent_url1.png)

     a. **“고급 URL 설정 표시”** 를 클릭합니다. 

     나. **로그온 URL** 텍스트 상자에서 `https://<instancename>.convercent.com/` 패턴을 사용하여 값을 입력합니다.

     다. **릴레이 상태** 텍스트 상자에서 `https://<instancename>.convercent.com/` 패턴을 사용하여 값을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 식별자, 로그온 URL 및 릴레이 상태로 이러한 값을 업데이트합니다. 이러한 값을 얻으려면 [Convercent 클라이언트 지원 팀](http://support.convercent.com)에 문의하세요.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/convercent-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/convercent-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/convercent-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/convercent-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-convercent-test-user"></a>Convercent 테스트 사용자 만들기

Convercent 플랫폼에서 사용자를 추가하려면 [Convercent 지원 팀](mailto:support@convercent.com)에 문의하세요.
...
액세스 패널에서 Convercent 타일을 클릭하면 Convercent 애플리케이션에 자동으로 로그온됩니다.
