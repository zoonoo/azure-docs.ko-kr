...
3. **[Convercent 테스트 사용자 만들기](#creating-a-convercent-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Convercent에 만듭니다.
...
7. 응용 프로그램에 대해 SSO를 구성하려면 [Convercent 지원 팀](mailto:support@convercent.com)에 문의하고 다운로드한 **메타데이터 XML**을 제공합니다.
