...
1. 결과 패널에서 **Moxtra**를 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Moxtra 애플리케이션에서 Single Sign-On을 구성합니다.

**Moxtra에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Moxtra** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. Moxtra 애플리케이션에는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이 구성에 대한 예제를 보여줍니다. 
...
액세스 패널에서 Moxtra 타일을 클릭하면 Moxtra 애플리케이션에 자동으로 로그온됩니다.
