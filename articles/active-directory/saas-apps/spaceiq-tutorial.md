...
1. 검색 상자에 **SpaceIQ**를 입력하고 결과 패널에서 **SpaceIQ**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[SpaceIQ 테스트 사용자 만들기](#create-a-spaceiq-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 SpaceIQ에 만듭니다.
...
1. **SpaceIQ 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **SpaceIQ 구성** 섹션에서 **SpaceIQ 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID**를 복사합니다.

    ![SpaceIQ 구성](./media/spaceiq-tutorial/tutorial_spaceiq_configure.png) 

1.  새 브라우저 창을 열고 SpaceIQ 환경에 관리자 권한으로 로그인합니다.

1. 로그인되었으면 오른쪽 맨 위의 퍼즐 기호를 클릭한 후 **“통합”** 을 클릭합니다.
...
1. 응용 프로그램 목록에서 **SpaceIQ**를 선택합니다.
