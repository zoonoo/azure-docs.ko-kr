...
1. **O.C. Tanner - AppreciateHub 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. 다음 링크를 사용하여 메타데이터 파일을 엽니다. [https://fed.appreciatehub.com/fed/sp/metadata](https://fed.appreciatehub.com/fed/sp/metadata)
...
O.C.를 클릭할 때 Tanner - 액세스 패널에서 AppreciateHub 타일, O.C.에 자동으로 로그온되야 합니다. Tanner - AppreciateHub 애플리케이션.
