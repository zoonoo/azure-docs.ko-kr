...
* 사용자가 해당 Azure AD 계정으로 Samanage에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 하여 Samanage에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Samanage의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Samanage에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Samanage Single Sign-On 구성](#configure-samanage-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Samanage 테스트 사용자 만들기](#create-samanage-test-user)** - Azure AD 표현과 연결된 Britta Simon에 해당하는 사용자를 Samanage에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Samanage** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
6. **Samanage 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-samanage-single-sign-on"></a>Samanage Single Sign-On 구성

1. 다른 웹 브라우저 창에서 Samanage 회사 사이트에 관리자로 로그인합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Samanage**를 차례로 선택합니다.
...
### <a name="create-samanage-test-user"></a>Samanage 테스트 사용자 만들기
...
2. **대시보드**를 클릭하고 왼쪽 창에서 **설정**을 선택합니다.
    ...
    ![설치](./media/samanage-tutorial/tutorial_samanage_001.png "설치 프로그램")
...
액세스 패널에서 Samanage 타일을 클릭하면 SSO를 설정한 Samanage에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
