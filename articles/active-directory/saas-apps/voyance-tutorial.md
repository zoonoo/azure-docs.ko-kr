...
1. 검색 상자에 **Voyance**를 입력하고 결과 패널에서 **Voyance**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Voyance](./media/voyance-tutorial/tutorial_voyance_addfromgallery.png)
...
1. **[Voyance 테스트 사용자 만들기](#create-a-voyance-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Voyance에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-on 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Voyance 애플리케이션에서 Single Sign-On을 구성합니다.

**Voyance에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Voyance** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/voyance-tutorial/tutorial_voyance_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/voyance-tutorial/tutorial_general_400.png)
    
1. **Voyance 구성** 섹션에서 **Voyance 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Voyance 구성](./media/voyance-tutorial/tutorial_voyance_configure.png) 

1. 다른 웹 브라우저 창에서 Voyance 테넌트에 관리자로 로그인합니다.

1. 탐색 모음의 오른쪽 위 구석으로 이동한 후 "**Acme University**"라는 드롭다운을 클릭합니다.
...
1. "**SSO 사용 안 함**" 단추를 클릭하여 SAML 2.0을 사용하여 IdP로 Azure AD를 구성합니다.

    ![앱 쪽에서 Single Sign-On 구성 SSO가 비활성화됨 단추](./media/voyance-tutorial/tutorial_voyance_004.png)

1. **SAML v2** 섹션으로 이동한 후 다음 단계를 수행합니다.

    ![앱 쪽에서 Single Sign-On 구성 SAML v2](./media/voyance-tutorial/tutorial_voyance_005.png)
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/voyance-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/voyance-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![추가 단추](./media/voyance-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![사용자 대화 상자](./media/voyance-tutorial/create_aaduser_04.png) 
...
액세스 패널에서 Voyance 타일을 클릭하면 Voyance 애플리케이션에 자동으로 로그온됩니다.
