...
1. **[The Funding Portal 테스트 사용자 만들기](#creating-the-funding-portal-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 The Funding Portal에 만듭니다.
...
1. **The Funding Portal 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
