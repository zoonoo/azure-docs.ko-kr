...
ms.date: 06/29/2017
ms.author: jeedes
ms.openlocfilehash: 7c89d341cae88fbdbb1d711b22dbcc3e281ac7b5
ms.sourcegitcommit: 16ddc345abd6e10a7a3714f12780958f60d339b6
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 06/19/2018
ms.locfileid: "36230219"
---
...
4. 검색 상자에 **PostBeyond**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/postbeyond-tutorial/tutorial_postbeyond_search.png)

5. 결과 패널에서 **PostBeyond**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **PostBeyond 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **PostBeyond 구성** 섹션에서 **PostBeyond 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/postbeyond-tutorial/tutorial_postbeyond_configure.png) 

7. **PostBeyond** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)**, **SAML 엔터티 ID**, **SAML Single Sign-On 서비스 URL** 및 **로그아웃 URL**을 [PostBeyond 지원 팀](mailto:sso@postbeyond.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
2. 응용 프로그램 목록에서 **PostBeyond**를 선택합니다.
