...
1. 결과 패널에서 **PostBeyond**를 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 PostBeyond 애플리케이션에서 Single Sign-On을 구성합니다.

**PostBeyond에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **PostBeyond** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **PostBeyond 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<subdomain>.postbeyond.com` 패턴을 사용하여 URL을 입력합니다.
...
1. 애플리케이션 목록에서 **PostBeyond**를 선택합니다.
