...
- 사용자가 해당 Azure AD 계정으로 Lessonly.com에 자동으로 로그온(Single Sign-on)되도록 설정할 수 있습니다.
...
1. 검색 상자에서 **Lessonly.com**을 입력합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자에 해당하는 Lessonly.com 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Lessonly.com의 관련 사용자 간에 연결이 형성되어야 합니다.

Lessonly.com에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 연결 관계를 설정합니다.
...
1. **Lessonly.com 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Lessonly.com 구성** 섹션에서 **Lessonly.com 구성**을 클릭하여 **로그인 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
### <a name="creating-a-lessonlycom-test-user"></a>Lessonly.com 테스트 사용자 만들기
...
**Britta Simon을 Lessonly.com에 할당하려면 다음 단계를 수행합니다.**
