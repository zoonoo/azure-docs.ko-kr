...
4. 검색 상자에서 **Lesson.ly**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/lessonly-tutorial/tutorial_lesson.ly_search.png)

5. 결과 패널에서 **Lesson.ly**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Lesson.ly 테스트 사용자 만들기](#creating-a-lessonly-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Lesson.ly에 만듭니다.
...
3. **Lesson.ly 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
5. Lesson.ly 응용 프로그램에는 특정 서식에서 SAML 어설션이 필요하므로, **SAML 토큰 특성** 구성에 사용자 지정 특성 매핑을 추가해야 합니다. 다음 스크린샷에서는 이에 대한 예를 보여 줍니다.
...
8. **Lesson.ly 구성** 섹션에서 **Lesson.ly 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/lessonly-tutorial/tutorial_lesson.ly_configure.png)

9. **Lesson.ly** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)**, **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 [Lesson.ly 지원 팀](mailto:dev@lessonly.com)에 보내야 합니다.
...
2. 응용 프로그램 목록에서 **Lesson.ly**를 선택합니다.
