---
title: '자습서: Contentful과 Azure Active Directory SSO(Single Sign-On) 연결 | Microsoft Docs'
...
* Contentful을 구성한 후에는 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](/cloud-app-security/proxy-deployment-any-app).
...
Contentful에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. **[Contentful SSO 구성](#configure-contentful-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[Contentful 테스트 사용자 만들기](#create-contentful-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Contentful에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Contentful** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On** 을 선택합니다.
...
액세스 패널에서 Contentful 타일을 클릭하면 SSO를 설정한 Contentful에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure AD에서 Contentful 사용해보기](https://aad.portal.azure.com/)