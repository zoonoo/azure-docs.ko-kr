...
1. **[HPE SaaS 테스트 사용자 만들기](#creating-an-hpe-saas-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 HPE SaaS에 만듭니다.
...
1. **HPE SaaS 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **HPE SaaS** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [HPE SaaS 지원 팀](https://saas.hpe.com/en-us/contact)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
