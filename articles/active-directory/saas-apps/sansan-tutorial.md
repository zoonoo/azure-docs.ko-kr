...
1. **기본 SAML 구성** 페이지에서 다음 단계를 수행합니다.
   ...
   1. **회신 URL** 텍스트 상자에서 다음 패턴 중 하나를 사용하여 URL을 입력합니다.
      ...
      | Smartphone 앱 |`https://internal.api.sansan.com/<COMPANY_NAME>/acs` |
...
* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 Sansan 타일을 클릭하면 Sansan 로그온 URL로 리디렉션됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
