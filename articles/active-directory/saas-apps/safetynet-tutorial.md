...
1. 검색 상자에 **SafetyNet**을 입력하고 결과 패널에서 **SafetyNet**을 선택한 후, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 SafetyNet](./media/safetynet-tutorial/tutorial_safetynet_addfromgallery.png)
...
1. **[SafetyNet 테스트 사용자 만들기](#create-a-safetynet-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 SafetyNet에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 SafetyNet 애플리케이션에서 Single Sign-On을 구성합니다.

**SafetyNet에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **SafetyNet** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/safetynet-tutorial/tutorial_safetynet_samlbase.png)

1. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **SafetyNet 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![SafetyNet 도메인 및 URL Single Sign-On 정보](./media/safetynet-tutorial/tutorial_safetynet_url.png)

    a. **식별자** 텍스트 상자에서 `https://<subdomain>.predictivesolutions.com/sp` 패턴을 사용하여 URL을 입력합니다.

    b. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://<subdomain>.predictivesolutions.com/CRMApp/saml/SSO`

1. **SP** 시작 모드에서 애플리케이션을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.

    ![SafetyNet 도메인 및 URL Single Sign-On 정보](./media/safetynet-tutorial/tutorial_safetynet_url1.png)
...
1.  **SAML 서명 인증서** 섹션에서 복사 단추를 클릭하여 **앱 페더레이션 메타데이터 URL**을 복사하고 메모장에 붙여넣습니다.
    ...
    ![인증서 다운로드 링크](./media/safetynet-tutorial/tutorial_safetynet_certificate.png)

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/safetynet-tutorial/tutorial_general_400.png)

1. **SafetyNet** 쪽에서 Single Sign-On을 구성하려면 **앱 페더레이션 메타데이터 URL**을 [SafetyNet 지원 팀](mailto:dev@predictivesolutions.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/safetynet-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/safetynet-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/safetynet-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/safetynet-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **SafetyNet**을 선택합니다.
    ...
    ![애플리케이션 목록의 SafetyNet 링크](./media/safetynet-tutorial/tutorial_safetynet_app.png)  
...
액세스 패널에서 SafetyNet 타일을 클릭하면 SafetyNet 애플리케이션에 자동으로 로그온됩니다.
