...
1. **기본 SAML 구성** 섹션에서 다음 필드에 대한 값을 입력합니다.
    ...
    a. **식별자(엔터티 ID)** 텍스트 상자에서 `http://samlsp.bluejeans.com` URL을 입력합니다.

    a. **회신 URL** 텍스트 상자에서 `https://bluejeans.com/sso/saml2/` URL을 입력합니다.
...
액세스 패널에서 BlueJeans for Azure AD 타일을 클릭하면 SSO를 설정한 BlueJeans for Azure AD에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
