...
1. 검색 상자에 **BlueJeans**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/bluejeans-tutorial/tutorial_bluejeans_search.png)

1. 결과 패널에서 **BlueJeans**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[BlueJeans 테스트 사용자 만들기](#creating-a-bluejeans-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 BlueJeans에 만듭니다.
...
1. **BlueJeans 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **BlueJeans 구성** 섹션에서 **BlueJeans 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, 암호 변경 URL 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. 응용 프로그램 목록에서 **BlueJeans**를 선택합니다.
