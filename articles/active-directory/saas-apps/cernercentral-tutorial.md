...
**Cerner Central** 응용 프로그램은 모든 페더레이션된 ID 공급자의 인증을 허용합니다. 사용자가 애플리케이션 홈페이지에 로그인할 수 있다면 페더레이션되고 수동 프로비전이 필요하지 않습니다. 자동 사용자 프로비전 구성 방법에 대한 자세한 내용은 [여기](cernercentral-provisioning-tutorial.md)에서 제공합니다.
