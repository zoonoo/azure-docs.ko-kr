...
1. [Starleaf 관리 콘솔](https://portal.starleaf.com/#page=login)에 로그인 합니다. 통합 >  통합을 **추가**로 이동 합니다.
...
4. 검색 상자에서 **starleaf**를 입력 하 고 결과 패널에서 **starleaf** 를 선택 합니다.
    결과 목록에서 StarLeaf를 ![](common/search-new-app.png)
...
* [로그를 검토 하 고 프로 비전 활동에 대 한 보고서를 가져오는](../app-provisioning/check-status-user-account-provisioning.md)방법에 대해 알아봅니다.
