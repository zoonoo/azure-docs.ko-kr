...
1. 검색 상자에 **IMPAC Risk Manager**를 입력하고 결과 창에서 **IMPAC Risk Manager**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
1. **[IMPAC Risk Manager 테스트 사용자 만들기](#create-a-impac-risk-manager-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 IMPAC Risk Manager에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 IMPAC Risk Manager 애플리케이션에서 Single Sign-On을 구성합니다.

**IMPAC Risk Manager에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **IMPAC Risk Manager** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **IMPAC Risk Manager 도메인 및 URL** 섹션에서 IDP 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
1. **IMPAC Risk Manager 구성** 섹션에서 **IMPAC Risk Manager 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL, SAML 엔터티 ID** 및 **로그아웃 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_configure.png)

1. **IMPAC Risk Manager** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)**, **로그아웃 URL, SAML 엔터티 ID** 및 **SAML Single Sign-On 서비스 URL**을 [IMPAC Risk Manager 지원 팀](mailto:rmsupport@Impac.co.nz)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. 애플리케이션 목록에서 **IMPAC Risk Manager**를 선택합니다.
    ...
    ![애플리케이션 목록의 IMPAC Risk Manager 링크](./media/impacriskmanager-tutorial/tutorial_impacriskmanager_app.png)  
...
액세스 패널에서 IMPAC Risk Manager 타일을 클릭하면 IMPAC Risk Manager 애플리케이션에 자동으로 로그온됩니다.
