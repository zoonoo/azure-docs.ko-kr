...
4. 검색 상자에 **BGS Online**을 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/bgsonline-tutorial/tutorial_bgsonline_search.png)

5. 결과 패널에서 **BGS Online**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[BGS Online 테스트 사용자 만들기](#creating-a-bgs-online-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 BGS Online에 만듭니다.
...
3. **BGS Online 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **BGS Online 구성** 섹션에서 **BGS Online 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/bgsonline-tutorial/tutorial_bgsonline_configure.png) 

7. **BGS Online** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML** 및 **SAML Single Sign-On 서비스 URL**을 [BGS Online 지원팀](mailto:bgsdashboardteam@millwardbrown.com)으로 보내야 합니다. 
