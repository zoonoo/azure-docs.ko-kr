...
1. 검색 상자에 **ArcGIS Online**을 입력하고 결과 패널에서 **ArcGIS Online**을 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![결과 목록의 ArcGIS Online](./media/arcgis-tutorial/tutorial_arcgisonline_addfromgallery.png)
...
1. **[ArcGIS Online 테스트 사용자 만들기](#create-a-arcgis-online-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 ArcGIS Online에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/arcgis-tutorial/tutorial_arcgisonline_samlbase.png)

1. **ArcGIS Online 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![ArcGIS Online 도메인 및 URL Single Sign-On 정보](./media/arcgis-tutorial/tutorial_arcgisonline_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/arcgis-tutorial/tutorial_arcgisonline_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/arcgis-tutorial/tutorial_general_400.png)

1. 다른 웹 브라우저 창에서 ArcGIS 회사 사이트에 관리자로 로그인합니다.
...
1. **회사 로그인**에서 **ID 공급자 설정**을 클릭합니다.

    ![회사 로그인](./media/arcgis-tutorial/ic784744.png "회사 로그인")

1. **ID 공급자 설정** 구성 페이지에서 다음 단계를 수행합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/arcgis-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/arcgis-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/arcgis-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/arcgis-tutorial/create_aaduser_04.png)
...
1. **전자 메일을 보내지 않고 멤버를 자동으로 추가**를 선택하고 **다음**을 클릭합니다.
   
    ![멤버를 자동으로 추가](./media/arcgis-tutorial/ic784748.png "멤버를 자동으로 추가")

1. **멤버** 대화 상자 페이지에서 다음 단계를 수행합니다.
     ...
     나. **추가 및 검토**를 클릭합니다.
1. 입력한 데이터를 검토한 다음 **멤버 추가**를 클릭합니다.
...
1. 응용 프로그램 목록에서 **ArcGIS Online**을 선택합니다.

    ![응용 프로그램 목록의 ArcGIS Online 링크](./media/arcgis-tutorial/tutorial_arcgisonline_app.png)  
