...
1. 검색 상자에 **EasyTerritory**를 입력하고 결과 패널에서 **EasyTerritory**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[EasyTerritory 테스트 사용자 만들기](#create-a-easyterritory-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 EasyTerritory에 만듭니다.
...
1. **EasyTerritory 도메인 및 URL** 섹션에서 IDP 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
1. **EasyTerritory** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [EasyTerritory 지원 팀](mailto:sales@easyterritory.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
