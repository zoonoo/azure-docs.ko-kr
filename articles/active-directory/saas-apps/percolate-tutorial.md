...
액세스 패널에서 Percolate 타일을 선택하면 SSO를 설정한 Percolate 인스턴스에 자동으로 로그인됩니다. 자세한 내용은 [내 앱 포털에서 앱 액세스 및 사용](../user-help/my-apps-portal-end-user-access.md)을 참조하세요.
