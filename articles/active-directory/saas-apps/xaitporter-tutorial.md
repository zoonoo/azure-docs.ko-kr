...
4. **관리** 를 클릭합니다.
    ...
    ![스크린샷은 XaitPorter 사이트에서 선택한 관리자를 보여줍니다.](./media/xaitporter-tutorial/user1.png)

5. **시스템 설정** 드롭다운 목록에서 **Single Sign-On 관리** 를 선택합니다.

    ![스크린샷은 시스템 설정에서 선택한 Single Sign-On 관리를 보여줍니다.](./media/xaitporter-tutorial/user2.png)

6. **Single Sign-On 관리** 섹션에서 다음 단계를 수행합니다.

    ![스크린샷은 이러한 단계를 수행할 수 있는 Single Sign-On 관리 섹션을 보여줍니다.](./media/xaitporter-tutorial/user3.png)
...
액세스 패널에서 XaitPorter 타일을 클릭하면 SSO를 설정한 XaitPorter에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
