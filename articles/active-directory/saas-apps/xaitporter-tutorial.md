...
4. **관리**를 클릭합니다.
    ...
    ![Single Sign-on 구성](./media/xaitporter-tutorial/user1.png)

5. **시스템 설정** 드롭다운 목록에서 **Single Sign-On 관리**를 선택합니다.

    ![Single Sign-on 구성](./media/xaitporter-tutorial/user2.png)

6. **Single Sign-On 관리** 섹션에서 다음 단계를 수행합니다.

    ![Single Sign-on 구성](./media/xaitporter-tutorial/user3.png)
