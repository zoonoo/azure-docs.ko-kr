...
ms.locfileid: "56190843"
---
# <a name="tutorial-azure-active-directory-integration-with-skills-base"></a>자습서: Skills Manager와 Azure Active Directory 통합

이 자습서에서는 Azure AD(Azure Active Directory)와 Skills Base를 통합하는 방법을 알아봅니다.

Skills Base를 Azure AD와 통합하면 다음과 같은 혜택이 있습니다.

- Skills Base에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
...
Skills Base와 Azure AD 통합을 구성하려면 다음 항목이 필요합니다.

- Azure AD 구독
- Skills Base Single Sign-On이 설정된 구독
...
**갤러리에서 Skills Base를 추가하려면 다음 단계를 수행합니다.**
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Skills Base 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Skills Base의 관련 사용자 간에 연결 관계가 형성되어야 합니다.

Skills Base에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
3. **[Skills Base 테스트 사용자 만들기](#create-a-skills-base-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Skills Base에 만듭니다.
...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/skillsbase-tutorial/tutorial_skillsbase_samlbase.png)

3. **Skills Base 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Skills Base 도메인 및 URL Single Sign-On 정보](./media/skillsbase-tutorial/tutorial_skillsbase_url.png)
...
4. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/skillsbase-tutorial/tutorial_skillsbase_certificate.png) 

5. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/skillsbase-tutorial/tutorial_general_400.png)

6. 다른 웹 브라우저 창에서 Skills Base에 보안 관리자로 로그인합니다.

7. 왼쪽 메뉴의 **관리자** 아래에서 **인증**을 클릭합니다.

    ![관리자](./media/skillsbase-tutorial/tutorial_skillsbase_auth.png)

8. **인증** 페이지에서 Single Sign-On을 **SAML 2**로 선택합니다.

    ![단일](./media/skillsbase-tutorial/tutorial_skillsbase_single.png)

9. **인증** 페이지에서 다음 단계를 수행합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/skillsbase-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/skillsbase-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/skillsbase-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/skillsbase-tutorial/create_aaduser_04.png)
...
### <a name="create-a-skills-base-test-user"></a>Skills Base 테스트 사용자 만들기
