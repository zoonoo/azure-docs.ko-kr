...
* 사용자가 해당 Azure AD 계정으로 Skillsi Base에 자동으로 로그인(Single Sign-on)되도록 설정할 수 있습니다.
...
2. **[Skills Base Single Sign-On 구성](#configure-skills-base-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-on 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Skills Base 테스트 사용자 만들기](#create-skills-base-test-user)** - 사용자의 Azure AD 표현과 연결된 Skills Base에서 Britta Simon의 상대 사용자를 만듭니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Skills Base 도메인 및 URL Single Sign-On 정보](common/sp-signonurl.png)
...
### <a name="configure-skills-base-single-sign-on"></a>Skills Base Single Sign-On 구성
...
액세스 패널에서 Skills Base 타일을 클릭하면 SSO를 설정한 Skills Base에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
