...
4. 검색 상자에 **SecureW2 JoinNow Connector**를 입력하고 결과 패널에서 **SecureW2 JoinNow Connector**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 SecureW2 JoinNow Connector 애플리케이션에서 Single Sign-On을 구성합니다.

**SecureW2 JoinNow Connector에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **SecureW2 JoinNow Connector** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **SecureW2 JoinNow Connector 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **식별자** 텍스트 상자에서 `https://<organization-identifier>-auth.securew2.com/auth/saml` 패턴을 사용하여 URL을 입력합니다.
...
이 섹션에서는 SecureW2 JoinNow Connector에서 Britta Simon이라는 사용자를 만듭니다. SecureW2 JoinNow Connector 플랫폼에서 사용자를 추가하려면 [SecureW2 JoinNow Connector 클라이언트 지원 팀](mailto:support@securew2.com)에 문의하세요. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.
...
2. 애플리케이션 목록에서 **SecureW2 JoinNow Connector**를 선택합니다.

    ![애플리케이션 목록의 SecureW2 JoinNow Connector 링크](./media/securejoinnow-tutorial/tutorial_securejoinnow_app.png)  
