...
4. 검색 상자에 **Blackboard Learn - Shibboleth**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/blackboard-learn-shibboleth-tutorial/tutorial_blackboardlearn-shibboleth_search.png)

5. 결과 패널에서 **Blackboard Learn - Shibboleth**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **Blackboard Learn - Shibboleth 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Blackboard Learn - Shibboleth 구성** 섹션에서 **Blackboard Learn - Shibboleth 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/blackboard-learn-shibboleth-tutorial/tutorial_blackboardlearn-shibboleth_configure.png) 

7. **Blackboard Learn - Shibboleth** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**, **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 [Blackboard Learn - Shibboleth 지원팀](https://www.blackboard.com/forms/contact-us_form.aspx)으로 보내야 합니다.
