...
1. 검색 상자에 **TargetProcess**를 입력하고 결과 창에서 **TargetProcess**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![갤러리에서 TargetProcess 추가](./media/target-process-tutorial/tutorial_target-process_addfromgallery.png)
...
1. **[TargetProcess 테스트 사용자 만들기](#create-a-targetprocess-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 TargetProcess에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![SAML 기반 로그온](./media/target-process-tutorial/tutorial_target-process_samlbase.png)

1. **TargetProcess 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![TargetProcess 도메인 및 URL 섹션](./media/target-process-tutorial/tutorial_target-process_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![SAML 서명 인증서 섹션](./media/target-process-tutorial/tutorial_target-process_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![저장 단추](./media/target-process-tutorial/tutorial_general_400.png)

1. **TargetProcess 구성** 섹션에서 **TargetProcess 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![TargetProcess 구성 섹션](./media/target-process-tutorial/tutorial_target-process_configure.png) 
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/target-process-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![사용자 목록을 표시하려면](./media/target-process-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![추가 단추](./media/target-process-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![사용자 섹션](./media/target-process-tutorial/create_aaduser_04.png) 
...
1. 응용 프로그램 목록에서 **TargetProcess**를 선택합니다.

    ![앱 목록의 TargetProcess](./media/target-process-tutorial/tutorial_target-process_app.png) 
...
액세스 패널에서 TargetProcess 타일을 클릭하면 TargetProcess 응용 프로그램에 자동으로 로그온됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/active-directory-saas-access-panel-introduction.md)를 참조하세요.
