...
1. 검색 상자에 **SilkRoad Life Suite**를 입력하고 결과 패널에서 **SilkRoad Life Suite**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. 애플리케이션 목록에서 **SilkRoad Life Suite**를 선택합니다.
    ...
    ![응용 프로그램 목록의 SilkRoad Life Suite 링크](./media/silkroad-life-suite-tutorial/tutorial_silkroadlifesuite_app.png)  
