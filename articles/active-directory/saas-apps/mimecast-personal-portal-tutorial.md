...
* Mimecast Personal Portal이 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).
...
1. **관리** > **서비스** > **애플리케이션**으로 이동합니다.
    ...
    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/services.png)

1. **인증 프로필** 탭을 클릭합니다.
    
    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/authentication-profiles.png)

1. **새 인증 프로필** 탭을 클릭합니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/new-authenticatio-profile.png)

1. **설명** 텍스트 상자에 올바른 설명을 입력하고 **Mimecast Personal Portal에 SAML 인증 적용** 확인란을 선택합니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/selecting-personal-portal.png)

1. **Mimecast Personal Portal의 SAML 구성** 페이지에서 다음 단계를 수행합니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/sso-settings.png)
...
1. **관리** > **디렉터리** > **내부 디렉터리**로 이동합니다.
    ...
    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/internal-directories.png)

1. 아래에 도메인이 언급된 경우 도메인을 선택하고, 그렇지 않은 경우 **새 도메인**을 클릭하여 새 도메인을 만듭니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/domain-name.png)

1. **새 주소** 탭을 클릭합니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/new-address.png)

1. 다음 페이지에 필수 사용자 정보를 제공합니다.

    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/user-information.png)
    ...
    ![Mimecast Personal Portal 구성](./media/mimecast-personal-portal-tutorial/assign-role.png)
...
- [고급 표시 유형 및 컨트롤을 사용하여 Mimecast Personal Portal을 보호하는 방법](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
