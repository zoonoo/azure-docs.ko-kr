...
* Visibly는 **SP** 시작 SSO를 지원합니다.

* Visibly가 구성되면 세션 제어를 적용하여 조직의 중요한 데이터의 반출 및 반입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-visibly-from-the-gallery"></a>갤러리에서 Visibly 추가
...
Visibly에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Visibly** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On**을 선택합니다.
...
1. 탐색 메뉴에서 **설정** 옵션으로 이동합니다.
    ...
    ![구성](./media/visibly-tutorial/settings.png)

1. 설정 내에서 **통합**을 클릭합니다.

    ![구성](./media/visibly-tutorial/integrations.png)

1. **통합**에서 **SSO**를 선택합니다.

    ![구성](./media/visibly-tutorial/sso.png)

1. 다음 페이지에서 다음 단계를 수행합니다.

    ![구성](./media/visibly-tutorial/configuration.png)
...
액세스 패널에서 Visibly 타일을 클릭하면 SSO를 설정한 Visibly에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD로 Visibly 사용해 보기](https://aad.portal.azure.com/)
