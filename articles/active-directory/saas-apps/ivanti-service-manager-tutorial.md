...
액세스 패널에서 ISM(Ivanti Service Manager) 타일을 클릭하면 사용자가 SSO를 설정한 ISM(Ivanti Service Manager)에 자동으로 로그온되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
