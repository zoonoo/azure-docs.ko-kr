...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 &frankly 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 &frankly의 관련 사용자 간에 연결이 형성되어야 합니다.

&frankly에서 Azure AD의 **사용자 이름** 값을 **Username** 값으로 할당하여 링크 관계를 설정합니다.
...
4. **고급 URL 설정 표시**를 선택합니다. **SP** 시작 모드에서 애플리케이션을 구성하려면:
    ...
    **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://andfrankly.com/saml/okta/?saml_sso=<tenant id>`
    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 식별자, 로그인 및 회신 URL로 해당 값을 업데이트합니다. 이러한 값을 얻으려면 [&frankly 지원팀](mailto:help@andfrankly.com)에 문의하세요.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/andfrankly-tutorial/create_aaduser_01.png) 

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/andfrankly-tutorial/create_aaduser_02.png) 

3. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/andfrankly-tutorial/create_aaduser_03.png) 

4. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/andfrankly-tutorial/create_aaduser_04.png) 
...
이 섹션에서는 &frankly에서 Britta Simon이라는 사용자를 만듭니다. &frankly 플랫폼에 사용자를 추가하려면 [&frankly 지원팀](mailto:help@andfrankly.com)과 함께 작업하세요.
