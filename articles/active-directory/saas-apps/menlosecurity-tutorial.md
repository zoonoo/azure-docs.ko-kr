...
1. 검색 상자에 **Menlo Security**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/menlosecurity-tutorial/tutorial_menlosecurity_search.png)

1. 결과 창에서 **Menlo Security**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[Menlo Security 테스트 사용자 만들기](#creating-a-menlo-security-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Menlo Security에 만듭니다.
...
1. **Menlo Security 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Menlo Security 구성** 섹션에서 **Menlo Security 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID** 및 **SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. **Settings(설정)** 에서 **Authentication(인증)** 으로 이동하여 다음 작업을 수행합니다.
...
1. 응용 프로그램 목록에서 **Menlo Security**를 선택합니다.
