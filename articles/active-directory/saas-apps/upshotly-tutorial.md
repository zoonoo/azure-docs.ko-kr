...
## <a name="configure-and-test-azure-ad-single-sign-on-for-upshotly"></a>Upshotly에 대한 Azure AD Single Sign-On 구성 및 테스트
...
Upshotly에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. **[Upshotly SSO 구성](#configure-upshotly-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[Upshotly 테스트 사용자 만들기](#create-upshotly-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Upshotly에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Upshotly** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고, **Single Sign-On**을 선택합니다.
...
1. 다른 웹 브라우저 창에서 Upshotly 회사 사이트에 관리자 권한으로 로그인합니다.
...
이 섹션에서는 Fastly Edge Cloud에서 B.Simon이라는 사용자를 만듭니다.  [Upshotly 클라이언트 지원 팀](mailto:support@upshotly.com)과 협력하여 사용자를 Upshotly 플랫폼에 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

## <a name="test-sso"></a>SSO 테스트 

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Upshotly 타일을 클릭하면 SSO를 설정한 Upshotly에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD에서 Upshotly 사용해 보기](https://aad.portal.azure.com/)