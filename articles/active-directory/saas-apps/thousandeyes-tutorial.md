...
* ThousandEyes는 [**자동화된** 사용자 프로비전](./thousandeyes-provisioning-tutorial.md)을 지원합니다.
...
2. 위쪽의 메뉴에서 **설정** 을 클릭합니다.
    ...
    ![스크린샷은 설정이 선택된 ThousandEyes 사이트를 보여줍니다.](./media/thousandeyes-tutorial/ic790066.png "설정")

3. 페이지 맨 아래에 있는 **계정**

    ![스크린샷은 설정 메뉴에서 선택한 계정을 보여줍니다.](./media/thousandeyes-tutorial/ic790067.png "계정")
...
액세스 패널에서 ThousandEyes 타일을 클릭하면 SSO를 설정한 ThousandEyes에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
