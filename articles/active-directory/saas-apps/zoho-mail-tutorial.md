...
1. **사용자 세부 정보 \> 사용자 추가** 로 이동합니다.
    ...
    ![스크린샷은 사용자 세부 정보 및 사용자 추가가 선택된 Zoho Mail 사이트를 보여줍니다.](./media/zoho-mail-tutorial/ic789611.png "사용자 추가")

1. **사용자 추가** 대화 상자에서 다음 단계를 수행합니다.
   
    ![스크린샷은 설명된 값을 입력할 수 있는 사용자 추가 대화 상자를 보여줍니다.](./media/zoho-mail-tutorial/ic789612.png "사용자 추가")
...
액세스 패널에서 Zoho 타일을 클릭하면 SSO를 설정한 Zoho에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
