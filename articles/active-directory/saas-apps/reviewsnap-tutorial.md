...
1. 검색 상자에 **Reviewsnap**을 입력하고 결과 패널에서 **Reviewsnap**을 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **IDP** 시작 모드에서 응용 프로그램을 구성하려면 **Reviewsnap 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. 응용 프로그램 목록에서 **Reviewsnap**을 선택합니다.
