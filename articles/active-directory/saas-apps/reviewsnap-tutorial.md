...
4. 검색 상자에 **Reviewsnap**을 입력하고 결과 패널에서 **Reviewsnap**을 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Reviewsnap 테스트 사용자 만들기](#create-a-reviewsnap-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Reviewsnap에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Reviewsnap 응용 프로그램에서 Single Sign-On을 구성합니다.

**Reviewsnap에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Reviewsnap** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **IDP** 시작 모드에서 응용 프로그램을 구성하려면 **Reviewsnap 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
7. **Reviewsnap 구성** 섹션에서 **Reviewsnap 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Reviewsnap 구성](./media/reviewsnap-tutorial/tutorial_reviewsnap_configure.png) 

8. **Reviewsnap** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64), 로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 [Reviewsnap 지원 팀](mailto:support@reviewsnap.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
2. 응용 프로그램 목록에서 **Reviewsnap**을 선택합니다.

    ![응용 프로그램 목록의 Reviewsnap 링크](./media/reviewsnap-tutorial/tutorial_reviewsnap_app.png)  
...
액세스 패널에서 Reviewsnap 타일을 클릭하면 Reviewsnap 응용 프로그램에 자동으로 로그온됩니다.
