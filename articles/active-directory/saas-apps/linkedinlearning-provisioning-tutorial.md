...
![LinkedIn Learning 프로비저닝](./media/linkedinlearning-provisioning-tutorial/linkedin_1.PNG)

> 자동 라이선스 할당을 사용하는 경우 응용 프로그램 인스턴스 및 라이선스 유형을 메모해 두어야 합니다. 라이선스는 모든 라이선스가 취득될 때까지 선착순으로 할당됩니다.

![LinkedIn Learning 프로비저닝](./media/linkedinlearning-provisioning-tutorial/linkedin_2.PNG)
...
![LinkedIn Learning 프로비저닝](./media/linkedinlearning-provisioning-tutorial/linkedin_3.PNG)
...
![LinkedIn Learning 프로비저닝](./media/linkedinlearning-provisioning-tutorial/linkedin_4.PNG)
