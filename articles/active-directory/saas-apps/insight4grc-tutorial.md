...
4. 검색 상자에 **Insight4GRC**을 입력하고 결과 패널에서 **Insight4GRC**을 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Insight4GRC 테스트 사용자 만들기](#create-an-insight4grc-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Insight4GRC에 만듭니다.
...
3. **Insight4GRC 도메인 및 URL** 섹션에서 **IDP** 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
7. **Insight4GRC** 쪽에서 Single Sign-On을 구성하려면 복사된 **앱 페더레이션 메타데이터 URL**을 [Insight4GRC 지원 팀](mailto:support.ss@rsmuk.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
2. 응용 프로그램 목록에서 **Insight4GRC**를 선택합니다.
