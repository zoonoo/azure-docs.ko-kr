...
Azure AD와 SaaS(Software as a Service) 앱 연결에 대해 자세히 알아보려면 [SSO(Single Sign-On)란?](../manage-apps/what-is-single-sign-on.md)을 참조하세요.
...
내 앱 포털에서 ekarda 타일을 선택하면 SSO를 설정한 ekarda 사이트에 자동으로 로그인되어야 합니다. 내 앱 포털에 대한 자세한 내용은 [내 앱 포털 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
* [고급 표시 유형 및 컨트롤을 사용하여 ekarda를 보호하는 방법](/cloud-app-security/proxy-intro-aad)