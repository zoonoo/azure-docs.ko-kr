...
- 사용자가 해당 Azure AD 계정으로 Gra-Pe에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Gra-Pe 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Gra-Pe의 관련 사용자 간에 연결이 형성되어야 합니다.

Gra-Pe에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
3. **[Gra-Pe 테스트 사용자 만들기](#create-a-gra-pe-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Gra-Pe에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Gra-Pe** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 선택합니다.

    ![이미지](./media/grape-tutorial/b1_b2_select_sso.png)

2. **Single Sign-On 방법 선택** 대화 상자에서 **SAML** 모드에 대해 **선택**을 클릭하여 Single Sign-On을 사용하도록 설정합니다.

    ![이미지](./media/grape-tutorial/b1_b2_saml_sso.png)

3. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **기본 SAML 구성** 대화 상자를 엽니다.

    ![이미지](./media/grape-tutorial/b1-domains_and_urlsedit.png)
...
5. **SAML로 Single Sign-On 설정** 페이지의 **SAML 서명 인증서** 섹션에서 **다운로드**를 클릭하여 **인증서(Base64)** 를 컴퓨터에 다운로드하고 저장합니다.
    ...
    ![이미지](./media/grape-tutorial/tutorial_grape_certficate.png)
...
6. **Gra-Pe 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
    ...
    ![이미지](./media/grape-tutorial/d1_samlsonfigure.png) 

7. **Gra-Pe** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)** 및 복사한 **로그인 URL, Azure AD 식별자, 로그아웃 URL**을 [ 지원 팀](https://www.toppantravel.com/inquiry/)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory**, **사용자**를 차례로 선택하고 **모든 사용자**를 선택합니다.
    ...
    ![이미지](./media/grape-tutorial/d_users_and_groups.png)

2. 화면 위쪽에서 **새 사용자**를 선택합니다.

    ![이미지](./media/grape-tutorial/d_adduser.png)

3. 사용자 속성에서 다음 단계를 수행합니다.

    ![이미지](./media/grape-tutorial/d_userproperties.png)
...
3. 왼쪽 메뉴에서 **사용자 및 그룹**을 선택합니다.
    ...
    ![이미지](./media/grape-tutorial/d_leftpaneusers.png)

4. **추가** 단추를 선택하고 **할당 추가** 대화 상자에서 **사용자 및 그룹**을 선택합니다.

    ![이미지](./media/grape-tutorial/d_assign_user.png)
...
액세스 패널에서 Gra-Pe 타일을 클릭하면 Gra-Pe 응용 프로그램에 자동으로 로그온됩니다.
