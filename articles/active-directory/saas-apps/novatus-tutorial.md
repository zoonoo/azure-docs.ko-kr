...
4. 검색 상자에서 **Novatus**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/novatus-tutorial/tutorial_novatus_search.png)

5. 결과 패널에서 **Novatus**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Novatus 테스트 사용자 만들기](#creating-a-novatus-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Novatus에 만듭니다.
...
3. **Novatus 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Novatus 구성** 섹션에서 **Novatus 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/novatus-tutorial/tutorial_novatus_configure.png) 

7. 응용 프로그램에 대해 SSO를 구성하려면 [Novatus 지원 팀](mailto:jvinci@novatusinc.com)에 문의하세요. **다운로드한 인증서** 파일을 메일에 첨부하고 해당하는 쪽에 SSO를 설정하기 위해 Novatus 팀과 **메타데이터 URL**(**로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**)을 공유합니다.
...
액세스 패널에서 Novatus 타일을 클릭하면 Novatus 응용 프로그램에 자동으로 로그온됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../active-directory-saas-access-panel-introduction.md)를 참조하세요.
