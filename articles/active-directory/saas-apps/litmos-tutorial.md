...
## <a name="configure-and-test-azure-ad-single-sign-on-for-litmos"></a>Litmos용 Azure AD Single Sign-On 구성 및 테스트

**B.Simon** 이라는 테스트 사용자를 사용하여 Litmos에서 Azure AD SSO를 구성하고 테스트합니다. SSO가 작동하려면 Azure AD 사용자와 Litmos의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Litmos에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Litmos** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On** 을 선택합니다.
...
액세스 패널에서 Litmos 타일을 클릭하면 SSO를 설정한 Litmos에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure AD로 Litmos 사용해보기](https://aad.portal.azure.com/)
