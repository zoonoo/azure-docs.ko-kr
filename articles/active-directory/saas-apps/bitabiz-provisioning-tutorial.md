...
> [!TIP]
> [BitaBIZ Single Sign-On 자습서](BitaBIZ-tutorial.md)에서 제공하는 지침에 따라 SAML 기반 Single Sign-On을 BitaBIZ에 사용하도록 선택할 수도 있습니다. Single Sign-On과 자동 사용자 프로비저닝은 서로 보완적이지만, 별개로 구성할 수 있습니다.
