...
1. 검색 상자에 **Evernote**를 입력하고 결과 패널에서 **Evernote**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Evernote](./media/evernote-tutorial/tutorial_evernote_addfromgallery.png)
...
1. **[Evernote 테스트 사용자 만들기](#create-an-evernote-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Evernote에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Evernote 애플리케이션에서 Single Sign-On을 구성합니다.

**Evernote에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Evernote** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/evernote-tutorial/tutorial_evernote_samlbase.png)

1. **Evernote 도메인 및 URL** 섹션에서 IDP 시작 모드로 애플리케이션을 구성하려는 경우 다음 단계를 수행합니다.

    ![Evernote 도메인 및 URL Single Sign-On 정보](./media/evernote-tutorial/tutorial_evernote_url.png)

    **식별자** 텍스트 상자에 URL `https://www.evernote.com/saml2`을 입력합니다.

1. **SP** 시작 모드에서 애플리케이션을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.

    ![Evernote 도메인 및 URL Single Sign-On 정보](./media/evernote-tutorial/tutorial_evernote_url1.png)

    **로그온 URL** 텍스트 상자에 URL `https://www.evernote.com/Login.action`을 입력합니다.   

1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.

    ![인증서 다운로드 링크](./media/evernote-tutorial/tutorial_evernote_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/evernote-tutorial/tutorial_general_400.png)

1. **Evernote 구성** 섹션에서 **Evernote 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Evernote 구성](./media/evernote-tutorial/tutorial_evernote_configure.png) 

1. 다른 웹 브라우저 창에서 Evernote 회사 사이트에 관리자로 로그인합니다.

1. **'관리 콘솔'** 로 이동합니다.

    ![관리 콘솔](./media/evernote-tutorial/tutorial_evernote_adminconsole.png)

1. **'관리 콘솔'** 에서 **'보안'** 으로 이동하고 **'Single Sign-On'** 을 선택합니다.
...
1. 다음 값을 구성 합니다.
    ...
    b. Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL** 값을 **SAML HTTP 요청 URL** 텍스트 상자에 붙여 넣습니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/evernote-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/evernote-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/evernote-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/evernote-tutorial/create_aaduser_04.png)
...
1. **'관리 콘솔'** 에서 **'사용자 추가'** 로 이동합니다.

    ![테스트 사용자 추가](./media/evernote-tutorial/create_aaduser_0001.png)

1. **전자 메일** 텍스트 상자에서 **팀 멤버를 추가**하고 사용자 계정의 전자 메일 주소를 입력한 다음 **초대**를 클릭합니다.

    ![테스트 사용자 추가](./media/evernote-tutorial/create_aaduser_0002.png)
    
1. 초대를 보낸 후에 Azure Active Directory 계정 소유자는 초대를 수락하기 위한 전자 메일을 받게 됩니다.
...
1. 애플리케이션 목록에서 **Evernote**를 선택합니다.
    ...
    ![애플리케이션 목록의 Evernote 링크](./media/evernote-tutorial/tutorial_evernote_app.png)  
...
액세스 패널에서 Evernote 타일을 클릭하면 Evernote 애플리케이션에 로그인됩니다. 조직 계정으로 로그인하지만 개인 계정으로 로그인해야 합니다. 
