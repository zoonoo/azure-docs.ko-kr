...
4. **관리** 탭을 클릭하고 **플러그 인** 단추를 클릭해야 하는 **통합** 섹션으로 이동하여 로그인을 위한 새 플러그 인을 만듭니다.
    ...
    ![스크린샷은 플러그 인을 선택할 수 있는 통합 페이지를 보여줍니다.](./media/velpicsaml-tutorial/velpic_1.png)

5. **‘플로그 인 추가’** 단추를 클릭합니다.
    
    ![스크린샷은 선택된 플러그 인 추가 단추를 보여줍니다.](./media/velpicsaml-tutorial/velpic_2.png)

6. 플러그 인 추가 페이지에서 **SAML** 타일을 클릭합니다.
    
    ![스크린샷은 플러그 인 추가 페이지에서 선택한 SAML을 보여줍니다.](./media/velpicsaml-tutorial/velpic_3.png)

7. 새 SAML 플러그 인의 이름을 입력하고 **'추가'** 단추를 클릭합니다.

    ![스크린샷은 Azure AD가 입력된 새 SAML 플러그 인 추가 대화 상자를 보여줍니다.](./media/velpicsaml-tutorial/velpic_4.png)

8. 세부 정보를 다음과 같이 입력합니다.

    ![스크린샷은 설명된 값을 입력할 수 있는 Azure AD 페이지를 보여줍니다.](./media/velpicsaml-tutorial/velpic_5.png)
...
1. 액세스 패널에서 Velpic SAML 타일을 클릭할 때 Velpic SAML 애플리케이션의 로그인 페이지를 가져와야 합니다. 로그인 페이지에 **'Azure AD를 사용하여 로그인'** 단추가 표시됩니다.
    ...
    ![스크린샷은 Azure AD를 사용하여 로그인이 선택된 학습 포털을 보여줍니다.](./media/velpicsaml-tutorial/velpic_6.png)
