...
1. 검색 상자에 **SmarterU**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/smarteru-tutorial/tutorial_smarteru_search.png)

1. 결과 창에서 **SmarterU**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[SmarterU 테스트 사용자 만들기](#creating-a-smarteru-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 SmarterU에 만듭니다.
...
1. **SmarterU 도메인 및 URL** 섹션에서 다음 단계를 수행합니다. 
...
1. 응용 프로그램 목록에서 **SmarterU**를 선택합니다.
