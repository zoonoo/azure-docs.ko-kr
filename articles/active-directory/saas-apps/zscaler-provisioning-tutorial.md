...
3. Zscaler를 추가 하려면 클릭 합니다 **새 응용 프로그램** 대화 상자의 위쪽 단추입니다.

    ![새 애플리케이션 단추][3]

4. 검색 상자에 **Zscaler**를 입력합니다.

    ![Zscaler에 프로 비전](./media/zscaler-provisioning-tutorial/app-search.png)

5. 결과 패널에서 선택 **Zscaler**를 클릭 하 고는 **추가** Zscaler SaaS 응용 프로그램 목록에 추가 하려면 단추입니다.

    ![Zscaler에 프로 비전](./media/zscaler-provisioning-tutorial/app-search-results.png)

    ![Zscaler에 프로 비전](./media/zscaler-provisioning-tutorial/app-creation.png)
...
2. SaaS 응용 프로그램 목록에서 Zscaler를 선택 합니다.

    ![Zscaler에 프로 비전](./media/zscaler-provisioning-tutorial/app-instance-search.png)
