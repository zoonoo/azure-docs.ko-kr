...
- 사용자가 해당 Azure AD 계정으로 ThirdLight에 자동으로 로그온(Single Sign-On)되도록 설정할 수 있습니다.
...
4. 검색 상자에 **ThirdLight**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/tutorial_thirdlight_search.png)

5. 결과 창에서 **ThirdLight**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/tutorial_thirdlight_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>Azure AD Single Sign-on 구성 및 테스트
이 섹션에서는 "Britta Simon"이라는 테스트 사용자를 기반으로 ThirdLight에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 ThirdLight 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 ThirdLight의 관련 사용자 간에 연결 관계가 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 ThirdLight의 **Username** 값으로 할당하여 설정합니다.

ThirdLight에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Configuring Azure AD Single Sign-On](#configuring-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
3. **[ThirdLight 테스트 사용자 만들기](#creating-a-thirdlight-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 ThirdLight에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 ThirdLight 응용 프로그램에서 Single Sign-On을 구성합니다.

**ThirdLight에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **ThirdLight** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **ThirdLight 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Configure Single Sign-On](./media/thirdlight-tutorial/tutorial_thirdlight_url.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<subdomain>.thirdlight.com/`

    나. **식별자** 텍스트 상자에서 `https://<subdomain>.thirdlight.com/saml/sp` 패턴을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 실제 로그온 URL 및 식별자로 값을 업데이트합니다. 이러한 값을 얻으려면 [ThirdLight 클라이언트 지원 팀](https://www.thirdlight.com/support)에 문의하세요. 
...
6. 다른 웹 브라우저 창에서 ThirdLight 회사 사이트에 관리자로 로그인합니다.

7. **구성 \> 시스템 관리**로 이동하고 **SAML2**를 클릭합니다.
   
    ![시스템 관리](./media/thirdlight-tutorial/ic805843.png "시스템 관리")

8. SAML2 구성 섹션에서 다음 단계를 수행합니다.
   
    ![SAML Single Sign-On](./media/thirdlight-tutorial/ic805844.png "SAML Single Sign-On")   

     a. **SAML2 Single Sign-On 사용**을 선택합니다.
 
     나. **IdP 메타데이터에 대한 원본**으로 **XML에서 IdP 메타데이터 로드**를 선택합니다.
 
     다. 다운로드한 메타데이터 파일을 열고 내용을 복사한 다음 **IdP 메타데이터 XML** 텍스트 상자에 붙여 넣습니다. 
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/create_aaduser_01.png) 

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/create_aaduser_02.png) 

3. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/create_aaduser_03.png) 

4. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/thirdlight-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-thirdlight-test-user"></a>ThirdLight 테스트 사용자 만들기
...
**Britta Simon을 ThirdLight에 할당하려면 다음 단계를 수행합니다.**

1. Azure Portal에서 응용 프로그램 보기를 연 다음 디렉터리 보기로 이동하고 **엔터프라이즈 응용 프로그램**으로 이동한 후 **모든 응용 프로그램**을 클릭합니다.

    ![사용자 할당][201] 

2. 응용 프로그램 목록에서 **ThirdLight**를 선택합니다.
...
액세스 패널에서 ThirdLight 타일을 클릭하면 ThirdLight 응용 프로그램에 자동으로 로그온됩니다.
