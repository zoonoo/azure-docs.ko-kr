...
1. 검색 상자에 **Bambu by Sprout Social**을 입력합니다.
...
1. **[Bambu by Sprout Social 테스트 사용자 만들기](#creating-a-bambu-by-sprout-social-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Bambu by Sprout Social에 만듭니다.
...
1. **Bambu by Sprout Social 도메인 및 URL** 섹션에서 앱이 Azure와 이미 사전 통합되었으므로 사용자는 아무 단계도 수행할 필요가 없습니다. 
...
1. **Bambu by Sprout Social 구성** 섹션에서 **Bambu by Sprout Social 구성**을 클릭하여 **로그인 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/bambubysproutsocial-tutorial/tutorial_bambubysproutsocial_configure.png) 

1. **Bambu by Sprout Social** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML** 및 **SAML Single Sign-On 서비스 URL**을 [Bambu by Sprout Social 지원](mailto:support@getbambu.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
