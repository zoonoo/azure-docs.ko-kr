...
1. 결과 패널에서 **CloudPassage**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 CloudPassage 애플리케이션에서 Single Sign-On을 구성합니다.

**CloudPassage에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **CloudPassage** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
1. CloudPassage 애플리케이션은 특정 서식에서 SAML 어설션을 예상하며 이는 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가합니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
액세스 패널에서 CloudPassage 타일을 클릭하면 CloudPassage 애플리케이션에 자동으로 로그온됩니다.
