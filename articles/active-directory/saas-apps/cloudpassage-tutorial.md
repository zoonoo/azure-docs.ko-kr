...
1. 검색 상자에 **CloudPassage**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/cloudpassage-tutorial/tutorial_cloudpassage_search.png)

1. 결과 패널에서 **CloudPassage**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[CloudPassage 테스트 사용자 만들기](#creating-a-cloudpassage-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 CloudPassage에 만듭니다.
...
1. **CloudPassage 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. CloudPassage 응용 프로그램은 특정 서식에서 SAML 어설션을 예상하며 이는 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가합니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
1. **CloudPassage 구성** 섹션에서 **CloudPassage 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. 응용 프로그램 목록에서 **CloudPassage**를 선택합니다.
