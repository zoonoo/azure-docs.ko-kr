...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Way We Do 애플리케이션에서 Single Sign-On을 구성합니다.

**Way We Do에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Way We Do** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Way We Do 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<SUBDOMAIN>.waywedo.com` 패턴을 사용하여 URL을 입력합니다.
...
2. 애플리케이션 목록에서 **Way We Do**를 선택합니다.
    ...
    ![애플리케이션 목록의 Way We Do 연결](./media/waywedo-tutorial/tutorial_waywedo_app.png)  
...
액세스 패널에서 Way We Do 타일을 클릭하면 Way We Do 애플리케이션에 자동으로 로그온됩니다.
