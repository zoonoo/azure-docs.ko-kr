...
1. **[DATABASICS 테스트 사용자 만들기](#create-a-databasics-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 DATABASICS에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/databasics-tutorial/tutorial_databasics_samlbase.png)

1. **DATABASICS 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![DATABASICS 도메인 및 URL Single Sign-On 정보](./media/databasics-tutorial/tutorial_databasics_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/databasics-tutorial/tutorial_databasics_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/databasics-tutorial/tutorial_general_400.png)

1. DATABASICS 쪽에서 Single Sign-On을 구성하려면 아래 URL을 사용하여 양식을 작성하세요. 양식을 제출하시면 [DATABASICS 클라이언트 지원 팀](https://www.data-basics.com/support/)에서 연락을 드릴 것입니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/databasics-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/databasics-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/databasics-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/databasics-tutorial/create_aaduser_04.png)
