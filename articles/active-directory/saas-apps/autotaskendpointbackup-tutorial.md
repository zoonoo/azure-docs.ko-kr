...
* 사용자가 Azure AD 계정으로 Autotask Endpoint Backup에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
* Autotask Endpoint Backup Single Sign-On이 설정된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Autotask Endpoint Backup은 **IDP** 시작 SSO를 지원합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Autotask Endpoint Backup의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Autotask Endpoint Backup에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Autotask Endpoint Backup Single Sign-On 구성](#configure-autotask-endpoint-backup-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Autotask Endpoint Backup 테스트 사용자 만들기](#create-autotask-endpoint-backup-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 해당 사용자를 Autotask Endpoint Backup에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Autotask Endpoint Backup** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **SAML로 Single Sign-On 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    ![Autotask Endpoint Backup 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
2. 애플리케이션 목록에서 **Autotask Endpoint Backup**을 선택합니다.

    ![애플리케이션 목록에서 Autotask Endpoint Backup 연결](common/all-applications.png)
...
이 섹션에서는 Autotask Endpoint Backup에서 Britta Simon이라는 사용자를 만듭니다.  [Autotask Endpoint Backup 지원 팀](https://backup.autotask.net/help/Content/0_HOME/Support_for_End_Clients.htm)과 협력하여 Autotask Endpoint Backup 플랫폼에서 사용자를 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

### <a name="test-single-sign-on"></a>Single Sign-On 테스트

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Autotask Endpoint Backup 타일을 클릭하면 SSO를 설정한 Autotask Endpoint Backup에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
