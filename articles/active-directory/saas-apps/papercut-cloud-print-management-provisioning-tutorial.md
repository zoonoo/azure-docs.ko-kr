---
title: '자습서: Azure Active Directory을 사용 하 여 자동 사용자 프로 비전을 위한 용지 자르기 Pocket/Hive (클라우드 인쇄 관리) 구성 Microsoft Docs'
description: Azure AD에서 사용자 계정을 자동으로 프로 비전 및 프로 비전 해제 하는 방법에 대해 알아봅니다 클라우드 인쇄 관리 (포켓/Hive).
...
ms.locfileid: "96031269"
---
# <a name="tutorial-configure-papercut-cloud-print-management-pockethive-for-automatic-user-provisioning"></a>자습서: 자동 사용자 프로 비전을 위한 용지 자르기 (Pocket/Hive) 클라우드 인쇄 관리 구성

이 자습서에서는 자동 사용자 프로 비전을 구성 하기 위해 용지 잘라내기 (포켓/Hive) 및 Azure Active Directory (Azure AD)에서 수행 해야 하는 단계를 설명 합니다. 구성 된 경우 Azure AD는 사용자와 그룹을 자동으로 프로 비전 하 고 프로 비전 하 여 Azure AD 프로 비전 서비스를 사용 하 여 [클라우드 인쇄 관리를 잘라냅니다](https://www.papercut.com/products/papercut-pocket/) . 이 서비스의 기능, 작동 방법 및 질문과 대답에 대한 중요한 내용은 [Azure Active Directory를 사용하여 SaaS 애플리케이션의 사용자를 자동으로 프로비저닝 및 프로비저닝 해제](../manage-apps/user-provisioning.md)를 참조하세요.

## <a name="capabilities-supported"></a>지원되는 기능

> [!div class="checklist"]
> * 용지에서 사용자 만들기 클라우드 인쇄 관리 (포켓/Hive)
> * 더 이상 액세스 하지 않아도 되는 경우에는 용지에서 사용자 제거 (포켓/Hive)
> * Azure AD와 용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive) 간에 사용자 특성을 동기화 상태로 유지
...
* 용지에 있는 사용자 계정, 관리자 권한으로 클라우드 인쇄 관리 (포켓/Hive) 잘라내기
...
3. [AZURE AD와 용지 잘라내기 클라우드 인쇄 관리 간에 매핑할](https://docs.microsoft.com/azure/active-directory/manage-apps/customize-application-attributes)데이터를 결정 합니다.

## <a name="step-2-configure-papercut-cloud-print-management-to-support-provisioning-with-azure-ad"></a>2단계. Azure AD로 프로 비전을 지원 하도록 용지 잘림 클라우드 인쇄 관리 구성
...
4. 설치 되 면 추가 정보 페이지에 **테 넌 트 URL** 및 **암호 토큰이** 표시 됩니다. 이러한 값은 \* \* Azure Portal의 용지 잘라내기 (포켓/Hive) 응용 프로그램의 프로 비전 탭에 있는 테 넌 트 URL 필드 및 비밀 토큰 필드에 입력 됩니다.



## <a name="step-3-add-papercut-cloud-print-management-pockethive-from-the-azure-ad-application-gallery"></a>3단계: Azure AD 응용 프로그램 갤러리에서 용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive) 추가

Azure AD 응용 프로그램 갤러리에서 용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive)를 추가 하 여 용지에 대 한 프로 비전 관리를 시작 합니다. 포켓/Hive (클라우드 인쇄 관리). 이전에 설치 된 경우에는 SSO 용 용지 잘라내기 (Pocket/Hive)를 사용 하 여 동일한 응용 프로그램을 사용할 수 있습니다. 그러나 처음 통합을 테스트하는 경우 별도의 앱을 만드는 것이 좋습니다. [여기](https://docs.microsoft.com/azure/active-directory/manage-apps/add-gallery-app)를 클릭하여 갤러리에서 애플리케이션을 추가하는 방법에 대해 자세히 알아봅니다.
...
## <a name="step-5-configure-automatic-user-provisioning-to-papercut-cloud-print-management-pockethive"></a>5단계. 자동 사용자 프로 비전을 사용 하 여 용지 자르기 클라우드 인쇄 관리 (포켓/Hive)
...
2. 응용 프로그램 목록에서 **용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive)** 를 선택 합니다.

   ![응용 프로그램 목록의 용지 잘라내기 클라우드 인쇄 관리 링크](common/all-applications.png)
...
5. **관리자 자격 증명** 섹션에서 용지를 입력 하 여 포켓/Hive (클라우드 인쇄 관리) 테 넌 트 URL 및 비밀 토큰을 입력 합니다. **연결 테스트** 를 클릭 하 여 Azure AD가 용지 잘라내기 클라우드 인쇄 관리에 연결할 수 있는지 확인 합니다. 연결에 실패 하면 용지 잘라내기 클라우드 인쇄 관리 계정에 관리자 권한이 있는지 확인 하 고 다시 시도 하세요.
...
11. 용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive)에 대해 Azure AD 프로 비전 서비스를 사용 하도록 **설정 하려면 설정** 섹션에서 **프로 비전 상태** 를 **켜기** 로 변경 합니다.

    ![프로비전 상태 켜기로 전환](common/provisioning-toggle-on.png)

12. **설정** 섹션의 **범위** 에서 원하는 값을 선택 하 여 용지 잘라내기 클라우드 인쇄 관리 (포켓/Hive)에 프로 비전 하려는 사용자 및/또는 그룹을 정의 합니다.
