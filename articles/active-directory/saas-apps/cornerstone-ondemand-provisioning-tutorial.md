...
**Azure AD 응용 프로그램 갤러리에서 Cornerstone OnDemand를 추가 하려면 다음 단계를 수행 합니다.**
...
1. 에 로그인 합니다 [Azure portal](https://portal.azure.com) 선택한 **엔터프라이즈 응용 프로그램**를 선택 **모든 응용 프로그램**를 선택 하 고 **Cornerstone OnDemand**.
