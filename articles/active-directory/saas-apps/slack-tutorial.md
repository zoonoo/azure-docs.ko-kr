...
1. Slack 응용 프로그램에는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
1. **SAML 인증 설정** 대화 상자에서 다음 단계를 수행합니다.
    ...
    a.  Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL** 값을 **SAML 2.0 엔드포인트(HTTP)** 텍스트 상자에 붙여 넣습니다.
