...
* Microsoft 내 앱을 사용할 수 있습니다. 내 앱에서 Slack 타일을 클릭하면 Slack 로그온 URL로 리디렉션됩니다. 내 앱에 대한 자세한 내용은 [내 앱 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
