...
1. **기본 SAML 구성** 섹션에서 다음 필드에 대한 값을 입력합니다.
    ...
    a. **로그온 URL** 텍스트 상자에서 `https://<your Slack company>.slack.com` 패턴을 사용하는 URL을 입력합니다.
...
2. 왼쪽에 있는 여유 회사 이름으로 이동(이 경우 **Microsoft Azure AD** 로 설정됨)한 후, 다음 스크린샷에 표시된 것처럼 **Team 설정**으로 이동합니다.
