...
1. 검색 상자에 **Printix** 를 입력합니다.
    ...
    ![스크린샷은 갤러리에서 추가 대화 상자에서 Printix 검색을 보여 줍니다.](./media/printix-tutorial/tutorial_printix_search.png)

1. 결과 패널에서 **Printix** 를 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![스크린샷은 선택된 Printix 옵션을 보여 줍니다.](./media/printix-tutorial/tutorial_printix_addfromgallery.png)
...
1. **Single Sign-On** 대화 상자에서 **모드** 를 **SAML 기반 로그온** 으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![스크린샷은 선택한 SAML 기반 로그온 모드를 보여 줍니다.](./media/printix-tutorial/tutorial_printix_samlbase.png)

1. **Printix 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![스크린샷은 Printix 도메인 및 URL 섹션을 보여 줍니다. 여기서 로그온에 대해 URL을 지정할 수 있습니다.](./media/printix-tutorial/tutorial_printix_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML** 을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![스크린샷은 인증서를 다운로드할 수 있는 SAML 서명 인증서 창을 보여줍니다.](./media/printix-tutorial/tutorial_printix_certificate.png) 
...
1. 위쪽의 메뉴에서 오른쪽 위 모서리에 있는 아이콘을 클릭하고 "**인증**"을 선택합니다.
    ...
    ![스크린샷은 메뉴에서 선택한 인증을 보여 줍니다.](./media/printix-tutorial/tutorial_printix_06.png)

1. **설정** 탭에서 **Azure/Office 365 인증 사용** 을 선택합니다.
   
    ![스크린샷은 Azure/Office 365 인증 사용을 선택할 수 있는 Printix.net 페이지를 표시합니다.](./media/printix-tutorial/tutorial_printix_07.png)
...
1. **Azure** 탭에서 "**페더레이션 메타데이터 문서**"의 텍스트 상자에 페더레이션 메타데이터 URL을 입력합니다. 
    ...
    ![스크린샷은 페더레이션 메타데이터 문서를 지정할 수 있는 Printix.net 페이지를 표시합니다.](./media/printix-tutorial/tutorial_printix_08.png)
...
1. "**테스트**"단추를 클릭한 후 테스트가 성공적이면 "**확인**" 단추를 클릭합니다.
    ...
    ![스크린샷은 테스트의 결과를 보여 줍니다.](./media/printix-tutorial/tutorial_printix_09.png)
...
1. **Azure Portal** 의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![스크린샷은 만들 이름 및 사용자 이름을 보여 줍니다.](./media/printix-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹** 으로 이동한 후 **모든 사용자** 를 클릭합니다.
    
    ![스크린샷은 Azure Portal에서 Azure AD 아이콘을 보여 줍니다.](./media/printix-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가** 를 클릭합니다.
 
    ![스크린샷은 모든 사용자가 선택된 관리 메뉴에서 선택한 사용자 및 그룹을 보여 줍니다.](./media/printix-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![스크린샷은 설명된 값을 입력할 수 있는 사용자 대화 상자를 보여 줍니다.](./media/printix-tutorial/create_aaduser_04.png) 
...
![스크린샷은 기본 액세스 권한이 있는 사용자를 보여 줍니다.][200] 

**Britta Simon을 Printix에 할당하려면 다음 단계를 수행합니다.**

1. Azure Portal에서 애플리케이션 보기를 연 다음 디렉터리 보기로 이동하고 **엔터프라이즈 애플리케이션** 으로 이동한 후 **모든 애플리케이션** 을 클릭합니다.

    ![스크린샷은 모든 애플리케이션이 선택된 관리 아래에서 선택한 엔터프라이즈 애플리케이션을 보여 줍니다.][201] 

1. 애플리케이션 목록에서 **Printix** 를 선택합니다.

    ![스크린샷은 Printix를 선택할 수 있는 애플리케이션 목록을 보여 줍니다.](./media/printix-tutorial/tutorial_printix_app.png) 

1. 왼쪽 메뉴에서 **사용자 및 그룹** 을 클릭합니다.

    ![스크린샷은 관리 메뉴에서 선택한 사용자 및 그룹을 보여 줍니다.][202] 

1. **추가** 단추를 클릭합니다. 그런 후 **할당 추가** 대화 상자에서 **사용자 및 그룹** 을 선택합니다.

    ![스크린샷은 사용자 및 그룹을 선택할 수 있는 추가 단추 및 할당 추가 페이지를 보여 줍니다.][203]
