...
* Comeet Recruiting Software는 **SP 및 IDP** 시작 SSO를 지원합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Comeet Recruiting Software의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Comeet Recruiting Software에서 Azure AD Single Sign-on을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Comeet Recruiting Software Single Sign-On 구성](#configure-comeet-recruiting-software-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Comeet Recruiting Software 테스트 사용자 만들기](#create-comeet-recruiting-software-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Comeet Recruiting Software에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Comeet Recruiting Software** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Comeet Recruiting Software 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.
    ...
    ![Comeet Recruiting Software 도메인 및 URL Single Sign-On 정보](common/metadata-upload-additional-signon.png)

    **로그온 URL** 텍스트 상자에 `https://app.comeet.co` URL을 입력합니다.

5. Comeet Recruiting Software 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성** 대화 상자를 엽니다.
...
### <a name="configure-comeet-recruiting-software-single-sign-on"></a>Comeet Recruiting Software Single Sign-On 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**을 선택하고, **모든 애플리케이션**을 선택한 다음, **Comeet Recruiting Software**를 선택합니다.
...
액세스 패널에서 Comeet Recruiting Software 타일을 클릭하면 SSO를 설정한 Comeet Recruiting Software에 자동으로 로그온됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
