...
1. **[Pingboard 테스트 사용자 만들기](#create-a-pingboard-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Pingboard에 만듭니다.
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 XML 파일을 저장합니다.
    ...
    ![Pingboard 메타데이터 xml](./media/pingboard-tutorial/tutorial_pingboard_certificate.png)

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/pingboard-tutorial/tutorial_general_400.png)

1. Pingboard 쪽에서 SSO를 구성하려면 새 브라우저 창을 열고 Pingboard 계정에 로그인합니다. Single Sign-On을 설정하려면 Pingboard 관리자여야 합니다.

1. 상단 메뉴에서 **앱 > 통합**을 선택합니다.

    ![Configure Single Sign-On](./media/pingboard-tutorial/Pingboard_integration.png)

1. **통합** 페이지에서 **"Azure Active Directory"** 타일을 찾아 클릭합니다.

    ![Pingboard Single Sign-on 통합](./media/pingboard-tutorial/Pingboard_aad.png)

1. 다음에 나오는 모달에서 **"구성"** 을 클릭합니다.

    ![Pingboard 구성 단추](./media/pingboard-tutorial/Pingboard_configure.png)

1. 다음 페이지에서 "Azure SSO 통합을 사용합니다."라는 메시지를 확인할 수 있습니다. 다운로드한 메타데이터 XML 파일을 메모장에서 열고 **IDP 메타데이터**에 콘텐츠를 붙여 넣습니다.

    ![Pingboard SSO 구성 화면](./media/pingboard-tutorial/Pingboard_sso_configure.png)

1. 파일 유효성을 검사하여 모든 것이 올바르면 지금부터 Single Sign-on이 사용됩니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/pingboard-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/pingboard-tutorial/create_aaduser_02.png)

1. 대화 상자 위쪽에서 **추가**를 클릭하여 **사용자** 대화 상자를 엽니다.

    ![추가 단추](./media/pingboard-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/pingboard-tutorial/create_aaduser_04.png)
...
액세스 패널에서 Pingboard 타일을 클릭하면 Pingboard 애플리케이션에 자동으로 로그온됩니다.
