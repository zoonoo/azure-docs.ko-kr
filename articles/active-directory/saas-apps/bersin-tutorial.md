...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Bersin 도메인 및 URL Single Sign-On 정보](common/idp-identifier-relay.png)

    a. **식별자** 텍스트 상자에서 다음 패턴을 사용하여 URL을 입력합니다. `https://www.bersin.com/shibboleth`

    b. **추가 URL 설정**을 클릭합니다.

    다. **릴레이 상태** 텍스트 상자에 다음 패턴을 사용하는 URL을 입력합니다. `https://www.bersin.com/secure/`

5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.

    ![Bersin 도메인 및 URL Single Sign-On 정보](common/metadata-upload-additional-signon.png)
...
액세스 패널에서 Bersin 타일을 클릭하면 SSO를 설정한 Bersin에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
