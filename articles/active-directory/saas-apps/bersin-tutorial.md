...
1. 검색 상자에 **Bersin**을 입력하고 결과 패널에서 **Bersin**을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
1. **[Bersin 테스트 사용자 만들기](#create-a-bersin-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Bersin에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Bersin 애플리케이션에서 Single Sign-On을 구성합니다.

**Bersin에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Bersin** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Bersin 도메인 및 URL** 섹션에서 **IDP** 시작 모드로 애플리케이션을 구성하려는 경우 다음 단계를 수행합니다.
    ...
    b. **고급 URL 설정 표시**를 선택하고 **릴레이 상태** 텍스트 상자에 다음 URL을 입력합니다. `https://www.bersin.com/secure/`
...
1. **Bersin** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Bersin 지원 팀](mailto:USBersinServiceClient@deloitte.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. 애플리케이션 목록에서 **Bersin**을 선택합니다.

    ![애플리케이션 목록의 Bersin 링크](./media/bersin-tutorial/tutorial_bersin_app.png)  
...
액세스 패널에서 Bersin 타일을 클릭하면 Bersin 애플리케이션에 자동으로 로그온됩니다.
