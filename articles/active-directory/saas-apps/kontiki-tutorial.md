...
1. 검색 상자에 **Kontiki**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/kontiki-tutorial/tutorial_kontiki_search.png)

1. 결과 패널에서 **Kontiki**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
1. **[Kontiki 테스트 사용자 만들기](#creating-a-kontiki-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Kontiki에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Kontiki 애플리케이션에서 Single Sign-On을 구성합니다.

**Kontiki에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Kontiki** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Kontiki 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    > [!NOTE] 
    > 이 값은 실제 값이 아닙니다. 이 값을 실제 로그온 URL로 업데이트합니다. 값을 얻으려면 [Kontiki 클라이언트 지원 팀](https://customersupport.kontiki.com/enterprise/contactsupport.html)에 문의하세요. 
...
1. **Kontiki** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Kontiki 지원 팀](https://customersupport.kontiki.com/enterprise/contactsupport.html)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
액세스 패널에서 Kontiki 타일을 클릭하면 Kontiki 애플리케이션에 자동으로 로그온됩니다.
