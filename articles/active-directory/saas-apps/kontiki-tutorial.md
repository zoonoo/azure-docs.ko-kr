...
1. **Kontiki** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Kontiki 지원 팀](http://customersupport.kontiki.com/enterprise/contactsupport.html)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
