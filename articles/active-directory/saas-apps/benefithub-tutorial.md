...
1. **[BenefitHub 테스트 사용자 만들기](#creating-a-benefithub-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 BenefitHub에 만듭니다.
...
1. **BenefitHub 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **BenefitHub** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [BenefitHub 지원팀](https://www.benefithub.com/Home/ContactUs)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/benefithub-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/benefithub-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/benefithub-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/benefithub-tutorial/create_aaduser_04.png) 
...
이 섹션에서는 BenefitHub에서 Britta Simon이라는 사용자를 만듭니다. BenefitHub 플랫폼에 사용자를 추가하려면 [BenefitHub 지원 팀](https://www.benefithub.com/Home/ContactUs)에 문의하세요.  Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다. 
