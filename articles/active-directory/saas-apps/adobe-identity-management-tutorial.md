...
이 섹션에서는 Adobe Identity Management에 B.Simon이라는 사용자를 만듭니다. Adobe Identity Management 플랫폼에 사용자를 추가하려면 [Adobe Identity Management 지원 팀](mailto:identity@adobe.com)에 문의하세요. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.
