...
## <a name="configure-and-test-azure-ad-single-sign-on-for-adobe-identity-management"></a>Adobe Identity Management에 대한 Azure AD Single Sign-On 구성 및 테스트
...
Adobe Identity Management에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Adobe Identity Management** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 후 **Single Sign-On**을 선택합니다.
...
**Adobe Identity Management** 쪽에서 Single Sign-On을 구성하려면 Azure Portal에서 다운로드한 **페더레이션 메타데이터 XML**과 적절히 복사한 URL을 [Adobe Identity Management 지원 팀](mailto:identity@adobe.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.

### <a name="create-adobe-identity-management-test-user"></a>Adobe Identity Management 테스트 사용자 만들기

이 섹션에서는 Adobe Identity Management에 B.Simon이라는 사용자를 만듭니다. Adobe Identity Management 플랫폼에서 사용자를 추가하려면  [Adobe Identity Management 지원 팀](mailto:identity@adobe.com)에 문의하세요. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.

## <a name="test-sso"></a>SSO 테스트 

이 섹션에서는 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트합니다.

액세스 패널에서 Adobe Identity Management 타일을 클릭하면 SSO를 설정한 Adobe Identity Management에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD와 함께 Adobe Identity Management 사용해 보기](https://aad.portal.azure.com/)
