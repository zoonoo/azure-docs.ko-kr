...
4. 검색 상자에 **Mercell**을 입력하고 결과 패널에서 **Mercell**을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
    ...
    ![결과 목록의 Mercell](./media/mercell-tutorial/tutorial_mercell_addfromgallery.png)
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Mercell 애플리케이션에서 Single Sign-On을 구성합니다.

**Mercell에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Mercell** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.

    ![Single Sign-On 대화 상자](./media/mercell-tutorial/tutorial_mercell_samlbase.png)

3. **Mercell 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Mercell 도메인 및 URL Single Sign-On 정보](./media/mercell-tutorial/tutorial_mercell_url.png)
...
5. **저장** 단추를 클릭합니다.
    ...
    ![Single Sign-On 구성 저장 단추](./media/mercell-tutorial/tutorial_general_400.png)
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/mercell-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/mercell-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/mercell-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/mercell-tutorial/create_aaduser_04.png)
...
>[!Note]
>사용자를 수동으로 만들어야 하는 경우  [Mercell 지원 팀](mailto:webmaster@mercell.com)에 문의해야 합니다.
...
2. 애플리케이션 목록에서 **Mercell**을 선택합니다.
    ...
    ![애플리케이션 목록의 Mercell 링크](./media/mercell-tutorial/tutorial_mercell_app.png)  
...
액세스 패널에서 Mercell 타일을 클릭하면 Mercell 애플리케이션에 자동으로 로그온됩니다.
