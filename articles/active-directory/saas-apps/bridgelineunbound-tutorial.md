...
4. 검색 상자에 **Bridgeline Unbound**를 입력하고 결과 패널에서 **Bridgeline Unbound**를 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Bridgeline Unbound 응용 프로그램에서 Single Sign-On을 구성합니다.

**Bridgeline Unbound에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Bridgeline Unbound** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
2. 응용 프로그램 목록에서 **Bridgeline Unbound**를 선택합니다.

    ![응용 프로그램 목록의 Bridgeline Unbound 링크](./media/bridgelineunbound-tutorial/tutorial_bridgelineunbound_app.png)  
...
액세스 패널에서 Bridgeline Unbound 타일을 클릭하면 Bridgeline Unbound 응용 프로그램에 자동으로 로그온되어야 합니다.
