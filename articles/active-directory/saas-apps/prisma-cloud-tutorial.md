...
* Prisma Cloud SSO는 **IDP** 시작 SSO를 지원합니다.

* Prisma Cloud SSO는 **Just In Time** 사용자 프로비저닝을 지원합니다.

* Prisma Cloud SSO를 구성한 후에는 세션 컨트롤을 적용하여 조직의 중요한 데이터의 반출 및 침입을 실시간으로 보호할 수 있습니다. 세션 제어는 조건부 액세스에서 확장됩니다. [Microsoft Cloud App Security를 사용하여 세션 제어를 적용하는 방법을 알아봅니다](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app).

## <a name="adding-prisma-cloud-sso-from-the-gallery"></a>갤러리에서 Prisma Cloud SSO 추가
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-prisma-cloud-sso"></a>Prisma Cloud SSO용 Azure AD Single Sign-On 구성 및 테스트
...
Prisma Cloud SSO에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Prisma Cloud SSO** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 다음, **Single Sign-On**을 선택합니다.
...
액세스 패널에서 Prisma Cloud SSO타일을 클릭하면 SSO를 설정한 Prisma Cloud SSO에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD에서 Prisma Cloud SSO 사용해보기](https://aad.portal.azure.com/)
