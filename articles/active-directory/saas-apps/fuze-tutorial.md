...
4. 검색 상자에 **Fuze**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/fuze-tutorial/tutorial_fuze_000.png)

5. 결과 창에서 **Fuze**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Fuze 테스트 사용자 만들기](#creating-a-fuze-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Fuze에 만듭니다.
...
3. **Fuze 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Fuze** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Fuze 지원 팀](https://www.fuze.com/support)에 보내야 합니다. 그러면 해당 팀에서 SAML SSO 연결이 양쪽에 제대로 설정되도록 설정합니다.
