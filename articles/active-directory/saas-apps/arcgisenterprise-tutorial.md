...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 ArcGIS Enterprise 애플리케이션에서 Single Sign-On을 구성합니다.

**ArcGIS Enterprise에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **ArcGIS Enterprise** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
2. 애플리케이션 목록에서 **ArcGIS Enterprise**를 선택합니다.

    ![애플리케이션 목록의 ArcGIS Enterprise 링크](./media/arcgisenterprise-tutorial/tutorial_arcgisenterprise_app.png)  
...
액세스 패널에서 ArcGIS Enterprise 타일을 클릭하면 ArcGIS Enterprise 애플리케이션에 자동으로 로그온되어야 합니다.
