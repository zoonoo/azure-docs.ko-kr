...
1. 검색 상자에 **Pluralsight**를 입력하고 결과 패널에서 **Pluralsight**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[Pluralsight 테스트 사용자 만들기](#create-a-pluralsight-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Pluralsight에 만듭니다.
...
1. **Pluralsight 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
