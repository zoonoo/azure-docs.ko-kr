...
1. 검색 상자에 **Front**를 입력하고 결과 패널에서 **Front**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **진입점** 텍스트 상자에서 Azure AD 응용 프로그램 구성 마법사에서 나온 **Single Sign-On Service URL** 값을 입력합니다.
