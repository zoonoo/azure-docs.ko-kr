...
* 사용자가 자동으로 로그인 (Single Sign-on) Shuccho Navi를 해당 Azure AD 계정으로 사용할 수 있습니다.
...
* Shuccho Navi에서 single sign-on이 설정 된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Shuccho Navi 지원 **SP** 에서 시작한 SSO
...
이 섹션에서는 구성 및 Shuccho Navi를 사용 하 여 Azure AD에서 single sign-on 테스트 사용자를 기반으로 테스트 호출 **Britta Simon**합니다.
Single sign-on 작업에 대 한 Azure AD 사용자와 Shuccho Navi의 관련된 사용자 간에 연결 관계가 설정 해야 합니다.

Shuccho Navi에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Shuccho Navi Single Sign-on 구성](#configure-shuccho-navi-single-sign-on)**  -응용 프로그램 쪽에서 Single Sign-on 설정을 구성 합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Shuccho Navi 테스트 사용자 만들기](#create-shuccho-navi-test-user)**  -Britta simon 이라는 사용자를 Azure AD 표현과 연결 된 Shuccho Navi 합니다.
...
Shuccho Navi를 사용 하 여 Azure AD에서 single sign-on 구성 하려면 다음 단계를 수행 합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    **로그인 URL** 텍스트 상자에서 `https://naviauth.nta.co.jp/saml/login?ENTP_CD=<Your company code>` 패턴을 사용하여 URL을 입력합니다.
    ...
    > [!NOTE]
    > 이 값은 실제 값이 아닙니다. 이 값을 실제 로그온 URL로 업데이트합니다. 연락처 [Shuccho Navi 클라이언트 지원 팀](mailto:sys_ntabtm@nta.co.jp) 값을 가져옵니다. Azure Portal의 **기본 SAML 구성** 섹션에 표시된 패턴을 참조할 수도 있습니다.

5. **SAML로 Single Sign-On 설정** 페이지의 **SAML 서명 인증서** 섹션에서 **다운로드**를 클릭하여 요구 사항에 따라 제공된 옵션에서 **페더레이션 메타데이터 XML**을 다운로드하고 컴퓨터에 저장합니다.

    ![인증서 다운로드 링크](common/metadataxml.png)

6. 에 **Shuccho Navi 설정** 섹션, 요구 사항에 따라 적절 한 URL을 복사 합니다.
...
single sign-on을 구성 하려면 **Shuccho Navi** 쪽에서 다운로드 한 보내야 할 **메타 데이터 XML** 하 고 Azure portal에서 복사한 Url을 적절 한 [Shuccho Navi 지원팀](mailto:sys_ntabtm@nta.co.jp). 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure portal에서 선택 **엔터프라이즈 응용 프로그램**를 선택 **모든 응용 프로그램**을 선택한 후 **Shuccho Navi**합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Shuccho Navi**를 선택합니다.

    ![응용 프로그램 목록의 Shuccho Navi 링크](common/all-applications.png)
...
액세스 패널에서 Shuccho Navi 타일을 클릭 하면 있습니다 자동으로 로그온 됩니다 sso 설정 Shuccho Navi 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
