...
1. 검색 상자에 **Infogix Data3Sixty Govern**을 입력하고 결과 패널에서 **Infogix Data3Sixty Govern**을 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Infogix Data3Sixty Govern](./media/infogix-tutorial/tutorial_infogix_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 “Britta Simon”이라는 테스트 사용자를 기반으로 Infogix Data3Sixty Govern에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

Single Sign-On이 작동하려면 Azure AD 사용자에 해당하는 Infogix Data3Sixty Govern 사용자가 누구인지 Azure AD에서 인식할 수 있어야 합니다. 즉, Azure AD 사용자와 Infogix Data3Sixty Govern의 관련 사용자 간에 연결이 형성되어야 합니다.
...
1. **[Infogix Data3Sixty Govern 테스트 사용자 만들기](#create-an-infogix-data3sixty-govern-test-user)** - Azure AD의 Britta Simon과 연결된 Britta Simon에 해당하는 사용자를 Infogix Data3Sixty Govern에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Infogix Data3Sixty Govern 애플리케이션에서 Single Sign-On을 구성합니다.

**Infogix Data3Sixty Govern에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Infogix Data3Sixty Govern** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
1. Infogix Data3Sixty Govern 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
    
    ![Single Sign-On 구성 attb](./media/infogix-tutorial/tutorial_infogix_attribute.png)
...
1. **Single Sign-On** 대화 상자의 **사용자 특성** 섹션에서 이미지에 표시된 것과 같이 SAML 토큰 특성을 구성하고 다음 단계를 수행합니다.
    ...
    ![Single Sign-On 구성 추가](./media/infogix-tutorial/tutorial_attribute_04.png)

    ![Single Sign-On Addattb](./media/infogix-tutorial/tutorial_attribute_05.png)
...
1. **SAML 서명 인증서** 섹션에서 **인증서(원시)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/infogix-tutorial/tutorial_infogix_certificate.png)

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/infogix-tutorial/tutorial_general_400.png)
    
1. **Infogix Data3Sixty Govern Configuration**(Infogix Data3Sixty Govern 구성) 섹션에서 **Infogix Data3Sixty Govern 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Infogix Data3Sixty Govern 구성](./media/infogix-tutorial/tutorial_infogix_configure.png) 

1. **Infogix Data3Sixty Govern** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서, 로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 [Infogix Data3Sixty Govern 지원 팀](mailto:data3sixtysupport@infogix.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/infogix-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/infogix-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/infogix-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/infogix-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **Infogix Data3Sixty Govern**을 선택합니다.

    ![애플리케이션 목록의 Infogix Data3Sixty Govern 링크](./media/infogix-tutorial/tutorial_infogix_app.png)  
...
액세스 패널에서 Infogix Data3Sixty Govern 타일을 클릭하면 Infogix Data3Sixty Govern 애플리케이션에 자동으로 로그온됩니다.
