...
4. 검색 상자에 **Inkling**을 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/inkling-tutorial/tutorial_inkling_001.png)

5. 결과 창에서 **Inkling**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Inkling 테스트 사용자 만들기](#creating-an-inkling-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Inkling에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure 관리 포털에서 Azure AD Single Sign-On을 사용하도록 설정하고 Inkling 응용 프로그램에서 Single Sign-On을 구성합니다.

**Inkling에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure 관리 포털의 **Inkling** 응용 프로그램 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
3. **Inkling 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **회신 URL** 텍스트 상자에 다음 패턴으로 URL을 입력합니다.`https://api.inkling.com/saml/v2/acs/<user-id>`
...
9. 응용 프로그램에 대해 SSO를 구성하려면 [Inkling 지원 팀](mailto:press@inkling.com)에 문의하고 다운로드한 **메타데이터**를 제공합니다. 
...
2. 응용 프로그램 목록에서 **Inkling**을 선택합니다.
...
액세스 패널에서 Inkling 타일을 클릭하면 Inkling 응용 프로그램에 자동으로 로그온됩니다.
