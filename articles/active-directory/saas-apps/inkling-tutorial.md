...
1. 결과 창에서 **Inkling**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. 응용 프로그램에 대해 SSO를 구성하려면 [Inkling 지원 팀](mailto:press@inkling.com)에 문의하고 다운로드한 **메타데이터**를 제공합니다. 
...
1. 응용 프로그램 목록에서 **Inkling**을 선택합니다.
