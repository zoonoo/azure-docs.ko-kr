...
이 자습서에서는 테스트 환경에서 Azure AD SSO를 구성하고 테스트합니다. Miro는 **SP 및 IDP** 시작 SSO 및 **Just-In-Time** 사용자 프로비저닝을 지원합니다.

## <a name="adding-miro-from-the-gallery"></a>갤러리에서 Miro 추가
...
Miro에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.

1. 사용자가 이 기능을 사용할 수 있도록 **[Azure AD SSO를 구성](#configure-azure-ad-sso)** 합니다.
2. **[Miro 구성](#configure-miro)** - 애플리케이션 쪽에서 SSO 설정을 구성합니다.
...
5. **[Miro 테스트 사용자 만들기](#create-miro-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Miro에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Miro** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 다음, **Single Sign-On**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    **식별자** 텍스트 상자에 URL을 입력합니다. `https://miro.com`
...
### <a name="configure-miro"></a>Miro 구성
...
액세스 패널에서 Miro 타일을 클릭하면 SSO를 설정한 Miro에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
