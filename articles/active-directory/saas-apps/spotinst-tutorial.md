...
4. 검색 상자에 **Spotinst**를 입력하고 결과 패널에서 **Spotinst**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Spotinst 응용 프로그램에서 Single Sign-On을 구성합니다.

**Spotinst에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Spotinst** 응용 프로그램 통합 페이지에서 **Single sign-on**을 클릭합니다.
...
3. IDP 시작 모드에서 응용 프로그램을 구성하려면 **Spotinst 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
4. Spotinst 응용 프로그램은 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
2. 응용 프로그램 목록에서 **Spotinst**를 선택합니다.

    ![응용 프로그램 목록의 Spotinst 링크](./media/spotinst-tutorial/tutorial_spotinst_app.png)  
...
액세스 패널에서 Spotinst 타일을 클릭하면 Spotinst 응용 프로그램에 자동으로 로그온됩니다.
