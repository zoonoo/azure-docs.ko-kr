...
Secret Server (On-Premises)에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD SSO 구성](#configure-azure-ad-sso)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Secret Server (On-Premises) SSO 구성](#configure-secret-server-on-premises-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
...
5. **[Secret Server (On-Premises) 테스트 사용자 만들기](#create-secret-server-on-premises-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 Secret Server (On-Premises)에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Secret Server (On-Premises)** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾은 다음, **Single Sign-On**을 선택합니다.
...
1. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 아이콘을 클릭하여 **SAML 서명 인증서** 대화 상자를 엽니다.
    ...
    ![서명 옵션](./media/secretserver-on-premises-tutorial/edit-saml-signon.png)
...
액세스 패널에서 Secret Server (On-Premises) 타일을 클릭하면 SSO를 설정한 Secret Server (On-Premises)에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
