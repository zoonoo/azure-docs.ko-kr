...
1. 결과 패널에서 **Kindling**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Kindling 응용 프로그램에서 Single Sign-On을 구성합니다.

**Kindling에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Kindling** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Kindling 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나.  **식별자** 텍스트 상자에서 `https://<companyname>.kindlingapp.com/saml/module.php/saml/sp/metadata.php/clientIDP` 패턴을 사용하여 URL을 입력합니다.
...
1. 응용 프로그램 목록에서 **Kindling**을 선택합니다.
...
액세스 패널에서 Kindling 타일을 클릭하면 Kindling 응용 프로그램에 자동으로 로그온됩니다. 
