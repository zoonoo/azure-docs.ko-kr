...
4. 검색 상자에 **Kindling**을 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/kindling-tutorial/tutorial_kindling_search.png)

5. 결과 패널에서 **Kindling**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Kindling 테스트 사용자 만들기](#creating-a-kindling-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Kindling에 만듭니다.
...
3. **Kindling 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Kindling 구성** 섹션에서 **Kindling 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/kindling-tutorial/tutorial_kindling_configure.png) 

7. **Kindling** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64)**, **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 [Kindling 지원 팀](mailto:support@kindlingapp.com)으로 보내야 합니다.
