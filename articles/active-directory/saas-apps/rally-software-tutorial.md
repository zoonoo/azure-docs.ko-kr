...
4. 검색 상자에 **Rally Software**를 입력하고 결과 패널에서 **Rally Software**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Rally Software 테스트 사용자 만들기](#create-a-rally-software-test-user)** - Britta Simon의 Azure AD 사용자 표현과 연결되는 대응 사용자를 Rally Software에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Rally Software 응용 프로그램에서 Single Sign-On을 구성합니다.

**Rally Software에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Rally Software** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Rally Software 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Rally Software 구성** 섹션에서 **Rally Software 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조** 섹션에서 **로그아웃 URL 및 SAML 엔터티 ID**를 복사합니다.

    ![Rally 소프트웨어 구성](./media/rally-software-tutorial/tutorial_rallysoftware_configure.png) 

7. **Rally Software** 테넌트에 로그인합니다.

8. 위쪽의 도구 모음에서 **설정**을 클릭한 다음 **구독**을 선택합니다.
   
    ![구독](./media/rally-software-tutorial/ic769531.png "구독")

9. **작업** 단추를 클릭합니다. 도구 모음 맨 위 오른쪽에서 **구독 편집**을 선택합니다.

10. **구독** 대화 상자 페이지에서 다음 단계를 수행하고 **저장 및 닫기**를 클릭합니다.
...
Azure AD 사용자가 로그인할 수 있도록 Azure Active Directory 사용자 이름을 사용하여 Rally Software 응용 프로그램에 프로비전되어야 합니다.
...
2. 응용 프로그램 목록에서 **Rally Software**를 선택합니다.

    ![응용 프로그램 목록의 Rally Software 링크](./media/rally-software-tutorial/tutorial_rallysoftware_app.png)  
...
액세스 패널에서 Rally Software 타일을 클릭하면 Rally Software 응용 프로그램에 자동으로 로그온됩니다.
