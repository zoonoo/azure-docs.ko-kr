...
## <a name="configure-and-test-azure-ad-single-sign-on-for-cylanceprotect"></a>CylancePROTECT용 Azure AD Single Sign-On 구성 및 테스트
...
CylancePROTECT에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. **[CylancePROTECT SSO 구성](#configure-cylanceprotect-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[CylancePROTECT 테스트 사용자 만들기](#create-cylanceprotect-test-user)** - Azure AD 표현과 연결된 B.Simon에 해당하는 사용자를 CylancePROTECT에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **CylancePROTECT** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고, **Single Sign-On** 을 선택합니다.
...
액세스 패널에서 CylancePROTECT 타일을 클릭하면 SSO를 설정한 CylancePROTECT에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
...
- [Azure AD로 CylancePROTECT 사용해보기](https://aad.portal.azure.com/)