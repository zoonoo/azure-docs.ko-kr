...
1. **[CylancePROTECT 테스트 사용자 만들기](#create-a-cylanceprotect-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 CylancePROTECT에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_samlbase.png)

1. **CylancePROTECT 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![CylancePROTECT 도메인 및 URL Single Sign-On 정보](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/cylanceprotect-tutorial/tutorial_general_400.png)

1. **CylancePROTECT 구성** 섹션에서 **CylancePROTECT 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![CylancePROTECT 구성](./media/cylanceprotect-tutorial/tutorial_cylanceprotect_configure.png) 

1. **CylancePROTECT** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서(Base64), 로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 콘솔 관리자로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/cylanceprotect-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/cylanceprotect-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/cylanceprotect-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/cylanceprotect-tutorial/create_aaduser_04.png)
