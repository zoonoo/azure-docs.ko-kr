...
1. 결과 창에서 **Kantega SSO for FishEye/Crucible**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. 응용 프로그램 목록에서 **Kantega SSO for FishEye/Crucible**을 선택합니다.
