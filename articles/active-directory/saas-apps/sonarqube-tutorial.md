...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sonarqube"></a>Sonarqube에 대한 Azure AD Single Sign-On 구성 및 테스트
...
Sonarqube에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Sonarqube** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고, **Single Sign-On**을 선택합니다.
...
액세스 패널에서 Sonarqube 타일을 클릭하면, SSO를 설정한 Sonarqube에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD로 Sonarqube 사용해보기](https://aad.portal.azure.com/)
