...
ms.locfileid: "54810808"
---
# <a name="tutorial-azure-active-directory-integration-with-cisco-spark"></a>자습서: Cisco Umbrella와 Azure Active Directory 통합
...
* 사용자가 해당 Azure AD 계정으로 Cisco Spark에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
* Cisco Spark Single Sign-On을 사용하도록 설정된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Cisco Spark에서 **SP** 시작 SSO를 지원합니다.
...
이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 하여 Cisco Spark에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Cisco Spark의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Cisco Spark에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Cisco Spark Single Sign-On 구성](#configure-cisco-spark-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Cisco Spark 테스트 사용자 만들기](#create-cisco-spark-test-user)** - Azure AD 표현과 연결된 Britta Simon에 해당하는 사용자를 Cisco Spark에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Cisco Spark** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Cisco Spark 도메인 및 URL Single Sign-On 정보](common/sp-identifier.png)

    a. **로그온 URL** 텍스트 상자에서 URL을 `https://web.ciscospark.com/#/signin`으로 입력합니다.

    b. **식별자(엔터티 ID)** 텍스트 상자에서 `https://idbroker.webex.com/<companyname>` 패턴을 사용하는 URL을 입력합니다.

    > [!NOTE]
    > 식별자 값은 실제 값이 아닙니다. 실제 식별자로 이 값을 업데이트하세요. 이 값을 얻으려면 [Cisco Spark 클라이언트 지원 팀](https://support.ciscospark.com/)에 문의하세요. Azure Portal의 **기본 SAML 구성** 섹션에 표시된 패턴을 참조할 수도 있습니다.

5. Cisco Spark 애플리케이션에는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성** 대화 상자를 엽니다.
...
8. **Cisco Spark 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-cisco-spark-single-sign-on"></a>Cisco Spark Single Sign-On 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Cisco Spark**를 차례로 선택합니다.
...
### <a name="create-cisco-spark-test-user"></a>Cisco Spark 테스트 사용자 만들기
...
액세스 패널에서 Cisco Spark 타일을 클릭하면 SSO를 설정한 Cisco Spark에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
