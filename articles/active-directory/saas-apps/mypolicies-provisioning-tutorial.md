...
1. MyPolicies **support@mypolicies.com** 담당자에 게 연락 하 여 scim 프로 비전을 구성 하는 데 필요한 비밀 토큰을 가져옵니다.
...
5. **관리자 자격 증명** 섹션 아래에 있는 **테 넌 트 URL** 에 `https://<myPoliciesCustomDomain>.mypolicies.com/scim`을 입력 합니다. 여기서 `<myPoliciesCustomDomain>`은 myPolicies 사용자 지정 도메인입니다. URL에서 myPolicies customer 도메인을 검색할 수 있습니다.
