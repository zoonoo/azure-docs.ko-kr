---
title: '자습서: Azure Active Directory를 사용 하 여 자동 사용자 프로 비전을 위한 myPolicies 구성 Microsoft Docs'
...
1. Scim 프로 비전을 구성 하 **support@mypolicies.com** 는 데 필요한 비밀 토큰을 가져오기 위해 myPolicies 담당자에 게 연락 하세요.
...
> [!TIP]
> [MyPolicies single sign-on 자습서](mypolicies-tutorial.md)에 제공 된 지침에 따라 myPolicies에 대해 SAML 기반 single sign-on을 사용 하도록 선택할 수도 있습니다. Single Sign-On과 자동 사용자 프로비저닝은 서로 보완적이지만, 별개로 구성할 수 있습니다.
