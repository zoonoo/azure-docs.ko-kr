---
title: '자습서: Braze와 Azure Active Directory 연결 | Microsoft Docs'
...
이 자습서에서는 Azure AD(Azure Active Directory)와 Braze를 연결하는 방법에 대해 알아봅니다.
Braze를 Azure AD와 연결하면 다음과 같은 이점을 누릴 수 있습니다.

* Braze에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
...
Braze와 Azure AD 연결을 구성하려면 다음 항목이 필요합니다.

* Azure AD 구독 Azure AD 환경이 없으면 [체험 계정](https://azure.microsoft.com/free/)을 얻을 수 있습니다.
* Braze Single Sign-On이 설정된 구독
...
**갤러리에서 Braze를 추가하려면 다음 단계를 수행합니다.**
...
4. 검색 상자에 **Braze**를 입력하고 결과 패널에서 **Braze**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Braze](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 Braze에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Braze의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Braze에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Braze Single Sign-On 구성](#configure-braze-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Braze 테스트 사용자 만들기](#create-braze-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Braze에 만듭니다.
...
Braze에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.

1. [Azure Portal](https://portal.azure.com/)의 **Braze** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
9. **Braze 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
이 섹션에서는 Azure Single Sign-On을 사용할 수 있도록 Britta Simon에게 Braze에 대한 액세스 권한을 부여합니다.

1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Braze**를 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Braze**를 선택합니다.

    ![애플리케이션 목록의 Braze 링크](common/all-applications.png)
...
액세스 패널에서 Braze 타일을 클릭하면 SSO를 설정한 Braze에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
