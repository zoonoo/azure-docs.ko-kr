...
4. **SAML로 Single Sign-On 설정** 페이지에서 다음 단계를 수행합니다.
    ...
    ![Alibaba Cloud Service(역할 기반 SSO) 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
액세스 패널에서 Alibaba Cloud Service(역할 기반 SSO) 타일을 클릭하면 SSO를 설정한 Alibaba Cloud Service(역할 기반 SSO)에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
