...
1. **Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    ![Single Sign-on 구성](./media/liquidfiles-tutorial/tutorial_single_01.png)
...
액세스 패널에서 LiquidFiles 타일을 클릭하면, SSO를 설정한 LiquidFiles에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
