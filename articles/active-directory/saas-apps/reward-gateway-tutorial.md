...
1. 검색 상자에 **Reward Gateway**를 입력합니다.
...
1. **[Reward Gateway 테스트 사용자 만들기](#creating-a-reward-gateway-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Reward Gateway에 만듭니다.
...
1. **Reward Gateway 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **보상 게이트웨이** 쪽에서 Single Sign-On을 구성하려면 보상 관리자 포털에서 통합 설정을 시작합니다. 다운로드한 메타데이터를 사용하여 서명 인증서를 가져오고 구성하는 동안 업로드합니다. 자세한 내용은 http://success.rewardgateway.com/it-implementation/293968-how-to-configure-a-sso-integration에서 찾을 수 있습니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/reward-gateway-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/reward-gateway-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/reward-gateway-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/reward-gateway-tutorial/create_aaduser_04.png) 
...
1. 응용 프로그램 목록에서 **Reward Gateway**를 선택합니다.
