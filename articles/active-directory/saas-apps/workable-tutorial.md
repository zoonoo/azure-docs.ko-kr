...
ms.locfileid: "56180847"
---
# <a name="tutorial-azure-active-directory-integration-with-workable"></a>자습서: Workable과 Azure Active Directory 통합

이 자습서에서는 Azure AD(Azure Active Directory)와 Workable을 통합하는 방법에 대해 알아봅니다.
Workable을 Azure AD와 통합하면 다음과 같은 이점이 있습니다.

* Workable에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다.
...
Workable과 Azure AD 통합을 구성하려면 다음 항목이 필요합니다.

* Azure AD 구독 Azure AD 환경이 없으면 [여기](https://azure.microsoft.com/pricing/free-trial/)에서 1개월 평가판을 구할 수 있습니다.
* Workable Single Sign-on이 설정된 구독

## <a name="scenario-description"></a>시나리오 설명

이 자습서에서는 테스트 환경에서 Azure AD Single Sign-On을 구성하고 테스트합니다.

* Workable에서 **SP 및 IDP** 시작 SSO 지원
* Workable은 **Just In Time** 사용자 프로비전을 지원

## <a name="adding-workable-from-the-gallery"></a>갤러리에서 Workable 추가

Workable과 Azure AD 통합을 구성하려면 갤러리에서 Workable을 관리형 SaaS 앱 목록에 추가해야 합니다.

**갤러리에서 Workable을 추가하려면 다음 단계를 수행합니다.**
...
이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 한 Workable에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Workable의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Workable에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.
...
Workable에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.

1. [Azure portal](https://portal.azure.com/)의 **Workable** 애플리케이션 통합 페이지에서 **Single sign-on**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Workable 도메인 및 URL Single Sign-On 정보](common/both-replyurl.png)
...
5. **SP** 시작 모드로 애플리케이션을 구성하려는 경우 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.
    ...
    ![Workable 도메인 및 URL Single Sign-On 정보](common/both-signonurl.png)
...
### <a name="configure-workable-single-sign-on"></a>Workable Single Sign-on 구성
...
2. 애플리케이션 목록에서 **Workable**을 선택합니다.

    ![애플리케이션 목록의 Workable 링크](common/all-applications.png)
...
액세스 패널에서 Workable 타일을 클릭하는 경우 SSO를 설정하려면 Workable에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
