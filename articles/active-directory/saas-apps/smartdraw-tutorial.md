...
1. **[SmartDraw SSO 구성](#configure-smartdraw-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[SmartDraw 테스트 사용자 만들기](#create-smartdraw-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 SmartDraw에 만듭니다.
...
1. SmartDraw 라이선스 관리 아래에서 **Single Sign-On** 을 클릭합니다.
    ...
    ![스크린샷은 Single Sign-On을 선택할 수 있는 SmartDraw 라이선스 관리 대화 상자를 보여줍니다.](./media/smartdraw-tutorial/configure01.png)

1. 구성 페이지에서 다음 단계를 수행합니다.

    ![스크린샷은 설명된 값을 입력할 수 있는 구성 페이지를 보여줍니다.](./media/smartdraw-tutorial/configure02.png)
