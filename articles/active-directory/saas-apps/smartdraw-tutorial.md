...
## <a name="configure-and-test-azure-ad-single-sign-on-for-smartdraw"></a>SmartDraw에 대한 Azure AD Single Sign-On 구성 및 테스트
...
SmartDraw에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **SmartDraw** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고, **Single Sign-On**을 선택합니다.
...
- [Azure AD에서 SmartDraw 사용해 보기](https://aad.portal.azure.com/)
