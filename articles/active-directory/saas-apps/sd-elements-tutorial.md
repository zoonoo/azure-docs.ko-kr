...
4. 검색 상자에 **SD Elements**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/sd-elements-tutorial/tutorial_sdelements_search.png)

5. 결과 패널에서 **SD Elements**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
10. 다른 브라우저 창에서 SD Elements 테넌트에 관리자로 로그온합니다.
...
2. 위쪽 메뉴에서 **사용자 관리**를 클릭한 다음 **사용자**를 클릭합니다.
