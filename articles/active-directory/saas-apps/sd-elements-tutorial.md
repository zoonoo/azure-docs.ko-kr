...
1. 위쪽의 메뉴에서 **시스템** 및 **Single Sign-On** 을 차례로 클릭합니다.
    ...
    ![선택된 "시스템"과 드롭다운에서 선택된 "Single Sign-On"을 보여주는 스크린샷.](./media/sd-elements-tutorial/tutorial_sd-elements_09.png)
...
1. 위쪽 메뉴에서 **사용자 관리** 를 클릭한 다음 **사용자** 를 클릭합니다.
    ...
    !["사용자 관리" 드롭다운에서 선택한 "사용자"를 보여주는 스크린샷.](./media/sd-elements-tutorial/tutorial_sd-elements_11.png) 

1. **새 사용자 추가** 를 클릭합니다.

    ![선택된 "새 사용자 추가" 단추를 보여주는 스크린샷.](./media/sd-elements-tutorial/tutorial_sd-elements_12.png)
...
액세스 패널에서 SD Elements 타일을 클릭하면 SSO를 설정한 SD Elements에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
