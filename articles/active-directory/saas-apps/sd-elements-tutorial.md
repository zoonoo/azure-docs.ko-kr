...
## <a name="configure-and-test-azure-ad-single-sign-on-for-sd-elements"></a>SD Elements용 Azure AD Single Sign-On 구성 및 테스트
...
SD Elements에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료합니다.
...
1. **[SD Elements SSO 구성](#configure-sd-elements-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
    * **[SD Elements 테스트 사용자 만들기](#create-sd-elements-test-user)** - B.Simon의 Azure AD 표현과 연결된 해당 사용자를 SD Elements에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **SD Elements** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On**을 선택합니다.
...
1. 위쪽의 메뉴에서 **시스템** 및 **Single Sign-On**을 차례로 클릭합니다.
    ...
    ![Single Sign-on 구성](./media/sd-elements-tutorial/tutorial_sd-elements_09.png)

1. **Single Sign-On 설정** 대화 상자에서 다음 단계를 수행합니다.

    ![Single Sign-on 구성](./media/sd-elements-tutorial/tutorial_sd-elements_10.png)
...
- [Azure AD로 SD Elements 사용해 보기](https://aad.portal.azure.com/)