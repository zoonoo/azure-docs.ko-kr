...
1. 검색 상자에 **Dealpath**를 입력하고 결과 패널에서 **Dealpath**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
1. **[Dealpath 테스트 사용자 만들기](#create-a-dealpath-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Dealpath에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Dealpath 애플리케이션에서 Single Sign-On을 구성합니다.

**Dealpath에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Dealpath** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Dealpath 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://api.dealpath.com/saml/metadata/<ID>` 패턴을 사용하여 URL을 입력합니다.
...
1. **Dealpath 구성** 섹션에서 **Dealpath 구성**을 클릭하여 **로그인 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Dealpath 구성](./media/dealpath-tutorial/tutorial_dealpath_configure.png) 

1. 다른 웹 브라우저 창에서 Dealpath에 관리자로 로그인합니다.

1. 오른쪽 위에서 **관리 도구**를 클릭하고 **통합**으로 이동한 다음, **SAML 2.0 인증** 섹션에서 **업데이트 설정**을 클릭합니다.

    ![Dealpath 구성](./media/dealpath-tutorial/tutorial_dealpath_admin.png)

1. **SAML 2.0 인증 설정** 페이지에서 다음 단계를 수행합니다.
...
이 섹션에서는 Dealpath에서 Britta Simon이라는 사용자를 만듭니다.  [Dealpath 클라이언트 지원 팀](mailto:kenter@dealpath.com) 과 협력하여 Dealpath 플랫폼에서 사용자를 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.
...
1. 애플리케이션 목록에서 **Dealpath**를 선택합니다.
    ...
    ![애플리케이션 목록의 Dealpath 링크](./media/dealpath-tutorial/tutorial_dealpath_app.png)  
...
액세스 패널에서 Dealpath 타일을 클릭하면 Dealpath 애플리케이션에 자동으로 로그온됩니다.
