...
* 사용자가 자신의 Azure AD 계정으로 Proxyclick에 자동으로 로그인(Single Sign-On)되도록 설정할 수 있습니다.
...
4. 검색 상자에서 **Proxyclick**을 입력하고, 결과 패널에서 **Proxyclick**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Proxyclick의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Proxyclick에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Proxyclick Single Sign-On 구성](#configure-proxyclick-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Proxyclick 테스트 사용자 만들기](#create-proxyclick-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Proxyclick에 만듭니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Proxyclick 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)

    a. **식별자** 텍스트 상자에서 다음 패턴을 사용하여 URL을 입력합니다. `https://saml.proxyclick.com/init/<companyId>`

    b. **회신 URL** 텍스트 상자에 다음 패턴을 사용하여 URL을 입력합니다. `https://saml.proxyclick.com/consume/<companyId>`

5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.

    ![Proxyclick 도메인 및 URL Single Sign-On 정보](common/metadata-upload-additional-signon.png)

    **로그인 URL** 텍스트 상자에서 `https://saml.proxyclick.com/init/<companyId>` 패턴을 사용하여 URL을 입력합니다.
...
7. **Proxyclick 설정** 섹션에서 요구 사항에 해당하는 적절한 URL을 복사합니다.
...
3. **통합**까지 아래로 스크롤하여 **SAML**을 선택합니다.
...
4. **SAML** 섹션에서 다음 단계를 수행합니다.
    ...
    a. **SAML 소비자 URL** 값을 복사하여 Azure Portal의 **기본 SAML 구성**에서 **회신 URL** 텍스트 상자에 붙여넣습니다.

    b. **SAML SSO 리디렉션 URL** 값을 복사하여 Azure Portal의 **기본 SAML 구성** 섹션에서 **로그온 URL** 및 **식별자** 텍스트 상자에 붙여넣습니다.

    다. **SAML 요청 메서드**를 **HTTP 리디렉션**으로 선택합니다.

    d. **발급자** 텍스트 상자에 Azure Portal에서 복사한 **Azure AD 식별자** 값을 붙여넣습니다.

    e. **SAML 2.0 엔드포인트 URL** 텍스트 상자에 Azure Portal에서 복사한 **로그인 URL** 값을 붙여넣습니다.
...
Azure AD 사용자가 Proxyclick에 로그인할 수 있도록 하려면 이 사용자를 Proxyclick에 프로비저닝해야 합니다. Proxyclick의 경우 프로비전은 수동 작업입니다.

**사용자 계정을 프로비저닝하려면 다음 단계를 수행합니다.**

1. Proxyclick 회사 사이트에 관리자로 로그인합니다.
...
액세스 패널에서 Proxyclick 타일을 클릭하면, SSO를 설정한 Proxyclick에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
