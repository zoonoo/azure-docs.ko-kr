...
4. 검색 상자에서 **Proxyclick**을 입력하고, 결과 패널에서 **Proxyclick**을 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Proxyclick 테스트 사용자 만들기](#create-a-proxyclick-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Proxyclick에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Proxyclick 응용 프로그램에서 Single Sign-On을 구성합니다.

**Proxyclick에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Proxyclick** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Proxyclick 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
7. **Proxyclick 구성** 섹션에서 **Proxyclick 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Proxyclick 구성](./media/proxyclick-tutorial/tutorial_proxyclick_configure.png)

8. 다른 웹 브라우저 창에서 Proxyclick 회사 사이트에 관리자로 로그인합니다.

9. **계정 및 설정**을 선택합니다.

    ![Proxyclick 구성](./media/proxyclick-tutorial/configure1.png)

10. **통합**까지 아래로 스크롤하여 **SAML**을 선택합니다.

    ![Proxyclick 구성](./media/proxyclick-tutorial/configure2.png)

11. **SAML** 섹션에서 다음 단계를 수행합니다.
...
2. 응용 프로그램 목록에서 **Proxyclick**을 선택합니다.

    ![응용 프로그램 목록의 Proxyclick 링크](./media/proxyclick-tutorial/tutorial_proxyclick_app.png)  
...
액세스 패널에서 Proxyclick 타일을 클릭하면 Proxyclick 응용 프로그램에 자동으로 로그온됩니다.
