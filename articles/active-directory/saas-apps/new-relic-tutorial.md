...
1. 검색 상자에 **New Relic**을 입력하고, 결과 패널에서 **New Relic**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 New Relic 애플리케이션에서 Single Sign-On을 구성합니다.

**New Relic에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **New Relic** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. 애플리케이션 목록에서 **New Relic**을 선택합니다.
    ...
    ![애플리케이션 목록의 New Relic 링크](./media/new-relic-tutorial/tutorial_new-relic_app.png)  
...
액세스 패널에서 New Relic 타일을 클릭하면 New Relic 애플리케이션에 자동으로 로그온됩니다.
