...
4. **MaxxPoint 도메인 및 URL** 섹션에서 **SP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
    ...
    나. **로그온 URL** 텍스트 상자에서 다음 패턴 `https://maxxpoint.westipc.com/default/sso/login/entity/<customer-id>-azure`을 사용하여 URL을 입력합니다.

    > [!NOTE] 
    > 이러한 값은 실제 값이 아닙니다. 이 값은 실제 로그인 URL로 업데이트해야 합니다. 이 값을 얻으려면 MaxxPoint 팀(**888-728-0950**)에 문의하세요.
...
7. 응용 프로그램에 대해 SSO를 구성하려면 MaxxPoint 지원 팀(**888-728-0950**)에 문의합니다. 그러면 다운로드한 **메타데이터 XML** 파일을 제공하는 방법에 대한 추가 지원을 받을 수 있습니다. 
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/maxxpoint-tutorial/create_aaduser_01.png) 

2. **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭하여 사용자 목록을 표시합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/maxxpoint-tutorial/create_aaduser_02.png) 

3. 대화 상자 위쪽에서 **추가**를 클릭하여 **사용자** 대화 상자를 엽니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/maxxpoint-tutorial/create_aaduser_03.png) 

4. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/maxxpoint-tutorial/create_aaduser_04.png) 
