...
1. **MaxxPoint 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 애플리케이션을 구성하려는 경우 단계를 수행하지 않아도 됩니다.

    ![Configure Single Sign-On](./media/maxxpoint-tutorial/tutorial_maxxpoint_02.png)
    
1. **MaxxPoint 도메인 및 URL** 섹션에서 **SP 시작 모드**로 애플리케이션을 구성하려는 경우 다음 단계를 수행합니다.
