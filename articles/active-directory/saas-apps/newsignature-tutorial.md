...
1. 검색 상자에 **Microsoft Azure용 클라우드 관리 포털**을 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/newsignature-tutorial/tutorial_newsignature_search.png)

1. 결과 창에서 **Microsoft Azure용 클라우드 관리 포털**을 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. **[Microsoft Azure용 클라우드 관리 포털 테스트 사용자 만들기](#creating-a-cloud-management-portal-for-microsoft-azure-test-user)** - Azure AD에 연결된 Microsoft Azure용 클라우드 관리 포털에서 Britta Simon을 나타내는 사용자를 만듭니다.
...
1. **Microsoft Azure용 클라우드 관리 포털 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Microsoft Azure용 클라우드 관리 포털 구성** 섹션에서 **Microsoft Azure용 클라우드 관리 포털 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. 응용 프로그램 목록에서 **Microsoft Azure용 클라우드 관리 포털**을 선택합니다.
