...
1. **SAML 서명 인증서** 섹션에서 다음 단계를 수행합니다. 
    ...
    b. **인증서(Base64)** 를 클릭한 다음, 컴퓨터에 인증서 파일을 저장합니다.
...
1. **새 통합**을 클릭하고 **설치** 탭 아래에서 다음 단계를 수행합니다.
    ...
    b. **통합 ID** 값을 복사하고, Azure Portal의 **SignalFx 도메인 및 URL** 섹션에 있는 **회신 URL** 텍스트 상자에서 **회신 URL**(예: `https://api.signalfx.com/v1/saml/acs/<integration ID>`)을 추가합니다.
