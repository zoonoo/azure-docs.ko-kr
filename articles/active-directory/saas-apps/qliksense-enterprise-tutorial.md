...
이 자습서에서는 테스트 환경에서 Azure AD SSO를 구성하고 테스트합니다. Qlik Sense Enterprise에서 **SP** 시작 SSO를 지원합니다.
...
2. **[Qlik Sense Enterprise SSO 구성](#configure-qlik-sense-enterprise-sso)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
