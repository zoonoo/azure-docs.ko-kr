...
* 사용자가 해당 Azure AD 계정으로 YouEarnedIt에 자동으로 로그인(Single Sign-on)되도록 설정할 수 있습니다.
...
4. 검색 상자에 **YouEarnedIt**를 입력하고 결과 패널에서 **YouEarnedIt**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

     ![결과 목록의 YouEarnedIt](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성 및 테스트

이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 YouEarnedIt에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 YouEarnedIt의 관련 사용자 간에 연결 관계를 설정해야 합니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **YouEarnedIt** 애플리케이션 통합 페이지에서 **Single sign-on**을 선택합니다.
...
### <a name="configure-youearnedit-single-sign-on"></a>YouEarnedIt Single Sign-On 구성
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**을 선택하고 **모든 애플리케이션**을 선택한 다음, **YouEarnedIt**를 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에 **YouEarnedIt**를 입력하고 선택합니다.

    ![애플리케이션 목록의 YouEarnedIt 연결](common/all-applications.png)
...
액세스 패널에서 YouEarnedIt 타일을 클릭하면 SSO를 설정한 YouEarnedIt에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
