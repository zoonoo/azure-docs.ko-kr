...
4. 검색 상자에 **Supermood**를 입력하고 결과 패널에서 **Supermood**를 선택한 다음, **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[Supermood 테스트 사용자 만들기](#create-a-supermood-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Supermood에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Supermoodl 응용 프로그램에서 Single Sign-On을 구성합니다.

**Supermood에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Supermood** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Supermood 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
4. Supermood 응용 프로그램은 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
6. **SAML 서명 인증서** 섹션에서 복사 단추를 클릭하여 **앱 페더레이션 메타데이터 URL**을 복사하고 메모장에 붙여넣습니다.
...
8. 보안 관리자 권한으로 Supermood.co 관리 패널로 이동합니다.

9. **내 계정**(왼쪽 아래)을 클릭하고 **SSO(Single Sign On)** 을 클릭합니다.

    ![인증서 단일](./media/supermood-tutorial/tutorial_supermood_single.png)
10. **SAML 2.0 구성**에서 **이메일 도메인에 대한 SAML 2.0 구성 추가**를 클릭합니다.

    ![인증서 추가](./media/supermood-tutorial/tutorial_supermood_add.png)

11. **이메일 도메인에 대한 SAML 2.0 구성 추가** 섹션에서 다음 단계를 수행합니다.
...
2. 응용 프로그램 목록에서 **Supermood**를 선택합니다.

    ![응용 프로그램 목록의 Supermood 링크](./media/supermood-tutorial/tutorial_supermood_app.png)  
...
액세스 패널에서 Supermood 타일을 클릭하면 Supermood 응용 프로그램에 자동으로 로그온됩니다.
