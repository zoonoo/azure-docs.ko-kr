...
1. **[Clear Review 테스트 사용자 만들기](#create-a-clear-review-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Clear Review에 만듭니다.
...
1. **Clear Review 도메인 및 URL** 섹션에서 **IdP 시작** 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
...
1. **Clear Review 구성** 섹션에서 **Clear Review 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. 응용 프로그램 목록에서 **Clear Review**를 선택합니다.
