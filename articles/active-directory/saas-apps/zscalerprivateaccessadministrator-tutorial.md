...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![스크린샷은 설명된 값을 입력할 수 있는 기본 SAML 구성을 보여줍니다.](common/idp-relay.png)
...
액세스 패널에서 Zscaler Private Access Administrator 타일을 클릭하면 SSO를 설정한 Zscaler Private Access Administrator에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
