...
4. 검색 상자에 **Domo**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/domo-tutorial/tutorial_domo_search.png)

5. 결과 패널에서 **Domo**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **Domo 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
8. **Domo 구성** 섹션에서 **Domo 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.   

   ![Configure Single Sign-On](./media/domo-tutorial/tutorial_domo_configure.png) 

9. **Domo** 쪽에서 Single Sign-On을 구성하려면 [여기](http://knowledge.domo.com?cid=azuread)에 있는 Domo의 기술 자료 아티클로 이동하고 지시를 따릅니다.
