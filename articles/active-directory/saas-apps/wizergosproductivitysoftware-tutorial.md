...
1. 검색 상자에 **Wizergos Productivity Software**를 입력하고 결과 패널에서 **Wizergos Productivity Software**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Wizergos Productivity Software](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_addfromgallery.png)
...
1. **[Wizergos Productivity Software 테스트 사용자 만들기](#create-a-wizergos-productivity-software-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Wizergos Productivity Software에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Wizergos Productivity Software 애플리케이션에서 Single Sign-On을 구성합니다.

**Wizergos Productivity Software에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Wizergos Productivity Software** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_samlbase.png)

1. **Wizergos Productivity Software 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Wizergos Productivity Software 도메인 및 URL Single Sign-On 정보](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_url.png)

    **식별자** 텍스트 상자에 URL `https://www.wizergos.net`을 입력합니다.

1. **SAML 서명 인증서** 섹션에서 **인증서**를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.

    ![인증서 다운로드 링크](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/wizergosproductivitysoftware-tutorial/tutorial_general_400.png)

1. **Wizergos Productivity Software 구성** 섹션에서 **Wizergos Productivity Software 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Wizergos Productivity Software 구성](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_configure.png) 

1. 다른 웹 브라우저 창에서 Wizergos Productivity Software 테넌트에 관리자로 로그인합니다.

1. 햄버거 메뉴에서 **관리자**를 선택합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_000.png)

1. 왼쪽 메뉴의 관리자 페이지에서 **인증**을 선택하고 **Azure AD**를 클릭합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_002.png)

1. **인증** 섹션에서 다음 단계를 수행합니다.

    ![앱 쪽에서 Single Sign-On 구성](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_003.png)
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/wizergosproductivitysoftware-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/wizergosproductivitysoftware-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/wizergosproductivitysoftware-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/wizergosproductivitysoftware-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **Wizergos Productivity Software**를 선택합니다.

    ![애플리케이션 목록의 Wizergos Productivity Software 링크](./media/wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_app.png)  
...
액세스 패널에서 Wizergos Productivity Software 타일을 클릭하면 Wizergos Productivity Software 애플리케이션에 자동으로 로그온됩니다.
