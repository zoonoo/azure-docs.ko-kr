...
4. 검색 상자에 **LoginRadius**를 입력하고 결과 패널에서 **LoginRadius**를 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에 다음 URL을 입력합니다. `https://secure.loginradius.com/login`
...
**LoginRadius** 쪽에서 Single Sign-On을 구성하려면 Azure Portal에서 다운로드한 **메타데이터 XML**과 적절히 복사한 URL을 [LoginRadius 지원 팀](mailto:support@loginradius.com)으로 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
...
액세스 패널에서 LoginRadius 타일을 클릭하면 SSO를 설정한 LoginRadius에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
