...
> [!TIP]
> [Rollbar single sign-on 자습서](rollbar-tutorial.md)에 제공 된 지침에 따라 Rollbar에 대해 SAML 기반 Single Sign-On를 사용 하도록 선택할 수도 있습니다. Single Sign-On과 자동 사용자 프로비저닝은 서로 보완적이지만, 별개로 구성할 수 있습니다.
