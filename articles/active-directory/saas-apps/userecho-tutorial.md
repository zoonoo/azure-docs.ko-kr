...
1. 결과 패널에서 **UserEcho**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 UserEcho 응용 프로그램에서 Single Sign-On을 구성합니다.
...
액세스 패널에서 UserEcho 타일을 클릭하면 UserEcho 응용 프로그램에 자동으로 로그온됩니다.
