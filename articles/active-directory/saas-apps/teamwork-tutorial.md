...
1. 검색 상자에 **Teamwork.com**을 입력하고 결과 패널에서 을 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. 응용 프로그램 목록에서 **Teamwork.com**을 선택합니다.

    ![응용 프로그램 목록의 Teamwork.com 링크](./media/teamwork-tutorial/tutorial_teamwork_app.png)  
