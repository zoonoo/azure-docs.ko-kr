...
4. 검색 상자에 **RunMyProcess**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/runmyprocess-tutorial/tutorial_runmyprocess_search.png)

5. 결과 창에서 **RunMyProcess**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
3. **[RunMyProcess 테스트 사용자 만들기](#creating-a-runmyprocess-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 RunMyProcess에 만듭니다.
...
3. **RunMyProcess 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **RunMyProcess 구성** 섹션에서 **RunMyProcess 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/runmyprocess-tutorial/tutorial_runmyprocess_configure.png) 

7. 다른 웹 브라우저 창에서 RunMyProcess 테넌트에 관리자로 로그인합니다.

8. 왼쪽 탐색 패널에서 **계정**을 클릭하고 **구성**을 선택합니다.
   
    ![앱 쪽에서 Single Sign-On 구성](./media/runmyprocess-tutorial/tutorial_runmyprocess_001.png)

9. **인증 방법** 섹션으로 이동하고 아래 단계를 수행합니다.
...
2. 왼쪽 탐색 패널에서 **계정**을 클릭하고 **사용자**를 선택한 다음 **새 사용자**를 클릭합니다.
...
2. 응용 프로그램 목록에서 **RunMyProcess**를 선택합니다.
