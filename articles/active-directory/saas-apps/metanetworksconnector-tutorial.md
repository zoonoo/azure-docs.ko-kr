...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Meta Networks Connector 응용 프로그램에서 Single Sign-On을 구성합니다.

**Meta Networks Connector에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Meta Networks Connector** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
액세스 패널에서 Meta Networks Connector 타일을 클릭하면 Meta Networks Connector 응용 프로그램에 자동으로 로그온됩니다.
