...
- 사용자가 해당 Azure AD 계정으로 Meta Networks Connector에 자동으로 로그온(Single Sign-on)되도록 설정할 수 있습니다.
...
1. 검색 상자에 **Meta Networks Connector**를 입력하고 결과 패널에서 **Meta Networks Connector**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 Meta Networks Connector 사용자가 누구인지 알고 있어야 합니다. 즉, Azure AD 사용자와 Meta Networks Connector의 관련 사용자 간에 연결 관계가 형성되어야 합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Meta Networks Connector 애플리케이션에서 Single Sign-On을 구성합니다.

**Meta Networks Connector에서 Azure AD Single Sign-on을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Meta Networks Connector** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. Meta Networks Connector 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다.
...
1. 애플리케이션 목록에서 **Meta Networks Connector**를 선택합니다.
    ...
    ![애플리케이션 목록의 Meta Networks Connector 링크](./media/metanetworksconnector-tutorial/tutorial_metanetworksconnector_app.png)  
...
액세스 패널에서 Meta Networks Connector 타일을 클릭하면 Meta Networks Connector 애플리케이션에 자동으로 로그온됩니다.
