...
1. 검색 상자에 **SAP NetWeaver**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_search.png)

1. 결과 창에서 **SAP NetWeaver**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_addfromgallery.png)
...
1. **[SAP NetWeaver 테스트 사용자 만들기](#creating-an-sap-netweaver-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 SAP NetWeaver에 만듭니다.
...
1. **SAP NetWeaver 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **SAP NetWeaver 구성** 섹션에서 **SAP NetWeaver 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML 엔터티 ID**를 복사합니다.

    ![Configure Single Sign-On](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

1. **SAP NetWeaver** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML** 및 **SAML 엔터티 ID**를 [SAP NetWeaver 지원](https://www.sap.com/support.html)으로 보내야 합니다. 
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/sap-netweaver-tutorial/create_aaduser_04.png) 
...
1. 응용 프로그램 목록에서 **SAP NetWeaver**를 선택합니다.
