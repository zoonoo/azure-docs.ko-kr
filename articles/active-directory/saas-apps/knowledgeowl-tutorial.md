...
1. **[KnowledgeOwl 테스트 사용자 만들기](#create-a-knowledgeowl-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 KnowledgeOwl에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/knowledgeowl-tutorial/tutorial_knowledgeowl_samlbase.png)

1. **IDP** 시작 모드에서 응용 프로그램을 구성하려면 **KnowledgeOwl 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. KnowledgeOwl 응용 프로그램은 특정 형식의 SAML 어설션을 예상하므로 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가해야 합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다.
...
1. **SAML 서명 인증서** 섹션에서 **인증서(원시)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/knowledgeowl-tutorial/tutorial_knowledgeowl_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/knowledgeowl-tutorial/tutorial_general_400.png)
    
1. **KnowledgeOwl 구성** 섹션에서 **KnowledgeOwl 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![KnowledgeOwl 구성](./media/knowledgeowl-tutorial/tutorial_knowledgeowl_configure.png)
...
1. **SAML SSO 통합**까지 아래로 스크롤하고 다음 단계를 수행합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/knowledgeowl-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/knowledgeowl-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/knowledgeowl-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/knowledgeowl-tutorial/create_aaduser_04.png)
