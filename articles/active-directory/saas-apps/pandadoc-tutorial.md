...
ms.locfileid: "88553952"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-pandadoc"></a>자습서: PandaDoc와 Azure Active Directory SSO(Single Sign-On) 연결
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-pandadoc"></a>PandaDoc용 Azure AD Single Sign-On 구성 및 테스트
...
1. [Azure Portal](https://portal.azure.com/)의 **PandaDoc** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾아 **Single Sign-On**을 선택합니다.
...
액세스 패널에서 PandaDoc 타일을 클릭하면 SSO를 설정한 PandaDoc에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
...
- [Azure AD로 PandaDoc 사용해 보기](https://aad.portal.azure.com/)
