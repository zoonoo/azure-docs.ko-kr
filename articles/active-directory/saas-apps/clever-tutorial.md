...
1. 검색 상자에 **Clever**를 입력하고 결과 패널에서 **Clever**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
1. Clever 응용 프로그램은 특정 서식에서 SAML 어설션을 예상하며 이는 **SAML 토큰 특성** 구성에 사용자 지정 특성 매핑을 추가합니다.
...
1. 응용 프로그램 목록에서 **Clever**를 선택합니다.

    ![응용 프로그램 목록의 Clever 링크](./media/clever-tutorial/tutorial_clever_app.png)
