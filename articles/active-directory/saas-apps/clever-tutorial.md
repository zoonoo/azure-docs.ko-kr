...
1. [Azure Portal](https://portal.azure.com/)의 **Clever** 애플리케이션 통합 페이지에서 **관리** 섹션을 찾고 **Single Sign-On**을 선택합니다.
...
- [Azure AD로 Clever 사용해 보기](https://aad.portal.azure.com/)