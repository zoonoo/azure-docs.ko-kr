...
이 섹션에서는 GetThere에서 Britta Simon이라는 사용자를 만듭니다.  [GetThere 클라이언트 지원 팀](mailto:dataintegration@sabre.com)과 협력하여 GetThere 플랫폼에 사용자를 추가합니다. Single Sign-On을 사용하려면 먼저 사용자를 만들고 활성화해야 합니다.
