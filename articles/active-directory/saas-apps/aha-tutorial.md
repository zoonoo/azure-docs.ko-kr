...
이 섹션에서는 **Britta Simon**이라는 테스트 사용자를 기반으로 Aha!에서 Azure AD Single Sign-On을 구성하고 테스트합니다.
Single Sign-On이 작동하려면 Azure AD 사용자와 Aha! 의 관련 사용자 간에 연결 관계를 설정해야 합니다.
