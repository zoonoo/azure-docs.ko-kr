---
title: '자습서: Azure Active Directory를 사용 하 여 자동 사용자 프로 비전을 위한 Blink 구성 Microsoft Docs'
...
1. 에서support@joinblink.com scim 토큰을 요청 하도록 [지원 사례](https://help.joinblink.com/hc/requests/new) 또는 전자 메일 **깜박임 지원** 을 기록 합니다. 을 선택합니다.
