...
4. 검색 상자에 **Hornbill**을 입력하고 결과 패널에서 **Hornbill**을 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Hornbill 응용 프로그램에서 Single Sign-On을 구성합니다.

**Hornbill에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Hornbill** 응용 프로그램 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **Hornbill 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    나. **식별자** 텍스트 상자에서 `https://<SUBDOMAIN>.hornbill.com/<INSTANCE_NAME>/lib/saml/auth/simplesaml/module.php/saml/sp/metadata.php/saml` 패턴을 사용하여 URL을 입력합니다.
...
2. 응용 프로그램 목록에서 **Hornbill**을 선택합니다.

    ![응용 프로그램 목록의 Hornbill 링크](./media/hornbill-tutorial/tutorial_hornbill_app.png)  
...
액세스 패널에서 Hornbill 타일을 클릭하면 Hornbill 응용 프로그램에 자동으로 로그온됩니다.
