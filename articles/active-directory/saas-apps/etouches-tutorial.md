...
1. 검색 상자에 **etouches**를 입력하고 결과 패널에서 **etouches**를 선택한 후 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 etouches](./media/etouches-tutorial/tutorial_etouches_addfromgallery.png)
...
1. **[etouches 테스트 사용자 만들기](#create-an-etouches-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 etouches에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-on 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 etouches 애플리케이션에서 Single Sign-On을 구성합니다.

**etouches에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **etouches** 애플리케이션 통합 페이지에서 **Single sign-on**을 클릭합니다.

    ![Configure Single Sign-On][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/etouches-tutorial/tutorial_etouches_samlbase.png)

1. **etouches 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![etouches 도메인 및 URL Single Sign-On 정보](./media/etouches-tutorial/tutorial_etouches_url.png)
...
1. etouches 애플리케이션은 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션의 **사용자 특성**에서 이러한 특성의 값을 관리할 수 있습니다. 다음 스크린샷은 이에 대한 예제를 보여 줍니다. 

    ![사용자 특성](./media/etouches-tutorial/tutorial_etouches_attribute.png) 
...
1. **Single Sign-On** 대화 상자의 **사용자 특성** 섹션에서 이미지에 표시된 것과 같이 SAML 토큰 특성을 구성하고 다음 단계를 수행합니다.
    ...
    ![특성 추가](./media/etouches-tutorial/tutorial_attribute_04.png)

    ![특성 추가 대화 상자](./media/etouches-tutorial/tutorial_attribute_05.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/etouches-tutorial/tutorial_etouches_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/etouches-tutorial/tutorial_general_400.png)
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/etouches-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/etouches-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![추가 단추](./media/etouches-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![사용자 대화 상자](./media/etouches-tutorial/create_aaduser_04.png) 
...
1. 애플리케이션 목록에서 **etouches**를 선택합니다.
    ...
    ![애플리케이션 목록의 etouches 링크](./media/etouches-tutorial/tutorial_etouches_app.png) 
...
액세스 패널에서 etouches 타일을 클릭하면 etouches 애플리케이션에 자동으로 로그온됩니다.
