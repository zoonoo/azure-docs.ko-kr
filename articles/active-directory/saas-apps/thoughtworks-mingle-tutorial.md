...
1. **[Thoughtworks Mingle 테스트 사용자 만들기](#create-a-thoughtworks-mingle-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Thoughtworks Mingle에 만듭니다.
...
1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/thoughtworks-mingle-tutorial/tutorial_thoughtworksmingle_samlbase.png)

1. **Thoughtworks Mingle 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Thoughtworks Mingle 도메인 및 URL Single Sign-On 정보](./media/thoughtworks-mingle-tutorial/tutorial_thoughtworksmingle_url.png)
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/thoughtworks-mingle-tutorial/tutorial_thoughtworksmingle_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/thoughtworks-mingle-tutorial/tutorial_general_400.png)

1. **Thoughtworks Mingle** 회사 사이트에 관리자 권한으로 로그인합니다.

1. **관리자** 탭을 클릭하고 **SSO 구성**을 클릭합니다.
   
    ![관리 탭](./media/thoughtworks-mingle-tutorial/ic785157.png "SSO 구성")

1. **SSO 구성** 섹션에서 다음 단계를 수행합니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/thoughtworks-mingle-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/thoughtworks-mingle-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![추가 단추](./media/thoughtworks-mingle-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![사용자 대화 상자](./media/thoughtworks-mingle-tutorial/create_aaduser_04.png) 
