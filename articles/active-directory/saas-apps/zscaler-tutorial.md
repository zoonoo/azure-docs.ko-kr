...
5. **사용자 및 그룹** 대화 상자의 목록에서 **Britta Simon** 등의 사용자를 선택한 다음, 화면 맨 아래에서 **선택** 단추를 클릭합니다.
    ...
    ![스크린샷은 사용자를 선택할 수 있는 사용자 및 그룹 대화 상자를 보여줍니다.](./media/zscaler-tutorial/tutorial_zscaler_users.png)

6. **역할 선택** 대화 상자의 목록에서 적절한 사용자 역할을 선택한 다음, 화면 맨 아래에서 **선택** 단추를 클릭합니다.

    ![스크린샷은 사용자 역할을 선택할 수 있는 역할 선택 대화 상자를 보여줍니다.](./media/zscaler-tutorial/tutorial_zscaler_roles.png)

7. **할당 추가** 대화 상자에서 **할당** 단추를 선택합니다.

    ![스크린샷은 할당을 선택할 수 있는 할당 추가 대화 상자를 보여줍니다.](./media/zscaler-tutorial/tutorial_zscaler_assign.png)
...
액세스 패널에서 Zscaler 타일을 클릭하면 SSO를 설정한 Zscaler에 자동으로 로그인되어야 합니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](../user-help/my-apps-portal-end-user-access.md)를 참조하세요.
