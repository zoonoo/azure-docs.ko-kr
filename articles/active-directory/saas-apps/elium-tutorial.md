...
* Elium Single Sign-On을 사용하도록 설정된 구독
...
4. 검색 상자에서 **Elium**을 입력하고, 결과 패널에서 **Elium**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
Single Sign-On이 작동하려면 Azure AD 사용자와 Elium의 관련 사용자 간에 연결 관계를 설정해야 합니다.

Elium에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configure-azure-ad-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Elium Single Sign-On 구성](#configure-elium-single-sign-on)** - 애플리케이션 쪽에서 Single Sign-On 설정을 구성합니다.
3. **[Azure AD 테스트 사용자 만들기](#create-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
4. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Elium 테스트 사용자 만들기](#create-elium-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Elium에 만듭니다.
...
1. [Azure Portal](https://portal.azure.com/)의 **Elium** 애플리케이션 통합 페이지에서 **Single Sign-On**을 선택합니다.
...
4. **IDP** 시작 모드에서 애플리케이션을 구성하려면 **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    ![Elium 도메인 및 URL Single Sign-On 정보](common/idp-intiated.png)
...
5. **SP** 시작 모드에서 애플리케이션을 구성하려면 **추가 URL 설정**을 클릭하고 다음 단계를 수행합니다.
    ...
    ![Elium 도메인 및 URL Single Sign-On 정보](common/metadata-upload-additional-signon.png)
...
6. Elium 애플리케이션에는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **사용자 특성** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. **SAML로 Single Sign-On 설정** 페이지에서 **편집** 단추를 클릭하여 **사용자 특성** 대화 상자를 엽니다.
...
9. **Elium 설정** 섹션에서 요구 사항에 따라 적절한 URL을 복사합니다.
...
### <a name="configure-elium-single-sign-on"></a>Elium Single Sign-On 구성

1. 다른 웹 브라우저 창에서 Elium 회사 사이트에 관리자 권한으로 로그인합니다.

2. 오른쪽 위 모서리에서 **사용자 프로필**을 클릭한 다음, **관리**를 선택합니다.
...
4. **SSO(Single Sign-On)** 섹션까지 아래로 스크롤하여 다음 단계를 수행합니다.
...
1. Azure Portal에서 **엔터프라이즈 애플리케이션**, **모든 애플리케이션**, **Elium**을 차례로 선택합니다.

    ![엔터프라이즈 애플리케이션 블레이드](common/enterprise-applications.png)

2. 애플리케이션 목록에서 **Elium**을 선택합니다.

    ![애플리케이션 목록의 Elium 링크](common/all-applications.png)
...
이 섹션에서는 Elium에서 Britta Simon이라는 사용자를 만듭니다. Elium은 기본적으로 사용하도록 설정되는 **Just-In-Time 프로비전**을 지원합니다. 이 섹션에 작업 항목이 없습니다. Elium에 사용자가 아직 없는 경우 Elium에 액세스하려고 할 때 새 사용자가 만들어집니다.
...
액세스 패널에서 Elium 타일을 클릭하면 SSO를 설정한 Elium에 자동으로 로그인됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
