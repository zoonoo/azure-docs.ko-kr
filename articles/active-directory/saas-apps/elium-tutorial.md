...
1. 검색 상자에서 **Elium**을 입력하고, 결과 패널에서 **Elium**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Elium](./media/elium-tutorial/tutorial_elium_addfromgallery.png)
...
1. **[Elium 테스트 사용자 만들기](#create-an-elium-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Elium에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고, Elium 애플리케이션에서 Single Sign-On을 구성합니다.

**Elium에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Elium** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. Elium 애플리케이션에는 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가해야 하는 특정 형식의 SAML 어설션이 필요합니다. 이 애플리케이션에 대해 다음 클레임을 구성합니다. 애플리케이션 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다.
...
1. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/elium-tutorial/tutorial_elium_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/elium-tutorial/tutorial_general_400.png)
    
1. 다른 웹 브라우저 창에서 관리자 권한으로 Elium 회사 사이트에 로그인합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/elium-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/elium-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/elium-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/elium-tutorial/create_aaduser_04.png)
...
1. 애플리케이션 목록에서 **Elium**을 선택합니다.
    ...
    ![애플리케이션 목록의 Elium 링크](./media/elium-tutorial/tutorial_elium_app.png)  
...
액세스 패널에서 Elium 타일을 클릭하면 Elium 애플리케이션에 자동으로 로그온됩니다.
