...
1. Elium 응용 프로그램에는 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가해야 하는 특정 형식의 SAML 어설션이 필요합니다. 이 응용 프로그램에 대해 다음 클레임을 구성합니다. 응용 프로그램 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다.
...
1. 응용 프로그램 목록에서 **Elium**을 선택합니다.

    ![응용 프로그램 목록의 Elium 링크](./media/elium-tutorial/tutorial_elium_app.png)  
