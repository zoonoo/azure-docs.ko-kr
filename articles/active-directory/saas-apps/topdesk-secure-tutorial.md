...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 TOPdesk - Secure 애플리케이션에서 Single Sign-On을 구성합니다.

**TOPdesk - Secure에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **TOPdesk - Secure** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
3. **TOPdesk - Secure 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<companyname>.topdesk.net/tas/secure/login/verify` 패턴을 사용하여 URL을 입력합니다.
...
2. 애플리케이션 목록에서 **TOPdesk-Secure**를 선택합니다.

    ![애플리케이션 목록의 TOPdesk - Secure 링크](./media/topdesk-secure-tutorial/tutorial_topdesk-secure_app.png)  
...
액세스 패널에서 TOPdesk - Secure 타일을 클릭하면 TOPdesk - Secure 애플리케이션에 자동으로 로그온됩니다.
