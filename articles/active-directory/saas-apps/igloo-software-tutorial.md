...
4. **기본 SAML 구성** 섹션에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에 다음 패턴을 사용하여 URL을 입력합니다. `https://<company name>.igloocommmunities.com`

    b. **식별자** 텍스트 상자에서 다음 패턴을 사용하는 URL을 입력합니다. `https://<company name>.igloocommmunities.com/saml.digest`

    다. **회신 URL** 텍스트 상자에 다음 패턴을 사용하여 URL을 입력합니다. `https://<company name>.igloocommmunities.com/saml.digest`
...
3. **멤버 자격** 탭을 클릭하고 **로그인 설정**을 클릭합니다.
...
액세스 패널에서 Igloo Software 타일을 클릭하면 SSO를 설정한 Igloo Software에 자동으로 로그온됩니다. 액세스 패널에 대한 자세한 내용은 [액세스 패널 소개](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)를 참조하세요.
