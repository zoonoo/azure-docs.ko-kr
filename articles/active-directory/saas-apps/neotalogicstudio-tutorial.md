...
1. 검색 상자에 입력 **Neota Logic Studio**를 입력합니다.
...
1. **[Neota Logic Studio 테스트 사용자 만들기](#creating-a-neota-logic-studio-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Neota Logic Studio에 만듭니다.
...
1. **Neota Logic Studio 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://<sub domain>.neotalogic.com/wb` 패턴을 사용하여 URL을 입력합니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/neotalogicstudio-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/neotalogicstudio-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/neotalogicstudio-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/neotalogicstudio-tutorial/create_aaduser_04.png) 
