...
1. 검색 상자에서 **Evidence.com**을 입력하고, 결과 패널에서 **Evidence.com**을 선택한 다음, **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![결과 목록의 Evidence.com](./media/evidence-tutorial/tutorial_evidence.com_addfromgallery.png)
...
1. **[Evidence.com 테스트 사용자 만들기](#create-a-evidencecom-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Evidence.com에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assign-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#test-single-sign-on)** - 구성이 작동하는지 여부를 확인합니다.

### <a name="configure-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Evidence.com 애플리케이션에서 Single Sign-On을 구성합니다.

**Evidence.com에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Evidence.com** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.

    ![Single Sign-On 구성 링크][4]

1. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
 
    ![Single Sign-On 대화 상자](./media/evidence-tutorial/tutorial_evidence.com_samlbase.png)

1. **Evidence.com 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.

    ![Evidence.com 도메인 및 URL Single Sign-On 정보](./media/evidence-tutorial/tutorial_evidence.com_url.png)

    a. **로그온 URL** 텍스트 상자에서 다음 패턴으로 URL을 입력합니다. `https://<yourtenant>.evidence.com`

    b. **식별자** 텍스트 상자에서 `https://<yourtenant>.evidence.com` 패턴을 사용하여 URL을 입력합니다.
...
1. **SAML 서명 인증서** 섹션에서 **인증서(Base64)** 를 클릭한 후 컴퓨터에 인증서 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/evidence-tutorial/tutorial_evidence.com_certificate.png) 

1. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/evidence-tutorial/tutorial_general_400.png)

1. **Evidence.com 구성** 섹션에서 **Evidence.com 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **로그아웃 URL, SAML 엔터티 ID 및 SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Evidence.com 구성](./media/evidence-tutorial/tutorial_evidence.com_configure.png) 

1. 별도 웹 브라우저 창에서 Evidence.com 테넌트에 관리자 권한으로 로그인하고 **관리자** 탭으로 이동합니다.

1.  **Agency Single Sign On**

1.  **SAML 기반 Single Sign On**

1. Azure Portal에 표시된 **SAML 엔터티 ID**, **SAML Single Sign-On 서비스 URL** 및 **로그아웃 URL** 값을 Evidence.com의 해당 필드에 복사합니다.

1. 다운로드한 인증서(Base64) 파일을 메모장에서 열고 내용을 클립보드에 복사한 다음 **보안 인증서** 상자에 붙여넣습니다. 

1. Evidence.com에서 구성을 저장합니다.
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/evidence-tutorial/create_aaduser_01.png)

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/evidence-tutorial/create_aaduser_02.png)

1. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/evidence-tutorial/create_aaduser_03.png)

1. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/evidence-tutorial/create_aaduser_04.png)
...
1. 추가된 사용자의 **전자 메일 주소** 는 액세스 권한을 부여하려는 Azure AD 사용자의 사용자 이름과 일치해야 합니다. 조직에서 사용자 이름 및 이메일 주소가 동일한 값이 아닌 경우 Azure Portal의 **Evidence.com > 특성 > Single Sign-On** 섹션을 사용하여 Evidence.com에 보낼 nameidenitifer를 이메일 주소로 변경할 수 있습니다.
...
1. 애플리케이션 목록에서 **Evidence.com**을 선택합니다.
    ...
    ![애플리케이션 목록의 Evidence.com 링크](./media/evidence-tutorial/tutorial_evidence.com_app.png)  
...
액세스 패널에서 Evidence.com 타일을 클릭하면 Evidence.com 애플리케이션에 자동으로 로그온됩니다.
