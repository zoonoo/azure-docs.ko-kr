...
1. 검색 상자에 **Mixpanel**을 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/tutorial_mixpanel_search.png)

1. 결과 패널에서 **Mixpanel**을 선택하고 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.

    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/tutorial_mixpanel_addfromgallery.png)
...
1. **[Mixpanel 테스트 사용자 만들기](#creating-a-mixpanel-test-user)** - Britta Simon의 Azure AD 표현과 연결되는 대응 사용자를 Mixpanel에 만듭니다.
1. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
1. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configuring-azure-ad-single-sign-on"></a>Azure AD Single Sign-On 구성

이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Mixpanel 애플리케이션에서 Single Sign-On을 구성합니다.

**Mixpanel에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **Mixpanel** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **Mixpanel 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
1. **Mixpanel 구성** 섹션에서 **Mixpanel 구성**을 클릭하여 **로그인 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.
...
1. 페이지 왼쪽 아래에 있는 작은 **기어** 아이콘을 클릭합니다. 
   
    ![Mixpanel Single Sign-On](./media/mixpanel-tutorial/tutorial_mixpanel_06.png) 

1. **액세스 보안** 탭을 클릭한 후 **설정 변경**을 클릭합니다.
   
    ![Mixpanel 설정](./media/mixpanel-tutorial/tutorial_mixpanel_08.png) 

1. **인증서 변경** 대화 상자 페이지에서 다운로드한 인증서를 업로드하려면 **파일 선택**을 클릭한 후, **다음**을 클릭합니다.
   
    ![Mixpanel 설정](./media/mixpanel-tutorial/tutorial_mixpanel_09.png) 

1.  **인증 URL 변경** 대화 상자 페이지의 [인증 URL] 텍스트 상자에 Azure Portal에서 복사한 **SAML Single Sign-On 서비스 URL**의 값을 붙여넣고 나서 **다음**을 클릭합니다.
...
1. **Azure Portal**의 왼쪽 탐색 창에서 **Azure Active Directory** 아이콘을 클릭합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/create_aaduser_01.png) 

1. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.
    
    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/create_aaduser_02.png) 

1. **사용자** 대화 상자를 열려면 대화 상자 위쪽에서 **추가**를 클릭합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/create_aaduser_03.png) 

1. **사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
 
    ![Azure AD 테스트 사용자 만들기](./media/mixpanel-tutorial/create_aaduser_04.png) 
...
1. 페이지 맨 아래에서 **설정** 창을 열려면 왼쪽 아래에 있는 작은 기어 버튼을 클릭합니다.

1. **팀** 탭을 클릭합니다.

1. **팀 멤버** 텍스트 상자에 Azure에 있는 Britta의 메일 주소를 입력합니다.
...
액세스 패널에서 Mixpanel 타일을 클릭하면 Mixpanel 애플리케이션에 자동으로 로그인됩니다.
