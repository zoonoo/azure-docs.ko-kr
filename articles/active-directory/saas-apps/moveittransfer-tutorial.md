...
1. 검색 상자에 **MOVEit Transfer - Azure AD 통합**을 입력하고 결과 패널에서 **MOVEit Transfer - Azure AD 통합**을 선택한 다음 **추가** 단추를 클릭하여 애플리케이션을 추가합니다.
...
이 섹션에서는 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 MOVEit Transfer - Azure AD 통합 애플리케이션에서 Single Sign-On을 구성합니다.

**MOVEit Transfer - Azure AD 통합에서 Azure AD Single Sign-On을 구성하려면 다음 단계를 수행합니다.**

1. Azure Portal의 **MOVEit Transfer - Azure AD 통합** 애플리케이션 통합 페이지에서 **Single Sign-On**을 클릭합니다.
...
1. **MOVEit Transfer - Azure AD 통합 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에서 `https://contoso.com/<tenatid>` 패턴을 사용하여 URL을 입력합니다.
...
1. 애플리케이션 목록에서 **MOVEit Transfer - Azure AD 통합**을 선택합니다.
    ...
    ![애플리케이션 목록의 MOVEit Transfer - Azure AD 통합 링크](./media/moveittransfer-tutorial/tutorial_moveittransfer_app.png)  
...
액세스 패널에서 MOVEit Transfer - Azure AD 통합 타일을 클릭하면 MOVEit Transfer - Azure AD 통합 애플리케이션에 자동으로 로그온됩니다. 
