...
1. Pega Systems 애플리케이션에는 특정 형식을 갖는 SAML 어설션을 사용해야 합니다. 이를 위해서는 SAML 토큰 특성 구성에 사용자 지정 특성 매핑을 추가해야 합니다. 이러한 클레임은 고객의 요구 사항에 따라 달라집니다. 아래의 선택적 클레임은 하나의 예이며, 이를 사용자 애플리케이션에 구성해 볼 수 있습니다. 애플리케이션 통합 페이지의 **"사용자 특성"** 섹션에서 이러한 특성의 값을 관리할 수 있습니다. 
