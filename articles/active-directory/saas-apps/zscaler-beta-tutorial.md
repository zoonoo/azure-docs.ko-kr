...
4. 검색 상자에 **Zscaler Beta**를 입력합니다.

    ![Azure AD 테스트 사용자 만들기](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_search.png)

5. 결과 패널에서 **Zscaler Beta**를 선택하고 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
...
4. **[Zscaler Beta 테스트 사용자 만들기](#creating-a-zscaler-beta-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Zscaler Beta에 만듭니다.
...
3. **Zscaler Beta 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Zscaler Beta 구성** 섹션에서 **Zscaler Beta 구성**을 클릭하여 **로그온 구성** 창을 엽니다. **빠른 참조 섹션**에서 **SAML Single Sign-On 서비스 URL**을 복사합니다.

    ![Configure Single Sign-On](./media/zscaler-beta-tutorial/tutorial_zscalerbeta_configure.png) 

7. 다른 웹 브라우저 창에서 관리자로 Zscaler Beta 회사 사이트에 로그인합니다.
...
2. 응용 프로그램 목록에서 **Zscaler Beta**를 선택합니다.
