...
## <a name="enable-the-application-integration-for-adaptive-suite"></a>Adaptive Suite에 응용 프로그램 통합 사용
...
Adaptive Suite에 대한 Single Sign-On을 구성하려면 인증서의 손도장(thumbprint) 값을 검색해야 합니다. 이 절차를 잘 모르는 경우 [인증서의 지문 값을 검색하는 방법](http://youtu.be/YKQF266SAxI)을 참조하십시오.
