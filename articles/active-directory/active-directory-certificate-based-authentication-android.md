...
# Android에서 인증서 기반 인증 시작 - 공개 미리 보기  
...
이 항목에서는 Android 장치에서 Office 365 Enterprise, Business 및 Education 계획의 테넌트 사용자를 위해 CBA(인증서 기반 인증)를 구성하고 활용하는 방법을 보여 줍니다.
...
1.	테스트 장치에서 Google Play 스토어의 Office 모바일 응용 프로그램(예: OneDrive)을 설치합니다.
...
### Android에서 EAS 클라이언트 응용 프로그램 테스트 

Android 5.0(Lollipop) 이상의 응용 프로그램으로 인증서 인증을 테스트하려면 다음 단계를 수행합니다.

1. 위의 요구 사항을 충족하는 EAS 프로필을 응용 프로그램에서 구성합니다.


2. 프로필이 제대로 구성되면 응용 프로그램을 열고 메일이 동기화되는지 확인합니다.
