...
## <a name="add-additional-sync-administrators"></a>추가 동기화 관리자 추가
...
## <a name="assigning-licenses-to-azure-ad-premium-and-enterprise-mobility-users"></a>Azure AD Premium 및 엔터프라이즈 이동성 사용자에게 라이선스 할당
...
## <a name="verifying-the-scheduled-synchronization-task"></a>예약된 동기화 작업 확인
...
<center>![클라우드](./media/active-directory-aadconnect-whats-next/verify.png)</center>

## <a name="starting-a-scheduled-synchronization-task"></a>예약된 동기화 작업 시작
...
<center>![클라우드](./media/active-directory-aadconnect-whats-next/startsynch.png)</center>

Azure AD Connect 동기화: 스케줄러에 대한 자세한 내용은 [Azure AD Connect 스케줄러](active-directory-aadconnectsync-feature-scheduler.md)
