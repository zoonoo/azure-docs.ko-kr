...
이 문서에서는 Azure AD Reporting API를 시작하는 데 필요한 정보를 제공합니다. 다음 섹션에는 감사 및 로그인 API를 사용하는 방법에 대한 자세한 정보가 있습니다. 다른 모든 API는 [Azure AD 보고서 및 이벤트(미리 보기)](https://msdn.microsoft.com/Library/Azure/Ad/Graph/howto/azure-ad-reports-and-events-preview) 문서를 참조하세요.
