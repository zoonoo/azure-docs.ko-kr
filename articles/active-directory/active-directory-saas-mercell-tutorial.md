...
5. **메타데이터 URL**을 생성하려면 다음 단계를 수행합니다.
    ...
    d. 이제 **Mercell**의 속성 페이지로 이동한 후 **복사** 단추를 사용하여 **응용 프로그램 ID**를 복사하여 메모장에 붙여넣습니다.
...
6. **Mercell** 쪽에서 Single Sign-On을 구성하려면 생성된 **메타데이터 URL**을 [Mercell 지원 팀](mailto:webmaster@mercell.com)에 보내야 합니다. 이렇게 설정하면 SAML SSO 연결이 양쪽에서 제대로 설정됩니다.
