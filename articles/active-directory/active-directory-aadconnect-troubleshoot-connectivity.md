...
| **.verisign.com | HTTP/80 | CRL 목록을 다운로드하는 데 사용됩니다. | | *.entrust.com | HTTP/80 | MFA용 CRL 목록을 다운로드하는 데 사용합니다. | | *.windows.net | HTTPS/443 | Azure AD에 로그인하는 데 사용됩니다. | | secure.aadcdn.microsoftonline-p.com | HTTPS/443 | MFA에 사용됩니다. | | *.microsoftonline.com | HTTPS/443 | Azure AD 디렉터리 및 가져오기/내보내기 데이터를 구성하는 데 사용됩니다. |
