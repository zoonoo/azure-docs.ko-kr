...
에이전트를 설치하려면 다음 단계를 따르세요.
 ...
 9. **Active Directory 연결** 화면에서 **디렉터리 추가** 를 선택합니다. 그런 다음, Active Directory 관리자 계정으로 로그인합니다. 이 작업을 수행하면 온-프레미스 디렉터리가 추가됩니다. 
 10. 필요에 따라 **도메인 컨트롤러 우선 순위 선택** 및 도메인 컨트롤러 목록 순서 지정을 선택 하 여 에이전트가 사용 하는 도메인 컨트롤러의 기본 설정을 관리할 수 있습니다.   **확인** 을 클릭합니다.
  ![주문 도메인 controlllers](media/how-to-install/install-2a.png)</br>
 11. **새로 만들기** 를 선택합니다.
  ![Active Directory 연결 화면](media/how-to-install/install-3.png)</br>
 12. **서비스 계정 구성 화면** 에서 도메인 관리자 자격 증명을 입력 하 여 에이전트 서비스를 실행 하는 데 사용 되는 그룹 관리 서비스 계정을 만듭니다.  이 계정의 이름은 provAgentgMSA $로 지정 됩니다.
   ![GMSA 만들기](media/how-to-install/install-10.png)</br>
 13.  **에이전트 설치** 화면에서 설정 및 생성 될 계정을 확인 하 고 **확인** 을 클릭 합니다.
  ![설정 구성 확인](media/how-to-install/install-11.png)</br>
 14. 이 작업이 완료 **되 면 에이전트 설치가 완료 된 것** 을 확인할 수 있습니다. **끝내기** 를 선택합니다.
