...
1. 사용자 개체에서 `ExtensionAttribute3`에 대 한 코드를 찾습니다.
    ...
    ```
1. 회사 특성이 `ExtensionAttribute3`에 매핑되도록 코드를 편집 합니다.
 ...
 1. 잠시 후 그래프 탐색기: `https://graph.microsoft.com/beta/users/{Azure AD user UPN}`에서 다음 쿼리를 실행 하 여 특성을 채우는 지 확인 합니다.
 1. 이제 값이 표시 됩니다.
