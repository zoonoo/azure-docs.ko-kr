...
이 보고서에는 사전 통합된 Microsoft 응용 프로그램을 비롯하여 디렉터리에 액세스 권한이 있는 _모든_ 응용 프로그램에 대한 로그인이 포함됩니다.
...
- 사용자에게 연락하여 활동 확인
- 사용자 암호 재설정
- 추가 보안을 위해 [다단계 인증](multi-factor-authentication-get-started.md) 사용
