...
3. **Jive 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
...
6. **Jive** 쪽에서 Single Sign-On을 구성하려면 Jive 테넌트에 관리자 권한으로 로그온합니다.

7. 메뉴 위쪽에서 "**SAML**"을 클릭합니다.
...
Jive 플랫폼에서 사용자를 추가하려면 [Jive 클라이언트 지원 팀](https://www.jivesoftware.com/services-support/)에 문의하세요.
...
* [사용자 프로비저닝 구성](active-directory-saas-jive-provisioning-tutorial.md)
