...
## <a name="enable-the-application-integration-for-replicon"></a>Replicon에 응용 프로그램 통합 사용
이 섹션은 Replicon에 응용 프로그램 통합을 사용하도록 설정하는 방법을 간략하게 설명하기 위한 것입니다.

**Replicon에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.**
...
6. 다음 단계를 수행하여 SAML 2.0을 구성합니다.
  ...
  1. **EnableSAML Authentication2** 대화 상자를 표시하려면 URL에서 회사 키 다음에 **/services/SecurityService1.svc/help/test/EnableSAMLAuthentication2**를 추가합니다.  
