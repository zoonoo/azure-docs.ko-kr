<properties 
    pageTitle="자습서: TeamSeer와 Azure Active Directory 통합 | Microsoft Azure" 
...
11. Azure AD 포털에서 Single Sign-On 구성 확인을 선택한 다음 **완료**를 클릭하여 **Single Sign-On 구성** 대화 상자를 닫습니다.
