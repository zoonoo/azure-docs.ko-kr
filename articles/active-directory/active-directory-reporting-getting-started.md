...
### <a name="sign-into-the-azure-classic-portal"></a>Azure 클래식 포털에 로그인하기
먼저, [Azure 클래식 포털](https://manage.windowsazure.com)에 전역 또는 규정 준수 관리자로 로그인해야 합니다. Azure 구독 서비스 관리자 또는 공동 관리자이어야 하거나, "Azure AD에 액세스" Azure 구독을 사용해야 합니다.

### <a name="navigate-to-reports"></a>보고서 탐색
...
### <a name="download-the-reports-as-csv"></a>보고서를 CSV로 다운로드
...
### <a name="integrate-with-the-azure-ad-reporting-api"></a>Azure AD Reporting API와 통합
[Reporting API 시작](active-directory-reporting-api-getting-started.md)을 참조하세요.

### <a name="engage-multifactor-authentication-on-users"></a>사용자에 대해 Multi-Factor Authentication 적용
보고서에서 사용자를 선택합니다.
