...
description: Azure Active Directory에서 OfficeSpace Software를 사용하여 Single Sign-On, 자동화된 프로비전 등을 사용하도록 설정하는 방법을 알아봅니다.
...
이 자습서를 완료하면 OfficeSpace Software에 할당한 Azure AD 사용자가 OfficeSpace Software 회사 사이트(서비스 공급자가 제공한 로그온)에서 또는 [액세스 패널 소개](active-directory-saas-access-panel-introduction.md)를 사용하여 응용 프로그램에 Single Sign-On 할 수 있습니다.
...
1. Azure 클래식 포털의 **OfficeSpace Software** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
...
8. **SAML 권한 부여** 섹션에서 다음 단계를 수행합니다.
   ...
   1. Azure 클래식 포털의 **OfficeSpace Software에서 Single Sign-On 구성** 대화 상자 페이지에서 **원격 로그인 URL** 값을 복사한 다음 **로그아웃 공급자 URL** 텍스트 상자에 붙여넣습니다.
   2. Azure 클래식 포털의 **OfficeSpace Software에서 Single Sign-On 구성** 대화 상자 페이지에서 **원격 로그아웃 URL** 값을 복사한 다음 **클라이언트 idp 대상 URL** 텍스트 상자에 붙여넣습니다.
...
> [!NOTE]
> 다른 OfficeSpace Software 사용자 계정 생성 도구 또는 OfficeSpace Software가 제공한 API를 사용하여 AAD 사용자 계정을 프로비전할 수 있습니다.
> 
> 
