...
Azure AD 응용 프로그램 프록시를 처음 사용하는 경우 응용 프로그램을 게시하기 전에 개인 네트워크에서 웹 사이트를 게시하여 커넥터를 테스트합니다.
...
사용자가 게시된 응용 프로그램에 액세스하기 위해서는 개별적으로 또는 그룹에 할당되어야 합니다. 사전 인증을 필요로 하는 앱의 경우 이렇게 하면 앱을 사용할 권한이 부여됩니다. 사전 인증을 요구하지 않는 앱의 경우 해당 응용 프로그램 목록에 표시되도록 사용자를 앱에 할당해야 합니다.
