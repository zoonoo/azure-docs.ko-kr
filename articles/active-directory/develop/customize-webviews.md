...
| [SFAuthenticationSession](https://developer.apple.com/documentation/safariservices/sfauthenticationsession) | 시스템 | iOS11 이상 | 해당 없음 | yes | iOS만 |  w/Safari 인스턴스
...
| **SFSafariViewController** | 시스템 | iOS10 | 해당 없음 | yes | iOS만 |  w/Safari 인스턴스
| **WKWebView**  | 앱 내 | iOS8 이상 | macOS 10.10 이상 | 예 | iOS 및 macOS | 아니요**
