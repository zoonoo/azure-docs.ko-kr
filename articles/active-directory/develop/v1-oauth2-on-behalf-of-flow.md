...
On-Behalf-Of 흐름을 구성하는 단계는 다음과 같습니다. ![OAuth 2.0 for flow의 단계를 표시 합니다.](./media/v1-oauth2-on-behalf-of-flow/active-directory-protocols-oauth-on-behalf-of-flow.png)
