...
* Microsoft Graph API를 사용 하 여 토큰 수명 정책을 관리 하는 방법에 대해 자세히 알아보려면 [정책 리소스](https://docs.microsoft.com/graph/api/resources/policy?view=graph-rest-beta)를 참조 하세요.
