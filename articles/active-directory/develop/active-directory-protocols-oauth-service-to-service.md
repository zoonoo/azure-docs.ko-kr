...
| client_secret |필수 |Azure AD에서 호출 웹 서비스 또는 디먼 응용 프로그램에 대해 등록된 키를 입력합니다. 키를 만들려면 Azure Portal에서 **Azure Active Directory**, **앱 등록** 및 응용 프로그램, **설정** 및 **키**를 차례로 클릭하고, 키를 추가합니다.  이 비밀을 제공하는 경우 URL로 인코딩합니다. |
