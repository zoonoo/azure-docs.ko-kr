...
1. [응용 프로그램 등록 포털](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/documentation/articles&deeplink=/appList)에서 응용 프로그램으로 이동하거나 응용 프로그램이 없는 경우 [응용 프로그램을 만듭니다](quickstart-v2-register-an-app.md). 응용 프로그램을 만들 때 하나 이상의 응용 프로그램 암호를 사용해야 합니다.
