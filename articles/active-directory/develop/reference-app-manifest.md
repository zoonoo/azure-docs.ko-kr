...
| `homepage` | string | 응용 프로그램의 홈페이지에 대 한 URL입니다. <br><br> _참고:이 기능은 앱 등록 (레거시) 환경 에서만 사용할 수 있습니다. [앱 등록](https://go.microsoft.com/fwlink/?linkid=2083908) 환경에서 `signInUrl`로 대체 되었습니다._ | `"https://MyRegisteredApp"` |
