...
description: 사용자 지정 개발된 다중 테넌트 응용 프로그램을 Azure AD 응용 프로그램 갤러리에서 나열하는 방법을 설명합니다.
...
SAML 또는 OpenIDConnect를 지원하지 않는 응용 프로그램이라도 암호 Single Sign-On 기술을 통해 응용 프로그램 갤러리에 통합할 수 있습니다.

암호 Single Sign-On('암호 저장'이라고도 함)을 사용하면 ID 페더레이션을 지원하지 않는 웹 응용 프로그램에 대한 사용자 액세스 및 암호를 관리할 수 있습니다. 여러 사용자가 조직의 소셜 미디어 앱 계정과 같은 단일 계정을 공유해야 하는 시나리오에도 유용합니다. 

이 기술을 사용하여 응용 프로그램을 나열하려면 다음을 수행합니다.
