...
새 macOS 및 iOS 애플리케이션의 경우 다음과 같이 Microsoft ID 플랫폼(v2.0) 및 MSAL을 사용하여 토큰을 획득하고 보안 웹 API에 액세스하는 것이 좋습니다. [빠른 시작: iOS 또는 macOS 앱에서 사용자를 로그인하고 Microsoft Graph API를 호출](quickstart-v2-ios.md)합니다.
