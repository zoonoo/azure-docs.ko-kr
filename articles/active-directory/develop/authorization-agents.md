...
| -- |:-------------:| -----:|-----:|-----:|-----:|-----:|
| Nexus 4 (API 17) | 전달을 | 전달을 |해당 없음 |해당 없음 |해당 없음 |해당 없음 |
| Samsung S7 (API 25) | 전달을 | 전달을 | 전달을 | 전달을 | 통과 |전달을 |
| Huawei (API 26) |pass * * | 전달을 | 통과 | 전달을 | 전달을 |전달을 |
| Vivo (API 26) |전달을|전달을|전달을|전달을|전달을|통과|
| 픽셀 2 (API 26) |전달을 | 전달을 | 전달을 | 전달을 | 통과 |전달을 |
