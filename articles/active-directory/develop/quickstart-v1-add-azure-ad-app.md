...
description: Azure AD(Azure Active Directory) v1.0 엔드포인트에 애플리케이션을 추가하고 등록하는 방법을 알아봅니다.
...
엔터프라이즈 개발자 및 소프트웨어 SaaS(software-as-a-service) 공급자는 Azure AD(Azure Active directory)와 함께 통합되어 해당 서비스에 대한 보안 로그인 및 권한 부여를 제공하는 상용 클라우드 서비스 또는 업무용 애플리케이션 제품군을 개발할 수 있습니다. 애플리케이션 또는 서비스를 Azure AD와 통합하려면 개발자가 먼저 Azure AD에 애플리케이션을 등록해야 합니다.
...
- 애플리케이션 등록에서 추가 구성 기능(예: 자격 증명, 사용 권한, 다른 테넌트의 사용자 로그인 사용)을 사용하도록 설정하려면 [Azure AD에서 애플리케이션 업데이트](quickstart-v1-update-azure-ad-app.md)를 참조하세요.
...
- Azure Active Directory를 사용하여 애플리케이션을 개발할 때 사용해야 하는 브랜딩 지침에 대한 자세한 내용은 [애플리케이션에 대한 브랜딩 지침](howto-add-branding-in-azure-ad-apps.md)을 참조하세요.
