---
title: Azure Active Directory v2 Windows 데스크톱 시작 | Microsoft Docs
description: Windows Desktop .NET(XAML) 응용 프로그램이 액세스 토큰을 가져와서 Azure Active Directory v2 끝점으로 보호되는 API를 호출하는 방법입니다.
