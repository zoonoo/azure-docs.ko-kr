---
title: 웹 Api를 호출 하는 web API | Microsoft
...
MSAL Python을 사용 하 여이 흐름을 설명 하는 샘플은 transact-sql [에서](https://github.com/Azure-Samples/ms-identity-python-on-behalf-of)사용할 수 있습니다.
