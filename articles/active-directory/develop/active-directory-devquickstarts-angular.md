...
5. 프롬프트에 따라 새 웹 응용 프로그램 및/또는 Web API를 만듭니다.
  ...
  * **리디렉션 Uri**는 Azure AD가 토큰을 반환할 위치입니다. 이 샘플의 기본 위치는 `https://localhost:44326/`입니다.
...
8. 응용 프로그램에 대해 테넌트 전체에서 권한을 부여합니다. **설정** > **속성** > **필요한 권한**으로 이동하고 위쪽 막대에서 **권한 부여** 단추를 클릭합니다. **예** 를 클릭하여 확인합니다.
