...
> [!NOTE]
> Microsoft. Identity. Web을 사용 하 고appsettings.js에를 설정 하지 않으면 `Audience` 다음이 사용 됩니다. 
...
이 시나리오의 다음 문서로 이동 하 여 [코드의 범위 및 앱 역할을 확인](scenario-protected-web-api-verification-scope-app-roles.md)합니다.
