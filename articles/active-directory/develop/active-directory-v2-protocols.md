...
> [!TIP]
> Azure AD에 등록 된 모든 앱 개인 계정에 로그인 하지 하더라도 v2.0 끝점을 사용할 수 있습니다.  이 이렇게 하면 기존 응용 프로그램을 v2.0 마이그레이션할 수 있습니다 하 고 [MSAL](reference-v2-libraries.md) 응용 프로그램을 다시 만들어야만 합니다.  
