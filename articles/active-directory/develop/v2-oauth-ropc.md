...
Microsoft id 플랫폼은 응용 프로그램이 암호를 직접 처리 하 여 사용자에 게 로그인 할 수 있도록 하는 [OAuth 2.0 리소스 소유자 암호 자격 증명 (ROPC) 부여](https://tools.ietf.org/html/rfc6749#section-4.3)를 지원 합니다.
