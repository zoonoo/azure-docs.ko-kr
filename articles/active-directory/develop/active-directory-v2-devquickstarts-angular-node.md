---
title: Azure AD v2.0 NodeJS AngularJS 단일 페이지 앱 시작하기 | Microsoft Docs
...
---
# <a name="add-sign-in-to-an-angularjs-single-page-app---nodejs"></a>AngularJS 단일 페이지 앱에 로그인 추가 - NodeJS
...
골격 앱은 간단한 AngularJS 앱에 대한 모든 상용구 코드를 포함하지만 ID 관련 부분은 전혀 포함하지 않습니다. 따라서 진행하지 않으려면 전체 샘플을 대신 복제하거나 [다운로드](https://github.com/AzureADQuickStarts/AppModelv2-SinglePageApp-AngularJS-NodeJS/archive/complete.zip) 합니다.
