...
| 필드           | Description        |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 클라이언트 암호            | 클라이언트 암호 또는 키를 만들어 사용자 개입 없이 Azure AD로 보호 되는 웹 Api에 프로그래밍 방식으로 액세스할 수 있습니다. **새 클라이언트 암호** 페이지에서 키 설명 및 만료 날짜를 입력 하 고 저장을 입력 하 여 키를 생성 합니다. 나중에 액세스하지 못하므로 키를 안전한 곳에 보관하세요.             |
