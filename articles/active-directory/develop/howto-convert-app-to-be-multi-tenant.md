...
애플리케이션이 Azure AD에서 수신한 토큰의 유효성을 검사하는 방법을 살펴보겠습니다. 단일 테넌트 애플리케이션은 일반적으로 다음과 같은 엔드포인트 값을 사용합니다.
