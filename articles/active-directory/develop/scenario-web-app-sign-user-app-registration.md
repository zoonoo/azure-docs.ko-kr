...
1. **애플리케이션 등록** 페이지가 표시되면 애플리케이션의 등록 정보를 입력합니다.
   ...
   ![등록을 선택할 수 있는 응용 프로그램 등록 페이지를 보여 주는 스크린샷](media/scenario-webapp/scenario-webapp-app-registration-1.png)
1. **인증** 메뉴를 선택한 후 다음 정보를 추가합니다.
   ...
   1. **저장** 을 선택합니다.
  ![설명 된 변경 내용을 적용할 수 있는 인증 옵션을 보여 주는 스크린샷](media/scenario-webapp/scenario-webapp-app-registration-2.png)
