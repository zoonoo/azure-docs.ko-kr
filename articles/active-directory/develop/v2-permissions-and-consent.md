...
1. 사용 가능한 Api 목록에서 **Microsoft Graph** 을 선택 하 고 앱에 필요한 사용 권한을 추가 합니다.
1. **권한 추가** 를 선택 합니다.
