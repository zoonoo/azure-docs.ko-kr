...
- 보호 된 웹 API는 토큰의 유효성을 검사 하 고 MSAL (Microsoft Authentication `AcquireTokenOnBehalfOf` Library) 메서드를 사용 하 여 Azure Active Directory (Azure AD)에서 다른 토큰을 요청 합니다. 따라서 보호 된 웹 api는 사용자를 대신 하 여 두 번째 web api 또는 다운스트림 웹 api를 호출할 수 있습니다.
