...
> 이 샘플의 Visual Studio 프로젝트를 다운로드하고 싶으세요? [프로젝트를 다운로드](https://github.com/Azure-Samples/active-directory-dotnet-desktop-msgraph-v2/archive/master.zip)하면 실행 전 코드 샘플을 구성하는 [구성](#create-an-application-express "구성 단계")의 단계를 건너뛸 수 있습니다.
