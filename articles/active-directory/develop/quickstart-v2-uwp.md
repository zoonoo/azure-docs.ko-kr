...
---
# <a name="quickstart-call-the-microsoft-graph-api-from-a-universal-windows-platform-uwp-application"></a>빠른 시작: 유니버설 Windows 플랫폼(UWP) 응용 프로그램에서 Microsoft Graph API 호출
...
> 응용 프로그램을 등록하고 앱의 등록 정보를 솔루션에 추가하려면 다음 단계를 따르세요.
