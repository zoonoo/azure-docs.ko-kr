...
JSON 웹 토큰에 대한 자세한 내용은 [JWT IETF 초안 사양](http://go.microsoft.com/fwlink/?LinkId=392344)을 참조하세요. 토큰 유형 및 클레임에 대한 자세한 내용은 [지원되는 토큰 및 클레임 유형](v1-id-and-access-tokens.md)을 읽어 보세요.
