...
> 1. 작업을 마쳤으면 **등록**을 선택합니다.  앱 **개요** 페이지에서 **응용 프로그램(클라이언트) ID** 값을 기록해 둡니다.
> 1. 이 빠른 시작에서는 [암시적 허용 흐름](v2-oauth2-implicit-grant-flow.md)을 사용하도록 설정해야 합니다. 등록된 응용 프로그램의 왼쪽 탐색 창에서 **인증**을 선택합니다.
