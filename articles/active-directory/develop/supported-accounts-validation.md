...
등록 된 응용 프로그램의 경우 응용 프로그램의 **인증** 섹션에서 지원 되는 계정 유형 값을 찾을 수 있습니다. `signInAudience` **매니페스트의**속성 아래에서 찾을 수도 있습니다.
...
| 권한 있는 클라이언트 응용`preautorizedApplications`프로그램 () | 제한 없음 * | 제한 없음 * | 총 500 <br><br> 정의 된 최대 100 클라이언트 앱 <br><br> 클라이언트 당 최대 30 개 범위 정의 | 
