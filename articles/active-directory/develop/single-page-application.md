...
1. 인증에 성공하는 경우 Azure AD는 ID 토큰을 만들고 이 토큰을 애플리케이션의 회신 URL에 URL 조각(#)으로 반환합니다. 프로덕션 응용 프로그램의 경우 이 회신 URL은 HTTPS여야 합니다. 반환된 토큰에는 애플리케이션이 토큰의 유효성을 검사하는 데 필요한, 사용자 및 Azure AD에 대한 클레임이 포함됩니다.
