...
- 사용자가 조직에 속한 경우에만 로그인 할 수 있도록 할지 결정 합니다. 이 응용 프로그램은 단일 테 넌 트 응용 프로그램입니다. 또는 사용자가 회사 또는 학교 계정을 사용 하 여 로그인 하도록 허용 합니다. 다중 테 넌 트 응용 프로그램입니다. 또한 개인 Microsoft 계정 또는 연결 된, Google 등의 소셜 계정도 허용할 수 있습니다.
