...
- **공유 장치 모드 구현**: 병원, 제조, 소매 및 금융과 같은 공유 장치 시나리오에서 응용 프로그램을 사용할 수 있습니다. [공유 장치 모드 지원에 대해 자세히 읽어보십시오.](msal-shared-devices.md)
...
- iOS 및 Android에서 MSAL은 외부 브라우저를 사용하여 사용자를 로그인할 수 있습니다. 외부 브라우저가 앱 위에 나타날 수 있습니다.
