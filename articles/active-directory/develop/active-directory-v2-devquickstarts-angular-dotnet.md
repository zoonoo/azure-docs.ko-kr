...
우선 [앱 등록 포털](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/documentation/articles&deeplink=/appList)에서 앱을 만들거나 [자세한 단계](active-directory-v2-app-registration.md)에 따라서 진행합니다.  다음을 수행해야 합니다.
...
## <a name="set-up-the-rest-api"></a>REST API 설정
...
## <a name="call-the-rest-api"></a>REST API 호출
