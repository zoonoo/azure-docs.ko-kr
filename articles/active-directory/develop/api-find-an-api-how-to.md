...
API에 액세스하려면 액세스 범위 및 역할을 구성해야 합니다. 리소스 응용 프로그램 웹 Api를 클라이언트 응용 프로그램에 노출 하려면 API에 대 한 액세스 범위 및 역할을 구성 합니다. 클라이언트 응용 프로그램이 web API에 액세스 하도록 하려면 앱 등록에서 API에 액세스할 수 있는 권한을 구성 합니다.
