...
| [ADAL에 대한 모범 사례 오류 처리](https://docs.microsoft.com/azure/active-directory/develop/active-directory-devhowto-adal-error-handling) | 복원력 있는 오류 처리를 구축하고 로깅을 사용하도록 설정하는 방법 |
