---
title: Azure Active Directory v2.0 Android 시작 | Microsoft Docs
description: Android 앱이 액세스 토큰을 얻고 Azure Active Directory v2.0 엔드포인트에서 액세스 토큰이 필요한 Microsoft Graph API를 한 개 이상 호출할 수 있는 방법입니다.
