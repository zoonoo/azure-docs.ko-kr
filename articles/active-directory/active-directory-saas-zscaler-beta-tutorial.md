...
이 자습에서는 Azure와 ZScaler Beta 통합을 보여줍니다.  
...
![시나리오](./media/active-directory-saas-zscaler-beta-tutorial/IC800223.png "Scenario")

## <a name="enabling-the-application-integration-for-zscaler-beta"></a>ZScaler Beta에 응용 프로그램 통합
이 섹션에서는 ZScaler Beta에 응용 프로그램 통합 사용 방법을 간략하게 설명합니다.

### <a name="to-enable-the-application-integration-for-zscaler-beta-perform-the-following-steps"></a>ZScaler Beta에 응용 프로그램 통합을 사용하려면 다음 단계를 수행합니다.
...
3. 응용 프로그램 보기를 열려면 디렉터리 보기의 최상위 메뉴에서 **응용 프로그램** 을 클릭합니다.
   ...
   ![응용 프로그램](./media/active-directory-saas-zscaler-beta-tutorial/IC700994.png "Applications")
4. 페이지 맨 아래에 있는 **추가** 를 클릭합니다.
   
   ![응용 프로그램 추가](./media/active-directory-saas-zscaler-beta-tutorial/IC749321.png "Add application")
5. **수행할 작업** 대화 상자에서 **갤러리에서 응용 프로그램 추가**를 클릭합니다.
   
   ![갤러리에서 응용 프로그램 추가](./media/active-directory-saas-zscaler-beta-tutorial/IC749322.png "Add an application from gallerry")
6. **검색 상자**에 **ZScaler Beta**를 입력합니다.
   
   ![응용 프로그램 갤러리](./media/active-directory-saas-zscaler-beta-tutorial/IC800224.png "Application Gallery")
...
이 섹션의 목적은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD에서 자신의 계정으로 ZScaler Beta에 인증할 수 있게 하는 방법을 간략하게 설명하는 것입니다.  
이 절차의 일부로 base-64로 인코딩 된 인증서를 ZScaler Beta 테넌트로 업로드 해야 합니다.  
...
1. Azure 클래식 포털의 **ZScaler Beta** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
   ...
   ![Single Sign-on 구성](./media/active-directory-saas-zscaler-beta-tutorial/IC800225.png "Configure Single Sign-On")
2. **ZScaler Beta에 대한 사용자 로그온 방법을 선택하세요.** 페이지에서 **Microsoft Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
   
   ![Single Sign-On 구성](./media/active-directory-saas-zscaler-beta-tutorial/IC800226.png "Configure Single Sign-On")
3. **ZScaler Beta 로그인 URL** 텍스트 상자의 **앱 URL 구성** 페이지에서 사용자가 ZScaler Beta 응용 프로그램에 로그인할 때 사용하는 URL을 입력한 후, **다음**을 클릭합니다.
   
   ![앱 URL 구성](./media/active-directory-saas-zscaler-beta-tutorial/IC800227.png "Configure App URL")
   
   > [!NOTE]
   > 필요할 경우 ZScaler Beta 지원팀에서 사용자 환경의 실제값을 얻을 수 있습니다.
   > 
   > 
4. 인증서를 다운로드하려면 **ZScaler Beta에서 Single Sign-On 구성**의 **인증서 다운로드**를 클릭하여 컴퓨터에 인증서 파일을 저장합니다.
   
   ![Single Sign-on 구성](./media/active-directory-saas-zscaler-beta-tutorial/IC800228.png "Configure Single Sign-On")
5. 다른 웹 브라우저 창에서 관리자 권한으로 ZScaler 베타 회사 사이트에 로그인 합니다.
6. 위쪽의 메뉴에서 **관리**를 클릭합니다.
   
   ![관리](./media/active-directory-saas-zscaler-beta-tutorial/IC800206.png "Administration")
7. **관리자 & 역할 관리**에서 **사용자 및 인증 관리**를 클릭합니다.
   
   ![사용자 & 인증 관리](./media/active-directory-saas-zscaler-beta-tutorial/IC800207.png "Manage Users & Authentication")
8. **구성에 대한 인증 옵션 선택** 섹션에서, 다음 단계를 수행합니다.
   
   ![인증](./media/active-directory-saas-zscaler-beta-tutorial/IC800208.png "Authentication")
...
10. **사용자 인증 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![관리](./media/active-directory-saas-zscaler-beta-tutorial/IC800210.png "Administration")
    
    1. **Save**를 클릭합니다.
    2. **지금 활성화**를 클릭합니다.
11. Azure 클래식 포털의 **ZScaler Beta에서 Single Sign-On 구성** 대화 상자 페이지에서 Single Sign-On 구성 확인을 선택하고 **완료**를 클릭합니다.
    
    ![Single Sign-on 구성](./media/active-directory-saas-zscaler-beta-tutorial/IC800229.png "Configure Single Sign-On")
...
2. **도구** 메뉴에서 **인터넷 옵션**을 선택하여 **인터넷 옵션** 대화 상자를 엽니다.
   ...
   ![인터넷 옵션](./media/active-directory-saas-zscaler-beta-tutorial/IC769492.png "Internet Options")
3. **연결** 탭을 클릭합니다.
   
   ![연결](./media/active-directory-saas-zscaler-beta-tutorial/IC769493.png "Connections")
4. **LAN 설정**을 클릭하여 **LAN 설정** 대화 상자를 엽니다.
5. 프록시 서버 섹션에서 다음 단계를 수행합니다.
   
   ![프록시 서버](./media/active-directory-saas-zscaler-beta-tutorial/IC769494.png "Proxy server")
...
Azure AD 사용자가 ZScaler Beta에 로그인할 수 있도록 하려면 사용자 계정이 ZScaler Beta로 프로비전되어야 합니다.  
ZScaler 베타의 경우, 수동으로 프로비전합니다.

### <a name="to-configure-user-provisioning-perform-the-following-steps"></a>사용자 프로비저닝을 구성하려면
1. **Zscaler** 테넌트에 로그인 합니다.
2. **관리**를 클릭합니다.
   
   ![관리](./media/active-directory-saas-zscaler-beta-tutorial/IC781035.png "Administration")
3. **사용자 관리**를 클릭합니다.
   
   ![추가](./media/active-directory-saas-zscaler-beta-tutorial/IC781037.png "Add")
4. **사용자** 탭에서 **추가**를 클릭합니다.
   
   ![추가](./media/active-directory-saas-zscaler-beta-tutorial/IC781037.png "Add")
5. 사용자 추가 섹션에서 다음 단계를 수행합니다.
   
   ![사용자 추가](./media/active-directory-saas-zscaler-beta-tutorial/IC781038.png "Add User")
...
### <a name="to-assign-users-to-zscaler-beta-perform-the-following-steps"></a>ZScaler 베타로 사용자를 할당하려면 다음 단계를 수행합니다.
1. Azure 클래식 포털에서 테스트 계정을 만듭니다.
2. **ZScaler Beta** 통합 페이지에서 **사용자 할당**을 클릭합니다.
   
   ![사용자 할당](./media/active-directory-saas-zscaler-beta-tutorial/IC800230.png "Assign Users")
3. 테스트 사용자를 선택하고 **할당**을 클릭한 다음 **예**를 클릭하여 할당을 확인합니다.
   
   ![예](./media/active-directory-saas-zscaler-beta-tutorial/IC767830.png "Yes")
