...
4. 검색 상자에 **Envi MMIS**를 입력하고 결과 패널에서 **Envi MMIS**를 선택한 후 **추가** 단추를 클릭하여 응용 프로그램을 추가합니다.
    ...
    ![결과 목록의 Envi MMIS](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_addfromgallery.png)
...
2. **Single Sign-On** 대화 상자에서 **모드**를 **SAML 기반 로그온**으로 선택하여 Single Sign-On을 사용하도록 설정합니다.
    ...
    ![Single Sign-On 대화 상자](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_samlbase.png)

3. **Envi MMIS 도메인 및 URL** 섹션에서 **IDP** 시작 모드로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.

    ![Envi MMIS 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url.png)
...
4. **SP** 시작 모드에서 응용 프로그램을 구성하려면 **고급 URL 설정 표시**를 확인하고 다음 단계를 수행합니다.
    ...
    ![Envi MMIS 도메인 및 URL Single Sign-On 정보](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_url1.png)
...
5. **SAML 서명 인증서** 섹션에서 **메타데이터 XML**을 클릭한 후 컴퓨터에 메타데이터 파일을 저장합니다.
    ...
    ![인증서 다운로드 링크](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_certificate.png) 

6. **저장** 단추를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/tutorial_general_400.png)

7. 다른 웹 브라우저 창에서 Envi MMIS 회사 사이트에 관리자로 로그인합니다.

8. **내 도메인** 탭을 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure1.png)

9. **편집**을 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure2.png)

10. **원격 인증 사용** 확인란을 선택한 다음, **인증 형식** 드롭다운에서 **HTTP 리디렉션**을 선택합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure3.png)

11. **리소스** 탭을 선택한 다음, **메타데이터 업로드**를 클릭합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure4.png)

12. **메타데이터 업로드** 팝업에서 다음 단계를 수행합니다.

    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure5.png)
...
13. 다운로드한 메타데이터 파일을 업로드하면 필드가 자동으로 채워집니다. **업데이트**를 클릭합니다.
    ...
    ![Single Sign-On 구성 저장 단추](./media/active-directory-saas-envimmis-tutorial/configure6.png)
...
1. Azure Portal의 왼쪽 창에서 **Azure Active Directory** 단추를 클릭합니다.
    ...
    ![Azure Active Directory 단추](./media/active-directory-saas-envimmis-tutorial/create_aaduser_01.png)

2. 사용자 목록을 표시하려면 **사용자 및 그룹**으로 이동한 후 **모든 사용자**를 클릭합니다.

    !["사용자 및 그룹" 및 "모든 사용자" 링크](./media/active-directory-saas-envimmis-tutorial/create_aaduser_02.png)

3. **사용자** 대화 상자를 열려면 **모든 사용자** 대화 상자 위쪽에서 **추가**를 클릭합니다.

    ![추가 단추](./media/active-directory-saas-envimmis-tutorial/create_aaduser_03.png)

4. **사용자** 대화 상자에서 다음 단계를 수행합니다.

    ![사용자 대화 상자](./media/active-directory-saas-envimmis-tutorial/create_aaduser_04.png)
...
2. **사용자 목록** 탭을 클릭합니다.
    ...
    ![직원 추가](./media/active-directory-saas-envimmis-tutorial/user1.png)

3. **사용자 추가** 단추를 클릭합니다.

    ![직원 추가](./media/active-directory-saas-envimmis-tutorial/user2.png)

4. **사용자 추가** 섹션에서 다음 단계를 수행합니다.

    ![직원 추가](./media/active-directory-saas-envimmis-tutorial/user3.png)
...
2. 응용 프로그램 목록에서 **Envi MMIS**를 선택합니다.
    ...
    ![응용 프로그램 목록의 Envi MMIS 링크](./media/active-directory-saas-envimmis-tutorial/tutorial_envimmis_app.png)  
