...
* 유효한 Azure 구독
* Huddle SSO(Single Sign-On)가 설정된 구독
...
## <a name="enable-the-application-integration-for-huddle"></a>Huddle에 응용 프로그램 통합 사용
...
4. **Huddle의 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
   ...
   2. **발급자 URL** 값, **SAML SSO URL** 값 및 다운로드된 인증서를 복사한 다음 Huddle 지원팀에 보냅니다.  
    ...
    >[!NOTE]
    >Single Sign-on은 Huddle 지원팀에서 사용할 수 있어야 합니다. 구성이 완료되면 알림을 받아볼 수 있습니다. 
    > 
