<properties
	pageTitle="자습서: Printix와 Azure Active Directory 통합 | Microsoft Azure"
...
# 자습서: Printix와 Azure Active Directory 통합
...
> [AZURE.NOTE] 사용자를 수동으로 만들어야 하는 경우 Printix 지원 팀에 문의해야 합니다.
