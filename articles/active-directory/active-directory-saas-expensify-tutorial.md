...
1. **Expensify에서 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    b. **다음**을 클릭합니다.
2. Expensify에서 SSO를 사용하도록 설정하려면 먼저 응용 프로그램에서 **도메인 컨트롤** 을 사용하도록 설정해야 합니다. 응용 프로그램에서 도메인 컨트롤을 사용할 수 있습니다. 단계는 [여기](http://help.expensify.com/domain-control)에 나열됩니다. 추가 지원은 [help@expensify.com](mailto:help@expensify.com)을 참조하세요. 도메인 컨트롤을 사용하도록 설정한 후에는 다음 단계를 따릅니다.
