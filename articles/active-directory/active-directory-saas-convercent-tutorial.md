...
이 섹션에서는 새로운 Azure Portal에서 Azure AD Single Sign-On을 사용하도록 설정하고 Convercent 응용 프로그램에서 Single Sign-On을 구성합니다.
...
3. **Convercent 도메인 및 URL** 섹션에서 **IDP 시작 모드**로 응용 프로그램을 구성하려는 경우 다음 단계를 수행합니다.
    ...
    a. **식별자** 텍스트 상자에 `https://sts.convercent.com/`를 입력합니다.

    b. **"고급 URL 설정 표시"**를 클릭합니다.

    c. **릴레이 상태** 텍스트 상자에 다음을 입력합니다. `https://app.convercent.com/`
...
4. **SP 시작 모드**에서 응용 프로그램을 구성하려는 경우 **Convercent 도메인 및 URL** 섹션에서 다음 단계를 수행합니다.
    ...
    a. **로그온 URL** 텍스트 상자에 `https://app.convercent.com/`를 입력합니다.
