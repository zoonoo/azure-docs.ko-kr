...
이 자습서에서는 HPE SaaS와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다. HPE SaaS를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다.
...
Single Sign-On이 작동하려면 Azure AD에서 Azure AD 사용자에 해당하는 HPE SaaS 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 HPE SaaS의 관련 사용자 간에 연결이 형성되어야 합니다. 이 연결 관계는 Azure AD의 **사용자 이름** 값을 HPE SaaS의 **Username** 값으로 할당하여 설정합니다.

HPE SaaS에서 Azure AD Single Sign-On을 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-on 구성](#configuring-azure-ad-single-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On 테스트하는 데 사용합니다.
3. **[HPE SaaS 테스트 사용자 만들기](#creating-a-hpesaas-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 HPE SaaS에 만듭니다.
...
1. Azure 클래식 포털의 **HPE SaaS** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
   
    ![Single Sign-On 구성][6]
2. **HPE SaaS에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
   
    ![Single Sign-On 구성](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_03.png)
...
1. **HPE SaaS의 Single Sign-On 구성** 페이지에서 다음 단계를 수행합니다.
    ...
    ![Single Sign-On 구성](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_05.png)
...
1. **디렉터리** 목록에서 디렉터리 통합을 사용하도록 설정할 디렉터리를 선택합니다.
2. 사용자 목록을 표시하려면 위쪽 메뉴에서 **사용자**를 클릭합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_03.png)
3. **사용자 추가** 대화 상자를 열려면 아래쪽 도구 모음에서 **사용자 추가**를 클릭합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_04.png)
4. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_05.png)
    ...
    c. **Next**를 클릭합니다.
5. **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다.
   
   ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_06.png)
   ...
   e. **Next**를 클릭합니다.
6. **임시 암호 가져오기** 대화 상자 페이지에서 **만들기**를 클릭합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_07.png)
7. **임시 암호 가져오기** 대화 상자 페이지에서 다음 단계를 수행합니다.
   
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_08.png)
...
> [!NOTE]
> 사용자를 수동으로 만들어야 하는 경우 HPE SaaS 지원 팀에 문의해야 합니다.
> 
> 

### Azure AD 테스트 사용자 할당
이 섹션의 목적은 Britta Simon에게 HPE SaaS에 대한 액세스 권한을 부여하여 Azure Single Sign-On을 사용할 수 있도록 하는 것입니다.
...
2. 응용 프로그램 목록에서 **HPE SaaS**를 선택합니다.
    ...
    ![Single Sign-On 구성](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_50.png)
...
### Single Sign-On 테스트
이 섹션은 액세스 패널을 사용하여 Azure AD Single Sign-On 구성을 테스트하기 위한 것입니다. 액세스 패널에서 HPE SaaS 타일을 클릭하면 HPE SaaS 응용 프로그램에 자동으로 로그온됩니다.
