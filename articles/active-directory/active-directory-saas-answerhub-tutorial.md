...
이 자습서는 Azure 및 [AnswerHub](http://www.dzonesoftware.com/products/answerhub-question-answer-software)의 통합을 보여주기 위한 것입니다.  
...
###<a name="to-enable-the-application-integration-for-answerhub,-perform-the-following-steps:"></a>AnswerHub에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
이 섹션은 사용자가 SAML 프로토콜 기반 페더레이션을 사용하여 Azure AD의 계정으로 AnswerHub에 인증할 수 있게 하는 방법을 간략하게 설명하기 위한 것입니다.  
...
10. **IDP 구성** 탭에서 다음 단계를 수행합니다.
    ...
    3.  Azure 클래식 포털의 **AnswerHub에서 Single Sign-On 구성** 대화 상자 페이지에서 **이름 식별자 서식** 값을 복사한 다음 **IDP 이름 식별자 서식** 텍스트 상자에 붙여 넣습니다.
    4.  **키 및 인증서**를 클릭합니다.
...
###<a name="to-assign-users-to-answerhub,-perform-the-following-steps:"></a>AnswerHub에 사용자를 할당하려면 다음 단계를 수행합니다.
