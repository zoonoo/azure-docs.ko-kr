...
이 자습서를 완료한 후 AnswerHub에 할당한 Azure AD 사용자가 AnswerHub 회사 사이트(서비스 공급자가 시작한 로그온)에서 또는 [액세스 패널 소개](active-directory-saas-access-panel-introduction.md)를 사용하여 SSO(Single Sign-On)를 통해 응용 프로그램에 액세스할 수 있습니다.
...
## <a name="enable-the-application-integration-for-answerhub"></a>AnswerHub에 응용 프로그램 통합 사용
...
11. 키와 인증서 탭에서 다음 단계를 수행 합니다.
  ...
  1. 다운로드한 인증서에서 **Base-64로 인코딩된** 파일을 만듭니다.
    ...
    > 
  2. Base&64;로 인코딩된 인증서를 메모장에서 열고, 내용을 클립보드에 복사한 다음 **IDP 공용 키(x509 서식)** 텍스트 상자에 붙여 넣습니다.
  3. **Save**를 클릭합니다.
