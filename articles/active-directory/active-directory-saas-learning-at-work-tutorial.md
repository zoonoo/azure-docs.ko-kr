...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    b. **식별자** 텍스트 상자에 `https://<company name>.sabacloud.com/Saba/SAML/sso/alias/<company name>`` 패턴을 사용하여 URL을 입력합니다.
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서  ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_05.png) 단계를 수행합니다. 
    ...
    c. **다음**을 클릭합니다.
6. **사용자 프로필** 대화 상자 페이지에서 ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_06.png) 단계를 수행합니다. 
...
### <a name="creating-an-learning-at-work-test-user"></a>Learning at Work 테스트 사용자 만들기
