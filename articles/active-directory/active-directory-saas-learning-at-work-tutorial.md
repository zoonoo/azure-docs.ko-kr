...
* 사용자가 해당 Azure AD 계정으로 Learning at Work SSO(Single Sign-On)에 자동으로 로그온되도록 설정할 수 있습니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    1. **로그온 URL** 텍스트 상자에 `https://\<company name\>.sabacloud.com/Saba/Web/<company code>` 패턴을 사용하여 사용자가 Learning at Work 응용 프로그램에 로그온하는 데 사용할 URL을 입력합니다.
    2. **식별자** 텍스트 상자에 다음 패턴 `https://<company name>.sabacloud.com/Saba/SAML/sso/alias/<company name>`을 사용하여 URL을 입력합니다.
    3. **다음**을 클릭합니다.
...
5. **이 사용자에 대한 정보 입력** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_05.png) 
...
6. **사용자 프로필** 대화 상자 페이지에서 다음 단계를 수행합니다.
   ...
   ![Azure AD 테스트 사용자 만들기](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-learning-at-work-test-user"></a>Learning at Work 테스트 사용자 만들기
