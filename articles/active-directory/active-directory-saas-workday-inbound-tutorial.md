...
## <a name="configure-user-import-in-azure-ad"></a>Azure AD에서 사용자 가져오기 구성
...
2. **설정 및 관리자 자격 증명** 페이지에서 다음 단계를 수행하고 **다음**을 클릭합니다. 
  ...
  1. **Workday 관리자 이름** 텍스트 상자에 통합 시스템 사용자 만들기 섹션에서 만든 사용자의 이름을 입력합니다.
  2. **Workday 관리자 암호** 텍스트 상자에 통합 시스템 사용자 만들기 섹션에서 만든 사용자의 암호를 입력합니다.
