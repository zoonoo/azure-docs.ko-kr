...
2. **Halogen Software에 대한 사용자 로그온 방법을 선택하십시오.** 페이지에서 **Azure AD Single Sign-on**을 선택하고 **다음**을 클릭합니다.
...
8. **SAML 구성** 페이지에서 다음 단계를 수행합니다. ![Azure AD Connect의 정의][14]
...
3. **새 사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    c. **사용자 이름** 텍스트 상자에 **Azure 클래식 포털의 Brita Simon 사용자 이름**을 입력합니다.
