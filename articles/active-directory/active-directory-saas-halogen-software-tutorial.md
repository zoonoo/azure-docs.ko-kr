...
Single Sign-on이 작동되려면 Azure AD는 Azure AD의 사용자에 해당하는 Halogen Software의 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Halogen Software의 관련 사용자 간에 연결이 형성되어야 합니다.
...
이 섹션은 Azure 클래식 포털에서 Azure AD Single Sign-on을 사용하도록 설정하고 Halogen Software에서 Single Sign-on을 구성하는 방법을 설명하기 위해 제공되었습니다.
...
3. **앱 설정 구성** 대화 상자 페이지에서  ![앱 설정 구성][10] 단계를 수행합니다.
...
8. **SAML 구성** 페이지에서  ![Azure AD Connect 정의][14] 단계를 수행합니다.
...
3. **새 사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
    ...
    c. **사용자 이름** 텍스트 상자에 **Brita Simon의 Azure 클래식 포털 사용자 이름**을 입력합니다.
