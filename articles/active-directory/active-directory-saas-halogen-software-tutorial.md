---
title: "자습서: Halogen Software와 Azure Active Directory 통합"
...
이 자습서에서는 Halogen Software와 Azure AD(Azure Active Directory)를 통합하는 방법을 보여 줍니다.

Halogen Software를 Azure AD와 통합하면 다음과 같은 이점이 제공됩니다. 

* Halogen Software에 대한 액세스 권한이 있는 사용자를 Azure AD에서 제어할 수 있습니다. 
* 사용자가 해당 Azure AD 계정으로 Halogen Software SSO(Single Sign-on)에 자동으로 로그온되도록 설정할 수 있습니다.
...
5. **수행할 작업** 대화 상자에서 **갤러리에서 응용 프로그램 추가**를 클릭합니다.
    ...
    ![응용 프로그램][4]
6. 검색 상자에 **halogen software**를 입력합니다.
   
    ![응용 프로그램][5]
7. 결과 창에서 **Halogen Software**를 선택하고 **완료**를 클릭하여 응용 프로그램을 추가합니다.

## <a name="configure-and-test-azure-ad-sso"></a>Azure AD SSO 구성 및 테스트
이 섹션은 "Britta Simon"이라는 테스트 사용자를 기반으로 Halogen Software에서 Azure AD SSO를 구성하고 테스트하는 방법을 보여 주기 위해 작성되었습니다.

SSO가 작동되려면 Azure AD는 Azure AD의 사용자에 해당하는 Halogen Software의 사용자가 누군지 알고 있어야 합니다. 즉, Azure AD 사용자와 Halogen Software의 관련 사용자 간에 연결이 형성되어야 합니다.

이 연결 관계는 Azure AD의 **사용자 이름** 값을 Halogen Software의 **Username** 값으로 할당하여 설정합니다.

Halogen Software에서 Azure AD SSO를 구성하고 테스트하려면 다음 구성 요소를 완료해야 합니다.

1. **[Azure AD Single Sign-On 구성](#configuring-azure-ad-single-single-sign-on)** - 사용자가 이 기능을 사용할 수 있도록 합니다.
2. **[Azure AD 테스트 사용자 만들기](#creating-an-azure-ad-test-user)** - Britta Simon으로 Azure AD Single Sign-On을 테스트하는 데 사용합니다.
3. **[Halogen Software 테스트 사용자 만들기](#creating-a-halogen-software-test-user)** - Britta Simon의 Azure AD 표현과 연결된 해당 사용자를 Halogen Software에 만듭니다.
4. **[Azure AD 테스트 사용자 할당](#assigning-the-azure-ad-test-user)** - Britta Simon이 Azure AD Single Sign-on을 사용할 수 있도록 합니다.
5. **[Single Sign-On 테스트](#testing-single-sign-on)** - 구성이 작동하는지 확인합니다.

### <a name="configure-azure-ad-sso"></a>Azure AD SSO 구성
이 섹션은 Azure 클래식 포털에서 Azure AD SSO를 사용하도록 설정하고 Halogen Software 응용 프로그램에서 SSO를 구성하는 방법을 설명하기 위한 것입니다.

**Halogen Software에서 Azure AD SSO를 구성하려면 다음 단계를 수행합니다.**

1. Azure 클래식 포털의 **Halogen Software** 응용 프로그램 통합 페이지에서 **Single Sign-On 구성**을 클릭하여 **Single Sign-On 구성** 대화 상자를 엽니다.
   
    ![Single Sign-On 구성][8]
2. **Halogen Software에 대한 사용자 로그온 방법 선택** 페이지에서 **Azure AD Single Sign-on**을 선택하고 **다음**을 클릭합니다.
   
    ![Azure AD Single Sign-On][9]
3. **앱 설정 구성** 대화 상자 페이지에서 다음 단계를 수행합니다.

    ![앱 설정 구성][10]
   1. **로그온 URL** 텍스트 상자에 *https://global.hgncloud.com/fabrikam/welcome.jsp* 패턴을 사용하여 사용자가 Halogen Software 응용 프로그램에 로그온하는 데 사용하는 URL을 입력합니다.
   2. **다음**을 클릭합니다.
4. **Halogen Software에서 Single Sign-On 구성** 페이지에서 **메타데이터 다운로드**를 클릭한 다음 컴퓨터에 로컬로 메타데이터 파일을 저장합니다.
...
7. 왼쪽 탐색 창에서 **SAML 구성**을 클릭합니다. 
   
    ![Azure AD Connect의 정의][13]
8. **SAML 구성** 페이지에서 다음 단계를 수행합니다. 

    ![Azure AD Connect의 정의][14]
  1. **고유 식별자**로 **NameID**를 선택합니다.
  2. **고유 식별자 매핑 대상**으로 **Username**을 선택합니다.
  3. 다운로드한 메타데이터 파일을 업로드하려면 **찾아보기**를 클릭하여 파일을 선택하고 **파일 업로드**를 클릭합니다.
  4. 구성을 테스트하려면 **테스트 실행**을 클릭합니다. 
    >[!NOTE]
...
### <a name="create-a-halogen-software-test-user"></a>Halogen Software 테스트 사용자 만들기
...
3. **새 사용자** 대화 상자 페이지에서 다음 단계를 수행합니다.
  ...
  1. **이름** 텍스트 상자에 **Britta**를 입력합니다. 
  2. **성** 텍스트 상자에 **Simon**을 입력합니다. 
  3. **사용자 이름** 텍스트 상자에 **Brita Simon의 Azure 클래식 포털 사용자 이름**을 입력합니다.
  4. **암호** 텍스트 상자에 Britta에 대한 암호를 입력합니다.
  5. **Save**를 클릭합니다.

### <a name="assign-the-azure-ad-test-user"></a>Azure AD 테스트 사용자 할당
이 섹션은 Britta Simon에게 Halogen Software에 대한 액세스 권한을 부여하여 Azure SSO를 사용할 수 있도록 하기 위한 것입니다.
