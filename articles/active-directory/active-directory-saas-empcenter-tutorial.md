...
이 자습서는 Azure 및 EmpCenter의 통합을 보여주기 위한 것입니다.  
이 자습서에 설명된 시나리오에서는 사용자에게 이미 다음 항목이 있다고 가정합니다.

* 유효한 Azure 구독
* EmpCenter Single Sign-on이 설정된 구독

이 자습서를 완료한 후 EmpCenter에 할당한 Azure AD 사용자가 EmpCenter 회사 사이트(서비스 공급자가 시작한 로그온)에서 또는 [액세스 패널 소개](active-directory-saas-access-panel-introduction.md)를 사용하여 응용 프로그램에 Single Sign-On 할 수 있습니다.
...
### <a name="to-enable-the-application-integration-for-empcenter-perform-the-following-steps"></a>EmpCenter에 응용 프로그램 통합을 사용하도록 설정하려면 다음 단계를 수행합니다.
...
5. 다운로드한 메타데이터 파일을 EmpCenter 지원팀에 보냅니다.
   ...
   > [!NOTE]
   > EmpCenter 지원팀은 실제 SSO 구성을 수행해야 합니다.
...
### <a name="to-assign-users-to-empcenter-perform-the-following-steps"></a>EmpCenter에 사용자를 할당하려면 다음 단계를 수행합니다.
