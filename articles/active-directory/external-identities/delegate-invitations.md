...
6. **게스트에 대 한 일회성 암호 전자 메일** 에서 적절 한 설정을 선택 합니다 (자세한 내용은 [일회용 암호 인증 전자 메일](one-time-passcode.md)참조).
   ...
   > [!NOTE]
   > 위의 옵션 대신,이 기능을 사용 하거나 사용 하지 않도록 설정 했거나 이전에 미리 보기에 옵트인 한 경우 다음과 같은 설정이 표시 됩니다.
   >
