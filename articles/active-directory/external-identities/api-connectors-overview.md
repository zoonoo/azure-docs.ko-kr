...
개발자 또는 IT 관리자는 API 커넥터를 사용 하 여 웹 Api와 [셀프 서비스 등록 사용자 흐름](self-service-sign-up-overview.md) 을 통합 하 여 등록 환경을 사용자 지정 하 고 외부 시스템과 통합할 수 있습니다. 예를 들어 API 커넥터를 사용 하 여 다음을 수행할 수 있습니다.

- [**사용자 지정 승인 워크플로와 통합**](self-service-sign-up-add-approvals.md)합니다. 계정 생성을 관리 및 제한 하기 위해 사용자 지정 승인 시스템에 연결 합니다.
