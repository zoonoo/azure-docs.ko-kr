...
8. 그룹 소유자의 액세스 패널에 앱을 추가 하려면 **사용자** 사용자  >  **및 그룹** 추가를 선택 합니다. 그룹 소유자를 검색하여 사용자를 선택하고, **선택** 을 클릭한 다음, **할당** 을 클릭하여 사용자를 앱에 추가합니다.
