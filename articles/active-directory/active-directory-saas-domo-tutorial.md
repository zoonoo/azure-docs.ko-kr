...
9. **Domo** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **인증서**, **SAML 엔터티 ID**, **SAML Single Sign-On 서비스 URL** 및 **로그아웃 URL**을 [Domo 지원 팀](mailto:support@domo.com)으로 보내야 합니다. 그러면 SAML SSO 연결이 양쪽에 제대로 설정되도록 지정합니다.
