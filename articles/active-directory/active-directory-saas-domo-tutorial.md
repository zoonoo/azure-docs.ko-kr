...
3. **Domo에 대한 사용자 로그온 방법 선택 페이지**에서 **Azure AD Single Sign-On**을 선택하고 **다음**을 클릭합니다.
...
6. 응용 프로그램에 대해 구성된 SSO를 가져오려면 [support@domo.com](mailto: support@domo.com)로 Domo 지원 팀에 문의합니다. 이때 다운로드한 인증서를 첨부하고 **발급자 URL**, **SAML SSO URL** 및 **로그아웃 URL**을 제공합니다.
