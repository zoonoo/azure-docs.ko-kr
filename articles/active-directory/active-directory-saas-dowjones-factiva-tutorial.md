...
6. **Dow Jones Factiva** 쪽에서 Single Sign-On을 구성하려면 다운로드한 **메타데이터 XML**을 [Dow Jones Factiva 지원 팀](https://www.dowjones.com/contact/)에 보내야 합니다. 그러면 SAML SSO 연결이 양쪽에 제대로 설정되도록 지정합니다.
