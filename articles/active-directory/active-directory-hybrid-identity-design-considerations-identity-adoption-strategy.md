...
>[AZURE.NOTE]동기화 옵션에 대한 자세한 내용은 [Azure Active Directory와 온-프레미스 ID 통합](https://azure.microsoft.com/ko-KR/documentation/articles/active-directory-aadconnect/)을 참조하세요.
...
>[AZURE.NOTE]또한 선택한 Multi-Factor Authentication 설계 옵션이 설계에 필요한 기능을 지원하도록 해야 합니다. 자세한 내용은 [다단계 보안 솔루션 선택](https://azure.microsoft.com/documentation/articles/multi-factor-authentication-get-started/#what-am-i-trying-to-secure)을 참조하세요.
