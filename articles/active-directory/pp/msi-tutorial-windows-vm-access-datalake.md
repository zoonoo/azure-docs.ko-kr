...
VM MSI는 사용자가 만든 폴더에 있는 파일에서 모든 작업을 수행할 수 있습니다.  Data Lake Store에 대한 액세스 권한을 관리하는 방법에 대한 자세한 내용은 [Data Lake Store의 액세스 제어](~/articles/data-lake-store/data-lake-store-access-control.md)에서 이 문서를 참고하세요.
