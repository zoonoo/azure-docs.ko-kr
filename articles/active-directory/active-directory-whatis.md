...
## <a name="what-are-the-benefits-of-azure-ad"></a>Azure AD의 장점은 무엇입니까?
...
## <a name="how-does-azure-ad-compare-to-on-premises-active-directory-domain-services-ad-ds"></a>Azure AD와 온-프레미스 AD DS(Active Directory 도메인 서비스) 비교
...
| Azure AD                                   | 온-프레미스 AD DS |
|--------------------------------------------|-------------------|
| <li>   SAML      <li>   WS-Federation    <li>   지원되는 자격 증명을 사용하여 대화형으로  <li>   OAuth 2.0   <li>   OpenID Connect                          | <li>   SAML   <li>   WS-Federation  <li>   NTLM  <li>   Kerberos   <li>   MD5   <li>   Basic          |

### <a name="object-repository-details"></a>개체 리포지토리 세부 정보

| Azure AD                                          | 온-프레미스 AD DS |
|---------------------------------------------------|-------------------|
| Azure AD Graph 및 Microsoft Graph를 통한 액세스 | X.500 LDAP    |
...
| Azure AD           | 온-프레미스 AD DS   |
|--------------------|---------------------|
| <li>   OpenID Connect  <li>   SAML          | <li>   SAML      <li>   WS-Fed   <li>   Open-ID 연결  |

### <a name="access-management-details"></a>액세스 관리 세부 정보

| Azure AD         | 온-프레미스 AD DS     |
|------------------------------------|------------------------------------------------------------------------|
| <li>   리소스 정의 범위 및 역할 기반 액세스 제어   <li>   클라이언트 정의 위임 및 응용 프로그램 사용 권한        <li>   승인 프레임워크(리소스/클라이언트에서 정의/요청된 대로 적절한 사용자/관리자 승인 적용)  <li>   앱 역할을 통해, 개별적으로 또는 그룹을 통해 적용 가능, 지원 기능:   <ul> <li>   관리자 관리       <li>   셀프 서비스 응용 프로그램 액세스  <li>   사용자 승인 </ul>         | <li>   ACL을 통해, 개별적으로 또는 그룹을 통해 적용 가능, 지원 기능:  <ul><li>   관리자 관리  </ul>                                                 |

### <a name="group-management-details"></a>그룹 관리 세부 정보

| Azure AD                          | 온-프레미스 AD DS                                 |
|-----------------------------------|---------------------------------------------------|
| <li>   관리자 관리    <li>   규칙/동적 관리   <li>   셀프 서비스 그룹 관리  | <li>   관리자 관리      <li>   다음을 위한 외부 시스템(FIM 또는 기타) 필요:  <ul><li>   규칙/동적 관리      </ul>                 |

### <a name="supported-credentials-details"></a>지원되는 자격 증명 세부 정보

| Azure AD           | 온-프레미스 AD DS  |
|--------------------|--------------------|
| <li>   사용자 이름 + 암호  <li>   스마트 카드     | <li>   사용자 이름 + 암호  <li>   스마트 카드     |
