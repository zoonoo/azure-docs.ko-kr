...
4.  데이터베이스 **이름**에 값을 입력하고 **버전**[(WEB 또는 BUSINESS)](http://msdn.microsoft.com/ko-kr/library/windowsazure/ee621788.aspx), 데이터베이스의 **최대 크기**, **데이터 정렬** 및 **새 SQL 데이터베이스 서버**를 선택합니다. 대화 상자 맨 아래에 있는 화살표를 클릭합니다.
