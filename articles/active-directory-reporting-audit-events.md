...
| 사용자 라이선스 변경 | 디렉터리의 사용자에게 할당된 라이선스를 변경합니다. |
| 사용자 업데이트 | 디렉터리의 사용자를 업데이트합니다. |
...
| 위임 항목 추가 | 디렉터리에 위임 항목을 추가합니다. |
| 위임 항목 설정 | 디렉터리에서 위임 항목을 업데이트합니다. |
| 위임 항목 제거 | 디렉터리에서 위임 항목을 제거합니다. |
