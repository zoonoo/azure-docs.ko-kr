...
Windows Server 2012 R2 환경에 Active Directory 도메인 서비스를 아직 추가하지 않은 경우 작업 방법에 대한 자세한 내용은 [이러한 지침](https://technet.microsoft.com/library/cc731053.aspx)을 참조하세요.
### UPN 도메인 접미사 검사 및 구성
...
1. RemoteApp 서비스 계정의 권한을 허용하여 이 OU에 컴퓨터를 추가 및 삭제합니다.
...
- [도메인 추가](http://technet.microsoft.com/library/hh969247.aspx) – 이 정보를 사용하여 온-프레미스 Active Directory 도메인의 UPN 도메인 접미사와 일치하는 도메인을 추가합니다.
- [디렉터리 통합](http://technet.microsoft.com/library/jj573653.aspx) – 이 정보를 사용하여 디렉터리 통합 옵션([암호 동기화 사용 DirSync](http://technet.microsoft.com/library/dn441214.aspx) 또는 [페더레이션 사용 DirSync](http://technet.microsoft.com/library/dn441213.aspx))을 선택합니다.

[MFA(Multi-Factor Authentication)](http://technet.microsoft.com/library/dn249466.aspx)를 구성할 수도 있습니다.

## 디렉터리 동기화를 구성하는 데 문제가 있습니까?

디렉터리 동기화를 구성하는 데 문제가 있는 경우 다음 사항을 확인합니다.

- 최신 버전의 Azure Directory 동기화 도구를 사용하고 있습니다. 
-	관리 포털의 **Active Directory->기본 디렉터리->도메인** 아래에서 사용자 지정 도메인(예: mydomain.com)에 이미 추가하여 기본으로 설정했습니다.
