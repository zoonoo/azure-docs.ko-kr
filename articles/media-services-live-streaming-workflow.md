...
다음 다이어그램에서는 주문형 워크플로 관련 비디오에 관련된 미디어 서비스 플랫폼의 주요 부분을 보여줍니다.
![Live workflow][live-overview]

##미디어 서비스 계정 만들기

**Azure 관리 포털**을 이용하여 [Azure Media Services 계정](../media-services-create-account/) 을 만듭니다.
...
자세한 내용은 [Azure Media Services와 함께 타사 라이브 트랜스코더 사용하기](https://msdn.microsoft.com/ko-kr/library/azure/dn783464.aspx)를 참조하세요.

##채널, 프로그램, 자산 관리하기

자세한 내용은 [라이브 스트리밍](https://msdn.microsoft.com/ko-kr/library/azure/dn783466.aspx)을 참조하세요.
...
스트리밍 단위 크기 조정에 대한 내용은 다음을 참조하세요. [스트리밍 단위 크기를 조정하는 방법](../media-services-manage-origins#scale_streaming_endpoints).
