...
1. **이름** 목록에서 프로필을 선택한 다음 **복사본 만들기**를 클릭합니다.

1. **닫기** 단추를 선택합니다.

    새 프로필이 대상 프로필 목록에 나타납니다.

1. **대상 프로필** 목록에서 방금 만든 프로필을 클릭합니다. 게시 마법사 설정은 선택한 프로필의 선택 항목으로 채워집니다.
