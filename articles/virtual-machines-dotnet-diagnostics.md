...
### 필수 구성 요소
이 연습에서는 Azure 구독이 있으며 Visual Studio 2013과 Azure SDK를 함께 사용 중인 것으로 가정합니다. Azure 구독이 없는 경우 [무료 평가판][무료 평가판]에 등록할 수 있습니다. [Azure PowerShell 버전 0.8.7 이상을 설치 및 구성][Azure PowerShell 버전 0.8.7 이상을 설치 및 구성]해야 합니다.
