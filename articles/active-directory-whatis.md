...
Azure Active Directory는 클라우드에서 ID 및 액세스 관리 기능을 제공하는 서비스입니다. Active Directory가 온-프레미스 ID 관리를 위해 Windows Server 운영 체제를 통해 고객에게 제공되는 서비스인 것과 거의 마찬가지로 Azure AD(Azure Active Directory)는 클라우드 기반 ID 관리를 위해 Azure를 통해 제공되는 서비스입니다. [자세한 정보][자세한 정보]
...
-   [MSDN의 Azure AD 라이브러리][MSDN의 Azure AD 라이브러리]
  ...
  [자세한 정보]: http://msdn.microsoft.com/library/hh967611.aspx
