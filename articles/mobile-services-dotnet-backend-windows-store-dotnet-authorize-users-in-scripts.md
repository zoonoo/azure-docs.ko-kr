<properties pageTitle="서비스 쪽 권한 부여(Windows 스토어) | 모바일 개발자 센터" metaKeywords="" description="Azure 모바일 서비스의 .NET 백 엔드에서 사용자에게 권한을 부여하는 방법에 대해 알아봅니다." metaCanonical="" services="" documentationCenter="Mobile" title="Service-side authorization of Mobile Services users" authors="glenga" solutions="" manager="dwrede" editor="" />
...
1. Visual Studio에서 [인증 시작] 자습서를 완료했을 때 수정한 프로젝트를 엽니다.
