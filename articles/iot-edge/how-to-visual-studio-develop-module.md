...
1. **AzureIoTEdgeApp1** 를 마우스 오른쪽 단추로 클릭 하 고**새 IoT Edge 모듈** **추가** > 를 선택 하 여 두 번째 모듈을 솔루션에 추가 합니다. 두 번째 모듈의 기본 이름은 **IoTEdgeModule2**이며 파이프 모듈로 기능할 것입니다.
