...
2. **registryCredentials** 속성을 $edgeAgent desired 속성에서 찾습니다. 프로젝트를 만들 때 제공한 정보에서 레지스트리 주소를 자동으로 채워야 합니다. 사용자 이름 및 암호 필드는 변수 이름을 포함해야 합니다. 다음은 그 예입니다.
