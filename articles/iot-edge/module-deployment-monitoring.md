...
Azure IoT Edge는 IoT Edge 장치에서 실행되도록 모듈을 구성하는 두 가지 방법을 제공합니다. 하나는 Azure IoT Edge 자습서에서 이 방법을 사용한 단일 장치에서 개발 및 빠른 반복을 위한 것이고, 다른 하나는 대규모 IoT Edge 장치를 관리하기 위한 것입니다. 이러한 두 가지 방법은 Azure Portal에서 프로그래밍 방식으로 사용할 수 있습니다.
