...
IoT Edge 런타임은 여러 IoT Edge 모듈의 기능을 통합하고 이를 IoT Edge 디바이스에 배포하기 위한 인프라를 제공합니다. 모든 프로그램은 IoT Edge 모듈로 패키징할 수 있습니다. IoT Edge 통신 및 관리 기능을 최대한 활용하려면 모듈에서 실행되는 프로그램은 Azure IoT 장치 SDK를 사용하여 로컬 IoT Edge 허브에 연결할 수 있습니다.
...
* 그것은 [장치 트윈](../iot-hub/iot-hub-devguide-device-twins.md) 및 해당 장치의 다른 모듈 쌍둥이에서 구별되고 분리된 모듈 트윈을 가지고 있습니다.
...
모듈을 작성할 때 [Azure IoT 장치 SDK를](../iot-hub/iot-hub-devguide-sdks.md) 사용하여 IoT Edge 허브에 연결하고 장치 응용 프로그램과 함께 IoT Hub를 사용할 때와 마찬가지로 위의 기능을 사용할 수 있습니다. IoT Edge 모듈과 IoT 장치 응용 프로그램의 유일한 차이점은 장치 ID 대신 모듈 ID를 참조해야 한다는 것입니다.
...
일반 IoT Hub 장치 응용 프로그램과 달리 IoT Edge 모듈은 로컬 IoT Edge 허브에서 처리하려는 장치-클라우드 메시지를 수신할 수 있습니다.
...
DeviceClient 인스턴스가 IoT Hub에 IoT 디바이스를 연결하는 방법과 비슷하게 디바이스에서 실행 중인 IoT Edge 허브에 모듈을 연결하는 ModuleClient 인스턴스를 만듭니다. ModuleClient 클래스 및 통신 메서드에 대한 자세한 내용은 기본 설정 SDK 언어에 대한 API 참조를 참조하십시오: [C#](https://docs.microsoft.com/dotnet/api/microsoft.azure.devices.client.moduleclient?view=azure-dotnet), [C,](https://docs.microsoft.com/azure/iot-hub/iot-c-sdk-ref/iothub-module-client-h) [파이썬,](https://docs.microsoft.com/python/api/azure-iot-device/azure.iot.device.iothubmoduleclient?view=azure-python) [Java,](https://docs.microsoft.com/java/api/com.microsoft.azure.sdk.iot.device.moduleclient?view=azure-java-stable)또는 [Node.js](https://docs.microsoft.com/javascript/api/azure-iot-device/moduleclient?view=azure-node-latest).

## <a name="language-and-architecture-support"></a>언어 및 아키텍처 지원

IoT Edge는 여러 운영 체제, 장치 아키텍처 및 개발 언어를 지원하므로 필요에 맞는 시나리오를 빌드할 수 있습니다. 이 섹션을 사용하여 사용자 지정 IoT Edge 모듈을 개발하기 위한 옵션을 이해합니다. [IoT Edge의 개발 및 테스트 환경 준비에서](development-environment.md)각 언어에 대한 툴링 지원 및 요구 사항에 대해 자세히 알아볼 수 있습니다.

### <a name="linux"></a>Linux

다음 표의 모든 언어에 대해 IoT Edge는 AMD64 및 ARM32 Linux 장치 개발을 지원합니다.
...
>[!NOTE]
>ARM64 Linux 장치에 대한 개발 및 디버깅 지원은 [공개 미리 보기입니다.](https://azure.microsoft.com/support/legal/preview-supplemental-terms/) 자세한 내용은 [Visual Studio Code(미리 보기)에서 ARM64 IoT Edge 모듈 개발 및 디버그](https://devblogs.microsoft.com/iotdev/develop-and-debug-arm64-iot-edge-modules-in-visual-studio-code-preview)를 참조하세요.

### <a name="windows"></a>Windows

다음 표의 모든 언어에 대해 IoT Edge는 AMD64 Windows 장치에 대한 개발을 지원합니다.

| 개발 언어 | 개발 도구 |
| -------------------- | ----------------- |
| C | Visual Studio 2017/2019 |
| C# | 비주얼 스튜디오 코드(디버깅 기능 없음)<br>Visual Studio 2017/2019 |

## <a name="next-steps"></a>다음 단계

[IoT Edge를 위한 개발 및 테스트 환경 준비](development-environment.md)

[비주얼 스튜디오를 사용하여 IoT 에지용 C# 모듈 개발](how-to-visual-studio-develop-module.md)

[비주얼 스튜디오 코드를 사용하여 IoT 에지용 모듈 개발](how-to-vs-code-develop-module.md)
