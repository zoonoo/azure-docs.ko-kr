...
description: Azure IoT Edge 런타임 및 Edge 디바이스에 권한을 부여하는 방법을 알아봅니다.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 08/13/2018
...
* IoT Edge 디바이스와 클라우드 간의 통신을 용이하게 합니다.
...
![여러 물리적 디바이스와 클라우드 간의 게이트웨이 역할을 하는 Edge 허브](./media/iot-edge-runtime/Gateway.png)
