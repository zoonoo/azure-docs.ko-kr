...
이 자습서에서는 **Linux 디바이스에 C# 모듈**을 배포하는 예제를 사용합니다. 이 예는 IoT Edge 솔루션에서 가장 일반적인 개발자 시나리오이기 때문에 선택되었습니다. 다른 언어를 사용하거나 Azure 서비스를 배포하려는 경우에도 이 자습서는 개발 도구 및 개념에 대해 알아보는 데 유용합니다. 개발 프로세스에 대한 지침을 완료한 후 기본 언어 또는 Azure 서비스를 선택하여 세부 정보를 자세히 살펴볼 수 있습니다. 
