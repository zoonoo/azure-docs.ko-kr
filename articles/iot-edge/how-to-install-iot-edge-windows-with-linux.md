...
개발 및 테스트에는 [Windows용 Docker][lnk-docker-for-windows]를 사용할 수 있습니다. Windows용 Docker가 [Linux 컨테이너를 사용하도록 구성][lnk-docker-config]되어 있는지 확인합니다.
...
구성 파일의 **connect:** 섹션에서 **workload_uri** 및 **management_uri**를 업데이트합니다. **\<GATEWAY_ADDRESS\>** 를 복사한 DockerNAT IP 주소로 바꿉니다. 
