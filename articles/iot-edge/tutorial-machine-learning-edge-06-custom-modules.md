---
title: 사용자 지정 모듈 만들기 및 배포 - Azure IoT Edge의 Machine Learning | Microsoft Docs
description: 기계 학습 모델을 통해 리프 디바이스의 데이터를 처리하고 인사이트를 IoT Hub에 보내는 IoT Edge 모듈을 만들고 배포합니다.
author: kgremban
manager: philmea
ms.author: kgremban
ms.date: 06/13/2019
