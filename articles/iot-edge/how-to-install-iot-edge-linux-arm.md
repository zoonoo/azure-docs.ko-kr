...
description: Raspberry PI 같은 ARM32 장치의 Linux에 Azure IoT Edge를 설치하는 방법에 대한 지침
author: kgremban
manager: philmea
ms.reviewer: veyalla
ms.service: iot-edge
...
이 문서에서는 Linux ARM32v7/armhf Edge 장치에 Azure IoT Edge 런타임을 설치하는 단계가 나열합니다. 예를 들어 다음 단계는 Raspberry Pi 장치에서 작동합니다. 현재 지원되는 ARM32 운영 체제 목록은 [Azure IoT Edge 지원](support.md#operating-systems)을 참조하세요. 
...
## <a name="connect-your-device-to-an-iot-hub"></a>장치를 IoT Hub에 연결 
