...
Azure IoT Edge 모듈은 한 번 이상 IoT Hub와 동기화한 후 오프라인에서 무기한으로 작업할 수 있습니다. IoT Edge 디바이스는 이 오프라인 기능을 다른 IoT 디바이스로 확장할 수도 있습니다. 자세한 내용은 [IoT Edge 디바이스, 모듈 및 하위 디바이스용 확장 오프라인 기능 이해](offline-capabilities.md)를 참조하세요.
