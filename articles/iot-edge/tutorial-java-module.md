---
title: Azure IoT Edge Java 자습서 | Microsoft Docs
description: 이 자습서에서는 Java 코드를 사용하여 IoT Edge 모듈을 만들고, 에지 장치에 배포하는 방법을 보여 줍니다.
services: iot-edge
author: kgremban
manager: timlt
ms.author: kgremban
...
* IoT Edge용 Java 모듈은 Windows 장치를 지원하지 않습니다.
