...
개별 디바이스를 관리하고 모듈을 한 번에 하나씩 배포할 수 있습니다. 그러나 대대적으로 장치를 변경하려는 경우 IoT Hub에서 자동 장치 관리의 일부인 **IoT Edge 자동 배포**를 만들 수 있습니다. 배포는 여러 모듈을 여러 디바이스에 한 번에 배포하고, 모듈의 상태를 추적하며, 필요한 경우 변경할 수 있게 하는 동적 프로세스입니다. 
...
다른 매개 변수뿐만 아니라 배포 매니페스트로 구성된 배포를 만들어 대상 장치에 모듈을 배포합니다. 
