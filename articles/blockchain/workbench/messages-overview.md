---
title: 메시지를 사용 하 여 Azure Blockchain 워크 벤치와 통합
description: 메시지를 사용 하 여 Azure Blockchain 워크 벤치 Preview를 다른 시스템과 통합 하는 방법에 대 한 개요입니다.
ms.date: 09/05/2019
ms.topic: article
ms.reviewer: brendal
...
1. Azure Portal에서 **Azure 함수 앱** 를 만듭니다.
2. 새 함수를 만듭니다.
