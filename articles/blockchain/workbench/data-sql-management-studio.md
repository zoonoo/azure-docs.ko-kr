---
title: SQL Server Management Studio를 사용하여 Azure Blockchain Workbench 데이터 쿼리
...
* [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms)를 다운로드합니다.
