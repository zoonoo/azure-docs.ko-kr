...
구성에서 배열 형식으로 속성을 정의하는 경우 Solidity에서 배열 형식의 공용 속성을 반환하는 명시적인 가져오기 함수를 포함해야 합니다. 예를 들어 다음과 같은 가치를 제공해야 합니다.
...
| 필드 | 설명 | 필수 |
|-------|-------------|:--------:|
| AllowedRoles | 전환을 시작하도록 허용된 애플리케이션 역할 목록. 지정된 역할의 모든 사용자가 작업을 수행할 수 있습니다. | 아니오 |
