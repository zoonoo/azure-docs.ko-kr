---
title: Azure Blockchain Workbench 구성 메타데이터 참조
description: Azure Blockchain Workbench 미리 보기 애플리케이션 구성 메타데이터 개요입니다.
ms.date: 12/09/2019
ms.topic: article
ms.reviewer: brendal
...
> [Azure Blockchain Workbench REST API 참조](/rest/api/azure-blockchain-workbench)
