---
title: Azure Blockchain 워크 벤치 구성 메타 데이터 참조
description: Azure Blockchain 워크 벤치 미리 보기 응용 프로그램 구성 메타 데이터 개요.
ms.date: 12/09/2019
ms.topic: article
ms.reviewer: brendal
...
| Description | 애플리케이션에 대한 설명입니다. | 예 |
...
|-------|-------------|:--------:|-----------:|
| 속성 | 고유 워크플로 이름. 해당 스마트 계약은 적용 가능한 계약 클래스에 대해 동일한 **Name**을 사용해야 합니다. | yes | 50 |
| DisplayName | 워크플로의 친숙한 표시 이름. | yes | 255 |
| Description | 워크플로에 대한 설명. | 예 | 255 |
...
구성에서 배열 형식으로 속성을 정의하는 경우 Solidity에서 배열 형식의 공용 속성을 반환하는 명시적인 가져오기 함수를 포함해야 합니다. 다음은 그 예입니다.
...
| 필드 | Description | 필수 | 최대 길이 |
|-------|-------------|:--------:|-----------:|
| 속성 | 함수의 고유한 이름. 해당 스마트 계약은 적용 가능한 함수에 대해 동일한 **Name**을 사용해야 합니다. | yes | 50 |
| DisplayName | 함수의 친숙한 표시 이름. | yes | 255 |
| Description | 함수에 대한 설명 | 예 | 255 |
...
| 필드 | Description | 필수 | 최대 길이 |
|-------|-------------|:--------:|-----------:|
| 속성 | 상태의 고유 이름. 해당 스마트 계약은 적용 가능한 상태에 대해 동일한 **Name**을 사용해야 합니다. | yes | 50 |
| DisplayName | 상태의 친숙한 표시 이름. | yes | 255 |
| Description | 상태에 대한 설명. | 예 | 255 |
...
| 필드 | Description | 필수 | 최대 길이 |
|-------|-------------|:--------:|-----------:|
| 속성 | 애플리케이션 역할의 고유한 이름입니다. 해당 스마트 계약은 적용 가능한 역할에 대해 동일한 **Name**을 사용해야 합니다. 기본 형식 이름은 예약되어 있습니다. [형식](#type)과 같은 이름으로 애플리케이션 역할의 이름을 지정할 수 없습니다.| yes | 50 |
| Description | 애플리케이션 역할에 대한 설명. | 예 | 255 |
...
| 필드 | Description | 필수 | 최대 길이 |
|-------|-------------|:--------:|-----------:|
| 속성 | 속성 또는 매개 변수의 고유 이름. 해당 스마트 계약은 적용 가능한 속성 또는 매개 변수에 대해 동일한 **Name**을 사용해야 합니다. | yes | 50 |
| DisplayName | 속성 또는 매개 변수의 친숙한 표시 이름. | yes | 255 |
| Description | 속성 또는 매개 변수에 대한 설명. | 예 | 255 |
| Type | 속성 [데이터 형식](#type)입니다. | yes |
