---
title: 스마트 계약 통합 패턴 - Azure 블록 체인 워크벤치
description: Azure 블록 체인 워크 벤치 미리 보기에서 스마트 계약 통합 패턴의 개요입니다.
ms.date: 11/20/2019
ms.topic: conceptual
...
예를 들어 약품을 운반하는 트럭의 온도가 110도까지 상승하면 약품의 효능에 영향을 미칠 수 있으며 공급망에서 감지되고 제거되지 않으면 공공 안전 문제가 발생할 수 있습니다. 운전자가 시속 100마일로 차량을 가속하면 센서 정보가 보험 제공업체에 의해 보험 취소를 유발할 수 있습니다. 자동차가 렌트카인 경우 GPS 데이터는 운전자가 임대 계약서의 적용을 받는 지역을 벗어날 때를 나타내고 벌금을 부과할 수 있습니다.
