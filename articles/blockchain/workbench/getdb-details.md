...
description: Azure Blockchain Workbench 미리 보기 데이터베이스 및 데이터베이스 서버 정보를 가져오는 방법을 알아봅니다.
ms.date: 09/05/2019
ms.topic: how-to
...
4. **형식** 을 선택하여 리소스 목록을 정렬한 다음, **SQL 서버** 를 선택합니다. 다음 화면 캡처의 정렬된 목록에는 두 개의 데이터베이스인 “master” 데이터베이스와 “lhgn”을 **리소스 접두사** 로 사용하는 데이터베이스가 표시됩니다.
