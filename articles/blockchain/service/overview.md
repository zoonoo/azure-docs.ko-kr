...
ms.locfileid: "122643522"
---
# <a name="what-is-azure-blockchain-service"></a>Azure Blockchain Service란?

Azure Blockchain Service는 사용자가 Azure에서 대규모로 블록체인 네트워크를 확장하고 운영할 수 있는 기능을 제공하는 완전 관리형 원장 서비스입니다.

[!INCLUDE [Retirement note](./includes/retirement.md)]

Azure Blockchain Service는 blockchain 네트워크 거버넌스 뿐만 아니라 인프라 관리를 통합적으로 제어하여 다음 기능을 제공합니다.
