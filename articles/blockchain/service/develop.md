...
단계별 지침은 [자습서: 개인 트랜잭션 예제를 위해 Azure blockchain](send-transaction.md) 서비스를 사용 하 여 트랜잭션을 보냅니다.
...
* Web3 Labs의 [Azure Blockchain 서비스 탐색기](https://web3labs.com/azure-offer)
