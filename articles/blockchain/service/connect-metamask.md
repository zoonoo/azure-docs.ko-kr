...
1. 블록체인에서 **add** 트랜잭션을 수행하려면 추가할 숫자를 입력한 다음, **add**를 선택합니다. Remix에서 가스 예측 실패 메시지를 받을 수 있습니다. 가스가 필요 없는 프라이빗 블록 체인으로 트랜잭션을 전송하려 합니다. **트랜잭션 보내기**를 선택하여 트랜잭션을 강제로 실행합니다.
