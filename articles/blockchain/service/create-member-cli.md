...
| **위치** | 블록체인 멤버가 만들어지는 Azure 지역입니다. 예: `westus2` 사용자 또는 다른 Azure 애플리케이션에 가장 가까운 위치를 선택합니다.
...
앞에서 만든 블록체인 멤버를 다음 빠른 시작 또는 자습서에 사용할 수 있습니다. 더 이상 필요하지 않은 경우빠른 시작을 위해 만든 `myResourceGroup` 리소스 그룹을 삭제하여 리소스를 삭제할 수 있습니다.
...
이 빠른 시작에서는 Azure Blockchain Service 멤버 및 새로운 컨소시엄을 배포했습니다. Ethereum용 Azure Blockchain Development Kit를 사용하여 Azure Blockchain Service의 컨소시엄에 연결하려면 다음 빠른 시작을 사용해 보세요.
