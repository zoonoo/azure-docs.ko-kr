...
이 문서에서는 공간 앵커를 사용 하 여 앵커를 효과적으로 만들고 찾는 데 도움이 되는 지침과 고려 사항을 제공 합니다.

## <a name="good-anchors"></a>좋은 앵커

공간 앵커는 좋은 앵커를 만드는 데 도움이 됩니다. 사용자 환경 (UX)의 사용자에 게 좋은 앵커를 만들도록 교육 하거나 안내 하는 데 시간을 투자 하는 것이 중요 합니다. 전면에서 좋은 앵커를 만들 때 투자 하면 최종 사용자가 앵커를 안정적으로 찾을 수 있습니다.
...
첫째, 사용자가 몇 초 내에 앵커를 찾지 못하는 경우 앱은 사용자가 장치를 이동 하 여 더 많은 관점을 캡처하도록 권장 해야 합니다. 또한 앱은 사용자가 환경에서 자신을 이동 하 여 더 많은 관점에서 앵커를 검색 하도록 할 수 있습니다. 장치에 표시 되는 기능 관점이 많을 수록 성능이 향상 됩니다.
