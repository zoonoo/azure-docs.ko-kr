---
title: Swift의 Azure 공간 앵커를 사용 하 여 앵커를 찾아서 만들 | Microsoft Docs
...
ms.locfileid: "57863613"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-swift"></a>Swift의 Azure 공간 앵커를 사용 하 여 앵커를 찾아서 만들기
...
Azure Spatial Anchors를 사용하면 다양한 디바이스 간에 전 세계 앵커를 공유할 수 있습니다. 여러 개발 환경을 지원합니다. 이 문서에서는 Swift에서 작업을 수행 하는 방법에 자세히 알아봅니다.
