---
title: 만들고 찾을 앵커 Azure 공간 앵커를 사용 하 여 C + + /cli NDK | Microsoft Docs
...
ms.locfileid: "57857388"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-cndk"></a>만들고 찾을 앵커 Azure 공간 앵커를 사용 하 여 C + + /cli NDK
...
Azure Spatial Anchors를 사용하면 다양한 디바이스 간에 전 세계 앵커를 공유할 수 있습니다. 여러 개발 환경을 지원합니다. C + 작업을 수행 하는 방법에 알아보겠습니다이 문서에서는 + NDK 합니다.
