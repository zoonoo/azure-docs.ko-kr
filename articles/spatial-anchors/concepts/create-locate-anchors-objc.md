---
title: Azure 공간 앵커를 사용 하 여 Objective-c에서 앵커를 찾아서 만들 | Microsoft Docs
...
ms.locfileid: "57850737"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-objective-c"></a>Azure 공간 앵커를 사용 하 여 Objective-c에서 앵커를 찾아서 만들기
...
Azure Spatial Anchors를 사용하면 다양한 디바이스 간에 전 세계 앵커를 공유할 수 있습니다. 여러 개발 환경을 지원합니다. 이 문서에서는 것에 대해 자세히 알아봅니다 목표 C에서 수행 하는 방법
