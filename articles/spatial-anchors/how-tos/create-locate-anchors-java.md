...
Azure Spatial Anchors를 사용하면 다양한 디바이스 간에 전 세계 앵커를 공유할 수 있습니다. 여러 다른 개발 환경을 지원합니다. 이 문서에서는 Azure 공간 앵커 SDK, java이 든,를 사용 하는 방법에 자세히 알아봅니다.
