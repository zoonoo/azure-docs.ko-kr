...
[광역 위치 재결정](../concepts/coarse-reloc.md) 기능에 포함된 센서 지문 공급자 개체는 Azure Spatial Anchors 세션에 연결하지 않고도 사용할 수 있습니다.
다음 코드 조각은 센서 공급자에 액세스하여 디바이스 위치의 추정치를 얻는 방법을 보여줍니다.
...
이 문서에서는 광역 위치 재결정 API를 사용하여 디바이스 위치의 추정치를 구하는 방법을 살펴보았습니다. 광역 위치 재결정에 대한 자세한 내용은 다음 가이드를 참조하세요.
