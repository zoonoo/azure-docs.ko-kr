---
title: Swift에서 디바이스 내 센서를 사용하여 앵커를 만들고 찾는 방법 | Microsoft Docs
description: Swift에서 디바이스 내 센서를 사용하여 앵커를 만들고 찾는 방법에 대해 자세히 설명합니다.
author: bucurb
manager: dacoghl
...
ms.locfileid: "74093049"
---
# <a name="how-to-create-and-locate-anchors-using-on-device-sensors-in-swift"></a>Swift에서 디바이스 내 센서를 사용하여 앵커를 만들고 찾는 방법
