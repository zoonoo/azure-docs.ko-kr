...
Azure Spatial Anchors를 사용하면 다양한 디바이스 간에 전 세계 앵커를 공유할 수 있습니다. 여러 다른 개발 환경을 지원합니다. C + Azure 공간 앵커 SDK를 사용 하는 방법에 알아보겠습니다이 문서에서는 + WinRT를 합니다.
...
- C + +에 대 한 기본 지식이 하며 <a href="https://docs.microsoft.com/windows/uwp/cpp-and-winrt-apis/intro-to-using-cpp-with-winrt" target="_blank">Windows 런타임 Api</a>합니다.
