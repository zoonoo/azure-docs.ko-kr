...
- [실제에서 가상 콘텐츠 유지](concepts/create-locate-anchors-unity.md#creating-a-cloud-spatial-anchor). 사용자는 앱을 통해 가상 달력을 회의실 벽에 배치할 수 있으며 사람들은 휴대폰 앱 또는 HoloLens 디바이스를 사용하여 이를 볼 수 있습니다. 산업용 설정에서는 사용자가 지원되는 디바이스 카메라로 대상을 가리켜서 머신에 대한 컨텍스트 정보를 받을 수 있습니다.
