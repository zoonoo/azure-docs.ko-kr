<properties 
	...
	description="Azure WebJob 및 Azure WebJob SDK를 사용하는 방법에 대해 설명하는 권장 리소스입니다." 
...
이 항목은 Azure WebJob 및 Azure WebJobs SDK를 사용하는 방법에 대한 설명서 리소스에 연결됩니다. Azure WebJob은 쉽게 스크립트 또는 프로그램을 [앱 서비스 웹 앱](http://go.microsoft.com/fwlink/?LinkId=529714)에서 백그라운드 프로세스로 실행하는 편리한 방법을 제공합니다. cmd, bat, exe(.NET), ps1, sh, php, py, js 및 jar와 같은 실행 파일을 업로드하고 실행할 수 있습니다. 이러한 프로그램은 일정에 따라(cron) 또는 지속적으로 WebJob으로 실행됩니다.
...
##<a name="getstarted"></a>WebJob 및 WebJob SDK 시작

* [Azure WebJob 소개](http://www.hanselman.comblog.md/IntroducingWindowsAzureWebJobs.aspx)
* [Azure WebJob 기능](/blog/2014/10/22/webjobs-goes-into-full-production/)
* [WebJob SDK 정의](websites-dotnet-webjobs-sdk.md)
* [Microsoft Azure WebJob SDK 1.0.0 RTM 발표](/blog/2014/10/25/announcing-the-1-0-0-rtm-of-microsoft-azure-webjobs-sdk/)
* [Azure WebJob SDK 시작](websites-dotnet-webjobs-sdk-get-started.md)
...
* 비디오
	* [WebJob 및 WebJob SDK](http://channel9.msdn.com/Shows/Cloud+Cover/Episode-153-WebJobs-with-Pranav-Rastogi?utm_source=dlvr.it&utm_medium=twitter)
	...
	* [WebJob Tooling 및 원격 디버깅](http://channel9.msdn.com/Shows/Web+Camps+TV/WebJobs-GA-Series-Episode-1-WebJobs-Tooling-with-Brady-Gaster)

[WebJob 배포](#deploy) 및 [WebJob 테스트 및 디버깅]에 대한 다음 섹션도 참조하세요(#debug).

##<a name="deploy"></a>WebJob 배포

* [Azure WebJob을 Azure 웹 사이트에 배포하는 방법](websites-dotnet-deploy-webjobs.md)
* [Azure 관리 포털을 사용하여 WebJob을 배포하는 방법](web-sites-create-web-jobs.md)
...
* [WebJob SDK 대시보드 보기](websites-dotnet-webjobs-sdk-get-started.md#view-the-webjobs-sdk-dashboard)
* [WebJob SDK를 사용하여 로그를 작성하고 대시보드에서 보는 방법](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#logs)
* [WebJob 원격 디버깅](web-sites-dotnet-troubleshoot-visual-studio.md#remotedebugwj)
...
##<a name="scale"></a>WebJob 크기 조정

* [Azure 웹 사이트로 웹 응용 프로그램 크기 조정](http://msdn.microsoft.com/magazine/dn786914.aspx)
* [Azure 웹 사이트: 업무에 즉시 사용할 수 있는 뛰어난 확장성의 웹 앱 설계](https://channel9.msdn.com/Events/Build/2014/3-626). WebJobs SDK를 비롯하여 WebJob을 사용한 Azure 웹 사이트 확장을 포함합니다.
* 비디오
...
* [최초 요청 시 느려지는 Azure 웹 사이트 및 클라우드 서비스](http://wp.sjkp.dk/windows-azure-websites-and-cloud-services-slow-on-first-request/). WebJob을 사용하여 표준 웹 사이트 계층에서만 사용할 수 있는 AlwaysOn 기능을 시뮬레이트하는 방법을 보여 줍니다.
* [WebJobs 정상 종료](http://blog.amitapple.com/post/2014/05/webjobs-graceful-shutdown/#.U72Il_5OWUl). WebJob SDK 정상 종료에 대해서는 [정상 종료](websites-dotnet-webjobs-sdk-storage-queues-how-to.md#graceful).)를 참조하세요.
* 비디오
...
* [Azure 웹 사이트 포럼](http://social.msdn.microsoft.com/Forums/azure/home?forum=windowsazurewebsitespreview)
