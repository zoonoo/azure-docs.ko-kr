...
1. **사물 인터넷** 범주를 선택하고 **Time Series Insights**를 선택합니다.
   ...
   [Time Series Insights 환경을 만드는 ![](media/time-series-insights-get-started/tsi-create-new-environment.png)](media/time-series-insights-get-started/tsi-create-new-environment.png#lightbox)
...
1. 리소스 **개요**에서 배포 구성 설정을 확인 합니다.
   ...
   [대시보드에 Time Series Insights 고정 ![만들려면](media/time-series-insights-get-started/tsi-verify-deployment.png)](media/time-series-insights-get-started/tsi-verify-deployment.png#lightbox)
