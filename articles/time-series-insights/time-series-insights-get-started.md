...
1. 리소스 **개요**의 오른쪽 위 모서리에 있는 **고정 아이콘** 을 선택 하 여 나중에 Time Series Insights 환경에 쉽게 액세스할 수 있습니다.
   ...
   [![ 대시보드에 Time Series Insights pin 만들기](media/time-series-insights-get-started/4-pin-create.png)](media/time-series-insights-get-started/4-pin-create.png#lightbox)
