...
* Time Series Insights 환경을 프로 비전 합니다. [Azure Time Series Insights Preview](./time-series-insights-update-create-environment.md) 자습서를 읽어 인스턴스를 프로 비전 하는 방법에 대해 자세히 알아보세요.
...
## <a name="explore-the-time-series-insights-preview-explorer"></a>Time Series Insights Preview 탐색기 살펴보기

Azure Time Series Insights Preview 탐색기는 다음과 같은 7 개의 요소로 구성 됩니다.

[![Time Series Insights Preview 탐색기 개요](media/v2-update-explorer/preview-explorer-overview.png)](media/v2-update-explorer/preview-explorer-overview.png#lightbox)

1. [환경 패널](#1-environment-panel): 모든 Azure Time Series Insights 환경을 표시 합니다.
...
차트를 사용 하면 시계열 인스턴스를 선으로 표시할 수 있습니다. 웹 컨트롤을 클릭해서 환경 패널, 데이터 모델 및 시간 범위 제어 패널을 접으면 차트를 확장할 수 있습니다. 
  ...
  [![차트 미리 보기 개요](media/v2-update-explorer/tsi-preview-chart-overview.png)](media/v2-update-explorer/tsi-preview-chart-overview.png#lightbox)
...
**확대/축소** 작업을 수행 하면 선택한 데이터 집합이 표시 됩니다. 서식 컨트롤을 선택 하 여 Time Series Insights 데이터에 대 한 3 개의 y 축 표현을 순환 합니다.
  ...
  [![차트 y 축 미리 보기](media/v2-update-explorer/tsi-preview-explorer-standard-chart.png)](media/v2-update-explorer/tsi-preview-explorer-standard-chart.png#lightbox)
...
다음 웹 컨트롤은 작업 시간 범위 선택을 위한 Time Series Insights 업데이트에서 사용할 수 있습니다. 
...
- [저장소](concepts-storage.md) 에 대 한 문서 확인

- [데이터 모델링](./concepts-model-overview.md)에 대 한 Time Series Insights 미리 보기 문서를 읽습니다.
