...
Azure Time Series Insights Gen2는 시계열 [변수](./concepts-variables.md)에서 계산을 표현 하는 데 사용 되는 다양 한 문자열 기반 식 언어인 [TSX (시계열 식)](https://docs.microsoft.com/rest/api/time-series-insights/preview#time-series-expression-and-syntax)를 사용 합니다.
