...
Power BI에서 데이터 집합을 이미 로드 했지만 쿼리를 수정 하려는 경우 (예: 날짜/시간 또는 환경 ID 매개 변수) Power BI의 고급 편집기 기능을 통해이 작업을 수행할 수 있습니다. 자세한 내용은 [Power BI 설명서](/power-bi/desktop-query-overview) 를 참조 하세요.
...
* Azure Time Series Insights에 대 한 [Power BI 커넥터 개념](/power-bi/desktop-query-overview) 을 참조 하세요.
