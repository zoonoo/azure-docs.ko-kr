...
6. 키 이름과 형식을 지정합니다. 이 이름과 형식은 이벤트 원본의 이벤트에서 올바른 속성을 선택하는 데 사용됩니다. 예를 들어, 키 이름을 “DeviceId”, 형식을 “String”으로 제공한 경우 Time Series Insights 수신 엔진은 들어오는 이벤트에서 “DeviceId”라는 이름과 “String” 형식의 속성을 찾습니다. 이벤트와 조인하는 키를 둘 이상 제공할 수 있습니다. 속성 이름 일치는 대/소문자를 구분합니다.
