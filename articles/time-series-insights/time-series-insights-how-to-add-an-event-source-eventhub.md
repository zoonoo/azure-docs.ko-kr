...
> [!NOTE]
> 이 문서에서 설명하는 단계는 Time Series Insights GA 및 Time Series Insights 미리 보기 환경에 적용됩니다.
...
애플리케이션은 소비자 그룹을 사용하여 Azure Event Hubs의 데이터를 풀합니다. 이벤트 허브에서 안정적으로 데이터를 읽기 위해 이 Time Series Insights 환경에서만 사용하는 전용 소비자 그룹을 제공합니다.
...
1. 다음 표에서는 **수동으로 이벤트 허브 설정 제공** 옵션에 필요한 속성을 설명합니다.
