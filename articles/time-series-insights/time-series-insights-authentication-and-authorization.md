...
이 섹션에서는 애플리케이션을 대신해 Time Series Insights API에 액세스하도록 애플리케이션을 구성하는 방법을 설명합니다. 응용 프로그램은 사용자 자격 증명이 아니라 응용 프로그램 자격 증명으로 Time Series Insights 환경에서 데이터를 쿼리하거나 참조 데이터를 게시할 수 있습니다.
