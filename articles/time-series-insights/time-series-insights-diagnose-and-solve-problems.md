---
title: Azure Time Series Insights 문제 해결 - Azure Time Series Insights에서 문제 진단 및 해결 | Microsoft Docs
...
이 비디오에서는 일반적인 Time Series Insight 고객의 어려움과 문제를 완화하는 방법에 대해 설명합니다.</br>
...
### <a name="cause-c-the-consumer-group-provided-isnt-exclusive-to-time-series-insights"></a>원인 C: 제공된 소비자 그룹이 Time Series Insights에 배타적으로 적용되지 않음
...
## <a name="problem-2-some-data-is-shown-but-data-is-missing"></a>문제 2: 데이터 중 일부만 표시됨
...
## <a name="problem-3-my-event-sources-timestamp-property-name-setting-doesnt-work"></a>문제 3: 내 이벤트 원본 타임스탬프 속성 이름 설정이 작동하지 않음
