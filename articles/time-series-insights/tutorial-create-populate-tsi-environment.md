...
2. 이 시점에서 디바이스 시뮬레이션 웹앱이 시작되고 초기 로드가 완료되는 데 몇 초가 소요될 수 있습니다. 또한 웹 응용 프로그램에 “로그인 및 프로필 읽기” 권한을 부여하기 위한 동의를 묻는 메시지가 나타납니다. 이 권한을 통해 응용 프로그램은 응용 프로그램의 기능을 지원하는 데 필요한 사용자 프로필 정보를 검색할 수 있습니다.
