...
기본적으로 Time Series Insights는 프로 비전 하는 저장소 용량 (단위당 저장소 크기 &#215; 단위) 및 수신에 따라 데이터를 보존 합니다.
...
Time Series Insights 환경을 계획 하는 데 중점을 두는 두 번째 영역은 수신 용량입니다. 일별 수신 저장소 및 이벤트 용량은 분당 1 k b 블록 단위로 측정 됩니다. 허용 되는 최대 패킷 크기는 32 KB입니다. 32 KB 보다 큰 데이터 패킷은 잘립니다.
