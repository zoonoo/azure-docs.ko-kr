...
Azure Time Series Insights Gen2 환경은 강력 하 게 형식화 되어 있습니다. 장치 또는 태그가 장치 속성에 대해 서로 다른 유형의 데이터를 전송 하는 경우 값은 두 개의 분리 된 열에 저장 되며, API 호출에서 시계열 모델 변수 식을 정의할 때 [병합 () 함수](/rest/api/time-series-insights/reference-time-series-expression-syntax#other-functions) 를 사용 해야 합니다.
