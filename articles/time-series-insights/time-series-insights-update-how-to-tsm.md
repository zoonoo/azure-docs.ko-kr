...
1. **업로드**를 선택합니다.
    ...
    [![ 대량 업로드 계층 구조](media/v2-update-how-to-tsm/portal-ten.png)](media/v2-update-how-to-tsm/portal-ten.png#lightbox)
...
1. 필요에 따라 변경하고 **저장**을 선택합니다.
    ...
    [![ 계층 편집](media/v2-update-how-to-tsm/portal-eleven.png)](media/v2-update-how-to-tsm/portal-eleven.png#lightbox)
...
1. 계층 구조와 연결된 인스턴스가 없으면 계층 구조가 삭제됩니다.
    ...
    [![ 계층을 삭제 합니다.](media/v2-update-how-to-tsm/portal-twelve.png)](media/v2-update-how-to-tsm/portal-twelve.png#lightbox)
...
1. 인스턴스 페이로드를 포함하는 파일을 선택합니다.
    ...
    [![ 개 이상의 인스턴스를 대량으로 업로드 합니다.](media/v2-update-how-to-tsm/portal-fifteen.png)](media/v2-update-how-to-tsm/portal-fifteen.png#lightbox)
