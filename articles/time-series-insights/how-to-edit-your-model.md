...
> * [Azure Time Series Insights Gen2 explorer](./concepts-ux-panels.md)탐색에 대해 자세히 알아보세요.
...
* Gen2에 대 한 자세한 내용을 보려면 [Azure Time Series Insights Gen2 탐색기에서 데이터 시각화](./concepts-ux-panels.md)를 참조 하세요.
