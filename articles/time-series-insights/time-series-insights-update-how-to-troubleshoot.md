...
- 이벤트 원본 키를 다시 생성 했을 수 있으며 미리 보기 환경에 새 이벤트 원본 키가 있어야 합니다.
...
새 키를 사용 하 여 Time Series Insights 미리 보기 환경을 업데이트 하려면 Azure Portal에서 허브 리소스를 열고 새 키를 복사 합니다. TSI 리소스로 이동 하 여 이벤트 원본을 클릭 합니다. 
