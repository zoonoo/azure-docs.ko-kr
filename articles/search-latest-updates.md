...
[관리 REST API](https://msdn.microsoft.com/library/azure/dn832684.aspx)가 Azure 검색을 일반적으로 사용할 수 있는 릴리스에 속한 관리 API의 1차 버전을 표시합니다. 이전의 미리 보기 및 해당 버전 간의 기능에는 차이가 없습니다.
