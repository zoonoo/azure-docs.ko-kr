...
| REST 작업                                         | .NET 메서드                                      | 전체 공용 읽기가 가능한 권한 | Blob 전용 공용 읽기가 가능한 권한 |
|--------------------------------------------------------|--------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| 컨테이너 나열                                        | ListContainers                                   | 소유자만                              | 소유자만                                        |
| 컨테이너 만들기                                       | 생성                                           | 소유자만                              | 소유자만                                        |
| 컨테이너 속성 가져오기                               | 속성                                       | 모두                                     | 소유자만                                        |
| 컨테이너 메타데이터 가져오기                                 | Metadata                                         | 모두                                     | 소유자만                                        |
| 컨테이너 메타데이터 설정                                 | Metadata                                         | 소유자만                              | 소유자만                                        |
| 컨테이너 ACL 가져오기                                      | BlobContainerPermissions                         | 소유자만                              | 소유자만                                        |
| 컨테이너 ACL 설정                                      | BlobContainerPermissions                         | 소유자만                              | 소유자만                                        |
| 컨테이너 삭제                                       | 삭제                                           | 소유자만                              | 소유자만                                        |
| Blob 나열                                             | ListBlobs                                        | 모두                                     | 소유자만                                        |
| Blob 배치                                               | CloudPageBlob 또는 CloudBlockBlob의 Create 메서드 | 소유자만                              | 소유자만                                        |
| Blob 가져오기                                               | DownloadByteArray 및 기타 메서드                     | 모두                                     | 모두                                               |
| Blob 속성 가져오기                                    | 속성                                       | 모두                                     | 모두                                               |
| Blob 속성 설정                                    | SetProperties                                    | 소유자만                              | 소유자만                                        |
| Blob 메타데이터 가져오기                                      | Metadata                                         | 모두                                     | 모두                                               |
| Blob 메타데이터 설정                                      | Metadata                                         | 소유자만                              | 소유자만                                        |
| 블록 배치                                              | PutBlock                                         | 소유자만                              | 소유자만                                        |
| 블록 목록 가져오기(커밋된 블록만)                 | DownloadBlockList                                | 모두                                     | 모두                                               |
| 블록 목록 가져오기(커밋되지 않은 블록만 또는 모든 블록) | DownloadBlockList                                | 소유자만                              | 소유자만                                        |
| 블록 목록 배치                                         | PutBlockList                                     | 소유자만                              | 소유자만                                        |
| Blob 삭제                                            | 삭제                                           | 소유자만                              | 소유자만                                        |
| Blob 복사                                              | CopyFromBlob                                     | 소유자만                              | 소유자만                                        |
| 스냅숏 Blob                                          | CreateSnapshot                                   | 소유자만                              | 소유자만                                        |
| Blob 임대                                             | 임대                                            | 소유자만                              | 소유자만                                        |
| 페이지 가져오기                                               | WritePages                                       | 소유자만                              | 소유자만                                        |
| 페이지 범위 가져오기                                        | GetPageRanges                                    | 모두                                     |                                                   |
...
>[AZURE.NOTE]공유 액세스 서명에 대한 자세한 개념 개요 및 자습서는 [공유 액세스 서명](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/)을 참조하세요.
