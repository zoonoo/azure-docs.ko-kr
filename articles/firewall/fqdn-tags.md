...
|Azure Kubernetes Service(AKS)|AKS에 대 한 아웃 바운드 액세스를 허용 합니다. 자세한 내용은 [Azure 방화벽을 사용 하 여 AKS (Azure Kubernetes Service) 배포 보호를](protect-azure-kubernetes-service.md)참조 하세요.|
