...
2. 완료되면 **다음: IP 주소** 를 선택합니다.
3. **IPv4 주소 공간** 에 **10.5.0.0/16** 을 입력합니다.
6. **서브넷 이름** 아래에서 **기본값** 을 선택합니다.
7. **이름** 에 **AzureFirewallSubnet** 을 입력합니다. 방화벽은 이 서브넷에 있고 해당 서브넷 이름은 AzureFirewallSubnet이 **되어야** 합니다.
8. **주소 범위** 에 대해 **10.5.0.0/26** 을 입력합니다. 
9. **저장** 을 선택합니다.
10. **검토 + 만들기** 를 선택합니다.
11. **만들기** 를 선택합니다.
...
4. **IPv4 주소 공간** 에 **10.6.0.0/16** 을 입력합니다.
6. **서브넷 이름** 아래에서 **기본값** 을 선택합니다.
7. **이름** 에 **SN-Workload** 를 입력합니다.
8. **주소 범위** 에 대해 **10.6.0.0/24** 를 입력합니다. 
9. **저장** 을 선택합니다.
10. **검토 + 만들기** 를 선택합니다.
11. **만들기** 를 선택합니다.
...
2. **지역** 에 대해 **(US) 미국 동부** 를 선택합니다.
3. **다음: IP 주소** 를 선택합니다.
4. **IPv4 주소 공간** 에 **192.168.0.0/16** 을 입력합니다.
5. **서브넷 이름** 아래에서 **기본값** 을 선택합니다.
7. **이름** 에 **SN-Corp** 를 입력합니다.
8. **주소 범위** 에 대해 **192.168.1.0/24** 를 입력합니다. 
9. **저장** 을 선택합니다.
10. **검토 + 만들기** 를 선택합니다.
11. **만들기** 를 선택합니다.
