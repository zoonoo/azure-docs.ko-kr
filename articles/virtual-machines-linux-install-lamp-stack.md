...
1. **Apache** 설치
	...
	- Apache는 기본적으로 포트 80에서 수신 대기합니다. Apache 서버에 원격으로 액세스하려면 끝점을 열어야 할 수도 있습니다.  자세한 지침에 대해서는 [끝점 구성](http://azure.microsoft.com/ko-kr/documentation/articles/virtual-machines-set-up-endpoints/) 에 대한 설명서를 참조하세요.
