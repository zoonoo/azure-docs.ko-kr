...
7.  전자 메일을 확인해서 주문 확인을 받았는지 확인합니다. 전자 메일을 보내는 데 문제가 있는 경우 ASP.NET 웹 페이지(Razor) 가이드의 [전자 메일 보내기 관련 문제](http://go.microsoft.com/fwlink/?LinkId=253001#email)(영문)를 참조하십시오.
