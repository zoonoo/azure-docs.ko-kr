...
새 자산을 만들 때(예: [파일을 업로드]하기 전(../media-services-rest-upload-files/)) 다음과 같은 암호화 옵션을 지정할 수 있습니다. **StorageEncrypted**, **CommonEncryptionProtected** 또는 **EnvelopeEncryptionProtected** 
