...
[사용자 고유의 이미지를 템플릿으로](../virtual-machines-create-upload-vhd-windows-server/) 사용하여 Windows VM을 만들 수도 있습니다. Azure VM에 대한 자세한 내용은 [Azure 가상 컴퓨터 개요](http://msdn.microsoft.com/library/azure/jj156143.aspx)를 참조하세요.
...
[가상 컴퓨터를 가상 네트워크 또는 클라우드 서비스와 연결하는 방법](../cloud-services-connect-virtual-machine/)

[Windows Server VHD를 만들어서 Azure에 업로드](../virtual-machines-create-upload-vhd-windows-server/)

[가상 컴퓨터의 가용성 관리](../manage-availability-virtual-machines/)
