...
이제 연결 및 쿼리할 수 있으므로 [Power BI로 데이터 시각화](sql-data-warehouse-get-started-visualize-with-power-bi.md)를 시도해 보세요. Azure Active Directory 인증을 위한 환경을 구성하려면 [SQL 풀에 대한 인증](sql-data-warehouse-authentication.md)을 참조하세요.
