---
title: 인증
description: Azure Active Directory(AAD) 또는 SQL Server 인증을 사용하여 Azure Synapse 분석을 인증하는 방법을 알아봅니다.
...
* Azure Active Directory 인증을 구성하고 사용하는 단계는 Azure Synapse의 Azure SQL 데이터베이스 및 SQL 분석과 거의 동일합니다. [Azure Active Directory 인증을 사용하여 SQL 데이터베이스 또는 SQL 풀에 연결하는](../../sql-database/sql-database-aad-authentication.md)항목의 자세한 단계를 따릅니다.
