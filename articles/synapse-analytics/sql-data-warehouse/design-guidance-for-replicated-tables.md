...
description: SQL 분석에서 복제된 테이블 디자인권장 사항
...
- [테이블 만들기(SQL 분석)](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [선택으로 테이블 만들기(SQL 분석)](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
