...
| [DWU(데이터 웨어하우스 단위)](what-is-a-data-warehouse-unit-dwu-cdwu.md) |서버당 기본 DTU |54,000<br></br>기본적으로 각 SQL 서버(예: myserver.database.windows.net)에는 DTU 할당량이 54,000개에 이며, 최대 DW5000c까지 사용할 수 있습니다. 이 할당량은 안전을 위한 제한일 뿐입니다. [지원 티켓을 만들고](sql-data-warehouse-get-started-create-support-ticket.md) 할당량을 요청 유형으로 선택하여 *할당량을* 늘릴 수 있습니다.  DTU 요구 사항을 계산하려면 7.5에 필요한 총 DWU를 곱하거나 9.5에 필요한 총 cDWU를 곱합니다. 다음은 그 예입니다.<br></br>DW6000 x 7.5 = 45,000DTU<br></br>DW5000c x 9.5 = 47,500 DTU.<br></br>포털의 SQL Server 옵션에서 현재 DTU 사용량을 볼 수 있습니다. 일시 중지되거나 일시 중지되지 않은 데이터베이스는 모두 DTU 할당량에 포함됩니다. |
