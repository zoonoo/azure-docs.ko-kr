...
* *구독*:
  * 전용 SQL 풀이 Stream Analytics 작업과 동일한 구독에 있는 경우에는 **구독에서 Azure Synapse Analytics를 선택** 합니다.
  _ 전용 SQL 풀이 다른 구독에 있는 경우 Azure Synapse Analytics 설정 수동으로 제공을 클릭 합니다.
