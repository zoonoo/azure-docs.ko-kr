...
1. 할당량 증가 요청의 경우 **할당량 유형에**대해 **Azure Synapse Analytics** 를 선택 합니다. 그런 후 **다음: 솔루션 >>** 을 선택 합니다.
...
최종 단계는 SQL Database 지원 요청의 나머지 세부 정보를 입력 하는 것입니다. 그런 후 다음을 선택 합니다 **. 검토 + 만들기>>**, 요청 정보를 검토 한 후 **만들기** 를 클릭 하 여 요청을 제출 합니다.
