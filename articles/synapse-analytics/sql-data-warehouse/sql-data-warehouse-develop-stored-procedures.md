...
참고: SQL 데이터 웨어하우스는 현재 [@를@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql)지원하지 않습니다. 중첩 수준을 추적해야 합니다. 8개의 중첩 수준을 초과할 가능성은 없지만 초과하는 경우 이 한도 내에서 중첩 수준에 맞도록 코드를 다시 작업해야 합니다.
