...
- A: 서비스 수준 목표를 참조하는 모든 자동화 스크립트는 Gen2와 동등한 수준으로 변경해야 합니다.  자세한 내용은 [여기](upgrade-to-latest-generation.md#sign-in-to-the-azure-portal)를 참조하세요.
