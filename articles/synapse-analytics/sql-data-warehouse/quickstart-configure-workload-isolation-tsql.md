...
1. [Azure Portal](https://portal.azure.com)에 로그인하고 데이터 웨어하우스에서 선택합니다.
    ...
    ![리소스 정리](./media/quickstart-configure-workload-isolation-tsql/clean-up-resources.png)
