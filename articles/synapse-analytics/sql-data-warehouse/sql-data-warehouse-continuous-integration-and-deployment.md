---
title: 지속적인 통합 및 배포
description: 엔터프라이즈급 데이터베이스 DevOps는 Azure 파이프라인을 사용하여 지속적인 통합 및 배포를 지원하는 데이터 웨어하우징을 위한 환경을 제공합니다.
...
- [SQL 분석 MPP 아키텍처](massively-parallel-processing-mpp-architecture.md) 살펴보기
