...
> [!TIP]
> 행 수가 6천만 개 미만인 테이블의 경우 columstore 인덱스를 사용하는 것은 최적의 솔루션이 아닐 수 있습니다.  
...
따라서 성능이 개선됩니다. 자세한 내용은 [filename](develop-storage-files-overview.md#filename-function) 및 [filepath](develop-storage-files-overview.md#filepath-function) 함수와 [특정 파일을 쿼리하는 방법](query-specific-files.md)을 확인하세요.
