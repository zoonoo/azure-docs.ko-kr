...
이 문서에서는 Azure Synapse Analytics에서 SQL 주문형 (미리 보기)를 사용 하 여 쿼리를 작성 하는 방법에 대해 알아봅니다. 쿼리의 목표는 JSON 파일을 읽는 것입니다. 지원 되는 형식은 [OPENROWSET](develop-openrowset.md)에 나열 됩니다.
