...
다음 예제에서 전용 SQL 풀의 서버 이름은 showdemoweu.sql.azuresynapse.net입니다.
다음 예제에서 서버리스 SQL 풀의 서버 이름은 showdemoweu-ondemand.sql.azuresynapse.net입니다.
...
| 데이터베이스 설정 | 값 |
|:--- |:--- |
| [ANSI_NULLS](/sql/t-sql/statements/set-ansi-nulls-transact-sql?view=azure-sqldw-latest&preserve-view=true) |켜기 |
| [QUOTED_IDENTIFIERS](/sql/t-sql/statements/set-quoted-identifier-transact-sql?view=azure-sqldw-latest&preserve-view=true) |켜기 |
