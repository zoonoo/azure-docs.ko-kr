---
title: 저장 프로시저 사용
description: 솔루션 개발을 위한 Azure Synapse Analytics에서 Synapse SQL을 사용 하 여 저장 프로시저를 구현 하기 위한 팁입니다.
...
> [!NOTE]
> 프로시저 본문에서 Synapse SQL 노출 영역에서 지원 되는 기능만 사용할 수 있습니다. 저장 프로시저에서 사용할 수 있는 개체를 식별 하려면 [이 문서](overview-features.md) 를 검토 하세요. 이 문서의 예제에서는 서버 리스와 전용 노출 영역 둘 다에서 사용할 수 있는 일반 기능을 사용 합니다. 이 문서의 끝부분에서 [프로 비전 및 서버를 사용 하지 않는 SYNAPSE SQL 풀의 추가 제한 사항을](#limitations) 참조 하세요.
