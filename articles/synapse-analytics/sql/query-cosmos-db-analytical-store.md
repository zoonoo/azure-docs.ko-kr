...
description: 이 문서에서는 Azure Synapse Link (미리 보기)에서 서버를 사용 하지 않는 SQL 풀을 사용 하 여 Azure Cosmos DB를 쿼리 하는 방법에 대해 알아봅니다.
...
- [서버를 사용 하지 않는 SQL 풀에서 뷰를 만들고 사용 하는 방법](create-use-views.md) 
