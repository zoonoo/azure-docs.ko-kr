...
다음 쿼리는 parquet 파일을 읽고 [JSON_VALUE](/sql/t-sql/functions/json-value-transact-sql?view=azure-sqldw-latest&preserve-view=true) 를 사용 하 여 배열 또는 맵과 같이 반복 되는 열에서 스칼라 요소를 검색 합니다.
...
다음 쿼리는 mapExample 파일을 읽고 [JSON_QUERY](/sql/t-sql/functions/json-query-transact-sql?view=azure-sqldw-latest&preserve-view=true) 를 사용 하 여 배열 또는 맵과 같이 반복 되는 열 내에서 비 스칼라 요소를 검색 합니다.
