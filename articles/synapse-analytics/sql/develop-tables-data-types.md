...
| [table](/sql/t-sql/data-types/table-transact-sql?view=azure-sqldw-latest&preserve-view=true) |임시 테이블로 변환 하거나 [CETAS](../sql/develop-tables-cetas.md)를 사용 하 여 저장소에 데이터를 저장 하는 것이 좋습니다. |
