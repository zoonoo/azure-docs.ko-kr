...
- Oracle 개체를 SQL Server으로 변환 하는 Oracle 용 SSMA 자세한 내용은 [Oracle 데이터베이스를 SQL Server로 마이그레이션 (OracleToSQL)을](https://docs.microsoft.com/sql/ssma/oracle/migrating-oracle-databases-to-sql-server-oracletosql) 참조 하세요. 
