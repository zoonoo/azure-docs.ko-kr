...
Azure Synapse Studio에서 데이터 원본에 대 한 관리 되는 개인 끝점을 만들 수 있습니다. Azure Portal에서 **개요** 탭을 선택 하 고 시작 섹션에서 Open Synapse Studio 카드에서 **열기** 를 선택 합니다.
...
Azure Synapse Studio의 왼쪽 탐색 모음에서 **관리** 탭을 선택 합니다. **관리 되는 개인 끝점** 을 선택 하 고 **+ 새로 만들기** 를 선택 합니다.
