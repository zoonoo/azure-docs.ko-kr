...
description: Azure Synapse Analytics에서 작업 영역, 데이터 및 파이프라인에 대한 액세스 제어를 관리하는 방법에 대해 알아봅니다.
...
ms.locfileid: "96461350"
---
# <a name="manage-access-to-workspaces-data-and-pipelines"></a>작업 영역, 데이터 및 파이프라인에 대한 액세스 관리

Azure Synapse Analytics에서 작업 영역, 데이터 및 파이프라인에 대한 액세스 제어를 관리하는 방법에 대해 알아봅니다.

> [!NOTE]
> GA의 경우 Synapse 관련 Azure 역할을 도입하여 Azure RBAC를 더욱 개량할 예정입니다.

## <a name="access-control-for-workspace"></a>작업 영역에 대한 액세스 제어
