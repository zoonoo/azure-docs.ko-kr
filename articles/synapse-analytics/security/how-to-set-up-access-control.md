...
| 데이터 허브/연결 된 ADLS Gen2 계정 및 컨테이너 참조 | 예 [1] | 예 [1] | 예 [1] |
...
| 허브/오케스트레이션/파이프라인 실행 모니터링  | YES | 아니요 | 아니요 |
| 허브/오케스트레이션/트리거 실행 모니터링  | YES | 아니요 | 아니요 |
| 허브/오케스트레이션/통합 런타임 모니터링  | YES | YES | YES |
| 허브/작업/Spark 응용 프로그램 모니터링 | YES | YES | 아니요  |
| 허브/활동/s q m 요청 모니터링 | YES | 아니요 | YES |
| 허브/작업/Spark 풀 모니터링 | YES | YES | 아니요  |
| 허브/트리거 모니터링 | YES | 아니요 | 아니요 |
| 허브/연결 된 서비스 관리 | YES | YES | YES |
| 허브/Access Control 관리 (Synapse 작업 영역 역할에 사용자 할당) | YES | 아니요 | 아니요 |
| 허브/통합 런타임 관리 | YES | YES | YES |
...
> [!NOTE]
> [1] 컨테이너의 데이터에 대 한 액세스는 ADLS Gen2의 액세스 제어에 따라 다릅니다. </br>
> [2] SQL OD 테이블 및 Spark 테이블은 ADLS Gen2 데이터를 저장 하 고 액세스에는 ADLS Gen2에 대 한 적절 한 권한이 필요 합니다.
