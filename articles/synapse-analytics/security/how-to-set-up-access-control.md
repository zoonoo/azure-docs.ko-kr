...
> [!NOTE]
> [1] 컨테이너의 데이터에 대 한 액세스는 ADLSGen2의 액세스 제어에 따라 다릅니다. </br>
> [2] SQL OD 테이블 및 Spark 테이블은 ADLSGen2에 데이터를 저장 하 고 access에는 ADLSGen2에 대 한 적절 한 권한이 필요 합니다.
