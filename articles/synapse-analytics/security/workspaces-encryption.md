...
ms.locfileid: "96296801"
---
# <a name="encryption-for-azure-synapse-analytics-workspaces-preview"></a>Azure Synapse Analytics에 대 한 암호화 (작업 영역 미리 보기)

이 문서는 다음을 설명합니다.
* Azure Synapse Analytics 작업 영역에서 미사용 데이터의 암호화.
