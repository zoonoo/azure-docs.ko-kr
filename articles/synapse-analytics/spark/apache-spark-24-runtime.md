---
title: Apache Spark 2.4에 대한 Azure Synapse 런타임
description: Apache Spark 2.4에 지원되는 Spark, Scala, Python 및 .NET 버전
...
Azure Synapse Analytics는 Apache Spark에 다양한 런타임을 지원합니다. 이 문서에서는 Apache Spark 2.4의 Azure Synapse 런타임에 대한 런타임 구성 요소 및 버전을 다룹니다.
