...
| 만들기 편의성 |Azure Portal, Azure PowerShell 또는 Synapse Analytics .NET SDK를 사용하여 몇 분 안에 Azure Synapse에서 새 Spark 풀을 만들 수 있습니다. [Synapse Analytics에서 Spark 풀 시작](apache-spark-notebook-create-spark-use-sql.md)을 참조하세요. |
...
- [빠른 시작: Azure Synapse에서 Spark 풀 만들기](./apache-spark-notebook-create-spark-use-sql.md)
...
- [Azure Synapse에서 Spark 풀 만들기](./apache-spark-notebook-create-spark-use-sql.md)
