...
description: 지원되는 Spark, Scala, Python 버전
...
azureml-파이프라인-코어 = = 1.6.0

azureml-파이프라인-단계 = = 1.6.0
...
azureml-학습-automl = = 1.6.0

azureml-학습-automl-client = = 1.6.0. post1

azureml-학습-automl-runtime = = 1.6.0
