<properties urlDisplayName="Twilio Voice/SMS Service" pageTitle="음성 및 SMS에 Twilio 사용(Java) - Azure" metaKeywords="Twilio, Twilio API, 전화 통화, SMS 메시지, TwiML 응답, Azure Twilio Java" description="Learn how to make a phone call and send a SMS message with the Twilio API service on Azure. Code samples written in Java." metaCanonical="" services="" videoId="" scriptId="" documentationCenter="Java" title="How to Use Twilio for Voice and SMS Capabilities in Java" authors="MicrosoftHelp@twilio.com; robmcm" solutions="" manager="twilio" editor="mollybos" />
