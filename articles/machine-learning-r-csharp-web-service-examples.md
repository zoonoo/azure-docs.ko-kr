<properties title="Sample Web Services Built with R on Azure ML and Published to Marketplace" pageTitle="Azure 기계 학습에서 R로 작성되고 마켓플레이스에 게시되는 샘플 웹 서비스 | Azure" description="Azure 기계 학습에서 R로 작성되고 마켓플레이스에 게시되는 샘플 웹 서비스" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />
...
* [이진 분류자](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-binary-classifier/)
* [클러스터 모델](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-cluster-model/)
* [다변량 선형 회귀](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-multivariate-linear-regression/)
* [예측 - 지수 평활법](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-forecasting-exponential-smoothing/)
* [ETS + STL 예측](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-retail-demand-forecasting/)
* [예측 자동 회귀 통합 이동 평균(ARIMA)](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-arima/)
* [생존 분석](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-survival-analysis/)
...
* [어휘집 기반 감정 분석](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-lexicon-based-sentiment-analysis/)

####시나리오 4: 고급 계산기 
사용자는 고급 계산 또는 시뮬레이션을 제공하므로 학습된 모델이 필요하지 않고 모델을 사용자 데이터에 맞출 필요가 없습니다.

* [비율 차이 테스트](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-difference-in-two-proportions/)
* [정규 분포 제품군](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-normal-distribution/)
* [이항 분포 패키지](http://azure.microsoft.com/ko-kr/documentation/articles/machine-learning-r-csharp-binomial-distribution/)
