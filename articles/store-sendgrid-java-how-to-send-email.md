...
이 가이드에서는 Azure에서 SendGrid 메일 서비스로 일반 프로그래밍 작업을 수행하는 방법을 보여 줍니다. 샘플은 Java로 작성되었습니다. **메일 생성**, **메일 보내기**, **첨부 파일 추가**, **필터 사용**, **속성 업데이트** 등의 시나리오를 다룹니다. SendGrid 및 메일 보내기에 대한 자세한 내용은 [다음 단계][] 섹션을 참조하세요.
...
<http://www.oracle.com/technetwork/java/javamail>(영문)에서 얻어
코드로 가져옵니다. javax.mail 라이브러리를 사용하여 SMTP를 통해 메일을
...
3.  인증된 메일 세션을
    <span class="auto-style1">javax.mail.Session</span> 개체를 통해 만듭니다.  

        Authenticator auth = new SMTPAuthenticator();
        Session mailSession = Session.getDefaultInstance(properties, auth);

4.  메시지를 만들고 **받는 사람**, **보낸 사람**, **제목** 및
    내용 값을 할당합니다. [방법: 메일 만들기](#bkmk_HowToCreateEmail) 섹션에 나와 있습니다.
5.  메시지를
    <span class="auto-style1">javax.mail.Transport</span> 개체를 통해 보냅니다. 
    [방법: 메일 보내기][How to: Send an Email]
    섹션에 나와 있습니다.

## <a name="bkmk_HowToCreateEmail"> </a>방법: 메일 만들기
...
-   다음은 보내는 메일 아래쪽에 HTML 텍스트가 표시되도록 하는
...
## <a name="bkmk_HowToUpdateEmail"> </a>방법: 메일 속성 업데이트

일부 메일 속성을 **set*Property***를 사용하여 덮어쓰거나 **add*Property***를 사용하여 추가할 수 있습니다.
