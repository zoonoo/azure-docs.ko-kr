...
## <a name="how-to-use-the-javaxmail-libraries"></a>방법: Javax.sql 라이브러리 사용
...
3. 메시지를 만들고 **받는 사람**, **보낸 사람**, **제목** 및 내용 값을 할당합니다. 이는 [방법: 전자 메일](#how-to-create-an-email) 섹션을 만듭니다.
4. *javax.mail.Transport* 개체를 통해 메시지를 보냅니다. 이는 [방법: 전자 메일 보내기] [전자 메일 보내기] 섹션을 #how.
...
## <a name="how-to-use-filters-to-enable-footers-tracking-and-analytics"></a>방법: 필터를 사용 하 여 바닥글, 추적 및 분석을 사용 하도록 설정
...
* Azure 배포에서 SendGrid를 사용 하는 방법을 보여 주는 샘플: [Azure 배포에서 Java의 SendGrid를 사용 하 여 전자 메일을 보내는 방법](store-sendgrid-java-how-to-send-email-example.md)
