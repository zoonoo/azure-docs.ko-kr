<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Dotster" pageTitle="트래픽 관리자를 사용하여 Azure 웹 사이트에 대한 Dotster 도메인 이름 구성" metaKeywords="Microsoft Azure, Microsoft Azure 웹 사이트, Dotster, 트래픽 관리자" description="Dotster에 등록된 도메인 이름을 사용하도록 트래픽 관리자를 사용하는 Azure 웹 사이트를 구성하는 방법에 대해 알아봅니다." services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
