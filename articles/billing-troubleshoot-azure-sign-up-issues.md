...
* "문자로 인증"을 선택하는 경우 메시징 시스템에서 문자 메시지를 보낼 수 있도록 최대 4분 기다려 주세요.
...
### <a name="suggestion"></a>제안
새 혜택 구독을 활성화하려고 하는데 등록 중에 오류가 발생한 경우 [Azure 구독 페이지](http://account.windowsazure.com/Subscriptions)에서 구독 설정을 완료했는지 확인하세요. 구독이 활성 상태로 표시되려면 몇 분 정도 걸릴 수 있습니다. 구독이 활성화되면 이메일을 수신합니다. 구독 상태가 4분 넘게 보류 중으로 남아 있으면 [Azure 지원에 문의](http://go.microsoft.com/fwlink/?linkid=544831&clcid=0x409)하여 도움을 요청하세요.
