...
이 자습서에서는 [Azure PowerShell](http://azure.microsoft.com/documentation/articles/install-configure-powershell/)에서 삭제된 Azure SQL 데이터베이스를 복원하는 방법을 설명합니다. 삭제된 데이터베이스는 보존 기간이 지나지 않은 경우 삭제된 시점으로 복원할 수 있습니다. 보존 기간은 데이터베이스의 서비스 계층에 의해 결정됩니다.
