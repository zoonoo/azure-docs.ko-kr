---
title: Linux 용 Azure Automanage
description: Linux 컴퓨터용으로 자동으로 등록 및 구성 되는 서비스에 대 한 Azure Automanage for virtual machines 모범 사례에 대해 알아봅니다.
author: deanwe
...
이러한 Azure 서비스는 Linux VM에서 Vm (가상 머신)에 대해 Automanage를 사용 하는 경우 자동으로 등록 됩니다. [클라우드 채택 프레임 워크](/azure/cloud-adoption-framework/manage/azure-server-management)에서 찾을 수 있는 모범 사례 백서에 반드시 필요 합니다.
...
## <a name="supported-linux-distributions-and-versions"></a>지원 되는 Linux 배포판 및 버전
...
|Azure 게스트 구성    | 게스트 구성 정책을 사용 하 여 구성을 모니터링 하 고 컴퓨터의 호환성을 보고 합니다. Automanage 서비스는 게스트 구성 확장을 사용 하 여 Azure Linux 기준선을 설치 합니다. Linux 컴퓨터의 경우 게스트 구성 서비스는 감사 전용 모드에서 기준선을 설치 합니다. VM이 기준을 준수 하지 않는 위치를 확인할 수 있지만 비준수는 자동으로 재구성 되지 않습니다. 자세히 [알아보세요.](../governance/policy/concepts/guest-configuration.md)    |프로덕션, 개발/테스트    |아니요    |
