...
* Log Analytics 작업 영역, Automation 계정 지역 및 대상 지역이 [여기](https://docs.microsoft.com/azure/automation/how-to/region-mappings)에서 지역 매핑에서 지 원하는 모든 지역 인지 확인 합니다.
...
Vm을 이동 하는 방법에 대 한 자세한 내용은이 [문서](https://docs.microsoft.com/azure/resource-mover/tutorial-move-region-virtual-machines)를 참조 하세요.
