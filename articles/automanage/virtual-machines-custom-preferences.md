...
4. **구성 프로필**에서 **프로필 및 기본 설정을 찾아 변경**을 클릭합니다.
    ...
    :::image type="content" source="media\virtual-machine-custom-preferences\existing-vm-quick-create.png" alt-text="사용 가능한 VM 목록에서 기존 VM 선택":::

5. **구성 프로필 + 기본 설정 선택** 블레이드에서 왼쪽에 있는 프로필을 선택 합니다. 테스트에 대 한 *개발/테스트* , 프로덕션에 대해 *Prod* 입니다.

    :::image type="content" source="media\virtual-machine-custom-preferences\browse-production-profile.png" alt-text="사용 가능한 VM 목록에서 기존 VM 선택":::
...
:::image type="content" source="media\virtual-machine-custom-preferences\disable-step-1.png" alt-text="사용 가능한 VM 목록에서 기존 VM 선택":::
