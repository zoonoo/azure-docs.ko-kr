---
title: 서버 탐색기에서 Azure 가상 컴퓨터 액세스 | Microsoft Docs
...
3. 다음 테이블은 사용 가능하지만 읽기 전용인 끝점 속성을 설명합니다. 가상 컴퓨터에 대해 끝점을 추가 또는 편집하려면 [Azure 클래식 포털](http://go.microsoft.com/fwlink/?LinkID=213885)을 사용합니다.
