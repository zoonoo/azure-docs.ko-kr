...
- [안전 하 고 Azure로 관리 되는 워크스테이션 이해](/security/compass/concept-azure-managed-workstation)
...
- [Privileged Identity Management 배포 하는 방법](../active-directory/privileged-identity-management/pim-deployment-plan.md)
