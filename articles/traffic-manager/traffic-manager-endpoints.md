...
>[AZURE.NOTE]Azure 포털을 사용하여 외부 위치나 트래픽 관리자 프로필을 끝점으로 추가할 수 없습니다. REST API [정의 만들기](http://go.microsoft.com/fwlink/p/?LinkId=400772) 또는 Windows PowerShell [Add-AzureTrafficManagerEndpoint](http://go.microsoft.com/fwlink/p/?LinkId=400774)를 사용해야 합니다.
