---
title: 회사 인터넷 도메인이 트래픽 관리자 도메인을 가리키도록 설정 | Microsoft Docs
...
> [!IMPORTANT]
> *contoso.com* 과 같은 두 번째 수준의 도메인이 트래픽 관리자 도메인을 가리킬 수 없습니다. DNS 프로토콜의 제한사항이며, CNAME 레코드를 두 번째 수준 도메인 이름으로 허용하지 않습니다.
> 
> 
