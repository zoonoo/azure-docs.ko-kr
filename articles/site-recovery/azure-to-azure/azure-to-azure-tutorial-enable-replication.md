...
IP 기반 방화벽, 프록시 또는 NSG 규칙을 사용하여 아웃바운드 연결을 제어하는 경우 다음 IP 주소 범위를 허용 목록에 추가해야 합니다. 다음 링크에서 범위 목록을 다운로드합니다.
  ...
  - [Microsoft Azure 데이터 센터 IP 범위](http://www.microsoft.com/download/details.aspx?id=41653)
  - [Windows Azure 데이터 센터 IP 범위(독일)](http://www.microsoft.com/download/details.aspx?id=54770)
  - [Windows Azure 데이터 센터 IP 범위(중국)](http://www.microsoft.com/download/details.aspx?id=42064)
