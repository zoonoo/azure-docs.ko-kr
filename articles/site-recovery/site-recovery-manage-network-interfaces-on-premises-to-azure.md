---
title: Azure 사이트 복구를 통해 온-프레미스 재해 복구를 위한 네트워크 어댑터 관리
...
---
# <a name="manage-vm-network-interfaces-for-on-premises-disaster-recovery-to-azure"></a>Azure에 대한 온-프레미스 재해 복구를 위한 VM 네트워크 인터페이스 관리
