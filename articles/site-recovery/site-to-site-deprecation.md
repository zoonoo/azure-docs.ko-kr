---
title: Azure Site Recovery를 사용 하 여 고객 관리 사이트 (VMM) 간의 재해 복구 사용 중단 Microsoft Docs
...
ms.locfileid: "74040399"
---
# <a name="deprecation-of-disaster-recovery-between-customer-managed-sites-with-vmm-using-azure-site-recovery"></a>Azure Site Recovery를 사용 하 여 고객 관리 사이트 (VMM 사용) 간의 재해 복구 사용 중단
...
Hyper-v 복제본 사용의 옵션 2로 이동 하려면 다음 단계를 실행 하십시오.
