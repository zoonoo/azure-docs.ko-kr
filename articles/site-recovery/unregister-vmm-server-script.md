---
title: VMM 서버 스크립트 등록 취소
description: 이 문서에서는 VMM 서버의 정리 스크립트에 대해 설명합니다.
manager: evansma
...
ms.locfileid: "112026222"
---
# <a name="cleanup-script-on-a-vmm-server"></a>VMM 서버의 정리 스크립트
VMM 서버가 연결 분리 상태인 경우 VMM 서버에서 정리 스크립트를 다운로드하여 실행합니다.
