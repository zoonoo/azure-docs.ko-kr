...
전체 배포를 진행하려면 필요한 복제 리소스를 파악해야 합니다. 이 작업을 수행하는 데 사용할 수 있는 도구는 두 가지가 있습니다. 2단계로 이동합니다. 환경을 테스트하는 빠른 설정을 수행하려면 이 단계를 건너뛸 수 있습니다.
...
시작하기 전에 Azure 네트워크 및 저장소를 설정합니다. 배포하는 동안 이 작업을 수행할 수 있지만 시작하기 전에 수행하는 것이 좋습니다.
