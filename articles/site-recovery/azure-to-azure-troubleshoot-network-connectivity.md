...
1. 다음 스크린샷에 표시 된 것 처럼 NSG에 대 한 HTTPS 아웃 바운드 보안 규칙을 만듭니다. 이 예제에서는 **대상 서비스 태그**: _AzureActiveDirectory_ 및 **대상 포트 범위**: _443_ 을 사용 합니다.
...
1. _CentralUS_ 에 대 한 HTTPS 아웃 바운드 보안 규칙을 만듭니다.

   - **대상 서비스 태그**: _CentralUS_
   - **대상 포트 범위**: _443_

1. _AzureActiveDirectory_ 에 대 한 HTTPS 아웃 바운드 보안 규칙을 만듭니다.
