...
이 자습서에서는 [Azure Site Recovery](site-recovery-overview.md) 서비스를 사용하여 보조 Azure 지역으로 Azure VM(가상 머신)을 장애 조치(failover)하는 방법을 설명합니다. 장애 조치한 후 VM을 다시 보호합니다. 이 자습서에서는 다음 작업 방법을 알아봅니다.
