<properties
	pageTitle="사이트 복구 저장소 매핑 | Microsoft Azure"
...
저장소 매핑은 사이트 복구 배포의 중요한 요소입니다. 이 요소를 통해 저장소 사용을 최적화할 수 있습니다. 이 문서는 저장소 매핑을 설명하고 저장소 매핑 작동 원리를 이해하는 데 도움이 되는 몇 가지 예를 제공합니다.
