---
title: Azure 사이트 복구를 사용하여 보조 사이트에 대한 VMware/물리적 재해 복구 지원
...
온-프레미스 VMware 또는 물리적 데이터 센터 간의 복제를 위한 사이트 복구 시나리오가 지원 종료에 도달하고 있습니다.

- 2018년 8월부터 는 복구 서비스 자격 증명 모음에서 시나리오를 구성할 수 없으며 InMage Scout 소프트웨어는 볼트에서 다운로드할 수 없습니다. 기존 배포는 계속 지원됩니다.
