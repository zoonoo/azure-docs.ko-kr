...
1. VMware VM에 대 한 [복제를 사용 하도록 설정](site-recovery-hyper-v-site-to-azure.md) 하는 경우 복제 하려는 vm을 선택한 후 **복제 사용** > **속성** > **구성 속성** 페이지에서 **복제할 디스크** 열을 검토 합니다. 기본적으로 모든 디스크는 복제를 위해 선택 됩니다.
