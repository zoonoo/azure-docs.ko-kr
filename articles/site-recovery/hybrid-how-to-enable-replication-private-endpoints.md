...
> [!NOTE]
> 저장소 계정에서 개인 끝점을 사용 하도록 설정 하지 않은 경우에도 보호에 성공 합니다. 그러나 복제 트래픽은 인터넷을 통해 Azure Site Recovery 공용 끝점으로 전송 됩니다. 복제 트래픽이 개인 링크를 통해 전달 되도록 하려면 개인 끝점을 사용 하 여 저장소 계정을 설정 해야 합니다.
