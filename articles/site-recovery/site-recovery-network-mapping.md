<properties
	pageTitle="Azure Site Recovery 네트워크 매핑 | Microsoft Azure"
...
네트워크 매핑을 자세히 살펴보았으므로 이제 배포 준비를 위해 [모범 사례](site-recovery-best-practices.md)를 읽어보세요.
