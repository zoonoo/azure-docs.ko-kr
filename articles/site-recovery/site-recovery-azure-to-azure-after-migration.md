...
복제를 설정하고 온-프레미스 Hyper-V, VMware 및 실제 워크로드를 Azure로 마이그레이션하려면 [Azure Site Recovery를 사용하여 Azure 지역 간에 Azure IaaS 가상 컴퓨터 마이그레이션](site-recovery-migrate-to-azure.md) 문서의 단계를 따르세요. 
