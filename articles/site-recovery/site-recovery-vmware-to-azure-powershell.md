---
title: "Azure Site Recovery PowerShell을 사용하여 VMware 가상 머신을 Azure로 복제 및 장애 조치(failover) | Microsoft Docs"
description: "Azure Site Recovery PowerShell을 사용하여 VMware 가상 머신을 Azure로 복제 및 장애 조치(failover)"
...
---
# <a name="replicate-and-failover-vmware-virtual-machines-to-azure-using-azure-site-recovery-powershell"></a>Azure Site Recovery PowerShell을 사용하여 VMware 가상 머신을 Azure로 복제 및 장애 조치(failover)
...
시작하기 전에 다음을 수행합니다.
- [시나리오 아키텍처 및 구성 요소](concepts-vmware-to-azure-architecture.md)를 이해해야 합니다.
...
* [보호 목표 선택](site-recovery-set-up-vmware-to-azure.md#choose-your-protection-goals)
* [원본 환경 설정](site-recovery-set-up-vmware-to-azure.md#set-up-the-source-environment) 
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>vCenter Server를 추가하고 VMware 가상 머신 검색
