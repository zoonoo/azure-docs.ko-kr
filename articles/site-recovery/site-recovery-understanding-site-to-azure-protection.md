<properties
	pageTitle="Azure Site Recovery를 사용한 Hyper-V 복제 | Microsoft Azure"
...
# Azure Site Recovery를 사용한 Hyper-V 복제
...
## 온-프레미스와 Azure 간 복제를 위한 원본 환경 설정
...
| Category | 시나리오 |
|---------------------------|----------------------------------------------|
| 복구할 수 없는 오류 | 재시도가 수행되지 않습니다. 가상 컴퓨터 복제 상태가 **위험**으로 표시되고 관리자 개입이 필요합니다. 이러한 예로 다음이 포함됩니다. <ul><li>VHD 체인 끊김</li><li>복제본 가상 컴퓨터의 유효하지 않은 상태</li><li>네트워크 인증 오류</li><li>권한 부여 오류</li><li> 독립 실행형 Hyper-V 서버인 경우 가상 컴퓨터를 찾을 수 없음</li></ul>|
