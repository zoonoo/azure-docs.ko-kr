...
**모바일 서비스** | 온-프레미스 VMware 서버/물리적 서버 및 Azure/보조 사이트 간 복제 조정 | NA(포털에서 사용 가능) | 복제하려는 각 VMware VM 또는 물리적 서버에 설치 **MARS(Microsoft Azure Recovery Services) 에이전트** | Hyper-V VM과 Azure 간 복제 조정<br/><br/>  온-프레미스 Hyper-V 서버에 설치(VMM 서버 존재 여부는 관계 없음) | 2.0.8689.0(포털에서 사용 가능) | 이 에이전트는 Azure Site Recovery 및 Azure 백업에서 사용됩니다. [자세한 정보](https://support.microsoft.com/en-us/kb/2997692)
