...
---|---|---
**VMM**: System Center 2012 R2에서 실행 중인 VMM 서버 하나 이상. VMM 서버에는 VMM 호스트 그룹이 하나 이상 포함된 클라우드가 하나 이상 있어야 합니다.<br/><br/> 
