...
7. 초기 데이터 동기화가 완료되고 Azure에서 가상 컴퓨터를 종료할 준비가 되었을 때 장애 조치 전에 데이터를 동기화하는 옵션을 선택했다면 **작업** > <계획된 장애 조치 작업 이름> **완전한 장애 조치**를 클릭합니다. 그러면 Azure 컴퓨터가 종료되고 마지막 변경 내용이 온-프레미스 가상 컴퓨터에 전송된 다음 시작됩니다.
...
3. **보호된 항목** -> **보호 그룹** -> <ProtectionGroupName> -> 장애 복구할 <VirtualMachineName>을 선택하고 **계획된 장애 복구**를 선택합니다.
...
8. 초기 동기화가 완료되고 Azure에서 가상 컴퓨터를 종료할 준비가 되면 **작업** > <계획된 장애 복구 작업> > **완전한 장애 조치**를 클릭합니다. 그러면 Azure 컴퓨터가 종료되고 최신 변경 내용이 온-프레미스 가상 컴퓨터에 전송된 다음 시작됩니다.
