---
title: Azure Site Recovery를 사용 하 여 Hyper-v 재해 복구를 위한 Deployment Planner
...
* [Deployment planner를 실행](site-recovery-hyper-v-deployment-planner-run.md)합니다.
