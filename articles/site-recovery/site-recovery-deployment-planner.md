...
* Azure로 재해 복구하는 데 예상되는 총 비용: 계산, 저장소, 네트워크 및 Site Recovery 라이선스 비용
* VM별 자세한 비용 분석
...
Site Recovery Deployment Planner 도구의 최신 버전은 2.2입니다.
