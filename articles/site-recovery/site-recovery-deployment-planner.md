...
* 각 VM의 스토리지 유형(표준 또는 프리미엄 스토리지) 요구 사항
* 복제를 위해 설정해야 할 표준 및 프리미엄 스토리지 계정의 총 수(캐시 스토리지 계정 포함)
...
최신 업데이트는 Deployment Planner [버전 기록](site-recovery-deployment-planner-history.md)에 요약되어 있습니다.
...
Site Recovery Deployment Planner 도구의 최신 버전은 2.5입니다.
각 업데이트에 추가된 수정 사항은 [Site Recovery Deployment Planner 버전 기록](./site-recovery-deployment-planner-history.md) 페이지를 참조하세요.
