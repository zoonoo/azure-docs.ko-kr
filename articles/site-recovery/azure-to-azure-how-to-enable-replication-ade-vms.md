...
8. **대상 위치**를 선택합니다.
9. **디스크 암호화 키 자격 증명 모음**: 기본적으로 Azure Site Recovery는 원본 VM 디스크 암호화 키를 기반으로 대상 지역에 접미사 "asr"이 포함된 이름으로 새로운 키 자격 증명 모음을 만듭니다. Azure Site Recovery에서 만든 키 자격 증명 모음이 이미 있으면 재사용 됩니다. 필요한 경우 목록에서 다른 키 자격 증명 모음을 선택할 수 있습니다.
10. **키 암호화 키 자격 증명 모음**: 기본적으로 Azure Site Recovery는 원본 VM 키 암호화 키를 기반으로 대상 지역에 접미사 "asr"이 포함된 이름으로 새로운 키 자격 증명 모음을 만듭니다. Azure Site Recovery에서 만든 키 자격 증명 모음이 이미 있으면 재사용 됩니다. 필요한 경우 목록에서 다른 키 자격 증명 모음을 선택할 수 있습니다.
