...
* [온-프레미스 VMware 준비](tutorial-prepare-on-premises-vmware.md)
...
3. Site Recovery가 호환되는 Azure 저장소 계정 및 네트워크가 하나 이상 있는지 확인합니다.
   ...
   ![대상 탭](./media/tutorial-vmware-to-azure/storage-network.png)
...
7. **앱 일치 스냅숏 빈도**에서 앱 일치 스냅숏을 만드는 빈도로 기본값인 60분을 사용합니다. **확인**을 선택하여 정책을 만듭니다.
   ...
   ![복제 정책 만들기](./media/tutorial-vmware-to-azure/replication-policy.png)
