...
### <a name="how-often-does-site-recovery-send-diagnostic-logs-to-azure-monitor-log"></a>Site Recovery에서 진단 로그를 Azure Monitor 로그에 전송 하는 빈도는 얼마나 됩니까? 
...
### <a name="whats-the-size-of-the-diagnostic-logs"></a>진단 로그의 크기는 어떻게 되나요? 
