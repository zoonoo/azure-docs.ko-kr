...
|---|---|
|**Azure 간** | |
| [Recovery Services 자격 증명 모음 만들기](https://docs.microsoft.com/azure/site-recovery/quickstart-create-vault-template)| Recovery Services 자격 증명 모음을 만듭니다. 자격 증명 모음은 Azure Backup 및 Azure Site Recovery에 사용할 수 있습니다. |
