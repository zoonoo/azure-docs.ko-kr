...
운영 체제 디스크 크기 | 1 세대 컴퓨터의 경우 최대 2048 GB <br> 2 세대 컴퓨터의 경우 최대 4095 GB | 지원되지 않는 경우 확인이 실패합니다.
운영 체제 디스크 수 | 1 </br> 서로 다른 디스크의 부팅 및 시스템 파티션이 지원 되지 않습니다. | 지원되지 않는 경우 확인이 실패합니다.
데이터 디스크 수 | 64개 이하. | 지원되지 않는 경우 확인이 실패합니다.
데이터 디스크 크기 | 관리 디스크 (9.41 버전 이상)에 복제 하는 경우 최대 32767 GB<br> 저장소 계정으로 복제 하는 경우 최대 4095 GB </br> 최소 디스크 크기 요구 사항-1024 이상| 지원되지 않는 경우 확인이 실패합니다.
