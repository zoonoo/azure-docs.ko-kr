---
title: "Azure Site Recovery를 사용하여 보조 사이트로 장애 조치(failover) 후 VM 연결 | Microsoft Docs"
...
---
# <a name="vm-connectivity-after-failover-to-a-secondary-site"></a>보조 사이트로 장애 조치(failover) 후 VM 연결
