...
![구성 요소](./media/concepts-physical-to-azure-architecture/arch-enhanced.png)
...
![복제 프로세스](./media/concepts-physical-to-azure-architecture/v2a-architecture-henry.png)
...
![장애 복구](./media/concepts-physical-to-azure-architecture/enhanced-failback.png)
