...
2. 온-프레미스 [VMware](tutorial-prepare-on-premises-vmware.md) 또는 Hyper-V 서버를 준비합니다.
...
6. 대시보드에서 자격 증명 모음에 빠르게 액세스하려면 **대시보드에 고정**을 클릭하고 **만들기**를 클릭합니다.
   ...
   ![새 자격 증명 모음](./media/tutorial-migrate-on-premises-to-azure/onprem-to-azure-vault.png)
...
> 온-프레미스 사이트에서 마이그레이션한 후 Azure VM에 대해 [재해 복구를 설정](site-recovery-azure-to-azure-after-migration.md)합니다.
