...
Azure Site Recovery Deployment Planner 보고서는 [권장 사항](site-recovery-hyper-v-deployment-planner-analyze-report.md#recommendations) 시트에서 비용 예측 요약을 제공하고, 비용 예측 시트에서 자세한 비용 분석을 제공합니다. VM당 자세한 비용 분석이 있습니다. 
...
![비용 예측 세부 정보](media/site-recovery-hyper-v-deployment-planner-cost-estimation/cost-estimation1-h2a.png)
...
![자세한 비용 분석](media/site-recovery-hyper-v-deployment-planner-cost-estimation/detailed-cost-analysis-h2a.png)
...
[Site Recovery를 사용하여 Hyper-V VM을 Azure로 보호](https://docs.microsoft.com/azure/site-recovery/tutorial-hyper-v-to-azure)하는 방법을 자세히 알아봅니다.
