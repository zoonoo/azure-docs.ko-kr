...
> [!NOTE]
> 업데이트 롤업 35부터 업데이트에 사용할 기존 automation 계정을 선택할 수 있습니다. 이 업데이트 전에 Site Recovery는 기본적으로이 계정을 만들었습니다. 이 옵션은 VM의 복제를 사용 하도록 설정 하면 사용할 수 있습니다. 설정을 변경 하는 경우 동일한 자격 증명 모음에서 보호 하는 모든 Azure Vm에 대해 적용 됩니다.
...
> [!Note]
> 두 옵션 중 하나를 사용 하면 업데이트 관리에 사용 되는 automation 계정의 알려줍니다. 처음에 대 한 자격 증명 모음에서이 기능을 사용 중인, 하는 경우 새 automation 계정은 기본적으로 생성 됩니다. 또는 설정을 사용자 지정 하 고 기존 automation 계정을 선택할 수 있습니다. 동일한 자격 증명 모음의 모든 후속 활성화 복제 이전에 만든된 것을 사용합니다.
