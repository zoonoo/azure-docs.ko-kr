...
4. **설정** 에서 다음과 같은 대상 사이트 설정을 구성할 수 있습니다.
    ...
    - **대상 virtual network** : 기본적으로 Site Recovery는 대상 지역에 새 가상 네트워크를 만듭니다. 이름은 접미사를 가져옵니다 `asr` . 원본 네트워크에 매핑되고 향후 보호에 사용 됩니다. [자세히 알아봅니다](./azure-to-azure-network-mapping.md) 를 확인해 보세요.
...
![Vm의 상태를 확인할 수 있는 위치를 보여 주는 스크린샷](./media/azure-to-azure-how-to-enable-replication-cmk-disks/cmk-customize-target-disk-properties.png)
