...
다운로드한 자격 증명 모음 등록 키를 사용하여 아래 제공된 문서의 단계에 따라 구성 서버의 설치 및 등록을 완료합니다.
...
* 컴퓨터를 복제하는 데 사용할 수 있는 프로세스 서버를 식별합니다.
...
장애 조치(failover)가 완료되면 장애 조치(failover) 작업을 커밋하고 Azure에서 온-프레미스 VMware 사이트로 역방향 복제를 설정할 수 있습니다.
