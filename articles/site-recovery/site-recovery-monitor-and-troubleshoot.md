...
ms.locfileid: "68717360"
---
# <a name="monitor-site-recovery"></a>모니터 Site Recovery
...
2. 대시보드에서 다른 영역으로 드릴 다운 합니다. 
    ...
    ![Site Recovery 대시보드](./media/site-recovery-monitor-and-troubleshoot/site-recovery-overview-page.png)을 선택합니다.
...
**State** | **세부 정보**
--- | ---
정상 | 복제가 정상적으로 진행되고 있습니다. 오류 또는 경고 증상이 검색되지 않았습니다.
경고 | 복제에 영향을 줄 수 있는 하나 이상의 경고 증상이 검색되었습니다.
심각 | 하나 이상의 중요한 복제 오류 증상이 검색되었습니다.<br/><br/> 이러한 오류 증상은 일반적으로 복제가 중단되거나 데이터 변경률만큼 빠르게 진행되지 않음을 나타내는 지표입니다.
...
리소스 누락 | 지정된 리소스를 찾을 수 없거나 구독에서 사용할 수 없습니다. 예를 들어, 리소스가 삭제되었거나 마이그레이션되었습니다. 모니터링된 리소스에는 대상 리소스 그룹, 대상 VNet/서브넷, 로그/대상 스토리지 계정, 대상 가용성 집합, 대상 IP 주소가 포함되어 있습니다.
...
**복제 된 항목**에서 복제 된 컴퓨터의 목록을 가져옵니다. 
    ![Site Recovery 복제 된 항목 목록 보기](./media/site-recovery-monitor-and-troubleshoot/site-recovery-virtual-machine-list-view.png)
