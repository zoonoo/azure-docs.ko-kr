...
**지원 매트릭스** | [자세한 내용을 보려면 여기를 클릭 하세요.](./vmware-physical-azure-support-matrix.md)|[ASR Scout 호환 매트릭스 다운로드](https://aka.ms/asr-scout-cm)


## <a name="prerequisites"></a>사전 요구 사항
이 자습서를 완료하려면 다음이 필요합니다.

- 모든 구성 요소에 대 한 지원 요구 사항을 [검토](vmware-physical-secondary-support-matrix.md) 합니다.
...
- InMage_UA_8.0.7.0_SLES11-SP4-64_GA_03Dec2018_release.tar.gz
  1. .zip 파일의 압축을 풉니다.
  2. **Rx 서버**: Copy **RX_8.0.7.0_St_up_7_29656b_28release.tar.gz** MF.를 RX 서버에 복사 하 고 압축을 풉니다. 압축을 푼 폴더에서 **/Install**을 실행합니다.
  ...
  **InMage_Scout_vContinuum_MT_8.0.7.0_Windows_GA_27Dec2018_release.exe**로 준비된 마스터 대상에는 이 업데이트를 적용할 필요가 없습니다. 모든 최신 변경 내용을 포함하는 새 GA 설치 관리자이기 때문입니다.
  ...
  6. **Linux 마스터 대상 서버**: 통합 된 에이전트를 업데이트 하려면 Linux 마스터 대상 서버에 InMage_UA_8을 복사 하 고, Linux 마스터 대상 서버에 **201를** 복사 하 여 압축을 풉니다. 압축을 푼 폴더에서 **/Install**을 실행합니다.
  ...
  8. **Linux 원본 서버**: 통합 에이전트를 업데이트하려면 해당 버전의 통합 에이전트 파일을 Linux 서버에 복사하고 압축을 풉니다. 압축을 푼 폴더에서 **/Install**을 실행합니다.  예: RHEL 6.7 64 비트 서버에서 InMage_UA_8를 복사 하 고 서버에 release.tar.gz를 복사 하 여 서버에 압축을 풉니다 ( **InMage_UA_8.0.7.0_RHEL6-64_GA_03Dec2018_release.tar.gz** ). 압축을 푼 폴더에서 **/Install**을 실행합니다.
