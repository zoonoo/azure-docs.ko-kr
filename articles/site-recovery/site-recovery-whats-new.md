...
- 모바일 서비스 확장 (Azure Vm의 경우) 및 모바일 서비스 에이전트 (VMware/물리적 컴퓨터의 경우)의 9.30 (릴리스 11 월 2019) 버전에서 일부 컴퓨터 운영 체제는 서비스 스택 업데이트 및 s h a-2를 실행 해야 합니다. 세부 정보는 아래 표에 나와 있습니다.
