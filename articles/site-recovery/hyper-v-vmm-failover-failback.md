---
title: Azure Site Recovery를 사용 하 여 보조 Hyper-v 사이트로 장애 조치 (failover)/장애 복구 (failback) 설정
...
- [재해 복구 훈련](hyper-v-vmm-test-failover.md)을 완료하여 모든 항목이 예상대로 작동하는지 확인합니다.
