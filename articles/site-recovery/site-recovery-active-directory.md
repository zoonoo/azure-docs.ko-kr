...
> [!NOTE]
> 옵션-2를 구현하더라도 테스트 장애 조치(Failover)를 수행하기 위해서는 Site Recovery를 사용하여 계속 도메인 컨트롤러를 복제해야 합니다. 자세한 내용은 [테스트 장애 조치 시 고려 사항](#considerations-for-test-failover) 을 확인하세요.
> 
> 
