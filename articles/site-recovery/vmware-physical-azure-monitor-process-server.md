...
![중요][red] | 지난 15 분간 CPU 사용률 > 95%
![중요][red] | 최근 15 분 동안 메모리 사용 > 95%
![중요][red] | 최근 15 분 동안 캐시 폴더의 사용 가능한 공간 < 25%
![중요][red] | Site Recovery은 5 분 마다 보류/발신 데이터를 모니터링 하 고, 프로세스 서버 캐시의 데이터를 45 분 내에 Azure에 업로드할 수 없음을 예상 합니다.
