...
> [!NOTE]
> Azure에는 리소스를 만들고 작업하기 위한 [리소스 관리자 및 클래식](../resource-manager-deployment-model.md)라는 두 가지 배포 모델이 있습니다. 이 문서에서는 클래식 배포 모델 사용에 대해 설명합니다. 
> 
> 
...
## <a name="<a-name=monitor></a>-monitor-activity"></a><a name=monitor></a> 작업 모니터
