...
- Windows를 실행하는 컴퓨터의 경우 규정 준수를 사전에 확인하고 필요한 경우 규정을 준수할 수 있습니다. [자세히 알아봅니다](site-recovery-failover-to-azure-troubleshoot.md#failover-failed-with-error-id-170010).
...
1. 워크로드 장애 조치(failover)에 대한 복구 계획을 만듭니다.
    - 각 복구 계획은 최대 50대의 컴퓨터 장애 조치(failover)를 트리거할 수 있습니다.
