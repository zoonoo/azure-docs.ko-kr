...
2. 원하는 설치 유형을 묻는 경우 파티션으로 **사용자 지정 레이아웃 만들기**를 선택합니다. **다음**을 누릅니다. **무료**를 선택하고 **만들기**를 클릭합니다. **FS 유형:** **ext4**를 사용하여 **/**,  **/var/crash** 및 **/home partitions**를 만듭니다. **FS 형식: 스왑**으로 스왑 파티션을 만듭니다.
