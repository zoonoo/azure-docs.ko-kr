...
6. *리소스 관리자* Azure 네트워크를 선택하면 서버 배포를 위해 다음 입력을 제공해야 합니다.
...
1.	RHEL 6-64 통합 에이전트 바이너리를 VM에 복사합니다. 이 명령을 실행하여 바이너리 **tar-zxvf <파일 이름>**을 untar합니다.
...
1.	복제된 항목 페이지에서 **계획되지 않은 장애 조치**의 마우스 오른쪽 클릭을 포함해 가상 컴퓨터를 선택합니다.
