...
관리 서버의 C:\Program Files (x86)\InMage Systems\private\connection에서 암호를 복사하고 관리 서버에 "passphrase.txt"로 저장합니다. 그런 후에 다음 명령을 실행합니다. 예제에서는 관리 서버 IP 주소가 104.40.75.37이며 HTTPS 포트는 443이어야 합니다.
