...
3.	**시작하기 전**에서 **구성 서버 및 프로세스 서버 설치**를 선택합니다.
...
1. **보호된 항목** > **보호 그룹** > **컴퓨터** > 컴퓨터 추가를 클릭합니다(모범 사례).
