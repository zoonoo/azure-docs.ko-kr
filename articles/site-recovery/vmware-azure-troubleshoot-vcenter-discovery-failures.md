...
9\.20 이전 버전에서는 VM의 속성 `snapshot.maxSnapShots` 속성에 대해 숫자가 아닌 값을 검색할 때 vCenter의 연결이 끊깁니다.
...
[VMware VM 재해 복구를 위한 구성 서버 관리](https://docs.microsoft.com/azure/site-recovery/vmware-azure-manage-configuration-server#refresh-configuration-server) 
