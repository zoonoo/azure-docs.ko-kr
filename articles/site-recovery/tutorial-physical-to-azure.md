...
- [시나리오 아키텍처 및 구성 요소](concepts-physical-to-azure-architecture.md)를 이해해야 합니다.
...
5. 자격 증명 모음 등록 키를 다운로드합니다. 통합 설치를 실행할 때 이 키가 필요합니다. 이 키는 생성된 날로부터 5일간 유효합니다.
   ...
   ![원본 설정](./media/tutorial-physical-to-azure/source-environment.png)
...
3. Site Recovery가 호환되는 Azure 저장소 계정 및 네트워크가 하나 이상 있는지 확인합니다.
   ...
   ![대상](./media/tutorial-physical-to-azure/network-storage.png)
