---
title: Azure Site Recovery에서 프로세스 서버 VMware/물리적 장애 조치(failback) 설정
...
6. **확인** 단추를 클릭하여 프로세스 서버 VM을 배포하기 시작합니다. 프로세스 서버가 Standard_A8_v2 SKU에 배포됩니다. 이 VM SKU를 구독에 사용할 수 있는지 확인합니다.
