---
title: Azure 사이트 복구에서 프로세스 서버 VMware/물리적 장애 복구 설정
...
1. 사이트 복구 **인프라**> **관리** > 구성 서버를 > 볼트에서 구성 서버를**선택합니다.**
...
6. **확인** 단추를 클릭하여 프로세스 서버 VM을 배포하기 시작합니다. 프로세스 서버는 Standard_A8_v2 SKU에 배포됩니다. 이 VM SKU가 구독에 사용할 수 있는지 확인합니다.
