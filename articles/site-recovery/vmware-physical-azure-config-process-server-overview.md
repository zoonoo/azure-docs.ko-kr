...
**설정** | **세부 정보** | **연결**
--- | --- | ---
**배포웹사이트를**  | 온-프레미스 VMware Vm 및 물리적 서버에 대 한 재해 복구 및 복제의 경우 온-프레미스 프로세스 서버가 필요 합니다. 기본적으로 프로세스 서버는 배포할 때 구성 서버에 설치 됩니다. | [자세히 알아봅니다](vmware-azure-architecture.md?#architectural-components).
