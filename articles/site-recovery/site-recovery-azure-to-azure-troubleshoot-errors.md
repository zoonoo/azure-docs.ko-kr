...
3.  Symantec 루트 CA 인증서가 있는지 여부를 확인하려면 다음 명령을 실행합니다.

      ``# ls VeriSign_Class_3_Public_Primary_Certification_Authority_G5.pem``

4.  파일을 찾을 수 없으면 다음 명령을 실행합니다.

      ``# wget https://www.symantec.com/content/dam/symantec/docs/other-resources/verisign-class-3-public-primary-certification-authority-g5-en.pem -O VeriSign_Class_3_Public_Primary_Certification_Authority_G5.pem``

      ``# c_rehash``

5.  b204d74a.0이 VeriSign_Class_3_Public_Primary_Certification_Authority_G5.pem이 되는 Symlink를 만들려면 다음 명령을 실행합니다.

      ``# ln -s  VeriSign_Class_3_Public_Primary_Certification_Authority_G5.pem b204d74a.0``

6.  이 명령에 다음과 같은 출력이 있는지 확인합니다. 없으면 symlink를 만들어야 합니다.
...
7. symlink 653b494a.0이 없으면 다음 명령을 사용하여 symlink를 만듭니다.
...
### <a name="fix-the-problem"></a>문제 해결
[필요한 URL](site-recovery-azure-to-azure-networking-guidance.md#outbound-connectivity-for-azure-site-recovery-urls) 또는 [필요한 IP 범위](site-recovery-azure-to-azure-networking-guidance.md#outbound-connectivity-for-azure-site-recovery-ip-ranges)가 허용 목록에 있도록 하려면 [네트워킹 지침 문서](site-recovery-azure-to-azure-networking-guidance.md)의 단계에 따릅니다.
...
[복제를 사용하도록 설정: 2단계](./site-recovery-azure-to-azure.md#step-2-select-virtual-machines)에서 선택할 Azure VM을 표시할 수 없습니다. 이 문제는 Azure VM에 부실 Site Recovery 구성이 남겨졌기 때문일 수 있습니다. 다음과 같은 경우 Azure VM에 부실 구성이 남겨질 수 있습니다.
...
[부실 ASR 구성 스크립트를 제거](https://gallery.technet.microsoft.com/Azure-Recovery-ASR-script-3a93f412)하고 Azure VM의 부실 Site Recovery 구성을 제거할 수 있습니다. 부실 구성을 제거한 후 [복제를 사용하도록 설정: 2단계](./site-recovery-azure-to-azure.md#step-2-select-virtual-machines)에 VM이 표시되어야 합니다.
