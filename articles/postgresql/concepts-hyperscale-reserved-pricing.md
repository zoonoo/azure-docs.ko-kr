...
> [!IMPORTANT]
> 이 문서는 Azure Database for PostgreSQL – Hyperscale (Citus)에 대 한 예약 된 용량에 대 한 것입니다. Azure Database for PostgreSQL – 단일 서버에 대 한 예약 된 용량에 대 한 자세한 내용은 [선불 for Azure Database for PostgreSQL – reserved capacity이 포함 된 단일 서버 계산 리소스](./concept-reserved-pricing.md)를 참조 하세요.
...
[Azure Portal](https://portal.azure.com/)에서 Citus (hyperscale) 예약 용량을 구입할 수 있습니다. 예약 요금은 [사전 결제 또는 월별 결제](../cost-management-billing/reservations/prepare-buy-reservation.md)로 처리할 수 있습니다. 예약 된 용량을 구입 하려면:
...
- [기업계약 등록에 대 한 Azure 예약 사용량 이해](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
- [종 량 제 구독에 대 한 Azure 예약 사용량 이해](../cost-management-billing/reservations/understand-reserved-instance-usage.md)
...
예약을 취소, 교환 또는 환불할 수 있지만 몇 가지 제한 사항은 있습니다. 자세한 내용은 [셀프 서비스 교환 및 Azure 예약에 대 한 환불](../cost-management-billing/reservations/exchange-and-refund-azure-reservations.md)를 참조 하세요.
...
* [종 량 제 구독에 대 한 예약 사용 이해](../cost-management-billing/reservations/understand-reservation-charges-postgresql.md)
* [기업계약 등록에 대 한 예약 사용 이해](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md)
