...
예를 들어, 16 개의 vCore 코디네이터와 3 개의 vCore 작업자 노드를 사용 하 여 하나의 Hyperscale (Citus) 서버 그룹을 실행 하는 경우를 가정해 보겠습니다. 또한 32 vCore 코디네이터와 2 개의 vCore 작업자 노드를 사용 하 여 다음 달에 추가 Citus (Hyperscale) 서버 그룹을 배포할 계획인 경우를 가정해 보겠습니다. 또한 1 년 이상에 대해 이러한 리소스가 필요 하다 고 가정해 보겠습니다.
