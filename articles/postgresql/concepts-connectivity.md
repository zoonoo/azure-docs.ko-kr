---
title: 일시적 연결 오류 처리 - Azure Database for PostgreSQL - 단일 서버
description: Azure Database for PostgreSQL - 단일 서버의 일시적 연결 오류를 처리하는 방법을 알아봅니다.
...
이 문서에서는 Azure Database for PostgreSQL에 대한 일시적 연결 오류를 처리하는 방법을 설명합니다.
