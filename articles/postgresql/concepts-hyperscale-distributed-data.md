---
title: 분산 데이터 – Hyperscale (Citus)-Azure Database for PostgreSQL
...
분할 102027이 해당 행과 연관된다고 가정합니다. 작업자 중 한 `github_events_102027` 라는 테이블에서 행을 읽거나 씁니다. 어느 작업자일까요? 이는 메타 데이터 테이블에 의해 완전히 결정 됩니다. 분할 된 작업자에 대 한 분할을 분할 된 배치 라고 합니다.
