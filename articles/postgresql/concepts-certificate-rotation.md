...
PostgreSQL sslmode를 이해 하려면 PostgreSQL 설명서의 [SSL 모드 설명을](https://www.postgresql.org/docs/11/libpq-ssl.html#ssl-mode-descriptions) 참조 하십시오.
