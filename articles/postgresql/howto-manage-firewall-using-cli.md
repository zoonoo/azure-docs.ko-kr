...
다음 예제에서는 0.0.0.0을 `--start-ip-address` 범위로, 255.255.255.255를 `--end-ip-address` 범위로 지정하여 모든 IP 주소 범위에서 **mydemoserver.postgres.database.azure.com** 서버에 액세스하도록 허용합니다.
```azurecli-interactive
