---
title: Azure Database for PostgreSQL-Hyperscale (Citus)에 대 한 Azure 보안 기준
description: Citus (Azure Database for PostgreSQL-Hyperscale) 보안 기준은 Azure 보안 벤치 마크에 지정 된 보안 권장 사항을 구현 하기 위한 절차 지침과 리소스를 제공 합니다.
author: msmbaldwin
