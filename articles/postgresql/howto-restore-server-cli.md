---
title: Azure Database for PostgreSQL 단일 서버에서 서버를 백업 및 복원 하는 방법
description: Azure CLI를 사용 하 여 Azure Database for PostgreSQL 단일 서버에서 서버를 백업 및 복원 하는 방법에 대해 알아봅니다.
author: rachel-msft
ms.author: raagyema
