...
|IOPS|IOPS|개수|[IOPS 정의](../virtual-machines/linux/premium-storage-performance.md#iops) 및 [처리량 크기 조정](concepts-hyperscale-configuration-options.md) 을 참조 하세요.|
