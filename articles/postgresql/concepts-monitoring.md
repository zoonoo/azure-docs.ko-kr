---
title: "Azure Database for PostgreSQL에서 모니터링 | Microsoft Docs"
description: "이 문서에서는 CPU, 제한, 저장소 및 연결 통계를 포함하여 Azure Database for PostgreSQL을 모니터링하고 경고하는 메트릭에 대해 설명합니다."
services: postgresql
author: rachel-msft
ms.author: raagyema
manager: jhubbard
