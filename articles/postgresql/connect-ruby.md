...
# PostgreSQL용 Azure Database: Ruby를 사용하여 데이터 연결 및 쿼리
...
- 최신 버전의 [Ruby](http://rubyinstaller.org/downloads/)를 다운로드하여 설치합니다.
