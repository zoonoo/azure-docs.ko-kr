---
title: 서버 다시 시작 - Azure CLI - PostgreSQL용 Azure 데이터베이스 - 단일 서버
description: 이 문서에서는 Azure CLI를 사용하여 PostgreSQL - 단일 서버에 대한 Azure 데이터베이스를 다시 시작하는 방법에 대해 설명합니다.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="restart-azure-database-for-postgresql---single-server-using-the-azure-cli"></a>PostgreSQL에 대한 Azure 데이터베이스 다시 시작 - Azure CLI를 사용하여 단일 서버
...
[PostgreSQL에 대한 Azure 데이터베이스에서 매개 변수를 설정하는 방법에 대해](howto-configure-server-parameters-using-cli.md) 알아봅니다.