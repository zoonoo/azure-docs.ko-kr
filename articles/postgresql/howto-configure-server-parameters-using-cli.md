---
title: Azure Database for PostgreSQL에서 서버 매개 변수 구성
...
---
# <a name="customize-server-configuration-parameters-using-azure-cli"></a>Azure CLI를 사용하여 Azure Database for PostgreSQL-단일 서버에 대한 서버 구성 매개 변수 사용자 지정
...
## <a name="list-server-configuration-parameters-for-azure-database-for-postgresql-server"></a>서버 구성 매개 변수 나열
