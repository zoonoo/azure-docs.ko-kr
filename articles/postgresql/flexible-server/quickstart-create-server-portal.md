...
Azure Database for PostgreSQL 서버는 구성된 [컴퓨팅 및 스토리지 리소스](./concepts-compute-storage.md) 세트로 만들어집니다. 서버는 [Azure 리소스 그룹](https://docs.microsoft.com/azure/azure-resource-manager/management/overview) 내에 만들어집니다.
