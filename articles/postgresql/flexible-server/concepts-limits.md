...
- 구성 된 후에는 저장소 크기를 줄일 수 없습니다. 원하는 저장소 크기의 새 서버를 만들고, 수동 덤프를 수행 하 [고](../howto-migrate-using-dump-and-restore.md) , 데이터베이스를 새 서버로 복원 하 고 마이그레이션해야 합니다.
