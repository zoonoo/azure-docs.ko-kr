---
title: PostgreSQL - Azure 포털에 대한 Azure 데이터베이스 관리
description: Azure 포털에서 PostgreSQL 서버에 대한 Azure 데이터베이스를 관리하는 방법을 알아봅니다.
author: rachel-msft
ms.author: raagyema
...
---
# <a name="manage-an-azure-database-for-postgresql-server-using-the-azure-portal"></a>Azure 포털을 사용하여 PostgreSQL 서버에 대한 Azure 데이터베이스 관리
이 문서에서는 PostgreSQL 서버에 대한 Azure 데이터베이스를 관리하는 방법을 보여 줍니다. 관리 작업에는 계산 및 저장소 확장, 관리자 암호 재설정 및 서버 세부 정보 보기가 포함됩니다.

## <a name="sign-in"></a>로그인
[Azure 포털에](https://portal.azure.com)로그인합니다.

## <a name="create-a-server"></a>서버 만들기
빠른 [시작을](quickstart-create-server-database-portal.md) 방문하여 PostgreSQL 서버용 Azure 데이터베이스를 만들고 시작하는 방법을 알아봅니다.
...
- [PostgreSQL용 Azure 데이터베이스에서 튜닝 및 모니터링 옵션에 대해](concepts-monitoring.md) 알아보기
