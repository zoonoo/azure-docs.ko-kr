...
1. 서버에서 **개요**  >  **복원** 을 선택 합니다.
   ...
   :::image type="content" source="media/concepts-data-access-and-security-data-encryption/postgresql-replica.png" alt-text="액세스 정책을 사용 하는 Key Vault의 스크린샷 강조 표시 된 액세스 정책 추가":::
