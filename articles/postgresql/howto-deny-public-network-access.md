...
1. **공용 네트워크 액세스 거부**에서 **예** 를 선택 하 여 PostgreSQL 단일 서버에 대 한 공용 액세스 거부를 사용 하도록 설정 합니다.
    ...
    ![Azure Database for PostgreSQL 단일 서버 네트워크 액세스 거부](./media/howto-deny-public-network-access/deny-public-network-access.PNG)

1. **저장**을 클릭하여 변경 내용을 저장합니다.

1. 연결 보안 설정이 성공적으로 설정 되었는지 확인 하는 알림이 나타납니다.

    ![Azure Database for PostgreSQL 단일 서버 네트워크 액세스 거부 성공](./media/howto-deny-public-network-access/deny-public-network-access-success.png)
