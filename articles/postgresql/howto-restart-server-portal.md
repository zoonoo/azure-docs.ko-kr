---
title: 서버 다시 시작 - Azure 포털 - PostgreSQL용 Azure 데이터베이스 - 단일 서버
description: 이 문서에서는 Azure 포털을 사용하여 PostgreSQL - 단일 서버에 대한 Azure 데이터베이스를 다시 시작하는 방법에 대해 설명합니다.
author: ajlam
ms.author: andrela
...
ms.locfileid: "74770087"
---
# <a name="restart-azure-database-for-postgresql---single-server-using-the-azure-portal"></a>PostgreSQL에 대한 Azure 데이터베이스 다시 시작 - Azure 포털을 사용하여 단일 서버
...
1. Azure [포털에서](https://portal.azure.com/)PostgreSQL 서버에 대한 Azure 데이터베이스를 선택합니다.
...
[PostgreSQL에 대한 Azure 데이터베이스에서 매개 변수를 설정하는 방법에 대해](howto-configure-server-parameters-using-portal.md) 알아봅니다.