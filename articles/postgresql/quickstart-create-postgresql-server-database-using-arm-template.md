---
title: ARM 템플릿을 사용하여 Azure DB for PostgreSQL 만들기
description: 이 문서에서는 Azure Resource Manager 템플릿을 사용하여 Azure Database for PostgreSQL 서버를 만드는 방법을 알아봅니다.
author: mgblythe
