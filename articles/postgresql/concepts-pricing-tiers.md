...
컴퓨팅 리소스는 기본 하드웨어의 논리적 CPU를 나타내는 vCore 수로 제공됩니다. 중국 동부 1, 중국 북부 1, 미국 국방부 중부 및 미국 국방부 동부 Intel E5-2673 v3을 기반으로 하는 범용 4 세대 논리 Cpu를 활용 (Haswell) 2.4ghz 프로세서. Intel E5-2673 v4를 기반으로 하는 Gen 5 논리 Cpu를 활용 하는 다른 모든 하위 지역 (Broadwell) 2.3ghz 프로세서.
