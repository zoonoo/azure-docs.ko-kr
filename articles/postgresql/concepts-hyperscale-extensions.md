...
> | [pg \_ cron](https://github.com/citusdata/pg_cron) | PostgreSQL에 대 한 작업 스케줄러입니다. |
> | [pg \_ freespacemap](https://www.postgresql.org/docs/current/pgfreespacemap.html) | 사용 가능한 공간 맵 (FSM)을 검사 합니다. |
...
> | [pg \_ 표시 유형](https://www.postgresql.org/docs/current/pgvisibility.html) | 표시 유형 맵 (VM) 및 페이지 수준 표시 유형 정보를 검사 합니다. |
...
> | postgis \_ sfcgal | PostGIS SFCGAL 함수입니다. |
> | postgis \_ tiger \_ geocoder | PostGIS tiger geocoder 및 reverse geocoder입니다. |
> | 사후 gis \_ 토폴로지 | PostGIS는 토폴로지 공간 유형 및 함수입니다. |
