...
> | session\_analytics | 함수 쿼리 hstore 배열입니다. |
...
> | shard\_rebalancer | 노드 추가 또는 제거 하는 경우 서버 그룹의 데이터를 안전 하게 리밸런스 합니다. |
