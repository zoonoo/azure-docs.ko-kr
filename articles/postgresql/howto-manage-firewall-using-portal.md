...
- 마찬가지로 [Azure CLI를 사용 하 여 Azure Database for PostgreSQL 방화벽 규칙을 만들고 관리](howto-manage-firewall-using-cli.md)하는 스크립트를 사용할 수 있습니다.
