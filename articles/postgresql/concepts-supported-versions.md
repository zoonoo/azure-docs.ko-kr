...
## <a name="postgresql-version-956"></a>PostgreSQL 버전 9.5.6
PostgreSQL 9.5.6의 향상된 기능 및 수정 내용에 대한 자세한 내용은 [PostgreSQL 설명서](https://www.postgresql.org/docs/9.6/static/release-9-5-6.html)를 참조하세요.
