---
title: Azure Database for PostgreSQL-단일 서버 (미리 보기) 포털 설치 방법에 대 한 개인 링크
...
1. Azure Portal 화면 왼쪽 상단에서 **리소스 만들기** > **데이터베이스** > **Azure Database for PostgreSQL**를 선택 합니다.
...
2. **유효성 검사 통과** 메시지가 표시되면 **만들기**를 선택합니다. 
    ...
    ![개인 링크를 만듦](media/concepts-data-access-and-security-private-link/show-postgres-private-link.png)
