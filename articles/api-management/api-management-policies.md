...
-   [고급 정책](api-management-advanced-policies.md#AdvancedPolicies)  
    ...
    -   [추적](api-management-advanced-policies.md#Trace) - [API 검사기](https://azure.microsoft.com/en-us/documentation/articles/api-management-howto-api-inspector/) 출력에 문자열을 추가합니다.  
