...
정책 명령문 및 설정의 전체 목록은 [정책 참조][Policy Reference] 를 참조하세요.
...
정책을 글로벌로 구성하거나 [제품][Product], [API][API] 또는 [작업][Operation] 범위로 구성할 수 있습니다. 정책을 구성하려면 게시자 포털의 정책 편집기로 이동합니다.
...
정책 명령문 및 설정의 전체 목록은 [정책 참조][Policy Reference]에서 확인할 수 있습니다.
