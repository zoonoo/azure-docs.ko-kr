...
| vary-by-developer              | [구독 키](https://docs.microsoft.com/azure/api-management/api-management-subscriptions#what-is-subscriptions)별 캐시 응답을 위해서는 `true`로 설정합니다.                                                                                                                                                                                                                                                                                                         | yes      |                   |
| vary-by-developer-groups       | [사용자 그룹](https://docs.microsoft.com/azure/api-management/api-management-howto-create-groups)별 캐시 응답을 위해서는 `true`로 설정합니다.                                                                                                                                                                                                                                                                                                             | yes      |                   |  
