...
![Azure API Management에서 Redis 용 외부 Azure 캐시를 추가 하는 방법을 보여 주는 스크린샷](media/api-management-howto-cache-external/add-external-cache.png)
