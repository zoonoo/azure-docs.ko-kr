...
2. **새 API 추가** 목록에서 **함수 앱** 을 선택합니다.
    ...
    ![함수 앱 타일을 보여주는 스크린샷.](./media/import-function-app-as-api/add-01.png)

3. **찾아보기** 를 클릭하여 가져올 Functions를 선택합니다.

    ![찾아보기 단추를 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-02.png)

4. 사용 가능한 함수 앱 목록에서 선택하려면 **함수 앱** 섹션을 클릭합니다.

    ![함수 앱 섹션을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-03.png)

5. Functions를 가져오려는 함수 앱을 찾아서 클릭하고, **선택** 을 누릅니다.

    ![함수를 가져오려는 함수 앱과 선택 단추를 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-04.png)

6. 가져오려는 Functions를 선택하고, **선택** 을 클릭합니다.

    ![가져올 함수와 선택 단추를 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-05.png)
...
2. Azure 함수 앱을 가져올 API를 선택합니다. **...** 를 클릭하고, 상황에 맞는 메뉴에서 **가져오기** 를 선택합니다.
    ...
    ![가져오기 메뉴 옵션을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/append-01.png)

3. **함수 앱** 타일을 클릭합니다.

    ![함수 앱 타일을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/append-02.png)

4. 팝업 창에서 **찾아보기** 를 클릭합니다.

    ![찾아보기 단추를 보여주는 스크린샷.](./media/import-function-app-as-api/append-03.png)

5. 사용 가능한 함수 앱 목록에서 선택하려면 **함수 앱** 섹션을 클릭합니다.

    ![함수 앱 목록을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-03.png)

6. Functions를 가져오려는 함수 앱을 찾아서 클릭하고, **선택** 을 누릅니다.

    ![함수를 가져오려는 함수 앱을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-04.png)

7. 가져오려는 Functions를 선택하고, **선택** 을 클릭합니다.

    ![가져오려는 함수를 강조 표시하는 스크린샷.](./media/import-function-app-as-api/add-05.png)
...
2. 개요에서 **함수 앱 설정** 을 선택합니다.
    ...
    ![함수 앱 설정 옵션을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/keys-02-a.png)

3. 키는 **호스트 키** 섹션에 있습니다.

    ![호스트 키 섹션을 강조 표시하는 스크린샷.](./media/import-function-app-as-api/keys-02-b.png)
