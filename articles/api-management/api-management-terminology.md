...
* **프런트 엔드 API** / **Apim api** -apim Api는 api를 호스팅하지 않으며, 백 엔드 api를 건드리지 않고도 요구 사항에 따라 외관을 사용자 지정 하기 위해 api에 대 한 외관를 만듭니다. 자세한 내용은 [API 가져오기 및 게시](import-and-publish.md)를 참조하세요.
