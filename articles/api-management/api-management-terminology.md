...
* **프런트 엔드 APIM**/**API** - APIM API는 API를 호스팅하지 않으며 백 엔드 API를 건드리지 않고 필요에 따라 외관을 사용자 정의하기 위해 API에 대한 외관을 만듭니다. 자세한 내용은 [API 가져오기 및 게시](import-and-publish.md)를 참조하세요.
