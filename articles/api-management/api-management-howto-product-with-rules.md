<properties
	pageTitle="Azure API 관리를 사용하여 속도 제한으로 API 보호"
...
속도 제한 및 할당량을 설정하는 데모 및 자세한 내용은 다음 비디오를 참조하세요.
...
API 관리에서 제품은 **개방형** 또는 **보호된** 제품일 수 있습니다. 보호된 제품은 사용하기 전에 구독해야 하는 반면, 개방형 제품은 구독하지 않고 사용할 수 있습니다. **구독 필요**를 선택하여 구독이 필요한 보호된 제품을 만들도록 합니다. 기본 설정입니다.
...
개발자 계정으로 제품을 여러 번 구독할 수 있도록 하려면 **여러 동시 구독 허용** 확인란을 선택합니다. 이 항목은 여러 동시 구독을 활용하지 않으므로 해당 항목을 선택하지 마세요.
...
왼쪽의 **API 관리** 메뉴에서 **사용자**를 클릭하고 개발자 계정의 이름을 클릭합니다. 이 예제에서는 **Clayton Gragg** 개발자 계정을 사용합니다.
...
## <a name="test-rate-limit"> </a>작업 호출 및 속도 제한 테스트
