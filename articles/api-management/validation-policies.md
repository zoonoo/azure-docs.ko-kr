...
> [!IMPORTANT]
> 이전 버전의 관리 API를 사용 하 여 API를 가져온 경우 `2021-01-01-preview` `validate-parameters` 정책이 작동 하지 않을 수 있습니다. Management API 버전 이상을 사용 하 여 API를 다시 [가져와야](/rest/api/apimanagement/2021-01-01-preview/apis/createorupdate) 할 수 있습니다 `2021-01-01-preview` .
