...
API 관리에서 제품은 **개방형** 또는 **보호된** 제품일 수 있습니다. 보호된 제품은 사용하기 전에 구독해야 하는 반면, 개방형 제품은 구독하지 않고 사용할 수 있습니다. **구독 필요**를 선택하여 구독이 필요한 보호된 제품을 만듭니다. 기본 설정입니다.

관리자가 이 제품에 대한 구독을 검토하고 허용하거나 거부하도록 하려면 **구독 승인 필요**를 선택합니다. 상자의 선택을 취소하면 구독 시도가 자동으로 승인됩니다. 구독에 대한 자세한 내용은 [제품 구독자 보기][]를 참조하세요.
...
>자세한 내용은 [Azure API 관리에서 개발자 계정을 관리하는 그룹을 만들고 사용하는 방법][]을 참조하세요.
...
원하는 API가 추가되고 제품이 게시되면 개발자는 제품을 구독하고 API를 호출할 수 있습니다. 이러한 항목 및 고급 제품 구성을 설명하는 자습서에 대해서는 [Azure API 관리에서 고급 제품 설정을 만들고 구성하는 방법][]을 참조하세요.
