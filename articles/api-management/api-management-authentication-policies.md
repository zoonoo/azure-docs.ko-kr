...
##  <a name="a-nameauthenticationpoliciesa-authentication-policies"></a><a name="AuthenticationPolicies"></a> 인증 정책  
...
##  <a name="a-namebasica-authenticate-with-basic"></a><a name="Basic"></a> 기본 사용 인증  
...
##  <a name="a-nameclientcertificatea-authenticate-with-client-certificate"></a><a name="ClientCertificate"></a> 클라이언트 인증서 사용 인증  
