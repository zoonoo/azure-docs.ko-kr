...
|자산|type|설명|  
|--------------|----------|-----------------|  
|Id|string|애플리케이션의 고유 식별자입니다.|  
|제목|string|애플리케이션의 제목입니다.|  
|설명|string|애플리케이션의 설명입니다.|  
|Url|URI|애플리케이션에 대한 URI입니다.|  
|버전|string|애플리케이션에 대한 버전 정보입니다.|  
|요구 사항|string|애플리케이션에 대한 요구 사항의 설명입니다.|  
|시스템 상태|number|애플리케이션의 현재 상태입니다.<br /><br /> - 0 - 등록됨<br /><br /> - 1 - 제출됨<br /><br /> - 2 - 게시됨<br /><br /> - 3 - 거부됨<br /><br /> - 4 - 게시 취소됨|  
...
|첨부 파일|[첨부 파일](#Attachment) 엔터티의 컬렉션입니다.|스크린샷 또는 아이콘과 같은 애플리케이션에 대한 첨부 파일입니다.|  
|아이콘|[첨부 파일](#Attachment)|애플리케이션에 대한 아이콘입니다.|  
