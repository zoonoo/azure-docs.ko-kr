...
|OAuth2Flow_AuthorizationCodeGrant_Step_AuthorizationRequest_RequestDescription|<p\> OAuth 프로세스를 시작하려면 클라이언트 앱에서 사용자를 권한 부여 끝점으로 보내야 합니다.          권한 부여 엔드포인트에서 사용자는 인증한 후 앱에 대한 액세스 권한을 부여하거나 거부합니다.     </p\>|  
...
|OAuth2Flow_ImplicitGrant_Step_AuthorizationRequest_RequestDescription|<p\> OAuth 프로세스를 시작하려면 클라이언트 앱에서 사용자를 권한 부여 끝점으로 보내야 합니다.      권한 부여 엔드포인트에서 사용자는 인증한 후 앱에 대한 액세스 권한을 부여하거나 거부합니다. </p\>|  
