...
> [!NOTE]
> Azure Active Directory 기본 디렉토리에 사용자의 계정이 표시되지않는 경우, 계정에 필요한 사용 권한을 부여하려면 Azure 구독의 관리자에게 문의하세요. 기본 디렉터리 찾기에 대한 내용은 [기본 디렉토리 찾기](../virtual-machines/resource-group-create-work-id-from-persona.md#locate-your-default-directory-in-the-azure-portal)를 참조하세요.
> 
> 
