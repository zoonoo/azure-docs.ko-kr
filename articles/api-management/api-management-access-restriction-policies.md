...
> [!TIP]
> 다른 용도로 다른 범위에서 액세스 제한 정책을 사용할 수 있습니다. 예를 들어 api 수준에서 `validate-jwt` 정책을 적용 하 여 AAD 인증으로 전체 API를 보호 하거나 api 작업 수준에서 정책을 적용 하 고 보다 세부적인 제어를 위해를 사용할 `claims` 수 있습니다.
