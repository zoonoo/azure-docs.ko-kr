...
| 데이터 평면 로깅 및 감사| 예 | [진단 로그](../azure-monitor/platform/resource-logs-overview.md) 및 (선택 사항) [정보](../azure-monitor/app/app-insights-overview.md)를 Azure Monitor Azure 애플리케이션 합니다.  | |
