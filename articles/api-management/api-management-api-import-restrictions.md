...
OpenAPI 문서를 가져오는 중 오류를 수신하면 Azure Portal에서 디자이너를 사용하거나(Design - Front End - OpenAPI Specification Editor) <a href="https://editor.swagger.io">Swagger Editor</a>와 같은 타사 도구를 사용하여 유효성을 검사해야 합니다.
...
* **재귀** - 재귀적으로 정의된(예: 자체 참조) 정의는 APIM에서 지원되지 않습니다.
