...
| [클라이언트 인증서 인증](api-management-howto-mutual-certificates-for-clients.md) | 아니요<sup>3</sup>                | 예.            | 예            | 예            | 예.            |
...
| Azure Monitor 로그 및 메트릭                                                               | 아니요<sup>4</sup>                | 예.            | 예            | 예            | 예.            |
...
<sup>3</sup> 클라이언트 인증서 인증의 일반 공급 전에 소비 계층에 추가 됩니다.<br/>
<sup>4</sup> 전체 Azure Monitor 지원 사용 계층에 추가 됩니다.
