...
|  StorageAccountTypeNotSupported  |  저장소 계정 {0}은(는) {1} 형식입니다. 부팅 진단은 저장소 계정 유형 {2}을(를) 지원합니다.  <ul><li>부팅 진단에 프리미엄 저장소 계정을 사용하는 경우 이 오류가 발생합니다. 자세한 내용은 [부팅 진단 사용 방법](../articles/virtual-machines/windows/boot-diagnostics.md)을 참조하세요. </li></ul> |
