...
2. 포털의 왼쪽 탐색 창에서 **+ 리소스 만들기**, **엔터프라이즈 통합** 및 **릴레이**를 차례로 클릭합니다.
...
2. 릴레이 네임스페이스 창에서 **공유 액세스 정책**을 클릭합니다.
3. **공유 액세스 정책** 창에서 **RootManageSharedAccessKey**를 클릭합니다.
   
    ![connection-info][connection-info]
4. **정책: RootManageSharedAccessKey** 화면에서 **연결 문자열–기본 키** 옆의 **복사** 단추를 클릭하여 나중에 사용하기 위해 연결 문자열을 클립보드에 복사합니다. 메모장이나 기타 다른 위치에 임시로 이 값을 붙여 넣습니다.
