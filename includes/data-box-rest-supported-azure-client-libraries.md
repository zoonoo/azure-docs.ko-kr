...
ms.locfileid: "91744106"
---
클라이언트 라이브러리     |지원되는 버전     | 링크   |     엔드포인트 사양      |
|--------------------|--------------------------------------------|--------|---------------------------------|
|    .NET                |     11.0.0                                           |    NuGet 패키지:  <br>일반: https://www.nuget.org/packages/Microsoft.Azure.Storage.Common/11.0.0    <br> Blob: https://www.nuget.org/packages/Microsoft.Azure.Storage.Blob/11.0.0 <br>큐   https://www.nuget.org/packages/Microsoft.Azure.Storage.Queue/11.0.0 <br>GitHub 릴리스: https://github.com/Azure/azure-storage-net/releases/tag/v11.0.00                          |    app.config 파일                 |
|    Java                |    12.0.0-preview. 3                                           |   Maven 패키지: https://mvnrepository.com/artifact/com.azure/azure-storage-file/12.0.0-preview.3   <br>GitHub 릴리스: https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/storage                                                                                                                                                                              |    연결 문자열 설정         |
