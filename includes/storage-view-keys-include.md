...
ms.locfileid: "67302510"
---
보고 Azure portal에서 저장소 계정 액세스 키 또는 연결 문자열에 복사 하려면:
...
5. 또는 전체 연결 문자열을 복사할 수 있습니다. **key1** 아래에서 **연결 문자열** 값을 찾고, **복사** 단추를 클릭하여 연결 문자열을 복사합니다.
    ...
    ![Azure portal에서 액세스 키를 확인 하는 방법을 보여 주는 스크린샷](media/storage-view-keys-include/portal-connection-string.png)