...
3. **연결 추가** 페이지에서 연결에 대한 값을 구성합니다.
  ...
  - **공유 키:** 여기 값은 온-프레미스 로컬 VPN 장치에 사용하는 값과 일치해야 합니다. 예제에서는 'abc123'을 사용하지만 좀 더 복잡한 항목을 사용할 수 있습니다. 중요한 점은 여기에서 지정한 값이 VPN 디바이스를 구성할 때 지정한 값과 동일해야 한다는 것입니다.
