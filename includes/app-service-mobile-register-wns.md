...
5. [Windows 개발자 센터](https://dev.windows.com/ko-KR/overview)로 이동하여 Microsoft 계정을 사용해 로그인하고 **내 앱**에서 새 앱 등록을 클릭한 후 **서비스** > **푸시 알림**을 확장합니다.
6. **푸시 알림** 페이지의 **WNS(Windows 푸시 알림 서비스) 및 Microsoft Azure 모바일 앱**에서 **Live 서비스 사이트**를 클릭하고 **응용 프로그램 암호**의 **패키지 SID** 및 *현재* 값을 적어둡니다.
