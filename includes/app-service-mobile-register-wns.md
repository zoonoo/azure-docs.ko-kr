...
---
1. Visual Studio 솔루션 탐색기에서 Windows 스토어 앱 프로젝트를 마우스 오른쪽 단추로 클릭합니다. 그런 다음 **스토어** > **연결 앱을 스토어와**선택합니다.
...
5. [Windows 개발자 센터](https://dev.windows.com/en-us/overview)로 이동한 다음, Microsoft 계정으로 로그인합니다. **내 앱**에서 새 앱 등록을 선택합니다. 그런 다음 **서비스** > **푸시 알림을 확장합니다.**
