...
> 
> **무료 계층에 대해서는 사용자 지정 도메인 이름이 지원되지 않습니다**. [더 높은 가격 책정 계층으로 강화](../articles/app-service/manage-scale-up.md)해야 합니다 .이 경우 구독에 대해 청구되는 요금이 바뀔 수 있습니다. 
