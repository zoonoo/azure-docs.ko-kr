...
>
>공용 IP 주소가 가상 머신에 할당되거나 아웃바운드 규칙이 있거나 없는 표준 Load Balancer의 백엔드 풀에 가상 머신이 배치되면 기본 아웃바운드 IP가 비활성화됩니다. [Azure Virtual Network NAT](../articles/virtual-network/nat-overview.md) 게이트웨이 리소스가 가상 머신의 서브넷에 할당되면 기본 아웃바운드 액세스 IP가 비활성화됩니다.
>
