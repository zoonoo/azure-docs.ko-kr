...
Azure 저장소에 대한 계정 키를 보거나 복사하는 단계는 [저장소 액세스 키 보기, 복사 및 다시 생성](../articles/storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys) 문서를 참조하세요.
