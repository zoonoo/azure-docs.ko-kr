...
**Azure Storage 연결된 서비스**에서 **계정 키**를 사용하여 Azure 저장소 계정을 Azure Data Factory에 연결할 수 있습니다. 이렇게 하면 데이터 팩터리에 Azure 저장소에 대한 전역 액세스를 제공합니다. 다음 테이블은 Azure 저장소 연결된 서비스에 특정된 JSON 요소에 대한 설명을 제공합니다.
