...
소비자 그룹은 응용 프로그램에서 Azure IoT Hub의 데이터를 끌어오는 데 사용됩니다. 이 단원에서는 예정된 Azure 서비스가 IoT Hub에서 데이터를 읽는 데 사용할 소비자 그룹을 만듭니다.
...
1. 왼쪽 창에서 **끝점**을 클릭하고, 가운데 창에서 **이벤트**를 선택하고, 오른쪽 창의 **소비자 그룹** 아래에서 이름을 입력한 다음, **저장**을 클릭합니다.
   ...
   ![Azure IoT Hub에서 소비자 그룹 만들기](../articles/iot-hub/media/iot-hub-create-consumer-group/1_iot-hub-create-consumer-group-azure.png)