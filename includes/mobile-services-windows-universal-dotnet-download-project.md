...
이 자습서는 Visual Studio 2013의 범용 Windows 앱 프로젝트인 [GetStartedWithMobileServices 앱][GetStartedWithMobileServices 앱]을 기반으로 합니다. 이 앱의 UI는 추가된 항목이 로컬 메모리에 저장된다는 점을 제외하고 모바일 서비스 빠른 시작에서 생성된 앱과 동일합니다.
