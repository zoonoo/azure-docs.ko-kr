* [지리적으로 분산된 앱 공간 설정](../articles/app-service-web/app-service-app-service-environment-geo-distributed-scale.md)
* [계층화된 보안 아키텍처 구현](../articles/app-service-web/app-service-app-service-environment-layered-security.md)
* [앱 서비스 환경을 사용하여 웹 응용 프로그램 방화벽 구성](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
* [Resource Manager 템플릿을 사용하여 ILB 사용 앱 서비스 환경 만들기](../articles/app-service-web/app-service-app-service-environment-create-ilb-ase-resourcemanager.md)
* [앱 서비스 환경에서 자동 크기 조정 사용](../articles/app-service/app-service-environment-auto-scale.md)
