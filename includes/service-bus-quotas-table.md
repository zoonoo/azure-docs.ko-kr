...
|큐/토픽 크기|엔터티|큐/토픽을 만들 때 정의됨|들어오는 메시지가 거부되며 호출 코드에서 예외를 수신합니다.|1, 2, 3, 4 또는 5GB입니다.<br /><br />[분할](https://msdn.microsoft.com/library/dn520246.aspx)이 활성화된 경우 최대 큐/항목 크기는 80GB입니다.|
