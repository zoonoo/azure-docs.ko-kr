...
|키 유형|HSM key<br>CREATE key|HSM key<br>모든 다른 트랜잭션|소프트웨어 키<br>CREATE key|소프트웨어 키<br>모든 다른 트랜잭션|
|:---|---:|---:|---:|---:|
...
| 트랜잭션 유형 | Maximum transactions allowed in 10 seconds, per vault per region<sup>1</sup> |
| --- | --- |
| 모든 트랜잭션 |2,000 |
