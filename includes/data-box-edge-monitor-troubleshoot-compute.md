...
ms.locfileid: "82562324"
---
계산 역할이 구성 된 Azure Stack Edge 장치에서 docker 명령의 하위 집합을 사용 하 여 모듈을 모니터링 하거나 문제를 해결할 수 있습니다. 사용 가능한 명령 목록을 보려면 [PowerShell 인터페이스에 연결](#connect-to-the-powershell-interface) 하 고 `dkrdbe` 함수를 사용 합니다.
...
[10.100.10.10]: PS>
```
다음 표에는에서 사용할 수 있는 명령에 대 한 간략 `dkrdbe`한 설명이 나와 있습니다.
