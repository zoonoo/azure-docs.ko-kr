다음으로, 클러스터의 서버가 Windows Server 2008 R2 또는 Windows Server 20012를 실행 중인 경우 핫픽스 [KB2854082](http://support.microsoft.com/kb/2854082)가 클러스터에 속한 Azure VM 또는 온-프레미스 서버 각각에 설치되어 있는지 확인해야 합니다. 클러스터에 있지만 가용성 그룹에 없는 서버 또는 VM에도 이 핫픽스를 설치해야 합니다.
