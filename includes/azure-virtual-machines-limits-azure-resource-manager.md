...
<sup>1</sup> 기본 한도는 평가판 및 종량제와 같은 제안 범주 유형과 Dv2, F, G와 같은 시리즈에 따라 다릅니다. 예를 들어 기업계약 구독의 기본값은 350입니다. 보안을 위해 구독은 대규모 코어 배포를 방지하기 위해 기본적으로 20개 코어로 설정됩니다. 더 많은 코어가 필요한 경우 지원 티켓을 제출합니다.
