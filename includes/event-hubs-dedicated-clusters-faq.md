...
만든 후에는 최소 4 시간 사용에 대 한 클러스터가 청구 됩니다. 셀프 서비스 환경의 Preview 릴리스에서는 **기술** 할당량 요청에 따라 Event Hubs 팀에 [지원 요청](https://ms.portal.azure.com/#create/Microsoft.Support) 을 제출 하 여 클러스터를 확장 하거나 축소할 수 있도록  >    >  **전용 클러스터를 강화 하거나 확장할** 수 있습니다. 클러스터 규모를 축소 하는 요청을 완료 하는 데 최대 7 일까 지 걸릴 수 있습니다. 
