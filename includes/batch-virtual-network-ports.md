...
| 원본 | 원본 포트 | 대상 | 대상 서비스 태그 | 대상 포트 | 프로토콜 | 액션(Action) |
| --- | --- | --- | --- | --- | --- | --- |
| 모두 | * | [Service 태그](../articles/virtual-network/security-overview.md#service-tags) | `Storage` (동일한 지역의 Batch 계정 및 VNet으로) | 443 | TCP | 허용 |
