...
>[WACOM.NOTE]이 절차는 Visual Studio 도구를 사용하여 모바일 서비스를 게시하는 방법을 보여 줍니다. 원본 제어를 사용하여 .NET 백 엔드 모바일 서비스를 게시할 수도 있습니다. 자세한 내용은 [원본 제어에 프로젝트 코드 저장](/ko-kr/documentation/articles/mobile-services-dotnet-backend-store-code-source-control/)을 참조하세요.
...
2. Azure 계정 자격 증명으로 로그인하고, **기존 모바일 서비스**에서 서비스를 선택하고 **확인**을 클릭합니다.
	...
	>[WACOM.NOTE]Visual Studio는 사용자가 명시적으로 로그아웃할 때까지 Azure 자격 증명을 저장합니다.
