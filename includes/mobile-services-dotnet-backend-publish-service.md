...
>[AZURE.NOTE] 이 절차는 Visual Studio 도구를 사용하여 모바일 서비스를 게시하는 방법을 보여 줍니다. 원본 제어를 사용하여 .NET 백 엔드 모바일 서비스를 게시할 수도 있습니다. 자세한 내용은 [소스 제어에 프로젝트 코드 저장]을 참조하세요(/documentation/articles/mobile-services-dotnet-backend-store-code-source-control/).
