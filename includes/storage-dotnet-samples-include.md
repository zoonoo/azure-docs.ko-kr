...
ms.locfileid: "67182412"
---
## <a name="net-sample-code-repositories"></a>.NET 샘플 코드 리포지토리

Azure Storage .NET 클라이언트 라이브러리에 대한 모든 샘플 리포지토리 목록은 다음과 같습니다.

* [Azure Blob Storage 사진 갤러리 웹 애플리케이션](https://azure.microsoft.com/resources/samples/storage-blobs-dotnet-webapp/)
* [.NET용 Azure Blob Storage 샘플](https://azure.microsoft.com/resources/samples/storage-blob-dotnet-getting-started/)
* [증분 스냅숏을 사용하여 Azure Virtual Machine 디스크 백업](https://azure.microsoft.com/resources/samples/storage-blob-dotnet-back-up-with-incremental-snapshots/)
...
* [MyDriving - Azure IOT 및 모바일 샘플 애플리케이션](https://azure.microsoft.com/resources/samples/mydriving/)
