...
4. 화살표 아이콘![StorSimple 화살표 아이콘](./media/storsimple-complete-minimum-device-setup/HCS_ArrowIcon-include.png)을 클릭합니다.
...
1. 확인 아이콘![StorSimple 확인 아이콘](./media/storsimple-complete-minimum-device-setup/HCS_CheckIcon-include.png)을 클릭합니다. 장치 **퀵 스타트** 페이지로 돌아갑니다.
