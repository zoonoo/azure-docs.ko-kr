...
퀵 스타트 클라이언트 앱을 업데이트하여 이미지 캡처 및 업로드
------------------------------------------------------------
...
2.  MainPage.xaml 파일을 열어 첫 번째 **Task** 요소 바로 다음에 있는 **StackPanel** 요소를 다음 코드로 바꿉니다.
...
3.  **DataTemplate**의 **StackPanel** 요소를 다음 코드로 바꿉니다.
...
4.  MainPage.xaml.cs 프로젝트 파일을 열고 다음 **using** 문을 추가합니다.
...
1.  기존 `InsertTodoItem` 메서드를 다음 코드로 바꿉니다.
