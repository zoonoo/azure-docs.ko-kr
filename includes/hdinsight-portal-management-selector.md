> [AZURE.SELECTOR]
- [포털(Linux 클러스터)](../articles/hdinsight/hdinsight-administer-use-portal-linux.md)
- [포털(Windows 클러스터)](../articles/hdinsight/hdinsight-administer-use-management-portal.md)
