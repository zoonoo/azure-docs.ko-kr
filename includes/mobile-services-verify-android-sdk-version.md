...
2. Project Explorer 탭의 **Gradle 스크립트**에서 **gradle.build(modeule: app)** 파일을 엽니다. **compileSdkVersion** 및 **buildToolsVersion**이 설치된 최신 SDK 버전으로 설정되어 있는지 확인합니다. 태그는 다음과 같이 표시될 수 있습니다.
