...
ms.locfileid: "110473837"
---
다음의 모든 단계를 완료하려면 [구독에 다음 권한이 있는 역할](../articles/role-based-access-control/rbac-and-directory-admin-roles.md)이 있어야 합니다.
* Azure 리소스 만들기 및 관리
...
:::image type="content" source="../articles/digital-twins/media/how-to-set-up-instance/portal/subscriptions-role.png" alt-text="사용자를 소유자로 표시하는 Azure Portal의 구독 페이지 스크린샷" lightbox="../articles/digital-twins/media/how-to-set-up-instance/portal/subscriptions-role.png":::
