...
* 가져온 TravelAgent 앱의 LUIS [**응용 프로그램 ID**](../articles/cognitive-services/luis/luis-get-started-create-app.md)입니다. 응용 프로그램 ID는 응용 프로그램 대시보드에 표시되어 있습니다. 
