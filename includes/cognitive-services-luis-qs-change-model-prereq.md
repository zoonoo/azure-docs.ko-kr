...
* 가져온 TravelAgent 앱의 LUIS [**애플리케이션 ID**](../articles/cognitive-services/luis/luis-get-started-create-app.md)입니다. 애플리케이션 ID는 애플리케이션 대시보드에 표시됩니다. 
* 가져올 예시 발언이 포함된 **[utterances.json](https://github.com/Azure-Samples/cognitive-services-language-understanding/blob/master/documentation-samples/quickstarts/change-model/utterances.json)** 파일입니다. 
