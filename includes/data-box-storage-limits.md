...
> [!IMPORTANT]
> Azure Storage 서비스 제한을 초과하는 파일또는 디렉터리또는 Azure 파일/Blob 이름 지정 규칙을 준수하지 않는 경우 이러한 파일 또는 디렉터리가 데이터 상자 서비스를 통해 Azure Storage에 수집되지 않습니다.
