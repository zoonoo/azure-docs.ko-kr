...
>
> 이미지 버전을 저장할 수도 있습니다 [영역 중복 저장소](https://docs.microsoft.com/azure/storage/common/storage-redundancy-zrs) 추가 하 여 `--storage-account-type standard_zrs` 이미지 버전을 만들 때.
>
