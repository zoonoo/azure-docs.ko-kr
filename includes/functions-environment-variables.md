...
* [미리 컴파일된 C#](../articles/azure-functions/functions-dotnet-class-library.md#environment-variables)
* [C# 스크립트(.csx)](../articles/azure-functions/functions-reference-csharp.md#environment-variables)
* [F# 스크립트(.fsx)](../articles/azure-functions/functions-reference-fsharp.md#environment-variables)
* [Java](../articles/azure-functions/functions-reference-java.md#environment-variables)
* [자바 스크립트](../articles/azure-functions/functions-reference-node.md#environment-variables)
