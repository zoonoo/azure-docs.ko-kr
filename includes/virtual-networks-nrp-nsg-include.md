...
|**protocol**|규칙과 일치하는 프로토콜|TCP, UDP 또는 *| |**sourcePortRange**|규칙과 일치하는 원본 포트 범위|80, 100-200, *| |**destinationPortRange**|규칙과 일치하는 대상 포트 범위|80, 100-200, *| |**sourceAddressPrefix**|규칙과 일치하는 원본 주소 접두사|10\.10.10.1, 10.10.10.0/24, VirtualNetwork|
