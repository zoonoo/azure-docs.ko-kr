...
서비스 버스 토픽 및 구독을 사용하면 다수의 사용자와 응용 프로그램에 대해 다수의 메시지를 확장하고 처리할 수 있습니다.
...
새 네임스페이스에 대해 토픽 또는 구독 만들기 등의 관리 작업을 수행하려면 네임스페이스에 대한 관리 자격 증명을 받아야 합니다. Azure 포털에서 이러한 자격 증명을 가져올 수 있습니다.
