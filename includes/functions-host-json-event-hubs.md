...
<sup>1</sup> `initialOffsetOptions`에 대한 지원은 [EventHubs v4.2.0](https://github.com/Azure/azure-functions-eventhubs-extension/releases/tag/v4.2.0)부터 시작됩니다.
