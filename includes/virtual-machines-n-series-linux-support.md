...
| 유통 | 드라이버 |
| --- | -- | 
| Ubuntu 16.04 LTS, 18.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3, 7.4, 7.5, 7.6<br/><br/> CentOS 기반 7.3, 7.4, 7.5, 7.6, CentOS 기반 7.4 HPC | NVIDIA, DA 10.1, 드라이버 분기 R418 |
...
| 유통 | 드라이버 |
| --- | -- |
|Ubuntu 18.04 LTS<br/><br/>Ubuntu 16.04 LTS<br/><br/>7\.0 Red Hat Enterprise Linux 7.6<br/><br/>CentOS 기반 7.0 ~ 7.6<br/><br/>SUSE Linux Enterprise Server 12 SP2 | NVIDIA GRID 9.1, 드라이버 분기 R430|
