...
[![적절한 제한이 적용되는 방화벽 및 가상 네트워크 블레이드의 스크린샷](media/storage-files-networking-endpoints-public-disable-portal/disable-public-endpoint-0.png)](media/storage-files-networking-endpoints-public-disable-portal/disable-public-endpoint-0.png#lightbox)