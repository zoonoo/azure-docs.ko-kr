...
다음과 같이 Azure PowerShell을 사용하는 방법도 있습니다. Get-AzureVM -ServiceName "<VmCloudServiceName>" -Name "<VmName>" | Remove-AzureAvailabilitySet | Update-AzureVM

## 단일 인스턴스 구성의 경우
이러한 VM을 가용성 집합에 추가하여 계획된 유지 관리가 단일 인스턴스 구성의 VM에 영향을 미치는 시간을 선택할 수 있습니다. 단계별 과정
