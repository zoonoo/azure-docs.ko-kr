...
이 자습서에서는 Visual Studio에서 ASP.NET [Web API 2](http://www.asp.net/web-api/overview/getting-started-with-aspnet-web-api/tutorial-your-first-web-api) 및 [MVC 5](http://www.asp.net/mvc/overview/getting-started/introduction/getting-started)와 함께 작업하는 방법에 대한 기본적인 지식이 있다고 가정합니다.
...
Microsoft Azure로 작업하는 방법을 먼저 알 필요는 없지만 자습서를 완료하려면 Azure 계정이 필요합니다. 다음을 수행할 수 있습니다.
