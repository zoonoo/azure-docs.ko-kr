...
기본적으로 Visual Studio는 함수 앱을 만드는 데 필요한 모든 Azure 리소스를 만듭니다. 이러한 리소스의 이름은 선택한 함수 앱 이름을 기반으로 합니다. 만들어진 리소스를 전체적으로 제어해야 하는 경우에는 대신 [고급 옵션을 사용하여 게시](../articles/azure-functions/functions-develop-vs-code.md#enabled-publishing-with-advanced-create-options)할 수 있습니다.
