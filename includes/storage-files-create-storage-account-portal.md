...
2. 검색 상자에 **스토리지 계정**을 입력하고, **스토리지 계정 - Blob, 파일, 테이블, 큐**를 선택한 다음, **만들기**를 선택합니다.
