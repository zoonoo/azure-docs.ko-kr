...
| 기본적으로 보안 적용 | 네트워크 보안 그룹에 의해 허용 목록에 추가되지 않은 경우, 공용 IP 및 Load Balancer 엔드포인트(공용 및 내부)에 대한 인바운드는 허용되지 않습니다. | 기본적으로 열려 있는 선택적 네트워크 보안 그룹입니다. |
