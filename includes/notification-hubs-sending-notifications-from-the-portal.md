...
* ASP.NET: [Notification Hubs를 사용하여 사용자에게 알림을 푸시합니다](../articles/notification-hubs/notification-hubs-aspnet-backend-ios-apple-apns-notification.md).
...
* PHP: [PHP에서 Notification Hubs를 사용하는 방법](../articles/notification-hubs/notification-hubs-php-push-notification-tutorial.md).
