...
## <a name="enable-azure-preview-features"></a>Azure 미리 보기 기능 사용
1. <https://account.windowsazure.com/>으로 이동한 다음 Azure 계정으로 로그인합니다.
2. **미리 보기 기능**을 클릭하여 사용할 수 있는 미리 보기를 표시합니다.<br />
   ![미리 보기 기능 탭 열기][1]
3. 아래쪽으로 스크롤하여 사용하려는 기능이 표시되면 **지금 시도**를 클릭합니다.<br />
   ![미리 보기 기능 선택][2]
4. 구독을 선택하고 확인 표시를 클릭합니다.<br />
   ![구독 선택][3]
