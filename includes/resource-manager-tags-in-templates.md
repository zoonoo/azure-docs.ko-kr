...
### <a name="apply-literal-value-to-tag-name"></a>태그 이름에 리터럴 값 적용
...
### <a name="apply-object-to-tag-element"></a>태그 요소에 개체 적용
...
### <a name="apply-json-string-to-tag-name"></a>태그 이름에 JSON 문자열 적용
