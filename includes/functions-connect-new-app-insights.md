...
1. [포털][Azure portal]의 페이지 맨 위에 `Function Apps` 있는 검색 표시줄에를 입력 하 고 함수 앱을 선택한 다음 창의 맨 위에 있는 **Application Insights 구성 되지 않음** 배너를 선택 합니다. 이 배너가 표시 되지 않으면 앱이 이미 Application Insights 사용 하도록 설정 되어 있는 것입니다.
