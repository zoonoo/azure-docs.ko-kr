## <a name="setup-connection-string"> </a>저장소 연결 문자열 설정
...
5.  저장소 에뮬레이터(로컬 컴퓨터에서 시뮬레이트된 Microsoft Azure 저장소)를 대상으로 지정할지 또는 클라우드의 저장소 계정을 대상으로 지정할지 선택합니다. 이 가이드의 코드는 두 옵션 중 어떤 옵션을 사용하든 작동합니다. 앞에서 Azure에 만든 저장소 계정에 큐 데이터를 저장하려면 이 자습서의 이전 단계에서 복사한 **기본 액세스 키** 값을 입력합니다.
...
[연결 문자열 구성]: http://msdn.microsoft.com/ko-kr/library/windowsazure/ee758697.aspx<!--HONumber=42-->
