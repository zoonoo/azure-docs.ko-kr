...
ms.locfileid: "87841934"
---
클라우드 기반 애플리케이션을 인증하는 가장 간단한 방법은 관리 ID를 사용하는 것입니다. 자세한 내용은 [App Service 관리 ID를 사용하여 Azure Key Vault에 액세스](/azure/key-vault/general/managed-identity)를 참조하세요. 
