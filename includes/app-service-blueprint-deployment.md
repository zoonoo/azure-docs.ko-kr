* [Azure 앱 서비스에 앱 배포](../app-service-web/web-sites-deploy.md)
* [소스 제어 및 연속 통합 구성](../app-service-web/web-sites-publish-source-control.md)
* [배포 슬롯을 사용하여 스테이징 배포](../app-service-web/web-sites-staged-publishing.md)
