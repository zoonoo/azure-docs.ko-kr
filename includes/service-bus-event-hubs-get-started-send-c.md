...
1. [Qpid AMQP Messenger 페이지](http://qpid.apache.org/components/messenger/index.html)(영문)에서 **Installing Qpid Proton** 링크를 클릭하고 환경에 맞는 지침을 따릅니다. 여기서는 Linux 환경(예: [Azure Linux VM](../articles/virtual-machines/virtual-machines-linux-tutorial.md)과 Ubuntu 14.04 사용)을 가정합니다.
