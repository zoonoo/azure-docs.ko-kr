...
이 섹션에서는 허브의 id 레지스트리에서 장치 id 및 모듈 id를 만드는 .NET 콘솔 앱을 만듭니다. 장치 또는 모듈은 id 레지스트리에 항목이 없는 경우 허브에 연결할 수 없습니다. 자세한 내용은 [IoT Hub 개발자 가이드의 Id 레지스트리 섹션](../articles/iot-hub/iot-hub-devguide-identity-registry.md)을 참조 하세요.
