...
**Azure Cosmos DB에(서) JSON 파일을 그대로 가져오거나 내보내려면** Azure Cosmos DB 커넥터의 [JSON 문서 가져오기/내보내기](../articles/data-factory/data-factory-azure-documentdb-connector.md#importexport-json-documents) 섹션에 있는 자세한 정보를 참조하세요.
