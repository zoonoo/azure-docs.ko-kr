...
[az webapp create](/cli/azure/appservice/web#create) 명령을 사용하여 `myAppServicePlan` App Service 계획에 [API 앱](../articles/app-service-api/app-service-api-apps-why-best-platform.md)을 만듭니다. 
