...
VPN 연결을 통해 가상 컴퓨터에 연결하는 데 문제가 있는 경우 몇 가지 방법으로 확인할 수 있습니다. 자세한 문제 해결 정보는 [VM에 대한 원격 데스크톱 연결 문제 해결](../articles/virtual-machines/windows/troubleshoot-rdp-connection.md)을 참조하세요.
