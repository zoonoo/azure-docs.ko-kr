...
시뮬레이션된 장치를 연결할 IoT Hub를 만듭니다. 다음 단계는 Azure 포털을 사용하여 이 작업을 완료하는 방법을 보여줍니다.
...
3. **IoT Hub** 블레이드에서 IoT Hub의 구성을 선택합니다.
   ...
   * [가격 및 크기 조정 계층][lnk-pricing]을 선택합니다. 이 자습서에는 특정 계층이 필요하지 않습니다. 이 자습서에는 무료 F1 계층을 사용합니다.
