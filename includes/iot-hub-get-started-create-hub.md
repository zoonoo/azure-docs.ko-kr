...
1. IoT Hub가 성공적으로 만들어지면 Azure Portal에서 IoT Hub에 대한 새 타일을 클릭하여 새 IoT Hub에 대한 속성 창을 엽니다. IoT 허브를 만들었으므로 IoT 허브에 장치 및 응용 프로그램을 연결하는 데 사용하는 중요한 정보를 찾습니다. **호스트 이름**을 기록해둔 다음 **공유 액세스 정책**을 클릭합니다.
