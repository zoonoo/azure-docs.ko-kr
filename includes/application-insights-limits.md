...
| 데이터 보존 로그 | [30~730일](../articles/azure-monitor/app/pricing.md#change-the-data-retention-period)  | 이 리소스는 [로그](../articles/azure-monitor/logs/log-query-overview.md)용입니다.
| 데이터 보존 메트릭 | 90일| 이 리소스는 [메트릭 탐색기](../articles/azure-monitor/essentials/metrics-charts.md)용입니다.
