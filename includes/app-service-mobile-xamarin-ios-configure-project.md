...
4. **Build**에서 **iOS Bundle Signing**을 선택하고 방금 이 프로젝트에 대해 설정한 해당 ID 및 프로비전 프로필을 선택합니다.
   ...
   이제 프로젝트에서 코드 서명에 새 프로필을 사용하게 됩니다. 공식 Xamarin 디바이스 프로비저닝 설명서를 보려면 [Xamarin 디바이스 프로비저닝]을 참조하세요.
...
[Xamarin 디바이스 프로비저닝]: http://developer.xamarin.com/guides/ios/getting_started/installation/device_provisioning/
