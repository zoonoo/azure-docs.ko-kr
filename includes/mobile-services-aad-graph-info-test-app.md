...
1. 앱을 시작하고 디렉터리의 자세한 정보가 포함된 사용자 계정으로 인증합니다. 

    ![](./media/mobile-services-aad-graph-info-test-app/bob-login.png)

2. 사용자 지정 API가 실행되어 사용자의 디렉터리 정보를 사용자 지정 인사말로 반환합니다. 이 예제에서는 사용자의 주소를 표시하기 위해 *streetAddress*, *city*, *state* 및 *postalCode*가 필요합니다.
