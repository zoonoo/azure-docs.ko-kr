...
사용자 고유의 응용 프로그램 템플릿을 만든 경우이 템플릿을 사용 하 여 새 응용 프로그램을 만들 수 있습니다. 응용 프로그램 템플릿에 대 한 메시지가 표시 되 면 앱의 [응용 프로그램 템플릿 내보내기](../articles/iot-central/core/howto-use-app-templates.md#create-an-application-template) 섹션 아래에 있는 내보낸 앱의 URL 공유 가능 링크에 표시 된 앱 ID를 입력 합니다. 
