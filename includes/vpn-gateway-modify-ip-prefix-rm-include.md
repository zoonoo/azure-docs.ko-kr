### <a name="noconnection"></a>접두사 수정 - 게이트웨이 연결 없음
...
### <a name="withconnection"></a>접두사 수정 - 기존 게이트웨이 연결
게이트웨이 연결이 있고 로컬 네트워크 게이트웨이에 포함된 IP 주소 접두사를 추가 또는 제거하려면 다음 단계를 순서대로 수행해야 합니다. 이로 인해 VPN 연결에 약간의 가동 중지 시간이 발생합니다.
