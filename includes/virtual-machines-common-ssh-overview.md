...
* *개인 키*는 로컬 시스템에 남아 있습니다. 이 개인 키는 보호해야 하는 한편, 공유하면 안됩니다.

SSH 클라이언트를 사용하여 공개 키가 있는 Linux VM에 연결하는 경우 원격 VM이 클라이언트를 테스트하여 개인 키를 소유하고 있는지 확인합니다. 클라이언트에 개인 키가 있으면 VM에 액세스할 수 있습니다. 
