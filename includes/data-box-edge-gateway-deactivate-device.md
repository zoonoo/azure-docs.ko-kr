...
`BootDisk`스위치는 부팅 디스크를 초기화 하 고 장치를 사용할 수 없게 만듭니다. 장치를 Microsoft에 반환 해야 하는 경우에만 사용 해야 합니다. 자세한 내용은 [Microsoft로 장치 반환](https://docs.microsoft.com/azure/databox-online/data-box-edge-return-device)을 참조 하세요.
