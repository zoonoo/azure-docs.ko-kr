...
`BootDisk` 스위치는 부팅 디스크를 지워 디바이스를 사용할 수 없게 만듭니다. 디바이스를 Microsoft에 반환해야 하는 경우에만 사용해야 합니다. 자세한 내용은 [Microsoft로 디바이스 반환](../articles/databox-online/azure-stack-edge-return-device.md)을 참조하세요.
