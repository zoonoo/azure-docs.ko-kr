...
1. 이동할 VM이 포함 된 리소스 그룹을 관리 하려면 [Azure Portal](https://portal.azure.com) 로 이동 합니다. **리소스 그룹**을 검색하여 선택합니다.
2. 이동 하려는 VM이 포함 된 리소스 그룹을 선택 합니다.
...
1. 이동할 VM이 포함 된 리소스 그룹을 관리 하려면 [Azure Portal](https://portal.azure.com) 로 이동 합니다. **리소스 그룹**을 검색하여 선택합니다.
2. 이동 하려는 VM이 포함 된 리소스 그룹을 선택 합니다.
3. 리소스 그룹에 대 한 페이지 맨 위에서 **이동** 을 선택 하 고 **다른 리소스 그룹으로 이동**을 선택 합니다. **리소스 이동** 페이지가 열립니다.
4. 이동할 각 리소스를 선택합니다. 대부분의 경우에는 나열된 모든 관련 리소스를 이동해야 합니다.
