...
| 옵션 | 예제/링크 |
|-----------------------------------------------|---|
| 코드 블록의 오른쪽 위 모서리에서 **사용해 보기**를 선택합니다. **사용해 보기**를 선택하더라도 코드가 Cloud Shell에 자동으로 복사되지는 않습니다. | ![Azure Cloud Shell에 대한 사용 예제](./media/cloud-shell-try-it/cli-try-it.png) |
