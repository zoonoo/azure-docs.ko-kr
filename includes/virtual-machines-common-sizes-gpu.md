...
NDv2 시리즈 가상 머신은 HPC, AI 및 기계 학습 워크로드의 요구 사항을 위해 설계된 GPU 제품군에 새롭게 추가된 제품입니다. 8 NVIDIA Tesla V100 NVLINK 상호 연결 된 Gpu 및 40 Intel Xeon Platinum 8168 (Skylake) 코어 및 672 GiB 시스템 메모리를 기반으로 합니다. NDv2 인스턴스는 Cuda, TensorFlow, Pytorch, Caff 및 기타 프레임워크를 사용하는 HPC 및 AI 워크로드를 위한 우수한 FP32 및 FP64 성능을 제공합니다.
