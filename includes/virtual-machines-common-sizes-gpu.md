...
| 크기 | vCPU | GPU | 메모리 | NIC(최대) | 최대 디스크 크기 | 최대 데이터 디스크 | 캐시되지 않은 최대 디스크 처리량: IOPS/MBps | 최대 네트워크 대역폭 | 
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_ND40s_v2 | 40 | 8 V100 (NVLink) | 672GiB | 8 | 임시 1344/2948XIO | 32 | 80000 / 800 | 24000 Mbps |
...
| 크기 | vCPU | 메모리: GiB | 임시 저장소(SSD) GiB | GPU | GPU 메모리: GiB | 최대 데이터 디스크 수 | 캐시되지 않은 최대 디스크 처리량: IOPS/MBps | 최대 NIC 수 | 가상 워크스테이션 | 가상 애플리케이션 | 
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
