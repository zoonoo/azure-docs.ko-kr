...
### <a name="update-manifest-file-to-enable-notifications"></a>매니페스트 파일을 업데이트하여 알림 사용
...
> [!TIP]
> 올바른 아이콘 해상도를 사용하는지 확인하려면 [해당 예제](https://www.google.com/design/icons)를 확인하세요.
> **알림** 섹션이 나올 때까지 아래로 스크롤하고 아이콘을 클릭한 다음 `PNGS`을(를) 클릭하여 아이콘 drawable 집합을 다운로드합니다. 각 아이콘 버전에 사용할 drawable 폴더와 해상도를 확인할 수 있습니다.
> 
> 

### <a name="enable-your-app-to-receive-gcm-push-notifications"></a>앱이 GCM 푸시 알림을 받을 수 있도록 설정
1. Firebase 프로젝트 콘솔에서 가져온 **보낸 사람 ID**를 교체한 후에 다음을 `<application>` 및 `</application>` 태그 사이의 Manifest.xml을 붙여 넣습니다. \n은 프로젝트 번호가 \n으로 끝나도록 의도적으로 사용되었습니다.
