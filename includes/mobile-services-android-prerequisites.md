이 자습서는 모바일 서비스 퀵 스타트에서 다운로드한 코드를 기반으로 합니다. 이 자습서를 시작하기 전에 [모바일 서비스 시작](../articles/mobile-services-android-get-started.md) 또는 [기존 앱에 모바일 서비스 추가](../articles/mobile-services-android-get-started-data.md) 를 완료해야 합니다.
