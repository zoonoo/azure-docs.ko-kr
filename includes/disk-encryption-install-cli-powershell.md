...
[Azure PowerShell az 모듈은](/powershell/azure/new-azureps-module-az) Azure 리소스 관리자 모델을 사용하여 [Azure 리소스를](/azure/azure-resource-manager/resource-group-overview) 관리하는 cmdlet 집합을 제공합니다. [Azure Cloud Shell을](/azure/cloud-shell/overview)사용하여 브라우저에서 사용하거나 [Azure PowerShell 설치 모듈의](/powershell/azure/install-az-ps)지침을 사용하여 로컬 컴퓨터에 설치할 수 있습니다. 
