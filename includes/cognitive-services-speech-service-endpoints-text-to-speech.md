...
---
### <a name="standard-and-neural-voices"></a>표준 및 신경 음성

이 표를 사용하여 지역/끝점별로 표준 및 신경 음성의 가용성을 결정합니다.

| 지역 | 엔드포인트 | 표준 음성 | 신경 음성 |
|--------|----------|-----------------|---------------|
| 오스트레일리아 동부 | `https://australiaeast.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 브라질 남부 | `https://brazilsouth.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 캐나다 중부 | `https://canadacentral.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 미국 중부 | `https://centralus.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 동아시아 | `https://eastasia.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 미국 동부 | `https://eastus.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 미국 동부 2 | `https://eastus2.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 프랑스 중부 | `https://francecentral.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 인도 중부 | `https://centralindia.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 일본 동부 | `https://japaneast.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 일본 서부 | `https://japanwest.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 한국 중부 | `https://koreacentral.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 미국 중북부 | `https://northcentralus.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 북유럽 | `https://northeurope.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 미국 중남부 | `https://southcentralus.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 동남아시아 | `https://southeastasia.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 영국 남부 | `https://uksouth.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 서유럽 | `https://westeurope.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |
| 미국 서부 | `https://westus.tts.speech.microsoft.com/cognitiveservices/v1` | yes | 예 |
| 미국 서부 2 | `https://westus2.tts.speech.microsoft.com/cognitiveservices/v1` | yes | yes |

### <a name="custom-voices"></a>사용자 지정 음성

사용자 지정 음성 글꼴을 만든 경우 만든 끝점을 사용합니다. 아래 나열된 끝점을 음성 모델의 배포 `{deploymentId}` ID로 대체할 수도 있습니다.
