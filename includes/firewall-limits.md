...
ms.locfileid: "83673529"
---
| 리소스 | 제한 |
| --- | --- |
| 데이터 처리량 |30Gbps<sup>1</sup> |
|규칙|10,000. 모든 규칙 유형이 결합되었습니다.|
|최대 DNAT 규칙|298<br>규칙의 프로토콜이 TCP와 UDP 둘 다에 대해 구성된 경우 두 개의 규칙으로 계산됩니다.|
...
|IP 그룹의 IP 주소|50개 이하의 IP: 각 방화벽 인스턴스당 최대 5000개의 개별 IP 주소.<br>51 - 100개의 IP 그룹: 각 방화벽 인스턴스당 500개의 개별 IP 주소.<br><br>자세한 내용은 [Azure Firewall의 IP 그룹(미리 보기)](../articles/firewall/ip-groups.md#ip-address-limits)을 참조하세요.
