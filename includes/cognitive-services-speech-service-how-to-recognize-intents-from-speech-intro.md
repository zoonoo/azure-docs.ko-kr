...
1. LUIS 구독 키와 [지역](~/articles/cognitive-services/speech-service/regions.md#regions-for-intent-recognition)을 매개 변수로 사용하여 음성 구성을 만듭니다. LUIS 구독 키는 서비스 설명서에서 **엔드포인트 키**라고 합니다. LUIS 작성 키는 사용할 수 없습니다. (이 섹션의 뒷부분에 나오는 내용을 참고하세요.)
