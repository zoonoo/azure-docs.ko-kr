...
### <a name="setupdevenv"></a>.NET용 Azure SDK를 설치한 Visual Studio 2015

이 자습서는 [.NET용 Azure SDK](../articles/dotnet-sdk.md) 2.8.2 이상을 설치한 Visual Studio 2015에 대해 설명합니다. [여기에서 Visual Studio 2015용 최신 Azure SDK를 다운로드합니다](http://go.microsoft.com/fwlink/?linkid=518003). SDK가 없는 경우 Visual Studio는 SDK와 함께 자동으로 설치됩니다.
