...
9. Event Hub의 이름을 입력한 다음 **만들기**를 클릭합니다.
   
    ![](./media/event-hubs-create-event-hub/create-event-hub5.png)
10. Event Hubs의 목록에서 새로 만든 Event Hub 이름을 클릭합니다. 
    
     ![](./media/event-hubs-create-event-hub/create-event-hub6.png)
11. 네임스페이스 블레이드(특정 Event Hub 블레이드가 아님)로 돌아와서 **공유 액세스 정책**을 클릭한 다음 **RootManageSharedAccessKey**를 클릭합니다.
    
     ![](./media/event-hubs-create-event-hub/create-event-hub7.png)
12. 복사 단추를 클릭하여 클립보드에 대한 **RootManageSharedAccessKey** 연결 문자열을 복사합니다. 이 자습서 뒷부분에서 사용할 연결 문자열을 저장합니다.
