...
| **networkSecurityGroup** |서브넷에 적용된 NSG |아래 [NSG](#Network-Security-Group) |
| **routeTable** |서브넷에 적용된 경로 테이블 |아래 [UDR](#Route-table) |
| **ipConfigurations** |서브넷에 연결된 NIC에 사용된 IP 구성 개체 컬렉션 |아래 [UDR](#Route-table) |
