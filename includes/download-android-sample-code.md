...
1. <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures" target="blank">여기</a>를 클릭하여 gitHub에서 `mobile-services-samples` 리포지토리를 다운로드하고 **Download ZIP**을 클릭합니다.
