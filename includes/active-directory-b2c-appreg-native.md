...
1. 고유 구성표가 있는 리디렉션 URI를 입력합니다. 예들 들어 `com.onmicrosoft.contosob2c.exampleapp://oauth/redirect`입니다. 리디렉션 URI를 선택하는 경우 다음과 같은 두 가지 중요한 고려 사항이 있습니다.
