### <a name="disk-persistence"></a>데이터 지속성 

다음 테이블은 Azure VM에 있는 여러 디스크의 여러 상태 그리고 데이터가 각 상태에서 유지되는지 여부를 보여줍니다.

| 디스크 | 시작 | 중지/<br>할당 취소 | 일시 중지 | 다시<br>boot | 종<br>료 | 삭제 | 실패 | 크기 조정 | 
| ---- | ----- | ---- | ---- | ---- | ----  | ------ | ------- | ------ | 
| OS 디스크 | 예 | 예  | 예 | 예 | 예  | 아니요 | 아니요  | 예 | 
| RAM  | 예 | 예 | 예 | 예 | 아니요   | 아니요 | 아니요 | 아니요 | 
| 로컬 임시 디스크 | 예 | 아니요 | 예 | 아니요 | 아니요  | 아니요 | 아니요 | 아니요 | 
| 연결된 데이터 디스크 | 예 | 예 | 예 | 예 | 예  | 예 | 예 | 예 | 
