...
| 개요  | SSD 기반 고성능의 낮은 대기 시간의 디스크는 IO 사용량이 많은 작업을 실행하거나 중요 업무용 프로덕션 환경을 호스팅하는 VM 지원 | HDD 기반 비용 효율적인 디스크는 개발/테스트 VM 시나리오 지원 |
| 시나리오  | 프로덕션 및 성능이 중요한 워크로드 | 개발/테스트, 중요하지 않음, <br>액세스를 자주 하지 않음 |
| 디스크 크기 | P10: 128GB<br>P20: 512GB<br>P30: 1024GB | 관리되지 않는 디스크: 1GB – 1TB <br><br>관리 디스크:<br> S4: 32GB <br>S6: 64GB <br>S10: 128GB <br>S20: 512GB <br>S30: 1024GB |
