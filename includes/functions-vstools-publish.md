...
3. **프로필 만들기**를 선택합니다. Visual Studio에서 Azure 계정에 아직 로그인하지 않은 경우 **로그인**을 선택합니다. Azure 체험 계정을 만들 수도 있습니다.

4. **App Service: 새로 만들기**에서 다음 표에 지정된 값을 사용합니다.
