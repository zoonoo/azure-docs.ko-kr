**솔루션 탐색기**에서 프로젝트를 마우스 오른쪽 단추로 클릭하고 **게시**를 선택합니다. **새로 만들기**를 선택한 다음 **게시**를 클릭합니다. 

![게시 - 새 함수 앱 만들기](./media/functions-vstools-publish/functions-vstools-publish-new-function-app.png)

Visual Studio를 Azure 계정에 아직 연결하지 않았으면 **계정 추가...**를 클릭합니다.  

**App Service 만들기** 대화 상자에서 테이블에 지정된 대로 호스팅 설정을 사용합니다. 
