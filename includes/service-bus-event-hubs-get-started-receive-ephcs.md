...
7. **SimpleEventProcessor**라는 새 클래스를 만들고 파일 위쪽에 다음 문을 추가합니다.

		using Microsoft.ServiceBus.Messaging;
		using System.Diagnostics;
		using System.Threading.Tasks;

	그런 다음 다음 코드를 클래스의 본문으로 삽입합니다.
...
8. **Program** 클래스의 위쪽에 다음 `using` 문을 추가합니다.
	...
	그런 다음 **Main** 메서드에 다음 코드를 추가하고 이벤트 허브 이름 및 연결 문자열과 이전 섹션에서 복사한 저장소 계정 및 키로 대체합니다.
