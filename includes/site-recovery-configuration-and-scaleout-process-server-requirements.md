...
https:\//dev.mysql.com/get/Downloads/MySQLInstaller/mysql-installer-community-5.7.20.0.msi  | MySQL 다운로드를 완료 합니다. </br> 몇몇 지역 다운로드 CDN URL로 리디렉션될 수 있습니다. 필요한 경우 CDN URL을 허용 목록에도 인지를 확인 합니다.
|
**설치할 소프트웨어** | 
