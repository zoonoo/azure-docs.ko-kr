# <a name="using-cdn-for-azure"></a>Azure에 CDN 사용
...
2. 왼쪽 아래에서 **새로 만들기**를 클릭합니다. **새로 만들기** 대화 상자에서 **Data Services**를 선택한 다음 **저장소**, **빠른 생성**을 차례로 클릭합니다.
...
7. 저장소 계정이 만들어졌는지 확인하려면 계정이 **온라인** 상태인 **저장소**에 대해 나열된 항목에 표시되는지 확인합니다.
...
2. 리본에서 **New**를 클릭합니다. **새로 만들기** 대화 상자에서 **App Services**, **CDN**, **빠른 생성**을 차례로 선택합니다.
