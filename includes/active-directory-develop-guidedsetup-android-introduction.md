...
이 샘플에서는 MSAL(Android용 Microsoft 인증 라이브러리)를 사용하여 인증을 조정하고 지원합니다. MSAL은 토큰을 자동으로 갱신하고 장치의 다른 앱 간에 SSO를 제공하며 계정을 관리하고 대부분의 조건부 액세스 사례를 처리합니다. 

## <a name="prerequisites"></a>필수 조건
* 이 단계별 설정은 Android Studio 3.0을 사용합니다. 
