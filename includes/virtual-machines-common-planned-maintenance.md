...
일부 응용 프로그램은 이러한 종류의 업데이트에 영향을 받을 수 있습니다. 미디어 스트리밍이나 코드 변환과 같은 실시간 이벤트 처리 또는 처리량이 높은 네트워킹 시나리오를 수행하는 응용 프로그램은 30초 일시 중지를 허용할 수 있도록 설계되지 않았을 수 있습니다. <!-- sooooo, what should they do? --> 
