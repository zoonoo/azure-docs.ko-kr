...
| 부하 분산 |클라우드 서비스를 만들면 배포된 가상 컴퓨터에 대한 암시적 부하 분산 장치가 제공됩니다. |부하 분산 장치는 Microsoft.Network 공급자가 표시하는 리소스입니다. 부하 분산이 필요한 가상 컴퓨터의 기본 네트워크 인터페이스는 부하 분산 장치를 참조해야 합니다. 부하 분산 장치는 내부 또는 외부에 있을 수 있습니다. [자세한 정보](../articles/virtual-network/resource-groups-networking.md) |
