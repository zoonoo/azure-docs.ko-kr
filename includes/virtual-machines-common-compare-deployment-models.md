...
사용자가 작성한 모든 자동화 및 스크립트는 Azure 서비스 관리 모드에서 만든 기존 가상 컴퓨터 및 가상 네트워크에서 계속 작동합니다. 그러나 새 Azure 리소스 관리자 모드를 통해 동일한 리소스를 만드는 데 새 스키마를 사용하도록 스크립트를 업데이트해야 합니다. [Azure CLI 스크립트](../articles/virtual-machines/virtual-machines-linux-cli-manage.md) 수정 방법을 자세히 알아보세요.
