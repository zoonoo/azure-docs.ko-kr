...
1. StorSimple 디바이스 관리자를 이동하고 **디바이스** 를 선택합니다. 서비스에 연결된 디바이스 목록에서 업데이트하려는 디바이스를 선택하고 클릭합니다. 
    ...
    ![최근 장치 관리자 MySSDevManager 강조 표시 되 고 선택 된 후에는 장치가 강조 표시 되 고 선택 되며, 장치 MYSSIS1103 강조 표시 되 고 선택 됩니다.](../includes/media/storsimple-virtual-array-install-update-via-portal/azupdate1m.png) 
