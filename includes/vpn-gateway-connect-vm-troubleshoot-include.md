...
RDP 연결의 문제를 해결하는 방법에 대한 자세한 내용은 [VM에 대한 원격 데스크톱 연결 문제 해결](../articles/virtual-machines/troubleshooting/troubleshoot-rdp-connection.md)을 참조하세요.