...
1. 새 작업 영역을 구성하려면 다음 정보를 제공하세요.
   ...
   Workspace Edition | 이 자습서의 작업 영역 유형으로 **기본**을 선택합니다. 작업 영역 유형(기본 및 엔터프라이즈)에 따라 액세스 및 가격을 결정하는 기능이 달라집니다. 이 자습서의 모든 것은 기본 또는 엔터프라이즈 작업 영역으로 수행할 수 있습니다.
