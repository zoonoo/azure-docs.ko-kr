## <a name="tcp-settings-for-azure-vms"></a>Azure VM에 대한 TCP 설정
...
* [Azure Load Balancer][azure-lb-timeout]를 통한 **인바운드**. 이 시간 제한은 4분을 기본값으로 하며 30분까지 조정할 수 있습니다.
