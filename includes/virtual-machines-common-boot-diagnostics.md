...
![Azure 포털](./media/virtual-machines-common-boot-diagnostics/screenshot1.png)
...
부팅 진단이 활성화된 샘플 Virtual Machine을 배포하려면 여기에서 리포지토리를 확인하세요.

## <a name="update-an-existing-virtual-machine"></a>기존 가상 컴퓨터 업데이트 ##

포털을 통해 부팅 진단을 활성화하려면 포털을 통해 기존 Virtual Machine을 업데이트할 수도 있습니다. 부팅 진단 옵션을 선택하고 저장합니다. 적용하려면 VM을 다시 시작합니다.
