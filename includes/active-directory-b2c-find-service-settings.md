...
Azure AD B2C가 서비스 목록에 없으면 포털 맨 아래 왼쪽의 탐색 표시줄 아래에서 **More services**(서비스 더 보기)를 확장하세요. **Azure AD B2C**를 검색하고 검색 결과에서 **Azure AD B2C**를 선택합니다. 또한, 별 아이콘을 선택하여 Azure AD B2C를 즐겨찾기 서비스 목록에 추가할 수도 있습니다.
