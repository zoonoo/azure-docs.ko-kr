...
그룹을 만들고 멤버를 추가 하려면 [기본 그룹 만들기 및 Azure Active Directory를 사용 하 여 멤버 추가](../articles/active-directory/fundamentals/active-directory-groups-create-azure-portal.md)를 참조 하세요.