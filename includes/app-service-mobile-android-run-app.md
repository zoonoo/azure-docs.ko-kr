...
1. [Azure 포털]을 방문합니다. **모두 찾아보기** > **Mobile Apps** > 방금 만든 백 엔드를 클릭합니다. 모바일 앱 설정에서 **빠른 시작** > **Android**를 클릭합니다. **클라이언트 응용 프로그램 구성** 아래에서 **다운로드**를 클릭합니다. 그러면 사전 구성된 앱을 백 엔드에 연결하기 위한 전체 Android 프로젝트가 다운로드됩니다. 
