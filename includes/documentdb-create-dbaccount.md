...
3. **새 DocumentDB 계정** 블레이드에서 DocumentDB 계정에 대한 구성을 원하는 대로 지정합니다.
	...
	- **리소스 그룹**에서 DocumentDB 계정에 대한 리소스 그룹을 선택하거나 만듭니다. 기본적으로 새 리소스 그룹이 생성됩니다. 자세한 내용은 [Azure 포털을 사용하여 Azure 리소스 관리](../articles/azure-portal/resource-group-portal.md)를 참조하세요.
