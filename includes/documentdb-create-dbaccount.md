...
5.	DocumentDB 계정이 생성되면 온라인 포털에서 기본 설정으로 사용할 수 있습니다. DocumentDB 계정의 기본 일관성은 **세션**으로 설정됩니다. **Essentials 모음**에 있는 **열쇠 아이콘**을 클릭한 다음, **모든 설정** 블레이드에 있는 **기본 일관성** 항목을 클릭하여 기본 일관성 설정을 조정할 수 있습니다.
