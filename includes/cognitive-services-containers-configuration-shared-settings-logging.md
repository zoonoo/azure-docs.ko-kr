...
|공급자|용도|
|--|--|
|[콘솔](/aspnet/core/fundamentals/logging/#console-provider)|ASP.NET Core `Console` 로깅 공급자입니다. 이 로깅 공급자에 대한 모든 ASP.NET Core 구성 설정 및 기본값이 지원됩니다.|
|[디버그](/aspnet/core/fundamentals/logging/#debug-provider)|ASP.NET Core `Debug` 로깅 공급자입니다. 이 로깅 공급자에 대한 모든 ASP.NET Core 구성 설정 및 기본값이 지원됩니다.|
...
ASP.NET Core 로깅 지원 구성에 대한 자세한 내용은 [설정 파일 구성](/aspnet/core/fundamentals/logging/)을 참조하세요.