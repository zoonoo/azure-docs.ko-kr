...
ms.locfileid: "72237406"
---
Azure Storage 비용은 스토리지 계정 사용량에 따라 청구됩니다. 스토리지 계정의 모든 개체는 그룹으로 합산 청구됩니다. 

스토리지 비용은 지역/위치, 계정 유형, 스토리지 용량, 복제 체계, 스토리지 트랜잭션, 데이터 송신 등의 요소에 따라 계산됩니다.
