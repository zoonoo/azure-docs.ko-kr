## <a name="what-is-azure-file-storage"></a>파일 저장소 정의
...
* **공유** : Azure에서 파일 저장소 공유는 SMB 파일 공유입니다. 
  모든 디렉터리 및 파일을 부모 공유에 만들어야 합니다. 계정에 포함할 수 있는 공유 수에는 제한이 없으며, 공유에 저장할 수 있는 파일 수에는 파일 공유의 최대 5TB의 최대 용량까지 제한이 없습니다.
