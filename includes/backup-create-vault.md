...
### <a name="azure-backup---storage-redundancy-options"></a>Azure 백업 - 저장소 중복 옵션
> [!IMPORTANT]
...
#### <a name="geo-redundant-storage-grs"></a>지역 중복 저장소(GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>로컬 중복 저장소(LRS)
