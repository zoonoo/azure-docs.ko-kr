...
1. [Azure 관리 포털]에서 **Active Directory**로 이동한 후 디렉터리를 클릭합니다.

   ![](./media/mobile-services-dotnet-adal-register-client/mobile-services-select-aad.png)

2. 맨 위에 있는 **응용 프로그램** 탭을 클릭한 후 앱을 클릭하여 **추가**합니다. 
...
5. **리디렉션 URI** 상자에 모바일 서비스의 /login/done 끝점을 입력합니다. 이 값은 https://todolist.azure-mobile.net/login/done. 와 유사합니다.
