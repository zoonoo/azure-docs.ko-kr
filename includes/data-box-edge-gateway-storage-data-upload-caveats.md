...
- 파일 탐색기 또는 명령줄을 통해 끌어서 놓기 로 데이터를 복사할 수 있습니다. 복사할 파일의 집계 크기가 10GB를 초과하는 경우 Robocopy 또는 rsync와 같은 대량 복사 프로그램을 사용하는 것이 좋습니다. 대량 복사 도구는 간헐적인 오류에 대해 복사 작업을 다시 시도하고 추가 복원력을 제공합니다.
