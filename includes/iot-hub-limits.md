...
| 파일 업로드 작업 |83.33 파일 업로드 알림/초/단위 (5000/분/단위) (s 3의 경우), 1.67 파일 업로드 알림/초/단위 (100/분/단위) (S1 및 s 2의 경우) <br/> 1만 SAS Uri는 한 번에 Azure Storage 계정에 대해 사용할 수 있습니다.<br/> 10 SAS URI/디바이스는 한 번에 나올 수 있습니다. |
