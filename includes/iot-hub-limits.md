...
| 디바이스 쌍 읽기 | 50/초/단위(S3의 경우), 최대 10/초 또는 1/초/단위(S2의 경우), 10/초(S1의 경우) |
| 디바이스 쌍 업데이트 | 50/초/단위(S3의 경우), 최대 10/초 또는 1/초/단위(S2의 경우), 10/초(S1의 경우) |
...
| 디바이스 스트림 시작 속도 | 초당 새 스트림 5개(S1, S2, S3 및 F1만 해당) |