...
| 클라우드-디바이스 보내기 | 83.33/sec/unit (5000/분/단위) ((s3의 경우), 1.67/sec/unit (100/분/단위) (에 대 한 S1 및 s2의 경우). |
| 클라우드-디바이스 받기 |833.33/sec/unit (50000/분/단위) ((s3의 경우), 16.67/sec/unit (1000/분/단위) (에 대 한 S1 및 s2의 경우). |
| 파일 업로드 작업 |83.33 파일 업로드 알림/초/단위 (5000/분/단위) ((s3의 경우), 1.67 파일 업로드 알림/초/단위 (100/분/단위) ()(s1 및 S2의 경우). <br/> 10000 SAS Uri는 한 번에 Azure Storage 계정에 대 한 아웃 수 있습니다.<br/> 10 SAS URI/디바이스는 한 번에 나올 수 있습니다. |
...
| 디바이스 단위 작업 연산 처리량 | 50/초/단위 (s3), (의 최대 10/초 또는 1/초/단위 ((s2의 경우), 10/초 ((s1의 경우). |
