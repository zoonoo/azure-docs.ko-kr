...
ms.locfileid: "79381676"
---
다음 표에서는 Azure 범용 v1, v2, Blob 스토리지, 블록 Blob 스토리지 및 Data Lake Storage Gen2 지원 스토리지 계정의 기본 제한에 대해 설명합니다. *수신* 제한은 스토리지 계정에 보내는 모든 데이터를 나타냅니다. *송신* 제한은 스토리지 계정에서 받는 모든 데이터를 나타냅니다.

| 리소스 | 기본 제한 |
| --- | --- |
| 표준, 프리미엄 및 Data Lake Storage Gen2 지원 스토리지 계정을 포함하여 구독당 지역별 스토리지 계정 수입니다.<sup>3</sup> | 250 |
...
<sup>3</sup> [Azure Data Lake Storage Gen2](../articles/storage/blobs/data-lake-storage-introduction.md)는 Azure Blob 스토리지를 기반으로 하는 빅 데이터 분석 전용 기능 세트입니다. Azure Storage 및 Blob 스토리지 제한은 Data Lake Storage Gen2에 적용됩니다.
