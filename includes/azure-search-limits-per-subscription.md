...
| 리소스            | 무료<sup>1</sup> | Basic | S1  | S2 | S3 | S3&nbsp;HD |
| ------------------- | ---- | ----- | --- | -- | -- | ----- |
| 최대 서비스    |1     | 12    | 12  | 6  | 6  | 6     |
| 검색 단위 (SU)의 최대 크기<sup>2</sup> |N/A |3 SU |36 SU |36 SU |36 SU |36 SU |

<sup>1</sup>공유, 전용이 아닌 리소스를 기반으로 하는 무료입니다. 강화는 공유 리소스에서 지원되지 않습니다.
