...
ms.locfileid: "67182785"
---
> [!IMPORTANT]
> **이 문서의 작업을 완료하기 전에 Azure AD Domain Services에 대한 암호 해시 동기화를 사용하도록 설정합니다.**
>
> Azure AD 디렉터리의 사용자 유형에 따라 아래 지침을 따릅니다. Azure AD 디렉터리에 클라우드 전용 사용자 계정과 동기화된 사용자 계정이 혼합되어 있는 경우, 두 가지 지침을 모두 완료합니다. B2B 게스트 계정 (예: 여 gmail 또는 수 있도록 허용 하는 다른 Id 공급자에서 MSA)을 사용 하려는 경우 다음 작업을 수행할 수 없으므로에서는 이러한 관리 되는 도메인에 동기화 된 이러한 사용자에 대 한 암호 디렉터리에 게스트 계정입니다. 외부 Azure AD에서 자신의 암호를 포함 하 여 이러한 계정에 대 한 전체 정보는 것이 정보를 Azure AD에서 아니므로 따라서 해당 않습니다도 가져오기에 동기화 되지 관리 되는 도메인을 
