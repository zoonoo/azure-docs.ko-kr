...
---
## <a name="create-a-client-connection"></a><a name="create-client"></a>클라이언트 연결 만들기
...
## <a name="work-with-tables"></a><a name="table-reference"></a>테이블 작업
...
### <a name="how-to-query-a-table-reference"></a><a name="querying"></a>방법: 테이블 참조 쿼리
...
#### <a name="filtering-data-on-the-server"></a><a name="table-filter"></a>서버에서 데이터 필터링
...
#### <a name="paging-through-data"></a><a name="table-paging"></a>데이터 페이징
...
#### <a name="how-to-return-sorted-data"></a><a name="sorting-data"></a>방법: 정렬된 데이터 반환
