...
* **높은 우선 순위**: 리하이드레이션 요청은 표준 요청을 통해 우선 순위가 지정 되 고 1 시간 이내에 완료 될 수 있습니다. 높은 우선 순위는 blob 크기와 현재 수요에 따라 1 시간 이상 걸릴 수 있습니다. 높은 우선 순위의 요청은 표준 우선 순위 요청에 우선 순위가 지정 됩니다.
