...
3. **일정 추가** 블레이드에서 스냅샷 유형, 백업 빈도, 재방문 주기, 시작 및 종료 시간을 수정합니다. **추가** 를 클릭합니다.
    ...
    ![일정 관리 2](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule5.png)

4. 백업 정책 만들기가 완료되면 알림이 표시됩니다. 백업 정책 목록도 업데이트됩니다.

    ![일정 관리 3](./media/storsimple-8000-add-modify-backup-schedule-u2/addschedule4.png)
