...
1. **가상 네트워크 게이트웨이** 페이지에서 **+ 추가** 를 선택합니다. 그러면 **가상 네트워크 게이트웨이 만들기** 페이지가 열립니다.
   ...
   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/add.png" alt-text="가상 네트워크 게이트웨이 페이지":::
1. **기본** 탭에서 가상 네트워크 게이트웨이 값을 입력합니다.

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway.png" alt-text="게이트웨이 필드":::

   :::image type="content" source="./media/vpn-gateway-add-gw-rm-portal-empty/gateway-vnet.png" alt-text="추가 게이트웨이 필드":::
