...
-->
## <a name="create-a-new-azure-sql-server-level-firewall"></a>새 Azure SQL 서버 수준 방화벽 만들기
...
6. **클라이언트 IP 추가**를 클릭하여 Azure에서 규칙 상자에 사용자의 IP 주소를 입력하도록 합니다.
