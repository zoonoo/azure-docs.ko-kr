...
1. **myDeviceId**와 같은 새 장치의 이름을 입력하고 **저장**을 클릭합니다. 이 작업은 IoT Hub에 대한 새 장치 ID를 만듭니다.
   ...
   ![새 장치 추가](./media/iot-hub-get-started-create-device-identity-portal/add-device.png)

1. 나중에 사용하기 위해 장치 목록에서 새로 만든 장치를 클릭하고 **연결 문자열---기본 키**를 복사합니다.

    ![장치 연결 문자열](./media/iot-hub-get-started-create-device-identity-portal/device-connection-string.png)
