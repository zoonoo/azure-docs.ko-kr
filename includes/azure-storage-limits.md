...
<sup>1</sup>저장소 계정이 100개 이상 필요한 경우 [Azure 지원](https://azure.microsoft.com/support/faq/)에 요청합니다. Azure 저장소 팀은 비즈니스 사례를 검토합니다. 이에 대해 승인하면 최대 250개의 저장소 계정을 사용할 수 있습니다.
