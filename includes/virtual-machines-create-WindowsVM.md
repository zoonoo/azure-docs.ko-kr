...
5. 두 번째 화면에서는 컴퓨터 이름, 크기 및 관리자 사용자 이름과 암호를 선택할 수 있습니다. 앱 또는 워크로드를 실행하는 데 필요한 계층과 크기를 사용합니다. 다음은 이러한 정보를 채우는 데 도움이 되는 몇 가지 세부 정보입니다.
	...
	- 가상 컴퓨터의 크기는 사용 비용과 구성 옵션(예: 연결할 수 있는 데이터 디스크 수)에 영향을 미칩니다. 자세한 내용은 Azure에서 [가상 컴퓨터의 크기](../articles/virtual-machines-size-specs.md) 및 [클라우드 서비스에 적합한 크기](../articles/cloud-services-sizes-specs.md)를 참조하세요.
