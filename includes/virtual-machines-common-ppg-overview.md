...
- PowerShell, CLI 또는 SDK를 사용 하 여 배포를 스크립팅 하는 경우 `OverconstrainedAllocationRequest`할당 오류가 발생할 수 있습니다. 이 경우 모든 기존 Vm을 중지/할당 취소 하 고 실패 한 VM SKU/크기로 시작 하도록 배포 스크립트의 시퀀스를 변경 해야 합니다. 
