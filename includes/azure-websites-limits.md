...
| 구독당 App Service 인증서 수<sup>9</sup>| 지원되지 않음 | 지원되지 않음 |10 |10 |10 |10 |
| 앱당 사용자 지정 도메인</a> |0(azurewebsites.net 하위 도메인 전용)|500 |500 |500 |500 |500 |
| 사용자 지정 도메인 [SSL 지원](../articles/app-service/configure-ssl-certificate.md) |지원되지 않음, *.azurewebsites.net용 와일드카드 인증서는 기본적으로 사용 가능|지원되지 않음, *.azurewebsites.net용 와일드카드 인증서는 기본적으로 사용 가능|무제한 SNI SSL 연결 |무제한 SNI SSL 및 1개의 IP SSL 연결 포함 |무제한 SNI SSL 및 1개의 IP SSL 연결 포함 | 무제한 SNI SSL 및 1개의 IP SSL 연결 포함|
| 계획당 하이브리드 연결 수 | | | 5 | 25 | 200 | 200 |
...
<sup>8</sup>최대 IP 연결 수는 인스턴스당 기준이며, 인스턴스 크기에 따라 달라집니다. 즉 B1/S1/P1V2 인스턴스당 1,920개, B2/S2/P2V2 인스턴스당 3,968개, B3/S3/P3V2 인스턴스당 8,064개입니다.  
