...
<sup>9</sup>App Service 격리 SKU에는 Azure Load Balancer에서 내부적으로 부하 분산(ILB)되는 기능이 있습니다. 즉 인터넷의 공용 연결성이 없습니다. 그 결과, ILB 격리 App Service의 일부 기능은 ILB 네트워크 엔드포인트와 직접 액세스되는 컴퓨터에서 사용해야 합니다.