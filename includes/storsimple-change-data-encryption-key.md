...
> [AZURE.NOTE]StorSimple 가상 장치는 Azure 클래식 포털에서 키 변경을 시작할 권한을 부여받을 수 있는 장치 목록에 표시되지 않습니다.
...
> [AZURE.NOTE]키 롤오버가 완료될 때까지 StorSimple 관리자 서비스의 Azure 클래식 포털에서 수행할 수 있는 작업은 없습니다.
