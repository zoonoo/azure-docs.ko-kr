## <a name="generate-an-api-app-client"></a>API 앱 클라이언트 생성
Visual Studio의 API 앱 도구를 사용하면 데스크톱, 스토어 및 모바일 앱에서 Azure API 앱을 호출하는 C# 코드를 쉽게 생성할 수 있습니다. 

1. Visual Studio에서 [API 앱 만들기](../articles/app-service-api/app-service-dotnet-create-api-app.md) 항목의 API 앱이 포함된 솔루션을 엽니다. 
...
## <a name="test-the-api-app-client"></a>API 앱 클라이언트 테스트
