...
2. **그래프 추가** 페이지에서 새 그래프에 대한 설정을 입력합니다.
    ...
    Partition Key| /pk |모든 Cosmos DB 계정에는 수평 확장을 위한 파티션 키가 필요합니다. [그래프 데이터 분할 문서](../articles/cosmos-db/graph-partitioning.md)에서 적절한 파티션 키를 선택하는 방법에 대해 알아봅니다.
