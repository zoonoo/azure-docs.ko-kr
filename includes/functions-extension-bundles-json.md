...
기본 번들에 의해 설치된 현재 확장 집합은 이 [extensions.json 파일에](https://github.com/Azure/azure-functions-extension-bundles/blob/dev/src/Microsoft.Azure.Functions.ExtensionBundle/extensions.json)함께 표시됩니다.
