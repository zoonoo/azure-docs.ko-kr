...
가상 컴퓨터와 가상 네트워크당 역할 인스턴스 | 2048 | 2048
가상 컴퓨터 또는 역할 인스턴스용 동시 TCP 연결 | 500K |500K
네트워크 인터페이스(NIC) | 300 | 1000
네트워크 보안 그룹(NSG) | 100 | 400
NSG당 NSG 규칙 | 200 | 500
사용자 정의 경로 테이블 | 100 | 400
경로 테이블당 사용자 정의 경로 | 100 | 500
...
부하 분산 장치당 개인 프런트 엔드 IP | 1 | 지원에 문의
응용 프로그램 게이트웨이 | 50 | 50
