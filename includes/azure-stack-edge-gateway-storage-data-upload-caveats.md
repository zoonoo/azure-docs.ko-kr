...
- 파일 탐색기에서 끌어서 놓기를 사용하거나 명령줄을 통해 데이터를 복사할 수 있습니다. 복사할 파일의 집계 크기가 10GB보다 큰 경우에는 Robocopy 또는 rsync와 같은 대량 복사 프로그램을 사용하는 것이 좋습니다. 대량 복사 도구는 일시적인 오류에 대한 복사 작업을 다시 시도하고 추가 복원력을 제공합니다. REST를 통해 Blob storage를 사용 하는 경우 AzCopy 또는 Azure Storage 탐색기을 사용할 수 있습니다.
