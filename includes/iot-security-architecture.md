...
**정보 공개(I)**: 디바이스에서 조작된 소프트웨어를 실행하는 경우 조작된 소프트웨어가 권한 없는 사람에게 데이터를 유출할 수 있습니다. 예를 들어 공격자가 추출한 키 자료를 활용하여 컨트롤러 또는 필드 게이트웨이나 클라우드 게이트웨이와 디바이스 사이의 통신 경로에 키 자료 자체를 삽입하여 정보를 빼돌릴 수 있습니다.
