...
| --- | --- | --- | --- | --- |
| 장치 |S |장치에 ID를 할당하고 장치 인증 |장치 또는 장치 일부를 다른 장치로 대체합니다. 올바른 장치와 통신하고 있는지 어떻게 알 수 있을까요? |TLS(전송 계층 보안) 또는 IPSec을 사용하여 장치를 인증합니다. 전체 비대칭 암호화를 처리할 수 없는 PSK(미리 공유한 키)를 해당 장치에서 사용할 수 있도록 인프라가 지원해야 합니다. Azure AD, [OAuth](https://www.rfc-editor.org/pdfrfc/rfc6755.txt.pdf)를 활용하세요. |
