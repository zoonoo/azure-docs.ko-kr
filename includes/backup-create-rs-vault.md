...
>[!IMPORTANT]
> 자격 증명 모음에서 백업을 구성하기 전에 **스토리지 복제 유형** 및 **보안 설정** 에 대한 기본 설정을 검토하는 것이 좋습니다. 자세한 내용은 [스토리지 중복 설정](../articles/backup/backup-create-rs-vault.md#set-storage-redundancy) 섹션을 참조하세요.