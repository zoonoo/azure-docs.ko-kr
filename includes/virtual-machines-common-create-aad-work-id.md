...
## <a name="locate-your-default-directory-in-the-azure-classic-portal"></a>Azure 클래식 포털에서 기본 디렉터리 찾기
...
## <a name="creating-a-new-user-in-the-default-domain"></a>기본 도메인에서 새 사용자 만들기
...
## <a name="logging-in-and-changing-the-new-users-password"></a>로그인 및 새 사용자의 암호 변경
만든 새 사용자로 로그인합니다.
