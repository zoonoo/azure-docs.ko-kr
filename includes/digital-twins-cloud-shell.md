...
다음으로, [**Azure CLI용 Microsoft Azure IoT 확장**](/cli/azure/ext/azure-iot/iot)을 Cloud Shell에 추가하여 Azure Digital Twins 및 기타 IoT 서비스와 상호 작용하는 명령을 사용하도록 설정합니다. 
