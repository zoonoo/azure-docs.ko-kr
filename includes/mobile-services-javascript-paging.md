...
4.  default.js 파일에서 **RefreshTodoItems** 메서드를 다음 코드로 바꿉니다.
...
1.  (옵션) 브라우저 개발자 도구 또는 [Fiddler](http://go.microsoft.com/fwlink/?LinkID=262412)(영문)와 같은 메시지 검사 소프트웨어를 사용하여 모바일 서비스에 전송된 요청의 URI를 봅니다.

        **take(3)** 메서드는 쿼리 URI에서 쿼리 옵션 **$top=3**으로 변환되었습니다.

2.  **RefreshTodoItems** 메서드를 다음 코드로 한 번 더 업데이트합니다.
...
3.  (옵션) 모바일 서비스에 전송된 요청의 URI를 다시 봅니다.
