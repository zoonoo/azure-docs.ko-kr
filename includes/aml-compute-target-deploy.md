...
ms.locfileid: "74549453"
---
| 컴퓨팅 대상 | 용도 | GPU 지원 | FPGA 지원 | 설명 |
| ----- | ----- | ----- | ----- | ----- |
...
| [Azure Machine Learning compute 인스턴스&nbsp;웹&nbsp;서비스](../articles/machine-learning/service/how-to-deploy-and-where.md#notebookvm) | 테스트/디버깅 | &nbsp; | &nbsp; | 제한 된 테스트 및 문제 해결에 사용 합니다.
...
| [Azure Machine Learning 계산 클러스터](../articles/machine-learning/service/how-to-run-batch-predictions.md) | 모드 일괄 처리&nbsp;유추 | [예](../articles/machine-learning/service/how-to-run-batch-predictions.md) (기계 학습 파이프라인) | &nbsp;  | 서버를 사용 하지 않는 계산에서 일괄 처리 점수 매기기를 실행 합니다. 는 보통 및 낮은 우선 순위 Vm을 지원 합니다. |
| [Azure 기능](../articles/machine-learning/service/how-to-deploy-functions.md) | 모드 실시간 유추 | &nbsp; | &nbsp; | &nbsp; |
...
> [!NOTE]
> 로컬, Azure Machine Learning 계산 인스턴스 및 Azure Machine Learning 계산 클러스터와 같은 계산 대상이 학습 및 실험을 위해 GPU를 지원 하지만 __웹 서비스로 배포할 때__ gpu를 사용 하면 Azure 에서만 지원 됩니다. Kubernetes 서비스입니다.
>
