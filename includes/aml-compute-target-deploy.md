...
| [Azure Functions](../articles/machine-learning/service/how-to-deploy-functions.md) | 모드 실시간 유추 | &nbsp; | &nbsp; | &nbsp; |
...
| [Azure Data Box Edge](../articles/databox-online/data-box-edge-overview.md)   | Via IoT Edge |  &nbsp; | yes | IoT 장치에서 ML 모델을 배포 하 고 제공 합니다. |
