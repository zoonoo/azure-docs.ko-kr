...
ms.locfileid: "70014789"
---
| 컴퓨팅 대상 | 사용법 | GPU 지원 | FPGA 지원 | Description |
| ----- | ----- | ----- | ----- | ----- |
| [로컬&nbsp;웹&nbsp;서비스](../articles/machine-learning/service/how-to-deploy-and-where.md#local) | 테스트/디버그 | &nbsp; | &nbsp; | 제한 된 테스트 및 문제 해결에 적합 합니다. 하드웨어 가속은 로컬 시스템의 라이브러리를 사용 하는 방법에 따라 달라 집니다.
| [노트북 VM&nbsp;웹&nbsp;서비스](../articles/machine-learning/service/how-to-deploy-and-where.md#notebookvm) | 테스트/디버그 | &nbsp; | &nbsp; | 제한 된 테스트 및 문제 해결에 적합 합니다. 
...
| [Azure Machine Learning 컴퓨팅](../articles/machine-learning/service/how-to-run-batch-predictions.md) | 모드 일괄&nbsp;처리 유추 | &nbsp; | &nbsp;  | 서버를 사용 하지 않는 계산에서 일괄 처리 점수 매기기를 실행 합니다. 는 보통 및 낮은 우선 순위 Vm을 지원 합니다. |
...
> [!NOTE]
> 로컬, 노트북 VM 및 Azure Machine Learning Compute와 같은 계산 대상은 학습 및 실험을 위해 GPU를 지원 하지만 유추에 GPU를 사용 하는 것은 Azure Kubernetes Service 에서만 지원 됩니다.