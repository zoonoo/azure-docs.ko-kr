...
ZRS 복제를 사용하여 스토리지 계정에 데이터를 저장하는 경우 가용성 영역을 사용할 수 없으면 데이터 액세스 및 관리를 계속할 수 있습니다. ZRS는 뛰어난 성능과 짧은 대기 시간을 제공하며, ZRS는 [LRS (로컬 중복 저장소)](../articles/storage/common/storage-redundancy-lrs.md)와 동일한 확장성 목표를 제공 합니다. Standard storage 계정의 확장성 목표에 대 한 자세한 내용은 [standard storage 계정에 대 한 확장성 목표](../articles/storage/common/scalability-targets-standard-account.md)를 참조 하세요.
