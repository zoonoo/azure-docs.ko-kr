...
3. **새 계정** 창에서 Azure Cosmos DB 계정에 대해 원하는 구성을 지정합니다. 
    ...
    테이블의 정보를 가이드로 사용하여 **새 계정** 창을 채웁니다.
 
    ![새 Azure Cosmos DB 창의 스크린샷](./media/cosmos-db-create-dbaccount-mongodb/create-nosql-db-databases-json-tutorial-2.png)
