...
ms.locfileid: "84268987"
---
## <a name="sign-in-to-azure"></a>Azure에 로그인

앱을 게시하기 전에 Azure에 로그인해야 합니다. 

1. 아직 로그인하지 않은 경우 작업 막대에서 Azure 아이콘을 선택한 다음, **Azure: Functions** 영역에서 **Azure에 로그인...** 을 선택합니다. 계정이 없는 경우 **[평가판 Azure 계정 만들기](https://azure.microsoft.com/free/)** 를 수행할 수 있습니다. 학생은 여기를 클릭하여 **[학생용 평가판 Azure 계정을 만들 수 있습니다](https://azure.microsoft.com/free/students/)** .
