...
* M 시리즈는 클라우드에서 가장 높은 CPU 수(최대 128개의 vCPU) 및 모든 VM의 가장 큰 메모리(최대 2.0TiB)를 제공합니다.  높은 CPU 개수 및 많은 양의 메모리를 활용하는 매우 큰 데이터베이스 또는 다른 응용 프로그램에 이상적입니다.
...
| 크기             | vCPU | 메모리: GiB | 로컬 SSD: GiB | 최대 데이터 디스크 수 | 최대 캐시된 로컬 디스크 처리량: IOPS/MBps(GiB 단위 캐시 크기) | 최대 캐시되지 않은 디스크 처리량: IOPS/MBps | 최대 NIC 수 / 예상 네트워크 성능(Mbps) |
|------------------|-----------|-------------|----------------|----------------|-----------------------------------------------------------------------|-------------------------------------------|------------------------------------------------|
...
| 크기             | vCPU | 메모리: GiB | 로컬 SSD: GiB | 최대 데이터 디스크 수 | 최대 캐시된 로컬 디스크 처리량: IOPS/MBps(GiB 단위 캐시 크기) | 최대 캐시되지 않은 디스크 처리량: IOPS/MBps | 최대 NIC 수 / 예상 네트워크 성능(Mbps) |
|------------------|-----------|-------------|----------------|----------------|-----------------------------------------------------------------------|-------------------------------------------|------------------------------------------------|
| Standard_E2_v3  | 2         | 16          | 32             | 4              | 4,000 / 32 (50)                                                       | 3,200/48                                | 2/보통                                   |
| Standard_E4_v3  | 4         | 32          | 64             | 8              | 8,000 / 64 (100)                                                      | 6,400/96                                | 2/보통                                   |
| Standard_E8_v3  | 8         | 64          | 128            | 16             | 16,000 / 128 (200)                                                    | 12,800/192                              | 4/높음                                       |
| Standard_E16_v3 | 16        | 128         | 256            | 32             | 32,000 / 256 (400)                                                    | 25,600/384                              | 8/높음                                       |
| Standard_E32_v3 | 32        | 256         | 512            | 32             | 64,000 / 512 (800)                                                    | 51,200/768                              | 8/극히 높음                             |
| Standard_E64_v3 | 64        | 432         | 864            | 32             | 128,000/1024 (1600)                                                   | 80,000 / 1200                             | 8/극히 높음                             |
