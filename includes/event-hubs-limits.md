...
---
다음 표에서는 [Azure Event Hubs](https://azure.microsoft.com/services/event-hubs/)에 한정 된 할당량 및 제한을 제공 합니다. 가격 책정에 대 한 자세한 내용은 [가격 책정 Event Hubs](https://azure.microsoft.com/pricing/details/event-hubs/)를 참조 Event Hubs.
