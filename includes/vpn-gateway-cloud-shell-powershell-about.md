...
로컬에서 실행 중인 PowerShell 버전을 찾으려면 ‘Get-Module-ListAvailable AzureRM’ cmdlet을 사용합니다. 업데이트하려면 [Azure PowerShell 모듈 설치](/powershell/azure/azurerm/install-azurerm-ps)를 참조하세요. 자세한 내용은 [Azure PowerShell을 설치 및 구성하는 방법](/powershell/azure/azurerm/overview)을 참조하세요.
