...
1. Keychain Access에서 **Keys** 또는 **My Certificates**의 quickstart 앱 새 인증서를 마우스 오른쪽 단추로 클릭하고 **Export**를 클릭한 다음 파일의 이름을 QuickstartPusher로 지정하고 **.p12** 형식을 선택한 다음 **Save**를 클릭합니다.
...
2. [Azure 미리 보기 포털]에 로그온하고 **찾아보기**, **모바일 앱**을 선택한 다음 앱을 클릭합니다. 푸시 알림 서비스를 클릭합니다.
