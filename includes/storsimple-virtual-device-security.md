...
* Azure StorSimple에 저장된 데이터를 암호화하는 데 사용되는 인증서의 공개 키는 Azure 클래식 포털에서 안전하게 사용할 수 있으며 개인 키는 StorSimple 디바이스에 유지됩니다. StorSimple 가상 디바이스에서 공개 및 개인 키는 모두 Azure에 저장됩니다.
