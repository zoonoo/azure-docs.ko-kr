...
- **개체 형식**을 선택하고 개체 목록에서 *Lead*를 선택합니다. 이 단계에서는 Salesforce에서 새 잠재 고객을 만들 때마다 논리 앱에 알리는 트리거를 만들고 있음을 지정합니다.  
![Salesforce 트리거 이미지 3](./media/connectors-create-api-salesforce/trigger-3.png)  
- 이것으로 끝입니다. 트리거가 만들어졌습니다. 그러나 이 유효한 논리 앱을 만들기 위해서는 하나 이상의 동작을 만들어야 합니다.  
