...
|----------------------------------------------------------- |------------------------------------|
| [IoT Hub 메시지 관리](../articles/iot-hub/iot-hub-vscode-iot-toolkit-cloud-device-messaging.md)                  | VS 코드 Azure IoT 허브 확장|
| [IoT 디바이스 관리](../articles/iot-hub/iot-hub-device-management-iot-extension-azure-cli-2-0.md)                        | Azure CLI 및 IoT 확장    |
| [IoT 디바이스 관리](../articles/iot-hub/iot-hub-device-management-iot-toolkit.md)                | VS 코드 Azure IoT 허브 확장|
| [Azure Storage에 IoT Hub 메시지 저장](../articles/iot-hub/iot-hub-store-data-in-azure-table-storage.md)  | Azure 테이블 스토리지                |
