...
1. [Azure 클래식 포털][Azure 클래식 포털]에 로그온한 다음 화면 맨 아래에서 **새로 만들기**를 클릭합니다.
...
Event Hubs에 대한 Java 클라이언트 라이브러리는 [Maven 중앙 리포지토리][Maven 패키지]의 Maven 프로젝트에 사용할 수 있으며 Maven 프로젝트 파일 내의 다음 종속성 선언을 사용하여 참조할 수 있습니다.    
...
다양한 유형의 빌드 환경을 위해, [Maven 중앙 리포지토리][Maven 패키지] 또는 [GitHub의 릴리스 배포 지점](https://github.com/Azure/azure-event-hubs/releases)에서 최근에 릴리스된 JAR 파일을 명시적으로 가져올 수 있습니다.  
...
<!-- Links -->
[이벤트 허브 개요]: ../articles/event-hubs/event-hubs-overview.md
[Azure Storage 계정]: ../articles/storage/storage-create-storage-account.md
[Azure 클래식 포털]: http://manage.windowsazure.com
[Maven 패키지]: https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22azure-eventhubs-eph%22
