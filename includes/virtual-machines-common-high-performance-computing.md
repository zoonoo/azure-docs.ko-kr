...
* **Marketplace 솔루션**
    * [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/)에서 제공되는 [HPC 애플리케이션](#hpc-applications) 및 [솔루션](#marketplace-solutions)의 규모를 사용합니다. 
...
* [RogueWave CentOS 기반 HPC](https://azuremarketplace.microsoft.com/marketplace/apps/RogueWave.CentOSbased74HPC?tab=Overview)
...
* Autodesk Maya, 3ds Max, and Arnold, Chaos Group V-Ray, Blender를 포함하여 Azure Batch의 [렌더링 애플리케이션](../articles/batch/batch-rendering-service.md)
...
[Azure CycleCloud](https://docs.microsoft.com/azure/cyclecloud/overview)를 통해 Azure VM에서 HPC 클러스터를 만들고 최적화하는 동시에 일반 워크로드를 효과적으로 손쉽게 관리합니다.
...
[Batch](../articles/batch/batch-technical-overview.md)는 클라우드에서 대규모 병렬 및 HPC(고성능 컴퓨팅) 애플리케이션을 효율적으로 실행하기 위한 플랫폼 서비스입니다. Azure Batch는 가상 머신의 관리되는 풀에서 실행되는 계산 집약적 작업을 예약하고, 작업 요구에 맞게 계산 리소스를 자동으로 크기 조정할 수 있습니다. 
...
대규모 Batch 및 HPC 작업에는 기존 클라우드 파일 시스템의 용량을 초과하는 데이터 저장 및 액세스에 대한 요구 사항이 있습니다. 

자세한 정보:

* [Avere vFXT for Azure](../articles/avere-vfxt/avere-vfxt-overview.md) 
* [Lustre](http://lustre.org/) 및 [BeeGFS](http://www.beegfs.com/content/)를 포함하여 [Azure의 병렬 가상 파일 시스템](https://azure.microsoft.com/resources/parallel-virtual-file-systems-on-microsoft-azure/)
...
* [Blob, 테이블 및 Queue Storage](../articles/storage/storage-introduction.md)
...
* [Machine Learning 서비스](../articles/machine-learning/service/overview-what-is-azure-ml.md)
...
* [고성능 컴퓨팅](https://azure.microsoft.com/solutions/high-performance-computing/), [렌더링](https://azure.microsoft.com/solutions/big-compute/rendering/), [금융 및 자본 시장](https://finance.azure.com/) 및 [유전체학](https://enterprise.microsoft.com/industries/health/genomics/)에 대한 Azure 솔루션을 자세히 알아봅니다.

* Azure의 [빅 컴퓨팅 솔루션 아키텍처](https://azure.microsoft.com/solutions/architecture/?solution=high-performance-computing)를 자세히 알아봅니다.
