1.  [Azure(Preview) 관리 포털][AzurePreviewPortal]에서 **Virtual Machines**를 클릭하고 방금 만든 가상 컴퓨터(**testlinuxvm**)를 선택합니다.
...
5.  가상 컴퓨터의 이름을 클릭하여 대시보드를 표시합니다. 이 대시보드를 사용하여 데이터 디스크가 가상 컴퓨터에 연결되었는지 확인할 수 있습니다.
    ...
    ![빈 디스크 연결](./media/attach-data-disk-centos-vm-in-portal/AttachDataDiskLinuxVM3.png)
...
8.  **mkfs** 명령을 사용하여 새 디스크를 포맷합니다.
    ...
    ![파일 시스템 만들기](./media/howto-attach-disk-window-linux/DiskFileSystem.png)
