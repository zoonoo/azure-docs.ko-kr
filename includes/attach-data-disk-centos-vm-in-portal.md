1.  Azure [관리 포털][관리 포털]에서 **Virtual Machines**를 클릭하고 방금 만든 가상 컴퓨터(**testlinuxvm**)를 선택합니다.
...
11. /etc/fstab에 새 드라이브를 추가합니다.
  ...
  [빈 디스크 연결]: ./media/attach-data-disk-centos-vm-in-portal/AttachDataDiskLinuxVM2.png
