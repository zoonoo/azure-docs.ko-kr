1.  [Azure(Preview) 관리 포털][AzurePreviewPortal]에서 **Virtual
    Machines**를 클릭하고 방금 만든 가상 컴퓨터(**testlinuxvm**)를 선택합니다.
...
3.  **Virtual Machine Name**, **Storage Location** 및 **File Name**은 이미
    ...
    ![빈 디스크
    연결](./media/attach-data-disk-centos-vm-in-portal/AttachDataDiskLinuxVM2.png)
...
5.  가상 컴퓨터의 이름을 클릭하여 대시보드를 표시합니다. 이 대시보드를 사용하여 데이터 디스크가 가상 컴퓨터에 연결되었는지
    ...
    ![빈 디스크
    연결](./media/attach-data-disk-centos-vm-in-portal/AttachDataDiskLinuxVM3.png)
...
1.  가상 컴퓨터가 프로비전된 후 위 단계에 설명된 대로 SSH 또는 PuTTY를 사용하여 연결하고 **newuser**로
    로그인합니다.
