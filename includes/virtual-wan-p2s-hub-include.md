...
1. [가상 허브 만들기] 페이지에서 다음 필드를 채웁니다.
   ...
   * **허브 프라이빗 주소 공간** - CIDR 표기법으로 된 허브의 주소 범위입니다.
   ...
   :::image type="content" source="media/virtual-wan-p2s-hub/create-hub.jpg" alt-text="가상 허브 만들기":::
...
1. 지점 및 사이트 간 탭에서 다음 필드를 완료합니다.
   ...
   * **사용자 지정 DNS 서버 IP**
   ...
   :::image type="content" source="media/virtual-wan-p2s-hub/hub-with-p2s.png" alt-text="지점 및 사이트 간 허브":::
