...
ms.locfileid: "74224552"
---
| 리소스 | [Consumption plan](../articles/azure-functions/functions-scale.md#consumption-plan) | [Premium plan](../articles/azure-functions/functions-scale.md#premium-plan) | [App Service plan](../articles/azure-functions/functions-scale.md#app-service-plan)<sup>1</sup> |
| --- | --- | --- | --- |
| 확장 | Event driven | Event driven | [Manual/autoscale](../articles/app-service/manage-scale-up.md) | 
...
| [App Service 계획](../articles/app-service/overview-hosting-plans.md) | 100 per [region](https://azure.microsoft.com/global-infrastructure/regions/) |리소스 그룹당 100 |리소스 그룹당 100 |
| Storage<sup>6</sup> |1GB |250GB |50-1000 GB |
| 앱당 사용자 지정 도메인</a> |500<sup>7</sup> |500 |500 |
| 사용자 지정 도메인 [SSL 지원](../articles/app-service/configure-ssl-bindings.md) |unbounded SNI SSL connection included | unbounded SNI SSL and 1 IP SSL connections included |unbounded SNI SSL and 1 IP SSL connections included | 
