...
<sup>7</sup> 함수 앱에서 호스트 되는 경우는 [소비 계획](../articles/azure-functions/functions-scale.md#consumption-plan), CNAME 옵션만 지원 됩니다. 함수 앱에 대 한는 [프리미엄 요금제](../articles/azure-functions/functions-scale.md#premium-plan) 요소나 [App Service 계획](../articles/azure-functions/functions-scale.md#app-service-plan), CNAME 또는 A 레코드를 사용 하 여 사용자 지정 도메인을 매핑할 수 있습니다.
