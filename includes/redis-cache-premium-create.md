...
>[AZURE.NOTE] Azure 포털에서 캐시를 만드는 것 외에도 ARM 템플릿, PowerShell 또는 Azure CLI를 사용해서도 만들 수 있습니다. 자세한 내용은 [캐시 만들기](../articles/redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md#create-a-cache)를 참조하세요.
