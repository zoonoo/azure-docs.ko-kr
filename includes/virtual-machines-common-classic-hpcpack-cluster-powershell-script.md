...
* **Azure PowerShell 0.8.7 이상이 설치 및 구성된 Windows 클라이언트 컴퓨터** - [Azure PowerShell 설치 및 구성](../articles/powershell-install-configure.md)을 참조하세요. 이 스크립트는 Azure 서비스 관리(asm) 모드에서 실행됩니다.
