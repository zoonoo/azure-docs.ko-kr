...
>[AZURE.NOTE]기존 SQL Server 데이터베이스를 마이그레이션하는 경우 타사 도구인 [Azure SQL 데이터베이스 DTU 계산기](http://dtucalculator.azurewebsites.net/)를 사용하여 성능 수준을 추정할 수 있으며 서비스 계층 데이터베이스는 Azure SQL 데이터베이스에서 필요할 수 있습니다.
