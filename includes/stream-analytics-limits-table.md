...
| 제한 식별자 | 제한 | 주석 |
| --- | --- | --- |
| 지역별 구독당 최대 스트리밍 단위 수 |500 |500개를 초과하는 구독의 스트리밍 단위 증가를 요청하려면 [Microsoft 지원](https://support.microsoft.com/en-us)에 문의하세요. |
| 작업당 입력의 최대 수 |60 |Azure Stream Analytics 작업당 60개의 입력 하드 제한이 있습니다. |
