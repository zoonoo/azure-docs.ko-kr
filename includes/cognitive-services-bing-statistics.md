...
기본적으로 차트와 그래프는 사용자가 액세스할 수 있는 모든 메트릭 데이터를 반영합니다. 관심 있는 리소스, 지역/국가, 엔드포인트 및 보고 기간을 선택하여 차트 및 그래프에 표시되는 데이터를 필터링할 수 있습니다. 차트와 그래프는 적용한 필터에 맞게 변경됩니다. 다음은 변경할 수 있는 필터에 대한 설명입니다.
...
가능한 메트릭은 다음과 같습니다. 각 메트릭은 엔드포인트 제한 사항을 나타냅니다.
...
다음은 각 엔드포인트에 사용할 수 있는 분석입니다.

![엔드포인트 지원 매트릭스별 배포](./media/cognitive-services-bing-statistics/bing-statistics-matrix.PNG)
