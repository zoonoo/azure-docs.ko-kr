...
| 데이터베이스 |64 |
| 최대 연결된 클라이언트 |40,000 |
| 고가용성을 위해 Redis 복제본용 Azure 캐시 |1 |
| 클러스터링을 사용하여 프리미엄 캐시 분할 |10 |

Azure Cache for Redis 제한 및 크기는 각 가격 책정 계층에 따라 다릅니다. 가격 책정 계층 및 관련 크기를 보려면 [Redis 가격 책정에 대한 Azure 캐시를](https://azure.microsoft.com/pricing/details/cache/)참조하십시오.
