...
1. 데이터 디스크가 생성되어 연결된 후에는 VM의 대시보드에 나열됩니다.
   
   ![빈 데이터 디스크 연결됨](./media/howto-attach-disk-windows-linux/AttachEmptySuccess.png)

> [!NOTE]
> 새 데이터 디스크를 추가한 후 VM에 로그온하여 디스크를 사용할 수 있도록 초기화해야 합니다.
> 
> 
