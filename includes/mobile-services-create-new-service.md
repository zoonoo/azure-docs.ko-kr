...
4.	**모바일 서비스 만들기** 페이지에서 **무료 20MB SQL 데이터베이스 만들기**, **Node.js** 런타임을 차례로 선택한 후 **URL** 입력란에 새 모바일 서비스를 위한 하위 도메인 이름을 입력하고 이름 확인을 기다립니다. 이름 확인이 완료되면 오른쪽 화살표 단추를 클릭하여 다음 페이지로 이동합니다.	
