...
3. 서비스 등록 키를 찾습니다.
4. 복사 아이콘  ![StorSimple 복사 아이콘](./media/storsimple-get-service-registration-key/HCS_CopyIcon-include.png) 을 클릭하여 키를 복사한 다음 나중에 사용할 수 있도록 저장합니다.
5. 확인 아이콘 ![StorSimple 확인 아이콘](./media/storsimple-get-service-registration-key/HCS_CheckIcon-include.png) 을 클릭하여 이 대화 상자를 닫고 **빠른 시작** 페이지로 이동합니다.
