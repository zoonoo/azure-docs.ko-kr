...
[`Set-AzStorageAccount`](https://docs.microsoft.com/powershell/module/az.storage/set-azstorageaccount)PowerShell cmdlet 및 Azure CLI 명령을 통해 100 TiB 파일 공유를 사용 하도록 설정할 수도 있습니다 [`az storage account update`](https://docs.microsoft.com/cli/azure/storage/account#az-storage-account-update) . 대량 파일 공유 사용에 대 한 자세한 지침은 [대량 파일 공유 사용 및 만들기](../articles/storage/files/storage-files-how-to-create-large-file-share.md)를 참조 하세요.
