...
- [Azure CLI을 사용하여 템플릿 배포](virtual-machines-linux-cli-manage.md)
- [Azure PowerShell을 사용하여 템플릿 배포](virtual-machines-windows-ps-manage.md)

### 필수 조건

1. [여기](https://azure.microsoft.com/downloads/)에서 해당 운영 체제에 대한 Azure 명령줄 도구를 다운로드합니다.
2. 기존의 VM에서 스크립트를 실행하려면 VM에서 VM 에이전트가 사용하도록 설정되어 있는지 확인하고, 그렇지 않은 경우 [Linux](virtual-machines-linux-classic-manage extensions.md) 또는 [Windows](virtual-machines-windows-classic-manage extensions.md) 참고 자료를 따라 VM 에이전트를 설치합니다.
