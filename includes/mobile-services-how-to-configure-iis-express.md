...
5.  Windows 방화벽 콘솔을 열고 포트에 대한 연결을 허용하도록 새 포트 규칙을 만듭니다. 새 Windows 방화벽 포트 규칙을 만드는 방법에 대한 자세한 내용은 [새 Windows 방화벽 포트 규칙을 추가하는 방법][새 Windows 방화벽 포트 규칙을 추가하는 방법]을 참조하십시오.
