...
3. **백업 정책 만들기** 블레이드에서 다음 단계를 수행합니다.
   ...
   2. 3 ~ 150 자의 백업 **정책 이름을** 지정 합니다. 정책을 만든 후에는 정책 이름을 바꿀 수 없습니다.
   ...
   4. 이 백업 정책에 대한 일정을 정의하려면 **첫 번째 일정** 을 클릭한 후 다음 매개 변수를 수정합니다.<!--Do the substeps remain the same? Can they follow without a screenshot?-->
       ...
       ![백업 정책 추가 3](./media/storsimple-8000-add-backup-policy-u2/add-backup-policy-03.png)<!--Replacement screen source: create-backup-policy-first-schedule.png-->
   ...
   6. 백업 정책이 만들어지면 알림이 표시됩니다. 새로 추가된 정책은 **Backup 정책** 블레이드에서 테이블 형식 뷰로 표시됩니다.
       ...
       ![백업 정책 추가 5](./media/storsimple-8000-add-backup-policy-u2/add-backup-policy-07.png)
