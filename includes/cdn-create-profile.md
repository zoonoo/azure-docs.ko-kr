...
4. **리소스 그룹**을 선택하거나 만듭니다. 리소스 그룹에 대한 자세한 내용은 [Azure 리소스 관리자 개요](../articles/resource-group-overview.md#resource-groups)를 참조하세요.
5. **가격 책정 계층**을 선택합니다. 가격 책정 계층은 [CDN 개요](../articles/cdn/cdn-overview.md#azure-cdn-features)를 참조합니다.
