...
> [AZURE.NOTE] Azure의 가상 컴퓨터는 운영 체제 디스크, 로컬 임시 디스크, 선택적 데이터 디스크 등 다양한 유형의 디스크를 사용합니다. 자세한 내용은 [가상 컴퓨터용 디스크 및 VHD 정보](../articles/virtual-machines/virtual-machines-linux-about-disks-vhds.md)를 참조하십시오. 또한 가상 컴퓨터를 삭제하지 않는 한 운영 체제 디스크를 분리할 수 없습니다.
