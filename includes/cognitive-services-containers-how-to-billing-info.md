...
<a href="https://docs.docker.com/engine/reference/commandline/run/" target="_blank">`docker run` <span class="docon docon-navigate-external x-hidden-focus"></span> </a> 명령은 다음 중 세 가지 옵션을 모두 유효한 값으로 제공 하면 컨테이너를 시작 합니다.
