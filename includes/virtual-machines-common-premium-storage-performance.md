...
Azure Premium Storage는 현재 8가지 디스크 크기를 제공합니다. 각 디스크 크기는 IOPS, 대역폭 및 저장소에 대한 다른 규모 한도를 가집니다. 응용 프로그램 요구 사항 및 높은 확장성의 VM 크기에 따라 올바른 Premium Storage 디스크 크기를 선택합니다. 아래 표에서 8가지 디스크 크기와 해당 기능을 보여 줍니다. P4, P6 및 P15 크기는 현재 Managed Disks에 대해서만 지원됩니다.
