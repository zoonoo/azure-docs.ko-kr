...
로드 밸러워 및 가상 시스템 스케일 집합에 대한 자세한 내용은 [Azure 가상 시스템 규모 집합에 대한 네트워킹을](https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-networking)참조하십시오.
