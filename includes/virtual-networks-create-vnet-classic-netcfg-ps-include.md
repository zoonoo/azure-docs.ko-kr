...
5. 네트워크 구성 파일을 저장합니다.
6. Azure PowerShell 콘솔에서 **Set-AzureVnetConfig** cmdlet을 사용하고 아래 명령을 실행하여 네트워크 구성 파일을 업로드합니다. 명령 아래의 출력을 확인하면 **OperationStatus** 아래에 **Succeeded**가 표시됩니다. 그렇지 않으면 xml 파일에 오류가 있는지 확인합니다.
