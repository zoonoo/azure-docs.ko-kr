...
Logic Apps에서 OneDrive 계정을 사용 하려면 먼저 Azure Portal에서 OneDrive 계정에 연결 하도록 Logic Apps에 권한을 부여 해야 합니다.

OneDrive 계정에 연결 하 Logic Apps 권한을 부여 하려면 다음 단계를 수행 합니다.  
...
1. Logic Apps 디자이너에서 드롭다운 목록에서 **Microsoft 관리 Api 표시** 를 선택한 다음 검색 상자에 *OneDrive* 를 입력 합니다. 사용할 트리거 또는 동작을 선택 합니다.
   ...
   ![추가할 OneDrive API 작업 목록을 보여 주는 Logic Apps 디자이너의 스크린샷](./media/connectors-create-api-onedrive/onedrive-1.png)

2. OneDrive에 대 한 연결을 이전에 만들지 않은 경우 프롬프트에 따라 OneDrive 자격 증명을 사용 하 여 로그인 합니다.  
...
5. 이제 연결이 단계에 나열 됩니다. 저장을 선택한 다음 논리 앱을 계속 만듭니다. 

   ![OneDrive API 연결을 사용 하 여 작업 편집기를 보여 주는 Logic Apps 디자이너의 스크린샷](./media/connectors-create-api-onedrive/onedrive-5.png)
