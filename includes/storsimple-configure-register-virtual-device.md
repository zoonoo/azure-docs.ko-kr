#### <a name="to-configure-and-register-the-virtual-device"></a>가상 장치를 구성 및 등록하려면
...
4. **서비스 데이터 암호화 키** 를 제공한 공간에 입력합니다.

5. 지정된 길이 및 설정의 스냅숏 관리자 및 장치 관리자 암호를 입력합니다.

6. 가상 장치의 초기 구성 및 등록을 완료하려면 확인 표시를 클릭합니다. 
