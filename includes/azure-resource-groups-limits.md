...
리소스 그룹당 800개 배포 제한에 도달하면 기록에서 더 이상 필요하지 않은 배포를 삭제합니다. 사용 하 여 기록에서 항목을 삭제할 수 있습니다 [az 그룹 배포 삭제](/cli/azure/group/deployment) Azure CLI에 대 한 합니다. 사용할 수도 있습니다 [Remove-azurermresourcegroupdeployment](/powershell/module/azurerm.resources/remove-azurermresourcegroupdeployment) powershell에서. 배포 기록에서 항목을 삭제 해도 배포 리소스 영향을 주지 않습니다. 