...
* **개념**: IoT Gateway SDK를 사용하여 만드는 게이트웨이를 구성하는 구성 요소에 대한 개념적인 개요입니다.  
...
## <a name="azure-iot-gateway-sdk-concepts"></a>Azure IoT Gateway SDK 개념
샘플 코드를 점검하거나 IoT Gateway SDK를 사용하여 자체적인 게이트웨이를 만들기 전에, SDK 아키텍처의 토대가 되는 주요 개념을 이해해야 합니다.
...
![Azure IoT Gateway SDK 추상화 계층][2]
