...
7.  **Library** 섹션에서 **Add**를 선택하여 Google Play Services 프로젝트(*google-play-services-lib*)를 선택하고 **OK**를 클릭합니다.

8.  **Apply**를 클릭한 후 **OK**를 클릭합니다.
