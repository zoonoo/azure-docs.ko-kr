...
* [Azure 클래식 포털](https://manage.windowsazure.com/)에서 **모바일 서비스**를 클릭한 후 해당 모바일 서비스를 클릭합니다. **대시보드** 탭을 클릭하고 **사이트 URL** 값을 기록해 둡니다. 이제 **키 관리**를 클릭하고 **응용 프로그램 키**를 기록해 둡니다. 앱 코드에서 모바일 서비스에 액세스할 때 이 값이 필요합니다.
