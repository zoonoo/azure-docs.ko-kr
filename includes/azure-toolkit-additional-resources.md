Java IDE(통합 개발 환경)용 Azure 도구 키트에 대한 자세한 내용은 다음 링크를 참조하세요.
...
Azure와 함께 Java를 사용하는 방법에 대한 추가 내용은 [Azure Java 개발자 센터](https://azure.microsoft.com/develop/java/) 및 [Visual Studio Team Services용 Java 도구](https://java.visualstudio.com/)를 참조하세요.
