...
지침 및 최신 버전으로 연결되는 링크를 보려면 [Azure PowerShell을 설치 및 구성하는 방법](../articles/powershell-install-configure.md)을 참조하세요.
...
Azure 구독 및 계정에 대한 자세한 내용은 [방법: 구독에 연결](../articles/powershell-install-configure.md#Connect)을 참조하세요.
