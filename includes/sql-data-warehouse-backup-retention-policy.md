...
-->
SQL 데이터 웨어하우스는 Azure 저장소 스냅숏을 사용하여 적어도 8시간마다 모든 라이브 데이터를 백업합니다. 이러한 스냅숏은 7일 동안 유지됩니다. 이를 통해 지난 7일 내에 적어도 21개의 특정 시점 중 하나로 마지막 스냅숏 작업 시까지 데이터를 복원할 수 있습니다.
