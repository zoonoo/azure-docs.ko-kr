...
1.  [Azure 관리 포털][1]에서 **Virtual Machines**를 클릭하고 방금 만든 가상 컴퓨터(**testwinvm**)를 선택합니다.
...
5.  가상 컴퓨터의 이름을 클릭하여 대시보드를 표시합니다. 이 대시보드를 사용하여 데이터 디스크가 가상 컴퓨터에 연결되었는지 확인할 수 있습니다.
    ...
    ![빈 디스크 연결](./media/attach-data-disk-windows-server-2008-vm-in-portal/AttachDataDiskWinVM3.png)
...
2.  페이지 맨 아래에 있는 **Connect**를 클릭합니다. Windows 원격 데스크톱 프로그램(*%windir%\\system32\\mstsc.exe*)을 사용하여 .rpd 파일을 엽니다.
