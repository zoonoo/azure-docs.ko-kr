 <h1>Azure 백서</h1>
  <p>아래 나열된 백서에서는 Azure 서비스에 대한 추가적인 견해 및 전망을 제공합니다.</p>
  <p>(인기순)</p>
  <table border="1" cellspacing="0" cellpadding="10" style="border: 0.5px solid #000000;">
    <tbody>
      <tr>
        ...
        <td style="width: 400px;">이 문서는 Microsoft의 Azure 플랫폼에 대해 보다 안전한 응용 프로그램을 설계하고 개발하도록 보안 과제 및 권장 접근 방법에 중점을 둡니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
        ...
        <td style="width: 400px;">이 문서에서는 Azure에서 구현되는 컨트롤의 배열에 대해 설명하므로 고객이 이러한 기능 및 컨트롤이 그들만의 요구 사항에 적합한지 여부를 결정할 수 있습니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
        ...
        <td style="width: 400px;">이 문서에는 온-프레미스와 클라우드 둘 다에 배포되는 웹 응용 프로그램에서 SSO를 얻기 위해 Windows Identity Foundation, Azure 및 Active Directory Federation Services(AD FS) 2.0을 사용하기 위한 단계별 지침이 포함되어 있습니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
          <a href="http://go.microsoft.com/fwlink/?LinkId=153401">Azure 테이블 - 테이블 저장소 프로그래밍(영문)</a>
        </td>
        <td style="width: 400px;">이 문서에서는 Azure 플랫폼에서 제공하는 구조적 저장소인 Azure 테이블에 대해 설명합니다. 이 저장소는 클라우드에서 거대한 규모의 테이블을 지원하며 여기에 수억 개의 엔터티 및 테라바이트의 데이터를 포함할 수 있습니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
      ...
      <tr>
        ...
        <td style="width: 400px;">이 문서에는 제공하는 <em>Platform as a Service</em> 클라우드의 혜택 및 Azure 내에서 구현되는 방법에 대해 논의되어 있습니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
      ...
      <tr>
        ...
        <td style="width: 400px;">이 문서는 어떤 Azure 캐싱이 캐싱 서비스가 지원하는 캐시 패턴 중 다른 유형을 제공하는지 살펴봅니다. 또한 캐싱을 활용하도록 응용 프로그램을 구성할 때 고려해야 하는 캐시가 소개하는 중요한 문제도 다룹니다.</td>
      </tr>
      <tr>
        <td style="width: 200px;">
