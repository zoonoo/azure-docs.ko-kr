...
[Web Apps](/app-service/overview)는 Windows 환경을 사용하여 웹 애플리케이션을 빌드하고 호스팅하는 App Service의 주요 제품입니다. Linux 환경을 선호하는 개발자는 [Linux용 App Service](/app-service/overview#app-service-on-linux)를 선택할 수 있습니다. 또한 개발자는 Docker 이미지를 Linux용 App Service에 직접 배포하여 사용자 정의 런타임/프레임워크를 배포할 수도 있습니다.
...
- 다음을 사용하여 애플리케이션을 만듭니다.
  ...
  - [MongoDB를 사용하는 Node.js](/azure/app-service/tutorial-nodejs-mongodb-app)
  - [MySQL을 사용하는 Java](/app-service/app-service-web-tutorial-java-mysql)
  - [PostgreSQL을 사용하는 Python](/app-service/tutorial-python-postgresql-app)
